...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckIndex=ogCheckIndex, ogHostUserTable=ogHostUserTable, ogSerialPortMode=ogSerialPortMode, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemTemperature=ogCellModemTemperature, ogAlarmDevice=ogAlarmDevice, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsState=ogUpsState, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserName=ogHostUserName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialNumber=ogSerialNumber, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostPingNotification=ogHostPingNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityName=ogEmdHumidityName, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServicePort=ogHostServicePort, ogAlarmLogTable=ogAlarmLogTable, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientMode=ogWifiClientMode, ogSerialUserPort=ogSerialUserPort, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioCounter=ogEmdDioCounter, ogCellSignalNotification=ogCellSignalNotification, ogAlarmUser=ogAlarmUser, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletState=ogRpcOutletState, ogEmdDioType=ogEmdDioType, ogAlarmName=ogAlarmName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcInputCurrent=ogRpcInputCurrent, ogWebUserName=ogWebUserName, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsTable=ogUpsTable, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientRssi=ogWifiClientRssi, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemConnected=ogCellModemConnected, ogSerialPortRTS=ogSerialPortRTS, ogCellModemVendor=ogCellModemVendor, ogUpsIndex=ogUpsIndex, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellTowerNotification=ogCellTowerNotification, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceTable=ogHostServiceTable, ogRpcType=ogRpcType, ogHostEntry=ogHostEntry, ogCellModemApn=ogCellModemApn, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostServiceNotification=ogHostServiceNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarm=ogAlarm, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDioDescription=ogEmdDioDescription, ogStatus2=ogStatus2, ogSerialPortEntry=ogSerialPortEntry, ogAlarmState=ogAlarmState, ogEmdTable=ogEmdTable, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserLabel=ogSerialUserLabel, ogWifiApInterface=ogWifiApInterface, ogEmdDioIndex=ogEmdDioIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserNotification=ogWebUserNotification, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioState=ogEmdDioState, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApEnabled=ogWifiApEnabled, ogEmdIndex=ogEmdIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdEntry=ogEmdEntry, ogHostUserAddress=ogHostUserAddress, ogHostName=ogHostName, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckEntry=ogCheckEntry, ogSerialPortIndex=ogSerialPortIndex, ogRpcTable=ogRpcTable, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserEntry=ogHostUserEntry, PYSNMP_MODULE_ID=ogStatus2, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserTable=ogSerialUserTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceStatus=ogHostServiceStatus, ogHostIpV4Address=ogHostIpV4Address, ogCellDataNotification=ogCellDataNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserHost=ogHostUserHost, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckName=ogCheckName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsOutputPower=ogUpsOutputPower, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdEnabled=ogEmdEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsHumidity=ogUpsHumidity, ogHostUserStartTime=ogHostUserStartTime, ogHostIpV6Address=ogHostIpV6Address, ogWifiApSsid=ogWifiApSsid, ogSerialPortDTR=ogSerialPortDTR, ogCellModemCounter=ogCellModemCounter, ogEmdDioName=ogEmdDioName, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWebUserTable=ogWebUserTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientEssid=ogWifiClientEssid, ogUpsEntry=ogUpsEntry, ogAlarmType=ogAlarmType, ogAlarmInstance=ogAlarmInstance, ogEmdDioTable=ogEmdDioTable, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDescription=ogEmdDescription, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserEntry=ogSerialUserEntry, ogUpsName=ogUpsName, ogNetInterfaceTable=ogNetInterfaceTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmTime=ogAlarmTime, ogWifiClientEntry=ogWifiClientEntry, ogCheckDeviceName=ogCheckDeviceName, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientApMac=ogWifiClientApMac, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApTable=ogWifiApTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcName=ogRpcName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsType=ogUpsType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceNotification=ogNetInterfaceNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemTower=ogCellModemTower, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemEntry=ogCellModemEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostTable=ogHostTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientTable=ogWifiClientTable, ogSystem=ogSystem, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostUserHostName=ogHostUserHostName, ogCellModemTable=ogCellModemTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckTable=ogCheckTable, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcEntry=ogRpcEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmTime=ogCurrentAlarmTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApCounter=ogWifiApCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemEnabled=ogCellModemEnabled, ogCustomNotification=ogCustomNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcIndex=ogRpcIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemModel=ogCellModemModel, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsNotification=ogUpsNotification, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcDescription=ogRpcDescription, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemIndex=ogCellModemIndex, ogUpsDescription=ogUpsDescription, ogHostUserIndex=ogHostUserIndex, ogAlarmCheck=ogAlarmCheck, ogMibNotifications=ogMibNotifications, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceType=ogHostServiceType, ogSerialPortParity=ogSerialPortParity, ogWifiApIndex=ogWifiApIndex, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortTable=ogSerialPortTable, ogUpsInputNotification=ogUpsInputNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2Compliance=ogStatus2Compliance, ogHostIndex=ogHostIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserName=ogSerialUserName, ogEmdDioDirection=ogEmdDioDirection, ogStatus2Groups=ogStatus2Groups, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcConnectType=ogRpcConnectType, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdName=ogEmdName, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortStopBits=ogSerialPortStopBits, ogNetInterfaceState=ogNetInterfaceState, ogCellModemRegistered=ogCellModemRegistered, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsCounter=ogUpsCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsTemperature=ogUpsTemperature, ogRpcCounter=ogRpcCounter, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortDCD=ogSerialPortDCD, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmEventId=ogAlarmEventId, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsConnectType=ogUpsConnectType, ogCheckType=ogCheckType, ogRpcInputNotification=ogRpcInputNotification, ogWifiApEntry=ogWifiApEntry)
