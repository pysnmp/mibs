...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApTxPower=ogWifiApTxPower, ogCellModemModel=ogCellModemModel, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioName=ogEmdDioName, ogCheckTriggerActions=ogCheckTriggerActions, ogHostIndex=ogHostIndex, ogUpsTable=ogUpsTable, ogAlarmInstance=ogAlarmInstance, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckIndex=ogCheckIndex, ogWebUserNotification=ogWebUserNotification, ogWifiClientMode=ogWifiClientMode, ogRpcConnectType=ogRpcConnectType, ogCheckResolveActions=ogCheckResolveActions, ogWifiApInterface=ogWifiApInterface, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletState=ogRpcOutletState, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemTower=ogCellModemTower, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserLabel=ogSerialUserLabel, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialNumber=ogSerialNumber, ogSerialPortEntry=ogSerialPortEntry, ogHostUserName=ogHostUserName, ogWifiApClientEntry=ogWifiApClientEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsDescription=ogUpsDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServicePort=ogHostServicePort, ogWebUserIndex=ogWebUserIndex, ogAlarmTime=ogAlarmTime, ogWifiClientEntry=ogWifiClientEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmCheck=ogAlarmCheck, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemTable=ogCellModemTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsConnectType=ogUpsConnectType, ogUpsNotification=ogUpsNotification, ogSystem=ogSystem, ogSerialUserEntry=ogSerialUserEntry, ogWebUserName=ogWebUserName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserAddress=ogHostUserAddress, ogAlarmType=ogAlarmType, ogCheckEntry=ogCheckEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientBitRate=ogWifiClientBitRate, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmName=ogAlarmName, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcName=ogRpcName, ogWifiClientTable=ogWifiClientTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemCounter=ogCellModemCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioTable=ogEmdDioTable, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsCounter=ogUpsCounter, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortParity=ogSerialPortParity, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioType=ogEmdDioType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApCounter=ogWifiApCounter, ogHostPingNotification=ogHostPingNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletName=ogRpcOutletName, ogSerialPortDTR=ogSerialPortDTR, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceName=ogCheckDeviceName, ogUpsState=ogUpsState, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioNotification=ogEmdDioNotification, ogNetInterfaceState=ogNetInterfaceState, ogWebUserTable=ogWebUserTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogStatus2Conformance=ogStatus2Conformance, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserNotification=ogHostUserNotification, ogSerialUserName=ogSerialUserName, ogNetInterfaceType=ogNetInterfaceType, ogHostUserEntry=ogHostUserEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsEntry=ogUpsEntry, ogFirmwareVersion=ogFirmwareVersion, ogRpcType=ogRpcType, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTable=ogEmdTable, ogWifiClientCounter=ogWifiClientCounter, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemApn=ogCellModemApn, ogEmdDioState=ogEmdDioState, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortBreaks=ogSerialPortBreaks, ogCellDataNotification=ogCellDataNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserTable=ogSerialUserTable, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemIndex=ogCellModemIndex, ogEmdDioIndex=ogEmdDioIndex, ogCheckName=ogCheckName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogMibNotifications=ogMibNotifications, ogWifiApSsid=ogWifiApSsid, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarm=ogAlarm, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserStartTime=ogHostUserStartTime, ogCellModemVendor=ogCellModemVendor, ogWifiApIndex=ogWifiApIndex, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioDirection=ogEmdDioDirection, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsIndex=ogUpsIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostTable=ogHostTable, ogRpcIndex=ogRpcIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsName=ogUpsName, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsTemperature=ogUpsTemperature, ogHostServiceStatus=ogHostServiceStatus, ogCheckType=ogCheckType, ogUpsLogEnabled=ogUpsLogEnabled, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortIndex=ogSerialPortIndex, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmState=ogAlarmState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdEntry=ogEmdEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemSessionTime=ogCellModemSessionTime, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcTable=ogRpcTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortDSR=ogSerialPortDSR, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmUser=ogAlarmUser, ogHostName=ogHostName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostIpV6Address=ogHostIpV6Address, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostIpV4Address=ogHostIpV4Address, ogRpcCounter=ogRpcCounter, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWebUserEntry=ogWebUserEntry, ogWifiClientRssi=ogWifiClientRssi, ogCellApnNotification=ogCellApnNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioEmd=ogEmdDioEmd, ogUpsType=ogUpsType, ogSerialPortTable=ogSerialPortTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialUserNotification=ogSerialUserNotification, ogStatus2Compliance=ogStatus2Compliance, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcEntry=ogRpcEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdName=ogEmdName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2Groups=ogStatus2Groups, ogHostServiceTable=ogHostServiceTable, ogCustomNotification=ogCustomNotification, ogHostUserIndex=ogHostUserIndex, ogSerialUserPort=ogSerialUserPort, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceType=ogHostServiceType, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellMessageNotification=ogCellMessageNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputFrequency=ogUpsInputFrequency, ogHostServiceEntry=ogHostServiceEntry, ogHostUserTable=ogHostUserTable, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApTable=ogWifiApTable, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryState=ogUpsBatteryState, ogHostUserHost=ogHostUserHost, ogEmdDioDescription=ogEmdDioDescription, ogCheckTable=ogCheckTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogStatus2=ogStatus2, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceHost=ogHostServiceHost, ogEmdIndex=ogEmdIndex, ogPowerSupplyName=ogPowerSupplyName, ogRpcDescription=ogRpcDescription, ogHostEntry=ogHostEntry, ogWifiClientApMac=ogWifiClientApMac, ogAlarmSummary=ogAlarmSummary, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceIndex=ogHostServiceIndex, ogEmdEnabled=ogEmdEnabled, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemEntry=ogCellModemEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDescription=ogEmdDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmState=ogCurrentAlarmState)
