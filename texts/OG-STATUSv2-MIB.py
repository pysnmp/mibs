...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsName=ogUpsName, ogWifiApTable=ogWifiApTable, ogEmdIndex=ogEmdIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortStopBits=ogSerialPortStopBits, ogHostIpV6Address=ogHostIpV6Address, ogCellDataNotification=ogCellDataNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostTable=ogHostTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmInstance=ogAlarmInstance, ogAlarmDevice=ogAlarmDevice, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioType=ogEmdDioType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientMode=ogWifiClientMode, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioName=ogEmdDioName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserStartTime=ogHostUserStartTime, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemConnected=ogCellModemConnected, ogHostServiceType=ogHostServiceType, ogCheckName=ogCheckName, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemEnabled=ogCellModemEnabled, ogCheckIndex=ogCheckIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserAddress=ogHostUserAddress, ogRpcOutletName=ogRpcOutletName, ogSerialUserEntry=ogSerialUserEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdConnectType=ogEmdConnectType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcConnectType=ogRpcConnectType, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApIndex=ogWifiApIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcType=ogRpcType, ogAlarmCheck=ogAlarmCheck, ogHostUserTable=ogHostUserTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostName=ogHostName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemIndex=ogCellModemIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialNumber=ogSerialNumber, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostPingNotification=ogHostPingNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletState=ogRpcOutletState, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceNotification=ogHostServiceNotification, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioEntry=ogEmdDioEntry, ogAlarmEventId=ogAlarmEventId, ogUpsConnectType=ogUpsConnectType, ogUpsInputNotification=ogUpsInputNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsNotification=ogUpsNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogNetInterfaceState=ogNetInterfaceState, ogRpcName=ogRpcName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletTable=ogRpcOutletTable, ogHostUserNotification=ogHostUserNotification, ogCellModemVendor=ogCellModemVendor, ogAlarmTime=ogAlarmTime, ogSerialUserNotification=ogSerialUserNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientAp=ogWifiApClientAp, ogUpsInputCurrent=ogUpsInputCurrent, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceName=ogCheckDeviceName, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcEntry=ogRpcEntry, ogCellModemRegistered=ogCellModemRegistered, ogEmdEntry=ogEmdEntry, ogSerialPortTable=ogSerialPortTable, ogWifiClientCounter=ogWifiClientCounter, ogWebUserIndex=ogWebUserIndex, ogRpcCounter=ogRpcCounter, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceCounter=ogHostServiceCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemEntry=ogCellModemEntry, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsTable=ogUpsTable, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTable=ogEmdTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsType=ogUpsType, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApFrequency=ogWifiApFrequency, ogMibNotifications=ogMibNotifications, ogCellModemApn=ogCellModemApn, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserName=ogSerialUserName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellApnNotification=ogCellApnNotification, ogUpsEntry=ogUpsEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserName=ogHostUserName, ogSerialUserLabel=ogSerialUserLabel, ogUpsCounter=ogUpsCounter, ogHostServiceTable=ogHostServiceTable, ogWebUserName=ogWebUserName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientInterface=ogWifiClientInterface, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmUser=ogAlarmUser, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWebUserTable=ogWebUserTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserHost=ogHostUserHost, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemModel=ogCellModemModel, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellTowerNotification=ogCellTowerNotification, ogWifiApSsid=ogWifiApSsid, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientTable=ogWifiClientTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientIndex=ogWifiClientIndex, ogCellModemTable=ogCellModemTable, ogAlarm=ogAlarm, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApEntry=ogWifiApEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWebUserNotification=ogWebUserNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemSessionTime=ogCellModemSessionTime, ogCustomNotification=ogCustomNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, PYSNMP_MODULE_ID=ogStatus2, ogEmdDescription=ogEmdDescription, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmName=ogAlarmName, ogSystem=ogSystem, ogSerialUserPort=ogSerialUserPort, ogAlarmState=ogAlarmState, ogSerialPortMode=ogSerialPortMode, ogEmdDioState=ogEmdDioState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServiceStatus=ogHostServiceStatus)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletNotification=ogRpcOutletNotification, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioTable=ogEmdDioTable, ogWifiApClientRssi=ogWifiApClientRssi, ogStatus2=ogStatus2, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmType=ogAlarmType, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemTemperature=ogCellModemTemperature, ogHostUserIndex=ogHostUserIndex, ogHostUserHostName=ogHostUserHostName, ogRpcTable=ogRpcTable, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientEssid=ogWifiClientEssid, ogCellModemCounter=ogCellModemCounter, ogRpcDescription=ogRpcDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogStatus2Groups=ogStatus2Groups, ogWifiApClientMac=ogWifiApClientMac, ogCellModemTower=ogCellModemTower, ogHostEntry=ogHostEntry, ogCheckType=ogCheckType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortParity=ogSerialPortParity, ogHostServicePort=ogHostServicePort, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientEntry=ogWifiClientEntry, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletEntry=ogRpcOutletEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckEntry=ogCheckEntry, ogHostUserEntry=ogHostUserEntry, ogUpsIndex=ogUpsIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdName=ogEmdName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApEnabled=ogWifiApEnabled, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApCounter=ogWifiApCounter, ogHostIndex=ogHostIndex, ogUpsHumidity=ogUpsHumidity, ogCheckTable=ogCheckTable, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcIndex=ogRpcIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserEntry=ogWebUserEntry, ogUpsTemperature=ogUpsTemperature, ogUpsDescription=ogUpsDescription, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsState=ogUpsState, ogWifiClientBitRate=ogWifiClientBitRate)
