...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPatternNotification=ogSerialPatternNotification, ogUpsEntry=ogUpsEntry, ogRpcIndex=ogRpcIndex, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletNotification=ogRpcOutletNotification, ogCellMessageNotification=ogCellMessageNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientAp=ogWifiApClientAp, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioNotification=ogEmdDioNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDescription=ogEmdDescription, ogRpcOutletCurrent=ogRpcOutletCurrent, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsIndex=ogUpsIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellTowerNotification=ogCellTowerNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmUser=ogAlarmUser, ogEmdEntry=ogEmdEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletState=ogRpcOutletState, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmName=ogCurrentAlarmName, ogCustomNotification=ogCustomNotification, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserEntry=ogWebUserEntry, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceName=ogNetInterfaceName, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioDirection=ogEmdDioDirection, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemTower=ogCellModemTower, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceState=ogNetInterfaceState, ogAlarmState=ogAlarmState, ogWifiApEntry=ogWifiApEntry, ogRpcDescription=ogRpcDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputPower=ogUpsOutputPower, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserName=ogSerialUserName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryState=ogUpsBatteryState, ogRpcInputVoltage=ogRpcInputVoltage, ogCellDataNotification=ogCellDataNotification, ogHostName=ogHostName, ogCellModemApn=ogCellModemApn, ogSerialUserIndex=ogSerialUserIndex, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityName=ogEmdHumidityName, ogStatus2Groups=ogStatus2Groups, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWebUserIndex=ogWebUserIndex, ogSerialPortDCD=ogSerialPortDCD, ogHostUserEntry=ogHostUserEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdEnabled=ogEmdEnabled, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcType=ogRpcType, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApIndex=ogWifiApIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceTable=ogHostServiceTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsInputNotification=ogUpsInputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostEntry=ogHostEntry, ogHostUserAddress=ogHostUserAddress, ogUpsTable=ogUpsTable, ogWifiClientRssi=ogWifiClientRssi, ogWifiApSsid=ogWifiApSsid, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWebUserName=ogWebUserName, ogSerialUserPort=ogSerialUserPort, ogEmdDioState=ogEmdDioState, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioType=ogEmdDioType, ogCellApnNotification=ogCellApnNotification, ogUpsConnectType=ogUpsConnectType, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmType=ogAlarmType, ogHostPingNotification=ogHostPingNotification, ogWifiApTable=ogWifiApTable, ogEmdTable=ogEmdTable, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSystem=ogSystem, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckName=ogCheckName, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemModel=ogCellModemModel, ogEmdIndex=ogEmdIndex, ogEmdDioIndex=ogEmdDioIndex, ogHostIndex=ogHostIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortEntry=ogSerialPortEntry, ogUpsTemperature=ogUpsTemperature, ogRpcTable=ogRpcTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserIndex=ogHostUserIndex, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceNotification=ogHostServiceNotification, ogUpsState=ogUpsState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckIndex=ogCheckIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsDescription=ogUpsDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletTable=ogRpcOutletTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemSessionTime=ogCellModemSessionTime, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsCounter=ogUpsCounter, ogSerialPortParity=ogSerialPortParity, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserHost=ogHostUserHost, ogRpcCounter=ogRpcCounter, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellSignalNotification=ogCellSignalNotification, ogAlarmInstance=ogAlarmInstance, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmTime=ogAlarmTime, ogWifiApTxPower=ogWifiApTxPower, PYSNMP_MODULE_ID=ogStatus2, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserNotification=ogWebUserNotification, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServiceStatus=ogHostServiceStatus, ogCellModemCounter=ogCellModemCounter, ogRpcName=ogRpcName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceCounter=ogHostServiceCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioDescription=ogEmdDioDescription, ogHostUserHostName=ogHostUserHostName, ogSerialPortTable=ogSerialPortTable, ogSerialPortDSR=ogSerialPortDSR, ogCheckType=ogCheckType, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostTable=ogHostTable, ogUpsType=ogUpsType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserName=ogHostUserName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserTable=ogHostUserTable, ogHostServiceType=ogHostServiceType, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarm=ogAlarm, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserNotification=ogHostUserNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientTable=ogWifiClientTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModem3gRssi=ogCellModem3gRssi, ogMibNotifications=ogMibNotifications, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortMode=ogSerialPortMode, ogSerialNumber=ogSerialNumber, ogCellModemEntry=ogCellModemEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcConnectType=ogRpcConnectType, ogStatus2=ogStatus2, ogCheckTriggerActions=ogCheckTriggerActions, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemTable=ogCellModemTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletName=ogRpcOutletName, ogAlarmName=ogAlarmName, ogRpcEntry=ogRpcEntry, ogHostServicePort=ogHostServicePort, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryCharge=ogUpsBatteryCharge, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsName=ogUpsName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmSummary=ogAlarmSummary, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientInterface=ogWifiClientInterface, ogCheckTable=ogCheckTable, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdName=ogEmdName, ogEmdDioName=ogEmdDioName, ogStatus2Compliances=ogStatus2Compliances, ogCheckEntry=ogCheckEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortIndex=ogSerialPortIndex, ogAlarmCheck=ogAlarmCheck, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialUserTable=ogSerialUserTable, ogHostServiceIndex=ogHostServiceIndex, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsNotification=ogUpsNotification, ogWifiApCounter=ogWifiApCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserTable=ogWebUserTable, ogWifiApClientTable=ogWifiApClientTable)
