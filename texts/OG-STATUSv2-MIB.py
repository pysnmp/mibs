...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserNotification=ogHostUserNotification, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioType=ogEmdDioType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientMac=ogWifiApClientMac, ogCellModemRegistered=ogCellModemRegistered, ogCellModemTable=ogCellModemTable, ogHostUserTable=ogHostUserTable, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserStartTime=ogSerialUserStartTime, ogHostUserHost=ogHostUserHost, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcCounter=ogRpcCounter, ogAlarmDevice=ogAlarmDevice, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialUserTable=ogSerialUserTable, ogRpcOutletState=ogRpcOutletState, ogSerialPortStopBits=ogSerialPortStopBits, ogHostServiceType=ogHostServiceType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApTable=ogWifiApTable, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletName=ogRpcOutletName, ogMibNotifications=ogMibNotifications, ogUpsEntry=ogUpsEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogNetInterfaceState=ogNetInterfaceState, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemApn=ogCellModemApn, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioDirection=ogEmdDioDirection, ogAlarmName=ogAlarmName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckIndex=ogCheckIndex, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletTable=ogRpcOutletTable, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyName=ogPowerSupplyName, ogHostUserStartTime=ogHostUserStartTime, ogRpcType=ogRpcType, ogEmdEntry=ogEmdEntry, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcInputNotification=ogRpcInputNotification, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckType=ogCheckType, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientApMac=ogWifiClientApMac, ogRpcIndex=ogRpcIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientMode=ogWifiClientMode, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortTable=ogSerialPortTable, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcConnectType=ogRpcConnectType, ogEmdName=ogEmdName, ogCheckTable=ogCheckTable, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientEssid=ogWifiClientEssid, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortDSR=ogSerialPortDSR, ogHostServicePort=ogHostServicePort, ogStatus2Conformance=ogStatus2Conformance, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsName=ogUpsName, ogWebUserNotification=ogWebUserNotification, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDescription=ogEmdDescription, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, PYSNMP_MODULE_ID=ogStatus2, ogUpsIndex=ogUpsIndex, ogHostIndex=ogHostIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserNotification=ogSerialUserNotification, ogWifiApSsid=ogWifiApSsid, ogUpsDescription=ogUpsDescription, ogAlarmInstance=ogAlarmInstance, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserName=ogWebUserName, ogSerialUserName=ogSerialUserName, ogCellModemCounter=ogCellModemCounter, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdLogEnabled=ogEmdLogEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortParity=ogSerialPortParity, ogRpcName=ogRpcName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityTotal=ogEmdHumidityTotal, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsHumidity=ogUpsHumidity, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientIndex=ogWifiClientIndex, ogAlarmUser=ogAlarmUser, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsNotification=ogUpsNotification, ogUpsInputNotification=ogUpsInputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsType=ogUpsType, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmState=ogAlarmState, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioCounter=ogEmdDioCounter, ogCheckEntry=ogCheckEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemModel=ogCellModemModel, ogCheckName=ogCheckName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTable=ogEmdTable, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellTowerNotification=ogCellTowerNotification, ogStatus2=ogStatus2, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemEntry=ogCellModemEntry, ogCheckResolveActions=ogCheckResolveActions, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceHost=ogHostServiceHost, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputPower=ogUpsOutputPower, ogHostTable=ogHostTable, ogUpsConnectType=ogUpsConnectType, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortDTR=ogSerialPortDTR, ogAlarm=ogAlarm, ogEmdDioEntry=ogEmdDioEntry, ogAlarmType=ogAlarmType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortMode=ogSerialPortMode, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientTable=ogWifiClientTable, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogNetInterfaceType=ogNetInterfaceType, ogAlarmSummary=ogAlarmSummary, ogEmdDioName=ogEmdDioName, ogCellApnNotification=ogCellApnNotification, ogSystem=ogSystem, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostUserName=ogHostUserName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellDataNotification=ogCellDataNotification, ogWebUserEntry=ogWebUserEntry, ogWifiApEntry=ogWifiApEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceTable=ogHostServiceTable, ogUpsState=ogUpsState, ogSerialPortLabel=ogSerialPortLabel, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcDescription=ogRpcDescription, ogHostServiceIndex=ogHostServiceIndex, ogWebUserIndex=ogWebUserIndex, ogHostName=ogHostName, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserAddress=ogHostUserAddress, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcEntry=ogRpcEntry, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsTemperature=ogUpsTemperature, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmDevice=ogCurrentAlarmDevice)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserLabel=ogSerialUserLabel, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsTable=ogUpsTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdEnabled=ogEmdEnabled, ogHostEntry=ogHostEntry, ogAlarmEventId=ogAlarmEventId, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogFirmwareVersion=ogFirmwareVersion, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsCounter=ogUpsCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserTable=ogWebUserTable, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserStartTime=ogWebUserStartTime, ogCellModemTower=ogCellModemTower, ogRpcOutletNotification=ogRpcOutletNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdConnectType=ogEmdConnectType, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemVendor=ogCellModemVendor, ogSerialUserPort=ogSerialUserPort, ogEmdIndex=ogEmdIndex, ogAlarmTime=ogAlarmTime, ogHostPingNotification=ogHostPingNotification, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioState=ogEmdDioState, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortDataBits=ogSerialPortDataBits, ogCustomNotification=ogCustomNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmLogTable=ogAlarmLogTable, ogSerialNumber=ogSerialNumber, ogHostUserHostName=ogHostUserHostName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserIndex=ogHostUserIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioEmd=ogEmdDioEmd, ogWifiApInterface=ogWifiApInterface, ogStatus2Groups=ogStatus2Groups, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcTable=ogRpcTable, ogHostIpV6Address=ogHostIpV6Address, ogSerialSignalNotification=ogSerialSignalNotification)
