...
Integer32, Bits, IpAddress, Counter64, NotificationType, Counter32, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Unsigned32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "IpAddress", "Counter64", "NotificationType", "Counter32", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Unsigned32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletRpc=ogRpcOutletRpc, ogHostServicePort=ogHostServicePort, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApCounter=ogWifiApCounter, ogAlarmState=ogAlarmState, ogHostEntry=ogHostEntry, ogStatus2Compliance=ogStatus2Compliance, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsConnectType=ogUpsConnectType, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsInputNotification=ogUpsInputNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserIndex=ogSerialUserIndex, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcName=ogRpcName, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortDTR=ogSerialPortDTR, ogWebUserName=ogWebUserName, ogHostUserEntry=ogHostUserEntry, ogWifiApInterface=ogWifiApInterface, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemTower=ogCellModemTower, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdName=ogEmdName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostIpV6Address=ogHostIpV6Address, ogAlarmEventId=ogAlarmEventId, ogWebUserNotification=ogWebUserNotification, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputPower=ogUpsOutputPower, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletTotal=ogRpcOutletTotal, ogHostIpV4Address=ogHostIpV4Address, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdIndex=ogEmdIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogPowerSupplyName=ogPowerSupplyName, ogHostUserAddress=ogHostUserAddress, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserNotification=ogHostUserNotification, ogHostUserStartTime=ogHostUserStartTime, ogCellModemSessionTime=ogCellModemSessionTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceTable=ogHostServiceTable, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsEntry=ogUpsEntry, ogWebUserStartTime=ogWebUserStartTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserTable=ogHostUserTable, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialNumber=ogSerialNumber, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPatternNotification=ogSerialPatternNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserName=ogHostUserName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcInputNotification=ogRpcInputNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmUser=ogAlarmUser, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioDescription=ogEmdDioDescription, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSystem=ogSystem, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmSummary=ogAlarmSummary, ogSerialUserName=ogSerialUserName, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityName=ogEmdHumidityName, ogHostUserIndex=ogHostUserIndex, ogCheckName=ogCheckName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostUserHost=ogHostUserHost, ogEmdDescription=ogEmdDescription, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcDescription=ogRpcDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemRegistered=ogCellModemRegistered, ogCellModemNetwork=ogCellModemNetwork, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioDirection=ogEmdDioDirection, ogCheckDeviceRef=ogCheckDeviceRef, ogStatus2=ogStatus2, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdEnabled=ogEmdEnabled, ogHostServiceHost=ogHostServiceHost, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmDevice=ogAlarmDevice, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdLogEnabled=ogEmdLogEnabled, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellDataNotification=ogCellDataNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientCounter=ogWifiClientCounter, ogUpsName=ogUpsName, ogCellModemIndex=ogCellModemIndex, ogCellModemApn=ogCellModemApn, ogCellModemTemperature=ogCellModemTemperature, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcType=ogRpcType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioType=ogEmdDioType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellTowerNotification=ogCellTowerNotification, ogAlarmCheck=ogAlarmCheck, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsCounter=ogUpsCounter, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortLabel=ogSerialPortLabel, ogWifiApTable=ogWifiApTable, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmLogTable=ogAlarmLogTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarm=ogAlarm, ogStatus2Groups=ogStatus2Groups, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckDeviceName=ogCheckDeviceName, ogRpcCounter=ogRpcCounter, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioTable=ogEmdDioTable, ogUpsTable=ogUpsTable, ogHostServiceEntry=ogHostServiceEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientApMac=ogWifiClientApMac, ogHostTable=ogHostTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioIndex=ogEmdDioIndex, ogCellModemTable=ogCellModemTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletState=ogRpcOutletState, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsIndex=ogUpsIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostPingNotification=ogHostPingNotification, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckType=ogCheckType, ogWifiApIndex=ogWifiApIndex, ogHostIndex=ogHostIndex, ogUpsState=ogUpsState, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserEntry=ogWebUserEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckIndex=ogCheckIndex, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemEnabled=ogCellModemEnabled, ogHostName=ogHostName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceCounter=ogHostServiceCounter, ogCellMessageNotification=ogCellMessageNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortTable=ogSerialPortTable, ogEmdDioNotification=ogEmdDioNotification, ogHostServiceStatus=ogHostServiceStatus, ogCellModemCounter=ogCellModemCounter, ogCellModemModel=ogCellModemModel, PYSNMP_MODULE_ID=ogStatus2, ogMibNotifications=ogMibNotifications, ogEmdDioState=ogEmdDioState, ogRpcIndex=ogRpcIndex, ogUpsNotification=ogUpsNotification, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmTime=ogAlarmTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioName=ogEmdDioName, ogHostUserHostName=ogHostUserHostName, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckTable=ogCheckTable, ogCustomNotification=ogCustomNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientMac=ogWifiApClientMac, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogStatus2Compliances=ogStatus2Compliances, ogHostServiceType=ogHostServiceType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdEntry=ogEmdEntry, ogAlarmName=ogAlarmName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWebUserTable=ogWebUserTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcTable=ogRpcTable, ogUpsHumidity=ogUpsHumidity, ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdTable=ogEmdTable, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortMode=ogSerialPortMode, ogWifiClientEntry=ogWifiClientEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioEntry=ogEmdDioEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemConnected=ogCellModemConnected, ogCheckEntry=ogCheckEntry, ogUpsDescription=ogUpsDescription, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceType=ogNetInterfaceType, ogRpcEntry=ogRpcEntry, ogRpcOutletName=ogRpcOutletName, ogUpsOutputNotification=ogUpsOutputNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserLabel=ogSerialUserLabel, ogUpsType=ogUpsType, ogWifiApEntry=ogWifiApEntry, ogAlarmType=ogAlarmType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcConnectType=ogRpcConnectType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellApnNotification=ogCellApnNotification, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue)
