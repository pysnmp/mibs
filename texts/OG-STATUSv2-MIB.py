...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsName=ogUpsName, ogCellModemApn=ogCellModemApn, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserIndex=ogSerialUserIndex, ogHostIpV4Address=ogHostIpV4Address, ogRpcIndex=ogRpcIndex, ogAlarmCheck=ogAlarmCheck, ogRpcInputNotification=ogRpcInputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCustomNotification=ogCustomNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdEnabled=ogEmdEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcTable=ogRpcTable, ogNetInterfaceType=ogNetInterfaceType, ogEmdDescription=ogEmdDescription, ogCellModemTower=ogCellModemTower, ogRpcType=ogRpcType, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletTable=ogRpcOutletTable, ogCheckName=ogCheckName, ogRpcName=ogRpcName, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsConnectType=ogUpsConnectType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioTable=ogEmdDioTable, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceStatus=ogHostServiceStatus, ogHostUserTable=ogHostUserTable, ogHostUserEntry=ogHostUserEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckEntry=ogCheckEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmTime=ogAlarmTime, ogHostName=ogHostName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellDataNotification=ogCellDataNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckType=ogCheckType, ogHostUserHostName=ogHostUserHostName, ogWifiApClientMac=ogWifiApClientMac, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceHost=ogHostServiceHost, ogCellModemEnabled=ogCellModemEnabled, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWebUserTable=ogWebUserTable, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsCounter=ogUpsCounter, ogWifiApIndex=ogWifiApIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogMibNotifications=ogMibNotifications, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserHost=ogHostUserHost, ogWifiClientCounter=ogWifiClientCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcCounter=ogRpcCounter, ogSerialNumber=ogSerialNumber, ogAlarmUser=ogAlarmUser, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApTxPower=ogWifiApTxPower, ogCellModemModel=ogCellModemModel, ogUpsState=ogUpsState, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceTable=ogHostServiceTable, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemTable=ogCellModemTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserName=ogSerialUserName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputLoad=ogUpsOutputLoad, ogHostEntry=ogHostEntry, ogUpsType=ogUpsType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemEntry=ogCellModemEntry, ogWifiApClientTable=ogWifiApClientTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsTable=ogUpsTable, ogEmdDioDirection=ogEmdDioDirection, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortParity=ogSerialPortParity, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdName=ogEmdName, ogAlarmSummary=ogAlarmSummary, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientTable=ogWifiClientTable, ogRpcOutletTotal=ogRpcOutletTotal, ogSystem=ogSystem, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsTemperature=ogUpsTemperature, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortEntry=ogSerialPortEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostIndex=ogHostIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWebUserNotification=ogWebUserNotification, ogAlarm=ogAlarm, ogStatus2Compliance=ogStatus2Compliance, ogUpsHumidity=ogUpsHumidity, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserIndex=ogHostUserIndex, ogRpcDescription=ogRpcDescription, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogFirmwareVersion=ogFirmwareVersion, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortIndex=ogSerialPortIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceType=ogHostServiceType, ogEmdDioState=ogEmdDioState, ogEmdIndex=ogEmdIndex, ogWifiClientApMac=ogWifiClientApMac, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdEntry=ogEmdEntry, ogCellModemIndex=ogCellModemIndex, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceName=ogNetInterfaceName, ogWebUserEntry=ogWebUserEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemRegistered=ogCellModemRegistered, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceIndex=ogHostServiceIndex, ogCheckTable=ogCheckTable, ogSerialUserEntry=ogSerialUserEntry, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletName=ogRpcOutletName, ogWebUserName=ogWebUserName, ogWifiClientMode=ogWifiClientMode, ogSerialUserStartTime=ogSerialUserStartTime, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogHostIpV6Address=ogHostIpV6Address, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortRTS=ogSerialPortRTS, ogAlarmType=ogAlarmType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogCellTowerNotification=ogCellTowerNotification, ogCellModemIMSI=ogCellModemIMSI, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApInterface=ogWifiApInterface, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModem4gRssi=ogCellModem4gRssi, ogCellSignalNotification=ogCellSignalNotification, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApTable=ogWifiApTable, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemConnected=ogCellModemConnected, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserName=ogHostUserName, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserStartTime=ogWebUserStartTime, ogAlarmDevice=ogAlarmDevice, ogSerialUserPort=ogSerialUserPort, ogEmdTable=ogEmdTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioNotification=ogEmdDioNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsEntry=ogUpsEntry, ogSerialUserTable=ogSerialUserTable, ogRpcInputVoltage=ogRpcInputVoltage, ogStatus2=ogStatus2, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmEventId=ogAlarmEventId, ogCellModemNetwork=ogCellModemNetwork)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioName=ogEmdDioName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletState=ogRpcOutletState, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortMode=ogSerialPortMode, ogCellModemTemperature=ogCellModemTemperature, ogWifiApSsid=ogWifiApSsid, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsDescription=ogUpsDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckIndex=ogCheckIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogHostPingNotification=ogHostPingNotification, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServicePort=ogHostServicePort, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortDSR=ogSerialPortDSR, ogUpsNotification=ogUpsNotification, ogUpsIndex=ogUpsIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioDescription=ogEmdDioDescription, ogAlarmName=ogAlarmName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApCounter=ogWifiApCounter, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputVoltage=ogUpsInputVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcEntry=ogRpcEntry, ogHostTable=ogHostTable, ogEmdDioType=ogEmdDioType, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmInstance=ogAlarmInstance, ogEmdDioIndex=ogEmdDioIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortCTS=ogSerialPortCTS, ogAlarmState=ogAlarmState)
