...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceName=ogNetInterfaceName, ogSerialPortIndex=ogSerialPortIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceRef=ogCheckDeviceRef, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmName=ogAlarmName, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioName=ogEmdDioName, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioCounter=ogEmdDioCounter, ogHostServiceType=ogHostServiceType, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioEntry=ogEmdDioEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortCTS=ogSerialPortCTS, ogAlarmInstance=ogAlarmInstance, ogSerialUserTable=ogSerialUserTable, ogCellModemApn=ogCellModemApn, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDescription=ogEmdDescription, ogSerialPortParity=ogSerialPortParity, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserEntry=ogWebUserEntry, ogEmdEnabled=ogEmdEnabled, ogWifiApCounter=ogWifiApCounter, ogWebUserName=ogWebUserName, ogHostUserEntry=ogHostUserEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellDataNotification=ogCellDataNotification, ogCellModemRegistered=ogCellModemRegistered, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioTable=ogEmdDioTable, ogRpcOutletName=ogRpcOutletName, ogUpsEntry=ogUpsEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioState=ogEmdDioState, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmType=ogAlarmType, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemIndex=ogCellModemIndex, ogUpsType=ogUpsType, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsIndex=ogUpsIndex, ogEmdIndex=ogEmdIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostIpV6Address=ogHostIpV6Address, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryState=ogUpsBatteryState, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityValue=ogEmdHumidityValue, ogCustomNotification=ogCustomNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientEntry=ogWifiClientEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdTable=ogEmdTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcName=ogRpcName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostIndex=ogHostIndex, ogHostServiceEntry=ogHostServiceEntry, ogHostName=ogHostName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckResolveActions=ogCheckResolveActions, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdEntry=ogEmdEntry, ogWifiClientIndex=ogWifiClientIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsNotification=ogUpsNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcInputNotification=ogRpcInputNotification, ogUpsName=ogUpsName, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceHost=ogHostServiceHost, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmState=ogAlarmState, ogHostIpV4Address=ogHostIpV4Address, ogCheckIndex=ogCheckIndex, ogStatus2Compliances=ogStatus2Compliances, ogUpsCounter=ogUpsCounter, ogEmdName=ogEmdName, ogUpsLogEnabled=ogUpsLogEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckDeviceName=ogCheckDeviceName, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApEnabled=ogWifiApEnabled, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogFirmwareVersion=ogFirmwareVersion, ogHostEntry=ogHostEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserTable=ogWebUserTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcInputFrequency=ogRpcInputFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWebUserStartTime=ogWebUserStartTime, ogCellApnNotification=ogCellApnNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientApMac=ogWifiClientApMac, ogCellModemVendor=ogCellModemVendor, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemEnabled=ogCellModemEnabled, ogCheckTable=ogCheckTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostUserName=ogHostUserName, ogCellModemNetwork=ogCellModemNetwork, ogAlarmUser=ogAlarmUser, ogCheckName=ogCheckName, ogAlarm=ogAlarm, ogWifiApClientIndex=ogWifiApClientIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserIndex=ogHostUserIndex, ogCellModemTower=ogCellModemTower, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogStatus2Conformance=ogStatus2Conformance, ogHostUserTable=ogHostUserTable, ogWifiClientCounter=ogWifiClientCounter, ogHostUserNotification=ogHostUserNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcDescription=ogRpcDescription, ogUpsHumidity=ogUpsHumidity, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmCheck=ogAlarmCheck, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcCounter=ogRpcCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogStatus2=ogStatus2, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmTime=ogAlarmTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcType=ogRpcType, ogWebUserNotification=ogWebUserNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApTxPower=ogWifiApTxPower, ogCheckDeviceIndex=ogCheckDeviceIndex, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsConnectType=ogUpsConnectType, ogSerialPortTable=ogSerialPortTable, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserPort=ogSerialUserPort, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServicePort=ogHostServicePort, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsInputNotification=ogUpsInputNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostPingNotification=ogHostPingNotification, ogWifiClientMode=ogWifiClientMode, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApTable=ogWifiApTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientMac=ogWifiApClientMac, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioType=ogEmdDioType, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsTable=ogUpsTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialUserLabel=ogSerialUserLabel, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Groups=ogStatus2Groups, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckEntry=ogCheckEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsDescription=ogUpsDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogMibNotifications=ogMibNotifications, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletNotification=ogRpcOutletNotification, ogHostTable=ogHostTable, ogEmdConnectType=ogEmdConnectType, ogWifiApSsid=ogWifiApSsid, ogSerialNumber=ogSerialNumber, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcEntry=ogRpcEntry, ogSerialPortMode=ogSerialPortMode, ogWifiClientEssid=ogWifiClientEssid, ogSystem=ogSystem, ogWifiClientRssi=ogWifiClientRssi, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyName=ogPowerSupplyName, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcIndex=ogRpcIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostUserHost=ogHostUserHost, ogSerialUserName=ogSerialUserName, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogStatus2Compliance=ogStatus2Compliance, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcConnectType=ogRpcConnectType, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserEntry=ogSerialUserEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemTable=ogCellModemTable, ogCheckType=ogCheckType, ogRpcTable=ogRpcTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemTemperature=ogCellModemTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemModel=ogCellModemModel, ogWifiApIndex=ogWifiApIndex, ogCellModemEntry=ogCellModemEntry, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmSummary=ogAlarmSummary, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsState=ogUpsState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmEventId=ogAlarmEventId, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostServiceTable=ogHostServiceTable, ogWifiClientTable=ogWifiClientTable)
