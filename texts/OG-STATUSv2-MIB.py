...
TimeTicks, Counter32, Integer32, MibIdentifier, Bits, Gauge32, IpAddress, ObjectIdentity, ModuleIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Integer32", "MibIdentifier", "Bits", "Gauge32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcInputNotification=ogRpcInputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2Compliance=ogStatus2Compliance, ogAlarmInstance=ogAlarmInstance, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioName=ogEmdDioName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientMode=ogWifiClientMode, ogHostUserNotification=ogHostUserNotification, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDescription=ogEmdDescription, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServiceNotification=ogHostServiceNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemTable=ogCellModemTable, ogSerialUserTable=ogSerialUserTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientEntry=ogWifiClientEntry, ogCellTowerNotification=ogCellTowerNotification, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApTable=ogWifiApTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWebUserTable=ogWebUserTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortDCD=ogSerialPortDCD, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogStatus2=ogStatus2, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserHostName=ogHostUserHostName, ogWifiApCounter=ogWifiApCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsEntry=ogUpsEntry, ogSerialPortIndex=ogSerialPortIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletName=ogRpcOutletName, ogCellApnNotification=ogCellApnNotification, ogUpsHumidity=ogUpsHumidity, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemIndex=ogCellModemIndex, ogAlarmName=ogAlarmName, ogHostUserName=ogHostUserName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcType=ogRpcType, ogCellModemTemperature=ogCellModemTemperature, ogWebUserName=ogWebUserName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientTable=ogWifiClientTable, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcTable=ogRpcTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortTable=ogSerialPortTable, ogUpsIndex=ogUpsIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApEnabled=ogWifiApEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsDescription=ogUpsDescription, ogWebUserNotification=ogWebUserNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApTxPower=ogWifiApTxPower, ogUpsName=ogUpsName, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientEssid=ogWifiClientEssid, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemTower=ogCellModemTower, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemEnabled=ogCellModemEnabled, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdEntry=ogEmdEntry, ogWebUserEntry=ogWebUserEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsState=ogUpsState, ogHostServiceHost=ogHostServiceHost, ogCheckIndex=ogCheckIndex, ogHostName=ogHostName, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioTable=ogEmdDioTable, ogHostServicePort=ogHostServicePort, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioIndex=ogEmdDioIndex, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmLogTable=ogAlarmLogTable, ogCellDataNotification=ogCellDataNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmTime=ogAlarmTime, ogSerialUserLabel=ogSerialUserLabel, ogUpsType=ogUpsType, ogWifiClientInterface=ogWifiClientInterface, ogUpsConnectType=ogUpsConnectType, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcName=ogRpcName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcConnectType=ogRpcConnectType, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckTable=ogCheckTable, ogStatus2Groups=ogStatus2Groups, ogUpsOutputLoad=ogUpsOutputLoad, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceStatus=ogHostServiceStatus, ogMibNotifications=ogMibNotifications, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemEntry=ogCellModemEntry, ogSerialPortRTS=ogSerialPortRTS, ogHostUserEntry=ogHostUserEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputPower=ogUpsOutputPower, ogHostTable=ogHostTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserEntry=ogSerialUserEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogWebUserIndex=ogWebUserIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcEntry=ogRpcEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTable=ogEmdTable, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemConnected=ogCellModemConnected, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialUserNotification=ogSerialUserNotification, ogWebUserStartTime=ogWebUserStartTime, ogHostIndex=ogHostIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserIndex=ogHostUserIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortDTR=ogSerialPortDTR, ogRpcIndex=ogRpcIndex, ogSerialPortParity=ogSerialPortParity, ogHostServiceType=ogHostServiceType, ogNetInterfaceName=ogNetInterfaceName, ogWifiApIndex=ogWifiApIndex, ogCellModemNetwork=ogCellModemNetwork, ogSerialUserName=ogSerialUserName, ogCellModemIMSI=ogCellModemIMSI, ogCellSignalNotification=ogCellSignalNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmDevice=ogAlarmDevice, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioType=ogEmdDioType, ogAlarmUser=ogAlarmUser, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputNotification=ogUpsOutputNotification, ogCustomNotification=ogCustomNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioCounter=ogEmdDioCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserPort=ogSerialUserPort, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogSystem=ogSystem, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdIndex=ogEmdIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemModel=ogCellModemModel, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostPingNotification=ogHostPingNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialNumber=ogSerialNumber, ogEmdDioState=ogEmdDioState, ogAlarmState=ogAlarmState, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarm=ogAlarm, ogSerialPortMode=ogSerialPortMode, ogRpcOutletFrequency=ogRpcOutletFrequency)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortEntry=ogSerialPortEntry, ogHostUserHost=ogHostUserHost, ogRpcCounter=ogRpcCounter, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckName=ogCheckName, ogUpsTable=ogUpsTable, ogEmdDioEntry=ogEmdDioEntry, ogCheckDeviceName=ogCheckDeviceName, ogEmdConnectType=ogEmdConnectType, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientTable=ogWifiApClientTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientRssi=ogWifiClientRssi, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserTable=ogHostUserTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyName=ogPowerSupplyName, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApEntry=ogWifiApEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostIpV4Address=ogHostIpV4Address, ogHostUserStartTime=ogHostUserStartTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdEnabled=ogEmdEnabled, ogEmdName=ogEmdName, ogWifiApSsid=ogWifiApSsid, ogUpsCounter=ogUpsCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostEntry=ogHostEntry, ogEmdDioEmd=ogEmdDioEmd, ogRpcDescription=ogRpcDescription, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceType=ogNetInterfaceType, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryState=ogUpsBatteryState, ogAlarmSummary=ogAlarmSummary, ogUpsNotification=ogUpsNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutletState=ogRpcOutletState, ogCellModemApn=ogCellModemApn, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckType=ogCheckType, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmType=ogAlarmType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientApMac=ogWifiClientApMac, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckEntry=ogCheckEntry)
