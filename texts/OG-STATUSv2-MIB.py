...
NotificationType, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Counter32, Gauge32, MibIdentifier, Bits, Integer32, Counter64, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Counter32", "Gauge32", "MibIdentifier", "Bits", "Integer32", "Counter64", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletState=ogRpcOutletState, ogSerialPortDSR=ogSerialPortDSR, ogCheckResolveActions=ogCheckResolveActions, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApFrequency=ogWifiApFrequency, ogWebUserNotification=ogWebUserNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApTxPower=ogWifiApTxPower, ogRpcEntry=ogRpcEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputPower=ogUpsOutputPower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemIMSI=ogCellModemIMSI, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSystem=ogSystem, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioState=ogEmdDioState, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmType=ogAlarmType, ogWifiClientEssid=ogWifiClientEssid, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletTotal=ogRpcOutletTotal, ogHostUserTable=ogHostUserTable, ogUpsDescription=ogUpsDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserEntry=ogWebUserEntry, ogCellModemConnected=ogCellModemConnected, ogHostTable=ogHostTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceHost=ogHostServiceHost, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceType=ogHostServiceType, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemEntry=ogCellModemEntry, ogRpcIndex=ogRpcIndex, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostServiceStatus=ogHostServiceStatus, ogAlarmState=ogAlarmState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioTable=ogEmdDioTable, ogSerialPortMode=ogSerialPortMode, ogRpcInputVoltage=ogRpcInputVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientApMac=ogWifiClientApMac, ogCellModemSessionTime=ogCellModemSessionTime, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserIndex=ogWebUserIndex, ogCellModemModel=ogCellModemModel, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmName=ogAlarmName, ogStatus2Conformance=ogStatus2Conformance, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceTable=ogHostServiceTable, ogRpcConnectType=ogRpcConnectType, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostName=ogHostName, ogHostServicePort=ogHostServicePort, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemTable=ogCellModemTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsTable=ogUpsTable, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioCounter=ogEmdDioCounter, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsHumidity=ogUpsHumidity, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcDescription=ogRpcDescription, ogCellModemApn=ogCellModemApn, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemRegistered=ogCellModemRegistered, ogUpsIndex=ogUpsIndex, ogWifiApSsid=ogWifiApSsid, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApEnabled=ogWifiApEnabled, ogCheckType=ogCheckType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemVendor=ogCellModemVendor, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsTemperature=ogUpsTemperature, ogCellModemEnabled=ogCellModemEnabled, ogWifiApInterface=ogWifiApInterface, ogSerialUserEntry=ogSerialUserEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientMode=ogWifiClientMode, ogCheckTable=ogCheckTable, ogUpsConnectType=ogUpsConnectType, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioType=ogEmdDioType, ogSerialUserLabel=ogSerialUserLabel, ogCellModemTower=ogCellModemTower, ogFirmwareVersion=ogFirmwareVersion, ogAlarmLogEntry=ogAlarmLogEntry, ogNetInterfaceName=ogNetInterfaceName, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogStatus2Compliances=ogStatus2Compliances, ogCellTowerNotification=ogCellTowerNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserAddress=ogHostUserAddress, ogStatus2=ogStatus2, ogUpsEntry=ogUpsEntry, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserName=ogSerialUserName, ogNetInterfaceType=ogNetInterfaceType, ogCheckEntry=ogCheckEntry, ogRpcInputNotification=ogRpcInputNotification, ogHostIpV6Address=ogHostIpV6Address, ogRpcCounter=ogRpcCounter, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialUserPort=ogSerialUserPort, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarm=ogAlarm, ogRpcName=ogRpcName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientTable=ogWifiClientTable, ogHostServiceIndex=ogHostServiceIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmCheck=ogAlarmCheck, ogWebUserName=ogWebUserName, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmDevice=ogAlarmDevice, ogAlarmSummary=ogAlarmSummary, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientEntry=ogWifiClientEntry, ogHostUserNotification=ogHostUserNotification, ogWifiApTable=ogWifiApTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortRTS=ogSerialPortRTS, ogUpsName=ogUpsName, ogCustomNotification=ogCustomNotification, ogAlarmEventId=ogAlarmEventId, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserTable=ogSerialUserTable, ogHostUserIndex=ogHostUserIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostPingNotification=ogHostPingNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmUser=ogAlarmUser, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsState=ogUpsState, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsNotification=ogUpsNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserName=ogHostUserName, ogEmdName=ogEmdName, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogMibNotifications=ogMibNotifications, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckIndex=ogCheckIndex, ogStatus2Compliance=ogStatus2Compliance, ogHostUserEntry=ogHostUserEntry, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortTable=ogSerialPortTable, ogHostIndex=ogHostIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostEntry=ogHostEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmTime=ogAlarmTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDescription=ogEmdDescription, ogUpsInputFrequency=ogUpsInputFrequency, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioEmd=ogEmdDioEmd, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckName=ogCheckName, ogCellModemIndex=ogCellModemIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortCTS=ogSerialPortCTS, ogWifiApIndex=ogWifiApIndex, ogUpsCounter=ogUpsCounter, ogEmdTable=ogEmdTable, ogAlarmLogIndex=ogAlarmLogIndex, ogHostUserHost=ogHostUserHost, ogCellApnNotification=ogCellApnNotification, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdConnectType=ogEmdConnectType, ogEmdDioName=ogEmdDioName, ogWifiApCounter=ogWifiApCounter, ogUpsType=ogUpsType, ogRpcType=ogRpcType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialNumber=ogSerialNumber, ogEmdIndex=ogEmdIndex, ogRpcOutletName=ogRpcOutletName, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWebUserTable=ogWebUserTable, ogSerialPortParity=ogSerialPortParity, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityName=ogEmdHumidityName, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcTable=ogRpcTable, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdEntry=ogEmdEntry, ogHostServiceEntry=ogHostServiceEntry, PYSNMP_MODULE_ID=ogStatus2, ogAlarmLogTable=ogAlarmLogTable, ogRpcInputFrequency=ogRpcInputFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature)
