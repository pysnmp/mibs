...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsDescription=ogUpsDescription, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortEntry=ogSerialPortEntry, ogCellModemIndex=ogCellModemIndex, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApTable=ogWifiApTable, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortIndex=ogSerialPortIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioEmd=ogEmdDioEmd, ogUpsState=ogUpsState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDescription=ogEmdDescription, ogWifiApFrequency=ogWifiApFrequency, ogEmdIndex=ogEmdIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmState=ogCurrentAlarmState, ogMibNotifications=ogMibNotifications, ogWifiClientApMac=ogWifiClientApMac, ogAlarmEventId=ogAlarmEventId, ogUpsCounter=ogUpsCounter, ogStatus2Conformance=ogStatus2Conformance, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogHostPingNotification=ogHostPingNotification, ogHostServiceEntry=ogHostServiceEntry, ogRpcType=ogRpcType, ogCheckTriggerActions=ogCheckTriggerActions, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioEntry=ogEmdDioEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckTable=ogCheckTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcTable=ogRpcTable, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsIndex=ogUpsIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemConnected=ogCellModemConnected, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceName=ogCheckDeviceName, ogRpcIndex=ogRpcIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserEntry=ogSerialUserEntry, ogCellModemApn=ogCellModemApn, ogCellModemModel=ogCellModemModel, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioIndex=ogEmdDioIndex, ogCellModemTower=ogCellModemTower, ogHostServicePort=ogHostServicePort, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceNotification=ogHostServiceNotification, ogCellSignalNotification=ogCellSignalNotification, ogHostServiceHost=ogHostServiceHost, ogRpcOutletState=ogRpcOutletState, ogWebUserSourcePort=ogWebUserSourcePort, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioType=ogEmdDioType, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcCounter=ogRpcCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserTable=ogSerialUserTable, ogSerialUserLabel=ogSerialUserLabel, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmLogTable=ogAlarmLogTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortStopBits=ogSerialPortStopBits, ogHostServiceCounter=ogHostServiceCounter, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserTable=ogWebUserTable, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortDSR=ogSerialPortDSR, ogAlarmName=ogAlarmName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckName=ogCheckName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemTable=ogCellModemTable, ogRpcInputNotification=ogRpcInputNotification, ogEmdName=ogEmdName, ogAlarmSummary=ogAlarmSummary, ogEmdEnabled=ogEmdEnabled, ogAlarmInstance=ogAlarmInstance, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemRegistered=ogCellModemRegistered, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserEntry=ogWebUserEntry, ogUpsTable=ogUpsTable, ogHostUserNotification=ogHostUserNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientEntry=ogWifiClientEntry, ogEmdConnectType=ogEmdConnectType, ogCellDataNotification=ogCellDataNotification, ogUpsHumidity=ogUpsHumidity, ogHostIpV6Address=ogHostIpV6Address, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostIndex=ogHostIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApClientTable=ogWifiApClientTable, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCustomNotification=ogCustomNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostTable=ogHostTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostIpV4Address=ogHostIpV4Address, ogHostUserTable=ogHostUserTable, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApIndex=ogWifiApIndex, ogWifiApEntry=ogWifiApEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserStartTime=ogSerialUserStartTime, ogHostUserHostName=ogHostUserHostName, ogHostUserAddress=ogHostUserAddress, ogCellModemEntry=ogCellModemEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogHostServiceTable=ogHostServiceTable, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmType=ogAlarmType, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientEssid=ogWifiClientEssid, ogSerialNumber=ogSerialNumber, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientTable=ogWifiClientTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserName=ogHostUserName, ogSerialPortTable=ogSerialPortTable, ogAlarmUser=ogAlarmUser, ogSerialPortRxBytes=ogSerialPortRxBytes, ogStatus2=ogStatus2, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsEntry=ogUpsEntry, ogPowerSupplyName=ogPowerSupplyName, ogCellModemVendor=ogCellModemVendor, ogUpsName=ogUpsName, ogCheckType=ogCheckType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTable=ogEmdTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApInterface=ogWifiApInterface, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioName=ogEmdDioName, ogSerialUserName=ogSerialUserName, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortMode=ogSerialPortMode, ogWifiApCounter=ogWifiApCounter, ogAlarm=ogAlarm, ogEmdDioState=ogEmdDioState, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceType=ogHostServiceType, ogUpsType=ogUpsType, ogEmdDioDescription=ogEmdDioDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWebUserNotification=ogWebUserNotification, ogCheckEntry=ogCheckEntry, ogAlarmState=ogAlarmState, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserEntry=ogHostUserEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostServiceIndex=ogHostServiceIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcName=ogRpcName, ogCellApnNotification=ogCellApnNotification, ogAlarmTime=ogAlarmTime, ogCellModem4gRssi=ogCellModem4gRssi, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientTxPower=ogWifiClientTxPower)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioTable=ogEmdDioTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2Compliance=ogStatus2Compliance, ogSystem=ogSystem, ogWifiClientMode=ogWifiClientMode, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApSsid=ogWifiApSsid, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmDevice=ogAlarmDevice, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogBasicStatusGroup=ogBasicStatusGroup, ogStatus2Compliances=ogStatus2Compliances, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemNetwork=ogCellModemNetwork, ogRpcConnectType=ogRpcConnectType, ogEmdEntry=ogEmdEntry, ogCheckIndex=ogCheckIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogStatus2Groups=ogStatus2Groups, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureName=ogEmdTemperatureName, ogHostName=ogHostName, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientAp=ogWifiApClientAp, ogWifiApEnabled=ogWifiApEnabled, ogWifiApTxPower=ogWifiApTxPower, ogRpcInputCurrent=ogRpcInputCurrent, ogCellTowerNotification=ogCellTowerNotification, ogHostEntry=ogHostEntry, PYSNMP_MODULE_ID=ogStatus2, ogRpcEntry=ogRpcEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryState=ogUpsBatteryState, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsNotification=ogUpsNotification, ogWebUserName=ogWebUserName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcDescription=ogRpcDescription, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsTemperature=ogUpsTemperature, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserHost=ogHostUserHost, ogCurrentAlarmTime=ogCurrentAlarmTime)
