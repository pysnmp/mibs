...
IpAddress, ModuleIdentity, Counter32, Bits, TimeTicks, Gauge32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, iso, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Counter32", "Bits", "TimeTicks", "Gauge32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "iso", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputPower=ogUpsOutputPower, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioName=ogEmdDioName, ogWifiApClientAp=ogWifiApClientAp, ogCellModemVendor=ogCellModemVendor, ogAlarmName=ogAlarmName, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortDataBits=ogSerialPortDataBits, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortLabel=ogSerialPortLabel, ogCheckEntry=ogCheckEntry, ogUpsHumidity=ogUpsHumidity, ogEmdDioEntry=ogEmdDioEntry, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdName=ogEmdName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostEntry=ogHostEntry, ogRpcTable=ogRpcTable, ogCheckResetTimeout=ogCheckResetTimeout, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserHost=ogHostUserHost, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletName=ogRpcOutletName, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserPort=ogSerialUserPort, ogHostTable=ogHostTable, ogUpsTable=ogUpsTable, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdEntry=ogEmdEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemTower=ogCellModemTower, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellNetworkNotification=ogCellNetworkNotification, ogCellTowerNotification=ogCellTowerNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemNetwork=ogCellModemNetwork, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceState=ogNetInterfaceState, ogUpsInputNotification=ogUpsInputNotification, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsNotification=ogUpsNotification, ogEmdIndex=ogEmdIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyName=ogPowerSupplyName, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2Groups=ogStatus2Groups, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmInstance=ogAlarmInstance, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioState=ogEmdDioState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientMode=ogWifiClientMode, ogWebUserTable=ogWebUserTable, ogCellModemTemperature=ogCellModemTemperature, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmName=ogCurrentAlarmName, ogMibNotifications=ogMibNotifications, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserAddress=ogHostUserAddress, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemIndex=ogCellModemIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsDescription=ogUpsDescription, ogAlarmUser=ogAlarmUser, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceName=ogNetInterfaceName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcIndex=ogRpcIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckType=ogCheckType, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsName=ogUpsName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsCounter=ogUpsCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcConnectType=ogRpcConnectType, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckName=ogCheckName, ogHostUserEntry=ogHostUserEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostUserIndex=ogHostUserIndex, ogUpsType=ogUpsType, ogEmdConnectType=ogEmdConnectType, ogSerialUserEntry=ogSerialUserEntry, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApIndex=ogWifiApIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckIndex=ogCheckIndex, ogHostServicePort=ogHostServicePort, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryState=ogUpsBatteryState, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcDescription=ogRpcDescription, ogHostUserNotification=ogHostUserNotification, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceName=ogCheckDeviceName, ogCellModemEntry=ogCellModemEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientRssi=ogWifiClientRssi, ogUpsConnectType=ogUpsConnectType, ogHostName=ogHostName, ogCellModemTable=ogCellModemTable, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsState=ogUpsState, ogWifiApTxPower=ogWifiApTxPower, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserName=ogHostUserName, ogRpcType=ogRpcType, ogCellModemModel=ogCellModemModel, ogWifiApClientTable=ogWifiApClientTable, ogCellMessageNotification=ogCellMessageNotification, ogHostIndex=ogHostIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTable=ogEmdTable, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarm=ogAlarm, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientApMac=ogWifiClientApMac, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletState=ogRpcOutletState, ogCellModemIMSI=ogCellModemIMSI, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortDSR=ogSerialPortDSR, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcCounter=ogRpcCounter, ogEmdDioIndex=ogEmdDioIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDescription=ogEmdDescription, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2Compliance=ogStatus2Compliance, ogAlarmTime=ogAlarmTime, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApTable=ogWifiApTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmState=ogAlarmState, ogEmdDioType=ogEmdDioType, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmDevice=ogAlarmDevice, ogUpsEntry=ogUpsEntry, ogWifiApCounter=ogWifiApCounter, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientMac=ogWifiApClientMac, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellSignalNotification=ogCellSignalNotification, ogHostIpV6Address=ogHostIpV6Address, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsTemperature=ogUpsTemperature, ogHostServiceCounter=ogHostServiceCounter, ogCellDataNotification=ogCellDataNotification, ogCellModemCounter=ogCellModemCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientTable=ogWifiClientTable, ogSerialPortParity=ogSerialPortParity, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcName=ogRpcName, ogCellModemApn=ogCellModemApn, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortDCD=ogSerialPortDCD, ogStatus2=ogStatus2, ogWebUserEntry=ogWebUserEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCustomNotification=ogCustomNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserNotification=ogWebUserNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmSummary=ogAlarmSummary, ogSystem=ogSystem, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceType=ogHostServiceType, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApFrequency=ogWifiApFrequency, ogHostServiceIndex=ogHostServiceIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserName=ogWebUserName, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientCounter=ogWifiClientCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserTable=ogHostUserTable, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWebUserStartTime=ogWebUserStartTime, ogHostPingNotification=ogHostPingNotification, ogRpcEntry=ogRpcEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmType=ogAlarmType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserIndex=ogWebUserIndex, ogUpsIndex=ogUpsIndex, ogCheckTable=ogCheckTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserName=ogSerialUserName, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceHost=ogHostServiceHost, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioTable=ogEmdDioTable, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, PYSNMP_MODULE_ID=ogStatus2, ogWifiApSsid=ogWifiApSsid, ogWifiApInterface=ogWifiApInterface, ogHostIpV4Address=ogHostIpV4Address, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialNumber=ogSerialNumber, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmType=ogCurrentAlarmType)
