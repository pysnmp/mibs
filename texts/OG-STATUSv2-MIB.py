...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortMode=ogSerialPortMode, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityDescription=ogEmdHumidityDescription, ogNetInterfaceName=ogNetInterfaceName, ogNetInterfaceTable=ogNetInterfaceTable, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletState=ogRpcOutletState, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApFrequency=ogWifiApFrequency, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserPort=ogSerialUserPort, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcTable=ogRpcTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserName=ogSerialUserName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDescription=ogEmdDescription, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortDSR=ogSerialPortDSR, ogUpsEntry=ogUpsEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmState=ogAlarmState, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsInputNotification=ogUpsInputNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcIndex=ogRpcIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemApn=ogCellModemApn, ogStatus2=ogStatus2, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogMibNotifications=ogMibNotifications, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckTable=ogCheckTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckEntry=ogCheckEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryState=ogUpsBatteryState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceType=ogHostServiceType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsCounter=ogUpsCounter, ogSerialUserStartTime=ogSerialUserStartTime, ogHostIndex=ogHostIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientApMac=ogWifiClientApMac, ogAlarmEventId=ogAlarmEventId, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogSystem=ogSystem, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcInputNotification=ogRpcInputNotification, ogWebUserEntry=ogWebUserEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogCellMessageNotification=ogCellMessageNotification, ogAlarmCheck=ogAlarmCheck, ogHostTable=ogHostTable, ogCellApnNotification=ogCellApnNotification, ogSerialNumber=ogSerialNumber, ogEmdDioEntry=ogEmdDioEntry, ogUpsTable=ogUpsTable, ogCellModemCounter=ogCellModemCounter, ogWifiClientTable=ogWifiClientTable, ogHostUserName=ogHostUserName, ogHostServiceTable=ogHostServiceTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApIndex=ogWifiApIndex, ogEmdName=ogEmdName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioState=ogEmdDioState, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsState=ogUpsState, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostServiceEntry=ogHostServiceEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTable=ogEmdTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApSsid=ogWifiApSsid, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemModel=ogCellModemModel, ogSerialUserEntry=ogSerialUserEntry, ogCheckIndex=ogCheckIndex, ogCheckDeviceName=ogCheckDeviceName, ogCustomNotification=ogCustomNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostServiceHost=ogHostServiceHost, ogAlarm=ogAlarm, ogEmdEntry=ogEmdEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcConnectType=ogRpcConnectType, ogCheckType=ogCheckType, ogRpcOutletName=ogRpcOutletName, ogRpcName=ogRpcName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemIndex=ogCellModemIndex, ogWifiApClientAp=ogWifiApClientAp, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcType=ogRpcType, ogHostUserIndex=ogHostUserIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmType=ogAlarmType, ogRpcCounter=ogRpcCounter, ogHostIpV4Address=ogHostIpV4Address, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserSourcePort=ogWebUserSourcePort, ogHostEntry=ogHostEntry, ogAlarmUser=ogAlarmUser, ogHostServiceCounter=ogHostServiceCounter, ogAlarmLogTable=ogAlarmLogTable, ogUpsTemperature=ogUpsTemperature, ogUpsIndex=ogUpsIndex, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostUserNotification=ogHostUserNotification, ogCellTowerNotification=ogCellTowerNotification, PYSNMP_MODULE_ID=ogStatus2, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogFirmwareVersion=ogFirmwareVersion, ogCellModemRegistered=ogCellModemRegistered, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApTable=ogWifiApTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckName=ogCheckName, ogUpsHumidity=ogUpsHumidity, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsDescription=ogUpsDescription, ogSerialPortParity=ogSerialPortParity, ogWebUserIndex=ogWebUserIndex, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdIndex=ogEmdIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioIndex=ogEmdDioIndex, ogCellModemEntry=ogCellModemEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserNotification=ogSerialUserNotification, ogRpcEntry=ogRpcEntry, ogHostUserEntry=ogHostUserEntry, ogSerialUserTable=ogSerialUserTable, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserHost=ogHostUserHost, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApInterface=ogWifiApInterface, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientEntry=ogWifiClientEntry, ogCellModemTable=ogCellModemTable, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientMode=ogWifiClientMode, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserStartTime=ogWebUserStartTime, ogAlarmTime=ogAlarmTime, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdConnectType=ogEmdConnectType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyName=ogPowerSupplyName, ogHostPingNotification=ogHostPingNotification, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletIndex=ogRpcOutletIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioDescription=ogEmdDioDescription, ogCellModemNetwork=ogCellModemNetwork, ogWifiApCounter=ogWifiApCounter, ogWifiClientCounter=ogWifiClientCounter, ogEmdEnabled=ogEmdEnabled, ogWebUserTable=ogWebUserTable, ogUpsOutputPower=ogUpsOutputPower)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceIndex=ogHostServiceIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmDevice=ogAlarmDevice, ogNetInterfaceType=ogNetInterfaceType, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioDirection=ogEmdDioDirection, ogCellModemIMSI=ogCellModemIMSI, ogHostName=ogHostName, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2Groups=ogStatus2Groups, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientFrequency=ogWifiClientFrequency, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsName=ogUpsName, ogWebUserName=ogWebUserName, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletTable=ogRpcOutletTable, ogCellModemTower=ogCellModemTower, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsConnectType=ogUpsConnectType, ogCellDataNotification=ogCellDataNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsNotification=ogUpsNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServicePort=ogHostServicePort, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientMac=ogWifiApClientMac, ogAlarmName=ogAlarmName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApEntry=ogWifiApEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogStatus2Conformance=ogStatus2Conformance, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserHostName=ogHostUserHostName, ogUpsType=ogUpsType, ogRpcDescription=ogRpcDescription, ogHostUserTable=ogHostUserTable, ogEmdDioName=ogEmdDioName, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemConnected=ogCellModemConnected, ogEmdDioType=ogEmdDioType, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioEmd=ogEmdDioEmd)
