...
Integer32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Unsigned32, TimeTicks, ObjectIdentity, MibIdentifier, IpAddress, iso, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Unsigned32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "IpAddress", "iso", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsEntry=ogUpsEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcDescription=ogRpcDescription, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogStatus2=ogStatus2, ogEmdName=ogEmdName, ogWifiClientIndex=ogWifiClientIndex, ogHostUserHost=ogHostUserHost, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmCheck=ogAlarmCheck, ogHostUserIndex=ogHostUserIndex, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioType=ogEmdDioType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioEmd=ogEmdDioEmd, ogHostIndex=ogHostIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmUser=ogAlarmUser, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientMode=ogWifiClientMode, ogHostUserStartTime=ogHostUserStartTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialNumber=ogSerialNumber, ogCellTowerNotification=ogCellTowerNotification, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsInputVoltage=ogUpsInputVoltage, ogWebUserNotification=ogWebUserNotification, ogCellModemIndex=ogCellModemIndex, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioEntry=ogEmdDioEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServicePort=ogHostServicePort, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientMac=ogWifiApClientMac, ogAlarmInstance=ogAlarmInstance, ogWifiApFrequency=ogWifiApFrequency, ogUpsIndex=ogUpsIndex, ogEmdDioDirection=ogEmdDioDirection, ogUpsTable=ogUpsTable, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdConnectType=ogEmdConnectType, ogSerialPortLabel=ogSerialPortLabel, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsNotification=ogUpsNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemConnected=ogCellModemConnected, ogWifiApTxPower=ogWifiApTxPower, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserName=ogHostUserName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientEssid=ogWifiClientEssid, ogCellDataNotification=ogCellDataNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarm=ogAlarm, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmDevice=ogAlarmDevice, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioNotification=ogEmdDioNotification, ogStatus2Groups=ogStatus2Groups, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioName=ogEmdDioName, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsLogEnabled=ogUpsLogEnabled, ogCustomNotification=ogCustomNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsName=ogUpsName, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortTable=ogSerialPortTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialUserNotification=ogSerialUserNotification, ogWifiApInterface=ogWifiApInterface, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortEntry=ogSerialPortEntry, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckType=ogCheckType, ogCellSignalNotification=ogCellSignalNotification, ogCellModemVendor=ogCellModemVendor, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortRTS=ogSerialPortRTS, ogWifiApEntry=ogWifiApEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckEntry=ogCheckEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmName=ogAlarmName, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletLoad=ogRpcOutletLoad, ogSystem=ogSystem, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortIndex=ogSerialPortIndex, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogMibNotifications=ogMibNotifications, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdIndex=ogEmdIndex, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsCounter=ogUpsCounter, ogCellModemCounter=ogCellModemCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsHumidity=ogUpsHumidity, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostEntry=ogHostEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientApMac=ogWifiClientApMac, ogHostPingNotification=ogHostPingNotification, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityTable=ogEmdHumidityTable, ogStatus2Compliances=ogStatus2Compliances, ogAlarmType=ogAlarmType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsState=ogUpsState, ogCellModemApn=ogCellModemApn, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWebUserName=ogWebUserName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletName=ogRpcOutletName, ogCheckName=ogCheckName, ogAlarmSummary=ogAlarmSummary, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientRssi=ogWifiClientRssi, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellApnNotification=ogCellApnNotification, ogRpcTable=ogRpcTable, ogCellModemModel=ogCellModemModel, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialUserEntry=ogSerialUserEntry, ogCellModemTower=ogCellModemTower, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmTime=ogAlarmTime, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortDCD=ogSerialPortDCD, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcType=ogRpcType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemRegistered=ogCellModemRegistered, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdEntry=ogEmdEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServiceHost=ogHostServiceHost, ogEmdDioState=ogEmdDioState, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserTable=ogHostUserTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioDescription=ogEmdDioDescription, ogRpcCounter=ogRpcCounter, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemTable=ogCellModemTable, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogNetInterfaceName=ogNetInterfaceName, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceEntry=ogHostServiceEntry, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceNotification=ogHostServiceNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcName=ogRpcName, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceState=ogNetInterfaceState, ogHostServiceCounter=ogHostServiceCounter)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserTable=ogWebUserTable, ogSerialUserPort=ogSerialUserPort, ogWebUserEntry=ogWebUserEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialUserName=ogSerialUserName, ogUpsConnectType=ogUpsConnectType, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTemperature=ogCellModemTemperature, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientEnabled=ogWifiClientEnabled, ogCellMessageNotification=ogCellMessageNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDescription=ogEmdDescription, ogWifiApTable=ogWifiApTable, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTable=ogEmdTable, ogUpsDescription=ogUpsDescription, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserEntry=ogHostUserEntry, ogHostServiceTable=ogHostServiceTable, ogRpcOutletState=ogRpcOutletState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckDeviceName=ogCheckDeviceName, ogRpcIndex=ogRpcIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsType=ogUpsType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceType=ogHostServiceType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmState=ogAlarmState, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckIndex=ogCheckIndex, ogWifiApIndex=ogWifiApIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApCounter=ogWifiApCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemEntry=ogCellModemEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostTable=ogHostTable, ogUpsTemperature=ogUpsTemperature, ogSerialPortParity=ogSerialPortParity, ogWebUserSourceAddress=ogWebUserSourceAddress, ogStatus2Conformance=ogStatus2Conformance, ogSerialPatternNotification=ogSerialPatternNotification, ogHostName=ogHostName, ogWifiApClientTable=ogWifiApClientTable, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserHostName=ogHostUserHostName, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmEventId=ogAlarmEventId, ogCheckTable=ogCheckTable, ogRpcEntry=ogRpcEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletFrequency=ogRpcOutletFrequency)
