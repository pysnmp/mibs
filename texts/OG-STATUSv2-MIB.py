...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostUserTable=ogHostUserTable, ogWifiClientEnabled=ogWifiClientEnabled, ogCellSignalNotification=ogCellSignalNotification, ogNetInterfaceType=ogNetInterfaceType, ogCheckTable=ogCheckTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellMessageNotification=ogCellMessageNotification, ogSerialNumber=ogSerialNumber, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceRef=ogCheckDeviceRef, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogWebUserEntry=ogWebUserEntry, ogEmdDioState=ogEmdDioState, ogCellTowerNotification=ogCellTowerNotification, ogCellModemApn=ogCellModemApn, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortMode=ogSerialPortMode, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckName=ogCheckName, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostEntry=ogHostEntry, ogHostServiceType=ogHostServiceType, ogWifiApIndex=ogWifiApIndex, ogCellModemModel=ogCellModemModel, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioDirection=ogEmdDioDirection, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioEmd=ogEmdDioEmd, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdEnabled=ogEmdEnabled, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemRegistered=ogCellModemRegistered, ogAlarmState=ogAlarmState, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogNetInterfaceState=ogNetInterfaceState, ogCellModemTemperature=ogCellModemTemperature, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemTower=ogCellModemTower, ogEmdEntry=ogEmdEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSystem=ogSystem, ogWifiApSsid=ogWifiApSsid, ogSerialPortParity=ogSerialPortParity, ogStatus2Compliance=ogStatus2Compliance, ogHostIndex=ogHostIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcCounter=ogRpcCounter, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmUser=ogAlarmUser, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsName=ogUpsName, ogHostServiceStatus=ogHostServiceStatus, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientMode=ogWifiClientMode, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmTime=ogAlarmTime, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioEntry=ogEmdDioEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDescription=ogEmdDescription, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortEntry=ogSerialPortEntry, ogAlarmLogTable=ogAlarmLogTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServicePort=ogHostServicePort, ogRpcConnectType=ogRpcConnectType, ogSerialPortLabel=ogSerialPortLabel, ogWifiApFrequency=ogWifiApFrequency, ogAlarmCheck=ogAlarmCheck, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserName=ogWebUserName, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceNotification=ogHostServiceNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckResetTimeout=ogCheckResetTimeout, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioIndex=ogEmdDioIndex, ogCellModemConnected=ogCellModemConnected, ogCellModemEnabled=ogCellModemEnabled, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsType=ogUpsType, ogWifiApInterface=ogWifiApInterface, ogWebUserTable=ogWebUserTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserName=ogHostUserName, ogWifiApTxPower=ogWifiApTxPower, ogCellModemTable=ogCellModemTable, ogWebUserSourcePort=ogWebUserSourcePort, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemCounter=ogCellModemCounter, ogRpcIndex=ogRpcIndex, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellApnNotification=ogCellApnNotification, ogCheckIndex=ogCheckIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortCTS=ogSerialPortCTS, ogUpsTable=ogUpsTable, ogUpsHumidity=ogUpsHumidity, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortIndex=ogSerialPortIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialUserName=ogSerialUserName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcType=ogRpcType, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityName=ogEmdHumidityName, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcEntry=ogRpcEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceIndex=ogHostServiceIndex, ogCellModemIndex=ogCellModemIndex, ogUpsCounter=ogUpsCounter, ogEmdIndex=ogEmdIndex, ogWifiApCounter=ogWifiApCounter, ogUpsDescription=ogUpsDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApTable=ogWifiApTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdName=ogEmdName, ogUpsNotification=ogUpsNotification, ogSerialPortDSR=ogSerialPortDSR, ogAlarmDevice=ogAlarmDevice, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityIndex=ogEmdHumidityIndex, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioTable=ogEmdDioTable, ogHostServiceTable=ogHostServiceTable, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarm=ogAlarm, ogNetInterfaceName=ogNetInterfaceName, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserIndex=ogHostUserIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcDescription=ogRpcDescription, ogRpcLogEnabled=ogRpcLogEnabled, ogHostTable=ogHostTable, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmSummary=ogAlarmSummary, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdConnectType=ogEmdConnectType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientInterface=ogWifiClientInterface, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletName=ogRpcOutletName, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckType=ogCheckType, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmName=ogAlarmName, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityEntry=ogEmdHumidityEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsTemperature=ogUpsTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsState=ogUpsState, ogCheckEntry=ogCheckEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcTable=ogRpcTable, ogEmdTable=ogEmdTable, ogMibNotifications=ogMibNotifications, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2=ogStatus2, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserTable=ogSerialUserTable, ogHostUserStartTime=ogHostUserStartTime, ogAlarmType=ogAlarmType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientApMac=ogWifiClientApMac, ogUpsEntry=ogUpsEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceHost=ogHostServiceHost, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientTable=ogWifiClientTable, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortTable=ogSerialPortTable, ogSerialPortDTR=ogSerialPortDTR, ogRpcName=ogRpcName, ogAlarmInstance=ogAlarmInstance, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcInputNotification=ogRpcInputNotification, ogStatus2Groups=ogStatus2Groups, ogRpcOutletEntry=ogRpcOutletEntry, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCustomNotification=ogCustomNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellDataNotification=ogCellDataNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserNotification=ogHostUserNotification, ogRpcOutletTable=ogRpcOutletTable, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioType=ogEmdDioType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostPingNotification=ogHostPingNotification, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientCounter=ogWifiClientCounter, ogUpsIndex=ogUpsIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWebUserIndex=ogWebUserIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletState=ogRpcOutletState, ogHostName=ogHostName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioName=ogEmdDioName, ogHostUserHost=ogHostUserHost, ogWifiClientEntry=ogWifiClientEntry)
