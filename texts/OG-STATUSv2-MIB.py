...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsCounter=ogUpsCounter, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserTable=ogSerialUserTable, ogUpsTemperature=ogUpsTemperature, ogSerialPortCTS=ogSerialPortCTS, ogRpcConnectType=ogRpcConnectType, ogCellModemIMSI=ogCellModemIMSI, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmTime=ogAlarmTime, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmState=ogAlarmState, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceType=ogHostServiceType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientApMac=ogWifiClientApMac, ogCellNetworkNotification=ogCellNetworkNotification, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmSummary=ogAlarmSummary, ogSerialUserPort=ogSerialUserPort, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2Conformance=ogStatus2Conformance, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmDevice=ogAlarmDevice, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellSignalNotification=ogCellSignalNotification, ogEmdIndex=ogEmdIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceState=ogNetInterfaceState, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioState=ogEmdDioState, ogCellModemConnected=ogCellModemConnected, ogHostServicePort=ogHostServicePort, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckType=ogCheckType, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientTable=ogWifiClientTable, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyName=ogPowerSupplyName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputNotification=ogUpsInputNotification, ogRpcCounter=ogRpcCounter, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmCheck=ogAlarmCheck, ogEmdDioEntry=ogEmdDioEntry, ogHostEntry=ogHostEntry, ogHostServiceStatus=ogHostServiceStatus, ogWebUserEntry=ogWebUserEntry, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletState=ogRpcOutletState, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserName=ogSerialUserName, ogHostUserHost=ogHostUserHost, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortLabel=ogSerialPortLabel, ogMibNotifications=ogMibNotifications, ogCustomNotification=ogCustomNotification, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortMode=ogSerialPortMode, ogSerialPortSpeed=ogSerialPortSpeed, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmUser=ogAlarmUser, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserTable=ogHostUserTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientTxPower=ogWifiClientTxPower, ogWebUserNotification=ogWebUserNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemTemperature=ogCellModemTemperature, ogEmdTable=ogEmdTable, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckEntry=ogCheckEntry, ogEmdDioType=ogEmdDioType, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApCounter=ogWifiApCounter, ogWebUserIndex=ogWebUserIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostTable=ogHostTable, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioName=ogEmdDioName, ogRpcType=ogRpcType, ogCellTowerNotification=ogCellTowerNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellApnNotification=ogCellApnNotification, ogAlarmType=ogAlarmType, ogRpcDescription=ogRpcDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsType=ogUpsType, ogEmdName=ogEmdName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemTower=ogCellModemTower, ogStatus2Groups=ogStatus2Groups, ogSerialNumber=ogSerialNumber, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellMessageNotification=ogCellMessageNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientMac=ogWifiApClientMac, ogRpcName=ogRpcName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostName=ogHostName, ogWifiClientInterface=ogWifiClientInterface, ogStatus2=ogStatus2, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsName=ogUpsName, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserTable=ogWebUserTable, ogCellModemIndex=ogCellModemIndex, ogSerialPortRTS=ogSerialPortRTS, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioDirection=ogEmdDioDirection, ogUpsNotification=ogUpsNotification, ogEmdDioTable=ogEmdDioTable, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcEntry=ogRpcEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostIpV4Address=ogHostIpV4Address, ogWifiApEntry=ogWifiApEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsDescription=ogUpsDescription, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostServiceTable=ogHostServiceTable, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletTable=ogRpcOutletTable, ogUpsIndex=ogUpsIndex, ogRpcInputNotification=ogRpcInputNotification, ogCheckTable=ogCheckTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDescription=ogEmdDescription, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogHostIndex=ogHostIndex, ogSerialPortEntry=ogSerialPortEntry, ogUpsEntry=ogUpsEntry, ogRpcTable=ogRpcTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarm=ogAlarm, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcIndex=ogRpcIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdEntry=ogEmdEntry, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryState=ogUpsBatteryState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserHostName=ogHostUserHostName, ogSystem=ogSystem, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceCounter=ogHostServiceCounter, ogHostServiceHost=ogHostServiceHost, ogWifiApTable=ogWifiApTable, ogSerialPortParity=ogSerialPortParity, ogSerialUserNotification=ogSerialUserNotification, ogCellModemModel=ogCellModemModel, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogHostServiceIndex=ogHostServiceIndex, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioCounter=ogEmdDioCounter, ogUpsHumidity=ogUpsHumidity, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmName=ogAlarmName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellDataNotification=ogCellDataNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckDeviceName=ogCheckDeviceName, ogWebUserName=ogWebUserName, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmInstance=ogAlarmInstance, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsLogEnabled=ogUpsLogEnabled)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputFrequency=ogUpsInputFrequency, ogHostUserNotification=ogHostUserNotification, ogCellModemRegistered=ogCellModemRegistered, ogUpsConnectType=ogUpsConnectType, ogSerialPortIndex=ogSerialPortIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApIndex=ogWifiApIndex, ogCellModemTable=ogCellModemTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortDTR=ogSerialPortDTR, ogAlarmEventId=ogAlarmEventId, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsTable=ogUpsTable, ogEmdEnabled=ogEmdEnabled, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletName=ogRpcOutletName, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckTriggerActions=ogCheckTriggerActions, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApInterface=ogWifiApInterface, ogCellModemEntry=ogCellModemEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemApn=ogCellModemApn, ogWifiApSsid=ogWifiApSsid, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientMode=ogWifiClientMode, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserName=ogHostUserName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdConnectType=ogEmdConnectType, ogUpsState=ogUpsState, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApFrequency=ogWifiApFrequency, ogCheckName=ogCheckName, ogHostUserAddress=ogHostUserAddress, ogHostUserIndex=ogHostUserIndex, PYSNMP_MODULE_ID=ogStatus2, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserEntry=ogHostUserEntry, ogWifiClientEssid=ogWifiClientEssid, ogCheckIndex=ogCheckIndex)
