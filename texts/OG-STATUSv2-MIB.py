...
iso, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Counter32, Bits, IpAddress, Counter64, ModuleIdentity, ObjectIdentity, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Counter32", "Bits", "IpAddress", "Counter64", "ModuleIdentity", "ObjectIdentity", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioNotification=ogEmdDioNotification, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApAuthNotification=ogWifiApAuthNotification, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServiceNotification=ogHostServiceNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortEntry=ogSerialPortEntry, ogCheckName=ogCheckName, ogSerialNumber=ogSerialNumber, ogCheckEntry=ogCheckEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcIndex=ogRpcIndex, ogHostServicePort=ogHostServicePort, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemVendor=ogCellModemVendor, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemCounter=ogCellModemCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserHostName=ogHostUserHostName, ogCellModemRegistered=ogCellModemRegistered, ogWifiApTable=ogWifiApTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserStartTime=ogWebUserStartTime, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmEventId=ogAlarmEventId, ogUpsHumidity=ogUpsHumidity, ogHostServiceHost=ogHostServiceHost, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsDescription=ogUpsDescription, ogWebUserName=ogWebUserName, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmUser=ogAlarmUser, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcInputNotification=ogRpcInputNotification, ogSerialUserLabel=ogSerialUserLabel, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogPowerSupplyName=ogPowerSupplyName, ogUpsTable=ogUpsTable, ogStatus2Compliance=ogStatus2Compliance, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientInterface=ogWifiClientInterface, ogWifiApCounter=ogWifiApCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdName=ogEmdName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputNotification=ogUpsInputNotification, ogHostUserHost=ogHostUserHost, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemEnabled=ogCellModemEnabled, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostName=ogHostName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWebUserEntry=ogWebUserEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckResolveActions=ogCheckResolveActions, ogWebUserNotification=ogWebUserNotification, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdConnectType=ogEmdConnectType, ogHostServiceTable=ogHostServiceTable, ogWifiClientIndex=ogWifiClientIndex, ogAlarmInstance=ogAlarmInstance, ogCellModemEntry=ogCellModemEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceCounter=ogHostServiceCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceType=ogNetInterfaceType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletName=ogRpcOutletName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserTable=ogSerialUserTable, ogUpsCounter=ogUpsCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserTable=ogWebUserTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogMibNotifications=ogMibNotifications, ogNetInterfaceName=ogNetInterfaceName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcEntry=ogRpcEntry, ogWifiClientEssid=ogWifiClientEssid, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogHostIndex=ogHostIndex, ogAlarmSummary=ogAlarmSummary, ogWifiApEntry=ogWifiApEntry, ogCellApnNotification=ogCellApnNotification, ogHostServiceEntry=ogHostServiceEntry, ogAlarmState=ogAlarmState, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSystem=ogSystem, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckType=ogCheckType, ogNetInterfaceState=ogNetInterfaceState, ogCellModemApn=ogCellModemApn, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApInterface=ogWifiApInterface, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckTable=ogCheckTable, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckIndex=ogCheckIndex, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortParity=ogSerialPortParity, ogWifiApClientMac=ogWifiApClientMac, ogHostPingNotification=ogHostPingNotification, ogHostUserNotification=ogHostUserNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioDirection=ogEmdDioDirection, ogCellModemTable=ogCellModemTable, ogStatus2Groups=ogStatus2Groups, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioState=ogEmdDioState, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmDevice=ogAlarmDevice, ogSerialPortDCD=ogSerialPortDCD, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemModel=ogCellModemModel, ogEmdDioType=ogEmdDioType, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortCTS=ogSerialPortCTS, ogUpsState=ogUpsState, ogRpcDescription=ogRpcDescription, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserIndex=ogSerialUserIndex, ogHostEntry=ogHostEntry, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletState=ogRpcOutletState, ogWifiApClientAp=ogWifiApClientAp, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientTable=ogWifiApClientTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2=ogStatus2, ogEmdEnabled=ogEmdEnabled, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemTower=ogCellModemTower, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcType=ogRpcType, ogHostUserName=ogHostUserName, ogUpsEntry=ogUpsEntry, ogWifiClientRssi=ogWifiClientRssi, ogCellModem4gRssi=ogCellModem4gRssi, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceType=ogHostServiceType, ogCustomNotification=ogCustomNotification, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserStartTime=ogHostUserStartTime, ogUpsName=ogUpsName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserIndex=ogWebUserIndex, ogSerialUserPort=ogSerialUserPort, ogUpsTemperature=ogUpsTemperature, ogHostUserIndex=ogHostUserIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmName=ogAlarmName, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsNotification=ogUpsNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmType=ogAlarmType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellDataNotification=ogCellDataNotification, ogHostTable=ogHostTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTable=ogEmdTable, ogWifiClientApMac=ogWifiClientApMac, ogAlarmTime=ogAlarmTime, ogEmdDioTable=ogEmdDioTable, ogWifiApSsid=ogWifiApSsid)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputPower=ogUpsOutputPower, ogAlarmCheck=ogAlarmCheck, ogWifiClientIeeeMode=ogWifiClientIeeeMode, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioName=ogEmdDioName, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemIndex=ogCellModemIndex, ogSerialUserEntry=ogSerialUserEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserAddress=ogHostUserAddress, ogSerialPortMode=ogSerialPortMode, ogAlarm=ogAlarm, ogWifiClientEntry=ogWifiClientEntry, ogRpcName=ogRpcName, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceIndex=ogHostServiceIndex, ogUpsType=ogUpsType, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortLabel=ogSerialPortLabel, ogRpcCounter=ogRpcCounter, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserTable=ogHostUserTable, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientTable=ogWifiClientTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdIndex=ogEmdIndex, ogCellModemTemperature=ogCellModemTemperature, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsConnectType=ogUpsConnectType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdEntry=ogEmdEntry, ogUpsIndex=ogUpsIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcTable=ogRpcTable, ogEmdDescription=ogEmdDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialUserName=ogSerialUserName)
