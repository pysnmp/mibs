...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemConnected=ogCellModemConnected, ogSerialPortDSR=ogSerialPortDSR, ogEmdName=ogEmdName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsName=ogUpsName, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortMode=ogSerialPortMode, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemTemperature=ogCellModemTemperature, ogEmdIndex=ogEmdIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletName=ogRpcOutletName, ogWifiClientRssi=ogWifiClientRssi, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCustomNotification=ogCustomNotification, ogHostUserAddress=ogHostUserAddress, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortLabel=ogSerialPortLabel, ogStatus2Compliance=ogStatus2Compliance, ogUpsEntry=ogUpsEntry, ogHostServiceType=ogHostServiceType, ogCellModemTable=ogCellModemTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemNetwork=ogCellModemNetwork, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApClientAp=ogWifiApClientAp, ogAlarmLogTable=ogAlarmLogTable, ogUpsHumidity=ogUpsHumidity, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceType=ogNetInterfaceType, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioNotification=ogEmdDioNotification, ogHostUserEntry=ogHostUserEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogMibNotifications=ogMibNotifications, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdConnectType=ogEmdConnectType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortEntry=ogSerialPortEntry, ogCellModemIndex=ogCellModemIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWebUserTable=ogWebUserTable, ogStatus2Groups=ogStatus2Groups, ogHostUserHostName=ogHostUserHostName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcType=ogRpcType, ogEmdDioDirection=ogEmdDioDirection, ogUpsIndex=ogUpsIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserIndex=ogWebUserIndex, ogUpsState=ogUpsState, ogEmdDioType=ogEmdDioType, ogCellModemTower=ogCellModemTower, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmCheck=ogAlarmCheck, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceName=ogNetInterfaceName, ogCheckName=ogCheckName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostEntry=ogHostEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogSystem=ogSystem, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmType=ogAlarmType, ogAlarmEventId=ogAlarmEventId, ogWifiApTable=ogWifiApTable, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemModel=ogCellModemModel, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcName=ogRpcName, ogHostPingNotification=ogHostPingNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApCounter=ogWifiApCounter, ogUpsLogEnabled=ogUpsLogEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogHostName=ogHostName, ogHostUserIndex=ogHostUserIndex, ogHostIpV6Address=ogHostIpV6Address, ogUpsTable=ogUpsTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsType=ogUpsType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserNotification=ogHostUserNotification, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientTable=ogWifiClientTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcDescription=ogRpcDescription, ogHostTable=ogHostTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortParity=ogSerialPortParity, ogEmdTable=ogEmdTable, ogWebUserName=ogWebUserName, ogSerialPortRTS=ogSerialPortRTS, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemEntry=ogCellModemEntry, ogWifiApSsid=ogWifiApSsid, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcCounter=ogRpcCounter, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortDCD=ogSerialPortDCD, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemRegistered=ogCellModemRegistered, ogCellModemCounter=ogCellModemCounter, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserStartTime=ogWebUserStartTime, ogUpsTemperature=ogUpsTemperature, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsDescription=ogUpsDescription, ogEmdDescription=ogEmdDescription, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, PYSNMP_MODULE_ID=ogStatus2, ogEmdEntry=ogEmdEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckType=ogCheckType, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogStatus2=ogStatus2, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioCounter=ogEmdDioCounter, ogRpcEntry=ogRpcEntry, ogSerialUserPort=ogSerialUserPort, ogCellModemApn=ogCellModemApn, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioName=ogEmdDioName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmSummary=ogAlarmSummary, ogWifiApTxPower=ogWifiApTxPower, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmState=ogAlarmState, ogAlarmUser=ogAlarmUser, ogHostServiceStatus=ogHostServiceStatus, ogHostUserHost=ogHostUserHost, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServicePort=ogHostServicePort, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsNotification=ogUpsNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmName=ogAlarmName, ogSerialUserTable=ogSerialUserTable, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioIndex=ogEmdDioIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellApnNotification=ogCellApnNotification, ogHostUserName=ogHostUserName, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServiceCounter=ogHostServiceCounter, ogUpsCounter=ogUpsCounter, ogCheckResolveActions=ogCheckResolveActions, ogWebUserNotification=ogWebUserNotification, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApIndex=ogWifiApIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientMode=ogWifiClientMode, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryState=ogUpsBatteryState, ogRpcIndex=ogRpcIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortTable=ogSerialPortTable, ogRpcOutletTable=ogRpcOutletTable, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcTable=ogRpcTable, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioState=ogEmdDioState, ogWifiClientIndex=ogWifiClientIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserName=ogSerialUserName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostServiceTable=ogHostServiceTable, ogAlarmInstance=ogAlarmInstance, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientMac=ogWifiApClientMac, ogSerialNumber=ogSerialNumber, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioTable=ogEmdDioTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellSignalNotification=ogCellSignalNotification, ogRpcInputNotification=ogRpcInputNotification, ogHostUserTable=ogHostUserTable, ogCheckEntry=ogCheckEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckIndex=ogCheckIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModem3gRssi=ogCellModem3gRssi, ogCellDataNotification=ogCellDataNotification, ogHostIndex=ogHostIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmTime=ogAlarmTime, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceIndex=ogHostServiceIndex, ogAlarm=ogAlarm, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckTable=ogCheckTable, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryCharge=ogUpsBatteryCharge)
