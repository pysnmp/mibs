...
Integer32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Counter32, MibIdentifier, Counter64, iso, IpAddress, TimeTicks, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Counter32", "MibIdentifier", "Counter64", "iso", "IpAddress", "TimeTicks", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialNumber=ogSerialNumber, ogSerialUserName=ogSerialUserName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostIndex=ogHostIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientEntry=ogWifiClientEntry, ogUpsNotification=ogUpsNotification, ogUpsIndex=ogUpsIndex, ogCellModemTable=ogCellModemTable, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserName=ogWebUserName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioEmd=ogEmdDioEmd, ogRpcName=ogRpcName, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogCellTowerNotification=ogCellTowerNotification, ogAlarmLogTable=ogAlarmLogTable, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortTable=ogSerialPortTable, ogCellDataNotification=ogCellDataNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApCounter=ogWifiApCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioState=ogEmdDioState, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostUserTable=ogHostUserTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortCTS=ogSerialPortCTS, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApFrequency=ogWifiApFrequency, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarm=ogAlarm, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceNotification=ogHostServiceNotification, ogEmdName=ogEmdName, ogHostUserIndex=ogHostUserIndex, ogEmdDioCounter=ogEmdDioCounter, ogHostServiceStatus=ogHostServiceStatus, ogAlarmState=ogAlarmState, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostUserNotification=ogHostUserNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletName=ogRpcOutletName, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserNotification=ogWebUserNotification, ogRpcDescription=ogRpcDescription, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientRssi=ogWifiClientRssi, ogUpsConnectType=ogUpsConnectType, ogCheckResolveActions=ogCheckResolveActions, ogEmdEntry=ogEmdEntry, ogUpsBatteryState=ogUpsBatteryState, ogMibNotifications=ogMibNotifications, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceIndex=ogHostServiceIndex, ogHostServiceCounter=ogHostServiceCounter, ogUpsState=ogUpsState, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityName=ogEmdHumidityName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemTemperature=ogCellModemTemperature, ogRpcTable=ogRpcTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletIndex=ogRpcOutletIndex, ogCustomNotification=ogCustomNotification, ogNetInterfaceState=ogNetInterfaceState, ogCellModemApn=ogCellModemApn, ogSerialPortParity=ogSerialPortParity, ogRpcConnectType=ogRpcConnectType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortLabel=ogSerialPortLabel, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcCounter=ogRpcCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckTriggerActions=ogCheckTriggerActions, ogHostTable=ogHostTable, ogHostEntry=ogHostEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserEntry=ogWebUserEntry, ogEmdIndex=ogEmdIndex, ogCellModemEntry=ogCellModemEntry, ogCellModemModel=ogCellModemModel, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmDevice=ogAlarmDevice, ogHostName=ogHostName, ogCellModemConnected=ogCellModemConnected, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioName=ogEmdDioName, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemTower=ogCellModemTower, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserTable=ogWebUserTable, ogCheckTable=ogCheckTable, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmTime=ogAlarmTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsDescription=ogUpsDescription, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcIndex=ogRpcIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientTable=ogWifiClientTable, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioTable=ogEmdDioTable, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmName=ogAlarmName, ogAlarmType=ogAlarmType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserIndex=ogWebUserIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApInterface=ogWifiApInterface, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortRTS=ogSerialPortRTS, ogEmdEnabled=ogEmdEnabled, ogAlarmEventId=ogAlarmEventId, ogEmdDioIndex=ogEmdDioIndex, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcEntry=ogRpcEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostUserName=ogHostUserName, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServicePort=ogHostServicePort, ogAlarmSummary=ogAlarmSummary, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientMode=ogWifiClientMode, ogEmdDioNotification=ogEmdDioNotification, ogAlarmInstance=ogAlarmInstance, ogCheckEntry=ogCheckEntry, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckType=ogCheckType, ogCellModemVendor=ogCellModemVendor, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceName=ogNetInterfaceName, ogStatus2Groups=ogStatus2Groups, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserEntry=ogSerialUserEntry, ogEmdDescription=ogEmdDescription, ogWifiApSsid=ogWifiApSsid, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortMode=ogSerialPortMode, ogWifiApClientTable=ogWifiApClientTable, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApEntry=ogWifiApEntry, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceTable=ogHostServiceTable, ogSerialPortDCD=ogSerialPortDCD, ogCheckName=ogCheckName, ogSystem=ogSystem, ogWifiApEnabled=ogWifiApEnabled, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientCounter=ogWifiClientCounter, ogUpsTable=ogUpsTable, ogRpcType=ogRpcType, ogCurrentAlarmTime=ogCurrentAlarmTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientIndex=ogWifiClientIndex, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostServiceType=ogHostServiceType, ogAlarmUser=ogAlarmUser, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostServiceHost=ogHostServiceHost, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApTable=ogWifiApTable, ogUpsInputFrequency=ogUpsInputFrequency, ogHostServiceEntry=ogHostServiceEntry, ogUpsTemperature=ogUpsTemperature, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTable=ogEmdTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserHost=ogHostUserHost, ogUpsEntry=ogUpsEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsName=ogUpsName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserPort=ogSerialUserPort, ogUpsType=ogUpsType, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientEssid=ogWifiClientEssid, ogHostPingNotification=ogHostPingNotification, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogNetInterfaceType=ogNetInterfaceType, ogCellModemIndex=ogCellModemIndex, ogHostIpV6Address=ogHostIpV6Address, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioType=ogEmdDioType, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientIndex=ogWifiApClientIndex, ogStatus2=ogStatus2, ogRpcInputNotification=ogRpcInputNotification, ogFirmwareVersion=ogFirmwareVersion, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellApnNotification=ogCellApnNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostUserStartTime=ogHostUserStartTime, ogHostUserAddress=ogHostUserAddress, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsCounter=ogUpsCounter, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityTable=ogEmdHumidityTable, ogHostIpV4Address=ogHostIpV4Address, ogCheckIndex=ogCheckIndex, ogWebUserStartTime=ogWebUserStartTime)
