...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioState=ogEmdDioState, ogWebUserTable=ogWebUserTable, ogSerialPortTable=ogSerialPortTable, ogEmdDioDirection=ogEmdDioDirection, ogAlarmTime=ogAlarmTime, ogEmdDescription=ogEmdDescription, ogAlarmState=ogAlarmState, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortCTS=ogSerialPortCTS, ogCellModemTable=ogCellModemTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortRTS=ogSerialPortRTS, ogUpsConnectType=ogUpsConnectType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckResetTimeout=ogCheckResetTimeout, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryState=ogUpsBatteryState, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemConnected=ogCellModemConnected, ogCheckTable=ogCheckTable, ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputPower=ogUpsOutputPower, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApTable=ogWifiApTable, ogCheckEntry=ogCheckEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletState=ogRpcOutletState, ogWifiApClientTable=ogWifiApClientTable, ogCellModemIMSI=ogCellModemIMSI, ogHostUserIndex=ogHostUserIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityEntry=ogEmdHumidityEntry, PYSNMP_MODULE_ID=ogStatus2, ogSystem=ogSystem, ogEmdDioEntry=ogEmdDioEntry, ogStatus2=ogStatus2, ogAlarmType=ogAlarmType, ogUpsTable=ogUpsTable, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdIndex=ogEmdIndex, ogWebUserNotification=ogWebUserNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemTemperature=ogCellModemTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServicePort=ogHostServicePort, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioEmd=ogEmdDioEmd, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientIndex=ogWifiClientIndex, ogHostIpV6Address=ogHostIpV6Address, ogHostUserHost=ogHostUserHost, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceHost=ogHostServiceHost, ogWebUserIndex=ogWebUserIndex, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdEntry=ogEmdEntry, ogRpcTable=ogRpcTable, ogHostUserName=ogHostUserName, ogUpsName=ogUpsName, ogAlarm=ogAlarm, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApSsid=ogWifiApSsid, ogCellModemNetwork=ogCellModemNetwork, ogHostServiceType=ogHostServiceType, ogUpsCounter=ogUpsCounter, ogHostTable=ogHostTable, ogEmdDioTable=ogEmdDioTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogMibNotifications=ogMibNotifications, ogRpcOutletName=ogRpcOutletName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmCheck=ogAlarmCheck, ogEmdConnectType=ogEmdConnectType, ogRpcName=ogRpcName, ogWifiClientBitRate=ogWifiClientBitRate, ogCustomNotification=ogCustomNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemTower=ogCellModemTower, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApFrequency=ogWifiApFrequency, ogAlarmEventId=ogAlarmEventId, ogSerialPatternNotification=ogSerialPatternNotification, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckType=ogCheckType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityName=ogEmdHumidityName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioType=ogEmdDioType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsInputNotification=ogUpsInputNotification, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceTable=ogCheckDeviceTable, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialNumber=ogSerialNumber, ogUpsHumidity=ogUpsHumidity, ogRpcDescription=ogRpcDescription, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortLabel=ogSerialPortLabel, ogHostUserStartTime=ogHostUserStartTime, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceNotification=ogHostServiceNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostServiceTable=ogHostServiceTable, ogHostUserEntry=ogHostUserEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsState=ogUpsState, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2Groups=ogStatus2Groups, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2Compliances=ogStatus2Compliances, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmDevice=ogAlarmDevice, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsEntry=ogUpsEntry, ogCheckDeviceName=ogCheckDeviceName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserHostName=ogHostUserHostName, ogHostUserTable=ogHostUserTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostIpV4Address=ogHostIpV4Address, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApInterface=ogWifiApInterface, ogUpsType=ogUpsType, ogCheckTriggerActions=ogCheckTriggerActions, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellSignalNotification=ogCellSignalNotification, ogHostIndex=ogHostIndex, ogSerialUserTable=ogSerialUserTable, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemVendor=ogCellModemVendor, ogAlarmName=ogAlarmName, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemCounter=ogCellModemCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellMessageNotification=ogCellMessageNotification, ogRpcEntry=ogRpcEntry, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmName=ogCurrentAlarmName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialUserNotification=ogSerialUserNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserName=ogWebUserName, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemEnabled=ogCellModemEnabled, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcIndex=ogRpcIndex, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsIndex=ogUpsIndex, ogUpsNotification=ogUpsNotification, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialUserName=ogSerialUserName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckIndex=ogCheckIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogCellDataNotification=ogCellDataNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemModel=ogCellModemModel, ogHostServiceCounter=ogHostServiceCounter, ogEmdTable=ogEmdTable, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioName=ogEmdDioName, ogUpsTemperature=ogUpsTemperature, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemIndex=ogCellModemIndex, ogEmdEnabled=ogEmdEnabled, ogCellApnNotification=ogCellApnNotification, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcCounter=ogRpcCounter, ogRpcOutletTable=ogRpcOutletTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckName=ogCheckName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmUser=ogAlarmUser, ogCellModemApn=ogCellModemApn, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostName=ogHostName, ogWifiApCounter=ogWifiApCounter, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcType=ogRpcType, ogWebUserEntry=ogWebUserEntry, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApIndex=ogWifiApIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserStartTime=ogWebUserStartTime, ogUpsDescription=ogUpsDescription, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmSummary=ogAlarmSummary, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientMode=ogWifiClientMode, ogSerialPortParity=ogSerialPortParity, ogWifiApEntry=ogWifiApEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogNetInterfaceType=ogNetInterfaceType, ogHostEntry=ogHostEntry, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioDescription=ogEmdDioDescription, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioCounter=ogEmdDioCounter, ogSerialUserIndex=ogSerialUserIndex, ogEmdName=ogEmdName, ogBasicAlarmGroup=ogBasicAlarmGroup)
