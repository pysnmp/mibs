...
ModuleIdentity, NotificationType, TimeTicks, iso, Counter32, Bits, ObjectIdentity, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "TimeTicks", "iso", "Counter32", "Bits", "ObjectIdentity", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2Conformance=ogStatus2Conformance, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserIndex=ogHostUserIndex, ogHostUserHostName=ogHostUserHostName, ogUpsInputVoltage=ogUpsInputVoltage, ogCellApnNotification=ogCellApnNotification, ogSystem=ogSystem, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdConnectType=ogEmdConnectType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostTable=ogHostTable, ogWifiApClientAp=ogWifiApClientAp, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApIndex=ogWifiApIndex, ogRpcName=ogRpcName, ogEmdEnabled=ogEmdEnabled, ogWifiClientEntry=ogWifiClientEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDescription=ogEmdDescription, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemVendor=ogCellModemVendor, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryState=ogUpsBatteryState, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceNotification=ogHostServiceNotification, ogAlarmLogTable=ogAlarmLogTable, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsConnectType=ogUpsConnectType, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceIndex=ogHostServiceIndex, ogUpsType=ogUpsType, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceTable=ogHostServiceTable, ogAlarmUser=ogAlarmUser, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioDescription=ogEmdDioDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletName=ogRpcOutletName, ogCellTowerNotification=ogCellTowerNotification, ogHostEntry=ogHostEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsEntry=ogUpsEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcTable=ogRpcTable, ogUpsDescription=ogUpsDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioName=ogEmdDioName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceName=ogNetInterfaceName, ogStatus2Compliance=ogStatus2Compliance, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioDirection=ogEmdDioDirection, ogCellModemCounter=ogCellModemCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioIndex=ogEmdDioIndex, ogUpsTemperature=ogUpsTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserName=ogWebUserName, ogWebUserStartTime=ogWebUserStartTime, ogEmdIndex=ogEmdIndex, ogSerialUserName=ogSerialUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsIndex=ogUpsIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApCounter=ogWifiApCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckIndex=ogCheckIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientTable=ogWifiApClientTable, ogAlarmSummary=ogAlarmSummary, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceType=ogHostServiceType, ogWebUserEntry=ogWebUserEntry, ogAlarmEventId=ogAlarmEventId, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcDescription=ogRpcDescription, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogMibNotifications=ogMibNotifications, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellMessageNotification=ogCellMessageNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletState=ogRpcOutletState, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcEntry=ogRpcEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioEmd=ogEmdDioEmd, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialUserTable=ogSerialUserTable, ogFirmwareVersion=ogFirmwareVersion, ogCellModemConnected=ogCellModemConnected, ogCellModemTemperature=ogCellModemTemperature, ogNetInterfaceEntry=ogNetInterfaceEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostName=ogHostName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckType=ogCheckType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientRssi=ogWifiClientRssi, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemModel=ogCellModemModel, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientTable=ogWifiClientTable, ogEmdName=ogEmdName, ogWifiClientMode=ogWifiClientMode, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserEntry=ogHostUserEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostIpV4Address=ogHostIpV4Address, ogCheckEntry=ogCheckEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogStatus2=ogStatus2, ogCheckTable=ogCheckTable, ogStatus2Groups=ogStatus2Groups, ogRpcType=ogRpcType, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostUserAddress=ogHostUserAddress, ogCheckDeviceName=ogCheckDeviceName, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmInstance=ogAlarmInstance, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemApn=ogCellModemApn, PYSNMP_MODULE_ID=ogStatus2, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApFrequency=ogWifiApFrequency, ogHostIndex=ogHostIndex, ogRpcIndex=ogRpcIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortLabel=ogSerialPortLabel, ogAlarmType=ogAlarmType, ogUpsName=ogUpsName, ogCellModemTable=ogCellModemTable, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemTower=ogCellModemTower, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioEntry=ogEmdDioEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarm=ogAlarm, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientBitRate=ogWifiClientBitRate, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserTable=ogHostUserTable, ogEmdDioType=ogEmdDioType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemEnabled=ogCellModemEnabled, ogRpcInputNotification=ogRpcInputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioTable=ogEmdDioTable, ogSerialPortIndex=ogSerialPortIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientMac=ogWifiApClientMac, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmCheck=ogAlarmCheck, ogUpsState=ogUpsState, ogCellDataNotification=ogCellDataNotification, ogSerialNumber=ogSerialNumber, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApTable=ogWifiApTable, ogEmdDioState=ogEmdDioState, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortDTR=ogSerialPortDTR, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTable=ogEmdTable, ogHostServiceEntry=ogHostServiceEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsTable=ogUpsTable, ogWifiClientCounter=ogWifiClientCounter)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdEntry=ogEmdEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceHost=ogHostServiceHost, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientInterface=ogWifiClientInterface, ogCheckName=ogCheckName, ogAlarmDevice=ogAlarmDevice, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostUserNotification=ogHostUserNotification, ogUpsNotification=ogUpsNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsCounter=ogUpsCounter, ogCustomNotification=ogCustomNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcConnectType=ogRpcConnectType, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletTable=ogRpcOutletTable, ogWifiApEnabled=ogWifiApEnabled, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientApMac=ogWifiClientApMac, ogAlarmTime=ogAlarmTime, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmState=ogAlarmState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmName=ogCurrentAlarmName, ogHostPingNotification=ogHostPingNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApEntry=ogWifiApEntry, ogWebUserTable=ogWebUserTable, ogHostUserHost=ogHostUserHost, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcCounter=ogRpcCounter, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmName=ogAlarmName, ogCellModemEntry=ogCellModemEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserName=ogHostUserName, ogSerialPortParity=ogSerialPortParity, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServicePort=ogHostServicePort, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex)
