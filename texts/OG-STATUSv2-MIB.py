...
MibIdentifier, iso, NotificationType, Integer32, Counter64, Bits, TimeTicks, IpAddress, Gauge32, ModuleIdentity, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "NotificationType", "Integer32", "Counter64", "Bits", "TimeTicks", "IpAddress", "Gauge32", "ModuleIdentity", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientTable=ogWifiClientTable, ogStatus2=ogStatus2, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcEntry=ogRpcEntry, ogCellApnNotification=ogCellApnNotification, ogHostUserName=ogHostUserName, ogSerialPortParity=ogSerialPortParity, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostIndex=ogHostIndex, ogCellMessageNotification=ogCellMessageNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserPort=ogSerialUserPort, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioCounter=ogEmdDioCounter, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostName=ogHostName, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioName=ogEmdDioName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSystem=ogSystem, ogCellModemRegistered=ogCellModemRegistered, ogRpcName=ogRpcName, ogStatus2Groups=ogStatus2Groups, ogEmdConnectType=ogEmdConnectType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemCounter=ogCellModemCounter, ogHostTable=ogHostTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmDevice=ogAlarmDevice, ogRpcDescription=ogRpcDescription, ogSerialPortDTR=ogSerialPortDTR, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmSummary=ogAlarmSummary, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialNumber=ogSerialNumber, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletName=ogRpcOutletName, ogAlarmEventId=ogAlarmEventId, ogEmdTable=ogEmdTable, ogWifiClientIndex=ogWifiClientIndex, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmName=ogCurrentAlarmName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortDCD=ogSerialPortDCD, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsType=ogUpsType, ogRpcOutletTable=ogRpcOutletTable, ogHostUserHostName=ogHostUserHostName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserNotification=ogHostUserNotification, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdName=ogEmdName, ogEmdDioType=ogEmdDioType, ogAlarmTime=ogAlarmTime, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioState=ogEmdDioState, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcTable=ogRpcTable, ogHostEntry=ogHostEntry, ogWifiApTable=ogWifiApTable, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcInputNotification=ogRpcInputNotification, ogSerialUserName=ogSerialUserName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApEntry=ogWifiApEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemEntry=ogCellModemEntry, ogAlarmInstance=ogAlarmInstance, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApSsid=ogWifiApSsid, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2Compliance=ogStatus2Compliance, ogWifiApEnabled=ogWifiApEnabled, ogCustomNotification=ogCustomNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDioDirection=ogEmdDioDirection, ogWebUserNotification=ogWebUserNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioIndex=ogEmdDioIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsIndex=ogUpsIndex, ogWifiApInterface=ogWifiApInterface, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdEntry=ogEmdEntry, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckEntry=ogCheckEntry, ogUpsNotification=ogUpsNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientApMac=ogWifiClientApMac, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletTotal=ogRpcOutletTotal, ogHostServiceType=ogHostServiceType, ogCheckName=ogCheckName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmName=ogAlarmName, ogAlarmType=ogAlarmType, ogAlarmCheck=ogAlarmCheck, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostUserTable=ogHostUserTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsCounter=ogUpsCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApCounter=ogWifiApCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogCellDataNotification=ogCellDataNotification, ogCellModemIndex=ogCellModemIndex, ogEmdDioDescription=ogEmdDioDescription, ogAlarm=ogAlarm, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemEnabled=ogCellModemEnabled, ogUpsEntry=ogUpsEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioEmd=ogEmdDioEmd, ogCellModemTower=ogCellModemTower, ogHostUserAddress=ogHostUserAddress, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsDescription=ogUpsDescription, ogHostServiceHost=ogHostServiceHost, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsTable=ogUpsTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckTable=ogCheckTable, ogUpsTemperature=ogUpsTemperature, ogStatus2Conformance=ogStatus2Conformance, ogStatus2Compliances=ogStatus2Compliances, ogUpsConnectType=ogUpsConnectType, ogCheckIndex=ogCheckIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdHumidityDescription=ogEmdHumidityDescription, ogFirmwareVersion=ogFirmwareVersion, ogCellModemTable=ogCellModemTable, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogNetInterfaceName=ogNetInterfaceName, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApFrequency=ogWifiApFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemModel=ogCellModemModel, ogRpcOutletState=ogRpcOutletState, ogEmdDescription=ogEmdDescription, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcConnectType=ogRpcConnectType, ogEmdDioTable=ogEmdDioTable, ogAlarmUser=ogAlarmUser, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortIndex=ogSerialPortIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyIndex=ogPowerSupplyIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellTowerNotification=ogCellTowerNotification, ogWebUserTable=ogWebUserTable, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcCounter=ogRpcCounter, ogUpsName=ogUpsName, ogAlarmState=ogAlarmState, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialUserNotification=ogSerialUserNotification, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdEnabled=ogEmdEnabled, ogHostIpV4Address=ogHostIpV4Address, ogUpsHumidity=ogUpsHumidity, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortEntry=ogSerialPortEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceEntry=ogHostServiceEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostServicePort=ogHostServicePort, ogWebUserEntry=ogWebUserEntry, ogSerialPortTable=ogSerialPortTable, ogRpcOutletEntry=ogRpcOutletEntry, ogWebUserName=ogWebUserName, ogMibNotifications=ogMibNotifications, ogEmdIndex=ogEmdIndex, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostUserHost=ogHostUserHost, ogHostServiceTable=ogHostServiceTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemApn=ogCellModemApn, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceState=ogNetInterfaceState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckType=ogCheckType, ogRpcType=ogRpcType, ogCellModemConnected=ogCellModemConnected, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostPingNotification=ogHostPingNotification, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcIndex=ogRpcIndex, ogEmdDioNotification=ogEmdDioNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientEssid=ogWifiClientEssid, ogUpsState=ogUpsState, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortRTS=ogSerialPortRTS)
