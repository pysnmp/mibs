...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, IpAddress, MibIdentifier, ModuleIdentity, ObjectIdentity, Counter64, iso, TimeTicks, Integer32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "IpAddress", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter64", "iso", "TimeTicks", "Integer32", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioType=ogEmdDioType, ogHostUserStartTime=ogHostUserStartTime, ogAlarmTime=ogAlarmTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcTable=ogRpcTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCustomNotification=ogCustomNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioNotification=ogEmdDioNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityEntry=ogEmdHumidityEntry, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortMode=ogSerialPortMode, ogEmdConnectType=ogEmdConnectType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostPingNotification=ogHostPingNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemIndex=ogCellModemIndex, ogUpsDescription=ogUpsDescription, ogHostServiceNotification=ogHostServiceNotification, ogCellTowerNotification=ogCellTowerNotification, ogWifiApCounter=ogWifiApCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortTable=ogSerialPortTable, ogWifiClientApMac=ogWifiClientApMac, ogHostIpV6Address=ogHostIpV6Address, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsNotification=ogUpsNotification, ogSerialNumber=ogSerialNumber, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyName=ogPowerSupplyName, ogUpsIndex=ogUpsIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogHostIndex=ogHostIndex, ogStatus2=ogStatus2, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceIndex=ogHostServiceIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckIndex=ogCheckIndex, ogAlarm=ogAlarm, ogCellDataNotification=ogCellDataNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientTable=ogWifiClientTable, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserName=ogSerialUserName, ogUpsType=ogUpsType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcConnectType=ogRpcConnectType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmName=ogAlarmName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserEntry=ogSerialUserEntry, ogCellModemConnected=ogCellModemConnected, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortEntry=ogSerialPortEntry, ogHostServiceTable=ogHostServiceTable, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWebUserTable=ogWebUserTable, ogCellModemTable=ogCellModemTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApTxPower=ogWifiApTxPower, ogEmdEnabled=ogEmdEnabled, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserName=ogHostUserName, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceStatus=ogHostServiceStatus, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientMode=ogWifiClientMode, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmState=ogAlarmState, ogHostUserTable=ogHostUserTable, ogSerialPortIndex=ogSerialPortIndex, ogUpsTemperature=ogUpsTemperature, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdName=ogEmdName, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserTable=ogSerialUserTable, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserLabel=ogSerialUserLabel, ogEmdTable=ogEmdTable, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortLogLevel=ogSerialPortLogLevel, ogStatus2Compliances=ogStatus2Compliances, ogUpsConnectType=ogUpsConnectType, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsEntry=ogUpsEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckName=ogCheckName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemModel=ogCellModemModel, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserIndex=ogWebUserIndex, ogCheckType=ogCheckType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsCounter=ogUpsCounter, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioEmd=ogEmdDioEmd, ogCellModemRegistered=ogCellModemRegistered, ogRpcType=ogRpcType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientFrequency=ogWifiClientFrequency, ogMibNotifications=ogMibNotifications, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemVendor=ogCellModemVendor, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserPort=ogSerialUserPort, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialUserIndex=ogSerialUserIndex, ogHostUserAddress=ogHostUserAddress, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceIndex=ogCheckDeviceIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSystem=ogSystem, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsState=ogUpsState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApTable=ogWifiApTable, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioDescription=ogEmdDioDescription, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserEntry=ogHostUserEntry, ogUpsName=ogUpsName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostServicePort=ogHostServicePort, ogSerialPortDCD=ogSerialPortDCD, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientAp=ogWifiApClientAp, ogAlarmInstance=ogAlarmInstance, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemSessionTime=ogCellModemSessionTime, ogHostServiceType=ogHostServiceType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApEnabled=ogWifiApEnabled, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcDescription=ogRpcDescription, ogCheckEntry=ogCheckEntry, ogRpcName=ogRpcName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmDevice=ogAlarmDevice, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmUser=ogAlarmUser, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckResolveActions=ogCheckResolveActions, ogRpcIndex=ogRpcIndex, ogRpcOutletName=ogRpcOutletName, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientIndex=ogWifiClientIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortRTS=ogSerialPortRTS, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceName=ogCheckDeviceName, ogCellModemTower=ogCellModemTower, ogSerialPatternNotification=ogSerialPatternNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmEventId=ogAlarmEventId, ogCellModemApn=ogCellModemApn, ogEmdDescription=ogEmdDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmCheck=ogAlarmCheck, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputNotification=ogUpsOutputNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogHostName=ogHostName, ogStatus2Groups=ogStatus2Groups, ogRpcOutputNotification=ogRpcOutputNotification, ogCellApnNotification=ogCellApnNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortDSR=ogSerialPortDSR)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdIndex=ogEmdIndex, ogAlarmType=ogAlarmType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsHumidity=ogUpsHumidity, ogRpcEntry=ogRpcEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientInterface=ogWifiClientInterface, ogHostServiceEntry=ogHostServiceEntry, ogEmdEntry=ogEmdEntry, ogRpcOutletState=ogRpcOutletState, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserHostName=ogHostUserHostName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletRpc=ogRpcOutletRpc, ogHostUserNotification=ogHostUserNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemCounter=ogCellModemCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemEntry=ogCellModemEntry, ogEmdDioName=ogEmdDioName, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletTable=ogRpcOutletTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApEntry=ogWifiApEntry, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostUserIndex=ogHostUserIndex, ogFirmwareVersion=ogFirmwareVersion, ogHostTable=ogHostTable, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientMac=ogWifiApClientMac, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioEntry=ogEmdDioEntry, ogWebUserEntry=ogWebUserEntry, ogHostEntry=ogHostEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcCounter=ogRpcCounter, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserName=ogWebUserName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceState=ogNetInterfaceState, ogHostServiceHost=ogHostServiceHost, ogCheckTable=ogCheckTable, ogWebUserNotification=ogWebUserNotification, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityName=ogEmdHumidityName, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientTable=ogWifiApClientTable, ogUpsTable=ogUpsTable, ogStatus2Compliance=ogStatus2Compliance, ogCellModemIMSI=ogCellModemIMSI, ogHostUserHost=ogHostUserHost, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcInputNotification=ogRpcInputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApSsid=ogWifiApSsid, ogEmdDioState=ogEmdDioState)
