...
Integer32, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, MibIdentifier, Bits, Gauge32, ModuleIdentity, Counter64, iso, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "MibIdentifier", "Bits", "Gauge32", "ModuleIdentity", "Counter64", "iso", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientAp=ogWifiApClientAp, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdEntry=ogEmdEntry, ogStatus2Compliance=ogStatus2Compliance, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioCounter=ogEmdDioCounter, ogSystem=ogSystem, ogWebUserEntry=ogWebUserEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmState=ogCurrentAlarmState, ogStatus2Conformance=ogStatus2Conformance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmInstance=ogAlarmInstance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmName=ogAlarmName, ogHostUserHost=ogHostUserHost, ogHostServiceType=ogHostServiceType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmTime=ogAlarmTime, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApTable=ogWifiApTable, ogCellModemEntry=ogCellModemEntry, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsTable=ogUpsTable, ogUpsType=ogUpsType, ogRpcCounter=ogRpcCounter, ogAlarmType=ogAlarmType, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletTable=ogRpcOutletTable, ogSerialUserPort=ogSerialUserPort, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioDescription=ogEmdDioDescription, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsTemperature=ogUpsTemperature, ogUpsDescription=ogUpsDescription, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApInterface=ogWifiApInterface, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserName=ogHostUserName, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioType=ogEmdDioType, ogFirmwareVersion=ogFirmwareVersion, ogCheckEntry=ogCheckEntry, ogHostUserHostName=ogHostUserHostName, ogEmdIndex=ogEmdIndex, ogEmdEnabled=ogEmdEnabled, ogCustomNotification=ogCustomNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcName=ogRpcName, ogCellModemTable=ogCellModemTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioName=ogEmdDioName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioIndex=ogEmdDioIndex, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmDevice=ogAlarmDevice, ogUpsEntry=ogUpsEntry, ogStatus2=ogStatus2, ogSerialUserName=ogSerialUserName, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsState=ogUpsState, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckName=ogCheckName, ogAlarmState=ogAlarmState, ogCellModemEnabled=ogCellModemEnabled, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceState=ogNetInterfaceState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckResolveActions=ogCheckResolveActions, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsHumidity=ogUpsHumidity, ogUpsName=ogUpsName, ogUpsConnectType=ogUpsConnectType, ogHostUserNotification=ogHostUserNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApSsid=ogWifiApSsid, ogSerialUserIndex=ogSerialUserIndex, ogCellModemModel=ogCellModemModel, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityValue=ogEmdHumidityValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServicePort=ogHostServicePort, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellApnNotification=ogCellApnNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortEntry=ogSerialPortEntry, ogWifiApCounter=ogWifiApCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogHostName=ogHostName, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdName=ogEmdName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmUser=ogAlarmUser, ogStatus2Groups=ogStatus2Groups, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApFrequency=ogWifiApFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientMac=ogWifiApClientMac, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserAddress=ogHostUserAddress, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmCheck=ogAlarmCheck, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellDataNotification=ogCellDataNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioTable=ogEmdDioTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcTable=ogRpcTable, ogHostServiceEntry=ogHostServiceEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientMode=ogWifiClientMode, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmSummary=ogAlarmSummary, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialNumber=ogSerialNumber, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemVendor=ogCellModemVendor, ogWebUserIndex=ogWebUserIndex, ogUpsIndex=ogUpsIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioNotification=ogEmdDioNotification, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcDescription=ogRpcDescription, ogHostUserEntry=ogHostUserEntry, ogHostEntry=ogHostEntry, ogCheckType=ogCheckType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemTower=ogCellModemTower, ogEmdHumidityName=ogEmdHumidityName, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogMibNotifications=ogMibNotifications, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcConnectType=ogRpcConnectType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcIndex=ogRpcIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioState=ogEmdDioState, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModem4gRssi=ogCellModem4gRssi, ogHostPingNotification=ogHostPingNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcType=ogRpcType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWebUserName=ogWebUserName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDescription=ogEmdDescription, ogWifiApEnabled=ogWifiApEnabled)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletState=ogRpcOutletState, ogHostServiceNotification=ogHostServiceNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletName=ogRpcOutletName, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceName=ogNetInterfaceName, ogCheckIndex=ogCheckIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsNotification=ogUpsNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserTable=ogHostUserTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientInterface=ogWifiClientInterface, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceTable=ogHostServiceTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserTable=ogSerialUserTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogCellNetworkNotification=ogCellNetworkNotification, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostTable=ogHostTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialUserEntry=ogSerialUserEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioEntry=ogEmdDioEntry, ogCellModemIndex=ogCellModemIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckTable=ogCheckTable, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceHost=ogHostServiceHost, ogEmdDioDirection=ogEmdDioDirection, ogEmdTable=ogEmdTable, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientTable=ogWifiClientTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostIndex=ogHostIndex, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioEmd=ogEmdDioEmd, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarm=ogAlarm, ogSerialPortDSR=ogSerialPortDSR, ogWebUserStartTime=ogWebUserStartTime, ogCellModemConnected=ogCellModemConnected, ogHostUserIndex=ogHostUserIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsCounter=ogUpsCounter, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApIndex=ogWifiApIndex, ogWebUserTable=ogWebUserTable, ogRpcEntry=ogRpcEntry, ogCellModemApn=ogCellModemApn, ogWifiClientCounter=ogWifiClientCounter)
