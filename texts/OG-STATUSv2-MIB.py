...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Gauge32, Integer32, Unsigned32, ModuleIdentity, NotificationType, Counter32, IpAddress, MibIdentifier, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Gauge32", "Integer32", "Unsigned32", "ModuleIdentity", "NotificationType", "Counter32", "IpAddress", "MibIdentifier", "Counter64", "Bits")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApInterface=ogWifiApInterface, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsConnectType=ogUpsConnectType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmCheck=ogAlarmCheck, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckDeviceName=ogCheckDeviceName, ogAlarmSummary=ogAlarmSummary, ogRpcCounter=ogRpcCounter, ogAlarmTime=ogAlarmTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemConnected=ogCellModemConnected, ogEmdEntry=ogEmdEntry, ogHostUserName=ogHostUserName, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryState=ogUpsBatteryState, ogCustomNotification=ogCustomNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletLoad=ogRpcOutletLoad, ogCellMessageNotification=ogCellMessageNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckEntry=ogCheckEntry, ogSerialUserIndex=ogSerialUserIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmName=ogAlarmName, ogUpsNotification=ogUpsNotification, ogEmdName=ogEmdName, ogSerialUserPort=ogSerialUserPort, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApSsid=ogWifiApSsid, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmType=ogCurrentAlarmType, ogHostServiceHost=ogHostServiceHost, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmType=ogAlarmType, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogTable=ogAlarmLogTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmEventId=ogAlarmEventId, ogWifiClientMode=ogWifiClientMode, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostUserStartTime=ogHostUserStartTime, ogRpcTable=ogRpcTable, ogStatus2Groups=ogStatus2Groups, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletName=ogRpcOutletName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemTable=ogCellModemTable, ogCellModemVendor=ogCellModemVendor, ogWifiClientRssi=ogWifiClientRssi, ogCellModemIndex=ogCellModemIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogNetInterfaceType=ogNetInterfaceType, ogWifiApCounter=ogWifiApCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortCTS=ogSerialPortCTS, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioEntry=ogEmdDioEntry, ogCheckIndex=ogCheckIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputTruePower=ogUpsOutputTruePower, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceNotification=ogHostServiceNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsTemperature=ogUpsTemperature, ogHostUserNotification=ogHostUserNotification, ogWifiApFrequency=ogWifiApFrequency, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserTable=ogHostUserTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortMode=ogSerialPortMode, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemTower=ogCellModemTower, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioType=ogEmdDioType, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserAddress=ogHostUserAddress, ogSerialUserName=ogSerialUserName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmUser=ogAlarmUser, ogHostUserHostName=ogHostUserHostName, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioTable=ogEmdDioTable, ogUpsEntry=ogUpsEntry, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemApn=ogCellModemApn, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceTable=ogHostServiceTable, ogWebUserTable=ogWebUserTable, ogWifiClientIndex=ogWifiClientIndex, ogUpsIndex=ogUpsIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioName=ogEmdDioName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellApnNotification=ogCellApnNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTable=ogEmdTable, ogHostIndex=ogHostIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApTable=ogWifiApTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostIpV4Address=ogHostIpV4Address, ogCellSignalNotification=ogCellSignalNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureValue=ogEmdTemperatureValue, ogStatus2Compliance=ogStatus2Compliance, ogSystem=ogSystem, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServiceCounter=ogHostServiceCounter, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioState=ogEmdDioState, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcEntry=ogRpcEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsCounter=ogUpsCounter, ogHostServiceIndex=ogHostServiceIndex, ogCellModemCounter=ogCellModemCounter, ogAlarm=ogAlarm, ogCellModemModel=ogCellModemModel, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceState=ogNetInterfaceState, ogHostEntry=ogHostEntry, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortTable=ogSerialPortTable, ogWebUserIndex=ogWebUserIndex, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientTable=ogWifiClientTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcType=ogRpcType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdConnectType=ogEmdConnectType, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientCounter=ogWifiClientCounter, ogStatus2Compliances=ogStatus2Compliances, ogPowerSupplyName=ogPowerSupplyName, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcName=ogRpcName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientTable=ogWifiApClientTable, ogUpsTable=ogUpsTable, ogEmdDescription=ogEmdDescription, ogCheckResolveActions=ogCheckResolveActions, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioEmd=ogEmdDioEmd, ogWifiApIndex=ogWifiApIndex, ogMibNotifications=ogMibNotifications, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserName=ogWebUserName, ogWifiApClientMac=ogWifiApClientMac, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientEssid=ogWifiClientEssid, ogAlarmState=ogAlarmState, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserIndex=ogHostUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserHost=ogHostUserHost)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserEntry=ogWebUserEntry, ogRpcDescription=ogRpcDescription, ogWebUserNotification=ogWebUserNotification, ogHostServiceEntry=ogHostServiceEntry, ogCellTowerNotification=ogCellTowerNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogCellDataNotification=ogCellDataNotification, ogFirmwareVersion=ogFirmwareVersion, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsState=ogUpsState, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortParity=ogSerialPortParity, ogCheckName=ogCheckName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckTable=ogCheckTable, ogUpsType=ogUpsType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdIndex=ogEmdIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemEntry=ogCellModemEntry, PYSNMP_MODULE_ID=ogStatus2, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceType=ogHostServiceType, ogAlarmDevice=ogAlarmDevice, ogSerialUserTable=ogSerialUserTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsName=ogUpsName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdEnabled=ogEmdEnabled, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcConnectType=ogRpcConnectType, ogUpsInputNotification=ogUpsInputNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemTemperature=ogCellModemTemperature, ogUpsOutputPower=ogUpsOutputPower, ogHostTable=ogHostTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortDCD=ogSerialPortDCD, ogWifiApTxPower=ogWifiApTxPower, ogStatus2=ogStatus2, ogHostName=ogHostName, ogHostUserEntry=ogHostUserEntry, ogRpcOutletTable=ogRpcOutletTable, ogHostServicePort=ogHostServicePort, ogSerialNumber=ogSerialNumber, ogCheckType=ogCheckType, ogCellModemNetwork=ogCellModemNetwork, ogRpcIndex=ogRpcIndex, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientInterface=ogWifiClientInterface, ogUpsDescription=ogUpsDescription)
