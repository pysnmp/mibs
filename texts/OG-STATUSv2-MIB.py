...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, iso, NotificationType, Counter32, Counter64, Gauge32, Unsigned32, Bits, TimeTicks, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "iso", "NotificationType", "Counter32", "Counter64", "Gauge32", "Unsigned32", "Bits", "TimeTicks", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientEntry=ogWifiClientEntry, ogUpsConnectType=ogUpsConnectType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortTable=ogSerialPortTable, ogHostServiceCounter=ogHostServiceCounter, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcName=ogRpcName, ogRpcLogEnabled=ogRpcLogEnabled, ogStatus2Groups=ogStatus2Groups, ogHostUserTable=ogHostUserTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioType=ogEmdDioType, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientTable=ogWifiClientTable, ogWebUserTable=ogWebUserTable, ogUpsInputNotification=ogUpsInputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsTable=ogUpsTable, ogAlarmName=ogAlarmName, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckIndex=ogCheckIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDescription=ogEmdDescription, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellDataNotification=ogCellDataNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemEnabled=ogCellModemEnabled, ogHostTable=ogHostTable, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortLabel=ogSerialPortLabel, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmUser=ogAlarmUser, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmType=ogAlarmType, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWebUserIndex=ogWebUserIndex, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletState=ogRpcOutletState, ogEmdConnectType=ogEmdConnectType, ogWifiApClientAp=ogWifiApClientAp, ogRpcEntry=ogRpcEntry, ogSerialPortParity=ogSerialPortParity, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmTime=ogAlarmTime, ogUpsDescription=ogUpsDescription, ogCellTowerNotification=ogCellTowerNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyName=ogPowerSupplyName, ogUpsOutputLoad=ogUpsOutputLoad, PYSNMP_MODULE_ID=ogStatus2, ogHostUserEntry=ogHostUserEntry, ogEmdTable=ogEmdTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostIpV6Address=ogHostIpV6Address, ogAlarmTriggerValue=ogAlarmTriggerValue, ogNetInterfaceName=ogNetInterfaceName, ogUpsEntry=ogUpsEntry, ogCheckName=ogCheckName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemApn=ogCellModemApn, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsIndex=ogUpsIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryState=ogUpsBatteryState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsState=ogUpsState, ogAlarmCheck=ogAlarmCheck, ogHostPingNotification=ogHostPingNotification, ogWifiApTable=ogWifiApTable, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceTable=ogCheckDeviceTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiApEntry=ogWifiApEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletTable=ogRpcOutletTable, ogCellApnNotification=ogCellApnNotification, ogRpcConnectType=ogRpcConnectType, ogAlarm=ogAlarm, ogCustomNotification=ogCustomNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemNetwork=ogCellModemNetwork, ogRpcCounter=ogRpcCounter, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApSsid=ogWifiApSsid, ogWebUserStartTime=ogWebUserStartTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostUserHostName=ogHostUserHostName, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApCounter=ogWifiApCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogMibNotifications=ogMibNotifications, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortRTS=ogSerialPortRTS, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserHost=ogHostUserHost, ogRpcTable=ogRpcTable, ogCellModemTemperature=ogCellModemTemperature, ogHostUserName=ogHostUserName, ogSerialNumber=ogSerialNumber, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemTower=ogCellModemTower, ogWifiClientCounter=ogWifiClientCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApIndex=ogWifiApIndex, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdEnabled=ogEmdEnabled, ogUpsHumidity=ogUpsHumidity, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialUserName=ogSerialUserName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdIndex=ogEmdIndex, ogAlarmDevice=ogAlarmDevice, ogRpcType=ogRpcType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceHost=ogHostServiceHost, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemTable=ogCellModemTable, ogCheckResolveActions=ogCheckResolveActions, ogUpsName=ogUpsName, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmInstance=ogAlarmInstance, ogWifiClientEssid=ogWifiClientEssid, ogCheckEntry=ogCheckEntry, ogHostUserStartTime=ogHostUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientTable=ogWifiApClientTable, ogAlarmSummary=ogAlarmSummary, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioInputTotal=ogEmdDioInputTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioIndex=ogEmdDioIndex, ogHostIndex=ogHostIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletLoad=ogRpcOutletLoad, ogHostName=ogHostName, ogWebUserNotification=ogWebUserNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientFrequency=ogWifiClientFrequency, ogHostServiceEntry=ogHostServiceEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWebUserName=ogWebUserName, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputPower=ogUpsOutputPower, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserAddress=ogHostUserAddress, ogSerialUserPort=ogSerialUserPort, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemConnected=ogCellModemConnected, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmState=ogAlarmState, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostServiceType=ogHostServiceType, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckTable=ogCheckTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmEventId=ogAlarmEventId, ogWifiApTxPower=ogWifiApTxPower, ogStatus2=ogStatus2, ogRpcOutletVoltage=ogRpcOutletVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsTemperature=ogUpsTemperature, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioState=ogEmdDioState, ogEmdDioCounter=ogEmdDioCounter, ogCellModemEntry=ogCellModemEntry, ogEmdEntry=ogEmdEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmType=ogCurrentAlarmType, ogHostServicePort=ogHostServicePort, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserIndex=ogHostUserIndex, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcDescription=ogRpcDescription, ogHostEntry=ogHostEntry, ogCellModemIndex=ogCellModemIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientIndex=ogWifiClientIndex, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Compliance=ogStatus2Compliance, ogRpcIndex=ogRpcIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioName=ogEmdDioName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckType=ogCheckType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdName=ogEmdName, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioEmd=ogEmdDioEmd, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemModel=ogCellModemModel, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortMode=ogSerialPortMode, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSystem=ogSystem, ogCellModemVendor=ogCellModemVendor, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceStatus=ogHostServiceStatus, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletName=ogRpcOutletName, ogSerialUserTable=ogSerialUserTable, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortDCD=ogSerialPortDCD, ogUpsType=ogUpsType, ogWifiClientRssi=ogWifiClientRssi, ogUpsNotification=ogUpsNotification, ogAlarmLogTable=ogAlarmLogTable, ogUpsCounter=ogUpsCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserNotification=ogHostUserNotification, ogHostServiceTable=ogHostServiceTable)
