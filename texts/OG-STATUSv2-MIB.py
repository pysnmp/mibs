...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarm=ogAlarm, ogEmdName=ogEmdName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsEntry=ogUpsEntry, ogCellApnNotification=ogCellApnNotification, ogHostServiceNotification=ogHostServiceNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemEnabled=ogCellModemEnabled, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmName=ogAlarmName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserAddress=ogHostUserAddress, ogStatus2Compliances=ogStatus2Compliances, ogWebUserName=ogWebUserName, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostServicePort=ogHostServicePort, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckTable=ogCheckTable, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioState=ogEmdDioState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmUser=ogAlarmUser, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserName=ogSerialUserName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceCounter=ogHostServiceCounter, ogCellModemNetwork=ogCellModemNetwork, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserName=ogHostUserName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientMac=ogWifiApClientMac, ogWebUserNotification=ogWebUserNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceHost=ogHostServiceHost, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientInterface=ogWifiClientInterface, ogWifiApSsid=ogWifiApSsid, ogUpsName=ogUpsName, ogUpsState=ogUpsState, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemTower=ogCellModemTower, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortParity=ogSerialPortParity, ogSerialPortTable=ogSerialPortTable, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioTable=ogEmdDioTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioEntry=ogEmdDioEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientTable=ogWifiApClientTable, ogEmdEntry=ogEmdEntry, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdConnectType=ogEmdConnectType, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserPort=ogSerialUserPort, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserStartTime=ogWebUserStartTime, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemEntry=ogCellModemEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyName=ogPowerSupplyName, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTable=ogEmdTable, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostTable=ogHostTable, ogEmdDioIndex=ogEmdDioIndex, ogAlarmSummary=ogAlarmSummary, ogWebUserIndex=ogWebUserIndex, ogMibNotifications=ogMibNotifications, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcName=ogRpcName, ogCellMessageNotification=ogCellMessageNotification, ogHostIpV4Address=ogHostIpV4Address, ogAlarmLogEntry=ogAlarmLogEntry, ogHostEntry=ogHostEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialNumber=ogSerialNumber, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdIndex=ogEmdIndex, ogSerialPortDCD=ogSerialPortDCD, ogNetInterfaceName=ogNetInterfaceName, ogUpsNotification=ogUpsNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcType=ogRpcType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemIndex=ogCellModemIndex, ogHostUserHost=ogHostUserHost, ogWifiApTable=ogWifiApTable, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletName=ogRpcOutletName, ogSerialUserNotification=ogSerialUserNotification, ogWifiApInterface=ogWifiApInterface, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserIndex=ogHostUserIndex, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientAp=ogWifiApClientAp, ogStatus2Conformance=ogStatus2Conformance, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApEntry=ogWifiApEntry, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserHostName=ogHostUserHostName, ogRpcEntry=ogRpcEntry, ogSerialUserEntry=ogSerialUserEntry, ogHostUserEntry=ogHostUserEntry, ogHostName=ogHostName, ogUpsHumidity=ogUpsHumidity, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserNotification=ogHostUserNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemTable=ogCellModemTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcIndex=ogRpcIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSystem=ogSystem, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcTable=ogRpcTable, ogAlarmEventId=ogAlarmEventId, ogAlarmType=ogAlarmType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserTable=ogSerialUserTable, ogUpsIndex=ogUpsIndex, ogAlarmLogTable=ogAlarmLogTable, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcInputNotification=ogRpcInputNotification, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientEssid=ogWifiClientEssid, ogHostPingNotification=ogHostPingNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServiceType=ogHostServiceType, ogHostUserTable=ogHostUserTable, ogAlarmCheck=ogAlarmCheck, ogSerialPortDSR=ogSerialPortDSR, ogRpcCounter=ogRpcCounter, ogCheckEntry=ogCheckEntry, ogEmdDioNotification=ogEmdDioNotification, ogFirmwareVersion=ogFirmwareVersion, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmType=ogCurrentAlarmType, ogWebUserTable=ogWebUserTable, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmState=ogAlarmState, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsCounter=ogUpsCounter, ogCellModemConnected=ogCellModemConnected, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostIndex=ogHostIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRssi=ogWifiClientRssi, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApTxPower=ogWifiApTxPower, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmTime=ogAlarmTime, ogEmdDioName=ogEmdDioName, ogWifiClientEntry=ogWifiClientEntry, ogUpsTable=ogUpsTable, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletVoltage=ogRpcOutletVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsType=ogUpsType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletTable=ogRpcOutletTable, ogWebUserEntry=ogWebUserEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckIndex=ogCheckIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsTemperature=ogUpsTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCustomNotification=ogCustomNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckName=ogCheckName, ogStatus2=ogStatus2, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioDirection=ogEmdDioDirection, ogCellSignalNotification=ogCellSignalNotification, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDescription=ogEmdDescription, ogEmdDioType=ogEmdDioType, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmTable=ogCurrentAlarmTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsConnectType=ogUpsConnectType, ogWifiClientCounter=ogWifiClientCounter, ogCellModemModel=ogCellModemModel, ogWifiApCounter=ogWifiApCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckType=ogCheckType, ogRpcDescription=ogRpcDescription, ogCellModemApn=ogCellModemApn, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceTable=ogHostServiceTable, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsDescription=ogUpsDescription, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellDataNotification=ogCellDataNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletIndex=ogRpcOutletIndex, ogStatus2Groups=ogStatus2Groups, ogRpcConnectType=ogRpcConnectType, ogUpsInputNotification=ogUpsInputNotification)
