...
Integer32, iso, TimeTicks, MibIdentifier, Bits, ObjectIdentity, Counter32, ModuleIdentity, Unsigned32, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "TimeTicks", "MibIdentifier", "Bits", "ObjectIdentity", "Counter32", "ModuleIdentity", "Unsigned32", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryState=ogUpsBatteryState, ogSerialNumber=ogSerialNumber, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmEventId=ogAlarmEventId, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdEnabled=ogEmdEnabled, ogUpsOutputTruePower=ogUpsOutputTruePower, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApEnabled=ogWifiApEnabled, ogHostUserHost=ogHostUserHost, ogAlarmName=ogAlarmName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemApn=ogCellModemApn, ogEmdDioNotification=ogEmdDioNotification, ogCellApnNotification=ogCellApnNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortTable=ogSerialPortTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmCheck=ogAlarmCheck, ogRpcTable=ogRpcTable, ogSerialPortCTS=ogSerialPortCTS, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceName=ogCheckDeviceName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialUserName=ogSerialUserName, ogUpsHumidity=ogUpsHumidity, ogHostTable=ogHostTable, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCustomNotification=ogCustomNotification, ogWifiClientTable=ogWifiClientTable, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemVendor=ogCellModemVendor, ogWifiApInterface=ogWifiApInterface, ogWifiApTable=ogWifiApTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarm=ogAlarm, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostServiceEntry=ogHostServiceEntry, ogCellModemTable=ogCellModemTable, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioType=ogEmdDioType, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserAddress=ogHostUserAddress, ogCellModemEntry=ogCellModemEntry, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserNotification=ogHostUserNotification, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApCounter=ogWifiApCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioName=ogEmdDioName, ogHostUserTable=ogHostUserTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityName=ogEmdHumidityName, ogAlarmTime=ogAlarmTime, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientAp=ogWifiApClientAp, ogEmdTable=ogEmdTable, ogSerialPortParity=ogSerialPortParity, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserName=ogHostUserName, ogPowerSupplyTable=ogPowerSupplyTable, ogSystem=ogSystem, ogRpcCounter=ogRpcCounter, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortDTR=ogSerialPortDTR, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApIndex=ogWifiApIndex, ogCellDataNotification=ogCellDataNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioState=ogEmdDioState, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientCounter=ogWifiClientCounter, ogUpsState=ogUpsState, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostUserEntry=ogHostUserEntry, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientMode=ogWifiClientMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmUser=ogAlarmUser, ogEmdHumidityTotal=ogEmdHumidityTotal, ogStatus2Conformance=ogStatus2Conformance, ogAlarmSummary=ogAlarmSummary, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletState=ogRpcOutletState, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckName=ogCheckName, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceStatus=ogHostServiceStatus, ogHostServiceNotification=ogHostServiceNotification, ogHostIndex=ogHostIndex, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsEntry=ogUpsEntry, ogRpcType=ogRpcType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioIndex=ogEmdDioIndex, ogEmdDescription=ogEmdDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcName=ogRpcName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientMac=ogWifiApClientMac, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogWebUserName=ogWebUserName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsConnectType=ogUpsConnectType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientEssid=ogWifiClientEssid, ogWebUserEntry=ogWebUserEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserStartTime=ogWebUserStartTime, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortMode=ogSerialPortMode, ogSerialUserPort=ogSerialUserPort, ogNetInterfaceName=ogNetInterfaceName, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserStartTime=ogHostUserStartTime, ogUpsTable=ogUpsTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcInputNotification=ogRpcInputNotification, ogWifiApTxPower=ogWifiApTxPower, ogCellTowerNotification=ogCellTowerNotification, ogRpcIndex=ogRpcIndex, ogWifiApSsid=ogWifiApSsid, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckEntry=ogCheckEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceHost=ogHostServiceHost, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmInstance=ogAlarmInstance, ogUpsType=ogUpsType, ogHostIpV6Address=ogHostIpV6Address, ogCellModemIndex=ogCellModemIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemModel=ogCellModemModel, ogUpsTemperature=ogUpsTemperature, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckType=ogCheckType, ogRpcEntry=ogRpcEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsName=ogUpsName, ogEmdIndex=ogEmdIndex, ogUpsDescription=ogUpsDescription, ogSerialPortRTS=ogSerialPortRTS, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceType=ogHostServiceType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcOutletName=ogRpcOutletName, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsIndex=ogUpsIndex, ogHostServicePort=ogHostServicePort, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioEmd=ogEmdDioEmd, ogHostPingNotification=ogHostPingNotification, ogWifiApFrequency=ogWifiApFrequency)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostName=ogHostName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdEntry=ogEmdEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceType=ogNetInterfaceType, ogUpsCounter=ogUpsCounter, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2Compliances=ogStatus2Compliances, ogAlarmType=ogAlarmType, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsNotification=ogUpsNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemIMSI=ogCellModemIMSI, ogCellModemTower=ogCellModemTower, ogStatus2=ogStatus2, ogHostEntry=ogHostEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceTable=ogHostServiceTable, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApEntry=ogWifiApEntry, ogSerialUserTable=ogSerialUserTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmState=ogAlarmState, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioTable=ogEmdDioTable, ogHostIpV4Address=ogHostIpV4Address, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdConnectType=ogEmdConnectType, ogCheckIndex=ogCheckIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdName=ogEmdName, ogMibNotifications=ogMibNotifications, ogRpcDescription=ogRpcDescription, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortDCD=ogSerialPortDCD, ogWebUserNotification=ogWebUserNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemRegistered=ogCellModemRegistered)
