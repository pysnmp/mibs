...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceName=ogNetInterfaceName, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserName=ogSerialUserName, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioName=ogEmdDioName, ogCellModemNetwork=ogCellModemNetwork, ogAlarmType=ogAlarmType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmDevice=ogAlarmDevice, ogSystem=ogSystem, ogHostIpV4Address=ogHostIpV4Address, ogUpsEntry=ogUpsEntry, ogEmdConnectType=ogEmdConnectType, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostPingNotification=ogHostPingNotification, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientCounter=ogWifiClientCounter, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletState=ogRpcOutletState, ogCellModemCounter=ogCellModemCounter, ogHostIndex=ogHostIndex, ogEmdDescription=ogEmdDescription, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioTable=ogEmdDioTable, ogRpcCounter=ogRpcCounter, ogHostUserTable=ogHostUserTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsTable=ogUpsTable, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletName=ogRpcOutletName, ogRpcIndex=ogRpcIndex, ogMibNotifications=ogMibNotifications, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsTemperature=ogUpsTemperature, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcTable=ogRpcTable, ogUpsConnectType=ogUpsConnectType, ogHostUserIndex=ogHostUserIndex, ogAlarmLogTable=ogAlarmLogTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortLabel=ogSerialPortLabel, ogCellModemModel=ogCellModemModel, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortTable=ogSerialPortTable, ogEmdDioEntry=ogEmdDioEntry, ogRpcName=ogRpcName, ogCheckTable=ogCheckTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityName=ogEmdHumidityName, ogHostUserAddress=ogHostUserAddress, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityTable=ogEmdHumidityTable, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserIndex=ogWebUserIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckDeviceTable=ogCheckDeviceTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckType=ogCheckType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemTower=ogCellModemTower, ogHostServiceIndex=ogHostServiceIndex, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryState=ogUpsBatteryState, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellSignalNotification=ogCellSignalNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcType=ogRpcType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApInterface=ogWifiApInterface, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckEntry=ogCheckEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientEssid=ogWifiClientEssid, ogSerialNumber=ogSerialNumber, ogRpcConnectType=ogRpcConnectType, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortCTS=ogSerialPortCTS, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcDescription=ogRpcDescription, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientTable=ogWifiApClientTable, ogCheckResetTimeout=ogCheckResetTimeout, ogHostTable=ogHostTable, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortMode=ogSerialPortMode, ogHostUserHost=ogHostUserHost, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserStartTime=ogWebUserStartTime, ogRpcInputCurrent=ogRpcInputCurrent, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortParity=ogSerialPortParity, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostEntry=ogHostEntry, ogCheckDeviceName=ogCheckDeviceName, ogWifiApCounter=ogWifiApCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletTable=ogRpcOutletTable, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemVendor=ogCellModemVendor, ogWifiClientMode=ogWifiClientMode, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckIndex=ogCheckIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmEventId=ogAlarmEventId, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceState=ogNetInterfaceState, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostUserName=ogHostUserName, ogHostName=ogHostName, ogCellModemEntry=ogCellModemEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsType=ogUpsType, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserNotification=ogHostUserNotification, ogEmdDioDescription=ogEmdDioDescription, ogAlarmTime=ogAlarmTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserTable=ogSerialUserTable, ogUpsHumidity=ogUpsHumidity, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceStatus=ogHostServiceStatus, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientIndex=ogWifiClientIndex, ogNetInterfaceType=ogNetInterfaceType, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemTemperature=ogCellModemTemperature, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdName=ogEmdName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostServiceCounter=ogHostServiceCounter, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsCounter=ogUpsCounter, ogEmdDioType=ogEmdDioType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioCounter=ogEmdDioCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmName=ogAlarmName, ogCellDataNotification=ogCellDataNotification, ogWebUserTable=ogWebUserTable, ogHostServiceTable=ogHostServiceTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletLoad=ogRpcOutletLoad, ogHostUserEntry=ogHostUserEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceEntry=ogHostServiceEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApSsid=ogWifiApSsid, ogAlarm=ogAlarm, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApTable=ogWifiApTable, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemIndex=ogCellModemIndex, ogCellModemTable=ogCellModemTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortDTR=ogSerialPortDTR, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTable=ogEmdTable, ogEmdIndex=ogEmdIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputCurrent=ogUpsOutputCurrent)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemRegistered=ogCellModemRegistered, ogSerialUserPort=ogSerialUserPort, ogAlarmState=ogAlarmState, ogPowerSupplyName=ogPowerSupplyName, ogAlarmInstance=ogAlarmInstance, ogStatus2=ogStatus2, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioState=ogEmdDioState, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApEntry=ogWifiApEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApIndex=ogWifiApIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserNotification=ogWebUserNotification, ogHostServiceHost=ogHostServiceHost, ogUpsDescription=ogUpsDescription, ogCellModemApn=ogCellModemApn, ogCheckName=ogCheckName, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCustomNotification=ogCustomNotification, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortIndex=ogSerialPortIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcEntry=ogRpcEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmSummary=ogAlarmSummary, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogStatus2Conformance=ogStatus2Conformance, ogEmdEntry=ogEmdEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsName=ogUpsName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserEntry=ogSerialUserEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientEntry=ogWifiClientEntry, ogHostServiceType=ogHostServiceType, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsIndex=ogUpsIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWebUserName=ogWebUserName, ogAlarmUser=ogAlarmUser, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserLabel=ogSerialUserLabel, ogStatus2Compliances=ogStatus2Compliances, ogUpsState=ogUpsState, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostServicePort=ogHostServicePort, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsNotification=ogUpsNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification)
