...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTable=ogEmdTable, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsType=ogUpsType, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioName=ogEmdDioName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApIndex=ogWifiApIndex, ogUpsName=ogUpsName, ogSerialPortParity=ogSerialPortParity, ogSerialPortDSR=ogSerialPortDSR, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortSpeed=ogSerialPortSpeed, ogHostName=ogHostName, ogUpsDescription=ogUpsDescription, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletState=ogRpcOutletState, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWebUserStartTime=ogWebUserStartTime, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostIndex=ogHostIndex, ogEmdDioType=ogEmdDioType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServiceType=ogHostServiceType, ogCheckType=ogCheckType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioState=ogEmdDioState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmType=ogAlarmType, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcCounter=ogRpcCounter, ogEmdConnectType=ogEmdConnectType, ogRpcEntry=ogRpcEntry, ogSerialPortCTS=ogSerialPortCTS, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemTable=ogCellModemTable, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmSummary=ogAlarmSummary, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserNotification=ogWebUserNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogHostTable=ogHostTable, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmTime=ogAlarmTime, ogRpcDescription=ogRpcDescription, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceHost=ogHostServiceHost, ogUpsState=ogUpsState, ogWebUserIndex=ogWebUserIndex, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellApnNotification=ogCellApnNotification, ogWifiApTxPower=ogWifiApTxPower, ogWebUserName=ogWebUserName, ogCellModemApn=ogCellModemApn, ogCheckEntry=ogCheckEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityName=ogEmdHumidityName, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialUserLabel=ogSerialUserLabel, ogRpcName=ogRpcName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientEssid=ogWifiClientEssid, ogHostServiceStatus=ogHostServiceStatus, ogAlarmUser=ogAlarmUser, ogWebUserTable=ogWebUserTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApInterface=ogWifiApInterface, ogStatus2Conformance=ogStatus2Conformance, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserName=ogHostUserName, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientInterface=ogWifiClientInterface, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcIndex=ogRpcIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioEntry=ogEmdDioEntry, ogHostServiceTable=ogHostServiceTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientCounter=ogWifiClientCounter, ogAlarmEventId=ogAlarmEventId, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcInputNotification=ogRpcInputNotification, ogCellDataNotification=ogCellDataNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostEntry=ogHostEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemIMSI=ogCellModemIMSI, ogCellModemEntry=ogCellModemEntry, ogCellModemTower=ogCellModemTower, ogAlarmState=ogAlarmState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsTable=ogUpsTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsCounter=ogUpsCounter, ogWifiApTable=ogWifiApTable, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientMode=ogWifiClientMode, ogSerialPortTable=ogSerialPortTable, ogSerialUserPort=ogSerialUserPort, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogNetInterfaceType=ogNetInterfaceType, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletIndex=ogRpcOutletIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2=ogStatus2, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmInstance=ogAlarmInstance, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputPower=ogUpsOutputPower, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApCounter=ogWifiApCounter, ogAlarm=ogAlarm, ogSerialUserTable=ogSerialUserTable, ogHostUserHostName=ogHostUserHostName, ogHostUserHost=ogHostUserHost, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceRef=ogCheckDeviceRef, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcTable=ogRpcTable, ogCellModemModel=ogCellModemModel, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsNotification=ogUpsNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientTable=ogWifiApClientTable, ogHostUserNotification=ogHostUserNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserEntry=ogHostUserEntry, ogHostUserTable=ogHostUserTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemCounter=ogCellModemCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdIndex=ogEmdIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioIndex=ogEmdDioIndex, ogFirmwareVersion=ogFirmwareVersion, ogAlarmLogTable=ogAlarmLogTable, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdEntry=ogEmdEntry, ogEmdDescription=ogEmdDescription, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortDCD=ogSerialPortDCD, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApFrequency=ogWifiApFrequency, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioEmd=ogEmdDioEmd, ogUpsTemperature=ogUpsTemperature, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsIndex=ogUpsIndex, PYSNMP_MODULE_ID=ogStatus2, ogSystem=ogSystem, ogHostUserIndex=ogHostUserIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortEntry=ogSerialPortEntry, ogCheckIndex=ogCheckIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogCustomNotification=ogCustomNotification, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmDevice=ogCurrentAlarmDevice)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmName=ogAlarmName, ogCellModemConnected=ogCellModemConnected, ogHostServiceCounter=ogHostServiceCounter, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortMode=ogSerialPortMode, ogEmdName=ogEmdName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsInputNotification=ogUpsInputNotification, ogCellMessageNotification=ogCellMessageNotification, ogRpcType=ogRpcType, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyName=ogPowerSupplyName, ogCheckName=ogCheckName, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialNumber=ogSerialNumber, ogEmdTemperatureValue=ogEmdTemperatureValue, ogStatus2Groups=ogStatus2Groups, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmCheck=ogAlarmCheck, ogCheckTable=ogCheckTable, ogAlarmDevice=ogAlarmDevice, ogRpcOutletName=ogRpcOutletName, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceState=ogNetInterfaceState, ogCellModemIndex=ogCellModemIndex, ogCellModemTemperature=ogCellModemTemperature, ogCellTowerNotification=ogCellTowerNotification, ogMibNotifications=ogMibNotifications, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsEntry=ogUpsEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientApMac=ogWifiClientApMac, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogHostUserStartTime=ogHostUserStartTime, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientEntry=ogWifiClientEntry, ogRpcConnectType=ogRpcConnectType, ogSerialUserName=ogSerialUserName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputVoltage=ogUpsOutputVoltage, ogStatus2Compliance=ogStatus2Compliance, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioTable=ogEmdDioTable, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApSsid=ogWifiApSsid, ogHostIpV6Address=ogHostIpV6Address, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceNotification=ogHostServiceNotification, ogWifiApEnabled=ogWifiApEnabled, ogHostServicePort=ogHostServicePort)
