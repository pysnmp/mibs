...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientEntry=ogWifiClientEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcMaxTemperature=ogRpcMaxTemperature, ogStatus2Groups=ogStatus2Groups, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckIndex=ogCheckIndex, ogAlarmDevice=ogAlarmDevice, ogCheckResolveActions=ogCheckResolveActions, ogUpsTable=ogUpsTable, ogCellModemModel=ogCellModemModel, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletIndex=ogRpcOutletIndex, ogHostTable=ogHostTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServiceCounter=ogHostServiceCounter, ogUpsName=ogUpsName, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostIpV4Address=ogHostIpV4Address, ogHostUserStartTime=ogHostUserStartTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsHumidity=ogUpsHumidity, ogRpcOutletTable=ogRpcOutletTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserName=ogHostUserName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialUserName=ogSerialUserName, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmLogTable=ogAlarmLogTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcInputVoltage=ogRpcInputVoltage, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDescription=ogEmdDescription, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2=ogStatus2, ogEmdDioState=ogEmdDioState, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostUserEntry=ogHostUserEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogHostEntry=ogHostEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcName=ogRpcName, ogCellModemTable=ogCellModemTable, ogWifiApEnabled=ogWifiApEnabled, ogHostUserAddress=ogHostUserAddress, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostUserHostName=ogHostUserHostName, ogAlarmType=ogAlarmType, ogHostServiceEntry=ogHostServiceEntry, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceTable=ogHostServiceTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellNetworkNotification=ogCellNetworkNotification, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserTable=ogSerialUserTable, ogSerialUserPort=ogSerialUserPort, ogAlarmSummary=ogAlarmSummary, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcEntry=ogRpcEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckDeviceTable=ogCheckDeviceTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsType=ogUpsType, ogCellTowerNotification=ogCellTowerNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityName=ogEmdHumidityName, ogEmdDioEntry=ogEmdDioEntry, ogWebUserStartTime=ogWebUserStartTime, ogCellModemRegistered=ogCellModemRegistered, ogUpsEntry=ogUpsEntry, ogFirmwareVersion=ogFirmwareVersion, ogUpsInputNotification=ogUpsInputNotification, ogCellModemEnabled=ogCellModemEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemApn=ogCellModemApn, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceStatus=ogHostServiceStatus, ogNetInterfaceName=ogNetInterfaceName, ogEmdTable=ogEmdTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApSsid=ogWifiApSsid, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputNotification=ogRpcInputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserIndex=ogWebUserIndex, ogSerialPortLabel=ogSerialPortLabel, ogEmdEnabled=ogEmdEnabled, ogCellModemNetwork=ogCellModemNetwork, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortIndex=ogSerialPortIndex, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCustomNotification=ogCustomNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemCounter=ogCellModemCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemTower=ogCellModemTower, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdEntry=ogEmdEntry, ogRpcIndex=ogRpcIndex, ogUpsCounter=ogUpsCounter, ogHostUserHost=ogHostUserHost, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostPingNotification=ogHostPingNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcCounter=ogRpcCounter, ogHostServiceNotification=ogHostServiceNotification, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientTable=ogWifiClientTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApCounter=ogWifiApCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserNotification=ogWebUserNotification, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckEntry=ogCheckEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioName=ogEmdDioName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsState=ogUpsState, ogEmdIndex=ogEmdIndex, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserTable=ogWebUserTable, ogWifiClientRssi=ogWifiClientRssi, ogWifiApIndex=ogWifiApIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcConnectType=ogRpcConnectType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsDescription=ogUpsDescription, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserTable=ogHostUserTable, ogWifiApEntry=ogWifiApEntry, ogSystem=ogSystem, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioType=ogEmdDioType, ogSerialNumber=ogSerialNumber, ogRpcTable=ogRpcTable, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioNotification=ogEmdDioNotification, ogCheckTable=ogCheckTable, ogSerialUserEntry=ogSerialUserEntry, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApTable=ogWifiApTable, ogWifiApClientTable=ogWifiApClientTable, ogHostServicePort=ogHostServicePort, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostIndex=ogHostIndex, ogWebUserName=ogWebUserName, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogHostName=ogHostName, ogCurrentAlarmTable=ogCurrentAlarmTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmLogEntry=ogAlarmLogEntry, ogCheckName=ogCheckName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckType=ogCheckType, ogSerialPortParity=ogSerialPortParity, ogRpcDescription=ogRpcDescription, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletName=ogRpcOutletName, ogMibNotifications=ogMibNotifications, ogRpcType=ogRpcType, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemIndex=ogCellModemIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsIndex=ogUpsIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmState=ogAlarmState, ogSerialPortMode=ogSerialPortMode, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemEntry=ogCellModemEntry, ogUpsConnectType=ogUpsConnectType, ogHostServiceType=ogHostServiceType, ogWebUserEntry=ogWebUserEntry, ogPowerSupplyName=ogPowerSupplyName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmUser=ogAlarmUser, ogEmdConnectType=ogEmdConnectType, ogRpcOutletState=ogRpcOutletState, ogCellModemConnected=ogCellModemConnected, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortRTS=ogSerialPortRTS, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarm=ogAlarm, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioDirection=ogEmdDioDirection, ogCellModemIMSI=ogCellModemIMSI, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsNotification=ogUpsNotification, ogSerialUserIndex=ogSerialUserIndex, ogEmdName=ogEmdName, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortTable=ogSerialPortTable, PYSNMP_MODULE_ID=ogStatus2, ogAlarmEventId=ogAlarmEventId, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmName=ogAlarmName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientMode=ogWifiClientMode, ogAlarmCheck=ogAlarmCheck, ogCheckTriggerActions=ogCheckTriggerActions, ogCellMessageNotification=ogCellMessageNotification, ogAlarmTime=ogAlarmTime, ogEmdDioIndex=ogEmdDioIndex, ogUpsTemperature=ogUpsTemperature)
