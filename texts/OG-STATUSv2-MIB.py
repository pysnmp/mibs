...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdConnectType=ogEmdConnectType, ogUpsInputNotification=ogUpsInputNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserEntry=ogSerialUserEntry, ogWebUserStartTime=ogWebUserStartTime, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortMode=ogSerialPortMode, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostEntry=ogHostEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletName=ogRpcOutletName, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWebUserTable=ogWebUserTable, ogAlarmInstance=ogAlarmInstance, ogRpcOutletIndex=ogRpcOutletIndex, ogCellTowerNotification=ogCellTowerNotification, ogCellApnNotification=ogCellApnNotification, ogWifiClientTable=ogWifiClientTable, ogEmdTable=ogEmdTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostIndex=ogHostIndex, ogEmdDioTable=ogEmdDioTable, ogRpcName=ogRpcName, ogAlarmSummary=ogAlarmSummary, ogUpsBatteryState=ogUpsBatteryState, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApCounter=ogWifiApCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckName=ogCheckName, ogWifiApClientMac=ogWifiApClientMac, ogCellModemCounter=ogCellModemCounter, ogRpcInputNotification=ogRpcInputNotification, ogWifiApFrequency=ogWifiApFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserStartTime=ogHostUserStartTime, ogHostServicePort=ogHostServicePort, ogCellModemModel=ogCellModemModel, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemTemperature=ogCellModemTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckType=ogCheckType, ogHostPingNotification=ogHostPingNotification, ogSerialPortEntry=ogSerialPortEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceHost=ogHostServiceHost, ogSerialUserName=ogSerialUserName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemEntry=ogCellModemEntry, ogCellModemTower=ogCellModemTower, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserNotification=ogWebUserNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletState=ogRpcOutletState, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletNotification=ogRpcOutletNotification, ogSystem=ogSystem, ogRpcOutputNotification=ogRpcOutputNotification, ogHostTable=ogHostTable, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserNotification=ogSerialUserNotification, ogAlarmCheck=ogAlarmCheck, PYSNMP_MODULE_ID=ogStatus2, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcDescription=ogRpcDescription, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceType=ogHostServiceType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdEnabled=ogEmdEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsIndex=ogUpsIndex, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientAp=ogWifiApClientAp, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogMibNotifications=ogMibNotifications, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientInterface=ogWifiClientInterface, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortParity=ogSerialPortParity, ogWifiClientMode=ogWifiClientMode, ogHostServiceEntry=ogHostServiceEntry, ogRpcEntry=ogRpcEntry, ogCellModemApn=ogCellModemApn, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Groups=ogStatus2Groups, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsType=ogUpsType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserName=ogHostUserName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckIndex=ogCheckIndex, ogRpcCounter=ogRpcCounter, ogAlarmTime=ogAlarmTime, ogCheckDeviceName=ogCheckDeviceName, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcType=ogRpcType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsTable=ogUpsTable, ogHostServiceTable=ogHostServiceTable, ogHostIpV4Address=ogHostIpV4Address, ogUpsNotification=ogUpsNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdName=ogEmdName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioName=ogEmdDioName, ogCellDataNotification=ogCellDataNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmType=ogAlarmType, ogHostUserNotification=ogHostUserNotification, ogStatus2Conformance=ogStatus2Conformance, ogCellModemConnected=ogCellModemConnected, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceIndex=ogHostServiceIndex, ogSerialUserTable=ogSerialUserTable, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarm=ogAlarm, ogSerialPortCTS=ogSerialPortCTS, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialUserLabel=ogSerialUserLabel, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApInterface=ogWifiApInterface, ogAlarmName=ogAlarmName, ogUpsDescription=ogUpsDescription, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2=ogStatus2, ogCustomNotification=ogCustomNotification, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioType=ogEmdDioType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioState=ogEmdDioState, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientCounter=ogWifiClientCounter, ogAlarmEventId=ogAlarmEventId, ogCellMessageNotification=ogCellMessageNotification, ogWifiApIndex=ogWifiApIndex, ogWifiApTable=ogWifiApTable, ogFirmwareVersion=ogFirmwareVersion, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemIndex=ogCellModemIndex, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortTable=ogSerialPortTable, ogWifiApSsid=ogWifiApSsid, ogSerialNumber=ogSerialNumber, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioDescription=ogEmdDioDescription, ogUpsEntry=ogUpsEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserHostName=ogHostUserHostName, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmDevice=ogAlarmDevice, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmDevice=ogCurrentAlarmDevice)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserHost=ogHostUserHost, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemVendor=ogCellModemVendor, ogRpcConnectType=ogRpcConnectType, ogHostServiceStatus=ogHostServiceStatus, ogEmdEntry=ogEmdEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserTable=ogHostUserTable, ogEmdDioIndex=ogEmdDioIndex, ogWifiApTxPower=ogWifiApTxPower, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsCounter=ogUpsCounter, ogUpsName=ogUpsName, ogCellModemTable=ogCellModemTable, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsConnectType=ogUpsConnectType, ogEmdDioEntry=ogEmdDioEntry, ogHostName=ogHostName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletTable=ogRpcOutletTable, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputPower=ogUpsOutputPower, ogCheckEntry=ogCheckEntry, ogStatus2Compliance=ogStatus2Compliance, ogUpsState=ogUpsState, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmUser=ogAlarmUser, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmState=ogAlarmState, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcTable=ogRpcTable, ogWebUserIndex=ogWebUserIndex, ogAlarmLogTable=ogAlarmLogTable, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDescription=ogEmdDescription, ogWifiClientRssi=ogWifiClientRssi, ogCheckTable=ogCheckTable, ogWebUserName=ogWebUserName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdIndex=ogEmdIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityName=ogEmdHumidityName, ogHostUserEntry=ogHostUserEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcIndex=ogRpcIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApEntry=ogWifiApEntry)
