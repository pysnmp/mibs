...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDTR=ogSerialPortDTR, ogAlarmCheck=ogAlarmCheck, ogHostUserAddress=ogHostUserAddress, ogAlarmName=ogAlarmName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApSsid=ogWifiApSsid, ogCellModemNetwork=ogCellModemNetwork, ogCellMessageNotification=ogCellMessageNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmDevice=ogAlarmDevice, ogSerialPortMode=ogSerialPortMode, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityName=ogEmdHumidityName, ogSerialUserNotification=ogSerialUserNotification, ogWifiApInterface=ogWifiApInterface, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortEntry=ogSerialPortEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcConnectType=ogRpcConnectType, ogEmdDioType=ogEmdDioType, ogEmdName=ogEmdName, ogHostTable=ogHostTable, ogWebUserTable=ogWebUserTable, ogCellModemApn=ogCellModemApn, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogHostUserStartTime=ogHostUserStartTime, ogCellModemVendor=ogCellModemVendor, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortDataBits=ogSerialPortDataBits, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientMac=ogWifiApClientMac, ogHostUserIndex=ogHostUserIndex, ogAlarmUser=ogAlarmUser, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientEssid=ogWifiClientEssid, ogRpcInputCurrent=ogRpcInputCurrent, ogHostServicePort=ogHostServicePort, ogSerialUserName=ogSerialUserName, ogRpcInputNotification=ogRpcInputNotification, ogCellSignalNotification=ogCellSignalNotification, ogHostPingNotification=ogHostPingNotification, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogHostIndex=ogHostIndex, ogStatus2Groups=ogStatus2Groups, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioName=ogEmdDioName, ogBasicStatusGroup=ogBasicStatusGroup, ogCellTowerNotification=ogCellTowerNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserEntry=ogSerialUserEntry, ogStatus2Conformance=ogStatus2Conformance, ogHostIpV6Address=ogHostIpV6Address, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcDescription=ogRpcDescription, ogSerialPortParity=ogSerialPortParity, ogUpsDescription=ogUpsDescription, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioState=ogEmdDioState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApFrequency=ogWifiApFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsName=ogUpsName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortTable=ogSerialPortTable, ogCheckName=ogCheckName, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyName=ogPowerSupplyName, ogUpsCounter=ogUpsCounter, ogRpcTable=ogRpcTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserHost=ogHostUserHost, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceEntry=ogHostServiceEntry, ogHostUserTable=ogHostUserTable, ogAlarmInstance=ogAlarmInstance, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTable=ogEmdTable, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsConnectType=ogUpsConnectType, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserHostName=ogHostUserHostName, ogEmdDioNotification=ogEmdDioNotification, PYSNMP_MODULE_ID=ogStatus2, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServiceHost=ogHostServiceHost, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserEntry=ogWebUserEntry, ogUpsTemperature=ogUpsTemperature, ogCellModemTable=ogCellModemTable, ogWifiApCounter=ogWifiApCounter, ogEmdDioTable=ogEmdDioTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemTower=ogCellModemTower, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemIndex=ogCellModemIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdEntry=ogEmdEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogMibNotifications=ogMibNotifications, ogAlarmTime=ogAlarmTime, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcEntry=ogRpcEntry, ogAlarmType=ogAlarmType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialUserPort=ogSerialUserPort, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemConnected=ogCellModemConnected, ogWifiClientTable=ogWifiClientTable, ogSystem=ogSystem, ogAlarm=ogAlarm, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogNetInterfaceName=ogNetInterfaceName, ogWifiApTable=ogWifiApTable, ogCellModemCounter=ogCellModemCounter, ogRpcCounter=ogRpcCounter, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckEntry=ogCheckEntry, ogUpsIndex=ogUpsIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcIndex=ogRpcIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogCellApnNotification=ogCellApnNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApEntry=ogWifiApEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialUserLabel=ogSerialUserLabel, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogStatus2Compliances=ogStatus2Compliances, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCustomNotification=ogCustomNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsTable=ogUpsTable, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemIMSI=ogCellModemIMSI, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcName=ogRpcName, ogEmdLogEnabled=ogEmdLogEnabled, ogStatus2=ogStatus2, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceIndex=ogHostServiceIndex, ogUpsState=ogUpsState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceTable=ogHostServiceTable, ogRpcOutletEntry=ogRpcOutletEntry, ogHostName=ogHostName, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserTable=ogSerialUserTable, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmEventId=ogAlarmEventId, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdIndex=ogEmdIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutputNotification=ogRpcOutputNotification, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmState=ogAlarmState, ogWifiApClientTxPackets=ogWifiApClientTxPackets)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemTemperature=ogCellModemTemperature, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserName=ogWebUserName, ogUpsType=ogUpsType, ogWifiApTxPower=ogWifiApTxPower, ogUpsHumidity=ogUpsHumidity, ogWifiClientCounter=ogWifiClientCounter, ogHostIpV4Address=ogHostIpV4Address, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckTable=ogCheckTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletName=ogRpcOutletName, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdConnectType=ogEmdConnectType, ogHostUserEntry=ogHostUserEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialNumber=ogSerialNumber, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortIndex=ogSerialPortIndex, ogCellModemModel=ogCellModemModel, ogCheckIndex=ogCheckIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmSummary=ogAlarmSummary, ogSerialPortCTS=ogSerialPortCTS, ogCellModemEntry=ogCellModemEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityTotal=ogEmdHumidityTotal, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserIndex=ogWebUserIndex, ogHostServiceType=ogHostServiceType, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceCounter=ogHostServiceCounter, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcType=ogRpcType, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsNotification=ogUpsNotification, ogUpsEntry=ogUpsEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserName=ogHostUserName, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApIndex=ogWifiApIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostEntry=ogHostEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDescription=ogEmdDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApEnabled=ogWifiApEnabled, ogAlarmLogTable=ogAlarmLogTable, ogCheckType=ogCheckType, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode)
