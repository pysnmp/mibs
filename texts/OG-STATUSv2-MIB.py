...
Counter32, Bits, Counter64, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Integer32, Unsigned32, NotificationType, MibIdentifier, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "Counter64", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Integer32", "Unsigned32", "NotificationType", "MibIdentifier", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientTxPower=ogWifiClientTxPower, ogEmdName=ogEmdName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemTable=ogCellModemTable, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsDescription=ogUpsDescription, ogFirmwareVersion=ogFirmwareVersion, ogHostUserAddress=ogHostUserAddress, ogEmdHumidityTotal=ogEmdHumidityTotal, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsLogEnabled=ogUpsLogEnabled, PYSNMP_MODULE_ID=ogStatus2, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceType=ogHostServiceType, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsEntry=ogUpsEntry, ogHostIpV4Address=ogHostIpV4Address, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsState=ogUpsState, ogCheckIndex=ogCheckIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmDevice=ogAlarmDevice, ogCellModemIndex=ogCellModemIndex, ogSerialUserPort=ogSerialUserPort, ogCellModemConnected=ogCellModemConnected, ogWifiClientRssi=ogWifiClientRssi, ogSerialPatternNotification=ogSerialPatternNotification, ogStatus2=ogStatus2, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioIndex=ogEmdDioIndex, ogHostUserStartTime=ogHostUserStartTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsTable=ogUpsTable, ogRpcType=ogRpcType, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsType=ogUpsType, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWebUserTable=ogWebUserTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientTable=ogWifiClientTable, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioNotification=ogEmdDioNotification, ogCellModemEntry=ogCellModemEntry, ogHostServicePort=ogHostServicePort, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmLogTable=ogAlarmLogTable, ogStatus2Compliances=ogStatus2Compliances, ogHostUserName=ogHostUserName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemVendor=ogCellModemVendor, ogHostIndex=ogHostIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioEntry=ogEmdDioEntry, ogHostName=ogHostName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmUser=ogAlarmUser, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioDescription=ogEmdDioDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortParity=ogSerialPortParity, ogCellModemCounter=ogCellModemCounter, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcEntry=ogRpcEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletName=ogRpcOutletName, ogRpcName=ogRpcName, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemTower=ogCellModemTower, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserLabel=ogSerialUserLabel, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserName=ogSerialUserName, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsConnectType=ogUpsConnectType, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserTable=ogHostUserTable, ogRpcTable=ogRpcTable, ogEmdConnectType=ogEmdConnectType, ogHostServiceTable=ogHostServiceTable, ogWifiApSsid=ogWifiApSsid, ogEmdDioType=ogEmdDioType, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortMode=ogSerialPortMode, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortEntry=ogSerialPortEntry, ogCellApnNotification=ogCellApnNotification, ogPowerSupplyName=ogPowerSupplyName, ogEmdEntry=ogEmdEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortLabel=ogSerialPortLabel, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioName=ogEmdDioName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityName=ogEmdHumidityName, ogEmdTable=ogEmdTable, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsCounter=ogUpsCounter, ogCheckName=ogCheckName, ogCheckResolveActions=ogCheckResolveActions, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserNotification=ogWebUserNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWebUserIndex=ogWebUserIndex, ogEmdDioState=ogEmdDioState, ogCheckType=ogCheckType, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApIndex=ogWifiApIndex, ogEmdDioDirection=ogEmdDioDirection, ogAlarmType=ogAlarmType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcCounter=ogRpcCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsHumidity=ogUpsHumidity, ogUpsNotification=ogUpsNotification, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortRTS=ogSerialPortRTS, ogCellModemModel=ogCellModemModel, ogSystem=ogSystem, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialUserTable=ogSerialUserTable, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioEmd=ogEmdDioEmd, ogCellTowerNotification=ogCellTowerNotification, ogHostPingNotification=ogHostPingNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApTable=ogWifiApTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostTable=ogHostTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsName=ogUpsName, ogEmdEnabled=ogEmdEnabled, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarm=ogAlarm, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsIndex=ogUpsIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellMessageNotification=ogCellMessageNotification, ogCustomNotification=ogCustomNotification, ogRpcConnectType=ogRpcConnectType, ogCellModemNetwork=ogCellModemNetwork, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckDeviceRef=ogCheckDeviceRef, ogHostEntry=ogHostEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserHost=ogHostUserHost, ogRpcDescription=ogRpcDescription, ogHostUserNotification=ogHostUserNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmTime=ogAlarmTime, ogEmdDioTable=ogEmdDioTable, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceType=ogNetInterfaceType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortTable=ogSerialPortTable, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDescription=ogEmdDescription, ogRpcIndex=ogRpcIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientEnabled=ogWifiClientEnabled, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmState=ogAlarmState, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemApn=ogCellModemApn, ogCheckDeviceName=ogCheckDeviceName, ogAlarmCheck=ogAlarmCheck, ogAlarmInstance=ogAlarmInstance, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientInterface=ogWifiClientInterface, ogStatus2Compliance=ogStatus2Compliance, ogAlarmName=ogAlarmName, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellSignalNotification=ogCellSignalNotification, ogWebUserName=ogWebUserName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApFrequency=ogWifiApFrequency, ogMibNotifications=ogMibNotifications, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdIndex=ogEmdIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientMode=ogWifiClientMode, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmSummary=ogAlarmSummary, ogSerialNumber=ogSerialNumber, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientMac=ogWifiApClientMac, ogRpcInputNotification=ogRpcInputNotification, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckEntry=ogCheckEntry, ogHostServiceHost=ogHostServiceHost, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckTable=ogCheckTable, ogRpcOutletState=ogRpcOutletState, ogWifiApInterface=ogWifiApInterface, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostIpV6Address=ogHostIpV6Address)
