...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckType=ogCheckType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcIndex=ogRpcIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientMac=ogWifiApClientMac, ogWebUserSourceAddress=ogWebUserSourceAddress, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcInputNotification=ogRpcInputNotification, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletName=ogRpcOutletName, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserEntry=ogHostUserEntry, ogHostUserHost=ogHostUserHost, ogSerialUserName=ogSerialUserName, ogWifiApTxPower=ogWifiApTxPower, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcDescription=ogRpcDescription, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmType=ogAlarmType, ogWifiClientIndex=ogWifiClientIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostIpV4Address=ogHostIpV4Address, ogCellModemConnected=ogCellModemConnected, ogFirmwareVersion=ogFirmwareVersion, ogHostServiceCounter=ogHostServiceCounter, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmState=ogAlarmState, ogAlarmLogEntry=ogAlarmLogEntry, ogCellApnNotification=ogCellApnNotification, ogRpcOutletState=ogRpcOutletState, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellDataNotification=ogCellDataNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsType=ogUpsType, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioState=ogEmdDioState, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTable=ogEmdTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostServiceType=ogHostServiceType, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckName=ogCheckName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortEntry=ogSerialPortEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortRTS=ogSerialPortRTS, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletRpc=ogRpcOutletRpc, ogHostServiceStatus=ogHostServiceStatus, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogNetInterfaceState=ogNetInterfaceState, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletTable=ogRpcOutletTable, ogRpcLogEnabled=ogRpcLogEnabled, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemApn=ogCellModemApn, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientTable=ogWifiClientTable, ogSerialUserNotification=ogSerialUserNotification, ogAlarmSummary=ogAlarmSummary, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcMaxTemperature=ogRpcMaxTemperature, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckTable=ogCheckTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioName=ogEmdDioName, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryState=ogUpsBatteryState, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDescription=ogEmdDescription, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApIndex=ogWifiApIndex, ogEmdDioType=ogEmdDioType, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmInstance=ogAlarmInstance, ogRpcType=ogRpcType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCustomNotification=ogCustomNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceIndex=ogHostServiceIndex, ogHostServiceNotification=ogHostServiceNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckIndex=ogCheckIndex, ogHostServiceHost=ogHostServiceHost, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyEntry=ogPowerSupplyEntry, ogPowerSupplyName=ogPowerSupplyName, ogWifiApFrequency=ogWifiApFrequency, ogWifiApEntry=ogWifiApEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcInputVoltage=ogRpcInputVoltage, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortDataBits=ogSerialPortDataBits, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserStartTime=ogWebUserStartTime, ogHostIpV6Address=ogHostIpV6Address, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortTable=ogSerialPortTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemEntry=ogCellModemEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogStatus2Compliances=ogStatus2Compliances, ogWebUserName=ogWebUserName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientEssid=ogWifiClientEssid, ogUpsConnectType=ogUpsConnectType, ogWifiClientEntry=ogWifiClientEntry, ogRpcName=ogRpcName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdName=ogEmdName, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputCurrent=ogUpsInputCurrent, ogSystem=ogSystem, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityName=ogEmdHumidityName, ogRpcConnectType=ogRpcConnectType, ogCellModemModel=ogCellModemModel, ogUpsState=ogUpsState, ogAlarm=ogAlarm, ogAlarmLogTable=ogAlarmLogTable, ogEmdIndex=ogEmdIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApSsid=ogWifiApSsid, ogCellModemTable=ogCellModemTable, ogEmdDioDirection=ogEmdDioDirection, ogCellSignalNotification=ogCellSignalNotification, ogCellModemCounter=ogCellModemCounter, ogEmdConnectType=ogEmdConnectType, ogRpcTable=ogRpcTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckEntry=ogCheckEntry, ogHostServiceEntry=ogHostServiceEntry, ogSerialNumber=ogSerialNumber, ogAlarmDevice=ogAlarmDevice, ogMibNotifications=ogMibNotifications, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogStatus2Groups=ogStatus2Groups, ogRpcOutletIndex=ogRpcOutletIndex, ogHostServicePort=ogHostServicePort, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioTable=ogEmdDioTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostUserNotification=ogHostUserNotification, ogSerialUserIndex=ogSerialUserIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientTable=ogWifiApClientTable, ogUpsName=ogUpsName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmName=ogAlarmName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApCounter=ogWifiApCounter, ogRpcEntry=ogRpcEntry, ogHostUserName=ogHostUserName, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogHostEntry=ogHostEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserTable=ogHostUserTable, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemTemperature=ogCellModemTemperature, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcCounter=ogRpcCounter, ogUpsNotification=ogUpsNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWebUserEntry=ogWebUserEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdEnabled=ogEmdEnabled, ogHostServiceTable=ogHostServiceTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostTable=ogHostTable, ogCellModemVendor=ogCellModemVendor, ogWifiApTable=ogWifiApTable, ogWebUserNotification=ogWebUserNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserIndex=ogHostUserIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWebUserIndex=ogWebUserIndex, ogEmdEntry=ogEmdEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsTemperature=ogUpsTemperature, ogHostUserAddress=ogHostUserAddress, ogWebUserTable=ogWebUserTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsCounter=ogUpsCounter, ogSerialUserLabel=ogSerialUserLabel, ogStatus2=ogStatus2, ogAlarmTime=ogAlarmTime, ogHostName=ogHostName, ogUpsDescription=ogUpsDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsIndex=ogUpsIndex, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortMode=ogSerialPortMode, ogSerialPortDCD=ogSerialPortDCD, ogCellModemTower=ogCellModemTower, ogAlarmUser=ogAlarmUser, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientRssi=ogWifiClientRssi, ogAlarmEventId=ogAlarmEventId, ogUpsTable=ogUpsTable, ogEmdDioCounter=ogEmdDioCounter, ogHostIndex=ogHostIndex, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceName=ogCheckDeviceName, ogUpsEntry=ogUpsEntry, ogWifiClientInterface=ogWifiClientInterface)
