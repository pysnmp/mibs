...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioDirection=ogEmdDioDirection, ogCheckTable=ogCheckTable, ogHostServiceStatus=ogHostServiceStatus, ogCellModemCounter=ogCellModemCounter, ogAlarmState=ogAlarmState, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmCheck=ogAlarmCheck, ogEmdDioType=ogEmdDioType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientMode=ogWifiClientMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioTable=ogEmdDioTable, ogWebUserEntry=ogWebUserEntry, ogUpsIndex=ogUpsIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogCellMessageNotification=ogCellMessageNotification, ogStatus2Conformance=ogStatus2Conformance, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsTable=ogUpsTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2Compliances=ogStatus2Compliances, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemModel=ogCellModemModel, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcEntry=ogRpcEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCustomNotification=ogCustomNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckDeviceName=ogCheckDeviceName, ogAlarmEventId=ogAlarmEventId, ogUpsNotification=ogUpsNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserTable=ogSerialUserTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserName=ogWebUserName, ogWifiApCounter=ogWifiApCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmName=ogCurrentAlarmName, PYSNMP_MODULE_ID=ogStatus2, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostServiceTable=ogHostServiceTable, ogEmdIndex=ogEmdIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemApn=ogCellModemApn, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmUser=ogAlarmUser, ogEmdEntry=ogEmdEntry, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioState=ogEmdDioState, ogHostUserHostName=ogHostUserHostName, ogWifiApClientRssi=ogWifiApClientRssi, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceType=ogHostServiceType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialNumber=ogSerialNumber, ogUpsDescription=ogUpsDescription, ogPowerSupplyName=ogPowerSupplyName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsConnectType=ogUpsConnectType, ogRpcIndex=ogRpcIndex, ogCellModemVendor=ogCellModemVendor, ogSerialUserIndex=ogSerialUserIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserPort=ogSerialUserPort, ogHostName=ogHostName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemIndex=ogCellModemIndex, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdName=ogEmdName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemTower=ogCellModemTower, ogEmdDioEmd=ogEmdDioEmd, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmLogTable=ogAlarmLogTable, ogHostIndex=ogHostIndex, ogHostTable=ogHostTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcInputNotification=ogRpcInputNotification, ogAlarmSummary=ogAlarmSummary, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientInterface=ogWifiClientInterface, ogHostServiceEntry=ogHostServiceEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceHost=ogHostServiceHost, ogHostUserName=ogHostUserName, ogRpcOutletTable=ogRpcOutletTable, ogNetInterfaceName=ogNetInterfaceName, ogWifiApFrequency=ogWifiApFrequency, ogWebUserTable=ogWebUserTable, ogAlarmTime=ogAlarmTime, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientTable=ogWifiApClientTable, ogUpsCounter=ogUpsCounter, ogEmdDescription=ogEmdDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdConnectType=ogEmdConnectType, ogWifiApEnabled=ogWifiApEnabled, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellApnNotification=ogCellApnNotification, ogStatus2=ogStatus2, ogSerialPortDTR=ogSerialPortDTR, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceIndex=ogHostServiceIndex, ogSerialUserEntry=ogSerialUserEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortParity=ogSerialPortParity, ogCellSignalNotification=ogCellSignalNotification, ogHostServicePort=ogHostServicePort, ogSystem=ogSystem, ogWifiApTxPower=ogWifiApTxPower, ogUpsEntry=ogUpsEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserHost=ogHostUserHost, ogHostUserEntry=ogHostUserEntry, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRssi=ogWifiClientRssi, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckEntry=ogCheckEntry, ogWifiClientEntry=ogWifiClientEntry, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemTable=ogCellModemTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortIndex=ogSerialPortIndex, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserIndex=ogWebUserIndex, ogCellModemRegistered=ogCellModemRegistered, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarm=ogAlarm, ogUpsType=ogUpsType, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioName=ogEmdDioName, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcDescription=ogRpcDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApInterface=ogWifiApInterface, ogHostEntry=ogHostEntry, ogEmdTable=ogEmdTable, ogUpsInputCurrent=ogUpsInputCurrent, ogMibNotifications=ogMibNotifications, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientTable=ogWifiClientTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmType=ogAlarmType, ogRpcType=ogRpcType, ogRpcOutletName=ogRpcOutletName, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientAp=ogWifiApClientAp, ogWifiApSsid=ogWifiApSsid, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcName=ogRpcName, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortTable=ogSerialPortTable, ogUpsName=ogUpsName, ogRpcInputFrequency=ogRpcInputFrequency, ogStatus2Groups=ogStatus2Groups, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortDCD=ogSerialPortDCD, ogWebUserNotification=ogWebUserNotification, ogHostUserIndex=ogHostUserIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortMode=ogSerialPortMode, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientApMac=ogWifiClientApMac)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioDescription=ogEmdDioDescription, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckTriggerActions=ogCheckTriggerActions, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletState=ogRpcOutletState, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientEssid=ogWifiClientEssid, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckIndex=ogCheckIndex, ogWifiApTable=ogWifiApTable, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserNotification=ogHostUserNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemEnabled=ogCellModemEnabled, ogHostServiceCounter=ogHostServiceCounter, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserName=ogSerialUserName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcCounter=ogRpcCounter, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckType=ogCheckType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserStartTime=ogHostUserStartTime, ogRpcTable=ogRpcTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApEntry=ogWifiApEntry, ogCheckName=ogCheckName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdEnabled=ogEmdEnabled, ogCellModemEntry=ogCellModemEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceState=ogNetInterfaceState, ogUpsHumidity=ogUpsHumidity, ogSerialPortEntry=ogSerialPortEntry, ogRpcConnectType=ogRpcConnectType, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApIndex=ogWifiApIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserTable=ogHostUserTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsInputNotification=ogUpsInputNotification, ogAlarmDevice=ogAlarmDevice, ogUpsState=ogUpsState, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmName=ogAlarmName)
