...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostName=ogHostName, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2Groups=ogStatus2Groups, ogRpcOutletState=ogRpcOutletState, ogCheckEntry=ogCheckEntry, ogWifiApEnabled=ogWifiApEnabled, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsNotification=ogUpsNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmDevice=ogAlarmDevice, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientFrequency=ogWifiClientFrequency, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsHumidity=ogUpsHumidity, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsTable=ogUpsTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogHostIndex=ogHostIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcEntry=ogRpcEntry, ogAlarmCheck=ogAlarmCheck, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsIndex=ogUpsIndex, ogUpsType=ogUpsType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmName=ogAlarmName, ogWebUserEntry=ogWebUserEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortTable=ogSerialPortTable, ogWifiApClientAp=ogWifiApClientAp, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmSummary=ogAlarmSummary, ogHostServiceTable=ogHostServiceTable, ogWifiClientMode=ogWifiClientMode, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellMessageNotification=ogCellMessageNotification, ogCellModemModel=ogCellModemModel, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientTable=ogWifiClientTable, ogWifiClientIndex=ogWifiClientIndex, ogCellModemApn=ogCellModemApn, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostServiceHost=ogHostServiceHost, ogWebUserName=ogWebUserName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApSsid=ogWifiApSsid, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioType=ogEmdDioType, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialUserName=ogSerialUserName, ogWifiApClientRssi=ogWifiApClientRssi, ogNetInterfaceType=ogNetInterfaceType, ogRpcInputFrequency=ogRpcInputFrequency, ogStatus2Compliance=ogStatus2Compliance, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmEventId=ogAlarmEventId, ogStatus2Compliances=ogStatus2Compliances, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserEntry=ogSerialUserEntry, ogRpcIndex=ogRpcIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientEnabled=ogWifiClientEnabled, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdEnabled=ogEmdEnabled, ogUpsName=ogUpsName, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioName=ogEmdDioName, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarm=ogAlarm, ogUpsCounter=ogUpsCounter, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioState=ogEmdDioState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserHostName=ogHostUserHostName, ogSerialPortSpeed=ogSerialPortSpeed, ogCellTowerNotification=ogCellTowerNotification, ogStatus2=ogStatus2, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcName=ogRpcName, ogEmdDioNotification=ogEmdDioNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceEntry=ogHostServiceEntry, ogHostUserEntry=ogHostUserEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcType=ogRpcType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletName=ogRpcOutletName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemTable=ogCellModemTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemEntry=ogCellModemEntry, ogCellModemVendor=ogCellModemVendor, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserTable=ogHostUserTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialNumber=ogSerialNumber, ogEmdName=ogEmdName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserNotification=ogHostUserNotification, ogCellModemRegistered=ogCellModemRegistered, ogWifiApTable=ogWifiApTable, ogWifiApEntry=ogWifiApEntry, ogCellModemCounter=ogCellModemCounter, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWebUserNotification=ogWebUserNotification, ogCheckName=ogCheckName, ogCellApnNotification=ogCellApnNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogNetInterfaceName=ogNetInterfaceName, ogCellModemTemperature=ogCellModemTemperature, ogCellModemNetwork=ogCellModemNetwork, ogCellDataNotification=ogCellDataNotification, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemConnected=ogCellModemConnected, ogWebUserStartTime=ogWebUserStartTime, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmTime=ogAlarmTime, ogUpsOutputLoad=ogUpsOutputLoad, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogMibNotifications=ogMibNotifications, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserTable=ogWebUserTable, ogUpsState=ogUpsState, ogUpsEntry=ogUpsEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdConnectType=ogEmdConnectType, ogEmdDescription=ogEmdDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCustomNotification=ogCustomNotification, ogHostTable=ogHostTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWebUserIndex=ogWebUserIndex, ogWifiClientEntry=ogWifiClientEntry, ogHostServiceNotification=ogHostServiceNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcDescription=ogRpcDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdEntry=ogEmdEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserIndex=ogHostUserIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApTxPower=ogWifiApTxPower, ogCheckDeviceName=ogCheckDeviceName, ogEmdTable=ogEmdTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioTable=ogEmdDioTable, ogHostEntry=ogHostEntry, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortParity=ogSerialPortParity, ogHostUserAddress=ogHostUserAddress, ogCellModemTower=ogCellModemTower, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApIndex=ogWifiApIndex, ogFirmwareVersion=ogFirmwareVersion, ogWifiApCounter=ogWifiApCounter, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientIeeeMode=ogWifiClientIeeeMode)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceIndex=ogHostServiceIndex, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSystem=ogSystem, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserPort=ogSerialUserPort, ogAlarmState=ogAlarmState, ogWifiClientEssid=ogWifiClientEssid, ogHostServicePort=ogHostServicePort, ogCellModemIndex=ogCellModemIndex, ogSerialPortMode=ogSerialPortMode, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckTable=ogCheckTable, ogHostIpV4Address=ogHostIpV4Address, ogCheckIndex=ogCheckIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortLabel=ogSerialPortLabel, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcCounter=ogRpcCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServiceType=ogHostServiceType, ogEmdDioCounter=ogEmdDioCounter, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcTable=ogRpcTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApFrequency=ogWifiApFrequency, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioEntry=ogEmdDioEntry, ogAlarmType=ogAlarmType, PYSNMP_MODULE_ID=ogStatus2, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdIndex=ogEmdIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserName=ogHostUserName, ogSerialPortEntry=ogSerialPortEntry, ogCheckType=ogCheckType, ogWifiClientApMac=ogWifiClientApMac, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmUser=ogAlarmUser, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserHost=ogHostUserHost, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsBatteryState=ogUpsBatteryState, ogHostUserStartTime=ogHostUserStartTime, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmInstance=ogAlarmInstance, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsDescription=ogUpsDescription, ogWifiClientCounter=ogWifiClientCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsBatteryVoltage=ogUpsBatteryVoltage)
