...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmTime=ogAlarmTime, ogCheckResolveActions=ogCheckResolveActions, ogStatus2Conformance=ogStatus2Conformance, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserName=ogWebUserName, ogWifiApEnabled=ogWifiApEnabled, ogCellModemConnected=ogCellModemConnected, ogHostUserNotification=ogHostUserNotification, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserAddress=ogHostUserAddress, ogUpsName=ogUpsName, ogWebUserIndex=ogWebUserIndex, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceNotification=ogHostServiceNotification, ogCellModemTemperature=ogCellModemTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientRssi=ogWifiClientRssi, ogWifiApEntry=ogWifiApEntry, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsDescription=ogUpsDescription, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckTable=ogCheckTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckName=ogCheckName, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceType=ogHostServiceType, ogUpsOutputPower=ogUpsOutputPower, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogStatus2Groups=ogStatus2Groups, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortEntry=ogSerialPortEntry, ogCellModemModel=ogCellModemModel, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmUser=ogAlarmUser, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioName=ogEmdDioName, ogEmdDioTable=ogEmdDioTable, ogStatus2=ogStatus2, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogNetInterfaceState=ogNetInterfaceState, ogHostName=ogHostName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioType=ogEmdDioType, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsType=ogUpsType, ogRpcEntry=ogRpcEntry, ogSerialPortParity=ogSerialPortParity, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogSystem=ogSystem, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTable=ogEmdTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortDSR=ogSerialPortDSR, ogHostServiceIndex=ogHostServiceIndex, ogAlarm=ogAlarm, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcCounter=ogRpcCounter, ogCellDataNotification=ogCellDataNotification, ogSerialPortRTS=ogSerialPortRTS, ogEmdEntry=ogEmdEntry, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmCheck=ogAlarmCheck, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserName=ogSerialUserName, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsHumidity=ogUpsHumidity, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdName=ogEmdName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmState=ogAlarmState, ogSerialUserIndex=ogSerialUserIndex, ogUpsInputNotification=ogUpsInputNotification, ogWifiApIndex=ogWifiApIndex, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortMode=ogSerialPortMode, ogStatus2Compliances=ogStatus2Compliances, ogWebUserTable=ogWebUserTable, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletState=ogRpcOutletState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCustomNotification=ogCustomNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDescription=ogEmdDescription, ogEmdHumidityName=ogEmdHumidityName, ogHostUserTable=ogHostUserTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemEntry=ogCellModemEntry, ogUpsIndex=ogUpsIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostUserHost=ogHostUserHost, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortBreaks=ogSerialPortBreaks, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsTemperature=ogUpsTemperature, ogCellModemIndex=ogCellModemIndex, ogEmdDioState=ogEmdDioState, ogCellModemNetwork=ogCellModemNetwork, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortLabel=ogSerialPortLabel, ogMibNotifications=ogMibNotifications, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmSummary=ogAlarmSummary, ogUpsTable=ogUpsTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcTable=ogRpcTable, ogEmdEnabled=ogEmdEnabled, ogCellModemVendor=ogCellModemVendor, ogWifiApClientEntry=ogWifiApClientEntry, ogHostServicePort=ogHostServicePort, ogSerialPortIndex=ogSerialPortIndex, ogWifiApInterface=ogWifiApInterface, ogCellModemTower=ogCellModemTower, ogWifiApSsid=ogWifiApSsid, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsState=ogUpsState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApTable=ogWifiApTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellApnNotification=ogCellApnNotification, ogUpsCounter=ogUpsCounter, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialUserPort=ogSerialUserPort, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellMessageNotification=ogCellMessageNotification, ogHostTable=ogHostTable, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcDescription=ogRpcDescription, ogAlarmEventId=ogAlarmEventId, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcIndex=ogRpcIndex, ogRpcType=ogRpcType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemTable=ogCellModemTable, ogUpsEntry=ogUpsEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcName=ogRpcName, ogEmdIndex=ogEmdIndex, ogUpsNotification=ogUpsNotification, ogWifiClientMode=ogWifiClientMode, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyTable=ogPowerSupplyTable, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceCounter=ogHostServiceCounter, ogRpcConnectType=ogRpcConnectType, ogRpcOutletName=ogRpcOutletName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostServiceEntry=ogHostServiceEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioDescription=ogEmdDioDescription, ogWifiApCounter=ogWifiApCounter, ogSerialNumber=ogSerialNumber, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialUserTable=ogSerialUserTable, ogWifiClientTable=ogWifiClientTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserIndex=ogHostUserIndex, ogWifiApFrequency=ogWifiApFrequency, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmLogTable=ogAlarmLogTable, ogAlarmDevice=ogAlarmDevice, ogWebUserNotification=ogWebUserNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckEntry=ogCheckEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientIndex=ogWifiClientIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemRegistered=ogCellModemRegistered, ogAlarmType=ogAlarmType, ogWifiClientInterface=ogWifiClientInterface, ogCheckType=ogCheckType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserName=ogHostUserName, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientApMac=ogWifiClientApMac, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceHost=ogHostServiceHost, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckIndex=ogCheckIndex, ogSerialUserEntry=ogSerialUserEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmName=ogAlarmName, ogEmdLogEnabled=ogEmdLogEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostEntry=ogHostEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserStartTime=ogWebUserStartTime, ogHostIndex=ogHostIndex, ogCellModemCounter=ogCellModemCounter, ogCellModemApn=ogCellModemApn, ogHostUserEntry=ogHostUserEntry, ogWebUserEntry=ogWebUserEntry, ogEmdConnectType=ogEmdConnectType, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserHostName=ogHostUserHostName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWebUserSourceAddress=ogWebUserSourceAddress)
