...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletState=ogRpcOutletState, ogAlarmUser=ogAlarmUser, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdEnabled=ogEmdEnabled, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostPingNotification=ogHostPingNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserIndex=ogSerialUserIndex, ogRpcIndex=ogRpcIndex, ogAlarmEventId=ogAlarmEventId, ogAlarmDevice=ogAlarmDevice, ogRpcCounter=ogRpcCounter, ogCheckType=ogCheckType, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsNotification=ogUpsNotification, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdConnectType=ogEmdConnectType, ogCellModemApn=ogCellModemApn, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortTable=ogSerialPortTable, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletTable=ogRpcOutletTable, ogWifiApTable=ogWifiApTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemModel=ogCellModemModel, ogRpcType=ogRpcType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdEntry=ogEmdEntry, ogEmdDioIndex=ogEmdDioIndex, ogStatus2Conformance=ogStatus2Conformance, ogUpsCounter=ogUpsCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogMibNotifications=ogMibNotifications, ogEmdDescription=ogEmdDescription, ogAlarmCheck=ogAlarmCheck, ogHostIndex=ogHostIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckEntry=ogCheckEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortLabel=ogSerialPortLabel, ogStatus2Compliance=ogStatus2Compliance, ogHostUserAddress=ogHostUserAddress, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityName=ogEmdHumidityName, ogHostName=ogHostName, ogWifiApSsid=ogWifiApSsid, ogWifiClientTable=ogWifiClientTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyName=ogPowerSupplyName, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcDescription=ogRpcDescription, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcInputNotification=ogRpcInputNotification, ogCheckIndex=ogCheckIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortDSR=ogSerialPortDSR, ogUpsTemperature=ogUpsTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostServicePort=ogHostServicePort, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostEntry=ogHostEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientEntry=ogWifiClientEntry, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientTable=ogWifiApClientTable, ogAlarmName=ogAlarmName, ogRpcLogEnabled=ogRpcLogEnabled, ogHostIpV6Address=ogHostIpV6Address, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserName=ogWebUserName, ogAlarmSummary=ogAlarmSummary, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsEntry=ogUpsEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientEssid=ogWifiClientEssid, ogHostServiceIndex=ogHostServiceIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserTable=ogSerialUserTable, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioName=ogEmdDioName, ogSerialPortMode=ogSerialPortMode, ogHostUserName=ogHostUserName, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostIpV4Address=ogHostIpV4Address, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioState=ogEmdDioState, ogHostUserTable=ogHostUserTable, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialUserName=ogSerialUserName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioType=ogEmdDioType, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmType=ogAlarmType, ogSerialUserPort=ogSerialUserPort, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioDirection=ogEmdDioDirection, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcName=ogRpcName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostServiceType=ogHostServiceType, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsInputFrequency=ogUpsInputFrequency, ogCellMessageNotification=ogCellMessageNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApTxPower=ogWifiApTxPower, ogAlarmLogTable=ogAlarmLogTable, ogUpsHumidity=ogUpsHumidity, ogEmdDioEntry=ogEmdDioEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarm=ogAlarm, ogSerialPortTxBytes=ogSerialPortTxBytes, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSystem=ogSystem, ogHostTable=ogHostTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsDescription=ogUpsDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserEntry=ogHostUserEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserLabel=ogSerialUserLabel, ogCheckResolveActions=ogCheckResolveActions, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcTable=ogRpcTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsName=ogUpsName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApCounter=ogWifiApCounter, ogWifiApEnabled=ogWifiApEnabled, ogCellModemConnected=ogCellModemConnected, ogHostServiceCounter=ogHostServiceCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemIndex=ogCellModemIndex, ogHostServiceNotification=ogHostServiceNotification, ogWifiApEntry=ogWifiApEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemEntry=ogCellModemEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemTable=ogCellModemTable, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioEmd=ogEmdDioEmd, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityEmd=ogEmdHumidityEmd, ogStatus2Compliances=ogStatus2Compliances, ogFirmwareVersion=ogFirmwareVersion, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsConnectType=ogUpsConnectType, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemIMSI=ogCellModemIMSI, PYSNMP_MODULE_ID=ogStatus2, ogEmdTable=ogEmdTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckName=ogCheckName, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsIndex=ogUpsIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryState=ogUpsBatteryState, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserIndex=ogHostUserIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogStatus2=ogStatus2, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletName=ogRpcOutletName, ogEmdDioTable=ogEmdDioTable, ogWifiClientMode=ogWifiClientMode, ogHostUserHostName=ogHostUserHostName, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceState=ogNetInterfaceState)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserStartTime=ogWebUserStartTime, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckTable=ogCheckTable, ogSerialPortDTR=ogSerialPortDTR, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApIndex=ogWifiApIndex, ogCustomNotification=ogCustomNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdIndex=ogEmdIndex, ogSerialPortParity=ogSerialPortParity, ogAlarmTime=ogAlarmTime, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmState=ogAlarmState, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserHost=ogHostUserHost, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialNumber=ogSerialNumber, ogSerialPortEntry=ogSerialPortEntry, ogUpsType=ogUpsType, ogEmdDioCounter=ogEmdDioCounter, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientCounter=ogWifiClientCounter, ogUpsState=ogUpsState, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostServiceHost=ogHostServiceHost, ogCellModemCounter=ogCellModemCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellApnNotification=ogCellApnNotification, ogHostServiceEntry=ogHostServiceEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialUserNotification=ogSerialUserNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogNetInterfaceName=ogNetInterfaceName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientRssi=ogWifiClientRssi, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsTable=ogUpsTable, ogWebUserNotification=ogWebUserNotification, ogCellModemTower=ogCellModemTower, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApInterface=ogWifiApInterface, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWebUserTable=ogWebUserTable, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserEntry=ogWebUserEntry, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcConnectType=ogRpcConnectType, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialUserEntry=ogSerialUserEntry, ogRpcEntry=ogRpcEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdName=ogEmdName, ogCellModemVendor=ogCellModemVendor)
