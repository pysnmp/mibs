...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsCounter=ogUpsCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortIndex=ogSerialPortIndex, ogCellModemModel=ogCellModemModel, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientApMac=ogWifiClientApMac, ogWifiApIndex=ogWifiApIndex, ogFirmwareVersion=ogFirmwareVersion, ogRpcConnectType=ogRpcConnectType, ogAlarmUser=ogAlarmUser, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioName=ogEmdDioName, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientEssid=ogWifiClientEssid, ogMibNotifications=ogMibNotifications, ogCheckIndex=ogCheckIndex, ogRpcEntry=ogRpcEntry, ogWifiApTable=ogWifiApTable, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortDCD=ogSerialPortDCD, ogHostPingNotification=ogHostPingNotification, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserName=ogSerialUserName, ogEmdDioState=ogEmdDioState, ogHostServiceIndex=ogHostServiceIndex, ogHostServiceTable=ogHostServiceTable, ogWifiApEnabled=ogWifiApEnabled, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApEntry=ogWifiApEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserName=ogWebUserName, ogCellModemApn=ogCellModemApn, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcInputNotification=ogRpcInputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientMac=ogWifiApClientMac, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientIndex=ogWifiApClientIndex, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceNotification=ogHostServiceNotification, ogUpsDescription=ogUpsDescription, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcName=ogRpcName, ogCellDataNotification=ogCellDataNotification, ogEmdIndex=ogEmdIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientTable=ogWifiClientTable, ogAlarmInstance=ogAlarmInstance, ogAlarmName=ogAlarmName, ogWifiApClientAp=ogWifiApClientAp, ogCheckTable=ogCheckTable, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserEntry=ogHostUserEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmType=ogAlarmType, ogUpsConnectType=ogUpsConnectType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApTxPower=ogWifiApTxPower, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioTable=ogEmdDioTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientEntry=ogWifiClientEntry, ogEmdTable=ogEmdTable, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckName=ogCheckName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmEventId=ogAlarmEventId, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientInterface=ogWifiClientInterface, ogWebUserNotification=ogWebUserNotification, ogSerialPortParity=ogSerialPortParity, ogCellModem3gRssi=ogCellModem3gRssi, ogHostEntry=ogHostEntry, ogEmdName=ogEmdName, ogStatus2Conformance=ogStatus2Conformance, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsTable=ogUpsTable, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsEntry=ogUpsEntry, ogHostUserHostName=ogHostUserHostName, ogHostName=ogHostName, ogUpsNotification=ogUpsNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioIndex=ogEmdDioIndex, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceName=ogNetInterfaceName, ogCellModemIndex=ogCellModemIndex, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortCTS=ogSerialPortCTS, ogCellModemTower=ogCellModemTower, ogEmdEntry=ogEmdEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserEntry=ogSerialUserEntry, ogCellModemVendor=ogCellModemVendor, ogUpsType=ogUpsType, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2=ogStatus2, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserNotification=ogSerialUserNotification, ogCellModemCounter=ogCellModemCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCustomNotification=ogCustomNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemIMSI=ogCellModemIMSI, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckDeviceName=ogCheckDeviceName, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortDTR=ogSerialPortDTR, ogSerialNumber=ogSerialNumber, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsState=ogUpsState, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWebUserTable=ogWebUserTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemTable=ogCellModemTable, ogCellModemConnected=ogCellModemConnected, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsIndex=ogUpsIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckType=ogCheckType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcDescription=ogRpcDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostIndex=ogHostIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellSignalNotification=ogCellSignalNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarm=ogAlarm, ogStatus2Groups=ogStatus2Groups, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSystem=ogSystem, ogEmdHumidityName=ogEmdHumidityName, ogWebUserIndex=ogWebUserIndex, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientIndex=ogWifiClientIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialUserIndex=ogSerialUserIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcType=ogRpcType, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletState=ogRpcOutletState, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialUserPort=ogSerialUserPort, ogHostUserIndex=ogHostUserIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserAddress=ogHostUserAddress, ogHostUserTable=ogHostUserTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcCounter=ogRpcCounter, ogEmdConnectType=ogEmdConnectType, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputPower=ogUpsOutputPower, ogWebUserEntry=ogWebUserEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmState=ogAlarmState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogStatus2Compliances=ogStatus2Compliances, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmSummary=ogAlarmSummary, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioType=ogEmdDioType, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortEntry=ogSerialPortEntry, ogHostServiceType=ogHostServiceType, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostServiceHost=ogHostServiceHost, ogCellApnNotification=ogCellApnNotification, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserHost=ogHostUserHost, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletName=ogRpcOutletName, ogSerialPortSpeed=ogSerialPortSpeed, ogHostTable=ogHostTable, ogCheckEntry=ogCheckEntry, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletVoltage=ogRpcOutletVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServicePort=ogHostServicePort, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmTime=ogAlarmTime, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsName=ogUpsName, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsHumidity=ogUpsHumidity, ogSerialUserTable=ogSerialUserTable, ogRpcIndex=ogRpcIndex, ogHostUserName=ogHostUserName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcTable=ogRpcTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApSsid=ogWifiApSsid, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostIpV6Address=ogHostIpV6Address, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets)
