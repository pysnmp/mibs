...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientTable=ogWifiClientTable, ogUpsHumidity=ogUpsHumidity, ogWifiClientEssid=ogWifiClientEssid, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemApn=ogCellModemApn, ogRpcCounter=ogRpcCounter, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckEntry=ogCheckEntry, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApSsid=ogWifiApSsid, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityName=ogEmdHumidityName, ogUpsName=ogUpsName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmName=ogAlarmName, ogEmdDioNotification=ogEmdDioNotification, ogWebUserStartTime=ogWebUserStartTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogStatus2Groups=ogStatus2Groups, ogWifiApCounter=ogWifiApCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioDescription=ogEmdDioDescription, ogUpsType=ogUpsType, ogCellModemTable=ogCellModemTable, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutputNotification=ogRpcOutputNotification, PYSNMP_MODULE_ID=ogStatus2, ogUpsIndex=ogUpsIndex, ogSerialPortDSR=ogSerialPortDSR, ogCellModemVendor=ogCellModemVendor, ogSerialPortMode=ogSerialPortMode, ogAlarmCheck=ogAlarmCheck, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyName=ogPowerSupplyName, ogAlarm=ogAlarm, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemRegistered=ogCellModemRegistered, ogRpcConnectType=ogRpcConnectType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletRpc=ogRpcOutletRpc, ogHostIpV6Address=ogHostIpV6Address, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServiceTable=ogHostServiceTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsDescription=ogUpsDescription, ogHostIpV4Address=ogHostIpV4Address, ogEmdTable=ogEmdTable, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceEntry=ogHostServiceEntry, ogUpsState=ogUpsState, ogCellNetworkNotification=ogCellNetworkNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioEntry=ogEmdDioEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApEntry=ogWifiApEntry, ogHostUserHostName=ogHostUserHostName, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserIndex=ogHostUserIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcDescription=ogRpcDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemModel=ogCellModemModel, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmSummary=ogAlarmSummary, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioType=ogEmdDioType, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCustomNotification=ogCustomNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckDeviceName=ogCheckDeviceName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellMessageNotification=ogCellMessageNotification, ogSerialUserName=ogSerialUserName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogMibNotifications=ogMibNotifications, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioIndex=ogEmdDioIndex, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletLoad=ogRpcOutletLoad, ogWebUserIndex=ogWebUserIndex, ogWebUserTable=ogWebUserTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcType=ogRpcType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortDCD=ogSerialPortDCD, ogNetInterfaceState=ogNetInterfaceState, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceName=ogNetInterfaceName, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellApnNotification=ogCellApnNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemCounter=ogCellModemCounter, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRssi=ogWifiClientRssi, ogCellModemNetwork=ogCellModemNetwork, ogSerialUserIndex=ogSerialUserIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmUser=ogAlarmUser, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdEnabled=ogEmdEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcTable=ogRpcTable, ogAlarmType=ogAlarmType, ogCheckType=ogCheckType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdIndex=ogEmdIndex, ogUpsInputNotification=ogUpsInputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserNotification=ogHostUserNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostTable=ogHostTable, ogEmdDescription=ogEmdDescription, ogRpcName=ogRpcName, ogWifiClientApMac=ogWifiClientApMac, ogSerialNumber=ogSerialNumber, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmTime=ogAlarmTime, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckTable=ogCheckTable, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceType=ogHostServiceType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserNotification=ogSerialUserNotification, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioEmd=ogEmdDioEmd, ogWifiApTxPower=ogWifiApTxPower, ogHostUserName=ogHostUserName, ogWifiClientMode=ogWifiClientMode, ogWifiApClientIndex=ogWifiApClientIndex, ogCellTowerNotification=ogCellTowerNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcEntry=ogRpcEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostServiceCounter=ogHostServiceCounter, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdEntry=ogEmdEntry, ogCheckIndex=ogCheckIndex, ogUpsTable=ogUpsTable, ogBasicStatusGroup=ogBasicStatusGroup, ogHostPingNotification=ogHostPingNotification, ogHostServiceNotification=ogHostServiceNotification, ogEmdName=ogEmdName, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModem3gRssi=ogCellModem3gRssi, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostEntry=ogHostEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortLabel=ogSerialPortLabel, ogWebUserName=ogWebUserName, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioState=ogEmdDioState, ogHostName=ogHostName, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortTable=ogSerialPortTable, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortEntry=ogSerialPortEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsNotification=ogUpsNotification, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostIndex=ogHostIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServicePort=ogHostServicePort, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApIndex=ogWifiApIndex, ogSerialPortRTS=ogSerialPortRTS, ogHostUserTable=ogHostUserTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApInterface=ogWifiApInterface, ogEmdDioName=ogEmdDioName, ogRpcOutletName=ogRpcOutletName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientIndex=ogWifiClientIndex, ogStatus2Conformance=ogStatus2Conformance, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletTable=ogRpcOutletTable, ogCellModemConnected=ogCellModemConnected, ogHostUserHost=ogHostUserHost, ogStatus2=ogStatus2, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemTower=ogCellModemTower, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsEntry=ogUpsEntry, ogAlarmEventId=ogAlarmEventId, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckName=ogCheckName, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcIndex=ogRpcIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserEntry=ogHostUserEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientEntry=ogWifiClientEntry, ogAlarmState=ogAlarmState, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserPort=ogSerialUserPort, ogWifiApTable=ogWifiApTable, ogStatus2Compliances=ogStatus2Compliances, ogSystem=ogSystem, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemEnabled=ogCellModemEnabled, ogUpsCounter=ogUpsCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserEntry=ogWebUserEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWebUserNotification=ogWebUserNotification, ogSerialPortParity=ogSerialPortParity)
