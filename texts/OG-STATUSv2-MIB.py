...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, TimeTicks, Integer32, MibIdentifier, Counter64, NotificationType, Bits, iso, ObjectIdentity, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "TimeTicks", "Integer32", "MibIdentifier", "Counter64", "NotificationType", "Bits", "iso", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostTable=ogHostTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsTable=ogUpsTable, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemApn=ogCellModemApn, ogMibNotifications=ogMibNotifications, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsDescription=ogUpsDescription, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceNotification=ogHostServiceNotification, ogCheckType=ogCheckType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostUserHost=ogHostUserHost, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcDescription=ogRpcDescription, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemCounter=ogCellModemCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortRTS=ogSerialPortRTS, ogRpcConnectType=ogRpcConnectType, ogCellModemRegistered=ogCellModemRegistered, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsTemperature=ogUpsTemperature, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioType=ogEmdDioType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserTable=ogWebUserTable, ogAlarmState=ogAlarmState, ogSerialUserNotification=ogSerialUserNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientEssid=ogWifiClientEssid, ogEmdTable=ogEmdTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsConnectType=ogUpsConnectType, ogHostServicePort=ogHostServicePort, ogHostEntry=ogHostEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSystem=ogSystem, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsInputNotification=ogUpsInputNotification, ogHostUserNotification=ogHostUserNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogHostUserTable=ogHostUserTable, ogCellDataNotification=ogCellDataNotification, ogWifiClientMode=ogWifiClientMode, ogCellModemNetwork=ogCellModemNetwork, ogUpsEntry=ogUpsEntry, ogEmdIndex=ogEmdIndex, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientEntry=ogWifiClientEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcTable=ogRpcTable, ogSerialPortDTR=ogSerialPortDTR, ogWifiApCounter=ogWifiApCounter, ogCellModemVendor=ogCellModemVendor, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCustomNotification=ogCustomNotification, ogHostUserIndex=ogHostUserIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioDescription=ogEmdDioDescription, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceType=ogNetInterfaceType, ogWifiApIndex=ogWifiApIndex, ogAlarmDevice=ogAlarmDevice, ogAlarmEventId=ogAlarmEventId, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostUserHostName=ogHostUserHostName, ogRpcOutletState=ogRpcOutletState, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemTower=ogCellModemTower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckEntry=ogCheckEntry, ogAlarmTime=ogAlarmTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortDSR=ogSerialPortDSR, ogHostServiceTable=ogHostServiceTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortIndex=ogSerialPortIndex, ogAlarmInstance=ogAlarmInstance, ogSerialUserIndex=ogSerialUserIndex, ogCheckTable=ogCheckTable, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsState=ogUpsState, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialNumber=ogSerialNumber, ogHostUserName=ogHostUserName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceName=ogCheckDeviceName, ogCellModemEntry=ogCellModemEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioDirection=ogEmdDioDirection, ogEmdEnabled=ogEmdEnabled, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientAp=ogWifiApClientAp, ogEmdEntry=ogEmdEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceCounter=ogHostServiceCounter, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyName=ogPowerSupplyName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemTable=ogCellModemTable, ogEmdDioNotification=ogEmdDioNotification, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostServiceHost=ogHostServiceHost, ogWifiClientInterface=ogWifiClientInterface, ogWebUserIndex=ogWebUserIndex, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdName=ogEmdName, ogWebUserName=ogWebUserName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApInterface=ogWifiApInterface, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcEntry=ogRpcEntry, ogNetInterfaceName=ogNetInterfaceName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsCounter=ogUpsCounter, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioName=ogEmdDioName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyTable=ogPowerSupplyTable, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckIndex=ogCheckIndex, ogStatus2Groups=ogStatus2Groups, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialUserTable=ogSerialUserTable, ogWifiClientTable=ogWifiClientTable, ogRpcName=ogRpcName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDescription=ogEmdDescription, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsName=ogUpsName, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcType=ogRpcType, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputPower=ogUpsOutputPower, ogAlarmType=ogAlarmType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyIndex=ogPowerSupplyIndex, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApTable=ogWifiApTable, ogHostPingNotification=ogHostPingNotification, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletLoad=ogRpcOutletLoad, ogHostUserEntry=ogHostUserEntry, ogCheckName=ogCheckName, ogAlarm=ogAlarm, ogWebUserEntry=ogWebUserEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserName=ogSerialUserName, ogAlarmSummary=ogAlarmSummary, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdConnectType=ogEmdConnectType, ogCellModemTemperature=ogCellModemTemperature, ogUpsOutputNotification=ogUpsOutputNotification, ogHostServiceType=ogHostServiceType, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmUser=ogAlarmUser, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryRunTime=ogUpsBatteryRunTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserPort=ogSerialUserPort, ogStatus2=ogStatus2, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmLogTable=ogAlarmLogTable, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserStartTime=ogHostUserStartTime, ogRpcIndex=ogRpcIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsType=ogUpsType, ogHostName=ogHostName, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortTable=ogSerialPortTable, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioTable=ogEmdDioTable, ogWifiApEntry=ogWifiApEntry, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcInputNotification=ogRpcInputNotification, ogCellModemConnected=ogCellModemConnected, ogSerialUserLabel=ogSerialUserLabel, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostIpV6Address=ogHostIpV6Address, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortMode=ogSerialPortMode, ogCellModemModel=ogCellModemModel, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletIndex=ogRpcOutletIndex, ogHostIndex=ogHostIndex, ogUpsBatteryState=ogUpsBatteryState, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsNotification=ogUpsNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletName=ogRpcOutletName, ogRpcCounter=ogRpcCounter, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellApnNotification=ogCellApnNotification, ogWebUserNotification=ogWebUserNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemIndex=ogCellModemIndex, ogAlarmName=ogAlarmName, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioState=ogEmdDioState, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsIndex=ogUpsIndex, ogUpsHumidity=ogUpsHumidity, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortParity=ogSerialPortParity, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortDataBits=ogSerialPortDataBits)
