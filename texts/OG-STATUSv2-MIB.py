...
Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, IpAddress, Unsigned32, Integer32, Gauge32, NotificationType, Counter32, ObjectIdentity, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "IpAddress", "Unsigned32", "Integer32", "Gauge32", "NotificationType", "Counter32", "ObjectIdentity", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientEntry=ogWifiApClientEntry, ogNetInterfaceState=ogNetInterfaceState, ogRpcInputVoltage=ogRpcInputVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcDescription=ogRpcDescription, ogSerialPortMode=ogSerialPortMode, ogEmdDioIndex=ogEmdDioIndex, ogStatus2Compliance=ogStatus2Compliance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserHostName=ogHostUserHostName, ogAlarmInstance=ogAlarmInstance, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioEmd=ogEmdDioEmd, ogHostUserTable=ogHostUserTable, ogAlarmLogTable=ogAlarmLogTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortDCD=ogSerialPortDCD, ogSystem=ogSystem, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserSourcePort=ogWebUserSourcePort, ogCellApnNotification=ogCellApnNotification, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortTable=ogSerialPortTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostIndex=ogHostIndex, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemTable=ogCellModemTable, ogSerialUserName=ogSerialUserName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarm=ogAlarm, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioCounter=ogEmdDioCounter, ogEmdConnectType=ogEmdConnectType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioState=ogEmdDioState, ogHostPingNotification=ogHostPingNotification, ogCheckName=ogCheckName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientTable=ogWifiApClientTable, ogEmdIndex=ogEmdIndex, ogHostServicePort=ogHostServicePort, ogWifiApCounter=ogWifiApCounter, ogWebUserNotification=ogWebUserNotification, ogHostUserAddress=ogHostUserAddress, ogRpcOutletIndex=ogRpcOutletIndex, ogWebUserTable=ogWebUserTable, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserName=ogWebUserName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserName=ogHostUserName, ogRpcTable=ogRpcTable, ogRpcEntry=ogRpcEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Groups=ogStatus2Groups, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyName=ogPowerSupplyName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckTable=ogCheckTable, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortEntry=ogSerialPortEntry, ogAlarmSummary=ogAlarmSummary, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmState=ogAlarmState, ogHostName=ogHostName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemTemperature=ogCellModemTemperature, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsTable=ogUpsTable, ogEmdDioNotification=ogEmdDioNotification, ogAlarmEventId=ogAlarmEventId, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsCounter=ogUpsCounter, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletName=ogRpcOutletName, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsState=ogUpsState, ogSerialPortCTS=ogSerialPortCTS, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckIndex=ogCheckIndex, ogUpsHumidity=ogUpsHumidity, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientRssi=ogWifiClientRssi, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortParity=ogSerialPortParity, ogCellDataNotification=ogCellDataNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostEntry=ogHostEntry, ogNetInterfaceName=ogNetInterfaceName, ogUpsEntry=ogUpsEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceHost=ogHostServiceHost, ogCellModemConnected=ogCellModemConnected, ogStatus2=ogStatus2, ogHostServiceTable=ogHostServiceTable, ogEmdDescription=ogEmdDescription, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemRegistered=ogCellModemRegistered, ogWifiApInterface=ogWifiApInterface, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcIndex=ogRpcIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApSsid=ogWifiApSsid, ogUpsType=ogUpsType, ogHostUserIndex=ogHostUserIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcInputNotification=ogRpcInputNotification, ogStatus2Compliances=ogStatus2Compliances, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserNotification=ogHostUserNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletTable=ogRpcOutletTable, ogWifiApEntry=ogWifiApEntry, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckDeviceName=ogCheckDeviceName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostTable=ogHostTable, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmTime=ogAlarmTime, ogCellModemIndex=ogCellModemIndex, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTable=ogEmdTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsNotification=ogUpsNotification, ogHostUserStartTime=ogHostUserStartTime, ogCellModemModel=ogCellModemModel, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdEntry=ogEmdEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemTower=ogCellModemTower, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserIndex=ogSerialUserIndex, ogAlarmName=ogAlarmName, ogWifiClientMode=ogWifiClientMode, ogHostUserEntry=ogHostUserEntry, ogEmdDioTable=ogEmdDioTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemVendor=ogCellModemVendor, ogRpcType=ogRpcType, ogHostServiceStatus=ogHostServiceStatus, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserHost=ogHostUserHost, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortIndex=ogSerialPortIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemNetwork=ogCellModemNetwork, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceType=ogHostServiceType, ogWebUserEntry=ogWebUserEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsDescription=ogUpsDescription, ogRpcOutletState=ogRpcOutletState, ogAlarmUser=ogAlarmUser, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputNotification=ogUpsInputNotification, ogEmdName=ogEmdName, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserNotification=ogSerialUserNotification, ogCheckEntry=ogCheckEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioDescription=ogEmdDioDescription, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientInterface=ogWifiClientInterface, ogCellModemCounter=ogCellModemCounter, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogFirmwareVersion=ogFirmwareVersion, ogCheckType=ogCheckType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortDTR=ogSerialPortDTR, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserIndex=ogWebUserIndex, ogEmdDioType=ogEmdDioType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApTxPower=ogWifiApTxPower, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsName=ogUpsName, ogWifiApTable=ogWifiApTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialUserPort=ogSerialUserPort, ogWifiApIndex=ogWifiApIndex, ogHostServiceIndex=ogHostServiceIndex, ogUpsConnectType=ogUpsConnectType, ogAlarmCheck=ogAlarmCheck, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserEntry=ogSerialUserEntry, ogCellModemIMSI=ogCellModemIMSI, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcName=ogRpcName, ogAlarmType=ogAlarmType, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApEnabled=ogWifiApEnabled, ogUpsIndex=ogUpsIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModemApn=ogCellModemApn, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientRssi=ogWifiApClientRssi, ogMibNotifications=ogMibNotifications, ogSerialNumber=ogSerialNumber, ogUpsOutputPower=ogUpsOutputPower, ogCustomNotification=ogCustomNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcCounter=ogRpcCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmDevice=ogAlarmDevice, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserTable=ogSerialUserTable, ogEmdDioName=ogEmdDioName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors)
