...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputNotification=ogRpcInputNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServicePort=ogHostServicePort, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioDirection=ogEmdDioDirection, ogEmdConnectType=ogEmdConnectType, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsIndex=ogUpsIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostUserEntry=ogHostUserEntry, ogWebUserTable=ogWebUserTable, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemApn=ogCellModemApn, ogCellModemCounter=ogCellModemCounter, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsName=ogUpsName, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortMode=ogSerialPortMode, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmCheck=ogAlarmCheck, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmState=ogAlarmState, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserHostName=ogHostUserHostName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsTable=ogUpsTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogNetInterfaceState=ogNetInterfaceState, ogEmdDescription=ogEmdDescription, ogHostPingNotification=ogHostPingNotification, ogSerialPortDCD=ogSerialPortDCD, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellApnNotification=ogCellApnNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApInterface=ogWifiApInterface, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmUser=ogAlarmUser, ogHostIpV4Address=ogHostIpV4Address, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogMibNotifications=ogMibNotifications, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioState=ogEmdDioState, ogEmdName=ogEmdName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialUserTable=ogSerialUserTable, ogHostUserStartTime=ogHostUserStartTime, ogHostTable=ogHostTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemModel=ogCellModemModel, ogUpsConnectType=ogUpsConnectType, ogEmdDioNotification=ogEmdDioNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcIndex=ogRpcIndex, ogEmdDioDescription=ogEmdDioDescription, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemVendor=ogCellModemVendor, ogAlarmEventId=ogAlarmEventId, ogAlarmDevice=ogAlarmDevice, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServiceNotification=ogHostServiceNotification, ogRpcType=ogRpcType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmType=ogAlarmType, ogUpsState=ogUpsState, PYSNMP_MODULE_ID=ogStatus2, ogCellModemTower=ogCellModemTower, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcName=ogRpcName, ogCurrentAlarmType=ogCurrentAlarmType, ogWebUserName=ogWebUserName, ogEmdEnabled=ogEmdEnabled, ogSerialNumber=ogSerialNumber, ogEmdEntry=ogEmdEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemIMSI=ogCellModemIMSI, ogCellModemTable=ogCellModemTable, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientEssid=ogWifiClientEssid, ogHostName=ogHostName, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarm=ogAlarm, ogWebUserEntry=ogWebUserEntry, ogAlarmName=ogAlarmName, ogUpsTemperature=ogUpsTemperature, ogSerialPortEntry=ogSerialPortEntry, ogWifiApEntry=ogWifiApEntry, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceStatus=ogHostServiceStatus, ogAlarmSummary=ogAlarmSummary, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserName=ogSerialUserName, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogNetInterfaceType=ogNetInterfaceType, ogEmdIndex=ogEmdIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWebUserStartTime=ogWebUserStartTime, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostUserIndex=ogHostUserIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckType=ogCheckType, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortLabel=ogSerialPortLabel, ogRpcCounter=ogRpcCounter, ogUpsEntry=ogUpsEntry, ogStatus2=ogStatus2, ogRpcDescription=ogRpcDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserPort=ogSerialUserPort, ogCustomNotification=ogCustomNotification, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellTowerNotification=ogCellTowerNotification, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryState=ogUpsBatteryState, ogHostUserName=ogHostUserName, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientIndex=ogWifiClientIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserNotification=ogHostUserNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCellSignalNotification=ogCellSignalNotification, ogHostUserTable=ogHostUserTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientTable=ogWifiClientTable, ogUpsType=ogUpsType, ogEmdDioCounter=ogEmdDioCounter, ogEmdHumidityName=ogEmdHumidityName, ogCellModemIndex=ogCellModemIndex, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientApMac=ogWifiClientApMac, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortRTS=ogSerialPortRTS, ogNetInterfaceName=ogNetInterfaceName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientEntry=ogWifiClientEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdTable=ogEmdTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioName=ogEmdDioName, ogWebUserNotification=ogWebUserNotification, ogWifiApTxPower=ogWifiApTxPower, ogCellModemConnected=ogCellModemConnected, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioTable=ogEmdDioTable, ogCheckIndex=ogCheckIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsCounter=ogUpsCounter, ogSerialPortParity=ogSerialPortParity, ogCheckEntry=ogCheckEntry, ogStatus2Compliances=ogStatus2Compliances, ogStatus2Compliance=ogStatus2Compliance, ogUpsNotification=ogUpsNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceType=ogHostServiceType, ogUpsInputNotification=ogUpsInputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserHost=ogHostUserHost, ogEmdDioInputTotal=ogEmdDioInputTotal)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckTable=ogCheckTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApIndex=ogWifiApIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellNetworkNotification=ogCellNetworkNotification, ogHostEntry=ogHostEntry, ogHostServiceCounter=ogHostServiceCounter, ogCellDataNotification=ogCellDataNotification, ogSerialPortDSR=ogSerialPortDSR, ogStatus2Groups=ogStatus2Groups, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletState=ogRpcOutletState, ogUpsDescription=ogUpsDescription, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcConnectType=ogRpcConnectType, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientAp=ogWifiApClientAp, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostIndex=ogHostIndex, ogAlarmTime=ogAlarmTime, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletName=ogRpcOutletName, ogRpcEntry=ogRpcEntry, ogEmdDioType=ogEmdDioType, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRssi=ogWifiClientRssi, ogWifiApTable=ogWifiApTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckName=ogCheckName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientCounter=ogWifiClientCounter, ogUpsHumidity=ogUpsHumidity, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceEntry=ogHostServiceEntry, ogSystem=ogSystem, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortDTR=ogSerialPortDTR, ogRpcTable=ogRpcTable, ogCellModemEntry=ogCellModemEntry, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsOutputVoltage=ogUpsOutputVoltage)
