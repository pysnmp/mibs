...
TimeTicks, MibIdentifier, NotificationType, Unsigned32, Gauge32, ModuleIdentity, Counter64, iso, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "NotificationType", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter64", "iso", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcIndex=ogRpcIndex, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientMode=ogWifiClientMode, ogCellDataNotification=ogCellDataNotification, ogWebUserNotification=ogWebUserNotification, ogHostServiceHost=ogHostServiceHost, ogAlarmUser=ogAlarmUser, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTable=ogEmdTable, ogEmdIndex=ogEmdIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellTowerNotification=ogCellTowerNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckEntry=ogCheckEntry, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogFirmwareVersion=ogFirmwareVersion, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceCounter=ogHostServiceCounter, ogCellModemTemperature=ogCellModemTemperature, ogRpcCounter=ogRpcCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApTxPower=ogWifiApTxPower, ogAlarmType=ogAlarmType, ogCellApnNotification=ogCellApnNotification, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcConnectType=ogRpcConnectType, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientTable=ogWifiApClientTable, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdConnectType=ogEmdConnectType, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceTable=ogHostServiceTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioDirection=ogEmdDioDirection, ogWifiApEntry=ogWifiApEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemNetwork=ogCellModemNetwork, ogWifiApIndex=ogWifiApIndex, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioType=ogEmdDioType, ogCellModemVendor=ogCellModemVendor, ogUpsTemperature=ogUpsTemperature, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsName=ogUpsName, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserNotification=ogSerialUserNotification, ogHostTable=ogHostTable, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientIndex=ogWifiClientIndex, ogAlarm=ogAlarm, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemIndex=ogCellModemIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmTime=ogAlarmTime, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletTable=ogRpcOutletTable, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceState=ogNetInterfaceState, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApSsid=ogWifiApSsid, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostPingNotification=ogHostPingNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcInputNotification=ogRpcInputNotification, ogWifiApEnabled=ogWifiApEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserTable=ogWebUserTable, ogUpsConnectType=ogUpsConnectType, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceTable=ogCheckDeviceTable, ogStatus2=ogStatus2, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortDCD=ogSerialPortDCD, ogCheckTable=ogCheckTable, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserTable=ogHostUserTable, ogRpcOutletState=ogRpcOutletState, ogAlarmEventId=ogAlarmEventId, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsIndex=ogUpsIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsState=ogUpsState, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcDescription=ogRpcDescription, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDescription=ogEmdDescription, ogCellModemConnected=ogCellModemConnected, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioState=ogEmdDioState, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsType=ogUpsType, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientAp=ogWifiApClientAp, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortMode=ogSerialPortMode, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserName=ogHostUserName, ogSerialPortBreaks=ogSerialPortBreaks, ogMibNotifications=ogMibNotifications, ogEmdDioName=ogEmdDioName, ogCheckType=ogCheckType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemModel=ogCellModemModel, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserName=ogSerialUserName, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserLabel=ogSerialUserLabel, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellMessageNotification=ogCellMessageNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortParity=ogSerialPortParity, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogStatus2Groups=ogStatus2Groups, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserPort=ogSerialUserPort, ogAlarmSummary=ogAlarmSummary, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsDescription=ogUpsDescription, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApInterface=ogWifiApInterface, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientCounter=ogWifiClientCounter, ogWifiApFrequency=ogWifiApFrequency, ogWebUserName=ogWebUserName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModem4gRssi=ogCellModem4gRssi, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckDeviceName=ogCheckDeviceName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmName=ogAlarmName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioTable=ogEmdDioTable, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModem3gRssi=ogCellModem3gRssi, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityName=ogEmdHumidityName, ogUpsHumidity=ogUpsHumidity, ogRpcTable=ogRpcTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServiceType=ogHostServiceType, ogWebUserIndex=ogWebUserIndex, ogHostEntry=ogHostEntry, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsNotification=ogUpsNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemTower=ogCellModemTower, ogRpcEntry=ogRpcEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserHost=ogHostUserHost, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceStatus=ogHostServiceStatus, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmTime=ogCurrentAlarmTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletTotal=ogRpcOutletTotal, ogNetInterfaceType=ogNetInterfaceType, ogHostIpV4Address=ogHostIpV4Address, ogHostIndex=ogHostIndex, ogWebUserEntry=ogWebUserEntry, ogCustomNotification=ogCustomNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsEntry=ogUpsEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmDevice=ogAlarmDevice, ogAlarmState=ogAlarmState, ogHostServicePort=ogHostServicePort, ogAlarmCheck=ogAlarmCheck, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserIndex=ogHostUserIndex, ogEmdDioEmd=ogEmdDioEmd)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcType=ogRpcType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserEntry=ogHostUserEntry, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsInputFrequency=ogUpsInputFrequency, ogHostName=ogHostName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortTable=ogSerialPortTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioCounter=ogEmdDioCounter, ogStatus2Compliance=ogStatus2Compliance, ogCellModemCounter=ogCellModemCounter, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsTable=ogUpsTable, ogCheckIndex=ogCheckIndex, ogSerialUserTable=ogSerialUserTable, ogHostUserHostName=ogHostUserHostName, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureTable=ogEmdTemperatureTable, ogPowerSupplyName=ogPowerSupplyName, ogCellModemApn=ogCellModemApn, ogWifiApTable=ogWifiApTable, ogSystem=ogSystem, ogEmdEntry=ogEmdEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckName=ogCheckName, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputNotification=ogUpsInputNotification, ogCellModemEntry=ogCellModemEntry, ogEmdEnabled=ogEmdEnabled, ogCellModemTable=ogCellModemTable, ogCellModemIMSI=ogCellModemIMSI, ogSerialNumber=ogSerialNumber, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcName=ogRpcName, ogEmdName=ogEmdName, PYSNMP_MODULE_ID=ogStatus2, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputPower=ogUpsOutputPower, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsInputCurrent=ogUpsInputCurrent)
