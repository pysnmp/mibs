...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsEntry=ogUpsEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientInterface=ogWifiClientInterface, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmDevice=ogAlarmDevice, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcIndex=ogRpcIndex, ogHostUserNotification=ogHostUserNotification, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmUser=ogAlarmUser, ogWifiClientFrequency=ogWifiClientFrequency, ogHostIpV6Address=ogHostIpV6Address, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogStatus2Groups=ogStatus2Groups, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApSsid=ogWifiApSsid, ogWifiApClientAp=ogWifiApClientAp, ogCellModemConnected=ogCellModemConnected, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostIndex=ogHostIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcInputNotification=ogRpcInputNotification, ogEmdDescription=ogEmdDescription, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmType=ogAlarmType, ogCellMessageNotification=ogCellMessageNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdConnectType=ogEmdConnectType, ogAlarm=ogAlarm, ogHostUserIndex=ogHostUserIndex, ogHostPingNotification=ogHostPingNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmEventId=ogAlarmEventId, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletState=ogRpcOutletState, ogAlarmCheck=ogAlarmCheck, ogWebUserStartTime=ogWebUserStartTime, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsCounter=ogUpsCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmCurrentValue=ogAlarmCurrentValue, ogMibNotifications=ogMibNotifications, ogUpsIndex=ogUpsIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApInterface=ogWifiApInterface, ogCheckEntry=ogCheckEntry, ogWebUserNotification=ogWebUserNotification, ogEmdDioEntry=ogEmdDioEntry, ogHostUserStartTime=ogHostUserStartTime, ogCellModemIndex=ogCellModemIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialUserPort=ogSerialUserPort, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckType=ogCheckType, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserTable=ogWebUserTable, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemCounter=ogCellModemCounter, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioName=ogEmdDioName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdEntry=ogEmdEntry, ogStatus2Compliance=ogStatus2Compliance, ogHostUserName=ogHostUserName, ogWifiClientEntry=ogWifiClientEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsTemperature=ogUpsTemperature, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostName=ogHostName, ogSerialUserTable=ogSerialUserTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemEntry=ogCellModemEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioTable=ogEmdDioTable, ogRpcEntry=ogRpcEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialNumber=ogSerialNumber, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckName=ogCheckName, ogHostUserAddress=ogHostUserAddress, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckIndex=ogCheckIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckTable=ogCheckTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortIndex=ogSerialPortIndex, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceName=ogCheckDeviceName, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialUserName=ogSerialUserName, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioType=ogEmdDioType, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputPower=ogUpsOutputPower, ogWebUserName=ogWebUserName, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckResolveActions=ogCheckResolveActions, ogEmdIndex=ogEmdIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcType=ogRpcType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyName=ogPowerSupplyName, ogWifiApCounter=ogWifiApCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemApn=ogCellModemApn, ogEmdName=ogEmdName, ogEmdHumidityName=ogEmdHumidityName, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortLabel=ogSerialPortLabel, ogAlarmLogTable=ogAlarmLogTable, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmState=ogAlarmState, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcConnectType=ogRpcConnectType, ogSerialPortMode=ogSerialPortMode, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdDioIndex=ogEmdDioIndex, ogCellApnNotification=ogCellApnNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceStatus=ogHostServiceStatus, ogCellModemIMSI=ogCellModemIMSI, ogCellModemVendor=ogCellModemVendor, ogCustomNotification=ogCustomNotification, ogStatus2Conformance=ogStatus2Conformance, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsTable=ogUpsTable, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientMode=ogWifiClientMode, ogUpsType=ogUpsType, ogHostUserHostName=ogHostUserHostName, ogHostUserTable=ogHostUserTable, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceHost=ogHostServiceHost, ogRpcDescription=ogRpcDescription, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcTable=ogRpcTable, ogHostServiceType=ogHostServiceType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogNetInterfaceName=ogNetInterfaceName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmTime=ogAlarmTime, ogWifiApClientMac=ogWifiApClientMac, ogHostUserHost=ogHostUserHost, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmName=ogCurrentAlarmName, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioNotification=ogEmdDioNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityValue=ogEmdHumidityValue, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, PYSNMP_MODULE_ID=ogStatus2, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryState=ogUpsBatteryState, ogUpsNotification=ogUpsNotification, ogHostUserEntry=ogHostUserEntry, ogSystem=ogSystem, ogWebUserIndex=ogWebUserIndex, ogRpcOutletName=ogRpcOutletName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemTable=ogCellModemTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApEntry=ogWifiApEntry, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostEntry=ogHostEntry, ogCellSignalNotification=ogCellSignalNotification, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcInputVoltage=ogRpcInputVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioDirection=ogEmdDioDirection, ogWifiApIndex=ogWifiApIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientTable=ogWifiApClientTable, ogRpcCounter=ogRpcCounter, ogSerialPortParity=ogSerialPortParity, ogStatus2=ogStatus2, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioState=ogEmdDioState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemModel=ogCellModemModel, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsState=ogUpsState, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioDescription=ogEmdDioDescription, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortTable=ogSerialPortTable, ogAlarmSummary=ogAlarmSummary, ogWebUserEntry=ogWebUserEntry, ogAlarmName=ogAlarmName, ogUpsLogEnabled=ogUpsLogEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceState=ogNetInterfaceState, ogUpsInputNotification=ogUpsInputNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemTower=ogCellModemTower, ogUpsDescription=ogUpsDescription, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioCounter=ogEmdDioCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientCounter=ogWifiClientCounter, ogUpsName=ogUpsName, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTable=ogEmdTable, ogHostServicePort=ogHostServicePort, ogWifiApTable=ogWifiApTable, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortEntry=ogSerialPortEntry, ogRpcName=ogRpcName, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientTable=ogWifiClientTable, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletTable=ogRpcOutletTable, ogBasicStatusGroup=ogBasicStatusGroup, ogHostTable=ogHostTable)
