...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Integer32, Bits, NotificationType, Gauge32, Unsigned32, Counter32, TimeTicks, iso, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Integer32", "Bits", "NotificationType", "Gauge32", "Unsigned32", "Counter32", "TimeTicks", "iso", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcDescription=ogRpcDescription, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsCounter=ogUpsCounter, ogEmdEntry=ogEmdEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserTable=ogHostUserTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsDescription=ogUpsDescription, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApCounter=ogWifiApCounter, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceIndex=ogHostServiceIndex, ogUpsName=ogUpsName, ogUpsInputNotification=ogUpsInputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioName=ogEmdDioName, ogSerialUserPort=ogSerialUserPort, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortParity=ogSerialPortParity, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioType=ogEmdDioType, ogCellApnNotification=ogCellApnNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogHostTable=ogHostTable, ogAlarmInstance=ogAlarmInstance, ogSerialPortCTS=ogSerialPortCTS, ogAlarmState=ogAlarmState, ogEmdDioState=ogEmdDioState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioCounter=ogEmdDioCounter, ogHostUserEntry=ogHostUserEntry, ogRpcType=ogRpcType, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceEntry=ogHostServiceEntry, ogRpcCounter=ogRpcCounter, ogCheckType=ogCheckType, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckResolveActions=ogCheckResolveActions, ogAlarmTime=ogAlarmTime, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemNetwork=ogCellModemNetwork, ogUpsInputVoltage=ogUpsInputVoltage, ogHostUserHost=ogHostUserHost, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortDTR=ogSerialPortDTR, ogEmdName=ogEmdName, ogHostServiceCounter=ogHostServiceCounter, ogCellDataNotification=ogCellDataNotification, ogRpcIndex=ogRpcIndex, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsIndex=ogUpsIndex, ogEmdDioEmd=ogEmdDioEmd, ogUpsTemperature=ogUpsTemperature, ogCheckName=ogCheckName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialUserLabel=ogSerialUserLabel, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApIndex=ogWifiApIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsEntry=ogUpsEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientTable=ogWifiApClientTable, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmEventId=ogAlarmEventId, ogUpsOutputNotification=ogUpsOutputNotification, ogCellMessageNotification=ogCellMessageNotification, ogWifiApEntry=ogWifiApEntry, ogCellModemTable=ogCellModemTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletState=ogRpcOutletState, ogCheckEntry=ogCheckEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientTable=ogWifiClientTable, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortDataBits=ogSerialPortDataBits, ogMibNotifications=ogMibNotifications, ogCellModemEntry=ogCellModemEntry, ogAlarmCheck=ogAlarmCheck, ogStatus2Compliance=ogStatus2Compliance, ogHostServiceTable=ogHostServiceTable, ogCellModemApn=ogCellModemApn, ogHostUserIndex=ogHostUserIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostPingNotification=ogHostPingNotification, ogWifiApInterface=ogWifiApInterface, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCustomNotification=ogCustomNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcInputNotification=ogRpcInputNotification, ogHostIndex=ogHostIndex, ogAlarmLogTable=ogAlarmLogTable, ogHostEntry=ogHostEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcName=ogRpcName, ogWifiApTable=ogWifiApTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientApMac=ogWifiClientApMac, ogSerialUserName=ogSerialUserName, ogHostUserName=ogHostUserName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmDevice=ogAlarmDevice, ogWifiApTxPower=ogWifiApTxPower, ogCellModemCounter=ogCellModemCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmType=ogAlarmType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcTable=ogRpcTable, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientMac=ogWifiApClientMac, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyName=ogPowerSupplyName, ogNetInterfaceName=ogNetInterfaceName, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemEnabled=ogCellModemEnabled, ogCheckTable=ogCheckTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceHost=ogHostServiceHost, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortRTS=ogSerialPortRTS, ogCellModemConnected=ogCellModemConnected, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientAp=ogWifiApClientAp, ogWebUserEntry=ogWebUserEntry, ogWebUserTable=ogWebUserTable, ogEmdTemperatureName=ogEmdTemperatureName, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserTable=ogSerialUserTable, ogUpsHumidity=ogUpsHumidity, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortBreaks=ogSerialPortBreaks, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceNotification=ogHostServiceNotification, ogWebUserNotification=ogWebUserNotification, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsType=ogUpsType, ogWifiApClientRssi=ogWifiApClientRssi, ogSystem=ogSystem, ogFirmwareVersion=ogFirmwareVersion, ogEmdDescription=ogEmdDescription, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcEntry=ogRpcEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogHostServicePort=ogHostServicePort, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTable=ogEmdTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserAddress=ogHostUserAddress, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceType=ogHostServiceType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdConnectType=ogEmdConnectType, ogWifiApFrequency=ogWifiApFrequency, ogUpsNotification=ogUpsNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityName=ogEmdHumidityName, ogAlarmName=ogAlarmName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogStatus2=ogStatus2, ogWebUserSourcePort=ogWebUserSourcePort, ogStatus2Groups=ogStatus2Groups, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemModel=ogCellModemModel)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckIndex=ogCheckIndex, ogRpcOutletName=ogRpcOutletName, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortTable=ogSerialPortTable, ogUpsTable=ogUpsTable, ogHostName=ogHostName, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarm=ogAlarm, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2Conformance=ogStatus2Conformance, ogEmdIndex=ogEmdIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogHostUserStartTime=ogHostUserStartTime, ogEmdEnabled=ogEmdEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioTable=ogEmdDioTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortIndex=ogSerialPortIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemTower=ogCellModemTower, ogWebUserName=ogWebUserName, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemVendor=ogCellModemVendor, ogAlarmUser=ogAlarmUser, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialNumber=ogSerialNumber, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcConnectType=ogRpcConnectType, ogSerialPortMode=ogSerialPortMode, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemTemperature=ogCellModemTemperature, ogWifiApSsid=ogWifiApSsid, ogSerialUserEntry=ogSerialUserEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogNetInterfaceState=ogNetInterfaceState, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserNotification=ogSerialUserNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioEntry=ogEmdDioEntry, ogUpsState=ogUpsState, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletTotal=ogRpcOutletTotal, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserNotification=ogHostUserNotification)
