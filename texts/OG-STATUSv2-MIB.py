...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserSourcePort=ogWebUserSourcePort, ogWebUserNotification=ogWebUserNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdName=ogEmdName, ogWifiApTable=ogWifiApTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserTable=ogSerialUserTable, ogSerialPortParity=ogSerialPortParity, ogStatus2=ogStatus2, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserIndex=ogWebUserIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcType=ogRpcType, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcEntry=ogRpcEntry, ogRpcConnectType=ogRpcConnectType, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApFrequency=ogWifiApFrequency, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellSignalNotification=ogCellSignalNotification, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemTable=ogCellModemTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientAp=ogWifiApClientAp, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostUserIndex=ogHostUserIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDescription=ogEmdDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserStartTime=ogHostUserStartTime, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarm=ogAlarm, ogMibNotifications=ogMibNotifications, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientApMac=ogWifiClientApMac, ogCheckName=ogCheckName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientCounter=ogWifiClientCounter, ogUpsNotification=ogUpsNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceTable=ogHostServiceTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioTable=ogEmdDioTable, ogEmdDioEmd=ogEmdDioEmd, ogEmdEnabled=ogEmdEnabled, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostIpV4Address=ogHostIpV4Address, ogEmdDioDescription=ogEmdDioDescription, ogCellModemIMSI=ogCellModemIMSI, ogWifiApEntry=ogWifiApEntry, ogSerialUserPort=ogSerialUserPort, ogCellModemModel=ogCellModemModel, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserTable=ogHostUserTable, ogHostUserHostName=ogHostUserHostName, ogSerialPortEntry=ogSerialPortEntry, ogAlarmInstance=ogAlarmInstance, ogStatus2Compliance=ogStatus2Compliance, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialUserEntry=ogSerialUserEntry, ogWebUserName=ogWebUserName, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputPower=ogUpsOutputPower, ogRpcCounter=ogRpcCounter, ogEmdDioName=ogEmdDioName, ogAlarmName=ogAlarmName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckIndex=ogCheckIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserIndex=ogSerialUserIndex, ogWebUserStartTime=ogWebUserStartTime, ogCellModemApn=ogCellModemApn, ogWifiApCounter=ogWifiApCounter, ogHostUserHost=ogHostUserHost, ogHostUserName=ogHostUserName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientTable=ogWifiClientTable, ogWifiClientMode=ogWifiClientMode, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsEntry=ogUpsEntry, ogSerialPortDTR=ogSerialPortDTR, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApIndex=ogWifiApIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApSsid=ogWifiApSsid, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioIndex=ogEmdDioIndex, ogWebUserEntry=ogWebUserEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortIndex=ogSerialPortIndex, ogRpcIndex=ogRpcIndex, ogUpsInputNotification=ogUpsInputNotification, ogStatus2Groups=ogStatus2Groups, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsHumidity=ogUpsHumidity, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientEntry=ogWifiClientEntry, ogAlarmSummary=ogAlarmSummary, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsConnectType=ogUpsConnectType, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemConnected=ogCellModemConnected, ogUpsIndex=ogUpsIndex, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRssi=ogWifiClientRssi, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemCounter=ogCellModemCounter, ogCellModemRegistered=ogCellModemRegistered, ogSystem=ogSystem, ogUpsType=ogUpsType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialNumber=ogSerialNumber, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmState=ogAlarmState, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletState=ogRpcOutletState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioType=ogEmdDioType, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServicePort=ogHostServicePort, ogRpcTable=ogRpcTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmDevice=ogAlarmDevice, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmTime=ogAlarmTime, ogWifiApInterface=ogWifiApInterface, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsName=ogUpsName, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioNotification=ogEmdDioNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcName=ogRpcName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientTable=ogWifiApClientTable, ogCheckTable=ogCheckTable, ogCellMessageNotification=ogCellMessageNotification, ogCheckEntry=ogCheckEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmType=ogAlarmType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsOutputNotification=ogUpsOutputNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioState=ogEmdDioState, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceType=ogHostServiceType, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmLogTable=ogAlarmLogTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostServiceCounter=ogHostServiceCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApEnabled=ogWifiApEnabled, ogEmdTable=ogEmdTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcInputCurrent=ogRpcInputCurrent, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogPowerSupplyIndex=ogPowerSupplyIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmUser=ogAlarmUser, ogEmdHumidityName=ogEmdHumidityName, ogUpsDescription=ogUpsDescription, ogCellModemVendor=ogCellModemVendor, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellDataNotification=ogCellDataNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortMode=ogSerialPortMode, ogEmdConnectType=ogEmdConnectType, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcDescription=ogRpcDescription, ogStatus2Conformance=ogStatus2Conformance, ogHostIndex=ogHostIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientIndex=ogWifiClientIndex, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsTable=ogUpsTable, ogHostTable=ogHostTable, ogEmdDioDirection=ogEmdDioDirection, ogCellTowerNotification=ogCellTowerNotification, ogCheckType=ogCheckType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemEnabled=ogCellModemEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdIndex=ogEmdIndex, ogEmdDioCounter=ogEmdDioCounter, ogWebUserTable=ogWebUserTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsCounter=ogUpsCounter, ogSerialUserName=ogSerialUserName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletName=ogRpcOutletName, ogHostPingNotification=ogHostPingNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemTower=ogCellModemTower, ogHostServiceIndex=ogHostServiceIndex, ogCustomNotification=ogCustomNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsState=ogUpsState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioEntry=ogEmdDioEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostName=ogHostName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceEntry=ogHostServiceEntry, ogHostEntry=ogHostEntry, ogEmdEntry=ogEmdEntry, ogHostServiceHost=ogHostServiceHost)
