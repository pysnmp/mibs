...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdName=ogEmdName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletState=ogRpcOutletState, ogAlarmDevice=ogAlarmDevice, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcType=ogRpcType, ogWifiClientEssid=ogWifiClientEssid, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdIndex=ogEmdIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemConnected=ogCellModemConnected, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientTable=ogWifiClientTable, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputNotification=ogUpsOutputNotification, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2=ogStatus2, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioName=ogEmdDioName, ogEmdTable=ogEmdTable, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsName=ogUpsName, ogCellMessageNotification=ogCellMessageNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortEntry=ogSerialPortEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCustomNotification=ogCustomNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostEntry=ogHostEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmName=ogAlarmName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmInstance=ogAlarmInstance, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmType=ogAlarmType, ogRpcInputNotification=ogRpcInputNotification, ogHostPingNotification=ogHostPingNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientMode=ogWifiClientMode, ogSerialPortDTR=ogSerialPortDTR, ogUpsTable=ogUpsTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientCounter=ogWifiClientCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApTxPower=ogWifiApTxPower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityTotal=ogEmdHumidityTotal, ogNetInterfaceState=ogNetInterfaceState, ogHostName=ogHostName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcIndex=ogRpcIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApEnabled=ogWifiApEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsTemperature=ogUpsTemperature, ogRpcOutletName=ogRpcOutletName, ogCellTowerNotification=ogCellTowerNotification, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortLabel=ogSerialPortLabel, ogCheckEntry=ogCheckEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserName=ogWebUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletLoad=ogRpcOutletLoad, ogWebUserIndex=ogWebUserIndex, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortParity=ogSerialPortParity, ogEmdDioTable=ogEmdDioTable, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortDSR=ogSerialPortDSR, ogCheckResolveActions=ogCheckResolveActions, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientInterface=ogWifiClientInterface, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckIndex=ogCheckIndex, ogUpsType=ogUpsType, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialUserName=ogSerialUserName, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityName=ogEmdHumidityName, ogWebUserTable=ogWebUserTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsHumidity=ogUpsHumidity, ogRpcTable=ogRpcTable, ogHostIpV4Address=ogHostIpV4Address, ogHostIpV6Address=ogHostIpV6Address, ogCellSignalNotification=ogCellSignalNotification, ogUpsState=ogUpsState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemTower=ogCellModemTower, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdConnectType=ogEmdConnectType, ogCellModemEntry=ogCellModemEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckTable=ogCheckTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServiceType=ogHostServiceType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioType=ogEmdDioType, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmUser=ogAlarmUser, ogAlarmState=ogAlarmState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmEventId=ogAlarmEventId, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdEntry=ogEmdEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortTable=ogSerialPortTable, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarm=ogAlarm, ogStatus2Conformance=ogStatus2Conformance, ogWifiApTable=ogWifiApTable, ogRpcName=ogRpcName, ogSerialUserPort=ogSerialUserPort, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserHost=ogHostUserHost, ogRpcDescription=ogRpcDescription, ogUpsDescription=ogUpsDescription, ogRpcEntry=ogRpcEntry, ogHostServicePort=ogHostServicePort, ogRpcCounter=ogRpcCounter, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutputNotification=ogRpcOutputNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserNotification=ogWebUserNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApInterface=ogWifiApInterface, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortMode=ogSerialPortMode, ogHostUserEntry=ogHostUserEntry, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckType=ogCheckType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortIndex=ogSerialPortIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsEntry=ogUpsEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialNumber=ogSerialNumber, ogUpsNotification=ogUpsNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogMibNotifications=ogMibNotifications, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemVendor=ogCellModemVendor, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDescription=ogEmdDescription, ogHostServiceNotification=ogHostServiceNotification, ogUpsIndex=ogUpsIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemModel=ogCellModemModel, ogWifiApCounter=ogWifiApCounter, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellApnNotification=ogCellApnNotification, ogHostServiceTable=ogHostServiceTable, ogAlarmTime=ogAlarmTime, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogStatus2Groups=ogStatus2Groups, ogEmdDioEmd=ogEmdDioEmd, ogHostUserStartTime=ogHostUserStartTime, ogNetInterfaceName=ogNetInterfaceName, ogHostTable=ogHostTable, ogCellModemIndex=ogCellModemIndex, ogAlarmSummary=ogAlarmSummary, ogSystem=ogSystem, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsCounter=ogUpsCounter)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemApn=ogCellModemApn, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioState=ogEmdDioState, ogHostUserName=ogHostUserName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserTable=ogSerialUserTable, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApSsid=ogWifiApSsid, ogCellModemTable=ogCellModemTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2Compliances=ogStatus2Compliances, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserNotification=ogHostUserNotification, ogWifiApClientAp=ogWifiApClientAp, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckDeviceName=ogCheckDeviceName, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletTable=ogRpcOutletTable, ogUpsConnectType=ogUpsConnectType, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemNetwork=ogCellModemNetwork, ogHostUserIndex=ogHostUserIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApEntry=ogWifiApEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogStatus2Compliance=ogStatus2Compliance, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostIndex=ogHostIndex, ogCheckName=ogCheckName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceStatus=ogHostServiceStatus, ogHostUserTable=ogHostUserTable, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellDataNotification=ogCellDataNotification, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserAddress=ogHostUserAddress, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemIMSI=ogCellModemIMSI)
