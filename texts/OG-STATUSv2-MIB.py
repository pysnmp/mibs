...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortDSR=ogSerialPortDSR, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortCTS=ogSerialPortCTS, ogAlarm=ogAlarm, ogRpcEntry=ogRpcEntry, ogAlarmType=ogAlarmType, ogHostServiceHost=ogHostServiceHost, ogWifiApInterface=ogWifiApInterface, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsType=ogUpsType, ogCheckDeviceName=ogCheckDeviceName, ogStatus2Groups=ogStatus2Groups, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientEssid=ogWifiClientEssid, ogCellSignalNotification=ogCellSignalNotification, ogWebUserIndex=ogWebUserIndex, ogEmdDioName=ogEmdDioName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortDTR=ogSerialPortDTR, ogUpsTable=ogUpsTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortIndex=ogSerialPortIndex, ogWifiApCounter=ogWifiApCounter, ogCellModemVendor=ogCellModemVendor, ogRpcIndex=ogRpcIndex, ogAlarmDevice=ogAlarmDevice, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcOutletName=ogRpcOutletName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckName=ogCheckName, ogNetInterfaceType=ogNetInterfaceType, ogEmdHumidityName=ogEmdHumidityName, ogCheckTriggerActions=ogCheckTriggerActions, ogCustomNotification=ogCustomNotification, ogEmdIndex=ogEmdIndex, ogRpcOutletTable=ogRpcOutletTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdEnabled=ogEmdEnabled, ogEmdDioNotification=ogEmdDioNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmLogTable=ogAlarmLogTable, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsCounter=ogUpsCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostServiceTable=ogHostServiceTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcName=ogRpcName, ogWifiApClientAp=ogWifiApClientAp, ogStatus2Compliances=ogStatus2Compliances, ogCellModemApn=ogCellModemApn, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserName=ogSerialUserName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityValue=ogEmdHumidityValue, ogWebUserName=ogWebUserName, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortParity=ogSerialPortParity, ogHostUserIndex=ogHostUserIndex, ogWifiClientMode=ogWifiClientMode, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDescription=ogEmdDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceCounter=ogHostServiceCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioDirection=ogEmdDioDirection, ogWifiApTable=ogWifiApTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckTable=ogCheckTable, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputCurrent=ogUpsInputCurrent, PYSNMP_MODULE_ID=ogStatus2, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyTable=ogPowerSupplyTable, ogFirmwareVersion=ogFirmwareVersion, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserEntry=ogHostUserEntry, ogCellModemCounter=ogCellModemCounter, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmName=ogAlarmName, ogWifiApEntry=ogWifiApEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioEmd=ogEmdDioEmd, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdTable=ogEmdTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApIndex=ogWifiApIndex, ogCellModemEntry=ogCellModemEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemEnabled=ogCellModemEnabled, ogAlarmCheck=ogAlarmCheck, ogEmdDioIndex=ogEmdDioIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWebUserNotification=ogWebUserNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckIndex=ogCheckIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogCellDataNotification=ogCellDataNotification, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcCounter=ogRpcCounter, ogSerialUserEntry=ogSerialUserEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServicePort=ogHostServicePort, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientEntry=ogWifiClientEntry, ogHostUserNotification=ogHostUserNotification, ogEmdDioTable=ogEmdDioTable, ogHostUserHostName=ogHostUserHostName, ogAlarmSummary=ogAlarmSummary, ogHostUserHost=ogHostUserHost, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserLabel=ogSerialUserLabel, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioType=ogEmdDioType, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortLabel=ogSerialPortLabel, ogAlarmEventId=ogAlarmEventId, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemConnected=ogCellModemConnected, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceEntry=ogHostServiceEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsConnectType=ogUpsConnectType, ogStatus2=ogStatus2, ogUpsTemperature=ogUpsTemperature, ogSerialNumber=ogSerialNumber, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmState=ogAlarmState, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdHumidityTable=ogEmdHumidityTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsIndex=ogUpsIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemIndex=ogCellModemIndex, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortMode=ogSerialPortMode, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputPower=ogUpsOutputPower, ogCellModemTable=ogCellModemTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogMibNotifications=ogMibNotifications, ogCheckType=ogCheckType, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsNotification=ogUpsNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostPingNotification=ogHostPingNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientTable=ogWifiClientTable, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioState=ogEmdDioState, ogHostIndex=ogHostIndex, ogHostUserTable=ogHostUserTable, ogWebUserEntry=ogWebUserEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcDescription=ogRpcDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioEntry=ogEmdDioEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialUserPort=ogSerialUserPort, ogCellModemTower=ogCellModemTower, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSystem=ogSystem, ogHostUserName=ogHostUserName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostTable=ogHostTable, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostName=ogHostName, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogHostEntry=ogHostEntry, ogUpsDescription=ogUpsDescription, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemRegistered=ogCellModemRegistered, ogWebUserTable=ogWebUserTable, ogCellApnNotification=ogCellApnNotification, ogAlarmTime=ogAlarmTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellMessageNotification=ogCellMessageNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcConnectType=ogRpcConnectType, ogWifiApEnabled=ogWifiApEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortTable=ogSerialPortTable, ogWifiClientCounter=ogWifiClientCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceType=ogHostServiceType, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemModel=ogCellModemModel, ogSerialUserIndex=ogSerialUserIndex, ogRpcType=ogRpcType, ogWifiApClientTable=ogWifiApClientTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsEntry=ogUpsEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsHumidity=ogUpsHumidity, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserTable=ogSerialUserTable, ogAlarmUser=ogAlarmUser, ogUpsName=ogUpsName, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckEntry=ogCheckEntry, ogEmdConnectType=ogEmdConnectType, ogRpcTable=ogRpcTable, ogEmdName=ogEmdName, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsState=ogUpsState, ogHostUserAddress=ogHostUserAddress)
