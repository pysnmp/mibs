...
TimeTicks, MibIdentifier, Counter64, ModuleIdentity, Integer32, Unsigned32, Bits, Gauge32, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Counter64", "ModuleIdentity", "Integer32", "Unsigned32", "Bits", "Gauge32", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellTowerNotification=ogCellTowerNotification, ogRpcConnectType=ogRpcConnectType, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserNotification=ogSerialUserNotification, ogUpsName=ogUpsName, ogHostUserEntry=ogHostUserEntry, ogWifiApIndex=ogWifiApIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioEntry=ogEmdDioEntry, ogSystem=ogSystem, ogWebUserEntry=ogWebUserEntry, ogHostServiceIndex=ogHostServiceIndex, ogUpsConnectType=ogUpsConnectType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientInterface=ogWifiClientInterface, ogCellModemEnabled=ogCellModemEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceState=ogNetInterfaceState, ogHostIndex=ogHostIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletTable=ogRpcOutletTable, ogUpsTable=ogUpsTable, ogHostUserAddress=ogHostUserAddress, ogWifiClientTable=ogWifiClientTable, ogUpsCounter=ogUpsCounter, ogHostUserStartTime=ogHostUserStartTime, ogWebUserIndex=ogWebUserIndex, ogRpcIndex=ogRpcIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioType=ogEmdDioType, ogHostName=ogHostName, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletNotification=ogRpcOutletNotification, ogStatus2Groups=ogStatus2Groups, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmTime=ogAlarmTime, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmName=ogCurrentAlarmName, ogHostUserHost=ogHostUserHost, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemModel=ogCellModemModel, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsState=ogUpsState, ogStatus2Compliance=ogStatus2Compliance, ogCellModemTemperature=ogCellModemTemperature, ogCheckEntry=ogCheckEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientBitRate=ogWifiClientBitRate, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientRssi=ogWifiClientRssi, ogAlarmName=ogAlarmName, ogEmdEnabled=ogEmdEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellDataNotification=ogCellDataNotification, ogSerialNumber=ogSerialNumber, ogUpsEntry=ogUpsEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsHumidity=ogUpsHumidity, ogWifiClientIndex=ogWifiClientIndex, ogAlarmType=ogAlarmType, ogCellModemTable=ogCellModemTable, ogUpsNotification=ogUpsNotification, ogNetInterfaceName=ogNetInterfaceName, ogHostUserName=ogHostUserName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioDirection=ogEmdDioDirection, ogHostPingNotification=ogHostPingNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostTable=ogHostTable, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckIndex=ogCheckIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmDevice=ogAlarmDevice, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarm=ogAlarm, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserTable=ogHostUserTable, ogAlarmState=ogAlarmState, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioNotification=ogEmdDioNotification, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserEntry=ogSerialUserEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemIMSI=ogCellModemIMSI, ogWifiApAssociationNotification=ogWifiApAssociationNotification, PYSNMP_MODULE_ID=ogStatus2, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserName=ogWebUserName, ogEmdTable=ogEmdTable, ogEmdHumidityTable=ogEmdHumidityTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioState=ogEmdDioState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmSummary=ogAlarmSummary, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserPort=ogSerialUserPort, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdEntry=ogEmdEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckName=ogCheckName, ogWifiApClientRssi=ogWifiApClientRssi, ogWebUserSourcePort=ogWebUserSourcePort, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceHost=ogHostServiceHost, ogRpcEntry=ogRpcEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApFrequency=ogWifiApFrequency, ogCustomNotification=ogCustomNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmUser=ogAlarmUser, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApTable=ogWifiApTable, ogRpcType=ogRpcType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdIndex=ogEmdIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientMode=ogWifiClientMode, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckType=ogCheckType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserNotification=ogHostUserNotification, ogHostUserIndex=ogHostUserIndex, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputPower=ogUpsOutputPower, ogCheckTable=ogCheckTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemConnected=ogCellModemConnected, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcCounter=ogRpcCounter, ogWebUserNotification=ogWebUserNotification, ogWifiApSsid=ogWifiApSsid, ogHostEntry=ogHostEntry, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceEntry=ogCheckDeviceEntry, ogStatus2=ogStatus2, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputNotification=ogUpsInputNotification, ogWifiApEnabled=ogWifiApEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserTable=ogWebUserTable, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellApnNotification=ogCellApnNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemTower=ogCellModemTower, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostServiceTable=ogHostServiceTable, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostIpV6Address=ogHostIpV6Address, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientEssid=ogWifiClientEssid, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemApn=ogCellModemApn, ogCellSignalNotification=ogCellSignalNotification, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServiceType=ogHostServiceType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsDescription=ogUpsDescription, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDescription=ogEmdDescription, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsIndex=ogUpsIndex, ogSerialUserTable=ogSerialUserTable, ogWifiApCounter=ogWifiApCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcDescription=ogRpcDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmEventId=ogAlarmEventId, ogEmdDioName=ogEmdDioName, ogWifiApClientAp=ogWifiApClientAp, ogEmdName=ogEmdName, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletState=ogRpcOutletState, ogWifiApClientMac=ogWifiApClientMac, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsTemperature=ogUpsTemperature, ogHostServiceStatus=ogHostServiceStatus, ogWifiApInterface=ogWifiApInterface, ogAlarmLogTable=ogAlarmLogTable, ogHostServicePort=ogHostServicePort, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2Compliances=ogStatus2Compliances, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcName=ogRpcName, ogUpsType=ogUpsType, ogSerialPortParity=ogSerialPortParity, ogEmdDioTable=ogEmdDioTable, ogCellModemCounter=ogCellModemCounter, ogEmdConnectType=ogEmdConnectType, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletName=ogRpcOutletName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogMibNotifications=ogMibNotifications, ogSerialUserLabel=ogSerialUserLabel, ogHostUserHostName=ogHostUserHostName, ogRpcTable=ogRpcTable, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryState=ogUpsBatteryState, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialSignalNotification=ogSerialSignalNotification, ogCellMessageNotification=ogCellMessageNotification, ogSerialUserName=ogSerialUserName, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmCheck=ogAlarmCheck, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemIndex=ogCellModemIndex, ogEmdDioDescription=ogEmdDioDescription, ogEmdTemperatureNotification=ogEmdTemperatureNotification)
