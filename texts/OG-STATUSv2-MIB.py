...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDescription=ogEmdDescription, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcCounter=ogRpcCounter, ogRpcDescription=ogRpcDescription, ogWifiApTable=ogWifiApTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemTable=ogCellModemTable, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserHostName=ogHostUserHostName, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemTower=ogCellModemTower, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApAssociationNotification=ogWifiApAssociationNotification, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmInstance=ogAlarmInstance, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemModel=ogCellModemModel, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserEntry=ogSerialUserEntry, ogWebUserTable=ogWebUserTable, ogEmdDioNotification=ogEmdDioNotification, ogMibNotifications=ogMibNotifications, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostEntry=ogHostEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientEssid=ogWifiClientEssid, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckType=ogCheckType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsEntry=ogUpsEntry, ogCellModemIndex=ogCellModemIndex, ogSerialPortParity=ogSerialPortParity, ogAlarmTime=ogAlarmTime, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcEntry=ogRpcEntry, ogHostServicePort=ogHostServicePort, ogHostServiceStatus=ogHostServiceStatus, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioIndex=ogEmdDioIndex, ogAlarmType=ogAlarmType, ogCellMessageNotification=ogCellMessageNotification, ogStatus2Conformance=ogStatus2Conformance, ogCellApnNotification=ogCellApnNotification, ogUpsType=ogUpsType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserNotification=ogHostUserNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialUserPort=ogSerialUserPort, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientTable=ogWifiClientTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostIndex=ogHostIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmCheck=ogAlarmCheck, ogCellModemSessionTime=ogCellModemSessionTime, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcIndex=ogRpcIndex, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortDSR=ogSerialPortDSR, ogWifiApIndex=ogWifiApIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserIndex=ogHostUserIndex, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientRssi=ogWifiClientRssi, ogCheckDeviceRef=ogCheckDeviceRef, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsLogEnabled=ogUpsLogEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioEmd=ogEmdDioEmd, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortCTS=ogSerialPortCTS, ogCheckTriggerActions=ogCheckTriggerActions, ogCellSignalNotification=ogCellSignalNotification, ogRpcType=ogRpcType, ogAlarmName=ogAlarmName, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientApMac=ogWifiClientApMac, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceState=ogNetInterfaceState, ogCellModemTemperature=ogCellModemTemperature, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2=ogStatus2, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioState=ogEmdDioState, ogWifiApCounter=ogWifiApCounter, ogCustomNotification=ogCustomNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemEnabled=ogCellModemEnabled, ogCellModemIMSI=ogCellModemIMSI, ogWifiApEntry=ogWifiApEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemVendor=ogCellModemVendor, ogUpsHumidity=ogUpsHumidity, ogHostName=ogHostName, ogCheckTable=ogCheckTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioCounter=ogEmdDioCounter, ogHostPingNotification=ogHostPingNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsName=ogUpsName, ogEmdTable=ogEmdTable, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioEntry=ogEmdDioEntry, ogHostUserEntry=ogHostUserEntry, ogUpsDescription=ogUpsDescription, ogEmdDioTable=ogEmdDioTable, ogAlarmState=ogAlarmState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletName=ogRpcOutletName, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarm=ogAlarm, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApTxPower=ogWifiApTxPower, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellDataNotification=ogCellDataNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserLabel=ogSerialUserLabel, ogWebUserEntry=ogWebUserEntry, ogAlarmUser=ogAlarmUser, ogHostUserHost=ogHostUserHost, ogWifiApInterface=ogWifiApInterface, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialUserName=ogSerialUserName, ogHostServiceCounter=ogHostServiceCounter, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsBatteryState=ogUpsBatteryState, ogStatus2Compliance=ogStatus2Compliance, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckIndex=ogCheckIndex, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityName=ogEmdHumidityName, ogEmdConnectType=ogEmdConnectType, ogEmdDioType=ogEmdDioType, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserName=ogWebUserName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientEntry=ogWifiClientEntry, ogHostUserAddress=ogHostUserAddress, ogStatus2Groups=ogStatus2Groups, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmSummary=ogAlarmSummary, ogSerialPortMode=ogSerialPortMode, ogEmdEnabled=ogEmdEnabled, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsCounter=ogUpsCounter, ogRpcTable=ogRpcTable, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceType=ogHostServiceType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdIndex=ogEmdIndex, ogCellModemEntry=ogCellModemEntry, ogCheckEntry=ogCheckEntry, ogRpcConnectType=ogRpcConnectType, ogUpsTable=ogUpsTable, ogPowerSupplyName=ogPowerSupplyName, ogCheckName=ogCheckName, ogUpsBatteryNotification=ogUpsBatteryNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortTable=ogSerialPortTable, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioDescription=ogEmdDioDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdName=ogEmdName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortRTS=ogSerialPortRTS, ogNetInterfaceName=ogNetInterfaceName, ogHostUserName=ogHostUserName, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortLabel=ogSerialPortLabel, ogHostUserTable=ogHostUserTable, ogWifiClientMode=ogWifiClientMode, ogUpsIndex=ogUpsIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemConnected=ogCellModemConnected, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortDTR=ogSerialPortDTR, ogWifiApEnabled=ogWifiApEnabled, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcName=ogRpcName, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioName=ogEmdDioName, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSystem=ogSystem, ogRpcInputNotification=ogRpcInputNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemCounter=ogCellModemCounter, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceTable=ogHostServiceTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdEntry=ogEmdEntry, ogHostTable=ogHostTable, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemApn=ogCellModemApn, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApSsid=ogWifiApSsid, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialNumber=ogSerialNumber, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserTable=ogSerialUserTable, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputNotification=ogUpsInputNotification, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsNotification=ogUpsNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsState=ogUpsState, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientTable=ogWifiApClientTable)
