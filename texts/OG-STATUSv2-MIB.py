...
TimeTicks, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Bits, ModuleIdentity, Unsigned32, NotificationType, ObjectIdentity, Gauge32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Bits", "ModuleIdentity", "Unsigned32", "NotificationType", "ObjectIdentity", "Gauge32", "Counter32", "iso")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioName=ogEmdDioName, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsState=ogUpsState, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserStartTime=ogWebUserStartTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientIndex=ogWifiClientIndex, ogCellDataNotification=ogCellDataNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsHumidity=ogUpsHumidity, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmTime=ogAlarmTime, ogStatus2Groups=ogStatus2Groups, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdEntry=ogEmdEntry, ogWifiClientApMac=ogWifiClientApMac, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcConnectType=ogRpcConnectType, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmInstance=ogAlarmInstance, ogEmdDioCounter=ogEmdDioCounter, ogWifiApFrequency=ogWifiApFrequency, ogAlarmUser=ogAlarmUser, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletTable=ogRpcOutletTable, ogUpsTable=ogUpsTable, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostPingNotification=ogHostPingNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioEmd=ogEmdDioEmd, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsNotification=ogUpsNotification, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckTable=ogCheckTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputPower=ogUpsOutputPower, ogCheckName=ogCheckName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortTable=ogSerialPortTable, ogCellModemApn=ogCellModemApn, ogHostName=ogHostName, ogCellModemRegistered=ogCellModemRegistered, ogAlarmType=ogAlarmType, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogWebUserName=ogWebUserName, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmState=ogAlarmState, ogNetInterfaceType=ogNetInterfaceType, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortDCD=ogSerialPortDCD, ogAlarmName=ogAlarmName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserPort=ogSerialUserPort, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserName=ogHostUserName, ogWebUserIndex=ogWebUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApEnabled=ogWifiApEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostTable=ogHostTable, ogCellTowerNotification=ogCellTowerNotification, ogCellModemConnected=ogCellModemConnected, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsCounter=ogUpsCounter, ogUpsDescription=ogUpsDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRssi=ogWifiClientRssi, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletName=ogRpcOutletName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdIndex=ogEmdIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostIndex=ogHostIndex, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserName=ogSerialUserName, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckIndex=ogCheckIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApEntry=ogWifiApEntry, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserHost=ogHostUserHost, ogRpcOutletState=ogRpcOutletState, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellApnNotification=ogCellApnNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsInputNotification=ogUpsInputNotification, ogRpcEntry=ogRpcEntry, ogMibNotifications=ogMibNotifications, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsName=ogUpsName, ogRpcDescription=ogRpcDescription, ogRpcCounter=ogRpcCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmSummary=ogAlarmSummary, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcIndex=ogRpcIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmDevice=ogAlarmDevice, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckDeviceTable=ogCheckDeviceTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientEnabled=ogWifiClientEnabled, ogWebUserNotification=ogWebUserNotification, ogCellModemTable=ogCellModemTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDescription=ogEmdDescription, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemIndex=ogCellModemIndex, ogFirmwareVersion=ogFirmwareVersion, ogEmdTable=ogEmdTable, ogUpsIndex=ogUpsIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsType=ogUpsType, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcName=ogRpcName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServiceEntry=ogHostServiceEntry, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCustomNotification=ogCustomNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApIndex=ogWifiApIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceHost=ogHostServiceHost, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserNotification=ogHostUserNotification, ogWifiApCounter=ogWifiApCounter, ogWifiClientTable=ogWifiClientTable, ogSystem=ogSystem, ogHostUserTable=ogHostUserTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemIMSI=ogCellModemIMSI, ogSerialNumber=ogSerialNumber, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdConnectType=ogEmdConnectType, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostIpV6Address=ogHostIpV6Address, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApTable=ogWifiApTable, ogHostUserHostName=ogHostUserHostName, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioState=ogEmdDioState, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientInterface=ogWifiClientInterface, ogUpsConnectType=ogUpsConnectType, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsEntry=ogUpsEntry, ogHostServicePort=ogHostServicePort, ogCheckEntry=ogCheckEntry, ogEmdEnabled=ogEmdEnabled, ogCheckType=ogCheckType, ogRpcType=ogRpcType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemModel=ogCellModemModel, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortParity=ogSerialPortParity, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientRssi=ogWifiApClientRssi, ogWebUserTable=ogWebUserTable, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemTower=ogCellModemTower, ogWifiApTxPower=ogWifiApTxPower, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserIndex=ogHostUserIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioDirection=ogEmdDioDirection, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcTable=ogRpcTable, ogStatus2=ogStatus2, ogWifiApInterface=ogWifiApInterface, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemCounter=ogCellModemCounter, ogHostEntry=ogHostEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserAddress=ogHostUserAddress, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioType=ogEmdDioType, ogWebUserEntry=ogWebUserEntry, ogUpsTemperature=ogUpsTemperature, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientMode=ogWifiClientMode, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogStatus2Compliances=ogStatus2Compliances, ogAlarmEventId=ogAlarmEventId, ogEmdDioNotification=ogEmdDioNotification, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceIndex=ogHostServiceIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortIndex=ogSerialPortIndex, ogAlarm=ogAlarm, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdName=ogEmdName, ogRpcOutletIndex=ogRpcOutletIndex, ogHostServiceType=ogHostServiceType, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputVoltage=ogUpsOutputVoltage)
