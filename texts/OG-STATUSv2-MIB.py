...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortLabel=ogSerialPortLabel, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdEntry=ogEmdEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogCellApnNotification=ogCellApnNotification, ogHostServiceIndex=ogHostServiceIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserHost=ogHostUserHost, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcConnectType=ogRpcConnectType, ogHostTable=ogHostTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceType=ogHostServiceType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostIpV6Address=ogHostIpV6Address, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServiceTable=ogHostServiceTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellTowerNotification=ogCellTowerNotification, ogAlarmSummary=ogAlarmSummary, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserEntry=ogHostUserEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemApn=ogCellModemApn, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserNotification=ogSerialUserNotification, ogUpsType=ogUpsType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceHost=ogHostServiceHost, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialNumber=ogSerialNumber, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsTable=ogUpsTable, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserTable=ogSerialUserTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApCounter=ogWifiApCounter, ogEmdDescription=ogEmdDescription, ogWebUserIndex=ogWebUserIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserNotification=ogHostUserNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPatternNotification=ogSerialPatternNotification, ogHostIndex=ogHostIndex, ogRpcEntry=ogRpcEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioState=ogEmdDioState, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdName=ogEmdName, ogSerialUserEntry=ogSerialUserEntry, ogCheckDeviceName=ogCheckDeviceName, ogHostUserIndex=ogHostUserIndex, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioName=ogEmdDioName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogStatus2Compliance=ogStatus2Compliance, ogRpcDescription=ogRpcDescription, ogWifiApTable=ogWifiApTable, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioType=ogEmdDioType, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemIndex=ogCellModemIndex, ogEmdDioIndex=ogEmdDioIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceState=ogNetInterfaceState, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsIndex=ogUpsIndex, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServicePort=ogHostServicePort, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellMessageNotification=ogCellMessageNotification, ogCellDataNotification=ogCellDataNotification, ogStatus2=ogStatus2, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckName=ogCheckName, ogCellModemTable=ogCellModemTable, ogHostServiceCounter=ogHostServiceCounter, ogWifiApIndex=ogWifiApIndex, ogRpcIndex=ogRpcIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcTable=ogRpcTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemVendor=ogCellModemVendor, ogCellModemEntry=ogCellModemEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletState=ogRpcOutletState, ogAlarmInstance=ogAlarmInstance, ogNetInterfaceType=ogNetInterfaceType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcName=ogRpcName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, PYSNMP_MODULE_ID=ogStatus2, ogCellModemTower=ogCellModemTower, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsDescription=ogUpsDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsHumidity=ogUpsHumidity, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputNotification=ogUpsInputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmCheck=ogAlarmCheck, ogWifiClientEntry=ogWifiClientEntry, ogStatus2Compliances=ogStatus2Compliances, ogWifiApInterface=ogWifiApInterface, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialUserPort=ogSerialUserPort, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsName=ogUpsName, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmEventId=ogAlarmEventId, ogWebUserEntry=ogWebUserEntry, ogCheckIndex=ogCheckIndex, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostUserAddress=ogHostUserAddress, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserNotification=ogWebUserNotification, ogCheckResolveActions=ogCheckResolveActions, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemConnected=ogCellModemConnected, ogRpcOutletTable=ogRpcOutletTable, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserName=ogWebUserName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogFirmwareVersion=ogFirmwareVersion, ogUpsConnectType=ogUpsConnectType, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmLogTable=ogAlarmLogTable, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortIndex=ogSerialPortIndex, ogUpsState=ogUpsState, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostName=ogHostName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcCounter=ogRpcCounter, ogEmdDioEmd=ogEmdDioEmd, ogRpcType=ogRpcType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmType=ogAlarmType, ogStatus2Groups=ogStatus2Groups, ogCustomNotification=ogCustomNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmTime=ogAlarmTime, ogSerialPortMode=ogSerialPortMode, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserTable=ogHostUserTable, ogHostEntry=ogHostEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdConnectType=ogEmdConnectType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletName=ogRpcOutletName, ogCellModemIMSI=ogCellModemIMSI, ogWifiApSsid=ogWifiApSsid, ogAlarmName=ogAlarmName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSystem=ogSystem, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsNotification=ogUpsNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceTable=ogCheckDeviceTable, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemNetwork=ogCellModemNetwork, ogRpcInputNotification=ogRpcInputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmUser=ogAlarmUser, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityName=ogEmdHumidityName, ogWebUserStartTime=ogWebUserStartTime, ogWebUserTable=ogWebUserTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceStatus=ogHostServiceStatus, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmState=ogAlarmState, ogAlarm=ogAlarm, ogWifiApClientMac=ogWifiApClientMac, ogWifiApTxPower=ogWifiApTxPower, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmState=ogCurrentAlarmState, ogHostIpV4Address=ogHostIpV4Address, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortDTR=ogSerialPortDTR, ogEmdIndex=ogEmdIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortRTS=ogSerialPortRTS, ogUpsEntry=ogUpsEntry, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortTable=ogSerialPortTable, ogCheckEntry=ogCheckEntry, ogUpsCounter=ogUpsCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRssi=ogWifiClientRssi, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckType=ogCheckType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserName=ogHostUserName, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserName=ogSerialUserName, ogWifiClientApMac=ogWifiClientApMac, ogMibNotifications=ogMibNotifications, ogCellModemModel=ogCellModemModel, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostPingNotification=ogHostPingNotification, ogCheckTable=ogCheckTable, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdTable=ogEmdTable, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow)
