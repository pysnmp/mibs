...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsTemperature=ogUpsTemperature, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceName=ogCheckDeviceName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcCounter=ogRpcCounter, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemCounter=ogCellModemCounter, ogHostServiceType=ogHostServiceType, ogAlarmInstance=ogAlarmInstance, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserHostName=ogHostUserHostName, ogSerialUserPort=ogSerialUserPort, ogSerialPortEntry=ogSerialPortEntry, ogStatus2=ogStatus2, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApEntry=ogWifiApEntry, ogRpcEntry=ogRpcEntry, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioState=ogEmdDioState, ogEmdHumidityEmd=ogEmdHumidityEmd, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellSignalNotification=ogCellSignalNotification, ogEmdIndex=ogEmdIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarm=ogAlarm, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortIndex=ogSerialPortIndex, ogAlarmName=ogAlarmName, ogWifiClientIndex=ogWifiClientIndex, ogSystem=ogSystem, ogHostUserName=ogHostUserName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletName=ogRpcOutletName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmCheck=ogAlarmCheck, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcName=ogRpcName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientTable=ogWifiClientTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogStatus2Compliances=ogStatus2Compliances, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserName=ogSerialUserName, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsType=ogUpsType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientCounter=ogWifiClientCounter, ogHostServiceEntry=ogHostServiceEntry, ogCellDataNotification=ogCellDataNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApTable=ogWifiApTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserAddress=ogHostUserAddress, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckType=ogCheckType, ogRpcInputFrequency=ogRpcInputFrequency, ogMibNotifications=ogMibNotifications, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserTable=ogHostUserTable, ogEmdDioCounter=ogEmdDioCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioDirection=ogEmdDioDirection, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModemModel=ogCellModemModel, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientEntry=ogWifiClientEntry, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioEmd=ogEmdDioEmd, ogFirmwareVersion=ogFirmwareVersion, ogCellModemTower=ogCellModemTower, ogUpsTable=ogUpsTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmLogTable=ogAlarmLogTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellTowerNotification=ogCellTowerNotification, ogWebUserNotification=ogWebUserNotification, ogHostServicePort=ogHostServicePort, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserName=ogWebUserName, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioDescription=ogEmdDioDescription, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyTable=ogPowerSupplyTable, ogHostIpV6Address=ogHostIpV6Address, ogHostUserNotification=ogHostUserNotification, ogSerialPortDSR=ogSerialPortDSR, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityName=ogEmdHumidityName, ogUpsName=ogUpsName, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsState=ogUpsState, ogSerialPatternNotification=ogSerialPatternNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsNotification=ogUpsNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcInputVoltage=ogRpcInputVoltage, ogHostName=ogHostName, ogRpcType=ogRpcType, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialUserIndex=ogSerialUserIndex, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioName=ogEmdDioName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientApMac=ogWifiClientApMac, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortRTS=ogSerialPortRTS, ogEmdTable=ogEmdTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserTable=ogWebUserTable, ogWifiClientEssid=ogWifiClientEssid, ogSerialNumber=ogSerialNumber, ogSerialPortMode=ogSerialPortMode, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientRssi=ogWifiClientRssi, ogCellModemEntry=ogCellModemEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemNetwork=ogCellModemNetwork, ogRpcConnectType=ogRpcConnectType, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDescription=ogEmdDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogHostEntry=ogHostEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogNetInterfaceName=ogNetInterfaceName, ogStatus2Groups=ogStatus2Groups, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcInputNotification=ogRpcInputNotification, ogHostPingNotification=ogHostPingNotification, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmEventId=ogAlarmEventId, ogUpsHumidity=ogUpsHumidity, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioTable=ogEmdDioTable, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsConnectType=ogUpsConnectType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApInterface=ogWifiApInterface, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApTxPower=ogWifiApTxPower, ogCellModemTemperature=ogCellModemTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogHostIndex=ogHostIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioType=ogEmdDioType, ogAlarmSummary=ogAlarmSummary, ogCellApnNotification=ogCellApnNotification, ogWebUserStartTime=ogWebUserStartTime, ogUpsEntry=ogUpsEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserHost=ogHostUserHost, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCustomNotification=ogCustomNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsIndex=ogUpsIndex, ogCheckTable=ogCheckTable, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcTable=ogRpcTable, ogCellModemTable=ogCellModemTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemIndex=ogCellModemIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdConnectType=ogEmdConnectType, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostTable=ogHostTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdEnabled=ogEmdEnabled, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortDCD=ogSerialPortDCD, ogAlarmType=ogAlarmType, ogEmdName=ogEmdName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmTriggerValue=ogAlarmTriggerValue)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceTable=ogHostServiceTable, ogUpsInputNotification=ogUpsInputNotification, ogCellModemEnabled=ogCellModemEnabled, ogCheckIndex=ogCheckIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemIMSI=ogCellModemIMSI, ogWifiApSsid=ogWifiApSsid, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialUserLabel=ogSerialUserLabel, ogWebUserEntry=ogWebUserEntry, ogRpcDescription=ogRpcDescription, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckEntry=ogCheckEntry, ogAlarmState=ogAlarmState, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmUser=ogAlarmUser, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemApn=ogCellModemApn, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogNetInterfaceIndex=ogNetInterfaceIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcIndex=ogRpcIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserEntry=ogSerialUserEntry, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortParity=ogSerialPortParity, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmDevice=ogAlarmDevice, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceHost=ogHostServiceHost, ogAlarmTime=ogAlarmTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApEnabled=ogWifiApEnabled, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserIndex=ogHostUserIndex, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemConnected=ogCellModemConnected, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWebUserIndex=ogWebUserIndex, ogRpcOutletState=ogRpcOutletState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientMac=ogWifiApClientMac, ogUpsDescription=ogUpsDescription, ogCheckName=ogCheckName, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdEntry=ogEmdEntry)
