...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemEnabled=ogCellModemEnabled, ogRpcCounter=ogRpcCounter, ogHostUserTable=ogHostUserTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceType=ogHostServiceType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientEssid=ogWifiClientEssid, ogUpsName=ogUpsName, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostPingNotification=ogHostPingNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityName=ogEmdHumidityName, ogAlarmLogTable=ogAlarmLogTable, ogHostServiceStatus=ogHostServiceStatus, ogHostServiceNotification=ogHostServiceNotification, ogCheckIndex=ogCheckIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsNotification=ogUpsNotification, ogCellModemApn=ogCellModemApn, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsType=ogUpsType, ogRpcName=ogRpcName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputPower=ogUpsOutputPower, ogAlarmTime=ogAlarmTime, ogHostServiceCounter=ogHostServiceCounter, ogUpsEntry=ogUpsEntry, ogCellMessageNotification=ogCellMessageNotification, ogCheckResolveActions=ogCheckResolveActions, ogStatus2Conformance=ogStatus2Conformance, ogEmdEnabled=ogEmdEnabled, ogUpsTable=ogUpsTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioIndex=ogEmdDioIndex, ogWebUserNotification=ogWebUserNotification, ogUpsTemperature=ogUpsTemperature, ogAlarmInstance=ogAlarmInstance, ogSerialPortLabel=ogSerialPortLabel, ogCellModemVendor=ogCellModemVendor, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApTable=ogWifiApTable, ogUpsConnectType=ogUpsConnectType, ogWebUserEntry=ogWebUserEntry, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemConnected=ogCellModemConnected, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCustomNotification=ogCustomNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWebUserName=ogWebUserName, ogEmdIndex=ogEmdIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogStatus2Groups=ogStatus2Groups, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortCTS=ogSerialPortCTS, ogHostUserName=ogHostUserName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmUser=ogAlarmUser, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdConnectType=ogEmdConnectType, ogRpcEntry=ogRpcEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcType=ogRpcType, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellSignalNotification=ogCellSignalNotification, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsState=ogUpsState, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialUserTable=ogSerialUserTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmType=ogAlarmType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServicePort=ogHostServicePort, ogCheckName=ogCheckName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemTemperature=ogCellModemTemperature, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletName=ogRpcOutletName, ogEmdDioDirection=ogEmdDioDirection, ogCellModemNetwork=ogCellModemNetwork, ogAlarm=ogAlarm, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputVoltage=ogUpsOutputVoltage, ogStatus2=ogStatus2, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemModel=ogCellModemModel, ogUpsInputNotification=ogUpsInputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogCellApnNotification=ogCellApnNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientAp=ogWifiApClientAp, ogUpsIndex=ogUpsIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogHostTable=ogHostTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemTable=ogCellModemTable, ogNetInterfaceType=ogNetInterfaceType, ogWifiApEntry=ogWifiApEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortMode=ogSerialPortMode, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientEntry=ogWifiClientEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmCheck=ogAlarmCheck, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemCounter=ogCellModemCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcTable=ogRpcTable, ogHostUserEntry=ogHostUserEntry, ogHostEntry=ogHostEntry, ogHostUserHost=ogHostUserHost, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdEntry=ogEmdEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioTable=ogEmdDioTable, ogSystem=ogSystem, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmState=ogAlarmState, ogSerialUserEntry=ogSerialUserEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogCellDataNotification=ogCellDataNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserHostName=ogHostUserHostName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputFrequency=ogUpsInputFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmEventId=ogAlarmEventId, ogRpcDescription=ogRpcDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserIndex=ogSerialUserIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemTower=ogCellModemTower, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioState=ogEmdDioState, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientMode=ogWifiClientMode, ogUpsHumidity=ogUpsHumidity, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApIndex=ogWifiApIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletCurrent=ogRpcOutletCurrent, ogFirmwareVersion=ogFirmwareVersion, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemEntry=ogCellModemEntry, ogWifiClientIndex=ogWifiClientIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogWebUserStartTime=ogWebUserStartTime, ogCheckDeviceName=ogCheckDeviceName, ogRpcIndex=ogRpcIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmSummary=ogAlarmSummary, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityTable=ogEmdHumidityTable, ogStatus2Compliance=ogStatus2Compliance, ogMibNotifications=ogMibNotifications, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientTable=ogWifiApClientTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserTable=ogWebUserTable, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckEntry=ogCheckEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogHostIndex=ogHostIndex, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserNotification=ogSerialUserNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioDescription=ogEmdDioDescription, ogUpsDescription=ogUpsDescription, ogHostUserAddress=ogHostUserAddress, ogUpsOutputNotification=ogUpsOutputNotification, ogHostName=ogHostName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortDCD=ogSerialPortDCD, ogWifiApEnabled=ogWifiApEnabled, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceTable=ogHostServiceTable, ogEmdTable=ogEmdTable, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdName=ogEmdName, ogWifiApInterface=ogWifiApInterface, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemIMSI=ogCellModemIMSI)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmDevice=ogAlarmDevice, ogCheckTable=ogCheckTable, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmState=ogCurrentAlarmState, PYSNMP_MODULE_ID=ogStatus2, ogHostUserIndex=ogHostUserIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApCounter=ogWifiApCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsCounter=ogUpsCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientTable=ogWifiClientTable, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryState=ogUpsBatteryState, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserName=ogSerialUserName, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialNumber=ogSerialNumber, ogSerialPortParity=ogSerialPortParity, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioType=ogEmdDioType, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServiceHost=ogHostServiceHost, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioName=ogEmdDioName, ogEmdDescription=ogEmdDescription, ogSerialUserPort=ogSerialUserPort, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckType=ogCheckType, ogAlarmName=ogAlarmName, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortTable=ogSerialPortTable, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortRxBytes=ogSerialPortRxBytes)
