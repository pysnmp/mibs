...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserSourceAddress=ogWebUserSourceAddress, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserHostName=ogHostUserHostName, ogHostEntry=ogHostEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckResolveActions=ogCheckResolveActions, ogUpsType=ogUpsType, ogWifiApInterface=ogWifiApInterface, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientTable=ogWifiApClientTable, ogWebUserEntry=ogWebUserEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmName=ogAlarmName, ogRpcName=ogRpcName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcEntry=ogRpcEntry, ogStatus2Compliances=ogStatus2Compliances, ogCellModemModel=ogCellModemModel, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogBasicStatusGroup=ogBasicStatusGroup, ogSystem=ogSystem, ogWifiApClientAp=ogWifiApClientAp, ogEmdEnabled=ogEmdEnabled, ogUpsDescription=ogUpsDescription, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckType=ogCheckType, ogEmdDioCounter=ogEmdDioCounter, ogCheckName=ogCheckName, ogUpsCounter=ogUpsCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientMac=ogWifiApClientMac, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsHumidity=ogUpsHumidity, ogSerialPortTable=ogSerialPortTable, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcInputNotification=ogRpcInputNotification, ogWebUserStartTime=ogWebUserStartTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostIndex=ogHostIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostIpV6Address=ogHostIpV6Address, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckEntry=ogCheckEntry, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceTable=ogHostServiceTable, ogCellModemConnected=ogCellModemConnected, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApEntry=ogWifiApEntry, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcDescription=ogRpcDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyName=ogPowerSupplyName, ogCellDataNotification=ogCellDataNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcCounter=ogRpcCounter, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckTable=ogCheckTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientInterface=ogWifiClientInterface, ogWebUserTable=ogWebUserTable, ogCellModemEntry=ogCellModemEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserIndex=ogHostUserIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApCounter=ogWifiApCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcTable=ogRpcTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServicePort=ogHostServicePort, ogAlarm=ogAlarm, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientMode=ogWifiClientMode, ogSerialUserName=ogSerialUserName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcIndex=ogRpcIndex, ogHostIpV4Address=ogHostIpV4Address, ogStatus2Groups=ogStatus2Groups, ogStatus2=ogStatus2, ogEmdHumidityEntry=ogEmdHumidityEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioType=ogEmdDioType, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellMessageNotification=ogCellMessageNotification, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDescription=ogEmdDescription, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemRegistered=ogCellModemRegistered, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmState=ogAlarmState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioName=ogEmdDioName, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemNetwork=ogCellModemNetwork, ogUpsTable=ogUpsTable, ogUpsConnectType=ogUpsConnectType, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortFlowControl=ogSerialPortFlowControl, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioState=ogEmdDioState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsEntry=ogUpsEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserAddress=ogHostUserAddress, ogWifiApTable=ogWifiApTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostName=ogHostName, ogCustomNotification=ogCustomNotification, ogSerialNumber=ogSerialNumber, ogRpcType=ogRpcType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserEntry=ogSerialUserEntry, ogAlarmSummary=ogAlarmSummary, ogUpsName=ogUpsName, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceHost=ogHostServiceHost, ogWebUserNotification=ogWebUserNotification, ogCellApnNotification=ogCellApnNotification, ogEmdTable=ogEmdTable, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientRssi=ogWifiClientRssi, ogCellModemIMSI=ogCellModemIMSI, ogUpsIndex=ogUpsIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemApn=ogCellModemApn, ogHostUserTable=ogHostUserTable, ogEmdName=ogEmdName, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckIndex=ogCheckIndex, ogCellModemCounter=ogCellModemCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientTable=ogWifiClientTable, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemIndex=ogCellModemIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmLogTable=ogAlarmLogTable, ogEmdIndex=ogEmdIndex, ogHostServiceType=ogHostServiceType, ogEmdDioTable=ogEmdDioTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemVendor=ogCellModemVendor, ogCellTowerNotification=ogCellTowerNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserHost=ogHostUserHost, ogRpcOutletName=ogRpcOutletName, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceType=ogNetInterfaceType, PYSNMP_MODULE_ID=ogStatus2, ogAlarmUser=ogAlarmUser, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmTime=ogAlarmTime, ogAlarmCheck=ogAlarmCheck, ogSerialPortParityErrors=ogSerialPortParityErrors)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsNotification=ogUpsNotification, ogCellModemEnabled=ogCellModemEnabled, ogCellModemTemperature=ogCellModemTemperature, ogAlarmInstance=ogAlarmInstance, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserLabel=ogSerialUserLabel, ogUpsTemperature=ogUpsTemperature, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApTxPower=ogWifiApTxPower, ogWifiApSsid=ogWifiApSsid, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogMibNotifications=ogMibNotifications, ogHostTable=ogHostTable, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdEntry=ogEmdEntry, ogEmdDioDescription=ogEmdDioDescription, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceIndex=ogHostServiceIndex, ogHostUserNotification=ogHostUserNotification, ogSerialPortCTS=ogSerialPortCTS, ogWebUserName=ogWebUserName, ogHostServiceNotification=ogHostServiceNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortMode=ogSerialPortMode, ogHostUserStartTime=ogHostUserStartTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialUserTable=ogSerialUserTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostUserName=ogHostUserName, ogRpcOutletTable=ogRpcOutletTable, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApIndex=ogWifiApIndex, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsState=ogUpsState, ogEmdDioEntry=ogEmdDioEntry, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmType=ogAlarmType, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemTower=ogCellModemTower, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTable=ogCellModemTable, ogAlarmDevice=ogAlarmDevice, ogCellModem3gRssi=ogCellModem3gRssi)
