...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletTable=ogRpcOutletTable, ogSerialUserEntry=ogSerialUserEntry, ogHostServiceIndex=ogHostServiceIndex, ogCheckName=ogCheckName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckEntry=ogCheckEntry, ogHostServiceNotification=ogHostServiceNotification, ogUpsIndex=ogUpsIndex, ogHostServiceTable=ogHostServiceTable, ogHostUserEntry=ogHostUserEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserIndex=ogHostUserIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsName=ogUpsName, ogWebUserStartTime=ogWebUserStartTime, ogHostUserName=ogHostUserName, ogNetInterfaceName=ogNetInterfaceName, ogAlarmTime=ogAlarmTime, ogSerialPortTable=ogSerialPortTable, ogRpcOutletState=ogRpcOutletState, ogWebUserName=ogWebUserName, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientCounter=ogWifiClientCounter, ogEmdEntry=ogEmdEntry, ogCheckIndex=ogCheckIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcInputNotification=ogRpcInputNotification, ogUpsNotification=ogUpsNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceHost=ogHostServiceHost, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemModel=ogCellModemModel, ogCellModemApn=ogCellModemApn, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdName=ogEmdName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioName=ogEmdDioName, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckType=ogCheckType, ogRpcConnectType=ogRpcConnectType, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemCounter=ogCellModemCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceCounter=ogHostServiceCounter, ogUpsHumidity=ogUpsHumidity, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTable=ogEmdTable, ogCellModemConnected=ogCellModemConnected, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientEntry=ogWifiClientEntry, ogCellModemNetwork=ogCellModemNetwork, ogRpcTable=ogRpcTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserName=ogSerialUserName, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioTable=ogEmdDioTable, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcEntry=ogRpcEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserIndex=ogWebUserIndex, ogEmdIndex=ogEmdIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmInstance=ogAlarmInstance, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellDataNotification=ogCellDataNotification, ogSystem=ogSystem, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmState=ogAlarmState, ogRpcIndex=ogRpcIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckTriggerActions=ogCheckTriggerActions, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientTable=ogWifiClientTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdEnabled=ogEmdEnabled, ogSerialUserPort=ogSerialUserPort, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWebUserEntry=ogWebUserEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmEventId=ogAlarmEventId, ogCellModemEntry=ogCellModemEntry, ogEmdDioState=ogEmdDioState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientIndex=ogWifiClientIndex, ogHostIndex=ogHostIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdConnectType=ogEmdConnectType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostPingNotification=ogHostPingNotification, ogWifiClientMode=ogWifiClientMode, ogCellModemTower=ogCellModemTower, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsCounter=ogUpsCounter, ogCheckTable=ogCheckTable, ogWifiApCounter=ogWifiApCounter, ogEmdDioEntry=ogEmdDioEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmCheck=ogAlarmCheck, ogMibNotifications=ogMibNotifications, ogEmdDioDirection=ogEmdDioDirection, ogStatus2Compliance=ogStatus2Compliance, ogHostTable=ogHostTable, ogRpcType=ogRpcType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApTable=ogWifiApTable, ogEmdDioEmd=ogEmdDioEmd, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceType=ogHostServiceType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWebUserNotification=ogWebUserNotification, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientRssi=ogWifiClientRssi, ogFirmwareVersion=ogFirmwareVersion, ogCellSignalNotification=ogCellSignalNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletName=ogRpcOutletName, ogWifiApIndex=ogWifiApIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcName=ogRpcName, ogCellModemTable=ogCellModemTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserHostName=ogHostUserHostName, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletLoad=ogRpcOutletLoad, ogHostUserAddress=ogHostUserAddress, ogSerialPortDTR=ogSerialPortDTR, ogHostUserHost=ogHostUserHost, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmLogTable=ogAlarmLogTable, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortCTS=ogSerialPortCTS, ogRpcDescription=ogRpcDescription, ogCellModemVendor=ogCellModemVendor, ogEmdDescription=ogEmdDescription, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmSummary=ogAlarmSummary, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceType=ogNetInterfaceType, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemRegistered=ogCellModemRegistered, ogSerialNumber=ogSerialNumber, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServicePort=ogHostServicePort, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityName=ogEmdHumidityName, ogAlarmType=ogAlarmType, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsConnectType=ogUpsConnectType, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioType=ogEmdDioType, ogEmdDioIndex=ogEmdDioIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioNotification=ogEmdDioNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserIndex=ogSerialUserIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogHostUserNotification=ogHostUserNotification, PYSNMP_MODULE_ID=ogStatus2, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmDevice=ogAlarmDevice, ogAlarm=ogAlarm, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsTable=ogUpsTable, ogAlarmUser=ogAlarmUser, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCustomNotification=ogCustomNotification, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceEntry=ogHostServiceEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApEntry=ogWifiApEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsState=ogUpsState, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostEntry=ogHostEntry, ogWebUserTable=ogWebUserTable, ogSerialPortIndex=ogSerialPortIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostName=ogHostName, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryState=ogUpsBatteryState, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientApMac=ogWifiClientApMac, ogAlarmName=ogAlarmName, ogHostUserTable=ogHostUserTable, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckResolveActions=ogCheckResolveActions, ogUpsType=ogUpsType, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientAp=ogWifiApClientAp, ogCellModemIndex=ogCellModemIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsTemperature=ogUpsTemperature, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsDescription=ogUpsDescription, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortMode=ogSerialPortMode, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcCounter=ogRpcCounter, ogWifiApInterface=ogWifiApInterface, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApEnabled=ogWifiApEnabled, ogCellModemTemperature=ogCellModemTemperature, ogHostIpV6Address=ogHostIpV6Address, ogUpsEntry=ogUpsEntry, ogStatus2=ogStatus2, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApSsid=ogWifiApSsid, ogWifiApFrequency=ogWifiApFrequency, ogCheckResetTimeout=ogCheckResetTimeout)
