...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApTable=ogWifiApTable, ogUpsInputFrequency=ogUpsInputFrequency, ogCustomNotification=ogCustomNotification, ogWifiApEnabled=ogWifiApEnabled, ogRpcEntry=ogRpcEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientEssid=ogWifiClientEssid, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceHost=ogHostServiceHost, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserName=ogHostUserName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmType=ogAlarmType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsType=ogUpsType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortParity=ogSerialPortParity, ogAlarmTime=ogAlarmTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTable=ogEmdTable, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemRegistered=ogCellModemRegistered, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2Compliance=ogStatus2Compliance, ogEmdConnectType=ogEmdConnectType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApTxPower=ogWifiApTxPower, ogStatus2Groups=ogStatus2Groups, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioState=ogEmdDioState, ogRpcOutletEntry=ogRpcOutletEntry, ogWebUserNotification=ogWebUserNotification, ogSerialPortDTR=ogSerialPortDTR, ogHostTable=ogHostTable, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserHostName=ogHostUserHostName, ogEmdName=ogEmdName, ogEmdDescription=ogEmdDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsIndex=ogUpsIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcConnectType=ogRpcConnectType, ogSerialPortDCD=ogSerialPortDCD, ogWebUserEntry=ogWebUserEntry, ogEmdEnabled=ogEmdEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmLogTable=ogAlarmLogTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostServiceCounter=ogHostServiceCounter, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemModel=ogCellModemModel, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioDirection=ogEmdDioDirection, PYSNMP_MODULE_ID=ogStatus2, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserStartTime=ogHostUserStartTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApSsid=ogWifiApSsid, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmUser=ogAlarmUser, ogUpsNotification=ogUpsNotification, ogCellModemIMSI=ogCellModemIMSI, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostIpV6Address=ogHostIpV6Address, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellApnNotification=ogCellApnNotification, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortRTS=ogSerialPortRTS, ogAlarmState=ogAlarmState, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckIndex=ogCheckIndex, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostPingNotification=ogHostPingNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmInstance=ogAlarmInstance, ogCheckType=ogCheckType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcName=ogRpcName, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortEntry=ogSerialPortEntry, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioName=ogEmdDioName, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserPort=ogSerialUserPort, ogWifiClientRssi=ogWifiClientRssi, ogNetInterfaceState=ogNetInterfaceState, ogCellModemApn=ogCellModemApn, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortMode=ogSerialPortMode, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcType=ogRpcType, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckTable=ogCheckTable, ogHostServiceTable=ogHostServiceTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmCheck=ogAlarmCheck, ogCellModemTable=ogCellModemTable, ogUpsTable=ogUpsTable, ogNetInterfaceName=ogNetInterfaceName, ogRpcInputNotification=ogRpcInputNotification, ogHostIndex=ogHostIndex, ogSystem=ogSystem, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2=ogStatus2, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletName=ogRpcOutletName, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsDescription=ogUpsDescription, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityEntry=ogEmdHumidityEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserNotification=ogHostUserNotification, ogWebUserTable=ogWebUserTable, ogHostEntry=ogHostEntry, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceName=ogCheckDeviceName, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmName=ogAlarmName, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortCTS=ogSerialPortCTS, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemEntry=ogCellModemEntry, ogCellModemCounter=ogCellModemCounter, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcCounter=ogRpcCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserName=ogWebUserName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialNumber=ogSerialNumber, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientMode=ogWifiClientMode, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortDSR=ogSerialPortDSR, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServicePort=ogHostServicePort, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletTable=ogRpcOutletTable, ogCheckName=ogCheckName, ogCheckEntry=ogCheckEntry, ogUpsName=ogUpsName, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdEntry=ogEmdEntry, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemIndex=ogCellModemIndex, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientMac=ogWifiApClientMac, ogCheckResolveActions=ogCheckResolveActions, ogHostName=ogHostName, ogSerialUserIndex=ogSerialUserIndex, ogUpsCounter=ogUpsCounter, ogCellModemTemperature=ogCellModemTemperature, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialUserName=ogSerialUserName, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarm=ogAlarm, ogWebUserIndex=ogWebUserIndex, ogEmdDioType=ogEmdDioType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApEntry=ogWifiApEntry, ogMibNotifications=ogMibNotifications, ogUpsTemperature=ogUpsTemperature, ogEmdIndex=ogEmdIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientCounter=ogWifiClientCounter)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientInterface=ogWifiClientInterface, ogHostUserHost=ogHostUserHost, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortLabel=ogSerialPortLabel, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsState=ogUpsState, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioTable=ogEmdDioTable, ogHostUserAddress=ogHostUserAddress, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmType=ogCurrentAlarmType, ogCellDataNotification=ogCellDataNotification, ogAlarmDevice=ogAlarmDevice, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientAp=ogWifiApClientAp, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcDescription=ogRpcDescription, ogWifiApInterface=ogWifiApInterface, ogHostUserEntry=ogHostUserEntry, ogCellModemConnected=ogCellModemConnected, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcIndex=ogRpcIndex, ogCellModemTower=ogCellModemTower, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityName=ogEmdHumidityName, ogEmdDioEntry=ogEmdDioEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsHumidity=ogUpsHumidity, ogStatus2Compliances=ogStatus2Compliances, ogUpsEntry=ogUpsEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogHostUserTable=ogHostUserTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioCounter=ogEmdDioCounter, ogAlarmSummary=ogAlarmSummary, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyName=ogPowerSupplyName, ogCellModemVendor=ogCellModemVendor, ogRpcTable=ogRpcTable, ogCheckDeviceTable=ogCheckDeviceTable)
