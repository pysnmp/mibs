...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmName=ogAlarmName, ogRpcTable=ogRpcTable, ogWifiApTable=ogWifiApTable, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsEntry=ogUpsEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsIndex=ogUpsIndex, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemNetwork=ogCellModemNetwork, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemIndex=ogCellModemIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApCounter=ogWifiApCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogCellApnNotification=ogCellApnNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdIndex=ogEmdIndex, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialNumber=ogSerialNumber, ogRpcInputNotification=ogRpcInputNotification, ogCustomNotification=ogCustomNotification, ogHostServiceIndex=ogHostServiceIndex, ogAlarmState=ogAlarmState, ogCellModemTower=ogCellModemTower, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemConnected=ogCellModemConnected, ogUpsState=ogUpsState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioEmd=ogEmdDioEmd, ogStatus2=ogStatus2, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogNetInterfaceState=ogNetInterfaceState, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcEntry=ogRpcEntry, ogRpcOutletTable=ogRpcOutletTable, ogRpcCounter=ogRpcCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogMibNotifications=ogMibNotifications, ogSerialUserTable=ogSerialUserTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsType=ogUpsType, ogStatus2Compliances=ogStatus2Compliances, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryState=ogUpsBatteryState, ogAlarmTime=ogAlarmTime, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletState=ogRpcOutletState, ogSerialUserPort=ogSerialUserPort, ogAlarmSummary=ogAlarmSummary, ogEmdConnectType=ogEmdConnectType, ogHostUserIndex=ogHostUserIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioIndex=ogEmdDioIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemModel=ogCellModemModel, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortDCD=ogSerialPortDCD, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellSignalNotification=ogCellSignalNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemApn=ogCellModemApn, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortEntry=ogSerialPortEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostIndex=ogHostIndex, ogEmdDioState=ogEmdDioState, ogWebUserNotification=ogWebUserNotification, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioType=ogEmdDioType, ogCellModemVendor=ogCellModemVendor, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientMode=ogWifiClientMode, ogRpcConnectType=ogRpcConnectType, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemTemperature=ogCellModemTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserName=ogHostUserName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientTable=ogWifiClientTable, ogWebUserStartTime=ogWebUserStartTime, ogUpsTable=ogUpsTable, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioName=ogEmdDioName, ogRpcInputFrequency=ogRpcInputFrequency, ogCellTowerNotification=ogCellTowerNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApEntry=ogWifiApEntry, ogHostUserHostName=ogHostUserHostName, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserTable=ogHostUserTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostIpV6Address=ogHostIpV6Address, ogAlarmInstance=ogAlarmInstance, ogHostIpV4Address=ogHostIpV4Address, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserEntry=ogSerialUserEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckTable=ogCheckTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsName=ogUpsName, ogEmdDioTable=ogEmdDioTable, ogCellModemTable=ogCellModemTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTable=ogEmdTable, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortDTR=ogSerialPortDTR, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletVoltage=ogRpcOutletVoltage, ogFirmwareVersion=ogFirmwareVersion, ogUpsTemperature=ogUpsTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckType=ogCheckType, ogPowerSupplyName=ogPowerSupplyName, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcDescription=ogRpcDescription, ogCellModemCounter=ogCellModemCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientBitRate=ogWifiClientBitRate, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserTable=ogWebUserTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsDescription=ogUpsDescription, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsConnectType=ogUpsConnectType, ogWifiClientEssid=ogWifiClientEssid, ogUpsNotification=ogUpsNotification, ogEmdEntry=ogEmdEntry, ogEmdDioCounter=ogEmdDioCounter, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortMode=ogSerialPortMode, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceStatus=ogHostServiceStatus, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientFrequency=ogWifiClientFrequency, PYSNMP_MODULE_ID=ogStatus2, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserEntry=ogHostUserEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputLoad=ogUpsOutputLoad, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServiceType=ogHostServiceType, ogEmdEnabled=ogEmdEnabled, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmType=ogAlarmType, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApEnabled=ogWifiApEnabled, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDescription=ogEmdDescription, ogHostUserNotification=ogHostUserNotification, ogHostServiceHost=ogHostServiceHost, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortCTS=ogSerialPortCTS)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServicePort=ogHostServicePort, ogAlarmEventId=ogAlarmEventId, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWebUserName=ogWebUserName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServiceNotification=ogHostServiceNotification, ogRpcName=ogRpcName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostName=ogHostName, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemEnabled=ogCellModemEnabled, ogEmdName=ogEmdName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserName=ogSerialUserName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientMac=ogWifiApClientMac, ogUpsCounter=ogUpsCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostEntry=ogHostEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckEntry=ogCheckEntry, ogWebUserIndex=ogWebUserIndex, ogHostUserHost=ogHostUserHost, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsHumidity=ogUpsHumidity, ogRpcType=ogRpcType, ogEmdHumidityName=ogEmdHumidityName, ogWifiApInterface=ogWifiApInterface, ogWifiClientEntry=ogWifiClientEntry, ogCheckIndex=ogCheckIndex, ogAlarm=ogAlarm, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletEntry=ogRpcOutletEntry, ogHostPingNotification=ogHostPingNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortTable=ogSerialPortTable, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcIndex=ogRpcIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogHostTable=ogHostTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserAddress=ogHostUserAddress, ogAlarmUser=ogAlarmUser, ogSerialPortParity=ogSerialPortParity, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckName=ogCheckName, ogEmdDioNotification=ogEmdDioNotification, ogSystem=ogSystem, ogWifiApFrequency=ogWifiApFrequency, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmDevice=ogAlarmDevice, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletName=ogRpcOutletName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemEntry=ogCellModemEntry)
