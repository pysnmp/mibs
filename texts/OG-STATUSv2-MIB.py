...
ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, TimeTicks, Gauge32, Counter32, Bits, ObjectIdentity, MibIdentifier, Integer32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "TimeTicks", "Gauge32", "Counter32", "Bits", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckDeviceName=ogCheckDeviceName, ogUpsName=ogUpsName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserName=ogSerialUserName, ogCellModemNetwork=ogCellModemNetwork, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioState=ogEmdDioState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemTable=ogCellModemTable, ogSerialPortEntry=ogSerialPortEntry, ogHostUserTable=ogHostUserTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortRTS=ogSerialPortRTS, ogHostEntry=ogHostEntry, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioIndex=ogEmdDioIndex, ogWifiApSsid=ogWifiApSsid, ogAlarm=ogAlarm, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceCounter=ogHostServiceCounter, ogWifiApCounter=ogWifiApCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckTable=ogCheckTable, ogHostPingNotification=ogHostPingNotification, ogCheckType=ogCheckType, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioTable=ogEmdDioTable, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsCounter=ogUpsCounter, ogHostServiceIndex=ogHostServiceIndex, ogSystem=ogSystem, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioNotification=ogEmdDioNotification, ogHostServicePort=ogHostServicePort, ogWebUserIndex=ogWebUserIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdName=ogEmdName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserHost=ogHostUserHost, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcCounter=ogRpcCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortMode=ogSerialPortMode, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogStatus2=ogStatus2, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientApMac=ogWifiClientApMac, ogEmdEnabled=ogEmdEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcEntry=ogRpcEntry, ogRpcOutletName=ogRpcOutletName, ogCellModemApn=ogCellModemApn, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserAddress=ogHostUserAddress, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcIndex=ogRpcIndex, ogAlarmState=ogAlarmState, ogWebUserName=ogWebUserName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApTable=ogWifiApTable, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserTable=ogSerialUserTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientCounter=ogWifiClientCounter, ogEmdConnectType=ogEmdConnectType, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortIndex=ogSerialPortIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserEntry=ogSerialUserEntry, ogEmdTable=ogEmdTable, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortFlowControl=ogSerialPortFlowControl, PYSNMP_MODULE_ID=ogStatus2, ogRpcType=ogRpcType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsHumidity=ogUpsHumidity, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcDescription=ogRpcDescription, ogAlarmEventId=ogAlarmEventId, ogUpsIndex=ogUpsIndex, ogCellModemIndex=ogCellModemIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdIndex=ogEmdIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceType=ogHostServiceType, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmTime=ogAlarmTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServiceNotification=ogHostServiceNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmName=ogAlarmName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDescription=ogEmdDescription, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsDescription=ogUpsDescription, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortTable=ogSerialPortTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckIndex=ogCheckIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmInstance=ogAlarmInstance, ogSerialUserIndex=ogSerialUserIndex, ogStatus2Compliance=ogStatus2Compliance, ogNetInterfaceName=ogNetInterfaceName, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioEmd=ogEmdDioEmd, ogFirmwareVersion=ogFirmwareVersion, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogHostTable=ogHostTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogUpsEntry=ogUpsEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletState=ogRpcOutletState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcTable=ogRpcTable, ogCellModemEnabled=ogCellModemEnabled, ogAlarmCheck=ogAlarmCheck, ogSerialPortDTR=ogSerialPortDTR, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmDevice=ogAlarmDevice, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientTable=ogWifiApClientTable, ogCheckResolveActions=ogCheckResolveActions, ogCellModemModel=ogCellModemModel, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Compliances=ogStatus2Compliances, ogWifiApIndex=ogWifiApIndex, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApEntry=ogWifiApEntry, ogSerialNumber=ogSerialNumber, ogHostUserName=ogHostUserName, ogHostIpV6Address=ogHostIpV6Address, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostIndex=ogHostIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceStatus=ogHostServiceStatus, ogHostUserHostName=ogHostUserHostName, ogEmdDioName=ogEmdDioName, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortSpeed=ogSerialPortSpeed, ogHostName=ogHostName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCustomNotification=ogCustomNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsType=ogUpsType, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortCTS=ogSerialPortCTS, ogWebUserStartTime=ogWebUserStartTime, ogCellSignalNotification=ogCellSignalNotification, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsTable=ogUpsTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortLogLevel=ogSerialPortLogLevel)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserIndex=ogHostUserIndex, ogSerialPortParity=ogSerialPortParity, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsTemperature=ogUpsTemperature, ogCheckName=ogCheckName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioEntry=ogEmdDioEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcConnectType=ogRpcConnectType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWebUserTable=ogWebUserTable, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientAp=ogWifiApClientAp, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmUser=ogAlarmUser, ogMibNotifications=ogMibNotifications, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioDescription=ogEmdDioDescription, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemTower=ogCellModemTower, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserPort=ogSerialUserPort, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioType=ogEmdDioType, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioCounter=ogEmdDioCounter, ogCheckEntry=ogCheckEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceHost=ogHostServiceHost, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsState=ogUpsState, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmType=ogAlarmType, ogEmdEntry=ogEmdEntry, ogUpsNotification=ogUpsNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemCounter=ogCellModemCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceIndex=ogNetInterfaceIndex, ogStatus2Conformance=ogStatus2Conformance, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserNotification=ogHostUserNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientTable=ogWifiClientTable, ogAlarmSummary=ogAlarmSummary, ogRpcName=ogRpcName, ogCellMessageNotification=ogCellMessageNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApEnabled=ogWifiApEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemVendor=ogCellModemVendor)
