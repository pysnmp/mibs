...
ModuleIdentity, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, iso, IpAddress, MibIdentifier, Bits, Unsigned32, Counter32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "iso", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "Counter32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserHost=ogHostUserHost, ogSerialPortTable=ogSerialPortTable, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputVoltage=ogUpsOutputVoltage, ogFirmwareVersion=ogFirmwareVersion, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostIndex=ogHostIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletRpc=ogRpcOutletRpc, ogHostServiceStatus=ogHostServiceStatus, ogEmdName=ogEmdName, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcTable=ogRpcTable, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsTable=ogUpsTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioTable=ogEmdDioTable, ogMibNotifications=ogMibNotifications, ogUpsInputNotification=ogUpsInputNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceNotification=ogHostServiceNotification, ogCheckResolveActions=ogCheckResolveActions, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCustomNotification=ogCustomNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortMode=ogSerialPortMode, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsType=ogUpsType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmName=ogAlarmName, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialNumber=ogSerialNumber, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmType=ogAlarmType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2Compliances=ogStatus2Compliances, ogCheckType=ogCheckType, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientCounter=ogWifiClientCounter, ogCellDataNotification=ogCellDataNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostTable=ogHostTable, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortEntry=ogSerialPortEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostIpV4Address=ogHostIpV4Address, ogWifiApSsid=ogWifiApSsid, ogRpcIndex=ogRpcIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmDevice=ogAlarmDevice, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserEntry=ogWebUserEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcInputNotification=ogRpcInputNotification, ogCellModemVendor=ogCellModemVendor, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserAddress=ogHostUserAddress, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemConnected=ogCellModemConnected, ogAlarm=ogAlarm, ogCellModemRegistered=ogCellModemRegistered, ogRpcConnectType=ogRpcConnectType, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserNotification=ogHostUserNotification, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserTable=ogHostUserTable, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2Groups=ogStatus2Groups, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientEssid=ogWifiClientEssid, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioIndex=ogEmdDioIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckEntry=ogCheckEntry, ogCheckDeviceName=ogCheckDeviceName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApEntry=ogWifiApEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdIndex=ogEmdIndex, ogSerialUserIndex=ogSerialUserIndex, ogEmdEnabled=ogEmdEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTable=ogEmdTable, ogWifiClientFrequency=ogWifiClientFrequency, ogNetInterfaceName=ogNetInterfaceName, ogCellModemEntry=ogCellModemEntry, ogCellModemTemperature=ogCellModemTemperature, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmEventId=ogAlarmEventId, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmTime=ogAlarmTime, ogRpcOutletName=ogRpcOutletName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmCheck=ogAlarmCheck, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWebUserTable=ogWebUserTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceTable=ogNetInterfaceTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmSummary=ogAlarmSummary, ogUpsNotification=ogUpsNotification, ogCellModemModel=ogCellModemModel, ogRpcCounter=ogRpcCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostIpV6Address=ogHostIpV6Address, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioState=ogEmdDioState, ogHostServiceTable=ogHostServiceTable, ogUpsIndex=ogUpsIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostUserHostName=ogHostUserHostName, ogSerialPortParity=ogSerialPortParity, ogWebUserNotification=ogWebUserNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsTemperature=ogUpsTemperature, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceEntry=ogHostServiceEntry, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsEntry=ogUpsEntry, ogEmdDioDirection=ogEmdDioDirection, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserTable=ogSerialUserTable, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioType=ogEmdDioType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsHumidity=ogUpsHumidity, ogUpsOutputPower=ogUpsOutputPower, ogAlarmInstance=ogAlarmInstance, ogCellModemTable=ogCellModemTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmUser=ogAlarmUser, ogAlarmState=ogAlarmState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserName=ogSerialUserName, ogEmdDescription=ogEmdDescription, ogWifiApAssociationNotification=ogWifiApAssociationNotification, PYSNMP_MODULE_ID=ogStatus2, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApTxPower=ogWifiApTxPower, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsCounter=ogUpsCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServicePort=ogHostServicePort, ogCheckIndex=ogCheckIndex, ogCellApnNotification=ogCellApnNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioName=ogEmdDioName, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdEntry=ogEmdEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsState=ogUpsState, ogCheckTable=ogCheckTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServiceType=ogHostServiceType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApFrequency=ogWifiApFrequency, ogCheckName=ogCheckName, ogStatus2=ogStatus2, ogUpsName=ogUpsName, ogWebUserName=ogWebUserName, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortRTS=ogSerialPortRTS, ogCellModemApn=ogCellModemApn, ogEmdHumidityName=ogEmdHumidityName, ogRpcName=ogRpcName, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserPort=ogSerialUserPort, ogHostName=ogHostName, ogWifiApTable=ogWifiApTable, ogCellModemCounter=ogCellModemCounter, ogWifiClientApMac=ogWifiClientApMac, ogHostPingNotification=ogHostPingNotification, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioDescription=ogEmdDioDescription, ogHostUserName=ogHostUserName, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemIMSI=ogCellModemIMSI, ogRpcDescription=ogRpcDescription, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2Compliance=ogStatus2Compliance, ogSystem=ogSystem, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortLabel=ogSerialPortLabel, ogWifiApInterface=ogWifiApInterface, ogBasicStatusGroup=ogBasicStatusGroup, ogCellTowerNotification=ogCellTowerNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcType=ogRpcType, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApIndex=ogWifiApIndex, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemNetwork=ogCellModemNetwork, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApCounter=ogWifiApCounter, ogUpsConnectType=ogUpsConnectType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsDescription=ogUpsDescription, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcEntry=ogRpcEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemIndex=ogCellModemIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioNotification=ogEmdDioNotification, ogHostEntry=ogHostEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemTower=ogCellModemTower, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostServiceIndex=ogHostServiceIndex)
