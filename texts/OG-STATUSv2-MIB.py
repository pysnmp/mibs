...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserIndex=ogHostUserIndex, ogEmdIndex=ogEmdIndex, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioType=ogEmdDioType, ogRpcInputFrequency=ogRpcInputFrequency, ogSystem=ogSystem, ogSerialNumber=ogSerialNumber, ogCellModemCounter=ogCellModemCounter, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckType=ogCheckType, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostServiceNotification=ogHostServiceNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserName=ogWebUserName, ogEmdDescription=ogEmdDescription, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserTable=ogWebUserTable, ogEmdDioEntry=ogEmdDioEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogCellTowerNotification=ogCellTowerNotification, ogHostUserTable=ogHostUserTable, ogWifiApIndex=ogWifiApIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmUser=ogAlarmUser, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientBitRate=ogWifiClientBitRate, ogStatus2Compliance=ogStatus2Compliance, ogSerialUserName=ogSerialUserName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServiceTable=ogHostServiceTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostName=ogHostName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserNotification=ogWebUserNotification, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdEntry=ogEmdEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmName=ogAlarmName, ogRpcOutletState=ogRpcOutletState, ogHostEntry=ogHostEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcEntry=ogRpcEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemConnected=ogCellModemConnected, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcType=ogRpcType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientRssi=ogWifiClientRssi, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemRegistered=ogCellModemRegistered, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemTemperature=ogCellModemTemperature, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogNetInterfaceName=ogNetInterfaceName, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcConnectType=ogRpcConnectType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCustomNotification=ogCustomNotification, ogUpsCounter=ogUpsCounter, ogRpcOutputNotification=ogRpcOutputNotification, PYSNMP_MODULE_ID=ogStatus2, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsHumidity=ogUpsHumidity, ogUpsIndex=ogUpsIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCliUserSessionNotification=ogCliUserSessionNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostTable=ogHostTable, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemVendor=ogCellModemVendor, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApEntry=ogWifiApEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApCounter=ogWifiApCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogFirmwareVersion=ogFirmwareVersion, ogHostUserHostName=ogHostUserHostName, ogStatus2=ogStatus2, ogRpcInputCurrent=ogRpcInputCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletName=ogRpcOutletName, ogCheckIndex=ogCheckIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckResolveActions=ogCheckResolveActions, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortEntry=ogSerialPortEntry, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceType=ogNetInterfaceType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcTable=ogRpcTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortDCD=ogSerialPortDCD, ogRpcName=ogRpcName, ogCellDataNotification=ogCellDataNotification, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcDescription=ogRpcDescription, ogPowerSupplyName=ogPowerSupplyName, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmState=ogAlarmState, ogMibNotifications=ogMibNotifications, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserNotification=ogHostUserNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckName=ogCheckName, ogCheckTable=ogCheckTable, ogWifiClientCounter=ogWifiClientCounter, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioIndex=ogEmdDioIndex, ogRpcIndex=ogRpcIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdEnabled=ogEmdEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserHost=ogHostUserHost, ogUpsTable=ogUpsTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioName=ogEmdDioName, ogWifiClientTable=ogWifiClientTable, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortCTS=ogSerialPortCTS, ogCellModemModel=ogCellModemModel, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioTable=ogEmdDioTable, ogAlarmInstance=ogAlarmInstance, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserEntry=ogSerialUserEntry, ogHostIpV4Address=ogHostIpV4Address, ogAlarmTime=ogAlarmTime, ogEmdConnectType=ogEmdConnectType, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcCounter=ogRpcCounter, ogSerialPortMode=ogSerialPortMode, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsName=ogUpsName, ogRpcOutletTable=ogRpcOutletTable, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmEventId=ogAlarmEventId, ogCellModemTable=ogCellModemTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostIndex=ogHostIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceHost=ogHostServiceHost, ogUpsState=ogUpsState, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApTxPower=ogWifiApTxPower, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTable=ogEmdTable, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemTower=ogCellModemTower, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientEnabled=ogWifiClientEnabled, ogCellApnNotification=ogCellApnNotification, ogSerialUserNotification=ogSerialUserNotification, ogEmdName=ogEmdName, ogSerialPortParity=ogSerialPortParity, ogWifiApClientAp=ogWifiApClientAp, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceEntry=ogHostServiceEntry, ogUpsDescription=ogUpsDescription, ogWifiApClientTable=ogWifiApClientTable, ogCheckEntry=ogCheckEntry, ogCheckDeviceName=ogCheckDeviceName, ogHostUserName=ogHostUserName, ogUpsEntry=ogUpsEntry, ogEmdHumidityName=ogEmdHumidityName, ogHostUserStartTime=ogHostUserStartTime, ogWifiApTable=ogWifiApTable, ogCellModemIndex=ogCellModemIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmType=ogAlarmType, ogStatus2Groups=ogStatus2Groups, ogCellModemApn=ogCellModemApn, ogUpsNotification=ogUpsNotification, ogSerialUserPort=ogSerialUserPort, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostUserAddress=ogHostUserAddress, ogAlarmSummary=ogAlarmSummary, ogEmdDioState=ogEmdDioState, ogUpsConnectType=ogUpsConnectType, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmDevice=ogAlarmDevice, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemEnabled=ogCellModemEnabled, ogWebUserIndex=ogWebUserIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmCheck=ogAlarmCheck, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApEnabled=ogWifiApEnabled, ogHostPingNotification=ogHostPingNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceType=ogHostServiceType, ogWebUserEntry=ogWebUserEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientMode=ogWifiClientMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServicePort=ogHostServicePort, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortDTR=ogSerialPortDTR, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortIndex=ogSerialPortIndex, ogUpsTemperature=ogUpsTemperature, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsType=ogUpsType, ogEmdDioDirection=ogEmdDioDirection, ogAlarm=ogAlarm, ogSerialUserTable=ogSerialUserTable, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletRpc=ogRpcOutletRpc)
