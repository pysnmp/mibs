...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTxBytes=ogSerialPortTxBytes, ogStatus2Groups=ogStatus2Groups, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortDSR=ogSerialPortDSR, ogUpsConnectType=ogUpsConnectType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemConnected=ogCellModemConnected, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientEntry=ogWifiClientEntry, ogRpcDescription=ogRpcDescription, ogAlarmInstance=ogAlarmInstance, ogWifiClientTable=ogWifiClientTable, ogWebUserTable=ogWebUserTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdHumidityName=ogEmdHumidityName, ogCheckEntry=ogCheckEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcType=ogRpcType, ogCheckName=ogCheckName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsNotification=ogUpsNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserIndex=ogHostUserIndex, ogHostUserAddress=ogHostUserAddress, ogRpcCounter=ogRpcCounter, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellApnNotification=ogCellApnNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsHumidity=ogUpsHumidity, ogCellModemNetwork=ogCellModemNetwork, ogAlarmTime=ogAlarmTime, ogUpsTable=ogUpsTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyName=ogPowerSupplyName, ogCellTowerNotification=ogCellTowerNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserEntry=ogHostUserEntry, ogHostIpV4Address=ogHostIpV4Address, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputTruePower=ogUpsOutputTruePower, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserNotification=ogHostUserNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortLabel=ogSerialPortLabel, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceName=ogCheckDeviceName, ogEmdIndex=ogEmdIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletState=ogRpcOutletState, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceType=ogNetInterfaceType, ogCustomNotification=ogCustomNotification, ogRpcEntry=ogRpcEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsState=ogUpsState, ogStatus2Compliance=ogStatus2Compliance, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckTable=ogCheckTable, ogHostUserName=ogHostUserName, ogWifiClientEnabled=ogWifiClientEnabled, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceTable=ogHostServiceTable, ogEmdDioState=ogEmdDioState, ogWifiApIndex=ogWifiApIndex, ogWifiApCounter=ogWifiApCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdEntry=ogEmdEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioDirection=ogEmdDioDirection, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioIndex=ogEmdDioIndex, ogAlarmName=ogAlarmName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogStatus2=ogStatus2, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientMac=ogWifiApClientMac, ogCellModemTable=ogCellModemTable, ogWifiClientMode=ogWifiClientMode, ogAlarmType=ogAlarmType, ogSerialPortMode=ogSerialPortMode, ogUpsOutputLoad=ogUpsOutputLoad, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortCTS=ogSerialPortCTS, ogEmdTable=ogEmdTable, ogHostUserHost=ogHostUserHost, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioType=ogEmdDioType, ogUpsCounter=ogUpsCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioName=ogEmdDioName, ogWifiClientRssi=ogWifiClientRssi, ogEmdDescription=ogEmdDescription, ogSerialUserLabel=ogSerialUserLabel, ogCellModemIMSI=ogCellModemIMSI, ogHostServiceStatus=ogHostServiceStatus, ogUpsIndex=ogUpsIndex, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsTemperature=ogUpsTemperature, ogRpcConnectType=ogRpcConnectType, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckIndex=ogCheckIndex, ogCheckResolveActions=ogCheckResolveActions, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsType=ogUpsType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserIndex=ogSerialUserIndex, ogHostUserHostName=ogHostUserHostName, ogSerialPortTable=ogSerialPortTable, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcName=ogRpcName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogStatus2Conformance=ogStatus2Conformance, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckType=ogCheckType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialUserTable=ogSerialUserTable, ogSerialNumber=ogSerialNumber, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostTable=ogHostTable, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmState=ogAlarmState, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemApn=ogCellModemApn, ogSerialPortEntry=ogSerialPortEntry, ogAlarmSummary=ogAlarmSummary, ogHostServicePort=ogHostServicePort, ogEmdTemperatureName=ogEmdTemperatureName, ogSystem=ogSystem, ogWebUserName=ogWebUserName, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmDevice=ogAlarmDevice, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortRTS=ogSerialPortRTS, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcTable=ogRpcTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemRegistered=ogCellModemRegistered, ogHostIndex=ogHostIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, PYSNMP_MODULE_ID=ogStatus2, ogEmdEnabled=ogEmdEnabled, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortParity=ogSerialPortParity, ogWifiApClientEntry=ogWifiApClientEntry, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemTower=ogCellModemTower, ogSerialPortDCD=ogSerialPortDCD, ogHostServiceHost=ogHostServiceHost, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostEntry=ogHostEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellMessageNotification=ogCellMessageNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortBreaks=ogSerialPortBreaks)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserName=ogSerialUserName, ogHostServiceType=ogHostServiceType, ogRpcOutletTable=ogRpcOutletTable, ogWebUserStartTime=ogWebUserStartTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarm=ogAlarm, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserTable=ogHostUserTable, ogAlarmLogTable=ogAlarmLogTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApEntry=ogWifiApEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostName=ogHostName, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmUser=ogAlarmUser, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Compliances=ogStatus2Compliances, ogCellModemEntry=ogCellModemEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdName=ogEmdName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemModel=ogCellModemModel, ogAlarmPreviousValue=ogAlarmPreviousValue, ogMibNotifications=ogMibNotifications, ogUpsEntry=ogUpsEntry, ogWifiApFrequency=ogWifiApFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioTable=ogEmdDioTable, ogSerialPortIndex=ogSerialPortIndex, ogCellModemVendor=ogCellModemVendor, ogCellModemIndex=ogCellModemIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApTable=ogWifiApTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletName=ogRpcOutletName, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsDescription=ogUpsDescription, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientAp=ogWifiApClientAp, ogRpcIndex=ogRpcIndex, ogWebUserNotification=ogWebUserNotification, ogUpsName=ogUpsName, ogEmdDioCounter=ogEmdDioCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdConnectType=ogEmdConnectType, ogWifiApTxPower=ogWifiApTxPower, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyEntry=ogPowerSupplyEntry)
