...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApEntry=ogWifiApEntry, ogCellModemTemperature=ogCellModemTemperature, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemApn=ogCellModemApn, ogEmdDioCounter=ogEmdDioCounter, ogUpsIndex=ogUpsIndex, ogSerialPortParity=ogSerialPortParity, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserIndex=ogSerialUserIndex, ogCellModemTable=ogCellModemTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioName=ogEmdDioName, ogHostUserHostName=ogHostUserHostName, ogAlarmState=ogAlarmState, ogEmdDioType=ogEmdDioType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsNotification=ogUpsNotification, ogHostPingNotification=ogHostPingNotification, ogUpsTable=ogUpsTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogFirmwareVersion=ogFirmwareVersion, ogStatus2Compliances=ogStatus2Compliances, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsHumidity=ogUpsHumidity, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientInterface=ogWifiClientInterface, ogAlarmInstance=ogAlarmInstance, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckName=ogCheckName, ogCheckEntry=ogCheckEntry, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, PYSNMP_MODULE_ID=ogStatus2, ogCellModemModel=ogCellModemModel, ogRpcEntry=ogRpcEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceEntry=ogNetInterfaceEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortTable=ogSerialPortTable, ogAlarmName=ogAlarmName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortEntry=ogSerialPortEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckIndex=ogCheckIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServiceType=ogHostServiceType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserTable=ogSerialUserTable, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemTower=ogCellModemTower, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckType=ogCheckType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcTable=ogRpcTable, ogHostUserTable=ogHostUserTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceTable=ogHostServiceTable, ogSerialPortIndex=ogSerialPortIndex, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApTable=ogWifiApTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialUserName=ogSerialUserName, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortRTS=ogSerialPortRTS, ogNetInterfaceType=ogNetInterfaceType, ogHostUserEntry=ogHostUserEntry, ogHostIndex=ogHostIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdEntry=ogEmdEntry, ogAlarmDevice=ogAlarmDevice, ogWifiApClientRssi=ogWifiApClientRssi, ogStatus2=ogStatus2, ogUpsOutputPower=ogUpsOutputPower, ogRpcType=ogRpcType, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSystem=ogSystem, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmTime=ogAlarmTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserLabel=ogSerialUserLabel, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostEntry=ogHostEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcConnectType=ogRpcConnectType, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioTable=ogEmdDioTable, ogSerialUserPort=ogSerialUserPort, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsTemperature=ogUpsTemperature, ogAlarm=ogAlarm, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortDCD=ogSerialPortDCD, ogCellSignalNotification=ogCellSignalNotification, ogHostUserName=ogHostUserName, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmType=ogAlarmType, ogUpsBatteryState=ogUpsBatteryState, ogWebUserIndex=ogWebUserIndex, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogHostTable=ogHostTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceName=ogNetInterfaceName, ogWifiApInterface=ogWifiApInterface, ogStatus2Compliance=ogStatus2Compliance, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdConnectType=ogEmdConnectType, ogCheckTable=ogCheckTable, ogWifiApIndex=ogWifiApIndex, ogRpcOutletName=ogRpcOutletName, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckDeviceName=ogCheckDeviceName, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceCounter=ogHostServiceCounter, ogRpcInputNotification=ogRpcInputNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemVendor=ogCellModemVendor, ogEmdDioEmd=ogEmdDioEmd, ogCellApnNotification=ogCellApnNotification, ogHostServiceIndex=ogHostServiceIndex, ogUpsConnectType=ogUpsConnectType, ogMibNotifications=ogMibNotifications, ogEmdName=ogEmdName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientMode=ogWifiClientMode, ogRpcOutletNotification=ogRpcOutletNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserHost=ogHostUserHost, ogUpsName=ogUpsName, ogUpsState=ogUpsState, ogWifiClientIndex=ogWifiClientIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmEventId=ogAlarmEventId, ogHostServiceHost=ogHostServiceHost, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmLogTable=ogAlarmLogTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemEntry=ogCellModemEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcIndex=ogRpcIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTable=ogEmdTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyName=ogPowerSupplyName, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdEnabled=ogEmdEnabled, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientEntry=ogWifiClientEntry, ogUpsEntry=ogUpsEntry, ogRpcDescription=ogRpcDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioState=ogEmdDioState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortMode=ogSerialPortMode, ogWebUserTable=ogWebUserTable, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortBreaks=ogSerialPortBreaks, ogCellTowerNotification=ogCellTowerNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientRssi=ogWifiClientRssi, ogStatus2Conformance=ogStatus2Conformance, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWebUserName=ogWebUserName, ogWebUserEntry=ogWebUserEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientTable=ogWifiApClientTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmSummary=ogAlarmSummary, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserNotification=ogWebUserNotification, ogCellDataNotification=ogCellDataNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemCounter=ogCellModemCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioNotification=ogEmdDioNotification, ogStatus2Groups=ogStatus2Groups, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDescription=ogEmdDescription, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsType=ogUpsType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientMac=ogWifiApClientMac, ogRpcName=ogRpcName, ogWifiApClientAp=ogWifiApClientAp, ogCellModemIMSI=ogCellModemIMSI, ogEmdIndex=ogEmdIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostName=ogHostName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCustomNotification=ogCustomNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioDescription=ogEmdDioDescription, ogCellModemIndex=ogCellModemIndex, ogRpcOutletState=ogRpcOutletState, ogAlarmUser=ogAlarmUser, ogSerialNumber=ogSerialNumber, ogRpcCounter=ogRpcCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServicePort=ogHostServicePort, ogUpsCounter=ogUpsCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsDescription=ogUpsDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortDTR=ogSerialPortDTR, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApEnabled=ogWifiApEnabled, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApCounter=ogWifiApCounter, ogCellModemConnected=ogCellModemConnected)
