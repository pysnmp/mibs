...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdEntry=ogEmdEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientEntry=ogWifiClientEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioEntry=ogEmdDioEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdConnectType=ogEmdConnectType, ogAlarmDevice=ogAlarmDevice, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsState=ogUpsState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApTxPower=ogWifiApTxPower, ogEmdEnabled=ogEmdEnabled, ogSerialUserName=ogSerialUserName, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemRegistered=ogCellModemRegistered, ogAlarmType=ogAlarmType, ogUpsTable=ogUpsTable, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckType=ogCheckType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemTower=ogCellModemTower, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortParity=ogSerialPortParity, ogUpsOutputLoad=ogUpsOutputLoad, ogWebUserEntry=ogWebUserEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioEmd=ogEmdDioEmd, ogRpcType=ogRpcType, ogAlarm=ogAlarm, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApCounter=ogWifiApCounter, ogSerialUserLabel=ogSerialUserLabel, ogAlarmTriggerValue=ogAlarmTriggerValue, ogFirmwareVersion=ogFirmwareVersion, ogRpcConnectType=ogRpcConnectType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2Groups=ogStatus2Groups, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceIndex=ogHostServiceIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemConnected=ogCellModemConnected, ogMibNotifications=ogMibNotifications, ogWebUserTable=ogWebUserTable, ogEmdDioType=ogEmdDioType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioState=ogEmdDioState, ogHostIndex=ogHostIndex, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckName=ogCheckName, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserStartTime=ogHostUserStartTime, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserIndex=ogSerialUserIndex, PYSNMP_MODULE_ID=ogStatus2, ogUpsName=ogUpsName, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdIndex=ogEmdIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryState=ogUpsBatteryState, ogUpsNotification=ogUpsNotification, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientRssi=ogWifiClientRssi, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemTable=ogCellModemTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortDTR=ogSerialPortDTR, ogEmdName=ogEmdName, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortMode=ogSerialPortMode, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemModel=ogCellModemModel, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserEntry=ogSerialUserEntry, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceCounter=ogHostServiceCounter, ogAlarmCheck=ogAlarmCheck, ogWebUserIndex=ogWebUserIndex, ogEmdDioTable=ogEmdDioTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceType=ogHostServiceType, ogHostTable=ogHostTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialUserPort=ogSerialUserPort, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostIpV6Address=ogHostIpV6Address, ogHostUserHostName=ogHostUserHostName, ogSerialNumber=ogSerialNumber, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemApn=ogCellModemApn, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostName=ogHostName, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckResolveActions=ogCheckResolveActions, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemCounter=ogCellModemCounter, ogHostUserHost=ogHostUserHost, ogUpsOutputVoltage=ogUpsOutputVoltage, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletState=ogRpcOutletState, ogAlarmState=ogAlarmState, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsEntry=ogUpsEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientTable=ogWifiClientTable, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemIndex=ogCellModemIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcCounter=ogRpcCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemNetwork=ogCellModemNetwork, ogCheckTable=ogCheckTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckEntry=ogCheckEntry, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserIndex=ogHostUserIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserTable=ogHostUserTable, ogRpcEntry=ogRpcEntry, ogUpsTemperature=ogUpsTemperature, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostUserName=ogHostUserName, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostUserNotification=ogHostUserNotification, ogCellDataNotification=ogCellDataNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostUserEntry=ogHostUserEntry, ogAlarmInstance=ogAlarmInstance, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApSsid=ogWifiApSsid, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserNotification=ogSerialUserNotification, ogHostPingNotification=ogHostPingNotification, ogCheckIndex=ogCheckIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostEntry=ogHostEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogStatus2Compliances=ogStatus2Compliances, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServicePort=ogHostServicePort, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemVendor=ogCellModemVendor, ogHostServiceHost=ogHostServiceHost, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmName=ogAlarmName, ogWebUserName=ogWebUserName, ogCheckTriggerActions=ogCheckTriggerActions, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApInterface=ogWifiApInterface, ogHostUserAddress=ogHostUserAddress, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientIndex=ogWifiClientIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApIndex=ogWifiApIndex, ogCustomNotification=ogCustomNotification, ogAlarmLogTable=ogAlarmLogTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientMode=ogWifiClientMode, ogEmdDioDirection=ogEmdDioDirection, ogAlarmUser=ogAlarmUser, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletName=ogRpcOutletName, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsConnectType=ogUpsConnectType, ogRpcName=ogRpcName, ogCellMessageNotification=ogCellMessageNotification, ogNetInterfaceType=ogNetInterfaceType, ogUpsType=ogUpsType, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyName=ogPowerSupplyName, ogUpsHumidity=ogUpsHumidity, ogEmdTable=ogEmdTable, ogHostServiceTable=ogHostServiceTable, ogUpsDescription=ogUpsDescription, ogSerialPortTable=ogSerialPortTable, ogAlarmTime=ogAlarmTime, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDescription=ogEmdDescription, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcTable=ogRpcTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsCounter=ogUpsCounter, ogUpsOutputPower=ogUpsOutputPower, ogRpcIndex=ogRpcIndex, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserTable=ogSerialUserTable, ogRpcDescription=ogRpcDescription, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2=ogStatus2, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsIndex=ogUpsIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSystem=ogSystem, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostIpV4Address=ogHostIpV4Address, ogCellSignalNotification=ogCellSignalNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortDCD=ogSerialPortDCD, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApTable=ogWifiApTable, ogEmdDioName=ogEmdDioName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserNotification=ogWebUserNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceRef=ogCheckDeviceRef)
