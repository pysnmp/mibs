...
iso, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Bits, ObjectIdentity, ModuleIdentity, Integer32, Unsigned32, Counter64, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Bits", "ObjectIdentity", "ModuleIdentity", "Integer32", "Unsigned32", "Counter64", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientTable=ogWifiApClientTable, ogWebUserTable=ogWebUserTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortRTS=ogSerialPortRTS, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogSystem=ogSystem, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserStartTime=ogWebUserStartTime, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemEntry=ogCellModemEntry, ogRpcType=ogRpcType, ogStatus2Compliance=ogStatus2Compliance, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmDevice=ogAlarmDevice, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsHumidity=ogUpsHumidity, ogCellModemIMSI=ogCellModemIMSI, ogUpsNotification=ogUpsNotification, ogCellModemModel=ogCellModemModel, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsTable=ogUpsTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsTemperature=ogUpsTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsName=ogUpsName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServicePort=ogHostServicePort, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckEntry=ogCheckEntry, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDescription=ogEmdDescription, ogEmdDioEntry=ogEmdDioEntry, ogAlarm=ogAlarm, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientIndex=ogWifiClientIndex, ogAlarmCheck=ogAlarmCheck, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortParity=ogSerialPortParity, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientMac=ogWifiApClientMac, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioDescription=ogEmdDioDescription, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdConnectType=ogEmdConnectType, ogWifiApEnabled=ogWifiApEnabled, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckTable=ogCheckTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortMode=ogSerialPortMode, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemConnected=ogCellModemConnected, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureName=ogEmdTemperatureName, ogHostServiceTable=ogHostServiceTable, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioState=ogEmdDioState, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemApn=ogCellModemApn, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCustomNotification=ogCustomNotification, ogCheckIndex=ogCheckIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellTowerNotification=ogCellTowerNotification, ogAlarmType=ogAlarmType, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserName=ogSerialUserName, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcIndex=ogRpcIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioName=ogEmdDioName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcDescription=ogRpcDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcTable=ogRpcTable, ogHostUserHostName=ogHostUserHostName, ogAlarmLogIndex=ogAlarmLogIndex, ogMibNotifications=ogMibNotifications, ogWifiClientTable=ogWifiClientTable, ogRpcCounter=ogRpcCounter, ogStatus2Groups=ogStatus2Groups, ogWifiClientFrequency=ogWifiClientFrequency, ogHostUserTable=ogHostUserTable, ogHostServiceCounter=ogHostServiceCounter, ogUpsCounter=ogUpsCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdEntry=ogEmdEntry, ogUpsDescription=ogUpsDescription, ogRpcEntry=ogRpcEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemVendor=ogCellModemVendor, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientMode=ogWifiClientMode, ogRpcConnectType=ogRpcConnectType, ogUpsType=ogUpsType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApIndex=ogWifiApIndex, ogWebUserIndex=ogWebUserIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsState=ogUpsState, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityEmd=ogEmdHumidityEmd, ogStatus2=ogStatus2, ogCellModemTable=ogCellModemTable, ogAlarmInstance=ogAlarmInstance, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmName=ogAlarmName, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostName=ogHostName, ogHostUserName=ogHostUserName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceEntry=ogHostServiceEntry, ogHostUserAddress=ogHostUserAddress, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserName=ogWebUserName, ogCheckDeviceName=ogCheckDeviceName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletState=ogRpcOutletState, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortDCD=ogSerialPortDCD, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemIndex=ogCellModemIndex, ogHostEntry=ogHostEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogCellDataNotification=ogCellDataNotification, ogRpcName=ogRpcName, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmEventId=ogAlarmEventId, ogCellApnNotification=ogCellApnNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiApSsid=ogWifiApSsid, ogWebUserEntry=ogWebUserEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserHost=ogHostUserHost, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTable=ogEmdTable, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceType=ogHostServiceType, ogAlarmState=ogAlarmState, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceIndex=ogHostServiceIndex, ogSerialUserPort=ogSerialUserPort, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserNotification=ogHostUserNotification, ogWifiApClientAp=ogWifiApClientAp, ogHostIndex=ogHostIndex, ogWifiApEntry=ogWifiApEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioType=ogEmdDioType, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcOutletName=ogRpcOutletName, ogUpsOutputNotification=ogUpsOutputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdName=ogEmdName, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialNumber=ogSerialNumber, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTower=ogCellModemTower)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApTable=ogWifiApTable, ogRpcOutletTable=ogRpcOutletTable, ogUpsInputNotification=ogUpsInputNotification, ogAlarmUser=ogAlarmUser, ogCheckTriggerActions=ogCheckTriggerActions, ogHostTable=ogHostTable, ogEmdLogEnabled=ogEmdLogEnabled, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmSummary=ogAlarmSummary, ogHostPingNotification=ogHostPingNotification, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialUserTable=ogSerialUserTable, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortTable=ogSerialPortTable, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioTable=ogEmdDioTable, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmTime=ogAlarmTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsIndex=ogUpsIndex, ogWebUserNotification=ogWebUserNotification, ogSerialPortDSR=ogSerialPortDSR, ogEmdIndex=ogEmdIndex, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApCounter=ogWifiApCounter, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserEntry=ogSerialUserEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsEntry=ogUpsEntry, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletCurrent=ogRpcOutletCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceStatus=ogHostServiceStatus, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserIndex=ogHostUserIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTemperatureTable=ogEmdTemperatureTable, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientCounter=ogWifiClientCounter, ogCheckType=ogCheckType, ogEmdDioDirection=ogEmdDioDirection, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostIpV6Address=ogHostIpV6Address, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortEntry=ogSerialPortEntry, ogWifiApInterface=ogWifiApInterface, ogWifiClientApMac=ogWifiClientApMac, ogCheckName=ogCheckName, ogAlarmLogTable=ogAlarmLogTable)
