...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckName=ogCheckName, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostTable=ogHostTable, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialUserIndex=ogSerialUserIndex, ogCellModemIMSI=ogCellModemIMSI, ogHostServiceTable=ogHostServiceTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogStatus2=ogStatus2, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemIndex=ogCellModemIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemTower=ogCellModemTower, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceCounter=ogHostServiceCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsEntry=ogUpsEntry, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioEmd=ogEmdDioEmd, ogCheckDeviceTable=ogCheckDeviceTable, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsNotification=ogUpsNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioName=ogEmdDioName, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryState=ogUpsBatteryState, ogWifiApCounter=ogWifiApCounter, ogWebUserTable=ogWebUserTable, ogWifiClientIndex=ogWifiClientIndex, ogHostUserHost=ogHostUserHost, ogEmdDioTable=ogEmdDioTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckIndex=ogCheckIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckEntry=ogCheckEntry, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientAp=ogWifiApClientAp, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckResolveActions=ogCheckResolveActions, ogAlarmDevice=ogAlarmDevice, ogAlarmEventId=ogAlarmEventId, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioState=ogEmdDioState, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckTable=ogCheckTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApEnabled=ogWifiApEnabled, ogCellModemModel=ogCellModemModel, ogUpsTemperature=ogUpsTemperature, ogUpsHumidity=ogUpsHumidity, ogUpsConnectType=ogUpsConnectType, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostServiceNotification=ogHostServiceNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApTable=ogWifiApTable, ogEmdIndex=ogEmdIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdConnectType=ogEmdConnectType, ogRpcOutletTable=ogRpcOutletTable, ogWifiApSsid=ogWifiApSsid, ogRpcIndex=ogRpcIndex, ogAlarmInstance=ogAlarmInstance, ogHostUserHostName=ogHostUserHostName, ogSerialPortRTS=ogSerialPortRTS, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceState=ogNetInterfaceState, ogUpsCounter=ogUpsCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioType=ogEmdDioType, ogWifiClientApMac=ogWifiClientApMac, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckDeviceName=ogCheckDeviceName, ogUpsTable=ogUpsTable, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogSystem=ogSystem, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceName=ogNetInterfaceName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogNetInterfaceTable=ogNetInterfaceTable, ogHostIndex=ogHostIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogMibNotifications=ogMibNotifications, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientTable=ogWifiClientTable, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemVendor=ogCellModemVendor, ogWifiApInterface=ogWifiApInterface, ogHostUserAddress=ogHostUserAddress, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortDTR=ogSerialPortDTR, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientFrequency=ogWifiClientFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemTemperature=ogCellModemTemperature, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputCurrent=ogUpsOutputCurrent, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdEntry=ogEmdEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWebUserStartTime=ogWebUserStartTime, ogHostUserTable=ogHostUserTable, ogSerialPortParity=ogSerialPortParity, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialNumber=ogSerialNumber, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogStatus2Groups=ogStatus2Groups, ogSerialPortMode=ogSerialPortMode, ogHostServiceType=ogHostServiceType, ogHostUserIndex=ogHostUserIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientTable=ogWifiApClientTable, ogHostUserNotification=ogHostUserNotification, ogWebUserEntry=ogWebUserEntry, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcDescription=ogRpcDescription, ogSerialUserName=ogSerialUserName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortLabel=ogSerialPortLabel, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Compliances=ogStatus2Compliances, ogAlarmName=ogAlarmName, ogCellModemApn=ogCellModemApn, ogEmdDescription=ogEmdDescription, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortTable=ogSerialPortTable, ogCellModemTable=ogCellModemTable, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserName=ogHostUserName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogHostName=ogHostName, ogCellApnNotification=ogCellApnNotification, ogCheckType=ogCheckType, ogCellMessageNotification=ogCellMessageNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialUserTable=ogSerialUserTable, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTable=ogEmdTable, ogRpcOutletState=ogRpcOutletState, ogRpcInputFrequency=ogRpcInputFrequency, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsName=ogUpsName, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientMode=ogWifiClientMode, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmTime=ogAlarmTime, ogUpsState=ogUpsState, ogHostUserStartTime=ogHostUserStartTime, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsDescription=ogUpsDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmSummary=ogAlarmSummary, ogUpsOutputNotification=ogUpsOutputNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceEntry=ogHostServiceEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcTable=ogRpcTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceHost=ogHostServiceHost, ogRpcName=ogRpcName, ogStatus2Compliance=ogStatus2Compliance, ogUpsIndex=ogUpsIndex, ogWifiClientRssi=ogWifiClientRssi, ogWifiApTxPower=ogWifiApTxPower, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApEntry=ogWifiApEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortIndex=ogSerialPortIndex, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserPort=ogSerialUserPort, ogSerialUserStartTime=ogSerialUserStartTime, ogWebUserIndex=ogWebUserIndex, ogAlarmState=ogAlarmState, ogSerialPortEntry=ogSerialPortEntry, ogAlarm=ogAlarm, ogRpcOutletName=ogRpcOutletName, ogUpsInputNotification=ogUpsInputNotification, ogUpsType=ogUpsType, ogAlarmType=ogAlarmType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcCounter=ogRpcCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientEssid=ogWifiClientEssid, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemCounter=ogCellModemCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostEntry=ogHostEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdName=ogEmdName, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApIndex=ogWifiApIndex, ogHostServicePort=ogHostServicePort, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserName=ogWebUserName, ogCellDataNotification=ogCellDataNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceIndex=ogHostServiceIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcType=ogRpcType, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmUser=ogAlarmUser, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCustomNotification=ogCustomNotification, ogHostServiceStatus=ogHostServiceStatus, ogRpcEntry=ogRpcEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureValue=ogEmdTemperatureValue)
