...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCustomNotification=ogCustomNotification, ogEmdName=ogEmdName, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdEnabled=ogEmdEnabled, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckIndex=ogCheckIndex, ogUpsCounter=ogUpsCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioDirection=ogEmdDioDirection, ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserHost=ogHostUserHost, ogCheckTable=ogCheckTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmLogTable=ogAlarmLogTable, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletRpc=ogRpcOutletRpc, ogSystem=ogSystem, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServicePort=ogHostServicePort, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemEnabled=ogCellModemEnabled, ogHostUserTable=ogHostUserTable, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellApnNotification=ogCellApnNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientTable=ogWifiApClientTable, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsBatteryState=ogUpsBatteryState, ogSerialUserName=ogSerialUserName, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserStartTime=ogHostUserStartTime, ogAlarmEventId=ogAlarmEventId, ogCellModemVendor=ogCellModemVendor, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialUserPort=ogSerialUserPort, ogRpcOutletState=ogRpcOutletState, ogRpcInputCurrent=ogRpcInputCurrent, ogCellSignalNotification=ogCellSignalNotification, ogWebUserEntry=ogWebUserEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyEntry=ogPowerSupplyEntry, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioEmd=ogEmdDioEmd, ogRpcIndex=ogRpcIndex, ogHostUserHostName=ogHostUserHostName, ogCellModemEntry=ogCellModemEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserIndex=ogHostUserIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsDescription=ogUpsDescription, ogSerialPortMode=ogSerialPortMode, ogSerialPortDCD=ogSerialPortDCD, ogEmdIndex=ogEmdIndex, ogHostServiceHost=ogHostServiceHost, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostPingNotification=ogHostPingNotification, ogUpsHumidity=ogUpsHumidity, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioType=ogEmdDioType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApTable=ogWifiApTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityValue=ogEmdHumidityValue, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientMac=ogWifiApClientMac, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialUserIndex=ogSerialUserIndex, ogCellModemCounter=ogCellModemCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, PYSNMP_MODULE_ID=ogStatus2, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcEntry=ogRpcEntry, ogHostName=ogHostName, ogSerialPortRTS=ogSerialPortRTS, ogHostEntry=ogHostEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientEntry=ogWifiClientEntry, ogHostUserAddress=ogHostUserAddress, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemTable=ogCellModemTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmCheck=ogAlarmCheck, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckName=ogCheckName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserName=ogWebUserName, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostIndex=ogHostIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortLabel=ogSerialPortLabel, ogWifiApEnabled=ogWifiApEnabled, ogCheckType=ogCheckType, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceEntry=ogHostServiceEntry, ogRpcName=ogRpcName, ogCellModemIMSI=ogCellModemIMSI, ogWifiApSsid=ogWifiApSsid, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserTable=ogSerialUserTable, ogUpsState=ogUpsState, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortIndex=ogSerialPortIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsEntry=ogUpsEntry, ogSerialNumber=ogSerialNumber, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmInstance=ogAlarmInstance, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmState=ogAlarmState, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApCounter=ogWifiApCounter, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcCounter=ogRpcCounter, ogUpsIndex=ogUpsIndex, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserEntry=ogHostUserEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogStatus2=ogStatus2, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostServiceCounter=ogHostServiceCounter, ogUpsTemperature=ogUpsTemperature, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioDescription=ogEmdDioDescription, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdConnectType=ogEmdConnectType, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmDevice=ogAlarmDevice, ogEmdEntry=ogEmdEntry, ogSerialUserNotification=ogSerialUserNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarm=ogAlarm, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsName=ogUpsName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientTable=ogWifiClientTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostTable=ogHostTable, ogRpcType=ogRpcType, ogCellModemTemperature=ogCellModemTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogMibNotifications=ogMibNotifications, ogAlarmUser=ogAlarmUser, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientInterface=ogWifiClientInterface, ogCellTowerNotification=ogCellTowerNotification, ogRpcTable=ogRpcTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioName=ogEmdDioName, ogWebUserTable=ogWebUserTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientAp=ogWifiApClientAp, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientMode=ogWifiClientMode, ogWifiApEntry=ogWifiApEntry, ogEmdDioState=ogEmdDioState, ogCellModemIndex=ogCellModemIndex, ogSerialPortTable=ogSerialPortTable, ogHostUserNotification=ogHostUserNotification, ogCheckResolveActions=ogCheckResolveActions)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcConnectType=ogRpcConnectType, ogSerialPortParity=ogSerialPortParity, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsTable=ogUpsTable, ogUpsNotification=ogUpsNotification, ogStatus2Groups=ogStatus2Groups, ogEmdTable=ogEmdTable, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceType=ogHostServiceType, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserName=ogHostUserName, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientEssid=ogWifiClientEssid, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioTable=ogEmdDioTable, ogAlarmTime=ogAlarmTime, ogWebUserIndex=ogWebUserIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsConnectType=ogUpsConnectType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogCellDataNotification=ogCellDataNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemModel=ogCellModemModel, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmName=ogAlarmName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogPowerSupplyName=ogPowerSupplyName, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortDTR=ogSerialPortDTR, ogStatus2Compliance=ogStatus2Compliance, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemTower=ogCellModemTower, ogCheckEntry=ogCheckEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemApn=ogCellModemApn, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWebUserNotification=ogWebUserNotification, ogAlarmType=ogAlarmType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcDescription=ogRpcDescription, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmSummary=ogAlarmSummary, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApIndex=ogWifiApIndex, ogHostServiceNotification=ogHostServiceNotification, ogUpsType=ogUpsType, ogCurrentAlarmTable=ogCurrentAlarmTable)
