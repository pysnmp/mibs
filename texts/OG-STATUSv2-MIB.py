...
iso, Counter32, NotificationType, TimeTicks, ModuleIdentity, Gauge32, Counter64, IpAddress, Bits, MibIdentifier, ObjectIdentity, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "NotificationType", "TimeTicks", "ModuleIdentity", "Gauge32", "Counter64", "IpAddress", "Bits", "MibIdentifier", "ObjectIdentity", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIpV6Address=ogHostIpV6Address, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureTotal=ogEmdTemperatureTotal, PYSNMP_MODULE_ID=ogStatus2, ogWebUserTable=ogWebUserTable, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemNetwork=ogCellModemNetwork, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsEntry=ogUpsEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdEntry=ogEmdEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientTable=ogWifiClientTable, ogWifiApEntry=ogWifiApEntry, ogWifiClientApMac=ogWifiClientApMac, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserName=ogSerialUserName, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdTemperatureName=ogEmdTemperatureName, ogStatus2Compliance=ogStatus2Compliance, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioDirection=ogEmdDioDirection, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemTower=ogCellModemTower, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientCounter=ogWifiClientCounter, ogNetInterfaceName=ogNetInterfaceName, ogCheckDeviceName=ogCheckDeviceName, ogWifiApInterface=ogWifiApInterface, ogCheckTriggerActions=ogCheckTriggerActions, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApTable=ogWifiApTable, ogSystem=ogSystem, ogSerialUserIndex=ogSerialUserIndex, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientEntry=ogWifiClientEntry, ogEmdDioState=ogEmdDioState, ogAlarmDevice=ogAlarmDevice, ogWifiApTxPower=ogWifiApTxPower, ogUpsType=ogUpsType, ogStatus2Groups=ogStatus2Groups, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialUserPort=ogSerialUserPort, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceTable=ogHostServiceTable, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCustomNotification=ogCustomNotification, ogSerialPortRTS=ogSerialPortRTS, ogRpcEntry=ogRpcEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyName=ogPowerSupplyName, ogAlarmCheck=ogAlarmCheck, ogSerialPortIndex=ogSerialPortIndex, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsIndex=ogUpsIndex, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserHostName=ogHostUserHostName, ogSerialPortLabel=ogSerialPortLabel, ogRpcInputNotification=ogRpcInputNotification, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsDescription=ogUpsDescription, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarm=ogAlarm, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemApn=ogCellModemApn, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApSsid=ogWifiApSsid, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyEntry=ogPowerSupplyEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemCounter=ogCellModemCounter, ogEmdDescription=ogEmdDescription, ogCheckType=ogCheckType, ogNetInterfaceState=ogNetInterfaceState, ogUpsCounter=ogUpsCounter, ogHostUserNotification=ogHostUserNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioName=ogEmdDioName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsNotification=ogUpsNotification, ogCheckIndex=ogCheckIndex, ogRpcOutletTable=ogRpcOutletTable, ogSerialNumber=ogSerialNumber, ogAlarmLogEntry=ogAlarmLogEntry, ogHostEntry=ogHostEntry, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortParity=ogSerialPortParity, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModem4gRssi=ogCellModem4gRssi, ogWebUserStartTime=ogWebUserStartTime, ogUpsState=ogUpsState, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmInstance=ogAlarmInstance, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmUser=ogAlarmUser, ogWifiApClientIndex=ogWifiApClientIndex, ogHostPingNotification=ogHostPingNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServicePort=ogHostServicePort, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioEntry=ogEmdDioEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellApnNotification=ogCellApnNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemModel=ogCellModemModel, ogWebUserName=ogWebUserName, ogCellMessageNotification=ogCellMessageNotification, ogAlarmName=ogAlarmName, ogEmdDioEmd=ogEmdDioEmd, ogEmdConnectType=ogEmdConnectType, ogSerialPortMode=ogSerialPortMode, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcCounter=ogRpcCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsName=ogUpsName, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialUserLabel=ogSerialUserLabel, ogHostUserIndex=ogHostUserIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmState=ogAlarmState, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialSignalNotification=ogSerialSignalNotification, ogHostIndex=ogHostIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialUserEntry=ogSerialUserEntry, ogEmdIndex=ogEmdIndex, ogMibNotifications=ogMibNotifications, ogRpcOutletState=ogRpcOutletState, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserTable=ogHostUserTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioType=ogEmdDioType, ogHostServiceType=ogHostServiceType, ogCellModemRegistered=ogCellModemRegistered, ogCellModemEntry=ogCellModemEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogHostTable=ogHostTable, ogCheckTable=ogCheckTable, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserName=ogHostUserName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserEntry=ogHostUserEntry, ogWebUserIndex=ogWebUserIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsHumidity=ogUpsHumidity)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRssi=ogWifiApClientRssi, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortDTR=ogSerialPortDTR, ogRpcDescription=ogRpcDescription, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcType=ogRpcType, ogHostServiceStatus=ogHostServiceStatus, ogStatus2=ogStatus2, ogAlarmType=ogAlarmType, ogEmdName=ogEmdName, ogRpcOutletName=ogRpcOutletName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcTable=ogRpcTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsInputNotification=ogUpsInputNotification, ogWebUserNotification=ogWebUserNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortTable=ogSerialPortTable, ogWifiClientMode=ogWifiClientMode, ogWifiApCounter=ogWifiApCounter, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostName=ogHostName, ogCheckName=ogCheckName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioTable=ogEmdDioTable, ogWebUserEntry=ogWebUserEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserHost=ogHostUserHost, ogCellModemTable=ogCellModemTable, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTable=ogEmdTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcConnectType=ogRpcConnectType, ogSerialPortEntry=ogSerialPortEntry, ogUpsTemperature=ogUpsTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsTable=ogUpsTable, ogHostServiceHost=ogHostServiceHost, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcName=ogRpcName, ogRpcIndex=ogRpcIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmSummary=ogAlarmSummary, ogAlarmTime=ogAlarmTime, ogCellDataNotification=ogCellDataNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckEntry=ogCheckEntry, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmEventId=ogAlarmEventId, ogEmdEnabled=ogEmdEnabled, ogCellModemVendor=ogCellModemVendor)
