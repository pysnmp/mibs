...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemConnected=ogCellModemConnected, ogUpsType=ogUpsType, ogWebUserName=ogWebUserName, ogRpcName=ogRpcName, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmUser=ogCurrentAlarmUser, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellSignalNotification=ogCellSignalNotification, ogWifiApIndex=ogWifiApIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletState=ogRpcOutletState, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientInterface=ogWifiClientInterface, ogStatus2=ogStatus2, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckType=ogCheckType, ogCellModemApn=ogCellModemApn, ogHostServiceType=ogHostServiceType, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryState=ogUpsBatteryState, ogAlarmName=ogAlarmName, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientAp=ogWifiApClientAp, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryNotification=ogUpsBatteryNotification, ogMibNotifications=ogMibNotifications, ogRpcInputNotification=ogRpcInputNotification, ogAlarmDevice=ogAlarmDevice, ogRpcTable=ogRpcTable, ogEmdDescription=ogEmdDescription, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcType=ogRpcType, ogAlarmState=ogAlarmState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostName=ogHostName, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostTable=ogHostTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortLabel=ogSerialPortLabel, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortDTR=ogSerialPortDTR, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortDCD=ogSerialPortDCD, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsNotification=ogUpsNotification, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckTable=ogCheckTable, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityTable=ogEmdHumidityTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortTable=ogSerialPortTable, ogHostIpV4Address=ogHostIpV4Address, ogUpsState=ogUpsState, ogSerialPortDSR=ogSerialPortDSR, ogStatus2Groups=ogStatus2Groups, ogSerialUserPort=ogSerialUserPort, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckEntry=ogCheckEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApInterface=ogWifiApInterface, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostPingNotification=ogHostPingNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioEntry=ogEmdDioEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCustomNotification=ogCustomNotification, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemEnabled=ogCellModemEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckIndex=ogCheckIndex, ogUpsTable=ogUpsTable, ogEmdDioDescription=ogEmdDioDescription, ogCellApnNotification=ogCellApnNotification, ogEmdDioEmd=ogEmdDioEmd, ogWebUserNotification=ogWebUserNotification, ogWebUserEntry=ogWebUserEntry, ogHostIndex=ogHostIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioName=ogEmdDioName, ogCellMessageNotification=ogCellMessageNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortMode=ogSerialPortMode, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientEntry=ogWifiClientEntry, ogHostUserHostName=ogHostUserHostName, ogWifiClientTable=ogWifiClientTable, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemEntry=ogCellModemEntry, ogWifiApTable=ogWifiApTable, ogRpcEntry=ogRpcEntry, ogCellModemTable=ogCellModemTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWebUserIndex=ogWebUserIndex, ogHostUserHost=ogHostUserHost, ogAlarmTime=ogAlarmTime, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserTable=ogHostUserTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceHost=ogHostServiceHost, ogAlarmCheck=ogAlarmCheck, ogWebUserStartTime=ogWebUserStartTime, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostEntry=ogHostEntry, ogSerialUserTable=ogSerialUserTable, ogUpsHumidity=ogUpsHumidity, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRssi=ogWifiClientRssi, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarm=ogAlarm, ogRpcCounter=ogRpcCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServicePort=ogHostServicePort, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmInstance=ogAlarmInstance, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsInputNotification=ogUpsInputNotification, ogRpcConnectType=ogRpcConnectType, ogCellModemTower=ogCellModemTower, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsName=ogUpsName, ogAlarmType=ogAlarmType, ogSerialPortCTS=ogSerialPortCTS, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsCounter=ogUpsCounter, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApSsid=ogWifiApSsid, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostIpV6Address=ogHostIpV6Address, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserName=ogSerialUserName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletCurrent=ogRpcOutletCurrent, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApFrequency=ogWifiApFrequency, ogHostUserEntry=ogHostUserEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdEntry=ogEmdEntry, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogNetInterfaceState=ogNetInterfaceState, ogUpsDescription=ogUpsDescription, ogWifiClientMode=ogWifiClientMode, ogWifiApEntry=ogWifiApEntry, ogEmdConnectType=ogEmdConnectType, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserTable=ogWebUserTable, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemRegistered=ogCellModemRegistered, ogAlarmLogTable=ogAlarmLogTable, ogRpcIndex=ogRpcIndex, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioState=ogEmdDioState, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcDescription=ogRpcDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioType=ogEmdDioType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientApMac=ogWifiClientApMac, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemNetwork=ogCellModemNetwork, ogUpsIndex=ogUpsIndex, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioCounter=ogEmdDioCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdEnabled=ogEmdEnabled, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityNotification=ogEmdHumidityNotification, ogStatus2Conformance=ogStatus2Conformance, ogHostUserName=ogHostUserName, ogHostUserNotification=ogHostUserNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyName=ogPowerSupplyName, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemIndex=ogCellModemIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmUser=ogAlarmUser, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceEntry=ogHostServiceEntry, ogSerialNumber=ogSerialNumber, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApCounter=ogWifiApCounter, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdName=ogEmdName, ogEmdDioTable=ogEmdDioTable, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceName=ogNetInterfaceName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsEntry=ogUpsEntry, ogSerialPortIndex=ogSerialPortIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckName=ogCheckName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, PYSNMP_MODULE_ID=ogStatus2, ogEmdTable=ogEmdTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSystem=ogSystem, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortEntry=ogSerialPortEntry, ogEmdIndex=ogEmdIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsConnectType=ogUpsConnectType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemModel=ogCellModemModel)
