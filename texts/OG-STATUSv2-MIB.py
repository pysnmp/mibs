...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserHostName=ogHostUserHostName, ogCheckTable=ogCheckTable, ogEmdDioState=ogEmdDioState, ogWifiApSsid=ogWifiApSsid, ogWifiClientTable=ogWifiClientTable, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsNotification=ogUpsNotification, ogSerialPortParity=ogSerialPortParity, ogStatus2=ogStatus2, ogUpsConnectType=ogUpsConnectType, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserEntry=ogHostUserEntry, ogRpcEntry=ogRpcEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserHost=ogHostUserHost, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialUserNotification=ogSerialUserNotification, ogHostUserNotification=ogHostUserNotification, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckDeviceName=ogCheckDeviceName, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserTable=ogSerialUserTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcInputNotification=ogRpcInputNotification, ogRpcDescription=ogRpcDescription, ogWifiApCounter=ogWifiApCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserTable=ogHostUserTable, ogHostServiceTable=ogHostServiceTable, ogEmdDioCounter=ogEmdDioCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogStatus2Compliances=ogStatus2Compliances, ogUpsState=ogUpsState, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceType=ogHostServiceType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServicePort=ogHostServicePort, ogHostServiceCounter=ogHostServiceCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApEntry=ogWifiApEntry, ogWifiApFrequency=ogWifiApFrequency, ogUpsEntry=ogUpsEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostTable=ogHostTable, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckEntry=ogCheckEntry, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletName=ogRpcOutletName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogFirmwareVersion=ogFirmwareVersion, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyName=ogPowerSupplyName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortTable=ogSerialPortTable, ogCellMessageNotification=ogCellMessageNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemModel=ogCellModemModel, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemCounter=ogCellModemCounter, ogUpsIndex=ogUpsIndex, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmName=ogAlarmName, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortCTS=ogSerialPortCTS, ogEmdTable=ogEmdTable, ogHostUserName=ogHostUserName, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogHostIpV6Address=ogHostIpV6Address, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserNotification=ogWebUserNotification, ogCellModemVendor=ogCellModemVendor, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostServiceHost=ogHostServiceHost, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsTable=ogUpsTable, ogAlarmState=ogAlarmState, ogMibNotifications=ogMibNotifications, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellDataNotification=ogCellDataNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortLabel=ogSerialPortLabel, ogWebUserStartTime=ogWebUserStartTime, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdEnabled=ogEmdEnabled, ogWifiApClientMac=ogWifiApClientMac, ogHostUserIndex=ogHostUserIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcType=ogRpcType, ogEmdDioDirection=ogEmdDioDirection, ogRpcCounter=ogRpcCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioType=ogEmdDioType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckName=ogCheckName, ogHostServiceIndex=ogHostServiceIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletTable=ogRpcOutletTable, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserEntry=ogSerialUserEntry, ogCellModemRegistered=ogCellModemRegistered, ogUpsTemperature=ogUpsTemperature, ogRpcName=ogRpcName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmUser=ogAlarmUser, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSystem=ogSystem, ogSerialPortDTR=ogSerialPortDTR, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmType=ogCurrentAlarmType, ogWebUserIndex=ogWebUserIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcTable=ogRpcTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserSourcePort=ogWebUserSourcePort, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputPower=ogUpsOutputPower, ogCellModemNetwork=ogCellModemNetwork, ogCellModemConnected=ogCellModemConnected, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmCheck=ogAlarmCheck, ogEmdDescription=ogEmdDescription, ogRpcIndex=ogRpcIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioName=ogEmdDioName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsDescription=ogUpsDescription, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApTable=ogWifiApTable, ogWifiClientEntry=ogWifiClientEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdConnectType=ogEmdConnectType, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsType=ogUpsType, ogCellSignalNotification=ogCellSignalNotification, ogUpsHumidity=ogUpsHumidity, ogCheckType=ogCheckType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemTower=ogCellModemTower, ogEmdDioEmd=ogEmdDioEmd, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserPort=ogSerialUserPort, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceNotification=ogHostServiceNotification, ogAlarmType=ogAlarmType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemApn=ogCellModemApn, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCustomNotification=ogCustomNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioTable=ogEmdDioTable, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientApMac=ogWifiClientApMac, ogWifiApInterface=ogWifiApInterface, ogEmdEntry=ogEmdEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDSR=ogSerialPortDSR, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioIndex=ogEmdDioIndex, ogWebUserTable=ogWebUserTable, ogWifiApEnabled=ogWifiApEnabled, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmDevice=ogAlarmDevice, ogWifiApIndex=ogWifiApIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmInstance=ogAlarmInstance, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserName=ogWebUserName, ogUpsName=ogUpsName, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmEventId=ogAlarmEventId, ogUpsCounter=ogUpsCounter, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemTemperature=ogCellModemTemperature, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmSummary=ogAlarmSummary, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcConnectType=ogRpcConnectType, ogWifiClientRssi=ogWifiClientRssi, ogHostUserAddress=ogHostUserAddress, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdHumidityTotal=ogEmdHumidityTotal, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostEntry=ogHostEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarm=ogAlarm, ogWifiApClientRssi=ogWifiApClientRssi, ogHostIndex=ogHostIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientIndex=ogWifiClientIndex, ogNetInterfaceName=ogNetInterfaceName, ogAlarmTime=ogAlarmTime, ogSerialNumber=ogSerialNumber, ogHostServiceStatus=ogHostServiceStatus, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdIndex=ogEmdIndex, ogNetInterfaceState=ogNetInterfaceState, ogEmdName=ogEmdName, ogStatus2Groups=ogStatus2Groups, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemTable=ogCellModemTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemEnabled=ogCellModemEnabled, ogHostName=ogHostName, ogCellModemEntry=ogCellModemEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmLogTable=ogAlarmLogTable, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletState=ogRpcOutletState, ogSerialUserName=ogSerialUserName, ogCheckIndex=ogCheckIndex)
