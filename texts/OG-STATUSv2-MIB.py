...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsTemperature=ogUpsTemperature, ogWifiApClientMac=ogWifiApClientMac, ogHostUserAddress=ogHostUserAddress, ogWifiApTable=ogWifiApTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemTable=ogCellModemTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdEntry=ogEmdEntry, ogSerialPortParity=ogSerialPortParity, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsIndex=ogUpsIndex, ogMibNotifications=ogMibNotifications, ogHostServicePort=ogHostServicePort, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcDescription=ogRpcDescription, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserName=ogWebUserName, ogCheckName=ogCheckName, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientIndex=ogWifiClientIndex, ogRpcConnectType=ogRpcConnectType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellApnNotification=ogCellApnNotification, ogCellModemEntry=ogCellModemEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmCheck=ogAlarmCheck, ogHostIpV4Address=ogHostIpV4Address, ogAlarmTime=ogAlarmTime, ogUpsInputFrequency=ogUpsInputFrequency, ogCellDataNotification=ogCellDataNotification, ogAlarmUser=ogAlarmUser, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2Compliances=ogStatus2Compliances, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmType=ogAlarmType, ogSerialUserTable=ogSerialUserTable, ogCellTowerNotification=ogCellTowerNotification, ogCellModemCounter=ogCellModemCounter, ogRpcInputNotification=ogRpcInputNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletLoad=ogRpcOutletLoad, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogStatus2Conformance=ogStatus2Conformance, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyName=ogPowerSupplyName, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcName=ogRpcName, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientTable=ogWifiApClientTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemModel=ogCellModemModel, ogCheckEntry=ogCheckEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioCounter=ogEmdDioCounter, ogWifiApSsid=ogWifiApSsid, ogHostServiceCounter=ogHostServiceCounter, ogCellModemTemperature=ogCellModemTemperature, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioEntry=ogEmdDioEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientTable=ogWifiClientTable, ogWifiClientInterface=ogWifiClientInterface, ogWifiApIndex=ogWifiApIndex, ogSerialPortTable=ogSerialPortTable, ogStatus2=ogStatus2, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellMessageNotification=ogCellMessageNotification, ogWifiApEntry=ogWifiApEntry, ogEmdConnectType=ogEmdConnectType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemIMSI=ogCellModemIMSI, ogRpcEntry=ogRpcEntry, ogEmdDioDescription=ogEmdDioDescription, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryState=ogUpsBatteryState, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryTemperature=ogUpsBatteryTemperature, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientCounter=ogWifiClientCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletNotification=ogRpcOutletNotification, ogCustomNotification=ogCustomNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsCounter=ogUpsCounter, ogUpsDescription=ogUpsDescription, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcIndex=ogRpcIndex, ogHostServiceStatus=ogHostServiceStatus, ogWebUserNotification=ogWebUserNotification, ogRpcType=ogRpcType, ogRpcCounter=ogRpcCounter, ogEmdIndex=ogEmdIndex, ogSerialPortDCD=ogSerialPortDCD, ogUpsConnectType=ogUpsConnectType, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceHost=ogHostServiceHost, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientMode=ogWifiClientMode, ogEmdDescription=ogEmdDescription, ogNetInterfaceTable=ogNetInterfaceTable, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletName=ogRpcOutletName, ogHostUserHost=ogHostUserHost, ogWifiApFrequency=ogWifiApFrequency, ogSerialUserName=ogSerialUserName, ogSerialPortEntry=ogSerialPortEntry, ogStatus2Groups=ogStatus2Groups, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientApMac=ogWifiClientApMac, ogHostName=ogHostName, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApInterface=ogWifiApInterface, ogUpsTable=ogUpsTable, ogAlarmEventId=ogAlarmEventId, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogNetInterfaceType=ogNetInterfaceType, ogCheckTable=ogCheckTable, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsState=ogUpsState, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputNotification=ogUpsInputNotification, ogHostUserTable=ogHostUserTable, ogAlarmState=ogAlarmState, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarm=ogAlarm, ogWifiApClientRssi=ogWifiApClientRssi, ogSystem=ogSystem, ogCellModemVendor=ogCellModemVendor, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserTable=ogWebUserTable, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserIndex=ogSerialUserIndex, ogUpsHumidity=ogUpsHumidity, ogAlarmDevice=ogAlarmDevice, ogEmdEnabled=ogEmdEnabled, ogEmdDioIndex=ogEmdDioIndex, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogStatus2Compliance=ogStatus2Compliance, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceType=ogHostServiceType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletTable=ogRpcOutletTable, ogEmdName=ogEmdName, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletState=ogRpcOutletState, ogWebUserIndex=ogWebUserIndex, ogHostUserIndex=ogHostUserIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWebUserStartTime=ogWebUserStartTime, ogCheckIndex=ogCheckIndex, ogEmdTable=ogEmdTable, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioState=ogEmdDioState, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortMode=ogSerialPortMode, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialSignalNotification=ogSerialSignalNotification, ogHostEntry=ogHostEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostIndex=ogHostIndex, ogAlarmName=ogAlarmName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletRpc=ogRpcOutletRpc, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcTable=ogRpcTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemTower=ogCellModemTower, ogUpsName=ogUpsName, ogHostUserEntry=ogHostUserEntry, ogNetInterfaceState=ogNetInterfaceState, ogHostUserHostName=ogHostUserHostName, ogUpsEntry=ogUpsEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostPingNotification=ogHostPingNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogHostTable=ogHostTable, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioType=ogEmdDioType, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortRTS=ogSerialPortRTS, ogWifiApCounter=ogWifiApCounter, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserName=ogHostUserName, ogSerialNumber=ogSerialNumber, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioName=ogEmdDioName, ogCellModemConnected=ogCellModemConnected, ogCellModemApn=ogCellModemApn, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsType=ogUpsType, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceTable=ogHostServiceTable, ogSerialPortIndex=ogSerialPortIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckType=ogCheckType, ogUpsNotification=ogUpsNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioEmd=ogEmdDioEmd, ogSerialUserPort=ogSerialUserPort)
