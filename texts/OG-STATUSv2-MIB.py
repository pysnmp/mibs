...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsCounter=ogUpsCounter, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortEntry=ogSerialPortEntry, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioName=ogEmdDioName, ogWifiClientTable=ogWifiClientTable, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientMac=ogWifiApClientMac, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmName=ogAlarmName, ogRpcName=ogRpcName, ogHostUserTable=ogHostUserTable, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcLogEnabled=ogRpcLogEnabled, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApSsid=ogWifiApSsid, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemVendor=ogCellModemVendor, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortTable=ogSerialPortTable, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserIndex=ogHostUserIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2Groups=ogStatus2Groups, ogUpsTable=ogUpsTable, ogHostUserName=ogHostUserName, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellApnNotification=ogCellApnNotification, ogWifiApTable=ogWifiApTable, ogCellModemEntry=ogCellModemEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioEntry=ogEmdDioEntry, ogCheckIndex=ogCheckIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckDeviceName=ogCheckDeviceName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceType=ogNetInterfaceType, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsHumidity=ogUpsHumidity, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortDCD=ogSerialPortDCD, ogCellModemTemperature=ogCellModemTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServicePort=ogHostServicePort, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioIndex=ogEmdDioIndex, ogWifiApEntry=ogWifiApEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsDescription=ogUpsDescription, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioTable=ogEmdDioTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcCounter=ogRpcCounter, ogEmdEnabled=ogEmdEnabled, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemTower=ogCellModemTower, ogHostServiceHost=ogHostServiceHost, ogSerialPortParity=ogSerialPortParity, ogAlarmState=ogAlarmState, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmSummary=ogAlarmSummary, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserStartTime=ogWebUserStartTime, ogUpsName=ogUpsName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarm=ogAlarm, ogEmdDioCounter=ogEmdDioCounter, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmEventId=ogAlarmEventId, ogHostServiceEntry=ogHostServiceEntry, ogUpsInputNotification=ogUpsInputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogNetInterfaceName=ogNetInterfaceName, ogCellModemIMSI=ogCellModemIMSI, ogAlarmDevice=ogAlarmDevice, ogStatus2=ogStatus2, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTable=ogEmdTable, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioDirection=ogEmdDioDirection, ogUpsType=ogUpsType, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputPower=ogUpsOutputPower, ogCellModemTable=ogCellModemTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostName=ogHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialUserPort=ogSerialUserPort, ogWebUserNotification=ogWebUserNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmCheck=ogAlarmCheck, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortDSR=ogSerialPortDSR, ogHostServiceStatus=ogHostServiceStatus, ogRpcTable=ogRpcTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckTable=ogCheckTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletTable=ogRpcOutletTable, ogStatus2Compliance=ogStatus2Compliance, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApFrequency=ogWifiApFrequency, ogSerialSignalNotification=ogSerialSignalNotification, ogHostUserAddress=ogHostUserAddress, ogEmdIndex=ogEmdIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientInterface=ogWifiClientInterface, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcConnectType=ogRpcConnectType, ogSerialUserEntry=ogSerialUserEntry, ogUpsConnectType=ogUpsConnectType, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmInstance=ogAlarmInstance, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostPingNotification=ogHostPingNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApInterface=ogWifiApInterface, ogSystem=ogSystem, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientCounter=ogWifiClientCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserIndex=ogSerialUserIndex, ogWebUserEntry=ogWebUserEntry, ogCellModemModel=ogCellModemModel, ogRpcIndex=ogRpcIndex, ogEmdEntry=ogEmdEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmUser=ogAlarmUser, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsTemperature=ogUpsTemperature, ogCellSignalNotification=ogCellSignalNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcInputVoltage=ogRpcInputVoltage, ogHostIpV6Address=ogHostIpV6Address, ogUpsIndex=ogUpsIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellDataNotification=ogCellDataNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemIndex=ogCellModemIndex, ogWifiClientIndex=ogWifiClientIndex, ogCheckEntry=ogCheckEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogCustomNotification=ogCustomNotification, ogCellModemApn=ogCellModemApn, ogHostIpV4Address=ogHostIpV4Address, ogWebUserTable=ogWebUserTable, ogWifiApClientTable=ogWifiApClientTable, ogUpsState=ogUpsState, ogWifiClientApMac=ogWifiClientApMac, ogSerialUserName=ogSerialUserName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckType=ogCheckType, ogSerialNumber=ogSerialNumber, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostUserNotification=ogHostUserNotification, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsEntry=ogUpsEntry, ogRpcType=ogRpcType, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApIeeeMode=ogWifiApIeeeMode, ogMibNotifications=ogMibNotifications, ogSerialPortLabel=ogSerialPortLabel, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortDTR=ogSerialPortDTR, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientMode=ogWifiClientMode)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogFirmwareVersion=ogFirmwareVersion, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioType=ogEmdDioType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogCellMessageNotification=ogCellMessageNotification, ogRpcEntry=ogRpcEntry, ogHostIndex=ogHostIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmTime=ogAlarmTime, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientEntry=ogWifiClientEntry, ogWifiApCounter=ogWifiApCounter, ogHostEntry=ogHostEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcDescription=ogRpcDescription, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostServiceType=ogHostServiceType, ogCellModemEnabled=ogCellModemEnabled, ogEmdName=ogEmdName, ogEmdDioState=ogEmdDioState, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckName=ogCheckName, ogCellModemNetwork=ogCellModemNetwork, ogUpsNotification=ogUpsNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceNotification=ogHostServiceNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcOutletRpc=ogRpcOutletRpc, ogHostUserEntry=ogHostUserEntry, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortMode=ogSerialPortMode, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDescription=ogEmdDescription, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientFrequency=ogWifiClientFrequency, ogHostTable=ogHostTable, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceTable=ogHostServiceTable, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmType=ogAlarmType, ogHostUserHost=ogHostUserHost, ogWebUserName=ogWebUserName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryCharge=ogUpsBatteryCharge)
