...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcIndex=ogRpcIndex, ogEmdDioNotification=ogEmdDioNotification, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemCounter=ogCellModemCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostTable=ogHostTable, ogCheckIndex=ogCheckIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsType=ogUpsType, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcTable=ogRpcTable, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletState=ogRpcOutletState, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserTable=ogSerialUserTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemNetwork=ogCellModemNetwork, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemApn=ogCellModemApn, ogCellTowerNotification=ogCellTowerNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioTable=ogEmdDioTable, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmCheck=ogAlarmCheck, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsTable=ogUpsTable, ogSerialPortMode=ogSerialPortMode, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientRssi=ogWifiClientRssi, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemModel=ogCellModemModel, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioCounter=ogEmdDioCounter, ogUpsHumidity=ogUpsHumidity, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmState=ogAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsState=ogUpsState, ogHostUserName=ogHostUserName, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdEnabled=ogEmdEnabled, ogRpcDescription=ogRpcDescription, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortTable=ogSerialPortTable, ogUpsCounter=ogUpsCounter, ogRpcOutputNotification=ogRpcOutputNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialNumber=ogSerialNumber, ogCellDataNotification=ogCellDataNotification, ogEmdConnectType=ogEmdConnectType, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarm=ogAlarm, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemTable=ogCellModemTable, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserEntry=ogSerialUserEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemRegistered=ogCellModemRegistered, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientEnabled=ogWifiClientEnabled, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogHostServiceNotification=ogHostServiceNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemEnabled=ogCellModemEnabled, ogStatus2Compliance=ogStatus2Compliance, ogAlarmInstance=ogAlarmInstance, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDescription=ogEmdDescription, ogRpcName=ogRpcName, ogUpsInputVoltage=ogUpsInputVoltage, ogSystem=ogSystem, ogUpsEntry=ogUpsEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogNetInterfaceName=ogNetInterfaceName, ogMibNotifications=ogMibNotifications, ogCheckEntry=ogCheckEntry, ogCellModemConnected=ogCellModemConnected, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserPort=ogSerialUserPort, ogHostUserEntry=ogHostUserEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdEntry=ogEmdEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemVendor=ogCellModemVendor, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletTable=ogRpcOutletTable, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientMac=ogWifiApClientMac, ogCellApnNotification=ogCellApnNotification, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemEntry=ogCellModemEntry, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceStatus=ogHostServiceStatus, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortIndex=ogSerialPortIndex, ogWebUserStartTime=ogWebUserStartTime, ogRpcConnectType=ogRpcConnectType, ogEmdTable=ogEmdTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemTower=ogCellModemTower, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserName=ogWebUserName, ogEmdHumidityName=ogEmdHumidityName, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellMessageNotification=ogCellMessageNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServicePort=ogHostServicePort, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcEntry=ogRpcEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsDescription=ogUpsDescription, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogStatus2=ogStatus2, ogHostServiceIndex=ogHostServiceIndex, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsNotification=ogUpsNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletName=ogRpcOutletName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientApMac=ogWifiClientApMac, ogAlarmType=ogAlarmType, ogCheckType=ogCheckType, ogHostName=ogHostName, ogCustomNotification=ogCustomNotification, ogEmdIndex=ogEmdIndex, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioIndex=ogEmdDioIndex, ogWifiApEntry=ogWifiApEntry, ogEmdName=ogEmdName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWebUserEntry=ogWebUserEntry, ogWifiClientIndex=ogWifiClientIndex, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryState=ogUpsBatteryState, ogWebUserNotification=ogWebUserNotification, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceType=ogNetInterfaceType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApIndex=ogWifiApIndex, ogAlarmLogTable=ogAlarmLogTable, ogWifiApInterface=ogWifiApInterface, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientEssid=ogWifiClientEssid, ogAlarmTime=ogAlarmTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApEnabled=ogWifiApEnabled, ogUpsConnectType=ogUpsConnectType, ogSerialPortRTS=ogSerialPortRTS, ogUpsIndex=ogUpsIndex, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmName=ogCurrentAlarmName, ogHostUserNotification=ogHostUserNotification, ogUpsTemperature=ogUpsTemperature, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostEntry=ogHostEntry, ogCellModemIndex=ogCellModemIndex, ogCheckName=ogCheckName, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserHostName=ogHostUserHostName, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmSummary=ogAlarmSummary, ogCheckTable=ogCheckTable, ogSerialSignalNotification=ogSerialSignalNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiApTxPower=ogWifiApTxPower, ogRpcCounter=ogRpcCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmUser=ogAlarmUser, ogEmdDioName=ogEmdDioName, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckDeviceName=ogCheckDeviceName, ogSerialUserName=ogSerialUserName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmDevice=ogAlarmDevice, ogAlarmName=ogAlarmName, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioType=ogEmdDioType, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientEntry=ogWifiClientEntry, ogWifiApCounter=ogWifiApCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceType=ogHostServiceType, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserIndex=ogHostUserIndex, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioState=ogEmdDioState, ogHostUserTable=ogHostUserTable, ogStatus2Groups=ogStatus2Groups, ogHostServiceEntry=ogHostServiceEntry, ogHostIpV4Address=ogHostIpV4Address, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApTable=ogWifiApTable, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserAddress=ogHostUserAddress, ogHostIndex=ogHostIndex, ogWifiClientTable=ogWifiClientTable, ogWebUserTable=ogWebUserTable, ogUpsName=ogUpsName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcType=ogRpcType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioDescription=ogEmdDioDescription, ogHostUserHost=ogHostUserHost, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceCounter=ogHostServiceCounter, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputPower=ogUpsOutputPower)
