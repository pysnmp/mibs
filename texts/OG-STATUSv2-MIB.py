...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputPower=ogUpsOutputPower, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioState=ogEmdDioState, ogCheckDeviceName=ogCheckDeviceName, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientBitRate=ogWifiClientBitRate, ogNetInterfaceName=ogNetInterfaceName, ogHostUserTable=ogHostUserTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsEntry=ogUpsEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortDSR=ogSerialPortDSR, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityValue=ogEmdHumidityValue, ogCustomNotification=ogCustomNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceCounter=ogHostServiceCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApTable=ogWifiApTable, ogWifiApFrequency=ogWifiApFrequency, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckType=ogCheckType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemApn=ogCellModemApn, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortCTS=ogSerialPortCTS, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTable=ogEmdTable, ogRpcTable=ogRpcTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmEventId=ogAlarmEventId, ogWifiClientTable=ogWifiClientTable, ogEmdDioType=ogEmdDioType, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApInterface=ogWifiApInterface, ogCellModemTable=ogCellModemTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceTable=ogHostServiceTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserIndex=ogWebUserIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortEntry=ogSerialPortEntry, ogCheckTable=ogCheckTable, ogWifiClientMode=ogWifiClientMode, ogCellModemCounter=ogCellModemCounter, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApEnabled=ogWifiApEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2Compliance=ogStatus2Compliance, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmTime=ogAlarmTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdIndex=ogEmdIndex, ogHostEntry=ogHostEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserTable=ogSerialUserTable, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmInstance=ogAlarmInstance, ogWifiClientEntry=ogWifiClientEntry, ogSystem=ogSystem, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialSignalNotification=ogSerialSignalNotification, ogHostIndex=ogHostIndex, ogAlarmDevice=ogAlarmDevice, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2Groups=ogStatus2Groups, ogCellModemModel=ogCellModemModel, ogEmdDioName=ogEmdDioName, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientAp=ogWifiApClientAp, ogHostUserAddress=ogHostUserAddress, ogEmdDioDescription=ogEmdDioDescription, ogUpsConnectType=ogUpsConnectType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckEntry=ogCheckEntry, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcName=ogRpcName, ogRpcOutletState=ogRpcOutletState, ogCellApnNotification=ogCellApnNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmName=ogAlarmName, ogRpcIndex=ogRpcIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdLogEnabled=ogEmdLogEnabled, ogHostUserHost=ogHostUserHost, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmState=ogAlarmState, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceType=ogHostServiceType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmType=ogAlarmType, ogSerialNumber=ogSerialNumber, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcEntry=ogRpcEntry, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostPingNotification=ogHostPingNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortRTS=ogSerialPortRTS, ogRpcType=ogRpcType, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogHostName=ogHostName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApCounter=ogWifiApCounter, ogSerialUserName=ogSerialUserName, ogUpsTable=ogUpsTable, ogRpcOutletName=ogRpcOutletName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletTable=ogRpcOutletTable, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcCounter=ogRpcCounter, ogSerialPortTable=ogSerialPortTable, ogHostServiceNotification=ogHostServiceNotification, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsNotification=ogUpsNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsTemperature=ogUpsTemperature, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientInterface=ogWifiClientInterface, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdConnectType=ogEmdConnectType, ogSerialUserLabel=ogSerialUserLabel, ogCellTowerNotification=ogCellTowerNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserName=ogHostUserName, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsDescription=ogUpsDescription, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputNotification=ogUpsOutputNotification, ogHostTable=ogHostTable, ogUpsState=ogUpsState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApIndex=ogWifiApIndex, ogCheckName=ogCheckName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsHumidity=ogUpsHumidity, ogCellModemTower=ogCellModemTower, ogAlarmCheck=ogAlarmCheck, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientIndex=ogWifiClientIndex, ogAlarmUser=ogAlarmUser, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserEntry=ogWebUserEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsCounter=ogUpsCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioCounter=ogEmdDioCounter, ogCellDataNotification=ogCellDataNotification, ogCellModemEntry=ogCellModemEntry, ogHostUserEntry=ogHostUserEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDescription=ogEmdDescription, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsIndex=ogUpsIndex, ogWifiApClientMac=ogWifiApClientMac, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsName=ogUpsName, ogSerialPortDCD=ogSerialPortDCD, ogHostUserNotification=ogHostUserNotification, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmName=ogCurrentAlarmName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceState=ogNetInterfaceState, ogStatus2=ogStatus2, ogCellModemVendor=ogCellModemVendor, ogEmdName=ogEmdName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserIndex=ogHostUserIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialUserEntry=ogSerialUserEntry, ogHostServiceEntry=ogHostServiceEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemIndex=ogCellModemIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckIndex=ogCheckIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioEntry=ogEmdDioEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientApMac=ogWifiClientApMac, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWebUserName=ogWebUserName, ogUpsType=ogUpsType, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialUserPort=ogSerialUserPort, ogRpcConnectType=ogRpcConnectType, ogAlarmSummary=ogAlarmSummary, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcInputNotification=ogRpcInputNotification, ogAlarm=ogAlarm, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserStartTime=ogHostUserStartTime, ogHostServiceStatus=ogHostServiceStatus, ogCheckResolveActions=ogCheckResolveActions, ogWebUserNotification=ogWebUserNotification, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServicePort=ogHostServicePort, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogMibNotifications=ogMibNotifications, ogWifiClientRssi=ogWifiClientRssi, ogEmdEntry=ogEmdEntry, ogEmdDioTable=ogEmdDioTable, ogWebUserStartTime=ogWebUserStartTime, ogRpcDescription=ogRpcDescription, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientTable=ogWifiApClientTable, ogAlarmLogTable=ogAlarmLogTable, ogEmdEnabled=ogEmdEnabled, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioNotification=ogEmdDioNotification, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryState=ogUpsBatteryState, ogCellModemConnected=ogCellModemConnected, ogSerialPortLabel=ogSerialPortLabel)
