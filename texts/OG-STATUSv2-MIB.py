...
MibIdentifier, Unsigned32, iso, Bits, Integer32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, ModuleIdentity, IpAddress, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "iso", "Bits", "Integer32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsHumidity=ogUpsHumidity, ogWifiApTxPower=ogWifiApTxPower, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostUserName=ogHostUserName, ogUpsTable=ogUpsTable, ogRpcName=ogRpcName, ogCellApnNotification=ogCellApnNotification, ogUpsCounter=ogUpsCounter, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckType=ogCheckType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdName=ogEmdName, ogSerialNumber=ogSerialNumber, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserTable=ogHostUserTable, ogHostEntry=ogHostEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogHostIpV6Address=ogHostIpV6Address, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientIndex=ogWifiClientIndex, ogHostServiceTable=ogHostServiceTable, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyName=ogPowerSupplyName, ogAlarmEventId=ogAlarmEventId, ogCheckName=ogCheckName, ogCellModemTable=ogCellModemTable, ogFirmwareVersion=ogFirmwareVersion, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcIndex=ogRpcIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmState=ogAlarmState, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientApMac=ogWifiClientApMac, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCellTowerNotification=ogCellTowerNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcType=ogRpcType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioTable=ogEmdDioTable, ogMibNotifications=ogMibNotifications, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdConnectType=ogEmdConnectType, ogCellModemTemperature=ogCellModemTemperature, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApFrequency=ogWifiApFrequency, ogHostUserHost=ogHostUserHost, ogCellModemModel=ogCellModemModel, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortMode=ogSerialPortMode, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellDataNotification=ogCellDataNotification, ogSerialPortDSR=ogSerialPortDSR, ogUpsIndex=ogUpsIndex, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientBitRate=ogWifiClientBitRate, ogHostTable=ogHostTable, ogUpsState=ogUpsState, ogWebUserEntry=ogWebUserEntry, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioState=ogEmdDioState, ogUpsEntry=ogUpsEntry, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceName=ogNetInterfaceName, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientMode=ogWifiClientMode, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortDCD=ogSerialPortDCD, ogWifiApInterface=ogWifiApInterface, ogCheckTable=ogCheckTable, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemConnected=ogCellModemConnected, ogRpcOutletState=ogRpcOutletState, ogCellModemVendor=ogCellModemVendor, ogWebUserNotification=ogWebUserNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserIndex=ogHostUserIndex, ogEmdDioEmd=ogEmdDioEmd, ogSerialUserPort=ogSerialUserPort, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsConnectType=ogUpsConnectType, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcDescription=ogRpcDescription, ogCheckResolveActions=ogCheckResolveActions, ogEmdTable=ogEmdTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmName=ogAlarmName, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserStartTime=ogHostUserStartTime, ogWebUserTable=ogWebUserTable, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientTable=ogWifiClientTable, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsDescription=ogUpsDescription, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogStatus2Groups=ogStatus2Groups, ogAlarmTime=ogAlarmTime, ogEmdDioEntry=ogEmdDioEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApIndex=ogWifiApIndex, ogHostServicePort=ogHostServicePort, ogCellModemRegistered=ogCellModemRegistered, ogWebUserStartTime=ogWebUserStartTime, ogHostPingNotification=ogHostPingNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioCounter=ogEmdDioCounter, ogRpcConnectType=ogRpcConnectType, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApTable=ogWifiApTable, ogWifiApEntry=ogWifiApEntry, ogHostIndex=ogHostIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortCTS=ogSerialPortCTS, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDescription=ogEmdDescription, ogHostIpV4Address=ogHostIpV4Address, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckEntry=ogCheckEntry, ogHostName=ogHostName, ogAlarmLogEntry=ogAlarmLogEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserEntry=ogHostUserEntry, ogCheckIndex=ogCheckIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmLogTable=ogAlarmLogTable, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApEnabled=ogWifiApEnabled, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckDeviceTable=ogCheckDeviceTable, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCustomNotification=ogCustomNotification, ogRpcOutletName=ogRpcOutletName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialUserNotification=ogSerialUserNotification, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceIndex=ogHostServiceIndex, ogCellModemIMSI=ogCellModemIMSI, ogStatus2=ogStatus2, ogRpcTable=ogRpcTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserTable=ogSerialUserTable, ogStatus2Compliances=ogStatus2Compliances, ogAlarmInstance=ogAlarmInstance, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioName=ogEmdDioName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserIndex=ogWebUserIndex, ogEmdIndex=ogEmdIndex, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioType=ogEmdDioType, ogRpcCounter=ogRpcCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserLabel=ogSerialUserLabel, ogWebUserName=ogWebUserName, ogWifiClientRssi=ogWifiClientRssi, ogCellMessageNotification=ogCellMessageNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceCheck=ogCheckDeviceCheck)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientTable=ogWifiApClientTable, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioTriggerMode=ogEmdDioTriggerMode, PYSNMP_MODULE_ID=ogStatus2, ogUpsNotification=ogUpsNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceType=ogNetInterfaceType, ogRpcEntry=ogRpcEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserNotification=ogHostUserNotification, ogCellModemApn=ogCellModemApn, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsType=ogUpsType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientCounter=ogWifiClientCounter, ogCellModemIndex=ogCellModemIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServiceCounter=ogHostServiceCounter, ogCellModemCounter=ogCellModemCounter, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsName=ogUpsName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarm=ogAlarm, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceType=ogHostServiceType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdEntry=ogEmdEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortParity=ogSerialPortParity, ogCellModemTower=ogCellModemTower, ogEmdDioNotification=ogEmdDioNotification, ogStatus2Conformance=ogStatus2Conformance, ogSystem=ogSystem, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsOutputVoltage=ogUpsOutputVoltage, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortIndex=ogSerialPortIndex, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmDevice=ogAlarmDevice, ogEmdEnabled=ogEmdEnabled, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmUser=ogAlarmUser, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmType=ogAlarmType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostServiceHost=ogHostServiceHost, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserName=ogSerialUserName)
