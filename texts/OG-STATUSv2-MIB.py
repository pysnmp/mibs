...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsState=ogUpsState, ogEmdDioName=ogEmdDioName, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsTemperature=ogUpsTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceIndex=ogHostServiceIndex, ogAlarm=ogAlarm, ogPowerSupplyName=ogPowerSupplyName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsIndex=ogUpsIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDescription=ogEmdDescription, ogRpcType=ogRpcType, ogHostEntry=ogHostEntry, PYSNMP_MODULE_ID=ogStatus2, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCustomNotification=ogCustomNotification, ogRpcConnectType=ogRpcConnectType, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortEntry=ogSerialPortEntry, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioType=ogEmdDioType, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityName=ogEmdHumidityName, ogCellModemModel=ogCellModemModel, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsDescription=ogUpsDescription, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmLogTable=ogAlarmLogTable, ogHostIpV4Address=ogHostIpV4Address, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostUserNotification=ogHostUserNotification, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellApnNotification=ogCellApnNotification, ogAlarmState=ogAlarmState, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogNetInterfaceIndex=ogNetInterfaceIndex, ogStatus2Conformance=ogStatus2Conformance, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserHost=ogHostUserHost, ogCheckType=ogCheckType, ogCellModemTable=ogCellModemTable, ogCheckIndex=ogCheckIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApCounter=ogWifiApCounter, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortIndex=ogSerialPortIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientMac=ogWifiApClientMac, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServiceHost=ogHostServiceHost, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceTable=ogHostServiceTable, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemRegistered=ogCellModemRegistered, ogCellModemEntry=ogCellModemEntry, ogCheckName=ogCheckName, ogWebUserTable=ogWebUserTable, ogEmdIndex=ogEmdIndex, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserName=ogSerialUserName, ogEmdDioDirection=ogEmdDioDirection, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogHostIpV6Address=ogHostIpV6Address, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsType=ogUpsType, ogCellModemCounter=ogCellModemCounter, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortLabel=ogSerialPortLabel, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioCounter=ogEmdDioCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApIndex=ogWifiApIndex, ogEmdEnabled=ogEmdEnabled, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserTable=ogHostUserTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletName=ogRpcOutletName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserName=ogHostUserName, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsConnectType=ogUpsConnectType, ogHostUserHostName=ogHostUserHostName, ogUpsTable=ogUpsTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsEntry=ogUpsEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemIMSI=ogCellModemIMSI, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApFrequency=ogWifiApFrequency, ogAlarmType=ogAlarmType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostServiceNotification=ogHostServiceNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientTable=ogWifiClientTable, ogWebUserIndex=ogWebUserIndex, ogHostUserEntry=ogHostUserEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemNetwork=ogCellModemNetwork, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogMibNotifications=ogMibNotifications, ogSerialPortParityErrors=ogSerialPortParityErrors, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmInstance=ogAlarmInstance, ogUpsNotification=ogUpsNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceType=ogHostServiceType, ogRpcOutletState=ogRpcOutletState, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdEntry=ogEmdEntry, ogRpcInputNotification=ogRpcInputNotification, ogRpcCounter=ogRpcCounter, ogWifiClientEntry=ogWifiClientEntry, ogEmdTable=ogEmdTable, ogEmdDioTable=ogEmdDioTable, ogRpcDescription=ogRpcDescription, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialNumber=ogSerialNumber, ogAlarmCheck=ogAlarmCheck, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmUser=ogAlarmUser, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientAp=ogWifiApClientAp, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostTable=ogHostTable, ogHostIndex=ogHostIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientCounter=ogWifiClientCounter, ogWebUserEntry=ogWebUserEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsName=ogUpsName, ogUpsCounter=ogUpsCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogStatus2Groups=ogStatus2Groups, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApEnabled=ogWifiApEnabled, ogWebUserName=ogWebUserName, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientInterface=ogWifiClientInterface, ogHostUserAddress=ogHostUserAddress, ogRpcEntry=ogRpcEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserTable=ogSerialUserTable, ogSerialPortParity=ogSerialPortParity, ogCellTowerNotification=ogCellTowerNotification, ogHostUserIndex=ogHostUserIndex, ogStatus2=ogStatus2, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWebUserNotification=ogWebUserNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserIndex=ogSerialUserIndex, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckTable=ogCheckTable, ogWifiApInterface=ogWifiApInterface, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortRTS=ogSerialPortRTS, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemIndex=ogCellModemIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientRssi=ogWifiClientRssi, ogAlarmTime=ogAlarmTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogSystem=ogSystem, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmSummary=ogAlarmSummary, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioState=ogEmdDioState, ogSerialPortDTR=ogSerialPortDTR, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserStartTime=ogHostUserStartTime, ogRpcTable=ogRpcTable, ogWifiApEntry=ogWifiApEntry, ogEmdName=ogEmdName, ogRpcName=ogRpcName, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemApn=ogCellModemApn, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortMode=ogSerialPortMode, ogRpcIndex=ogRpcIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceState=ogNetInterfaceState, ogHostServicePort=ogHostServicePort, ogCellNetworkNotification=ogCellNetworkNotification, ogHostName=ogHostName, ogWifiApTable=ogWifiApTable, ogCellModemTower=ogCellModemTower, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmName=ogAlarmName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmEventId=ogAlarmEventId, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserNotification=ogSerialUserNotification, ogEmdConnectType=ogEmdConnectType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellSignalNotification=ogCellSignalNotification, ogNetInterfaceName=ogNetInterfaceName, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckEntry=ogCheckEntry, ogSerialPortCTS=ogSerialPortCTS)
