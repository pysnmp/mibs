...
Gauge32, IpAddress, Counter64, ModuleIdentity, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, NotificationType, Counter32, TimeTicks, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Counter64", "ModuleIdentity", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "NotificationType", "Counter32", "TimeTicks", "Bits", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialNumber=ogSerialNumber, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemTemperature=ogCellModemTemperature, ogHostUserName=ogHostUserName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserStartTime=ogWebUserStartTime, ogUpsTable=ogUpsTable, ogSerialPortDTR=ogSerialPortDTR, ogHostPingNotification=ogHostPingNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModem4gRssi=ogCellModem4gRssi, ogSystem=ogSystem, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioDescription=ogEmdDioDescription, ogCellModemIndex=ogCellModemIndex, ogWebUserIndex=ogWebUserIndex, ogStatus2=ogStatus2, ogRpcTable=ogRpcTable, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserAddress=ogHostUserAddress, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckType=ogCheckType, ogWebUserName=ogWebUserName, ogHostTable=ogHostTable, ogHostServiceStatus=ogHostServiceStatus, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemCounter=ogCellModemCounter, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletName=ogRpcOutletName, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityIndex=ogEmdHumidityIndex, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcEntry=ogRpcEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckResolveActions=ogCheckResolveActions, ogCellModemConnected=ogCellModemConnected, ogWifiApEntry=ogWifiApEntry, ogCellDataNotification=ogCellDataNotification, ogUpsConnectType=ogUpsConnectType, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmInstance=ogAlarmInstance, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientApMac=ogWifiClientApMac, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortMode=ogSerialPortMode, ogSerialUserName=ogSerialUserName, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmTriggerValue=ogAlarmTriggerValue, ogMibNotifications=ogMibNotifications, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostName=ogHostName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialUserTable=ogSerialUserTable, ogEmdConnectType=ogEmdConnectType, ogWifiClientEntry=ogWifiClientEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogHostUserEntry=ogHostUserEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceRef=ogCheckDeviceRef, ogCellMessageNotification=ogCellMessageNotification, ogSerialUserNotification=ogSerialUserNotification, ogEmdDescription=ogEmdDescription, ogWebUserTable=ogWebUserTable, ogSerialPortIndex=ogSerialPortIndex, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserIndex=ogSerialUserIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTable=ogEmdTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioTable=ogEmdDioTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemTable=ogCellModemTable, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityName=ogEmdHumidityName, ogEmdName=ogEmdName, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientCounter=ogWifiClientCounter, ogRpcIndex=ogRpcIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApCounter=ogWifiApCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserStartTime=ogHostUserStartTime, ogAlarmState=ogAlarmState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsDescription=ogUpsDescription, ogHostUserHost=ogHostUserHost, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletRpc=ogRpcOutletRpc, ogHostServiceTable=ogHostServiceTable, ogHostUserTable=ogHostUserTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, PYSNMP_MODULE_ID=ogStatus2, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioName=ogEmdDioName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortCTS=ogSerialPortCTS, ogUpsState=ogUpsState, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioType=ogEmdDioType, ogEmdDioState=ogEmdDioState, ogWebUserNotification=ogWebUserNotification, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmEventId=ogAlarmEventId, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarm=ogAlarm, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckEntry=ogCheckEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsNotification=ogUpsNotification, ogWifiApInterface=ogWifiApInterface, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckName=ogCheckName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserPort=ogSerialUserPort, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceIndex=ogHostServiceIndex, ogRpcCounter=ogRpcCounter, ogCellApnNotification=ogCellApnNotification, ogCheckIndex=ogCheckIndex, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDSR=ogSerialPortDSR, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostEntry=ogHostEntry, ogAlarmDevice=ogAlarmDevice, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcName=ogRpcName, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletIndex=ogRpcOutletIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsEntry=ogUpsEntry, ogUpsName=ogUpsName, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemModel=ogCellModemModel, ogHostIpV4Address=ogHostIpV4Address, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmLogTable=ogAlarmLogTable, ogFirmwareVersion=ogFirmwareVersion, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckTable=ogCheckTable, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortParity=ogSerialPortParity, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientInterface=ogWifiClientInterface, ogCellModemApn=ogCellModemApn, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletState=ogRpcOutletState, ogHostServicePort=ogHostServicePort, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApFrequency=ogWifiApFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2Conformance=ogStatus2Conformance, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApTable=ogWifiApTable, ogRpcOutletNotification=ogRpcOutletNotification, ogCustomNotification=ogCustomNotification, ogPowerSupplyName=ogPowerSupplyName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdIndex=ogEmdIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientTable=ogWifiApClientTable, ogWifiApSsid=ogWifiApSsid, ogAlarmCheck=ogAlarmCheck, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioDirection=ogEmdDioDirection, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsHumidity=ogUpsHumidity, ogEmdEnabled=ogEmdEnabled)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemEnabled=ogCellModemEnabled, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserEntry=ogSerialUserEntry, ogHostUserHostName=ogHostUserHostName, ogUpsInputFrequency=ogUpsInputFrequency, ogHostIndex=ogHostIndex, ogAlarmTime=ogAlarmTime, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmName=ogAlarmName, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsType=ogUpsType, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryState=ogUpsBatteryState, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceHost=ogHostServiceHost, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortRTS=ogSerialPortRTS, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserEntry=ogWebUserEntry, ogRpcDescription=ogRpcDescription, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortTable=ogSerialPortTable, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogNetInterfaceName=ogNetInterfaceName, ogStatus2Compliance=ogStatus2Compliance, ogCellModemTower=ogCellModemTower, ogWifiApIndex=ogWifiApIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcConnectType=ogRpcConnectType, ogSerialUserLabel=ogSerialUserLabel, ogUpsCounter=ogUpsCounter, ogAlarmType=ogAlarmType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemEntry=ogCellModemEntry, ogEmdEntry=ogEmdEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsIndex=ogUpsIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmUser=ogAlarmUser, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostServiceEntry=ogHostServiceEntry, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcType=ogRpcType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceType=ogHostServiceType, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification)
