...
iso, MibIdentifier, IpAddress, ObjectIdentity, NotificationType, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Gauge32, Bits, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "IpAddress", "ObjectIdentity", "NotificationType", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Gauge32", "Bits", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemModel=ogCellModemModel, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserIndex=ogWebUserIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmName=ogAlarmName, ogEmdDioName=ogEmdDioName, ogStatus2Conformance=ogStatus2Conformance, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortMode=ogSerialPortMode, ogHostName=ogHostName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsEntry=ogUpsEntry, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRssi=ogWifiClientRssi, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemNetwork=ogCellModemNetwork, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcCounter=ogRpcCounter, ogWifiApClientAp=ogWifiApClientAp, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdIndex=ogEmdIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckEntry=ogCheckEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcDescription=ogRpcDescription, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientEntry=ogWifiClientEntry, ogCheckTable=ogCheckTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioState=ogEmdDioState, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserPort=ogSerialUserPort, ogCheckType=ogCheckType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserNotification=ogSerialUserNotification, ogHostIndex=ogHostIndex, ogHostEntry=ogHostEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioIndex=ogEmdDioIndex, ogHostUserEntry=ogHostUserEntry, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserName=ogHostUserName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientCounter=ogWifiClientCounter, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApIndex=ogWifiApIndex, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortTable=ogSerialPortTable, ogSerialPortRTS=ogSerialPortRTS, ogCellTowerNotification=ogCellTowerNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogFirmwareVersion=ogFirmwareVersion, ogWifiApCounter=ogWifiApCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsTemperature=ogUpsTemperature, ogUpsCounter=ogUpsCounter, ogCellModemTower=ogCellModemTower, ogEmdDioTable=ogEmdDioTable, ogCellMessageNotification=ogCellMessageNotification, ogEmdEnabled=ogEmdEnabled, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortIndex=ogSerialPortIndex, ogEmdEntry=ogEmdEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogStatus2=ogStatus2, ogUpsIndex=ogUpsIndex, ogWifiClientTable=ogWifiClientTable, ogHostPingNotification=ogHostPingNotification, ogRpcOutletTable=ogRpcOutletTable, ogUpsState=ogUpsState, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioDirection=ogEmdDioDirection, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcTable=ogRpcTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmState=ogAlarmState, ogSerialUserIndex=ogSerialUserIndex, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemApn=ogCellModemApn, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputPower=ogUpsOutputPower, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserHost=ogHostUserHost, ogHostUserNotification=ogHostUserNotification, ogSerialPortLabel=ogSerialPortLabel, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserIndex=ogHostUserIndex, ogHostUserAddress=ogHostUserAddress, ogWebUserTable=ogWebUserTable, ogAlarmType=ogAlarmType, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletState=ogRpcOutletState, ogStatus2Groups=ogStatus2Groups, ogWifiApTable=ogWifiApTable, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceState=ogNetInterfaceState, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsConnectType=ogUpsConnectType, ogSerialPortSpeed=ogSerialPortSpeed, ogCellNetworkNotification=ogCellNetworkNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientApMac=ogWifiClientApMac, ogCheckName=ogCheckName, ogHostServicePort=ogHostServicePort, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogMibNotifications=ogMibNotifications, ogSerialPortCTS=ogSerialPortCTS, ogCellModemTable=ogCellModemTable, ogNetInterfaceName=ogNetInterfaceName, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientEssid=ogWifiClientEssid, ogStatus2Compliance=ogStatus2Compliance, ogAlarmTime=ogAlarmTime, ogRpcConnectType=ogRpcConnectType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsTable=ogUpsTable, ogHostUserTable=ogHostUserTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortDCD=ogSerialPortDCD, ogSystem=ogSystem, ogRpcOutletName=ogRpcOutletName, ogAlarmInstance=ogAlarmInstance, ogUpsName=ogUpsName, ogSerialUserName=ogSerialUserName, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWebUserEntry=ogWebUserEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceIndex=ogHostServiceIndex, ogAlarmUser=ogAlarmUser, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceTable=ogHostServiceTable, ogAlarmCheck=ogAlarmCheck, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcIndex=ogRpcIndex, PYSNMP_MODULE_ID=ogStatus2, ogRpcName=ogRpcName, ogEmdDioDescription=ogEmdDioDescription, ogCellModemIndex=ogCellModemIndex, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApInterface=ogWifiApInterface, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckIndex=ogCheckIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsNotification=ogUpsNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApSsid=ogWifiApSsid, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarm=ogAlarm, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWebUserName=ogWebUserName, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdName=ogEmdName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostTable=ogHostTable, ogCustomNotification=ogCustomNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserTable=ogSerialUserTable, ogCellModemCounter=ogCellModemCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcEntry=ogRpcEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserStartTime=ogHostUserStartTime, ogAlarmDevice=ogAlarmDevice, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcType=ogRpcType, ogHostServiceType=ogHostServiceType, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserNotification=ogWebUserNotification, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceNotification=ogHostServiceNotification, ogEmdTable=ogEmdTable, ogSerialNumber=ogSerialNumber, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsDescription=ogUpsDescription, ogUpsHumidity=ogUpsHumidity, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientIndex=ogWifiClientIndex, ogUpsType=ogUpsType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellApnNotification=ogCellApnNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTemperature=ogCellModemTemperature, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDescription=ogEmdDescription, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmSummary=ogAlarmSummary, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcInputNotification=ogRpcInputNotification, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioEntry=ogEmdDioEntry, ogHostUserHostName=ogHostUserHostName, ogEmdConnectType=ogEmdConnectType, ogRpcOutletTotal=ogRpcOutletTotal, ogHostIpV6Address=ogHostIpV6Address, ogNetInterfaceType=ogNetInterfaceType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioType=ogEmdDioType, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Compliances=ogStatus2Compliances)
