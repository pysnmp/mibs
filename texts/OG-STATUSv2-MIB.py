...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcCounter=ogRpcCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdConnectType=ogEmdConnectType, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsState=ogUpsState, ogWifiApSsid=ogWifiApSsid, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortParity=ogSerialPortParity, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcInputCurrent=ogRpcInputCurrent, ogCellDataNotification=ogCellDataNotification, ogRpcIndex=ogRpcIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApTable=ogWifiApTable, ogWifiClientTable=ogWifiClientTable, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyName=ogPowerSupplyName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarm=ogAlarm, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceType=ogHostServiceType, ogSystem=ogSystem, ogAlarmState=ogAlarmState, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserHostName=ogHostUserHostName, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemTower=ogCellModemTower, ogHostIpV6Address=ogHostIpV6Address, ogUpsNotification=ogUpsNotification, ogHostServicePort=ogHostServicePort, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmTime=ogAlarmTime, ogHostUserNotification=ogHostUserNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemCounter=ogCellModemCounter, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemVendor=ogCellModemVendor, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsTable=ogUpsTable, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRssi=ogWifiClientRssi, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserEntry=ogSerialUserEntry, ogEmdName=ogEmdName, ogHostServiceEntry=ogHostServiceEntry, ogCellModemEnabled=ogCellModemEnabled, ogRpcMaxTemperature=ogRpcMaxTemperature, ogNetInterfaceState=ogNetInterfaceState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCustomNotification=ogCustomNotification, ogSerialPortRTS=ogSerialPortRTS, ogEmdTable=ogEmdTable, ogWebUserIndex=ogWebUserIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmDevice=ogAlarmDevice, ogEmdDioEntry=ogEmdDioEntry, ogSerialUserIndex=ogSerialUserIndex, ogEmdEnabled=ogEmdEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostEntry=ogHostEntry, ogEmdDioEmd=ogEmdDioEmd, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApInterface=ogWifiApInterface, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletState=ogRpcOutletState, ogRpcConnectType=ogRpcConnectType, ogFirmwareVersion=ogFirmwareVersion, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsName=ogUpsName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdLogEnabled=ogEmdLogEnabled, ogHostIpV4Address=ogHostIpV4Address, ogWebUserNotification=ogWebUserNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortDTR=ogSerialPortDTR, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletName=ogRpcOutletName, ogEmdDioType=ogEmdDioType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellMessageNotification=ogCellMessageNotification, ogRpcInputNotification=ogRpcInputNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmCheck=ogAlarmCheck, ogCellModemEntry=ogCellModemEntry, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortSpeed=ogSerialPortSpeed, ogStatus2Conformance=ogStatus2Conformance, ogCellModemModel=ogCellModemModel, ogMibNotifications=ogMibNotifications, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckType=ogCheckType, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortDSR=ogSerialPortDSR, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApFrequency=ogWifiApFrequency, ogWifiApIndex=ogWifiApIndex, ogHostServiceIndex=ogHostServiceIndex, ogCheckIndex=ogCheckIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdEntry=ogEmdEntry, ogHostUserName=ogHostUserName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioTable=ogEmdDioTable, ogSerialNumber=ogSerialNumber, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioNotification=ogEmdDioNotification, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmEventId=ogAlarmEventId, ogRpcType=ogRpcType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostName=ogHostName, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcTable=ogRpcTable, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmType=ogAlarmType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserHost=ogHostUserHost, ogUpsInputFrequency=ogUpsInputFrequency, ogHostPingNotification=ogHostPingNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserNotification=ogSerialUserNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2=ogStatus2, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckName=ogCheckName, ogCheckDeviceTable=ogCheckDeviceTable, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmType=ogCurrentAlarmType, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWebUserName=ogWebUserName, ogAlarmInstance=ogAlarmInstance, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryState=ogUpsBatteryState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemIndex=ogCellModemIndex, ogRpcEntry=ogRpcEntry, ogCellModemConnected=ogCellModemConnected, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserName=ogSerialUserName, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsIndex=ogUpsIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserPort=ogSerialUserPort, ogCellModemApn=ogCellModemApn, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputNotification=ogUpsInputNotification, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioState=ogEmdDioState, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcDescription=ogRpcDescription, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsTemperature=ogUpsTemperature, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApCounter=ogWifiApCounter, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletTable=ogRpcOutletTable, ogEmdIndex=ogEmdIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioName=ogEmdDioName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIndex=ogHostIndex, ogUpsHumidity=ogUpsHumidity, ogStatus2Compliance=ogStatus2Compliance, ogCellModemTable=ogCellModemTable, ogWifiClientApMac=ogWifiClientApMac, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmUser=ogAlarmUser, ogCellModemIMSI=ogCellModemIMSI, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcName=ogRpcName, ogCheckResetTimeout=ogCheckResetTimeout, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortMode=ogSerialPortMode, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserTable=ogSerialUserTable, ogHostServiceHost=ogHostServiceHost, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserTable=ogHostUserTable, ogUpsCounter=ogUpsCounter, ogHostTable=ogHostTable, ogUpsEntry=ogUpsEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserStartTime=ogHostUserStartTime, ogUpsConnectType=ogUpsConnectType, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortFlowControl=ogSerialPortFlowControl, ogStatus2Groups=ogStatus2Groups, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmName=ogCurrentAlarmName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortDCD=ogSerialPortDCD, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsType=ogUpsType, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortIndex=ogSerialPortIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckEntry=ogCheckEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmName=ogAlarmName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWebUserEntry=ogWebUserEntry, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDescription=ogEmdDescription, ogUpsDescription=ogUpsDescription, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWebUserTable=ogWebUserTable, ogHostUserIndex=ogHostUserIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmTable=ogCurrentAlarmTable)
