...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortCTS=ogSerialPortCTS, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdEntry=ogEmdEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmUser=ogAlarmUser, ogEmdEnabled=ogEmdEnabled, ogWebUserName=ogWebUserName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserIndex=ogHostUserIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcConnectType=ogRpcConnectType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientEntry=ogWifiClientEntry, ogCellModemTower=ogCellModemTower, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmType=ogAlarmType, ogSerialPortTable=ogSerialPortTable, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostTable=ogHostTable, ogSerialPortMode=ogSerialPortMode, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsTemperature=ogUpsTemperature, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceStatus=ogHostServiceStatus, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmSummary=ogAlarmSummary, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioName=ogEmdDioName, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcIndex=ogRpcIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceNotification=ogHostServiceNotification, ogCellDataNotification=ogCellDataNotification, ogWifiClientIndex=ogWifiClientIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCustomNotification=ogCustomNotification, ogHostServiceCounter=ogHostServiceCounter, ogRpcCounter=ogRpcCounter, ogHostUserTable=ogHostUserTable, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceType=ogNetInterfaceType, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmName=ogAlarmName, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialNumber=ogSerialNumber, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApTable=ogWifiApTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSystem=ogSystem, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortParity=ogSerialPortParity, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceTable=ogNetInterfaceTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioEntry=ogEmdDioEntry, ogUpsNotification=ogUpsNotification, ogSerialPortLabel=ogSerialPortLabel, ogHostUserHost=ogHostUserHost, ogWebUserEntry=ogWebUserEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2Compliance=ogStatus2Compliance, ogWebUserTable=ogWebUserTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemEntry=ogCellModemEntry, ogAlarmInstance=ogAlarmInstance, ogEmdDioCounter=ogEmdDioCounter, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletState=ogRpcOutletState, ogWifiClientApMac=ogWifiClientApMac, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDescription=ogEmdDescription, ogCheckName=ogCheckName, ogRpcDescription=ogRpcDescription, ogHostEntry=ogHostEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioNotification=ogEmdDioNotification, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdTable=ogEmdTable, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWebUserStartTime=ogWebUserStartTime, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemModel=ogCellModemModel, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsDescription=ogUpsDescription, ogUpsHumidity=ogUpsHumidity, ogAlarmTime=ogAlarmTime, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserHostName=ogHostUserHostName, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckType=ogCheckType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserAddress=ogHostUserAddress, ogEmdDioTable=ogEmdDioTable, ogEmdDioState=ogEmdDioState, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsTable=ogUpsTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServiceType=ogHostServiceType, PYSNMP_MODULE_ID=ogStatus2, ogCellModemCounter=ogCellModemCounter, ogAlarmDevice=ogAlarmDevice, ogEmdName=ogEmdName, ogSerialUserPort=ogSerialUserPort, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemTemperature=ogCellModemTemperature, ogUpsType=ogUpsType, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckTable=ogCheckTable, ogStatus2Conformance=ogStatus2Conformance, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsState=ogUpsState, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserName=ogHostUserName, ogHostServiceEntry=ogHostServiceEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckIndex=ogCheckIndex, ogEmdDioType=ogEmdDioType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogNetInterfaceName=ogNetInterfaceName, ogAlarmState=ogAlarmState, ogCheckDeviceName=ogCheckDeviceName, ogMibNotifications=ogMibNotifications, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserEntry=ogHostUserEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostIndex=ogHostIndex, ogHostIpV6Address=ogHostIpV6Address, ogAlarm=ogAlarm, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsName=ogUpsName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcName=ogRpcName, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemTable=ogCellModemTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientTable=ogWifiClientTable, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputTruePower=ogUpsOutputTruePower, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsEntry=ogUpsEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemIndex=ogCellModemIndex, ogWifiApIndex=ogWifiApIndex, ogCellModemVendor=ogCellModemVendor, ogRpcType=ogRpcType, ogWebUserNotification=ogWebUserNotification, ogHostServiceHost=ogHostServiceHost, ogHostUserNotification=ogHostUserNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServiceIndex=ogHostServiceIndex, ogAlarmCheck=ogAlarmCheck, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcTable=ogRpcTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioIndex=ogEmdDioIndex, ogWebUserIndex=ogWebUserIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogHostPingNotification=ogHostPingNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApTxPower=ogWifiApTxPower, ogAlarmEventId=ogAlarmEventId, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletName=ogRpcOutletName, ogWifiClientMode=ogWifiClientMode, ogEmdIndex=ogEmdIndex, ogEmdHumidityName=ogEmdHumidityName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortEntry=ogSerialPortEntry, ogWifiApInterface=ogWifiApInterface, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostServiceTable=ogHostServiceTable, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsConnectType=ogUpsConnectType, ogHostServicePort=ogHostServicePort, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckEntry=ogCheckEntry, ogWifiApClientAp=ogWifiApClientAp, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcEntry=ogRpcEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApSsid=ogWifiApSsid, ogWifiClientEssid=ogWifiClientEssid, ogCellModemRegistered=ogCellModemRegistered, ogHostName=ogHostName, ogSerialPortSpeed=ogSerialPortSpeed, ogNetInterfaceState=ogNetInterfaceState, ogEmdConnectType=ogEmdConnectType, ogUpsCounter=ogUpsCounter, ogCellModemConnected=ogCellModemConnected, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApCounter=ogWifiApCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2Groups=ogStatus2Groups, ogEmdDioDescription=ogEmdDioDescription, ogUpsIndex=ogUpsIndex, ogCellModemApn=ogCellModemApn, ogRpcOutletRpc=ogRpcOutletRpc, ogStatus2=ogStatus2, ogSerialUserName=ogSerialUserName)
