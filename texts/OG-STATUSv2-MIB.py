...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", PYSNMP_MODULE_ID=ogStatus2, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellSignalNotification=ogCellSignalNotification, ogEmdTable=ogEmdTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogMibNotifications=ogMibNotifications, ogCellModemConnected=ogCellModemConnected, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortIndex=ogSerialPortIndex, ogUpsTable=ogUpsTable, ogSerialPortDSR=ogSerialPortDSR, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdConnectType=ogEmdConnectType, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemApn=ogCellModemApn, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioState=ogEmdDioState, ogSerialPortDTR=ogSerialPortDTR, ogAlarmSummary=ogAlarmSummary, ogStatus2=ogStatus2, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortMode=ogSerialPortMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApCounter=ogWifiApCounter, ogCellModemCounter=ogCellModemCounter, ogHostName=ogHostName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemIndex=ogCellModemIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientEssid=ogWifiClientEssid, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmUser=ogAlarmUser, ogSerialNumber=ogSerialNumber, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcDescription=ogRpcDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostIndex=ogHostIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceType=ogNetInterfaceType, ogCheckName=ogCheckName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRssi=ogWifiClientRssi, ogCellDataNotification=ogCellDataNotification, ogSystem=ogSystem, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletState=ogRpcOutletState, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletNotification=ogRpcOutletNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserIndex=ogWebUserIndex, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserPort=ogSerialUserPort, ogSerialPortParity=ogSerialPortParity, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmState=ogAlarmState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientMode=ogWifiClientMode, ogUpsTemperature=ogUpsTemperature, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsCounter=ogUpsCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsIndex=ogUpsIndex, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogCellTowerNotification=ogCellTowerNotification, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioTable=ogEmdDioTable, ogUpsState=ogUpsState, ogHostUserTable=ogHostUserTable, ogCellModemIMSI=ogCellModemIMSI, ogEmdEntry=ogEmdEntry, ogHostUserEntry=ogHostUserEntry, ogUpsDescription=ogUpsDescription, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserTable=ogWebUserTable, ogAlarmName=ogAlarmName, ogEmdDioName=ogEmdDioName, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioType=ogEmdDioType, ogWifiApClientAp=ogWifiApClientAp, ogWebUserName=ogWebUserName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemTower=ogCellModemTower, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortRTS=ogSerialPortRTS, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemModel=ogCellModemModel, ogEmdDescription=ogEmdDescription, ogCheckResolveActions=ogCheckResolveActions, ogEmdIndex=ogEmdIndex, ogRpcCounter=ogRpcCounter, ogStatus2Groups=ogStatus2Groups, ogUpsInputNotification=ogUpsInputNotification, ogWifiApEnabled=ogWifiApEnabled, ogWifiApFrequency=ogWifiApFrequency, ogSerialUserEntry=ogSerialUserEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserHost=ogHostUserHost, ogAlarmCheck=ogAlarmCheck, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioDescription=ogEmdDioDescription, ogHostUserNotification=ogHostUserNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletName=ogRpcOutletName, ogCellModemTable=ogCellModemTable, ogHostServiceIndex=ogHostServiceIndex, ogAlarm=ogAlarm, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortCTS=ogSerialPortCTS, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientCounter=ogWifiClientCounter, ogAlarmDevice=ogAlarmDevice, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcEntry=ogRpcEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortDataBits=ogSerialPortDataBits, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioNotification=ogEmdDioNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceName=ogNetInterfaceName, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsHumidity=ogUpsHumidity, ogAlarmType=ogAlarmType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcConnectType=ogRpcConnectType, ogHostIpV4Address=ogHostIpV4Address, ogCheckIndex=ogCheckIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmTime=ogAlarmTime, ogUpsType=ogUpsType, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientApMac=ogWifiClientApMac, ogSerialUserName=ogSerialUserName, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserIndex=ogSerialUserIndex, ogEmdName=ogEmdName, ogHostServiceTable=ogHostServiceTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckTable=ogCheckTable, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserName=ogHostUserName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialUserTable=ogSerialUserTable, ogRpcIndex=ogRpcIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialUserLabel=ogSerialUserLabel, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortEntry=ogSerialPortEntry, ogHostEntry=ogHostEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostPingNotification=ogHostPingNotification, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcTable=ogRpcTable, ogNetInterfaceState=ogNetInterfaceState, ogHostServiceCounter=ogHostServiceCounter, ogUpsName=ogUpsName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellMessageNotification=ogCellMessageNotification, ogHostIpV6Address=ogHostIpV6Address, ogHostUserIndex=ogHostUserIndex, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioEmd=ogEmdDioEmd, ogCustomNotification=ogCustomNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellApnNotification=ogCellApnNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyTemperature=ogPowerSupplyTemperature)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceType=ogHostServiceType, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemRegistered=ogCellModemRegistered, ogHostTable=ogHostTable, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmInstance=ogAlarmInstance, ogUpsConnectType=ogUpsConnectType, ogStatus2Conformance=ogStatus2Conformance, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemNetwork=ogCellModemNetwork, ogHostUserStartTime=ogHostUserStartTime, ogUpsNotification=ogUpsNotification, ogSerialPortTable=ogSerialPortTable, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemVendor=ogCellModemVendor, ogRpcType=ogRpcType, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogTable=ogAlarmLogTable, ogHostServicePort=ogHostServicePort, ogUpsEntry=ogUpsEntry, ogRpcInputNotification=ogRpcInputNotification, ogWebUserNotification=ogWebUserNotification, ogStatus2Compliance=ogStatus2Compliance, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckType=ogCheckType, ogUpsBatteryState=ogUpsBatteryState, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcName=ogRpcName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApTable=ogWifiApTable, ogCheckEntry=ogCheckEntry)
