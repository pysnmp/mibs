...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWebUserNotification=ogWebUserNotification, ogAlarm=ogAlarm, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWebUserIndex=ogWebUserIndex, ogSerialPortMode=ogSerialPortMode, ogHostServiceNotification=ogHostServiceNotification, ogCellDataNotification=ogCellDataNotification, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientBitRate=ogWifiClientBitRate, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemIndex=ogCellModemIndex, ogAlarmUser=ogAlarmUser, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckEntry=ogCheckEntry, ogRpcType=ogRpcType, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApIndex=ogWifiApIndex, ogSerialUserPort=ogSerialUserPort, ogWifiClientTxPower=ogWifiClientTxPower, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserName=ogWebUserName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemConnected=ogCellModemConnected, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientEntry=ogWifiClientEntry, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserEntry=ogSerialUserEntry, ogCustomNotification=ogCustomNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdName=ogEmdName, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmTime=ogAlarmTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientMode=ogWifiClientMode, ogSerialPortDTR=ogSerialPortDTR, ogAlarmType=ogAlarmType, ogSerialNumber=ogSerialNumber, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserAddress=ogHostUserAddress, ogCellModemTemperature=ogCellModemTemperature, ogAlarmEventId=ogAlarmEventId, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcInputNotification=ogRpcInputNotification, ogHostServicePort=ogHostServicePort, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModem4gRssi=ogCellModem4gRssi, ogCellTowerNotification=ogCellTowerNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputNotification=ogUpsInputNotification, ogHostUserIndex=ogHostUserIndex, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmState=ogAlarmState, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientAp=ogWifiApClientAp, ogCellModemApn=ogCellModemApn, ogCheckType=ogCheckType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellMessageNotification=ogCellMessageNotification, ogRpcCounter=ogRpcCounter, ogHostUserTable=ogHostUserTable, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsName=ogUpsName, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioEmd=ogEmdDioEmd, ogEmdTable=ogEmdTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsEntry=ogUpsEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDescription=ogEmdDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioType=ogEmdDioType, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostPingNotification=ogHostPingNotification, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortIndex=ogSerialPortIndex, ogWebUserTable=ogWebUserTable, ogHostTable=ogHostTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceStatus=ogHostServiceStatus, ogEmdEntry=ogEmdEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceState=ogNetInterfaceState, ogCheckIndex=ogCheckIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostUserEntry=ogHostUserEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletState=ogRpcOutletState, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSystem=ogSystem, ogAlarmInstance=ogAlarmInstance, ogRpcEntry=ogRpcEntry, ogCellModemVendor=ogCellModemVendor, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApEnabled=ogWifiApEnabled, ogCheckDeviceName=ogCheckDeviceName, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApTable=ogWifiApTable, ogRpcConnectType=ogRpcConnectType, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientInterface=ogWifiClientInterface, ogHostEntry=ogHostEntry, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserName=ogSerialUserName, ogAlarmCheck=ogAlarmCheck, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcTable=ogRpcTable, ogCellModemCounter=ogCellModemCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApSsid=ogWifiApSsid, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortTable=ogSerialPortTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemEntry=ogCellModemEntry, ogSerialPortCTS=ogSerialPortCTS, ogCheckTriggerActions=ogCheckTriggerActions, ogStatus2=ogStatus2, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcIndex=ogRpcIndex, ogHostServiceIndex=ogHostServiceIndex, ogUpsState=ogUpsState, ogWifiClientEnabled=ogWifiClientEnabled, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsTable=ogUpsTable, ogRpcName=ogRpcName, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortEntry=ogSerialPortEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsNotification=ogUpsNotification, ogUpsConnectType=ogUpsConnectType, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceType=ogHostServiceType, ogEmdEnabled=ogEmdEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityValue=ogEmdHumidityValue, PYSNMP_MODULE_ID=ogStatus2, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsIndex=ogUpsIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientIndex=ogWifiClientIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemTable=ogCellModemTable, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsType=ogUpsType, ogEmdDioNotification=ogEmdDioNotification, ogHostIpV4Address=ogHostIpV4Address, ogEmdConnectType=ogEmdConnectType, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemModel=ogCellModemModel, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientMac=ogWifiApClientMac, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortParity=ogSerialPortParity, ogCheckName=ogCheckName, ogUpsDescription=ogUpsDescription, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceType=ogNetInterfaceType, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogMibNotifications=ogMibNotifications, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApInterface=ogWifiApInterface, ogSerialPortRTS=ogSerialPortRTS, ogCellApnNotification=ogCellApnNotification, ogEmdDioState=ogEmdDioState, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletTable=ogRpcOutletTable, ogWebUserEntry=ogWebUserEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostIndex=ogHostIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemTower=ogCellModemTower, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceTable=ogCheckDeviceTable, ogStatus2Groups=ogStatus2Groups, ogUpsTemperature=ogUpsTemperature, ogHostUserHostName=ogHostUserHostName, ogRpcDescription=ogRpcDescription, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemEnabled=ogCellModemEnabled, ogFirmwareVersion=ogFirmwareVersion, ogCheckTable=ogCheckTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostName=ogHostName, ogWifiClientRssi=ogWifiClientRssi, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientTable=ogWifiApClientTable, ogUpsHumidity=ogUpsHumidity, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioCounter=ogEmdDioCounter, ogCellModemNetwork=ogCellModemNetwork, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserHost=ogHostUserHost, ogSerialUserTable=ogSerialUserTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmName=ogAlarmName, ogAlarmDevice=ogAlarmDevice, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogStatus2Compliances=ogStatus2Compliances, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostUserNotification=ogHostUserNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServiceHost=ogHostServiceHost, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserName=ogHostUserName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioName=ogEmdDioName, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsCounter=ogUpsCounter, ogWifiApEntry=ogWifiApEntry, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyName=ogPowerSupplyName, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdIndex=ogEmdIndex, ogUpsBatteryCharge=ogUpsBatteryCharge)
