...
ObjectIdentity, MibIdentifier, Counter32, iso, Unsigned32, Counter64, Bits, ModuleIdentity, Gauge32, NotificationType, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Counter32", "iso", "Unsigned32", "Counter64", "Bits", "ModuleIdentity", "Gauge32", "NotificationType", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceIndex=ogHostServiceIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmTime=ogAlarmTime, ogWifiApEntry=ogWifiApEntry, ogMibNotifications=ogMibNotifications, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcConnectType=ogRpcConnectType, ogCellModemVendor=ogCellModemVendor, ogCellModemConnected=ogCellModemConnected, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckType=ogCheckType, ogSerialPortMode=ogSerialPortMode, ogWifiApCounter=ogWifiApCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserName=ogHostUserName, ogAlarmCheck=ogAlarmCheck, ogUpsState=ogUpsState, ogSerialPortTable=ogSerialPortTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWebUserName=ogWebUserName, ogUpsEntry=ogUpsEntry, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdConnectType=ogEmdConnectType, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmType=ogAlarmType, ogHostUserIndex=ogHostUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientRssi=ogWifiApClientRssi, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialUserNotification=ogSerialUserNotification, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsTable=ogUpsTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarm=ogAlarm, ogRpcTable=ogRpcTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsTemperature=ogUpsTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioDescription=ogEmdDioDescription, ogEmdDescription=ogEmdDescription, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortDCD=ogSerialPortDCD, ogUpsName=ogUpsName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserEntry=ogWebUserEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServiceTable=ogHostServiceTable, ogWebUserTable=ogWebUserTable, ogHostServiceNotification=ogHostServiceNotification, ogCellSignalNotification=ogCellSignalNotification, ogCellApnNotification=ogCellApnNotification, ogUpsHumidity=ogUpsHumidity, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientMac=ogWifiApClientMac, ogEmdEnabled=ogEmdEnabled, ogHostUserHost=ogHostUserHost, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostServiceHost=ogHostServiceHost, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServicePort=ogHostServicePort, ogCellModemNetwork=ogCellModemNetwork, ogCellModemTable=ogCellModemTable, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellTowerNotification=ogCellTowerNotification, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientEntry=ogWifiApClientEntry, ogHostIndex=ogHostIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcName=ogRpcName, ogHostServiceCounter=ogHostServiceCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2=ogStatus2, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemApn=ogCellModemApn, ogRpcCounter=ogRpcCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcType=ogRpcType, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioEmd=ogEmdDioEmd, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientEntry=ogWifiClientEntry, ogHostUserAddress=ogHostUserAddress, ogCheckResolveActions=ogCheckResolveActions, ogAlarmInstance=ogAlarmInstance, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTable=ogEmdTable, ogWifiApTable=ogWifiApTable, ogAlarmName=ogAlarmName, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsNotification=ogUpsNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemTower=ogCellModemTower, ogSerialPortDSR=ogSerialPortDSR, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsIndex=ogUpsIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioName=ogEmdDioName, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmUser=ogAlarmUser, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSystem=ogSystem, ogHostUserHostName=ogHostUserHostName, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostName=ogHostName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemCounter=ogCellModemCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostEntry=ogHostEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcDescription=ogRpcDescription, ogHostUserNotification=ogHostUserNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortParity=ogSerialPortParity, ogHostUserTable=ogHostUserTable, ogCheckIndex=ogCheckIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsCounter=ogUpsCounter, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCustomNotification=ogCustomNotification, ogWifiClientTable=ogWifiClientTable, ogAlarmEventId=ogAlarmEventId, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioCounter=ogEmdDioCounter, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdEntry=ogEmdEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemEntry=ogCellModemEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellMessageNotification=ogCellMessageNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApSsid=ogWifiApSsid, ogSerialNumber=ogSerialNumber, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortLabel=ogSerialPortLabel, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioType=ogEmdDioType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioTable=ogEmdDioTable, ogWebUserStartTime=ogWebUserStartTime, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputPower=ogUpsOutputPower, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientAp=ogWifiApClientAp, ogAlarmLogTable=ogAlarmLogTable, ogCheckDeviceName=ogCheckDeviceName, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemIndex=ogCellModemIndex, ogAlarmState=ogAlarmState, ogRpcOutletName=ogRpcOutletName, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckEntry=ogCheckEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientTable=ogWifiApClientTable, ogRpcInputVoltage=ogRpcInputVoltage, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserPort=ogSerialUserPort, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletLoad=ogRpcOutletLoad, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserTable=ogSerialUserTable, ogSerialUserName=ogSerialUserName, ogRpcOutletState=ogRpcOutletState, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityName=ogEmdHumidityName, ogUpsDescription=ogUpsDescription, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryState=ogUpsBatteryState, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemModel=ogCellModemModel, ogCheckName=ogCheckName, ogUpsType=ogUpsType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientMode=ogWifiClientMode, ogCellDataNotification=ogCellDataNotification, ogRpcEntry=ogRpcEntry, ogRpcInputNotification=ogRpcInputNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogNetInterfaceType=ogNetInterfaceType, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdIndex=ogEmdIndex, ogCellModemRegistered=ogCellModemRegistered, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmType=ogCurrentAlarmType, ogHostServiceType=ogHostServiceType, ogCellModemIMSI=ogCellModemIMSI, ogHostUserEntry=ogHostUserEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserLabel=ogSerialUserLabel, ogEmdName=ogEmdName, ogEmdDioState=ogEmdDioState, ogRpcIndex=ogRpcIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogStatus2Compliance=ogStatus2Compliance, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientCounter=ogWifiClientCounter, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostTable=ogHostTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutputNotification=ogRpcOutputNotification)
