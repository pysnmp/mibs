...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserHost=ogHostUserHost, ogUpsTable=ogUpsTable, ogAlarmName=ogAlarmName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserTable=ogHostUserTable, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogHostIpV4Address=ogHostIpV4Address, ogEmdTable=ogEmdTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientApMac=ogWifiClientApMac, ogAlarmCheck=ogAlarmCheck, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApInterface=ogWifiApInterface, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioDescription=ogEmdDioDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientEntry=ogWifiClientEntry, ogAlarmSummary=ogAlarmSummary, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientCounter=ogWifiClientCounter, ogUpsCounter=ogUpsCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsEntry=ogUpsEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmDevice=ogAlarmDevice, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityName=ogEmdHumidityName, ogHostUserNotification=ogHostUserNotification, ogHostName=ogHostName, ogEmdDioEntry=ogEmdDioEntry, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsDescription=ogUpsDescription, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWebUserEntry=ogWebUserEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserEntry=ogHostUserEntry, ogHostServicePort=ogHostServicePort, ogStatus2Compliance=ogStatus2Compliance, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostServiceHost=ogHostServiceHost, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioName=ogEmdDioName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortRTS=ogSerialPortRTS, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsType=ogUpsType, ogWifiClientBitRate=ogWifiClientBitRate, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientInterface=ogWifiClientInterface, ogCheckType=ogCheckType, ogCellModemEnabled=ogCellModemEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceName=ogNetInterfaceName, ogSerialNumber=ogSerialNumber, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemVendor=ogCellModemVendor, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientMode=ogWifiClientMode, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioState=ogEmdDioState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdConnectType=ogEmdConnectType, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsNotification=ogUpsNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortEntry=ogSerialPortEntry, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServiceType=ogHostServiceType, ogSerialPortTable=ogSerialPortTable, ogRpcCounter=ogRpcCounter, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellMessageNotification=ogCellMessageNotification, ogCustomNotification=ogCustomNotification, ogRpcName=ogRpcName, ogCheckDeviceTable=ogCheckDeviceTable, ogHostServiceStatus=ogHostServiceStatus, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogFirmwareVersion=ogFirmwareVersion, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcDescription=ogRpcDescription, ogUpsTemperature=ogUpsTemperature, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostIndex=ogHostIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcInputVoltage=ogRpcInputVoltage, ogPowerSupplyName=ogPowerSupplyName, ogWifiApTable=ogWifiApTable, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdEntry=ogEmdEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletName=ogRpcOutletName, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogStatus2Groups=ogStatus2Groups, ogSerialUserLabel=ogSerialUserLabel, ogMibNotifications=ogMibNotifications, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmUser=ogAlarmUser, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmState=ogAlarmState, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsIndex=ogUpsIndex, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserName=ogSerialUserName, ogEmdDioType=ogEmdDioType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostPingNotification=ogHostPingNotification, ogWifiApSsid=ogWifiApSsid, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmTime=ogAlarmTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2=ogStatus2, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRssi=ogWifiClientRssi, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemConnected=ogCellModemConnected, ogHostUserIndex=ogHostUserIndex, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckEntry=ogCheckEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmLogEntry=ogAlarmLogEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortSpeed=ogSerialPortSpeed, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemApn=ogCellModemApn, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsHumidity=ogUpsHumidity, ogWebUserName=ogWebUserName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDSR=ogSerialPortDSR, ogAlarmType=ogAlarmType, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostTable=ogHostTable, ogCellModemTable=ogCellModemTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApIndex=ogWifiApIndex, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcTable=ogRpcTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSystem=ogSystem, ogRpcEntry=ogRpcEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioTable=ogEmdDioTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckDeviceName=ogCheckDeviceName, ogCellModemCounter=ogCellModemCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckName=ogCheckName, ogSerialPortParity=ogSerialPortParity, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmLogTable=ogAlarmLogTable, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemNetwork=ogCellModemNetwork, ogWifiApCounter=ogWifiApCounter, ogUpsBatteryState=ogUpsBatteryState, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputFrequency=ogUpsOutputFrequency)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialUserTable=ogSerialUserTable, ogHostUserHostName=ogHostUserHostName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemIndex=ogCellModemIndex, ogWifiApEntry=ogWifiApEntry, ogCellModemModel=ogCellModemModel, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmInstance=ogAlarmInstance, ogCheckTable=ogCheckTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceCounter=ogHostServiceCounter, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserName=ogHostUserName, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdName=ogEmdName, ogEmdDioDirection=ogEmdDioDirection, ogWebUserTable=ogWebUserTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckResolveActions=ogCheckResolveActions, ogAlarmEventId=ogAlarmEventId, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsName=ogUpsName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogStatus2Conformance=ogStatus2Conformance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortMode=ogSerialPortMode, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcType=ogRpcType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceTable=ogHostServiceTable, ogWifiApFrequency=ogWifiApFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientAp=ogWifiApClientAp, ogCellModemRegistered=ogCellModemRegistered, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemEntry=ogCellModemEntry, ogUpsState=ogUpsState, ogAlarm=ogAlarm, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserNotification=ogWebUserNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckIndex=ogCheckIndex, ogEmdDescription=ogEmdDescription, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdIndex=ogEmdIndex, ogRpcConnectType=ogRpcConnectType, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientIndex=ogWifiClientIndex, ogHostEntry=ogHostEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcIndex=ogRpcIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemTower=ogCellModemTower)
