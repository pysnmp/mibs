...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletNotification=ogRpcOutletNotification, ogSerialUserName=ogSerialUserName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckName=ogCheckName, ogEmdDioIndex=ogEmdDioIndex, ogHostName=ogHostName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostUserIndex=ogHostUserIndex, ogHostUserEntry=ogHostUserEntry, ogRpcEntry=ogRpcEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityTable=ogEmdHumidityTable, ogFirmwareVersion=ogFirmwareVersion, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmUser=ogAlarmUser, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioCounter=ogEmdDioCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsTemperature=ogUpsTemperature, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRssi=ogWifiClientRssi, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsType=ogUpsType, ogCheckEntry=ogCheckEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortParity=ogSerialPortParity, ogCellModemRegistered=ogCellModemRegistered, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostIndex=ogHostIndex, ogUpsTable=ogUpsTable, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceNotification=ogHostServiceNotification, ogAlarmDevice=ogAlarmDevice, ogWifiClientInterface=ogWifiClientInterface, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmCheck=ogAlarmCheck, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsInputCurrent=ogUpsInputCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApClientMac=ogWifiApClientMac, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellSignalNotification=ogCellSignalNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioTable=ogEmdDioTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemTable=ogCellModemTable, ogWebUserIndex=ogWebUserIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioType=ogEmdDioType, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsEntry=ogUpsEntry, ogUpsName=ogUpsName, ogSerialUserIndex=ogSerialUserIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdName=ogEmdName, ogCellModemNetwork=ogCellModemNetwork, ogEmdEnabled=ogEmdEnabled, ogCheckIndex=ogCheckIndex, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemCounter=ogCellModemCounter, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemTower=ogCellModemTower, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialNumber=ogSerialNumber, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdIndex=ogEmdIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortIndex=ogSerialPortIndex, ogUpsIndex=ogUpsIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioState=ogEmdDioState, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletTotal=ogRpcOutletTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientTable=ogWifiApClientTable, ogEmdDescription=ogEmdDescription, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioEmd=ogEmdDioEmd, ogWebUserName=ogWebUserName, ogRpcOutletIndex=ogRpcOutletIndex, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogMibNotifications=ogMibNotifications, ogCustomNotification=ogCustomNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmInstance=ogAlarmInstance, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmName=ogAlarmName, ogWifiClientApMac=ogWifiClientApMac, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmState=ogAlarmState, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostServiceCounter=ogHostServiceCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApCounter=ogWifiApCounter, ogCellModemApn=ogCellModemApn, ogCellDataNotification=ogCellDataNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellMessageNotification=ogCellMessageNotification, ogHostServicePort=ogHostServicePort, ogUpsCounter=ogUpsCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortDSR=ogSerialPortDSR, ogEmdTable=ogEmdTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarm=ogAlarm, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletName=ogRpcOutletName, ogHostUserName=ogHostUserName, ogHostUserNotification=ogHostUserNotification, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserAddress=ogHostUserAddress, ogSerialUserTable=ogSerialUserTable, ogCheckType=ogCheckType, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemConnected=ogCellModemConnected, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmTime=ogAlarmTime, ogWifiApFrequency=ogWifiApFrequency, ogUpsNotification=ogUpsNotification, ogStatus2=ogStatus2, ogEmdDioName=ogEmdDioName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcIndex=ogRpcIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletRpc=ogRpcOutletRpc, ogHostPingNotification=ogHostPingNotification, ogSystem=ogSystem, ogHostUserHost=ogHostUserHost, ogStatus2Compliance=ogStatus2Compliance, ogStatus2Groups=ogStatus2Groups, ogUpsConnectType=ogUpsConnectType, PYSNMP_MODULE_ID=ogStatus2, ogHostTable=ogHostTable, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortCTS=ogSerialPortCTS, ogHostEntry=ogHostEntry, ogWifiApClientAp=ogWifiApClientAp, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientCounter=ogWifiClientCounter, ogCellModemModel=ogCellModemModel, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceHost=ogHostServiceHost, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryState=ogUpsBatteryState, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmType=ogAlarmType, ogNetInterfaceType=ogNetInterfaceType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmSummary=ogAlarmSummary, ogHostServiceTable=ogHostServiceTable, ogUpsDescription=ogUpsDescription, ogCellModemIMSI=ogCellModemIMSI, ogRpcInputNotification=ogRpcInputNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogHostServiceIndex=ogHostServiceIndex, ogStatus2Conformance=ogStatus2Conformance, ogWifiApSsid=ogWifiApSsid, ogHostServiceEntry=ogHostServiceEntry, ogHostUserHostName=ogHostUserHostName, ogRpcName=ogRpcName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsState=ogUpsState, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialUserLabel=ogSerialUserLabel, ogRpcCounter=ogRpcCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserTable=ogHostUserTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceStatus=ogHostServiceStatus, ogCellModemEnabled=ogCellModemEnabled, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceName=ogNetInterfaceName, ogCellModemVendor=ogCellModemVendor, ogUpsInputNotification=ogUpsInputNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioEntry=ogEmdDioEntry, ogRpcDescription=ogRpcDescription, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserPort=ogSerialUserPort, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogNetInterfaceState=ogNetInterfaceState, ogCellApnNotification=ogCellApnNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientTable=ogWifiClientTable, ogWebUserTable=ogWebUserTable, ogCheckTable=ogCheckTable, ogCellModemEntry=ogCellModemEntry, ogRpcType=ogRpcType, ogPowerSupplyName=ogPowerSupplyName, ogRpcTable=ogRpcTable, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserEntry=ogSerialUserEntry, ogWifiApTable=ogWifiApTable, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioDirection=ogEmdDioDirection, ogWebUserEntry=ogWebUserEntry, ogWifiApIndex=ogWifiApIndex, ogEmdDioNotification=ogEmdDioNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletState=ogRpcOutletState, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmEventId=ogAlarmEventId, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceType=ogHostServiceType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsOutputPower=ogUpsOutputPower)
