...
NotificationType, Counter64, Integer32, Counter32, TimeTicks, IpAddress, ModuleIdentity, Bits, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Integer32", "Counter32", "TimeTicks", "IpAddress", "ModuleIdentity", "Bits", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientTxPower=ogWifiClientTxPower, ogRpcTable=ogRpcTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmName=ogAlarmName, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostServiceStatus=ogHostServiceStatus, ogWifiApEnabled=ogWifiApEnabled, ogHostUserEntry=ogHostUserEntry, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientMode=ogWifiClientMode, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmDevice=ogAlarmDevice, ogCheckIndex=ogCheckIndex, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsIndex=ogUpsIndex, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckName=ogCheckName, ogUpsDescription=ogUpsDescription, ogEmdDioState=ogEmdDioState, ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioType=ogEmdDioType, ogRpcOutletState=ogRpcOutletState, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogSystem=ogSystem, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemTower=ogCellModemTower, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsTemperature=ogUpsTemperature, ogWebUserTable=ogWebUserTable, ogUpsBatteryState=ogUpsBatteryState, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceHost=ogHostServiceHost, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortIndex=ogSerialPortIndex, ogCheckType=ogCheckType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogHostServiceType=ogHostServiceType, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdConnectType=ogEmdConnectType, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemNetwork=ogCellModemNetwork, ogCellDataNotification=ogCellDataNotification, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioName=ogEmdDioName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsName=ogUpsName, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletName=ogRpcOutletName, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortDTR=ogSerialPortDTR, ogCellModemTable=ogCellModemTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemIMSI=ogCellModemIMSI, ogHostName=ogHostName, ogRpcConnectType=ogRpcConnectType, ogCellModemCounter=ogCellModemCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarm=ogAlarm, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsEntry=ogUpsEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserName=ogHostUserName, ogPowerSupplyName=ogPowerSupplyName, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientIndex=ogWifiClientIndex, ogAlarmUser=ogAlarmUser, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioTable=ogEmdDioTable, ogEmdDescription=ogEmdDescription, ogHostPingNotification=ogHostPingNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2=ogStatus2, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioNotification=ogEmdDioNotification, ogRpcType=ogRpcType, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserStartTime=ogHostUserStartTime, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellTowerNotification=ogCellTowerNotification, ogCellModemVendor=ogCellModemVendor, ogCellModemEntry=ogCellModemEntry, ogCellModemApn=ogCellModemApn, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialUserNotification=ogSerialUserNotification, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureTable=ogEmdTemperatureTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServicePort=ogHostServicePort, ogAlarmState=ogAlarmState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortTable=ogSerialPortTable, ogWifiApIndex=ogWifiApIndex, ogSerialPortLabel=ogSerialPortLabel, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApTxPower=ogWifiApTxPower, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemConnected=ogCellModemConnected, ogWifiClientTable=ogWifiClientTable, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserIndex=ogHostUserIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsCounter=ogUpsCounter, ogSerialUserName=ogSerialUserName, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserTable=ogSerialUserTable, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogHostServiceIndex=ogHostServiceIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemIndex=ogCellModemIndex, ogRpcCounter=ogRpcCounter, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortParity=ogSerialPortParity, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcIndex=ogRpcIndex, ogHostTable=ogHostTable, ogEmdHumidityTable=ogEmdHumidityTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsState=ogUpsState, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioDirection=ogEmdDioDirection, ogWifiApTable=ogWifiApTable, ogRpcName=ogRpcName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCustomNotification=ogCustomNotification, ogEmdDioDescription=ogEmdDioDescription, ogHostIndex=ogHostIndex, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostServiceNotification=ogHostServiceNotification, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmCheck=ogAlarmCheck, ogEmdTable=ogEmdTable, ogUpsNotification=ogUpsNotification, ogHostEntry=ogHostEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserNotification=ogWebUserNotification, ogEmdEntry=ogEmdEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioEntry=ogEmdDioEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserTable=ogHostUserTable, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialNumber=ogSerialNumber, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdName=ogEmdName, ogRpcDescription=ogRpcDescription, ogHostServiceTable=ogHostServiceTable, ogCellModemModel=ogCellModemModel, ogCurrentAlarmEntry=ogCurrentAlarmEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmType=ogAlarmType, ogWebUserIndex=ogWebUserIndex, ogHostUserNotification=ogHostUserNotification, ogStatus2Compliances=ogStatus2Compliances, ogHostUserHost=ogHostUserHost, ogAlarmEventId=ogAlarmEventId, ogEmdIndex=ogEmdIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserAddress=ogHostUserAddress, ogCheckEntry=ogCheckEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmTime=ogAlarmTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputNotification=ogUpsInputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcInputNotification=ogRpcInputNotification, ogUpsConnectType=ogUpsConnectType, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioEmd=ogEmdDioEmd, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcEntry=ogRpcEntry, ogUpsType=ogUpsType, ogHostServiceCounter=ogHostServiceCounter, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserPort=ogSerialUserPort, ogMibNotifications=ogMibNotifications, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcInputCurrent=ogRpcInputCurrent, ogFirmwareVersion=ogFirmwareVersion, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckTable=ogCheckTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserName=ogWebUserName, ogWifiApClientMac=ogWifiApClientMac, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsTable=ogUpsTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogStatus2Groups=ogStatus2Groups, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientAp=ogWifiApClientAp, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserStartTime=ogWebUserStartTime, ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceName=ogCheckDeviceName, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApEntry=ogWifiApEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter)
