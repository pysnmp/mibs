...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortIndex=ogSerialPortIndex, ogWifiApIndex=ogWifiApIndex, ogCustomNotification=ogCustomNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSystem=ogSystem, ogSerialUserName=ogSerialUserName, ogHostUserIndex=ogHostUserIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserLabel=ogSerialUserLabel, ogHostIpV6Address=ogHostIpV6Address, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServicePort=ogHostServicePort, ogHostTable=ogHostTable, ogCellApnNotification=ogCellApnNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsTemperature=ogUpsTemperature, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsName=ogUpsName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckType=ogCheckType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserStartTime=ogWebUserStartTime, ogCellModemApn=ogCellModemApn, ogAlarmName=ogAlarmName, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemTower=ogCellModemTower, ogWifiApCounter=ogWifiApCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcType=ogRpcType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryState=ogUpsBatteryState, ogWifiApFrequency=ogWifiApFrequency, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceName=ogCheckDeviceName, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsCounter=ogUpsCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmState=ogAlarmState, ogSerialPortLabel=ogSerialPortLabel, ogHostUserName=ogHostUserName, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientTable=ogWifiClientTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientRssi=ogWifiClientRssi, ogStatus2Compliances=ogStatus2Compliances, ogRpcEntry=ogRpcEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserEntry=ogSerialUserEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientTxPower=ogWifiClientTxPower, ogCellMessageNotification=ogCellMessageNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialUserPort=ogSerialUserPort, ogBasicAlarmGroup=ogBasicAlarmGroup, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckIndex=ogCheckIndex, ogHostServiceTable=ogHostServiceTable, ogHostServiceEntry=ogHostServiceEntry, ogEmdName=ogEmdName, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckTable=ogCheckTable, ogCellModemTable=ogCellModemTable, ogSerialPortCTS=ogSerialPortCTS, ogHostEntry=ogHostEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellDataNotification=ogCellDataNotification, ogRpcCounter=ogRpcCounter, ogWifiClientMode=ogWifiClientMode, ogSerialPortParity=ogSerialPortParity, ogCheckName=ogCheckName, ogCheckEntry=ogCheckEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientIndex=ogWifiClientIndex, ogAlarmCheck=ogAlarmCheck, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletName=ogRpcOutletName, ogHostServiceStatus=ogHostServiceStatus, ogEmdEnabled=ogEmdEnabled, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcTable=ogRpcTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellSignalNotification=ogCellSignalNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarm=ogAlarm, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientAp=ogWifiApClientAp, ogHostIpV4Address=ogHostIpV4Address, ogCellModemVendor=ogCellModemVendor, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioName=ogEmdDioName, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserTable=ogHostUserTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTable=ogEmdTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellTowerNotification=ogCellTowerNotification, ogUpsTable=ogUpsTable, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserAddress=ogHostUserAddress, ogUpsType=ogUpsType, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApTable=ogWifiApTable, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmName=ogCurrentAlarmName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmDevice=ogAlarmDevice, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmUser=ogAlarmUser, ogUpsEntry=ogUpsEntry, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWebUserTable=ogWebUserTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmType=ogAlarmType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmTime=ogAlarmTime, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsConnectType=ogUpsConnectType, ogRpcIndex=ogRpcIndex, ogWifiApClientTable=ogWifiApClientTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmInstance=ogAlarmInstance, ogUpsIndex=ogUpsIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioState=ogEmdDioState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceType=ogHostServiceType, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdEntry=ogEmdEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemModel=ogCellModemModel, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcDescription=ogRpcDescription, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsDescription=ogUpsDescription, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientMac=ogWifiApClientMac, ogUpsHumidity=ogUpsHumidity, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioDirection=ogEmdDioDirection, ogEmdDescription=ogEmdDescription, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityName=ogEmdHumidityName, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceState=ogNetInterfaceState, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialNumber=ogSerialNumber, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcConnectType=ogRpcConnectType, ogSerialUserNotification=ogSerialUserNotification, ogRpcName=ogRpcName, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2Groups=ogStatus2Groups, ogUpsNotification=ogUpsNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogHostUserHost=ogHostUserHost, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModemEntry=ogCellModemEntry, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientEntry=ogWifiClientEntry, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserIndex=ogWebUserIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientApMac=ogWifiClientApMac)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2=ogStatus2, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdIndex=ogEmdIndex, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcInputCurrent=ogRpcInputCurrent, ogWebUserNotification=ogWebUserNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioType=ogEmdDioType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletState=ogRpcOutletState, ogHostPingNotification=ogHostPingNotification, ogWifiApEntry=ogWifiApEntry, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortTable=ogSerialPortTable, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostName=ogHostName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortRTS=ogSerialPortRTS, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsState=ogUpsState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcInputNotification=ogRpcInputNotification, ogHostIndex=ogHostIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserNotification=ogHostUserNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemTemperature=ogCellModemTemperature, ogMibNotifications=ogMibNotifications, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserName=ogWebUserName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortMode=ogSerialPortMode, ogEmdDioCounter=ogEmdDioCounter, ogHostUserEntry=ogHostUserEntry, ogSerialUserTable=ogSerialUserTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemConnected=ogCellModemConnected, ogHostServiceCounter=ogHostServiceCounter, ogCellModemNetwork=ogCellModemNetwork, ogAlarmEventId=ogAlarmEventId, ogEmdConnectType=ogEmdConnectType, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApSsid=ogWifiApSsid, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogBasicNotificationGroup=ogBasicNotificationGroup)
