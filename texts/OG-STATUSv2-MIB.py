...
MibIdentifier, IpAddress, iso, Counter32, Counter64, Unsigned32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Gauge32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "iso", "Counter32", "Counter64", "Unsigned32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Gauge32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioType=ogEmdDioType, ogWifiApEntry=ogWifiApEntry, ogRpcOutletTable=ogRpcOutletTable, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApFrequency=ogWifiApFrequency, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcType=ogRpcType, ogSerialUserName=ogSerialUserName, ogRpcOutletRpc=ogRpcOutletRpc, ogHostTable=ogHostTable, ogFirmwareVersion=ogFirmwareVersion, ogUpsNotification=ogUpsNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioIndex=ogEmdDioIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioName=ogEmdDioName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmType=ogAlarmType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellSignalNotification=ogCellSignalNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientTable=ogWifiClientTable, ogCellApnNotification=ogCellApnNotification, ogAlarmSummary=ogAlarmSummary, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserName=ogWebUserName, ogUpsDescription=ogUpsDescription, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsEntry=ogUpsEntry, ogUpsCounter=ogUpsCounter, ogEmdDioEntry=ogEmdDioEntry, ogAlarmName=ogAlarmName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogCellDataNotification=ogCellDataNotification, ogCellModemModel=ogCellModemModel, ogNetInterfaceName=ogNetInterfaceName, ogHostServiceHost=ogHostServiceHost, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarm=ogAlarm, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsState=ogUpsState, ogWifiClientBitRate=ogWifiClientBitRate, ogHostEntry=ogHostEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientMode=ogWifiClientMode, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserTable=ogSerialUserTable, ogUpsTemperature=ogUpsTemperature, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsIndex=ogUpsIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdEnabled=ogEmdEnabled, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemApn=ogCellModemApn, ogHostServiceTable=ogHostServiceTable, ogCellModemEntry=ogCellModemEntry, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostUserName=ogHostUserName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmDevice=ogAlarmDevice, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcDescription=ogRpcDescription, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckEntry=ogCheckEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletName=ogRpcOutletName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortDSR=ogSerialPortDSR, ogEmdTable=ogEmdTable, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityValue=ogEmdHumidityValue, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioCounter=ogEmdDioCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortIndex=ogSerialPortIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmUser=ogAlarmUser, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioState=ogEmdDioState, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserIndex=ogSerialUserIndex, ogHostUserIndex=ogHostUserIndex, ogStatus2Compliances=ogStatus2Compliances, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostPingNotification=ogHostPingNotification, ogWifiApIndex=ogWifiApIndex, ogSerialPortMode=ogSerialPortMode, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDescription=ogEmdDescription, ogWifiApInterface=ogWifiApInterface, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogNetInterfaceState=ogNetInterfaceState, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceType=ogHostServiceType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioDescription=ogEmdDioDescription, ogHostUserHostName=ogHostUserHostName, ogStatus2=ogStatus2, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsName=ogUpsName, ogHostServiceNotification=ogHostServiceNotification, ogCheckType=ogCheckType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserPort=ogSerialUserPort, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckTable=ogCheckTable, ogCellModemIndex=ogCellModemIndex, ogWebUserNotification=ogWebUserNotification, ogAlarmInstance=ogAlarmInstance, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmTime=ogAlarmTime, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApEnabled=ogWifiApEnabled, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostUserNotification=ogHostUserNotification, ogHostIndex=ogHostIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdEntry=ogEmdEntry, ogHostUserTable=ogHostUserTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialNumber=ogSerialNumber, ogEmdDioTable=ogEmdDioTable, ogAlarmCheck=ogAlarmCheck, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceEntry=ogHostServiceEntry, ogWebUserEntry=ogWebUserEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletState=ogRpcOutletState, ogCellModemTable=ogCellModemTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcEntry=ogRpcEntry, ogRpcTable=ogRpcTable, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortRTS=ogSerialPortRTS, ogWebUserIndex=ogWebUserIndex, ogStatus2Groups=ogStatus2Groups, ogAlarmState=ogAlarmState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdIndex=ogEmdIndex, ogMibNotifications=ogMibNotifications, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsInputNotification=ogUpsInputNotification, ogCheckName=ogCheckName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryState=ogUpsBatteryState, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemCounter=ogCellModemCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserStartTime=ogHostUserStartTime, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcCounter=ogRpcCounter, ogRpcName=ogRpcName, ogWifiApTable=ogWifiApTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortParity=ogSerialPortParity, ogCheckIndex=ogCheckIndex, ogHostName=ogHostName, ogHostUserEntry=ogHostUserEntry, ogHostUserHost=ogHostUserHost, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientIndex=ogWifiClientIndex, ogEmdName=ogEmdName, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryCharge=ogUpsBatteryCharge)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTable=ogSerialPortTable, ogSerialUserLabel=ogSerialUserLabel, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcConnectType=ogRpcConnectType, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceType=ogNetInterfaceType, ogStatus2Compliance=ogStatus2Compliance, ogHostServicePort=ogHostServicePort, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientRssi=ogWifiClientRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCustomNotification=ogCustomNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceStatus=ogHostServiceStatus, ogUpsType=ogUpsType, ogWifiClientEntry=ogWifiClientEntry, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogStatus2Conformance=ogStatus2Conformance, ogWebUserTable=ogWebUserTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSystem=ogSystem, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserEntry=ogSerialUserEntry, ogRpcIndex=ogRpcIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsHumidity=ogUpsHumidity, ogWifiClientInterface=ogWifiClientInterface, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceCounter=ogHostServiceCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemVendor=ogCellModemVendor, ogUpsTable=ogUpsTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemTower=ogCellModemTower, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityNotification=ogEmdHumidityNotification)
