...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsCounter=ogUpsCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemCounter=ogCellModemCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientEssid=ogWifiClientEssid, ogHostName=ogHostName, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortEntry=ogSerialPortEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogSystem=ogSystem, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsInputNotification=ogUpsInputNotification, ogRpcDescription=ogRpcDescription, ogCellModemIndex=ogCellModemIndex, ogAlarmName=ogAlarmName, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogNetInterfaceState=ogNetInterfaceState, ogUpsName=ogUpsName, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioState=ogEmdDioState, ogHostServiceType=ogHostServiceType, ogSerialPortMode=ogSerialPortMode, ogHostUserNotification=ogHostUserNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServicePort=ogHostServicePort, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemVendor=ogCellModemVendor, ogAlarmLogTable=ogAlarmLogTable, ogWifiApTable=ogWifiApTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsTable=ogUpsTable, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientMode=ogWifiClientMode, ogWifiClientTable=ogWifiClientTable, ogCheckResolveActions=ogCheckResolveActions, ogHostTable=ogHostTable, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortStopBits=ogSerialPortStopBits, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletName=ogRpcOutletName, ogHostEntry=ogHostEntry, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsConnectType=ogUpsConnectType, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckTable=ogCheckTable, ogSerialPortTable=ogSerialPortTable, ogRpcEntry=ogRpcEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceIndex=ogHostServiceIndex, ogStatus2Groups=ogStatus2Groups, ogSerialUserName=ogSerialUserName, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceTable=ogHostServiceTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellTowerNotification=ogCellTowerNotification, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserEntry=ogSerialUserEntry, ogAlarmTime=ogAlarmTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyName=ogPowerSupplyName, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcInputNotification=ogRpcInputNotification, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortDTR=ogSerialPortDTR, ogAlarmUser=ogAlarmUser, ogWifiApTxPower=ogWifiApTxPower, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsType=ogUpsType, ogCellModemTable=ogCellModemTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioDirection=ogEmdDioDirection, ogHostPingNotification=ogHostPingNotification, ogWebUserName=ogWebUserName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdEnabled=ogEmdEnabled, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdConnectType=ogEmdConnectType, ogSerialUserNotification=ogSerialUserNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogStatus2=ogStatus2, ogWifiApSsid=ogWifiApSsid, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientRssi=ogWifiClientRssi, ogHostServiceStatus=ogHostServiceStatus, ogSerialUserPort=ogSerialUserPort, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialNumber=ogSerialNumber, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientEntry=ogWifiClientEntry, ogAlarmInstance=ogAlarmInstance, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientMac=ogWifiApClientMac, ogWebUserTable=ogWebUserTable, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsNotification=ogUpsNotification, ogCellModemModel=ogCellModemModel, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModem3gRssi=ogCellModem3gRssi, ogCustomNotification=ogCustomNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcInputFrequency=ogRpcInputFrequency, ogHostIpV4Address=ogHostIpV4Address, ogAlarmEventId=ogAlarmEventId, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdIndex=ogEmdIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckEntry=ogCheckEntry, ogHostUserName=ogHostUserName, ogWebUserIndex=ogWebUserIndex, ogWebUserEntry=ogWebUserEntry, ogWebUserNotification=ogWebUserNotification, ogEmdDioType=ogEmdDioType, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarm=ogAlarm, ogAlarmState=ogAlarmState, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemEntry=ogCellModemEntry, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortParity=ogSerialPortParity, ogCellModemTemperature=ogCellModemTemperature, ogSerialUserTable=ogSerialUserTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdName=ogEmdName, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcIndex=ogRpcIndex, ogRpcType=ogRpcType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckName=ogCheckName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioIndex=ogEmdDioIndex, ogUpsTemperature=ogUpsTemperature, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemApn=ogCellModemApn, ogAlarmCheck=ogAlarmCheck, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsHumidity=ogUpsHumidity, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserHost=ogHostUserHost, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDescription=ogEmdDescription, ogCellDataNotification=ogCellDataNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioCounter=ogEmdDioCounter, ogWebUserSourcePort=ogWebUserSourcePort, PYSNMP_MODULE_ID=ogStatus2, ogUpsState=ogUpsState, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsIndex=ogUpsIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortRTS=ogSerialPortRTS, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityName=ogEmdHumidityName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserTable=ogHostUserTable, ogHostIndex=ogHostIndex, ogWebUserStartTime=ogWebUserStartTime, ogHostUserIndex=ogHostUserIndex, ogRpcTable=ogRpcTable, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApInterface=ogWifiApInterface, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceType=ogNetInterfaceType, ogMibNotifications=ogMibNotifications, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioEmd=ogEmdDioEmd, ogDialPoolHealthNotification=ogDialPoolHealthNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsDescription=ogUpsDescription, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioName=ogEmdDioName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmType=ogAlarmType, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckIndex=ogCheckIndex, ogRpcConnectType=ogRpcConnectType, ogEmdDioNotification=ogEmdDioNotification, ogCellModemTower=ogCellModemTower, ogUpsEntry=ogUpsEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApEntry=ogWifiApEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioTable=ogEmdDioTable, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsLogEnabled=ogUpsLogEnabled, ogCellApnNotification=ogCellApnNotification, ogWifiApCounter=ogWifiApCounter, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcName=ogRpcName, ogHostUserEntry=ogHostUserEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmDevice=ogAlarmDevice, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyIndex=ogPowerSupplyIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTable=ogEmdTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckType=ogCheckType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServiceHost=ogHostServiceHost, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioDescription=ogEmdDioDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTable=ogWifiApClientTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckDeviceName=ogCheckDeviceName, ogRpcCounter=ogRpcCounter)
