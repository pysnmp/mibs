...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioNotification=ogEmdDioNotification, ogAlarmCheck=ogAlarmCheck, ogRpcEntry=ogRpcEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogStatus2Compliances=ogStatus2Compliances, ogStatus2Groups=ogStatus2Groups, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioIndex=ogEmdDioIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsTemperature=ogUpsTemperature, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemTable=ogCellModemTable, ogUpsCounter=ogUpsCounter, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmDevice=ogAlarmDevice, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemCounter=ogCellModemCounter, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortCTS=ogSerialPortCTS, ogNetInterfaceType=ogNetInterfaceType, ogUpsConnectType=ogUpsConnectType, ogSerialUserName=ogSerialUserName, ogUpsType=ogUpsType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogStatus2Conformance=ogStatus2Conformance, ogHostUserAddress=ogHostUserAddress, ogUpsDescription=ogUpsDescription, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryState=ogUpsBatteryState, ogWifiApCounter=ogWifiApCounter, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckName=ogCheckName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmType=ogAlarmType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsHumidity=ogUpsHumidity, ogAlarmEventId=ogAlarmEventId, ogEmdName=ogEmdName, ogEmdDescription=ogEmdDescription, ogAlarmSummary=ogAlarmSummary, ogRpcCounter=ogRpcCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientRssi=ogWifiApClientRssi, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsName=ogUpsName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortParity=ogSerialPortParity, ogEmdDioName=ogEmdDioName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyName=ogPowerSupplyName, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceEntry=ogHostServiceEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApSsid=ogWifiApSsid, ogHostServiceType=ogHostServiceType, ogWifiClientEntry=ogWifiClientEntry, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsState=ogUpsState, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemEntry=ogCellModemEntry, ogHostTable=ogHostTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientApMac=ogWifiClientApMac, ogWebUserEntry=ogWebUserEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletTable=ogRpcOutletTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserEntry=ogHostUserEntry, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletName=ogRpcOutletName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortIndex=ogSerialPortIndex, ogCellTowerNotification=ogCellTowerNotification, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdEnabled=ogEmdEnabled, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcType=ogRpcType, ogEmdConnectType=ogEmdConnectType, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioState=ogEmdDioState, ogCellSignalNotification=ogCellSignalNotification, ogRpcTable=ogRpcTable, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialUserPort=ogSerialUserPort, ogCellModemApn=ogCellModemApn, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogStatus2=ogStatus2, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceName=ogNetInterfaceName, ogCellModemEnabled=ogCellModemEnabled, ogHostUserHost=ogHostUserHost, ogHostServiceHost=ogHostServiceHost, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemTower=ogCellModemTower, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostEntry=ogHostEntry, ogCustomNotification=ogCustomNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientAp=ogWifiApClientAp, ogEmdTable=ogEmdTable, ogCellDataNotification=ogCellDataNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcName=ogRpcName, ogCheckTable=ogCheckTable, ogRpcOutletEntry=ogRpcOutletEntry, ogWebUserTable=ogWebUserTable, ogEmdEntry=ogEmdEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcConnectType=ogRpcConnectType, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemConnected=ogCellModemConnected, ogCellModemNetwork=ogCellModemNetwork, ogHostIndex=ogHostIndex, ogAlarmInstance=ogAlarmInstance, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellApnNotification=ogCellApnNotification, ogSystem=ogSystem, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmName=ogAlarmName, ogAlarmState=ogAlarmState, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemIMSI=ogCellModemIMSI, ogUpsTable=ogUpsTable, ogWebUserStartTime=ogWebUserStartTime, ogHostName=ogHostName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserNotification=ogSerialUserNotification, ogHostUserTable=ogHostUserTable, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserTable=ogSerialUserTable, ogWebUserIndex=ogWebUserIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioCounter=ogEmdDioCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialNumber=ogSerialNumber, ogEmdDioTable=ogEmdDioTable, ogSerialPortDSR=ogSerialPortDSR, ogHostUserStartTime=ogHostUserStartTime, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsNotification=ogUpsNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckIndex=ogCheckIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmUser=ogAlarmUser, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioType=ogEmdDioType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsEntry=ogUpsEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdIndex=ogEmdIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApInterface=ogWifiApInterface, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientMode=ogWifiClientMode, ogAlarm=ogAlarm, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletRpc=ogRpcOutletRpc, ogHostIpV6Address=ogHostIpV6Address)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceTable=ogHostServiceTable, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortMode=ogSerialPortMode, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceCounter=ogHostServiceCounter, ogRpcDescription=ogRpcDescription, ogWifiClientRssi=ogWifiClientRssi, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApTxPower=ogWifiApTxPower, ogHostUserHostName=ogHostUserHostName, ogHostUserName=ogHostUserName, ogUpsOutputPower=ogUpsOutputPower, ogHostServicePort=ogHostServicePort, ogCellModemVendor=ogCellModemVendor, ogSerialPortDTR=ogSerialPortDTR, ogCheckType=ogCheckType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioDescription=ogEmdDioDescription, ogWifiApFrequency=ogWifiApFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogStatus2Compliance=ogStatus2Compliance, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWebUserNotification=ogWebUserNotification, ogCellModemModel=ogCellModemModel, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortDCD=ogSerialPortDCD, ogHostPingNotification=ogHostPingNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogNetInterfaceState=ogNetInterfaceState, ogAlarmTime=ogAlarmTime, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioDirection=ogEmdDioDirection, ogWifiApTable=ogWifiApTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserName=ogWebUserName, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcIndex=ogRpcIndex, ogWifiClientTable=ogWifiClientTable, ogUpsIndex=ogUpsIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortLabel=ogSerialPortLabel, ogMibNotifications=ogMibNotifications, ogCheckEntry=ogCheckEntry)
