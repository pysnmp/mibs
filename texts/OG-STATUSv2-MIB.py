...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemTemperature=ogCellModemTemperature, ogAlarmTriggerValue=ogAlarmTriggerValue, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemTower=ogCellModemTower, ogRpcDescription=ogRpcDescription, ogSerialPortDTR=ogSerialPortDTR, ogUpsCounter=ogUpsCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientRssi=ogWifiApClientRssi, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRssi=ogWifiClientRssi, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsName=ogUpsName, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceName=ogNetInterfaceName, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmState=ogAlarmState, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarm=ogAlarm, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCustomNotification=ogCustomNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemApn=ogCellModemApn, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortTable=ogSerialPortTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemIndex=ogCellModemIndex, ogRpcType=ogRpcType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogWebUserName=ogWebUserName, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellApnNotification=ogCellApnNotification, ogWifiApClientTable=ogWifiApClientTable, ogEmdIndex=ogEmdIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApTable=ogWifiApTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcTable=ogRpcTable, ogWifiApFrequency=ogWifiApFrequency, ogUpsNotification=ogUpsNotification, ogWifiApEntry=ogWifiApEntry, ogEmdDioTable=ogEmdDioTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialUserPort=ogSerialUserPort, ogRpcOutletTable=ogRpcOutletTable, ogUpsTemperature=ogUpsTemperature, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialUserTable=ogSerialUserTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserTable=ogHostUserTable, ogHostServiceHost=ogHostServiceHost, ogEmdDioType=ogEmdDioType, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmUser=ogAlarmUser, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientTable=ogWifiClientTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioDescription=ogEmdDioDescription, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcConnectType=ogRpcConnectType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmName=ogAlarmName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcIndex=ogRpcIndex, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientEntry=ogWifiClientEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdName=ogEmdName, ogCellModemVendor=ogCellModemVendor, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellDataNotification=ogCellDataNotification, ogEmdDioCounter=ogEmdDioCounter, ogCheckName=ogCheckName, ogSerialPortParity=ogSerialPortParity, ogHostPingNotification=ogHostPingNotification, ogRpcName=ogRpcName, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckTable=ogCheckTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmSummary=ogAlarmSummary, ogHostServiceTable=ogHostServiceTable, ogHostServiceCounter=ogHostServiceCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortIndex=ogSerialPortIndex, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortDSR=ogSerialPortDSR, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioEmd=ogEmdDioEmd, ogHostName=ogHostName, ogEmdDioName=ogEmdDioName, ogPowerSupplyName=ogPowerSupplyName, ogAlarmTime=ogAlarmTime, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmCheck=ogAlarmCheck, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceNotification=ogHostServiceNotification, ogUpsTable=ogUpsTable, ogCheckIndex=ogCheckIndex, ogEmdConnectType=ogEmdConnectType, ogUpsState=ogUpsState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserTable=ogWebUserTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmType=ogAlarmType, ogHostUserAddress=ogHostUserAddress, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostTable=ogHostTable, ogSerialNumber=ogSerialNumber, ogFirmwareVersion=ogFirmwareVersion, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserName=ogHostUserName, ogCheckEntry=ogCheckEntry, ogUpsHumidity=ogUpsHumidity, ogSystem=ogSystem, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserNotification=ogWebUserNotification, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputNotification=ogUpsInputNotification, ogHostUserIndex=ogHostUserIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserLabel=ogSerialUserLabel, ogHostUserHost=ogHostUserHost, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostIndex=ogHostIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserEntry=ogHostUserEntry, ogUpsEntry=ogUpsEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmType=ogCurrentAlarmType, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApInterface=ogWifiApInterface, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostServicePort=ogHostServicePort, ogCheckDeviceName=ogCheckDeviceName, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsIndex=ogUpsIndex, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsType=ogUpsType, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsConnectType=ogUpsConnectType, ogHostUserStartTime=ogHostUserStartTime, ogHostUserHostName=ogHostUserHostName, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientIndex=ogWifiClientIndex, ogEmdDescription=ogEmdDescription, ogCellModemConnected=ogCellModemConnected, ogAlarmDevice=ogAlarmDevice, ogRpcEntry=ogRpcEntry, ogWebUserEntry=ogWebUserEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckType=ogCheckType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdEnabled=ogEmdEnabled, ogWifiClientCounter=ogWifiClientCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemModel=ogCellModemModel, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2Groups=ogStatus2Groups, ogWifiClientFrequency=ogWifiClientFrequency, ogHostServiceStatus=ogHostServiceStatus, ogRpcCounter=ogRpcCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckResolveActions=ogCheckResolveActions, ogWebUserIndex=ogWebUserIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostIpV6Address=ogHostIpV6Address, ogRpcInputFrequency=ogRpcInputFrequency)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletState=ogRpcOutletState, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortEntry=ogSerialPortEntry, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientEntry=ogWifiApClientEntry, PYSNMP_MODULE_ID=ogStatus2, ogMibNotifications=ogMibNotifications, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceType=ogHostServiceType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserNotification=ogHostUserNotification, ogUpsDescription=ogUpsDescription, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemTable=ogCellModemTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientInterface=ogWifiClientInterface, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmName=ogCurrentAlarmName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserName=ogSerialUserName, ogCellModemEntry=ogCellModemEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostEntry=ogHostEntry, ogCellModemNetwork=ogCellModemNetwork, ogWifiApIndex=ogWifiApIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdEntry=ogEmdEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApCounter=ogWifiApCounter, ogEmdDioState=ogEmdDioState, ogStatus2=ogStatus2, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortMode=ogSerialPortMode, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApTxPower=ogWifiApTxPower, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputPower=ogUpsOutputPower, ogEmdTable=ogEmdTable, ogRpcOutletLoad=ogRpcOutletLoad)
