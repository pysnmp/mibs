...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogNetInterfaceType=ogNetInterfaceType, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemTower=ogCellModemTower, ogCheckEntry=ogCheckEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceHost=ogHostServiceHost, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostUserStartTime=ogHostUserStartTime, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsState=ogUpsState, ogAlarmSummary=ogAlarmSummary, ogSerialPortCTS=ogSerialPortCTS, ogUpsName=ogUpsName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserName=ogSerialUserName, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsInputNotification=ogUpsInputNotification, ogCellModemCounter=ogCellModemCounter, ogWifiClientCounter=ogWifiClientCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientTable=ogWifiApClientTable, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortTable=ogSerialPortTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryState=ogUpsBatteryState, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceCounter=ogHostServiceCounter, ogWifiApIndex=ogWifiApIndex, ogEmdDioCounter=ogEmdDioCounter, ogCellModemApn=ogCellModemApn, ogWebUserStartTime=ogWebUserStartTime, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortMode=ogSerialPortMode, ogCellModemNetwork=ogCellModemNetwork, ogHostServiceTable=ogHostServiceTable, ogCustomNotification=ogCustomNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsHumidity=ogUpsHumidity, ogWifiApSsid=ogWifiApSsid, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceType=ogHostServiceType, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostPingNotification=ogHostPingNotification, ogUpsIndex=ogUpsIndex, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdName=ogEmdName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioIndex=ogEmdDioIndex, ogHostTable=ogHostTable, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckType=ogCheckType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemIndex=ogCellModemIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSystem=ogSystem, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostServiceIndex=ogHostServiceIndex, ogCellModemVendor=ogCellModemVendor, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserNotification=ogSerialUserNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdIndex=ogEmdIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckDeviceName=ogCheckDeviceName, ogHostUserName=ogHostUserName, ogEmdDioDirection=ogEmdDioDirection, ogRpcIndex=ogRpcIndex, ogAlarmUser=ogAlarmUser, ogWifiApEntry=ogWifiApEntry, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientMode=ogWifiClientMode, ogWifiApCounter=ogWifiApCounter, ogEmdDioType=ogEmdDioType, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputPower=ogUpsOutputPower, ogWifiApEnabled=ogWifiApEnabled, ogWifiApInterface=ogWifiApInterface, ogUpsTable=ogUpsTable, ogSerialPortDTR=ogSerialPortDTR, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmTime=ogAlarmTime, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogHostUserAddress=ogHostUserAddress, ogCheckTable=ogCheckTable, ogSerialPortRTS=ogSerialPortRTS, ogStatus2Conformance=ogStatus2Conformance, ogAlarmState=ogAlarmState, ogWifiClientIndex=ogWifiClientIndex, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioEntry=ogEmdDioEntry, ogRpcName=ogRpcName, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioTable=ogEmdDioTable, ogSerialPortEntry=ogSerialPortEntry, ogHostUserNotification=ogHostUserNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsEntry=ogUpsEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletState=ogRpcOutletState, ogEmdEnabled=ogEmdEnabled, ogEmdTable=ogEmdTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDescription=ogEmdDescription, ogAlarmEventId=ogAlarmEventId, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemTable=ogCellModemTable, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcType=ogRpcType, ogSerialPortDSR=ogSerialPortDSR, ogWebUserName=ogWebUserName, ogCellModemEntry=ogCellModemEntry, ogHostUserHostName=ogHostUserHostName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmType=ogAlarmType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientEssid=ogWifiClientEssid, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceState=ogNetInterfaceState, ogWebUserTable=ogWebUserTable, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdConnectType=ogEmdConnectType, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortDCD=ogSerialPortDCD, ogUpsCounter=ogUpsCounter, ogCheckIndex=ogCheckIndex, ogWifiApTable=ogWifiApTable, ogSerialPortParity=ogSerialPortParity, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcTable=ogRpcTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcEntry=ogRpcEntry, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserEntry=ogHostUserEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserTable=ogSerialUserTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserIndex=ogHostUserIndex, PYSNMP_MODULE_ID=ogStatus2, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserHost=ogHostUserHost, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortLabel=ogSerialPortLabel, ogRpcInputNotification=ogRpcInputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsType=ogUpsType, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmName=ogAlarmName, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdDioName=ogEmdDioName, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdEntry=ogEmdEntry, ogHostName=ogHostName, ogFirmwareVersion=ogFirmwareVersion, ogMibNotifications=ogMibNotifications, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmName=ogCurrentAlarmName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckName=ogCheckName, ogCellDataNotification=ogCellDataNotification, ogAlarmDevice=ogAlarmDevice, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServicePort=ogHostServicePort, ogWifiApTxPower=ogWifiApTxPower, ogCellModemRegistered=ogCellModemRegistered, ogHostIndex=ogHostIndex, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioDescription=ogEmdDioDescription, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmInstance=ogAlarmInstance, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarm=ogAlarm, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcDescription=ogRpcDescription, ogStatus2Groups=ogStatus2Groups, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserTable=ogHostUserTable, ogRpcOutletName=ogRpcOutletName, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellApnNotification=ogCellApnNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostServiceNotification=ogHostServiceNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientApMac=ogWifiClientApMac, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientTable=ogWifiClientTable, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemModel=ogCellModemModel, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientMac=ogWifiApClientMac, ogCellModemEnabled=ogCellModemEnabled, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioState=ogEmdDioState, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioEmd=ogEmdDioEmd, ogSerialNumber=ogSerialNumber, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientRssi=ogWifiClientRssi, ogStatus2=ogStatus2, ogSerialPortIndex=ogSerialPortIndex, ogUpsDescription=ogUpsDescription, ogWebUserIndex=ogWebUserIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityName=ogEmdHumidityName, ogHostEntry=ogHostEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcCounter=ogRpcCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostServiceEntry=ogHostServiceEntry, ogUpsNotification=ogUpsNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCliUserSessionNotification=ogCliUserSessionNotification)
