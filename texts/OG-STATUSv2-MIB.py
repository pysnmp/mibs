...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdEntry=ogEmdEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogHostName=ogHostName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckName=ogCheckName, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemApn=ogCellModemApn, ogWifiApTable=ogWifiApTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientEnabled=ogWifiClientEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsCounter=ogUpsCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemVendor=ogCellModemVendor, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemConnected=ogCellModemConnected, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientMac=ogWifiApClientMac, ogSerialNumber=ogSerialNumber, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserLabel=ogSerialUserLabel, ogWebUserIndex=ogWebUserIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostServiceNotification=ogHostServiceNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmState=ogAlarmState, ogHostUserEntry=ogHostUserEntry, ogAlarmDevice=ogAlarmDevice, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCustomNotification=ogCustomNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckTable=ogCheckTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmEventId=ogAlarmEventId, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogNetInterfaceState=ogNetInterfaceState, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemRegistered=ogCellModemRegistered, ogCellModemTable=ogCellModemTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsTemperature=ogUpsTemperature, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNotification=ogUpsInputNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletName=ogRpcOutletName, ogCheckIndex=ogCheckIndex, ogHostServiceType=ogHostServiceType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmSummary=ogAlarmSummary, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDTR=ogSerialPortDTR, ogCellDataNotification=ogCellDataNotification, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserName=ogHostUserName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckDeviceName=ogCheckDeviceName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioDescription=ogEmdDioDescription, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientTable=ogWifiApClientTable, ogEmdConnectType=ogEmdConnectType, ogWifiApTxPower=ogWifiApTxPower, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortDataBits=ogSerialPortDataBits, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPatternNotification=ogSerialPatternNotification, ogStatus2=ogStatus2, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioName=ogEmdDioName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceStatus=ogHostServiceStatus, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemTower=ogCellModemTower, ogUpsState=ogUpsState, ogWifiClientTable=ogWifiClientTable, ogUpsDescription=ogUpsDescription, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialUserNotification=ogSerialUserNotification, ogAlarmUser=ogAlarmUser, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserName=ogSerialUserName, ogCellModemCounter=ogCellModemCounter, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceEntry=ogHostServiceEntry, ogMibNotifications=ogMibNotifications, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientIndex=ogWifiClientIndex, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioState=ogEmdDioState, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckResolveActions=ogCheckResolveActions, ogUpsEntry=ogUpsEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckEntry=ogCheckEntry, ogRpcDescription=ogRpcDescription, ogHostServicePort=ogHostServicePort, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarm=ogAlarm, ogSerialPortRTS=ogSerialPortRTS, ogRpcEntry=ogRpcEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserTable=ogSerialUserTable, ogUpsHumidity=ogUpsHumidity, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserName=ogWebUserName, ogStatus2Conformance=ogStatus2Conformance, ogRpcIndex=ogRpcIndex, ogHostIndex=ogHostIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsConnectType=ogUpsConnectType, ogCellModemModel=ogCellModemModel, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdEnabled=ogEmdEnabled, ogHostEntry=ogHostEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcType=ogRpcType, ogRpcTable=ogRpcTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmCheck=ogAlarmCheck, ogCellMessageNotification=ogCellMessageNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogNetInterfaceName=ogNetInterfaceName, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsInputCurrent=ogUpsInputCurrent, ogSystem=ogSystem, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortMode=ogSerialPortMode, ogWifiClientApMac=ogWifiClientApMac, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioDirection=ogEmdDioDirection, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcCounter=ogRpcCounter, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientInterface=ogWifiClientInterface, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDescription=ogEmdDescription, ogCellModemTemperature=ogCellModemTemperature, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmType=ogAlarmType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientEntry=ogWifiClientEntry, ogCellSignalNotification=ogCellSignalNotification, ogNetInterfaceType=ogNetInterfaceType, ogHostUserAddress=ogHostUserAddress, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioCounter=ogEmdDioCounter, ogCellModemIndex=ogCellModemIndex, ogWifiClientBitRate=ogWifiClientBitRate)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApCounter=ogWifiApCounter, ogSerialPortDCD=ogSerialPortDCD, ogAlarmInstance=ogAlarmInstance, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientMode=ogWifiClientMode, ogUpsNotification=ogUpsNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogStatus2Groups=ogStatus2Groups, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityCounter=ogEmdHumidityCounter, PYSNMP_MODULE_ID=ogStatus2, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialUserEntry=ogSerialUserEntry, ogWifiApIndex=ogWifiApIndex, ogUpsType=ogUpsType, ogEmdHumidityName=ogEmdHumidityName, ogEmdDioType=ogEmdDioType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostIpV6Address=ogHostIpV6Address, ogHostUserHostName=ogHostUserHostName, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdIndex=ogEmdIndex, ogAlarmName=ogAlarmName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdName=ogEmdName, ogSerialPortParity=ogSerialPortParity, ogAlarmTime=ogAlarmTime, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsIndex=ogUpsIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApSsid=ogWifiApSsid, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellApnNotification=ogCellApnNotification, ogHostTable=ogHostTable, ogHostUserTable=ogHostUserTable, ogSerialUserIndex=ogSerialUserIndex, ogRpcName=ogRpcName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsName=ogUpsName, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemEntry=ogCellModemEntry, ogHostUserStartTime=ogHostUserStartTime, ogUpsTable=ogUpsTable, ogRpcOutletState=ogRpcOutletState, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckType=ogCheckType, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserHost=ogHostUserHost, ogWebUserNotification=ogWebUserNotification, ogWebUserTable=ogWebUserTable, ogEmdTable=ogEmdTable, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApEnabled=ogWifiApEnabled, ogWebUserEntry=ogWebUserEntry, ogBasicStatusGroup=ogBasicStatusGroup)
