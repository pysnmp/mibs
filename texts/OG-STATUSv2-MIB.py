...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcType=ogRpcType, ogAlarmInstance=ogAlarmInstance, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemTower=ogCellModemTower, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletState=ogRpcOutletState, ogCheckDeviceName=ogCheckDeviceName, ogHostUserName=ogHostUserName, ogAlarmCheck=ogAlarmCheck, ogWebUserIndex=ogWebUserIndex, ogStatus2=ogStatus2, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceTable=ogHostServiceTable, ogHostUserAddress=ogHostUserAddress, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsNotification=ogUpsNotification, ogCellModemConnected=ogCellModemConnected, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemCounter=ogCellModemCounter, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogMibNotifications=ogMibNotifications, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletTable=ogRpcOutletTable, ogCustomNotification=ogCustomNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmEventId=ogAlarmEventId, ogHostServicePort=ogHostServicePort, ogEmdHumidityName=ogEmdHumidityName, ogCellModemApn=ogCellModemApn, ogRpcTable=ogRpcTable, ogEmdLogEnabled=ogEmdLogEnabled, ogHostUserHost=ogHostUserHost, ogCellDataNotification=ogCellDataNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortTable=ogSerialPortTable, ogHostUserEntry=ogHostUserEntry, ogSerialUserLabel=ogSerialUserLabel, ogWifiApCounter=ogWifiApCounter, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioIndex=ogEmdDioIndex, ogCellModemVendor=ogCellModemVendor, ogRpcIndex=ogRpcIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioDirection=ogEmdDioDirection, ogRpcCounter=ogRpcCounter, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApIndex=ogWifiApIndex, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientMode=ogWifiClientMode, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostServiceHost=ogHostServiceHost, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceType=ogHostServiceType, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserHostName=ogHostUserHostName, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyName=ogPowerSupplyName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsCounter=ogUpsCounter, ogHostUserTable=ogHostUserTable, ogWebUserEntry=ogWebUserEntry, ogCheckIndex=ogCheckIndex, ogEmdConnectType=ogEmdConnectType, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryState=ogUpsBatteryState, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcName=ogRpcName, ogCheckTable=ogCheckTable, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletCurrent=ogRpcOutletCurrent, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogFirmwareVersion=ogFirmwareVersion, ogUpsTemperature=ogUpsTemperature, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcConnectType=ogRpcConnectType, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceIndex=ogHostServiceIndex, ogSerialUserPort=ogSerialUserPort, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApTxPower=ogWifiApTxPower, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApEnabled=ogWifiApEnabled, ogRpcInputNotification=ogRpcInputNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRssi=ogWifiClientRssi, ogUpsIndex=ogUpsIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsHumidity=ogUpsHumidity, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserName=ogSerialUserName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApTable=ogWifiApTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioType=ogEmdDioType, ogSerialPortLabel=ogSerialPortLabel, ogHostIndex=ogHostIndex, ogWebUserTable=ogWebUserTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioName=ogEmdDioName, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientEntry=ogWifiClientEntry, ogAlarmSummary=ogAlarmSummary, ogCheckType=ogCheckType, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDescription=ogEmdDescription, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsEntry=ogUpsEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortParity=ogSerialPortParity, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmTime=ogAlarmTime, ogCellModemTable=ogCellModemTable, ogWifiApEntry=ogWifiApEntry, ogCellModemEntry=ogCellModemEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmType=ogAlarmType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceRef=ogCheckDeviceRef, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioDescription=ogEmdDioDescription, ogStatus2Conformance=ogStatus2Conformance, ogCellModemEnabled=ogCellModemEnabled, ogEmdTable=ogEmdTable, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemIndex=ogCellModemIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostPingNotification=ogHostPingNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientTable=ogWifiApClientTable, ogUpsState=ogUpsState, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientApMac=ogWifiClientApMac, ogHostUserIndex=ogHostUserIndex, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcEntry=ogRpcEntry, ogWifiClientIndex=ogWifiClientIndex, ogRpcDescription=ogRpcDescription, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdEntry=ogEmdEntry, ogHostTable=ogHostTable, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdName=ogEmdName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmName=ogAlarmName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceCounter=ogHostServiceCounter, ogUpsName=ogUpsName, ogUpsLogEnabled=ogUpsLogEnabled)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceName=ogNetInterfaceName, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmState=ogAlarmState, ogUpsConnectType=ogUpsConnectType, ogHostUserNotification=ogHostUserNotification, ogUpsType=ogUpsType, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckEntry=ogCheckEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialNumber=ogSerialNumber, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemModel=ogCellModemModel, ogStatus2Groups=ogStatus2Groups, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletName=ogRpcOutletName, ogUpsDescription=ogUpsDescription, ogCellModemIMSI=ogCellModemIMSI, ogUpsTable=ogUpsTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserNotification=ogSerialUserNotification, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApFrequency=ogWifiApFrequency, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdIndex=ogEmdIndex, ogAlarmLogTable=ogAlarmLogTable, ogAlarmUser=ogAlarmUser, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletEntry=ogRpcOutletEntry, ogStatus2Compliances=ogStatus2Compliances, ogAlarm=ogAlarm, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserName=ogWebUserName, ogRpcOutletIndex=ogRpcOutletIndex, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckName=ogCheckName, ogHostEntry=ogHostEntry, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostName=ogHostName, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientCounter=ogWifiClientCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortMode=ogSerialPortMode, ogSystem=ogSystem, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioState=ogEmdDioState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent)
