...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserName=ogSerialUserName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletName=ogRpcOutletName, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckType=ogCheckType, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserName=ogHostUserName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioDescription=ogEmdDioDescription, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostIndex=ogHostIndex, ogWifiApTable=ogWifiApTable, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserPort=ogSerialUserPort, ogCellModemApn=ogCellModemApn, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyName=ogPowerSupplyName, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserEntry=ogHostUserEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApEntry=ogWifiApEntry, ogSerialUserEntry=ogSerialUserEntry, ogRpcCounter=ogRpcCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserHostName=ogHostUserHostName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserTable=ogHostUserTable, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmInstance=ogAlarmInstance, ogEmdEnabled=ogEmdEnabled, ogSerialPortLogLevel=ogSerialPortLogLevel, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserStartTime=ogWebUserStartTime, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2Compliance=ogStatus2Compliance, ogCheckDeviceName=ogCheckDeviceName, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemVendor=ogCellModemVendor, ogWifiClientEssid=ogWifiClientEssid, ogEmdTable=ogEmdTable, ogSerialPortMode=ogSerialPortMode, ogEmdDioCounter=ogEmdDioCounter, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemNetwork=ogCellModemNetwork, ogAlarmSummary=ogAlarmSummary, ogRpcOutletVoltage=ogRpcOutletVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogStatus2Groups=ogStatus2Groups, ogHostIpV4Address=ogHostIpV4Address, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemEntry=ogCellModemEntry, ogEmdEntry=ogEmdEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemIndex=ogCellModemIndex, ogWifiClientApMac=ogWifiClientApMac, ogStatus2Compliances=ogStatus2Compliances, ogAlarmType=ogAlarmType, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceEntry=ogHostServiceEntry, ogCellModemConnected=ogCellModemConnected, ogCellModemTable=ogCellModemTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemModel=ogCellModemModel, ogSerialPortDTR=ogSerialPortDTR, ogEmdName=ogEmdName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientTable=ogWifiClientTable, ogAlarmCheck=ogAlarmCheck, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogHostUserNotification=ogHostUserNotification, ogHostServiceStatus=ogHostServiceStatus, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCustomNotification=ogCustomNotification, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostPingNotification=ogHostPingNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortParity=ogSerialPortParity, ogRpcTable=ogRpcTable, ogHostEntry=ogHostEntry, ogEmdDioTable=ogEmdDioTable, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckIndex=ogCheckIndex, ogEmdDioNotification=ogEmdDioNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserStartTime=ogHostUserStartTime, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsNotification=ogUpsNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmTime=ogAlarmTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsDescription=ogUpsDescription, ogRpcOutletState=ogRpcOutletState, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsInputNotification=ogUpsInputNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApEnabled=ogWifiApEnabled, ogRpcName=ogRpcName, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmName=ogAlarmName, ogSerialUserIndex=ogSerialUserIndex, ogStatus2Conformance=ogStatus2Conformance, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientTxPower=ogWifiClientTxPower, ogMibNotifications=ogMibNotifications, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserName=ogWebUserName, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckName=ogCheckName, ogSystem=ogSystem, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserIndex=ogWebUserIndex, ogSerialUserTable=ogSerialUserTable, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsEntry=ogUpsEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsIndex=ogUpsIndex, ogSerialPortDCD=ogSerialPortDCD, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdDescription=ogEmdDescription, ogHostServiceTable=ogHostServiceTable, ogWebUserNotification=ogWebUserNotification, ogRpcDescription=ogRpcDescription, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWebUserTable=ogWebUserTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServicePort=ogHostServicePort, ogUpsHumidity=ogUpsHumidity, ogWifiApIndex=ogWifiApIndex, ogWifiApTxPower=ogWifiApTxPower, ogStatus2=ogStatus2, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarm=ogAlarm, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsName=ogUpsName, ogCellModemTower=ogCellModemTower, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellMessageNotification=ogCellMessageNotification, ogCheckTable=ogCheckTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioState=ogEmdDioState, ogCheckEntry=ogCheckEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostName=ogHostName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsType=ogUpsType, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcIndex=ogRpcIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsTable=ogUpsTable, ogUpsConnectType=ogUpsConnectType, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceType=ogHostServiceType, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientMode=ogWifiClientMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApInterface=ogWifiApInterface, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmUser=ogAlarmUser, ogSerialPortLabel=ogSerialPortLabel, ogUpsInputFrequency=ogUpsInputFrequency, ogHostUserHost=ogHostUserHost, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientCounter=ogWifiClientCounter)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientFrequency=ogWifiClientFrequency, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialNumber=ogSerialNumber, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellDataNotification=ogCellDataNotification, ogCellApnNotification=ogCellApnNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApFrequency=ogWifiApFrequency, ogUpsState=ogUpsState, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryState=ogUpsBatteryState, ogHostTable=ogHostTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmEventId=ogAlarmEventId, ogEmdDioName=ogEmdDioName, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyTable=ogPowerSupplyTable, ogHostIpV6Address=ogHostIpV6Address, ogCellTowerNotification=ogCellTowerNotification, ogRpcType=ogRpcType, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmState=ogAlarmState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcEntry=ogRpcEntry, ogEmdIndex=ogEmdIndex, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmDevice=ogAlarmDevice, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioIndex=ogEmdDioIndex, ogHostUserAddress=ogHostUserAddress, ogSerialUserStartTime=ogSerialUserStartTime, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientTable=ogWifiApClientTable, ogEmdConnectType=ogEmdConnectType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceHost=ogHostServiceHost, ogRpcOutletIndex=ogRpcOutletIndex, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsCounter=ogUpsCounter, ogEmdDioType=ogEmdDioType, ogWifiApCounter=ogWifiApCounter, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletLoad=ogRpcOutletLoad)
