...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserStartTime=ogHostUserStartTime, ogRpcIndex=ogRpcIndex, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioDescription=ogEmdDioDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdEnabled=ogEmdEnabled, ogUpsEntry=ogUpsEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientCounter=ogWifiClientCounter, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmCheck=ogAlarmCheck, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemEntry=ogCellModemEntry, ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmName=ogAlarmName, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcDescription=ogRpcDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsState=ogUpsState, ogSerialPortCTS=ogSerialPortCTS, ogWebUserStartTime=ogWebUserStartTime, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserIndex=ogWebUserIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdEntry=ogEmdEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckName=ogCheckName, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckEntry=ogCheckEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientTable=ogWifiClientTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSystem=ogSystem, ogWifiApEntry=ogWifiApEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientEssid=ogWifiClientEssid, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortEntry=ogSerialPortEntry, ogAlarmLogTable=ogAlarmLogTable, ogEmdTable=ogEmdTable, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcName=ogRpcName, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmTime=ogAlarmTime, ogMibNotifications=ogMibNotifications, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserTable=ogSerialUserTable, ogHostIndex=ogHostIndex, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputPower=ogUpsOutputPower, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsName=ogUpsName, ogSerialUserPort=ogSerialUserPort, ogWifiClientApMac=ogWifiClientApMac, ogHostServicePort=ogHostServicePort, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortLabel=ogSerialPortLabel, ogWebUserTable=ogWebUserTable, ogWifiApClientTable=ogWifiApClientTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioDirection=ogEmdDioDirection, ogHostTable=ogHostTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemIndex=ogCellModemIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortSpeed=ogSerialPortSpeed, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcTable=ogRpcTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmUser=ogAlarmUser, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostName=ogHostName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellSignalNotification=ogCellSignalNotification, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsHumidity=ogUpsHumidity, ogUpsNotification=ogUpsNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserLabel=ogSerialUserLabel, ogStatus2=ogStatus2, ogHostServiceHost=ogHostServiceHost, ogWifiApTable=ogWifiApTable, ogCellModemTower=ogCellModemTower, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcInputNotification=ogRpcInputNotification, ogWifiApEnabled=ogWifiApEnabled, PYSNMP_MODULE_ID=ogStatus2, ogWifiApTxPower=ogWifiApTxPower, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckType=ogCheckType, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletState=ogRpcOutletState, ogCustomNotification=ogCustomNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserName=ogHostUserName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserEntry=ogWebUserEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsIndex=ogUpsIndex, ogSerialPortParity=ogSerialPortParity, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApIndex=ogWifiApIndex, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogStatus2Compliances=ogStatus2Compliances, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserNotification=ogWebUserNotification, ogSerialPortMode=ogSerialPortMode, ogEmdDioType=ogEmdDioType, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdName=ogEmdName, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserTable=ogHostUserTable, ogWifiClientEnabled=ogWifiClientEnabled, ogWebUserName=ogWebUserName, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceName=ogNetInterfaceName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceState=ogNetInterfaceState, ogHostUserNotification=ogHostUserNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientMode=ogWifiClientMode, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioState=ogEmdDioState, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogHostServiceNotification=ogHostServiceNotification, ogCheckIndex=ogCheckIndex, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcType=ogRpcType, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserName=ogSerialUserName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioEmd=ogEmdDioEmd, ogNetInterfaceType=ogNetInterfaceType, ogRpcConnectType=ogRpcConnectType, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientEntry=ogWifiClientEntry, ogHostUserEntry=ogHostUserEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsType=ogUpsType, ogWifiClientIndex=ogWifiClientIndex, ogAlarmType=ogAlarmType, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceType=ogHostServiceType, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApSsid=ogWifiApSsid, ogCellApnNotification=ogCellApnNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemCounter=ogCellModemCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServiceTable=ogHostServiceTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckTable=ogCheckTable, ogEmdDioName=ogEmdDioName, ogEmdDescription=ogEmdDescription, ogHostUserHostName=ogHostUserHostName, ogCellModemTable=ogCellModemTable, ogEmdDioTable=ogEmdDioTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputVoltage=ogUpsOutputVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemConnected=ogCellModemConnected, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyName=ogPowerSupplyName, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmSummary=ogAlarmSummary, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcEntry=ogRpcEntry, ogUpsBatteryState=ogUpsBatteryState, ogSerialNumber=ogSerialNumber, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientAp=ogWifiApClientAp, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApFrequency=ogWifiApFrequency, ogWifiApCounter=ogWifiApCounter, ogAlarmInstance=ogAlarmInstance, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarm=ogAlarm, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletName=ogRpcOutletName, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcInputCurrent=ogRpcInputCurrent, ogHostEntry=ogHostEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcCounter=ogRpcCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemApn=ogCellModemApn, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApInterface=ogWifiApInterface, ogUpsDescription=ogUpsDescription, ogStatus2Groups=ogStatus2Groups, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemVendor=ogCellModemVendor, ogUpsInputNotification=ogUpsInputNotification, ogAlarmEventId=ogAlarmEventId, ogCellModemModel=ogCellModemModel, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogCellTowerNotification=ogCellTowerNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsTable=ogUpsTable, ogStatus2Compliance=ogStatus2Compliance, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserEntry=ogSerialUserEntry, ogHostUserHost=ogHostUserHost, ogEmdDioCounter=ogEmdDioCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellMessageNotification=ogCellMessageNotification, ogAlarmState=ogAlarmState, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdIndex=ogEmdIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage)
