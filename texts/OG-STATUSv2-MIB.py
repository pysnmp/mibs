...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostIndex=ogHostIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemConnected=ogCellModemConnected, ogWifiClientCounter=ogWifiClientCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceNotification=ogHostServiceNotification, ogFirmwareVersion=ogFirmwareVersion, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmSummary=ogAlarmSummary, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioEntry=ogEmdDioEntry, ogHostName=ogHostName, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryState=ogUpsBatteryState, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcName=ogRpcName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortLabel=ogSerialPortLabel, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServicePort=ogHostServicePort, ogRpcType=ogRpcType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWebUserNotification=ogWebUserNotification, ogRpcDescription=ogRpcDescription, ogHostTable=ogHostTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemCounter=ogCellModemCounter, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserTable=ogSerialUserTable, ogEmdDioState=ogEmdDioState, ogEmdDioCounter=ogEmdDioCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioType=ogEmdDioType, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogStatus2Compliances=ogStatus2Compliances, ogWebUserName=ogWebUserName, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApCounter=ogWifiApCounter, ogUpsTable=ogUpsTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputPower=ogUpsOutputPower, ogRpcInputNotification=ogRpcInputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientEssid=ogWifiClientEssid, ogCheckName=ogCheckName, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceType=ogHostServiceType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortMode=ogSerialPortMode, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletTable=ogRpcOutletTable, ogWebUserEntry=ogWebUserEntry, ogAlarmName=ogAlarmName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceStatus=ogHostServiceStatus, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsConnectType=ogUpsConnectType, ogHostUserTable=ogHostUserTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogMibNotifications=ogMibNotifications, ogAlarmInstance=ogAlarmInstance, ogRpcInputFrequency=ogRpcInputFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioEmd=ogEmdDioEmd, ogHostPingNotification=ogHostPingNotification, ogEmdTable=ogEmdTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemRegistered=ogCellModemRegistered, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdConnectType=ogEmdConnectType, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdEntry=ogEmdEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemNetwork=ogCellModemNetwork, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmTime=ogAlarmTime, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserName=ogHostUserName, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserPort=ogSerialUserPort, ogRpcOutletName=ogRpcOutletName, ogAlarmLogTable=ogAlarmLogTable, ogAlarmUser=ogAlarmUser, ogCellModemVendor=ogCellModemVendor, ogCheckResolveActions=ogCheckResolveActions, ogCheckEntry=ogCheckEntry, ogEmdDioName=ogEmdDioName, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserNotification=ogHostUserNotification, ogUpsEntry=ogUpsEntry, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortDCD=ogSerialPortDCD, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserEntry=ogHostUserEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostServiceTable=ogHostServiceTable, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmCheck=ogAlarmCheck, ogUpsState=ogUpsState, ogCellModemTable=ogCellModemTable, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientMac=ogWifiApClientMac, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCustomNotification=ogCustomNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogHostEntry=ogHostEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsDescription=ogUpsDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserHost=ogHostUserHost, ogWifiApIndex=ogWifiApIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcIndex=ogRpcIndex, ogSerialUserName=ogSerialUserName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellDataNotification=ogCellDataNotification, ogAlarm=ogAlarm, ogUpsHumidity=ogUpsHumidity, ogRpcTable=ogRpcTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsType=ogUpsType, ogEmdIndex=ogEmdIndex, ogWifiClientInterface=ogWifiClientInterface, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemModel=ogCellModemModel, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2=ogStatus2, ogAlarmType=ogAlarmType, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioDescription=ogEmdDioDescription, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemTower=ogCellModemTower, ogWifiApSsid=ogWifiApSsid, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortParity=ogSerialPortParity, ogRpcCounter=ogRpcCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemEnabled=ogCellModemEnabled, ogUpsNotification=ogUpsNotification, ogCheckIndex=ogCheckIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemApn=ogCellModemApn, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2Groups=ogStatus2Groups, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApClientAp=ogWifiApClientAp, ogCellModemEntry=ogCellModemEntry, ogSystem=ogSystem, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckType=ogCheckType, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientTable=ogWifiClientTable, ogWifiApFrequency=ogWifiApFrequency, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRssi=ogWifiClientRssi, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServiceIndex=ogHostServiceIndex, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortIndex=ogSerialPortIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputNotification=ogUpsInputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioTable=ogEmdDioTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckTable=ogCheckTable, ogHostUserHostName=ogHostUserHostName, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserEntry=ogSerialUserEntry, ogEmdName=ogEmdName, ogStatus2Conformance=ogStatus2Conformance, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApTxPower=ogWifiApTxPower, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApTable=ogWifiApTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserIndex=ogHostUserIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserTable=ogWebUserTable, ogAlarmState=ogAlarmState, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsTemperature=ogUpsTemperature, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletState=ogRpcOutletState, ogCellTowerNotification=ogCellTowerNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioDirection=ogEmdDioDirection, ogWebUserStartTime=ogWebUserStartTime, ogEmdDescription=ogEmdDescription, ogRpcEntry=ogRpcEntry, ogCellApnNotification=ogCellApnNotification, ogSerialPortEntry=ogSerialPortEntry, ogUpsIndex=ogUpsIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortTable=ogSerialPortTable, ogWifiClientEntry=ogWifiClientEntry, ogUpsName=ogUpsName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsCounter=ogUpsCounter, ogSerialNumber=ogSerialNumber, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWebUserIndex=ogWebUserIndex, ogRpcConnectType=ogRpcConnectType, ogAlarmDevice=ogAlarmDevice)
