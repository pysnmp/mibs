...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioEmd=ogEmdDioEmd, ogSerialPortDSR=ogSerialPortDSR, ogUpsDescription=ogUpsDescription, ogCellModemNetwork=ogCellModemNetwork, ogWebUserEntry=ogWebUserEntry, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogHostUserHost=ogHostUserHost, ogHostIndex=ogHostIndex, ogSerialUserName=ogSerialUserName, ogSerialUserTable=ogSerialUserTable, ogEmdDescription=ogEmdDescription, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcTable=ogRpcTable, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApTable=ogWifiApTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmDevice=ogAlarmDevice, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogCellMessageNotification=ogCellMessageNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortEntry=ogSerialPortEntry, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcName=ogRpcName, ogEmdTable=ogEmdTable, ogHostServiceHost=ogHostServiceHost, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyName=ogPowerSupplyName, ogEmdIndex=ogEmdIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialNumber=ogSerialNumber, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcDescription=ogRpcDescription, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserEntry=ogHostUserEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmType=ogAlarmType, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemModel=ogCellModemModel, ogHostServicePort=ogHostServicePort, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserEntry=ogSerialUserEntry, ogCellModemIndex=ogCellModemIndex, ogSerialUserIndex=ogSerialUserIndex, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientEssid=ogWifiClientEssid, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApSsid=ogWifiApSsid, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortLabel=ogSerialPortLabel, ogEmdEntry=ogEmdEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsCounter=ogUpsCounter, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWebUserTable=ogWebUserTable, ogStatus2Conformance=ogStatus2Conformance, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientMac=ogWifiApClientMac, ogAlarmEventId=ogAlarmEventId, ogMibNotifications=ogMibNotifications, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemCounter=ogCellModemCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogCellSignalNotification=ogCellSignalNotification, ogHostEntry=ogHostEntry, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientAp=ogWifiApClientAp, ogUpsEntry=ogUpsEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSystem=ogSystem, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceTable=ogHostServiceTable, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientIndex=ogWifiClientIndex, ogCellModemTower=ogCellModemTower, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceEntry=ogHostServiceEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortParity=ogSerialPortParity, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemConnected=ogCellModemConnected, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmState=ogAlarmState, ogWebUserIndex=ogWebUserIndex, ogUpsTable=ogUpsTable, ogUpsTemperature=ogUpsTemperature, ogWifiApEnabled=ogWifiApEnabled, ogCheckDeviceCheck=ogCheckDeviceCheck, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModem4gRssi=ogCellModem4gRssi, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortStopBits=ogSerialPortStopBits, ogFirmwareVersion=ogFirmwareVersion, ogUpsConnectType=ogUpsConnectType, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioState=ogEmdDioState, ogWebUserName=ogWebUserName, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmCheck=ogAlarmCheck, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemTable=ogCellModemTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmName=ogAlarmName, ogCheckIndex=ogCheckIndex, ogSerialPortCTS=ogSerialPortCTS, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcType=ogRpcType, ogCellModemApn=ogCellModemApn, ogWifiClientMode=ogWifiClientMode, ogRpcIndex=ogRpcIndex, ogCheckType=ogCheckType, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogStatus2=ogStatus2, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsHumidity=ogUpsHumidity, ogRpcConnectType=ogRpcConnectType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserNotification=ogWebUserNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceCounter=ogHostServiceCounter, ogCheckName=ogCheckName, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserName=ogHostUserName, ogEmdDioType=ogEmdDioType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemVendor=ogCellModemVendor, ogCheckEntry=ogCheckEntry, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientFrequency=ogWifiClientFrequency, ogHostUserAddress=ogHostUserAddress, ogUpsName=ogUpsName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcEntry=ogRpcEntry, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletRpc=ogRpcOutletRpc, ogHostUserTable=ogHostUserTable, ogSerialUserPort=ogSerialUserPort, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserStartTime=ogSerialUserStartTime, ogHostTable=ogHostTable, ogUpsNotification=ogUpsNotification, ogRpcInputNotification=ogRpcInputNotification, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmInstance=ogAlarmInstance, ogUpsType=ogUpsType, ogRpcCounter=ogRpcCounter, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceIndex=ogHostServiceIndex, ogAlarmTime=ogAlarmTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdConnectType=ogEmdConnectType, ogWifiApEntry=ogWifiApEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostUserIndex=ogHostUserIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioTable=ogEmdDioTable, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdDioName=ogEmdDioName, ogCellModemEntry=ogCellModemEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserStartTime=ogHostUserStartTime, ogHostName=ogHostName, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemRegistered=ogCellModemRegistered, ogHostUserHostName=ogHostUserHostName, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityName=ogEmdHumidityName, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientEntry=ogWifiApClientEntry, ogCustomNotification=ogCustomNotification, ogAlarm=ogAlarm, ogUpsState=ogUpsState, ogSerialPortRTS=ogSerialPortRTS, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceNotification=ogHostServiceNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientEntry=ogWifiClientEntry, ogCheckTable=ogCheckTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientTable=ogWifiClientTable, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdName=ogEmdName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckResolveActions=ogCheckResolveActions, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletName=ogRpcOutletName, ogCellModemIMSI=ogCellModemIMSI, ogWifiApInterface=ogWifiApInterface, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletTable=ogRpcOutletTable, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsIndex=ogUpsIndex, ogAlarmUser=ogAlarmUser, ogSerialPortTable=ogSerialPortTable, ogAlarmSummary=ogAlarmSummary, ogWifiApFrequency=ogWifiApFrequency, ogEmdEnabled=ogEmdEnabled)
