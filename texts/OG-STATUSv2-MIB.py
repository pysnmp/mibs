...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioTable=ogEmdDioTable, PYSNMP_MODULE_ID=ogStatus2, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioDirection=ogEmdDioDirection, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdIndex=ogEmdIndex, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserName=ogHostUserName, ogWifiApTxPower=ogWifiApTxPower, ogWebUserEntry=ogWebUserEntry, ogUpsType=ogUpsType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostName=ogHostName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemModel=ogCellModemModel, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckType=ogCheckType, ogUpsNotification=ogUpsNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientEssid=ogWifiClientEssid, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortRxBytes=ogSerialPortRxBytes, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostIpV4Address=ogHostIpV4Address, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletTable=ogRpcOutletTable, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceTable=ogHostServiceTable, ogRpcOutletName=ogRpcOutletName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostUserIndex=ogHostUserIndex, ogHostUserEntry=ogHostUserEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortLabel=ogSerialPortLabel, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemApn=ogCellModemApn, ogSerialUserNotification=ogSerialUserNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcCounter=ogRpcCounter, ogWebUserName=ogWebUserName, ogAlarmLogTable=ogAlarmLogTable, ogRpcInputFrequency=ogRpcInputFrequency, ogHostPingNotification=ogHostPingNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogCustomNotification=ogCustomNotification, ogAlarmEventId=ogAlarmEventId, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckIndex=ogCheckIndex, ogEmdDioState=ogEmdDioState, ogHostServicePort=ogHostServicePort, ogCheckDeviceName=ogCheckDeviceName, ogWebUserTable=ogWebUserTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcType=ogRpcType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientEntry=ogWifiClientEntry, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApFrequency=ogWifiApFrequency, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserHostName=ogHostUserHostName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2=ogStatus2, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserAddress=ogHostUserAddress, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemTable=ogCellModemTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsEntry=ogUpsEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTable=ogEmdTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcEntry=ogRpcEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdEnabled=ogEmdEnabled, ogSystem=ogSystem, ogUpsConnectType=ogUpsConnectType, ogAlarmDevice=ogAlarmDevice, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemVendor=ogCellModemVendor, ogEmdName=ogEmdName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostIndex=ogHostIndex, ogWifiClientTable=ogWifiClientTable, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmName=ogAlarmName, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureName=ogEmdTemperatureName, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcTable=ogRpcTable, ogUpsTable=ogUpsTable, ogCheckName=ogCheckName, ogNetInterfaceName=ogNetInterfaceName, ogEmdDescription=ogEmdDescription, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcDescription=ogRpcDescription, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdEntry=ogEmdEntry, ogWebUserNotification=ogWebUserNotification, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioType=ogEmdDioType, ogAlarmTime=ogAlarmTime, ogUpsState=ogUpsState, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortTable=ogSerialPortTable, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserNotification=ogHostUserNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellDataNotification=ogCellDataNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdConnectType=ogEmdConnectType, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Compliances=ogStatus2Compliances, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioName=ogEmdDioName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApSsid=ogWifiApSsid, ogRpcOutletLoad=ogRpcOutletLoad, ogCellApnNotification=ogCellApnNotification, ogWifiClientCounter=ogWifiClientCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsDescription=ogUpsDescription, ogCheckEntry=ogCheckEntry, ogRpcOutletState=ogRpcOutletState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioNotification=ogEmdDioNotification, ogRpcIndex=ogRpcIndex, ogWifiApTable=ogWifiApTable, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmState=ogAlarmState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialUserName=ogSerialUserName, ogHostUserStartTime=ogHostUserStartTime, ogAlarmCheck=ogAlarmCheck, ogAlarmUser=ogAlarmUser, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsTemperature=ogUpsTemperature, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortDTR=ogSerialPortDTR, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioIndex=ogEmdDioIndex, ogWifiApEntry=ogWifiApEntry, ogWifiApCounter=ogWifiApCounter, ogSerialPortRTS=ogSerialPortRTS, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmType=ogAlarmType, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserEntry=ogSerialUserEntry, ogHostServiceHost=ogHostServiceHost, ogWifiApClientMac=ogWifiApClientMac, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApInterface=ogWifiApInterface, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientRssi=ogWifiClientRssi, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckTable=ogCheckTable, ogWifiClientInterface=ogWifiClientInterface, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputVoltage=ogUpsOutputVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserSourceAddress=ogWebUserSourceAddress, ogMibNotifications=ogMibNotifications, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsName=ogUpsName, ogCurrentAlarmState=ogCurrentAlarmState, ogStatus2Compliance=ogStatus2Compliance, ogStatus2Conformance=ogStatus2Conformance, ogHostTable=ogHostTable, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioEntry=ogEmdDioEntry, ogSerialNumber=ogSerialNumber, ogHostUserTable=ogHostUserTable, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceEntry=ogHostServiceEntry, ogHostUserHost=ogHostUserHost, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2Groups=ogStatus2Groups, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserIndex=ogWebUserIndex, ogWifiApClientAp=ogWifiApClientAp, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarm=ogAlarm, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmSummary=ogAlarmSummary, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcName=ogRpcName, ogHostEntry=ogHostEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsHumidity=ogUpsHumidity, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityName=ogEmdHumidityName, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcConnectType=ogRpcConnectType, ogWifiClientIndex=ogWifiClientIndex, ogUpsCounter=ogUpsCounter, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsIndex=ogUpsIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortMode=ogSerialPortMode, ogCheckResolveActions=ogCheckResolveActions, ogRpcInputNotification=ogRpcInputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceType=ogNetInterfaceType, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialUserPort=ogSerialUserPort, ogHostServiceType=ogHostServiceType, ogCellModemTower=ogCellModemTower)
