...
MibIdentifier, IpAddress, iso, Bits, TimeTicks, Gauge32, Unsigned32, NotificationType, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "iso", "Bits", "TimeTicks", "Gauge32", "Unsigned32", "NotificationType", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientAp=ogWifiApClientAp, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioEmd=ogEmdDioEmd, ogAlarmState=ogAlarmState, ogStatus2Groups=ogStatus2Groups, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputPower=ogUpsOutputPower, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserStartTime=ogSerialUserStartTime, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostIndex=ogHostIndex, ogCellSignalNotification=ogCellSignalNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogHostTable=ogHostTable, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdTemperatureName=ogEmdTemperatureName, ogHostName=ogHostName, ogEmdDioType=ogEmdDioType, ogUpsConnectType=ogUpsConnectType, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceTable=ogHostServiceTable, ogEmdEnabled=ogEmdEnabled, ogHostServiceCounter=ogHostServiceCounter, ogUpsName=ogUpsName, ogHostServiceNotification=ogHostServiceNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogStatus2Conformance=ogStatus2Conformance, ogStatus2=ogStatus2, ogWifiApIndex=ogWifiApIndex, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmSummary=ogAlarmSummary, ogEmdDioState=ogEmdDioState, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortTable=ogSerialPortTable, ogWifiClientBitRate=ogWifiClientBitRate, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortLabel=ogSerialPortLabel, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserNotification=ogSerialUserNotification, ogAlarmLogTable=ogAlarmLogTable, ogWifiApEnabled=ogWifiApEnabled, ogRpcCounter=ogRpcCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdIndex=ogEmdIndex, ogHostUserStartTime=ogHostUserStartTime, ogAlarmCheck=ogAlarmCheck, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletTable=ogRpcOutletTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioDescription=ogEmdDioDescription, ogAlarmTime=ogAlarmTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcInputCurrent=ogRpcInputCurrent, ogMibNotifications=ogMibNotifications, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcInputNotification=ogRpcInputNotification, ogEmdEntry=ogEmdEntry, ogCheckEntry=ogCheckEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApFrequency=ogWifiApFrequency, ogCellDataNotification=ogCellDataNotification, ogAlarmType=ogAlarmType, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioNotification=ogEmdDioNotification, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserHostName=ogHostUserHostName, ogWifiApTable=ogWifiApTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceName=ogCheckDeviceName, ogAlarmUser=ogAlarmUser, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortRTS=ogSerialPortRTS, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserIndex=ogWebUserIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletState=ogRpcOutletState, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientTable=ogWifiClientTable, ogEmdConnectType=ogEmdConnectType, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellApnNotification=ogCellApnNotification, ogHostUserNotification=ogHostUserNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserTable=ogSerialUserTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmInstance=ogAlarmInstance, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcName=ogRpcName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortMode=ogSerialPortMode, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserAddress=ogHostUserAddress, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortStopBits=ogSerialPortStopBits, ogHostIpV4Address=ogHostIpV4Address, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckName=ogCheckName, ogUpsOutputLoad=ogUpsOutputLoad, ogHostPingNotification=ogHostPingNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckIndex=ogCheckIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortIndex=ogSerialPortIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserName=ogSerialUserName, ogPowerSupplyName=ogPowerSupplyName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCustomNotification=ogCustomNotification, ogHostServiceIndex=ogHostServiceIndex, ogRpcConnectType=ogRpcConnectType, ogRpcEntry=ogRpcEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServicePort=ogHostServicePort, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApEntry=ogWifiApEntry, ogEmdDioEntry=ogEmdDioEntry, ogCellModemCounter=ogCellModemCounter, ogCellModemVendor=ogCellModemVendor, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletName=ogRpcOutletName, ogCellModemTower=ogCellModemTower, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcTable=ogRpcTable, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcIndex=ogRpcIndex, ogWifiApClientTable=ogWifiApClientTable, ogSerialPatternNotification=ogSerialPatternNotification, ogWebUserName=ogWebUserName, ogCheckType=ogCheckType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserEntry=ogWebUserEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemEntry=ogCellModemEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserName=ogHostUserName, ogHostUserIndex=ogHostUserIndex, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellTowerNotification=ogCellTowerNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortEntry=ogSerialPortEntry, ogUpsNotification=ogUpsNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsEntry=ogUpsEntry, ogSerialPortDTR=ogSerialPortDTR, ogWebUserTable=ogWebUserTable, ogUpsDescription=ogUpsDescription, ogAlarmDevice=ogAlarmDevice, ogUpsState=ogUpsState, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApSsid=ogWifiApSsid, ogSystem=ogSystem, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsType=ogUpsType, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDSR=ogSerialPortDSR, ogAlarmName=ogAlarmName, ogSerialUserLabel=ogSerialUserLabel, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsIndex=ogUpsIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortParity=ogSerialPortParity, ogWifiClientEntry=ogWifiClientEntry, ogHostServiceHost=ogHostServiceHost, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTable=ogEmdTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogBasicStatusGroup=ogBasicStatusGroup)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioName=ogEmdDioName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceType=ogHostServiceType, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemModel=ogCellModemModel, ogEmdDescription=ogEmdDescription, ogSerialNumber=ogSerialNumber, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientApMac=ogWifiClientApMac, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdName=ogEmdName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckTable=ogCheckTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsTable=ogUpsTable, ogAlarmEventId=ogAlarmEventId, ogWifiClientInterface=ogWifiClientInterface, ogHostEntry=ogHostEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientCounter=ogWifiClientCounter, ogAlarm=ogAlarm, ogUpsTemperature=ogUpsTemperature, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortDCD=ogSerialPortDCD, ogCellModemApn=ogCellModemApn, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemConnected=ogCellModemConnected, ogSerialUserPort=ogSerialUserPort, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsCounter=ogUpsCounter, ogEmdDioTable=ogEmdDioTable, ogWifiClientMode=ogWifiClientMode, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserTable=ogHostUserTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserHost=ogHostUserHost, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemTemperature=ogCellModemTemperature, ogRpcDescription=ogRpcDescription, ogCellModemTable=ogCellModemTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApInterface=ogWifiApInterface, ogRpcType=ogRpcType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserNotification=ogWebUserNotification)
