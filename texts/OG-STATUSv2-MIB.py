...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientApMac=ogWifiClientApMac, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmName=ogAlarmName, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyName=ogPowerSupplyName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDCD=ogSerialPortDCD, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserNotification=ogSerialUserNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceIndex=ogHostServiceIndex, ogCustomNotification=ogCustomNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApIndex=ogWifiApIndex, ogMibNotifications=ogMibNotifications, ogFirmwareVersion=ogFirmwareVersion, PYSNMP_MODULE_ID=ogStatus2, ogWebUserStartTime=ogWebUserStartTime, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckIndex=ogCheckIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdLogEnabled=ogEmdLogEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletTable=ogRpcOutletTable, ogUpsName=ogUpsName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientBitRate=ogWifiClientBitRate, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckDeviceTable=ogCheckDeviceTable, ogHostServiceTable=ogHostServiceTable, ogAlarmUser=ogAlarmUser, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemModel=ogCellModemModel, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientEssid=ogWifiClientEssid, ogRpcType=ogRpcType, ogCellModemTable=ogCellModemTable, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserIndex=ogWebUserIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWebUserTable=ogWebUserTable, ogWifiClientTable=ogWifiClientTable, ogRpcDescription=ogRpcDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTable=ogEmdTable, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsEntry=ogUpsEntry, ogWifiApInterface=ogWifiApInterface, ogHostName=ogHostName, ogCheckType=ogCheckType, ogCellDataNotification=ogCellDataNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientAp=ogWifiApClientAp, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioType=ogEmdDioType, ogCellModemCounter=ogCellModemCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemSessionTime=ogCellModemSessionTime, ogHostEntry=ogHostEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellApnNotification=ogCellApnNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogStatus2=ogStatus2, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdIndex=ogEmdIndex, ogUpsDescription=ogUpsDescription, ogSerialPortMode=ogSerialPortMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserTable=ogHostUserTable, ogSerialPortParity=ogSerialPortParity, ogEmdDioEntry=ogEmdDioEntry, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellTowerNotification=ogCellTowerNotification, ogWifiApClientMac=ogWifiApClientMac, ogHostIndex=ogHostIndex, ogWifiApTable=ogWifiApTable, ogUpsOutputNotification=ogUpsOutputNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDSR=ogSerialPortDSR, ogAlarmInstance=ogAlarmInstance, ogCellModemApn=ogCellModemApn, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcCounter=ogRpcCounter, ogHostUserNotification=ogHostUserNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientIndex=ogWifiApClientIndex, ogStatus2Conformance=ogStatus2Conformance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApFrequency=ogWifiApFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckName=ogCheckName, ogWifiApSsid=ogWifiApSsid, ogRpcEntry=ogRpcEntry, ogHostPingNotification=ogHostPingNotification, ogWifiApCounter=ogWifiApCounter, ogHostServiceType=ogHostServiceType, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortEntry=ogSerialPortEntry, ogHostUserHostName=ogHostUserHostName, ogNetInterfaceState=ogNetInterfaceState, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSystem=ogSystem, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserEntry=ogSerialUserEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApTxPower=ogWifiApTxPower, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsBatteryState=ogUpsBatteryState, ogCheckTriggerActions=ogCheckTriggerActions, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmEventId=ogAlarmEventId, ogAlarmCheck=ogAlarmCheck, ogHostTable=ogHostTable, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserIndex=ogSerialUserIndex, ogSerialUserName=ogSerialUserName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarm=ogAlarm, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Compliance=ogStatus2Compliance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemEntry=ogCellModemEntry, ogCheckResolveActions=ogCheckResolveActions, ogHostUserStartTime=ogHostUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientCounter=ogWifiClientCounter, ogEmdName=ogEmdName, ogAlarmState=ogAlarmState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioState=ogEmdDioState, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioIndex=ogEmdDioIndex, ogRpcIndex=ogRpcIndex, ogAlarmTime=ogAlarmTime, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsType=ogUpsType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioEmd=ogEmdDioEmd, ogCheckEntry=ogCheckEntry, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsNotification=ogUpsNotification, ogSerialNumber=ogSerialNumber, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialUserLabel=ogSerialUserLabel, ogRpcName=ogRpcName, ogWebUserEntry=ogWebUserEntry, ogEmdDioNotification=ogEmdDioNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserName=ogHostUserName, ogCheckTable=ogCheckTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortRTS=ogSerialPortRTS, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsIndex=ogUpsIndex, ogSerialPortIndex=ogSerialPortIndex, ogHostUserAddress=ogHostUserAddress)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsTemperature=ogUpsTemperature, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserTable=ogSerialUserTable, ogWifiClientMode=ogWifiClientMode, ogStatus2Compliances=ogStatus2Compliances, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcTable=ogRpcTable, ogRpcConnectType=ogRpcConnectType, ogAlarmType=ogAlarmType, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserName=ogWebUserName, ogHostServicePort=ogHostServicePort, ogUpsState=ogUpsState, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemNetwork=ogCellModemNetwork, ogUpsConnectType=ogUpsConnectType, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceHost=ogHostServiceHost, ogCellModemConnected=ogCellModemConnected, ogEmdEntry=ogEmdEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortCTS=ogSerialPortCTS, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmLogTable=ogAlarmLogTable, ogCellModemRegistered=ogCellModemRegistered, ogAlarmCurrentValue=ogAlarmCurrentValue, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemTower=ogCellModemTower, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceCounter=ogHostServiceCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientIndex=ogWifiClientIndex, ogCellModemVendor=ogCellModemVendor, ogAlarmSummary=ogAlarmSummary, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdEnabled=ogEmdEnabled, ogHostIpV4Address=ogHostIpV4Address, ogUpsTable=ogUpsTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmDevice=ogAlarmDevice, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserPort=ogSerialUserPort, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioName=ogEmdDioName, ogHostUserHost=ogHostUserHost, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryCharge=ogUpsBatteryCharge)
