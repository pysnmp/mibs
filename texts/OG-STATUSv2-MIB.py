...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioState=ogEmdDioState, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemCounter=ogCellModemCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserEntry=ogHostUserEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsTable=ogUpsTable, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemIndex=ogCellModemIndex, ogEmdDioName=ogEmdDioName, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2Groups=ogStatus2Groups, ogAlarmDevice=ogAlarmDevice, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputPower=ogUpsOutputPower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemTemperature=ogCellModemTemperature, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostEntry=ogHostEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmLogTable=ogAlarmLogTable, ogCellModemConnected=ogCellModemConnected, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioType=ogEmdDioType, ogHostUserStartTime=ogHostUserStartTime, ogHostServiceType=ogHostServiceType, ogHostUserTable=ogHostUserTable, ogRpcTable=ogRpcTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmType=ogAlarmType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientTable=ogWifiApClientTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortDCD=ogSerialPortDCD, ogCellModemModel=ogCellModemModel, ogUpsCounter=ogUpsCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientInterface=ogWifiClientInterface, ogFirmwareVersion=ogFirmwareVersion, ogAlarmLogEntry=ogAlarmLogEntry, ogHostIndex=ogHostIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserStartTime=ogWebUserStartTime, ogAlarmUser=ogAlarmUser, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialUserName=ogSerialUserName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmTime=ogAlarmTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdIndex=ogEmdIndex, ogWifiApTxPower=ogWifiApTxPower, ogRpcOutletState=ogRpcOutletState, ogAlarmName=ogAlarmName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellApnNotification=ogCellApnNotification, ogCheckType=ogCheckType, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioCounter=ogEmdDioCounter, ogHostUserNotification=ogHostUserNotification, ogHostServiceTable=ogHostServiceTable, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyName=ogPowerSupplyName, ogWifiApTable=ogWifiApTable, ogHostTable=ogHostTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcCounter=ogRpcCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsState=ogUpsState, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApInterface=ogWifiApInterface, ogEmdDioEmd=ogEmdDioEmd, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortTable=ogSerialPortTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemIMSI=ogCellModemIMSI, ogUpsLogEnabled=ogUpsLogEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSystem=ogSystem, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserLabel=ogSerialUserLabel, ogUpsIndex=ogUpsIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarm=ogAlarm, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcEntry=ogRpcEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmSummary=ogAlarmSummary, ogEmdName=ogEmdName, ogHostServiceNotification=ogHostServiceNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientFrequency=ogWifiClientFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientRssi=ogWifiApClientRssi, ogNetInterfaceState=ogNetInterfaceState, ogUpsInputNotification=ogUpsInputNotification, ogEmdTable=ogEmdTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWebUserIndex=ogWebUserIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmCheck=ogAlarmCheck, ogSerialPortParity=ogSerialPortParity, ogWifiApEntry=ogWifiApEntry, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityName=ogEmdHumidityName, ogHostServicePort=ogHostServicePort, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientAp=ogWifiApClientAp, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogStatus2Compliance=ogStatus2Compliance, ogHostServiceHost=ogHostServiceHost, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletName=ogRpcOutletName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserHost=ogHostUserHost, ogCellModemApn=ogCellModemApn, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsConnectType=ogUpsConnectType, ogRpcName=ogRpcName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserEntry=ogSerialUserEntry, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserName=ogHostUserName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmEventId=ogAlarmEventId, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceCounter=ogHostServiceCounter, ogHostName=ogHostName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemEntry=ogCellModemEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsType=ogUpsType, ogEmdEnabled=ogEmdEnabled, ogCellModemVendor=ogCellModemVendor, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryState=ogUpsBatteryState, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceIndex=ogHostServiceIndex, ogCheckEntry=ogCheckEntry, ogAlarmState=ogAlarmState, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcType=ogRpcType, ogUpsNotification=ogUpsNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsName=ogUpsName, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientMode=ogWifiClientMode, PYSNMP_MODULE_ID=ogStatus2, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsTemperature=ogUpsTemperature, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckDeviceRef=ogCheckDeviceRef, ogCustomNotification=ogCustomNotification, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientEssid=ogWifiClientEssid, ogPowerSupplyIndex=ogPowerSupplyIndex, ogMibNotifications=ogMibNotifications)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsHumidity=ogUpsHumidity, ogHostServiceStatus=ogHostServiceStatus, ogSerialUserPort=ogSerialUserPort, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApCounter=ogWifiApCounter, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcConnectType=ogRpcConnectType, ogCheckName=ogCheckName, ogHostUserHostName=ogHostUserHostName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioEntry=ogEmdDioEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserIndex=ogHostUserIndex, ogCheckIndex=ogCheckIndex, ogAlarmInstance=ogAlarmInstance, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsEntry=ogUpsEntry, ogStatus2Conformance=ogStatus2Conformance, ogCellModemTable=ogCellModemTable, ogCellModemNetwork=ogCellModemNetwork, ogRpcIndex=ogRpcIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialNumber=ogSerialNumber, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserNotification=ogWebUserNotification, ogCellModemTower=ogCellModemTower, ogCellModemRegistered=ogCellModemRegistered, ogWebUserEntry=ogWebUserEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogCellSignalNotification=ogCellSignalNotification, ogUpsDescription=ogUpsDescription, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdEntry=ogEmdEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApSsid=ogWifiApSsid, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientEntry=ogWifiClientEntry, ogRpcDescription=ogRpcDescription, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryNotification=ogUpsBatteryNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogStatus2=ogStatus2, ogEmdDescription=ogEmdDescription, ogWifiClientApMac=ogWifiClientApMac, ogWebUserSourcePort=ogWebUserSourcePort, ogCellMessageNotification=ogCellMessageNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioDescription=ogEmdDioDescription, ogWebUserTable=ogWebUserTable, ogCheckTable=ogCheckTable, ogWifiApIndex=ogWifiApIndex, ogWebUserName=ogWebUserName, ogEmdDioTable=ogEmdDioTable)
