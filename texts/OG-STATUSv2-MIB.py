...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostIndex=ogHostIndex, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogStatus2Groups=ogStatus2Groups, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmEventId=ogAlarmEventId, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsIndex=ogUpsIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckDeviceName=ogCheckDeviceName, ogCellModemVendor=ogCellModemVendor, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserStartTime=ogHostUserStartTime, ogHostServiceIndex=ogHostServiceIndex, ogUpsState=ogUpsState, ogCellModemTable=ogCellModemTable, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientEntry=ogWifiClientEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckResolveActions=ogCheckResolveActions, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcEntry=ogRpcEntry, ogCellModemRegistered=ogCellModemRegistered, ogAlarmLogTable=ogAlarmLogTable, ogHostUserEntry=ogHostUserEntry, ogUpsCounter=ogUpsCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputNotification=ogUpsOutputNotification, ogWebUserNotification=ogWebUserNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApCounter=ogWifiApCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcCounter=ogRpcCounter, ogWifiApEntry=ogWifiApEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDescription=ogEmdDescription, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcType=ogRpcType, ogRpcOutletTable=ogRpcOutletTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsOutputFrequency=ogUpsOutputFrequency, ogFirmwareVersion=ogFirmwareVersion, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortParity=ogSerialPortParity, PYSNMP_MODULE_ID=ogStatus2, ogHostEntry=ogHostEntry, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioType=ogEmdDioType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortDSR=ogSerialPortDSR, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemApn=ogCellModemApn, ogSerialNumber=ogSerialNumber, ogCustomNotification=ogCustomNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostTable=ogHostTable, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceEntry=ogHostServiceEntry, ogHostUserHost=ogHostUserHost, ogEmdDioState=ogEmdDioState, ogSerialPortLabel=ogSerialPortLabel, ogCheckName=ogCheckName, ogAlarmCheck=ogAlarmCheck, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortTable=ogSerialPortTable, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmUser=ogAlarmUser, ogSerialUserNotification=ogSerialUserNotification, ogStatus2Compliance=ogStatus2Compliance, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmInstance=ogAlarmInstance, ogAlarmType=ogAlarmType, ogCheckDeviceTable=ogCheckDeviceTable, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApInterface=ogWifiApInterface, ogHostUserIndex=ogHostUserIndex, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckIndex=ogCheckIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialUserTable=ogSerialUserTable, ogEmdDioDescription=ogEmdDioDescription, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientMac=ogWifiApClientMac, ogSerialUserName=ogSerialUserName, ogUpsOutputPower=ogUpsOutputPower, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserTable=ogWebUserTable, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckType=ogCheckType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientAp=ogWifiApClientAp, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientTable=ogWifiClientTable, ogHostServiceHost=ogHostServiceHost, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmState=ogAlarmState, ogWifiApTable=ogWifiApTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2=ogStatus2, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApEnabled=ogWifiApEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApIndex=ogWifiApIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioEntry=ogEmdDioEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryNotification=ogUpsBatteryNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsTemperature=ogUpsTemperature, ogCellTowerNotification=ogCellTowerNotification, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsName=ogUpsName, ogNetInterfaceName=ogNetInterfaceName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellMessageNotification=ogCellMessageNotification, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceState=ogNetInterfaceState, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletLoad=ogRpcOutletLoad, ogWebUserStartTime=ogWebUserStartTime, ogEmdEntry=ogEmdEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletEntry=ogRpcOutletEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceNotification=ogHostServiceNotification, ogRpcIndex=ogRpcIndex, ogSystem=ogSystem, ogUpsConnectType=ogUpsConnectType, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsNotification=ogUpsNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemTower=ogCellModemTower, ogRpcTable=ogRpcTable, ogEmdDioName=ogEmdDioName, ogHostServicePort=ogHostServicePort, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsTable=ogUpsTable, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortMode=ogSerialPortMode, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApFrequency=ogWifiApFrequency, ogHostName=ogHostName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsType=ogUpsType, ogCellModemConnected=ogCellModemConnected, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemIndex=ogCellModemIndex, ogUpsDescription=ogUpsDescription, ogWebUserEntry=ogWebUserEntry, ogUpsHumidity=ogUpsHumidity, ogUpsBatteryState=ogUpsBatteryState, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialUserLabel=ogSerialUserLabel, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserTable=ogHostUserTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarm=ogAlarm, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletName=ogRpcOutletName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserName=ogWebUserName, ogHostUserName=ogHostUserName, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsEntry=ogUpsEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioNotification=ogEmdDioNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemNetwork=ogCellModemNetwork, ogCellModemModel=ogCellModemModel, ogEmdEnabled=ogEmdEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioCounter=ogEmdDioCounter, ogCheckEntry=ogCheckEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogStatus2Compliances=ogStatus2Compliances, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckTable=ogCheckTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcConnectType=ogRpcConnectType, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcName=ogRpcName, ogMibNotifications=ogMibNotifications, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientRssi=ogWifiClientRssi, ogAlarmDevice=ogAlarmDevice, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserIndex=ogSerialUserIndex, ogHostUserAddress=ogHostUserAddress, ogHostUserNotification=ogHostUserNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientMode=ogWifiClientMode, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcDescription=ogRpcDescription, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdIndex=ogEmdIndex, ogAlarmTime=ogAlarmTime, ogSerialPortDTR=ogSerialPortDTR, ogEmdName=ogEmdName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellApnNotification=ogCellApnNotification, ogCellModemCounter=ogCellModemCounter, ogCellModemEntry=ogCellModemEntry, ogEmdDioTable=ogEmdDioTable, ogHostServiceType=ogHostServiceType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmName=ogAlarmName, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTable=ogEmdTable)
