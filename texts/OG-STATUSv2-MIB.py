...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdIndex=ogEmdIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmState=ogAlarmState, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsName=ogUpsName, ogHostServicePort=ogHostServicePort, ogSystem=ogSystem, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioCounter=ogEmdDioCounter, ogUpsIndex=ogUpsIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTable=ogEmdTable, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserName=ogWebUserName, ogRpcCounter=ogRpcCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioState=ogEmdDioState, ogHostUserTable=ogHostUserTable, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckDeviceRef=ogCheckDeviceRef, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostTable=ogHostTable, ogWifiClientEntry=ogWifiClientEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckResolveActions=ogCheckResolveActions, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmName=ogAlarmName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApFrequency=ogWifiApFrequency, ogCellModemApn=ogCellModemApn, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcConnectType=ogRpcConnectType, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcTable=ogRpcTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcIndex=ogRpcIndex, ogWebUserIndex=ogWebUserIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdHumidityName=ogEmdHumidityName, ogCellModemTemperature=ogCellModemTemperature, ogHostUserIndex=ogHostUserIndex, ogRpcName=ogRpcName, ogWifiApTxPower=ogWifiApTxPower, ogUpsEntry=ogUpsEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortMode=ogSerialPortMode, ogEmdDioEmd=ogEmdDioEmd, PYSNMP_MODULE_ID=ogStatus2, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsConnectType=ogUpsConnectType, ogCellModemIndex=ogCellModemIndex, ogCellSignalNotification=ogCellSignalNotification, ogHostUserName=ogHostUserName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostIpV4Address=ogHostIpV4Address, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletState=ogRpcOutletState, ogCheckType=ogCheckType, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialUserName=ogSerialUserName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmSummary=ogAlarmSummary, ogUpsOutputNotification=ogUpsOutputNotification, ogHostName=ogHostName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogHostEntry=ogHostEntry, ogAlarmInstance=ogAlarmInstance, ogStatus2Groups=ogStatus2Groups, ogHostUserHost=ogHostUserHost, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdEnabled=ogEmdEnabled, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmTime=ogAlarmTime, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemEntry=ogCellModemEntry, ogHostPingNotification=ogHostPingNotification, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortDCD=ogSerialPortDCD, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApTable=ogWifiApTable, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortLabel=ogSerialPortLabel, ogHostIndex=ogHostIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioTable=ogEmdDioTable, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientMode=ogWifiClientMode, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioType=ogEmdDioType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsCounter=ogUpsCounter, ogUpsBatteryState=ogUpsBatteryState, ogCellModemVendor=ogCellModemVendor, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioNotification=ogEmdDioNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceCounter=ogHostServiceCounter, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellApnNotification=ogCellApnNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostUserNotification=ogHostUserNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsInputNotification=ogUpsInputNotification, ogRpcInputNotification=ogRpcInputNotification, ogAlarmCheck=ogAlarmCheck, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApIndex=ogWifiApIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceName=ogNetInterfaceName, ogMibNotifications=ogMibNotifications, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortRTS=ogSerialPortRTS, ogCellMessageNotification=ogCellMessageNotification, ogStatus2Compliances=ogStatus2Compliances, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcEntry=ogRpcEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogWebUserTable=ogWebUserTable, ogCellModemCounter=ogCellModemCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserHostName=ogHostUserHostName, ogCellModemModel=ogCellModemModel, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApCounter=ogWifiApCounter, ogAlarmType=ogAlarmType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcType=ogRpcType, ogRpcDescription=ogRpcDescription, ogSerialPortEntry=ogSerialPortEntry, ogWebUserStartTime=ogWebUserStartTime, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckName=ogCheckName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsDescription=ogUpsDescription, ogHostIpV6Address=ogHostIpV6Address, ogCheckEntry=ogCheckEntry, ogUpsNotification=ogUpsNotification, ogHostUserAddress=ogHostUserAddress, ogWifiClientApMac=ogWifiClientApMac, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortTable=ogSerialPortTable, ogCellModemNetwork=ogCellModemNetwork, ogUpsType=ogUpsType, ogCheckIndex=ogCheckIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsLogEnabled=ogUpsLogEnabled, ogHostServiceIndex=ogHostServiceIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientTable=ogWifiClientTable, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioEntry=ogEmdDioEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsHumidity=ogUpsHumidity, ogEmdName=ogEmdName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmUser=ogAlarmUser, ogCellModemTable=ogCellModemTable, ogCellDataNotification=ogCellDataNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientIndex=ogWifiClientIndex, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsState=ogUpsState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsTable=ogUpsTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostServiceType=ogHostServiceType, ogAlarm=ogAlarm, ogSerialSignalNotification=ogSerialSignalNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2=ogStatus2, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletTable=ogRpcOutletTable, ogCellModemTower=ogCellModemTower, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortParity=ogSerialPortParity, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialUserNotification=ogSerialUserNotification, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialNumber=ogSerialNumber, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmDevice=ogAlarmDevice, ogWifiApEntry=ogWifiApEntry, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdEntry=ogEmdEntry, ogRpcOutletName=ogRpcOutletName, ogUpsTemperature=ogUpsTemperature, ogEmdConnectType=ogEmdConnectType, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCustomNotification=ogCustomNotification, ogHostServiceTable=ogHostServiceTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialUserTable=ogSerialUserTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWebUserNotification=ogWebUserNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientRssi=ogWifiClientRssi, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApSsid=ogWifiApSsid, ogWifiApInterface=ogWifiApInterface, ogSerialUserIndex=ogSerialUserIndex, ogEmdDescription=ogEmdDescription, ogHostUserEntry=ogHostUserEntry, ogUpsOutputPower=ogUpsOutputPower, ogCellModemConnected=ogCellModemConnected, ogCheckTable=ogCheckTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioName=ogEmdDioName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserSourcePort=ogWebUserSourcePort)
