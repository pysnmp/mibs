...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckName=ogCheckName, ogHostName=ogHostName, ogHostServicePort=ogHostServicePort, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcInputNotification=ogRpcInputNotification, ogFirmwareVersion=ogFirmwareVersion, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientCounter=ogWifiClientCounter, ogCellModemEntry=ogCellModemEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApEntry=ogWifiApEntry, ogEmdName=ogEmdName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcInputCurrent=ogRpcInputCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserHost=ogHostUserHost, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemTower=ogCellModemTower, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemIMSI=ogCellModemIMSI, ogAlarmType=ogAlarmType, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckEntry=ogCheckEntry, ogCellModemApn=ogCellModemApn, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostServiceType=ogHostServiceType, ogRpcOutletState=ogRpcOutletState, ogWifiApIndex=ogWifiApIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarm=ogAlarm, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostServiceHost=ogHostServiceHost, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioNotification=ogEmdDioNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcName=ogRpcName, ogWifiClientTable=ogWifiClientTable, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmDevice=ogAlarmDevice, ogCellTowerNotification=ogCellTowerNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientMode=ogWifiClientMode, ogSerialUserName=ogSerialUserName, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcCounter=ogRpcCounter, ogUpsNotification=ogUpsNotification, ogUpsState=ogUpsState, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsTemperature=ogUpsTemperature, ogEmdDioTable=ogEmdDioTable, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientEssid=ogWifiClientEssid, ogHostUserIndex=ogHostUserIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApEnabled=ogWifiApEnabled, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmTime=ogAlarmTime, ogEmdConnectType=ogEmdConnectType, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialUserNotification=ogSerialUserNotification, ogEmdTable=ogEmdTable, ogUpsType=ogUpsType, ogEmdDescription=ogEmdDescription, ogCheckType=ogCheckType, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceIndex=ogHostServiceIndex, ogEmdEntry=ogEmdEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityName=ogEmdHumidityName, ogHostUserName=ogHostUserName, ogWebUserName=ogWebUserName, ogHostIndex=ogHostIndex, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioName=ogEmdDioName, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmIndex=ogCurrentAlarmIndex, PYSNMP_MODULE_ID=ogStatus2, ogWifiApCounter=ogWifiApCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckDeviceName=ogCheckDeviceName, ogSerialUserTable=ogSerialUserTable, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortDCD=ogSerialPortDCD, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogMibNotifications=ogMibNotifications, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcDescription=ogRpcDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsDescription=ogUpsDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioEntry=ogEmdDioEntry, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcTable=ogRpcTable, ogUpsCounter=ogUpsCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2Compliances=ogStatus2Compliances, ogRpcIndex=ogRpcIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserStartTime=ogWebUserStartTime, ogEmdEnabled=ogEmdEnabled, ogAlarmState=ogAlarmState, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostEntry=ogHostEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckResolveActions=ogCheckResolveActions, ogCellModemNetwork=ogCellModemNetwork, ogRpcType=ogRpcType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemIndex=ogCellModemIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmCheck=ogAlarmCheck, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioState=ogEmdDioState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioDirection=ogEmdDioDirection, ogStatus2=ogStatus2, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdIndex=ogEmdIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcEntry=ogRpcEntry, ogEmdDioType=ogEmdDioType, ogSerialUserEntry=ogSerialUserEntry, ogHostUserHostName=ogHostUserHostName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApTxPower=ogWifiApTxPower, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientMac=ogWifiApClientMac, ogAlarmUser=ogAlarmUser, ogUpsName=ogUpsName, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogCustomNotification=ogCustomNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmInstance=ogAlarmInstance, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemTable=ogCellModemTable, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApAuthNotification=ogWifiApAuthNotification, ogNetInterfaceName=ogNetInterfaceName, ogWebUserNotification=ogWebUserNotification, ogStatus2Conformance=ogStatus2Conformance, ogSystem=ogSystem, ogRpcOutletLoad=ogRpcOutletLoad)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialNumber=ogSerialNumber, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostServiceNotification=ogHostServiceNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserTable=ogHostUserTable, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmEventId=ogAlarmEventId, ogUpsOutputPower=ogUpsOutputPower, ogUpsEntry=ogUpsEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserNotification=ogHostUserNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostIpV6Address=ogHostIpV6Address, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemCounter=ogCellModemCounter, ogStatus2Groups=ogStatus2Groups, ogWebUserTable=ogWebUserTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmSummary=ogAlarmSummary, ogHostUserEntry=ogHostUserEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortParity=ogSerialPortParity, ogEmdDioCounter=ogEmdDioCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortDSR=ogSerialPortDSR, ogHostTable=ogHostTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckTable=ogCheckTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputLoad=ogUpsOutputLoad, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApSsid=ogWifiApSsid, ogUpsTable=ogUpsTable, ogAlarmName=ogAlarmName, ogSerialPortIndex=ogSerialPortIndex, ogCellSignalNotification=ogCellSignalNotification, ogCellModemVendor=ogCellModemVendor, ogWebUserEntry=ogWebUserEntry, ogUpsIndex=ogUpsIndex, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApTable=ogWifiApTable, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientAp=ogWifiApClientAp, ogCellDataNotification=ogCellDataNotification, ogHostServiceCounter=ogHostServiceCounter, ogCellModemModel=ogCellModemModel, ogCheckIndex=ogCheckIndex, ogAlarmTriggerValue=ogAlarmTriggerValue)
