...
NotificationType, IpAddress, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Integer32, Gauge32, MibIdentifier, Counter32, Bits, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Integer32", "Gauge32", "MibIdentifier", "Counter32", "Bits", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServicePort=ogHostServicePort, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletName=ogRpcOutletName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientTable=ogWifiApClientTable, ogEmdEntry=ogEmdEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsConnectType=ogUpsConnectType, ogRpcDescription=ogRpcDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsState=ogUpsState, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsCounter=ogUpsCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcEntry=ogRpcEntry, ogAlarmName=ogAlarmName, ogUpsDescription=ogUpsDescription, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApSsid=ogWifiApSsid, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApInterface=ogWifiApInterface, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortMode=ogSerialPortMode, ogWebUserNotification=ogWebUserNotification, ogCellModemConnected=ogCellModemConnected, ogWifiApCounter=ogWifiApCounter, ogRpcIndex=ogRpcIndex, ogEmdDioName=ogEmdDioName, ogWifiClientInterface=ogWifiClientInterface, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserNotification=ogSerialUserNotification, ogHostUserNotification=ogHostUserNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckEntry=ogCheckEntry, ogCellModemApn=ogCellModemApn, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortCTS=ogSerialPortCTS, ogUpsEntry=ogUpsEntry, ogHostServiceCounter=ogHostServiceCounter, ogEmdEnabled=ogEmdEnabled, ogWebUserTable=ogWebUserTable, ogHostServiceIndex=ogHostServiceIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogCellTowerNotification=ogCellTowerNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientEntry=ogWifiClientEntry, ogRpcName=ogRpcName, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogSystem=ogSystem, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmLogTable=ogAlarmLogTable, ogAlarmEventId=ogAlarmEventId, ogHostUserTable=ogHostUserTable, ogAlarmInstance=ogAlarmInstance, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsTable=ogUpsTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckName=ogCheckName, ogEmdName=ogEmdName, ogAlarmSummary=ogAlarmSummary, ogRpcOutletState=ogRpcOutletState, ogCustomNotification=ogCustomNotification, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletTable=ogRpcOutletTable, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogPowerSupplyTable=ogPowerSupplyTable, ogHostUserAddress=ogHostUserAddress, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserStartTime=ogWebUserStartTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortDTR=ogSerialPortDTR, ogEmdDescription=ogEmdDescription, ogWifiApTable=ogWifiApTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserEntry=ogHostUserEntry, ogRpcCounter=ogRpcCounter, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckType=ogCheckType, ogWifiApTxPower=ogWifiApTxPower, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApIndex=ogWifiApIndex, ogHostIndex=ogHostIndex, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdLogEnabled=ogEmdLogEnabled, ogWebUserName=ogWebUserName, ogHostUserHost=ogHostUserHost, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmState=ogAlarmState, ogCellModemRegistered=ogCellModemRegistered, ogWebUserEntry=ogWebUserEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemNetwork=ogCellModemNetwork, ogHostServiceEntry=ogHostServiceEntry, ogEmdIndex=ogEmdIndex, ogRpcConnectType=ogRpcConnectType, ogAlarmUser=ogAlarmUser, ogHostUserIndex=ogHostUserIndex, ogWifiClientMode=ogWifiClientMode, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemTable=ogCellModemTable, ogUpsNotification=ogUpsNotification, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserLabel=ogSerialUserLabel, ogHostTable=ogHostTable, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarm=ogAlarm, ogEmdConnectType=ogEmdConnectType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserPort=ogSerialUserPort, ogCellModemTower=ogCellModemTower, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostIpV6Address=ogHostIpV6Address, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogCellDataNotification=ogCellDataNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceName=ogCheckDeviceName, ogAlarmType=ogAlarmType, ogRpcType=ogRpcType, ogUpsName=ogUpsName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckResolveActions=ogCheckResolveActions, ogMibNotifications=ogMibNotifications, ogStatus2=ogStatus2, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioNotification=ogEmdDioNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsTemperature=ogUpsTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortDCD=ogSerialPortDCD, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemIMSI=ogCellModemIMSI, ogHostServiceType=ogHostServiceType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioType=ogEmdDioType, ogNetInterfaceType=ogNetInterfaceType, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogFirmwareVersion=ogFirmwareVersion, ogHostIpV4Address=ogHostIpV4Address, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserHostName=ogHostUserHostName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckIndex=ogCheckIndex, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioEntry=ogEmdDioEntry, ogCheckTable=ogCheckTable, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostPingNotification=ogHostPingNotification, ogCellMessageNotification=ogCellMessageNotification, ogHostEntry=ogHostEntry, ogSerialUserName=ogSerialUserName, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialUserTable=ogSerialUserTable, ogStatus2Compliances=ogStatus2Compliances, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioState=ogEmdDioState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmTime=ogCurrentAlarmTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsHumidity=ogUpsHumidity, ogWifiApClientAp=ogWifiApClientAp, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostName=ogHostName, ogWifiClientCounter=ogWifiClientCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioCounter=ogEmdDioCounter, ogCellModemEntry=ogCellModemEntry, ogCellModemTemperature=ogCellModemTemperature, ogWifiApFrequency=ogWifiApFrequency, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWebUserIndex=ogWebUserIndex, ogUpsType=ogUpsType, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityName=ogEmdHumidityName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmTime=ogAlarmTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRssi=ogWifiClientRssi, ogHostUserName=ogHostUserName, ogWifiClientTable=ogWifiClientTable, ogSerialUserEntry=ogSerialUserEntry, ogSerialNumber=ogSerialNumber, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsIndex=ogUpsIndex, ogCellModemModel=ogCellModemModel, ogRpcInputNotification=ogRpcInputNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientIndex=ogWifiClientIndex, ogRpcTable=ogRpcTable, ogCellModemVendor=ogCellModemVendor, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemIndex=ogCellModemIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTable=ogEmdTable, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortTable=ogSerialPortTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioTable=ogEmdDioTable, ogWifiApEntry=ogWifiApEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortParity=ogSerialPortParity, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmCheck=ogAlarmCheck, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent)
