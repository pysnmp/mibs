...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceCounter=ogHostServiceCounter, ogEmdTable=ogEmdTable, ogWifiApTxPower=ogWifiApTxPower, ogSystem=ogSystem, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceTable=ogHostServiceTable, ogEmdDioType=ogEmdDioType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioCounter=ogEmdDioCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdName=ogEmdName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdEntry=ogEmdEntry, ogCustomNotification=ogCustomNotification, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogHostUserNotification=ogHostUserNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserPort=ogSerialUserPort, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialNumber=ogSerialNumber, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemNetwork=ogCellModemNetwork, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserTable=ogHostUserTable, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemTable=ogCellModemTable, ogRpcDescription=ogRpcDescription, ogAlarmTime=ogAlarmTime, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletEntry=ogRpcOutletEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserIndex=ogSerialUserIndex, ogWebUserName=ogWebUserName, ogStatus2=ogStatus2, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsCounter=ogUpsCounter, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostPingNotification=ogHostPingNotification, ogCellModemEntry=ogCellModemEntry, ogRpcCounter=ogRpcCounter, ogUpsConnectType=ogUpsConnectType, ogAlarmSummary=ogAlarmSummary, ogCellModemCounter=ogCellModemCounter, ogCellMessageNotification=ogCellMessageNotification, ogEmdIndex=ogEmdIndex, ogEmdDioEmd=ogEmdDioEmd, ogRpcIndex=ogRpcIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortCTS=ogSerialPortCTS, ogUpsName=ogUpsName, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogNetInterfaceName=ogNetInterfaceName, ogCheckIndex=ogCheckIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsTemperature=ogUpsTemperature, ogUpsState=ogUpsState, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserHost=ogHostUserHost, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletTable=ogRpcOutletTable, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemApn=ogCellModemApn, ogUpsDescription=ogUpsDescription, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApEntry=ogWifiApEntry, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApInterface=ogWifiApInterface, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcConnectType=ogRpcConnectType, ogEmdConnectType=ogEmdConnectType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckType=ogCheckType, ogEmdDioDirection=ogEmdDioDirection, ogRpcTable=ogRpcTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserStartTime=ogWebUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWebUserIndex=ogWebUserIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortDSR=ogSerialPortDSR, ogCheckTable=ogCheckTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmState=ogCurrentAlarmState, ogHostIpV6Address=ogHostIpV6Address, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsType=ogUpsType, ogRpcOutletState=ogRpcOutletState, ogAlarmState=ogAlarmState, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortIndex=ogSerialPortIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWebUserTable=ogWebUserTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApTable=ogWifiApTable, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsEntry=ogUpsEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogFirmwareVersion=ogFirmwareVersion, ogCheckName=ogCheckName, ogMibNotifications=ogMibNotifications, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryState=ogUpsBatteryState, ogUpsTable=ogUpsTable, ogHostIndex=ogHostIndex, ogRpcType=ogRpcType, ogStatus2Groups=ogStatus2Groups, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckDeviceName=ogCheckDeviceName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserHostName=ogHostUserHostName, ogUpsIndex=ogUpsIndex, ogNetInterfaceType=ogNetInterfaceType, ogCheckResolveActions=ogCheckResolveActions, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceHost=ogHostServiceHost, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostEntry=ogHostEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDescription=ogEmdDescription, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientEntry=ogWifiClientEntry, ogStatus2Conformance=ogStatus2Conformance, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApEnabled=ogWifiApEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApFrequency=ogWifiApFrequency, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServicePort=ogHostServicePort, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemEnabled=ogCellModemEnabled, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioIndex=ogEmdDioIndex, ogWifiApIndex=ogWifiApIndex, ogWebUserNotification=ogWebUserNotification, ogCellModemModel=ogCellModemModel, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyName=ogPowerSupplyName, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceStatus=ogHostServiceStatus, ogCellModemIndex=ogCellModemIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceType=ogHostServiceType, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserTable=ogSerialUserTable, ogRpcName=ogRpcName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioName=ogEmdDioName, ogWifiApClientAp=ogWifiApClientAp, ogAlarmDevice=ogAlarmDevice, ogHostUserAddress=ogHostUserAddress)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemTower=ogCellModemTower, ogAlarmEventId=ogAlarmEventId, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostName=ogHostName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostTable=ogHostTable, ogEmdEnabled=ogEmdEnabled, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmUser=ogAlarmUser, ogEmdDioEntry=ogEmdDioEntry, ogCellModemRegistered=ogCellModemRegistered, ogCheckEntry=ogCheckEntry, ogAlarmType=ogAlarmType, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserName=ogSerialUserName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellDataNotification=ogCellDataNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmCheck=ogAlarmCheck, ogUpsNotification=ogUpsNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientEssid=ogWifiClientEssid, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceState=ogNetInterfaceState, ogAlarm=ogAlarm, PYSNMP_MODULE_ID=ogStatus2, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemTemperature=ogCellModemTemperature, ogHostUserName=ogHostUserName, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellApnNotification=ogCellApnNotification, ogAlarmName=ogAlarmName, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioState=ogEmdDioState, ogWebUserEntry=ogWebUserEntry, ogSerialUserNotification=ogSerialUserNotification, ogHostUserEntry=ogHostUserEntry, ogRpcEntry=ogRpcEntry, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmInstance=ogAlarmInstance, ogUpsOutputPower=ogUpsOutputPower, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortMode=ogSerialPortMode, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletName=ogRpcOutletName, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckResetTimeout=ogCheckResetTimeout)
