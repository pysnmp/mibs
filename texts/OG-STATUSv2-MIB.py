...
Gauge32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, NotificationType, iso, Unsigned32, Counter64, Counter32, Integer32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "Counter64", "Counter32", "Integer32", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletRpc=ogRpcOutletRpc, ogHostIpV6Address=ogHostIpV6Address, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserAddress=ogHostUserAddress, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostIndex=ogHostIndex, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemCounter=ogCellModemCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcTable=ogRpcTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcCounter=ogRpcCounter, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceStatus=ogHostServiceStatus, ogEmdDescription=ogEmdDescription, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemApn=ogCellModemApn, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsType=ogUpsType, ogSerialPortEntry=ogSerialPortEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdEntry=ogEmdEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogStatus2=ogStatus2, ogEmdEnabled=ogEmdEnabled, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostPingNotification=ogHostPingNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsIndex=ogUpsIndex, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTable=ogEmdTable, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientCounter=ogWifiClientCounter, ogMibNotifications=ogMibNotifications, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletTable=ogRpcOutletTable, ogHostUserHostName=ogHostUserHostName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcType=ogRpcType, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioName=ogEmdDioName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsTable=ogUpsTable, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdIndex=ogEmdIndex, ogUpsState=ogUpsState, ogWifiApClientIndex=ogWifiApClientIndex, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortMode=ogSerialPortMode, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortDSR=ogSerialPortDSR, ogHostTable=ogHostTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcConnectType=ogRpcConnectType, ogAlarmState=ogAlarmState, ogHostServiceCounter=ogHostServiceCounter, ogSystem=ogSystem, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletName=ogRpcOutletName, ogCellSignalNotification=ogCellSignalNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmEventId=ogAlarmEventId, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientInterface=ogWifiClientInterface, ogCellApnNotification=ogCellApnNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckResetTimeout=ogCheckResetTimeout, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogFirmwareVersion=ogFirmwareVersion, ogWebUserIndex=ogWebUserIndex, ogWebUserName=ogWebUserName, ogEmdDioTable=ogEmdDioTable, ogSerialPortIndex=ogSerialPortIndex, ogCheckIndex=ogCheckIndex, ogCellModemTower=ogCellModemTower, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioType=ogEmdDioType, ogHostEntry=ogHostEntry, ogWifiApIndex=ogWifiApIndex, ogWebUserNotification=ogWebUserNotification, ogEmdDioEmd=ogEmdDioEmd, ogSerialUserPort=ogSerialUserPort, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioEntry=ogEmdDioEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcName=ogRpcName, ogEmdConnectType=ogEmdConnectType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientTable=ogWifiClientTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcDescription=ogRpcDescription, ogSerialPortTable=ogSerialPortTable, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceState=ogNetInterfaceState, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserEntry=ogSerialUserEntry, ogRpcEntry=ogRpcEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarm=ogAlarm, ogUpsNotification=ogUpsNotification, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostServiceType=ogHostServiceType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientTable=ogWifiApClientTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserTable=ogWebUserTable, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsEntry=ogUpsEntry, ogCheckType=ogCheckType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletState=ogRpcOutletState, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsCounter=ogUpsCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioState=ogEmdDioState, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogCellNetworkNotification=ogCellNetworkNotification, ogCellTowerNotification=ogCellTowerNotification, ogHostUserStartTime=ogHostUserStartTime, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryState=ogUpsBatteryState, ogStatus2Groups=ogStatus2Groups, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemIndex=ogCellModemIndex, ogEmdDioNotification=ogEmdDioNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserHost=ogHostUserHost, ogAlarmName=ogAlarmName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemTable=ogCellModemTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsTemperature=ogUpsTemperature, ogCellModemModel=ogCellModemModel, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServicePort=ogHostServicePort, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortRTS=ogSerialPortRTS, ogCellModemVendor=ogCellModemVendor, ogRpcIndex=ogRpcIndex, ogWifiApEntry=ogWifiApEntry, ogHostServiceTable=ogHostServiceTable, ogUpsInputNotification=ogUpsInputNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemTemperature=ogCellModemTemperature, ogAlarmUser=ogAlarmUser, ogCheckEntry=ogCheckEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserNotification=ogHostUserNotification, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellDataNotification=ogCellDataNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmDevice=ogAlarmDevice, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientApMac=ogWifiClientApMac, ogRpcInputFrequency=ogRpcInputFrequency, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsName=ogUpsName, ogUpsDescription=ogUpsDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientTxPower=ogWifiClientTxPower)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityName=ogEmdHumidityName, ogCellModemRegistered=ogCellModemRegistered, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientMac=ogWifiApClientMac, ogHostUserName=ogHostUserName, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialUserIndex=ogSerialUserIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmLogTable=ogAlarmLogTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogHostName=ogHostName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApTable=ogWifiApTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmCheck=ogAlarmCheck, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmType=ogAlarmType, ogSerialNumber=ogSerialNumber, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdName=ogEmdName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemConnected=ogCellModemConnected, ogUpsHumidity=ogUpsHumidity, ogSerialUserTable=ogSerialUserTable, ogCheckName=ogCheckName, ogUpsConnectType=ogUpsConnectType, ogCustomNotification=ogCustomNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientEntry=ogWifiClientEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmTime=ogAlarmTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserName=ogSerialUserName, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemEntry=ogCellModemEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmSummary=ogAlarmSummary, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioDescription=ogEmdDioDescription, ogHostUserTable=ogHostUserTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceNotification=ogHostServiceNotification, ogCellModemNetwork=ogCellModemNetwork)
