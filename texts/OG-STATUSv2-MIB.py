...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCustomNotification=ogCustomNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientCounter=ogWifiClientCounter, ogHostServicePort=ogHostServicePort, ogCheckResolveActions=ogCheckResolveActions, ogUpsType=ogUpsType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceIndex=ogHostServiceIndex, ogWifiApInterface=ogWifiApInterface, ogCellModemApn=ogCellModemApn, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApTable=ogWifiApTable, ogHostIpV4Address=ogHostIpV4Address, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsIndex=ogUpsIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserHost=ogHostUserHost, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellNetworkNotification=ogCellNetworkNotification, ogNetInterfaceName=ogNetInterfaceName, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmState=ogAlarmState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsHumidity=ogUpsHumidity, ogAlarmSummary=ogAlarmSummary, ogSerialUserNotification=ogSerialUserNotification, ogHostEntry=ogHostEntry, ogHostUserAddress=ogHostUserAddress, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdEntry=ogEmdEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellTowerNotification=ogCellTowerNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputPower=ogUpsOutputPower, ogCheckType=ogCheckType, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryState=ogUpsBatteryState, ogCellModemNetwork=ogCellModemNetwork, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostTable=ogHostTable, ogMibNotifications=ogMibNotifications, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsCounter=ogUpsCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmInstance=ogAlarmInstance, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserTable=ogSerialUserTable, ogRpcEntry=ogRpcEntry, ogEmdDioState=ogEmdDioState, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceHost=ogHostServiceHost, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortMode=ogSerialPortMode, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmDevice=ogAlarmDevice, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortDSR=ogSerialPortDSR, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2=ogStatus2, ogRpcDescription=ogRpcDescription, ogWifiClientBitRate=ogWifiClientBitRate, PYSNMP_MODULE_ID=ogStatus2, ogUpsName=ogUpsName, ogEmdEnabled=ogEmdEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostName=ogHostName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsTemperature=ogUpsTemperature, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApCounter=ogWifiApCounter, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsInputNotification=ogUpsInputNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcName=ogRpcName, ogStatus2Compliances=ogStatus2Compliances, ogHostUserEntry=ogHostUserEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemTable=ogCellModemTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcCounter=ogRpcCounter, ogWifiClientMode=ogWifiClientMode, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDioEmd=ogEmdDioEmd, ogWifiApSsid=ogWifiApSsid, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWebUserTable=ogWebUserTable, ogEmdConnectType=ogEmdConnectType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellApnNotification=ogCellApnNotification, ogEmdTable=ogEmdTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogStatus2Compliance=ogStatus2Compliance, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientTable=ogWifiApClientTable, ogRpcIndex=ogRpcIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceState=ogNetInterfaceState, ogHostServiceTable=ogHostServiceTable, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserName=ogHostUserName, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogStatus2Groups=ogStatus2Groups, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemTemperature=ogCellModemTemperature, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApEnabled=ogWifiApEnabled, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostIndex=ogHostIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortParity=ogSerialPortParity, ogWifiClientEntry=ogWifiClientEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWebUserEntry=ogWebUserEntry, ogAlarmName=ogAlarmName, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserTable=ogHostUserTable, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsLogEnabled=ogUpsLogEnabled, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdName=ogEmdName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortTable=ogSerialPortTable, ogWifiClientApMac=ogWifiClientApMac, ogCellModemModel=ogCellModemModel, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserEntry=ogSerialUserEntry, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemTower=ogCellModemTower, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientEssid=ogWifiClientEssid, ogHostUserNotification=ogHostUserNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogFirmwareVersion=ogFirmwareVersion, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyName=ogPowerSupplyName, ogRpcTable=ogRpcTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioEntry=ogEmdDioEntry, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsNotification=ogUpsNotification, ogUpsDescription=ogUpsDescription, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServiceType=ogHostServiceType, ogWifiApIndex=ogWifiApIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSystem=ogSystem, ogCheckIndex=ogCheckIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioName=ogEmdDioName, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcConnectType=ogRpcConnectType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdIndex=ogEmdIndex, ogEmdDioDescription=ogEmdDioDescription, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckTable=ogCheckTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmUser=ogAlarmUser, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientInterface=ogWifiClientInterface, ogSerialNumber=ogSerialNumber)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellDataNotification=ogCellDataNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcType=ogRpcType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioType=ogEmdDioType, ogHostUserStartTime=ogHostUserStartTime, ogCellModemCounter=ogCellModemCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogHostPingNotification=ogHostPingNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsEntry=ogUpsEntry, ogHostUserHostName=ogHostUserHostName, ogAlarmType=ogAlarmType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserName=ogWebUserName, ogAlarm=ogAlarm, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckName=ogCheckName, ogEmdDioIndex=ogEmdDioIndex, ogAlarmEventId=ogAlarmEventId, ogAlarmTime=ogAlarmTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioDirection=ogEmdDioDirection, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserName=ogSerialUserName, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortRTS=ogSerialPortRTS, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckEntry=ogCheckEntry, ogSerialUserPort=ogSerialUserPort, ogCellModemEnabled=ogCellModemEnabled, ogCellModemRegistered=ogCellModemRegistered, ogCellModem4gRssi=ogCellModem4gRssi, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemEntry=ogCellModemEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletState=ogRpcOutletState, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcInputNotification=ogRpcInputNotification, ogWebUserNotification=ogWebUserNotification, ogUpsTable=ogUpsTable, ogEmdHumidityName=ogEmdHumidityName, ogUpsState=ogUpsState, ogSerialPortCTS=ogSerialPortCTS, ogWebUserIndex=ogWebUserIndex, ogEmdDescription=ogEmdDescription, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioTable=ogEmdDioTable, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserStartTime=ogWebUserStartTime, ogHostUserIndex=ogHostUserIndex, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioCounter=ogEmdDioCounter, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPatternNotification=ogSerialPatternNotification)
