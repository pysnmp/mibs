...
Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, TimeTicks, ObjectIdentity, Counter64, iso, IpAddress, Gauge32, MibIdentifier, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "TimeTicks", "ObjectIdentity", "Counter64", "iso", "IpAddress", "Gauge32", "MibIdentifier", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemIMSI=ogCellModemIMSI, ogSerialNumber=ogSerialNumber, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioName=ogEmdDioName, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsEntry=ogUpsEntry, ogWebUserIndex=ogWebUserIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceTable=ogHostServiceTable, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServiceType=ogHostServiceType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTable=ogEmdTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemIndex=ogCellModemIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortMode=ogSerialPortMode, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioTable=ogEmdDioTable, ogWifiClientApMac=ogWifiClientApMac, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmEventId=ogAlarmEventId, ogUpsTable=ogUpsTable, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemTable=ogCellModemTable, ogSerialUserNotification=ogSerialUserNotification, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmType=ogCurrentAlarmType, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceHost=ogHostServiceHost, ogRpcDescription=ogRpcDescription, ogWifiClientTable=ogWifiClientTable, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdName=ogEmdName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdConnectType=ogEmdConnectType, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemApn=ogCellModemApn, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioEntry=ogEmdDioEntry, ogWifiApTxPower=ogWifiApTxPower, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserTable=ogHostUserTable, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemTower=ogCellModemTower, ogCustomNotification=ogCustomNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWebUserNotification=ogWebUserNotification, ogHostUserNotification=ogHostUserNotification, ogAlarmName=ogAlarmName, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDescription=ogEmdDescription, ogWifiClientCounter=ogWifiClientCounter, ogAlarmTime=ogAlarmTime, ogEmdHumidityIndex=ogEmdHumidityIndex, ogStatus2Groups=ogStatus2Groups, ogUpsHumidity=ogUpsHumidity, ogRpcOutletTable=ogRpcOutletTable, ogEmdEntry=ogEmdEntry, ogRpcType=ogRpcType, ogWifiClientMode=ogWifiClientMode, ogCheckName=ogCheckName, ogStatus2Compliances=ogStatus2Compliances, ogWifiApClientAp=ogWifiApClientAp, ogCellModemConnected=ogCellModemConnected, ogCellModemRegistered=ogCellModemRegistered, ogCellModemNetwork=ogCellModemNetwork, ogMibNotifications=ogMibNotifications, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioDirection=ogEmdDioDirection, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostTable=ogHostTable, ogRpcCounter=ogRpcCounter, ogHostServiceCounter=ogHostServiceCounter, ogCellTowerNotification=ogCellTowerNotification, ogRpcTable=ogRpcTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDTR=ogSerialPortDTR, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApSsid=ogWifiApSsid, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsName=ogUpsName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarm=ogAlarm, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApTable=ogWifiApTable, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioState=ogEmdDioState, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioEmd=ogEmdDioEmd, ogUpsCounter=ogUpsCounter, ogAlarmInstance=ogAlarmInstance, ogCheckIndex=ogCheckIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyName=ogPowerSupplyName, ogHostPingNotification=ogHostPingNotification, ogWifiClientIndex=ogWifiClientIndex, ogWebUserName=ogWebUserName, ogEmdDioCounter=ogEmdDioCounter, ogUpsNotification=ogUpsNotification, ogAlarmState=ogAlarmState, ogCellModemVendor=ogCellModemVendor, ogCheckTable=ogCheckTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserName=ogSerialUserName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserAddress=ogHostUserAddress, ogAlarmCheck=ogAlarmCheck, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortCTS=ogSerialPortCTS, ogHostUserIndex=ogHostUserIndex, ogUpsTemperature=ogUpsTemperature, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientRssi=ogWifiClientRssi, ogHostUserHost=ogHostUserHost, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserEntry=ogWebUserEntry, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioIndex=ogEmdDioIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostServicePort=ogHostServicePort, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellDataNotification=ogCellDataNotification, ogUpsType=ogUpsType, ogHostEntry=ogHostEntry, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellApnNotification=ogCellApnNotification, ogWifiApCounter=ogWifiApCounter, ogSerialPortParity=ogSerialPortParity, ogHostServiceStatus=ogHostServiceStatus, ogEmdIndex=ogEmdIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortTable=ogSerialPortTable, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckDeviceTable=ogCheckDeviceTable, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostName=ogHostName, ogRpcIndex=ogRpcIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckResolveActions=ogCheckResolveActions, ogRpcConnectType=ogRpcConnectType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcName=ogRpcName, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2=ogStatus2, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcInputNotification=ogRpcInputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcEntry=ogRpcEntry, ogSerialUserPort=ogSerialUserPort, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckType=ogCheckType, ogSystem=ogSystem, ogRpcOutletState=ogRpcOutletState, ogHostUserHostName=ogHostUserHostName, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortEntry=ogSerialPortEntry, ogNetInterfaceState=ogNetInterfaceState, ogCellModemEntry=ogCellModemEntry, ogCheckEntry=ogCheckEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, PYSNMP_MODULE_ID=ogStatus2, ogAlarmUser=ogAlarmUser, ogWebUserTable=ogWebUserTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortLabel=ogSerialPortLabel, ogCellModemCounter=ogCellModemCounter, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmDevice=ogAlarmDevice, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApInterface=ogWifiApInterface, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserName=ogHostUserName, ogCellModemModel=ogCellModemModel, ogWifiApClientMac=ogWifiApClientMac, ogAlarmSummary=ogAlarmSummary, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioType=ogEmdDioType, ogAlarmType=ogAlarmType, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsState=ogUpsState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdEnabled=ogEmdEnabled, ogHostIndex=ogHostIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsDescription=ogUpsDescription, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortDSR=ogSerialPortDSR, ogUpsIndex=ogUpsIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortRTS=ogSerialPortRTS)
