...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsDescription=ogUpsDescription, ogAlarmCheck=ogAlarmCheck, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemNetwork=ogCellModemNetwork, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryState=ogUpsBatteryState, ogStatus2Groups=ogStatus2Groups, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostIpV4Address=ogHostIpV4Address, ogHostUserName=ogHostUserName, ogHostServicePort=ogHostServicePort, ogSystem=ogSystem, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmDevice=ogAlarmDevice, ogCellModemTable=ogCellModemTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserTable=ogWebUserTable, ogEmdDioCounter=ogEmdDioCounter, ogSerialUserNotification=ogSerialUserNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioNotification=ogEmdDioNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdIndex=ogEmdIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsName=ogUpsName, ogCellModemIndex=ogCellModemIndex, ogCellModemRegistered=ogCellModemRegistered, ogCellModemApn=ogCellModemApn, ogUpsOutputTruePower=ogUpsOutputTruePower, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcEntry=ogRpcEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckName=ogCheckName, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemEntry=ogCellModemEntry, ogHostIndex=ogHostIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckEntry=ogCheckEntry, ogAlarmUser=ogAlarmUser, ogWifiClientApMac=ogWifiClientApMac, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserStartTime=ogHostUserStartTime, ogEmdEntry=ogEmdEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceCounter=ogHostServiceCounter, ogWifiApIndex=ogWifiApIndex, ogCellTowerNotification=ogCellTowerNotification, ogUpsTable=ogUpsTable, ogRpcIndex=ogRpcIndex, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceTable=ogHostServiceTable, ogSerialPortDSR=ogSerialPortDSR, ogUpsNotification=ogUpsNotification, ogCheckDeviceName=ogCheckDeviceName, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioState=ogEmdDioState, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostTable=ogHostTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientRssi=ogWifiClientRssi, ogHostUserHostName=ogHostUserHostName, ogUpsIndex=ogUpsIndex, ogWifiClientEssid=ogWifiClientEssid, ogMibNotifications=ogMibNotifications, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTable=ogEmdTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogHostName=ogHostName, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortTable=ogSerialPortTable, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserName=ogSerialUserName, ogHostPingNotification=ogHostPingNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemConnected=ogCellModemConnected, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserEntry=ogWebUserEntry, ogEmdDescription=ogEmdDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcName=ogRpcName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsInputNotification=ogUpsInputNotification, ogPowerSupplyName=ogPowerSupplyName, ogHostUserEntry=ogHostUserEntry, ogHostUserAddress=ogHostUserAddress, ogCellModemCounter=ogCellModemCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientFrequency=ogWifiClientFrequency, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmName=ogAlarmName, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceState=ogNetInterfaceState, ogRpcCounter=ogRpcCounter, ogStatus2=ogStatus2, ogWebUserSourcePort=ogWebUserSourcePort, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemIMSI=ogCellModemIMSI, ogHostUserTable=ogHostUserTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsConnectType=ogUpsConnectType, ogRpcTable=ogRpcTable, ogCellModemModel=ogCellModemModel, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellDataNotification=ogCellDataNotification, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckIndex=ogCheckIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioTable=ogEmdDioTable, ogWifiApTable=ogWifiApTable, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmInstance=ogAlarmInstance, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcType=ogRpcType, ogWifiApSsid=ogWifiApSsid, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmTime=ogAlarmTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioName=ogEmdDioName, ogCellModemTower=ogCellModemTower, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmEventId=ogAlarmEventId, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientMode=ogWifiClientMode, ogUpsType=ogUpsType, ogUpsInputFrequency=ogUpsInputFrequency, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApTxPower=ogWifiApTxPower, ogHostEntry=ogHostEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApFrequency=ogWifiApFrequency, ogCellApnNotification=ogCellApnNotification, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortDCD=ogSerialPortDCD, ogWebUserName=ogWebUserName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioEmd=ogEmdDioEmd, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortMode=ogSerialPortMode, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortLabel=ogSerialPortLabel, ogUpsHumidity=ogUpsHumidity, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialNumber=ogSerialNumber, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientTable=ogWifiClientTable, ogWifiClientIndex=ogWifiClientIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletName=ogRpcOutletName, ogAlarmSummary=ogAlarmSummary, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioDescription=ogEmdDioDescription, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckType=ogCheckType, ogEmdDioDirection=ogEmdDioDirection, ogHostServiceType=ogHostServiceType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsCounter=ogUpsCounter, ogUpsState=ogUpsState, ogStatus2Compliances=ogStatus2Compliances)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortParity=ogSerialPortParity, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemVendor=ogCellModemVendor, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarm=ogAlarm, ogSerialPortEntry=ogSerialPortEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2Conformance=ogStatus2Conformance, ogEmdName=ogEmdName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortIndex=ogSerialPortIndex, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCustomNotification=ogCustomNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApEnabled=ogWifiApEnabled, ogHostUserIndex=ogHostUserIndex, ogRpcOutletTable=ogRpcOutletTable, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmType=ogAlarmType, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdEnabled=ogEmdEnabled, ogAlarmState=ogAlarmState, ogEmdDioType=ogEmdDioType, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcConnectType=ogRpcConnectType, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientCounter=ogWifiClientCounter, ogCheckTable=ogCheckTable, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcDescription=ogRpcDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientMac=ogWifiApClientMac, ogSerialUserIndex=ogSerialUserIndex, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceHost=ogHostServiceHost, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientRssi=ogWifiApClientRssi, PYSNMP_MODULE_ID=ogStatus2, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsEntry=ogUpsEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserHost=ogHostUserHost, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientInterface=ogWifiClientInterface, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage)
