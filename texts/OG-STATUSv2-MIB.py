...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Gauge32, iso, MibIdentifier, Unsigned32, TimeTicks, NotificationType, Integer32, Counter64, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Gauge32", "iso", "MibIdentifier", "Unsigned32", "TimeTicks", "NotificationType", "Integer32", "Counter64", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApEnabled=ogWifiApEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellSignalNotification=ogCellSignalNotification, ogHostServiceIndex=ogHostServiceIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceStatus=ogHostServiceStatus, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputNotification=ogUpsOutputNotification, ogHostName=ogHostName, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsEntry=ogUpsEntry, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortParity=ogSerialPortParity, ogEmdDioType=ogEmdDioType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceType=ogHostServiceType, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortEntry=ogSerialPortEntry, ogHostUserHost=ogHostUserHost, ogCustomNotification=ogCustomNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemTower=ogCellModemTower, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemModel=ogCellModemModel, ogWifiClientTable=ogWifiClientTable, ogUpsType=ogUpsType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceHost=ogHostServiceHost, ogUpsInputFrequency=ogUpsInputFrequency, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemEntry=ogCellModemEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientRssi=ogWifiClientRssi, ogAlarmInstance=ogAlarmInstance, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientEntry=ogWifiClientEntry, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioTable=ogEmdDioTable, ogWifiClientMode=ogWifiClientMode, ogUpsLogEnabled=ogUpsLogEnabled, ogHostServiceCounter=ogHostServiceCounter, ogCellTowerNotification=ogCellTowerNotification, ogHostUserHostName=ogHostUserHostName, ogCellModemIMSI=ogCellModemIMSI, ogStatus2=ogStatus2, ogUpsState=ogUpsState, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutputNotification=ogRpcOutputNotification, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletTable=ogRpcOutletTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApTable=ogWifiApTable, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsTemperature=ogUpsTemperature, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellApnNotification=ogCellApnNotification, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckType=ogCheckType, ogRpcIndex=ogRpcIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientMac=ogWifiApClientMac, ogNetInterfaceName=ogNetInterfaceName, ogWebUserName=ogWebUserName, ogSerialUserNotification=ogSerialUserNotification, ogWifiApEntry=ogWifiApEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemTable=ogCellModemTable, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortIndex=ogSerialPortIndex, ogCellModemVendor=ogCellModemVendor, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsDescription=ogUpsDescription, ogEmdDioName=ogEmdDioName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceName=ogCheckDeviceName, ogUpsTable=ogUpsTable, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdName=ogEmdName, ogAlarmLogTable=ogAlarmLogTable, ogAlarmSummary=ogAlarmSummary, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcEntry=ogRpcEntry, ogEmdDioNotification=ogEmdDioNotification, ogRpcType=ogRpcType, ogWifiApClientTable=ogWifiApClientTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserIndex=ogWebUserIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcName=ogRpcName, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemTemperature=ogCellModemTemperature, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckIndex=ogCheckIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostIndex=ogHostIndex, ogRpcCounter=ogRpcCounter, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientAp=ogWifiApClientAp, ogCheckTable=ogCheckTable, ogStatus2Conformance=ogStatus2Conformance, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellDataNotification=ogCellDataNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTable=ogEmdTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDioDescription=ogEmdDioDescription, ogCellModemCounter=ogCellModemCounter, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialNumber=ogSerialNumber, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserTable=ogWebUserTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDioCounter=ogEmdDioCounter, ogHostUserAddress=ogHostUserAddress, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmUser=ogAlarmUser, ogWebUserStartTime=ogWebUserStartTime, ogCellModemIndex=ogCellModemIndex, ogRpcDescription=ogRpcDescription, ogHostUserStartTime=ogHostUserStartTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserEntry=ogWebUserEntry, ogStatus2Compliance=ogStatus2Compliance, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdEnabled=ogEmdEnabled, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostEntry=ogHostEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserPort=ogSerialUserPort, ogRpcOutletName=ogRpcOutletName, ogAlarmType=ogAlarmType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserIndex=ogSerialUserIndex, ogNetInterfaceState=ogNetInterfaceState, ogWebUserNotification=ogWebUserNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsHumidity=ogUpsHumidity, ogRpcOutletTotal=ogRpcOutletTotal, ogSystem=ogSystem, ogWifiApCounter=ogWifiApCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortMode=ogSerialPortMode, ogEmdIndex=ogEmdIndex, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioEmd=ogEmdDioEmd, ogWifiApSsid=ogWifiApSsid, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserName=ogHostUserName, ogHostUserTable=ogHostUserTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostServicePort=ogHostServicePort, ogCheckResolveActions=ogCheckResolveActions, ogEmdConnectType=ogEmdConnectType, ogCheckName=ogCheckName, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientInterface=ogWifiClientInterface, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmEventId=ogAlarmEventId, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientCounter=ogWifiClientCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemRegistered=ogCellModemRegistered, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogHostPingNotification=ogHostPingNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarm=ogAlarm, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApInterface=ogWifiApInterface, ogAlarmState=ogAlarmState, ogAlarmName=ogAlarmName, ogAlarmTime=ogAlarmTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceTable=ogHostServiceTable, ogSerialUserName=ogSerialUserName, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryState=ogUpsBatteryState, ogRpcTable=ogRpcTable, ogCheckEntry=ogCheckEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemApn=ogCellModemApn, ogMibNotifications=ogMibNotifications, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogStatus2Groups=ogStatus2Groups, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDescription=ogEmdDescription, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceNotification=ogHostServiceNotification, ogUpsCounter=ogUpsCounter, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioState=ogEmdDioState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostTable=ogHostTable, ogWifiApIndex=ogWifiApIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsName=ogUpsName, ogCellModemEnabled=ogCellModemEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserNotification=ogHostUserNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsNotification=ogUpsNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsIndex=ogUpsIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdEntry=ogEmdEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsConnectType=ogUpsConnectType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientIndex=ogWifiApClientIndex)
