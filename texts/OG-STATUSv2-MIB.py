...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserEntry=ogSerialUserEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserEntry=ogHostUserEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckType=ogCheckType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemModel=ogCellModemModel, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckIndex=ogCheckIndex, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioState=ogEmdDioState, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModemConnected=ogCellModemConnected, ogEmdDioEmd=ogEmdDioEmd, ogSerialUserLabel=ogSerialUserLabel, ogCellModemEntry=ogCellModemEntry, ogEmdDioNotification=ogEmdDioNotification, ogHostServiceIndex=ogHostServiceIndex, ogStatus2=ogStatus2, ogWifiApInterface=ogWifiApInterface, ogUpsCounter=ogUpsCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsState=ogUpsState, ogCellModemRegistered=ogCellModemRegistered, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserHostName=ogHostUserHostName, ogSerialUserName=ogSerialUserName, ogWebUserNotification=ogWebUserNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogMibNotifications=ogMibNotifications, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmInstance=ogAlarmInstance, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckName=ogCheckName, ogUpsInputNotification=ogUpsInputNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemNetwork=ogCellModemNetwork, ogHostUserStartTime=ogHostUserStartTime, PYSNMP_MODULE_ID=ogStatus2, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsNotification=ogUpsNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientTable=ogWifiClientTable, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceEntry=ogHostServiceEntry, ogAlarmType=ogAlarmType, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmUser=ogAlarmUser, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmTime=ogAlarmTime, ogPowerSupplyName=ogPowerSupplyName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientMac=ogWifiApClientMac, ogStatus2Compliances=ogStatus2Compliances, ogCellModemTower=ogCellModemTower, ogHostServicePort=ogHostServicePort, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioName=ogEmdDioName, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsIndex=ogUpsIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioTable=ogEmdDioTable, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckEntry=ogCheckEntry, ogAlarm=ogAlarm, ogWifiApTxPower=ogWifiApTxPower, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientEntry=ogWifiClientEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApCounter=ogWifiApCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortTable=ogSerialPortTable, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostServiceStatus=ogHostServiceStatus, ogWebUserTable=ogWebUserTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsConnectType=ogUpsConnectType, ogHostUserTable=ogHostUserTable, ogRpcDescription=ogRpcDescription, ogUpsEntry=ogUpsEntry, ogCellModemIMSI=ogCellModemIMSI, ogUpsType=ogUpsType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientApMac=ogWifiClientApMac, ogSerialUserStartTime=ogSerialUserStartTime, ogCustomNotification=ogCustomNotification, ogHostServiceType=ogHostServiceType, ogRpcTable=ogRpcTable, ogWebUserName=ogWebUserName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostName=ogHostName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientIndex=ogWifiClientIndex, ogHostServiceCounter=ogHostServiceCounter, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdHumidityDescription=ogEmdHumidityDescription, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApSsid=ogWifiApSsid, ogSerialPortLabel=ogSerialPortLabel, ogWifiApTable=ogWifiApTable, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceNotification=ogHostServiceNotification, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApIndex=ogWifiApIndex, ogCellTowerNotification=ogCellTowerNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserIndex=ogWebUserIndex, ogRpcConnectType=ogRpcConnectType, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcType=ogRpcType, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletState=ogRpcOutletState, ogRpcEntry=ogRpcEntry, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortParity=ogSerialPortParity, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmLogTable=ogAlarmLogTable, ogEmdIndex=ogEmdIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientAp=ogWifiApClientAp, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialNumber=ogSerialNumber, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdName=ogEmdName, ogUpsName=ogUpsName, ogCellModemIndex=ogCellModemIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogHostTable=ogHostTable, ogCellModemVendor=ogCellModemVendor, ogCellModemTable=ogCellModemTable, ogWifiClientRssi=ogWifiClientRssi, ogCellNetworkNotification=ogCellNetworkNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmEventId=ogAlarmEventId, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSystem=ogSystem, ogStatus2Groups=ogStatus2Groups, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmName=ogAlarmName, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTable=ogEmdTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceTable=ogHostServiceTable, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcName=ogRpcName, ogCellModemApn=ogCellModemApn, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserName=ogHostUserName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostIndex=ogHostIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsLogEnabled=ogUpsLogEnabled, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioCounter=ogEmdDioCounter, ogStatus2Conformance=ogStatus2Conformance, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDescription=ogEmdDescription, ogCellDataNotification=ogCellDataNotification, ogSerialPortMode=ogSerialPortMode, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientEntry=ogWifiApClientEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientTable=ogWifiApClientTable, ogUpsTemperature=ogUpsTemperature, ogHostIpV4Address=ogHostIpV4Address, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmUser=ogCurrentAlarmUser)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceHost=ogHostServiceHost, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserAddress=ogHostUserAddress, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsDescription=ogUpsDescription, ogEmdDioType=ogEmdDioType, ogSerialUserTable=ogSerialUserTable, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcIndex=ogRpcIndex, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserEntry=ogWebUserEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApEnabled=ogWifiApEnabled, ogCellApnNotification=ogCellApnNotification, ogEmdDioDescription=ogEmdDioDescription, ogAlarmState=ogAlarmState, ogSerialPortIndex=ogSerialPortIndex, ogRpcCounter=ogRpcCounter, ogSerialUserPort=ogSerialUserPort, ogRpcOutletIndex=ogRpcOutletIndex, ogHostEntry=ogHostEntry, ogWifiClientInterface=ogWifiClientInterface, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdEnabled=ogEmdEnabled, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdConnectType=ogEmdConnectType, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWebUserStartTime=ogWebUserStartTime, ogCheckDeviceName=ogCheckDeviceName, ogHostUserHost=ogHostUserHost, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientMode=ogWifiClientMode, ogAlarmCheck=ogAlarmCheck, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdEntry=ogEmdEntry, ogUpsTable=ogUpsTable, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioDirection=ogEmdDioDirection, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApEntry=ogWifiApEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckTable=ogCheckTable, ogWifiClientCounter=ogWifiClientCounter, ogStatus2Compliance=ogStatus2Compliance)
