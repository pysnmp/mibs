...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcDescription=ogRpcDescription, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientTable=ogWifiClientTable, ogHostUserTable=ogHostUserTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWebUserTable=ogWebUserTable, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApInterface=ogWifiApInterface, ogEmdDioType=ogEmdDioType, ogUpsHumidity=ogUpsHumidity, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserPort=ogSerialUserPort, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckType=ogCheckType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortRxBytes=ogSerialPortRxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientApMac=ogWifiClientApMac, ogSerialUserIndex=ogSerialUserIndex, ogCellModemCounter=ogCellModemCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsType=ogUpsType, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsTemperature=ogUpsTemperature, ogRpcOutletName=ogRpcOutletName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientMac=ogWifiApClientMac, ogCellModemTower=ogCellModemTower, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserNotification=ogWebUserNotification, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortParity=ogSerialPortParity, ogRpcOutputNotification=ogRpcOutputNotification, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletTable=ogRpcOutletTable, ogEmdEntry=ogEmdEntry, ogHostUserHost=ogHostUserHost, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcIndex=ogRpcIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogHostPingNotification=ogHostPingNotification, ogAlarmInstance=ogAlarmInstance, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsName=ogUpsName, ogWifiClientInterface=ogWifiClientInterface, ogSerialNumber=ogSerialNumber, ogRpcEntry=ogRpcEntry, ogEmdDioDescription=ogEmdDioDescription, ogAlarm=ogAlarm, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserNotification=ogSerialUserNotification, ogMibNotifications=ogMibNotifications, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostName=ogHostName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialUserEntry=ogSerialUserEntry, ogRpcName=ogRpcName, ogEmdDioEntry=ogEmdDioEntry, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserAddress=ogHostUserAddress, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmInstance=ogCurrentAlarmInstance, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellTowerNotification=ogCellTowerNotification, ogHostServicePort=ogHostServicePort, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemTable=ogCellModemTable, ogHostEntry=ogHostEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsNotification=ogUpsNotification, ogCellModemVendor=ogCellModemVendor, ogAlarmEventId=ogAlarmEventId, ogSerialSignalNotification=ogSerialSignalNotification, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioState=ogEmdDioState, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryState=ogUpsBatteryState, ogCellModemTemperature=ogCellModemTemperature, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCustomNotification=ogCustomNotification, ogUpsCounter=ogUpsCounter, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioDirection=ogEmdDioDirection, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSystem=ogSystem, ogCheckIndex=ogCheckIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcConnectType=ogRpcConnectType, ogCellModemIndex=ogCellModemIndex, ogEmdDescription=ogEmdDescription, ogWebUserIndex=ogWebUserIndex, ogSerialPortIndex=ogSerialPortIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcType=ogRpcType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserHostName=ogHostUserHostName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientMode=ogWifiClientMode, ogWifiClientRssi=ogWifiClientRssi, ogStatus2=ogStatus2, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmDevice=ogAlarmDevice, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletState=ogRpcOutletState, ogAlarmCheck=ogAlarmCheck, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortTable=ogSerialPortTable, ogWebUserEntry=ogWebUserEntry, ogHostIpV4Address=ogHostIpV4Address, ogCellSignalNotification=ogCellSignalNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostIpV6Address=ogHostIpV6Address, ogUpsEntry=ogUpsEntry, ogEmdEnabled=ogEmdEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApTxPower=ogWifiApTxPower, ogAlarmType=ogAlarmType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioTable=ogEmdDioTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientAp=ogWifiApClientAp, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostServiceType=ogHostServiceType, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortMode=ogSerialPortMode, ogEmdName=ogEmdName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialUserLabel=ogSerialUserLabel, ogCellModemRegistered=ogCellModemRegistered, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckDeviceName=ogCheckDeviceName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientTable=ogWifiApClientTable, ogUpsDescription=ogUpsDescription, ogCellModemConnected=ogCellModemConnected, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostTable=ogHostTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserName=ogHostUserName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsIndex=ogUpsIndex, ogCellModemModel=ogCellModemModel, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemApn=ogCellModemApn, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmLogTable=ogAlarmLogTable, ogHostServiceIndex=ogHostServiceIndex, ogWifiApCounter=ogWifiApCounter, ogHostServiceTable=ogHostServiceTable, ogEmdTable=ogEmdTable, ogAlarmSummary=ogAlarmSummary, ogUpsState=ogUpsState, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioIndex=ogEmdDioIndex, ogCheckName=ogCheckName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialUserName=ogSerialUserName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApEntry=ogWifiApEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemEnabled=ogCellModemEnabled)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserNotification=ogHostUserNotification, ogSerialPortRTS=ogSerialPortRTS, ogWifiApSsid=ogWifiApSsid, ogCheckTable=ogCheckTable, ogSerialPortCTS=ogSerialPortCTS, ogCellModemNetwork=ogCellModemNetwork, ogHostServiceStatus=ogHostServiceStatus, ogRpcInputNotification=ogRpcInputNotification, ogCellModemIMSI=ogCellModemIMSI, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApTable=ogWifiApTable, ogEmdIndex=ogEmdIndex, ogUpsTable=ogUpsTable, ogAlarmTime=ogAlarmTime, ogSerialPortDataBits=ogSerialPortDataBits, ogCheckEntry=ogCheckEntry, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientEntry=ogWifiClientEntry, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserStartTime=ogHostUserStartTime, ogHostServiceNotification=ogHostServiceNotification, ogWebUserName=ogWebUserName, ogWifiClientBitRate=ogWifiClientBitRate, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmUser=ogAlarmUser, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmName=ogAlarmName, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostIndex=ogHostIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcCounter=ogRpcCounter, ogUpsOutputPower=ogUpsOutputPower, ogUpsConnectType=ogUpsConnectType, ogRpcTable=ogRpcTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioName=ogEmdDioName, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmState=ogAlarmState, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcOutletVoltage=ogRpcOutletVoltage)
