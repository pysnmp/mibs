...
TimeTicks, Counter64, MibIdentifier, iso, Integer32, Gauge32, Bits, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "MibIdentifier", "iso", "Integer32", "Gauge32", "Bits", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsState=ogUpsState, ogAlarmCheck=ogAlarmCheck, ogUpsNotification=ogUpsNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmLogTable=ogAlarmLogTable, ogHostServiceNotification=ogHostServiceNotification, ogMibNotifications=ogMibNotifications, ogCellModemModel=ogCellModemModel, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcIndex=ogRpcIndex, ogEmdDioDirection=ogEmdDioDirection, ogCellApnNotification=ogCellApnNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortParity=ogSerialPortParity, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDescription=ogEmdDescription, ogSerialNumber=ogSerialNumber, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApIndex=ogWifiApIndex, ogRpcTable=ogRpcTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcConnectType=ogRpcConnectType, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostUserIndex=ogHostUserIndex, ogRpcOutletState=ogRpcOutletState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmSummary=ogAlarmSummary, ogCheckIndex=ogCheckIndex, ogHostServiceType=ogHostServiceType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserName=ogHostUserName, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcName=ogRpcName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceIndex=ogHostServiceIndex, ogRpcEntry=ogRpcEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckName=ogCheckName, ogHostUserHostName=ogHostUserHostName, ogSerialPortTable=ogSerialPortTable, ogEmdDioName=ogEmdDioName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckEntry=ogCheckEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmEventId=ogAlarmEventId, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApCounter=ogWifiApCounter, ogSerialPortMode=ogSerialPortMode, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsHumidity=ogUpsHumidity, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioIndex=ogEmdDioIndex, ogUpsInputNotification=ogUpsInputNotification, ogHostTable=ogHostTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsDescription=ogUpsDescription, ogCheckTable=ogCheckTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApEntry=ogWifiApEntry, ogNetInterfaceType=ogNetInterfaceType, ogPowerSupplyName=ogPowerSupplyName, ogCellModemApn=ogCellModemApn, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcLogEnabled=ogRpcLogEnabled, ogSystem=ogSystem, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemTable=ogCellModemTable, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogNetInterfaceName=ogNetInterfaceName, ogHostServicePort=ogHostServicePort, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserLabel=ogSerialUserLabel, ogCellModemIndex=ogCellModemIndex, ogRpcCounter=ogRpcCounter, ogWebUserNotification=ogWebUserNotification, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogCustomNotification=ogCustomNotification, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostEntry=ogHostEntry, ogEmdConnectType=ogEmdConnectType, ogFirmwareVersion=ogFirmwareVersion, ogHostUserEntry=ogHostUserEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserEntry=ogWebUserEntry, ogWifiApSsid=ogWifiApSsid, ogHostUserHost=ogHostUserHost, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsTable=ogUpsTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortRTS=ogSerialPortRTS, ogSerialUserNotification=ogSerialUserNotification, ogHostUserTable=ogHostUserTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemTower=ogCellModemTower, ogEmdIndex=ogEmdIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsIndex=ogUpsIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmInstance=ogAlarmInstance, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceStatus=ogHostServiceStatus, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsEntry=ogUpsEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserTable=ogSerialUserTable, ogHostIndex=ogHostIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmType=ogAlarmType, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioType=ogEmdDioType, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemVendor=ogCellModemVendor, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceEntry=ogHostServiceEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsCounter=ogUpsCounter, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserIndex=ogWebUserIndex, ogAlarmTime=ogAlarmTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsConnectType=ogUpsConnectType, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogStatus2=ogStatus2, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsOutputPower=ogUpsOutputPower, ogAlarmState=ogAlarmState, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRssi=ogWifiClientRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialUserName=ogSerialUserName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWebUserTable=ogWebUserTable, ogCellModemEntry=ogCellModemEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletTable=ogRpcOutletTable, ogUpsType=ogUpsType, ogCellSignalNotification=ogCellSignalNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioTable=ogEmdDioTable, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortEntry=ogSerialPortEntry, ogAlarmUser=ogAlarmUser, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsTemperature=ogUpsTemperature, ogCheckType=ogCheckType, ogHostName=ogHostName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientTable=ogWifiApClientTable, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemIMSI=ogCellModemIMSI, ogHostIpV4Address=ogHostIpV4Address, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApTxPower=ogWifiApTxPower, ogEmdEntry=ogEmdEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2Compliances=ogStatus2Compliances, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTable=ogEmdTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioEmd=ogEmdDioEmd, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApTable=ogWifiApTable, ogWebUserSourceAddress=ogWebUserSourceAddress, PYSNMP_MODULE_ID=ogStatus2, ogHostUserStartTime=ogHostUserStartTime, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioCounter=ogEmdDioCounter, ogEmdHumidityName=ogEmdHumidityName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApInterface=ogWifiApInterface, ogWebUserStartTime=ogWebUserStartTime, ogWebUserName=ogWebUserName, ogEmdDioState=ogEmdDioState, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdName=ogEmdName, ogCellModemConnected=ogCellModemConnected, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientEntry=ogWifiClientEntry, ogCheckResolveActions=ogCheckResolveActions, ogCheckResetTimeout=ogCheckResetTimeout, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcDescription=ogRpcDescription, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioDescription=ogEmdDioDescription, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientMode=ogWifiClientMode, ogWifiApEnabled=ogWifiApEnabled, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserAddress=ogHostUserAddress, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogHostServiceTable=ogHostServiceTable, ogUpsName=ogUpsName, ogNetInterfaceState=ogNetInterfaceState, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServiceHost=ogHostServiceHost, ogRpcType=ogRpcType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogStatus2Groups=ogStatus2Groups, ogEmdEnabled=ogEmdEnabled, ogCellDataNotification=ogCellDataNotification, ogWifiClientApMac=ogWifiClientApMac, ogAlarmName=ogAlarmName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserPort=ogSerialUserPort, ogAlarm=ogAlarm, ogPowerSupplyTable=ogPowerSupplyTable)
