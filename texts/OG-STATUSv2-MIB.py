...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApEntry=ogWifiApEntry, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialUserName=ogSerialUserName, ogEmdDioState=ogEmdDioState, ogUpsEntry=ogUpsEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialSignalNotification=ogSerialSignalNotification, ogMibNotifications=ogMibNotifications, ogEmdHumidityName=ogEmdHumidityName, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2Groups=ogStatus2Groups, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsType=ogUpsType, ogRpcInputNotification=ogRpcInputNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdName=ogEmdName, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientEntry=ogWifiClientEntry, ogEmdConnectType=ogEmdConnectType, ogWifiApTable=ogWifiApTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsInputNotification=ogUpsInputNotification, ogSerialUserEntry=ogSerialUserEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostServicePort=ogHostServicePort, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortDSR=ogSerialPortDSR, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostIndex=ogHostIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserIndex=ogHostUserIndex, ogCellDataNotification=ogCellDataNotification, ogHostUserAddress=ogHostUserAddress, ogCellModemEntry=ogCellModemEntry, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientTable=ogWifiClientTable, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortParity=ogSerialPortParity, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialNumber=ogSerialNumber, ogWifiApEnabled=ogWifiApEnabled, ogCellApnNotification=ogCellApnNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmInstance=ogAlarmInstance, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmState=ogAlarmState, ogWifiApCounter=ogWifiApCounter, ogCheckEntry=ogCheckEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcDescription=ogRpcDescription, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortMode=ogSerialPortMode, ogWifiApSsid=ogWifiApSsid, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceCounter=ogHostServiceCounter, ogCellSignalNotification=ogCellSignalNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientAp=ogWifiApClientAp, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserEntry=ogWebUserEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientRssi=ogWifiClientRssi, ogWifiApTxPower=ogWifiApTxPower, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioType=ogEmdDioType, ogEmdDioName=ogEmdDioName, ogAlarmType=ogAlarmType, ogAlarm=ogAlarm, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCustomNotification=ogCustomNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogStatus2=ogStatus2, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletState=ogRpcOutletState, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputPower=ogUpsOutputPower, ogHostPingNotification=ogHostPingNotification, ogNetInterfaceType=ogNetInterfaceType, ogAlarmEventId=ogAlarmEventId, ogEmdIndex=ogEmdIndex, ogRpcEntry=ogRpcEntry, ogHostIpV4Address=ogHostIpV4Address, PYSNMP_MODULE_ID=ogStatus2, ogHostName=ogHostName, ogEmdDioDescription=ogEmdDioDescription, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTable=ogEmdTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientCounter=ogWifiClientCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApInterface=ogWifiApInterface, ogCheckResolveActions=ogCheckResolveActions, ogCellModemEnabled=ogCellModemEnabled, ogCellModemTable=ogCellModemTable, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserIndex=ogWebUserIndex, ogUpsNotification=ogUpsNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmDevice=ogAlarmDevice, ogRpcTable=ogRpcTable, ogUpsConnectType=ogUpsConnectType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWebUserName=ogWebUserName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortEntry=ogSerialPortEntry, ogUpsHumidity=ogUpsHumidity, ogEmdDioCounter=ogEmdDioCounter, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioEntry=ogEmdDioEntry, ogRpcCounter=ogRpcCounter, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserStartTime=ogSerialUserStartTime, ogHostTable=ogHostTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientMac=ogWifiApClientMac, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsDescription=ogUpsDescription, ogCheckIndex=ogCheckIndex, ogUpsTable=ogUpsTable, ogAlarmUser=ogAlarmUser, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcIndex=ogRpcIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemNetwork=ogCellModemNetwork, ogWebUserNotification=ogWebUserNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletName=ogRpcOutletName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientFrequency=ogWifiClientFrequency, ogSystem=ogSystem, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemModel=ogCellModemModel, ogWifiClientIndex=ogWifiClientIndex, ogCellTowerNotification=ogCellTowerNotification, ogCellModemTower=ogCellModemTower, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckTable=ogCheckTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdEntry=ogEmdEntry, ogAlarmName=ogAlarmName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemApn=ogCellModemApn, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmLogTable=ogAlarmLogTable, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckType=ogCheckType, ogHostUserHost=ogHostUserHost, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdDescription=ogEmdDescription, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostEntry=ogHostEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcName=ogRpcName, ogFirmwareVersion=ogFirmwareVersion, ogAlarmTime=ogAlarmTime, ogCheckResetTimeout=ogCheckResetTimeout)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientApMac=ogWifiClientApMac, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApIndex=ogWifiApIndex, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsTemperature=ogUpsTemperature, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsIndex=ogUpsIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioNotification=ogEmdDioNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsState=ogUpsState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceName=ogCheckDeviceName, ogRpcConnectType=ogRpcConnectType, ogWifiClientMode=ogWifiClientMode, ogHostServiceType=ogHostServiceType, ogUpsCounter=ogUpsCounter, ogStatus2Compliances=ogStatus2Compliances, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckName=ogCheckName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmCheck=ogAlarmCheck, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellMessageNotification=ogCellMessageNotification, ogEmdEnabled=ogEmdEnabled, ogWifiApFrequency=ogWifiApFrequency, ogHostUserName=ogHostUserName, ogCellModemConnected=ogCellModemConnected, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserEntry=ogHostUserEntry, ogRpcType=ogRpcType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostServiceHost=ogHostServiceHost, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsName=ogUpsName, ogAlarmSummary=ogAlarmSummary, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortTable=ogSerialPortTable, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserTable=ogHostUserTable, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioEmd=ogEmdDioEmd, ogHostUserNotification=ogHostUserNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemTemperature=ogCellModemTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletTable=ogRpcOutletTable)
