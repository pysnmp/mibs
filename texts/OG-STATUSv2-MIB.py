...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsHumidity=ogUpsHumidity, ogRpcName=ogRpcName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogMibNotifications=ogMibNotifications, ogHostServiceIndex=ogHostServiceIndex, ogRpcType=ogRpcType, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsDescription=ogUpsDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioEmd=ogEmdDioEmd, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApSsid=ogWifiApSsid, ogEmdDioCounter=ogEmdDioCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTable=ogCellModemTable, ogSerialUserPort=ogSerialUserPort, ogHostServiceEntry=ogHostServiceEntry, ogCheckIndex=ogCheckIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostTable=ogHostTable, ogUpsCounter=ogUpsCounter, ogHostPingNotification=ogHostPingNotification, ogWifiApFrequency=ogWifiApFrequency, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortMode=ogSerialPortMode, ogHostUserHost=ogHostUserHost, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialNumber=ogSerialNumber, ogRpcOutletLoad=ogRpcOutletLoad, ogWebUserNotification=ogWebUserNotification, ogCellModemConnected=ogCellModemConnected, ogRpcTable=ogRpcTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsIndex=ogUpsIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmType=ogAlarmType, ogCellModemIMSI=ogCellModemIMSI, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSystem=ogSystem, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckName=ogCheckName, ogHostServiceCounter=ogHostServiceCounter, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogHostIpV4Address=ogHostIpV4Address, ogCheckEntry=ogCheckEntry, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTable=ogWifiApClientTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmTime=ogAlarmTime, ogEmdDescription=ogEmdDescription, ogRpcCounter=ogRpcCounter, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserName=ogSerialUserName, ogAlarmInstance=ogAlarmInstance, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceType=ogNetInterfaceType, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserEntry=ogWebUserEntry, ogSerialUserTable=ogSerialUserTable, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceTable=ogHostServiceTable, ogWifiApIndex=ogWifiApIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsTemperature=ogUpsTemperature, ogRpcConnectType=ogRpcConnectType, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmLogTable=ogAlarmLogTable, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsName=ogUpsName, ogEmdEnabled=ogEmdEnabled, ogCellModemApn=ogCellModemApn, ogEmdEntry=ogEmdEntry, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApTable=ogWifiApTable, ogUpsNotification=ogUpsNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWebUserTable=ogWebUserTable, ogEmdDioName=ogEmdDioName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortRTS=ogSerialPortRTS, ogCellModemTower=ogCellModemTower, ogHostUserEntry=ogHostUserEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortParity=ogSerialPortParity, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryState=ogUpsBatteryState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTable=ogEmdTable, ogEmdDioType=ogEmdDioType, ogCheckTriggerActions=ogCheckTriggerActions, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostIndex=ogHostIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostEntry=ogHostEntry, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemIndex=ogCellModemIndex, ogEmdName=ogEmdName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWebUserIndex=ogWebUserIndex, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemCounter=ogCellModemCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortDTR=ogSerialPortDTR, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckResetTimeout=ogCheckResetTimeout, ogCellApnNotification=ogCellApnNotification, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcEntry=ogRpcEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmDevice=ogAlarmDevice, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientMode=ogWifiClientMode, ogUpsType=ogUpsType, ogCellModemEntry=ogCellModemEntry, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServicePort=ogHostServicePort, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemVendor=ogCellModemVendor, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceStatus=ogHostServiceStatus, ogRpcIndex=ogRpcIndex, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioDescription=ogEmdDioDescription, ogRpcInputCurrent=ogRpcInputCurrent, PYSNMP_MODULE_ID=ogStatus2, ogUpsTable=ogUpsTable, ogCustomNotification=ogCustomNotification, ogSerialPortCTS=ogSerialPortCTS, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemTemperature=ogCellModemTemperature, ogWebUserName=ogWebUserName, ogCheckType=ogCheckType, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceType=ogHostServiceType, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellSignalNotification=ogCellSignalNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmState=ogAlarmState, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientEssid=ogWifiClientEssid, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientInterface=ogWifiClientInterface, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientApMac=ogWifiClientApMac, ogStatus2Groups=ogStatus2Groups, ogEmdDioTable=ogEmdDioTable, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceName=ogNetInterfaceName, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemRegistered=ogCellModemRegistered, ogEmdIndex=ogEmdIndex, ogEmdDioDirection=ogEmdDioDirection, ogAlarm=ogAlarm, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyTable=ogPowerSupplyTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdConnectType=ogEmdConnectType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmUser=ogAlarmUser, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserIndex=ogHostUserIndex, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemModel=ogCellModemModel, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientMac=ogWifiApClientMac, ogUpsInputNotification=ogUpsInputNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogStatus2=ogStatus2, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyName=ogPowerSupplyName, ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmEventId=ogAlarmEventId, ogStatus2Conformance=ogStatus2Conformance, ogAlarmName=ogAlarmName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmSummary=ogAlarmSummary, ogHostUserNotification=ogHostUserNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsState=ogUpsState, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletName=ogRpcOutletName, ogWifiClientTable=ogWifiClientTable, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserHostName=ogHostUserHostName, ogHostUserName=ogHostUserName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostName=ogHostName, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioState=ogEmdDioState, ogRpcDescription=ogRpcDescription, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceHost=ogHostServiceHost, ogUpsEntry=ogUpsEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityTable=ogEmdHumidityTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserEntry=ogSerialUserEntry, ogHostUserTable=ogHostUserTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogStatus2Compliance=ogStatus2Compliance, ogSerialSignalNotification=ogSerialSignalNotification)
