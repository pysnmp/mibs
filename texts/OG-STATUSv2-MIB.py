...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, ObjectIdentity, ModuleIdentity, NotificationType, Integer32, Counter32, iso, TimeTicks, MibIdentifier, Bits, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Integer32", "Counter32", "iso", "TimeTicks", "MibIdentifier", "Bits", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortMode=ogSerialPortMode, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceTable=ogHostServiceTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostEntry=ogHostEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortRTS=ogSerialPortRTS, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckDeviceName=ogCheckDeviceName, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmType=ogAlarmType, ogCellModemNetwork=ogCellModemNetwork, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserAddress=ogHostUserAddress, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostUserNotification=ogHostUserNotification, ogRpcTable=ogRpcTable, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdEntry=ogEmdEntry, ogSerialPortLabel=ogSerialPortLabel, ogHostUserHost=ogHostUserHost, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortTable=ogSerialPortTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserStartTime=ogHostUserStartTime, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceNotification=ogHostServiceNotification, ogStatus2=ogStatus2, ogCheckName=ogCheckName, ogUpsEntry=ogUpsEntry, ogWebUserNotification=ogWebUserNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemTable=ogCellModemTable, ogAlarmUser=ogAlarmUser, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemTower=ogCellModemTower, ogUpsType=ogUpsType, ogCellTowerNotification=ogCellTowerNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogHostName=ogHostName, ogNetInterfaceState=ogNetInterfaceState, ogCellModemIMSI=ogCellModemIMSI, ogAlarm=ogAlarm, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsHumidity=ogUpsHumidity, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsConnectType=ogUpsConnectType, ogEmdDioNotification=ogEmdDioNotification, ogWebUserTable=ogWebUserTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdName=ogEmdName, ogCellDataNotification=ogCellDataNotification, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletVoltage=ogRpcOutletVoltage, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioTable=ogEmdDioTable, ogCellModemConnected=ogCellModemConnected, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmInstance=ogAlarmInstance, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcCounter=ogRpcCounter, ogHostTable=ogHostTable, ogCellModemModel=ogCellModemModel, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmDevice=ogAlarmDevice, ogAlarmState=ogAlarmState, ogSerialNumber=ogSerialNumber, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsCounter=ogUpsCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmCheck=ogAlarmCheck, ogSerialUserLabel=ogSerialUserLabel, ogCheckTable=ogCheckTable, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdIndex=ogEmdIndex, ogAlarmEventId=ogAlarmEventId, ogSerialPortDTR=ogSerialPortDTR, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceType=ogHostServiceType, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientMac=ogWifiApClientMac, ogUpsDescription=ogUpsDescription, ogSerialPortParity=ogSerialPortParity, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemEntry=ogCellModemEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcDescription=ogRpcDescription, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserName=ogHostUserName, ogWifiClientApMac=ogWifiClientApMac, ogHostUserEntry=ogHostUserEntry, ogHostServiceCounter=ogHostServiceCounter, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckIndex=ogCheckIndex, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientRssi=ogWifiClientRssi, ogRpcIndex=ogRpcIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortEntry=ogSerialPortEntry, ogWebUserStartTime=ogWebUserStartTime, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletTable=ogRpcOutletTable, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDescription=ogEmdDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsIndex=ogUpsIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmSummary=ogAlarmSummary, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsState=ogUpsState, ogWifiApCounter=ogWifiApCounter, ogCellModemIndex=ogCellModemIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserTable=ogHostUserTable, ogSerialPortDCD=ogSerialPortDCD, ogAlarmName=ogAlarmName, ogRpcOutletName=ogRpcOutletName, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioIndex=ogEmdDioIndex, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserName=ogSerialUserName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceStatus=ogHostServiceStatus, ogHostServiceHost=ogHostServiceHost, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientInterface=ogWifiClientInterface, ogCellModemCounter=ogCellModemCounter, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioName=ogEmdDioName, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2Groups=ogStatus2Groups, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckEntry=ogCheckEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsName=ogUpsName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsTable=ogUpsTable, ogAlarmLogTable=ogAlarmLogTable, ogCellModemApn=ogCellModemApn, ogCheckType=ogCheckType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsTemperature=ogUpsTemperature, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortIndex=ogSerialPortIndex, ogFirmwareVersion=ogFirmwareVersion, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialUserPort=ogSerialUserPort, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientTable=ogWifiClientTable, ogRpcConnectType=ogRpcConnectType, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioType=ogEmdDioType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCustomNotification=ogCustomNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletTotal=ogRpcOutletTotal, ogUpsNotification=ogUpsNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcEntry=ogRpcEntry, ogHostUserHostName=ogHostUserHostName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApTxPower=ogWifiApTxPower, ogHostIndex=ogHostIndex, ogHostIpV6Address=ogHostIpV6Address, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmTime=ogAlarmTime, ogWifiApSsid=ogWifiApSsid, ogWifiApFrequency=ogWifiApFrequency, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientCounter=ogWifiClientCounter, ogHostServicePort=ogHostServicePort, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogMibNotifications=ogMibNotifications, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdLogEnabled=ogEmdLogEnabled, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputNotification=ogUpsInputNotification, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcType=ogRpcType, ogCellApnNotification=ogCellApnNotification, ogCellMessageNotification=ogCellMessageNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApTable=ogWifiApTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientMode=ogWifiClientMode, ogWebUserName=ogWebUserName, ogHostPingNotification=ogHostPingNotification, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSystem=ogSystem, ogEmdTable=ogEmdTable, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApEntry=ogWifiApEntry, ogRpcName=ogRpcName, ogEmdDioCounter=ogEmdDioCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioState=ogEmdDioState)
