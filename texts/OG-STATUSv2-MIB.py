...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogMibNotifications=ogMibNotifications, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserIndex=ogWebUserIndex, ogHostUserNotification=ogHostUserNotification, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputNotification=ogUpsOutputNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostIpV6Address=ogHostIpV6Address, ogCheckEntry=ogCheckEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletTable=ogRpcOutletTable, ogWebUserTable=ogWebUserTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2=ogStatus2, ogUpsOutputPower=ogUpsOutputPower, ogCellDataNotification=ogCellDataNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsTemperature=ogUpsTemperature, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmType=ogAlarmType, ogSerialPortIndex=ogSerialPortIndex, ogWifiApTxPower=ogWifiApTxPower, ogHostUserTable=ogHostUserTable, ogAlarmTime=ogAlarmTime, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWebUserNotification=ogWebUserNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsName=ogUpsName, ogCellModemConnected=ogCellModemConnected, ogRpcInputNotification=ogRpcInputNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApTable=ogWifiApTable, ogWifiApSsid=ogWifiApSsid, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemCounter=ogCellModemCounter, ogWifiApClientAp=ogWifiApClientAp, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioDescription=ogEmdDioDescription, ogSerialUserName=ogSerialUserName, ogEmdDioType=ogEmdDioType, ogSerialUserTable=ogSerialUserTable, ogSerialNumber=ogSerialNumber, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortTable=ogSerialPortTable, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcConnectType=ogRpcConnectType, ogHostServiceType=ogHostServiceType, ogWifiClientEssid=ogWifiClientEssid, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApIndex=ogWifiApIndex, ogSerialPortDCD=ogSerialPortDCD, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmInstance=ogAlarmInstance, ogCellModemTable=ogCellModemTable, ogCheckDeviceName=ogCheckDeviceName, ogHostTable=ogHostTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsHumidity=ogUpsHumidity, ogAlarm=ogAlarm, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDescription=ogEmdDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcEntry=ogRpcEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioState=ogEmdDioState, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioNotification=ogEmdDioNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemNetwork=ogCellModemNetwork, ogUpsIndex=ogUpsIndex, ogHostUserStartTime=ogHostUserStartTime, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserIndex=ogHostUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcIndex=ogRpcIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmEventId=ogAlarmEventId, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientMac=ogWifiApClientMac, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogStatus2Compliance=ogStatus2Compliance, ogAlarmCheck=ogAlarmCheck, ogUpsInputCurrent=ogUpsInputCurrent, ogHostIndex=ogHostIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostPingNotification=ogHostPingNotification, ogHostServiceHost=ogHostServiceHost, ogSerialPortMode=ogSerialPortMode, ogEmdDioName=ogEmdDioName, ogStatus2Groups=ogStatus2Groups, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdEntry=ogEmdEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckTable=ogCheckTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceNotification=ogHostServiceNotification, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcTable=ogRpcTable, ogHostUserName=ogHostUserName, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcDescription=ogRpcDescription, ogAlarmLogIndex=ogAlarmLogIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemVendor=ogCellModemVendor, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemModel=ogCellModemModel, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcCounter=ogRpcCounter, ogHostIpV4Address=ogHostIpV4Address, ogSystem=ogSystem, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellTowerNotification=ogCellTowerNotification, ogUpsConnectType=ogUpsConnectType, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsNotification=ogUpsNotification, ogWifiApCounter=ogWifiApCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApEntry=ogWifiApEntry, ogSerialUserIndex=ogSerialUserIndex, ogRpcName=ogRpcName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemTower=ogCellModemTower, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioEmd=ogEmdDioEmd, ogAlarmUser=ogAlarmUser, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceIndex=ogHostServiceIndex, ogUpsType=ogUpsType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioCounter=ogEmdDioCounter, ogRpcType=ogRpcType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserAddress=ogHostUserAddress, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletName=ogRpcOutletName, ogSerialUserEntry=ogSerialUserEntry, ogCellModemApn=ogCellModemApn, ogEmdDioTable=ogEmdDioTable, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientIndex=ogWifiClientIndex, ogEmdTable=ogEmdTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserEntry=ogHostUserEntry, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceType=ogNetInterfaceType, ogWebUserName=ogWebUserName, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientTable=ogWifiClientTable, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserHost=ogHostUserHost, ogAlarmState=ogAlarmState, ogHostServiceTable=ogHostServiceTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsDescription=ogUpsDescription, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceState=ogNetInterfaceState, ogCheckType=ogCheckType, ogSerialPortParity=ogSerialPortParity, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryState=ogUpsBatteryState, ogHostName=ogHostName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdEnabled=ogEmdEnabled, ogCellModem4gRssi=ogCellModem4gRssi)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdConnectType=ogEmdConnectType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmName=ogAlarmName, ogCurrentAlarmName=ogCurrentAlarmName, ogCustomNotification=ogCustomNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityName=ogEmdHumidityName, ogEmdName=ogEmdName, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmDevice=ogAlarmDevice, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsEntry=ogUpsEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemSessionTime=ogCellModemSessionTime, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientMode=ogWifiClientMode, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsTable=ogUpsTable, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioEntry=ogEmdDioEntry, ogCellModemEntry=ogCellModemEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostServicePort=ogHostServicePort, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellSignalNotification=ogCellSignalNotification, ogCellModemIndex=ogCellModemIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckResolveActions=ogCheckResolveActions, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityValue=ogEmdHumidityValue, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsState=ogUpsState, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientInterface=ogWifiClientInterface, ogHostEntry=ogHostEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWebUserEntry=ogWebUserEntry, ogWifiApFrequency=ogWifiApFrequency, ogCheckName=ogCheckName, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdIndex=ogEmdIndex, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckIndex=ogCheckIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostUserHostName=ogHostUserHostName, ogEmdDioDirection=ogEmdDioDirection)
