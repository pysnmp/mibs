...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputCurrent=ogRpcInputCurrent, ogHostIndex=ogHostIndex, ogNetInterfaceName=ogNetInterfaceName, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemTable=ogCellModemTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsIndex=ogUpsIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialUserPort=ogSerialUserPort, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmSummary=ogAlarmSummary, ogUpsEntry=ogUpsEntry, ogEmdTable=ogEmdTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserEntry=ogWebUserEntry, ogUpsType=ogUpsType, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsNotification=ogUpsNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsTable=ogUpsTable, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdEntry=ogEmdEntry, ogSerialPortCTS=ogSerialPortCTS, ogRpcMaxTemperature=ogRpcMaxTemperature, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortTable=ogSerialPortTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortEntry=ogSerialPortEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdEnabled=ogEmdEnabled, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletTable=ogRpcOutletTable, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientEssid=ogWifiClientEssid, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogStatus2Groups=ogStatus2Groups, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientTable=ogWifiApClientTable, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApInterface=ogWifiApInterface, ogCheckName=ogCheckName, ogSerialUserEntry=ogSerialUserEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientMode=ogWifiClientMode, ogEmdDioName=ogEmdDioName, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletName=ogRpcOutletName, ogCheckTable=ogCheckTable, ogCellModemIndex=ogCellModemIndex, ogSerialUserTable=ogSerialUserTable, ogUpsTemperature=ogUpsTemperature, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserIndex=ogHostUserIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortLabel=ogSerialPortLabel, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckType=ogCheckType, ogCellApnNotification=ogCellApnNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemCounter=ogCellModemCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostServiceNotification=ogHostServiceNotification, ogWifiApCounter=ogWifiApCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceState=ogNetInterfaceState, ogSerialNumber=ogSerialNumber, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserIndex=ogSerialUserIndex, ogUpsCounter=ogUpsCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserName=ogWebUserName, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApTable=ogWifiApTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioState=ogEmdDioState, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdName=ogEmdName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemEntry=ogCellModemEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientMac=ogWifiApClientMac, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcType=ogRpcType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcConnectType=ogRpcConnectType, ogRpcTable=ogRpcTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceType=ogHostServiceType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCustomNotification=ogCustomNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApIndex=ogWifiApIndex, ogCellModemTower=ogCellModemTower, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSystem=ogSystem, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmState=ogAlarmState, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioEntry=ogEmdDioEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmLogTable=ogAlarmLogTable, ogCellModemModel=ogCellModemModel, ogEmdDioTable=ogEmdDioTable, ogRpcInputNotification=ogRpcInputNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmType=ogAlarmType, ogHostServiceStatus=ogHostServiceStatus, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogStatus2Compliance=ogStatus2Compliance, ogCheckIndex=ogCheckIndex, ogRpcEntry=ogRpcEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioDirection=ogEmdDioDirection, ogRpcName=ogRpcName, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmTable=ogCurrentAlarmTable, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceTable=ogNetInterfaceTable, ogStatus2=ogStatus2, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemApn=ogCellModemApn, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostPingNotification=ogHostPingNotification, ogHostUserEntry=ogHostUserEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServiceHost=ogHostServiceHost, ogAlarmName=ogAlarmName, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostName=ogHostName, ogAlarmTime=ogAlarmTime, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceTable=ogHostServiceTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserNotification=ogSerialUserNotification, ogAlarm=ogAlarm, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcDescription=ogRpcDescription, ogHostUserHostName=ogHostUserHostName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserName=ogSerialUserName, ogEmdDescription=ogEmdDescription, ogAlarmUser=ogAlarmUser, ogEmdDioEmd=ogEmdDioEmd, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcIndex=ogRpcIndex, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsInputNotification=ogUpsInputNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemRegistered=ogCellModemRegistered, ogWebUserTable=ogWebUserTable, ogHostEntry=ogHostEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortParity=ogSerialPortParity, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServicePort=ogHostServicePort, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckDeviceRef=ogCheckDeviceRef, ogCellMessageNotification=ogCellMessageNotification, ogAlarmCheck=ogAlarmCheck, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogFirmwareVersion=ogFirmwareVersion, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserHost=ogHostUserHost)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemConnected=ogCellModemConnected, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsDescription=ogUpsDescription, ogMibNotifications=ogMibNotifications, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellTowerNotification=ogCellTowerNotification, ogCheckDeviceName=ogCheckDeviceName, ogNetInterfaceType=ogNetInterfaceType, ogCellDataNotification=ogCellDataNotification, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsName=ogUpsName, ogUpsHumidity=ogUpsHumidity, ogHostUserTable=ogHostUserTable, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsBatteryState=ogUpsBatteryState, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioType=ogEmdDioType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemVendor=ogCellModemVendor, ogHostUserName=ogHostUserName, ogAlarmInstance=ogAlarmInstance, ogAlarmDevice=ogAlarmDevice, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApEntry=ogWifiApEntry, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserStartTime=ogWebUserStartTime, ogCheckResetTimeout=ogCheckResetTimeout, PYSNMP_MODULE_ID=ogStatus2, ogHostTable=ogHostTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityName=ogEmdHumidityName, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcCounter=ogRpcCounter, ogUpsState=ogUpsState, ogUpsConnectType=ogUpsConnectType, ogEmdIndex=ogEmdIndex, ogWebUserIndex=ogWebUserIndex, ogAlarmEventId=ogAlarmEventId, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletState=ogRpcOutletState, ogCheckEntry=ogCheckEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry)
