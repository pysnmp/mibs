...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckType=ogCheckType, ogWifiApEntry=ogWifiApEntry, ogSerialPortEntry=ogSerialPortEntry, ogEmdDescription=ogEmdDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostServiceType=ogHostServiceType, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemConnected=ogCellModemConnected, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarm=ogAlarm, ogSerialPortTable=ogSerialPortTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceTable=ogHostServiceTable, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserHost=ogHostUserHost, ogNetInterfaceState=ogNetInterfaceState, ogHostUserIndex=ogHostUserIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsState=ogUpsState, ogWifiClientMode=ogWifiClientMode, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortDTR=ogSerialPortDTR, ogCheckName=ogCheckName, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemVendor=ogCellModemVendor, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsCounter=ogUpsCounter, ogUpsDescription=ogUpsDescription, ogCheckTable=ogCheckTable, ogCheckDeviceRef=ogCheckDeviceRef, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogStatus2=ogStatus2, ogEmdEntry=ogEmdEntry, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsConnectType=ogUpsConnectType, ogCellModemModel=ogCellModemModel, ogCellModemCounter=ogCellModemCounter, ogWebUserName=ogWebUserName, ogUpsHumidity=ogUpsHumidity, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserAddress=ogHostUserAddress, ogEmdDioState=ogEmdDioState, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserHostName=ogHostUserHostName, ogUpsIndex=ogUpsIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsTable=ogUpsTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostTable=ogHostTable, ogSerialNumber=ogSerialNumber, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientIndex=ogWifiClientIndex, ogHostIndex=ogHostIndex, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmUser=ogAlarmUser, ogFirmwareVersion=ogFirmwareVersion, ogEmdEnabled=ogEmdEnabled, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemSessionTime=ogCellModemSessionTime, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortDCD=ogSerialPortDCD, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsType=ogUpsType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcType=ogRpcType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsName=ogUpsName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApFrequency=ogWifiApFrequency, ogUpsTemperature=ogUpsTemperature, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserEntry=ogWebUserEntry, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialUserPort=ogSerialUserPort, ogRpcEntry=ogRpcEntry, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWebUserNotification=ogWebUserNotification, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletName=ogRpcOutletName, ogHostServiceStatus=ogHostServiceStatus, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdIndex=ogEmdIndex, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryState=ogUpsBatteryState, ogWifiApSsid=ogWifiApSsid, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserEntry=ogSerialUserEntry, ogRpcTable=ogRpcTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemApn=ogCellModemApn, ogSerialPortMode=ogSerialPortMode, ogSerialUserLabel=ogSerialUserLabel, ogHostName=ogHostName, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmType=ogAlarmType, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputPower=ogUpsOutputPower, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmDevice=ogAlarmDevice, ogHostUserTable=ogHostUserTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsEntry=ogUpsEntry, ogHostUserName=ogHostUserName, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserNotification=ogSerialUserNotification, ogWifiApTable=ogWifiApTable, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientEntry=ogWifiClientEntry, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioTable=ogEmdDioTable, ogMibNotifications=ogMibNotifications, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyName=ogPowerSupplyName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckDeviceName=ogCheckDeviceName, ogAlarmName=ogAlarmName, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcName=ogRpcName, ogRpcConnectType=ogRpcConnectType, ogEmdDioDirection=ogEmdDioDirection, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemTower=ogCellModemTower, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioNotification=ogEmdDioNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceCounter=ogHostServiceCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmCheck=ogAlarmCheck, ogEmdName=ogEmdName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogStatus2Compliance=ogStatus2Compliance, ogRpcIndex=ogRpcIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientTable=ogWifiClientTable, ogHostServicePort=ogHostServicePort, ogWebUserIndex=ogWebUserIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserEntry=ogHostUserEntry, ogCellTowerNotification=ogCellTowerNotification, ogSerialUserName=ogSerialUserName, ogHostUserStartTime=ogHostUserStartTime, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletTable=ogRpcOutletTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogCellDataNotification=ogCellDataNotification, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogStatus2Compliances=ogStatus2Compliances, ogEmdTable=ogEmdTable, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioDescription=ogEmdDioDescription, ogStatus2Groups=ogStatus2Groups, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemTable=ogCellModemTable, ogHostEntry=ogHostEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientMac=ogWifiApClientMac)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletRpc=ogRpcOutletRpc, ogCustomNotification=ogCustomNotification, ogEmdDioName=ogEmdDioName, ogUpsNotification=ogUpsNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcDescription=ogRpcDescription, ogAlarmInstance=ogAlarmInstance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientEssid=ogWifiClientEssid, ogAlarmState=ogAlarmState, ogWifiClientApMac=ogWifiClientApMac, ogEmdConnectType=ogEmdConnectType, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioType=ogEmdDioType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPatternNotification=ogSerialPatternNotification, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientAp=ogWifiApClientAp, ogCheckEntry=ogCheckEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckIndex=ogCheckIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioIndex=ogEmdDioIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmType=ogCurrentAlarmType, ogHostPingNotification=ogHostPingNotification, ogHostServiceHost=ogHostServiceHost, ogWifiClientRssi=ogWifiClientRssi, ogCellModemRegistered=ogCellModemRegistered, ogCellApnNotification=ogCellApnNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortParity=ogSerialPortParity, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostUserNotification=ogHostUserNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcCounter=ogRpcCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortCTS=ogSerialPortCTS, ogWifiApIndex=ogWifiApIndex, PYSNMP_MODULE_ID=ogStatus2, ogWebUserTable=ogWebUserTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemEnabled=ogCellModemEnabled, ogSystem=ogSystem, ogRpcOutletState=ogRpcOutletState, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmTime=ogAlarmTime)
