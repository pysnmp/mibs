...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioType=ogEmdDioType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostName=ogHostName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityName=ogEmdHumidityName, ogUpsState=ogUpsState, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApEntry=ogWifiApEntry, ogRpcDescription=ogRpcDescription, ogSerialPortParity=ogSerialPortParity, ogSerialPortCTS=ogSerialPortCTS, ogWifiApCounter=ogWifiApCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioEntry=ogEmdDioEntry, ogHostUserHostName=ogHostUserHostName, ogRpcIndex=ogRpcIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsCounter=ogUpsCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogMibNotifications=ogMibNotifications, ogUpsIndex=ogUpsIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemModel=ogCellModemModel, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdIndex=ogEmdIndex, ogStatus2Compliance=ogStatus2Compliance, ogRpcName=ogRpcName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckName=ogCheckName, ogRpcTable=ogRpcTable, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientTable=ogWifiClientTable, ogEmdDioTable=ogEmdDioTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletState=ogRpcOutletState, ogRpcEntry=ogRpcEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmSummary=ogAlarmSummary, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsConnectType=ogUpsConnectType, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckIndex=ogCheckIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserStartTime=ogWebUserStartTime, ogSerialNumber=ogSerialNumber, ogCellModemTable=ogCellModemTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmCheck=ogAlarmCheck, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcConnectType=ogRpcConnectType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioState=ogEmdDioState, ogHostServiceIndex=ogHostServiceIndex, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemNetwork=ogCellModemNetwork, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmDevice=ogAlarmDevice, ogSystem=ogSystem, ogCellModemIMSI=ogCellModemIMSI, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsName=ogUpsName, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortEntry=ogSerialPortEntry, ogCellModemCounter=ogCellModemCounter, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcLogEnabled=ogRpcLogEnabled, ogHostIndex=ogHostIndex, ogCellModemApn=ogCellModemApn, ogWifiClientEntry=ogWifiClientEntry, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortMode=ogSerialPortMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserIndex=ogHostUserIndex, ogCheckTable=ogCheckTable, ogAlarmName=ogAlarmName, ogSerialUserLabel=ogSerialUserLabel, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdName=ogEmdName, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserName=ogSerialUserName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserEntry=ogWebUserEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsDescription=ogUpsDescription, ogSerialUserNotification=ogSerialUserNotification, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApInterface=ogWifiApInterface, ogSerialPortFlowControl=ogSerialPortFlowControl, ogNetInterfaceName=ogNetInterfaceName, ogCellModemVendor=ogCellModemVendor, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserHost=ogHostUserHost, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdEntry=ogEmdEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsEntry=ogUpsEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmState=ogAlarmState, ogHostUserTable=ogHostUserTable, ogWifiApTable=ogWifiApTable, ogEmdDioNotification=ogEmdDioNotification, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioDirection=ogEmdDioDirection, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckType=ogCheckType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemTemperature=ogCellModemTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogStatus2Compliances=ogStatus2Compliances, ogCellTowerNotification=ogCellTowerNotification, ogStatus2Conformance=ogStatus2Conformance, ogAlarmEventId=ogAlarmEventId, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientInterface=ogWifiClientInterface, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioDescription=ogEmdDioDescription, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmInstance=ogAlarmInstance, ogHostPingNotification=ogHostPingNotification, ogAlarmLogTable=ogAlarmLogTable, ogUpsLogEnabled=ogUpsLogEnabled, ogHostServiceType=ogHostServiceType, ogHostServicePort=ogHostServicePort, ogUpsBatteryState=ogUpsBatteryState, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmUser=ogAlarmUser, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemTower=ogCellModemTower, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioCounter=ogEmdDioCounter, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApIndex=ogWifiApIndex, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserIndex=ogWebUserIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortDSR=ogSerialPortDSR, ogRpcType=ogRpcType, ogHostIpV6Address=ogHostIpV6Address, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServiceStatus=ogHostServiceStatus, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTable=ogWifiApClientTable, ogUpsType=ogUpsType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostEntry=ogHostEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdConnectType=ogEmdConnectType, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemEntry=ogCellModemEntry, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureNotification=ogEmdTemperatureNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsTemperature=ogUpsTemperature, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsNotification=ogUpsNotification, ogAlarm=ogAlarm, ogCheckEntry=ogCheckEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostTable=ogHostTable, ogAlarmTime=ogAlarmTime, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletName=ogRpcOutletName, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortTable=ogSerialPortTable, ogSerialPortDCD=ogSerialPortDCD, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsHumidity=ogUpsHumidity, ogHostUserNotification=ogHostUserNotification, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioIndex=ogEmdDioIndex, ogCellDataNotification=ogCellDataNotification, ogUpsTable=ogUpsTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApSsid=ogWifiApSsid, ogEmdDescription=ogEmdDescription, ogWebUserName=ogWebUserName, ogEmdTable=ogEmdTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCustomNotification=ogCustomNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogHostUserName=ogHostUserName, ogRpcCounter=ogRpcCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioName=ogEmdDioName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogStatus2=ogStatus2, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientEssid=ogWifiClientEssid, ogCheckResolveActions=ogCheckResolveActions, ogWebUserTable=ogWebUserTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialUserPort=ogSerialUserPort, ogWebUserNotification=ogWebUserNotification, ogAlarmType=ogAlarmType, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserAddress=ogHostUserAddress)
