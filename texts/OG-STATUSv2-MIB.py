...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsInputNotification=ogUpsInputNotification, ogCellModemTable=ogCellModemTable, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemModel=ogCellModemModel, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserName=ogSerialUserName, ogSystem=ogSystem, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsTemperature=ogUpsTemperature, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioIndex=ogEmdDioIndex, ogCellModemIndex=ogCellModemIndex, ogCellModemEnabled=ogCellModemEnabled, ogCellModemVendor=ogCellModemVendor, ogHostUserHostName=ogHostUserHostName, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientAp=ogWifiApClientAp, ogWifiApFrequency=ogWifiApFrequency, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckType=ogCheckType, ogCellModemTemperature=ogCellModemTemperature, ogWebUserTable=ogWebUserTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostUserNotification=ogHostUserNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortTable=ogSerialPortTable, ogCustomNotification=ogCustomNotification, ogHostServicePort=ogHostServicePort, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortParity=ogSerialPortParity, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserEntry=ogSerialUserEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceStatus=ogHostServiceStatus, ogRpcIndex=ogRpcIndex, ogUpsType=ogUpsType, ogUpsState=ogUpsState, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmCheck=ogAlarmCheck, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientRssi=ogWifiApClientRssi, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserHost=ogHostUserHost, ogSerialPortDSR=ogSerialPortDSR, ogRpcName=ogRpcName, ogAlarmInstance=ogAlarmInstance, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcTable=ogRpcTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogHostUserEntry=ogHostUserEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmDevice=ogAlarmDevice, ogRpcConnectType=ogRpcConnectType, ogEmdDioState=ogEmdDioState, ogNetInterfaceEntry=ogNetInterfaceEntry, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmState=ogCurrentAlarmState, ogStatus2Compliances=ogStatus2Compliances, ogUpsHumidity=ogUpsHumidity, ogAlarmName=ogAlarmName, ogAlarm=ogAlarm, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogMibNotifications=ogMibNotifications, ogUpsOutputPower=ogUpsOutputPower, ogSerialSignalNotification=ogSerialSignalNotification, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApIndex=ogWifiApIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsEntry=ogUpsEntry, ogNetInterfaceName=ogNetInterfaceName, ogUpsIndex=ogUpsIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialUserPort=ogSerialUserPort, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortEntry=ogSerialPortEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemEntry=ogCellModemEntry, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletState=ogRpcOutletState, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApCounter=ogWifiApCounter, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsCounter=ogUpsCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientCounter=ogWifiClientCounter, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcEntry=ogRpcEntry, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserName=ogWebUserName, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApEntry=ogWifiApEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsDescription=ogUpsDescription, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioName=ogEmdDioName, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityName=ogEmdHumidityName, ogUpsConnectType=ogUpsConnectType, ogEmdDioNotification=ogEmdDioNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostServiceType=ogHostServiceType, ogNetInterfaceType=ogNetInterfaceType, ogCheckIndex=ogCheckIndex, ogEmdEnabled=ogEmdEnabled, ogHostUserAddress=ogHostUserAddress, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientIndex=ogWifiClientIndex, ogCellApnNotification=ogCellApnNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioTable=ogEmdDioTable, ogWifiApInterface=ogWifiApInterface, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcCounter=ogRpcCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellTowerNotification=ogCellTowerNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmCurrentValue=ogAlarmCurrentValue, ogStatus2=ogStatus2, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputFrequency=ogUpsOutputFrequency, ogFirmwareVersion=ogFirmwareVersion, ogAlarmTime=ogAlarmTime, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsBatteryState=ogUpsBatteryState, ogSerialNumber=ogSerialNumber, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceHost=ogHostServiceHost, ogCheckEntry=ogCheckEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemConnected=ogCellModemConnected, ogAlarmSummary=ogAlarmSummary, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckTable=ogCheckTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientTable=ogWifiClientTable, ogHostIpV6Address=ogHostIpV6Address, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmUser=ogAlarmUser, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogNetInterfaceState=ogNetInterfaceState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcDescription=ogRpcDescription, ogHostIndex=ogHostIndex, ogAlarmState=ogAlarmState, ogHostUserName=ogHostUserName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemTower=ogCellModemTower, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientApMac=ogWifiClientApMac, ogCheckName=ogCheckName, ogWifiApTable=ogWifiApTable, ogAlarmEventId=ogAlarmEventId, ogEmdDioEntry=ogEmdDioEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemApn=ogCellModemApn, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostName=ogHostName, ogRpcOutletLoad=ogRpcOutletLoad)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsNotification=ogUpsNotification, ogRpcOutletName=ogRpcOutletName, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceName=ogCheckDeviceName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserLabel=ogSerialUserLabel, ogSerialUserTable=ogSerialUserTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortLabel=ogSerialPortLabel, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTable=ogEmdTable, ogEmdEntry=ogEmdEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostServiceEntry=ogHostServiceEntry, ogAlarmType=ogAlarmType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServiceCounter=ogHostServiceCounter, ogWifiApSsid=ogWifiApSsid, ogCheckResolveActions=ogCheckResolveActions, ogCellDataNotification=ogCellDataNotification, ogRpcType=ogRpcType, ogWebUserNotification=ogWebUserNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientEntry=ogWifiClientEntry, ogHostEntry=ogHostEntry, ogHostTable=ogHostTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientInterface=ogWifiClientInterface, ogEmdName=ogEmdName, ogHostServiceTable=ogHostServiceTable, ogUpsName=ogUpsName, ogCellModemIMSI=ogCellModemIMSI, ogEmdIndex=ogEmdIndex, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserTable=ogHostUserTable, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdConnectType=ogEmdConnectType, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApTxPower=ogWifiApTxPower, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioType=ogEmdDioType, ogUpsTable=ogUpsTable, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostPingNotification=ogHostPingNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDescription=ogEmdDescription, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortDTR=ogSerialPortDTR)
