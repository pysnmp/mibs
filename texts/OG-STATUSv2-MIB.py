...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApEnabled=ogWifiApEnabled, ogMibNotifications=ogMibNotifications, ogAlarm=ogAlarm, ogUpsOutputCurrent=ogUpsOutputCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceName=ogNetInterfaceName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientAp=ogWifiApClientAp, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApEntry=ogWifiApEntry, ogWifiApTable=ogWifiApTable, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserName=ogHostUserName, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortDCD=ogSerialPortDCD, ogStatus2Compliance=ogStatus2Compliance, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmTime=ogAlarmTime, ogHostEntry=ogHostEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWebUserEntry=ogWebUserEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputNotification=ogUpsInputNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckIndex=ogCheckIndex, ogRpcTable=ogRpcTable, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellSignalNotification=ogCellSignalNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsEntry=ogUpsEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioCounter=ogEmdDioCounter, ogCheckType=ogCheckType, ogSerialUserPort=ogSerialUserPort, ogAlarmName=ogAlarmName, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortDataBits=ogSerialPortDataBits, ogStatus2Compliances=ogStatus2Compliances, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcEntry=ogRpcEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostPingNotification=ogHostPingNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdConnectType=ogEmdConnectType, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcInputNotification=ogRpcInputNotification, ogCellModemApn=ogCellModemApn, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDescription=ogEmdDescription, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemTable=ogCellModemTable, ogStatus2=ogStatus2, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModem3gRssi=ogCellModem3gRssi, ogStatus2Conformance=ogStatus2Conformance, ogHostUserHostName=ogHostUserHostName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellTowerNotification=ogCellTowerNotification, ogSerialUserTable=ogSerialUserTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemModel=ogCellModemModel, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientEnabled=ogWifiClientEnabled, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletState=ogRpcOutletState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsConnectType=ogUpsConnectType, ogEmdDioName=ogEmdDioName, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientEntry=ogWifiApClientEntry, ogHostServiceHost=ogHostServiceHost, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioTable=ogEmdDioTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsDescription=ogUpsDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserIndex=ogSerialUserIndex, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientRssi=ogWifiClientRssi, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellMessageNotification=ogCellMessageNotification, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdName=ogEmdName, ogHostUserIndex=ogHostUserIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemTemperature=ogCellModemTemperature, ogSystem=ogSystem, ogSerialPortParity=ogSerialPortParity, ogSerialPortTable=ogSerialPortTable, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemTower=ogCellModemTower, ogNetInterfaceType=ogNetInterfaceType, ogRpcInputCurrent=ogRpcInputCurrent, ogHostServiceNotification=ogHostServiceNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostTable=ogHostTable, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortBreaks=ogSerialPortBreaks, ogCustomNotification=ogCustomNotification, ogRpcIndex=ogRpcIndex, ogWifiApTxPower=ogWifiApTxPower, ogUpsTable=ogUpsTable, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyName=ogPowerSupplyName, ogWebUserName=ogWebUserName, ogUpsState=ogUpsState, ogEmdDioNotification=ogEmdDioNotification, ogHostServiceCounter=ogHostServiceCounter, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcDescription=ogRpcDescription, ogEmdDioState=ogEmdDioState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserIndex=ogWebUserIndex, ogUpsType=ogUpsType, ogWebUserTable=ogWebUserTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApIndex=ogWifiApIndex, ogHostIndex=ogHostIndex, ogEmdDioDescription=ogEmdDioDescription, ogCheckEntry=ogCheckEntry, ogCellModemEntry=ogCellModemEntry, ogSerialNumber=ogSerialNumber, ogCellModemCounter=ogCellModemCounter, ogHostServicePort=ogHostServicePort, ogAlarmEventId=ogAlarmEventId, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcConnectType=ogRpcConnectType, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientCounter=ogWifiClientCounter, ogCellModemNetwork=ogCellModemNetwork, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcType=ogRpcType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApInterface=ogWifiApInterface, ogCheckTable=ogCheckTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserHost=ogHostUserHost, ogEmdEnabled=ogEmdEnabled, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryState=ogUpsBatteryState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmSummary=ogAlarmSummary, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellApnNotification=ogCellApnNotification, ogUpsIndex=ogUpsIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortMode=ogSerialPortMode, ogWifiApCounter=ogWifiApCounter, ogCellDataNotification=ogCellDataNotification, ogEmdDioDirection=ogEmdDioDirection, ogEmdIndex=ogEmdIndex, ogCheckName=ogCheckName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsHumidity=ogUpsHumidity, ogAlarmLogTable=ogAlarmLogTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserTable=ogHostUserTable, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmUser=ogAlarmUser, ogRpcCounter=ogRpcCounter, ogUpsOutputPower=ogUpsOutputPower, ogHostName=ogHostName, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmEntry=ogCurrentAlarmEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletName=ogRpcOutletName, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmType=ogAlarmType, ogWifiClientEntry=ogWifiClientEntry, ogNetInterfaceState=ogNetInterfaceState, ogEmdEntry=ogEmdEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientMode=ogWifiClientMode, ogAlarmState=ogAlarmState, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsName=ogUpsName, ogWifiApClientMac=ogWifiApClientMac, ogCheckResolveActions=ogCheckResolveActions, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemVendor=ogCellModemVendor, ogHostServiceTable=ogHostServiceTable, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogStatus2Groups=ogStatus2Groups, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserAddress=ogHostUserAddress, ogEmdDioType=ogEmdDioType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialUserName=ogSerialUserName, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortRTS=ogSerialPortRTS, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortIndex=ogSerialPortIndex, ogCheckDeviceName=ogCheckDeviceName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTable=ogEmdTable, ogAlarmInstance=ogAlarmInstance, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceType=ogHostServiceType, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsNotification=ogUpsNotification, ogWebUserNotification=ogWebUserNotification, ogRpcName=ogRpcName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientTxBytes=ogWifiApClientTxBytes, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmCheck=ogAlarmCheck, ogUpsTemperature=ogUpsTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogFirmwareVersion=ogFirmwareVersion, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityNotification=ogEmdHumidityNotification)
