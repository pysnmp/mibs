...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModem4gRssi=ogCellModem4gRssi, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortDTR=ogSerialPortDTR, ogHostIpV6Address=ogHostIpV6Address, ogCellModemApn=ogCellModemApn, ogAlarmName=ogAlarmName, ogSerialPortIndex=ogSerialPortIndex, ogHostUserHost=ogHostUserHost, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemTower=ogCellModemTower, ogEmdConnectType=ogEmdConnectType, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortLogLevel=ogSerialPortLogLevel, ogMibNotifications=ogMibNotifications, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemEntry=ogCellModemEntry, ogWifiClientEssid=ogWifiClientEssid, ogHostServicePort=ogHostServicePort, ogAlarm=ogAlarm, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogNetInterfaceName=ogNetInterfaceName, ogCellModem3gRssi=ogCellModem3gRssi, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemIndex=ogCellModemIndex, ogAlarmCheck=ogAlarmCheck, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApSsid=ogWifiApSsid, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWebUserTable=ogWebUserTable, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioType=ogEmdDioType, ogCheckIndex=ogCheckIndex, ogHostUserNotification=ogHostUserNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputPower=ogUpsOutputPower, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsConnectType=ogUpsConnectType, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioTable=ogEmdDioTable, ogRpcName=ogRpcName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserAddress=ogHostUserAddress, ogRpcType=ogRpcType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsType=ogUpsType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletName=ogRpcOutletName, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsTemperature=ogUpsTemperature, ogHostIndex=ogHostIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckName=ogCheckName, ogStatus2Groups=ogStatus2Groups, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmTime=ogCurrentAlarmTime, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemTable=ogCellModemTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWebUserNotification=ogWebUserNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdEnabled=ogEmdEnabled, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserTable=ogHostUserTable, ogWifiApIndex=ogWifiApIndex, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryState=ogUpsBatteryState, ogUpsTable=ogUpsTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioIndex=ogEmdDioIndex, ogHostIpV4Address=ogHostIpV4Address, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceHost=ogHostServiceHost, ogSerialPortDCD=ogSerialPortDCD, ogHostUserStartTime=ogHostUserStartTime, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserEntry=ogWebUserEntry, ogCheckTable=ogCheckTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientInterface=ogWifiClientInterface, ogHostTable=ogHostTable, ogStatus2=ogStatus2, ogPowerSupplyName=ogPowerSupplyName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientTable=ogWifiClientTable, ogSerialPortMode=ogSerialPortMode, ogUpsInputCurrent=ogUpsInputCurrent, ogCellDataNotification=ogCellDataNotification, ogEmdDioEmd=ogEmdDioEmd, ogAlarmEventId=ogAlarmEventId, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioState=ogEmdDioState, ogHostEntry=ogHostEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogSystem=ogSystem, ogEmdDescription=ogEmdDescription, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialUserPort=ogSerialUserPort, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialUserEntry=ogSerialUserEntry, ogAlarmSummary=ogAlarmSummary, ogHostServiceCounter=ogHostServiceCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityName=ogEmdHumidityName, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientEntry=ogWifiClientEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientFrequency=ogWifiClientFrequency, ogCliUserSessionNotification=ogCliUserSessionNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApInterface=ogWifiApInterface, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcDescription=ogRpcDescription, ogNetInterfaceType=ogNetInterfaceType, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTable=ogEmdTable, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletState=ogRpcOutletState, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioEntry=ogEmdDioEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioName=ogEmdDioName, ogWifiApCounter=ogWifiApCounter, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcCounter=ogRpcCounter, ogHostServiceType=ogHostServiceType, ogSerialPortTable=ogSerialPortTable, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserIndex=ogWebUserIndex, ogEmdName=ogEmdName, ogWifiApClientTable=ogWifiApClientTable, ogWebUserStartTime=ogWebUserStartTime, ogWifiApTable=ogWifiApTable, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApEnabled=ogWifiApEnabled, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmTime=ogAlarmTime, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsNotification=ogUpsNotification, ogSerialUserName=ogSerialUserName, ogHostServiceEntry=ogHostServiceEntry, ogRpcIndex=ogRpcIndex, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceIndex=ogHostServiceIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortEntry=ogSerialPortEntry, ogCellApnNotification=ogCellApnNotification, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserTable=ogSerialUserTable, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsCounter=ogUpsCounter, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceTable=ogHostServiceTable, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientAp=ogWifiApClientAp, ogWifiApEntry=ogWifiApEntry, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsEntry=ogUpsEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialNumber=ogSerialNumber, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogFirmwareVersion=ogFirmwareVersion)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortCTS=ogSerialPortCTS, ogWifiApFrequency=ogWifiApFrequency, ogUpsDescription=ogUpsDescription, ogHostUserHostName=ogHostUserHostName, ogWifiClientRssi=ogWifiClientRssi, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmDevice=ogAlarmDevice, ogHostUserIndex=ogHostUserIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckEntry=ogCheckEntry, ogWebUserName=ogWebUserName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceName=ogCheckDeviceName, ogCellModemNetwork=ogCellModemNetwork, ogCellMessageNotification=ogCellMessageNotification, ogAlarmUser=ogAlarmUser, ogUpsIndex=ogUpsIndex, ogCellModemCounter=ogCellModemCounter, ogAlarmType=ogAlarmType, ogRpcTable=ogRpcTable, ogAlarmState=ogAlarmState, ogCheckType=ogCheckType, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialUserLabel=ogSerialUserLabel, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityCounter=ogEmdHumidityCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdEntry=ogEmdEntry, ogRpcEntry=ogRpcEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserName=ogHostUserName, ogCustomNotification=ogCustomNotification, ogEmdIndex=ogEmdIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemModel=ogCellModemModel, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsName=ogUpsName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsState=ogUpsState, ogHostName=ogHostName, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientCounter=ogWifiClientCounter)
