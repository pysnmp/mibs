...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarm=ogAlarm, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcConnectType=ogRpcConnectType, ogUpsState=ogUpsState, ogSerialPortDCD=ogSerialPortDCD, ogAlarmState=ogAlarmState, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortCTS=ogSerialPortCTS, ogHostServicePort=ogHostServicePort, ogCellModemTower=ogCellModemTower, ogEmdDioType=ogEmdDioType, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialUserPort=ogSerialUserPort, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserName=ogSerialUserName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWebUserTable=ogWebUserTable, ogHostServiceEntry=ogHostServiceEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemTable=ogCellModemTable, ogRpcTable=ogRpcTable, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserHostName=ogHostUserHostName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryState=ogUpsBatteryState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemCounter=ogCellModemCounter, ogUpsDescription=ogUpsDescription, ogEmdDioEntry=ogEmdDioEntry, ogStatus2Conformance=ogStatus2Conformance, ogHostUserIndex=ogHostUserIndex, ogUpsNotification=ogUpsNotification, ogEmdEnabled=ogEmdEnabled, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientRssi=ogWifiClientRssi, ogHostUserHost=ogHostUserHost, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckDeviceName=ogCheckDeviceName, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceName=ogNetInterfaceName, ogUpsType=ogUpsType, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioName=ogEmdDioName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsName=ogUpsName, ogHostEntry=ogHostEntry, ogWifiClientCounter=ogWifiClientCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckIndex=ogCheckIndex, ogHostUserEntry=ogHostUserEntry, ogRpcOutletName=ogRpcOutletName, ogSerialPortTable=ogSerialPortTable, ogWifiApEnabled=ogWifiApEnabled, ogEmdHumidityTable=ogEmdHumidityTable, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmTime=ogAlarmTime, ogMibNotifications=ogMibNotifications, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemEnabled=ogCellModemEnabled, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcIndex=ogRpcIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsHumidity=ogUpsHumidity, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceStatus=ogHostServiceStatus, ogCellModemEntry=ogCellModemEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientMac=ogWifiApClientMac, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdTable=ogEmdTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostIndex=ogHostIndex, ogWifiApClientTable=ogWifiApClientTable, ogHostUserName=ogHostUserName, ogEmdDioIndex=ogEmdDioIndex, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputPower=ogUpsOutputPower, ogWifiApSsid=ogWifiApSsid, ogAlarmUser=ogAlarmUser, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogStatus2Compliances=ogStatus2Compliances, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioDirection=ogEmdDioDirection, ogCellModemIMSI=ogCellModemIMSI, ogWifiApTable=ogWifiApTable, ogUpsIndex=ogUpsIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsEntry=ogUpsEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostPingNotification=ogHostPingNotification, ogEmdDioDescription=ogEmdDioDescription, ogSystem=ogSystem, ogUpsConnectType=ogUpsConnectType, ogCheckResolveActions=ogCheckResolveActions, ogCellModemTemperature=ogCellModemTemperature, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcDescription=ogRpcDescription, ogRpcOutletState=ogRpcOutletState, ogEmdIndex=ogEmdIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioState=ogEmdDioState, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceTable=ogCheckDeviceTable, PYSNMP_MODULE_ID=ogStatus2, ogPowerSupplyName=ogPowerSupplyName, ogCellDataNotification=ogCellDataNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdConnectType=ogEmdConnectType, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientEssid=ogWifiClientEssid, ogAlarmCheck=ogAlarmCheck, ogSerialNumber=ogSerialNumber, ogSerialPortMode=ogSerialPortMode, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2Groups=ogStatus2Groups, ogHostIpV6Address=ogHostIpV6Address, ogEmdEntry=ogEmdEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCustomNotification=ogCustomNotification, ogHostName=ogHostName, ogRpcCounter=ogRpcCounter, ogRpcEntry=ogRpcEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemApn=ogCellModemApn, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortIndex=ogSerialPortIndex, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsInputFrequency=ogUpsInputFrequency, ogCellApnNotification=ogCellApnNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsCounter=ogUpsCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserName=ogWebUserName, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogStatus2=ogStatus2, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemModel=ogCellModemModel, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientMode=ogWifiClientMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApInterface=ogWifiApInterface, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostUserNotification=ogHostUserNotification, ogSerialUserTable=ogSerialUserTable, ogHostTable=ogHostTable, ogHostUserTable=ogHostUserTable, ogRpcName=ogRpcName, ogHostServiceHost=ogHostServiceHost, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckType=ogCheckType, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletTable=ogRpcOutletTable, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortParity=ogSerialPortParity, ogAlarmName=ogAlarmName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemNetwork=ogCellModemNetwork, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemConnected=ogCellModemConnected, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserNotification=ogWebUserNotification, ogEmdDioTable=ogEmdDioTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsInputNotification=ogUpsInputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsTemperature=ogUpsTemperature, ogCheckName=ogCheckName, ogCellModemVendor=ogCellModemVendor, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioEmd=ogEmdDioEmd)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2Compliance=ogStatus2Compliance, ogEmdDescription=ogEmdDescription, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioCounter=ogEmdDioCounter, ogUpsTable=ogUpsTable, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortRTS=ogSerialPortRTS, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemIndex=ogCellModemIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserStartTime=ogWebUserStartTime, ogEmdName=ogEmdName, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceType=ogHostServiceType, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApIndex=ogWifiApIndex, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityNotification=ogEmdHumidityNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientApMac=ogWifiClientApMac, ogHostUserAddress=ogHostUserAddress, ogAlarmType=ogAlarmType, ogAlarmInstance=ogAlarmInstance, ogRpcType=ogRpcType, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApFrequency=ogWifiApFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellMessageNotification=ogCellMessageNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientRssi=ogWifiApClientRssi, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserEntry=ogWebUserEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemRegistered=ogCellModemRegistered, ogWebUserIndex=ogWebUserIndex, ogCheckEntry=ogCheckEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientEntry=ogWifiClientEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApEntry=ogWifiApEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioInputTotal=ogEmdDioInputTotal)
