...
Unsigned32, MibIdentifier, Gauge32, NotificationType, Counter64, ObjectIdentity, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, ModuleIdentity, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "Gauge32", "NotificationType", "Counter64", "ObjectIdentity", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "ModuleIdentity", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostUserIndex=ogHostUserIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckResolveActions=ogCheckResolveActions, ogAlarmLogTable=ogAlarmLogTable, ogUpsInputVoltage=ogUpsInputVoltage, ogHostUserHost=ogHostUserHost, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioState=ogEmdDioState, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdIndex=ogEmdIndex, ogUpsConnectType=ogUpsConnectType, ogHostIpV4Address=ogHostIpV4Address, ogCellModemApn=ogCellModemApn, ogWifiApTable=ogWifiApTable, ogEmdHumidityName=ogEmdHumidityName, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApTxPower=ogWifiApTxPower, ogHostIndex=ogHostIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmName=ogAlarmName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortDCD=ogSerialPortDCD, ogHostIpV6Address=ogHostIpV6Address, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmType=ogAlarmType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserHostName=ogHostUserHostName, ogWifiClientEntry=ogWifiClientEntry, ogEmdConnectType=ogEmdConnectType, ogWifiApCounter=ogWifiApCounter, ogAlarmEventId=ogAlarmEventId, ogAlarmSummary=ogAlarmSummary, ogEmdName=ogEmdName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceType=ogHostServiceType, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserName=ogWebUserName, ogUpsName=ogUpsName, ogHostServiceStatus=ogHostServiceStatus, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsNotification=ogUpsNotification, ogRpcInputNotification=ogRpcInputNotification, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmState=ogAlarmState, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2Groups=ogStatus2Groups, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApSsid=ogWifiApSsid, ogSerialPortLabel=ogSerialPortLabel, ogCellModemModel=ogCellModemModel, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckName=ogCheckName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserName=ogHostUserName, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsState=ogUpsState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcName=ogRpcName, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDescription=ogEmdDescription, ogSerialPortTable=ogSerialPortTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemTemperature=ogCellModemTemperature, ogHostUserTable=ogHostUserTable, ogUpsIndex=ogUpsIndex, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemVendor=ogCellModemVendor, ogEmdDioTable=ogEmdDioTable, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmCheck=ogAlarmCheck, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioDescription=ogEmdDioDescription, ogAlarmDevice=ogAlarmDevice, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsTemperature=ogUpsTemperature, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserNotification=ogHostUserNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortParity=ogSerialPortParity, ogCheckDeviceTable=ogCheckDeviceTable, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialNumber=ogSerialNumber, ogSerialUserStartTime=ogSerialUserStartTime, ogWebUserTable=ogWebUserTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputVoltage=ogUpsOutputVoltage, ogStatus2=ogStatus2, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserNotification=ogWebUserNotification, ogHostUserEntry=ogHostUserEntry, ogUpsHumidity=ogUpsHumidity, ogRpcConnectType=ogRpcConnectType, ogWebUserSourcePort=ogWebUserSourcePort, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmTime=ogAlarmTime, ogSystem=ogSystem, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceHost=ogHostServiceHost, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioName=ogEmdDioName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemTable=ogCellModemTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellMessageNotification=ogCellMessageNotification, ogCheckType=ogCheckType, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserStartTime=ogHostUserStartTime, ogRpcEntry=ogRpcEntry, ogWifiClientMode=ogWifiClientMode, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmUser=ogAlarmUser, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceTable=ogHostServiceTable, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientCounter=ogWifiClientCounter, ogEmdTable=ogEmdTable, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyEntry=ogPowerSupplyEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortDSR=ogSerialPortDSR, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsTable=ogUpsTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortEntry=ogSerialPortEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogHostServiceCounter=ogHostServiceCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcType=ogRpcType, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogNetInterfaceState=ogNetInterfaceState, ogUpsEntry=ogUpsEntry, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2Conformance=ogStatus2Conformance, ogUpsCounter=ogUpsCounter, ogEmdEntry=ogEmdEntry, ogCustomNotification=ogCustomNotification, ogMibNotifications=ogMibNotifications, ogSerialUserName=ogSerialUserName, ogWifiApFrequency=ogWifiApFrequency, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserPort=ogSerialUserPort, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostPingNotification=ogHostPingNotification, ogRpcIndex=ogRpcIndex, ogSerialPortMode=ogSerialPortMode, ogCheckEntry=ogCheckEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputPower=ogUpsOutputPower, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioNotification=ogEmdDioNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioIndex=ogEmdDioIndex, ogRpcCounter=ogRpcCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogCellDataNotification=ogCellDataNotification, ogSerialUserEntry=ogSerialUserEntry, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletState=ogRpcOutletState, ogRpcDescription=ogRpcDescription, ogCellNetworkNotification=ogCellNetworkNotification, ogCellApnNotification=ogCellApnNotification, ogAlarmInstance=ogAlarmInstance, ogSerialUserTable=ogSerialUserTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdEnabled=ogEmdEnabled, ogAlarm=ogAlarm, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyName=ogPowerSupplyName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialUserNotification=ogSerialUserNotification, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioType=ogEmdDioType, ogHostServicePort=ogHostServicePort, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceNotification=ogHostServiceNotification, ogCellModemCounter=ogCellModemCounter, ogUpsType=ogUpsType, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckIndex=ogCheckIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostTable=ogHostTable, ogRpcTable=ogRpcTable, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletName=ogRpcOutletName, ogWifiApEnabled=ogWifiApEnabled, ogCheckDeviceName=ogCheckDeviceName, ogCellTowerNotification=ogCellTowerNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemIMSI=ogCellModemIMSI, ogWifiApEntry=ogWifiApEntry, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientEssid=ogWifiClientEssid, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemEntry=ogCellModemEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckTable=ogCheckTable, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletNotification=ogRpcOutletNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserIndex=ogWebUserIndex, ogHostEntry=ogHostEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsDescription=ogUpsDescription, ogCellModemTower=ogCellModemTower, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostName=ogHostName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogBasicNotificationGroup=ogBasicNotificationGroup)
