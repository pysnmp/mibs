...
TimeTicks, ObjectIdentity, iso, Gauge32, NotificationType, Unsigned32, Counter32, ModuleIdentity, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "iso", "Gauge32", "NotificationType", "Unsigned32", "Counter32", "ModuleIdentity", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortMode=ogSerialPortMode, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortIndex=ogSerialPortIndex, ogSerialUserTable=ogSerialUserTable, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsNotification=ogUpsNotification, ogUpsTable=ogUpsTable, ogHostName=ogHostName, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcInputNotification=ogRpcInputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServicePort=ogHostServicePort, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemIndex=ogCellModemIndex, ogHostUserIndex=ogHostUserIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioNotification=ogEmdDioNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialNumber=ogSerialNumber, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientIndex=ogWifiClientIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioCounter=ogEmdDioCounter, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsDescription=ogUpsDescription, ogCellModemTemperature=ogCellModemTemperature, ogNetInterfaceType=ogNetInterfaceType, ogCellModemVendor=ogCellModemVendor, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputFrequency=ogUpsOutputFrequency, ogStatus2Groups=ogStatus2Groups, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserTable=ogHostUserTable, ogUpsInputVoltage=ogUpsInputVoltage, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWebUserTable=ogWebUserTable, ogHostUserStartTime=ogHostUserStartTime, ogRpcEntry=ogRpcEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckResolveActions=ogCheckResolveActions, ogCellModemRegistered=ogCellModemRegistered, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceTable=ogHostServiceTable, ogWebUserName=ogWebUserName, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioEmd=ogEmdDioEmd, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogMibNotifications=ogMibNotifications, ogAlarm=ogAlarm, ogHostTable=ogHostTable, ogHostServiceIndex=ogHostServiceIndex, ogRpcCounter=ogRpcCounter, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceEntry=ogHostServiceEntry, ogEmdTable=ogEmdTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemIMSI=ogCellModemIMSI, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmCheck=ogAlarmCheck, ogCellTowerNotification=ogCellTowerNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortDSR=ogSerialPortDSR, ogHostUserHost=ogHostUserHost, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckName=ogCheckName, ogStatus2Compliance=ogStatus2Compliance, ogEmdName=ogEmdName, ogHostEntry=ogHostEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserName=ogHostUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialUserNotification=ogSerialUserNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcConnectType=ogRpcConnectType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDescription=ogEmdDescription, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemTable=ogCellModemTable, ogRpcOutletNotification=ogRpcOutletNotification, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemConnected=ogCellModemConnected, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortTable=ogSerialPortTable, ogUpsHumidity=ogUpsHumidity, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemEnabled=ogCellModemEnabled, ogRpcDescription=ogRpcDescription, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSystem=ogSystem, ogUpsIndex=ogUpsIndex, ogHostServiceStatus=ogHostServiceStatus, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmLogEntry=ogAlarmLogEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortStopBits=ogSerialPortStopBits, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioType=ogEmdDioType, ogEmdDioTable=ogEmdDioTable, ogWifiApEntry=ogWifiApEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckIndex=ogCheckIndex, ogWifiClientApMac=ogWifiClientApMac, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsConnectType=ogUpsConnectType, ogWifiClientMode=ogWifiClientMode, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortEntry=ogSerialPortEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmName=ogAlarmName, ogHostUserHostName=ogHostUserHostName, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsName=ogUpsName, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdEntry=ogEmdEntry, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmTime=ogAlarmTime, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemApn=ogCellModemApn, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmType=ogCurrentAlarmType, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmEventId=ogAlarmEventId, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApCounter=ogWifiApCounter, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcIndex=ogRpcIndex, ogAlarmInstance=ogAlarmInstance, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserNotification=ogHostUserNotification, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcTable=ogRpcTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortRTS=ogSerialPortRTS, ogSerialUserPort=ogSerialUserPort, ogCellModemTower=ogCellModemTower, ogUpsCounter=ogUpsCounter, ogHostIndex=ogHostIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientInterface=ogWifiClientInterface, ogWifiApIndex=ogWifiApIndex, ogSerialUserName=ogSerialUserName, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmState=ogAlarmState, ogHostServiceCounter=ogHostServiceCounter, ogStatus2Conformance=ogStatus2Conformance, ogCheckType=ogCheckType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioName=ogEmdDioName, ogSerialPortCTS=ogSerialPortCTS, ogCellModemModel=ogCellModemModel, ogWifiApInterface=ogWifiApInterface, ogAlarmType=ogAlarmType, ogRpcOutletName=ogRpcOutletName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckTable=ogCheckTable, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApEnabled=ogWifiApEnabled)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioState=ogEmdDioState, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletState=ogRpcOutletState, ogRpcName=ogRpcName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsState=ogUpsState, ogAlarmUser=ogAlarmUser, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogStatus2=ogStatus2, ogWebUserEntry=ogWebUserEntry, ogWifiApTable=ogWifiApTable, ogUpsTemperature=ogUpsTemperature, ogUpsEntry=ogUpsEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellApnNotification=ogCellApnNotification, ogWifiClientEntry=ogWifiClientEntry, ogWebUserNotification=ogWebUserNotification, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostIpV4Address=ogHostIpV4Address, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostUserAddress=ogHostUserAddress, ogUpsType=ogUpsType, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostIpV6Address=ogHostIpV6Address, ogEmdConnectType=ogEmdConnectType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputCurrent=ogUpsOutputCurrent, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdIndex=ogEmdIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckEntry=ogCheckEntry, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryState=ogUpsBatteryState, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCustomNotification=ogCustomNotification, ogAlarmSummary=ogAlarmSummary, ogRpcType=ogRpcType, ogWifiClientRssi=ogWifiClientRssi, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientTxBytes=ogWifiApClientTxBytes, PYSNMP_MODULE_ID=ogStatus2, ogAlarmLogTable=ogAlarmLogTable)
