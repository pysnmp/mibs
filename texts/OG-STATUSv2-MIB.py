...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortMode=ogSerialPortMode, ogHostPingNotification=ogHostPingNotification, ogRpcType=ogRpcType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckDeviceName=ogCheckDeviceName, ogHostUserTable=ogHostUserTable, ogEmdEnabled=ogEmdEnabled, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemApn=ogCellModemApn, ogUpsDescription=ogUpsDescription, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmState=ogAlarmState, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostTable=ogHostTable, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientAp=ogWifiApClientAp, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcEntry=ogRpcEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckEntry=ogCheckEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostName=ogHostName, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserEntry=ogHostUserEntry, ogCellApnNotification=ogCellApnNotification, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceState=ogNetInterfaceState, ogHostServiceHost=ogHostServiceHost, ogEmdDioTable=ogEmdDioTable, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcDescription=ogRpcDescription, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostIndex=ogHostIndex, ogHostServiceStatus=ogHostServiceStatus, ogHostUserHostName=ogHostUserHostName, ogEmdDioEntry=ogEmdDioEntry, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioIndex=ogEmdDioIndex, ogUpsTable=ogUpsTable, ogWebUserNotification=ogWebUserNotification, ogCellModemCounter=ogCellModemCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemTemperature=ogCellModemTemperature, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogStatus2Compliances=ogStatus2Compliances, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserName=ogHostUserName, ogCheckType=ogCheckType, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemIMSI=ogCellModemIMSI, ogNetInterfaceNotification=ogNetInterfaceNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsNotification=ogUpsNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWebUserEntry=ogWebUserEntry, ogCellModemEntry=ogCellModemEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientEntry=ogWifiClientEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmSummary=ogAlarmSummary, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDTR=ogSerialPortDTR, ogWebUserStartTime=ogWebUserStartTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogMibNotifications=ogMibNotifications, ogEmdDescription=ogEmdDescription, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioName=ogEmdDioName, ogEmdDioType=ogEmdDioType, ogEmdDioDirection=ogEmdDioDirection, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortTable=ogSerialPortTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellSignalNotification=ogCellSignalNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientMode=ogWifiClientMode, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemIndex=ogCellModemIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceCounter=ogHostServiceCounter, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyName=ogPowerSupplyName, ogAlarmCheck=ogAlarmCheck, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApEntry=ogWifiApEntry, ogWebUserIndex=ogWebUserIndex, ogHostUserHost=ogHostUserHost, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityName=ogEmdHumidityName, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemRegistered=ogCellModemRegistered, ogCellModemTower=ogCellModemTower, ogStatus2=ogStatus2, ogRpcTable=ogRpcTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsConnectType=ogUpsConnectType, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceType=ogNetInterfaceType, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsIndex=ogUpsIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortDCD=ogSerialPortDCD, ogEmdTable=ogEmdTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsHumidity=ogUpsHumidity, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsTemperature=ogUpsTemperature, ogWebUserName=ogWebUserName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarm=ogAlarm, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortIndex=ogSerialPortIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApInterface=ogWifiApInterface, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcConnectType=ogRpcConnectType, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientCounter=ogWifiClientCounter, ogHostServiceEntry=ogHostServiceEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogStatus2Compliance=ogStatus2Compliance, ogHostServiceType=ogHostServiceType, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemVendor=ogCellModemVendor, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostServiceIndex=ogHostServiceIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckIndex=ogCheckIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientEssid=ogWifiClientEssid, ogEmdName=ogEmdName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserAddress=ogHostUserAddress, ogWebUserSourcePort=ogWebUserSourcePort, ogHostEntry=ogHostEntry, ogWifiApCounter=ogWifiApCounter, ogWifiApFrequency=ogWifiApFrequency, ogAlarmEventId=ogAlarmEventId, ogAlarmName=ogAlarmName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemNetwork=ogCellModemNetwork, ogCheckTable=ogCheckTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialNumber=ogSerialNumber, ogSerialUserName=ogSerialUserName, ogUpsType=ogUpsType, ogSerialUserEntry=ogSerialUserEntry, ogCellModemTable=ogCellModemTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletTable=ogRpcOutletTable, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioNotification=ogEmdDioNotification, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellDataNotification=ogCellDataNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSystem=ogSystem, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortParity=ogSerialPortParity, ogUpsName=ogUpsName, ogWifiApClientMac=ogWifiApClientMac, ogCellMessageNotification=ogCellMessageNotification, ogCheckName=ogCheckName, ogCustomNotification=ogCustomNotification, ogUpsEntry=ogUpsEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryTemperature=ogUpsBatteryTemperature)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckTriggerActions=ogCheckTriggerActions, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutputNotification=ogRpcOutputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioCounter=ogEmdDioCounter, ogSerialUserPort=ogSerialUserPort, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApSsid=ogWifiApSsid, ogStatus2Groups=ogStatus2Groups, ogWebUserTable=ogWebUserTable, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceTable=ogHostServiceTable, ogUpsState=ogUpsState, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemModel=ogCellModemModel, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserIndex=ogHostUserIndex, ogSerialPortEntry=ogSerialPortEntry, ogEmdIndex=ogEmdIndex, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApIndex=ogWifiApIndex, PYSNMP_MODULE_ID=ogStatus2, ogEmdEntry=ogEmdEntry, ogRpcCounter=ogRpcCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApEnabled=ogWifiApEnabled, ogAlarmUser=ogAlarmUser, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientTable=ogWifiClientTable, ogUpsCounter=ogUpsCounter, ogUpsBatteryState=ogUpsBatteryState, ogRpcInputNotification=ogRpcInputNotification, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletState=ogRpcOutletState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioDescription=ogEmdDioDescription, ogAlarmType=ogAlarmType, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApTable=ogWifiApTable, ogHostIpV4Address=ogHostIpV4Address, ogRpcName=ogRpcName, ogSerialPortDSR=ogSerialPortDSR, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemConnected=ogCellModemConnected, ogHostServicePort=ogHostServicePort, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioState=ogEmdDioState, ogRpcIndex=ogRpcIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmTime=ogAlarmTime)
