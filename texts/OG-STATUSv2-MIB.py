...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogStatus2Groups=ogStatus2Groups, ogEmdIndex=ogEmdIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletState=ogRpcOutletState, ogHostIpV6Address=ogHostIpV6Address, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserNotification=ogSerialUserNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsEntry=ogUpsEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsName=ogUpsName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortDataBits=ogSerialPortDataBits, ogCheckType=ogCheckType, ogCellModemTower=ogCellModemTower, ogWifiClientRssi=ogWifiClientRssi, ogUpsIndex=ogUpsIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialNumber=ogSerialNumber, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcIndex=ogRpcIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemModel=ogCellModemModel, ogSerialPortDCD=ogSerialPortDCD, ogRpcName=ogRpcName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApTxPower=ogWifiApTxPower, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletName=ogRpcOutletName, ogUpsHumidity=ogUpsHumidity, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdName=ogEmdName, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsCounter=ogUpsCounter, ogEmdDioState=ogEmdDioState, ogRpcDescription=ogRpcDescription, ogAlarmTime=ogAlarmTime, ogEmdEnabled=ogEmdEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsTemperature=ogUpsTemperature, ogHostPingNotification=ogHostPingNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortParity=ogSerialPortParity, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientTable=ogWifiApClientTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcType=ogRpcType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemCounter=ogCellModemCounter, ogUpsType=ogUpsType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemVendor=ogCellModemVendor, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioType=ogEmdDioType, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientCounter=ogWifiClientCounter, ogAlarmSummary=ogAlarmSummary, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemTemperature=ogCellModemTemperature, ogAlarmType=ogAlarmType, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceTable=ogHostServiceTable, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityName=ogEmdHumidityName, ogUpsTable=ogUpsTable, ogHostIndex=ogHostIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCustomNotification=ogCustomNotification, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserTable=ogSerialUserTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPatternNotification=ogSerialPatternNotification, ogWebUserIndex=ogWebUserIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmLogIndex=ogAlarmLogIndex, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2Compliances=ogStatus2Compliances, PYSNMP_MODULE_ID=ogStatus2, ogAlarm=ogAlarm, ogWifiApClientAp=ogWifiApClientAp, ogAlarmEventId=ogAlarmEventId, ogCellMessageNotification=ogCellMessageNotification, ogUpsDescription=ogUpsDescription, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcInputFrequency=ogRpcInputFrequency, ogStatus2Compliance=ogStatus2Compliance, ogWebUserNotification=ogWebUserNotification, ogCellApnNotification=ogCellApnNotification, ogHostUserIndex=ogHostUserIndex, ogRpcCounter=ogRpcCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletEntry=ogRpcOutletEntry, ogCellDataNotification=ogCellDataNotification, ogCheckIndex=ogCheckIndex, ogHostServiceHost=ogHostServiceHost, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientMac=ogWifiApClientMac, ogWifiApIndex=ogWifiApIndex, ogSerialUserPort=ogSerialUserPort, ogRpcOutletRpc=ogRpcOutletRpc, ogHostTable=ogHostTable, ogWifiApEnabled=ogWifiApEnabled, ogWebUserEntry=ogWebUserEntry, ogEmdDioEmd=ogEmdDioEmd, ogHostUserTable=ogHostUserTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserEntry=ogHostUserEntry, ogCellModemApn=ogCellModemApn, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckEntry=ogCheckEntry, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioName=ogEmdDioName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemConnected=ogCellModemConnected, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialUserName=ogSerialUserName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcTable=ogRpcTable, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApEntry=ogWifiApEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogHostEntry=ogHostEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsNotification=ogUpsNotification, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientTable=ogWifiClientTable, ogHostIpV4Address=ogHostIpV4Address, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceName=ogNetInterfaceName, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmCheck=ogAlarmCheck, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioEntry=ogEmdDioEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserName=ogHostUserName, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmState=ogAlarmState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemIndex=ogCellModemIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputNotification=ogUpsInputNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmDevice=ogAlarmDevice, ogUpsConnectType=ogUpsConnectType, ogSystem=ogSystem, ogWifiClientIndex=ogWifiClientIndex, ogHostServiceStatus=ogHostServiceStatus, ogHostUserHost=ogHostUserHost, ogWebUserTable=ogWebUserTable, ogCellModemIMSI=ogCellModemIMSI, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserHostName=ogHostUserHostName, ogCheckDeviceName=ogCheckDeviceName, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApInterface=ogWifiApInterface)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDescription=ogEmdDescription, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostServicePort=ogHostServicePort, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsState=ogUpsState, ogAlarmInstance=ogAlarmInstance, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostName=ogHostName, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemTable=ogCellModemTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmName=ogAlarmName, ogCurrentAlarmName=ogCurrentAlarmName, ogWebUserName=ogWebUserName, ogEmdDioCounter=ogEmdDioCounter, ogHostUserAddress=ogHostUserAddress, ogWifiApSsid=ogWifiApSsid, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientEntry=ogWifiClientEntry, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckName=ogCheckName, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApFrequency=ogWifiApFrequency, ogHostUserNotification=ogHostUserNotification, ogSerialUserLabel=ogSerialUserLabel, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortDTR=ogSerialPortDTR, ogCellTowerNotification=ogCellTowerNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApTable=ogWifiApTable, ogEmdDioTable=ogEmdDioTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogStatus2=ogStatus2, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTable=ogEmdTable, ogMibNotifications=ogMibNotifications, ogSerialPortMode=ogSerialPortMode, ogHostServiceType=ogHostServiceType, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureValue=ogEmdTemperatureValue, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortIndex=ogSerialPortIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmUser=ogAlarmUser, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcEntry=ogRpcEntry, ogNetInterfaceState=ogNetInterfaceState, ogEmdEntry=ogEmdEntry, ogCheckTable=ogCheckTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputCurrent=ogUpsInputCurrent)
