...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserNotification=ogWebUserNotification, ogEmdDescription=ogEmdDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApTxPower=ogWifiApTxPower, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientMac=ogWifiApClientMac, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsName=ogUpsName, ogCustomNotification=ogCustomNotification, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellApnNotification=ogCellApnNotification, ogWebUserStartTime=ogWebUserStartTime, ogHostServiceHost=ogHostServiceHost, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceTable=ogHostServiceTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserHostName=ogHostUserHostName, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemTemperature=ogCellModemTemperature, ogSerialUserPort=ogSerialUserPort, ogHostIndex=ogHostIndex, ogHostUserName=ogHostUserName, ogCellModemNetwork=ogCellModemNetwork, ogSerialUserEntry=ogSerialUserEntry, ogRpcType=ogRpcType, ogHostServiceCounter=ogHostServiceCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialUserName=ogSerialUserName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmUser=ogAlarmUser, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientCounter=ogWifiClientCounter, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortDCD=ogSerialPortDCD, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortParity=ogSerialPortParity, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcName=ogRpcName, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceNotification=ogHostServiceNotification, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdDioCounter=ogEmdDioCounter, ogWifiApTable=ogWifiApTable, ogWifiApInterface=ogWifiApInterface, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostUserAddress=ogHostUserAddress, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmName=ogCurrentAlarmName, ogWebUserName=ogWebUserName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApCounter=ogWifiApCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortRTS=ogSerialPortRTS, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogCellDataNotification=ogCellDataNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemModel=ogCellModemModel, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdName=ogEmdName, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientRssi=ogWifiApClientRssi, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortIndex=ogSerialPortIndex, ogCellModemTower=ogCellModemTower, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcIndex=ogRpcIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsType=ogUpsType, ogRpcOutletName=ogRpcOutletName, ogStatus2=ogStatus2, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCellSignalNotification=ogCellSignalNotification, ogUpsCounter=ogUpsCounter, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityName=ogEmdHumidityName, ogHostUserStartTime=ogHostUserStartTime, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWebUserIndex=ogWebUserIndex, ogSerialPortTable=ogSerialPortTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsTable=ogUpsTable, ogHostServiceEntry=ogHostServiceEntry, ogEmdIndex=ogEmdIndex, ogUpsEntry=ogUpsEntry, ogAlarmType=ogAlarmType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemApn=ogCellModemApn, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdEnabled=ogEmdEnabled, ogWifiApEntry=ogWifiApEntry, ogRpcTable=ogRpcTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientInterface=ogWifiClientInterface, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialNumber=ogSerialNumber, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsConnectType=ogUpsConnectType, ogCheckIndex=ogCheckIndex, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRssi=ogWifiClientRssi, ogAlarmEventId=ogAlarmEventId, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsState=ogUpsState, ogEmdDioType=ogEmdDioType, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserLabel=ogSerialUserLabel, ogUpsIndex=ogUpsIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortCTS=ogSerialPortCTS, ogHostName=ogHostName, ogWebUserTable=ogWebUserTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmLogTable=ogAlarmLogTable, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmName=ogAlarmName, ogAlarmDevice=ogAlarmDevice, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserEntry=ogHostUserEntry, ogStatus2Groups=ogStatus2Groups, ogCellMessageNotification=ogCellMessageNotification, ogEmdEntry=ogEmdEntry, ogCellModemIMSI=ogCellModemIMSI, ogRpcConnectType=ogRpcConnectType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioEmd=ogEmdDioEmd, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemIndex=ogCellModemIndex, ogSerialPortLabel=ogSerialPortLabel, ogCheckName=ogCheckName, ogRpcDescription=ogRpcDescription, ogWifiApClientAp=ogWifiApClientAp, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemCounter=ogCellModemCounter, ogWifiApSsid=ogWifiApSsid, ogSystem=ogSystem, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputFrequency=ogUpsOutputFrequency, ogStatus2Conformance=ogStatus2Conformance, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostIpV4Address=ogHostIpV4Address, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServiceStatus=ogHostServiceStatus, ogUpsNotification=ogUpsNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemTable=ogCellModemTable, ogEmdDioTable=ogEmdDioTable, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortMode=ogSerialPortMode, ogCheckResolveActions=ogCheckResolveActions, ogUpsDescription=ogUpsDescription, ogSerialUserTable=ogSerialUserTable, ogSerialUserIndex=ogSerialUserIndex, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryVoltage=ogUpsBatteryVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckTable=ogCheckTable, PYSNMP_MODULE_ID=ogStatus2, ogHostUserHost=ogHostUserHost, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostServiceType=ogHostServiceType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientMode=ogWifiClientMode, ogAlarm=ogAlarm, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmTime=ogAlarmTime, ogWebUserEntry=ogWebUserEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckType=ogCheckType, ogHostPingNotification=ogHostPingNotification, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientTable=ogWifiClientTable, ogEmdDioName=ogEmdDioName, ogAlarmCheck=ogAlarmCheck, ogFirmwareVersion=ogFirmwareVersion, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdConnectType=ogEmdConnectType, ogUpsInputVoltage=ogUpsInputVoltage, ogHostTable=ogHostTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostEntry=ogHostEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioState=ogEmdDioState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckEntry=ogCheckEntry, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserTable=ogHostUserTable, ogHostServicePort=ogHostServicePort, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcEntry=ogRpcEntry, ogMibNotifications=ogMibNotifications, ogStatus2Compliance=ogStatus2Compliance, ogEmdTable=ogEmdTable, ogAlarmState=ogAlarmState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcCounter=ogRpcCounter, ogAlarmInstance=ogAlarmInstance, ogCellModemVendor=ogCellModemVendor, ogCellModemRegistered=ogCellModemRegistered)
