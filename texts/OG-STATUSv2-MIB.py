...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckDeviceEntry=ogCheckDeviceEntry, ogStatus2=ogStatus2, ogEmdEnabled=ogEmdEnabled, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserAddress=ogHostUserAddress, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputNotification=ogUpsInputNotification, ogStatus2Compliances=ogStatus2Compliances, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmUser=ogAlarmUser, ogCheckEntry=ogCheckEntry, ogRpcIndex=ogRpcIndex, ogWifiClientTable=ogWifiClientTable, ogHostTable=ogHostTable, ogSerialPortDCD=ogSerialPortDCD, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServicePort=ogHostServicePort, ogAlarmType=ogAlarmType, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsIndex=ogUpsIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogMibNotifications=ogMibNotifications, ogSerialUserName=ogSerialUserName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCustomNotification=ogCustomNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsConnectType=ogUpsConnectType, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortDTR=ogSerialPortDTR, ogWebUserName=ogWebUserName, ogHostUserTable=ogHostUserTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserHost=ogHostUserHost, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceName=ogNetInterfaceName, ogAlarmCheck=ogAlarmCheck, ogUpsTable=ogUpsTable, ogHostEntry=ogHostEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostServiceTable=ogHostServiceTable, ogUpsEntry=ogUpsEntry, ogSerialPortRTS=ogSerialPortRTS, ogAlarmEventId=ogAlarmEventId, ogUpsName=ogUpsName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortEntry=ogSerialPortEntry, ogRpcDescription=ogRpcDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortMode=ogSerialPortMode, ogCheckType=ogCheckType, ogHostServiceEntry=ogHostServiceEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdEntry=ogEmdEntry, ogUpsBatteryState=ogUpsBatteryState, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioTable=ogEmdDioTable, ogHostUserHostName=ogHostUserHostName, ogEmdIndex=ogEmdIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioIndex=ogEmdDioIndex, ogUpsHumidity=ogUpsHumidity, ogEmdDioType=ogEmdDioType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemModel=ogCellModemModel, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostUserEntry=ogHostUserEntry, ogAlarm=ogAlarm, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientMode=ogWifiClientMode, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDescription=ogEmdDescription, ogHostServiceType=ogHostServiceType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmDevice=ogAlarmDevice, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceIndex=ogHostServiceIndex, ogHostUserName=ogHostUserName, ogSerialUserLabel=ogSerialUserLabel, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientIndex=ogWifiClientIndex, ogCellModemEntry=ogCellModemEntry, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletName=ogRpcOutletName, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortParity=ogSerialPortParity, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientInterface=ogWifiClientInterface, ogRpcInputNotification=ogRpcInputNotification, ogRpcTable=ogRpcTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortTable=ogSerialPortTable, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceNotification=ogHostServiceNotification, ogCellSignalNotification=ogCellSignalNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientApMac=ogWifiClientApMac, ogCellModemVendor=ogCellModemVendor, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortIndex=ogSerialPortIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyName=ogPowerSupplyName, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApTxPower=ogWifiApTxPower, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcName=ogRpcName, ogCellModemConnected=ogCellModemConnected, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcType=ogRpcType, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApCounter=ogWifiApCounter, PYSNMP_MODULE_ID=ogStatus2, ogCellDataNotification=ogCellDataNotification, ogCheckName=ogCheckName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdName=ogEmdName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletState=ogRpcOutletState, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialUserTable=ogSerialUserTable, ogCheckIndex=ogCheckIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortCTS=ogSerialPortCTS, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckTable=ogCheckTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserNotification=ogHostUserNotification, ogCellModemTower=ogCellModemTower, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioState=ogEmdDioState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostIpV4Address=ogHostIpV4Address, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckResolveActions=ogCheckResolveActions, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemCounter=ogCellModemCounter, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserTable=ogWebUserTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsTemperature=ogUpsTemperature, ogWebUserNotification=ogWebUserNotification, ogSerialUserEntry=ogSerialUserEntry, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsState=ogUpsState, ogWifiApEntry=ogWifiApEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcCounter=ogRpcCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortFlowControl=ogSerialPortFlowControl)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsCounter=ogUpsCounter, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialNumber=ogSerialNumber, ogRpcEntry=ogRpcEntry, ogWifiApInterface=ogWifiApInterface, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmSummary=ogAlarmSummary, ogEmdDioCounter=ogEmdDioCounter, ogWifiApEnabled=ogWifiApEnabled, ogHostIndex=ogHostIndex, ogHostName=ogHostName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceHost=ogHostServiceHost, ogUpsType=ogUpsType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmInstance=ogAlarmInstance, ogHostPingNotification=ogHostPingNotification, ogHostUserIndex=ogHostUserIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmLogTable=ogAlarmLogTable, ogAlarmName=ogAlarmName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioName=ogEmdDioName, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTable=ogEmdTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogStatus2Groups=ogStatus2Groups, ogNetInterfaceTable=ogNetInterfaceTable, ogStatus2Conformance=ogStatus2Conformance, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceName=ogCheckDeviceName, ogWifiApIndex=ogWifiApIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientEntry=ogWifiApClientEntry, ogCellMessageNotification=ogCellMessageNotification, ogSystem=ogSystem, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsDescription=ogUpsDescription, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellApnNotification=ogCellApnNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemApn=ogCellModemApn, ogUpsNotification=ogUpsNotification, ogWifiApTable=ogWifiApTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserNotification=ogSerialUserNotification, ogCellModemTable=ogCellModemTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserEntry=ogWebUserEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmState=ogAlarmState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApFrequency=ogWifiApFrequency, ogAlarmTime=ogAlarmTime)
