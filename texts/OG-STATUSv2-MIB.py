...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostServiceType=ogHostServiceType, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApFrequency=ogWifiApFrequency, ogWebUserIndex=ogWebUserIndex, ogCellModemTable=ogCellModemTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmType=ogAlarmType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdEntry=ogEmdEntry, ogEmdDescription=ogEmdDescription, ogHostUserTable=ogHostUserTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckDeviceName=ogCheckDeviceName, ogRpcInputCurrent=ogRpcInputCurrent, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsTable=ogUpsTable, ogHostUserHost=ogHostUserHost, ogWifiClientEssid=ogWifiClientEssid, ogEmdIndex=ogEmdIndex, ogHostServiceEntry=ogHostServiceEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmState=ogAlarmState, ogHostIndex=ogHostIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApInterface=ogWifiApInterface, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemEntry=ogCellModemEntry, ogCheckType=ogCheckType, ogEmdDioDirection=ogEmdDioDirection, ogWifiApSsid=ogWifiApSsid, ogSerialPortRTS=ogSerialPortRTS, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModem3gRssi=ogCellModem3gRssi, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserTable=ogSerialUserTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutputNotification=ogRpcOutputNotification, ogStatus2Groups=ogStatus2Groups, ogSerialUserStartTime=ogSerialUserStartTime, ogNetInterfaceType=ogNetInterfaceType, ogSerialNumber=ogSerialNumber, ogRpcName=ogRpcName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletName=ogRpcOutletName, ogHostServiceHost=ogHostServiceHost, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyName=ogPowerSupplyName, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserName=ogSerialUserName, ogHostUserName=ogHostUserName, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioName=ogEmdDioName, ogWifiClientMode=ogWifiClientMode, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckTable=ogCheckTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApCounter=ogWifiApCounter, ogCellModemTower=ogCellModemTower, ogCellApnNotification=ogCellApnNotification, ogCheckEntry=ogCheckEntry, ogEmdTable=ogEmdTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceNotification=ogHostServiceNotification, ogHostName=ogHostName, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortParity=ogSerialPortParity, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmLogTable=ogAlarmLogTable, ogWebUserEntry=ogWebUserEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioEntry=ogEmdDioEntry, ogCellDataNotification=ogCellDataNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServicePort=ogHostServicePort, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletTable=ogRpcOutletTable, ogAlarmUser=ogAlarmUser, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmEventId=ogAlarmEventId, ogWifiApEntry=ogWifiApEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortMode=ogSerialPortMode, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceStatus=ogHostServiceStatus, ogRpcEntry=ogRpcEntry, ogHostServiceTable=ogHostServiceTable, ogUpsOutputPower=ogUpsOutputPower, ogRpcTable=ogRpcTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioIndex=ogEmdDioIndex, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientRssi=ogWifiClientRssi, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogHostEntry=ogHostEntry, ogUpsBatteryState=ogUpsBatteryState, ogCellModemIMSI=ogCellModemIMSI, ogUpsConnectType=ogUpsConnectType, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApTable=ogWifiApTable, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceName=ogNetInterfaceName, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsDescription=ogUpsDescription, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcType=ogRpcType, ogAlarmTime=ogAlarmTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcIndex=ogRpcIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientAp=ogWifiApClientAp, ogCellTowerNotification=ogCellTowerNotification, ogUpsState=ogUpsState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureName=ogEmdTemperatureName, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserIndex=ogSerialUserIndex, ogCellSignalNotification=ogCellSignalNotification, ogStatus2=ogStatus2, ogWifiApClientTable=ogWifiApClientTable, ogWebUserName=ogWebUserName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemApn=ogCellModemApn, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostIpV6Address=ogHostIpV6Address, ogCellModemVendor=ogCellModemVendor, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserTable=ogWebUserTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmDevice=ogAlarmDevice, ogRpcInputNotification=ogRpcInputNotification, ogAlarmSummary=ogAlarmSummary, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioCounter=ogEmdDioCounter, ogCustomNotification=ogCustomNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioNotification=ogEmdDioNotification, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmInstance=ogAlarmInstance, ogEmdEnabled=ogEmdEnabled, ogCellModemTemperature=ogCellModemTemperature, ogEmdConnectType=ogEmdConnectType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsTemperature=ogUpsTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserHostName=ogHostUserHostName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemEnabled=ogCellModemEnabled, ogHostUserIndex=ogHostUserIndex, ogUpsType=ogUpsType, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemNetwork=ogCellModemNetwork, ogCellModemRegistered=ogCellModemRegistered, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdName=ogEmdName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcDescription=ogRpcDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortDCD=ogSerialPortDCD, ogUpsEntry=ogUpsEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemModel=ogCellModemModel, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientEntry=ogWifiClientEntry, ogSystem=ogSystem, ogUpsNotification=ogUpsNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioState=ogEmdDioState, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortTable=ogSerialPortTable, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceCounter=ogHostServiceCounter, ogCellModemConnected=ogCellModemConnected, ogCellModemIndex=ogCellModemIndex, ogMibNotifications=ogMibNotifications, ogAlarmName=ogAlarmName, ogHostTable=ogHostTable, ogSerialPortDSR=ogSerialPortDSR, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsCounter=ogUpsCounter, ogHostUserEntry=ogHostUserEntry, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcCounter=ogRpcCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientTable=ogWifiClientTable, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsHumidity=ogUpsHumidity, ogStatus2Compliances=ogStatus2Compliances, ogAlarmCheck=ogAlarmCheck, ogRpcOutletFrequency=ogRpcOutletFrequency, PYSNMP_MODULE_ID=ogStatus2, ogAlarm=ogAlarm, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckName=ogCheckName, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckIndex=ogCheckIndex, ogUpsIndex=ogUpsIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsName=ogUpsName, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioType=ogEmdDioType, ogCurrentAlarmState=ogCurrentAlarmState)
