...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmEventId=ogAlarmEventId, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsDescription=ogUpsDescription, ogUpsState=ogUpsState, ogCellModemConnected=ogCellModemConnected, ogRpcTable=ogRpcTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserStartTime=ogWebUserStartTime, ogHostName=ogHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmState=ogCurrentAlarmState, ogCellApnNotification=ogCellApnNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsConnectType=ogUpsConnectType, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortFlowControl=ogSerialPortFlowControl, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApIndex=ogWifiApIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemTable=ogCellModemTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsCounter=ogUpsCounter, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdName=ogEmdName, ogCellModemNetwork=ogCellModemNetwork, ogStatus2=ogStatus2, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemIndex=ogCellModemIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioName=ogEmdDioName, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemRegistered=ogCellModemRegistered, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmCheck=ogAlarmCheck, ogCheckIndex=ogCheckIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemVendor=ogCellModemVendor, ogEmdDioState=ogEmdDioState, ogCheckType=ogCheckType, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserTable=ogWebUserTable, ogEmdEnabled=ogEmdEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmState=ogAlarmState, ogCellModemTower=ogCellModemTower, ogRpcOutletTable=ogRpcOutletTable, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityName=ogEmdHumidityName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserTable=ogSerialUserTable, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioNotification=ogEmdDioNotification, ogNetInterfaceName=ogNetInterfaceName, ogHostPingNotification=ogHostPingNotification, ogEmdDescription=ogEmdDescription, ogSerialUserPort=ogSerialUserPort, ogUpsIndex=ogUpsIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserLabel=ogSerialUserLabel, ogWifiApEntry=ogWifiApEntry, ogStatus2Compliance=ogStatus2Compliance, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserEntry=ogSerialUserEntry, ogCellSignalNotification=ogCellSignalNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogMibNotifications=ogMibNotifications, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioEmd=ogEmdDioEmd, ogHostTable=ogHostTable, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsEntry=ogUpsEntry, ogEmdConnectType=ogEmdConnectType, ogHostServiceHost=ogHostServiceHost, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcConnectType=ogRpcConnectType, ogCheckTable=ogCheckTable, ogSerialPortLabel=ogSerialPortLabel, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioCounter=ogEmdDioCounter, ogRpcIndex=ogRpcIndex, ogWifiClientEntry=ogWifiClientEntry, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsNotification=ogUpsNotification, ogRpcType=ogRpcType, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogFirmwareVersion=ogFirmwareVersion, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdIndex=ogEmdIndex, ogSerialUserNotification=ogSerialUserNotification, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServiceEntry=ogHostServiceEntry, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserName=ogSerialUserName, ogRpcInputNotification=ogRpcInputNotification, ogWebUserNotification=ogWebUserNotification, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyName=ogPowerSupplyName, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceType=ogHostServiceType, ogAlarmDevice=ogAlarmDevice, ogWifiApClientTable=ogWifiApClientTable, ogUpsType=ogUpsType, ogHostEntry=ogHostEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioDescription=ogEmdDioDescription, ogRpcEntry=ogRpcEntry, ogWebUserName=ogWebUserName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsInputCurrent=ogUpsInputCurrent, ogSystem=ogSystem, ogAlarmName=ogAlarmName, ogRpcOutletState=ogRpcOutletState, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceType=ogNetInterfaceType, ogWifiApEnabled=ogWifiApEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcName=ogRpcName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioType=ogEmdDioType, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserEntry=ogWebUserEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogNetInterfaceState=ogNetInterfaceState, ogCheckName=ogCheckName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserHostName=ogHostUserHostName, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortMode=ogSerialPortMode, ogWifiClientTable=ogWifiClientTable, ogWifiApSsid=ogWifiApSsid, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceName=ogCheckDeviceName, ogRpcDescription=ogRpcDescription, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsTable=ogUpsTable, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserIndex=ogWebUserIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcCounter=ogRpcCounter, ogHostServiceTable=ogHostServiceTable, ogHostUserAddress=ogHostUserAddress, ogEmdEntry=ogEmdEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsTemperature=ogUpsTemperature, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogStatus2Groups=ogStatus2Groups, ogRpcOutletName=ogRpcOutletName, ogEmdDioIndex=ogEmdDioIndex, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientMode=ogWifiClientMode, ogWifiApInterface=ogWifiApInterface, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostUserEntry=ogHostUserEntry, ogAlarm=ogAlarm, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCustomNotification=ogCustomNotification, ogCheckResetTimeout=ogCheckResetTimeout)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApTable=ogWifiApTable, ogHostServiceCounter=ogHostServiceCounter, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemEntry=ogCellModemEntry, ogHostUserNotification=ogHostUserNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserName=ogHostUserName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemModel=ogCellModemModel, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckEntry=ogCheckEntry, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsName=ogUpsName, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioDirection=ogEmdDioDirection, ogUpsBatteryState=ogUpsBatteryState, ogSerialNumber=ogSerialNumber, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostIndex=ogHostIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmInstance=ogAlarmInstance, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortTable=ogSerialPortTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemCounter=ogCellModemCounter, ogEmdTable=ogEmdTable, ogHostUserIndex=ogHostUserIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmType=ogAlarmType, ogAlarmUser=ogAlarmUser, ogSerialUserIndex=ogSerialUserIndex, ogCellModemApn=ogCellModemApn, ogRpcOutletFrequency=ogRpcOutletFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioEntry=ogEmdDioEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortDTR=ogSerialPortDTR, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostUserHost=ogHostUserHost, ogHostServicePort=ogHostServicePort, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmTime=ogAlarmTime, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserTable=ogHostUserTable, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityDescription=ogEmdHumidityDescription)
