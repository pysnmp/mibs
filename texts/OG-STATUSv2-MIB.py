...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserNotification=ogHostUserNotification, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckTriggerActions=ogCheckTriggerActions, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioCounter=ogEmdDioCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdIndex=ogEmdIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialUserTable=ogSerialUserTable, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioEntry=ogEmdDioEntry, ogHostIpV6Address=ogHostIpV6Address, ogEmdConnectType=ogEmdConnectType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmUser=ogAlarmUser, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcInputNotification=ogRpcInputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserName=ogWebUserName, ogRpcOutletName=ogRpcOutletName, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserNotification=ogWebUserNotification, ogUpsTable=ogUpsTable, ogRpcOutletState=ogRpcOutletState, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckTable=ogCheckTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogNetInterfaceName=ogNetInterfaceName, ogCellSignalNotification=ogCellSignalNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsState=ogUpsState, ogHostIndex=ogHostIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmLogTable=ogAlarmLogTable, ogWebUserTable=ogWebUserTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserHost=ogHostUserHost, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortDCD=ogSerialPortDCD, ogAlarmTime=ogAlarmTime, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientApMac=ogWifiClientApMac, ogWifiApFrequency=ogWifiApFrequency, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogStatus2=ogStatus2, ogCheckIndex=ogCheckIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServiceCounter=ogHostServiceCounter, ogCellModemTower=ogCellModemTower, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdLogEnabled=ogEmdLogEnabled, ogHostUserStartTime=ogHostUserStartTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputPower=ogUpsOutputPower, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioEmd=ogEmdDioEmd, ogCustomNotification=ogCustomNotification, ogRpcOutletTable=ogRpcOutletTable, ogCheckEntry=ogCheckEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceTable=ogHostServiceTable, ogSerialPortMode=ogSerialPortMode, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmCheck=ogAlarmCheck, ogAlarmType=ogAlarmType, ogHostServicePort=ogHostServicePort, ogUpsOutputCurrent=ogUpsOutputCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserName=ogHostUserName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsDescription=ogUpsDescription, ogHostServiceType=ogHostServiceType, ogRpcType=ogRpcType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemVendor=ogCellModemVendor, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityName=ogEmdHumidityName, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioDirection=ogEmdDioDirection, ogWifiApInterface=ogWifiApInterface, ogAlarmInstance=ogAlarmInstance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserPort=ogSerialUserPort, ogCheckDeviceName=ogCheckDeviceName, ogEmdTable=ogEmdTable, ogAlarmDevice=ogAlarmDevice, ogWebUserEntry=ogWebUserEntry, ogUpsCounter=ogUpsCounter, ogCellModemTable=ogCellModemTable, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserLabel=ogSerialUserLabel, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioName=ogEmdDioName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogStatus2Conformance=ogStatus2Conformance, ogUpsNotification=ogUpsNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogNetInterfaceType=ogNetInterfaceType, ogCellDataNotification=ogCellDataNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemRegistered=ogCellModemRegistered, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsTemperature=ogUpsTemperature, ogUpsIndex=ogUpsIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortCTS=ogSerialPortCTS, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioTable=ogEmdDioTable, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApCounter=ogWifiApCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcDescription=ogRpcDescription, ogWifiApSsid=ogWifiApSsid, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogStatus2Groups=ogStatus2Groups, ogSerialPortTable=ogSerialPortTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, PYSNMP_MODULE_ID=ogStatus2, ogWifiApIeeeMode=ogWifiApIeeeMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRssi=ogWifiClientRssi, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2Compliances=ogStatus2Compliances, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSystem=ogSystem, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogMibNotifications=ogMibNotifications, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckName=ogCheckName, ogAlarmName=ogAlarmName, ogHostIpV4Address=ogHostIpV4Address, ogAlarm=ogAlarm, ogCheckResolveActions=ogCheckResolveActions, ogRpcTable=ogRpcTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceIndex=ogHostServiceIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcEntry=ogRpcEntry, ogSerialPortParity=ogSerialPortParity, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialNumber=ogSerialNumber, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdName=ogEmdName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceEntry=ogHostServiceEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortDTR=ogSerialPortDTR, ogCellModemConnected=ogCellModemConnected, ogEmdEntry=ogEmdEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceStatus=ogHostServiceStatus, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientTable=ogWifiClientTable, ogHostName=ogHostName, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckType=ogCheckType, ogWifiApClientAp=ogWifiApClientAp, ogCellModemNetwork=ogCellModemNetwork, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemCounter=ogCellModemCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemModel=ogCellModemModel, ogUpsType=ogUpsType, ogWifiClientIndex=ogWifiClientIndex, ogCellModemApn=ogCellModemApn, ogRpcConnectType=ogRpcConnectType, ogHostPingNotification=ogHostPingNotification, ogWifiClientInterface=ogWifiClientInterface, ogEmdDescription=ogEmdDescription, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsEntry=ogUpsEntry, ogCellApnNotification=ogCellApnNotification, ogWifiApEntry=ogWifiApEntry, ogRpcName=ogRpcName, ogAlarmSummary=ogAlarmSummary, ogEmdEnabled=ogEmdEnabled, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostTable=ogHostTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientMode=ogWifiClientMode, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioType=ogEmdDioType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcIndex=ogRpcIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserName=ogSerialUserName, ogWifiApTable=ogWifiApTable, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcCounter=ogRpcCounter, ogAlarmState=ogAlarmState, ogWifiClientCounter=ogWifiClientCounter, ogHostUserEntry=ogHostUserEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioState=ogEmdDioState, ogRpcOutletTotal=ogRpcOutletTotal, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserNotification=ogSerialUserNotification, ogAlarmEventId=ogAlarmEventId, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsHumidity=ogUpsHumidity, ogHostUserTable=ogHostUserTable, ogCellModemIMSI=ogCellModemIMSI, ogUpsName=ogUpsName, ogHostEntry=ogHostEntry, ogUpsBatteryState=ogUpsBatteryState)
