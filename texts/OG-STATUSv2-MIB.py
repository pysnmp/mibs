...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsIndex=ogUpsIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcIndex=ogRpcIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioEmd=ogEmdDioEmd, ogCellModemIndex=ogCellModemIndex, ogWifiApClientAp=ogWifiApClientAp, ogRpcType=ogRpcType, ogFirmwareVersion=ogFirmwareVersion, ogUpsCounter=ogUpsCounter, ogWifiApInterface=ogWifiApInterface, ogEmdTable=ogEmdTable, ogAlarmState=ogAlarmState, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserEntry=ogWebUserEntry, ogCheckTable=ogCheckTable, ogCheckType=ogCheckType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcDescription=ogRpcDescription, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletName=ogRpcOutletName, ogCellModemConnected=ogCellModemConnected, ogAlarmUser=ogAlarmUser, ogHostUserName=ogHostUserName, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialNumber=ogSerialNumber, ogHostUserEntry=ogHostUserEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortIndex=ogSerialPortIndex, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostPingNotification=ogHostPingNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServiceHost=ogHostServiceHost, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserHostName=ogHostUserHostName, ogUpsOutputPower=ogUpsOutputPower, ogHostUserIndex=ogHostUserIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsNotification=ogUpsNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogHostName=ogHostName, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserPort=ogSerialUserPort, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyName=ogPowerSupplyName, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemCounter=ogCellModemCounter, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCustomNotification=ogCustomNotification, ogNetInterfaceName=ogNetInterfaceName, ogCellModemTable=ogCellModemTable, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmTime=ogAlarmTime, ogHostServiceStatus=ogHostServiceStatus, ogWebUserTable=ogWebUserTable, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApCounter=ogWifiApCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortParity=ogSerialPortParity, ogCellModemRegistered=ogCellModemRegistered, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletTable=ogRpcOutletTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserIndex=ogWebUserIndex, ogUpsType=ogUpsType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioEntry=ogEmdDioEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioIndex=ogEmdDioIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientTable=ogWifiClientTable, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcTable=ogRpcTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApEnabled=ogWifiApEnabled, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcName=ogRpcName, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsState=ogUpsState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioType=ogEmdDioType, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioTable=ogEmdDioTable, ogRpcEntry=ogRpcEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserNotification=ogWebUserNotification, ogSerialPortDCD=ogSerialPortDCD, ogAlarm=ogAlarm, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioNotification=ogEmdDioNotification, ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsTemperature=ogUpsTemperature, ogSerialUserLabel=ogSerialUserLabel, ogWifiApTable=ogWifiApTable, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialUserEntry=ogSerialUserEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmEventId=ogAlarmEventId, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsName=ogUpsName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogMibNotifications=ogMibNotifications, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortMode=ogSerialPortMode, ogAlarmSummary=ogAlarmSummary, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientApMac=ogWifiClientApMac, ogUpsDescription=ogUpsDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceTable=ogHostServiceTable, ogCellModemTower=ogCellModemTower, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSystem=ogSystem, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserAddress=ogHostUserAddress, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserName=ogWebUserName, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientIndex=ogWifiClientIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioDirection=ogEmdDioDirection, ogEmdIndex=ogEmdIndex, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogStatus2=ogStatus2, ogSerialPortSpeed=ogSerialPortSpeed, ogHostTable=ogHostTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioName=ogEmdDioName, ogSerialUserNotification=ogSerialUserNotification, ogAlarmCheck=ogAlarmCheck, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmName=ogAlarmName, ogHostServicePort=ogHostServicePort, ogHostIndex=ogHostIndex, ogUpsHumidity=ogUpsHumidity, ogCellModemModel=ogCellModemModel, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckEntry=ogCheckEntry, ogStatus2Groups=ogStatus2Groups, ogSerialPortTxBytes=ogSerialPortTxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellTowerNotification=ogCellTowerNotification, ogUpsInputNotification=ogUpsInputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsEntry=ogUpsEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdEnabled=ogEmdEnabled, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortCTS=ogSerialPortCTS, ogRpcCounter=ogRpcCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceType=ogHostServiceType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortLabel=ogSerialPortLabel, ogCellModemEntry=ogCellModemEntry, ogAlarmType=ogAlarmType, ogHostIpV4Address=ogHostIpV4Address, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortRTS=ogSerialPortRTS, ogCellModemApn=ogCellModemApn, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserStartTime=ogHostUserStartTime, ogAlarmInstance=ogAlarmInstance, ogWifiClientRssi=ogWifiClientRssi)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellApnNotification=ogCellApnNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserTable=ogHostUserTable, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckIndex=ogCheckIndex, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioState=ogEmdDioState, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApEntry=ogWifiApEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserNotification=ogHostUserNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserHost=ogHostUserHost, ogWifiClientInterface=ogWifiClientInterface, ogEmdEntry=ogEmdEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletState=ogRpcOutletState, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceCounter=ogHostServiceCounter, ogSerialUserName=ogSerialUserName, ogWifiApSsid=ogWifiApSsid, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortTable=ogSerialPortTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckResolveActions=ogCheckResolveActions, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsTable=ogUpsTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientMode=ogWifiClientMode, ogRpcConnectType=ogRpcConnectType, ogHostEntry=ogHostEntry, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckName=ogCheckName, ogCellDataNotification=ogCellDataNotification, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemVendor=ogCellModemVendor, ogCellSignalNotification=ogCellSignalNotification, ogEmdName=ogEmdName, ogUpsConnectType=ogUpsConnectType, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryVoltage=ogUpsBatteryVoltage)
