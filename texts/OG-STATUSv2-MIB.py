...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckType=ogCheckType, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemTemperature=ogCellModemTemperature, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserEntry=ogSerialUserEntry, ogCheckEntry=ogCheckEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemApn=ogCellModemApn, ogEmdDioNotification=ogEmdDioNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioEntry=ogEmdDioEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortEntry=ogSerialPortEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceType=ogNetInterfaceType, ogUpsDescription=ogUpsDescription, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioIndex=ogEmdDioIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogStatus2Compliances=ogStatus2Compliances, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApEnabled=ogWifiApEnabled, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryState=ogUpsBatteryState, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortLabel=ogSerialPortLabel, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserNotification=ogHostUserNotification, ogSerialUserName=ogSerialUserName, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientMac=ogWifiApClientMac, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcEntry=ogRpcEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputNotification=ogUpsOutputNotification, ogHostTable=ogHostTable, ogWifiClientMode=ogWifiClientMode, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdConnectType=ogEmdConnectType, ogUpsName=ogUpsName, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2=ogStatus2, ogSerialUserPort=ogSerialUserPort, ogUpsHumidity=ogUpsHumidity, ogHostServicePort=ogHostServicePort, ogEmdEnabled=ogEmdEnabled, ogHostIndex=ogHostIndex, ogSerialPortIndex=ogSerialPortIndex, ogCustomNotification=ogCustomNotification, ogHostServiceHost=ogHostServiceHost, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsConnectType=ogUpsConnectType, ogEmdDioType=ogEmdDioType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialUserTable=ogSerialUserTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceState=ogNetInterfaceState, ogHostUserName=ogHostUserName, ogHostUserTable=ogHostUserTable, ogAlarmInstance=ogAlarmInstance, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceNotification=ogHostServiceNotification, ogCellModemTower=ogCellModemTower, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmState=ogCurrentAlarmState, ogHostName=ogHostName, PYSNMP_MODULE_ID=ogStatus2, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityValue=ogEmdHumidityValue, ogHostEntry=ogHostEntry, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsTemperature=ogUpsTemperature, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientIndex=ogWifiClientIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApEntry=ogWifiApEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDescription=ogEmdDescription, ogHostUserHost=ogHostUserHost, ogWebUserIndex=ogWebUserIndex, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostPingNotification=ogHostPingNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortDTR=ogSerialPortDTR, ogCellModemNetwork=ogCellModemNetwork, ogWifiApInterface=ogWifiApInterface, ogEmdTable=ogEmdTable, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostIpV4Address=ogHostIpV4Address, ogAlarmSummary=ogAlarmSummary, ogHostUserIndex=ogHostUserIndex, ogAlarmEventId=ogAlarmEventId, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioEmd=ogEmdDioEmd, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckResetTimeout=ogCheckResetTimeout, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmName=ogAlarmName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmUser=ogAlarmUser, ogAlarmTime=ogAlarmTime, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserNotification=ogSerialUserNotification, ogHostUserStartTime=ogHostUserStartTime, ogWebUserStartTime=ogWebUserStartTime, ogCellModemModel=ogCellModemModel, ogCellApnNotification=ogCellApnNotification, ogWifiApCounter=ogWifiApCounter, ogEmdIndex=ogEmdIndex, ogCellMessageNotification=ogCellMessageNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApTxPower=ogWifiApTxPower, ogUpsIndex=ogUpsIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityCounter=ogEmdHumidityCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsTable=ogUpsTable, ogCheckTable=ogCheckTable, ogUpsEntry=ogUpsEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletState=ogRpcOutletState, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletName=ogRpcOutletName, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcInputNotification=ogRpcInputNotification, ogCellModemConnected=ogCellModemConnected, ogWifiClientTable=ogWifiClientTable, ogEmdName=ogEmdName, ogCellModemRegistered=ogCellModemRegistered, ogUpsType=ogUpsType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWebUserNotification=ogWebUserNotification, ogEmdDioState=ogEmdDioState, ogCheckResolveActions=ogCheckResolveActions, ogCheckIndex=ogCheckIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemCounter=ogCellModemCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcDescription=ogRpcDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialSignalNotification=ogSerialSignalNotification, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmDevice=ogAlarmDevice, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioName=ogEmdDioName, ogEmdHumidityTable=ogEmdHumidityTable, ogSystem=ogSystem, ogAlarmType=ogAlarmType, ogRpcIndex=ogRpcIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmLogTable=ogAlarmLogTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcTable=ogRpcTable, ogStatus2Conformance=ogStatus2Conformance, ogRpcConnectType=ogRpcConnectType, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserLabel=ogSerialUserLabel, ogStatus2Groups=ogStatus2Groups, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcType=ogRpcType, ogWifiApTable=ogWifiApTable, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApSsid=ogWifiApSsid, ogCellModemEntry=ogCellModemEntry, ogCellModemEnabled=ogCellModemEnabled, ogWebUserName=ogWebUserName, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemVendor=ogCellModemVendor, ogUpsNotification=ogUpsNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmState=ogAlarmState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserEntry=ogWebUserEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarm=ogAlarm, ogRpcCounter=ogRpcCounter, ogWifiClientCounter=ogWifiClientCounter, ogUpsState=ogUpsState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputNotification=ogUpsInputNotification, ogMibNotifications=ogMibNotifications, ogCheckName=ogCheckName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemTable=ogCellModemTable, ogWebUserTable=ogWebUserTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialNumber=ogSerialNumber, ogSerialPortDCD=ogSerialPortDCD, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsCounter=ogUpsCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortRTS=ogSerialPortRTS, ogRpcName=ogRpcName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostUserEntry=ogHostUserEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityName=ogEmdHumidityName, ogEmdDioTable=ogEmdDioTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostServiceType=ogHostServiceType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmName=ogCurrentAlarmName, ogCellDataNotification=ogCellDataNotification, ogSerialPortTable=ogSerialPortTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortParity=ogSerialPortParity, ogEmdEntry=ogEmdEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemIndex=ogCellModemIndex)
