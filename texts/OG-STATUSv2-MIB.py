...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogNetInterfaceNotification=ogNetInterfaceNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserIndex=ogWebUserIndex, ogRpcInputNotification=ogRpcInputNotification, ogWebUserEntry=ogWebUserEntry, ogUpsNotification=ogUpsNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDescription=ogEmdDescription, ogRpcEntry=ogRpcEntry, ogWifiClientApMac=ogWifiClientApMac, ogCellModemApn=ogCellModemApn, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2Compliances=ogStatus2Compliances, ogRpcName=ogRpcName, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServiceTable=ogHostServiceTable, ogWifiApClientTable=ogWifiApClientTable, ogCellModemTower=ogCellModemTower, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellApnNotification=ogCellApnNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmTime=ogAlarmTime, ogSerialUserPort=ogSerialUserPort, ogHostIndex=ogHostIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioIndex=ogEmdDioIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostServicePort=ogHostServicePort, ogSerialNumber=ogSerialNumber, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmDevice=ogAlarmDevice, ogCheckIndex=ogCheckIndex, ogHostPingNotification=ogHostPingNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmUser=ogAlarmUser, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserIndex=ogHostUserIndex, ogRpcType=ogRpcType, ogCellModemModel=ogCellModemModel, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientMode=ogWifiClientMode, ogEmdDioNotification=ogEmdDioNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureValue=ogEmdTemperatureValue, ogStatus2Compliance=ogStatus2Compliance, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDTR=ogSerialPortDTR, ogAlarm=ogAlarm, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckTable=ogCheckTable, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityName=ogEmdHumidityName, ogSystem=ogSystem, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsTemperature=ogUpsTemperature, ogWifiApTable=ogWifiApTable, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemEntry=ogCellModemEntry, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioState=ogEmdDioState, ogHostUserTable=ogHostUserTable, ogAlarmInstance=ogAlarmInstance, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialUserLabel=ogSerialUserLabel, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2=ogStatus2, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserHost=ogHostUserHost, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcConnectType=ogRpcConnectType, ogHostServiceIndex=ogHostServiceIndex, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServiceCounter=ogHostServiceCounter, ogWifiApInterface=ogWifiApInterface, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsDescription=ogUpsDescription, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostUserName=ogHostUserName, ogEmdDioTable=ogEmdDioTable, ogSerialUserIndex=ogSerialUserIndex, ogMibNotifications=ogMibNotifications, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserStartTime=ogWebUserStartTime, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserNotification=ogHostUserNotification, ogSerialPortLabel=ogSerialPortLabel, ogEmdConnectType=ogEmdConnectType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2Groups=ogStatus2Groups, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientCounter=ogWifiClientCounter, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletState=ogRpcOutletState, ogUpsCounter=ogUpsCounter, ogAlarmState=ogAlarmState, ogWebUserNotification=ogWebUserNotification, PYSNMP_MODULE_ID=ogStatus2, ogHostTable=ogHostTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserTable=ogWebUserTable, ogUpsInputNotification=ogUpsInputNotification, ogSerialUserTable=ogSerialUserTable, ogEmdEnabled=ogEmdEnabled, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostName=ogHostName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckEntry=ogCheckEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCustomNotification=ogCustomNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdIndex=ogEmdIndex, ogRpcOutletTable=ogRpcOutletTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcDescription=ogRpcDescription, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserName=ogWebUserName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsState=ogUpsState, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceHost=ogHostServiceHost, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApAuthNotification=ogWifiApAuthNotification, ogNetInterfaceType=ogNetInterfaceType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemCounter=ogCellModemCounter, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortCTS=ogSerialPortCTS, ogUpsTable=ogUpsTable, ogCheckResolveActions=ogCheckResolveActions, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioName=ogEmdDioName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortMode=ogSerialPortMode, ogHostUserStartTime=ogHostUserStartTime, ogEmdEntry=ogEmdEntry, ogCellMessageNotification=ogCellMessageNotification, ogAlarmCheck=ogAlarmCheck, ogFirmwareVersion=ogFirmwareVersion, ogHostServiceType=ogHostServiceType, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdName=ogEmdName, ogSerialPortDSR=ogSerialPortDSR, ogCellModemTable=ogCellModemTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTable=ogEmdTable, ogCellModemVendor=ogCellModemVendor, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckType=ogCheckType, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmType=ogAlarmType, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioDescription=ogEmdDioDescription)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcTable=ogRpcTable, ogEmdDioCounter=ogEmdDioCounter, ogHostEntry=ogHostEntry, ogCellDataNotification=ogCellDataNotification, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcIndex=ogRpcIndex, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceEntry=ogHostServiceEntry, ogHostUserEntry=ogHostUserEntry, ogRpcCounter=ogRpcCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckName=ogCheckName, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsHumidity=ogUpsHumidity, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmName=ogAlarmName, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserName=ogSerialUserName, ogSerialPortParity=ogSerialPortParity, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioType=ogEmdDioType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsIndex=ogUpsIndex, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortTable=ogSerialPortTable, ogUpsType=ogUpsType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemTemperature=ogCellModemTemperature, ogUpsEntry=ogUpsEntry, ogPowerSupplyName=ogPowerSupplyName, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRssi=ogWifiClientRssi, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApEntry=ogWifiApEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellSignalNotification=ogCellSignalNotification, ogHostUserHostName=ogHostUserHostName, ogWifiClientTable=ogWifiClientTable, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsName=ogUpsName, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletNotification=ogRpcOutletNotification)
