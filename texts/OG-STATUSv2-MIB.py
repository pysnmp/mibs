...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletTotal=ogRpcOutletTotal, ogCheckType=ogCheckType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDioCounter=ogEmdDioCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckIndex=ogCheckIndex, ogHostServiceHost=ogHostServiceHost, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserHostName=ogHostUserHostName, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApEntry=ogWifiApEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsInputVoltage=ogUpsInputVoltage, ogSystem=ogSystem, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceEntry=ogCheckDeviceEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApCounter=ogWifiApCounter, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioDirection=ogEmdDioDirection, ogUpsEntry=ogUpsEntry, ogCheckName=ogCheckName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceState=ogNetInterfaceState, ogEmdConnectType=ogEmdConnectType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApEnabled=ogWifiApEnabled, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientTable=ogWifiApClientTable, ogUpsDescription=ogUpsDescription, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmLogTable=ogAlarmLogTable, ogAlarmInstance=ogAlarmInstance, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsCounter=ogUpsCounter, ogWifiApInterface=ogWifiApInterface, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdHumidityEmd=ogEmdHumidityEmd, ogNetInterfaceTable=ogNetInterfaceTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogStatus2=ogStatus2, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostIndex=ogHostIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellApnNotification=ogCellApnNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletName=ogRpcOutletName, ogHostServiceEntry=ogHostServiceEntry, ogEmdName=ogEmdName, ogEmdEnabled=ogEmdEnabled, ogMibNotifications=ogMibNotifications, ogAlarmCheck=ogAlarmCheck, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemEntry=ogCellModemEntry, ogHostUserHost=ogHostUserHost, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserEntry=ogWebUserEntry, ogAlarmSummary=ogAlarmSummary, ogHostName=ogHostName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemApn=ogCellModemApn, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApTable=ogWifiApTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioIndex=ogEmdDioIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortRTS=ogSerialPortRTS, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogStatus2Compliances=ogStatus2Compliances, ogRpcType=ogRpcType, ogHostServiceTable=ogHostServiceTable, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsHumidity=ogUpsHumidity, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioName=ogEmdDioName, ogWebUserStartTime=ogWebUserStartTime, ogRpcTable=ogRpcTable, ogCellModemTower=ogCellModemTower, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialUserIndex=ogSerialUserIndex, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortMode=ogSerialPortMode, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarm=ogAlarm, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientMode=ogWifiClientMode, ogEmdEntry=ogEmdEntry, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsIndex=ogUpsIndex, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioEmd=ogEmdDioEmd, ogUpsName=ogUpsName, ogSerialPortTable=ogSerialPortTable, ogRpcConnectType=ogRpcConnectType, ogAlarmState=ogAlarmState, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsType=ogUpsType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioType=ogEmdDioType, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputPower=ogUpsOutputPower, ogCellModemVendor=ogCellModemVendor, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortDTR=ogSerialPortDTR, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogStatus2Compliance=ogStatus2Compliance, ogWifiApFrequency=ogWifiApFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserPort=ogSerialUserPort, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioNotification=ogEmdDioNotification, ogCellModemModel=ogCellModemModel, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModem3gRssi=ogCellModem3gRssi, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcName=ogRpcName, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserName=ogWebUserName, ogHostUserName=ogHostUserName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputLoad=ogUpsOutputLoad, ogCellTowerNotification=ogCellTowerNotification, ogCheckTable=ogCheckTable, ogHostUserAddress=ogHostUserAddress, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityName=ogEmdHumidityName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserIndex=ogHostUserIndex, ogSerialUserName=ogSerialUserName, ogWifiClientTable=ogWifiClientTable, ogCellSignalNotification=ogCellSignalNotification, ogEmdIndex=ogEmdIndex, ogWifiApIndex=ogWifiApIndex, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2Groups=ogStatus2Groups, ogWebUserTable=ogWebUserTable, ogUpsTemperature=ogUpsTemperature, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsState=ogUpsState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostServicePort=ogHostServicePort, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemTable=ogCellModemTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogFirmwareVersion=ogFirmwareVersion, ogRpcIndex=ogRpcIndex, ogCellModemCounter=ogCellModemCounter, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmEventId=ogAlarmEventId, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialNumber=ogSerialNumber, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsTable=ogUpsTable, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsNotification=ogUpsNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTable=ogEmdTable, ogStatus2Conformance=ogStatus2Conformance)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioEntry=ogEmdDioEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserTable=ogHostUserTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortDSR=ogSerialPortDSR, ogHostTable=ogHostTable, ogAlarmUser=ogAlarmUser, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputNotification=ogUpsInputNotification, ogHostEntry=ogHostEntry, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletState=ogRpcOutletState, ogHostIpV6Address=ogHostIpV6Address, ogCellModemConnected=ogCellModemConnected, ogHostPingNotification=ogHostPingNotification, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceType=ogHostServiceType, ogWebUserIndex=ogWebUserIndex, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcEntry=ogRpcEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortParity=ogSerialPortParity, ogCellModemIndex=ogCellModemIndex, ogRpcDescription=ogRpcDescription, ogHostServiceStatus=ogHostServiceStatus, ogHostUserEntry=ogHostUserEntry, ogNetInterfaceType=ogNetInterfaceType, ogAlarmType=ogAlarmType, ogWifiClientApMac=ogWifiClientApMac, ogAlarmName=ogAlarmName, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApTxPower=ogWifiApTxPower, ogWebUserNotification=ogWebUserNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioState=ogEmdDioState, ogRpcCounter=ogRpcCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApSsid=ogWifiApSsid, ogWifiClientRssi=ogWifiClientRssi, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogCustomNotification=ogCustomNotification, ogAlarmTime=ogAlarmTime, ogCheckEntry=ogCheckEntry, ogEmdDescription=ogEmdDescription, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialUserTable=ogSerialUserTable)
