...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutputNotification=ogRpcOutputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmUser=ogAlarmUser, ogSerialPortFlowControl=ogSerialPortFlowControl, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortDTR=ogSerialPortDTR, ogCellDataNotification=ogCellDataNotification, ogHostPingNotification=ogHostPingNotification, ogSystem=ogSystem, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioType=ogEmdDioType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmCheck=ogAlarmCheck, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCustomNotification=ogCustomNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortEntry=ogSerialPortEntry, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortParity=ogSerialPortParity, ogEmdDioName=ogEmdDioName, ogHostServiceNotification=ogHostServiceNotification, ogWifiApTxPower=ogWifiApTxPower, ogWifiApCounter=ogWifiApCounter, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcCounter=ogRpcCounter, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdEnabled=ogEmdEnabled, ogCellModemIndex=ogCellModemIndex, ogUpsName=ogUpsName, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientRssi=ogWifiClientRssi, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserTable=ogHostUserTable, ogHostEntry=ogHostEntry, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsState=ogUpsState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcIndex=ogRpcIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioCounter=ogEmdDioCounter, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostServiceCounter=ogHostServiceCounter, ogHostName=ogHostName, ogEmdHumidityTable=ogEmdHumidityTable, ogMibNotifications=ogMibNotifications, ogUpsOutputPower=ogUpsOutputPower, ogUpsTable=ogUpsTable, ogCellModemTable=ogCellModemTable, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApTable=ogWifiApTable, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmInstance=ogAlarmInstance, ogAlarmSummary=ogAlarmSummary, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserName=ogHostUserName, ogCheckName=ogCheckName, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdIndex=ogEmdIndex, ogSerialUserLabel=ogSerialUserLabel, ogUpsDescription=ogUpsDescription, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioDirection=ogEmdDioDirection, ogCheckType=ogCheckType, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserEntry=ogWebUserEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceStatus=ogHostServiceStatus, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientApMac=ogWifiClientApMac, ogUpsCounter=ogUpsCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckEntry=ogCheckEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsEntry=ogUpsEntry, ogUpsType=ogUpsType, ogHostUserAddress=ogHostUserAddress, ogAlarmLogIndex=ogAlarmLogIndex, ogFirmwareVersion=ogFirmwareVersion, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmState=ogAlarmState, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsHumidity=ogUpsHumidity, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarm=ogAlarm, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApSsid=ogWifiApSsid, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryState=ogUpsBatteryState, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletName=ogRpcOutletName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcName=ogRpcName, ogWebUserNotification=ogWebUserNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserTable=ogWebUserTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioState=ogEmdDioState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientInterface=ogWifiClientInterface, ogAlarmEventId=ogAlarmEventId, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmType=ogAlarmType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceTable=ogHostServiceTable, ogHostUserStartTime=ogHostUserStartTime, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsInputNotification=ogUpsInputNotification, ogWifiApFrequency=ogWifiApFrequency, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemTower=ogCellModemTower, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcOutletTable=ogRpcOutletTable, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDescription=ogEmdDescription, ogNetInterfaceName=ogNetInterfaceName, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckIndex=ogCheckIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdName=ogEmdName, ogHostIpV4Address=ogHostIpV4Address, ogHostIndex=ogHostIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcType=ogRpcType, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemEntry=ogCellModemEntry, ogEmdDioNotification=ogEmdDioNotification, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureValue=ogEmdTemperatureValue, ogStatus2=ogStatus2, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemApn=ogCellModemApn, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmName=ogAlarmName, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioEntry=ogEmdDioEntry, ogAlarmTime=ogAlarmTime, ogSerialPortIndex=ogSerialPortIndex, ogCheckDeviceName=ogCheckDeviceName, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserNotification=ogSerialUserNotification, ogCellApnNotification=ogCellApnNotification, ogSerialPortDCD=ogSerialPortDCD, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialUserName=ogSerialUserName, ogSerialPortCTS=ogSerialPortCTS, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientBitRate=ogWifiClientBitRate, ogWebUserName=ogWebUserName, ogCellModemModel=ogCellModemModel, ogHostTable=ogHostTable, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTable=ogEmdTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogStatus2Compliance=ogStatus2Compliance)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientIndex=ogWifiClientIndex, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsNotification=ogUpsNotification, ogEmdDioTable=ogEmdDioTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceHost=ogHostServiceHost, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsIndex=ogUpsIndex, ogRpcOutletState=ogRpcOutletState, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserIndex=ogWebUserIndex, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientEntry=ogWifiClientEntry, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemCounter=ogCellModemCounter, ogRpcDescription=ogRpcDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServicePort=ogHostServicePort, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortMode=ogSerialPortMode, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialNumber=ogSerialNumber, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemVendor=ogCellModemVendor, ogHostServiceType=ogHostServiceType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApIndex=ogWifiApIndex, ogWifiApEnabled=ogWifiApEnabled, ogHostUserHost=ogHostUserHost, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcTable=ogRpcTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioEmd=ogEmdDioEmd, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortStopBits=ogSerialPortStopBits, ogStatus2Conformance=ogStatus2Conformance, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcEntry=ogRpcEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserTable=ogSerialUserTable, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientTable=ogWifiClientTable, ogCheckTable=ogCheckTable, ogEmdEntry=ogEmdEntry, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcConnectType=ogRpcConnectType)
