...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, TimeTicks, Unsigned32, Integer32, IpAddress, Gauge32, iso, Bits, Counter64, MibIdentifier, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "TimeTicks", "Unsigned32", "Integer32", "IpAddress", "Gauge32", "iso", "Bits", "Counter64", "MibIdentifier", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcCounter=ogRpcCounter, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsCounter=ogUpsCounter, ogUpsOutputPower=ogUpsOutputPower, ogAlarmType=ogAlarmType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserName=ogHostUserName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApIndex=ogWifiApIndex, ogUpsDescription=ogUpsDescription, ogSystem=ogSystem, ogUpsOutputVoltage=ogUpsOutputVoltage, ogStatus2Groups=ogStatus2Groups, ogUpsName=ogUpsName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTable=ogEmdTable, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyTable=ogPowerSupplyTable, ogHostUserEntry=ogHostUserEntry, ogUpsTable=ogUpsTable, ogUpsInputNotification=ogUpsInputNotification, ogCheckName=ogCheckName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcInputNotification=ogRpcInputNotification, ogEmdName=ogEmdName, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceNotification=ogHostServiceNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortParity=ogSerialPortParity, ogWifiApTxPower=ogWifiApTxPower, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemCounter=ogCellModemCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialUserName=ogSerialUserName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryState=ogUpsBatteryState, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserHost=ogHostUserHost, ogStatus2Conformance=ogStatus2Conformance, ogRpcEntry=ogRpcEntry, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientMode=ogWifiClientMode, ogEmdDioTable=ogEmdDioTable, ogEmdDioEmd=ogEmdDioEmd, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialNumber=ogSerialNumber, ogEmdIndex=ogEmdIndex, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortEntry=ogSerialPortEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemTemperature=ogCellModemTemperature, ogHostIndex=ogHostIndex, ogEmdEnabled=ogEmdEnabled, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogHostName=ogHostName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialUserTable=ogSerialUserTable, ogHostUserIndex=ogHostUserIndex, ogAlarmDevice=ogAlarmDevice, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortTable=ogSerialPortTable, ogSerialPortIndex=ogSerialPortIndex, ogHostIpV6Address=ogHostIpV6Address, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdConnectType=ogEmdConnectType, ogRpcName=ogRpcName, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApInterface=ogWifiApInterface, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServicePort=ogHostServicePort, ogSerialUserNotification=ogSerialUserNotification, ogRpcType=ogRpcType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApTable=ogWifiApTable, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceType=ogHostServiceType, ogUpsEntry=ogUpsEntry, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortRxBytes=ogSerialPortRxBytes, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2Compliances=ogStatus2Compliances, ogHostUserNotification=ogHostUserNotification, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostUserAddress=ogHostUserAddress, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemModel=ogCellModemModel, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckIndex=ogCheckIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialUserIndex=ogSerialUserIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcTable=ogRpcTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWebUserEntry=ogWebUserEntry, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceName=ogCheckDeviceName, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserHostName=ogHostUserHostName, ogUpsHumidity=ogUpsHumidity, ogNetInterfaceName=ogNetInterfaceName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceType=ogNetInterfaceType, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmTime=ogAlarmTime, ogUpsIndex=ogUpsIndex, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmName=ogAlarmName, ogCellSignalNotification=ogCellSignalNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsType=ogUpsType, ogUpsNotification=ogUpsNotification, ogCellModemApn=ogCellModemApn, ogWifiClientEntry=ogWifiClientEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdEntry=ogEmdEntry, ogSerialUserLabel=ogSerialUserLabel, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellTowerNotification=ogCellTowerNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityIndex=ogEmdHumidityIndex, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsTemperature=ogUpsTemperature, ogWifiApEntry=ogWifiApEntry, ogWifiClientEssid=ogWifiClientEssid, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemTable=ogCellModemTable, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioName=ogEmdDioName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDescription=ogEmdDescription, ogWifiClientBitRate=ogWifiClientBitRate, ogStatus2=ogStatus2, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmUser=ogAlarmUser, ogCellModemEnabled=ogCellModemEnabled, ogCheckEntry=ogCheckEntry, ogEmdDioState=ogEmdDioState, ogAlarmInstance=ogAlarmInstance, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServiceCounter=ogHostServiceCounter, ogCellApnNotification=ogCellApnNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientTable=ogWifiApClientTable, ogHostTable=ogHostTable, ogHostServiceStatus=ogHostServiceStatus, ogMibNotifications=ogMibNotifications, ogWifiApClientAp=ogWifiApClientAp, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarm=ogAlarm, ogRpcConnectType=ogRpcConnectType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletName=ogRpcOutletName, ogCellModemConnected=ogCellModemConnected, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputNotification=ogUpsOutputNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCustomNotification=ogCustomNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogHostEntry=ogHostEntry, ogCellMessageNotification=ogCellMessageNotification, ogCheckType=ogCheckType, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientIndex=ogWifiApClientIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApCounter=ogWifiApCounter, ogEmdDioIndex=ogEmdDioIndex, ogNetInterfaceState=ogNetInterfaceState, ogWifiApSsid=ogWifiApSsid, ogSerialUserEntry=ogSerialUserEntry, ogWebUserTable=ogWebUserTable, ogEmdDioNotification=ogEmdDioNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostServiceTable=ogHostServiceTable, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioDirection=ogEmdDioDirection, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyName=ogPowerSupplyName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsState=ogUpsState, ogWifiClientIndex=ogWifiClientIndex, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletState=ogRpcOutletState, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserTable=ogHostUserTable, ogCellModemTower=ogCellModemTower, ogHostPingNotification=ogHostPingNotification, ogWifiClientApMac=ogWifiClientApMac, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioType=ogEmdDioType, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemEntry=ogCellModemEntry, ogCheckTable=ogCheckTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmEventId=ogAlarmEventId, ogWebUserNotification=ogWebUserNotification, ogRpcDescription=ogRpcDescription, ogAlarmSummary=ogAlarmSummary, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmState=ogAlarmState, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortMode=ogSerialPortMode, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcIndex=ogRpcIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogFirmwareVersion=ogFirmwareVersion, ogWebUserName=ogWebUserName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcMaxTemperature=ogRpcMaxTemperature)
