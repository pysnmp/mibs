...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTable=ogSerialPortTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWebUserIndex=ogWebUserIndex, ogUpsDescription=ogUpsDescription, ogWifiClientIndex=ogWifiClientIndex, ogUpsTemperature=ogUpsTemperature, ogCellModemConnected=ogCellModemConnected, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellTowerNotification=ogCellTowerNotification, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioType=ogEmdDioType, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserPort=ogSerialUserPort, ogUpsName=ogUpsName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostPingNotification=ogHostPingNotification, ogAlarmSummary=ogAlarmSummary, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserHostName=ogHostUserHostName, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioName=ogEmdDioName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcEntry=ogRpcEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserName=ogSerialUserName, ogSerialPortBreaks=ogSerialPortBreaks, ogHostTable=ogHostTable, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdEntry=ogEmdEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsState=ogUpsState, ogRpcIndex=ogRpcIndex, ogAlarmState=ogAlarmState, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserNotification=ogHostUserNotification, ogSerialUserEntry=ogSerialUserEntry, ogCellDataNotification=ogCellDataNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTable=ogEmdTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserIndex=ogHostUserIndex, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdIndex=ogEmdIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcDescription=ogRpcDescription, ogMibNotifications=ogMibNotifications, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientEntry=ogWifiClientEntry, ogCellMessageNotification=ogCellMessageNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApTable=ogWifiApTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostName=ogHostName, ogHostServiceCounter=ogHostServiceCounter, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogStatus2=ogStatus2, ogHostUserStartTime=ogHostUserStartTime, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioTable=ogEmdDioTable, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceName=ogNetInterfaceName, ogHostServicePort=ogHostServicePort, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApSsid=ogWifiApSsid, ogUpsEntry=ogUpsEntry, ogSystem=ogSystem, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserTable=ogWebUserTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientTable=ogWifiApClientTable, ogCheckName=ogCheckName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckEntry=ogCheckEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmDevice=ogAlarmDevice, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellSignalNotification=ogCellSignalNotification, ogRpcCounter=ogRpcCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsInputCurrent=ogUpsInputCurrent, ogHostUserTable=ogHostUserTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsCounter=ogUpsCounter, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServiceEntry=ogHostServiceEntry, ogCellModemModel=ogCellModemModel, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApCounter=ogWifiApCounter, ogRpcOutletState=ogRpcOutletState, ogHostIndex=ogHostIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmType=ogAlarmType, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostEntry=ogHostEntry, ogAlarmName=ogAlarmName, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortMode=ogSerialPortMode, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsIndex=ogUpsIndex, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemTable=ogCellModemTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientCounter=ogWifiClientCounter, ogUpsNotification=ogUpsNotification, ogHostServiceTable=ogHostServiceTable, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckIndex=ogCheckIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioEntry=ogEmdDioEntry, PYSNMP_MODULE_ID=ogStatus2, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemCounter=ogCellModemCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemApn=ogCellModemApn, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcTable=ogRpcTable, ogWifiApInterface=ogWifiApInterface, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsType=ogUpsType, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortLabel=ogSerialPortLabel, ogCheckType=ogCheckType, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckDeviceRef=ogCheckDeviceRef, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortRTS=ogSerialPortRTS, ogWebUserName=ogWebUserName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogStatus2Groups=ogStatus2Groups, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmInstance=ogAlarmInstance, ogCellModemTemperature=ogCellModemTemperature, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientInterface=ogWifiClientInterface, ogEmdDescription=ogEmdDescription, ogSerialUserIndex=ogSerialUserIndex, ogCellModemVendor=ogCellModemVendor, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsConnectType=ogUpsConnectType, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientApMac=ogWifiClientApMac, ogAlarmUser=ogAlarmUser, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserEntry=ogHostUserEntry, ogStatus2Conformance=ogStatus2Conformance, ogHostUserAddress=ogHostUserAddress, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcName=ogRpcName, ogHostServiceType=ogHostServiceType, ogCellModemTower=ogCellModemTower, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientRssi=ogWifiClientRssi, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientTable=ogWifiClientTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialUserTable=ogSerialUserTable, ogUpsOutputPower=ogUpsOutputPower, ogUpsTable=ogUpsTable, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApEnabled=ogWifiApEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostIpV6Address=ogHostIpV6Address)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogFirmwareVersion=ogFirmwareVersion, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortDCD=ogSerialPortDCD, ogRpcType=ogRpcType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdEnabled=ogEmdEnabled, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientAp=ogWifiApClientAp, ogWifiApEntry=ogWifiApEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserName=ogHostUserName, ogCheckTable=ogCheckTable, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientMode=ogWifiClientMode, ogRpcOutletTable=ogRpcOutletTable, ogWifiApIndex=ogWifiApIndex, ogEmdDioState=ogEmdDioState, ogUpsLogEnabled=ogUpsLogEnabled, ogWebUserStartTime=ogWebUserStartTime, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioDirection=ogEmdDioDirection, ogWifiApFrequency=ogWifiApFrequency, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarm=ogAlarm, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsHumidity=ogUpsHumidity, ogCellModemEnabled=ogCellModemEnabled, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialNumber=ogSerialNumber, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserNotification=ogWebUserNotification, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdName=ogEmdName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCustomNotification=ogCustomNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryState=ogUpsBatteryState, ogAlarmEventId=ogAlarmEventId, ogAlarmTime=ogAlarmTime, ogRpcOutletIndex=ogRpcOutletIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmCheck=ogAlarmCheck, ogHostUserHost=ogHostUserHost, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioDescription=ogEmdDioDescription)
