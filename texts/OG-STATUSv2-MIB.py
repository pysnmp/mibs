...
NotificationType, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Counter64, Unsigned32, Integer32, Gauge32, ModuleIdentity, IpAddress, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Counter64", "Unsigned32", "Integer32", "Gauge32", "ModuleIdentity", "IpAddress", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcType=ogRpcType, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientIndex=ogWifiApClientIndex, ogHostEntry=ogHostEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcName=ogRpcName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserHostName=ogHostUserHostName, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemTower=ogCellModemTower, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmSummary=ogAlarmSummary, ogHostUserTable=ogHostUserTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApFrequency=ogWifiApFrequency, ogCellModemApn=ogCellModemApn, ogAlarmState=ogAlarmState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogNetInterfaceName=ogNetInterfaceName, ogAlarmTime=ogAlarmTime, ogSerialPortDSR=ogSerialPortDSR, ogRpcConnectType=ogRpcConnectType, ogUpsNotification=ogUpsNotification, ogEmdTable=ogEmdTable, ogEmdDioCounter=ogEmdDioCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostPingNotification=ogHostPingNotification, ogHostUserNotification=ogHostUserNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcTable=ogRpcTable, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceType=ogHostServiceType, ogAlarmType=ogAlarmType, ogHostServiceTable=ogHostServiceTable, ogWifiApIndex=ogWifiApIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioName=ogEmdDioName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckTable=ogCheckTable, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientApMac=ogWifiClientApMac, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortDTR=ogSerialPortDTR, ogCheckType=ogCheckType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogStatus2Compliance=ogStatus2Compliance, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemVendor=ogCellModemVendor, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2=ogStatus2, ogUpsConnectType=ogUpsConnectType, ogWifiApClientTable=ogWifiApClientTable, ogWifiApInterface=ogWifiApInterface, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogHostServiceCounter=ogHostServiceCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdEntry=ogEmdEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemEntry=ogCellModemEntry, ogMibNotifications=ogMibNotifications, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServiceStatus=ogHostServiceStatus, ogEmdName=ogEmdName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckIndex=ogCheckIndex, ogUpsType=ogUpsType, ogNetInterfaceType=ogNetInterfaceType, ogUpsTemperature=ogUpsTemperature, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRssi=ogWifiClientRssi, ogRpcIndex=ogRpcIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserHost=ogHostUserHost, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmEventId=ogAlarmEventId, ogCustomNotification=ogCustomNotification, ogCellModemCounter=ogCellModemCounter, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWebUserName=ogWebUserName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSystem=ogSystem, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmName=ogAlarmName, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2Compliances=ogStatus2Compliances, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsTable=ogUpsTable, ogUpsOutputPower=ogUpsOutputPower, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApSsid=ogWifiApSsid, ogHostServiceHost=ogHostServiceHost, ogWifiClientTable=ogWifiClientTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmLogTable=ogAlarmLogTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientEntry=ogWifiClientEntry, ogUpsIndex=ogUpsIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsState=ogUpsState, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletName=ogRpcOutletName, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioEntry=ogEmdDioEntry, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortTable=ogSerialPortTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioIndex=ogEmdDioIndex, ogRpcCounter=ogRpcCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortLabel=ogSerialPortLabel, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcEntry=ogRpcEntry, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmName=ogCurrentAlarmName, ogHostUserEntry=ogHostUserEntry, ogHostServiceNotification=ogHostServiceNotification, ogHostTable=ogHostTable, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortParity=ogSerialPortParity, ogEmdDescription=ogEmdDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserTable=ogSerialUserTable, ogUpsDescription=ogUpsDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityName=ogEmdHumidityName, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientMac=ogWifiApClientMac, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarm=ogAlarm, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2Groups=ogStatus2Groups, ogHostUserName=ogHostUserName, ogRpcDescription=ogRpcDescription, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserEntry=ogWebUserEntry, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortMode=ogSerialPortMode, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioState=ogEmdDioState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemModel=ogCellModemModel, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsEntry=ogUpsEntry, ogSerialUserName=ogSerialUserName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserTable=ogWebUserTable, ogCheckName=ogCheckName, ogCellDataNotification=ogCellDataNotification, ogUpsCounter=ogUpsCounter, ogCellModemIndex=ogCellModemIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmCheck=ogAlarmCheck, ogRpcOutletState=ogRpcOutletState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsName=ogUpsName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletEntry=ogRpcOutletEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletLoad=ogRpcOutletLoad, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemIMSI=ogCellModemIMSI, ogSerialNumber=ogSerialNumber, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWebUserNotification=ogWebUserNotification, ogWifiApTable=ogWifiApTable, ogAlarmInstance=ogAlarmInstance, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmUser=ogAlarmUser, ogEmdIndex=ogEmdIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCheckEntry=ogCheckEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemRegistered=ogCellModemRegistered, ogWifiApCounter=ogWifiApCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPatternNotification=ogSerialPatternNotification, ogCellMessageNotification=ogCellMessageNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostIndex=ogHostIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcInputNotification=ogRpcInputNotification, ogCellTowerNotification=ogCellTowerNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogNetInterfaceState=ogNetInterfaceState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemTable=ogCellModemTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserEntry=ogSerialUserEntry, ogHostName=ogHostName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostServicePort=ogHostServicePort, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserLabel=ogSerialUserLabel, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientMode=ogWifiClientMode, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioDescription=ogEmdDioDescription, ogWifiApEntry=ogWifiApEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioType=ogEmdDioType, ogSerialUserPort=ogSerialUserPort, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout)
