...
ModuleIdentity, Counter64, Unsigned32, Counter32, Bits, IpAddress, Gauge32, MibIdentifier, ObjectIdentity, NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "Counter32", "Bits", "IpAddress", "Gauge32", "MibIdentifier", "ObjectIdentity", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserName=ogHostUserName, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialNumber=ogSerialNumber, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortEntry=ogSerialPortEntry, ogHostUserIndex=ogHostUserIndex, ogCellDataNotification=ogCellDataNotification, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellMessageNotification=ogCellMessageNotification, ogCellApnNotification=ogCellApnNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogWebUserTable=ogWebUserTable, ogRpcConnectType=ogRpcConnectType, ogHostIndex=ogHostIndex, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortDCD=ogSerialPortDCD, ogHostIpV6Address=ogHostIpV6Address, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityIndex=ogEmdHumidityIndex, ogMibNotifications=ogMibNotifications, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientInterface=ogWifiClientInterface, ogEmdConnectType=ogEmdConnectType, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDescription=ogEmdDescription, ogHostUserStartTime=ogHostUserStartTime, ogAlarmType=ogAlarmType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortTable=ogSerialPortTable, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserNotification=ogHostUserNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceCounter=ogHostServiceCounter, ogUpsTemperature=ogUpsTemperature, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletName=ogRpcOutletName, ogEmdTable=ogEmdTable, ogCellModemTemperature=ogCellModemTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellTowerNotification=ogCellTowerNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApCounter=ogWifiApCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientTable=ogWifiApClientTable, ogSystem=ogSystem, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsNotification=ogUpsNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsDescription=ogUpsDescription, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletState=ogRpcOutletState, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientFrequency=ogWifiClientFrequency, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioName=ogEmdDioName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceIndex=ogHostServiceIndex, ogUpsState=ogUpsState, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserHostName=ogHostUserHostName, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletTable=ogRpcOutletTable, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioType=ogEmdDioType, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostTable=ogHostTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceNotification=ogHostServiceNotification, ogWifiApIndex=ogWifiApIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientAp=ogWifiApClientAp, ogCheckName=ogCheckName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2Compliances=ogStatus2Compliances, ogUpsType=ogUpsType, ogHostServiceHost=ogHostServiceHost, ogWifiApEnabled=ogWifiApEnabled, ogUpsEntry=ogUpsEntry, ogEmdDioState=ogEmdDioState, ogAlarmUser=ogAlarmUser, ogSerialUserEntry=ogSerialUserEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortDTR=ogSerialPortDTR, ogAlarmState=ogAlarmState, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdHumidityName=ogEmdHumidityName, ogStatus2Groups=ogStatus2Groups, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcType=ogRpcType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostUserHost=ogHostUserHost, ogHostEntry=ogHostEntry, ogAlarmCheck=ogAlarmCheck, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApInterface=ogWifiApInterface, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserNotification=ogWebUserNotification, ogWifiApSsid=ogWifiApSsid, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialUserPort=ogSerialUserPort, ogRpcCounter=ogRpcCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApEntry=ogWifiApEntry, ogWebUserName=ogWebUserName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemApn=ogCellModemApn, ogWebUserSourcePort=ogWebUserSourcePort, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckTable=ogCheckTable, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmDevice=ogAlarmDevice, ogSerialUserName=ogSerialUserName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsTable=ogUpsTable, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmName=ogAlarmName, ogHostServicePort=ogHostServicePort, ogHostUserTable=ogHostUserTable, ogHostName=ogHostName, ogUpsHumidity=ogUpsHumidity, ogUpsName=ogUpsName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemTower=ogCellModemTower, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientMac=ogWifiApClientMac, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioNotification=ogEmdDioNotification, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApTxPower=ogWifiApTxPower, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdIndex=ogEmdIndex, ogCheckEntry=ogCheckEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcTable=ogRpcTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdEntry=ogEmdEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioTable=ogEmdDioTable, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckResolveActions=ogCheckResolveActions, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientMode=ogWifiClientMode, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcEntry=ogRpcEntry, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialUserNotification=ogSerialUserNotification, ogEmdEnabled=ogEmdEnabled, ogCellModemEnabled=ogCellModemEnabled, ogWifiApTable=ogWifiApTable, ogCellModemTable=ogCellModemTable, ogHostServiceStatus=ogHostServiceStatus, ogUpsInputVoltage=ogUpsInputVoltage, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserStartTime=ogWebUserStartTime, ogUpsInputNotification=ogUpsInputNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcIndex=ogRpcIndex, ogCellModemSessionTime=ogCellModemSessionTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceType=ogNetInterfaceType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcName=ogRpcName, ogAlarmSummary=ogAlarmSummary, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckType=ogCheckType, ogHostServiceType=ogHostServiceType, ogWifiClientApMac=ogWifiClientApMac, ogAlarm=ogAlarm, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserTable=ogSerialUserTable, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceName=ogCheckDeviceName, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientTable=ogWifiClientTable, ogHostUserEntry=ogHostUserEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogPowerSupplyName=ogPowerSupplyName, ogAlarmTime=ogAlarmTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsCounter=ogUpsCounter, ogCustomNotification=ogCustomNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckIndex=ogCheckIndex, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemCounter=ogCellModemCounter, ogStatus2Conformance=ogStatus2Conformance, ogAlarmEventId=ogAlarmEventId, ogCellModemEntry=ogCellModemEntry, ogCellSignalNotification=ogCellSignalNotification, ogRpcDescription=ogRpcDescription, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceTable=ogHostServiceTable, ogHostPingNotification=ogHostPingNotification, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdName=ogEmdName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioDescription=ogEmdDioDescription, ogCellModemConnected=ogCellModemConnected, ogStatus2=ogStatus2, ogCellModemModel=ogCellModemModel, ogUpsIndex=ogUpsIndex)
