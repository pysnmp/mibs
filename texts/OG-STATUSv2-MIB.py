...
MibIdentifier, ModuleIdentity, iso, Bits, IpAddress, Counter32, TimeTicks, NotificationType, Unsigned32, Counter64, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "iso", "Bits", "IpAddress", "Counter32", "TimeTicks", "NotificationType", "Unsigned32", "Counter64", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceTable=ogHostServiceTable, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmName=ogAlarmName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmLogTable=ogAlarmLogTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortFlowControl=ogSerialPortFlowControl, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWebUserStartTime=ogWebUserStartTime, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmEventId=ogAlarmEventId, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsDescription=ogUpsDescription, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServicePort=ogHostServicePort, ogWebUserNotification=ogWebUserNotification, ogHostServiceStatus=ogHostServiceStatus, ogSerialUserNotification=ogSerialUserNotification, ogCheckName=ogCheckName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioDescription=ogEmdDioDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmUser=ogCurrentAlarmUser, ogNetInterfaceType=ogNetInterfaceType, ogCellModemModel=ogCellModemModel, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckEntry=ogCheckEntry, ogEmdDioType=ogEmdDioType, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmType=ogAlarmType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApCounter=ogWifiApCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserLabel=ogSerialUserLabel, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemCounter=ogCellModemCounter, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientInterface=ogWifiClientInterface, ogAlarmUser=ogAlarmUser, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioState=ogEmdDioState, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioDirection=ogEmdDioDirection, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApInterface=ogWifiApInterface, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioIndex=ogEmdDioIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmInstance=ogAlarmInstance, ogEmdEnabled=ogEmdEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceType=ogHostServiceType, ogHostUserAddress=ogHostUserAddress, ogRpcDescription=ogRpcDescription, ogUpsNotification=ogUpsNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityName=ogEmdHumidityName, ogWebUserTable=ogWebUserTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientIndex=ogWifiClientIndex, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortLabel=ogSerialPortLabel, ogHostTable=ogHostTable, ogSerialPortSpeed=ogSerialPortSpeed, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemTable=ogCellModemTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsIndex=ogUpsIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCheckTable=ogCheckTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdEntry=ogEmdEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2=ogStatus2, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioName=ogEmdDioName, ogWifiApEntry=ogWifiApEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcType=ogRpcType, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsTable=ogUpsTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmDevice=ogAlarmDevice, ogRpcOutletState=ogRpcOutletState, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletCurrent=ogRpcOutletCurrent, ogMibNotifications=ogMibNotifications, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserName=ogSerialUserName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsName=ogUpsName, ogHostUserName=ogHostUserName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostServiceNotification=ogHostServiceNotification, ogEmdConnectType=ogEmdConnectType, ogHostUserTable=ogHostUserTable, ogCurrentAlarmTime=ogCurrentAlarmTime, PYSNMP_MODULE_ID=ogStatus2, ogPowerSupplyName=ogPowerSupplyName, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioCounter=ogEmdDioCounter, ogRpcEntry=ogRpcEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSystem=ogSystem, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcCounter=ogRpcCounter, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostEntry=ogHostEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApTxPower=ogWifiApTxPower, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcConnectType=ogRpcConnectType, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWebUserIndex=ogWebUserIndex, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserIndex=ogSerialUserIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserIndex=ogHostUserIndex, ogHostIndex=ogHostIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserTable=ogSerialUserTable, ogWifiApClientMac=ogWifiApClientMac, ogAlarm=ogAlarm, ogHostPingNotification=ogHostPingNotification, ogCellModemVendor=ogCellModemVendor, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientTxPower=ogWifiClientTxPower, ogStatus2Groups=ogStatus2Groups, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemIndex=ogCellModemIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioNotification=ogEmdDioNotification, ogWebUserName=ogWebUserName, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortMode=ogSerialPortMode, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckIndex=ogCheckIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApEnabled=ogWifiApEnabled, ogCellModemApn=ogCellModemApn, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcTable=ogRpcTable, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientTable=ogWifiApClientTable, ogHostUserHostName=ogHostUserHostName, ogSerialPortIndex=ogSerialPortIndex, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioEntry=ogEmdDioEntry, ogUpsType=ogUpsType, ogSerialPortTable=ogSerialPortTable, ogEmdIndex=ogEmdIndex, ogHostUserHost=ogHostUserHost, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmTime=ogAlarmTime, ogWifiClientApMac=ogWifiClientApMac, ogCustomNotification=ogCustomNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogStatus2Compliance=ogStatus2Compliance, ogCellModemEntry=ogCellModemEntry, ogRpcName=ogRpcName, ogBasicAlarmGroup=ogBasicAlarmGroup)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletTable=ogRpcOutletTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletLoad=ogRpcOutletLoad, ogHostName=ogHostName, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceCounter=ogHostServiceCounter, ogAlarmSummary=ogAlarmSummary, ogEmdDescription=ogEmdDescription, ogEmdDioTable=ogEmdDioTable, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortParity=ogSerialPortParity, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsState=ogUpsState, ogEmdTable=ogEmdTable, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApIndex=ogWifiApIndex, ogEmdName=ogEmdName, ogCheckResolveActions=ogCheckResolveActions, ogStatus2Conformance=ogStatus2Conformance, ogHostUserEntry=ogHostUserEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemTemperature=ogCellModemTemperature, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsHumidity=ogUpsHumidity, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletName=ogRpcOutletName, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckType=ogCheckType, ogUpsInputNotification=ogUpsInputNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApTable=ogWifiApTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsConnectType=ogUpsConnectType, ogSerialPortCTS=ogSerialPortCTS, ogRpcIndex=ogRpcIndex, ogUpsCounter=ogUpsCounter, ogWifiApSsid=ogWifiApSsid, ogUpsEntry=ogUpsEntry, ogSerialNumber=ogSerialNumber, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmState=ogAlarmState, ogCellModemConnected=ogCellModemConnected, ogCellModemTower=ogCellModemTower, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientRxBytes=ogWifiApClientRxBytes)
