...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceName=ogNetInterfaceName, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioEntry=ogEmdDioEntry, ogEmdConnectType=ogEmdConnectType, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemConnected=ogCellModemConnected, ogAlarmLogTable=ogAlarmLogTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemApn=ogCellModemApn, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserEntry=ogWebUserEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioState=ogEmdDioState, ogCellModemModel=ogCellModemModel, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostIpV6Address=ogHostIpV6Address, ogHostEntry=ogHostEntry, ogEmdEnabled=ogEmdEnabled, ogSerialUserIndex=ogSerialUserIndex, ogCheckEntry=ogCheckEntry, ogHostServiceIndex=ogHostServiceIndex, ogRpcTable=ogRpcTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostUserNotification=ogHostUserNotification, ogAlarm=ogAlarm, ogAlarmUser=ogAlarmUser, ogWifiApClientTable=ogWifiApClientTable, ogWifiApSsid=ogWifiApSsid, ogSerialUserLabel=ogSerialUserLabel, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemIMSI=ogCellModemIMSI, ogAlarmInstance=ogAlarmInstance, ogWebUserTable=ogWebUserTable, ogWifiApTable=ogWifiApTable, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcInputCurrent=ogRpcInputCurrent, ogWebUserNotification=ogWebUserNotification, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortDSR=ogSerialPortDSR, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdName=ogEmdName, ogWifiApClientAp=ogWifiApClientAp, ogAlarmEventId=ogAlarmEventId, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemRegistered=ogCellModemRegistered, ogAlarmDevice=ogAlarmDevice, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostIpV4Address=ogHostIpV4Address, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortMode=ogSerialPortMode, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioTable=ogEmdDioTable, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortIndex=ogSerialPortIndex, ogCellTowerNotification=ogCellTowerNotification, ogCustomNotification=ogCustomNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogFirmwareVersion=ogFirmwareVersion, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckType=ogCheckType, ogRpcOutletTotal=ogRpcOutletTotal, ogHostServiceHost=ogHostServiceHost, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcEntry=ogRpcEntry, ogRpcType=ogRpcType, ogRpcCounter=ogRpcCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsConnectType=ogUpsConnectType, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsDescription=ogUpsDescription, ogWifiApClientMac=ogWifiApClientMac, ogCellModemTower=ogCellModemTower, ogEmdTable=ogEmdTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmState=ogAlarmState, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialNumber=ogSerialNumber, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientTable=ogWifiClientTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogStatus2=ogStatus2, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortCTS=ogSerialPortCTS, ogUpsType=ogUpsType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceTable=ogHostServiceTable, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Groups=ogStatus2Groups, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioName=ogEmdDioName, ogRpcName=ogRpcName, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcDescription=ogRpcDescription, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsName=ogUpsName, ogUpsHumidity=ogUpsHumidity, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioDescription=ogEmdDioDescription, ogCheckTable=ogCheckTable, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckName=ogCheckName, ogSystem=ogSystem, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioDirection=ogEmdDioDirection, ogUpsEntry=ogUpsEntry, ogStatus2Compliances=ogStatus2Compliances, ogWifiApIndex=ogWifiApIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceCounter=ogHostServiceCounter, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserAddress=ogHostUserAddress, PYSNMP_MODULE_ID=ogStatus2, ogMibNotifications=ogMibNotifications, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientBitRate=ogWifiClientBitRate, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserHostName=ogHostUserHostName, ogAlarmTime=ogAlarmTime, ogPowerSupplyName=ogPowerSupplyName, ogAlarmCheck=ogAlarmCheck, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientMode=ogWifiClientMode, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserIndex=ogHostUserIndex, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsIndex=ogUpsIndex, ogWebUserName=ogWebUserName, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsState=ogUpsState, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortTable=ogSerialPortTable, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortDTR=ogSerialPortDTR, ogHostName=ogHostName, ogStatus2Conformance=ogStatus2Conformance, ogUpsNotification=ogUpsNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellApnNotification=ogCellApnNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemVendor=ogCellModemVendor, ogHostServiceEntry=ogHostServiceEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortDCD=ogSerialPortDCD, ogUpsTemperature=ogUpsTemperature, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialUserPort=ogSerialUserPort, ogEmdDioNotification=ogEmdDioNotification, ogEmdDescription=ogEmdDescription, ogRpcOutletName=ogRpcOutletName, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmType=ogAlarmType, ogHostPingNotification=ogHostPingNotification, ogHostUserTable=ogHostUserTable, ogAlarmName=ogAlarmName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApEntry=ogWifiApEntry, ogHostUserHost=ogHostUserHost, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletTable=ogRpcOutletTable, ogRpcInputNotification=ogRpcInputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogHostIndex=ogHostIndex, ogSerialUserName=ogSerialUserName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServicePort=ogHostServicePort, ogNetInterfaceType=ogNetInterfaceType, ogRpcIndex=ogRpcIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdIndex=ogEmdIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortLabel=ogSerialPortLabel, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemTable=ogCellModemTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserEntry=ogSerialUserEntry, ogRpcConnectType=ogRpcConnectType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWebUserIndex=ogWebUserIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemNetwork=ogCellModemNetwork, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellDataNotification=ogCellDataNotification, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModem4gRssi=ogCellModem4gRssi, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientRssi=ogWifiClientRssi, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogHostTable=ogHostTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemEntry=ogCellModemEntry, ogCellMessageNotification=ogCellMessageNotification, ogUpsTable=ogUpsTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckIndex=ogCheckIndex, ogHostUserName=ogHostUserName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsCounter=ogUpsCounter, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityName=ogEmdHumidityName, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioType=ogEmdDioType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceNotification=ogHostServiceNotification, ogWifiApTxPower=ogWifiApTxPower, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioCounter=ogEmdDioCounter)
