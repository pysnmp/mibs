...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsIndex=ogUpsIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcConnectType=ogRpcConnectType, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcInputNotification=ogRpcInputNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletTable=ogRpcOutletTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemEntry=ogCellModemEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortIndex=ogSerialPortIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcEntry=ogRpcEntry, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWebUserEntry=ogWebUserEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcType=ogRpcType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckIndex=ogCheckIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortBreaks=ogSerialPortBreaks, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostIpV6Address=ogHostIpV6Address, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarm=ogAlarm, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortRTS=ogSerialPortRTS, ogSystem=ogSystem, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemIndex=ogCellModemIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemVendor=ogCellModemVendor, ogWebUserIndex=ogWebUserIndex, ogHostServiceTable=ogHostServiceTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputPower=ogUpsOutputPower, ogRpcName=ogRpcName, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcDescription=ogRpcDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApIndex=ogWifiApIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioCounter=ogEmdDioCounter, ogCheckName=ogCheckName, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserLabel=ogSerialUserLabel, ogSerialUserEntry=ogSerialUserEntry, ogEmdEntry=ogEmdEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmSummary=ogAlarmSummary, ogWifiClientTxPower=ogWifiClientTxPower, ogFirmwareVersion=ogFirmwareVersion, ogAlarmState=ogAlarmState, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellDataNotification=ogCellDataNotification, ogUpsConnectType=ogUpsConnectType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckDeviceName=ogCheckDeviceName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApEntry=ogWifiApEntry, ogMibNotifications=ogMibNotifications, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsTable=ogUpsTable, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostName=ogHostName, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputVoltage=ogRpcInputVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostTable=ogHostTable, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletState=ogRpcOutletState, ogRpcIndex=ogRpcIndex, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientRssi=ogWifiClientRssi, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostUserIndex=ogHostUserIndex, ogEmdEnabled=ogEmdEnabled, ogCheckEntry=ogCheckEntry, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialUserName=ogSerialUserName, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientIndex=ogWifiClientIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemRegistered=ogCellModemRegistered, ogUpsName=ogUpsName, ogCustomNotification=ogCustomNotification, ogAlarmName=ogAlarmName, ogEmdDioState=ogEmdDioState, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientEssid=ogWifiClientEssid, ogCellModemTable=ogCellModemTable, ogHostUserAddress=ogHostUserAddress, ogCheckType=ogCheckType, ogUpsDescription=ogUpsDescription, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmUser=ogAlarmUser, ogSerialPortTable=ogSerialPortTable, ogEmdTable=ogEmdTable, ogHostServiceHost=ogHostServiceHost, ogEmdDioName=ogEmdDioName, ogSerialUserIndex=ogSerialUserIndex, ogHostIndex=ogHostIndex, ogUpsType=ogUpsType, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDescription=ogEmdDescription, ogWifiApClientTable=ogWifiApClientTable, ogCellModemTower=ogCellModemTower, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioType=ogEmdDioType, ogCheckTable=ogCheckTable, ogWifiApFrequency=ogWifiApFrequency, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemApn=ogCellModemApn, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceNotification=ogHostServiceNotification, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdIndex=ogEmdIndex, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcCounter=ogRpcCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApCounter=ogWifiApCounter, ogWebUserTable=ogWebUserTable, ogSerialPortParity=ogSerialPortParity, ogStatus2=ogStatus2, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogNetInterfaceType=ogNetInterfaceType, ogWifiApEnabled=ogWifiApEnabled, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioNotification=ogEmdDioNotification, ogHostUserEntry=ogHostUserEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceStatus=ogHostServiceStatus, ogStatus2Conformance=ogStatus2Conformance, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmTime=ogAlarmTime, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApInterface=ogWifiApInterface, ogAlarmCheck=ogAlarmCheck, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserNotification=ogSerialUserNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureName=ogEmdTemperatureName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientTable=ogWifiClientTable, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogStatus2Groups=ogStatus2Groups, ogSerialPortMode=ogSerialPortMode, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientMac=ogWifiApClientMac, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserName=ogWebUserName, ogWifiClientMode=ogWifiClientMode, ogHostUserStartTime=ogHostUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletName=ogRpcOutletName, ogCellModemModel=ogCellModemModel)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientEntry=ogWifiClientEntry, ogCellModemCounter=ogCellModemCounter, ogCellModemIMSI=ogCellModemIMSI, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellTowerNotification=ogCellTowerNotification, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellMessageNotification=ogCellMessageNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogHostServiceType=ogHostServiceType, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmInstance=ogAlarmInstance, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsInputNotification=ogUpsInputNotification, ogCellModemConnected=ogCellModemConnected, ogHostUserName=ogHostUserName, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioTable=ogEmdDioTable, ogAlarmEventId=ogAlarmEventId, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsNotification=ogUpsNotification, ogHostIpV4Address=ogHostIpV4Address, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdName=ogEmdName, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemEnabled=ogCellModemEnabled, ogAlarmType=ogAlarmType, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsCounter=ogUpsCounter, ogRpcTable=ogRpcTable, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialNumber=ogSerialNumber, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserTable=ogHostUserTable, ogSerialUserPort=ogSerialUserPort, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsHumidity=ogUpsHumidity, ogCellSignalNotification=ogCellSignalNotification, ogUpsState=ogUpsState, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioDescription=ogEmdDioDescription, ogWifiApTable=ogWifiApTable, ogUpsEntry=ogUpsEntry, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioEntry=ogEmdDioEntry, ogHostUserHost=ogHostUserHost, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServicePort=ogHostServicePort, ogHostEntry=ogHostEntry, ogEmdTemperatureTable=ogEmdTemperatureTable)
