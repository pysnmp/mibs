...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2Compliance=ogStatus2Compliance, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserIndex=ogHostUserIndex, ogUpsDescription=ogUpsDescription, ogHostUserName=ogHostUserName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemTemperature=ogCellModemTemperature, ogHostName=ogHostName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellTowerNotification=ogCellTowerNotification, ogRpcConnectType=ogRpcConnectType, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientApMac=ogWifiClientApMac, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckIndex=ogCheckIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostIpV6Address=ogHostIpV6Address, ogUpsType=ogUpsType, ogWebUserIndex=ogWebUserIndex, ogUpsIndex=ogUpsIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientAp=ogWifiApClientAp, ogAlarmSummary=ogAlarmSummary, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmTime=ogAlarmTime, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsEntry=ogUpsEntry, ogUpsName=ogUpsName, ogEmdDescription=ogEmdDescription, ogEmdEnabled=ogEmdEnabled, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsTable=ogUpsTable, ogUpsBatteryState=ogUpsBatteryState, ogAlarm=ogAlarm, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortLabel=ogSerialPortLabel, ogHostUserNotification=ogHostUserNotification, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApSsid=ogWifiApSsid, ogEmdDioEmd=ogEmdDioEmd, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdEntry=ogEmdEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserHost=ogHostUserHost, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcDescription=ogRpcDescription, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialNumber=ogSerialNumber, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientEssid=ogWifiClientEssid, ogCheckTable=ogCheckTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserTable=ogSerialUserTable, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmUser=ogAlarmUser, ogCustomNotification=ogCustomNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletName=ogRpcOutletName, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemModel=ogCellModemModel, ogCellModemIndex=ogCellModemIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogMibNotifications=ogMibNotifications, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsInputVoltage=ogUpsInputVoltage, ogWebUserStartTime=ogWebUserStartTime, ogWifiApEntry=ogWifiApEntry, ogHostPingNotification=ogHostPingNotification, ogSerialUserName=ogSerialUserName, ogEmdDioIndex=ogEmdDioIndex, ogCellModemTable=ogCellModemTable, ogWifiApCounter=ogWifiApCounter, ogRpcName=ogRpcName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortRTS=ogSerialPortRTS, ogUpsNotification=ogUpsNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogFirmwareVersion=ogFirmwareVersion, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPatternNotification=ogSerialPatternNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceCounter=ogHostServiceCounter, ogHostEntry=ogHostEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckEntry=ogCheckEntry, ogEmdIndex=ogEmdIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmType=ogAlarmType, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServicePort=ogHostServicePort, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceNotification=ogHostServiceNotification, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientTable=ogWifiClientTable, ogCellDataNotification=ogCellDataNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioState=ogEmdDioState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioName=ogEmdDioName, ogAlarmCheck=ogAlarmCheck, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemTower=ogCellModemTower, ogEmdDioType=ogEmdDioType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceState=ogNetInterfaceState, ogRpcCounter=ogRpcCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortDTR=ogSerialPortDTR, ogEmdTable=ogEmdTable, ogAlarmState=ogAlarmState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcTable=ogRpcTable, ogCellModemApn=ogCellModemApn, ogCellApnNotification=ogCellApnNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortDCD=ogSerialPortDCD, ogCellModemEntry=ogCellModemEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortParity=ogSerialPortParity, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApIndex=ogWifiApIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmDevice=ogAlarmDevice, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSystem=ogSystem, ogHostServiceTable=ogHostServiceTable, ogCellModemIMSI=ogCellModemIMSI, ogCellModemConnected=ogCellModemConnected, ogRpcEntry=ogRpcEntry, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletState=ogRpcOutletState, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyName=ogPowerSupplyName, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckType=ogCheckType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmName=ogAlarmName, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserPort=ogSerialUserPort, ogHostServiceHost=ogHostServiceHost, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceType=ogHostServiceType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostIndex=ogHostIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsConnectType=ogUpsConnectType, ogWifiApTable=ogWifiApTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserLabel=ogSerialUserLabel)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioDirection=ogEmdDioDirection, ogUpsState=ogUpsState, ogCheckName=ogCheckName, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortEntry=ogSerialPortEntry, ogWifiApTxPower=ogWifiApTxPower, ogUpsHumidity=ogUpsHumidity, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserName=ogWebUserName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostTable=ogHostTable, ogCheckDeviceName=ogCheckDeviceName, PYSNMP_MODULE_ID=ogStatus2, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsTemperature=ogUpsTemperature, ogHostServiceIndex=ogHostServiceIndex, ogWebUserTable=ogWebUserTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserTable=ogHostUserTable, ogEmdDioTable=ogEmdDioTable, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputNotification=ogUpsInputNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientMac=ogWifiApClientMac, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2Groups=ogStatus2Groups, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsCounter=ogUpsCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcIndex=ogRpcIndex, ogSerialPortTable=ogSerialPortTable, ogHostUserEntry=ogHostUserEntry, ogCellModemCounter=ogCellModemCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmLogTable=ogAlarmLogTable, ogRpcInputNotification=ogRpcInputNotification, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogStatus2=ogStatus2, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcType=ogRpcType, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemRegistered=ogCellModemRegistered, ogAlarmEventId=ogAlarmEventId, ogCellMessageNotification=ogCellMessageNotification, ogEmdName=ogEmdName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletTable=ogRpcOutletTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance)
