...
Bits, MibIdentifier, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Counter32, IpAddress, TimeTicks, Integer32, Counter64, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Counter32", "IpAddress", "TimeTicks", "Integer32", "Counter64", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceType=ogHostServiceType, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientInterface=ogWifiClientInterface, ogAlarmUser=ogAlarmUser, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioDescription=ogEmdDioDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientIndex=ogWifiClientIndex, ogWifiApIndex=ogWifiApIndex, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortTable=ogSerialPortTable, ogRpcInputNotification=ogRpcInputNotification, ogSerialNumber=ogSerialNumber, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApCounter=ogWifiApCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdName=ogEmdName, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsTemperature=ogUpsTemperature, ogRpcEntry=ogRpcEntry, ogHostServiceCounter=ogHostServiceCounter, ogWifiApTable=ogWifiApTable, ogEmdTable=ogEmdTable, ogSystem=ogSystem, ogRpcType=ogRpcType, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialUserLabel=ogSerialUserLabel, ogStatus2=ogStatus2, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckEntry=ogCheckEntry, ogWebUserName=ogWebUserName, ogCellModemModel=ogCellModemModel, ogHostUserName=ogHostUserName, ogWifiApFrequency=ogWifiApFrequency, ogStatus2Compliances=ogStatus2Compliances, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioEntry=ogEmdDioEntry, ogAlarmType=ogAlarmType, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDescription=ogEmdDescription, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellDataNotification=ogCellDataNotification, ogRpcCounter=ogRpcCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientRssi=ogWifiClientRssi, ogAlarmState=ogAlarmState, ogCheckDeviceName=ogCheckDeviceName, ogUpsTable=ogUpsTable, ogWebUserEntry=ogWebUserEntry, ogWifiApClientMac=ogWifiApClientMac, ogHostUserIndex=ogHostUserIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdConnectType=ogEmdConnectType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckTable=ogCheckTable, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserIndex=ogWebUserIndex, ogCellModemEnabled=ogCellModemEnabled, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcConnectType=ogRpcConnectType, ogHostUserAddress=ogHostUserAddress, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientAp=ogWifiApClientAp, ogRpcName=ogRpcName, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApEntry=ogWifiApEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcInputVoltage=ogRpcInputVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemIMSI=ogCellModemIMSI, ogHostUserHost=ogHostUserHost, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsNotification=ogUpsNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellTowerNotification=ogCellTowerNotification, ogAlarmEventId=ogAlarmEventId, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogNetInterfaceName=ogNetInterfaceName, ogHostUserNotification=ogHostUserNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioCounter=ogEmdDioCounter, ogStatus2Compliance=ogStatus2Compliance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostName=ogHostName, ogCellModemRegistered=ogCellModemRegistered, ogAlarmCheck=ogAlarmCheck, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmState=ogCurrentAlarmState, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioNotification=ogEmdDioNotification, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientEnabled=ogWifiClientEnabled, ogHostTable=ogHostTable, ogHostServiceTable=ogHostServiceTable, ogUpsInputCurrent=ogUpsInputCurrent, ogHostIpV6Address=ogHostIpV6Address, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserNotification=ogWebUserNotification, ogAlarmInstance=ogAlarmInstance, ogEmdDioState=ogEmdDioState, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsName=ogUpsName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Groups=ogStatus2Groups, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemConnected=ogCellModemConnected, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServicePort=ogHostServicePort, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletName=ogRpcOutletName, ogWifiClientCounter=ogWifiClientCounter, ogCheckIndex=ogCheckIndex, ogEmdDioEmd=ogEmdDioEmd, ogWifiApInterface=ogWifiApInterface, ogEmdEntry=ogEmdEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcTable=ogRpcTable, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemTemperature=ogCellModemTemperature, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckType=ogCheckType, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsCounter=ogUpsCounter, ogWifiClientMode=ogWifiClientMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientTable=ogWifiApClientTable, ogHostUserEntry=ogHostUserEntry, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioName=ogEmdDioName, ogUpsState=ogUpsState, ogUpsType=ogUpsType, ogSerialPortEntry=ogSerialPortEntry, ogAlarmName=ogAlarmName, ogHostUserHostName=ogHostUserHostName, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostEntry=ogHostEntry, ogSerialPortIndex=ogSerialPortIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientEssid=ogWifiClientEssid, ogAlarm=ogAlarm, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckName=ogCheckName, ogUpsDescription=ogUpsDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsIndex=ogUpsIndex, ogRpcOutletState=ogRpcOutletState, ogWebUserStartTime=ogWebUserStartTime, ogHostUserTable=ogHostUserTable, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApSsid=ogWifiApSsid, ogEmdDioDirection=ogEmdDioDirection, ogCellModemVendor=ogCellModemVendor, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemCounter=ogCellModemCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioType=ogEmdDioType, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioIndex=ogEmdDioIndex, ogSerialSignalNotification=ogSerialSignalNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemEntry=ogCellModemEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemTable=ogCellModemTable, ogRpcDescription=ogRpcDescription, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortRTS=ogSerialPortRTS, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceHost=ogHostServiceHost, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyName=ogPowerSupplyName, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortDCD=ogSerialPortDCD, ogWebUserTable=ogWebUserTable, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNotification=ogUpsInputNotification, ogHostPingNotification=ogHostPingNotification, ogCellModemApn=ogCellModemApn, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogMibNotifications=ogMibNotifications, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsEntry=ogUpsEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletTable=ogRpcOutletTable, ogAlarmSummary=ogAlarmSummary, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserTable=ogSerialUserTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemTower=ogCellModemTower, ogSerialUserPort=ogSerialUserPort, ogCellModemIndex=ogCellModemIndex, ogRpcIndex=ogRpcIndex, ogUpsHumidity=ogUpsHumidity, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortMode=ogSerialPortMode, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostIndex=ogHostIndex, ogEmdIndex=ogEmdIndex, ogAlarmTime=ogAlarmTime, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApEnabled=ogWifiApEnabled, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserName=ogSerialUserName, ogCustomNotification=ogCustomNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckDeviceRef=ogCheckDeviceRef)
