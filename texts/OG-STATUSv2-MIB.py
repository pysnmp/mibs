...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmCheck=ogAlarmCheck, ogAlarm=ogAlarm, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioType=ogEmdDioType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemRegistered=ogCellModemRegistered, ogHostUserIndex=ogHostUserIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServiceHost=ogHostServiceHost, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApEnabled=ogWifiApEnabled, ogUpsIndex=ogUpsIndex, ogSerialUserName=ogSerialUserName, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmInstance=ogAlarmInstance, ogUpsOutputPower=ogUpsOutputPower, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmType=ogAlarmType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientTable=ogWifiApClientTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserTable=ogWebUserTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemVendor=ogCellModemVendor, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserStartTime=ogSerialUserStartTime, ogHostEntry=ogHostEntry, ogCheckResolveActions=ogCheckResolveActions, ogHostServicePort=ogHostServicePort, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcType=ogRpcType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckName=ogCheckName, ogWebUserIndex=ogWebUserIndex, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortMode=ogSerialPortMode, ogHostUserName=ogHostUserName, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientAp=ogWifiApClientAp, ogUpsLogEnabled=ogUpsLogEnabled, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostUserTable=ogHostUserTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceType=ogHostServiceType, ogUpsType=ogUpsType, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioEmd=ogEmdDioEmd, ogSerialUserIndex=ogSerialUserIndex, ogAlarmEventId=ogAlarmEventId, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostName=ogHostName, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckTable=ogCheckTable, ogAlarmUser=ogAlarmUser, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortRTS=ogSerialPortRTS, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckType=ogCheckType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdName=ogEmdName, ogRpcOutletTable=ogRpcOutletTable, ogCellModemTower=ogCellModemTower, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioDescription=ogEmdDioDescription, ogAlarmName=ogAlarmName, ogAlarmDevice=ogAlarmDevice, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNotification=ogUpsOutputNotification, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApTxPower=ogWifiApTxPower, ogUpsTemperature=ogUpsTemperature, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmTime=ogAlarmTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTable=ogEmdTable, ogRpcOutputNotification=ogRpcOutputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceState=ogNetInterfaceState, ogCellModemModel=ogCellModemModel, ogHostUserNotification=ogHostUserNotification, ogHostIndex=ogHostIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserNotification=ogSerialUserNotification, ogCellTowerNotification=ogCellTowerNotification, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsNotification=ogUpsNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemCounter=ogCellModemCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsTable=ogUpsTable, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostTable=ogHostTable, ogUpsCounter=ogUpsCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientMac=ogWifiApClientMac, ogUpsEntry=ogUpsEntry, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortEntry=ogSerialPortEntry, ogWifiApCounter=ogWifiApCounter, ogRpcName=ogRpcName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioNotification=ogEmdDioNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApInterface=ogWifiApInterface, ogSerialUserPort=ogSerialUserPort, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApIndex=ogWifiApIndex, ogHostServiceNotification=ogHostServiceNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogMibNotifications=ogMibNotifications, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserEntry=ogSerialUserEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletName=ogRpcOutletName, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDescription=ogEmdDescription, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsState=ogUpsState, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellSignalNotification=ogCellSignalNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApSsid=ogWifiApSsid, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialNumber=ogSerialNumber, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostIpV4Address=ogHostIpV4Address, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioName=ogEmdDioName, ogCustomNotification=ogCustomNotification, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserHost=ogHostUserHost, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcIndex=ogRpcIndex, ogCellModemConnected=ogCellModemConnected, ogStatus2Groups=ogStatus2Groups, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogStatus2Conformance=ogStatus2Conformance, ogWifiApEntry=ogWifiApEntry, ogRpcEntry=ogRpcEntry, ogAlarmSummary=ogAlarmSummary, ogHostUserEntry=ogHostUserEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemEntry=ogCellModemEntry, ogCheckIndex=ogCheckIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdIndex=ogEmdIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemIndex=ogCellModemIndex, ogHostUserAddress=ogHostUserAddress, ogRpcTable=ogRpcTable, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioTable=ogEmdDioTable, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsDescription=ogUpsDescription, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApTable=ogWifiApTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmLogTable=ogAlarmLogTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletState=ogRpcOutletState, ogWifiClientInterface=ogWifiClientInterface, ogRpcCounter=ogRpcCounter, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientIndex=ogWifiClientIndex, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortTable=ogSerialPortTable, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientTable=ogWifiClientTable, ogHostServiceCounter=ogHostServiceCounter, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceName=ogCheckDeviceName, ogCellModemTable=ogCellModemTable, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceTable=ogHostServiceTable, ogHostPingNotification=ogHostPingNotification, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsHumidity=ogUpsHumidity, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortDCD=ogSerialPortDCD, ogCheckEntry=ogCheckEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogStatus2=ogStatus2, ogEmdDioState=ogEmdDioState, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcDescription=ogRpcDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmState=ogAlarmState, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsName=ogUpsName, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemApn=ogCellModemApn, ogSerialUserTable=ogSerialUserTable, ogSystem=ogSystem, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientMode=ogWifiClientMode, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdConnectType=ogEmdConnectType, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientEssid=ogWifiClientEssid, ogWebUserName=ogWebUserName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcConnectType=ogRpcConnectType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceEntry=ogHostServiceEntry, ogEmdEntry=ogEmdEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc)
