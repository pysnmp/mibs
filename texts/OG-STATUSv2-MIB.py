...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortRTS=ogSerialPortRTS, ogStatus2=ogStatus2, ogEmdDioIndex=ogEmdDioIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcTable=ogRpcTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientTable=ogWifiApClientTable, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostName=ogHostName, ogCheckType=ogCheckType, ogHostIndex=ogHostIndex, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortParity=ogSerialPortParity, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemApn=ogCellModemApn, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdName=ogEmdName, ogStatus2Groups=ogStatus2Groups, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcType=ogRpcType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortTable=ogSerialPortTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmUser=ogAlarmUser, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDescription=ogEmdDescription, ogWifiClientIndex=ogWifiClientIndex, ogHostUserIndex=ogHostUserIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmType=ogAlarmType, ogCheckDeviceTable=ogCheckDeviceTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryState=ogUpsBatteryState, ogCheckTable=ogCheckTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientRssi=ogWifiClientRssi, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServicePort=ogHostServicePort, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortIndex=ogSerialPortIndex, ogCheckName=ogCheckName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellDataNotification=ogCellDataNotification, ogWifiApIndex=ogWifiApIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientApMac=ogWifiClientApMac, ogAlarmSummary=ogAlarmSummary, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserEntry=ogSerialUserEntry, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserName=ogSerialUserName, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceName=ogNetInterfaceName, ogSystem=ogSystem, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemNetwork=ogCellModemNetwork, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmDevice=ogAlarmDevice, ogHostUserTable=ogHostUserTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemTable=ogCellModemTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientMac=ogWifiApClientMac, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioState=ogEmdDioState, ogWifiApSsid=ogWifiApSsid, ogCustomNotification=ogCustomNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioType=ogEmdDioType, ogCellModemTower=ogCellModemTower, ogUpsState=ogUpsState, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialNumber=ogSerialNumber, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientEntry=ogWifiClientEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsNotification=ogUpsNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWebUserName=ogWebUserName, ogEmdDioCounter=ogEmdDioCounter, ogCheckIndex=ogCheckIndex, ogAlarmState=ogAlarmState, ogUpsName=ogUpsName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletState=ogRpcOutletState, ogEmdConnectType=ogEmdConnectType, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcEntry=ogRpcEntry, PYSNMP_MODULE_ID=ogStatus2, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemModel=ogCellModemModel, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostUserHostName=ogHostUserHostName, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmTime=ogAlarmTime, ogRpcOutletName=ogRpcOutletName, ogUpsType=ogUpsType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceStatus=ogHostServiceStatus, ogRpcName=ogRpcName, ogUpsDescription=ogUpsDescription, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogFirmwareVersion=ogFirmwareVersion, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcCounter=ogRpcCounter, ogMibNotifications=ogMibNotifications, ogHostUserHost=ogHostUserHost, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioDescription=ogEmdDioDescription, ogRpcDescription=ogRpcDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortCTS=ogSerialPortCTS, ogWifiApInterface=ogWifiApInterface, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortDCD=ogSerialPortDCD, ogCellModemEntry=ogCellModemEntry, ogWifiApTxPower=ogWifiApTxPower, ogWifiApTable=ogWifiApTable, ogHostServiceType=ogHostServiceType, ogHostUserNotification=ogHostUserNotification, ogUpsCounter=ogUpsCounter, ogSerialPortDSR=ogSerialPortDSR, ogRpcIndex=ogRpcIndex, ogUpsInputNotification=ogUpsInputNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostTable=ogHostTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmName=ogAlarmName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioTable=ogEmdDioTable, ogUpsHumidity=ogUpsHumidity, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientMode=ogWifiClientMode, ogAlarm=ogAlarm, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserTable=ogWebUserTable, ogWebUserNotification=ogWebUserNotification, ogStatus2Compliance=ogStatus2Compliance, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientTxPower=ogWifiClientTxPower, ogHostPingNotification=ogHostPingNotification, ogCellModemIndex=ogCellModemIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceHost=ogHostServiceHost, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsConnectType=ogUpsConnectType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWebUserEntry=ogWebUserEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApEntry=ogWifiApEntry, ogCellModemCounter=ogCellModemCounter, ogCellModemVendor=ogCellModemVendor, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellTowerNotification=ogCellTowerNotification, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsTable=ogUpsTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdTable=ogEmdTable, ogUpsTemperature=ogUpsTemperature, ogCheckEntry=ogCheckEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserName=ogHostUserName, ogCurrentAlarmState=ogCurrentAlarmState, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortMode=ogSerialPortMode, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdEnabled=ogEmdEnabled, ogEmdDioName=ogEmdDioName, ogRpcConnectType=ogRpcConnectType, ogAlarmInstance=ogAlarmInstance, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceType=ogNetInterfaceType, ogCellApnNotification=ogCellApnNotification, ogCellModemIMSI=ogCellModemIMSI, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsEntry=ogUpsEntry, ogHostEntry=ogHostEntry, ogSerialPortDTR=ogSerialPortDTR, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserEntry=ogHostUserEntry, ogEmdIndex=ogEmdIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsIndex=ogUpsIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputCurrent=ogUpsInputCurrent, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmCheck=ogAlarmCheck, ogWifiApCounter=ogWifiApCounter, ogRpcInputNotification=ogRpcInputNotification, ogEmdEntry=ogEmdEntry, ogSerialUserPort=ogSerialUserPort, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdLogEnabled=ogEmdLogEnabled)
