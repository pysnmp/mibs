...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientMac=ogWifiApClientMac, ogHostUserNotification=ogHostUserNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortParity=ogSerialPortParity, ogHostServiceEntry=ogHostServiceEntry, ogUpsBatteryState=ogUpsBatteryState, ogSerialUserTable=ogSerialUserTable, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcIndex=ogRpcIndex, ogStatus2Conformance=ogStatus2Conformance, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserStartTime=ogHostUserStartTime, ogWebUserIndex=ogWebUserIndex, ogRpcOutletName=ogRpcOutletName, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdName=ogEmdName, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsTable=ogUpsTable, ogHostUserHost=ogHostUserHost, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserName=ogHostUserName, ogAlarmTime=ogAlarmTime, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostTable=ogHostTable, ogAlarmType=ogAlarmType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsDescription=ogUpsDescription, ogRpcConnectType=ogRpcConnectType, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmState=ogAlarmState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckEntry=ogCheckEntry, ogStatus2Compliances=ogStatus2Compliances, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceType=ogHostServiceType, ogCellModemApn=ogCellModemApn, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostEntry=ogHostEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortTable=ogSerialPortTable, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsNotification=ogUpsNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarm=ogAlarm, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsInputNotification=ogUpsInputNotification, ogCheckTable=ogCheckTable, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserEntry=ogSerialUserEntry, ogEmdConnectType=ogEmdConnectType, ogHostServiceHost=ogHostServiceHost, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellTowerNotification=ogCellTowerNotification, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortDSR=ogSerialPortDSR, ogRpcName=ogRpcName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, PYSNMP_MODULE_ID=ogStatus2, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApAuthNotification=ogWifiApAuthNotification, ogStatus2=ogStatus2, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemEnabled=ogCellModemEnabled, ogHostName=ogHostName, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckType=ogCheckType, ogAlarmDevice=ogAlarmDevice, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserName=ogSerialUserName, ogUpsOutputLoad=ogUpsOutputLoad, ogSystem=ogSystem, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyName=ogPowerSupplyName, ogSerialUserPort=ogSerialUserPort, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletCurrent=ogRpcOutletCurrent, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioDescription=ogEmdDioDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckDeviceName=ogCheckDeviceName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApInterface=ogWifiApInterface, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmInstance=ogAlarmInstance, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogStatus2Groups=ogStatus2Groups, ogRpcCounter=ogRpcCounter, ogSerialUserIndex=ogSerialUserIndex, ogWifiApEntry=ogWifiApEntry, ogWifiClientCounter=ogWifiClientCounter, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortEntry=ogSerialPortEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsCounter=ogUpsCounter, ogAlarmUser=ogAlarmUser, ogCellModemConnected=ogCellModemConnected, ogEmdDioNotification=ogEmdDioNotification, ogEmdIndex=ogEmdIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellDataNotification=ogCellDataNotification, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemIndex=ogCellModemIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceNotification=ogHostServiceNotification, ogCheckResolveActions=ogCheckResolveActions, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortMode=ogSerialPortMode, ogCustomNotification=ogCustomNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsType=ogUpsType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckName=ogCheckName, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsIndex=ogUpsIndex, ogEmdDescription=ogEmdDescription, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmName=ogAlarmName, ogWifiApCounter=ogWifiApCounter, ogCellModemIMSI=ogCellModemIMSI, ogEmdEntry=ogEmdEntry, ogUpsEntry=ogUpsEntry, ogFirmwareVersion=ogFirmwareVersion, ogUpsTemperature=ogUpsTemperature, ogSerialPortLabel=ogSerialPortLabel, ogHostServiceStatus=ogHostServiceStatus, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsState=ogUpsState, ogWifiApClientAp=ogWifiApClientAp, ogWifiApClientTable=ogWifiApClientTable, ogWifiApTable=ogWifiApTable, ogWebUserEntry=ogWebUserEntry, ogCellModemTable=ogCellModemTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckIndex=ogCheckIndex, ogAlarmLogTable=ogAlarmLogTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2Compliance=ogStatus2Compliance, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemTower=ogCellModemTower, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioState=ogEmdDioState, ogSerialPortDTR=ogSerialPortDTR, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmCheck=ogAlarmCheck, ogNetInterfaceName=ogNetInterfaceName, ogWebUserName=ogWebUserName, ogCellModemModel=ogCellModemModel, ogHostIndex=ogHostIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTable=ogEmdTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletState=ogRpcOutletState, ogEmdEnabled=ogEmdEnabled, ogUpsConnectType=ogUpsConnectType, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserStartTime=ogSerialUserStartTime, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortRTS=ogSerialPortRTS, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostServiceTable=ogHostServiceTable, ogWifiApTxPower=ogWifiApTxPower, ogCheckRepeatTimeout=ogCheckRepeatTimeout)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServicePort=ogHostServicePort, ogMibNotifications=ogMibNotifications, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortCTS=ogSerialPortCTS, ogRpcEntry=ogRpcEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserNotification=ogWebUserNotification, ogHostServiceIndex=ogHostServiceIndex, ogSerialNumber=ogSerialNumber, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientTable=ogWifiClientTable, ogWebUserTable=ogWebUserTable, ogHostIpV4Address=ogHostIpV4Address, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostUserIndex=ogHostUserIndex, ogWifiClientMode=ogWifiClientMode, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioEntry=ogEmdDioEntry, ogRpcTable=ogRpcTable, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioTable=ogEmdDioTable, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostPingNotification=ogHostPingNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientIndex=ogWifiClientIndex, ogHostUserTable=ogHostUserTable, ogRpcOutletEntry=ogRpcOutletEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioName=ogEmdDioName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmSummary=ogAlarmSummary, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsName=ogUpsName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcType=ogRpcType, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcDescription=ogRpcDescription, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioType=ogEmdDioType, ogHostUserHostName=ogHostUserHostName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientInterface=ogWifiClientInterface, ogCellModemEntry=ogCellModemEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostUserEntry=ogHostUserEntry, ogCellApnNotification=ogCellApnNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmEventId=ogAlarmEventId, ogUpsBatteryRunTime=ogUpsBatteryRunTime)
