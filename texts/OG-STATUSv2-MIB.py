...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Unsigned32, Counter32, TimeTicks, ObjectIdentity, iso, IpAddress, Bits, ModuleIdentity, NotificationType, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Unsigned32", "Counter32", "TimeTicks", "ObjectIdentity", "iso", "IpAddress", "Bits", "ModuleIdentity", "NotificationType", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortStopBits=ogSerialPortStopBits, ogRpcInputNotification=ogRpcInputNotification, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcDescription=ogRpcDescription, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputLoad=ogUpsOutputLoad, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWebUserName=ogWebUserName, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemTemperature=ogCellModemTemperature, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityName=ogEmdHumidityName, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCustomNotification=ogCustomNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckDeviceName=ogCheckDeviceName, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortEntry=ogSerialPortEntry, ogCellModemCounter=ogCellModemCounter, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarm=ogAlarm, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsEntry=ogUpsEntry, ogCellModemTower=ogCellModemTower, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmType=ogAlarmType, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemEntry=ogCellModemEntry, ogWifiApInterface=ogWifiApInterface, ogEmdDioTable=ogEmdDioTable, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogWebUserTable=ogWebUserTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemApn=ogCellModemApn, ogEmdEntry=ogEmdEntry, ogEmdDioIndex=ogEmdDioIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmCheck=ogAlarmCheck, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortDSR=ogSerialPortDSR, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceType=ogHostServiceType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApIndex=ogWifiApIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserAddress=ogHostUserAddress, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientFrequency=ogWifiClientFrequency, ogCellMessageNotification=ogCellMessageNotification, ogCheckIndex=ogCheckIndex, ogRpcCounter=ogRpcCounter, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletState=ogRpcOutletState, ogRpcType=ogRpcType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApCounter=ogWifiApCounter, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRssi=ogWifiClientRssi, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioType=ogEmdDioType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogHostServiceNotification=ogHostServiceNotification, ogHostServiceStatus=ogHostServiceStatus, ogHostUserName=ogHostUserName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletTable=ogRpcOutletTable, ogCheckEntry=ogCheckEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsNotification=ogUpsNotification, ogUpsTable=ogUpsTable, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckTable=ogCheckTable, ogWebUserIndex=ogWebUserIndex, ogSerialPortDCD=ogSerialPortDCD, ogRpcIndex=ogRpcIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2Compliances=ogStatus2Compliances, ogWifiApTxPower=ogWifiApTxPower, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserHost=ogHostUserHost, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioDescription=ogEmdDioDescription, ogHostEntry=ogHostEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserHostName=ogHostUserHostName, ogAlarmName=ogAlarmName, ogSerialPortParity=ogSerialPortParity, ogAlarmDevice=ogAlarmDevice, ogHostServicePort=ogHostServicePort, ogRpcOutletName=ogRpcOutletName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortSpeed=ogSerialPortSpeed, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientIndex=ogWifiClientIndex, ogWebUserNotification=ogWebUserNotification, ogStatus2Groups=ogStatus2Groups, ogAlarmState=ogAlarmState, ogAlarmSummary=ogAlarmSummary, ogCellModemIndex=ogCellModemIndex, ogCellModemIMSI=ogCellModemIMSI, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDescription=ogEmdDescription, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortLabel=ogSerialPortLabel, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServiceIndex=ogHostServiceIndex, ogUpsDescription=ogUpsDescription, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceName=ogNetInterfaceName, PYSNMP_MODULE_ID=ogStatus2, ogHostUserEntry=ogHostUserEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckType=ogCheckType, ogHostUserNotification=ogHostUserNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmUser=ogAlarmUser, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioState=ogEmdDioState, ogCheckDeviceTable=ogCheckDeviceTable, ogStatus2=ogStatus2, ogRpcTable=ogRpcTable, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsState=ogUpsState, ogCellModemRegistered=ogCellModemRegistered, ogEmdName=ogEmdName, ogWebUserStartTime=ogWebUserStartTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyName=ogPowerSupplyName, ogCellApnNotification=ogCellApnNotification, ogCellModemModel=ogCellModemModel, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialNumber=ogSerialNumber, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceCounter=ogHostServiceCounter, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsName=ogUpsName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsIndex=ogUpsIndex, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2Conformance=ogStatus2Conformance, ogUpsTemperature=ogUpsTemperature, ogSerialPortMode=ogSerialPortMode, ogSerialPortDTR=ogSerialPortDTR, ogCellModemVendor=ogCellModemVendor, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckName=ogCheckName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemConnected=ogCellModemConnected, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserName=ogSerialUserName, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsHumidity=ogUpsHumidity, ogSerialUserEntry=ogSerialUserEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcName=ogRpcName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemTable=ogCellModemTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientMode=ogWifiClientMode, ogWifiApSsid=ogWifiApSsid)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortIndex=ogSerialPortIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdIndex=ogEmdIndex, ogMibNotifications=ogMibNotifications, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostIndex=ogHostIndex, ogHostUserIndex=ogHostUserIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortTable=ogSerialPortTable, ogAlarmTime=ogAlarmTime, ogWifiApClientMac=ogWifiApClientMac, ogHostIpV6Address=ogHostIpV6Address, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsCounter=ogUpsCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserStartTime=ogHostUserStartTime, ogHostUserTable=ogHostUserTable, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmEventId=ogAlarmEventId, ogWifiClientBitRate=ogWifiClientBitRate, ogHostTable=ogHostTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckTriggerActions=ogCheckTriggerActions, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcEntry=ogRpcEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputNotification=ogUpsInputNotification, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTable=ogEmdTable, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApTable=ogWifiApTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdConnectType=ogEmdConnectType, ogEmdDioDirection=ogEmdDioDirection, ogEmdEnabled=ogEmdEnabled, ogEmdDioName=ogEmdDioName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSystem=ogSystem, ogUpsLogEnabled=ogUpsLogEnabled, ogHostName=ogHostName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmName=ogCurrentAlarmName, ogHostPingNotification=ogHostPingNotification, ogAlarmInstance=ogAlarmInstance, ogUpsType=ogUpsType, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsConnectType=ogUpsConnectType)
