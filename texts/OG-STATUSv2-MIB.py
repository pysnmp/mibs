...
ObjectIdentity, Gauge32, Unsigned32, Integer32, NotificationType, iso, Bits, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Unsigned32", "Integer32", "NotificationType", "iso", "Bits", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioTable=ogEmdDioTable, ogHostServiceType=ogHostServiceType, ogHostUserTable=ogHostUserTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletName=ogRpcOutletName, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortCTS=ogSerialPortCTS, ogRpcName=ogRpcName, ogCellModemCounter=ogCellModemCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortMode=ogSerialPortMode, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApEnabled=ogWifiApEnabled, ogUpsConnectType=ogUpsConnectType, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceHost=ogHostServiceHost, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientEssid=ogWifiClientEssid, ogEmdEnabled=ogEmdEnabled, ogWifiApSsid=ogWifiApSsid, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialUserName=ogSerialUserName, ogCheckTable=ogCheckTable, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserEntry=ogSerialUserEntry, ogRpcEntry=ogRpcEntry, ogWifiApInterface=ogWifiApInterface, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserTable=ogSerialUserTable, ogWifiApEntry=ogWifiApEntry, ogUpsTable=ogUpsTable, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioEntry=ogEmdDioEntry, ogCheckDeviceName=ogCheckDeviceName, ogCheckType=ogCheckType, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDescription=ogEmdDescription, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdEntry=ogEmdEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogMibNotifications=ogMibNotifications, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApTable=ogWifiApTable, ogAlarmUser=ogAlarmUser, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmEventId=ogAlarmEventId, ogCellApnNotification=ogCellApnNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApTxPower=ogWifiApTxPower, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletTable=ogRpcOutletTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioIndex=ogEmdDioIndex, ogCellModemEnabled=ogCellModemEnabled, ogSerialNumber=ogSerialNumber, ogSerialUserStartTime=ogSerialUserStartTime, PYSNMP_MODULE_ID=ogStatus2, ogHostUserNotification=ogHostUserNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckEntry=ogCheckEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogFirmwareVersion=ogFirmwareVersion, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemIndex=ogCellModemIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdName=ogEmdName, ogEmdConnectType=ogEmdConnectType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsLogEnabled=ogUpsLogEnabled, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioName=ogEmdDioName, ogCheckName=ogCheckName, ogUpsType=ogUpsType, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmDevice=ogAlarmDevice, ogEmdIndex=ogEmdIndex, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcDescription=ogRpcDescription, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmInstance=ogAlarmInstance, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostName=ogHostName, ogWebUserIndex=ogWebUserIndex, ogSerialPortLabel=ogSerialPortLabel, ogAlarm=ogAlarm, ogWifiClientInterface=ogWifiClientInterface, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserHost=ogHostUserHost, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmState=ogAlarmState, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModem3gRssi=ogCellModem3gRssi, ogHostIndex=ogHostIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsDescription=ogUpsDescription, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserName=ogWebUserName, ogHostServiceTable=ogHostServiceTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioNotification=ogEmdDioNotification, ogCellModemVendor=ogCellModemVendor, ogUpsInputNotification=ogUpsInputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsEntry=ogUpsEntry, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemConnected=ogCellModemConnected, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsCounter=ogUpsCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientTable=ogWifiApClientTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserLabel=ogSerialUserLabel, ogRpcIndex=ogRpcIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcConnectType=ogRpcConnectType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientMode=ogWifiClientMode, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemNetwork=ogCellModemNetwork, ogNetInterfaceName=ogNetInterfaceName, ogHostUserStartTime=ogHostUserStartTime, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmCheck=ogAlarmCheck, ogRpcOutletState=ogRpcOutletState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServiceIndex=ogHostServiceIndex, ogHostServicePort=ogHostServicePort, ogUpsName=ogUpsName, ogCheckResolveActions=ogCheckResolveActions, ogStatus2Compliances=ogStatus2Compliances, ogRpcTable=ogRpcTable, ogCellMessageNotification=ogCellMessageNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortRTS=ogSerialPortRTS, ogRpcLogEnabled=ogRpcLogEnabled, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortEntry=ogSerialPortEntry, ogUpsNotification=ogUpsNotification, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsIndex=ogUpsIndex, ogUpsState=ogUpsState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemApn=ogCellModemApn, ogWifiClientRssi=ogWifiClientRssi, ogCheckIndex=ogCheckIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogCustomNotification=ogCustomNotification, ogCellModemTower=ogCellModemTower, ogSerialPortTable=ogSerialPortTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialUserNotification=ogSerialUserNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmTime=ogAlarmTime, ogSystem=ogSystem, ogWifiApClientAp=ogWifiApClientAp, ogUpsHumidity=ogUpsHumidity, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortParity=ogSerialPortParity, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioType=ogEmdDioType, ogSerialUserPort=ogSerialUserPort, ogRpcMaxTemperature=ogRpcMaxTemperature, ogStatus2Groups=ogStatus2Groups, ogAlarmType=ogAlarmType, ogCellModemTemperature=ogCellModemTemperature, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemTable=ogCellModemTable, ogRpcType=ogRpcType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTable=ogEmdTable, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcCounter=ogRpcCounter, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioState=ogEmdDioState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientApMac=ogWifiClientApMac, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserEntry=ogWebUserEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortDCD=ogSerialPortDCD, ogHostEntry=ogHostEntry, ogSerialPortDSR=ogSerialPortDSR, ogWebUserTable=ogWebUserTable, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceType=ogNetInterfaceType, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryState=ogUpsBatteryState, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmLogTable=ogAlarmLogTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostTable=ogHostTable, ogEmdDioEmd=ogEmdDioEmd, ogCellModemEntry=ogCellModemEntry, ogStatus2=ogStatus2, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostUserEntry=ogHostUserEntry, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientTable=ogWifiClientTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemModel=ogCellModemModel, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogStatus2Conformance=ogStatus2Conformance, ogAlarmName=ogAlarmName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserNotification=ogWebUserNotification, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureName=ogEmdTemperatureName, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserIndex=ogSerialUserIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserName=ogHostUserName)
