...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellApnNotification=ogCellApnNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarm=ogAlarm, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckEntry=ogCheckEntry, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserTable=ogSerialUserTable, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmTime=ogCurrentAlarmTime, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2Groups=ogStatus2Groups, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialNumber=ogSerialNumber, ogWifiClientIndex=ogWifiClientIndex, ogUpsTable=ogUpsTable, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostPingNotification=ogHostPingNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientApMac=ogWifiClientApMac, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmState=ogAlarmState, ogWifiApIndex=ogWifiApIndex, ogRpcOutletName=ogRpcOutletName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcName=ogRpcName, ogCellMessageNotification=ogCellMessageNotification, ogSerialUserLabel=ogSerialUserLabel, ogAlarmUser=ogAlarmUser, ogHostServiceStatus=ogHostServiceStatus, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemEntry=ogCellModemEntry, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmDevice=ogAlarmDevice, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserEntry=ogWebUserEntry, ogHostServiceTable=ogHostServiceTable, ogWebUserName=ogWebUserName, ogEmdDioType=ogEmdDioType, ogEmdDioName=ogEmdDioName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserEntry=ogHostUserEntry, ogUpsCounter=ogUpsCounter, ogCellModemModel=ogCellModemModel, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDSR=ogSerialPortDSR, ogHostTable=ogHostTable, ogHostName=ogHostName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdIndex=ogEmdIndex, ogCheckType=ogCheckType, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserStartTime=ogWebUserStartTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdHumidityName=ogEmdHumidityName, ogRpcConnectType=ogRpcConnectType, ogEmdDioDescription=ogEmdDioDescription, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServiceType=ogHostServiceType, ogAlarmName=ogAlarmName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserHostName=ogHostUserHostName, ogEmdDioState=ogEmdDioState, ogEmdConnectType=ogEmdConnectType, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientMac=ogWifiApClientMac, ogSerialUserIndex=ogSerialUserIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApAuthNotification=ogWifiApAuthNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmType=ogAlarmType, ogUpsEntry=ogUpsEntry, ogSerialUserName=ogSerialUserName, ogStatus2Conformance=ogStatus2Conformance, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientMode=ogWifiClientMode, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemVendor=ogCellModemVendor, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientRssi=ogWifiClientRssi, ogEmdEntry=ogEmdEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSystem=ogSystem, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmTime=ogAlarmTime, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApTable=ogWifiApTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsHumidity=ogUpsHumidity, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcEntry=ogRpcEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogCellDataNotification=ogCellDataNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmSummary=ogAlarmSummary, ogHostEntry=ogHostEntry, ogUpsDescription=ogUpsDescription, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemApn=ogCellModemApn, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputNotification=ogUpsOutputNotification, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsConnectType=ogUpsConnectType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2=ogStatus2, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserHost=ogHostUserHost, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyName=ogPowerSupplyName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemTower=ogCellModemTower, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientEssid=ogWifiClientEssid, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckIndex=ogCheckIndex, ogEmdDioCounter=ogEmdDioCounter, ogUpsName=ogUpsName, ogCheckName=ogCheckName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortParity=ogSerialPortParity, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortFramingErrors=ogSerialPortFramingErrors, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortDCD=ogSerialPortDCD, ogWifiApEnabled=ogWifiApEnabled, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdName=ogEmdName, ogAlarmCheck=ogAlarmCheck, ogSerialPortLabel=ogSerialPortLabel, ogRpcIndex=ogRpcIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsType=ogUpsType, ogUpsOutputPower=ogUpsOutputPower, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioTable=ogEmdDioTable, ogWebUserIndex=ogWebUserIndex, ogMibNotifications=ogMibNotifications, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostServiceEntry=ogHostServiceEntry, ogCheckTable=ogCheckTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcTable=ogRpcTable, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCustomNotification=ogCustomNotification, ogAlarmEventId=ogAlarmEventId, ogCellModemIMSI=ogCellModemIMSI, ogWifiApInterface=ogWifiApInterface, ogEmdDescription=ogEmdDescription, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserIndex=ogHostUserIndex, ogEmdTable=ogEmdTable, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWebUserNotification=ogWebUserNotification, ogSerialPortDTR=ogSerialPortDTR, ogHostUserTable=ogHostUserTable, ogStatus2Compliances=ogStatus2Compliances, ogAlarmInstance=ogAlarmInstance, ogNetInterfaceState=ogNetInterfaceState, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserNotification=ogHostUserNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApTxPower=ogWifiApTxPower, ogHostServicePort=ogHostServicePort, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserName=ogHostUserName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceName=ogNetInterfaceName, ogHostServiceIndex=ogHostServiceIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcType=ogRpcType, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortMode=ogSerialPortMode, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemIndex=ogCellModemIndex, ogRpcDescription=ogRpcDescription, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcCounter=ogRpcCounter, ogCellModemTable=ogCellModemTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostIpV4Address=ogHostIpV4Address, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryState=ogUpsBatteryState, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApCounter=ogWifiApCounter, ogEmdEnabled=ogEmdEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsNotification=ogUpsNotification, ogUpsState=ogUpsState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApEntry=ogWifiApEntry, ogRpcOutletState=ogRpcOutletState, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceNotification=ogHostServiceNotification, ogWebUserTable=ogWebUserTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsIndex=ogUpsIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdDioIndex=ogEmdDioIndex, ogUpsInputNotification=ogUpsInputNotification, ogHostIndex=ogHostIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApSsid=ogWifiApSsid, ogWifiClientCounter=ogWifiClientCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApFrequency=ogWifiApFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortBreaks=ogSerialPortBreaks)
