...
Gauge32, MibIdentifier, Unsigned32, Integer32, ObjectIdentity, ModuleIdentity, NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Unsigned32", "Integer32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsEntry=ogUpsEntry, ogAlarmType=ogAlarmType, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsType=ogUpsType, ogAlarm=ogAlarm, ogCheckTable=ogCheckTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApTxPower=ogWifiApTxPower, ogUpsDescription=ogUpsDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckName=ogCheckName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemApn=ogCellModemApn, ogUpsConnectType=ogUpsConnectType, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdIndex=ogEmdIndex, ogHostUserNotification=ogHostUserNotification, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserEntry=ogWebUserEntry, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcType=ogRpcType, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientApMac=ogWifiClientApMac, ogUpsInputNotification=ogUpsInputNotification, ogUpsTable=ogUpsTable, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserAddress=ogHostUserAddress, ogEmdDioType=ogEmdDioType, ogAlarmInstance=ogAlarmInstance, ogCustomNotification=ogCustomNotification, ogSerialUserNotification=ogSerialUserNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServicePort=ogHostServicePort, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellApnNotification=ogCellApnNotification, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientMode=ogWifiClientMode, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApSsid=ogWifiApSsid, ogStatus2Groups=ogStatus2Groups, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDescription=ogEmdDescription, ogAlarmCheck=ogAlarmCheck, ogSerialPortRTS=ogSerialPortRTS, ogCellSignalNotification=ogCellSignalNotification, ogRpcConnectType=ogRpcConnectType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsInputCurrent=ogUpsInputCurrent, ogCellTowerNotification=ogCellTowerNotification, ogHostUserStartTime=ogHostUserStartTime, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogStatus2Conformance=ogStatus2Conformance, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientMac=ogWifiApClientMac, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioEmd=ogEmdDioEmd, ogWifiApIndex=ogWifiApIndex, ogHostPingNotification=ogHostPingNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemEntry=ogCellModemEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialUserPort=ogSerialUserPort, ogCellModemModel=ogCellModemModel, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientAp=ogWifiApClientAp, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApInterface=ogWifiApInterface, ogHostIpV6Address=ogHostIpV6Address, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmUser=ogAlarmUser, ogRpcOutletName=ogRpcOutletName, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioName=ogEmdDioName, ogEmdDioDescription=ogEmdDioDescription, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientEssid=ogWifiClientEssid, PYSNMP_MODULE_ID=ogStatus2, ogEmdEntry=ogEmdEntry, ogWebUserIndex=ogWebUserIndex, ogWebUserNotification=ogWebUserNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsHumidity=ogUpsHumidity, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcEntry=ogRpcEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserHostName=ogHostUserHostName, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioDirection=ogEmdDioDirection, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdName=ogEmdName, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcInputFrequency=ogRpcInputFrequency, ogMibNotifications=ogMibNotifications, ogHostUserEntry=ogHostUserEntry, ogSerialPortDSR=ogSerialPortDSR, ogAlarmLogTable=ogAlarmLogTable, ogUpsNotification=ogUpsNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSystem=ogSystem, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceCounter=ogHostServiceCounter, ogUpsState=ogUpsState, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcInputVoltage=ogRpcInputVoltage, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApEnabled=ogWifiApEnabled, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserTable=ogSerialUserTable, ogWifiApEntry=ogWifiApEntry, ogSerialPortLabel=ogSerialPortLabel, ogCellModemIndex=ogCellModemIndex, ogRpcCounter=ogRpcCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckEntry=ogCheckEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemVendor=ogCellModemVendor, ogAlarmName=ogAlarmName, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyName=ogPowerSupplyName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdConnectType=ogEmdConnectType, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemTable=ogCellModemTable, ogEmdDioState=ogEmdDioState, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmTime=ogAlarmTime, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputPower=ogUpsOutputPower, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckType=ogCheckType, ogRpcIndex=ogRpcIndex, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserName=ogWebUserName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcTable=ogRpcTable, ogHostUserHost=ogHostUserHost, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostTable=ogHostTable, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioTable=ogEmdDioTable, ogRpcDescription=ogRpcDescription, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceName=ogCheckDeviceName, ogHostEntry=ogHostEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortEntry=ogSerialPortEntry, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckIndex=ogCheckIndex, ogHostUserIndex=ogHostUserIndex, ogCellModemCounter=ogCellModemCounter, ogCellModemTower=ogCellModemTower, ogHostIpV4Address=ogHostIpV4Address, ogWifiApTable=ogWifiApTable, ogEmdEnabled=ogEmdEnabled, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityName=ogEmdHumidityName, ogCellMessageNotification=ogCellMessageNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsTemperature=ogUpsTemperature, ogCellModemConnected=ogCellModemConnected, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortCTS=ogSerialPortCTS, ogAlarmDevice=ogAlarmDevice, ogWifiApCounter=ogWifiApCounter, ogCellDataNotification=ogCellDataNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckDeviceEntry=ogCheckDeviceEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserIndex=ogSerialUserIndex, ogUpsIndex=ogUpsIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserName=ogHostUserName, ogSerialUserName=ogSerialUserName, ogSerialPortDTR=ogSerialPortDTR, ogSerialNumber=ogSerialNumber, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmState=ogAlarmState, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogStatus2=ogStatus2, ogRpcOutletTable=ogRpcOutletTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmSummary=ogAlarmSummary, ogHostName=ogHostName, ogHostServiceHost=ogHostServiceHost, ogCellModemNetwork=ogCellModemNetwork, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsName=ogUpsName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialUserEntry=ogSerialUserEntry, ogEmdTable=ogEmdTable, ogUpsCounter=ogUpsCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcName=ogRpcName, ogWebUserSourcePort=ogWebUserSourcePort, ogHostIndex=ogHostIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortMode=ogSerialPortMode, ogHostServiceType=ogHostServiceType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserTable=ogHostUserTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortParity=ogSerialPortParity, ogWebUserTable=ogWebUserTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientFrequency=ogWifiClientFrequency)
