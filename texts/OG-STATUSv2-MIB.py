...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostPingNotification=ogHostPingNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemEnabled=ogCellModemEnabled, ogCheckDeviceTable=ogCheckDeviceTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioState=ogEmdDioState, ogAlarmSummary=ogAlarmSummary, ogEmdDioType=ogEmdDioType, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdEnabled=ogEmdEnabled, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioName=ogEmdDioName, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckName=ogCheckName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarm=ogAlarm, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckEntry=ogCheckEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCustomNotification=ogCustomNotification, ogHostServiceStatus=ogHostServiceStatus, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsState=ogUpsState, ogHostEntry=ogHostEntry, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientMac=ogWifiApClientMac, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserName=ogHostUserName, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcConnectType=ogRpcConnectType, ogSerialPatternNotification=ogSerialPatternNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortIndex=ogSerialPortIndex, ogUpsEntry=ogUpsEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemVendor=ogCellModemVendor, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmEventId=ogAlarmEventId, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletIndex=ogRpcOutletIndex, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcIndex=ogRpcIndex, ogWifiApTable=ogWifiApTable, ogSerialPortLabel=ogSerialPortLabel, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletVoltage=ogRpcOutletVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemModel=ogCellModemModel, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcName=ogRpcName, ogWebUserTable=ogWebUserTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostIpV4Address=ogHostIpV4Address, ogCellMessageNotification=ogCellMessageNotification, ogHostUserEntry=ogHostUserEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsNotification=ogUpsNotification, ogSerialPortCTS=ogSerialPortCTS, ogHostIndex=ogHostIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceType=ogNetInterfaceType, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientTable=ogWifiApClientTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdIndex=ogEmdIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemApn=ogCellModemApn, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioIndex=ogEmdDioIndex, ogCheckType=ogCheckType, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsIndex=ogUpsIndex, ogEmdConnectType=ogEmdConnectType, ogRpcDescription=ogRpcDescription, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcCounter=ogRpcCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialUserName=ogSerialUserName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsName=ogUpsName, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientCounter=ogWifiClientCounter, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientRssi=ogWifiClientRssi, ogCheckTable=ogCheckTable, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceHost=ogHostServiceHost, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemConnected=ogCellModemConnected, ogWifiApClientAp=ogWifiApClientAp, ogEmdLogEnabled=ogEmdLogEnabled, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserTable=ogHostUserTable, ogHostServiceTable=ogHostServiceTable, ogCellModemTable=ogCellModemTable, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmState=ogAlarmState, ogCellTowerNotification=ogCellTowerNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostName=ogHostName, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceNotification=ogHostServiceNotification, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityEmd=ogEmdHumidityEmd, ogMibNotifications=ogMibNotifications, ogAlarmCheck=ogAlarmCheck, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsHumidity=ogUpsHumidity, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemCounter=ogCellModemCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioTable=ogEmdDioTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityIndex=ogEmdHumidityIndex, ogStatus2Groups=ogStatus2Groups, ogWifiApEnabled=ogWifiApEnabled, ogEmdName=ogEmdName, ogAlarmType=ogAlarmType, ogRpcEntry=ogRpcEntry, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortMode=ogSerialPortMode, ogWebUserIndex=ogWebUserIndex, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserPort=ogSerialUserPort, ogHostUserHost=ogHostUserHost, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcType=ogRpcType, ogHostServicePort=ogHostServicePort, ogAlarmInstance=ogAlarmInstance, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserStartTime=ogWebUserStartTime, ogHostUserHostName=ogHostUserHostName, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSystem=ogSystem, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApInterface=ogWifiApInterface, ogWifiApIndex=ogWifiApIndex, ogHostUserNotification=ogHostUserNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcInputNotification=ogRpcInputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserEntry=ogWebUserEntry, ogHostServiceCounter=ogHostServiceCounter, ogUpsConnectType=ogUpsConnectType, ogCellModemTower=ogCellModemTower, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletName=ogRpcOutletName, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsCounter=ogUpsCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmUser=ogAlarmUser, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserIndex=ogHostUserIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputNotification=ogUpsInputNotification, ogAlarmTime=ogAlarmTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientMode=ogWifiClientMode, ogCellModemIndex=ogCellModemIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcTable=ogRpcTable, ogAlarmName=ogAlarmName, ogUpsTable=ogUpsTable, ogEmdDioDirection=ogEmdDioDirection, ogWifiApCounter=ogWifiApCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostTable=ogHostTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApSsid=ogWifiApSsid, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsType=ogUpsType, ogUpsDescription=ogUpsDescription, ogRpcOutletState=ogRpcOutletState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogCellDataNotification=ogCellDataNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTable=ogEmdTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsTemperature=ogUpsTemperature, ogEmdEntry=ogEmdEntry, ogHostServiceType=ogHostServiceType, ogWebUserName=ogWebUserName, ogSerialPortSpeed=ogSerialPortSpeed, ogCellApnNotification=ogCellApnNotification, ogWifiApEntry=ogWifiApEntry, ogCheckIndex=ogCheckIndex, ogStatus2=ogStatus2, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientInterface=ogWifiClientInterface, ogSerialNumber=ogSerialNumber, ogEmdDescription=ogEmdDescription, ogAlarmDevice=ogAlarmDevice, ogWifiApFrequency=ogWifiApFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserNotification=ogWebUserNotification, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemEntry=ogCellModemEntry)
