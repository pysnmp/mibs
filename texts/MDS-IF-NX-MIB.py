...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxLastChan=mIfNxLastChan, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxLinkStatus=mIfNxLinkStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, InitStatus=InitStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxHardwareRevision=mIfNxHardwareRevision, FirmwareRevision=FirmwareRevision, UnsignedByte=UnsignedByte, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxActiveNic=mIfNxActiveNic, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, InetIpAddress=InetIpAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, UnsignedShort=UnsignedShort, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, ModemType=ModemType, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode)
