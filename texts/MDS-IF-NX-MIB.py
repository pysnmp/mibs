...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxTemperature=mIfNxTemperature, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mdsIfNxMIB=mdsIfNxMIB, mIfNxFirmwareRevision=mIfNxFirmwareRevision, UnsignedByte=UnsignedByte, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, ModemType=ModemType, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, FirmwareRevision=FirmwareRevision, InitStatus=InitStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, DeviceModeType=DeviceModeType, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatus=mIfNxStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxSerialNumber=mIfNxSerialNumber, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxLastLqi=mIfNxLastLqi, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxError=mIfNxMacStatsTxError, AlarmFlags=AlarmFlags, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus)
