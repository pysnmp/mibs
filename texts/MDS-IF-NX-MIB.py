...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, InitStatus=InitStatus, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxHardwareRevision=mIfNxHardwareRevision, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, AlarmFlags=AlarmFlags, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, DeviceModeType=DeviceModeType, FirmwareRevision=FirmwareRevision, mIfNxLastRssi=mIfNxLastRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, LinkStatus=LinkStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, InetIpAddress=InetIpAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxLastChan=mIfNxLastChan, UnsignedByte=UnsignedByte, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, ModemType=ModemType, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress)
