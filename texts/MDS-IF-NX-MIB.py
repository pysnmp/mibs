...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxAlarms=mIfNxAlarms, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxCompliance=mIfNxCompliance, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, FirmwareRevision=FirmwareRevision, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxTemperature=mIfNxTemperature, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIB=mdsIfNxMIB, ModemType=ModemType, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, UnsignedByte=UnsignedByte, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusTable=mIfNxStatusTable, mIfNxSerialNumber=mIfNxSerialNumber, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, UnsignedShort=UnsignedShort, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, DeviceModeType=DeviceModeType, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, InitStatus=InitStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess)
