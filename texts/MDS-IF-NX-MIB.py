...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxHardwareId=mIfNxHardwareId, mIfNxActiveNic=mIfNxActiveNic, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, ModemType=ModemType, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxTemperature=mIfNxTemperature, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxConfig=mIfNxConfig, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, InetIpAddress=InetIpAddress, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxHardwareRevision=mIfNxHardwareRevision, UnsignedByte=UnsignedByte, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, LinkStatus=LinkStatus, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mdsIfNxMIB=mdsIfNxMIB, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusTable=mIfNxStatusTable, DeviceModeType=DeviceModeType, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, InitStatus=InitStatus, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop)
