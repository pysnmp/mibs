...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxAlarms=mIfNxAlarms, mIfNxStatusActChanTable=mIfNxStatusActChanTable, UnsignedShort=UnsignedShort, ModemType=ModemType, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLinkStatus=mIfNxLinkStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, LinkStatus=LinkStatus, mIfNxTemperature=mIfNxTemperature, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxLastLqi=mIfNxLastLqi, UnsignedByte=UnsignedByte, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, InitStatus=InitStatus, AlarmFlags=AlarmFlags, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, FirmwareRevision=FirmwareRevision, mIfNxHardwareId=mIfNxHardwareId, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, DeviceModeType=DeviceModeType, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway)
