...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxLastRssi=mIfNxLastRssi, InitStatus=InitStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, DeviceModeType=DeviceModeType, mIfNxHardwareRevision=mIfNxHardwareRevision, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, UnsignedShort=UnsignedShort, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatus=mIfNxStatus, mIfNxCompliance=mIfNxCompliance, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLastChan=mIfNxLastChan, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusTable=mIfNxStatusTable, AlarmFlags=AlarmFlags, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, FirmwareRevision=FirmwareRevision, ModemType=ModemType, mdsIfNxMIB=mdsIfNxMIB, mIfNxActiveNic=mIfNxActiveNic, InetIpAddress=InetIpAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxConfig=mIfNxConfig, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress)
