...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLastChan=mIfNxLastChan, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, ModemType=ModemType, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, AlarmFlags=AlarmFlags, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxHardwareRevision=mIfNxHardwareRevision, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxConfig=mIfNxConfig, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusGroup=mIfNxStatusGroup, InitStatus=InitStatus, FirmwareRevision=FirmwareRevision, UnsignedShort=UnsignedShort, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, InetIpAddress=InetIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, DeviceModeType=DeviceModeType, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxHardwareId=mIfNxHardwareId, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr)
