...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, AlarmFlags=AlarmFlags, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, DeviceModeType=DeviceModeType, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxActiveNic=mIfNxActiveNic, InitStatus=InitStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, ModemType=ModemType, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, UnsignedShort=UnsignedShort, mIfNxCompliance=mIfNxCompliance, mIfNxStatus=mIfNxStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxLastChan=mIfNxLastChan, mIfNxHardwareId=mIfNxHardwareId, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxTemperature=mIfNxTemperature, mIfNxFirmwareRevision=mIfNxFirmwareRevision, InetIpAddress=InetIpAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, UnsignedByte=UnsignedByte, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxConfig=mIfNxConfig, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, LinkStatus=LinkStatus, FirmwareRevision=FirmwareRevision, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxInitStatus=mIfNxInitStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi)
