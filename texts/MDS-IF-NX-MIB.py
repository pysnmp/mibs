...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatus=mIfNxStatus, UnsignedShort=UnsignedShort, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMIBObjects=mIfNxMIBObjects, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, LinkStatus=LinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIB=mdsIfNxMIB, DeviceModeType=DeviceModeType, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxError=mIfNxMacStatsTxError, UnsignedByte=UnsignedByte, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusTable=mIfNxStatusTable, ModemType=ModemType, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxConfig=mIfNxConfig, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, InitStatus=InitStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxAlarms=mIfNxAlarms, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxHardwareRevision=mIfNxHardwareRevision, AlarmFlags=AlarmFlags, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, InetIpAddress=InetIpAddress, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets)
