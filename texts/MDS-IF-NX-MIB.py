...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxCurrentModem=mIfNxCurrentModem, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxInitStatus=mIfNxInitStatus, mIfNxAlarms=mIfNxAlarms, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, FirmwareRevision=FirmwareRevision, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxConfig=mIfNxConfig, DeviceModeType=DeviceModeType, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, InitStatus=InitStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxLastLqi=mIfNxLastLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoApAddress=mIfNxApInfoApAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, AlarmFlags=AlarmFlags, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, ModemType=ModemType, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, InetIpAddress=InetIpAddress, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets)
