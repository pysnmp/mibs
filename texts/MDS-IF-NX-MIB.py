...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, ModemType=ModemType, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, AlarmFlags=AlarmFlags, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, DeviceModeType=DeviceModeType, mIfNxConfig=mIfNxConfig, mIfNxLastChan=mIfNxLastChan, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatus=mIfNxStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, InetIpAddress=InetIpAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, InitStatus=InitStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, FirmwareRevision=FirmwareRevision, mIfNxTemperature=mIfNxTemperature, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLinkStatus=mIfNxLinkStatus, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr)
