...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, DeviceModeType=DeviceModeType, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, InitStatus=InitStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCompliance=mIfNxCompliance, mIfNxLastLqi=mIfNxLastLqi, UnsignedByte=UnsignedByte, LinkStatus=LinkStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, UnsignedShort=UnsignedShort, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxInitStatus=mIfNxInitStatus, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxConfig=mIfNxConfig, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, InetIpAddress=InetIpAddress, FirmwareRevision=FirmwareRevision, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, ModemType=ModemType, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry)
