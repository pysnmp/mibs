...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, DeviceModeType=DeviceModeType, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxInitStatus=mIfNxInitStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatus=mIfNxStatus, UnsignedByte=UnsignedByte, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxAlarms=mIfNxAlarms, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxConfig=mIfNxConfig, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, UnsignedShort=UnsignedShort, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLastChan=mIfNxLastChan, LinkStatus=LinkStatus, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxHardwareRevision=mIfNxHardwareRevision, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mdsIfNxMIB=mdsIfNxMIB, InitStatus=InitStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxTemperature=mIfNxTemperature, AlarmFlags=AlarmFlags, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusGroup=mIfNxStatusGroup, ModemType=ModemType, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes)
