...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, ModemType=ModemType, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, DeviceModeType=DeviceModeType, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, UnsignedShort=UnsignedShort, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, FirmwareRevision=FirmwareRevision, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxConfig=mIfNxConfig, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatus=mIfNxStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, UnsignedByte=UnsignedByte, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mdsIfNxMIBGroups=mdsIfNxMIBGroups, LinkStatus=LinkStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, InitStatus=InitStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxCompliance=mIfNxCompliance, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, AlarmFlags=AlarmFlags, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxActiveNic=mIfNxActiveNic, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive)
