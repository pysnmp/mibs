...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, DeviceModeType=DeviceModeType, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, InitStatus=InitStatus, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, InetIpAddress=InetIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, AlarmFlags=AlarmFlags, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxTemperature=mIfNxTemperature, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusTable=mIfNxStatusTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, UnsignedShort=UnsignedShort, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, LinkStatus=LinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, FirmwareRevision=FirmwareRevision, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxLastRssi=mIfNxLastRssi, mIfNxLinkStatus=mIfNxLinkStatus, ModemType=ModemType)
