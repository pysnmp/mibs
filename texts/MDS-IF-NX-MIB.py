...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastLqi=mIfNxLastLqi, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxCompliance=mIfNxCompliance, DeviceModeType=DeviceModeType, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, AlarmFlags=AlarmFlags, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusTable=mIfNxStatusTable, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, InitStatus=InitStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, LinkStatus=LinkStatus, InetIpAddress=InetIpAddress, ModemType=ModemType, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxInitStatus=mIfNxInitStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxLinkStatus=mIfNxLinkStatus)
