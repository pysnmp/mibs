...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatus=mIfNxStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, DeviceModeType=DeviceModeType, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, ModemType=ModemType, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLastLqi=mIfNxLastLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, LinkStatus=LinkStatus, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, UnsignedByte=UnsignedByte, UnsignedShort=UnsignedShort, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxTemperature=mIfNxTemperature, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, FirmwareRevision=FirmwareRevision, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxLastRssi=mIfNxLastRssi, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, InitStatus=InitStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, AlarmFlags=AlarmFlags, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync)
