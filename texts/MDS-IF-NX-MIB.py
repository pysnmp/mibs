...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", FirmwareRevision=FirmwareRevision, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxTemperature=mIfNxTemperature, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLastChan=mIfNxLastChan, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, InitStatus=InitStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, DeviceModeType=DeviceModeType, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxConfig=mIfNxConfig, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, InetIpAddress=InetIpAddress, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, ModemType=ModemType, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, UnsignedShort=UnsignedShort, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxInitStatus=mIfNxInitStatus, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, AlarmFlags=AlarmFlags, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLastRssi=mIfNxLastRssi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxCompliance=mIfNxCompliance, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway)
