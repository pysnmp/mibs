...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, UnsignedByte=UnsignedByte, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLastLqi=mIfNxLastLqi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxAlarms=mIfNxAlarms, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, LinkStatus=LinkStatus, mIfNxStatusEntry=mIfNxStatusEntry, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, InitStatus=InitStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mdsIfNxMIB=mdsIfNxMIB, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusGroup=mIfNxStatusGroup, InetIpAddress=InetIpAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, UnsignedShort=UnsignedShort, ModemType=ModemType, mIfNxTemperature=mIfNxTemperature, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatus=mIfNxStatus, FirmwareRevision=FirmwareRevision, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxSerialNumber=mIfNxSerialNumber, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes)
