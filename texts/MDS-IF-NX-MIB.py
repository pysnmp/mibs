...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxLinkStatus=mIfNxLinkStatus, ModemType=ModemType, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLastLqi=mIfNxLastLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, DeviceModeType=DeviceModeType, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxConfig=mIfNxConfig, mIfNxStatusTable=mIfNxStatusTable, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxCurrentModem=mIfNxCurrentModem, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, UnsignedShort=UnsignedShort, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, InetIpAddress=InetIpAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, InitStatus=InitStatus, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, LinkStatus=LinkStatus, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, AlarmFlags=AlarmFlags, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxSerialNumber=mIfNxSerialNumber, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry)
