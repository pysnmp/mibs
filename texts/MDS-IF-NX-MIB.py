...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, DeviceModeType=DeviceModeType, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxInitStatus=mIfNxInitStatus, InetIpAddress=InetIpAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLastChan=mIfNxLastChan, ModemType=ModemType, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatus=mIfNxStatus, mIfNxConfig=mIfNxConfig, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusTable=mIfNxStatusTable, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, InitStatus=InitStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, AlarmFlags=AlarmFlags, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mdsIfNxMIB=mdsIfNxMIB, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, LinkStatus=LinkStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, FirmwareRevision=FirmwareRevision, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxLinkStatus=mIfNxLinkStatus)
