...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxSerialNumber=mIfNxSerialNumber, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, InetIpAddress=InetIpAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxAlarms=mIfNxAlarms, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, LinkStatus=LinkStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, ModemType=ModemType, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxHardwareRevision=mIfNxHardwareRevision, UnsignedShort=UnsignedShort, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, DeviceModeType=DeviceModeType, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxCurrentModem=mIfNxCurrentModem, InitStatus=InitStatus, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, UnsignedByte=UnsignedByte)
