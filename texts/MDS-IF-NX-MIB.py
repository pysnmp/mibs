...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, UnsignedShort=UnsignedShort, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, LinkStatus=LinkStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, FirmwareRevision=FirmwareRevision, mIfNxTemperature=mIfNxTemperature, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxActiveNic=mIfNxActiveNic, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxHardwareId=mIfNxHardwareId, mIfNxLastLqi=mIfNxLastLqi, InetIpAddress=InetIpAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, ModemType=ModemType, AlarmFlags=AlarmFlags, mIfNxCompliance=mIfNxCompliance, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLastChan=mIfNxLastChan, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, InitStatus=InitStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets)
