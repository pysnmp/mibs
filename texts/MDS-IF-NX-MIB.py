...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatus=mIfNxStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxInitStatus=mIfNxInitStatus, mIfNxLastChan=mIfNxLastChan, mdsIfNxMIBConformance=mdsIfNxMIBConformance, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxLastRssi=mIfNxLastRssi, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, DeviceModeType=DeviceModeType, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, ModemType=ModemType, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, FirmwareRevision=FirmwareRevision, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, InitStatus=InitStatus, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxConfig=mIfNxConfig, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxHardwareId=mIfNxHardwareId, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxLastLqi=mIfNxLastLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedByte=UnsignedByte, LinkStatus=LinkStatus)
