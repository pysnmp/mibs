...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxTemperature=mIfNxTemperature, UnsignedShort=UnsignedShort, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatus=mIfNxStatus, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, DeviceModeType=DeviceModeType, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxHardwareId=mIfNxHardwareId, ModemType=ModemType, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, InitStatus=InitStatus, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, UnsignedByte=UnsignedByte, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxCurrentModem=mIfNxCurrentModem, AlarmFlags=AlarmFlags, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxActiveNic=mIfNxActiveNic, mIfNxLastChan=mIfNxLastChan, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, LinkStatus=LinkStatus, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMIBObjects=mIfNxMIBObjects, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode)
