...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxLastLqi=mIfNxLastLqi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mdsIfNxMIBGroups=mdsIfNxMIBGroups, DeviceModeType=DeviceModeType, UnsignedByte=UnsignedByte, mIfNxTemperature=mIfNxTemperature, ModemType=ModemType, mIfNxActiveNic=mIfNxActiveNic, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, AlarmFlags=AlarmFlags, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxHardwareId=mIfNxHardwareId, mIfNxSerialNumber=mIfNxSerialNumber, InetIpAddress=InetIpAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLastRssi=mIfNxLastRssi, InitStatus=InitStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxConfig=mIfNxConfig, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, UnsignedShort=UnsignedShort, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi)
