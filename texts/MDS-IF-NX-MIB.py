...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxCurrentModem=mIfNxCurrentModem, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, UnsignedByte=UnsignedByte, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxLastLqi=mIfNxLastLqi, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, UnsignedShort=UnsignedShort, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, DeviceModeType=DeviceModeType, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatus=mIfNxStatus, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, FirmwareRevision=FirmwareRevision, mIfNxActiveNic=mIfNxActiveNic, AlarmFlags=AlarmFlags, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxCompliance=mIfNxCompliance, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEntry=mIfNxStatusEntry, ModemType=ModemType, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, InetIpAddress=InetIpAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, InitStatus=InitStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus)
