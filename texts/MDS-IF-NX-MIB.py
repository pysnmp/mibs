...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, AlarmFlags=AlarmFlags, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxConfig=mIfNxConfig, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxTemperature=mIfNxTemperature, DeviceModeType=DeviceModeType, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxCompliance=mIfNxCompliance, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxAlarms=mIfNxAlarms, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxInitStatus=mIfNxInitStatus, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, UnsignedByte=UnsignedByte, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, FirmwareRevision=FirmwareRevision, ModemType=ModemType, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEntry=mIfNxStatusEntry, UnsignedShort=UnsignedShort, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, InitStatus=InitStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxLastLqi=mIfNxLastLqi, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, InetIpAddress=InetIpAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable)
