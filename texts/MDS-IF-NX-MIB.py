...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxCompliance=mIfNxCompliance, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, InetIpAddress=InetIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, ModemType=ModemType, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoApAddress=mIfNxApInfoApAddress, LinkStatus=LinkStatus, InitStatus=InitStatus, UnsignedShort=UnsignedShort, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxActiveNic=mIfNxActiveNic, DeviceModeType=DeviceModeType, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLastChan=mIfNxLastChan, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxConfig=mIfNxConfig, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, UnsignedByte=UnsignedByte, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxLastRssi=mIfNxLastRssi, mIfNxInitStatus=mIfNxInitStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi)
