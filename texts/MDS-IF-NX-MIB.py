...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, ModemType=ModemType, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusTable=mIfNxStatusTable, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxTemperature=mIfNxTemperature, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxInitStatus=mIfNxInitStatus, LinkStatus=LinkStatus, mIfNxHardwareId=mIfNxHardwareId, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, UnsignedByte=UnsignedByte, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, InetIpAddress=InetIpAddress, UnsignedShort=UnsignedShort, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, FirmwareRevision=FirmwareRevision, InitStatus=InitStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLastChan=mIfNxLastChan, mIfNxAlarms=mIfNxAlarms, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxConfig=mIfNxConfig, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, DeviceModeType=DeviceModeType, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError)
