...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIB=mdsIfNxMIB, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatus=mIfNxStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxLastLqi=mIfNxLastLqi, InetIpAddress=InetIpAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, AlarmFlags=AlarmFlags, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusTable=mIfNxStatusTable, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxLastRssi=mIfNxLastRssi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, FirmwareRevision=FirmwareRevision, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, InitStatus=InitStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, ModemType=ModemType, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, LinkStatus=LinkStatus)
