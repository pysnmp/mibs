...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, ModemType=ModemType, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, FirmwareRevision=FirmwareRevision, mIfNxConfig=mIfNxConfig, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, LinkStatus=LinkStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxLastChan=mIfNxLastChan, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusGroup=mIfNxStatusGroup, UnsignedByte=UnsignedByte, InetIpAddress=InetIpAddress, mIfNxStatus=mIfNxStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, UnsignedShort=UnsignedShort, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mdsIfNxMIB=mdsIfNxMIB, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, InitStatus=InitStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxLinkStatus=mIfNxLinkStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxCurrentModem=mIfNxCurrentModem, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxHardwareId=mIfNxHardwareId)
