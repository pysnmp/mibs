...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, DeviceModeType=DeviceModeType, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxTemperature=mIfNxTemperature, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxActiveNic=mIfNxActiveNic, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, UnsignedByte=UnsignedByte, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, ModemType=ModemType, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, PYSNMP_MODULE_ID=mdsIfNxMIB, InitStatus=InitStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxAlarms=mIfNxAlarms, mIfNxConfig=mIfNxConfig, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, UnsignedShort=UnsignedShort, AlarmFlags=AlarmFlags, InetIpAddress=InetIpAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLastChan=mIfNxLastChan, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, LinkStatus=LinkStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxInitStatus=mIfNxInitStatus, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup)
