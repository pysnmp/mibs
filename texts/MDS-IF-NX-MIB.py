...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, LinkStatus=LinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, UnsignedShort=UnsignedShort, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, ModemType=ModemType, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxConfig=mIfNxConfig, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, AlarmFlags=AlarmFlags, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, FirmwareRevision=FirmwareRevision, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, InetIpAddress=InetIpAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxSerialNumber=mIfNxSerialNumber, InitStatus=InitStatus, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, DeviceModeType=DeviceModeType, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatus=mIfNxStatus, mdsIfNxMIB=mdsIfNxMIB, mdsIfNxMIBGroups=mdsIfNxMIBGroups)
