...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", InitStatus=InitStatus, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxHardwareRevision=mIfNxHardwareRevision, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, ModemType=ModemType, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, AlarmFlags=AlarmFlags, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, LinkStatus=LinkStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxFirmwareRevision=mIfNxFirmwareRevision, DeviceModeType=DeviceModeType, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, UnsignedByte=UnsignedByte, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatus=mIfNxStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mdsIfNxMIB=mdsIfNxMIB, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxTemperature=mIfNxTemperature, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxConfig=mIfNxConfig, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, UnsignedShort=UnsignedShort)
