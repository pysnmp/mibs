...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, InitStatus=InitStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, ModemType=ModemType, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, AlarmFlags=AlarmFlags, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, LinkStatus=LinkStatus, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, InetIpAddress=InetIpAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxApInfoApAddress=mIfNxApInfoApAddress, UnsignedShort=UnsignedShort, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxConfig=mIfNxConfig, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxAlarms=mIfNxAlarms, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxLastChan=mIfNxLastChan, UnsignedByte=UnsignedByte, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mdsIfNxMIBConformance=mdsIfNxMIBConformance, DeviceModeType=DeviceModeType)
