...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxLastLqi=mIfNxLastLqi, ModemType=ModemType, mdsIfNxMIB=mdsIfNxMIB, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, FirmwareRevision=FirmwareRevision, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, InitStatus=InitStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, UnsignedByte=UnsignedByte, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxLastRssi=mIfNxLastRssi, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, LinkStatus=LinkStatus, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatus=mIfNxStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, UnsignedShort=UnsignedShort, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi)
