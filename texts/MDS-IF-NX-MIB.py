...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxLastChan=mIfNxLastChan, mIfNxLastRssi=mIfNxLastRssi, mIfNxLinkStatus=mIfNxLinkStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, UnsignedByte=UnsignedByte, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxInitStatus=mIfNxInitStatus, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatus=mIfNxStatus, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, UnsignedShort=UnsignedShort, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, ModemType=ModemType, FirmwareRevision=FirmwareRevision, InetIpAddress=InetIpAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, InitStatus=InitStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop)
