...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, UnsignedShort=UnsignedShort, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, DeviceModeType=DeviceModeType, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, LinkStatus=LinkStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxLastRssi=mIfNxLastRssi, mIfNxInitStatus=mIfNxInitStatus, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxConfig=mIfNxConfig, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxAlarms=mIfNxAlarms, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, ModemType=ModemType, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mdsIfNxMIB=mdsIfNxMIB, InitStatus=InitStatus, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, InetIpAddress=InetIpAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB)
