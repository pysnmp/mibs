...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxInitStatus=mIfNxInitStatus, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, InitStatus=InitStatus, DeviceModeType=DeviceModeType, UnsignedShort=UnsignedShort, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxAlarms=mIfNxAlarms, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, ModemType=ModemType, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, AlarmFlags=AlarmFlags, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxCompliance=mIfNxCompliance, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxSerialNumber=mIfNxSerialNumber, LinkStatus=LinkStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, FirmwareRevision=FirmwareRevision, UnsignedByte=UnsignedByte, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull)
