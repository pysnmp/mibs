...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, InetIpAddress=InetIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusTable=mIfNxStatusTable, mIfNxLastRssi=mIfNxLastRssi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, UnsignedShort=UnsignedShort, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxActiveNic=mIfNxActiveNic, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, FirmwareRevision=FirmwareRevision, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusGroup=mIfNxStatusGroup, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatus=mIfNxStatus, ModemType=ModemType, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, InitStatus=InitStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, PYSNMP_MODULE_ID=mdsIfNxMIB)
