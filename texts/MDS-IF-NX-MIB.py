...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, LinkStatus=LinkStatus, mIfNxLastLqi=mIfNxLastLqi, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, ModemType=ModemType, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, AlarmFlags=AlarmFlags, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxAlarms=mIfNxAlarms, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, FirmwareRevision=FirmwareRevision, mIfNxStatusTable=mIfNxStatusTable, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, InitStatus=InitStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLastChan=mIfNxLastChan, UnsignedShort=UnsignedShort, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, UnsignedByte=UnsignedByte, mIfNxHardwareId=mIfNxHardwareId, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress)
