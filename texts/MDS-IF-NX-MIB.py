...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusGroup=mIfNxStatusGroup, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, DeviceModeType=DeviceModeType, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxCompliance=mIfNxCompliance, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, InetIpAddress=InetIpAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxInitStatus=mIfNxInitStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, LinkStatus=LinkStatus, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatus=mIfNxStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, InitStatus=InitStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mdsIfNxMIBGroups=mdsIfNxMIBGroups, ModemType=ModemType, mdsIfNxMIB=mdsIfNxMIB, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, UnsignedShort=UnsignedShort, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, UnsignedByte=UnsignedByte, AlarmFlags=AlarmFlags, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxSerialNumber=mIfNxSerialNumber, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxHardwareId=mIfNxHardwareId, mIfNxConfig=mIfNxConfig, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry)
