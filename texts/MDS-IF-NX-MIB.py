...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatus=mIfNxStatus, mIfNxTemperature=mIfNxTemperature, InitStatus=InitStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoApAddress=mIfNxApInfoApAddress, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, DeviceModeType=DeviceModeType, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, ModemType=ModemType, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, UnsignedByte=UnsignedByte, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusTable=mIfNxStatusTable)
