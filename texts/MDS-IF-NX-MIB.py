...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxAlarms=mIfNxAlarms, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, LinkStatus=LinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, UnsignedByte=UnsignedByte, mIfNxStatusActChanTable=mIfNxStatusActChanTable, InitStatus=InitStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, ModemType=ModemType, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, AlarmFlags=AlarmFlags, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatus=mIfNxStatus, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxTemperature=mIfNxTemperature, mIfNxCompliance=mIfNxCompliance, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mdsIfNxMIBGroups=mdsIfNxMIBGroups)
