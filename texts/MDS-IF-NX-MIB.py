...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, DeviceModeType=DeviceModeType, ModemType=ModemType, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEntry=mIfNxStatusEntry, AlarmFlags=AlarmFlags, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, PYSNMP_MODULE_ID=mdsIfNxMIB, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, UnsignedShort=UnsignedShort, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIB=mdsIfNxMIB, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, LinkStatus=LinkStatus, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, UnsignedByte=UnsignedByte, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatus=mIfNxStatus, mIfNxConfig=mIfNxConfig, InitStatus=InitStatus, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets)
