...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, InitStatus=InitStatus, mIfNxHardwareId=mIfNxHardwareId, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, FirmwareRevision=FirmwareRevision, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, DeviceModeType=DeviceModeType, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, ModemType=ModemType, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, LinkStatus=LinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxSerialNumber=mIfNxSerialNumber, mdsIfNxMIBGroups=mdsIfNxMIBGroups, UnsignedShort=UnsignedShort, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLastChan=mIfNxLastChan, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxCompliance=mIfNxCompliance, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, InetIpAddress=InetIpAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxLastLqi=mIfNxLastLqi)
