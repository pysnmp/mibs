...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxLastLqi=mIfNxLastLqi, mIfNxAlarms=mIfNxAlarms, mIfNxStatus=mIfNxStatus, UnsignedByte=UnsignedByte, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, ModemType=ModemType, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEntry=mIfNxStatusEntry, InitStatus=InitStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, LinkStatus=LinkStatus, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, AlarmFlags=AlarmFlags, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mdsIfNxMIB=mdsIfNxMIB, mIfNxTemperature=mIfNxTemperature, mdsIfNxMIBConformance=mdsIfNxMIBConformance, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, InetIpAddress=InetIpAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, DeviceModeType=DeviceModeType, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes)
