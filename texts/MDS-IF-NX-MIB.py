...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, LinkStatus=LinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, FirmwareRevision=FirmwareRevision, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxLastLqi=mIfNxLastLqi, InitStatus=InitStatus, mIfNxInitStatus=mIfNxInitStatus, DeviceModeType=DeviceModeType, ModemType=ModemType, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, UnsignedShort=UnsignedShort, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mdsIfNxMIB=mdsIfNxMIB, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxLastChan=mIfNxLastChan, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusTable=mIfNxStatusTable, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop)
