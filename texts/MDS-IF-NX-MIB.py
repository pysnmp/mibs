...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, AlarmFlags=AlarmFlags, ModemType=ModemType, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, InitStatus=InitStatus, mIfNxAlarms=mIfNxAlarms, FirmwareRevision=FirmwareRevision, InetIpAddress=InetIpAddress, mIfNxMIBObjects=mIfNxMIBObjects, UnsignedByte=UnsignedByte, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, LinkStatus=LinkStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, UnsignedShort=UnsignedShort, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, DeviceModeType=DeviceModeType, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatus=mIfNxStatus, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxHardwareId=mIfNxHardwareId)
