...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", AlarmFlags=AlarmFlags, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxHardwareId=mIfNxHardwareId, DeviceModeType=DeviceModeType, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusGroup=mIfNxStatusGroup, FirmwareRevision=FirmwareRevision, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxConfig=mIfNxConfig, LinkStatus=LinkStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, InitStatus=InitStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mdsIfNxMIB=mdsIfNxMIB, UnsignedByte=UnsignedByte, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusTable=mIfNxStatusTable, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, UnsignedShort=UnsignedShort, mIfNxMIBObjects=mIfNxMIBObjects, ModemType=ModemType, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi)
