...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, DeviceModeType=DeviceModeType, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxConfig=mIfNxConfig, InitStatus=InitStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMIBObjects=mIfNxMIBObjects, AlarmFlags=AlarmFlags, ModemType=ModemType, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, UnsignedShort=UnsignedShort, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusTable=mIfNxStatusTable, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatus=mIfNxStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, InetIpAddress=InetIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxActiveNic=mIfNxActiveNic, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, LinkStatus=LinkStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable)
