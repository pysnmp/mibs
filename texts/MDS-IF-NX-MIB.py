...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxConfig=mIfNxConfig, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, LinkStatus=LinkStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, DeviceModeType=DeviceModeType, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, ModemType=ModemType, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxLastRssi=mIfNxLastRssi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusGroup=mIfNxStatusGroup, UnsignedShort=UnsignedShort, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxInitStatus=mIfNxInitStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, InitStatus=InitStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxError=mIfNxMacStatsTxError)
