...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanTable=mIfNxStatusActChanTable, LinkStatus=LinkStatus, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxLastLqi=mIfNxLastLqi, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxActiveNic=mIfNxActiveNic, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxSerialNumber=mIfNxSerialNumber, UnsignedByte=UnsignedByte, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, InitStatus=InitStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxTemperature=mIfNxTemperature, mIfNxCompliance=mIfNxCompliance, ModemType=ModemType, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, InetIpAddress=InetIpAddress, mIfNxLinkStatus=mIfNxLinkStatus)
