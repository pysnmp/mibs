...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusTable=mIfNxStatusTable, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, FirmwareRevision=FirmwareRevision, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxConfig=mIfNxConfig, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLastRssi=mIfNxLastRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, InitStatus=InitStatus, DeviceModeType=DeviceModeType, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, InetIpAddress=InetIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, PYSNMP_MODULE_ID=mdsIfNxMIB, AlarmFlags=AlarmFlags, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, ModemType=ModemType, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, UnsignedByte=UnsignedByte, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup)
