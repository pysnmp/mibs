...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", UnsignedByte=UnsignedByte, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMIBObjects=mIfNxMIBObjects, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusTable=mIfNxStatusTable, UnsignedShort=UnsignedShort, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, InitStatus=InitStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxCompliance=mIfNxCompliance, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEntry=mIfNxStatusEntry, DeviceModeType=DeviceModeType, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, InetIpAddress=InetIpAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, ModemType=ModemType, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, LinkStatus=LinkStatus, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable)
