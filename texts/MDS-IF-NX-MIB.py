...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxLastChan=mIfNxLastChan, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, DeviceModeType=DeviceModeType, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxCurrentModem=mIfNxCurrentModem, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, ModemType=ModemType, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mdsIfNxMIB=mdsIfNxMIB, mIfNxConfig=mIfNxConfig, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, FirmwareRevision=FirmwareRevision, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMIBObjects=mIfNxMIBObjects, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxAlarms=mIfNxAlarms, InitStatus=InitStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, UnsignedShort=UnsignedShort, mIfNxTemperature=mIfNxTemperature, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxCompliance=mIfNxCompliance, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, UnsignedByte=UnsignedByte, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi)
