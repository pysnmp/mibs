...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxTemperature=mIfNxTemperature, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusTable=mIfNxStatusTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxLastRssi=mIfNxLastRssi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, InetIpAddress=InetIpAddress, UnsignedShort=UnsignedShort, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxHardwareId=mIfNxHardwareId, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, InitStatus=InitStatus, mIfNxLinkStatus=mIfNxLinkStatus, DeviceModeType=DeviceModeType, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxCompliance=mIfNxCompliance, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxInitStatus=mIfNxInitStatus, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, ModemType=ModemType, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError)
