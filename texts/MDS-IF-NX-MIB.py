...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, LinkStatus=LinkStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mdsIfNxMIB=mdsIfNxMIB, DeviceModeType=DeviceModeType, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxInitStatus=mIfNxInitStatus, AlarmFlags=AlarmFlags, UnsignedShort=UnsignedShort, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxActiveNic=mIfNxActiveNic, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusTable=mIfNxStatusTable, mIfNxAlarms=mIfNxAlarms, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, InitStatus=InitStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, ModemType=ModemType, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxCurrentModem=mIfNxCurrentModem, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatus=mIfNxStatus, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBConformance=mdsIfNxMIBConformance, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress)
