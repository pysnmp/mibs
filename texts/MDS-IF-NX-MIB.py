...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxSerialNumber=mIfNxSerialNumber, UnsignedShort=UnsignedShort, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMIBObjects=mIfNxMIBObjects, LinkStatus=LinkStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, UnsignedByte=UnsignedByte, mIfNxApInfoApAddress=mIfNxApInfoApAddress, InetIpAddress=InetIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, InitStatus=InitStatus, mIfNxConfig=mIfNxConfig, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, AlarmFlags=AlarmFlags, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, ModemType=ModemType, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxCompliance=mIfNxCompliance, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxLastLqi=mIfNxLastLqi)
