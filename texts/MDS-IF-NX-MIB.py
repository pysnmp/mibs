...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxHardwareId=mIfNxHardwareId, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, DeviceModeType=DeviceModeType, mdsIfNxMIB=mdsIfNxMIB, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mdsIfNxMIBGroups=mdsIfNxMIBGroups, InitStatus=InitStatus, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, ModemType=ModemType, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, UnsignedShort=UnsignedShort, FirmwareRevision=FirmwareRevision, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, AlarmFlags=AlarmFlags, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxActiveNic=mIfNxActiveNic, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, PYSNMP_MODULE_ID=mdsIfNxMIB)
