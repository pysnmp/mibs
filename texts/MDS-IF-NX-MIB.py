...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoApAddress=mIfNxApInfoApAddress, ModemType=ModemType, DeviceModeType=DeviceModeType, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxConfig=mIfNxConfig, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxLinkStatus=mIfNxLinkStatus, InetIpAddress=InetIpAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxTemperature=mIfNxTemperature, InitStatus=InitStatus, mIfNxInitStatus=mIfNxInitStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mdsIfNxMIB=mdsIfNxMIB, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, UnsignedByte=UnsignedByte, UnsignedShort=UnsignedShort, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mdsIfNxMIBGroups=mdsIfNxMIBGroups, LinkStatus=LinkStatus, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxLastRssi=mIfNxLastRssi)
