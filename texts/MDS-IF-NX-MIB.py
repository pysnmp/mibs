...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, UnsignedShort=UnsignedShort, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, UnsignedByte=UnsignedByte, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, ModemType=ModemType, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, InetIpAddress=InetIpAddress, mdsIfNxMIB=mdsIfNxMIB, InitStatus=InitStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, AlarmFlags=AlarmFlags, PYSNMP_MODULE_ID=mdsIfNxMIB, DeviceModeType=DeviceModeType, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxLastLqi=mIfNxLastLqi, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxActiveNic=mIfNxActiveNic, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess)
