...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, ModemType=ModemType, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, DeviceModeType=DeviceModeType, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusTable=mIfNxStatusTable, mIfNxInitStatus=mIfNxInitStatus, InetIpAddress=InetIpAddress, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxLastLqi=mIfNxLastLqi, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxAlarms=mIfNxAlarms, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxHardwareId=mIfNxHardwareId, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, AlarmFlags=AlarmFlags, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, InitStatus=InitStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxSerialNumber=mIfNxSerialNumber)
