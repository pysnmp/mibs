...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxLastLqi=mIfNxLastLqi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxCompliance=mIfNxCompliance, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, LinkStatus=LinkStatus, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, DeviceModeType=DeviceModeType, UnsignedByte=UnsignedByte, FirmwareRevision=FirmwareRevision, mIfNxAlarms=mIfNxAlarms, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatus=mIfNxStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, ModemType=ModemType, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxConfig=mIfNxConfig, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, InetIpAddress=InetIpAddress, InitStatus=InitStatus, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop)
