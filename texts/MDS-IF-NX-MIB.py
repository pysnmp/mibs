...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxConfig=mIfNxConfig, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, AlarmFlags=AlarmFlags, UnsignedShort=UnsignedShort, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLastChan=mIfNxLastChan, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxSerialNumber=mIfNxSerialNumber, DeviceModeType=DeviceModeType, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, InitStatus=InitStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatus=mIfNxStatus, InetIpAddress=InetIpAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedByte=UnsignedByte, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxCompliance=mIfNxCompliance, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxHardwareId=mIfNxHardwareId, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, ModemType=ModemType, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress)
