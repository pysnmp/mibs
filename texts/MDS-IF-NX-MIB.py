...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, ModemType=ModemType, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, AlarmFlags=AlarmFlags, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, UnsignedByte=UnsignedByte, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxLastChan=mIfNxLastChan, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, LinkStatus=LinkStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, FirmwareRevision=FirmwareRevision, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, DeviceModeType=DeviceModeType, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, UnsignedShort=UnsignedShort, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxLastRssi=mIfNxLastRssi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatus=mIfNxStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, InitStatus=InitStatus, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress)
