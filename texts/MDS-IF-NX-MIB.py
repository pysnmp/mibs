...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxInitStatus=mIfNxInitStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, ModemType=ModemType, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxSerialNumber=mIfNxSerialNumber, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, InitStatus=InitStatus, mIfNxHardwareId=mIfNxHardwareId, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, DeviceModeType=DeviceModeType, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxLinkStatus=mIfNxLinkStatus, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxConfig=mIfNxConfig, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, AlarmFlags=AlarmFlags, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxLastRssi=mIfNxLastRssi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxAlarms=mIfNxAlarms, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mdsIfNxMIBGroups=mdsIfNxMIBGroups, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange)
