...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, FirmwareRevision=FirmwareRevision, ModemType=ModemType, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, LinkStatus=LinkStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxAlarms=mIfNxAlarms, mIfNxConfig=mIfNxConfig, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCompliance=mIfNxCompliance, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, DeviceModeType=DeviceModeType, mdsIfNxMIB=mdsIfNxMIB, UnsignedByte=UnsignedByte, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxActiveNic=mIfNxActiveNic, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, InitStatus=InitStatus, UnsignedShort=UnsignedShort, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError)
