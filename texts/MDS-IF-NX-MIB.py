...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxHardwareRevision=mIfNxHardwareRevision, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusGroup=mIfNxStatusGroup, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, InitStatus=InitStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxConfig=mIfNxConfig, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxAlarms=mIfNxAlarms, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, PYSNMP_MODULE_ID=mdsIfNxMIB, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, DeviceModeType=DeviceModeType, ModemType=ModemType, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, InetIpAddress=InetIpAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatus=mIfNxStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi)
