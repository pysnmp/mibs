...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMIBObjects=mIfNxMIBObjects, mdsIfNxMIBGroups=mdsIfNxMIBGroups, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, DeviceModeType=DeviceModeType, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, ModemType=ModemType, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxError=mIfNxMacStatsTxError, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, InitStatus=InitStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, AlarmFlags=AlarmFlags, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatus=mIfNxStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, LinkStatus=LinkStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxConfig=mIfNxConfig)
