...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxTemperature=mIfNxTemperature, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, AlarmFlags=AlarmFlags, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxHardwareId=mIfNxHardwareId, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, InitStatus=InitStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxSerialNumber=mIfNxSerialNumber, LinkStatus=LinkStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, ModemType=ModemType, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxCompliance=mIfNxCompliance, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, InetIpAddress=InetIpAddress, mIfNxLastChan=mIfNxLastChan, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, UnsignedShort=UnsignedShort, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry)
