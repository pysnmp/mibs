...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxCompliance=mIfNxCompliance, ModemType=ModemType, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, DeviceModeType=DeviceModeType, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, InitStatus=InitStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusTable=mIfNxStatusTable, mIfNxAlarms=mIfNxAlarms, FirmwareRevision=FirmwareRevision, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, UnsignedByte=UnsignedByte, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, AlarmFlags=AlarmFlags, mIfNxConfig=mIfNxConfig)
