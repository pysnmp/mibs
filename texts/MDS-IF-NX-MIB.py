...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxLastRssi=mIfNxLastRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, InitStatus=InitStatus, mIfNxInitStatus=mIfNxInitStatus, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, ModemType=ModemType, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxConfig=mIfNxConfig, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, InetIpAddress=InetIpAddress, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxLinkStatus=mIfNxLinkStatus, LinkStatus=LinkStatus, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatus=mIfNxStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedByte=UnsignedByte, DeviceModeType=DeviceModeType, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, FirmwareRevision=FirmwareRevision, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, UnsignedShort=UnsignedShort, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, AlarmFlags=AlarmFlags, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail)
