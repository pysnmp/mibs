...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, LinkStatus=LinkStatus, UnsignedByte=UnsignedByte, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxActiveNic=mIfNxActiveNic, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, ModemType=ModemType, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLastLqi=mIfNxLastLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxLastRssi=mIfNxLastRssi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, InitStatus=InitStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusGroup=mIfNxStatusGroup, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusTable=mIfNxStatusTable, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxTemperature=mIfNxTemperature, mIfNxHardwareId=mIfNxHardwareId, DeviceModeType=DeviceModeType, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxConfig=mIfNxConfig, mIfNxStatusActChanTable=mIfNxStatusActChanTable, InetIpAddress=InetIpAddress)
