...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxTemperature=mIfNxTemperature, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, InetIpAddress=InetIpAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxConfig=mIfNxConfig, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxLastChan=mIfNxLastChan, mIfNxLastLqi=mIfNxLastLqi, UnsignedShort=UnsignedShort, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, LinkStatus=LinkStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, FirmwareRevision=FirmwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, ModemType=ModemType, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, DeviceModeType=DeviceModeType, InitStatus=InitStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed)
