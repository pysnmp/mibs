...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxConfig=mIfNxConfig, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, UnsignedShort=UnsignedShort, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, InitStatus=InitStatus, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, UnsignedByte=UnsignedByte, mIfNxAlarms=mIfNxAlarms, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxLastLqi=mIfNxLastLqi, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, DeviceModeType=DeviceModeType, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, ModemType=ModemType, mIfNxStatusTable=mIfNxStatusTable, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatus=mIfNxStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, LinkStatus=LinkStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxCompliance=mIfNxCompliance, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi)
