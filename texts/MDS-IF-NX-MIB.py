...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, AlarmFlags=AlarmFlags, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, FirmwareRevision=FirmwareRevision, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, UnsignedByte=UnsignedByte, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxConfig=mIfNxConfig, mIfNxTemperature=mIfNxTemperature, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, DeviceModeType=DeviceModeType, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxCompliance=mIfNxCompliance, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, ModemType=ModemType, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, LinkStatus=LinkStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mdsIfNxMIB=mdsIfNxMIB, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusTable=mIfNxStatusTable, InetIpAddress=InetIpAddress, mIfNxStatus=mIfNxStatus, InitStatus=InitStatus, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEntry=mIfNxStatusEntry, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLastLqi=mIfNxLastLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxHardwareId=mIfNxHardwareId)
