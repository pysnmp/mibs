...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxCompliance=mIfNxCompliance, mIfNxMIBObjects=mIfNxMIBObjects, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, InitStatus=InitStatus, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, ModemType=ModemType, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, UnsignedByte=UnsignedByte, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, DeviceModeType=DeviceModeType, AlarmFlags=AlarmFlags, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, LinkStatus=LinkStatus, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatus=mIfNxStatus, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxLastChan=mIfNxLastChan, mIfNxAlarms=mIfNxAlarms, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, UnsignedShort=UnsignedShort, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry)
