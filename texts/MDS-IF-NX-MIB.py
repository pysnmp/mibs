...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxAlarms=mIfNxAlarms, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, DeviceModeType=DeviceModeType, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, AlarmFlags=AlarmFlags, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, InitStatus=InitStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxLastChan=mIfNxLastChan, mIfNxCompliance=mIfNxCompliance, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusGroup=mIfNxStatusGroup, UnsignedShort=UnsignedShort, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, ModemType=ModemType, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, InetIpAddress=InetIpAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, FirmwareRevision=FirmwareRevision, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode)
