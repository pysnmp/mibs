...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, LinkStatus=LinkStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatus=mIfNxStatus, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, FirmwareRevision=FirmwareRevision, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxConfig=mIfNxConfig, mIfNxLastChan=mIfNxLastChan, UnsignedByte=UnsignedByte, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, ModemType=ModemType, mIfNxMIBObjects=mIfNxMIBObjects, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxCompliance=mIfNxCompliance, InetIpAddress=InetIpAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, DeviceModeType=DeviceModeType, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, AlarmFlags=AlarmFlags, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, InitStatus=InitStatus)
