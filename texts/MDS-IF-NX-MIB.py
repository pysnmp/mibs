...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatus=mIfNxStatus, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, FirmwareRevision=FirmwareRevision, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, UnsignedShort=UnsignedShort, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, UnsignedByte=UnsignedByte, mIfNxCurrentModem=mIfNxCurrentModem, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, LinkStatus=LinkStatus, AlarmFlags=AlarmFlags, mIfNxAlarms=mIfNxAlarms, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, DeviceModeType=DeviceModeType, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, InetIpAddress=InetIpAddress, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxSerialNumber=mIfNxSerialNumber, ModemType=ModemType, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxLastChan=mIfNxLastChan, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, InitStatus=InitStatus, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc)
