...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, AlarmFlags=AlarmFlags, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, DeviceModeType=DeviceModeType, UnsignedByte=UnsignedByte, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxHardwareId=mIfNxHardwareId, mIfNxConfig=mIfNxConfig, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxLastRssi=mIfNxLastRssi, mIfNxInitStatus=mIfNxInitStatus, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusTable=mIfNxStatusTable, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, InitStatus=InitStatus, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatus=mIfNxStatus, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, InetIpAddress=InetIpAddress, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, ModemType=ModemType, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxAlarms=mIfNxAlarms, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mdsIfNxMIB=mdsIfNxMIB, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLinkStatus=mIfNxLinkStatus, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError)
