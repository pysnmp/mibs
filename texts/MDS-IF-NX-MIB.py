...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, LinkStatus=LinkStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, InetIpAddress=InetIpAddress, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, DeviceModeType=DeviceModeType, PYSNMP_MODULE_ID=mdsIfNxMIB, AlarmFlags=AlarmFlags, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatus=mIfNxStatus, mIfNxInitStatus=mIfNxInitStatus, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxTemperature=mIfNxTemperature, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, UnsignedByte=UnsignedByte, mIfNxMIBObjects=mIfNxMIBObjects, InitStatus=InitStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, UnsignedShort=UnsignedShort, ModemType=ModemType, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxCompliance=mIfNxCompliance)
