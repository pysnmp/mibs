...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxLastChan=mIfNxLastChan, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, FirmwareRevision=FirmwareRevision, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, LinkStatus=LinkStatus, UnsignedShort=UnsignedShort, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxCompliance=mIfNxCompliance, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxHardwareRevision=mIfNxHardwareRevision, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMIBObjects=mIfNxMIBObjects, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusTable=mIfNxStatusTable, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, ModemType=ModemType, AlarmFlags=AlarmFlags, InetIpAddress=InetIpAddress, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxAlarms=mIfNxAlarms, InitStatus=InitStatus, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange)
