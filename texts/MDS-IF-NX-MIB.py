...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxInitStatus=mIfNxInitStatus, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, LinkStatus=LinkStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxLastRssi=mIfNxLastRssi, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanTable=mIfNxStatusActChanTable, DeviceModeType=DeviceModeType, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxTemperature=mIfNxTemperature, mIfNxActiveNic=mIfNxActiveNic, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxCompliance=mIfNxCompliance, AlarmFlags=AlarmFlags, InetIpAddress=InetIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoApAddress=mIfNxApInfoApAddress, UnsignedShort=UnsignedShort, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, ModemType=ModemType, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, FirmwareRevision=FirmwareRevision, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, InitStatus=InitStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion)
