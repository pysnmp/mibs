...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxInitStatus=mIfNxInitStatus, AlarmFlags=AlarmFlags, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, UnsignedByte=UnsignedByte, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, InitStatus=InitStatus, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, FirmwareRevision=FirmwareRevision, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, ModemType=ModemType, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxActiveNic=mIfNxActiveNic, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, UnsignedShort=UnsignedShort, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMIBObjects=mIfNxMIBObjects, LinkStatus=LinkStatus, InetIpAddress=InetIpAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mdsIfNxMIBConformance=mdsIfNxMIBConformance, DeviceModeType=DeviceModeType, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable)
