...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxConfig=mIfNxConfig, mIfNxMIBObjects=mIfNxMIBObjects, PYSNMP_MODULE_ID=mdsIfNxMIB, UnsignedByte=UnsignedByte, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxLinkStatus=mIfNxLinkStatus, InetIpAddress=InetIpAddress, LinkStatus=LinkStatus, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxAlarms=mIfNxAlarms, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, FirmwareRevision=FirmwareRevision, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxLastChan=mIfNxLastChan, DeviceModeType=DeviceModeType, ModemType=ModemType, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, InitStatus=InitStatus, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, AlarmFlags=AlarmFlags, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, UnsignedShort=UnsignedShort, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxCompliance=mIfNxCompliance, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive)
