...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, UnsignedByte=UnsignedByte, mIfNxLastRssi=mIfNxLastRssi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, ModemType=ModemType, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, InitStatus=InitStatus, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusActChanTable=mIfNxStatusActChanTable, FirmwareRevision=FirmwareRevision, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, LinkStatus=LinkStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxConfig=mIfNxConfig, AlarmFlags=AlarmFlags, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, InetIpAddress=InetIpAddress, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxLastLqi=mIfNxLastLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatus=mIfNxStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIB=mdsIfNxMIB, mIfNxTemperature=mIfNxTemperature, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxAlarms=mIfNxAlarms)
