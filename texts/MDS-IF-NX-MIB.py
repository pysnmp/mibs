...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, FirmwareRevision=FirmwareRevision, mIfNxStatusTable=mIfNxStatusTable, InitStatus=InitStatus, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, InetIpAddress=InetIpAddress, ModemType=ModemType, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxConfig=mIfNxConfig, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxLastLqi=mIfNxLastLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, AlarmFlags=AlarmFlags, mIfNxTemperature=mIfNxTemperature, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, DeviceModeType=DeviceModeType, mIfNxLastChan=mIfNxLastChan, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxAlarms=mIfNxAlarms, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxMIBObjects=mIfNxMIBObjects, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mdsIfNxMIB=mdsIfNxMIB, mIfNxCurrentModem=mIfNxCurrentModem, LinkStatus=LinkStatus, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxInitStatus=mIfNxInitStatus, mIfNxStatus=mIfNxStatus, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxLastRssi=mIfNxLastRssi, UnsignedShort=UnsignedShort)
