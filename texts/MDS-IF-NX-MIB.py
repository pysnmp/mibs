...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", UnsignedShort=UnsignedShort, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusTable=mIfNxStatusTable, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxLastChan=mIfNxLastChan, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxHardwareId=mIfNxHardwareId, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxLastLqi=mIfNxLastLqi, mIfNxTemperature=mIfNxTemperature, mIfNxLastRssi=mIfNxLastRssi, mIfNxInitStatus=mIfNxInitStatus, mIfNxAlarms=mIfNxAlarms, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, LinkStatus=LinkStatus, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, UnsignedByte=UnsignedByte, FirmwareRevision=FirmwareRevision, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, AlarmFlags=AlarmFlags, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, InitStatus=InitStatus, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, DeviceModeType=DeviceModeType, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, ModemType=ModemType, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxCompliance=mIfNxCompliance, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxConfig=mIfNxConfig, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc)
