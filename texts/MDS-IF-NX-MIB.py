...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxConfig=mIfNxConfig, UnsignedShort=UnsignedShort, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, AlarmFlags=AlarmFlags, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, DeviceModeType=DeviceModeType, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, UnsignedByte=UnsignedByte, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxAlarms=mIfNxAlarms, mIfNxHardwareRevision=mIfNxHardwareRevision, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxInitStatus=mIfNxInitStatus, LinkStatus=LinkStatus, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mdsIfNxMIBConformance=mdsIfNxMIBConformance, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, FirmwareRevision=FirmwareRevision, mIfNxTemperature=mIfNxTemperature, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mdsIfNxMIB=mdsIfNxMIB, InitStatus=InitStatus, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxLastChan=mIfNxLastChan, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, InetIpAddress=InetIpAddress, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, ModemType=ModemType, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive)
