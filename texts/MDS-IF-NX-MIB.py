...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mdsIfNxMIBGroups=mdsIfNxMIBGroups, DeviceModeType=DeviceModeType, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mIfNxLastRssi=mIfNxLastRssi, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mdsIfNxMIB=mdsIfNxMIB, mIfNxMacStatsTxError=mIfNxMacStatsTxError, InetIpAddress=InetIpAddress, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxInitStatus=mIfNxInitStatus, mIfNxAlarms=mIfNxAlarms, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxTemperature=mIfNxTemperature, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, UnsignedShort=UnsignedShort, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, InitStatus=InitStatus, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, ModemType=ModemType, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, FirmwareRevision=FirmwareRevision, mIfNxStatus=mIfNxStatus, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxCompliance=mIfNxCompliance, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, UnsignedByte=UnsignedByte, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxStatusGroup=mIfNxStatusGroup, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxActiveNic=mIfNxActiveNic, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxLastChan=mIfNxLastChan, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxLastLqi=mIfNxLastLqi, mIfNxLinkStatus=mIfNxLinkStatus, LinkStatus=LinkStatus, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxConfig=mIfNxConfig, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxHardwareRevision=mIfNxHardwareRevision)
