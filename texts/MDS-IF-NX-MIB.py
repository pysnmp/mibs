...
mibBuilder.exportSymbols("MDS-IF-NX-MIB", mIfNxTemperature=mIfNxTemperature, mIfNxMacStatsTxSuccess=mIfNxMacStatsTxSuccess, mIfNxStatusConnRemStatsRxDrop=mIfNxStatusConnRemStatsRxDrop, mIfNxStatusEndpointStatsRxError=mIfNxStatusEndpointStatsRxError, mIfNxStatusGroup=mIfNxStatusGroup, ModemType=ModemType, mIfNxStatusEndpointStatsTxError=mIfNxStatusEndpointStatsTxError, mIfNxFirmwareRevision=mIfNxFirmwareRevision, mdsIfNxMIBCompliances=mdsIfNxMIBCompliances, mIfNxStatusEndpointStatsTxDrop=mIfNxStatusEndpointStatsTxDrop, mIfNxStatusEndpointIpAddress=mIfNxStatusEndpointIpAddress, mIfNxStatusConnRemStatsAlarmed=mIfNxStatusConnRemStatsAlarmed, mIfNxStatusConnRemAvgLqi=mIfNxStatusConnRemAvgLqi, mIfNxMacStatsTxFail=mIfNxMacStatsTxFail, mIfNxStatusConnRemTimeToLive=mIfNxStatusConnRemTimeToLive, AlarmFlags=AlarmFlags, mIfNxStatusEndpointStatsRxPackets=mIfNxStatusEndpointStatsRxPackets, mIfNxStatusEndpointAddress=mIfNxStatusEndpointAddress, InetIpAddress=InetIpAddress, mIfNxStatusConnRemLinkStatus=mIfNxStatusConnRemLinkStatus, mIfNxLinkStatus=mIfNxLinkStatus, mIfNxStatusTable=mIfNxStatusTable, mIfNxStatusConnRemStatsTxPackets=mIfNxStatusConnRemStatsTxPackets, mIfNxStatusActChanGroup=mIfNxStatusActChanGroup, mIfNxStatusActChanEntry=mIfNxStatusActChanEntry, mIfNxSerialNumber=mIfNxSerialNumber, mIfNxStatusActChanFrequency=mIfNxStatusActChanFrequency, mIfNxHardwareRevision=mIfNxHardwareRevision, mIfNxMacStatsRxSuccess=mIfNxMacStatsRxSuccess, FirmwareRevision=FirmwareRevision, mIfNxApInfoAvgRssi=mIfNxApInfoAvgRssi, mIfNxCurrentDeviceMode=mIfNxCurrentDeviceMode, mIfNxStatusConnRemTable=mIfNxStatusConnRemTable, mIfNxActiveNic=mIfNxActiveNic, mIfNxStatusConnRemStatsDwnLqi=mIfNxStatusConnRemStatsDwnLqi, mIfNxStatusConnRemStatsRxPackets=mIfNxStatusConnRemStatsRxPackets, mIfNxStatusConnRemStatsTxBytes=mIfNxStatusConnRemStatsTxBytes, mIfNxStatusActChanChannel=mIfNxStatusActChanChannel, mIfNxStatusEndpointStatsRxDrop=mIfNxStatusEndpointStatsRxDrop, UnsignedByte=UnsignedByte, mIfNxStatusConnRemStatsName=mIfNxStatusConnRemStatsName, mIfNxStatusEndpointEntry=mIfNxStatusEndpointEntry, mIfNxStatusEndpointStatsTxBytes=mIfNxStatusEndpointStatsTxBytes, mIfNxMIBObjects=mIfNxMIBObjects, mIfNxStatusConnRemStatsRxError=mIfNxStatusConnRemStatsRxError, InitStatus=InitStatus, mIfNxStatusEndpointGroup=mIfNxStatusEndpointGroup, mIfNxStatusConnRemStatsTemp=mIfNxStatusConnRemStatsTemp, mIfNxLastRssi=mIfNxLastRssi, mIfNxMacStatsSyncChange=mIfNxMacStatsSyncChange, mdsIfNxMIBConformance=mdsIfNxMIBConformance, mIfNxStatusConnRemEntry=mIfNxStatusConnRemEntry, mIfNxStatusEndpointTable=mIfNxStatusEndpointTable, mIfNxLastChan=mIfNxLastChan, mIfNxAlarms=mIfNxAlarms, mIfNxStatusConnRemStatsAllIp=mIfNxStatusConnRemStatsAllIp, mIfNxApInfoApAddress=mIfNxApInfoApAddress, mIfNxInitStatus=mIfNxInitStatus, mIfNxMacStatsTxQueueFull=mIfNxMacStatsTxQueueFull, mIfNxStatusConnRemIpAddress=mIfNxStatusConnRemIpAddress, mIfNxStatusActChanAvgLqi=mIfNxStatusActChanAvgLqi, mIfNxConfig=mIfNxConfig, mIfNxApInfoIpAddress=mIfNxApInfoIpAddress, mIfNxStatusConnRemStatsDwnSnr=mIfNxStatusConnRemStatsDwnSnr, DeviceModeType=DeviceModeType, mIfNxStatusEndpointRemAddress=mIfNxStatusEndpointRemAddress, mIfNxStatusConnRemGroup=mIfNxStatusConnRemGroup, mIfNxCurrentModem=mIfNxCurrentModem, mIfNxMacStatsTxError=mIfNxMacStatsTxError, mIfNxMacStatsTxRetry=mIfNxMacStatsTxRetry, mdsIfNxMIBGroups=mdsIfNxMIBGroups, mdsIfNxMIB=mdsIfNxMIB, mIfNxStatusActChanAvgRssi=mIfNxStatusActChanAvgRssi, mIfNxStatusConnRemStatsTxDrop=mIfNxStatusConnRemStatsTxDrop, mIfNxHardwareId=mIfNxHardwareId, mIfNxStatusConnRemStatsDwnRssi=mIfNxStatusConnRemStatsDwnRssi, UnsignedShort=UnsignedShort, mIfNxStatusConnRemAddress=mIfNxStatusConnRemAddress, mIfNxLastLqi=mIfNxLastLqi, mIfNxApInfoConnectedTime=mIfNxApInfoConnectedTime, mIfNxStatusEndpointTimeToLive=mIfNxStatusEndpointTimeToLive, mIfNxStatusConnRemAvgSnr=mIfNxStatusConnRemAvgSnr, PYSNMP_MODULE_ID=mdsIfNxMIB, mIfNxMacStatsTxNoSync=mIfNxMacStatsTxNoSync, mIfNxStatusActChanTable=mIfNxStatusActChanTable, mIfNxStatusEndpointStatsTxPackets=mIfNxStatusEndpointStatsTxPackets, mIfNxStatusConnRemStatsRxBytes=mIfNxStatusConnRemStatsRxBytes, mIfNxStatus=mIfNxStatus, mIfNxStatusConnRemNicId=mIfNxStatusConnRemNicId, mIfNxStatusConnRemStatsGateway=mIfNxStatusConnRemStatsGateway, mIfNxStatusEntry=mIfNxStatusEntry, mIfNxMacStatsSyncCheckError=mIfNxMacStatsSyncCheckError, mIfNxStatusConnRemStatsTxError=mIfNxStatusConnRemStatsTxError, mIfNxStatusEndpointStatsRxBytes=mIfNxStatusEndpointStatsRxBytes, mIfNxMacStatsTxNoAssoc=mIfNxMacStatsTxNoAssoc, LinkStatus=LinkStatus, mIfNxApInfoAvgLqi=mIfNxApInfoAvgLqi, mIfNxStatusConnRemStatsVersion=mIfNxStatusConnRemStatsVersion, mIfNxCompliance=mIfNxCompliance, mIfNxStatusConnRemAvgRssi=mIfNxStatusConnRemAvgRssi)
