...
mibBuilder.exportSymbols("A4400-RTM-MIB", trunkname=trunkname, dspRessOutOfService=dspRessOutOfService, setsInService=setsInService, freechan=freechan, setsOutOfService=setsOutOfService, ipDomainTable=ipDomainTable, couplerno=couplerno, trunkEntry=trunkEntry, dspRessBusy=dspRessBusy, cumuloos=cumuloos, nodepbx=nodepbx, dspRessOverrun=dspRessOverrun, cacAllowed=cacAllowed, confAvailable=confAvailable, ipDomain=ipDomain, cacOverrun=cacOverrun, sipUnregSets=sipUnregSets, cumuloverrun=cumuloverrun, trunkid=trunkid, crystalno=crystalno, trunkTable=trunkTable, dspRessAvailable=dspRessAvailable, sipRegSets=sipRegSets, confOutOfOrder=confOutOfOrder, confBusy=confBusy, cacUsed=cacUsed, ooschan=ooschan, busychan=busychan, pbxRole=pbxRole, trunktype=trunktype, trunkstatus=trunkstatus, ipDomainEntry=ipDomainEntry)
