...
mibBuilder.exportSymbols("HWg-WLD-MIB", wldStateToNormal=wldStateToNormal, SensorID=SensorID, wldName=wldName, hwgwld=hwgwld, wldValue=wldValue, wldSN=wldSN, info=info, PositiveInteger=PositiveInteger, SensorSN=SensorSN, wldState=wldState, wldStateToAlarm=wldStateToAlarm, wldPeriodicAlarm=wldPeriodicAlarm, wldIndex=wldIndex, SensorState=SensorState, x390=x390, wldEntry=wldEntry, wldTable=wldTable, wldID=wldID, SensorName=SensorName, SensorValue=SensorValue, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC)
