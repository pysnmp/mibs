...
mibBuilder.exportSymbols("HWg-WLD-MIB", info=info, wldState=wldState, wldSN=wldSN, hwgwld=hwgwld, wldName=wldName, wldID=wldID, SensorSN=SensorSN, wldIndex=wldIndex, wldTable=wldTable, wldEntry=wldEntry, SensorID=SensorID, wldValue=wldValue, SensorValue=SensorValue, SensorName=SensorName, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, wldStateToNormal=wldStateToNormal, wldPeriodicAlarm=wldPeriodicAlarm, wldStateToAlarm=wldStateToAlarm, x390=x390, SensorState=SensorState, PositiveInteger=PositiveInteger)
