...
mibBuilder.exportSymbols("HWg-WLD-MIB", wldSN=wldSN, SensorSN=SensorSN, hwgwld=hwgwld, wldIndex=wldIndex, wldState=wldState, wldValue=wldValue, infoAddressMAC=infoAddressMAC, wldTable=wldTable, hwgroup=hwgroup, wldEntry=wldEntry, PositiveInteger=PositiveInteger, wldStateToAlarm=wldStateToAlarm, x390=x390, SensorID=SensorID, info=info, SensorValue=SensorValue, wldPeriodicAlarm=wldPeriodicAlarm, wldID=wldID, wldName=wldName, SensorName=SensorName, wldStateToNormal=wldStateToNormal, SensorState=SensorState)
