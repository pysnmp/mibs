...
mibBuilder.exportSymbols("HWg-WLD-MIB", infoAddressMAC=infoAddressMAC, PositiveInteger=PositiveInteger, hwgwld=hwgwld, SensorSN=SensorSN, wldValue=wldValue, SensorState=SensorState, SensorID=SensorID, wldEntry=wldEntry, wldStateToNormal=wldStateToNormal, SensorName=SensorName, wldSN=wldSN, wldTable=wldTable, wldStateToAlarm=wldStateToAlarm, wldPeriodicAlarm=wldPeriodicAlarm, SensorValue=SensorValue, wldState=wldState, wldIndex=wldIndex, wldName=wldName, info=info, wldID=wldID, hwgroup=hwgroup, x390=x390)
