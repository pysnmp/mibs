...
mibBuilder.exportSymbols("HWg-WLD-MIB", wldTable=wldTable, SensorSN=SensorSN, hwgwld=hwgwld, wldID=wldID, wldState=wldState, info=info, wldStateToNormal=wldStateToNormal, wldName=wldName, wldValue=wldValue, wldIndex=wldIndex, wldEntry=wldEntry, infoAddressMAC=infoAddressMAC, wldPeriodicAlarm=wldPeriodicAlarm, hwgroup=hwgroup, wldSN=wldSN, SensorState=SensorState, wldStateToAlarm=wldStateToAlarm, SensorID=SensorID, SensorValue=SensorValue, x390=x390, PositiveInteger=PositiveInteger, SensorName=SensorName)
