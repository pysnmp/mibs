...
mibBuilder.exportSymbols("HWg-WLD-MIB", wldName=wldName, info=info, SensorValue=SensorValue, wldID=wldID, wldEntry=wldEntry, hwgwld=hwgwld, x390=x390, wldSN=wldSN, SensorID=SensorID, hwgroup=hwgroup, SensorName=SensorName, wldState=wldState, infoAddressMAC=infoAddressMAC, wldStateToAlarm=wldStateToAlarm, SensorState=SensorState, wldValue=wldValue, wldStateToNormal=wldStateToNormal, wldIndex=wldIndex, SensorSN=SensorSN, PositiveInteger=PositiveInteger, wldPeriodicAlarm=wldPeriodicAlarm, wldTable=wldTable)
