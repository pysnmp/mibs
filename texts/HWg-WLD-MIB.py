...
mibBuilder.exportSymbols("HWg-WLD-MIB", SensorID=SensorID, SensorState=SensorState, SensorValue=SensorValue, PositiveInteger=PositiveInteger, wldSN=wldSN, wldIndex=wldIndex, wldStateToAlarm=wldStateToAlarm, hwgwld=hwgwld, wldID=wldID, infoAddressMAC=infoAddressMAC, SensorName=SensorName, x390=x390, wldState=wldState, wldName=wldName, wldValue=wldValue, hwgroup=hwgroup, info=info, wldStateToNormal=wldStateToNormal, wldTable=wldTable, wldPeriodicAlarm=wldPeriodicAlarm, SensorSN=SensorSN, wldEntry=wldEntry)
