...
mibBuilder.exportSymbols("HWg-WLD-MIB", hwgwld=hwgwld, SensorName=SensorName, wldState=wldState, wldEntry=wldEntry, SensorSN=SensorSN, x390=x390, wldID=wldID, wldIndex=wldIndex, infoAddressMAC=infoAddressMAC, hwgroup=hwgroup, wldStateToAlarm=wldStateToAlarm, SensorState=SensorState, SensorValue=SensorValue, info=info, wldSN=wldSN, wldTable=wldTable, wldValue=wldValue, wldStateToNormal=wldStateToNormal, wldName=wldName, SensorID=SensorID, wldPeriodicAlarm=wldPeriodicAlarm, PositiveInteger=PositiveInteger)
