...
mibBuilder.exportSymbols("HWg-WLD-MIB", SensorName=SensorName, wldStateToAlarm=wldStateToAlarm, wldEntry=wldEntry, wldSN=wldSN, wldTable=wldTable, hwgroup=hwgroup, wldIndex=wldIndex, wldPeriodicAlarm=wldPeriodicAlarm, SensorID=SensorID, PositiveInteger=PositiveInteger, wldID=wldID, wldState=wldState, SensorState=SensorState, infoAddressMAC=infoAddressMAC, wldValue=wldValue, x390=x390, wldName=wldName, SensorValue=SensorValue, hwgwld=hwgwld, info=info, wldStateToNormal=wldStateToNormal, SensorSN=SensorSN)
