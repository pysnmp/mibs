...
mibBuilder.exportSymbols("HWg-WLD-MIB", wldPeriodicAlarm=wldPeriodicAlarm, hwgroup=hwgroup, SensorValue=SensorValue, wldTable=wldTable, infoAddressMAC=infoAddressMAC, PositiveInteger=PositiveInteger, SensorID=SensorID, SensorSN=SensorSN, hwgwld=hwgwld, wldIndex=wldIndex, wldEntry=wldEntry, wldValue=wldValue, wldSN=wldSN, wldStateToNormal=wldStateToNormal, wldStateToAlarm=wldStateToAlarm, x390=x390, info=info, SensorState=SensorState, wldState=wldState, wldID=wldID, SensorName=SensorName, wldName=wldName)
