...
mibBuilder.exportSymbols("HWg-WLD-MIB", wldIndex=wldIndex, info=info, wldState=wldState, PositiveInteger=PositiveInteger, wldStateToAlarm=wldStateToAlarm, SensorName=SensorName, x390=x390, wldTable=wldTable, SensorSN=SensorSN, wldPeriodicAlarm=wldPeriodicAlarm, SensorValue=SensorValue, wldStateToNormal=wldStateToNormal, wldID=wldID, wldName=wldName, hwgwld=hwgwld, SensorID=SensorID, wldValue=wldValue, wldSN=wldSN, wldEntry=wldEntry, infoAddressMAC=infoAddressMAC, hwgroup=hwgroup, SensorState=SensorState)
