...
mibBuilder.exportSymbols("HWg-WLD-MIB", wldStateToAlarm=wldStateToAlarm, SensorID=SensorID, hwgroup=hwgroup, wldEntry=wldEntry, wldIndex=wldIndex, wldSN=wldSN, wldState=wldState, SensorValue=SensorValue, wldTable=wldTable, wldName=wldName, hwgwld=hwgwld, infoAddressMAC=infoAddressMAC, x390=x390, wldValue=wldValue, wldPeriodicAlarm=wldPeriodicAlarm, info=info, PositiveInteger=PositiveInteger, wldID=wldID, SensorName=SensorName, SensorSN=SensorSN, SensorState=SensorState, wldStateToNormal=wldStateToNormal)
