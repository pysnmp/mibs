...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:00:06 2021
...
ObjectIdentity, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, enterprises, iso, Bits, Integer32, Counter64, Unsigned32, MibIdentifier, NotificationType, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "enterprises", "iso", "Bits", "Integer32", "Counter64", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("RAY-MIB", rfPowerConfigured=rfPowerConfigured, productName=productName, txMulticast=txMulticast, rxDones=rxDones, txCollisions=txCollisions, fecUncorrectBlockCounter=fecUncorrectBlockCounter, ethInThroughput=ethInThroughput, eth2OutThroughput=eth2OutThroughput, PYSNMP_MODULE_ID=ray, speed=speed, timeMaxDisconnect=timeMaxDisconnect, useMemory=useMemory, ModulationList=ModulationList, statistic=statistic, txHCBytes=txHCBytes, ray=ray, product=product, authorization=authorization, managementVlanId=managementVlanId, managementVlan=managementVlan, ifEth=ifEth, rxDroppedPkts=rxDroppedPkts, tr2SnrAlarm=tr2SnrAlarm, rayTraps=rayTraps, modemR=modemR, txControlFrames=txControlFrames, keyTable=keyTable, systemStatus=systemStatus, interface=interface, powerAlarm=powerAlarm, tr2WifiOn=tr2WifiOn, rxModulation=rxModulation, rxBroadcast=rxBroadcast, linkUptime=linkUptime, alarmEth2Down=alarmEth2Down, timeAllConnect=timeAllConnect, lineStatusII=lineStatusII, tr2NetBitrate=tr2NetBitrate, alarmWifiOn=alarmWifiOn, DisplayString=DisplayString, tr2VoltageHighAlarm=tr2VoltageHighAlarm, wifiHAP=wifiHAP, tr2RfPowerFail=tr2RfPowerFail, channelArrangement=channelArrangement, rxModulationIndex=rxModulationIndex, duplex=duplex, rxMulticast=rxMulticast, memoryAlarm=memoryAlarm, rfPowerStatus=rfPowerStatus, serviceVlanId=serviceVlanId, PhysAddress=PhysAddress, mdix=mdix, txLengthCheckErrors=txLengthCheckErrors, vlanId=vlanId, txCrcErrors=txCrcErrors, snr=snr, maxNetBitrate=maxNetBitrate, netBitrate=netBitrate, status=status, eth2InThroughput=eth2InThroughput, alarmRfPowerFail=alarmRfPowerFail, serialNumber=serialNumber, station=station, tr2AirConnect=tr2AirConnect, txBroadcast=txBroadcast, autonego=autonego, useLogStorage=useLogStorage, prioritized=prioritized, ethernet=ethernet, info=info, ifEthEntry=ifEthEntry, alarm=alarm, temperatureRadio=temperatureRadio, ber=ber, useCpu=useCpu, access=access, tr2Eth21LinkDown=tr2Eth21LinkDown, rxOutOfRangeErrors=rxOutOfRangeErrors, bandwidthKHz=bandwidthKHz, tr2RssAlarm=tr2RssAlarm, keyName=keyName, sshd=sshd, unitType=unitType, alarmEth1Down=alarmEth1Down, eth2Link=eth2Link, lineStatus=lineStatus, txFreq=txFreq, berAlarm=berAlarm, swVer=swVer, voltageSource=voltageSource, tr2TemperatureAlarm=tr2TemperatureAlarm, rxCrcErrors=rxCrcErrors, rxHCBytes=rxHCBytes, ifEthTable=ifEthTable, txChannel=txChannel, searchModeDisabled=searchModeDisabled, reliability=reliability, mac=mac, peerEthLinkDown=peerEthLinkDown, snrAlarm=snrAlarm, ethOutThroughput=ethOutThroughput, radio=radio, ethPeer=ethPeer, timeAllDisconnect=timeAllDisconnect, bandwidth=bandwidth, asymPause=asymPause, numDisconnect=numDisconnect, OptionSetting=OptionSetting, alarmRss=alarmRss, rxPauseFrames=rxPauseFrames, txDones=txDones, rssAlarm=rssAlarm, alarmSnr=alarmSnr, ray2Traps=ray2Traps, keyEntry=keyEntry, airWdog=airWdog, tempAlarm=tempAlarm, rxCodeErrors=rxCodeErrors, coding=coding, alarmBer=alarmBer, txPauseFrames=txPauseFrames, temperatureModem=temperatureModem, pause=pause, ip=ip, httpd=httpd, securePeerMode=securePeerMode, alarmNetBitrate=alarmNetBitrate, system=system, rxChannel=rxChannel, tr2VoltageLowAlarm=tr2VoltageLowAlarm, voltageUnit=voltageUnit, eth1Link=eth1Link, txModulationIndex=txModulationIndex, peerNumber=peerNumber, alarmVoltageLow=alarmVoltageLow, txModulation=txModulation, fecBlockCounter=fecBlockCounter, racom=racom, ServiceState=ServiceState, tr2AirDisconnect=tr2AirDisconnect, tr2Eth1LinkDown=tr2Eth1LinkDown, rxFalseCarrierErrors=rxFalseCarrierErrors, alarmTemperature=alarmTemperature, alarmVoltageHigh=alarmVoltageHigh, alarmPeerDisconnected=alarmPeerDisconnected, AlarmState=AlarmState, deviceName=deviceName, telnetd=telnetd, matching=matching, ifRadio=ifRadio, airConnect=airConnect, rfPowerFail=rfPowerFail, airDisconnect=airDisconnect, rxControlFrames=rxControlFrames, tr2BerAlarm=tr2BerAlarm, rxFreq=rxFreq, rss=rss, swVerRadio=swVerRadio, chassis=chassis, rfPowerCurrent=rfPowerCurrent)
