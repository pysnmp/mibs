...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:14:49 2022
...
Bits, NotificationType, ModuleIdentity, enterprises, mib_2, Gauge32, Counter64, ObjectIdentity, Integer32, TimeTicks, iso, MibIdentifier, IpAddress, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "ModuleIdentity", "enterprises", "mib-2", "Gauge32", "Counter64", "ObjectIdentity", "Integer32", "TimeTicks", "iso", "MibIdentifier", "IpAddress", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("RAY-MIB", tr2TemperatureAlarm=tr2TemperatureAlarm, alarmEth1Down=alarmEth1Down, rayTraps=rayTraps, alarm=alarm, alarmTemperature=alarmTemperature, ray2Traps=ray2Traps, racom=racom, lineStatus=lineStatus, ifEth=ifEth, rxCrcErrors=rxCrcErrors, eth2OutThroughput=eth2OutThroughput, telnetd=telnetd, txCrcErrors=txCrcErrors, alarmEth2Down=alarmEth2Down, txCollisions=txCollisions, sshd=sshd, rxMulticast=rxMulticast, pause=pause, rxFreq=rxFreq, rxDones=rxDones, deviceName=deviceName, ethernet=ethernet, mac=mac, ray=ray, powerAlarm=powerAlarm, berAlarm=berAlarm, temperatureModem=temperatureModem, eth1Link=eth1Link, AlarmState=AlarmState, rxModulation=rxModulation, memoryAlarm=memoryAlarm, alarmSnr=alarmSnr, ethPeer=ethPeer, tr2Eth21LinkDown=tr2Eth21LinkDown, txControlFrames=txControlFrames, txPauseFrames=txPauseFrames, status=status, unitType=unitType, vlanId=vlanId, tr2VoltageLowAlarm=tr2VoltageLowAlarm, OptionSetting=OptionSetting, rss=rss, rfPowerConfigured=rfPowerConfigured, httpd=httpd, fecBlockCounter=fecBlockCounter, eth2InThroughput=eth2InThroughput, rfPowerStatus=rfPowerStatus, product=product, ip=ip, timeAllDisconnect=timeAllDisconnect, authorization=authorization, tr2WifiOn=tr2WifiOn, swVer=swVer, swVerRadio=swVerRadio, serialNumber=serialNumber, access=access, rxModulationIndex=rxModulationIndex, ifRadio=ifRadio, serviceVlanId=serviceVlanId, ModulationList=ModulationList, useCpu=useCpu, rfPowerCurrent=rfPowerCurrent, airDisconnect=airDisconnect, modemR=modemR, rxBroadcast=rxBroadcast, rssAlarm=rssAlarm, netBitrate=netBitrate, ifEthEntry=ifEthEntry, speed=speed, txBroadcast=txBroadcast, DisplayString=DisplayString, tempAlarm=tempAlarm, prioritized=prioritized, ethInThroughput=ethInThroughput, snrAlarm=snrAlarm, voltageUnit=voltageUnit, useMemory=useMemory, tr2NetBitrate=tr2NetBitrate, alarmNetBitrate=alarmNetBitrate, txLengthCheckErrors=txLengthCheckErrors, airWdog=airWdog, tr2BerAlarm=tr2BerAlarm, statistic=statistic, tr2AirConnect=tr2AirConnect, lineStatusII=lineStatusII, rxOutOfRangeErrors=rxOutOfRangeErrors, duplex=duplex, channelArrangement=channelArrangement, coding=coding, keyName=keyName, timeMaxDisconnect=timeMaxDisconnect, rxFalseCarrierErrors=rxFalseCarrierErrors, rxPauseFrames=rxPauseFrames, searchModeDisabled=searchModeDisabled, eth2Link=eth2Link, station=station, txModulation=txModulation, autonego=autonego, txHCBytes=txHCBytes, peerNumber=peerNumber, tr2AirDisconnect=tr2AirDisconnect, peerEthLinkDown=peerEthLinkDown, timeAllConnect=timeAllConnect, rxChannel=rxChannel, tr2RfPowerFail=tr2RfPowerFail, alarmRss=alarmRss, txChannel=txChannel, tr2RssAlarm=tr2RssAlarm, rxHCBytes=rxHCBytes, systemStatus=systemStatus, tr2Eth1LinkDown=tr2Eth1LinkDown, txDones=txDones, useLogStorage=useLogStorage, temperatureRadio=temperatureRadio, bandwidth=bandwidth, matching=matching, reliability=reliability, txMulticast=txMulticast, tr2VoltageHighAlarm=tr2VoltageHighAlarm, numDisconnect=numDisconnect, alarmWifiOn=alarmWifiOn, ber=ber, snr=snr, linkUptime=linkUptime, wifiHAP=wifiHAP, ServiceState=ServiceState, productName=productName, alarmBer=alarmBer, ethOutThroughput=ethOutThroughput, ifEthTable=ifEthTable, radio=radio, keyEntry=keyEntry, mdix=mdix, interface=interface, chassis=chassis, rfPowerFail=rfPowerFail, txFreq=txFreq, securePeerMode=securePeerMode, alarmVoltageHigh=alarmVoltageHigh, rxCodeErrors=rxCodeErrors, alarmPeerDisconnected=alarmPeerDisconnected, tr2SnrAlarm=tr2SnrAlarm, info=info, airConnect=airConnect, rxControlFrames=rxControlFrames, keyTable=keyTable, managementVlan=managementVlan, alarmRfPowerFail=alarmRfPowerFail, alarmVoltageLow=alarmVoltageLow, fecUncorrectBlockCounter=fecUncorrectBlockCounter, txModulationIndex=txModulationIndex, bandwidthKHz=bandwidthKHz, asymPause=asymPause, maxNetBitrate=maxNetBitrate, voltageSource=voltageSource, rxDroppedPkts=rxDroppedPkts, system=system, managementVlanId=managementVlanId, PhysAddress=PhysAddress, PYSNMP_MODULE_ID=ray)
