...
NotificationType, iso, Counter32, Unsigned32, mib_2, MibIdentifier, Integer32, enterprises, TimeTicks, IpAddress, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter32", "Unsigned32", "mib-2", "MibIdentifier", "Integer32", "enterprises", "TimeTicks", "IpAddress", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("RAY-MIB", alarmVoltageLow=alarmVoltageLow, AlarmState=AlarmState, alarmEth2Down=alarmEth2Down, txCollisions=txCollisions, peerEthLinkDown=peerEthLinkDown, managementVlanId=managementVlanId, alarmPeerDisconnected=alarmPeerDisconnected, authorization=authorization, ifEthTable=ifEthTable, keyEntry=keyEntry, ip=ip, txFreq=txFreq, tr2BerAlarm=tr2BerAlarm, rxBroadcast=rxBroadcast, vlanId=vlanId, rxChannel=rxChannel, rfPowerCurrent=rfPowerCurrent, alarmNetBitrate=alarmNetBitrate, tempAlarm=tempAlarm, maxNetBitrate=maxNetBitrate, info=info, txDones=txDones, ber=ber, tr2AirDisconnect=tr2AirDisconnect, fecBlockCounter=fecBlockCounter, timeMaxDisconnect=timeMaxDisconnect, matching=matching, tr2NetBitrate=tr2NetBitrate, station=station, fecUncorrectBlockCounter=fecUncorrectBlockCounter, OptionSetting=OptionSetting, speed=speed, alarm=alarm, txModulation=txModulation, channelArrangement=channelArrangement, alarmEth1Down=alarmEth1Down, mdix=mdix, airDisconnect=airDisconnect, swVer=swVer, rxModulationIndex=rxModulationIndex, duplex=duplex, txLengthCheckErrors=txLengthCheckErrors, alarmRss=alarmRss, rxModulation=rxModulation, memoryAlarm=memoryAlarm, lineStatus=lineStatus, rfPowerFail=rfPowerFail, peerNumber=peerNumber, serialNumber=serialNumber, rfPowerConfigured=rfPowerConfigured, rxFalseCarrierErrors=rxFalseCarrierErrors, rxDones=rxDones, tr2SnrAlarm=tr2SnrAlarm, ray2Traps=ray2Traps, txHCBytes=txHCBytes, temperatureModem=temperatureModem, useCpu=useCpu, modemR=modemR, bandwidth=bandwidth, tr2Eth1LinkDown=tr2Eth1LinkDown, rxOutOfRangeErrors=rxOutOfRangeErrors, txCrcErrors=txCrcErrors, txMulticast=txMulticast, eth2InThroughput=eth2InThroughput, rssAlarm=rssAlarm, txBroadcast=txBroadcast, wifiHAP=wifiHAP, autonego=autonego, tr2VoltageLowAlarm=tr2VoltageLowAlarm, numDisconnect=numDisconnect, tr2WifiOn=tr2WifiOn, sshd=sshd, rxCrcErrors=rxCrcErrors, swVerRadio=swVerRadio, asymPause=asymPause, serviceVlanId=serviceVlanId, ray=ray, managementVlan=managementVlan, tr2AirConnect=tr2AirConnect, ethernet=ethernet, systemStatus=systemStatus, access=access, voltageSource=voltageSource, rxControlFrames=rxControlFrames, txControlFrames=txControlFrames, linkUptime=linkUptime, tr2RfPowerFail=tr2RfPowerFail, tr2TemperatureAlarm=tr2TemperatureAlarm, voltageUnit=voltageUnit, rxPauseFrames=rxPauseFrames, lineStatusII=lineStatusII, snrAlarm=snrAlarm, coding=coding, timeAllConnect=timeAllConnect, alarmWifiOn=alarmWifiOn, ethOutThroughput=ethOutThroughput, searchModeDisabled=searchModeDisabled, rfPowerStatus=rfPowerStatus, tr2RssAlarm=tr2RssAlarm, prioritized=prioritized, ifEth=ifEth, alarmTemperature=alarmTemperature, rxDroppedPkts=rxDroppedPkts, timeAllDisconnect=timeAllDisconnect, racom=racom, useMemory=useMemory, txChannel=txChannel, chassis=chassis, tr2VoltageHighAlarm=tr2VoltageHighAlarm, reliability=reliability, securePeerMode=securePeerMode, alarmBer=alarmBer, unitType=unitType, alarmRfPowerFail=alarmRfPowerFail, ethPeer=ethPeer, berAlarm=berAlarm, tr2Eth21LinkDown=tr2Eth21LinkDown, airWdog=airWdog, txModulationIndex=txModulationIndex, status=status, rxFreq=rxFreq, snr=snr, radio=radio, ModulationList=ModulationList, telnetd=telnetd, rayTraps=rayTraps, system=system, statistic=statistic, eth1Link=eth1Link, ethInThroughput=ethInThroughput, temperatureRadio=temperatureRadio, PhysAddress=PhysAddress, httpd=httpd, PYSNMP_MODULE_ID=ray, bandwidthKHz=bandwidthKHz, rxCodeErrors=rxCodeErrors, product=product, ifRadio=ifRadio, txPauseFrames=txPauseFrames, useLogStorage=useLogStorage, netBitrate=netBitrate, interface=interface, keyTable=keyTable, mac=mac, rxHCBytes=rxHCBytes, rss=rss, powerAlarm=powerAlarm, eth2OutThroughput=eth2OutThroughput, eth2Link=eth2Link, DisplayString=DisplayString, ServiceState=ServiceState, rxMulticast=rxMulticast, keyName=keyName, ifEthEntry=ifEthEntry, productName=productName, pause=pause, alarmVoltageHigh=alarmVoltageHigh, airConnect=airConnect, alarmSnr=alarmSnr, deviceName=deviceName)
