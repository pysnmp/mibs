...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:30:19 2023
...
ModuleIdentity, TimeTicks, Unsigned32, ObjectIdentity, Gauge32, Counter64, MibIdentifier, Bits, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, enterprises, IpAddress, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter64", "MibIdentifier", "Bits", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "enterprises", "IpAddress", "NotificationType", "iso")
...
mibBuilder.exportSymbols("RAY-MIB", useMemory=useMemory, bandwidthKHz=bandwidthKHz, ray=ray, matching=matching, channelArrangement=channelArrangement, ifRadio=ifRadio, ifEthEntry=ifEthEntry, rxCrcErrors=rxCrcErrors, tr2RfPowerFail=tr2RfPowerFail, alarmBer=alarmBer, eth2Link=eth2Link, serialNumber=serialNumber, deviceName=deviceName, alarmNetBitrate=alarmNetBitrate, ip=ip, alarmVoltageLow=alarmVoltageLow, searchModeDisabled=searchModeDisabled, bandwidth=bandwidth, authorization=authorization, airWdog=airWdog, ethernet=ethernet, useLogStorage=useLogStorage, swVer=swVer, peerNumber=peerNumber, tr2VoltageHighAlarm=tr2VoltageHighAlarm, rxOutOfRangeErrors=rxOutOfRangeErrors, alarmWifiOn=alarmWifiOn, rss=rss, txControlFrames=txControlFrames, txCrcErrors=txCrcErrors, DisplayString=DisplayString, telnetd=telnetd, tr2Eth1LinkDown=tr2Eth1LinkDown, rfPowerFail=rfPowerFail, rayTraps=rayTraps, alarmPeerDisconnected=alarmPeerDisconnected, tr2AirDisconnect=tr2AirDisconnect, rxControlFrames=rxControlFrames, ifEthTable=ifEthTable, access=access, ifEth=ifEth, alarmSnr=alarmSnr, lineStatusII=lineStatusII, system=system, alarmEth2Down=alarmEth2Down, reliability=reliability, useCpu=useCpu, temperatureModem=temperatureModem, duplex=duplex, berAlarm=berAlarm, memoryAlarm=memoryAlarm, rxHCBytes=rxHCBytes, speed=speed, info=info, airConnect=airConnect, lineStatus=lineStatus, prioritized=prioritized, pause=pause, timeAllConnect=timeAllConnect, PYSNMP_MODULE_ID=ray, racom=racom, temperatureRadio=temperatureRadio, txChannel=txChannel, rxFreq=rxFreq, modemR=modemR, rxPauseFrames=rxPauseFrames, txHCBytes=txHCBytes, rxFalseCarrierErrors=rxFalseCarrierErrors, alarm=alarm, tr2TemperatureAlarm=tr2TemperatureAlarm, rxModulationIndex=rxModulationIndex, txLengthCheckErrors=txLengthCheckErrors, productName=productName, rxDroppedPkts=rxDroppedPkts, keyEntry=keyEntry, peerEthLinkDown=peerEthLinkDown, status=status, keyName=keyName, chassis=chassis, fecBlockCounter=fecBlockCounter, autonego=autonego, eth2OutThroughput=eth2OutThroughput, eth1Link=eth1Link, ethOutThroughput=ethOutThroughput, tr2RssAlarm=tr2RssAlarm, snr=snr, httpd=httpd, unitType=unitType, voltageSource=voltageSource, statistic=statistic, ethPeer=ethPeer, asymPause=asymPause, coding=coding, vlanId=vlanId, tr2SnrAlarm=tr2SnrAlarm, managementVlan=managementVlan, rxCodeErrors=rxCodeErrors, rxChannel=rxChannel, ray2Traps=ray2Traps, txPauseFrames=txPauseFrames, alarmRss=alarmRss, rxModulation=rxModulation, PhysAddress=PhysAddress, rxDones=rxDones, ethInThroughput=ethInThroughput, timeAllDisconnect=timeAllDisconnect, rfPowerStatus=rfPowerStatus, eth2InThroughput=eth2InThroughput, alarmEth1Down=alarmEth1Down, rfPowerConfigured=rfPowerConfigured, ber=ber, alarmRfPowerFail=alarmRfPowerFail, securePeerMode=securePeerMode, rxMulticast=rxMulticast, netBitrate=netBitrate, ServiceState=ServiceState, systemStatus=systemStatus, tr2AirConnect=tr2AirConnect, alarmVoltageHigh=alarmVoltageHigh, txMulticast=txMulticast, keyTable=keyTable, tr2VoltageLowAlarm=tr2VoltageLowAlarm, alarmTemperature=alarmTemperature, rssAlarm=rssAlarm, station=station, interface=interface, product=product, powerAlarm=powerAlarm, txDones=txDones, tr2Eth21LinkDown=tr2Eth21LinkDown, txFreq=txFreq, mdix=mdix, tr2NetBitrate=tr2NetBitrate, txModulation=txModulation, airDisconnect=airDisconnect, tr2WifiOn=tr2WifiOn, managementVlanId=managementVlanId, fecUncorrectBlockCounter=fecUncorrectBlockCounter, sshd=sshd, snrAlarm=snrAlarm, radio=radio, rxBroadcast=rxBroadcast, tr2BerAlarm=tr2BerAlarm, txCollisions=txCollisions, rfPowerCurrent=rfPowerCurrent, ModulationList=ModulationList, maxNetBitrate=maxNetBitrate, mac=mac, tempAlarm=tempAlarm, txBroadcast=txBroadcast, timeMaxDisconnect=timeMaxDisconnect, AlarmState=AlarmState, numDisconnect=numDisconnect, OptionSetting=OptionSetting, serviceVlanId=serviceVlanId, txModulationIndex=txModulationIndex, voltageUnit=voltageUnit, wifiHAP=wifiHAP, swVerRadio=swVerRadio, linkUptime=linkUptime)
