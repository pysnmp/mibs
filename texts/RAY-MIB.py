...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Counter64, MibIdentifier, NotificationType, ModuleIdentity, iso, IpAddress, enterprises, TimeTicks, Bits, ObjectIdentity, Counter32, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Counter64", "MibIdentifier", "NotificationType", "ModuleIdentity", "iso", "IpAddress", "enterprises", "TimeTicks", "Bits", "ObjectIdentity", "Counter32", "mib-2", "Gauge32")
...
mibBuilder.exportSymbols("RAY-MIB", eth2InThroughput=eth2InThroughput, rxCrcErrors=rxCrcErrors, snr=snr, peerNumber=peerNumber, rxModulation=rxModulation, snrAlarm=snrAlarm, tr2AirDisconnect=tr2AirDisconnect, PhysAddress=PhysAddress, ray2Traps=ray2Traps, txDones=txDones, status=status, managementVlan=managementVlan, OptionSetting=OptionSetting, tr2AirConnect=tr2AirConnect, httpd=httpd, mdix=mdix, alarmEth2Down=alarmEth2Down, temperatureRadio=temperatureRadio, speed=speed, statistic=statistic, autonego=autonego, txControlFrames=txControlFrames, rxCodeErrors=rxCodeErrors, tempAlarm=tempAlarm, voltageUnit=voltageUnit, rss=rss, interface=interface, memoryAlarm=memoryAlarm, ethPeer=ethPeer, tr2TemperatureAlarm=tr2TemperatureAlarm, timeAllConnect=timeAllConnect, txChannel=txChannel, rxDroppedPkts=rxDroppedPkts, coding=coding, tr2VoltageHighAlarm=tr2VoltageHighAlarm, fecUncorrectBlockCounter=fecUncorrectBlockCounter, txLengthCheckErrors=txLengthCheckErrors, eth1Link=eth1Link, tr2Eth1LinkDown=tr2Eth1LinkDown, numDisconnect=numDisconnect, alarmSnr=alarmSnr, keyTable=keyTable, alarmTemperature=alarmTemperature, powerAlarm=powerAlarm, ModulationList=ModulationList, swVer=swVer, peerEthLinkDown=peerEthLinkDown, ifEth=ifEth, rxControlFrames=rxControlFrames, rfPowerConfigured=rfPowerConfigured, alarmPeerDisconnected=alarmPeerDisconnected, alarm=alarm, modemR=modemR, useLogStorage=useLogStorage, prioritized=prioritized, eth2Link=eth2Link, netBitrate=netBitrate, bandwidthKHz=bandwidthKHz, ber=ber, rssAlarm=rssAlarm, asymPause=asymPause, ethInThroughput=ethInThroughput, rxHCBytes=rxHCBytes, ip=ip, keyName=keyName, securePeerMode=securePeerMode, ifEthTable=ifEthTable, pause=pause, system=system, alarmWifiOn=alarmWifiOn, txCrcErrors=txCrcErrors, tr2Eth21LinkDown=tr2Eth21LinkDown, maxNetBitrate=maxNetBitrate, timeAllDisconnect=timeAllDisconnect, linkUptime=linkUptime, radio=radio, serialNumber=serialNumber, voltageSource=voltageSource, tr2BerAlarm=tr2BerAlarm, mac=mac, AlarmState=AlarmState, rxFreq=rxFreq, swVerRadio=swVerRadio, tr2RssAlarm=tr2RssAlarm, rxDones=rxDones, alarmVoltageLow=alarmVoltageLow, chassis=chassis, channelArrangement=channelArrangement, airDisconnect=airDisconnect, access=access, alarmBer=alarmBer, vlanId=vlanId, tr2WifiOn=tr2WifiOn, alarmNetBitrate=alarmNetBitrate, txBroadcast=txBroadcast, systemStatus=systemStatus, timeMaxDisconnect=timeMaxDisconnect, rxPauseFrames=rxPauseFrames, tr2RfPowerFail=tr2RfPowerFail, eth2OutThroughput=eth2OutThroughput, bandwidth=bandwidth, alarmRfPowerFail=alarmRfPowerFail, alarmEth1Down=alarmEth1Down, txMulticast=txMulticast, ifEthEntry=ifEthEntry, tr2NetBitrate=tr2NetBitrate, reliability=reliability, matching=matching, rfPowerCurrent=rfPowerCurrent, rfPowerStatus=rfPowerStatus, lineStatus=lineStatus, berAlarm=berAlarm, rxMulticast=rxMulticast, unitType=unitType, rfPowerFail=rfPowerFail, managementVlanId=managementVlanId, wifiHAP=wifiHAP, serviceVlanId=serviceVlanId, txPauseFrames=txPauseFrames, ServiceState=ServiceState, productName=productName, ethernet=ethernet, txFreq=txFreq, deviceName=deviceName, duplex=duplex, alarmVoltageHigh=alarmVoltageHigh, rxChannel=rxChannel, rxOutOfRangeErrors=rxOutOfRangeErrors, DisplayString=DisplayString, useCpu=useCpu, lineStatusII=lineStatusII, keyEntry=keyEntry, tr2SnrAlarm=tr2SnrAlarm, airWdog=airWdog, rxBroadcast=rxBroadcast, tr2VoltageLowAlarm=tr2VoltageLowAlarm, ifRadio=ifRadio, txHCBytes=txHCBytes, searchModeDisabled=searchModeDisabled, alarmRss=alarmRss, ray=ray, rxFalseCarrierErrors=rxFalseCarrierErrors, racom=racom, info=info, sshd=sshd, airConnect=airConnect, ethOutThroughput=ethOutThroughput, rayTraps=rayTraps, station=station, rxModulationIndex=rxModulationIndex, PYSNMP_MODULE_ID=ray, temperatureModem=temperatureModem, telnetd=telnetd, authorization=authorization, txModulation=txModulation, txModulationIndex=txModulationIndex, useMemory=useMemory, txCollisions=txCollisions, product=product, fecBlockCounter=fecBlockCounter)
