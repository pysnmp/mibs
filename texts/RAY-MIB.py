...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:12:11 2022
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, mib_2, Unsigned32, enterprises, Counter32, TimeTicks, IpAddress, ObjectIdentity, ModuleIdentity, Gauge32, Bits, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "mib-2", "Unsigned32", "enterprises", "Counter32", "TimeTicks", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Bits", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", rfPowerFail=rfPowerFail, statistic=statistic, keyTable=keyTable, ServiceState=ServiceState, airConnect=airConnect, alarmVoltageLow=alarmVoltageLow, useMemory=useMemory, alarmEth2Down=alarmEth2Down, status=status, telnetd=telnetd, ber=ber, ifEth=ifEth, rxModulation=rxModulation, snrAlarm=snrAlarm, authorization=authorization, PhysAddress=PhysAddress, tr2VoltageLowAlarm=tr2VoltageLowAlarm, alarmRfPowerFail=alarmRfPowerFail, txDones=txDones, wifiHAP=wifiHAP, tr2RssAlarm=tr2RssAlarm, access=access, alarmWifiOn=alarmWifiOn, txControlFrames=txControlFrames, netBitrate=netBitrate, alarmRss=alarmRss, numDisconnect=numDisconnect, tr2AirConnect=tr2AirConnect, alarmBer=alarmBer, tr2RfPowerFail=tr2RfPowerFail, interface=interface, unitType=unitType, rxPauseFrames=rxPauseFrames, linkUptime=linkUptime, lineStatus=lineStatus, ray=ray, temperatureModem=temperatureModem, rxOutOfRangeErrors=rxOutOfRangeErrors, txCrcErrors=txCrcErrors, txBroadcast=txBroadcast, airWdog=airWdog, info=info, system=system, rxHCBytes=rxHCBytes, ModulationList=ModulationList, tr2Eth1LinkDown=tr2Eth1LinkDown, rxDones=rxDones, fecUncorrectBlockCounter=fecUncorrectBlockCounter, useLogStorage=useLogStorage, mdix=mdix, ifEthTable=ifEthTable, speed=speed, rxModulationIndex=rxModulationIndex, alarmVoltageHigh=alarmVoltageHigh, peerNumber=peerNumber, txCollisions=txCollisions, bandwidth=bandwidth, fecBlockCounter=fecBlockCounter, rfPowerStatus=rfPowerStatus, keyName=keyName, ethPeer=ethPeer, temperatureRadio=temperatureRadio, rxMulticast=rxMulticast, managementVlan=managementVlan, tr2WifiOn=tr2WifiOn, txModulation=txModulation, eth2Link=eth2Link, duplex=duplex, alarmNetBitrate=alarmNetBitrate, voltageSource=voltageSource, rxFalseCarrierErrors=rxFalseCarrierErrors, ray2Traps=ray2Traps, powerAlarm=powerAlarm, rxBroadcast=rxBroadcast, securePeerMode=securePeerMode, reliability=reliability, chassis=chassis, tr2TemperatureAlarm=tr2TemperatureAlarm, eth2OutThroughput=eth2OutThroughput, OptionSetting=OptionSetting, memoryAlarm=memoryAlarm, tr2Eth21LinkDown=tr2Eth21LinkDown, tr2AirDisconnect=tr2AirDisconnect, sshd=sshd, eth1Link=eth1Link, rssAlarm=rssAlarm, rxChannel=rxChannel, lineStatusII=lineStatusII, bandwidthKHz=bandwidthKHz, rxCodeErrors=rxCodeErrors, AlarmState=AlarmState, swVer=swVer, racom=racom, alarmEth1Down=alarmEth1Down, rxDroppedPkts=rxDroppedPkts, alarmTemperature=alarmTemperature, rfPowerConfigured=rfPowerConfigured, ifEthEntry=ifEthEntry, timeAllConnect=timeAllConnect, ip=ip, rss=rss, eth2InThroughput=eth2InThroughput, useCpu=useCpu, ethOutThroughput=ethOutThroughput, txMulticast=txMulticast, keyEntry=keyEntry, timeMaxDisconnect=timeMaxDisconnect, channelArrangement=channelArrangement, tr2VoltageHighAlarm=tr2VoltageHighAlarm, vlanId=vlanId, voltageUnit=voltageUnit, asymPause=asymPause, txHCBytes=txHCBytes, systemStatus=systemStatus, txFreq=txFreq, maxNetBitrate=maxNetBitrate, rxControlFrames=rxControlFrames, station=station, pause=pause, managementVlanId=managementVlanId, tr2NetBitrate=tr2NetBitrate, rxFreq=rxFreq, searchModeDisabled=searchModeDisabled, txModulationIndex=txModulationIndex, snr=snr, PYSNMP_MODULE_ID=ray, deviceName=deviceName, rayTraps=rayTraps, tr2BerAlarm=tr2BerAlarm, rfPowerCurrent=rfPowerCurrent, matching=matching, radio=radio, txChannel=txChannel, ifRadio=ifRadio, prioritized=prioritized, peerEthLinkDown=peerEthLinkDown, airDisconnect=airDisconnect, txLengthCheckErrors=txLengthCheckErrors, ethernet=ethernet, tr2SnrAlarm=tr2SnrAlarm, productName=productName, autonego=autonego, tempAlarm=tempAlarm, alarm=alarm, product=product, serviceVlanId=serviceVlanId, txPauseFrames=txPauseFrames, httpd=httpd, mac=mac, berAlarm=berAlarm, coding=coding, timeAllDisconnect=timeAllDisconnect, modemR=modemR, swVerRadio=swVerRadio, alarmSnr=alarmSnr, ethInThroughput=ethInThroughput, serialNumber=serialNumber, DisplayString=DisplayString, alarmPeerDisconnected=alarmPeerDisconnected, rxCrcErrors=rxCrcErrors)
