...
# Produced by pysmi-1.1.8 at Thu Feb  9 14:05:44 2023
...
mib_2, iso, Integer32, Gauge32, MibIdentifier, TimeTicks, Bits, enterprises, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, NotificationType, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "Integer32", "Gauge32", "MibIdentifier", "TimeTicks", "Bits", "enterprises", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "NotificationType", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("RAY-MIB", productName=productName, serialNumber=serialNumber, tr2Eth21LinkDown=tr2Eth21LinkDown, alarmWifiOn=alarmWifiOn, linkUptime=linkUptime, alarmTemperature=alarmTemperature, ifEth=ifEth, managementVlanId=managementVlanId, racom=racom, system=system, access=access, ray=ray, txChannel=txChannel, txCrcErrors=txCrcErrors, reliability=reliability, rxControlFrames=rxControlFrames, rxMulticast=rxMulticast, airDisconnect=airDisconnect, tr2RssAlarm=tr2RssAlarm, rxChannel=rxChannel, coding=coding, tr2VoltageHighAlarm=tr2VoltageHighAlarm, ModulationList=ModulationList, eth2Link=eth2Link, bandwidth=bandwidth, keyTable=keyTable, rayTraps=rayTraps, rxFalseCarrierErrors=rxFalseCarrierErrors, alarmBer=alarmBer, temperatureRadio=temperatureRadio, txControlFrames=txControlFrames, useLogStorage=useLogStorage, bandwidthKHz=bandwidthKHz, fecBlockCounter=fecBlockCounter, numDisconnect=numDisconnect, txLengthCheckErrors=txLengthCheckErrors, tr2NetBitrate=tr2NetBitrate, rfPowerCurrent=rfPowerCurrent, rxOutOfRangeErrors=rxOutOfRangeErrors, status=status, pause=pause, eth2InThroughput=eth2InThroughput, tr2SnrAlarm=tr2SnrAlarm, netBitrate=netBitrate, tr2Eth1LinkDown=tr2Eth1LinkDown, alarmPeerDisconnected=alarmPeerDisconnected, station=station, txFreq=txFreq, airConnect=airConnect, txPauseFrames=txPauseFrames, rxCrcErrors=rxCrcErrors, alarmEth2Down=alarmEth2Down, PYSNMP_MODULE_ID=ray, lineStatus=lineStatus, radio=radio, rxBroadcast=rxBroadcast, tempAlarm=tempAlarm, sshd=sshd, ethernet=ethernet, tr2AirDisconnect=tr2AirDisconnect, rxDroppedPkts=rxDroppedPkts, txModulation=txModulation, rxModulation=rxModulation, duplex=duplex, txBroadcast=txBroadcast, txMulticast=txMulticast, rfPowerConfigured=rfPowerConfigured, alarmVoltageHigh=alarmVoltageHigh, rxCodeErrors=rxCodeErrors, AlarmState=AlarmState, DisplayString=DisplayString, rxDones=rxDones, ethOutThroughput=ethOutThroughput, matching=matching, info=info, maxNetBitrate=maxNetBitrate, autonego=autonego, ip=ip, lineStatusII=lineStatusII, fecUncorrectBlockCounter=fecUncorrectBlockCounter, snrAlarm=snrAlarm, rxHCBytes=rxHCBytes, chassis=chassis, ifEthEntry=ifEthEntry, ifEthTable=ifEthTable, ServiceState=ServiceState, OptionSetting=OptionSetting, rss=rss, mdix=mdix, mac=mac, prioritized=prioritized, rfPowerFail=rfPowerFail, timeAllConnect=timeAllConnect, telnetd=telnetd, alarmNetBitrate=alarmNetBitrate, tr2VoltageLowAlarm=tr2VoltageLowAlarm, serviceVlanId=serviceVlanId, ber=ber, tr2TemperatureAlarm=tr2TemperatureAlarm, swVerRadio=swVerRadio, snr=snr, asymPause=asymPause, txModulationIndex=txModulationIndex, txDones=txDones, ethInThroughput=ethInThroughput, powerAlarm=powerAlarm, rxFreq=rxFreq, useMemory=useMemory, alarmVoltageLow=alarmVoltageLow, tr2WifiOn=tr2WifiOn, managementVlan=managementVlan, tr2RfPowerFail=tr2RfPowerFail, temperatureModem=temperatureModem, peerEthLinkDown=peerEthLinkDown, alarmRfPowerFail=alarmRfPowerFail, txHCBytes=txHCBytes, modemR=modemR, wifiHAP=wifiHAP, httpd=httpd, alarmSnr=alarmSnr, keyName=keyName, vlanId=vlanId, memoryAlarm=memoryAlarm, voltageSource=voltageSource, rxModulationIndex=rxModulationIndex, tr2AirConnect=tr2AirConnect, rfPowerStatus=rfPowerStatus, channelArrangement=channelArrangement, timeMaxDisconnect=timeMaxDisconnect, airWdog=airWdog, eth2OutThroughput=eth2OutThroughput, peerNumber=peerNumber, keyEntry=keyEntry, swVer=swVer, ray2Traps=ray2Traps, eth1Link=eth1Link, speed=speed, txCollisions=txCollisions, rssAlarm=rssAlarm, interface=interface, systemStatus=systemStatus, alarmRss=alarmRss, PhysAddress=PhysAddress, alarm=alarm, ifRadio=ifRadio, useCpu=useCpu, tr2BerAlarm=tr2BerAlarm, timeAllDisconnect=timeAllDisconnect, berAlarm=berAlarm, product=product, ethPeer=ethPeer, authorization=authorization, rxPauseFrames=rxPauseFrames, statistic=statistic, unitType=unitType, voltageUnit=voltageUnit, searchModeDisabled=searchModeDisabled, securePeerMode=securePeerMode, deviceName=deviceName, alarmEth1Down=alarmEth1Down)
