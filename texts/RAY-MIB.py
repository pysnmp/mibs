...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:51:49 2021
...
mib_2, Counter64, iso, Gauge32, Counter32, ModuleIdentity, NotificationType, Bits, TimeTicks, IpAddress, Integer32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "iso", "Gauge32", "Counter32", "ModuleIdentity", "NotificationType", "Bits", "TimeTicks", "IpAddress", "Integer32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("RAY-MIB", alarmTemperature=alarmTemperature, fecUncorrectBlockCounter=fecUncorrectBlockCounter, rxModulation=rxModulation, tr2VoltageHighAlarm=tr2VoltageHighAlarm, txChannel=txChannel, alarmPeerDisconnected=alarmPeerDisconnected, tr2BerAlarm=tr2BerAlarm, txBroadcast=txBroadcast, rssAlarm=rssAlarm, swVer=swVer, autonego=autonego, httpd=httpd, peerEthLinkDown=peerEthLinkDown, tr2Eth21LinkDown=tr2Eth21LinkDown, peerNumber=peerNumber, maxNetBitrate=maxNetBitrate, alarmNetBitrate=alarmNetBitrate, rxControlFrames=rxControlFrames, txFreq=txFreq, ServiceState=ServiceState, useCpu=useCpu, alarmBer=alarmBer, airWdog=airWdog, swVerRadio=swVerRadio, timeAllConnect=timeAllConnect, ber=ber, ifEthEntry=ifEthEntry, eth1Link=eth1Link, keyEntry=keyEntry, rfPowerConfigured=rfPowerConfigured, ifEthTable=ifEthTable, mac=mac, status=status, bandwidth=bandwidth, temperatureRadio=temperatureRadio, useLogStorage=useLogStorage, ifEth=ifEth, pause=pause, wifiHAP=wifiHAP, ray=ray, bandwidthKHz=bandwidthKHz, rxCrcErrors=rxCrcErrors, txDones=txDones, keyName=keyName, info=info, txPauseFrames=txPauseFrames, product=product, berAlarm=berAlarm, lineStatus=lineStatus, rxOutOfRangeErrors=rxOutOfRangeErrors, tr2AirDisconnect=tr2AirDisconnect, tr2AirConnect=tr2AirConnect, tr2Eth1LinkDown=tr2Eth1LinkDown, rxCodeErrors=rxCodeErrors, systemStatus=systemStatus, duplex=duplex, useMemory=useMemory, temperatureModem=temperatureModem, channelArrangement=channelArrangement, txLengthCheckErrors=txLengthCheckErrors, rfPowerStatus=rfPowerStatus, rayTraps=rayTraps, rss=rss, authorization=authorization, ip=ip, eth2InThroughput=eth2InThroughput, snrAlarm=snrAlarm, tr2NetBitrate=tr2NetBitrate, alarmRss=alarmRss, numDisconnect=numDisconnect, AlarmState=AlarmState, txCollisions=txCollisions, rxChannel=rxChannel, serviceVlanId=serviceVlanId, reliability=reliability, system=system, rfPowerCurrent=rfPowerCurrent, tr2SnrAlarm=tr2SnrAlarm, station=station, securePeerMode=securePeerMode, ifRadio=ifRadio, tr2TemperatureAlarm=tr2TemperatureAlarm, tr2VoltageLowAlarm=tr2VoltageLowAlarm, radio=radio, DisplayString=DisplayString, alarmVoltageHigh=alarmVoltageHigh, OptionSetting=OptionSetting, txModulationIndex=txModulationIndex, ModulationList=ModulationList, alarm=alarm, fecBlockCounter=fecBlockCounter, ethernet=ethernet, timeAllDisconnect=timeAllDisconnect, rxPauseFrames=rxPauseFrames, speed=speed, eth2OutThroughput=eth2OutThroughput, productName=productName, keyTable=keyTable, ethOutThroughput=ethOutThroughput, ray2Traps=ray2Traps, tr2RfPowerFail=tr2RfPowerFail, sshd=sshd, alarmWifiOn=alarmWifiOn, telnetd=telnetd, eth2Link=eth2Link, serialNumber=serialNumber, matching=matching, mdix=mdix, timeMaxDisconnect=timeMaxDisconnect, rxBroadcast=rxBroadcast, lineStatusII=lineStatusII, alarmRfPowerFail=alarmRfPowerFail, airConnect=airConnect, rxFreq=rxFreq, txControlFrames=txControlFrames, rxModulationIndex=rxModulationIndex, managementVlan=managementVlan, txCrcErrors=txCrcErrors, snr=snr, unitType=unitType, airDisconnect=airDisconnect, tr2RssAlarm=tr2RssAlarm, txMulticast=txMulticast, deviceName=deviceName, txHCBytes=txHCBytes, alarmEth1Down=alarmEth1Down, PYSNMP_MODULE_ID=ray, searchModeDisabled=searchModeDisabled, rxHCBytes=rxHCBytes, interface=interface, alarmSnr=alarmSnr, ethPeer=ethPeer, rfPowerFail=rfPowerFail, voltageSource=voltageSource, asymPause=asymPause, alarmEth2Down=alarmEth2Down, memoryAlarm=memoryAlarm, chassis=chassis, netBitrate=netBitrate, tempAlarm=tempAlarm, rxDroppedPkts=rxDroppedPkts, voltageUnit=voltageUnit, tr2WifiOn=tr2WifiOn, prioritized=prioritized, managementVlanId=managementVlanId, powerAlarm=powerAlarm, vlanId=vlanId, ethInThroughput=ethInThroughput, alarmVoltageLow=alarmVoltageLow, rxFalseCarrierErrors=rxFalseCarrierErrors, coding=coding, access=access, rxDones=rxDones, txModulation=txModulation, linkUptime=linkUptime, rxMulticast=rxMulticast, statistic=statistic, racom=racom, modemR=modemR, PhysAddress=PhysAddress)
