...
# Produced by pysmi-1.1.8 at Tue Jan 18 13:49:27 2022
...
NotificationType, Gauge32, iso, enterprises, Bits, Unsigned32, Integer32, mib_2, IpAddress, TimeTicks, ObjectIdentity, MibIdentifier, Counter64, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "iso", "enterprises", "Bits", "Unsigned32", "Integer32", "mib-2", "IpAddress", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter64", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("RAY-MIB", alarmRfPowerFail=alarmRfPowerFail, ifEthTable=ifEthTable, tr2Eth1LinkDown=tr2Eth1LinkDown, rxChannel=rxChannel, ray2Traps=ray2Traps, asymPause=asymPause, ifEth=ifEth, ifRadio=ifRadio, productName=productName, alarmSnr=alarmSnr, tr2RfPowerFail=tr2RfPowerFail, alarmVoltageHigh=alarmVoltageHigh, temperatureModem=temperatureModem, prioritized=prioritized, rss=rss, berAlarm=berAlarm, txModulation=txModulation, txControlFrames=txControlFrames, modemR=modemR, ModulationList=ModulationList, alarmEth1Down=alarmEth1Down, ray=ray, station=station, txDones=txDones, rxModulation=rxModulation, ifEthEntry=ifEthEntry, txBroadcast=txBroadcast, numDisconnect=numDisconnect, fecBlockCounter=fecBlockCounter, alarmVoltageLow=alarmVoltageLow, product=product, DisplayString=DisplayString, alarm=alarm, OptionSetting=OptionSetting, vlanId=vlanId, httpd=httpd, lineStatusII=lineStatusII, txFreq=txFreq, rxCrcErrors=rxCrcErrors, info=info, maxNetBitrate=maxNetBitrate, autonego=autonego, voltageUnit=voltageUnit, unitType=unitType, searchModeDisabled=searchModeDisabled, eth2InThroughput=eth2InThroughput, rfPowerStatus=rfPowerStatus, eth1Link=eth1Link, rxOutOfRangeErrors=rxOutOfRangeErrors, txCollisions=txCollisions, channelArrangement=channelArrangement, airConnect=airConnect, matching=matching, access=access, serviceVlanId=serviceVlanId, rxBroadcast=rxBroadcast, rfPowerCurrent=rfPowerCurrent, lineStatus=lineStatus, ethPeer=ethPeer, temperatureRadio=temperatureRadio, tr2AirDisconnect=tr2AirDisconnect, managementVlan=managementVlan, ber=ber, system=system, systemStatus=systemStatus, chassis=chassis, alarmNetBitrate=alarmNetBitrate, tr2BerAlarm=tr2BerAlarm, ip=ip, alarmRss=alarmRss, txLengthCheckErrors=txLengthCheckErrors, swVer=swVer, rxPauseFrames=rxPauseFrames, peerEthLinkDown=peerEthLinkDown, statistic=statistic, txCrcErrors=txCrcErrors, txModulationIndex=txModulationIndex, fecUncorrectBlockCounter=fecUncorrectBlockCounter, alarmWifiOn=alarmWifiOn, ServiceState=ServiceState, tr2NetBitrate=tr2NetBitrate, keyEntry=keyEntry, tr2VoltageHighAlarm=tr2VoltageHighAlarm, mac=mac, AlarmState=AlarmState, tr2Eth21LinkDown=tr2Eth21LinkDown, PhysAddress=PhysAddress, txChannel=txChannel, tr2RssAlarm=tr2RssAlarm, rxModulationIndex=rxModulationIndex, voltageSource=voltageSource, eth2Link=eth2Link, managementVlanId=managementVlanId, status=status, airWdog=airWdog, rxHCBytes=rxHCBytes, tr2SnrAlarm=tr2SnrAlarm, alarmEth2Down=alarmEth2Down, peerNumber=peerNumber, bandwidthKHz=bandwidthKHz, ethInThroughput=ethInThroughput, alarmTemperature=alarmTemperature, powerAlarm=powerAlarm, bandwidth=bandwidth, netBitrate=netBitrate, racom=racom, rfPowerConfigured=rfPowerConfigured, txHCBytes=txHCBytes, rfPowerFail=rfPowerFail, sshd=sshd, rayTraps=rayTraps, timeAllConnect=timeAllConnect, radio=radio, speed=speed, useMemory=useMemory, txPauseFrames=txPauseFrames, rxControlFrames=rxControlFrames, securePeerMode=securePeerMode, alarmBer=alarmBer, rssAlarm=rssAlarm, timeMaxDisconnect=timeMaxDisconnect, tempAlarm=tempAlarm, tr2AirConnect=tr2AirConnect, rxFreq=rxFreq, useCpu=useCpu, linkUptime=linkUptime, eth2OutThroughput=eth2OutThroughput, useLogStorage=useLogStorage, memoryAlarm=memoryAlarm, rxCodeErrors=rxCodeErrors, swVerRadio=swVerRadio, snrAlarm=snrAlarm, serialNumber=serialNumber, alarmPeerDisconnected=alarmPeerDisconnected, rxDones=rxDones, interface=interface, mdix=mdix, timeAllDisconnect=timeAllDisconnect, telnetd=telnetd, deviceName=deviceName, duplex=duplex, coding=coding, reliability=reliability, ethernet=ethernet, ethOutThroughput=ethOutThroughput, rxMulticast=rxMulticast, txMulticast=txMulticast, PYSNMP_MODULE_ID=ray, snr=snr, rxDroppedPkts=rxDroppedPkts, tr2TemperatureAlarm=tr2TemperatureAlarm, wifiHAP=wifiHAP, authorization=authorization, rxFalseCarrierErrors=rxFalseCarrierErrors, pause=pause, tr2WifiOn=tr2WifiOn, tr2VoltageLowAlarm=tr2VoltageLowAlarm, airDisconnect=airDisconnect, keyTable=keyTable, keyName=keyName)
