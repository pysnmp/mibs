...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:22:59 2021
...
ModuleIdentity, ObjectIdentity, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Gauge32, Integer32, Unsigned32, TimeTicks, IpAddress, Bits, Counter64, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Gauge32", "Integer32", "Unsigned32", "TimeTicks", "IpAddress", "Bits", "Counter64", "iso", "Counter32")
...
mibBuilder.exportSymbols("RAY-MIB", ethOutThroughput=ethOutThroughput, alarmRfPowerFail=alarmRfPowerFail, tr2VoltageLowAlarm=tr2VoltageLowAlarm, rxChannel=rxChannel, ifEthEntry=ifEthEntry, rxDones=rxDones, txDones=txDones, deviceName=deviceName, PYSNMP_MODULE_ID=ray, alarmPeerDisconnected=alarmPeerDisconnected, ifEthTable=ifEthTable, rxControlFrames=rxControlFrames, AlarmState=AlarmState, statistic=statistic, berAlarm=berAlarm, rxDroppedPkts=rxDroppedPkts, rxFalseCarrierErrors=rxFalseCarrierErrors, modemR=modemR, txControlFrames=txControlFrames, rss=rss, txCrcErrors=txCrcErrors, telnetd=telnetd, tr2BerAlarm=tr2BerAlarm, txChannel=txChannel, ServiceState=ServiceState, rfPowerStatus=rfPowerStatus, airConnect=airConnect, temperatureRadio=temperatureRadio, rfPowerCurrent=rfPowerCurrent, rfPowerFail=rfPowerFail, tr2WifiOn=tr2WifiOn, ethernet=ethernet, eth1Link=eth1Link, snrAlarm=snrAlarm, alarmSnr=alarmSnr, fecBlockCounter=fecBlockCounter, rfPowerConfigured=rfPowerConfigured, sshd=sshd, rxBroadcast=rxBroadcast, peerNumber=peerNumber, tr2Eth21LinkDown=tr2Eth21LinkDown, radio=radio, securePeerMode=securePeerMode, product=product, ethInThroughput=ethInThroughput, prioritized=prioritized, timeAllDisconnect=timeAllDisconnect, tr2Eth1LinkDown=tr2Eth1LinkDown, linkUptime=linkUptime, serialNumber=serialNumber, racom=racom, chassis=chassis, systemStatus=systemStatus, netBitrate=netBitrate, alarmRss=alarmRss, productName=productName, temperatureModem=temperatureModem, timeMaxDisconnect=timeMaxDisconnect, access=access, txModulation=txModulation, OptionSetting=OptionSetting, useCpu=useCpu, mdix=mdix, lineStatusII=lineStatusII, httpd=httpd, lineStatus=lineStatus, tr2SnrAlarm=tr2SnrAlarm, unitType=unitType, tr2NetBitrate=tr2NetBitrate, ifRadio=ifRadio, keyEntry=keyEntry, voltageUnit=voltageUnit, numDisconnect=numDisconnect, station=station, rxMulticast=rxMulticast, voltageSource=voltageSource, tr2RfPowerFail=tr2RfPowerFail, tr2TemperatureAlarm=tr2TemperatureAlarm, alarmWifiOn=alarmWifiOn, swVerRadio=swVerRadio, swVer=swVer, authorization=authorization, duplex=duplex, status=status, alarmNetBitrate=alarmNetBitrate, rxCodeErrors=rxCodeErrors, alarmVoltageLow=alarmVoltageLow, useMemory=useMemory, txCollisions=txCollisions, bandwidth=bandwidth, rxModulationIndex=rxModulationIndex, rayTraps=rayTraps, ip=ip, matching=matching, rxPauseFrames=rxPauseFrames, fecUncorrectBlockCounter=fecUncorrectBlockCounter, airWdog=airWdog, channelArrangement=channelArrangement, keyName=keyName, txMulticast=txMulticast, useLogStorage=useLogStorage, ethPeer=ethPeer, powerAlarm=powerAlarm, ModulationList=ModulationList, system=system, interface=interface, keyTable=keyTable, memoryAlarm=memoryAlarm, txPauseFrames=txPauseFrames, alarmTemperature=alarmTemperature, ray=ray, coding=coding, alarmEth1Down=alarmEth1Down, PhysAddress=PhysAddress, txLengthCheckErrors=txLengthCheckErrors, alarmBer=alarmBer, autonego=autonego, DisplayString=DisplayString, alarmVoltageHigh=alarmVoltageHigh, wifiHAP=wifiHAP, speed=speed, ifEth=ifEth, info=info, asymPause=asymPause, serviceVlanId=serviceVlanId, txModulationIndex=txModulationIndex, mac=mac, eth2InThroughput=eth2InThroughput, ray2Traps=ray2Traps, txBroadcast=txBroadcast, rxHCBytes=rxHCBytes, airDisconnect=airDisconnect, peerEthLinkDown=peerEthLinkDown, txHCBytes=txHCBytes, bandwidthKHz=bandwidthKHz, rssAlarm=rssAlarm, tr2RssAlarm=tr2RssAlarm, reliability=reliability, tr2AirConnect=tr2AirConnect, ber=ber, managementVlan=managementVlan, tr2AirDisconnect=tr2AirDisconnect, rxFreq=rxFreq, searchModeDisabled=searchModeDisabled, timeAllConnect=timeAllConnect, snr=snr, rxOutOfRangeErrors=rxOutOfRangeErrors, tempAlarm=tempAlarm, managementVlanId=managementVlanId, maxNetBitrate=maxNetBitrate, eth2OutThroughput=eth2OutThroughput, alarm=alarm, tr2VoltageHighAlarm=tr2VoltageHighAlarm, rxModulation=rxModulation, rxCrcErrors=rxCrcErrors, eth2Link=eth2Link, pause=pause, vlanId=vlanId, alarmEth2Down=alarmEth2Down, txFreq=txFreq)
