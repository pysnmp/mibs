...
# Produced by pysmi-1.1.8 at Thu Sep  7 12:09:45 2023
...
mib_2, TimeTicks, Counter32, IpAddress, Gauge32, iso, MibIdentifier, Integer32, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, ModuleIdentity, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "Counter32", "IpAddress", "Gauge32", "iso", "MibIdentifier", "Integer32", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "ModuleIdentity", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("RAY-MIB", rxDroppedPkts=rxDroppedPkts, tr2WifiOn=tr2WifiOn, tr2SnrAlarm=tr2SnrAlarm, ServiceState=ServiceState, rxChannel=rxChannel, rxModulationIndex=rxModulationIndex, alarmVoltageHigh=alarmVoltageHigh, speed=speed, unitType=unitType, ethInThroughput=ethInThroughput, swVer=swVer, timeMaxDisconnect=timeMaxDisconnect, alarmRfPowerFail=alarmRfPowerFail, ber=ber, rxControlFrames=rxControlFrames, rxFalseCarrierErrors=rxFalseCarrierErrors, txMulticast=txMulticast, linkUptime=linkUptime, rxCodeErrors=rxCodeErrors, ip=ip, autonego=autonego, berAlarm=berAlarm, radio=radio, searchModeDisabled=searchModeDisabled, fecBlockCounter=fecBlockCounter, ethOutThroughput=ethOutThroughput, telnetd=telnetd, ethernet=ethernet, productName=productName, rfPowerConfigured=rfPowerConfigured, bandwidth=bandwidth, mdix=mdix, maxNetBitrate=maxNetBitrate, interface=interface, ifEth=ifEth, txModulation=txModulation, airWdog=airWdog, matching=matching, tr2VoltageHighAlarm=tr2VoltageHighAlarm, ethPeer=ethPeer, alarm=alarm, txCollisions=txCollisions, OptionSetting=OptionSetting, ModulationList=ModulationList, swVerRadio=swVerRadio, fecUncorrectBlockCounter=fecUncorrectBlockCounter, modemR=modemR, useMemory=useMemory, PhysAddress=PhysAddress, alarmNetBitrate=alarmNetBitrate, peerEthLinkDown=peerEthLinkDown, txFreq=txFreq, DisplayString=DisplayString, asymPause=asymPause, rssAlarm=rssAlarm, eth2Link=eth2Link, statistic=statistic, prioritized=prioritized, powerAlarm=powerAlarm, rayTraps=rayTraps, chassis=chassis, rxMulticast=rxMulticast, txCrcErrors=txCrcErrors, eth2OutThroughput=eth2OutThroughput, coding=coding, bandwidthKHz=bandwidthKHz, managementVlan=managementVlan, tr2VoltageLowAlarm=tr2VoltageLowAlarm, rxOutOfRangeErrors=rxOutOfRangeErrors, pause=pause, txBroadcast=txBroadcast, rxModulation=rxModulation, snr=snr, voltageSource=voltageSource, tr2NetBitrate=tr2NetBitrate, netBitrate=netBitrate, txModulationIndex=txModulationIndex, snrAlarm=snrAlarm, lineStatus=lineStatus, ifEthEntry=ifEthEntry, txPauseFrames=txPauseFrames, txChannel=txChannel, rxCrcErrors=rxCrcErrors, txLengthCheckErrors=txLengthCheckErrors, keyName=keyName, systemStatus=systemStatus, tr2Eth1LinkDown=tr2Eth1LinkDown, PYSNMP_MODULE_ID=ray, tr2RfPowerFail=tr2RfPowerFail, eth2InThroughput=eth2InThroughput, alarmTemperature=alarmTemperature, rxFreq=rxFreq, product=product, keyEntry=keyEntry, serviceVlanId=serviceVlanId, ray=ray, timeAllConnect=timeAllConnect, tempAlarm=tempAlarm, ifEthTable=ifEthTable, rfPowerFail=rfPowerFail, ray2Traps=ray2Traps, tr2AirDisconnect=tr2AirDisconnect, racom=racom, alarmWifiOn=alarmWifiOn, rxHCBytes=rxHCBytes, ifRadio=ifRadio, station=station, lineStatusII=lineStatusII, txControlFrames=txControlFrames, rxDones=rxDones, alarmRss=alarmRss, securePeerMode=securePeerMode, tr2Eth21LinkDown=tr2Eth21LinkDown, alarmPeerDisconnected=alarmPeerDisconnected, rfPowerCurrent=rfPowerCurrent, airConnect=airConnect, httpd=httpd, keyTable=keyTable, timeAllDisconnect=timeAllDisconnect, reliability=reliability, serialNumber=serialNumber, alarmSnr=alarmSnr, tr2RssAlarm=tr2RssAlarm, useCpu=useCpu, rss=rss, info=info, vlanId=vlanId, status=status, peerNumber=peerNumber, deviceName=deviceName, tr2AirConnect=tr2AirConnect, managementVlanId=managementVlanId, airDisconnect=airDisconnect, memoryAlarm=memoryAlarm, tr2TemperatureAlarm=tr2TemperatureAlarm, txHCBytes=txHCBytes, system=system, authorization=authorization, alarmVoltageLow=alarmVoltageLow, rxBroadcast=rxBroadcast, access=access, alarmBer=alarmBer, useLogStorage=useLogStorage, sshd=sshd, rxPauseFrames=rxPauseFrames, numDisconnect=numDisconnect, tr2BerAlarm=tr2BerAlarm, AlarmState=AlarmState, temperatureRadio=temperatureRadio, alarmEth1Down=alarmEth1Down, wifiHAP=wifiHAP, channelArrangement=channelArrangement, rfPowerStatus=rfPowerStatus, alarmEth2Down=alarmEth2Down, mac=mac, voltageUnit=voltageUnit, duplex=duplex, txDones=txDones, temperatureModem=temperatureModem, eth1Link=eth1Link)
