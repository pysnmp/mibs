...
ModuleIdentity, MibIdentifier, TimeTicks, NotificationType, Unsigned32, Gauge32, Bits, ObjectIdentity, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, Counter32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "Unsigned32", "Gauge32", "Bits", "ObjectIdentity", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "Counter32", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", tr2Eth21LinkDown=tr2Eth21LinkDown, searchModeDisabled=searchModeDisabled, rxModulationIndex=rxModulationIndex, txControlFrames=txControlFrames, mdix=mdix, tr2Eth1LinkDown=tr2Eth1LinkDown, reliability=reliability, system=system, ip=ip, duplex=duplex, netBitrate=netBitrate, rfPowerFail=rfPowerFail, keyTable=keyTable, matching=matching, managementVlan=managementVlan, timeAllDisconnect=timeAllDisconnect, memoryAlarm=memoryAlarm, httpd=httpd, tr2TemperatureAlarm=tr2TemperatureAlarm, tr2VoltageHighAlarm=tr2VoltageHighAlarm, useCpu=useCpu, rfPowerConfigured=rfPowerConfigured, rxDones=rxDones, ethOutThroughput=ethOutThroughput, maxNetBitrate=maxNetBitrate, temperatureRadio=temperatureRadio, ifEthEntry=ifEthEntry, ray2Traps=ray2Traps, airConnect=airConnect, productName=productName, txModulation=txModulation, tr2NetBitrate=tr2NetBitrate, serviceVlanId=serviceVlanId, alarmSnr=alarmSnr, authorization=authorization, rxPauseFrames=rxPauseFrames, chassis=chassis, securePeerMode=securePeerMode, alarmTemperature=alarmTemperature, racom=racom, txLengthCheckErrors=txLengthCheckErrors, ModulationList=ModulationList, autonego=autonego, ServiceState=ServiceState, alarmNetBitrate=alarmNetBitrate, peerNumber=peerNumber, alarmRfPowerFail=alarmRfPowerFail, rxCrcErrors=rxCrcErrors, telnetd=telnetd, rxOutOfRangeErrors=rxOutOfRangeErrors, fecBlockCounter=fecBlockCounter, txBroadcast=txBroadcast, eth2Link=eth2Link, keyEntry=keyEntry, alarm=alarm, rxFalseCarrierErrors=rxFalseCarrierErrors, useLogStorage=useLogStorage, rss=rss, alarmBer=alarmBer, alarmEth2Down=alarmEth2Down, eth2InThroughput=eth2InThroughput, voltageSource=voltageSource, rxChannel=rxChannel, txCrcErrors=txCrcErrors, product=product, OptionSetting=OptionSetting, rfPowerStatus=rfPowerStatus, txDones=txDones, managementVlanId=managementVlanId, tempAlarm=tempAlarm, peerEthLinkDown=peerEthLinkDown, keyName=keyName, txFreq=txFreq, voltageUnit=voltageUnit, powerAlarm=powerAlarm, access=access, txHCBytes=txHCBytes, rxControlFrames=rxControlFrames, lineStatusII=lineStatusII, timeMaxDisconnect=timeMaxDisconnect, rssAlarm=rssAlarm, tr2SnrAlarm=tr2SnrAlarm, swVer=swVer, modemR=modemR, ifEthTable=ifEthTable, snr=snr, rxMulticast=rxMulticast, temperatureModem=temperatureModem, airDisconnect=airDisconnect, eth1Link=eth1Link, vlanId=vlanId, rxCodeErrors=rxCodeErrors, tr2VoltageLowAlarm=tr2VoltageLowAlarm, rxBroadcast=rxBroadcast, AlarmState=AlarmState, alarmRss=alarmRss, bandwidth=bandwidth, ethernet=ethernet, PhysAddress=PhysAddress, DisplayString=DisplayString, fecUncorrectBlockCounter=fecUncorrectBlockCounter, swVerRadio=swVerRadio, rayTraps=rayTraps, bandwidthKHz=bandwidthKHz, ifEth=ifEth, speed=speed, rxModulation=rxModulation, tr2RssAlarm=tr2RssAlarm, channelArrangement=channelArrangement, pause=pause, serialNumber=serialNumber, snrAlarm=snrAlarm, status=status, txModulationIndex=txModulationIndex, airWdog=airWdog, tr2WifiOn=tr2WifiOn, rxHCBytes=rxHCBytes, txChannel=txChannel, rfPowerCurrent=rfPowerCurrent, prioritized=prioritized, deviceName=deviceName, tr2AirDisconnect=tr2AirDisconnect, station=station, tr2AirConnect=tr2AirConnect, txMulticast=txMulticast, mac=mac, alarmVoltageHigh=alarmVoltageHigh, tr2RfPowerFail=tr2RfPowerFail, alarmVoltageLow=alarmVoltageLow, radio=radio, sshd=sshd, alarmWifiOn=alarmWifiOn, lineStatus=lineStatus, alarmPeerDisconnected=alarmPeerDisconnected, coding=coding, unitType=unitType, systemStatus=systemStatus, linkUptime=linkUptime, rxDroppedPkts=rxDroppedPkts, info=info, ifRadio=ifRadio, ethPeer=ethPeer, eth2OutThroughput=eth2OutThroughput, timeAllConnect=timeAllConnect, berAlarm=berAlarm, ethInThroughput=ethInThroughput, PYSNMP_MODULE_ID=ray, asymPause=asymPause, alarmEth1Down=alarmEth1Down, rxFreq=rxFreq, useMemory=useMemory, ray=ray, tr2BerAlarm=tr2BerAlarm, wifiHAP=wifiHAP, txPauseFrames=txPauseFrames, numDisconnect=numDisconnect, statistic=statistic, txCollisions=txCollisions, interface=interface, ber=ber)
