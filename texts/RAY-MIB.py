...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:51:04 2022
...
mib_2, Bits, ObjectIdentity, Counter64, MibIdentifier, ModuleIdentity, Integer32, enterprises, Gauge32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "ObjectIdentity", "Counter64", "MibIdentifier", "ModuleIdentity", "Integer32", "enterprises", "Gauge32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("RAY-MIB", linkUptime=linkUptime, ifRadio=ifRadio, serviceVlanId=serviceVlanId, rxCrcErrors=rxCrcErrors, rss=rss, status=status, access=access, txControlFrames=txControlFrames, rxDones=rxDones, tr2SnrAlarm=tr2SnrAlarm, rxPauseFrames=rxPauseFrames, rxFreq=rxFreq, authorization=authorization, tempAlarm=tempAlarm, tr2NetBitrate=tr2NetBitrate, tr2AirConnect=tr2AirConnect, product=product, ethOutThroughput=ethOutThroughput, serialNumber=serialNumber, keyEntry=keyEntry, alarmVoltageHigh=alarmVoltageHigh, channelArrangement=channelArrangement, temperatureModem=temperatureModem, lineStatus=lineStatus, sshd=sshd, securePeerMode=securePeerMode, ModulationList=ModulationList, rxModulationIndex=rxModulationIndex, tr2BerAlarm=tr2BerAlarm, rfPowerFail=rfPowerFail, tr2VoltageHighAlarm=tr2VoltageHighAlarm, alarmNetBitrate=alarmNetBitrate, txDones=txDones, timeMaxDisconnect=timeMaxDisconnect, tr2WifiOn=tr2WifiOn, peerEthLinkDown=peerEthLinkDown, useMemory=useMemory, telnetd=telnetd, useLogStorage=useLogStorage, tr2RfPowerFail=tr2RfPowerFail, ifEth=ifEth, rayTraps=rayTraps, searchModeDisabled=searchModeDisabled, tr2VoltageLowAlarm=tr2VoltageLowAlarm, swVer=swVer, OptionSetting=OptionSetting, txBroadcast=txBroadcast, txCollisions=txCollisions, mdix=mdix, netBitrate=netBitrate, txMulticast=txMulticast, interface=interface, maxNetBitrate=maxNetBitrate, bandwidthKHz=bandwidthKHz, speed=speed, voltageUnit=voltageUnit, productName=productName, memoryAlarm=memoryAlarm, txLengthCheckErrors=txLengthCheckErrors, bandwidth=bandwidth, ray=ray, lineStatusII=lineStatusII, reliability=reliability, rxCodeErrors=rxCodeErrors, rxOutOfRangeErrors=rxOutOfRangeErrors, duplex=duplex, fecUncorrectBlockCounter=fecUncorrectBlockCounter, httpd=httpd, tr2AirDisconnect=tr2AirDisconnect, prioritized=prioritized, coding=coding, ethernet=ethernet, rxHCBytes=rxHCBytes, berAlarm=berAlarm, alarmEth1Down=alarmEth1Down, rxControlFrames=rxControlFrames, powerAlarm=powerAlarm, ifEthEntry=ifEthEntry, ip=ip, peerNumber=peerNumber, voltageSource=voltageSource, unitType=unitType, txModulationIndex=txModulationIndex, ifEthTable=ifEthTable, timeAllDisconnect=timeAllDisconnect, modemR=modemR, rxFalseCarrierErrors=rxFalseCarrierErrors, txCrcErrors=txCrcErrors, info=info, ServiceState=ServiceState, wifiHAP=wifiHAP, keyName=keyName, ethInThroughput=ethInThroughput, numDisconnect=numDisconnect, AlarmState=AlarmState, eth2InThroughput=eth2InThroughput, timeAllConnect=timeAllConnect, ray2Traps=ray2Traps, alarmVoltageLow=alarmVoltageLow, tr2Eth21LinkDown=tr2Eth21LinkDown, txModulation=txModulation, vlanId=vlanId, radio=radio, autonego=autonego, txPauseFrames=txPauseFrames, snrAlarm=snrAlarm, rxChannel=rxChannel, alarmPeerDisconnected=alarmPeerDisconnected, rssAlarm=rssAlarm, statistic=statistic, DisplayString=DisplayString, txHCBytes=txHCBytes, eth1Link=eth1Link, snr=snr, airWdog=airWdog, txChannel=txChannel, tr2Eth1LinkDown=tr2Eth1LinkDown, alarmRfPowerFail=alarmRfPowerFail, rfPowerConfigured=rfPowerConfigured, managementVlanId=managementVlanId, ethPeer=ethPeer, airDisconnect=airDisconnect, txFreq=txFreq, keyTable=keyTable, rfPowerCurrent=rfPowerCurrent, swVerRadio=swVerRadio, systemStatus=systemStatus, alarmTemperature=alarmTemperature, tr2TemperatureAlarm=tr2TemperatureAlarm, airConnect=airConnect, alarmBer=alarmBer, rxMulticast=rxMulticast, ber=ber, PhysAddress=PhysAddress, eth2Link=eth2Link, matching=matching, alarmSnr=alarmSnr, temperatureRadio=temperatureRadio, managementVlan=managementVlan, asymPause=asymPause, station=station, rxDroppedPkts=rxDroppedPkts, rxModulation=rxModulation, pause=pause, fecBlockCounter=fecBlockCounter, mac=mac, racom=racom, useCpu=useCpu, chassis=chassis, rfPowerStatus=rfPowerStatus, eth2OutThroughput=eth2OutThroughput, rxBroadcast=rxBroadcast, deviceName=deviceName, system=system, alarm=alarm, alarmWifiOn=alarmWifiOn, alarmRss=alarmRss, alarmEth2Down=alarmEth2Down, PYSNMP_MODULE_ID=ray, tr2RssAlarm=tr2RssAlarm)
