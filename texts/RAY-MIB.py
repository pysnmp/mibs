...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:59:51 2022
...
Counter64, enterprises, iso, IpAddress, Unsigned32, mib_2, TimeTicks, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Gauge32, MibIdentifier, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "iso", "IpAddress", "Unsigned32", "mib-2", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Gauge32", "MibIdentifier", "Bits", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", authorization=authorization, voltageSource=voltageSource, rxCodeErrors=rxCodeErrors, reliability=reliability, txLengthCheckErrors=txLengthCheckErrors, alarmEth2Down=alarmEth2Down, rxPauseFrames=rxPauseFrames, useMemory=useMemory, txFreq=txFreq, speed=speed, txHCBytes=txHCBytes, mdix=mdix, ethPeer=ethPeer, bandwidthKHz=bandwidthKHz, alarmSnr=alarmSnr, peerNumber=peerNumber, tempAlarm=tempAlarm, fecUncorrectBlockCounter=fecUncorrectBlockCounter, station=station, txPauseFrames=txPauseFrames, statistic=statistic, useLogStorage=useLogStorage, rss=rss, txCrcErrors=txCrcErrors, swVerRadio=swVerRadio, linkUptime=linkUptime, alarmVoltageHigh=alarmVoltageHigh, rxBroadcast=rxBroadcast, ethOutThroughput=ethOutThroughput, timeMaxDisconnect=timeMaxDisconnect, rayTraps=rayTraps, ifEthEntry=ifEthEntry, serialNumber=serialNumber, timeAllDisconnect=timeAllDisconnect, searchModeDisabled=searchModeDisabled, alarm=alarm, ifEth=ifEth, ethInThroughput=ethInThroughput, memoryAlarm=memoryAlarm, txBroadcast=txBroadcast, mac=mac, alarmEth1Down=alarmEth1Down, managementVlanId=managementVlanId, temperatureRadio=temperatureRadio, rxHCBytes=rxHCBytes, OptionSetting=OptionSetting, rxMulticast=rxMulticast, powerAlarm=powerAlarm, httpd=httpd, airDisconnect=airDisconnect, productName=productName, matching=matching, useCpu=useCpu, rfPowerFail=rfPowerFail, coding=coding, racom=racom, eth2Link=eth2Link, rxChannel=rxChannel, rxModulationIndex=rxModulationIndex, ifEthTable=ifEthTable, vlanId=vlanId, product=product, info=info, serviceVlanId=serviceVlanId, txModulationIndex=txModulationIndex, system=system, tr2TemperatureAlarm=tr2TemperatureAlarm, radio=radio, alarmNetBitrate=alarmNetBitrate, channelArrangement=channelArrangement, txModulation=txModulation, keyName=keyName, rfPowerCurrent=rfPowerCurrent, ifRadio=ifRadio, snrAlarm=snrAlarm, lineStatusII=lineStatusII, rxCrcErrors=rxCrcErrors, sshd=sshd, maxNetBitrate=maxNetBitrate, rxDones=rxDones, tr2AirDisconnect=tr2AirDisconnect, access=access, numDisconnect=numDisconnect, deviceName=deviceName, tr2RfPowerFail=tr2RfPowerFail, DisplayString=DisplayString, rfPowerConfigured=rfPowerConfigured, airConnect=airConnect, ServiceState=ServiceState, fecBlockCounter=fecBlockCounter, eth2OutThroughput=eth2OutThroughput, peerEthLinkDown=peerEthLinkDown, pause=pause, txDones=txDones, prioritized=prioritized, tr2VoltageHighAlarm=tr2VoltageHighAlarm, autonego=autonego, lineStatus=lineStatus, txControlFrames=txControlFrames, txCollisions=txCollisions, tr2BerAlarm=tr2BerAlarm, unitType=unitType, keyTable=keyTable, ray2Traps=ray2Traps, netBitrate=netBitrate, temperatureModem=temperatureModem, rxModulation=rxModulation, airWdog=airWdog, bandwidth=bandwidth, asymPause=asymPause, rxDroppedPkts=rxDroppedPkts, securePeerMode=securePeerMode, ip=ip, tr2NetBitrate=tr2NetBitrate, rxControlFrames=rxControlFrames, PhysAddress=PhysAddress, swVer=swVer, ethernet=ethernet, chassis=chassis, alarmWifiOn=alarmWifiOn, duplex=duplex, rxOutOfRangeErrors=rxOutOfRangeErrors, tr2Eth1LinkDown=tr2Eth1LinkDown, systemStatus=systemStatus, berAlarm=berAlarm, keyEntry=keyEntry, alarmTemperature=alarmTemperature, txChannel=txChannel, timeAllConnect=timeAllConnect, rssAlarm=rssAlarm, tr2AirConnect=tr2AirConnect, modemR=modemR, ray=ray, rfPowerStatus=rfPowerStatus, snr=snr, alarmRss=alarmRss, wifiHAP=wifiHAP, tr2WifiOn=tr2WifiOn, interface=interface, alarmVoltageLow=alarmVoltageLow, tr2Eth21LinkDown=tr2Eth21LinkDown, tr2SnrAlarm=tr2SnrAlarm, status=status, eth1Link=eth1Link, managementVlan=managementVlan, tr2RssAlarm=tr2RssAlarm, alarmPeerDisconnected=alarmPeerDisconnected, txMulticast=txMulticast, PYSNMP_MODULE_ID=ray, voltageUnit=voltageUnit, ber=ber, AlarmState=AlarmState, rxFreq=rxFreq, ModulationList=ModulationList, rxFalseCarrierErrors=rxFalseCarrierErrors, alarmRfPowerFail=alarmRfPowerFail, tr2VoltageLowAlarm=tr2VoltageLowAlarm, alarmBer=alarmBer, eth2InThroughput=eth2InThroughput, telnetd=telnetd)
