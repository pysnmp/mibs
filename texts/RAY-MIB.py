...
Bits, Counter32, enterprises, mib_2, Unsigned32, IpAddress, iso, Integer32, ModuleIdentity, NotificationType, Gauge32, MibIdentifier, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "enterprises", "mib-2", "Unsigned32", "IpAddress", "iso", "Integer32", "ModuleIdentity", "NotificationType", "Gauge32", "MibIdentifier", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("RAY-MIB", vlanId=vlanId, useCpu=useCpu, eth2InThroughput=eth2InThroughput, txHCBytes=txHCBytes, alarmVoltageHigh=alarmVoltageHigh, txPauseFrames=txPauseFrames, tr2VoltageHighAlarm=tr2VoltageHighAlarm, managementVlan=managementVlan, rfPowerCurrent=rfPowerCurrent, rxCodeErrors=rxCodeErrors, tr2WifiOn=tr2WifiOn, ethernet=ethernet, fecUncorrectBlockCounter=fecUncorrectBlockCounter, lineStatus=lineStatus, ethPeer=ethPeer, systemStatus=systemStatus, alarmRss=alarmRss, rayTraps=rayTraps, rxChannel=rxChannel, useMemory=useMemory, temperatureRadio=temperatureRadio, rss=rss, tr2BerAlarm=tr2BerAlarm, timeAllDisconnect=timeAllDisconnect, bandwidth=bandwidth, station=station, txFreq=txFreq, tr2AirConnect=tr2AirConnect, tr2RfPowerFail=tr2RfPowerFail, ethOutThroughput=ethOutThroughput, tr2RssAlarm=tr2RssAlarm, voltageSource=voltageSource, tr2NetBitrate=tr2NetBitrate, alarmRfPowerFail=alarmRfPowerFail, access=access, txControlFrames=txControlFrames, ifEthTable=ifEthTable, keyEntry=keyEntry, airWdog=airWdog, rxModulationIndex=rxModulationIndex, mdix=mdix, rxCrcErrors=rxCrcErrors, timeMaxDisconnect=timeMaxDisconnect, ServiceState=ServiceState, txModulationIndex=txModulationIndex, sshd=sshd, ray2Traps=ray2Traps, snrAlarm=snrAlarm, prioritized=prioritized, rxDones=rxDones, alarmSnr=alarmSnr, ifEth=ifEth, productName=productName, timeAllConnect=timeAllConnect, coding=coding, berAlarm=berAlarm, numDisconnect=numDisconnect, txCollisions=txCollisions, rxFalseCarrierErrors=rxFalseCarrierErrors, AlarmState=AlarmState, txCrcErrors=txCrcErrors, rxControlFrames=rxControlFrames, fecBlockCounter=fecBlockCounter, lineStatusII=lineStatusII, mac=mac, authorization=authorization, securePeerMode=securePeerMode, modemR=modemR, keyTable=keyTable, alarmWifiOn=alarmWifiOn, peerEthLinkDown=peerEthLinkDown, status=status, tr2Eth1LinkDown=tr2Eth1LinkDown, tr2Eth21LinkDown=tr2Eth21LinkDown, rxModulation=rxModulation, rxMulticast=rxMulticast, product=product, airDisconnect=airDisconnect, serialNumber=serialNumber, statistic=statistic, txDones=txDones, tr2TemperatureAlarm=tr2TemperatureAlarm, system=system, managementVlanId=managementVlanId, alarmEth1Down=alarmEth1Down, peerNumber=peerNumber, httpd=httpd, alarm=alarm, txMulticast=txMulticast, unitType=unitType, swVer=swVer, tempAlarm=tempAlarm, ray=ray, telnetd=telnetd, rxFreq=rxFreq, ifEthEntry=ifEthEntry, deviceName=deviceName, rssAlarm=rssAlarm, rfPowerConfigured=rfPowerConfigured, alarmVoltageLow=alarmVoltageLow, rxOutOfRangeErrors=rxOutOfRangeErrors, linkUptime=linkUptime, voltageUnit=voltageUnit, info=info, txLengthCheckErrors=txLengthCheckErrors, tr2AirDisconnect=tr2AirDisconnect, rxHCBytes=rxHCBytes, alarmPeerDisconnected=alarmPeerDisconnected, DisplayString=DisplayString, tr2VoltageLowAlarm=tr2VoltageLowAlarm, powerAlarm=powerAlarm, racom=racom, speed=speed, eth1Link=eth1Link, PhysAddress=PhysAddress, alarmBer=alarmBer, ifRadio=ifRadio, rfPowerFail=rfPowerFail, ethInThroughput=ethInThroughput, temperatureModem=temperatureModem, bandwidthKHz=bandwidthKHz, radio=radio, searchModeDisabled=searchModeDisabled, pause=pause, ip=ip, netBitrate=netBitrate, alarmNetBitrate=alarmNetBitrate, chassis=chassis, txModulation=txModulation, airConnect=airConnect, serviceVlanId=serviceVlanId, alarmTemperature=alarmTemperature, asymPause=asymPause, txChannel=txChannel, wifiHAP=wifiHAP, autonego=autonego, OptionSetting=OptionSetting, ModulationList=ModulationList, snr=snr, rxDroppedPkts=rxDroppedPkts, memoryAlarm=memoryAlarm, tr2SnrAlarm=tr2SnrAlarm, ber=ber, alarmEth2Down=alarmEth2Down, useLogStorage=useLogStorage, channelArrangement=channelArrangement, rxBroadcast=rxBroadcast, matching=matching, keyName=keyName, duplex=duplex, rxPauseFrames=rxPauseFrames, swVerRadio=swVerRadio, interface=interface, txBroadcast=txBroadcast, eth2Link=eth2Link, rfPowerStatus=rfPowerStatus, reliability=reliability, PYSNMP_MODULE_ID=ray, maxNetBitrate=maxNetBitrate, eth2OutThroughput=eth2OutThroughput)
