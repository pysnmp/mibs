...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:36:53 2023
...
Bits, Unsigned32, MibIdentifier, enterprises, ObjectIdentity, mib_2, iso, Counter64, IpAddress, NotificationType, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "MibIdentifier", "enterprises", "ObjectIdentity", "mib-2", "iso", "Counter64", "IpAddress", "NotificationType", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", alarmTemperature=alarmTemperature, txCrcErrors=txCrcErrors, alarmNetBitrate=alarmNetBitrate, airWdog=airWdog, rxModulation=rxModulation, bandwidthKHz=bandwidthKHz, fecUncorrectBlockCounter=fecUncorrectBlockCounter, racom=racom, unitType=unitType, sshd=sshd, rxDroppedPkts=rxDroppedPkts, tr2NetBitrate=tr2NetBitrate, txModulation=txModulation, txDones=txDones, voltageUnit=voltageUnit, AlarmState=AlarmState, rxFalseCarrierErrors=rxFalseCarrierErrors, reliability=reliability, netBitrate=netBitrate, ethInThroughput=ethInThroughput, ray2Traps=ray2Traps, asymPause=asymPause, txChannel=txChannel, tempAlarm=tempAlarm, snrAlarm=snrAlarm, tr2BerAlarm=tr2BerAlarm, eth2OutThroughput=eth2OutThroughput, rfPowerStatus=rfPowerStatus, temperatureRadio=temperatureRadio, rxCrcErrors=rxCrcErrors, voltageSource=voltageSource, pause=pause, txModulationIndex=txModulationIndex, timeAllConnect=timeAllConnect, ServiceState=ServiceState, airConnect=airConnect, tr2Eth1LinkDown=tr2Eth1LinkDown, keyName=keyName, rayTraps=rayTraps, rfPowerFail=rfPowerFail, txPauseFrames=txPauseFrames, serviceVlanId=serviceVlanId, useLogStorage=useLogStorage, modemR=modemR, securePeerMode=securePeerMode, alarmVoltageLow=alarmVoltageLow, ifEthEntry=ifEthEntry, speed=speed, systemStatus=systemStatus, prioritized=prioritized, txCollisions=txCollisions, timeAllDisconnect=timeAllDisconnect, tr2SnrAlarm=tr2SnrAlarm, tr2RfPowerFail=tr2RfPowerFail, temperatureModem=temperatureModem, numDisconnect=numDisconnect, rxFreq=rxFreq, useMemory=useMemory, rxModulationIndex=rxModulationIndex, timeMaxDisconnect=timeMaxDisconnect, searchModeDisabled=searchModeDisabled, maxNetBitrate=maxNetBitrate, system=system, managementVlanId=managementVlanId, chassis=chassis, eth1Link=eth1Link, airDisconnect=airDisconnect, PhysAddress=PhysAddress, ethPeer=ethPeer, txMulticast=txMulticast, txFreq=txFreq, alarmRfPowerFail=alarmRfPowerFail, PYSNMP_MODULE_ID=ray, ray=ray, snr=snr, lineStatus=lineStatus, authorization=authorization, httpd=httpd, ethernet=ethernet, fecBlockCounter=fecBlockCounter, rfPowerCurrent=rfPowerCurrent, productName=productName, info=info, vlanId=vlanId, alarmRss=alarmRss, berAlarm=berAlarm, product=product, mdix=mdix, duplex=duplex, rxPauseFrames=rxPauseFrames, alarmVoltageHigh=alarmVoltageHigh, alarmEth1Down=alarmEth1Down, rxOutOfRangeErrors=rxOutOfRangeErrors, keyEntry=keyEntry, tr2AirConnect=tr2AirConnect, txBroadcast=txBroadcast, rss=rss, memoryAlarm=memoryAlarm, tr2WifiOn=tr2WifiOn, interface=interface, rxBroadcast=rxBroadcast, txLengthCheckErrors=txLengthCheckErrors, useCpu=useCpu, ifEthTable=ifEthTable, powerAlarm=powerAlarm, swVer=swVer, tr2VoltageHighAlarm=tr2VoltageHighAlarm, linkUptime=linkUptime, lineStatusII=lineStatusII, channelArrangement=channelArrangement, telnetd=telnetd, ip=ip, rfPowerConfigured=rfPowerConfigured, alarmWifiOn=alarmWifiOn, ModulationList=ModulationList, ethOutThroughput=ethOutThroughput, DisplayString=DisplayString, station=station, eth2InThroughput=eth2InThroughput, statistic=statistic, radio=radio, bandwidth=bandwidth, status=status, rxMulticast=rxMulticast, eth2Link=eth2Link, ifRadio=ifRadio, wifiHAP=wifiHAP, deviceName=deviceName, rxControlFrames=rxControlFrames, coding=coding, managementVlan=managementVlan, alarmSnr=alarmSnr, matching=matching, OptionSetting=OptionSetting, txControlFrames=txControlFrames, alarm=alarm, keyTable=keyTable, rxHCBytes=rxHCBytes, rssAlarm=rssAlarm, alarmBer=alarmBer, tr2Eth21LinkDown=tr2Eth21LinkDown, tr2VoltageLowAlarm=tr2VoltageLowAlarm, txHCBytes=txHCBytes, tr2AirDisconnect=tr2AirDisconnect, ber=ber, access=access, alarmPeerDisconnected=alarmPeerDisconnected, peerNumber=peerNumber, rxChannel=rxChannel, tr2TemperatureAlarm=tr2TemperatureAlarm, tr2RssAlarm=tr2RssAlarm, alarmEth2Down=alarmEth2Down, swVerRadio=swVerRadio, serialNumber=serialNumber, autonego=autonego, rxCodeErrors=rxCodeErrors, peerEthLinkDown=peerEthLinkDown, ifEth=ifEth, mac=mac, rxDones=rxDones)
