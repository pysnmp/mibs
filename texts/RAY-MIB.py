...
Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Unsigned32, mib_2, Integer32, NotificationType, Gauge32, Counter64, ObjectIdentity, TimeTicks, Counter32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Unsigned32", "mib-2", "Integer32", "NotificationType", "Gauge32", "Counter64", "ObjectIdentity", "TimeTicks", "Counter32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("RAY-MIB", txCrcErrors=txCrcErrors, ip=ip, snrAlarm=snrAlarm, txLengthCheckErrors=txLengthCheckErrors, numDisconnect=numDisconnect, useLogStorage=useLogStorage, alarmRss=alarmRss, autonego=autonego, tr2WifiOn=tr2WifiOn, lineStatus=lineStatus, tr2SnrAlarm=tr2SnrAlarm, bandwidthKHz=bandwidthKHz, txMulticast=txMulticast, rxModulationIndex=rxModulationIndex, wifiHAP=wifiHAP, voltageSource=voltageSource, ifRadio=ifRadio, swVerRadio=swVerRadio, DisplayString=DisplayString, rxCrcErrors=rxCrcErrors, ModulationList=ModulationList, speed=speed, rxHCBytes=rxHCBytes, keyTable=keyTable, peerNumber=peerNumber, useCpu=useCpu, tr2TemperatureAlarm=tr2TemperatureAlarm, alarmVoltageHigh=alarmVoltageHigh, rxOutOfRangeErrors=rxOutOfRangeErrors, eth2OutThroughput=eth2OutThroughput, linkUptime=linkUptime, timeMaxDisconnect=timeMaxDisconnect, rfPowerFail=rfPowerFail, txCollisions=txCollisions, httpd=httpd, tr2VoltageLowAlarm=tr2VoltageLowAlarm, ber=ber, ray2Traps=ray2Traps, fecUncorrectBlockCounter=fecUncorrectBlockCounter, lineStatusII=lineStatusII, alarmEth2Down=alarmEth2Down, ray=ray, coding=coding, airWdog=airWdog, serialNumber=serialNumber, powerAlarm=powerAlarm, ifEthEntry=ifEthEntry, peerEthLinkDown=peerEthLinkDown, product=product, deviceName=deviceName, statistic=statistic, AlarmState=AlarmState, fecBlockCounter=fecBlockCounter, tempAlarm=tempAlarm, productName=productName, txChannel=txChannel, rxModulation=rxModulation, rxCodeErrors=rxCodeErrors, airDisconnect=airDisconnect, alarmEth1Down=alarmEth1Down, bandwidth=bandwidth, access=access, managementVlan=managementVlan, rxDroppedPkts=rxDroppedPkts, serviceVlanId=serviceVlanId, timeAllDisconnect=timeAllDisconnect, airConnect=airConnect, ifEthTable=ifEthTable, timeAllConnect=timeAllConnect, tr2VoltageHighAlarm=tr2VoltageHighAlarm, vlanId=vlanId, tr2AirConnect=tr2AirConnect, chassis=chassis, telnetd=telnetd, tr2Eth1LinkDown=tr2Eth1LinkDown, prioritized=prioritized, tr2BerAlarm=tr2BerAlarm, modemR=modemR, searchModeDisabled=searchModeDisabled, rssAlarm=rssAlarm, tr2RfPowerFail=tr2RfPowerFail, temperatureModem=temperatureModem, txPauseFrames=txPauseFrames, matching=matching, txFreq=txFreq, systemStatus=systemStatus, ifEth=ifEth, rxChannel=rxChannel, alarmNetBitrate=alarmNetBitrate, radio=radio, berAlarm=berAlarm, system=system, alarmBer=alarmBer, station=station, alarmRfPowerFail=alarmRfPowerFail, txModulation=txModulation, interface=interface, rxDones=rxDones, eth1Link=eth1Link, keyEntry=keyEntry, txModulationIndex=txModulationIndex, sshd=sshd, txHCBytes=txHCBytes, rxControlFrames=rxControlFrames, snr=snr, securePeerMode=securePeerMode, ethernet=ethernet, alarm=alarm, swVer=swVer, PYSNMP_MODULE_ID=ray, eth2InThroughput=eth2InThroughput, tr2NetBitrate=tr2NetBitrate, reliability=reliability, racom=racom, info=info, asymPause=asymPause, mdix=mdix, voltageUnit=voltageUnit, alarmSnr=alarmSnr, pause=pause, rxFreq=rxFreq, managementVlanId=managementVlanId, alarmPeerDisconnected=alarmPeerDisconnected, txControlFrames=txControlFrames, temperatureRadio=temperatureRadio, rxBroadcast=rxBroadcast, rfPowerCurrent=rfPowerCurrent, channelArrangement=channelArrangement, netBitrate=netBitrate, rss=rss, memoryAlarm=memoryAlarm, rxMulticast=rxMulticast, eth2Link=eth2Link, alarmTemperature=alarmTemperature, txBroadcast=txBroadcast, ServiceState=ServiceState, rxPauseFrames=rxPauseFrames, authorization=authorization, maxNetBitrate=maxNetBitrate, rayTraps=rayTraps, rfPowerStatus=rfPowerStatus, mac=mac, tr2AirDisconnect=tr2AirDisconnect, rxFalseCarrierErrors=rxFalseCarrierErrors, duplex=duplex, tr2Eth21LinkDown=tr2Eth21LinkDown, keyName=keyName, unitType=unitType, alarmVoltageLow=alarmVoltageLow, ethPeer=ethPeer, ethInThroughput=ethInThroughput, tr2RssAlarm=tr2RssAlarm, alarmWifiOn=alarmWifiOn, PhysAddress=PhysAddress, useMemory=useMemory, ethOutThroughput=ethOutThroughput, OptionSetting=OptionSetting, txDones=txDones, status=status, rfPowerConfigured=rfPowerConfigured)
