...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:47:32 2023
...
iso, ModuleIdentity, Counter64, MibIdentifier, IpAddress, Unsigned32, Bits, mib_2, Integer32, NotificationType, TimeTicks, Gauge32, enterprises, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Counter64", "MibIdentifier", "IpAddress", "Unsigned32", "Bits", "mib-2", "Integer32", "NotificationType", "TimeTicks", "Gauge32", "enterprises", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("RAY-MIB", interface=interface, product=product, peerNumber=peerNumber, channelArrangement=channelArrangement, asymPause=asymPause, voltageUnit=voltageUnit, mdix=mdix, rss=rss, tr2BerAlarm=tr2BerAlarm, lineStatus=lineStatus, alarmNetBitrate=alarmNetBitrate, eth2InThroughput=eth2InThroughput, ethernet=ethernet, rayTraps=rayTraps, alarmRss=alarmRss, useCpu=useCpu, ModulationList=ModulationList, ethPeer=ethPeer, rxDones=rxDones, ifEthEntry=ifEthEntry, speed=speed, numDisconnect=numDisconnect, peerEthLinkDown=peerEthLinkDown, rfPowerConfigured=rfPowerConfigured, ServiceState=ServiceState, alarmBer=alarmBer, AlarmState=AlarmState, airDisconnect=airDisconnect, tr2RfPowerFail=tr2RfPowerFail, txControlFrames=txControlFrames, swVerRadio=swVerRadio, keyEntry=keyEntry, duplex=duplex, alarm=alarm, securePeerMode=securePeerMode, ber=ber, productName=productName, rxOutOfRangeErrors=rxOutOfRangeErrors, berAlarm=berAlarm, snr=snr, alarmPeerDisconnected=alarmPeerDisconnected, rxCrcErrors=rxCrcErrors, alarmEth2Down=alarmEth2Down, searchModeDisabled=searchModeDisabled, sshd=sshd, coding=coding, info=info, rxModulation=rxModulation, rfPowerStatus=rfPowerStatus, telnetd=telnetd, bandwidthKHz=bandwidthKHz, airWdog=airWdog, temperatureRadio=temperatureRadio, txCrcErrors=txCrcErrors, ethInThroughput=ethInThroughput, PYSNMP_MODULE_ID=ray, status=status, tr2VoltageHighAlarm=tr2VoltageHighAlarm, tr2AirDisconnect=tr2AirDisconnect, system=system, PhysAddress=PhysAddress, txChannel=txChannel, netBitrate=netBitrate, rxBroadcast=rxBroadcast, keyName=keyName, ethOutThroughput=ethOutThroughput, voltageSource=voltageSource, rxMulticast=rxMulticast, fecUncorrectBlockCounter=fecUncorrectBlockCounter, racom=racom, tr2WifiOn=tr2WifiOn, tr2VoltageLowAlarm=tr2VoltageLowAlarm, keyTable=keyTable, tr2SnrAlarm=tr2SnrAlarm, httpd=httpd, alarmRfPowerFail=alarmRfPowerFail, pause=pause, statistic=statistic, bandwidth=bandwidth, rxHCBytes=rxHCBytes, rfPowerCurrent=rfPowerCurrent, wifiHAP=wifiHAP, OptionSetting=OptionSetting, station=station, tr2RssAlarm=tr2RssAlarm, rxDroppedPkts=rxDroppedPkts, eth2Link=eth2Link, matching=matching, rssAlarm=rssAlarm, alarmWifiOn=alarmWifiOn, txCollisions=txCollisions, powerAlarm=powerAlarm, serialNumber=serialNumber, ifRadio=ifRadio, ray2Traps=ray2Traps, snrAlarm=snrAlarm, alarmVoltageHigh=alarmVoltageHigh, rxModulationIndex=rxModulationIndex, txPauseFrames=txPauseFrames, useMemory=useMemory, rxControlFrames=rxControlFrames, tr2Eth21LinkDown=tr2Eth21LinkDown, DisplayString=DisplayString, lineStatusII=lineStatusII, txModulationIndex=txModulationIndex, eth2OutThroughput=eth2OutThroughput, rxFreq=rxFreq, memoryAlarm=memoryAlarm, tr2AirConnect=tr2AirConnect, eth1Link=eth1Link, unitType=unitType, serviceVlanId=serviceVlanId, tr2Eth1LinkDown=tr2Eth1LinkDown, alarmSnr=alarmSnr, tr2TemperatureAlarm=tr2TemperatureAlarm, managementVlanId=managementVlanId, modemR=modemR, swVer=swVer, alarmEth1Down=alarmEth1Down, rxChannel=rxChannel, txMulticast=txMulticast, prioritized=prioritized, tr2NetBitrate=tr2NetBitrate, txFreq=txFreq, reliability=reliability, rfPowerFail=rfPowerFail, systemStatus=systemStatus, rxPauseFrames=rxPauseFrames, txHCBytes=txHCBytes, txLengthCheckErrors=txLengthCheckErrors, rxFalseCarrierErrors=rxFalseCarrierErrors, alarmTemperature=alarmTemperature, ifEth=ifEth, autonego=autonego, mac=mac, ifEthTable=ifEthTable, ray=ray, timeAllDisconnect=timeAllDisconnect, deviceName=deviceName, txBroadcast=txBroadcast, timeAllConnect=timeAllConnect, vlanId=vlanId, tempAlarm=tempAlarm, managementVlan=managementVlan, access=access, txDones=txDones, ip=ip, timeMaxDisconnect=timeMaxDisconnect, chassis=chassis, useLogStorage=useLogStorage, txModulation=txModulation, airConnect=airConnect, rxCodeErrors=rxCodeErrors, fecBlockCounter=fecBlockCounter, alarmVoltageLow=alarmVoltageLow, radio=radio, temperatureModem=temperatureModem, linkUptime=linkUptime, maxNetBitrate=maxNetBitrate, authorization=authorization)
