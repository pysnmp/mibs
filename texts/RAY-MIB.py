...
MibIdentifier, Counter64, Counter32, mib_2, ObjectIdentity, Gauge32, Unsigned32, IpAddress, ModuleIdentity, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Counter32", "mib-2", "ObjectIdentity", "Gauge32", "Unsigned32", "IpAddress", "ModuleIdentity", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "iso", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", alarmVoltageLow=alarmVoltageLow, alarmEth1Down=alarmEth1Down, keyEntry=keyEntry, pause=pause, timeAllConnect=timeAllConnect, keyName=keyName, tempAlarm=tempAlarm, useCpu=useCpu, tr2VoltageLowAlarm=tr2VoltageLowAlarm, reliability=reliability, bandwidthKHz=bandwidthKHz, linkUptime=linkUptime, alarmTemperature=alarmTemperature, chassis=chassis, alarmVoltageHigh=alarmVoltageHigh, txCollisions=txCollisions, txBroadcast=txBroadcast, status=status, sshd=sshd, alarmEth2Down=alarmEth2Down, txModulationIndex=txModulationIndex, tr2SnrAlarm=tr2SnrAlarm, statistic=statistic, lineStatus=lineStatus, txChannel=txChannel, productName=productName, powerAlarm=powerAlarm, temperatureModem=temperatureModem, modemR=modemR, ethernet=ethernet, rxOutOfRangeErrors=rxOutOfRangeErrors, rxMulticast=rxMulticast, netBitrate=netBitrate, tr2VoltageHighAlarm=tr2VoltageHighAlarm, rfPowerCurrent=rfPowerCurrent, tr2NetBitrate=tr2NetBitrate, rxDroppedPkts=rxDroppedPkts, rfPowerStatus=rfPowerStatus, swVerRadio=swVerRadio, securePeerMode=securePeerMode, useLogStorage=useLogStorage, ServiceState=ServiceState, snrAlarm=snrAlarm, ifRadio=ifRadio, PhysAddress=PhysAddress, rxCodeErrors=rxCodeErrors, eth2OutThroughput=eth2OutThroughput, memoryAlarm=memoryAlarm, peerEthLinkDown=peerEthLinkDown, txFreq=txFreq, autonego=autonego, airDisconnect=airDisconnect, serialNumber=serialNumber, txCrcErrors=txCrcErrors, DisplayString=DisplayString, alarmNetBitrate=alarmNetBitrate, airConnect=airConnect, useMemory=useMemory, eth1Link=eth1Link, txControlFrames=txControlFrames, voltageUnit=voltageUnit, speed=speed, alarmRss=alarmRss, ifEth=ifEth, rxModulationIndex=rxModulationIndex, eth2InThroughput=eth2InThroughput, tr2AirDisconnect=tr2AirDisconnect, system=system, timeAllDisconnect=timeAllDisconnect, duplex=duplex, tr2Eth21LinkDown=tr2Eth21LinkDown, tr2RfPowerFail=tr2RfPowerFail, swVer=swVer, lineStatusII=lineStatusII, alarmRfPowerFail=alarmRfPowerFail, rxCrcErrors=rxCrcErrors, ifEthEntry=ifEthEntry, ethInThroughput=ethInThroughput, timeMaxDisconnect=timeMaxDisconnect, airWdog=airWdog, berAlarm=berAlarm, tr2TemperatureAlarm=tr2TemperatureAlarm, alarm=alarm, AlarmState=AlarmState, rss=rss, matching=matching, asymPause=asymPause, telnetd=telnetd, ModulationList=ModulationList, rxFreq=rxFreq, rxChannel=rxChannel, rxControlFrames=rxControlFrames, tr2AirConnect=tr2AirConnect, rxBroadcast=rxBroadcast, maxNetBitrate=maxNetBitrate, authorization=authorization, prioritized=prioritized, rfPowerFail=rfPowerFail, rxModulation=rxModulation, peerNumber=peerNumber, alarmPeerDisconnected=alarmPeerDisconnected, rxFalseCarrierErrors=rxFalseCarrierErrors, ethOutThroughput=ethOutThroughput, serviceVlanId=serviceVlanId, eth2Link=eth2Link, txMulticast=txMulticast, alarmWifiOn=alarmWifiOn, tr2BerAlarm=tr2BerAlarm, rxPauseFrames=rxPauseFrames, txDones=txDones, ray=ray, txHCBytes=txHCBytes, txModulation=txModulation, alarmSnr=alarmSnr, OptionSetting=OptionSetting, tr2Eth1LinkDown=tr2Eth1LinkDown, rxHCBytes=rxHCBytes, systemStatus=systemStatus, wifiHAP=wifiHAP, txLengthCheckErrors=txLengthCheckErrors, snr=snr, access=access, vlanId=vlanId, radio=radio, PYSNMP_MODULE_ID=ray, managementVlanId=managementVlanId, interface=interface, searchModeDisabled=searchModeDisabled, deviceName=deviceName, info=info, alarmBer=alarmBer, ifEthTable=ifEthTable, ip=ip, coding=coding, voltageSource=voltageSource, fecBlockCounter=fecBlockCounter, temperatureRadio=temperatureRadio, tr2WifiOn=tr2WifiOn, fecUncorrectBlockCounter=fecUncorrectBlockCounter, bandwidth=bandwidth, ethPeer=ethPeer, rfPowerConfigured=rfPowerConfigured, txPauseFrames=txPauseFrames, product=product, managementVlan=managementVlan, rxDones=rxDones, ray2Traps=ray2Traps, rayTraps=rayTraps, keyTable=keyTable, tr2RssAlarm=tr2RssAlarm, mdix=mdix, station=station, rssAlarm=rssAlarm, ber=ber, racom=racom, unitType=unitType, httpd=httpd, mac=mac, numDisconnect=numDisconnect, channelArrangement=channelArrangement)
