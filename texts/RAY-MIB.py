...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:24:45 2022
...
IpAddress, MibIdentifier, Unsigned32, Bits, Counter32, Gauge32, ObjectIdentity, TimeTicks, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, mib_2, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Unsigned32", "Bits", "Counter32", "Gauge32", "ObjectIdentity", "TimeTicks", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "mib-2", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("RAY-MIB", tr2VoltageLowAlarm=tr2VoltageLowAlarm, txControlFrames=txControlFrames, rxPauseFrames=rxPauseFrames, ethOutThroughput=ethOutThroughput, rxBroadcast=rxBroadcast, speed=speed, bandwidthKHz=bandwidthKHz, fecBlockCounter=fecBlockCounter, channelArrangement=channelArrangement, PhysAddress=PhysAddress, rfPowerFail=rfPowerFail, tr2VoltageHighAlarm=tr2VoltageHighAlarm, alarmNetBitrate=alarmNetBitrate, authorization=authorization, useCpu=useCpu, airWdog=airWdog, maxNetBitrate=maxNetBitrate, alarmBer=alarmBer, peerNumber=peerNumber, alarmRss=alarmRss, tr2BerAlarm=tr2BerAlarm, serviceVlanId=serviceVlanId, txModulation=txModulation, txMulticast=txMulticast, rss=rss, ModulationList=ModulationList, systemStatus=systemStatus, securePeerMode=securePeerMode, managementVlan=managementVlan, timeAllConnect=timeAllConnect, deviceName=deviceName, keyName=keyName, DisplayString=DisplayString, timeAllDisconnect=timeAllDisconnect, eth2OutThroughput=eth2OutThroughput, rfPowerStatus=rfPowerStatus, rxMulticast=rxMulticast, tr2RfPowerFail=tr2RfPowerFail, ip=ip, matching=matching, productName=productName, tr2Eth1LinkDown=tr2Eth1LinkDown, alarmEth2Down=alarmEth2Down, snr=snr, peerEthLinkDown=peerEthLinkDown, chassis=chassis, txCollisions=txCollisions, lineStatus=lineStatus, txLengthCheckErrors=txLengthCheckErrors, ServiceState=ServiceState, ethernet=ethernet, alarmSnr=alarmSnr, wifiHAP=wifiHAP, rxModulationIndex=rxModulationIndex, access=access, powerAlarm=powerAlarm, eth1Link=eth1Link, swVerRadio=swVerRadio, rxFalseCarrierErrors=rxFalseCarrierErrors, txFreq=txFreq, ethPeer=ethPeer, voltageSource=voltageSource, eth2InThroughput=eth2InThroughput, tr2Eth21LinkDown=tr2Eth21LinkDown, coding=coding, reliability=reliability, temperatureModem=temperatureModem, keyTable=keyTable, mac=mac, racom=racom, timeMaxDisconnect=timeMaxDisconnect, tr2RssAlarm=tr2RssAlarm, station=station, alarmPeerDisconnected=alarmPeerDisconnected, txHCBytes=txHCBytes, tr2SnrAlarm=tr2SnrAlarm, lineStatusII=lineStatusII, eth2Link=eth2Link, OptionSetting=OptionSetting, txChannel=txChannel, fecUncorrectBlockCounter=fecUncorrectBlockCounter, duplex=duplex, keyEntry=keyEntry, httpd=httpd, alarm=alarm, searchModeDisabled=searchModeDisabled, swVer=swVer, rxCrcErrors=rxCrcErrors, autonego=autonego, PYSNMP_MODULE_ID=ray, statistic=statistic, rxFreq=rxFreq, txBroadcast=txBroadcast, tr2WifiOn=tr2WifiOn, tempAlarm=tempAlarm, netBitrate=netBitrate, tr2TemperatureAlarm=tr2TemperatureAlarm, rfPowerCurrent=rfPowerCurrent, ifEthEntry=ifEthEntry, system=system, radio=radio, rxDroppedPkts=rxDroppedPkts, ifEthTable=ifEthTable, tr2AirConnect=tr2AirConnect, memoryAlarm=memoryAlarm, status=status, rxControlFrames=rxControlFrames, rxDones=rxDones, airConnect=airConnect, interface=interface, sshd=sshd, snrAlarm=snrAlarm, alarmVoltageLow=alarmVoltageLow, prioritized=prioritized, txPauseFrames=txPauseFrames, ray2Traps=ray2Traps, txModulationIndex=txModulationIndex, txDones=txDones, numDisconnect=numDisconnect, useLogStorage=useLogStorage, ifRadio=ifRadio, alarmTemperature=alarmTemperature, useMemory=useMemory, voltageUnit=voltageUnit, product=product, airDisconnect=airDisconnect, rxOutOfRangeErrors=rxOutOfRangeErrors, rssAlarm=rssAlarm, alarmRfPowerFail=alarmRfPowerFail, serialNumber=serialNumber, info=info, bandwidth=bandwidth, modemR=modemR, rxChannel=rxChannel, unitType=unitType, rxCodeErrors=rxCodeErrors, telnetd=telnetd, ray=ray, alarmVoltageHigh=alarmVoltageHigh, ber=ber, rxHCBytes=rxHCBytes, ethInThroughput=ethInThroughput, alarmWifiOn=alarmWifiOn, vlanId=vlanId, AlarmState=AlarmState, ifEth=ifEth, temperatureRadio=temperatureRadio, rfPowerConfigured=rfPowerConfigured, managementVlanId=managementVlanId, rxModulation=rxModulation, linkUptime=linkUptime, mdix=mdix, pause=pause, asymPause=asymPause, tr2AirDisconnect=tr2AirDisconnect, rayTraps=rayTraps, txCrcErrors=txCrcErrors, berAlarm=berAlarm, tr2NetBitrate=tr2NetBitrate, alarmEth1Down=alarmEth1Down)
