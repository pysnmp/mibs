...
ModuleIdentity, Unsigned32, Counter64, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, NotificationType, Gauge32, mib_2, IpAddress, MibIdentifier, ObjectIdentity, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Counter64", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "NotificationType", "Gauge32", "mib-2", "IpAddress", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", rxModulationIndex=rxModulationIndex, alarmEth2Down=alarmEth2Down, ber=ber, alarmNetBitrate=alarmNetBitrate, tr2RfPowerFail=tr2RfPowerFail, productName=productName, berAlarm=berAlarm, chassis=chassis, ethernet=ethernet, ifEthTable=ifEthTable, rxPauseFrames=rxPauseFrames, ip=ip, wifiHAP=wifiHAP, timeAllConnect=timeAllConnect, ethInThroughput=ethInThroughput, tr2RssAlarm=tr2RssAlarm, bandwidth=bandwidth, unitType=unitType, interface=interface, airConnect=airConnect, alarmEth1Down=alarmEth1Down, duplex=duplex, speed=speed, ifEth=ifEth, ServiceState=ServiceState, rxCrcErrors=rxCrcErrors, racom=racom, tr2WifiOn=tr2WifiOn, tr2VoltageHighAlarm=tr2VoltageHighAlarm, bandwidthKHz=bandwidthKHz, eth2Link=eth2Link, tr2TemperatureAlarm=tr2TemperatureAlarm, tr2BerAlarm=tr2BerAlarm, vlanId=vlanId, OptionSetting=OptionSetting, PhysAddress=PhysAddress, serialNumber=serialNumber, txCrcErrors=txCrcErrors, searchModeDisabled=searchModeDisabled, txCollisions=txCollisions, tempAlarm=tempAlarm, voltageUnit=voltageUnit, lineStatusII=lineStatusII, ifEthEntry=ifEthEntry, timeAllDisconnect=timeAllDisconnect, rayTraps=rayTraps, eth2InThroughput=eth2InThroughput, radio=radio, securePeerMode=securePeerMode, mdix=mdix, txFreq=txFreq, alarmRss=alarmRss, telnetd=telnetd, ModulationList=ModulationList, rxDroppedPkts=rxDroppedPkts, peerEthLinkDown=peerEthLinkDown, timeMaxDisconnect=timeMaxDisconnect, eth2OutThroughput=eth2OutThroughput, alarmPeerDisconnected=alarmPeerDisconnected, netBitrate=netBitrate, ifRadio=ifRadio, alarm=alarm, txDones=txDones, eth1Link=eth1Link, rssAlarm=rssAlarm, modemR=modemR, deviceName=deviceName, rxFalseCarrierErrors=rxFalseCarrierErrors, info=info, autonego=autonego, rfPowerFail=rfPowerFail, channelArrangement=channelArrangement, numDisconnect=numDisconnect, system=system, rfPowerConfigured=rfPowerConfigured, voltageSource=voltageSource, temperatureModem=temperatureModem, rxMulticast=rxMulticast, alarmVoltageLow=alarmVoltageLow, tr2AirConnect=tr2AirConnect, rfPowerCurrent=rfPowerCurrent, ray=ray, keyName=keyName, rxModulation=rxModulation, airWdog=airWdog, AlarmState=AlarmState, coding=coding, rfPowerStatus=rfPowerStatus, rxCodeErrors=rxCodeErrors, fecUncorrectBlockCounter=fecUncorrectBlockCounter, snrAlarm=snrAlarm, txControlFrames=txControlFrames, keyEntry=keyEntry, status=status, rxChannel=rxChannel, tr2AirDisconnect=tr2AirDisconnect, swVerRadio=swVerRadio, alarmWifiOn=alarmWifiOn, statistic=statistic, useLogStorage=useLogStorage, rxControlFrames=rxControlFrames, txBroadcast=txBroadcast, managementVlan=managementVlan, temperatureRadio=temperatureRadio, asymPause=asymPause, DisplayString=DisplayString, tr2VoltageLowAlarm=tr2VoltageLowAlarm, tr2Eth1LinkDown=tr2Eth1LinkDown, snr=snr, product=product, sshd=sshd, fecBlockCounter=fecBlockCounter, rxHCBytes=rxHCBytes, linkUptime=linkUptime, pause=pause, alarmRfPowerFail=alarmRfPowerFail, peerNumber=peerNumber, txHCBytes=txHCBytes, alarmSnr=alarmSnr, access=access, rxOutOfRangeErrors=rxOutOfRangeErrors, txModulation=txModulation, alarmBer=alarmBer, swVer=swVer, serviceVlanId=serviceVlanId, alarmVoltageHigh=alarmVoltageHigh, txModulationIndex=txModulationIndex, ethPeer=ethPeer, alarmTemperature=alarmTemperature, txMulticast=txMulticast, httpd=httpd, ray2Traps=ray2Traps, ethOutThroughput=ethOutThroughput, authorization=authorization, mac=mac, maxNetBitrate=maxNetBitrate, memoryAlarm=memoryAlarm, rxFreq=rxFreq, station=station, systemStatus=systemStatus, lineStatus=lineStatus, managementVlanId=managementVlanId, txChannel=txChannel, tr2SnrAlarm=tr2SnrAlarm, rxDones=rxDones, airDisconnect=airDisconnect, matching=matching, keyTable=keyTable, powerAlarm=powerAlarm, txLengthCheckErrors=txLengthCheckErrors, prioritized=prioritized, useMemory=useMemory, reliability=reliability, PYSNMP_MODULE_ID=ray, rxBroadcast=rxBroadcast, useCpu=useCpu, tr2Eth21LinkDown=tr2Eth21LinkDown, txPauseFrames=txPauseFrames, tr2NetBitrate=tr2NetBitrate, rss=rss)
