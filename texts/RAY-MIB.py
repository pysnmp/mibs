...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, ModuleIdentity, ObjectIdentity, Bits, iso, TimeTicks, Gauge32, enterprises, Counter64, Unsigned32, IpAddress, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Bits", "iso", "TimeTicks", "Gauge32", "enterprises", "Counter64", "Unsigned32", "IpAddress", "mib-2", "Integer32")
...
mibBuilder.exportSymbols("RAY-MIB", useCpu=useCpu, rfPowerConfigured=rfPowerConfigured, timeMaxDisconnect=timeMaxDisconnect, fecBlockCounter=fecBlockCounter, keyName=keyName, ModulationList=ModulationList, statistic=statistic, serviceVlanId=serviceVlanId, ethOutThroughput=ethOutThroughput, eth2InThroughput=eth2InThroughput, rfPowerCurrent=rfPowerCurrent, ethPeer=ethPeer, rxBroadcast=rxBroadcast, alarmPeerDisconnected=alarmPeerDisconnected, wifiHAP=wifiHAP, interface=interface, tr2TemperatureAlarm=tr2TemperatureAlarm, airConnect=airConnect, product=product, txControlFrames=txControlFrames, txCollisions=txCollisions, tr2AirDisconnect=tr2AirDisconnect, alarmVoltageHigh=alarmVoltageHigh, peerEthLinkDown=peerEthLinkDown, autonego=autonego, txBroadcast=txBroadcast, ip=ip, alarmEth2Down=alarmEth2Down, rxControlFrames=rxControlFrames, ethInThroughput=ethInThroughput, rxMulticast=rxMulticast, rxCrcErrors=rxCrcErrors, unitType=unitType, alarmEth1Down=alarmEth1Down, AlarmState=AlarmState, system=system, rxOutOfRangeErrors=rxOutOfRangeErrors, tr2WifiOn=tr2WifiOn, status=status, txFreq=txFreq, reliability=reliability, tr2RfPowerFail=tr2RfPowerFail, OptionSetting=OptionSetting, eth1Link=eth1Link, duplex=duplex, PYSNMP_MODULE_ID=ray, alarmBer=alarmBer, modemR=modemR, keyTable=keyTable, useMemory=useMemory, alarmSnr=alarmSnr, ifEthTable=ifEthTable, info=info, txLengthCheckErrors=txLengthCheckErrors, rfPowerFail=rfPowerFail, alarmRss=alarmRss, txCrcErrors=txCrcErrors, ifEthEntry=ifEthEntry, lineStatus=lineStatus, txHCBytes=txHCBytes, txPauseFrames=txPauseFrames, managementVlan=managementVlan, matching=matching, mdix=mdix, rss=rss, rfPowerStatus=rfPowerStatus, alarmRfPowerFail=alarmRfPowerFail, coding=coding, powerAlarm=powerAlarm, netBitrate=netBitrate, rayTraps=rayTraps, rxModulation=rxModulation, tr2SnrAlarm=tr2SnrAlarm, PhysAddress=PhysAddress, txModulation=txModulation, sshd=sshd, voltageSource=voltageSource, rxHCBytes=rxHCBytes, rxModulationIndex=rxModulationIndex, tr2Eth1LinkDown=tr2Eth1LinkDown, alarmNetBitrate=alarmNetBitrate, ifEth=ifEth, tr2AirConnect=tr2AirConnect, alarmWifiOn=alarmWifiOn, temperatureRadio=temperatureRadio, radio=radio, lineStatusII=lineStatusII, rssAlarm=rssAlarm, systemStatus=systemStatus, prioritized=prioritized, rxDones=rxDones, bandwidth=bandwidth, serialNumber=serialNumber, rxCodeErrors=rxCodeErrors, productName=productName, alarm=alarm, tr2RssAlarm=tr2RssAlarm, tr2NetBitrate=tr2NetBitrate, snrAlarm=snrAlarm, racom=racom, speed=speed, rxFalseCarrierErrors=rxFalseCarrierErrors, bandwidthKHz=bandwidthKHz, snr=snr, station=station, berAlarm=berAlarm, chassis=chassis, mac=mac, tr2BerAlarm=tr2BerAlarm, swVerRadio=swVerRadio, ray=ray, rxDroppedPkts=rxDroppedPkts, deviceName=deviceName, ifRadio=ifRadio, DisplayString=DisplayString, httpd=httpd, alarmTemperature=alarmTemperature, useLogStorage=useLogStorage, temperatureModem=temperatureModem, rxFreq=rxFreq, voltageUnit=voltageUnit, airDisconnect=airDisconnect, peerNumber=peerNumber, tr2VoltageLowAlarm=tr2VoltageLowAlarm, ethernet=ethernet, ray2Traps=ray2Traps, rxChannel=rxChannel, memoryAlarm=memoryAlarm, txMulticast=txMulticast, rxPauseFrames=rxPauseFrames, searchModeDisabled=searchModeDisabled, txChannel=txChannel, txModulationIndex=txModulationIndex, managementVlanId=managementVlanId, timeAllConnect=timeAllConnect, txDones=txDones, vlanId=vlanId, timeAllDisconnect=timeAllDisconnect, securePeerMode=securePeerMode, telnetd=telnetd, ber=ber, access=access, ServiceState=ServiceState, eth2OutThroughput=eth2OutThroughput, authorization=authorization, numDisconnect=numDisconnect, swVer=swVer, asymPause=asymPause, pause=pause, tr2VoltageHighAlarm=tr2VoltageHighAlarm, maxNetBitrate=maxNetBitrate, fecUncorrectBlockCounter=fecUncorrectBlockCounter, airWdog=airWdog, eth2Link=eth2Link, tempAlarm=tempAlarm, alarmVoltageLow=alarmVoltageLow, linkUptime=linkUptime, keyEntry=keyEntry, channelArrangement=channelArrangement, tr2Eth21LinkDown=tr2Eth21LinkDown)
