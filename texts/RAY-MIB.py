...
Bits, Counter64, Gauge32, enterprises, ModuleIdentity, Integer32, ObjectIdentity, mib_2, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, TimeTicks, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Gauge32", "enterprises", "ModuleIdentity", "Integer32", "ObjectIdentity", "mib-2", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "TimeTicks", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("RAY-MIB", tr2Eth1LinkDown=tr2Eth1LinkDown, temperatureModem=temperatureModem, alarmBer=alarmBer, rxChannel=rxChannel, systemStatus=systemStatus, ip=ip, rxCodeErrors=rxCodeErrors, tr2BerAlarm=tr2BerAlarm, rxModulationIndex=rxModulationIndex, ray=ray, snr=snr, txBroadcast=txBroadcast, system=system, timeMaxDisconnect=timeMaxDisconnect, ray2Traps=ray2Traps, product=product, tr2VoltageLowAlarm=tr2VoltageLowAlarm, vlanId=vlanId, alarmRss=alarmRss, fecBlockCounter=fecBlockCounter, tr2AirConnect=tr2AirConnect, rfPowerConfigured=rfPowerConfigured, ethOutThroughput=ethOutThroughput, airWdog=airWdog, txCrcErrors=txCrcErrors, alarmEth2Down=alarmEth2Down, alarmNetBitrate=alarmNetBitrate, rxDroppedPkts=rxDroppedPkts, telnetd=telnetd, powerAlarm=powerAlarm, alarmPeerDisconnected=alarmPeerDisconnected, rxModulation=rxModulation, lineStatusII=lineStatusII, rxFalseCarrierErrors=rxFalseCarrierErrors, maxNetBitrate=maxNetBitrate, rxCrcErrors=rxCrcErrors, rxBroadcast=rxBroadcast, txCollisions=txCollisions, prioritized=prioritized, txControlFrames=txControlFrames, ethernet=ethernet, unitType=unitType, interface=interface, txMulticast=txMulticast, tr2Eth21LinkDown=tr2Eth21LinkDown, timeAllDisconnect=timeAllDisconnect, managementVlanId=managementVlanId, temperatureRadio=temperatureRadio, duplex=duplex, authorization=authorization, txModulation=txModulation, txLengthCheckErrors=txLengthCheckErrors, productName=productName, rxControlFrames=rxControlFrames, ethInThroughput=ethInThroughput, ifEth=ifEth, timeAllConnect=timeAllConnect, txFreq=txFreq, fecUncorrectBlockCounter=fecUncorrectBlockCounter, ServiceState=ServiceState, useMemory=useMemory, lineStatus=lineStatus, mdix=mdix, rfPowerCurrent=rfPowerCurrent, peerEthLinkDown=peerEthLinkDown, reliability=reliability, eth2Link=eth2Link, eth2OutThroughput=eth2OutThroughput, airDisconnect=airDisconnect, tr2WifiOn=tr2WifiOn, txModulationIndex=txModulationIndex, chassis=chassis, swVer=swVer, ifRadio=ifRadio, rssAlarm=rssAlarm, rxOutOfRangeErrors=rxOutOfRangeErrors, serialNumber=serialNumber, tr2RfPowerFail=tr2RfPowerFail, alarmVoltageLow=alarmVoltageLow, alarmRfPowerFail=alarmRfPowerFail, keyName=keyName, tr2AirDisconnect=tr2AirDisconnect, snrAlarm=snrAlarm, keyTable=keyTable, tempAlarm=tempAlarm, voltageSource=voltageSource, useCpu=useCpu, autonego=autonego, OptionSetting=OptionSetting, berAlarm=berAlarm, alarmWifiOn=alarmWifiOn, airConnect=airConnect, matching=matching, numDisconnect=numDisconnect, alarm=alarm, deviceName=deviceName, DisplayString=DisplayString, rfPowerFail=rfPowerFail, ModulationList=ModulationList, bandwidth=bandwidth, searchModeDisabled=searchModeDisabled, ethPeer=ethPeer, alarmSnr=alarmSnr, mac=mac, peerNumber=peerNumber, serviceVlanId=serviceVlanId, alarmEth1Down=alarmEth1Down, station=station, netBitrate=netBitrate, coding=coding, sshd=sshd, tr2NetBitrate=tr2NetBitrate, keyEntry=keyEntry, alarmVoltageHigh=alarmVoltageHigh, txChannel=txChannel, radio=radio, linkUptime=linkUptime, speed=speed, memoryAlarm=memoryAlarm, tr2SnrAlarm=tr2SnrAlarm, tr2RssAlarm=tr2RssAlarm, pause=pause, useLogStorage=useLogStorage, httpd=httpd, ifEthTable=ifEthTable, info=info, wifiHAP=wifiHAP, PYSNMP_MODULE_ID=ray, channelArrangement=channelArrangement, rxFreq=rxFreq, ifEthEntry=ifEthEntry, statistic=statistic, eth2InThroughput=eth2InThroughput, ber=ber, tr2VoltageHighAlarm=tr2VoltageHighAlarm, rayTraps=rayTraps, eth1Link=eth1Link, txHCBytes=txHCBytes, rxDones=rxDones, securePeerMode=securePeerMode, AlarmState=AlarmState, asymPause=asymPause, voltageUnit=voltageUnit, rfPowerStatus=rfPowerStatus, bandwidthKHz=bandwidthKHz, rxPauseFrames=rxPauseFrames, status=status, managementVlan=managementVlan, txDones=txDones, tr2TemperatureAlarm=tr2TemperatureAlarm, access=access, rxMulticast=rxMulticast, modemR=modemR, rxHCBytes=rxHCBytes, swVerRadio=swVerRadio, PhysAddress=PhysAddress, rss=rss, txPauseFrames=txPauseFrames, alarmTemperature=alarmTemperature, racom=racom)
