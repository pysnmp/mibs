...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:51:18 2022
...
ObjectIdentity, TimeTicks, mib_2, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, IpAddress, Bits, ModuleIdentity, Unsigned32, enterprises, Counter32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "mib-2", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "IpAddress", "Bits", "ModuleIdentity", "Unsigned32", "enterprises", "Counter32", "iso", "Gauge32")
...
mibBuilder.exportSymbols("RAY-MIB", httpd=httpd, tr2WifiOn=tr2WifiOn, duplex=duplex, tr2SnrAlarm=tr2SnrAlarm, rxCodeErrors=rxCodeErrors, alarmTemperature=alarmTemperature, alarmEth1Down=alarmEth1Down, coding=coding, numDisconnect=numDisconnect, useMemory=useMemory, alarm=alarm, alarmBer=alarmBer, fecBlockCounter=fecBlockCounter, deviceName=deviceName, productName=productName, tr2NetBitrate=tr2NetBitrate, rfPowerConfigured=rfPowerConfigured, eth2OutThroughput=eth2OutThroughput, airDisconnect=airDisconnect, ip=ip, voltageSource=voltageSource, tr2VoltageLowAlarm=tr2VoltageLowAlarm, rxFreq=rxFreq, keyEntry=keyEntry, alarmEth2Down=alarmEth2Down, useLogStorage=useLogStorage, ModulationList=ModulationList, systemStatus=systemStatus, rfPowerCurrent=rfPowerCurrent, rayTraps=rayTraps, maxNetBitrate=maxNetBitrate, mdix=mdix, txMulticast=txMulticast, prioritized=prioritized, mac=mac, eth2Link=eth2Link, bandwidth=bandwidth, tr2TemperatureAlarm=tr2TemperatureAlarm, AlarmState=AlarmState, alarmSnr=alarmSnr, keyName=keyName, ethPeer=ethPeer, alarmNetBitrate=alarmNetBitrate, txDones=txDones, matching=matching, fecUncorrectBlockCounter=fecUncorrectBlockCounter, rxDones=rxDones, ServiceState=ServiceState, station=station, peerEthLinkDown=peerEthLinkDown, rxHCBytes=rxHCBytes, telnetd=telnetd, rxControlFrames=rxControlFrames, txCollisions=txCollisions, tr2AirConnect=tr2AirConnect, reliability=reliability, rxMulticast=rxMulticast, netBitrate=netBitrate, rxCrcErrors=rxCrcErrors, eth2InThroughput=eth2InThroughput, lineStatus=lineStatus, alarmRss=alarmRss, managementVlan=managementVlan, alarmRfPowerFail=alarmRfPowerFail, searchModeDisabled=searchModeDisabled, powerAlarm=powerAlarm, rssAlarm=rssAlarm, tr2RssAlarm=tr2RssAlarm, tr2VoltageHighAlarm=tr2VoltageHighAlarm, unitType=unitType, system=system, snr=snr, modemR=modemR, ber=ber, useCpu=useCpu, keyTable=keyTable, swVerRadio=swVerRadio, pause=pause, rxFalseCarrierErrors=rxFalseCarrierErrors, ray2Traps=ray2Traps, txControlFrames=txControlFrames, timeAllConnect=timeAllConnect, channelArrangement=channelArrangement, tr2BerAlarm=tr2BerAlarm, txBroadcast=txBroadcast, alarmVoltageHigh=alarmVoltageHigh, tr2AirDisconnect=tr2AirDisconnect, product=product, ifEthTable=ifEthTable, ifEthEntry=ifEthEntry, securePeerMode=securePeerMode, managementVlanId=managementVlanId, ray=ray, chassis=chassis, PhysAddress=PhysAddress, voltageUnit=voltageUnit, speed=speed, rss=rss, ethInThroughput=ethInThroughput, serialNumber=serialNumber, alarmPeerDisconnected=alarmPeerDisconnected, lineStatusII=lineStatusII, memoryAlarm=memoryAlarm, rxModulation=rxModulation, rfPowerStatus=rfPowerStatus, ifEth=ifEth, serviceVlanId=serviceVlanId, txFreq=txFreq, rxOutOfRangeErrors=rxOutOfRangeErrors, temperatureModem=temperatureModem, OptionSetting=OptionSetting, rxBroadcast=rxBroadcast, snrAlarm=snrAlarm, PYSNMP_MODULE_ID=ray, txLengthCheckErrors=txLengthCheckErrors, airConnect=airConnect, authorization=authorization, txModulationIndex=txModulationIndex, tr2Eth1LinkDown=tr2Eth1LinkDown, sshd=sshd, txCrcErrors=txCrcErrors, peerNumber=peerNumber, ethernet=ethernet, rxDroppedPkts=rxDroppedPkts, eth1Link=eth1Link, rxChannel=rxChannel, rfPowerFail=rfPowerFail, alarmWifiOn=alarmWifiOn, tr2Eth21LinkDown=tr2Eth21LinkDown, ethOutThroughput=ethOutThroughput, DisplayString=DisplayString, autonego=autonego, wifiHAP=wifiHAP, statistic=statistic, tr2RfPowerFail=tr2RfPowerFail, ifRadio=ifRadio, airWdog=airWdog, txPauseFrames=txPauseFrames, txHCBytes=txHCBytes, access=access, txChannel=txChannel, rxModulationIndex=rxModulationIndex, linkUptime=linkUptime, asymPause=asymPause, vlanId=vlanId, timeAllDisconnect=timeAllDisconnect, swVer=swVer, txModulation=txModulation, temperatureRadio=temperatureRadio, status=status, interface=interface, alarmVoltageLow=alarmVoltageLow, timeMaxDisconnect=timeMaxDisconnect, tempAlarm=tempAlarm, berAlarm=berAlarm, bandwidthKHz=bandwidthKHz, rxPauseFrames=rxPauseFrames, radio=radio, info=info, racom=racom)
