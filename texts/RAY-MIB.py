...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:36:40 2022
...
IpAddress, NotificationType, Gauge32, Counter32, mib_2, iso, Counter64, TimeTicks, enterprises, Unsigned32, ObjectIdentity, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Gauge32", "Counter32", "mib-2", "iso", "Counter64", "TimeTicks", "enterprises", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("RAY-MIB", eth2Link=eth2Link, temperatureModem=temperatureModem, mac=mac, alarmVoltageHigh=alarmVoltageHigh, linkUptime=linkUptime, txCrcErrors=txCrcErrors, alarmRfPowerFail=alarmRfPowerFail, maxNetBitrate=maxNetBitrate, peerNumber=peerNumber, productName=productName, alarmPeerDisconnected=alarmPeerDisconnected, rxDroppedPkts=rxDroppedPkts, eth1Link=eth1Link, ber=ber, swVerRadio=swVerRadio, rfPowerCurrent=rfPowerCurrent, pause=pause, ethOutThroughput=ethOutThroughput, keyTable=keyTable, tr2NetBitrate=tr2NetBitrate, txPauseFrames=txPauseFrames, tr2VoltageLowAlarm=tr2VoltageLowAlarm, ray2Traps=ray2Traps, channelArrangement=channelArrangement, powerAlarm=powerAlarm, berAlarm=berAlarm, racom=racom, alarmWifiOn=alarmWifiOn, interface=interface, rfPowerConfigured=rfPowerConfigured, matching=matching, wifiHAP=wifiHAP, radio=radio, reliability=reliability, eth2OutThroughput=eth2OutThroughput, station=station, alarm=alarm, rxModulation=rxModulation, rxBroadcast=rxBroadcast, txFreq=txFreq, systemStatus=systemStatus, product=product, serialNumber=serialNumber, rfPowerStatus=rfPowerStatus, bandwidthKHz=bandwidthKHz, voltageUnit=voltageUnit, timeAllConnect=timeAllConnect, bandwidth=bandwidth, timeAllDisconnect=timeAllDisconnect, managementVlan=managementVlan, ethInThroughput=ethInThroughput, fecUncorrectBlockCounter=fecUncorrectBlockCounter, tr2VoltageHighAlarm=tr2VoltageHighAlarm, PhysAddress=PhysAddress, ServiceState=ServiceState, statistic=statistic, rxOutOfRangeErrors=rxOutOfRangeErrors, rxPauseFrames=rxPauseFrames, ethernet=ethernet, memoryAlarm=memoryAlarm, access=access, useCpu=useCpu, tr2AirDisconnect=tr2AirDisconnect, numDisconnect=numDisconnect, securePeerMode=securePeerMode, status=status, prioritized=prioritized, tempAlarm=tempAlarm, alarmEth2Down=alarmEth2Down, tr2TemperatureAlarm=tr2TemperatureAlarm, tr2RfPowerFail=tr2RfPowerFail, fecBlockCounter=fecBlockCounter, coding=coding, txDones=txDones, airDisconnect=airDisconnect, alarmRss=alarmRss, voltageSource=voltageSource, temperatureRadio=temperatureRadio, netBitrate=netBitrate, txBroadcast=txBroadcast, telnetd=telnetd, alarmSnr=alarmSnr, useLogStorage=useLogStorage, OptionSetting=OptionSetting, lineStatusII=lineStatusII, ray=ray, snrAlarm=snrAlarm, airWdog=airWdog, peerEthLinkDown=peerEthLinkDown, chassis=chassis, deviceName=deviceName, ModulationList=ModulationList, mdix=mdix, alarmTemperature=alarmTemperature, tr2Eth1LinkDown=tr2Eth1LinkDown, PYSNMP_MODULE_ID=ray, txModulationIndex=txModulationIndex, rxHCBytes=rxHCBytes, ifRadio=ifRadio, AlarmState=AlarmState, txCollisions=txCollisions, ip=ip, unitType=unitType, speed=speed, tr2SnrAlarm=tr2SnrAlarm, rss=rss, rssAlarm=rssAlarm, rfPowerFail=rfPowerFail, tr2RssAlarm=tr2RssAlarm, asymPause=asymPause, modemR=modemR, rxDones=rxDones, rayTraps=rayTraps, txMulticast=txMulticast, httpd=httpd, txLengthCheckErrors=txLengthCheckErrors, rxCodeErrors=rxCodeErrors, rxModulationIndex=rxModulationIndex, snr=snr, rxControlFrames=rxControlFrames, rxFalseCarrierErrors=rxFalseCarrierErrors, txModulation=txModulation, txHCBytes=txHCBytes, tr2BerAlarm=tr2BerAlarm, ifEthTable=ifEthTable, sshd=sshd, alarmBer=alarmBer, rxMulticast=rxMulticast, rxCrcErrors=rxCrcErrors, DisplayString=DisplayString, swVer=swVer, duplex=duplex, autonego=autonego, lineStatus=lineStatus, ifEth=ifEth, rxChannel=rxChannel, serviceVlanId=serviceVlanId, tr2Eth21LinkDown=tr2Eth21LinkDown, system=system, searchModeDisabled=searchModeDisabled, tr2WifiOn=tr2WifiOn, ethPeer=ethPeer, alarmVoltageLow=alarmVoltageLow, authorization=authorization, info=info, alarmNetBitrate=alarmNetBitrate, alarmEth1Down=alarmEth1Down, txChannel=txChannel, ifEthEntry=ifEthEntry, txControlFrames=txControlFrames, keyName=keyName, managementVlanId=managementVlanId, timeMaxDisconnect=timeMaxDisconnect, eth2InThroughput=eth2InThroughput, tr2AirConnect=tr2AirConnect, vlanId=vlanId, rxFreq=rxFreq, airConnect=airConnect, keyEntry=keyEntry, useMemory=useMemory)
