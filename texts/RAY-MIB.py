...
# Produced by pysmi-1.1.8 at Mon Jan  2 15:35:10 2023
...
IpAddress, Bits, ObjectIdentity, Integer32, Counter64, iso, NotificationType, TimeTicks, MibIdentifier, Unsigned32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "ObjectIdentity", "Integer32", "Counter64", "iso", "NotificationType", "TimeTicks", "MibIdentifier", "Unsigned32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "Counter32")
...
mibBuilder.exportSymbols("RAY-MIB", ifEth=ifEth, access=access, rxOutOfRangeErrors=rxOutOfRangeErrors, mdix=mdix, statistic=statistic, rxFalseCarrierErrors=rxFalseCarrierErrors, info=info, alarmNetBitrate=alarmNetBitrate, linkUptime=linkUptime, tr2AirConnect=tr2AirConnect, systemStatus=systemStatus, rxDones=rxDones, managementVlanId=managementVlanId, alarmEth1Down=alarmEth1Down, berAlarm=berAlarm, DisplayString=DisplayString, timeAllDisconnect=timeAllDisconnect, unitType=unitType, tr2VoltageLowAlarm=tr2VoltageLowAlarm, snrAlarm=snrAlarm, searchModeDisabled=searchModeDisabled, system=system, rxControlFrames=rxControlFrames, asymPause=asymPause, rxBroadcast=rxBroadcast, eth2OutThroughput=eth2OutThroughput, txLengthCheckErrors=txLengthCheckErrors, rss=rss, serialNumber=serialNumber, voltageSource=voltageSource, rxCrcErrors=rxCrcErrors, alarmPeerDisconnected=alarmPeerDisconnected, txControlFrames=txControlFrames, powerAlarm=powerAlarm, lineStatus=lineStatus, temperatureModem=temperatureModem, peerEthLinkDown=peerEthLinkDown, httpd=httpd, airWdog=airWdog, tr2VoltageHighAlarm=tr2VoltageHighAlarm, useCpu=useCpu, swVerRadio=swVerRadio, bandwidth=bandwidth, tr2Eth1LinkDown=tr2Eth1LinkDown, alarmTemperature=alarmTemperature, autonego=autonego, vlanId=vlanId, peerNumber=peerNumber, timeMaxDisconnect=timeMaxDisconnect, telnetd=telnetd, station=station, ber=ber, keyName=keyName, PhysAddress=PhysAddress, securePeerMode=securePeerMode, netBitrate=netBitrate, txCrcErrors=txCrcErrors, tr2RssAlarm=tr2RssAlarm, rfPowerConfigured=rfPowerConfigured, duplex=duplex, wifiHAP=wifiHAP, txChannel=txChannel, swVer=swVer, rxDroppedPkts=rxDroppedPkts, alarmSnr=alarmSnr, managementVlan=managementVlan, keyTable=keyTable, interface=interface, rxCodeErrors=rxCodeErrors, eth1Link=eth1Link, tr2BerAlarm=tr2BerAlarm, alarm=alarm, fecBlockCounter=fecBlockCounter, useLogStorage=useLogStorage, modemR=modemR, txHCBytes=txHCBytes, tr2Eth21LinkDown=tr2Eth21LinkDown, timeAllConnect=timeAllConnect, alarmVoltageHigh=alarmVoltageHigh, txMulticast=txMulticast, rfPowerFail=rfPowerFail, eth2Link=eth2Link, rayTraps=rayTraps, channelArrangement=channelArrangement, rxMulticast=rxMulticast, pause=pause, txPauseFrames=txPauseFrames, sshd=sshd, reliability=reliability, airDisconnect=airDisconnect, txFreq=txFreq, racom=racom, ServiceState=ServiceState, airConnect=airConnect, rxModulationIndex=rxModulationIndex, tr2AirDisconnect=tr2AirDisconnect, temperatureRadio=temperatureRadio, rfPowerCurrent=rfPowerCurrent, alarmRfPowerFail=alarmRfPowerFail, speed=speed, txModulationIndex=txModulationIndex, tr2TemperatureAlarm=tr2TemperatureAlarm, serviceVlanId=serviceVlanId, txDones=txDones, tr2WifiOn=tr2WifiOn, txModulation=txModulation, alarmEth2Down=alarmEth2Down, tr2SnrAlarm=tr2SnrAlarm, ifEthTable=ifEthTable, keyEntry=keyEntry, alarmRss=alarmRss, fecUncorrectBlockCounter=fecUncorrectBlockCounter, snr=snr, ethernet=ethernet, PYSNMP_MODULE_ID=ray, alarmVoltageLow=alarmVoltageLow, ip=ip, productName=productName, ethInThroughput=ethInThroughput, matching=matching, ray2Traps=ray2Traps, eth2InThroughput=eth2InThroughput, rssAlarm=rssAlarm, memoryAlarm=memoryAlarm, useMemory=useMemory, rxModulation=rxModulation, rxPauseFrames=rxPauseFrames, OptionSetting=OptionSetting, radio=radio, rxHCBytes=rxHCBytes, txCollisions=txCollisions, tempAlarm=tempAlarm, lineStatusII=lineStatusII, prioritized=prioritized, voltageUnit=voltageUnit, rfPowerStatus=rfPowerStatus, numDisconnect=numDisconnect, AlarmState=AlarmState, ethPeer=ethPeer, rxChannel=rxChannel, tr2RfPowerFail=tr2RfPowerFail, txBroadcast=txBroadcast, deviceName=deviceName, status=status, maxNetBitrate=maxNetBitrate, product=product, coding=coding, rxFreq=rxFreq, mac=mac, ethOutThroughput=ethOutThroughput, alarmBer=alarmBer, authorization=authorization, tr2NetBitrate=tr2NetBitrate, alarmWifiOn=alarmWifiOn, chassis=chassis, ray=ray, ifRadio=ifRadio, ModulationList=ModulationList, ifEthEntry=ifEthEntry, bandwidthKHz=bandwidthKHz)
