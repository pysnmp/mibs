...
IpAddress, enterprises, Bits, Unsigned32, NotificationType, ModuleIdentity, Counter32, Counter64, mib_2, iso, ObjectIdentity, MibIdentifier, TimeTicks, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "Bits", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter32", "Counter64", "mib-2", "iso", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("RAY-MIB", PhysAddress=PhysAddress, ber=ber, serviceVlanId=serviceVlanId, eth1Link=eth1Link, txPauseFrames=txPauseFrames, rxOutOfRangeErrors=rxOutOfRangeErrors, alarmVoltageLow=alarmVoltageLow, rxChannel=rxChannel, eth2Link=eth2Link, temperatureRadio=temperatureRadio, info=info, rxBroadcast=rxBroadcast, tr2BerAlarm=tr2BerAlarm, tr2NetBitrate=tr2NetBitrate, serialNumber=serialNumber, deviceName=deviceName, alarmTemperature=alarmTemperature, tr2WifiOn=tr2WifiOn, ray=ray, rssAlarm=rssAlarm, alarmPeerDisconnected=alarmPeerDisconnected, alarmRfPowerFail=alarmRfPowerFail, ServiceState=ServiceState, keyEntry=keyEntry, tr2VoltageLowAlarm=tr2VoltageLowAlarm, alarm=alarm, racom=racom, alarmBer=alarmBer, txHCBytes=txHCBytes, alarmWifiOn=alarmWifiOn, powerAlarm=powerAlarm, alarmEth2Down=alarmEth2Down, alarmEth1Down=alarmEth1Down, duplex=duplex, ethOutThroughput=ethOutThroughput, ModulationList=ModulationList, rfPowerStatus=rfPowerStatus, peerEthLinkDown=peerEthLinkDown, interface=interface, peerNumber=peerNumber, txMulticast=txMulticast, eth2OutThroughput=eth2OutThroughput, unitType=unitType, ray2Traps=ray2Traps, txBroadcast=txBroadcast, eth2InThroughput=eth2InThroughput, statistic=statistic, rfPowerConfigured=rfPowerConfigured, rxDones=rxDones, tr2RfPowerFail=tr2RfPowerFail, snr=snr, bandwidthKHz=bandwidthKHz, txModulation=txModulation, keyTable=keyTable, securePeerMode=securePeerMode, airConnect=airConnect, telnetd=telnetd, rfPowerCurrent=rfPowerCurrent, status=status, matching=matching, modemR=modemR, tr2VoltageHighAlarm=tr2VoltageHighAlarm, sshd=sshd, voltageSource=voltageSource, numDisconnect=numDisconnect, httpd=httpd, swVerRadio=swVerRadio, keyName=keyName, tr2RssAlarm=tr2RssAlarm, rfPowerFail=rfPowerFail, mdix=mdix, tr2AirDisconnect=tr2AirDisconnect, rxModulation=rxModulation, rxMulticast=rxMulticast, tr2AirConnect=tr2AirConnect, swVer=swVer, timeMaxDisconnect=timeMaxDisconnect, airDisconnect=airDisconnect, useMemory=useMemory, txCrcErrors=txCrcErrors, searchModeDisabled=searchModeDisabled, coding=coding, linkUptime=linkUptime, tr2Eth21LinkDown=tr2Eth21LinkDown, channelArrangement=channelArrangement, AlarmState=AlarmState, ifEth=ifEth, tr2SnrAlarm=tr2SnrAlarm, ethInThroughput=ethInThroughput, PYSNMP_MODULE_ID=ray, rxHCBytes=rxHCBytes, alarmRss=alarmRss, airWdog=airWdog, ethernet=ethernet, authorization=authorization, ethPeer=ethPeer, wifiHAP=wifiHAP, alarmSnr=alarmSnr, txDones=txDones, memoryAlarm=memoryAlarm, fecBlockCounter=fecBlockCounter, lineStatus=lineStatus, ifEthEntry=ifEthEntry, snrAlarm=snrAlarm, alarmNetBitrate=alarmNetBitrate, radio=radio, reliability=reliability, chassis=chassis, autonego=autonego, timeAllDisconnect=timeAllDisconnect, speed=speed, ifRadio=ifRadio, txChannel=txChannel, rxPauseFrames=rxPauseFrames, useLogStorage=useLogStorage, txModulationIndex=txModulationIndex, lineStatusII=lineStatusII, asymPause=asymPause, managementVlanId=managementVlanId, rxFreq=rxFreq, managementVlan=managementVlan, txControlFrames=txControlFrames, rxCodeErrors=rxCodeErrors, rxFalseCarrierErrors=rxFalseCarrierErrors, tempAlarm=tempAlarm, OptionSetting=OptionSetting, prioritized=prioritized, ifEthTable=ifEthTable, tr2Eth1LinkDown=tr2Eth1LinkDown, rxDroppedPkts=rxDroppedPkts, vlanId=vlanId, timeAllConnect=timeAllConnect, alarmVoltageHigh=alarmVoltageHigh, fecUncorrectBlockCounter=fecUncorrectBlockCounter, productName=productName, tr2TemperatureAlarm=tr2TemperatureAlarm, bandwidth=bandwidth, berAlarm=berAlarm, txCollisions=txCollisions, station=station, maxNetBitrate=maxNetBitrate, access=access, product=product, rxCrcErrors=rxCrcErrors, rxModulationIndex=rxModulationIndex, system=system, DisplayString=DisplayString, rayTraps=rayTraps, voltageUnit=voltageUnit, txLengthCheckErrors=txLengthCheckErrors, temperatureModem=temperatureModem, rss=rss, txFreq=txFreq, pause=pause, useCpu=useCpu, systemStatus=systemStatus, mac=mac, netBitrate=netBitrate, ip=ip, rxControlFrames=rxControlFrames)
