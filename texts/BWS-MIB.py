...
Gauge32, ModuleIdentity, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Integer32, Unsigned32, iso, ObjectIdentity, IpAddress, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Integer32", "Unsigned32", "iso", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyActiveConn=sslProxyActiveConn, activeApplications=activeApplications, ipsReqSrvcPort=ipsReqSrvcPort, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrAddress=sslSrvrAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrNumConn=httpSrvrNumConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, dataPathStatus=dataPathStatus, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, uptime=uptime, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, memUtilization=memUtilization, smRealmName=smRealmName, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsRCPort=ipsRCPort, sslSrvrState=sslSrvrState, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyAddressType=httpProxyAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, smNumUserSessions=smNumUserSessions, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheMiss=webCacheMiss, totalAttacks=totalAttacks, ipsLrnSrvcAddress=ipsLrnSrvcAddress, systemFailure=systemFailure, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCAddress=ipsRCAddress, webCmprPort=webCmprPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyOutBytes=sslProxyOutBytes, energizeUpdateExpire=energizeUpdateExpire, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclPort=ipsUrlAclPort, httpProxyInBytes=httpProxyInBytes, httpSrvrTotResponse=httpSrvrTotResponse, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlPort=ipsAccessCtrlPort, webCmprAddress=webCmprAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlAclReserved=ipsUrlAclReserved, activeServers=activeServers, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsHdrAclAddressType=ipsHdrAclAddressType, tempHigh=tempHigh, sslProxyAddress=sslProxyAddress, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, systemFanSpeed=systemFanSpeed, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyTotalConn=sslProxyTotalConn, ipsUrlNormAddress=ipsUrlNormAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, srvcName=srvcName, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyServerAbrt=httpProxyServerAbrt, cpuFanSpeed=cpuFanSpeed, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, smAgentName=smAgentName, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, tempCritical=tempCritical, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecPort=ipsCookieSecPort, cpuUtilization=cpuUtilization, securityDefUpdates=securityDefUpdates, totalApplications=totalApplications, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serviceStatus=serviceStatus, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, serverUp=serverUp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheReq=webCacheReq, httpSrvrState=httpSrvrState, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, totalMem=totalMem, ipsRCTotOutOfResource=ipsRCTotOutOfResource, logStorageHigh=logStorageHigh, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsMessage=bwsMessage, webCmprAddressType=webCmprAddressType, ipsRCTotQueued=ipsRCTotQueued, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, raidDegrading=raidDegrading, linkStatus=linkStatus, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyAddress=httpProxyAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrInBytes=httpSrvrInBytes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCacheHits=webCacheHits, bwsCompressionStatsEntry=bwsCompressionStatsEntry, processCountHigh=processCountHigh, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheProtocol=webCacheProtocol, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrTotRefused=sslSrvrTotRefused, serviceAddress=serviceAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCacheStale=webCacheStale, sslSrvrPort=sslSrvrPort, webCacheBytesOut=webCacheBytesOut, httpProxyServerErr=httpProxyServerErr, httpProxyPort=httpProxyPort, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitPort=ipsReqLimitPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, virusDefUpdates=virusDefUpdates, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrNumConn=sslSrvrNumConn, memoryUsageHigh=memoryUsageHigh, httpProxyParseErr=httpProxyParseErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, vipStatus=vipStatus, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, firmwareStorageHigh=firmwareStorageHigh, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsRCStatsTable=bwsIpsRCStatsTable, peerUp=peerUp, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheAddress=webCacheAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyTotalConn=httpProxyTotalConn, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsHdrAclHits=ipsHdrAclHits, ipsHdrAclPort=ipsHdrAclPort, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrAddressType=sslSrvrAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, totalBandwidth=totalBandwidth, firmwareStorage=firmwareStorage, peerDown=peerDown, logStorage=logStorage, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsMIBConformance=bwsMIBConformance, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, cpuTemperature=cpuTemperature, httpProxyTotalReq=httpProxyTotalReq, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrOutBytes=sslSrvrOutBytes, webCacheLongHdrs=webCacheLongHdrs, bwsMIBCompliances=bwsMIBCompliances, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCTotDropped=ipsRCTotDropped, httpSrvrAddress=httpSrvrAddress, PYSNMP_MODULE_ID=bws, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrInBytes=sslSrvrInBytes, httpSrvrPort=httpSrvrPort, systemSerialNumber=systemSerialNumber, webCmprProtocol=webCmprProtocol, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrTotTimedout=httpSrvrTotTimedout, switchingToMaintMode=switchingToMaintMode, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyErrPms=sslProxyErrPms, ipsRCAddressType=ipsRCAddressType, bws=bws, ipsUrlPolicyPort=ipsUrlPolicyPort, systemFailOver=systemFailOver, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsMIBGroups=bwsMIBGroups, freeMem=freeMem, bwstraps=bwstraps)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsStats=bwsStats, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsStatsGroup=bwsStatsGroup, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheCachedObjects=webCacheCachedObjects, systemLoad=systemLoad, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrAddressType=httpSrvrAddressType, webCachePort=webCachePort, httpProxyOutBytes=httpProxyOutBytes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, serverDown=serverDown, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrOutBytes=httpSrvrOutBytes, serviceName=serviceName, totalServers=totalServers, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsMIBCompliance=bwsMIBCompliance, servicePort=servicePort, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, switchingToBypassMode=switchingToBypassMode, dataPortLinkDown=dataPortLinkDown, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyAddressType=sslProxyAddressType, sslProxyInBytes=sslProxyInBytes, webCacheCacheableRes=webCacheCacheableRes, fanDead=fanDead, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyServerReq=httpProxyServerReq, sslProxyPort=sslProxyPort, webCacheAddressType=webCacheAddressType, operationalMode=operationalMode, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, dataPortLinkUp=dataPortLinkUp)
