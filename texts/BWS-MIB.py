...
Counter64, Counter32, ModuleIdentity, NotificationType, Unsigned32, MibIdentifier, iso, Bits, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "ModuleIdentity", "NotificationType", "Unsigned32", "MibIdentifier", "iso", "Bits", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxySessionTimeOut=httpProxySessionTimeOut, raidDegrading=raidDegrading, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsRCTimeStamp=ipsRCTimeStamp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyAddress=sslProxyAddress, peerDown=peerDown, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyCacheMiss=sslProxyCacheMiss, smRealmName=smRealmName, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrTotSuccess=httpSrvrTotSuccess, cpuUtilization=cpuUtilization, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, PYSNMP_MODULE_ID=bws, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCTotServed=ipsRCTotServed, logStorageHigh=logStorageHigh, systemFanSpeed=systemFanSpeed, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyAddressType=sslProxyAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, freeMem=freeMem, sslSrvrAvgResTime=sslSrvrAvgResTime, switchingToMaintMode=switchingToMaintMode, httpProxyTotalReq=httpProxyTotalReq, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheHits=webCacheHits, ipsUrlNormPort=ipsUrlNormPort, fanDead=fanDead, totalServers=totalServers, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, totalMem=totalMem, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, vipStatus=vipStatus, bwsMIBGroups=bwsMIBGroups, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsHdrAclAddressType=ipsHdrAclAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, bws=bws, sslSrvrAddress=sslSrvrAddress, logStorage=logStorage, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsStats=bwsStats, energizeUpdateExpire=energizeUpdateExpire, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotTimedout=sslSrvrTotTimedout, webCachePort=webCachePort, webCacheCachedObjects=webCacheCachedObjects, sslSrvrAddressType=sslSrvrAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqSrvcPort=ipsReqSrvcPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, activeServers=activeServers, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyInBytes=httpProxyInBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrState=sslSrvrState, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, securityDefUpdates=securityDefUpdates, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrInBytes=sslSrvrInBytes, webCmprProtocol=webCmprProtocol, dataPathStatus=dataPathStatus, memUtilization=memUtilization, serviceStatus=serviceStatus, httpProxyOutBytes=httpProxyOutBytes, httpProxyAddress=httpProxyAddress, ipsUrlAclReserved=ipsUrlAclReserved, peerUp=peerUp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, linkStatus=linkStatus, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyServerErr=httpProxyServerErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyInBytes=sslProxyInBytes, sharedSecretKeyExpired=sharedSecretKeyExpired, webCmprAddressType=webCmprAddressType, totalBandwidth=totalBandwidth, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCacheMiss=webCacheMiss, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheBytesOut=webCacheBytesOut, httpSrvrOutBytes=httpSrvrOutBytes, webCacheReq=webCacheReq, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsCacheStatsTable=bwsCacheStatsTable, virusDefUpdates=virusDefUpdates, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyAddressType=httpProxyAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyParseErr=httpProxyParseErr, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsServiceStatusTable=bwsServiceStatusTable, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, serviceName=serviceName, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, cpuFanSpeed=cpuFanSpeed, httpProxyPort=httpProxyPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsMessage=bwsMessage, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCmprAddress=webCmprAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyOutBytes=sslProxyOutBytes, bwsTrapGroup=bwsTrapGroup, httpProxyActiveConn=httpProxyActiveConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclPort=ipsUrlAclPort, httpSrvrNumConn=httpSrvrNumConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyServerReq=httpProxyServerReq, webCmprCompressedDataSize=webCmprCompressedDataSize, operationalMode=operationalMode, cpuTemperature=cpuTemperature, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, highAvailabilityStatus=highAvailabilityStatus, servicePort=servicePort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrPort=sslSrvrPort, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, totalApplications=totalApplications, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsMIBCompliance=bwsMIBCompliance, smAgentName=smAgentName, webCacheAddress=webCacheAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serviceAddress=serviceAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCacheAddressType=webCacheAddressType, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, systemLoad=systemLoad, httpProxyTotalConn=httpProxyTotalConn, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, totalAttacks=totalAttacks, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyPort=sslProxyPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyCurrentConn=sslProxyCurrentConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, tempCritical=tempCritical, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsMIBConformance=bwsMIBConformance, httpSrvrState=httpSrvrState, srvcName=srvcName, systemFailure=systemFailure, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, smNumUserSessions=smNumUserSessions, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsRCTotQueued=ipsRCTotQueued, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrPort=httpSrvrPort, ipsRCPort=ipsRCPort, sslSrvrOutBytes=sslSrvrOutBytes, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyCacheHits=sslProxyCacheHits, dataPortLinkUp=dataPortLinkUp, httpProxyServerAbrt=httpProxyServerAbrt, serverUp=serverUp, sslSrvrMinResTime=sslSrvrMinResTime, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsRCAddress=ipsRCAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsMIBCompliances=bwsMIBCompliances, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, activeApplications=activeApplications, processCountHigh=processCountHigh, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, serverDown=serverDown, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheProtocol=webCacheProtocol, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, switchingToInlineMode=switchingToInlineMode, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprPort=webCmprPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, uptime=uptime, sslProxyTotalConn=sslProxyTotalConn, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, tempHigh=tempHigh, bwsCompressionStatsEntry=bwsCompressionStatsEntry, systemSerialNumber=systemSerialNumber, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, firmwareStorage=firmwareStorage, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsHdrAclHits=ipsHdrAclHits, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwstraps=bwstraps, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, firmwareStorageHigh=firmwareStorageHigh, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsCookieSecPort=ipsCookieSecPort, currentFirmwareVersion=currentFirmwareVersion, ipsRCTotDropped=ipsRCTotDropped, webCacheStale=webCacheStale, systemFailOver=systemFailOver)
