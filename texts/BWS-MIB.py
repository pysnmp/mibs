...
iso, TimeTicks, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, Unsigned32, MibIdentifier, NotificationType, Counter64, IpAddress, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "Unsigned32", "MibIdentifier", "NotificationType", "Counter64", "IpAddress", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", totalBandwidth=totalBandwidth, dataPathStatus=dataPathStatus, bwsIpsRCStatsTable=bwsIpsRCStatsTable, cpuUtilization=cpuUtilization, serviceAddress=serviceAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrAddress=httpSrvrAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, smRealmName=smRealmName, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheReq=webCacheReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyOutBytes=httpProxyOutBytes, ipsRCTotServed=ipsRCTotServed, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, memUtilization=memUtilization, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, switchingToMaintMode=switchingToMaintMode, httpProxyTotalReq=httpProxyTotalReq, bwsStats=bwsStats, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, processCountHigh=processCountHigh, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, PYSNMP_MODULE_ID=bws, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqLimitAddressType=ipsReqLimitAddressType, uptime=uptime, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheBytesOut=webCacheBytesOut, sslSrvrOutBytes=sslSrvrOutBytes, currentFirmwareVersion=currentFirmwareVersion, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyActiveConn=httpProxyActiveConn, totalAttacks=totalAttacks, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrPort=sslSrvrPort, freeMem=freeMem, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlNormPort=ipsUrlNormPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, totalMem=totalMem, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serverUp=serverUp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, cpuFanSpeed=cpuFanSpeed, httpProxyAddressType=httpProxyAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrTotTimedout=sslSrvrTotTimedout, switchingToBypassMode=switchingToBypassMode, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrOutBytes=httpSrvrOutBytes, firmwareStorageHigh=firmwareStorageHigh, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyOutBytes=sslProxyOutBytes, webCacheAddressType=webCacheAddressType, tempCritical=tempCritical, fanDead=fanDead, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyActiveConn=sslProxyActiveConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, srvcName=srvcName, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheHits=webCacheHits, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyTotalConn=httpProxyTotalConn, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, peerUp=peerUp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, totalApplications=totalApplications, sslSrvrTotReqActive=sslSrvrTotReqActive, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrAddressType=sslSrvrAddressType, bwstraps=bwstraps, sslProxyAddress=sslProxyAddress, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, logStorage=logStorage, ipsUrlAclPort=ipsUrlAclPort, ipsRCAddressType=ipsRCAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrState=sslSrvrState, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrAddressType=httpSrvrAddressType, httpSrvrPort=httpSrvrPort, httpProxyAddress=httpProxyAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotReqRejected=sslSrvrTotReqRejected, serverDown=serverDown, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsRCAddress=ipsRCAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, cpuTemperature=cpuTemperature, ipsRCTotQueued=ipsRCTotQueued, sslProxyInBytes=sslProxyInBytes, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrAddress=sslSrvrAddress, webCmprAddressType=webCmprAddressType, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrMaxResTime=httpSrvrMaxResTime, serviceStatus=serviceStatus, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, firmwareStorage=firmwareStorage, webCmprAddress=webCmprAddress, serviceName=serviceName, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheLongHdrs=webCacheLongHdrs, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, virusDefUpdates=virusDefUpdates, vipStatus=vipStatus, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, activeServers=activeServers, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCachePort=webCachePort, webCmprPort=webCmprPort, httpSrvrMinResTime=httpSrvrMinResTime, logStorageHigh=logStorageHigh, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bws=bws, ipsHdrAclHits=ipsHdrAclHits, bwsMIBGroups=bwsMIBGroups, httpSrvrNumConn=httpSrvrNumConn, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqSrvcPort=ipsReqSrvcPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrSrvcAddress=httpSrvrSrvcAddress, systemSerialNumber=systemSerialNumber, operationalMode=operationalMode, sslProxyPort=sslProxyPort, bwsMessage=bwsMessage, smNumUserSessions=smNumUserSessions, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheCachedObjects=webCacheCachedObjects, ipsReqLimitPort=ipsReqLimitPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, switchingToInlineMode=switchingToInlineMode, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, linkStatus=linkStatus, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyClientAbrt=httpProxyClientAbrt, webCacheCacheableRes=webCacheCacheableRes, bwsTrapGroup=bwsTrapGroup, webCacheMiss=webCacheMiss, webCmprProtocol=webCmprProtocol, sslProxyErrPms=sslProxyErrPms, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrState=httpSrvrState, peerDown=peerDown, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrTotRefused=httpSrvrTotRefused, webCacheStale=webCacheStale, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyServerErr=httpProxyServerErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyInBytes=httpProxyInBytes, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsMIBCompliances=bwsMIBCompliances, sslProxyTotalReq=sslProxyTotalReq, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTotDropped=ipsRCTotDropped, dataPortLinkDown=dataPortLinkDown)
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcAddress=ipsLrnSrvcAddress, dataPortLinkUp=dataPortLinkUp, totalServers=totalServers, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, securityDefUpdates=securityDefUpdates, systemFanSpeed=systemFanSpeed, webCacheProtocol=webCacheProtocol, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyCacheHits=sslProxyCacheHits, ipsRCPort=ipsRCPort, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, systemFailure=systemFailure, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, energizeUpdateExpire=energizeUpdateExpire, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, servicePort=servicePort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrTotTimedout=httpSrvrTotTimedout, activeApplications=activeApplications, ipsHdrAclPort=ipsHdrAclPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, tempHigh=tempHigh, bwsStatsGroup=bwsStatsGroup, sslProxyAddressType=sslProxyAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, systemFailOver=systemFailOver, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyServerReq=httpProxyServerReq, bwsMIBConformance=bwsMIBConformance, httpProxyPort=httpProxyPort, httpProxyWAFWarnings=httpProxyWAFWarnings, systemLoad=systemLoad, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheAddress=webCacheAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, smAgentName=smAgentName, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, raidDegrading=raidDegrading, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyParseErr=httpProxyParseErr, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrNumConn=sslSrvrNumConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry)
