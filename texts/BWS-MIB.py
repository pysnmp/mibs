...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Gauge32, MibIdentifier, Unsigned32, IpAddress, iso, Integer32, ModuleIdentity, Counter32, TimeTicks, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Gauge32", "MibIdentifier", "Unsigned32", "IpAddress", "iso", "Integer32", "ModuleIdentity", "Counter32", "TimeTicks", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, memoryUsageHigh=memoryUsageHigh, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrState=sslSrvrState, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCPort=ipsRCPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyPort=httpProxyPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrMinResTime=sslSrvrMinResTime, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyOutBytes=sslProxyOutBytes, systemFailure=systemFailure, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsHdrAclPort=ipsHdrAclPort, switchingToMaintMode=switchingToMaintMode, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclAddressType=ipsUrlAclAddressType, logStorageHigh=logStorageHigh, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCAddressType=ipsRCAddressType, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyPort=sslProxyPort, webCmprAddress=webCmprAddress, sslProxyTotalReq=sslProxyTotalReq, bwsServiceStatusTable=bwsServiceStatusTable, serverUp=serverUp, bwsMIBCompliances=bwsMIBCompliances, webCacheStale=webCacheStale, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, dataPortLinkDown=dataPortLinkDown, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyWAFWarnings=httpProxyWAFWarnings, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrMinResTime=httpSrvrMinResTime, webCacheHits=webCacheHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyAddressType=sslProxyAddressType, ipsRCAddress=ipsRCAddress, activeServers=activeServers, operationalMode=operationalMode, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyServerReq=httpProxyServerReq, webCmprProtocol=webCmprProtocol, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, servicePort=servicePort, securityDefUpdates=securityDefUpdates, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, PYSNMP_MODULE_ID=bws, webCacheMiss=webCacheMiss, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlPort=ipsAccessCtrlPort, fanDead=fanDead, dataPortLinkUp=dataPortLinkUp, cpuUtilization=cpuUtilization, webCmprAddressType=webCmprAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, firmwareStorageHigh=firmwareStorageHigh, httpSrvrState=httpSrvrState, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyCurrentConn=sslProxyCurrentConn, totalServers=totalServers, totalMem=totalMem, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, energizeUpdateExpire=energizeUpdateExpire, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsMessage=bwsMessage, sslProxyActiveConn=sslProxyActiveConn, smAgentName=smAgentName, httpSrvrPort=httpSrvrPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCmprCompressedDataSize=webCmprCompressedDataSize, totalApplications=totalApplications, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, peerDown=peerDown, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyAddress=httpProxyAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyAddress=sslProxyAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, cpuTemperature=cpuTemperature, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyPort=ipsUrlPolicyPort, totalAttacks=totalAttacks, bwsMIBConformance=bwsMIBConformance, ipsCookieSecAddressType=ipsCookieSecAddressType, bws=bws, cpuFanSpeed=cpuFanSpeed, ipsCookieSecTampered=ipsCookieSecTampered, activeApplications=activeApplications, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqSrvcPort=ipsReqSrvcPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyInBytes=httpProxyInBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, tempCritical=tempCritical, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotRefused=sslSrvrTotRefused, webCacheAddressType=webCacheAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, linkStatus=linkStatus, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrAddressType=httpSrvrAddressType, bwsTrapGroup=bwsTrapGroup, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCacheCacheableRes=webCacheCacheableRes, ipsRCTotServed=ipsRCTotServed, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyOutBytes=httpProxyOutBytes, webCacheReq=webCacheReq, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, switchingToInlineMode=switchingToInlineMode, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, smRealmName=smRealmName, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, srvcName=srvcName, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, dataPathStatus=dataPathStatus, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecPort=ipsCookieSecPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, systemSerialNumber=systemSerialNumber, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyInBytes=sslProxyInBytes, serviceStatus=serviceStatus, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, highAvailabilityStatus=highAvailabilityStatus, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, virusDefUpdates=virusDefUpdates, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyTotalReq=httpProxyTotalReq, sslSrvrPort=sslSrvrPort, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsMIBGroups=bwsMIBGroups, memUtilization=memUtilization, webCmprPort=webCmprPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsStats=bwsStats, webCacheCachedObjects=webCacheCachedObjects, systemFailOver=systemFailOver, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, switchingToBypassMode=switchingToBypassMode, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyCacheMiss=sslProxyCacheMiss, raidDegrading=raidDegrading, uptime=uptime, processCountHigh=processCountHigh, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheAddress=webCacheAddress, systemLoad=systemLoad, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsRCTimeStamp=ipsRCTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyTotalConn=sslProxyTotalConn, ipsUrlNormAddress=ipsUrlNormAddress, vipStatus=vipStatus, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrAddressType=sslSrvrAddressType, sslSrvrNumConn=sslSrvrNumConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyServerErr=httpProxyServerErr, serviceAddress=serviceAddress)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrSrvcPort=sslSrvrSrvcPort, firmwareStorage=firmwareStorage, sslProxyCacheHits=sslProxyCacheHits, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsHdrAclHits=ipsHdrAclHits, bwsSMUserSessionTable=bwsSMUserSessionTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyErrPms=sslProxyErrPms, bwsStatsGroup=bwsStatsGroup, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyActiveConn=httpProxyActiveConn, webCacheBytesOut=webCacheBytesOut, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyParseErr=httpProxyParseErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsReqLimitPort=ipsReqLimitPort, webCachePort=webCachePort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrAddress=sslSrvrAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsRCTotDropped=ipsRCTotDropped, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, logStorage=logStorage, bwstraps=bwstraps, sharedSecretKeyExpired=sharedSecretKeyExpired, tempHigh=tempHigh, ipsUrlAclPort=ipsUrlAclPort, systemFanSpeed=systemFanSpeed, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlNormPort=ipsUrlNormPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyAddressType=httpProxyAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsMIBCompliance=bwsMIBCompliance, ipsCookieSecAddress=ipsCookieSecAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, serviceName=serviceName, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheProtocol=webCacheProtocol, serverDown=serverDown, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, smNumUserSessions=smNumUserSessions, ipsLrnSrvcAddress=ipsLrnSrvcAddress, peerUp=peerUp, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, totalBandwidth=totalBandwidth, httpProxyTotalConn=httpProxyTotalConn, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlAddress=ipsAccessCtrlAddress, freeMem=freeMem, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsCompressionStatsEntry=bwsCompressionStatsEntry)
