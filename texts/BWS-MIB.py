...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, NotificationType, Gauge32, Unsigned32, IpAddress, iso, Bits, Counter32, ModuleIdentity, ObjectIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "NotificationType", "Gauge32", "Unsigned32", "IpAddress", "iso", "Bits", "Counter32", "ModuleIdentity", "ObjectIdentity", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, systemLoad=systemLoad, dataPortLinkUp=dataPortLinkUp, firmwareStorageHigh=firmwareStorageHigh, sslProxyCacheHits=sslProxyCacheHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyServerErr=httpProxyServerErr, ipsRCTotDropped=ipsRCTotDropped, switchingToMaintMode=switchingToMaintMode, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, smAgentName=smAgentName, firmwareStorage=firmwareStorage, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCacheCachedObjects=webCacheCachedObjects, serviceName=serviceName, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCacheStale=webCacheStale, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheAddress=webCacheAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCmprAddress=webCmprAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCAddress=ipsRCAddress, cpuUtilization=cpuUtilization, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyInBytes=httpProxyInBytes, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCacheHits=webCacheHits, sslSrvrPort=sslSrvrPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, serviceAddress=serviceAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, logStorage=logStorage, sslProxyPort=sslProxyPort, serviceStatus=serviceStatus, sslProxyBadDNCErr=sslProxyBadDNCErr, uptime=uptime, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrOutBytes=httpSrvrOutBytes, cpuFanSpeed=cpuFanSpeed, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrAddress=httpSrvrAddress, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsMessage=bwsMessage, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, cpuTemperature=cpuTemperature, srvcName=srvcName, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyActiveConn=httpProxyActiveConn, bwsStats=bwsStats, memoryUsageHigh=memoryUsageHigh, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyErrPms=sslProxyErrPms, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitPort=ipsReqLimitPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, currentFirmwareVersion=currentFirmwareVersion, httpProxyOutBytes=httpProxyOutBytes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, smNumUserSessions=smNumUserSessions, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, raidDegrading=raidDegrading, sslProxyTotalReq=sslProxyTotalReq, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyAddress=sslProxyAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, vipStatus=vipStatus, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyAddress=httpProxyAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, serverUp=serverUp, securityDefUpdates=securityDefUpdates, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrAddressType=httpSrvrAddressType, ipsRCTotServed=ipsRCTotServed, webCacheBytesOut=webCacheBytesOut, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsMIBConformance=bwsMIBConformance, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyAddressType=httpProxyAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, activeApplications=activeApplications, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsTrapGroup=bwsTrapGroup, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrNumConn=httpSrvrNumConn, highAvailabilityStatus=highAvailabilityStatus, httpSrvrTotReqRejected=httpSrvrTotReqRejected, systemFailure=systemFailure, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheReq=webCacheReq, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, logStorageHigh=logStorageHigh, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsHdrAclHits=ipsHdrAclHits, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemFanSpeed=systemFanSpeed, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrAddress=sslSrvrAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, tempCritical=tempCritical, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, smRealmName=smRealmName, bwsMIBGroups=bwsMIBGroups, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormPort=ipsUrlNormPort, httpSrvrMaxResTime=httpSrvrMaxResTime, memUtilization=memUtilization, ipsUrlAclReserved=ipsUrlAclReserved, webCacheProtocol=webCacheProtocol, linkStatus=linkStatus, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCacheMiss=webCacheMiss, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsHdrAclPort=ipsHdrAclPort, systemFailOver=systemFailOver, fanDead=fanDead, webCmprAddressType=webCmprAddressType, httpSrvrState=httpSrvrState, sslProxyAddressType=sslProxyAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyServerReq=httpProxyServerReq, ipsRCTotQueued=ipsRCTotQueued, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, tempHigh=tempHigh, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, totalApplications=totalApplications, httpSrvrPort=httpSrvrPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyParseErr=httpProxyParseErr, peerDown=peerDown, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyTotalConn=httpProxyTotalConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, switchingToBypassMode=switchingToBypassMode, sslProxyActiveConn=sslProxyActiveConn, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, freeMem=freeMem, processCountHigh=processCountHigh, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCmprProtocol=webCmprProtocol, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, totalBandwidth=totalBandwidth, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, systemSerialNumber=systemSerialNumber, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrState=sslSrvrState, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyTotalReq=httpProxyTotalReq, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsMIBCompliances=bwsMIBCompliances, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrNumConn=sslSrvrNumConn, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyOutBytes=sslProxyOutBytes, sslSrvrAvgResTime=sslSrvrAvgResTime, serverDown=serverDown, totalServers=totalServers, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, dataPortLinkDown=dataPortLinkDown, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, energizeUpdateExpire=energizeUpdateExpire, ipsRCAddressType=ipsRCAddressType, sslSrvrInBytes=sslSrvrInBytes, webCmprPort=webCmprPort, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bws=bws, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, virusDefUpdates=virusDefUpdates)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAvgResTime=httpSrvrAvgResTime, peerUp=peerUp, sslProxyInBytes=sslProxyInBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCachePort=webCachePort, totalAttacks=totalAttacks, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCacheLongHdrs=webCacheLongHdrs, ipsRCPort=ipsRCPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, bwstraps=bwstraps, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheAddressType=webCacheAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheCacheableRes=webCacheCacheableRes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyPort=httpProxyPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecPort=ipsCookieSecPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, dataPathStatus=dataPathStatus, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitAddress=ipsReqLimitAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, totalMem=totalMem, PYSNMP_MODULE_ID=bws, httpProxyServerAbrt=httpProxyServerAbrt, activeServers=activeServers, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrMinResTime=httpSrvrMinResTime, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, operationalMode=operationalMode, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsMIBCompliance=bwsMIBCompliance, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsCookieSecAddress=ipsCookieSecAddress, servicePort=servicePort)
