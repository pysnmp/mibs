...
ModuleIdentity, iso, Bits, TimeTicks, Integer32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, IpAddress, Counter64, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Bits", "TimeTicks", "Integer32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "IpAddress", "Counter64", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, uptime=uptime, ipsRCAddress=ipsRCAddress, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, linkStatus=linkStatus, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, logStorage=logStorage, webCacheLongHdrs=webCacheLongHdrs, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, processCountHigh=processCountHigh, webCacheMiss=webCacheMiss, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyServerReq=httpProxyServerReq, webCmprAddress=webCmprAddress, switchingToBypassMode=switchingToBypassMode, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, firmwareStorage=firmwareStorage, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheAddressType=webCacheAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, highAvailabilityStatus=highAvailabilityStatus, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, energizeUpdateExpire=energizeUpdateExpire, httpProxyOutBytes=httpProxyOutBytes, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsStatsGroup=bwsStatsGroup, logStorageHigh=logStorageHigh, sslProxyErrPms=sslProxyErrPms, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlNormAddress=ipsUrlNormAddress, PYSNMP_MODULE_ID=bws, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsRCPort=ipsRCPort, httpProxyServerErr=httpProxyServerErr, ipsUrlAclAddressType=ipsUrlAclAddressType, dataPathStatus=dataPathStatus, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheAddress=webCacheAddress, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsMessage=bwsMessage, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsRCTotServed=ipsRCTotServed, sslProxyCacheHits=sslProxyCacheHits, smNumUserSessions=smNumUserSessions, activeServers=activeServers, bwstraps=bwstraps, cpuFanSpeed=cpuFanSpeed, webCacheProtocol=webCacheProtocol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, totalServers=totalServers, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyTotalReq=httpProxyTotalReq, httpProxyParseErr=httpProxyParseErr, sslProxyPort=sslProxyPort, httpSrvrState=httpSrvrState, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, switchingToMaintMode=switchingToMaintMode, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotResponse=httpSrvrTotResponse, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyActiveConn=httpProxyActiveConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitPort=ipsReqLimitPort, webCacheReq=webCacheReq, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, fanDead=fanDead, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, operationalMode=operationalMode, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotTimedout=httpSrvrTotTimedout, serviceAddress=serviceAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrTotRefused=httpSrvrTotRefused, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, firmwareStorageHigh=firmwareStorageHigh, httpProxyAddressType=httpProxyAddressType, memUtilization=memUtilization, sslProxyAddressType=sslProxyAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyTotalConn=httpProxyTotalConn, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, peerDown=peerDown, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsMIBCompliances=bwsMIBCompliances, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrInBytes=sslSrvrInBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrAddress=sslSrvrAddress, virusDefUpdates=virusDefUpdates, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrNumConn=sslSrvrNumConn, serverDown=serverDown, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyAddress=sslProxyAddress, httpSrvrNumConn=httpSrvrNumConn, webCmprPort=webCmprPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsHdrAclHits=ipsHdrAclHits, systemFailOver=systemFailOver, sslProxyTotalConn=sslProxyTotalConn, totalApplications=totalApplications, memoryUsageHigh=memoryUsageHigh, totalBandwidth=totalBandwidth, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheHits=webCacheHits, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, securityDefUpdates=securityDefUpdates, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCmprAddressType=webCmprAddressType, cpuTemperature=cpuTemperature, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyAddress=httpProxyAddress, sslProxyCurrentConn=sslProxyCurrentConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, vipStatus=vipStatus, totalMem=totalMem, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyClientAbrt=httpProxyClientAbrt, firmwareUpdateAvailable=firmwareUpdateAvailable, freeMem=freeMem, sslSrvrPort=sslSrvrPort, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsSMUserSessionTable=bwsSMUserSessionTable, peerUp=peerUp, currentFirmwareVersion=currentFirmwareVersion, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsMIBGroups=bwsMIBGroups, webCacheCacheableRes=webCacheCacheableRes, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, raidDegrading=raidDegrading, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, smRealmName=smRealmName, cpuUtilization=cpuUtilization, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCmprProtocol=webCmprProtocol, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsStats=bwsStats, httpProxyPort=httpProxyPort, ipsLrnSrvcPort=ipsLrnSrvcPort, serviceName=serviceName, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsHdrAclPort=ipsHdrAclPort, sslProxyActiveConn=sslProxyActiveConn, httpSrvrPort=httpSrvrPort, systemSerialNumber=systemSerialNumber, ipsRCAddressType=ipsRCAddressType, ipsUrlNormPort=ipsUrlNormPort, activeApplications=activeApplications, webCacheStale=webCacheStale, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrState=sslSrvrState, ipsReqSrvcPort=ipsReqSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, servicePort=servicePort, ipsRCTotDropped=ipsRCTotDropped, sslProxyOutBytes=sslProxyOutBytes, tempHigh=tempHigh, srvcName=srvcName, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsTrapGroup=bwsTrapGroup)
mibBuilder.exportSymbols("BWS-MIB", bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrAddress=httpSrvrAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, dataPortLinkDown=dataPortLinkDown, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrAddressType=sslSrvrAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyInBytes=sslProxyInBytes, bws=bws, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlAclAddress=ipsUrlAclAddress, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, smAgentName=smAgentName, sslProxyTotalReq=sslProxyTotalReq, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, systemLoad=systemLoad, tempCritical=tempCritical, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, systemFailure=systemFailure, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyInBytes=httpProxyInBytes, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, systemFanSpeed=systemFanSpeed, webCmprCompressibleDataSize=webCmprCompressibleDataSize, totalAttacks=totalAttacks, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, switchingToInlineMode=switchingToInlineMode, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, webCachePort=webCachePort, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serviceStatus=serviceStatus, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, serverUp=serverUp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsRCTotOutOfResource=ipsRCTotOutOfResource)
