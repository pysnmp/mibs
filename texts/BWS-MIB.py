...
Unsigned32, IpAddress, ObjectIdentity, Counter64, NotificationType, Integer32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Gauge32, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter64", "NotificationType", "Integer32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Gauge32", "Counter32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheLongHdrs=webCacheLongHdrs, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheHits=webCacheHits, dataPortLinkUp=dataPortLinkUp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrAddress=httpSrvrAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, systemLoad=systemLoad, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, tempCritical=tempCritical, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serverUp=serverUp, httpProxyTotalConn=httpProxyTotalConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, srvcName=srvcName, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsRCTotServed=ipsRCTotServed, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyPort=httpProxyPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsTrapGroup=bwsTrapGroup, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrInBytes=httpSrvrInBytes, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, logStorageHigh=logStorageHigh, webCmprPort=webCmprPort, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCmprAddressType=webCmprAddressType, ipsRCAddress=ipsRCAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, firmwareStorageHigh=firmwareStorageHigh, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyOutBytes=sslProxyOutBytes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrInBytes=sslSrvrInBytes, bwsMessage=bwsMessage, securityDefUpdates=securityDefUpdates, webCacheCacheableRes=webCacheCacheableRes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitPort=ipsReqLimitPort, sslSrvrAddress=sslSrvrAddress, sslSrvrAddressType=sslSrvrAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, vipStatus=vipStatus, sslProxyErrPms=sslProxyErrPms, tempHigh=tempHigh, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyAddress=httpProxyAddress, serviceName=serviceName, serviceStatus=serviceStatus, httpSrvrSrvcAddress=httpSrvrSrvcAddress, smRealmName=smRealmName, bws=bws, logStorage=logStorage, ipsReqLimitAddress=ipsReqLimitAddress, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCPort=ipsRCPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, PYSNMP_MODULE_ID=bws, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, activeApplications=activeApplications, webCacheProtocol=webCacheProtocol, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyCacheHits=sslProxyCacheHits, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyAddressType=sslProxyAddressType, switchingToMaintMode=switchingToMaintMode, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrPort=httpSrvrPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprProtocol=webCmprProtocol, webCacheAddressType=webCacheAddressType, webCacheBytesOut=webCacheBytesOut, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, smNumUserSessions=smNumUserSessions, ipsUrlPolicyAddress=ipsUrlPolicyAddress, systemFailOver=systemFailOver, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, serverDown=serverDown, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsStats=bwsStats, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, cpuUtilization=cpuUtilization, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCacheStale=webCacheStale, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrNumConn=sslSrvrNumConn, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheReq=webCacheReq, httpSrvrNumConn=httpSrvrNumConn, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrState=sslSrvrState, httpProxyServerReq=httpProxyServerReq, cpuFanSpeed=cpuFanSpeed, httpProxyAddressType=httpProxyAddressType, webCacheAddress=webCacheAddress, bwsMIBCompliance=bwsMIBCompliance, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, memUtilization=memUtilization, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyInBytes=httpProxyInBytes, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, totalServers=totalServers, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, systemFanSpeed=systemFanSpeed, fanDead=fanDead, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlAclPort=ipsUrlAclPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsRCTotDropped=ipsRCTotDropped, memoryUsageHigh=memoryUsageHigh, switchingToBypassMode=switchingToBypassMode, activeServers=activeServers, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyActiveConn=sslProxyActiveConn, httpSrvrState=httpSrvrState, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMIBCompliances=bwsMIBCompliances, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsStatsGroup=bwsStatsGroup, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCTotQueued=ipsRCTotQueued, smAgentName=smAgentName, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, dataPathStatus=dataPathStatus, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, cpuTemperature=cpuTemperature, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCachePort=webCachePort, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrNumFreeConn=httpSrvrNumFreeConn, totalApplications=totalApplications, operationalMode=operationalMode, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyPort=sslProxyPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsHdrAclPort=ipsHdrAclPort, raidDegrading=raidDegrading, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsMIBConformance=bwsMIBConformance, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsCookieSecPort=ipsCookieSecPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyServerAbrt=httpProxyServerAbrt, totalAttacks=totalAttacks, switchingToInlineMode=switchingToInlineMode, sslSrvrPort=sslSrvrPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrAddressType=httpSrvrAddressType, totalMem=totalMem, bwsSMUserSessionEntry=bwsSMUserSessionEntry, peerDown=peerDown, systemSerialNumber=systemSerialNumber, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrTotTimedout=sslSrvrTotTimedout, virusDefUpdates=virusDefUpdates, sslProxyCacheMiss=sslProxyCacheMiss, totalBandwidth=totalBandwidth, ipsUrlAclAddress=ipsUrlAclAddress)
mibBuilder.exportSymbols("BWS-MIB", linkStatus=linkStatus, sslSrvrMinResTime=sslSrvrMinResTime, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrTotRefused=sslSrvrTotRefused, highAvailabilityStatus=highAvailabilityStatus, bwstraps=bwstraps, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyAddress=sslProxyAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, uptime=uptime, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyInBytes=sslProxyInBytes, webCacheMiss=webCacheMiss, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyTotalReq=httpProxyTotalReq, webCmprAddress=webCmprAddress, peerUp=peerUp, freeMem=freeMem, httpSrvrOutBytes=httpSrvrOutBytes, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, processCountHigh=processCountHigh, serviceAddress=serviceAddress, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlPort=ipsAccessCtrlPort, dataPortLinkDown=dataPortLinkDown, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsHdrAclHits=ipsHdrAclHits, bwsMIBGroups=bwsMIBGroups, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, systemFailure=systemFailure, webCacheCachedObjects=webCacheCachedObjects, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrTotResponse=sslSrvrTotResponse, firmwareStorage=firmwareStorage, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, energizeUpdateExpire=energizeUpdateExpire, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyParseErr=httpProxyParseErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsRCAddressType=ipsRCAddressType, servicePort=servicePort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormPort=ipsUrlNormPort)
