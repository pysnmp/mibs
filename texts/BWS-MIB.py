...
Integer32, Counter64, Counter32, NotificationType, MibIdentifier, iso, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, TimeTicks, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Counter32", "NotificationType", "MibIdentifier", "iso", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "TimeTicks", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsTrapGroup=bwsTrapGroup, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, logStorageHigh=logStorageHigh, webCacheMiss=webCacheMiss, serviceStatus=serviceStatus, httpProxyAddress=httpProxyAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, webCacheCacheableRes=webCacheCacheableRes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, tempHigh=tempHigh, sslProxyAddress=sslProxyAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyServerErr=httpProxyServerErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlNormPort=ipsUrlNormPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrState=sslSrvrState, sslSrvrNumFreeConn=sslSrvrNumFreeConn, cpuFanSpeed=cpuFanSpeed, smRealmName=smRealmName, processCountHigh=processCountHigh, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclPort=ipsUrlAclPort, systemLoad=systemLoad, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyServerAbrt=httpProxyServerAbrt, uptime=uptime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, webCacheStale=webCacheStale, httpProxyParseErr=httpProxyParseErr, ipsCookieSecAddress=ipsCookieSecAddress, smAgentName=smAgentName, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrAddressType=httpSrvrAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyTotalConn=sslProxyTotalConn, webCacheCachedObjects=webCacheCachedObjects, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrPort=httpSrvrPort, switchingToMaintMode=switchingToMaintMode, ipsRCTotQueued=ipsRCTotQueued, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlNormAddress=ipsUrlNormAddress, ipsRCAddress=ipsRCAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCacheAddressType=webCacheAddressType, bws=bws, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, operationalMode=operationalMode, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprPort=webCmprPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsMIBGroups=bwsMIBGroups, httpSrvrAddress=httpSrvrAddress, httpSrvrOutBytes=httpSrvrOutBytes, vipStatus=vipStatus, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyPort=sslProxyPort, sslProxyBadCRLErr=sslProxyBadCRLErr, peerUp=peerUp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrNumConn=sslSrvrNumConn, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheHits=webCacheHits, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, srvcName=srvcName, ipsHdrAclHits=ipsHdrAclHits, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyBadDNCErr=sslProxyBadDNCErr, serviceName=serviceName, sslSrvrAddress=sslSrvrAddress, bwstraps=bwstraps, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyUnknownRsp=httpProxyUnknownRsp, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, webCachePort=webCachePort, ipsRCTotServed=ipsRCTotServed, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprCompressedDataSize=webCmprCompressedDataSize, securityDefUpdates=securityDefUpdates, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyServerReq=httpProxyServerReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, PYSNMP_MODULE_ID=bws, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyCurrentConn=sslProxyCurrentConn, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheBytesOut=webCacheBytesOut, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrTotRefused=sslSrvrTotRefused, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalApplications=totalApplications, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyAddressType=sslProxyAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyTotalReq=sslProxyTotalReq, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrState=httpSrvrState, httpSrvrTotTimedout=httpSrvrTotTimedout, linkStatus=linkStatus, switchingToBypassMode=switchingToBypassMode, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyCacheHits=sslProxyCacheHits, serverDown=serverDown, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, dataPortLinkDown=dataPortLinkDown, systemFailure=systemFailure, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyInBytes=sslProxyInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, currentFirmwareVersion=currentFirmwareVersion, logStorage=logStorage, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyClientAbrt=httpProxyClientAbrt, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrInBytes=httpSrvrInBytes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheAddress=webCacheAddress, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsStats=bwsStats, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitAddressType=ipsReqLimitAddressType, serviceAddress=serviceAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, totalBandwidth=totalBandwidth, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsCacheStatsTable=bwsCacheStatsTable, webCmprAddress=webCmprAddress, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, energizeUpdateExpire=energizeUpdateExpire, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyPort=httpProxyPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrAddressType=sslSrvrAddressType, bwsMIBConformance=bwsMIBConformance, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, highAvailabilityStatus=highAvailabilityStatus, bwsMIBCompliances=bwsMIBCompliances, webCmprAddressType=webCmprAddressType, freeMem=freeMem, dataPathStatus=dataPathStatus, httpSrvrNumConn=httpSrvrNumConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, memoryUsageHigh=memoryUsageHigh, activeServers=activeServers, memUtilization=memUtilization, sslSrvrAvgResTime=sslSrvrAvgResTime, serverUp=serverUp, fanDead=fanDead, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyTotalReq=httpProxyTotalReq, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, firmwareStorage=firmwareStorage, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, cpuTemperature=cpuTemperature, ipsUrlAclReserved=ipsUrlAclReserved, ipsWebAddrTransPort=ipsWebAddrTransPort, webCmprProtocol=webCmprProtocol, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsMIBCompliance=bwsMIBCompliance, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, totalAttacks=totalAttacks, systemFailOver=systemFailOver, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyActiveConn=sslProxyActiveConn, sslSrvrPort=sslSrvrPort, httpProxyAddressType=httpProxyAddressType)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyInBytes=httpProxyInBytes, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrTotRefused=httpSrvrTotRefused, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCacheProtocol=webCacheProtocol, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, raidDegrading=raidDegrading, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, systemFanSpeed=systemFanSpeed, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, switchingToInlineMode=switchingToInlineMode, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheReq=webCacheReq, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyErrPms=sslProxyErrPms, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, servicePort=servicePort, dataPortLinkUp=dataPortLinkUp, totalMem=totalMem, sslSrvrTotTimedout=sslSrvrTotTimedout, smNumUserSessions=smNumUserSessions, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsRCStatsTable=bwsIpsRCStatsTable, activeApplications=activeApplications, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsRCAddressType=ipsRCAddressType, firmwareStorageHigh=firmwareStorageHigh, tempCritical=tempCritical, ipsReqLimitPort=ipsReqLimitPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCTotDropped=ipsRCTotDropped, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, virusDefUpdates=virusDefUpdates, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsRCPort=ipsRCPort, totalServers=totalServers, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyTotalConn=httpProxyTotalConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyOutBytes=httpProxyOutBytes, cpuUtilization=cpuUtilization, ipsCookieSecPort=ipsCookieSecPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsMessage=bwsMessage, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, peerDown=peerDown)
