...
Counter32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, ModuleIdentity, Integer32, TimeTicks, Counter64, MibIdentifier, Gauge32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "ModuleIdentity", "Integer32", "TimeTicks", "Counter64", "MibIdentifier", "Gauge32", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclAddress=ipsUrlAclAddress, webCacheAddress=webCacheAddress, httpSrvrMinResTime=httpSrvrMinResTime, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsRCAddress=ipsRCAddress, energizeUpdateExpire=energizeUpdateExpire, bwsStats=bwsStats, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsMIBCompliances=bwsMIBCompliances, raidDegrading=raidDegrading, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, vipStatus=vipStatus, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCmprCompressedDataSize=webCmprCompressedDataSize, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, serverDown=serverDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bws=bws, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyTotalReq=sslProxyTotalReq, bwsMessage=bwsMessage, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrState=httpSrvrState, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, activeApplications=activeApplications, ipsCookieSecAddress=ipsCookieSecAddress, systemSerialNumber=systemSerialNumber, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, PYSNMP_MODULE_ID=bws, httpSrvrAvgResTime=httpSrvrAvgResTime, peerUp=peerUp, serverUp=serverUp, sslSrvrTotRefused=sslSrvrTotRefused, ipsHdrAclPort=ipsHdrAclPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, dataPathStatus=dataPathStatus, webCacheAddressType=webCacheAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, serviceName=serviceName, bwstraps=bwstraps, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlNormPort=ipsUrlNormPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, smNumUserSessions=smNumUserSessions, srvcName=srvcName, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, tempCritical=tempCritical, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsMIBGroups=bwsMIBGroups, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, systemFailOver=systemFailOver, bwsStatsGroup=bwsStatsGroup, processCountHigh=processCountHigh, sslProxyPort=sslProxyPort, servicePort=servicePort, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, activeServers=activeServers, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, totalServers=totalServers, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrAddressType=httpSrvrAddressType, linkStatus=linkStatus, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecPort=ipsCookieSecPort, smAgentName=smAgentName, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyCacheMiss=sslProxyCacheMiss, freeMem=freeMem, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, systemLoad=systemLoad, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCacheMiss=webCacheMiss, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyCacheHits=sslProxyCacheHits, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrAddress=httpSrvrAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlAclPort=ipsUrlAclPort, sslSrvrState=sslSrvrState, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, bwsCacheStatsEntry=bwsCacheStatsEntry, totalMem=totalMem, sslSrvrInBytes=sslSrvrInBytes, webCacheCacheableRes=webCacheCacheableRes, bwsTrapGroup=bwsTrapGroup, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsCacheStatsTable=bwsCacheStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrPort=httpSrvrPort, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, fanDead=fanDead, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCAddressType=ipsRCAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyOutBytes=httpProxyOutBytes, sslSrvrTotReqActive=sslSrvrTotReqActive, totalApplications=totalApplications, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyAddressType=sslProxyAddressType, systemFanSpeed=systemFanSpeed, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, firmwareStorageHigh=firmwareStorageHigh, peerDown=peerDown, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyActiveConn=httpProxyActiveConn, logStorage=logStorage, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitPort=ipsReqLimitPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsMIBCompliance=bwsMIBCompliance, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotResponse=sslSrvrTotResponse, totalAttacks=totalAttacks, httpProxyTotalConn=httpProxyTotalConn, webCacheCachedObjects=webCacheCachedObjects, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyPort=httpProxyPort, sslProxyInBytes=sslProxyInBytes, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, systemFailure=systemFailure, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsMIBConformance=bwsMIBConformance, highAvailabilityStatus=highAvailabilityStatus, httpSrvrInBytes=httpSrvrInBytes, sslProxyActiveConn=sslProxyActiveConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCPort=ipsRCPort, webCachePort=webCachePort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheBytesOut=webCacheBytesOut, webCacheStale=webCacheStale, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, switchingToMaintMode=switchingToMaintMode, smRealmName=smRealmName, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyAddress=httpProxyAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, serviceStatus=serviceStatus, httpProxyAddressType=httpProxyAddressType, sslSrvrPort=sslSrvrPort, securityDefUpdates=securityDefUpdates, switchingToInlineMode=switchingToInlineMode, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheHits=webCacheHits, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyServerErr=httpProxyServerErr, sslSrvrAddress=sslSrvrAddress, sslProxyOutBytes=sslProxyOutBytes, webCmprAddressType=webCmprAddressType, sslProxyErrPms=sslProxyErrPms, cpuTemperature=cpuTemperature, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumConn=httpSrvrNumConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheProtocol=webCacheProtocol, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsRCTimeStamp=ipsRCTimeStamp, ipsRCTotDropped=ipsRCTotDropped, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, operationalMode=operationalMode, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits)
mibBuilder.exportSymbols("BWS-MIB", ipsRCTotQueued=ipsRCTotQueued, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, virusDefUpdates=virusDefUpdates, firmwareStorage=firmwareStorage, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrOutBytes=sslSrvrOutBytes, serviceAddress=serviceAddress, dataPortLinkDown=dataPortLinkDown, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, logStorageHigh=logStorageHigh, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, currentFirmwareVersion=currentFirmwareVersion, totalBandwidth=totalBandwidth, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlPort=ipsAccessCtrlPort, cpuUtilization=cpuUtilization, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, memUtilization=memUtilization, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, tempHigh=tempHigh, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyAddress=sslProxyAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCacheReq=webCacheReq, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitAddress=ipsReqLimitAddress, uptime=uptime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, switchingToBypassMode=switchingToBypassMode, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyInBytes=httpProxyInBytes, ipsRCTotServed=ipsRCTotServed, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprPort=webCmprPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCmprAddress=webCmprAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyTotalConn=sslProxyTotalConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrAddressType=sslSrvrAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, memoryUsageHigh=memoryUsageHigh, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyServerReq=httpProxyServerReq, webCmprProtocol=webCmprProtocol, dataPortLinkUp=dataPortLinkUp, sslProxyBadCRLErr=sslProxyBadCRLErr)
