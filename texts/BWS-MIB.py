...
Unsigned32, ModuleIdentity, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Counter64, NotificationType, iso, MibIdentifier, ObjectIdentity, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Counter64", "NotificationType", "iso", "MibIdentifier", "ObjectIdentity", "Counter32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", totalServers=totalServers, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, firmwareStorageHigh=firmwareStorageHigh, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrAddress=httpSrvrAddress, ipsUrlAclReserved=ipsUrlAclReserved, webCmprPort=webCmprPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyAddress=httpProxyAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyAddressType=httpProxyAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyCurrentConn=sslProxyCurrentConn, systemFailure=systemFailure, httpSrvrTotResponse=httpSrvrTotResponse, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, totalApplications=totalApplications, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, memUtilization=memUtilization, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsRCAddressType=ipsRCAddressType, vipStatus=vipStatus, systemLoad=systemLoad, httpProxyTotalConn=httpProxyTotalConn, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcAddress=ipsLrnSrvcAddress, activeApplications=activeApplications, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, smRealmName=smRealmName, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsStatsGroup=bwsStatsGroup, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrNumConn=sslSrvrNumConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, serviceStatus=serviceStatus, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyPort=sslProxyPort, httpSrvrInBytes=httpSrvrInBytes, highAvailabilityStatus=highAvailabilityStatus, webCachePort=webCachePort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, dataPortLinkUp=dataPortLinkUp, tempCritical=tempCritical, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheBytesOut=webCacheBytesOut, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyTotalConn=sslProxyTotalConn, ipsRCTotDropped=ipsRCTotDropped, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheCacheableRes=webCacheCacheableRes, freeMem=freeMem, ipsReqSrvcAddress=ipsReqSrvcAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheAddressType=webCacheAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCacheReq=webCacheReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, switchingToInlineMode=switchingToInlineMode, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, processCountHigh=processCountHigh, sslProxyCacheTimeouts=sslProxyCacheTimeouts, totalAttacks=totalAttacks, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecTampered=ipsCookieSecTampered, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsRCAddress=ipsRCAddress, webCacheProtocol=webCacheProtocol, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyInBytes=sslProxyInBytes, ipsReqSrvcPort=ipsReqSrvcPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrAddressType=httpSrvrAddressType, ipsHdrAclHits=ipsHdrAclHits, webCmprProtocol=webCmprProtocol, httpProxyTotalReq=httpProxyTotalReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, currentFirmwareVersion=currentFirmwareVersion, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumConn=httpSrvrNumConn, cpuUtilization=cpuUtilization, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCPort=ipsRCPort, httpProxyServerReq=httpProxyServerReq, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, fanDead=fanDead, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyActiveConn=sslProxyActiveConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyErrPms=sslProxyErrPms, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, smAgentName=smAgentName, httpProxyActiveConn=httpProxyActiveConn, bwsTrapGroup=bwsTrapGroup, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, operationalMode=operationalMode, serviceName=serviceName, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMessage=bwsMessage, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsRCTotServed=ipsRCTotServed, httpSrvrTotSuccess=httpSrvrTotSuccess, smNumUserSessions=smNumUserSessions, sslSrvrTotReqRejected=sslSrvrTotReqRejected, memoryUsageHigh=memoryUsageHigh, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, peerUp=peerUp, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrAddressType=sslSrvrAddressType, httpProxyParseErr=httpProxyParseErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, dataPathStatus=dataPathStatus, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheAddress=webCacheAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyTotalReq=sslProxyTotalReq, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrPort=sslSrvrPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrState=sslSrvrState, raidDegrading=raidDegrading, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecPort=ipsCookieSecPort, energizeUpdateExpire=energizeUpdateExpire, bwstraps=bwstraps, activeServers=activeServers, httpProxyServerErr=httpProxyServerErr, sslSrvrMinResTime=sslSrvrMinResTime, switchingToBypassMode=switchingToBypassMode, logStorage=logStorage, dataPortLinkDown=dataPortLinkDown, sslSrvrAddress=sslSrvrAddress, serverUp=serverUp, httpSrvrPort=httpSrvrPort, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheHits=webCacheHits, ipsUrlAclPort=ipsUrlAclPort, PYSNMP_MODULE_ID=bws, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, srvcName=srvcName, sslProxyFullHandshakes=sslProxyFullHandshakes, systemSerialNumber=systemSerialNumber, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsStats=bwsStats, switchingToMaintMode=switchingToMaintMode, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyInBytes=httpProxyInBytes, totalMem=totalMem, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, firmwareStorage=firmwareStorage, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyPort=httpProxyPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyOutBytes=httpProxyOutBytes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsMIBGroups=bwsMIBGroups, bwsMIBCompliances=bwsMIBCompliances, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, virusDefUpdates=virusDefUpdates, webCacheMiss=webCacheMiss, bwsMIBCompliance=bwsMIBCompliance, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, linkStatus=linkStatus, servicePort=servicePort, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrOutBytes=sslSrvrOutBytes, tempHigh=tempHigh, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrTotResponse=sslSrvrTotResponse, uptime=uptime, webCmprAddress=webCmprAddress, ipsHdrAclAddress=ipsHdrAclAddress, bwsMIBConformance=bwsMIBConformance, sslProxyCacheHits=sslProxyCacheHits, httpSrvrTotRefused=httpSrvrTotRefused, webCmprAddressType=webCmprAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, totalBandwidth=totalBandwidth, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheStale=webCacheStale, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrTotSuccess=sslSrvrTotSuccess, systemFailOver=systemFailOver, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrMinResTime=httpSrvrMinResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheCachedObjects=webCacheCachedObjects, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrState=httpSrvrState, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyAddress=sslProxyAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, peerDown=peerDown, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, logStorageHigh=logStorageHigh, ipsReqLimitPort=ipsReqLimitPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, securityDefUpdates=securityDefUpdates, serverDown=serverDown, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, cpuFanSpeed=cpuFanSpeed, sslProxyAddressType=sslProxyAddressType, cpuTemperature=cpuTemperature, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bws=bws, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlNormPort=ipsUrlNormPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, serviceAddress=serviceAddress, systemFanSpeed=systemFanSpeed, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry)
