...
Integer32, Counter32, Unsigned32, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Counter64, ObjectIdentity, MibIdentifier, Bits, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Unsigned32", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Counter64", "ObjectIdentity", "MibIdentifier", "Bits", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsCacheStatsTable=bwsCacheStatsTable, ipsRCTotQueued=ipsRCTotQueued, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyCacheHits=sslProxyCacheHits, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrAddress=sslSrvrAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyPort=sslProxyPort, switchingToInlineMode=switchingToInlineMode, bwsStats=bwsStats, httpSrvrMinResTime=httpSrvrMinResTime, webCmprAddressType=webCmprAddressType, sslProxyOutBytes=sslProxyOutBytes, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitPort=ipsReqLimitPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, peerDown=peerDown, webCmprAddress=webCmprAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, systemFailOver=systemFailOver, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCmprCompressedDataSize=webCmprCompressedDataSize, fanDead=fanDead, totalBandwidth=totalBandwidth, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCTimeStamp=ipsRCTimeStamp, operationalMode=operationalMode, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, linkStatus=linkStatus, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, cpuUtilization=cpuUtilization, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, tempHigh=tempHigh, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, logStorage=logStorage, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sharedSecretKeyExpired=sharedSecretKeyExpired, bws=bws, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, dataPortLinkDown=dataPortLinkDown, httpSrvrPort=httpSrvrPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, webCachePort=webCachePort, webCacheMiss=webCacheMiss, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsMIBConformance=bwsMIBConformance, bwsStatsGroup=bwsStatsGroup, servicePort=servicePort, httpSrvrNumConn=httpSrvrNumConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrState=sslSrvrState, sslSrvrAddressType=sslSrvrAddressType, bwsMIBCompliances=bwsMIBCompliances, bwsMIBCompliance=bwsMIBCompliance, webCacheReq=webCacheReq, smRealmName=smRealmName, sslProxyActiveConn=sslProxyActiveConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyPort=httpProxyPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsRCTotDropped=ipsRCTotDropped, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsRCAddress=ipsRCAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, serverUp=serverUp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyClientAbrt=httpProxyClientAbrt, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsHdrAclHits=ipsHdrAclHits, httpSrvrSrvcPort=httpSrvrSrvcPort, currentFirmwareVersion=currentFirmwareVersion, memoryUsageHigh=memoryUsageHigh, PYSNMP_MODULE_ID=bws, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, srvcName=srvcName, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, firmwareStorageHigh=firmwareStorageHigh, sslProxyBadCRLErr=sslProxyBadCRLErr, totalServers=totalServers, sslProxyTotalConn=sslProxyTotalConn, systemLoad=systemLoad, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTotServed=ipsRCTotServed, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyAddressType=sslProxyAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyTotalConn=httpProxyTotalConn, webCacheAddressType=webCacheAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, systemFanSpeed=systemFanSpeed, bwsMessage=bwsMessage, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyServerAbrt=httpProxyServerAbrt, webCmprProtocol=webCmprProtocol, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheAddress=webCacheAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlAclAddress=ipsUrlAclAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrAddress=httpSrvrAddress, webCacheBytesOut=webCacheBytesOut, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlAclReserved=ipsUrlAclReserved, totalMem=totalMem, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrPort=sslSrvrPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsHdrAclPort=ipsHdrAclPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, peerUp=peerUp, ipsReqLimitAddress=ipsReqLimitAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsTrapGroup=bwsTrapGroup, webCacheCacheableRes=webCacheCacheableRes, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, processCountHigh=processCountHigh, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, virusDefUpdates=virusDefUpdates, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, vipStatus=vipStatus, ipsRCPort=ipsRCPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrState=httpSrvrState, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyParseErr=httpProxyParseErr, securityDefUpdates=securityDefUpdates, httpSrvrAddressType=httpSrvrAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, raidDegrading=raidDegrading, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyTotalReq=httpProxyTotalReq, webCacheHits=webCacheHits, httpProxyOutBytes=httpProxyOutBytes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyAddress=httpProxyAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheProtocol=webCacheProtocol, totalAttacks=totalAttacks, dataPortLinkUp=dataPortLinkUp, energizeUpdateExpire=energizeUpdateExpire, sslSrvrMinResTime=sslSrvrMinResTime, switchingToBypassMode=switchingToBypassMode, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, systemFailure=systemFailure, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyActiveConn=httpProxyActiveConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, bwsMIBGroups=bwsMIBGroups, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCacheStale=webCacheStale, ipsWebAddrTransPort=ipsWebAddrTransPort, logStorageHigh=logStorageHigh, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwstraps=bwstraps, memUtilization=memUtilization)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumConn=sslSrvrNumConn, sslSrvrAvgResTime=sslSrvrAvgResTime, tempCritical=tempCritical, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCmprPort=webCmprPort, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrTotTimedout=sslSrvrTotTimedout, serviceName=serviceName, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, smNumUserSessions=smNumUserSessions, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, cpuTemperature=cpuTemperature, webCacheLongHdrs=webCacheLongHdrs, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, smAgentName=smAgentName, sslSrvrTotReqRejected=sslSrvrTotReqRejected, totalApplications=totalApplications, cpuFanSpeed=cpuFanSpeed, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCAddressType=ipsRCAddressType, uptime=uptime, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, firmwareStorage=firmwareStorage, serviceStatus=serviceStatus, sslProxyInBytes=sslProxyInBytes, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, freeMem=freeMem, ipsUrlNormAddress=ipsUrlNormAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, systemSerialNumber=systemSerialNumber, activeServers=activeServers, serviceAddress=serviceAddress, sslProxyErrPms=sslProxyErrPms, httpSrvrInBytes=httpSrvrInBytes, ipsUrlNormPort=ipsUrlNormPort, sslProxyAddress=sslProxyAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, activeApplications=activeApplications, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrInBytes=sslSrvrInBytes, ipsCookieSecPort=ipsCookieSecPort, bwsCacheStatsEntry=bwsCacheStatsEntry, dataPathStatus=dataPathStatus, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, serverDown=serverDown, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyServerReq=httpProxyServerReq, ipsUrlAclPort=ipsUrlAclPort)
