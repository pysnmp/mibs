...
Integer32, iso, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Bits, TimeTicks, IpAddress, Counter32, ModuleIdentity, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Bits", "TimeTicks", "IpAddress", "Counter32", "ModuleIdentity", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyActiveConn=sslProxyActiveConn, tempHigh=tempHigh, totalAttacks=totalAttacks, totalBandwidth=totalBandwidth, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, systemFailOver=systemFailOver, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrMinResTime=httpSrvrMinResTime, dataPathStatus=dataPathStatus, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprProtocol=webCmprProtocol, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, peerDown=peerDown, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, switchingToBypassMode=switchingToBypassMode, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, srvcName=srvcName, firmwareStorageHigh=firmwareStorageHigh, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsMIBCompliances=bwsMIBCompliances, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheAddressType=webCacheAddressType, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, fanDead=fanDead, webCacheMiss=webCacheMiss, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, dataPortLinkUp=dataPortLinkUp, httpSrvrAddress=httpSrvrAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, smNumUserSessions=smNumUserSessions, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsHdrAclHits=ipsHdrAclHits, bwsMIBGroups=bwsMIBGroups, uptime=uptime, sslProxyCacheHits=sslProxyCacheHits, smRealmName=smRealmName, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, serviceAddress=serviceAddress, bwstraps=bwstraps, webCacheAddress=webCacheAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqSrvcPort=ipsReqSrvcPort, activeServers=activeServers, currentFirmwareVersion=currentFirmwareVersion, ipsHdrAclPort=ipsHdrAclPort, systemSerialNumber=systemSerialNumber, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrInBytes=sslSrvrInBytes, sslProxyCacheMiss=sslProxyCacheMiss, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, totalApplications=totalApplications, bwsStatsGroup=bwsStatsGroup, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyAddress=sslProxyAddress, webCacheStale=webCacheStale, sslProxyFullHandshakes=sslProxyFullHandshakes, webCachePort=webCachePort, sslSrvrAddressType=sslSrvrAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyTotalReq=sslProxyTotalReq, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sharedSecretKeyExpired=sharedSecretKeyExpired, memUtilization=memUtilization, httpProxyActiveConn=httpProxyActiveConn, bwsMessage=bwsMessage, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, activeApplications=activeApplications, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprPort=webCmprPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheProtocol=webCacheProtocol, httpProxyAddressType=httpProxyAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, highAvailabilityStatus=highAvailabilityStatus, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxySessionTimeOut=httpProxySessionTimeOut, energizeUpdateExpire=energizeUpdateExpire, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCmprAddress=webCmprAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheReq=webCacheReq, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotRefused=sslSrvrTotRefused, vipStatus=vipStatus, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyInBytes=sslProxyInBytes, bwsStats=bwsStats, switchingToMaintMode=switchingToMaintMode, httpProxyServerErr=httpProxyServerErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, totalMem=totalMem, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, serviceName=serviceName, raidDegrading=raidDegrading, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyParseErr=httpProxyParseErr, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrPort=sslSrvrPort, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyPort=httpProxyPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, serverDown=serverDown, sslSrvrState=sslSrvrState, PYSNMP_MODULE_ID=bws, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrState=httpSrvrState, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyTotalConn=httpProxyTotalConn, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrInBytes=httpSrvrInBytes, switchingToInlineMode=switchingToInlineMode, processCountHigh=processCountHigh, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyCurrentConn=sslProxyCurrentConn, ipsRCTotServed=ipsRCTotServed, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, systemFanSpeed=systemFanSpeed, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlNormPort=ipsUrlNormPort, bwsMIBConformance=bwsMIBConformance, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyAddressType=sslProxyAddressType, webCmprAddressType=webCmprAddressType, servicePort=servicePort, securityDefUpdates=securityDefUpdates, serviceStatus=serviceStatus, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsRCTimeStamp=ipsRCTimeStamp, bwsMIBCompliance=bwsMIBCompliance, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheHits=webCacheHits, linkStatus=linkStatus, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, freeMem=freeMem, sslProxyOutBytes=sslProxyOutBytes, systemLoad=systemLoad, totalServers=totalServers, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, logStorage=logStorage, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyServerReq=httpProxyServerReq, ipsCookieSecPort=ipsCookieSecPort, sslSrvrAddress=sslSrvrAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCAddress=ipsRCAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCacheCacheableRes=webCacheCacheableRes, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrNumConn=httpSrvrNumConn)
mibBuilder.exportSymbols("BWS-MIB", ipsRCTotDropped=ipsRCTotDropped, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheBytesOut=webCacheBytesOut, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlAddress=ipsAccessCtrlAddress, peerUp=peerUp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, cpuTemperature=cpuTemperature, systemFailure=systemFailure, httpSrvrAddressType=httpSrvrAddressType, bws=bws, cpuFanSpeed=cpuFanSpeed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyPort=sslProxyPort, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrPort=httpSrvrPort, httpProxyAddress=httpProxyAddress, virusDefUpdates=virusDefUpdates, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyServerAbrt=httpProxyServerAbrt, firmwareStorage=firmwareStorage, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheCachedObjects=webCacheCachedObjects, serverUp=serverUp, memoryUsageHigh=memoryUsageHigh, cpuUtilization=cpuUtilization, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrNumConn=sslSrvrNumConn, tempCritical=tempCritical, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, logStorageHigh=logStorageHigh, smAgentName=smAgentName, httpProxyTotalReq=httpProxyTotalReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyErrPms=sslProxyErrPms, sslProxyTotalConn=sslProxyTotalConn, ipsRCPort=ipsRCPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyClientAbrt=httpProxyClientAbrt, operationalMode=operationalMode, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, dataPortLinkDown=dataPortLinkDown, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess)
