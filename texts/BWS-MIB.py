...
Gauge32, ObjectIdentity, Counter64, Integer32, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Unsigned32, iso, IpAddress, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Counter64", "Integer32", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Unsigned32", "iso", "IpAddress", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", peerUp=peerUp, webCmprAddressType=webCmprAddressType, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyErrPms=sslProxyErrPms, linkStatus=linkStatus, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, PYSNMP_MODULE_ID=bws, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsStats=bwsStats, tempCritical=tempCritical, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, servicePort=servicePort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, serviceAddress=serviceAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheCacheableRes=webCacheCacheableRes, httpProxyOutBytes=httpProxyOutBytes, bwstraps=bwstraps, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bws=bws, bwsMIBCompliances=bwsMIBCompliances, httpProxyClientAbrt=httpProxyClientAbrt, webCacheReq=webCacheReq, sslSrvrInBytes=sslSrvrInBytes, sslProxyAddressType=sslProxyAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, serverUp=serverUp, cpuTemperature=cpuTemperature, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCacheBytesOut=webCacheBytesOut, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrState=sslSrvrState, httpSrvrPort=httpSrvrPort, ipsHdrAclHits=ipsHdrAclHits, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyOutBytes=sslProxyOutBytes, webCacheHits=webCacheHits, totalApplications=totalApplications, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyCacheTimeouts=sslProxyCacheTimeouts, cpuUtilization=cpuUtilization, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCmprPort=webCmprPort, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheAddress=webCacheAddress, httpSrvrMinResTime=httpSrvrMinResTime, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyAddress=sslProxyAddress, ipsRCAddress=ipsRCAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, vipStatus=vipStatus, dataPortLinkDown=dataPortLinkDown, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyInBytes=httpProxyInBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrAddress=sslSrvrAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, freeMem=freeMem, operationalMode=operationalMode, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, fanDead=fanDead, httpProxyServerErr=httpProxyServerErr, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsMIBConformance=bwsMIBConformance, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsRCTimeStamp=ipsRCTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, tempHigh=tempHigh, peerDown=peerDown, httpProxyAddress=httpProxyAddress, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, switchingToInlineMode=switchingToInlineMode, systemFailure=systemFailure, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlNormPort=ipsUrlNormPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrTotSuccess=httpSrvrTotSuccess, firmwareStorageHigh=firmwareStorageHigh, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, virusDefUpdates=virusDefUpdates, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCAddressType=ipsRCAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyActiveConn=sslProxyActiveConn, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, energizeUpdateExpire=energizeUpdateExpire, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclPort=ipsUrlAclPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheStale=webCacheStale, ipsHdrAclPort=ipsHdrAclPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, dataPortLinkUp=dataPortLinkUp, webCachePort=webCachePort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, switchingToMaintMode=switchingToMaintMode, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, totalMem=totalMem, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrState=httpSrvrState, logStorageHigh=logStorageHigh, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyParseErr=httpProxyParseErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, systemLoad=systemLoad, ipsRCTotDropped=ipsRCTotDropped, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyServerReq=httpProxyServerReq, totalServers=totalServers, totalAttacks=totalAttacks, ipsCookieSecPort=ipsCookieSecPort, raidDegrading=raidDegrading, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrTotResponse=sslSrvrTotResponse, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrAddressType=sslSrvrAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsMessage=bwsMessage, firmwareUpdateAvailable=firmwareUpdateAvailable, smNumUserSessions=smNumUserSessions, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, serverDown=serverDown, memUtilization=memUtilization, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyAddress=ipsUrlPolicyAddress, dataPathStatus=dataPathStatus, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serviceStatus=serviceStatus, httpSrvrSrvcPort=httpSrvrSrvcPort, serviceName=serviceName, ipsRCPort=ipsRCPort, securityDefUpdates=securityDefUpdates, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyActiveConn=httpProxyActiveConn, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrNumConn=httpSrvrNumConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, uptime=uptime, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, srvcName=srvcName, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrNumConn=sslSrvrNumConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, smRealmName=smRealmName, logStorage=logStorage, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, memoryUsageHigh=memoryUsageHigh, httpProxyPort=httpProxyPort, webCacheLongHdrs=webCacheLongHdrs, systemSerialNumber=systemSerialNumber, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyTotalConn=sslProxyTotalConn, activeServers=activeServers, bwsTrapGroup=bwsTrapGroup, systemFanSpeed=systemFanSpeed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr)
mibBuilder.exportSymbols("BWS-MIB", cpuFanSpeed=cpuFanSpeed, webCacheAddressType=webCacheAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, processCountHigh=processCountHigh, webCmprProtocol=webCmprProtocol, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsMIBCompliance=bwsMIBCompliance, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, totalBandwidth=totalBandwidth, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, firmwareStorage=firmwareStorage, webCacheProtocol=webCacheProtocol, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyAddressType=httpProxyAddressType, ipsReqLimitPort=ipsReqLimitPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsStatsGroup=bwsStatsGroup, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, currentFirmwareVersion=currentFirmwareVersion, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitAddress=ipsReqLimitAddress, bwsMIBGroups=bwsMIBGroups, systemFailOver=systemFailOver, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyInBytes=sslProxyInBytes, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyPort=sslProxyPort, smAgentName=smAgentName, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqSrvcPort=ipsReqSrvcPort, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyTotalConn=httpProxyTotalConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrPort=sslSrvrPort, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, activeApplications=activeApplications, webCmprAddress=webCmprAddress, webCacheMiss=webCacheMiss, sslProxyTotalReq=sslProxyTotalReq, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCTotQueued=ipsRCTotQueued, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable)
