...
Bits, ModuleIdentity, Counter32, TimeTicks, Unsigned32, Gauge32, ObjectIdentity, IpAddress, Counter64, MibIdentifier, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Counter32", "TimeTicks", "Unsigned32", "Gauge32", "ObjectIdentity", "IpAddress", "Counter64", "MibIdentifier", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsMessage=bwsMessage, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, cpuUtilization=cpuUtilization, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsTrapGroup=bwsTrapGroup, sslSrvrNumConn=sslSrvrNumConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitPort=ipsReqLimitPort, dataPortLinkUp=dataPortLinkUp, ipsRCTotServed=ipsRCTotServed, virusDefUpdates=virusDefUpdates, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, webCmprProtocol=webCmprProtocol, logStorageHigh=logStorageHigh, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyServerErr=httpProxyServerErr, systemSerialNumber=systemSerialNumber, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, tempCritical=tempCritical, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyServerAbrt=httpProxyServerAbrt, webCacheAddress=webCacheAddress, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyAddress=sslProxyAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclAddress=ipsUrlAclAddress, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, securityDefUpdates=securityDefUpdates, httpProxyParseErr=httpProxyParseErr, httpProxyTotalReq=httpProxyTotalReq, webCacheHits=webCacheHits, tempHigh=tempHigh, httpSrvrAddress=httpSrvrAddress, sslSrvrInBytes=sslSrvrInBytes, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, switchingToMaintMode=switchingToMaintMode, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrAddress=sslSrvrAddress, webCachePort=webCachePort, webCacheMiss=webCacheMiss, httpSrvrMinResTime=httpSrvrMinResTime, ipsHdrAclHits=ipsHdrAclHits, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrTotReqRejected=sslSrvrTotReqRejected, systemFailure=systemFailure, bwsMIBCompliance=bwsMIBCompliance, systemFanSpeed=systemFanSpeed, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqSrvcPort=ipsReqSrvcPort, servicePort=servicePort, systemLoad=systemLoad, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, processCountHigh=processCountHigh, operationalMode=operationalMode, httpProxyTotalConn=httpProxyTotalConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyAddressType=httpProxyAddressType, serviceName=serviceName, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrOutBytes=sslSrvrOutBytes, smRealmName=smRealmName, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, energizeUpdateExpire=energizeUpdateExpire, webCacheBytesOut=webCacheBytesOut, totalServers=totalServers, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyBadDNCErr=sslProxyBadDNCErr, totalApplications=totalApplications, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCmprAddressType=webCmprAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, serviceAddress=serviceAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrNumConn=httpSrvrNumConn, bwsMIBCompliances=bwsMIBCompliances, sslProxyErrPms=sslProxyErrPms, activeApplications=activeApplications, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecTampered=ipsCookieSecTampered, serviceStatus=serviceStatus, httpProxyInBytes=httpProxyInBytes, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, raidDegrading=raidDegrading, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, switchingToBypassMode=switchingToBypassMode, dataPortLinkDown=dataPortLinkDown, httpSrvrPort=httpSrvrPort, ipsUrlAclReserved=ipsUrlAclReserved, logStorage=logStorage, fanDead=fanDead, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, smAgentName=smAgentName, ipsHdrAclPort=ipsHdrAclPort, ipsRCPort=ipsRCPort, bwsStatsGroup=bwsStatsGroup, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, uptime=uptime, sslProxyPort=sslProxyPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, totalBandwidth=totalBandwidth, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsRCAddress=ipsRCAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsStats=bwsStats, sslProxyTotalReq=sslProxyTotalReq, serverDown=serverDown, freeMem=freeMem, httpProxyOutBytes=httpProxyOutBytes, smNumUserSessions=smNumUserSessions, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlPort=ipsAccessCtrlPort, webCacheStale=webCacheStale, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, peerUp=peerUp, sslSrvrPort=sslSrvrPort, httpProxyWAFWarnings=httpProxyWAFWarnings, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrState=sslSrvrState, ipsUrlAclPort=ipsUrlAclPort, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsCacheStatsEntry=bwsCacheStatsEntry, bws=bws, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCTotDropped=ipsRCTotDropped, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, cpuFanSpeed=cpuFanSpeed, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyServerReq=httpProxyServerReq, httpSrvrState=httpSrvrState, switchingToInlineMode=switchingToInlineMode, httpProxyActiveConn=httpProxyActiveConn, srvcName=srvcName, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheProtocol=webCacheProtocol, PYSNMP_MODULE_ID=bws, activeServers=activeServers, highAvailabilityStatus=highAvailabilityStatus, ipsRCAddressType=ipsRCAddressType, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCmprAddress=webCmprAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrOutBytes=httpSrvrOutBytes, totalAttacks=totalAttacks, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyCacheMiss=sslProxyCacheMiss, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotRefused=httpSrvrTotRefused, peerDown=peerDown, systemFailOver=systemFailOver, sslProxyCacheHits=sslProxyCacheHits, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, linkStatus=linkStatus, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, memoryUsageHigh=memoryUsageHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrAddressType=sslSrvrAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, totalMem=totalMem, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsRCTotQueued=ipsRCTotQueued, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyTotalConn=sslProxyTotalConn, httpProxyPort=httpProxyPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlNormAddress=ipsUrlNormAddress, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyClientAbrt=httpProxyClientAbrt, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, serverUp=serverUp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrTotTimedout=httpSrvrTotTimedout, webCmprPort=webCmprPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotReqRejected=httpSrvrTotReqRejected, memUtilization=memUtilization, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrAddressType=httpSrvrAddressType, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrMinResTime=sslSrvrMinResTime, cpuTemperature=cpuTemperature, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, vipStatus=vipStatus, webCacheReq=webCacheReq, httpProxyAddress=httpProxyAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwstraps=bwstraps, webCacheAddressType=webCacheAddressType, firmwareStorageHigh=firmwareStorageHigh, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, firmwareStorage=firmwareStorage, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyInBytes=sslProxyInBytes, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, dataPathStatus=dataPathStatus, bwsMIBConformance=bwsMIBConformance, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr)
