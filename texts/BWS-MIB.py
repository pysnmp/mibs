...
NotificationType, Bits, iso, ObjectIdentity, Gauge32, Counter32, TimeTicks, MibIdentifier, Counter64, Unsigned32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "iso", "ObjectIdentity", "Gauge32", "Counter32", "TimeTicks", "MibIdentifier", "Counter64", "Unsigned32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, freeMem=freeMem, systemFailOver=systemFailOver, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, virusDefUpdates=virusDefUpdates, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrTotTimedout=sslSrvrTotTimedout, processCountHigh=processCountHigh, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyServerErr=httpProxyServerErr, activeApplications=activeApplications, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, serviceAddress=serviceAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, currentFirmwareVersion=currentFirmwareVersion, cpuFanSpeed=cpuFanSpeed, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsMIBCompliance=bwsMIBCompliance, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwstraps=bwstraps, serverUp=serverUp, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyTotalReq=httpProxyTotalReq, webCacheMiss=webCacheMiss, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyErrPms=sslProxyErrPms, tempCritical=tempCritical, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, totalMem=totalMem, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheReq=webCacheReq, sslSrvrTotSuccess=sslSrvrTotSuccess, serviceName=serviceName, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprProtocol=webCmprProtocol, operationalMode=operationalMode, memoryUsageHigh=memoryUsageHigh, sslSrvrPort=sslSrvrPort, switchingToMaintMode=switchingToMaintMode, httpSrvrNumConn=httpSrvrNumConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheStale=webCacheStale, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCmprAddressType=webCmprAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, firmwareStorageHigh=firmwareStorageHigh, serverDown=serverDown, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormPort=ipsUrlNormPort, linkStatus=linkStatus, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrAddressType=httpSrvrAddressType, ipsRCPort=ipsRCPort, httpProxyActiveConn=httpProxyActiveConn, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheAddress=webCacheAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyPort=sslProxyPort, sslProxyActiveConn=sslProxyActiveConn, httpSrvrState=httpSrvrState, httpProxyPort=httpProxyPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, logStorageHigh=logStorageHigh, systemSerialNumber=systemSerialNumber, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, totalAttacks=totalAttacks, ipsRCTotQueued=ipsRCTotQueued, energizeUpdateExpire=energizeUpdateExpire, bwsStatsGroup=bwsStatsGroup, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrSrvcAddress=sslSrvrSrvcAddress, vipStatus=vipStatus, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyTotalReq=sslProxyTotalReq, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, srvcName=srvcName, switchingToInlineMode=switchingToInlineMode, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, memUtilization=memUtilization, bwsMessage=bwsMessage, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, dataPortLinkUp=dataPortLinkUp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsStats=bwsStats, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqLimitPort=ipsReqLimitPort, bwsCacheStatsTable=bwsCacheStatsTable, bwsTrapGroup=bwsTrapGroup, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheAddressType=webCacheAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, systemFailure=systemFailure, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCmprPort=webCmprPort, uptime=uptime, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsRCAddress=ipsRCAddress, PYSNMP_MODULE_ID=bws, dataPortLinkDown=dataPortLinkDown, peerUp=peerUp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotDropped=ipsRCTotDropped, httpProxyServerAbrt=httpProxyServerAbrt, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, securityDefUpdates=securityDefUpdates, httpSrvrInBytes=httpSrvrInBytes, ipsRCAddressType=ipsRCAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprAddress=webCmprAddress, bwsMIBCompliances=bwsMIBCompliances, serviceStatus=serviceStatus, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxyAddressType=httpProxyAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCacheHits=webCacheHits, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyAddress=httpProxyAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyInBytes=sslProxyInBytes, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, smNumUserSessions=smNumUserSessions, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrTotRefused=httpSrvrTotRefused, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsMIBGroups=bwsMIBGroups, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyParseErr=httpProxyParseErr, httpProxyInBytes=httpProxyInBytes, firmwareStorage=firmwareStorage, sslProxyAddressType=sslProxyAddressType, httpProxyTotalConn=httpProxyTotalConn, ipsReqSrvcPort=ipsReqSrvcPort, raidDegrading=raidDegrading, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrState=sslSrvrState, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyOutBytes=httpProxyOutBytes, peerDown=peerDown, httpSrvrAddress=httpSrvrAddress, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, dataPathStatus=dataPathStatus, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrPort=httpSrvrPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsAccessCtrlPort=ipsAccessCtrlPort, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyCacheHits=sslProxyCacheHits, ipsUrlAclAddressType=ipsUrlAclAddressType, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotServed=ipsRCTotServed, logStorage=logStorage, totalBandwidth=totalBandwidth, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrInBytes=sslSrvrInBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr)
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyClientAbrt=httpProxyClientAbrt, cpuTemperature=cpuTemperature, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyAddress=sslProxyAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, activeServers=activeServers, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, smRealmName=smRealmName, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyUnknownRsp=httpProxyUnknownRsp, servicePort=servicePort, fanDead=fanDead, bws=bws, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, systemLoad=systemLoad, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrAddressType=sslSrvrAddressType, totalServers=totalServers, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumConn=sslSrvrNumConn, cpuUtilization=cpuUtilization, totalApplications=totalApplications, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, switchingToBypassMode=switchingToBypassMode, bwsServiceStatusTable=bwsServiceStatusTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheProtocol=webCacheProtocol, webCachePort=webCachePort, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyOutBytes=sslProxyOutBytes, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheBytesOut=webCacheBytesOut, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, tempHigh=tempHigh, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, systemFanSpeed=systemFanSpeed, bwsMIBConformance=bwsMIBConformance, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, smAgentName=smAgentName, sslProxyBadCRLErr=sslProxyBadCRLErr)
