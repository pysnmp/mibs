...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Bits, MibIdentifier, Counter64, Unsigned32, Gauge32, TimeTicks, NotificationType, ObjectIdentity, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Bits", "MibIdentifier", "Counter64", "Unsigned32", "Gauge32", "TimeTicks", "NotificationType", "ObjectIdentity", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsMIBCompliance=bwsMIBCompliance, servicePort=servicePort, systemFanSpeed=systemFanSpeed, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrSrvcPort=httpSrvrSrvcPort, totalMem=totalMem, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsMIBCompliances=bwsMIBCompliances, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyTotalConn=sslProxyTotalConn, smRealmName=smRealmName, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrTotResponse=httpSrvrTotResponse, ipsRCTimeStamp=ipsRCTimeStamp, webCacheAddressType=webCacheAddressType, webCmprAddressType=webCmprAddressType, httpProxyTotalReq=httpProxyTotalReq, totalAttacks=totalAttacks, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, tempCritical=tempCritical, systemFailure=systemFailure, ipsRCAddressType=ipsRCAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyCacheHits=sslProxyCacheHits, ipsRCTotQueued=ipsRCTotQueued, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxyTotalConn=httpProxyTotalConn, totalApplications=totalApplications, bwsMIBConformance=bwsMIBConformance, sslProxyAddress=sslProxyAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyErrPms=sslProxyErrPms, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsHdrAclHits=ipsHdrAclHits, ipsRCAddress=ipsRCAddress, sslProxyActiveConn=sslProxyActiveConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, operationalMode=operationalMode, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheLongHdrs=webCacheLongHdrs, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrAddressType=httpSrvrAddressType, sslProxyAddressType=sslProxyAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrAddress=sslSrvrAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, vipStatus=vipStatus, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclPort=ipsUrlAclPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrInBytes=sslSrvrInBytes, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, systemLoad=systemLoad, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCacheBytesOut=webCacheBytesOut, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, raidDegrading=raidDegrading, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrMinResTime=sslSrvrMinResTime, serviceStatus=serviceStatus, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqSrvcAddress=ipsReqSrvcAddress, uptime=uptime, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, firmwareStorage=firmwareStorage, webCacheStale=webCacheStale, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyInBytes=httpProxyInBytes, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, switchingToMaintMode=switchingToMaintMode, energizeUpdateExpire=energizeUpdateExpire, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheProtocol=webCacheProtocol, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrAddressType=sslSrvrAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, systemFailOver=systemFailOver, ipsUrlNormPort=ipsUrlNormPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, serviceName=serviceName, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, activeApplications=activeApplications, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCTotServed=ipsRCTotServed, webCacheHits=webCacheHits, switchingToBypassMode=switchingToBypassMode, activeServers=activeServers, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyPort=sslProxyPort, httpProxyAddressType=httpProxyAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyOutBytes=sslProxyOutBytes, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyBadDNCErr=sslProxyBadDNCErr, bwstraps=bwstraps, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrPort=sslSrvrPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqSrvcAddressType=ipsReqSrvcAddressType, smAgentName=smAgentName, sslProxyCacheMiss=sslProxyCacheMiss, webCacheAddress=webCacheAddress, logStorage=logStorage, sslSrvrTotRefused=sslSrvrTotRefused, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, tempHigh=tempHigh, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotTimedout=sslSrvrTotTimedout, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrNumConn=sslSrvrNumConn, httpSrvrPort=httpSrvrPort, peerUp=peerUp, webCmprAddress=webCmprAddress, systemSerialNumber=systemSerialNumber, webCacheCacheableRes=webCacheCacheableRes, ipsRCTotDropped=ipsRCTotDropped, memUtilization=memUtilization, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsMessage=bwsMessage, memoryUsageHigh=memoryUsageHigh, httpSrvrState=httpSrvrState, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, cpuTemperature=cpuTemperature, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrAddress=httpSrvrAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, linkStatus=linkStatus, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCmprPort=webCmprPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, switchingToInlineMode=switchingToInlineMode, bwsCacheStatsEntry=bwsCacheStatsEntry, PYSNMP_MODULE_ID=bws, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrTotResponse=sslSrvrTotResponse, serviceAddress=serviceAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, smNumUserSessions=smNumUserSessions, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyAddress=httpProxyAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, webCacheMiss=webCacheMiss, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecPort=ipsCookieSecPort, webCmprProtocol=webCmprProtocol, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitPort=ipsReqLimitPort, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyInBytes=sslProxyInBytes, processCountHigh=processCountHigh, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsCookieSecEncrypted=ipsCookieSecEncrypted)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, serverUp=serverUp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, totalServers=totalServers, httpSrvrNumConn=httpSrvrNumConn, bwsMIBGroups=bwsMIBGroups, peerDown=peerDown, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCachePort=webCachePort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, highAvailabilityStatus=highAvailabilityStatus, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bws=bws, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, securityDefUpdates=securityDefUpdates, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsTrapGroup=bwsTrapGroup, dataPathStatus=dataPathStatus, httpProxyServerReq=httpProxyServerReq, ipsHdrAclPort=ipsHdrAclPort, httpProxyActiveConn=httpProxyActiveConn, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, fanDead=fanDead, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyPort=httpProxyPort, ipsReqSrvcPort=ipsReqSrvcPort, webCacheCachedObjects=webCacheCachedObjects, webCacheReq=webCacheReq, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, currentFirmwareVersion=currentFirmwareVersion, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrState=sslSrvrState, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsStats=bwsStats, srvcName=srvcName, freeMem=freeMem, cpuUtilization=cpuUtilization, dataPortLinkUp=dataPortLinkUp, totalBandwidth=totalBandwidth, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsRCPort=ipsRCPort, httpProxyServerErr=httpProxyServerErr, virusDefUpdates=virusDefUpdates, serverDown=serverDown, logStorageHigh=logStorageHigh, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyOutBytes=httpProxyOutBytes)
