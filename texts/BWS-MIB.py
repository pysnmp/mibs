...
IpAddress, Integer32, Unsigned32, Counter64, TimeTicks, ModuleIdentity, Gauge32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "Unsigned32", "Counter64", "TimeTicks", "ModuleIdentity", "Gauge32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", serviceStatus=serviceStatus, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxySessionTimeOut=httpProxySessionTimeOut, serverDown=serverDown, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwstraps=bwstraps, sslProxyTotalReq=sslProxyTotalReq, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrAddressType=httpSrvrAddressType, systemFailOver=systemFailOver, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, securityDefUpdates=securityDefUpdates, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, memoryUsageHigh=memoryUsageHigh, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyActiveConn=httpProxyActiveConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyTotalConn=httpProxyTotalConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsHdrAclHits=ipsHdrAclHits, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheLongHdrs=webCacheLongHdrs, vipStatus=vipStatus, fanDead=fanDead, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecPort=ipsCookieSecPort, bwsMIBGroups=bwsMIBGroups, httpSrvrPort=httpSrvrPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, webCacheCacheableRes=webCacheCacheableRes, activeApplications=activeApplications, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, smRealmName=smRealmName, serverUp=serverUp, sslProxyAddress=sslProxyAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsStatsGroup=bwsStatsGroup, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyAddress=httpProxyAddress, bwsMessage=bwsMessage, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, srvcName=srvcName, ipsRCAddressType=ipsRCAddressType, processCountHigh=processCountHigh, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCachePort=webCachePort, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrState=sslSrvrState, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, smNumUserSessions=smNumUserSessions, bwsMIBConformance=bwsMIBConformance, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, firmwareStorage=firmwareStorage, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, PYSNMP_MODULE_ID=bws, bws=bws, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, dataPortLinkDown=dataPortLinkDown, uptime=uptime, sslProxyAddressType=sslProxyAddressType, ipsRCPort=ipsRCPort, httpProxyAddressType=httpProxyAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, virusDefUpdates=virusDefUpdates, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, peerUp=peerUp, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormPort=ipsUrlNormPort, webCacheHits=webCacheHits, sslProxyInBytes=sslProxyInBytes, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyPort=sslProxyPort, logStorage=logStorage, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotSuccess=httpSrvrTotSuccess, serviceAddress=serviceAddress, smAgentName=smAgentName, totalMem=totalMem, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrInBytes=httpSrvrInBytes, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrMinResTime=httpSrvrMinResTime, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsMIBCompliance=bwsMIBCompliance, tempHigh=tempHigh, sslSrvrAddressType=sslSrvrAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, tempCritical=tempCritical, ipsUrlAclPort=ipsUrlAclPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCmprAddressType=webCmprAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, totalServers=totalServers, httpSrvrTotResponse=httpSrvrTotResponse, energizeUpdateExpire=energizeUpdateExpire, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyPort=httpProxyPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsSMUserSessionTable=bwsSMUserSessionTable, systemLoad=systemLoad, sslProxyOutBytes=sslProxyOutBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyActiveConn=sslProxyActiveConn, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsCacheStatsTable=bwsCacheStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, servicePort=servicePort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCmprAddress=webCmprAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheAddressType=webCacheAddressType, httpSrvrAddress=httpSrvrAddress, ipsReqLimitAddress=ipsReqLimitAddress, systemSerialNumber=systemSerialNumber, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlAclAddressType=ipsUrlAclAddressType, switchingToBypassMode=switchingToBypassMode, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyErrPms=sslProxyErrPms, sslSrvrNumConn=sslSrvrNumConn, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, totalBandwidth=totalBandwidth, peerDown=peerDown, serviceName=serviceName, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, activeServers=activeServers, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsRCTotDropped=ipsRCTotDropped, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, systemFanSpeed=systemFanSpeed, switchingToInlineMode=switchingToInlineMode, httpSrvrOutBytes=httpSrvrOutBytes, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsHdrAclPort=ipsHdrAclPort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrTotReqRejected=sslSrvrTotReqRejected, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheAddress=webCacheAddress, totalApplications=totalApplications, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumConn=httpSrvrNumConn, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitPort=ipsReqLimitPort, firmwareStorageHigh=firmwareStorageHigh, logStorageHigh=logStorageHigh, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyServerReq=httpProxyServerReq, sslProxyCurrentConn=sslProxyCurrentConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCAddress=ipsRCAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqSrvcAddress=ipsReqSrvcAddress, dataPathStatus=dataPathStatus, webCmprPort=webCmprPort, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsStats=bwsStats, httpProxyServerErr=httpProxyServerErr, webCacheReq=webCacheReq, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrInBytes=sslSrvrInBytes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheMiss=webCacheMiss, sslSrvrAddress=sslSrvrAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrAvgResTime=httpSrvrAvgResTime)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrState=httpSrvrState, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, systemFailure=systemFailure, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsRCTotQueued=ipsRCTotQueued, linkStatus=linkStatus, memUtilization=memUtilization, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyParseErr=httpProxyParseErr, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, dataPortLinkUp=dataPortLinkUp, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsMIBCompliances=bwsMIBCompliances, freeMem=freeMem, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, operationalMode=operationalMode, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrPort=sslSrvrPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCacheStale=webCacheStale, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, cpuUtilization=cpuUtilization, webCmprProtocol=webCmprProtocol, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsRCTotServed=ipsRCTotServed, switchingToMaintMode=switchingToMaintMode, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotResponse=sslSrvrTotResponse, raidDegrading=raidDegrading, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, totalAttacks=totalAttacks, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyInBytes=httpProxyInBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, cpuTemperature=cpuTemperature, httpProxyOutBytes=httpProxyOutBytes, webCacheProtocol=webCacheProtocol, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry)
