...
Unsigned32, iso, Counter32, Gauge32, TimeTicks, Bits, MibIdentifier, NotificationType, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Counter32", "Gauge32", "TimeTicks", "Bits", "MibIdentifier", "NotificationType", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", bws=bws, totalAttacks=totalAttacks, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrSrvcPort=sslSrvrSrvcPort, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheCachedObjects=webCacheCachedObjects, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrInBytes=sslSrvrInBytes, firmwareStorage=firmwareStorage, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwstraps=bwstraps, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyOutBytes=httpProxyOutBytes, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrTotReqActive=sslSrvrTotReqActive, serverDown=serverDown, bwsTrapGroup=bwsTrapGroup, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrTotRefused=httpSrvrTotRefused, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, processCountHigh=processCountHigh, ipsHdrAclPort=ipsHdrAclPort, switchingToInlineMode=switchingToInlineMode, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, currentFirmwareVersion=currentFirmwareVersion, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecAddress=ipsCookieSecAddress, activeServers=activeServers, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, cpuFanSpeed=cpuFanSpeed, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrPort=sslSrvrPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqLimitAddress=ipsReqLimitAddress, tempHigh=tempHigh, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsMIBCompliances=bwsMIBCompliances, webCacheHits=webCacheHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitPort=ipsReqLimitPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrAddress=httpSrvrAddress, logStorage=logStorage, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, serviceName=serviceName, ipsReqSrvcAddressType=ipsReqSrvcAddressType, servicePort=servicePort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCachePort=webCachePort, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyInBytes=sslProxyInBytes, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, switchingToBypassMode=switchingToBypassMode, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, webCacheReq=webCacheReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsRCTotQueued=ipsRCTotQueued, sslProxyActiveConn=sslProxyActiveConn, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, cpuTemperature=cpuTemperature, sslProxyAddress=sslProxyAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCacheProtocol=webCacheProtocol, httpProxyParseErr=httpProxyParseErr, bwsMIBCompliance=bwsMIBCompliance, systemFailOver=systemFailOver, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheMiss=webCacheMiss, webCacheCacheableRes=webCacheCacheableRes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecPort=ipsCookieSecPort, memUtilization=memUtilization, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, dataPathStatus=dataPathStatus, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, dataPortLinkUp=dataPortLinkUp, sslProxyPort=sslProxyPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, raidDegrading=raidDegrading, smRealmName=smRealmName, webCmprPort=webCmprPort, linkStatus=linkStatus, ipsHdrAclAddress=ipsHdrAclAddress, systemFanSpeed=systemFanSpeed, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyCacheHits=sslProxyCacheHits, peerUp=peerUp, httpProxyPort=httpProxyPort, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecTampered=ipsCookieSecTampered, webCmprAddressType=webCmprAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsStats=bwsStats, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyTotalConn=sslProxyTotalConn, serverUp=serverUp, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyTotalConn=httpProxyTotalConn, firmwareStorageHigh=firmwareStorageHigh, operationalMode=operationalMode, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCacheBytesOut=webCacheBytesOut, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsCacheStatsEntry=bwsCacheStatsEntry, virusDefUpdates=virusDefUpdates, bwsStatsGroup=bwsStatsGroup, totalServers=totalServers, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsRCPort=ipsRCPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyCacheMiss=sslProxyCacheMiss, serviceAddress=serviceAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, totalApplications=totalApplications, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCacheAddressType=webCacheAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheAddress=webCacheAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, logStorageHigh=logStorageHigh, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrAddress=sslSrvrAddress, PYSNMP_MODULE_ID=bws, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrState=sslSrvrState, sslProxyTotalReq=sslProxyTotalReq, freeMem=freeMem, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyServerReq=httpProxyServerReq, peerDown=peerDown, bwsCacheStatsTable=bwsCacheStatsTable, bwsMIBGroups=bwsMIBGroups, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, switchingToMaintMode=switchingToMaintMode, ipsRCTotServed=ipsRCTotServed, sslProxyAddressType=sslProxyAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCacheStale=webCacheStale, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, securityDefUpdates=securityDefUpdates, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrTotTimedout=sslSrvrTotTimedout, smAgentName=smAgentName, totalBandwidth=totalBandwidth, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumFreeConn=sslSrvrNumFreeConn, tempCritical=tempCritical, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, systemFailure=systemFailure, vipStatus=vipStatus, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCmprAddress=webCmprAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrState=httpSrvrState, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, totalMem=totalMem, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, cpuUtilization=cpuUtilization, highAvailabilityStatus=highAvailabilityStatus, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheLongHdrs=webCacheLongHdrs, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyAddress=httpProxyAddress, httpSrvrInBytes=httpSrvrInBytes, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlAclPort=ipsUrlAclPort, httpProxyActiveConn=httpProxyActiveConn)
mibBuilder.exportSymbols("BWS-MIB", memoryUsageHigh=memoryUsageHigh, httpSrvrPort=httpSrvrPort, systemLoad=systemLoad, srvcName=srvcName, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsHdrAclHits=ipsHdrAclHits, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrAddressType=sslSrvrAddressType, uptime=uptime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrAddressType=httpSrvrAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyOutBytes=sslProxyOutBytes, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlNormPort=ipsUrlNormPort, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCAddress=ipsRCAddress, webCmprProtocol=webCmprProtocol, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, systemSerialNumber=systemSerialNumber, fanDead=fanDead, httpProxyInBytes=httpProxyInBytes, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyErrPms=sslProxyErrPms, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, smNumUserSessions=smNumUserSessions, bwsSMUserSessionTable=bwsSMUserSessionTable, activeApplications=activeApplications, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrNumConn=httpSrvrNumConn, httpProxyServerErr=httpProxyServerErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, serviceStatus=serviceStatus, bwsMessage=bwsMessage, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsMIBConformance=bwsMIBConformance, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyTotalReq=httpProxyTotalReq, bwsServiceStatusTable=bwsServiceStatusTable, energizeUpdateExpire=energizeUpdateExpire, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, dataPortLinkDown=dataPortLinkDown, httpProxyClientAbrt=httpProxyClientAbrt)
