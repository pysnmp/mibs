...
MibIdentifier, Unsigned32, Counter32, iso, NotificationType, TimeTicks, Gauge32, Bits, IpAddress, ObjectIdentity, ModuleIdentity, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Counter32", "iso", "NotificationType", "TimeTicks", "Gauge32", "Bits", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", totalMem=totalMem, webCacheAddressType=webCacheAddressType, ipsHdrAclPort=ipsHdrAclPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsMIBGroups=bwsMIBGroups, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, freeMem=freeMem, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, peerUp=peerUp, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsMIBConformance=bwsMIBConformance, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyPort=ipsUrlPolicyPort, processCountHigh=processCountHigh, raidDegrading=raidDegrading, sslSrvrOutBytes=sslSrvrOutBytes, vipStatus=vipStatus, httpSrvrTotResponse=httpSrvrTotResponse, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyOutBytes=httpProxyOutBytes, bwsMIBCompliances=bwsMIBCompliances, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCmprProtocol=webCmprProtocol, httpSrvrInBytes=httpSrvrInBytes, serverUp=serverUp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, dataPortLinkDown=dataPortLinkDown, bws=bws, ipsCookieSecPort=ipsCookieSecPort, switchingToMaintMode=switchingToMaintMode, totalAttacks=totalAttacks, sslSrvrTotTimedout=sslSrvrTotTimedout, totalApplications=totalApplications, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprAddress=webCmprAddress, sslProxyPort=sslProxyPort, systemSerialNumber=systemSerialNumber, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrInBytes=sslSrvrInBytes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsRCAddress=ipsRCAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, systemLoad=systemLoad, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, fanDead=fanDead, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCacheStale=webCacheStale, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlAclAddress=ipsUrlAclAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsCookieSecTampered=ipsCookieSecTampered, srvcName=srvcName, energizeUpdateExpire=energizeUpdateExpire, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyInBytes=httpProxyInBytes, httpProxyTotalConn=httpProxyTotalConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyTotalReq=sslProxyTotalReq, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyUnknownRsp=httpProxyUnknownRsp, firmwareStorage=firmwareStorage, httpSrvrState=httpSrvrState, tempHigh=tempHigh, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyInBytes=sslProxyInBytes, sslProxyAddress=sslProxyAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsStats=bwsStats, servicePort=servicePort, webCmprAddressType=webCmprAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, serverDown=serverDown, httpProxyParseErr=httpProxyParseErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, smNumUserSessions=smNumUserSessions, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrAddressType=httpSrvrAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheAddress=webCacheAddress, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsRCTotQueued=ipsRCTotQueued, linkStatus=linkStatus, sslProxyAddressType=sslProxyAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCmprPort=webCmprPort, smAgentName=smAgentName, currentFirmwareVersion=currentFirmwareVersion, firmwareStorageHigh=firmwareStorageHigh, webCacheCachedObjects=webCacheCachedObjects, logStorage=logStorage, securityDefUpdates=securityDefUpdates, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrMinResTime=httpSrvrMinResTime, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrAddressType=sslSrvrAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyTotalReq=httpProxyTotalReq, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, operationalMode=operationalMode, ipsRCTotServed=ipsRCTotServed, sslProxyActiveConn=sslProxyActiveConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, serviceName=serviceName, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrPort=httpSrvrPort, ipsRCTotDropped=ipsRCTotDropped, bwsMIBCompliance=bwsMIBCompliance, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclPort=ipsUrlAclPort, dataPortLinkUp=dataPortLinkUp, httpSrvrTotSuccess=httpSrvrTotSuccess, serviceStatus=serviceStatus, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCacheHits=webCacheHits, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, activeServers=activeServers, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsWebAddrTransAddress=ipsWebAddrTransAddress, switchingToBypassMode=switchingToBypassMode, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, uptime=uptime, bwstraps=bwstraps, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsMessage=bwsMessage, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyPort=httpProxyPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, systemFailure=systemFailure, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyTotalConn=sslProxyTotalConn, webCacheCacheableRes=webCacheCacheableRes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyOutBytes=sslProxyOutBytes, cpuTemperature=cpuTemperature, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, virusDefUpdates=virusDefUpdates, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheBytesOut=webCacheBytesOut, sslSrvrAddress=sslSrvrAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyAddress=httpProxyAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyErrPms=sslProxyErrPms, memUtilization=memUtilization, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrNumConn=httpSrvrNumConn, ipsUrlNormPort=ipsUrlNormPort, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrPort=sslSrvrPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCPort=ipsRCPort, highAvailabilityStatus=highAvailabilityStatus, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCacheMiss=webCacheMiss, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyCacheHits=sslProxyCacheHits, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, smRealmName=smRealmName, totalServers=totalServers, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheReq=webCacheReq, webCachePort=webCachePort, dataPathStatus=dataPathStatus, serviceAddress=serviceAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, peerDown=peerDown, systemFanSpeed=systemFanSpeed, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyAddressType=httpProxyAddressType, sslSrvrNumConn=sslSrvrNumConn, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, systemFailOver=systemFailOver, cpuFanSpeed=cpuFanSpeed, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrAddress=httpSrvrAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, memoryUsageHigh=memoryUsageHigh, httpProxyActiveConn=httpProxyActiveConn, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqSrvcPort=ipsReqSrvcPort, cpuUtilization=cpuUtilization, totalBandwidth=totalBandwidth, logStorageHigh=logStorageHigh, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrState=sslSrvrState, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxySessionTimeOut=httpProxySessionTimeOut, activeApplications=activeApplications, ipsUrlAclReserved=ipsUrlAclReserved, PYSNMP_MODULE_ID=bws, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheProtocol=webCacheProtocol, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, switchingToInlineMode=switchingToInlineMode, tempCritical=tempCritical, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry)
