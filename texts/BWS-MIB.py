...
IpAddress, NotificationType, Integer32, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, ModuleIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "ModuleIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, systemFailOver=systemFailOver, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, serverDown=serverDown, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrTotRefused=sslSrvrTotRefused, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, srvcName=srvcName, totalServers=totalServers, httpSrvrTotRefused=httpSrvrTotRefused, virusDefUpdates=virusDefUpdates, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsHdrAclPort=ipsHdrAclPort, dataPathStatus=dataPathStatus, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bws=bws, ipsCookieSecPort=ipsCookieSecPort, cpuTemperature=cpuTemperature, totalBandwidth=totalBandwidth, sslSrvrAddressType=sslSrvrAddressType, webCacheAddress=webCacheAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, dataPortLinkDown=dataPortLinkDown, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqSrvcAddress=ipsReqSrvcAddress, sslProxyCacheHits=sslProxyCacheHits, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, logStorage=logStorage, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprAddress=webCmprAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsStats=bwsStats, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrMinResTime=httpSrvrMinResTime, dataPortLinkUp=dataPortLinkUp, serviceStatus=serviceStatus, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyAddress=httpProxyAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprProtocol=webCmprProtocol, webCacheAddressType=webCacheAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrState=httpSrvrState, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, servicePort=servicePort, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsTrapGroup=bwsTrapGroup, webCacheCacheableRes=webCacheCacheableRes, ipsUrlAclReserved=ipsUrlAclReserved, cpuUtilization=cpuUtilization, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyOutBytes=sslProxyOutBytes, ipsRCAddressType=ipsRCAddressType, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, switchingToInlineMode=switchingToInlineMode, activeServers=activeServers, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, systemFanSpeed=systemFanSpeed, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCacheHits=webCacheHits, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, peerUp=peerUp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyTotalConn=sslProxyTotalConn, httpProxyServerReq=httpProxyServerReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, operationalMode=operationalMode, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlNormAddress=ipsUrlNormAddress, fanDead=fanDead, sslProxyActiveConn=sslProxyActiveConn, sslSrvrPort=sslSrvrPort, bwsStatsGroup=bwsStatsGroup, linkStatus=linkStatus, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyBadCRLErr=sslProxyBadCRLErr, smNumUserSessions=smNumUserSessions, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrInBytes=httpSrvrInBytes, httpSrvrAddressType=httpSrvrAddressType, webCmprPort=webCmprPort, serverUp=serverUp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, memoryUsageHigh=memoryUsageHigh, httpProxyOutBytes=httpProxyOutBytes, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrPort=httpSrvrPort, ipsRCPort=ipsRCPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, smRealmName=smRealmName, webCacheCachedObjects=webCacheCachedObjects, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyAddressType=sslProxyAddressType, vipStatus=vipStatus, systemSerialNumber=systemSerialNumber, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrMinResTime=sslSrvrMinResTime, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitPort=ipsReqLimitPort, processCountHigh=processCountHigh, sslProxyCacheMiss=sslProxyCacheMiss, webCacheBytesOut=webCacheBytesOut, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyServerErr=httpProxyServerErr, sslProxyAddress=sslProxyAddress, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsRCTotServed=ipsRCTotServed, bwsMIBCompliance=bwsMIBCompliance, httpProxyTotalReq=httpProxyTotalReq, webCacheMiss=webCacheMiss, ipsRCAddress=ipsRCAddress, firmwareStorage=firmwareStorage, webCmprAddressType=webCmprAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheStale=webCacheStale, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyInBytes=httpProxyInBytes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyActiveConn=httpProxyActiveConn, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyPort=httpProxyPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrTotSuccess=httpSrvrTotSuccess, totalMem=totalMem, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyParseErr=httpProxyParseErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyErrPms=sslProxyErrPms, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyAddressType=httpProxyAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, PYSNMP_MODULE_ID=bws, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyUnknownRsp=httpProxyUnknownRsp, tempCritical=tempCritical, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotQueued=ipsRCTotQueued, bwsMIBCompliances=bwsMIBCompliances, activeApplications=activeApplications, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyServerAbrt=httpProxyServerAbrt, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, peerDown=peerDown, freeMem=freeMem, ipsUrlNormPort=ipsUrlNormPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsMIBConformance=bwsMIBConformance, httpSrvrNumConn=httpSrvrNumConn, systemLoad=systemLoad, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsHdrAclHits=ipsHdrAclHits, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyPort=sslProxyPort, ipsReqLimitAddressType=ipsReqLimitAddressType, switchingToMaintMode=switchingToMaintMode, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCTotOutOfResource=ipsRCTotOutOfResource, switchingToBypassMode=switchingToBypassMode, serviceName=serviceName, sslProxyInBytes=sslProxyInBytes, smAgentName=smAgentName)
mibBuilder.exportSymbols("BWS-MIB", webCachePort=webCachePort, bwsMessage=bwsMessage, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrNumConn=sslSrvrNumConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsMIBGroups=bwsMIBGroups, totalAttacks=totalAttacks, cpuFanSpeed=cpuFanSpeed, httpSrvrAddress=httpSrvrAddress, sslProxyTotalReq=sslProxyTotalReq, tempHigh=tempHigh, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, uptime=uptime, webCacheProtocol=webCacheProtocol, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclPort=ipsUrlAclPort, httpSrvrSrvcPort=httpSrvrSrvcPort, serviceAddress=serviceAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrOutBytes=sslSrvrOutBytes, totalApplications=totalApplications, ipsReqLimitAddress=ipsReqLimitAddress, webCacheLongHdrs=webCacheLongHdrs, memUtilization=memUtilization, systemFailure=systemFailure, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, firmwareStorageHigh=firmwareStorageHigh, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, logStorageHigh=logStorageHigh, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, securityDefUpdates=securityDefUpdates, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcPort=ipsLrnSrvcPort, bwstraps=bwstraps, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyTotalConn=httpProxyTotalConn, raidDegrading=raidDegrading, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, energizeUpdateExpire=energizeUpdateExpire, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrState=sslSrvrState, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheReq=webCacheReq, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr)
