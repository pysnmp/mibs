...
TimeTicks, IpAddress, Bits, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Counter64, iso, ObjectIdentity, Counter32, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Bits", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Counter64", "iso", "ObjectIdentity", "Counter32", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyOutBytes=httpProxyOutBytes, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheAddress=webCacheAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotResponse=httpSrvrTotResponse, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumFreeConn=httpSrvrNumFreeConn, serverDown=serverDown, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCmprProtocol=webCmprProtocol, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyErrPms=sslProxyErrPms, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, smNumUserSessions=smNumUserSessions, systemSerialNumber=systemSerialNumber, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, processCountHigh=processCountHigh, ipsRCTotServed=ipsRCTotServed, activeServers=activeServers, sslSrvrNumConn=sslSrvrNumConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCacheAddressType=webCacheAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, operationalMode=operationalMode, httpSrvrSrvcPort=httpSrvrSrvcPort, tempCritical=tempCritical, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlNormPort=ipsUrlNormPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, switchingToInlineMode=switchingToInlineMode, sslProxyPort=sslProxyPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyPort=httpProxyPort, bwsServiceStatusTable=bwsServiceStatusTable, switchingToBypassMode=switchingToBypassMode, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheHits=webCacheHits, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, raidDegrading=raidDegrading, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, smRealmName=smRealmName, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsStatsGroup=bwsStatsGroup, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, systemFanSpeed=systemFanSpeed, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrState=httpSrvrState, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsMIBCompliances=bwsMIBCompliances, sslProxyOutBytes=sslProxyOutBytes, bwsCacheStatsEntry=bwsCacheStatsEntry, virusDefUpdates=virusDefUpdates, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyCacheMiss=sslProxyCacheMiss, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, dataPathStatus=dataPathStatus, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlPort=ipsAccessCtrlPort, systemFailOver=systemFailOver, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsTrapGroup=bwsTrapGroup, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, serviceAddress=serviceAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrState=sslSrvrState, securityDefUpdates=securityDefUpdates, webCacheMiss=webCacheMiss, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsMessage=bwsMessage, httpProxyTotalReq=httpProxyTotalReq, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsMIBCompliance=bwsMIBCompliance, dataPortLinkDown=dataPortLinkDown, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, servicePort=servicePort, cpuUtilization=cpuUtilization, systemFailure=systemFailure, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyServerReq=httpProxyServerReq, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCAddress=ipsRCAddress, logStorageHigh=logStorageHigh, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsRCTotDropped=ipsRCTotDropped, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, cpuFanSpeed=cpuFanSpeed, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyAddressType=httpProxyAddressType, httpSrvrInBytes=httpSrvrInBytes, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyInBytes=sslProxyInBytes, sslSrvrOutBytes=sslSrvrOutBytes, bws=bws, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, totalBandwidth=totalBandwidth, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, logStorage=logStorage, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, freeMem=freeMem, sslSrvrTotTimedout=sslSrvrTotTimedout, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsCacheStatsTable=bwsCacheStatsTable, cpuTemperature=cpuTemperature, energizeUpdateExpire=energizeUpdateExpire, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrAddress=httpSrvrAddress, ipsRCTimeStamp=ipsRCTimeStamp, vipStatus=vipStatus, webCmprAddressType=webCmprAddressType, webCacheProtocol=webCacheProtocol, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclPort=ipsUrlAclPort, totalApplications=totalApplications, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, totalMem=totalMem, sslSrvrAddress=sslSrvrAddress, httpSrvrTotRefused=httpSrvrTotRefused, smAgentName=smAgentName, httpProxyTotalConn=httpProxyTotalConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, linkStatus=linkStatus, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyAddressType=sslProxyAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCTotQueued=ipsRCTotQueued, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsMIBGroups=bwsMIBGroups, sslSrvrPort=sslSrvrPort, srvcName=srvcName, webCacheReq=webCacheReq, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, activeApplications=activeApplications, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCPort=ipsRCPort, bwsStats=bwsStats, serviceStatus=serviceStatus, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyActiveConn=sslProxyActiveConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, totalServers=totalServers, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, uptime=uptime, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyTotalReq=sslProxyTotalReq, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyAddress=sslProxyAddress, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrAddressType=sslSrvrAddressType, tempHigh=tempHigh, webCacheStale=webCacheStale, httpSrvrPort=httpSrvrPort, bwstraps=bwstraps, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrInBytes=sslSrvrInBytes, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, dataPortLinkUp=dataPortLinkUp, sslProxyCacheHits=sslProxyCacheHits, webCachePort=webCachePort)
mibBuilder.exportSymbols("BWS-MIB", firmwareStorage=firmwareStorage, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrTotResponse=sslSrvrTotResponse, webCmprPort=webCmprPort, webCacheBytesOut=webCacheBytesOut, ipsReqLimitPort=ipsReqLimitPort, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxyAddress=httpProxyAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, fanDead=fanDead, serviceName=serviceName, highAvailabilityStatus=highAvailabilityStatus, memUtilization=memUtilization, webCacheLongHdrs=webCacheLongHdrs, httpSrvrAddressType=httpSrvrAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyActiveConn=httpProxyActiveConn, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprAddress=webCmprAddress, ipsCookieSecAddress=ipsCookieSecAddress, peerDown=peerDown, peerUp=peerUp, serverUp=serverUp, memoryUsageHigh=memoryUsageHigh, httpSrvrNumConn=httpSrvrNumConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, totalAttacks=totalAttacks, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsRCAddressType=ipsRCAddressType, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, switchingToMaintMode=switchingToMaintMode, firmwareStorageHigh=firmwareStorageHigh, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyCurrentConn=sslProxyCurrentConn, PYSNMP_MODULE_ID=bws, ipsCookieSecTampered=ipsCookieSecTampered, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyParseErr=httpProxyParseErr, systemLoad=systemLoad, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheCachedObjects=webCacheCachedObjects)
