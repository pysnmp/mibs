...
Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, MibIdentifier, Counter64, ModuleIdentity, iso, TimeTicks, ObjectIdentity, Unsigned32, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "MibIdentifier", "Counter64", "ModuleIdentity", "iso", "TimeTicks", "ObjectIdentity", "Unsigned32", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", webCachePort=webCachePort, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrMinResTime=httpSrvrMinResTime, cpuTemperature=cpuTemperature, httpSrvrSrvcAddress=httpSrvrSrvcAddress, fanDead=fanDead, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCacheHits=webCacheHits, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrPort=sslSrvrPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCacheStale=webCacheStale, webCacheAddress=webCacheAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, totalAttacks=totalAttacks, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsMessage=bwsMessage, bwsCacheStatsEntry=bwsCacheStatsEntry, highAvailabilityStatus=highAvailabilityStatus, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrNumConn=httpSrvrNumConn, ipsRCAddress=ipsRCAddress, ipsUrlAclPort=ipsUrlAclPort, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, freeMem=freeMem, logStorageHigh=logStorageHigh, totalMem=totalMem, sslProxyCacheHits=sslProxyCacheHits, dataPortLinkDown=dataPortLinkDown, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyTotalReq=sslProxyTotalReq, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCPort=ipsRCPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, energizeUpdateExpire=energizeUpdateExpire, operationalMode=operationalMode, cpuUtilization=cpuUtilization, totalBandwidth=totalBandwidth, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, smRealmName=smRealmName, securityDefUpdates=securityDefUpdates, ipsRCAddressType=ipsRCAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheBytesOut=webCacheBytesOut, sslSrvrState=sslSrvrState, serverDown=serverDown, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyServerErr=httpProxyServerErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, raidDegrading=raidDegrading, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsRCTimeStamp=ipsRCTimeStamp, ipsHdrAclHits=ipsHdrAclHits, sslSrvrAddress=sslSrvrAddress, serviceStatus=serviceStatus, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheMiss=webCacheMiss, ipsRCTotQueued=ipsRCTotQueued, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrTotTimedout=httpSrvrTotTimedout, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyErrPms=sslProxyErrPms, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsRCStatsTable=bwsIpsRCStatsTable, srvcName=srvcName, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsMIBCompliance=bwsMIBCompliance, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrState=httpSrvrState, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyClientAbrt=httpProxyClientAbrt, bwsStatsGroup=bwsStatsGroup, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, serviceName=serviceName, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, PYSNMP_MODULE_ID=bws, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, peerUp=peerUp, peerDown=peerDown, httpProxyServerReq=httpProxyServerReq, webCmprProtocol=webCmprProtocol, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyTotalReq=httpProxyTotalReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCmprPort=webCmprPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCacheProtocol=webCacheProtocol, systemFailure=systemFailure, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyAddress=httpProxyAddress, sslProxyPort=sslProxyPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, switchingToBypassMode=switchingToBypassMode, httpProxyTotalConn=httpProxyTotalConn, sslSrvrTotRefused=sslSrvrTotRefused, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, cpuFanSpeed=cpuFanSpeed, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCacheAddressType=webCacheAddressType, sslProxyInBytes=sslProxyInBytes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyAddress=sslProxyAddress, tempHigh=tempHigh, linkStatus=linkStatus, sslProxyTotalConn=sslProxyTotalConn, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, currentFirmwareVersion=currentFirmwareVersion, ipsUrlAclReserved=ipsUrlAclReserved, ipsHdrAclAddressType=ipsHdrAclAddressType, uptime=uptime, httpProxyAddressType=httpProxyAddressType, bwsMIBGroups=bwsMIBGroups, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrNumConn=sslSrvrNumConn, smAgentName=smAgentName, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, vipStatus=vipStatus, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsServiceStatusTable=bwsServiceStatusTable, logStorage=logStorage, webCacheCacheableRes=webCacheCacheableRes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, firmwareStorage=firmwareStorage, switchingToInlineMode=switchingToInlineMode, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyInBytes=httpProxyInBytes, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotResponse=httpSrvrTotResponse, ipsHdrAclPort=ipsHdrAclPort, firmwareStorageHigh=firmwareStorageHigh, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyOutBytes=sslProxyOutBytes, bwsMIBConformance=bwsMIBConformance, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsRCTotServed=ipsRCTotServed, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, memUtilization=memUtilization, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrAddressType=sslSrvrAddressType, sslSrvrTotResponse=sslSrvrTotResponse, webCmprAddressType=webCmprAddressType, sslProxyAddressType=sslProxyAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitAddress=ipsReqLimitAddress, dataPathStatus=dataPathStatus, dataPortLinkUp=dataPortLinkUp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyCacheMiss=sslProxyCacheMiss, activeApplications=activeApplications, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyActiveConn=sslProxyActiveConn, webCmprAddress=webCmprAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, virusDefUpdates=virusDefUpdates, tempCritical=tempCritical, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsTrapGroup=bwsTrapGroup, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyPort=httpProxyPort, systemFailOver=systemFailOver, processCountHigh=processCountHigh, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, systemLoad=systemLoad, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, activeServers=activeServers, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsServiceStatusEntry=bwsServiceStatusEntry, memoryUsageHigh=memoryUsageHigh, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsStats=bwsStats, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitPort=ipsReqLimitPort, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyActiveConn=httpProxyActiveConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, serverUp=serverUp, bws=bws, ipsUrlNormPort=ipsUrlNormPort, systemFanSpeed=systemFanSpeed, systemSerialNumber=systemSerialNumber, servicePort=servicePort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheReq=webCacheReq, sslSrvrSrvcAddress=sslSrvrSrvcAddress, totalApplications=totalApplications, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, totalServers=totalServers, bwsSslProxyStatsTable=bwsSslProxyStatsTable, serviceAddress=serviceAddress, bwstraps=bwstraps, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrPort=httpSrvrPort, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrAddressType=httpSrvrAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrInBytes=sslSrvrInBytes, smNumUserSessions=smNumUserSessions, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, switchingToMaintMode=switchingToMaintMode)
