...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, ObjectIdentity, Unsigned32, Gauge32, TimeTicks, ModuleIdentity, Integer32, iso, Counter32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "ObjectIdentity", "Unsigned32", "Gauge32", "TimeTicks", "ModuleIdentity", "Integer32", "iso", "Counter32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, cpuUtilization=cpuUtilization, ipsRCTotServed=ipsRCTotServed, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsHdrAclPort=ipsHdrAclPort, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrAddressType=httpSrvrAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotResponse=httpSrvrTotResponse, webCmprAddressType=webCmprAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotQueued=ipsRCTotQueued, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, serviceStatus=serviceStatus, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, securityDefUpdates=securityDefUpdates, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsMIBGroups=bwsMIBGroups, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyClientAbrt=httpProxyClientAbrt, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheLongHdrs=webCacheLongHdrs, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, smRealmName=smRealmName, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheCacheableRes=webCacheCacheableRes, memUtilization=memUtilization, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCAddressType=ipsRCAddressType, PYSNMP_MODULE_ID=bws, activeServers=activeServers, systemFanSpeed=systemFanSpeed, httpSrvrNumConn=httpSrvrNumConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrAvgResTime=httpSrvrAvgResTime, smNumUserSessions=smNumUserSessions, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, processCountHigh=processCountHigh, httpProxyTotalReq=httpProxyTotalReq, serverDown=serverDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, cpuFanSpeed=cpuFanSpeed, ipsRCPort=ipsRCPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrAddress=httpSrvrAddress, httpSrvrTotRefused=httpSrvrTotRefused, ipsRCTotDropped=ipsRCTotDropped, httpProxyActiveConn=httpProxyActiveConn, httpProxyServerErr=httpProxyServerErr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, currentFirmwareVersion=currentFirmwareVersion, totalBandwidth=totalBandwidth, sslProxyAddress=sslProxyAddress, switchingToInlineMode=switchingToInlineMode, sslProxyOutBytes=sslProxyOutBytes, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, peerDown=peerDown, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyErrPms=sslProxyErrPms, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyServerReq=httpProxyServerReq, bwsMIBConformance=bwsMIBConformance, systemLoad=systemLoad, webCmprAddress=webCmprAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyTotalConn=sslProxyTotalConn, bwsMessage=bwsMessage, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrTotTimedout=sslSrvrTotTimedout, totalServers=totalServers, tempHigh=tempHigh, vipStatus=vipStatus, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, fanDead=fanDead, logStorage=logStorage, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyInBytes=httpProxyInBytes, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCmprPort=webCmprPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheHits=webCacheHits, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyInBytes=sslProxyInBytes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheReq=webCacheReq, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, logStorageHigh=logStorageHigh, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlNormAddressType=ipsUrlNormAddressType, totalAttacks=totalAttacks, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, systemFailure=systemFailure, energizeUpdateExpire=energizeUpdateExpire, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrAddress=sslSrvrAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheBytesOut=webCacheBytesOut, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrInBytes=sslSrvrInBytes, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyPort=sslProxyPort, sslSrvrTotResponse=sslSrvrTotResponse, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyOutBytes=httpProxyOutBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecPort=ipsCookieSecPort, sslProxyFullHandshakes=sslProxyFullHandshakes, servicePort=servicePort, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCacheProtocol=webCacheProtocol, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyAddressType=sslProxyAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, raidDegrading=raidDegrading, virusDefUpdates=virusDefUpdates, bwsStatsGroup=bwsStatsGroup, operationalMode=operationalMode, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyTotalConn=httpProxyTotalConn, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrPort=httpSrvrPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyPort=httpProxyPort, switchingToMaintMode=switchingToMaintMode, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, totalApplications=totalApplications, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCachePort=webCachePort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, totalMem=totalMem, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrPort=sslSrvrPort, sslProxyActiveConn=sslProxyActiveConn, httpSrvrOutBytes=httpSrvrOutBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, memoryUsageHigh=memoryUsageHigh, webCacheMiss=webCacheMiss, srvcName=srvcName, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyPort=ipsUrlPolicyPort, bws=bws, switchingToBypassMode=switchingToBypassMode, httpSrvrTotReqRejected=httpSrvrTotReqRejected, freeMem=freeMem, tempCritical=tempCritical, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclAddress=ipsUrlAclAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsStats=bwsStats, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, linkStatus=linkStatus, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsTrapGroup=bwsTrapGroup, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, serviceName=serviceName)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrState=httpSrvrState, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheAddressType=webCacheAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsMIBCompliances=bwsMIBCompliances, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCacheAddress=webCacheAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrState=sslSrvrState, activeApplications=activeApplications, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, systemFailOver=systemFailOver, firmwareStorage=firmwareStorage, sslSrvrOutBytes=sslSrvrOutBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyAddress=httpProxyAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyTotalReq=sslProxyTotalReq, dataPortLinkUp=dataPortLinkUp, dataPortLinkDown=dataPortLinkDown, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, highAvailabilityStatus=highAvailabilityStatus, serverUp=serverUp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, dataPathStatus=dataPathStatus, ipsUrlNormPort=ipsUrlNormPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitPort=ipsReqLimitPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, serviceAddress=serviceAddress, bwstraps=bwstraps, smAgentName=smAgentName, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, httpProxyParseErr=httpProxyParseErr, bwsMIBCompliance=bwsMIBCompliance, uptime=uptime, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyServerAbrt=httpProxyServerAbrt, systemSerialNumber=systemSerialNumber, cpuTemperature=cpuTemperature, ipsRCAddress=ipsRCAddress, peerUp=peerUp, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheStale=webCacheStale, webCacheCachedObjects=webCacheCachedObjects, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions)
