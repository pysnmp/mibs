...
MibIdentifier, Integer32, ModuleIdentity, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Counter64, Counter32, ObjectIdentity, TimeTicks, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "ModuleIdentity", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Counter64", "Counter32", "ObjectIdentity", "TimeTicks", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", cpuFanSpeed=cpuFanSpeed, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyInBytes=sslProxyInBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecPort=ipsCookieSecPort, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsServiceStatusTable=bwsServiceStatusTable, fanDead=fanDead, httpSrvrAddress=httpSrvrAddress, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCmprProtocol=webCmprProtocol, currentFirmwareVersion=currentFirmwareVersion, httpProxyServerErr=httpProxyServerErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyErrPms=sslProxyErrPms, serviceStatus=serviceStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotReqActive=httpSrvrTotReqActive, PYSNMP_MODULE_ID=bws, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyCacheHits=sslProxyCacheHits, webCmprAddress=webCmprAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyTotalConn=httpProxyTotalConn, srvcName=srvcName, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, totalServers=totalServers, ipsUrlAclAddress=ipsUrlAclAddress, processCountHigh=processCountHigh, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, smRealmName=smRealmName, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsMIBCompliance=bwsMIBCompliance, serverUp=serverUp, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, totalAttacks=totalAttacks, serviceName=serviceName, httpSrvrNumConn=httpSrvrNumConn, ipsReqLimitPort=ipsReqLimitPort, sslProxyOutBytes=sslProxyOutBytes, httpSrvrPort=httpSrvrPort, smAgentName=smAgentName, securityDefUpdates=securityDefUpdates, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyPort=sslProxyPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheReq=webCacheReq, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, operationalMode=operationalMode, webCacheMiss=webCacheMiss, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, cpuUtilization=cpuUtilization, peerUp=peerUp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, switchingToMaintMode=switchingToMaintMode, ipsUrlNormPort=ipsUrlNormPort, sslSrvrState=sslSrvrState, raidDegrading=raidDegrading, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrAddressType=httpSrvrAddressType, httpProxyAddress=httpProxyAddress, bwsMessage=bwsMessage, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, logStorage=logStorage, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrInBytes=httpSrvrInBytes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsRCTotQueued=ipsRCTotQueued, httpProxyClientAbrt=httpProxyClientAbrt, webCacheAddress=webCacheAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsMIBCompliances=bwsMIBCompliances, tempHigh=tempHigh, ipsUrlPolicyPort=ipsUrlPolicyPort, webCacheProtocol=webCacheProtocol, ipsRCTotServed=ipsRCTotServed, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, switchingToInlineMode=switchingToInlineMode, ipsRCAddress=ipsRCAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, totalMem=totalMem, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyServerReq=httpProxyServerReq, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrTotRefused=httpSrvrTotRefused, serverDown=serverDown, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsMIBGroups=bwsMIBGroups, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheHits=webCacheHits, tempCritical=tempCritical, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyTotalReq=sslProxyTotalReq, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyInBytes=httpProxyInBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyActiveConn=httpProxyActiveConn, ipsHdrAclPort=ipsHdrAclPort, freeMem=freeMem, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, memoryUsageHigh=memoryUsageHigh, bwstraps=bwstraps, systemFailure=systemFailure, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlAclPort=ipsUrlAclPort, linkStatus=linkStatus, webCacheCacheableRes=webCacheCacheableRes, bwsMIBConformance=bwsMIBConformance, systemLoad=systemLoad, httpSrvrNumFreeConn=httpSrvrNumFreeConn, smNumUserSessions=smNumUserSessions, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, peerDown=peerDown, httpSrvrOutBytes=httpSrvrOutBytes, memUtilization=memUtilization, cpuTemperature=cpuTemperature, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, dataPathStatus=dataPathStatus, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsHdrAclAddress=ipsHdrAclAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyParseErr=httpProxyParseErr, vipStatus=vipStatus, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bws=bws, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCmprPort=webCmprPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrInBytes=sslSrvrInBytes, virusDefUpdates=virusDefUpdates, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, systemFailOver=systemFailOver, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalApplications=totalApplications, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, dataPortLinkUp=dataPortLinkUp, totalBandwidth=totalBandwidth, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheStale=webCacheStale, sslSrvrMaxResTime=sslSrvrMaxResTime, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyAddress=sslProxyAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyAddressType=httpProxyAddressType, bwsStats=bwsStats, httpSrvrTotResponse=httpSrvrTotResponse, activeServers=activeServers, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCTotDropped=ipsRCTotDropped, firmwareStorage=firmwareStorage, httpProxyPort=httpProxyPort, sslSrvrAddressType=sslSrvrAddressType)
mibBuilder.exportSymbols("BWS-MIB", sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCachePort=webCachePort, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrAddress=sslSrvrAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyCurrentConn=sslProxyCurrentConn, activeApplications=activeApplications, webCmprAddressType=webCmprAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, serviceAddress=serviceAddress, webCacheLongHdrs=webCacheLongHdrs, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrPort=sslSrvrPort, uptime=uptime, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitAddressType=ipsReqLimitAddressType, servicePort=servicePort, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsRCAddressType=ipsRCAddressType, systemFanSpeed=systemFanSpeed, httpSrvrState=httpSrvrState, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, logStorageHigh=logStorageHigh, webCacheBytesOut=webCacheBytesOut, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCPort=ipsRCPort, switchingToBypassMode=switchingToBypassMode, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyOutBytes=httpProxyOutBytes, energizeUpdateExpire=energizeUpdateExpire, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrNumConn=sslSrvrNumConn, dataPortLinkDown=dataPortLinkDown, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsTrapGroup=bwsTrapGroup, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheAddressType=webCacheAddressType)
