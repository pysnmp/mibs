...
NotificationType, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, ModuleIdentity, Integer32, Counter32, iso, ObjectIdentity, MibIdentifier, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "ModuleIdentity", "Integer32", "Counter32", "iso", "ObjectIdentity", "MibIdentifier", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyErrPms=sslProxyErrPms, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprPort=webCmprPort, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlNormPort=ipsUrlNormPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyCacheMiss=sslProxyCacheMiss, cpuFanSpeed=cpuFanSpeed, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrTotResponse=sslSrvrTotResponse, dataPathStatus=dataPathStatus, ipsWebAddrTransPort=ipsWebAddrTransPort, servicePort=servicePort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsRCPort=ipsRCPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsMIBCompliance=bwsMIBCompliance, ipsRCTotServed=ipsRCTotServed, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bws=bws, operationalMode=operationalMode, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprAddress=webCmprAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, energizeUpdateExpire=energizeUpdateExpire, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCachePort=webCachePort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMIBGroups=bwsMIBGroups, srvcName=srvcName, httpProxyOutBytes=httpProxyOutBytes, httpSrvrMinResTime=httpSrvrMinResTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyServerErr=httpProxyServerErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, smAgentName=smAgentName, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyCacheHits=sslProxyCacheHits, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrAddress=sslSrvrAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsMessage=bwsMessage, ipsCookieSecAddress=ipsCookieSecAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, firmwareStorageHigh=firmwareStorageHigh, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyParseErr=httpProxyParseErr, sslProxyCurrentConn=sslProxyCurrentConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyTotalConn=sslProxyTotalConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsStats=bwsStats, sslSrvrState=sslSrvrState, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, virusDefUpdates=virusDefUpdates, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsMIBConformance=bwsMIBConformance, ipsUrlAclPort=ipsUrlAclPort, bwsMIBCompliances=bwsMIBCompliances, peerDown=peerDown, webCacheBytesOut=webCacheBytesOut, highAvailabilityStatus=highAvailabilityStatus, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrAddress=httpSrvrAddress, totalBandwidth=totalBandwidth, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyServerReq=httpProxyServerReq, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, memUtilization=memUtilization, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, memoryUsageHigh=memoryUsageHigh, httpSrvrAddressType=httpSrvrAddressType, raidDegrading=raidDegrading, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, systemSerialNumber=systemSerialNumber, webCacheProtocol=webCacheProtocol, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyPort=httpProxyPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsHdrAclPort=ipsHdrAclPort, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheAddress=webCacheAddress, httpProxyClientAbrt=httpProxyClientAbrt, webCacheCacheableRes=webCacheCacheableRes, httpSrvrNumConn=httpSrvrNumConn, currentFirmwareVersion=currentFirmwareVersion, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcPort=ipsReqSrvcPort, sharedSecretKeyExpired=sharedSecretKeyExpired, systemLoad=systemLoad, webCmprProtocol=webCmprProtocol, sslSrvrTotTimedout=sslSrvrTotTimedout, logStorage=logStorage, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyFullHandshakes=sslProxyFullHandshakes, activeApplications=activeApplications, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrTotRefused=httpSrvrTotRefused, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsRCTotQueued=ipsRCTotQueued, systemFanSpeed=systemFanSpeed, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, logStorageHigh=logStorageHigh, httpProxyUnknownRsp=httpProxyUnknownRsp, bwstraps=bwstraps, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrPort=httpSrvrPort, vipStatus=vipStatus, cpuUtilization=cpuUtilization, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, switchingToBypassMode=switchingToBypassMode, httpSrvrState=httpSrvrState, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, uptime=uptime, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, systemFailOver=systemFailOver, sslProxyPort=sslProxyPort, sslSrvrInBytes=sslSrvrInBytes, tempCritical=tempCritical, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrInBytes=httpSrvrInBytes, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyTotalReq=sslProxyTotalReq, PYSNMP_MODULE_ID=bws, cpuTemperature=cpuTemperature, sslSrvrOutBytes=sslSrvrOutBytes, fanDead=fanDead, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheAddressType=webCacheAddressType, tempHigh=tempHigh, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCacheMiss=webCacheMiss, smRealmName=smRealmName, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecTampered=ipsCookieSecTampered, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrAddressType=sslSrvrAddressType, smNumUserSessions=smNumUserSessions, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyInBytes=httpProxyInBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, totalMem=totalMem, httpProxyActiveConn=httpProxyActiveConn, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, switchingToMaintMode=switchingToMaintMode, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyAddressType=httpProxyAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, linkStatus=linkStatus, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, activeServers=activeServers, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsRCAddress=ipsRCAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyActiveConn=sslProxyActiveConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotReqRejected=httpSrvrTotReqRejected, serviceAddress=serviceAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, dataPortLinkDown=dataPortLinkDown, sslSrvrNumConn=sslSrvrNumConn, totalServers=totalServers, serverDown=serverDown, httpProxyAddress=httpProxyAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, processCountHigh=processCountHigh, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAddress=sslProxyAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, firmwareStorage=firmwareStorage, dataPortLinkUp=dataPortLinkUp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCmprAddressType=webCmprAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, serviceName=serviceName, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, totalApplications=totalApplications, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsStatsGroup=bwsStatsGroup, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyTotalReq=httpProxyTotalReq, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemFailure=systemFailure, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrTotResponse=httpSrvrTotResponse, webCacheReq=webCacheReq, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCmprCompressibleDataSize=webCmprCompressibleDataSize, securityDefUpdates=securityDefUpdates, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyAddressType=sslProxyAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, peerUp=peerUp, serverUp=serverUp, switchingToInlineMode=switchingToInlineMode, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheHits=webCacheHits, ipsHdrAclHits=ipsHdrAclHits, freeMem=freeMem, webCacheStale=webCacheStale, sslSrvrPort=sslSrvrPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, totalAttacks=totalAttacks, ipsCookieSecPort=ipsCookieSecPort, serviceStatus=serviceStatus, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcPort=ipsLrnSrvcPort)
