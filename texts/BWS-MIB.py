...
MibIdentifier, NotificationType, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, ModuleIdentity, IpAddress, Integer32, ObjectIdentity, iso, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "ModuleIdentity", "IpAddress", "Integer32", "ObjectIdentity", "iso", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrMinResTime=httpSrvrMinResTime, cpuTemperature=cpuTemperature, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumConn=sslSrvrNumConn, srvcName=srvcName, webCacheLongHdrs=webCacheLongHdrs, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, tempHigh=tempHigh, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, processCountHigh=processCountHigh, firmwareStorageHigh=firmwareStorageHigh, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, vipStatus=vipStatus, peerDown=peerDown, totalMem=totalMem, ipsReqLimitAddressType=ipsReqLimitAddressType, dataPathStatus=dataPathStatus, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, logStorage=logStorage, switchingToBypassMode=switchingToBypassMode, sslSrvrAddressType=sslSrvrAddressType, operationalMode=operationalMode, tempCritical=tempCritical, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, serverUp=serverUp, sslProxyOutBytes=sslProxyOutBytes, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, webCmprProtocol=webCmprProtocol, sslSrvrState=sslSrvrState, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyAddressType=sslProxyAddressType, bwstraps=bwstraps, httpProxyAddress=httpProxyAddress, totalBandwidth=totalBandwidth, bwsMIBConformance=bwsMIBConformance, httpProxyAddressType=httpProxyAddressType, httpSrvrNumConn=httpSrvrNumConn, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsCompressionStatsEntry=bwsCompressionStatsEntry, cpuUtilization=cpuUtilization, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, dataPortLinkDown=dataPortLinkDown, ipsUrlNormPort=ipsUrlNormPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, virusDefUpdates=virusDefUpdates, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyInBytes=sslProxyInBytes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrAddress=httpSrvrAddress, sslProxyAddress=sslProxyAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrSrvcPort=httpSrvrSrvcPort, systemFailure=systemFailure, systemLoad=systemLoad, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrAddress=sslSrvrAddress, totalApplications=totalApplications, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bws=bws, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsRCAddressType=ipsRCAddressType, httpSrvrAddressType=httpSrvrAddressType, smRealmName=smRealmName, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, webCacheProtocol=webCacheProtocol, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, energizeUpdateExpire=energizeUpdateExpire, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyCacheTimeouts=sslProxyCacheTimeouts, activeApplications=activeApplications, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCmprAddress=webCmprAddress, ipsRCAddress=ipsRCAddress, serviceStatus=serviceStatus, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsHdrAclPort=ipsHdrAclPort, serviceName=serviceName, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serviceAddress=serviceAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheReq=webCacheReq, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, systemSerialNumber=systemSerialNumber, httpProxyServerErr=httpProxyServerErr, memoryUsageHigh=memoryUsageHigh, httpProxyTotalReq=httpProxyTotalReq, smAgentName=smAgentName, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrInBytes=httpSrvrInBytes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, systemFanSpeed=systemFanSpeed, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcAddress=ipsReqSrvcAddress, sslProxyCacheMiss=sslProxyCacheMiss, webCmprPort=webCmprPort, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsRCTotServed=ipsRCTotServed, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrPort=httpSrvrPort, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyOutBytes=httpProxyOutBytes, ipsRCPort=ipsRCPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, servicePort=servicePort, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecPort=ipsCookieSecPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, securityDefUpdates=securityDefUpdates, sslProxyCacheHits=sslProxyCacheHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsHdrAclAddressType=ipsHdrAclAddressType, currentFirmwareVersion=currentFirmwareVersion, sslSrvrPort=sslSrvrPort, sslProxyCurrentConn=sslProxyCurrentConn, webCachePort=webCachePort, webCacheCacheableRes=webCacheCacheableRes, webCacheAddress=webCacheAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsMIBGroups=bwsMIBGroups, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyActiveConn=httpProxyActiveConn, bwsStatsGroup=bwsStatsGroup, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, peerUp=peerUp, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrState=httpSrvrState, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, smNumUserSessions=smNumUserSessions, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlPolicyPort=ipsUrlPolicyPort, fanDead=fanDead, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, raidDegrading=raidDegrading, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrMinResTime=sslSrvrMinResTime, systemFailOver=systemFailOver, ipsCookieSecTampered=ipsCookieSecTampered, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, PYSNMP_MODULE_ID=bws, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyServerReq=httpProxyServerReq, httpProxyPort=httpProxyPort, httpProxyInBytes=httpProxyInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, memUtilization=memUtilization, bwsMIBCompliance=bwsMIBCompliance, bwsSMUserSessionEntry=bwsSMUserSessionEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCacheBytesOut=webCacheBytesOut, sslSrvrInBytes=sslSrvrInBytes, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyPort=sslProxyPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsRCTotQueued=ipsRCTotQueued, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheMiss=webCacheMiss, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormAddress=ipsUrlNormAddress, webCacheStale=webCacheStale, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, serverDown=serverDown, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheAddressType=webCacheAddressType, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, dataPortLinkUp=dataPortLinkUp, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrSrvcAddress=httpSrvrSrvcAddress, totalAttacks=totalAttacks, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, logStorageHigh=logStorageHigh, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, httpProxyTotalConn=httpProxyTotalConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlPort=ipsAccessCtrlPort, webCmprAddressType=webCmprAddressType, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqLimitPort=ipsReqLimitPort, totalServers=totalServers, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyTotalReq=sslProxyTotalReq, bwsStats=bwsStats, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsMessage=bwsMessage, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, freeMem=freeMem, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrOutBytes=sslSrvrOutBytes, uptime=uptime, linkStatus=linkStatus, switchingToMaintMode=switchingToMaintMode, sslSrvrMaxResTime=sslSrvrMaxResTime, firmwareStorage=firmwareStorage, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcPort=ipsReqSrvcPort, activeServers=activeServers, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, cpuFanSpeed=cpuFanSpeed, httpProxyClientAbrt=httpProxyClientAbrt, webCacheHits=webCacheHits, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCacheCachedObjects=webCacheCachedObjects)
