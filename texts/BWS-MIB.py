...
TimeTicks, NotificationType, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Counter64, Integer32, iso, ModuleIdentity, Unsigned32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Counter64", "Integer32", "iso", "ModuleIdentity", "Unsigned32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCmprPort=webCmprPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, securityDefUpdates=securityDefUpdates, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, dataPortLinkDown=dataPortLinkDown, ipsUrlAclReserved=ipsUrlAclReserved, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, systemFailure=systemFailure, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, smAgentName=smAgentName, sslProxyCurrentConn=sslProxyCurrentConn, bwsCompressionStatsTable=bwsCompressionStatsTable, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, freeMem=freeMem, httpProxyTotalReq=httpProxyTotalReq, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclPort=ipsUrlAclPort, sslSrvrAddress=sslSrvrAddress, sslProxyErrPms=sslProxyErrPms, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsMIBCompliance=bwsMIBCompliance, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, servicePort=servicePort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrSrvcPort=sslSrvrSrvcPort, energizeUpdateExpire=energizeUpdateExpire, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, totalApplications=totalApplications, webCacheHits=webCacheHits, webCacheStale=webCacheStale, highAvailabilityStatus=highAvailabilityStatus, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, serverUp=serverUp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, raidDegrading=raidDegrading, bwsMIBConformance=bwsMIBConformance, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumConn=sslSrvrNumConn, httpProxyAddress=httpProxyAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCTotServed=ipsRCTotServed, webCacheReq=webCacheReq, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, activeApplications=activeApplications, httpSrvrNumConn=httpSrvrNumConn, ipsReqLimitPort=ipsReqLimitPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwstraps=bwstraps, sslSrvrTotTimedout=sslSrvrTotTimedout, linkStatus=linkStatus, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCacheLongHdrs=webCacheLongHdrs, sslSrvrMaxResTime=sslSrvrMaxResTime, memUtilization=memUtilization, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyPort=sslProxyPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyBadDNCErr=sslProxyBadDNCErr, smNumUserSessions=smNumUserSessions, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCacheProtocol=webCacheProtocol, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsStats=bwsStats, fanDead=fanDead, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecPort=ipsCookieSecPort, peerUp=peerUp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, memoryUsageHigh=memoryUsageHigh, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, logStorageHigh=logStorageHigh, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyInBytes=httpProxyInBytes, sslSrvrInBytes=sslSrvrInBytes, serverDown=serverDown, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, serviceName=serviceName, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, totalMem=totalMem, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyTotalConn=sslProxyTotalConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsMIBCompliances=bwsMIBCompliances, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, totalAttacks=totalAttacks, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyTotalConn=httpProxyTotalConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrOutBytes=httpSrvrOutBytes, peerDown=peerDown, ipsRCTotQueued=ipsRCTotQueued, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyAddressType=sslProxyAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsCookieSecTampered=ipsCookieSecTampered, webCacheBytesOut=webCacheBytesOut, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCmprAddressType=webCmprAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrState=sslSrvrState, sslProxyTotalReq=sslProxyTotalReq, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCPort=ipsRCPort, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrMinResTime=sslSrvrMinResTime, webCacheCachedObjects=webCacheCachedObjects, httpProxyOutBytes=httpProxyOutBytes, webCacheAddressType=webCacheAddressType, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, vipStatus=vipStatus, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyPort=httpProxyPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, serviceStatus=serviceStatus, httpProxyServerReq=httpProxyServerReq, webCachePort=webCachePort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyCacheHits=sslProxyCacheHits, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrSrvcPort=httpSrvrSrvcPort, dataPathStatus=dataPathStatus, activeServers=activeServers, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyParseErr=httpProxyParseErr, bwsMIBGroups=bwsMIBGroups, currentFirmwareVersion=currentFirmwareVersion, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, tempHigh=tempHigh, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyClientAbrt=httpProxyClientAbrt, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCmprAddress=webCmprAddress, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlAclAddressType=ipsUrlAclAddressType, systemSerialNumber=systemSerialNumber, ipsRCAddress=ipsRCAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrMinResTime=httpSrvrMinResTime, systemFailOver=systemFailOver, smRealmName=smRealmName, sslProxyAddress=sslProxyAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsHdrAclHits=ipsHdrAclHits, sslSrvrPort=sslSrvrPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqSrvcAddressType=ipsReqSrvcAddressType, switchingToInlineMode=switchingToInlineMode, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyServerErr=httpProxyServerErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheAddress=webCacheAddress, tempCritical=tempCritical, httpSrvrInBytes=httpSrvrInBytes, ipsRCTotDropped=ipsRCTotDropped, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, firmwareStorage=firmwareStorage, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsHdrAclPort=ipsHdrAclPort, virusDefUpdates=virusDefUpdates, systemFanSpeed=systemFanSpeed, srvcName=srvcName, httpSrvrState=httpSrvrState, bwsCompressionStatsEntry=bwsCompressionStatsEntry, totalBandwidth=totalBandwidth, ipsCookieSecAddress=ipsCookieSecAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, operationalMode=operationalMode, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, systemLoad=systemLoad, webCacheMiss=webCacheMiss, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyActiveConn=httpProxyActiveConn, cpuUtilization=cpuUtilization)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, uptime=uptime, webCacheCacheableRes=webCacheCacheableRes, logStorage=logStorage, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrAddressType=httpSrvrAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsStatsGroup=bwsStatsGroup, httpProxyAddressType=httpProxyAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsRCAddressType=ipsRCAddressType, totalServers=totalServers, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, firmwareStorageHigh=firmwareStorageHigh, PYSNMP_MODULE_ID=bws, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrAddress=httpSrvrAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrPort=httpSrvrPort, sslProxyInBytes=sslProxyInBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprProtocol=webCmprProtocol, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrAddressType=sslSrvrAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serviceAddress=serviceAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsMessage=bwsMessage, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsWebAddrTransAddress=ipsWebAddrTransAddress, switchingToBypassMode=switchingToBypassMode, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, processCountHigh=processCountHigh, bwsTrapGroup=bwsTrapGroup, bws=bws, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sharedSecretKeyExpired=sharedSecretKeyExpired, dataPortLinkUp=dataPortLinkUp, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyActiveConn=sslProxyActiveConn, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, cpuTemperature=cpuTemperature, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, cpuFanSpeed=cpuFanSpeed)
