...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Unsigned32, Counter32, Counter64, NotificationType, MibIdentifier, Gauge32, Bits, ObjectIdentity, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Unsigned32", "Counter32", "Counter64", "NotificationType", "MibIdentifier", "Gauge32", "Bits", "ObjectIdentity", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyPort=httpProxyPort, dataPortLinkUp=dataPortLinkUp, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprProtocol=webCmprProtocol, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, switchingToInlineMode=switchingToInlineMode, serviceStatus=serviceStatus, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyAddressType=sslProxyAddressType, httpProxyParseErr=httpProxyParseErr, ipsRCAddressType=ipsRCAddressType, ipsUrlNormAddress=ipsUrlNormAddress, currentFirmwareVersion=currentFirmwareVersion, sslProxyOutBytes=sslProxyOutBytes, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrState=httpSrvrState, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheCachedObjects=webCacheCachedObjects, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsTrapGroup=bwsTrapGroup, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, activeApplications=activeApplications, tempHigh=tempHigh, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsMIBConformance=bwsMIBConformance, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrInBytes=httpSrvrInBytes, sslSrvrAddressType=sslSrvrAddressType, sslProxyCacheHits=sslProxyCacheHits, bwsStatsGroup=bwsStatsGroup, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, logStorage=logStorage, linkStatus=linkStatus, webCacheLongHdrs=webCacheLongHdrs, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlAclAddress=ipsUrlAclAddress, ipsRCAddress=ipsRCAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, smRealmName=smRealmName, ipsCookieSecAddress=ipsCookieSecAddress, bwsStats=bwsStats, webCmprAddress=webCmprAddress, ipsCookieSecPort=ipsCookieSecPort, ipsRCPort=ipsRCPort, sslSrvrAddress=sslSrvrAddress, httpProxyClientAbrt=httpProxyClientAbrt, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, firmwareStorageHigh=firmwareStorageHigh, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyAddressType=httpProxyAddressType, serviceAddress=serviceAddress, raidDegrading=raidDegrading, ipsRCTotServed=ipsRCTotServed, sslProxyErrPms=sslProxyErrPms, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrOutBytes=sslSrvrOutBytes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrPort=sslSrvrPort, activeServers=activeServers, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyOutBytes=httpProxyOutBytes, logStorageHigh=logStorageHigh, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, servicePort=servicePort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, systemLoad=systemLoad, totalApplications=totalApplications, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, firmwareUpdateAvailable=firmwareUpdateAvailable, fanDead=fanDead, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormPort=ipsUrlNormPort, webCacheStale=webCacheStale, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrState=sslSrvrState, totalBandwidth=totalBandwidth, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsMIBCompliances=bwsMIBCompliances, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, systemFanSpeed=systemFanSpeed, ipsUrlAclReserved=ipsUrlAclReserved, peerUp=peerUp, energizeUpdateExpire=energizeUpdateExpire, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, memoryUsageHigh=memoryUsageHigh, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlNormAddressType=ipsUrlNormAddressType, totalAttacks=totalAttacks, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, smNumUserSessions=smNumUserSessions, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclPort=ipsUrlAclPort, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyInBytes=httpProxyInBytes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyInBytes=sslProxyInBytes, dataPortLinkDown=dataPortLinkDown, sslProxyActiveConn=sslProxyActiveConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyAddress=sslProxyAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyPort=sslProxyPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, switchingToMaintMode=switchingToMaintMode, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsHdrAclPort=ipsHdrAclPort, sslProxyBadDNCErr=sslProxyBadDNCErr, switchingToBypassMode=switchingToBypassMode, webCacheProtocol=webCacheProtocol, bwsMIBGroups=bwsMIBGroups, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCTimeStamp=ipsRCTimeStamp, virusDefUpdates=virusDefUpdates, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, peerDown=peerDown, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrInBytes=sslSrvrInBytes, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheCacheableRes=webCacheCacheableRes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, systemFailOver=systemFailOver, httpSrvrMinResTime=httpSrvrMinResTime, bwsMessage=bwsMessage, systemFailure=systemFailure, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrPort=httpSrvrPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, processCountHigh=processCountHigh, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitPort=ipsReqLimitPort, cpuUtilization=cpuUtilization, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrNumConn=sslSrvrNumConn, sslProxyTotalReq=sslProxyTotalReq, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsRCTotDropped=ipsRCTotDropped, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, tempCritical=tempCritical, webCacheAddress=webCacheAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, operationalMode=operationalMode, httpSrvrOutBytes=httpSrvrOutBytes, webCachePort=webCachePort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwstraps=bwstraps, firmwareStorage=firmwareStorage, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, memUtilization=memUtilization, sslSrvrMinResTime=sslSrvrMinResTime, bws=bws, ipsReqSrvcAddress=ipsReqSrvcAddress, totalServers=totalServers, webCmprAddressType=webCmprAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serverUp=serverUp, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, freeMem=freeMem, cpuTemperature=cpuTemperature, webCacheAddressType=webCacheAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable)
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, smAgentName=smAgentName, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrTotRefused=httpSrvrTotRefused, PYSNMP_MODULE_ID=bws, serverDown=serverDown, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheReq=webCacheReq, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyAddress=httpProxyAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, vipStatus=vipStatus, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheMiss=webCacheMiss, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, serviceName=serviceName, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCmprPort=webCmprPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyActiveConn=httpProxyActiveConn, httpSrvrAddress=httpSrvrAddress, sslProxyCacheMiss=sslProxyCacheMiss, bwsMIBCompliance=bwsMIBCompliance, httpProxyServerErr=httpProxyServerErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, srvcName=srvcName, totalMem=totalMem, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCacheHits=webCacheHits, httpSrvrNumConn=httpSrvrNumConn, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyTotalReq=httpProxyTotalReq, uptime=uptime, dataPathStatus=dataPathStatus, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyServerReq=httpProxyServerReq, highAvailabilityStatus=highAvailabilityStatus, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrAddressType=httpSrvrAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsCacheStatsTable=bwsCacheStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn)
