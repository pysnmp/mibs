...
iso, Integer32, TimeTicks, Counter32, Bits, NotificationType, MibIdentifier, Gauge32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "TimeTicks", "Counter32", "Bits", "NotificationType", "MibIdentifier", "Gauge32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", memUtilization=memUtilization, switchingToInlineMode=switchingToInlineMode, switchingToBypassMode=switchingToBypassMode, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCacheReq=webCacheReq, bwsMIBConformance=bwsMIBConformance, sslSrvrTotReqRejected=sslSrvrTotReqRejected, peerDown=peerDown, sslProxyErrPms=sslProxyErrPms, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, firmwareStorage=firmwareStorage, logStorage=logStorage, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, totalServers=totalServers, sslSrvrAddress=sslSrvrAddress, bwsStatsGroup=bwsStatsGroup, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyTotalConn=sslProxyTotalConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheHits=webCacheHits, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrState=httpSrvrState, httpProxyServerErr=httpProxyServerErr, PYSNMP_MODULE_ID=bws, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyPort=sslProxyPort, ipsHdrAclPort=ipsHdrAclPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheBytesOut=webCacheBytesOut, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCmprCompressedDataSize=webCmprCompressedDataSize, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemFailOver=systemFailOver, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyCacheHits=sslProxyCacheHits, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, energizeUpdateExpire=energizeUpdateExpire, bws=bws, bwsStats=bwsStats, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyCacheMiss=sslProxyCacheMiss, securityDefUpdates=securityDefUpdates, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrInBytes=sslSrvrInBytes, virusDefUpdates=virusDefUpdates, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCPort=ipsRCPort, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheProtocol=webCacheProtocol, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, servicePort=servicePort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, freeMem=freeMem, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCmprProtocol=webCmprProtocol, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, firmwareStorageHigh=firmwareStorageHigh, sslProxyTotalReq=sslProxyTotalReq, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitPort=ipsReqLimitPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, currentFirmwareVersion=currentFirmwareVersion, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyTotalConn=httpProxyTotalConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, uptime=uptime, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyTotalReq=httpProxyTotalReq, ipsRCTotDropped=ipsRCTotDropped, webCacheStale=webCacheStale, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, smAgentName=smAgentName, httpSrvrAvgResTime=httpSrvrAvgResTime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyAddress=ipsUrlPolicyAddress, activeServers=activeServers, bwsTrapGroup=bwsTrapGroup, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, peerUp=peerUp, totalApplications=totalApplications, tempHigh=tempHigh, systemFanSpeed=systemFanSpeed, dataPortLinkDown=dataPortLinkDown, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrPort=httpSrvrPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, webCmprPort=webCmprPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsCookieSecAddress=ipsCookieSecAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, logStorageHigh=logStorageHigh, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, smRealmName=smRealmName, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, raidDegrading=raidDegrading, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, webCachePort=webCachePort, serverUp=serverUp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, systemLoad=systemLoad, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyAddress=sslProxyAddress, httpSrvrOutBytes=httpSrvrOutBytes, cpuTemperature=cpuTemperature, ipsRCAddress=ipsRCAddress, bwsServiceStatusTable=bwsServiceStatusTable, ipsRCTotServed=ipsRCTotServed, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclAddressType=ipsUrlAclAddressType, systemFailure=systemFailure, vipStatus=vipStatus, totalMem=totalMem, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotSuccess=sslSrvrTotSuccess, activeApplications=activeApplications, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, operationalMode=operationalMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrAddressType=httpSrvrAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcPort=ipsLrnSrvcPort, sharedSecretKeyExpired=sharedSecretKeyExpired, linkStatus=linkStatus, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsMessage=bwsMessage, fanDead=fanDead, webCacheAddressType=webCacheAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, totalAttacks=totalAttacks, serviceName=serviceName, dataPathStatus=dataPathStatus, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyPort=httpProxyPort, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyActiveConn=sslProxyActiveConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumConn=sslSrvrNumConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, switchingToMaintMode=switchingToMaintMode, dataPortLinkUp=dataPortLinkUp, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, serviceStatus=serviceStatus, cpuFanSpeed=cpuFanSpeed, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrState=sslSrvrState, ipsCookieSecTampered=ipsCookieSecTampered, memoryUsageHigh=memoryUsageHigh, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsMIBGroups=bwsMIBGroups, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyAddress=httpProxyAddress, webCacheAddress=webCacheAddress, bwstraps=bwstraps, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsRCAddressType=ipsRCAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsMIBCompliances=bwsMIBCompliances, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCmprAddressType=webCmprAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrPort=sslSrvrPort, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, systemSerialNumber=systemSerialNumber, processCountHigh=processCountHigh, webCmprAddress=webCmprAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, cpuUtilization=cpuUtilization, smNumUserSessions=smNumUserSessions, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serviceAddress=serviceAddress, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclHits=ipsHdrAclHits, bwsMIBCompliance=bwsMIBCompliance, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyOutBytes=httpProxyOutBytes, webCacheCacheableRes=webCacheCacheableRes, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecPort=ipsCookieSecPort, httpProxyInBytes=httpProxyInBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrAddress=httpSrvrAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCacheMiss=webCacheMiss, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, tempCritical=tempCritical, sslSrvrAddressType=sslSrvrAddressType, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCacheLongHdrs=webCacheLongHdrs, totalBandwidth=totalBandwidth, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, serverDown=serverDown, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCacheCachedObjects=webCacheCachedObjects, httpSrvrTotResponse=httpSrvrTotResponse, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrNumConn=httpSrvrNumConn, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlPort=ipsAccessCtrlPort, srvcName=srvcName)
