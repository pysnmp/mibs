...
iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, TimeTicks, Gauge32, NotificationType, Counter32, MibIdentifier, ObjectIdentity, IpAddress, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "TimeTicks", "Gauge32", "NotificationType", "Counter32", "MibIdentifier", "ObjectIdentity", "IpAddress", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", systemFailure=systemFailure, httpSrvrSrvcAddress=httpSrvrSrvcAddress, tempHigh=tempHigh, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, totalServers=totalServers, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqLimitAddress=ipsReqLimitAddress, switchingToBypassMode=switchingToBypassMode, webCacheProtocol=webCacheProtocol, httpSrvrPort=httpSrvrPort, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, dataPortLinkUp=dataPortLinkUp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyTotalReq=sslProxyTotalReq, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, cpuTemperature=cpuTemperature, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrPort=sslSrvrPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, raidDegrading=raidDegrading, ipsUrlNormPort=ipsUrlNormPort, ipsRCAddress=ipsRCAddress, ipsCookieSecTampered=ipsCookieSecTampered, webCmprProtocol=webCmprProtocol, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyParseErr=httpProxyParseErr, totalBandwidth=totalBandwidth, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsRCPort=ipsRCPort, systemLoad=systemLoad, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, serverDown=serverDown, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, totalApplications=totalApplications, smNumUserSessions=smNumUserSessions, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, PYSNMP_MODULE_ID=bws, totalAttacks=totalAttacks, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, linkStatus=linkStatus, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, uptime=uptime, sslSrvrAddress=sslSrvrAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyCacheTimeouts=sslProxyCacheTimeouts, switchingToMaintMode=switchingToMaintMode, ipsRCTotQueued=ipsRCTotQueued, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, systemFailOver=systemFailOver, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrAddressType=sslSrvrAddressType, fanDead=fanDead, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheStale=webCacheStale, httpProxyPort=httpProxyPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyAddressType=httpProxyAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrState=sslSrvrState, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsMIBGroups=bwsMIBGroups, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCmprAddress=webCmprAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, processCountHigh=processCountHigh, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCmprAddressType=webCmprAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlAclAddress=ipsUrlAclAddress, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheAddress=webCacheAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, memoryUsageHigh=memoryUsageHigh, ipsRCTotServed=ipsRCTotServed, sslProxyTotalConn=sslProxyTotalConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwstraps=bwstraps, ipsUrlAclPort=ipsUrlAclPort, ipsReqLimitPort=ipsReqLimitPort, systemSerialNumber=systemSerialNumber, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyErrPms=sslProxyErrPms, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrTotResponse=sslSrvrTotResponse, highAvailabilityStatus=highAvailabilityStatus, activeServers=activeServers, operationalMode=operationalMode, srvcName=srvcName, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, serviceName=serviceName, webCacheReq=webCacheReq, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyOutBytes=httpProxyOutBytes, webCacheMiss=webCacheMiss, ipsAccessCtrlPort=ipsAccessCtrlPort, webCacheAddressType=webCacheAddressType, serviceStatus=serviceStatus, dataPortLinkDown=dataPortLinkDown, sslProxyAddressType=sslProxyAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, peerDown=peerDown, currentFirmwareVersion=currentFirmwareVersion, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsServiceStatusTable=bwsServiceStatusTable, bwsMIBCompliance=bwsMIBCompliance, freeMem=freeMem, logStorage=logStorage, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyAddress=httpProxyAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, totalMem=totalMem, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyBadDNCErr=sslProxyBadDNCErr, virusDefUpdates=virusDefUpdates, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqSrvcPort=ipsReqSrvcPort, servicePort=servicePort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrInBytes=sslSrvrInBytes, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, serverUp=serverUp, sslProxyAddress=sslProxyAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, webCachePort=webCachePort, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, cpuUtilization=cpuUtilization, energizeUpdateExpire=energizeUpdateExpire, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, memUtilization=memUtilization, bwsMIBCompliances=bwsMIBCompliances, sslSrvrNumConn=sslSrvrNumConn, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsMessage=bwsMessage, securityDefUpdates=securityDefUpdates, httpSrvrAddressType=httpSrvrAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyInBytes=httpProxyInBytes, ipsRCTotDropped=ipsRCTotDropped, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprPort=webCmprPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsCacheStatsEntry=bwsCacheStatsEntry, switchingToInlineMode=switchingToInlineMode, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormAddressType=ipsUrlNormAddressType, cpuFanSpeed=cpuFanSpeed, httpProxyActiveConn=httpProxyActiveConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyServerReq=httpProxyServerReq, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyPort=sslProxyPort)
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheCacheableRes=webCacheCacheableRes, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, smRealmName=smRealmName, httpProxyTotalConn=httpProxyTotalConn, bwsTrapGroup=bwsTrapGroup, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, serviceAddress=serviceAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyTotalReq=httpProxyTotalReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrOutBytes=sslSrvrOutBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheHits=webCacheHits, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, firmwareStorageHigh=firmwareStorageHigh, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrNumConn=httpSrvrNumConn, systemFanSpeed=systemFanSpeed, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, smAgentName=smAgentName, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyInBytes=sslProxyInBytes, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsRCAddressType=ipsRCAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, tempCritical=tempCritical, activeApplications=activeApplications, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrState=httpSrvrState, firmwareStorage=firmwareStorage, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, bws=bws, logStorageHigh=logStorageHigh, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCacheBytesOut=webCacheBytesOut, bwsCacheStatsTable=bwsCacheStatsTable, ipsHdrAclPort=ipsHdrAclPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, vipStatus=vipStatus, bwsStats=bwsStats, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotRefused=sslSrvrTotRefused, dataPathStatus=dataPathStatus, bwsMIBConformance=bwsMIBConformance, sslProxyActiveConn=sslProxyActiveConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, peerUp=peerUp, httpProxyServerErr=httpProxyServerErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrAddress=httpSrvrAddress)
