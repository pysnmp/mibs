...
iso, IpAddress, NotificationType, ObjectIdentity, ModuleIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Counter64, TimeTicks, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Counter64", "TimeTicks", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotRefused=httpSrvrTotRefused, ipsReqLimitPort=ipsReqLimitPort, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrAddress=httpSrvrAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, cpuUtilization=cpuUtilization, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyServerReq=httpProxyServerReq, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyErrPms=sslProxyErrPms, totalBandwidth=totalBandwidth, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCacheMiss=webCacheMiss, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsHdrAclPort=ipsHdrAclPort, webCacheCachedObjects=webCacheCachedObjects, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, processCountHigh=processCountHigh, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyCacheHits=sslProxyCacheHits, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyAddress=httpProxyAddress, energizeUpdateExpire=energizeUpdateExpire, linkStatus=linkStatus, smRealmName=smRealmName, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwstraps=bwstraps, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, logStorageHigh=logStorageHigh, smAgentName=smAgentName, sslProxyTotalConn=sslProxyTotalConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrMaxResTime=sslSrvrMaxResTime, webCachePort=webCachePort, webCacheLongHdrs=webCacheLongHdrs, webCmprProtocol=webCmprProtocol, sslProxyAddressType=sslProxyAddressType, bwsMIBGroups=bwsMIBGroups, ipsUrlNormPort=ipsUrlNormPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, logStorage=logStorage, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, peerDown=peerDown, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrAddress=sslSrvrAddress, ipsUrlAclPort=ipsUrlAclPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, freeMem=freeMem, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsRCAddressType=ipsRCAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyBadCRLErr=sslProxyBadCRLErr, switchingToBypassMode=switchingToBypassMode, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrState=sslSrvrState, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsHdrAclAddress=ipsHdrAclAddress, bwsMessage=bwsMessage, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, cpuTemperature=cpuTemperature, sslSrvrInBytes=sslSrvrInBytes, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsTrapGroup=bwsTrapGroup, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheProtocol=webCacheProtocol, totalApplications=totalApplications, webCmprAddress=webCmprAddress, httpSrvrInBytes=httpSrvrInBytes, sslSrvrTotResponse=sslSrvrTotResponse, virusDefUpdates=virusDefUpdates, activeApplications=activeApplications, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTotQueued=ipsRCTotQueued, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrPort=httpSrvrPort, ipsRCTimeStamp=ipsRCTimeStamp, firmwareStorageHigh=firmwareStorageHigh, operationalMode=operationalMode, webCmprPort=webCmprPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, tempHigh=tempHigh, serviceStatus=serviceStatus, httpSrvrOutBytes=httpSrvrOutBytes, cpuFanSpeed=cpuFanSpeed, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, raidDegrading=raidDegrading, sslSrvrTotTimedout=sslSrvrTotTimedout, systemFailure=systemFailure, memUtilization=memUtilization, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, highAvailabilityStatus=highAvailabilityStatus, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, totalMem=totalMem, httpProxyParseErr=httpProxyParseErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, switchingToMaintMode=switchingToMaintMode, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecPort=ipsCookieSecPort, serverUp=serverUp, webCacheBytesOut=webCacheBytesOut, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, memoryUsageHigh=memoryUsageHigh, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyClientAbrt=httpProxyClientAbrt, webCacheStale=webCacheStale, systemFanSpeed=systemFanSpeed, httpProxyOutBytes=httpProxyOutBytes, webCacheReq=webCacheReq, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyPort=httpProxyPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, smNumUserSessions=smNumUserSessions, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyCurrentConn=sslProxyCurrentConn, serviceAddress=serviceAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, systemLoad=systemLoad, uptime=uptime, totalServers=totalServers, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheAddress=webCacheAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsStats=bwsStats, securityDefUpdates=securityDefUpdates, sslProxyInBytes=sslProxyInBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsSMUserSessionEntry=bwsSMUserSessionEntry, dataPathStatus=dataPathStatus, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, systemSerialNumber=systemSerialNumber, httpProxyAddressType=httpProxyAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsServiceStatusTable=bwsServiceStatusTable, switchingToInlineMode=switchingToInlineMode, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsStatsGroup=bwsStatsGroup, bwsMIBCompliance=bwsMIBCompliance, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrState=httpSrvrState, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheCacheableRes=webCacheCacheableRes, sslProxyAddress=sslProxyAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, peerUp=peerUp, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransAddress=ipsWebAddrTransAddress, firmwareStorage=firmwareStorage, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyCacheMiss=sslProxyCacheMiss, currentFirmwareVersion=currentFirmwareVersion, bws=bws, sslSrvrOutBytes=sslSrvrOutBytes, webCmprCompressedDataSize=webCmprCompressedDataSize, serviceName=serviceName, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, webCacheAddressType=webCacheAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyOutBytes=sslProxyOutBytes, ipsRCTotDropped=ipsRCTotDropped, httpProxyTotalConn=httpProxyTotalConn, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyPort=sslProxyPort, ipsRCTotServed=ipsRCTotServed, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsRCAddress=ipsRCAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, totalAttacks=totalAttacks, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, srvcName=srvcName, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsCookieSecAddress=ipsCookieSecAddress, bwsMIBConformance=bwsMIBConformance, ipsRCPort=ipsRCPort, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddress=ipsUrlNormAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, systemFailOver=systemFailOver, httpSrvrTotSuccess=httpSrvrTotSuccess, fanDead=fanDead, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrNumConn=httpSrvrNumConn, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, tempCritical=tempCritical, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyActiveConn=httpProxyActiveConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, PYSNMP_MODULE_ID=bws, webCacheHits=webCacheHits, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrTotTimedout=httpSrvrTotTimedout, dataPortLinkDown=dataPortLinkDown, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyInBytes=httpProxyInBytes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, dataPortLinkUp=dataPortLinkUp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, servicePort=servicePort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serverDown=serverDown, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyServerErr=httpProxyServerErr, sslSrvrPort=sslSrvrPort, bwsCompressionStatsTable=bwsCompressionStatsTable, webCmprAddressType=webCmprAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclAddress=ipsUrlAclAddress, vipStatus=vipStatus, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, activeServers=activeServers, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyTotalReq=httpProxyTotalReq, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsHdrAclHits=ipsHdrAclHits, sslProxyActiveConn=sslProxyActiveConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled)
