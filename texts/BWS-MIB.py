...
NotificationType, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, IpAddress, MibIdentifier, ModuleIdentity, TimeTicks, iso, Counter32, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "IpAddress", "MibIdentifier", "ModuleIdentity", "TimeTicks", "iso", "Counter32", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrAvgResTime=sslSrvrAvgResTime, servicePort=servicePort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsHdrAclPort=ipsHdrAclPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyPort=httpProxyPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormAddress=ipsUrlNormAddress, memUtilization=memUtilization, webCacheStale=webCacheStale, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, logStorageHigh=logStorageHigh, webCacheMiss=webCacheMiss, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsStatsGroup=bwsStatsGroup, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyAddressType=httpProxyAddressType, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, totalMem=totalMem, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsHdrAclHits=ipsHdrAclHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCacheReq=webCacheReq, smNumUserSessions=smNumUserSessions, bwsServiceStatusTable=bwsServiceStatusTable, srvcName=srvcName, bwsMIBGroups=bwsMIBGroups, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyCacheHits=sslProxyCacheHits, firmwareStorageHigh=firmwareStorageHigh, fanDead=fanDead, serviceAddress=serviceAddress, systemFanSpeed=systemFanSpeed, bwsMessage=bwsMessage, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsMIBCompliances=bwsMIBCompliances, smRealmName=smRealmName, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, activeServers=activeServers, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheLongHdrs=webCacheLongHdrs, totalAttacks=totalAttacks, httpProxyServerReq=httpProxyServerReq, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, serviceName=serviceName, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrPort=sslSrvrPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyTotalReq=httpProxyTotalReq, ipsRCTotServed=ipsRCTotServed, webCacheAddressType=webCacheAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsStats=bwsStats, sslProxyInBytes=sslProxyInBytes, sslSrvrNumConn=sslSrvrNumConn, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprAddress=webCmprAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwstraps=bwstraps, ipsCookieSecPort=ipsCookieSecPort, dataPathStatus=dataPathStatus, bwsMIBConformance=bwsMIBConformance, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, virusDefUpdates=virusDefUpdates, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, tempHigh=tempHigh, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcPort=ipsReqSrvcPort, bwsTrapGroup=bwsTrapGroup, activeApplications=activeApplications, ipsLrnSrvcPort=ipsLrnSrvcPort, dataPortLinkUp=dataPortLinkUp, ipsCookieSecAddressType=ipsCookieSecAddressType, systemSerialNumber=systemSerialNumber, ipsRCTotDropped=ipsRCTotDropped, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, cpuUtilization=cpuUtilization, ipsRCPort=ipsRCPort, sslSrvrOutBytes=sslSrvrOutBytes, operationalMode=operationalMode, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCmprProtocol=webCmprProtocol, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyParseErr=httpProxyParseErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsCookieSecTampered=ipsCookieSecTampered, peerDown=peerDown, sslProxyAddress=sslProxyAddress, memoryUsageHigh=memoryUsageHigh, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, systemFailOver=systemFailOver, httpProxyServerErr=httpProxyServerErr, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrState=sslSrvrState, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprAddressType=webCmprAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, dataPortLinkDown=dataPortLinkDown, firmwareStorage=firmwareStorage, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCAddress=ipsRCAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsRCTotQueued=ipsRCTotQueued, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, switchingToBypassMode=switchingToBypassMode, smAgentName=smAgentName, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrState=httpSrvrState, switchingToMaintMode=switchingToMaintMode, currentFirmwareVersion=currentFirmwareVersion, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheProtocol=webCacheProtocol, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheCachedObjects=webCacheCachedObjects, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, tempCritical=tempCritical, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, systemFailure=systemFailure, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, raidDegrading=raidDegrading, httpProxyInBytes=httpProxyInBytes, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyAddress=httpProxyAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyAddressType=sslProxyAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyPort=sslProxyPort, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyActiveConn=httpProxyActiveConn, peerUp=peerUp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyTotalConn=httpProxyTotalConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyTotalConn=sslProxyTotalConn, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrAddress=sslSrvrAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, totalBandwidth=totalBandwidth, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCacheCacheableRes=webCacheCacheableRes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrTotTimedout=sslSrvrTotTimedout, serviceStatus=serviceStatus, bwsMIBCompliance=bwsMIBCompliance, processCountHigh=processCountHigh, httpSrvrNumConn=httpSrvrNumConn, totalApplications=totalApplications, ipsReqLimitAddressType=ipsReqLimitAddressType, webCmprPort=webCmprPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrAddressType=sslSrvrAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, linkStatus=linkStatus, webCmprCompressibleDataSize=webCmprCompressibleDataSize)
mibBuilder.exportSymbols("BWS-MIB", bws=bws, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, energizeUpdateExpire=energizeUpdateExpire, sslProxyActiveConn=sslProxyActiveConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransPort=ipsWebAddrTransPort, switchingToInlineMode=switchingToInlineMode, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, serverUp=serverUp, webCacheBytesOut=webCacheBytesOut, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrInBytes=sslSrvrInBytes, httpProxyClientAbrt=httpProxyClientAbrt, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, uptime=uptime, sslSrvrMinResTime=sslSrvrMinResTime, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrPort=httpSrvrPort, cpuFanSpeed=cpuFanSpeed, PYSNMP_MODULE_ID=bws, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, systemLoad=systemLoad, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlNormPort=ipsUrlNormPort, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrTotResponse=httpSrvrTotResponse, cpuTemperature=cpuTemperature, httpSrvrInBytes=httpSrvrInBytes, serverDown=serverDown, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, vipStatus=vipStatus, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyServerAbrt=httpProxyServerAbrt, webCachePort=webCachePort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheAddress=webCacheAddress, freeMem=freeMem, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheHits=webCacheHits, httpProxyOutBytes=httpProxyOutBytes, logStorage=logStorage, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlAclPort=ipsUrlAclPort, securityDefUpdates=securityDefUpdates, totalServers=totalServers)
