...
Integer32, Counter64, NotificationType, iso, Counter32, ModuleIdentity, IpAddress, Gauge32, MibIdentifier, Bits, TimeTicks, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "NotificationType", "iso", "Counter32", "ModuleIdentity", "IpAddress", "Gauge32", "MibIdentifier", "Bits", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrAddressType=sslSrvrAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecPort=ipsCookieSecPort, sslProxyErrPms=sslProxyErrPms, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, virusDefUpdates=virusDefUpdates, ipsRCTotServed=ipsRCTotServed, operationalMode=operationalMode, raidDegrading=raidDegrading, ipsRCTotDropped=ipsRCTotDropped, ipsHdrAclHits=ipsHdrAclHits, httpProxyClientAbrt=httpProxyClientAbrt, serverUp=serverUp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, dataPortLinkUp=dataPortLinkUp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, uptime=uptime, systemSerialNumber=systemSerialNumber, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, smAgentName=smAgentName, ipsReqLimitPort=ipsReqLimitPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrNumConn=httpSrvrNumConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheBytesOut=webCacheBytesOut, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyAddress=httpProxyAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsMIBGroups=bwsMIBGroups, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCmprPort=webCmprPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsRCAddressType=ipsRCAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrPort=sslSrvrPort, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrNumConn=sslSrvrNumConn, cpuFanSpeed=cpuFanSpeed, cpuTemperature=cpuTemperature, systemLoad=systemLoad, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqSrvcAddress=ipsReqSrvcAddress, linkStatus=linkStatus, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitAddress=ipsReqLimitAddress, webCmprAddress=webCmprAddress, freeMem=freeMem, switchingToBypassMode=switchingToBypassMode, httpSrvrInBytes=httpSrvrInBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyPort=sslProxyPort, sslProxyAddressType=sslProxyAddressType, systemFanSpeed=systemFanSpeed, totalApplications=totalApplications, httpSrvrTotSuccess=httpSrvrTotSuccess, serviceStatus=serviceStatus, highAvailabilityStatus=highAvailabilityStatus, webCmprAddressType=webCmprAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrState=httpSrvrState, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, tempCritical=tempCritical, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlNormPort=ipsUrlNormPort, webCacheHits=webCacheHits, webCacheProtocol=webCacheProtocol, bwsCacheStatsTable=bwsCacheStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheAddress=webCacheAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, totalServers=totalServers, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, processCountHigh=processCountHigh, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, vipStatus=vipStatus, ipsUrlNormAddress=ipsUrlNormAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheStale=webCacheStale, ipsRCPort=ipsRCPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyTotalConn=httpProxyTotalConn, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheLongHdrs=webCacheLongHdrs, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrAddress=sslSrvrAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, smRealmName=smRealmName, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyAddress=sslProxyAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheCacheableRes=webCacheCacheableRes, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrState=sslSrvrState, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyWAFWarnings=httpProxyWAFWarnings, dataPortLinkDown=dataPortLinkDown, totalMem=totalMem, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, currentFirmwareVersion=currentFirmwareVersion, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxySessionTimeOut=httpProxySessionTimeOut, srvcName=srvcName, sslProxyInBytes=sslProxyInBytes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyOutBytes=httpProxyOutBytes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, systemFailOver=systemFailOver, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsWebAddrTransPort=ipsWebAddrTransPort, switchingToInlineMode=switchingToInlineMode, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, logStorageHigh=logStorageHigh, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, totalAttacks=totalAttacks, memoryUsageHigh=memoryUsageHigh, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsStatsGroup=bwsStatsGroup, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrOutBytes=httpSrvrOutBytes, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, cpuUtilization=cpuUtilization, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, peerDown=peerDown, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, switchingToMaintMode=switchingToMaintMode, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, servicePort=servicePort, energizeUpdateExpire=energizeUpdateExpire, httpSrvrPort=httpSrvrPort, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyInBytes=httpProxyInBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bws=bws, tempHigh=tempHigh, bwsMIBCompliances=bwsMIBCompliances, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, serviceName=serviceName, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, smNumUserSessions=smNumUserSessions, bwsSMUserSessionTable=bwsSMUserSessionTable, serviceAddress=serviceAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyActiveConn=sslProxyActiveConn, sslSrvrTotTimedout=sslSrvrTotTimedout, fanDead=fanDead, httpSrvrAddressType=httpSrvrAddressType, bwsMIBCompliance=bwsMIBCompliance, sslSrvrTotRefused=sslSrvrTotRefused, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCacheReq=webCacheReq, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsStats=bwsStats, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrSrvcPort=sslSrvrSrvcPort, securityDefUpdates=securityDefUpdates, ipsUrlAclAddress=ipsUrlAclAddress)
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCachePort=webCachePort, totalBandwidth=totalBandwidth, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyOutBytes=sslProxyOutBytes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, serverDown=serverDown, logStorage=logStorage, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyServerReq=httpProxyServerReq, systemFailure=systemFailure, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrInBytes=sslSrvrInBytes, bwsMIBConformance=bwsMIBConformance, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, dataPathStatus=dataPathStatus, httpSrvrAddress=httpSrvrAddress, activeServers=activeServers, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsRCTotQueued=ipsRCTotQueued, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyAddressType=httpProxyAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyServerErr=httpProxyServerErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, PYSNMP_MODULE_ID=bws, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyCacheHits=sslProxyCacheHits, memUtilization=memUtilization, bwsMessage=bwsMessage, webCmprProtocol=webCmprProtocol, webCacheAddressType=webCacheAddressType, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCAddress=ipsRCAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, firmwareStorage=firmwareStorage, activeApplications=activeApplications, webCacheMiss=webCacheMiss, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, peerUp=peerUp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyPort=httpProxyPort, sslProxyTotalReq=sslProxyTotalReq, bwstraps=bwstraps, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr)
