...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, IpAddress, ObjectIdentity, Counter64, Unsigned32, iso, Bits, MibIdentifier, NotificationType, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "IpAddress", "ObjectIdentity", "Counter64", "Unsigned32", "iso", "Bits", "MibIdentifier", "NotificationType", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", tempCritical=tempCritical, bwsMIBGroups=bwsMIBGroups, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bws=bws, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyTotalReq=httpProxyTotalReq, ipsUrlAclPort=ipsUrlAclPort, smNumUserSessions=smNumUserSessions, srvcName=srvcName, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyCacheMiss=sslProxyCacheMiss, serviceName=serviceName, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrNumConn=sslSrvrNumConn, sslProxyTotalReq=sslProxyTotalReq, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyErrPms=sslProxyErrPms, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, logStorage=logStorage, dataPathStatus=dataPathStatus, activeApplications=activeApplications, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsMIBCompliances=bwsMIBCompliances, systemSerialNumber=systemSerialNumber, ipsHdrAclAddressType=ipsHdrAclAddressType, systemFailure=systemFailure, bwstraps=bwstraps, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyOutBytes=sslProxyOutBytes, switchingToInlineMode=switchingToInlineMode, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, smAgentName=smAgentName, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheAddressType=webCacheAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, cpuFanSpeed=cpuFanSpeed, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, serviceStatus=serviceStatus, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyActiveConn=httpProxyActiveConn, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrAddress=sslSrvrAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecPort=ipsCookieSecPort, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, highAvailabilityStatus=highAvailabilityStatus, httpSrvrNumFreeConn=httpSrvrNumFreeConn, vipStatus=vipStatus, totalAttacks=totalAttacks, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCPort=ipsRCPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, raidDegrading=raidDegrading, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrTotTimedout=httpSrvrTotTimedout, uptime=uptime, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCacheProtocol=webCacheProtocol, httpProxyAddress=httpProxyAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, firmwareStorageHigh=firmwareStorageHigh, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrState=sslSrvrState, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, servicePort=servicePort, serviceAddress=serviceAddress, switchingToBypassMode=switchingToBypassMode, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprPort=webCmprPort, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotResponse=httpSrvrTotResponse, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, linkStatus=linkStatus, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCmprProtocol=webCmprProtocol, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, peerUp=peerUp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitPort=ipsReqLimitPort, totalServers=totalServers, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrState=httpSrvrState, httpProxyParseErr=httpProxyParseErr, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyServerReq=httpProxyServerReq, totalApplications=totalApplications, cpuUtilization=cpuUtilization, ipsCookieSecAddress=ipsCookieSecAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyAddress=sslProxyAddress, webCacheCacheableRes=webCacheCacheableRes, bwsSMUserSessionTable=bwsSMUserSessionTable, webCmprAddressType=webCmprAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTotDropped=ipsRCTotDropped, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsServiceStatusEntry=bwsServiceStatusEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyTotalConn=httpProxyTotalConn, webCacheHits=webCacheHits, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheAddress=webCacheAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrInBytes=sslSrvrInBytes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, freeMem=freeMem, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsRCTotServed=ipsRCTotServed, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsHdrAclPort=ipsHdrAclPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecTampered=ipsCookieSecTampered, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, systemFailOver=systemFailOver, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, smRealmName=smRealmName, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, securityDefUpdates=securityDefUpdates, serverUp=serverUp, httpProxyClientAbrt=httpProxyClientAbrt, tempHigh=tempHigh, sslProxyCacheHits=sslProxyCacheHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsTrapGroup=bwsTrapGroup, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, serverDown=serverDown, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, cpuTemperature=cpuTemperature, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsRCAddress=ipsRCAddress, ipsRCTotQueued=ipsRCTotQueued, bwsStats=bwsStats, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrAddressType=httpSrvrAddressType, logStorageHigh=logStorageHigh, webCmprAddress=webCmprAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyServerErr=httpProxyServerErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyTotalConn=sslProxyTotalConn, httpProxyPort=httpProxyPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyAddressType=httpProxyAddressType, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyInBytes=httpProxyInBytes, sslProxyInBytes=sslProxyInBytes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrPort=httpSrvrPort, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrMinResTime=httpSrvrMinResTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, operationalMode=operationalMode, activeServers=activeServers, sslProxyPort=sslProxyPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, systemLoad=systemLoad, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyOutBytes=httpProxyOutBytes, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, switchingToMaintMode=switchingToMaintMode, ipsUrlNormPort=ipsUrlNormPort, ipsRCAddressType=ipsRCAddressType, ipsReqSrvcPort=ipsReqSrvcPort)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAddress=httpSrvrAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sharedSecretKeyExpired=sharedSecretKeyExpired, energizeUpdateExpire=energizeUpdateExpire, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCachePort=webCachePort, bwsCacheStatsTable=bwsCacheStatsTable, webCacheStale=webCacheStale, sslSrvrAddressType=sslSrvrAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsMessage=bwsMessage, webCacheLongHdrs=webCacheLongHdrs, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, systemFanSpeed=systemFanSpeed, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsCacheStatsEntry=bwsCacheStatsEntry, peerDown=peerDown, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyAddressType=sslProxyAddressType, webCacheMiss=webCacheMiss, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, dataPortLinkDown=dataPortLinkDown, firmwareStorage=firmwareStorage, ipsHdrAclAddress=ipsHdrAclAddress, fanDead=fanDead, memUtilization=memUtilization, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, currentFirmwareVersion=currentFirmwareVersion, httpSrvrAvgResTime=httpSrvrAvgResTime, PYSNMP_MODULE_ID=bws, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, virusDefUpdates=virusDefUpdates, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormAddress=ipsUrlNormAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrPort=sslSrvrPort, processCountHigh=processCountHigh, totalBandwidth=totalBandwidth, webCacheReq=webCacheReq, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMIBConformance=bwsMIBConformance, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitAddress=ipsReqLimitAddress, totalMem=totalMem, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotTimedout=sslSrvrTotTimedout)
