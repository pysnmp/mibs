...
IpAddress, ModuleIdentity, TimeTicks, Counter32, Gauge32, ObjectIdentity, iso, Integer32, Bits, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "TimeTicks", "Counter32", "Gauge32", "ObjectIdentity", "iso", "Integer32", "Bits", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyServerErr=httpProxyServerErr, activeServers=activeServers, webCacheAddress=webCacheAddress, webCacheBytesOut=webCacheBytesOut, totalMem=totalMem, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, tempCritical=tempCritical, memoryUsageHigh=memoryUsageHigh, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, virusDefUpdates=virusDefUpdates, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, smAgentName=smAgentName, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMessage=bwsMessage, bwsStatsGroup=bwsStatsGroup, httpProxyServerAbrt=httpProxyServerAbrt, httpProxySessionTimeOut=httpProxySessionTimeOut, tempHigh=tempHigh, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyCurrentConn=sslProxyCurrentConn, webCacheHits=webCacheHits, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, systemSerialNumber=systemSerialNumber, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, systemFailOver=systemFailOver, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyServerReq=httpProxyServerReq, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyAddressType=sslProxyAddressType, httpSrvrState=httpSrvrState, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheLongHdrs=webCacheLongHdrs, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsStats=bwsStats, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitPort=ipsReqLimitPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, serverUp=serverUp, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecPort=ipsCookieSecPort, bwsMIBCompliance=bwsMIBCompliance, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyPort=sslProxyPort, ipsRCTotQueued=ipsRCTotQueued, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlAclReserved=ipsUrlAclReserved, webCmprAddressType=webCmprAddressType, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyTotalReq=httpProxyTotalReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrNumConn=httpSrvrNumConn, peerUp=peerUp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, fanDead=fanDead, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, vipStatus=vipStatus, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyCacheHits=sslProxyCacheHits, sslProxyCacheTimeouts=sslProxyCacheTimeouts, linkStatus=linkStatus, memUtilization=memUtilization, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrAddress=sslSrvrAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, freeMem=freeMem, webCacheReq=webCacheReq, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsMIBConformance=bwsMIBConformance, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, systemFanSpeed=systemFanSpeed, httpProxyTotalConn=httpProxyTotalConn, smNumUserSessions=smNumUserSessions, bwsSslProxyStatsTable=bwsSslProxyStatsTable, logStorageHigh=logStorageHigh, sslProxyAddress=sslProxyAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrTotReqActive=httpSrvrTotReqActive, sharedSecretKeyExpired=sharedSecretKeyExpired, PYSNMP_MODULE_ID=bws, systemFailure=systemFailure, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyAddressType=httpProxyAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheMiss=webCacheMiss, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlNormPort=ipsUrlNormPort, securityDefUpdates=securityDefUpdates, cpuFanSpeed=cpuFanSpeed, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrOutBytes=sslSrvrOutBytes, ipsRCTotDropped=ipsRCTotDropped, raidDegrading=raidDegrading, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprAddress=webCmprAddress, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, totalApplications=totalApplications, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCacheStale=webCacheStale, dataPathStatus=dataPathStatus, ipsRCAddress=ipsRCAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlAclAddress=ipsUrlAclAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, processCountHigh=processCountHigh, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, cpuTemperature=cpuTemperature, ipsRCAddressType=ipsRCAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, totalBandwidth=totalBandwidth, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, firmwareStorage=firmwareStorage, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, dataPortLinkDown=dataPortLinkDown, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrAddressType=httpSrvrAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyParseErr=httpProxyParseErr, httpProxyOutBytes=httpProxyOutBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, serviceName=serviceName, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheAddressType=webCacheAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, energizeUpdateExpire=energizeUpdateExpire, httpSrvrInBytes=httpSrvrInBytes, sslSrvrAddressType=sslSrvrAddressType, dataPortLinkUp=dataPortLinkUp, ipsUrlAclPort=ipsUrlAclPort, totalAttacks=totalAttacks, cpuUtilization=cpuUtilization, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCacheCachedObjects=webCacheCachedObjects, sslProxyOutBytes=sslProxyOutBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, servicePort=servicePort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrAddress=httpSrvrAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, serviceStatus=serviceStatus, sslSrvrMaxResTime=sslSrvrMaxResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsMIBGroups=bwsMIBGroups, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyTotalReq=sslProxyTotalReq, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsTrapGroup=bwsTrapGroup, bwstraps=bwstraps, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, serverDown=serverDown, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, smRealmName=smRealmName, httpProxyWAFWarnings=httpProxyWAFWarnings, activeApplications=activeApplications, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsHdrAclHits=ipsHdrAclHits, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyAddress=httpProxyAddress, sslSrvrTotResponse=sslSrvrTotResponse)
mibBuilder.exportSymbols("BWS-MIB", ipsRCTimeStamp=ipsRCTimeStamp, systemLoad=systemLoad, currentFirmwareVersion=currentFirmwareVersion, logStorage=logStorage, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrPort=httpSrvrPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsMIBCompliances=bwsMIBCompliances, httpProxyPort=httpProxyPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyActiveConn=httpProxyActiveConn, uptime=uptime, ipsRCPort=ipsRCPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrPort=sslSrvrPort, totalServers=totalServers, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyErrPms=sslProxyErrPms, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrMinResTime=httpSrvrMinResTime, srvcName=srvcName, webCmprProtocol=webCmprProtocol, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheProtocol=webCacheProtocol, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyInBytes=httpProxyInBytes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serviceAddress=serviceAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyTotalConn=sslProxyTotalConn, bws=bws, sslProxyInBytes=sslProxyInBytes, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcPort=ipsLrnSrvcPort, webCmprPort=webCmprPort, peerDown=peerDown, switchingToMaintMode=switchingToMaintMode, switchingToBypassMode=switchingToBypassMode, webCachePort=webCachePort, operationalMode=operationalMode, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrState=sslSrvrState, ipsHdrAclAddress=ipsHdrAclAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrInBytes=sslSrvrInBytes, ipsRCTotServed=ipsRCTotServed)
