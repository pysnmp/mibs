...
Bits, Integer32, NotificationType, TimeTicks, IpAddress, Counter64, Unsigned32, iso, Counter32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "Counter64", "Unsigned32", "iso", "Counter32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheStale=webCacheStale, ipsCookieSecPort=ipsCookieSecPort, httpProxyPort=httpProxyPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, firmwareStorage=firmwareStorage, serverDown=serverDown, httpSrvrTotResponse=httpSrvrTotResponse, totalServers=totalServers, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrInBytes=httpSrvrInBytes, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwstraps=bwstraps, ipsReqLimitPort=ipsReqLimitPort, totalAttacks=totalAttacks, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrAddressType=sslSrvrAddressType, freeMem=freeMem, cpuTemperature=cpuTemperature, httpProxyServerAbrt=httpProxyServerAbrt, linkStatus=linkStatus, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsRCPort=ipsRCPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyAddress=httpProxyAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsMIBCompliances=bwsMIBCompliances, ipsRCTotDropped=ipsRCTotDropped, cpuUtilization=cpuUtilization, httpProxyTotalConn=httpProxyTotalConn, ipsUrlAclAddress=ipsUrlAclAddress, ipsHdrAclAddress=ipsHdrAclAddress, virusDefUpdates=virusDefUpdates, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, totalBandwidth=totalBandwidth, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, peerUp=peerUp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyTotalReq=httpProxyTotalReq, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrPort=sslSrvrPort, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, smNumUserSessions=smNumUserSessions, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCmprCompressibleDataSize=webCmprCompressibleDataSize, dataPathStatus=dataPathStatus, httpProxyServerReq=httpProxyServerReq, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyInBytes=sslProxyInBytes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyActiveConn=httpProxyActiveConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyOutBytes=sslProxyOutBytes, httpProxyOutBytes=httpProxyOutBytes, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, systemSerialNumber=systemSerialNumber, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsRCAddress=ipsRCAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrAddress=sslSrvrAddress, ipsHdrAclPort=ipsHdrAclPort, memoryUsageHigh=memoryUsageHigh, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, dataPortLinkUp=dataPortLinkUp, operationalMode=operationalMode, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlAclPort=ipsUrlAclPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, tempCritical=tempCritical, sslSrvrMaxResTime=sslSrvrMaxResTime, peerDown=peerDown, raidDegrading=raidDegrading, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, memUtilization=memUtilization, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsRCTotQueued=ipsRCTotQueued, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrNumConn=httpSrvrNumConn, httpProxyInBytes=httpProxyInBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, systemLoad=systemLoad, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyCurrentConn=sslProxyCurrentConn, totalApplications=totalApplications, sslProxyAddressType=sslProxyAddressType, activeServers=activeServers, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyParseErr=httpProxyParseErr, webCacheBytesOut=webCacheBytesOut, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsTrapGroup=bwsTrapGroup, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsMIBConformance=bwsMIBConformance, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormPort=ipsUrlNormPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCacheHits=webCacheHits, smRealmName=smRealmName, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrPort=httpSrvrPort, httpSrvrState=httpSrvrState, serviceName=serviceName, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsStats=bwsStats, webCachePort=webCachePort, systemFailOver=systemFailOver, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCmprAddress=webCmprAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyActiveConn=sslProxyActiveConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, securityDefUpdates=securityDefUpdates, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyErrPms=sslProxyErrPms, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyAddress=sslProxyAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsMIBGroups=bwsMIBGroups, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrState=sslSrvrState, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, switchingToInlineMode=switchingToInlineMode, bwsStatsGroup=bwsStatsGroup, bwsCacheStatsTable=bwsCacheStatsTable, logStorage=logStorage, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, serviceAddress=serviceAddress, tempHigh=tempHigh, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrAddressType=httpSrvrAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, fanDead=fanDead, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, serverUp=serverUp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, activeApplications=activeApplications, uptime=uptime, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, totalMem=totalMem, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsHdrAclHits=ipsHdrAclHits, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrOutBytes=sslSrvrOutBytes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprPort=webCmprPort, bws=bws, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrTotSuccess=httpSrvrTotSuccess, currentFirmwareVersion=currentFirmwareVersion)
mibBuilder.exportSymbols("BWS-MIB", switchingToMaintMode=switchingToMaintMode, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyTotalReq=sslProxyTotalReq, httpSrvrAddress=httpSrvrAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, smAgentName=smAgentName, firmwareStorageHigh=firmwareStorageHigh, webCacheProtocol=webCacheProtocol, dataPortLinkDown=dataPortLinkDown, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyServerErr=httpProxyServerErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, PYSNMP_MODULE_ID=bws, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsMessage=bwsMessage, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, energizeUpdateExpire=energizeUpdateExpire, webCacheMiss=webCacheMiss, webCacheLongHdrs=webCacheLongHdrs, sslSrvrInBytes=sslSrvrInBytes, webCacheAddress=webCacheAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyAddressType=httpProxyAddressType, webCmprAddressType=webCmprAddressType, serviceStatus=serviceStatus, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyPort=sslProxyPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheReq=webCacheReq, systemFanSpeed=systemFanSpeed, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsRCStatsTable=bwsIpsRCStatsTable, processCountHigh=processCountHigh, ipsUrlAclReserved=ipsUrlAclReserved, systemFailure=systemFailure, vipStatus=vipStatus, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsMIBCompliance=bwsMIBCompliance, srvcName=srvcName, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsRCAddressType=ipsRCAddressType, logStorageHigh=logStorageHigh, webCmprProtocol=webCmprProtocol, servicePort=servicePort, switchingToBypassMode=switchingToBypassMode, sslSrvrTotRefused=sslSrvrTotRefused, cpuFanSpeed=cpuFanSpeed, sslProxyCacheHits=sslProxyCacheHits)
