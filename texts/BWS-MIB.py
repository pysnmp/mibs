...
NotificationType, Unsigned32, Counter64, MibIdentifier, IpAddress, Integer32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, TimeTicks, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Counter64", "MibIdentifier", "IpAddress", "Integer32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "TimeTicks", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, activeApplications=activeApplications, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, logStorageHigh=logStorageHigh, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyAddressType=sslProxyAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecEncrypted=ipsCookieSecEncrypted, raidDegrading=raidDegrading, PYSNMP_MODULE_ID=bws, switchingToBypassMode=switchingToBypassMode, httpProxyTotalConn=httpProxyTotalConn, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, switchingToMaintMode=switchingToMaintMode, energizeUpdateExpire=energizeUpdateExpire, totalBandwidth=totalBandwidth, servicePort=servicePort, webCmprAddress=webCmprAddress, sslProxyOutBytes=sslProxyOutBytes, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bws=bws, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyAddress=sslProxyAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrState=httpSrvrState, ipsReqSrvcPort=ipsReqSrvcPort, ipsRCTimeStamp=ipsRCTimeStamp, highAvailabilityStatus=highAvailabilityStatus, totalApplications=totalApplications, ipsRCPort=ipsRCPort, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheCacheableRes=webCacheCacheableRes, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyActiveConn=httpProxyActiveConn, ipsRCTotDropped=ipsRCTotDropped, freeMem=freeMem, totalServers=totalServers, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyCacheHits=sslProxyCacheHits, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrAddressType=httpSrvrAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrState=sslSrvrState, firmwareStorageHigh=firmwareStorageHigh, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyErrPms=sslProxyErrPms, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, operationalMode=operationalMode, activeServers=activeServers, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheStale=webCacheStale, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, serviceStatus=serviceStatus, httpSrvrTotReqRejected=httpSrvrTotReqRejected, cpuTemperature=cpuTemperature, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, cpuUtilization=cpuUtilization, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCmprProtocol=webCmprProtocol, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyServerAbrt=httpProxyServerAbrt, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, totalMem=totalMem, sslProxyPort=sslProxyPort, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, cpuFanSpeed=cpuFanSpeed, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, switchingToInlineMode=switchingToInlineMode, sslSrvrAddressType=sslSrvrAddressType, dataPathStatus=dataPathStatus, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, systemFailOver=systemFailOver, srvcName=srvcName, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyCurrentConn=sslProxyCurrentConn, serviceName=serviceName, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlNormPort=ipsUrlNormPort, tempCritical=tempCritical, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, currentFirmwareVersion=currentFirmwareVersion, securityDefUpdates=securityDefUpdates, httpSrvrTotRefused=httpSrvrTotRefused, httpProxyClientAbrt=httpProxyClientAbrt, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrTotReqRejected=sslSrvrTotReqRejected, systemLoad=systemLoad, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCAddress=ipsRCAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyServerReq=httpProxyServerReq, ipsRCTotQueued=ipsRCTotQueued, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, serviceAddress=serviceAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, dataPortLinkUp=dataPortLinkUp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrAddress=httpSrvrAddress, serverUp=serverUp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyTotalReq=sslProxyTotalReq, ipsUrlAclPort=ipsUrlAclPort, processCountHigh=processCountHigh, webCacheAddressType=webCacheAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, systemFailure=systemFailure, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsHdrAclAddressType=ipsHdrAclAddressType, bwstraps=bwstraps, webCacheProtocol=webCacheProtocol, sslSrvrNumConn=sslSrvrNumConn, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrTotResponse=sslSrvrTotResponse, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, virusDefUpdates=virusDefUpdates, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyOutBytes=httpProxyOutBytes, httpProxyParseErr=httpProxyParseErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsStatsGroup=bwsStatsGroup, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheLongHdrs=webCacheLongHdrs, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, vipStatus=vipStatus, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyPort=httpProxyPort, linkStatus=linkStatus, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheBytesOut=webCacheBytesOut, httpSrvrNumConn=httpSrvrNumConn, sslSrvrAddress=sslSrvrAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyAddress=httpProxyAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCachePort=webCachePort, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheAddress=webCacheAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrPort=httpSrvrPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsMIBGroups=bwsMIBGroups, ipsRCTotServed=ipsRCTotServed, fanDead=fanDead, firmwareStorage=firmwareStorage, ipsUrlNormAddress=ipsUrlNormAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrAvgResTime=httpSrvrAvgResTime, smNumUserSessions=smNumUserSessions, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, systemFanSpeed=systemFanSpeed, sslProxyActiveConn=sslProxyActiveConn, webCacheHits=webCacheHits, webCacheMiss=webCacheMiss, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsMessage=bwsMessage, httpSrvrInBytes=httpSrvrInBytes, smAgentName=smAgentName, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitPort=ipsReqLimitPort, webCmprPort=webCmprPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, serverDown=serverDown, ipsUrlAclReserved=ipsUrlAclReserved, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyServerErr=httpProxyServerErr, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsRCAddressType=ipsRCAddressType)
mibBuilder.exportSymbols("BWS-MIB", bwsTrapGroup=bwsTrapGroup, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrAvgResTime=sslSrvrAvgResTime, dataPortLinkDown=dataPortLinkDown, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrPort=sslSrvrPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyBadCRLErr=sslProxyBadCRLErr, peerUp=peerUp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, tempHigh=tempHigh, peerDown=peerDown, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyInBytes=httpProxyInBytes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyInBytes=sslProxyInBytes, memUtilization=memUtilization, ipsUrlAclAddress=ipsUrlAclAddress, webCacheReq=webCacheReq, httpProxySessionTimeOut=httpProxySessionTimeOut, webCmprAddressType=webCmprAddressType, bwsStats=bwsStats, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyCacheMiss=sslProxyCacheMiss, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrMinResTime=sslSrvrMinResTime, smRealmName=smRealmName, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsLrnSrvcPort=ipsLrnSrvcPort, logStorage=logStorage, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, totalAttacks=totalAttacks, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, systemSerialNumber=systemSerialNumber, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsHdrAclPort=ipsHdrAclPort, uptime=uptime, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq)
