...
Counter64, iso, MibIdentifier, Integer32, IpAddress, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, TimeTicks, Gauge32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "MibIdentifier", "Integer32", "IpAddress", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "TimeTicks", "Gauge32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, servicePort=servicePort, switchingToBypassMode=switchingToBypassMode, httpSrvrAvgResTime=httpSrvrAvgResTime, firmwareStorage=firmwareStorage, webCmprProtocol=webCmprProtocol, ipsCookieSecAddress=ipsCookieSecAddress, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsRCTotServed=ipsRCTotServed, dataPortLinkUp=dataPortLinkUp, sslProxyAddress=sslProxyAddress, fanDead=fanDead, serverUp=serverUp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitAddressType=ipsReqLimitAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, srvcName=srvcName, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, currentFirmwareVersion=currentFirmwareVersion, peerDown=peerDown, ipsCookieSecTampered=ipsCookieSecTampered, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyTotalConn=sslProxyTotalConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, systemFailure=systemFailure, httpProxyTotalConn=httpProxyTotalConn, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, switchingToInlineMode=switchingToInlineMode, httpSrvrNumConn=httpSrvrNumConn, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprPort=webCmprPort, bwsMIBGroups=bwsMIBGroups, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCachePort=webCachePort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsStats=bwsStats, webCacheAddressType=webCacheAddressType, sslProxyTotalReq=sslProxyTotalReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCacheProtocol=webCacheProtocol, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, memoryUsageHigh=memoryUsageHigh, webCacheStale=webCacheStale, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsRCTotDropped=ipsRCTotDropped, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyAddressType=sslProxyAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrMinResTime=sslSrvrMinResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, securityDefUpdates=securityDefUpdates, bwsMIBCompliances=bwsMIBCompliances, sslSrvrState=sslSrvrState, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, tempCritical=tempCritical, sslSrvrAddress=sslSrvrAddress, raidDegrading=raidDegrading, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, systemFailOver=systemFailOver, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrInBytes=sslSrvrInBytes, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, peerUp=peerUp, tempHigh=tempHigh, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsRCPort=ipsRCPort, systemFanSpeed=systemFanSpeed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyActiveConn=httpProxyActiveConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, firmwareStorageHigh=firmwareStorageHigh, ipsHdrAclAddress=ipsHdrAclAddress, webCacheBytesOut=webCacheBytesOut, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyServerReq=httpProxyServerReq, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, serviceStatus=serviceStatus, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, processCountHigh=processCountHigh, bwsServiceStatusTable=bwsServiceStatusTable, webCacheHits=webCacheHits, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrAddressType=httpSrvrAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlNormPort=ipsUrlNormPort, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyAddressType=httpProxyAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyOutBytes=sslProxyOutBytes, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwstraps=bwstraps, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyPort=httpProxyPort, webCacheReq=webCacheReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrPort=sslSrvrPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, totalServers=totalServers, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCTotQueued=ipsRCTotQueued, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrTotReqActive=httpSrvrTotReqActive, memUtilization=memUtilization, webCmprAddressType=webCmprAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, smAgentName=smAgentName, operationalMode=operationalMode, sslSrvrOutBytes=sslSrvrOutBytes, logStorageHigh=logStorageHigh, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, uptime=uptime, webCacheCachedObjects=webCacheCachedObjects, httpProxyServerErr=httpProxyServerErr, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyAddress=httpProxyAddress, totalBandwidth=totalBandwidth, webCacheLongHdrs=webCacheLongHdrs, cpuTemperature=cpuTemperature, httpSrvrTotRefused=httpSrvrTotRefused, virusDefUpdates=virusDefUpdates, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsRCAddressType=ipsRCAddressType, httpProxyTotalReq=httpProxyTotalReq, ipsCookieSecPort=ipsCookieSecPort, serviceAddress=serviceAddress, ipsRCAddress=ipsRCAddress, smRealmName=smRealmName, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, systemSerialNumber=systemSerialNumber, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsStatsGroup=bwsStatsGroup, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, energizeUpdateExpire=energizeUpdateExpire, totalMem=totalMem, webCacheAddress=webCacheAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrAddress=httpSrvrAddress, serverDown=serverDown, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsMessage=bwsMessage, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheCacheableRes=webCacheCacheableRes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, webCmprAddress=webCmprAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bws=bws, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrState=httpSrvrState, sslProxyInBytes=sslProxyInBytes, highAvailabilityStatus=highAvailabilityStatus, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, totalApplications=totalApplications, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, dataPortLinkDown=dataPortLinkDown, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsHdrAclHits=ipsHdrAclHits, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, vipStatus=vipStatus, httpSrvrPort=httpSrvrPort, totalAttacks=totalAttacks, logStorage=logStorage, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsHdrAclPort=ipsHdrAclPort, sslSrvrAddressType=sslSrvrAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, cpuUtilization=cpuUtilization, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, activeApplications=activeApplications)
mibBuilder.exportSymbols("BWS-MIB", freeMem=freeMem, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, smNumUserSessions=smNumUserSessions, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsTrapGroup=bwsTrapGroup, PYSNMP_MODULE_ID=bws, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitPort=ipsReqLimitPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlAclPort=ipsUrlAclPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyCacheHits=sslProxyCacheHits, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyParseErr=httpProxyParseErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlNormAddress=ipsUrlNormAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlPolicyPort=ipsUrlPolicyPort, activeServers=activeServers, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCacheMiss=webCacheMiss, bwsMIBCompliance=bwsMIBCompliance, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrTotRefused=sslSrvrTotRefused, serviceName=serviceName, sslProxyPort=sslProxyPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemLoad=systemLoad, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, linkStatus=linkStatus, cpuFanSpeed=cpuFanSpeed, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, dataPathStatus=dataPathStatus, bwsMIBConformance=bwsMIBConformance, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqSrvcPort=ipsReqSrvcPort, switchingToMaintMode=switchingToMaintMode, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped)
