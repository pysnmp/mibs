...
TimeTicks, Gauge32, NotificationType, MibIdentifier, ModuleIdentity, Counter64, iso, IpAddress, Counter32, Unsigned32, Bits, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter64", "iso", "IpAddress", "Counter32", "Unsigned32", "Bits", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, cpuFanSpeed=cpuFanSpeed, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyAddress=httpProxyAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, totalBandwidth=totalBandwidth, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, serviceName=serviceName, serviceAddress=serviceAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyParseErr=httpProxyParseErr, ipsReqLimitPort=ipsReqLimitPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheMiss=webCacheMiss, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrTotResponse=httpSrvrTotResponse, securityDefUpdates=securityDefUpdates, webCmprProtocol=webCmprProtocol, webCacheStale=webCacheStale, bwsMIBCompliances=bwsMIBCompliances, bwsMIBConformance=bwsMIBConformance, httpProxyServerErr=httpProxyServerErr, ipsHdrAclAddress=ipsHdrAclAddress, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcPort=ipsReqSrvcPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, vipStatus=vipStatus, switchingToMaintMode=switchingToMaintMode, highAvailabilityStatus=highAvailabilityStatus, httpSrvrState=httpSrvrState, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCmprPort=webCmprPort, energizeUpdateExpire=energizeUpdateExpire, ipsRCTotDropped=ipsRCTotDropped, servicePort=servicePort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, raidDegrading=raidDegrading, webCacheCachedObjects=webCacheCachedObjects, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyTotalReq=httpProxyTotalReq, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, serverUp=serverUp, httpProxyOutBytes=httpProxyOutBytes, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyCacheMiss=sslProxyCacheMiss, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, switchingToInlineMode=switchingToInlineMode, sslProxyInBytes=sslProxyInBytes, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsStats=bwsStats, webCacheAddressType=webCacheAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheAddress=webCacheAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, webCachePort=webCachePort, ipsCookieSecPort=ipsCookieSecPort, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCacheReq=webCacheReq, ipsHdrAclPort=ipsHdrAclPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyAddressType=sslProxyAddressType, systemFanSpeed=systemFanSpeed, dataPortLinkDown=dataPortLinkDown, cpuTemperature=cpuTemperature, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyPort=sslProxyPort, smNumUserSessions=smNumUserSessions, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrAddress=sslSrvrAddress, dataPathStatus=dataPathStatus, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyUnknownRsp=httpProxyUnknownRsp, cpuUtilization=cpuUtilization, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, smRealmName=smRealmName, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsMessage=bwsMessage, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrState=sslSrvrState, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, tempCritical=tempCritical, httpProxyAddressType=httpProxyAddressType, dataPortLinkUp=dataPortLinkUp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, virusDefUpdates=virusDefUpdates, webCacheProtocol=webCacheProtocol, ipsRCTotQueued=ipsRCTotQueued, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCacheBytesOut=webCacheBytesOut, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, tempHigh=tempHigh, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyPort=httpProxyPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bws=bws, firmwareStorageHigh=firmwareStorageHigh, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyOutBytes=sslProxyOutBytes, sslProxyActiveConn=sslProxyActiveConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlPort=ipsAccessCtrlPort, firmwareStorage=firmwareStorage, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, logStorage=logStorage, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsStatsGroup=bwsStatsGroup, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyTotalConn=httpProxyTotalConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrTotTimedout=sslSrvrTotTimedout, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, serviceStatus=serviceStatus, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sharedSecretKeyExpired=sharedSecretKeyExpired, systemSerialNumber=systemSerialNumber, sslSrvrPort=sslSrvrPort, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyCacheHits=sslProxyCacheHits, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, currentFirmwareVersion=currentFirmwareVersion, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheHits=webCacheHits, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrTotRefused=sslSrvrTotRefused, peerUp=peerUp, httpSrvrMaxResTime=httpSrvrMaxResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, activeApplications=activeApplications, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyAddress=sslProxyAddress, httpProxyServerReq=httpProxyServerReq, sslProxyCurrentConn=sslProxyCurrentConn, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrPort=httpSrvrPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrAddressType=sslSrvrAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsCompressionStatsTable=bwsCompressionStatsTable, memoryUsageHigh=memoryUsageHigh, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, fanDead=fanDead, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlAclPort=ipsUrlAclPort, smAgentName=smAgentName, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrAddressType=httpSrvrAddressType, ipsRCAddressType=ipsRCAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrOutBytes=sslSrvrOutBytes, serverDown=serverDown, freeMem=freeMem, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsRCAddress=ipsRCAddress, ipsRCTotServed=ipsRCTotServed, activeServers=activeServers, linkStatus=linkStatus, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyActiveConn=httpProxyActiveConn, peerDown=peerDown)
mibBuilder.exportSymbols("BWS-MIB", PYSNMP_MODULE_ID=bws, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCmprAddressType=webCmprAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcPort=ipsLrnSrvcPort, operationalMode=operationalMode, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcAddress=ipsReqSrvcAddress, totalMem=totalMem, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, totalApplications=totalApplications, systemLoad=systemLoad, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormPort=ipsUrlNormPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsRCPort=ipsRCPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyInBytes=httpProxyInBytes, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, logStorageHigh=logStorageHigh, srvcName=srvcName, totalAttacks=totalAttacks, sslSrvrInBytes=sslSrvrInBytes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsSslProxyStatsTable=bwsSslProxyStatsTable, memUtilization=memUtilization, systemFailOver=systemFailOver, totalServers=totalServers, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsHdrAclHits=ipsHdrAclHits, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrNumConn=httpSrvrNumConn, webCacheCacheableRes=webCacheCacheableRes, processCountHigh=processCountHigh, bwstraps=bwstraps, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumConn=sslSrvrNumConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, systemFailure=systemFailure, ipsUrlAclReserved=ipsUrlAclReserved, webCmprAddress=webCmprAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsMIBCompliance=bwsMIBCompliance, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, uptime=uptime, httpSrvrAddress=httpSrvrAddress, ipsUrlAclAddress=ipsUrlAclAddress)
