...
ObjectIdentity, Counter32, iso, Integer32, Gauge32, IpAddress, Bits, ModuleIdentity, Counter64, MibIdentifier, TimeTicks, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "iso", "Integer32", "Gauge32", "IpAddress", "Bits", "ModuleIdentity", "Counter64", "MibIdentifier", "TimeTicks", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlNormPort=ipsUrlNormPort, activeServers=activeServers, activeApplications=activeApplications, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsRCTotQueued=ipsRCTotQueued, httpProxyAddressType=httpProxyAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bws=bws, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, logStorageHigh=logStorageHigh, bwsStatsGroup=bwsStatsGroup, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, tempHigh=tempHigh, sslProxyAddressType=sslProxyAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, serviceAddress=serviceAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyServerErr=httpProxyServerErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyInBytes=httpProxyInBytes, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, dataPortLinkDown=dataPortLinkDown, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrAddress=httpSrvrAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrInBytes=sslSrvrInBytes, totalBandwidth=totalBandwidth, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsCookieSecTampered=ipsCookieSecTampered, totalAttacks=totalAttacks, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, freeMem=freeMem, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, serverUp=serverUp, vipStatus=vipStatus, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrTotResponse=sslSrvrTotResponse, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyTotalReq=sslProxyTotalReq, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyActiveConn=httpProxyActiveConn, serviceStatus=serviceStatus, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqSrvcPort=ipsReqSrvcPort, webCacheReq=webCacheReq, highAvailabilityStatus=highAvailabilityStatus, cpuUtilization=cpuUtilization, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecPort=ipsCookieSecPort, webCacheHits=webCacheHits, bwsCacheStatsTable=bwsCacheStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCachePort=webCachePort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyCurrentConn=sslProxyCurrentConn, ipsRCAddress=ipsRCAddress, sslProxyInBytes=sslProxyInBytes, switchingToMaintMode=switchingToMaintMode, sharedSecretKeyExpired=sharedSecretKeyExpired, currentFirmwareVersion=currentFirmwareVersion, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheAddressType=webCacheAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrAddressType=sslSrvrAddressType, sslProxyAddress=sslProxyAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, serviceName=serviceName, virusDefUpdates=virusDefUpdates, httpSrvrPort=httpSrvrPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, linkStatus=linkStatus, memUtilization=memUtilization, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrPort=sslSrvrPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, totalMem=totalMem, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCTotServed=ipsRCTotServed, webCacheAddress=webCacheAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, switchingToBypassMode=switchingToBypassMode, sslProxyErrPms=sslProxyErrPms, sslSrvrTotSuccess=sslSrvrTotSuccess, systemFanSpeed=systemFanSpeed, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrSrvcPort=httpSrvrSrvcPort, securityDefUpdates=securityDefUpdates, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCmprPort=webCmprPort, ipsReqLimitPort=ipsReqLimitPort, uptime=uptime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, firmwareStorageHigh=firmwareStorageHigh, dataPathStatus=dataPathStatus, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsMIBCompliance=bwsMIBCompliance, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, PYSNMP_MODULE_ID=bws, memoryUsageHigh=memoryUsageHigh, energizeUpdateExpire=energizeUpdateExpire, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsRCTotDropped=ipsRCTotDropped, sslProxyBadCRLErr=sslProxyBadCRLErr, raidDegrading=raidDegrading, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, totalApplications=totalApplications, ipsRCPort=ipsRCPort, bwsMIBCompliances=bwsMIBCompliances, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrAddressType=httpSrvrAddressType, serverDown=serverDown, fanDead=fanDead, sslProxyActiveConn=sslProxyActiveConn, bwstraps=bwstraps, ipsLrnSrvcPort=ipsLrnSrvcPort, webCacheLongHdrs=webCacheLongHdrs, servicePort=servicePort, webCmprCompressedDataSize=webCmprCompressedDataSize, tempCritical=tempCritical, sslProxyOutBytes=sslProxyOutBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyServerReq=httpProxyServerReq, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheMiss=webCacheMiss, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsCompressionStatsTable=bwsCompressionStatsTable, cpuTemperature=cpuTemperature, logStorage=logStorage, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrOutBytes=httpSrvrOutBytes, smNumUserSessions=smNumUserSessions, sslSrvrState=sslSrvrState, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsHdrAclHits=ipsHdrAclHits, httpProxyOutBytes=httpProxyOutBytes, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsHdrAclPort=ipsHdrAclPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, peerUp=peerUp, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrState=httpSrvrState, bwsSMUserSessionEntry=bwsSMUserSessionEntry, smAgentName=smAgentName, httpProxyClientAbrt=httpProxyClientAbrt, webCmprProtocol=webCmprProtocol, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCacheProtocol=webCacheProtocol, httpProxyTotalConn=httpProxyTotalConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, systemFailOver=systemFailOver, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprAddress=webCmprAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, cpuFanSpeed=cpuFanSpeed, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsStats=bwsStats, httpSrvrTotRefused=httpSrvrTotRefused, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, systemLoad=systemLoad, bwsMIBGroups=bwsMIBGroups, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, systemSerialNumber=systemSerialNumber, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsTrapGroup=bwsTrapGroup, httpProxyAddress=httpProxyAddress, webCmprAddressType=webCmprAddressType)
mibBuilder.exportSymbols("BWS-MIB", dataPortLinkUp=dataPortLinkUp, ipsCookieSecAddress=ipsCookieSecAddress, systemFailure=systemFailure, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsMessage=bwsMessage, httpSrvrNumConn=httpSrvrNumConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, smRealmName=smRealmName, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, operationalMode=operationalMode, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsMIBConformance=bwsMIBConformance, webCacheStale=webCacheStale, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsRCAddressType=ipsRCAddressType, sslProxyPort=sslProxyPort, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, firmwareStorage=firmwareStorage, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrTotReqRejected=sslSrvrTotReqRejected, srvcName=srvcName, webCacheCacheableRes=webCacheCacheableRes, sslSrvrNumConn=sslSrvrNumConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclPort=ipsUrlAclPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrAddress=sslSrvrAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, processCountHigh=processCountHigh, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, totalServers=totalServers, sslSrvrOutBytes=sslSrvrOutBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, peerDown=peerDown, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrInBytes=httpSrvrInBytes, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyTotalReq=httpProxyTotalReq, httpProxyPort=httpProxyPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyCacheHits=sslProxyCacheHits, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped)
