...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, TimeTicks, Counter64, ObjectIdentity, NotificationType, Counter32, iso, ModuleIdentity, Unsigned32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "TimeTicks", "Counter64", "ObjectIdentity", "NotificationType", "Counter32", "iso", "ModuleIdentity", "Unsigned32", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecTampered=ipsCookieSecTampered, webCmprAddress=webCmprAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsMIBCompliances=bwsMIBCompliances, bwsCacheStatsEntry=bwsCacheStatsEntry, dataPortLinkDown=dataPortLinkDown, cpuFanSpeed=cpuFanSpeed, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrMinResTime=sslSrvrMinResTime, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, PYSNMP_MODULE_ID=bws, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsRCPort=ipsRCPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, totalAttacks=totalAttacks, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, vipStatus=vipStatus, webCmprCompressedDataSize=webCmprCompressedDataSize, bwstraps=bwstraps, httpProxyActiveConn=httpProxyActiveConn, webCacheReq=webCacheReq, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsStats=bwsStats, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyAddressType=httpProxyAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheCacheableRes=webCacheCacheableRes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, totalMem=totalMem, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, dataPathStatus=dataPathStatus, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsMIBCompliance=bwsMIBCompliance, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrAddressType=sslSrvrAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrPort=sslSrvrPort, sslProxyTotalReq=sslProxyTotalReq, httpSrvrPort=httpSrvrPort, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, firmwareStorage=firmwareStorage, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, systemFanSpeed=systemFanSpeed, cpuUtilization=cpuUtilization, serverDown=serverDown, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, processCountHigh=processCountHigh, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, servicePort=servicePort, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsStatsGroup=bwsStatsGroup, httpProxyAddress=httpProxyAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsCompressionStatsTable=bwsCompressionStatsTable, highAvailabilityStatus=highAvailabilityStatus, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrState=httpSrvrState, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, logStorage=logStorage, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCTotServed=ipsRCTotServed, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyOutBytes=sslProxyOutBytes, webCacheBytesOut=webCacheBytesOut, webCachePort=webCachePort, ipsHdrAclHits=ipsHdrAclHits, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrNumConn=sslSrvrNumConn, activeApplications=activeApplications, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheProtocol=webCacheProtocol, totalServers=totalServers, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheMiss=webCacheMiss, bwsTrapGroup=bwsTrapGroup, webCacheAddress=webCacheAddress, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, tempCritical=tempCritical, sslSrvrTotRefused=sslSrvrTotRefused, systemFailOver=systemFailOver, ipsCookieSecPort=ipsCookieSecPort, bwsMIBGroups=bwsMIBGroups, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, systemLoad=systemLoad, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrAddress=sslSrvrAddress, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyServerErr=httpProxyServerErr, httpSrvrAddressType=httpSrvrAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrTotSuccess=sslSrvrTotSuccess, memoryUsageHigh=memoryUsageHigh, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsMessage=bwsMessage, sslProxyAddress=sslProxyAddress, sslProxyPort=sslProxyPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCacheAddressType=webCacheAddressType, webCacheStale=webCacheStale, ipsUrlAclAddress=ipsUrlAclAddress, cpuTemperature=cpuTemperature, peerUp=peerUp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, totalBandwidth=totalBandwidth, sslSrvrState=sslSrvrState, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheHits=webCacheHits, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, peerDown=peerDown, memUtilization=memUtilization, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, firmwareStorageHigh=firmwareStorageHigh, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, activeServers=activeServers, linkStatus=linkStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCmprAddressType=webCmprAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, uptime=uptime, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsRCAddressType=ipsRCAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumFreeConn=httpSrvrNumFreeConn, operationalMode=operationalMode, webCacheCachedObjects=webCacheCachedObjects, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrNumConn=httpSrvrNumConn, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxySessionTimeOut=httpProxySessionTimeOut, virusDefUpdates=virusDefUpdates, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, freeMem=freeMem, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, serviceName=serviceName, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyOutBytes=httpProxyOutBytes, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotTimedout=sslSrvrTotTimedout, logStorageHigh=logStorageHigh, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, switchingToMaintMode=switchingToMaintMode, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, energizeUpdateExpire=energizeUpdateExpire, systemSerialNumber=systemSerialNumber, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyInBytes=sslProxyInBytes, fanDead=fanDead)
mibBuilder.exportSymbols("BWS-MIB", httpProxyPort=httpProxyPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlAclPort=ipsUrlAclPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyErrPms=sslProxyErrPms, smNumUserSessions=smNumUserSessions, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, smRealmName=smRealmName, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, smAgentName=smAgentName, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsMIBConformance=bwsMIBConformance, systemFailure=systemFailure, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, raidDegrading=raidDegrading, ipsRCAddress=ipsRCAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCmprProtocol=webCmprProtocol, securityDefUpdates=securityDefUpdates, sslProxyAddressType=sslProxyAddressType, webCmprPort=webCmprPort, httpProxyInBytes=httpProxyInBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrTotRefused=httpSrvrTotRefused, ipsRCTotOutOfResource=ipsRCTotOutOfResource, serviceAddress=serviceAddress, bws=bws, sslProxyCacheHits=sslProxyCacheHits, tempHigh=tempHigh, httpSrvrMinResTime=httpSrvrMinResTime, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCTotQueued=ipsRCTotQueued, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, totalApplications=totalApplications, srvcName=srvcName, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyTotalConn=httpProxyTotalConn, serviceStatus=serviceStatus, sslSrvrTotResponse=sslSrvrTotResponse, currentFirmwareVersion=currentFirmwareVersion, serverUp=serverUp, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyServerReq=httpProxyServerReq, switchingToInlineMode=switchingToInlineMode, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyParseErr=httpProxyParseErr)
