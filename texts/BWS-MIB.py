...
Bits, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, ModuleIdentity, Counter64, NotificationType, iso, ObjectIdentity, Integer32, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter64", "NotificationType", "iso", "ObjectIdentity", "Integer32", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotRefused=sslSrvrTotRefused, srvcName=srvcName, sslSrvrSrvcPort=sslSrvrSrvcPort, securityDefUpdates=securityDefUpdates, dataPortLinkDown=dataPortLinkDown, httpProxyInBytes=httpProxyInBytes, peerUp=peerUp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bws=bws, httpProxyParseErr=httpProxyParseErr, ipsReqLimitPort=ipsReqLimitPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyErrPms=sslProxyErrPms, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyInBytes=sslProxyInBytes, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, systemLoad=systemLoad, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyTotalConn=httpProxyTotalConn, webCacheCacheableRes=webCacheCacheableRes, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheHits=webCacheHits, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, serverDown=serverDown, systemFailure=systemFailure, bwsMIBCompliances=bwsMIBCompliances, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheBytesOut=webCacheBytesOut, totalApplications=totalApplications, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsStatsGroup=bwsStatsGroup, freeMem=freeMem, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrPort=sslSrvrPort, sslProxyBadDNCErr=sslProxyBadDNCErr, memUtilization=memUtilization, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, serviceName=serviceName, httpProxyActiveConn=httpProxyActiveConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, dataPortLinkUp=dataPortLinkUp, totalServers=totalServers, uptime=uptime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, cpuUtilization=cpuUtilization, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlNormPort=ipsUrlNormPort, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyCacheHits=sslProxyCacheHits, webCacheAddress=webCacheAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyServerReq=httpProxyServerReq, webCacheStale=webCacheStale, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyPort=sslProxyPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrInBytes=sslSrvrInBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, vipStatus=vipStatus, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, totalBandwidth=totalBandwidth, smAgentName=smAgentName, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlAclPort=ipsUrlAclPort, webCmprAddressType=webCmprAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyAddressType=httpProxyAddressType, sslSrvrNumConn=sslSrvrNumConn, httpProxyAddress=httpProxyAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyAddressType=sslProxyAddressType, firmwareStorage=firmwareStorage, peerDown=peerDown, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrAddress=sslSrvrAddress, bwsMIBCompliance=bwsMIBCompliance, highAvailabilityStatus=highAvailabilityStatus, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyTotalReq=sslProxyTotalReq, systemFailOver=systemFailOver, httpSrvrPort=httpSrvrPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, raidDegrading=raidDegrading, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, memoryUsageHigh=memoryUsageHigh, httpSrvrNumConn=httpSrvrNumConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, cpuFanSpeed=cpuFanSpeed, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCTimeStamp=ipsRCTimeStamp, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, serviceStatus=serviceStatus, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, smRealmName=smRealmName, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, fanDead=fanDead, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheAddressType=webCacheAddressType, sslProxyOutBytes=sslProxyOutBytes, webCacheReq=webCacheReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransAddress=ipsWebAddrTransAddress, systemFanSpeed=systemFanSpeed, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, energizeUpdateExpire=energizeUpdateExpire, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsRCPort=ipsRCPort, PYSNMP_MODULE_ID=bws, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyCurrentConn=sslProxyCurrentConn, switchingToInlineMode=switchingToInlineMode, webCmprPort=webCmprPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, totalAttacks=totalAttacks, ipsHdrAclPort=ipsHdrAclPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, operationalMode=operationalMode, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyTotalReq=httpProxyTotalReq, webCacheMiss=webCacheMiss, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, linkStatus=linkStatus, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, virusDefUpdates=virusDefUpdates, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, servicePort=servicePort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyOutBytes=httpProxyOutBytes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCachePort=webCachePort, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyAddress=sslProxyAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsMessage=bwsMessage, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, systemSerialNumber=systemSerialNumber, switchingToMaintMode=switchingToMaintMode, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrInBytes=httpSrvrInBytes, serviceAddress=serviceAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrAddress=httpSrvrAddress, totalMem=totalMem, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, smNumUserSessions=smNumUserSessions, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsRCAddress=ipsRCAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotResponse=httpSrvrTotResponse, tempHigh=tempHigh, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, firmwareUpdateAvailable=firmwareUpdateAvailable, activeServers=activeServers, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyPort=httpProxyPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitAddressType=ipsReqLimitAddressType, bwstraps=bwstraps, tempCritical=tempCritical, currentFirmwareVersion=currentFirmwareVersion, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, processCountHigh=processCountHigh, activeApplications=activeApplications, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsServiceStatusTable=bwsServiceStatusTable, serverUp=serverUp, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrState=httpSrvrState)
mibBuilder.exportSymbols("BWS-MIB", ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlAclAddress=ipsUrlAclAddress, ipsRCTotDropped=ipsRCTotDropped, bwsServiceStatusEntry=bwsServiceStatusEntry, logStorage=logStorage, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsStats=bwsStats, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheProtocol=webCacheProtocol, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyTotalConn=sslProxyTotalConn, logStorageHigh=logStorageHigh, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, firmwareStorageHigh=firmwareStorageHigh, sslSrvrState=sslSrvrState, httpSrvrAddressType=httpSrvrAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCmprAddress=webCmprAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCmprProtocol=webCmprProtocol, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTotQueued=ipsRCTotQueued, ipsRCTotServed=ipsRCTotServed, bwsMIBConformance=bwsMIBConformance, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyServerErr=httpProxyServerErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheCachedObjects=webCacheCachedObjects, switchingToBypassMode=switchingToBypassMode, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyServerAbrt=httpProxyServerAbrt, cpuTemperature=cpuTemperature, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyActiveConn=sslProxyActiveConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, dataPathStatus=dataPathStatus, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten)
