...
NotificationType, ObjectIdentity, iso, Counter64, ModuleIdentity, Counter32, TimeTicks, Unsigned32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "iso", "Counter64", "ModuleIdentity", "Counter32", "TimeTicks", "Unsigned32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, logStorage=logStorage, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, serverDown=serverDown, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, smAgentName=smAgentName, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, activeApplications=activeApplications, bwstraps=bwstraps, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumConn=httpSrvrNumConn, bwsMIBCompliance=bwsMIBCompliance, ipsHdrAclAddressType=ipsHdrAclAddressType, fanDead=fanDead, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, dataPathStatus=dataPathStatus, sslSrvrState=sslSrvrState, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsCookieSecEncrypted=ipsCookieSecEncrypted, serviceAddress=serviceAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, totalServers=totalServers, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyAddress=sslProxyAddress, ipsCookieSecPort=ipsCookieSecPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsReqSrvcPort=ipsReqSrvcPort, tempCritical=tempCritical, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitAddress=ipsReqLimitAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCTotDropped=ipsRCTotDropped, sslSrvrPort=sslSrvrPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCTotServed=ipsRCTotServed, processCountHigh=processCountHigh, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsMIBCompliances=bwsMIBCompliances, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheBytesOut=webCacheBytesOut, sslProxyCurrentConn=sslProxyCurrentConn, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsStats=bwsStats, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, systemFanSpeed=systemFanSpeed, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCmprAddress=webCmprAddress, raidDegrading=raidDegrading, sslSrvrAddressType=sslSrvrAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheAddressType=webCacheAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheProtocol=webCacheProtocol, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, currentFirmwareVersion=currentFirmwareVersion, ipsRCAddress=ipsRCAddress, bwsTrapGroup=bwsTrapGroup, operationalMode=operationalMode, httpProxyParseErr=httpProxyParseErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, firmwareStorage=firmwareStorage, peerUp=peerUp, httpProxyOutBytes=httpProxyOutBytes, serviceName=serviceName, webCacheAddress=webCacheAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, uptime=uptime, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitPort=ipsReqLimitPort, systemFailure=systemFailure, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrInBytes=sslSrvrInBytes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyPort=httpProxyPort, httpProxyTotalReq=httpProxyTotalReq, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsHdrAclPort=ipsHdrAclPort, httpSrvrAddress=httpSrvrAddress, ipsUrlNormPort=ipsUrlNormPort, switchingToBypassMode=switchingToBypassMode, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrMinResTime=sslSrvrMinResTime, highAvailabilityStatus=highAvailabilityStatus, memUtilization=memUtilization, serverUp=serverUp, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyInBytes=sslProxyInBytes, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsMessage=bwsMessage, sslProxyCacheMiss=sslProxyCacheMiss, logStorageHigh=logStorageHigh, firmwareStorageHigh=firmwareStorageHigh, httpSrvrTotRefused=httpSrvrTotRefused, srvcName=srvcName, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyErrPms=sslProxyErrPms, dataPortLinkUp=dataPortLinkUp, ipsCookieSecTampered=ipsCookieSecTampered, bws=bws, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, freeMem=freeMem, httpProxyServerReq=httpProxyServerReq, ipsUrlAclPort=ipsUrlAclPort, sslProxyActiveConn=sslProxyActiveConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, PYSNMP_MODULE_ID=bws, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, totalApplications=totalApplications, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCacheCachedObjects=webCacheCachedObjects, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheCacheableRes=webCacheCacheableRes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCacheReq=webCacheReq, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrTotTimedout=httpSrvrTotTimedout, systemSerialNumber=systemSerialNumber, cpuTemperature=cpuTemperature, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, systemLoad=systemLoad, webCacheStale=webCacheStale, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, dataPortLinkDown=dataPortLinkDown, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, cpuUtilization=cpuUtilization, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsHdrAclHits=ipsHdrAclHits, httpProxyServerAbrt=httpProxyServerAbrt, servicePort=servicePort, vipStatus=vipStatus, webCacheMiss=webCacheMiss, webCacheHits=webCacheHits, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyPort=sslProxyPort, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsStatsGroup=bwsStatsGroup, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCTotQueued=ipsRCTotQueued, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrSrvcPort=httpSrvrSrvcPort, switchingToInlineMode=switchingToInlineMode, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyServerErr=httpProxyServerErr, energizeUpdateExpire=energizeUpdateExpire, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyAddressType=sslProxyAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyActiveConn=httpProxyActiveConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyOutBytes=sslProxyOutBytes, virusDefUpdates=virusDefUpdates, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrPort=httpSrvrPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, systemFailOver=systemFailOver, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, totalAttacks=totalAttacks, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrAddress=sslSrvrAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCmprProtocol=webCmprProtocol, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrState=httpSrvrState, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess)
mibBuilder.exportSymbols("BWS-MIB", totalBandwidth=totalBandwidth, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotReqActive=sslSrvrTotReqActive, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, cpuFanSpeed=cpuFanSpeed, serviceStatus=serviceStatus, ipsRCPort=ipsRCPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsCacheStatsTable=bwsCacheStatsTable, tempHigh=tempHigh, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, peerDown=peerDown, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyAddress=httpProxyAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, switchingToMaintMode=switchingToMaintMode, activeServers=activeServers, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, linkStatus=linkStatus, sslProxyCacheHits=sslProxyCacheHits, httpSrvrMinResTime=httpSrvrMinResTime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCmprAddressType=webCmprAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, smNumUserSessions=smNumUserSessions, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyTotalConn=sslProxyTotalConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, smRealmName=smRealmName, totalMem=totalMem, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, bwsMIBGroups=bwsMIBGroups, bwsMIBConformance=bwsMIBConformance, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCmprPort=webCmprPort, webCachePort=webCachePort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsRCAddressType=ipsRCAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource)
