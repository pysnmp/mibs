...
NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, IpAddress, Bits, Counter64, iso, Gauge32, Unsigned32, ModuleIdentity, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "IpAddress", "Bits", "Counter64", "iso", "Gauge32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyCacheHits=sslProxyCacheHits, cpuUtilization=cpuUtilization, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprAddressType=webCmprAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyAddress=httpProxyAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyAddress=sslProxyAddress, securityDefUpdates=securityDefUpdates, bwsSMUserSessionTable=bwsSMUserSessionTable, firmwareStorage=firmwareStorage, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, logStorageHigh=logStorageHigh, bwsStatsGroup=bwsStatsGroup, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCacheHits=webCacheHits, dataPathStatus=dataPathStatus, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, switchingToMaintMode=switchingToMaintMode, webCacheAddressType=webCacheAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsMIBCompliance=bwsMIBCompliance, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsMIBConformance=bwsMIBConformance, httpSrvrMinResTime=httpSrvrMinResTime, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrInBytes=httpSrvrInBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, dataPortLinkUp=dataPortLinkUp, httpProxyServerAbrt=httpProxyServerAbrt, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, logStorage=logStorage, httpProxyServerErr=httpProxyServerErr, sslSrvrAddressType=sslSrvrAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, smRealmName=smRealmName, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, srvcName=srvcName, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrOutBytes=httpSrvrOutBytes, webCacheCacheableRes=webCacheCacheableRes, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwstraps=bwstraps, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrInBytes=sslSrvrInBytes, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrAddressType=httpSrvrAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCmprAddress=webCmprAddress, sslSrvrNumConn=sslSrvrNumConn, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, smNumUserSessions=smNumUserSessions, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, totalServers=totalServers, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, totalAttacks=totalAttacks, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqSrvcPort=ipsReqSrvcPort, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, systemSerialNumber=systemSerialNumber, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyAddressType=sslProxyAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyPort=httpProxyPort, webCacheCachedObjects=webCacheCachedObjects, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCacheBytesOut=webCacheBytesOut, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, switchingToInlineMode=switchingToInlineMode, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, serviceStatus=serviceStatus, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCTotQueued=ipsRCTotQueued, httpProxyTotalConn=httpProxyTotalConn, httpProxyTotalReq=httpProxyTotalReq, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCTotServed=ipsRCTotServed, PYSNMP_MODULE_ID=bws, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCacheStale=webCacheStale, raidDegrading=raidDegrading, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyServerReq=httpProxyServerReq, processCountHigh=processCountHigh, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, tempCritical=tempCritical, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, memUtilization=memUtilization, peerDown=peerDown, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, firmwareStorageHigh=firmwareStorageHigh, freeMem=freeMem, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyOutBytes=httpProxyOutBytes, webCacheAddress=webCacheAddress, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, cpuFanSpeed=cpuFanSpeed, sslSrvrAddress=sslSrvrAddress, ipsHdrAclPort=ipsHdrAclPort, ipsRCTotDropped=ipsRCTotDropped, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCachePort=webCachePort, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitPort=ipsReqLimitPort, bwsMIBGroups=bwsMIBGroups, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecPort=ipsCookieSecPort, serverUp=serverUp, ipsRCPort=ipsRCPort, sslSrvrState=sslSrvrState, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyClientAbrt=httpProxyClientAbrt, bwsStats=bwsStats, webCmprPort=webCmprPort, serviceAddress=serviceAddress, sslSrvrPort=sslSrvrPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyInBytes=sslProxyInBytes, serverDown=serverDown, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsMessage=bwsMessage, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyErrPms=sslProxyErrPms, webCmprProtocol=webCmprProtocol, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrTotTimedout=httpSrvrTotTimedout, smAgentName=smAgentName, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsMIBCompliances=bwsMIBCompliances, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, linkStatus=linkStatus, vipStatus=vipStatus, cpuTemperature=cpuTemperature, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, fanDead=fanDead, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, dataPortLinkDown=dataPortLinkDown, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, activeServers=activeServers, ipsUrlAclPort=ipsUrlAclPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyTotalReq=sslProxyTotalReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsRCTimeStamp=ipsRCTimeStamp, ipsRCAddress=ipsRCAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, activeApplications=activeApplications, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, virusDefUpdates=virusDefUpdates, httpSrvrNumConn=httpSrvrNumConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclReserved=ipsUrlAclReserved, bwsServiceStatusEntry=bwsServiceStatusEntry, highAvailabilityStatus=highAvailabilityStatus, webCacheProtocol=webCacheProtocol, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, systemFanSpeed=systemFanSpeed, ipsUrlNormPort=ipsUrlNormPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, peerUp=peerUp)
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, totalBandwidth=totalBandwidth, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqSrvcAddress=ipsReqSrvcAddress, currentFirmwareVersion=currentFirmwareVersion, serviceName=serviceName, systemFailOver=systemFailOver, ipsUrlPolicyAddress=ipsUrlPolicyAddress, systemLoad=systemLoad, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, memoryUsageHigh=memoryUsageHigh, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, totalMem=totalMem, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, operationalMode=operationalMode, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCacheLongHdrs=webCacheLongHdrs, webCacheReq=webCacheReq, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrState=httpSrvrState, httpSrvrPort=httpSrvrPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bws=bws, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyPort=sslProxyPort, totalApplications=totalApplications, webCacheMiss=webCacheMiss, ipsCookieSecEncrypted=ipsCookieSecEncrypted, tempHigh=tempHigh, uptime=uptime, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyActiveConn=httpProxyActiveConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsServiceStatusTable=bwsServiceStatusTable, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyOutBytes=sslProxyOutBytes, systemFailure=systemFailure, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrTotRefused=sslSrvrTotRefused, servicePort=servicePort, ipsCookieSecTampered=ipsCookieSecTampered)
