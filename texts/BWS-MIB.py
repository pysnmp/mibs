...
ModuleIdentity, IpAddress, Counter64, Unsigned32, Counter32, Bits, iso, Integer32, ObjectIdentity, NotificationType, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Counter64", "Unsigned32", "Counter32", "Bits", "iso", "Integer32", "ObjectIdentity", "NotificationType", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", systemFanSpeed=systemFanSpeed, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, systemFailure=systemFailure, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, uptime=uptime, ipsCookieSecPort=ipsCookieSecPort, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheCachedObjects=webCacheCachedObjects, ipsReqLimitPort=ipsReqLimitPort, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, totalMem=totalMem, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCmprAddressType=webCmprAddressType, linkStatus=linkStatus, httpSrvrNumConn=httpSrvrNumConn, activeApplications=activeApplications, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyAddressType=httpProxyAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrAddress=sslSrvrAddress, ipsRCAddressType=ipsRCAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyPort=httpProxyPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, cpuUtilization=cpuUtilization, httpSrvrPort=httpSrvrPort, httpProxyUnknownRsp=httpProxyUnknownRsp, totalAttacks=totalAttacks, sslProxyInBytes=sslProxyInBytes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, peerUp=peerUp, httpSrvrInBytes=httpSrvrInBytes, totalApplications=totalApplications, sslProxyOutBytes=sslProxyOutBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqSrvcAddress=ipsReqSrvcAddress, peerDown=peerDown, httpSrvrAddress=httpSrvrAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, systemFailOver=systemFailOver, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclReserved=ipsUrlAclReserved, dataPathStatus=dataPathStatus, sslSrvrSrvcAddress=sslSrvrSrvcAddress, switchingToInlineMode=switchingToInlineMode, sslSrvrState=sslSrvrState, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyAddress=httpProxyAddress, httpProxyActiveConn=httpProxyActiveConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyOutBytes=httpProxyOutBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrState=httpSrvrState, sslProxyTotalReq=sslProxyTotalReq, ipsRCTotServed=ipsRCTotServed, ipsReqSrvcPort=ipsReqSrvcPort, currentFirmwareVersion=currentFirmwareVersion, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyAddress=sslProxyAddress, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrTotRefused=httpSrvrTotRefused, webCacheMiss=webCacheMiss, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyInBytes=httpProxyInBytes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, memoryUsageHigh=memoryUsageHigh, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheProtocol=webCacheProtocol, srvcName=srvcName, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCacheStale=webCacheStale, highAvailabilityStatus=highAvailabilityStatus, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, PYSNMP_MODULE_ID=bws, ipsRCPort=ipsRCPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclPort=ipsUrlAclPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCacheAddressType=webCacheAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotSuccess=sslSrvrTotSuccess, logStorageHigh=logStorageHigh, tempCritical=tempCritical, bwsMIBCompliance=bwsMIBCompliance, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, energizeUpdateExpire=energizeUpdateExpire, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwstraps=bwstraps, fanDead=fanDead, cpuFanSpeed=cpuFanSpeed, ipsRCTotDropped=ipsRCTotDropped, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, systemLoad=systemLoad, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyTotalConn=sslProxyTotalConn, ipsRCTotQueued=ipsRCTotQueued, tempHigh=tempHigh, sslProxyCurrentConn=sslProxyCurrentConn, ipsCookieSecAddress=ipsCookieSecAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, serverUp=serverUp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsMIBGroups=bwsMIBGroups, httpProxyTotalReq=httpProxyTotalReq, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyAddressType=sslProxyAddressType, bwsTrapGroup=bwsTrapGroup, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyServerErr=httpProxyServerErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyPort=sslProxyPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, raidDegrading=raidDegrading, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, dataPortLinkDown=dataPortLinkDown, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, firmwareUpdateAvailable=firmwareUpdateAvailable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormPort=ipsUrlNormPort, sslProxyBadDNCErr=sslProxyBadDNCErr, logStorage=logStorage, firmwareStorageHigh=firmwareStorageHigh, smRealmName=smRealmName, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsRCAddress=ipsRCAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, serverDown=serverDown, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyActiveConn=sslProxyActiveConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrPort=sslSrvrPort, httpProxyTotalConn=httpProxyTotalConn, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrNumConn=sslSrvrNumConn, ipsHdrAclHits=ipsHdrAclHits, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serviceAddress=serviceAddress, webCmprProtocol=webCmprProtocol, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheReq=webCacheReq, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, smAgentName=smAgentName, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheAddress=webCacheAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCachePort=webCachePort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, dataPortLinkUp=dataPortLinkUp, memUtilization=memUtilization, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, serviceName=serviceName, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bws=bws, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrMinResTime=sslSrvrMinResTime, webCacheCacheableRes=webCacheCacheableRes, vipStatus=vipStatus, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, servicePort=servicePort, totalBandwidth=totalBandwidth, ipsWebAddrTransAddress=ipsWebAddrTransAddress)
mibBuilder.exportSymbols("BWS-MIB", switchingToMaintMode=switchingToMaintMode, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrInBytes=sslSrvrInBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitAddress=ipsReqLimitAddress, freeMem=freeMem, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, totalServers=totalServers, ipsUrlAclAddress=ipsUrlAclAddress, firmwareStorage=firmwareStorage, sslSrvrAvgResTime=sslSrvrAvgResTime, serviceStatus=serviceStatus, virusDefUpdates=virusDefUpdates, bwsStatsGroup=bwsStatsGroup, httpSrvrAddressType=httpSrvrAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlNormAddressType=ipsUrlNormAddressType, operationalMode=operationalMode, sslProxyCacheMiss=sslProxyCacheMiss, smNumUserSessions=smNumUserSessions, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCacheHits=webCacheHits, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsMIBConformance=bwsMIBConformance, webCmprAddress=webCmprAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, cpuTemperature=cpuTemperature, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, processCountHigh=processCountHigh, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsMIBCompliances=bwsMIBCompliances, sslProxyCacheHits=sslProxyCacheHits, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCmprPort=webCmprPort, activeServers=activeServers, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyErrPms=sslProxyErrPms, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsStats=bwsStats, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsHdrAclPort=ipsHdrAclPort, securityDefUpdates=securityDefUpdates, bwsMessage=bwsMessage, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable)
