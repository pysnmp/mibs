...
Bits, ObjectIdentity, Counter32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Gauge32, Unsigned32, TimeTicks, Integer32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Gauge32", "Unsigned32", "TimeTicks", "Integer32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", ipsRCTotServed=ipsRCTotServed, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsStats=bwsStats, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyAddressType=httpProxyAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheAddressType=webCacheAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlAclReserved=ipsUrlAclReserved, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bws=bws, httpSrvrOutBytes=httpSrvrOutBytes, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheStale=webCacheStale, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxyOutBytes=httpProxyOutBytes, cpuFanSpeed=cpuFanSpeed, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, smRealmName=smRealmName, bwsMIBCompliances=bwsMIBCompliances, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyTotalConn=sslProxyTotalConn, dataPortLinkDown=dataPortLinkDown, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, totalAttacks=totalAttacks, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyErrPms=sslProxyErrPms, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsMIBCompliance=bwsMIBCompliance, systemFanSpeed=systemFanSpeed, webCacheCacheableRes=webCacheCacheableRes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsRCTotQueued=ipsRCTotQueued, peerUp=peerUp, webCmprAddressType=webCmprAddressType, systemFailure=systemFailure, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, tempHigh=tempHigh, httpProxyServerErr=httpProxyServerErr, systemFailOver=systemFailOver, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlPort=ipsAccessCtrlPort, memoryUsageHigh=memoryUsageHigh, httpProxyPort=httpProxyPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, totalBandwidth=totalBandwidth, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsHdrAclHits=ipsHdrAclHits, webCachePort=webCachePort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, logStorage=logStorage, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyParseErr=httpProxyParseErr, sslProxyCacheHits=sslProxyCacheHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, dataPathStatus=dataPathStatus, currentFirmwareVersion=currentFirmwareVersion, httpSrvrAddressType=httpSrvrAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, totalApplications=totalApplications, httpSrvrTotResponse=httpSrvrTotResponse, ipsRCAddressType=ipsRCAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprPort=webCmprPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyTotalReq=sslProxyTotalReq, switchingToInlineMode=switchingToInlineMode, httpSrvrTotReqActive=httpSrvrTotReqActive, operationalMode=operationalMode, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsMessage=bwsMessage, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsTrapGroup=bwsTrapGroup, ipsReqLimitAddress=ipsReqLimitAddress, totalMem=totalMem, ipsHdrAclPort=ipsHdrAclPort, sslSrvrAddress=sslSrvrAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrMinResTime=sslSrvrMinResTime, webCmprAddress=webCmprAddress, raidDegrading=raidDegrading, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyOutBytes=sslProxyOutBytes, activeServers=activeServers, sslProxyAddressType=sslProxyAddressType, bwsMIBConformance=bwsMIBConformance, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, vipStatus=vipStatus, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlNormPort=ipsUrlNormPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyInBytes=sslProxyInBytes, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrState=httpSrvrState, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyAddress=httpProxyAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, servicePort=servicePort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, processCountHigh=processCountHigh, ipsHdrAclAddress=ipsHdrAclAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyAddress=sslProxyAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, PYSNMP_MODULE_ID=bws, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlAddress=ipsAccessCtrlAddress, cpuTemperature=cpuTemperature, sslSrvrState=sslSrvrState, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, highAvailabilityStatus=highAvailabilityStatus, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, virusDefUpdates=virusDefUpdates, srvcName=srvcName, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, linkStatus=linkStatus, sslSrvrPort=sslSrvrPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, serviceName=serviceName, ipsCookieSecPort=ipsCookieSecPort, webCacheProtocol=webCacheProtocol, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrInBytes=sslSrvrInBytes, serviceAddress=serviceAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsMIBGroups=bwsMIBGroups, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheMiss=webCacheMiss, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyPort=sslProxyPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, firmwareStorageHigh=firmwareStorageHigh, webCacheHits=webCacheHits, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitAddressType=ipsReqLimitAddressType, systemLoad=systemLoad, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyInBytes=httpProxyInBytes, tempCritical=tempCritical, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclPort=ipsUrlAclPort, ipsRCAddress=ipsRCAddress, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyActiveConn=httpProxyActiveConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, switchingToMaintMode=switchingToMaintMode, httpProxyTotalReq=httpProxyTotalReq, httpSrvrTotReqRejected=httpSrvrTotReqRejected, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheReq=webCacheReq, fanDead=fanDead, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqSrvcPort=ipsReqSrvcPort, webCacheAddress=webCacheAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, logStorageHigh=logStorageHigh, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, cpuUtilization=cpuUtilization, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt)
mibBuilder.exportSymbols("BWS-MIB", ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, serverDown=serverDown, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, smAgentName=smAgentName, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrAddress=httpSrvrAddress, smNumUserSessions=smNumUserSessions, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsRCPort=ipsRCPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, serverUp=serverUp, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrTotResponse=sslSrvrTotResponse, dataPortLinkUp=dataPortLinkUp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsCookieSecEncrypted=ipsCookieSecEncrypted, securityDefUpdates=securityDefUpdates, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheBytesOut=webCacheBytesOut, httpProxyTotalConn=httpProxyTotalConn, ipsWebAddrTransPort=ipsWebAddrTransPort, peerDown=peerDown, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrNumConn=sslSrvrNumConn, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrMaxResTime=sslSrvrMaxResTime, firmwareStorage=firmwareStorage, memUtilization=memUtilization, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwstraps=bwstraps, systemSerialNumber=systemSerialNumber, httpProxyServerReq=httpProxyServerReq, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, freeMem=freeMem, switchingToBypassMode=switchingToBypassMode, firmwareUpdateAvailable=firmwareUpdateAvailable, webCmprProtocol=webCmprProtocol, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, uptime=uptime, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrNumConn=httpSrvrNumConn, httpSrvrMinResTime=httpSrvrMinResTime, serviceStatus=serviceStatus, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrAddressType=sslSrvrAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, energizeUpdateExpire=energizeUpdateExpire, httpSrvrPort=httpSrvrPort, activeApplications=activeApplications, webCacheLongHdrs=webCacheLongHdrs, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsRCTotDropped=ipsRCTotDropped, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, totalServers=totalServers, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans)
