...
Counter32, Integer32, Gauge32, ObjectIdentity, Counter64, TimeTicks, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, iso, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Gauge32", "ObjectIdentity", "Counter64", "TimeTicks", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "iso", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsRCTotServed=ipsRCTotServed, ipsRCTotDropped=ipsRCTotDropped, ipsReqSrvcAddress=ipsReqSrvcAddress, serverDown=serverDown, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCacheLongHdrs=webCacheLongHdrs, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCAddress=ipsRCAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCmprAddress=webCmprAddress, serverUp=serverUp, systemFailure=systemFailure, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, peerUp=peerUp, freeMem=freeMem, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, totalServers=totalServers, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrOutBytes=httpSrvrOutBytes, logStorage=logStorage, ipsHdrAclPort=ipsHdrAclPort, bwsMIBConformance=bwsMIBConformance, bwsSMUserSessionTable=bwsSMUserSessionTable, servicePort=servicePort, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrState=httpSrvrState, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, PYSNMP_MODULE_ID=bws, virusDefUpdates=virusDefUpdates, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, securityDefUpdates=securityDefUpdates, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyServerReq=httpProxyServerReq, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, energizeUpdateExpire=energizeUpdateExpire, httpProxyActiveConn=httpProxyActiveConn, ipsRCAddressType=ipsRCAddressType, cpuTemperature=cpuTemperature, sslProxyTotalConn=sslProxyTotalConn, sslProxyTotalReq=sslProxyTotalReq, highAvailabilityStatus=highAvailabilityStatus, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqSrvcPort=ipsReqSrvcPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, tempHigh=tempHigh, ipsLrnSrvcAddress=ipsLrnSrvcAddress, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, serviceStatus=serviceStatus, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, peerDown=peerDown, cpuFanSpeed=cpuFanSpeed, webCachePort=webCachePort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCmprProtocol=webCmprProtocol, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyCurrentConn=sslProxyCurrentConn, totalBandwidth=totalBandwidth, sslProxyErrPms=sslProxyErrPms, logStorageHigh=logStorageHigh, bwsMIBCompliance=bwsMIBCompliance, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyTotalReq=httpProxyTotalReq, systemSerialNumber=systemSerialNumber, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyInBytes=sslProxyInBytes, sslSrvrTotReqRejected=sslSrvrTotReqRejected, fanDead=fanDead, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyAddressType=sslProxyAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, currentFirmwareVersion=currentFirmwareVersion, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrNumConn=sslSrvrNumConn, sslProxyActiveConn=sslProxyActiveConn, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, activeServers=activeServers, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheReq=webCacheReq, srvcName=srvcName, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyPort=sslProxyPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyAddressType=httpProxyAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyAddress=sslProxyAddress, totalAttacks=totalAttacks, switchingToBypassMode=switchingToBypassMode, serviceAddress=serviceAddress, webCacheMiss=webCacheMiss, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrPort=sslSrvrPort, httpSrvrNumConn=httpSrvrNumConn, ipsHdrAclHits=ipsHdrAclHits, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrOutBytes=sslSrvrOutBytes, ipsRCTotQueued=ipsRCTotQueued, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, smRealmName=smRealmName, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCacheAddress=webCacheAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, systemFailOver=systemFailOver, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCmprPort=webCmprPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyServerErr=httpProxyServerErr, bwstraps=bwstraps, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsMIBGroups=bwsMIBGroups, webCacheHits=webCacheHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyServerAbrt=httpProxyServerAbrt, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, uptime=uptime, totalApplications=totalApplications, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, smNumUserSessions=smNumUserSessions, webCacheCacheableRes=webCacheCacheableRes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyCacheHits=sslProxyCacheHits, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, smAgentName=smAgentName, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrAddress=httpSrvrAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, firmwareStorageHigh=firmwareStorageHigh, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, switchingToMaintMode=switchingToMaintMode, raidDegrading=raidDegrading, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrPort=httpSrvrPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, systemFanSpeed=systemFanSpeed, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsCacheStatsTable=bwsCacheStatsTable, serviceName=serviceName, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, totalMem=totalMem, ipsCookieSecTampered=ipsCookieSecTampered, bwsTrapGroup=bwsTrapGroup, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitAddressType=ipsReqLimitAddressType, memUtilization=memUtilization, httpProxyPort=httpProxyPort, systemLoad=systemLoad, ipsRCTimeStamp=ipsRCTimeStamp, bwsStats=bwsStats, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsStatsGroup=bwsStatsGroup, cpuUtilization=cpuUtilization, switchingToInlineMode=switchingToInlineMode, dataPathStatus=dataPathStatus, httpProxyTotalConn=httpProxyTotalConn, httpProxyUnknownRsp=httpProxyUnknownRsp, tempCritical=tempCritical, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsHdrAclAddressType=ipsHdrAclAddressType, vipStatus=vipStatus, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrAddress=sslSrvrAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten)
mibBuilder.exportSymbols("BWS-MIB", sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrTotRefused=sslSrvrTotRefused, operationalMode=operationalMode, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, linkStatus=linkStatus, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlPolicyPort=ipsUrlPolicyPort, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyAddress=httpProxyAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheStale=webCacheStale, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, firmwareStorage=firmwareStorage, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCPort=ipsRCPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCmprAddressType=webCmprAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheProtocol=webCacheProtocol, ipsUrlAclPort=ipsUrlAclPort, bws=bws, httpProxyParseErr=httpProxyParseErr, ipsReqLimitPort=ipsReqLimitPort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrTotResponse=httpSrvrTotResponse, bwsMessage=bwsMessage, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCacheAddressType=webCacheAddressType, activeApplications=activeApplications, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsCookieSecPort=ipsCookieSecPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrInBytes=sslSrvrInBytes, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrState=sslSrvrState, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxySessionTimeOut=httpProxySessionTimeOut, processCountHigh=processCountHigh, dataPortLinkDown=dataPortLinkDown, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrMinResTime=httpSrvrMinResTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated)
