...
Bits, Gauge32, Counter64, NotificationType, TimeTicks, Counter32, Unsigned32, ModuleIdentity, Integer32, ObjectIdentity, iso, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "Counter64", "NotificationType", "TimeTicks", "Counter32", "Unsigned32", "ModuleIdentity", "Integer32", "ObjectIdentity", "iso", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", serviceAddress=serviceAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCTotQueued=ipsRCTotQueued, memUtilization=memUtilization, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrAddressType=sslSrvrAddressType, activeApplications=activeApplications, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsHdrAclPort=ipsHdrAclPort, ipsRCTotDropped=ipsRCTotDropped, currentFirmwareVersion=currentFirmwareVersion, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrInBytes=sslSrvrInBytes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, energizeUpdateExpire=energizeUpdateExpire, bwsMIBGroups=bwsMIBGroups, bwsSMUserSessionEntry=bwsSMUserSessionEntry, serverUp=serverUp, totalBandwidth=totalBandwidth, sslSrvrPort=sslSrvrPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, cpuUtilization=cpuUtilization, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, memoryUsageHigh=memoryUsageHigh, webCacheBytesOut=webCacheBytesOut, bwsMIBCompliances=bwsMIBCompliances, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrState=sslSrvrState, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyBadDNCErr=sslProxyBadDNCErr, operationalMode=operationalMode, systemLoad=systemLoad, sslProxyErrPms=sslProxyErrPms, bwsMIBCompliance=bwsMIBCompliance, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, fanDead=fanDead, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, linkStatus=linkStatus, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlAclAddress=ipsUrlAclAddress, smNumUserSessions=smNumUserSessions, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyTotalConn=httpProxyTotalConn, ipsHdrAclHits=ipsHdrAclHits, virusDefUpdates=virusDefUpdates, ipsRCPort=ipsRCPort, systemSerialNumber=systemSerialNumber, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprProtocol=webCmprProtocol, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCacheLongHdrs=webCacheLongHdrs, httpProxyAddressType=httpProxyAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlAclPort=ipsUrlAclPort, httpProxyAddress=httpProxyAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrState=httpSrvrState, sslSrvrAddress=sslSrvrAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyOutBytes=httpProxyOutBytes, serviceStatus=serviceStatus, switchingToInlineMode=switchingToInlineMode, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyAddress=sslProxyAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyOutBytes=sslProxyOutBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, serviceName=serviceName, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheProtocol=webCacheProtocol, totalAttacks=totalAttacks, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheStale=webCacheStale, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrAddressType=httpSrvrAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyPort=httpProxyPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrPort=httpSrvrPort, switchingToMaintMode=switchingToMaintMode, ipsCookieSecPort=ipsCookieSecPort, sslProxyInBytes=sslProxyInBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, servicePort=servicePort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyInBytes=httpProxyInBytes, webCachePort=webCachePort, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, totalMem=totalMem, bwsTrapGroup=bwsTrapGroup, cpuFanSpeed=cpuFanSpeed, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, smRealmName=smRealmName, vipStatus=vipStatus, bwsSMUserSessionTable=bwsSMUserSessionTable, firmwareStorage=firmwareStorage, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serverDown=serverDown, ipsUrlNormAddress=ipsUrlNormAddress, dataPortLinkDown=dataPortLinkDown, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, dataPortLinkUp=dataPortLinkUp, sslProxyCacheHits=sslProxyCacheHits, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, systemFanSpeed=systemFanSpeed, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, firmwareStorageHigh=firmwareStorageHigh, webCmprPort=webCmprPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, tempCritical=tempCritical, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheReq=webCacheReq, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrAddress=httpSrvrAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, systemFailure=systemFailure, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsRCTotServed=ipsRCTotServed, httpProxyParseErr=httpProxyParseErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, peerDown=peerDown, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, uptime=uptime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheCacheableRes=webCacheCacheableRes, processCountHigh=processCountHigh, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyPort=sslProxyPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, freeMem=freeMem, highAvailabilityStatus=highAvailabilityStatus, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCAddress=ipsRCAddress, webCmprAddress=webCmprAddress, sslSrvrTotResponse=sslSrvrTotResponse, bwsMIBConformance=bwsMIBConformance, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, raidDegrading=raidDegrading, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwstraps=bwstraps, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsStatsGroup=bwsStatsGroup, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsRCTotOutOfResource=ipsRCTotOutOfResource, cpuTemperature=cpuTemperature, ipsReqLimitAddressType=ipsReqLimitAddressType, systemFailOver=systemFailOver, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCmprAddressType=webCmprAddressType, httpProxyTotalReq=httpProxyTotalReq, securityDefUpdates=securityDefUpdates, ipsReqLimitAddress=ipsReqLimitAddress, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn)
mibBuilder.exportSymbols("BWS-MIB", webCacheAddressType=webCacheAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, webCacheHits=webCacheHits, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrNumConn=httpSrvrNumConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sharedSecretKeyExpired=sharedSecretKeyExpired, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyAddressType=sslProxyAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyBadCRLErr=sslProxyBadCRLErr, srvcName=srvcName, logStorageHigh=logStorageHigh, peerUp=peerUp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrNumConn=sslSrvrNumConn, httpProxyActiveConn=httpProxyActiveConn, webCacheMiss=webCacheMiss, httpProxyServerErr=httpProxyServerErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrInBytes=httpSrvrInBytes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, totalServers=totalServers, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsMessage=bwsMessage, sslProxyActiveConn=sslProxyActiveConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprCompressedDataSize=webCmprCompressedDataSize, smAgentName=smAgentName, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAddress=ipsAccessCtrlAddress, totalApplications=totalApplications, dataPathStatus=dataPathStatus, sslProxyTotalConn=sslProxyTotalConn, bwsStats=bwsStats, tempHigh=tempHigh, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCacheAddress=webCacheAddress, activeServers=activeServers, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqSrvcPort=ipsReqSrvcPort, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlNormPort=ipsUrlNormPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, PYSNMP_MODULE_ID=bws, logStorage=logStorage, bws=bws)
