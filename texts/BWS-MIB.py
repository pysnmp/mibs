...
Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, TimeTicks, ObjectIdentity, Unsigned32, NotificationType, IpAddress, MibIdentifier, iso, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "TimeTicks", "ObjectIdentity", "Unsigned32", "NotificationType", "IpAddress", "MibIdentifier", "iso", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlAclPort=ipsUrlAclPort, virusDefUpdates=virusDefUpdates, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyErrPms=sslProxyErrPms, totalBandwidth=totalBandwidth, sslProxyTotalConn=sslProxyTotalConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyActiveConn=sslProxyActiveConn, smRealmName=smRealmName, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bws=bws, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwstraps=bwstraps, sslSrvrMinResTime=sslSrvrMinResTime, processCountHigh=processCountHigh, sslSrvrTotResponse=sslSrvrTotResponse, webCacheAddress=webCacheAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheHits=webCacheHits, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheCacheableRes=webCacheCacheableRes, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyTotalReq=httpProxyTotalReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, logStorage=logStorage, operationalMode=operationalMode, highAvailabilityStatus=highAvailabilityStatus, vipStatus=vipStatus, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsHdrAclPort=ipsHdrAclPort, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsMIBCompliance=bwsMIBCompliance, bwsTrapGroup=bwsTrapGroup, systemFanSpeed=systemFanSpeed, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, dataPortLinkUp=dataPortLinkUp, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrNumFreeConn=sslSrvrNumFreeConn, cpuTemperature=cpuTemperature, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyOutBytes=httpProxyOutBytes, httpProxyServerReq=httpProxyServerReq, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, switchingToMaintMode=switchingToMaintMode, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprPort=webCmprPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, smAgentName=smAgentName, webCacheAddressType=webCacheAddressType, bwsStatsGroup=bwsStatsGroup, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlAclReserved=ipsUrlAclReserved, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, peerUp=peerUp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCmprAddressType=webCmprAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlNormPort=ipsUrlNormPort, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, systemFailure=systemFailure, sslProxyAddress=sslProxyAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecPort=ipsCookieSecPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyInBytes=sslProxyInBytes, httpProxyServerErr=httpProxyServerErr, peerDown=peerDown, webCacheMiss=webCacheMiss, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsCompressionStatsEntry=bwsCompressionStatsEntry, freeMem=freeMem, serverUp=serverUp, memoryUsageHigh=memoryUsageHigh, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrInBytes=httpSrvrInBytes, serviceAddress=serviceAddress, webCmprProtocol=webCmprProtocol, serverDown=serverDown, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, energizeUpdateExpire=energizeUpdateExpire, httpProxyActiveConn=httpProxyActiveConn, securityDefUpdates=securityDefUpdates, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, servicePort=servicePort, totalAttacks=totalAttacks, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrState=httpSrvrState, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyPort=sslProxyPort, sslSrvrInBytes=sslSrvrInBytes, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyInBytes=httpProxyInBytes, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyClientAbrt=httpProxyClientAbrt, bwsServiceStatusTable=bwsServiceStatusTable, raidDegrading=raidDegrading, sslSrvrState=sslSrvrState, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCacheProtocol=webCacheProtocol, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyCurrentConn=sslProxyCurrentConn, tempHigh=tempHigh, serviceStatus=serviceStatus, sslSrvrAddress=sslSrvrAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsStats=bwsStats, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrNumConn=httpSrvrNumConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, serviceName=serviceName, dataPathStatus=dataPathStatus, switchingToInlineMode=switchingToInlineMode, sslProxyFullHandshakes=sslProxyFullHandshakes, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyPort=httpProxyPort, httpProxyAddressType=httpProxyAddressType, webCacheCachedObjects=webCacheCachedObjects, ipsReqLimitPort=ipsReqLimitPort, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyTotalReq=sslProxyTotalReq, ipsRCPort=ipsRCPort, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, firmwareStorageHigh=firmwareStorageHigh, firmwareStorage=firmwareStorage, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, PYSNMP_MODULE_ID=bws, httpSrvrAddress=httpSrvrAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, webCacheReq=webCacheReq, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyParseErr=httpProxyParseErr, srvcName=srvcName, ipsRCAddressType=ipsRCAddressType, linkStatus=linkStatus, webCacheStale=webCacheStale, systemFailOver=systemFailOver, logStorageHigh=logStorageHigh, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrAddressType=sslSrvrAddressType, bwsMIBCompliances=bwsMIBCompliances, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrPort=sslSrvrPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, fanDead=fanDead, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransAddress=ipsWebAddrTransAddress, totalApplications=totalApplications, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCTotDropped=ipsRCTotDropped, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, systemLoad=systemLoad, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotRefused=sslSrvrTotRefused, cpuUtilization=cpuUtilization, ipsRCTotServed=ipsRCTotServed, webCacheLongHdrs=webCacheLongHdrs, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsHdrAclHits=ipsHdrAclHits, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyCacheHits=sslProxyCacheHits, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsRCAddress=ipsRCAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsMessage=bwsMessage, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyBadCRLErr=sslProxyBadCRLErr, switchingToBypassMode=switchingToBypassMode, bwsMIBConformance=bwsMIBConformance, ipsReqSrvcPort=ipsReqSrvcPort, bwsMIBGroups=bwsMIBGroups, httpSrvrAvgResTime=httpSrvrAvgResTime, memUtilization=memUtilization, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, smNumUserSessions=smNumUserSessions, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyAddress=httpProxyAddress, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrAddressType=httpSrvrAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCmprAddress=webCmprAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCacheBytesOut=webCacheBytesOut, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyAddressType=sslProxyAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, totalServers=totalServers, sslProxyOutBytes=sslProxyOutBytes, dataPortLinkDown=dataPortLinkDown, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, activeApplications=activeApplications, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrPort=httpSrvrPort, webCachePort=webCachePort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, activeServers=activeServers, currentFirmwareVersion=currentFirmwareVersion, systemSerialNumber=systemSerialNumber, newAttackDefinitionInstalled=newAttackDefinitionInstalled, tempCritical=tempCritical, uptime=uptime, totalMem=totalMem, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr)
