...
TimeTicks, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Bits, Unsigned32, MibIdentifier, NotificationType, iso, Gauge32, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Bits", "Unsigned32", "MibIdentifier", "NotificationType", "iso", "Gauge32", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, smAgentName=smAgentName, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecPort=ipsCookieSecPort, systemFailOver=systemFailOver, bwsServiceStatusEntry=bwsServiceStatusEntry, activeApplications=activeApplications, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, systemSerialNumber=systemSerialNumber, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrTotRefused=sslSrvrTotRefused, securityDefUpdates=securityDefUpdates, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsRCPort=ipsRCPort, operationalMode=operationalMode, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyErrPms=sslProxyErrPms, srvcName=srvcName, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheReq=webCacheReq, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsTrapGroup=bwsTrapGroup, bwsIpsRCStatsTable=bwsIpsRCStatsTable, serviceName=serviceName, sslProxyCacheHits=sslProxyCacheHits, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsMIBGroups=bwsMIBGroups, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrPort=sslSrvrPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrTotReqRejected=sslSrvrTotReqRejected, peerUp=peerUp, totalAttacks=totalAttacks, ipsRCAddressType=ipsRCAddressType, systemFanSpeed=systemFanSpeed, sslSrvrState=sslSrvrState, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, logStorageHigh=logStorageHigh, httpProxyTotalReq=httpProxyTotalReq, webCmprPort=webCmprPort, smNumUserSessions=smNumUserSessions, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrPort=httpSrvrPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bws=bws, httpSrvrTotRefused=httpSrvrTotRefused, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyPort=sslProxyPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxyOutBytes=httpProxyOutBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsRCAddress=ipsRCAddress, serverUp=serverUp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyAddress=httpProxyAddress, sslProxyAddress=sslProxyAddress, dataPortLinkDown=dataPortLinkDown, vipStatus=vipStatus, totalServers=totalServers, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrState=httpSrvrState, fanDead=fanDead, ipsUrlNormPort=ipsUrlNormPort, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrAvgResTime=httpSrvrAvgResTime, switchingToMaintMode=switchingToMaintMode, cpuUtilization=cpuUtilization, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheStale=webCacheStale, sslProxyAddressType=sslProxyAddressType, ipsHdrAclPort=ipsHdrAclPort, sslProxyTotalReq=sslProxyTotalReq, webCacheProtocol=webCacheProtocol, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyPort=httpProxyPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCmprProtocol=webCmprProtocol, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsSMUserSessionTable=bwsSMUserSessionTable, bwstraps=bwstraps, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, raidDegrading=raidDegrading, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyTotalConn=sslProxyTotalConn, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, uptime=uptime, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, switchingToInlineMode=switchingToInlineMode, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrNumConn=sslSrvrNumConn, cpuFanSpeed=cpuFanSpeed, webCacheAddressType=webCacheAddressType, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecAddress=ipsCookieSecAddress, currentFirmwareVersion=currentFirmwareVersion, webCmprAddress=webCmprAddress, firmwareStorage=firmwareStorage, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheCacheableRes=webCacheCacheableRes, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlNormAddress=ipsUrlNormAddress, totalBandwidth=totalBandwidth, webCacheMiss=webCacheMiss, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyCurrentConn=sslProxyCurrentConn, httpProxyServerErr=httpProxyServerErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, dataPortLinkUp=dataPortLinkUp, totalApplications=totalApplications, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrOutBytes=sslSrvrOutBytes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsHdrAclHits=ipsHdrAclHits, httpSrvrAddressType=httpSrvrAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, energizeUpdateExpire=energizeUpdateExpire, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, highAvailabilityStatus=highAvailabilityStatus, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, serviceAddress=serviceAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrSrvcPort=sslSrvrSrvcPort, dataPathStatus=dataPathStatus, systemFailure=systemFailure, sslSrvrTotTimedout=sslSrvrTotTimedout, firmwareUpdateAvailable=firmwareUpdateAvailable, virusDefUpdates=virusDefUpdates, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, processCountHigh=processCountHigh, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsMIBConformance=bwsMIBConformance, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, PYSNMP_MODULE_ID=bws, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsRCTotServed=ipsRCTotServed, sslSrvrInBytes=sslSrvrInBytes, servicePort=servicePort, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyServerReq=httpProxyServerReq, webCacheHits=webCacheHits, bwsMIBCompliances=bwsMIBCompliances, httpProxyInBytes=httpProxyInBytes, freeMem=freeMem, smRealmName=smRealmName, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsStats=bwsStats, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsStatsGroup=bwsStatsGroup, httpProxyTotalConn=httpProxyTotalConn, sslSrvrAddressType=sslSrvrAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCmprAddressType=webCmprAddressType, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyParseErr=httpProxyParseErr, tempHigh=tempHigh, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, systemLoad=systemLoad, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, firmwareStorageHigh=firmwareStorageHigh, httpSrvrInBytes=httpSrvrInBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitPort=ipsReqLimitPort, serviceStatus=serviceStatus, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, cpuTemperature=cpuTemperature, bwsMessage=bwsMessage, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, activeServers=activeServers, serverDown=serverDown, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsCookieSecTampered=ipsCookieSecTampered, webCacheBytesOut=webCacheBytesOut, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCachePort=webCachePort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyInBytes=sslProxyInBytes, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, logStorage=logStorage, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, linkStatus=linkStatus, ipsRCTotDropped=ipsRCTotDropped, tempCritical=tempCritical, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCacheAddress=webCacheAddress, httpProxyActiveConn=httpProxyActiveConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyActiveConn=sslProxyActiveConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, totalMem=totalMem, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, peerDown=peerDown, memUtilization=memUtilization, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrAddress=httpSrvrAddress, sslSrvrAddress=sslSrvrAddress)
