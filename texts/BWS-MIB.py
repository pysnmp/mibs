...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, iso, IpAddress, Counter32, Unsigned32, Gauge32, ModuleIdentity, ObjectIdentity, TimeTicks, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "iso", "IpAddress", "Counter32", "Unsigned32", "Gauge32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, fanDead=fanDead, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, systemFanSpeed=systemFanSpeed, dataPortLinkUp=dataPortLinkUp, uptime=uptime, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheBytesOut=webCacheBytesOut, linkStatus=linkStatus, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrAddressType=sslSrvrAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheMiss=webCacheMiss, peerDown=peerDown, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrMaxResTime=httpSrvrMaxResTime, memoryUsageHigh=memoryUsageHigh, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, serverUp=serverUp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, totalServers=totalServers, ipsReqLimitAddress=ipsReqLimitAddress, systemLoad=systemLoad, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitPort=ipsReqLimitPort, serviceStatus=serviceStatus, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, cpuUtilization=cpuUtilization, serviceName=serviceName, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, operationalMode=operationalMode, dataPortLinkDown=dataPortLinkDown, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsStats=bwsStats, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyBadCRLErr=sslProxyBadCRLErr, virusDefUpdates=virusDefUpdates, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyInBytes=sslProxyInBytes, httpSrvrAvgResTime=httpSrvrAvgResTime, bwstraps=bwstraps, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcAddress=ipsLrnSrvcAddress, freeMem=freeMem, ipsRCTotServed=ipsRCTotServed, raidDegrading=raidDegrading, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprProtocol=webCmprProtocol, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyTotalReq=sslProxyTotalReq, bwsMIBConformance=bwsMIBConformance, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, activeApplications=activeApplications, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, systemFailOver=systemFailOver, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyPort=sslProxyPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCacheStale=webCacheStale, webCmprPort=webCmprPort, logStorageHigh=logStorageHigh, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyTotalReq=httpProxyTotalReq, ipsRCAddress=ipsRCAddress, smNumUserSessions=smNumUserSessions, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsMIBCompliance=bwsMIBCompliance, sslProxyErrPms=sslProxyErrPms, sslSrvrAddress=sslSrvrAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrTotResponse=sslSrvrTotResponse, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyOutBytes=sslProxyOutBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlNormPort=ipsUrlNormPort, firmwareStorage=firmwareStorage, serviceAddress=serviceAddress, serverDown=serverDown, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyAddress=httpProxyAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyActiveConn=httpProxyActiveConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheAddressType=webCacheAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheCacheableRes=webCacheCacheableRes, httpProxyParseErr=httpProxyParseErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrTotRefused=sslSrvrTotRefused, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecPort=ipsCookieSecPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, cpuTemperature=cpuTemperature, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrTotRefused=httpSrvrTotRefused, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, smRealmName=smRealmName, highAvailabilityStatus=highAvailabilityStatus, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecTampered=ipsCookieSecTampered, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumConn=httpSrvrNumConn, tempHigh=tempHigh, totalApplications=totalApplications, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, activeServers=activeServers, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyServerAbrt=httpProxyServerAbrt, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyServerErr=httpProxyServerErr, webCacheAddress=webCacheAddress, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsMIBGroups=bwsMIBGroups, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, energizeUpdateExpire=energizeUpdateExpire, bws=bws, ipsHdrAclHits=ipsHdrAclHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsMIBCompliances=bwsMIBCompliances, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrPort=sslSrvrPort, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCAddressType=ipsRCAddressType, httpProxyPort=httpProxyPort, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrOutBytes=sslSrvrOutBytes, memUtilization=memUtilization, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprCompressedDataSize=webCmprCompressedDataSize, vipStatus=vipStatus, webCmprAddressType=webCmprAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyAddressType=httpProxyAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrAvgResTime=sslSrvrAvgResTime, webCachePort=webCachePort, sslSrvrNumConn=sslSrvrNumConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, systemSerialNumber=systemSerialNumber, currentFirmwareVersion=currentFirmwareVersion, httpSrvrState=httpSrvrState, sslProxyTotalConn=sslProxyTotalConn, httpSrvrAddressType=httpSrvrAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, PYSNMP_MODULE_ID=bws, webCacheHits=webCacheHits, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, peerUp=peerUp, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, securityDefUpdates=securityDefUpdates, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrTotResponse=httpSrvrTotResponse, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrState=sslSrvrState, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrAddress=httpSrvrAddress, switchingToBypassMode=switchingToBypassMode, dataPathStatus=dataPathStatus, sslSrvrMinResTime=sslSrvrMinResTime)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclPort=ipsUrlAclPort, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, switchingToMaintMode=switchingToMaintMode, logStorage=logStorage, bwsCompressionStatsTable=bwsCompressionStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyOutBytes=httpProxyOutBytes, ipsRCTotDropped=ipsRCTotDropped, processCountHigh=processCountHigh, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheReq=webCacheReq, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsMessage=bwsMessage, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyServerReq=httpProxyServerReq, totalAttacks=totalAttacks, totalBandwidth=totalBandwidth, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyAddress=sslProxyAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrOutBytes=httpSrvrOutBytes, webCacheProtocol=webCacheProtocol, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrPort=httpSrvrPort, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyTotalConn=httpProxyTotalConn, totalMem=totalMem, webCmprCompressibleDataSize=webCmprCompressibleDataSize, servicePort=servicePort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCPort=ipsRCPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyUnknownRsp=httpProxyUnknownRsp, systemFailure=systemFailure, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, srvcName=srvcName, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, bwsStatsGroup=bwsStatsGroup, ipsRCTotQueued=ipsRCTotQueued, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCacheLongHdrs=webCacheLongHdrs, smAgentName=smAgentName, sslProxyAddressType=sslProxyAddressType, tempCritical=tempCritical, firmwareStorageHigh=firmwareStorageHigh, webCmprAddress=webCmprAddress, sslSrvrTotTimedout=sslSrvrTotTimedout)
