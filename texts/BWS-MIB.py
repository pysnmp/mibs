...
TimeTicks, Counter64, ModuleIdentity, iso, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Unsigned32, NotificationType, Bits, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "ModuleIdentity", "iso", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Unsigned32", "NotificationType", "Bits", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", memUtilization=memUtilization, httpSrvrOutBytes=httpSrvrOutBytes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, servicePort=servicePort, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyPort=sslProxyPort, bwstraps=bwstraps, logStorageHigh=logStorageHigh, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrInBytes=sslSrvrInBytes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyTotalReq=sslProxyTotalReq, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrTotReqActive=sslSrvrTotReqActive, switchingToInlineMode=switchingToInlineMode, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyAddressType=sslProxyAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecPort=ipsCookieSecPort, securityDefUpdates=securityDefUpdates, httpSrvrState=httpSrvrState, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyAddress=httpProxyAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCTotDropped=ipsRCTotDropped, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrTotResponse=httpSrvrTotResponse, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCachePort=webCachePort, ipsRCTimeStamp=ipsRCTimeStamp, logStorage=logStorage, bwsStats=bwsStats, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, currentFirmwareVersion=currentFirmwareVersion, linkStatus=linkStatus, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrState=sslSrvrState, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyInBytes=sslProxyInBytes, httpProxyParseErr=httpProxyParseErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, vipStatus=vipStatus, ipsReqLimitPort=ipsReqLimitPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCacheMiss=webCacheMiss, webCacheBytesOut=webCacheBytesOut, sslSrvrNumFreeConn=sslSrvrNumFreeConn, cpuTemperature=cpuTemperature, webCacheCacheableRes=webCacheCacheableRes, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyServerReq=httpProxyServerReq, dataPortLinkUp=dataPortLinkUp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, switchingToBypassMode=switchingToBypassMode, ipsUrlNormAddressType=ipsUrlNormAddressType, memoryUsageHigh=memoryUsageHigh, webCmprProtocol=webCmprProtocol, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, virusDefUpdates=virusDefUpdates, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsMIBCompliance=bwsMIBCompliance, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCacheProtocol=webCacheProtocol, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyServerAbrt=httpProxyServerAbrt, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsRCAddress=ipsRCAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrAddress=httpSrvrAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrAddress=sslSrvrAddress, systemSerialNumber=systemSerialNumber, bwsCacheStatsTable=bwsCacheStatsTable, totalApplications=totalApplications, serviceName=serviceName, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, systemFailure=systemFailure, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlNormPort=ipsUrlNormPort, ipsRCTotServed=ipsRCTotServed, httpProxyAddressType=httpProxyAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumConn=httpSrvrNumConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, totalBandwidth=totalBandwidth, bwsTrapGroup=bwsTrapGroup, webCacheHits=webCacheHits, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyActiveConn=httpProxyActiveConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, tempCritical=tempCritical, sslSrvrPort=sslSrvrPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrAddressType=httpSrvrAddressType, bwsStatsGroup=bwsStatsGroup, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlAclAddressType=ipsUrlAclAddressType, bws=bws, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyUnknownRsp=httpProxyUnknownRsp, highAvailabilityStatus=highAvailabilityStatus, smAgentName=smAgentName, httpProxyOutBytes=httpProxyOutBytes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsRCAddressType=ipsRCAddressType, cpuFanSpeed=cpuFanSpeed, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsMIBCompliances=bwsMIBCompliances, httpProxyTotalConn=httpProxyTotalConn, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyServerErr=httpProxyServerErr, ipsRCPort=ipsRCPort, peerDown=peerDown, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyCacheHits=sslProxyCacheHits, PYSNMP_MODULE_ID=bws, tempHigh=tempHigh, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheAddress=webCacheAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyPort=httpProxyPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyOutBytes=sslProxyOutBytes, bwsMIBGroups=bwsMIBGroups, energizeUpdateExpire=energizeUpdateExpire, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyErrPms=sslProxyErrPms, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrInBytes=httpSrvrInBytes, srvcName=srvcName, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, firmwareStorageHigh=firmwareStorageHigh, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, serverUp=serverUp, sslProxyFullHandshakes=sslProxyFullHandshakes, switchingToMaintMode=switchingToMaintMode, operationalMode=operationalMode, serviceStatus=serviceStatus, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyActiveConn=sslProxyActiveConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, totalServers=totalServers, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, freeMem=freeMem, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCacheStale=webCacheStale, systemFailOver=systemFailOver, httpProxyTotalReq=httpProxyTotalReq, smNumUserSessions=smNumUserSessions, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclPort=ipsUrlAclPort, activeServers=activeServers, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclReserved=ipsUrlAclReserved, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, fanDead=fanDead, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, cpuUtilization=cpuUtilization, sslSrvrMinResTime=sslSrvrMinResTime, bwsServiceStatusTable=bwsServiceStatusTable, dataPortLinkDown=dataPortLinkDown)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrPort=httpSrvrPort, ipsUrlPolicyPort=ipsUrlPolicyPort, totalMem=totalMem, sslProxyAddress=sslProxyAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, systemFanSpeed=systemFanSpeed, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCacheLongHdrs=webCacheLongHdrs, webCmprPort=webCmprPort, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsHdrAclHits=ipsHdrAclHits, serviceAddress=serviceAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrAddressType=sslSrvrAddressType, peerUp=peerUp, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, activeApplications=activeApplications, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, uptime=uptime, httpProxyClientAbrt=httpProxyClientAbrt, systemLoad=systemLoad, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsMessage=bwsMessage, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransAddress=ipsWebAddrTransAddress, smRealmName=smRealmName, webCacheReq=webCacheReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, processCountHigh=processCountHigh, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, raidDegrading=raidDegrading, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsMIBConformance=bwsMIBConformance, webCmprAddress=webCmprAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, firmwareStorage=firmwareStorage, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, webCacheCachedObjects=webCacheCachedObjects, sslProxyTotalConn=sslProxyTotalConn, webCacheAddressType=webCacheAddressType, webCmprAddressType=webCmprAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, totalAttacks=totalAttacks, httpProxyInBytes=httpProxyInBytes, sslSrvrMaxResTime=sslSrvrMaxResTime, dataPathStatus=dataPathStatus, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, serverDown=serverDown)
