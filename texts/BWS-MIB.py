...
iso, Integer32, TimeTicks, Gauge32, Bits, ObjectIdentity, Counter64, ModuleIdentity, Counter32, Unsigned32, NotificationType, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "TimeTicks", "Gauge32", "Bits", "ObjectIdentity", "Counter64", "ModuleIdentity", "Counter32", "Unsigned32", "NotificationType", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", totalApplications=totalApplications, httpProxyInBytes=httpProxyInBytes, sslSrvrPort=sslSrvrPort, systemLoad=systemLoad, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, memUtilization=memUtilization, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCAddressType=ipsRCAddressType, firmwareStorage=firmwareStorage, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsStats=bwsStats, ipsUrlNormAddress=ipsUrlNormAddress, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, virusDefUpdates=virusDefUpdates, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCacheLongHdrs=webCacheLongHdrs, activeServers=activeServers, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyAddressType=httpProxyAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyActiveConn=sslProxyActiveConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, smAgentName=smAgentName, sslProxyPort=sslProxyPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrSrvcPort=sslSrvrSrvcPort, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrAddressType=sslSrvrAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsTrapGroup=bwsTrapGroup, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, uptime=uptime, webCachePort=webCachePort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, systemFailure=systemFailure, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCmprProtocol=webCmprProtocol, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyServerErr=httpProxyServerErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, logStorageHigh=logStorageHigh, httpProxyTotalReq=httpProxyTotalReq, serverUp=serverUp, operationalMode=operationalMode, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCAddress=ipsRCAddress, sslProxyCacheMiss=sslProxyCacheMiss, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, PYSNMP_MODULE_ID=bws, httpSrvrState=httpSrvrState, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsStatsGroup=bwsStatsGroup, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheReq=webCacheReq, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, serviceStatus=serviceStatus, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsWebAddrTransPort=ipsWebAddrTransPort, cpuFanSpeed=cpuFanSpeed, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrOutBytes=httpSrvrOutBytes, webCacheAddressType=webCacheAddressType, totalBandwidth=totalBandwidth, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCacheCacheableRes=webCacheCacheableRes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, switchingToInlineMode=switchingToInlineMode, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqLimitPort=ipsReqLimitPort, securityDefUpdates=securityDefUpdates, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyOutBytes=sslProxyOutBytes, webCmprAddress=webCmprAddress, webCacheMiss=webCacheMiss, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, logStorage=logStorage, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyOutBytes=httpProxyOutBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, dataPortLinkDown=dataPortLinkDown, sslProxyErrPms=sslProxyErrPms, sslProxyInBytes=sslProxyInBytes, ipsRCTotOutOfResource=ipsRCTotOutOfResource, fanDead=fanDead, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bws=bws, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, systemSerialNumber=systemSerialNumber, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, peerDown=peerDown, sslProxyTotalReq=sslProxyTotalReq, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, cpuUtilization=cpuUtilization, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprPort=webCmprPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCTimeStamp=ipsRCTimeStamp, totalMem=totalMem, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, energizeUpdateExpire=energizeUpdateExpire, bwsMessage=bwsMessage, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, smRealmName=smRealmName, linkStatus=linkStatus, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrNumConn=sslSrvrNumConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheAddress=webCacheAddress, webCacheProtocol=webCacheProtocol, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, raidDegrading=raidDegrading, httpSrvrAddressType=httpSrvrAddressType, sslProxyTotalConn=sslProxyTotalConn, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, firmwareStorageHigh=firmwareStorageHigh, httpProxyServerReq=httpProxyServerReq, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotTimedout=sslSrvrTotTimedout, serverDown=serverDown, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyTotalConn=httpProxyTotalConn, httpProxyAddress=httpProxyAddress, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, memoryUsageHigh=memoryUsageHigh, httpProxyParseErr=httpProxyParseErr, dataPortLinkUp=dataPortLinkUp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, switchingToBypassMode=switchingToBypassMode, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsMIBCompliance=bwsMIBCompliance, ipsCookieSecTampered=ipsCookieSecTampered, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyAddressType=sslProxyAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCTotServed=ipsRCTotServed, bwstraps=bwstraps, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrInBytes=httpSrvrInBytes, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsRCTotDropped=ipsRCTotDropped, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlAclReserved=ipsUrlAclReserved, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyCacheHits=sslProxyCacheHits, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlAclPort=ipsUrlAclPort, sslProxyBadCRLErr=sslProxyBadCRLErr, serviceName=serviceName, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyAddress=sslProxyAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsMIBGroups=bwsMIBGroups, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCPort=ipsRCPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheHits=webCacheHits)
mibBuilder.exportSymbols("BWS-MIB", currentFirmwareVersion=currentFirmwareVersion, webCmprAddressType=webCmprAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecPort=ipsCookieSecPort, srvcName=srvcName, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsMIBConformance=bwsMIBConformance, serviceAddress=serviceAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyCurrentConn=sslProxyCurrentConn, vipStatus=vipStatus, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrAddress=httpSrvrAddress, systemFanSpeed=systemFanSpeed, dataPathStatus=dataPathStatus, systemFailOver=systemFailOver, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsHdrAclHits=ipsHdrAclHits, freeMem=freeMem, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, processCountHigh=processCountHigh, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, totalServers=totalServers, tempHigh=tempHigh, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, peerUp=peerUp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, totalAttacks=totalAttacks, activeApplications=activeApplications, switchingToMaintMode=switchingToMaintMode, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrAddress=sslSrvrAddress, httpProxyPort=httpProxyPort, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrState=sslSrvrState, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyActiveConn=httpProxyActiveConn, cpuTemperature=cpuTemperature, bwsServiceStatusTable=bwsServiceStatusTable, tempCritical=tempCritical, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCacheStale=webCacheStale, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrPort=httpSrvrPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, servicePort=servicePort, httpSrvrTotRefused=httpSrvrTotRefused)
