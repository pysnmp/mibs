...
iso, IpAddress, Counter32, Counter64, MibIdentifier, Integer32, NotificationType, ModuleIdentity, TimeTicks, Unsigned32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter32", "Counter64", "MibIdentifier", "Integer32", "NotificationType", "ModuleIdentity", "TimeTicks", "Unsigned32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyPort=httpProxyPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, tempHigh=tempHigh, totalServers=totalServers, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitPort=ipsReqLimitPort, sslSrvrAddress=sslSrvrAddress, sslProxyOutBytes=sslProxyOutBytes, PYSNMP_MODULE_ID=bws, bwsMIBCompliance=bwsMIBCompliance, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, activeApplications=activeApplications, httpSrvrAddress=httpSrvrAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrState=sslSrvrState, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, srvcName=srvcName, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, operationalMode=operationalMode, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, smAgentName=smAgentName, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyInBytes=sslProxyInBytes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, serviceStatus=serviceStatus, webCacheHits=webCacheHits, ipsRCAddress=ipsRCAddress, webCmprAddressType=webCmprAddressType, httpSrvrInBytes=httpSrvrInBytes, httpSrvrNumConn=httpSrvrNumConn, totalApplications=totalApplications, logStorage=logStorage, httpProxyInBytes=httpProxyInBytes, dataPathStatus=dataPathStatus, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheAddress=webCacheAddress, sslProxyAddress=sslProxyAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, smNumUserSessions=smNumUserSessions, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, processCountHigh=processCountHigh, sslProxyCurrentConn=sslProxyCurrentConn, ipsHdrAclHits=ipsHdrAclHits, cpuFanSpeed=cpuFanSpeed, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrAddressType=sslSrvrAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecAddress=ipsCookieSecAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrPort=httpSrvrPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, dataPortLinkDown=dataPortLinkDown, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsRCAddressType=ipsRCAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyPort=sslProxyPort, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyAddress=httpProxyAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsMessage=bwsMessage, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, systemFailure=systemFailure, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrInBytes=sslSrvrInBytes, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyAddressType=httpProxyAddressType, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrOutBytes=httpSrvrOutBytes, systemFailOver=systemFailOver, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrAvgResTime=httpSrvrAvgResTime, webCachePort=webCachePort, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsRCTotServed=ipsRCTotServed, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, cpuUtilization=cpuUtilization, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecPort=ipsCookieSecPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, firmwareStorage=firmwareStorage, totalBandwidth=totalBandwidth, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCacheCachedObjects=webCacheCachedObjects, firmwareStorageHigh=firmwareStorageHigh, webCmprPort=webCmprPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, systemSerialNumber=systemSerialNumber, sslSrvrTotRefused=sslSrvrTotRefused, serviceAddress=serviceAddress, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyErrPms=sslProxyErrPms, ipsUrlNormAddress=ipsUrlNormAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrSrvcPort=httpSrvrSrvcPort, webCacheStale=webCacheStale, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCmprAddress=webCmprAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, freeMem=freeMem, httpSrvrState=httpSrvrState, webCacheReq=webCacheReq, httpProxySessionTimeOut=httpProxySessionTimeOut, systemFanSpeed=systemFanSpeed, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsRCTotDropped=ipsRCTotDropped, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrAddressType=httpSrvrAddressType, ipsHdrAclPort=ipsHdrAclPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheProtocol=webCacheProtocol, serverUp=serverUp, systemLoad=systemLoad, serverDown=serverDown, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, peerUp=peerUp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsRCPort=ipsRCPort, ipsRCTotQueued=ipsRCTotQueued, memoryUsageHigh=memoryUsageHigh, peerDown=peerDown, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMIBCompliances=bwsMIBCompliances, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, cpuTemperature=cpuTemperature, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, virusDefUpdates=virusDefUpdates, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheMiss=webCacheMiss, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyAddressType=sslProxyAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsStatsGroup=bwsStatsGroup, totalMem=totalMem, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyTotalConn=httpProxyTotalConn, ipsRCTimeStamp=ipsRCTimeStamp, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsStats=bwsStats, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsTrapGroup=bwsTrapGroup, bws=bws, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotRefused=httpSrvrTotRefused, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyServerErr=httpProxyServerErr, raidDegrading=raidDegrading, uptime=uptime, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheAddressType=webCacheAddressType)
mibBuilder.exportSymbols("BWS-MIB", securityDefUpdates=securityDefUpdates, servicePort=servicePort, webCacheCacheableRes=webCacheCacheableRes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, fanDead=fanDead, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyServerAbrt=httpProxyServerAbrt, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, switchingToMaintMode=switchingToMaintMode, bwsMIBConformance=bwsMIBConformance, serviceName=serviceName, logStorageHigh=logStorageHigh, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, switchingToInlineMode=switchingToInlineMode, httpSrvrTotReqActive=httpSrvrTotReqActive, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, dataPortLinkUp=dataPortLinkUp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, memUtilization=memUtilization, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, totalAttacks=totalAttacks, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, smRealmName=smRealmName, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, bwstraps=bwstraps, webCacheBytesOut=webCacheBytesOut, httpProxyOutBytes=httpProxyOutBytes, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyServerReq=httpProxyServerReq, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrAvgResTime=sslSrvrAvgResTime, linkStatus=linkStatus, httpProxyActiveConn=httpProxyActiveConn, activeServers=activeServers, sslSrvrPort=sslSrvrPort, httpSrvrMaxResTime=httpSrvrMaxResTime, tempCritical=tempCritical, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyTotalReq=sslProxyTotalReq, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCacheLongHdrs=webCacheLongHdrs, vipStatus=vipStatus, sslProxyCacheHits=sslProxyCacheHits, webCmprProtocol=webCmprProtocol)
