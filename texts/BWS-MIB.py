...
Counter32, Counter64, NotificationType, iso, ObjectIdentity, Unsigned32, MibIdentifier, TimeTicks, ModuleIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrAddress=sslSrvrAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheProtocol=webCacheProtocol, switchingToInlineMode=switchingToInlineMode, sslProxyCacheHits=sslProxyCacheHits, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrState=sslSrvrState, httpSrvrSrvcAddress=httpSrvrSrvcAddress, energizeUpdateExpire=energizeUpdateExpire, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, totalBandwidth=totalBandwidth, webCacheCacheableRes=webCacheCacheableRes, securityDefUpdates=securityDefUpdates, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCAddressType=ipsRCAddressType, tempCritical=tempCritical, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, totalMem=totalMem, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlAclPort=ipsUrlAclPort, sslProxyPort=sslProxyPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, serviceAddress=serviceAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCPort=ipsRCPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyParseErr=httpProxyParseErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, firmwareStorage=firmwareStorage, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrNumConn=sslSrvrNumConn, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrInBytes=httpSrvrInBytes, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyInBytes=sslProxyInBytes, ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, uptime=uptime, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrTotRefused=sslSrvrTotRefused, webCacheBytesOut=webCacheBytesOut, webCmprAddress=webCmprAddress, totalServers=totalServers, sslSrvrPort=sslSrvrPort, dataPortLinkDown=dataPortLinkDown, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrMinResTime=sslSrvrMinResTime, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsTrapGroup=bwsTrapGroup, peerDown=peerDown, dataPortLinkUp=dataPortLinkUp, httpSrvrAvgResTime=httpSrvrAvgResTime, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, vipStatus=vipStatus, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrPort=httpSrvrPort, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsSMUserSessionEntry=bwsSMUserSessionEntry, switchingToBypassMode=switchingToBypassMode, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqSrvcPort=ipsReqSrvcPort, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheHits=webCacheHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCAddress=ipsRCAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, servicePort=servicePort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, systemSerialNumber=systemSerialNumber, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsHdrAclAddress=ipsHdrAclAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, totalAttacks=totalAttacks, freeMem=freeMem, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, systemLoad=systemLoad, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsStats=bwsStats, httpProxyPort=httpProxyPort, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, smAgentName=smAgentName, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrNumConn=httpSrvrNumConn, totalApplications=totalApplications, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrAvgResTime=sslSrvrAvgResTime, smRealmName=smRealmName, tempHigh=tempHigh, bwsCompressionStatsTable=bwsCompressionStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, serviceStatus=serviceStatus, operationalMode=operationalMode, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyOutBytes=httpProxyOutBytes, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyInBytes=httpProxyInBytes, serviceName=serviceName, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrAddress=httpSrvrAddress, highAvailabilityStatus=highAvailabilityStatus, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCacheMiss=webCacheMiss, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyActiveConn=httpProxyActiveConn, sslProxyOutBytes=sslProxyOutBytes, activeServers=activeServers, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, cpuTemperature=cpuTemperature, bwsStatsGroup=bwsStatsGroup, bwsIpsRCStatsTable=bwsIpsRCStatsTable, logStorageHigh=logStorageHigh, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCmprProtocol=webCmprProtocol, sslProxyTotalReq=sslProxyTotalReq, processCountHigh=processCountHigh, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyAddressType=sslProxyAddressType, webCacheCachedObjects=webCacheCachedObjects, systemFailure=systemFailure, currentFirmwareVersion=currentFirmwareVersion, httpProxyAddressType=httpProxyAddressType, raidDegrading=raidDegrading, httpProxyTotalConn=httpProxyTotalConn, memUtilization=memUtilization, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyActiveConn=sslProxyActiveConn, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, srvcName=srvcName, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsServiceStatusTable=bwsServiceStatusTable, PYSNMP_MODULE_ID=bws, switchingToMaintMode=switchingToMaintMode, systemFanSpeed=systemFanSpeed, sslProxyAddress=sslProxyAddress, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheStale=webCacheStale, virusDefUpdates=virusDefUpdates, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, fanDead=fanDead, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyTotalConn=sslProxyTotalConn, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bws=bws, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCmprAddressType=webCmprAddressType, webCacheAddressType=webCacheAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyTotalReq=httpProxyTotalReq, smNumUserSessions=smNumUserSessions, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrMaxResTime=httpSrvrMaxResTime, linkStatus=linkStatus, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits)
mibBuilder.exportSymbols("BWS-MIB", httpProxyAddress=httpProxyAddress, httpSrvrAddressType=httpSrvrAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsMIBConformance=bwsMIBConformance, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyErrPms=sslProxyErrPms, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, peerUp=peerUp, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, serverUp=serverUp, sslSrvrAddressType=sslSrvrAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyServerReq=httpProxyServerReq, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrOutBytes=httpSrvrOutBytes, cpuUtilization=cpuUtilization, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsMIBCompliances=bwsMIBCompliances, webCmprPort=webCmprPort, httpProxyServerErr=httpProxyServerErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwstraps=bwstraps, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheAddress=webCacheAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCachePort=webCachePort, webCacheReq=webCacheReq, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, cpuFanSpeed=cpuFanSpeed, firmwareUpdateAvailable=firmwareUpdateAvailable, sharedSecretKeyExpired=sharedSecretKeyExpired, systemFailOver=systemFailOver, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitAddress=ipsReqLimitAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsMIBCompliance=bwsMIBCompliance, logStorage=logStorage, httpSrvrTotReqRejected=httpSrvrTotReqRejected, activeApplications=activeApplications, dataPathStatus=dataPathStatus, bwsMessage=bwsMessage, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, serverDown=serverDown, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrState=httpSrvrState, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlNormPort=ipsUrlNormPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress)
