...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Bits, TimeTicks, ObjectIdentity, Counter64, Counter32, Unsigned32, Gauge32, NotificationType, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Bits", "TimeTicks", "ObjectIdentity", "Counter64", "Counter32", "Unsigned32", "Gauge32", "NotificationType", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyTotalReq=sslProxyTotalReq, totalMem=totalMem, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsHdrAclPort=ipsHdrAclPort, bwsMIBCompliances=bwsMIBCompliances, sslProxyInBytes=sslProxyInBytes, bwsMessage=bwsMessage, httpProxyServerErr=httpProxyServerErr, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheAddress=webCacheAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyPort=httpProxyPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, freeMem=freeMem, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsMIBConformance=bwsMIBConformance, webCacheBytesOut=webCacheBytesOut, sslSrvrInBytes=sslSrvrInBytes, sslProxyAddress=sslProxyAddress, bwstraps=bwstraps, uptime=uptime, firmwareStorage=firmwareStorage, securityDefUpdates=securityDefUpdates, httpSrvrNumFreeConn=httpSrvrNumFreeConn, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, activeServers=activeServers, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, tempCritical=tempCritical, switchingToMaintMode=switchingToMaintMode, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyAddressType=httpProxyAddressType, virusDefUpdates=virusDefUpdates, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, dataPortLinkDown=dataPortLinkDown, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlAclPort=ipsUrlAclPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, serviceName=serviceName, webCacheLongHdrs=webCacheLongHdrs, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrState=sslSrvrState, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheProtocol=webCacheProtocol, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheCacheableRes=webCacheCacheableRes, serviceStatus=serviceStatus, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyTotalConn=httpProxyTotalConn, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsServiceStatusEntry=bwsServiceStatusEntry, energizeUpdateExpire=energizeUpdateExpire, httpSrvrAddressType=httpSrvrAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCachePort=webCachePort, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, systemFanSpeed=systemFanSpeed, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyOutBytes=sslProxyOutBytes, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyServerReq=httpProxyServerReq, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCmprPort=webCmprPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, highAvailabilityStatus=highAvailabilityStatus, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, cpuFanSpeed=cpuFanSpeed, serverDown=serverDown, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, totalAttacks=totalAttacks, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, logStorageHigh=logStorageHigh, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsCookieSecPort=ipsCookieSecPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsTrapGroup=bwsTrapGroup, cpuTemperature=cpuTemperature, webCacheReq=webCacheReq, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsRCAddress=ipsRCAddress, httpProxyParseErr=httpProxyParseErr, memUtilization=memUtilization, sslProxyPort=sslProxyPort, peerDown=peerDown, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrPort=httpSrvrPort, serviceAddress=serviceAddress, PYSNMP_MODULE_ID=bws, ipsReqLimitPort=ipsReqLimitPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, raidDegrading=raidDegrading, dataPathStatus=dataPathStatus, systemLoad=systemLoad, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, activeApplications=activeApplications, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, smNumUserSessions=smNumUserSessions, sslProxyAddressType=sslProxyAddressType, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrNumConn=sslSrvrNumConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, smAgentName=smAgentName, webCmprAddress=webCmprAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlAclReserved=ipsUrlAclReserved, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrState=httpSrvrState, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyClientAbrt=httpProxyClientAbrt, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, processCountHigh=processCountHigh, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclAddress=ipsUrlAclAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, srvcName=srvcName, logStorage=logStorage, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsCompressionStatsTable=bwsCompressionStatsTable, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsRCTotServed=ipsRCTotServed, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCTotQueued=ipsRCTotQueued, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, tempHigh=tempHigh, bws=bws, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrTotRefused=sslSrvrTotRefused, peerUp=peerUp, ipsWebAddrTransPort=ipsWebAddrTransPort, vipStatus=vipStatus, webCacheMiss=webCacheMiss, ipsCookieSecEncrypted=ipsCookieSecEncrypted, fanDead=fanDead, linkStatus=linkStatus, httpSrvrNumConn=httpSrvrNumConn, sslProxyTotalConn=sslProxyTotalConn, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrAddress=httpSrvrAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCurrentConn=sslProxyCurrentConn, servicePort=servicePort, webCacheAddressType=webCacheAddressType, totalServers=totalServers, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheStale=webCacheStale, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemSerialNumber=systemSerialNumber, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrPort=sslSrvrPort, bwsServiceStatusTable=bwsServiceStatusTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsRCTotDropped=ipsRCTotDropped, bwsMIBGroups=bwsMIBGroups, currentFirmwareVersion=currentFirmwareVersion, httpSrvrInBytes=httpSrvrInBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyErrPms=sslProxyErrPms, operationalMode=operationalMode, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCacheHits=webCacheHits, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrTotResponse=httpSrvrTotResponse)
mibBuilder.exportSymbols("BWS-MIB", systemFailure=systemFailure, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlNormPort=ipsUrlNormPort, bwsStats=bwsStats, dataPortLinkUp=dataPortLinkUp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, smRealmName=smRealmName, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, switchingToBypassMode=switchingToBypassMode, httpProxyInBytes=httpProxyInBytes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, totalApplications=totalApplications, bwsStatsGroup=bwsStatsGroup, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyOutBytes=httpProxyOutBytes, cpuUtilization=cpuUtilization, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsRCPort=ipsRCPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyActiveConn=sslProxyActiveConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCmprProtocol=webCmprProtocol, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, totalBandwidth=totalBandwidth, ipsHdrAclHits=ipsHdrAclHits, sslSrvrAddressType=sslSrvrAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyAddress=httpProxyAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, serverUp=serverUp, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, systemFailOver=systemFailOver, firmwareStorageHigh=firmwareStorageHigh, webCmprAddressType=webCmprAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsRCAddressType=ipsRCAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToInlineMode=switchingToInlineMode, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry)
