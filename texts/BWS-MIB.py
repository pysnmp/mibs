...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, NotificationType, ModuleIdentity, Gauge32, Bits, Unsigned32, Counter64, iso, Integer32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Gauge32", "Bits", "Unsigned32", "Counter64", "iso", "Integer32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, peerUp=peerUp, httpSrvrAvgResTime=httpSrvrAvgResTime, linkStatus=linkStatus, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheCachedObjects=webCacheCachedObjects, smRealmName=smRealmName, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecAddress=ipsCookieSecAddress, raidDegrading=raidDegrading, dataPathStatus=dataPathStatus, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, securityDefUpdates=securityDefUpdates, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyTotalReq=sslProxyTotalReq, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlAclAddressType=ipsUrlAclAddressType, dataPortLinkUp=dataPortLinkUp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, totalMem=totalMem, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsCompressionStatsTable=bwsCompressionStatsTable, memUtilization=memUtilization, webCacheBytesOut=webCacheBytesOut, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrPort=httpSrvrPort, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, cpuUtilization=cpuUtilization, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyCacheMiss=sslProxyCacheMiss, webCacheLongHdrs=webCacheLongHdrs, ipsRCPort=ipsRCPort, ipsReqSrvcAddress=ipsReqSrvcAddress, sslProxyCacheHits=sslProxyCacheHits, ipsUrlAclReserved=ipsUrlAclReserved, cpuTemperature=cpuTemperature, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, memoryUsageHigh=memoryUsageHigh, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsServiceStatusTable=bwsServiceStatusTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyAddress=httpProxyAddress, sslSrvrNumConn=sslSrvrNumConn, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyOutBytes=sslProxyOutBytes, httpSrvrMinResTime=httpSrvrMinResTime, serverDown=serverDown, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrPort=sslSrvrPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyAddressType=httpProxyAddressType, ipsReqLimitPort=ipsReqLimitPort, httpProxyTotalConn=httpProxyTotalConn, logStorage=logStorage, uptime=uptime, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, switchingToMaintMode=switchingToMaintMode, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCAddressType=ipsRCAddressType, bwsMessage=bwsMessage, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyServerAbrt=httpProxyServerAbrt, operationalMode=operationalMode, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyAddress=sslProxyAddress, systemFailOver=systemFailOver, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyTotalConn=sslProxyTotalConn, webCmprPort=webCmprPort, sslProxyCurrentConn=sslProxyCurrentConn, dataPortLinkDown=dataPortLinkDown, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsTrapGroup=bwsTrapGroup, tempHigh=tempHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, srvcName=srvcName, sslProxyErrPms=sslProxyErrPms, ipsHdrAclPort=ipsHdrAclPort, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrAddress=sslSrvrAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, currentFirmwareVersion=currentFirmwareVersion, ipsRCTotQueued=ipsRCTotQueued, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, switchingToBypassMode=switchingToBypassMode, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrAddressType=sslSrvrAddressType, bwstraps=bwstraps, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsRCAddress=ipsRCAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, totalAttacks=totalAttacks, httpSrvrAddressType=httpSrvrAddressType, systemFailure=systemFailure, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, webCmprAddress=webCmprAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, servicePort=servicePort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheCacheableRes=webCacheCacheableRes, bwsMIBCompliances=bwsMIBCompliances, highAvailabilityStatus=highAvailabilityStatus, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bws=bws, totalApplications=totalApplications, serviceStatus=serviceStatus, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrNumConn=httpSrvrNumConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrTotResponse=sslSrvrTotResponse, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, switchingToInlineMode=switchingToInlineMode, virusDefUpdates=virusDefUpdates, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsMIBConformance=bwsMIBConformance, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyAddressType=sslProxyAddressType, bwsMIBCompliance=bwsMIBCompliance, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, systemFanSpeed=systemFanSpeed, ipsRCTotDropped=ipsRCTotDropped, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyPort=sslProxyPort, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, fanDead=fanDead, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, firmwareStorage=firmwareStorage, systemSerialNumber=systemSerialNumber, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, processCountHigh=processCountHigh, firmwareStorageHigh=firmwareStorageHigh, webCmprAddressType=webCmprAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheAddress=webCacheAddress, httpProxyInBytes=httpProxyInBytes, logStorageHigh=logStorageHigh, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheHits=webCacheHits, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrState=httpSrvrState, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyOutBytes=httpProxyOutBytes, httpSrvrInBytes=httpSrvrInBytes, webCacheAddressType=webCacheAddressType, ipsHdrAclHits=ipsHdrAclHits, totalServers=totalServers, webCachePort=webCachePort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyPort=httpProxyPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyParseErr=httpProxyParseErr, PYSNMP_MODULE_ID=bws, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, freeMem=freeMem, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, cpuFanSpeed=cpuFanSpeed)
mibBuilder.exportSymbols("BWS-MIB", newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMIBGroups=bwsMIBGroups, activeApplications=activeApplications, webCacheStale=webCacheStale, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCacheProtocol=webCacheProtocol, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, energizeUpdateExpire=energizeUpdateExpire, peerDown=peerDown, bwsStats=bwsStats, sslProxyActiveConn=sslProxyActiveConn, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyServerReq=httpProxyServerReq, serviceAddress=serviceAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, smAgentName=smAgentName, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, vipStatus=vipStatus, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheMiss=webCacheMiss, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, serviceName=serviceName, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, smNumUserSessions=smNumUserSessions, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheReq=webCacheReq, httpSrvrTotReqRejected=httpSrvrTotReqRejected, systemLoad=systemLoad, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyServerErr=httpProxyServerErr, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serverUp=serverUp, webCmprProtocol=webCmprProtocol, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormPort=ipsUrlNormPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrInBytes=sslSrvrInBytes, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrState=sslSrvrState, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyInBytes=sslProxyInBytes, httpSrvrAddress=httpSrvrAddress, tempCritical=tempCritical, activeServers=activeServers, totalBandwidth=totalBandwidth, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable)
