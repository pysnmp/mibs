...
Gauge32, ObjectIdentity, Counter64, NotificationType, MibIdentifier, iso, Bits, Integer32, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Counter64", "NotificationType", "MibIdentifier", "iso", "Bits", "Integer32", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, firmwareStorage=firmwareStorage, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrAddress=sslSrvrAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyActiveConn=httpProxyActiveConn, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serviceStatus=serviceStatus, webCmprAddress=webCmprAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyPort=httpProxyPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCacheMiss=webCacheMiss, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCAddress=ipsRCAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, systemFailure=systemFailure, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, cpuFanSpeed=cpuFanSpeed, systemFanSpeed=systemFanSpeed, highAvailabilityStatus=highAvailabilityStatus, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyOutBytes=sslProxyOutBytes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrAddress=httpSrvrAddress, ipsReqSrvcPort=ipsReqSrvcPort, webCachePort=webCachePort, totalMem=totalMem, ipsCookieSecAddressType=ipsCookieSecAddressType, totalServers=totalServers, webCmprProtocol=webCmprProtocol, serverDown=serverDown, httpProxyClientAbrt=httpProxyClientAbrt, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, memoryUsageHigh=memoryUsageHigh, totalBandwidth=totalBandwidth, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheCachedObjects=webCacheCachedObjects, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsStatsGroup=bwsStatsGroup, peerUp=peerUp, ipsRCPort=ipsRCPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCTotQueued=ipsRCTotQueued, httpSrvrNumConn=httpSrvrNumConn, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrAddressType=httpSrvrAddressType, dataPathStatus=dataPathStatus, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, totalApplications=totalApplications, bwsMessage=bwsMessage, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyTotalReq=sslProxyTotalReq, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheCacheableRes=webCacheCacheableRes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, logStorage=logStorage, ipsAccessCtrlPort=ipsAccessCtrlPort, totalAttacks=totalAttacks, webCacheLongHdrs=webCacheLongHdrs, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyServerAbrt=httpProxyServerAbrt, cpuUtilization=cpuUtilization, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, energizeUpdateExpire=energizeUpdateExpire, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrOutBytes=httpSrvrOutBytes, activeApplications=activeApplications, httpSrvrMinResTime=httpSrvrMinResTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serviceAddress=serviceAddress, serviceName=serviceName, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, raidDegrading=raidDegrading, ipsCookieSecPort=ipsCookieSecPort, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCTotOutOfResource=ipsRCTotOutOfResource, memUtilization=memUtilization, bwsCacheStatsTable=bwsCacheStatsTable, freeMem=freeMem, ipsReqLimitPort=ipsReqLimitPort, ipsUrlNormAddress=ipsUrlNormAddress, webCmprAddressType=webCmprAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheStale=webCacheStale, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransAddress=ipsWebAddrTransAddress, switchingToBypassMode=switchingToBypassMode, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyAddressType=httpProxyAddressType, webCacheHits=webCacheHits, ipsRCTotServed=ipsRCTotServed, tempHigh=tempHigh, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrAddressType=sslSrvrAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, servicePort=servicePort, httpProxyParseErr=httpProxyParseErr, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyAddressType=sslProxyAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecAddress=ipsCookieSecAddress, webCmprPort=webCmprPort, serverUp=serverUp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrMinResTime=sslSrvrMinResTime, cpuTemperature=cpuTemperature, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrState=sslSrvrState, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyPort=sslProxyPort, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, peerDown=peerDown, sslSrvrPort=sslSrvrPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyAddress=httpProxyAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyFullHandshakes=sslProxyFullHandshakes, bwstraps=bwstraps, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsTrapGroup=bwsTrapGroup, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyInBytes=sslProxyInBytes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, currentFirmwareVersion=currentFirmwareVersion, sslSrvrTotTimedout=sslSrvrTotTimedout, smNumUserSessions=smNumUserSessions, sslProxyErrPms=sslProxyErrPms, bwsMIBCompliances=bwsMIBCompliances, activeServers=activeServers, ipsUrlNormPort=ipsUrlNormPort, bws=bws, ipsUrlAclPort=ipsUrlAclPort, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, dataPortLinkDown=dataPortLinkDown, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsRCAddressType=ipsRCAddressType, switchingToInlineMode=switchingToInlineMode, httpSrvrPort=httpSrvrPort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsRCTimeStamp=ipsRCTimeStamp, firmwareStorageHigh=firmwareStorageHigh, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, tempCritical=tempCritical, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, logStorageHigh=logStorageHigh, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, processCountHigh=processCountHigh, bwsMIBGroups=bwsMIBGroups, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, virusDefUpdates=virusDefUpdates, webCacheProtocol=webCacheProtocol, ipsCookieSecTampered=ipsCookieSecTampered, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, PYSNMP_MODULE_ID=bws)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, dataPortLinkUp=dataPortLinkUp, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrState=httpSrvrState, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyCacheHits=sslProxyCacheHits, httpProxyServerReq=httpProxyServerReq, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyAddress=sslProxyAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheAddressType=webCacheAddressType, securityDefUpdates=securityDefUpdates, httpProxyTotalConn=httpProxyTotalConn, systemLoad=systemLoad, sslProxyCurrentConn=sslProxyCurrentConn, bwsMIBConformance=bwsMIBConformance, sslProxyCacheMiss=sslProxyCacheMiss, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, srvcName=srvcName, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, vipStatus=vipStatus, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheReq=webCacheReq, httpProxyOutBytes=httpProxyOutBytes, sslProxyActiveConn=sslProxyActiveConn, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrTotTimedout=httpSrvrTotTimedout, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, systemFailOver=systemFailOver, bwsStats=bwsStats, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsHdrAclAddress=ipsHdrAclAddress, smAgentName=smAgentName, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, linkStatus=linkStatus, smRealmName=smRealmName, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, operationalMode=operationalMode, sslSrvrInBytes=sslSrvrInBytes, webCacheAddress=webCacheAddress, uptime=uptime, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, fanDead=fanDead, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyUnknownRsp=httpProxyUnknownRsp, systemSerialNumber=systemSerialNumber, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable)
