...
Counter32, Counter64, iso, Bits, NotificationType, TimeTicks, ObjectIdentity, ModuleIdentity, Unsigned32, Integer32, Gauge32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "iso", "Bits", "NotificationType", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Integer32", "Gauge32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, firmwareStorageHigh=firmwareStorageHigh, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsRCPort=ipsRCPort, firmwareUpdateAvailable=firmwareUpdateAvailable, memUtilization=memUtilization, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsStatsGroup=bwsStatsGroup, ipsHdrAclPort=ipsHdrAclPort, sslProxyOutBytes=sslProxyOutBytes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprAddressType=webCmprAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxyServerErr=httpProxyServerErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, linkStatus=linkStatus, smAgentName=smAgentName, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, peerDown=peerDown, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyUnknownRsp=httpProxyUnknownRsp, freeMem=freeMem, totalMem=totalMem, dataPathStatus=dataPathStatus, httpSrvrPort=httpSrvrPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, serverUp=serverUp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, servicePort=servicePort, bwsMessage=bwsMessage, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsHdrAclAddress=ipsHdrAclAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, totalAttacks=totalAttacks, bwsMIBCompliance=bwsMIBCompliance, bwsStats=bwsStats, fanDead=fanDead, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyPort=sslProxyPort, httpProxyTotalReq=httpProxyTotalReq, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrAddressType=httpSrvrAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, energizeUpdateExpire=energizeUpdateExpire, bwsMIBGroups=bwsMIBGroups, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsRCTotServed=ipsRCTotServed, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsMIBCompliances=bwsMIBCompliances, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, totalBandwidth=totalBandwidth, httpProxyAddressType=httpProxyAddressType, uptime=uptime, sslProxyCurrentConn=sslProxyCurrentConn, bwsServiceStatusTable=bwsServiceStatusTable, webCacheReq=webCacheReq, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, switchingToBypassMode=switchingToBypassMode, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheProtocol=webCacheProtocol, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, switchingToInlineMode=switchingToInlineMode, totalApplications=totalApplications, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyErrPms=sslProxyErrPms, httpSrvrTotReqActive=httpSrvrTotReqActive, operationalMode=operationalMode, sslProxyActiveConn=sslProxyActiveConn, httpProxyParseErr=httpProxyParseErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, systemFailure=systemFailure, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, tempCritical=tempCritical, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrState=httpSrvrState, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, smNumUserSessions=smNumUserSessions, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, dataPortLinkUp=dataPortLinkUp, logStorageHigh=logStorageHigh, serviceName=serviceName, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, memoryUsageHigh=memoryUsageHigh, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, webCmprProtocol=webCmprProtocol, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCachePort=webCachePort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitPort=ipsReqLimitPort, activeApplications=activeApplications, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bws=bws, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, switchingToMaintMode=switchingToMaintMode, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, virusDefUpdates=virusDefUpdates, ipsCookieSecPort=ipsCookieSecPort, ipsRCTotQueued=ipsRCTotQueued, webCacheAddressType=webCacheAddressType, webCacheAddress=webCacheAddress, systemLoad=systemLoad, sslProxyCacheHits=sslProxyCacheHits, smRealmName=smRealmName, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrState=sslSrvrState, httpProxyActiveConn=httpProxyActiveConn, srvcName=srvcName, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrPort=sslSrvrPort, sslProxyCacheMiss=sslProxyCacheMiss, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, activeServers=activeServers, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, totalServers=totalServers, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, cpuFanSpeed=cpuFanSpeed, processCountHigh=processCountHigh, serverDown=serverDown, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheStale=webCacheStale, systemSerialNumber=systemSerialNumber, webCmprAddress=webCmprAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheCachedObjects=webCacheCachedObjects, webCacheHits=webCacheHits, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrInBytes=httpSrvrInBytes, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecTampered=ipsCookieSecTampered, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, dataPortLinkDown=dataPortLinkDown, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, PYSNMP_MODULE_ID=bws, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlNormPort=ipsUrlNormPort, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, systemFanSpeed=systemFanSpeed, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, serviceStatus=serviceStatus, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrAddress=sslSrvrAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, vipStatus=vipStatus, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, raidDegrading=raidDegrading, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheCacheableRes=webCacheCacheableRes, cpuUtilization=cpuUtilization, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheBytesOut=webCacheBytesOut, highAvailabilityStatus=highAvailabilityStatus, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, cpuTemperature=cpuTemperature, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrMinResTime=httpSrvrMinResTime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime)
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyInBytes=httpProxyInBytes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrNumConn=httpSrvrNumConn, sslProxyTotalReq=sslProxyTotalReq, sslProxyAddress=sslProxyAddress, sslSrvrAddressType=sslSrvrAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, securityDefUpdates=securityDefUpdates, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCmprCompressibleDataSize=webCmprCompressibleDataSize, logStorage=logStorage, webCacheMiss=webCacheMiss, systemFailOver=systemFailOver, sslSrvrInBytes=sslSrvrInBytes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyPort=httpProxyPort, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyAddressType=sslProxyAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, firmwareStorage=firmwareStorage, httpProxyAddress=httpProxyAddress, ipsRCAddress=ipsRCAddress, webCmprPort=webCmprPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCAddressType=ipsRCAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwstraps=bwstraps, ipsUrlAclPort=ipsUrlAclPort, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyServerReq=httpProxyServerReq, currentFirmwareVersion=currentFirmwareVersion, peerUp=peerUp, tempHigh=tempHigh, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrNumConn=sslSrvrNumConn, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, serviceAddress=serviceAddress, webCacheLongHdrs=webCacheLongHdrs, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyOutBytes=httpProxyOutBytes, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsRCTotDropped=ipsRCTotDropped, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlPort=ipsAccessCtrlPort)
