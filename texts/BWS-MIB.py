...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, IpAddress, iso, TimeTicks, Gauge32, ObjectIdentity, Integer32, NotificationType, Unsigned32, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "IpAddress", "iso", "TimeTicks", "Gauge32", "ObjectIdentity", "Integer32", "NotificationType", "Unsigned32", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", energizeUpdateExpire=energizeUpdateExpire, bwsMIBCompliances=bwsMIBCompliances, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, securityDefUpdates=securityDefUpdates, serverUp=serverUp, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, cpuTemperature=cpuTemperature, sslProxyAddress=sslProxyAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyServerErr=httpProxyServerErr, systemSerialNumber=systemSerialNumber, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, systemFailure=systemFailure, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, cpuUtilization=cpuUtilization, webCacheBytesOut=webCacheBytesOut, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, fanDead=fanDead, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyAddressType=httpProxyAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCacheStale=webCacheStale, bwsMIBGroups=bwsMIBGroups, httpSrvrAddress=httpSrvrAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, serverDown=serverDown, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemFailOver=systemFailOver, sslSrvrOutBytes=sslSrvrOutBytes, bwsServiceStatusTable=bwsServiceStatusTable, servicePort=servicePort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheMiss=webCacheMiss, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrNumConn=httpSrvrNumConn, serviceAddress=serviceAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrInBytes=sslSrvrInBytes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, linkStatus=linkStatus, sslProxyCacheTimeouts=sslProxyCacheTimeouts, totalServers=totalServers, webCmprAddress=webCmprAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsMessage=bwsMessage, httpProxyInBytes=httpProxyInBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCmprProtocol=webCmprProtocol, ipsRCAddress=ipsRCAddress, firmwareStorageHigh=firmwareStorageHigh, httpSrvrMinResTime=httpSrvrMinResTime, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, dataPathStatus=dataPathStatus, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsMIBConformance=bwsMIBConformance, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyTotalReq=httpProxyTotalReq, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bws=bws, httpSrvrAddressType=httpSrvrAddressType, serviceStatus=serviceStatus, httpProxyServerReq=httpProxyServerReq, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheAddress=webCacheAddress, serviceName=serviceName, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, smAgentName=smAgentName, bwsSMUserSessionEntry=bwsSMUserSessionEntry, switchingToMaintMode=switchingToMaintMode, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsRCTotQueued=ipsRCTotQueued, ipsRCPort=ipsRCPort, dataPortLinkUp=dataPortLinkUp, smRealmName=smRealmName, ipsUrlAclPort=ipsUrlAclPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTotServed=ipsRCTotServed, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, activeApplications=activeApplications, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, processCountHigh=processCountHigh, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, peerDown=peerDown, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyErrPms=sslProxyErrPms, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrTotSuccess=httpSrvrTotSuccess, uptime=uptime, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyPort=httpProxyPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCacheHits=webCacheHits, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlNormAddress=ipsUrlNormAddress, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrState=sslSrvrState, tempCritical=tempCritical, webCacheReq=webCacheReq, sslProxyActiveConn=sslProxyActiveConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqSrvcPort=ipsReqSrvcPort, vipStatus=vipStatus, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsHdrAclPort=ipsHdrAclPort, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheAddressType=webCacheAddressType, httpProxyClientAbrt=httpProxyClientAbrt, webCmprAddressType=webCmprAddressType, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrAddress=sslSrvrAddress, totalMem=totalMem, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, currentFirmwareVersion=currentFirmwareVersion, systemFanSpeed=systemFanSpeed, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCacheCacheableRes=webCacheCacheableRes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyOutBytes=httpProxyOutBytes, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitPort=ipsReqLimitPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalAttacks=totalAttacks, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsHdrAclHits=ipsHdrAclHits, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, webCmprPort=webCmprPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlNormPort=ipsUrlNormPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrOutBytes=httpSrvrOutBytes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrPort=sslSrvrPort, freeMem=freeMem, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecPort=ipsCookieSecPort, raidDegrading=raidDegrading, bwsTrapGroup=bwsTrapGroup, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyOutBytes=sslProxyOutBytes, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyTotalConn=httpProxyTotalConn, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrPort=httpSrvrPort, bwsSMUserSessionTable=bwsSMUserSessionTable, tempHigh=tempHigh, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyInBytes=sslProxyInBytes, sslSrvrNumConn=sslSrvrNumConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, smNumUserSessions=smNumUserSessions, operationalMode=operationalMode, firmwareStorage=firmwareStorage, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, highAvailabilityStatus=highAvailabilityStatus, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyTotalReq=sslProxyTotalReq, PYSNMP_MODULE_ID=bws, sslProxyPort=sslProxyPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyParseErr=httpProxyParseErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrMinResTime=sslSrvrMinResTime)
mibBuilder.exportSymbols("BWS-MIB", totalBandwidth=totalBandwidth, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrMaxResTime=sslSrvrMaxResTime, srvcName=srvcName, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrState=httpSrvrState, logStorageHigh=logStorageHigh, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyAddressType=sslProxyAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrAddressType=sslSrvrAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, systemLoad=systemLoad, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheCachedObjects=webCacheCachedObjects, bwsStats=bwsStats, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, memoryUsageHigh=memoryUsageHigh, activeServers=activeServers, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyAddress=httpProxyAddress, totalApplications=totalApplications, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, memUtilization=memUtilization, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsLrnSrvcAddress=ipsLrnSrvcAddress, virusDefUpdates=virusDefUpdates, webCacheProtocol=webCacheProtocol, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCachePort=webCachePort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, logStorage=logStorage, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyCacheHits=sslProxyCacheHits, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheLongHdrs=webCacheLongHdrs, cpuFanSpeed=cpuFanSpeed, httpProxyActiveConn=httpProxyActiveConn, peerUp=peerUp, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrTotTimedout=sslSrvrTotTimedout, bwstraps=bwstraps, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsCompressionStatsTable=bwsCompressionStatsTable, switchingToInlineMode=switchingToInlineMode, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions)
