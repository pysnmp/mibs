...
IpAddress, TimeTicks, NotificationType, Gauge32, Unsigned32, MibIdentifier, iso, Counter64, Integer32, Counter32, Bits, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "NotificationType", "Gauge32", "Unsigned32", "MibIdentifier", "iso", "Counter64", "Integer32", "Counter32", "Bits", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAddressType=httpSrvrAddressType, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyTotalReq=httpProxyTotalReq, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, dataPathStatus=dataPathStatus, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheProtocol=webCacheProtocol, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCmprProtocol=webCmprProtocol, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, cpuTemperature=cpuTemperature, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheCacheableRes=webCacheCacheableRes, activeServers=activeServers, cpuFanSpeed=cpuFanSpeed, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrAvgResTime=sslSrvrAvgResTime, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheStale=webCacheStale, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrAddress=httpSrvrAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyActiveConn=httpProxyActiveConn, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyServerErr=httpProxyServerErr, sslProxyAddressType=sslProxyAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCPort=ipsRCPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwstraps=bwstraps, bwsMessage=bwsMessage, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlAddress=ipsAccessCtrlAddress, cpuUtilization=cpuUtilization, bwsMIBGroups=bwsMIBGroups, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyPort=sslProxyPort, webCacheAddressType=webCacheAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, virusDefUpdates=virusDefUpdates, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, systemFailOver=systemFailOver, ipsHdrAclAddressType=ipsHdrAclAddressType, firmwareStorageHigh=firmwareStorageHigh, sslProxyTotalConn=sslProxyTotalConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyErrPms=sslProxyErrPms, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, energizeUpdateExpire=energizeUpdateExpire, firmwareStorage=firmwareStorage, sslSrvrSrvcAddress=sslSrvrSrvcAddress, serviceStatus=serviceStatus, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, logStorage=logStorage, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrInBytes=sslSrvrInBytes, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, totalMem=totalMem, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrMinResTime=sslSrvrMinResTime, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyTotalReq=sslProxyTotalReq, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, dataPortLinkDown=dataPortLinkDown, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, smAgentName=smAgentName, webCmprCompressibleDataSize=webCmprCompressibleDataSize, vipStatus=vipStatus, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyCacheHits=sslProxyCacheHits, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, tempCritical=tempCritical, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, freeMem=freeMem, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlNormPort=ipsUrlNormPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsRCAddress=ipsRCAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyServerReq=httpProxyServerReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, totalServers=totalServers, bws=bws, httpSrvrPort=httpSrvrPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, memoryUsageHigh=memoryUsageHigh, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, serverUp=serverUp, bwsMIBCompliances=bwsMIBCompliances, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyAddress=ipsUrlPolicyAddress, switchingToMaintMode=switchingToMaintMode, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, systemLoad=systemLoad, webCmprAddressType=webCmprAddressType, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsCacheStatsTable=bwsCacheStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMIBConformance=bwsMIBConformance, systemSerialNumber=systemSerialNumber, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, raidDegrading=raidDegrading, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCmprAddress=webCmprAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, systemFailure=systemFailure, sslProxyAddress=sslProxyAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlAclPort=ipsUrlAclPort, ipsUrlAclReserved=ipsUrlAclReserved, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, switchingToInlineMode=switchingToInlineMode, bwsStats=bwsStats, totalApplications=totalApplications, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsRCTotDropped=ipsRCTotDropped, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, securityDefUpdates=securityDefUpdates, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsCompressionStatsTable=bwsCompressionStatsTable, servicePort=servicePort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, memUtilization=memUtilization, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyInBytes=httpProxyInBytes, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitPort=ipsReqLimitPort, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCmprPort=webCmprPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyOutBytes=httpProxyOutBytes, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, processCountHigh=processCountHigh, webCacheHits=webCacheHits, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrNumConn=httpSrvrNumConn, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCachePort=webCachePort, totalAttacks=totalAttacks, httpProxyAddressType=httpProxyAddressType, webCacheReq=webCacheReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, serviceName=serviceName, httpProxyPort=httpProxyPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrState=httpSrvrState, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, peerUp=peerUp, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, operationalMode=operationalMode, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheCachedObjects=webCacheCachedObjects, bwsMIBCompliance=bwsMIBCompliance, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, totalBandwidth=totalBandwidth, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, srvcName=srvcName)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, serverDown=serverDown, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, smRealmName=smRealmName, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlAclAddress=ipsUrlAclAddress, smNumUserSessions=smNumUserSessions, PYSNMP_MODULE_ID=bws, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, uptime=uptime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyTotalConn=httpProxyTotalConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, linkStatus=linkStatus, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, serviceAddress=serviceAddress, bwsStatsGroup=bwsStatsGroup, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecPort=ipsCookieSecPort, ipsHdrAclHits=ipsHdrAclHits, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, dataPortLinkUp=dataPortLinkUp, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrState=sslSrvrState, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsRCTotServed=ipsRCTotServed, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheBytesOut=webCacheBytesOut, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, systemFanSpeed=systemFanSpeed, currentFirmwareVersion=currentFirmwareVersion, httpProxyAddress=httpProxyAddress, sslSrvrPort=sslSrvrPort, sslSrvrNumConn=sslSrvrNumConn, webCacheAddress=webCacheAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, peerDown=peerDown, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, newAttackDefinitionInstalled=newAttackDefinitionInstalled, fanDead=fanDead, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsRCStatsTable=bwsIpsRCStatsTable, activeApplications=activeApplications, ipsCookieSecAddressType=ipsCookieSecAddressType, tempHigh=tempHigh, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, logStorageHigh=logStorageHigh, webCacheMiss=webCacheMiss)
