...
ModuleIdentity, Counter32, ObjectIdentity, NotificationType, TimeTicks, Unsigned32, IpAddress, Bits, Integer32, iso, Gauge32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "ObjectIdentity", "NotificationType", "TimeTicks", "Unsigned32", "IpAddress", "Bits", "Integer32", "iso", "Gauge32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", webCachePort=webCachePort, ipsWebAddrTransPort=ipsWebAddrTransPort, linkStatus=linkStatus, webCmprPort=webCmprPort, ipsUrlNormAddressType=ipsUrlNormAddressType, serverUp=serverUp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, memoryUsageHigh=memoryUsageHigh, vipStatus=vipStatus, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCacheBytesOut=webCacheBytesOut, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCAddress=ipsRCAddress, processCountHigh=processCountHigh, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsMIBCompliance=bwsMIBCompliance, sslProxyPort=sslProxyPort, fanDead=fanDead, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, smNumUserSessions=smNumUserSessions, switchingToMaintMode=switchingToMaintMode, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyClientAbrt=httpProxyClientAbrt, dataPathStatus=dataPathStatus, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqSrvcAddress=ipsReqSrvcAddress, freeMem=freeMem, switchingToBypassMode=switchingToBypassMode, sslProxyBadDNCErr=sslProxyBadDNCErr, smRealmName=smRealmName, httpProxyOutBytes=httpProxyOutBytes, firmwareStorage=firmwareStorage, httpProxyInBytes=httpProxyInBytes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, totalAttacks=totalAttacks, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsRCTotDropped=ipsRCTotDropped, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, activeServers=activeServers, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, cpuTemperature=cpuTemperature, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyCacheMiss=sslProxyCacheMiss, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, uptime=uptime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrAddress=httpSrvrAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, virusDefUpdates=virusDefUpdates, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyServerErr=httpProxyServerErr, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsRCPort=ipsRCPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrInBytes=httpSrvrInBytes, httpSrvrOutBytes=httpSrvrOutBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, currentFirmwareVersion=currentFirmwareVersion, sslProxyActiveConn=sslProxyActiveConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCacheAddress=webCacheAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bws=bws, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, totalMem=totalMem, webCmprAddressType=webCmprAddressType, ipsRCTimeStamp=ipsRCTimeStamp, switchingToInlineMode=switchingToInlineMode, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrPort=sslSrvrPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, peerUp=peerUp, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyTotalReq=sslProxyTotalReq, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumConn=sslSrvrNumConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCacheMiss=webCacheMiss, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, logStorage=logStorage, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrState=httpSrvrState, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsTrapGroup=bwsTrapGroup, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, systemLoad=systemLoad, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCmprAddress=webCmprAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, dataPortLinkDown=dataPortLinkDown, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyOutBytes=sslProxyOutBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsStatsGroup=bwsStatsGroup, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, operationalMode=operationalMode, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwstraps=bwstraps, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrPort=httpSrvrPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheHits=webCacheHits, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, raidDegrading=raidDegrading, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, activeApplications=activeApplications, tempCritical=tempCritical, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrSrvcAddress=httpSrvrSrvcAddress, cpuUtilization=cpuUtilization, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyAddress=httpProxyAddress, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrAddress=sslSrvrAddress, sslSrvrAddressType=sslSrvrAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrTotTimedout=httpSrvrTotTimedout, webCacheReq=webCacheReq, sslProxyInBytes=sslProxyInBytes, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, tempHigh=tempHigh, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsHdrAclPort=ipsHdrAclPort, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheAddressType=webCacheAddressType, dataPortLinkUp=dataPortLinkUp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, peerDown=peerDown, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, PYSNMP_MODULE_ID=bws, sslProxyAddressType=sslProxyAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyTotalReq=httpProxyTotalReq, webCacheLongHdrs=webCacheLongHdrs, sslProxyAddress=sslProxyAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsCacheStatsTable=bwsCacheStatsTable, ipsRCTotServed=ipsRCTotServed, systemFailOver=systemFailOver, httpProxyActiveConn=httpProxyActiveConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, memUtilization=memUtilization, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalApplications=totalApplications, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyParseErr=httpProxyParseErr, httpProxyServerReq=httpProxyServerReq, totalBandwidth=totalBandwidth, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, firmwareStorageHigh=firmwareStorageHigh, bwsMIBCompliances=bwsMIBCompliances, serverDown=serverDown, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrAddressType=httpSrvrAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, serviceStatus=serviceStatus, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, highAvailabilityStatus=highAvailabilityStatus, logStorageHigh=logStorageHigh)
mibBuilder.exportSymbols("BWS-MIB", webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrOutBytes=sslSrvrOutBytes, bwsMessage=bwsMessage, sslSrvrMinResTime=sslSrvrMinResTime, totalServers=totalServers, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrState=sslSrvrState, webCacheProtocol=webCacheProtocol, sslProxyErrPms=sslProxyErrPms, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, systemFailure=systemFailure, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyUnknownRsp=httpProxyUnknownRsp, smAgentName=smAgentName, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, systemFanSpeed=systemFanSpeed, bwsMIBConformance=bwsMIBConformance, serviceAddress=serviceAddress, ipsUrlNormPort=ipsUrlNormPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheCacheableRes=webCacheCacheableRes, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecPort=ipsCookieSecPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrMinResTime=httpSrvrMinResTime, webCacheStale=webCacheStale, cpuFanSpeed=cpuFanSpeed, httpProxyTotalConn=httpProxyTotalConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, serviceName=serviceName, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, systemSerialNumber=systemSerialNumber, ipsUrlAclReserved=ipsUrlAclReserved, srvcName=srvcName, httpProxyPort=httpProxyPort, servicePort=servicePort, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsRCAddressType=ipsRCAddressType, securityDefUpdates=securityDefUpdates, bwsStats=bwsStats, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsHdrAclAddressType=ipsHdrAclAddressType, webCmprProtocol=webCmprProtocol, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime)
