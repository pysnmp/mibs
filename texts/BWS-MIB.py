...
IpAddress, MibIdentifier, Bits, Counter64, iso, TimeTicks, ObjectIdentity, Unsigned32, Integer32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Bits", "Counter64", "iso", "TimeTicks", "ObjectIdentity", "Unsigned32", "Integer32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", tempHigh=tempHigh, cpuTemperature=cpuTemperature, webCacheProtocol=webCacheProtocol, dataPortLinkDown=dataPortLinkDown, raidDegrading=raidDegrading, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrAddress=sslSrvrAddress, webCacheAddressType=webCacheAddressType, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrPort=sslSrvrPort, totalAttacks=totalAttacks, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, fanDead=fanDead, activeServers=activeServers, systemFailure=systemFailure, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyPort=httpProxyPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bws=bws, cpuFanSpeed=cpuFanSpeed, sslSrvrNumConn=sslSrvrNumConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, memoryUsageHigh=memoryUsageHigh, sslSrvrOutBytes=sslSrvrOutBytes, vipStatus=vipStatus, ipsCookieSecAddress=ipsCookieSecAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, logStorageHigh=logStorageHigh, httpProxyWAFWarnings=httpProxyWAFWarnings, firmwareStorage=firmwareStorage, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyOutBytes=httpProxyOutBytes, highAvailabilityStatus=highAvailabilityStatus, httpProxyTotalConn=httpProxyTotalConn, webCmprAddressType=webCmprAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, serverUp=serverUp, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrInBytes=sslSrvrInBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyTotalConn=sslProxyTotalConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, activeApplications=activeApplications, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyPort=sslProxyPort, sslProxyAddressType=sslProxyAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, serviceStatus=serviceStatus, totalServers=totalServers, dataPathStatus=dataPathStatus, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrAddressType=sslSrvrAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheReq=webCacheReq, operationalMode=operationalMode, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, srvcName=srvcName, sslProxyAddress=sslProxyAddress, peerUp=peerUp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrInBytes=httpSrvrInBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, logStorage=logStorage, bwsSMUserSessionTable=bwsSMUserSessionTable, webCmprProtocol=webCmprProtocol, servicePort=servicePort, ipsUrlAclAddress=ipsUrlAclAddress, webCacheAddress=webCacheAddress, processCountHigh=processCountHigh, sslSrvrState=sslSrvrState, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyParseErr=httpProxyParseErr, httpSrvrPort=httpSrvrPort, switchingToInlineMode=switchingToInlineMode, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyActiveConn=httpProxyActiveConn, smAgentName=smAgentName, systemFailOver=systemFailOver, freeMem=freeMem, webCachePort=webCachePort, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsRCTotServed=ipsRCTotServed, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsStatsGroup=bwsStatsGroup, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyInBytes=sslProxyInBytes, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyActiveConn=sslProxyActiveConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyTotalReq=sslProxyTotalReq, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, securityDefUpdates=securityDefUpdates, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCTotQueued=ipsRCTotQueued, systemFanSpeed=systemFanSpeed, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, totalApplications=totalApplications, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyInBytes=httpProxyInBytes, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsRCAddress=ipsRCAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxySessionTimeOut=httpProxySessionTimeOut, systemLoad=systemLoad, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsTrapGroup=bwsTrapGroup, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrState=httpSrvrState, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyAddressType=httpProxyAddressType, firmwareStorageHigh=firmwareStorageHigh, totalMem=totalMem, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, serviceAddress=serviceAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, systemSerialNumber=systemSerialNumber, httpSrvrMaxResTime=httpSrvrMaxResTime, switchingToMaintMode=switchingToMaintMode, cpuUtilization=cpuUtilization, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsStats=bwsStats, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrAddress=httpSrvrAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyCacheHits=sslProxyCacheHits, bwsMIBGroups=bwsMIBGroups, webCacheBytesOut=webCacheBytesOut, linkStatus=linkStatus, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrNumConn=httpSrvrNumConn, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, smRealmName=smRealmName, ipsRCAddressType=ipsRCAddressType, energizeUpdateExpire=energizeUpdateExpire, httpSrvrTotRefused=httpSrvrTotRefused, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyServerReq=httpProxyServerReq, httpSrvrAddressType=httpSrvrAddressType, webCmprPort=webCmprPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyOutBytes=sslProxyOutBytes, sslProxyErrPms=sslProxyErrPms, httpSrvrNumFreeConn=httpSrvrNumFreeConn, PYSNMP_MODULE_ID=bws, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsRCPort=ipsRCPort, bwstraps=bwstraps, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, virusDefUpdates=virusDefUpdates, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitPort=ipsReqLimitPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr)
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheMiss=webCacheMiss, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsMIBConformance=bwsMIBConformance, bwsMIBCompliances=bwsMIBCompliances, webCacheHits=webCacheHits, webCmprAddress=webCmprAddress, serviceName=serviceName, httpProxyTotalReq=httpProxyTotalReq, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyAddress=httpProxyAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, totalBandwidth=totalBandwidth, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsMIBCompliance=bwsMIBCompliance, httpProxyServerErr=httpProxyServerErr, ipsRCTotDropped=ipsRCTotDropped, webCacheStale=webCacheStale, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsMessage=bwsMessage, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrTotTimedout=sslSrvrTotTimedout, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serverDown=serverDown, peerDown=peerDown, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsCookieSecPort=ipsCookieSecPort, httpSrvrMinResTime=httpSrvrMinResTime, uptime=uptime, ipsUrlAclPort=ipsUrlAclPort, tempCritical=tempCritical, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, smNumUserSessions=smNumUserSessions, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, memUtilization=memUtilization, ipsUrlNormAddress=ipsUrlNormAddress, webCacheCacheableRes=webCacheCacheableRes, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry)
