...
Counter64, iso, ObjectIdentity, ModuleIdentity, Unsigned32, Bits, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Integer32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Bits", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Integer32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotReqRejected=httpSrvrTotReqRejected, uptime=uptime, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsRCAddressType=ipsRCAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyTotalConn=httpProxyTotalConn, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, cpuFanSpeed=cpuFanSpeed, linkStatus=linkStatus, httpProxyAddressType=httpProxyAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsHdrAclAddress=ipsHdrAclAddress, totalServers=totalServers, totalBandwidth=totalBandwidth, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, PYSNMP_MODULE_ID=bws, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyCurrentConn=sslProxyCurrentConn, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, cpuTemperature=cpuTemperature, webCacheHits=webCacheHits, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyServerReq=httpProxyServerReq, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsMessage=bwsMessage, httpSrvrTotRefused=httpSrvrTotRefused, ipsHdrAclHits=ipsHdrAclHits, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, serviceName=serviceName, bws=bws, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrTotResponse=httpSrvrTotResponse, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsSMUserSessionTable=bwsSMUserSessionTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheMiss=webCacheMiss, webCmprAddress=webCmprAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, tempHigh=tempHigh, ipsCookieSecPort=ipsCookieSecPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheReq=webCacheReq, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, totalAttacks=totalAttacks, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyOutBytes=sslProxyOutBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyTotalReq=sslProxyTotalReq, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, serviceStatus=serviceStatus, firmwareStorageHigh=firmwareStorageHigh, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, currentFirmwareVersion=currentFirmwareVersion, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheBytesOut=webCacheBytesOut, processCountHigh=processCountHigh, sslProxyBadDNCErr=sslProxyBadDNCErr, memoryUsageHigh=memoryUsageHigh, switchingToMaintMode=switchingToMaintMode, smAgentName=smAgentName, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyInBytes=httpProxyInBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsRCPort=ipsRCPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrOutBytes=httpSrvrOutBytes, ipsRCTotDropped=ipsRCTotDropped, webCmprAddressType=webCmprAddressType, tempCritical=tempCritical, totalMem=totalMem, httpSrvrAddressType=httpSrvrAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsMIBConformance=bwsMIBConformance, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwstraps=bwstraps, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrTotResponse=sslSrvrTotResponse, peerUp=peerUp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrNumConn=httpSrvrNumConn, serverDown=serverDown, sslProxyCacheHits=sslProxyCacheHits, systemSerialNumber=systemSerialNumber, httpSrvrSrvcPort=httpSrvrSrvcPort, highAvailabilityStatus=highAvailabilityStatus, bwsMIBCompliance=bwsMIBCompliance, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, smNumUserSessions=smNumUserSessions, vipStatus=vipStatus, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyOutBytes=httpProxyOutBytes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, webCacheAddressType=webCacheAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, dataPathStatus=dataPathStatus, sslProxyErrPms=sslProxyErrPms, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrOutBytes=sslSrvrOutBytes, virusDefUpdates=virusDefUpdates, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcPort=ipsLrnSrvcPort, activeServers=activeServers, peerDown=peerDown, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrAddress=httpSrvrAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrAddress=sslSrvrAddress, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrPort=httpSrvrPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrAddressType=sslSrvrAddressType, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, systemFanSpeed=systemFanSpeed, bwsStats=bwsStats, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrInBytes=httpSrvrInBytes, freeMem=freeMem, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyActiveConn=httpProxyActiveConn, totalApplications=totalApplications, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsRCAddress=ipsRCAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsRCStatsTable=bwsIpsRCStatsTable, switchingToInlineMode=switchingToInlineMode, logStorageHigh=logStorageHigh, logStorage=logStorage, servicePort=servicePort, sslProxyPort=sslProxyPort, dataPortLinkDown=dataPortLinkDown, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, serverUp=serverUp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrNumConn=sslSrvrNumConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsCookieSecTampered=ipsCookieSecTampered, securityDefUpdates=securityDefUpdates, systemFailOver=systemFailOver, webCacheAddress=webCacheAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, smRealmName=smRealmName, operationalMode=operationalMode, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsRCTotQueued=ipsRCTotQueued, webCmprProtocol=webCmprProtocol, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCacheStale=webCacheStale, ipsHdrAclPort=ipsHdrAclPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheCachedObjects=webCacheCachedObjects, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrAvgResTime=sslSrvrAvgResTime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, energizeUpdateExpire=energizeUpdateExpire, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, raidDegrading=raidDegrading, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCmprPort=webCmprPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyActiveConn=sslProxyActiveConn, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlAclPort=ipsUrlAclPort, firmwareStorage=firmwareStorage)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotRefused=sslSrvrTotRefused, activeApplications=activeApplications, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyServerErr=httpProxyServerErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotServed=ipsRCTotServed, systemFailure=systemFailure, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyPort=httpProxyPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, cpuUtilization=cpuUtilization, ipsRCTotOutOfResource=ipsRCTotOutOfResource, srvcName=srvcName, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrState=httpSrvrState, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrPort=sslSrvrPort, ipsReqLimitPort=ipsReqLimitPort, sslSrvrState=sslSrvrState, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsTrapGroup=bwsTrapGroup, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, fanDead=fanDead, memUtilization=memUtilization, dataPortLinkUp=dataPortLinkUp, sslProxyAddressType=sslProxyAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsMIBGroups=bwsMIBGroups, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyAddress=httpProxyAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheProtocol=webCacheProtocol, sslSrvrInBytes=sslSrvrInBytes, ipsUrlNormAddress=ipsUrlNormAddress, serviceAddress=serviceAddress, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyAddress=sslProxyAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsStatsGroup=bwsStatsGroup, httpProxyTotalReq=httpProxyTotalReq, webCacheCacheableRes=webCacheCacheableRes, httpProxyParseErr=httpProxyParseErr, systemLoad=systemLoad, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCachePort=webCachePort, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr)
