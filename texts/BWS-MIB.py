...
Gauge32, Bits, IpAddress, ObjectIdentity, NotificationType, ModuleIdentity, Counter32, Unsigned32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "IpAddress", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Counter32", "Unsigned32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrNumConn=sslSrvrNumConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCTotQueued=ipsRCTotQueued, httpProxyTotalReq=httpProxyTotalReq, uptime=uptime, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCmprAddressType=webCmprAddressType, httpSrvrNumConn=httpSrvrNumConn, memUtilization=memUtilization, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheCachedObjects=webCacheCachedObjects, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, vipStatus=vipStatus, totalAttacks=totalAttacks, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, serviceAddress=serviceAddress, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, servicePort=servicePort, ipsRCTotDropped=ipsRCTotDropped, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, systemFanSpeed=systemFanSpeed, httpProxyOutBytes=httpProxyOutBytes, raidDegrading=raidDegrading, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, totalBandwidth=totalBandwidth, fanDead=fanDead, webCacheLongHdrs=webCacheLongHdrs, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsMessage=bwsMessage, serviceName=serviceName, sslSrvrNumFreeConn=sslSrvrNumFreeConn, switchingToBypassMode=switchingToBypassMode, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, cpuUtilization=cpuUtilization, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, currentFirmwareVersion=currentFirmwareVersion, virusDefUpdates=virusDefUpdates, webCmprAddress=webCmprAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrPort=httpSrvrPort, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrAddressType=sslSrvrAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsMIBConformance=bwsMIBConformance, ipsUrlNormAddressType=ipsUrlNormAddressType, firmwareStorageHigh=firmwareStorageHigh, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, systemSerialNumber=systemSerialNumber, smNumUserSessions=smNumUserSessions, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, systemFailOver=systemFailOver, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, energizeUpdateExpire=energizeUpdateExpire, dataPortLinkUp=dataPortLinkUp, webCacheReq=webCacheReq, bws=bws, sslProxyPort=sslProxyPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrMaxResTime=sslSrvrMaxResTime, processCountHigh=processCountHigh, bwsServiceStatusTable=bwsServiceStatusTable, bwsTrapGroup=bwsTrapGroup, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyPort=httpProxyPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyErrPms=sslProxyErrPms, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, cpuFanSpeed=cpuFanSpeed, httpSrvrState=httpSrvrState, ipsUrlAclAddress=ipsUrlAclAddress, bwsMIBGroups=bwsMIBGroups, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, switchingToMaintMode=switchingToMaintMode, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsHdrAclAddress=ipsHdrAclAddress, activeServers=activeServers, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsHdrAclHits=ipsHdrAclHits, freeMem=freeMem, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyActiveConn=sslProxyActiveConn, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyInBytes=httpProxyInBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, smAgentName=smAgentName, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrAddress=sslSrvrAddress, totalMem=totalMem, webCmprCompressibleDataSize=webCmprCompressibleDataSize, serverUp=serverUp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, systemFailure=systemFailure, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, highAvailabilityStatus=highAvailabilityStatus, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, switchingToInlineMode=switchingToInlineMode, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsStatsGroup=bwsStatsGroup, ipsRCTotServed=ipsRCTotServed, smRealmName=smRealmName, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyAddress=httpProxyAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlNormPort=ipsUrlNormPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyCacheHits=sslProxyCacheHits, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, serviceStatus=serviceStatus, securityDefUpdates=securityDefUpdates, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsRCPort=ipsRCPort, sslProxyInBytes=sslProxyInBytes, ipsUrlAclPort=ipsUrlAclPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsMIBCompliances=bwsMIBCompliances, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyTotalConn=httpProxyTotalConn, bwsMIBCompliance=bwsMIBCompliance, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, linkStatus=linkStatus, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, tempCritical=tempCritical, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheMiss=webCacheMiss, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCmprProtocol=webCmprProtocol, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCachePort=webCachePort, serverDown=serverDown, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrOutBytes=httpSrvrOutBytes, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyAddressType=sslProxyAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, tempHigh=tempHigh, activeApplications=activeApplications, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsRCAddressType=ipsRCAddressType, httpSrvrAddressType=httpSrvrAddressType, webCacheProtocol=webCacheProtocol, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyServerErr=httpProxyServerErr, srvcName=srvcName, cpuTemperature=cpuTemperature, ipsReqLimitPort=ipsReqLimitPort, logStorage=logStorage, ipsUrlAclAddressType=ipsUrlAclAddressType, systemLoad=systemLoad, webCacheAddressType=webCacheAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, PYSNMP_MODULE_ID=bws, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyActiveConn=httpProxyActiveConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsHdrAclPort=ipsHdrAclPort, sslSrvrTotResponse=sslSrvrTotResponse, ipsCookieSecAddress=ipsCookieSecAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCAddress=ipsRCAddress, webCacheStale=webCacheStale, firmwareStorage=firmwareStorage, ipsReqSrvcAddress=ipsReqSrvcAddress, totalApplications=totalApplications)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcAddress=ipsLrnSrvcAddress, operationalMode=operationalMode, ipsCookieSecTampered=ipsCookieSecTampered, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrInBytes=sslSrvrInBytes, webCacheHits=webCacheHits, peerDown=peerDown, bwsStats=bwsStats, httpSrvrAddress=httpSrvrAddress, httpProxyParseErr=httpProxyParseErr, logStorageHigh=logStorageHigh, webCacheAddress=webCacheAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, dataPathStatus=dataPathStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCacheBytesOut=webCacheBytesOut, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyAddressType=httpProxyAddressType, totalServers=totalServers, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqSrvcAddressType=ipsReqSrvcAddressType, dataPortLinkDown=dataPortLinkDown, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrState=sslSrvrState, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrPort=sslSrvrPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyAddress=sslProxyAddress, bwstraps=bwstraps, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitAddress=ipsReqLimitAddress, webCmprPort=webCmprPort, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotTimedout=sslSrvrTotTimedout, peerUp=peerUp, webCacheCacheableRes=webCacheCacheableRes, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyOutBytes=sslProxyOutBytes)
