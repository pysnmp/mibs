...
ModuleIdentity, TimeTicks, IpAddress, Unsigned32, Counter32, Counter64, MibIdentifier, iso, Bits, Gauge32, Integer32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "IpAddress", "Unsigned32", "Counter32", "Counter64", "MibIdentifier", "iso", "Bits", "Gauge32", "Integer32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", bwstraps=bwstraps, bwsServiceStatusTable=bwsServiceStatusTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyParseErr=httpProxyParseErr, httpProxyInBytes=httpProxyInBytes, srvcName=srvcName, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, switchingToBypassMode=switchingToBypassMode, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyTotalReq=httpProxyTotalReq, httpSrvrAddressType=httpSrvrAddressType, webCacheHits=webCacheHits, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsHdrAclPort=ipsHdrAclPort, serviceName=serviceName, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrAvgResTime=httpSrvrAvgResTime, serverDown=serverDown, httpSrvrState=httpSrvrState, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrAddress=sslSrvrAddress, ipsRCPort=ipsRCPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, processCountHigh=processCountHigh, webCacheProtocol=webCacheProtocol, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrPort=sslSrvrPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, fanDead=fanDead, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrTotTimedout=sslSrvrTotTimedout, cpuTemperature=cpuTemperature, httpProxyAddress=httpProxyAddress, bwsStatsGroup=bwsStatsGroup, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormPort=ipsUrlNormPort, sslSrvrInBytes=sslSrvrInBytes, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheAddressType=webCacheAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, energizeUpdateExpire=energizeUpdateExpire, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, PYSNMP_MODULE_ID=bws, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, smRealmName=smRealmName, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, tempHigh=tempHigh, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, highAvailabilityStatus=highAvailabilityStatus, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCacheLongHdrs=webCacheLongHdrs, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemFailure=systemFailure, activeServers=activeServers, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheAddress=webCacheAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsMIBCompliances=bwsMIBCompliances, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, raidDegrading=raidDegrading, webCmprPort=webCmprPort, sslProxyAddress=sslProxyAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyOutBytes=sslProxyOutBytes, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyAddressType=httpProxyAddressType, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyPort=httpProxyPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, systemLoad=systemLoad, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, servicePort=servicePort, activeApplications=activeApplications, dataPathStatus=dataPathStatus, webCmprAddressType=webCmprAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprAddress=webCmprAddress, systemFailOver=systemFailOver, bwsStats=bwsStats, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumConn=httpSrvrNumConn, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, smAgentName=smAgentName, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, virusDefUpdates=virusDefUpdates, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCacheMiss=webCacheMiss, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrState=sslSrvrState, ipsReqSrvcAddressType=ipsReqSrvcAddressType, totalMem=totalMem, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsRCTotDropped=ipsRCTotDropped, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsMessage=bwsMessage, ipsCookieSecTampered=ipsCookieSecTampered, dataPortLinkDown=dataPortLinkDown, webCmprProtocol=webCmprProtocol, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsRCAddress=ipsRCAddress, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, securityDefUpdates=securityDefUpdates, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqLimitPort=ipsReqLimitPort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrInBytes=httpSrvrInBytes, tempCritical=tempCritical, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, switchingToMaintMode=switchingToMaintMode, ipsUrlAclPort=ipsUrlAclPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheBytesOut=webCacheBytesOut, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bws=bws, ipsRCAddressType=ipsRCAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, totalServers=totalServers, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, peerDown=peerDown, bwsCompressionStatsTable=bwsCompressionStatsTable, cpuUtilization=cpuUtilization, httpProxyUnknownRsp=httpProxyUnknownRsp, switchingToInlineMode=switchingToInlineMode, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyTotalConn=httpProxyTotalConn, webCacheReq=webCacheReq, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyAddressType=sslProxyAddressType, serviceStatus=serviceStatus, logStorage=logStorage, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyActiveConn=httpProxyActiveConn, sslSrvrNumConn=sslSrvrNumConn, webCacheCachedObjects=webCacheCachedObjects, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyPort=sslProxyPort, httpSrvrOutBytes=httpSrvrOutBytes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, vipStatus=vipStatus, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsMIBConformance=bwsMIBConformance, ipsUrlPolicyPort=ipsUrlPolicyPort, cpuFanSpeed=cpuFanSpeed, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsCacheStatsTable=bwsCacheStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, logStorageHigh=logStorageHigh, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, uptime=uptime, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsMIBCompliance=bwsMIBCompliance, httpProxyServerReq=httpProxyServerReq, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyTotalReq=sslProxyTotalReq, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCachePort=webCachePort, webCacheCacheableRes=webCacheCacheableRes, totalBandwidth=totalBandwidth, sslProxyErrPms=sslProxyErrPms, operationalMode=operationalMode, ipsReqSrvcPort=ipsReqSrvcPort, systemFanSpeed=systemFanSpeed, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCTotServed=ipsRCTotServed, currentFirmwareVersion=currentFirmwareVersion)
mibBuilder.exportSymbols("BWS-MIB", memoryUsageHigh=memoryUsageHigh, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, systemSerialNumber=systemSerialNumber, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, peerUp=peerUp, smNumUserSessions=smNumUserSessions, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheStale=webCacheStale, firmwareStorageHigh=firmwareStorageHigh, freeMem=freeMem, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsMIBGroups=bwsMIBGroups, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, serverUp=serverUp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyInBytes=sslProxyInBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, totalAttacks=totalAttacks, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, serviceAddress=serviceAddress, memUtilization=memUtilization, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsTrapGroup=bwsTrapGroup, ipsUrlNormAddress=ipsUrlNormAddress, linkStatus=linkStatus, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyOutBytes=httpProxyOutBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsRCTimeStamp=ipsRCTimeStamp, totalApplications=totalApplications, httpSrvrPort=httpSrvrPort, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrAddressType=sslSrvrAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, firmwareStorage=firmwareStorage, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled)
