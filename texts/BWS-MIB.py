...
Counter64, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Integer32, iso, Gauge32, ObjectIdentity, MibIdentifier, NotificationType, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Integer32", "iso", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotReqRejected=httpSrvrTotReqRejected, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyParseErr=httpProxyParseErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, firmwareStorageHigh=firmwareStorageHigh, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, totalServers=totalServers, httpSrvrSrvcAddress=httpSrvrSrvcAddress, systemLoad=systemLoad, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlAclAddress=ipsUrlAclAddress, uptime=uptime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, tempHigh=tempHigh, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrOutBytes=httpSrvrOutBytes, ipsRCPort=ipsRCPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, systemFailOver=systemFailOver, energizeUpdateExpire=energizeUpdateExpire, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, totalAttacks=totalAttacks, bwsMIBConformance=bwsMIBConformance, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyAddressType=sslProxyAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, webCachePort=webCachePort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyAddress=sslProxyAddress, bwsMessage=bwsMessage, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, serviceName=serviceName, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyActiveConn=httpProxyActiveConn, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlNormPort=ipsUrlNormPort, httpSrvrPort=httpSrvrPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, activeApplications=activeApplications, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheReq=webCacheReq, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsMIBCompliances=bwsMIBCompliances, sslProxyActiveConn=sslProxyActiveConn, currentFirmwareVersion=currentFirmwareVersion, sslProxyErrPms=sslProxyErrPms, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyAddress=httpProxyAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyTotalConn=httpProxyTotalConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotSuccess=httpSrvrTotSuccess, dataPathStatus=dataPathStatus, bwsIpsRCStatsTable=bwsIpsRCStatsTable, peerUp=peerUp, httpProxyAddressType=httpProxyAddressType, sslProxyCacheMiss=sslProxyCacheMiss, srvcName=srvcName, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrAddress=sslSrvrAddress, webCacheAddressType=webCacheAddressType, ipsCookieSecTampered=ipsCookieSecTampered, processCountHigh=processCountHigh, webCacheBytesOut=webCacheBytesOut, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyTotalReq=sslProxyTotalReq, switchingToInlineMode=switchingToInlineMode, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrInBytes=httpSrvrInBytes, webCacheCachedObjects=webCacheCachedObjects, webCacheStale=webCacheStale, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyServerErr=httpProxyServerErr, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyInBytes=sslProxyInBytes, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bws=bws, memUtilization=memUtilization, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlAclPort=ipsUrlAclPort, cpuFanSpeed=cpuFanSpeed, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrNumConn=httpSrvrNumConn, smAgentName=smAgentName, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, switchingToMaintMode=switchingToMaintMode, httpProxyServerReq=httpProxyServerReq, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheAddress=webCacheAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrAddressType=sslSrvrAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsTrapGroup=bwsTrapGroup, serverDown=serverDown, tempCritical=tempCritical, sslSrvrAvgResTime=sslSrvrAvgResTime, cpuUtilization=cpuUtilization, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCacheLongHdrs=webCacheLongHdrs, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyServerAbrt=httpProxyServerAbrt, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsRCAddress=ipsRCAddress, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyPort=httpProxyPort, ipsRCTotQueued=ipsRCTotQueued, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, linkStatus=linkStatus, serviceAddress=serviceAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsMIBGroups=bwsMIBGroups, securityDefUpdates=securityDefUpdates, ipsRCAddressType=ipsRCAddressType, freeMem=freeMem, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrTotResponse=httpSrvrTotResponse, fanDead=fanDead, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqSrvcPort=ipsReqSrvcPort, operationalMode=operationalMode, ipsReqLimitPort=ipsReqLimitPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyCacheHits=sslProxyCacheHits, webCmprAddress=webCmprAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, peerDown=peerDown, newAttackDefinitionInstalled=newAttackDefinitionInstalled, totalMem=totalMem, memoryUsageHigh=memoryUsageHigh, sslSrvrPort=sslSrvrPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCmprAddressType=webCmprAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyOutBytes=httpProxyOutBytes, logStorage=logStorage, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheHits=webCacheHits, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrAddress=httpSrvrAddress, switchingToBypassMode=switchingToBypassMode, totalApplications=totalApplications, smNumUserSessions=smNumUserSessions, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyPort=sslProxyPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrState=sslSrvrState, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, webCacheCacheableRes=webCacheCacheableRes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsRCTotDropped=ipsRCTotDropped, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, totalBandwidth=totalBandwidth, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsHdrAclHits=ipsHdrAclHits, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, virusDefUpdates=virusDefUpdates)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, highAvailabilityStatus=highAvailabilityStatus, httpSrvrState=httpSrvrState, httpSrvrAddressType=httpSrvrAddressType, raidDegrading=raidDegrading, webCacheProtocol=webCacheProtocol, cpuTemperature=cpuTemperature, webCacheMiss=webCacheMiss, httpProxyInBytes=httpProxyInBytes, systemFanSpeed=systemFanSpeed, activeServers=activeServers, httpProxySessionTimeOut=httpProxySessionTimeOut, serviceStatus=serviceStatus, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsHdrAclPort=ipsHdrAclPort, firmwareStorage=firmwareStorage, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCmprProtocol=webCmprProtocol, sslSrvrNumConn=sslSrvrNumConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyOutBytes=sslProxyOutBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemSerialNumber=systemSerialNumber, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlPort=ipsAccessCtrlPort, serverUp=serverUp, bwstraps=bwstraps, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrInBytes=sslSrvrInBytes, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, systemFailure=systemFailure, smRealmName=smRealmName, sslProxyBadCRLErr=sslProxyBadCRLErr, logStorageHigh=logStorageHigh, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTotServed=ipsRCTotServed, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, servicePort=servicePort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprPort=webCmprPort, bwsStatsGroup=bwsStatsGroup, vipStatus=vipStatus, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyTotalReq=httpProxyTotalReq, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, PYSNMP_MODULE_ID=bws, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsStats=bwsStats, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr)
