...
Unsigned32, TimeTicks, MibIdentifier, Bits, Counter32, IpAddress, ModuleIdentity, ObjectIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "MibIdentifier", "Bits", "Counter32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyAddress=sslProxyAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsMIBCompliances=bwsMIBCompliances, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprAddressType=webCmprAddressType, sslSrvrNumConn=sslSrvrNumConn, totalApplications=totalApplications, ipsCookieSecPort=ipsCookieSecPort, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyInBytes=httpProxyInBytes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, totalAttacks=totalAttacks, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprProtocol=webCmprProtocol, processCountHigh=processCountHigh, freeMem=freeMem, operationalMode=operationalMode, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrNumConn=httpSrvrNumConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, memUtilization=memUtilization, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsMIBCompliance=bwsMIBCompliance, tempHigh=tempHigh, webCacheCachedObjects=webCacheCachedObjects, totalBandwidth=totalBandwidth, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, linkStatus=linkStatus, peerUp=peerUp, ipsUrlAclPort=ipsUrlAclPort, activeApplications=activeApplications, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, totalServers=totalServers, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, cpuUtilization=cpuUtilization, webCacheReq=webCacheReq, bws=bws, vipStatus=vipStatus, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyOutBytes=sslProxyOutBytes, webCacheProtocol=webCacheProtocol, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyClientAbrt=httpProxyClientAbrt, smAgentName=smAgentName, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, systemFanSpeed=systemFanSpeed, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, switchingToInlineMode=switchingToInlineMode, ipsCookieSecAddress=ipsCookieSecAddress, activeServers=activeServers, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrPort=httpSrvrPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, serviceAddress=serviceAddress, cpuFanSpeed=cpuFanSpeed, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, raidDegrading=raidDegrading, sslSrvrState=sslSrvrState, webCmprAddress=webCmprAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, tempCritical=tempCritical, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, dataPathStatus=dataPathStatus, httpProxyAddress=httpProxyAddress, firmwareStorage=firmwareStorage, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyTotalConn=httpProxyTotalConn, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsRCTotDropped=ipsRCTotDropped, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrOutBytes=httpSrvrOutBytes, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsWebAddrTransAddress=ipsWebAddrTransAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCAddressType=ipsRCAddressType, ipsHdrAclHits=ipsHdrAclHits, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyActiveConn=sslProxyActiveConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsRCAddress=ipsRCAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyPort=httpProxyPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyCacheMiss=sslProxyCacheMiss, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyTotalConn=sslProxyTotalConn, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, systemLoad=systemLoad, webCacheAddressType=webCacheAddressType, servicePort=servicePort, PYSNMP_MODULE_ID=bws, bwsTrapGroup=bwsTrapGroup, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsStats=bwsStats, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serverUp=serverUp, smNumUserSessions=smNumUserSessions, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlAclAddress=ipsUrlAclAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsCompressionStatsTable=bwsCompressionStatsTable, switchingToBypassMode=switchingToBypassMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, energizeUpdateExpire=energizeUpdateExpire, dataPortLinkUp=dataPortLinkUp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrPort=sslSrvrPort, logStorage=logStorage, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyTotalReq=httpProxyTotalReq, webCacheHits=webCacheHits, sslSrvrAddressType=sslSrvrAddressType, httpProxyParseErr=httpProxyParseErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyServerReq=httpProxyServerReq, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, memoryUsageHigh=memoryUsageHigh, highAvailabilityStatus=highAvailabilityStatus, bwsServiceStatusTable=bwsServiceStatusTable, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, fanDead=fanDead, ipsHdrAclPort=ipsHdrAclPort, bwsCacheStatsEntry=bwsCacheStatsEntry, switchingToMaintMode=switchingToMaintMode, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, systemFailOver=systemFailOver, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, virusDefUpdates=virusDefUpdates, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCTotQueued=ipsRCTotQueued, dataPortLinkDown=dataPortLinkDown, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, smRealmName=smRealmName, webCmprPort=webCmprPort, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrState=httpSrvrState, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyCacheHits=sslProxyCacheHits, httpSrvrInBytes=httpSrvrInBytes, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, webCacheAddress=webCacheAddress, webCacheStale=webCacheStale, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcPort=ipsReqSrvcPort, securityDefUpdates=securityDefUpdates, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwstraps=bwstraps, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, serviceStatus=serviceStatus, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr)
mibBuilder.exportSymbols("BWS-MIB", ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrInBytes=sslSrvrInBytes, ipsRCPort=ipsRCPort, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsStatsGroup=bwsStatsGroup, sslProxyInBytes=sslProxyInBytes, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrSrvcPort=sslSrvrSrvcPort, totalMem=totalMem, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormAddress=ipsUrlNormAddress, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCachePort=webCachePort, webCacheMiss=webCacheMiss, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyAddressType=sslProxyAddressType, httpProxyOutBytes=httpProxyOutBytes, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyTotalReq=sslProxyTotalReq, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, systemFailure=systemFailure, ipsReqLimitPort=ipsReqLimitPort, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, srvcName=srvcName, serverDown=serverDown, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serviceName=serviceName, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyPort=sslProxyPort, logStorageHigh=logStorageHigh, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, peerDown=peerDown, sslProxyErrPms=sslProxyErrPms, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsMessage=bwsMessage, cpuTemperature=cpuTemperature, uptime=uptime)
