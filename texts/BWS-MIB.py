...
Counter64, ModuleIdentity, Counter32, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, NotificationType, ObjectIdentity, TimeTicks, IpAddress, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Counter32", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "NotificationType", "ObjectIdentity", "TimeTicks", "IpAddress", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrMaxResTime=httpSrvrMaxResTime, srvcName=srvcName, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, logStorageHigh=logStorageHigh, sslProxyBadCRLErr=sslProxyBadCRLErr, virusDefUpdates=virusDefUpdates, httpProxyTotalReq=httpProxyTotalReq, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyOutBytes=sslProxyOutBytes, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsRCPort=ipsRCPort, bwsMIBConformance=bwsMIBConformance, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAddress=ipsAccessCtrlAddress, securityDefUpdates=securityDefUpdates, httpProxyServerErr=httpProxyServerErr, firmwareStorage=firmwareStorage, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, systemFailOver=systemFailOver, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, switchingToInlineMode=switchingToInlineMode, ipsRCTotQueued=ipsRCTotQueued, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, vipStatus=vipStatus, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsStatsGroup=bwsStatsGroup, bwsCacheStatsTable=bwsCacheStatsTable, webCacheAddress=webCacheAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, smRealmName=smRealmName, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, systemFailure=systemFailure, memUtilization=memUtilization, switchingToBypassMode=switchingToBypassMode, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsReqSrvcAddress=ipsReqSrvcAddress, activeServers=activeServers, webCacheStale=webCacheStale, smNumUserSessions=smNumUserSessions, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyPort=sslProxyPort, sslProxyCacheHits=sslProxyCacheHits, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, totalMem=totalMem, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrAddressType=sslSrvrAddressType, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrAddress=httpSrvrAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, linkStatus=linkStatus, systemSerialNumber=systemSerialNumber, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, serverDown=serverDown, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrState=httpSrvrState, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCTotServed=ipsRCTotServed, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrNumConn=httpSrvrNumConn, sslProxyActiveConn=sslProxyActiveConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclPort=ipsUrlAclPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCmprAddress=webCmprAddress, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrOutBytes=sslSrvrOutBytes, switchingToMaintMode=switchingToMaintMode, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxyActiveConn=httpProxyActiveConn, sslSrvrPort=sslSrvrPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, serviceName=serviceName, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrTotRefused=httpSrvrTotRefused, webCacheMiss=webCacheMiss, serviceAddress=serviceAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyInBytes=httpProxyInBytes, webCacheLongHdrs=webCacheLongHdrs, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlNormAddress=ipsUrlNormAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, tempHigh=tempHigh, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrTotTimedout=httpSrvrTotTimedout, bwstraps=bwstraps, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsStats=bwsStats, ipsReqSrvcPort=ipsReqSrvcPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, dataPortLinkUp=dataPortLinkUp, ipsUrlNormAddressType=ipsUrlNormAddressType, raidDegrading=raidDegrading, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsHdrAclPort=ipsHdrAclPort, cpuUtilization=cpuUtilization, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyPort=httpProxyPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, dataPathStatus=dataPathStatus, sslProxyCacheTimeouts=sslProxyCacheTimeouts, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyTotalConn=httpProxyTotalConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheReq=webCacheReq, serviceStatus=serviceStatus, highAvailabilityStatus=highAvailabilityStatus, sslProxyErrPms=sslProxyErrPms, sslProxyAddress=sslProxyAddress, uptime=uptime, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyAddressType=sslProxyAddressType, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrOutBytes=httpSrvrOutBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsHdrAclHits=ipsHdrAclHits, webCacheProtocol=webCacheProtocol, webCmprPort=webCmprPort, smAgentName=smAgentName, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCacheCachedObjects=webCacheCachedObjects, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecPort=ipsCookieSecPort, totalBandwidth=totalBandwidth, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, processCountHigh=processCountHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, operationalMode=operationalMode, freeMem=freeMem, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, totalServers=totalServers, ipsRCTotDropped=ipsRCTotDropped, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsMIBCompliances=bwsMIBCompliances, logStorage=logStorage, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsCookieSecAddress=ipsCookieSecAddress, bwsMIBCompliance=bwsMIBCompliance, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, activeApplications=activeApplications, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, cpuFanSpeed=cpuFanSpeed, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCmprProtocol=webCmprProtocol, memoryUsageHigh=memoryUsageHigh, systemFanSpeed=systemFanSpeed, totalAttacks=totalAttacks, dataPortLinkDown=dataPortLinkDown, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCAddress=ipsRCAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrInBytes=httpSrvrInBytes, httpSrvrAddressType=httpSrvrAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, tempCritical=tempCritical, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrAddress=sslSrvrAddress, sslProxyTotalReq=sslProxyTotalReq, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyAddress=httpProxyAddress, sslSrvrNumConn=sslSrvrNumConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, serverUp=serverUp, webCachePort=webCachePort, sslSrvrInBytes=sslSrvrInBytes, webCmprAddressType=webCmprAddressType, httpProxyOutBytes=httpProxyOutBytes, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyParseErr=httpProxyParseErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrMinResTime=sslSrvrMinResTime, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, firmwareStorageHigh=firmwareStorageHigh, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, peerUp=peerUp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyServerReq=httpProxyServerReq, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, totalApplications=totalApplications, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheHits=webCacheHits, PYSNMP_MODULE_ID=bws, fanDead=fanDead, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyInBytes=sslProxyInBytes, ipsUrlAclReserved=ipsUrlAclReserved, cpuTemperature=cpuTemperature, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsMessage=bwsMessage, httpSrvrPort=httpSrvrPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, peerDown=peerDown, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, servicePort=servicePort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCacheCacheableRes=webCacheCacheableRes, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrState=sslSrvrState, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, systemLoad=systemLoad, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bws=bws, ipsReqLimitAddress=ipsReqLimitAddress)
