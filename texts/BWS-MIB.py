...
Counter32, Bits, Unsigned32, ObjectIdentity, IpAddress, iso, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "Unsigned32", "ObjectIdentity", "IpAddress", "iso", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, memUtilization=memUtilization, httpSrvrState=httpSrvrState, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, totalServers=totalServers, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, tempCritical=tempCritical, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, firmwareStorageHigh=firmwareStorageHigh, activeServers=activeServers, sslSrvrAddressType=sslSrvrAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyInBytes=sslProxyInBytes, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyActiveConn=httpProxyActiveConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, serviceAddress=serviceAddress, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, firmwareStorage=firmwareStorage, ipsUrlNormPort=ipsUrlNormPort, httpProxyServerAbrt=httpProxyServerAbrt, webCacheLongHdrs=webCacheLongHdrs, httpSrvrAddress=httpSrvrAddress, linkStatus=linkStatus, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsStatsGroup=bwsStatsGroup, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, operationalMode=operationalMode, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyTotalReq=httpProxyTotalReq, sslProxyAddress=sslProxyAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsRCAddressType=ipsRCAddressType, bwsMIBCompliance=bwsMIBCompliance, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrAddress=sslSrvrAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCPort=ipsRCPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, logStorageHigh=logStorageHigh, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, logStorage=logStorage, sslSrvrState=sslSrvrState, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlAclReserved=ipsUrlAclReserved, peerUp=peerUp, cpuTemperature=cpuTemperature, sslProxyCacheMiss=sslProxyCacheMiss, highAvailabilityStatus=highAvailabilityStatus, cpuUtilization=cpuUtilization, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsCacheStatsEntry=bwsCacheStatsEntry, memoryUsageHigh=memoryUsageHigh, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecTampered=ipsCookieSecTampered, uptime=uptime, freeMem=freeMem, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, cpuFanSpeed=cpuFanSpeed, sslProxyErrPms=sslProxyErrPms, serverDown=serverDown, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bws=bws, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, smNumUserSessions=smNumUserSessions, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyInBytes=httpProxyInBytes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, processCountHigh=processCountHigh, webCacheReq=webCacheReq, fanDead=fanDead, systemSerialNumber=systemSerialNumber, ipsRCTotQueued=ipsRCTotQueued, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsRCTotDropped=ipsRCTotDropped, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCAddress=ipsRCAddress, switchingToMaintMode=switchingToMaintMode, webCacheStale=webCacheStale, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, peerDown=peerDown, bwsServiceStatusEntry=bwsServiceStatusEntry, serviceStatus=serviceStatus, sslSrvrNumConn=sslSrvrNumConn, httpProxyOutBytes=httpProxyOutBytes, httpSrvrMinResTime=httpSrvrMinResTime, serverUp=serverUp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyAddress=httpProxyAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrNumConn=httpSrvrNumConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsMIBCompliances=bwsMIBCompliances, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, systemFailure=systemFailure, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, activeApplications=activeApplications, ipsRCTimeStamp=ipsRCTimeStamp, systemFailOver=systemFailOver, totalMem=totalMem, webCmprAddressType=webCmprAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsStats=bwsStats, sslSrvrInBytes=sslSrvrInBytes, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, switchingToBypassMode=switchingToBypassMode, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, switchingToInlineMode=switchingToInlineMode, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsHdrAclPort=ipsHdrAclPort, bwsMIBConformance=bwsMIBConformance, webCacheProtocol=webCacheProtocol, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, smAgentName=smAgentName, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsServiceStatusTable=bwsServiceStatusTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyCacheHits=sslProxyCacheHits, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, servicePort=servicePort, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsMessage=bwsMessage, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyAddressType=sslProxyAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, systemLoad=systemLoad, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, vipStatus=vipStatus, httpSrvrInBytes=httpSrvrInBytes, totalApplications=totalApplications, sslProxyPort=sslProxyPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, dataPathStatus=dataPathStatus, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsTrapGroup=bwsTrapGroup, systemFanSpeed=systemFanSpeed, webCacheCacheableRes=webCacheCacheableRes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyParseErr=httpProxyParseErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCmprPort=webCmprPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, serviceName=serviceName, httpProxyServerErr=httpProxyServerErr, sslProxyOutBytes=sslProxyOutBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, dataPortLinkUp=dataPortLinkUp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, srvcName=srvcName, ipsCookieSecPort=ipsCookieSecPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyServerReq=httpProxyServerReq, httpSrvrPort=httpSrvrPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprAddress=webCmprAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheBytesOut=webCacheBytesOut, webCacheCachedObjects=webCacheCachedObjects, webCachePort=webCachePort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyActiveConn=sslProxyActiveConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, totalBandwidth=totalBandwidth, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyTotalConn=sslProxyTotalConn, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp)
mibBuilder.exportSymbols("BWS-MIB", bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitPort=ipsReqLimitPort, smRealmName=smRealmName, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, totalAttacks=totalAttacks, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheMiss=webCacheMiss, webCacheAddress=webCacheAddress, securityDefUpdates=securityDefUpdates, energizeUpdateExpire=energizeUpdateExpire, webCmprProtocol=webCmprProtocol, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyTotalReq=sslProxyTotalReq, sslSrvrPort=sslSrvrPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, virusDefUpdates=virusDefUpdates, httpSrvrTotSuccess=httpSrvrTotSuccess, PYSNMP_MODULE_ID=bws, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, tempHigh=tempHigh, httpProxyAddressType=httpProxyAddressType, httpProxyPort=httpProxyPort, httpProxyTotalConn=httpProxyTotalConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheHits=webCacheHits, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsLrnSrvcPort=ipsLrnSrvcPort, raidDegrading=raidDegrading, bwstraps=bwstraps, bwsMIBGroups=bwsMIBGroups, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlAclPort=ipsUrlAclPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqSrvcAddressType=ipsReqSrvcAddressType, dataPortLinkDown=dataPortLinkDown, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsRCTotServed=ipsRCTotServed)
