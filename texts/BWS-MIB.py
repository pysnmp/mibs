...
NotificationType, Gauge32, Counter64, ModuleIdentity, Integer32, Unsigned32, IpAddress, iso, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "Integer32", "Unsigned32", "IpAddress", "iso", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", fanDead=fanDead, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, switchingToBypassMode=switchingToBypassMode, sslSrvrAddress=sslSrvrAddress, sslProxyTotalConn=sslProxyTotalConn, serverUp=serverUp, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, raidDegrading=raidDegrading, totalAttacks=totalAttacks, httpProxyServerReq=httpProxyServerReq, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, PYSNMP_MODULE_ID=bws, activeServers=activeServers, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlNormPort=ipsUrlNormPort, serviceStatus=serviceStatus, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrInBytes=httpSrvrInBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, serviceName=serviceName, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, serviceAddress=serviceAddress, httpProxyAddress=httpProxyAddress, highAvailabilityStatus=highAvailabilityStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyUnknownRsp=httpProxyUnknownRsp, memUtilization=memUtilization, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotResponse=sslSrvrTotResponse, webCacheHits=webCacheHits, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, vipStatus=vipStatus, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheAddress=webCacheAddress, cpuFanSpeed=cpuFanSpeed, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, logStorageHigh=logStorageHigh, ipsReqLimitPort=ipsReqLimitPort, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrNumConn=httpSrvrNumConn, bwsCompressionStatsTable=bwsCompressionStatsTable, webCmprPort=webCmprPort, sslProxyActiveConn=sslProxyActiveConn, servicePort=servicePort, sslProxyErrPms=sslProxyErrPms, ipsWebAddrTransPort=ipsWebAddrTransPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, peerUp=peerUp, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwstraps=bwstraps, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyCurrentConn=sslProxyCurrentConn, totalApplications=totalApplications, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlAclPort=ipsUrlAclPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqSrvcPort=ipsReqSrvcPort, webCmprAddress=webCmprAddress, firmwareStorageHigh=firmwareStorageHigh, httpSrvrPort=httpSrvrPort, httpSrvrAvgResTime=httpSrvrAvgResTime, systemFailOver=systemFailOver, freeMem=freeMem, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyTotalReq=httpProxyTotalReq, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsCookieSecAddress=ipsCookieSecAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrAddressType=sslSrvrAddressType, totalBandwidth=totalBandwidth, uptime=uptime, bwsStats=bwsStats, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, srvcName=srvcName, httpSrvrNumFreeConn=httpSrvrNumFreeConn, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheStale=webCacheStale, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, serverDown=serverDown, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, linkStatus=linkStatus, cpuTemperature=cpuTemperature, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, operationalMode=operationalMode, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, systemFanSpeed=systemFanSpeed, httpSrvrState=httpSrvrState, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, smNumUserSessions=smNumUserSessions, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsHdrAclPort=ipsHdrAclPort, energizeUpdateExpire=energizeUpdateExpire, bwsMIBGroups=bwsMIBGroups, bwsMIBCompliance=bwsMIBCompliance, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsStatsGroup=bwsStatsGroup, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, logStorage=logStorage, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, peerDown=peerDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsHdrAclHits=ipsHdrAclHits, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyTotalConn=httpProxyTotalConn, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, smRealmName=smRealmName, tempHigh=tempHigh, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCAddress=ipsRCAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrInBytes=sslSrvrInBytes, virusDefUpdates=virusDefUpdates, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcAddressType=ipsReqSrvcAddressType, systemLoad=systemLoad, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheReq=webCacheReq, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsCacheStatsTable=bwsCacheStatsTable, bwsMIBConformance=bwsMIBConformance, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlAddress=ipsAccessCtrlAddress, systemSerialNumber=systemSerialNumber, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsMIBCompliances=bwsMIBCompliances, httpProxyServerErr=httpProxyServerErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrOutBytes=sslSrvrOutBytes, memoryUsageHigh=memoryUsageHigh, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, processCountHigh=processCountHigh, webCacheProtocol=webCacheProtocol, activeApplications=activeApplications, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyCacheMiss=sslProxyCacheMiss, bwsMessage=bwsMessage, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyPort=sslProxyPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalMem=totalMem, webCmprAddressType=webCmprAddressType, webCacheCachedObjects=webCacheCachedObjects, ipsRCPort=ipsRCPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsRCTotQueued=ipsRCTotQueued, httpProxyInBytes=httpProxyInBytes, tempCritical=tempCritical, ipsUrlAclAddress=ipsUrlAclAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCmprProtocol=webCmprProtocol, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyPort=httpProxyPort, totalServers=totalServers, webCacheAddressType=webCacheAddressType, sslProxyAddressType=sslProxyAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyCacheHits=sslProxyCacheHits)
mibBuilder.exportSymbols("BWS-MIB", ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCTotServed=ipsRCTotServed, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyParseErr=httpProxyParseErr, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsTrapGroup=bwsTrapGroup, bwsSMUserSessionTable=bwsSMUserSessionTable, firmwareStorage=firmwareStorage, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheMiss=webCacheMiss, dataPortLinkUp=dataPortLinkUp, httpProxyActiveConn=httpProxyActiveConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, dataPathStatus=dataPathStatus, bws=bws, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, dataPortLinkDown=dataPortLinkDown, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, systemFailure=systemFailure, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrState=sslSrvrState, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyOutBytes=httpProxyOutBytes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheCacheableRes=webCacheCacheableRes, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, cpuUtilization=cpuUtilization, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrAddress=httpSrvrAddress, securityDefUpdates=securityDefUpdates, httpSrvrAddressType=httpSrvrAddressType, sslProxyAddress=sslProxyAddress, httpProxyAddressType=httpProxyAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, smAgentName=smAgentName, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, switchingToMaintMode=switchingToMaintMode, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrPort=sslSrvrPort, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyInBytes=sslProxyInBytes, ipsRCAddressType=ipsRCAddressType, webCachePort=webCachePort, webCacheBytesOut=webCacheBytesOut)
