...
NotificationType, Unsigned32, ModuleIdentity, Integer32, IpAddress, MibIdentifier, Gauge32, Bits, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "ModuleIdentity", "Integer32", "IpAddress", "MibIdentifier", "Gauge32", "Bits", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, totalApplications=totalApplications, switchingToMaintMode=switchingToMaintMode, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsHdrAclAddress=ipsHdrAclAddress, serviceAddress=serviceAddress, memUtilization=memUtilization, sslProxyPort=sslProxyPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyOutBytes=httpProxyOutBytes, switchingToInlineMode=switchingToInlineMode, linkStatus=linkStatus, sslProxyOutBytes=sslProxyOutBytes, bwsTrapGroup=bwsTrapGroup, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, systemSerialNumber=systemSerialNumber, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyTotalReq=httpProxyTotalReq, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrOutBytes=sslSrvrOutBytes, virusDefUpdates=virusDefUpdates, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, serverUp=serverUp, vipStatus=vipStatus, ipsReqLimitAddress=ipsReqLimitAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, tempCritical=tempCritical, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyAddressType=sslProxyAddressType, webCacheAddress=webCacheAddress, ipsRCAddressType=ipsRCAddressType, cpuUtilization=cpuUtilization, fanDead=fanDead, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCTotDropped=ipsRCTotDropped, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrInBytes=sslSrvrInBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrAddress=sslSrvrAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrNumConn=httpSrvrNumConn, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheAddressType=webCacheAddressType, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, activeApplications=activeApplications, httpProxyAddress=httpProxyAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyAddressType=httpProxyAddressType, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, logStorageHigh=logStorageHigh, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwstraps=bwstraps, webCacheReq=webCacheReq, PYSNMP_MODULE_ID=bws, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, operationalMode=operationalMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyCacheHits=sslProxyCacheHits, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrNumConn=sslSrvrNumConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrSrvcAddress=httpSrvrSrvcAddress, srvcName=srvcName, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyTotalConn=httpProxyTotalConn, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, peerUp=peerUp, freeMem=freeMem, uptime=uptime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrPort=httpSrvrPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, switchingToBypassMode=switchingToBypassMode, dataPortLinkDown=dataPortLinkDown, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, totalServers=totalServers, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, totalAttacks=totalAttacks, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, totalBandwidth=totalBandwidth, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, firmwareStorageHigh=firmwareStorageHigh, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, tempHigh=tempHigh, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprAddressType=webCmprAddressType, sslProxyAddress=sslProxyAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsHdrAclPort=ipsHdrAclPort, webCacheHits=webCacheHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, currentFirmwareVersion=currentFirmwareVersion, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitPort=ipsReqLimitPort, httpProxyInBytes=httpProxyInBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrInBytes=httpSrvrInBytes, totalMem=totalMem, webCacheCacheableRes=webCacheCacheableRes, serviceStatus=serviceStatus, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsRCPort=ipsRCPort, httpProxyServerErr=httpProxyServerErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, systemFailOver=systemFailOver, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlAclAddress=ipsUrlAclAddress, webCacheMiss=webCacheMiss, systemFanSpeed=systemFanSpeed, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsRCTotQueued=ipsRCTotQueued, sslSrvrState=sslSrvrState, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheProtocol=webCacheProtocol, dataPathStatus=dataPathStatus, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, processCountHigh=processCountHigh, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMIBCompliances=bwsMIBCompliances, httpSrvrOutBytes=httpSrvrOutBytes, bwsStatsGroup=bwsStatsGroup, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCmprProtocol=webCmprProtocol, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyClientAbrt=httpProxyClientAbrt, httpProxySessionTimeOut=httpProxySessionTimeOut, firmwareStorage=firmwareStorage, highAvailabilityStatus=highAvailabilityStatus, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, raidDegrading=raidDegrading, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqSrvcAddress=ipsReqSrvcAddress, peerDown=peerDown, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrPort=sslSrvrPort, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, serviceName=serviceName, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormPort=ipsUrlNormPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyServerReq=httpProxyServerReq, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotTimedout=httpSrvrTotTimedout, webCachePort=webCachePort, httpProxyActiveConn=httpProxyActiveConn, securityDefUpdates=securityDefUpdates, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, cpuTemperature=cpuTemperature, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsStats=bwsStats, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCmprPort=webCmprPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, smRealmName=smRealmName, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxyParseErr=httpProxyParseErr, activeServers=activeServers, bwsMIBCompliance=bwsMIBCompliance, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsCacheStatsTable=bwsCacheStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable)
mibBuilder.exportSymbols("BWS-MIB", sslProxyActiveConn=sslProxyActiveConn, httpProxyPort=httpProxyPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsRCTotServed=ipsRCTotServed, bwsServiceStatusTable=bwsServiceStatusTable, logStorage=logStorage, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, energizeUpdateExpire=energizeUpdateExpire, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsMIBConformance=bwsMIBConformance, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, systemLoad=systemLoad, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, serverDown=serverDown, webCacheStale=webCacheStale, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrState=httpSrvrState, sslProxyInBytes=sslProxyInBytes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsSslProxyStatsTable=bwsSslProxyStatsTable, smNumUserSessions=smNumUserSessions, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrAddressType=httpSrvrAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrAvgResTime=httpSrvrAvgResTime, webCmprAddress=webCmprAddress, sslProxyErrPms=sslProxyErrPms, systemFailure=systemFailure, bwsServiceStatusEntry=bwsServiceStatusEntry, dataPortLinkUp=dataPortLinkUp, smAgentName=smAgentName, ipsRCTotOutOfResource=ipsRCTotOutOfResource, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, cpuFanSpeed=cpuFanSpeed, bwsMIBGroups=bwsMIBGroups, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, servicePort=servicePort, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsRCAddress=ipsRCAddress, bws=bws, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsMessage=bwsMessage, sslProxyCacheMiss=sslProxyCacheMiss, memoryUsageHigh=memoryUsageHigh, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr)
