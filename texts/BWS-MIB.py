...
ModuleIdentity, ObjectIdentity, Unsigned32, Counter64, iso, TimeTicks, Integer32, NotificationType, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter64", "iso", "TimeTicks", "Integer32", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, energizeUpdateExpire=energizeUpdateExpire, peerDown=peerDown, sslSrvrState=sslSrvrState, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyOutBytes=sslProxyOutBytes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrInBytes=httpSrvrInBytes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, firmwareStorage=firmwareStorage, sslSrvrSrvcAddress=sslSrvrSrvcAddress, systemFailure=systemFailure, systemFailOver=systemFailOver, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, cpuUtilization=cpuUtilization, httpSrvrPort=httpSrvrPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, smAgentName=smAgentName, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyParseErr=httpProxyParseErr, ipsHdrAclHits=ipsHdrAclHits, serverDown=serverDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, securityDefUpdates=securityDefUpdates, webCmprPort=webCmprPort, raidDegrading=raidDegrading, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyActiveConn=httpProxyActiveConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsHdrAclPort=ipsHdrAclPort, sharedSecretKeyExpired=sharedSecretKeyExpired, tempHigh=tempHigh, vipStatus=vipStatus, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlAddress=ipsAccessCtrlAddress, peerUp=peerUp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, processCountHigh=processCountHigh, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsCookieSecPort=ipsCookieSecPort, httpProxyTotalReq=httpProxyTotalReq, switchingToMaintMode=switchingToMaintMode, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrTotRefused=httpSrvrTotRefused, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheStale=webCacheStale, sslSrvrNumConn=sslSrvrNumConn, servicePort=servicePort, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrAvgResTime=sslSrvrAvgResTime, dataPortLinkUp=dataPortLinkUp, httpSrvrMinResTime=httpSrvrMinResTime, bwsStats=bwsStats, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheMiss=webCacheMiss, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyServerReq=httpProxyServerReq, bwstraps=bwstraps, webCachePort=webCachePort, httpProxyAddressType=httpProxyAddressType, cpuTemperature=cpuTemperature, httpProxyPort=httpProxyPort, virusDefUpdates=virusDefUpdates, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyTotalConn=httpProxyTotalConn, PYSNMP_MODULE_ID=bws, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, logStorage=logStorage, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, serviceStatus=serviceStatus, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsServiceStatusTable=bwsServiceStatusTable, uptime=uptime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrPort=sslSrvrPort, sslProxyActiveConn=sslProxyActiveConn, sslSrvrAddressType=sslSrvrAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsRCTotServed=ipsRCTotServed, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheCachedObjects=webCacheCachedObjects, totalMem=totalMem, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsMIBCompliance=bwsMIBCompliance, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlNormPort=ipsUrlNormPort, httpProxyOutBytes=httpProxyOutBytes, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsCookieSecAddressType=ipsCookieSecAddressType, memUtilization=memUtilization, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrAddress=httpSrvrAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheAddress=webCacheAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, totalBandwidth=totalBandwidth, webCmprAddress=webCmprAddress, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsMessage=bwsMessage, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrInBytes=sslSrvrInBytes, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, dataPathStatus=dataPathStatus, smNumUserSessions=smNumUserSessions, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsStatsGroup=bwsStatsGroup, sslSrvrMaxResTime=sslSrvrMaxResTime, tempCritical=tempCritical, ipsUrlPolicyAddress=ipsUrlPolicyAddress, linkStatus=linkStatus, ipsHdrAclAddress=ipsHdrAclAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, memoryUsageHigh=memoryUsageHigh, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrTotRefused=sslSrvrTotRefused, highAvailabilityStatus=highAvailabilityStatus, totalServers=totalServers, activeApplications=activeApplications, httpProxyAddress=httpProxyAddress, fanDead=fanDead, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyAddressType=sslProxyAddressType, webCacheAddressType=webCacheAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlAclAddressType=ipsUrlAclAddressType, cpuFanSpeed=cpuFanSpeed, sslProxyInBytes=sslProxyInBytes, webCacheLongHdrs=webCacheLongHdrs, webCacheHits=webCacheHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serviceAddress=serviceAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, srvcName=srvcName, logStorageHigh=logStorageHigh, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyAddress=sslProxyAddress, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyPort=ipsUrlPolicyPort, systemFanSpeed=systemFanSpeed, sslProxyPort=sslProxyPort, bws=bws, webCacheReq=webCacheReq, ipsLrnSrvcPort=ipsLrnSrvcPort, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyServerErr=httpProxyServerErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrAddress=sslSrvrAddress, ipsUrlAclPort=ipsUrlAclPort, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrNumConn=httpSrvrNumConn, ipsReqLimitPort=ipsReqLimitPort, ipsRCAddress=ipsRCAddress, sslProxyErrPms=sslProxyErrPms)
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsCompressionStatsTable=bwsCompressionStatsTable, webCmprAddressType=webCmprAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, activeServers=activeServers, sslProxyCacheHits=sslProxyCacheHits, operationalMode=operationalMode, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, dataPortLinkDown=dataPortLinkDown, smRealmName=smRealmName, totalAttacks=totalAttacks, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCPort=ipsRCPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsHdrAclAddressType=ipsHdrAclAddressType, firmwareStorageHigh=firmwareStorageHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyTotalReq=sslProxyTotalReq, systemSerialNumber=systemSerialNumber, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyTotalConn=sslProxyTotalConn, bwsMIBCompliances=bwsMIBCompliances, currentFirmwareVersion=currentFirmwareVersion, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, systemLoad=systemLoad, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecTampered=ipsCookieSecTampered, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsRCTotQueued=ipsRCTotQueued, totalApplications=totalApplications, webCacheProtocol=webCacheProtocol, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsMIBGroups=bwsMIBGroups, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCTotDropped=ipsRCTotDropped, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyInBytes=httpProxyInBytes, serverUp=serverUp, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxySessionTimeOut=httpProxySessionTimeOut, serviceName=serviceName, freeMem=freeMem, sslProxyCacheMiss=sslProxyCacheMiss, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrState=httpSrvrState)
