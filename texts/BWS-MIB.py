...
iso, TimeTicks, ModuleIdentity, NotificationType, Gauge32, Counter32, ObjectIdentity, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "ModuleIdentity", "NotificationType", "Gauge32", "Counter32", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", bwsMIBGroups=bwsMIBGroups, webCacheCachedObjects=webCacheCachedObjects, dataPortLinkUp=dataPortLinkUp, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyActiveConn=sslProxyActiveConn, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyTotalReq=sslProxyTotalReq, sslProxyCurrentConn=sslProxyCurrentConn, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrState=sslSrvrState, activeServers=activeServers, firmwareStorage=firmwareStorage, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyOutBytes=httpProxyOutBytes, dataPortLinkDown=dataPortLinkDown, switchingToMaintMode=switchingToMaintMode, bwsMIBConformance=bwsMIBConformance, webCacheLongHdrs=webCacheLongHdrs, httpProxyAddress=httpProxyAddress, totalAttacks=totalAttacks, totalApplications=totalApplications, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, systemSerialNumber=systemSerialNumber, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyInBytes=httpProxyInBytes, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlNormPort=ipsUrlNormPort, dataPathStatus=dataPathStatus, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqSrvcAddressType=ipsReqSrvcAddressType, systemFailure=systemFailure, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, cpuTemperature=cpuTemperature, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, tempHigh=tempHigh, webCacheMiss=webCacheMiss, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, linkStatus=linkStatus, ipsUrlAclPort=ipsUrlAclPort, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrNumConn=httpSrvrNumConn, systemLoad=systemLoad, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheHits=webCacheHits, bwstraps=bwstraps, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyPort=httpProxyPort, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrNumConn=sslSrvrNumConn, sslProxyAddress=sslProxyAddress, systemFanSpeed=systemFanSpeed, smNumUserSessions=smNumUserSessions, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bws=bws, smAgentName=smAgentName, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, memUtilization=memUtilization, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsHdrAclPort=ipsHdrAclPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, PYSNMP_MODULE_ID=bws, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsTrapGroup=bwsTrapGroup, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheStale=webCacheStale, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrAddressType=sslSrvrAddressType, webCacheReq=webCacheReq, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, securityDefUpdates=securityDefUpdates, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrTotResponse=sslSrvrTotResponse, cpuFanSpeed=cpuFanSpeed, bwsCompressionStatsTable=bwsCompressionStatsTable, sslProxyErrPms=sslProxyErrPms, webCacheBytesOut=webCacheBytesOut, serverDown=serverDown, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, totalMem=totalMem, ipsUrlAclReserved=ipsUrlAclReserved, webCacheAddressType=webCacheAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsRCAddress=ipsRCAddress, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, cpuUtilization=cpuUtilization, sslSrvrPort=sslSrvrPort, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, memoryUsageHigh=memoryUsageHigh, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, peerDown=peerDown, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyServerReq=httpProxyServerReq, sslSrvrInBytes=sslSrvrInBytes, servicePort=servicePort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, firmwareStorageHigh=firmwareStorageHigh, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrAddressType=httpSrvrAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecTampered=ipsCookieSecTampered, uptime=uptime, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsMIBCompliances=bwsMIBCompliances, httpSrvrState=httpSrvrState, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyPort=sslProxyPort, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitPort=ipsReqLimitPort, webCmprProtocol=webCmprProtocol, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsRCPort=ipsRCPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrPort=httpSrvrPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsHdrAclHits=ipsHdrAclHits, httpProxyActiveConn=httpProxyActiveConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, peerUp=peerUp, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, tempCritical=tempCritical, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, freeMem=freeMem, serviceStatus=serviceStatus, webCmprAddress=webCmprAddress, httpSrvrTotRefused=httpSrvrTotRefused, bwsStats=bwsStats, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCmprAddressType=webCmprAddressType, sslSrvrAddress=sslSrvrAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsRCAddressType=ipsRCAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyInBytes=sslProxyInBytes, httpProxyTotalConn=httpProxyTotalConn, processCountHigh=processCountHigh, httpProxyTotalReq=httpProxyTotalReq, webCacheAddress=webCacheAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, logStorageHigh=logStorageHigh, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, raidDegrading=raidDegrading, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serviceName=serviceName, bwsMessage=bwsMessage, sslSrvrMinResTime=sslSrvrMinResTime, activeApplications=activeApplications, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheProtocol=webCacheProtocol, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable)
mibBuilder.exportSymbols("BWS-MIB", currentFirmwareVersion=currentFirmwareVersion, totalBandwidth=totalBandwidth, vipStatus=vipStatus, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsServiceStatusEntry=bwsServiceStatusEntry, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMIBCompliance=bwsMIBCompliance, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprPort=webCmprPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrInBytes=httpSrvrInBytes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, smRealmName=smRealmName, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsStatsGroup=bwsStatsGroup, energizeUpdateExpire=energizeUpdateExpire, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyWAFWarnings=httpProxyWAFWarnings, firmwareUpdateAvailable=firmwareUpdateAvailable, operationalMode=operationalMode, sslProxyCacheHits=sslProxyCacheHits, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrOutBytes=httpSrvrOutBytes, switchingToBypassMode=switchingToBypassMode, virusDefUpdates=virusDefUpdates, ipsCookieSecPort=ipsCookieSecPort, httpProxyParseErr=httpProxyParseErr, ipsRCTotQueued=ipsRCTotQueued, totalServers=totalServers, webCachePort=webCachePort, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, fanDead=fanDead, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyAddressType=httpProxyAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serverUp=serverUp, logStorage=logStorage, httpSrvrTotSuccess=httpSrvrTotSuccess, systemFailOver=systemFailOver, sslProxyAddressType=sslProxyAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, srvcName=srvcName, serviceAddress=serviceAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCacheCacheableRes=webCacheCacheableRes, sslSrvrTotRefused=sslSrvrTotRefused, bwsSMUserSessionTable=bwsSMUserSessionTable)
