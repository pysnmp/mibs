...
iso, TimeTicks, Bits, Counter32, Unsigned32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, ObjectIdentity, Gauge32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Bits", "Counter32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "ObjectIdentity", "Gauge32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", ipsHdrAclHits=ipsHdrAclHits, sslProxyInBytes=sslProxyInBytes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrPort=httpSrvrPort, firmwareStorage=firmwareStorage, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, tempCritical=tempCritical, energizeUpdateExpire=energizeUpdateExpire, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, logStorageHigh=logStorageHigh, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrInBytes=httpSrvrInBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, totalApplications=totalApplications, cpuTemperature=cpuTemperature, linkStatus=linkStatus, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheReq=webCacheReq, sslSrvrTotTimedout=sslSrvrTotTimedout, webCacheBytesOut=webCacheBytesOut, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyInBytes=httpProxyInBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlNormPort=ipsUrlNormPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, dataPortLinkUp=dataPortLinkUp, webCmprProtocol=webCmprProtocol, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsMIBCompliance=bwsMIBCompliance, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, systemFailOver=systemFailOver, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, peerUp=peerUp, PYSNMP_MODULE_ID=bws, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, freeMem=freeMem, serviceName=serviceName, activeServers=activeServers, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, systemFailure=systemFailure, srvcName=srvcName, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyTotalReq=httpProxyTotalReq, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrOutBytes=httpSrvrOutBytes, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, dataPathStatus=dataPathStatus, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyPort=sslProxyPort, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, switchingToBypassMode=switchingToBypassMode, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, logStorage=logStorage, sslSrvrPort=sslSrvrPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, uptime=uptime, peerDown=peerDown, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, virusDefUpdates=virusDefUpdates, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyActiveConn=httpProxyActiveConn, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bws=bws, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheCacheableRes=webCacheCacheableRes, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsRCTotQueued=ipsRCTotQueued, serviceStatus=serviceStatus, memUtilization=memUtilization, sslProxyErrPms=sslProxyErrPms, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprAddress=webCmprAddress, cpuFanSpeed=cpuFanSpeed, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlNormAddress=ipsUrlNormAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsMessage=bwsMessage, currentFirmwareVersion=currentFirmwareVersion, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprAddressType=webCmprAddressType, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyActiveConn=sslProxyActiveConn, tempHigh=tempHigh, switchingToMaintMode=switchingToMaintMode, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, raidDegrading=raidDegrading, sslProxyCacheHits=sslProxyCacheHits, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrAddress=httpSrvrAddress, webCacheProtocol=webCacheProtocol, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, securityDefUpdates=securityDefUpdates, systemSerialNumber=systemSerialNumber, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyAddressType=sslProxyAddressType, webCacheStale=webCacheStale, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, firmwareStorageHigh=firmwareStorageHigh, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsRCAddress=ipsRCAddress, sslSrvrOutBytes=sslSrvrOutBytes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, serverDown=serverDown, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsMIBCompliances=bwsMIBCompliances, totalBandwidth=totalBandwidth, activeApplications=activeApplications, sslProxyTotalReq=sslProxyTotalReq, systemFanSpeed=systemFanSpeed, ipsHdrAclPort=ipsHdrAclPort, smNumUserSessions=smNumUserSessions, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitPort=ipsReqLimitPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyTotalConn=httpProxyTotalConn, webCacheCachedObjects=webCacheCachedObjects, vipStatus=vipStatus, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyAddress=sslProxyAddress, totalMem=totalMem, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsStatsGroup=bwsStatsGroup, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, processCountHigh=processCountHigh, memoryUsageHigh=memoryUsageHigh, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrNumConn=sslSrvrNumConn, bwstraps=bwstraps, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrAddressType=httpSrvrAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyParseErr=httpProxyParseErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyServerReq=httpProxyServerReq, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyTotalConn=sslProxyTotalConn, ipsRCTotDropped=ipsRCTotDropped, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsMIBGroups=bwsMIBGroups, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyAddress=httpProxyAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, smRealmName=smRealmName, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheHits=webCacheHits, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheAddressType=webCacheAddressType, sslSrvrAddressType=sslSrvrAddressType, servicePort=servicePort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsStats=bwsStats, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, switchingToInlineMode=switchingToInlineMode, sslProxyCurrentConn=sslProxyCurrentConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCachePort=webCachePort, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyPort=httpProxyPort, ipsRCPort=ipsRCPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecPort=ipsCookieSecPort, totalAttacks=totalAttacks, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrMaxResTime=httpSrvrMaxResTime, smAgentName=smAgentName, sslSrvrState=sslSrvrState, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, serviceAddress=serviceAddress, httpProxyServerErr=httpProxyServerErr, sslSrvrAddress=sslSrvrAddress, webCacheAddress=webCacheAddress, operationalMode=operationalMode, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrState=httpSrvrState, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, cpuUtilization=cpuUtilization, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsCacheStatsTable=bwsCacheStatsTable, bwsMIBConformance=bwsMIBConformance, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsSMUserSessionTable=bwsSMUserSessionTable, highAvailabilityStatus=highAvailabilityStatus, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyOutBytes=httpProxyOutBytes, systemLoad=systemLoad, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, totalServers=totalServers, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyAddressType=httpProxyAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheMiss=webCacheMiss, webCacheLongHdrs=webCacheLongHdrs, fanDead=fanDead, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCTimeStamp=ipsRCTimeStamp, serverUp=serverUp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsCookieSecTampered=ipsCookieSecTampered, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprPort=webCmprPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsTrapGroup=bwsTrapGroup, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlAclPort=ipsUrlAclPort)
