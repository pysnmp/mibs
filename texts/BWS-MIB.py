...
NotificationType, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, IpAddress, MibIdentifier, iso, ObjectIdentity, Unsigned32, ModuleIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "IpAddress", "MibIdentifier", "iso", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrPort=httpSrvrPort, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlNormAddressType=ipsUrlNormAddressType, smAgentName=smAgentName, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, serviceAddress=serviceAddress, sslSrvrState=sslSrvrState, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlAclPort=ipsUrlAclPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, uptime=uptime, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, currentFirmwareVersion=currentFirmwareVersion, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrInBytes=sslSrvrInBytes, ipsRCPort=ipsRCPort, webCmprProtocol=webCmprProtocol, totalAttacks=totalAttacks, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsMessage=bwsMessage, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyAddressType=httpProxyAddressType, bws=bws, logStorageHigh=logStorageHigh, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheLongHdrs=webCacheLongHdrs, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, activeApplications=activeApplications, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCacheReq=webCacheReq, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsRCTotServed=ipsRCTotServed, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrTotTimedout=sslSrvrTotTimedout, webCacheAddress=webCacheAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrOutBytes=sslSrvrOutBytes, cpuUtilization=cpuUtilization, sslSrvrSrvcPort=sslSrvrSrvcPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsMIBCompliance=bwsMIBCompliance, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, memUtilization=memUtilization, sslSrvrMinResTime=sslSrvrMinResTime, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyOutBytes=httpProxyOutBytes, webCmprPort=webCmprPort, ipsRCTotDropped=ipsRCTotDropped, sslSrvrMaxResTime=sslSrvrMaxResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCacheCachedObjects=webCacheCachedObjects, ipsHdrAclHits=ipsHdrAclHits, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, switchingToBypassMode=switchingToBypassMode, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheCacheableRes=webCacheCacheableRes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrPort=sslSrvrPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlAclAddress=ipsUrlAclAddress, switchingToMaintMode=switchingToMaintMode, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToInlineMode=switchingToInlineMode, activeServers=activeServers, httpProxyParseErr=httpProxyParseErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, servicePort=servicePort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrAddress=sslSrvrAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, peerDown=peerDown, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, systemLoad=systemLoad, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrMinResTime=httpSrvrMinResTime, totalServers=totalServers, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitAddress=ipsReqLimitAddress, dataPortLinkUp=dataPortLinkUp, httpSrvrInBytes=httpSrvrInBytes, serverDown=serverDown, bwsStats=bwsStats, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrTotReqRejected=httpSrvrTotReqRejected, vipStatus=vipStatus, sslProxyOutBytes=sslProxyOutBytes, webCmprAddressType=webCmprAddressType, httpSrvrAddressType=httpSrvrAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, webCacheHits=webCacheHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, raidDegrading=raidDegrading, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, virusDefUpdates=virusDefUpdates, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqSrvcPort=ipsReqSrvcPort, bwsTrapGroup=bwsTrapGroup, PYSNMP_MODULE_ID=bws, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitAddressType=ipsReqLimitAddressType, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyUnknownRsp=httpProxyUnknownRsp, processCountHigh=processCountHigh, securityDefUpdates=securityDefUpdates, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCacheStale=webCacheStale, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyInBytes=sslProxyInBytes, sslProxyPort=sslProxyPort, httpProxyServerErr=httpProxyServerErr, sslProxyAddress=sslProxyAddress, httpProxyPort=httpProxyPort, ipsCookieSecPort=ipsCookieSecPort, webCachePort=webCachePort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, webCmprAddress=webCmprAddress, cpuTemperature=cpuTemperature, serviceStatus=serviceStatus, httpSrvrNumConn=httpSrvrNumConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, dataPortLinkDown=dataPortLinkDown, bwsMIBCompliances=bwsMIBCompliances, firmwareStorageHigh=firmwareStorageHigh, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, energizeUpdateExpire=energizeUpdateExpire, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsCacheStatsEntry=bwsCacheStatsEntry, tempHigh=tempHigh, httpSrvrAvgResTime=httpSrvrAvgResTime, systemFanSpeed=systemFanSpeed, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyTotalConn=sslProxyTotalConn, sslSrvrAddressType=sslSrvrAddressType, webCacheMiss=webCacheMiss, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, memoryUsageHigh=memoryUsageHigh, sslProxyTotalReq=sslProxyTotalReq, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyInBytes=httpProxyInBytes, ipsReqSrvcAddress=ipsReqSrvcAddress, sslProxyAddressType=sslProxyAddressType, systemFailure=systemFailure, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, freeMem=freeMem, logStorage=logStorage, ipsReqLimitPort=ipsReqLimitPort, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrAddress=httpSrvrAddress, firmwareStorage=firmwareStorage, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, tempCritical=tempCritical, ipsCookieSecAddress=ipsCookieSecAddress, ipsRCAddressType=ipsRCAddressType, sslSrvrNumConn=sslSrvrNumConn, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, srvcName=srvcName, fanDead=fanDead, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, totalApplications=totalApplications, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrState=httpSrvrState, sslSrvrTotReqActive=sslSrvrTotReqActive, operationalMode=operationalMode, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCacheProtocol=webCacheProtocol, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, peerUp=peerUp, webCmprCompressibleDataSize=webCmprCompressibleDataSize, smNumUserSessions=smNumUserSessions, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyErrPms=sslProxyErrPms, httpProxyTotalReq=httpProxyTotalReq, webCacheAddressType=webCacheAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsHdrAclPort=ipsHdrAclPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serviceName=serviceName, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyTotalConn=httpProxyTotalConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, linkStatus=linkStatus, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsRCAddress=ipsRCAddress, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsRCStatsTable=bwsIpsRCStatsTable, serverUp=serverUp, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyActiveConn=sslProxyActiveConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwstraps=bwstraps, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, systemFailOver=systemFailOver, bwsMIBConformance=bwsMIBConformance, smRealmName=smRealmName, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalMem=totalMem, httpProxyAddress=httpProxyAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, totalBandwidth=totalBandwidth, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, dataPathStatus=dataPathStatus)
