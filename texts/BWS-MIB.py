...
ObjectIdentity, TimeTicks, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Counter64, MibIdentifier, Bits, Integer32, ModuleIdentity, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Counter64", "MibIdentifier", "Bits", "Integer32", "ModuleIdentity", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyServerReq=httpProxyServerReq, bwsMIBConformance=bwsMIBConformance, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrTotTimedout=httpSrvrTotTimedout, peerDown=peerDown, httpProxyInBytes=httpProxyInBytes, ipsCookieSecAddress=ipsCookieSecAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyAddress=httpProxyAddress, webCacheProtocol=webCacheProtocol, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrNumConn=sslSrvrNumConn, ipsUrlNormPort=ipsUrlNormPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheStale=webCacheStale, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, systemFanSpeed=systemFanSpeed, currentFirmwareVersion=currentFirmwareVersion, sslProxyErrPms=sslProxyErrPms, httpProxyTotalConn=httpProxyTotalConn, dataPortLinkUp=dataPortLinkUp, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyActiveConn=sslProxyActiveConn, activeServers=activeServers, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, virusDefUpdates=virusDefUpdates, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheCachedObjects=webCacheCachedObjects, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyPort=sslProxyPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrInBytes=sslSrvrInBytes, ipsRCPort=ipsRCPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheMiss=webCacheMiss, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsCompressionStatsTable=bwsCompressionStatsTable, webCmprPort=webCmprPort, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclReserved=ipsUrlAclReserved, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwstraps=bwstraps, sslProxyOutBytes=sslProxyOutBytes, httpProxyPort=httpProxyPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, operationalMode=operationalMode, ipsRCTimeStamp=ipsRCTimeStamp, smRealmName=smRealmName, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, switchingToInlineMode=switchingToInlineMode, webCacheAddress=webCacheAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsRCAddressType=ipsRCAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsRCTotServed=ipsRCTotServed, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsStatsGroup=bwsStatsGroup, uptime=uptime, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, httpProxyServerErr=httpProxyServerErr, totalApplications=totalApplications, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, logStorageHigh=logStorageHigh, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyActiveConn=httpProxyActiveConn, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, serviceStatus=serviceStatus, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrOutBytes=sslSrvrOutBytes, fanDead=fanDead, linkStatus=linkStatus, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrTotRefused=sslSrvrTotRefused, serverDown=serverDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bws=bws, ipsHdrAclHits=ipsHdrAclHits, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, logStorage=logStorage, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, switchingToMaintMode=switchingToMaintMode, sslSrvrState=sslSrvrState, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsHdrAclPort=ipsHdrAclPort, raidDegrading=raidDegrading, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyAddressType=httpProxyAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqSrvcAddressType=ipsReqSrvcAddressType, energizeUpdateExpire=energizeUpdateExpire, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, freeMem=freeMem, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, totalAttacks=totalAttacks, webCachePort=webCachePort, sslSrvrTotResponse=sslSrvrTotResponse, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsTrapGroup=bwsTrapGroup, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrAddressType=sslSrvrAddressType, sslProxyAddress=sslProxyAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheReq=webCacheReq, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, cpuUtilization=cpuUtilization, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, tempCritical=tempCritical, smNumUserSessions=smNumUserSessions, totalServers=totalServers, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCacheHits=webCacheHits, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, PYSNMP_MODULE_ID=bws, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, securityDefUpdates=securityDefUpdates, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlNormAddress=ipsUrlNormAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, vipStatus=vipStatus, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, webCmprProtocol=webCmprProtocol, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyCacheHits=sslProxyCacheHits, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsRCTotDropped=ipsRCTotDropped, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, serviceAddress=serviceAddress, cpuTemperature=cpuTemperature, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, systemFailure=systemFailure, httpSrvrState=httpSrvrState, httpSrvrPort=httpSrvrPort, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxySessionTimeOut=httpProxySessionTimeOut, serverUp=serverUp, webCmprAddress=webCmprAddress, cpuFanSpeed=cpuFanSpeed, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsRCAddress=ipsRCAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, srvcName=srvcName, webCacheLongHdrs=webCacheLongHdrs, serviceName=serviceName, sslProxyInBytes=sslProxyInBytes, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsStats=bwsStats, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr)
mibBuilder.exportSymbols("BWS-MIB", peerUp=peerUp, ipsUrlAclPort=ipsUrlAclPort, dataPortLinkDown=dataPortLinkDown, bwsMessage=bwsMessage, firmwareStorage=firmwareStorage, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyParseErr=httpProxyParseErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, tempHigh=tempHigh, bwsSMUserSessionTable=bwsSMUserSessionTable, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, memoryUsageHigh=memoryUsageHigh, sslSrvrPort=sslSrvrPort, systemLoad=systemLoad, activeApplications=activeApplications, memUtilization=memUtilization, ipsCookieSecPort=ipsCookieSecPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, systemFailOver=systemFailOver, ipsReqLimitPort=ipsReqLimitPort, smAgentName=smAgentName, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrInBytes=httpSrvrInBytes, webCmprAddressType=webCmprAddressType, switchingToBypassMode=switchingToBypassMode, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, firmwareStorageHigh=firmwareStorageHigh, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, systemSerialNumber=systemSerialNumber, servicePort=servicePort, sslSrvrAvgResTime=sslSrvrAvgResTime, totalBandwidth=totalBandwidth, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyTotalReq=sslProxyTotalReq, ipsUrlPolicyAddress=ipsUrlPolicyAddress, dataPathStatus=dataPathStatus, webCacheAddressType=webCacheAddressType, sslProxyAddressType=sslProxyAddressType, bwsMIBCompliances=bwsMIBCompliances, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, processCountHigh=processCountHigh, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcPort=ipsReqSrvcPort, totalMem=totalMem)
