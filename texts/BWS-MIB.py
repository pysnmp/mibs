...
NotificationType, Gauge32, Integer32, ObjectIdentity, iso, TimeTicks, Unsigned32, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Integer32", "ObjectIdentity", "iso", "TimeTicks", "Unsigned32", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyAddress=sslProxyAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsRCTotDropped=ipsRCTotDropped, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrAddressType=sslSrvrAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyAddress=ipsUrlPolicyAddress, activeApplications=activeApplications, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsMIBCompliances=bwsMIBCompliances, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, dataPathStatus=dataPathStatus, bwstraps=bwstraps, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsHdrAclHits=ipsHdrAclHits, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, systemFanSpeed=systemFanSpeed, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, dataPortLinkUp=dataPortLinkUp, peerUp=peerUp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyTotalConn=sslProxyTotalConn, sslSrvrInBytes=sslSrvrInBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, memUtilization=memUtilization, sslSrvrNumConn=sslSrvrNumConn, cpuTemperature=cpuTemperature, operationalMode=operationalMode, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, dataPortLinkDown=dataPortLinkDown, httpProxyServerReq=httpProxyServerReq, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCmprPort=webCmprPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, serviceStatus=serviceStatus, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsHdrAclAddress=ipsHdrAclAddress, webCacheHits=webCacheHits, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyInBytes=sslProxyInBytes, switchingToBypassMode=switchingToBypassMode, ipsUrlNormAddress=ipsUrlNormAddress, logStorageHigh=logStorageHigh, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, activeServers=activeServers, switchingToMaintMode=switchingToMaintMode, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyPort=httpProxyPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, cpuUtilization=cpuUtilization, systemSerialNumber=systemSerialNumber, webCmprAddressType=webCmprAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecPort=ipsCookieSecPort, PYSNMP_MODULE_ID=bws, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsMIBConformance=bwsMIBConformance, totalMem=totalMem, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitAddress=ipsReqLimitAddress, bws=bws, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, firmwareStorage=firmwareStorage, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, logStorage=logStorage, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, srvcName=srvcName, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheReq=webCacheReq, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsRCAddress=ipsRCAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, tempCritical=tempCritical, webCmprProtocol=webCmprProtocol, serverUp=serverUp, httpSrvrPort=httpSrvrPort, sslSrvrPort=sslSrvrPort, sslProxyCurrentConn=sslProxyCurrentConn, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrState=sslSrvrState, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrState=httpSrvrState, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyAddressType=httpProxyAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsStatsGroup=bwsStatsGroup, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlNormPort=ipsUrlNormPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyTotalConn=httpProxyTotalConn, httpProxyOutBytes=httpProxyOutBytes, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyTotalReq=httpProxyTotalReq, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsMessage=bwsMessage, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, vipStatus=vipStatus, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, smAgentName=smAgentName, sslSrvrAddress=sslSrvrAddress, webCacheCachedObjects=webCacheCachedObjects, ipsRCPort=ipsRCPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheStale=webCacheStale, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyActiveConn=httpProxyActiveConn, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyAddress=httpProxyAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, serverDown=serverDown, httpProxyServerErr=httpProxyServerErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrInBytes=httpSrvrInBytes, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsHdrAclPort=ipsHdrAclPort, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrTotResponse=sslSrvrTotResponse, serviceName=serviceName, firmwareStorageHigh=firmwareStorageHigh, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, freeMem=freeMem, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsRCAddressType=ipsRCAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, servicePort=servicePort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, virusDefUpdates=virusDefUpdates, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecAddress=ipsCookieSecAddress, totalBandwidth=totalBandwidth, sslProxyErrPms=sslProxyErrPms, webCacheAddress=webCacheAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyActiveConn=sslProxyActiveConn, httpProxyParseErr=httpProxyParseErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, smRealmName=smRealmName, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTimeStamp=ipsRCTimeStamp, systemFailure=systemFailure, sslProxyTotalReq=sslProxyTotalReq, energizeUpdateExpire=energizeUpdateExpire, totalAttacks=totalAttacks, webCacheProtocol=webCacheProtocol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclReserved=ipsUrlAclReserved, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, memoryUsageHigh=memoryUsageHigh, serviceAddress=serviceAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCmprAddress=webCmprAddress, systemLoad=systemLoad, webCacheAddressType=webCacheAddressType, linkStatus=linkStatus, httpProxyInBytes=httpProxyInBytes)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsStats=bwsStats, totalApplications=totalApplications, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheMiss=webCacheMiss, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, tempHigh=tempHigh, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyPort=sslProxyPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyServerAbrt=httpProxyServerAbrt, webCacheBytesOut=webCacheBytesOut, ipsReqLimitPort=ipsReqLimitPort, webCacheCacheableRes=webCacheCacheableRes, uptime=uptime, ipsUrlAclPort=ipsUrlAclPort, sslProxyAddressType=sslProxyAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsMIBCompliance=bwsMIBCompliance, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlPolicyPort=ipsUrlPolicyPort, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, systemFailOver=systemFailOver, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCachePort=webCachePort, smNumUserSessions=smNumUserSessions, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyCacheHits=sslProxyCacheHits, securityDefUpdates=securityDefUpdates, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, switchingToInlineMode=switchingToInlineMode, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotRefused=sslSrvrTotRefused, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, raidDegrading=raidDegrading, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsCookieSecTampered=ipsCookieSecTampered, peerDown=peerDown, httpSrvrNumConn=httpSrvrNumConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, highAvailabilityStatus=highAvailabilityStatus, fanDead=fanDead, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsCacheStatsTable=bwsCacheStatsTable, processCountHigh=processCountHigh, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, totalServers=totalServers, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCacheLongHdrs=webCacheLongHdrs)
