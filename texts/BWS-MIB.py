...
NotificationType, Counter32, Integer32, Bits, Gauge32, TimeTicks, MibIdentifier, ModuleIdentity, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Integer32", "Bits", "Gauge32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitPort=ipsReqLimitPort, totalAttacks=totalAttacks, ipsRCAddress=ipsRCAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyInBytes=sslProxyInBytes, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, servicePort=servicePort, httpSrvrAddress=httpSrvrAddress, webCmprAddressType=webCmprAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, currentFirmwareVersion=currentFirmwareVersion, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheProtocol=webCacheProtocol, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, smNumUserSessions=smNumUserSessions, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, uptime=uptime, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsStatsGroup=bwsStatsGroup, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, serviceStatus=serviceStatus, ipsRCTotServed=ipsRCTotServed, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyTotalReq=sslProxyTotalReq, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyTotalReq=httpProxyTotalReq, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsMIBCompliance=bwsMIBCompliance, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsTrapGroup=bwsTrapGroup, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrNumConn=sslSrvrNumConn, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyInBytes=httpProxyInBytes, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, activeServers=activeServers, httpSrvrAddressType=httpSrvrAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, logStorageHigh=logStorageHigh, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheAddressType=webCacheAddressType, ipsRCAddressType=ipsRCAddressType, httpProxyPort=httpProxyPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, memUtilization=memUtilization, webCacheHits=webCacheHits, serverUp=serverUp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyParseErr=httpProxyParseErr, cpuTemperature=cpuTemperature, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, processCountHigh=processCountHigh, httpProxyServerReq=httpProxyServerReq, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsStats=bwsStats, vipStatus=vipStatus, PYSNMP_MODULE_ID=bws, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsMIBCompliances=bwsMIBCompliances, ipsCookieSecTampered=ipsCookieSecTampered, totalApplications=totalApplications, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsMIBGroups=bwsMIBGroups, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrTotRefused=httpSrvrTotRefused, peerDown=peerDown, ipsRCTotQueued=ipsRCTotQueued, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, serverDown=serverDown, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, serviceName=serviceName, webCacheBytesOut=webCacheBytesOut, bwsServiceStatusTable=bwsServiceStatusTable, httpProxySessionTimeOut=httpProxySessionTimeOut, raidDegrading=raidDegrading, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, logStorage=logStorage, energizeUpdateExpire=energizeUpdateExpire, ipsUrlAclPort=ipsUrlAclPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, systemFanSpeed=systemFanSpeed, systemFailure=systemFailure, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrInBytes=httpSrvrInBytes, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheStale=webCacheStale, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, linkStatus=linkStatus, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, srvcName=srvcName, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrMaxResTime=httpSrvrMaxResTime, smAgentName=smAgentName, totalServers=totalServers, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyAddressType=sslProxyAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, smRealmName=smRealmName, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsCompressionStatsTable=bwsCompressionStatsTable, cpuUtilization=cpuUtilization, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsHdrAclPort=ipsHdrAclPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, highAvailabilityStatus=highAvailabilityStatus, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, systemSerialNumber=systemSerialNumber, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, dataPathStatus=dataPathStatus, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlNormPort=ipsUrlNormPort, activeApplications=activeApplications, httpProxyActiveConn=httpProxyActiveConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, fanDead=fanDead, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyTotalConn=httpProxyTotalConn, httpProxyAddressType=httpProxyAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, systemFailOver=systemFailOver, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrAddressType=sslSrvrAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwstraps=bwstraps, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsCookieSecPort=ipsCookieSecPort, bws=bws, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheReq=webCacheReq, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrPort=httpSrvrPort, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsMessage=bwsMessage, cpuFanSpeed=cpuFanSpeed, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, dataPortLinkUp=dataPortLinkUp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrAddress=sslSrvrAddress, ipsRCTotDropped=ipsRCTotDropped, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyServerAbrt=httpProxyServerAbrt, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, webCacheAddress=webCacheAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCmprProtocol=webCmprProtocol, httpSrvrState=httpSrvrState, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, tempCritical=tempCritical, dataPortLinkDown=dataPortLinkDown, virusDefUpdates=virusDefUpdates, webCmprAddress=webCmprAddress, ipsReqSrvcPort=ipsReqSrvcPort, firmwareUpdateAvailable=firmwareUpdateAvailable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, firmwareStorage=firmwareStorage, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, operationalMode=operationalMode, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprPort=webCmprPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyFullHandshakes=sslProxyFullHandshakes)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyCacheHits=sslProxyCacheHits, sslSrvrPort=sslSrvrPort, bwsMIBConformance=bwsMIBConformance, serviceAddress=serviceAddress, httpProxyServerErr=httpProxyServerErr, sslProxyCacheMiss=sslProxyCacheMiss, webCachePort=webCachePort, sslProxyOutBytes=sslProxyOutBytes, sslSrvrState=sslSrvrState, sslProxyActiveConn=sslProxyActiveConn, securityDefUpdates=securityDefUpdates, ipsCookieSecAddress=ipsCookieSecAddress, firmwareStorageHigh=firmwareStorageHigh, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, memoryUsageHigh=memoryUsageHigh, ipsReqSrvcAddressType=ipsReqSrvcAddressType, switchingToMaintMode=switchingToMaintMode, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, tempHigh=tempHigh, freeMem=freeMem, switchingToInlineMode=switchingToInlineMode, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyAddress=sslProxyAddress, webCacheLongHdrs=webCacheLongHdrs, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCacheCacheableRes=webCacheCacheableRes, httpSrvrNumConn=httpSrvrNumConn, webCacheMiss=webCacheMiss, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyOutBytes=httpProxyOutBytes, peerUp=peerUp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsRCPort=ipsRCPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, totalMem=totalMem, totalBandwidth=totalBandwidth, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyPort=sslProxyPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyTotalConn=sslProxyTotalConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyErrPms=sslProxyErrPms, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, systemLoad=systemLoad, ipsLrnSrvcAddress=ipsLrnSrvcAddress)
