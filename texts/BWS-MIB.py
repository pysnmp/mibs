...
Unsigned32, IpAddress, Counter32, Gauge32, Counter64, Integer32, ModuleIdentity, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter32", "Gauge32", "Counter64", "Integer32", "ModuleIdentity", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", PYSNMP_MODULE_ID=bws, httpProxyAddress=httpProxyAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsCookieSecPort=ipsCookieSecPort, logStorage=logStorage, sslSrvrInBytes=sslSrvrInBytes, webCmprPort=webCmprPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsStats=bwsStats, sslProxyAddress=sslProxyAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrState=httpSrvrState, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, activeApplications=activeApplications, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsTrapGroup=bwsTrapGroup, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsRCAddress=ipsRCAddress, sslSrvrAddress=sslSrvrAddress, vipStatus=vipStatus, totalApplications=totalApplications, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, uptime=uptime, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, memUtilization=memUtilization, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsHdrAclPort=ipsHdrAclPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, peerUp=peerUp, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyTotalConn=httpProxyTotalConn, webCacheMiss=webCacheMiss, sslSrvrAvgResTime=sslSrvrAvgResTime, switchingToMaintMode=switchingToMaintMode, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrPort=httpSrvrPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrAddressType=sslSrvrAddressType, webCachePort=webCachePort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheAddressType=webCacheAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyBadCRLErr=sslProxyBadCRLErr, totalServers=totalServers, cpuTemperature=cpuTemperature, totalMem=totalMem, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlAclReserved=ipsUrlAclReserved, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bws=bws, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyServerErr=httpProxyServerErr, httpProxyAddressType=httpProxyAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsSMUserSessionEntry=bwsSMUserSessionEntry, switchingToBypassMode=switchingToBypassMode, totalAttacks=totalAttacks, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, linkStatus=linkStatus, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, firmwareStorage=firmwareStorage, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsStatsGroup=bwsStatsGroup, sslSrvrState=sslSrvrState, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, servicePort=servicePort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, energizeUpdateExpire=energizeUpdateExpire, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrPort=sslSrvrPort, webCmprAddressType=webCmprAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyOutBytes=httpProxyOutBytes, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, logStorageHigh=logStorageHigh, httpProxyActiveConn=httpProxyActiveConn, ipsHdrAclHits=ipsHdrAclHits, webCacheCachedObjects=webCacheCachedObjects, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheProtocol=webCacheProtocol, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsCompressionStatsTable=bwsCompressionStatsTable, serverUp=serverUp, sslProxyTotalConn=sslProxyTotalConn, bwstraps=bwstraps, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyTotalReq=sslProxyTotalReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsMIBGroups=bwsMIBGroups, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrAddress=httpSrvrAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCmprAddress=webCmprAddress, raidDegrading=raidDegrading, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, smAgentName=smAgentName, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, systemSerialNumber=systemSerialNumber, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, systemFanSpeed=systemFanSpeed, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsMIBCompliances=bwsMIBCompliances, bwsMIBConformance=bwsMIBConformance, sslProxyCacheHits=sslProxyCacheHits, tempCritical=tempCritical, ipsUrlAclAddressType=ipsUrlAclAddressType, totalBandwidth=totalBandwidth, serviceName=serviceName, processCountHigh=processCountHigh, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyParseErr=httpProxyParseErr, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsHdrAclAddress=ipsHdrAclAddress, ipsRCPort=ipsRCPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyInBytes=httpProxyInBytes, ipsRCTotQueued=ipsRCTotQueued, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheCacheableRes=webCacheCacheableRes, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecTampered=ipsCookieSecTampered, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCmprProtocol=webCmprProtocol, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, securityDefUpdates=securityDefUpdates, httpProxyServerReq=httpProxyServerReq, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlNormPort=ipsUrlNormPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, operationalMode=operationalMode, systemLoad=systemLoad, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyAddressType=sslProxyAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyPort=httpProxyPort, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyActiveConn=sslProxyActiveConn, webCacheReq=webCacheReq, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlAclPort=ipsUrlAclPort, smRealmName=smRealmName, virusDefUpdates=virusDefUpdates, webCacheAddress=webCacheAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCTotServed=ipsRCTotServed, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyPort=sslProxyPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, currentFirmwareVersion=currentFirmwareVersion, bwsMessage=bwsMessage, ipsReqLimitPort=ipsReqLimitPort, dataPathStatus=dataPathStatus, webCacheBytesOut=webCacheBytesOut, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, freeMem=freeMem, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, cpuFanSpeed=cpuFanSpeed, serviceStatus=serviceStatus, httpSrvrAddressType=httpSrvrAddressType, smNumUserSessions=smNumUserSessions, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable)
mibBuilder.exportSymbols("BWS-MIB", dataPortLinkDown=dataPortLinkDown, systemFailOver=systemFailOver, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrOutBytes=sslSrvrOutBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumConn=httpSrvrNumConn, webCacheHits=webCacheHits, srvcName=srvcName, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, serviceAddress=serviceAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, fanDead=fanDead, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyServerAbrt=httpProxyServerAbrt, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, cpuUtilization=cpuUtilization, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, highAvailabilityStatus=highAvailabilityStatus, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyTotalReq=httpProxyTotalReq, memoryUsageHigh=memoryUsageHigh, webCacheLongHdrs=webCacheLongHdrs, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyInBytes=sslProxyInBytes, systemFailure=systemFailure, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrTotReqRejected=httpSrvrTotReqRejected, serverDown=serverDown, switchingToInlineMode=switchingToInlineMode, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, peerDown=peerDown, sslProxyErrPms=sslProxyErrPms, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrNumConn=sslSrvrNumConn, activeServers=activeServers, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, tempHigh=tempHigh, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheStale=webCacheStale, dataPortLinkUp=dataPortLinkUp, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrInBytes=httpSrvrInBytes)
