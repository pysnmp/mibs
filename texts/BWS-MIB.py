...
Bits, IpAddress, Counter64, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Counter32, ObjectIdentity, TimeTicks, iso, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Counter64", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Counter32", "ObjectIdentity", "TimeTicks", "iso", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyInBytes=sslProxyInBytes, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyErrPms=sslProxyErrPms, bwsServiceStatusEntry=bwsServiceStatusEntry, dataPathStatus=dataPathStatus, totalApplications=totalApplications, sslSrvrPort=sslSrvrPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheCacheableRes=webCacheCacheableRes, ipsCookieSecPort=ipsCookieSecPort, firmwareStorage=firmwareStorage, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, logStorageHigh=logStorageHigh, cpuUtilization=cpuUtilization, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, serviceAddress=serviceAddress, totalBandwidth=totalBandwidth, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyPort=sslProxyPort, srvcName=srvcName, ipsUrlNormAddress=ipsUrlNormAddress, serverUp=serverUp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyCacheHits=sslProxyCacheHits, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, totalAttacks=totalAttacks, ipsCookieSecAddress=ipsCookieSecAddress, webCacheLongHdrs=webCacheLongHdrs, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, firmwareStorageHigh=firmwareStorageHigh, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyTotalReq=httpProxyTotalReq, virusDefUpdates=virusDefUpdates, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCacheBytesOut=webCacheBytesOut, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyParseErr=httpProxyParseErr, ipsHdrAclPort=ipsHdrAclPort, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsMIBConformance=bwsMIBConformance, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrNumConn=httpSrvrNumConn, ipsUrlNormPort=ipsUrlNormPort, httpSrvrTotResponse=httpSrvrTotResponse, energizeUpdateExpire=energizeUpdateExpire, webCmprAddress=webCmprAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyTotalConn=sslProxyTotalConn, httpSrvrPort=httpSrvrPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyOutBytes=sslProxyOutBytes, smNumUserSessions=smNumUserSessions, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, systemFanSpeed=systemFanSpeed, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheHits=webCacheHits, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsCacheStatsTable=bwsCacheStatsTable, webCacheStale=webCacheStale, sslProxyTotalReq=sslProxyTotalReq, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrTotTimedout=httpSrvrTotTimedout, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrNumConn=sslSrvrNumConn, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyServerErr=httpProxyServerErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrInBytes=sslSrvrInBytes, httpSrvrInBytes=httpSrvrInBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsStats=bwsStats, switchingToBypassMode=switchingToBypassMode, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrTotReqActive=sslSrvrTotReqActive, peerDown=peerDown, activeServers=activeServers, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCPort=ipsRCPort, bwsStatsGroup=bwsStatsGroup, fanDead=fanDead, webCachePort=webCachePort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrAddress=httpSrvrAddress, ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, tempCritical=tempCritical, httpSrvrState=httpSrvrState, cpuTemperature=cpuTemperature, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyCacheMiss=sslProxyCacheMiss, servicePort=servicePort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, systemFailure=systemFailure, ipsUrlAclAddress=ipsUrlAclAddress, systemFailOver=systemFailOver, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, linkStatus=linkStatus, sslSrvrAddress=sslSrvrAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwstraps=bwstraps, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrState=sslSrvrState, ipsRCTotServed=ipsRCTotServed, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, uptime=uptime, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCmprAddressType=webCmprAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, highAvailabilityStatus=highAvailabilityStatus, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, totalMem=totalMem, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, tempHigh=tempHigh, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheReq=webCacheReq, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCmprProtocol=webCmprProtocol, freeMem=freeMem, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyAddress=sslProxyAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsMIBGroups=bwsMIBGroups, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serviceStatus=serviceStatus, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyAddressType=httpProxyAddressType, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlAclPort=ipsUrlAclPort, dataPortLinkDown=dataPortLinkDown, serverDown=serverDown, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCTimeStamp=ipsRCTimeStamp, webCacheProtocol=webCacheProtocol, cpuFanSpeed=cpuFanSpeed, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, peerUp=peerUp, switchingToInlineMode=switchingToInlineMode, sslProxyAddressType=sslProxyAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsTrapGroup=bwsTrapGroup, httpSrvrTotSuccess=httpSrvrTotSuccess, smAgentName=smAgentName, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, serviceName=serviceName)
mibBuilder.exportSymbols("BWS-MIB", activeApplications=activeApplications, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyOutBytes=httpProxyOutBytes, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, raidDegrading=raidDegrading, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, totalServers=totalServers, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheAddress=webCacheAddress, ipsHdrAclHits=ipsHdrAclHits, bwsMIBCompliances=bwsMIBCompliances, bws=bws, sslSrvrAddressType=sslSrvrAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCurrentConn=sslProxyCurrentConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheCachedObjects=webCacheCachedObjects, ipsRCAddress=ipsRCAddress, systemLoad=systemLoad, bwsMessage=bwsMessage, memUtilization=memUtilization, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, PYSNMP_MODULE_ID=bws, httpProxyServerReq=httpProxyServerReq, httpProxyPort=httpProxyPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyAddress=httpProxyAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, operationalMode=operationalMode, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyTotalConn=httpProxyTotalConn, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsWebAddrTransAddress=ipsWebAddrTransAddress, switchingToMaintMode=switchingToMaintMode, systemSerialNumber=systemSerialNumber, ipsRCTotDropped=ipsRCTotDropped, httpProxyServerAbrt=httpProxyServerAbrt, webCmprPort=webCmprPort, logStorage=logStorage, smRealmName=smRealmName, processCountHigh=processCountHigh, sslSrvrMinResTime=sslSrvrMinResTime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheMiss=webCacheMiss, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, dataPortLinkUp=dataPortLinkUp, httpProxyInBytes=httpProxyInBytes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, vipStatus=vipStatus, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, securityDefUpdates=securityDefUpdates, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions)
