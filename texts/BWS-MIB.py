...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Integer32, NotificationType, Unsigned32, Counter64, TimeTicks, Gauge32, Bits, iso, MibIdentifier, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Integer32", "NotificationType", "Unsigned32", "Counter64", "TimeTicks", "Gauge32", "Bits", "iso", "MibIdentifier", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheProtocol=webCacheProtocol, dataPathStatus=dataPathStatus, webCacheAddressType=webCacheAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecPort=ipsCookieSecPort, fanDead=fanDead, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyWAFWarnings=httpProxyWAFWarnings, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCPort=ipsRCPort, sslProxyCacheMiss=sslProxyCacheMiss, srvcName=srvcName, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrState=sslSrvrState, bwsMIBCompliances=bwsMIBCompliances, operationalMode=operationalMode, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, systemFanSpeed=systemFanSpeed, uptime=uptime, sslProxyPort=sslProxyPort, ipsHdrAclAddressType=ipsHdrAclAddressType, tempCritical=tempCritical, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrMinResTime=sslSrvrMinResTime, totalApplications=totalApplications, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, totalBandwidth=totalBandwidth, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCmprAddressType=webCmprAddressType, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, securityDefUpdates=securityDefUpdates, totalAttacks=totalAttacks, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, currentFirmwareVersion=currentFirmwareVersion, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrAddress=httpSrvrAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyBadDNCErr=sslProxyBadDNCErr, raidDegrading=raidDegrading, bws=bws, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsHdrAclPort=ipsHdrAclPort, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwstraps=bwstraps, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheMiss=webCacheMiss, serviceStatus=serviceStatus, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlAclAddress=ipsUrlAclAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, vipStatus=vipStatus, webCmprAddress=webCmprAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheLongHdrs=webCacheLongHdrs, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serverUp=serverUp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlAclPort=ipsUrlAclPort, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, serviceAddress=serviceAddress, energizeUpdateExpire=energizeUpdateExpire, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyActiveConn=httpProxyActiveConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsTrapGroup=bwsTrapGroup, logStorage=logStorage, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCacheCacheableRes=webCacheCacheableRes, ipsRCAddressType=ipsRCAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, switchingToMaintMode=switchingToMaintMode, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyParseErr=httpProxyParseErr, memUtilization=memUtilization, virusDefUpdates=virusDefUpdates, sslProxyErrPms=sslProxyErrPms, activeServers=activeServers, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, smNumUserSessions=smNumUserSessions, switchingToInlineMode=switchingToInlineMode, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlNormPort=ipsUrlNormPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMIBGroups=bwsMIBGroups, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyPort=httpProxyPort, webCacheStale=webCacheStale, memoryUsageHigh=memoryUsageHigh, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, cpuUtilization=cpuUtilization, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, serviceName=serviceName, httpProxyClientAbrt=httpProxyClientAbrt, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, peerUp=peerUp, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheHits=webCacheHits, ipsRCTotDropped=ipsRCTotDropped, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyCurrentConn=sslProxyCurrentConn, dataPortLinkUp=dataPortLinkUp, httpProxyAddress=httpProxyAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, firmwareStorage=firmwareStorage, webCacheCachedObjects=webCacheCachedObjects, bwsMessage=bwsMessage, totalServers=totalServers, sslSrvrAddress=sslSrvrAddress, sslSrvrAddressType=sslSrvrAddressType, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, servicePort=servicePort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitPort=ipsReqLimitPort, sslProxyAddress=sslProxyAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCAddress=ipsRCAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumConn=httpSrvrNumConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsHdrAclHits=ipsHdrAclHits, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCTotQueued=ipsRCTotQueued, cpuTemperature=cpuTemperature, freeMem=freeMem, newAttackDefinitionInstalled=newAttackDefinitionInstalled, smRealmName=smRealmName, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyTotalConn=httpProxyTotalConn, ipsUrlAclAddressType=ipsUrlAclAddressType, systemLoad=systemLoad, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, processCountHigh=processCountHigh, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsMIBCompliance=bwsMIBCompliance, sslProxyAddressType=sslProxyAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrPort=httpSrvrPort, sslProxyInBytes=sslProxyInBytes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyAddressType=httpProxyAddressType, totalMem=totalMem, systemFailOver=systemFailOver, ipsAccessCtrlPort=ipsAccessCtrlPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyActiveConn=sslProxyActiveConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, smAgentName=smAgentName, dataPortLinkDown=dataPortLinkDown, logStorageHigh=logStorageHigh, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrState=httpSrvrState, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsStats=bwsStats, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyServerErr=httpProxyServerErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsRCTotServed=ipsRCTotServed, activeApplications=activeApplications, linkStatus=linkStatus)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyOutBytes=httpProxyOutBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyServerAbrt=httpProxyServerAbrt, webCacheAddress=webCacheAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrNumConn=sslSrvrNumConn, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCachePort=webCachePort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, peerDown=peerDown, systemSerialNumber=systemSerialNumber, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlPolicyPort=ipsUrlPolicyPort, serverDown=serverDown, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrPort=sslSrvrPort, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, PYSNMP_MODULE_ID=bws, ipsWebAddrTransPort=ipsWebAddrTransPort, systemFailure=systemFailure, ipsReqLimitAddressType=ipsReqLimitAddressType, webCmprPort=webCmprPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheBytesOut=webCacheBytesOut, webCacheReq=webCacheReq, sslProxyCacheHits=sslProxyCacheHits, httpSrvrSrvcPort=httpSrvrSrvcPort, cpuFanSpeed=cpuFanSpeed, bwsMIBConformance=bwsMIBConformance, httpProxyServerReq=httpProxyServerReq, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCmprProtocol=webCmprProtocol, tempHigh=tempHigh, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsSMUserSessionEntry=bwsSMUserSessionEntry)
