...
Gauge32, NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Integer32, ObjectIdentity, Counter64, Bits, TimeTicks, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Integer32", "ObjectIdentity", "Counter64", "Bits", "TimeTicks", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", smRealmName=smRealmName, cpuTemperature=cpuTemperature, systemFailOver=systemFailOver, httpSrvrAddress=httpSrvrAddress, httpProxyAddressType=httpProxyAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, currentFirmwareVersion=currentFirmwareVersion, ipsReqSrvcPort=ipsReqSrvcPort, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCTotQueued=ipsRCTotQueued, httpProxyServerAbrt=httpProxyServerAbrt, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsMIBCompliance=bwsMIBCompliance, ipsReqLimitAddress=ipsReqLimitAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, switchingToInlineMode=switchingToInlineMode, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyServerReq=httpProxyServerReq, linkStatus=linkStatus, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrNumConn=sslSrvrNumConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqSrvcAddressType=ipsReqSrvcAddressType, serverDown=serverDown, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsRCTotDropped=ipsRCTotDropped, ipsHdrAclPort=ipsHdrAclPort, vipStatus=vipStatus, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrTotResponse=httpSrvrTotResponse, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, systemFanSpeed=systemFanSpeed, webCmprAddress=webCmprAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, peerDown=peerDown, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsMIBGroups=bwsMIBGroups, sslProxyPort=sslProxyPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, systemLoad=systemLoad, httpSrvrSrvcPort=httpSrvrSrvcPort, totalApplications=totalApplications, dataPortLinkUp=dataPortLinkUp, energizeUpdateExpire=energizeUpdateExpire, webCacheReq=webCacheReq, sslSrvrTotSuccess=sslSrvrTotSuccess, totalMem=totalMem, webCachePort=webCachePort, bwstraps=bwstraps, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheCacheableRes=webCacheCacheableRes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, dataPathStatus=dataPathStatus, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumFreeConn=sslSrvrNumFreeConn, logStorageHigh=logStorageHigh, httpProxyAddress=httpProxyAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecTampered=ipsCookieSecTampered, switchingToMaintMode=switchingToMaintMode, webCacheCachedObjects=webCacheCachedObjects, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, memUtilization=memUtilization, sslSrvrAddressType=sslSrvrAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrInBytes=sslSrvrInBytes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsHdrAclAddress=ipsHdrAclAddress, webCacheProtocol=webCacheProtocol, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyFullHandshakes=sslProxyFullHandshakes, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, totalAttacks=totalAttacks, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, firmwareStorageHigh=firmwareStorageHigh, cpuFanSpeed=cpuFanSpeed, bwsMIBConformance=bwsMIBConformance, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, totalBandwidth=totalBandwidth, sslProxyActiveConn=sslProxyActiveConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, activeApplications=activeApplications, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrAddress=sslSrvrAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyTotalConn=httpProxyTotalConn, tempCritical=tempCritical, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, freeMem=freeMem, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyTotalReq=sslProxyTotalReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, PYSNMP_MODULE_ID=bws, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyAddressType=sslProxyAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrTotRefused=sslSrvrTotRefused, totalServers=totalServers, ipsCookieSecPort=ipsCookieSecPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrPort=httpSrvrPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrMinResTime=sslSrvrMinResTime, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheAddressType=webCacheAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, servicePort=servicePort, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclReserved=ipsUrlAclReserved, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bws=bws, webCacheBytesOut=webCacheBytesOut, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, virusDefUpdates=virusDefUpdates, sslSrvrPort=sslSrvrPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, activeServers=activeServers, httpProxyClientAbrt=httpProxyClientAbrt, highAvailabilityStatus=highAvailabilityStatus, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrInBytes=httpSrvrInBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCacheMiss=webCacheMiss, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheStale=webCacheStale, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyCurrentConn=sslProxyCurrentConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, tempHigh=tempHigh, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclAddress=ipsUrlAclAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyCacheHits=sslProxyCacheHits, smAgentName=smAgentName, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlAclPort=ipsUrlAclPort, ipsRCAddressType=ipsRCAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, peerUp=peerUp, cpuUtilization=cpuUtilization, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumConn=httpSrvrNumConn, ipsUrlNormPort=ipsUrlNormPort, sslProxyInBytes=sslProxyInBytes, bwsStats=bwsStats, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsRCAddress=ipsRCAddress, httpProxyTotalReq=httpProxyTotalReq, systemSerialNumber=systemSerialNumber, memoryUsageHigh=memoryUsageHigh, raidDegrading=raidDegrading, bwsMessage=bwsMessage, webCmprPort=webCmprPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCmprAddressType=webCmprAddressType, sslProxyAddress=sslProxyAddress, uptime=uptime, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrAvgResTime=httpSrvrAvgResTime, smNumUserSessions=smNumUserSessions, srvcName=srvcName, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, dataPortLinkDown=dataPortLinkDown, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclHits=ipsHdrAclHits, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrOutBytes=sslSrvrOutBytes, serviceStatus=serviceStatus, systemFailure=systemFailure, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyServerErr=httpProxyServerErr, httpSrvrState=httpSrvrState, serviceName=serviceName)
mibBuilder.exportSymbols("BWS-MIB", webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyInBytes=httpProxyInBytes, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrAddressType=httpSrvrAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsRCTotServed=ipsRCTotServed, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, serviceAddress=serviceAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, logStorage=logStorage, httpProxyPort=httpProxyPort, webCacheAddress=webCacheAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotResponse=sslSrvrTotResponse, fanDead=fanDead, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, securityDefUpdates=securityDefUpdates, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyErrPms=sslProxyErrPms, serverUp=serverUp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, operationalMode=operationalMode, ipsReqLimitPort=ipsReqLimitPort, sslProxyOutBytes=sslProxyOutBytes, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, firmwareStorage=firmwareStorage, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, webCmprProtocol=webCmprProtocol, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCPort=ipsRCPort, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheHits=webCacheHits, sslSrvrState=sslSrvrState, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrAvgResTime=sslSrvrAvgResTime, processCountHigh=processCountHigh, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlNormAddress=ipsUrlNormAddress)
