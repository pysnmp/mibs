...
ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Unsigned32, Counter32, ObjectIdentity, IpAddress, MibIdentifier, TimeTicks, iso, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Unsigned32", "Counter32", "ObjectIdentity", "IpAddress", "MibIdentifier", "TimeTicks", "iso", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsMIBConformance=bwsMIBConformance, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, tempCritical=tempCritical, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, dataPortLinkDown=dataPortLinkDown, serviceAddress=serviceAddress, httpProxyOutBytes=httpProxyOutBytes, sslProxyAddressType=sslProxyAddressType, httpProxyAddress=httpProxyAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, peerDown=peerDown, bwstraps=bwstraps, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprProtocol=webCmprProtocol, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrTotResponse=httpSrvrTotResponse, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyTotalReq=httpProxyTotalReq, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsMIBGroups=bwsMIBGroups, dataPortLinkUp=dataPortLinkUp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, firmwareStorage=firmwareStorage, ipsCookieSecAddress=ipsCookieSecAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqSrvcPort=ipsReqSrvcPort, bws=bws, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, smNumUserSessions=smNumUserSessions, securityDefUpdates=securityDefUpdates, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, highAvailabilityStatus=highAvailabilityStatus, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, systemFailure=systemFailure, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, PYSNMP_MODULE_ID=bws, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyCacheHits=sslProxyCacheHits, ipsUrlNormPort=ipsUrlNormPort, ipsReqLimitPort=ipsReqLimitPort, webCacheAddressType=webCacheAddressType, sslSrvrNumConn=sslSrvrNumConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, totalBandwidth=totalBandwidth, ipsRCAddress=ipsRCAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheAddress=webCacheAddress, webCacheHits=webCacheHits, systemSerialNumber=systemSerialNumber, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, switchingToMaintMode=switchingToMaintMode, sslSrvrNumFreeConn=sslSrvrNumFreeConn, smRealmName=smRealmName, httpSrvrInBytes=httpSrvrInBytes, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyErrPms=sslProxyErrPms, cpuTemperature=cpuTemperature, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrState=httpSrvrState, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, dataPathStatus=dataPathStatus, webCachePort=webCachePort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsRCTotDropped=ipsRCTotDropped, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCmprAddress=webCmprAddress, webCacheStale=webCacheStale, serverDown=serverDown, vipStatus=vipStatus, raidDegrading=raidDegrading, logStorageHigh=logStorageHigh, cpuUtilization=cpuUtilization, httpProxyPort=httpProxyPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheBytesOut=webCacheBytesOut, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, systemLoad=systemLoad, memUtilization=memUtilization, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrInBytes=sslSrvrInBytes, processCountHigh=processCountHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCacheMiss=webCacheMiss, ipsRCPort=ipsRCPort, freeMem=freeMem, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyInBytes=httpProxyInBytes, totalMem=totalMem, webCmprPort=webCmprPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyServerReq=httpProxyServerReq, smAgentName=smAgentName, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyInBytes=sslProxyInBytes, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCmprCompressedDataSize=webCmprCompressedDataSize, servicePort=servicePort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrAddress=sslSrvrAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyAddressType=httpProxyAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheCacheableRes=webCacheCacheableRes, httpProxyParseErr=httpProxyParseErr, activeApplications=activeApplications, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrAddress=httpSrvrAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclAddress=ipsUrlAclAddress, webCacheReq=webCacheReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, srvcName=srvcName, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, switchingToInlineMode=switchingToInlineMode, sslProxyOutBytes=sslProxyOutBytes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrPort=sslSrvrPort, httpProxyServerAbrt=httpProxyServerAbrt, serviceStatus=serviceStatus, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsStats=bwsStats, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, systemFailOver=systemFailOver, energizeUpdateExpire=energizeUpdateExpire, httpProxyActiveConn=httpProxyActiveConn, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsHdrAclAddress=ipsHdrAclAddress, fanDead=fanDead, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, webCacheLongHdrs=webCacheLongHdrs, totalApplications=totalApplications, httpSrvrNumConn=httpSrvrNumConn, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprAddressType=webCmprAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, peerUp=peerUp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, uptime=uptime, ipsHdrAclPort=ipsHdrAclPort, sslProxyPort=sslProxyPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, serverUp=serverUp, httpSrvrPort=httpSrvrPort, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCAddressType=ipsRCAddressType, bwsMIBCompliance=bwsMIBCompliance, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrMinResTime=sslSrvrMinResTime, webCacheCachedObjects=webCacheCachedObjects, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyTotalReq=sslProxyTotalReq, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrAddressType=httpSrvrAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsTrapGroup=bwsTrapGroup, activeServers=activeServers, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsMIBCompliances=bwsMIBCompliances, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, totalAttacks=totalAttacks)
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, virusDefUpdates=virusDefUpdates, bwsStatsGroup=bwsStatsGroup, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serviceName=serviceName, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyServerErr=httpProxyServerErr, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheProtocol=webCacheProtocol, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxySessionTimeOut=httpProxySessionTimeOut, linkStatus=linkStatus, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, logStorage=logStorage, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlAclPort=ipsUrlAclPort, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsMessage=bwsMessage, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrAddressType=sslSrvrAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, tempHigh=tempHigh, operationalMode=operationalMode, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecPort=ipsCookieSecPort, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecTampered=ipsCookieSecTampered, systemFanSpeed=systemFanSpeed, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyAddress=sslProxyAddress, sslSrvrState=sslSrvrState, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, cpuFanSpeed=cpuFanSpeed, firmwareStorageHigh=firmwareStorageHigh, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyActiveConn=sslProxyActiveConn, sslSrvrSrvcPort=sslSrvrSrvcPort, totalServers=totalServers, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrMaxResTime=sslSrvrMaxResTime)
