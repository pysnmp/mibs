...
NotificationType, IpAddress, ModuleIdentity, Counter32, Gauge32, Unsigned32, Counter64, iso, TimeTicks, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "ModuleIdentity", "Counter32", "Gauge32", "Unsigned32", "Counter64", "iso", "TimeTicks", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", activeServers=activeServers, sslSrvrInBytes=sslSrvrInBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyPort=httpProxyPort, sslSrvrTotRefused=sslSrvrTotRefused, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqLimitPort=ipsReqLimitPort, webCacheLongHdrs=webCacheLongHdrs, webCacheReq=webCacheReq, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCTotOutOfResource=ipsRCTotOutOfResource, systemFailure=systemFailure, operationalMode=operationalMode, webCacheCachedObjects=webCacheCachedObjects, totalAttacks=totalAttacks, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, totalMem=totalMem, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrTotRefused=httpSrvrTotRefused, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, dataPathStatus=dataPathStatus, bwsCacheStatsEntry=bwsCacheStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, memoryUsageHigh=memoryUsageHigh, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, energizeUpdateExpire=energizeUpdateExpire, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, firmwareStorage=firmwareStorage, ipsRCAddress=ipsRCAddress, httpSrvrInBytes=httpSrvrInBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheBytesOut=webCacheBytesOut, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, systemLoad=systemLoad, sslProxyTotalReq=sslProxyTotalReq, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, srvcName=srvcName, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrPort=httpSrvrPort, switchingToBypassMode=switchingToBypassMode, smAgentName=smAgentName, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, highAvailabilityStatus=highAvailabilityStatus, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyServerReq=httpProxyServerReq, raidDegrading=raidDegrading, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecPort=ipsCookieSecPort, activeApplications=activeApplications, ipsCookieSecTampered=ipsCookieSecTampered, ipsRCTotServed=ipsRCTotServed, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyParseErr=httpProxyParseErr, tempHigh=tempHigh, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheAddressType=webCacheAddressType, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyActiveConn=httpProxyActiveConn, sslProxyCacheMiss=sslProxyCacheMiss, webCmprAddressType=webCmprAddressType, serviceName=serviceName, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyTotalConn=httpProxyTotalConn, webCmprAddress=webCmprAddress, tempCritical=tempCritical, uptime=uptime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyOutBytes=httpProxyOutBytes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyAddress=sslProxyAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyCacheHits=sslProxyCacheHits, bwsStatsGroup=bwsStatsGroup, bwstraps=bwstraps, ipsCookieSecAddressType=ipsCookieSecAddressType, currentFirmwareVersion=currentFirmwareVersion, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrTotTimedout=httpSrvrTotTimedout, systemFanSpeed=systemFanSpeed, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrAddressType=sslSrvrAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyInBytes=httpProxyInBytes, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyOutBytes=sslProxyOutBytes, bwsMIBCompliances=bwsMIBCompliances, peerDown=peerDown, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheAddress=webCacheAddress, webCacheCacheableRes=webCacheCacheableRes, httpSrvrSrvcPort=httpSrvrSrvcPort, fanDead=fanDead, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, serviceStatus=serviceStatus, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyActiveConn=sslProxyActiveConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrOutBytes=httpSrvrOutBytes, webCacheStale=webCacheStale, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, virusDefUpdates=virusDefUpdates, sslSrvrNumConn=sslSrvrNumConn, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, PYSNMP_MODULE_ID=bws, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheMiss=webCacheMiss, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCTotQueued=ipsRCTotQueued, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, totalBandwidth=totalBandwidth, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, peerUp=peerUp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsHdrAclPort=ipsHdrAclPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyPort=sslProxyPort, ipsHdrAclHits=ipsHdrAclHits, httpSrvrState=httpSrvrState, sslProxyCurrentConn=sslProxyCurrentConn, serverUp=serverUp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, processCountHigh=processCountHigh, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheProtocol=webCacheProtocol, ipsRCTimeStamp=ipsRCTimeStamp, bwsMessage=bwsMessage, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecAddress=ipsCookieSecAddress, totalServers=totalServers, bws=bws, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsMIBGroups=bwsMIBGroups, smRealmName=smRealmName, memUtilization=memUtilization, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheHits=webCacheHits, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsMIBConformance=bwsMIBConformance, sslProxyTotalConn=sslProxyTotalConn, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyAddressType=sslProxyAddressType, ipsUrlNormPort=ipsUrlNormPort, totalApplications=totalApplications, switchingToInlineMode=switchingToInlineMode, httpProxyAddressType=httpProxyAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsCompressionStatsTable=bwsCompressionStatsTable, dataPortLinkUp=dataPortLinkUp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrAddress=httpSrvrAddress, webCmprProtocol=webCmprProtocol, webCachePort=webCachePort, bwsStats=bwsStats, cpuUtilization=cpuUtilization, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyAddress=httpProxyAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, serverDown=serverDown, securityDefUpdates=securityDefUpdates, cpuFanSpeed=cpuFanSpeed, sslSrvrState=sslSrvrState, logStorageHigh=logStorageHigh, ipsUrlAclAddress=ipsUrlAclAddress, smNumUserSessions=smNumUserSessions, firmwareStorageHigh=firmwareStorageHigh, bwsMIBCompliance=bwsMIBCompliance, switchingToMaintMode=switchingToMaintMode, linkStatus=linkStatus, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlNormAddressType=ipsUrlNormAddressType, systemSerialNumber=systemSerialNumber, webCmprPort=webCmprPort, logStorage=logStorage, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyServerErr=httpProxyServerErr, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyTotalReq=httpProxyTotalReq, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrPort=sslSrvrPort, sslProxyErrPms=sslProxyErrPms, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrNumConn=httpSrvrNumConn, vipStatus=vipStatus, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsTrapGroup=bwsTrapGroup, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, cpuTemperature=cpuTemperature, ipsRCPort=ipsRCPort, serviceAddress=serviceAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, freeMem=freeMem, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, servicePort=servicePort, systemFailOver=systemFailOver, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr)
