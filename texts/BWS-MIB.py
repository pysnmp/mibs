...
TimeTicks, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, IpAddress, iso, MibIdentifier, NotificationType, ModuleIdentity, Gauge32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "IpAddress", "iso", "MibIdentifier", "NotificationType", "ModuleIdentity", "Gauge32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlAclPort=ipsUrlAclPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, systemFailOver=systemFailOver, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, peerUp=peerUp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bws=bws, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSMUserSessionEntry=bwsSMUserSessionEntry, activeApplications=activeApplications, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrAddressType=sslSrvrAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, tempCritical=tempCritical, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsMessage=bwsMessage, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheAddress=webCacheAddress, ipsUrlNormAddress=ipsUrlNormAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsRCTotDropped=ipsRCTotDropped, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsRCPort=ipsRCPort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyServerErr=httpProxyServerErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsHdrAclPort=ipsHdrAclPort, virusDefUpdates=virusDefUpdates, bwsStats=bwsStats, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrInBytes=sslSrvrInBytes, sslProxyTotalReq=sslProxyTotalReq, httpProxyTotalReq=httpProxyTotalReq, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyTotalConn=httpProxyTotalConn, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrPort=httpSrvrPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, cpuTemperature=cpuTemperature, webCmprPort=webCmprPort, operationalMode=operationalMode, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsRCTotServed=ipsRCTotServed, energizeUpdateExpire=energizeUpdateExpire, systemSerialNumber=systemSerialNumber, ipsCookieSecPort=ipsCookieSecPort, totalBandwidth=totalBandwidth, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrState=httpSrvrState, sslSrvrNumConn=sslSrvrNumConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, switchingToInlineMode=switchingToInlineMode, ipsRCAddress=ipsRCAddress, webCacheAddressType=webCacheAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, activeServers=activeServers, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheHits=webCacheHits, ipsRCTimeStamp=ipsRCTimeStamp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrPort=sslSrvrPort, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, memUtilization=memUtilization, sslProxyPort=sslProxyPort, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCachePort=webCachePort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsHdrAclHits=ipsHdrAclHits, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCacheStale=webCacheStale, webCmprAddress=webCmprAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, logStorageHigh=logStorageHigh, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, serverDown=serverDown, webCmprCompressibleDataSize=webCmprCompressibleDataSize, peerDown=peerDown, webCacheBytesOut=webCacheBytesOut, firmwareStorage=firmwareStorage, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCmprAddressType=webCmprAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, processCountHigh=processCountHigh, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCAddressType=ipsRCAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlPolicyPort=ipsUrlPolicyPort, systemFanSpeed=systemFanSpeed, sslProxyErrPms=sslProxyErrPms, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrAddressType=httpSrvrAddressType, bwsTrapGroup=bwsTrapGroup, smNumUserSessions=smNumUserSessions, cpuFanSpeed=cpuFanSpeed, linkStatus=linkStatus, totalMem=totalMem, totalServers=totalServers, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrInBytes=httpSrvrInBytes, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsMIBCompliances=bwsMIBCompliances, srvcName=srvcName, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, serviceName=serviceName, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyActiveConn=sslProxyActiveConn, bwstraps=bwstraps, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, raidDegrading=raidDegrading, highAvailabilityStatus=highAvailabilityStatus, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, switchingToMaintMode=switchingToMaintMode, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, systemLoad=systemLoad, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, smAgentName=smAgentName, serviceAddress=serviceAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, PYSNMP_MODULE_ID=bws, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, serviceStatus=serviceStatus, currentFirmwareVersion=currentFirmwareVersion, systemFailure=systemFailure, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyAddressType=httpProxyAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, dataPortLinkUp=dataPortLinkUp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheReq=webCacheReq, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitPort=ipsReqLimitPort, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyAddress=sslProxyAddress, httpProxyOutBytes=httpProxyOutBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, tempHigh=tempHigh, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyInBytes=httpProxyInBytes, switchingToBypassMode=switchingToBypassMode)
mibBuilder.exportSymbols("BWS-MIB", webCacheMiss=webCacheMiss, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyCacheHits=sslProxyCacheHits, webCacheLongHdrs=webCacheLongHdrs, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyPort=httpProxyPort, httpSrvrAddress=httpSrvrAddress, servicePort=servicePort, httpProxyAddress=httpProxyAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsStatsGroup=bwsStatsGroup, totalApplications=totalApplications, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCmprProtocol=webCmprProtocol, bwsMIBCompliance=bwsMIBCompliance, httpProxyActiveConn=httpProxyActiveConn, sslSrvrState=sslSrvrState, totalAttacks=totalAttacks, sslProxyTotalConn=sslProxyTotalConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, freeMem=freeMem, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrAddress=sslSrvrAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, uptime=uptime, httpProxyServerReq=httpProxyServerReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrTotTimedout=sslSrvrTotTimedout, serverUp=serverUp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, securityDefUpdates=securityDefUpdates, cpuUtilization=cpuUtilization, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyOutBytes=sslProxyOutBytes, vipStatus=vipStatus, dataPortLinkDown=dataPortLinkDown, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, smRealmName=smRealmName, ipsReqSrvcPort=ipsReqSrvcPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, dataPathStatus=dataPathStatus, logStorage=logStorage, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, webCacheProtocol=webCacheProtocol, ipsLrnSrvcPort=ipsLrnSrvcPort, webCmprCompressedDataSize=webCmprCompressedDataSize, fanDead=fanDead, httpSrvrNumConn=httpSrvrNumConn)
