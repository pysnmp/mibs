...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Integer32, ModuleIdentity, TimeTicks, ObjectIdentity, NotificationType, Gauge32, Counter64, IpAddress, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Integer32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32", "Counter64", "IpAddress", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrPort=sslSrvrPort, totalMem=totalMem, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrAddress=httpSrvrAddress, tempCritical=tempCritical, sslSrvrTotReqRejected=sslSrvrTotReqRejected, totalApplications=totalApplications, virusDefUpdates=virusDefUpdates, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyBadDNCErr=sslProxyBadDNCErr, peerUp=peerUp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCPort=ipsRCPort, dataPathStatus=dataPathStatus, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, systemSerialNumber=systemSerialNumber, sslSrvrTotSuccess=sslSrvrTotSuccess, totalBandwidth=totalBandwidth, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, totalAttacks=totalAttacks, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyPort=sslProxyPort, bwsStats=bwsStats, webCacheProtocol=webCacheProtocol, raidDegrading=raidDegrading, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyInBytes=sslProxyInBytes, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyCurrentConn=sslProxyCurrentConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMessage=bwsMessage, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsTrapGroup=bwsTrapGroup, serviceAddress=serviceAddress, sslProxyErrPms=sslProxyErrPms, smRealmName=smRealmName, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, cpuFanSpeed=cpuFanSpeed, sslSrvrAddress=sslSrvrAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrState=httpSrvrState, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrAddressType=sslSrvrAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, currentFirmwareVersion=currentFirmwareVersion, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, tempHigh=tempHigh, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheHits=webCacheHits, httpSrvrTotReqRejected=httpSrvrTotReqRejected, activeServers=activeServers, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheMiss=webCacheMiss, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsMIBCompliance=bwsMIBCompliance, PYSNMP_MODULE_ID=bws, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, dataPortLinkDown=dataPortLinkDown, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, cpuUtilization=cpuUtilization, httpSrvrAvgResTime=httpSrvrAvgResTime, smAgentName=smAgentName, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyServerReq=httpProxyServerReq, ipsReqSrvcPort=ipsReqSrvcPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, memoryUsageHigh=memoryUsageHigh, peerDown=peerDown, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, switchingToMaintMode=switchingToMaintMode, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCmprAddress=webCmprAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToInlineMode=switchingToInlineMode, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlNormPort=ipsUrlNormPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotRefused=httpSrvrTotRefused, ipsHdrAclPort=ipsHdrAclPort, ipsReqSrvcAddress=ipsReqSrvcAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrNumConn=sslSrvrNumConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyOutBytes=httpProxyOutBytes, webCacheLongHdrs=webCacheLongHdrs, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyTotalReq=httpProxyTotalReq, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCmprCompressibleDataSize=webCmprCompressibleDataSize, logStorage=logStorage, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, serviceName=serviceName, webCacheCachedObjects=webCacheCachedObjects, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, serverUp=serverUp, webCmprCompressedDataSize=webCmprCompressedDataSize, bws=bws, logStorageHigh=logStorageHigh, ipsRCTotDropped=ipsRCTotDropped, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrPort=httpSrvrPort, ipsRCTotServed=ipsRCTotServed, firmwareStorage=firmwareStorage, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyInBytes=httpProxyInBytes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, cpuTemperature=cpuTemperature, systemLoad=systemLoad, sslSrvrOutBytes=sslSrvrOutBytes, webCachePort=webCachePort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsRCAddress=ipsRCAddress, energizeUpdateExpire=energizeUpdateExpire, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, serverDown=serverDown, ipsReqLimitPort=ipsReqLimitPort, serviceStatus=serviceStatus, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheBytesOut=webCacheBytesOut, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, fanDead=fanDead, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheAddress=webCacheAddress, httpProxyServerErr=httpProxyServerErr, ipsRCAddressType=ipsRCAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, totalServers=totalServers, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, srvcName=srvcName, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCacheStale=webCacheStale, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyAddressType=httpProxyAddressType, webCacheReq=webCacheReq, activeApplications=activeApplications, memUtilization=memUtilization, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCmprPort=webCmprPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsHdrAclHits=ipsHdrAclHits, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheCacheableRes=webCacheCacheableRes, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyAddress=httpProxyAddress, bwsMIBGroups=bwsMIBGroups, uptime=uptime, firmwareStorageHigh=firmwareStorageHigh, bwstraps=bwstraps, servicePort=servicePort, freeMem=freeMem, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCmprAddressType=webCmprAddressType, vipStatus=vipStatus, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted)
mibBuilder.exportSymbols("BWS-MIB", sslProxyAddressType=sslProxyAddressType, linkStatus=linkStatus, securityDefUpdates=securityDefUpdates, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyParseErr=httpProxyParseErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, smNumUserSessions=smNumUserSessions, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrTotResponse=httpSrvrTotResponse, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumConn=httpSrvrNumConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrState=sslSrvrState, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsStatsGroup=bwsStatsGroup, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, systemFanSpeed=systemFanSpeed, httpProxyActiveConn=httpProxyActiveConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, systemFailure=systemFailure, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyClientAbrt=httpProxyClientAbrt, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, processCountHigh=processCountHigh, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, dataPortLinkUp=dataPortLinkUp, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecPort=ipsCookieSecPort, sslProxyTotalReq=sslProxyTotalReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyAddress=sslProxyAddress, sslSrvrInBytes=sslSrvrInBytes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyOutBytes=sslProxyOutBytes, sslSrvrTotResponse=sslSrvrTotResponse, systemFailOver=systemFailOver, httpProxyPort=httpProxyPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, webCacheAddressType=webCacheAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, operationalMode=operationalMode)
