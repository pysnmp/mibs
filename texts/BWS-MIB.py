...
MibIdentifier, Counter64, ModuleIdentity, Gauge32, IpAddress, NotificationType, ObjectIdentity, Integer32, iso, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "ModuleIdentity", "Gauge32", "IpAddress", "NotificationType", "ObjectIdentity", "Integer32", "iso", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", memUtilization=memUtilization, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, linkStatus=linkStatus, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotRefused=sslSrvrTotRefused, dataPortLinkDown=dataPortLinkDown, webCacheAddressType=webCacheAddressType, dataPathStatus=dataPathStatus, sslSrvrPort=sslSrvrPort, ipsWebAddrTransPort=ipsWebAddrTransPort, tempHigh=tempHigh, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsMIBConformance=bwsMIBConformance, httpSrvrAddress=httpSrvrAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrTotRefused=httpSrvrTotRefused, activeApplications=activeApplications, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCmprPort=webCmprPort, firmwareStorageHigh=firmwareStorageHigh, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrState=sslSrvrState, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyOutBytes=sslProxyOutBytes, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCTotServed=ipsRCTotServed, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotSuccess=sslSrvrTotSuccess, systemFanSpeed=systemFanSpeed, sslProxyTotalConn=sslProxyTotalConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, activeServers=activeServers, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, fanDead=fanDead, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, logStorage=logStorage, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlAclReserved=ipsUrlAclReserved, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwstraps=bwstraps, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, smAgentName=smAgentName, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqSrvcAddressType=ipsReqSrvcAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsStatsGroup=bwsStatsGroup, virusDefUpdates=virusDefUpdates, cpuUtilization=cpuUtilization, processCountHigh=processCountHigh, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsCookieSecAddressType=ipsCookieSecAddressType, tempCritical=tempCritical, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, peerDown=peerDown, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheLongHdrs=webCacheLongHdrs, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrAddressType=httpSrvrAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, cpuTemperature=cpuTemperature, sslProxyAddressType=sslProxyAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCAddress=ipsRCAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, cpuFanSpeed=cpuFanSpeed, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrState=httpSrvrState, bwsMIBCompliances=bwsMIBCompliances, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyWAFWarnings=httpProxyWAFWarnings, uptime=uptime, webCmprProtocol=webCmprProtocol, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, totalServers=totalServers, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrOutBytes=httpSrvrOutBytes, systemSerialNumber=systemSerialNumber, totalMem=totalMem, webCacheProtocol=webCacheProtocol, operationalMode=operationalMode, freeMem=freeMem, switchingToMaintMode=switchingToMaintMode, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, dataPortLinkUp=dataPortLinkUp, servicePort=servicePort, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, securityDefUpdates=securityDefUpdates, sslProxyTotalReq=sslProxyTotalReq, currentFirmwareVersion=currentFirmwareVersion, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyServerErr=httpProxyServerErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsRCTotQueued=ipsRCTotQueued, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrSrvcPort=httpSrvrSrvcPort, webCacheReq=webCacheReq, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxySessionTimeOut=httpProxySessionTimeOut, totalApplications=totalApplications, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsStats=bwsStats, bwsMIBGroups=bwsMIBGroups, ipsHdrAclHits=ipsHdrAclHits, httpProxyInBytes=httpProxyInBytes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, serverUp=serverUp, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitPort=ipsReqLimitPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyTotalConn=httpProxyTotalConn, smNumUserSessions=smNumUserSessions, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrNumConn=httpSrvrNumConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsHdrAclAddressType=ipsHdrAclAddressType, webCmprAddressType=webCmprAddressType, serviceAddress=serviceAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsRCAddressType=ipsRCAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclPort=ipsUrlAclPort, httpProxyParseErr=httpProxyParseErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrAddress=sslSrvrAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, switchingToInlineMode=switchingToInlineMode, bwsTrapGroup=bwsTrapGroup, logStorageHigh=logStorageHigh, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsMIBCompliance=bwsMIBCompliance, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, smRealmName=smRealmName, sslProxyPort=sslProxyPort, httpSrvrPort=httpSrvrPort, sslProxyInBytes=sslProxyInBytes, PYSNMP_MODULE_ID=bws, switchingToBypassMode=switchingToBypassMode, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, serviceName=serviceName, sslSrvrTotTimedout=sslSrvrTotTimedout, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyActiveConn=sslProxyActiveConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumConn=sslSrvrNumConn, totalBandwidth=totalBandwidth, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, raidDegrading=raidDegrading, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyOutBytes=httpProxyOutBytes, serviceStatus=serviceStatus, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, vipStatus=vipStatus, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyPort=httpProxyPort, webCacheStale=webCacheStale, ipsRCPort=ipsRCPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrInBytes=sslSrvrInBytes, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsHdrAclAddress=ipsHdrAclAddress, webCacheHits=webCacheHits, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyAddress=sslProxyAddress, ipsUrlNormPort=ipsUrlNormPort, httpProxyAddress=httpProxyAddress, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, serverDown=serverDown, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, webCacheAddress=webCacheAddress, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyCacheHits=sslProxyCacheHits, sslProxyFullHandshakes=sslProxyFullHandshakes, webCmprAddress=webCmprAddress, systemFailOver=systemFailOver, httpProxyServerReq=httpProxyServerReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMessage=bwsMessage, webCacheCacheableRes=webCacheCacheableRes, webCacheBytesOut=webCacheBytesOut, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCachePort=webCachePort, systemLoad=systemLoad, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, totalAttacks=totalAttacks, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, systemFailure=systemFailure, peerUp=peerUp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, firmwareStorage=firmwareStorage, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrAddressType=sslSrvrAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, memoryUsageHigh=memoryUsageHigh, bws=bws, webCacheMiss=webCacheMiss, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, srvcName=srvcName, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsCookieSecPort=ipsCookieSecPort, sslProxyErrPms=sslProxyErrPms, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrTotReqActive=httpSrvrTotReqActive)
