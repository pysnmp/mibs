...
ModuleIdentity, iso, Bits, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Counter32, Integer32, Gauge32, Unsigned32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Bits", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Counter32", "Integer32", "Gauge32", "Unsigned32", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", memUtilization=memUtilization, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCPort=ipsRCPort, webCacheAddressType=webCacheAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheAddress=webCacheAddress, dataPortLinkDown=dataPortLinkDown, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsMIBCompliances=bwsMIBCompliances, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, totalMem=totalMem, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, tempHigh=tempHigh, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyParseErr=httpProxyParseErr, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCachePort=webCachePort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, peerDown=peerDown, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsHdrAclPort=ipsHdrAclPort, sslSrvrAddress=sslSrvrAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyPort=httpProxyPort, serverUp=serverUp, bwsMIBConformance=bwsMIBConformance, webCmprPort=webCmprPort, sslSrvrPort=sslSrvrPort, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrSrvcAddress=httpSrvrSrvcAddress, srvcName=srvcName, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrState=httpSrvrState, sslProxyPort=sslProxyPort, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyCacheTimeouts=sslProxyCacheTimeouts, processCountHigh=processCountHigh, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyServerErr=httpProxyServerErr, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, totalBandwidth=totalBandwidth, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, servicePort=servicePort, totalServers=totalServers, cpuUtilization=cpuUtilization, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, activeApplications=activeApplications, systemFailOver=systemFailOver, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyCurrentConn=sslProxyCurrentConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyAddress=ipsUrlPolicyAddress, dataPortLinkUp=dataPortLinkUp, sslSrvrTotRefused=sslSrvrTotRefused, webCacheProtocol=webCacheProtocol, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitPort=ipsReqLimitPort, webCacheMiss=webCacheMiss, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyInBytes=sslProxyInBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsHdrAclHits=ipsHdrAclHits, ipsRCTotDropped=ipsRCTotDropped, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrNumConn=sslSrvrNumConn, securityDefUpdates=securityDefUpdates, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sharedSecretKeyExpired=sharedSecretKeyExpired, smRealmName=smRealmName, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, peerUp=peerUp, systemFailure=systemFailure, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bws=bws, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyAddress=sslProxyAddress, sslProxyCacheHits=sslProxyCacheHits, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsTrapGroup=bwsTrapGroup, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, PYSNMP_MODULE_ID=bws, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsRCAddress=ipsRCAddress, webCmprProtocol=webCmprProtocol, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, logStorage=logStorage, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsRCTotQueued=ipsRCTotQueued, activeServers=activeServers, sslSrvrSrvcPort=sslSrvrSrvcPort, cpuTemperature=cpuTemperature, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwstraps=bwstraps, totalApplications=totalApplications, totalAttacks=totalAttacks, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, dataPathStatus=dataPathStatus, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, currentFirmwareVersion=currentFirmwareVersion, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyAddressType=httpProxyAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheReq=webCacheReq, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, tempCritical=tempCritical, httpProxyActiveConn=httpProxyActiveConn, httpProxyTotalReq=httpProxyTotalReq, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, systemSerialNumber=systemSerialNumber, bwsMessage=bwsMessage, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, serviceName=serviceName, sslProxyTotalConn=sslProxyTotalConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, memoryUsageHigh=memoryUsageHigh, webCmprAddressType=webCmprAddressType, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsCookieSecPort=ipsCookieSecPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, operationalMode=operationalMode, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrState=sslSrvrState, uptime=uptime, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, linkStatus=linkStatus, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyOutBytes=sslProxyOutBytes, httpProxyInBytes=httpProxyInBytes, fanDead=fanDead, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, serviceStatus=serviceStatus, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, energizeUpdateExpire=energizeUpdateExpire, serverDown=serverDown, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCacheLongHdrs=webCacheLongHdrs, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCAddressType=ipsRCAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, switchingToMaintMode=switchingToMaintMode, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrNumConn=httpSrvrNumConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrAddress=httpSrvrAddress, ipsRCTimeStamp=ipsRCTimeStamp, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlNormPort=ipsUrlNormPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, smAgentName=smAgentName, webCacheCacheableRes=webCacheCacheableRes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, virusDefUpdates=virusDefUpdates, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrAddressType=httpSrvrAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyTotalConn=httpProxyTotalConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlAclAddress=ipsUrlAclAddress, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, smNumUserSessions=smNumUserSessions, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr)
mibBuilder.exportSymbols("BWS-MIB", httpProxyAddress=httpProxyAddress, sslSrvrInBytes=sslSrvrInBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMIBCompliance=bwsMIBCompliance, serviceAddress=serviceAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, vipStatus=vipStatus, sslProxyActiveConn=sslProxyActiveConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, systemFanSpeed=systemFanSpeed, sslProxyErrPms=sslProxyErrPms, switchingToInlineMode=switchingToInlineMode, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqSrvcPort=ipsReqSrvcPort, webCacheHits=webCacheHits, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyServerReq=httpProxyServerReq, httpProxyOutBytes=httpProxyOutBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, webCacheStale=webCacheStale, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, freeMem=freeMem, systemLoad=systemLoad, sslProxyAddressType=sslProxyAddressType, raidDegrading=raidDegrading, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyFullHandshakes=sslProxyFullHandshakes, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, bwsStats=bwsStats, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrPort=httpSrvrPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsRCTotServed=ipsRCTotServed, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, logStorageHigh=logStorageHigh, webCmprAddress=webCmprAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, firmwareStorage=firmwareStorage)
