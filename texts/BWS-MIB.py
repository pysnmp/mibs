...
iso, Counter32, NotificationType, IpAddress, MibIdentifier, TimeTicks, Gauge32, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "NotificationType", "IpAddress", "MibIdentifier", "TimeTicks", "Gauge32", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, peerDown=peerDown, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, systemFailOver=systemFailOver, firmwareStorage=firmwareStorage, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCmprPort=webCmprPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsRCTotServed=ipsRCTotServed, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwstraps=bwstraps, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, fanDead=fanDead, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrInBytes=sslSrvrInBytes, totalAttacks=totalAttacks, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, virusDefUpdates=virusDefUpdates, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyTotalConn=sslProxyTotalConn, bwsServiceStatusTable=bwsServiceStatusTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheReq=webCacheReq, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, smNumUserSessions=smNumUserSessions, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCacheStale=webCacheStale, bwsMIBCompliance=bwsMIBCompliance, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrOutBytes=httpSrvrOutBytes, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyCacheTimeouts=sslProxyCacheTimeouts, logStorage=logStorage, logStorageHigh=logStorageHigh, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyCurrentConn=sslProxyCurrentConn, systemSerialNumber=systemSerialNumber, httpProxyServerErr=httpProxyServerErr, dataPortLinkUp=dataPortLinkUp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyInBytes=sslProxyInBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormPort=ipsUrlNormPort, webCacheHits=webCacheHits, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, totalMem=totalMem, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsHdrAclPort=ipsHdrAclPort, httpSrvrAddress=httpSrvrAddress, httpProxyActiveConn=httpProxyActiveConn, serviceStatus=serviceStatus, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsMessage=bwsMessage, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, processCountHigh=processCountHigh, securityDefUpdates=securityDefUpdates, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, tempCritical=tempCritical, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyErrPms=sslProxyErrPms, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrInBytes=httpSrvrInBytes, servicePort=servicePort, cpuFanSpeed=cpuFanSpeed, operationalMode=operationalMode, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyTotalReq=sslProxyTotalReq, dataPathStatus=dataPathStatus, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, serviceName=serviceName, energizeUpdateExpire=energizeUpdateExpire, httpSrvrAvgResTime=httpSrvrAvgResTime, webCmprAddressType=webCmprAddressType, smRealmName=smRealmName, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrMaxResTime=httpSrvrMaxResTime, serverDown=serverDown, activeServers=activeServers, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyCacheHits=sslProxyCacheHits, ipsHdrAclHits=ipsHdrAclHits, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, highAvailabilityStatus=highAvailabilityStatus, bwsMIBGroups=bwsMIBGroups, activeApplications=activeApplications, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, memoryUsageHigh=memoryUsageHigh, sslSrvrState=sslSrvrState, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlAclPort=ipsUrlAclPort, sslSrvrAddress=sslSrvrAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsWebAddrTransPort=ipsWebAddrTransPort, cpuUtilization=cpuUtilization, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsRCPort=ipsRCPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyBadDNCErr=sslProxyBadDNCErr, srvcName=srvcName, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCAddress=ipsRCAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyParseErr=httpProxyParseErr, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrNumConn=sslSrvrNumConn, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcPort=ipsLrnSrvcPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitAddress=ipsReqLimitAddress, webCmprAddress=webCmprAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrPort=httpSrvrPort, totalApplications=totalApplications, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCachePort=webCachePort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyInBytes=httpProxyInBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, uptime=uptime, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, totalBandwidth=totalBandwidth, linkStatus=linkStatus, sslProxyPort=sslProxyPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, freeMem=freeMem, httpSrvrMinResTime=httpSrvrMinResTime, totalServers=totalServers, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCAddressType=ipsRCAddressType, switchingToMaintMode=switchingToMaintMode, systemFailure=systemFailure, webCacheAddress=webCacheAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, smAgentName=smAgentName, bwsTrapGroup=bwsTrapGroup, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyPort=httpProxyPort, bwsCacheStatsEntry=bwsCacheStatsEntry, vipStatus=vipStatus, cpuTemperature=cpuTemperature, serverUp=serverUp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyAddressType=httpProxyAddressType, PYSNMP_MODULE_ID=bws, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyOutBytes=httpProxyOutBytes, sslSrvrTotRefused=sslSrvrTotRefused, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyAddress=sslProxyAddress, bws=bws, firmwareStorageHigh=firmwareStorageHigh)
mibBuilder.exportSymbols("BWS-MIB", firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyAddressType=sslProxyAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, webCacheProtocol=webCacheProtocol, memUtilization=memUtilization, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, switchingToBypassMode=switchingToBypassMode, ipsUrlAclAddress=ipsUrlAclAddress, currentFirmwareVersion=currentFirmwareVersion, webCacheMiss=webCacheMiss, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, systemFanSpeed=systemFanSpeed, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrState=httpSrvrState, webCmprProtocol=webCmprProtocol, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrOutBytes=sslSrvrOutBytes, switchingToInlineMode=switchingToInlineMode, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyServerReq=httpProxyServerReq, peerUp=peerUp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheBytesOut=webCacheBytesOut, sslSrvrPort=sslSrvrPort, ipsRCTotDropped=ipsRCTotDropped, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsStats=bwsStats, serviceAddress=serviceAddress, sslSrvrAddressType=sslSrvrAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCacheAddressType=webCacheAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsStatsGroup=bwsStatsGroup, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyAddress=httpProxyAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyOutBytes=sslProxyOutBytes, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, raidDegrading=raidDegrading, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, dataPortLinkDown=dataPortLinkDown, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsMIBConformance=bwsMIBConformance, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrAddressType=httpSrvrAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsMIBCompliances=bwsMIBCompliances, tempHigh=tempHigh, systemLoad=systemLoad, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrNumConn=httpSrvrNumConn, httpProxyTotalReq=httpProxyTotalReq)
