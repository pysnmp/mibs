...
ModuleIdentity, Counter64, Gauge32, TimeTicks, Counter32, Integer32, Bits, Unsigned32, MibIdentifier, iso, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Gauge32", "TimeTicks", "Counter32", "Integer32", "Bits", "Unsigned32", "MibIdentifier", "iso", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyAddress=httpProxyAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, activeServers=activeServers, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsHdrAclHits=ipsHdrAclHits, sslProxyPort=sslProxyPort, linkStatus=linkStatus, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyActiveConn=httpProxyActiveConn, memUtilization=memUtilization, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsRCAddress=ipsRCAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, cpuTemperature=cpuTemperature, sslSrvrNumConn=sslSrvrNumConn, sslSrvrState=sslSrvrState, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCacheMiss=webCacheMiss, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsMIBConformance=bwsMIBConformance, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrPort=sslSrvrPort, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, freeMem=freeMem, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCPort=ipsRCPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrOutBytes=sslSrvrOutBytes, fanDead=fanDead, currentFirmwareVersion=currentFirmwareVersion, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsMIBGroups=bwsMIBGroups, cpuUtilization=cpuUtilization, memoryUsageHigh=memoryUsageHigh, dataPortLinkDown=dataPortLinkDown, firmwareStorageHigh=firmwareStorageHigh, servicePort=servicePort, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, serviceAddress=serviceAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, peerDown=peerDown, processCountHigh=processCountHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsStatsGroup=bwsStatsGroup, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, activeApplications=activeApplications, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, smAgentName=smAgentName, webCacheCacheableRes=webCacheCacheableRes, vipStatus=vipStatus, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemFanSpeed=systemFanSpeed, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, systemFailure=systemFailure, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrAddress=httpSrvrAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, securityDefUpdates=securityDefUpdates, firmwareStorage=firmwareStorage, cpuFanSpeed=cpuFanSpeed, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrAddressType=sslSrvrAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlNormAddress=ipsUrlNormAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, tempHigh=tempHigh, operationalMode=operationalMode, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, tempCritical=tempCritical, systemLoad=systemLoad, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, dataPortLinkUp=dataPortLinkUp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyTotalConn=httpProxyTotalConn, totalMem=totalMem, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, raidDegrading=raidDegrading, sslProxyTotalReq=sslProxyTotalReq, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, switchingToInlineMode=switchingToInlineMode, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, totalAttacks=totalAttacks, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyInBytes=sslProxyInBytes, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyOutBytes=sslProxyOutBytes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCacheProtocol=webCacheProtocol, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyAddressType=sslProxyAddressType, bwsMessage=bwsMessage, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, systemSerialNumber=systemSerialNumber, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, serverUp=serverUp, dataPathStatus=dataPathStatus, webCmprProtocol=webCmprProtocol, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlNormAddressType=ipsUrlNormAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrNumConn=httpSrvrNumConn, webCmprAddressType=webCmprAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrPort=httpSrvrPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCachePort=webCachePort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsTrapGroup=bwsTrapGroup, httpProxyServerAbrt=httpProxyServerAbrt, webCmprAddress=webCmprAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyPort=ipsUrlPolicyPort, logStorage=logStorage, ipsRCTotDropped=ipsRCTotDropped, ipsHdrAclAddress=ipsHdrAclAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsMIBCompliance=bwsMIBCompliance, webCacheStale=webCacheStale, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, serviceStatus=serviceStatus, smNumUserSessions=smNumUserSessions, httpProxyTotalReq=httpProxyTotalReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, srvcName=srvcName, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecTampered=ipsCookieSecTampered, switchingToBypassMode=switchingToBypassMode, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrTotResponse=httpSrvrTotResponse, webCacheAddress=webCacheAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCAddressType=ipsRCAddressType, ipsHdrAclPort=ipsHdrAclPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, logStorageHigh=logStorageHigh, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyClientAbrt=httpProxyClientAbrt, bwsMIBCompliances=bwsMIBCompliances, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrInBytes=sslSrvrInBytes, ipsRCTotServed=ipsRCTotServed, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCacheLongHdrs=webCacheLongHdrs, httpSrvrState=httpSrvrState, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyServerErr=httpProxyServerErr, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyErrPms=sslProxyErrPms, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormPort=ipsUrlNormPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, peerUp=peerUp, sslSrvrTotSuccess=sslSrvrTotSuccess, bwstraps=bwstraps, highAvailabilityStatus=highAvailabilityStatus, uptime=uptime, httpSrvrAvgResTime=httpSrvrAvgResTime, sslProxyCacheHits=sslProxyCacheHits, sslProxyTotalConn=sslProxyTotalConn, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsCookieSecPort=ipsCookieSecPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheReq=webCacheReq)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrMinResTime=httpSrvrMinResTime, webCacheHits=webCacheHits, sslSrvrAddress=sslSrvrAddress, ipsReqSrvcPort=ipsReqSrvcPort, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyAddressType=httpProxyAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrOutBytes=httpSrvrOutBytes, switchingToMaintMode=switchingToMaintMode, totalApplications=totalApplications, totalBandwidth=totalBandwidth, energizeUpdateExpire=energizeUpdateExpire, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bws=bws, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, serviceName=serviceName, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyAddress=sslProxyAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyParseErr=httpProxyParseErr, webCacheCachedObjects=webCacheCachedObjects, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheBytesOut=webCacheBytesOut, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, systemFailOver=systemFailOver, webCmprPort=webCmprPort, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlAclPort=ipsUrlAclPort, bwsStats=bwsStats, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyPort=httpProxyPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, smRealmName=smRealmName, httpProxySessionTimeOut=httpProxySessionTimeOut, virusDefUpdates=virusDefUpdates, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, serverDown=serverDown, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyServerReq=httpProxyServerReq, totalServers=totalServers, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrInBytes=httpSrvrInBytes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlAclAddressType=ipsUrlAclAddressType, PYSNMP_MODULE_ID=bws, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie)
