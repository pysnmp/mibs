...
TimeTicks, Unsigned32, Integer32, MibIdentifier, iso, IpAddress, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, ObjectIdentity, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Integer32", "MibIdentifier", "iso", "IpAddress", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, totalAttacks=totalAttacks, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrMinResTime=sslSrvrMinResTime, bwsMIBConformance=bwsMIBConformance, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, processCountHigh=processCountHigh, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyOutBytes=httpProxyOutBytes, webCmprProtocol=webCmprProtocol, totalBandwidth=totalBandwidth, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotReqActive=sslSrvrTotReqActive, bws=bws, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrTotRefused=httpSrvrTotRefused, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, PYSNMP_MODULE_ID=bws, dataPortLinkUp=dataPortLinkUp, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitAddress=ipsReqLimitAddress, systemFailOver=systemFailOver, sslProxyCacheMiss=sslProxyCacheMiss, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrAddress=httpSrvrAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, activeApplications=activeApplications, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrAvgResTime=httpSrvrAvgResTime, logStorage=logStorage, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyWAFWarnings=httpProxyWAFWarnings, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, tempHigh=tempHigh, httpProxyParseErr=httpProxyParseErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, systemFailure=systemFailure, serverUp=serverUp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, systemSerialNumber=systemSerialNumber, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, webCacheCacheableRes=webCacheCacheableRes, webCacheLongHdrs=webCacheLongHdrs, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, switchingToInlineMode=switchingToInlineMode, cpuUtilization=cpuUtilization, securityDefUpdates=securityDefUpdates, totalServers=totalServers, webCacheProtocol=webCacheProtocol, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsRCTotServed=ipsRCTotServed, ipsRCAddress=ipsRCAddress, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormAddress=ipsUrlNormAddress, ipsRCAddressType=ipsRCAddressType, totalApplications=totalApplications, servicePort=servicePort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyServerReq=httpProxyServerReq, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, uptime=uptime, vipStatus=vipStatus, httpProxyServerErr=httpProxyServerErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, energizeUpdateExpire=energizeUpdateExpire, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, cpuTemperature=cpuTemperature, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrInBytes=httpSrvrInBytes, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, memUtilization=memUtilization, webCmprPort=webCmprPort, smAgentName=smAgentName, srvcName=srvcName, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheMiss=webCacheMiss, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyPort=sslProxyPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, systemFanSpeed=systemFanSpeed, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyInBytes=httpProxyInBytes, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, serviceName=serviceName, httpProxyAddressType=httpProxyAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlNormPort=ipsUrlNormPort, totalMem=totalMem, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsStats=bwsStats, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrTotResponse=httpSrvrTotResponse, raidDegrading=raidDegrading, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheAddress=webCacheAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheReq=webCacheReq, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheCachedObjects=webCacheCachedObjects, serverDown=serverDown, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyTotalReq=httpProxyTotalReq, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCachePort=webCachePort, httpSrvrPort=httpSrvrPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, operationalMode=operationalMode, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrAddressType=sslSrvrAddressType, smRealmName=smRealmName, httpProxyTotalConn=httpProxyTotalConn, bwsMIBCompliance=bwsMIBCompliance, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyAddress=httpProxyAddress, webCmprAddressType=webCmprAddressType, smNumUserSessions=smNumUserSessions, systemLoad=systemLoad, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrAddress=sslSrvrAddress, fanDead=fanDead, sslSrvrState=sslSrvrState, webCmprAddress=webCmprAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsHdrAclAddress=ipsHdrAclAddress, peerDown=peerDown, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, peerUp=peerUp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsMessage=bwsMessage, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheStale=webCacheStale, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCPort=ipsRCPort, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotResponse=sslSrvrTotResponse, bwsServiceStatusTable=bwsServiceStatusTable, serviceAddress=serviceAddress, switchingToMaintMode=switchingToMaintMode, sslProxyAddressType=sslProxyAddressType, bwstraps=bwstraps, webCacheAddressType=webCacheAddressType, sslProxyAddress=sslProxyAddress)
mibBuilder.exportSymbols("BWS-MIB", sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, tempCritical=tempCritical, sslSrvrPort=sslSrvrPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsMIBCompliances=bwsMIBCompliances, bwsTrapGroup=bwsTrapGroup, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcPort=ipsReqSrvcPort, linkStatus=linkStatus, activeServers=activeServers, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, webCacheHits=webCacheHits, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrState=httpSrvrState, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, highAvailabilityStatus=highAvailabilityStatus, firmwareStorageHigh=firmwareStorageHigh, ipsUrlPolicyPort=ipsUrlPolicyPort, freeMem=freeMem, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, serviceStatus=serviceStatus, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, firmwareStorage=firmwareStorage, cpuFanSpeed=cpuFanSpeed, logStorageHigh=logStorageHigh, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyInBytes=sslProxyInBytes, virusDefUpdates=virusDefUpdates, switchingToBypassMode=switchingToBypassMode, sslProxyOutBytes=sslProxyOutBytes, sslSrvrNumConn=sslSrvrNumConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, memoryUsageHigh=memoryUsageHigh, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsStatsGroup=bwsStatsGroup, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyPort=httpProxyPort, ipsCookieSecPort=ipsCookieSecPort, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, dataPathStatus=dataPathStatus, dataPortLinkDown=dataPortLinkDown, httpProxyActiveConn=httpProxyActiveConn, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheBytesOut=webCacheBytesOut, currentFirmwareVersion=currentFirmwareVersion, ipsLrnSrvcAddress=ipsLrnSrvcAddress)
