...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Integer32, Bits, NotificationType, iso, ObjectIdentity, Unsigned32, Counter32, ModuleIdentity, Gauge32, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Integer32", "Bits", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "Counter32", "ModuleIdentity", "Gauge32", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCmprCompressedDataSize=webCmprCompressedDataSize, firmwareStorage=firmwareStorage, uptime=uptime, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, highAvailabilityStatus=highAvailabilityStatus, httpSrvrTotTimedout=httpSrvrTotTimedout, bwstraps=bwstraps, httpProxyParseErr=httpProxyParseErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcPort=ipsLrnSrvcPort, smNumUserSessions=smNumUserSessions, bwsMIBCompliances=bwsMIBCompliances, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyServerReq=httpProxyServerReq, bwsMIBCompliance=bwsMIBCompliance, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, vipStatus=vipStatus, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyInBytes=sslProxyInBytes, ipsRCTotQueued=ipsRCTotQueued, ipsRCTotDropped=ipsRCTotDropped, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyTotalReq=sslProxyTotalReq, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsMIBGroups=bwsMIBGroups, activeApplications=activeApplications, energizeUpdateExpire=energizeUpdateExpire, serverUp=serverUp, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlNormPort=ipsUrlNormPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, serviceName=serviceName, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, peerDown=peerDown, webCachePort=webCachePort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitPort=ipsReqLimitPort, processCountHigh=processCountHigh, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrTotRefused=httpSrvrTotRefused, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, systemFailOver=systemFailOver, serviceStatus=serviceStatus, sslSrvrAddressType=sslSrvrAddressType, cpuUtilization=cpuUtilization, smRealmName=smRealmName, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToInlineMode=switchingToInlineMode, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, logStorageHigh=logStorageHigh, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, totalAttacks=totalAttacks, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlPort=ipsAccessCtrlPort, webCacheAddress=webCacheAddress, bwsStatsGroup=bwsStatsGroup, webCacheHits=webCacheHits, serviceAddress=serviceAddress, sslSrvrPort=sslSrvrPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, raidDegrading=raidDegrading, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, systemLoad=systemLoad, sslProxyErrPms=sslProxyErrPms, httpSrvrTotReqActive=httpSrvrTotReqActive, tempCritical=tempCritical, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, cpuFanSpeed=cpuFanSpeed, bwsMessage=bwsMessage, serverDown=serverDown, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCacheReq=webCacheReq, httpSrvrAddress=httpSrvrAddress, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrInBytes=sslSrvrInBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyPort=httpProxyPort, bwsMIBConformance=bwsMIBConformance, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, totalBandwidth=totalBandwidth, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCacheAddressType=webCacheAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheStale=webCacheStale, bwsTrapGroup=bwsTrapGroup, ipsRCTotServed=ipsRCTotServed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsCacheStatsTable=bwsCacheStatsTable, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyAddress=httpProxyAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprAddress=webCmprAddress, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyOutBytes=sslProxyOutBytes, tempHigh=tempHigh, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, memUtilization=memUtilization, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsRCAddressType=ipsRCAddressType, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyAddressType=sslProxyAddressType, webCmprAddressType=webCmprAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrInBytes=httpSrvrInBytes, httpSrvrAddressType=httpSrvrAddressType, bwsStats=bwsStats, webCmprPort=webCmprPort, httpProxyTotalConn=httpProxyTotalConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheMiss=webCacheMiss, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, currentFirmwareVersion=currentFirmwareVersion, linkStatus=linkStatus, httpProxyAddressType=httpProxyAddressType, switchingToBypassMode=switchingToBypassMode, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheLongHdrs=webCacheLongHdrs, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrState=sslSrvrState, sslProxyAddress=sslProxyAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsHdrAclHits=ipsHdrAclHits, webCacheProtocol=webCacheProtocol, systemFailure=systemFailure, logStorage=logStorage, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlNormAddressType=ipsUrlNormAddressType, peerUp=peerUp, freeMem=freeMem, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyPort=sslProxyPort, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, firmwareStorageHigh=firmwareStorageHigh, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsRCPort=ipsRCPort, webCacheCacheableRes=webCacheCacheableRes, httpProxyServerErr=httpProxyServerErr, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrNumFreeConn=sslSrvrNumFreeConn, securityDefUpdates=securityDefUpdates, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSMUserSessionTable=bwsSMUserSessionTable, totalServers=totalServers, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclPort=ipsUrlAclPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrMaxResTime=sslSrvrMaxResTime, ipsHdrAclPort=ipsHdrAclPort, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyServerAbrt=httpProxyServerAbrt, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyInBytes=httpProxyInBytes, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, dataPathStatus=dataPathStatus, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCmprProtocol=webCmprProtocol, virusDefUpdates=virusDefUpdates, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, cpuTemperature=cpuTemperature, httpProxyTotalReq=httpProxyTotalReq, totalMem=totalMem, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, operationalMode=operationalMode, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, totalApplications=totalApplications, switchingToMaintMode=switchingToMaintMode, httpProxyActiveConn=httpProxyActiveConn, dataPortLinkDown=dataPortLinkDown, ipsReqSrvcAddressType=ipsReqSrvcAddressType, srvcName=srvcName, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecTampered=ipsCookieSecTampered, fanDead=fanDead, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, smAgentName=smAgentName, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrState=httpSrvrState, httpSrvrPort=httpSrvrPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, servicePort=servicePort, ipsRCAddress=ipsRCAddress, PYSNMP_MODULE_ID=bws, systemFanSpeed=systemFanSpeed, bws=bws, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumConn=httpSrvrNumConn, activeServers=activeServers, ipsReqSrvcAddress=ipsReqSrvcAddress)
