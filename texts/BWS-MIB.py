...
Gauge32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Counter64, Unsigned32, IpAddress, NotificationType, ObjectIdentity, Integer32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Counter64", "Unsigned32", "IpAddress", "NotificationType", "ObjectIdentity", "Integer32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyOutBytes=sslProxyOutBytes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, vipStatus=vipStatus, firmwareStorageHigh=firmwareStorageHigh, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheStale=webCacheStale, serviceAddress=serviceAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlAclPort=ipsUrlAclPort, bwsTrapGroup=bwsTrapGroup, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCacheBytesOut=webCacheBytesOut, uptime=uptime, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsHdrAclPort=ipsHdrAclPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyAddress=sslProxyAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, switchingToMaintMode=switchingToMaintMode, sslProxyBadCRLErr=sslProxyBadCRLErr, serverDown=serverDown, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, raidDegrading=raidDegrading, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsRCAddress=ipsRCAddress, ipsUrlNormPort=ipsUrlNormPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, systemFailure=systemFailure, tempHigh=tempHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyOutBytes=httpProxyOutBytes, serviceName=serviceName, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, totalMem=totalMem, httpProxyPort=httpProxyPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyActiveConn=httpProxyActiveConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheLongHdrs=webCacheLongHdrs, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrAddress=httpSrvrAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, peerDown=peerDown, webCacheAddress=webCacheAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, systemSerialNumber=systemSerialNumber, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyTotalReq=sslProxyTotalReq, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsHdrAclHits=ipsHdrAclHits, webCachePort=webCachePort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrState=sslSrvrState, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsMIBConformance=bwsMIBConformance, bwsServiceStatusTable=bwsServiceStatusTable, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, systemFailOver=systemFailOver, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrAddress=sslSrvrAddress, bwsStatsGroup=bwsStatsGroup, logStorageHigh=logStorageHigh, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrMinResTime=httpSrvrMinResTime, totalServers=totalServers, fanDead=fanDead, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, totalAttacks=totalAttacks, bws=bws, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyTotalConn=sslProxyTotalConn, sslProxyActiveConn=sslProxyActiveConn, bwsMessage=bwsMessage, httpSrvrInBytes=httpSrvrInBytes, tempCritical=tempCritical, securityDefUpdates=securityDefUpdates, ipsReqSrvcPort=ipsReqSrvcPort, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecAddressType=ipsCookieSecAddressType, cpuFanSpeed=cpuFanSpeed, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, energizeUpdateExpire=energizeUpdateExpire, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCacheHits=webCacheHits, dataPortLinkDown=dataPortLinkDown, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheMiss=webCacheMiss, linkStatus=linkStatus, serverUp=serverUp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyErrPms=sslProxyErrPms, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrAddressType=httpSrvrAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsStats=bwsStats, ipsCookieSecAddress=ipsCookieSecAddress, webCmprPort=webCmprPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, operationalMode=operationalMode, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrPort=httpSrvrPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, highAvailabilityStatus=highAvailabilityStatus, freeMem=freeMem, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrInBytes=sslSrvrInBytes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, cpuTemperature=cpuTemperature, smRealmName=smRealmName, sslSrvrTotResponse=sslSrvrTotResponse, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, srvcName=srvcName, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, totalApplications=totalApplications, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyInBytes=httpProxyInBytes, bwstraps=bwstraps, currentFirmwareVersion=currentFirmwareVersion, httpSrvrNumConn=httpSrvrNumConn, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlNormAddress=ipsUrlNormAddress, dataPortLinkUp=dataPortLinkUp, webCacheReq=webCacheReq, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCPort=ipsRCPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyClientAbrt=httpProxyClientAbrt, PYSNMP_MODULE_ID=bws, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrState=httpSrvrState, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsCookieSecEncrypted=ipsCookieSecEncrypted, processCountHigh=processCountHigh, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyServerErr=httpProxyServerErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrPort=sslSrvrPort, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, smNumUserSessions=smNumUserSessions, httpProxyServerReq=httpProxyServerReq, memoryUsageHigh=memoryUsageHigh, ipsHdrAclAddress=ipsHdrAclAddress, webCacheAddressType=webCacheAddressType, sslProxyCacheHits=sslProxyCacheHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, switchingToInlineMode=switchingToInlineMode, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serviceStatus=serviceStatus, bwsMIBCompliances=bwsMIBCompliances, sslProxyAddressType=sslProxyAddressType, httpProxyParseErr=httpProxyParseErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, systemFanSpeed=systemFanSpeed, sslSrvrMinResTime=sslSrvrMinResTime, activeServers=activeServers, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCmprAddressType=webCmprAddressType, bwsMIBCompliance=bwsMIBCompliance, sslProxyPort=sslProxyPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, virusDefUpdates=virusDefUpdates, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyAddress=httpProxyAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable)
mibBuilder.exportSymbols("BWS-MIB", bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, dataPathStatus=dataPathStatus, sslSrvrTotTimedout=sslSrvrTotTimedout, servicePort=servicePort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, smAgentName=smAgentName, newAttackDefinitionInstalled=newAttackDefinitionInstalled, memUtilization=memUtilization, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecPort=ipsCookieSecPort, totalBandwidth=totalBandwidth, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsMIBGroups=bwsMIBGroups, sslSrvrOutBytes=sslSrvrOutBytes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, firmwareStorage=firmwareStorage, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, logStorage=logStorage, ipsRCTotServed=ipsRCTotServed, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyAddressType=httpProxyAddressType, systemLoad=systemLoad, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCmprProtocol=webCmprProtocol, ipsRCTotQueued=ipsRCTotQueued, webCacheProtocol=webCacheProtocol, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, peerUp=peerUp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrTotRefused=sslSrvrTotRefused, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheCacheableRes=webCacheCacheableRes, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransPort=ipsWebAddrTransPort, webCmprAddress=webCmprAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyInBytes=sslProxyInBytes, sslSrvrAddressType=sslSrvrAddressType, ipsRCTotDropped=ipsRCTotDropped, activeApplications=activeApplications, ipsCookieSecTampered=ipsCookieSecTampered, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitPort=ipsReqLimitPort, cpuUtilization=cpuUtilization)
