...
ModuleIdentity, Counter64, Bits, NotificationType, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, ObjectIdentity, iso, Gauge32, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Bits", "NotificationType", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "ObjectIdentity", "iso", "Gauge32", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsStatsGroup=bwsStatsGroup, httpProxyActiveConn=httpProxyActiveConn, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyInBytes=sslProxyInBytes, raidDegrading=raidDegrading, webCmprAddressType=webCmprAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrAddress=httpSrvrAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyAddressType=httpProxyAddressType, sslProxyErrPms=sslProxyErrPms, ipsUrlNormPort=ipsUrlNormPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitPort=ipsReqLimitPort, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyAddress=sslProxyAddress, processCountHigh=processCountHigh, totalServers=totalServers, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyPort=sslProxyPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheAddressType=webCacheAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyCacheMiss=sslProxyCacheMiss, webCmprAddress=webCmprAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, serverUp=serverUp, linkStatus=linkStatus, sslProxyBadDNCErr=sslProxyBadDNCErr, highAvailabilityStatus=highAvailabilityStatus, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsMessage=bwsMessage, webCmprProtocol=webCmprProtocol, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, serverDown=serverDown, operationalMode=operationalMode, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyTotalConn=httpProxyTotalConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqSrvcAddressType=ipsReqSrvcAddressType, totalApplications=totalApplications, sslProxyAddressType=sslProxyAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, dataPortLinkDown=dataPortLinkDown, ipsUrlAclPort=ipsUrlAclPort, uptime=uptime, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, firmwareStorageHigh=firmwareStorageHigh, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrNumConn=httpSrvrNumConn, totalBandwidth=totalBandwidth, sslProxyTotalReq=sslProxyTotalReq, ipsRCTotDropped=ipsRCTotDropped, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, serviceAddress=serviceAddress, sslSrvrMinResTime=sslSrvrMinResTime, webCacheBytesOut=webCacheBytesOut, sslProxyTotalConn=sslProxyTotalConn, virusDefUpdates=virusDefUpdates, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrAddress=sslSrvrAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrAddressType=sslSrvrAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, logStorageHigh=logStorageHigh, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, systemLoad=systemLoad, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrPort=sslSrvrPort, ipsRCAddress=ipsRCAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheStale=webCacheStale, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, switchingToInlineMode=switchingToInlineMode, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, PYSNMP_MODULE_ID=bws, systemFailOver=systemFailOver, httpProxyAddress=httpProxyAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyCurrentConn=sslProxyCurrentConn, bwsMIBCompliance=bwsMIBCompliance, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyParseErr=httpProxyParseErr, dataPortLinkUp=dataPortLinkUp, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsCookieSecAddressType=ipsCookieSecAddressType, activeServers=activeServers, cpuFanSpeed=cpuFanSpeed, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrInBytes=sslSrvrInBytes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, fanDead=fanDead, switchingToBypassMode=switchingToBypassMode, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsMIBGroups=bwsMIBGroups, totalMem=totalMem, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyServerAbrt=httpProxyServerAbrt, ipsHdrAclHits=ipsHdrAclHits, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, freeMem=freeMem, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, cpuTemperature=cpuTemperature, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, memoryUsageHigh=memoryUsageHigh, httpSrvrPort=httpSrvrPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, switchingToMaintMode=switchingToMaintMode, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyServerErr=httpProxyServerErr, webCacheLongHdrs=webCacheLongHdrs, systemFailure=systemFailure, ipsRCAddressType=ipsRCAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitAddressType=ipsReqLimitAddressType, bwstraps=bwstraps, servicePort=servicePort, systemFanSpeed=systemFanSpeed, httpSrvrState=httpSrvrState, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, logStorage=logStorage, httpSrvrAvgResTime=httpSrvrAvgResTime, totalAttacks=totalAttacks, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrNumConn=sslSrvrNumConn, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, srvcName=srvcName, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheReq=webCacheReq, memUtilization=memUtilization, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, dataPathStatus=dataPathStatus, vipStatus=vipStatus, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheMiss=webCacheMiss, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, smNumUserSessions=smNumUserSessions, bwsCompressionStatsTable=bwsCompressionStatsTable, peerUp=peerUp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsMIBCompliances=bwsMIBCompliances, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, energizeUpdateExpire=energizeUpdateExpire, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, systemSerialNumber=systemSerialNumber, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyServerReq=httpProxyServerReq, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyOutBytes=httpProxyOutBytes, serviceStatus=serviceStatus, peerDown=peerDown, tempHigh=tempHigh, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsStats=bwsStats, httpProxyPort=httpProxyPort, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheHits=webCacheHits, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrAvgResTime=sslSrvrAvgResTime, smRealmName=smRealmName, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheCachedObjects=webCacheCachedObjects, bwsServiceStatusTable=bwsServiceStatusTable, ipsHdrAclAddress=ipsHdrAclAddress, bwsMIBConformance=bwsMIBConformance)
mibBuilder.exportSymbols("BWS-MIB", bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsTrapGroup=bwsTrapGroup, ipsRCTotServed=ipsRCTotServed, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyInBytes=httpProxyInBytes, bws=bws, ipsCookieSecPort=ipsCookieSecPort, cpuUtilization=cpuUtilization, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCachePort=webCachePort, activeApplications=activeApplications, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sharedSecretKeyExpired=sharedSecretKeyExpired, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCmprPort=webCmprPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, securityDefUpdates=securityDefUpdates, httpSrvrAddressType=httpSrvrAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyTotalReq=httpProxyTotalReq, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrState=sslSrvrState, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCacheProtocol=webCacheProtocol, serviceName=serviceName, ipsUrlNormAddress=ipsUrlNormAddress, tempCritical=tempCritical, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCacheAddress=webCacheAddress, currentFirmwareVersion=currentFirmwareVersion, httpSrvrInBytes=httpSrvrInBytes, ipsRCPort=ipsRCPort, sslSrvrTotResponse=sslSrvrTotResponse, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, smAgentName=smAgentName, firmwareStorage=firmwareStorage, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr)
