...
Counter64, Counter32, iso, ModuleIdentity, MibIdentifier, Integer32, NotificationType, TimeTicks, Bits, Gauge32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "iso", "ModuleIdentity", "MibIdentifier", "Integer32", "NotificationType", "TimeTicks", "Bits", "Gauge32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyTotalConn=sslProxyTotalConn, sslProxyTotalReq=sslProxyTotalReq, httpSrvrMinResTime=httpSrvrMinResTime, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotDropped=ipsRCTotDropped, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheReq=webCacheReq, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlNormPort=ipsUrlNormPort, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsStats=bwsStats, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCAddressType=ipsRCAddressType, tempCritical=tempCritical, totalAttacks=totalAttacks, httpProxyUnknownRsp=httpProxyUnknownRsp, serviceName=serviceName, httpProxyTotalConn=httpProxyTotalConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, freeMem=freeMem, httpSrvrSrvcPort=httpSrvrSrvcPort, uptime=uptime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrTotRefused=sslSrvrTotRefused, serviceStatus=serviceStatus, httpProxyServerReq=httpProxyServerReq, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsStatsGroup=bwsStatsGroup, activeServers=activeServers, energizeUpdateExpire=energizeUpdateExpire, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, systemLoad=systemLoad, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, raidDegrading=raidDegrading, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprAddressType=webCmprAddressType, httpSrvrAddressType=httpSrvrAddressType, bwsMIBGroups=bwsMIBGroups, bwsIpsRCStatsTable=bwsIpsRCStatsTable, systemFanSpeed=systemFanSpeed, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, serviceAddress=serviceAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, webCacheProtocol=webCacheProtocol, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormAddressType=ipsUrlNormAddressType, currentFirmwareVersion=currentFirmwareVersion, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, switchingToInlineMode=switchingToInlineMode, processCountHigh=processCountHigh, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCacheMiss=webCacheMiss, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsMIBCompliances=bwsMIBCompliances, bwsCacheStatsEntry=bwsCacheStatsEntry, serverUp=serverUp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, fanDead=fanDead, switchingToBypassMode=switchingToBypassMode, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, peerDown=peerDown, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyAddressType=httpProxyAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, dataPathStatus=dataPathStatus, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToMaintMode=switchingToMaintMode, bwsCompressionStatsEntry=bwsCompressionStatsEntry, highAvailabilityStatus=highAvailabilityStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyAddressType=sslProxyAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, logStorage=logStorage, totalBandwidth=totalBandwidth, ipsRCTotServed=ipsRCTotServed, httpProxyParseErr=httpProxyParseErr, httpProxyAddress=httpProxyAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCmprPort=webCmprPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, systemFailure=systemFailure, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, linkStatus=linkStatus, smRealmName=smRealmName, virusDefUpdates=virusDefUpdates, webCacheCacheableRes=webCacheCacheableRes, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrNumConn=sslSrvrNumConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyWAFWarnings=httpProxyWAFWarnings, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, cpuTemperature=cpuTemperature, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlAclReserved=ipsUrlAclReserved, smNumUserSessions=smNumUserSessions, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyCurrentConn=sslProxyCurrentConn, ipsRCAddress=ipsRCAddress, httpSrvrPort=httpSrvrPort, srvcName=srvcName, activeApplications=activeApplications, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, cpuFanSpeed=cpuFanSpeed, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotRefused=httpSrvrTotRefused, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrPort=sslSrvrPort, totalApplications=totalApplications, httpSrvrAddress=httpSrvrAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, firmwareStorageHigh=firmwareStorageHigh, ipsReqLimitPort=ipsReqLimitPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, dataPortLinkDown=dataPortLinkDown, bwsMessage=bwsMessage, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bws=bws, systemSerialNumber=systemSerialNumber, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, PYSNMP_MODULE_ID=bws, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyPort=sslProxyPort, ipsHdrAclHits=ipsHdrAclHits, sslSrvrAddress=sslSrvrAddress, memoryUsageHigh=memoryUsageHigh, httpSrvrState=httpSrvrState, ipsAccessCtrlPort=ipsAccessCtrlPort, webCacheAddressType=webCacheAddressType, peerUp=peerUp, systemFailOver=systemFailOver, ipsRCPort=ipsRCPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, totalServers=totalServers, ipsHdrAclAddress=ipsHdrAclAddress, securityDefUpdates=securityDefUpdates, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, logStorageHigh=logStorageHigh, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrInBytes=sslSrvrInBytes, cpuUtilization=cpuUtilization, sslProxyCacheMiss=sslProxyCacheMiss, servicePort=servicePort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecPort=ipsCookieSecPort, webCacheStale=webCacheStale, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, serverDown=serverDown, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyActiveConn=sslProxyActiveConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyErrPms=sslProxyErrPms, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, firmwareStorage=firmwareStorage, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyAddress=sslProxyAddress)
mibBuilder.exportSymbols("BWS-MIB", sslProxyInBytes=sslProxyInBytes, webCacheAddress=webCacheAddress, httpProxyPort=httpProxyPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecAddress=ipsCookieSecAddress, webCacheBytesOut=webCacheBytesOut, operationalMode=operationalMode, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumConn=httpSrvrNumConn, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwstraps=bwstraps, bwsTrapGroup=bwsTrapGroup, httpProxyOutBytes=httpProxyOutBytes, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyCacheHits=sslProxyCacheHits, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCmprCompressibleDataSize=webCmprCompressibleDataSize, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyInBytes=httpProxyInBytes, webCmprAddress=webCmprAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrAddressType=sslSrvrAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCTotQueued=ipsRCTotQueued, vipStatus=vipStatus, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrState=sslSrvrState, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyServerErr=httpProxyServerErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCachePort=webCachePort, webCmprProtocol=webCmprProtocol, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrTotTimedout=httpSrvrTotTimedout, tempHigh=tempHigh, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqSrvcPort=ipsReqSrvcPort, totalMem=totalMem, webCacheHits=webCacheHits, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsMIBConformance=bwsMIBConformance, dataPortLinkUp=dataPortLinkUp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, smAgentName=smAgentName, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, memUtilization=memUtilization)
