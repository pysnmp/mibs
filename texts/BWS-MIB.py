...
iso, Counter32, Bits, TimeTicks, Unsigned32, ModuleIdentity, Gauge32, NotificationType, ObjectIdentity, Integer32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Bits", "TimeTicks", "Unsigned32", "ModuleIdentity", "Gauge32", "NotificationType", "ObjectIdentity", "Integer32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", srvcName=srvcName, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrPort=sslSrvrPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsMessage=bwsMessage, dataPortLinkUp=dataPortLinkUp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyTotalConn=sslProxyTotalConn, sslSrvrTotResponse=sslSrvrTotResponse, webCmprAddressType=webCmprAddressType, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrInBytes=sslSrvrInBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumConn=sslSrvrNumConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, vipStatus=vipStatus, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, firmwareStorageHigh=firmwareStorageHigh, totalApplications=totalApplications, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyAddress=sslProxyAddress, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyAddress=httpProxyAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, serviceStatus=serviceStatus, PYSNMP_MODULE_ID=bws, ipsRCTotDropped=ipsRCTotDropped, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyPort=httpProxyPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, serviceAddress=serviceAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsStatsGroup=bwsStatsGroup, sslSrvrAddressType=sslSrvrAddressType, webCacheStale=webCacheStale, tempHigh=tempHigh, webCmprProtocol=webCmprProtocol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsRCAddressType=ipsRCAddressType, switchingToMaintMode=switchingToMaintMode, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, serviceName=serviceName, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, systemSerialNumber=systemSerialNumber, ipsRCTotServed=ipsRCTotServed, sslSrvrAddress=sslSrvrAddress, tempCritical=tempCritical, firmwareStorage=firmwareStorage, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrTotRefused=httpSrvrTotRefused, bwsTrapGroup=bwsTrapGroup, httpProxyParseErr=httpProxyParseErr, activeApplications=activeApplications, sslProxyErrPms=sslProxyErrPms, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsHdrAclHits=ipsHdrAclHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsMIBCompliance=bwsMIBCompliance, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, logStorage=logStorage, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrAddress=httpSrvrAddress, webCachePort=webCachePort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, smAgentName=smAgentName, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrAddressType=httpSrvrAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, systemFailure=systemFailure, switchingToInlineMode=switchingToInlineMode, totalServers=totalServers, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, peerDown=peerDown, currentFirmwareVersion=currentFirmwareVersion, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyOutBytes=httpProxyOutBytes, freeMem=freeMem, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, memUtilization=memUtilization, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitPort=ipsReqLimitPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheCacheableRes=webCacheCacheableRes, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, energizeUpdateExpire=energizeUpdateExpire, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, dataPortLinkDown=dataPortLinkDown, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlNormPort=ipsUrlNormPort, httpProxyWAFWarnings=httpProxyWAFWarnings, switchingToBypassMode=switchingToBypassMode, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyServerReq=httpProxyServerReq, totalMem=totalMem, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumConn=httpSrvrNumConn, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCAddress=ipsRCAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, memoryUsageHigh=memoryUsageHigh, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, activeServers=activeServers, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwstraps=bwstraps, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheProtocol=webCacheProtocol, httpProxyTotalReq=httpProxyTotalReq, serverDown=serverDown, webCacheMiss=webCacheMiss, httpProxyInBytes=httpProxyInBytes, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclAddress=ipsUrlAclAddress, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, systemFanSpeed=systemFanSpeed, smNumUserSessions=smNumUserSessions, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsHdrAclPort=ipsHdrAclPort, webCmprPort=webCmprPort, webCacheLongHdrs=webCacheLongHdrs, bwsMIBConformance=bwsMIBConformance, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsMIBCompliances=bwsMIBCompliances, fanDead=fanDead, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, virusDefUpdates=virusDefUpdates, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheReq=webCacheReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, webCmprAddress=webCmprAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsMIBGroups=bwsMIBGroups, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsRCTotQueued=ipsRCTotQueued, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyPort=ipsUrlPolicyPort, webCacheAddressType=webCacheAddressType, uptime=uptime, bws=bws, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyActiveConn=httpProxyActiveConn, webCacheAddress=webCacheAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyInBytes=sslProxyInBytes, systemLoad=systemLoad, totalAttacks=totalAttacks, httpSrvrTotResponse=httpSrvrTotResponse, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyTotalReq=sslProxyTotalReq, securityDefUpdates=securityDefUpdates, raidDegrading=raidDegrading, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyServerErr=httpProxyServerErr, dataPathStatus=dataPathStatus, operationalMode=operationalMode, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyAddressType=httpProxyAddressType, serverUp=serverUp)
mibBuilder.exportSymbols("BWS-MIB", httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsRCPort=ipsRCPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyPort=sslProxyPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrPort=httpSrvrPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsStats=bwsStats, peerUp=peerUp, logStorageHigh=logStorageHigh, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheBytesOut=webCacheBytesOut, cpuUtilization=cpuUtilization, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyActiveConn=sslProxyActiveConn, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCacheHits=webCacheHits, sslSrvrMinResTime=sslSrvrMinResTime, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyServerAbrt=httpProxyServerAbrt, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcPort=ipsReqSrvcPort, ipsCookieSecAddressType=ipsCookieSecAddressType, systemFailOver=systemFailOver, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, processCountHigh=processCountHigh, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotRefused=sslSrvrTotRefused, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, servicePort=servicePort, httpSrvrState=httpSrvrState, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrState=sslSrvrState, smRealmName=smRealmName, cpuTemperature=cpuTemperature, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, linkStatus=linkStatus, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, totalBandwidth=totalBandwidth)
