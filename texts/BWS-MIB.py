...
MibIdentifier, iso, Integer32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, TimeTicks, IpAddress, NotificationType, Bits, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Integer32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "TimeTicks", "IpAddress", "NotificationType", "Bits", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyWAFWarnings=httpProxyWAFWarnings, webCmprAddress=webCmprAddress, bwsMIBGroups=bwsMIBGroups, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyPort=httpProxyPort, httpProxyServerReq=httpProxyServerReq, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrAddress=sslSrvrAddress, sslSrvrNumConn=sslSrvrNumConn, bwsTrapGroup=bwsTrapGroup, linkStatus=linkStatus, webCmprProtocol=webCmprProtocol, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, tempCritical=tempCritical, raidDegrading=raidDegrading, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, systemFanSpeed=systemFanSpeed, smRealmName=smRealmName, sslSrvrPort=sslSrvrPort, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyOutBytes=httpProxyOutBytes, sslSrvrInBytes=sslSrvrInBytes, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCTotServed=ipsRCTotServed, sslProxyBadDNCErr=sslProxyBadDNCErr, serverUp=serverUp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCTotDropped=ipsRCTotDropped, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, systemFailOver=systemFailOver, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, dataPathStatus=dataPathStatus, logStorage=logStorage, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCacheStale=webCacheStale, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToMaintMode=switchingToMaintMode, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsCacheStatsEntry=bwsCacheStatsEntry, serviceAddress=serviceAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyInBytes=sslProxyInBytes, energizeUpdateExpire=energizeUpdateExpire, operationalMode=operationalMode, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcPort=ipsLrnSrvcPort, webCachePort=webCachePort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormPort=ipsUrlNormPort, smNumUserSessions=smNumUserSessions, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, peerDown=peerDown, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrState=httpSrvrState, PYSNMP_MODULE_ID=bws, webCacheReq=webCacheReq, srvcName=srvcName, httpProxyActiveConn=httpProxyActiveConn, webCacheHits=webCacheHits, tempHigh=tempHigh, serviceStatus=serviceStatus, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, processCountHigh=processCountHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsCookieSecTampered=ipsCookieSecTampered, bwsMIBCompliances=bwsMIBCompliances, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, virusDefUpdates=virusDefUpdates, sslProxyCurrentConn=sslProxyCurrentConn, smAgentName=smAgentName, serviceName=serviceName, securityDefUpdates=securityDefUpdates, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyServerAbrt=httpProxyServerAbrt, servicePort=servicePort, ipsRCAddressType=ipsRCAddressType, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsMIBConformance=bwsMIBConformance, ipsRCPort=ipsRCPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclPort=ipsUrlAclPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, webCmprPort=webCmprPort, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumConn=httpSrvrNumConn, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitPort=ipsReqLimitPort, bwsServiceStatusTable=bwsServiceStatusTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sharedSecretKeyExpired=sharedSecretKeyExpired, dataPortLinkUp=dataPortLinkUp, webCacheAddressType=webCacheAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsStatsGroup=bwsStatsGroup, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, totalMem=totalMem, totalAttacks=totalAttacks, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCacheBytesOut=webCacheBytesOut, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCmprAddressType=webCmprAddressType, sslProxyErrPms=sslProxyErrPms, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, systemSerialNumber=systemSerialNumber, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, memoryUsageHigh=memoryUsageHigh, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, currentFirmwareVersion=currentFirmwareVersion, ipsRCTotQueued=ipsRCTotQueued, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyAddress=httpProxyAddress, ipsRCTimeStamp=ipsRCTimeStamp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, vipStatus=vipStatus, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, firmwareStorageHigh=firmwareStorageHigh, sslProxyCacheHits=sslProxyCacheHits, httpSrvrPort=httpSrvrPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyAddress=sslProxyAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyPort=sslProxyPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, totalApplications=totalApplications, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsMessage=bwsMessage, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyServerErr=httpProxyServerErr, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrTotResponse=sslSrvrTotResponse, ipsCookieSecAddress=ipsCookieSecAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrTotTimedout=sslSrvrTotTimedout, totalServers=totalServers, firmwareStorage=firmwareStorage, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, switchingToInlineMode=switchingToInlineMode, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheAddress=webCacheAddress, logStorageHigh=logStorageHigh, dataPortLinkDown=dataPortLinkDown, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsHdrAclPort=ipsHdrAclPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, cpuFanSpeed=cpuFanSpeed, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsStats=bwsStats, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheProtocol=webCacheProtocol, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, memUtilization=memUtilization, cpuUtilization=cpuUtilization, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotReqRejected=httpSrvrTotReqRejected, cpuTemperature=cpuTemperature, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", totalBandwidth=totalBandwidth, freeMem=freeMem, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsCacheStatsTable=bwsCacheStatsTable, webCacheLongHdrs=webCacheLongHdrs, sslProxyAddressType=sslProxyAddressType, webCacheMiss=webCacheMiss, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, serverDown=serverDown, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyTotalConn=httpProxyTotalConn, httpSrvrInBytes=httpSrvrInBytes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwstraps=bwstraps, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, uptime=uptime, ipsCookieSecAddressType=ipsCookieSecAddressType, bws=bws, httpSrvrAddress=httpSrvrAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyAddressType=httpProxyAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, highAvailabilityStatus=highAvailabilityStatus, sslSrvrAddressType=sslSrvrAddressType, sslSrvrState=sslSrvrState, webCacheCacheableRes=webCacheCacheableRes, sslProxyOutBytes=sslProxyOutBytes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyParseErr=httpProxyParseErr, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, switchingToBypassMode=switchingToBypassMode, fanDead=fanDead, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, systemLoad=systemLoad, activeServers=activeServers, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, activeApplications=activeApplications, ipsRCAddress=ipsRCAddress, peerUp=peerUp, systemFailure=systemFailure, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr)
