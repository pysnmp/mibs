...
iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, TimeTicks, Unsigned32, ObjectIdentity, Counter32, NotificationType, Gauge32, ModuleIdentity, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "TimeTicks", "Unsigned32", "ObjectIdentity", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, switchingToBypassMode=switchingToBypassMode, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, srvcName=srvcName, httpSrvrNumConn=httpSrvrNumConn, webCmprAddress=webCmprAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrPort=httpSrvrPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, logStorageHigh=logStorageHigh, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheReq=webCacheReq, bwsCacheStatsTable=bwsCacheStatsTable, highAvailabilityStatus=highAvailabilityStatus, sslProxyErrPms=sslProxyErrPms, activeApplications=activeApplications, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitAddress=ipsReqLimitAddress, webCacheMiss=webCacheMiss, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, serviceName=serviceName, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, totalApplications=totalApplications, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, servicePort=servicePort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyTotalConn=sslProxyTotalConn, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, systemLoad=systemLoad, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsRCTotOutOfResource=ipsRCTotOutOfResource, systemSerialNumber=systemSerialNumber, webCmprProtocol=webCmprProtocol, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyTotalReq=sslProxyTotalReq, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrNumFreeConn=httpSrvrNumFreeConn, virusDefUpdates=virusDefUpdates, ipsRCTotQueued=ipsRCTotQueued, dataPortLinkDown=dataPortLinkDown, ipsRCAddressType=ipsRCAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrPort=sslSrvrPort, httpProxyUnknownRsp=httpProxyUnknownRsp, freeMem=freeMem, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, logStorage=logStorage, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, raidDegrading=raidDegrading, ipsUrlAclPort=ipsUrlAclPort, webCacheLongHdrs=webCacheLongHdrs, firmwareStorage=firmwareStorage, ipsUrlAclReserved=ipsUrlAclReserved, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyInBytes=httpProxyInBytes, sslSrvrOutBytes=sslSrvrOutBytes, ipsHdrAclPort=ipsHdrAclPort, tempHigh=tempHigh, operationalMode=operationalMode, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsRCAddress=ipsRCAddress, memUtilization=memUtilization, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrTotReqActive=sslSrvrTotReqActive, serviceStatus=serviceStatus, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, serverDown=serverDown, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, fanDead=fanDead, webCacheStale=webCacheStale, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqSrvcPort=ipsReqSrvcPort, currentFirmwareVersion=currentFirmwareVersion, bwstraps=bwstraps, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsMIBGroups=bwsMIBGroups, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, activeServers=activeServers, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, vipStatus=vipStatus, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, smAgentName=smAgentName, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, peerUp=peerUp, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrTotRefused=sslSrvrTotRefused, bwsMIBConformance=bwsMIBConformance, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheAddress=webCacheAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyServerReq=httpProxyServerReq, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotRefused=httpSrvrTotRefused, switchingToMaintMode=switchingToMaintMode, httpProxyPort=httpProxyPort, httpProxyAddressType=httpProxyAddressType, httpProxyActiveConn=httpProxyActiveConn, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, linkStatus=linkStatus, sslProxyAddress=sslProxyAddress, webCacheCachedObjects=webCacheCachedObjects, sslProxyPort=sslProxyPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsStats=bwsStats, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsTrapGroup=bwsTrapGroup, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, securityDefUpdates=securityDefUpdates, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotTimedout=sslSrvrTotTimedout, peerDown=peerDown, ipsRCTotDropped=ipsRCTotDropped, httpSrvrTotReqActive=httpSrvrTotReqActive, smNumUserSessions=smNumUserSessions, energizeUpdateExpire=energizeUpdateExpire, dataPathStatus=dataPathStatus, httpProxyOutBytes=httpProxyOutBytes, cpuTemperature=cpuTemperature, sslSrvrNumConn=sslSrvrNumConn, dataPortLinkUp=dataPortLinkUp, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyCacheMiss=sslProxyCacheMiss, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, memoryUsageHigh=memoryUsageHigh, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyParseErr=httpProxyParseErr, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, processCountHigh=processCountHigh, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, systemFailOver=systemFailOver, sslProxyBadCRLErr=sslProxyBadCRLErr, bws=bws, uptime=uptime, webCacheAddressType=webCacheAddressType, ipsCookieSecPort=ipsCookieSecPort, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyCacheHits=sslProxyCacheHits, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, tempCritical=tempCritical, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, serverUp=serverUp, PYSNMP_MODULE_ID=bws, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCmprPort=webCmprPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheProtocol=webCacheProtocol, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlNormPort=ipsUrlNormPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrState=sslSrvrState, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyFullHandshakes=sslProxyFullHandshakes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, systemFailure=systemFailure, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclAddress=ipsUrlAclAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyTotalConn=httpProxyTotalConn)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, totalServers=totalServers, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, cpuUtilization=cpuUtilization, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyInBytes=sslProxyInBytes, httpSrvrAddressType=httpSrvrAddressType, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCmprAddressType=webCmprAddressType, webCacheHits=webCacheHits, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsStatsGroup=bwsStatsGroup, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, switchingToInlineMode=switchingToInlineMode, ipsRCTotServed=ipsRCTotServed, httpSrvrState=httpSrvrState, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyTotalReq=httpProxyTotalReq, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, smRealmName=smRealmName, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyAddress=httpProxyAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCachePort=webCachePort, bwsMIBCompliance=bwsMIBCompliance, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyAddressType=sslProxyAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, totalBandwidth=totalBandwidth, serviceAddress=serviceAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, totalMem=totalMem, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, firmwareStorageHigh=firmwareStorageHigh, httpProxyServerErr=httpProxyServerErr, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsMessage=bwsMessage, sslSrvrAddress=sslSrvrAddress, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitPort=ipsReqLimitPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, totalAttacks=totalAttacks, systemFanSpeed=systemFanSpeed, ipsRCPort=ipsRCPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrAddressType=sslSrvrAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlAclAddressType=ipsUrlAclAddressType)
