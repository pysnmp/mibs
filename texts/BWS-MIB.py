...
ObjectIdentity, Unsigned32, TimeTicks, Integer32, ModuleIdentity, Counter64, MibIdentifier, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "TimeTicks", "Integer32", "ModuleIdentity", "Counter64", "MibIdentifier", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", activeApplications=activeApplications, webCmprAddressType=webCmprAddressType, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqLimitAddress=ipsReqLimitAddress, cpuFanSpeed=cpuFanSpeed, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyTotalReq=httpProxyTotalReq, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, cpuTemperature=cpuTemperature, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyCacheHits=sslProxyCacheHits, bwstraps=bwstraps, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheReq=webCacheReq, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, energizeUpdateExpire=energizeUpdateExpire, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAddressType=httpSrvrAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, firmwareStorage=firmwareStorage, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyInBytes=httpProxyInBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecAddress=ipsCookieSecAddress, bwsStatsGroup=bwsStatsGroup, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrAddress=httpSrvrAddress, sslProxyAddress=sslProxyAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, logStorage=logStorage, bwsServiceStatusTable=bwsServiceStatusTable, totalBandwidth=totalBandwidth, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsCacheStatsTable=bwsCacheStatsTable, totalServers=totalServers, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyAddress=httpProxyAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecPort=ipsCookieSecPort, sslSrvrPort=sslSrvrPort, sslProxyAddressType=sslProxyAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, tempCritical=tempCritical, sslSrvrAddress=sslSrvrAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, switchingToBypassMode=switchingToBypassMode, webCacheBytesOut=webCacheBytesOut, dataPortLinkUp=dataPortLinkUp, vipStatus=vipStatus, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrPort=httpSrvrPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsRCAddressType=ipsRCAddressType, servicePort=servicePort, bwsMessage=bwsMessage, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCTotQueued=ipsRCTotQueued, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheAddressType=webCacheAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsMIBCompliance=bwsMIBCompliance, webCmprPort=webCmprPort, serverUp=serverUp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheAddress=webCacheAddress, sslSrvrState=sslSrvrState, serviceName=serviceName, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclPort=ipsUrlAclPort, bwsSMUserSessionTable=bwsSMUserSessionTable, srvcName=srvcName, webCacheLongHdrs=webCacheLongHdrs, activeServers=activeServers, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bws=bws, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCacheHits=webCacheHits, ipsReqLimitPort=ipsReqLimitPort, ipsUrlNormAddress=ipsUrlNormAddress, peerDown=peerDown, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, tempHigh=tempHigh, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serverDown=serverDown, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsSslProxyStatsTable=bwsSslProxyStatsTable, processCountHigh=processCountHigh, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsMIBConformance=bwsMIBConformance, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, securityDefUpdates=securityDefUpdates, smNumUserSessions=smNumUserSessions, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyParseErr=httpProxyParseErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyActiveConn=httpProxyActiveConn, switchingToMaintMode=switchingToMaintMode, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCachePort=webCachePort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsRCAddress=ipsRCAddress, bwsMIBCompliances=bwsMIBCompliances, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyTotalConn=httpProxyTotalConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyPort=sslProxyPort, systemLoad=systemLoad, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, totalAttacks=totalAttacks, smRealmName=smRealmName, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheCachedObjects=webCacheCachedObjects, freeMem=freeMem, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, memoryUsageHigh=memoryUsageHigh, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrMinResTime=httpSrvrMinResTime, webCmprProtocol=webCmprProtocol, systemFailure=systemFailure, fanDead=fanDead, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsHdrAclHits=ipsHdrAclHits, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcPort=ipsLrnSrvcPort, cpuUtilization=cpuUtilization, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrInBytes=sslSrvrInBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, peerUp=peerUp, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, smAgentName=smAgentName, operationalMode=operationalMode, webCmprAddress=webCmprAddress, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrInBytes=httpSrvrInBytes, sslProxyBadDNCErr=sslProxyBadDNCErr, PYSNMP_MODULE_ID=bws, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsTrapGroup=bwsTrapGroup, totalApplications=totalApplications, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, serviceAddress=serviceAddress, webCacheCacheableRes=webCacheCacheableRes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, serviceStatus=serviceStatus, webCacheMiss=webCacheMiss, switchingToInlineMode=switchingToInlineMode, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, totalMem=totalMem, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyServerErr=httpProxyServerErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCacheProtocol=webCacheProtocol, sslProxyInBytes=sslProxyInBytes, linkStatus=linkStatus, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsMIBGroups=bwsMIBGroups, currentFirmwareVersion=currentFirmwareVersion, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrTotReqActive=sslSrvrTotReqActive, firmwareStorageHigh=firmwareStorageHigh)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrAddressType=sslSrvrAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCacheStale=webCacheStale, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, raidDegrading=raidDegrading, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyServerReq=httpProxyServerReq, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsServiceStatusEntry=bwsServiceStatusEntry, virusDefUpdates=virusDefUpdates, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyOutBytes=httpProxyOutBytes, httpSrvrState=httpSrvrState, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, logStorageHigh=logStorageHigh, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsRCTotServed=ipsRCTotServed, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsRCTotDropped=ipsRCTotDropped, ipsUrlAclReserved=ipsUrlAclReserved, dataPathStatus=dataPathStatus, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, memUtilization=memUtilization, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsStats=bwsStats, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, systemSerialNumber=systemSerialNumber, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, systemFailOver=systemFailOver, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyPort=httpProxyPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, uptime=uptime, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, systemFanSpeed=systemFanSpeed, ipsRCPort=ipsRCPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyErrPms=sslProxyErrPms, sslProxyTotalReq=sslProxyTotalReq)
