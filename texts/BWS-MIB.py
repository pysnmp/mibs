...
ObjectIdentity, MibIdentifier, TimeTicks, IpAddress, ModuleIdentity, Bits, Counter32, Counter64, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "ModuleIdentity", "Bits", "Counter32", "Counter64", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", dataPortLinkDown=dataPortLinkDown, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrMaxResTime=httpSrvrMaxResTime, serverUp=serverUp, systemSerialNumber=systemSerialNumber, bwstraps=bwstraps, httpSrvrAddressType=httpSrvrAddressType, httpSrvrPort=httpSrvrPort, tempCritical=tempCritical, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, vipStatus=vipStatus, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, memoryUsageHigh=memoryUsageHigh, httpProxyActiveConn=httpProxyActiveConn, webCachePort=webCachePort, httpProxyServerErr=httpProxyServerErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsRCAddress=ipsRCAddress, firmwareStorageHigh=firmwareStorageHigh, highAvailabilityStatus=highAvailabilityStatus, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyPort=sslProxyPort, logStorage=logStorage, ipsCookieSecAddress=ipsCookieSecAddress, webCacheHits=webCacheHits, linkStatus=linkStatus, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheAddressType=webCacheAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, firmwareStorage=firmwareStorage, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCacheCachedObjects=webCacheCachedObjects, servicePort=servicePort, webCacheCacheableRes=webCacheCacheableRes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, systemFailure=systemFailure, srvcName=srvcName, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyActiveConn=sslProxyActiveConn, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyPort=httpProxyPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, totalServers=totalServers, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, switchingToBypassMode=switchingToBypassMode, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, smRealmName=smRealmName, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, energizeUpdateExpire=energizeUpdateExpire, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, memUtilization=memUtilization, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, serviceName=serviceName, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, fanDead=fanDead, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprAddressType=webCmprAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCmprAddress=webCmprAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, systemFanSpeed=systemFanSpeed, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecPort=ipsCookieSecPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, uptime=uptime, ipsUrlNormAddressType=ipsUrlNormAddressType, dataPortLinkUp=dataPortLinkUp, ipsUrlAclReserved=ipsUrlAclReserved, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyServerReq=httpProxyServerReq, cpuTemperature=cpuTemperature, serviceAddress=serviceAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsMIBConformance=bwsMIBConformance, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, smNumUserSessions=smNumUserSessions, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCacheMiss=webCacheMiss, httpProxyInBytes=httpProxyInBytes, ipsUrlAclAddress=ipsUrlAclAddress, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, switchingToMaintMode=switchingToMaintMode, switchingToInlineMode=switchingToInlineMode, httpProxyAddress=httpProxyAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsMIBCompliance=bwsMIBCompliance, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, operationalMode=operationalMode, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsStats=bwsStats, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsRCTotServed=ipsRCTotServed, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumConn=httpSrvrNumConn, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsMessage=bwsMessage, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrState=httpSrvrState, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bws=bws, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsMIBGroups=bwsMIBGroups, httpProxyClientAbrt=httpProxyClientAbrt, webCacheStale=webCacheStale, httpSrvrMinResTime=httpSrvrMinResTime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrAddress=sslSrvrAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, totalAttacks=totalAttacks, ipsUrlAclPort=ipsUrlAclPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, totalMem=totalMem, sslProxyTotalConn=sslProxyTotalConn, raidDegrading=raidDegrading, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyAddressType=sslProxyAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyTotalReq=sslProxyTotalReq, httpSrvrAddress=httpSrvrAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsMIBCompliances=bwsMIBCompliances, serverDown=serverDown, webCmprPort=webCmprPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, currentFirmwareVersion=currentFirmwareVersion, httpProxyParseErr=httpProxyParseErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxySessionTimeOut=httpProxySessionTimeOut, totalBandwidth=totalBandwidth, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrState=sslSrvrState, peerUp=peerUp, activeServers=activeServers, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, smAgentName=smAgentName, ipsRCPort=ipsRCPort, cpuUtilization=cpuUtilization, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsRCTotDropped=ipsRCTotDropped, systemLoad=systemLoad, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsRCTotQueued=ipsRCTotQueued, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrSrvcPort=sslSrvrSrvcPort, dataPathStatus=dataPathStatus, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, peerDown=peerDown, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsTrapGroup=bwsTrapGroup, PYSNMP_MODULE_ID=bws, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp)
mibBuilder.exportSymbols("BWS-MIB", webCacheProtocol=webCacheProtocol, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrOutBytes=sslSrvrOutBytes, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, freeMem=freeMem, httpSrvrTotResponse=httpSrvrTotResponse, webCacheAddress=webCacheAddress, logStorageHigh=logStorageHigh, sslSrvrMinResTime=sslSrvrMinResTime, bwsStatsGroup=bwsStatsGroup, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyAddress=sslProxyAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, tempHigh=tempHigh, sslProxyInBytes=sslProxyInBytes, sslSrvrAddressType=sslSrvrAddressType, ipsUrlNormPort=ipsUrlNormPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, activeApplications=activeApplications, sslProxyErrPms=sslProxyErrPms, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, cpuFanSpeed=cpuFanSpeed, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitPort=ipsReqLimitPort, processCountHigh=processCountHigh, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrInBytes=sslSrvrInBytes, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, serviceStatus=serviceStatus, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyTotalReq=httpProxyTotalReq, webCacheReq=webCacheReq, totalApplications=totalApplications, sslSrvrPort=sslSrvrPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, systemFailOver=systemFailOver, securityDefUpdates=securityDefUpdates, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, virusDefUpdates=virusDefUpdates, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumConn=sslSrvrNumConn, webCmprProtocol=webCmprProtocol)
