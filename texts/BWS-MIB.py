...
Counter32, TimeTicks, Unsigned32, iso, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Gauge32, Bits, IpAddress, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Unsigned32", "iso", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Gauge32", "Bits", "IpAddress", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsStatsGroup=bwsStatsGroup, totalMem=totalMem, systemLoad=systemLoad, ipsCookieSecPort=ipsCookieSecPort, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCAddress=ipsRCAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCTotDropped=ipsRCTotDropped, ipsCookieSecAddress=ipsCookieSecAddress, peerUp=peerUp, webCmprAddressType=webCmprAddressType, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, operationalMode=operationalMode, webCacheLongHdrs=webCacheLongHdrs, webCacheAddressType=webCacheAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, totalAttacks=totalAttacks, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwstraps=bwstraps, bwsMIBGroups=bwsMIBGroups, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSMUserSessionEntry=bwsSMUserSessionEntry, switchingToBypassMode=switchingToBypassMode, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyErrPms=sslProxyErrPms, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyAddressType=sslProxyAddressType, webCacheHits=webCacheHits, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, currentFirmwareVersion=currentFirmwareVersion, webCacheAddress=webCacheAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyUnknownRsp=httpProxyUnknownRsp, systemFanSpeed=systemFanSpeed, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCmprProtocol=webCmprProtocol, httpSrvrInBytes=httpSrvrInBytes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyServerReq=httpProxyServerReq, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecTampered=ipsCookieSecTampered, logStorageHigh=logStorageHigh, systemFailure=systemFailure, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, activeApplications=activeApplications, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCachePort=webCachePort, webCacheMiss=webCacheMiss, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, cpuFanSpeed=cpuFanSpeed, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, switchingToInlineMode=switchingToInlineMode, serviceName=serviceName, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, totalServers=totalServers, ipsRCPort=ipsRCPort, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclHits=ipsHdrAclHits, switchingToMaintMode=switchingToMaintMode, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, smNumUserSessions=smNumUserSessions, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, webCmprAddress=webCmprAddress, sslProxyPort=sslProxyPort, fanDead=fanDead, raidDegrading=raidDegrading, httpProxyActiveConn=httpProxyActiveConn, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormPort=ipsUrlNormPort, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotResponse=sslSrvrTotResponse, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, processCountHigh=processCountHigh, ipsAccessCtrlPort=ipsAccessCtrlPort, webCmprPort=webCmprPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bws=bws, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyBadDNCErr=sslProxyBadDNCErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, tempHigh=tempHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, dataPathStatus=dataPathStatus, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyServerAbrt=httpProxyServerAbrt, serviceAddress=serviceAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheReq=webCacheReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrState=httpSrvrState, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlAclAddressType=ipsUrlAclAddressType, linkStatus=linkStatus, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, virusDefUpdates=virusDefUpdates, uptime=uptime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, totalBandwidth=totalBandwidth, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, memoryUsageHigh=memoryUsageHigh, bwsMIBCompliances=bwsMIBCompliances, ipsUrlNormAddress=ipsUrlNormAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, logStorage=logStorage, memUtilization=memUtilization, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsRCTotServed=ipsRCTotServed, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrAddressType=sslSrvrAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, serverUp=serverUp, dataPortLinkDown=dataPortLinkDown, httpSrvrNumConn=httpSrvrNumConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyAddress=httpProxyAddress, PYSNMP_MODULE_ID=bws, bwsMIBConformance=bwsMIBConformance, cpuUtilization=cpuUtilization, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, serviceStatus=serviceStatus, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyTotalConn=httpProxyTotalConn, webCacheProtocol=webCacheProtocol, webCacheStale=webCacheStale, httpProxyPort=httpProxyPort, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyParseErr=httpProxyParseErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrAddress=sslSrvrAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, firmwareStorage=firmwareStorage, vipStatus=vipStatus, dataPortLinkUp=dataPortLinkUp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlAclPort=ipsUrlAclPort, httpSrvrAddress=httpSrvrAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, peerDown=peerDown, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, smRealmName=smRealmName, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrInBytes=sslSrvrInBytes, sslProxyCacheHits=sslProxyCacheHits, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, cpuTemperature=cpuTemperature, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, tempCritical=tempCritical, httpSrvrPort=httpSrvrPort, ipsReqLimitPort=ipsReqLimitPort, httpProxyAddressType=httpProxyAddressType, webCacheCacheableRes=webCacheCacheableRes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsRCTotQueued=ipsRCTotQueued, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyAddress=sslProxyAddress, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, smAgentName=smAgentName, energizeUpdateExpire=energizeUpdateExpire, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serverDown=serverDown, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsMessage=bwsMessage, systemFailOver=systemFailOver, bwsMIBCompliance=bwsMIBCompliance, httpProxyInBytes=httpProxyInBytes)
mibBuilder.exportSymbols("BWS-MIB", highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrTotReqActive=httpSrvrTotReqActive, securityDefUpdates=securityDefUpdates, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, servicePort=servicePort, freeMem=freeMem, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, totalApplications=totalApplications, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheCachedObjects=webCacheCachedObjects, httpProxyServerErr=httpProxyServerErr, systemSerialNumber=systemSerialNumber, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrPort=sslSrvrPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheBytesOut=webCacheBytesOut, sslProxyOutBytes=sslProxyOutBytes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyInBytes=sslProxyInBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyWAFWarnings=httpProxyWAFWarnings, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrOutBytes=httpSrvrOutBytes, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsStats=bwsStats, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrMaxResTime=sslSrvrMaxResTime, srvcName=srvcName, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrState=sslSrvrState, bwsTrapGroup=bwsTrapGroup, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotResponse=httpSrvrTotResponse, firmwareStorageHigh=firmwareStorageHigh, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyTotalConn=sslProxyTotalConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, activeServers=activeServers, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry)
