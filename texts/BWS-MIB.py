...
TimeTicks, Counter32, Unsigned32, iso, Gauge32, IpAddress, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Integer32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Unsigned32", "iso", "Gauge32", "IpAddress", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Integer32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, totalServers=totalServers, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsHdrAclAddressType=ipsHdrAclAddressType, tempCritical=tempCritical, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyInBytes=httpProxyInBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyOutBytes=httpProxyOutBytes, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitPort=ipsReqLimitPort, bwsMIBGroups=bwsMIBGroups, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsTrapGroup=bwsTrapGroup, bwstraps=bwstraps, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsMIBCompliance=bwsMIBCompliance, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheReq=webCacheReq, bwsMessage=bwsMessage, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, dataPortLinkDown=dataPortLinkDown, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, systemLoad=systemLoad, webCacheCacheableRes=webCacheCacheableRes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsRCTotServed=ipsRCTotServed, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyFullHandshakes=sslProxyFullHandshakes, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, serverUp=serverUp, httpProxyServerReq=httpProxyServerReq, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, smRealmName=smRealmName, sslSrvrState=sslSrvrState, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyPort=httpProxyPort, logStorageHigh=logStorageHigh, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsRCTimeStamp=ipsRCTimeStamp, raidDegrading=raidDegrading, switchingToInlineMode=switchingToInlineMode, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, memoryUsageHigh=memoryUsageHigh, securityDefUpdates=securityDefUpdates, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormAddress=ipsUrlNormAddress, ipsHdrAclAddress=ipsHdrAclAddress, webCacheAddress=webCacheAddress, peerDown=peerDown, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecAddress=ipsCookieSecAddress, totalAttacks=totalAttacks, PYSNMP_MODULE_ID=bws, bws=bws, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, operationalMode=operationalMode, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheMiss=webCacheMiss, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrAddress=httpSrvrAddress, ipsUrlAclPort=ipsUrlAclPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrPort=httpSrvrPort, sslSrvrAddress=sslSrvrAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyTotalConn=httpProxyTotalConn, highAvailabilityStatus=highAvailabilityStatus, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyCacheTimeouts=sslProxyCacheTimeouts, systemFailure=systemFailure, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, dataPortLinkUp=dataPortLinkUp, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyAddressType=sslProxyAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlAclAddressType=ipsUrlAclAddressType, dataPathStatus=dataPathStatus, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumConn=sslSrvrNumConn, ipsRCAddressType=ipsRCAddressType, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, freeMem=freeMem, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, switchingToBypassMode=switchingToBypassMode, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, processCountHigh=processCountHigh, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, vipStatus=vipStatus, webCacheStale=webCacheStale, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, smAgentName=smAgentName, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyPort=sslProxyPort, bwsMIBCompliances=bwsMIBCompliances, sslProxyTotalReq=sslProxyTotalReq, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsRCPort=ipsRCPort, webCacheProtocol=webCacheProtocol, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrAvgResTime=httpSrvrAvgResTime, serverDown=serverDown, ipsRCAddress=ipsRCAddress, systemFailOver=systemFailOver, webCmprAddressType=webCmprAddressType, energizeUpdateExpire=energizeUpdateExpire, bwsSMUserSessionTable=bwsSMUserSessionTable, logStorage=logStorage, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, servicePort=servicePort, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrNumConn=httpSrvrNumConn, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCacheAddressType=webCacheAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, cpuTemperature=cpuTemperature, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsCacheStatsTable=bwsCacheStatsTable, systemFanSpeed=systemFanSpeed, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheBytesOut=webCacheBytesOut, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, activeServers=activeServers, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, virusDefUpdates=virusDefUpdates, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyErrPms=sslProxyErrPms, firmwareStorage=firmwareStorage, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrTotResponse=httpSrvrTotResponse, ipsRCTotQueued=ipsRCTotQueued, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyActiveConn=httpProxyActiveConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsHdrAclHits=ipsHdrAclHits, httpProxyServerErr=httpProxyServerErr, currentFirmwareVersion=currentFirmwareVersion, systemSerialNumber=systemSerialNumber, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, serviceStatus=serviceStatus, serviceAddress=serviceAddress, sslProxyTotalConn=sslProxyTotalConn, totalBandwidth=totalBandwidth, cpuFanSpeed=cpuFanSpeed, srvcName=srvcName, firmwareUpdateAvailable=firmwareUpdateAvailable, memUtilization=memUtilization, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyInBytes=sslProxyInBytes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrAvgResTime=sslSrvrAvgResTime, totalApplications=totalApplications, ipsUrlAclAddress=ipsUrlAclAddress, totalMem=totalMem, httpSrvrState=httpSrvrState, webCacheHits=webCacheHits, webCmprProtocol=webCmprProtocol, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn)
mibBuilder.exportSymbols("BWS-MIB", bwsStats=bwsStats, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyOutBytes=sslProxyOutBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprPort=webCmprPort, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrInBytes=sslSrvrInBytes, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlNormPort=ipsUrlNormPort, peerUp=peerUp, sslProxyActiveConn=sslProxyActiveConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCachePort=webCachePort, switchingToMaintMode=switchingToMaintMode, cpuUtilization=cpuUtilization, linkStatus=linkStatus, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, firmwareStorageHigh=firmwareStorageHigh, httpSrvrAddressType=httpSrvrAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCmprAddress=webCmprAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyTotalReq=httpProxyTotalReq, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyAddress=httpProxyAddress, tempHigh=tempHigh, bwsStatsGroup=bwsStatsGroup, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, activeApplications=activeApplications, sslSrvrPort=sslSrvrPort, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyParseErr=httpProxyParseErr, smNumUserSessions=smNumUserSessions, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyAddress=sslProxyAddress, webCacheLongHdrs=webCacheLongHdrs, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, fanDead=fanDead, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyCacheHits=sslProxyCacheHits, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsMIBConformance=bwsMIBConformance, sslSrvrTotResponse=sslSrvrTotResponse, serviceName=serviceName, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, uptime=uptime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue)
