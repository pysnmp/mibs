...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, MibIdentifier, Counter64, Integer32, Gauge32, Counter32, NotificationType, iso, Unsigned32, IpAddress, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Counter64", "Integer32", "Gauge32", "Counter32", "NotificationType", "iso", "Unsigned32", "IpAddress", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", dataPortLinkDown=dataPortLinkDown, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsMIBCompliance=bwsMIBCompliance, bwsIpsRCStatsTable=bwsIpsRCStatsTable, currentFirmwareVersion=currentFirmwareVersion, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, peerUp=peerUp, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, systemLoad=systemLoad, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCacheMiss=webCacheMiss, bwsTrapGroup=bwsTrapGroup, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, cpuUtilization=cpuUtilization, sslProxyTotalConn=sslProxyTotalConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTotOutOfResource=ipsRCTotOutOfResource, dataPathStatus=dataPathStatus, bwsMIBCompliances=bwsMIBCompliances, sslProxyInBytes=sslProxyInBytes, raidDegrading=raidDegrading, webCmprPort=webCmprPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsSMUserSessionTable=bwsSMUserSessionTable, serviceStatus=serviceStatus, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCAddressType=ipsRCAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsStatsGroup=bwsStatsGroup, bwsStats=bwsStats, httpProxyActiveConn=httpProxyActiveConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, activeApplications=activeApplications, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCacheAddress=webCacheAddress, webCacheProtocol=webCacheProtocol, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, vipStatus=vipStatus, freeMem=freeMem, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsSslProxyStatsTable=bwsSslProxyStatsTable, firmwareStorageHigh=firmwareStorageHigh, sslSrvrNumFreeConn=sslSrvrNumFreeConn, memUtilization=memUtilization, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrNumFreeConn=httpSrvrNumFreeConn, srvcName=srvcName, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheHits=webCacheHits, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyPort=httpProxyPort, webCacheReq=webCacheReq, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyCacheMiss=sslProxyCacheMiss, processCountHigh=processCountHigh, bwsMessage=bwsMessage, httpSrvrState=httpSrvrState, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyInBytes=httpProxyInBytes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, PYSNMP_MODULE_ID=bws, ipsReqSrvcPort=ipsReqSrvcPort, peerDown=peerDown, httpSrvrAvgResTime=httpSrvrAvgResTime, totalAttacks=totalAttacks, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheStale=webCacheStale, energizeUpdateExpire=energizeUpdateExpire, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrAddressType=httpSrvrAddressType, webCmprAddress=webCmprAddress, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, serviceAddress=serviceAddress, httpProxyAddress=httpProxyAddress, virusDefUpdates=virusDefUpdates, httpSrvrOutBytes=httpSrvrOutBytes, webCmprProtocol=webCmprProtocol, webCachePort=webCachePort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, firmwareStorage=firmwareStorage, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyAddress=sslProxyAddress, ipsRCAddress=ipsRCAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyTotalReq=sslProxyTotalReq, sslSrvrState=sslSrvrState, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, smNumUserSessions=smNumUserSessions, httpProxyTotalReq=httpProxyTotalReq, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyOutBytes=sslProxyOutBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, switchingToBypassMode=switchingToBypassMode, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bws=bws, webCacheLongHdrs=webCacheLongHdrs, tempHigh=tempHigh, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, systemFanSpeed=systemFanSpeed, webCacheCachedObjects=webCacheCachedObjects, smAgentName=smAgentName, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, fanDead=fanDead, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyOutBytes=httpProxyOutBytes, totalServers=totalServers, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyServerErr=httpProxyServerErr, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsRCTotServed=ipsRCTotServed, ipsCookieSecPort=ipsCookieSecPort, httpSrvrTotRefused=httpSrvrTotRefused, systemFailOver=systemFailOver, webCacheCacheableRes=webCacheCacheableRes, sslSrvrMinResTime=sslSrvrMinResTime, ipsHdrAclHits=ipsHdrAclHits, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlAclPort=ipsUrlAclPort, cpuTemperature=cpuTemperature, totalApplications=totalApplications, httpSrvrAddress=httpSrvrAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, switchingToMaintMode=switchingToMaintMode, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, uptime=uptime, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlNormPort=ipsUrlNormPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyServerReq=httpProxyServerReq, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsRCTotQueued=ipsRCTotQueued, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, highAvailabilityStatus=highAvailabilityStatus, systemFailure=systemFailure, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyAddressType=sslProxyAddressType, webCacheAddressType=webCacheAddressType, logStorageHigh=logStorageHigh, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, totalMem=totalMem, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheBytesOut=webCacheBytesOut, serverUp=serverUp, linkStatus=linkStatus, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsHdrAclPort=ipsHdrAclPort, bwsMIBGroups=bwsMIBGroups, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyPort=sslProxyPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCmprAddressType=webCmprAddressType, sslSrvrTotRefused=sslSrvrTotRefused, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyErrPms=sslProxyErrPms, bwsServiceStatusTable=bwsServiceStatusTable, logStorage=logStorage, sslSrvrInBytes=sslSrvrInBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrTotReqActive=sslSrvrTotReqActive)
mibBuilder.exportSymbols("BWS-MIB", sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyParseErr=httpProxyParseErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotSuccess=httpSrvrTotSuccess, cpuFanSpeed=cpuFanSpeed, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, memoryUsageHigh=memoryUsageHigh, serverDown=serverDown, httpProxyTotalConn=httpProxyTotalConn, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, switchingToInlineMode=switchingToInlineMode, activeServers=activeServers, operationalMode=operationalMode, smRealmName=smRealmName, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyAddressType=httpProxyAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, systemSerialNumber=systemSerialNumber, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, totalBandwidth=totalBandwidth, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsHdrAclAddress=ipsHdrAclAddress, serviceName=serviceName, ipsRCPort=ipsRCPort, ipsCookieSecTampered=ipsCookieSecTampered, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, tempCritical=tempCritical, sslSrvrAddress=sslSrvrAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrNumConn=sslSrvrNumConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrNumConn=httpSrvrNumConn, sslSrvrAddressType=sslSrvrAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrPort=sslSrvrPort, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwstraps=bwstraps, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, servicePort=servicePort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrPort=httpSrvrPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxySessionTimeOut=httpProxySessionTimeOut)
