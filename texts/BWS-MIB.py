...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter64, Bits, Unsigned32, MibIdentifier, NotificationType, Counter32, TimeTicks, iso, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter64", "Bits", "Unsigned32", "MibIdentifier", "NotificationType", "Counter32", "TimeTicks", "iso", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxySessionTimeOut=httpProxySessionTimeOut, raidDegrading=raidDegrading, totalAttacks=totalAttacks, webCacheAddressType=webCacheAddressType, processCountHigh=processCountHigh, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, tempHigh=tempHigh, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyAddress=sslProxyAddress, memoryUsageHigh=memoryUsageHigh, totalMem=totalMem, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, smAgentName=smAgentName, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsStatsGroup=bwsStatsGroup, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, systemLoad=systemLoad, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, cpuTemperature=cpuTemperature, ipsReqSrvcPort=ipsReqSrvcPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, vipStatus=vipStatus, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyPort=httpProxyPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, systemFailure=systemFailure, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheMiss=webCacheMiss, sslProxyCacheHits=sslProxyCacheHits, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCacheStale=webCacheStale, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, PYSNMP_MODULE_ID=bws, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrNumConn=sslSrvrNumConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyTotalConn=httpProxyTotalConn, totalApplications=totalApplications, operationalMode=operationalMode, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheAddress=webCacheAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsMIBCompliance=bwsMIBCompliance, ipsHdrAclPort=ipsHdrAclPort, sslSrvrAddressType=sslSrvrAddressType, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCmprAddressType=webCmprAddressType, firmwareStorage=firmwareStorage, switchingToBypassMode=switchingToBypassMode, httpProxyTotalReq=httpProxyTotalReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyActiveConn=sslProxyActiveConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlAclAddress=ipsUrlAclAddress, peerUp=peerUp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, switchingToMaintMode=switchingToMaintMode, systemFanSpeed=systemFanSpeed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCachePort=webCachePort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, systemSerialNumber=systemSerialNumber, logStorageHigh=logStorageHigh, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyOutBytes=sslProxyOutBytes, smRealmName=smRealmName, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyAddress=httpProxyAddress, ipsReqLimitPort=ipsReqLimitPort, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrInBytes=sslSrvrInBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, securityDefUpdates=securityDefUpdates, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsRCAddress=ipsRCAddress, srvcName=srvcName, linkStatus=linkStatus, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlAclPort=ipsUrlAclPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsMIBGroups=bwsMIBGroups, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, energizeUpdateExpire=energizeUpdateExpire, httpSrvrInBytes=httpSrvrInBytes, ipsRCTotQueued=ipsRCTotQueued, ipsUrlNormPort=ipsUrlNormPort, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumConn=httpSrvrNumConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotResponse=sslSrvrTotResponse, webCacheProtocol=webCacheProtocol, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyInBytes=httpProxyInBytes, webCacheCachedObjects=webCacheCachedObjects, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecAddressType=ipsCookieSecAddressType, systemFailOver=systemFailOver, httpProxyServerReq=httpProxyServerReq, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrPort=httpSrvrPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCacheReq=webCacheReq, bwsMessage=bwsMessage, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprAddress=webCmprAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, webCmprProtocol=webCmprProtocol, sslSrvrTotTimedout=sslSrvrTotTimedout, highAvailabilityStatus=highAvailabilityStatus, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyPort=sslProxyPort, httpProxyActiveConn=httpProxyActiveConn, smNumUserSessions=smNumUserSessions, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, serviceAddress=serviceAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyTotalConn=sslProxyTotalConn, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsHdrAclHits=ipsHdrAclHits, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsHdrAclAddress=ipsHdrAclAddress, serverUp=serverUp, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrTotTimedout=httpSrvrTotTimedout, servicePort=servicePort, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwstraps=bwstraps, switchingToInlineMode=switchingToInlineMode, httpSrvrTotResponse=httpSrvrTotResponse, activeServers=activeServers, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, logStorage=logStorage, webCmprPort=webCmprPort, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, cpuFanSpeed=cpuFanSpeed, ipsUrlAclReserved=ipsUrlAclReserved, bws=bws, ipsUrlNormAddressType=ipsUrlNormAddressType, serviceName=serviceName, bwsMIBConformance=bwsMIBConformance, virusDefUpdates=virusDefUpdates, ipsRCPort=ipsRCPort, serverDown=serverDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsRCTotServed=ipsRCTotServed, sslSrvrPort=sslSrvrPort, httpSrvrState=httpSrvrState, cpuUtilization=cpuUtilization, ipsRCTotDropped=ipsRCTotDropped, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, webCacheCacheableRes=webCacheCacheableRes, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrState=sslSrvrState, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrAddress=httpSrvrAddress, firmwareStorageHigh=firmwareStorageHigh, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, dataPathStatus=dataPathStatus, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyInBytes=sslProxyInBytes, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyOutBytes=httpProxyOutBytes, sslProxyErrPms=sslProxyErrPms)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, totalBandwidth=totalBandwidth, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrMaxResTime=httpSrvrMaxResTime, tempCritical=tempCritical, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, peerDown=peerDown, webCacheHits=webCacheHits, httpSrvrOutBytes=httpSrvrOutBytes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsCookieSecTampered=ipsCookieSecTampered, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, uptime=uptime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrAddress=sslSrvrAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, currentFirmwareVersion=currentFirmwareVersion, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCAddressType=ipsRCAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, freeMem=freeMem, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, serviceStatus=serviceStatus, sslProxyAddressType=sslProxyAddressType, memUtilization=memUtilization, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, totalServers=totalServers, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, activeApplications=activeApplications, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyAddressType=httpProxyAddressType, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheBytesOut=webCacheBytesOut, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, dataPortLinkUp=dataPortLinkUp, bwsStats=bwsStats, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, fanDead=fanDead, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyParseErr=httpProxyParseErr)
