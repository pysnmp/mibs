...
ModuleIdentity, Gauge32, IpAddress, MibIdentifier, Counter64, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Integer32, NotificationType, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Integer32", "NotificationType", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrState=sslSrvrState, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyActiveConn=httpProxyActiveConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsRCTotQueued=ipsRCTotQueued, sslProxyCurrentConn=sslProxyCurrentConn, webCacheReq=webCacheReq, sslSrvrAddress=sslSrvrAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyAddressType=httpProxyAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsStatsGroup=bwsStatsGroup, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, raidDegrading=raidDegrading, ipsReqLimitPort=ipsReqLimitPort, sslSrvrMaxResTime=sslSrvrMaxResTime, systemSerialNumber=systemSerialNumber, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsRCTotServed=ipsRCTotServed, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCachePort=webCachePort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsCacheStatsTable=bwsCacheStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrAddressType=sslSrvrAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, PYSNMP_MODULE_ID=bws, sslProxyCacheTimeouts=sslProxyCacheTimeouts, linkStatus=linkStatus, webCacheAddress=webCacheAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, memoryUsageHigh=memoryUsageHigh, bwsMessage=bwsMessage, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsMIBGroups=bwsMIBGroups, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, switchingToInlineMode=switchingToInlineMode, cpuUtilization=cpuUtilization, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyServerErr=httpProxyServerErr, httpSrvrAddressType=httpSrvrAddressType, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, dataPortLinkDown=dataPortLinkDown, sslSrvrTotRefused=sslSrvrTotRefused, securityDefUpdates=securityDefUpdates, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyAddress=sslProxyAddress, httpSrvrInBytes=httpSrvrInBytes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, serviceName=serviceName, sslSrvrPort=sslSrvrPort, ipsUrlAclPort=ipsUrlAclPort, webCmprPort=webCmprPort, fanDead=fanDead, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsStats=bwsStats, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyAddress=httpProxyAddress, ipsRCTimeStamp=ipsRCTimeStamp, bwsMIBCompliance=bwsMIBCompliance, webCmprProtocol=webCmprProtocol, webCacheProtocol=webCacheProtocol, srvcName=srvcName, sslProxyCacheHits=sslProxyCacheHits, httpSrvrTotResponse=httpSrvrTotResponse, logStorageHigh=logStorageHigh, bwsTrapGroup=bwsTrapGroup, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, cpuTemperature=cpuTemperature, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqSrvcPort=ipsReqSrvcPort, systemFailure=systemFailure, memUtilization=memUtilization, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, totalAttacks=totalAttacks, newAttackDefinitionInstalled=newAttackDefinitionInstalled, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyInBytes=sslProxyInBytes, httpProxyTotalConn=httpProxyTotalConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, serverUp=serverUp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprAddressType=webCmprAddressType, httpProxyParseErr=httpProxyParseErr, cpuFanSpeed=cpuFanSpeed, httpProxyPort=httpProxyPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecAddress=ipsCookieSecAddress, webCacheCachedObjects=webCacheCachedObjects, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bws=bws, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, logStorage=logStorage, tempCritical=tempCritical, sslProxyOutBytes=sslProxyOutBytes, dataPathStatus=dataPathStatus, ipsRCTotDropped=ipsRCTotDropped, sslSrvrNumConn=sslSrvrNumConn, sslProxyErrPms=sslProxyErrPms, httpSrvrAddress=httpSrvrAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, activeServers=activeServers, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyPort=sslProxyPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyOutBytes=httpProxyOutBytes, currentFirmwareVersion=currentFirmwareVersion, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheStale=webCacheStale, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, systemFanSpeed=systemFanSpeed, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, smNumUserSessions=smNumUserSessions, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrMinResTime=httpSrvrMinResTime, httpProxySessionTimeOut=httpProxySessionTimeOut, dataPortLinkUp=dataPortLinkUp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyTotalConn=sslProxyTotalConn, webCacheBytesOut=webCacheBytesOut, ipsRCPort=ipsRCPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheAddressType=webCacheAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, freeMem=freeMem, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, serviceAddress=serviceAddress, sslProxyTotalReq=sslProxyTotalReq, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, firmwareStorageHigh=firmwareStorageHigh, bwsMIBCompliances=bwsMIBCompliances, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, processCountHigh=processCountHigh, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, totalServers=totalServers, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrInBytes=sslSrvrInBytes, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, virusDefUpdates=virusDefUpdates, sslProxyFullHandshakes=sslProxyFullHandshakes, switchingToMaintMode=switchingToMaintMode, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCAddress=ipsRCAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, servicePort=servicePort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwstraps=bwstraps, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrTotResponse=sslSrvrTotResponse, totalBandwidth=totalBandwidth, sslSrvrAvgResTime=sslSrvrAvgResTime, serverDown=serverDown, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrState=httpSrvrState, ipsUrlAclAddressType=ipsUrlAclAddressType, smRealmName=smRealmName, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyInBytes=httpProxyInBytes, firmwareStorage=firmwareStorage, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, totalApplications=totalApplications, activeApplications=activeApplications, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCacheHits=webCacheHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyClientAbrt=httpProxyClientAbrt)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, systemFailOver=systemFailOver, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyServerReq=httpProxyServerReq, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyAddressType=sslProxyAddressType, peerDown=peerDown, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsRCAddressType=ipsRCAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsMIBConformance=bwsMIBConformance, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, serviceStatus=serviceStatus, systemLoad=systemLoad, totalMem=totalMem, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyActiveConn=sslProxyActiveConn, operationalMode=operationalMode, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, smAgentName=smAgentName, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, vipStatus=vipStatus, ipsLrnSrvcAddress=ipsLrnSrvcAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsHdrAclHits=ipsHdrAclHits, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumConn=httpSrvrNumConn, httpSrvrOutBytes=httpSrvrOutBytes, energizeUpdateExpire=energizeUpdateExpire, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheMiss=webCacheMiss, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheLongHdrs=webCacheLongHdrs, webCmprAddress=webCmprAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrPort=httpSrvrPort, peerUp=peerUp, switchingToBypassMode=switchingToBypassMode, uptime=uptime, highAvailabilityStatus=highAvailabilityStatus, tempHigh=tempHigh)
