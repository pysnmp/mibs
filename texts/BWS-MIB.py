...
Bits, Gauge32, NotificationType, MibIdentifier, IpAddress, Integer32, ModuleIdentity, TimeTicks, Counter64, Unsigned32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "NotificationType", "MibIdentifier", "IpAddress", "Integer32", "ModuleIdentity", "TimeTicks", "Counter64", "Unsigned32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, systemFailure=systemFailure, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrAddress=sslSrvrAddress, httpProxyAddress=httpProxyAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrState=httpSrvrState, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, totalServers=totalServers, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrInBytes=httpSrvrInBytes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, raidDegrading=raidDegrading, ipsRCAddress=ipsRCAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, dataPathStatus=dataPathStatus, bwsMessage=bwsMessage, bwsMIBCompliance=bwsMIBCompliance, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, cpuUtilization=cpuUtilization, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrTotRefused=httpSrvrTotRefused, systemFailOver=systemFailOver, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrState=sslSrvrState, currentFirmwareVersion=currentFirmwareVersion, sslProxyBadCRLErr=sslProxyBadCRLErr, webCachePort=webCachePort, PYSNMP_MODULE_ID=bws, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyErrPms=sslProxyErrPms, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, operationalMode=operationalMode, serviceStatus=serviceStatus, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, tempCritical=tempCritical, sslProxyCacheHits=sslProxyCacheHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitAddressType=ipsReqLimitAddressType, systemLoad=systemLoad, sslProxyInBytes=sslProxyInBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrTotReqRejected=sslSrvrTotReqRejected, smNumUserSessions=smNumUserSessions, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, totalAttacks=totalAttacks, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyServerErr=httpProxyServerErr, freeMem=freeMem, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyTotalConn=httpProxyTotalConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, systemFanSpeed=systemFanSpeed, webCacheAddressType=webCacheAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsStatsGroup=bwsStatsGroup, sslSrvrNumConn=sslSrvrNumConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyUnknownRsp=httpProxyUnknownRsp, switchingToMaintMode=switchingToMaintMode, sslSrvrInBytes=sslSrvrInBytes, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsMIBConformance=bwsMIBConformance, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcAddress=ipsLrnSrvcAddress, serverUp=serverUp, webCacheCachedObjects=webCacheCachedObjects, peerDown=peerDown, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyActiveConn=sslProxyActiveConn, ipsRCPort=ipsRCPort, memUtilization=memUtilization, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, srvcName=srvcName, httpSrvrNumConn=httpSrvrNumConn, httpProxyTotalReq=httpProxyTotalReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrTotResponse=httpSrvrTotResponse, fanDead=fanDead, httpProxyAddressType=httpProxyAddressType, ipsRCTotQueued=ipsRCTotQueued, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, servicePort=servicePort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheMiss=webCacheMiss, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotRefused=sslSrvrTotRefused, webCmprPort=webCmprPort, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrPort=sslSrvrPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, firmwareStorageHigh=firmwareStorageHigh, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, smAgentName=smAgentName, httpSrvrAddressType=httpSrvrAddressType, firmwareStorage=firmwareStorage, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, serverDown=serverDown, ipsHdrAclAddress=ipsHdrAclAddress, webCacheCacheableRes=webCacheCacheableRes, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheAddress=webCacheAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwstraps=bwstraps, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, ipsRCTotServed=ipsRCTotServed, ipsRCTimeStamp=ipsRCTimeStamp, uptime=uptime, ipsCookieSecAddress=ipsCookieSecAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, tempHigh=tempHigh, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, vipStatus=vipStatus, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrTotSuccess=httpSrvrTotSuccess, virusDefUpdates=virusDefUpdates, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyTotalConn=sslProxyTotalConn, securityDefUpdates=securityDefUpdates, sslProxyCacheMiss=sslProxyCacheMiss, webCacheProtocol=webCacheProtocol, cpuFanSpeed=cpuFanSpeed, httpSrvrTotTimedout=httpSrvrTotTimedout, switchingToInlineMode=switchingToInlineMode, ipsHdrAclPort=ipsHdrAclPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyPort=sslProxyPort, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, processCountHigh=processCountHigh, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, peerUp=peerUp, sslProxyOutBytes=sslProxyOutBytes, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyAddress=sslProxyAddress, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, memoryUsageHigh=memoryUsageHigh, bwsTrapGroup=bwsTrapGroup, ipsReqLimitPort=ipsReqLimitPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsHdrAclHits=ipsHdrAclHits, logStorage=logStorage, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, totalMem=totalMem, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheReq=webCacheReq, httpProxyPort=httpProxyPort, totalBandwidth=totalBandwidth, sslProxyAddressType=sslProxyAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCacheHits=webCacheHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, linkStatus=linkStatus, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, activeServers=activeServers, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, logStorageHigh=logStorageHigh, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqSrvcAddress=ipsReqSrvcAddress, energizeUpdateExpire=energizeUpdateExpire, ipsRCTotDropped=ipsRCTotDropped, totalApplications=totalApplications, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, activeApplications=activeApplications)
mibBuilder.exportSymbols("BWS-MIB", bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrAddressType=sslSrvrAddressType, bwsMIBCompliances=bwsMIBCompliances, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsRCAddressType=ipsRCAddressType, switchingToBypassMode=switchingToBypassMode, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrTotResponse=sslSrvrTotResponse, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsStats=bwsStats, webCmprAddress=webCmprAddress, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, cpuTemperature=cpuTemperature, systemSerialNumber=systemSerialNumber, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, serviceAddress=serviceAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCmprProtocol=webCmprProtocol, httpProxyActiveConn=httpProxyActiveConn, serviceName=serviceName, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecEncrypted=ipsCookieSecEncrypted, dataPortLinkDown=dataPortLinkDown, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, highAvailabilityStatus=highAvailabilityStatus, sslSrvrMaxResTime=sslSrvrMaxResTime, smRealmName=smRealmName, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheBytesOut=webCacheBytesOut, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheStale=webCacheStale, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyTotalReq=sslProxyTotalReq, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyClientAbrt=httpProxyClientAbrt, bws=bws, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecPort=ipsCookieSecPort, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrPort=httpSrvrPort, ipsUrlNormAddress=ipsUrlNormAddress, dataPortLinkUp=dataPortLinkUp, webCmprAddressType=webCmprAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits)
