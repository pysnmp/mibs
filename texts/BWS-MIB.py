...
IpAddress, Integer32, Counter32, Gauge32, Counter64, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, ModuleIdentity, Unsigned32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "Counter32", "Gauge32", "Counter64", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "ModuleIdentity", "Unsigned32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlNormAddress=ipsUrlNormAddress, bwsMessage=bwsMessage, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, energizeUpdateExpire=energizeUpdateExpire, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, tempCritical=tempCritical, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, switchingToInlineMode=switchingToInlineMode, currentFirmwareVersion=currentFirmwareVersion, httpProxyAddress=httpProxyAddress, memoryUsageHigh=memoryUsageHigh, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrAddressType=httpSrvrAddressType, peerUp=peerUp, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, serviceStatus=serviceStatus, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlPolicyPort=ipsUrlPolicyPort, memUtilization=memUtilization, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, dataPathStatus=dataPathStatus, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrTotRefused=httpSrvrTotRefused, logStorage=logStorage, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrInBytes=sslSrvrInBytes, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsMIBCompliance=bwsMIBCompliance, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyActiveConn=sslProxyActiveConn, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsMIBGroups=bwsMIBGroups, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrAvgResTime=sslSrvrAvgResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwstraps=bwstraps, ipsHdrAclPort=ipsHdrAclPort, webCacheBytesOut=webCacheBytesOut, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, firmwareStorageHigh=firmwareStorageHigh, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, uptime=uptime, activeApplications=activeApplications, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrInBytes=httpSrvrInBytes, logStorageHigh=logStorageHigh, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, peerDown=peerDown, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCachePort=webCachePort, systemSerialNumber=systemSerialNumber, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyTotalReq=httpProxyTotalReq, sslProxyAddress=sslProxyAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrNumConn=httpSrvrNumConn, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsTrapGroup=bwsTrapGroup, webCacheStale=webCacheStale, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, serviceName=serviceName, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, operationalMode=operationalMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCmprProtocol=webCmprProtocol, bwsStats=bwsStats, httpSrvrState=httpSrvrState, sslSrvrPort=sslSrvrPort, sslProxyTotalReq=sslProxyTotalReq, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitPort=ipsReqLimitPort, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlAclPort=ipsUrlAclPort, httpProxyAddressType=httpProxyAddressType, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, dataPortLinkUp=dataPortLinkUp, totalBandwidth=totalBandwidth, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, totalServers=totalServers, webCacheAddressType=webCacheAddressType, firmwareStorage=firmwareStorage, freeMem=freeMem, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, linkStatus=linkStatus, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, raidDegrading=raidDegrading, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsMIBConformance=bwsMIBConformance, sslSrvrSrvcAddress=sslSrvrSrvcAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, securityDefUpdates=securityDefUpdates, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, switchingToMaintMode=switchingToMaintMode, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCmprAddress=webCmprAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyServerErr=httpProxyServerErr, systemLoad=systemLoad, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyUnknownRsp=httpProxyUnknownRsp, activeServers=activeServers, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, servicePort=servicePort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, systemFailOver=systemFailOver, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, dataPortLinkDown=dataPortLinkDown, smRealmName=smRealmName, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, cpuTemperature=cpuTemperature, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, tempHigh=tempHigh, smAgentName=smAgentName, processCountHigh=processCountHigh, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsRCTotServed=ipsRCTotServed, webCmprAddressType=webCmprAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCmprPort=webCmprPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCacheReq=webCacheReq, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsHdrAclAddress=ipsHdrAclAddress, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyCacheHits=sslProxyCacheHits, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrAddress=httpSrvrAddress, totalMem=totalMem, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheAddress=webCacheAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, serverUp=serverUp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, totalAttacks=totalAttacks, serviceAddress=serviceAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyServerReq=httpProxyServerReq, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsCompressionStatsTable=bwsCompressionStatsTable, systemFanSpeed=systemFanSpeed, httpSrvrPort=httpSrvrPort, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyTotalConn=httpProxyTotalConn, vipStatus=vipStatus, httpProxyInBytes=httpProxyInBytes, ipsRCAddressType=ipsRCAddressType, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCTotQueued=ipsRCTotQueued, virusDefUpdates=virusDefUpdates, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyActiveConn=httpProxyActiveConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyInBytes=sslProxyInBytes, smNumUserSessions=smNumUserSessions, webCacheProtocol=webCacheProtocol, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsServiceStatusEntry=bwsServiceStatusEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, PYSNMP_MODULE_ID=bws, sslProxyPort=sslProxyPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsStatsGroup=bwsStatsGroup, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyParseErr=httpProxyParseErr, sslSrvrAddress=sslSrvrAddress, switchingToBypassMode=switchingToBypassMode, cpuUtilization=cpuUtilization, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serverDown=serverDown, systemFailure=systemFailure, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyOutBytes=httpProxyOutBytes, sslProxyTotalConn=sslProxyTotalConn, ipsRCTimeStamp=ipsRCTimeStamp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCacheMiss=webCacheMiss, sslSrvrTotReqActive=sslSrvrTotReqActive, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, srvcName=srvcName, bwsMIBCompliances=bwsMIBCompliances, ipsRCAddress=ipsRCAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheCachedObjects=webCacheCachedObjects, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrState=sslSrvrState, httpProxyPort=httpProxyPort, ipsUrlAclReserved=ipsUrlAclReserved, ipsHdrAclHits=ipsHdrAclHits, bws=bws, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsCookieSecPort=ipsCookieSecPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyErrPms=sslProxyErrPms, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsRCPort=ipsRCPort, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, webCacheHits=webCacheHits, ipsUrlAclAddress=ipsUrlAclAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheCacheableRes=webCacheCacheableRes, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, fanDead=fanDead, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, totalApplications=totalApplications)
