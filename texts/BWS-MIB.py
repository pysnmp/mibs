...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, IpAddress, NotificationType, ObjectIdentity, Gauge32, TimeTicks, MibIdentifier, ModuleIdentity, iso, Bits, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "IpAddress", "NotificationType", "ObjectIdentity", "Gauge32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "iso", "Bits", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsMessage=bwsMessage, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrPort=sslSrvrPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsRCAddressType=ipsRCAddressType, webCmprAddressType=webCmprAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, servicePort=servicePort, switchingToMaintMode=switchingToMaintMode, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyOutBytes=httpProxyOutBytes, tempHigh=tempHigh, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, cpuTemperature=cpuTemperature, httpSrvrTotReqActive=httpSrvrTotReqActive, smAgentName=smAgentName, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyAddress=httpProxyAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyTotalConn=sslProxyTotalConn, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, currentFirmwareVersion=currentFirmwareVersion, switchingToInlineMode=switchingToInlineMode, dataPortLinkUp=dataPortLinkUp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrSrvcAddress=sslSrvrSrvcAddress, smRealmName=smRealmName, httpSrvrState=httpSrvrState, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, processCountHigh=processCountHigh, systemFailOver=systemFailOver, virusDefUpdates=virusDefUpdates, logStorage=logStorage, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, cpuUtilization=cpuUtilization, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsRCAddress=ipsRCAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, srvcName=srvcName, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyActiveConn=sslProxyActiveConn, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsCompressionStatsTable=bwsCompressionStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, highAvailabilityStatus=highAvailabilityStatus, energizeUpdateExpire=energizeUpdateExpire, serverDown=serverDown, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, totalServers=totalServers, peerDown=peerDown, cpuFanSpeed=cpuFanSpeed, bwsMIBCompliance=bwsMIBCompliance, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bws=bws, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, serviceAddress=serviceAddress, systemLoad=systemLoad, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyPort=httpProxyPort, webCacheBytesOut=webCacheBytesOut, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyCacheHits=sslProxyCacheHits, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrAddressType=sslSrvrAddressType, webCmprAddress=webCmprAddress, sslProxyOutBytes=sslProxyOutBytes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyTotalConn=httpProxyTotalConn, switchingToBypassMode=switchingToBypassMode, ipsRCPort=ipsRCPort, httpProxyParseErr=httpProxyParseErr, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyAddressType=sslProxyAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrAddress=sslSrvrAddress, ipsReqLimitPort=ipsReqLimitPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCachePort=webCachePort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, securityDefUpdates=securityDefUpdates, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, uptime=uptime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, systemSerialNumber=systemSerialNumber, totalMem=totalMem, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyAddress=sslProxyAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyClientAbrt=httpProxyClientAbrt, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsTrapGroup=bwsTrapGroup, activeServers=activeServers, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyServerErr=httpProxyServerErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheStale=webCacheStale, systemFanSpeed=systemFanSpeed, dataPathStatus=dataPathStatus, bwsStatsGroup=bwsStatsGroup, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlNormPort=ipsUrlNormPort, httpProxyInBytes=httpProxyInBytes, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyServerReq=httpProxyServerReq, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrInBytes=sslSrvrInBytes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, linkStatus=linkStatus, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsMIBCompliances=bwsMIBCompliances, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyAddressType=httpProxyAddressType, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrInBytes=httpSrvrInBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, vipStatus=vipStatus, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, freeMem=freeMem, sslSrvrNumFreeConn=sslSrvrNumFreeConn, logStorageHigh=logStorageHigh, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrTotRefused=httpSrvrTotRefused, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheCacheableRes=webCacheCacheableRes, webCacheHits=webCacheHits, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrTotResponse=httpSrvrTotResponse, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheReq=webCacheReq, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, operationalMode=operationalMode, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serviceName=serviceName, peerUp=peerUp, ipsCookieSecPort=ipsCookieSecPort, firmwareStorage=firmwareStorage, sslProxyTotalReq=sslProxyTotalReq, memUtilization=memUtilization, PYSNMP_MODULE_ID=bws, sslProxyPort=sslProxyPort, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitAddress=ipsReqLimitAddress, webCacheAddress=webCacheAddress, webCacheMiss=webCacheMiss, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrAddress=httpSrvrAddress, ipsRCTotQueued=ipsRCTotQueued, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, raidDegrading=raidDegrading, sslProxyInBytes=sslProxyInBytes, sslSrvrNumConn=sslSrvrNumConn, totalBandwidth=totalBandwidth, webCacheLongHdrs=webCacheLongHdrs, totalAttacks=totalAttacks, fanDead=fanDead, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsCookieSecTampered=ipsCookieSecTampered, webCacheAddressType=webCacheAddressType, httpProxyServerAbrt=httpProxyServerAbrt)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheCachedObjects=webCacheCachedObjects, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheProtocol=webCacheProtocol, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, serverUp=serverUp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwstraps=bwstraps, httpSrvrNumFreeConn=httpSrvrNumFreeConn, smNumUserSessions=smNumUserSessions, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsMIBGroups=bwsMIBGroups, sslSrvrAvgResTime=sslSrvrAvgResTime, webCmprProtocol=webCmprProtocol, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrNumConn=httpSrvrNumConn, activeApplications=activeApplications, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, totalApplications=totalApplications, ipsRCTotServed=ipsRCTotServed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrAddressType=httpSrvrAddressType, tempCritical=tempCritical, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrPort=httpSrvrPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrState=sslSrvrState, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCTotDropped=ipsRCTotDropped, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsStats=bwsStats, dataPortLinkDown=dataPortLinkDown, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, systemFailure=systemFailure, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlAclPort=ipsUrlAclPort, serviceStatus=serviceStatus, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCmprPort=webCmprPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyActiveConn=httpProxyActiveConn)
