...
IpAddress, Unsigned32, MibIdentifier, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Gauge32, Bits, Counter64, ObjectIdentity, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "MibIdentifier", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Gauge32", "Bits", "Counter64", "ObjectIdentity", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyServerAbrt=httpProxyServerAbrt, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotSuccess=httpSrvrTotSuccess, systemLoad=systemLoad, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, uptime=uptime, sslProxyOutBytes=sslProxyOutBytes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsRCStatsTable=bwsIpsRCStatsTable, dataPortLinkDown=dataPortLinkDown, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheProtocol=webCacheProtocol, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsServiceStatusEntry=bwsServiceStatusEntry, operationalMode=operationalMode, servicePort=servicePort, webCmprAddressType=webCmprAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheCacheableRes=webCacheCacheableRes, ipsRCAddressType=ipsRCAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyActiveConn=sslProxyActiveConn, httpProxyActiveConn=httpProxyActiveConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyAddressType=sslProxyAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyServerErr=httpProxyServerErr, httpSrvrAvgResTime=httpSrvrAvgResTime, smAgentName=smAgentName, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsMessage=bwsMessage, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsHdrAclAddressType=ipsHdrAclAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrState=httpSrvrState, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyAddressType=httpProxyAddressType, systemFailure=systemFailure, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, currentFirmwareVersion=currentFirmwareVersion, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsMIBConformance=bwsMIBConformance, httpProxyAddress=httpProxyAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrPort=sslSrvrPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsRCTotDropped=ipsRCTotDropped, linkStatus=linkStatus, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrTotTimedout=sslSrvrTotTimedout, webCacheReq=webCacheReq, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsRCTotServed=ipsRCTotServed, webCacheBytesOut=webCacheBytesOut, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrMaxResTime=httpSrvrMaxResTime, processCountHigh=processCountHigh, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, logStorage=logStorage, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCmprPort=webCmprPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsCookieSecAddress=ipsCookieSecAddress, smNumUserSessions=smNumUserSessions, sslProxyCacheMiss=sslProxyCacheMiss, activeApplications=activeApplications, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyInBytes=httpProxyInBytes, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyInBytes=sslProxyInBytes, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsRCTotQueued=ipsRCTotQueued, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheMiss=webCacheMiss, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsServiceStatusTable=bwsServiceStatusTable, webCmprAddress=webCmprAddress, webCacheHits=webCacheHits, httpSrvrNumConn=httpSrvrNumConn, memUtilization=memUtilization, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, activeServers=activeServers, httpProxyTotalConn=httpProxyTotalConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, totalMem=totalMem, totalApplications=totalApplications, sslProxyTotalReq=sslProxyTotalReq, cpuUtilization=cpuUtilization, bwsMIBCompliances=bwsMIBCompliances, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrAddressType=httpSrvrAddressType, switchingToInlineMode=switchingToInlineMode, ipsRCPort=ipsRCPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, securityDefUpdates=securityDefUpdates, serverDown=serverDown, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, virusDefUpdates=virusDefUpdates, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyCacheHits=sslProxyCacheHits, tempHigh=tempHigh, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrAddress=httpSrvrAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsRCAddress=ipsRCAddress, webCachePort=webCachePort, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, systemSerialNumber=systemSerialNumber, httpProxyPort=httpProxyPort, switchingToBypassMode=switchingToBypassMode, sslProxyPort=sslProxyPort, firmwareStorageHigh=firmwareStorageHigh, httpProxyOutBytes=httpProxyOutBytes, switchingToMaintMode=switchingToMaintMode, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyTotalReq=httpProxyTotalReq, dataPathStatus=dataPathStatus, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheStale=webCacheStale, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqSrvcPort=ipsReqSrvcPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, raidDegrading=raidDegrading, sslProxyErrPms=sslProxyErrPms, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsHdrAclPort=ipsHdrAclPort, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, totalServers=totalServers, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, PYSNMP_MODULE_ID=bws, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsStats=bwsStats, systemFanSpeed=systemFanSpeed, webCacheCachedObjects=webCacheCachedObjects, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, highAvailabilityStatus=highAvailabilityStatus, peerDown=peerDown, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrAddress=sslSrvrAddress, totalAttacks=totalAttacks, serverUp=serverUp, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, dataPortLinkUp=dataPortLinkUp, systemFailOver=systemFailOver, httpSrvrPort=httpSrvrPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, vipStatus=vipStatus, serviceStatus=serviceStatus, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsMIBGroups=bwsMIBGroups, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsTrapGroup=bwsTrapGroup, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, firmwareStorage=firmwareStorage, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, peerUp=peerUp, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcPort=ipsLrnSrvcPort)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, fanDead=fanDead, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrOutBytes=sslSrvrOutBytes, logStorageHigh=logStorageHigh, webCmprProtocol=webCmprProtocol, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, serviceName=serviceName, bwsMIBCompliance=bwsMIBCompliance, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, tempCritical=tempCritical, webCacheAddressType=webCacheAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, totalBandwidth=totalBandwidth, freeMem=freeMem, cpuTemperature=cpuTemperature, sslProxyAddress=sslProxyAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bws=bws, smRealmName=smRealmName, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrInBytes=sslSrvrInBytes, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsStatsGroup=bwsStatsGroup, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyTotalConn=sslProxyTotalConn, httpSrvrTotResponse=httpSrvrTotResponse, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyServerReq=httpProxyServerReq, sslSrvrState=sslSrvrState, webCacheAddress=webCacheAddress, sslSrvrAddressType=sslSrvrAddressType, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrOutBytes=httpSrvrOutBytes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, srvcName=srvcName, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrTotRefused=sslSrvrTotRefused, ipsHdrAclAddress=ipsHdrAclAddress, serviceAddress=serviceAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwstraps=bwstraps, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled)
