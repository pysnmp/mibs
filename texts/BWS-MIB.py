...
ModuleIdentity, Counter64, Unsigned32, MibIdentifier, IpAddress, Integer32, TimeTicks, NotificationType, Gauge32, iso, Bits, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "MibIdentifier", "IpAddress", "Integer32", "TimeTicks", "NotificationType", "Gauge32", "iso", "Bits", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitPort=ipsReqLimitPort, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrNumConn=sslSrvrNumConn, peerUp=peerUp, httpProxyAddressType=httpProxyAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, systemSerialNumber=systemSerialNumber, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsServiceStatusTable=bwsServiceStatusTable, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrOutBytes=sslSrvrOutBytes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheReq=webCacheReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, serviceName=serviceName, smAgentName=smAgentName, httpProxyActiveConn=httpProxyActiveConn, sslProxyOutBytes=sslProxyOutBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsMIBCompliances=bwsMIBCompliances, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, switchingToMaintMode=switchingToMaintMode, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsRCTotDropped=ipsRCTotDropped, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlAclAddress=ipsUrlAclAddress, dataPortLinkUp=dataPortLinkUp, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrTotReqActive=httpSrvrTotReqActive, logStorage=logStorage, ipsUrlNormPort=ipsUrlNormPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotReqActive=sslSrvrTotReqActive, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprAddress=webCmprAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, serverDown=serverDown, servicePort=servicePort, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsTrapGroup=bwsTrapGroup, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyPort=sslProxyPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrAvgResTime=sslSrvrAvgResTime, smNumUserSessions=smNumUserSessions, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrPort=sslSrvrPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyActiveConn=sslProxyActiveConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyInBytes=sslProxyInBytes, webCacheAddress=webCacheAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, memoryUsageHigh=memoryUsageHigh, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, cpuUtilization=cpuUtilization, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsMIBConformance=bwsMIBConformance, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, peerDown=peerDown, webCacheCacheableRes=webCacheCacheableRes, httpProxyTotalConn=httpProxyTotalConn, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, PYSNMP_MODULE_ID=bws, webCacheBytesOut=webCacheBytesOut, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheLongHdrs=webCacheLongHdrs, ipsHdrAclPort=ipsHdrAclPort, ipsRCAddress=ipsRCAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrState=sslSrvrState, srvcName=srvcName, bwsCompressionStatsTable=bwsCompressionStatsTable, totalAttacks=totalAttacks, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, securityDefUpdates=securityDefUpdates, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrAddress=httpSrvrAddress, sslSrvrAddressType=sslSrvrAddressType, switchingToInlineMode=switchingToInlineMode, sslProxyTotalReq=sslProxyTotalReq, activeServers=activeServers, systemLoad=systemLoad, processCountHigh=processCountHigh, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bws=bws, webCacheMiss=webCacheMiss, currentFirmwareVersion=currentFirmwareVersion, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrPort=httpSrvrPort, logStorageHigh=logStorageHigh, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecPort=ipsCookieSecPort, bwstraps=bwstraps, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyParseErr=httpProxyParseErr, httpSrvrInBytes=httpSrvrInBytes, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsStatsGroup=bwsStatsGroup, highAvailabilityStatus=highAvailabilityStatus, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrState=httpSrvrState, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, linkStatus=linkStatus, uptime=uptime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrSrvcPort=httpSrvrSrvcPort, serviceAddress=serviceAddress, dataPortLinkDown=dataPortLinkDown, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, systemFanSpeed=systemFanSpeed, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheProtocol=webCacheProtocol, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheCachedObjects=webCacheCachedObjects, operationalMode=operationalMode, sslProxyTotalConn=sslProxyTotalConn, serverUp=serverUp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrAddress=sslSrvrAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlAclPort=ipsUrlAclPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyTotalReq=httpProxyTotalReq, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, totalMem=totalMem, httpProxyOutBytes=httpProxyOutBytes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, serviceStatus=serviceStatus, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sharedSecretKeyExpired=sharedSecretKeyExpired, fanDead=fanDead, httpProxyAddress=httpProxyAddress, sslProxyErrPms=sslProxyErrPms, webCachePort=webCachePort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, smRealmName=smRealmName, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCacheStale=webCacheStale, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrTotTimedout=httpSrvrTotTimedout, totalServers=totalServers, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsMIBGroups=bwsMIBGroups, activeApplications=activeApplications, energizeUpdateExpire=energizeUpdateExpire, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsMIBCompliance=bwsMIBCompliance, ipsUrlAclReserved=ipsUrlAclReserved)
mibBuilder.exportSymbols("BWS-MIB", bwsSMUserSessionTable=bwsSMUserSessionTable, ipsHdrAclAddress=ipsHdrAclAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyInBytes=httpProxyInBytes, sslSrvrInBytes=sslSrvrInBytes, webCmprAddressType=webCmprAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, vipStatus=vipStatus, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrTotRefused=httpSrvrTotRefused, bwsMessage=bwsMessage, cpuTemperature=cpuTemperature, cpuFanSpeed=cpuFanSpeed, httpSrvrNumConn=httpSrvrNumConn, ipsHdrAclHits=ipsHdrAclHits, firmwareStorage=firmwareStorage, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, memUtilization=memUtilization, raidDegrading=raidDegrading, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, freeMem=freeMem, webCmprProtocol=webCmprProtocol, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrTotResponse=httpSrvrTotResponse, tempHigh=tempHigh, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCPort=ipsRCPort, systemFailOver=systemFailOver, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsStats=bwsStats, sslProxyFullHandshakes=sslProxyFullHandshakes, totalApplications=totalApplications, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyPort=httpProxyPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyAddress=ipsUrlPolicyAddress, totalBandwidth=totalBandwidth, httpProxyServerReq=httpProxyServerReq, httpSrvrMinResTime=httpSrvrMinResTime, systemFailure=systemFailure, httpProxyServerErr=httpProxyServerErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCmprPort=webCmprPort, virusDefUpdates=virusDefUpdates, dataPathStatus=dataPathStatus, sslProxyAddressType=sslProxyAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, tempCritical=tempCritical, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheHits=webCacheHits, sslProxyAddress=sslProxyAddress, webCacheAddressType=webCacheAddressType)
