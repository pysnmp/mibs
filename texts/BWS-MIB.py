...
IpAddress, iso, ObjectIdentity, Counter32, Counter64, Gauge32, Unsigned32, ModuleIdentity, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "ObjectIdentity", "Counter32", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyBadCRLErr=sslProxyBadCRLErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsServiceStatusEntry=bwsServiceStatusEntry, switchingToBypassMode=switchingToBypassMode, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, dataPortLinkDown=dataPortLinkDown, tempCritical=tempCritical, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsCacheStatsTable=bwsCacheStatsTable, bwstraps=bwstraps, sslSrvrState=sslSrvrState, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrState=httpSrvrState, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyTotalConn=httpProxyTotalConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyInBytes=httpProxyInBytes, virusDefUpdates=virusDefUpdates, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlPort=ipsAccessCtrlPort, peerUp=peerUp, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsRCPort=ipsRCPort, totalAttacks=totalAttacks, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bws=bws, webCacheReq=webCacheReq, webCmprAddress=webCmprAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyPort=httpProxyPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqSrvcPort=ipsReqSrvcPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, firmwareStorage=firmwareStorage, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyTotalReq=httpProxyTotalReq, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyCacheHits=sslProxyCacheHits, webCacheProtocol=webCacheProtocol, webCacheHits=webCacheHits, switchingToInlineMode=switchingToInlineMode, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsTrapGroup=bwsTrapGroup, httpProxyServerReq=httpProxyServerReq, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, activeApplications=activeApplications, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyAddressType=httpProxyAddressType, ipsRCAddressType=ipsRCAddressType, sslSrvrPort=sslSrvrPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrNumConn=httpSrvrNumConn, activeServers=activeServers, firmwareStorageHigh=firmwareStorageHigh, ipsWebAddrTransAddress=ipsWebAddrTransAddress, freeMem=freeMem, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyErrPms=sslProxyErrPms, sslSrvrAddress=sslSrvrAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyServerErr=httpProxyServerErr, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitPort=ipsReqLimitPort, ipsUrlAclPort=ipsUrlAclPort, httpProxyActiveConn=httpProxyActiveConn, webCacheCacheableRes=webCacheCacheableRes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrInBytes=httpSrvrInBytes, systemSerialNumber=systemSerialNumber, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCmprAddressType=webCmprAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, dataPathStatus=dataPathStatus, systemFailure=systemFailure, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, logStorageHigh=logStorageHigh, securityDefUpdates=securityDefUpdates, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrAvgResTime=sslSrvrAvgResTime, fanDead=fanDead, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsCacheStatsEntry=bwsCacheStatsEntry, dataPortLinkUp=dataPortLinkUp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, memoryUsageHigh=memoryUsageHigh, servicePort=servicePort, httpSrvrAddressType=httpSrvrAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrAddress=httpSrvrAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcPort=ipsLrnSrvcPort, highAvailabilityStatus=highAvailabilityStatus, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheLongHdrs=webCacheLongHdrs, httpSrvrMinResTime=httpSrvrMinResTime, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotResponse=sslSrvrTotResponse, bwsStatsGroup=bwsStatsGroup, PYSNMP_MODULE_ID=bws, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheMiss=webCacheMiss, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, logStorage=logStorage, sslProxyOutBytes=sslProxyOutBytes, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCacheAddressType=webCacheAddressType, sslProxyAddress=sslProxyAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyOutBytes=httpProxyOutBytes, sslProxyActiveConn=sslProxyActiveConn, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCmprPort=webCmprPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlAclAddress=ipsUrlAclAddress, serverDown=serverDown, ipsCookieSecPort=ipsCookieSecPort, uptime=uptime, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsMIBGroups=bwsMIBGroups, ipsHdrAclPort=ipsHdrAclPort, sslProxyPort=sslProxyPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsMIBConformance=bwsMIBConformance, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, peerDown=peerDown, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, tempHigh=tempHigh, bwsMessage=bwsMessage, vipStatus=vipStatus, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, cpuFanSpeed=cpuFanSpeed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsStats=bwsStats, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCacheBytesOut=webCacheBytesOut, operationalMode=operationalMode, ipsRCTotServed=ipsRCTotServed, bwsMIBCompliances=bwsMIBCompliances, sslProxyInBytes=sslProxyInBytes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, webCachePort=webCachePort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsMIBCompliance=bwsMIBCompliance, serviceAddress=serviceAddress, ipsUrlAclReserved=ipsUrlAclReserved, totalServers=totalServers, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, linkStatus=linkStatus, sslProxyAddressType=sslProxyAddressType, totalMem=totalMem, smAgentName=smAgentName, httpProxyServerAbrt=httpProxyServerAbrt, ipsRCAddress=ipsRCAddress, serverUp=serverUp, energizeUpdateExpire=energizeUpdateExpire, ipsUrlNormAddress=ipsUrlNormAddress, memUtilization=memUtilization, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrTotReqActive=httpSrvrTotReqActive, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheCachedObjects=webCacheCachedObjects, webCacheStale=webCacheStale, sslProxyTotalReq=sslProxyTotalReq)
mibBuilder.exportSymbols("BWS-MIB", webCacheAddress=webCacheAddress, systemLoad=systemLoad, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, serviceStatus=serviceStatus, totalBandwidth=totalBandwidth, ipsUrlNormAddressType=ipsUrlNormAddressType, serviceName=serviceName, systemFailOver=systemFailOver, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrAddressType=sslSrvrAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, raidDegrading=raidDegrading, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, processCountHigh=processCountHigh, totalApplications=totalApplications, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTimeStamp=ipsRCTimeStamp, webCmprProtocol=webCmprProtocol, smRealmName=smRealmName, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlNormPort=ipsUrlNormPort, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrInBytes=sslSrvrInBytes, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, cpuUtilization=cpuUtilization, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyAddress=httpProxyAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsRCTotDropped=ipsRCTotDropped, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, firmwareUpdateAvailable=firmwareUpdateAvailable, cpuTemperature=cpuTemperature, systemFanSpeed=systemFanSpeed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, smNumUserSessions=smNumUserSessions, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyCurrentConn=sslProxyCurrentConn, srvcName=srvcName, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrPort=httpSrvrPort, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyClientAbrt=httpProxyClientAbrt)
