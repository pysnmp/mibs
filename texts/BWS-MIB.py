...
ModuleIdentity, Integer32, Gauge32, Unsigned32, Counter32, TimeTicks, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, iso, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Gauge32", "Unsigned32", "Counter32", "TimeTicks", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "iso", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyCacheHits=sslProxyCacheHits, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyInBytes=sslProxyInBytes, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, tempCritical=tempCritical, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlAclPort=ipsUrlAclPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrInBytes=sslSrvrInBytes, ipsRCAddressType=ipsRCAddressType, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitPort=ipsReqLimitPort, httpSrvrState=httpSrvrState, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, linkStatus=linkStatus, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, switchingToMaintMode=switchingToMaintMode, sslProxyCacheMiss=sslProxyCacheMiss, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, smRealmName=smRealmName, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, firmwareStorageHigh=firmwareStorageHigh, memUtilization=memUtilization, webCacheCacheableRes=webCacheCacheableRes, webCmprProtocol=webCmprProtocol, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, freeMem=freeMem, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyWAFWarnings=httpProxyWAFWarnings, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyParseErr=httpProxyParseErr, webCachePort=webCachePort, httpProxyAddressType=httpProxyAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, totalBandwidth=totalBandwidth, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsStatsGroup=bwsStatsGroup, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrPort=sslSrvrPort, webCacheReq=webCacheReq, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, currentFirmwareVersion=currentFirmwareVersion, webCacheProtocol=webCacheProtocol, sslSrvrAddressType=sslSrvrAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrAddress=httpSrvrAddress, httpProxyTotalReq=httpProxyTotalReq, processCountHigh=processCountHigh, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, fanDead=fanDead, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheMiss=webCacheMiss, PYSNMP_MODULE_ID=bws, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrSrvcAddress=sslSrvrSrvcAddress, totalAttacks=totalAttacks, ipsUrlNormPort=ipsUrlNormPort, sslSrvrState=sslSrvrState, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyOutBytes=sslProxyOutBytes, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, firmwareStorage=firmwareStorage, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyAddressType=sslProxyAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, smNumUserSessions=smNumUserSessions, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsRCTotServed=ipsRCTotServed, httpProxyActiveConn=httpProxyActiveConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, cpuFanSpeed=cpuFanSpeed, vipStatus=vipStatus, bwsMIBConformance=bwsMIBConformance, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsRCPort=ipsRCPort, webCacheAddress=webCacheAddress, ipsRCTotDropped=ipsRCTotDropped, sslSrvrAddress=sslSrvrAddress, webCmprPort=webCmprPort, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheAddressType=webCacheAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsCookieSecPort=ipsCookieSecPort, systemFailure=systemFailure, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, srvcName=srvcName, bwsMessage=bwsMessage, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemLoad=systemLoad, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyPort=sslProxyPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrMinResTime=sslSrvrMinResTime, peerUp=peerUp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyPort=httpProxyPort, sslSrvrNumConn=sslSrvrNumConn, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrInBytes=httpSrvrInBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyInBytes=httpProxyInBytes, bwsMIBCompliance=bwsMIBCompliance, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, energizeUpdateExpire=energizeUpdateExpire, httpSrvrMinResTime=httpSrvrMinResTime, operationalMode=operationalMode, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsStats=bwsStats, virusDefUpdates=virusDefUpdates, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, newAttackDefinitionInstalled=newAttackDefinitionInstalled, dataPathStatus=dataPathStatus, totalApplications=totalApplications, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsTrapGroup=bwsTrapGroup, httpSrvrAddressType=httpSrvrAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrTotRefused=sslSrvrTotRefused, webCacheHits=webCacheHits, serviceName=serviceName, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyAddress=httpProxyAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, systemFanSpeed=systemFanSpeed, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsHdrAclPort=ipsHdrAclPort, totalMem=totalMem, webCacheBytesOut=webCacheBytesOut, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, dataPortLinkUp=dataPortLinkUp, webCmprAddress=webCmprAddress, httpSrvrOutBytes=httpSrvrOutBytes, dataPortLinkDown=dataPortLinkDown, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, serviceStatus=serviceStatus, sslProxyErrPms=sslProxyErrPms, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsMIBGroups=bwsMIBGroups, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, servicePort=servicePort, sslProxyActiveConn=sslProxyActiveConn, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyTotalConn=httpProxyTotalConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCmprAddressType=webCmprAddressType, highAvailabilityStatus=highAvailabilityStatus, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheStale=webCacheStale, cpuTemperature=cpuTemperature, tempHigh=tempHigh, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, activeApplications=activeApplications, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, totalServers=totalServers, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, raidDegrading=raidDegrading, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcPort=ipsLrnSrvcPort, bws=bws, serverDown=serverDown, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrAvgResTime=sslSrvrAvgResTime, serviceAddress=serviceAddress, peerDown=peerDown, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsRCTotQueued=ipsRCTotQueued, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, uptime=uptime, httpProxyServerReq=httpProxyServerReq, sslProxyAddress=sslProxyAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, activeServers=activeServers, systemFailOver=systemFailOver, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyServerErr=httpProxyServerErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serverUp=serverUp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclAddress=ipsHdrAclAddress, smAgentName=smAgentName, httpSrvrTotResponse=httpSrvrTotResponse, bwstraps=bwstraps, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrPort=httpSrvrPort, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, cpuUtilization=cpuUtilization, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCAddress=ipsRCAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsMIBCompliances=bwsMIBCompliances, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCacheLongHdrs=webCacheLongHdrs, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, switchingToBypassMode=switchingToBypassMode, logStorage=logStorage, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, logStorageHigh=logStorageHigh)
