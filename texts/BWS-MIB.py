...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, NotificationType, Counter64, ObjectIdentity, ModuleIdentity, iso, TimeTicks, Integer32, Bits, Counter32, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "NotificationType", "Counter64", "ObjectIdentity", "ModuleIdentity", "iso", "TimeTicks", "Integer32", "Bits", "Counter32", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyAddress=sslProxyAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyTotalReq=httpProxyTotalReq, linkStatus=linkStatus, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrAddressType=httpSrvrAddressType, cpuUtilization=cpuUtilization, operationalMode=operationalMode, systemSerialNumber=systemSerialNumber, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, serviceName=serviceName, switchingToMaintMode=switchingToMaintMode, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyPort=sslProxyPort, sslSrvrState=sslSrvrState, sslProxyOutBytes=sslProxyOutBytes, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, smAgentName=smAgentName, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, webCacheHits=webCacheHits, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsMIBConformance=bwsMIBConformance, ipsRCTotServed=ipsRCTotServed, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormAddressType=ipsUrlNormAddressType, switchingToInlineMode=switchingToInlineMode, bwsStatsGroup=bwsStatsGroup, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, dataPathStatus=dataPathStatus, sslSrvrAddress=sslSrvrAddress, httpProxyParseErr=httpProxyParseErr, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrOutBytes=httpSrvrOutBytes, webCmprAddressType=webCmprAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyInBytes=sslProxyInBytes, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrPort=sslSrvrPort, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, peerDown=peerDown, bws=bws, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, firmwareUpdateAvailable=firmwareUpdateAvailable, logStorageHigh=logStorageHigh, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwstraps=bwstraps, sslProxyActiveConn=sslProxyActiveConn, ipsRCAddress=ipsRCAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, systemLoad=systemLoad, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheCachedObjects=webCacheCachedObjects, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsStats=bwsStats, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheProtocol=webCacheProtocol, securityDefUpdates=securityDefUpdates, uptime=uptime, httpProxySessionTimeOut=httpProxySessionTimeOut, activeApplications=activeApplications, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsMIBGroups=bwsMIBGroups, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyTotalConn=httpProxyTotalConn, httpSrvrTotTimedout=httpSrvrTotTimedout, serviceStatus=serviceStatus, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCPort=ipsRCPort, raidDegrading=raidDegrading, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, systemFailure=systemFailure, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, dataPortLinkUp=dataPortLinkUp, serverDown=serverDown, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrState=httpSrvrState, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, cpuTemperature=cpuTemperature, fanDead=fanDead, ipsReqSrvcPort=ipsReqSrvcPort, systemFailOver=systemFailOver, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, tempHigh=tempHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCmprAddress=webCmprAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyActiveConn=httpProxyActiveConn, httpProxyOutBytes=httpProxyOutBytes, webCachePort=webCachePort, servicePort=servicePort, webCacheAddressType=webCacheAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, logStorage=logStorage, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecPort=ipsCookieSecPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, serverUp=serverUp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, totalMem=totalMem, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumConn=sslSrvrNumConn, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, dataPortLinkDown=dataPortLinkDown, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumConn=httpSrvrNumConn, firmwareStorageHigh=firmwareStorageHigh, webCacheBytesOut=webCacheBytesOut, httpSrvrPort=httpSrvrPort, sslSrvrAddressType=sslSrvrAddressType, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, freeMem=freeMem, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, totalApplications=totalApplications, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyErrPms=sslProxyErrPms, energizeUpdateExpire=energizeUpdateExpire, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsRCAddressType=ipsRCAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyAddressType=sslProxyAddressType, bwsServiceStatusTable=bwsServiceStatusTable, highAvailabilityStatus=highAvailabilityStatus, httpSrvrSrvcAddress=httpSrvrSrvcAddress, processCountHigh=processCountHigh, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrInBytes=sslSrvrInBytes, sslProxyTotalReq=sslProxyTotalReq, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlAddress=ipsAccessCtrlAddress, totalServers=totalServers, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsHdrAclHits=ipsHdrAclHits, PYSNMP_MODULE_ID=bws, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrTotSuccess=httpSrvrTotSuccess, smNumUserSessions=smNumUserSessions, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCacheAddress=webCacheAddress, memoryUsageHigh=memoryUsageHigh, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, switchingToBypassMode=switchingToBypassMode, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyInBytes=httpProxyInBytes, httpProxyServerErr=httpProxyServerErr, bwsMessage=bwsMessage, bwsTrapGroup=bwsTrapGroup, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsMIBCompliance=bwsMIBCompliance, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, totalAttacks=totalAttacks, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCacheLongHdrs=webCacheLongHdrs, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, serviceAddress=serviceAddress, sslProxyCacheMiss=sslProxyCacheMiss)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrOutBytes=sslSrvrOutBytes, memUtilization=memUtilization, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, systemFanSpeed=systemFanSpeed, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, tempCritical=tempCritical, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyAddressType=httpProxyAddressType, ipsRCTotQueued=ipsRCTotQueued, webCacheCacheableRes=webCacheCacheableRes, ipsHdrAclAddressType=ipsHdrAclAddressType, webCmprPort=webCmprPort, webCacheMiss=webCacheMiss, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitPort=ipsReqLimitPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCacheStale=webCacheStale, srvcName=srvcName, httpProxyPort=httpProxyPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, cpuFanSpeed=cpuFanSpeed, peerUp=peerUp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyAddress=httpProxyAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, smRealmName=smRealmName, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrTotResponse=sslSrvrTotResponse, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyServerReq=httpProxyServerReq, totalBandwidth=totalBandwidth, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotResponse=httpSrvrTotResponse, webCacheReq=webCacheReq, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrAddress=httpSrvrAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, activeServers=activeServers, webCmprProtocol=webCmprProtocol, bwsSslProxyStatsTable=bwsSslProxyStatsTable, firmwareStorage=firmwareStorage, sslSrvrMinResTime=sslSrvrMinResTime, ipsCookieSecEncrypted=ipsCookieSecEncrypted, vipStatus=vipStatus, virusDefUpdates=virusDefUpdates, sslProxyTotalConn=sslProxyTotalConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlAclAddress=ipsUrlAclAddress, bwsCompressionStatsTable=bwsCompressionStatsTable)
