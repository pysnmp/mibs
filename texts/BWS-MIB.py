...
iso, ModuleIdentity, Gauge32, Counter32, Integer32, Bits, ObjectIdentity, TimeTicks, Counter64, NotificationType, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Gauge32", "Counter32", "Integer32", "Bits", "ObjectIdentity", "TimeTicks", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsCompressionStatsEntry=bwsCompressionStatsEntry, fanDead=fanDead, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyTotalConn=httpProxyTotalConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, serviceAddress=serviceAddress, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitAddress=ipsReqLimitAddress, systemFailure=systemFailure, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsHdrAclHits=ipsHdrAclHits, bwsMIBGroups=bwsMIBGroups, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, serverDown=serverDown, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, serverUp=serverUp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrNumConn=sslSrvrNumConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyActiveConn=httpProxyActiveConn, serviceName=serviceName, sslProxyAddress=sslProxyAddress, httpSrvrPort=httpSrvrPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsTrapGroup=bwsTrapGroup, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCTotQueued=ipsRCTotQueued, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrMinResTime=httpSrvrMinResTime, systemFailOver=systemFailOver, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyServerReq=httpProxyServerReq, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, totalServers=totalServers, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, cpuUtilization=cpuUtilization, peerUp=peerUp, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyTotalReq=sslProxyTotalReq, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCTotDropped=ipsRCTotDropped, webCmprAddressType=webCmprAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCacheMiss=webCacheMiss, bwsMIBCompliances=bwsMIBCompliances, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, servicePort=servicePort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, PYSNMP_MODULE_ID=bws, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrOutBytes=httpSrvrOutBytes, webCacheAddressType=webCacheAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyCacheTimeouts=sslProxyCacheTimeouts, processCountHigh=processCountHigh, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, srvcName=srvcName, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrTotRefused=httpSrvrTotRefused, totalAttacks=totalAttacks, serviceStatus=serviceStatus, webCacheBytesOut=webCacheBytesOut, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrState=httpSrvrState, httpProxyAddress=httpProxyAddress, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrMaxResTime=sslSrvrMaxResTime, bwstraps=bwstraps, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsMessage=bwsMessage, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyErrPms=sslProxyErrPms, tempHigh=tempHigh, activeServers=activeServers, dataPathStatus=dataPathStatus, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprPort=webCmprPort, sslProxyAddressType=sslProxyAddressType, bwsStats=bwsStats, ipsReqLimitPort=ipsReqLimitPort, webCacheCacheableRes=webCacheCacheableRes, webCacheStale=webCacheStale, sslSrvrMinResTime=sslSrvrMinResTime, linkStatus=linkStatus, ipsUrlAclPort=ipsUrlAclPort, httpSrvrSrvcPort=httpSrvrSrvcPort, peerDown=peerDown, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCacheProtocol=webCacheProtocol, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyAddressType=httpProxyAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprAddress=webCmprAddress, sslSrvrAddress=sslSrvrAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, smRealmName=smRealmName, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, operationalMode=operationalMode, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalApplications=totalApplications, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcAddress=ipsLrnSrvcAddress, totalMem=totalMem, tempCritical=tempCritical, sslSrvrTotReqRejected=sslSrvrTotReqRejected, totalBandwidth=totalBandwidth, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, dataPortLinkDown=dataPortLinkDown, switchingToMaintMode=switchingToMaintMode, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, logStorageHigh=logStorageHigh, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrTotRefused=sslSrvrTotRefused, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, smNumUserSessions=smNumUserSessions, sslSrvrOutBytes=sslSrvrOutBytes, dataPortLinkUp=dataPortLinkUp, httpSrvrAvgResTime=httpSrvrAvgResTime, sslProxyOutBytes=sslProxyOutBytes, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrMaxResTime=httpSrvrMaxResTime, raidDegrading=raidDegrading, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, securityDefUpdates=securityDefUpdates, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, smAgentName=smAgentName, ipsUrlNormPort=ipsUrlNormPort, httpSrvrInBytes=httpSrvrInBytes, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, ipsRCTotServed=ipsRCTotServed, webCacheHits=webCacheHits, cpuTemperature=cpuTemperature, webCmprProtocol=webCmprProtocol, activeApplications=activeApplications, httpSrvrAddressType=httpSrvrAddressType, sslSrvrState=sslSrvrState, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCachePort=webCachePort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsCacheStatsEntry=bwsCacheStatsEntry, firmwareStorage=firmwareStorage, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, uptime=uptime, ipsUrlAclAddress=ipsUrlAclAddress, memoryUsageHigh=memoryUsageHigh, logStorage=logStorage, memUtilization=memUtilization, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrInBytes=sslSrvrInBytes)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, cpuFanSpeed=cpuFanSpeed, httpProxyPort=httpProxyPort, bwsMIBCompliance=bwsMIBCompliance, httpProxyParseErr=httpProxyParseErr, switchingToInlineMode=switchingToInlineMode, bws=bws, freeMem=freeMem, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheAddress=webCacheAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrPort=sslSrvrPort, httpSrvrAddress=httpSrvrAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCPort=ipsRCPort, httpProxyTotalReq=httpProxyTotalReq, switchingToBypassMode=switchingToBypassMode, virusDefUpdates=virusDefUpdates, bwsStatsGroup=bwsStatsGroup, energizeUpdateExpire=energizeUpdateExpire, vipStatus=vipStatus, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, firmwareStorageHigh=firmwareStorageHigh, systemSerialNumber=systemSerialNumber, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheReq=webCacheReq, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCAddress=ipsRCAddress, sslProxyPort=sslProxyPort, systemLoad=systemLoad, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrAddressType=sslSrvrAddressType, systemFanSpeed=systemFanSpeed, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime)
