...
ModuleIdentity, Counter32, Bits, Unsigned32, Integer32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, ObjectIdentity, MibIdentifier, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Bits", "Unsigned32", "Integer32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "ObjectIdentity", "MibIdentifier", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyTotalReq=sslProxyTotalReq, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, serverDown=serverDown, sslProxyErrPms=sslProxyErrPms, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyOutBytes=sslProxyOutBytes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, tempCritical=tempCritical, httpSrvrMaxResTime=httpSrvrMaxResTime, activeServers=activeServers, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqSrvcPort=ipsReqSrvcPort, currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyWAFWarnings=httpProxyWAFWarnings, srvcName=srvcName, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsRCTotQueued=ipsRCTotQueued, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumConn=httpSrvrNumConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, dataPortLinkUp=dataPortLinkUp, httpSrvrTotSuccess=httpSrvrTotSuccess, smNumUserSessions=smNumUserSessions, totalMem=totalMem, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsStatsGroup=bwsStatsGroup, bwsServiceStatusEntry=bwsServiceStatusEntry, dataPortLinkDown=dataPortLinkDown, ipsUrlAclAddressType=ipsUrlAclAddressType, PYSNMP_MODULE_ID=bws, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyParseErr=httpProxyParseErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, switchingToInlineMode=switchingToInlineMode, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsRCPort=ipsRCPort, ipsUrlNormAddressType=ipsUrlNormAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyActiveConn=sslProxyActiveConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyCacheMiss=sslProxyCacheMiss, energizeUpdateExpire=energizeUpdateExpire, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyPort=httpProxyPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, servicePort=servicePort, fanDead=fanDead, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrSrvcPort=sslSrvrSrvcPort, cpuFanSpeed=cpuFanSpeed, ipsCookieSecTampered=ipsCookieSecTampered, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, firmwareStorageHigh=firmwareStorageHigh, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, raidDegrading=raidDegrading, sslSrvrInBytes=sslSrvrInBytes, sslProxyAddressType=sslProxyAddressType, sslProxyAddress=sslProxyAddress, serviceStatus=serviceStatus, securityDefUpdates=securityDefUpdates, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsRCTotServed=ipsRCTotServed, sslProxyFullHandshakes=sslProxyFullHandshakes, webCmprAddress=webCmprAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, processCountHigh=processCountHigh, vipStatus=vipStatus, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrSrvcPort=httpSrvrSrvcPort, operationalMode=operationalMode, cpuUtilization=cpuUtilization, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxySessionTimeOut=httpProxySessionTimeOut, totalAttacks=totalAttacks, ipsReqLimitPort=ipsReqLimitPort, httpSrvrOutBytes=httpSrvrOutBytes, systemFailOver=systemFailOver, webCmprProtocol=webCmprProtocol, httpProxyOutBytes=httpProxyOutBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCachePort=webCachePort, httpSrvrAddress=httpSrvrAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, bws=bws, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsRCAddressType=ipsRCAddressType, httpSrvrInBytes=httpSrvrInBytes, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlAclPort=ipsUrlAclPort, switchingToMaintMode=switchingToMaintMode, serviceAddress=serviceAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsMIBConformance=bwsMIBConformance, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, switchingToBypassMode=switchingToBypassMode, webCacheMiss=webCacheMiss, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, totalBandwidth=totalBandwidth, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, firmwareUpdateAvailable=firmwareUpdateAvailable, cpuTemperature=cpuTemperature, webCacheProtocol=webCacheProtocol, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, serviceName=serviceName, totalApplications=totalApplications, serverUp=serverUp, peerUp=peerUp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrPort=sslSrvrPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyServerReq=httpProxyServerReq, uptime=uptime, webCacheLongHdrs=webCacheLongHdrs, logStorage=logStorage, sslProxyTotalConn=sslProxyTotalConn, peerDown=peerDown, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyTotalConn=httpProxyTotalConn, webCacheReq=webCacheReq, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsCompressionStatsTable=bwsCompressionStatsTable, activeApplications=activeApplications, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsRCTimeStamp=ipsRCTimeStamp, firmwareStorage=firmwareStorage, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsHdrAclPort=ipsHdrAclPort, bwsMIBCompliance=bwsMIBCompliance, logStorageHigh=logStorageHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsStats=bwsStats, webCacheAddress=webCacheAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsServiceStatusTable=bwsServiceStatusTable, webCacheCacheableRes=webCacheCacheableRes, ipsUrlNormPort=ipsUrlNormPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, memUtilization=memUtilization, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyServerErr=httpProxyServerErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyPort=sslProxyPort, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsRCTotDropped=ipsRCTotDropped, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheAddressType=webCacheAddressType, webCmprAddressType=webCmprAddressType, bwstraps=bwstraps, freeMem=freeMem, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, linkStatus=linkStatus, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyTotalReq=httpProxyTotalReq, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyCacheHits=sslProxyCacheHits, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrState=sslSrvrState, sslSrvrAddressType=sslSrvrAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsMessage=bwsMessage, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrNumFreeConn=httpSrvrNumFreeConn, systemFanSpeed=systemFanSpeed, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyClientAbrt=httpProxyClientAbrt, bwsTrapGroup=bwsTrapGroup)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheHits=webCacheHits, httpProxyInBytes=httpProxyInBytes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecPort=ipsCookieSecPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyAddress=httpProxyAddress, smRealmName=smRealmName, sslSrvrNumConn=sslSrvrNumConn, virusDefUpdates=virusDefUpdates, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrSrvcAddress=httpSrvrSrvcAddress, systemLoad=systemLoad, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, systemFailure=systemFailure, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheBytesOut=webCacheBytesOut, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, memoryUsageHigh=memoryUsageHigh, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrTotRefused=httpSrvrTotRefused, totalServers=totalServers, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, smAgentName=smAgentName, webCacheStale=webCacheStale, httpProxyActiveConn=httpProxyActiveConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsRCAddress=ipsRCAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrPort=httpSrvrPort, bwsMIBGroups=bwsMIBGroups, webCmprPort=webCmprPort, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrState=httpSrvrState, sslProxyInBytes=sslProxyInBytes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, dataPathStatus=dataPathStatus, tempHigh=tempHigh, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsMIBCompliances=bwsMIBCompliances, httpSrvrAddressType=httpSrvrAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitAddressType=ipsReqLimitAddressType)
