...
ModuleIdentity, NotificationType, Counter64, Counter32, Bits, Gauge32, Integer32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Counter64", "Counter32", "Bits", "Gauge32", "Integer32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrPort=httpSrvrPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, switchingToInlineMode=switchingToInlineMode, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCacheMiss=webCacheMiss, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsHdrAclHits=ipsHdrAclHits, cpuFanSpeed=cpuFanSpeed, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, totalApplications=totalApplications, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlPolicyPort=ipsUrlPolicyPort, logStorageHigh=logStorageHigh, webCmprProtocol=webCmprProtocol, ipsUrlAclReserved=ipsUrlAclReserved, bwsServiceStatusTable=bwsServiceStatusTable, totalServers=totalServers, ipsCookieSecEncrypted=ipsCookieSecEncrypted, raidDegrading=raidDegrading, processCountHigh=processCountHigh, servicePort=servicePort, operationalMode=operationalMode, tempCritical=tempCritical, webCmprAddress=webCmprAddress, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, totalMem=totalMem, memoryUsageHigh=memoryUsageHigh, sslProxyInBytes=sslProxyInBytes, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsHdrAclAddressType=ipsHdrAclAddressType, dataPortLinkDown=dataPortLinkDown, ipsReqLimitAddressType=ipsReqLimitAddressType, systemSerialNumber=systemSerialNumber, httpProxyServerAbrt=httpProxyServerAbrt, webCacheProtocol=webCacheProtocol, ipsHdrAclPort=ipsHdrAclPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrNumConn=httpSrvrNumConn, logStorage=logStorage, httpProxyAddress=httpProxyAddress, sslProxyPort=sslProxyPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyTotalConn=httpProxyTotalConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyTotalReq=httpProxyTotalReq, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheBytesOut=webCacheBytesOut, PYSNMP_MODULE_ID=bws, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCPort=ipsRCPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyPort=httpProxyPort, sslProxyErrPms=sslProxyErrPms, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsStats=bwsStats, sslProxyAddress=sslProxyAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, currentFirmwareVersion=currentFirmwareVersion, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, linkStatus=linkStatus, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrMaxResTime=sslSrvrMaxResTime, memUtilization=memUtilization, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, dataPathStatus=dataPathStatus, systemFanSpeed=systemFanSpeed, systemFailure=systemFailure, httpSrvrNumFreeConn=httpSrvrNumFreeConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyServerErr=httpProxyServerErr, serverDown=serverDown, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsMIBGroups=bwsMIBGroups, bwsMIBCompliances=bwsMIBCompliances, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlAclPort=ipsUrlAclPort, httpProxySessionTimeOut=httpProxySessionTimeOut, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlAddress=ipsAccessCtrlAddress, freeMem=freeMem, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bws=bws, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, totalBandwidth=totalBandwidth, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheCacheableRes=webCacheCacheableRes, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrMaxResTime=httpSrvrMaxResTime, vipStatus=vipStatus, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheStale=webCacheStale, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCachePort=webCachePort, bwsCacheStatsEntry=bwsCacheStatsEntry, smAgentName=smAgentName, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, fanDead=fanDead, tempHigh=tempHigh, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, uptime=uptime, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrState=httpSrvrState, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, virusDefUpdates=virusDefUpdates, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsCookieSecAddressType=ipsCookieSecAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, dataPortLinkUp=dataPortLinkUp, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serviceName=serviceName, webCmprCompressedDataSize=webCmprCompressedDataSize, bwstraps=bwstraps, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrAvgResTime=sslSrvrAvgResTime, cpuUtilization=cpuUtilization, ipsReqLimitPort=ipsReqLimitPort, ipsRCTimeStamp=ipsRCTimeStamp, systemFailOver=systemFailOver, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyParseErr=httpProxyParseErr, firmwareStorage=firmwareStorage, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsStatsGroup=bwsStatsGroup, sslProxyActiveConn=sslProxyActiveConn, webCacheAddress=webCacheAddress, activeApplications=activeApplications, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrAddressType=sslSrvrAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrTotRefused=httpSrvrTotRefused, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecPort=ipsCookieSecPort, webCacheAddressType=webCacheAddressType, webCacheHits=webCacheHits, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrAddress=sslSrvrAddress, sslProxyTotalConn=sslProxyTotalConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsMIBConformance=bwsMIBConformance, sslProxyAddressType=sslProxyAddressType, totalAttacks=totalAttacks, serviceAddress=serviceAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsMessage=bwsMessage, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheReq=webCacheReq, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, cpuTemperature=cpuTemperature, systemLoad=systemLoad, httpProxyActiveConn=httpProxyActiveConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, securityDefUpdates=securityDefUpdates, httpProxyInBytes=httpProxyInBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, activeServers=activeServers, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCTotServed=ipsRCTotServed)
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, smRealmName=smRealmName, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, energizeUpdateExpire=energizeUpdateExpire, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, smNumUserSessions=smNumUserSessions, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrInBytes=sslSrvrInBytes, highAvailabilityStatus=highAvailabilityStatus, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, serviceStatus=serviceStatus, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsRCAddress=ipsRCAddress, peerDown=peerDown, httpProxyWAFWarnings=httpProxyWAFWarnings, firmwareUpdateAvailable=firmwareUpdateAvailable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyServerReq=httpProxyServerReq, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCmprPort=webCmprPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrAddress=httpSrvrAddress, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, switchingToBypassMode=switchingToBypassMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, serverUp=serverUp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrPort=sslSrvrPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsHdrAclAddress=ipsHdrAclAddress, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormPort=ipsUrlNormPort, peerUp=peerUp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, switchingToMaintMode=switchingToMaintMode, webCmprAddressType=webCmprAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, srvcName=srvcName, httpProxyAddressType=httpProxyAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrState=sslSrvrState, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyTotalReq=sslProxyTotalReq)
