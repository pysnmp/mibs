...
Integer32, MibIdentifier, TimeTicks, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, NotificationType, Gauge32, Counter64, IpAddress, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "TimeTicks", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "NotificationType", "Gauge32", "Counter64", "IpAddress", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", webCmprPort=webCmprPort, totalApplications=totalApplications, webCachePort=webCachePort, ipsCookieSecPort=ipsCookieSecPort, httpProxyAddressType=httpProxyAddressType, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrPort=httpSrvrPort, ipsRCTotServed=ipsRCTotServed, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrInBytes=sslSrvrInBytes, totalMem=totalMem, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, totalServers=totalServers, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyServerAbrt=httpProxyServerAbrt, memUtilization=memUtilization, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyPort=sslProxyPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyServerErr=httpProxyServerErr, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsRCTotQueued=ipsRCTotQueued, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsMIBCompliances=bwsMIBCompliances, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheAddressType=webCacheAddressType, bwsStats=bwsStats, securityDefUpdates=securityDefUpdates, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyCacheHits=sslProxyCacheHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, tempHigh=tempHigh, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyAddress=httpProxyAddress, dataPortLinkDown=dataPortLinkDown, cpuTemperature=cpuTemperature, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprAddressType=webCmprAddressType, bwsStatsGroup=bwsStatsGroup, processCountHigh=processCountHigh, srvcName=srvcName, sslSrvrAddressType=sslSrvrAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitPort=ipsReqLimitPort, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, dataPortLinkUp=dataPortLinkUp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheAddress=webCacheAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlNormPort=ipsUrlNormPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, systemFailOver=systemFailOver, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bws=bws, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlAclPort=ipsUrlAclPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyServerReq=httpProxyServerReq, bwsMIBCompliance=bwsMIBCompliance, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCmprAddress=webCmprAddress, totalBandwidth=totalBandwidth, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, virusDefUpdates=virusDefUpdates, webCacheProtocol=webCacheProtocol, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, serviceAddress=serviceAddress, sslProxyAddressType=sslProxyAddressType, dataPathStatus=dataPathStatus, httpProxyTotalConn=httpProxyTotalConn, sslProxyErrPms=sslProxyErrPms, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, serverUp=serverUp, ipsHdrAclPort=ipsHdrAclPort, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, totalAttacks=totalAttacks, httpSrvrTotRefused=httpSrvrTotRefused, webCacheBytesOut=webCacheBytesOut, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, serviceStatus=serviceStatus, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheLongHdrs=webCacheLongHdrs, peerUp=peerUp, httpSrvrTotTimedout=httpSrvrTotTimedout, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyPort=httpProxyPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrState=httpSrvrState, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrAddressType=httpSrvrAddressType, ipsRCTotDropped=ipsRCTotDropped, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyActiveConn=httpProxyActiveConn, cpuUtilization=cpuUtilization, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, switchingToInlineMode=switchingToInlineMode, cpuFanSpeed=cpuFanSpeed, peerDown=peerDown, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, uptime=uptime, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, webCacheCacheableRes=webCacheCacheableRes, bwsTrapGroup=bwsTrapGroup, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, tempCritical=tempCritical, webCmprProtocol=webCmprProtocol, sslSrvrAddress=sslSrvrAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyOutBytes=httpProxyOutBytes, activeServers=activeServers, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrState=sslSrvrState, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, firmwareStorageHigh=firmwareStorageHigh, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, linkStatus=linkStatus, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, operationalMode=operationalMode, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, energizeUpdateExpire=energizeUpdateExpire, sslProxyInBytes=sslProxyInBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, freeMem=freeMem, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheStale=webCacheStale, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, systemFailure=systemFailure, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyActiveConn=sslProxyActiveConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyAddress=sslProxyAddress, PYSNMP_MODULE_ID=bws, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCAddress=ipsRCAddress, fanDead=fanDead, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsMIBGroups=bwsMIBGroups, bwsSMUserSessionTable=bwsSMUserSessionTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlPolicyPort=ipsUrlPolicyPort, servicePort=servicePort, smNumUserSessions=smNumUserSessions, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrPort=sslSrvrPort, currentFirmwareVersion=currentFirmwareVersion, bwsCompressionStatsTable=bwsCompressionStatsTable, firmwareStorage=firmwareStorage, httpSrvrNumConn=httpSrvrNumConn, memoryUsageHigh=memoryUsageHigh, sslProxyTotalConn=sslProxyTotalConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCacheMiss=webCacheMiss, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsCompressionStatsEntry=bwsCompressionStatsEntry, raidDegrading=raidDegrading, logStorage=logStorage, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrOutBytes=sslSrvrOutBytes, systemFanSpeed=systemFanSpeed, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", highAvailabilityStatus=highAvailabilityStatus, sslProxyOutBytes=sslProxyOutBytes, sslProxyTotalReq=sslProxyTotalReq, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, smRealmName=smRealmName, switchingToMaintMode=switchingToMaintMode, ipsHdrAclHits=ipsHdrAclHits, httpProxyParseErr=httpProxyParseErr, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, serverDown=serverDown, ipsReqSrvcPort=ipsReqSrvcPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, systemSerialNumber=systemSerialNumber, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwstraps=bwstraps, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, smAgentName=smAgentName, sslSrvrNumConn=sslSrvrNumConn, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, vipStatus=vipStatus, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsMessage=bwsMessage, ipsReqSrvcAddress=ipsReqSrvcAddress, systemLoad=systemLoad, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlAclReserved=ipsUrlAclReserved, ipsCookieSecAddress=ipsCookieSecAddress, webCacheReq=webCacheReq, webCacheHits=webCacheHits, logStorageHigh=logStorageHigh, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, serviceName=serviceName, httpSrvrInBytes=httpSrvrInBytes, httpProxyInBytes=httpProxyInBytes, switchingToBypassMode=switchingToBypassMode, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsRCAddressType=ipsRCAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqLimitAddress=ipsReqLimitAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheCachedObjects=webCacheCachedObjects, ipsRCPort=ipsRCPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsRCTimeStamp=ipsRCTimeStamp, activeApplications=activeApplications)
