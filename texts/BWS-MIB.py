...
NotificationType, Counter64, Integer32, Unsigned32, Bits, IpAddress, iso, ModuleIdentity, ObjectIdentity, Counter32, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Integer32", "Unsigned32", "Bits", "IpAddress", "iso", "ModuleIdentity", "ObjectIdentity", "Counter32", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, systemFailure=systemFailure, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, vipStatus=vipStatus, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, highAvailabilityStatus=highAvailabilityStatus, ipsRCTimeStamp=ipsRCTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsRCTotDropped=ipsRCTotDropped, webCacheCacheableRes=webCacheCacheableRes, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsMIBCompliances=bwsMIBCompliances, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrInBytes=sslSrvrInBytes, bwsMessage=bwsMessage, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyErrPms=sslProxyErrPms, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, firmwareStorageHigh=firmwareStorageHigh, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsRCTotQueued=ipsRCTotQueued, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrInBytes=httpSrvrInBytes, webCacheStale=webCacheStale, ipsCookieSecPort=ipsCookieSecPort, totalServers=totalServers, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyAddressType=httpProxyAddressType, activeApplications=activeApplications, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcAddress=ipsLrnSrvcAddress, srvcName=srvcName, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, totalMem=totalMem, fanDead=fanDead, sslProxyAddressType=sslProxyAddressType, webCacheReq=webCacheReq, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyServerReq=httpProxyServerReq, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyActiveConn=sslProxyActiveConn, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsHdrAclHits=ipsHdrAclHits, httpProxyServerErr=httpProxyServerErr, sslProxyOutBytes=sslProxyOutBytes, httpProxyAddress=httpProxyAddress, smNumUserSessions=smNumUserSessions, ipsUrlNormAddress=ipsUrlNormAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrAddress=sslSrvrAddress, tempHigh=tempHigh, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyParseErr=httpProxyParseErr, bwstraps=bwstraps, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, serviceName=serviceName, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrSrvcPort=httpSrvrSrvcPort, peerUp=peerUp, webCacheHits=webCacheHits, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlPort=ipsAccessCtrlPort, peerDown=peerDown, httpSrvrAddressType=httpSrvrAddressType, PYSNMP_MODULE_ID=bws, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serverUp=serverUp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, securityDefUpdates=securityDefUpdates, webCmprProtocol=webCmprProtocol, httpSrvrTotTimedout=httpSrvrTotTimedout, webCmprAddressType=webCmprAddressType, virusDefUpdates=virusDefUpdates, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsStats=bwsStats, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCmprAddress=webCmprAddress, webCmprPort=webCmprPort, webCacheMiss=webCacheMiss, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsMIBGroups=bwsMIBGroups, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlAclReserved=ipsUrlAclReserved, dataPortLinkUp=dataPortLinkUp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, totalAttacks=totalAttacks, ipsRCAddressType=ipsRCAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyAddress=sslProxyAddress, logStorage=logStorage, energizeUpdateExpire=energizeUpdateExpire, httpSrvrPort=httpSrvrPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, switchingToMaintMode=switchingToMaintMode, httpProxyClientAbrt=httpProxyClientAbrt, webCacheCachedObjects=webCacheCachedObjects, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, cpuUtilization=cpuUtilization, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, activeServers=activeServers, bwsStatsGroup=bwsStatsGroup, currentFirmwareVersion=currentFirmwareVersion, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, dataPortLinkDown=dataPortLinkDown, httpProxyOutBytes=httpProxyOutBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, smAgentName=smAgentName, smRealmName=smRealmName, sslSrvrAddressType=sslSrvrAddressType, operationalMode=operationalMode, systemSerialNumber=systemSerialNumber, ipsReqLimitPort=ipsReqLimitPort, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyPort=httpProxyPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, serverDown=serverDown, webCmprCompressibleDataSize=webCmprCompressibleDataSize, servicePort=servicePort, sslProxyTotalConn=sslProxyTotalConn, bws=bws, cpuTemperature=cpuTemperature, bwsSMUserSessionEntry=bwsSMUserSessionEntry, dataPathStatus=dataPathStatus, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, firmwareUpdateAvailable=firmwareUpdateAvailable, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyCacheTimeouts=sslProxyCacheTimeouts, uptime=uptime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlNormPort=ipsUrlNormPort, totalBandwidth=totalBandwidth, httpProxyTotalConn=httpProxyTotalConn, systemFanSpeed=systemFanSpeed, httpSrvrTotResponse=httpSrvrTotResponse, totalApplications=totalApplications, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, firmwareStorage=firmwareStorage, httpSrvrState=httpSrvrState, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrState=sslSrvrState, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, systemFailOver=systemFailOver, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyInBytes=httpProxyInBytes, ipsRCAddress=ipsRCAddress, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, memoryUsageHigh=memoryUsageHigh, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, serviceAddress=serviceAddress, httpProxyServerAbrt=httpProxyServerAbrt, serviceStatus=serviceStatus, linkStatus=linkStatus, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, logStorageHigh=logStorageHigh, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsMIBCompliance=bwsMIBCompliance, webCacheProtocol=webCacheProtocol, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped)
mibBuilder.exportSymbols("BWS-MIB", sslProxyTotalReq=sslProxyTotalReq, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheAddress=webCacheAddress, ipsHdrAclPort=ipsHdrAclPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, processCountHigh=processCountHigh, switchingToInlineMode=switchingToInlineMode, sslSrvrNumConn=sslSrvrNumConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheAddressType=webCacheAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, cpuFanSpeed=cpuFanSpeed, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsMIBConformance=bwsMIBConformance, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, freeMem=freeMem, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrNumConn=httpSrvrNumConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsTrapGroup=bwsTrapGroup, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsCompressionStatsTable=bwsCompressionStatsTable, raidDegrading=raidDegrading, systemLoad=systemLoad, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrPort=sslSrvrPort, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsHdrAclAddress=ipsHdrAclAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, tempCritical=tempCritical, memUtilization=memUtilization, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCPort=ipsRCPort, webCachePort=webCachePort, httpProxyActiveConn=httpProxyActiveConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyPort=sslProxyPort, sslProxyInBytes=sslProxyInBytes, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, switchingToBypassMode=switchingToBypassMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr)
