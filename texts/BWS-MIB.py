...
mibBuilder.exportSymbols("BWS-MIB", dataPathStatus=dataPathStatus, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyAddress=sslProxyAddress, sslProxyInBytes=sslProxyInBytes, sslProxyOutBytes=sslProxyOutBytes, sslProxyTotalReq=sslProxyTotalReq, httpSrvrAddress=httpSrvrAddress, httpProxyServerErr=httpProxyServerErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, currentFirmwareVersion=currentFirmwareVersion, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsCompressionStatsTable=bwsCompressionStatsTable, systemLoad=systemLoad, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, newAttackDefinitionInstalled=newAttackDefinitionInstalled, peerUp=peerUp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalMem=totalMem, webCacheLongHdrs=webCacheLongHdrs, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, smNumUserSessions=smNumUserSessions, totalServers=totalServers, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, memUtilization=memUtilization, httpProxyAddress=httpProxyAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, highAvailabilityStatus=highAvailabilityStatus, sslSrvrTotReqActive=sslSrvrTotReqActive, linkStatus=linkStatus, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCacheHits=webCacheHits, tempHigh=tempHigh, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrTotRefused=httpSrvrTotRefused, httpProxyServerReq=httpProxyServerReq, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, cpuUtilization=cpuUtilization, smAgentName=smAgentName, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, operationalMode=operationalMode, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyPort=httpProxyPort, bwsStatsGroup=bwsStatsGroup, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyErrPms=sslProxyErrPms, httpSrvrAvgResTime=httpSrvrAvgResTime, PYSNMP_MODULE_ID=bws, ipsHdrAclPort=ipsHdrAclPort, httpSrvrInBytes=httpSrvrInBytes, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, servicePort=servicePort, webCachePort=webCachePort, serviceName=serviceName, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, switchingToInlineMode=switchingToInlineMode, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyActiveConn=sslProxyActiveConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, systemSerialNumber=systemSerialNumber, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, systemFailOver=systemFailOver, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsRCAddressType=ipsRCAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, processCountHigh=processCountHigh, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, activeServers=activeServers, httpSrvrPort=httpSrvrPort, httpSrvrState=httpSrvrState, totalBandwidth=totalBandwidth, cpuTemperature=cpuTemperature, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCmprAddress=webCmprAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclPort=ipsUrlAclPort, ipsUrlAclAddress=ipsUrlAclAddress, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheAddress=webCacheAddress, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, logStorageHigh=logStorageHigh, serverUp=serverUp, serviceAddress=serviceAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyPort=sslProxyPort, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyParseErr=httpProxyParseErr, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, totalApplications=totalApplications, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyActiveConn=httpProxyActiveConn, raidDegrading=raidDegrading, activeApplications=activeApplications, securityDefUpdates=securityDefUpdates, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, vipStatus=vipStatus, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, virusDefUpdates=virusDefUpdates, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrMinResTime=httpSrvrMinResTime, webCacheProtocol=webCacheProtocol, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyOutBytes=httpProxyOutBytes, webCacheCacheableRes=webCacheCacheableRes, sslProxyAddressType=sslProxyAddressType, webCmprAddressType=webCmprAddressType, sslSrvrInBytes=sslSrvrInBytes, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheMiss=webCacheMiss, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, smRealmName=smRealmName, bwsMIBCompliance=bwsMIBCompliance, ipsReqLimitAddress=ipsReqLimitAddress, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprProtocol=webCmprProtocol, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecPort=ipsCookieSecPort, httpProxyInBytes=httpProxyInBytes, webCacheReq=webCacheReq, srvcName=srvcName, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrOutBytes=httpSrvrOutBytes, firmwareStorageHigh=firmwareStorageHigh, ipsRCTotServed=ipsRCTotServed, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, cpuFanSpeed=cpuFanSpeed, bwsStats=bwsStats, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, freeMem=freeMem, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, energizeUpdateExpire=energizeUpdateExpire, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsTrapGroup=bwsTrapGroup, webCacheStale=webCacheStale, bwsMIBGroups=bwsMIBGroups, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCacheAddressType=webCacheAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyTotalConn=sslProxyTotalConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCmprPort=webCmprPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, serverDown=serverDown, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormPort=ipsUrlNormPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrNumConn=sslSrvrNumConn, fanDead=fanDead, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlNormAddressType=ipsUrlNormAddressType, memoryUsageHigh=memoryUsageHigh, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrState=sslSrvrState, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlNormAddress=ipsUrlNormAddress, bws=bws, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, firmwareStorage=firmwareStorage, sslProxyCacheHits=sslProxyCacheHits, bwsMessage=bwsMessage, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, totalAttacks=totalAttacks, systemFanSpeed=systemFanSpeed, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrAddressType=sslSrvrAddressType, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsRCPort=ipsRCPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrAddress=sslSrvrAddress, httpProxyTotalConn=httpProxyTotalConn, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheBytesOut=webCacheBytesOut, systemFailure=systemFailure, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, peerDown=peerDown, tempCritical=tempCritical, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrAddressType=httpSrvrAddressType, ipsRCAddress=ipsRCAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqSrvcPort=ipsReqSrvcPort, logStorage=logStorage, sslSrvrSrvcPort=sslSrvrSrvcPort, switchingToMaintMode=switchingToMaintMode, bwstraps=bwstraps, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrTotResponse=httpSrvrTotResponse, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, dataPortLinkDown=dataPortLinkDown, ipsReqLimitPort=ipsReqLimitPort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, switchingToBypassMode=switchingToBypassMode, ipsRCTotDropped=ipsRCTotDropped, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsMIBConformance=bwsMIBConformance, sslProxyCacheMiss=sslProxyCacheMiss, serviceStatus=serviceStatus, webCacheCachedObjects=webCacheCachedObjects, sslSrvrPort=sslSrvrPort, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyAddressType=httpProxyAddressType, uptime=uptime, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten)
