...
Unsigned32, Bits, Counter32, iso, TimeTicks, ObjectIdentity, Counter64, ModuleIdentity, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "Counter32", "iso", "TimeTicks", "ObjectIdentity", "Counter64", "ModuleIdentity", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", serviceAddress=serviceAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, peerDown=peerDown, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrState=httpSrvrState, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, logStorageHigh=logStorageHigh, securityDefUpdates=securityDefUpdates, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, systemSerialNumber=systemSerialNumber, httpSrvrMinResTime=httpSrvrMinResTime, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyServerReq=httpProxyServerReq, ipsReqLimitAddress=ipsReqLimitAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMIBConformance=bwsMIBConformance, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCacheCacheableRes=webCacheCacheableRes, httpSrvrInBytes=httpSrvrInBytes, sslSrvrAddressType=sslSrvrAddressType, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyServerErr=httpProxyServerErr, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCacheReq=webCacheReq, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serverUp=serverUp, tempHigh=tempHigh, webCmprPort=webCmprPort, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqLimitPort=ipsReqLimitPort, systemFailure=systemFailure, httpProxyOutBytes=httpProxyOutBytes, ipsRCTotServed=ipsRCTotServed, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, srvcName=srvcName, uptime=uptime, bwsServiceStatusTable=bwsServiceStatusTable, ipsHdrAclHits=ipsHdrAclHits, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, virusDefUpdates=virusDefUpdates, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrInBytes=sslSrvrInBytes, bwsStats=bwsStats, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlNormPort=ipsUrlNormPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, totalServers=totalServers, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsRCTotOutOfResource=ipsRCTotOutOfResource, vipStatus=vipStatus, sslSrvrMaxResTime=sslSrvrMaxResTime, totalBandwidth=totalBandwidth, webCmprAddress=webCmprAddress, systemFanSpeed=systemFanSpeed, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, freeMem=freeMem, smAgentName=smAgentName, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, servicePort=servicePort, firmwareStorage=firmwareStorage, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrTotResponse=sslSrvrTotResponse, smRealmName=smRealmName, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCTotQueued=ipsRCTotQueued, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, switchingToInlineMode=switchingToInlineMode, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, serviceName=serviceName, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyAddressType=httpProxyAddressType, firmwareStorageHigh=firmwareStorageHigh, ipsHdrAclPort=ipsHdrAclPort, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsMIBCompliance=bwsMIBCompliance, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyCurrentConn=sslProxyCurrentConn, totalApplications=totalApplications, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, serviceStatus=serviceStatus, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrNumConn=httpSrvrNumConn, switchingToMaintMode=switchingToMaintMode, ipsCookieSecAddressType=ipsCookieSecAddressType, dataPathStatus=dataPathStatus, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, cpuFanSpeed=cpuFanSpeed, sslProxyPort=sslProxyPort, totalMem=totalMem, bwsTrapGroup=bwsTrapGroup, ipsHdrAclAddressType=ipsHdrAclAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bws=bws, systemFailOver=systemFailOver, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrAvgResTime=sslSrvrAvgResTime, webCmprCompressedDataSize=webCmprCompressedDataSize, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyAddressType=sslProxyAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheMiss=webCacheMiss, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrMinResTime=sslSrvrMinResTime, webCacheBytesOut=webCacheBytesOut, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, systemLoad=systemLoad, webCacheLongHdrs=webCacheLongHdrs, httpSrvrAddress=httpSrvrAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCachePort=webCachePort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyInBytes=sslProxyInBytes, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, linkStatus=linkStatus, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrPort=httpSrvrPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsMessage=bwsMessage, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclPort=ipsUrlAclPort, httpProxyInBytes=httpProxyInBytes, webCacheAddress=webCacheAddress, sslSrvrNumConn=sslSrvrNumConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, fanDead=fanDead, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyParseErr=httpProxyParseErr, bwsMIBGroups=bwsMIBGroups, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, operationalMode=operationalMode, activeApplications=activeApplications, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, logStorage=logStorage, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyPort=httpProxyPort, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, cpuUtilization=cpuUtilization, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsSMUserSessionTable=bwsSMUserSessionTable, dataPortLinkDown=dataPortLinkDown, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheAddressType=webCacheAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrOutBytes=httpSrvrOutBytes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsMIBCompliances=bwsMIBCompliances, bwsStatsGroup=bwsStatsGroup, ipsReqSrvcPort=ipsReqSrvcPort, webCacheHits=webCacheHits, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsRCTotDropped=ipsRCTotDropped, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCmprProtocol=webCmprProtocol, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable)
mibBuilder.exportSymbols("BWS-MIB", webCacheStale=webCacheStale, sslProxyCacheHits=sslProxyCacheHits, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sharedSecretKeyExpired=sharedSecretKeyExpired, tempCritical=tempCritical, webCmprAddressType=webCmprAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyOutBytes=sslProxyOutBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyTotalReq=httpProxyTotalReq, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyTotalReq=sslProxyTotalReq, totalAttacks=totalAttacks, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, raidDegrading=raidDegrading, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, peerUp=peerUp, sslSrvrAddress=sslSrvrAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, webCacheProtocol=webCacheProtocol, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, activeServers=activeServers, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyErrPms=sslProxyErrPms, httpSrvrTotResponse=httpSrvrTotResponse, smNumUserSessions=smNumUserSessions, httpProxyAddress=httpProxyAddress, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheCachedObjects=webCacheCachedObjects, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrState=sslSrvrState, dataPortLinkUp=dataPortLinkUp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, cpuTemperature=cpuTemperature, sslSrvrPort=sslSrvrPort, switchingToBypassMode=switchingToBypassMode, highAvailabilityStatus=highAvailabilityStatus, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, PYSNMP_MODULE_ID=bws, memUtilization=memUtilization, processCountHigh=processCountHigh, ipsRCAddress=ipsRCAddress, serverDown=serverDown, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsRCPort=ipsRCPort, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, energizeUpdateExpire=energizeUpdateExpire, ipsHdrAclAddress=ipsHdrAclAddress, bwstraps=bwstraps, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyAddress=sslProxyAddress)
