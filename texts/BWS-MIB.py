...
NotificationType, iso, TimeTicks, Counter64, Counter32, Integer32, Bits, Unsigned32, Gauge32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "TimeTicks", "Counter64", "Counter32", "Integer32", "Bits", "Unsigned32", "Gauge32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, activeServers=activeServers, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyInBytes=httpProxyInBytes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, tempHigh=tempHigh, freeMem=freeMem, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, fanDead=fanDead, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyAddressType=sslProxyAddressType, sslSrvrNumConn=sslSrvrNumConn, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitPort=ipsReqLimitPort, httpProxyServerErr=httpProxyServerErr, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrOutBytes=sslSrvrOutBytes, webCacheCacheableRes=webCacheCacheableRes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsStats=bwsStats, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, switchingToInlineMode=switchingToInlineMode, sslProxyOutBytes=sslProxyOutBytes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, processCountHigh=processCountHigh, ipsReqLimitAddressType=ipsReqLimitAddressType, smAgentName=smAgentName, firmwareStorage=firmwareStorage, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrState=httpSrvrState, bwsCompressionStatsTable=bwsCompressionStatsTable, webCachePort=webCachePort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrAddress=httpSrvrAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, virusDefUpdates=virusDefUpdates, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrAddress=sslSrvrAddress, dataPortLinkUp=dataPortLinkUp, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCTotServed=ipsRCTotServed, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrInBytes=httpSrvrInBytes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, srvcName=srvcName, sslSrvrPort=sslSrvrPort, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, dataPathStatus=dataPathStatus, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyErrPms=sslProxyErrPms, totalAttacks=totalAttacks, smNumUserSessions=smNumUserSessions, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsMIBCompliances=bwsMIBCompliances, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsServiceStatusTable=bwsServiceStatusTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrInBytes=sslSrvrInBytes, bwsMIBCompliance=bwsMIBCompliance, PYSNMP_MODULE_ID=bws, totalMem=totalMem, ipsHdrAclAddressType=ipsHdrAclAddressType, operationalMode=operationalMode, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, vipStatus=vipStatus, webCacheReq=webCacheReq, ipsCookieSecAddress=ipsCookieSecAddress, webCmprAddressType=webCmprAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, linkStatus=linkStatus, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, memUtilization=memUtilization, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyParseErr=httpProxyParseErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, totalBandwidth=totalBandwidth, ipsAccessCtrlAddress=ipsAccessCtrlAddress, raidDegrading=raidDegrading, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalServers=totalServers, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyCurrentConn=sslProxyCurrentConn, memoryUsageHigh=memoryUsageHigh, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsRCPort=ipsRCPort, servicePort=servicePort, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlAclPort=ipsUrlAclPort, bwstraps=bwstraps, securityDefUpdates=securityDefUpdates, webCacheAddressType=webCacheAddressType, serviceStatus=serviceStatus, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheBytesOut=webCacheBytesOut, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, systemLoad=systemLoad, httpProxyTotalReq=httpProxyTotalReq, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsTrapGroup=bwsTrapGroup, sslProxyBadDNCErr=sslProxyBadDNCErr, totalApplications=totalApplications, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsStatsGroup=bwsStatsGroup, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyAddressType=httpProxyAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheAddress=webCacheAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsHdrAclAddress=ipsHdrAclAddress, peerDown=peerDown, systemSerialNumber=systemSerialNumber, sslSrvrAddressType=sslSrvrAddressType, uptime=uptime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyInBytes=sslProxyInBytes, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrState=sslSrvrState, switchingToMaintMode=switchingToMaintMode, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyServerReq=httpProxyServerReq, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsMIBGroups=bwsMIBGroups, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyActiveConn=sslProxyActiveConn, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, systemFailOver=systemFailOver, ipsUrlNormPort=ipsUrlNormPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyAddress=sslProxyAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsMIBConformance=bwsMIBConformance, ipsHdrAclHits=ipsHdrAclHits, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrMinResTime=httpSrvrMinResTime, systemFanSpeed=systemFanSpeed, switchingToBypassMode=switchingToBypassMode, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxySessionTimeOut=httpProxySessionTimeOut, webCmprAddress=webCmprAddress, ipsRCTotDropped=ipsRCTotDropped, serverUp=serverUp, cpuTemperature=cpuTemperature, webCmprCompressedDataSize=webCmprCompressedDataSize, cpuFanSpeed=cpuFanSpeed, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecPort=ipsCookieSecPort, energizeUpdateExpire=energizeUpdateExpire, serviceAddress=serviceAddress, tempCritical=tempCritical, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsRCAddress=ipsRCAddress, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, webCacheHits=webCacheHits, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyTotalConn=sslProxyTotalConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, logStorage=logStorage, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyPort=sslProxyPort, ipsRCTotQueued=ipsRCTotQueued)
mibBuilder.exportSymbols("BWS-MIB", attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, serviceName=serviceName, ipsReqLimitAddress=ipsReqLimitAddress, peerUp=peerUp, dataPortLinkDown=dataPortLinkDown, webCacheLongHdrs=webCacheLongHdrs, cpuUtilization=cpuUtilization, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, logStorageHigh=logStorageHigh, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCAddressType=ipsRCAddressType, serverDown=serverDown, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCmprProtocol=webCmprProtocol, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyTotalConn=httpProxyTotalConn, httpProxyPort=httpProxyPort, webCacheCachedObjects=webCacheCachedObjects, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrPort=httpSrvrPort, httpProxyAddress=httpProxyAddress, sslProxyCacheHits=sslProxyCacheHits, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCmprPort=webCmprPort, bws=bws, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, webCacheMiss=webCacheMiss, httpSrvrNumConn=httpSrvrNumConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMessage=bwsMessage, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, currentFirmwareVersion=currentFirmwareVersion, smRealmName=smRealmName, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, activeApplications=activeApplications, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrTotRefused=httpSrvrTotRefused, highAvailabilityStatus=highAvailabilityStatus, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheProtocol=webCacheProtocol, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlAclReserved=ipsUrlAclReserved, webCacheStale=webCacheStale, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, systemFailure=systemFailure)
