...
Unsigned32, Counter64, Counter32, MibIdentifier, NotificationType, iso, Integer32, IpAddress, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "Counter32", "MibIdentifier", "NotificationType", "iso", "Integer32", "IpAddress", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, systemFailOver=systemFailOver, sslProxyTotalConn=sslProxyTotalConn, highAvailabilityStatus=highAvailabilityStatus, sslProxyActiveConn=sslProxyActiveConn, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, servicePort=servicePort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclPort=ipsHdrAclPort, systemLoad=systemLoad, sslProxyAddress=sslProxyAddress, virusDefUpdates=virusDefUpdates, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqSrvcPort=ipsReqSrvcPort, webCacheLongHdrs=webCacheLongHdrs, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, logStorage=logStorage, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCmprPort=webCmprPort, systemSerialNumber=systemSerialNumber, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrState=sslSrvrState, firmwareStorageHigh=firmwareStorageHigh, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrAddressType=httpSrvrAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, dataPortLinkDown=dataPortLinkDown, bwsCacheStatsEntry=bwsCacheStatsEntry, bwstraps=bwstraps, switchingToMaintMode=switchingToMaintMode, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, activeApplications=activeApplications, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrPort=sslSrvrPort, httpProxyActiveConn=httpProxyActiveConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrNumConn=httpSrvrNumConn, uptime=uptime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqLimitPort=ipsReqLimitPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, systemFailure=systemFailure, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsWebAddrTransAddress=ipsWebAddrTransAddress, cpuUtilization=cpuUtilization, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serviceStatus=serviceStatus, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheHits=webCacheHits, webCacheCachedObjects=webCacheCachedObjects, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheAddress=webCacheAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, firmwareStorage=firmwareStorage, currentFirmwareVersion=currentFirmwareVersion, smRealmName=smRealmName, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsRCTotDropped=ipsRCTotDropped, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyBadCRLErr=sslProxyBadCRLErr, totalAttacks=totalAttacks, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyTotalReq=httpProxyTotalReq, httpProxyOutBytes=httpProxyOutBytes, httpSrvrPort=httpSrvrPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyTotalConn=httpProxyTotalConn, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsMessage=bwsMessage, securityDefUpdates=securityDefUpdates, ipsUrlNormPort=ipsUrlNormPort, fanDead=fanDead, ipsRCAddress=ipsRCAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcAddress=ipsReqSrvcAddress, serverDown=serverDown, bwsMIBCompliances=bwsMIBCompliances, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, systemFanSpeed=systemFanSpeed, webCmprAddress=webCmprAddress, webCacheProtocol=webCacheProtocol, freeMem=freeMem, httpProxyParseErr=httpProxyParseErr, memUtilization=memUtilization, dataPortLinkUp=dataPortLinkUp, httpProxyAddress=httpProxyAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheCacheableRes=webCacheCacheableRes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyInBytes=httpProxyInBytes, ipsHdrAclHits=ipsHdrAclHits, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, vipStatus=vipStatus, tempHigh=tempHigh, bwsStats=bwsStats, ipsUrlAclPort=ipsUrlAclPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsCookieSecTampered=ipsCookieSecTampered, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrTotRefused=sslSrvrTotRefused, webCacheAddressType=webCacheAddressType, PYSNMP_MODULE_ID=bws, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheBytesOut=webCacheBytesOut, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, totalServers=totalServers, sslProxyOutBytes=sslProxyOutBytes, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, smNumUserSessions=smNumUserSessions, bwsMIBGroups=bwsMIBGroups, bwsMIBCompliance=bwsMIBCompliance, ipsRCTotServed=ipsRCTotServed, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrAddress=httpSrvrAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, dataPathStatus=dataPathStatus, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, totalApplications=totalApplications, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, cpuTemperature=cpuTemperature, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, linkStatus=linkStatus, ipsLrnSrvcPort=ipsLrnSrvcPort, webCachePort=webCachePort, smAgentName=smAgentName, switchingToInlineMode=switchingToInlineMode, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrInBytes=sslSrvrInBytes, ipsRCAddressType=ipsRCAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrNumConn=sslSrvrNumConn, activeServers=activeServers, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyPort=sslProxyPort, raidDegrading=raidDegrading, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, serviceAddress=serviceAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, serviceName=serviceName, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheReq=webCacheReq, bws=bws, sslSrvrOutBytes=sslSrvrOutBytes, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyErrPms=sslProxyErrPms, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyCacheMiss=sslProxyCacheMiss, logStorageHigh=logStorageHigh, switchingToBypassMode=switchingToBypassMode, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyPort=httpProxyPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyServerErr=httpProxyServerErr, bwsTrapGroup=bwsTrapGroup, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrAddress=sslSrvrAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrInBytes=httpSrvrInBytes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, serverUp=serverUp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrMinResTime=sslSrvrMinResTime, webCmprAddressType=webCmprAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, operationalMode=operationalMode, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlNormAddress=ipsUrlNormAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable)
mibBuilder.exportSymbols("BWS-MIB", totalMem=totalMem, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, tempCritical=tempCritical, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyTotalReq=sslProxyTotalReq, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrTotSuccess=sslSrvrTotSuccess, totalBandwidth=totalBandwidth, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, peerUp=peerUp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsRCPort=ipsRCPort, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecPort=ipsCookieSecPort, httpProxyServerReq=httpProxyServerReq, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, peerDown=peerDown, bwsMIBConformance=bwsMIBConformance, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCacheStale=webCacheStale, webCmprCompressibleDataSize=webCmprCompressibleDataSize, energizeUpdateExpire=energizeUpdateExpire, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, memoryUsageHigh=memoryUsageHigh, httpSrvrState=httpSrvrState, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrAvgResTime=httpSrvrAvgResTime, processCountHigh=processCountHigh, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyInBytes=sslProxyInBytes, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyAddressType=httpProxyAddressType, cpuFanSpeed=cpuFanSpeed, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyAddressType=sslProxyAddressType, webCacheMiss=webCacheMiss, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, srvcName=srvcName)
