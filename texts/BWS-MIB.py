...
TimeTicks, Counter32, NotificationType, Bits, IpAddress, ObjectIdentity, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Unsigned32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "NotificationType", "Bits", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Unsigned32", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, processCountHigh=processCountHigh, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, totalApplications=totalApplications, servicePort=servicePort, bwsStatsGroup=bwsStatsGroup, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCTotServed=ipsRCTotServed, httpSrvrPort=httpSrvrPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsMessage=bwsMessage, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrInBytes=sslSrvrInBytes, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, freeMem=freeMem, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, vipStatus=vipStatus, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, switchingToMaintMode=switchingToMaintMode, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, switchingToInlineMode=switchingToInlineMode, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsTrapGroup=bwsTrapGroup, sslProxyInBytes=sslProxyInBytes, logStorageHigh=logStorageHigh, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlAclPort=ipsUrlAclPort, bws=bws, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyAddress=httpProxyAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsMIBCompliances=bwsMIBCompliances, webCacheAddressType=webCacheAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrTotReqRejected=sslSrvrTotReqRejected, systemLoad=systemLoad, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, cpuUtilization=cpuUtilization, httpProxyParseErr=httpProxyParseErr, httpProxyPort=httpProxyPort, webCmprAddress=webCmprAddress, totalBandwidth=totalBandwidth, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyServerReq=httpProxyServerReq, sslProxyErrPms=sslProxyErrPms, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyTotalReq=httpProxyTotalReq, systemSerialNumber=systemSerialNumber, operationalMode=operationalMode, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyInBytes=httpProxyInBytes, srvcName=srvcName, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumConn=httpSrvrNumConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlNormPort=ipsUrlNormPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyAddressType=sslProxyAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, securityDefUpdates=securityDefUpdates, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsRCAddressType=ipsRCAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsCookieSecAddress=ipsCookieSecAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCmprProtocol=webCmprProtocol, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheAddress=webCacheAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsMIBCompliance=bwsMIBCompliance, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheProtocol=webCacheProtocol, serverDown=serverDown, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrNumConn=sslSrvrNumConn, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsRCTotDropped=ipsRCTotDropped, sslProxyTotalConn=sslProxyTotalConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, raidDegrading=raidDegrading, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, serviceName=serviceName, webCacheHits=webCacheHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsStats=bwsStats, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, webCacheCacheableRes=webCacheCacheableRes, webCacheBytesOut=webCacheBytesOut, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyFullHandshakes=sslProxyFullHandshakes, serverUp=serverUp, linkStatus=linkStatus, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwstraps=bwstraps, energizeUpdateExpire=energizeUpdateExpire, bwsMIBConformance=bwsMIBConformance, httpProxyTotalConn=httpProxyTotalConn, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyPort=sslProxyPort, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCmprPort=webCmprPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, memUtilization=memUtilization, smAgentName=smAgentName, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqSrvcPort=ipsReqSrvcPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, tempCritical=tempCritical, activeServers=activeServers, sslProxyAddress=sslProxyAddress, ipsCookieSecTampered=ipsCookieSecTampered, logStorage=logStorage, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyActiveConn=sslProxyActiveConn, httpProxyServerErr=httpProxyServerErr, totalMem=totalMem, ipsRCTotQueued=ipsRCTotQueued, virusDefUpdates=virusDefUpdates, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrAvgResTime=sslSrvrAvgResTime, totalServers=totalServers, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrPort=sslSrvrPort, highAvailabilityStatus=highAvailabilityStatus, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrAddressType=httpSrvrAddressType, PYSNMP_MODULE_ID=bws, webCacheReq=webCacheReq, activeApplications=activeApplications, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCAddress=ipsRCAddress, peerUp=peerUp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, smRealmName=smRealmName, sslProxyCacheHits=sslProxyCacheHits, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, serviceStatus=serviceStatus, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecPort=ipsCookieSecPort, systemFailOver=systemFailOver, bwsMIBGroups=bwsMIBGroups, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, uptime=uptime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, firmwareStorage=firmwareStorage, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitPort=ipsReqLimitPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, dataPathStatus=dataPathStatus, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclPort=ipsHdrAclPort, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrOutBytes=httpSrvrOutBytes, switchingToBypassMode=switchingToBypassMode, httpProxyActiveConn=httpProxyActiveConn, systemFailure=systemFailure, webCacheStale=webCacheStale, webCmprAddressType=webCmprAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, tempHigh=tempHigh, cpuTemperature=cpuTemperature, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions)
mibBuilder.exportSymbols("BWS-MIB", fanDead=fanDead, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrAddressType=sslSrvrAddressType, systemFanSpeed=systemFanSpeed, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrAddress=sslSrvrAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyAddressType=httpProxyAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsRCPort=ipsRCPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, smNumUserSessions=smNumUserSessions, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, dataPortLinkDown=dataPortLinkDown, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, dataPortLinkUp=dataPortLinkUp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrAddress=httpSrvrAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyOutBytes=httpProxyOutBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, totalAttacks=totalAttacks, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCacheMiss=webCacheMiss, firmwareStorageHigh=firmwareStorageHigh, webCachePort=webCachePort, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrState=httpSrvrState, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclHits=ipsHdrAclHits, ipsUrlAclAddress=ipsUrlAclAddress, serviceAddress=serviceAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrState=sslSrvrState, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheCachedObjects=webCacheCachedObjects, sslProxyTotalReq=sslProxyTotalReq, peerDown=peerDown, sslSrvrMaxResTime=sslSrvrMaxResTime, cpuFanSpeed=cpuFanSpeed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, currentFirmwareVersion=currentFirmwareVersion)
