...
NotificationType, Gauge32, Unsigned32, MibIdentifier, Bits, Counter32, iso, Counter64, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Unsigned32", "MibIdentifier", "Bits", "Counter32", "iso", "Counter64", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsMessage=bwsMessage, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlAclAddress=ipsUrlAclAddress, smNumUserSessions=smNumUserSessions, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrAddressType=sslSrvrAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, PYSNMP_MODULE_ID=bws, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheReq=webCacheReq, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCTimeStamp=ipsRCTimeStamp, ipsRCTotDropped=ipsRCTotDropped, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlAclAddressType=ipsUrlAclAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, tempCritical=tempCritical, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyCacheHits=sslProxyCacheHits, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrOutBytes=httpSrvrOutBytes, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsStats=bwsStats, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyPort=sslProxyPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheLongHdrs=webCacheLongHdrs, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlAclPort=ipsUrlAclPort, httpProxyAddressType=httpProxyAddressType, httpSrvrTotResponse=httpSrvrTotResponse, bwstraps=bwstraps, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecAddress=ipsCookieSecAddress, tempHigh=tempHigh, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitAddress=ipsReqLimitAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, cpuUtilization=cpuUtilization, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrInBytes=sslSrvrInBytes, httpSrvrPort=httpSrvrPort, switchingToInlineMode=switchingToInlineMode, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyActiveConn=httpProxyActiveConn, httpProxyTotalReq=httpProxyTotalReq, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, uptime=uptime, ipsHdrAclAddressType=ipsHdrAclAddressType, totalMem=totalMem, linkStatus=linkStatus, httpSrvrInBytes=httpSrvrInBytes, highAvailabilityStatus=highAvailabilityStatus, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, currentFirmwareVersion=currentFirmwareVersion, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, systemFanSpeed=systemFanSpeed, ipsUrlNormPort=ipsUrlNormPort, webCacheAddress=webCacheAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyInBytes=httpProxyInBytes, webCacheCachedObjects=webCacheCachedObjects, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, memoryUsageHigh=memoryUsageHigh, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, serviceAddress=serviceAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, processCountHigh=processCountHigh, ipsAccessCtrlAddress=ipsAccessCtrlAddress, raidDegrading=raidDegrading, httpSrvrNumConn=httpSrvrNumConn, securityDefUpdates=securityDefUpdates, sslSrvrPort=sslSrvrPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, energizeUpdateExpire=energizeUpdateExpire, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsHdrAclAddress=ipsHdrAclAddress, activeServers=activeServers, totalBandwidth=totalBandwidth, webCacheBytesOut=webCacheBytesOut, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyAddress=sslProxyAddress, dataPathStatus=dataPathStatus, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyServerReq=httpProxyServerReq, sslSrvrSrvcPort=sslSrvrSrvcPort, systemFailure=systemFailure, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, firmwareStorage=firmwareStorage, ipsWebAddrTransPort=ipsWebAddrTransPort, smAgentName=smAgentName, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, serverUp=serverUp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyOutBytes=sslProxyOutBytes, bwsStatsGroup=bwsStatsGroup, sslProxyInBytes=sslProxyInBytes, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyParseErr=httpProxyParseErr, bwsMIBGroups=bwsMIBGroups, ipsRCAddressType=ipsRCAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, totalAttacks=totalAttacks, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheAddressType=webCacheAddressType, sslSrvrAddress=sslSrvrAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyServerAbrt=httpProxyServerAbrt, webCacheProtocol=webCacheProtocol, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bws=bws, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyOutBytes=httpProxyOutBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, activeApplications=activeApplications, virusDefUpdates=virusDefUpdates, ipsRCTotQueued=ipsRCTotQueued, webCacheHits=webCacheHits, srvcName=srvcName, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, servicePort=servicePort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrState=sslSrvrState, ipsRCTotServed=ipsRCTotServed, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyTotalConn=sslProxyTotalConn, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsMIBCompliance=bwsMIBCompliance, bwsTrapGroup=bwsTrapGroup, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, logStorageHigh=logStorageHigh, vipStatus=vipStatus, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, systemFailOver=systemFailOver, systemLoad=systemLoad, httpSrvrTotTimedout=httpSrvrTotTimedout, firmwareStorageHigh=firmwareStorageHigh, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotRefused=httpSrvrTotRefused, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, totalApplications=totalApplications, httpSrvrAddressType=httpSrvrAddressType, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, peerDown=peerDown, peerUp=peerUp, ipsReqLimitPort=ipsReqLimitPort, webCmprAddress=webCmprAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyPort=httpProxyPort, webCacheMiss=webCacheMiss, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsHdrAclHits=ipsHdrAclHits, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrState=httpSrvrState, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, systemSerialNumber=systemSerialNumber, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCPort=ipsRCPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, serviceStatus=serviceStatus, httpProxyAddress=httpProxyAddress, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyAddressType=sslProxyAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, switchingToMaintMode=switchingToMaintMode)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumFreeConn=sslSrvrNumFreeConn, smRealmName=smRealmName, memUtilization=memUtilization, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheStale=webCacheStale, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyTotalReq=sslProxyTotalReq, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyErrPms=sslProxyErrPms, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCachePort=webCachePort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, cpuFanSpeed=cpuFanSpeed, httpProxyTotalConn=httpProxyTotalConn, ipsRCAddress=ipsRCAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, logStorage=logStorage, dataPortLinkDown=dataPortLinkDown, serverDown=serverDown, webCmprProtocol=webCmprProtocol, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitAddressType=ipsReqLimitAddressType, freeMem=freeMem, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, fanDead=fanDead, serviceName=serviceName, totalServers=totalServers, httpProxyClientAbrt=httpProxyClientAbrt, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyFullHandshakes=sslProxyFullHandshakes, operationalMode=operationalMode, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrAddress=httpSrvrAddress, bwsServiceStatusTable=bwsServiceStatusTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrNumConn=sslSrvrNumConn, cpuTemperature=cpuTemperature, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, dataPortLinkUp=dataPortLinkUp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCmprAddressType=webCmprAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCmprPort=webCmprPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry)
