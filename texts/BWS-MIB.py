...
Counter32, Gauge32, Counter64, MibIdentifier, Bits, TimeTicks, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ModuleIdentity, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "Counter64", "MibIdentifier", "Bits", "TimeTicks", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ModuleIdentity", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", memoryUsageHigh=memoryUsageHigh, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsStats=bwsStats, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlNormAddress=ipsUrlNormAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyAddressType=sslProxyAddressType, firmwareStorageHigh=firmwareStorageHigh, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyTotalReq=sslProxyTotalReq, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, logStorage=logStorage, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyServerErr=httpProxyServerErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, smAgentName=smAgentName, uptime=uptime, webCacheReq=webCacheReq, currentFirmwareVersion=currentFirmwareVersion, totalApplications=totalApplications, sslProxyAddress=sslProxyAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, totalMem=totalMem, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCTotQueued=ipsRCTotQueued, totalBandwidth=totalBandwidth, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrOutBytes=httpSrvrOutBytes, serviceAddress=serviceAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, tempHigh=tempHigh, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrInBytes=httpSrvrInBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyOutBytes=sslProxyOutBytes, systemSerialNumber=systemSerialNumber, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, totalAttacks=totalAttacks, bwsCacheStatsTable=bwsCacheStatsTable, highAvailabilityStatus=highAvailabilityStatus, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrMinResTime=sslSrvrMinResTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprAddress=webCmprAddress, freeMem=freeMem, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, systemLoad=systemLoad, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrAddressType=sslSrvrAddressType, httpSrvrAddress=httpSrvrAddress, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, linkStatus=linkStatus, dataPortLinkDown=dataPortLinkDown, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, systemFailure=systemFailure, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsCookieSecPort=ipsCookieSecPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, peerDown=peerDown, peerUp=peerUp, webCacheAddress=webCacheAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, PYSNMP_MODULE_ID=bws, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, serviceName=serviceName, httpSrvrTotReqRejected=httpSrvrTotReqRejected, tempCritical=tempCritical, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, switchingToMaintMode=switchingToMaintMode, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, servicePort=servicePort, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsServiceStatusTable=bwsServiceStatusTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, systemFailOver=systemFailOver, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyActiveConn=httpProxyActiveConn, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsRCAddress=ipsRCAddress, bwsMIBConformance=bwsMIBConformance, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsMIBGroups=bwsMIBGroups, fanDead=fanDead, webCacheLongHdrs=webCacheLongHdrs, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsMIBCompliance=bwsMIBCompliance, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCacheAddressType=webCacheAddressType, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrPort=httpSrvrPort, webCachePort=webCachePort, sslSrvrNumConn=sslSrvrNumConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheStale=webCacheStale, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrAddressType=httpSrvrAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, vipStatus=vipStatus, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrNumConn=httpSrvrNumConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, firmwareStorage=firmwareStorage, ipsUrlAclPort=ipsUrlAclPort, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrAddress=sslSrvrAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCAddressType=ipsRCAddressType, webCacheProtocol=webCacheProtocol, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrPort=sslSrvrPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, totalServers=totalServers, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyActiveConn=sslProxyActiveConn, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyAddress=httpProxyAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyTotalReq=httpProxyTotalReq, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, energizeUpdateExpire=energizeUpdateExpire, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, cpuUtilization=cpuUtilization, activeApplications=activeApplications, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsRCTotServed=ipsRCTotServed, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyOutBytes=httpProxyOutBytes, sslProxyErrPms=sslProxyErrPms, virusDefUpdates=virusDefUpdates, httpProxyParseErr=httpProxyParseErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCTotDropped=ipsRCTotDropped, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheBytesOut=webCacheBytesOut, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyAddressType=httpProxyAddressType, cpuTemperature=cpuTemperature, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCTimeStamp=ipsRCTimeStamp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyInBytes=httpProxyInBytes, processCountHigh=processCountHigh, webCmprProtocol=webCmprProtocol, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, serverDown=serverDown, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyServerReq=httpProxyServerReq, bwsMessage=bwsMessage, operationalMode=operationalMode, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, systemFanSpeed=systemFanSpeed, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, memUtilization=memUtilization, serverUp=serverUp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheHits=webCacheHits, bwsMIBCompliances=bwsMIBCompliances, sslProxyTotalConn=sslProxyTotalConn, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, smRealmName=smRealmName)
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsRCPort=ipsRCPort, activeServers=activeServers, webCmprAddressType=webCmprAddressType, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyPort=sslProxyPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyCacheHits=sslProxyCacheHits, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, smNumUserSessions=smNumUserSessions, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, dataPortLinkUp=dataPortLinkUp, httpSrvrState=httpSrvrState, srvcName=srvcName, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwstraps=bwstraps, serviceStatus=serviceStatus, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsTrapGroup=bwsTrapGroup, cpuFanSpeed=cpuFanSpeed, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormPort=ipsUrlNormPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCmprPort=webCmprPort, sslSrvrOutBytes=sslSrvrOutBytes, switchingToBypassMode=switchingToBypassMode, httpProxyPort=httpProxyPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, raidDegrading=raidDegrading, switchingToInlineMode=switchingToInlineMode, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheMiss=webCacheMiss, httpProxyTotalConn=httpProxyTotalConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, logStorageHigh=logStorageHigh, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bws=bws, sslSrvrState=sslSrvrState, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, securityDefUpdates=securityDefUpdates, ipsReqLimitPort=ipsReqLimitPort, dataPathStatus=dataPathStatus)
