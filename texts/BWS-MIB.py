...
Bits, ObjectIdentity, MibIdentifier, NotificationType, iso, Unsigned32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Counter64, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Counter64", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", currentFirmwareVersion=currentFirmwareVersion, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheReq=webCacheReq, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheProtocol=webCacheProtocol, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrNumConn=sslSrvrNumConn, bwsServiceStatusEntry=bwsServiceStatusEntry, systemFanSpeed=systemFanSpeed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsMIBCompliances=bwsMIBCompliances, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrMaxResTime=httpSrvrMaxResTime, cpuFanSpeed=cpuFanSpeed, linkStatus=linkStatus, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCacheAddress=webCacheAddress, smNumUserSessions=smNumUserSessions, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsCompressionStatsTable=bwsCompressionStatsTable, firmwareStorage=firmwareStorage, sslProxyTotalConn=sslProxyTotalConn, ipsRCAddress=ipsRCAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrAddress=sslSrvrAddress, webCmprAddress=webCmprAddress, activeApplications=activeApplications, firmwareStorageHigh=firmwareStorageHigh, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, PYSNMP_MODULE_ID=bws, logStorageHigh=logStorageHigh, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, totalAttacks=totalAttacks, logStorage=logStorage, httpProxyPort=httpProxyPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bws=bws, serviceStatus=serviceStatus, webCacheStale=webCacheStale, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyOutBytes=httpProxyOutBytes, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyOutBytes=sslProxyOutBytes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, serviceName=serviceName, webCmprProtocol=webCmprProtocol, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyErrPms=sslProxyErrPms, cpuTemperature=cpuTemperature, sslProxyActiveConn=sslProxyActiveConn, memUtilization=memUtilization, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyInBytes=httpProxyInBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheCacheableRes=webCacheCacheableRes, httpProxyAddressType=httpProxyAddressType, serverUp=serverUp, servicePort=servicePort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, smAgentName=smAgentName, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, systemSerialNumber=systemSerialNumber, bwsSslProxyStatsTable=bwsSslProxyStatsTable, raidDegrading=raidDegrading, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotReqRejected=sslSrvrTotReqRejected, tempCritical=tempCritical, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheAddressType=webCacheAddressType, dataPortLinkDown=dataPortLinkDown, totalServers=totalServers, httpProxyServerErr=httpProxyServerErr, energizeUpdateExpire=energizeUpdateExpire, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyPort=sslProxyPort, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrInBytes=sslSrvrInBytes, sslProxyInBytes=sslProxyInBytes, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyAddressType=sslProxyAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, totalMem=totalMem, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCachePort=webCachePort, httpSrvrAddressType=httpSrvrAddressType, freeMem=freeMem, systemFailOver=systemFailOver, ipsHdrAclPort=ipsHdrAclPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrOutBytes=httpSrvrOutBytes, activeServers=activeServers, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMessage=bwsMessage, bwsMIBCompliance=bwsMIBCompliance, sslSrvrMinResTime=sslSrvrMinResTime, bwstraps=bwstraps, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitPort=ipsReqLimitPort, httpProxyTotalReq=httpProxyTotalReq, dataPathStatus=dataPathStatus, httpSrvrNumConn=httpSrvrNumConn, httpProxyTotalConn=httpProxyTotalConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrAddressType=sslSrvrAddressType, webCacheCachedObjects=webCacheCachedObjects, sslProxyAddress=sslProxyAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, operationalMode=operationalMode, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, vipStatus=vipStatus, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitAddressType=ipsReqLimitAddressType, peerUp=peerUp, bwsStatsGroup=bwsStatsGroup, webCacheBytesOut=webCacheBytesOut, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyAddress=httpProxyAddress, smRealmName=smRealmName, ipsRCAddressType=ipsRCAddressType, dataPortLinkUp=dataPortLinkUp, httpSrvrState=httpSrvrState, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsStats=bwsStats, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, tempHigh=tempHigh, cpuUtilization=cpuUtilization, sslProxyTotalReq=sslProxyTotalReq, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, systemLoad=systemLoad, uptime=uptime, webCacheHits=webCacheHits, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsRCPort=ipsRCPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprAddressType=webCmprAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyServerReq=httpProxyServerReq, ipsHdrAclHits=ipsHdrAclHits, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclAddressType=ipsUrlAclAddressType, peerDown=peerDown, processCountHigh=processCountHigh, virusDefUpdates=virusDefUpdates, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCTotQueued=ipsRCTotQueued, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsCookieSecPort=ipsCookieSecPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrState=sslSrvrState, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, highAvailabilityStatus=highAvailabilityStatus, systemFailure=systemFailure, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlAclReserved=ipsUrlAclReserved, bwsServiceStatusTable=bwsServiceStatusTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcAddress=ipsLrnSrvcAddress, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrPort=sslSrvrPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, totalApplications=totalApplications, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrPort=httpSrvrPort, httpSrvrTotSuccess=httpSrvrTotSuccess, serviceAddress=serviceAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCmprPort=webCmprPort, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlAclPort=ipsUrlAclPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, srvcName=srvcName, switchingToMaintMode=switchingToMaintMode, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, serverDown=serverDown, bwsMIBConformance=bwsMIBConformance, totalBandwidth=totalBandwidth, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheMiss=webCacheMiss, fanDead=fanDead, httpProxyParseErr=httpProxyParseErr, ipsRCTotServed=ipsRCTotServed, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCTotDropped=ipsRCTotDropped, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrMinResTime=httpSrvrMinResTime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, memoryUsageHigh=memoryUsageHigh, bwsTrapGroup=bwsTrapGroup, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, switchingToInlineMode=switchingToInlineMode)
