...
mibBuilder.exportSymbols("BWS-MIB", bwsTrapGroup=bwsTrapGroup, processCountHigh=processCountHigh, httpSrvrTotTimedout=httpSrvrTotTimedout, operationalMode=operationalMode, switchingToMaintMode=switchingToMaintMode, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, systemFanSpeed=systemFanSpeed, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsHdrAclHits=ipsHdrAclHits, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, switchingToInlineMode=switchingToInlineMode, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyAddressType=sslProxyAddressType, raidDegrading=raidDegrading, bwsStats=bwsStats, tempHigh=tempHigh, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, serverUp=serverUp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrInBytes=sslSrvrInBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlAclAddress=ipsUrlAclAddress, webCacheBytesOut=webCacheBytesOut, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyServerReq=httpProxyServerReq, ipsRCTotServed=ipsRCTotServed, httpSrvrPort=httpSrvrPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, highAvailabilityStatus=highAvailabilityStatus, webCmprProtocol=webCmprProtocol, servicePort=servicePort, sslSrvrTotResponse=sslSrvrTotResponse, webCacheMiss=webCacheMiss, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, smAgentName=smAgentName, httpProxySessionTimeOut=httpProxySessionTimeOut, PYSNMP_MODULE_ID=bws, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, systemFailure=systemFailure, sslSrvrState=sslSrvrState, firmwareStorage=firmwareStorage, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, firmwareStorageHigh=firmwareStorageHigh, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsRCTotDropped=ipsRCTotDropped, freeMem=freeMem, peerDown=peerDown, httpSrvrAddress=httpSrvrAddress, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, serverDown=serverDown, ipsUrlAclAddressType=ipsUrlAclAddressType, bwstraps=bwstraps, sslProxyTotalReq=sslProxyTotalReq, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyCacheHits=sslProxyCacheHits, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, cpuUtilization=cpuUtilization, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqSrvcPort=ipsReqSrvcPort, systemFailOver=systemFailOver, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyClientAbrt=httpProxyClientAbrt, webCacheAddressType=webCacheAddressType, httpSrvrAddressType=httpSrvrAddressType, bwsMIBGroups=bwsMIBGroups, securityDefUpdates=securityDefUpdates, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, serviceAddress=serviceAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyCacheMiss=sslProxyCacheMiss, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, activeApplications=activeApplications, smNumUserSessions=smNumUserSessions, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsCacheStatsTable=bwsCacheStatsTable, serviceName=serviceName, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsCookieSecPort=ipsCookieSecPort, httpProxyParseErr=httpProxyParseErr, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprPort=webCmprPort, bwsStatsGroup=bwsStatsGroup, dataPathStatus=dataPathStatus, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyAddress=sslProxyAddress, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyActiveConn=sslProxyActiveConn, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyInBytes=sslProxyInBytes, httpProxyServerErr=httpProxyServerErr, httpProxyAddressType=httpProxyAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, logStorage=logStorage, httpSrvrInBytes=httpSrvrInBytes, bwsMIBConformance=bwsMIBConformance, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyAddress=httpProxyAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsRCTotQueued=ipsRCTotQueued, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitPort=ipsReqLimitPort, httpSrvrOutBytes=httpSrvrOutBytes, cpuTemperature=cpuTemperature, ipsUrlPolicyPort=ipsUrlPolicyPort, cpuFanSpeed=cpuFanSpeed, bws=bws, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCacheHits=webCacheHits, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, dataPortLinkUp=dataPortLinkUp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, serviceStatus=serviceStatus, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyOutBytes=sslProxyOutBytes, httpProxyActiveConn=httpProxyActiveConn, bwsServiceStatusTable=bwsServiceStatusTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, totalMem=totalMem, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyTotalConn=httpProxyTotalConn, ipsUrlAclReserved=ipsUrlAclReserved, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, systemSerialNumber=systemSerialNumber, bwsMIBCompliance=bwsMIBCompliance, ipsHdrAclAddress=ipsHdrAclAddress, ipsHdrAclPort=ipsHdrAclPort, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsServiceStatusEntry=bwsServiceStatusEntry, linkStatus=linkStatus, webCmprCompressibleDataSize=webCmprCompressibleDataSize, currentFirmwareVersion=currentFirmwareVersion, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrMaxResTime=sslSrvrMaxResTime, uptime=uptime, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, peerUp=peerUp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCacheStale=webCacheStale, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, smRealmName=smRealmName, httpProxyPort=httpProxyPort, systemLoad=systemLoad, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyUnknownRsp=httpProxyUnknownRsp, webCmprAddressType=webCmprAddressType, ipsUrlAclPort=ipsUrlAclPort, httpSrvrNumConn=httpSrvrNumConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, memUtilization=memUtilization, ipsAccessCtrlAddress=ipsAccessCtrlAddress, srvcName=srvcName, totalServers=totalServers, sslSrvrPort=sslSrvrPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyTotalConn=sslProxyTotalConn, ipsRCAddressType=ipsRCAddressType, dataPortLinkDown=dataPortLinkDown, webCacheCachedObjects=webCacheCachedObjects, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsMIBCompliances=bwsMIBCompliances, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, totalAttacks=totalAttacks, virusDefUpdates=virusDefUpdates)
mibBuilder.exportSymbols("BWS-MIB", bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsRCAddress=ipsRCAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCacheReq=webCacheReq, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, memoryUsageHigh=memoryUsageHigh, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, tempCritical=tempCritical, activeServers=activeServers, webCacheAddress=webCacheAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxyInBytes=httpProxyInBytes, logStorageHigh=logStorageHigh, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcPort=ipsLrnSrvcPort, webCacheProtocol=webCacheProtocol, httpSrvrState=httpSrvrState, sslProxyPort=sslProxyPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrOutBytes=sslSrvrOutBytes, bwsMessage=bwsMessage, ipsRCPort=ipsRCPort, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, fanDead=fanDead, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCmprAddress=webCmprAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCachePort=webCachePort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, vipStatus=vipStatus, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyOutBytes=httpProxyOutBytes, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyErrPms=sslProxyErrPms, webCacheCacheableRes=webCacheCacheableRes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrAddress=sslSrvrAddress, sslSrvrAddressType=sslSrvrAddressType, energizeUpdateExpire=energizeUpdateExpire, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyBadCRLErr=sslProxyBadCRLErr, totalApplications=totalApplications, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalBandwidth=totalBandwidth)
