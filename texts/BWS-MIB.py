...
Integer32, ModuleIdentity, Gauge32, Counter32, TimeTicks, Bits, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, MibIdentifier, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Gauge32", "Counter32", "TimeTicks", "Bits", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "MibIdentifier", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyTotalReq=sslProxyTotalReq, sslSrvrMinResTime=sslSrvrMinResTime, webCmprPort=webCmprPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyAddress=httpProxyAddress, sslSrvrNumConn=sslSrvrNumConn, activeServers=activeServers, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, logStorageHigh=logStorageHigh, httpSrvrInBytes=httpSrvrInBytes, activeApplications=activeApplications, httpSrvrAddressType=httpSrvrAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyInBytes=sslProxyInBytes, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheAddressType=webCacheAddressType, peerUp=peerUp, sslProxyPort=sslProxyPort, webCmprCompressedDataSize=webCmprCompressedDataSize, peerDown=peerDown, bwsMIBConformance=bwsMIBConformance, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyActiveConn=httpProxyActiveConn, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyAddressType=sslProxyAddressType, PYSNMP_MODULE_ID=bws, sslSrvrAddressType=sslSrvrAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serverUp=serverUp, servicePort=servicePort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlPort=ipsAccessCtrlPort, linkStatus=linkStatus, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, systemFailure=systemFailure, httpProxyParseErr=httpProxyParseErr, httpProxyServerReq=httpProxyServerReq, dataPathStatus=dataPathStatus, totalApplications=totalApplications, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, smAgentName=smAgentName, switchingToBypassMode=switchingToBypassMode, cpuTemperature=cpuTemperature, webCacheStale=webCacheStale, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyTotalConn=sslProxyTotalConn, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, switchingToInlineMode=switchingToInlineMode, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, operationalMode=operationalMode, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyPort=httpProxyPort, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrAddress=httpSrvrAddress, uptime=uptime, webCacheCacheableRes=webCacheCacheableRes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyActiveConn=sslProxyActiveConn, httpSrvrPort=httpSrvrPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyInBytes=httpProxyInBytes, webCmprCompressibleDataSize=webCmprCompressibleDataSize, serviceAddress=serviceAddress, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsRCAddress=ipsRCAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, srvcName=srvcName, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCacheProtocol=webCacheProtocol, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyErrPms=sslProxyErrPms, bwsStats=bwsStats, httpSrvrTotResponse=httpSrvrTotResponse, bwsMIBCompliance=bwsMIBCompliance, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyAddress=sslProxyAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrMaxResTime=httpSrvrMaxResTime, vipStatus=vipStatus, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheReq=webCacheReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyTotalConn=httpProxyTotalConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheMiss=webCacheMiss, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, dataPortLinkUp=dataPortLinkUp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrTotTimedout=sslSrvrTotTimedout, dataPortLinkDown=dataPortLinkDown, webCmprAddressType=webCmprAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecPort=ipsCookieSecPort, cpuFanSpeed=cpuFanSpeed, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheCachedObjects=webCacheCachedObjects, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCmprProtocol=webCmprProtocol, bwsSMUserSessionTable=bwsSMUserSessionTable, sharedSecretKeyExpired=sharedSecretKeyExpired, highAvailabilityStatus=highAvailabilityStatus, systemSerialNumber=systemSerialNumber, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, serviceName=serviceName, httpProxyServerAbrt=httpProxyServerAbrt, serverDown=serverDown, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCachePort=webCachePort, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclPort=ipsUrlAclPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, currentFirmwareVersion=currentFirmwareVersion, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrOutBytes=sslSrvrOutBytes, bwsTrapGroup=bwsTrapGroup, ipsUrlAclAddress=ipsUrlAclAddress, smRealmName=smRealmName, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, firmwareStorageHigh=firmwareStorageHigh, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, totalServers=totalServers, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotReqActive=sslSrvrTotReqActive, serviceStatus=serviceStatus, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwstraps=bwstraps, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsCookieSecAddress=ipsCookieSecAddress, cpuUtilization=cpuUtilization, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsRCTotDropped=ipsRCTotDropped, tempHigh=tempHigh, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, fanDead=fanDead, ipsRCTotQueued=ipsRCTotQueued, switchingToMaintMode=switchingToMaintMode, bws=bws, totalBandwidth=totalBandwidth, virusDefUpdates=virusDefUpdates, bwsMIBCompliances=bwsMIBCompliances, firmwareStorage=firmwareStorage, webCacheHits=webCacheHits, ipsRCPort=ipsRCPort, ipsUrlAclReserved=ipsUrlAclReserved, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, systemLoad=systemLoad, httpProxyOutBytes=httpProxyOutBytes, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitPort=ipsReqLimitPort, raidDegrading=raidDegrading, tempCritical=tempCritical, sslSrvrTotReqRejected=sslSrvrTotReqRejected, freeMem=freeMem, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsMessage=bwsMessage, memUtilization=memUtilization)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyTotalReq=httpProxyTotalReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, logStorage=logStorage, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, processCountHigh=processCountHigh, webCacheAddress=webCacheAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, totalAttacks=totalAttacks, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCacheBytesOut=webCacheBytesOut, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsHdrAclHits=ipsHdrAclHits, bwsCacheStatsTable=bwsCacheStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyCacheHits=sslProxyCacheHits, sslSrvrState=sslSrvrState, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitAddressType=ipsReqLimitAddressType, smNumUserSessions=smNumUserSessions, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotRefused=sslSrvrTotRefused, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrNumConn=httpSrvrNumConn, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrPort=sslSrvrPort, sslSrvrInBytes=sslSrvrInBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, systemFailOver=systemFailOver, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrState=httpSrvrState, httpProxyServerErr=httpProxyServerErr, totalMem=totalMem, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyPort=ipsUrlPolicyPort, memoryUsageHigh=memoryUsageHigh, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyAddressType=httpProxyAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, securityDefUpdates=securityDefUpdates, webCmprAddress=webCmprAddress, systemFanSpeed=systemFanSpeed)
