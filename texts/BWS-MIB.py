...
NotificationType, Unsigned32, ObjectIdentity, TimeTicks, ModuleIdentity, Bits, MibIdentifier, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Bits", "MibIdentifier", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", smAgentName=smAgentName, bws=bws, bwsStats=bwsStats, sslProxyInBytes=sslProxyInBytes, sslProxyBadCRLErr=sslProxyBadCRLErr, dataPathStatus=dataPathStatus, dataPortLinkUp=dataPortLinkUp, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyTotalReq=httpProxyTotalReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormPort=ipsUrlNormPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, fanDead=fanDead, sslSrvrState=sslSrvrState, activeApplications=activeApplications, bwsTrapGroup=bwsTrapGroup, sslProxyPort=sslProxyPort, ipsReqLimitPort=ipsReqLimitPort, processCountHigh=processCountHigh, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, logStorage=logStorage, webCacheMiss=webCacheMiss, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, peerUp=peerUp, webCacheProtocol=webCacheProtocol, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsRCTotDropped=ipsRCTotDropped, ipsHdrAclHits=ipsHdrAclHits, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyInBytes=httpProxyInBytes, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyActiveConn=sslProxyActiveConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsServiceStatusTable=bwsServiceStatusTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, totalApplications=totalApplications, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, highAvailabilityStatus=highAvailabilityStatus, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, totalBandwidth=totalBandwidth, totalServers=totalServers, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyTotalReq=sslProxyTotalReq, webCacheAddressType=webCacheAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrAddress=httpSrvrAddress, httpProxyServerReq=httpProxyServerReq, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsMIBConformance=bwsMIBConformance, servicePort=servicePort, systemFailOver=systemFailOver, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, currentFirmwareVersion=currentFirmwareVersion, sslProxyAddress=sslProxyAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, PYSNMP_MODULE_ID=bws, bwstraps=bwstraps, sslSrvrAddressType=sslSrvrAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrInBytes=sslSrvrInBytes, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyServerAbrt=httpProxyServerAbrt, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheAddress=webCacheAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, virusDefUpdates=virusDefUpdates, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyTotalConn=sslProxyTotalConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclPort=ipsUrlAclPort, linkStatus=linkStatus, sslProxyErrPms=sslProxyErrPms, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlAclAddress=ipsUrlAclAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyOutBytes=sslProxyOutBytes, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrPort=sslSrvrPort, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyPort=httpProxyPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, switchingToBypassMode=switchingToBypassMode, bwsStatsGroup=bwsStatsGroup, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrAddressType=httpSrvrAddressType, sslSrvrAddress=sslSrvrAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, systemFanSpeed=systemFanSpeed, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, tempHigh=tempHigh, cpuTemperature=cpuTemperature, srvcName=srvcName, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrNumConn=httpSrvrNumConn, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, dataPortLinkDown=dataPortLinkDown, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsMIBCompliance=bwsMIBCompliance, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyOutBytes=httpProxyOutBytes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrMinResTime=sslSrvrMinResTime, bwsMessage=bwsMessage, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, memoryUsageHigh=memoryUsageHigh, systemSerialNumber=systemSerialNumber, httpSrvrOutBytes=httpSrvrOutBytes, logStorageHigh=logStorageHigh, httpSrvrInBytes=httpSrvrInBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrState=httpSrvrState, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecAddress=ipsCookieSecAddress, activeServers=activeServers, peerDown=peerDown, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCmprAddress=webCmprAddress, webCmprProtocol=webCmprProtocol, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsRCAddressType=ipsRCAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, totalMem=totalMem, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, serviceAddress=serviceAddress, uptime=uptime, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrTotRefused=httpSrvrTotRefused, raidDegrading=raidDegrading, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsCookieSecTampered=ipsCookieSecTampered, systemLoad=systemLoad, webCacheLongHdrs=webCacheLongHdrs, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyCacheHits=sslProxyCacheHits, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCachePort=webCachePort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, serviceStatus=serviceStatus, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCacheCacheableRes=webCacheCacheableRes, webCacheCachedObjects=webCacheCachedObjects, httpSrvrMinResTime=httpSrvrMinResTime, bwsSMUserSessionEntry=bwsSMUserSessionEntry, tempCritical=tempCritical, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCacheBytesOut=webCacheBytesOut, cpuUtilization=cpuUtilization, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyAddressType=httpProxyAddressType, ipsRCAddress=ipsRCAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, smNumUserSessions=smNumUserSessions, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, serverDown=serverDown, switchingToInlineMode=switchingToInlineMode)
mibBuilder.exportSymbols("BWS-MIB", httpProxyActiveConn=httpProxyActiveConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyAddressType=sslProxyAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsHdrAclPort=ipsHdrAclPort, ipsRCTimeStamp=ipsRCTimeStamp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsCookieSecAddressType=ipsCookieSecAddressType, serviceName=serviceName, webCacheHits=webCacheHits, cpuFanSpeed=cpuFanSpeed, httpSrvrPort=httpSrvrPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsMIBCompliances=bwsMIBCompliances, securityDefUpdates=securityDefUpdates, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, memUtilization=memUtilization, ipsRCPort=ipsRCPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsRCTotQueued=ipsRCTotQueued, totalAttacks=totalAttacks, webCmprPort=webCmprPort, smRealmName=smRealmName, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyServerErr=httpProxyServerErr, systemFailure=systemFailure, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, operationalMode=operationalMode, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, serverUp=serverUp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, vipStatus=vipStatus, bwsCacheStatsEntry=bwsCacheStatsEntry, freeMem=freeMem, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheReq=webCacheReq, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, firmwareStorage=firmwareStorage, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsMIBGroups=bwsMIBGroups, ipsReqLimitAddress=ipsReqLimitAddress, webCacheStale=webCacheStale, httpProxyAddress=httpProxyAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCmprAddressType=webCmprAddressType)
