...
ObjectIdentity, NotificationType, Counter32, iso, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, IpAddress, MibIdentifier, Unsigned32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Counter32", "iso", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "IpAddress", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrTotRefused=httpSrvrTotRefused, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, serverUp=serverUp, bwsMIBCompliances=bwsMIBCompliances, sslProxyCacheHits=sslProxyCacheHits, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyCurrentConn=sslProxyCurrentConn, cpuFanSpeed=cpuFanSpeed, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheReq=webCacheReq, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheAddressType=webCacheAddressType, PYSNMP_MODULE_ID=bws, freeMem=freeMem, sslProxyBadDNCErr=sslProxyBadDNCErr, firmwareStorage=firmwareStorage, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrAddress=httpSrvrAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheBytesOut=webCacheBytesOut, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, logStorageHigh=logStorageHigh, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, cpuUtilization=cpuUtilization, serverDown=serverDown, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheCachedObjects=webCacheCachedObjects, securityDefUpdates=securityDefUpdates, totalAttacks=totalAttacks, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCacheHits=webCacheHits, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, systemFailOver=systemFailOver, httpProxyParseErr=httpProxyParseErr, ipsUrlNormPort=ipsUrlNormPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyOutBytes=sslProxyOutBytes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclAddress=ipsHdrAclAddress, tempHigh=tempHigh, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsRCTotDropped=ipsRCTotDropped, httpProxyInBytes=httpProxyInBytes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, srvcName=srvcName, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsHdrAclHits=ipsHdrAclHits, linkStatus=linkStatus, httpProxyPort=httpProxyPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, fanDead=fanDead, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsStats=bwsStats, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, activeServers=activeServers, httpProxyActiveConn=httpProxyActiveConn, raidDegrading=raidDegrading, sslProxyPort=sslProxyPort, httpProxyServerAbrt=httpProxyServerAbrt, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyActiveConn=sslProxyActiveConn, totalApplications=totalApplications, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCmprAddress=webCmprAddress, smAgentName=smAgentName, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrInBytes=httpSrvrInBytes, ipsCookieSecAddress=ipsCookieSecAddress, peerUp=peerUp, ipsWebAddrTransPort=ipsWebAddrTransPort, webCmprPort=webCmprPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrAddress=sslSrvrAddress, sslSrvrState=sslSrvrState, bwsMessage=bwsMessage, memUtilization=memUtilization, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, operationalMode=operationalMode, systemFanSpeed=systemFanSpeed, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqSrvcPort=ipsReqSrvcPort, highAvailabilityStatus=highAvailabilityStatus, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCPort=ipsRCPort, webCmprCompressedDataSize=webCmprCompressedDataSize, switchingToMaintMode=switchingToMaintMode, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyErrPms=sslProxyErrPms, totalBandwidth=totalBandwidth, virusDefUpdates=virusDefUpdates, webCachePort=webCachePort, energizeUpdateExpire=energizeUpdateExpire, httpProxyServerErr=httpProxyServerErr, bwsServiceStatusTable=bwsServiceStatusTable, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, systemLoad=systemLoad, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheStale=webCacheStale, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotResponse=httpSrvrTotResponse, logStorage=logStorage, ipsRCAddress=ipsRCAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, switchingToInlineMode=switchingToInlineMode, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsCookieSecPort=ipsCookieSecPort, webCacheMiss=webCacheMiss, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, vipStatus=vipStatus, httpProxyTotalReq=httpProxyTotalReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, systemSerialNumber=systemSerialNumber, sslSrvrAddressType=sslSrvrAddressType, httpProxyAddressType=httpProxyAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheAddress=webCacheAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, peerDown=peerDown, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrMinResTime=httpSrvrMinResTime, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrTotSuccess=sslSrvrTotSuccess, webCmprAddressType=webCmprAddressType, smRealmName=smRealmName, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, memoryUsageHigh=memoryUsageHigh, ipsReqLimitAddress=ipsReqLimitAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, processCountHigh=processCountHigh, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, serviceAddress=serviceAddress, ipsRCAddressType=ipsRCAddressType, dataPortLinkDown=dataPortLinkDown, sslSrvrPort=sslSrvrPort, smNumUserSessions=smNumUserSessions, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyInBytes=sslProxyInBytes, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, dataPathStatus=dataPathStatus, webCacheCacheableRes=webCacheCacheableRes, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrNumConn=httpSrvrNumConn, activeApplications=activeApplications, totalMem=totalMem, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, servicePort=servicePort, firmwareStorageHigh=firmwareStorageHigh, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyOutBytes=httpProxyOutBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlNormAddressType=ipsUrlNormAddressType, uptime=uptime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsMIBCompliance=bwsMIBCompliance, ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions)
mibBuilder.exportSymbols("BWS-MIB", sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, cpuTemperature=cpuTemperature, serviceStatus=serviceStatus, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlAclPort=ipsUrlAclPort, bwsMIBGroups=bwsMIBGroups, ipsRCTotServed=ipsRCTotServed, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrNumConn=sslSrvrNumConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, serviceName=serviceName, bws=bws, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCTotQueued=ipsRCTotQueued, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCmprCompressibleDataSize=webCmprCompressibleDataSize, switchingToBypassMode=switchingToBypassMode, webCmprProtocol=webCmprProtocol, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, systemFailure=systemFailure, bwsTrapGroup=bwsTrapGroup, httpProxyTotalConn=httpProxyTotalConn, webCacheProtocol=webCacheProtocol, sslProxyTotalConn=sslProxyTotalConn, bwsStatsGroup=bwsStatsGroup, bwstraps=bwstraps, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsHdrAclPort=ipsHdrAclPort, httpSrvrPort=httpSrvrPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyAddressType=sslProxyAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrState=httpSrvrState, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, totalServers=totalServers, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyServerReq=httpProxyServerReq, dataPortLinkUp=dataPortLinkUp, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsMIBConformance=bwsMIBConformance, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTimeStamp=ipsRCTimeStamp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyAddress=sslProxyAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, tempCritical=tempCritical)
