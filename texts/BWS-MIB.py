...
Gauge32, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Counter64, Bits, ObjectIdentity, TimeTicks, iso, IpAddress, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Counter64", "Bits", "ObjectIdentity", "TimeTicks", "iso", "IpAddress", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsRCAddress=ipsRCAddress, bwsCacheStatsTable=bwsCacheStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrMinResTime=httpSrvrMinResTime, webCmprAddress=webCmprAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, cpuTemperature=cpuTemperature, bwsMessage=bwsMessage, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsSMUserSessionTable=bwsSMUserSessionTable, currentFirmwareVersion=currentFirmwareVersion, virusDefUpdates=virusDefUpdates, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, serviceStatus=serviceStatus, serverUp=serverUp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, systemFailure=systemFailure, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCmprPort=webCmprPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, systemFanSpeed=systemFanSpeed, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, switchingToMaintMode=switchingToMaintMode, cpuFanSpeed=cpuFanSpeed, freeMem=freeMem, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecPort=ipsCookieSecPort, ipsRCTotDropped=ipsRCTotDropped, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyParseErr=httpProxyParseErr, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, totalApplications=totalApplications, ipsAccessCtrlPort=ipsAccessCtrlPort, switchingToBypassMode=switchingToBypassMode, webCmprAddressType=webCmprAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrInBytes=sslSrvrInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlNormPort=ipsUrlNormPort, ipsReqLimitPort=ipsReqLimitPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsTrapGroup=bwsTrapGroup, smAgentName=smAgentName, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrAddress=sslSrvrAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheMiss=webCacheMiss, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlAclPort=ipsUrlAclPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrPort=httpSrvrPort, ipsUrlAclAddressType=ipsUrlAclAddressType, activeApplications=activeApplications, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheAddressType=webCacheAddressType, bwsStats=bwsStats, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsRCAddressType=ipsRCAddressType, sslProxyTotalConn=sslProxyTotalConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, systemLoad=systemLoad, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, firmwareStorage=firmwareStorage, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCachePort=webCachePort, totalAttacks=totalAttacks, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, securityDefUpdates=securityDefUpdates, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrNumFreeConn=sslSrvrNumFreeConn, totalServers=totalServers, sslProxyAddress=sslProxyAddress, httpSrvrState=httpSrvrState, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsMIBCompliance=bwsMIBCompliance, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsMIBConformance=bwsMIBConformance, sslProxyPort=sslProxyPort, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCmprProtocol=webCmprProtocol, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsStatsGroup=bwsStatsGroup, fanDead=fanDead, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecAddress=ipsCookieSecAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrTotReqActive=sslSrvrTotReqActive, raidDegrading=raidDegrading, uptime=uptime, switchingToInlineMode=switchingToInlineMode, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrAddressType=sslSrvrAddressType, ipsHdrAclPort=ipsHdrAclPort, sslProxyErrPms=sslProxyErrPms, systemSerialNumber=systemSerialNumber, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyAddress=httpProxyAddress, bwstraps=bwstraps, sslProxyInBytes=sslProxyInBytes, webCacheReq=webCacheReq, ipsRCTotServed=ipsRCTotServed, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrInBytes=httpSrvrInBytes, sslSrvrTotResponse=sslSrvrTotResponse, webCacheHits=webCacheHits, ipsRCTotQueued=ipsRCTotQueued, httpProxyTotalConn=httpProxyTotalConn, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheCachedObjects=webCacheCachedObjects, ipsRCTotOutOfResource=ipsRCTotOutOfResource, serviceName=serviceName, bws=bws, httpProxyOutBytes=httpProxyOutBytes, webCacheLongHdrs=webCacheLongHdrs, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumConn=httpSrvrNumConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, peerDown=peerDown, sslSrvrPort=sslSrvrPort, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrState=sslSrvrState, webCacheProtocol=webCacheProtocol, memUtilization=memUtilization, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyOutBytes=sslProxyOutBytes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrTotSuccess=httpSrvrTotSuccess, smNumUserSessions=smNumUserSessions, webCacheCacheableRes=webCacheCacheableRes, httpProxyAddressType=httpProxyAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, smRealmName=smRealmName, bwsIpsRCStatsTable=bwsIpsRCStatsTable, totalMem=totalMem, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, peerUp=peerUp, linkStatus=linkStatus, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheAddress=webCacheAddress, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrTotRefused=httpSrvrTotRefused, totalBandwidth=totalBandwidth, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlAclReserved=ipsUrlAclReserved, bwsMIBGroups=bwsMIBGroups, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyServerErr=httpProxyServerErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serviceAddress=serviceAddress, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsHdrAclHits=ipsHdrAclHits, servicePort=servicePort, ipsRCTimeStamp=ipsRCTimeStamp)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, operationalMode=operationalMode, srvcName=srvcName, dataPathStatus=dataPathStatus, cpuUtilization=cpuUtilization, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyUnknownRsp=httpProxyUnknownRsp, sharedSecretKeyExpired=sharedSecretKeyExpired, processCountHigh=processCountHigh, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, logStorage=logStorage, sslProxyAddressType=sslProxyAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, tempCritical=tempCritical, PYSNMP_MODULE_ID=bws, dataPortLinkUp=dataPortLinkUp, sslProxyTotalReq=sslProxyTotalReq, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrAddressType=httpSrvrAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrAddress=httpSrvrAddress, firmwareStorageHigh=firmwareStorageHigh, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrMaxResTime=sslSrvrMaxResTime, tempHigh=tempHigh, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrOutBytes=httpSrvrOutBytes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, logStorageHigh=logStorageHigh, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsServiceStatusTable=bwsServiceStatusTable, ipsRCPort=ipsRCPort, vipStatus=vipStatus, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, energizeUpdateExpire=energizeUpdateExpire, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCacheStale=webCacheStale, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyServerReq=httpProxyServerReq, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyPort=httpProxyPort, dataPortLinkDown=dataPortLinkDown, systemFailOver=systemFailOver, activeServers=activeServers, serverDown=serverDown)
