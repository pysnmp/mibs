...
NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ObjectIdentity, IpAddress, Bits, ModuleIdentity, MibIdentifier, Gauge32, TimeTicks, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ObjectIdentity", "IpAddress", "Bits", "ModuleIdentity", "MibIdentifier", "Gauge32", "TimeTicks", "iso", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyTotalReq=httpProxyTotalReq, dataPathStatus=dataPathStatus, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyActiveConn=sslProxyActiveConn, fanDead=fanDead, httpProxyOutBytes=httpProxyOutBytes, ipsUrlAclReserved=ipsUrlAclReserved, webCacheHits=webCacheHits, totalMem=totalMem, switchingToInlineMode=switchingToInlineMode, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqSrvcAddress=ipsReqSrvcAddress, dataPortLinkDown=dataPortLinkDown, cpuTemperature=cpuTemperature, processCountHigh=processCountHigh, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCTotServed=ipsRCTotServed, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrAvgResTime=httpSrvrAvgResTime, cpuFanSpeed=cpuFanSpeed, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, serviceName=serviceName, freeMem=freeMem, httpProxyPort=httpProxyPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsMIBCompliance=bwsMIBCompliance, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, raidDegrading=raidDegrading, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, totalBandwidth=totalBandwidth, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, totalAttacks=totalAttacks, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheLongHdrs=webCacheLongHdrs, httpSrvrOutBytes=httpSrvrOutBytes, serviceAddress=serviceAddress, totalServers=totalServers, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTotDropped=ipsRCTotDropped, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, ipsRCAddressType=ipsRCAddressType, ipsRCAddress=ipsRCAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCacheBytesOut=webCacheBytesOut, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrMinResTime=httpSrvrMinResTime, webCmprAddress=webCmprAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, peerUp=peerUp, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, memoryUsageHigh=memoryUsageHigh, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrPort=sslSrvrPort, httpProxyAddress=httpProxyAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, cpuUtilization=cpuUtilization, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bws=bws, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprAddressType=webCmprAddressType, httpSrvrState=httpSrvrState, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, peerDown=peerDown, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCacheReq=webCacheReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormPort=ipsUrlNormPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyTotalConn=httpProxyTotalConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrNumConn=httpSrvrNumConn, dataPortLinkUp=dataPortLinkUp, sslProxyAddress=sslProxyAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyTotalConn=sslProxyTotalConn, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitPort=ipsReqLimitPort, webCmprPort=webCmprPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyAddressType=httpProxyAddressType, sslProxyInBytes=sslProxyInBytes, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, smAgentName=smAgentName, webCmprProtocol=webCmprProtocol, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrInBytes=httpSrvrInBytes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyActiveConn=httpProxyActiveConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, systemSerialNumber=systemSerialNumber, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsCookieSecTampered=ipsCookieSecTampered, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitAddress=ipsReqLimitAddress, securityDefUpdates=securityDefUpdates, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, uptime=uptime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyFullHandshakes=sslProxyFullHandshakes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsTrapGroup=bwsTrapGroup, serverUp=serverUp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, totalApplications=totalApplications, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrState=sslSrvrState, ipsUrlAclAddress=ipsUrlAclAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, highAvailabilityStatus=highAvailabilityStatus, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, activeApplications=activeApplications, firmwareStorage=firmwareStorage, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCacheAddress=webCacheAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitAddressType=ipsReqLimitAddressType, systemFailure=systemFailure, sslSrvrAddressType=sslSrvrAddressType, tempHigh=tempHigh, httpProxyWAFWarnings=httpProxyWAFWarnings, energizeUpdateExpire=energizeUpdateExpire, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyTotalReq=sslProxyTotalReq, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyErrPms=sslProxyErrPms, systemFailOver=systemFailOver, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, activeServers=activeServers, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrPort=httpSrvrPort, servicePort=servicePort, ipsRCPort=ipsRCPort, smRealmName=smRealmName, ipsHdrAclAddress=ipsHdrAclAddress, webCacheCachedObjects=webCacheCachedObjects, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyInBytes=httpProxyInBytes, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, vipStatus=vipStatus, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyClientAbrt=httpProxyClientAbrt, webCacheStale=webCacheStale, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsMessage=bwsMessage, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, switchingToBypassMode=switchingToBypassMode, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, smNumUserSessions=smNumUserSessions, webCmprCompressibleDataSize=webCmprCompressibleDataSize, logStorage=logStorage, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsHdrAclHits=ipsHdrAclHits, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, tempCritical=tempCritical, httpProxyParseErr=httpProxyParseErr, serverDown=serverDown, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyAddressType=sslProxyAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyServerReq=httpProxyServerReq, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, systemFanSpeed=systemFanSpeed, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheMiss=webCacheMiss, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection)
mibBuilder.exportSymbols("BWS-MIB", httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, logStorageHigh=logStorageHigh, webCacheProtocol=webCacheProtocol, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, firmwareStorageHigh=firmwareStorageHigh, systemLoad=systemLoad, linkStatus=linkStatus, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsMIBGroups=bwsMIBGroups, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlAclPort=ipsUrlAclPort, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, switchingToMaintMode=switchingToMaintMode, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotSuccess=httpSrvrTotSuccess, operationalMode=operationalMode, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsStats=bwsStats, webCacheCacheableRes=webCacheCacheableRes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsMIBConformance=bwsMIBConformance, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyPort=sslProxyPort, webCachePort=webCachePort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, currentFirmwareVersion=currentFirmwareVersion, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serviceStatus=serviceStatus, srvcName=srvcName, bwstraps=bwstraps, memUtilization=memUtilization, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyCacheMiss=sslProxyCacheMiss, ipsHdrAclAddressType=ipsHdrAclAddressType, virusDefUpdates=virusDefUpdates, bwsServiceStatusTable=bwsServiceStatusTable, bwsStatsGroup=bwsStatsGroup, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, PYSNMP_MODULE_ID=bws, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyServerErr=httpProxyServerErr, httpSrvrTotTimedout=httpSrvrTotTimedout, webCacheAddressType=webCacheAddressType, ipsHdrAclPort=ipsHdrAclPort, sslSrvrAddress=sslSrvrAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt)
