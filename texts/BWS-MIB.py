...
Unsigned32, Gauge32, TimeTicks, Counter64, IpAddress, ObjectIdentity, Bits, MibIdentifier, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "IpAddress", "ObjectIdentity", "Bits", "MibIdentifier", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsMessage=bwsMessage, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyServerReq=httpProxyServerReq, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsMIBCompliance=bwsMIBCompliance, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, activeApplications=activeApplications, totalServers=totalServers, memUtilization=memUtilization, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyPort=httpProxyPort, bwsTrapGroup=bwsTrapGroup, httpProxyAddress=httpProxyAddress, sslProxyCurrentConn=sslProxyCurrentConn, systemLoad=systemLoad, ipsHdrAclPort=ipsHdrAclPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheProtocol=webCacheProtocol, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCacheAddress=webCacheAddress, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheLongHdrs=webCacheLongHdrs, switchingToMaintMode=switchingToMaintMode, sslProxyPort=sslProxyPort, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, totalBandwidth=totalBandwidth, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrState=sslSrvrState, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, tempCritical=tempCritical, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, smRealmName=smRealmName, sslProxyTotalReq=sslProxyTotalReq, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrInBytes=sslSrvrInBytes, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrPort=httpSrvrPort, sslProxyAddressType=sslProxyAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwstraps=bwstraps, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCacheReq=webCacheReq, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, webCachePort=webCachePort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsMIBConformance=bwsMIBConformance, serverUp=serverUp, bwsCacheStatsTable=bwsCacheStatsTable, systemFanSpeed=systemFanSpeed, ipsReqLimitAddress=ipsReqLimitAddress, logStorage=logStorage, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, activeServers=activeServers, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyServerErr=httpProxyServerErr, webCacheHits=webCacheHits, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrAddressType=sslSrvrAddressType, cpuTemperature=cpuTemperature, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, systemFailure=systemFailure, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCTotQueued=ipsRCTotQueued, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheCacheableRes=webCacheCacheableRes, bwsMIBGroups=bwsMIBGroups, bws=bws, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, dataPortLinkUp=dataPortLinkUp, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyActiveConn=httpProxyActiveConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTimeStamp=ipsRCTimeStamp, bwsMIBCompliances=bwsMIBCompliances, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, switchingToInlineMode=switchingToInlineMode, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, totalMem=totalMem, servicePort=servicePort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyActiveConn=sslProxyActiveConn, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyClientAbrt=httpProxyClientAbrt, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheStale=webCacheStale, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrAddressType=httpSrvrAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotTimedout=httpSrvrTotTimedout, peerUp=peerUp, sslProxyAddress=sslProxyAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsRCPort=ipsRCPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrState=httpSrvrState, ipsUrlAclAddress=ipsUrlAclAddress, totalAttacks=totalAttacks, webCacheMiss=webCacheMiss, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, firmwareStorage=firmwareStorage, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsStatsGroup=bwsStatsGroup, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, serviceName=serviceName, webCacheBytesOut=webCacheBytesOut, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, firmwareStorageHigh=firmwareStorageHigh, PYSNMP_MODULE_ID=bws, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumConn=sslSrvrNumConn, sslSrvrAvgResTime=sslSrvrAvgResTime, vipStatus=vipStatus, httpProxyAddressType=httpProxyAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrAddress=sslSrvrAddress, ipsCookieSecTampered=ipsCookieSecTampered, switchingToBypassMode=switchingToBypassMode, memoryUsageHigh=memoryUsageHigh, ipsCookieSecPort=ipsCookieSecPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, serviceAddress=serviceAddress, ipsReqSrvcPort=ipsReqSrvcPort, webCacheAddressType=webCacheAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyTotalReq=httpProxyTotalReq, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyCacheHits=sslProxyCacheHits, bwsCompressionStatsTable=bwsCompressionStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormPort=ipsUrlNormPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, serverDown=serverDown, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrOutBytes=httpSrvrOutBytes, bwsStats=bwsStats, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrInBytes=httpSrvrInBytes, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrTotTimedout=sslSrvrTotTimedout, securityDefUpdates=securityDefUpdates, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecAddress=ipsCookieSecAddress, highAvailabilityStatus=highAvailabilityStatus, sslProxyErrPms=sslProxyErrPms, operationalMode=operationalMode, sslProxyOutBytes=sslProxyOutBytes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheCachedObjects=webCacheCachedObjects, httpSrvrMaxResTime=httpSrvrMaxResTime, currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyParseErr=httpProxyParseErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyTotalConn=sslProxyTotalConn, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrTotReqRejected=httpSrvrTotReqRejected, smNumUserSessions=smNumUserSessions, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprAddressType=webCmprAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, serviceStatus=serviceStatus, peerDown=peerDown, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsRCTotServed=ipsRCTotServed, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, freeMem=freeMem)
mibBuilder.exportSymbols("BWS-MIB", httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCmprPort=webCmprPort, sslProxyInBytes=sslProxyInBytes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, dataPortLinkDown=dataPortLinkDown, virusDefUpdates=virusDefUpdates, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, linkStatus=linkStatus, raidDegrading=raidDegrading, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, cpuUtilization=cpuUtilization, dataPathStatus=dataPathStatus, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclPort=ipsUrlAclPort, ipsHdrAclHits=ipsHdrAclHits, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsHdrAclAddress=ipsHdrAclAddress, cpuFanSpeed=cpuFanSpeed, ipsRCAddress=ipsRCAddress, uptime=uptime, systemFailOver=systemFailOver, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyTotalConn=httpProxyTotalConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, systemSerialNumber=systemSerialNumber, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, totalApplications=totalApplications, webCmprProtocol=webCmprProtocol, httpSrvrTotRefused=httpSrvrTotRefused, webCmprAddress=webCmprAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, energizeUpdateExpire=energizeUpdateExpire, processCountHigh=processCountHigh, smAgentName=smAgentName, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, tempHigh=tempHigh, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrPort=sslSrvrPort, logStorageHigh=logStorageHigh, srvcName=srvcName, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, fanDead=fanDead, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt)
