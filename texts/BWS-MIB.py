...
IpAddress, Unsigned32, MibIdentifier, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ModuleIdentity, Gauge32, Bits, NotificationType, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "MibIdentifier", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ModuleIdentity", "Gauge32", "Bits", "NotificationType", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", tempHigh=tempHigh, fanDead=fanDead, bwsMIBGroups=bwsMIBGroups, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, highAvailabilityStatus=highAvailabilityStatus, cpuTemperature=cpuTemperature, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyPort=httpProxyPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyCacheTimeouts=sslProxyCacheTimeouts, peerDown=peerDown, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyActiveConn=sslProxyActiveConn, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormAddress=ipsUrlNormAddress, securityDefUpdates=securityDefUpdates, sslProxyErrPms=sslProxyErrPms, systemLoad=systemLoad, sslProxyTotalReq=sslProxyTotalReq, systemFailOver=systemFailOver, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyActiveConn=httpProxyActiveConn, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, srvcName=srvcName, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, activeApplications=activeApplications, ipsUrlAclPort=ipsUrlAclPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyInBytes=sslProxyInBytes, totalMem=totalMem, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecTampered=ipsCookieSecTampered, PYSNMP_MODULE_ID=bws, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclAddressType=ipsUrlAclAddressType, serviceAddress=serviceAddress, webCmprPort=webCmprPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlNormPort=ipsUrlNormPort, bwsMIBCompliance=bwsMIBCompliance, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, totalAttacks=totalAttacks, operationalMode=operationalMode, httpSrvrOutBytes=httpSrvrOutBytes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, processCountHigh=processCountHigh, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, raidDegrading=raidDegrading, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyClientAbrt=httpProxyClientAbrt, webCmprAddressType=webCmprAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyCurrentConn=sslProxyCurrentConn, webCacheReq=webCacheReq, bwsMIBCompliances=bwsMIBCompliances, webCacheMiss=webCacheMiss, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheProtocol=webCacheProtocol, webCacheHits=webCacheHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCTimeStamp=ipsRCTimeStamp, bws=bws, bwsSMUserSessionTable=bwsSMUserSessionTable, bwstraps=bwstraps, httpProxyAddress=httpProxyAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrState=sslSrvrState, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyCacheHits=sslProxyCacheHits, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCTotDropped=ipsRCTotDropped, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, logStorage=logStorage, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyAddressType=httpProxyAddressType, linkStatus=linkStatus, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrState=httpSrvrState, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCacheLongHdrs=webCacheLongHdrs, bwsStats=bwsStats, logStorageHigh=logStorageHigh, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, totalBandwidth=totalBandwidth, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitPort=ipsReqLimitPort, webCacheCacheableRes=webCacheCacheableRes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, peerUp=peerUp, webCmprAddress=webCmprAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyServerErr=httpProxyServerErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, dataPathStatus=dataPathStatus, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, systemFailure=systemFailure, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlNormAddressType=ipsUrlNormAddressType, energizeUpdateExpire=energizeUpdateExpire, sslProxyAddress=sslProxyAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsMessage=bwsMessage, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrPort=sslSrvrPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrAddress=httpSrvrAddress, smAgentName=smAgentName, httpProxyParseErr=httpProxyParseErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, memoryUsageHigh=memoryUsageHigh, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsMIBConformance=bwsMIBConformance, httpSrvrInBytes=httpSrvrInBytes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitAddressType=ipsReqLimitAddressType, activeServers=activeServers, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, switchingToInlineMode=switchingToInlineMode, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsRCTotServed=ipsRCTotServed, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCacheStale=webCacheStale, webCacheCachedObjects=webCacheCachedObjects, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, tempCritical=tempCritical, sslSrvrAvgResTime=sslSrvrAvgResTime, currentFirmwareVersion=currentFirmwareVersion, webCachePort=webCachePort, webCmprProtocol=webCmprProtocol, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, dataPortLinkDown=dataPortLinkDown, serviceName=serviceName, ipsRCPort=ipsRCPort, httpSrvrNumConn=httpSrvrNumConn, webCacheAddress=webCacheAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheAddressType=webCacheAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, systemFanSpeed=systemFanSpeed, memUtilization=memUtilization, httpSrvrTotReqRejected=httpSrvrTotReqRejected, smRealmName=smRealmName, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, virusDefUpdates=virusDefUpdates, httpProxyTotalReq=httpProxyTotalReq, serverUp=serverUp, ipsHdrAclHits=ipsHdrAclHits, ipsRCAddressType=ipsRCAddressType, httpProxyServerReq=httpProxyServerReq, firmwareStorage=firmwareStorage, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, smNumUserSessions=smNumUserSessions, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrAddress=sslSrvrAddress, freeMem=freeMem, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrAddressType=httpSrvrAddressType, totalApplications=totalApplications, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrPort=httpSrvrPort, ipsRCAddress=ipsRCAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess)
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyInBytes=httpProxyInBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, serverDown=serverDown, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, totalServers=totalServers, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, cpuUtilization=cpuUtilization, servicePort=servicePort, systemSerialNumber=systemSerialNumber, sslProxyAddressType=sslProxyAddressType, sslSrvrAddressType=sslSrvrAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsStatsGroup=bwsStatsGroup, sslSrvrInBytes=sslSrvrInBytes, httpProxyOutBytes=httpProxyOutBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecPort=ipsCookieSecPort, firmwareStorageHigh=firmwareStorageHigh, httpSrvrMinResTime=httpSrvrMinResTime, uptime=uptime, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrNumConn=sslSrvrNumConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyPort=sslProxyPort, bwsTrapGroup=bwsTrapGroup, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsHdrAclPort=ipsHdrAclPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, vipStatus=vipStatus, sslProxyTotalConn=sslProxyTotalConn, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsCookieSecAddress=ipsCookieSecAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, switchingToMaintMode=switchingToMaintMode, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serviceStatus=serviceStatus, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqSrvcPort=ipsReqSrvcPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, cpuFanSpeed=cpuFanSpeed)
