...
TimeTicks, Counter32, ModuleIdentity, Unsigned32, IpAddress, MibIdentifier, NotificationType, iso, Integer32, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "ModuleIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "iso", "Integer32", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAvgResTime=httpSrvrAvgResTime, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, operationalMode=operationalMode, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, cpuFanSpeed=cpuFanSpeed, raidDegrading=raidDegrading, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, currentFirmwareVersion=currentFirmwareVersion, processCountHigh=processCountHigh, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrState=sslSrvrState, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrAddress=sslSrvrAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, webCachePort=webCachePort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsStats=bwsStats, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwstraps=bwstraps, switchingToInlineMode=switchingToInlineMode, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrAddressType=httpSrvrAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheHits=webCacheHits, memUtilization=memUtilization, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyPort=sslProxyPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsRCPort=ipsRCPort, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsHdrAclAddress=ipsHdrAclAddress, dataPortLinkDown=dataPortLinkDown, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqSrvcAddressType=ipsReqSrvcAddressType, totalServers=totalServers, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlAclAddressType=ipsUrlAclAddressType, dataPathStatus=dataPathStatus, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyPort=ipsUrlPolicyPort, activeApplications=activeApplications, smAgentName=smAgentName, ipsReqSrvcAddress=ipsReqSrvcAddress, sslProxyOutBytes=sslProxyOutBytes, ipsReqLimitPort=ipsReqLimitPort, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrTotSuccess=httpSrvrTotSuccess, serverDown=serverDown, smRealmName=smRealmName, cpuTemperature=cpuTemperature, ipsCookieSecPort=ipsCookieSecPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsCacheStatsTable=bwsCacheStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCmprPort=webCmprPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCacheMiss=webCacheMiss, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrMinResTime=sslSrvrMinResTime, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, activeServers=activeServers, ipsRCTotServed=ipsRCTotServed, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, firmwareStorage=firmwareStorage, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyAddress=sslProxyAddress, serviceName=serviceName, ipsCookieSecAddress=ipsCookieSecAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMIBGroups=bwsMIBGroups, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, serviceStatus=serviceStatus, webCacheCacheableRes=webCacheCacheableRes, bwsStatsGroup=bwsStatsGroup, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsSslProxyStatsTable=bwsSslProxyStatsTable, uptime=uptime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, totalApplications=totalApplications, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheStale=webCacheStale, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheLongHdrs=webCacheLongHdrs, tempHigh=tempHigh, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, freeMem=freeMem, tempCritical=tempCritical, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, systemFailOver=systemFailOver, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyActiveConn=httpProxyActiveConn, serverUp=serverUp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, systemLoad=systemLoad, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, serviceAddress=serviceAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, firmwareStorageHigh=firmwareStorageHigh, switchingToMaintMode=switchingToMaintMode, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCAddress=ipsRCAddress, energizeUpdateExpire=energizeUpdateExpire, webCmprProtocol=webCmprProtocol, peerUp=peerUp, sslProxyAddressType=sslProxyAddressType, ipsRCTotDropped=ipsRCTotDropped, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrState=httpSrvrState, httpSrvrPort=httpSrvrPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprAddressType=webCmprAddressType, httpProxyParseErr=httpProxyParseErr, PYSNMP_MODULE_ID=bws, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, cpuUtilization=cpuUtilization, sslSrvrInBytes=sslSrvrInBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, logStorage=logStorage, totalMem=totalMem, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyServerReq=httpProxyServerReq, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyAddress=httpProxyAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrPort=sslSrvrPort, httpSrvrInBytes=httpSrvrInBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, systemFailure=systemFailure, sslProxyTotalReq=sslProxyTotalReq, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrTotReqRejected=sslSrvrTotReqRejected, totalAttacks=totalAttacks, fanDead=fanDead, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, logStorageHigh=logStorageHigh, sslProxyTotalConn=sslProxyTotalConn, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyUnknownRsp=httpProxyUnknownRsp, virusDefUpdates=virusDefUpdates, bwsMessage=bwsMessage, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, dataPortLinkUp=dataPortLinkUp, sslSrvrAddressType=sslSrvrAddressType, ipsUrlNormPort=ipsUrlNormPort, httpSrvrNumConn=httpSrvrNumConn, webCacheCachedObjects=webCacheCachedObjects, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyInBytes=sslProxyInBytes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrTotReqActive=sslSrvrTotReqActive, smNumUserSessions=smNumUserSessions, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlAclPort=ipsUrlAclPort, sslProxyErrPms=sslProxyErrPms, vipStatus=vipStatus, webCacheAddress=webCacheAddress, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMIBCompliances=bwsMIBCompliances, ipsRCTimeStamp=ipsRCTimeStamp, webCmprAddress=webCmprAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyTotalConn=httpProxyTotalConn, webCacheBytesOut=webCacheBytesOut, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyPort=httpProxyPort, httpProxyAddressType=httpProxyAddressType, switchingToBypassMode=switchingToBypassMode, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheReq=webCacheReq, srvcName=srvcName, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyCacheHits=sslProxyCacheHits, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrAddress=httpSrvrAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sharedSecretKeyExpired=sharedSecretKeyExpired, memoryUsageHigh=memoryUsageHigh, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrNumConn=sslSrvrNumConn, bws=bws, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrTotResponse=httpSrvrTotResponse, bwsMIBConformance=bwsMIBConformance, linkStatus=linkStatus, totalBandwidth=totalBandwidth, systemFanSpeed=systemFanSpeed, peerDown=peerDown, highAvailabilityStatus=highAvailabilityStatus, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, servicePort=servicePort, httpProxyServerAbrt=httpProxyServerAbrt, webCacheProtocol=webCacheProtocol, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, systemSerialNumber=systemSerialNumber, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqSrvcPort=ipsReqSrvcPort, ipsRCAddressType=ipsRCAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyInBytes=httpProxyInBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheAddressType=webCacheAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth)
