...
Unsigned32, NotificationType, IpAddress, Counter32, ModuleIdentity, ObjectIdentity, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, iso, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "IpAddress", "Counter32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "iso", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitAddressType=ipsReqLimitAddressType, currentFirmwareVersion=currentFirmwareVersion, bwsIpsRCStatsTable=bwsIpsRCStatsTable, activeServers=activeServers, totalApplications=totalApplications, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheAddressType=webCacheAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, memUtilization=memUtilization, ipsRCAddressType=ipsRCAddressType, bwsStats=bwsStats, dataPortLinkDown=dataPortLinkDown, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyServerReq=httpProxyServerReq, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrMinResTime=httpSrvrMinResTime, servicePort=servicePort, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrState=sslSrvrState, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyInBytes=sslProxyInBytes, serverUp=serverUp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsRCTotServed=ipsRCTotServed, httpSrvrState=httpSrvrState, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, logStorage=logStorage, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, operationalMode=operationalMode, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, uptime=uptime, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, dataPortLinkUp=dataPortLinkUp, smAgentName=smAgentName, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsMIBCompliance=bwsMIBCompliance, sslProxyOutBytes=sslProxyOutBytes, tempHigh=tempHigh, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheLongHdrs=webCacheLongHdrs, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyCurrentConn=sslProxyCurrentConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsServiceStatusTable=bwsServiceStatusTable, ipsHdrAclPort=ipsHdrAclPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, systemFanSpeed=systemFanSpeed, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrMinResTime=sslSrvrMinResTime, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, memoryUsageHigh=memoryUsageHigh, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, fanDead=fanDead, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, totalServers=totalServers, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyWAFWarnings=httpProxyWAFWarnings, systemFailOver=systemFailOver, ipsReqLimitPort=ipsReqLimitPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, webCmprAddress=webCmprAddress, sslProxyCacheHits=sslProxyCacheHits, vipStatus=vipStatus, sslSrvrAddressType=sslSrvrAddressType, firmwareStorageHigh=firmwareStorageHigh, sslSrvrPort=sslSrvrPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, totalMem=totalMem, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrOutBytes=httpSrvrOutBytes, webCacheStale=webCacheStale, webCacheProtocol=webCacheProtocol, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyAddress=httpProxyAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, energizeUpdateExpire=energizeUpdateExpire, sslSrvrInBytes=sslSrvrInBytes, httpSrvrAddressType=httpSrvrAddressType, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrOutBytes=sslSrvrOutBytes, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotResponse=httpSrvrTotResponse, virusDefUpdates=virusDefUpdates, systemLoad=systemLoad, sslProxyAddress=sslProxyAddress, sslProxyAddressType=sslProxyAddressType, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyBadDNCErr=sslProxyBadDNCErr, activeApplications=activeApplications, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyTotalReq=httpProxyTotalReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, systemFailure=systemFailure, srvcName=srvcName, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyParseErr=httpProxyParseErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyTotalConn=sslProxyTotalConn, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotDropped=ipsRCTotDropped, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, totalAttacks=totalAttacks, bwsMIBGroups=bwsMIBGroups, webCacheAddress=webCacheAddress, peerDown=peerDown, sslProxyPort=sslProxyPort, webCacheCachedObjects=webCacheCachedObjects, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, serviceStatus=serviceStatus, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, serverDown=serverDown, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrTotReqActive=httpSrvrTotReqActive, webCmprProtocol=webCmprProtocol, webCacheBytesOut=webCacheBytesOut, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, webCmprPort=webCmprPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsMIBCompliances=bwsMIBCompliances, switchingToMaintMode=switchingToMaintMode, cpuUtilization=cpuUtilization, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyActiveConn=httpProxyActiveConn, webCmprAddressType=webCmprAddressType, ipsRCTotQueued=ipsRCTotQueued, sslProxyTotalReq=sslProxyTotalReq, sharedSecretKeyExpired=sharedSecretKeyExpired, dataPathStatus=dataPathStatus, httpSrvrNumConn=httpSrvrNumConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrTotSuccess=httpSrvrTotSuccess, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormPort=ipsUrlNormPort, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrAddress=httpSrvrAddress, webCacheReq=webCacheReq, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, peerUp=peerUp, cpuFanSpeed=cpuFanSpeed, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCAddress=ipsRCAddress, bwsMIBConformance=bwsMIBConformance, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsHdrAclHits=ipsHdrAclHits, tempCritical=tempCritical, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsMessage=bwsMessage, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsRCPort=ipsRCPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsCacheStatsEntry=bwsCacheStatsEntry, freeMem=freeMem, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCachePort=webCachePort, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsTrapGroup=bwsTrapGroup, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrTotRefused=httpSrvrTotRefused, webCacheHits=webCacheHits, httpProxyInBytes=httpProxyInBytes)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddress=ipsUrlNormAddress, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumConn=sslSrvrNumConn, systemSerialNumber=systemSerialNumber, ipsUrlAclAddressType=ipsUrlAclAddressType, bwstraps=bwstraps, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, firmwareStorage=firmwareStorage, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrAddress=sslSrvrAddress, PYSNMP_MODULE_ID=bws, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyServerErr=httpProxyServerErr, ipsUrlAclPort=ipsUrlAclPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, linkStatus=linkStatus, ipsCookieSecPort=ipsCookieSecPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyPort=httpProxyPort, serviceAddress=serviceAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyOutBytes=httpProxyOutBytes, raidDegrading=raidDegrading, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, securityDefUpdates=securityDefUpdates, smRealmName=smRealmName, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsCacheStatsTable=bwsCacheStatsTable, bws=bws, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrPort=httpSrvrPort, processCountHigh=processCountHigh, httpSrvrInBytes=httpSrvrInBytes, totalBandwidth=totalBandwidth, smNumUserSessions=smNumUserSessions, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, switchingToBypassMode=switchingToBypassMode, webCacheMiss=webCacheMiss, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, logStorageHigh=logStorageHigh, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyErrPms=sslProxyErrPms, serviceName=serviceName, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, cpuTemperature=cpuTemperature, switchingToInlineMode=switchingToInlineMode)
