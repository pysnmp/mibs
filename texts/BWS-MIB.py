...
Bits, IpAddress, Gauge32, TimeTicks, MibIdentifier, Counter64, Counter32, Integer32, ModuleIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Gauge32", "TimeTicks", "MibIdentifier", "Counter64", "Counter32", "Integer32", "ModuleIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, currentFirmwareVersion=currentFirmwareVersion, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, serverDown=serverDown, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrTotRefused=httpSrvrTotRefused, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, servicePort=servicePort, webCacheProtocol=webCacheProtocol, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, systemLoad=systemLoad, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyCacheMiss=sslProxyCacheMiss, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclPort=ipsUrlAclPort, sslSrvrPort=sslSrvrPort, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, dataPortLinkUp=dataPortLinkUp, freeMem=freeMem, ipsUrlAclReserved=ipsUrlAclReserved, bws=bws, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, memUtilization=memUtilization, peerDown=peerDown, sslProxyOutBytes=sslProxyOutBytes, webCacheHits=webCacheHits, sslSrvrMaxResTime=sslSrvrMaxResTime, energizeUpdateExpire=energizeUpdateExpire, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, totalMem=totalMem, bwsMessage=bwsMessage, dataPathStatus=dataPathStatus, serviceName=serviceName, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheReq=webCacheReq, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyAddress=httpProxyAddress, webCmprAddress=webCmprAddress, systemFailOver=systemFailOver, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrInBytes=sslSrvrInBytes, smRealmName=smRealmName, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, cpuTemperature=cpuTemperature, bwsTrapGroup=bwsTrapGroup, httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrOutBytes=httpSrvrOutBytes, switchingToMaintMode=switchingToMaintMode, httpProxyActiveConn=httpProxyActiveConn, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, logStorageHigh=logStorageHigh, switchingToInlineMode=switchingToInlineMode, httpProxyAddressType=httpProxyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsRCPort=ipsRCPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCTotOutOfResource=ipsRCTotOutOfResource, highAvailabilityStatus=highAvailabilityStatus, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrNumConn=httpSrvrNumConn, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyPort=sslProxyPort, linkStatus=linkStatus, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheMiss=webCacheMiss, webCacheBytesOut=webCacheBytesOut, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyTotalConn=httpProxyTotalConn, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyInBytes=sslProxyInBytes, bwsMIBConformance=bwsMIBConformance, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, smNumUserSessions=smNumUserSessions, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyPort=httpProxyPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyBadCRLErr=sslProxyBadCRLErr, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrState=sslSrvrState, sslSrvrOutBytes=sslSrvrOutBytes, switchingToBypassMode=switchingToBypassMode, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlNormPort=ipsUrlNormPort, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyTotalReq=httpProxyTotalReq, systemFanSpeed=systemFanSpeed, sslProxyBadDNCErr=sslProxyBadDNCErr, srvcName=srvcName, totalServers=totalServers, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsCookieSecAddress=ipsCookieSecAddress, cpuUtilization=cpuUtilization, httpProxyParseErr=httpProxyParseErr, sslProxyAddress=sslProxyAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsCacheStatsTable=bwsCacheStatsTable, vipStatus=vipStatus, firmwareStorageHigh=firmwareStorageHigh, ipsRCAddress=ipsRCAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyInBytes=httpProxyInBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, processCountHigh=processCountHigh, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, serverUp=serverUp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrAddressType=httpSrvrAddressType, firmwareStorage=firmwareStorage, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, totalAttacks=totalAttacks, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsStats=bwsStats, httpSrvrState=httpSrvrState, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyOutBytes=httpProxyOutBytes, webCacheCachedObjects=webCacheCachedObjects, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsRCTotServed=ipsRCTotServed, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, PYSNMP_MODULE_ID=bws, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsStatsGroup=bwsStatsGroup, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, fanDead=fanDead, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcPort=ipsLrnSrvcPort, logStorage=logStorage, activeApplications=activeApplications, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, uptime=uptime, sslSrvrAddress=sslSrvrAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwstraps=bwstraps, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsMIBCompliance=bwsMIBCompliance, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheAddress=webCacheAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, operationalMode=operationalMode, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, webCacheAddressType=webCacheAddressType, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyCacheHits=sslProxyCacheHits, smAgentName=smAgentName, bwsMIBCompliances=bwsMIBCompliances, webCmprPort=webCmprPort, totalApplications=totalApplications, systemFailure=systemFailure, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsRCTotDropped=ipsRCTotDropped, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitPort=ipsReqLimitPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCmprAddressType=webCmprAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, memoryUsageHigh=memoryUsageHigh, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, cpuFanSpeed=cpuFanSpeed, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrAddress=httpSrvrAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCachePort=webCachePort, sslProxyErrPms=sslProxyErrPms, systemSerialNumber=systemSerialNumber, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, raidDegrading=raidDegrading, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsCacheStatsEntry=bwsCacheStatsEntry, tempHigh=tempHigh, webCmprProtocol=webCmprProtocol, webCacheStale=webCacheStale, sslSrvrSrvcPort=sslSrvrSrvcPort, virusDefUpdates=virusDefUpdates, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrInBytes=httpSrvrInBytes, peerUp=peerUp, sslProxyAddressType=sslProxyAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsSMUserSessionTable=bwsSMUserSessionTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyServerErr=httpProxyServerErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrPort=httpSrvrPort, ipsHdrAclHits=ipsHdrAclHits, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotResponse=sslSrvrTotResponse, totalBandwidth=totalBandwidth, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsMIBGroups=bwsMIBGroups, sslSrvrMinResTime=sslSrvrMinResTime, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheLongHdrs=webCacheLongHdrs, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheCacheableRes=webCacheCacheableRes, ipsRCAddressType=ipsRCAddressType, serviceAddress=serviceAddress, securityDefUpdates=securityDefUpdates, tempCritical=tempCritical, ipsRCTotQueued=ipsRCTotQueued, activeServers=activeServers, serviceStatus=serviceStatus, sslProxyTotalConn=sslProxyTotalConn)
