...
TimeTicks, NotificationType, Unsigned32, MibIdentifier, iso, ModuleIdentity, Bits, IpAddress, ObjectIdentity, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Unsigned32", "MibIdentifier", "iso", "ModuleIdentity", "Bits", "IpAddress", "ObjectIdentity", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, serverDown=serverDown, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyPort=sslProxyPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCTotServed=ipsRCTotServed, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, smNumUserSessions=smNumUserSessions, bwstraps=bwstraps, webCmprAddressType=webCmprAddressType, activeServers=activeServers, cpuFanSpeed=cpuFanSpeed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrAddressType=sslSrvrAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, servicePort=servicePort, serviceStatus=serviceStatus, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyAddress=httpProxyAddress, switchingToBypassMode=switchingToBypassMode, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCmprProtocol=webCmprProtocol, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyInBytes=sslProxyInBytes, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyAddressType=sslProxyAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrState=sslSrvrState, httpSrvrState=httpSrvrState, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCacheHits=webCacheHits, sslProxyAddress=sslProxyAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyOutBytes=httpProxyOutBytes, systemFanSpeed=systemFanSpeed, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCacheMiss=webCacheMiss, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, cpuUtilization=cpuUtilization, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCachePort=webCachePort, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheStale=webCacheStale, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, systemSerialNumber=systemSerialNumber, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, PYSNMP_MODULE_ID=bws, highAvailabilityStatus=highAvailabilityStatus, httpProxyInBytes=httpProxyInBytes, serviceAddress=serviceAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, peerUp=peerUp, bwsMIBCompliance=bwsMIBCompliance, ipsUrlAclPort=ipsUrlAclPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, srvcName=srvcName, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsStats=bwsStats, httpProxyClientAbrt=httpProxyClientAbrt, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, systemFailOver=systemFailOver, activeApplications=activeApplications, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, smRealmName=smRealmName, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyOutBytes=sslProxyOutBytes, httpProxyParseErr=httpProxyParseErr, bwsMIBGroups=bwsMIBGroups, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyAddressType=httpProxyAddressType, cpuTemperature=cpuTemperature, ipsRCAddressType=ipsRCAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, totalBandwidth=totalBandwidth, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, totalAttacks=totalAttacks, totalApplications=totalApplications, sslSrvrNumConn=sslSrvrNumConn, httpProxyActiveConn=httpProxyActiveConn, securityDefUpdates=securityDefUpdates, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsMIBConformance=bwsMIBConformance, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, tempCritical=tempCritical, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCPort=ipsRCPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheCacheableRes=webCacheCacheableRes, virusDefUpdates=virusDefUpdates, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, firmwareStorage=firmwareStorage, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyTotalConn=sslProxyTotalConn, webCmprPort=webCmprPort, sslSrvrAddress=sslSrvrAddress, peerDown=peerDown, ipsCookieSecAddress=ipsCookieSecAddress, logStorage=logStorage, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsCookieSecPort=ipsCookieSecPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrMinResTime=httpSrvrMinResTime, ipsHdrAclPort=ipsHdrAclPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrOutBytes=httpSrvrOutBytes, serviceName=serviceName, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrPort=httpSrvrPort, ipsRCTotQueued=ipsRCTotQueued, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, energizeUpdateExpire=energizeUpdateExpire, systemFailure=systemFailure, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyPort=httpProxyPort, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCAddress=ipsRCAddress, httpSrvrAddressType=httpSrvrAddressType, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, freeMem=freeMem, webCacheBytesOut=webCacheBytesOut, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlNormAddress=ipsUrlNormAddress, dataPortLinkUp=dataPortLinkUp, sslSrvrPort=sslSrvrPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, serverUp=serverUp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsStatsGroup=bwsStatsGroup, ipsReqLimitPort=ipsReqLimitPort, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsRCTotDropped=ipsRCTotDropped, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, totalMem=totalMem, smAgentName=smAgentName, ipsReqLimitAddress=ipsReqLimitAddress, totalServers=totalServers, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclAddress=ipsUrlAclAddress, ipsHdrAclHits=ipsHdrAclHits, firmwareStorageHigh=firmwareStorageHigh)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrAvgResTime=sslSrvrAvgResTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheProtocol=webCacheProtocol, httpProxyServerErr=httpProxyServerErr, sslProxyErrPms=sslProxyErrPms, webCacheCachedObjects=webCacheCachedObjects, bwsMIBCompliances=bwsMIBCompliances, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, operationalMode=operationalMode, httpProxyServerReq=httpProxyServerReq, webCacheAddress=webCacheAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, fanDead=fanDead, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyActiveConn=sslProxyActiveConn, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsMessage=bwsMessage, currentFirmwareVersion=currentFirmwareVersion, httpSrvrSrvcPort=httpSrvrSrvcPort, vipStatus=vipStatus, sslSrvrInBytes=sslSrvrInBytes, memUtilization=memUtilization, httpSrvrAddress=httpSrvrAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, processCountHigh=processCountHigh, httpProxyTotalConn=httpProxyTotalConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, memoryUsageHigh=memoryUsageHigh, tempHigh=tempHigh, switchingToMaintMode=switchingToMaintMode, logStorageHigh=logStorageHigh, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, dataPortLinkDown=dataPortLinkDown, raidDegrading=raidDegrading, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyTotalReq=sslProxyTotalReq, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, dataPathStatus=dataPathStatus, linkStatus=linkStatus, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bws=bws, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, uptime=uptime, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheReq=webCacheReq, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCmprAddress=webCmprAddress, systemLoad=systemLoad, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated)
