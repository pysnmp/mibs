...
NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Counter64, Integer32, Unsigned32, ModuleIdentity, Bits, TimeTicks, iso, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Counter64", "Integer32", "Unsigned32", "ModuleIdentity", "Bits", "TimeTicks", "iso", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyAddressType=httpProxyAddressType, httpSrvrState=httpSrvrState, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheAddressType=webCacheAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrAddress=httpSrvrAddress, ipsCookieSecAddress=ipsCookieSecAddress, dataPathStatus=dataPathStatus, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, virusDefUpdates=virusDefUpdates, currentFirmwareVersion=currentFirmwareVersion, freeMem=freeMem, webCmprPort=webCmprPort, firmwareStorage=firmwareStorage, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bws=bws, bwsMessage=bwsMessage, sslProxyTotalConn=sslProxyTotalConn, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyPort=httpProxyPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, systemSerialNumber=systemSerialNumber, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, serverDown=serverDown, switchingToInlineMode=switchingToInlineMode, bwsMIBCompliances=bwsMIBCompliances, webCmprProtocol=webCmprProtocol, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqSrvcPort=ipsReqSrvcPort, webCacheCacheableRes=webCacheCacheableRes, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, serviceName=serviceName, ipsHdrAclAddressType=ipsHdrAclAddressType, activeServers=activeServers, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrState=sslSrvrState, cpuUtilization=cpuUtilization, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, smRealmName=smRealmName, sslProxyInBytes=sslProxyInBytes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyCacheHits=sslProxyCacheHits, memoryUsageHigh=memoryUsageHigh, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsServiceStatusTable=bwsServiceStatusTable, webCmprAddress=webCmprAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCTimeStamp=ipsRCTimeStamp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyServerErr=httpProxyServerErr, cpuTemperature=cpuTemperature, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyAddress=sslProxyAddress, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, systemFailOver=systemFailOver, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, peerUp=peerUp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, uptime=uptime, totalApplications=totalApplications, securityDefUpdates=securityDefUpdates, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCmprAddressType=webCmprAddressType, sslProxyOutBytes=sslProxyOutBytes, switchingToMaintMode=switchingToMaintMode, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, operationalMode=operationalMode, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyTotalConn=httpProxyTotalConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheStale=webCacheStale, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheCachedObjects=webCacheCachedObjects, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, tempCritical=tempCritical, bwsStatsGroup=bwsStatsGroup, ipsRCTotServed=ipsRCTotServed, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsMIBGroups=bwsMIBGroups, ipsCookieSecTampered=ipsCookieSecTampered, webCacheProtocol=webCacheProtocol, ipsUrlAclReserved=ipsUrlAclReserved, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, raidDegrading=raidDegrading, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, totalAttacks=totalAttacks, ipsUrlAclPort=ipsUrlAclPort, webCacheBytesOut=webCacheBytesOut, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, webCacheHits=webCacheHits, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, totalBandwidth=totalBandwidth, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwstraps=bwstraps, totalMem=totalMem, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyTotalReq=sslProxyTotalReq, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, logStorageHigh=logStorageHigh, processCountHigh=processCountHigh, energizeUpdateExpire=energizeUpdateExpire, ipsHdrAclAddress=ipsHdrAclAddress, firmwareStorageHigh=firmwareStorageHigh, ipsHdrAclPort=ipsHdrAclPort, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyParseErr=httpProxyParseErr, ipsRCPort=ipsRCPort, linkStatus=linkStatus, PYSNMP_MODULE_ID=bws, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqLimitPort=ipsReqLimitPort, sslSrvrMinResTime=sslSrvrMinResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serverUp=serverUp, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyPort=sslProxyPort, activeApplications=activeApplications, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, vipStatus=vipStatus, httpProxyTotalReq=httpProxyTotalReq, tempHigh=tempHigh, dataPortLinkUp=dataPortLinkUp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, smAgentName=smAgentName, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, systemFailure=systemFailure, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrAvgResTime=sslSrvrAvgResTime, switchingToBypassMode=switchingToBypassMode, ipsRCTotQueued=ipsRCTotQueued, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, totalServers=totalServers, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, bwsSMUserSessionTable=bwsSMUserSessionTable, serviceStatus=serviceStatus, httpSrvrAvgResTime=httpSrvrAvgResTime, sslProxyAddressType=sslProxyAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyServerReq=httpProxyServerReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsHdrAclHits=ipsHdrAclHits, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyActiveConn=httpProxyActiveConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, memUtilization=memUtilization, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAddressType=httpSrvrAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, dataPortLinkDown=dataPortLinkDown, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, bwsStats=bwsStats, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrPort=httpSrvrPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrInBytes=httpSrvrInBytes, fanDead=fanDead, ipsRCAddress=ipsRCAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCacheMiss=webCacheMiss, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsCompressionStatsTable=bwsCompressionStatsTable)
mibBuilder.exportSymbols("BWS-MIB", peerDown=peerDown, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrMaxResTime=httpSrvrMaxResTime, highAvailabilityStatus=highAvailabilityStatus, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, systemFanSpeed=systemFanSpeed, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, smNumUserSessions=smNumUserSessions, systemLoad=systemLoad, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCTotDropped=ipsRCTotDropped, webCacheAddress=webCacheAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, servicePort=servicePort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyErrPms=sslProxyErrPms, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrAddressType=sslSrvrAddressType, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsRCAddressType=ipsRCAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, bwsServiceStatusEntry=bwsServiceStatusEntry, serviceAddress=serviceAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, srvcName=srvcName, sslSrvrInBytes=sslSrvrInBytes, logStorage=logStorage, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumConn=sslSrvrNumConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyInBytes=httpProxyInBytes, bwsMIBCompliance=bwsMIBCompliance, sslSrvrPort=sslSrvrPort, sslSrvrAddress=sslSrvrAddress, httpSrvrNumConn=httpSrvrNumConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCacheReq=webCacheReq, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyActiveConn=sslProxyActiveConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyCacheMiss=sslProxyCacheMiss, bwsMIBConformance=bwsMIBConformance, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyAddress=httpProxyAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCachePort=webCachePort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions)
