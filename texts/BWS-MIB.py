...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Gauge32, Unsigned32, iso, MibIdentifier, TimeTicks, Bits, Integer32, Counter32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Gauge32", "Unsigned32", "iso", "MibIdentifier", "TimeTicks", "Bits", "Integer32", "Counter32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", webCmprAddress=webCmprAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrPort=sslSrvrPort, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsServiceStatusTable=bwsServiceStatusTable, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlNormAddress=ipsUrlNormAddress, switchingToBypassMode=switchingToBypassMode, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyTotalReq=httpProxyTotalReq, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, processCountHigh=processCountHigh, webCacheAddressType=webCacheAddressType, logStorageHigh=logStorageHigh, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCAddress=ipsRCAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, dataPathStatus=dataPathStatus, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheMiss=webCacheMiss, activeServers=activeServers, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, cpuFanSpeed=cpuFanSpeed, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serviceStatus=serviceStatus, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serviceAddress=serviceAddress, systemFanSpeed=systemFanSpeed, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrSrvcPort=httpSrvrSrvcPort, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyServerErr=httpProxyServerErr, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, memUtilization=memUtilization, sslProxyErrPms=sslProxyErrPms, switchingToMaintMode=switchingToMaintMode, totalMem=totalMem, ipsRCAddressType=ipsRCAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, switchingToInlineMode=switchingToInlineMode, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsCookieSecPort=ipsCookieSecPort, bwsMessage=bwsMessage, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsRCTotQueued=ipsRCTotQueued, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrState=sslSrvrState, srvcName=srvcName, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, servicePort=servicePort, activeApplications=activeApplications, memoryUsageHigh=memoryUsageHigh, httpProxyServerReq=httpProxyServerReq, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyOutBytes=httpProxyOutBytes, tempHigh=tempHigh, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyAddressType=sslProxyAddressType, webCacheCacheableRes=webCacheCacheableRes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrInBytes=sslSrvrInBytes, httpProxyPort=httpProxyPort, httpProxyAddress=httpProxyAddress, logStorage=logStorage, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsHdrAclPort=ipsHdrAclPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrAddress=httpSrvrAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, virusDefUpdates=virusDefUpdates, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, serviceName=serviceName, peerUp=peerUp, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsHdrAclAddress=ipsHdrAclAddress, ipsRCTimeStamp=ipsRCTimeStamp, tempCritical=tempCritical, httpSrvrOutBytes=httpSrvrOutBytes, webCacheHits=webCacheHits, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsMIBCompliance=bwsMIBCompliance, freeMem=freeMem, totalServers=totalServers, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotServed=ipsRCTotServed, totalBandwidth=totalBandwidth, raidDegrading=raidDegrading, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsMIBCompliances=bwsMIBCompliances, sslProxyTotalReq=sslProxyTotalReq, webCacheReq=webCacheReq, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, dataPortLinkDown=dataPortLinkDown, sslSrvrMaxResTime=sslSrvrMaxResTime, smNumUserSessions=smNumUserSessions, httpSrvrTotResponse=httpSrvrTotResponse, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyActiveConn=sslProxyActiveConn, sslProxyBadCRLErr=sslProxyBadCRLErr, bws=bws, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, systemFailure=systemFailure, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, energizeUpdateExpire=energizeUpdateExpire, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, systemLoad=systemLoad, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, operationalMode=operationalMode, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, cpuTemperature=cpuTemperature, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrNumConn=httpSrvrNumConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsRCPort=ipsRCPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, systemFailOver=systemFailOver, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsStats=bwsStats, firmwareStorage=firmwareStorage, bwsStatsGroup=bwsStatsGroup, sslProxyOutBytes=sslProxyOutBytes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyInBytes=httpProxyInBytes, httpSrvrPort=httpSrvrPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyTotalConn=httpProxyTotalConn, webCacheCachedObjects=webCacheCachedObjects, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwstraps=bwstraps, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprAddressType=webCmprAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrAddressType=sslSrvrAddressType, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyActiveConn=httpProxyActiveConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrAddressType=httpSrvrAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, uptime=uptime, PYSNMP_MODULE_ID=bws, sslProxyPort=sslProxyPort, httpSrvrState=httpSrvrState, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheProtocol=webCacheProtocol, totalApplications=totalApplications, webCacheBytesOut=webCacheBytesOut, sslSrvrNumConn=sslSrvrNumConn, httpSrvrInBytes=httpSrvrInBytes, webCacheStale=webCacheStale, ipsRCTotDropped=ipsRCTotDropped, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyAddress=sslProxyAddress, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsHdrAclHits=ipsHdrAclHits, cpuUtilization=cpuUtilization)
mibBuilder.exportSymbols("BWS-MIB", securityDefUpdates=securityDefUpdates, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, fanDead=fanDead, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, bwsMIBGroups=bwsMIBGroups, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyAddressType=httpProxyAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprProtocol=webCmprProtocol, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, vipStatus=vipStatus, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCmprPort=webCmprPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsMIBConformance=bwsMIBConformance, webCachePort=webCachePort, dataPortLinkUp=dataPortLinkUp, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, linkStatus=linkStatus, totalAttacks=totalAttacks, systemSerialNumber=systemSerialNumber, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclPort=ipsUrlAclPort, bwsTrapGroup=bwsTrapGroup, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, peerDown=peerDown, sslProxyCacheHits=sslProxyCacheHits, serverDown=serverDown, webCacheAddress=webCacheAddress, smAgentName=smAgentName, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlNormPort=ipsUrlNormPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, smRealmName=smRealmName, serverUp=serverUp)
