...
Bits, Integer32, TimeTicks, Gauge32, IpAddress, ObjectIdentity, ModuleIdentity, Counter32, NotificationType, iso, Unsigned32, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "TimeTicks", "Gauge32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Counter32", "NotificationType", "iso", "Unsigned32", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, logStorageHigh=logStorageHigh, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyInBytes=sslProxyInBytes, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyPort=httpProxyPort, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyServerErr=httpProxyServerErr, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, totalServers=totalServers, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyTotalConn=httpProxyTotalConn, serviceAddress=serviceAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyPort=sslProxyPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, systemFailOver=systemFailOver, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprProtocol=webCmprProtocol, ipsLrnSrvcAddress=ipsLrnSrvcAddress, logStorage=logStorage, systemFanSpeed=systemFanSpeed, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrAddressType=sslSrvrAddressType, memUtilization=memUtilization, switchingToInlineMode=switchingToInlineMode, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, switchingToBypassMode=switchingToBypassMode, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheReq=webCacheReq, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecAddress=ipsCookieSecAddress, ipsHdrAclPort=ipsHdrAclPort, sslSrvrTotResponse=sslSrvrTotResponse, dataPortLinkUp=dataPortLinkUp, highAvailabilityStatus=highAvailabilityStatus, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCmprPort=webCmprPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCacheProtocol=webCacheProtocol, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, dataPortLinkDown=dataPortLinkDown, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheMiss=webCacheMiss, httpProxyOutBytes=httpProxyOutBytes, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, cpuUtilization=cpuUtilization, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsHdrAclHits=ipsHdrAclHits, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, systemSerialNumber=systemSerialNumber, httpSrvrNumConn=httpSrvrNumConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCTotDropped=ipsRCTotDropped, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, fanDead=fanDead, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheAddress=webCacheAddress, energizeUpdateExpire=energizeUpdateExpire, httpSrvrInBytes=httpSrvrInBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyUnknownRsp=httpProxyUnknownRsp, serverUp=serverUp, sslSrvrAddress=sslSrvrAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, linkStatus=linkStatus, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, totalAttacks=totalAttacks, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsRCPort=ipsRCPort, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCacheBytesOut=webCacheBytesOut, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsRCTotQueued=ipsRCTotQueued, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrMinResTime=httpSrvrMinResTime, operationalMode=operationalMode, peerUp=peerUp, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrState=httpSrvrState, totalMem=totalMem, webCacheCacheableRes=webCacheCacheableRes, ipsUrlAclPort=ipsUrlAclPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, serverDown=serverDown, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, peerDown=peerDown, smRealmName=smRealmName, sslSrvrNumConn=sslSrvrNumConn, bws=bws, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, uptime=uptime, ipsRCTotOutOfResource=ipsRCTotOutOfResource, serviceStatus=serviceStatus, cpuTemperature=cpuTemperature, processCountHigh=processCountHigh, ipsReqLimitPort=ipsReqLimitPort, httpProxyParseErr=httpProxyParseErr, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrInBytes=sslSrvrInBytes, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyErrPms=sslProxyErrPms, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyAddressType=sslProxyAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, cpuFanSpeed=cpuFanSpeed, sslProxyTotalReq=sslProxyTotalReq, bwsMIBGroups=bwsMIBGroups, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyTotalReq=httpProxyTotalReq, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheLongHdrs=webCacheLongHdrs, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsRCAddress=ipsRCAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, virusDefUpdates=virusDefUpdates, webCacheAddressType=webCacheAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemLoad=systemLoad, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, freeMem=freeMem, memoryUsageHigh=memoryUsageHigh, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsRCTotServed=ipsRCTotServed, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCmprAddress=webCmprAddress, smNumUserSessions=smNumUserSessions, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCachePort=webCachePort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, firmwareStorage=firmwareStorage, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, serviceName=serviceName, httpSrvrAddressType=httpSrvrAddressType, httpSrvrPort=httpSrvrPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, switchingToMaintMode=switchingToMaintMode, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, PYSNMP_MODULE_ID=bws, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyCacheMiss=sslProxyCacheMiss, bwsMIBConformance=bwsMIBConformance, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, smAgentName=smAgentName, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsStats=bwsStats, httpProxyClientAbrt=httpProxyClientAbrt, webCacheStale=webCacheStale, bwstraps=bwstraps, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, totalApplications=totalApplications, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrTotTimedout=sslSrvrTotTimedout, tempHigh=tempHigh, tempCritical=tempCritical, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrPort=sslSrvrPort, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyAddressType=httpProxyAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress)
mibBuilder.exportSymbols("BWS-MIB", bwsSMUserSessionTable=bwsSMUserSessionTable, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsRCAddressType=ipsRCAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCacheCachedObjects=webCacheCachedObjects, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, securityDefUpdates=securityDefUpdates, httpProxyInBytes=httpProxyInBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCmprAddressType=webCmprAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyCacheHits=sslProxyCacheHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsTrapGroup=bwsTrapGroup, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsMessage=bwsMessage, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsMIBCompliances=bwsMIBCompliances, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, servicePort=servicePort, activeServers=activeServers, sslProxyAddress=sslProxyAddress, dataPathStatus=dataPathStatus, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlNormPort=ipsUrlNormPort, webCacheHits=webCacheHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, srvcName=srvcName, sslProxyBadCRLErr=sslProxyBadCRLErr, activeApplications=activeApplications, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrState=sslSrvrState, bwsStatsGroup=bwsStatsGroup, httpProxyAddress=httpProxyAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, raidDegrading=raidDegrading, systemFailure=systemFailure, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrMaxResTime=sslSrvrMaxResTime, vipStatus=vipStatus, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyActiveConn=httpProxyActiveConn, totalBandwidth=totalBandwidth, sslProxyTotalConn=sslProxyTotalConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol)
