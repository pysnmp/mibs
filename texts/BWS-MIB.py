...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, MibIdentifier, Unsigned32, NotificationType, iso, ModuleIdentity, ObjectIdentity, TimeTicks, IpAddress, Counter32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "MibIdentifier", "Unsigned32", "NotificationType", "iso", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "IpAddress", "Counter32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, dataPortLinkUp=dataPortLinkUp, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, freeMem=freeMem, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsMIBConformance=bwsMIBConformance, dataPortLinkDown=dataPortLinkDown, ipsRCAddressType=ipsRCAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotRefused=sslSrvrTotRefused, webCacheMiss=webCacheMiss, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCacheAddressType=webCacheAddressType, sslSrvrAddressType=sslSrvrAddressType, systemFailOver=systemFailOver, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsRCPort=ipsRCPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, srvcName=srvcName, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheBytesOut=webCacheBytesOut, webCacheReq=webCacheReq, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrAddress=sslSrvrAddress, httpSrvrState=httpSrvrState, peerDown=peerDown, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, uptime=uptime, switchingToInlineMode=switchingToInlineMode, logStorage=logStorage, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsCookieSecTampered=ipsCookieSecTampered, virusDefUpdates=virusDefUpdates, totalMem=totalMem, ipsUrlAclAddress=ipsUrlAclAddress, bwsMIBGroups=bwsMIBGroups, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyParseErr=httpProxyParseErr, httpProxyInBytes=httpProxyInBytes, sslProxyErrPms=sslProxyErrPms, webCacheStale=webCacheStale, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsRCTotQueued=ipsRCTotQueued, httpProxyServerErr=httpProxyServerErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlNormPort=ipsUrlNormPort, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, smAgentName=smAgentName, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrOutBytes=httpSrvrOutBytes, webCmprPort=webCmprPort, cpuUtilization=cpuUtilization, totalServers=totalServers, httpSrvrPort=httpSrvrPort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, memoryUsageHigh=memoryUsageHigh, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrNumConn=httpSrvrNumConn, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyTotalReq=httpProxyTotalReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsHdrAclAddressType=ipsHdrAclAddressType, activeServers=activeServers, systemLoad=systemLoad, httpSrvrAddressType=httpSrvrAddressType, raidDegrading=raidDegrading, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, energizeUpdateExpire=energizeUpdateExpire, httpProxyActiveConn=httpProxyActiveConn, sslProxyOutBytes=sslProxyOutBytes, securityDefUpdates=securityDefUpdates, sslSrvrTotReqRejected=sslSrvrTotReqRejected, totalAttacks=totalAttacks, firmwareStorageHigh=firmwareStorageHigh, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlAclPort=ipsUrlAclPort, httpSrvrAddress=httpSrvrAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsHdrAclAddress=ipsHdrAclAddress, switchingToMaintMode=switchingToMaintMode, httpProxyPort=httpProxyPort, webCacheLongHdrs=webCacheLongHdrs, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCmprAddress=webCmprAddress, ipsHdrAclPort=ipsHdrAclPort, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, serviceAddress=serviceAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, fanDead=fanDead, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheAddress=webCacheAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitAddressType=ipsReqLimitAddressType, bwstraps=bwstraps, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, PYSNMP_MODULE_ID=bws, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheHits=webCacheHits, tempCritical=tempCritical, totalApplications=totalApplications, httpSrvrTotReqActive=httpSrvrTotReqActive, cpuTemperature=cpuTemperature, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, processCountHigh=processCountHigh, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, serviceStatus=serviceStatus, logStorageHigh=logStorageHigh, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrPort=sslSrvrPort, smRealmName=smRealmName, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCmprProtocol=webCmprProtocol, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, activeApplications=activeApplications, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrTotResponse=httpSrvrTotResponse, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, serviceName=serviceName, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyTotalConn=httpProxyTotalConn, sharedSecretKeyExpired=sharedSecretKeyExpired, totalBandwidth=totalBandwidth, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlNormAddress=ipsUrlNormAddress, systemFanSpeed=systemFanSpeed, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serverUp=serverUp, bwsMIBCompliance=bwsMIBCompliance, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, highAvailabilityStatus=highAvailabilityStatus, webCacheCacheableRes=webCacheCacheableRes, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, systemSerialNumber=systemSerialNumber, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCAddress=ipsRCAddress, memUtilization=memUtilization, sslProxyTotalConn=sslProxyTotalConn, webCacheProtocol=webCacheProtocol, webCachePort=webCachePort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyActiveConn=sslProxyActiveConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrState=sslSrvrState, httpProxyOutBytes=httpProxyOutBytes, systemFailure=systemFailure, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsMessage=bwsMessage, tempHigh=tempHigh, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrInBytes=httpSrvrInBytes, servicePort=servicePort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, ipsCookieSecPort=ipsCookieSecPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, firmwareStorage=firmwareStorage)
mibBuilder.exportSymbols("BWS-MIB", httpProxyAddress=httpProxyAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsStatsGroup=bwsStatsGroup, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyAddressType=httpProxyAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsRCTotDropped=ipsRCTotDropped, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyServerReq=httpProxyServerReq, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyBadCRLErr=sslProxyBadCRLErr, currentFirmwareVersion=currentFirmwareVersion, bws=bws, dataPathStatus=dataPathStatus, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, switchingToBypassMode=switchingToBypassMode, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsStats=bwsStats, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, serverDown=serverDown, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyPort=sslProxyPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsMIBCompliances=bwsMIBCompliances, sslProxyCacheHits=sslProxyCacheHits, sslProxyAddress=sslProxyAddress, sslProxyInBytes=sslProxyInBytes, sslSrvrNumConn=sslSrvrNumConn, httpSrvrTotRefused=httpSrvrTotRefused, peerUp=peerUp, ipsHdrAclHits=ipsHdrAclHits, linkStatus=linkStatus, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsTrapGroup=bwsTrapGroup, sslProxyTotalReq=sslProxyTotalReq, vipStatus=vipStatus, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, cpuFanSpeed=cpuFanSpeed, webCmprAddressType=webCmprAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, operationalMode=operationalMode, ipsRCTotServed=ipsRCTotServed, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrInBytes=sslSrvrInBytes, httpSrvrSrvcAddress=httpSrvrSrvcAddress)
