...
MibIdentifier, Bits, IpAddress, Counter32, NotificationType, Integer32, ModuleIdentity, Gauge32, Unsigned32, TimeTicks, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "IpAddress", "Counter32", "NotificationType", "Integer32", "ModuleIdentity", "Gauge32", "Unsigned32", "TimeTicks", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCmprAddressType=webCmprAddressType, sslProxyCacheHits=sslProxyCacheHits, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrPort=httpSrvrPort, ipsReqLimitAddressType=ipsReqLimitAddressType, smNumUserSessions=smNumUserSessions, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, currentFirmwareVersion=currentFirmwareVersion, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, servicePort=servicePort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, virusDefUpdates=virusDefUpdates, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyAddress=ipsUrlPolicyAddress, tempCritical=tempCritical, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheHits=webCacheHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sharedSecretKeyExpired=sharedSecretKeyExpired, PYSNMP_MODULE_ID=bws, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, systemLoad=systemLoad, webCacheCacheableRes=webCacheCacheableRes, memoryUsageHigh=memoryUsageHigh, ipsUrlAclPort=ipsUrlAclPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsRCTotServed=ipsRCTotServed, webCmprPort=webCmprPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyErrPms=sslProxyErrPms, httpProxyAddressType=httpProxyAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, systemFailOver=systemFailOver, operationalMode=operationalMode, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheLongHdrs=webCacheLongHdrs, switchingToBypassMode=switchingToBypassMode, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, activeServers=activeServers, dataPortLinkUp=dataPortLinkUp, httpProxyUnknownRsp=httpProxyUnknownRsp, cpuUtilization=cpuUtilization, sslSrvrInBytes=sslSrvrInBytes, ipsRCTotDropped=ipsRCTotDropped, memUtilization=memUtilization, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrState=httpSrvrState, dataPathStatus=dataPathStatus, ipsReqLimitAddress=ipsReqLimitAddress, activeApplications=activeApplications, switchingToMaintMode=switchingToMaintMode, totalBandwidth=totalBandwidth, webCmprCompressibleDataSize=webCmprCompressibleDataSize, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, fanDead=fanDead, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, serverUp=serverUp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsMIBGroups=bwsMIBGroups, webCacheStale=webCacheStale, sslSrvrPort=sslSrvrPort, webCacheBytesOut=webCacheBytesOut, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqLimitPort=ipsReqLimitPort, sslSrvrAddressType=sslSrvrAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, totalAttacks=totalAttacks, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, logStorage=logStorage, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, peerUp=peerUp, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsCacheStatsEntry=bwsCacheStatsEntry, bwstraps=bwstraps, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, logStorageHigh=logStorageHigh, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyCacheMiss=sslProxyCacheMiss, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMIBCompliances=bwsMIBCompliances, sslProxyOutBytes=sslProxyOutBytes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, firmwareStorageHigh=firmwareStorageHigh, tempHigh=tempHigh, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsHdrAclHits=ipsHdrAclHits, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, ipsHdrAclPort=ipsHdrAclPort, smRealmName=smRealmName, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, linkStatus=linkStatus, httpProxyAddress=httpProxyAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, serverDown=serverDown, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, systemFanSpeed=systemFanSpeed, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyPort=httpProxyPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, totalServers=totalServers, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsMIBConformance=bwsMIBConformance, sslProxyAddress=sslProxyAddress, serviceAddress=serviceAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bws=bws, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, securityDefUpdates=securityDefUpdates, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyPort=ipsUrlPolicyPort, peerDown=peerDown, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyTotalConn=httpProxyTotalConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, cpuFanSpeed=cpuFanSpeed, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlNormPort=ipsUrlNormPort, dataPortLinkDown=dataPortLinkDown, sslProxyPort=sslProxyPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsStats=bwsStats, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, raidDegrading=raidDegrading, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, switchingToInlineMode=switchingToInlineMode, httpProxyClientAbrt=httpProxyClientAbrt, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsRCPort=ipsRCPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheMiss=webCacheMiss, vipStatus=vipStatus, ipsUrlAclAddress=ipsUrlAclAddress, bwsTrapGroup=bwsTrapGroup, firmwareStorage=firmwareStorage, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrAddress=httpSrvrAddress, ipsRCAddressType=ipsRCAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyServerErr=httpProxyServerErr, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, systemSerialNumber=systemSerialNumber, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrNumConn=httpSrvrNumConn, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, processCountHigh=processCountHigh, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrAddress=sslSrvrAddress, sslSrvrState=sslSrvrState, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheReq=webCacheReq, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsMIBCompliance=bwsMIBCompliance, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrInBytes=httpSrvrInBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsRCTimeStamp=ipsRCTimeStamp, uptime=uptime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCacheAddress=webCacheAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, smAgentName=smAgentName, highAvailabilityStatus=highAvailabilityStatus, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, srvcName=srvcName, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheProtocol=webCacheProtocol)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyInBytes=sslProxyInBytes, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCmprAddress=webCmprAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, energizeUpdateExpire=energizeUpdateExpire, webCachePort=webCachePort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsStatsGroup=bwsStatsGroup, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCmprProtocol=webCmprProtocol, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrAddressType=httpSrvrAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, totalApplications=totalApplications, httpProxyInBytes=httpProxyInBytes, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsRCAddress=ipsRCAddress, httpProxyOutBytes=httpProxyOutBytes, serviceStatus=serviceStatus, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyAddressType=sslProxyAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyServerReq=httpProxyServerReq, bwsMessage=bwsMessage, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyTotalReq=httpProxyTotalReq, serviceName=serviceName, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyActiveConn=httpProxyActiveConn, sslProxyTotalConn=sslProxyTotalConn, freeMem=freeMem, cpuTemperature=cpuTemperature, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlPort=ipsAccessCtrlPort, systemFailure=systemFailure, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, bwsServiceStatusTable=bwsServiceStatusTable, webCacheAddressType=webCacheAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, totalMem=totalMem)
