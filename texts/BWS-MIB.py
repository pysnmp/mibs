...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Counter64, ModuleIdentity, NotificationType, Bits, TimeTicks, Unsigned32, Integer32, IpAddress, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Counter64", "ModuleIdentity", "NotificationType", "Bits", "TimeTicks", "Unsigned32", "Integer32", "IpAddress", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrPort=sslSrvrPort, serverUp=serverUp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, operationalMode=operationalMode, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, activeServers=activeServers, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, processCountHigh=processCountHigh, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyActiveConn=httpProxyActiveConn, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlNormPort=ipsUrlNormPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitPort=ipsReqLimitPort, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsMIBCompliance=bwsMIBCompliance, firmwareStorageHigh=firmwareStorageHigh, peerUp=peerUp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, peerDown=peerDown, webCacheMiss=webCacheMiss, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, servicePort=servicePort, freeMem=freeMem, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyAddressType=httpProxyAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitAddress=ipsReqLimitAddress, webCacheBytesOut=webCacheBytesOut, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyAddress=httpProxyAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsHdrAclAddress=ipsHdrAclAddress, bwsStatsGroup=bwsStatsGroup, sslProxyCacheHits=sslProxyCacheHits, webCmprAddress=webCmprAddress, fanDead=fanDead, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheCacheableRes=webCacheCacheableRes, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsRCAddress=ipsRCAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyTotalReq=sslProxyTotalReq, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, linkStatus=linkStatus, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, totalServers=totalServers, serverDown=serverDown, tempHigh=tempHigh, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsMessage=bwsMessage, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyInBytes=sslProxyInBytes, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, switchingToBypassMode=switchingToBypassMode, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, systemFailOver=systemFailOver, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrAddress=httpSrvrAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, logStorage=logStorage, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsCompressionStatsTable=bwsCompressionStatsTable, uptime=uptime, webCmprProtocol=webCmprProtocol, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, webCacheReq=webCacheReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheCachedObjects=webCacheCachedObjects, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyPort=sslProxyPort, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyAddressType=sslProxyAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecPort=ipsCookieSecPort, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsRCTimeStamp=ipsRCTimeStamp, webCacheProtocol=webCacheProtocol, activeApplications=activeApplications, httpProxyPort=httpProxyPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsMIBCompliances=bwsMIBCompliances, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrTotResponse=httpSrvrTotResponse, webCmprPort=webCmprPort, totalApplications=totalApplications, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyTotalReq=httpProxyTotalReq, cpuTemperature=cpuTemperature, virusDefUpdates=virusDefUpdates, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrAddress=sslSrvrAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrState=sslSrvrState, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyTotalConn=httpProxyTotalConn, systemSerialNumber=systemSerialNumber, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyServerErr=httpProxyServerErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsRCPort=ipsRCPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyAddress=sslProxyAddress, httpSrvrPort=httpSrvrPort, securityDefUpdates=securityDefUpdates, totalBandwidth=totalBandwidth, httpProxyServerReq=httpProxyServerReq, httpSrvrMinResTime=httpSrvrMinResTime, ipsRCTotQueued=ipsRCTotQueued, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsRCTotDropped=ipsRCTotDropped, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, firmwareStorage=firmwareStorage, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, highAvailabilityStatus=highAvailabilityStatus, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrMinResTime=sslSrvrMinResTime, serviceName=serviceName, webCachePort=webCachePort, bwsMIBConformance=bwsMIBConformance, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, switchingToMaintMode=switchingToMaintMode, logStorageHigh=logStorageHigh, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCmprAddressType=webCmprAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheLongHdrs=webCacheLongHdrs, httpSrvrInBytes=httpSrvrInBytes, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrAddressType=httpSrvrAddressType, memoryUsageHigh=memoryUsageHigh, webCmprCompressedDataSize=webCmprCompressedDataSize, raidDegrading=raidDegrading, bwsStats=bwsStats, ipsRCAddressType=ipsRCAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, serviceAddress=serviceAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwstraps=bwstraps, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, switchingToInlineMode=switchingToInlineMode, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, systemFailure=systemFailure, ipsHdrAclHits=ipsHdrAclHits, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, PYSNMP_MODULE_ID=bws, bws=bws, cpuUtilization=cpuUtilization, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsServiceStatusTable=bwsServiceStatusTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrState=httpSrvrState, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheAddress=webCacheAddress, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumConn=sslSrvrNumConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyActiveConn=sslProxyActiveConn, smAgentName=smAgentName, ipsWebAddrTransAddress=ipsWebAddrTransAddress, tempCritical=tempCritical, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, smRealmName=smRealmName)
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, currentFirmwareVersion=currentFirmwareVersion, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, memUtilization=memUtilization, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, cpuFanSpeed=cpuFanSpeed, httpProxyOutBytes=httpProxyOutBytes, webCacheHits=webCacheHits, httpProxyWAFWarnings=httpProxyWAFWarnings, energizeUpdateExpire=energizeUpdateExpire, systemFanSpeed=systemFanSpeed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, totalMem=totalMem, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, totalAttacks=totalAttacks, webCacheStale=webCacheStale, bwsTrapGroup=bwsTrapGroup, systemLoad=systemLoad, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecAddress=ipsCookieSecAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, vipStatus=vipStatus, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyParseErr=httpProxyParseErr, ipsRCTotServed=ipsRCTotServed, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrTotSuccess=httpSrvrTotSuccess, serviceStatus=serviceStatus, ipsUrlAclPort=ipsUrlAclPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, dataPathStatus=dataPathStatus, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheAddressType=webCacheAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrAddressType=sslSrvrAddressType, httpProxyInBytes=httpProxyInBytes, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyErrPms=sslProxyErrPms, httpSrvrTotReqRejected=httpSrvrTotReqRejected, srvcName=srvcName, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, smNumUserSessions=smNumUserSessions)
