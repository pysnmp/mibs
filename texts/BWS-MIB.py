...
Counter32, NotificationType, TimeTicks, Bits, iso, ObjectIdentity, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Counter64, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "TimeTicks", "Bits", "iso", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Counter64", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyTotalReq=sslProxyTotalReq, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, fanDead=fanDead, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyInBytes=sslProxyInBytes, totalMem=totalMem, serverUp=serverUp, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyErrPms=sslProxyErrPms, webCmprAddressType=webCmprAddressType, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrAddress=httpSrvrAddress, tempCritical=tempCritical, systemFailOver=systemFailOver, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheHits=webCacheHits, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyCacheHits=sslProxyCacheHits, switchingToMaintMode=switchingToMaintMode, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsRCPort=ipsRCPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrAddress=sslSrvrAddress, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, activeApplications=activeApplications, ipsHdrAclHits=ipsHdrAclHits, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheAddress=webCacheAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyServerErr=httpProxyServerErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsRCAddress=ipsRCAddress, sslProxyOutBytes=sslProxyOutBytes, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsMessage=bwsMessage, httpProxyTotalConn=httpProxyTotalConn, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsMIBCompliance=bwsMIBCompliance, serverDown=serverDown, freeMem=freeMem, switchingToInlineMode=switchingToInlineMode, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, systemSerialNumber=systemSerialNumber, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsHdrAclAddress=ipsHdrAclAddress, totalServers=totalServers, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, logStorageHigh=logStorageHigh, webCacheLongHdrs=webCacheLongHdrs, newAttackDefinitionInstalled=newAttackDefinitionInstalled, switchingToBypassMode=switchingToBypassMode, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, energizeUpdateExpire=energizeUpdateExpire, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsRCTotDropped=ipsRCTotDropped, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyOutBytes=httpProxyOutBytes, httpSrvrMinResTime=httpSrvrMinResTime, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsTrapGroup=bwsTrapGroup, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecPort=ipsCookieSecPort, smAgentName=smAgentName, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, smRealmName=smRealmName, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, processCountHigh=processCountHigh, ipsRCTotQueued=ipsRCTotQueued, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrState=sslSrvrState, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheReq=webCacheReq, servicePort=servicePort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlAclPort=ipsUrlAclPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, cpuFanSpeed=cpuFanSpeed, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrPort=httpSrvrPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrOutBytes=httpSrvrOutBytes, webCachePort=webCachePort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyAddress=httpProxyAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsStats=bwsStats, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCmprProtocol=webCmprProtocol, firmwareUpdateAvailable=firmwareUpdateAvailable, logStorage=logStorage, ipsUrlNormPort=ipsUrlNormPort, tempHigh=tempHigh, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, linkStatus=linkStatus, ipsRCAddressType=ipsRCAddressType, sslProxyActiveConn=sslProxyActiveConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, systemFanSpeed=systemFanSpeed, httpSrvrAddressType=httpSrvrAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, webCmprPort=webCmprPort, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, memUtilization=memUtilization, httpProxyParseErr=httpProxyParseErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheProtocol=webCacheProtocol, bwstraps=bwstraps, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, activeServers=activeServers, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrTotSuccess=httpSrvrTotSuccess, webCacheAddressType=webCacheAddressType, bwsMIBCompliances=bwsMIBCompliances, uptime=uptime, httpSrvrState=httpSrvrState, sslSrvrAddressType=sslSrvrAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, firmwareStorageHigh=firmwareStorageHigh, ipsCookieSecEncrypted=ipsCookieSecEncrypted, cpuTemperature=cpuTemperature, webCacheStale=webCacheStale, serviceName=serviceName, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, raidDegrading=raidDegrading, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, systemFailure=systemFailure, httpSrvrInBytes=httpSrvrInBytes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrMaxResTime=sslSrvrMaxResTime, PYSNMP_MODULE_ID=bws, securityDefUpdates=securityDefUpdates, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyServerReq=httpProxyServerReq, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, dataPathStatus=dataPathStatus, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsMIBGroups=bwsMIBGroups, firmwareStorage=firmwareStorage, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, srvcName=srvcName, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrTotRefused=sslSrvrTotRefused, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsServiceStatusTable=bwsServiceStatusTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, highAvailabilityStatus=highAvailabilityStatus, httpProxyClientAbrt=httpProxyClientAbrt, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyPort=sslProxyPort, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, systemLoad=systemLoad, ipsReqLimitAddress=ipsReqLimitAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrMinResTime=sslSrvrMinResTime, memoryUsageHigh=memoryUsageHigh, peerDown=peerDown, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyTotalConn=sslProxyTotalConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bws=bws, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyActiveConn=httpProxyActiveConn, smNumUserSessions=smNumUserSessions, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType)
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyAddressType=sslProxyAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyInBytes=httpProxyInBytes, ipsRCTotServed=ipsRCTotServed, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, virusDefUpdates=virusDefUpdates, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrNumConn=httpSrvrNumConn, operationalMode=operationalMode, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrNumConn=sslSrvrNumConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyServerAbrt=httpProxyServerAbrt, cpuUtilization=cpuUtilization, ipsHdrAclAddressType=ipsHdrAclAddressType, serviceStatus=serviceStatus, httpProxyAddressType=httpProxyAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, currentFirmwareVersion=currentFirmwareVersion, vipStatus=vipStatus, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyPort=ipsUrlPolicyPort, webCmprAddress=webCmprAddress, totalAttacks=totalAttacks, totalBandwidth=totalBandwidth, webCacheCachedObjects=webCacheCachedObjects, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyPort=httpProxyPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, serviceAddress=serviceAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyAddress=sslProxyAddress, totalApplications=totalApplications, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, dataPortLinkUp=dataPortLinkUp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheMiss=webCacheMiss, dataPortLinkDown=dataPortLinkDown, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, peerUp=peerUp, sslSrvrPort=sslSrvrPort)
