...
NotificationType, ObjectIdentity, Counter64, Unsigned32, IpAddress, Gauge32, ModuleIdentity, iso, TimeTicks, MibIdentifier, Integer32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "Gauge32", "ModuleIdentity", "iso", "TimeTicks", "MibIdentifier", "Integer32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheAddress=webCacheAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, serverDown=serverDown, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, totalBandwidth=totalBandwidth, webCmprAddressType=webCmprAddressType, ipsUrlNormPort=ipsUrlNormPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyErrPms=sslProxyErrPms, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, systemSerialNumber=systemSerialNumber, webCachePort=webCachePort, logStorageHigh=logStorageHigh, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsMIBCompliance=bwsMIBCompliance, ipsRCAddress=ipsRCAddress, bwsTrapGroup=bwsTrapGroup, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, webCacheCacheableRes=webCacheCacheableRes, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrPort=httpSrvrPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsCacheStatsTable=bwsCacheStatsTable, activeServers=activeServers, ipsRCPort=ipsRCPort, dataPathStatus=dataPathStatus, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrState=httpSrvrState, sslProxyTotalConn=sslProxyTotalConn, logStorage=logStorage, httpProxyClientAbrt=httpProxyClientAbrt, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotRefused=sslSrvrTotRefused, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyTotalConn=httpProxyTotalConn, tempCritical=tempCritical, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bws=bws, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheBytesOut=webCacheBytesOut, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, totalServers=totalServers, webCacheCachedObjects=webCacheCachedObjects, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsStats=bwsStats, ipsRCTotDropped=ipsRCTotDropped, securityDefUpdates=securityDefUpdates, sslProxyActiveConn=sslProxyActiveConn, tempHigh=tempHigh, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyOutBytes=sslProxyOutBytes, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, peerUp=peerUp, ipsUrlAclPort=ipsUrlAclPort, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrNumConn=httpSrvrNumConn, totalApplications=totalApplications, raidDegrading=raidDegrading, webCacheLongHdrs=webCacheLongHdrs, sslProxyFullHandshakes=sslProxyFullHandshakes, dataPortLinkUp=dataPortLinkUp, memUtilization=memUtilization, serviceName=serviceName, webCmprCompressedDataSize=webCmprCompressedDataSize, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlAclAddressType=ipsUrlAclAddressType, highAvailabilityStatus=highAvailabilityStatus, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsMIBGroups=bwsMIBGroups, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrInBytes=sslSrvrInBytes, sslProxyPort=sslProxyPort, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqLimitAddressType=ipsReqLimitAddressType, systemLoad=systemLoad, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, peerDown=peerDown, fanDead=fanDead, srvcName=srvcName, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyInBytes=sslProxyInBytes, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, firmwareStorageHigh=firmwareStorageHigh, httpProxyServerAbrt=httpProxyServerAbrt, serverUp=serverUp, bwsMIBConformance=bwsMIBConformance, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrInBytes=httpSrvrInBytes, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyAddressType=sslProxyAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, firmwareUpdateAvailable=firmwareUpdateAvailable, freeMem=freeMem, smNumUserSessions=smNumUserSessions, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, activeApplications=activeApplications, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslProxyCacheMiss=sslProxyCacheMiss, servicePort=servicePort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, processCountHigh=processCountHigh, sslSrvrSrvcAddress=sslSrvrSrvcAddress, firmwareStorage=firmwareStorage, systemFailure=systemFailure, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, currentFirmwareVersion=currentFirmwareVersion, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrMinResTime=httpSrvrMinResTime, serviceAddress=serviceAddress, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsMIBCompliances=bwsMIBCompliances, sslProxyBadDNCErr=sslProxyBadDNCErr, totalAttacks=totalAttacks, ipsRCAddressType=ipsRCAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, vipStatus=vipStatus, serviceStatus=serviceStatus, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCacheMiss=webCacheMiss, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, dataPortLinkDown=dataPortLinkDown, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsMessage=bwsMessage, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheReq=webCacheReq, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsStatsGroup=bwsStatsGroup, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCTotServed=ipsRCTotServed, sslProxyAddress=sslProxyAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrAddressType=httpSrvrAddressType, sslProxyCurrentConn=sslProxyCurrentConn, systemFailOver=systemFailOver, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyActiveConn=httpProxyActiveConn, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTotQueued=ipsRCTotQueued, bwstraps=bwstraps, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, uptime=uptime, virusDefUpdates=virusDefUpdates, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyServerReq=httpProxyServerReq, httpProxyAddress=httpProxyAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrMinResTime=sslSrvrMinResTime, webCmprProtocol=webCmprProtocol, smRealmName=smRealmName, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, smAgentName=smAgentName, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, operationalMode=operationalMode, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCacheProtocol=webCacheProtocol, totalMem=totalMem, sslSrvrAddress=sslSrvrAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, linkStatus=linkStatus, sslProxyTotalReq=sslProxyTotalReq, webCacheStale=webCacheStale, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyCacheHits=sslProxyCacheHits, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitPort=ipsReqLimitPort, memoryUsageHigh=memoryUsageHigh, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyOutBytes=httpProxyOutBytes, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrState=sslSrvrState, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, systemFanSpeed=systemFanSpeed, cpuTemperature=cpuTemperature, webCacheHits=webCacheHits, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCmprAddress=webCmprAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrAddressType=sslSrvrAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, switchingToMaintMode=switchingToMaintMode, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsHdrAclAddress=ipsHdrAclAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrTotRefused=httpSrvrTotRefused, bwsServiceStatusEntry=bwsServiceStatusEntry, switchingToInlineMode=switchingToInlineMode, cpuFanSpeed=cpuFanSpeed, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrPort=sslSrvrPort, httpProxyInBytes=httpProxyInBytes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyPort=httpProxyPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrTotReqRejected=sslSrvrTotReqRejected, energizeUpdateExpire=energizeUpdateExpire, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, PYSNMP_MODULE_ID=bws, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecPort=ipsCookieSecPort, webCacheAddressType=webCacheAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCmprPort=webCmprPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, cpuUtilization=cpuUtilization, switchingToBypassMode=switchingToBypassMode, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyParseErr=httpProxyParseErr)
