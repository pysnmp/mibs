...
Gauge32, IpAddress, TimeTicks, MibIdentifier, Bits, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Integer32, Counter64, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "TimeTicks", "MibIdentifier", "Bits", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Integer32", "Counter64", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", fanDead=fanDead, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheAddressType=webCacheAddressType, smAgentName=smAgentName, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, securityDefUpdates=securityDefUpdates, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, operationalMode=operationalMode, bwsMIBCompliances=bwsMIBCompliances, webCacheBytesOut=webCacheBytesOut, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheCacheableRes=webCacheCacheableRes, firmwareStorageHigh=firmwareStorageHigh, webCacheStale=webCacheStale, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, serverUp=serverUp, serviceName=serviceName, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, cpuFanSpeed=cpuFanSpeed, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheHits=webCacheHits, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyAddressType=httpProxyAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, vipStatus=vipStatus, sslSrvrNumConn=sslSrvrNumConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitPort=ipsReqLimitPort, memoryUsageHigh=memoryUsageHigh, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsRCTotDropped=ipsRCTotDropped, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyTotalReq=httpProxyTotalReq, httpProxyClientAbrt=httpProxyClientAbrt, smRealmName=smRealmName, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyOutBytes=sslProxyOutBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsHdrAclPort=ipsHdrAclPort, sslSrvrInBytes=sslSrvrInBytes, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyPort=sslProxyPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serviceStatus=serviceStatus, httpProxyActiveConn=httpProxyActiveConn, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyErrPms=sslProxyErrPms, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyServerErr=httpProxyServerErr, serverDown=serverDown, httpSrvrMinResTime=httpSrvrMinResTime, webCmprCompressibleDataSize=webCmprCompressibleDataSize, switchingToMaintMode=switchingToMaintMode, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyServerReq=httpProxyServerReq, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrState=httpSrvrState, raidDegrading=raidDegrading, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, systemSerialNumber=systemSerialNumber, ipsRCAddress=ipsRCAddress, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, tempHigh=tempHigh, bws=bws, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCachePort=webCachePort, memUtilization=memUtilization, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsCacheStatsEntry=bwsCacheStatsEntry, switchingToInlineMode=switchingToInlineMode, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, serviceAddress=serviceAddress, peerUp=peerUp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, systemLoad=systemLoad, systemFailOver=systemFailOver, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCPort=ipsRCPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, activeServers=activeServers, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrAddressType=httpSrvrAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, energizeUpdateExpire=energizeUpdateExpire, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyInBytes=httpProxyInBytes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsTrapGroup=bwsTrapGroup, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, processCountHigh=processCountHigh, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrTotRefused=httpSrvrTotRefused, logStorageHigh=logStorageHigh, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyOutBytes=httpProxyOutBytes, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsCookieSecPort=ipsCookieSecPort, sslProxyTotalReq=sslProxyTotalReq, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCTotServed=ipsRCTotServed, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, uptime=uptime, totalServers=totalServers, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsStatsGroup=bwsStatsGroup, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCmprProtocol=webCmprProtocol, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, linkStatus=linkStatus, ipsLrnSrvcPort=ipsLrnSrvcPort, webCmprAddressType=webCmprAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, PYSNMP_MODULE_ID=bws, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheMiss=webCacheMiss, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrNumConn=httpSrvrNumConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, logStorage=logStorage, totalMem=totalMem, ipsRCAddressType=ipsRCAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, cpuUtilization=cpuUtilization, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrTotReqRejected=httpSrvrTotReqRejected, totalAttacks=totalAttacks, sslSrvrPort=sslSrvrPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxyPort=httpProxyPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, virusDefUpdates=virusDefUpdates, smNumUserSessions=smNumUserSessions, ipsUrlAclReserved=ipsUrlAclReserved, srvcName=srvcName, freeMem=freeMem, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyAddress=httpProxyAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCmprPort=webCmprPort, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyParseErr=httpProxyParseErr, dataPortLinkDown=dataPortLinkDown, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheReq=webCacheReq, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCTotQueued=ipsRCTotQueued, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlAclPort=ipsUrlAclPort, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, activeApplications=activeApplications, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpProxyTotalConn=httpProxyTotalConn, webCmprAddress=webCmprAddress, webCacheProtocol=webCacheProtocol, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, firmwareStorage=firmwareStorage, totalBandwidth=totalBandwidth, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsMessage=bwsMessage, sslProxyActiveConn=sslProxyActiveConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, totalApplications=totalApplications, tempCritical=tempCritical, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, firmwareUpdateAvailable=firmwareUpdateAvailable)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, cpuTemperature=cpuTemperature, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrPort=httpSrvrPort, dataPortLinkUp=dataPortLinkUp, bwsMIBConformance=bwsMIBConformance, systemFailure=systemFailure, sslProxyAddressType=sslProxyAddressType, httpSrvrInBytes=httpSrvrInBytes, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCacheAddress=webCacheAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyAddress=sslProxyAddress, sslProxyTotalConn=sslProxyTotalConn, dataPathStatus=dataPathStatus, bwstraps=bwstraps, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsStats=bwsStats, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsMIBGroups=bwsMIBGroups, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsMIBCompliance=bwsMIBCompliance, sslProxyCacheHits=sslProxyCacheHits, currentFirmwareVersion=currentFirmwareVersion, peerDown=peerDown, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrState=sslSrvrState, systemFanSpeed=systemFanSpeed, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsServiceStatusTable=bwsServiceStatusTable, switchingToBypassMode=switchingToBypassMode, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, servicePort=servicePort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyInBytes=sslProxyInBytes, webCacheLongHdrs=webCacheLongHdrs, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlNormPort=ipsUrlNormPort, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyCurrentConn=sslProxyCurrentConn)
