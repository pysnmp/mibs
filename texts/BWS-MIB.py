...
Counter32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, NotificationType, Unsigned32, ModuleIdentity, TimeTicks, Gauge32, Counter64, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "NotificationType", "Unsigned32", "ModuleIdentity", "TimeTicks", "Gauge32", "Counter64", "Integer32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", serverDown=serverDown, webCacheCacheableRes=webCacheCacheableRes, httpSrvrMaxResTime=httpSrvrMaxResTime, srvcName=srvcName, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, cpuFanSpeed=cpuFanSpeed, bwsMessage=bwsMessage, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, peerDown=peerDown, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bws=bws, highAvailabilityStatus=highAvailabilityStatus, activeServers=activeServers, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlAclPort=ipsUrlAclPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsRCPort=ipsRCPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrOutBytes=httpSrvrOutBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyAddressType=httpProxyAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, PYSNMP_MODULE_ID=bws, ipsRCTotQueued=ipsRCTotQueued, httpProxyInBytes=httpProxyInBytes, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, totalMem=totalMem, firmwareStorage=firmwareStorage, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, smAgentName=smAgentName, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrNumConn=httpSrvrNumConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheReq=webCacheReq, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, smNumUserSessions=smNumUserSessions, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, memoryUsageHigh=memoryUsageHigh, systemFailOver=systemFailOver, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, currentFirmwareVersion=currentFirmwareVersion, webCacheMiss=webCacheMiss, sslProxyTotalConn=sslProxyTotalConn, securityDefUpdates=securityDefUpdates, tempCritical=tempCritical, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyAddressType=sslProxyAddressType, sslProxyCacheMiss=sslProxyCacheMiss, webCacheProtocol=webCacheProtocol, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumConn=sslSrvrNumConn, webCachePort=webCachePort, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsCookieSecPort=ipsCookieSecPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyTotalReq=httpProxyTotalReq, httpSrvrState=httpSrvrState, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyCurrentConn=sslProxyCurrentConn, serviceName=serviceName, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, switchingToBypassMode=switchingToBypassMode, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, peerUp=peerUp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsTrapGroup=bwsTrapGroup, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyTotalReq=sslProxyTotalReq, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyServerReq=httpProxyServerReq, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, tempHigh=tempHigh, sslSrvrInBytes=sslSrvrInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, logStorageHigh=logStorageHigh, webCmprAddress=webCmprAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, activeApplications=activeApplications, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrTotResponse=httpSrvrTotResponse, webCacheStale=webCacheStale, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyAddress=httpProxyAddress, totalBandwidth=totalBandwidth, webCacheHits=webCacheHits, bwsMIBConformance=bwsMIBConformance, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyTotalConn=httpProxyTotalConn, operationalMode=operationalMode, webCmprPort=webCmprPort, smRealmName=smRealmName, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsHdrAclHits=ipsHdrAclHits, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyOutBytes=sslProxyOutBytes, bwsStatsGroup=bwsStatsGroup, sslProxyPort=sslProxyPort, sslSrvrState=sslSrvrState, logStorage=logStorage, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqSrvcPort=ipsReqSrvcPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, energizeUpdateExpire=energizeUpdateExpire, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrInBytes=httpSrvrInBytes, systemFailure=systemFailure, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, uptime=uptime, servicePort=servicePort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, totalApplications=totalApplications, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, dataPortLinkDown=dataPortLinkDown, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, systemFanSpeed=systemFanSpeed, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrAddress=httpSrvrAddress, bwsMIBCompliances=bwsMIBCompliances, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyErrPms=sslProxyErrPms, httpProxyActiveConn=httpProxyActiveConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyPort=ipsUrlPolicyPort, cpuUtilization=cpuUtilization, bwsMIBCompliance=bwsMIBCompliance, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, fanDead=fanDead, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, totalAttacks=totalAttacks, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsRCAddress=ipsRCAddress, bwstraps=bwstraps, dataPathStatus=dataPathStatus, sslProxyAddress=sslProxyAddress, ipsUrlNormPort=ipsUrlNormPort, serviceStatus=serviceStatus, cpuTemperature=cpuTemperature, sslProxyCacheHits=sslProxyCacheHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsServiceStatusTable=bwsServiceStatusTable, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsCookieSecTampered=ipsCookieSecTampered, ipsHdrAclPort=ipsHdrAclPort, freeMem=freeMem, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrTotResponse=sslSrvrTotResponse)
mibBuilder.exportSymbols("BWS-MIB", processCountHigh=processCountHigh, httpProxyParseErr=httpProxyParseErr, webCmprProtocol=webCmprProtocol, sslSrvrTotReqRejected=sslSrvrTotReqRejected, firmwareStorageHigh=firmwareStorageHigh, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, memUtilization=memUtilization, webCacheLongHdrs=webCacheLongHdrs, systemLoad=systemLoad, httpSrvrPort=httpSrvrPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheAddressType=webCacheAddressType, switchingToInlineMode=switchingToInlineMode, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitPort=ipsReqLimitPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, virusDefUpdates=virusDefUpdates, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyPort=httpProxyPort, vipStatus=vipStatus, sslProxyInBytes=sslProxyInBytes, httpProxyServerErr=httpProxyServerErr, ipsUrlAclReserved=ipsUrlAclReserved, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprAddressType=webCmprAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, totalServers=totalServers, dataPortLinkUp=dataPortLinkUp, ipsRCTotServed=ipsRCTotServed, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, serverUp=serverUp, raidDegrading=raidDegrading, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheAddress=webCacheAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, switchingToMaintMode=switchingToMaintMode, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyOutBytes=httpProxyOutBytes, systemSerialNumber=systemSerialNumber, serviceAddress=serviceAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, linkStatus=linkStatus, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsRCTotDropped=ipsRCTotDropped, bwsStats=bwsStats, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrPort=sslSrvrPort, ipsHdrAclAddress=ipsHdrAclAddress, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrAddressType=httpSrvrAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress)
