...
IpAddress, Counter64, Unsigned32, Gauge32, Integer32, Counter32, ModuleIdentity, NotificationType, Bits, TimeTicks, MibIdentifier, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Unsigned32", "Gauge32", "Integer32", "Counter32", "ModuleIdentity", "NotificationType", "Bits", "TimeTicks", "MibIdentifier", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", systemSerialNumber=systemSerialNumber, totalBandwidth=totalBandwidth, operationalMode=operationalMode, sslProxyOutBytes=sslProxyOutBytes, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrAddressType=httpSrvrAddressType, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotReqActive=sslSrvrTotReqActive, systemFanSpeed=systemFanSpeed, ipsRCTotServed=ipsRCTotServed, ipsCookieSecPort=ipsCookieSecPort, httpProxyParseErr=httpProxyParseErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsMessage=bwsMessage, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, sslProxyInBytes=sslProxyInBytes, peerUp=peerUp, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, webCmprPort=webCmprPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrSrvcPort=httpSrvrSrvcPort, linkStatus=linkStatus, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, webCacheHits=webCacheHits, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCachePort=webCachePort, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCmprAddressType=webCmprAddressType, httpProxyAddress=httpProxyAddress, processCountHigh=processCountHigh, sslSrvrInBytes=sslSrvrInBytes, serviceStatus=serviceStatus, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, raidDegrading=raidDegrading, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheBytesOut=webCacheBytesOut, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, serviceAddress=serviceAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, firmwareStorage=firmwareStorage, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyActiveConn=httpProxyActiveConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitPort=ipsReqLimitPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, activeApplications=activeApplications, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, serviceName=serviceName, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsCookieSecAddressType=ipsCookieSecAddressType, webCacheProtocol=webCacheProtocol, ipsUrlAclPort=ipsUrlAclPort, sslSrvrAddress=sslSrvrAddress, serverDown=serverDown, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bws=bws, ipsRCTotQueued=ipsRCTotQueued, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsCookieSecTampered=ipsCookieSecTampered, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, cpuTemperature=cpuTemperature, httpProxyPort=httpProxyPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrNumConn=httpSrvrNumConn, totalAttacks=totalAttacks, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyAddressType=httpProxyAddressType, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyCacheMiss=sslProxyCacheMiss, bwsCompressionStatsEntry=bwsCompressionStatsEntry, totalApplications=totalApplications, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyOutBytes=httpProxyOutBytes, tempCritical=tempCritical, sslSrvrAvgResTime=sslSrvrAvgResTime, systemFailOver=systemFailOver, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsStats=bwsStats, switchingToMaintMode=switchingToMaintMode, serverUp=serverUp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, srvcName=srvcName, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, totalMem=totalMem, sslProxyCurrentConn=sslProxyCurrentConn, ipsRCTotDropped=ipsRCTotDropped, activeServers=activeServers, dataPortLinkDown=dataPortLinkDown, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheStale=webCacheStale, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCmprAddress=webCmprAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, logStorageHigh=logStorageHigh, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCTimeStamp=ipsRCTimeStamp, systemLoad=systemLoad, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecAddress=ipsCookieSecAddress, ipsRCAddress=ipsRCAddress, dataPathStatus=dataPathStatus, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlNormPort=ipsUrlNormPort, smRealmName=smRealmName, servicePort=servicePort, sslSrvrPort=sslSrvrPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, vipStatus=vipStatus, firmwareStorageHigh=firmwareStorageHigh, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, smAgentName=smAgentName, dataPortLinkUp=dataPortLinkUp, httpProxyInBytes=httpProxyInBytes, currentFirmwareVersion=currentFirmwareVersion, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrNumConn=sslSrvrNumConn, webCacheLongHdrs=webCacheLongHdrs, sslProxyCacheHits=sslProxyCacheHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheCachedObjects=webCacheCachedObjects, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyBadDNCErr=sslProxyBadDNCErr, switchingToBypassMode=switchingToBypassMode, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsMIBCompliances=bwsMIBCompliances, httpProxyClientAbrt=httpProxyClientAbrt, totalServers=totalServers, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsHdrAclHits=ipsHdrAclHits, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, cpuUtilization=cpuUtilization, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, highAvailabilityStatus=highAvailabilityStatus, peerDown=peerDown, httpSrvrAddress=httpSrvrAddress, fanDead=fanDead, bwsMIBCompliance=bwsMIBCompliance, energizeUpdateExpire=energizeUpdateExpire, webCacheAddressType=webCacheAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsMIBConformance=bwsMIBConformance, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyTotalReq=httpProxyTotalReq, httpSrvrTotResponse=httpSrvrTotResponse, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, freeMem=freeMem, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCAddressType=ipsRCAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheAddress=webCacheAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, virusDefUpdates=virusDefUpdates, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, uptime=uptime, PYSNMP_MODULE_ID=bws, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, smNumUserSessions=smNumUserSessions, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, webCacheCacheableRes=webCacheCacheableRes, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsTrapGroup=bwsTrapGroup, ipsRCPort=ipsRCPort, memoryUsageHigh=memoryUsageHigh, sslSrvrState=sslSrvrState, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsMIBGroups=bwsMIBGroups, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, memUtilization=memUtilization, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyTotalConn=sslProxyTotalConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyErrPms=sslProxyErrPms, httpSrvrState=httpSrvrState, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, tempHigh=tempHigh, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAddress=sslProxyAddress, webCacheReq=webCacheReq, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrPort=httpSrvrPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyTotalConn=httpProxyTotalConn, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheMiss=webCacheMiss, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwstraps=bwstraps, httpSrvrTotSuccess=httpSrvrTotSuccess, cpuFanSpeed=cpuFanSpeed, bwsCacheStatsTable=bwsCacheStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, systemFailure=systemFailure, logStorage=logStorage, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyServerReq=httpProxyServerReq, bwsStatsGroup=bwsStatsGroup, sslProxyPort=sslProxyPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyServerErr=httpProxyServerErr, httpSrvrInBytes=httpSrvrInBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyActiveConn=sslProxyActiveConn, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyAddressType=sslProxyAddressType, webCmprProtocol=webCmprProtocol, securityDefUpdates=securityDefUpdates)
