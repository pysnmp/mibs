...
iso, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, MibIdentifier, NotificationType, ModuleIdentity, Gauge32, Bits, TimeTicks, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "MibIdentifier", "NotificationType", "ModuleIdentity", "Gauge32", "Bits", "TimeTicks", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsHdrAclPort=ipsHdrAclPort, httpProxyTotalConn=httpProxyTotalConn, dataPortLinkDown=dataPortLinkDown, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlAclPort=ipsUrlAclPort, webCmprProtocol=webCmprProtocol, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsMIBCompliances=bwsMIBCompliances, httpProxyAddress=httpProxyAddress, vipStatus=vipStatus, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, cpuTemperature=cpuTemperature, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecAddressType=ipsCookieSecAddressType, webCacheProtocol=webCacheProtocol, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyTotalReq=sslProxyTotalReq, webCmprPort=webCmprPort, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, switchingToMaintMode=switchingToMaintMode, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyTotalConn=sslProxyTotalConn, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheReq=webCacheReq, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheCachedObjects=webCacheCachedObjects, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, tempHigh=tempHigh, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyPort=httpProxyPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCacheMiss=webCacheMiss, serviceStatus=serviceStatus, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCacheAddress=webCacheAddress, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyCacheHits=sslProxyCacheHits, sslSrvrAddress=sslSrvrAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyOutBytes=sslProxyOutBytes, httpSrvrState=httpSrvrState, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyActiveConn=sslProxyActiveConn, systemFailOver=systemFailOver, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsHdrAclHits=ipsHdrAclHits, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCTotDropped=ipsRCTotDropped, firmwareStorage=firmwareStorage, totalAttacks=totalAttacks, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, dataPortLinkUp=dataPortLinkUp, energizeUpdateExpire=energizeUpdateExpire, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyPort=sslProxyPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrMinResTime=sslSrvrMinResTime, fanDead=fanDead, ipsWebAddrTransPort=ipsWebAddrTransPort, memoryUsageHigh=memoryUsageHigh, logStorageHigh=logStorageHigh, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyActiveConn=httpProxyActiveConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrTotSuccess=sslSrvrTotSuccess, webCmprCompressibleDataSize=webCmprCompressibleDataSize, srvcName=srvcName, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCTotServed=ipsRCTotServed, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, securityDefUpdates=securityDefUpdates, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, systemSerialNumber=systemSerialNumber, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheHits=webCacheHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrAddress=httpSrvrAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumConn=httpSrvrNumConn, dataPathStatus=dataPathStatus, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, peerDown=peerDown, httpProxyOutBytes=httpProxyOutBytes, webCacheStale=webCacheStale, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, totalBandwidth=totalBandwidth, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsMIBConformance=bwsMIBConformance, totalApplications=totalApplications, bwsTrapGroup=bwsTrapGroup, sslProxyInBytes=sslProxyInBytes, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyBadCRLErr=sslProxyBadCRLErr, virusDefUpdates=virusDefUpdates, raidDegrading=raidDegrading, serviceName=serviceName, webCmprAddressType=webCmprAddressType, httpSrvrAddressType=httpSrvrAddressType, linkStatus=linkStatus, peerUp=peerUp, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsMessage=bwsMessage, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, firmwareUpdateAvailable=firmwareUpdateAvailable, bwstraps=bwstraps, switchingToBypassMode=switchingToBypassMode, systemFanSpeed=systemFanSpeed, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqLimitPort=ipsReqLimitPort, smAgentName=smAgentName, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrAddressType=sslSrvrAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyServerErr=httpProxyServerErr, tempCritical=tempCritical, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, activeServers=activeServers, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, serverDown=serverDown, ipsRCTimeStamp=ipsRCTimeStamp, currentFirmwareVersion=currentFirmwareVersion, sslSrvrTotReqActive=sslSrvrTotReqActive, PYSNMP_MODULE_ID=bws, sslSrvrNumConn=sslSrvrNumConn, httpProxyServerReq=httpProxyServerReq, sslSrvrPort=sslSrvrPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCachePort=webCachePort, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, serviceAddress=serviceAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlNormPort=ipsUrlNormPort, operationalMode=operationalMode, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyCacheMiss=sslProxyCacheMiss, smRealmName=smRealmName, httpSrvrPort=httpSrvrPort, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrTotResponse=httpSrvrTotResponse, systemLoad=systemLoad, webCacheAddressType=webCacheAddressType, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyErrPms=sslProxyErrPms, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsStatsGroup=bwsStatsGroup, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsServiceStatusTable=bwsServiceStatusTable, activeApplications=activeApplications, totalMem=totalMem, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsRCAddressType=ipsRCAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyAddress=sslProxyAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyAddressType=sslProxyAddressType, freeMem=freeMem, bws=bws, sslSrvrState=sslSrvrState, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, smNumUserSessions=smNumUserSessions, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, firmwareStorageHigh=firmwareStorageHigh, ipsRCAddress=ipsRCAddress, memUtilization=memUtilization, sslSrvrInBytes=sslSrvrInBytes, cpuFanSpeed=cpuFanSpeed, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, cpuUtilization=cpuUtilization, httpSrvrSrvcPort=httpSrvrSrvcPort, systemFailure=systemFailure, ipsUrlAclAddress=ipsUrlAclAddress, bwsStats=bwsStats, httpProxyParseErr=httpProxyParseErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyUnknownRsp=httpProxyUnknownRsp, totalServers=totalServers, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, webCmprAddress=webCmprAddress, ipsRCPort=ipsRCPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, uptime=uptime, httpProxyTotalReq=httpProxyTotalReq, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsMIBCompliance=bwsMIBCompliance, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, logStorage=logStorage, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheCacheableRes=webCacheCacheableRes, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheBytesOut=webCacheBytesOut, webCacheLongHdrs=webCacheLongHdrs, processCountHigh=processCountHigh, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, servicePort=servicePort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, serverUp=serverUp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry)
