...
iso, Unsigned32, Bits, Gauge32, TimeTicks, IpAddress, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, MibIdentifier, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Bits", "Gauge32", "TimeTicks", "IpAddress", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "MibIdentifier", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwstraps=bwstraps, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, logStorage=logStorage, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, systemFailure=systemFailure, cpuFanSpeed=cpuFanSpeed, sslProxyTotalReq=sslProxyTotalReq, uptime=uptime, httpSrvrTotSuccess=httpSrvrTotSuccess, dataPathStatus=dataPathStatus, httpProxyOutBytes=httpProxyOutBytes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, bwsMIBCompliances=bwsMIBCompliances, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsRCStatsTable=bwsIpsRCStatsTable, serverDown=serverDown, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrAddress=httpSrvrAddress, ipsRCAddress=ipsRCAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, vipStatus=vipStatus, httpProxyAddressType=httpProxyAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bws=bws, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, systemSerialNumber=systemSerialNumber, highAvailabilityStatus=highAvailabilityStatus, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrPort=httpSrvrPort, webCacheProtocol=webCacheProtocol, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclHits=ipsHdrAclHits, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyFullHandshakes=sslProxyFullHandshakes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyTotalReq=httpProxyTotalReq, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyCacheHits=sslProxyCacheHits, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyErrPms=sslProxyErrPms, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCTotServed=ipsRCTotServed, activeServers=activeServers, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheReq=webCacheReq, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheStale=webCacheStale, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, processCountHigh=processCountHigh, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecTampered=ipsCookieSecTampered, serviceStatus=serviceStatus, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrAddressType=httpSrvrAddressType, memUtilization=memUtilization, sslProxyTotalConn=sslProxyTotalConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyClientAbrt=httpProxyClientAbrt, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsStats=bwsStats, raidDegrading=raidDegrading, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlNormAddressType=ipsUrlNormAddressType, firmwareStorage=firmwareStorage, ipsRCTotQueued=ipsRCTotQueued, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrNumConn=httpSrvrNumConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsHdrAclPort=ipsHdrAclPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCacheMiss=webCacheMiss, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, smNumUserSessions=smNumUserSessions, webCacheHits=webCacheHits, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyActiveConn=httpProxyActiveConn, srvcName=srvcName, bwsMIBGroups=bwsMIBGroups, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, energizeUpdateExpire=energizeUpdateExpire, dataPortLinkUp=dataPortLinkUp, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecPort=ipsCookieSecPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, serviceAddress=serviceAddress, sslSrvrNumConn=sslSrvrNumConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlPort=ipsAccessCtrlPort, serverUp=serverUp, webCacheCachedObjects=webCacheCachedObjects, smRealmName=smRealmName, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, systemFailOver=systemFailOver, sslSrvrAddress=sslSrvrAddress, ipsReqLimitPort=ipsReqLimitPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyUnknownRsp=httpProxyUnknownRsp, systemLoad=systemLoad, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqSrvcPort=ipsReqSrvcPort, webCachePort=webCachePort, bwsTrapGroup=bwsTrapGroup, httpSrvrTotRefused=httpSrvrTotRefused, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, cpuTemperature=cpuTemperature, httpProxyAddress=httpProxyAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlNormPort=ipsUrlNormPort, sslProxyInBytes=sslProxyInBytes, virusDefUpdates=virusDefUpdates, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheBytesOut=webCacheBytesOut, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsMIBCompliance=bwsMIBCompliance, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsReqLimitAddressType=ipsReqLimitAddressType, webCmprProtocol=webCmprProtocol, sslProxyPort=sslProxyPort, sslSrvrTotSuccess=sslSrvrTotSuccess, fanDead=fanDead, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrPort=sslSrvrPort, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyAddress=sslProxyAddress, dataPortLinkDown=dataPortLinkDown, operationalMode=operationalMode, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrInBytes=sslSrvrInBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyInBytes=httpProxyInBytes, ipsRCTotOutOfResource=ipsRCTotOutOfResource, firmwareStorageHigh=firmwareStorageHigh, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrState=httpSrvrState, httpProxyServerReq=httpProxyServerReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsHdrAclAddressType=ipsHdrAclAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheAddress=webCacheAddress, switchingToInlineMode=switchingToInlineMode, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrTotReqActive=httpSrvrTotReqActive, totalServers=totalServers, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, logStorageHigh=logStorageHigh, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsRCPort=ipsRCPort, webCacheAddressType=webCacheAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsStatsGroup=bwsStatsGroup, peerDown=peerDown, smAgentName=smAgentName, sslSrvrTotResponse=sslSrvrTotResponse, freeMem=freeMem, systemFanSpeed=systemFanSpeed, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyPort=ipsUrlPolicyPort, tempHigh=tempHigh, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrTotRefused=sslSrvrTotRefused, totalApplications=totalApplications, totalMem=totalMem, linkStatus=linkStatus, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, currentFirmwareVersion=currentFirmwareVersion, securityDefUpdates=securityDefUpdates, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsRCAddressType=ipsRCAddressType, webCacheLongHdrs=webCacheLongHdrs, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, servicePort=servicePort)
mibBuilder.exportSymbols("BWS-MIB", sslProxyAddressType=sslProxyAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsMIBConformance=bwsMIBConformance, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, memoryUsageHigh=memoryUsageHigh, cpuUtilization=cpuUtilization, bwsCompressionStatsTable=bwsCompressionStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrInBytes=httpSrvrInBytes, httpProxyServerErr=httpProxyServerErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlAclPort=ipsUrlAclPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyWAFWarnings=httpProxyWAFWarnings, webCmprAddress=webCmprAddress, sslSrvrState=sslSrvrState, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, activeApplications=activeApplications, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, switchingToBypassMode=switchingToBypassMode, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCmprAddressType=webCmprAddressType, bwsMessage=bwsMessage, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCTotDropped=ipsRCTotDropped, webCmprPort=webCmprPort, serviceName=serviceName, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyPort=httpProxyPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, PYSNMP_MODULE_ID=bws, totalAttacks=totalAttacks, switchingToMaintMode=switchingToMaintMode, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyParseErr=httpProxyParseErr, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsCookieSecAddressType=ipsCookieSecAddressType, tempCritical=tempCritical, webCmprCompressibleDataSize=webCmprCompressibleDataSize, peerUp=peerUp, httpSrvrSrvcAddress=httpSrvrSrvcAddress, totalBandwidth=totalBandwidth, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyTotalConn=httpProxyTotalConn)
