...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, iso, TimeTicks, Gauge32, MibIdentifier, IpAddress, Counter64, Unsigned32, Bits, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "iso", "TimeTicks", "Gauge32", "MibIdentifier", "IpAddress", "Counter64", "Unsigned32", "Bits", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrOutBytes=httpSrvrOutBytes, systemFailure=systemFailure, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrInBytes=sslSrvrInBytes, httpProxyServerErr=httpProxyServerErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsHdrAclPort=ipsHdrAclPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, systemLoad=systemLoad, ipsRCTotServed=ipsRCTotServed, ipsHdrAclHits=ipsHdrAclHits, totalBandwidth=totalBandwidth, PYSNMP_MODULE_ID=bws, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheBytesOut=webCacheBytesOut, totalApplications=totalApplications, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrMaxResTime=httpSrvrMaxResTime, serviceAddress=serviceAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyServerReq=httpProxyServerReq, bwsMIBGroups=bwsMIBGroups, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, firmwareStorage=firmwareStorage, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyInBytes=httpProxyInBytes, raidDegrading=raidDegrading, sslSrvrState=sslSrvrState, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheStale=webCacheStale, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyOutBytes=httpProxyOutBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, webCacheProtocol=webCacheProtocol, sslProxyTotalConn=sslProxyTotalConn, webCacheMiss=webCacheMiss, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyServerAbrt=httpProxyServerAbrt, bwsStats=bwsStats, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, smNumUserSessions=smNumUserSessions, dataPortLinkDown=dataPortLinkDown, httpProxyAddress=httpProxyAddress, ipsRCAddress=ipsRCAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrAddressType=httpSrvrAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransPort=ipsWebAddrTransPort, energizeUpdateExpire=energizeUpdateExpire, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, systemSerialNumber=systemSerialNumber, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrAvgResTime=httpSrvrAvgResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrTotReqActive=sslSrvrTotReqActive, switchingToBypassMode=switchingToBypassMode, srvcName=srvcName, sslProxyAddressType=sslProxyAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, currentFirmwareVersion=currentFirmwareVersion, bwsMIBConformance=bwsMIBConformance, memUtilization=memUtilization, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsRCPort=ipsRCPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCachePort=webCachePort, highAvailabilityStatus=highAvailabilityStatus, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrPort=httpSrvrPort, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqLimitPort=ipsReqLimitPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, totalMem=totalMem, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsTrapGroup=bwsTrapGroup, webCacheAddress=webCacheAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, cpuUtilization=cpuUtilization, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, activeServers=activeServers, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcPort=ipsLrnSrvcPort, processCountHigh=processCountHigh, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyTotalReq=sslProxyTotalReq, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrNumConn=httpSrvrNumConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, totalAttacks=totalAttacks, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, smAgentName=smAgentName, bwsStatsGroup=bwsStatsGroup, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, fanDead=fanDead, memoryUsageHigh=memoryUsageHigh, systemFanSpeed=systemFanSpeed, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, switchingToMaintMode=switchingToMaintMode, sslProxyErrPms=sslProxyErrPms, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheCachedObjects=webCacheCachedObjects, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, serverDown=serverDown, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, serviceName=serviceName, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrAddress=httpSrvrAddress, dataPortLinkUp=dataPortLinkUp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrNumFreeConn=sslSrvrNumFreeConn, totalServers=totalServers, webCacheAddressType=webCacheAddressType, httpProxyTotalConn=httpProxyTotalConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlAclPort=ipsUrlAclPort, sslProxyPort=sslProxyPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyCacheMiss=sslProxyCacheMiss, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, tempCritical=tempCritical, sslProxyActiveConn=sslProxyActiveConn, logStorageHigh=logStorageHigh, ipsRCTotQueued=ipsRCTotQueued, bws=bws, webCacheReq=webCacheReq, httpProxyPort=httpProxyPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslProxyCacheHits=sslProxyCacheHits, uptime=uptime, tempHigh=tempHigh, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyAddress=sslProxyAddress, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, systemFailOver=systemFailOver, logStorage=logStorage, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrNumConn=sslSrvrNumConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyParseErr=httpProxyParseErr, freeMem=freeMem, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCmprAddress=webCmprAddress, webCacheHits=webCacheHits, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrAddress=sslSrvrAddress, serverUp=serverUp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyAddressType=httpProxyAddressType, virusDefUpdates=virusDefUpdates, webCmprPort=webCmprPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyFullHandshakes=sslProxyFullHandshakes, peerDown=peerDown, switchingToInlineMode=switchingToInlineMode, sslProxyCacheTimeouts=sslProxyCacheTimeouts, cpuTemperature=cpuTemperature, dataPathStatus=dataPathStatus, ipsCookieSecAddress=ipsCookieSecAddress, ipsRCAddressType=ipsRCAddressType)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, vipStatus=vipStatus, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprProtocol=webCmprProtocol, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, serviceStatus=serviceStatus, ipsUrlNormPort=ipsUrlNormPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, linkStatus=linkStatus, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCmprAddressType=webCmprAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, smRealmName=smRealmName, securityDefUpdates=securityDefUpdates, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, servicePort=servicePort, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyOutBytes=sslProxyOutBytes, sslSrvrPort=sslSrvrPort, sslProxyInBytes=sslProxyInBytes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrState=httpSrvrState, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, firmwareStorageHigh=firmwareStorageHigh, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, peerUp=peerUp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsCookieSecTampered=ipsCookieSecTampered, activeApplications=activeApplications, ipsCookieSecPort=ipsCookieSecPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsMessage=bwsMessage, httpSrvrTotReqActive=httpSrvrTotReqActive, bwstraps=bwstraps, operationalMode=operationalMode, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheCacheableRes=webCacheCacheableRes, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrMinResTime=httpSrvrMinResTime, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, ipsRCTotDropped=ipsRCTotDropped, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable)
