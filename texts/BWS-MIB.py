...
Integer32, TimeTicks, NotificationType, ModuleIdentity, MibIdentifier, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, ObjectIdentity, iso, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "NotificationType", "ModuleIdentity", "MibIdentifier", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "ObjectIdentity", "iso", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCacheStale=webCacheStale, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCacheCachedObjects=webCacheCachedObjects, webCachePort=webCachePort, sslProxyTotalReq=sslProxyTotalReq, firmwareStorage=firmwareStorage, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, fanDead=fanDead, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, dataPortLinkDown=dataPortLinkDown, uptime=uptime, sslSrvrAddressType=sslSrvrAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitPort=ipsReqLimitPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrInBytes=httpSrvrInBytes, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCAddressType=ipsRCAddressType, memUtilization=memUtilization, httpSrvrNumConn=httpSrvrNumConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsMIBConformance=bwsMIBConformance, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrAddressType=httpSrvrAddressType, cpuUtilization=cpuUtilization, firmwareStorageHigh=firmwareStorageHigh, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsWebAddrTransAddress=ipsWebAddrTransAddress, systemFailOver=systemFailOver, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrAddress=sslSrvrAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, systemFanSpeed=systemFanSpeed, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyTotalReq=httpProxyTotalReq, dataPathStatus=dataPathStatus, webCacheAddress=webCacheAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsHdrAclHits=ipsHdrAclHits, httpProxyAddressType=httpProxyAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclReserved=ipsUrlAclReserved, logStorageHigh=logStorageHigh, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyClientAbrt=httpProxyClientAbrt, switchingToBypassMode=switchingToBypassMode, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, PYSNMP_MODULE_ID=bws, ipsHdrAclAddress=ipsHdrAclAddress, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, smNumUserSessions=smNumUserSessions, logStorage=logStorage, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyOutBytes=sslProxyOutBytes, serverDown=serverDown, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsMessage=bwsMessage, currentFirmwareVersion=currentFirmwareVersion, highAvailabilityStatus=highAvailabilityStatus, webCacheMiss=webCacheMiss, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotResponse=sslSrvrTotResponse, energizeUpdateExpire=energizeUpdateExpire, httpSrvrPort=httpSrvrPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, systemFailure=systemFailure, memoryUsageHigh=memoryUsageHigh, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, operationalMode=operationalMode, sslProxyTotalConn=sslProxyTotalConn, switchingToMaintMode=switchingToMaintMode, httpProxyTotalConn=httpProxyTotalConn, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrMinResTime=sslSrvrMinResTime, bws=bws, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyCacheHits=sslProxyCacheHits, virusDefUpdates=virusDefUpdates, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyInBytes=httpProxyInBytes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, raidDegrading=raidDegrading, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyAddressType=sslProxyAddressType, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheReq=webCacheReq, sslSrvrAvgResTime=sslSrvrAvgResTime, processCountHigh=processCountHigh, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, smRealmName=smRealmName, cpuTemperature=cpuTemperature, sslProxyInBytes=sslProxyInBytes, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsHdrAclPort=ipsHdrAclPort, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, totalServers=totalServers, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, activeServers=activeServers, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrAvgResTime=httpSrvrAvgResTime, servicePort=servicePort, sslSrvrTotSuccess=sslSrvrTotSuccess, webCacheHits=webCacheHits, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, totalAttacks=totalAttacks, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrState=sslSrvrState, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyCurrentConn=sslProxyCurrentConn, webCmprAddressType=webCmprAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, totalBandwidth=totalBandwidth, sslProxyErrPms=sslProxyErrPms, vipStatus=vipStatus, cpuFanSpeed=cpuFanSpeed, bwstraps=bwstraps, ipsCookieSecPort=ipsCookieSecPort, bwsServiceStatusTable=bwsServiceStatusTable, webCmprAddress=webCmprAddress, ipsRCTotDropped=ipsRCTotDropped, serverUp=serverUp, freeMem=freeMem, webCacheProtocol=webCacheProtocol, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrNumConn=sslSrvrNumConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, peerDown=peerDown, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCmprProtocol=webCmprProtocol, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyAddress=httpProxyAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsRCAddress=ipsRCAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsRCPort=ipsRCPort, serviceStatus=serviceStatus, totalMem=totalMem, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAddress=ipsAccessCtrlAddress, srvcName=srvcName, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsTrapGroup=bwsTrapGroup, httpSrvrAddress=httpSrvrAddress, securityDefUpdates=securityDefUpdates, httpProxyPort=httpProxyPort, webCacheBytesOut=webCacheBytesOut, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyActiveConn=httpProxyActiveConn, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCmprPort=webCmprPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, newAttackDefinitionInstalled=newAttackDefinitionInstalled)
mibBuilder.exportSymbols("BWS-MIB", bwsMIBCompliances=bwsMIBCompliances, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclPort=ipsUrlAclPort, sslSrvrOutBytes=sslSrvrOutBytes, linkStatus=linkStatus, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyAddress=sslProxyAddress, sslSrvrTotRefused=sslSrvrTotRefused, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyPort=sslProxyPort, httpSrvrTotResponse=httpSrvrTotResponse, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsRCTotServed=ipsRCTotServed, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrSrvcPort=sslSrvrSrvcPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrPort=sslSrvrPort, ipsRCTotQueued=ipsRCTotQueued, totalApplications=totalApplications, activeApplications=activeApplications, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyActiveConn=sslProxyActiveConn, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrTotRefused=httpSrvrTotRefused, serviceAddress=serviceAddress, httpSrvrState=httpSrvrState, smAgentName=smAgentName, httpProxyServerReq=httpProxyServerReq, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, tempCritical=tempCritical, httpProxyServerErr=httpProxyServerErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsStats=bwsStats, httpProxyParseErr=httpProxyParseErr, serviceName=serviceName, tempHigh=tempHigh, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, systemSerialNumber=systemSerialNumber, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheAddressType=webCacheAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, dataPortLinkUp=dataPortLinkUp, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, systemLoad=systemLoad, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, peerUp=peerUp)
