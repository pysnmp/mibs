...
Unsigned32, MibIdentifier, ModuleIdentity, Counter64, NotificationType, ObjectIdentity, Bits, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Counter64", "NotificationType", "ObjectIdentity", "Bits", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrMaxResTime=httpSrvrMaxResTime, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCmprCompressedDataSize=webCmprCompressedDataSize, switchingToBypassMode=switchingToBypassMode, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyParseErr=httpProxyParseErr, ipsReqLimitPort=ipsReqLimitPort, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheCacheableRes=webCacheCacheableRes, webCachePort=webCachePort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpProxyTotalConn=httpProxyTotalConn, ipsCookieSecPort=ipsCookieSecPort, serviceName=serviceName, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrPort=httpSrvrPort, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrPort=sslSrvrPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, cpuFanSpeed=cpuFanSpeed, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, memoryUsageHigh=memoryUsageHigh, httpProxyServerErr=httpProxyServerErr, webCacheCachedObjects=webCacheCachedObjects, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlNormPort=ipsUrlNormPort, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCTotDropped=ipsRCTotDropped, sslSrvrInBytes=sslSrvrInBytes, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAddressType=sslProxyAddressType, linkStatus=linkStatus, httpSrvrSrvcAddress=httpSrvrSrvcAddress, dataPortLinkUp=dataPortLinkUp, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyPort=sslProxyPort, smNumUserSessions=smNumUserSessions, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrTotReqActive=sslSrvrTotReqActive, bwstraps=bwstraps, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyTotalConn=sslProxyTotalConn, dataPathStatus=dataPathStatus, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyActiveConn=sslProxyActiveConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bws=bws, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyAddress=httpProxyAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrAddress=sslSrvrAddress, httpProxyActiveConn=httpProxyActiveConn, raidDegrading=raidDegrading, webCacheMiss=webCacheMiss, systemFanSpeed=systemFanSpeed, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxySessionTimeOut=httpProxySessionTimeOut, dataPortLinkDown=dataPortLinkDown, httpProxyPort=httpProxyPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsServiceStatusTable=bwsServiceStatusTable, serviceStatus=serviceStatus, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyOutBytes=httpProxyOutBytes, httpSrvrState=httpSrvrState, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsRCPort=ipsRCPort, ipsRCTotServed=ipsRCTotServed, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecEncrypted=ipsCookieSecEncrypted, PYSNMP_MODULE_ID=bws, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrNumConn=httpSrvrNumConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqSrvcPort=ipsReqSrvcPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlPolicyAddress=ipsUrlPolicyAddress, cpuUtilization=cpuUtilization, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCacheStale=webCacheStale, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, switchingToInlineMode=switchingToInlineMode, totalApplications=totalApplications, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsMIBCompliance=bwsMIBCompliance, systemFailOver=systemFailOver, systemFailure=systemFailure, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, systemLoad=systemLoad, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyInBytes=sslProxyInBytes, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, peerUp=peerUp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyCacheHits=sslProxyCacheHits, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, fanDead=fanDead, webCmprAddress=webCmprAddress, sslProxyOutBytes=sslProxyOutBytes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, webCacheAddress=webCacheAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrAddressType=sslSrvrAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsMIBConformance=bwsMIBConformance, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsHdrAclPort=ipsHdrAclPort, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCacheProtocol=webCacheProtocol, totalBandwidth=totalBandwidth, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheReq=webCacheReq, highAvailabilityStatus=highAvailabilityStatus, sslProxyTotalReq=sslProxyTotalReq, webCacheAddressType=webCacheAddressType, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrInBytes=httpSrvrInBytes, bwsStats=bwsStats, serviceAddress=serviceAddress, peerDown=peerDown, operationalMode=operationalMode, firmwareStorageHigh=firmwareStorageHigh, energizeUpdateExpire=energizeUpdateExpire, logStorageHigh=logStorageHigh, vipStatus=vipStatus, ipsCookieSecAddressType=ipsCookieSecAddressType, processCountHigh=processCountHigh, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyServerReq=httpProxyServerReq, webCacheBytesOut=webCacheBytesOut, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrMinResTime=sslSrvrMinResTime, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, currentFirmwareVersion=currentFirmwareVersion, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyAddress=sslProxyAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrAddressType=httpSrvrAddressType, sslSrvrNumConn=sslSrvrNumConn, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, serverUp=serverUp, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyAddressType=httpProxyAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsRCAddress=ipsRCAddress, logStorage=logStorage, freeMem=freeMem, webCmprAddressType=webCmprAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, totalAttacks=totalAttacks, systemSerialNumber=systemSerialNumber, sslSrvrState=sslSrvrState, sslProxyErrPms=sslProxyErrPms, tempHigh=tempHigh, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumFreeConn=sslSrvrNumFreeConn, smRealmName=smRealmName, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, srvcName=srvcName)
mibBuilder.exportSymbols("BWS-MIB", totalServers=totalServers, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, switchingToMaintMode=switchingToMaintMode, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, serverDown=serverDown, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCacheHits=webCacheHits, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, tempCritical=tempCritical, virusDefUpdates=virusDefUpdates, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheLongHdrs=webCacheLongHdrs, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrOutBytes=httpSrvrOutBytes, smAgentName=smAgentName, activeApplications=activeApplications, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, uptime=uptime, firmwareStorage=firmwareStorage, bwsMIBGroups=bwsMIBGroups, bwsMessage=bwsMessage, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, cpuTemperature=cpuTemperature, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsStatsGroup=bwsStatsGroup, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, totalMem=totalMem, securityDefUpdates=securityDefUpdates, webCmprPort=webCmprPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, activeServers=activeServers, sslSrvrSrvcAddress=sslSrvrSrvcAddress, memUtilization=memUtilization, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, servicePort=servicePort, webCmprProtocol=webCmprProtocol)
