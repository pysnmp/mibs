...
ModuleIdentity, iso, MibIdentifier, IpAddress, Gauge32, Integer32, Counter32, Bits, NotificationType, Unsigned32, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibIdentifier", "IpAddress", "Gauge32", "Integer32", "Counter32", "Bits", "NotificationType", "Unsigned32", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, serverDown=serverDown, energizeUpdateExpire=energizeUpdateExpire, dataPathStatus=dataPathStatus, ipsHdrAclHits=ipsHdrAclHits, bwsMIBGroups=bwsMIBGroups, currentFirmwareVersion=currentFirmwareVersion, httpSrvrAddress=httpSrvrAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, peerDown=peerDown, sslSrvrAddressType=sslSrvrAddressType, webCmprAddressType=webCmprAddressType, memUtilization=memUtilization, sslSrvrOutBytes=sslSrvrOutBytes, systemLoad=systemLoad, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotRefused=sslSrvrTotRefused, linkStatus=linkStatus, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, smNumUserSessions=smNumUserSessions, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrNumConn=httpSrvrNumConn, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsRCPort=ipsRCPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCTotDropped=ipsRCTotDropped, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyTotalConn=httpProxyTotalConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyAddress=sslProxyAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyPort=httpProxyPort, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCmprProtocol=webCmprProtocol, bws=bws, webCachePort=webCachePort, ipsHdrAclAddressType=ipsHdrAclAddressType, activeApplications=activeApplications, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprAddress=webCmprAddress, httpProxyOutBytes=httpProxyOutBytes, sslSrvrState=sslSrvrState, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, servicePort=servicePort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, webCacheAddress=webCacheAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrInBytes=httpSrvrInBytes, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, smAgentName=smAgentName, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsTrapGroup=bwsTrapGroup, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrState=httpSrvrState, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsMessage=bwsMessage, processCountHigh=processCountHigh, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrNumConn=sslSrvrNumConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlAclPort=ipsUrlAclPort, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrAddress=sslSrvrAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, totalBandwidth=totalBandwidth, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyActiveConn=httpProxyActiveConn, cpuFanSpeed=cpuFanSpeed, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsMIBConformance=bwsMIBConformance, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, operationalMode=operationalMode, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, securityDefUpdates=securityDefUpdates, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, webCacheReq=webCacheReq, httpProxyInBytes=httpProxyInBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheMiss=webCacheMiss, httpSrvrPort=httpSrvrPort, ipsHdrAclAddress=ipsHdrAclAddress, bwsMIBCompliance=bwsMIBCompliance, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsMIBCompliances=bwsMIBCompliances, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsSMUserSessionTable=bwsSMUserSessionTable, fanDead=fanDead, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyAddress=httpProxyAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrAddressType=httpSrvrAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsRCAddress=ipsRCAddress, sslProxyAddressType=sslProxyAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, totalServers=totalServers, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, peerUp=peerUp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, smRealmName=smRealmName, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclReserved=ipsUrlAclReserved, ipsRCTotServed=ipsRCTotServed, totalApplications=totalApplications, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, serviceStatus=serviceStatus, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsRCAddressType=ipsRCAddressType, freeMem=freeMem, ipsRCTotQueued=ipsRCTotQueued, httpSrvrTotResponse=httpSrvrTotResponse, ipsHdrAclPort=ipsHdrAclPort, sslProxyCacheMiss=sslProxyCacheMiss, webCacheLongHdrs=webCacheLongHdrs, systemFailure=systemFailure, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsStatsGroup=bwsStatsGroup, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, switchingToInlineMode=switchingToInlineMode, httpProxyServerErr=httpProxyServerErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, PYSNMP_MODULE_ID=bws, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyParseErr=httpProxyParseErr, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrMinResTime=sslSrvrMinResTime, cpuUtilization=cpuUtilization, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, firmwareStorageHigh=firmwareStorageHigh, webCmprCompressedDataSize=webCmprCompressedDataSize, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecTampered=ipsCookieSecTampered, vipStatus=vipStatus, sslProxyPort=sslProxyPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, cpuTemperature=cpuTemperature, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprPort=webCmprPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyTotalReq=httpProxyTotalReq, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, activeServers=activeServers, srvcName=srvcName, systemFailOver=systemFailOver, logStorageHigh=logStorageHigh, sslProxyCacheHits=sslProxyCacheHits, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, switchingToMaintMode=switchingToMaintMode, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrAvgResTime=sslSrvrAvgResTime, tempHigh=tempHigh, httpProxyAddressType=httpProxyAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType)
mibBuilder.exportSymbols("BWS-MIB", bwsStats=bwsStats, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheCacheableRes=webCacheCacheableRes, ipsUrlNormPort=ipsUrlNormPort, webCacheProtocol=webCacheProtocol, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, virusDefUpdates=virusDefUpdates, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyServerReq=httpProxyServerReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, uptime=uptime, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsCacheStatsEntry=bwsCacheStatsEntry, bwstraps=bwstraps, systemSerialNumber=systemSerialNumber, dataPortLinkUp=dataPortLinkUp, tempCritical=tempCritical, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, totalAttacks=totalAttacks, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, raidDegrading=raidDegrading, webCacheHits=webCacheHits, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, systemFanSpeed=systemFanSpeed, firmwareStorage=firmwareStorage, webCacheCachedObjects=webCacheCachedObjects, switchingToBypassMode=switchingToBypassMode, sslSrvrInBytes=sslSrvrInBytes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, serverUp=serverUp, sslProxyErrPms=sslProxyErrPms, sslProxyOutBytes=sslProxyOutBytes, webCacheStale=webCacheStale, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrTotReqRejected=httpSrvrTotReqRejected, logStorage=logStorage, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, serviceName=serviceName, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, serviceAddress=serviceAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, totalMem=totalMem, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrPort=sslSrvrPort, memoryUsageHigh=memoryUsageHigh, ipsReqLimitPort=ipsReqLimitPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyUnknownRsp=httpProxyUnknownRsp)
