...
iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, ObjectIdentity, TimeTicks, Counter32, MibIdentifier, IpAddress, ModuleIdentity, Counter64, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "ObjectIdentity", "TimeTicks", "Counter32", "MibIdentifier", "IpAddress", "ModuleIdentity", "Counter64", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, switchingToBypassMode=switchingToBypassMode, systemFailOver=systemFailOver, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyInBytes=sslProxyInBytes, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprPort=webCmprPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, highAvailabilityStatus=highAvailabilityStatus, serviceName=serviceName, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrAddressType=httpSrvrAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, uptime=uptime, webCacheStale=webCacheStale, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsHdrAclPort=ipsHdrAclPort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyCacheMiss=sslProxyCacheMiss, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyAddressType=sslProxyAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, securityDefUpdates=securityDefUpdates, httpProxyAddressType=httpProxyAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyClientAbrt=httpProxyClientAbrt, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitPort=ipsReqLimitPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCacheMiss=webCacheMiss, sslProxyActiveConn=sslProxyActiveConn, webCacheProtocol=webCacheProtocol, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyTotalReq=httpProxyTotalReq, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheAddress=webCacheAddress, cpuTemperature=cpuTemperature, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsRCTotDropped=ipsRCTotDropped, webCmprCompressibleDataSize=webCmprCompressibleDataSize, srvcName=srvcName, memoryUsageHigh=memoryUsageHigh, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclPort=ipsUrlAclPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bws=bws, ipsReqSrvcAddressType=ipsReqSrvcAddressType, totalApplications=totalApplications, operationalMode=operationalMode, webCacheLongHdrs=webCacheLongHdrs, ipsReqSrvcAddress=ipsReqSrvcAddress, logStorage=logStorage, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrOutBytes=httpSrvrOutBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, dataPortLinkDown=dataPortLinkDown, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, firmwareStorageHigh=firmwareStorageHigh, webCmprProtocol=webCmprProtocol, totalAttacks=totalAttacks, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrPort=sslSrvrPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCmprAddressType=webCmprAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyTotalReq=sslProxyTotalReq, PYSNMP_MODULE_ID=bws, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, virusDefUpdates=virusDefUpdates, bwsStatsGroup=bwsStatsGroup, systemFanSpeed=systemFanSpeed, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, smRealmName=smRealmName, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyAddress=sslProxyAddress, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, peerUp=peerUp, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyActiveConn=httpProxyActiveConn, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsMIBConformance=bwsMIBConformance, fanDead=fanDead, sslSrvrNumFreeConn=sslSrvrNumFreeConn, serviceAddress=serviceAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsRCPort=ipsRCPort, webCacheCacheableRes=webCacheCacheableRes, smAgentName=smAgentName, webCacheBytesOut=webCacheBytesOut, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsMIBCompliances=bwsMIBCompliances, webCachePort=webCachePort, bwsMIBCompliance=bwsMIBCompliance, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsMessage=bwsMessage, webCacheAddressType=webCacheAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrInBytes=sslSrvrInBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, energizeUpdateExpire=energizeUpdateExpire, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, raidDegrading=raidDegrading, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, totalServers=totalServers, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcPort=ipsLrnSrvcPort, tempCritical=tempCritical, sslSrvrTotResponse=sslSrvrTotResponse, freeMem=freeMem, currentFirmwareVersion=currentFirmwareVersion, memUtilization=memUtilization, logStorageHigh=logStorageHigh, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, peerDown=peerDown, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCacheCachedObjects=webCacheCachedObjects, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyPort=sslProxyPort, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsRCTotQueued=ipsRCTotQueued, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, linkStatus=linkStatus, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyServerReq=httpProxyServerReq, tempHigh=tempHigh, webCmprAddress=webCmprAddress, webCacheHits=webCacheHits, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyPort=httpProxyPort, httpProxyTotalConn=httpProxyTotalConn, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsStats=bwsStats, systemFailure=systemFailure, serverUp=serverUp, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyTotalConn=sslProxyTotalConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyAddress=httpProxyAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, smNumUserSessions=smNumUserSessions, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, activeApplications=activeApplications, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrAddress=httpSrvrAddress, activeServers=activeServers, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable)
mibBuilder.exportSymbols("BWS-MIB", bwstraps=bwstraps, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyErrPms=sslProxyErrPms, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsRCAddressType=ipsRCAddressType, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrPort=httpSrvrPort, ipsWebAddrTransPort=ipsWebAddrTransPort, switchingToMaintMode=switchingToMaintMode, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCTotServed=ipsRCTotServed, totalBandwidth=totalBandwidth, vipStatus=vipStatus, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecTampered=ipsCookieSecTampered, switchingToInlineMode=switchingToInlineMode, bwsCompressionStatsTable=bwsCompressionStatsTable, firmwareStorage=firmwareStorage, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, cpuFanSpeed=cpuFanSpeed, httpProxyServerErr=httpProxyServerErr, bwsMIBGroups=bwsMIBGroups, httpSrvrMinResTime=httpSrvrMinResTime, serviceStatus=serviceStatus, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCAddress=ipsRCAddress, httpSrvrState=httpSrvrState, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, cpuUtilization=cpuUtilization, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, systemSerialNumber=systemSerialNumber, webCacheReq=webCacheReq, sslSrvrState=sslSrvrState, processCountHigh=processCountHigh, httpProxyInBytes=httpProxyInBytes, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrInBytes=httpSrvrInBytes, servicePort=servicePort, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, dataPathStatus=dataPathStatus, sslProxyCacheHits=sslProxyCacheHits, httpSrvrSrvcAddress=httpSrvrSrvcAddress, totalMem=totalMem, httpProxyParseErr=httpProxyParseErr, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrNumConn=sslSrvrNumConn, serverDown=serverDown, ipsUrlNormAddress=ipsUrlNormAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, systemLoad=systemLoad, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable)
