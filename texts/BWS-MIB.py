...
TimeTicks, iso, Counter32, Counter64, ModuleIdentity, MibIdentifier, IpAddress, Bits, NotificationType, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Counter32", "Counter64", "ModuleIdentity", "MibIdentifier", "IpAddress", "Bits", "NotificationType", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheAddress=webCacheAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCachePort=webCachePort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsMessage=bwsMessage, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, dataPathStatus=dataPathStatus, httpSrvrPort=httpSrvrPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsHdrAclAddressType=ipsHdrAclAddressType, activeApplications=activeApplications, sslProxyAddressType=sslProxyAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, activeServers=activeServers, switchingToMaintMode=switchingToMaintMode, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCmprPort=webCmprPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, totalAttacks=totalAttacks, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsMIBConformance=bwsMIBConformance, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyActiveConn=sslProxyActiveConn, sslSrvrOutBytes=sslSrvrOutBytes, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, cpuFanSpeed=cpuFanSpeed, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, currentFirmwareVersion=currentFirmwareVersion, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, energizeUpdateExpire=energizeUpdateExpire, cpuTemperature=cpuTemperature, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, linkStatus=linkStatus, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyTotalReq=sslProxyTotalReq, virusDefUpdates=virusDefUpdates, httpProxyAddress=httpProxyAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyInBytes=httpProxyInBytes, srvcName=srvcName, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrTotRefused=sslSrvrTotRefused, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, tempHigh=tempHigh, ipsRCTotDropped=ipsRCTotDropped, servicePort=servicePort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyCacheMiss=sslProxyCacheMiss, bwsSMUserSessionEntry=bwsSMUserSessionEntry, highAvailabilityStatus=highAvailabilityStatus, httpProxyTotalReq=httpProxyTotalReq, ipsHdrAclPort=ipsHdrAclPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyParseErr=httpProxyParseErr, bwsTrapGroup=bwsTrapGroup, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bws=bws, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, totalMem=totalMem, cpuUtilization=cpuUtilization, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyPort=sslProxyPort, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, smNumUserSessions=smNumUserSessions, bwsMIBCompliance=bwsMIBCompliance, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyInBytes=sslProxyInBytes, httpSrvrAddressType=httpSrvrAddressType, webCmprProtocol=webCmprProtocol, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheReq=webCacheReq, bwstraps=bwstraps, sslSrvrPort=sslSrvrPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrNumConn=httpSrvrNumConn, operationalMode=operationalMode, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsStats=bwsStats, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCacheAddressType=webCacheAddressType, webCmprAddress=webCmprAddress, ipsReqLimitPort=ipsReqLimitPort, webCmprAddressType=webCmprAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsRCAddress=ipsRCAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, processCountHigh=processCountHigh, httpProxyServerErr=httpProxyServerErr, totalServers=totalServers, sslProxyAddress=sslProxyAddress, smAgentName=smAgentName, serverDown=serverDown, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsStatsGroup=bwsStatsGroup, sslSrvrTotResponse=sslSrvrTotResponse, fanDead=fanDead, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyErrPms=sslProxyErrPms, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrAvgResTime=httpSrvrAvgResTime, firmwareStorageHigh=firmwareStorageHigh, httpProxyActiveConn=httpProxyActiveConn, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlNormPort=ipsUrlNormPort, httpSrvrInBytes=httpSrvrInBytes, webCacheMiss=webCacheMiss, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, systemLoad=systemLoad, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, tempCritical=tempCritical, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrNumConn=sslSrvrNumConn, ipsHdrAclHits=ipsHdrAclHits, memoryUsageHigh=memoryUsageHigh, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsRCTotOutOfResource=ipsRCTotOutOfResource, totalBandwidth=totalBandwidth, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyTotalConn=sslProxyTotalConn, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, memUtilization=memUtilization, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrAddressType=sslSrvrAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, systemFailure=systemFailure, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, switchingToInlineMode=switchingToInlineMode, bwsMIBGroups=bwsMIBGroups, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrInBytes=sslSrvrInBytes, systemFailOver=systemFailOver, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyServerReq=httpProxyServerReq, httpProxyServerAbrt=httpProxyServerAbrt, dataPortLinkUp=dataPortLinkUp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitAddress=ipsReqLimitAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCacheStale=webCacheStale, securityDefUpdates=securityDefUpdates, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, serviceAddress=serviceAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, systemFanSpeed=systemFanSpeed, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, firmwareStorage=firmwareStorage, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, freeMem=freeMem, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsRCAddressType=ipsRCAddressType, ipsUrlAclPort=ipsUrlAclPort, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, PYSNMP_MODULE_ID=bws, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, logStorageHigh=logStorageHigh, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, totalApplications=totalApplications, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyCacheHits=sslProxyCacheHits, httpProxyTotalConn=httpProxyTotalConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotRefused=httpSrvrTotRefused, firmwareUpdateAvailable=firmwareUpdateAvailable, serverUp=serverUp)
mibBuilder.exportSymbols("BWS-MIB", dataPortLinkDown=dataPortLinkDown, bwsSMUserSessionTable=bwsSMUserSessionTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, serviceStatus=serviceStatus, webCacheHits=webCacheHits, vipStatus=vipStatus, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyOutBytes=sslProxyOutBytes, webCacheProtocol=webCacheProtocol, serviceName=serviceName, ipsReqSrvcPort=ipsReqSrvcPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrMinResTime=sslSrvrMinResTime, webCacheLongHdrs=webCacheLongHdrs, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, peerUp=peerUp, httpProxyPort=httpProxyPort, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, uptime=uptime, webCacheCachedObjects=webCacheCachedObjects, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrMinResTime=httpSrvrMinResTime, logStorage=logStorage, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, smRealmName=smRealmName, webCacheCacheableRes=webCacheCacheableRes, ipsRCTotQueued=ipsRCTotQueued, peerDown=peerDown, ipsRCPort=ipsRCPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrState=sslSrvrState, httpSrvrAddress=httpSrvrAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrAddress=sslSrvrAddress, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsCacheStatsTable=bwsCacheStatsTable, systemSerialNumber=systemSerialNumber, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrState=httpSrvrState, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrSrvcPort=httpSrvrSrvcPort, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, raidDegrading=raidDegrading, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol)
