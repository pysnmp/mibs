...
IpAddress, Unsigned32, Bits, ModuleIdentity, Counter32, TimeTicks, ObjectIdentity, Counter64, Gauge32, MibIdentifier, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Bits", "ModuleIdentity", "Counter32", "TimeTicks", "ObjectIdentity", "Counter64", "Gauge32", "MibIdentifier", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", systemFailure=systemFailure, httpProxyOutBytes=httpProxyOutBytes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyErrPms=sslProxyErrPms, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, tempHigh=tempHigh, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheHits=webCacheHits, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcPort=ipsLrnSrvcPort, dataPortLinkDown=dataPortLinkDown, serverDown=serverDown, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsMessage=bwsMessage, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrInBytes=sslSrvrInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyServerAbrt=httpProxyServerAbrt, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyAddress=httpProxyAddress, sslProxyInBytes=sslProxyInBytes, serviceAddress=serviceAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrPort=httpSrvrPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyServerReq=httpProxyServerReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCachePort=webCachePort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, peerDown=peerDown, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsMIBCompliance=bwsMIBCompliance, energizeUpdateExpire=energizeUpdateExpire, ipsRCTotOutOfResource=ipsRCTotOutOfResource, switchingToBypassMode=switchingToBypassMode, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrState=httpSrvrState, dataPortLinkUp=dataPortLinkUp, webCmprCompressedDataSize=webCmprCompressedDataSize, totalAttacks=totalAttacks, raidDegrading=raidDegrading, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsMIBConformance=bwsMIBConformance, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrState=sslSrvrState, httpProxyParseErr=httpProxyParseErr, switchingToInlineMode=switchingToInlineMode, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, activeServers=activeServers, httpProxyActiveConn=httpProxyActiveConn, webCmprProtocol=webCmprProtocol, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, logStorageHigh=logStorageHigh, systemFailOver=systemFailOver, ipsRCPort=ipsRCPort, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, smNumUserSessions=smNumUserSessions, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsCookieSecPort=ipsCookieSecPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCacheAddress=webCacheAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheAddressType=webCacheAddressType, sslProxyTotalReq=sslProxyTotalReq, sslProxyPort=sslProxyPort, ipsHdrAclAddressType=ipsHdrAclAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, switchingToMaintMode=switchingToMaintMode, processCountHigh=processCountHigh, webCacheStale=webCacheStale, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sharedSecretKeyExpired=sharedSecretKeyExpired, webCmprPort=webCmprPort, bwsStats=bwsStats, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, totalApplications=totalApplications, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, PYSNMP_MODULE_ID=bws, systemSerialNumber=systemSerialNumber, httpProxyPort=httpProxyPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrTotResponse=sslSrvrTotResponse, totalServers=totalServers, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyActiveConn=sslProxyActiveConn, sslSrvrNumConn=sslSrvrNumConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, vipStatus=vipStatus, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, freeMem=freeMem, ipsCookieSecTampered=ipsCookieSecTampered, sslProxyTotalConn=sslProxyTotalConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, operationalMode=operationalMode, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, systemLoad=systemLoad, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheBytesOut=webCacheBytesOut, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrAddress=sslSrvrAddress, httpSrvrTotRefused=httpSrvrTotRefused, srvcName=srvcName, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bws=bws, servicePort=servicePort, bwsMIBCompliances=bwsMIBCompliances, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCmprAddressType=webCmprAddressType, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, serviceStatus=serviceStatus, httpSrvrMinResTime=httpSrvrMinResTime, ipsRCAddressType=ipsRCAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, fanDead=fanDead, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsMIBGroups=bwsMIBGroups, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsHdrAclHits=ipsHdrAclHits, smRealmName=smRealmName, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsCookieSecAddress=ipsCookieSecAddress, memUtilization=memUtilization, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, cpuTemperature=cpuTemperature, uptime=uptime, totalMem=totalMem, webCacheProtocol=webCacheProtocol, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, activeApplications=activeApplications, highAvailabilityStatus=highAvailabilityStatus, cpuFanSpeed=cpuFanSpeed, securityDefUpdates=securityDefUpdates, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsRCAddress=ipsRCAddress, serverUp=serverUp, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsCompressionStatsTable=bwsCompressionStatsTable, sslProxyCacheHits=sslProxyCacheHits, ipsUrlAclPort=ipsUrlAclPort, bwstraps=bwstraps, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyUnknownRsp=httpProxyUnknownRsp, tempCritical=tempCritical, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, systemFanSpeed=systemFanSpeed, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCmprAddress=webCmprAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, virusDefUpdates=virusDefUpdates, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, currentFirmwareVersion=currentFirmwareVersion, linkStatus=linkStatus, httpProxyInBytes=httpProxyInBytes, sslProxyAddress=sslProxyAddress, dataPathStatus=dataPathStatus, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrAddressType=httpSrvrAddressType)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsStatsGroup=bwsStatsGroup, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, firmwareStorageHigh=firmwareStorageHigh, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqLimitPort=ipsReqLimitPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsRCTotQueued=ipsRCTotQueued, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormPort=ipsUrlNormPort, totalBandwidth=totalBandwidth, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrTotReqActive=httpSrvrTotReqActive, cpuUtilization=cpuUtilization, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrPort=sslSrvrPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, firmwareStorage=firmwareStorage, serviceName=serviceName, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyTotalReq=httpProxyTotalReq, logStorage=logStorage, webCacheLongHdrs=webCacheLongHdrs, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCacheMiss=webCacheMiss, httpSrvrAddress=httpSrvrAddress, sslSrvrAddressType=sslSrvrAddressType, ipsRCTotDropped=ipsRCTotDropped, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsRCTotServed=ipsRCTotServed, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, smAgentName=smAgentName, webCacheReq=webCacheReq, peerUp=peerUp)
