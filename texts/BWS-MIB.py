...
ObjectIdentity, NotificationType, TimeTicks, Bits, Unsigned32, ModuleIdentity, Counter64, Gauge32, Counter32, Integer32, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "TimeTicks", "Bits", "Unsigned32", "ModuleIdentity", "Counter64", "Gauge32", "Counter32", "Integer32", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsCacheStatsEntry=bwsCacheStatsEntry, totalApplications=totalApplications, webCacheReq=webCacheReq, firmwareStorageHigh=firmwareStorageHigh, webCmprProtocol=webCmprProtocol, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclPort=ipsUrlAclPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsHdrAclPort=ipsHdrAclPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyTotalConn=httpProxyTotalConn, virusDefUpdates=virusDefUpdates, smRealmName=smRealmName, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCmprAddressType=webCmprAddressType, bws=bws, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, logStorage=logStorage, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, peerDown=peerDown, serverUp=serverUp, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, memUtilization=memUtilization, sslSrvrPort=sslSrvrPort, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrState=httpSrvrState, httpProxyClientAbrt=httpProxyClientAbrt, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, logStorageHigh=logStorageHigh, ipsCookieSecPort=ipsCookieSecPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrAvgResTime=httpSrvrAvgResTime, serviceAddress=serviceAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, switchingToBypassMode=switchingToBypassMode, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyAddress=httpProxyAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, bwstraps=bwstraps, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, uptime=uptime, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyActiveConn=sslProxyActiveConn, httpSrvrPort=httpSrvrPort, ipsReqLimitAddressType=ipsReqLimitAddressType, totalBandwidth=totalBandwidth, bwsMIBGroups=bwsMIBGroups, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, systemLoad=systemLoad, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsStatsGroup=bwsStatsGroup, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyPort=sslProxyPort, webCacheLongHdrs=webCacheLongHdrs, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheCachedObjects=webCacheCachedObjects, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormPort=ipsUrlNormPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, serviceName=serviceName, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsCacheStatsTable=bwsCacheStatsTable, ipsHdrAclHits=ipsHdrAclHits, httpProxyServerErr=httpProxyServerErr, totalAttacks=totalAttacks, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, systemFanSpeed=systemFanSpeed, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCmprPort=webCmprPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, dataPortLinkDown=dataPortLinkDown, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyAddressType=sslProxyAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyTotalConn=sslProxyTotalConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsMIBConformance=bwsMIBConformance, httpSrvrMaxResTime=httpSrvrMaxResTime, switchingToInlineMode=switchingToInlineMode, sslProxyFullHandshakes=sslProxyFullHandshakes, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotDropped=ipsRCTotDropped, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyActiveConn=httpProxyActiveConn, ipsRCPort=ipsRCPort, bwsMIBCompliance=bwsMIBCompliance, dataPathStatus=dataPathStatus, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, servicePort=servicePort, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyCacheMiss=sslProxyCacheMiss, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecTampered=ipsCookieSecTampered, currentFirmwareVersion=currentFirmwareVersion, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitPort=ipsReqLimitPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheAddress=webCacheAddress, activeServers=activeServers, httpProxyWAFWarnings=httpProxyWAFWarnings, linkStatus=linkStatus, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrNumConn=httpSrvrNumConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, fanDead=fanDead, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, webCmprAddress=webCmprAddress, operationalMode=operationalMode, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalMem=totalMem, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrAddress=sslSrvrAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsRCAddressType=ipsRCAddressType, sslSrvrNumConn=sslSrvrNumConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, firmwareStorage=firmwareStorage, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyOutBytes=httpProxyOutBytes, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyParseErr=httpProxyParseErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, activeApplications=activeApplications, sslProxyInBytes=sslProxyInBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, peerUp=peerUp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlNormAddressType=ipsUrlNormAddressType, serverDown=serverDown, highAvailabilityStatus=highAvailabilityStatus, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheCacheableRes=webCacheCacheableRes, systemSerialNumber=systemSerialNumber, webCacheHits=webCacheHits, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheMiss=webCacheMiss, sslSrvrTotTimedout=sslSrvrTotTimedout, raidDegrading=raidDegrading, securityDefUpdates=securityDefUpdates, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyErrPms=sslProxyErrPms, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrAddressType=httpSrvrAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrAddress=httpSrvrAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, energizeUpdateExpire=energizeUpdateExpire, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsStats=bwsStats, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsRCTotQueued=ipsRCTotQueued, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyInBytes=httpProxyInBytes, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsMessage=bwsMessage, httpProxyAddressType=httpProxyAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, dataPortLinkUp=dataPortLinkUp, vipStatus=vipStatus)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, tempCritical=tempCritical, sslProxyCacheHits=sslProxyCacheHits, httpSrvrTotSuccess=httpSrvrTotSuccess, freeMem=freeMem, sslSrvrState=sslSrvrState, systemFailOver=systemFailOver, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyServerReq=httpProxyServerReq, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, PYSNMP_MODULE_ID=bws, webCacheAddressType=webCacheAddressType, smNumUserSessions=smNumUserSessions, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheStale=webCacheStale, switchingToMaintMode=switchingToMaintMode, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyOutBytes=sslProxyOutBytes, cpuTemperature=cpuTemperature, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, srvcName=srvcName, systemFailure=systemFailure, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsTrapGroup=bwsTrapGroup, httpSrvrInBytes=httpSrvrInBytes, webCachePort=webCachePort, sslSrvrSrvcPort=sslSrvrSrvcPort, tempHigh=tempHigh, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyPort=httpProxyPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrInBytes=sslSrvrInBytes, webCacheProtocol=webCacheProtocol, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyAddress=sslProxyAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, totalServers=totalServers, ipsRCAddress=ipsRCAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, processCountHigh=processCountHigh, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, cpuFanSpeed=cpuFanSpeed, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqSrvcPort=ipsReqSrvcPort, serviceStatus=serviceStatus, smAgentName=smAgentName, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, cpuUtilization=cpuUtilization, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotReqActive=sslSrvrTotReqActive)
