...
iso, ModuleIdentity, Bits, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Unsigned32, Counter32, Integer32, Counter64, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Bits", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Unsigned32", "Counter32", "Integer32", "Counter64", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheAddressType=webCacheAddressType, serviceName=serviceName, raidDegrading=raidDegrading, webCacheReq=webCacheReq, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalMem=totalMem, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCmprAddress=webCmprAddress, sslSrvrTotResponse=sslSrvrTotResponse, bwsServiceStatusEntry=bwsServiceStatusEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, servicePort=servicePort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, cpuUtilization=cpuUtilization, webCacheAddress=webCacheAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, serviceStatus=serviceStatus, totalAttacks=totalAttacks, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsHdrAclHits=ipsHdrAclHits, httpProxyServerReq=httpProxyServerReq, securityDefUpdates=securityDefUpdates, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, tempCritical=tempCritical, sslProxyAddressType=sslProxyAddressType, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, activeServers=activeServers, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrOutBytes=httpSrvrOutBytes, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, totalBandwidth=totalBandwidth, sslProxyTotalConn=sslProxyTotalConn, bwsCompressionStatsTable=bwsCompressionStatsTable, logStorageHigh=logStorageHigh, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyInBytes=httpProxyInBytes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, tempHigh=tempHigh, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitPort=ipsReqLimitPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, serverUp=serverUp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrInBytes=httpSrvrInBytes, webCacheCachedObjects=webCacheCachedObjects, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, firmwareUpdateAvailable=firmwareUpdateAvailable, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsCookieSecTampered=ipsCookieSecTampered, virusDefUpdates=virusDefUpdates, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecAddress=ipsCookieSecAddress, memUtilization=memUtilization, webCacheBytesOut=webCacheBytesOut, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCPort=ipsRCPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsRCTotDropped=ipsRCTotDropped, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyAddress=httpProxyAddress, fanDead=fanDead, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyPort=sslProxyPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, serverDown=serverDown, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransAddress=ipsWebAddrTransAddress, systemSerialNumber=systemSerialNumber, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCacheProtocol=webCacheProtocol, sslProxyCacheMiss=sslProxyCacheMiss, webCmprCompressedDataSize=webCmprCompressedDataSize, smNumUserSessions=smNumUserSessions, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyActiveConn=sslProxyActiveConn, sslProxyErrPms=sslProxyErrPms, httpProxyActiveConn=httpProxyActiveConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsUrlAclAddress=ipsUrlAclAddress, cpuTemperature=cpuTemperature, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, switchingToInlineMode=switchingToInlineMode, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, switchingToMaintMode=switchingToMaintMode, webCacheHits=webCacheHits, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyCacheHits=sslProxyCacheHits, totalApplications=totalApplications, httpProxyPort=httpProxyPort, webCmprPort=webCmprPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, smRealmName=smRealmName, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyTotalReq=httpProxyTotalReq, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsRCAddress=ipsRCAddress, httpSrvrAddress=httpSrvrAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, serviceAddress=serviceAddress, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsMIBCompliances=bwsMIBCompliances, srvcName=srvcName, httpProxyOutBytes=httpProxyOutBytes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, energizeUpdateExpire=energizeUpdateExpire, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrState=sslSrvrState, bwsStats=bwsStats, httpSrvrAddressType=httpSrvrAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, systemFailure=systemFailure, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, firmwareStorageHigh=firmwareStorageHigh, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsMIBConformance=bwsMIBConformance, logStorage=logStorage, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwstraps=bwstraps, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, peerUp=peerUp, vipStatus=vipStatus, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, activeApplications=activeApplications, switchingToBypassMode=switchingToBypassMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrAddress=sslSrvrAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyServerErr=httpProxyServerErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrNumConn=httpSrvrNumConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrPort=httpSrvrPort, PYSNMP_MODULE_ID=bws, webCmprAddressType=webCmprAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyAddressType=httpProxyAddressType, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyWAFWarnings=httpProxyWAFWarnings, dataPathStatus=dataPathStatus, systemFailOver=systemFailOver, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, dataPortLinkUp=dataPortLinkUp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlAclPort=ipsUrlAclPort, bwsMessage=bwsMessage, memoryUsageHigh=memoryUsageHigh, ipsHdrAclPort=ipsHdrAclPort, peerDown=peerDown, processCountHigh=processCountHigh, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyTotalConn=httpProxyTotalConn, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrPort=sslSrvrPort, webCmprProtocol=webCmprProtocol, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, systemLoad=systemLoad, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlNormPort=ipsUrlNormPort, bws=bws, webCacheMiss=webCacheMiss, webCacheStale=webCacheStale, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, freeMem=freeMem, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, totalServers=totalServers, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormAddressType=ipsUrlNormAddressType, smAgentName=smAgentName, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsMIBGroups=bwsMIBGroups, operationalMode=operationalMode, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsStatsGroup=bwsStatsGroup, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyOutBytes=sslProxyOutBytes, firmwareStorage=firmwareStorage, webCachePort=webCachePort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheCacheableRes=webCacheCacheableRes, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsRCTotQueued=ipsRCTotQueued, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyInBytes=sslProxyInBytes, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, currentFirmwareVersion=currentFirmwareVersion, uptime=uptime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrState=httpSrvrState, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyAddress=sslProxyAddress, systemFanSpeed=systemFanSpeed, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, cpuFanSpeed=cpuFanSpeed, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, linkStatus=linkStatus)
