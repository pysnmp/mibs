...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, ObjectIdentity, MibIdentifier, Counter32, Counter64, TimeTicks, Integer32, Bits, Unsigned32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "ObjectIdentity", "MibIdentifier", "Counter32", "Counter64", "TimeTicks", "Integer32", "Bits", "Unsigned32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, fanDead=fanDead, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclPort=ipsUrlAclPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyInBytes=httpProxyInBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsStats=bwsStats, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, totalMem=totalMem, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyOutBytes=sslProxyOutBytes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, highAvailabilityStatus=highAvailabilityStatus, logStorageHigh=logStorageHigh, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyErrPms=sslProxyErrPms, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsMIBConformance=bwsMIBConformance, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, tempCritical=tempCritical, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrState=sslSrvrState, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrTotResponse=httpSrvrTotResponse, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheStale=webCacheStale, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, cpuTemperature=cpuTemperature, raidDegrading=raidDegrading, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpProxyAddress=httpProxyAddress, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, virusDefUpdates=virusDefUpdates, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitAddress=ipsReqLimitAddress, serverDown=serverDown, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheCachedObjects=webCacheCachedObjects, sslProxyActiveConn=sslProxyActiveConn, ipsHdrAclPort=ipsHdrAclPort, operationalMode=operationalMode, ipsRCTotDropped=ipsRCTotDropped, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, PYSNMP_MODULE_ID=bws, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrPort=httpSrvrPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, activeServers=activeServers, smNumUserSessions=smNumUserSessions, ipsUrlNormPort=ipsUrlNormPort, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumConn=sslSrvrNumConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyInBytes=sslProxyInBytes, webCmprAddressType=webCmprAddressType, httpProxyWAFWarnings=httpProxyWAFWarnings, bws=bws, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, freeMem=freeMem, httpProxyTotalConn=httpProxyTotalConn, sslSrvrPort=sslSrvrPort, ipsRCAddress=ipsRCAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, systemFanSpeed=systemFanSpeed, webCacheHits=webCacheHits, webCacheAddressType=webCacheAddressType, switchingToMaintMode=switchingToMaintMode, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheReq=webCacheReq, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrInBytes=httpSrvrInBytes, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCachePort=webCachePort, bwsMIBCompliance=bwsMIBCompliance, serviceStatus=serviceStatus, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCPort=ipsRCPort, switchingToInlineMode=switchingToInlineMode, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMessage=bwsMessage, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrAddress=sslSrvrAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, systemFailure=systemFailure, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, cpuUtilization=cpuUtilization, ipsUrlAclReserved=ipsUrlAclReserved, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheAddress=webCacheAddress, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, totalServers=totalServers, dataPathStatus=dataPathStatus, httpProxyServerReq=httpProxyServerReq, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrNumConn=httpSrvrNumConn, vipStatus=vipStatus, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSMUserSessionTable=bwsSMUserSessionTable, bwstraps=bwstraps, sslProxyAddressType=sslProxyAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrInBytes=sslSrvrInBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotRefused=sslSrvrTotRefused, memUtilization=memUtilization, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, serviceName=serviceName, linkStatus=linkStatus, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitPort=ipsReqLimitPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyPort=httpProxyPort, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrAddress=httpSrvrAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, srvcName=srvcName, tempHigh=tempHigh, systemLoad=systemLoad, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, peerUp=peerUp, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, uptime=uptime, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, switchingToBypassMode=switchingToBypassMode, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsCacheStatsTable=bwsCacheStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, serverUp=serverUp, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsWebAddrTransPort=ipsWebAddrTransPort, systemSerialNumber=systemSerialNumber, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyTotalReq=httpProxyTotalReq, totalAttacks=totalAttacks, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, securityDefUpdates=securityDefUpdates, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, currentFirmwareVersion=currentFirmwareVersion, sslProxyTotalConn=sslProxyTotalConn, servicePort=servicePort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsRCTimeStamp=ipsRCTimeStamp, ipsHdrAclHits=ipsHdrAclHits, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, smRealmName=smRealmName, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyAddress=sslProxyAddress, ipsRCTotQueued=ipsRCTotQueued, webCmprPort=webCmprPort, sslSrvrTotReqActive=sslSrvrTotReqActive)
mibBuilder.exportSymbols("BWS-MIB", httpProxyActiveConn=httpProxyActiveConn, smAgentName=smAgentName, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, totalBandwidth=totalBandwidth, ipsCookieSecPort=ipsCookieSecPort, httpSrvrTotReqActive=httpSrvrTotReqActive, dataPortLinkDown=dataPortLinkDown, firmwareStorageHigh=firmwareStorageHigh, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, systemFailOver=systemFailOver, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyOutBytes=httpProxyOutBytes, bwsTrapGroup=bwsTrapGroup, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsSslProxyStatsTable=bwsSslProxyStatsTable, cpuFanSpeed=cpuFanSpeed, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsMIBCompliances=bwsMIBCompliances, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheProtocol=webCacheProtocol, sslSrvrTotSuccess=sslSrvrTotSuccess, webCmprProtocol=webCmprProtocol, sslProxyPort=sslProxyPort, httpSrvrState=httpSrvrState, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, peerDown=peerDown, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, processCountHigh=processCountHigh, httpSrvrAddressType=httpSrvrAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyBadCRLErr=sslProxyBadCRLErr, logStorage=logStorage, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheCacheableRes=webCacheCacheableRes, webCacheBytesOut=webCacheBytesOut, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheMiss=webCacheMiss, energizeUpdateExpire=energizeUpdateExpire, firmwareStorage=firmwareStorage, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrMinResTime=sslSrvrMinResTime, serviceAddress=serviceAddress, sslProxyCacheHits=sslProxyCacheHits, webCmprAddress=webCmprAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, activeApplications=activeApplications, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, totalApplications=totalApplications, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsRCTotServed=ipsRCTotServed, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyTotalReq=sslProxyTotalReq, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits)
