...
Gauge32, ModuleIdentity, Counter32, NotificationType, Bits, Integer32, iso, TimeTicks, IpAddress, MibIdentifier, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter32", "NotificationType", "Bits", "Integer32", "iso", "TimeTicks", "IpAddress", "MibIdentifier", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, systemLoad=systemLoad, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrInBytes=sslSrvrInBytes, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyServerErr=httpProxyServerErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCmprAddress=webCmprAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, activeServers=activeServers, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, smRealmName=smRealmName, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, uptime=uptime, httpSrvrInBytes=httpSrvrInBytes, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyAddressType=sslProxyAddressType, sslProxyTotalReq=sslProxyTotalReq, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, serviceStatus=serviceStatus, systemFailOver=systemFailOver, ipsUrlNormPort=ipsUrlNormPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyInBytes=httpProxyInBytes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlPort=ipsAccessCtrlPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrNumConn=sslSrvrNumConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCmprAddressType=webCmprAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecAddress=ipsCookieSecAddress, ipsRCTotDropped=ipsRCTotDropped, operationalMode=operationalMode, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrState=httpSrvrState, totalMem=totalMem, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyClientAbrt=httpProxyClientAbrt, webCmprPort=webCmprPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyFullHandshakes=sslProxyFullHandshakes, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrTotResponse=sslSrvrTotResponse, webCacheProtocol=webCacheProtocol, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, cpuFanSpeed=cpuFanSpeed, tempCritical=tempCritical, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheAddress=webCacheAddress, sslProxyActiveConn=sslProxyActiveConn, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyActiveConn=httpProxyActiveConn, httpSrvrOutBytes=httpSrvrOutBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, logStorage=logStorage, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyParseErr=httpProxyParseErr, srvcName=srvcName, httpProxyAddress=httpProxyAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsMIBCompliances=bwsMIBCompliances, sslSrvrPort=sslSrvrPort, memUtilization=memUtilization, tempHigh=tempHigh, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyOutBytes=sslProxyOutBytes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, totalBandwidth=totalBandwidth, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyServerReq=httpProxyServerReq, systemFanSpeed=systemFanSpeed, serverDown=serverDown, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, switchingToBypassMode=switchingToBypassMode, ipsCookieSecTampered=ipsCookieSecTampered, cpuUtilization=cpuUtilization, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyCurrentConn=sslProxyCurrentConn, logStorageHigh=logStorageHigh, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsStats=bwsStats, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsStatsGroup=bwsStatsGroup, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsMessage=bwsMessage, highAvailabilityStatus=highAvailabilityStatus, ipsUrlPolicyPort=ipsUrlPolicyPort, webCacheCachedObjects=webCacheCachedObjects, webCachePort=webCachePort, ipsUrlNormAddress=ipsUrlNormAddress, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsHdrAclHits=ipsHdrAclHits, linkStatus=linkStatus, smNumUserSessions=smNumUserSessions, systemSerialNumber=systemSerialNumber, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, currentFirmwareVersion=currentFirmwareVersion, smAgentName=smAgentName, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, switchingToInlineMode=switchingToInlineMode, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, firmwareStorage=firmwareStorage, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsTrapGroup=bwsTrapGroup, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrPort=httpSrvrPort, httpProxyOutBytes=httpProxyOutBytes, httpProxyPort=httpProxyPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, serviceAddress=serviceAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsRCTimeStamp=ipsRCTimeStamp, PYSNMP_MODULE_ID=bws, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheBytesOut=webCacheBytesOut, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheReq=webCacheReq, cpuTemperature=cpuTemperature, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, dataPathStatus=dataPathStatus, sslProxyInBytes=sslProxyInBytes, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsRCAddress=ipsRCAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, memoryUsageHigh=memoryUsageHigh, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyTotalReq=httpProxyTotalReq, webCmprProtocol=webCmprProtocol, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrAddress=httpSrvrAddress, ipsRCTotServed=ipsRCTotServed, bwsMIBCompliance=bwsMIBCompliance, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, webCacheMiss=webCacheMiss, httpSrvrAvgResTime=httpSrvrAvgResTime, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, energizeUpdateExpire=energizeUpdateExpire, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrAddress=sslSrvrAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheLongHdrs=webCacheLongHdrs, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyCacheMiss=sslProxyCacheMiss, totalAttacks=totalAttacks, ipsRCPort=ipsRCPort, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyAddress=sslProxyAddress, virusDefUpdates=virusDefUpdates, bwstraps=bwstraps, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyAddressType=httpProxyAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheCacheableRes=webCacheCacheableRes, ipsRCAddressType=ipsRCAddressType, peerUp=peerUp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, fanDead=fanDead, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyPort=sslProxyPort, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, switchingToMaintMode=switchingToMaintMode, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsRCTotQueued=ipsRCTotQueued, raidDegrading=raidDegrading)
mibBuilder.exportSymbols("BWS-MIB", serverUp=serverUp, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyWAFWarnings=httpProxyWAFWarnings, processCountHigh=processCountHigh, httpSrvrNumConn=httpSrvrNumConn, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyTotalConn=httpProxyTotalConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, freeMem=freeMem, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlAclPort=ipsUrlAclPort, bwsMIBGroups=bwsMIBGroups, webCacheStale=webCacheStale, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, serviceName=serviceName, totalServers=totalServers, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitAddress=ipsReqLimitAddress, activeApplications=activeApplications, vipStatus=vipStatus, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, servicePort=servicePort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, peerDown=peerDown, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsMIBConformance=bwsMIBConformance, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyErrPms=sslProxyErrPms, webCacheAddressType=webCacheAddressType, bws=bws, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitPort=ipsReqLimitPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, dataPortLinkDown=dataPortLinkDown, systemFailure=systemFailure, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrState=sslSrvrState, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, firmwareStorageHigh=firmwareStorageHigh, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsCacheStatsEntry=bwsCacheStatsEntry, totalApplications=totalApplications, webCacheHits=webCacheHits, sslProxyTotalConn=sslProxyTotalConn, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue)
