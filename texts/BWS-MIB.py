...
Counter64, ObjectIdentity, NotificationType, ModuleIdentity, Bits, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Integer32, Unsigned32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Bits", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Integer32", "Unsigned32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyAddress=sslProxyAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsRCAddress=ipsRCAddress, webCacheHits=webCacheHits, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqSrvcAddressType=ipsReqSrvcAddressType, vipStatus=vipStatus, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, raidDegrading=raidDegrading, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrInBytes=sslSrvrInBytes, servicePort=servicePort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, activeApplications=activeApplications, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCacheBytesOut=webCacheBytesOut, systemSerialNumber=systemSerialNumber, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, dataPathStatus=dataPathStatus, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, systemFailure=systemFailure, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsMessage=bwsMessage, firmwareStorage=firmwareStorage, webCacheMiss=webCacheMiss, httpSrvrState=httpSrvrState, bwsSMUserSessionEntry=bwsSMUserSessionEntry, smAgentName=smAgentName, sslProxyCurrentConn=sslProxyCurrentConn, ipsHdrAclHits=ipsHdrAclHits, webCacheCachedObjects=webCacheCachedObjects, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsRCTimeStamp=ipsRCTimeStamp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, PYSNMP_MODULE_ID=bws, sslProxyCacheHits=sslProxyCacheHits, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlNormAddressType=ipsUrlNormAddressType, totalServers=totalServers, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheProtocol=webCacheProtocol, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsMIBGroups=bwsMIBGroups, cpuUtilization=cpuUtilization, bwsServiceStatusEntry=bwsServiceStatusEntry, totalAttacks=totalAttacks, ipsRCAddressType=ipsRCAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, serverUp=serverUp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrPort=sslSrvrPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, fanDead=fanDead, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, tempCritical=tempCritical, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitPort=ipsReqLimitPort, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyInBytes=sslProxyInBytes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyOutBytes=sslProxyOutBytes, bws=bws, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, serverDown=serverDown, srvcName=srvcName, switchingToInlineMode=switchingToInlineMode, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, serviceStatus=serviceStatus, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyActiveConn=httpProxyActiveConn, ipsUrlAclAddressType=ipsUrlAclAddressType, systemLoad=systemLoad, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrNumConn=sslSrvrNumConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, smRealmName=smRealmName, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyTotalConn=httpProxyTotalConn, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlNormAddress=ipsUrlNormAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrTotResponse=httpSrvrTotResponse, ipsRCTotQueued=ipsRCTotQueued, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsHdrAclPort=ipsHdrAclPort, httpSrvrAddressType=httpSrvrAddressType, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrOutBytes=httpSrvrOutBytes, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCPort=ipsRCPort, sslProxyAddressType=sslProxyAddressType, cpuFanSpeed=cpuFanSpeed, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlNormPort=ipsUrlNormPort, energizeUpdateExpire=energizeUpdateExpire, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyActiveConn=sslProxyActiveConn, freeMem=freeMem, bwsCompressionStatsTable=bwsCompressionStatsTable, webCmprAddressType=webCmprAddressType, bwsMIBCompliance=bwsMIBCompliance, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyServerReq=httpProxyServerReq, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyServerErr=httpProxyServerErr, httpProxyParseErr=httpProxyParseErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, peerDown=peerDown, httpSrvrTotRefused=httpSrvrTotRefused, switchingToBypassMode=switchingToBypassMode, webCacheStale=webCacheStale, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCacheAddress=webCacheAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, logStorageHigh=logStorageHigh, totalBandwidth=totalBandwidth, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrPort=httpSrvrPort, bwsStats=bwsStats, processCountHigh=processCountHigh, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyOutBytes=httpProxyOutBytes, sslSrvrState=sslSrvrState, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheLongHdrs=webCacheLongHdrs, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCachePort=webCachePort, smNumUserSessions=smNumUserSessions, httpSrvrNumConn=httpSrvrNumConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyAddress=ipsUrlPolicyAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, cpuTemperature=cpuTemperature, webCmprAddress=webCmprAddress, dataPortLinkDown=dataPortLinkDown, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsStatsGroup=bwsStatsGroup, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcPort=ipsReqSrvcPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyPort=httpProxyPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, systemFanSpeed=systemFanSpeed, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheCacheableRes=webCacheCacheableRes, httpProxyAddress=httpProxyAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, highAvailabilityStatus=highAvailabilityStatus, securityDefUpdates=securityDefUpdates, systemFailOver=systemFailOver, tempHigh=tempHigh, webCacheAddressType=webCacheAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCmprCompressibleDataSize=webCmprCompressibleDataSize, operationalMode=operationalMode, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclPort=ipsUrlAclPort, sslProxyTotalConn=sslProxyTotalConn)
mibBuilder.exportSymbols("BWS-MIB", peerUp=peerUp, logStorage=logStorage, memoryUsageHigh=memoryUsageHigh, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyErrPms=sslProxyErrPms, linkStatus=linkStatus, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, dataPortLinkUp=dataPortLinkUp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyAddressType=httpProxyAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrTotResponse=sslSrvrTotResponse, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyInBytes=httpProxyInBytes, webCmprPort=webCmprPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprProtocol=webCmprProtocol, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheReq=webCacheReq, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, memUtilization=memUtilization, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrNumFreeConn=sslSrvrNumFreeConn, totalMem=totalMem, currentFirmwareVersion=currentFirmwareVersion, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, switchingToMaintMode=switchingToMaintMode, sslSrvrAddressType=sslSrvrAddressType, uptime=uptime, serviceAddress=serviceAddress, virusDefUpdates=virusDefUpdates, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, totalApplications=totalApplications, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrAddress=sslSrvrAddress, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyPort=sslProxyPort, activeServers=activeServers, firmwareStorageHigh=firmwareStorageHigh, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsMIBConformance=bwsMIBConformance, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsRCTotServed=ipsRCTotServed, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwstraps=bwstraps, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, serviceName=serviceName)
