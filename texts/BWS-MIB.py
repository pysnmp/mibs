...
ModuleIdentity, ObjectIdentity, Unsigned32, Counter64, Counter32, Bits, MibIdentifier, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter64", "Counter32", "Bits", "MibIdentifier", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, smNumUserSessions=smNumUserSessions, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, firmwareStorage=firmwareStorage, ipsAccessCtrlPort=ipsAccessCtrlPort, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, tempCritical=tempCritical, webCmprProtocol=webCmprProtocol, uptime=uptime, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheAddressType=webCacheAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, dataPortLinkDown=dataPortLinkDown, httpProxyAddress=httpProxyAddress, sslProxyPort=sslProxyPort, logStorageHigh=logStorageHigh, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCPort=ipsRCPort, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsCookieSecEncrypted=ipsCookieSecEncrypted, totalServers=totalServers, sslProxyAddress=sslProxyAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyPort=httpProxyPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCacheStale=webCacheStale, webCmprPort=webCmprPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyInBytes=sslProxyInBytes, cpuUtilization=cpuUtilization, webCacheAddress=webCacheAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecAddress=ipsCookieSecAddress, firmwareStorageHigh=firmwareStorageHigh, sslProxyCurrentConn=sslProxyCurrentConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, vipStatus=vipStatus, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlNormPort=ipsUrlNormPort, ipsRCAddressType=ipsRCAddressType, sslProxyActiveConn=sslProxyActiveConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, tempHigh=tempHigh, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyTotalConn=httpProxyTotalConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, processCountHigh=processCountHigh, httpSrvrPort=httpSrvrPort, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyAddressType=httpProxyAddressType, ipsRCAddress=ipsRCAddress, httpSrvrNumConn=httpSrvrNumConn, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCachePort=webCachePort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwstraps=bwstraps, smRealmName=smRealmName, dataPathStatus=dataPathStatus, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCmprAddress=webCmprAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransAddress=ipsWebAddrTransAddress, PYSNMP_MODULE_ID=bws, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, serviceName=serviceName, webCacheMiss=webCacheMiss, webCacheReq=webCacheReq, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsStatsGroup=bwsStatsGroup, srvcName=srvcName, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsHdrAclPort=ipsHdrAclPort, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, logStorage=logStorage, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrTotTimedout=sslSrvrTotTimedout, webCacheProtocol=webCacheProtocol, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyParseErr=httpProxyParseErr, httpProxyServerErr=httpProxyServerErr, switchingToMaintMode=switchingToMaintMode, systemSerialNumber=systemSerialNumber, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrAddressType=sslSrvrAddressType, operationalMode=operationalMode, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyAddressType=sslProxyAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrAddress=httpSrvrAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyActiveConn=httpProxyActiveConn, freeMem=freeMem, serverDown=serverDown, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, securityDefUpdates=securityDefUpdates, httpSrvrInBytes=httpSrvrInBytes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheCacheableRes=webCacheCacheableRes, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrOutBytes=httpSrvrOutBytes, ipsCookieSecPort=ipsCookieSecPort, cpuFanSpeed=cpuFanSpeed, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrInBytes=sslSrvrInBytes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMIBCompliance=bwsMIBCompliance, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrAddressType=httpSrvrAddressType, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsMIBCompliances=bwsMIBCompliances, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrSrvcPort=httpSrvrSrvcPort, linkStatus=linkStatus, bws=bws, virusDefUpdates=virusDefUpdates, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, switchingToBypassMode=switchingToBypassMode, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsTrapGroup=bwsTrapGroup, peerUp=peerUp, bwsMessage=bwsMessage, systemFailure=systemFailure, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitAddressType=ipsReqLimitAddressType, serverUp=serverUp, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrAddress=sslSrvrAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, totalMem=totalMem, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyBadDNCErr=sslProxyBadDNCErr, activeServers=activeServers, httpProxyTotalReq=httpProxyTotalReq, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyBadCRLErr=sslProxyBadCRLErr, switchingToInlineMode=switchingToInlineMode, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsServiceStatusTable=bwsServiceStatusTable, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrPort=sslSrvrPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyCacheHits=sslProxyCacheHits, servicePort=servicePort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, cpuTemperature=cpuTemperature, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsStats=bwsStats, dataPortLinkUp=dataPortLinkUp, memUtilization=memUtilization, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, fanDead=fanDead, energizeUpdateExpire=energizeUpdateExpire, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn)
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsRCTotQueued=ipsRCTotQueued, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, raidDegrading=raidDegrading, ipsRCTimeStamp=ipsRCTimeStamp, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheHits=webCacheHits, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCTotDropped=ipsRCTotDropped, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrMinResTime=httpSrvrMinResTime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, peerDown=peerDown, sslSrvrState=sslSrvrState, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrState=httpSrvrState, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, highAvailabilityStatus=highAvailabilityStatus, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyErrPms=sslProxyErrPms, bwsCompressionStatsTable=bwsCompressionStatsTable, totalBandwidth=totalBandwidth, webCacheBytesOut=webCacheBytesOut, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyTotalConn=sslProxyTotalConn, smAgentName=smAgentName, serviceAddress=serviceAddress, httpProxyServerReq=httpProxyServerReq, sharedSecretKeyExpired=sharedSecretKeyExpired, systemFailOver=systemFailOver, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, totalApplications=totalApplications, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, activeApplications=activeApplications, webCmprAddressType=webCmprAddressType, httpProxyInBytes=httpProxyInBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumConn=sslSrvrNumConn, serviceStatus=serviceStatus, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlNormAddressType=ipsUrlNormAddressType, systemLoad=systemLoad, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, totalAttacks=totalAttacks, ipsReqLimitPort=ipsReqLimitPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, memoryUsageHigh=memoryUsageHigh, currentFirmwareVersion=currentFirmwareVersion, systemFanSpeed=systemFanSpeed, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize)
