...
Counter32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Counter64, Integer32, MibIdentifier, Bits, Gauge32, ModuleIdentity, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Counter64", "Integer32", "MibIdentifier", "Bits", "Gauge32", "ModuleIdentity", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrSrvcPort=httpSrvrSrvcPort, serviceName=serviceName, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsStats=bwsStats, sslProxyActiveConn=sslProxyActiveConn, peerUp=peerUp, webCachePort=webCachePort, fanDead=fanDead, serviceStatus=serviceStatus, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyOutBytes=sslProxyOutBytes, webCacheStale=webCacheStale, operationalMode=operationalMode, webCmprProtocol=webCmprProtocol, virusDefUpdates=virusDefUpdates, webCmprAddressType=webCmprAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheReq=webCacheReq, totalApplications=totalApplications, systemFailure=systemFailure, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsMIBCompliances=bwsMIBCompliances, totalAttacks=totalAttacks, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, firmwareStorage=firmwareStorage, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsCompressionStatsTable=bwsCompressionStatsTable, currentFirmwareVersion=currentFirmwareVersion, bwstraps=bwstraps, webCacheBytesOut=webCacheBytesOut, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlAclPort=ipsUrlAclPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecAddress=ipsCookieSecAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCacheLongHdrs=webCacheLongHdrs, bws=bws, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsTrapGroup=bwsTrapGroup, linkStatus=linkStatus, srvcName=srvcName, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyParseErr=httpProxyParseErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyUnknownRsp=httpProxyUnknownRsp, activeApplications=activeApplications, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrNumConn=httpSrvrNumConn, totalServers=totalServers, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemLoad=systemLoad, sslProxyAddress=sslProxyAddress, tempCritical=tempCritical, uptime=uptime, webCacheProtocol=webCacheProtocol, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCmprPort=webCmprPort, switchingToInlineMode=switchingToInlineMode, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, switchingToMaintMode=switchingToMaintMode, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsRCPort=ipsRCPort, systemSerialNumber=systemSerialNumber, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyTotalReq=httpProxyTotalReq, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsHdrAclPort=ipsHdrAclPort, httpSrvrPort=httpSrvrPort, ipsHdrAclAddressType=ipsHdrAclAddressType, smAgentName=smAgentName, bwsStatsGroup=bwsStatsGroup, ipsRCAddress=ipsRCAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, raidDegrading=raidDegrading, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, dataPathStatus=dataPathStatus, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsCookieSecAddressType=ipsCookieSecAddressType, systemFailOver=systemFailOver, sslSrvrInBytes=sslSrvrInBytes, webCmprAddress=webCmprAddress, webCacheHits=webCacheHits, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyOutBytes=httpProxyOutBytes, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, serverUp=serverUp, sslProxyTotalReq=sslProxyTotalReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, freeMem=freeMem, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyWAFWarnings=httpProxyWAFWarnings, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrTotResponse=sslSrvrTotResponse, servicePort=servicePort, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsCookieSecPort=ipsCookieSecPort, sslProxyTotalConn=sslProxyTotalConn, ipsRCTotDropped=ipsRCTotDropped, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, systemFanSpeed=systemFanSpeed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrAddress=sslSrvrAddress, sslProxyErrPms=sslProxyErrPms, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsMessage=bwsMessage, dataPortLinkUp=dataPortLinkUp, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrPort=sslSrvrPort, ipsHdrAclHits=ipsHdrAclHits, webCacheCacheableRes=webCacheCacheableRes, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, webCacheAddressType=webCacheAddressType, httpProxyActiveConn=httpProxyActiveConn, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyAddress=httpProxyAddress, serviceAddress=serviceAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, highAvailabilityStatus=highAvailabilityStatus, securityDefUpdates=securityDefUpdates, httpProxyPort=httpProxyPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheMiss=webCacheMiss, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyPort=sslProxyPort, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyClientAbrt=httpProxyClientAbrt, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, cpuUtilization=cpuUtilization, sslProxyAddressType=sslProxyAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrAddress=httpSrvrAddress, sslProxyCacheHits=sslProxyCacheHits, totalBandwidth=totalBandwidth, smNumUserSessions=smNumUserSessions, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, PYSNMP_MODULE_ID=bws, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyTotalConn=httpProxyTotalConn, switchingToBypassMode=switchingToBypassMode, logStorage=logStorage, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsRCTotQueued=ipsRCTotQueued, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotTimedout=sslSrvrTotTimedout, energizeUpdateExpire=energizeUpdateExpire, webCacheCachedObjects=webCacheCachedObjects, cpuTemperature=cpuTemperature, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, processCountHigh=processCountHigh, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, tempHigh=tempHigh, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, activeServers=activeServers, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyAddressType=httpProxyAddressType, firmwareStorageHigh=firmwareStorageHigh, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsMIBCompliance=bwsMIBCompliance, httpSrvrState=httpSrvrState, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, dataPortLinkDown=dataPortLinkDown, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrState=sslSrvrState, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCAddressType=ipsRCAddressType, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsRCTotServed=ipsRCTotServed, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, totalMem=totalMem, bwsMIBGroups=bwsMIBGroups, memUtilization=memUtilization, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, vipStatus=vipStatus, firmwareUpdateAvailable=firmwareUpdateAvailable, logStorageHigh=logStorageHigh, serverDown=serverDown, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, peerDown=peerDown, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheAddress=webCacheAddress, httpSrvrInBytes=httpSrvrInBytes, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyServerReq=httpProxyServerReq, httpProxyServerErr=httpProxyServerErr, bwsSMUserSessionTable=bwsSMUserSessionTable, smRealmName=smRealmName, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, cpuFanSpeed=cpuFanSpeed, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable)
