...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, IpAddress, Bits, Counter32, Gauge32, ObjectIdentity, TimeTicks, Integer32, NotificationType, MibIdentifier, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "IpAddress", "Bits", "Counter32", "Gauge32", "ObjectIdentity", "TimeTicks", "Integer32", "NotificationType", "MibIdentifier", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalServers=totalServers, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrInBytes=httpSrvrInBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrState=httpSrvrState, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyAddress=httpProxyAddress, energizeUpdateExpire=energizeUpdateExpire, activeApplications=activeApplications, securityDefUpdates=securityDefUpdates, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, memUtilization=memUtilization, totalAttacks=totalAttacks, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, tempHigh=tempHigh, srvcName=srvcName, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsMIBConformance=bwsMIBConformance, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsMIBGroups=bwsMIBGroups, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotRefused=sslSrvrTotRefused, bwsCacheStatsEntry=bwsCacheStatsEntry, fanDead=fanDead, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyActiveConn=httpProxyActiveConn, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrState=sslSrvrState, bwsServiceStatusEntry=bwsServiceStatusEntry, dataPathStatus=dataPathStatus, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, systemFanSpeed=systemFanSpeed, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsTrapGroup=bwsTrapGroup, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, systemLoad=systemLoad, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyPort=sslProxyPort, systemFailure=systemFailure, cpuTemperature=cpuTemperature, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCmprAddressType=webCmprAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, serviceAddress=serviceAddress, switchingToBypassMode=switchingToBypassMode, httpSrvrSrvcAddress=httpSrvrSrvcAddress, PYSNMP_MODULE_ID=bws, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyAddressType=httpProxyAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheAddressType=webCacheAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumFreeConn=sslSrvrNumFreeConn, firmwareStorageHigh=firmwareStorageHigh, systemFailOver=systemFailOver, bwsMessage=bwsMessage, sslProxyTotalReq=sslProxyTotalReq, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrPort=httpSrvrPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrTotSuccess=sslSrvrTotSuccess, bws=bws, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyErrPms=sslProxyErrPms, webCacheProtocol=webCacheProtocol, sslProxyInBytes=sslProxyInBytes, ipsRCTotQueued=ipsRCTotQueued, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, processCountHigh=processCountHigh, currentFirmwareVersion=currentFirmwareVersion, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsRCTotServed=ipsRCTotServed, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsRCTotDropped=ipsRCTotDropped, webCmprAddress=webCmprAddress, ipsReqSrvcPort=ipsReqSrvcPort, webCachePort=webCachePort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCAddressType=ipsRCAddressType, freeMem=freeMem, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecAddress=ipsCookieSecAddress, webCacheHits=webCacheHits, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprPort=webCmprPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsHdrAclPort=ipsHdrAclPort, ipsCookieSecTampered=ipsCookieSecTampered, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, webCmprProtocol=webCmprProtocol, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyInBytes=httpProxyInBytes, sslProxyCurrentConn=sslProxyCurrentConn, webCacheReq=webCacheReq, switchingToInlineMode=switchingToInlineMode, sslSrvrOutBytes=sslSrvrOutBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, cpuFanSpeed=cpuFanSpeed, bwsMIBCompliance=bwsMIBCompliance, logStorage=logStorage, uptime=uptime, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyServerAbrt=httpProxyServerAbrt, switchingToMaintMode=switchingToMaintMode, firmwareStorage=firmwareStorage, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrTotRefused=httpSrvrTotRefused, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCAddress=ipsRCAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, smAgentName=smAgentName, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyTotalConn=httpProxyTotalConn, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, tempCritical=tempCritical, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyAddress=sslProxyAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, virusDefUpdates=virusDefUpdates, sslProxyTotalConn=sslProxyTotalConn, ipsHdrAclHits=ipsHdrAclHits, webCacheBytesOut=webCacheBytesOut, totalBandwidth=totalBandwidth, sslProxyAddressType=sslProxyAddressType, sslSrvrInBytes=sslSrvrInBytes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCacheLongHdrs=webCacheLongHdrs, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, activeServers=activeServers, vipStatus=vipStatus, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlPolicyPort=ipsUrlPolicyPort, logStorageHigh=logStorageHigh, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCPort=ipsRCPort, ipsReqLimitPort=ipsReqLimitPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, smNumUserSessions=smNumUserSessions, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrNumConn=httpSrvrNumConn, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, peerDown=peerDown, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrPort=sslSrvrPort, linkStatus=linkStatus, webCacheCachedObjects=webCacheCachedObjects, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrAddress=sslSrvrAddress, systemSerialNumber=systemSerialNumber, serviceStatus=serviceStatus, raidDegrading=raidDegrading, bwstraps=bwstraps, sslProxyOutBytes=sslProxyOutBytes, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyParseErr=httpProxyParseErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie)
mibBuilder.exportSymbols("BWS-MIB", httpProxyServerErr=httpProxyServerErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyPort=httpProxyPort, webCacheAddress=webCacheAddress, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlNormPort=ipsUrlNormPort, sslProxyCacheHits=sslProxyCacheHits, serverUp=serverUp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsMIBCompliances=bwsMIBCompliances, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrAddressType=httpSrvrAddressType, ipsRCTimeStamp=ipsRCTimeStamp, bwsStats=bwsStats, operationalMode=operationalMode, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrTotTimedout=httpSrvrTotTimedout, totalMem=totalMem, ipsUrlAclPort=ipsUrlAclPort, dataPortLinkUp=dataPortLinkUp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, smRealmName=smRealmName, servicePort=servicePort, serverDown=serverDown, highAvailabilityStatus=highAvailabilityStatus, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheCacheableRes=webCacheCacheableRes, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyServerReq=httpProxyServerReq, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheMiss=webCacheMiss, webCacheStale=webCacheStale, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsStatsGroup=bwsStatsGroup, totalApplications=totalApplications, sslProxyActiveConn=sslProxyActiveConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAddress=ipsAccessCtrlAddress, serviceName=serviceName, peerUp=peerUp, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, cpuUtilization=cpuUtilization)
