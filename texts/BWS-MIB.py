...
NotificationType, Counter32, TimeTicks, Integer32, Counter64, ModuleIdentity, IpAddress, MibIdentifier, ObjectIdentity, iso, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "TimeTicks", "Integer32", "Counter64", "ModuleIdentity", "IpAddress", "MibIdentifier", "ObjectIdentity", "iso", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecEncrypted=ipsCookieSecEncrypted, processCountHigh=processCountHigh, sslProxyTotalConn=sslProxyTotalConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyParseErr=httpProxyParseErr, smRealmName=smRealmName, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, activeApplications=activeApplications, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyAddress=sslProxyAddress, webCmprAddress=webCmprAddress, bwsMIBConformance=bwsMIBConformance, webCacheAddressType=webCacheAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheProtocol=webCacheProtocol, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrInBytes=sslSrvrInBytes, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlNormPort=ipsUrlNormPort, webCachePort=webCachePort, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsStatsGroup=bwsStatsGroup, httpProxyTotalReq=httpProxyTotalReq, bwsCacheStatsTable=bwsCacheStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheReq=webCacheReq, tempCritical=tempCritical, dataPortLinkUp=dataPortLinkUp, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyErrPms=sslProxyErrPms, httpProxyOutBytes=httpProxyOutBytes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyOutBytes=sslProxyOutBytes, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, logStorageHigh=logStorageHigh, energizeUpdateExpire=energizeUpdateExpire, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, memUtilization=memUtilization, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, fanDead=fanDead, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyActiveConn=httpProxyActiveConn, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, systemLoad=systemLoad, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyCacheTimeouts=sslProxyCacheTimeouts, serverUp=serverUp, sslProxyTotalReq=sslProxyTotalReq, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyAddress=httpProxyAddress, sslSrvrTotRefused=sslSrvrTotRefused, webCacheCachedObjects=webCacheCachedObjects, httpProxyTotalConn=httpProxyTotalConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrNumConn=sslSrvrNumConn, switchingToInlineMode=switchingToInlineMode, ipsRCTimeStamp=ipsRCTimeStamp, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrAddress=httpSrvrAddress, httpProxyServerAbrt=httpProxyServerAbrt, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsCookieSecPort=ipsCookieSecPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsRCPort=ipsRCPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, dataPortLinkDown=dataPortLinkDown, httpSrvrMinResTime=httpSrvrMinResTime, linkStatus=linkStatus, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclPort=ipsUrlAclPort, webCmprAddressType=webCmprAddressType, bws=bws, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, PYSNMP_MODULE_ID=bws, totalAttacks=totalAttacks, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCTotDropped=ipsRCTotDropped, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCacheBytesOut=webCacheBytesOut, raidDegrading=raidDegrading, sslProxyCurrentConn=sslProxyCurrentConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotQueued=ipsRCTotQueued, httpSrvrTotRefused=httpSrvrTotRefused, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsStats=bwsStats, sslSrvrSrvcAddress=sslSrvrSrvcAddress, serviceName=serviceName, sslProxyPort=sslProxyPort, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrState=sslSrvrState, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, systemFailure=systemFailure, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrPort=sslSrvrPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, firmwareStorage=firmwareStorage, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrNumConn=httpSrvrNumConn, switchingToMaintMode=switchingToMaintMode, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheMiss=webCacheMiss, ipsHdrAclPort=ipsHdrAclPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, peerDown=peerDown, sslSrvrAddress=sslSrvrAddress, bwsTrapGroup=bwsTrapGroup, sslProxyActiveConn=sslProxyActiveConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, uptime=uptime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsMessage=bwsMessage, serviceStatus=serviceStatus, peerUp=peerUp, ipsReqLimitPort=ipsReqLimitPort, bwsMIBCompliance=bwsMIBCompliance, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, virusDefUpdates=virusDefUpdates, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCmprPort=webCmprPort, switchingToBypassMode=switchingToBypassMode, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, tempHigh=tempHigh, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, smNumUserSessions=smNumUserSessions, ipsCookieSecAddress=ipsCookieSecAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrMinResTime=sslSrvrMinResTime, totalMem=totalMem, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlNormAddress=ipsUrlNormAddress, ipsRCTotServed=ipsRCTotServed, totalServers=totalServers, httpProxyServerErr=httpProxyServerErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrPort=httpSrvrPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyPort=httpProxyPort, httpSrvrInBytes=httpSrvrInBytes, httpSrvrAvgResTime=httpSrvrAvgResTime, dataPathStatus=dataPathStatus, systemSerialNumber=systemSerialNumber, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsMIBCompliances=bwsMIBCompliances, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, logStorage=logStorage, currentFirmwareVersion=currentFirmwareVersion, ipsUrlPolicyPort=ipsUrlPolicyPort, systemFailOver=systemFailOver, bwstraps=bwstraps, sslProxyAddressType=sslProxyAddressType, serviceAddress=serviceAddress, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, cpuTemperature=cpuTemperature, systemFanSpeed=systemFanSpeed, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, vipStatus=vipStatus, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlAclAddress=ipsUrlAclAddress)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, securityDefUpdates=securityDefUpdates, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCacheMiss=sslProxyCacheMiss, srvcName=srvcName, totalBandwidth=totalBandwidth, totalApplications=totalApplications, webCacheCacheableRes=webCacheCacheableRes, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, activeServers=activeServers, memoryUsageHigh=memoryUsageHigh, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheHits=webCacheHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, serverDown=serverDown, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyServerReq=httpProxyServerReq, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, servicePort=servicePort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCAddress=ipsRCAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCAddressType=ipsRCAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCacheLongHdrs=webCacheLongHdrs, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, smAgentName=smAgentName, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyInBytes=sslProxyInBytes, webCacheAddress=webCacheAddress, freeMem=freeMem, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, cpuUtilization=cpuUtilization, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrState=httpSrvrState, webCacheStale=webCacheStale, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, cpuFanSpeed=cpuFanSpeed, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, newAttackDefinitionInstalled=newAttackDefinitionInstalled, operationalMode=operationalMode, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyCacheHits=sslProxyCacheHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyUnknownRsp=httpProxyUnknownRsp, highAvailabilityStatus=highAvailabilityStatus, webCmprProtocol=webCmprProtocol, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, firmwareStorageHigh=firmwareStorageHigh)
