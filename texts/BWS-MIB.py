...
Counter32, IpAddress, Counter64, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, ModuleIdentity, Integer32, ObjectIdentity, MibIdentifier, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Counter64", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, operationalMode=operationalMode, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsRCPort=ipsRCPort, webCacheProtocol=webCacheProtocol, currentFirmwareVersion=currentFirmwareVersion, virusDefUpdates=virusDefUpdates, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsStats=bwsStats, logStorage=logStorage, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrAddress=httpSrvrAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, smRealmName=smRealmName, switchingToMaintMode=switchingToMaintMode, sslSrvrPort=sslSrvrPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCmprPort=webCmprPort, servicePort=servicePort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecAddress=ipsCookieSecAddress, switchingToInlineMode=switchingToInlineMode, bwsCompressionStatsEntry=bwsCompressionStatsEntry, processCountHigh=processCountHigh, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsMIBGroups=bwsMIBGroups, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrTotReqRejected=httpSrvrTotReqRejected, serviceStatus=serviceStatus, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrPort=httpSrvrPort, totalApplications=totalApplications, sslSrvrNumConn=sslSrvrNumConn, httpSrvrOutBytes=httpSrvrOutBytes, bwsStatsGroup=bwsStatsGroup, sslSrvrInBytes=sslSrvrInBytes, uptime=uptime, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCTotDropped=ipsRCTotDropped, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCmprProtocol=webCmprProtocol, sslProxyTotalConn=sslProxyTotalConn, sslSrvrMinResTime=sslSrvrMinResTime, logStorageHigh=logStorageHigh, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyTotalConn=httpProxyTotalConn, bwsSMUserSessionTable=bwsSMUserSessionTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCacheStale=webCacheStale, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, systemFanSpeed=systemFanSpeed, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyInBytes=sslProxyInBytes, httpProxyAddressType=httpProxyAddressType, httpProxyActiveConn=httpProxyActiveConn, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, cpuFanSpeed=cpuFanSpeed, bws=bws, ipsReqLimitAddressType=ipsReqLimitAddressType, webCacheAddressType=webCacheAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalAttacks=totalAttacks, httpSrvrMinResTime=httpSrvrMinResTime, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsMIBCompliance=bwsMIBCompliance, systemFailure=systemFailure, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyOutBytes=sslProxyOutBytes, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyInBytes=httpProxyInBytes, ipsCookieSecPort=ipsCookieSecPort, sslSrvrAddress=sslSrvrAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslProxyAddress=sslProxyAddress, bwsCacheStatsTable=bwsCacheStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, serviceAddress=serviceAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCmprAddressType=webCmprAddressType, freeMem=freeMem, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, activeApplications=activeApplications, raidDegrading=raidDegrading, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, totalServers=totalServers, ipsReqLimitPort=ipsReqLimitPort, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrState=httpSrvrState, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsTrapGroup=bwsTrapGroup, ipsUrlNormPort=ipsUrlNormPort, ipsRCTotServed=ipsRCTotServed, httpProxyPort=httpProxyPort, ipsHdrAclHits=ipsHdrAclHits, dataPathStatus=dataPathStatus, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyAddress=ipsUrlPolicyAddress, memUtilization=memUtilization, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCacheCachedObjects=webCacheCachedObjects, smAgentName=smAgentName, tempCritical=tempCritical, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyAddress=httpProxyAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsCompressionStatsTable=bwsCompressionStatsTable, smNumUserSessions=smNumUserSessions, sslProxyAddressType=sslProxyAddressType, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, peerDown=peerDown, bwsMIBCompliances=bwsMIBCompliances, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyServerErr=httpProxyServerErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyErrPms=sslProxyErrPms, sslProxyBadDNCErr=sslProxyBadDNCErr, linkStatus=linkStatus, totalBandwidth=totalBandwidth, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsRCTotQueued=ipsRCTotQueued, httpProxyOutBytes=httpProxyOutBytes, peerUp=peerUp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, cpuUtilization=cpuUtilization, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyTotalReq=httpProxyTotalReq, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, serverDown=serverDown, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyCacheHits=sslProxyCacheHits, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, httpProxyServerReq=httpProxyServerReq, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclPort=ipsUrlAclPort, ipsRCAddress=ipsRCAddress, httpSrvrInBytes=httpSrvrInBytes, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyActiveConn=sslProxyActiveConn, webCacheCacheableRes=webCacheCacheableRes, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, securityDefUpdates=securityDefUpdates, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, systemFailOver=systemFailOver, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, webCacheHits=webCacheHits, ipsUrlAclAddress=ipsUrlAclAddress, bwsMessage=bwsMessage, serverUp=serverUp, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsHdrAclAddressType=ipsHdrAclAddressType, srvcName=srvcName, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCachePort=webCachePort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrNumConn=httpSrvrNumConn, serviceName=serviceName, fanDead=fanDead, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrTotRefused=httpSrvrTotRefused, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormAddress=ipsUrlNormAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCacheReq=webCacheReq, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, memoryUsageHigh=memoryUsageHigh, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, firmwareStorageHigh=firmwareStorageHigh, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, highAvailabilityStatus=highAvailabilityStatus, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyPort=sslProxyPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrAddressType=sslSrvrAddressType, dataPortLinkUp=dataPortLinkUp, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwstraps=bwstraps, ipsUrlNormAddressType=ipsUrlNormAddressType, systemLoad=systemLoad, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, switchingToBypassMode=switchingToBypassMode, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCacheMiss=webCacheMiss, tempHigh=tempHigh, ipsRCAddressType=ipsRCAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, vipStatus=vipStatus, sslProxyTotalReq=sslProxyTotalReq, webCacheLongHdrs=webCacheLongHdrs, activeServers=activeServers, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitAddress=ipsReqLimitAddress, webCacheAddress=webCacheAddress, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, systemSerialNumber=systemSerialNumber, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, energizeUpdateExpire=energizeUpdateExpire, totalMem=totalMem, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCmprAddress=webCmprAddress, firmwareStorage=firmwareStorage, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, PYSNMP_MODULE_ID=bws, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, dataPortLinkDown=dataPortLinkDown, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrState=sslSrvrState, cpuTemperature=cpuTemperature, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr)
