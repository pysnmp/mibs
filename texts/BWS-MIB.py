...
iso, Integer32, MibIdentifier, Bits, ObjectIdentity, ModuleIdentity, Unsigned32, Counter64, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "MibIdentifier", "Bits", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter64", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrPort=sslSrvrPort, ipsRCAddressType=ipsRCAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyAddress=httpProxyAddress, webCacheCacheableRes=webCacheCacheableRes, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotQueued=ipsRCTotQueued, dataPathStatus=dataPathStatus, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCacheMiss=webCacheMiss, fanDead=fanDead, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, activeServers=activeServers, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, vipStatus=vipStatus, currentFirmwareVersion=currentFirmwareVersion, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyTotalConn=sslProxyTotalConn, linkStatus=linkStatus, sslProxyOutBytes=sslProxyOutBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsStatsGroup=bwsStatsGroup, sslProxyBadCRLErr=sslProxyBadCRLErr, serviceStatus=serviceStatus, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsHdrAclPort=ipsHdrAclPort, sslProxyInBytes=sslProxyInBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyErrPms=sslProxyErrPms, bwsIpsRCStatsTable=bwsIpsRCStatsTable, systemFailOver=systemFailOver, httpProxyInBytes=httpProxyInBytes, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumConn=sslSrvrNumConn, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, switchingToInlineMode=switchingToInlineMode, serviceAddress=serviceAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsCookieSecTampered=ipsCookieSecTampered, peerUp=peerUp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, smAgentName=smAgentName, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprPort=webCmprPort, sslProxyAddress=sslProxyAddress, systemFanSpeed=systemFanSpeed, httpProxyAddressType=httpProxyAddressType, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrAddress=httpSrvrAddress, totalServers=totalServers, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyOutBytes=httpProxyOutBytes, httpSrvrAddressType=httpSrvrAddressType, uptime=uptime, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrInBytes=sslSrvrInBytes, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, energizeUpdateExpire=energizeUpdateExpire, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrTotRefused=sslSrvrTotRefused, ipsCookieSecPort=ipsCookieSecPort, firmwareStorage=firmwareStorage, bwstraps=bwstraps, systemFailure=systemFailure, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrMinResTime=httpSrvrMinResTime, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCachePort=webCachePort, ipsUrlNormAddress=ipsUrlNormAddress, bwsStats=bwsStats, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsRCTotServed=ipsRCTotServed, serverDown=serverDown, sslProxyCacheHits=sslProxyCacheHits, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, raidDegrading=raidDegrading, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrOutBytes=httpSrvrOutBytes, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheStale=webCacheStale, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCacheBytesOut=webCacheBytesOut, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyClientAbrt=httpProxyClientAbrt, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqLimitPort=ipsReqLimitPort, bwsMIBCompliances=bwsMIBCompliances, webCacheCachedObjects=webCacheCachedObjects, httpProxyServerReq=httpProxyServerReq, memUtilization=memUtilization, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCacheReq=webCacheReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, processCountHigh=processCountHigh, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyActiveConn=httpProxyActiveConn, operationalMode=operationalMode, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, serverUp=serverUp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyUnknownRsp=httpProxyUnknownRsp, cpuTemperature=cpuTemperature, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprAddress=webCmprAddress, logStorageHigh=logStorageHigh, securityDefUpdates=securityDefUpdates, webCmprAddressType=webCmprAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, smNumUserSessions=smNumUserSessions, srvcName=srvcName, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrPort=httpSrvrPort, bwsMIBCompliance=bwsMIBCompliance, ipsRCTotOutOfResource=ipsRCTotOutOfResource, firmwareStorageHigh=firmwareStorageHigh, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, tempHigh=tempHigh, dataPortLinkDown=dataPortLinkDown, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsMessage=bwsMessage, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrAddressType=sslSrvrAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqSrvcPort=ipsReqSrvcPort, tempCritical=tempCritical, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyActiveConn=sslProxyActiveConn, totalApplications=totalApplications, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsMIBGroups=bwsMIBGroups, ipsRCAddress=ipsRCAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, switchingToMaintMode=switchingToMaintMode, bws=bws, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyPort=sslProxyPort, ipsUrlPolicyPort=ipsUrlPolicyPort, totalMem=totalMem, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, serviceName=serviceName, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCPort=ipsRCPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyPort=httpProxyPort, virusDefUpdates=virusDefUpdates, sslProxyTotalReq=sslProxyTotalReq, sslSrvrAddress=sslSrvrAddress, systemLoad=systemLoad, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, PYSNMP_MODULE_ID=bws, totalAttacks=totalAttacks, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsTrapGroup=bwsTrapGroup, webCmprProtocol=webCmprProtocol, sslSrvrState=sslSrvrState)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrInBytes=httpSrvrInBytes, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitAddress=ipsReqLimitAddress, totalBandwidth=totalBandwidth, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyTotalConn=httpProxyTotalConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyCacheTimeouts=sslProxyCacheTimeouts, cpuUtilization=cpuUtilization, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, logStorage=logStorage, systemSerialNumber=systemSerialNumber, webCacheProtocol=webCacheProtocol, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumConn=httpSrvrNumConn, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyWAFWarnings=httpProxyWAFWarnings, servicePort=servicePort, sslProxyCacheMiss=sslProxyCacheMiss, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, freeMem=freeMem, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, smRealmName=smRealmName, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheHits=webCacheHits, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCacheLongHdrs=webCacheLongHdrs, httpProxyTotalReq=httpProxyTotalReq, webCacheAddress=webCacheAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, peerDown=peerDown, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsRCTotDropped=ipsRCTotDropped, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyAddressType=sslProxyAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCacheAddressType=webCacheAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, activeApplications=activeApplications, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrState=httpSrvrState, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr)
