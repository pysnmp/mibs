...
NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Bits, Unsigned32, Counter64, ObjectIdentity, Counter32, Integer32, TimeTicks, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Bits", "Unsigned32", "Counter64", "ObjectIdentity", "Counter32", "Integer32", "TimeTicks", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, activeApplications=activeApplications, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyTotalConn=httpProxyTotalConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, logStorage=logStorage, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrNumFreeConn=sslSrvrNumFreeConn, switchingToMaintMode=switchingToMaintMode, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, dataPathStatus=dataPathStatus, firmwareStorage=firmwareStorage, webCacheReq=webCacheReq, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyInBytes=httpProxyInBytes, systemFailOver=systemFailOver, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrInBytes=httpSrvrInBytes, sslSrvrOutBytes=sslSrvrOutBytes, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, uptime=uptime, webCacheAddress=webCacheAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxyServerReq=httpProxyServerReq, bwsCompressionStatsTable=bwsCompressionStatsTable, fanDead=fanDead, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, systemSerialNumber=systemSerialNumber, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCAddress=ipsRCAddress, systemLoad=systemLoad, bwsMIBCompliance=bwsMIBCompliance, sslProxyCacheMiss=sslProxyCacheMiss, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsRCAddressType=ipsRCAddressType, sslProxyAddressType=sslProxyAddressType, bwsServiceStatusEntry=bwsServiceStatusEntry, logStorageHigh=logStorageHigh, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, securityDefUpdates=securityDefUpdates, webCacheBytesOut=webCacheBytesOut, totalAttacks=totalAttacks, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxySessionTimeOut=httpProxySessionTimeOut, cpuUtilization=cpuUtilization, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrMinResTime=sslSrvrMinResTime, serviceAddress=serviceAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsHdrAclPort=ipsHdrAclPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsMIBGroups=bwsMIBGroups, sslProxyCacheHits=sslProxyCacheHits, webCacheAddressType=webCacheAddressType, srvcName=srvcName, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyPort=sslProxyPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsCookieSecAddress=ipsCookieSecAddress, totalServers=totalServers, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsServiceStatusTable=bwsServiceStatusTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsStatsGroup=bwsStatsGroup, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, peerDown=peerDown, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyWAFWarnings=httpProxyWAFWarnings, httpProxyActiveConn=httpProxyActiveConn, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrAddressType=httpSrvrAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyAddress=sslProxyAddress, dataPortLinkDown=dataPortLinkDown, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheHits=webCacheHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, linkStatus=linkStatus, httpSrvrTotSuccess=httpSrvrTotSuccess, totalApplications=totalApplications, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, servicePort=servicePort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrState=sslSrvrState, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlAclPort=ipsUrlAclPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, tempCritical=tempCritical, sslSrvrTotReqActive=sslSrvrTotReqActive, totalMem=totalMem, sslProxyOutBytes=sslProxyOutBytes, sslProxyInBytes=sslProxyInBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrAddress=sslSrvrAddress, memUtilization=memUtilization, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, energizeUpdateExpire=energizeUpdateExpire, httpProxyServerErr=httpProxyServerErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsTrapGroup=bwsTrapGroup, ipsHdrAclHits=ipsHdrAclHits, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrState=httpSrvrState, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsMIBConformance=bwsMIBConformance, bwsStats=bwsStats, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheLongHdrs=webCacheLongHdrs, webCacheMiss=webCacheMiss, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sharedSecretKeyExpired=sharedSecretKeyExpired, webCmprAddressType=webCmprAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, switchingToBypassMode=switchingToBypassMode, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheCacheableRes=webCacheCacheableRes, sslSrvrInBytes=sslSrvrInBytes, serviceStatus=serviceStatus, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, highAvailabilityStatus=highAvailabilityStatus, webCacheStale=webCacheStale, systemFanSpeed=systemFanSpeed, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, smRealmName=smRealmName, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, cpuTemperature=cpuTemperature, operationalMode=operationalMode, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, vipStatus=vipStatus, webCmprAddress=webCmprAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, systemFailure=systemFailure, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyOutBytes=httpProxyOutBytes, bws=bws, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyTotalReq=sslProxyTotalReq, ipsWebAddrTransPort=ipsWebAddrTransPort, serverDown=serverDown, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, PYSNMP_MODULE_ID=bws, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclAddressType=ipsUrlAclAddressType, smNumUserSessions=smNumUserSessions, processCountHigh=processCountHigh, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrAddress=httpSrvrAddress, httpProxyClientAbrt=httpProxyClientAbrt, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyParseErr=httpProxyParseErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyAddress=httpProxyAddress, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrNumConn=httpSrvrNumConn, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecPort=ipsCookieSecPort, httpProxyTotalReq=httpProxyTotalReq, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCacheProtocol=webCacheProtocol, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyServerAbrt=httpProxyServerAbrt, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyCurrentConn=sslProxyCurrentConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, cpuFanSpeed=cpuFanSpeed, httpSrvrTotResponse=httpSrvrTotResponse, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumConn=sslSrvrNumConn, virusDefUpdates=virusDefUpdates, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted)
mibBuilder.exportSymbols("BWS-MIB", ipsRCPort=ipsRCPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, smAgentName=smAgentName, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, memoryUsageHigh=memoryUsageHigh, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, switchingToInlineMode=switchingToInlineMode, webCmprPort=webCmprPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCmprProtocol=webCmprProtocol, bwstraps=bwstraps, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotTimedout=sslSrvrTotTimedout, serverUp=serverUp, firmwareStorageHigh=firmwareStorageHigh, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, raidDegrading=raidDegrading, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, freeMem=freeMem, webCachePort=webCachePort, ipsReqLimitPort=ipsReqLimitPort, webCacheCachedObjects=webCacheCachedObjects, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyAddressType=httpProxyAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlNormPort=ipsUrlNormPort, bwsMessage=bwsMessage, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, serviceName=serviceName, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyTotalConn=sslProxyTotalConn, ipsRCTotDropped=ipsRCTotDropped, peerUp=peerUp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, activeServers=activeServers, totalBandwidth=totalBandwidth, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrPort=httpSrvrPort, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, tempHigh=tempHigh, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrPort=sslSrvrPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrAddressType=sslSrvrAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyPort=httpProxyPort, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure)
