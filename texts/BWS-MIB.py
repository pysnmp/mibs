...
Integer32, iso, Counter32, ObjectIdentity, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, Bits, Unsigned32, Gauge32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Counter32", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "Bits", "Unsigned32", "Gauge32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheAddressType=webCacheAddressType, systemFailOver=systemFailOver, serverDown=serverDown, ipsAccessCtrlAddress=ipsAccessCtrlAddress, tempCritical=tempCritical, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsMIBCompliance=bwsMIBCompliance, bws=bws, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, systemLoad=systemLoad, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, webCmprPort=webCmprPort, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyBadCRLErr=sslProxyBadCRLErr, srvcName=srvcName, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, tempHigh=tempHigh, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCAddress=ipsRCAddress, memUtilization=memUtilization, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsTrapGroup=bwsTrapGroup, sslProxyPort=sslProxyPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, operationalMode=operationalMode, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyErrPms=sslProxyErrPms, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, serviceAddress=serviceAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsMessage=bwsMessage, vipStatus=vipStatus, PYSNMP_MODULE_ID=bws, httpSrvrPort=httpSrvrPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, dataPortLinkDown=dataPortLinkDown, cpuTemperature=cpuTemperature, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransPort=ipsWebAddrTransPort, dataPathStatus=dataPathStatus, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCTotQueued=ipsRCTotQueued, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCmprAddressType=webCmprAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, activeApplications=activeApplications, bwsServiceStatusTable=bwsServiceStatusTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitPort=ipsReqLimitPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, ipsHdrAclAddress=ipsHdrAclAddress, serviceName=serviceName, totalServers=totalServers, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyAddressType=httpProxyAddressType, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyOutBytes=httpProxyOutBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, totalAttacks=totalAttacks, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCmprAddress=webCmprAddress, smAgentName=smAgentName, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, linkStatus=linkStatus, webCmprProtocol=webCmprProtocol, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrAddress=httpSrvrAddress, processCountHigh=processCountHigh, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheCacheableRes=webCacheCacheableRes, bwsMIBCompliances=bwsMIBCompliances, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, fanDead=fanDead, uptime=uptime, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, smRealmName=smRealmName, ipsUrlAclAddressType=ipsUrlAclAddressType, switchingToInlineMode=switchingToInlineMode, sslProxyOutBytes=sslProxyOutBytes, logStorageHigh=logStorageHigh, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsRCTotDropped=ipsRCTotDropped, newAttackDefinitionInstalled=newAttackDefinitionInstalled, cpuUtilization=cpuUtilization, serviceStatus=serviceStatus, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyInBytes=httpProxyInBytes, httpProxyParseErr=httpProxyParseErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCacheProtocol=webCacheProtocol, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotServed=ipsRCTotServed, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, firmwareStorage=firmwareStorage, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCacheHits=webCacheHits, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyAddress=sslProxyAddress, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrState=httpSrvrState, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCachePort=webCachePort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, currentFirmwareVersion=currentFirmwareVersion, bwstraps=bwstraps, httpProxyServerReq=httpProxyServerReq, sslSrvrAddressType=sslSrvrAddressType, httpProxyActiveConn=httpProxyActiveConn, httpSrvrInBytes=httpSrvrInBytes, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, switchingToBypassMode=switchingToBypassMode, httpProxySessionTimeOut=httpProxySessionTimeOut, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCPort=ipsRCPort, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, smNumUserSessions=smNumUserSessions, raidDegrading=raidDegrading, freeMem=freeMem, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheStale=webCacheStale, webCacheMiss=webCacheMiss, totalMem=totalMem, dataPortLinkUp=dataPortLinkUp, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsMIBGroups=bwsMIBGroups, httpProxyWAFWarnings=httpProxyWAFWarnings, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyAddressType=sslProxyAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyCacheHits=sslProxyCacheHits, httpProxyTotalReq=httpProxyTotalReq, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, systemFanSpeed=systemFanSpeed, logStorage=logStorage, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, virusDefUpdates=virusDefUpdates, sslSrvrNumConn=sslSrvrNumConn, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyServerErr=httpProxyServerErr, serverUp=serverUp, httpProxyTotalConn=httpProxyTotalConn, httpProxyPort=httpProxyPort, peerDown=peerDown, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrState=sslSrvrState, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrInBytes=sslSrvrInBytes, energizeUpdateExpire=energizeUpdateExpire, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, webCacheAddress=webCacheAddress)
mibBuilder.exportSymbols("BWS-MIB", systemFailure=systemFailure, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrPort=sslSrvrPort, peerUp=peerUp, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, servicePort=servicePort, httpProxyAddress=httpProxyAddress, sslProxyTotalReq=sslProxyTotalReq, totalBandwidth=totalBandwidth, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, activeServers=activeServers, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyInBytes=sslProxyInBytes, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsHdrAclPort=ipsHdrAclPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheCachedObjects=webCacheCachedObjects, systemSerialNumber=systemSerialNumber, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsStats=bwsStats, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsHdrAclHits=ipsHdrAclHits, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsRCAddressType=ipsRCAddressType, httpSrvrNumConn=httpSrvrNumConn, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrMinResTime=sslSrvrMinResTime, webCacheReq=webCacheReq, sslSrvrAddress=sslSrvrAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, securityDefUpdates=securityDefUpdates, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, firmwareStorageHigh=firmwareStorageHigh, memoryUsageHigh=memoryUsageHigh, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, totalApplications=totalApplications, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow)
