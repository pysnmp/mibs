...
ModuleIdentity, Counter64, iso, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, TimeTicks, ObjectIdentity, Bits, Counter32, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "iso", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "TimeTicks", "ObjectIdentity", "Bits", "Counter32", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyTotalReq=sslProxyTotalReq, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlNormAddressType=ipsUrlNormAddressType, smNumUserSessions=smNumUserSessions, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumConn=httpSrvrNumConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrSrvcPort=sslSrvrSrvcPort, switchingToBypassMode=switchingToBypassMode, ipsRCTotDropped=ipsRCTotDropped, sslSrvrNumConn=sslSrvrNumConn, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyAddress=httpProxyAddress, webCmprPort=webCmprPort, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, bwsMIBCompliances=bwsMIBCompliances, httpProxyAddressType=httpProxyAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsHdrAclHits=ipsHdrAclHits, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsSMUserSessionEntry=bwsSMUserSessionEntry, totalApplications=totalApplications, cpuUtilization=cpuUtilization, sslProxyErrPms=sslProxyErrPms, httpProxyServerReq=httpProxyServerReq, bwsSMUserSessionTable=bwsSMUserSessionTable, dataPortLinkDown=dataPortLinkDown, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, tempCritical=tempCritical, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrPort=sslSrvrPort, tempHigh=tempHigh, sslSrvrTotResponse=sslSrvrTotResponse, webCmprAddressType=webCmprAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsServiceStatusTable=bwsServiceStatusTable, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, activeApplications=activeApplications, webCacheAddressType=webCacheAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheReq=webCacheReq, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyActiveConn=sslProxyActiveConn, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheProtocol=webCacheProtocol, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, dataPortLinkUp=dataPortLinkUp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcPort=ipsReqSrvcPort, webCacheHits=webCacheHits, webCachePort=webCachePort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCmprCompressedDataSize=webCmprCompressedDataSize, totalBandwidth=totalBandwidth, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsMessage=bwsMessage, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, smRealmName=smRealmName, securityDefUpdates=securityDefUpdates, ipsRCTotQueued=ipsRCTotQueued, ipsRCTotServed=ipsRCTotServed, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCmprAddress=webCmprAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyServerErr=httpProxyServerErr, switchingToMaintMode=switchingToMaintMode, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, servicePort=servicePort, ipsUrlAclAddress=ipsUrlAclAddress, serviceAddress=serviceAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyAddressType=sslProxyAddressType, sslProxyPort=sslProxyPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, logStorage=logStorage, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, memUtilization=memUtilization, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, bws=bws, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsRCPort=ipsRCPort, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlNormPort=ipsUrlNormPort, httpSrvrTotReqActive=httpSrvrTotReqActive, serviceName=serviceName, logStorageHigh=logStorageHigh, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrOutBytes=httpSrvrOutBytes, bwsMIBGroups=bwsMIBGroups, httpSrvrInBytes=httpSrvrInBytes, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, bwsStatsGroup=bwsStatsGroup, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, fanDead=fanDead, switchingToInlineMode=switchingToInlineMode, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, currentFirmwareVersion=currentFirmwareVersion, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, serverUp=serverUp, webCacheLongHdrs=webCacheLongHdrs, sslSrvrState=sslSrvrState, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, linkStatus=linkStatus, httpSrvrTotRefused=httpSrvrTotRefused, serviceStatus=serviceStatus, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsStats=bwsStats, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemSerialNumber=systemSerialNumber, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, firmwareStorage=firmwareStorage, httpProxyTotalConn=httpProxyTotalConn, httpSrvrPort=httpSrvrPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, dataPathStatus=dataPathStatus, energizeUpdateExpire=energizeUpdateExpire, srvcName=srvcName, PYSNMP_MODULE_ID=bws, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrAddressType=httpSrvrAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlAclReserved=ipsUrlAclReserved, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, memoryUsageHigh=memoryUsageHigh, smAgentName=smAgentName, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, raidDegrading=raidDegrading, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, cpuTemperature=cpuTemperature, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, systemFanSpeed=systemFanSpeed, ipsRCAddress=ipsRCAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyClientAbrt=httpProxyClientAbrt, firmwareStorageHigh=firmwareStorageHigh, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, systemFailure=systemFailure, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, totalAttacks=totalAttacks, processCountHigh=processCountHigh, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyAddress=sslProxyAddress, systemLoad=systemLoad, httpProxyPort=httpProxyPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, virusDefUpdates=virusDefUpdates, ipsHdrAclPort=ipsHdrAclPort, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCacheHits=sslProxyCacheHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, totalServers=totalServers, httpProxyParseErr=httpProxyParseErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsTrapGroup=bwsTrapGroup, highAvailabilityStatus=highAvailabilityStatus, webCacheCachedObjects=webCacheCachedObjects, ipsRCAddressType=ipsRCAddressType, activeServers=activeServers, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcAddress=ipsLrnSrvcAddress, peerDown=peerDown, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyTotalReq=httpProxyTotalReq, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyInBytes=sslProxyInBytes, httpProxyInBytes=httpProxyInBytes, sslSrvrAddress=sslSrvrAddress, webCacheBytesOut=webCacheBytesOut, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsMIBCompliance=bwsMIBCompliance, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, totalMem=totalMem, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, vipStatus=vipStatus, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxySessionTimeOut=httpProxySessionTimeOut, webCmprProtocol=webCmprProtocol, peerUp=peerUp, systemFailOver=systemFailOver, sslProxyOutBytes=sslProxyOutBytes, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrState=httpSrvrState, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrInBytes=sslSrvrInBytes, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyTotalConn=sslProxyTotalConn, operationalMode=operationalMode, webCacheAddress=webCacheAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, webCacheCacheableRes=webCacheCacheableRes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, freeMem=freeMem, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, serverDown=serverDown, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwstraps=bwstraps, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsMIBConformance=bwsMIBConformance, webCacheMiss=webCacheMiss, uptime=uptime, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqLimitPort=ipsReqLimitPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, webCacheStale=webCacheStale, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie)
