...
Counter64, ModuleIdentity, TimeTicks, NotificationType, Gauge32, Unsigned32, Bits, ObjectIdentity, IpAddress, Counter32, iso, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "TimeTicks", "NotificationType", "Gauge32", "Unsigned32", "Bits", "ObjectIdentity", "IpAddress", "Counter32", "iso", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyTotalReq=sslProxyTotalReq, webCmprAddress=webCmprAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyTotalConn=httpProxyTotalConn, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, cpuUtilization=cpuUtilization, sslProxyCacheHits=sslProxyCacheHits, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, totalMem=totalMem, logStorageHigh=logStorageHigh, httpSrvrPort=httpSrvrPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, currentFirmwareVersion=currentFirmwareVersion, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsMessage=bwsMessage, ipsReqLimitPort=ipsReqLimitPort, httpProxyAddressType=httpProxyAddressType, highAvailabilityStatus=highAvailabilityStatus, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, systemFanSpeed=systemFanSpeed, bws=bws, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprPort=webCmprPort, ipsCookieSecAddressType=ipsCookieSecAddressType, linkStatus=linkStatus, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyOutBytes=httpProxyOutBytes, dataPortLinkUp=dataPortLinkUp, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsMIBCompliances=bwsMIBCompliances, totalApplications=totalApplications, sslProxyPort=sslProxyPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrState=httpSrvrState, ipsRCTotServed=ipsRCTotServed, webCacheStale=webCacheStale, ipsReqSrvcAddress=ipsReqSrvcAddress, serviceStatus=serviceStatus, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcPort=ipsReqSrvcPort, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyInBytes=sslProxyInBytes, httpProxyWAFWarnings=httpProxyWAFWarnings, totalBandwidth=totalBandwidth, fanDead=fanDead, ipsUrlNormPort=ipsUrlNormPort, webCacheReq=webCacheReq, sslProxyTotalConn=sslProxyTotalConn, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrNumConn=httpSrvrNumConn, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheAddressType=webCacheAddressType, raidDegrading=raidDegrading, srvcName=srvcName, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrState=sslSrvrState, sslSrvrAddress=sslSrvrAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, switchingToInlineMode=switchingToInlineMode, httpSrvrTotResponse=httpSrvrTotResponse, uptime=uptime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsServiceStatusEntry=bwsServiceStatusEntry, operationalMode=operationalMode, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyParseErr=httpProxyParseErr, bwsMIBGroups=bwsMIBGroups, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrPort=sslSrvrPort, serviceAddress=serviceAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, dataPathStatus=dataPathStatus, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrInBytes=httpSrvrInBytes, processCountHigh=processCountHigh, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, memUtilization=memUtilization, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlAclAddress=ipsUrlAclAddress, freeMem=freeMem, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, systemFailure=systemFailure, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrNumConn=sslSrvrNumConn, sslProxyAddress=sslProxyAddress, sslSrvrAddressType=sslSrvrAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, systemFailOver=systemFailOver, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwstraps=bwstraps, newAttackDefinitionInstalled=newAttackDefinitionInstalled, memoryUsageHigh=memoryUsageHigh, serverDown=serverDown, servicePort=servicePort, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclPort=ipsUrlAclPort, ipsRCPort=ipsRCPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyCurrentConn=sslProxyCurrentConn, systemLoad=systemLoad, webCacheBytesOut=webCacheBytesOut, httpProxyInBytes=httpProxyInBytes, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsStats=bwsStats, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrAddress=httpSrvrAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, activeApplications=activeApplications, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, firmwareStorage=firmwareStorage, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, cpuTemperature=cpuTemperature, sslSrvrOutBytes=sslSrvrOutBytes, cpuFanSpeed=cpuFanSpeed, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCacheMiss=webCacheMiss, webCacheHits=webCacheHits, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsHdrAclPort=ipsHdrAclPort, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsStatsGroup=bwsStatsGroup, ipsUrlNormAddress=ipsUrlNormAddress, activeServers=activeServers, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheAddress=webCacheAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCacheLongHdrs=webCacheLongHdrs, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, vipStatus=vipStatus, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, peerUp=peerUp, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCAddressType=ipsRCAddressType, httpSrvrMinResTime=httpSrvrMinResTime, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, PYSNMP_MODULE_ID=bws, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheProtocol=webCacheProtocol, tempHigh=tempHigh, bwsTrapGroup=bwsTrapGroup, sslProxyFullHandshakes=sslProxyFullHandshakes, smRealmName=smRealmName, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, systemSerialNumber=systemSerialNumber, ipsRCAddress=ipsRCAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsHdrAclHits=ipsHdrAclHits, ipsRCTotQueued=ipsRCTotQueued, totalServers=totalServers, serverUp=serverUp)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCmprProtocol=webCmprProtocol, httpProxyActiveConn=httpProxyActiveConn, sslProxyBadCRLErr=sslProxyBadCRLErr, webCachePort=webCachePort, dataPortLinkDown=dataPortLinkDown, bwsMIBCompliance=bwsMIBCompliance, tempCritical=tempCritical, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyAddress=httpProxyAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyPort=httpProxyPort, securityDefUpdates=securityDefUpdates, virusDefUpdates=virusDefUpdates, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsMIBConformance=bwsMIBConformance, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyServerReq=httpProxyServerReq, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCTotDropped=ipsRCTotDropped, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyTotalReq=httpProxyTotalReq, serviceName=serviceName, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyErrPms=sslProxyErrPms, webCmprAddressType=webCmprAddressType, sslSrvrTotRefused=sslSrvrTotRefused, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlPort=ipsAccessCtrlPort, logStorage=logStorage, ipsCookieSecPort=ipsCookieSecPort, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, peerDown=peerDown, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCacheCachedObjects=webCacheCachedObjects, sslProxyAddressType=sslProxyAddressType, firmwareStorageHigh=firmwareStorageHigh, totalAttacks=totalAttacks, smAgentName=smAgentName, webCacheCacheableRes=webCacheCacheableRes, httpProxyClientAbrt=httpProxyClientAbrt)
