...
iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, ObjectIdentity, IpAddress, Counter32, Unsigned32, Bits, TimeTicks, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "ObjectIdentity", "IpAddress", "Counter32", "Unsigned32", "Bits", "TimeTicks", "Counter64", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, serverDown=serverDown, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsRCAddress=ipsRCAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlAclPort=ipsUrlAclPort, ipsHdrAclPort=ipsHdrAclPort, smRealmName=smRealmName, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitPort=ipsReqLimitPort, vipStatus=vipStatus, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serviceName=serviceName, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheHits=webCacheHits, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, dataPortLinkDown=dataPortLinkDown, webCacheLongHdrs=webCacheLongHdrs, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsRCTotDropped=ipsRCTotDropped, srvcName=srvcName, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, dataPortLinkUp=dataPortLinkUp, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, freeMem=freeMem, switchingToMaintMode=switchingToMaintMode, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, uptime=uptime, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheMiss=webCacheMiss, sslSrvrAddress=sslSrvrAddress, ipsHdrAclHits=ipsHdrAclHits, sslProxyInBytes=sslProxyInBytes, operationalMode=operationalMode, activeServers=activeServers, httpSrvrAddressType=httpSrvrAddressType, sslSrvrPort=sslSrvrPort, sslSrvrInBytes=sslSrvrInBytes, serviceStatus=serviceStatus, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, PYSNMP_MODULE_ID=bws, peerUp=peerUp, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, totalMem=totalMem, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrState=httpSrvrState, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, linkStatus=linkStatus, sslProxyCacheHits=sslProxyCacheHits, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlPort=ipsAccessCtrlPort, webCacheReq=webCacheReq, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, highAvailabilityStatus=highAvailabilityStatus, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, switchingToBypassMode=switchingToBypassMode, totalAttacks=totalAttacks, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrState=sslSrvrState, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyAddressType=httpProxyAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, cpuTemperature=cpuTemperature, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyTotalConn=httpProxyTotalConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyActiveConn=sslProxyActiveConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, raidDegrading=raidDegrading, cpuUtilization=cpuUtilization, systemFailOver=systemFailOver, totalBandwidth=totalBandwidth, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, processCountHigh=processCountHigh, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyErrPms=sslProxyErrPms, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, systemSerialNumber=systemSerialNumber, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, energizeUpdateExpire=energizeUpdateExpire, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwstraps=bwstraps, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransPort=ipsWebAddrTransPort, firmwareStorage=firmwareStorage, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, tempHigh=tempHigh, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, smNumUserSessions=smNumUserSessions, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, logStorageHigh=logStorageHigh, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsTrapGroup=bwsTrapGroup, fanDead=fanDead, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrNumConn=httpSrvrNumConn, bwsMIBGroups=bwsMIBGroups, bwsStatsGroup=bwsStatsGroup, logStorage=logStorage, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheBytesOut=webCacheBytesOut, bws=bws, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, serviceAddress=serviceAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsRCTotQueued=ipsRCTotQueued, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprPort=webCmprPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, systemFanSpeed=systemFanSpeed, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyPort=ipsUrlPolicyPort, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsStats=bwsStats, webCacheProtocol=webCacheProtocol, servicePort=servicePort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheAddress=webCacheAddress, bwsMIBConformance=bwsMIBConformance, httpProxyServerErr=httpProxyServerErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyInBytes=httpProxyInBytes, memoryUsageHigh=memoryUsageHigh, webCmprAddressType=webCmprAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, securityDefUpdates=securityDefUpdates, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, tempCritical=tempCritical, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, serverUp=serverUp, ipsUrlNormAddress=ipsUrlNormAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlAclAddress=ipsUrlAclAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotRefused=httpSrvrTotRefused, ipsRCPort=ipsRCPort, httpSrvrPort=httpSrvrPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCacheAddressType=webCacheAddressType, httpProxyAddress=httpProxyAddress, webCacheStale=webCacheStale, systemLoad=systemLoad, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyAddressType=sslProxyAddressType, sslProxyTotalReq=sslProxyTotalReq, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrNumConn=sslSrvrNumConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, totalServers=totalServers, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable)
mibBuilder.exportSymbols("BWS-MIB", bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotResponse=httpSrvrTotResponse, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsMIBCompliances=bwsMIBCompliances, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, totalApplications=totalApplications, webCacheCacheableRes=webCacheCacheableRes, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, peerDown=peerDown, sslProxyAddress=sslProxyAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyServerAbrt=httpProxyServerAbrt, webCmprAddress=webCmprAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsMessage=bwsMessage, memUtilization=memUtilization, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrAddress=httpSrvrAddress, currentFirmwareVersion=currentFirmwareVersion, ipsRCTotServed=ipsRCTotServed, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrOutBytes=httpSrvrOutBytes, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotRefused=sslSrvrTotRefused, ipsCookieSecAddress=ipsCookieSecAddress, dataPathStatus=dataPathStatus, httpProxyServerReq=httpProxyServerReq, webCachePort=webCachePort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, systemFailure=systemFailure, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitAddress=ipsReqLimitAddress, activeApplications=activeApplications, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyPort=sslProxyPort, virusDefUpdates=virusDefUpdates, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCAddressType=ipsRCAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlAddress=ipsAccessCtrlAddress, smAgentName=smAgentName, httpProxyPort=httpProxyPort, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyActiveConn=httpProxyActiveConn, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol)
