...
TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Counter64, NotificationType, ModuleIdentity, Bits, ObjectIdentity, MibIdentifier, IpAddress, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Counter64", "NotificationType", "ModuleIdentity", "Bits", "ObjectIdentity", "MibIdentifier", "IpAddress", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyAddressType=httpProxyAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, virusDefUpdates=virusDefUpdates, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlAclReserved=ipsUrlAclReserved, serviceStatus=serviceStatus, memUtilization=memUtilization, httpProxyServerReq=httpProxyServerReq, systemFailure=systemFailure, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, bwsSMUserSessionEntry=bwsSMUserSessionEntry, activeApplications=activeApplications, sslSrvrTotRefused=sslSrvrTotRefused, peerDown=peerDown, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCmprAddress=webCmprAddress, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsCompressionStatsTable=bwsCompressionStatsTable, bwstraps=bwstraps, httpProxyInBytes=httpProxyInBytes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrInBytes=sslSrvrInBytes, firmwareStorage=firmwareStorage, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrPort=httpSrvrPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlNormAddress=ipsUrlNormAddress, webCachePort=webCachePort, httpSrvrAddress=httpSrvrAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, activeServers=activeServers, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, smRealmName=smRealmName, ipsRCTimeStamp=ipsRCTimeStamp, httpProxyPort=httpProxyPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheReq=webCacheReq, servicePort=servicePort, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsRCAddress=ipsRCAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyErrPms=sslProxyErrPms, systemFailOver=systemFailOver, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsWebAddrTransAddress=ipsWebAddrTransAddress, cpuTemperature=cpuTemperature, peerUp=peerUp, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCacheAddress=webCacheAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrAddressType=sslSrvrAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, serviceName=serviceName, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyPort=sslProxyPort, httpProxyTotalReq=httpProxyTotalReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyTotalReq=sslProxyTotalReq, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCmprProtocol=webCmprProtocol, raidDegrading=raidDegrading, webCacheCachedObjects=webCacheCachedObjects, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsRCTotDropped=ipsRCTotDropped, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, switchingToBypassMode=switchingToBypassMode, sslProxyTotalConn=sslProxyTotalConn, ipsRCAddressType=ipsRCAddressType, webCacheMiss=webCacheMiss, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsMessage=bwsMessage, linkStatus=linkStatus, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsCookieSecEncrypted=ipsCookieSecEncrypted, vipStatus=vipStatus, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, systemLoad=systemLoad, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheStale=webCacheStale, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, tempHigh=tempHigh, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsHdrAclAddress=ipsHdrAclAddress, systemFanSpeed=systemFanSpeed, ipsReqLimitAddress=ipsReqLimitAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, operationalMode=operationalMode, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsHdrAclAddressType=ipsHdrAclAddressType, totalApplications=totalApplications, sslSrvrNumConn=sslSrvrNumConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, smNumUserSessions=smNumUserSessions, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, serverDown=serverDown, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitPort=ipsReqLimitPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, cpuUtilization=cpuUtilization, bwsStats=bwsStats, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsRCTotQueued=ipsRCTotQueued, httpSrvrInBytes=httpSrvrInBytes, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, switchingToMaintMode=switchingToMaintMode, smAgentName=smAgentName, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlAclAddress=ipsUrlAclAddress, ipsHdrAclPort=ipsHdrAclPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheHits=webCacheHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsCookieSecPort=ipsCookieSecPort, httpProxyUnknownRsp=httpProxyUnknownRsp, totalServers=totalServers, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, totalBandwidth=totalBandwidth, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrPort=sslSrvrPort, webCmprAddressType=webCmprAddressType, processCountHigh=processCountHigh, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyActiveConn=sslProxyActiveConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprPort=webCmprPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyCurrentConn=sslProxyCurrentConn, currentFirmwareVersion=currentFirmwareVersion, ipsReqSrvcPort=ipsReqSrvcPort, serverUp=serverUp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslProxyAddress=sslProxyAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCacheAddressType=webCacheAddressType, uptime=uptime, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrNumConn=httpSrvrNumConn, bwsStatsGroup=bwsStatsGroup, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsMIBConformance=bwsMIBConformance, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyOutBytes=sslProxyOutBytes, bwsMIBCompliances=bwsMIBCompliances, ipsRCPort=ipsRCPort, totalMem=totalMem, httpProxyTotalConn=httpProxyTotalConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyAddress=httpProxyAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrAddress=sslSrvrAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotRefused=httpSrvrTotRefused, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsServiceStatusTable=bwsServiceStatusTable, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bws=bws, fanDead=fanDead, dataPortLinkUp=dataPortLinkUp, srvcName=srvcName)
mibBuilder.exportSymbols("BWS-MIB", newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrAvgResTime=sslSrvrAvgResTime, systemSerialNumber=systemSerialNumber, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, logStorage=logStorage, sslProxyCacheHits=sslProxyCacheHits, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrMinResTime=sslSrvrMinResTime, serviceAddress=serviceAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, webCacheCacheableRes=webCacheCacheableRes, httpProxyOutBytes=httpProxyOutBytes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsLrnSrvcPort=ipsLrnSrvcPort, logStorageHigh=logStorageHigh, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyInBytes=sslProxyInBytes, PYSNMP_MODULE_ID=bws, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, tempCritical=tempCritical, totalAttacks=totalAttacks, highAvailabilityStatus=highAvailabilityStatus, dataPathStatus=dataPathStatus, bwsMIBCompliance=bwsMIBCompliance, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyAddressType=sslProxyAddressType, webCacheProtocol=webCacheProtocol, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrState=sslSrvrState, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheBytesOut=webCacheBytesOut, bwsTrapGroup=bwsTrapGroup, energizeUpdateExpire=energizeUpdateExpire, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyParseErr=httpProxyParseErr, freeMem=freeMem, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, switchingToInlineMode=switchingToInlineMode, ipsUrlAclPort=ipsUrlAclPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrState=httpSrvrState, httpProxyClientAbrt=httpProxyClientAbrt)
