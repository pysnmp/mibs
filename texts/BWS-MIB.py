...
Integer32, IpAddress, Counter64, iso, Bits, ObjectIdentity, MibIdentifier, Unsigned32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Counter64", "iso", "Bits", "ObjectIdentity", "MibIdentifier", "Unsigned32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", virusDefUpdates=virusDefUpdates, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlAddress=ipsAccessCtrlAddress, freeMem=freeMem, ipsReqLimitPort=ipsReqLimitPort, tempHigh=tempHigh, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheHits=webCacheHits, systemLoad=systemLoad, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, smRealmName=smRealmName, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyTotalReq=httpProxyTotalReq, webCacheReq=webCacheReq, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, processCountHigh=processCountHigh, sslSrvrOutBytes=sslSrvrOutBytes, ipsRCTimeStamp=ipsRCTimeStamp, peerUp=peerUp, sslProxyOutBytes=sslProxyOutBytes, httpProxyClientAbrt=httpProxyClientAbrt, bwsServiceStatusEntry=bwsServiceStatusEntry, logStorage=logStorage, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheCachedObjects=webCacheCachedObjects, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, servicePort=servicePort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsStats=bwsStats, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlNormPort=ipsUrlNormPort, dataPathStatus=dataPathStatus, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, serverUp=serverUp, sslProxyAddress=sslProxyAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrInBytes=sslSrvrInBytes, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, cpuUtilization=cpuUtilization, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsMIBConformance=bwsMIBConformance, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, systemSerialNumber=systemSerialNumber, sslSrvrNumConn=sslSrvrNumConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, energizeUpdateExpire=energizeUpdateExpire, ipsUrlAclAddress=ipsUrlAclAddress, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrAddress=sslSrvrAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, activeServers=activeServers, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyTotalConn=httpProxyTotalConn, systemFailure=systemFailure, systemFanSpeed=systemFanSpeed, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, serverDown=serverDown, httpProxyInBytes=httpProxyInBytes, httpProxyServerReq=httpProxyServerReq, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serviceName=serviceName, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, dataPortLinkUp=dataPortLinkUp, bwsStatsGroup=bwsStatsGroup, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrAddress=httpSrvrAddress, switchingToBypassMode=switchingToBypassMode, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyOutBytes=httpProxyOutBytes, webCmprAddressType=webCmprAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrTotTimedout=httpSrvrTotTimedout, totalMem=totalMem, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCmprProtocol=webCmprProtocol, memUtilization=memUtilization, httpProxyActiveConn=httpProxyActiveConn, bwstraps=bwstraps, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheAddressType=webCacheAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, switchingToMaintMode=switchingToMaintMode, activeApplications=activeApplications, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsHdrAclHits=ipsHdrAclHits, httpSrvrPort=httpSrvrPort, sslSrvrPort=sslSrvrPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotDropped=ipsRCTotDropped, firmwareStorageHigh=firmwareStorageHigh, logStorageHigh=logStorageHigh, httpSrvrTotResponse=httpSrvrTotResponse, currentFirmwareVersion=currentFirmwareVersion, totalAttacks=totalAttacks, memoryUsageHigh=memoryUsageHigh, smNumUserSessions=smNumUserSessions, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, cpuTemperature=cpuTemperature, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrState=httpSrvrState, operationalMode=operationalMode, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyPort=httpProxyPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrTotRefused=httpSrvrTotRefused, bwsMIBCompliances=bwsMIBCompliances, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, switchingToInlineMode=switchingToInlineMode, webCmprCompressedDataSize=webCmprCompressedDataSize, totalBandwidth=totalBandwidth, serviceStatus=serviceStatus, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCmprPort=webCmprPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheProtocol=webCacheProtocol, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCachePort=webCachePort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, uptime=uptime, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyAddressType=httpProxyAddressType, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrTotSuccess=httpSrvrTotSuccess, firmwareStorage=firmwareStorage, ipsCookieSecPort=ipsCookieSecPort, sslProxyPort=sslProxyPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, serviceAddress=serviceAddress, ipsUrlAclPort=ipsUrlAclPort, httpProxyAddress=httpProxyAddress, securityDefUpdates=securityDefUpdates, sslSrvrAddressType=sslSrvrAddressType, raidDegrading=raidDegrading, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, dataPortLinkDown=dataPortLinkDown, ipsUrlNormAddress=ipsUrlNormAddress, bwsMIBGroups=bwsMIBGroups, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, smAgentName=smAgentName, bws=bws, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, peerDown=peerDown, highAvailabilityStatus=highAvailabilityStatus, httpSrvrAddressType=httpSrvrAddressType, bwsMIBCompliance=bwsMIBCompliance, sslProxyTotalReq=sslProxyTotalReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyCacheHits=sslProxyCacheHits, httpProxyParseErr=httpProxyParseErr, webCmprAddress=webCmprAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyWAFWarnings=httpProxyWAFWarnings, srvcName=srvcName, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyAddressType=sslProxyAddressType)
mibBuilder.exportSymbols("BWS-MIB", tempCritical=tempCritical, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrState=sslSrvrState, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheMiss=webCacheMiss, httpSrvrAvgResTime=httpSrvrAvgResTime, totalServers=totalServers, webCacheStale=webCacheStale, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyActiveConn=sslProxyActiveConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, totalApplications=totalApplications, httpSrvrNumConn=httpSrvrNumConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqSrvcPort=ipsReqSrvcPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcPort=ipsLrnSrvcPort, linkStatus=linkStatus, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCPort=ipsRCPort, ipsRCAddress=ipsRCAddress, fanDead=fanDead, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrOutBytes=httpSrvrOutBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsTrapGroup=bwsTrapGroup, webCacheBytesOut=webCacheBytesOut, bwsMessage=bwsMessage, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheAddress=webCacheAddress, systemFailOver=systemFailOver, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, PYSNMP_MODULE_ID=bws, ipsRCAddressType=ipsRCAddressType, vipStatus=vipStatus, ipsHdrAclPort=ipsHdrAclPort, sslProxyTotalConn=sslProxyTotalConn, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrSrvcPort=httpSrvrSrvcPort, cpuFanSpeed=cpuFanSpeed, webCacheCacheableRes=webCacheCacheableRes, sslSrvrTotReqActive=sslSrvrTotReqActive)
