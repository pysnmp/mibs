...
Bits, IpAddress, NotificationType, Integer32, Gauge32, Unsigned32, Counter32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "NotificationType", "Integer32", "Gauge32", "Unsigned32", "Counter32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyAddress=httpProxyAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyAddressType=httpProxyAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, freeMem=freeMem, httpProxyTotalConn=httpProxyTotalConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, tempHigh=tempHigh, totalServers=totalServers, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclHits=ipsHdrAclHits, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, switchingToBypassMode=switchingToBypassMode, httpSrvrMaxResTime=httpSrvrMaxResTime, totalApplications=totalApplications, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrInBytes=sslSrvrInBytes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsStats=bwsStats, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, memUtilization=memUtilization, webCmprCompressibleDataSize=webCmprCompressibleDataSize, systemFailOver=systemFailOver, cpuTemperature=cpuTemperature, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCmprAddress=webCmprAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, systemFanSpeed=systemFanSpeed, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, raidDegrading=raidDegrading, serviceName=serviceName, firmwareStorage=firmwareStorage, sslProxyCurrentConn=sslProxyCurrentConn, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsMIBCompliances=bwsMIBCompliances, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, highAvailabilityStatus=highAvailabilityStatus, vipStatus=vipStatus, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, serviceAddress=serviceAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotRefused=sslSrvrTotRefused, ipsHdrAclAddressType=ipsHdrAclAddressType, switchingToInlineMode=switchingToInlineMode, webCacheReq=webCacheReq, peerUp=peerUp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyErrPms=sslProxyErrPms, webCmprProtocol=webCmprProtocol, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, serviceStatus=serviceStatus, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsRCTotDropped=ipsRCTotDropped, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCacheProtocol=webCacheProtocol, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, totalBandwidth=totalBandwidth, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsRCPort=ipsRCPort, smAgentName=smAgentName, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyTotalConn=sslProxyTotalConn, sslSrvrTotReqActive=sslSrvrTotReqActive, bws=bws, sslSrvrAddressType=sslSrvrAddressType, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, totalMem=totalMem, sslProxyAddress=sslProxyAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsMessage=bwsMessage, webCacheAddress=webCacheAddress, ipsUrlNormPort=ipsUrlNormPort, serverUp=serverUp, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, securityDefUpdates=securityDefUpdates, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, PYSNMP_MODULE_ID=bws, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrMinResTime=sslSrvrMinResTime, bwsStatsGroup=bwsStatsGroup, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, activeServers=activeServers, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, systemSerialNumber=systemSerialNumber, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, servicePort=servicePort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCachePort=webCachePort, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrAddressType=httpSrvrAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyServerReq=httpProxyServerReq, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyCacheHits=sslProxyCacheHits, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCmprPort=webCmprPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqLimitPort=ipsReqLimitPort, operationalMode=operationalMode, firmwareStorageHigh=firmwareStorageHigh, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyAddressType=sslProxyAddressType, energizeUpdateExpire=energizeUpdateExpire, httpProxyParseErr=httpProxyParseErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, linkStatus=linkStatus, sslProxyInBytes=sslProxyInBytes, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyTotalReq=sslProxyTotalReq, cpuFanSpeed=cpuFanSpeed, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrMaxResTime=sslSrvrMaxResTime, dataPortLinkUp=dataPortLinkUp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrAddress=sslSrvrAddress, bwsMIBConformance=bwsMIBConformance, webCacheAddressType=webCacheAddressType, totalAttacks=totalAttacks, bwsSMUserSessionTable=bwsSMUserSessionTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAddress=ipsAccessCtrlAddress, currentFirmwareVersion=currentFirmwareVersion, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, virusDefUpdates=virusDefUpdates, srvcName=srvcName, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitAddress=ipsReqLimitAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyClientAbrt=httpProxyClientAbrt, switchingToMaintMode=switchingToMaintMode, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyTotalReq=httpProxyTotalReq, memoryUsageHigh=memoryUsageHigh, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, peerDown=peerDown, ipsRCTotServed=ipsRCTotServed, uptime=uptime, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwstraps=bwstraps, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpSrvrState=httpSrvrState, webCacheCachedObjects=webCacheCachedObjects, bwsTrapGroup=bwsTrapGroup, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsMIBCompliance=bwsMIBCompliance, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheMiss=webCacheMiss, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq)
mibBuilder.exportSymbols("BWS-MIB", bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyPort=httpProxyPort, httpProxyServerErr=httpProxyServerErr, ipsCookieSecTampered=ipsCookieSecTampered, activeApplications=activeApplications, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheBytesOut=webCacheBytesOut, sslProxyPort=sslProxyPort, sslProxyActiveConn=sslProxyActiveConn, systemLoad=systemLoad, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrNumConn=httpSrvrNumConn, processCountHigh=processCountHigh, ipsLrnSrvcPort=ipsLrnSrvcPort, webCacheLongHdrs=webCacheLongHdrs, bwsCacheStatsEntry=bwsCacheStatsEntry, tempCritical=tempCritical, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrMinResTime=httpSrvrMinResTime, ipsRCAddress=ipsRCAddress, ipsUrlAclReserved=ipsUrlAclReserved, logStorageHigh=logStorageHigh, sslSrvrState=sslSrvrState, sslSrvrNumConn=sslSrvrNumConn, systemFailure=systemFailure, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, fanDead=fanDead, webCmprCompressedDataSize=webCmprCompressedDataSize, dataPortLinkDown=dataPortLinkDown, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, smRealmName=smRealmName, webCmprAddressType=webCmprAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, dataPathStatus=dataPathStatus, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, cpuUtilization=cpuUtilization, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrPort=sslSrvrPort, logStorage=logStorage, webCacheStale=webCacheStale, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheHits=webCacheHits, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrTotSuccess=sslSrvrTotSuccess, smNumUserSessions=smNumUserSessions, serverDown=serverDown, httpSrvrPort=httpSrvrPort, sslSrvrAvgResTime=sslSrvrAvgResTime)
