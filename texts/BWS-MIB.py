...
NotificationType, Integer32, Gauge32, ObjectIdentity, TimeTicks, Bits, MibIdentifier, IpAddress, Counter32, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Gauge32", "ObjectIdentity", "TimeTicks", "Bits", "MibIdentifier", "IpAddress", "Counter32", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAddressType=sslProxyAddressType, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, serviceName=serviceName, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCacheLongHdrs=webCacheLongHdrs, webCmprPort=webCmprPort, sslProxyTotalConn=sslProxyTotalConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlAclPort=ipsUrlAclPort, smAgentName=smAgentName, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCacheReq=webCacheReq, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, currentFirmwareVersion=currentFirmwareVersion, ipsUrlNormAddress=ipsUrlNormAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlPort=ipsAccessCtrlPort, cpuUtilization=cpuUtilization, servicePort=servicePort, httpProxyServerReq=httpProxyServerReq, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrAddressType=sslSrvrAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrAddressType=httpSrvrAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCmprAddress=webCmprAddress, serverUp=serverUp, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrOutBytes=httpSrvrOutBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsMIBConformance=bwsMIBConformance, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, smRealmName=smRealmName, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCPort=ipsRCPort, cpuTemperature=cpuTemperature, systemLoad=systemLoad, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCAddress=ipsRCAddress, dataPathStatus=dataPathStatus, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, tempHigh=tempHigh, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecTampered=ipsCookieSecTampered, PYSNMP_MODULE_ID=bws, webCmprProtocol=webCmprProtocol, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyCacheHits=sslProxyCacheHits, sslProxyOutBytes=sslProxyOutBytes, webCacheBytesOut=webCacheBytesOut, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrAddress=httpSrvrAddress, systemSerialNumber=systemSerialNumber, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCTotQueued=ipsRCTotQueued, fanDead=fanDead, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitPort=ipsReqLimitPort, tempCritical=tempCritical, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCachePort=webCachePort, sslSrvrPort=sslSrvrPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyServerErr=httpProxyServerErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, vipStatus=vipStatus, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, memoryUsageHigh=memoryUsageHigh, sslProxyBadCRLErr=sslProxyBadCRLErr, dataPortLinkDown=dataPortLinkDown, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, operationalMode=operationalMode, webCacheAddress=webCacheAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, freeMem=freeMem, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsHdrAclPort=ipsHdrAclPort, logStorage=logStorage, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, totalMem=totalMem, httpProxyActiveConn=httpProxyActiveConn, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecPort=ipsCookieSecPort, systemFailOver=systemFailOver, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyClientAbrt=httpProxyClientAbrt, bwsSslProxyStatsTable=bwsSslProxyStatsTable, peerUp=peerUp, webCacheHits=webCacheHits, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyAddress=sslProxyAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrMaxResTime=sslSrvrMaxResTime, switchingToMaintMode=switchingToMaintMode, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrTotResponse=httpSrvrTotResponse, uptime=uptime, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlNormPort=ipsUrlNormPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyPort=httpProxyPort, sslSrvrAddress=sslSrvrAddress, highAvailabilityStatus=highAvailabilityStatus, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwstraps=bwstraps, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheStale=webCacheStale, sslProxyInBytes=sslProxyInBytes, smNumUserSessions=smNumUserSessions, raidDegrading=raidDegrading, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCacheProtocol=webCacheProtocol, httpProxyAddress=httpProxyAddress, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsMIBGroups=bwsMIBGroups, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpSrvrState=httpSrvrState, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, firmwareStorage=firmwareStorage, httpSrvrInBytes=httpSrvrInBytes, switchingToBypassMode=switchingToBypassMode, ipsCookieSecEncrypted=ipsCookieSecEncrypted, dataPortLinkUp=dataPortLinkUp, sslSrvrInBytes=sslSrvrInBytes, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrTotRefused=sslSrvrTotRefused, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpProxyInBytes=httpProxyInBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyTotalReq=httpProxyTotalReq, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyOutBytes=httpProxyOutBytes, sslProxyActiveConn=sslProxyActiveConn, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, logStorageHigh=logStorageHigh, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCTotServed=ipsRCTotServed, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, cpuFanSpeed=cpuFanSpeed, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCmprAddressType=webCmprAddressType, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, switchingToInlineMode=switchingToInlineMode, ipsReqSrvcAddress=ipsReqSrvcAddress, processCountHigh=processCountHigh, bwsStatsGroup=bwsStatsGroup, activeApplications=activeApplications, webCacheMiss=webCacheMiss, memUtilization=memUtilization, sslSrvrState=sslSrvrState, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, totalApplications=totalApplications, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrPort=httpSrvrPort, sslProxyTotalReq=sslProxyTotalReq, bwsMIBCompliance=bwsMIBCompliance, sslSrvrNumConn=sslSrvrNumConn, serverDown=serverDown, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheCachedObjects=webCacheCachedObjects, peerDown=peerDown, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrOutBytes=sslSrvrOutBytes)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrAvgResTime=httpSrvrAvgResTime, totalAttacks=totalAttacks, systemFailure=systemFailure, sslSrvrAvgResTime=sslSrvrAvgResTime, totalBandwidth=totalBandwidth, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, energizeUpdateExpire=energizeUpdateExpire, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsTrapGroup=bwsTrapGroup, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyErrPms=sslProxyErrPms, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyCacheMiss=sslProxyCacheMiss, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsRCTimeStamp=ipsRCTimeStamp, bwsStats=bwsStats, serviceStatus=serviceStatus, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bws=bws, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyTotalConn=httpProxyTotalConn, bwsMessage=bwsMessage, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCTotDropped=ipsRCTotDropped, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, systemFanSpeed=systemFanSpeed, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, linkStatus=linkStatus, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsCompressionStatsTable=bwsCompressionStatsTable, virusDefUpdates=virusDefUpdates, srvcName=srvcName, sslProxyPort=sslProxyPort, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsUrlPolicyAddress=ipsUrlPolicyAddress, securityDefUpdates=securityDefUpdates, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, serviceAddress=serviceAddress, totalServers=totalServers, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, firmwareStorageHigh=firmwareStorageHigh, webCacheAddressType=webCacheAddressType, ipsHdrAclHits=ipsHdrAclHits, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyAddressType=httpProxyAddressType, activeServers=activeServers)
