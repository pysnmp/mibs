...
IpAddress, TimeTicks, Counter32, Counter64, NotificationType, iso, Unsigned32, MibIdentifier, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter32", "Counter64", "NotificationType", "iso", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlNormPort=ipsUrlNormPort, bwsCacheStatsTable=bwsCacheStatsTable, logStorage=logStorage, sslSrvrPort=sslSrvrPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCachePort=webCachePort, httpSrvrPort=httpSrvrPort, cpuTemperature=cpuTemperature, ipsReqSrvcPort=ipsReqSrvcPort, smRealmName=smRealmName, ipsRCTotQueued=ipsRCTotQueued, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrState=sslSrvrState, httpProxyClientAbrt=httpProxyClientAbrt, currentFirmwareVersion=currentFirmwareVersion, ipsReqSrvcAddress=ipsReqSrvcAddress, tempCritical=tempCritical, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheAddress=webCacheAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyAddress=httpProxyAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, uptime=uptime, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, systemFailure=systemFailure, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, systemFanSpeed=systemFanSpeed, totalServers=totalServers, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsStatsGroup=bwsStatsGroup, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, dataPortLinkDown=dataPortLinkDown, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, raidDegrading=raidDegrading, memoryUsageHigh=memoryUsageHigh, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, systemSerialNumber=systemSerialNumber, webCmprProtocol=webCmprProtocol, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheReq=webCacheReq, bwsMIBCompliances=bwsMIBCompliances, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrAddress=sslSrvrAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, serviceName=serviceName, bws=bws, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyServerReq=httpProxyServerReq, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsStats=bwsStats, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyBadDNCErr=sslProxyBadDNCErr, tempHigh=tempHigh, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyTotalReq=sslProxyTotalReq, ipsUrlAclPort=ipsUrlAclPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyPort=sslProxyPort, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsCookieSecAddress=ipsCookieSecAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, vipStatus=vipStatus, sslProxyAddressType=sslProxyAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCacheCacheableRes=webCacheCacheableRes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, freeMem=freeMem, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpProxyActiveConn=httpProxyActiveConn, bwsMIBCompliance=bwsMIBCompliance, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyTotalConn=httpProxyTotalConn, smNumUserSessions=smNumUserSessions, httpSrvrNumConn=httpSrvrNumConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheHits=webCacheHits, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyOutBytes=httpProxyOutBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheLongHdrs=webCacheLongHdrs, firmwareStorageHigh=firmwareStorageHigh, systemLoad=systemLoad, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, switchingToBypassMode=switchingToBypassMode, srvcName=srvcName, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrOutBytes=httpSrvrOutBytes, cpuUtilization=cpuUtilization, peerUp=peerUp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyInBytes=sslProxyInBytes, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, highAvailabilityStatus=highAvailabilityStatus, httpProxyPort=httpProxyPort, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyCacheHits=sslProxyCacheHits, totalBandwidth=totalBandwidth, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCmprAddressType=webCmprAddressType, switchingToMaintMode=switchingToMaintMode, sslSrvrSrvcPort=sslSrvrSrvcPort, logStorageHigh=logStorageHigh, httpProxyAddressType=httpProxyAddressType, ipsHdrAclHits=ipsHdrAclHits, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, serviceAddress=serviceAddress, dataPortLinkUp=dataPortLinkUp, sslSrvrInBytes=sslSrvrInBytes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrInBytes=httpSrvrInBytes, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrAddressType=httpSrvrAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, processCountHigh=processCountHigh, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsMIBGroups=bwsMIBGroups, sslSrvrAddressType=sslSrvrAddressType, smAgentName=smAgentName, dataPathStatus=dataPathStatus, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsMIBConformance=bwsMIBConformance, sslProxyAddress=sslProxyAddress, ipsReqLimitPort=ipsReqLimitPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwstraps=bwstraps, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsRCTotServed=ipsRCTotServed, ipsCookieSecAddressType=ipsCookieSecAddressType, webCacheMiss=webCacheMiss, httpSrvrMinResTime=httpSrvrMinResTime, cpuFanSpeed=cpuFanSpeed, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCacheCachedObjects=webCacheCachedObjects, serverUp=serverUp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCacheStale=webCacheStale, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheAddressType=webCacheAddressType, webCmprAddress=webCmprAddress, httpProxyServerErr=httpProxyServerErr, totalMem=totalMem, virusDefUpdates=virusDefUpdates, ipsRCAddressType=ipsRCAddressType, httpSrvrState=httpSrvrState, linkStatus=linkStatus, operationalMode=operationalMode, peerDown=peerDown, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, firmwareStorage=firmwareStorage, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, firmwareUpdateAvailable=firmwareUpdateAvailable, fanDead=fanDead, httpProxyInBytes=httpProxyInBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecTampered=ipsCookieSecTampered, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyTotalReq=httpProxyTotalReq, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, activeServers=activeServers, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, memUtilization=memUtilization, serviceStatus=serviceStatus, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCPort=ipsRCPort, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrAvgResTime=httpSrvrAvgResTime, serverDown=serverDown, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlPolicyAddress=ipsUrlPolicyAddress, totalAttacks=totalAttacks, webCacheProtocol=webCacheProtocol, PYSNMP_MODULE_ID=bws, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, servicePort=servicePort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsRCTotDropped=ipsRCTotDropped, sslProxyErrPms=sslProxyErrPms, sslProxyActiveConn=sslProxyActiveConn, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrMaxResTime=httpSrvrMaxResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCmprPort=webCmprPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCacheBytesOut=webCacheBytesOut, sslProxyOutBytes=sslProxyOutBytes, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, totalApplications=totalApplications, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrTotResponse=sslSrvrTotResponse, securityDefUpdates=securityDefUpdates, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsTrapGroup=bwsTrapGroup, systemFailOver=systemFailOver, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsRCAddress=ipsRCAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsMessage=bwsMessage, httpProxyParseErr=httpProxyParseErr, activeApplications=activeApplications)
