...
Counter32, NotificationType, IpAddress, ModuleIdentity, Unsigned32, iso, TimeTicks, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "IpAddress", "ModuleIdentity", "Unsigned32", "iso", "TimeTicks", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsRCAddress=ipsRCAddress, sslSrvrState=sslSrvrState, httpSrvrState=httpSrvrState, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, cpuFanSpeed=cpuFanSpeed, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrAddress=sslSrvrAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyCacheMiss=sslProxyCacheMiss, webCmprProtocol=webCmprProtocol, switchingToMaintMode=switchingToMaintMode, sslProxyErrPms=sslProxyErrPms, sslProxyCurrentConn=sslProxyCurrentConn, webCacheStale=webCacheStale, webCacheReq=webCacheReq, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrTotTimedout=httpSrvrTotTimedout, webCacheCachedObjects=webCacheCachedObjects, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, serviceStatus=serviceStatus, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, smRealmName=smRealmName, activeServers=activeServers, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, serviceAddress=serviceAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrAvgResTime=httpSrvrAvgResTime, serverUp=serverUp, systemSerialNumber=systemSerialNumber, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, systemFanSpeed=systemFanSpeed, uptime=uptime, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrPort=sslSrvrPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotRefused=sslSrvrTotRefused, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecTampered=ipsCookieSecTampered, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCmprPort=webCmprPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, firmwareStorageHigh=firmwareStorageHigh, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsHdrAclAddress=ipsHdrAclAddress, srvcName=srvcName, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsMIBConformance=bwsMIBConformance, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemLoad=systemLoad, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCacheAddress=webCacheAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, memUtilization=memUtilization, serverDown=serverDown, httpProxyPort=httpProxyPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, cpuUtilization=cpuUtilization, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, logStorageHigh=logStorageHigh, bwsStatsGroup=bwsStatsGroup, firmwareStorage=firmwareStorage, httpProxyServerReq=httpProxyServerReq, webCachePort=webCachePort, sslProxyOutBytes=sslProxyOutBytes, httpProxyServerAbrt=httpProxyServerAbrt, systemFailOver=systemFailOver, energizeUpdateExpire=energizeUpdateExpire, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, peerDown=peerDown, httpProxyInBytes=httpProxyInBytes, dataPathStatus=dataPathStatus, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyServerErr=httpProxyServerErr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, smAgentName=smAgentName, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyInBytes=sslProxyInBytes, ipsUrlNormPort=ipsUrlNormPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, serviceName=serviceName, bwsCompressionStatsTable=bwsCompressionStatsTable, bwstraps=bwstraps, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, virusDefUpdates=virusDefUpdates, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, peerUp=peerUp, linkStatus=linkStatus, smNumUserSessions=smNumUserSessions, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrAddressType=sslSrvrAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, logStorage=logStorage, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, cpuTemperature=cpuTemperature, httpSrvrTotRefused=httpSrvrTotRefused, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, freeMem=freeMem, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bws=bws, webCmprAddressType=webCmprAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCmprAddress=webCmprAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrAddressType=httpSrvrAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrPort=httpSrvrPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, servicePort=servicePort, ipsReqLimitPort=ipsReqLimitPort, switchingToInlineMode=switchingToInlineMode, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheAddressType=webCacheAddressType, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsRCPort=ipsRCPort, webCacheCacheableRes=webCacheCacheableRes, sslProxyTotalConn=sslProxyTotalConn, webCacheHits=webCacheHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlAclAddressType=ipsUrlAclAddressType, totalMem=totalMem, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyTotalReq=httpProxyTotalReq, httpProxyAddressType=httpProxyAddressType, bwsTrapGroup=bwsTrapGroup, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrMinResTime=httpSrvrMinResTime, webCacheMiss=webCacheMiss, webCacheBytesOut=webCacheBytesOut, sslProxyAddress=sslProxyAddress, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrSrvcAddress=httpSrvrSrvcAddress, totalApplications=totalApplications, sslSrvrInBytes=sslSrvrInBytes, httpProxyActiveConn=httpProxyActiveConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyCacheHits=sslProxyCacheHits, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsMessage=bwsMessage, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsMIBCompliance=bwsMIBCompliance, tempHigh=tempHigh, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsHdrAclHits=ipsHdrAclHits, raidDegrading=raidDegrading, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyTotalConn=httpProxyTotalConn, ipsCookieSecAddress=ipsCookieSecAddress, operationalMode=operationalMode, totalServers=totalServers, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsRCTotServed=ipsRCTotServed, totalBandwidth=totalBandwidth, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, PYSNMP_MODULE_ID=bws, ipsReqLimitAddress=ipsReqLimitAddress, webCacheLongHdrs=webCacheLongHdrs, sslProxyPort=sslProxyPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, dataPortLinkUp=dataPortLinkUp, httpProxyAddress=httpProxyAddress, fanDead=fanDead, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits)
mibBuilder.exportSymbols("BWS-MIB", ipsRCTimeStamp=ipsRCTimeStamp, dataPortLinkDown=dataPortLinkDown, activeApplications=activeApplications, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrNumConn=httpSrvrNumConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, totalAttacks=totalAttacks, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsMIBCompliances=bwsMIBCompliances, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitAddressType=ipsReqLimitAddressType, processCountHigh=processCountHigh, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, tempCritical=tempCritical, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, vipStatus=vipStatus, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCacheProtocol=webCacheProtocol, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMIBGroups=bwsMIBGroups, securityDefUpdates=securityDefUpdates, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsRCAddressType=ipsRCAddressType, currentFirmwareVersion=currentFirmwareVersion, sslSrvrMaxResTime=sslSrvrMaxResTime, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclReserved=ipsUrlAclReserved, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumConn=sslSrvrNumConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrAddress=httpSrvrAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyAddressType=sslProxyAddressType, bwsStats=bwsStats, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, systemFailure=systemFailure, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie)
