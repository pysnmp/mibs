...
TimeTicks, Counter64, IpAddress, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, iso, Integer32, Counter32, ModuleIdentity, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "IpAddress", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "iso", "Integer32", "Counter32", "ModuleIdentity", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", webCacheLongHdrs=webCacheLongHdrs, totalServers=totalServers, bwsServiceStatusEntry=bwsServiceStatusEntry, uptime=uptime, webCacheAddressType=webCacheAddressType, httpProxyParseErr=httpProxyParseErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlNormAddressType=ipsUrlNormAddressType, cpuUtilization=cpuUtilization, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, serviceAddress=serviceAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCmprAddressType=webCmprAddressType, peerDown=peerDown, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyCacheHits=sslProxyCacheHits, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, dataPortLinkDown=dataPortLinkDown, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrAddress=httpSrvrAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsMIBGroups=bwsMIBGroups, ipsRCTotDropped=ipsRCTotDropped, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsRCPort=ipsRCPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, httpProxyServerReq=httpProxyServerReq, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsRCTotServed=ipsRCTotServed, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyServerErr=httpProxyServerErr, httpSrvrPort=httpSrvrPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, highAvailabilityStatus=highAvailabilityStatus, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrMaxResTime=httpSrvrMaxResTime, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrAddressType=sslSrvrAddressType, ipsHdrAclPort=ipsHdrAclPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCacheHits=webCacheHits, memUtilization=memUtilization, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, cpuTemperature=cpuTemperature, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, processCountHigh=processCountHigh, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCacheProtocol=webCacheProtocol, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecPort=ipsCookieSecPort, bwsServiceStatusTable=bwsServiceStatusTable, bws=bws, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrInBytes=httpSrvrInBytes, ipsUrlNormPort=ipsUrlNormPort, servicePort=servicePort, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlAclPort=ipsUrlAclPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwstraps=bwstraps, securityDefUpdates=securityDefUpdates, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyActiveConn=httpProxyActiveConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, energizeUpdateExpire=energizeUpdateExpire, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, activeApplications=activeApplications, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, systemFanSpeed=systemFanSpeed, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyPort=ipsUrlPolicyPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyTotalConn=httpProxyTotalConn, tempHigh=tempHigh, httpSrvrNumConn=httpSrvrNumConn, sslProxyPort=sslProxyPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheStale=webCacheStale, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsStatsGroup=bwsStatsGroup, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, systemLoad=systemLoad, serverUp=serverUp, sslSrvrTotRefused=sslSrvrTotRefused, raidDegrading=raidDegrading, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqSrvcPort=ipsReqSrvcPort, smRealmName=smRealmName, sslSrvrNumConn=sslSrvrNumConn, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyAddressType=httpProxyAddressType, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrTotTimedout=sslSrvrTotTimedout, dataPortLinkUp=dataPortLinkUp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsMessage=bwsMessage, webCacheReq=webCacheReq, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCacheAddress=webCacheAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyInBytes=httpProxyInBytes, activeServers=activeServers, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheMiss=webCacheMiss, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, fanDead=fanDead, totalAttacks=totalAttacks, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsCacheStatsTable=bwsCacheStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCacheCacheableRes=webCacheCacheableRes, freeMem=freeMem, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyAddressType=sslProxyAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyTotalReq=sslProxyTotalReq, httpSrvrState=httpSrvrState, serverDown=serverDown, webCacheBytesOut=webCacheBytesOut, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, linkStatus=linkStatus, peerUp=peerUp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemFailOver=systemFailOver, ipsRCAddress=ipsRCAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyAddress=sslProxyAddress, vipStatus=vipStatus, sslProxyBadCRLErr=sslProxyBadCRLErr, firmwareStorageHigh=firmwareStorageHigh, systemSerialNumber=systemSerialNumber, ipsCookieSecTampered=ipsCookieSecTampered, memoryUsageHigh=memoryUsageHigh, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, webCmprAddress=webCmprAddress, bwsStats=bwsStats, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCmprPort=webCmprPort, sslProxyOutBytes=sslProxyOutBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, srvcName=srvcName, smAgentName=smAgentName, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyCurrentConn=sslProxyCurrentConn, httpProxyPort=httpProxyPort, sslSrvrPort=sslSrvrPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, currentFirmwareVersion=currentFirmwareVersion, webCmprProtocol=webCmprProtocol, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCTotQueued=ipsRCTotQueued, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, smNumUserSessions=smNumUserSessions, bwsMIBCompliances=bwsMIBCompliances, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyAddress=httpProxyAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, serviceName=serviceName, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsTrapGroup=bwsTrapGroup, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCachePort=webCachePort, httpSrvrTotReqActive=httpSrvrTotReqActive)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrOutBytes=httpSrvrOutBytes, switchingToMaintMode=switchingToMaintMode, httpSrvrAddressType=httpSrvrAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslProxyInBytes=sslProxyInBytes, sslSrvrState=sslSrvrState, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, PYSNMP_MODULE_ID=bws, firmwareStorage=firmwareStorage, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyTotalConn=sslProxyTotalConn, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMIBCompliance=bwsMIBCompliance, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, logStorage=logStorage, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyOutBytes=httpProxyOutBytes, httpProxyClientAbrt=httpProxyClientAbrt, totalMem=totalMem, tempCritical=tempCritical, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, logStorageHigh=logStorageHigh, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsMIBConformance=bwsMIBConformance, operationalMode=operationalMode, totalBandwidth=totalBandwidth, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlNormAddress=ipsUrlNormAddress, serviceStatus=serviceStatus, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, virusDefUpdates=virusDefUpdates, systemFailure=systemFailure, httpSrvrTotSuccess=httpSrvrTotSuccess, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyErrPms=sslProxyErrPms, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitAddress=ipsReqLimitAddress, totalApplications=totalApplications, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, dataPathStatus=dataPathStatus, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsHdrAclHits=ipsHdrAclHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType)
