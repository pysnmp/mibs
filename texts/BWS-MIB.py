...
Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ObjectIdentity, NotificationType, TimeTicks, Unsigned32, ModuleIdentity, Counter64, Integer32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ObjectIdentity", "NotificationType", "TimeTicks", "Unsigned32", "ModuleIdentity", "Counter64", "Integer32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsMessage=bwsMessage, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, dataPortLinkDown=dataPortLinkDown, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsRCTotQueued=ipsRCTotQueued, ipsReqSrvcPort=ipsReqSrvcPort, webCacheReq=webCacheReq, smNumUserSessions=smNumUserSessions, vipStatus=vipStatus, ipsRCPort=ipsRCPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsTrapGroup=bwsTrapGroup, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlNormPort=ipsUrlNormPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqSrvcAddress=ipsReqSrvcAddress, sslProxyErrPms=sslProxyErrPms, sslSrvrTotReqRejected=sslSrvrTotReqRejected, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, firmwareStorage=firmwareStorage, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrAddressType=sslSrvrAddressType, httpSrvrNumConn=httpSrvrNumConn, systemFanSpeed=systemFanSpeed, ipsCookieSecAddress=ipsCookieSecAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, raidDegrading=raidDegrading, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrInBytes=httpSrvrInBytes, logStorageHigh=logStorageHigh, httpSrvrAvgResTime=httpSrvrAvgResTime, webCmprProtocol=webCmprProtocol, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serviceAddress=serviceAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, serviceStatus=serviceStatus, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrAddress=httpSrvrAddress, totalApplications=totalApplications, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsRCAddress=ipsRCAddress, systemLoad=systemLoad, ipsRCTotDropped=ipsRCTotDropped, sslProxyAddressType=sslProxyAddressType, PYSNMP_MODULE_ID=bws, sslProxyInBytes=sslProxyInBytes, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCmprPort=webCmprPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sharedSecretKeyExpired=sharedSecretKeyExpired, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheLongHdrs=webCacheLongHdrs, sslProxyCacheHits=sslProxyCacheHits, uptime=uptime, activeServers=activeServers, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsMIBGroups=bwsMIBGroups, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitPort=ipsReqLimitPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, totalServers=totalServers, bwsCacheStatsEntry=bwsCacheStatsEntry, serverDown=serverDown, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlAclPort=ipsUrlAclPort, ipsHdrAclPort=ipsHdrAclPort, energizeUpdateExpire=energizeUpdateExpire, webCacheAddress=webCacheAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, processCountHigh=processCountHigh, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsMIBCompliance=bwsMIBCompliance, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyActiveConn=httpProxyActiveConn, sslProxyPort=sslProxyPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlPort=ipsAccessCtrlPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, memUtilization=memUtilization, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyServerErr=httpProxyServerErr, webCachePort=webCachePort, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrAddressType=httpSrvrAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, serverUp=serverUp, webCacheHits=webCacheHits, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, tempCritical=tempCritical, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCacheAddressType=webCacheAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheBytesOut=webCacheBytesOut, servicePort=servicePort, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyAddress=httpProxyAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrPort=sslSrvrPort, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCmprAddress=webCmprAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, cpuTemperature=cpuTemperature, fanDead=fanDead, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsCookieSecTampered=ipsCookieSecTampered, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrNumConn=sslSrvrNumConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, switchingToMaintMode=switchingToMaintMode, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, peerDown=peerDown, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, dataPathStatus=dataPathStatus, totalMem=totalMem, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, firmwareStorageHigh=firmwareStorageHigh, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwstraps=bwstraps, httpSrvrTotTimedout=httpSrvrTotTimedout, systemSerialNumber=systemSerialNumber, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyPort=httpProxyPort, systemFailure=systemFailure, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsHdrAclHits=ipsHdrAclHits, httpProxyOutBytes=httpProxyOutBytes, linkStatus=linkStatus, ipsUrlNormAddressType=ipsUrlNormAddressType, highAvailabilityStatus=highAvailabilityStatus, smAgentName=smAgentName, switchingToBypassMode=switchingToBypassMode, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsStatsGroup=bwsStatsGroup, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyInBytes=httpProxyInBytes, webCacheCachedObjects=webCacheCachedObjects, tempHigh=tempHigh, httpProxyServerReq=httpProxyServerReq, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheProtocol=webCacheProtocol, ipsCookieSecPort=ipsCookieSecPort, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrPort=httpSrvrPort, smRealmName=smRealmName, serviceName=serviceName, sslSrvrInBytes=sslSrvrInBytes, totalAttacks=totalAttacks, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, logStorage=logStorage, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyTotalReq=httpProxyTotalReq, ipsRCTimeStamp=ipsRCTimeStamp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, cpuUtilization=cpuUtilization, virusDefUpdates=virusDefUpdates, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime)
mibBuilder.exportSymbols("BWS-MIB", dataPortLinkUp=dataPortLinkUp, ipsRCAddressType=ipsRCAddressType, bwsStats=bwsStats, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, srvcName=srvcName, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCTotServed=ipsRCTotServed, webCacheMiss=webCacheMiss, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrTotResponse=sslSrvrTotResponse, ipsRCTotOutOfResource=ipsRCTotOutOfResource, securityDefUpdates=securityDefUpdates, bws=bws, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyTotalConn=sslProxyTotalConn, systemFailOver=systemFailOver, webCacheCacheableRes=webCacheCacheableRes, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyParseErr=httpProxyParseErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsCompressionStatsEntry=bwsCompressionStatsEntry, totalBandwidth=totalBandwidth, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyTotalReq=sslProxyTotalReq, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyAddressType=httpProxyAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyOutBytes=sslProxyOutBytes, webCmprAddressType=webCmprAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, switchingToInlineMode=switchingToInlineMode, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyActiveConn=sslProxyActiveConn, sslSrvrState=sslSrvrState, sslSrvrAddress=sslSrvrAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, operationalMode=operationalMode, webCacheStale=webCacheStale, sslProxyAddress=sslProxyAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsMIBCompliances=bwsMIBCompliances, freeMem=freeMem, httpSrvrState=httpSrvrState, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyTotalConn=httpProxyTotalConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, activeApplications=activeApplications, peerUp=peerUp, cpuFanSpeed=cpuFanSpeed, bwsCacheStatsTable=bwsCacheStatsTable)
