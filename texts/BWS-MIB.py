...
mibBuilder.exportSymbols("BWS-MIB", sslProxyPort=sslProxyPort, httpProxyAddress=httpProxyAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, httpProxyAddressType=httpProxyAddressType, dataPortLinkDown=dataPortLinkDown, energizeUpdateExpire=energizeUpdateExpire, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCacheMiss=webCacheMiss, sslSrvrMinResTime=sslSrvrMinResTime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsRCAddress=ipsRCAddress, systemLoad=systemLoad, bwsTrapGroup=bwsTrapGroup, httpSrvrPort=httpSrvrPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyServerErr=httpProxyServerErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrAddress=sslSrvrAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCachePort=webCachePort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrNumConn=httpSrvrNumConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMIBConformance=bwsMIBConformance, smAgentName=smAgentName, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, cpuFanSpeed=cpuFanSpeed, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyTotalConn=sslProxyTotalConn, systemFanSpeed=systemFanSpeed, httpSrvrState=httpSrvrState, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheReq=webCacheReq, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsRCPort=ipsRCPort, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCacheProtocol=webCacheProtocol, sslSrvrAddressType=sslSrvrAddressType, totalMem=totalMem, raidDegrading=raidDegrading, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyServerAbrt=httpProxyServerAbrt, linkStatus=linkStatus, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCacheCachedObjects=webCacheCachedObjects, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsMIBCompliance=bwsMIBCompliance, httpSrvrAddress=httpSrvrAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheAddressType=webCacheAddressType, sslProxyInBytes=sslProxyInBytes, systemFailOver=systemFailOver, sslProxyActiveConn=sslProxyActiveConn, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, fanDead=fanDead, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyAddress=sslProxyAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrTotResponse=httpSrvrTotResponse, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, cpuUtilization=cpuUtilization, systemSerialNumber=systemSerialNumber, peerUp=peerUp, bwsStatsGroup=bwsStatsGroup, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, freeMem=freeMem, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sharedSecretKeyExpired=sharedSecretKeyExpired, vipStatus=vipStatus, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, serviceName=serviceName, switchingToInlineMode=switchingToInlineMode, sslProxyOutBytes=sslProxyOutBytes, sslSrvrState=sslSrvrState, httpProxyActiveConn=httpProxyActiveConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrInBytes=httpSrvrInBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, smNumUserSessions=smNumUserSessions, sslSrvrInBytes=sslSrvrInBytes, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyTotalConn=httpProxyTotalConn, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyOutBytes=httpProxyOutBytes, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyServerReq=httpProxyServerReq, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, totalServers=totalServers, PYSNMP_MODULE_ID=bws, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrPort=sslSrvrPort, bwsMIBGroups=bwsMIBGroups, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrSrvcPort=sslSrvrSrvcPort, virusDefUpdates=virusDefUpdates, bwsMIBCompliances=bwsMIBCompliances, dataPathStatus=dataPathStatus, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwstraps=bwstraps, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormPort=ipsUrlNormPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, switchingToMaintMode=switchingToMaintMode, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, uptime=uptime, sslProxyBadCRLErr=sslProxyBadCRLErr, serviceAddress=serviceAddress, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCmprProtocol=webCmprProtocol, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, serverDown=serverDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheStale=webCacheStale, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, tempCritical=tempCritical, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, activeServers=activeServers, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, firmwareStorage=firmwareStorage, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrTotRefused=httpSrvrTotRefused, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTotDropped=ipsRCTotDropped, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyCacheHits=sslProxyCacheHits, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecPort=ipsCookieSecPort, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyTotalReq=httpProxyTotalReq, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCmprAddressType=webCmprAddressType, httpSrvrAddressType=httpSrvrAddressType, logStorage=logStorage, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlAclPort=ipsUrlAclPort, dataPortLinkUp=dataPortLinkUp, bwsMessage=bwsMessage, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrMaxResTime=sslSrvrMaxResTime, memoryUsageHigh=memoryUsageHigh, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyParseErr=httpProxyParseErr, webCacheCacheableRes=webCacheCacheableRes, ipsReqSrvcPort=ipsReqSrvcPort, webCmprPort=webCmprPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyTotalReq=sslProxyTotalReq, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCmprAddress=webCmprAddress, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsHdrAclAddressType=ipsHdrAclAddressType, processCountHigh=processCountHigh, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyInBytes=httpProxyInBytes, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsCookieSecTampered=ipsCookieSecTampered, webCacheHits=webCacheHits, webCacheBytesOut=webCacheBytesOut, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumConn=sslSrvrNumConn, totalApplications=totalApplications, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, currentFirmwareVersion=currentFirmwareVersion, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrTotResponse=sslSrvrTotResponse, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyPort=ipsUrlPolicyPort, memUtilization=memUtilization, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, tempHigh=tempHigh, peerDown=peerDown, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransPort=ipsWebAddrTransPort, bws=bws, ipsHdrAclAddress=ipsHdrAclAddress, ipsHdrAclPort=ipsHdrAclPort, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, operationalMode=operationalMode, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsCompressionStatsTable=bwsCompressionStatsTable, serverUp=serverUp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, serviceStatus=serviceStatus, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrTotReqActive=httpSrvrTotReqActive, sslProxyAddressType=sslProxyAddressType, smRealmName=smRealmName, srvcName=srvcName, totalAttacks=totalAttacks, ipsRCTotOutOfResource=ipsRCTotOutOfResource, newAttackDefinitionInstalled=newAttackDefinitionInstalled, totalBandwidth=totalBandwidth, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheLongHdrs=webCacheLongHdrs, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrSrvcPort=httpSrvrSrvcPort, webCacheAddress=webCacheAddress, cpuTemperature=cpuTemperature, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyPort=httpProxyPort, bwsServiceStatusTable=bwsServiceStatusTable, systemFailure=systemFailure, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsRCTotQueued=ipsRCTotQueued, activeApplications=activeApplications, bwsStats=bwsStats, servicePort=servicePort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, logStorageHigh=logStorageHigh, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrOutBytes=sslSrvrOutBytes, firmwareStorageHigh=firmwareStorageHigh, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr)
