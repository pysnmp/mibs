...
TimeTicks, MibIdentifier, Integer32, Unsigned32, Counter64, Bits, ObjectIdentity, Counter32, ModuleIdentity, NotificationType, IpAddress, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Integer32", "Unsigned32", "Counter64", "Bits", "ObjectIdentity", "Counter32", "ModuleIdentity", "NotificationType", "IpAddress", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, srvcName=srvcName, virusDefUpdates=virusDefUpdates, sslProxyAddress=sslProxyAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheReq=webCacheReq, ipsHdrAclPort=ipsHdrAclPort, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCmprCompressedDataSize=webCmprCompressedDataSize, webCmprProtocol=webCmprProtocol, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, dataPortLinkDown=dataPortLinkDown, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrInBytes=httpSrvrInBytes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlPolicyPort=ipsUrlPolicyPort, activeApplications=activeApplications, ipsRCTotServed=ipsRCTotServed, sslSrvrAddress=sslSrvrAddress, vipStatus=vipStatus, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsHdrAclHits=ipsHdrAclHits, sslSrvrTotRefused=sslSrvrTotRefused, webCacheStale=webCacheStale, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrInBytes=sslSrvrInBytes, linkStatus=linkStatus, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrPort=sslSrvrPort, httpSrvrState=httpSrvrState, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyTotalConn=sslProxyTotalConn, dataPortLinkUp=dataPortLinkUp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCAddressType=ipsRCAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsServiceStatusTable=bwsServiceStatusTable, highAvailabilityStatus=highAvailabilityStatus, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyAddressType=httpProxyAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, activeServers=activeServers, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyInBytes=httpProxyInBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, PYSNMP_MODULE_ID=bws, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheAddress=webCacheAddress, ipsRCAddress=ipsRCAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCTotDropped=ipsRCTotDropped, webCacheLongHdrs=webCacheLongHdrs, webCacheCacheableRes=webCacheCacheableRes, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyServerErr=httpProxyServerErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, switchingToBypassMode=switchingToBypassMode, sslProxyCacheMiss=sslProxyCacheMiss, peerUp=peerUp, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsMessage=bwsMessage, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCacheMiss=webCacheMiss, bwsTrapGroup=bwsTrapGroup, sslProxyActiveConn=sslProxyActiveConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, cpuUtilization=cpuUtilization, ipsWebAddrTransPort=ipsWebAddrTransPort, logStorage=logStorage, httpSrvrTotResponse=httpSrvrTotResponse, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, tempCritical=tempCritical, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsStats=bwsStats, httpSrvrNumConn=httpSrvrNumConn, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyServerReq=httpProxyServerReq, energizeUpdateExpire=energizeUpdateExpire, httpSrvrNumFreeConn=httpSrvrNumFreeConn, dataPathStatus=dataPathStatus, operationalMode=operationalMode, systemSerialNumber=systemSerialNumber, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, totalApplications=totalApplications, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, totalServers=totalServers, httpProxyAddress=httpProxyAddress, logStorageHigh=logStorageHigh, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, uptime=uptime, systemLoad=systemLoad, ipsReqLimitPort=ipsReqLimitPort, ipsUrlAclPort=ipsUrlAclPort, totalAttacks=totalAttacks, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotResponse=sslSrvrTotResponse, webCacheProtocol=webCacheProtocol, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrMinResTime=httpSrvrMinResTime, servicePort=servicePort, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, serverUp=serverUp, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyActiveConn=httpProxyActiveConn, fanDead=fanDead, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqLimitAddress=ipsReqLimitAddress, switchingToInlineMode=switchingToInlineMode, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, webCacheHits=webCacheHits, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyTotalReq=httpProxyTotalReq, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, systemFailOver=systemFailOver, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, freeMem=freeMem, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyErrPms=sslProxyErrPms, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsCookieSecPort=ipsCookieSecPort, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, switchingToMaintMode=switchingToMaintMode, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCmprAddress=webCmprAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlNormPort=ipsUrlNormPort, sslProxyInBytes=sslProxyInBytes, smRealmName=smRealmName, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrAddressType=sslSrvrAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, firmwareStorageHigh=firmwareStorageHigh, webCacheCachedObjects=webCacheCachedObjects, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, systemFanSpeed=systemFanSpeed, bws=bws, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCacheAddressType=webCacheAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, serverDown=serverDown, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrPort=httpSrvrPort, serviceStatus=serviceStatus, httpProxyPort=httpProxyPort, memUtilization=memUtilization, cpuFanSpeed=cpuFanSpeed, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, smAgentName=smAgentName, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyOutBytes=httpProxyOutBytes, systemFailure=systemFailure, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, currentFirmwareVersion=currentFirmwareVersion, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsMIBConformance=bwsMIBConformance, totalMem=totalMem, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCmprPort=webCmprPort, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyServerAbrt=httpProxyServerAbrt, processCountHigh=processCountHigh, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, securityDefUpdates=securityDefUpdates, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten)
mibBuilder.exportSymbols("BWS-MIB", bwsMIBCompliances=bwsMIBCompliances, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrState=sslSrvrState, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyPort=sslProxyPort, webCacheBytesOut=webCacheBytesOut, sslSrvrNumConn=sslSrvrNumConn, firmwareStorage=firmwareStorage, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, peerDown=peerDown, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, tempHigh=tempHigh, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, smNumUserSessions=smNumUserSessions, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, serviceAddress=serviceAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwstraps=bwstraps, memoryUsageHigh=memoryUsageHigh, ipsRCTotQueued=ipsRCTotQueued, serviceName=serviceName, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, bwsMIBCompliance=bwsMIBCompliance, cpuTemperature=cpuTemperature, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrOutBytes=httpSrvrOutBytes, ipsRCPort=ipsRCPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrAddress=httpSrvrAddress, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCachePort=webCachePort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyTotalConn=httpProxyTotalConn, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyParseErr=httpProxyParseErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, totalBandwidth=totalBandwidth, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, raidDegrading=raidDegrading, ipsReqLimitAddressType=ipsReqLimitAddressType, webCmprAddressType=webCmprAddressType)
