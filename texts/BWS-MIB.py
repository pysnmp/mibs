...
TimeTicks, ObjectIdentity, MibIdentifier, Integer32, ModuleIdentity, Unsigned32, IpAddress, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Integer32", "ModuleIdentity", "Unsigned32", "IpAddress", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrPort=sslSrvrPort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, firmwareStorage=firmwareStorage, energizeUpdateExpire=energizeUpdateExpire, smRealmName=smRealmName, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrNumConn=sslSrvrNumConn, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyInBytes=httpProxyInBytes, dataPathStatus=dataPathStatus, httpSrvrInBytes=httpSrvrInBytes, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrMinResTime=sslSrvrMinResTime, bwsMessage=bwsMessage, sslProxyTotalReq=sslProxyTotalReq, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, uptime=uptime, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsMIBCompliance=bwsMIBCompliance, logStorage=logStorage, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, tempCritical=tempCritical, bwsMIBCompliances=bwsMIBCompliances, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, cpuFanSpeed=cpuFanSpeed, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyPort=httpProxyPort, activeServers=activeServers, sslSrvrTotTimedout=sslSrvrTotTimedout, raidDegrading=raidDegrading, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrAddressType=sslSrvrAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, highAvailabilityStatus=highAvailabilityStatus, sslProxyOutBytes=sslProxyOutBytes, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsHdrAclHits=ipsHdrAclHits, processCountHigh=processCountHigh, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyOutBytes=httpProxyOutBytes, sslSrvrInBytes=sslSrvrInBytes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheReq=webCacheReq, sslProxyPort=sslProxyPort, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bws=bws, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsServiceStatusEntry=bwsServiceStatusEntry, serviceAddress=serviceAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyTotalConn=sslProxyTotalConn, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, bwsTrapGroup=bwsTrapGroup, httpSrvrState=httpSrvrState, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, totalServers=totalServers, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, PYSNMP_MODULE_ID=bws, webCacheCachedObjects=webCacheCachedObjects, sslProxyInBytes=sslProxyInBytes, cpuUtilization=cpuUtilization, securityDefUpdates=securityDefUpdates, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsCookieSecPort=ipsCookieSecPort, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemFanSpeed=systemFanSpeed, webCacheLongHdrs=webCacheLongHdrs, ipsRCTotQueued=ipsRCTotQueued, httpProxyServerReq=httpProxyServerReq, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyAddressType=sslProxyAddressType, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, currentFirmwareVersion=currentFirmwareVersion, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrOutBytes=sslSrvrOutBytes, serverUp=serverUp, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, cpuTemperature=cpuTemperature, webCacheAddress=webCacheAddress, freeMem=freeMem, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrNumConn=httpSrvrNumConn, operationalMode=operationalMode, webCmprPort=webCmprPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, systemSerialNumber=systemSerialNumber, sslProxyCacheHits=sslProxyCacheHits, bwsCacheStatsTable=bwsCacheStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, ipsRCAddress=ipsRCAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlAclPort=ipsUrlAclPort, httpSrvrAddressType=httpSrvrAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, firmwareStorageHigh=firmwareStorageHigh, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyAddress=sslProxyAddress, activeApplications=activeApplications, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyActiveConn=httpProxyActiveConn, bwstraps=bwstraps, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, dataPortLinkDown=dataPortLinkDown, switchingToBypassMode=switchingToBypassMode, httpSrvrMinResTime=httpSrvrMinResTime, bwsMIBGroups=bwsMIBGroups, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, tempHigh=tempHigh, ipsUrlPolicyAddress=ipsUrlPolicyAddress, switchingToMaintMode=switchingToMaintMode, webCacheCacheableRes=webCacheCacheableRes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyParseErr=httpProxyParseErr, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, systemFailOver=systemFailOver, bwsIpsRCStatsTable=bwsIpsRCStatsTable, totalApplications=totalApplications, totalMem=totalMem, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, memUtilization=memUtilization, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, vipStatus=vipStatus, httpProxyAddress=httpProxyAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, dataPortLinkUp=dataPortLinkUp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, serverDown=serverDown, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, logStorageHigh=logStorageHigh, sslSrvrState=sslSrvrState, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCTotServed=ipsRCTotServed, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsMIBConformance=bwsMIBConformance, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCmprProtocol=webCmprProtocol, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, serviceStatus=serviceStatus, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, totalAttacks=totalAttacks, webCacheMiss=webCacheMiss, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlNormAddress=ipsUrlNormAddress, systemLoad=systemLoad, systemFailure=systemFailure, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsSMUserSessionTable=bwsSMUserSessionTable, linkStatus=linkStatus, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrAddress=sslSrvrAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsCompressionStatsEntry=bwsCompressionStatsEntry, peerUp=peerUp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheStale=webCacheStale, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, serviceName=serviceName, sslProxyErrPms=sslProxyErrPms, webCacheProtocol=webCacheProtocol, webCacheHits=webCacheHits, ipsRCPort=ipsRCPort, memoryUsageHigh=memoryUsageHigh, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsHdrAclPort=ipsHdrAclPort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, switchingToInlineMode=switchingToInlineMode, bwsServiceStatusTable=bwsServiceStatusTable, firmwareUpdateAvailable=firmwareUpdateAvailable, fanDead=fanDead, virusDefUpdates=virusDefUpdates, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyAddressType=httpProxyAddressType, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyTotalConn=httpProxyTotalConn, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsRCTotDropped=ipsRCTotDropped, bwsStatsGroup=bwsStatsGroup, sharedSecretKeyExpired=sharedSecretKeyExpired, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, peerDown=peerDown, httpSrvrMaxResTime=httpSrvrMaxResTime, webCachePort=webCachePort, totalBandwidth=totalBandwidth, ipsReqLimitPort=ipsReqLimitPort, servicePort=servicePort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyTotalReq=httpProxyTotalReq, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, smAgentName=smAgentName, ipsUrlNormPort=ipsUrlNormPort, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheAddressType=webCacheAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCmprAddress=webCmprAddress, webCmprAddressType=webCmprAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsCompressionStatsTable=bwsCompressionStatsTable, srvcName=srvcName, bwsStats=bwsStats, httpSrvrPort=httpSrvrPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsRCAddressType=ipsRCAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits)
