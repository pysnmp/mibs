...
MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Counter64, Unsigned32, ObjectIdentity, Counter32, iso, TimeTicks, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Counter64", "Unsigned32", "ObjectIdentity", "Counter32", "iso", "TimeTicks", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, tempCritical=tempCritical, sslSrvrInBytes=sslSrvrInBytes, httpProxyTotalReq=httpProxyTotalReq, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyInBytes=httpProxyInBytes, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, highAvailabilityStatus=highAvailabilityStatus, systemFailOver=systemFailOver, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, peerDown=peerDown, sslProxyAddressType=sslProxyAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotResponse=sslSrvrTotResponse, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsMIBGroups=bwsMIBGroups, PYSNMP_MODULE_ID=bws, ipsUrlNormPort=ipsUrlNormPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrTotRefused=httpSrvrTotRefused, linkStatus=linkStatus, sslSrvrAddressType=sslSrvrAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsMIBConformance=bwsMIBConformance, totalAttacks=totalAttacks, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, webCacheAddressType=webCacheAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheBytesOut=webCacheBytesOut, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyPort=httpProxyPort, sslSrvrTotRefused=sslSrvrTotRefused, switchingToBypassMode=switchingToBypassMode, ipsHdrAclPort=ipsHdrAclPort, webCmprProtocol=webCmprProtocol, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlPolicyPort=ipsUrlPolicyPort, serverDown=serverDown, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, dataPortLinkUp=dataPortLinkUp, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrPort=httpSrvrPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyPort=sslProxyPort, fanDead=fanDead, totalApplications=totalApplications, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsCacheStatsTable=bwsCacheStatsTable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, firmwareUpdateAvailable=firmwareUpdateAvailable, smNumUserSessions=smNumUserSessions, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqSrvcPort=ipsReqSrvcPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheCachedObjects=webCacheCachedObjects, operationalMode=operationalMode, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsRCAddressType=ipsRCAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyAddressType=httpProxyAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyServerReq=httpProxyServerReq, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCmprPort=webCmprPort, systemLoad=systemLoad, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsCookieSecPort=ipsCookieSecPort, logStorageHigh=logStorageHigh, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitPort=ipsReqLimitPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, processCountHigh=processCountHigh, vipStatus=vipStatus, totalBandwidth=totalBandwidth, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrPort=sslSrvrPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyOutBytes=httpProxyOutBytes, systemFailure=systemFailure, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsStatsGroup=bwsStatsGroup, bwsTrapGroup=bwsTrapGroup, sslProxyInBytes=sslProxyInBytes, httpSrvrState=httpSrvrState, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyTotalConn=httpProxyTotalConn, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, totalServers=totalServers, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, memUtilization=memUtilization, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, virusDefUpdates=virusDefUpdates, webCmprAddressType=webCmprAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, serviceAddress=serviceAddress, securityDefUpdates=securityDefUpdates, smRealmName=smRealmName, ipsRCTotQueued=ipsRCTotQueued, webCmprAddress=webCmprAddress, tempHigh=tempHigh, webCacheMiss=webCacheMiss, systemFanSpeed=systemFanSpeed, bws=bws, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, switchingToInlineMode=switchingToInlineMode, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyParseErr=httpProxyParseErr, dataPortLinkDown=dataPortLinkDown, httpProxyUnknownRsp=httpProxyUnknownRsp, webCachePort=webCachePort, ipsHdrAclHits=ipsHdrAclHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTotServed=ipsRCTotServed, ipsRCPort=ipsRCPort, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlNormAddress=ipsUrlNormAddress, firmwareStorage=firmwareStorage, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serviceStatus=serviceStatus, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, firmwareStorageHigh=firmwareStorageHigh, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, srvcName=srvcName, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyTotalReq=sslProxyTotalReq, ipsUrlAclPort=ipsUrlAclPort, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, cpuUtilization=cpuUtilization, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, logStorage=logStorage, webCacheLongHdrs=webCacheLongHdrs, webCacheHits=webCacheHits, systemSerialNumber=systemSerialNumber, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheProtocol=webCacheProtocol, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheAddress=webCacheAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsMIBCompliance=bwsMIBCompliance, sslSrvrState=sslSrvrState, sslProxyCacheHits=sslProxyCacheHits, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsStats=bwsStats, webCacheReq=webCacheReq, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCAddress=ipsRCAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, freeMem=freeMem, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, currentFirmwareVersion=currentFirmwareVersion, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsMessage=bwsMessage, httpSrvrNumFreeConn=httpSrvrNumFreeConn, activeServers=activeServers, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, raidDegrading=raidDegrading, cpuTemperature=cpuTemperature, webCacheCacheableRes=webCacheCacheableRes, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheStale=webCacheStale, energizeUpdateExpire=energizeUpdateExpire, switchingToMaintMode=switchingToMaintMode, ipsAccessCtrlAddress=ipsAccessCtrlAddress, totalMem=totalMem, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable)
mibBuilder.exportSymbols("BWS-MIB", serverUp=serverUp, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, servicePort=servicePort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyAddress=httpProxyAddress, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, bwsMIBCompliances=bwsMIBCompliances, sslProxyActiveConn=sslProxyActiveConn, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyTotalConn=sslProxyTotalConn, sslSrvrAddress=sslSrvrAddress, bwstraps=bwstraps, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrAddress=httpSrvrAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrNumConn=httpSrvrNumConn, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serviceName=serviceName, httpSrvrMaxResTime=httpSrvrMaxResTime, memoryUsageHigh=memoryUsageHigh, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyErrPms=sslProxyErrPms, peerUp=peerUp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlNormAddressType=ipsUrlNormAddressType, smAgentName=smAgentName, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsRCTotDropped=ipsRCTotDropped, httpProxyActiveConn=httpProxyActiveConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyAddress=sslProxyAddress, dataPathStatus=dataPathStatus, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyCurrentConn=sslProxyCurrentConn, activeApplications=activeApplications, uptime=uptime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits)
