...
ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Bits, TimeTicks, Counter64, iso, MibIdentifier, Gauge32, Integer32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Bits", "TimeTicks", "Counter64", "iso", "MibIdentifier", "Gauge32", "Integer32", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", serviceStatus=serviceStatus, operationalMode=operationalMode, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrState=httpSrvrState, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrAddressType=httpSrvrAddressType, httpProxyPort=httpProxyPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqSrvcAddress=ipsReqSrvcAddress, dataPortLinkUp=dataPortLinkUp, httpSrvrAddress=httpSrvrAddress, ipsRCAddressType=ipsRCAddressType, webCacheHits=webCacheHits, serviceAddress=serviceAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCmprPort=webCmprPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyCacheMiss=sslProxyCacheMiss, linkStatus=linkStatus, smAgentName=smAgentName, httpSrvrMinResTime=httpSrvrMinResTime, smRealmName=smRealmName, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCTotServed=ipsRCTotServed, webCacheAddressType=webCacheAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitPort=ipsReqLimitPort, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransAddress=ipsWebAddrTransAddress, switchingToBypassMode=switchingToBypassMode, totalMem=totalMem, totalBandwidth=totalBandwidth, webCacheReq=webCacheReq, ipsUrlAclPort=ipsUrlAclPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrOutBytes=sslSrvrOutBytes, webCacheCachedObjects=webCacheCachedObjects, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCmprProtocol=webCmprProtocol, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrTotResponse=httpSrvrTotResponse, webCmprAddressType=webCmprAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyOutBytes=sslProxyOutBytes, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrNumConn=httpSrvrNumConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, systemLoad=systemLoad, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecTampered=ipsCookieSecTampered, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyTotalConn=httpProxyTotalConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsHdrAclHits=ipsHdrAclHits, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCacheCacheableRes=webCacheCacheableRes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, totalAttacks=totalAttacks, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrAvgResTime=sslSrvrAvgResTime, cpuTemperature=cpuTemperature, vipStatus=vipStatus, cpuFanSpeed=cpuFanSpeed, systemFailOver=systemFailOver, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyClientAbrt=httpProxyClientAbrt, smNumUserSessions=smNumUserSessions, tempCritical=tempCritical, bwsMIBCompliance=bwsMIBCompliance, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyServerReq=httpProxyServerReq, securityDefUpdates=securityDefUpdates, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCmprAddress=webCmprAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrInBytes=sslSrvrInBytes, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsRCTimeStamp=ipsRCTimeStamp, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyAddressType=sslProxyAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyTotalConn=sslProxyTotalConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, highAvailabilityStatus=highAvailabilityStatus, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, energizeUpdateExpire=energizeUpdateExpire, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, switchingToMaintMode=switchingToMaintMode, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlNormPort=ipsUrlNormPort, servicePort=servicePort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, webCacheMiss=webCacheMiss, httpSrvrTotRefused=httpSrvrTotRefused, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsStats=bwsStats, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, totalServers=totalServers, firmwareStorage=firmwareStorage, bwstraps=bwstraps, ipsHdrAclPort=ipsHdrAclPort, ipsRCAddress=ipsRCAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsRCPort=ipsRCPort, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, dataPathStatus=dataPathStatus, bwsMIBCompliances=bwsMIBCompliances, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, systemFanSpeed=systemFanSpeed, bwsMIBGroups=bwsMIBGroups, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheLongHdrs=webCacheLongHdrs, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, firmwareStorageHigh=firmwareStorageHigh, ipsUrlAclReserved=ipsUrlAclReserved, raidDegrading=raidDegrading, totalApplications=totalApplications, processCountHigh=processCountHigh, sslSrvrTotTimedout=sslSrvrTotTimedout, serverUp=serverUp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyServerErr=httpProxyServerErr, sslProxyCacheHits=sslProxyCacheHits, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCachePort=webCachePort, sslSrvrState=sslSrvrState, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyAddress=httpProxyAddress, httpProxyInBytes=httpProxyInBytes, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrAddress=sslSrvrAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsCookieSecAddressType=ipsCookieSecAddressType, uptime=uptime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlNormAddress=ipsUrlNormAddress, bws=bws, sslSrvrAddressType=sslSrvrAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrPort=httpSrvrPort, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheAddress=webCacheAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsTrapGroup=bwsTrapGroup, bwsCompressionStatsTable=bwsCompressionStatsTable, freeMem=freeMem, sslProxyAddress=sslProxyAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, PYSNMP_MODULE_ID=bws, sslProxyCurrentConn=sslProxyCurrentConn, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheStale=webCacheStale, peerDown=peerDown, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCacheProtocol=webCacheProtocol, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry)
mibBuilder.exportSymbols("BWS-MIB", cpuUtilization=cpuUtilization, tempHigh=tempHigh, memoryUsageHigh=memoryUsageHigh, peerUp=peerUp, bwsMessage=bwsMessage, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyInBytes=sslProxyInBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, activeApplications=activeApplications, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsServiceStatusTable=bwsServiceStatusTable, dataPortLinkDown=dataPortLinkDown, switchingToInlineMode=switchingToInlineMode, sslProxyPort=sslProxyPort, virusDefUpdates=virusDefUpdates, serviceName=serviceName, sslSrvrNumConn=sslSrvrNumConn, bwsMIBConformance=bwsMIBConformance, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitAddress=ipsReqLimitAddress, logStorage=logStorage, sslProxyActiveConn=sslProxyActiveConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, systemFailure=systemFailure, logStorageHigh=logStorageHigh, httpProxyOutBytes=httpProxyOutBytes, httpProxyAddressType=httpProxyAddressType, sslSrvrPort=sslSrvrPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, srvcName=srvcName, serverDown=serverDown, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, fanDead=fanDead, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, currentFirmwareVersion=currentFirmwareVersion, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyTotalReq=httpProxyTotalReq, activeServers=activeServers, memUtilization=memUtilization, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyTotalReq=sslProxyTotalReq, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted)
