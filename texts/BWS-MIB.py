...
ObjectIdentity, Counter32, Gauge32, Counter64, TimeTicks, Integer32, IpAddress, Unsigned32, NotificationType, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Gauge32", "Counter64", "TimeTicks", "Integer32", "IpAddress", "Unsigned32", "NotificationType", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", dataPathStatus=dataPathStatus, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, totalBandwidth=totalBandwidth, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, dataPortLinkDown=dataPortLinkDown, webCmprPort=webCmprPort, securityDefUpdates=securityDefUpdates, httpProxyParseErr=httpProxyParseErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrState=sslSrvrState, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, virusDefUpdates=virusDefUpdates, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrInBytes=sslSrvrInBytes, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheBytesOut=webCacheBytesOut, operationalMode=operationalMode, firmwareStorageHigh=firmwareStorageHigh, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormPort=ipsUrlNormPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, uptime=uptime, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, totalMem=totalMem, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxySessionTimeOut=httpProxySessionTimeOut, smNumUserSessions=smNumUserSessions, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsMessage=bwsMessage, bwsMIBCompliances=bwsMIBCompliances, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsCookieSecTampered=ipsCookieSecTampered, firmwareStorage=firmwareStorage, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitAddress=ipsReqLimitAddress, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyTotalConn=sslProxyTotalConn, sslSrvrOutBytes=sslSrvrOutBytes, ipsRCAddress=ipsRCAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, dataPortLinkUp=dataPortLinkUp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, cpuUtilization=cpuUtilization, httpSrvrNumConn=httpSrvrNumConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCacheAddressType=webCacheAddressType, webCacheReq=webCacheReq, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, systemFailOver=systemFailOver, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyCacheHits=sslProxyCacheHits, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, totalServers=totalServers, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrOutBytes=httpSrvrOutBytes, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsMIBConformance=bwsMIBConformance, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, systemLoad=systemLoad, cpuTemperature=cpuTemperature, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, logStorage=logStorage, bwsStats=bwsStats, PYSNMP_MODULE_ID=bws, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, switchingToMaintMode=switchingToMaintMode, webCacheMiss=webCacheMiss, ipsCookieSecAddress=ipsCookieSecAddress, ipsRCPort=ipsRCPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitPort=ipsReqLimitPort, httpProxyServerReq=httpProxyServerReq, bwsMIBGroups=bwsMIBGroups, bwsServiceStatusTable=bwsServiceStatusTable, ipsRCTotServed=ipsRCTotServed, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, serverDown=serverDown, webCmprAddress=webCmprAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrState=httpSrvrState, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, tempCritical=tempCritical, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, serviceStatus=serviceStatus, vipStatus=vipStatus, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyErrPms=sslProxyErrPms, webCacheCacheableRes=webCacheCacheableRes, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsRCTotDropped=ipsRCTotDropped, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, srvcName=srvcName, httpProxyActiveConn=httpProxyActiveConn, sslProxyAddressType=sslProxyAddressType, webCacheHits=webCacheHits, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlPort=ipsAccessCtrlPort, systemSerialNumber=systemSerialNumber, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCAddressType=ipsRCAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, currentFirmwareVersion=currentFirmwareVersion, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, systemFanSpeed=systemFanSpeed, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, memUtilization=memUtilization, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumFreeConn=httpSrvrNumFreeConn, tempHigh=tempHigh, httpSrvrAddressType=httpSrvrAddressType, httpProxyPort=httpProxyPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprAddressType=webCmprAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, webCacheProtocol=webCacheProtocol, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumConn=sslSrvrNumConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwstraps=bwstraps, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, sharedSecretKeyExpired=sharedSecretKeyExpired, fanDead=fanDead, switchingToBypassMode=switchingToBypassMode, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheStale=webCacheStale, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrSrvcPort=httpSrvrSrvcPort, webCachePort=webCachePort, sslProxyAddress=sslProxyAddress, bws=bws, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransPort=ipsWebAddrTransPort, highAvailabilityStatus=highAvailabilityStatus, sslProxyOutBytes=sslProxyOutBytes, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyPort=sslProxyPort, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, logStorageHigh=logStorageHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrInBytes=httpSrvrInBytes, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqSrvcAddressType=ipsReqSrvcAddressType, peerUp=peerUp, energizeUpdateExpire=energizeUpdateExpire, httpSrvrAddress=httpSrvrAddress, httpProxyServerErr=httpProxyServerErr, sslSrvrSrvcAddress=sslSrvrSrvcAddress, processCountHigh=processCountHigh, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsHdrAclPort=ipsHdrAclPort, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsCookieSecEncrypted=ipsCookieSecEncrypted, raidDegrading=raidDegrading, bwsTrapGroup=bwsTrapGroup, sslProxyInBytes=sslProxyInBytes, totalAttacks=totalAttacks, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyAddress=httpProxyAddress, httpProxyTotalConn=httpProxyTotalConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsHdrAclHits=ipsHdrAclHits, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrPort=httpSrvrPort, servicePort=servicePort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, totalApplications=totalApplications, webCacheAddress=webCacheAddress, linkStatus=linkStatus, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, smAgentName=smAgentName, bwsMIBCompliance=bwsMIBCompliance, ipsUrlAclPort=ipsUrlAclPort, peerDown=peerDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrPort=sslSrvrPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsServiceStatusEntry=bwsServiceStatusEntry, serverUp=serverUp, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpProxyTotalReq=httpProxyTotalReq, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyActiveConn=sslProxyActiveConn, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqSrvcPort=ipsReqSrvcPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyAddressType=httpProxyAddressType, memoryUsageHigh=memoryUsageHigh, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, activeServers=activeServers, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, switchingToInlineMode=switchingToInlineMode, webCmprProtocol=webCmprProtocol, activeApplications=activeApplications, webCacheCachedObjects=webCacheCachedObjects, bwsStatsGroup=bwsStatsGroup, serviceAddress=serviceAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, serviceName=serviceName, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, freeMem=freeMem, smRealmName=smRealmName, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyInBytes=httpProxyInBytes, systemFailure=systemFailure)
