...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Counter32, iso, Unsigned32, ObjectIdentity, Gauge32, NotificationType, TimeTicks, Counter64, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Counter32", "iso", "Unsigned32", "ObjectIdentity", "Gauge32", "NotificationType", "TimeTicks", "Counter64", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, linkStatus=linkStatus, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsMIBGroups=bwsMIBGroups, sslSrvrAddress=sslSrvrAddress, operationalMode=operationalMode, webCacheLongHdrs=webCacheLongHdrs, virusDefUpdates=virusDefUpdates, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, systemFailure=systemFailure, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrState=sslSrvrState, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, serverDown=serverDown, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCmprAddress=webCmprAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsStats=bwsStats, bws=bws, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsCompressionStatsEntry=bwsCompressionStatsEntry, logStorage=logStorage, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwstraps=bwstraps, httpProxyServerErr=httpProxyServerErr, ipsUrlAclReserved=ipsUrlAclReserved, ipsHdrAclHits=ipsHdrAclHits, systemFailOver=systemFailOver, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotRefused=httpSrvrTotRefused, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCacheHits=webCacheHits, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyPort=httpProxyPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyAddressType=sslProxyAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyCacheHits=sslProxyCacheHits, sslSrvrAvgResTime=sslSrvrAvgResTime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumConn=sslSrvrNumConn, httpSrvrInBytes=httpSrvrInBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyAddress=httpProxyAddress, bwsTrapGroup=bwsTrapGroup, webCacheAddress=webCacheAddress, ipsUrlAclPort=ipsUrlAclPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransPort=ipsWebAddrTransPort, switchingToMaintMode=switchingToMaintMode, webCacheCacheableRes=webCacheCacheableRes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyUnknownRsp=httpProxyUnknownRsp, memUtilization=memUtilization, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqLimitPort=ipsReqLimitPort, sslSrvrMinResTime=sslSrvrMinResTime, webCacheStale=webCacheStale, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, firmwareStorage=firmwareStorage, webCacheReq=webCacheReq, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslProxyInBytes=sslProxyInBytes, sslSrvrPort=sslSrvrPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, systemSerialNumber=systemSerialNumber, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrMaxResTime=httpSrvrMaxResTime, totalMem=totalMem, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSslProxyStatsTable=bwsSslProxyStatsTable, vipStatus=vipStatus, sslProxyTotalReq=sslProxyTotalReq, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlAclAddress=ipsUrlAclAddress, sharedSecretKeyExpired=sharedSecretKeyExpired, dataPortLinkDown=dataPortLinkDown, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, activeApplications=activeApplications, freeMem=freeMem, serviceStatus=serviceStatus, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, serviceAddress=serviceAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyAddressType=httpProxyAddressType, webCmprAddressType=webCmprAddressType, httpProxyInBytes=httpProxyInBytes, httpProxyOutBytes=httpProxyOutBytes, sslSrvrSrvcPort=sslSrvrSrvcPort, webCachePort=webCachePort, httpProxyServerReq=httpProxyServerReq, ipsRCTotOutOfResource=ipsRCTotOutOfResource, systemLoad=systemLoad, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitAddressType=ipsReqLimitAddressType, tempCritical=tempCritical, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlNormPort=ipsUrlNormPort, processCountHigh=processCountHigh, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, raidDegrading=raidDegrading, httpSrvrState=httpSrvrState, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyErrPms=sslProxyErrPms, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, srvcName=srvcName, webCacheMiss=webCacheMiss, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, smAgentName=smAgentName, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyPort=sslProxyPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCmprPort=webCmprPort, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, PYSNMP_MODULE_ID=bws, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsServiceStatusEntry=bwsServiceStatusEntry, securityDefUpdates=securityDefUpdates, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, dataPathStatus=dataPathStatus, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprProtocol=webCmprProtocol, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsCookieSecTampered=ipsCookieSecTampered, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotServed=ipsRCTotServed, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, logStorageHigh=logStorageHigh, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyTotalReq=httpProxyTotalReq, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, dataPortLinkUp=dataPortLinkUp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsRCTotDropped=ipsRCTotDropped, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsRCAddressType=ipsRCAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyTotalConn=httpProxyTotalConn, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, tempHigh=tempHigh, cpuUtilization=cpuUtilization, highAvailabilityStatus=highAvailabilityStatus, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyTotalConn=sslProxyTotalConn, httpSrvrNumConn=httpSrvrNumConn, cpuTemperature=cpuTemperature, serverUp=serverUp, ipsRCTotQueued=ipsRCTotQueued, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCacheProtocol=webCacheProtocol, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, fanDead=fanDead, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsMIBConformance=bwsMIBConformance, bwsCompressionStatsTable=bwsCompressionStatsTable, servicePort=servicePort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrAddress=httpSrvrAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsMIBCompliance=bwsMIBCompliance, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, energizeUpdateExpire=energizeUpdateExpire, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, firmwareStorageHigh=firmwareStorageHigh, bwsStatsGroup=bwsStatsGroup, webCacheBytesOut=webCacheBytesOut, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr)
mibBuilder.exportSymbols("BWS-MIB", totalServers=totalServers, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, smNumUserSessions=smNumUserSessions, sslSrvrOutBytes=sslSrvrOutBytes, serviceName=serviceName, currentFirmwareVersion=currentFirmwareVersion, totalApplications=totalApplications, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrPort=httpSrvrPort, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxySessionTimeOut=httpProxySessionTimeOut, sslProxyAddress=sslProxyAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, memoryUsageHigh=memoryUsageHigh, webCacheAddressType=webCacheAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, activeServers=activeServers, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrInBytes=sslSrvrInBytes, sslSrvrTotRefused=sslSrvrTotRefused, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, sslProxyBadCRLErr=sslProxyBadCRLErr, smRealmName=smRealmName, bwsMessage=bwsMessage, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, totalBandwidth=totalBandwidth, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsRCAddress=ipsRCAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, peerDown=peerDown, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyOutBytes=sslProxyOutBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, switchingToBypassMode=switchingToBypassMode, ipsRCPort=ipsRCPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, peerUp=peerUp, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, uptime=uptime, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrAddressType=sslSrvrAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, switchingToInlineMode=switchingToInlineMode, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrMinResTime=httpSrvrMinResTime, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, totalAttacks=totalAttacks, httpProxyActiveConn=httpProxyActiveConn, sslProxyActiveConn=sslProxyActiveConn, systemFanSpeed=systemFanSpeed, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyBadDNCErr=sslProxyBadDNCErr, sslProxyCacheMiss=sslProxyCacheMiss)
