...
Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, NotificationType, Bits, ObjectIdentity, Integer32, Unsigned32, TimeTicks, Counter32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "NotificationType", "Bits", "ObjectIdentity", "Integer32", "Unsigned32", "TimeTicks", "Counter32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", webCmprAddressType=webCmprAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCmprProtocol=webCmprProtocol, systemLoad=systemLoad, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheMiss=webCacheMiss, firmwareStorage=firmwareStorage, httpProxyParseErr=httpProxyParseErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrPort=httpSrvrPort, bws=bws, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, totalMem=totalMem, bwsMIBCompliance=bwsMIBCompliance, bwsMessage=bwsMessage, memUtilization=memUtilization, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyFullHandshakes=sslProxyFullHandshakes, cpuFanSpeed=cpuFanSpeed, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCacheHits=webCacheHits, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyErrPms=sslProxyErrPms, activeApplications=activeApplications, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, systemFanSpeed=systemFanSpeed, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsMIBConformance=bwsMIBConformance, httpProxyTotalConn=httpProxyTotalConn, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsMIBCompliances=bwsMIBCompliances, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyInBytes=httpProxyInBytes, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsRCTimeStamp=ipsRCTimeStamp, fanDead=fanDead, sslProxyPort=sslProxyPort, securityDefUpdates=securityDefUpdates, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, linkStatus=linkStatus, ipsCookieSecEncrypted=ipsCookieSecEncrypted, totalApplications=totalApplications, ipsWebAddrTransPort=ipsWebAddrTransPort, webCmprCompressedDataSize=webCmprCompressedDataSize, webCacheReq=webCacheReq, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, uptime=uptime, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyTotalReq=sslProxyTotalReq, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitPort=ipsReqLimitPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrAddress=httpSrvrAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxySessionTimeOut=httpProxySessionTimeOut, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, activeServers=activeServers, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, cpuTemperature=cpuTemperature, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrAddressType=httpSrvrAddressType, ipsRCAddress=ipsRCAddress, vipStatus=vipStatus, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, smNumUserSessions=smNumUserSessions, sslProxyTotalConn=sslProxyTotalConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, switchingToBypassMode=switchingToBypassMode, ipsHdrAclAddressType=ipsHdrAclAddressType, srvcName=srvcName, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsStats=bwsStats, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyServerReq=httpProxyServerReq, firmwareStorageHigh=firmwareStorageHigh, httpSrvrInBytes=httpSrvrInBytes, cpuUtilization=cpuUtilization, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsHdrAclHits=ipsHdrAclHits, webCmprPort=webCmprPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serverUp=serverUp, logStorageHigh=logStorageHigh, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyOutBytes=sslProxyOutBytes, httpProxyServerErr=httpProxyServerErr, serviceName=serviceName, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, energizeUpdateExpire=energizeUpdateExpire, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyBadDNCErr=sslProxyBadDNCErr, logStorage=logStorage, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, processCountHigh=processCountHigh, PYSNMP_MODULE_ID=bws, freeMem=freeMem, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyCacheHits=sslProxyCacheHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyAddressType=httpProxyAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrAddress=sslSrvrAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, highAvailabilityStatus=highAvailabilityStatus, switchingToInlineMode=switchingToInlineMode, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, totalBandwidth=totalBandwidth, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, peerDown=peerDown, httpProxyOutBytes=httpProxyOutBytes, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyActiveConn=httpProxyActiveConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheLongHdrs=webCacheLongHdrs, ipsUrlNormAddress=ipsUrlNormAddress, webCacheCacheableRes=webCacheCacheableRes, httpSrvrOutBytes=httpSrvrOutBytes, totalServers=totalServers, sslSrvrOutBytes=sslSrvrOutBytes, raidDegrading=raidDegrading, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, smAgentName=smAgentName, httpSrvrMinResTime=httpSrvrMinResTime, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrPort=sslSrvrPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrAddressType=sslSrvrAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsSMUserSessionTable=bwsSMUserSessionTable, sslProxyActiveConn=sslProxyActiveConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrState=sslSrvrState, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serviceStatus=serviceStatus, ipsRCTotQueued=ipsRCTotQueued, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyPort=httpProxyPort, sslProxyInBytes=sslProxyInBytes, tempCritical=tempCritical, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, systemSerialNumber=systemSerialNumber, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsMIBGroups=bwsMIBGroups, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCacheAddressType=webCacheAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsServiceStatusTable=bwsServiceStatusTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyAddressType=sslProxyAddressType, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheAddress=webCacheAddress, ipsHdrAclPort=ipsHdrAclPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, operationalMode=operationalMode, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyAddress=sslProxyAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclPort=ipsUrlAclPort, webCacheBytesOut=webCacheBytesOut, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, switchingToMaintMode=switchingToMaintMode, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, dataPortLinkUp=dataPortLinkUp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrNumConn=httpSrvrNumConn, servicePort=servicePort, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, dataPathStatus=dataPathStatus, smRealmName=smRealmName, tempHigh=tempHigh, httpProxyAddress=httpProxyAddress, currentFirmwareVersion=currentFirmwareVersion, bwstraps=bwstraps)
mibBuilder.exportSymbols("BWS-MIB", sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrTotResponse=sslSrvrTotResponse, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsRCAddressType=ipsRCAddressType, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlNormPort=ipsUrlNormPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheStale=webCacheStale, ipsRCTotDropped=ipsRCTotDropped, totalAttacks=totalAttacks, serverDown=serverDown, ipsRCPort=ipsRCPort, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsTrapGroup=bwsTrapGroup, virusDefUpdates=virusDefUpdates, webCmprAddress=webCmprAddress, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitAddress=ipsReqLimitAddress, webCacheProtocol=webCacheProtocol, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, dataPortLinkDown=dataPortLinkDown, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyBadCRLErr=sslProxyBadCRLErr, webCachePort=webCachePort, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrInBytes=sslSrvrInBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsCookieSecPort=ipsCookieSecPort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, systemFailOver=systemFailOver, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheCachedObjects=webCacheCachedObjects, systemFailure=systemFailure, sslSrvrNumConn=sslSrvrNumConn, ipsCookieSecAddress=ipsCookieSecAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serviceAddress=serviceAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, peerUp=peerUp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsRCTotServed=ipsRCTotServed, httpSrvrState=httpSrvrState, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecTampered=ipsCookieSecTampered)
