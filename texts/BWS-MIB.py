...
Counter64, ObjectIdentity, iso, IpAddress, Counter32, Integer32, TimeTicks, Unsigned32, Gauge32, NotificationType, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "iso", "IpAddress", "Counter32", "Integer32", "TimeTicks", "Unsigned32", "Gauge32", "NotificationType", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", serviceAddress=serviceAddress, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, servicePort=servicePort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsStatsGroup=bwsStatsGroup, firmwareStorageHigh=firmwareStorageHigh, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, srvcName=srvcName, httpProxyAddressType=httpProxyAddressType, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyPort=httpProxyPort, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrPort=sslSrvrPort, httpSrvrTotRefused=httpSrvrTotRefused, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCTotServed=ipsRCTotServed, bws=bws, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcAddress=ipsLrnSrvcAddress, raidDegrading=raidDegrading, bwsMessage=bwsMessage, ipsUrlAclReserved=ipsUrlAclReserved, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrInBytes=sslSrvrInBytes, totalMem=totalMem, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsRCPort=ipsRCPort, webCachePort=webCachePort, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, activeServers=activeServers, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAddress=sslProxyAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCacheHits=webCacheHits, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCmprProtocol=webCmprProtocol, sslProxyCacheHits=sslProxyCacheHits, webCmprAddress=webCmprAddress, sslSrvrAddress=sslSrvrAddress, ipsRCAddress=ipsRCAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsCacheStatsTable=bwsCacheStatsTable, bwstraps=bwstraps, httpProxyParseErr=httpProxyParseErr, webCacheReq=webCacheReq, sslProxyBadDNCErr=sslProxyBadDNCErr, logStorage=logStorage, sslProxyPort=sslProxyPort, PYSNMP_MODULE_ID=bws, switchingToInlineMode=switchingToInlineMode, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, tempHigh=tempHigh, sslSrvrTotResponse=sslSrvrTotResponse, ipsHdrAclHits=ipsHdrAclHits, processCountHigh=processCountHigh, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrSrvcPort=sslSrvrSrvcPort, serviceStatus=serviceStatus, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecPort=ipsCookieSecPort, httpSrvrAddress=httpSrvrAddress, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, memUtilization=memUtilization, sslSrvrAddressType=sslSrvrAddressType, peerUp=peerUp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCacheCachedObjects=webCacheCachedObjects, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, dataPortLinkUp=dataPortLinkUp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqLimitPort=ipsReqLimitPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, securityDefUpdates=securityDefUpdates, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, webCacheStale=webCacheStale, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, currentFirmwareVersion=currentFirmwareVersion, sslProxyErrPms=sslProxyErrPms, systemFailure=systemFailure, ipsReqLimitAddress=ipsReqLimitAddress, smRealmName=smRealmName, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, energizeUpdateExpire=energizeUpdateExpire, ipsRCTotQueued=ipsRCTotQueued, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, memoryUsageHigh=memoryUsageHigh, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, highAvailabilityStatus=highAvailabilityStatus, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, totalBandwidth=totalBandwidth, httpProxyActiveConn=httpProxyActiveConn, webCacheMiss=webCacheMiss, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyAddress=httpProxyAddress, webCacheAddress=webCacheAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyActiveConn=sslProxyActiveConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, totalApplications=totalApplications, bwsTrapGroup=bwsTrapGroup, smNumUserSessions=smNumUserSessions, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, systemFailOver=systemFailOver, freeMem=freeMem, httpProxyWAFWarnings=httpProxyWAFWarnings, systemFanSpeed=systemFanSpeed, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrNumConn=httpSrvrNumConn, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrAddressType=httpSrvrAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyInBytes=httpProxyInBytes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, operationalMode=operationalMode, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, smAgentName=smAgentName, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, dataPathStatus=dataPathStatus, ipsUrlNormAddress=ipsUrlNormAddress, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyTotalReq=sslProxyTotalReq, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, serverUp=serverUp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, linkStatus=linkStatus, bwsMIBGroups=bwsMIBGroups, httpProxyServerReq=httpProxyServerReq, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, serviceName=serviceName, cpuFanSpeed=cpuFanSpeed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, totalAttacks=totalAttacks, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, switchingToMaintMode=switchingToMaintMode, httpSrvrPort=httpSrvrPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, vipStatus=vipStatus, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrMinResTime=httpSrvrMinResTime, totalServers=totalServers, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, activeApplications=activeApplications, webCmprPort=webCmprPort, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, webCacheCacheableRes=webCacheCacheableRes, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, cpuTemperature=cpuTemperature, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCTimeStamp=ipsRCTimeStamp, webCacheBytesOut=webCacheBytesOut, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsMIBCompliances=bwsMIBCompliances, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslProxyTotalConn=sslProxyTotalConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, cpuUtilization=cpuUtilization, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrState=httpSrvrState, uptime=uptime, ipsUrlAclPort=ipsUrlAclPort, switchingToBypassMode=switchingToBypassMode, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyOutBytes=httpProxyOutBytes, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, firmwareStorage=firmwareStorage, webCacheProtocol=webCacheProtocol)
mibBuilder.exportSymbols("BWS-MIB", serverDown=serverDown, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, logStorageHigh=logStorageHigh, ipsUrlAclAddressType=ipsUrlAclAddressType, virusDefUpdates=virusDefUpdates, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyClientAbrt=httpProxyClientAbrt, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCacheLongHdrs=webCacheLongHdrs, dataPortLinkDown=dataPortLinkDown, ipsRCAddressType=ipsRCAddressType, bwsMIBConformance=bwsMIBConformance, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMIBCompliance=bwsMIBCompliance, tempCritical=tempCritical, ipsRCTotDropped=ipsRCTotDropped, webCmprAddressType=webCmprAddressType, fanDead=fanDead, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecTampered=ipsCookieSecTampered, bwsCompressionStatsTable=bwsCompressionStatsTable, sslSrvrState=sslSrvrState, systemLoad=systemLoad, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsHdrAclPort=ipsHdrAclPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, peerDown=peerDown, httpProxyTotalReq=httpProxyTotalReq, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, systemSerialNumber=systemSerialNumber, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqSrvcPort=ipsReqSrvcPort, bwsStats=bwsStats, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheAddressType=webCacheAddressType, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyInBytes=sslProxyInBytes, sslSrvrTotReqRejected=sslSrvrTotReqRejected)
