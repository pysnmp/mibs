...
ModuleIdentity, Integer32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, NotificationType, IpAddress, Gauge32, TimeTicks, MibIdentifier, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "NotificationType", "IpAddress", "Gauge32", "TimeTicks", "MibIdentifier", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCacheCacheableRes=webCacheCacheableRes, processCountHigh=processCountHigh, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, systemFailOver=systemFailOver, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrState=httpSrvrState, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrAddress=sslSrvrAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsStatsGroup=bwsStatsGroup, operationalMode=operationalMode, sslProxyActiveConn=sslProxyActiveConn, securityDefUpdates=securityDefUpdates, webCmprAddressType=webCmprAddressType, ipsRCTotDropped=ipsRCTotDropped, bwsMIBCompliances=bwsMIBCompliances, systemFanSpeed=systemFanSpeed, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrTotResponse=sslSrvrTotResponse, serviceName=serviceName, bwsStats=bwsStats, httpSrvrTotRefused=httpSrvrTotRefused, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCTotServed=ipsRCTotServed, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, serviceAddress=serviceAddress, webCacheReq=webCacheReq, ipsReqSrvcAddressType=ipsReqSrvcAddressType, servicePort=servicePort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsCacheStatsEntry=bwsCacheStatsEntry, cpuTemperature=cpuTemperature, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyTotalReq=httpProxyTotalReq, webCachePort=webCachePort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcAddress=ipsReqSrvcAddress, logStorage=logStorage, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, vipStatus=vipStatus, sslProxyTotalConn=sslProxyTotalConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyPort=sslProxyPort, sslSrvrMaxResTime=sslSrvrMaxResTime, cpuFanSpeed=cpuFanSpeed, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, virusDefUpdates=virusDefUpdates, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsSMUserSessionEntry=bwsSMUserSessionEntry, energizeUpdateExpire=energizeUpdateExpire, webCacheHits=webCacheHits, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyAddress=sslProxyAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsServiceStatusTable=bwsServiceStatusTable, ipsCookieSecAddress=ipsCookieSecAddress, bws=bws, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsMIBGroups=bwsMIBGroups, switchingToInlineMode=switchingToInlineMode, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrAddressType=httpSrvrAddressType, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlAclPort=ipsUrlAclPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, firmwareStorageHigh=firmwareStorageHigh, systemSerialNumber=systemSerialNumber, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, activeApplications=activeApplications, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCacheBytesOut=webCacheBytesOut, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyTotalReq=sslProxyTotalReq, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrTotReqRejected=sslSrvrTotReqRejected, currentFirmwareVersion=currentFirmwareVersion, raidDegrading=raidDegrading, switchingToBypassMode=switchingToBypassMode, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlPolicyPort=ipsUrlPolicyPort, dataPortLinkDown=dataPortLinkDown, ipsCookieSecAddressType=ipsCookieSecAddressType, tempHigh=tempHigh, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, webCacheAddressType=webCacheAddressType, httpProxyServerReq=httpProxyServerReq, httpProxyPort=httpProxyPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, totalAttacks=totalAttacks, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, logStorageHigh=logStorageHigh, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCmprAddress=webCmprAddress, dataPortLinkUp=dataPortLinkUp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsHdrAclHits=ipsHdrAclHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlNormPort=ipsUrlNormPort, switchingToMaintMode=switchingToMaintMode, webCacheCachedObjects=webCacheCachedObjects, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsHdrAclPort=ipsHdrAclPort, sharedSecretKeyExpired=sharedSecretKeyExpired, activeServers=activeServers, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrPort=httpSrvrPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, totalMem=totalMem, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlPort=ipsAccessCtrlPort, httpProxyActiveConn=httpProxyActiveConn, ipsRCTimeStamp=ipsRCTimeStamp, bwsMIBConformance=bwsMIBConformance, sslProxyErrPms=sslProxyErrPms, webCacheAddress=webCacheAddress, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrPort=sslSrvrPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, dataPathStatus=dataPathStatus, httpProxyInBytes=httpProxyInBytes, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrAddressType=sslSrvrAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitAddressType=ipsReqLimitAddressType, cpuUtilization=cpuUtilization, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, uptime=uptime, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, srvcName=srvcName, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, smAgentName=smAgentName, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrState=sslSrvrState, peerUp=peerUp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyTotalConn=httpProxyTotalConn, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrInBytes=sslSrvrInBytes, sslSrvrTotRefused=sslSrvrTotRefused, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyServerErr=httpProxyServerErr, freeMem=freeMem, httpProxyAddressType=httpProxyAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, memUtilization=memUtilization, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheMiss=webCacheMiss, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyOutBytes=sslProxyOutBytes, webCmprPort=webCmprPort, ipsRCTotQueued=ipsRCTotQueued, bwstraps=bwstraps, httpProxyAddress=httpProxyAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, totalBandwidth=totalBandwidth, firmwareStorage=firmwareStorage, PYSNMP_MODULE_ID=bws, systemFailure=systemFailure, linkStatus=linkStatus, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheStale=webCacheStale, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyCurrentConn=sslProxyCurrentConn, smRealmName=smRealmName, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyParseErr=httpProxyParseErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, peerDown=peerDown, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, serverUp=serverUp)
mibBuilder.exportSymbols("BWS-MIB", ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyInBytes=sslProxyInBytes, bwsTrapGroup=bwsTrapGroup, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsRCAddressType=ipsRCAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, smNumUserSessions=smNumUserSessions, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, serviceStatus=serviceStatus, httpSrvrOutBytes=httpSrvrOutBytes, bwsMIBCompliance=bwsMIBCompliance, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheProtocol=webCacheProtocol, bwsMessage=bwsMessage, httpSrvrInBytes=httpSrvrInBytes, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsRCPort=ipsRCPort, totalServers=totalServers, tempCritical=tempCritical, ipsHdrAclAddress=ipsHdrAclAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecTampered=ipsCookieSecTampered, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, fanDead=fanDead, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrNumConn=sslSrvrNumConn, memoryUsageHigh=memoryUsageHigh, httpSrvrNumConn=httpSrvrNumConn, serverDown=serverDown, ipsRCAddress=ipsRCAddress, ipsUrlNormAddress=ipsUrlNormAddress, highAvailabilityStatus=highAvailabilityStatus, totalApplications=totalApplications, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprProtocol=webCmprProtocol, httpSrvrMaxResTime=httpSrvrMaxResTime, systemLoad=systemLoad, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyAddressType=sslProxyAddressType)
