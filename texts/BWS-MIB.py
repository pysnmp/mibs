...
Unsigned32, Counter64, Counter32, ModuleIdentity, Bits, Gauge32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Integer32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "Counter32", "ModuleIdentity", "Bits", "Gauge32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Integer32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, uptime=uptime, systemFanSpeed=systemFanSpeed, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCacheProtocol=webCacheProtocol, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCmprAddress=webCmprAddress, activeApplications=activeApplications, bwsCacheStatsTable=bwsCacheStatsTable, srvcName=srvcName, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrAddress=sslSrvrAddress, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyActiveConn=sslProxyActiveConn, totalAttacks=totalAttacks, processCountHigh=processCountHigh, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, vipStatus=vipStatus, sslProxyTotalConn=sslProxyTotalConn, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, dataPortLinkUp=dataPortLinkUp, sslSrvrTotTimedout=sslSrvrTotTimedout, totalBandwidth=totalBandwidth, peerUp=peerUp, bwsCompressionStatsTable=bwsCompressionStatsTable, systemLoad=systemLoad, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrOutBytes=httpSrvrOutBytes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyAddress=sslProxyAddress, sslProxyPort=sslProxyPort, bwsMessage=bwsMessage, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, PYSNMP_MODULE_ID=bws, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyInBytes=httpProxyInBytes, serviceName=serviceName, cpuFanSpeed=cpuFanSpeed, sslSrvrState=sslSrvrState, sslProxyCacheMiss=sslProxyCacheMiss, switchingToMaintMode=switchingToMaintMode, totalServers=totalServers, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, activeServers=activeServers, sslProxyInBytes=sslProxyInBytes, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrTotReqActive=sslSrvrTotReqActive, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCacheCachedObjects=webCacheCachedObjects, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCmprAddressType=webCmprAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyTotalConn=httpProxyTotalConn, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, memUtilization=memUtilization, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bws=bws, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheCacheableRes=webCacheCacheableRes, httpSrvrAddressType=httpSrvrAddressType, serviceStatus=serviceStatus, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyOutBytes=sslProxyOutBytes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyParseErr=httpProxyParseErr, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, smAgentName=smAgentName, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, memoryUsageHigh=memoryUsageHigh, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, securityDefUpdates=securityDefUpdates, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrTotRefused=httpSrvrTotRefused, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyServerReq=httpProxyServerReq, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, logStorageHigh=logStorageHigh, httpSrvrAvgResTime=httpSrvrAvgResTime, webCachePort=webCachePort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyPort=httpProxyPort, sslProxyCacheHits=sslProxyCacheHits, ipsRCAddressType=ipsRCAddressType, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsMIBCompliance=bwsMIBCompliance, httpProxyAddressType=httpProxyAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitPort=ipsReqLimitPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsMIBConformance=bwsMIBConformance, httpSrvrPort=httpSrvrPort, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyTotalReq=sslProxyTotalReq, serverUp=serverUp, dataPathStatus=dataPathStatus, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsHdrAclHits=ipsHdrAclHits, sslSrvrOutBytes=sslSrvrOutBytes, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCacheReq=webCacheReq, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrNumConn=httpSrvrNumConn, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, fanDead=fanDead, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, freeMem=freeMem, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrInBytes=sslSrvrInBytes, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrInBytes=httpSrvrInBytes, ipsRCTotDropped=ipsRCTotDropped, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsCookieSecAddressType=ipsCookieSecAddressType, operationalMode=operationalMode, webCmprCompressedDataSize=webCmprCompressedDataSize, webCmprProtocol=webCmprProtocol, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, firmwareStorageHigh=firmwareStorageHigh, logStorage=logStorage, webCacheAddressType=webCacheAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecPort=ipsCookieSecPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyClientAbrt=httpProxyClientAbrt, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCacheAddress=webCacheAddress, serverDown=serverDown, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, totalApplications=totalApplications, httpSrvrAddress=httpSrvrAddress, ipsUrlAclPort=ipsUrlAclPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyOutBytes=httpProxyOutBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsMIBGroups=bwsMIBGroups, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsHdrAclPort=ipsHdrAclPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCmprPort=webCmprPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsRCAddress=ipsRCAddress, httpSrvrTotResponse=httpSrvrTotResponse, ipsRCTotServed=ipsRCTotServed, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormPort=ipsUrlNormPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, smRealmName=smRealmName, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsMIBCompliances=bwsMIBCompliances, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, energizeUpdateExpire=energizeUpdateExpire, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsStats=bwsStats, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, cpuUtilization=cpuUtilization, ipsUrlNormAddressType=ipsUrlNormAddressType, bwstraps=bwstraps, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsCookieSecEncrypted=ipsCookieSecEncrypted, systemSerialNumber=systemSerialNumber, dataPortLinkDown=dataPortLinkDown, bwsTrapGroup=bwsTrapGroup, raidDegrading=raidDegrading, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheMiss=webCacheMiss, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, totalMem=totalMem, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyAddressType=sslProxyAddressType, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecAddress=ipsCookieSecAddress, systemFailure=systemFailure, httpSrvrState=httpSrvrState, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsServiceStatusEntry=bwsServiceStatusEntry)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, switchingToInlineMode=switchingToInlineMode, webCacheBytesOut=webCacheBytesOut, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, highAvailabilityStatus=highAvailabilityStatus, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, systemFailOver=systemFailOver, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyActiveConn=httpProxyActiveConn, currentFirmwareVersion=currentFirmwareVersion, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrPort=sslSrvrPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, linkStatus=linkStatus, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, smNumUserSessions=smNumUserSessions, webCmprCompressibleDataSize=webCmprCompressibleDataSize, cpuTemperature=cpuTemperature, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, tempCritical=tempCritical, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsRCTotQueued=ipsRCTotQueued, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrAddressType=sslSrvrAddressType, ipsRCPort=ipsRCPort, webCacheStale=webCacheStale, peerDown=peerDown, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrNumConn=sslSrvrNumConn, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, tempHigh=tempHigh, webCacheHits=webCacheHits, httpProxyAddress=httpProxyAddress, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotResponse=sslSrvrTotResponse, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, serviceAddress=serviceAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitAddress=ipsReqLimitAddress, firmwareStorage=firmwareStorage, sslProxyErrPms=sslProxyErrPms, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, virusDefUpdates=virusDefUpdates, servicePort=servicePort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten)
