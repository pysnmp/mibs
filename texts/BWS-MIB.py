...
Bits, Gauge32, Unsigned32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, MibIdentifier, ObjectIdentity, iso, IpAddress, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "Unsigned32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "iso", "IpAddress", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrState=sslSrvrState, cpuTemperature=cpuTemperature, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrPort=sslSrvrPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlPolicyPort=ipsUrlPolicyPort, logStorageHigh=logStorageHigh, ipsRCTotServed=ipsRCTotServed, vipStatus=vipStatus, httpProxyAddressType=httpProxyAddressType, httpProxyParseErr=httpProxyParseErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, PYSNMP_MODULE_ID=bws, systemFanSpeed=systemFanSpeed, webCacheCacheableRes=webCacheCacheableRes, sslProxyAddress=sslProxyAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCmprPort=webCmprPort, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrNumConn=sslSrvrNumConn, bwsStats=bwsStats, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, highAvailabilityStatus=highAvailabilityStatus, sslProxyCacheHits=sslProxyCacheHits, firmwareStorageHigh=firmwareStorageHigh, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, firmwareStorage=firmwareStorage, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyAddressType=sslProxyAddressType, bws=bws, httpProxyServerErr=httpProxyServerErr, systemSerialNumber=systemSerialNumber, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, tempHigh=tempHigh, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, fanDead=fanDead, cpuFanSpeed=cpuFanSpeed, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyActiveConn=httpProxyActiveConn, sslProxyInBytes=sslProxyInBytes, sslSrvrTotTimedout=sslSrvrTotTimedout, systemLoad=systemLoad, sslProxyErrPms=sslProxyErrPms, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCmprAddressType=webCmprAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyPort=httpProxyPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyTotalReq=httpProxyTotalReq, servicePort=servicePort, sslProxyPort=sslProxyPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, currentFirmwareVersion=currentFirmwareVersion, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, smRealmName=smRealmName, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsMIBConformance=bwsMIBConformance, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, securityDefUpdates=securityDefUpdates, serviceName=serviceName, dataPathStatus=dataPathStatus, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheProtocol=webCacheProtocol, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyCurrentConn=sslProxyCurrentConn, serviceStatus=serviceStatus, tempCritical=tempCritical, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, dataPortLinkDown=dataPortLinkDown, operationalMode=operationalMode, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyActiveConn=sslProxyActiveConn, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, activeApplications=activeApplications, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCmprAddress=webCmprAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsHdrAclHits=ipsHdrAclHits, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, cpuUtilization=cpuUtilization, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, freeMem=freeMem, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, totalBandwidth=totalBandwidth, httpSrvrAddressType=httpSrvrAddressType, webCacheHits=webCacheHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, activeServers=activeServers, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyTotalConn=sslProxyTotalConn, linkStatus=linkStatus, serviceAddress=serviceAddress, virusDefUpdates=virusDefUpdates, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, switchingToInlineMode=switchingToInlineMode, bwsMIBCompliances=bwsMIBCompliances, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCachePort=webCachePort, webCacheStale=webCacheStale, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, totalMem=totalMem, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslSrvrMaxResTime=sslSrvrMaxResTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, serverUp=serverUp, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrMinResTime=sslSrvrMinResTime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrTotResponse=sslSrvrTotResponse, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, logStorage=logStorage, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotDropped=ipsRCTotDropped, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpProxyUnknownRsp=httpProxyUnknownRsp, systemFailure=systemFailure, peerDown=peerDown, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, peerUp=peerUp, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCmprProtocol=webCmprProtocol, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, switchingToMaintMode=switchingToMaintMode, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyTotalConn=httpProxyTotalConn, webCacheBytesOut=webCacheBytesOut, ipsUrlAclPort=ipsUrlAclPort, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlPort=ipsAccessCtrlPort, smNumUserSessions=smNumUserSessions, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsServiceStatusTable=bwsServiceStatusTable, systemFailOver=systemFailOver, ipsReqLimitAddress=ipsReqLimitAddress, webCacheAddress=webCacheAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrAvgResTime=sslSrvrAvgResTime, raidDegrading=raidDegrading, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, uptime=uptime, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormPort=ipsUrlNormPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, totalAttacks=totalAttacks, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, serverDown=serverDown, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrOutBytes=httpSrvrOutBytes, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheReq=webCacheReq, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrAddress=httpSrvrAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrNumConn=httpSrvrNumConn, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCAddress=ipsRCAddress, bwstraps=bwstraps, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecTampered=ipsCookieSecTampered, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrAddress=sslSrvrAddress, webCacheCachedObjects=webCacheCachedObjects, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable)
mibBuilder.exportSymbols("BWS-MIB", bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlAclAddress=ipsUrlAclAddress, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrAddressType=sslSrvrAddressType, ipsRCTimeStamp=ipsRCTimeStamp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyInBytes=httpProxyInBytes, webCacheAddressType=webCacheAddressType, ipsRCPort=ipsRCPort, totalApplications=totalApplications, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsCookieSecAddress=ipsCookieSecAddress, ipsRCTotQueued=ipsRCTotQueued, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, dataPortLinkUp=dataPortLinkUp, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsMessage=bwsMessage, bwsTrapGroup=bwsTrapGroup, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsRCAddressType=ipsRCAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, totalServers=totalServers, energizeUpdateExpire=energizeUpdateExpire, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsStatsGroup=bwsStatsGroup, memUtilization=memUtilization, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, srvcName=srvcName, smAgentName=smAgentName, httpSrvrInBytes=httpSrvrInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrPort=httpSrvrPort, webCacheLongHdrs=webCacheLongHdrs, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpSrvrState=httpSrvrState, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheMiss=webCacheMiss, ipsCookieSecPort=ipsCookieSecPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsMIBCompliance=bwsMIBCompliance, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, processCountHigh=processCountHigh, sslProxyTotalReq=sslProxyTotalReq, httpProxyServerReq=httpProxyServerReq, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyOutBytes=httpProxyOutBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled)
