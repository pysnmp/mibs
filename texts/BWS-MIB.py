...
ModuleIdentity, Gauge32, ObjectIdentity, IpAddress, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, MibIdentifier, NotificationType, TimeTicks, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "ObjectIdentity", "IpAddress", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "MibIdentifier", "NotificationType", "TimeTicks", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsMessage=bwsMessage, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqSrvcAddressType=ipsReqSrvcAddressType, dataPortLinkUp=dataPortLinkUp, totalMem=totalMem, systemFailure=systemFailure, ipsUrlAclReserved=ipsUrlAclReserved, cpuUtilization=cpuUtilization, httpSrvrTotResponse=httpSrvrTotResponse, peerDown=peerDown, webCacheCacheableRes=webCacheCacheableRes, webCacheHits=webCacheHits, currentFirmwareVersion=currentFirmwareVersion, webCacheAddressType=webCacheAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, totalServers=totalServers, httpProxyParseErr=httpProxyParseErr, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyTotalConn=sslProxyTotalConn, sslProxyBadDNCErr=sslProxyBadDNCErr, processCountHigh=processCountHigh, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyTotalReq=sslProxyTotalReq, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSMUserSessionEntry=bwsSMUserSessionEntry, serviceName=serviceName, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, virusDefUpdates=virusDefUpdates, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyOutBytes=httpProxyOutBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyOutBytes=sslProxyOutBytes, ipsReqSrvcPort=ipsReqSrvcPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCacheProtocol=webCacheProtocol, httpProxyTotalReq=httpProxyTotalReq, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, fanDead=fanDead, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsMIBCompliances=bwsMIBCompliances, ipsCookieSecAddressType=ipsCookieSecAddressType, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serverUp=serverUp, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsHdrAclHits=ipsHdrAclHits, bwsMIBConformance=bwsMIBConformance, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsStatsGroup=bwsStatsGroup, uptime=uptime, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclPort=ipsUrlAclPort, httpSrvrState=httpSrvrState, httpSrvrMinResTime=httpSrvrMinResTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsCookieSecAddress=ipsCookieSecAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, systemLoad=systemLoad, bwsTrapGroup=bwsTrapGroup, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrTotRefused=sslSrvrTotRefused, totalBandwidth=totalBandwidth, smRealmName=smRealmName, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrNumConn=httpSrvrNumConn, httpProxyTotalConn=httpProxyTotalConn, systemSerialNumber=systemSerialNumber, smAgentName=smAgentName, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrPort=httpSrvrPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrState=sslSrvrState, ipsRCAddress=ipsRCAddress, ipsRCAddressType=ipsRCAddressType, sslSrvrAddressType=sslSrvrAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyServerAbrt=httpProxyServerAbrt, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, cpuFanSpeed=cpuFanSpeed, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrAddress=sslSrvrAddress, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrAddress=httpSrvrAddress, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyPort=sslProxyPort, httpProxyAddressType=httpProxyAddressType, webCmprAddress=webCmprAddress, sslSrvrPort=sslSrvrPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyErrPms=sslProxyErrPms, ipsWebAddrTransPort=ipsWebAddrTransPort, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyActiveConn=httpProxyActiveConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprPort=webCmprPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsHdrAclPort=ipsHdrAclPort, srvcName=srvcName, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, smNumUserSessions=smNumUserSessions, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsStats=bwsStats, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrTotResponse=sslSrvrTotResponse, memUtilization=memUtilization, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrInBytes=sslSrvrInBytes, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslProxyAddressType=sslProxyAddressType, freeMem=freeMem, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, firmwareStorageHigh=firmwareStorageHigh, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrAddressType=httpSrvrAddressType, dataPathStatus=dataPathStatus, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyServerReq=httpProxyServerReq, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCmprProtocol=webCmprProtocol, httpProxyAddress=httpProxyAddress, httpProxyPort=httpProxyPort, ipsRCPort=ipsRCPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqLimitPort=ipsReqLimitPort, sslProxyAddress=sslProxyAddress, ipsCookieSecTampered=ipsCookieSecTampered, webCacheReq=webCacheReq, webCachePort=webCachePort, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, activeApplications=activeApplications, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, peerUp=peerUp, serviceStatus=serviceStatus, totalApplications=totalApplications, switchingToInlineMode=switchingToInlineMode, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, cpuTemperature=cpuTemperature, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, tempCritical=tempCritical, webCacheStale=webCacheStale, servicePort=servicePort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlNormAddress=ipsUrlNormAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyInBytes=httpProxyInBytes, serviceAddress=serviceAddress, logStorage=logStorage, ipsRCTotDropped=ipsRCTotDropped, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrNumConn=sslSrvrNumConn, memoryUsageHigh=memoryUsageHigh, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, logStorageHigh=logStorageHigh, bwsServiceStatusEntry=bwsServiceStatusEntry, bwstraps=bwstraps, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, activeServers=activeServers, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, PYSNMP_MODULE_ID=bws, webCmprAddressType=webCmprAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, switchingToBypassMode=switchingToBypassMode, ipsUrlNormPort=ipsUrlNormPort, ipsRCTimeStamp=ipsRCTimeStamp, ipsHdrAclAddress=ipsHdrAclAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, vipStatus=vipStatus)
mibBuilder.exportSymbols("BWS-MIB", webCacheAddress=webCacheAddress, energizeUpdateExpire=energizeUpdateExpire, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitAddress=ipsReqLimitAddress, bwsSMUserSessionTable=bwsSMUserSessionTable, securityDefUpdates=securityDefUpdates, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsMIBGroups=bwsMIBGroups, operationalMode=operationalMode, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, webCacheMiss=webCacheMiss, totalAttacks=totalAttacks, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, raidDegrading=raidDegrading, highAvailabilityStatus=highAvailabilityStatus, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitAddressType=ipsReqLimitAddressType, systemFailOver=systemFailOver, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, dataPortLinkDown=dataPortLinkDown, httpProxyServerErr=httpProxyServerErr, webCacheCachedObjects=webCacheCachedObjects, ipsCookieSecPort=ipsCookieSecPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, systemFanSpeed=systemFanSpeed, tempHigh=tempHigh, switchingToMaintMode=switchingToMaintMode, linkStatus=linkStatus, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsRCTotQueued=ipsRCTotQueued, bwsMIBCompliance=bwsMIBCompliance, sslProxyActiveConn=sslProxyActiveConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrInBytes=httpSrvrInBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, serverDown=serverDown, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bws=bws, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsRCTotServed=ipsRCTotServed, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrMinResTime=sslSrvrMinResTime, firmwareStorage=firmwareStorage, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure)
