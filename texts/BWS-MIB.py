...
MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Unsigned32, Counter32, Gauge32, ModuleIdentity, IpAddress, NotificationType, Integer32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Unsigned32", "Counter32", "Gauge32", "ModuleIdentity", "IpAddress", "NotificationType", "Integer32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, cpuTemperature=cpuTemperature, sslProxyPort=sslProxyPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, activeServers=activeServers, webCacheMiss=webCacheMiss, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, activeApplications=activeApplications, bwsCacheStatsEntry=bwsCacheStatsEntry, dataPathStatus=dataPathStatus, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrInBytes=httpSrvrInBytes, ipsRCPort=ipsRCPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrPort=httpSrvrPort, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsHdrAclPort=ipsHdrAclPort, vipStatus=vipStatus, sslSrvrAddressType=sslSrvrAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bws=bws, systemFanSpeed=systemFanSpeed, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCacheReq=webCacheReq, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, linkStatus=linkStatus, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqSrvcPort=ipsReqSrvcPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyActiveConn=sslProxyActiveConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, dataPortLinkUp=dataPortLinkUp, httpProxyAddressType=httpProxyAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsCompressionStatsTable=bwsCompressionStatsTable, webCacheHits=webCacheHits, securityDefUpdates=securityDefUpdates, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, peerUp=peerUp, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormAddress=ipsUrlNormAddress, bwsMIBCompliance=bwsMIBCompliance, bwsMIBConformance=bwsMIBConformance, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsCookieSecTampered=ipsCookieSecTampered, webCacheProtocol=webCacheProtocol, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCacheAddress=webCacheAddress, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsHdrAclHits=ipsHdrAclHits, ipsUrlNormPort=ipsUrlNormPort, sslSrvrOutBytes=sslSrvrOutBytes, sslSrvrState=sslSrvrState, httpProxyWAFWarnings=httpProxyWAFWarnings, tempCritical=tempCritical, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsRCAddress=ipsRCAddress, bwstraps=bwstraps, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, systemSerialNumber=systemSerialNumber, freeMem=freeMem, memUtilization=memUtilization, logStorage=logStorage, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsMIBCompliances=bwsMIBCompliances, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, PYSNMP_MODULE_ID=bws, ipsUrlAclPort=ipsUrlAclPort, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyPort=httpProxyPort, sslProxyAddress=sslProxyAddress, sslProxyCacheMiss=sslProxyCacheMiss, webCacheAddressType=webCacheAddressType, totalMem=totalMem, httpProxyAddress=httpProxyAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrNumConn=sslSrvrNumConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCmprAddress=webCmprAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsRCAddressType=ipsRCAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serviceAddress=serviceAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, serverUp=serverUp, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, memoryUsageHigh=memoryUsageHigh, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyServerErr=httpProxyServerErr, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsCacheStatsTable=bwsCacheStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrTotTimedout=sslSrvrTotTimedout, webCacheCacheableRes=webCacheCacheableRes, switchingToInlineMode=switchingToInlineMode, ipsUrlNormAddressType=ipsUrlNormAddressType, tempHigh=tempHigh, httpSrvrState=httpSrvrState, bwsServiceStatusTable=bwsServiceStatusTable, bwsStats=bwsStats, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyUnknownRsp=httpProxyUnknownRsp, fanDead=fanDead, energizeUpdateExpire=energizeUpdateExpire, systemFailure=systemFailure, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprProtocol=webCmprProtocol, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, totalApplications=totalApplications, serviceStatus=serviceStatus, switchingToMaintMode=switchingToMaintMode, totalBandwidth=totalBandwidth, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, switchingToBypassMode=switchingToBypassMode, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsMIBGroups=bwsMIBGroups, ipsReqLimitPort=ipsReqLimitPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, highAvailabilityStatus=highAvailabilityStatus, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, operationalMode=operationalMode, ipsCookieSecPort=ipsCookieSecPort, sslProxyTotalConn=sslProxyTotalConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrInBytes=sslSrvrInBytes, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyActiveConn=httpProxyActiveConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyOutBytes=sslProxyOutBytes, httpProxyOutBytes=httpProxyOutBytes, sslProxyAddressType=sslProxyAddressType, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrTotReqActive=sslSrvrTotReqActive, systemLoad=systemLoad, httpProxyTotalReq=httpProxyTotalReq, httpProxyTotalConn=httpProxyTotalConn, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyInBytes=sslProxyInBytes, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, logStorageHigh=logStorageHigh, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsLrnSrvcPort=ipsLrnSrvcPort, cpuUtilization=cpuUtilization, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrTotRefused=sslSrvrTotRefused, ipsRCTotOutOfResource=ipsRCTotOutOfResource, smRealmName=smRealmName, sslProxyErrPms=sslProxyErrPms, servicePort=servicePort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, raidDegrading=raidDegrading, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsStatsGroup=bwsStatsGroup, bwsMessage=bwsMessage, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotQueued=ipsRCTotQueued, totalAttacks=totalAttacks, smAgentName=smAgentName, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCacheStale=webCacheStale, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyClientAbrt=httpProxyClientAbrt, webCacheBytesOut=webCacheBytesOut, httpSrvrAddress=httpSrvrAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrAddressType=httpSrvrAddressType, virusDefUpdates=virusDefUpdates)
mibBuilder.exportSymbols("BWS-MIB", bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, webCacheLongHdrs=webCacheLongHdrs, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, webCmprPort=webCmprPort, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrPort=sslSrvrPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, serverDown=serverDown, srvcName=srvcName, ipsReqLimitAddress=ipsReqLimitAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, peerDown=peerDown, dataPortLinkDown=dataPortLinkDown, httpProxyInBytes=httpProxyInBytes, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrNumConn=httpSrvrNumConn, sslProxyTotalReq=sslProxyTotalReq, ipsRCTotDropped=ipsRCTotDropped, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyParseErr=httpProxyParseErr, serviceName=serviceName, httpProxyServerReq=httpProxyServerReq, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, uptime=uptime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, firmwareStorageHigh=firmwareStorageHigh, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, totalServers=totalServers, cpuFanSpeed=cpuFanSpeed, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlAclAddress=ipsUrlAclAddress, systemFailOver=systemFailOver, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCmprAddressType=webCmprAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, currentFirmwareVersion=currentFirmwareVersion, processCountHigh=processCountHigh, firmwareStorage=firmwareStorage, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCachePort=webCachePort, bwsTrapGroup=bwsTrapGroup, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted)
