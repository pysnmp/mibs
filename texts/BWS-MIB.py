...
IpAddress, ModuleIdentity, MibIdentifier, Unsigned32, Counter32, NotificationType, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, ObjectIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Counter32", "NotificationType", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "ObjectIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, virusDefUpdates=virusDefUpdates, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpProxyAddress=httpProxyAddress, operationalMode=operationalMode, httpSrvrAddress=httpSrvrAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, smRealmName=smRealmName, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsRCTotDropped=ipsRCTotDropped, bwsCacheStatsEntry=bwsCacheStatsEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheProtocol=webCacheProtocol, systemFanSpeed=systemFanSpeed, httpProxyInBytes=httpProxyInBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, serverUp=serverUp, ipsRCTimeStamp=ipsRCTimeStamp, ipsRCTotQueued=ipsRCTotQueued, httpProxyParseErr=httpProxyParseErr, httpSrvrTotTimedout=httpSrvrTotTimedout, tempCritical=tempCritical, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyInBytes=sslProxyInBytes, totalBandwidth=totalBandwidth, sslProxyErrPms=sslProxyErrPms, bwstraps=bwstraps, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsRCAddress=ipsRCAddress, highAvailabilityStatus=highAvailabilityStatus, activeServers=activeServers, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, firmwareStorageHigh=firmwareStorageHigh, httpSrvrPort=httpSrvrPort, bwsMIBCompliances=bwsMIBCompliances, bwsSMUserSessionEntry=bwsSMUserSessionEntry, totalServers=totalServers, dataPortLinkDown=dataPortLinkDown, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrState=httpSrvrState, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, httpSrvrAddressType=httpSrvrAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheAddress=webCacheAddress, memUtilization=memUtilization, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrTotSuccess=sslSrvrTotSuccess, peerDown=peerDown, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyPort=httpProxyPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyTotalConn=httpProxyTotalConn, sslProxyOutBytes=sslProxyOutBytes, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprAddressType=webCmprAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsMessage=bwsMessage, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsCookieSecPort=ipsCookieSecPort, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, serviceAddress=serviceAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsRCTotServed=ipsRCTotServed, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrPort=sslSrvrPort, securityDefUpdates=securityDefUpdates, newAttackDefinitionInstalled=newAttackDefinitionInstalled, webCmprAddress=webCmprAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyServerErr=httpProxyServerErr, sslSrvrAddressType=sslSrvrAddressType, sslProxyAddressType=sslProxyAddressType, ipsReqLimitAddress=ipsReqLimitAddress, webCacheStale=webCacheStale, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsMIBConformance=bwsMIBConformance, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrMaxResTime=sslSrvrMaxResTime, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrTotReqRejected=sslSrvrTotReqRejected, smNumUserSessions=smNumUserSessions, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, vipStatus=vipStatus, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, activeApplications=activeApplications, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsMIBGroups=bwsMIBGroups, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, switchingToBypassMode=switchingToBypassMode, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, systemFailure=systemFailure, httpProxyClientAbrt=httpProxyClientAbrt, srvcName=srvcName, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, tempHigh=tempHigh, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyAddressType=httpProxyAddressType, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsRCAddressType=ipsRCAddressType, bwsStatsGroup=bwsStatsGroup, cpuTemperature=cpuTemperature, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlNormPort=ipsUrlNormPort, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyActiveConn=httpProxyActiveConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqSrvcAddress=ipsReqSrvcAddress, smAgentName=smAgentName, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCacheReq=webCacheReq, linkStatus=linkStatus, freeMem=freeMem, sslProxyTotalConn=sslProxyTotalConn, sslProxyBadDNCErr=sslProxyBadDNCErr, peerUp=peerUp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, uptime=uptime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyCurrentConn=sslProxyCurrentConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsReqLimitAddressType=ipsReqLimitAddressType, processCountHigh=processCountHigh, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalMem=totalMem, sslProxyActiveConn=sslProxyActiveConn, httpSrvrTotResponse=httpSrvrTotResponse, ipsAccessCtrlPort=ipsAccessCtrlPort, webCmprPort=webCmprPort, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheCachedObjects=webCacheCachedObjects, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, firmwareStorage=firmwareStorage, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, switchingToMaintMode=switchingToMaintMode, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCacheMiss=webCacheMiss, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsHdrAclPort=ipsHdrAclPort, systemFailOver=systemFailOver, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsCacheStatsTable=bwsCacheStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyCacheHits=sslProxyCacheHits, sslSrvrState=sslSrvrState, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, logStorage=logStorage, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsRCPort=ipsRCPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCachePort=webCachePort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, cpuUtilization=cpuUtilization, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, raidDegrading=raidDegrading, httpSrvrInBytes=httpSrvrInBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, serviceName=serviceName, httpSrvrTotRefused=httpSrvrTotRefused, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, serviceStatus=serviceStatus, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyAddress=sslProxyAddress, systemLoad=systemLoad, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, logStorageHigh=logStorageHigh, bwsTrapGroup=bwsTrapGroup, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable)
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, switchingToInlineMode=switchingToInlineMode, dataPortLinkUp=dataPortLinkUp, httpProxyTotalReq=httpProxyTotalReq, sslSrvrAddress=sslSrvrAddress, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, cpuFanSpeed=cpuFanSpeed, sslProxyTotalReq=sslProxyTotalReq, webCacheLongHdrs=webCacheLongHdrs, systemSerialNumber=systemSerialNumber, webCacheBytesOut=webCacheBytesOut, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsStats=bwsStats, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsMIBCompliance=bwsMIBCompliance, ipsUrlPolicyAddress=ipsUrlPolicyAddress, servicePort=servicePort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, fanDead=fanDead, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsHdrAclHits=ipsHdrAclHits, httpProxyWAFWarnings=httpProxyWAFWarnings, totalAttacks=totalAttacks, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheHits=webCacheHits, serverDown=serverDown, bws=bws, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, memoryUsageHigh=memoryUsageHigh, httpSrvrTotReqActive=httpSrvrTotReqActive, dataPathStatus=dataPathStatus, bwsServiceStatusTable=bwsServiceStatusTable, webCacheAddressType=webCacheAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, currentFirmwareVersion=currentFirmwareVersion, httpSrvrNumConn=httpSrvrNumConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsServiceStatusEntry=bwsServiceStatusEntry, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, totalApplications=totalApplications, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyServerReq=httpProxyServerReq, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, PYSNMP_MODULE_ID=bws, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyPort=sslProxyPort, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotResponse=sslSrvrTotResponse)
