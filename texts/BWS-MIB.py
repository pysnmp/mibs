...
IpAddress, Counter64, Gauge32, Counter32, ModuleIdentity, iso, Bits, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Gauge32", "Counter32", "ModuleIdentity", "iso", "Bits", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, firmwareStorage=firmwareStorage, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslProxyErrPms=sslProxyErrPms, firmwareStorageHigh=firmwareStorageHigh, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, servicePort=servicePort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrTotReqRejected=httpSrvrTotReqRejected, totalApplications=totalApplications, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, currentFirmwareVersion=currentFirmwareVersion, uptime=uptime, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, linkStatus=linkStatus, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrTotResponse=httpSrvrTotResponse, ipsRCAddress=ipsRCAddress, sslSrvrPort=sslSrvrPort, ipsReqLimitAddressType=ipsReqLimitAddressType, cpuUtilization=cpuUtilization, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsReqLimitPort=ipsReqLimitPort, webCmprProtocol=webCmprProtocol, memoryUsageHigh=memoryUsageHigh, logStorage=logStorage, bwsMIBCompliance=bwsMIBCompliance, totalServers=totalServers, httpProxyPort=httpProxyPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsHdrAclPort=ipsHdrAclPort, peerDown=peerDown, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsCacheStatsEntry=bwsCacheStatsEntry, serviceName=serviceName, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, serverDown=serverDown, virusDefUpdates=virusDefUpdates, tempCritical=tempCritical, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsRCTotDropped=ipsRCTotDropped, webCacheCacheableRes=webCacheCacheableRes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, dataPathStatus=dataPathStatus, ipsUrlNormAddressType=ipsUrlNormAddressType, smRealmName=smRealmName, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, raidDegrading=raidDegrading, webCacheAddressType=webCacheAddressType, bwsMIBConformance=bwsMIBConformance, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyServerErr=httpProxyServerErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, logStorageHigh=logStorageHigh, ipsRCTotServed=ipsRCTotServed, sslSrvrState=sslSrvrState, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyUnknownRsp=httpProxyUnknownRsp, PYSNMP_MODULE_ID=bws, totalBandwidth=totalBandwidth, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyPort=sslProxyPort, ipsUrlNormPort=ipsUrlNormPort, srvcName=srvcName, vipStatus=vipStatus, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrNumConn=httpSrvrNumConn, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyParseErr=httpProxyParseErr, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecAddress=ipsCookieSecAddress, bwsMIBCompliances=bwsMIBCompliances, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyOutBytes=httpProxyOutBytes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCacheCachedObjects=webCacheCachedObjects, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, operationalMode=operationalMode, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyClientAbrt=httpProxyClientAbrt, activeApplications=activeApplications, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprAddress=webCmprAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, totalMem=totalMem, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslProxyAddress=sslProxyAddress, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheAddress=webCacheAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCachePort=webCachePort, totalAttacks=totalAttacks, httpProxyServerReq=httpProxyServerReq, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyActiveConn=sslProxyActiveConn, systemSerialNumber=systemSerialNumber, httpSrvrInBytes=httpSrvrInBytes, ipsCookieSecTampered=ipsCookieSecTampered, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsHdrAclHits=ipsHdrAclHits, webCmprPort=webCmprPort, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bws=bws, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrTotRefused=sslSrvrTotRefused, webCacheReq=webCacheReq, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, smNumUserSessions=smNumUserSessions, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyAddressType=httpProxyAddressType, memUtilization=memUtilization, ipsRCAddressType=ipsRCAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, serviceAddress=serviceAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyAddressType=sslProxyAddressType, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsRCPort=ipsRCPort, processCountHigh=processCountHigh, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, webCmprCompressedDataSize=webCmprCompressedDataSize, systemFanSpeed=systemFanSpeed, httpSrvrMinResTime=httpSrvrMinResTime, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, tempHigh=tempHigh, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyTotalReq=httpProxyTotalReq, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, serviceStatus=serviceStatus, sslProxyTotalConn=sslProxyTotalConn, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumConn=sslSrvrNumConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrAddressType=sslSrvrAddressType, ipsUrlAclReserved=ipsUrlAclReserved, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlPort=ipsAccessCtrlPort, activeServers=activeServers, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsRCStatsTable=bwsIpsRCStatsTable, cpuTemperature=cpuTemperature, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, switchingToInlineMode=switchingToInlineMode, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrTotResponse=sslSrvrTotResponse, highAvailabilityStatus=highAvailabilityStatus, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyCacheMiss=sslProxyCacheMiss, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsStatsGroup=bwsStatsGroup, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrOutBytes=sslSrvrOutBytes, webCacheMiss=webCacheMiss, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpSrvrPort=httpSrvrPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrAddress=httpSrvrAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyActiveConn=httpProxyActiveConn, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrAddress=sslSrvrAddress, httpProxyAddress=httpProxyAddress, bwsTrapGroup=bwsTrapGroup, sslProxyTotalReq=sslProxyTotalReq, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheBytesOut=webCacheBytesOut, bwsMessage=bwsMessage, firmwareUpdateAvailable=firmwareUpdateAvailable, systemFailOver=systemFailOver, sslSrvrTotSuccess=sslSrvrTotSuccess, peerUp=peerUp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCacheProtocol=webCacheProtocol, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp)
mibBuilder.exportSymbols("BWS-MIB", securityDefUpdates=securityDefUpdates, ipsCookieSecPort=ipsCookieSecPort, freeMem=freeMem, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, webCacheLongHdrs=webCacheLongHdrs, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheStale=webCacheStale, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrOutBytes=httpSrvrOutBytes, fanDead=fanDead, switchingToMaintMode=switchingToMaintMode, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsServiceStatusTable=bwsServiceStatusTable, smAgentName=smAgentName, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, systemLoad=systemLoad, bwsStats=bwsStats, httpSrvrTotRefused=httpSrvrTotRefused, webCmprAddressType=webCmprAddressType, bwstraps=bwstraps, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyInBytes=sslProxyInBytes, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, dataPortLinkUp=dataPortLinkUp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, httpProxyInBytes=httpProxyInBytes, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclAddress=ipsUrlAclAddress, bwsMIBGroups=bwsMIBGroups, dataPortLinkDown=dataPortLinkDown, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, systemFailure=systemFailure, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsCompressionStatsTable=bwsCompressionStatsTable, sslProxyCacheHits=sslProxyCacheHits, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, webCacheHits=webCacheHits, httpSrvrState=httpSrvrState, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, switchingToBypassMode=switchingToBypassMode, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, cpuFanSpeed=cpuFanSpeed, serverUp=serverUp)
