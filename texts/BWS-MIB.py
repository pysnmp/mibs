...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, IpAddress, iso, MibIdentifier, Bits, Unsigned32, Counter32, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "IpAddress", "iso", "MibIdentifier", "Bits", "Unsigned32", "Counter32", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsCookieSecPort=ipsCookieSecPort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsMIBCompliances=bwsMIBCompliances, memoryUsageHigh=memoryUsageHigh, PYSNMP_MODULE_ID=bws, sslProxyInBytes=sslProxyInBytes, tempCritical=tempCritical, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyParseErr=httpProxyParseErr, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, securityDefUpdates=securityDefUpdates, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqSrvcAddress=ipsReqSrvcAddress, energizeUpdateExpire=energizeUpdateExpire, raidDegrading=raidDegrading, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheCacheableRes=webCacheCacheableRes, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, dataPortLinkUp=dataPortLinkUp, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyTotalConn=httpProxyTotalConn, cpuTemperature=cpuTemperature, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrSrvcPort=httpSrvrSrvcPort, totalBandwidth=totalBandwidth, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrNumConn=sslSrvrNumConn, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, peerUp=peerUp, firmwareStorage=firmwareStorage, tempHigh=tempHigh, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyAddressType=sslProxyAddressType, systemLoad=systemLoad, bwsCacheStatsEntry=bwsCacheStatsEntry, webCacheBytesOut=webCacheBytesOut, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrAvgResTime=sslSrvrAvgResTime, serviceName=serviceName, sslSrvrOutBytes=sslSrvrOutBytes, sslProxyActiveConn=sslProxyActiveConn, webCmprAddressType=webCmprAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyServerReq=httpProxyServerReq, ipsRCAddressType=ipsRCAddressType, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrAddress=sslSrvrAddress, sslProxyTotalReq=sslProxyTotalReq, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitPort=ipsReqLimitPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsStatsGroup=bwsStatsGroup, sslSrvrSrvcPort=sslSrvrSrvcPort, uptime=uptime, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlNormAddress=ipsUrlNormAddress, cpuFanSpeed=cpuFanSpeed, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsStats=bwsStats, ipsRCTimeStamp=ipsRCTimeStamp, ipsRCTotServed=ipsRCTotServed, webCacheLongHdrs=webCacheLongHdrs, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrTotReqRejected=sslSrvrTotReqRejected, dataPathStatus=dataPathStatus, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrPort=sslSrvrPort, webCacheReq=webCacheReq, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecAddress=ipsCookieSecAddress, smNumUserSessions=smNumUserSessions, ipsHdrAclPort=ipsHdrAclPort, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyOutBytes=httpProxyOutBytes, totalApplications=totalApplications, bwsMessage=bwsMessage, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, logStorage=logStorage, httpSrvrTotResponse=httpSrvrTotResponse, serviceStatus=serviceStatus, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCachePort=webCachePort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, freeMem=freeMem, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, linkStatus=linkStatus, sslSrvrState=sslSrvrState, systemFailure=systemFailure, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, serviceAddress=serviceAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, activeServers=activeServers, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, serverUp=serverUp, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrAddressType=httpSrvrAddressType, webCacheStale=webCacheStale, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrAddress=httpSrvrAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, virusDefUpdates=virusDefUpdates, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, operationalMode=operationalMode, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, logStorageHigh=logStorageHigh, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclPort=ipsUrlAclPort, totalMem=totalMem, httpProxyAddress=httpProxyAddress, bwsCacheStatsTable=bwsCacheStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, systemSerialNumber=systemSerialNumber, switchingToMaintMode=switchingToMaintMode, httpProxyWAFWarnings=httpProxyWAFWarnings, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, serverDown=serverDown, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyCacheHits=sslProxyCacheHits, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrInBytes=httpSrvrInBytes, sslProxyTotalConn=sslProxyTotalConn, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCTotQueued=ipsRCTotQueued, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyPort=httpProxyPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyServerErr=httpProxyServerErr, srvcName=srvcName, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, processCountHigh=processCountHigh, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyInBytes=httpProxyInBytes, webCmprPort=webCmprPort, sslSrvrTotRefused=sslSrvrTotRefused, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, highAvailabilityStatus=highAvailabilityStatus, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyCurrentConn=sslProxyCurrentConn, cpuUtilization=cpuUtilization, httpSrvrPort=httpSrvrPort, httpProxyAddressType=httpProxyAddressType, memUtilization=memUtilization, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, systemFanSpeed=systemFanSpeed, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, webCmprProtocol=webCmprProtocol, webCacheProtocol=webCacheProtocol, firmwareStorageHigh=firmwareStorageHigh, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsRCPort=ipsRCPort, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyTotalReq=httpProxyTotalReq, bwstraps=bwstraps, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheAddress=webCacheAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyErrPms=sslProxyErrPms, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslProxyAddress=sslProxyAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecTampered=ipsCookieSecTampered, webCacheCachedObjects=webCacheCachedObjects, ipsRCAddress=ipsRCAddress, totalAttacks=totalAttacks, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsHdrAclHits=ipsHdrAclHits, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrAddressType=sslSrvrAddressType, activeApplications=activeApplications, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled)
mibBuilder.exportSymbols("BWS-MIB", sslProxyOutBytes=sslProxyOutBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCacheMiss=webCacheMiss, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrNumConn=httpSrvrNumConn, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyPort=sslProxyPort, bws=bws, httpSrvrState=httpSrvrState, servicePort=servicePort, currentFirmwareVersion=currentFirmwareVersion, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsMIBGroups=bwsMIBGroups, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormAddressType=ipsUrlNormAddressType, smAgentName=smAgentName, sslSrvrSrvcAddress=sslSrvrSrvcAddress, totalServers=totalServers, bwsServiceStatusTable=bwsServiceStatusTable, bwsMIBCompliance=bwsMIBCompliance, httpProxyClientAbrt=httpProxyClientAbrt, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrTotResponse=sslSrvrTotResponse, webCmprAddress=webCmprAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, peerDown=peerDown, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, fanDead=fanDead, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheHits=webCacheHits, smRealmName=smRealmName, switchingToInlineMode=switchingToInlineMode, httpSrvrMaxResTime=httpSrvrMaxResTime, vipStatus=vipStatus, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, dataPortLinkDown=dataPortLinkDown, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsTrapGroup=bwsTrapGroup, sharedSecretKeyExpired=sharedSecretKeyExpired, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheAddressType=webCacheAddressType, sslSrvrInBytes=sslSrvrInBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, systemFailOver=systemFailOver, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrMinResTime=httpSrvrMinResTime)
