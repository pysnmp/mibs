...
Unsigned32, Bits, IpAddress, TimeTicks, Gauge32, Integer32, ModuleIdentity, ObjectIdentity, iso, MibIdentifier, Counter32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "IpAddress", "TimeTicks", "Gauge32", "Integer32", "ModuleIdentity", "ObjectIdentity", "iso", "MibIdentifier", "Counter32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyCurrentConn=sslProxyCurrentConn, tempHigh=tempHigh, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyTotalReq=sslProxyTotalReq, tempCritical=tempCritical, bwsMIBGroups=bwsMIBGroups, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsMIBConformance=bwsMIBConformance, ipsRCAddress=ipsRCAddress, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, uptime=uptime, httpProxyAddressType=httpProxyAddressType, sslProxyPort=sslProxyPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsTrapGroup=bwsTrapGroup, webCacheAddressType=webCacheAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrPort=httpSrvrPort, currentFirmwareVersion=currentFirmwareVersion, ipsHdrAclPort=ipsHdrAclPort, httpProxyServerErr=httpProxyServerErr, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsStatsGroup=bwsStatsGroup, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsCacheStatsTable=bwsCacheStatsTable, fanDead=fanDead, ipsUrlAclAddressType=ipsUrlAclAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyAddressType=sslProxyAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyTotalReq=httpProxyTotalReq, serverUp=serverUp, peerUp=peerUp, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsMIBCompliance=bwsMIBCompliance, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyParseErr=httpProxyParseErr, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, virusDefUpdates=virusDefUpdates, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, serviceStatus=serviceStatus, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCmprPort=webCmprPort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCmprAddress=webCmprAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecPort=ipsCookieSecPort, webCmprProtocol=webCmprProtocol, vipStatus=vipStatus, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, logStorage=logStorage, sslSrvrTotSuccess=sslSrvrTotSuccess, cpuTemperature=cpuTemperature, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsRCAddressType=ipsRCAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, dataPortLinkDown=dataPortLinkDown, webCacheLongHdrs=webCacheLongHdrs, sslProxyOutBytes=sslProxyOutBytes, httpSrvrAddressType=httpSrvrAddressType, energizeUpdateExpire=energizeUpdateExpire, ipsRCPort=ipsRCPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, highAvailabilityStatus=highAvailabilityStatus, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrNumConn=httpSrvrNumConn, ipsLrnSrvcPort=ipsLrnSrvcPort, memUtilization=memUtilization, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheProtocol=webCacheProtocol, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyActiveConn=httpProxyActiveConn, serverDown=serverDown, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyServerReq=httpProxyServerReq, webCacheCachedObjects=webCacheCachedObjects, switchingToMaintMode=switchingToMaintMode, smAgentName=smAgentName, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyTotalConn=httpProxyTotalConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCacheStale=webCacheStale, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCmprAddressType=webCmprAddressType, bwstraps=bwstraps, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bws=bws, webCacheMiss=webCacheMiss, sslSrvrTotRefused=sslSrvrTotRefused, webCacheHits=webCacheHits, webCacheAddress=webCacheAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecTampered=ipsCookieSecTampered, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, raidDegrading=raidDegrading, httpSrvrOutBytes=httpSrvrOutBytes, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, serviceAddress=serviceAddress, sslProxyErrPms=sslProxyErrPms, servicePort=servicePort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrMaxResTime=httpSrvrMaxResTime, smRealmName=smRealmName, cpuUtilization=cpuUtilization, httpSrvrState=httpSrvrState, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyAddress=sslProxyAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrMinResTime=httpSrvrMinResTime, activeServers=activeServers, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, ipsRCTotServed=ipsRCTotServed, sslSrvrNumConn=sslSrvrNumConn, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsMIBCompliances=bwsMIBCompliances, totalAttacks=totalAttacks, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCacheBytesOut=webCacheBytesOut, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToBypassMode=switchingToBypassMode, bwsMessage=bwsMessage, bwsStats=bwsStats, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, switchingToInlineMode=switchingToInlineMode, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrState=sslSrvrState, totalServers=totalServers, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrAddressType=sslSrvrAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsSMUserSessionTable=bwsSMUserSessionTable, totalMem=totalMem, ipsReqSrvcAddress=ipsReqSrvcAddress, totalApplications=totalApplications, ipsUrlPolicyPort=ipsUrlPolicyPort, memoryUsageHigh=memoryUsageHigh, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, systemLoad=systemLoad, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, logStorageHigh=logStorageHigh, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheReq=webCacheReq, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsRCTotQueued=ipsRCTotQueued, ipsRCTotOutOfResource=ipsRCTotOutOfResource, systemSerialNumber=systemSerialNumber, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyBadCRLErr=sslProxyBadCRLErr, PYSNMP_MODULE_ID=bws, sslProxyInBytes=sslProxyInBytes, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrAddress=sslSrvrAddress, securityDefUpdates=securityDefUpdates, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyAddress=httpProxyAddress, ipsCookieSecAddress=ipsCookieSecAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, systemFailure=systemFailure, ipsCookieSecAddressType=ipsCookieSecAddressType, operationalMode=operationalMode, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, linkStatus=linkStatus, sslSrvrInBytes=sslSrvrInBytes, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpSrvrAddress=httpSrvrAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyPort=httpProxyPort)
mibBuilder.exportSymbols("BWS-MIB", activeApplications=activeApplications, smNumUserSessions=smNumUserSessions, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, totalBandwidth=totalBandwidth, serviceName=serviceName, ipsHdrAclHits=ipsHdrAclHits, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, systemFailOver=systemFailOver, httpProxyClientAbrt=httpProxyClientAbrt, srvcName=srvcName, dataPortLinkUp=dataPortLinkUp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrPort=sslSrvrPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlNormPort=ipsUrlNormPort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqLimitAddress=ipsReqLimitAddress, firmwareStorage=firmwareStorage, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, systemFanSpeed=systemFanSpeed, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsReqSrvcPort=ipsReqSrvcPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrTotReqRejected=sslSrvrTotReqRejected, dataPathStatus=dataPathStatus, webCachePort=webCachePort, processCountHigh=processCountHigh, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrInBytes=httpSrvrInBytes, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransPort=ipsWebAddrTransPort, peerDown=peerDown, webCacheCacheableRes=webCacheCacheableRes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, freeMem=freeMem, sslProxyCacheMiss=sslProxyCacheMiss, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitPort=ipsReqLimitPort, cpuFanSpeed=cpuFanSpeed, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrTotReqActive=httpSrvrTotReqActive, firmwareStorageHigh=firmwareStorageHigh)
