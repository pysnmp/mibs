...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, IpAddress, Integer32, NotificationType, Gauge32, MibIdentifier, Counter32, ModuleIdentity, Unsigned32, iso, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "IpAddress", "Integer32", "NotificationType", "Gauge32", "MibIdentifier", "Counter32", "ModuleIdentity", "Unsigned32", "iso", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, switchingToBypassMode=switchingToBypassMode, activeApplications=activeApplications, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpProxyParseErr=httpProxyParseErr, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, virusDefUpdates=virusDefUpdates, webCacheHits=webCacheHits, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrAddressType=httpSrvrAddressType, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCachePort=webCachePort, httpSrvrTotReqActive=httpSrvrTotReqActive, webCmprPort=webCmprPort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlAclPort=ipsUrlAclPort, peerUp=peerUp, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, srvcName=srvcName, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, systemLoad=systemLoad, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrNumConn=httpSrvrNumConn, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyPort=sslProxyPort, dataPortLinkDown=dataPortLinkDown, webCacheProtocol=webCacheProtocol, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsRCTimeStamp=ipsRCTimeStamp, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormPort=ipsUrlNormPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, PYSNMP_MODULE_ID=bws, bwsServiceStatusTable=bwsServiceStatusTable, smRealmName=smRealmName, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyOutBytes=httpProxyOutBytes, sslSrvrAddress=sslSrvrAddress, sslSrvrMinResTime=sslSrvrMinResTime, ipsRCAddressType=ipsRCAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyOutBytes=sslProxyOutBytes, sslProxyCacheHits=sslProxyCacheHits, httpSrvrState=httpSrvrState, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, totalAttacks=totalAttacks, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCmprAddress=webCmprAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCTotDropped=ipsRCTotDropped, bwsMIBCompliances=bwsMIBCompliances, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrInBytes=httpSrvrInBytes, tempHigh=tempHigh, httpSrvrMinResTime=httpSrvrMinResTime, activeServers=activeServers, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsMessage=bwsMessage, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, freeMem=freeMem, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, webCacheBytesOut=webCacheBytesOut, httpProxyAddressType=httpProxyAddressType, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyServerErr=httpProxyServerErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyTotalConn=sslProxyTotalConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyActiveConn=sslProxyActiveConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, memoryUsageHigh=memoryUsageHigh, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyWAFWarnings=httpProxyWAFWarnings, bwstraps=bwstraps, webCmprCompressedDataSize=webCmprCompressedDataSize, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCmprAddressType=webCmprAddressType, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyInBytes=httpProxyInBytes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyCurrentConn=sslProxyCurrentConn, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, totalApplications=totalApplications, ipsRCTotQueued=ipsRCTotQueued, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyServerReq=httpProxyServerReq, ipsUrlNormAddress=ipsUrlNormAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrOutBytes=sslSrvrOutBytes, processCountHigh=processCountHigh, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotResponse=httpSrvrTotResponse, highAvailabilityStatus=highAvailabilityStatus, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsRCPort=ipsRCPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCacheStale=webCacheStale, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheCacheableRes=webCacheCacheableRes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, systemFanSpeed=systemFanSpeed, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyErrPms=sslProxyErrPms, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsStats=bwsStats, bwsTrapGroup=bwsTrapGroup, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, operationalMode=operationalMode, webCmprProtocol=webCmprProtocol, serverUp=serverUp, cpuUtilization=cpuUtilization, dataPathStatus=dataPathStatus, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlAclReserved=ipsUrlAclReserved, ipsHdrAclAddress=ipsHdrAclAddress, dataPortLinkUp=dataPortLinkUp, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyPort=httpProxyPort, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyTotalReq=httpProxyTotalReq, serviceName=serviceName, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyClientAbrt=httpProxyClientAbrt, webCacheLongHdrs=webCacheLongHdrs, sslProxyInBytes=sslProxyInBytes, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheMiss=webCacheMiss, webCacheCachedObjects=webCacheCachedObjects, systemSerialNumber=systemSerialNumber, bws=bws, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsCookieSecAddress=ipsCookieSecAddress, firmwareStorageHigh=firmwareStorageHigh, firmwareStorage=firmwareStorage, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrPort=httpSrvrPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, totalServers=totalServers, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsHdrAclHits=ipsHdrAclHits, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsStatsGroup=bwsStatsGroup, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsHdrAclPort=ipsHdrAclPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrState=sslSrvrState, bwsCacheStatsEntry=bwsCacheStatsEntry, logStorageHigh=logStorageHigh, httpProxyTotalConn=httpProxyTotalConn, ipsUrlAclAddressType=ipsUrlAclAddressType, fanDead=fanDead, vipStatus=vipStatus, smNumUserSessions=smNumUserSessions, webCacheAddress=webCacheAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, cpuFanSpeed=cpuFanSpeed, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, memUtilization=memUtilization, servicePort=servicePort, sharedSecretKeyExpired=sharedSecretKeyExpired, switchingToMaintMode=switchingToMaintMode, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrNumConn=sslSrvrNumConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable)
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyServerAbrt=httpProxyServerAbrt, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrPort=sslSrvrPort, systemFailOver=systemFailOver, systemFailure=systemFailure, totalMem=totalMem, webCacheReq=webCacheReq, ipsRCTotServed=ipsRCTotServed, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsMIBCompliance=bwsMIBCompliance, ipsRCAddress=ipsRCAddress, sslProxyTotalReq=sslProxyTotalReq, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqLimitPort=ipsReqLimitPort, bwsServiceStatusEntry=bwsServiceStatusEntry, securityDefUpdates=securityDefUpdates, energizeUpdateExpire=energizeUpdateExpire, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrAddressType=sslSrvrAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, serviceStatus=serviceStatus, tempCritical=tempCritical, totalBandwidth=totalBandwidth, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrAddress=httpSrvrAddress, bwsMIBGroups=bwsMIBGroups, raidDegrading=raidDegrading, linkStatus=linkStatus, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyActiveConn=httpProxyActiveConn, serverDown=serverDown, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyAddress=sslProxyAddress, logStorage=logStorage, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, currentFirmwareVersion=currentFirmwareVersion, cpuTemperature=cpuTemperature, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrSrvcPort=httpSrvrSrvcPort, smAgentName=smAgentName, sslProxyAddressType=sslProxyAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, peerDown=peerDown, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, serviceAddress=serviceAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, uptime=uptime, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrTotRefused=sslSrvrTotRefused, webCacheAddressType=webCacheAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth)
