...
Bits, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, NotificationType, Gauge32, IpAddress, ModuleIdentity, Counter64, Integer32, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "NotificationType", "Gauge32", "IpAddress", "ModuleIdentity", "Counter64", "Integer32", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, serviceName=serviceName, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrInBytes=sslSrvrInBytes, ipsCookieSecTampered=ipsCookieSecTampered, httpProxyOutBytes=httpProxyOutBytes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsCacheStatsTable=bwsCacheStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, cpuTemperature=cpuTemperature, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyPort=httpProxyPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyAddress=sslProxyAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyServerAbrt=httpProxyServerAbrt, energizeUpdateExpire=energizeUpdateExpire, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsHdrAclHits=ipsHdrAclHits, operationalMode=operationalMode, bwsMIBConformance=bwsMIBConformance, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrState=httpSrvrState, cpuFanSpeed=cpuFanSpeed, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslSrvrMinResTime=sslSrvrMinResTime, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, firmwareStorageHigh=firmwareStorageHigh, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, tempHigh=tempHigh, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, serviceAddress=serviceAddress, smAgentName=smAgentName, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyAddressType=sslProxyAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, webCmprCompressibleDataSize=webCmprCompressibleDataSize, systemLoad=systemLoad, webCacheCachedObjects=webCacheCachedObjects, httpProxyParseErr=httpProxyParseErr, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsStats=bwsStats, smNumUserSessions=smNumUserSessions, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, systemSerialNumber=systemSerialNumber, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrPort=httpSrvrPort, httpProxyTotalReq=httpProxyTotalReq, fanDead=fanDead, sslSrvrTotSuccess=sslSrvrTotSuccess, totalApplications=totalApplications, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrState=sslSrvrState, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrTotTimedout=httpSrvrTotTimedout, logStorage=logStorage, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, logStorageHigh=logStorageHigh, switchingToInlineMode=switchingToInlineMode, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyInBytes=httpProxyInBytes, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, dataPathStatus=dataPathStatus, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, webCmprAddress=webCmprAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrSrvcPort=sslSrvrSrvcPort, webCacheMiss=webCacheMiss, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclAddressType=ipsUrlAclAddressType, webCacheProtocol=webCacheProtocol, serviceStatus=serviceStatus, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, smRealmName=smRealmName, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, PYSNMP_MODULE_ID=bws, uptime=uptime, sslProxyTotalConn=sslProxyTotalConn, ipsUrlPolicyPort=ipsUrlPolicyPort, bwstraps=bwstraps, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrPort=sslSrvrPort, totalServers=totalServers, httpSrvrAvgResTime=httpSrvrAvgResTime, httpSrvrAddressType=httpSrvrAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsHdrAclPort=ipsHdrAclPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCAddressType=ipsRCAddressType, webCmprProtocol=webCmprProtocol, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsServiceStatusTable=bwsServiceStatusTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, dataPortLinkDown=dataPortLinkDown, peerUp=peerUp, peerDown=peerDown, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrNumConn=httpSrvrNumConn, highAvailabilityStatus=highAvailabilityStatus, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsRCTotDropped=ipsRCTotDropped, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, securityDefUpdates=securityDefUpdates, ipsUrlAclPort=ipsUrlAclPort, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpProxyTotalConn=httpProxyTotalConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCachePort=webCachePort, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemFanSpeed=systemFanSpeed, sslProxyCurrentConn=sslProxyCurrentConn, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsRCAddress=ipsRCAddress, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyCacheHits=sslProxyCacheHits, sslProxyTotalReq=sslProxyTotalReq, systemFailOver=systemFailOver, switchingToBypassMode=switchingToBypassMode, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyAddress=httpProxyAddress, sslSrvrAddress=sslSrvrAddress, webCacheCacheableRes=webCacheCacheableRes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsMessage=bwsMessage, vipStatus=vipStatus, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, raidDegrading=raidDegrading, ipsLrnSrvcPort=ipsLrnSrvcPort, bws=bws, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyPort=sslProxyPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, tempCritical=tempCritical, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheAddress=webCacheAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, linkStatus=linkStatus, totalBandwidth=totalBandwidth, dataPortLinkUp=dataPortLinkUp, httpProxyActiveConn=httpProxyActiveConn, webCacheAddressType=webCacheAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqSrvcAddressType=ipsReqSrvcAddressType, switchingToMaintMode=switchingToMaintMode, httpSrvrOutBytes=httpSrvrOutBytes, systemFailure=systemFailure, httpSrvrInBytes=httpSrvrInBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, freeMem=freeMem, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCacheStale=webCacheStale, processCountHigh=processCountHigh, servicePort=servicePort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheBytesOut=webCacheBytesOut, sslProxyErrPms=sslProxyErrPms, ipsRCTotQueued=ipsRCTotQueued, activeApplications=activeApplications, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrAddress=httpSrvrAddress, httpSrvrTotRefused=httpSrvrTotRefused, sslSrvrNumConn=sslSrvrNumConn, totalAttacks=totalAttacks, webCmprAddressType=webCmprAddressType, bwsMIBCompliances=bwsMIBCompliances, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyAddressType=httpProxyAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheReq=webCacheReq, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue)
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, memUtilization=memUtilization, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, totalMem=totalMem, sslSrvrOutBytes=sslSrvrOutBytes, virusDefUpdates=virusDefUpdates, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyInBytes=sslProxyInBytes, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyServerReq=httpProxyServerReq, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, cpuUtilization=cpuUtilization, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsStatsGroup=bwsStatsGroup, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsTrapGroup=bwsTrapGroup, webCmprCompressedDataSize=webCmprCompressedDataSize, serverUp=serverUp, ipsReqLimitAddress=ipsReqLimitAddress, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyServerErr=httpProxyServerErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsHdrAclAddress=ipsHdrAclAddress, ipsRCTotServed=ipsRCTotServed, currentFirmwareVersion=currentFirmwareVersion, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransPort=ipsWebAddrTransPort, activeServers=activeServers, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, firmwareStorage=firmwareStorage, sslSrvrMaxResTime=sslSrvrMaxResTime, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrTotReqRejected=sslSrvrTotReqRejected, srvcName=srvcName, bwsMIBGroups=bwsMIBGroups, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheHits=webCacheHits, ipsRCPort=ipsRCPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, webCmprPort=webCmprPort, sslSrvrAddressType=sslSrvrAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyOutBytes=sslProxyOutBytes, bwsMIBCompliance=bwsMIBCompliance, serverDown=serverDown)
