...
mibBuilder.exportSymbols("BWS-MIB", httpProxyInBytes=httpProxyInBytes, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlAclReserved=ipsUrlAclReserved, securityDefUpdates=securityDefUpdates, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, operationalMode=operationalMode, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitAddress=ipsReqLimitAddress, webCacheBytesOut=webCacheBytesOut, ipsHdrAclAddress=ipsHdrAclAddress, webCachePort=webCachePort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, totalMem=totalMem, cpuTemperature=cpuTemperature, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecPort=ipsCookieSecPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, srvcName=srvcName, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyActiveConn=httpProxyActiveConn, webCacheHits=webCacheHits, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrMinResTime=sslSrvrMinResTime, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCTotServed=ipsRCTotServed, virusDefUpdates=virusDefUpdates, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, switchingToInlineMode=switchingToInlineMode, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrAddressType=httpSrvrAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCacheAddress=webCacheAddress, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, raidDegrading=raidDegrading, smRealmName=smRealmName, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, logStorage=logStorage, ipsRCTotOutOfResource=ipsRCTotOutOfResource, systemLoad=systemLoad, freeMem=freeMem, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsRCAddress=ipsRCAddress, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyPort=httpProxyPort, logStorageHigh=logStorageHigh, ipsHdrAclHits=ipsHdrAclHits, fanDead=fanDead, httpSrvrSrvcPort=httpSrvrSrvcPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrState=httpSrvrState, serviceStatus=serviceStatus, httpProxyServerErr=httpProxyServerErr, bws=bws, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrTotRefused=sslSrvrTotRefused, highAvailabilityStatus=highAvailabilityStatus, bwsMessage=bwsMessage, peerDown=peerDown, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyInBytes=sslProxyInBytes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, webCmprAddress=webCmprAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwstraps=bwstraps, bwsMIBGroups=bwsMIBGroups, newAttackDefinitionInstalled=newAttackDefinitionInstalled, memUtilization=memUtilization, totalServers=totalServers, PYSNMP_MODULE_ID=bws, httpProxyAddress=httpProxyAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrMaxResTime=httpSrvrMaxResTime, serviceName=serviceName, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, activeServers=activeServers, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpProxyClientAbrt=httpProxyClientAbrt, energizeUpdateExpire=energizeUpdateExpire, webCmprPort=webCmprPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrOutBytes=sslSrvrOutBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, webCacheReq=webCacheReq, peerUp=peerUp, ipsReqLimitPort=ipsReqLimitPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsHdrAclPort=ipsHdrAclPort, systemSerialNumber=systemSerialNumber, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheAddressType=webCacheAddressType, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, systemFanSpeed=systemFanSpeed, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, memoryUsageHigh=memoryUsageHigh, bwsMIBCompliances=bwsMIBCompliances, httpSrvrTotRefused=httpSrvrTotRefused, processCountHigh=processCountHigh, firmwareStorageHigh=firmwareStorageHigh, sslProxyErrPms=sslProxyErrPms, totalApplications=totalApplications, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, smNumUserSessions=smNumUserSessions, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsMIBConformance=bwsMIBConformance, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyParseErr=httpProxyParseErr, ipsRCPort=ipsRCPort, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotResponse=httpSrvrTotResponse, totalAttacks=totalAttacks, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrMaxResTime=sslSrvrMaxResTime, systemFailOver=systemFailOver, sslProxyActiveConn=sslProxyActiveConn, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyTotalConn=httpProxyTotalConn, smAgentName=smAgentName, httpProxyTotalReq=httpProxyTotalReq, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyAddressType=httpProxyAddressType, sslSrvrSrvcAddress=sslSrvrSrvcAddress, bwsTrapGroup=bwsTrapGroup, servicePort=servicePort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsRCAddressType=ipsRCAddressType, httpProxyServerReq=httpProxyServerReq, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, activeApplications=activeApplications, webCacheLongHdrs=webCacheLongHdrs, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecAddress=ipsCookieSecAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsMIBCompliance=bwsMIBCompliance, httpSrvrInBytes=httpSrvrInBytes, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrNumConn=httpSrvrNumConn, sslProxyPort=sslProxyPort, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, dataPathStatus=dataPathStatus, sslProxyCacheHits=sslProxyCacheHits, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrPort=sslSrvrPort, bwsStats=bwsStats, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, dataPortLinkUp=dataPortLinkUp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, systemFailure=systemFailure, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsHdrAclAddressType=ipsHdrAclAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable)
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCmprAddressType=webCmprAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlNormAddress=ipsUrlNormAddress, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyAddress=sslProxyAddress, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyAddressType=sslProxyAddressType, httpSrvrPort=httpSrvrPort, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyServerAbrt=httpProxyServerAbrt, totalBandwidth=totalBandwidth, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheCachedObjects=webCacheCachedObjects, ipsUrlNormPort=ipsUrlNormPort, serverUp=serverUp, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCacheCacheableRes=webCacheCacheableRes, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrState=sslSrvrState, uptime=uptime, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, switchingToMaintMode=switchingToMaintMode, webCmprCompressibleDataSize=webCmprCompressibleDataSize, serviceAddress=serviceAddress, currentFirmwareVersion=currentFirmwareVersion, cpuFanSpeed=cpuFanSpeed, sslSrvrAddressType=sslSrvrAddressType, httpProxyOutBytes=httpProxyOutBytes, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyCacheTimeouts=sslProxyCacheTimeouts, serverDown=serverDown, sslSrvrInBytes=sslSrvrInBytes, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrAddress=sslSrvrAddress, dataPortLinkDown=dataPortLinkDown, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, webCacheMiss=webCacheMiss, webCacheStale=webCacheStale, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, firmwareStorage=firmwareStorage, sslProxyTotalConn=sslProxyTotalConn, tempCritical=tempCritical, vipStatus=vipStatus, bwsStatsGroup=bwsStatsGroup, sslSrvrNumConn=sslSrvrNumConn, ipsRCTotDropped=ipsRCTotDropped, switchingToBypassMode=switchingToBypassMode, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, linkStatus=linkStatus, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheProtocol=webCacheProtocol, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, tempHigh=tempHigh, cpuUtilization=cpuUtilization, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCmprProtocol=webCmprProtocol)
