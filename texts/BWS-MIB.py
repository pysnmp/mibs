...
iso, ModuleIdentity, Bits, Integer32, Gauge32, ObjectIdentity, IpAddress, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Bits", "Integer32", "Gauge32", "ObjectIdentity", "IpAddress", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotResponse=httpSrvrTotResponse, smRealmName=smRealmName, cpuUtilization=cpuUtilization, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqLimitAddress=ipsReqLimitAddress, webCacheLongHdrs=webCacheLongHdrs, httpProxyAddressType=httpProxyAddressType, httpProxyInBytes=httpProxyInBytes, smNumUserSessions=smNumUserSessions, operationalMode=operationalMode, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, logStorage=logStorage, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, serviceAddress=serviceAddress, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyPort=sslProxyPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyTotalReq=httpProxyTotalReq, httpSrvrInBytes=httpSrvrInBytes, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslProxyErrPms=sslProxyErrPms, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyOutBytes=sslProxyOutBytes, ipsRCTotDropped=ipsRCTotDropped, tempCritical=tempCritical, webCmprPort=webCmprPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCAddress=ipsRCAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, PYSNMP_MODULE_ID=bws, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, linkStatus=linkStatus, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsMIBCompliances=bwsMIBCompliances, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCmprProtocol=webCmprProtocol, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, switchingToBypassMode=switchingToBypassMode, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsCookieSecAddressType=ipsCookieSecAddressType, servicePort=servicePort, switchingToInlineMode=switchingToInlineMode, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrState=sslSrvrState, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, peerDown=peerDown, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsRCAddressType=ipsRCAddressType, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsHdrAclHits=ipsHdrAclHits, sslSrvrTotTimedout=sslSrvrTotTimedout, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, sslSrvrAddressType=sslSrvrAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAddress=sslProxyAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprAddressType=webCmprAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, webCacheHits=webCacheHits, tempHigh=tempHigh, sslProxyInBytes=sslProxyInBytes, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrTotResponse=sslSrvrTotResponse, sslProxyCacheMiss=sslProxyCacheMiss, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, totalServers=totalServers, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, totalMem=totalMem, httpSrvrPort=httpSrvrPort, logStorageHigh=logStorageHigh, sslSrvrTotReqRejected=sslSrvrTotReqRejected, energizeUpdateExpire=energizeUpdateExpire, bwsSMUserSessionEntry=bwsSMUserSessionEntry, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrAddressType=httpSrvrAddressType, switchingToMaintMode=switchingToMaintMode, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCacheStale=webCacheStale, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyParseErr=httpProxyParseErr, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, peerUp=peerUp, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, securityDefUpdates=securityDefUpdates, webCacheProtocol=webCacheProtocol, totalApplications=totalApplications, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCacheCachedObjects=webCacheCachedObjects, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrInBytes=sslSrvrInBytes, bwsStatsGroup=bwsStatsGroup, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyActiveConn=sslProxyActiveConn, memUtilization=memUtilization, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrAddress=httpSrvrAddress, serverUp=serverUp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyOutBytes=httpProxyOutBytes, sslSrvrTotRefused=sslSrvrTotRefused, highAvailabilityStatus=highAvailabilityStatus, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsCacheStatsTable=bwsCacheStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyServerReq=httpProxyServerReq, ipsHdrAclPort=ipsHdrAclPort, sslProxyTotalReq=sslProxyTotalReq, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsRCTotServed=ipsRCTotServed, totalBandwidth=totalBandwidth, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslProxyAddressType=sslProxyAddressType, httpProxyAddress=httpProxyAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, serverDown=serverDown, webCacheCacheableRes=webCacheCacheableRes, sslSrvrPort=sslSrvrPort, smAgentName=smAgentName, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlAclPort=ipsUrlAclPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, freeMem=freeMem, systemFailOver=systemFailOver, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, dataPortLinkUp=dataPortLinkUp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, activeApplications=activeApplications, currentFirmwareVersion=currentFirmwareVersion, webCacheBytesOut=webCacheBytesOut, httpSrvrState=httpSrvrState, sslProxyCacheHits=sslProxyCacheHits, sslSrvrMinResTime=sslSrvrMinResTime, bwsSMUserSessionTable=bwsSMUserSessionTable, vipStatus=vipStatus, httpProxyPort=httpProxyPort, serviceStatus=serviceStatus, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheMiss=webCacheMiss, sslSrvrNumFreeConn=sslSrvrNumFreeConn, dataPathStatus=dataPathStatus, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, cpuFanSpeed=cpuFanSpeed, httpProxyTotalConn=httpProxyTotalConn, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsMIBConformance=bwsMIBConformance, fanDead=fanDead, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, systemLoad=systemLoad, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bws=bws, webCachePort=webCachePort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, serviceName=serviceName, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyServerErr=httpProxyServerErr, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, totalAttacks=totalAttacks, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsRCPort=ipsRCPort, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclAddress=ipsUrlAclAddress, memoryUsageHigh=memoryUsageHigh)
mibBuilder.exportSymbols("BWS-MIB", httpProxyUnknownRsp=httpProxyUnknownRsp, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheReq=webCacheReq, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsStats=bwsStats, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, raidDegrading=raidDegrading, systemFailure=systemFailure, webCacheAddressType=webCacheAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecPort=ipsCookieSecPort, processCountHigh=processCountHigh, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxyActiveConn=httpProxyActiveConn, webCacheAddress=webCacheAddress, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrAddress=sslSrvrAddress, bwsMessage=bwsMessage, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsCompressionStatsTable=bwsCompressionStatsTable, srvcName=srvcName, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, uptime=uptime, sslProxyBadDNCErr=sslProxyBadDNCErr, systemFanSpeed=systemFanSpeed, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, firmwareStorage=firmwareStorage, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrNumConn=httpSrvrNumConn, ipsUrlAclReserved=ipsUrlAclReserved, systemSerialNumber=systemSerialNumber, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, cpuTemperature=cpuTemperature, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwstraps=bwstraps, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsUrlNormPort=ipsUrlNormPort, webCmprAddress=webCmprAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, activeServers=activeServers, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyCurrentConn=sslProxyCurrentConn, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, virusDefUpdates=virusDefUpdates, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsReqLimitPort=ipsReqLimitPort)
