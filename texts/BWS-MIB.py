...
ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, ObjectIdentity, iso, Gauge32, TimeTicks, IpAddress, Integer32, NotificationType, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "ObjectIdentity", "iso", "Gauge32", "TimeTicks", "IpAddress", "Integer32", "NotificationType", "Counter32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrAddress=httpSrvrAddress, energizeUpdateExpire=energizeUpdateExpire, httpSrvrState=httpSrvrState, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, webCacheAddressType=webCacheAddressType, memUtilization=memUtilization, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsStats=bwsStats, peerDown=peerDown, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrState=sslSrvrState, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyTotalConn=sslProxyTotalConn, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheCacheableRes=webCacheCacheableRes, totalMem=totalMem, switchingToBypassMode=switchingToBypassMode, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsRCTotDropped=ipsRCTotDropped, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, webCmprAddressType=webCmprAddressType, smNumUserSessions=smNumUserSessions, totalAttacks=totalAttacks, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, firmwareStorage=firmwareStorage, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, tempCritical=tempCritical, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, raidDegrading=raidDegrading, sslSrvrAddress=sslSrvrAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, serverUp=serverUp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, dataPortLinkDown=dataPortLinkDown, webCmprPort=webCmprPort, webCacheStale=webCacheStale, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpProxyServerReq=httpProxyServerReq, sslSrvrNumConn=sslSrvrNumConn, ipsHdrAclAddress=ipsHdrAclAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyActiveConn=httpProxyActiveConn, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyServerAbrt=httpProxyServerAbrt, httpProxyParseErr=httpProxyParseErr, highAvailabilityStatus=highAvailabilityStatus, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, totalApplications=totalApplications, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, linkStatus=linkStatus, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyActiveConn=sslProxyActiveConn, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrPort=httpSrvrPort, httpProxyServerErr=httpProxyServerErr, webCacheHits=webCacheHits, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyErrPms=sslProxyErrPms, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyAddressType=sslProxyAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpProxyTotalConn=httpProxyTotalConn, bwsMIBCompliances=bwsMIBCompliances, httpProxyOutBytes=httpProxyOutBytes, serverDown=serverDown, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, systemFailure=systemFailure, switchingToInlineMode=switchingToInlineMode, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyCurrentConn=sslProxyCurrentConn, ipsRCAddress=ipsRCAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, httpProxyAddressType=httpProxyAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bws=bws, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, webCacheMiss=webCacheMiss, sslSrvrTotReqRejected=sslSrvrTotReqRejected, cpuTemperature=cpuTemperature, logStorageHigh=logStorageHigh, ipsWebAddrTransPort=ipsWebAddrTransPort, webCachePort=webCachePort, bwsMIBGroups=bwsMIBGroups, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsHdrAclPort=ipsHdrAclPort, bwsServiceStatusTable=bwsServiceStatusTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecEncrypted=ipsCookieSecEncrypted, smAgentName=smAgentName, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCPort=ipsRCPort, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, securityDefUpdates=securityDefUpdates, serviceStatus=serviceStatus, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyAddress=sslProxyAddress, ipsUrlAclAddress=ipsUrlAclAddress, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheReq=webCacheReq, ipsRCTotQueued=ipsRCTotQueued, ipsLrnSrvcAddress=ipsLrnSrvcAddress, totalBandwidth=totalBandwidth, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, fanDead=fanDead, systemLoad=systemLoad, webCacheCachedObjects=webCacheCachedObjects, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsStatsGroup=bwsStatsGroup, systemFailOver=systemFailOver, sslProxyInBytes=sslProxyInBytes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsHdrAclAddressType=ipsHdrAclAddressType, currentFirmwareVersion=currentFirmwareVersion, httpSrvrAvgResTime=httpSrvrAvgResTime, bwstraps=bwstraps, sslProxyTotalReq=sslProxyTotalReq, httpProxyTotalReq=httpProxyTotalReq, sslProxyOutBytes=sslProxyOutBytes, webCmprProtocol=webCmprProtocol, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, cpuFanSpeed=cpuFanSpeed, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, webCacheAddress=webCacheAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsSslProxyStatsTable=bwsSslProxyStatsTable, totalServers=totalServers, processCountHigh=processCountHigh, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, activeApplications=activeApplications, activeServers=activeServers, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCTotServed=ipsRCTotServed, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitAddress=ipsReqLimitAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlAclPort=ipsUrlAclPort, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, peerUp=peerUp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotResponse=httpSrvrTotResponse, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrAddressType=sslSrvrAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, tempHigh=tempHigh, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsRCTimeStamp=ipsRCTimeStamp, cpuUtilization=cpuUtilization, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, virusDefUpdates=virusDefUpdates, servicePort=servicePort, httpSrvrNumConn=httpSrvrNumConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, logStorage=logStorage, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrInBytes=httpSrvrInBytes, webCacheLongHdrs=webCacheLongHdrs, sslSrvrInBytes=sslSrvrInBytes, webCacheBytesOut=webCacheBytesOut, switchingToMaintMode=switchingToMaintMode)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrMaxResTime=sslSrvrMaxResTime, systemSerialNumber=systemSerialNumber, httpProxyInBytes=httpProxyInBytes, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyAddress=httpProxyAddress, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, PYSNMP_MODULE_ID=bws, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsMessage=bwsMessage, systemFanSpeed=systemFanSpeed, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecPort=ipsCookieSecPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, firmwareStorageHigh=firmwareStorageHigh, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrPort=sslSrvrPort, webCacheProtocol=webCacheProtocol, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAddressType=httpSrvrAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrTotResponse=sslSrvrTotResponse, vipStatus=vipStatus, serviceAddress=serviceAddress, ipsHdrAclHits=ipsHdrAclHits, smRealmName=smRealmName, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, dataPortLinkUp=dataPortLinkUp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslSrvrMinResTime=sslSrvrMinResTime, srvcName=srvcName, sslProxyCacheHits=sslProxyCacheHits, operationalMode=operationalMode, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlNormAddress=ipsUrlNormAddress, serviceName=serviceName, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsTrapGroup=bwsTrapGroup, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, dataPathStatus=dataPathStatus, freeMem=freeMem, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyPort=httpProxyPort, webCmprAddress=webCmprAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsMIBCompliance=bwsMIBCompliance, uptime=uptime, ipsRCAddressType=ipsRCAddressType, bwsMIBConformance=bwsMIBConformance, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyPort=sslProxyPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr)
