...
TimeTicks, Counter32, iso, ModuleIdentity, Bits, Gauge32, NotificationType, MibIdentifier, Unsigned32, IpAddress, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "iso", "ModuleIdentity", "Bits", "Gauge32", "NotificationType", "MibIdentifier", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrInBytes=httpSrvrInBytes, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, tempCritical=tempCritical, webCacheCachedObjects=webCacheCachedObjects, sslSrvrNumConn=sslSrvrNumConn, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCachePort=webCachePort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, totalApplications=totalApplications, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsRCTotDropped=ipsRCTotDropped, httpProxyInBytes=httpProxyInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCmprAddress=webCmprAddress, highAvailabilityStatus=highAvailabilityStatus, fanDead=fanDead, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyInBytes=sslProxyInBytes, dataPortLinkDown=dataPortLinkDown, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCmprPort=webCmprPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotRefused=httpSrvrTotRefused, httpProxyParseErr=httpProxyParseErr, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyActiveConn=sslProxyActiveConn, webCacheStale=webCacheStale, processCountHigh=processCountHigh, ipsReqLimitPort=ipsReqLimitPort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, webCacheAddressType=webCacheAddressType, sslSrvrInBytes=sslSrvrInBytes, bwsMIBConformance=bwsMIBConformance, bwsCacheStatsTable=bwsCacheStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, serviceAddress=serviceAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrAddressType=httpSrvrAddressType, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsUrlAclAddress=ipsUrlAclAddress, serviceName=serviceName, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, currentFirmwareVersion=currentFirmwareVersion, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransPort=ipsWebAddrTransPort, securityDefUpdates=securityDefUpdates, bwsMessage=bwsMessage, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrSrvcPort=sslSrvrSrvcPort, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsTrapGroup=bwsTrapGroup, webCacheBytesOut=webCacheBytesOut, ipsUrlNormAddressType=ipsUrlNormAddressType, switchingToMaintMode=switchingToMaintMode, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, cpuFanSpeed=cpuFanSpeed, ipsCookieSecTampered=ipsCookieSecTampered, systemFailure=systemFailure, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, totalBandwidth=totalBandwidth, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, totalServers=totalServers, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpProxyClientAbrt=httpProxyClientAbrt, ipsRCPort=ipsRCPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrNumConn=httpSrvrNumConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, memoryUsageHigh=memoryUsageHigh, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable, bwstraps=bwstraps, webCacheMiss=webCacheMiss, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsUrlAclAddressType=ipsUrlAclAddressType, systemFailOver=systemFailOver, webCacheCacheableRes=webCacheCacheableRes, systemLoad=systemLoad, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslSrvrMinResTime=sslSrvrMinResTime, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlAclReserved=ipsUrlAclReserved, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrState=httpSrvrState, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsHdrAclPort=ipsHdrAclPort, logStorage=logStorage, dataPortLinkUp=dataPortLinkUp, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyAddress=httpProxyAddress, webCmprProtocol=webCmprProtocol, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, switchingToBypassMode=switchingToBypassMode, sslProxyAddressType=sslProxyAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, sslProxyCacheHits=sslProxyCacheHits, firmwareStorage=firmwareStorage, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsMIBCompliance=bwsMIBCompliance, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrAddress=sslSrvrAddress, ipsCookieSecPort=ipsCookieSecPort, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, serviceStatus=serviceStatus, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrState=sslSrvrState, webCacheHits=webCacheHits, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, systemFanSpeed=systemFanSpeed, bwsMIBCompliances=bwsMIBCompliances, webCmprAddressType=webCmprAddressType, totalAttacks=totalAttacks, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlNormPort=ipsUrlNormPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyServerReq=httpProxyServerReq, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, memUtilization=memUtilization, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyServerErr=httpProxyServerErr, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsRCAddress=ipsRCAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, energizeUpdateExpire=energizeUpdateExpire, operationalMode=operationalMode, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrPort=sslSrvrPort, systemSerialNumber=systemSerialNumber, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsReqLimitAddress=ipsReqLimitAddress, httpProxyOutBytes=httpProxyOutBytes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, serverDown=serverDown, sslProxyErrPms=sslProxyErrPms, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, virusDefUpdates=virusDefUpdates, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, activeServers=activeServers, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyPort=sslProxyPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsHdrAclAddress=ipsHdrAclAddress, vipStatus=vipStatus, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, webCacheReq=webCacheReq, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, webCacheProtocol=webCacheProtocol, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, tempHigh=tempHigh, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrPort=httpSrvrPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyAddress=sslProxyAddress, firmwareStorageHigh=firmwareStorageHigh, activeApplications=activeApplications, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyPort=httpProxyPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsRCAddressType=ipsRCAddressType, smNumUserSessions=smNumUserSessions, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, webCacheAddress=webCacheAddress, cpuUtilization=cpuUtilization, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, switchingToInlineMode=switchingToInlineMode, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsHdrAclHits=ipsHdrAclHits, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsStats=bwsStats)
mibBuilder.exportSymbols("BWS-MIB", bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlAclPort=ipsUrlAclPort, smRealmName=smRealmName, ipsRCTotServed=ipsRCTotServed, httpSrvrAddress=httpSrvrAddress, totalMem=totalMem, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsStatsGroup=bwsStatsGroup, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, freeMem=freeMem, httpSrvrMinResTime=httpSrvrMinResTime, ipsRCTimeStamp=ipsRCTimeStamp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, uptime=uptime, httpSrvrSrvcPort=httpSrvrSrvcPort, raidDegrading=raidDegrading, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyTotalReq=httpProxyTotalReq, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyTotalConn=sslProxyTotalConn, peerDown=peerDown, smAgentName=smAgentName, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, dataPathStatus=dataPathStatus, bwsMIBGroups=bwsMIBGroups, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, srvcName=srvcName, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrOutBytes=sslSrvrOutBytes, PYSNMP_MODULE_ID=bws, linkStatus=linkStatus, cpuTemperature=cpuTemperature, serverUp=serverUp, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bws=bws, ipsRCTotQueued=ipsRCTotQueued, peerUp=peerUp, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyActiveConn=httpProxyActiveConn, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxyTotalConn=httpProxyTotalConn, logStorageHigh=logStorageHigh, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, servicePort=servicePort, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyAddressType=httpProxyAddressType)
