...
NotificationType, ModuleIdentity, IpAddress, Bits, ObjectIdentity, TimeTicks, Gauge32, Unsigned32, Integer32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "IpAddress", "Bits", "ObjectIdentity", "TimeTicks", "Gauge32", "Unsigned32", "Integer32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlAclPort=ipsUrlAclPort, ipsCookieSecPort=ipsCookieSecPort, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCachePort=webCachePort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, webCmprAddress=webCmprAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCacheProtocol=webCacheProtocol, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpProxyActiveConn=httpProxyActiveConn, memUtilization=memUtilization, systemFailOver=systemFailOver, dataPathStatus=dataPathStatus, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, peerUp=peerUp, highAvailabilityStatus=highAvailabilityStatus, httpProxyTotalReq=httpProxyTotalReq, bwsCacheStatsTable=bwsCacheStatsTable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bws=bws, sslProxyErrPms=sslProxyErrPms, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, raidDegrading=raidDegrading, ipsRCTotQueued=ipsRCTotQueued, ipsHdrAclPort=ipsHdrAclPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAddress=ipsAccessCtrlAddress, totalBandwidth=totalBandwidth, httpSrvrPort=httpSrvrPort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, switchingToBypassMode=switchingToBypassMode, bwsStats=bwsStats, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsRCAddressType=ipsRCAddressType, serverDown=serverDown, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, activeApplications=activeApplications, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqLimitPort=ipsReqLimitPort, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsRCPort=ipsRCPort, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyServerReq=httpProxyServerReq, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyPort=httpProxyPort, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCacheHits=webCacheHits, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyCacheHits=sslProxyCacheHits, totalAttacks=totalAttacks, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsTrapGroup=bwsTrapGroup, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, systemSerialNumber=systemSerialNumber, bwsMIBCompliances=bwsMIBCompliances, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsMIBConformance=bwsMIBConformance, httpSrvrInBytes=httpSrvrInBytes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, smAgentName=smAgentName, PYSNMP_MODULE_ID=bws, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrTotRefused=httpSrvrTotRefused, httpSrvrNumFreeConn=httpSrvrNumFreeConn, linkStatus=linkStatus, ipsRCAddress=ipsRCAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyAddressType=httpProxyAddressType, freeMem=freeMem, sslProxyInBytes=sslProxyInBytes, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpProxyServerAbrt=httpProxyServerAbrt, energizeUpdateExpire=energizeUpdateExpire, sslProxyActiveConn=sslProxyActiveConn, httpProxyTotalConn=httpProxyTotalConn, smNumUserSessions=smNumUserSessions, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyAddressType=sslProxyAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, currentFirmwareVersion=currentFirmwareVersion, httpSrvrTotSuccess=httpSrvrTotSuccess, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyClientAbrt=httpProxyClientAbrt, cpuUtilization=cpuUtilization, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsCookieSecEncrypted=ipsCookieSecEncrypted, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, totalApplications=totalApplications, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrSrvcAddress=httpSrvrSrvcAddress, dataPortLinkUp=dataPortLinkUp, ipsHdrAclHits=ipsHdrAclHits, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyPort=sslProxyPort, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCmprPort=webCmprPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, activeServers=activeServers, vipStatus=vipStatus, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, uptime=uptime, sslSrvrNumFreeConn=sslSrvrNumFreeConn, webCmprAddressType=webCmprAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyWAFWarnings=httpProxyWAFWarnings, serviceName=serviceName, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, servicePort=servicePort, securityDefUpdates=securityDefUpdates, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, totalServers=totalServers, sslSrvrTotReqActive=sslSrvrTotReqActive, totalMem=totalMem, serverUp=serverUp, sslProxyTotalReq=sslProxyTotalReq, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrAddressType=httpSrvrAddressType, httpProxyInBytes=httpProxyInBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrState=sslSrvrState, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheAddressType=webCacheAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyTotalConn=sslProxyTotalConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrPort=sslSrvrPort, tempHigh=tempHigh, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyOutBytes=httpProxyOutBytes, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, srvcName=srvcName, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslProxyCurrentConn=sslProxyCurrentConn, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrAddressType=sslSrvrAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumConn=sslSrvrNumConn, sslSrvrTotSuccess=sslSrvrTotSuccess, operationalMode=operationalMode, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, firmwareStorageHigh=firmwareStorageHigh, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, serviceAddress=serviceAddress, httpProxyServerErr=httpProxyServerErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyParseErr=httpProxyParseErr, fanDead=fanDead, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecTampered=ipsCookieSecTampered, webCacheReq=webCacheReq, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsRCTotDropped=ipsRCTotDropped, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, cpuTemperature=cpuTemperature, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrState=httpSrvrState, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, logStorage=logStorage, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, sslSrvrOutBytes=sslSrvrOutBytes, dataPortLinkDown=dataPortLinkDown, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsMessage=bwsMessage, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsRCTimeStamp=ipsRCTimeStamp, smRealmName=smRealmName, serviceStatus=serviceStatus, bwstraps=bwstraps, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, switchingToInlineMode=switchingToInlineMode, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrAddress=sslSrvrAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted)
mibBuilder.exportSymbols("BWS-MIB", bwsCacheStatsEntry=bwsCacheStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCmprProtocol=webCmprProtocol, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrTotResponse=httpSrvrTotResponse, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsMIBCompliance=bwsMIBCompliance, webCacheMiss=webCacheMiss, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsLrnSrvcAddress=ipsLrnSrvcAddress, systemFanSpeed=systemFanSpeed, systemLoad=systemLoad, switchingToMaintMode=switchingToMaintMode, memoryUsageHigh=memoryUsageHigh, webCacheStale=webCacheStale, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, peerDown=peerDown, firmwareStorage=firmwareStorage, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyAddress=httpProxyAddress, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclAddress=ipsUrlAclAddress, cpuFanSpeed=cpuFanSpeed, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCTotServed=ipsRCTotServed, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, webCacheCachedObjects=webCacheCachedObjects, webCacheAddress=webCacheAddress, httpSrvrOutBytes=httpSrvrOutBytes, virusDefUpdates=virusDefUpdates, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrNumConn=httpSrvrNumConn, logStorageHigh=logStorageHigh, sslSrvrInBytes=sslSrvrInBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheCacheableRes=webCacheCacheableRes, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrAddress=httpSrvrAddress, processCountHigh=processCountHigh, sslProxyAddress=sslProxyAddress, tempCritical=tempCritical, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, systemFailure=systemFailure, bwsServiceStatusTable=bwsServiceStatusTable)
