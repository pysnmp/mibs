...
Counter32, ObjectIdentity, Unsigned32, Integer32, NotificationType, TimeTicks, MibIdentifier, Bits, iso, ModuleIdentity, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Unsigned32", "Integer32", "NotificationType", "TimeTicks", "MibIdentifier", "Bits", "iso", "ModuleIdentity", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", freeMem=freeMem, ipsReqSrvcAddressType=ipsReqSrvcAddressType, linkStatus=linkStatus, raidDegrading=raidDegrading, webCacheBytesOut=webCacheBytesOut, sslSrvrSrvcAddress=sslSrvrSrvcAddress, systemFailure=systemFailure, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsReqLimitPort=ipsReqLimitPort, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumConn=sslSrvrNumConn, httpSrvrPort=httpSrvrPort, securityDefUpdates=securityDefUpdates, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslProxyOutBytes=sslProxyOutBytes, systemFailOver=systemFailOver, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, systemSerialNumber=systemSerialNumber, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsRCPort=ipsRCPort, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsReqLimitAddress=ipsReqLimitAddress, activeApplications=activeApplications, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrAddress=httpSrvrAddress, switchingToBypassMode=switchingToBypassMode, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsStatsGroup=bwsStatsGroup, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyActiveConn=httpProxyActiveConn, uptime=uptime, cpuFanSpeed=cpuFanSpeed, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslProxyCacheHits=sslProxyCacheHits, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsHdrAclPort=ipsHdrAclPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, peerDown=peerDown, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, energizeUpdateExpire=energizeUpdateExpire, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlAclPort=ipsUrlAclPort, ipsRCTotDropped=ipsRCTotDropped, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpSrvrAddressType=httpSrvrAddressType, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheStale=webCacheStale, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, cpuTemperature=cpuTemperature, httpProxyPort=httpProxyPort, webCacheCacheableRes=webCacheCacheableRes, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrNumFreeConn=httpSrvrNumFreeConn, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsMessage=bwsMessage, httpProxySessionTimeOut=httpProxySessionTimeOut, totalAttacks=totalAttacks, webCacheLongHdrs=webCacheLongHdrs, webCachePort=webCachePort, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlNormAddress=ipsUrlNormAddress, ipsRCAddress=ipsRCAddress, httpProxyServerErr=httpProxyServerErr, ipsCookieSecAddress=ipsCookieSecAddress, serverUp=serverUp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, logStorage=logStorage, webCacheHits=webCacheHits, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcPort=ipsLrnSrvcPort, switchingToInlineMode=switchingToInlineMode, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMIBCompliances=bwsMIBCompliances, firmwareStorage=firmwareStorage, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, virusDefUpdates=virusDefUpdates, sslProxyErrPms=sslProxyErrPms, ipsUrlNormPort=ipsUrlNormPort, peerUp=peerUp, serviceStatus=serviceStatus, httpSrvrState=httpSrvrState, dataPortLinkDown=dataPortLinkDown, webCacheCachedObjects=webCacheCachedObjects, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, tempHigh=tempHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCmprAddressType=webCmprAddressType, srvcName=srvcName, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, totalMem=totalMem, tempCritical=tempCritical, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyParseErr=httpProxyParseErr, systemFanSpeed=systemFanSpeed, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsRCAddressType=ipsRCAddressType, PYSNMP_MODULE_ID=bws, sslSrvrAvgResTime=sslSrvrAvgResTime, memUtilization=memUtilization, httpProxyOutBytes=httpProxyOutBytes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlAclAddressType=ipsUrlAclAddressType, cpuUtilization=cpuUtilization, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsHdrAclHits=ipsHdrAclHits, currentFirmwareVersion=currentFirmwareVersion, ipsCookieSecPort=ipsCookieSecPort, bws=bws, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, serviceAddress=serviceAddress, sslProxyAddress=sslProxyAddress, dataPathStatus=dataPathStatus, sslSrvrAddressType=sslSrvrAddressType, bwsStats=bwsStats, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyUnknownRsp=httpProxyUnknownRsp, serviceName=serviceName, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrState=sslSrvrState, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, switchingToMaintMode=switchingToMaintMode, httpProxyServerReq=httpProxyServerReq, totalServers=totalServers, bwsMIBGroups=bwsMIBGroups, webCacheAddressType=webCacheAddressType, processCountHigh=processCountHigh, sharedSecretKeyExpired=sharedSecretKeyExpired, fanDead=fanDead, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, serverDown=serverDown, vipStatus=vipStatus, highAvailabilityStatus=highAvailabilityStatus, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCacheProtocol=webCacheProtocol, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyTotalReq=sslProxyTotalReq, sslProxyAddressType=sslProxyAddressType, httpProxyInBytes=httpProxyInBytes, memoryUsageHigh=memoryUsageHigh, httpProxyServerAbrt=httpProxyServerAbrt, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCmprAddress=webCmprAddress, sslProxyInBytes=sslProxyInBytes, webCmprCompressedDataSize=webCmprCompressedDataSize, firmwareStorageHigh=firmwareStorageHigh, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCmprPort=webCmprPort, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyActiveConn=sslProxyActiveConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, totalBandwidth=totalBandwidth, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsMIBConformance=bwsMIBConformance, bwsMIBCompliance=bwsMIBCompliance, ipsReqSrvcPort=ipsReqSrvcPort, logStorageHigh=logStorageHigh, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsServiceStatusTable=bwsServiceStatusTable, webCacheAddress=webCacheAddress, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, httpSrvrNumConn=httpSrvrNumConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitAddressType=ipsReqLimitAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected)
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyBadCRLErr=sslProxyBadCRLErr, bwstraps=bwstraps, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpProxyAddressType=httpProxyAddressType, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, smNumUserSessions=smNumUserSessions, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, smAgentName=smAgentName, sslSrvrPort=sslSrvrPort, ipsUrlAclReserved=ipsUrlAclReserved, bwsTrapGroup=bwsTrapGroup, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCTotQueued=ipsRCTotQueued, systemLoad=systemLoad, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, operationalMode=operationalMode, smRealmName=smRealmName, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, totalApplications=totalApplications, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheReq=webCacheReq, sslSrvrAddress=sslSrvrAddress, dataPortLinkUp=dataPortLinkUp, sslProxyPort=sslProxyPort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, webCmprProtocol=webCmprProtocol, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecTampered=ipsCookieSecTampered, activeServers=activeServers, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyTotalReq=httpProxyTotalReq, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyAddress=httpProxyAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, sslSrvrInBytes=sslSrvrInBytes, servicePort=servicePort, webCacheMiss=webCacheMiss, httpSrvrTotResponse=httpSrvrTotResponse, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsRCTotServed=ipsRCTotServed)
