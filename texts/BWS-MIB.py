...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Integer32, iso, Counter32, Counter64, NotificationType, Bits, Gauge32, IpAddress, Unsigned32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Integer32", "iso", "Counter32", "Counter64", "NotificationType", "Bits", "Gauge32", "IpAddress", "Unsigned32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlAclAddress=ipsUrlAclAddress, smNumUserSessions=smNumUserSessions, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrNumFreeConn=sslSrvrNumFreeConn, highAvailabilityStatus=highAvailabilityStatus, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sslProxyOutBytes=sslProxyOutBytes, logStorageHigh=logStorageHigh, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrNumConn=sslSrvrNumConn, bwsMIBGroups=bwsMIBGroups, sslProxyErrPms=sslProxyErrPms, webCacheLongHdrs=webCacheLongHdrs, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyFullHandshakes=sslProxyFullHandshakes, sslProxyPort=sslProxyPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, operationalMode=operationalMode, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrSrvcPort=httpSrvrSrvcPort, switchingToInlineMode=switchingToInlineMode, ipsCookieSecTampered=ipsCookieSecTampered, peerDown=peerDown, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsHdrAclPort=ipsHdrAclPort, httpProxyAddress=httpProxyAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrTotRefused=httpSrvrTotRefused, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyTotalConn=httpProxyTotalConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrAddressType=sslSrvrAddressType, bwstraps=bwstraps, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsMIBCompliance=bwsMIBCompliance, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyAddressType=sslProxyAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, uptime=uptime, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlAclPort=ipsUrlAclPort, sslSrvrTotTimedout=sslSrvrTotTimedout, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsStatsGroup=bwsStatsGroup, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrMinResTime=sslSrvrMinResTime, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyCacheMiss=sslProxyCacheMiss, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrPort=httpSrvrPort, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, dataPathStatus=dataPathStatus, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsRCPort=ipsRCPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrMaxResTime=sslSrvrMaxResTime, webCmprAddress=webCmprAddress, sslSrvrPort=sslSrvrPort, switchingToBypassMode=switchingToBypassMode, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheCacheableRes=webCacheCacheableRes, webCacheBytesOut=webCacheBytesOut, httpProxyParseErr=httpProxyParseErr, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsMIBCompliances=bwsMIBCompliances, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsStats=bwsStats, bwsTrapGroup=bwsTrapGroup, webCacheAddress=webCacheAddress, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrTotSuccess=httpSrvrTotSuccess, bws=bws, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyActiveConn=httpProxyActiveConn, webCacheProtocol=webCacheProtocol, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsServiceStatusEntry=bwsServiceStatusEntry, tempHigh=tempHigh, vipStatus=vipStatus, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslProxyActiveConn=sslProxyActiveConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCAddressType=ipsRCAddressType, serverUp=serverUp, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, smAgentName=smAgentName, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrState=httpSrvrState, fanDead=fanDead, ipsUrlNormPort=ipsUrlNormPort, httpSrvrAddressType=httpSrvrAddressType, peerUp=peerUp, virusDefUpdates=virusDefUpdates, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, processCountHigh=processCountHigh, sslProxyBadDNCErr=sslProxyBadDNCErr, totalAttacks=totalAttacks, linkStatus=linkStatus, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrMinResTime=httpSrvrMinResTime, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsMessage=bwsMessage, systemFanSpeed=systemFanSpeed, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, PYSNMP_MODULE_ID=bws, httpProxyServerErr=httpProxyServerErr, serviceAddress=serviceAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsAccessCtrlPort=ipsAccessCtrlPort, webCacheAddressType=webCacheAddressType, serviceName=serviceName, ipsRCTotServed=ipsRCTotServed, httpProxyPort=httpProxyPort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, webCmprAddressType=webCmprAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, totalServers=totalServers, dataPortLinkDown=dataPortLinkDown, ipsReqSrvcPort=ipsReqSrvcPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, activeApplications=activeApplications, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCmprCompressedDataSize=webCmprCompressedDataSize, totalMem=totalMem, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpProxyServerReq=httpProxyServerReq, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsHdrAclAddress=ipsHdrAclAddress, systemLoad=systemLoad, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, totalApplications=totalApplications, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyAddress=sslProxyAddress, systemSerialNumber=systemSerialNumber, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, webCacheMiss=webCacheMiss, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, servicePort=servicePort, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheStale=webCacheStale, tempCritical=tempCritical, cpuTemperature=cpuTemperature, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheCachedObjects=webCacheCachedObjects, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyTotalReq=httpProxyTotalReq, httpSrvrInBytes=httpSrvrInBytes, securityDefUpdates=securityDefUpdates, ipsUrlNormAddressType=ipsUrlNormAddressType, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsRCTimeStamp=ipsRCTimeStamp, ipsRCAddress=ipsRCAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsHdrAclHits=ipsHdrAclHits, serviceStatus=serviceStatus, ipsUrlNormAddress=ipsUrlNormAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, systemFailure=systemFailure, webCmprPort=webCmprPort, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, currentFirmwareVersion=currentFirmwareVersion, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, firmwareStorageHigh=firmwareStorageHigh, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyInBytes=httpProxyInBytes, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpProxyOutBytes=httpProxyOutBytes, sslSrvrTotResponse=sslSrvrTotResponse, switchingToMaintMode=switchingToMaintMode, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCacheHits=webCacheHits, httpSrvrSrvcAddress=httpSrvrSrvcAddress, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsRCTotOutOfResource=ipsRCTotOutOfResource, memoryUsageHigh=memoryUsageHigh, raidDegrading=raidDegrading, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, systemFailOver=systemFailOver, sslProxyTotalConn=sslProxyTotalConn, httpSrvrTotResponse=httpSrvrTotResponse, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, totalBandwidth=totalBandwidth, cpuUtilization=cpuUtilization, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyInBytes=sslProxyInBytes, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrState=sslSrvrState, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyTotalReq=sslProxyTotalReq, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, cpuFanSpeed=cpuFanSpeed, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, dataPortLinkUp=dataPortLinkUp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecPort=ipsCookieSecPort, ipsRCTotDropped=ipsRCTotDropped, smRealmName=smRealmName, firmwareStorage=firmwareStorage, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, freeMem=freeMem, serverDown=serverDown, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrAddress=httpSrvrAddress, memUtilization=memUtilization, webCacheReq=webCacheReq, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitPort=ipsReqLimitPort, activeServers=activeServers, webCachePort=webCachePort, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, logStorage=logStorage, srvcName=srvcName, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsCompressionStatsTable=bwsCompressionStatsTable, httpSrvrNumConn=httpSrvrNumConn, webCmprProtocol=webCmprProtocol, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp)
