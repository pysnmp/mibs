...
Unsigned32, MibIdentifier, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, ModuleIdentity, TimeTicks, Counter64, Integer32, iso, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "ModuleIdentity", "TimeTicks", "Counter64", "Integer32", "iso", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", bwsCacheStatsTable=bwsCacheStatsTable, sslProxyPort=sslProxyPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpSrvrAddress=httpSrvrAddress, ipsRCTotQueued=ipsRCTotQueued, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, currentFirmwareVersion=currentFirmwareVersion, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsCookieSecPort=ipsCookieSecPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrAvgResTime=sslSrvrAvgResTime, serverDown=serverDown, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsMessage=bwsMessage, totalServers=totalServers, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, memoryUsageHigh=memoryUsageHigh, sslProxyOutBytes=sslProxyOutBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsCookieSecEncrypted=ipsCookieSecEncrypted, serviceStatus=serviceStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyServerAbrt=httpProxyServerAbrt, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsMIBConformance=bwsMIBConformance, bws=bws, ipsRCTotDropped=ipsRCTotDropped, httpProxyAddressType=httpProxyAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsStats=bwsStats, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotReqRejected=sslSrvrTotReqRejected, tempCritical=tempCritical, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, linkStatus=linkStatus, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCacheAddressType=webCacheAddressType, systemLoad=systemLoad, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, systemFanSpeed=systemFanSpeed, serverUp=serverUp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitPort=ipsReqLimitPort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, sslProxyErrPms=sslProxyErrPms, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, webCmprPort=webCmprPort, raidDegrading=raidDegrading, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, webCacheAddress=webCacheAddress, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclPort=ipsUrlAclPort, bwsMIBGroups=bwsMIBGroups, httpSrvrPort=httpSrvrPort, webCmprAddress=webCmprAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, webCachePort=webCachePort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, serviceName=serviceName, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheMiss=webCacheMiss, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlAclAddress=ipsUrlAclAddress, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyInBytes=httpProxyInBytes, sslProxyTotalReq=sslProxyTotalReq, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, totalAttacks=totalAttacks, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsCookieSecAddress=ipsCookieSecAddress, dataPathStatus=dataPathStatus, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsStatsGroup=bwsStatsGroup, PYSNMP_MODULE_ID=bws, switchingToBypassMode=switchingToBypassMode, firmwareStorageHigh=firmwareStorageHigh, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsMIBCompliances=bwsMIBCompliances, sslProxyInBytes=sslProxyInBytes, logStorageHigh=logStorageHigh, processCountHigh=processCountHigh, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, smAgentName=smAgentName, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyCurrentConn=sslProxyCurrentConn, ipsHdrAclPort=ipsHdrAclPort, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyActiveConn=httpProxyActiveConn, servicePort=servicePort, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, tempHigh=tempHigh, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCacheHits=webCacheHits, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrAddressType=httpSrvrAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsLrnSrvcPort=ipsLrnSrvcPort, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrTotResponse=httpSrvrTotResponse, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, highAvailabilityStatus=highAvailabilityStatus, vipStatus=vipStatus, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, memUtilization=memUtilization, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrPort=sslSrvrPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsRCPort=ipsRCPort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, operationalMode=operationalMode, sslProxyFullHandshakes=sslProxyFullHandshakes, switchingToMaintMode=switchingToMaintMode, logStorage=logStorage, sslSrvrMinResTime=sslSrvrMinResTime, switchingToInlineMode=switchingToInlineMode, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyTotalReq=httpProxyTotalReq, httpProxySessionTimeOut=httpProxySessionTimeOut, freeMem=freeMem, httpProxyServerReq=httpProxyServerReq, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsMIBCompliance=bwsMIBCompliance, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCacheReq=webCacheReq, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpProxyAddress=httpProxyAddress, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyActiveConn=sslProxyActiveConn, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprCompressedDataSize=webCmprCompressedDataSize, srvcName=srvcName, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrState=httpSrvrState, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, smRealmName=smRealmName, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCacheLongHdrs=webCacheLongHdrs, systemFailOver=systemFailOver, webCacheStale=webCacheStale, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrInBytes=httpSrvrInBytes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyTotalConn=httpProxyTotalConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrAddressType=sslSrvrAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsRCAddress=ipsRCAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwstraps=bwstraps, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, uptime=uptime, sslProxyAddressType=sslProxyAddressType, sslSrvrAddress=sslSrvrAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, totalApplications=totalApplications, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyOutBytes=httpProxyOutBytes, sslProxyCacheMiss=sslProxyCacheMiss, cpuTemperature=cpuTemperature, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, securityDefUpdates=securityDefUpdates, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsRCTotServed=ipsRCTotServed, peerUp=peerUp, ipsRCTimeStamp=ipsRCTimeStamp, webCacheProtocol=webCacheProtocol, ipsRCAddressType=ipsRCAddressType, bwsTrapGroup=bwsTrapGroup, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrTotReqActive=httpSrvrTotReqActive, systemSerialNumber=systemSerialNumber)
mibBuilder.exportSymbols("BWS-MIB", sslProxyCacheHits=sslProxyCacheHits, webCacheCacheableRes=webCacheCacheableRes, fanDead=fanDead, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyTotalConn=sslProxyTotalConn, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrNumConn=httpSrvrNumConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsCookieSecAddressType=ipsCookieSecAddressType, energizeUpdateExpire=energizeUpdateExpire, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlPolicyPort=ipsUrlPolicyPort, sslSrvrState=sslSrvrState, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsHdrAclAddress=ipsHdrAclAddress, ipsHdrAclHits=ipsHdrAclHits, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, serviceAddress=serviceAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, activeServers=activeServers, cpuUtilization=cpuUtilization, sslSrvrNumConn=sslSrvrNumConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, virusDefUpdates=virusDefUpdates, sslSrvrTotSuccess=sslSrvrTotSuccess, totalBandwidth=totalBandwidth, webCacheCachedObjects=webCacheCachedObjects, bwsSMUserSessionEntry=bwsSMUserSessionEntry, activeApplications=activeApplications, ipsCookieSecTampered=ipsCookieSecTampered, firmwareStorage=firmwareStorage, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpProxyPort=httpProxyPort, sslProxyAddress=sslProxyAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpProxyParseErr=httpProxyParseErr, totalMem=totalMem, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyServerErr=httpProxyServerErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCmprAddressType=webCmprAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, peerDown=peerDown, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, smNumUserSessions=smNumUserSessions, systemFailure=systemFailure, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry)
