...
ModuleIdentity, Gauge32, Unsigned32, TimeTicks, MibIdentifier, IpAddress, Integer32, iso, Bits, NotificationType, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Unsigned32", "TimeTicks", "MibIdentifier", "IpAddress", "Integer32", "iso", "Bits", "NotificationType", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyTotalConn=httpProxyTotalConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyErrPms=sslProxyErrPms, ipsRCTotServed=ipsRCTotServed, webCacheLongHdrs=webCacheLongHdrs, sharedSecretKeyExpired=sharedSecretKeyExpired, webCacheProtocol=webCacheProtocol, ipsUrlNormAddressType=ipsUrlNormAddressType, linkStatus=linkStatus, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, systemFailure=systemFailure, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsMessage=bwsMessage, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, currentFirmwareVersion=currentFirmwareVersion, bwsStatsGroup=bwsStatsGroup, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprPort=webCmprPort, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrSrvcPort=httpSrvrSrvcPort, serviceName=serviceName, webCacheAddress=webCacheAddress, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrState=sslSrvrState, ipsRCPort=ipsRCPort, energizeUpdateExpire=energizeUpdateExpire, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprAddress=webCmprAddress, webCacheHits=webCacheHits, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyServerErr=httpProxyServerErr, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumConn=sslSrvrNumConn, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsRCTotQueued=ipsRCTotQueued, switchingToInlineMode=switchingToInlineMode, webCmprProtocol=webCmprProtocol, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, memoryUsageHigh=memoryUsageHigh, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, systemLoad=systemLoad, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, totalMem=totalMem, sslProxyCurrentConn=sslProxyCurrentConn, cpuFanSpeed=cpuFanSpeed, httpProxyAddress=httpProxyAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitAddress=ipsReqLimitAddress, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrOutBytes=httpSrvrOutBytes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyInBytes=sslProxyInBytes, virusDefUpdates=virusDefUpdates, ipsCookieSecTampered=ipsCookieSecTampered, raidDegrading=raidDegrading, httpProxyWAFWarnings=httpProxyWAFWarnings, peerUp=peerUp, totalBandwidth=totalBandwidth, dataPortLinkDown=dataPortLinkDown, cpuUtilization=cpuUtilization, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, totalServers=totalServers, sslSrvrPort=sslSrvrPort, srvcName=srvcName, systemFanSpeed=systemFanSpeed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclReserved=ipsUrlAclReserved, ipsCookieSecPort=ipsCookieSecPort, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyOutBytes=sslProxyOutBytes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, httpProxyAddressType=httpProxyAddressType, httpProxyPort=httpProxyPort, firmwareStorageHigh=firmwareStorageHigh, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheAddressType=webCacheAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpProxyActiveConn=httpProxyActiveConn, serviceStatus=serviceStatus, webCmprAddressType=webCmprAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsHdrAclPort=ipsHdrAclPort, ipsHdrAclHits=ipsHdrAclHits, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, freeMem=freeMem, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyParseErr=httpProxyParseErr, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, tempCritical=tempCritical, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, logStorageHigh=logStorageHigh, vipStatus=vipStatus, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyAddress=sslProxyAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyPort=sslProxyPort, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, totalAttacks=totalAttacks, sslProxyCacheHits=sslProxyCacheHits, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, systemFailOver=systemFailOver, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyAddressType=sslProxyAddressType, ipsRCAddress=ipsRCAddress, httpSrvrNumConn=httpSrvrNumConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, webCacheCacheableRes=webCacheCacheableRes, sslSrvrTotResponse=sslSrvrTotResponse, bwsMIBConformance=bwsMIBConformance, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, smAgentName=smAgentName, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlPolicyPort=ipsUrlPolicyPort, logStorage=logStorage, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, firmwareUpdateAvailable=firmwareUpdateAvailable, serverUp=serverUp, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrSrvcAddress=httpSrvrSrvcAddress, firmwareStorage=firmwareStorage, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, memUtilization=memUtilization, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwstraps=bwstraps, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, serverDown=serverDown, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyOutBytes=httpProxyOutBytes, tempHigh=tempHigh, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlAclPort=ipsUrlAclPort, bwsMIBGroups=bwsMIBGroups, sslProxyCacheMiss=sslProxyCacheMiss, uptime=uptime, webCacheReq=webCacheReq, webCacheMiss=webCacheMiss, fanDead=fanDead, httpProxyTotalReq=httpProxyTotalReq, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsReqLimitPort=ipsReqLimitPort, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, dataPortLinkUp=dataPortLinkUp, webCacheCachedObjects=webCacheCachedObjects, processCountHigh=processCountHigh, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, smRealmName=smRealmName, PYSNMP_MODULE_ID=bws, httpSrvrTotResponse=httpSrvrTotResponse, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyInBytes=httpProxyInBytes, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrAddressType=sslSrvrAddressType, sslProxyTotalReq=sslProxyTotalReq, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, highAvailabilityStatus=highAvailabilityStatus, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyCacheTimeouts=sslProxyCacheTimeouts, peerDown=peerDown, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsStats=bwsStats, bwsTrapGroup=bwsTrapGroup, securityDefUpdates=securityDefUpdates, cpuTemperature=cpuTemperature, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, servicePort=servicePort, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrAddress=httpSrvrAddress, sslProxyActiveConn=sslProxyActiveConn, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrState=httpSrvrState, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrAddress=sslSrvrAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable)
mibBuilder.exportSymbols("BWS-MIB", ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyUnknownRsp=httpProxyUnknownRsp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, smNumUserSessions=smNumUserSessions, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyServerReq=httpProxyServerReq, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCachePort=webCachePort, webCacheBytesOut=webCacheBytesOut, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrMinResTime=httpSrvrMinResTime, serviceAddress=serviceAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, systemSerialNumber=systemSerialNumber, webCacheStale=webCacheStale, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, switchingToBypassMode=switchingToBypassMode, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrAvgResTime=httpSrvrAvgResTime, activeServers=activeServers, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransAddress=ipsWebAddrTransAddress, dataPathStatus=dataPathStatus, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsMIBCompliances=bwsMIBCompliances, operationalMode=operationalMode, activeApplications=activeApplications, ipsReqSrvcAddressType=ipsReqSrvcAddressType, switchingToMaintMode=switchingToMaintMode, bws=bws, httpSrvrInBytes=httpSrvrInBytes, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrPort=httpSrvrPort, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrMinResTime=sslSrvrMinResTime, totalApplications=totalApplications, ipsRCTotDropped=ipsRCTotDropped, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable)
