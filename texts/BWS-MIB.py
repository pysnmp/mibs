...
NotificationType, ModuleIdentity, Bits, Counter64, TimeTicks, ObjectIdentity, Gauge32, Counter32, iso, IpAddress, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Bits", "Counter64", "TimeTicks", "ObjectIdentity", "Gauge32", "Counter32", "iso", "IpAddress", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrTotResponse=sslSrvrTotResponse, httpProxyActiveConn=httpProxyActiveConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, highAvailabilityStatus=highAvailabilityStatus, dataPortLinkDown=dataPortLinkDown, firmwareStorage=firmwareStorage, ipsCookieSecAddress=ipsCookieSecAddress, peerUp=peerUp, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, systemLoad=systemLoad, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsHdrAclAddress=ipsHdrAclAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyCacheMiss=sslProxyCacheMiss, bwsCompressionStatsTable=bwsCompressionStatsTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, switchingToMaintMode=switchingToMaintMode, cpuTemperature=cpuTemperature, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsRCAddress=ipsRCAddress, webCachePort=webCachePort, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumConn=sslSrvrNumConn, ipsRCPort=ipsRCPort, raidDegrading=raidDegrading, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsHdrAclHits=ipsHdrAclHits, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, serviceAddress=serviceAddress, httpSrvrAddressType=httpSrvrAddressType, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclPort=ipsUrlAclPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, totalAttacks=totalAttacks, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyServerAbrt=httpProxyServerAbrt, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsMIBGroups=bwsMIBGroups, sslSrvrPort=sslSrvrPort, processCountHigh=processCountHigh, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsHdrAclPort=ipsHdrAclPort, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, tempHigh=tempHigh, sslSrvrSrvcPort=sslSrvrSrvcPort, sslProxyPort=sslProxyPort, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyParseErr=httpProxyParseErr, firmwareStorageHigh=firmwareStorageHigh, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlNormPort=ipsUrlNormPort, sslProxyTotalConn=sslProxyTotalConn, sslProxyAddressType=sslProxyAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyOutBytes=sslProxyOutBytes, httpSrvrState=httpSrvrState, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheBytesOut=webCacheBytesOut, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, switchingToInlineMode=switchingToInlineMode, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotRefused=sslSrvrTotRefused, bwsMessage=bwsMessage, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, currentFirmwareVersion=currentFirmwareVersion, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcPort=ipsLrnSrvcPort, switchingToBypassMode=switchingToBypassMode, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyWAFWarnings=httpProxyWAFWarnings, securityDefUpdates=securityDefUpdates, logStorageHigh=logStorageHigh, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsTrapGroup=bwsTrapGroup, sslProxyTotalReq=sslProxyTotalReq, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, webCacheLongHdrs=webCacheLongHdrs, vipStatus=vipStatus, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, PYSNMP_MODULE_ID=bws, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrOutBytes=httpSrvrOutBytes, webCmprAddress=webCmprAddress, systemSerialNumber=systemSerialNumber, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, totalServers=totalServers, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, memUtilization=memUtilization, ipsReqLimitPort=ipsReqLimitPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsMIBCompliance=bwsMIBCompliance, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, smAgentName=smAgentName, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, energizeUpdateExpire=energizeUpdateExpire, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCacheProtocol=webCacheProtocol, virusDefUpdates=virusDefUpdates, bwsServiceStatusTable=bwsServiceStatusTable, serviceStatus=serviceStatus, httpProxyServerErr=httpProxyServerErr, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsCacheStatsTable=bwsCacheStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsCookieSecPort=ipsCookieSecPort, serverUp=serverUp, ipsRCTotQueued=ipsRCTotQueued, bwsMIBCompliances=bwsMIBCompliances, tempCritical=tempCritical, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, httpProxyAddressType=httpProxyAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bws=bws, ipsRCAddressType=ipsRCAddressType, systemFanSpeed=systemFanSpeed, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, linkStatus=linkStatus, httpSrvrPort=httpSrvrPort, webCacheStale=webCacheStale, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, cpuUtilization=cpuUtilization, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrState=sslSrvrState, sslProxyCacheHits=sslProxyCacheHits, webCacheMiss=webCacheMiss, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsMIBConformance=bwsMIBConformance, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyTotalConn=httpProxyTotalConn, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, smNumUserSessions=smNumUserSessions, httpProxyPort=httpProxyPort, sslProxyAddress=sslProxyAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsCacheStatsEntry=bwsCacheStatsEntry, webCmprPort=webCmprPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwstraps=bwstraps, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, srvcName=srvcName, sslSrvrMinResTime=sslSrvrMinResTime, webCmprAddressType=webCmprAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrMinResTime=httpSrvrMinResTime, bwsStats=bwsStats, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, freeMem=freeMem, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrTotSuccess=httpSrvrTotSuccess, fanDead=fanDead, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsUrlNormAddress=ipsUrlNormAddress, httpProxyInBytes=httpProxyInBytes, sslSrvrInBytes=sslSrvrInBytes, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, smRealmName=smRealmName, systemFailure=systemFailure, totalApplications=totalApplications, sslProxyErrPms=sslProxyErrPms, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCacheAddress=webCacheAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, httpSrvrAddress=httpSrvrAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheHits=webCacheHits, serverDown=serverDown, systemFailOver=systemFailOver, sslProxyCurrentConn=sslProxyCurrentConn, serviceName=serviceName, sslSrvrAddress=sslSrvrAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, dataPathStatus=dataPathStatus, ipsRCTotOutOfResource=ipsRCTotOutOfResource, operationalMode=operationalMode, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsSMUserSessionTable=bwsSMUserSessionTable)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotReqActive=sslSrvrTotReqActive, totalBandwidth=totalBandwidth, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCacheAddressType=webCacheAddressType, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, dataPortLinkUp=dataPortLinkUp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpSrvrTotRefused=httpSrvrTotRefused, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsRCTotServed=ipsRCTotServed, sslSrvrAddressType=sslSrvrAddressType, bwsStatsGroup=bwsStatsGroup, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsRCTotDropped=ipsRCTotDropped, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyOutBytes=httpProxyOutBytes, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecTampered=ipsCookieSecTampered, peerDown=peerDown, servicePort=servicePort, totalMem=totalMem, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrInBytes=httpSrvrInBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, uptime=uptime, webCacheReq=webCacheReq, ipsUrlPolicyAddress=ipsUrlPolicyAddress, cpuFanSpeed=cpuFanSpeed, activeServers=activeServers, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrNumConn=httpSrvrNumConn, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, logStorage=logStorage, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, httpProxyTotalReq=httpProxyTotalReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCacheCachedObjects=webCacheCachedObjects, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCmprProtocol=webCmprProtocol, httpProxyServerReq=httpProxyServerReq, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyAddress=httpProxyAddress, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, memoryUsageHigh=memoryUsageHigh, ipsReqLimitAddress=ipsReqLimitAddress, activeApplications=activeApplications, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyActiveConn=sslProxyActiveConn, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrSrvcAddress=sslSrvrSrvcAddress)
