...
Integer32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, iso, ObjectIdentity, IpAddress, MibIdentifier, NotificationType, Bits, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "iso", "ObjectIdentity", "IpAddress", "MibIdentifier", "NotificationType", "Bits", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", httpProxyPort=httpProxyPort, vipStatus=vipStatus, bwsCompressionStatsTable=bwsCompressionStatsTable, dataPortLinkDown=dataPortLinkDown, totalApplications=totalApplications, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, httpProxyUnknownRsp=httpProxyUnknownRsp, PYSNMP_MODULE_ID=bws, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, logStorage=logStorage, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlNormPort=ipsUrlNormPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, totalBandwidth=totalBandwidth, ipsReqSrvcAddressType=ipsReqSrvcAddressType, webCmprPort=webCmprPort, ipsReqLimitPort=ipsReqLimitPort, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyOutBytes=sslProxyOutBytes, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, srvcName=srvcName, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, systemLoad=systemLoad, ipsUrlAclAddressType=ipsUrlAclAddressType, serverDown=serverDown, smAgentName=smAgentName, sslProxyActiveConn=sslProxyActiveConn, memUtilization=memUtilization, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslSrvrTotTimedout=sslSrvrTotTimedout, webCacheLongHdrs=webCacheLongHdrs, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sslProxyTotalReq=sslProxyTotalReq, httpSrvrAddress=httpSrvrAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, dataPathStatus=dataPathStatus, sslSrvrNumFreeConn=sslSrvrNumFreeConn, switchingToBypassMode=switchingToBypassMode, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, highAvailabilityStatus=highAvailabilityStatus, sslSrvrOutBytes=sslSrvrOutBytes, ipsReqSrvcPort=ipsReqSrvcPort, ipsRCAddress=ipsRCAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, serviceStatus=serviceStatus, bwstraps=bwstraps, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsMIBConformance=bwsMIBConformance, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsRCTotDropped=ipsRCTotDropped, virusDefUpdates=virusDefUpdates, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, bwsMessage=bwsMessage, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, servicePort=servicePort, logStorageHigh=logStorageHigh, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, httpProxyAddressType=httpProxyAddressType, webCmprProtocol=webCmprProtocol, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrPort=httpSrvrPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, operationalMode=operationalMode, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, httpSrvrInBytes=httpSrvrInBytes, bws=bws, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, activeApplications=activeApplications, bwsMIBCompliances=bwsMIBCompliances, httpSrvrState=httpSrvrState, httpSrvrTotRefused=httpSrvrTotRefused, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCachePort=webCachePort, httpSrvrTotResponse=httpSrvrTotResponse, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyServerReq=httpProxyServerReq, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCacheHits=webCacheHits, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyTotalConn=sslProxyTotalConn, webCacheMiss=webCacheMiss, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsCacheStatsTable=bwsCacheStatsTable, tempCritical=tempCritical, httpProxyOutBytes=httpProxyOutBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrMinResTime=httpSrvrMinResTime, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCAddressType=ipsRCAddressType, systemFailure=systemFailure, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslProxyAddress=sslProxyAddress, systemFailOver=systemFailOver, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslSrvrTotReqActive=sslSrvrTotReqActive, raidDegrading=raidDegrading, ipsCookieSecAddressType=ipsCookieSecAddressType, cpuFanSpeed=cpuFanSpeed, webCacheCacheableRes=webCacheCacheableRes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrMaxResTime=httpSrvrMaxResTime, webCacheAddress=webCacheAddress, sslSrvrState=sslSrvrState, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCmprAddress=webCmprAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, linkStatus=linkStatus, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsAccessCtrlAddress=ipsAccessCtrlAddress, sslProxyErrPms=sslProxyErrPms, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, serverUp=serverUp, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpProxyAddress=httpProxyAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsRCTotQueued=ipsRCTotQueued, sslProxyBadCRLErr=sslProxyBadCRLErr, uptime=uptime, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, activeServers=activeServers, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyCurrentConn=sslProxyCurrentConn, webCacheAddressType=webCacheAddressType, webCacheCachedObjects=webCacheCachedObjects, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, smNumUserSessions=smNumUserSessions, sslProxyCacheHits=sslProxyCacheHits, freeMem=freeMem, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrAddress=sslSrvrAddress, firmwareStorageHigh=firmwareStorageHigh, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsStats=bwsStats, webCacheBytesOut=webCacheBytesOut, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, systemFanSpeed=systemFanSpeed, httpProxyInBytes=httpProxyInBytes, httpSrvrAddressType=httpSrvrAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, switchingToInlineMode=switchingToInlineMode, memoryUsageHigh=memoryUsageHigh, processCountHigh=processCountHigh, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyBadDNCErr=sslProxyBadDNCErr, peerUp=peerUp, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpProxyClientAbrt=httpProxyClientAbrt, smRealmName=smRealmName, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, serviceAddress=serviceAddress, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsRCPort=ipsRCPort, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrAddressType=sslSrvrAddressType, cpuUtilization=cpuUtilization, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, fanDead=fanDead, bwsTrapGroup=bwsTrapGroup, ipsUrlAclPort=ipsUrlAclPort, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyTotalConn=httpProxyTotalConn, sslProxyCacheMiss=sslProxyCacheMiss, bwsMIBCompliance=bwsMIBCompliance, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrTotReqActive=httpSrvrTotReqActive, webCacheProtocol=webCacheProtocol, currentFirmwareVersion=currentFirmwareVersion, totalMem=totalMem, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, dataPortLinkUp=dataPortLinkUp, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrInBytes=sslSrvrInBytes, webCmprAddressType=webCmprAddressType, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType)
mibBuilder.exportSymbols("BWS-MIB", energizeUpdateExpire=energizeUpdateExpire, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyPort=sslProxyPort, tempHigh=tempHigh, newAttackDefinitionInstalled=newAttackDefinitionInstalled, peerDown=peerDown, cpuTemperature=cpuTemperature, ipsHdrAclHits=ipsHdrAclHits, securityDefUpdates=securityDefUpdates, systemSerialNumber=systemSerialNumber, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, webCacheStale=webCacheStale, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsMIBGroups=bwsMIBGroups, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxyTotalReq=httpProxyTotalReq, httpProxyActiveConn=httpProxyActiveConn, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, webCacheReq=webCacheReq, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, switchingToMaintMode=switchingToMaintMode, bwsSslProxyStatsTable=bwsSslProxyStatsTable, firmwareStorage=firmwareStorage, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrNumConn=httpSrvrNumConn, sslProxyAddressType=sslProxyAddressType, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsRCTotServed=ipsRCTotServed, sslSrvrPort=sslSrvrPort, sslSrvrMinResTime=sslSrvrMinResTime, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsStatsGroup=bwsStatsGroup, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, totalServers=totalServers, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyServerErr=httpProxyServerErr, totalAttacks=totalAttacks, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsCookieSecPort=ipsCookieSecPort, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, serviceName=serviceName, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrNumConn=sslSrvrNumConn, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable)
