...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, ModuleIdentity, iso, Bits, Integer32, Gauge32, Counter64, ObjectIdentity, NotificationType, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "ModuleIdentity", "iso", "Bits", "Integer32", "Gauge32", "Counter64", "ObjectIdentity", "NotificationType", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrState=httpSrvrState, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslSrvrOutBytes=sslSrvrOutBytes, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, freeMem=freeMem, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, tempCritical=tempCritical, webCacheLongHdrs=webCacheLongHdrs, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpProxyInBytes=httpProxyInBytes, httpProxyTotalConn=httpProxyTotalConn, PYSNMP_MODULE_ID=bws, bwsMIBConformance=bwsMIBConformance, httpSrvrTotRefused=httpSrvrTotRefused, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, currentFirmwareVersion=currentFirmwareVersion, smAgentName=smAgentName, webCacheReq=webCacheReq, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrState=sslSrvrState, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, smRealmName=smRealmName, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, totalAttacks=totalAttacks, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsMIBCompliances=bwsMIBCompliances, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyAddressType=httpProxyAddressType, cpuUtilization=cpuUtilization, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsTrapGroup=bwsTrapGroup, ipsRCTotQueued=ipsRCTotQueued, raidDegrading=raidDegrading, totalBandwidth=totalBandwidth, bwsSslProxyStatsTable=bwsSslProxyStatsTable, tempHigh=tempHigh, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serverUp=serverUp, systemLoad=systemLoad, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsCookieSecTampered=ipsCookieSecTampered, serverDown=serverDown, bwsServiceStatusTable=bwsServiceStatusTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrAddress=sslSrvrAddress, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCachePort=webCachePort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyTotalReq=sslProxyTotalReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrAddressType=sslSrvrAddressType, switchingToMaintMode=switchingToMaintMode, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCmprPort=webCmprPort, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsCompressionStatsEntry=bwsCompressionStatsEntry, highAvailabilityStatus=highAvailabilityStatus, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, logStorageHigh=logStorageHigh, memoryUsageHigh=memoryUsageHigh, httpSrvrAddressType=httpSrvrAddressType, ipsRCTotDropped=ipsRCTotDropped, httpSrvrPort=httpSrvrPort, cpuFanSpeed=cpuFanSpeed, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsReqLimitPort=ipsReqLimitPort, ipsReqLimitAddress=ipsReqLimitAddress, ipsRCAddressType=ipsRCAddressType, ipsCookieSecPort=ipsCookieSecPort, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyActiveConn=httpProxyActiveConn, ipsUrlNormAddressType=ipsUrlNormAddressType, securityDefUpdates=securityDefUpdates, activeServers=activeServers, operationalMode=operationalMode, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsCookieSecAddress=ipsCookieSecAddress, virusDefUpdates=virusDefUpdates, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, firmwareStorage=firmwareStorage, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheProtocol=webCacheProtocol, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, activeApplications=activeApplications, totalApplications=totalApplications, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsMIBGroups=bwsMIBGroups, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAddressType=sslProxyAddressType, switchingToBypassMode=switchingToBypassMode, sslSrvrPort=sslSrvrPort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrNumFreeConn=httpSrvrNumFreeConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprAddressType=webCmprAddressType, bwsIpsRCStatsTable=bwsIpsRCStatsTable, srvcName=srvcName, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrNumConn=sslSrvrNumConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrTotResponse=httpSrvrTotResponse, webCmprAddress=webCmprAddress, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, firmwareStorageHigh=firmwareStorageHigh, webCacheHits=webCacheHits, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslProxyCacheHits=sslProxyCacheHits, sslSrvrMaxResTime=sslSrvrMaxResTime, peerUp=peerUp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, cpuTemperature=cpuTemperature, httpProxyTotalReq=httpProxyTotalReq, httpSrvrSrvcPort=httpSrvrSrvcPort, httpProxyOutBytes=httpProxyOutBytes, serviceAddress=serviceAddress, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, totalServers=totalServers, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, processCountHigh=processCountHigh, httpProxyServerReq=httpProxyServerReq, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, energizeUpdateExpire=energizeUpdateExpire, peerDown=peerDown, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslProxyAddress=sslProxyAddress, ipsUrlNormPort=ipsUrlNormPort, ipsHdrAclPort=ipsHdrAclPort, bwsMessage=bwsMessage, bwsCacheStatsEntry=bwsCacheStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsSMUserSessionTable=bwsSMUserSessionTable, serviceStatus=serviceStatus, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyServerErr=httpProxyServerErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwstraps=bwstraps, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsRCAddress=ipsRCAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyInBytes=sslProxyInBytes, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, systemFailOver=systemFailOver, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrInBytes=sslSrvrInBytes, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsUrlAclPort=ipsUrlAclPort, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyAddress=httpProxyAddress, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheAddress=webCacheAddress, ipsUrlAclAddressType=ipsUrlAclAddressType, vipStatus=vipStatus, uptime=uptime, ipsWebAddrTransPort=ipsWebAddrTransPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCTimeStamp=ipsRCTimeStamp, totalMem=totalMem, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCacheCacheableRes=webCacheCacheableRes, httpProxyUnknownRsp=httpProxyUnknownRsp, memUtilization=memUtilization, ipsCookieSecAddressType=ipsCookieSecAddressType, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrTotSuccess=httpSrvrTotSuccess, logStorage=logStorage, sslProxyActiveConn=sslProxyActiveConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCPort=ipsRCPort, sslProxyOutBytes=sslProxyOutBytes, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheStale=webCacheStale, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, ipsRCTotServed=ipsRCTotServed, httpSrvrNumConn=httpSrvrNumConn, webCmprProtocol=webCmprProtocol, systemFailure=systemFailure, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr)
mibBuilder.exportSymbols("BWS-MIB", ipsHdrAclHits=ipsHdrAclHits, dataPathStatus=dataPathStatus, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, serviceName=serviceName, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsStatsGroup=bwsStatsGroup, httpSrvrAddress=httpSrvrAddress, sslProxyPort=sslProxyPort, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheAddressType=webCacheAddressType, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, fanDead=fanDead, httpProxyParseErr=httpProxyParseErr, dataPortLinkDown=dataPortLinkDown, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrSrvcAddress=httpSrvrSrvcAddress, sslProxyTotalConn=sslProxyTotalConn, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyPort=httpProxyPort, bws=bws, sslSrvrTotTimedout=sslSrvrTotTimedout, servicePort=servicePort, sslProxyErrPms=sslProxyErrPms, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCacheMiss=webCacheMiss, systemFanSpeed=systemFanSpeed, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrMinResTime=httpSrvrMinResTime, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, linkStatus=linkStatus, bwsMIBCompliance=bwsMIBCompliance, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, webCacheCachedObjects=webCacheCachedObjects, smNumUserSessions=smNumUserSessions, bwsStats=bwsStats, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsCookieSecEncrypted=ipsCookieSecEncrypted, dataPortLinkUp=dataPortLinkUp, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, systemSerialNumber=systemSerialNumber, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten)
