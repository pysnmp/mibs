...
ObjectIdentity, MibIdentifier, Gauge32, IpAddress, Counter32, Bits, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ModuleIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Gauge32", "IpAddress", "Counter32", "Bits", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ModuleIdentity", "iso", "NotificationType")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsCompressionStatsTable=bwsCompressionStatsTable, logStorage=logStorage, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyOutBytes=sslProxyOutBytes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAddress=ipsAccessCtrlAddress, virusDefUpdates=virusDefUpdates, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsRCAddress=ipsRCAddress, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, totalBandwidth=totalBandwidth, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsRCPort=ipsRCPort, httpProxyActiveConn=httpProxyActiveConn, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, systemSerialNumber=systemSerialNumber, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, activeServers=activeServers, httpProxyInBytes=httpProxyInBytes, webCacheHits=webCacheHits, httpProxySessionTimeOut=httpProxySessionTimeOut, webCmprAddress=webCmprAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxyParseErr=httpProxyParseErr, processCountHigh=processCountHigh, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, serviceName=serviceName, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, raidDegrading=raidDegrading, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsMIBCompliances=bwsMIBCompliances, ipsRCTotServed=ipsRCTotServed, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsCacheStatsTable=bwsCacheStatsTable, ipsUrlNormAddressType=ipsUrlNormAddressType, firmwareStorage=firmwareStorage, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, uptime=uptime, sslProxyTotalConn=sslProxyTotalConn, totalServers=totalServers, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCmprCompressibleDataSize=webCmprCompressibleDataSize, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsRCAddressType=ipsRCAddressType, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, dataPortLinkDown=dataPortLinkDown, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, totalAttacks=totalAttacks, sslProxyErrPms=sslProxyErrPms, sslSrvrTotReqActive=sslSrvrTotReqActive, logStorageHigh=logStorageHigh, httpSrvrNumConn=httpSrvrNumConn, freeMem=freeMem, bwstraps=bwstraps, httpProxyServerErr=httpProxyServerErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrTotRefused=httpSrvrTotRefused, cpuUtilization=cpuUtilization, ipsUrlNormAddress=ipsUrlNormAddress, systemFailOver=systemFailOver, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrPort=httpSrvrPort, operationalMode=operationalMode, smRealmName=smRealmName, ipsHdrAclAddress=ipsHdrAclAddress, webCacheMiss=webCacheMiss, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, peerUp=peerUp, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsRCTotQueued=ipsRCTotQueued, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheAddress=webCacheAddress, smAgentName=smAgentName, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsMessage=bwsMessage, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrAddress=sslSrvrAddress, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsTrapGroup=bwsTrapGroup, ipsUrlAclReserved=ipsUrlAclReserved, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotResponse=httpSrvrTotResponse, webCacheAddressType=webCacheAddressType, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyAddressType=sslProxyAddressType, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, webCacheProtocol=webCacheProtocol, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqLimitPort=ipsReqLimitPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, activeApplications=activeApplications, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, serverUp=serverUp, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheStale=webCacheStale, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, ipsHdrAclPort=ipsHdrAclPort, energizeUpdateExpire=energizeUpdateExpire, httpProxyOutBytes=httpProxyOutBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, securityDefUpdates=securityDefUpdates, ipsUrlNormPort=ipsUrlNormPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrOutBytes=sslSrvrOutBytes, vipStatus=vipStatus, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, switchingToInlineMode=switchingToInlineMode, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpProxyServerReq=httpProxyServerReq, httpSrvrInBytes=httpSrvrInBytes, ipsUrlAclAddress=ipsUrlAclAddress, ipsCookieSecPort=ipsCookieSecPort, sslSrvrTotTimedout=sslSrvrTotTimedout, sslProxyInBytes=sslProxyInBytes, webCacheCacheableRes=webCacheCacheableRes, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyTotalConn=httpProxyTotalConn, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrOutBytes=httpSrvrOutBytes, sslSrvrNumConn=sslSrvrNumConn, httpProxyAddressType=httpProxyAddressType, serverDown=serverDown, ipsCookieSecTampered=ipsCookieSecTampered, highAvailabilityStatus=highAvailabilityStatus, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCachePort=webCachePort, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, peerDown=peerDown, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, tempCritical=tempCritical, httpProxyPort=httpProxyPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, switchingToMaintMode=switchingToMaintMode, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyCacheMiss=sslProxyCacheMiss, webCmprAddressType=webCmprAddressType, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsRCTotOutOfResource=ipsRCTotOutOfResource, webCmprProtocol=webCmprProtocol, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrMinResTime=httpSrvrMinResTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, cpuTemperature=cpuTemperature, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsMIBCompliance=bwsMIBCompliance, newAttackDefinitionInstalled=newAttackDefinitionInstalled, srvcName=srvcName, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, servicePort=servicePort, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsCookieSecAddress=ipsCookieSecAddress, systemLoad=systemLoad, linkStatus=linkStatus, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, dataPathStatus=dataPathStatus, httpSrvrState=httpSrvrState, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, currentFirmwareVersion=currentFirmwareVersion, httpProxyAddress=httpProxyAddress, ipsHdrAclHits=ipsHdrAclHits, systemFailure=systemFailure, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, sslProxyTotalReq=sslProxyTotalReq, ipsRCTotDropped=ipsRCTotDropped, httpSrvrAddressType=httpSrvrAddressType, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitAddress=ipsReqLimitAddress, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyAddress=sslProxyAddress, ipsCookieSecEncrypted=ipsCookieSecEncrypted, serviceStatus=serviceStatus, bwsIpsRCStatsTable=bwsIpsRCStatsTable)
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheLongHdrs=webCacheLongHdrs, smNumUserSessions=smNumUserSessions, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpSrvrAddress=httpSrvrAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpSrvrTotReqActive=httpSrvrTotReqActive, totalApplications=totalApplications, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, memUtilization=memUtilization, tempHigh=tempHigh, firmwareStorageHigh=firmwareStorageHigh, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrState=sslSrvrState, bwsMIBConformance=bwsMIBConformance, sslSrvrAddressType=sslSrvrAddressType, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlAclPort=ipsUrlAclPort, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, bwsMIBGroups=bwsMIBGroups, sslProxyPort=sslProxyPort, cpuFanSpeed=cpuFanSpeed, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrAvgResTime=httpSrvrAvgResTime, webCmprPort=webCmprPort, PYSNMP_MODULE_ID=bws, memoryUsageHigh=memoryUsageHigh, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyActiveConn=sslProxyActiveConn, systemFanSpeed=systemFanSpeed, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, serviceAddress=serviceAddress, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsStats=bwsStats, webCacheReq=webCacheReq, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, fanDead=fanDead, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrPort=sslSrvrPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, switchingToBypassMode=switchingToBypassMode, totalMem=totalMem, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpProxyTotalReq=httpProxyTotalReq, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bws=bws, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheCachedObjects=webCacheCachedObjects)
