...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Bits, Counter32, Unsigned32, iso, ObjectIdentity, Counter64, ModuleIdentity, NotificationType, Gauge32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Bits", "Counter32", "Unsigned32", "iso", "ObjectIdentity", "Counter64", "ModuleIdentity", "NotificationType", "Gauge32", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("BWS-MIB", freeMem=freeMem, serviceStatus=serviceStatus, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, fanDead=fanDead, ipsCookieSecTampered=ipsCookieSecTampered, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotResponse=sslSrvrTotResponse, ipsHdrAclHits=ipsHdrAclHits, ipsRCTimeStamp=ipsRCTimeStamp, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyInBytes=sslProxyInBytes, sslProxyAddressType=sslProxyAddressType, webCmprPort=webCmprPort, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, webCacheBytesOut=webCacheBytesOut, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpProxyServerReq=httpProxyServerReq, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bws=bws, ipsCookieSecAddress=ipsCookieSecAddress, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, webCacheAddress=webCacheAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, sslProxyOutBytes=sslProxyOutBytes, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, switchingToMaintMode=switchingToMaintMode, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, webCacheLongHdrs=webCacheLongHdrs, webCacheCachedObjects=webCacheCachedObjects, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrTotRefused=httpSrvrTotRefused, logStorage=logStorage, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, webCacheCacheableRes=webCacheCacheableRes, smRealmName=smRealmName, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, srvcName=srvcName, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrAddressType=sslSrvrAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, operationalMode=operationalMode, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpSrvrNumFreeConn=httpSrvrNumFreeConn, systemSerialNumber=systemSerialNumber, sslSrvrPort=sslSrvrPort, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, switchingToBypassMode=switchingToBypassMode, httpProxyPort=httpProxyPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyBadDNCErr=sslProxyBadDNCErr, httpProxyAddress=httpProxyAddress, ipsReqSrvcAddress=ipsReqSrvcAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrState=httpSrvrState, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclReserved=ipsUrlAclReserved, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyTotalReq=httpProxyTotalReq, sslSrvrOutBytes=sslSrvrOutBytes, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyErrPms=sslProxyErrPms, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsHdrAclAddress=ipsHdrAclAddress, virusDefUpdates=virusDefUpdates, ipsCookieSecPort=ipsCookieSecPort, switchingToInlineMode=switchingToInlineMode, bwsMessage=bwsMessage, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, activeServers=activeServers, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, totalApplications=totalApplications, bwsTrapGroup=bwsTrapGroup, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitPort=ipsReqLimitPort, smAgentName=smAgentName, webCacheProtocol=webCacheProtocol, ipsRCTotDropped=ipsRCTotDropped, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, cpuTemperature=cpuTemperature, bwstraps=bwstraps, PYSNMP_MODULE_ID=bws, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, firmwareStorage=firmwareStorage, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecEncrypted=ipsCookieSecEncrypted, activeApplications=activeApplications, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyAddress=sslProxyAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpSrvrOutBytes=httpSrvrOutBytes, serverUp=serverUp, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpProxyAddressType=httpProxyAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, firmwareUpdateAvailable=firmwareUpdateAvailable, httpProxyParseErr=httpProxyParseErr, totalServers=totalServers, bwsMIBGroups=bwsMIBGroups, httpSrvrPort=httpSrvrPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, totalMem=totalMem, httpSrvrTotReqRejected=httpSrvrTotReqRejected, smNumUserSessions=smNumUserSessions, httpSrvrAddress=httpSrvrAddress, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheReq=webCacheReq, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, logStorageHigh=logStorageHigh, sslProxyCacheTimeouts=sslProxyCacheTimeouts, raidDegrading=raidDegrading, sslSrvrState=sslSrvrState, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, sslSrvrTotReqRejected=sslSrvrTotReqRejected, highAvailabilityStatus=highAvailabilityStatus, ipsUrlAclPort=ipsUrlAclPort, sslProxyTotalReq=sslProxyTotalReq, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, sslProxyCacheMiss=sslProxyCacheMiss, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheStale=webCacheStale, tempCritical=tempCritical, ipsRCPort=ipsRCPort, serviceAddress=serviceAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsSslProxyStatsTable=bwsSslProxyStatsTable, webCacheHits=webCacheHits, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyInBytes=httpProxyInBytes, systemLoad=systemLoad, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, vipStatus=vipStatus, sslProxyPort=sslProxyPort, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCachePort=webCachePort, processCountHigh=processCountHigh, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, serverDown=serverDown, sslSrvrTotRefused=sslSrvrTotRefused, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsMIBCompliances=bwsMIBCompliances, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpProxyOutBytes=httpProxyOutBytes, httpSrvrAddressType=httpSrvrAddressType, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, totalAttacks=totalAttacks, servicePort=servicePort, firmwareStorageHigh=firmwareStorageHigh, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsCacheStatsTable=bwsCacheStatsTable, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyCacheHits=sslProxyCacheHits, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, systemFanSpeed=systemFanSpeed, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCmprProtocol=webCmprProtocol, bwsStatsGroup=bwsStatsGroup, ipsUrlPolicyPort=ipsUrlPolicyPort, dataPathStatus=dataPathStatus, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslProxyTotalConn=sslProxyTotalConn, ipsLrnSrvcAddress=ipsLrnSrvcAddress, webCmprAddressType=webCmprAddressType, peerUp=peerUp, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyServerErr=httpProxyServerErr, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyWAFWarnings=httpProxyWAFWarnings, linkStatus=linkStatus, bwsStats=bwsStats, currentFirmwareVersion=currentFirmwareVersion, peerDown=peerDown, ipsRCAddress=ipsRCAddress, dataPortLinkUp=dataPortLinkUp, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsHdrAclPort=ipsHdrAclPort, securityDefUpdates=securityDefUpdates, energizeUpdateExpire=energizeUpdateExpire, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl)
mibBuilder.exportSymbols("BWS-MIB", cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, serviceName=serviceName, httpSrvrInBytes=httpSrvrInBytes, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, memoryUsageHigh=memoryUsageHigh, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsReqLimitAddress=ipsReqLimitAddress, dataPortLinkDown=dataPortLinkDown, totalBandwidth=totalBandwidth, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlNormAddress=ipsUrlNormAddress, ipsUrlAclAddress=ipsUrlAclAddress, cpuUtilization=cpuUtilization, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, systemFailOver=systemFailOver, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsRCTotServed=ipsRCTotServed, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransPort=ipsWebAddrTransPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsRCAddressType=ipsRCAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheAddressType=webCacheAddressType, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrNumConn=sslSrvrNumConn, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, httpProxyActiveConn=httpProxyActiveConn, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheMiss=webCacheMiss, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sharedSecretKeyExpired=sharedSecretKeyExpired, tempHigh=tempHigh, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyClientAbrt=httpProxyClientAbrt, memUtilization=memUtilization, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, webCmprAddress=webCmprAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsMIBCompliance=bwsMIBCompliance, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrNumConn=httpSrvrNumConn, systemFailure=systemFailure, httpProxyTotalConn=httpProxyTotalConn, uptime=uptime, bwsServiceStatusEntry=bwsServiceStatusEntry)
