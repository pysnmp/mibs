...
IpAddress, ModuleIdentity, Counter64, Gauge32, Integer32, ObjectIdentity, iso, TimeTicks, Counter32, Unsigned32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Counter64", "Gauge32", "Integer32", "ObjectIdentity", "iso", "TimeTicks", "Counter32", "Unsigned32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyTotalConn=httpProxyTotalConn, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, freeMem=freeMem, bwsServiceStatusTable=bwsServiceStatusTable, totalMem=totalMem, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrPort=httpSrvrPort, httpSrvrTotRefused=httpSrvrTotRefused, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, memoryUsageHigh=memoryUsageHigh, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serviceName=serviceName, ipsUrlNormPort=ipsUrlNormPort, raidDegrading=raidDegrading, httpProxyUnknownRsp=httpProxyUnknownRsp, webCacheAddress=webCacheAddress, httpSrvrTotResponse=httpSrvrTotResponse, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyClientAbrt=httpProxyClientAbrt, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsSMUserSessionTable=bwsSMUserSessionTable, ipsHdrAclHits=ipsHdrAclHits, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsUrlAclReserved=ipsUrlAclReserved, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsStats=bwsStats, ipsHdrAclPort=ipsHdrAclPort, ipsCookieSecAddressType=ipsCookieSecAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, highAvailabilityStatus=highAvailabilityStatus, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, activeServers=activeServers, httpSrvrAddressType=httpSrvrAddressType, webCacheCachedObjects=webCacheCachedObjects, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, firmwareStorageHigh=firmwareStorageHigh, cpuUtilization=cpuUtilization, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyTotalReq=httpProxyTotalReq, bwsCacheStatsTable=bwsCacheStatsTable, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyCacheHits=sslProxyCacheHits, serverUp=serverUp, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsMIBGroups=bwsMIBGroups, bwsCompressionStatsTable=bwsCompressionStatsTable, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, cpuFanSpeed=cpuFanSpeed, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, firmwareUpdateAvailable=firmwareUpdateAvailable, activeApplications=activeApplications, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, totalAttacks=totalAttacks, bwsMIBConformance=bwsMIBConformance, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrAddressType=sslSrvrAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, totalApplications=totalApplications, systemSerialNumber=systemSerialNumber, servicePort=servicePort, srvcName=srvcName, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, fanDead=fanDead, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyAddressType=httpProxyAddressType, sslProxyAddress=sslProxyAddress, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, totalServers=totalServers, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, systemFailOver=systemFailOver, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, tempCritical=tempCritical, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsReqSrvcPort=ipsReqSrvcPort, bwsCacheStatsEntry=bwsCacheStatsEntry, energizeUpdateExpire=energizeUpdateExpire, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpProxyOutBytes=httpProxyOutBytes, bwsStatsGroup=bwsStatsGroup, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, serviceAddress=serviceAddress, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrOutBytes=sslSrvrOutBytes, ipsCookieSecPort=ipsCookieSecPort, webCacheStale=webCacheStale, dataPortLinkDown=dataPortLinkDown, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrState=sslSrvrState, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, logStorageHigh=logStorageHigh, httpSrvrOutBytes=httpSrvrOutBytes, operationalMode=operationalMode, sslProxyTotalReq=sslProxyTotalReq, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsRCAddress=ipsRCAddress, systemFanSpeed=systemFanSpeed, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyServerErr=httpProxyServerErr, ipsRCTotOutOfResource=ipsRCTotOutOfResource, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCacheHits=webCacheHits, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwstraps=bwstraps, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransPort=ipsWebAddrTransPort, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, tempHigh=tempHigh, sslSrvrNumConn=sslSrvrNumConn, webCmprPort=webCmprPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsRCTimeStamp=ipsRCTimeStamp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheProtocol=webCacheProtocol, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyServerReq=httpProxyServerReq, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, serverDown=serverDown, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslSrvrNumFreeConn=sslSrvrNumFreeConn, switchingToMaintMode=switchingToMaintMode, webCacheAddressType=webCacheAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, processCountHigh=processCountHigh, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, dataPortLinkUp=dataPortLinkUp, sslProxyCurrentConn=sslProxyCurrentConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, webCacheMiss=webCacheMiss, sslSrvrTotRefused=sslSrvrTotRefused, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrNumConn=httpSrvrNumConn, bwsMIBCompliance=bwsMIBCompliance, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, systemFailure=systemFailure, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpSrvrInBytes=httpSrvrInBytes, sslSrvrPort=sslSrvrPort, linkStatus=linkStatus, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlAclPort=ipsUrlAclPort, peerDown=peerDown, switchingToInlineMode=switchingToInlineMode, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, ipsRCTotDropped=ipsRCTotDropped, sslSrvrAddress=sslSrvrAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, sslProxyErrPms=sslProxyErrPms, webCacheCacheableRes=webCacheCacheableRes, sslProxyInBytes=sslProxyInBytes, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCacheLongHdrs=webCacheLongHdrs, currentFirmwareVersion=currentFirmwareVersion, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyOutBytes=sslProxyOutBytes, webCmprAddress=webCmprAddress, bwsMIBCompliances=bwsMIBCompliances, httpProxyInBytes=httpProxyInBytes, ipsRCPort=ipsRCPort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrSrvcAddress=sslSrvrSrvcAddress, peerUp=peerUp, smRealmName=smRealmName, logStorage=logStorage, ipsRCAddressType=ipsRCAddressType, ipsRCTotQueued=ipsRCTotQueued, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, cpuTemperature=cpuTemperature, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, firmwareStorage=firmwareStorage, PYSNMP_MODULE_ID=bws, bwsMessage=bwsMessage, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyTotalConn=sslProxyTotalConn, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyParseErr=httpProxyParseErr, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsSMUserSessionEntry=bwsSMUserSessionEntry, systemLoad=systemLoad, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, webCachePort=webCachePort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrTotReqRejected=httpSrvrTotReqRejected, dataPathStatus=dataPathStatus, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyPort=sslProxyPort, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCacheReq=webCacheReq, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCacheBytesOut=webCacheBytesOut, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsCookieSecAddress=ipsCookieSecAddress, smNumUserSessions=smNumUserSessions, httpProxyAddress=httpProxyAddress, securityDefUpdates=securityDefUpdates, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, switchingToBypassMode=switchingToBypassMode, totalBandwidth=totalBandwidth, ipsRCTotServed=ipsRCTotServed, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, vipStatus=vipStatus, ipsReqLimitPort=ipsReqLimitPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyAddressType=sslProxyAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, serviceStatus=serviceStatus, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, virusDefUpdates=virusDefUpdates, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bws=bws, httpSrvrMaxResTime=httpSrvrMaxResTime, uptime=uptime, httpSrvrTotReqActive=httpSrvrTotReqActive, httpProxyActiveConn=httpProxyActiveConn, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrState=httpSrvrState, smAgentName=smAgentName, sslProxyCacheMiss=sslProxyCacheMiss, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsAccessCtrlPort=ipsAccessCtrlPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyActiveConn=sslProxyActiveConn, memUtilization=memUtilization, sslSrvrInBytes=sslSrvrInBytes, webCmprProtocol=webCmprProtocol, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCmprAddressType=webCmprAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrAddress=httpSrvrAddress, httpProxyPort=httpProxyPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry)
