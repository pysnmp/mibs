...
Counter64, MibIdentifier, Bits, Gauge32, ModuleIdentity, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, iso, Counter32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "Bits", "Gauge32", "ModuleIdentity", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "iso", "Counter32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("BWS-MIB", ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrTotRefused=sslSrvrTotRefused, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, cpuFanSpeed=cpuFanSpeed, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, uptime=uptime, systemFailure=systemFailure, httpSrvrNumConn=httpSrvrNumConn, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, raidDegrading=raidDegrading, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsRCAddressType=ipsRCAddressType, bwsSMUserSessionTable=bwsSMUserSessionTable, switchingToInlineMode=switchingToInlineMode, bwsServiceStatusTable=bwsServiceStatusTable, httpSrvrInBytes=httpSrvrInBytes, memoryUsageHigh=memoryUsageHigh, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlAclAddressType=ipsUrlAclAddressType, freeMem=freeMem, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, httpProxyAddress=httpProxyAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheBytesOut=webCacheBytesOut, bws=bws, tempCritical=tempCritical, sslSrvrAvgResTime=sslSrvrAvgResTime, sslProxyErrPms=sslProxyErrPms, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsRCTotDropped=ipsRCTotDropped, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCacheStale=webCacheStale, sslProxyTotalConn=sslProxyTotalConn, firmwareStorageHigh=firmwareStorageHigh, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, fanDead=fanDead, dataPathStatus=dataPathStatus, bwsTrapGroup=bwsTrapGroup, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrSrvcPort=sslSrvrSrvcPort, totalMem=totalMem, ipsCookieSecPort=ipsCookieSecPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, virusDefUpdates=virusDefUpdates, smRealmName=smRealmName, ipsRCTotServed=ipsRCTotServed, sslProxyActiveConn=sslProxyActiveConn, ipsUrlNormPort=ipsUrlNormPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, cpuUtilization=cpuUtilization, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsCacheStatsTable=bwsCacheStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlAclPort=ipsUrlAclPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, webCacheCacheableRes=webCacheCacheableRes, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrMinResTime=sslSrvrMinResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, systemFailOver=systemFailOver, activeServers=activeServers, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, httpProxyOutBytes=httpProxyOutBytes, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, totalServers=totalServers, servicePort=servicePort, httpProxyAddressType=httpProxyAddressType, sslProxyFullHandshakes=sslProxyFullHandshakes, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, switchingToMaintMode=switchingToMaintMode, memUtilization=memUtilization, bwsMIBCompliance=bwsMIBCompliance, webCacheAddress=webCacheAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsReqSrvcPort=ipsReqSrvcPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, highAvailabilityStatus=highAvailabilityStatus, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCacheHits=webCacheHits, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheCachedObjects=webCacheCachedObjects, webCacheReq=webCacheReq, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyCacheHits=sslProxyCacheHits, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslProxyAddressType=sslProxyAddressType, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsMIBGroups=bwsMIBGroups, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrAddress=httpSrvrAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpSrvrTotResponse=httpSrvrTotResponse, webCmprProtocol=webCmprProtocol, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCacheProtocol=webCacheProtocol, sslSrvrState=sslSrvrState, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyPort=httpProxyPort, httpProxyServerReq=httpProxyServerReq, bwsMessage=bwsMessage, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyInBytes=sslProxyInBytes, httpSrvrAddressType=httpSrvrAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsMIBCompliances=bwsMIBCompliances, webCmprPort=webCmprPort, srvcName=srvcName, dataPortLinkDown=dataPortLinkDown, sslProxyPort=sslProxyPort, sslSrvrAddressType=sslSrvrAddressType, serviceName=serviceName, ipsRCTotQueued=ipsRCTotQueued, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, totalApplications=totalApplications, PYSNMP_MODULE_ID=bws, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyWAFWarnings=httpProxyWAFWarnings, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrState=httpSrvrState, httpProxyTotalReq=httpProxyTotalReq, webCachePort=webCachePort, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCacheAddressType=webCacheAddressType, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpProxyServerErr=httpProxyServerErr, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, firmwareStorage=firmwareStorage, logStorage=logStorage, securityDefUpdates=securityDefUpdates, ipsRCTimeStamp=ipsRCTimeStamp, linkStatus=linkStatus, activeApplications=activeApplications, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsCookieSecAddressType=ipsCookieSecAddressType, webCmprAddress=webCmprAddress, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsHdrAclHits=ipsHdrAclHits, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrInBytes=sslSrvrInBytes, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitPort=ipsReqLimitPort, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsRCAddress=ipsRCAddress, sslSrvrPort=sslSrvrPort, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormAddressType=ipsUrlNormAddressType, peerUp=peerUp, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, systemSerialNumber=systemSerialNumber, httpSrvrAvgResTime=httpSrvrAvgResTime, switchingToBypassMode=switchingToBypassMode, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCPort=ipsRCPort, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, httpSrvrOutBytes=httpSrvrOutBytes, webCacheMiss=webCacheMiss, dataPortLinkUp=dataPortLinkUp, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, serviceStatus=serviceStatus, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrNumFreeConn=httpSrvrNumFreeConn, processCountHigh=processCountHigh, systemLoad=systemLoad, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, serverDown=serverDown, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyAddress=sslProxyAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, ipsCookieSecTampered=ipsCookieSecTampered, systemFanSpeed=systemFanSpeed, httpProxyActiveConn=httpProxyActiveConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsHdrAclAddress=ipsHdrAclAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled)
mibBuilder.exportSymbols("BWS-MIB", operationalMode=operationalMode, httpProxyInBytes=httpProxyInBytes, webCmprAddressType=webCmprAddressType, totalAttacks=totalAttacks, serviceAddress=serviceAddress, vipStatus=vipStatus, httpSrvrPort=httpSrvrPort, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, logStorageHigh=logStorageHigh, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsHdrAclPort=ipsHdrAclPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, bwsStats=bwsStats, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, tempHigh=tempHigh, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, httpProxyUnknownRsp=httpProxyUnknownRsp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrNumConn=sslSrvrNumConn, bwstraps=bwstraps, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyTotalReq=sslProxyTotalReq, serverUp=serverUp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpProxyTotalConn=httpProxyTotalConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrOutBytes=sslSrvrOutBytes, peerDown=peerDown, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsMIBConformance=bwsMIBConformance, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsLrnSrvcPort=ipsLrnSrvcPort, httpProxyParseErr=httpProxyParseErr, smNumUserSessions=smNumUserSessions, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, cpuTemperature=cpuTemperature, sslProxyCacheMiss=sslProxyCacheMiss, sslSrvrTotReqActive=sslSrvrTotReqActive, totalBandwidth=totalBandwidth, httpSrvrMinResTime=httpSrvrMinResTime, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, smAgentName=smAgentName, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheLongHdrs=webCacheLongHdrs, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry)
