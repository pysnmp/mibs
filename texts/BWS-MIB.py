...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ObjectIdentity, Integer32, NotificationType, Unsigned32, MibIdentifier, Gauge32, TimeTicks, ModuleIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ObjectIdentity", "Integer32", "NotificationType", "Unsigned32", "MibIdentifier", "Gauge32", "TimeTicks", "ModuleIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpProxyWAFWarnings=httpProxyWAFWarnings, webCacheHits=webCacheHits, httpProxySessionTimeOut=httpProxySessionTimeOut, sslSrvrPort=sslSrvrPort, highAvailabilityStatus=highAvailabilityStatus, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrMinResTime=httpSrvrMinResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, logStorageHigh=logStorageHigh, uptime=uptime, switchingToInlineMode=switchingToInlineMode, serverDown=serverDown, sslSrvrAddressType=sslSrvrAddressType, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, dataPortLinkUp=dataPortLinkUp, sslProxyAddress=sslProxyAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyBadCRLErr=sslProxyBadCRLErr, bwsMessage=bwsMessage, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsHdrAclAddress=ipsHdrAclAddress, bwsServiceStatusTable=bwsServiceStatusTable, webCacheAddressType=webCacheAddressType, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, firmwareStorageHigh=firmwareStorageHigh, webCacheCacheableRes=webCacheCacheableRes, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrAddress=httpSrvrAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslProxyTotalConn=sslProxyTotalConn, ipsCookieSecPort=ipsCookieSecPort, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsUrlPolicyPort=ipsUrlPolicyPort, httpProxyTotalReq=httpProxyTotalReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyServerErr=httpProxyServerErr, activeApplications=activeApplications, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrAddress=sslSrvrAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, peerUp=peerUp, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrInBytes=httpSrvrInBytes, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsCookieSecTampered=ipsCookieSecTampered, ipsRCTotServed=ipsRCTotServed, switchingToBypassMode=switchingToBypassMode, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, energizeUpdateExpire=energizeUpdateExpire, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, cpuFanSpeed=cpuFanSpeed, bwsMIBCompliance=bwsMIBCompliance, httpSrvrTotRefused=httpSrvrTotRefused, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsStats=bwsStats, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, cpuTemperature=cpuTemperature, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlNormAddress=ipsUrlNormAddress, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsRCTimeStamp=ipsRCTimeStamp, bwsMIBCompliances=bwsMIBCompliances, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, raidDegrading=raidDegrading, memoryUsageHigh=memoryUsageHigh, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlNormAddressType=ipsUrlNormAddressType, sslProxyOutBytes=sslProxyOutBytes, serviceAddress=serviceAddress, ipsUrlNormPort=ipsUrlNormPort, sslSrvrTotReqActive=sslSrvrTotReqActive, sslSrvrState=sslSrvrState, dataPortLinkDown=dataPortLinkDown, webCmprProtocol=webCmprProtocol, securityDefUpdates=securityDefUpdates, httpProxyParseErr=httpProxyParseErr, sslProxyCacheHits=sslProxyCacheHits, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, totalBandwidth=totalBandwidth, httpSrvrPort=httpSrvrPort, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyAddress=httpProxyAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, smRealmName=smRealmName, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, vipStatus=vipStatus, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsRCPort=ipsRCPort, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyErrPms=sslProxyErrPms, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, dataPathStatus=dataPathStatus, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsRCTotQueued=ipsRCTotQueued, ipsCookieSecAddress=ipsCookieSecAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxyTotalConn=httpProxyTotalConn, systemFanSpeed=systemFanSpeed, switchingToMaintMode=switchingToMaintMode, httpSrvrState=httpSrvrState, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, webCacheProtocol=webCacheProtocol, systemSerialNumber=systemSerialNumber, srvcName=srvcName, bwstraps=bwstraps, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, sslProxyPort=sslProxyPort, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyCurrentConn=sslProxyCurrentConn, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, freeMem=freeMem, webCachePort=webCachePort, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCmprAddressType=webCmprAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsHdrAclPort=ipsHdrAclPort, ipsReqLimitAddress=ipsReqLimitAddress, bwsMIBConformance=bwsMIBConformance, httpSrvrTotResponse=httpSrvrTotResponse, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqLimitPort=ipsReqLimitPort, httpSrvrAddressType=httpSrvrAddressType, webCacheStale=webCacheStale, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, totalMem=totalMem, memUtilization=memUtilization, sslSrvrMinResTime=sslSrvrMinResTime, ipsHdrAclHits=ipsHdrAclHits, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlAclPort=ipsUrlAclPort, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, peerDown=peerDown, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, bwsTrapGroup=bwsTrapGroup, httpProxyServerAbrt=httpProxyServerAbrt, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpSrvrTotReqActive=httpSrvrTotReqActive, totalApplications=totalApplications, sslProxyActiveConn=sslProxyActiveConn, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, tempCritical=tempCritical, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, currentFirmwareVersion=currentFirmwareVersion, ipsReqSrvcPort=ipsReqSrvcPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, systemFailOver=systemFailOver, serverUp=serverUp, webCacheMiss=webCacheMiss, httpProxyServerReq=httpProxyServerReq, systemFailure=systemFailure, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrOutBytes=sslSrvrOutBytes, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyAddressType=sslProxyAddressType, httpProxyPort=httpProxyPort, activeServers=activeServers, linkStatus=linkStatus, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyActiveConn=httpProxyActiveConn, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheLongHdrs=webCacheLongHdrs, virusDefUpdates=virusDefUpdates, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrTotTimedout=sslSrvrTotTimedout, processCountHigh=processCountHigh, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, servicePort=servicePort, sslSrvrTotRefused=sslSrvrTotRefused, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyUnknownRsp=httpProxyUnknownRsp, PYSNMP_MODULE_ID=bws, tempHigh=tempHigh, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, webCmprPort=webCmprPort, totalAttacks=totalAttacks, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, firmwareStorage=firmwareStorage, sslSrvrNumConn=sslSrvrNumConn, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrTotReqRejected=sslSrvrTotReqRejected, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsRCTotDropped=ipsRCTotDropped, httpProxyClientAbrt=httpProxyClientAbrt, webCmprAddress=webCmprAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, webCacheReq=webCacheReq)
mibBuilder.exportSymbols("BWS-MIB", httpSrvrSrvcPort=httpSrvrSrvcPort, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslProxyCacheTimeouts=sslProxyCacheTimeouts, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyAddressType=httpProxyAddressType, httpSrvrNumConn=httpSrvrNumConn, bwsStatsGroup=bwsStatsGroup, sslProxyTotalReq=sslProxyTotalReq, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, firmwareUpdateAvailable=firmwareUpdateAvailable, systemLoad=systemLoad, cpuUtilization=cpuUtilization, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheCachedObjects=webCacheCachedObjects, bwsSMUserSessionTable=bwsSMUserSessionTable, bws=bws, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, operationalMode=operationalMode, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsRCAddress=ipsRCAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, serviceName=serviceName, ipsUrlAclAddress=ipsUrlAclAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, serviceStatus=serviceStatus, logStorage=logStorage, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, httpProxyInBytes=httpProxyInBytes, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsRCAddressType=ipsRCAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, smNumUserSessions=smNumUserSessions, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, smAgentName=smAgentName, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsReqSrvcAddress=ipsReqSrvcAddress, fanDead=fanDead, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, webCacheAddress=webCacheAddress, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, totalServers=totalServers, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyInBytes=sslProxyInBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyOutBytes=httpProxyOutBytes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned)
