...
Bits, Counter32, ModuleIdentity, Unsigned32, IpAddress, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, Counter64, TimeTicks, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "ModuleIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "Counter64", "TimeTicks", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCmprPort=webCmprPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyActiveConn=httpProxyActiveConn, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, totalApplications=totalApplications, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, smNumUserSessions=smNumUserSessions, PYSNMP_MODULE_ID=bws, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCacheAddressType=webCacheAddressType, ipsUrlAclReserved=ipsUrlAclReserved, serviceName=serviceName, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCmprAddressType=webCmprAddressType, ipsReqLimitPort=ipsReqLimitPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyClientAbrt=httpProxyClientAbrt, bwsStatsGroup=bwsStatsGroup, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslProxyBadCRLErr=sslProxyBadCRLErr, webCacheHits=webCacheHits, ipsUrlNormAddressType=ipsUrlNormAddressType, bwsMIBGroups=bwsMIBGroups, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslProxyTotalReq=sslProxyTotalReq, processCountHigh=processCountHigh, webCacheCachedObjects=webCacheCachedObjects, httpSrvrState=httpSrvrState, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, energizeUpdateExpire=energizeUpdateExpire, bwsCacheStatsTable=bwsCacheStatsTable, tempHigh=tempHigh, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyAddress=httpProxyAddress, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, sslSrvrTotResponse=sslSrvrTotResponse, webCacheAddress=webCacheAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsUrlNormPort=ipsUrlNormPort, fanDead=fanDead, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxyServerErr=httpProxyServerErr, tempCritical=tempCritical, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsUrlPolicyAddress=ipsUrlPolicyAddress, webCacheStale=webCacheStale, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyOutBytes=sslProxyOutBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsRCTotServed=ipsRCTotServed, bwsIpsRCStatsTable=bwsIpsRCStatsTable, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsReqLimitAddressType=ipsReqLimitAddressType, httpSrvrTotReqActive=httpSrvrTotReqActive, bwsServiceStatusTable=bwsServiceStatusTable, ipsHdrAclPort=ipsHdrAclPort, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, serverUp=serverUp, ipsCookieSecPort=ipsCookieSecPort, httpSrvrTotTimedout=httpSrvrTotTimedout, sslProxyActiveConn=sslProxyActiveConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, securityDefUpdates=securityDefUpdates, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, newAttackDefinitionInstalled=newAttackDefinitionInstalled, systemFanSpeed=systemFanSpeed, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, currentFirmwareVersion=currentFirmwareVersion, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrMaxResTime=sslSrvrMaxResTime, systemLoad=systemLoad, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, dataPortLinkUp=dataPortLinkUp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyPort=httpProxyPort, httpProxySessionTimeOut=httpProxySessionTimeOut, dataPathStatus=dataPathStatus, webCacheLongHdrs=webCacheLongHdrs, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlPolicyPort=ipsUrlPolicyPort, vipStatus=vipStatus, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, serviceStatus=serviceStatus, httpSrvrNumConn=httpSrvrNumConn, ipsAccessCtrlPort=ipsAccessCtrlPort, smAgentName=smAgentName, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrAddressType=sslSrvrAddressType, ipsRCTotDropped=ipsRCTotDropped, activeServers=activeServers, logStorageHigh=logStorageHigh, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrPort=sslSrvrPort, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, httpProxyTotalReq=httpProxyTotalReq, bwsCompressionStatsTable=bwsCompressionStatsTable, operationalMode=operationalMode, webCacheProtocol=webCacheProtocol, ipsWebAddrTransPort=ipsWebAddrTransPort, bwstraps=bwstraps, sslSrvrState=sslSrvrState, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsTrapGroup=bwsTrapGroup, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpSrvrTotResponse=httpSrvrTotResponse, switchingToMaintMode=switchingToMaintMode, httpSrvrTotRefused=httpSrvrTotRefused, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsRCTimeStamp=ipsRCTimeStamp, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, virusDefUpdates=virusDefUpdates, httpProxyParseErr=httpProxyParseErr, sharedSecretKeyExpired=sharedSecretKeyExpired, peerUp=peerUp, cpuUtilization=cpuUtilization, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, httpSrvrPort=httpSrvrPort, httpSrvrAddressType=httpSrvrAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCAddress=ipsRCAddress, logStorage=logStorage, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, systemFailure=systemFailure, bwsCompressionStatsEntry=bwsCompressionStatsEntry, bwsMIBCompliances=bwsMIBCompliances, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, serviceAddress=serviceAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrAddress=sslSrvrAddress, firmwareStorage=firmwareStorage, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, bwsMessage=bwsMessage, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, linkStatus=linkStatus, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrTotTimedout=sslSrvrTotTimedout, webCacheReq=webCacheReq, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrSrvcAddress=sslSrvrSrvcAddress, httpProxyInBytes=httpProxyInBytes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyServerReq=httpProxyServerReq, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, highAvailabilityStatus=highAvailabilityStatus, ipsRCPort=ipsRCPort, sslProxyCacheMiss=sslProxyCacheMiss, systemFailOver=systemFailOver, systemSerialNumber=systemSerialNumber, cpuTemperature=cpuTemperature, totalServers=totalServers, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, bws=bws, totalAttacks=totalAttacks, sslProxyAddressType=sslProxyAddressType, webCachePort=webCachePort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrOutBytes=httpSrvrOutBytes, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, servicePort=servicePort, totalMem=totalMem, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsReqSrvcAddress=ipsReqSrvcAddress, httpSrvrMaxResTime=httpSrvrMaxResTime, serverDown=serverDown, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheMiss=webCacheMiss, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, httpSrvrAddress=httpSrvrAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrMinResTime=httpSrvrMinResTime, smRealmName=smRealmName, webCmprAddress=webCmprAddress, bwsStats=bwsStats, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyAddressType=httpProxyAddressType, sslProxyCacheHits=sslProxyCacheHits, activeApplications=activeApplications, srvcName=srvcName, ipsUrlNormAddress=ipsUrlNormAddress)
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsMIBConformance=bwsMIBConformance, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, ipsHdrAclHits=ipsHdrAclHits, freeMem=freeMem, sslSrvrInBytes=sslSrvrInBytes, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyPort=sslProxyPort, firmwareStorageHigh=firmwareStorageHigh, sslProxyAddress=sslProxyAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, dataPortLinkDown=dataPortLinkDown, memUtilization=memUtilization, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsRCTotQueued=ipsRCTotQueued, httpSrvrInBytes=httpSrvrInBytes, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyTotalConn=httpProxyTotalConn, bwsMIBCompliance=bwsMIBCompliance, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, memoryUsageHigh=memoryUsageHigh, ipsReqSrvcPort=ipsReqSrvcPort, ipsWebAddrTransAddress=ipsWebAddrTransAddress, peerDown=peerDown, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsHdrAclAddressType=ipsHdrAclAddressType, raidDegrading=raidDegrading, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, cpuFanSpeed=cpuFanSpeed, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyErrPms=sslProxyErrPms, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, switchingToInlineMode=switchingToInlineMode, totalBandwidth=totalBandwidth, sslProxyInBytes=sslProxyInBytes, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyTotalConn=sslProxyTotalConn, webCmprProtocol=webCmprProtocol, ipsHdrAclAddress=ipsHdrAclAddress, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlAclPort=ipsUrlAclPort, sslSrvrSrvcPort=sslSrvrSrvcPort, sslSrvrAvgResTime=sslSrvrAvgResTime, webCacheCacheableRes=webCacheCacheableRes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheBytesOut=webCacheBytesOut, switchingToBypassMode=switchingToBypassMode, sslSrvrTotRefused=sslSrvrTotRefused, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsRCAddressType=ipsRCAddressType, httpProxyOutBytes=httpProxyOutBytes, uptime=uptime, bwsSMUserSessionTable=bwsSMUserSessionTable)
