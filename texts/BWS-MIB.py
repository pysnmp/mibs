...
IpAddress, Bits, ObjectIdentity, ModuleIdentity, Gauge32, MibIdentifier, NotificationType, Unsigned32, TimeTicks, Integer32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "ObjectIdentity", "ModuleIdentity", "Gauge32", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks", "Integer32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrPort=httpSrvrPort, dataPortLinkUp=dataPortLinkUp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrOutBytes=httpSrvrOutBytes, cpuTemperature=cpuTemperature, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsRCTimeStamp=ipsRCTimeStamp, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, currentFirmwareVersion=currentFirmwareVersion, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsRCPort=ipsRCPort, httpProxyTotalReq=httpProxyTotalReq, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsMIBConformance=bwsMIBConformance, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrMinResTime=httpSrvrMinResTime, highAvailabilityStatus=highAvailabilityStatus, webCmprPort=webCmprPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrSrvcPort=httpSrvrSrvcPort, totalMem=totalMem, serviceName=serviceName, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCacheStale=webCacheStale, webCacheBytesOut=webCacheBytesOut, httpSrvrNumConn=httpSrvrNumConn, httpProxyInBytes=httpProxyInBytes, ipsUrlAclReserved=ipsUrlAclReserved, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqSrvcAddressType=ipsReqSrvcAddressType, cpuFanSpeed=cpuFanSpeed, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqLimitAddress=ipsReqLimitAddress, ipsCookieSecAddress=ipsCookieSecAddress, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyUnknownRsp=httpProxyUnknownRsp, processCountHigh=processCountHigh, ipsCookieSecEncrypted=ipsCookieSecEncrypted, switchingToBypassMode=switchingToBypassMode, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsServiceStatusTable=bwsServiceStatusTable, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyFullHandshakes=sslProxyFullHandshakes, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, tempHigh=tempHigh, uptime=uptime, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, bwsMIBCompliance=bwsMIBCompliance, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyPort=sslProxyPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpProxyOutBytes=httpProxyOutBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrOutBytes=sslSrvrOutBytes, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsRCAddress=ipsRCAddress, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyServerErr=httpProxyServerErr, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, firmwareStorage=firmwareStorage, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, webCachePort=webCachePort, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsTrapGroup=bwsTrapGroup, ipsUrlNormPort=ipsUrlNormPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsHdrAclHits=ipsHdrAclHits, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyAddressType=sslProxyAddressType, sslProxyErrPms=sslProxyErrPms, webCmprAddress=webCmprAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, webCmprProtocol=webCmprProtocol, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlPolicyAddress=ipsUrlPolicyAddress, httpSrvrTotReqActive=httpSrvrTotReqActive, srvcName=srvcName, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsHdrAclPort=ipsHdrAclPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, activeApplications=activeApplications, ipsRCAddressType=ipsRCAddressType, httpProxyParseErr=httpProxyParseErr, webCacheCacheableRes=webCacheCacheableRes, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, webCmprAddressType=webCmprAddressType, serviceAddress=serviceAddress, sslSrvrTotRefused=sslSrvrTotRefused, logStorage=logStorage, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrTotSuccess=sslSrvrTotSuccess, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, systemFailOver=systemFailOver, PYSNMP_MODULE_ID=bws, newAttackDefinitionInstalled=newAttackDefinitionInstalled, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrInBytes=sslSrvrInBytes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsRCTotOutOfResource=ipsRCTotOutOfResource, dataPortLinkDown=dataPortLinkDown, servicePort=servicePort, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsCacheStatsTable=bwsCacheStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsMessage=bwsMessage, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, cpuUtilization=cpuUtilization, httpProxyAddress=httpProxyAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, firmwareStorageHigh=firmwareStorageHigh, httpProxyServerAbrt=httpProxyServerAbrt, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, securityDefUpdates=securityDefUpdates, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsMIBGroups=bwsMIBGroups, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, memUtilization=memUtilization, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotResponse=sslSrvrTotResponse, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, serverDown=serverDown, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsAccessCtrlAddress=ipsAccessCtrlAddress, systemSerialNumber=systemSerialNumber, ipsReqLimitPort=ipsReqLimitPort, sslSrvrPort=sslSrvrPort, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, raidDegrading=raidDegrading, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, httpProxyClientAbrt=httpProxyClientAbrt, fanDead=fanDead, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, peerUp=peerUp, sslProxyCurrentConn=sslProxyCurrentConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, httpSrvrTotTimedout=httpSrvrTotTimedout, httpSrvrInBytes=httpSrvrInBytes, switchingToInlineMode=switchingToInlineMode, httpSrvrAddressType=httpSrvrAddressType, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, httpSrvrState=httpSrvrState, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, sslSrvrTotTimedout=sslSrvrTotTimedout, sslSrvrAddressType=sslSrvrAddressType, webCacheAddress=webCacheAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sslSrvrMinResTime=sslSrvrMinResTime, tempCritical=tempCritical, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, operationalMode=operationalMode, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serverUp=serverUp, sslProxyCacheHits=sslProxyCacheHits, ipsRCTotServed=ipsRCTotServed, httpProxyServerReq=httpProxyServerReq, sslSrvrNumConn=sslSrvrNumConn, ipsRCTotQueued=ipsRCTotQueued, energizeUpdateExpire=energizeUpdateExpire, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslProxyOutBytes=sslProxyOutBytes, webCacheReq=webCacheReq, vipStatus=vipStatus, httpProxyTotalConn=httpProxyTotalConn, sslProxyCacheMiss=sslProxyCacheMiss, bwsSMUserSessionTable=bwsSMUserSessionTable, webCacheLongHdrs=webCacheLongHdrs, freeMem=freeMem, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, systemFailure=systemFailure, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, sslProxyActiveConn=sslProxyActiveConn, ipsRCTotDropped=ipsRCTotDropped, dataPathStatus=dataPathStatus, totalServers=totalServers, bwstraps=bwstraps, totalApplications=totalApplications, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, totalBandwidth=totalBandwidth, systemFanSpeed=systemFanSpeed, peerDown=peerDown, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, bwsCompressionStatsEntry=bwsCompressionStatsEntry, memoryUsageHigh=memoryUsageHigh, ipsCookieSecPort=ipsCookieSecPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlAclPort=ipsUrlAclPort, activeServers=activeServers, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslProxyTotalReq=sslProxyTotalReq, sslSrvrState=sslSrvrState, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyAddress=sslProxyAddress, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, smRealmName=smRealmName)
mibBuilder.exportSymbols("BWS-MIB", ipsReqSrvcAddress=ipsReqSrvcAddress, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, switchingToMaintMode=switchingToMaintMode, httpSrvrAddress=httpSrvrAddress, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrAddress=sslSrvrAddress, httpSrvrTotReqRejected=httpSrvrTotReqRejected, smNumUserSessions=smNumUserSessions, httpProxyAddressType=httpProxyAddressType, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, virusDefUpdates=virusDefUpdates, serviceStatus=serviceStatus, bwsMIBCompliances=bwsMIBCompliances, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, systemLoad=systemLoad, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsCookieSecTampered=ipsCookieSecTampered, ipsLrnSrvcPort=ipsLrnSrvcPort, webCacheMiss=webCacheMiss, bwsStats=bwsStats, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, linkStatus=linkStatus, webCacheProtocol=webCacheProtocol, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlAclAddress=ipsUrlAclAddress, httpProxyActiveConn=httpProxyActiveConn, ipsReqLimitAddressType=ipsReqLimitAddressType, totalAttacks=totalAttacks, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyPort=httpProxyPort, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslProxyInBytes=sslProxyInBytes, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyTotalConn=sslProxyTotalConn, logStorageHigh=logStorageHigh, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqSrvcPort=ipsReqSrvcPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bws=bws, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, webCacheHits=webCacheHits, webCacheAddressType=webCacheAddressType, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsServiceStatusEntry=bwsServiceStatusEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, smAgentName=smAgentName, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyBadDNCErr=sslProxyBadDNCErr, webCmprCompressedDataSize=webCmprCompressedDataSize, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable)
