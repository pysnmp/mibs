...
Unsigned32, Counter32, IpAddress, Gauge32, Counter64, Integer32, ObjectIdentity, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "IpAddress", "Gauge32", "Counter64", "Integer32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("BWS-MIB", serviceAddress=serviceAddress, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsHdrAclAddressType=ipsHdrAclAddressType, webCmprAddressType=webCmprAddressType, switchingToInlineMode=switchingToInlineMode, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsMIBCompliances=bwsMIBCompliances, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, systemFanSpeed=systemFanSpeed, bwsServiceStatusEntry=bwsServiceStatusEntry, logStorage=logStorage, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, httpProxyAddress=httpProxyAddress, bws=bws, httpProxyClientAbrt=httpProxyClientAbrt, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsHdrAclHits=ipsHdrAclHits, httpProxySessionTimeOut=httpProxySessionTimeOut, currentFirmwareVersion=currentFirmwareVersion, serviceStatus=serviceStatus, ipsReqSrvcAddressType=ipsReqSrvcAddressType, operationalMode=operationalMode, sslSrvrAddress=sslSrvrAddress, bwsMIBCompliance=bwsMIBCompliance, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, serviceName=serviceName, vipStatus=vipStatus, httpSrvrInBytes=httpSrvrInBytes, totalServers=totalServers, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrTotRefused=sslSrvrTotRefused, sslProxyBadCRLErr=sslProxyBadCRLErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, systemLoad=systemLoad, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCacheAddress=webCacheAddress, ipsUrlAclReserved=ipsUrlAclReserved, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, cpuTemperature=cpuTemperature, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpProxyUnknownRsp=httpProxyUnknownRsp, highAvailabilityStatus=highAvailabilityStatus, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsCookieSecTampered=ipsCookieSecTampered, webCmprAddress=webCmprAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, webCacheAddressType=webCacheAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, smAgentName=smAgentName, sslSrvrMinResTime=sslSrvrMinResTime, httpProxyTotalConn=httpProxyTotalConn, httpSrvrTotTimedout=httpSrvrTotTimedout, dataPortLinkDown=dataPortLinkDown, httpSrvrTotReqActive=httpSrvrTotReqActive, smNumUserSessions=smNumUserSessions, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrTotSuccess=httpSrvrTotSuccess, sslProxyActiveConn=sslProxyActiveConn, sslSrvrState=sslSrvrState, sslSrvrTotResponse=sslSrvrTotResponse, freeMem=freeMem, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwstraps=bwstraps, energizeUpdateExpire=energizeUpdateExpire, ipsReqSrvcPort=ipsReqSrvcPort, httpProxyOutBytes=httpProxyOutBytes, webCmprPort=webCmprPort, dataPathStatus=dataPathStatus, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, memUtilization=memUtilization, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsRCAddressType=ipsRCAddressType, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, webCmprCompressibleDataSize=webCmprCompressibleDataSize, totalBandwidth=totalBandwidth, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsRCTotServed=ipsRCTotServed, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, raidDegrading=raidDegrading, peerUp=peerUp, serverUp=serverUp, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslProxyOutBytes=sslProxyOutBytes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, tempHigh=tempHigh, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, virusDefUpdates=virusDefUpdates, httpSrvrAddressType=httpSrvrAddressType, httpSrvrState=httpSrvrState, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyErrPms=sslProxyErrPms, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecPort=ipsCookieSecPort, sslSrvrOutBytes=sslSrvrOutBytes, bwsMIBGroups=bwsMIBGroups, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsRCTotOutOfResource=ipsRCTotOutOfResource, securityDefUpdates=securityDefUpdates, ipsRCTotDropped=ipsRCTotDropped, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsRCPort=ipsRCPort, httpProxyPort=httpProxyPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsRCTotQueued=ipsRCTotQueued, ipsCookieSecEncrypted=ipsCookieSecEncrypted, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheCacheableRes=webCacheCacheableRes, bwsServiceStatusTable=bwsServiceStatusTable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsMessage=bwsMessage, httpSrvrOutBytes=httpSrvrOutBytes, ipsHdrAclPort=ipsHdrAclPort, httpProxyServerErr=httpProxyServerErr, webCacheReq=webCacheReq, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, totalApplications=totalApplications, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsHdrAclAddress=ipsHdrAclAddress, ipsReqLimitPort=ipsReqLimitPort, sslProxyInBytes=sslProxyInBytes, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, webCachePort=webCachePort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, systemFailure=systemFailure, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrPort=httpSrvrPort, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrInBytes=sslSrvrInBytes, sslSrvrPort=sslSrvrPort, sslSrvrAddressType=sslSrvrAddressType, sslProxyAddress=sslProxyAddress, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, fanDead=fanDead, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, webCacheProtocol=webCacheProtocol, httpSrvrAddress=httpSrvrAddress, serverDown=serverDown, webCacheMiss=webCacheMiss, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsSMUserSessionTable=bwsSMUserSessionTable, httpProxyTotalReq=httpProxyTotalReq, processCountHigh=processCountHigh, PYSNMP_MODULE_ID=bws, totalAttacks=totalAttacks, totalMem=totalMem, activeServers=activeServers, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsReqLimitAddressType=ipsReqLimitAddressType, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, httpProxyActiveConn=httpProxyActiveConn, sslProxyTotalReq=sslProxyTotalReq, cpuFanSpeed=cpuFanSpeed, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitAddress=ipsReqLimitAddress, systemSerialNumber=systemSerialNumber, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpSrvrMaxResTime=httpSrvrMaxResTime, httpProxyServerAbrt=httpProxyServerAbrt, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, switchingToBypassMode=switchingToBypassMode, activeApplications=activeApplications, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, cpuUtilization=cpuUtilization, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslSrvrSrvcPort=sslSrvrSrvcPort, sharedSecretKeyExpired=sharedSecretKeyExpired, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, servicePort=servicePort, systemFailOver=systemFailOver, linkStatus=linkStatus, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, sslProxyPort=sslProxyPort, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, peerDown=peerDown, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, sslSrvrMaxResTime=sslSrvrMaxResTime, smRealmName=smRealmName, httpProxyServerReq=httpProxyServerReq, httpProxyParseErr=httpProxyParseErr, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslSrvrTotSuccess=sslSrvrTotSuccess, bwsCacheStatsTable=bwsCacheStatsTable, tempCritical=tempCritical, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, bwsMIBConformance=bwsMIBConformance)
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, switchingToMaintMode=switchingToMaintMode, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslProxyAddressType=sslProxyAddressType, sslSrvrNumConn=sslSrvrNumConn, dataPortLinkUp=dataPortLinkUp, sslProxyBadDNCErr=sslProxyBadDNCErr, bwsStatsGroup=bwsStatsGroup, webCacheStale=webCacheStale, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheBytesOut=webCacheBytesOut, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, webCacheCachedObjects=webCacheCachedObjects, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, sslProxyFullHandshakes=sslProxyFullHandshakes, httpSrvrTotReqRejected=httpSrvrTotReqRejected, uptime=uptime, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsRCAddress=ipsRCAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, logStorageHigh=logStorageHigh, ipsCookieSecAddress=ipsCookieSecAddress, firmwareStorageHigh=firmwareStorageHigh, ipsRCTimeStamp=ipsRCTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, firmwareStorage=firmwareStorage, bwsStats=bwsStats, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, webCacheHits=webCacheHits, ipsUrlAclAddressType=ipsUrlAclAddressType, httpSrvrTotResponse=httpSrvrTotResponse, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormPort=ipsUrlNormPort, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlAclPort=ipsUrlAclPort, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, srvcName=srvcName, httpProxyAddressType=httpProxyAddressType, memoryUsageHigh=memoryUsageHigh, sslProxyCurrentConn=sslProxyCurrentConn, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlNormAddressType=ipsUrlNormAddressType, webCacheLongHdrs=webCacheLongHdrs, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyCacheHits=sslProxyCacheHits, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyTotalConn=sslProxyTotalConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, httpProxyInBytes=httpProxyInBytes)
