...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, MibIdentifier, IpAddress, Counter64, Bits, ObjectIdentity, Counter32, iso, Unsigned32, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "MibIdentifier", "IpAddress", "Counter64", "Bits", "ObjectIdentity", "Counter32", "iso", "Unsigned32", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("BWS-MIB", httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, bwsMIBGroups=bwsMIBGroups, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsStats=bwsStats, httpSrvrState=httpSrvrState, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, dataPortLinkUp=dataPortLinkUp, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlAddress=ipsAccessCtrlAddress, switchingToInlineMode=switchingToInlineMode, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCacheCachedObjects=webCacheCachedObjects, bwsCompressionStatsEntry=bwsCompressionStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, serviceName=serviceName, bwsMessage=bwsMessage, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrNumConn=httpSrvrNumConn, processCountHigh=processCountHigh, bwsTrapGroup=bwsTrapGroup, operationalMode=operationalMode, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, tempCritical=tempCritical, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsSMUserSessionTable=bwsSMUserSessionTable, energizeUpdateExpire=energizeUpdateExpire, bwsMIBConformance=bwsMIBConformance, ipsUrlAclAddress=ipsUrlAclAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, systemFailure=systemFailure, httpSrvrTotSuccess=httpSrvrTotSuccess, uptime=uptime, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, sslSrvrTotRefused=sslSrvrTotRefused, webCacheHits=webCacheHits, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsUrlPolicyAddress=ipsUrlPolicyAddress, peerUp=peerUp, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslSrvrState=sslSrvrState, httpSrvrTotReqRejected=httpSrvrTotReqRejected, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, cpuUtilization=cpuUtilization, systemLoad=systemLoad, totalApplications=totalApplications, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, smRealmName=smRealmName, httpSrvrTotResponse=httpSrvrTotResponse, bwsMIBCompliances=bwsMIBCompliances, bwsCacheStatsTable=bwsCacheStatsTable, webCacheAddressType=webCacheAddressType, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyErrPms=sslProxyErrPms, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, webCmprAddress=webCmprAddress, ipsUrlNormAddress=ipsUrlNormAddress, httpSrvrPort=httpSrvrPort, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsUrlAclPort=ipsUrlAclPort, fanDead=fanDead, httpProxyParseErr=httpProxyParseErr, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, securityDefUpdates=securityDefUpdates, smAgentName=smAgentName, httpSrvrAddressType=httpSrvrAddressType, sslProxyActiveConn=sslProxyActiveConn, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsReqLimitAddressType=ipsReqLimitAddressType, totalMem=totalMem, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, sslSrvrOutBytes=sslSrvrOutBytes, ipsHdrAclPort=ipsHdrAclPort, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, totalServers=totalServers, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsRCPort=ipsRCPort, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, totalAttacks=totalAttacks, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyTotalConn=httpProxyTotalConn, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, sslProxyAddress=sslProxyAddress, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsReqLimitPort=ipsReqLimitPort, ipsRCAddress=ipsRCAddress, ipsRCTotQueued=ipsRCTotQueued, logStorage=logStorage, ipsCookieSecPort=ipsCookieSecPort, webCacheReq=webCacheReq, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, switchingToBypassMode=switchingToBypassMode, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsMIBCompliance=bwsMIBCompliance, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, serverDown=serverDown, ipsUrlAclAddressType=ipsUrlAclAddressType, httpProxyInBytes=httpProxyInBytes, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslSrvrAddress=sslSrvrAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, currentFirmwareVersion=currentFirmwareVersion, httpProxyServerErr=httpProxyServerErr, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheBytesOut=webCacheBytesOut, httpProxyOutBytes=httpProxyOutBytes, sslSrvrAddressType=sslSrvrAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrInBytes=sslSrvrInBytes, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, sslProxyAddressType=sslProxyAddressType, httpProxyServerReq=httpProxyServerReq, httpProxyClientAbrt=httpProxyClientAbrt, bws=bws, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, dataPortLinkDown=dataPortLinkDown, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, sslProxyInBytes=sslProxyInBytes, ipsHdrAclAddress=ipsHdrAclAddress, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsCookieSecAddress=ipsCookieSecAddress, bwsServiceStatusTable=bwsServiceStatusTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, sslProxyFullHandshakes=sslProxyFullHandshakes, webCmprProtocol=webCmprProtocol, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, sslProxyCacheMiss=sslProxyCacheMiss, sslProxyCacheTimeouts=sslProxyCacheTimeouts, sslSrvrMaxResTime=sslSrvrMaxResTime, webCacheProtocol=webCacheProtocol, webCacheAddress=webCacheAddress, ipsRCTimeStamp=ipsRCTimeStamp, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheStale=webCacheStale, sslSrvrTotSuccess=sslSrvrTotSuccess, sslSrvrTotResponse=sslSrvrTotResponse, srvcName=srvcName, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, httpSrvrOutBytes=httpSrvrOutBytes, newAttackDefinitionInstalled=newAttackDefinitionInstalled, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrTotTimedout=httpSrvrTotTimedout, webCmprAddressType=webCmprAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, cpuFanSpeed=cpuFanSpeed, ipsRCTotDropped=ipsRCTotDropped, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsReqLimitAddress=ipsReqLimitAddress, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, servicePort=servicePort, ipsCookieSecAddressType=ipsCookieSecAddressType, httpSrvrAddress=httpSrvrAddress, activeApplications=activeApplications, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, systemFanSpeed=systemFanSpeed, smNumUserSessions=smNumUserSessions, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, httpProxyServerAbrt=httpProxyServerAbrt, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyTotalReq=sslProxyTotalReq, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheLongHdrs=webCacheLongHdrs, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyTotalConn=sslProxyTotalConn, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, serverUp=serverUp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, totalBandwidth=totalBandwidth, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, freeMem=freeMem, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, switchingToMaintMode=switchingToMaintMode, httpProxyAddress=httpProxyAddress, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsUrlPolicyPort=ipsUrlPolicyPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, serviceAddress=serviceAddress, sslSrvrTotReqActive=sslSrvrTotReqActive, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpProxySessionTimeOut=httpProxySessionTimeOut, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, bwsServiceStatusEntry=bwsServiceStatusEntry, webCacheCacheableRes=webCacheCacheableRes, highAvailabilityStatus=highAvailabilityStatus, sslProxyOutBytes=sslProxyOutBytes, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, cpuTemperature=cpuTemperature, tempHigh=tempHigh, ipsAccessCtrlPort=ipsAccessCtrlPort, serviceStatus=serviceStatus, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue)
mibBuilder.exportSymbols("BWS-MIB", bwsCompressionStatsTable=bwsCompressionStatsTable, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumConn=sslSrvrNumConn, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsUrlNormPort=ipsUrlNormPort, peerDown=peerDown, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, linkStatus=linkStatus, memoryUsageHigh=memoryUsageHigh, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpProxyPort=httpProxyPort, bwstraps=bwstraps, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsReqSrvcPort=ipsReqSrvcPort, sslProxyPort=sslProxyPort, PYSNMP_MODULE_ID=bws, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, systemSerialNumber=systemSerialNumber, httpProxyActiveConn=httpProxyActiveConn, vipStatus=vipStatus, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, memUtilization=memUtilization, firmwareStorageHigh=firmwareStorageHigh, virusDefUpdates=virusDefUpdates, httpProxyAddressType=httpProxyAddressType, dataPathStatus=dataPathStatus, ipsRCTotServed=ipsRCTotServed, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrPort=sslSrvrPort, httpSrvrInBytes=httpSrvrInBytes, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsRCAddressType=ipsRCAddressType, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyTotalReq=httpProxyTotalReq, activeServers=activeServers, webCacheMiss=webCacheMiss, ipsHdrAclHits=ipsHdrAclHits, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, logStorageHigh=logStorageHigh, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrSrvcAddress=sslSrvrSrvcAddress, systemFailOver=systemFailOver, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, raidDegrading=raidDegrading, sslProxyCacheHits=sslProxyCacheHits, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecEncrypted=ipsCookieSecEncrypted, webCachePort=webCachePort, firmwareStorage=firmwareStorage, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, webCmprPort=webCmprPort)
