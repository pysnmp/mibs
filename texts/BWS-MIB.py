...
Counter64, TimeTicks, Counter32, Unsigned32, Gauge32, NotificationType, IpAddress, Integer32, ObjectIdentity, ModuleIdentity, MibIdentifier, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Counter32", "Unsigned32", "Gauge32", "NotificationType", "IpAddress", "Integer32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", sslProxyBadCRLErr=sslProxyBadCRLErr, totalBandwidth=totalBandwidth, ipsLrnSrvcPort=ipsLrnSrvcPort, sslSrvrMaxResTime=sslSrvrMaxResTime, dataPortLinkDown=dataPortLinkDown, webCacheCachedObjects=webCacheCachedObjects, firmwareUpdateAvailable=firmwareUpdateAvailable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrSrvcPort=sslSrvrSrvcPort, processCountHigh=processCountHigh, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, webCacheAddress=webCacheAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, webCacheAddressType=webCacheAddressType, systemFailOver=systemFailOver, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyServerErr=httpProxyServerErr, cpuFanSpeed=cpuFanSpeed, servicePort=servicePort, systemFailure=systemFailure, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, bwsMIBGroups=bwsMIBGroups, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, sslSrvrAvgResTime=sslSrvrAvgResTime, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, bwsSMUserSessionTable=bwsSMUserSessionTable, activeServers=activeServers, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, totalApplications=totalApplications, httpSrvrAddress=httpSrvrAddress, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyCurrentConn=sslProxyCurrentConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, httpProxyServerReq=httpProxyServerReq, activeApplications=activeApplications, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, smNumUserSessions=smNumUserSessions, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrNumConn=sslSrvrNumConn, cpuTemperature=cpuTemperature, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, bwsTrapGroup=bwsTrapGroup, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, bwsIpsRCStatsTable=bwsIpsRCStatsTable, webCacheCacheableRes=webCacheCacheableRes, webCmprProtocol=webCmprProtocol, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, webCmprCompressibleDataSize=webCmprCompressibleDataSize, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, httpSrvrTotRefused=httpSrvrTotRefused, uptime=uptime, sslSrvrPort=sslSrvrPort, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsHdrAclPort=ipsHdrAclPort, sslProxyAddressType=sslProxyAddressType, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, switchingToMaintMode=switchingToMaintMode, webCacheReq=webCacheReq, webCachePort=webCachePort, ipsReqLimitPort=ipsReqLimitPort, bwsStats=bwsStats, httpProxyParseErr=httpProxyParseErr, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, serviceName=serviceName, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, highAvailabilityStatus=highAvailabilityStatus, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyBadDNCErr=sslProxyBadDNCErr, webCacheLongHdrs=webCacheLongHdrs, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, PYSNMP_MODULE_ID=bws, totalMem=totalMem, httpSrvrPort=httpSrvrPort, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpProxyInBytes=httpProxyInBytes, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlAclReserved=ipsUrlAclReserved, httpSrvrState=httpSrvrState, ipsReqSrvcAddressType=ipsReqSrvcAddressType, freeMem=freeMem, webCacheMiss=webCacheMiss, ipsReqSrvcPort=ipsReqSrvcPort, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, httpProxyAddress=httpProxyAddress, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsUrlNormAddress=ipsUrlNormAddress, raidDegrading=raidDegrading, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecAddress=ipsCookieSecAddress, webCmprAddress=webCmprAddress, httpProxyActiveConn=httpProxyActiveConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, httpSrvrTotTimedout=httpSrvrTotTimedout, bwsServiceStatusEntry=bwsServiceStatusEntry, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsUrlNormPort=ipsUrlNormPort, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, totalServers=totalServers, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrAddressType=sslSrvrAddressType, sslProxyOutBytes=sslProxyOutBytes, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, firmwareStorage=firmwareStorage, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, sslSrvrAddress=sslSrvrAddress, bwsMessage=bwsMessage, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslSrvrState=sslSrvrState, firmwareStorageHigh=firmwareStorageHigh, sslProxyCacheMiss=sslProxyCacheMiss, bwsServiceStatusTable=bwsServiceStatusTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, sslProxyInBytes=sslProxyInBytes, bwsSslProxyStatsTable=bwsSslProxyStatsTable, serviceAddress=serviceAddress, ipsHdrAclAddress=ipsHdrAclAddress, totalAttacks=totalAttacks, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, systemSerialNumber=systemSerialNumber, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, serviceStatus=serviceStatus, sslProxyFullHandshakes=sslProxyFullHandshakes, serverDown=serverDown, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, memoryUsageHigh=memoryUsageHigh, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, dataPathStatus=dataPathStatus, tempHigh=tempHigh, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsRCTotQueued=ipsRCTotQueued, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, webCacheBytesOut=webCacheBytesOut, webCmprCompressedDataSize=webCmprCompressedDataSize, smRealmName=smRealmName, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotSuccess=sslSrvrTotSuccess, httpSrvrInBytes=httpSrvrInBytes, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlAclPort=ipsUrlAclPort, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsRCTotServed=ipsRCTotServed, cpuUtilization=cpuUtilization, bwsMIBCompliance=bwsMIBCompliance, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, bwsMIBCompliances=bwsMIBCompliances, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyUnknownRsp=httpProxyUnknownRsp, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpSrvrNumConn=httpSrvrNumConn, webCmprPort=webCmprPort, tempCritical=tempCritical, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsCookieSecAddressType=ipsCookieSecAddressType, sslSrvrTotTimedout=sslSrvrTotTimedout, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitAddress=ipsReqLimitAddress, ipsUrlPolicyPort=ipsUrlPolicyPort, bwsMIBConformance=bwsMIBConformance, ipsLrnSrvcAddress=ipsLrnSrvcAddress, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyCacheHits=sslProxyCacheHits, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, sslProxyAddress=sslProxyAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, memUtilization=memUtilization, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, sslProxyPort=sslProxyPort, ipsRCTotDropped=ipsRCTotDropped, httpSrvrSrvcPort=httpSrvrSrvcPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyActiveConn=sslProxyActiveConn, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrTotResponse=httpSrvrTotResponse, switchingToBypassMode=switchingToBypassMode, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpProxyServerAbrt=httpProxyServerAbrt, ipsRCAddressType=ipsRCAddressType, vipStatus=vipStatus, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, operationalMode=operationalMode, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrAvgResTime=httpSrvrAvgResTime, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, dataPortLinkUp=dataPortLinkUp, webCacheStale=webCacheStale, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, securityDefUpdates=securityDefUpdates, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyTotalReq=sslProxyTotalReq, httpProxyTotalReq=httpProxyTotalReq, virusDefUpdates=virusDefUpdates, peerDown=peerDown, srvcName=srvcName, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, bwsStatsGroup=bwsStatsGroup, httpProxyOutBytes=httpProxyOutBytes, currentFirmwareVersion=currentFirmwareVersion, webCmprAddressType=webCmprAddressType, ipsWebAddrTransAddress=ipsWebAddrTransAddress, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, systemFanSpeed=systemFanSpeed, bwsCompressionStatsTable=bwsCompressionStatsTable, httpProxySessionTimeOut=httpProxySessionTimeOut, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, ipsCookieSecTampered=ipsCookieSecTampered, fanDead=fanDead, bwstraps=bwstraps)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlAclAddressType=ipsUrlAclAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bws=bws, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslProxyErrPms=sslProxyErrPms, httpSrvrAddressType=httpSrvrAddressType, httpSrvrMinResTime=httpSrvrMinResTime, bwsCacheStatsEntry=bwsCacheStatsEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, smAgentName=smAgentName, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsUrlNormAddressType=ipsUrlNormAddressType, linkStatus=linkStatus, serverUp=serverUp, sharedSecretKeyExpired=sharedSecretKeyExpired, systemLoad=systemLoad, logStorage=logStorage, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxyTotalConn=httpProxyTotalConn, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, sslProxyTotalConn=sslProxyTotalConn, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, httpProxyPort=httpProxyPort, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyCacheTimeouts=sslProxyCacheTimeouts, energizeUpdateExpire=energizeUpdateExpire, sslSrvrOutBytes=sslSrvrOutBytes, httpProxyClientAbrt=httpProxyClientAbrt, logStorageHigh=logStorageHigh, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, webCacheHits=webCacheHits, ipsRCTimeStamp=ipsRCTimeStamp, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsRCAddress=ipsRCAddress, peerUp=peerUp, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsRCPort=ipsRCPort, httpProxyAddressType=httpProxyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrTotRefused=sslSrvrTotRefused, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslSrvrInBytes=sslSrvrInBytes, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, httpSrvrOutBytes=httpSrvrOutBytes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsHdrAclHits=ipsHdrAclHits, switchingToInlineMode=switchingToInlineMode, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, webCacheProtocol=webCacheProtocol, ipsCookieSecPort=ipsCookieSecPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr)
