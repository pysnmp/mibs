...
Bits, iso, IpAddress, ModuleIdentity, Unsigned32, TimeTicks, Counter32, ObjectIdentity, Counter64, MibIdentifier, Integer32, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "IpAddress", "ModuleIdentity", "Unsigned32", "TimeTicks", "Counter32", "ObjectIdentity", "Counter64", "MibIdentifier", "Integer32", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsUrlNormAddress=ipsUrlNormAddress, ipsRCTimeStamp=ipsRCTimeStamp, bwsSMUserSessionTable=bwsSMUserSessionTable, httpSrvrAddress=httpSrvrAddress, switchingToInlineMode=switchingToInlineMode, ipsUrlAclPort=ipsUrlAclPort, activeApplications=activeApplications, webCacheHits=webCacheHits, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, switchingToMaintMode=switchingToMaintMode, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, cpuTemperature=cpuTemperature, sslSrvrAddressType=sslSrvrAddressType, sslProxyTotalConn=sslProxyTotalConn, tempCritical=tempCritical, webCacheMiss=webCacheMiss, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCmprCompressibleDataSize=webCmprCompressibleDataSize, currentFirmwareVersion=currentFirmwareVersion, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, httpSrvrTotResponse=httpSrvrTotResponse, logStorage=logStorage, sslSrvrInBytes=sslSrvrInBytes, sslSrvrNumFreeConn=sslSrvrNumFreeConn, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwstraps=bwstraps, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, smRealmName=smRealmName, webCmprAddressType=webCmprAddressType, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlAclAddressType=ipsUrlAclAddressType, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, httpProxyTotalConn=httpProxyTotalConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, webCacheProtocol=webCacheProtocol, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, webCacheAddressType=webCacheAddressType, ipsRCPort=ipsRCPort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, dataPathStatus=dataPathStatus, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, webCacheAddress=webCacheAddress, systemSerialNumber=systemSerialNumber, ipsReqLimitAddress=ipsReqLimitAddress, sslProxyOutBytes=sslProxyOutBytes, cpuUtilization=cpuUtilization, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, bwsMIBGroups=bwsMIBGroups, httpSrvrNumConn=httpSrvrNumConn, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsMIBCompliance=bwsMIBCompliance, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsHdrAclAddressType=ipsHdrAclAddressType, serverDown=serverDown, ipsHdrAclPort=ipsHdrAclPort, srvcName=srvcName, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, dataPortLinkUp=dataPortLinkUp, httpProxyWAFWarnings=httpProxyWAFWarnings, dataPortLinkDown=dataPortLinkDown, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrInBytes=httpSrvrInBytes, bwsCompressionStatsTable=bwsCompressionStatsTable, logStorageHigh=logStorageHigh, webCacheCachedObjects=webCacheCachedObjects, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, vipStatus=vipStatus, httpSrvrPort=httpSrvrPort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrMaxResTime=httpSrvrMaxResTime, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, httpProxyServerErr=httpProxyServerErr, ipsRCTotServed=ipsRCTotServed, bwsStatsGroup=bwsStatsGroup, httpProxyActiveConn=httpProxyActiveConn, sslProxyErrPms=sslProxyErrPms, bwsCacheStatsEntry=bwsCacheStatsEntry, operationalMode=operationalMode, webCmprAddress=webCmprAddress, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsReqSrvcAddressType=ipsReqSrvcAddressType, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, httpProxyServerReq=httpProxyServerReq, totalAttacks=totalAttacks, firmwareStorageHigh=firmwareStorageHigh, ipsUrlNormPort=ipsUrlNormPort, firmwareUpdateAvailable=firmwareUpdateAvailable, switchingToBypassMode=switchingToBypassMode, sslSrvrOutBytes=sslSrvrOutBytes, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsCacheStatsTable=bwsCacheStatsTable, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, securityDefUpdates=securityDefUpdates, ipsReqSrvcAddress=ipsReqSrvcAddress, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrState=sslSrvrState, systemFailure=systemFailure, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, sslSrvrTotSuccess=sslSrvrTotSuccess, totalBandwidth=totalBandwidth, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, firmwareStorage=firmwareStorage, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, smAgentName=smAgentName, ipsUrlAclReserved=ipsUrlAclReserved, sslSrvrTotResponse=sslSrvrTotResponse, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, webCmprPort=webCmprPort, servicePort=servicePort, sslProxyCacheMiss=sslProxyCacheMiss, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, memUtilization=memUtilization, httpProxyOutBytes=httpProxyOutBytes, ipsCookieSecPort=ipsCookieSecPort, httpProxyParseErr=httpProxyParseErr, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsRCAddressType=ipsRCAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, webCacheReq=webCacheReq, sslProxyBadCRLErr=sslProxyBadCRLErr, sslProxyPort=sslProxyPort, ipsAccessCtrlAddress=ipsAccessCtrlAddress, httpProxySessionTimeOut=httpProxySessionTimeOut, webCacheStale=webCacheStale, activeServers=activeServers, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyTotalReq=sslProxyTotalReq, httpSrvrTotRefused=httpSrvrTotRefused, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, ipsRCAddress=ipsRCAddress, smNumUserSessions=smNumUserSessions, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyTotalReq=httpProxyTotalReq, ipsUrlNormAddressType=ipsUrlNormAddressType, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsRCTotQueued=ipsRCTotQueued, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslProxyAddressType=sslProxyAddressType, fanDead=fanDead, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrMaxResTime=sslSrvrMaxResTime, serviceName=serviceName, ipsReqLimitPort=ipsReqLimitPort, bwsMIBCompliances=bwsMIBCompliances, ipsCookieSecTampered=ipsCookieSecTampered, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrNumConn=sslSrvrNumConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslProxyCurrentConn=sslProxyCurrentConn, bws=bws, httpSrvrState=httpSrvrState, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, serviceStatus=serviceStatus, sslProxyActiveConn=sslProxyActiveConn, bwsMIBConformance=bwsMIBConformance, memoryUsageHigh=memoryUsageHigh, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, virusDefUpdates=virusDefUpdates, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, serverUp=serverUp, totalMem=totalMem, bwsStats=bwsStats, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, ipsReqSrvcPort=ipsReqSrvcPort, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsMessage=bwsMessage, peerDown=peerDown, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, systemFailOver=systemFailOver, httpSrvrMinResTime=httpSrvrMinResTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrAvgResTime=httpSrvrAvgResTime, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsHdrAclHits=ipsHdrAclHits, webCacheBytesOut=webCacheBytesOut, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, ipsCookieSecAddress=ipsCookieSecAddress, httpProxyInBytes=httpProxyInBytes, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, sslSrvrTotRefused=sslSrvrTotRefused, bwsServiceStatusTable=bwsServiceStatusTable, webCmprCompressedDataSize=webCmprCompressedDataSize, webCmprProtocol=webCmprProtocol, sslSrvrTotReqActive=sslSrvrTotReqActive, ipsUrlAclAddress=ipsUrlAclAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, serviceAddress=serviceAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, cpuFanSpeed=cpuFanSpeed, ipsUrlPolicyAddress=ipsUrlPolicyAddress, energizeUpdateExpire=energizeUpdateExpire, peerUp=peerUp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, ipsAccessCtrlPort=ipsAccessCtrlPort, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpProxyAddress=httpProxyAddress, totalApplications=totalApplications, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, tempHigh=tempHigh, linkStatus=linkStatus, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, httpProxyServerAbrt=httpProxyServerAbrt, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq)
mibBuilder.exportSymbols("BWS-MIB", totalServers=totalServers, sslSrvrMinResTime=sslSrvrMinResTime, httpSrvrAddressType=httpSrvrAddressType, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpProxyAddressType=httpProxyAddressType, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, httpProxyClientAbrt=httpProxyClientAbrt, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCacheCacheableRes=webCacheCacheableRes, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrPort=sslSrvrPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, systemLoad=systemLoad, sslProxyInBytes=sslProxyInBytes, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, freeMem=freeMem, sslProxyAddress=sslProxyAddress, processCountHigh=processCountHigh, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsWebAddrTransAddress=ipsWebAddrTransAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsRCTotDropped=ipsRCTotDropped, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, raidDegrading=raidDegrading, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslSrvrSrvcAddress=sslSrvrSrvcAddress, systemFanSpeed=systemFanSpeed, httpProxyPort=httpProxyPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, sslProxyCacheHits=sslProxyCacheHits, PYSNMP_MODULE_ID=bws, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslSrvrAvgResTime=sslSrvrAvgResTime, uptime=uptime, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, webCacheLongHdrs=webCacheLongHdrs, ipsCookieSecAddressType=ipsCookieSecAddressType, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrAddress=sslSrvrAddress, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, httpSrvrTotTimedout=httpSrvrTotTimedout, webCachePort=webCachePort, highAvailabilityStatus=highAvailabilityStatus, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsTrapGroup=bwsTrapGroup)
