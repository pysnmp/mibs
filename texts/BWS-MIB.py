...
MibIdentifier, Integer32, Unsigned32, ModuleIdentity, TimeTicks, Gauge32, iso, NotificationType, Counter32, Bits, Counter64, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Unsigned32", "ModuleIdentity", "TimeTicks", "Gauge32", "iso", "NotificationType", "Counter32", "Bits", "Counter64", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, sslSrvrNumConn=sslSrvrNumConn, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, bwsCompressionStatsEntry=bwsCompressionStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, uptime=uptime, webCachePort=webCachePort, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsRCPort=ipsRCPort, webCacheAddress=webCacheAddress, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrMinResTime=sslSrvrMinResTime, vipStatus=vipStatus, sslProxyTotalConn=sslProxyTotalConn, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsCookieSecEncrypted=ipsCookieSecEncrypted, serverUp=serverUp, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, operationalMode=operationalMode, httpSrvrState=httpSrvrState, ipsReqLimitPort=ipsReqLimitPort, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, cpuUtilization=cpuUtilization, ipsUrlAclPort=ipsUrlAclPort, totalAttacks=totalAttacks, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, webCmprCompressedDataSize=webCmprCompressedDataSize, sslSrvrTotSuccess=sslSrvrTotSuccess, httpProxyAddressType=httpProxyAddressType, httpProxyServerErr=httpProxyServerErr, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, firmwareStorage=firmwareStorage, httpSrvrTotResponse=httpSrvrTotResponse, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, sslProxyActiveConn=sslProxyActiveConn, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, bwsMIBConformance=bwsMIBConformance, cpuFanSpeed=cpuFanSpeed, httpSrvrAddressType=httpSrvrAddressType, httpSrvrAddress=httpSrvrAddress, ipsUrlNormPort=ipsUrlNormPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, httpSrvrAvgResTime=httpSrvrAvgResTime, webCacheStale=webCacheStale, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, systemFailure=systemFailure, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, sslSrvrAddressType=sslSrvrAddressType, currentFirmwareVersion=currentFirmwareVersion, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsStatsGroup=bwsStatsGroup, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, bwsSMUserSessionTable=bwsSMUserSessionTable, totalServers=totalServers, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, fanDead=fanDead, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, tempCritical=tempCritical, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsUrlPolicyAddress=ipsUrlPolicyAddress, serviceName=serviceName, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, energizeUpdateExpire=energizeUpdateExpire, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyWAFWarnings=httpProxyWAFWarnings, highAvailabilityStatus=highAvailabilityStatus, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, activeApplications=activeApplications, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyCacheMiss=sslProxyCacheMiss, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheReq=webCacheReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, logStorageHigh=logStorageHigh, ipsRCAddressType=ipsRCAddressType, totalBandwidth=totalBandwidth, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, bwsServiceStatusTable=bwsServiceStatusTable, bwsCacheStatsEntry=bwsCacheStatsEntry, ipsRCAddress=ipsRCAddress, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpSrvrSrvcPort=httpSrvrSrvcPort, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, smRealmName=smRealmName, firmwareStorageHigh=firmwareStorageHigh, memUtilization=memUtilization, httpProxyTotalConn=httpProxyTotalConn, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, bwsMIBGroups=bwsMIBGroups, webCmprPort=webCmprPort, httpProxyInBytes=httpProxyInBytes, virusDefUpdates=virusDefUpdates, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, webCmprProtocol=webCmprProtocol, sslSrvrOutBytes=sslSrvrOutBytes, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, systemLoad=systemLoad, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, httpProxyParseErr=httpProxyParseErr, ipsHdrAclHits=ipsHdrAclHits, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, activeServers=activeServers, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslProxyCacheHits=sslProxyCacheHits, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsHdrAclAddressType=ipsHdrAclAddressType, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpSrvrTotRefused=httpSrvrTotRefused, logStorage=logStorage, httpSrvrInBytes=httpSrvrInBytes, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsCookieSecPort=ipsCookieSecPort, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, firmwareUpdateAvailable=firmwareUpdateAvailable, webCacheCachedObjects=webCacheCachedObjects, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrMaxResTime=sslSrvrMaxResTime, sslProxyFullHandshakes=sslProxyFullHandshakes, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, totalApplications=totalApplications, ipsRCTotDropped=ipsRCTotDropped, ipsUrlAclAddressType=ipsUrlAclAddressType, sslSrvrState=sslSrvrState, httpSrvrMinResTime=httpSrvrMinResTime, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, switchingToMaintMode=switchingToMaintMode, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsLrnSrvcPort=ipsLrnSrvcPort, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, switchingToBypassMode=switchingToBypassMode, httpSrvrNumConn=httpSrvrNumConn, serviceAddress=serviceAddress, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlPort=ipsAccessCtrlPort, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, srvcName=srvcName, serviceStatus=serviceStatus, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, sslProxyInBytes=sslProxyInBytes, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, ipsRCTotOutOfResource=ipsRCTotOutOfResource, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, sslProxyBadDNCErr=sslProxyBadDNCErr, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, sslProxyPort=sslProxyPort, httpProxyUnknownRsp=httpProxyUnknownRsp, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpProxyPort=httpProxyPort, PYSNMP_MODULE_ID=bws, systemFanSpeed=systemFanSpeed, bwsMessage=bwsMessage, sslProxyBadCRLErr=sslProxyBadCRLErr, sslSrvrTotResponse=sslSrvrTotResponse, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, dataPortLinkUp=dataPortLinkUp, ipsHdrAclAddress=ipsHdrAclAddress, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsCookieSecAddress=ipsCookieSecAddress, peerDown=peerDown, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, sslSrvrTotTimedout=sslSrvrTotTimedout, linkStatus=linkStatus, httpProxyServerReq=httpProxyServerReq, ipsUrlAclAddress=ipsUrlAclAddress, webCacheLongHdrs=webCacheLongHdrs, systemFailOver=systemFailOver, httpSrvrSrvcAddress=httpSrvrSrvcAddress, peerUp=peerUp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyActiveConn=httpProxyActiveConn, httpProxyOutBytes=httpProxyOutBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sharedSecretKeyExpired=sharedSecretKeyExpired, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, webCacheBytesOut=webCacheBytesOut, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, systemSerialNumber=systemSerialNumber, smNumUserSessions=smNumUserSessions, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrPort=sslSrvrPort, bwsServiceStatusEntry=bwsServiceStatusEntry, httpSrvrOutBytes=httpSrvrOutBytes, sslProxyTotalReq=sslProxyTotalReq, tempHigh=tempHigh, httpSrvrTotReqRejected=httpSrvrTotReqRejected, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheCacheableRes=webCacheCacheableRes, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyAddress=sslProxyAddress, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyAddressType=sslProxyAddressType, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, httpSrvrTotReqActive=httpSrvrTotReqActive, sslSrvrAddress=sslSrvrAddress, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, httpProxyAddress=httpProxyAddress, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslProxyCurrentConn=sslProxyCurrentConn, processCountHigh=processCountHigh, webCmprAddress=webCmprAddress, webCacheProtocol=webCacheProtocol, httpProxySessionTimeOut=httpProxySessionTimeOut, httpProxyTotalReq=httpProxyTotalReq, webCmprAddressType=webCmprAddressType)
mibBuilder.exportSymbols("BWS-MIB", totalMem=totalMem, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, sslSrvrTotReqActive=sslSrvrTotReqActive, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, serverDown=serverDown, ipsReqLimitAddressType=ipsReqLimitAddressType, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, ipsReqLimitAddress=ipsReqLimitAddress, servicePort=servicePort, httpSrvrPort=httpSrvrPort, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpProxyServerAbrt=httpProxyServerAbrt, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsRCTotQueued=ipsRCTotQueued, bwsStats=bwsStats, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsWebAddrTransPort=ipsWebAddrTransPort, webCacheHits=webCacheHits, webCacheAddressType=webCacheAddressType, bwstraps=bwstraps, bws=bws, dataPathStatus=dataPathStatus, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsRCTotServed=ipsRCTotServed, bwsSMUserSessionEntry=bwsSMUserSessionEntry, sslProxyErrPms=sslProxyErrPms, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, smAgentName=smAgentName, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, sslSrvrInBytes=sslSrvrInBytes, ipsUrlPolicyPort=ipsUrlPolicyPort, cpuTemperature=cpuTemperature, webCacheMiss=webCacheMiss, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, dataPortLinkDown=dataPortLinkDown, ipsHdrAclPort=ipsHdrAclPort, raidDegrading=raidDegrading, webCmprCompressibleDataSize=webCmprCompressibleDataSize, freeMem=freeMem, bwsCacheStatsTable=bwsCacheStatsTable, bwsTrapGroup=bwsTrapGroup, bwsMIBCompliances=bwsMIBCompliances, memoryUsageHigh=memoryUsageHigh, ipsReqSrvcAddressType=ipsReqSrvcAddressType, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsReqSrvcPort=ipsReqSrvcPort, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsRCStatsTable=bwsIpsRCStatsTable, securityDefUpdates=securityDefUpdates, bwsMIBCompliance=bwsMIBCompliance, sslProxyOutBytes=sslProxyOutBytes, switchingToInlineMode=switchingToInlineMode, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow)
