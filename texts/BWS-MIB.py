...
Counter32, ModuleIdentity, IpAddress, MibIdentifier, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ObjectIdentity, Gauge32, NotificationType, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "IpAddress", "MibIdentifier", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ObjectIdentity", "Gauge32", "NotificationType", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("BWS-MIB", ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, ipsUrlAclAddress=ipsUrlAclAddress, sslProxyBadDNCErr=sslProxyBadDNCErr, memoryUsageHigh=memoryUsageHigh, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsCacheStatsTable=bwsCacheStatsTable, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, peerDown=peerDown, uptime=uptime, httpSrvrOutBytes=httpSrvrOutBytes, bwsIpsRCStatsTable=bwsIpsRCStatsTable, servicePort=servicePort, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, httpSrvrMaxResTime=httpSrvrMaxResTime, sslProxyAddressType=sslProxyAddressType, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, sharedSecretKeyExpired=sharedSecretKeyExpired, httpProxyAddressType=httpProxyAddressType, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, cpuUtilization=cpuUtilization, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrTotRefused=httpSrvrTotRefused, dataPortLinkUp=dataPortLinkUp, ipsRCTimeStamp=ipsRCTimeStamp, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslProxyAddress=sslProxyAddress, systemFanSpeed=systemFanSpeed, logStorageHigh=logStorageHigh, httpSrvrNumConn=httpSrvrNumConn, firmwareUpdateAvailable=firmwareUpdateAvailable, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, ipsReqLimitPort=ipsReqLimitPort, webCmprAddress=webCmprAddress, ipsRCAddressType=ipsRCAddressType, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, activeApplications=activeApplications, ipsAccessCtrlPort=ipsAccessCtrlPort, logStorage=logStorage, httpProxyPort=httpProxyPort, ipsCookieSecTampered=ipsCookieSecTampered, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, smRealmName=smRealmName, bwsCacheStatsEntry=bwsCacheStatsEntry, sslProxyTotalConn=sslProxyTotalConn, bwsMIBCompliances=bwsMIBCompliances, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslSrvrNumFreeConn=sslSrvrNumFreeConn, bwsTrapGroup=bwsTrapGroup, httpSrvrTotTimedout=httpSrvrTotTimedout, sslSrvrAddressType=sslSrvrAddressType, switchingToMaintMode=switchingToMaintMode, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsServiceStatusTable=bwsServiceStatusTable, httpProxyWAFWarnings=httpProxyWAFWarnings, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, sslProxyCacheTimeouts=sslProxyCacheTimeouts, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, serviceAddress=serviceAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, webCmprProtocol=webCmprProtocol, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, serviceStatus=serviceStatus, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsHdrAclHits=ipsHdrAclHits, ipsRCPort=ipsRCPort, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrSrvcPort=sslSrvrSrvcPort, httpProxyUnknownRsp=httpProxyUnknownRsp, httpProxyTotalReq=httpProxyTotalReq, ipsUrlPolicyAddress=ipsUrlPolicyAddress, sslProxyPort=sslProxyPort, ipsReqSrvcAddress=ipsReqSrvcAddress, webCacheCachedObjects=webCacheCachedObjects, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, httpProxyOutBytes=httpProxyOutBytes, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, virusDefUpdates=virusDefUpdates, ipsReqSrvcPort=ipsReqSrvcPort, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, webCacheBytesOut=webCacheBytesOut, sslSrvrTotRefused=sslSrvrTotRefused, httpSrvrState=httpSrvrState, bwstraps=bwstraps, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, httpProxyParseErr=httpProxyParseErr, bwsStats=bwsStats, ipsReqLimitAddress=ipsReqLimitAddress, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsServiceStatusEntry=bwsServiceStatusEntry, currentFirmwareVersion=currentFirmwareVersion, webCacheAddressType=webCacheAddressType, totalMem=totalMem, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, httpSrvrAddressType=httpSrvrAddressType, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsHdrAclPort=ipsHdrAclPort, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyClientAbrt=httpProxyClientAbrt, freeMem=freeMem, httpSrvrAvgResTime=httpSrvrAvgResTime, httpProxyTotalConn=httpProxyTotalConn, ipsUrlNormPort=ipsUrlNormPort, smAgentName=smAgentName, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxyServerReq=httpProxyServerReq, ipsCookieSecEncrypted=ipsCookieSecEncrypted, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsMIBGroups=bwsMIBGroups, operationalMode=operationalMode, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, totalBandwidth=totalBandwidth, newAttackDefinitionInstalled=newAttackDefinitionInstalled, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, webCacheReq=webCacheReq, sslSrvrState=sslSrvrState, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, webCacheAddress=webCacheAddress, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, firmwareStorageHigh=firmwareStorageHigh, httpProxyAddress=httpProxyAddress, ipsRCTotQueued=ipsRCTotQueued, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsLrnSrvcPort=ipsLrnSrvcPort, httpSrvrInBytes=httpSrvrInBytes, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, totalServers=totalServers, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsWebAddrTransAddress=ipsWebAddrTransAddress, energizeUpdateExpire=energizeUpdateExpire, smNumUserSessions=smNumUserSessions, systemSerialNumber=systemSerialNumber, sslSrvrOutBytes=sslSrvrOutBytes, raidDegrading=raidDegrading, ipsUrlAclPort=ipsUrlAclPort, sslSrvrAvgResTime=sslSrvrAvgResTime, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bwsMessage=bwsMessage, bwsMIBCompliance=bwsMIBCompliance, fanDead=fanDead, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, dataPortLinkDown=dataPortLinkDown, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrSrvcPort=httpSrvrSrvcPort, highAvailabilityStatus=highAvailabilityStatus, vipStatus=vipStatus, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCmprPort=webCmprPort, httpProxyServerErr=httpProxyServerErr, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, ipsRCTotOutOfResource=ipsRCTotOutOfResource, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, bwsMIBConformance=bwsMIBConformance, sslSrvrAddress=sslSrvrAddress, sslProxyTotalReq=sslProxyTotalReq, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, dataPathStatus=dataPathStatus, ipsUrlNormAddress=ipsUrlNormAddress, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, systemFailure=systemFailure, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, sslSrvrInBytes=sslSrvrInBytes, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, httpSrvrPort=httpSrvrPort, cpuTemperature=cpuTemperature, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrTotReqActive=sslSrvrTotReqActive, activeServers=activeServers, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, ipsReqSrvcAddressType=ipsReqSrvcAddressType, totalApplications=totalApplications, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrTotResponse=httpSrvrTotResponse, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlAclReserved=ipsUrlAclReserved, tempHigh=tempHigh, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, httpSrvrSrvcAddress=httpSrvrSrvcAddress, serverUp=serverUp, sslSrvrMaxResTime=sslSrvrMaxResTime, httpSrvrTotReqRejected=httpSrvrTotReqRejected, bwsCompressionStatsEntry=bwsCompressionStatsEntry, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, webCacheHits=webCacheHits, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, linkStatus=linkStatus, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, webCacheLongHdrs=webCacheLongHdrs, sslProxyOutBytes=sslProxyOutBytes, webCacheCacheableRes=webCacheCacheableRes, switchingToBypassMode=switchingToBypassMode, memUtilization=memUtilization, ipsHdrAclAddress=ipsHdrAclAddress, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsAccessCtrlAddress=ipsAccessCtrlAddress, securityDefUpdates=securityDefUpdates, sslProxyErrPms=sslProxyErrPms, sslProxyInBytes=sslProxyInBytes)
mibBuilder.exportSymbols("BWS-MIB", webCacheStale=webCacheStale, bws=bws, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, httpProxyInBytes=httpProxyInBytes, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, serviceName=serviceName, PYSNMP_MODULE_ID=bws, ipsCookieSecAddress=ipsCookieSecAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, httpProxyServerAbrt=httpProxyServerAbrt, tempCritical=tempCritical, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, bwsStatsGroup=bwsStatsGroup, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, httpSrvrAddress=httpSrvrAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, systemFailOver=systemFailOver, sslSrvrPort=sslSrvrPort, ipsRCTotDropped=ipsRCTotDropped, sslSrvrNumConn=sslSrvrNumConn, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, systemLoad=systemLoad, httpSrvrMinResTime=httpSrvrMinResTime, httpProxyActiveConn=httpProxyActiveConn, serverDown=serverDown, webCacheProtocol=webCacheProtocol, ipsCookieSecAddressType=ipsCookieSecAddressType, webCachePort=webCachePort, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, bwsSMUserSessionTable=bwsSMUserSessionTable, firmwareStorage=firmwareStorage, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyCacheHits=sslProxyCacheHits, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCmprCompressibleDataSize=webCmprCompressibleDataSize, webCacheMiss=webCacheMiss, bwsSMUserSessionEntry=bwsSMUserSessionEntry, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, cpuFanSpeed=cpuFanSpeed, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsUrlAclAddressType=ipsUrlAclAddressType, switchingToInlineMode=switchingToInlineMode, sslProxyActiveConn=sslProxyActiveConn, srvcName=srvcName, webCmprAddressType=webCmprAddressType, ipsCookieSecPort=ipsCookieSecPort, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, peerUp=peerUp, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsRCAddress=ipsRCAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, sslProxyCurrentConn=sslProxyCurrentConn, totalAttacks=totalAttacks, ipsRCTotServed=ipsRCTotServed, processCountHigh=processCountHigh, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry)
