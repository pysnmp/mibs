...
NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, IpAddress, TimeTicks, Counter32, MibIdentifier, Counter64, Unsigned32, Integer32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "IpAddress", "TimeTicks", "Counter32", "MibIdentifier", "Counter64", "Unsigned32", "Integer32", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("BWS-MIB", bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, firmwareStorageHigh=firmwareStorageHigh, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, httpSrvrTotResponse=httpSrvrTotResponse, ipsHdrAclHits=ipsHdrAclHits, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, ipsUrlAclAddressType=ipsUrlAclAddressType, peerUp=peerUp, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsUrlAclReserved=ipsUrlAclReserved, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsReqLimitAddress=ipsReqLimitAddress, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, httpSrvrNumFreeConn=httpSrvrNumFreeConn, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransPort=ipsWebAddrTransPort, bwsTrapGroup=bwsTrapGroup, httpSrvrAddress=httpSrvrAddress, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, systemSerialNumber=systemSerialNumber, bwstraps=bwstraps, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, sslSrvrTotTimedout=sslSrvrTotTimedout, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, sslProxyPort=sslProxyPort, httpSrvrNumConn=httpSrvrNumConn, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsAccessCtrlAddress=ipsAccessCtrlAddress, newAttackDefinitionInstalled=newAttackDefinitionInstalled, highAvailabilityStatus=highAvailabilityStatus, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsCookieSecAddress=ipsCookieSecAddress, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, cpuFanSpeed=cpuFanSpeed, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, sslSrvrMaxResTime=sslSrvrMaxResTime, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslSrvrNumConn=sslSrvrNumConn, webCmprProtocol=webCmprProtocol, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsUrlNormAddress=ipsUrlNormAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, webCacheAddressType=webCacheAddressType, totalMem=totalMem, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, srvcName=srvcName, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, switchingToInlineMode=switchingToInlineMode, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, bwsCacheStatsEntry=bwsCacheStatsEntry, bws=bws, httpProxyInBytes=httpProxyInBytes, httpProxyParseErr=httpProxyParseErr, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrSrvcAddress=httpSrvrSrvcAddress, bwsStats=bwsStats, webCmprAddressType=webCmprAddressType, httpProxyServerReq=httpProxyServerReq, webCacheCachedObjects=webCacheCachedObjects, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, logStorage=logStorage, servicePort=servicePort, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, sslSrvrState=sslSrvrState, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrTotResponse=sslSrvrTotResponse, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, dataPortLinkDown=dataPortLinkDown, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, httpSrvrOutBytes=httpSrvrOutBytes, smNumUserSessions=smNumUserSessions, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, webCacheHits=webCacheHits, bwsCompressionStatsEntry=bwsCompressionStatsEntry, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsRCAddress=ipsRCAddress, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, totalApplications=totalApplications, ipsUrlNormAddressType=ipsUrlNormAddressType, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, activeApplications=activeApplications, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, memoryUsageHigh=memoryUsageHigh, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, sslSrvrMinResTime=sslSrvrMinResTime, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, systemFailOver=systemFailOver, switchingToBypassMode=switchingToBypassMode, sslProxyErrPms=sslProxyErrPms, sslProxyTotalReq=sslProxyTotalReq, ipsRCTimeStamp=ipsRCTimeStamp, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, httpProxyAddress=httpProxyAddress, processCountHigh=processCountHigh, currentFirmwareVersion=currentFirmwareVersion, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsHdrAclPort=ipsHdrAclPort, httpProxyTotalReq=httpProxyTotalReq, memUtilization=memUtilization, bwsIpsRCStatsTable=bwsIpsRCStatsTable, sslSrvrSrvcAddress=sslSrvrSrvcAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsSMUserSessionEntry=bwsSMUserSessionEntry, httpProxyClientAbrt=httpProxyClientAbrt, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqLimitPort=ipsReqLimitPort, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpSrvrTotReqActive=httpSrvrTotReqActive, vipStatus=vipStatus, ipsCookieSecTampered=ipsCookieSecTampered, operationalMode=operationalMode, ipsReqSrvcAddress=ipsReqSrvcAddress, systemFanSpeed=systemFanSpeed, totalBandwidth=totalBandwidth, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsReqLimitAddressType=ipsReqLimitAddressType, sslSrvrPort=sslSrvrPort, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, webCacheCacheableRes=webCacheCacheableRes, httpSrvrAddressType=httpSrvrAddressType, logStorageHigh=logStorageHigh, energizeUpdateExpire=energizeUpdateExpire, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTotDropped=ipsRCTotDropped, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheAddress=webCacheAddress, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, httpProxyServerAbrt=httpProxyServerAbrt, bwsServiceStatusEntry=bwsServiceStatusEntry, sslProxyOutBytes=sslProxyOutBytes, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, peerDown=peerDown, bwsMIBCompliances=bwsMIBCompliances, webCacheLongHdrs=webCacheLongHdrs, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyPort=httpProxyPort, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, webCacheMiss=webCacheMiss, systemFailure=systemFailure, cpuUtilization=cpuUtilization, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, httpProxyOutBytes=httpProxyOutBytes, httpProxyWAFWarnings=httpProxyWAFWarnings, freeMem=freeMem, httpProxyAddressType=httpProxyAddressType, webCmprAddress=webCmprAddress, sslSrvrTotSuccess=sslSrvrTotSuccess, totalServers=totalServers, fanDead=fanDead, dataPortLinkUp=dataPortLinkUp, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsCookieSecPort=ipsCookieSecPort, switchingToMaintMode=switchingToMaintMode, sslProxyCacheTimeouts=sslProxyCacheTimeouts, ipsRCAddressType=ipsRCAddressType, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, sslProxyBadCRLErr=sslProxyBadCRLErr, PYSNMP_MODULE_ID=bws, raidDegrading=raidDegrading, activeServers=activeServers, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslSrvrAddressType=sslSrvrAddressType, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheReq=webCacheReq, httpProxyUnknownRsp=httpProxyUnknownRsp, sslProxyActiveConn=sslProxyActiveConn, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsRCTotQueued=ipsRCTotQueued, ipsHdrAclAddress=ipsHdrAclAddress, ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslProxyCurrentConn=sslProxyCurrentConn, serviceName=serviceName, httpProxyServerErr=httpProxyServerErr, sslProxyAddress=sslProxyAddress, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, webCacheStale=webCacheStale, webCacheProtocol=webCacheProtocol, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrTotReqRejected=httpSrvrTotReqRejected, webCmprPort=webCmprPort, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyTotalConn=httpProxyTotalConn, webCmprCompressibleDataSize=webCmprCompressibleDataSize, httpProxyActiveConn=httpProxyActiveConn, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, serverUp=serverUp, uptime=uptime, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, systemLoad=systemLoad, bwsStatsGroup=bwsStatsGroup, httpSrvrMinResTime=httpSrvrMinResTime, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpSrvrMaxResTime=httpSrvrMaxResTime, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, bwsMIBCompliance=bwsMIBCompliance, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, serverDown=serverDown, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, sslProxyInBytes=sslProxyInBytes, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, dataPathStatus=dataPathStatus, serviceAddress=serviceAddress, sslSrvrOutBytes=sslSrvrOutBytes, ipsRCTotServed=ipsRCTotServed, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp)
mibBuilder.exportSymbols("BWS-MIB", serviceStatus=serviceStatus, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, bwsCacheStatsTable=bwsCacheStatsTable, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, securityDefUpdates=securityDefUpdates, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, sslProxyBadDNCErr=sslProxyBadDNCErr, ipsLrnSrvcPort=ipsLrnSrvcPort, tempHigh=tempHigh, httpSrvrAvgResTime=httpSrvrAvgResTime, sslProxyTotalConn=sslProxyTotalConn, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrAvgResTime=sslSrvrAvgResTime, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsRCPort=ipsRCPort, httpSrvrTotRefused=httpSrvrTotRefused, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, bwsMIBGroups=bwsMIBGroups, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, tempCritical=tempCritical, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsMessage=bwsMessage, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, cpuTemperature=cpuTemperature, totalAttacks=totalAttacks, sslSrvrInBytes=sslSrvrInBytes, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, bwsServiceStatusTable=bwsServiceStatusTable, smRealmName=smRealmName, firmwareStorage=firmwareStorage, virusDefUpdates=virusDefUpdates, bwsSMUserSessionTable=bwsSMUserSessionTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, httpSrvrTotSuccess=httpSrvrTotSuccess, httpSrvrInBytes=httpSrvrInBytes, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpSrvrSrvcPort=httpSrvrSrvcPort, webCmprCompressedDataSize=webCmprCompressedDataSize, ipsUrlAclPort=ipsUrlAclPort, httpSrvrPort=httpSrvrPort, sslProxyCacheHits=sslProxyCacheHits, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyCacheMiss=sslProxyCacheMiss, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, linkStatus=linkStatus, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, smAgentName=smAgentName, sslProxyAddressType=sslProxyAddressType, sslSrvrTotRefused=sslSrvrTotRefused, bwsMIBConformance=bwsMIBConformance, httpSrvrState=httpSrvrState, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCacheBytesOut=webCacheBytesOut, webCachePort=webCachePort, sslSrvrAddress=sslSrvrAddress, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, ipsRCTotOutOfResource=ipsRCTotOutOfResource, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr)
