...
iso, TimeTicks, Gauge32, Unsigned32, NotificationType, Counter64, ModuleIdentity, Integer32, Bits, ObjectIdentity, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Gauge32", "Unsigned32", "NotificationType", "Counter64", "ModuleIdentity", "Integer32", "Bits", "ObjectIdentity", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", ipsWebAddrTransAddress=ipsWebAddrTransAddress, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, memoryUsageHigh=memoryUsageHigh, totalAttacks=totalAttacks, ipsCookieSecTampered=ipsCookieSecTampered, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, bwsMIBCompliance=bwsMIBCompliance, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, securityDefUpdates=securityDefUpdates, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpProxyParseErr=httpProxyParseErr, sslSrvrTotReqActive=sslSrvrTotReqActive, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, virusDefUpdates=virusDefUpdates, freeMem=freeMem, webCmprAddress=webCmprAddress, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, webCacheAddressType=webCacheAddressType, switchingToBypassMode=switchingToBypassMode, webCmprCompressedDataSize=webCmprCompressedDataSize, httpSrvrTotReqActive=httpSrvrTotReqActive, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, webCacheLongHdrs=webCacheLongHdrs, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, sslProxyBadCRLErr=sslProxyBadCRLErr, httpSrvrAddress=httpSrvrAddress, httpSrvrAddressType=httpSrvrAddressType, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, sslSrvrNumFreeConn=sslSrvrNumFreeConn, httpSrvrPort=httpSrvrPort, webCacheMiss=webCacheMiss, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, sslSrvrTotResponse=sslSrvrTotResponse, sslSrvrState=sslSrvrState, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, sslProxyTotalConn=sslProxyTotalConn, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, ipsUrlPolicyAddress=ipsUrlPolicyAddress, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, sslSrvrPort=sslSrvrPort, ipsRCAddress=ipsRCAddress, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, linkStatus=linkStatus, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, ipsLrnSrvcAddress=ipsLrnSrvcAddress, ipsCookieSecAddress=ipsCookieSecAddress, sslSrvrSrvcPort=sslSrvrSrvcPort, ipsRCAddressType=ipsRCAddressType, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, sslProxyErrPms=sslProxyErrPms, webCacheAddress=webCacheAddress, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, httpProxyInBytes=httpProxyInBytes, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, ipsCookieSecEncrypted=ipsCookieSecEncrypted, firmwareStorage=firmwareStorage, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, httpProxyAddress=httpProxyAddress, httpSrvrTotSuccess=httpSrvrTotSuccess, smNumUserSessions=smNumUserSessions, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, bwsMIBCompliances=bwsMIBCompliances, sslSrvrSrvcAddress=sslSrvrSrvcAddress, switchingToMaintMode=switchingToMaintMode, energizeUpdateExpire=energizeUpdateExpire, httpProxyPort=httpProxyPort, smAgentName=smAgentName, sslProxyCacheHits=sslProxyCacheHits, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, bwsTrapGroup=bwsTrapGroup, bwsCompressionStatsEntry=bwsCompressionStatsEntry, totalApplications=totalApplications, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrMinResTime=sslSrvrMinResTime, sslProxyCacheMiss=sslProxyCacheMiss, ipsRCTotDropped=ipsRCTotDropped, peerUp=peerUp, bwsSslProxyStatsTable=bwsSslProxyStatsTable, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, ipsRCPort=ipsRCPort, bwsCacheStatsEntry=bwsCacheStatsEntry, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, webCmprProtocol=webCmprProtocol, ipsRCTotQueued=ipsRCTotQueued, cpuUtilization=cpuUtilization, bwsStats=bwsStats, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, sslSrvrAddress=sslSrvrAddress, ipsReqLimitAddressType=ipsReqLimitAddressType, systemFanSpeed=systemFanSpeed, sslProxyFullHandshakes=sslProxyFullHandshakes, webCacheCacheableRes=webCacheCacheableRes, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, httpProxyActiveConn=httpProxyActiveConn, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsUrlNormAddress=ipsUrlNormAddress, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, uptime=uptime, httpSrvrMinResTime=httpSrvrMinResTime, sslProxyPort=sslProxyPort, sslProxyAddress=sslProxyAddress, webCmprPort=webCmprPort, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, ipsCookieSecAddressType=ipsCookieSecAddressType, webCachePort=webCachePort, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, sslProxyInBytes=sslProxyInBytes, tempHigh=tempHigh, servicePort=servicePort, httpSrvrTotResponse=httpSrvrTotResponse, ipsHdrAclPort=ipsHdrAclPort, httpProxyAddressType=httpProxyAddressType, sslProxyOutBytes=sslProxyOutBytes, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, processCountHigh=processCountHigh, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, webCacheCachedObjects=webCacheCachedObjects, httpSrvrSrvcAddress=httpSrvrSrvcAddress, ipsReqSrvcPort=ipsReqSrvcPort, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlPolicyPort=ipsUrlPolicyPort, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsMIBConformance=bwsMIBConformance, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, firmwareStorageHigh=firmwareStorageHigh, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, totalBandwidth=totalBandwidth, ipsUrlNormAddressType=ipsUrlNormAddressType, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, httpProxyServerErr=httpProxyServerErr, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxySessionTimeOut=httpProxySessionTimeOut, serverDown=serverDown, logStorage=logStorage, httpSrvrMaxResTime=httpSrvrMaxResTime, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, ipsReqSrvcAddressType=ipsReqSrvcAddressType, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, ipsReqLimitAddress=ipsReqLimitAddress, highAvailabilityStatus=highAvailabilityStatus, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, ipsUrlAclPort=ipsUrlAclPort, bwstraps=bwstraps, activeServers=activeServers, webCacheHits=webCacheHits, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, ipsUrlAclReserved=ipsUrlAclReserved, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, sslProxyCacheTimeouts=sslProxyCacheTimeouts, webCmprAddressType=webCmprAddressType, cpuFanSpeed=cpuFanSpeed, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie, ipsRCTimeStamp=ipsRCTimeStamp, PYSNMP_MODULE_ID=bws, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, ipsRCTotOutOfResource=ipsRCTotOutOfResource, systemFailure=systemFailure, ipsLrnSrvcPort=ipsLrnSrvcPort, sslProxyCurrentConn=sslProxyCurrentConn, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, ipsReqLimitPort=ipsReqLimitPort, operationalMode=operationalMode, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, systemSerialNumber=systemSerialNumber, httpProxyServerReq=httpProxyServerReq, httpSrvrNumConn=httpSrvrNumConn, webCacheReq=webCacheReq, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, newAttackDefinitionInstalled=newAttackDefinitionInstalled, dataPathStatus=dataPathStatus, webCacheBytesOut=webCacheBytesOut, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, bwsServiceStatusTable=bwsServiceStatusTable, bwsStatsGroup=bwsStatsGroup, httpSrvrTotReqRejected=httpSrvrTotReqRejected, memUtilization=memUtilization, sslSrvrAddressType=sslSrvrAddressType, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, srvcName=srvcName, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, firmwareUpdateAvailable=firmwareUpdateAvailable, bwsCacheStatsTable=bwsCacheStatsTable, serverUp=serverUp, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, httpProxyTotalReq=httpProxyTotalReq, ipsUrlAclAddressType=ipsUrlAclAddressType, systemFailOver=systemFailOver, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, totalMem=totalMem, ipsCookieSecPort=ipsCookieSecPort, httpSrvrNumFreeConn=httpSrvrNumFreeConn, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, webCacheStale=webCacheStale, sharedSecretKeyExpired=sharedSecretKeyExpired, ipsReqSrvcAddress=ipsReqSrvcAddress, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, httpProxyClientAbrt=httpProxyClientAbrt, sslProxyActiveConn=sslProxyActiveConn, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, sslProxyBadDNCErr=sslProxyBadDNCErr, switchingToInlineMode=switchingToInlineMode, ipsUrlNormPort=ipsUrlNormPort, ipsAccessCtrlPort=ipsAccessCtrlPort, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, sslSrvrTotTimedout=sslSrvrTotTimedout, serviceStatus=serviceStatus, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, sslProxyTotalReq=sslProxyTotalReq, bwsMessage=bwsMessage, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, bwsCompressionStatsTable=bwsCompressionStatsTable, bws=bws, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr)
mibBuilder.exportSymbols("BWS-MIB", sslSrvrTotRefused=sslSrvrTotRefused, sslSrvrTotSuccess=sslSrvrTotSuccess, ipsAccessCtrlAddress=ipsAccessCtrlAddress, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, webCacheProtocol=webCacheProtocol, sslSrvrNumConn=sslSrvrNumConn, vipStatus=vipStatus, smRealmName=smRealmName, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, fanDead=fanDead, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, activeApplications=activeApplications, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, systemLoad=systemLoad, currentFirmwareVersion=currentFirmwareVersion, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpSrvrInBytes=httpSrvrInBytes, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrTotTimedout=httpSrvrTotTimedout, webCmprCompressibleDataSize=webCmprCompressibleDataSize, dataPortLinkUp=dataPortLinkUp, totalServers=totalServers, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, logStorageHigh=logStorageHigh, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, sslProxyAddressType=sslProxyAddressType, sslSrvrTotReqRejected=sslSrvrTotReqRejected, cpuTemperature=cpuTemperature, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, httpProxyOutBytes=httpProxyOutBytes, dataPortLinkDown=dataPortLinkDown, peerDown=peerDown, sslSrvrAvgResTime=sslSrvrAvgResTime, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, serviceAddress=serviceAddress, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, raidDegrading=raidDegrading, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsUrlAclAddress=ipsUrlAclAddress, tempCritical=tempCritical, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, ipsWebAddrTransPort=ipsWebAddrTransPort, sslSrvrInBytes=sslSrvrInBytes, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, httpProxyTotalConn=httpProxyTotalConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, ipsHdrAclAddressType=ipsHdrAclAddressType, ipsHdrAclHits=ipsHdrAclHits, bwsServiceStatusEntry=bwsServiceStatusEntry, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, ipsRCTotServed=ipsRCTotServed, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, bwsSMUserSessionEntry=bwsSMUserSessionEntry, ipsHdrAclAddress=ipsHdrAclAddress, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, serviceName=serviceName, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrOutBytes=sslSrvrOutBytes, httpSrvrState=httpSrvrState)
