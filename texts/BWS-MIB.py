...
Integer32, iso, ObjectIdentity, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Gauge32, Bits, ModuleIdentity, IpAddress, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "ObjectIdentity", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Gauge32", "Bits", "ModuleIdentity", "IpAddress", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("BWS-MIB", systemSerialNumber=systemSerialNumber, ipsWebAddrTransReqUrlTrans=ipsWebAddrTransReqUrlTrans, httpSrvrSrvcPort=httpSrvrSrvcPort, sslSrvrTotReqRejected=sslSrvrTotReqRejected, ipsReqSrvcNoOfAppProfViol=ipsReqSrvcNoOfAppProfViol, webCmprAddressType=webCmprAddressType, ipsWebAddrTransPort=ipsWebAddrTransPort, ipsUrlNormAddress=ipsUrlNormAddress, bwsHttpProxyStatsTable=bwsHttpProxyStatsTable, ipsUrlPolicyAddressType=ipsUrlPolicyAddressType, httpSrvrTotReqRejected=httpSrvrTotReqRejected, processCountHigh=processCountHigh, sharedSecretKeyAboutToExpire=sharedSecretKeyAboutToExpire, bws=bws, bwsTrapGroup=bwsTrapGroup, tempCritical=tempCritical, activeApplications=activeApplications, ipsReqSrvcTotProfViol=ipsReqSrvcTotProfViol, webCmprCompressedDataSize=webCmprCompressedDataSize, totalMem=totalMem, ipsUrlPolicyEntryCtrlAuth=ipsUrlPolicyEntryCtrlAuth, bwstraps=bwstraps, httpSrvrTotTimedout=httpSrvrTotTimedout, ipsUrlNormEncodingErr=ipsUrlNormEncodingErr, totalApplications=totalApplications, sslProxyPort=sslProxyPort, sslSrvrSrvcAddress=sslSrvrSrvcAddress, sslSrvrNumIBDisabled=sslSrvrNumIBDisabled, ipsHdrAclAddress=ipsHdrAclAddress, bwsMIBConformance=bwsMIBConformance, freeMem=freeMem, sslSrvrNumReqEnqueue=sslSrvrNumReqEnqueue, httpSrvrPort=httpSrvrPort, sslSrvrAvgResTime=sslSrvrAvgResTime, httpSrvrNumIBDisabled=httpSrvrNumIBDisabled, ipsWebAddrTransReqUrlReWritten=ipsWebAddrTransReqUrlReWritten, ipsAccessCtrlAccessAttemptsTotRtt=ipsAccessCtrlAccessAttemptsTotRtt, vipStatus=vipStatus, serviceAddress=serviceAddress, ipsLrnSrvcTotUpdatesByReq=ipsLrnSrvcTotUpdatesByReq, serverUp=serverUp, httpSrvrLastDisabledTime=httpSrvrLastDisabledTime, httpProxyOutBytes=httpProxyOutBytes, ipsCookieSecNumCookieErr=ipsCookieSecNumCookieErr, ipsUrlAclAllowAclHits=ipsUrlAclAllowAclHits, systemFailure=systemFailure, httpSrvrNumFreeConn=httpSrvrNumFreeConn, httpSrvrNumOOBDisabled=httpSrvrNumOOBDisabled, ipsReqLimitQueryLenOFErr=ipsReqLimitQueryLenOFErr, bwsSMUserSessionTable=bwsSMUserSessionTable, sslSrvrTotRefused=sslSrvrTotRefused, ipsAccessCtrlAuthCacheMiss=ipsAccessCtrlAuthCacheMiss, bwsIpsUrlPolicyStatsTable=bwsIpsUrlPolicyStatsTable, ipsUrlAclProcessAclHits=ipsUrlAclProcessAclHits, ipsLrnSrvcUpdatesByReq=ipsLrnSrvcUpdatesByReq, bwsIpsLrnSrvcStatsTable=bwsIpsLrnSrvcStatsTable, ipsWebAddrTransRspHdrReWritten=ipsWebAddrTransRspHdrReWritten, bwsIpsReqLimitStatsEntry=bwsIpsReqLimitStatsEntry, ipsUrlAclReserved=ipsUrlAclReserved, ipsReqSrvcAddress=ipsReqSrvcAddress, sslSrvrNumOOBDisabled=sslSrvrNumOOBDisabled, bwsHttpSrvrStatsTable=bwsHttpSrvrStatsTable, webCacheCachedObjects=webCacheCachedObjects, sslProxyActiveConn=sslProxyActiveConn, bwsMessage=bwsMessage, httpSrvrSrvcAddressType=httpSrvrSrvcAddressType, ipsUrlNormAddressType=ipsUrlNormAddressType, httpSrvrAddress=httpSrvrAddress, webCmprCompressibleDataSize=webCmprCompressibleDataSize, tempHigh=tempHigh, bwsIpsReqLimitStatsTable=bwsIpsReqLimitStatsTable, ipsCookieSecTampered=ipsCookieSecTampered, httpSrvrMinResTime=httpSrvrMinResTime, webCacheCacheableRes=webCacheCacheableRes, bwsIpsAccessCtrlStatsEntry=bwsIpsAccessCtrlStatsEntry, switchingToInlineMode=switchingToInlineMode, smNumUserSessions=smNumUserSessions, serverDown=serverDown, sslProxyResumptionHandshakes=sslProxyResumptionHandshakes, ipsHdrAclHits=ipsHdrAclHits, bwsCompressionStatsTable=bwsCompressionStatsTable, ipsRCAddressType=ipsRCAddressType, httpSrvrNumConn=httpSrvrNumConn, bwsIpsUrlPolicyStatsEntry=bwsIpsUrlPolicyStatsEntry, ipsWebAddrTransAddressType=ipsWebAddrTransAddressType, ipsReqLimitUrlLenOFErr=ipsReqLimitUrlLenOFErr, httpSrvrState=httpSrvrState, ipsLrnSrvcTotUpdatesByRsp=ipsLrnSrvcTotUpdatesByRsp, httpProxyServerAbrt=httpProxyServerAbrt, ipsReqLimitCookieLenOFErr=ipsReqLimitCookieLenOFErr, ipsReqLimitReqLenOFErr=ipsReqLimitReqLenOFErr, ipsCookieSecCookieDecErr=ipsCookieSecCookieDecErr, sslProxyFullHandshakes=sslProxyFullHandshakes, bwsSMUserSessionEntry=bwsSMUserSessionEntry, webCmprAddress=webCmprAddress, smAgentName=smAgentName, ipsAccessCtrlInvalidSrcIp=ipsAccessCtrlInvalidSrcIp, operationalMode=operationalMode, sslProxyBadCRLErr=sslProxyBadCRLErr, httpProxyTotalConn=httpProxyTotalConn, firmwareUpdateAvailable=firmwareUpdateAvailable, sslProxyAuthBadCertErr=sslProxyAuthBadCertErr, ipsReqLimitBlkdMethodErr=ipsReqLimitBlkdMethodErr, ipsCookieSecNumCookieSet=ipsCookieSecNumCookieSet, ipsLrnSrvcTotUrlUpdated=ipsLrnSrvcTotUrlUpdated, sslSrvrTotSuccess=sslSrvrTotSuccess, firmwareStorage=firmwareStorage, ipsAccessCtrlPort=ipsAccessCtrlPort, sslProxyAuthBadCNErr=sslProxyAuthBadCNErr, ipsLrnSrvcUpdatesByRsp=ipsLrnSrvcUpdatesByRsp, sslSrvrMaxResTime=sslSrvrMaxResTime, ipsUrlAclAddressType=ipsUrlAclAddressType, webCmprPort=webCmprPort, sslProxyCacheHits=sslProxyCacheHits, httpSrvrTotReqAccepted=httpSrvrTotReqAccepted, sslProxyCacheTimeouts=sslProxyCacheTimeouts, switchingToBypassMode=switchingToBypassMode, memUtilization=memUtilization, ipsUrlPolicyTimeStamp=ipsUrlPolicyTimeStamp, bwsIpsRCStatsEntry=bwsIpsRCStatsEntry, ipsUrlAclPort=ipsUrlAclPort, servicePort=servicePort, ipsUrlPolicyAddress=ipsUrlPolicyAddress, ipsAccessCtrlAccessDenied=ipsAccessCtrlAccessDenied, newAttackDefinitionInstalled=newAttackDefinitionInstalled, sslProxyInBytes=sslProxyInBytes, systemLoad=systemLoad, ipsUrlNormSlashDotInUrlErr=ipsUrlNormSlashDotInUrlErr, httpSrvrTotSuccess=httpSrvrTotSuccess, bwsMIBGroups=bwsMIBGroups, ipsLrnSrvcTotParamsLearned=ipsLrnSrvcTotParamsLearned, sslSrvrSrvcPort=sslSrvrSrvcPort, httpSrvrAvgResTime=httpSrvrAvgResTime, bwsServiceStatusEntry=bwsServiceStatusEntry, httpProxyWAFBlockedIntrusions=httpProxyWAFBlockedIntrusions, httpProxyPort=httpProxyPort, sslSrvrTotResponse=sslSrvrTotResponse, ipsReqLimitAddress=ipsReqLimitAddress, peerUp=peerUp, bwsIpsHdrAclStatsTable=bwsIpsHdrAclStatsTable, ipsReqLimitContentLenErr=ipsReqLimitContentLenErr, ipsAccessCtrlNoAuthHdr=ipsAccessCtrlNoAuthHdr, httpProxyWAFMonitoredIntrusions=httpProxyWAFMonitoredIntrusions, logStorageHigh=logStorageHigh, bwsCompressionStatsEntry=bwsCompressionStatsEntry, webCmprProtocol=webCmprProtocol, bwsIpsUrlAclStatsEntry=bwsIpsUrlAclStatsEntry, sslSrvrAddressType=sslSrvrAddressType, ipsAccessCtrlAccessAttempts=ipsAccessCtrlAccessAttempts, ipsRCPort=ipsRCPort, securityDefUpdates=securityDefUpdates, firmwareStorageHigh=firmwareStorageHigh, sslSrvrTotReqActive=sslSrvrTotReqActive, webCacheReq=webCacheReq, ipsRCTotDropped=ipsRCTotDropped, httpSrvrNumReqEnqueue=httpSrvrNumReqEnqueue, httpProxyInBytes=httpProxyInBytes, ipsReqSrvcNoOfUrlProfMatched=ipsReqSrvcNoOfUrlProfMatched, sslSrvrLastDisabledTime=sslSrvrLastDisabledTime, ipsUrlNormCharSetEncodingErr=ipsUrlNormCharSetEncodingErr, dataPortLinkDown=dataPortLinkDown, sslProxyHandshakeAttempts=sslProxyHandshakeAttempts, ipsRCTotQueued=ipsRCTotQueued, ipsAccessCtrlAuthCacheExp=ipsAccessCtrlAuthCacheExp, sslProxyTotalConn=sslProxyTotalConn, httpProxyParseErr=httpProxyParseErr, systemFanSpeed=systemFanSpeed, dataPortLinkUp=dataPortLinkUp, ipsWebAddrTransReqReDirection=ipsWebAddrTransReqReDirection, serviceStatus=serviceStatus, ipsAccessCtrlExpiredCookie=ipsAccessCtrlExpiredCookie, bwsHttpProxyStatsEntry=bwsHttpProxyStatsEntry, bwsIpsRCStatsTable=bwsIpsRCStatsTable, bwsStats=bwsStats, ipsAccessCtrlAddressType=ipsAccessCtrlAddressType, ipsAccessCtrlGenFailure=ipsAccessCtrlGenFailure, bwsIpsUrlAclStatsTable=bwsIpsUrlAclStatsTable, ipsCookieSecAddressType=ipsCookieSecAddressType, sslProxyErrPms=sslProxyErrPms, bwsCacheStatsTable=bwsCacheStatsTable, bwsIpsReqSrvcStatsTable=bwsIpsReqSrvcStatsTable, httpProxyActiveConn=httpProxyActiveConn, bwsServiceStatusTable=bwsServiceStatusTable, ipsUrlAclAddress=ipsUrlAclAddress, ipsUrlPolicyTotQueued=ipsUrlPolicyTotQueued, httpProxyTotalReq=httpProxyTotalReq, httpSrvrInBytes=httpSrvrInBytes, bwsIpsReqSrvcStatsEntry=bwsIpsReqSrvcStatsEntry, virusDefUpdates=virusDefUpdates, cpuUtilization=cpuUtilization, webCacheBytesOut=webCacheBytesOut, peerDown=peerDown, PYSNMP_MODULE_ID=bws, sslSrvrNumOOBEnabled=sslSrvrNumOOBEnabled, ipsUrlPolicyTotOutOfResource=ipsUrlPolicyTotOutOfResource, webCachePort=webCachePort, bwsIpsCookieSecStatsTable=bwsIpsCookieSecStatsTable, uptime=uptime, sslSrvrState=sslSrvrState, switchingToMaintMode=switchingToMaintMode, httpProxyServerReq=httpProxyServerReq, attackDefinitionUpdateAvailable=attackDefinitionUpdateAvailable, sslProxyAddress=sslProxyAddress, httpProxyClientAbrt=httpProxyClientAbrt, sslSrvrAddress=sslSrvrAddress, ipsUrlAclPolicyHits=ipsUrlAclPolicyHits, srvcName=srvcName, ipsLrnSrvcAddressType=ipsLrnSrvcAddressType, ipsCookieSecEncrypted=ipsCookieSecEncrypted, httpSrvrTotReqActive=httpSrvrTotReqActive, smRealmName=smRealmName, ipsReqSrvcAddressType=ipsReqSrvcAddressType, sslSrvrSrvcAddressType=sslSrvrSrvcAddressType, cpuTemperature=cpuTemperature, webCacheAddress=webCacheAddress, ipsReqLimitHdrLenOFErr=ipsReqLimitHdrLenOFErr, bwsIpsCookieSecStatsEntry=bwsIpsCookieSecStatsEntry, ipsUrlPolicyPort=ipsUrlPolicyPort, ipsLrnSrvcPort=ipsLrnSrvcPort, bwsMIBCompliance=bwsMIBCompliance, raidDegrading=raidDegrading, cpuFanSpeed=cpuFanSpeed, highAvailabilityStatus=highAvailabilityStatus, totalBandwidth=totalBandwidth, ipsRCTotOutOfResource=ipsRCTotOutOfResource, currentFirmwareVersion=currentFirmwareVersion, sslSrvrNumOpeningConn=sslSrvrNumOpeningConn, httpProxyServerErr=httpProxyServerErr, ipsUrlNormTildaInUrl=ipsUrlNormTildaInUrl, systemFailOver=systemFailOver, fanDead=fanDead, logStorage=logStorage, ipsReqSrvcPort=ipsReqSrvcPort, webCacheProtocol=webCacheProtocol, ipsWebAddrTransTimeStamp=ipsWebAddrTransTimeStamp, ipsCookieSecCookieDecrypted=ipsCookieSecCookieDecrypted, ipsUrlPolicyTotDropped=ipsUrlPolicyTotDropped, httpProxyUnknownRsp=httpProxyUnknownRsp, bwsIpsAccessCtrlStatsTable=bwsIpsAccessCtrlStatsTable, serviceName=serviceName, ipsAccessCtrlAddress=ipsAccessCtrlAddress, ipsHdrAclPort=ipsHdrAclPort, activeServers=activeServers, sslSrvrMinResTime=sslSrvrMinResTime, ipsUrlAclTimeStamp=ipsUrlAclTimeStamp, bwsIpsHdrAclStatsEntry=bwsIpsHdrAclStatsEntry, sslSrvrTotReqAccepted=sslSrvrTotReqAccepted, ipsRCTimeStamp=ipsRCTimeStamp, sharedSecretKeyExpired=sharedSecretKeyExpired, bwsSslSrvrStatsTable=bwsSslSrvrStatsTable, sslSrvrNumFreeConn=sslSrvrNumFreeConn, ipsLrnSrvcTimeLastUpdated=ipsLrnSrvcTimeLastUpdated, httpSrvrNumOpeningConn=httpSrvrNumOpeningConn, ipsAccessCtrlMissingCookie=ipsAccessCtrlMissingCookie)
mibBuilder.exportSymbols("BWS-MIB", linkStatus=linkStatus, webCmprNoOfReqCompressed=webCmprNoOfReqCompressed, httpProxyAddress=httpProxyAddress, ipsAccessCtrlAuthCacheHits=ipsAccessCtrlAuthCacheHits, webCacheHits=webCacheHits, totalServers=totalServers, bwsIpsUrlNormStatsEntry=bwsIpsUrlNormStatsEntry, ipsCookieSecNumCookieAllow=ipsCookieSecNumCookieAllow, webCacheLongHdrs=webCacheLongHdrs, sslSrvrNumConn=sslSrvrNumConn, ipsHdrAclAddressType=ipsHdrAclAddressType, httpSrvrTotRefused=httpSrvrTotRefused, ipsUrlNormPort=ipsUrlNormPort, ipsLrnSrvcTimeLocked=ipsLrnSrvcTimeLocked, memoryUsageHigh=memoryUsageHigh, httpSrvrNumOOBEnabled=httpSrvrNumOOBEnabled, sslProxyCacheMiss=sslProxyCacheMiss, httpSrvrAvgReqPerConn=httpSrvrAvgReqPerConn, ipsRCAddress=ipsRCAddress, sslSrvrPort=sslSrvrPort, ipsWebAddrTransReqHdrReWritten=ipsWebAddrTransReqHdrReWritten, sslProxyOutBytes=sslProxyOutBytes, sslProxyCurrentConn=sslProxyCurrentConn, totalAttacks=totalAttacks, bwsHttpSrvrStatsEntry=bwsHttpSrvrStatsEntry, bwsSslProxyStatsTable=bwsSslProxyStatsTable, httpProxyAddressType=httpProxyAddressType, sslProxyTotalReq=sslProxyTotalReq, bwsIpsWebAddrTransStatsTable=bwsIpsWebAddrTransStatsTable, ipsUrlPolicyTotServed=ipsUrlPolicyTotServed, sslSrvrTotTimedout=sslSrvrTotTimedout, ipsWebAddrTransAddress=ipsWebAddrTransAddress, bwsSslProxyStatsEntry=bwsSslProxyStatsEntry, ipsHdrAclTimeStamp=ipsHdrAclTimeStamp, sslSrvrOutBytes=sslSrvrOutBytes, bwsMIBCompliances=bwsMIBCompliances, energizeUpdateExpire=energizeUpdateExpire, sslProxyBadDNCErr=sslProxyBadDNCErr, httpSrvrTotResponse=httpSrvrTotResponse, ipsReqLimitPort=ipsReqLimitPort, sslSrvrInBytes=sslSrvrInBytes, webCacheStale=webCacheStale, ipsCookieSecAddress=ipsCookieSecAddress, ipsReqLimitHdrCntOFErr=ipsReqLimitHdrCntOFErr, webCacheAddressType=webCacheAddressType, bwsIpsLrnSrvcStatsEntry=bwsIpsLrnSrvcStatsEntry, httpProxySessionTimeOut=httpProxySessionTimeOut, ipsLrnSrvcAddress=ipsLrnSrvcAddress, sslSrvrAvgReqPerConn=sslSrvrAvgReqPerConn, ipsReqLimitAddressType=ipsReqLimitAddressType, bwsCacheStatsEntry=bwsCacheStatsEntry, bwsSslSrvrStatsEntry=bwsSslSrvrStatsEntry, httpProxyWAFWarnings=httpProxyWAFWarnings, bwsIpsWebAddrTransStatsEntry=bwsIpsWebAddrTransStatsEntry, ipsAccessCtrlInvalidCookie=ipsAccessCtrlInvalidCookie, ipsAccessCtrlTimeStamp=ipsAccessCtrlTimeStamp, httpSrvrAddressType=httpSrvrAddressType, ipsRCTotServed=ipsRCTotServed, sslProxyAddressType=sslProxyAddressType, bwsIpsUrlNormStatsTable=bwsIpsUrlNormStatsTable, ipsCookieSecPort=ipsCookieSecPort, ipsWebAddrTransRspUrlTrans=ipsWebAddrTransRspUrlTrans, httpSrvrSrvcAddress=httpSrvrSrvcAddress, dataPathStatus=dataPathStatus, httpSrvrOutBytes=httpSrvrOutBytes, httpSrvrMaxResTime=httpSrvrMaxResTime, bwsStatsGroup=bwsStatsGroup, webCacheMiss=webCacheMiss)
