...
# ASN.1 source CISCO-WIRELESS-P2P-BPI-MIB
# Source digest sha256:3a8ccfbf3853245deeb9939c1b8cf24dc6bdf46e696d9941182ddc01ebfd7710
...
if mibBuilder.loadTexts: ciscoWirelessP2pBpiMIB.setLastUpdated('1999-05-18 12:00')
if mibBuilder.loadTexts: ciscoWirelessP2pBpiMIB.setOrganization('Cisco Systems Inc.')
if mibBuilder.loadTexts: ciscoWirelessP2pBpiMIB.setContactInfo('\tCisco Systems\n\t\tCustomer Service\n\n\t   Postal: 170 W Tasman Drive\n\t\t   San Jose, CA  95134\n\t\t   USA\n\n\t\t   Tel: +1 800 553-NETS\n\t           E-mail: cs-wireless@cisco.com')
if mibBuilder.loadTexts: ciscoWirelessP2pBpiMIB.setDescription('This is the MIB Module for the Baseline Privacy Interface (BPI)\n\tat Point to Point Wireless Radio Card.\n\n\tThis is a specialization on the MCNS docsBpiMib for Cisco Wireless\n\tpoint to point communication links.')
cwrBpiMIBObjects = MibIdentifier((1, 3, 6, 1, 4, 1, 9, 9, 135, 1))
cwrBpiRsObjects = MibIdentifier((1, 3, 6, 1, 4, 1, 9, 9, 135, 1, 1))
cwrBpiRsBaseTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 135, 1, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cwrBpiRsBaseTable.setStatus('current')
if mibBuilder.loadTexts: cwrBpiRsBaseTable.setDescription('Describes the basic and authorization-related Baseline Privacy\n        attributes of each Slave Radio interface.')
cwrBpiRsBaseEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 135, 1, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
if mibBuilder.loadTexts: cwrBpiRsBaseEntry.setStatus('current')
if mibBuilder.loadTexts: cwrBpiRsBaseEntry.setDescription('An entry containing objects describing attributes of one Slave\n\tRadio interface. An entry in this table exists for each\n\tifEntry with an\tifType of ciscoWirelessP2P.')
...
if mibBuilder.loadTexts: cwrBpiRsPrivacyEnable.setDescription('This object identifies whether the Slave Radio is provisioned\n\tto use Encryption or not.')
...
if mibBuilder.loadTexts: cwrBpiRsPublicKey.setDescription('Public key of the Radio Slave encoded as an ASN.1\n\tSubjectPublicKeyInfo object as defined in the RSA Encryption\n\tStandard (PKCS #1) [RSA1].')
...
if mibBuilder.loadTexts: cwrBpiRsAuthState.setDescription('The state of the Radio Slave authorization FSM. \n\tThe start state indicates that FSM is in its initial state.')
...
if mibBuilder.loadTexts: cwrBpiRsAuthExpires.setDescription('The number of seconds left before the current authorization for this\n\tFSM expires. If the Radio Slave does not have an active authorization,\n\tthen this value is 0.')
...
if mibBuilder.loadTexts: cwrBpiRsAuthWaitTimeout.setDescription('Authorize Wait Timeout. The value of this object cannot be changed\n\twhile the authorization state machine is running.')
...
if mibBuilder.loadTexts: cwrBpiRsReauthWaitTimeout.setDescription('Reauthorize Wait Timeout in seconds. The value of this object cannot\n\tbe changed while the authorization state machine is running.')
...
if mibBuilder.loadTexts: cwrBpiRsOpWaitTimeout.setDescription('Operational Wait Timeout in seconds. The value of this object cannot\n\tbe changed while the authorization state machine is running.')
...
if mibBuilder.loadTexts: cwrBpiRsRekeyWaitTimeout.setDescription('Rekey Wait Timeout in seconds. The value of this object cannot be\n\tchanged while the authorization state machine is running.')
...
if mibBuilder.loadTexts: cwrBpiRsAuthRequests.setDescription('Count of times the Radio Slave has transmitted an Authorization\n\tRequest message.')
...
if mibBuilder.loadTexts: cwrBpiRsAuthReplies.setDescription('Count of times the Radio Slave has received an Authorization\n\tReply message.')
...
if mibBuilder.loadTexts: cwrBpiRsAuthInvalids.setDescription('Count of times the Radio Slave has received an Authorization\n\tInvalid message.')
...
if mibBuilder.loadTexts: cwrBpiRsAuthInvalidErrorCode.setDescription('Error-Code in most recent Authorization Invalid message received by\n\tthe Radio Slave. On bootup, this has value no-information(0).  At all\n        other times, this object reflects the error code received')
...
if mibBuilder.loadTexts: cwrBpiRsAuthInvalidErrorString.setDescription('Display-String in most recent Authorization Invalid message received\n\t by the Radio Slave. This is a zero length string if no Authorization\n\t Invalid message has been received since reboot.')
cwrBpiRsTEKTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 135, 1, 1, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cwrBpiRsTEKTable.setStatus('current')
if mibBuilder.loadTexts: cwrBpiRsTEKTable.setDescription('Describes the attributes of each Radio Slave Traffic Encryption\n\tKey (TEK) Service.')
cwrBpiRsTEKEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 135, 1, 1, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
if mibBuilder.loadTexts: cwrBpiRsTEKEntry.setStatus('current')
if mibBuilder.loadTexts: cwrBpiRsTEKEntry.setDescription('An entry containing objects describing the TEK attributes of\n\tone instantiated TEK service. There will be one such entry for every\n\tRadio Slave of a P2P link.')
...
if mibBuilder.loadTexts: cwrBpiRsTEKState.setDescription('The state of the indicated TEK FSM. The start(1) state indicates\n\tthat FSM is in its initial state.')
...
if mibBuilder.loadTexts: cwrBpiRsTEKExpiresOld.setDescription('The number of seconds left to expire for the oldest active key\n\tfor this FSM. If this FSM has no active keys then this value will\n\tbe zero.')
...
if mibBuilder.loadTexts: cwrBpiRsTEKExpiresNew.setDescription('The number of seconds left to expire for the newest active key for\n\tthis FSM. If this FSM has no active keys then this value will\n\tbe zero.')
...
if mibBuilder.loadTexts: cwrBpiRsTEKKeyRequests.setDescription('Count of times the this TEK Service has transmitted a Key Request\n\tmessage.')
...
if mibBuilder.loadTexts: cwrBpiRsTEKAuthPends.setDescription('Count of times an Authorization Pending (Auth Pend) event\n\toccurred in this TEK Serivce FSM.')
...
if mibBuilder.loadTexts: cwrBpiRsTEKInvalidErrorCode.setDescription('Error-Code in most recent TEK Invalid message received by this TEK\n\tservice. On bootup, this has value no-information(0).  At all\n        other times, this object reflects the error code received')
...
if mibBuilder.loadTexts: cwrBpiRmAuthPrivacyEnable.setDescription('This object identifies whether the Master Radio is provisioned\n\tto use Encryption or not.')
...
if mibBuilder.loadTexts: cwrBpiRmAuthRsPublicKey.setDescription('Public key of the Radio Slave encoded as an ASN.1 SubjectPublicKeyInfo\n\tobject as defined in the RSA Encryption Standard (PKCS #1) [RSA1].\n\tThis is a zero-length string if the Radio Master does not retain the\n\tpublic key.')
...
if mibBuilder.loadTexts: cwrBpiRmAuthRsExpires.setDescription('The number of seconds left before the current authorization for\n\tthis Radio Slave expires. If this Radio Slave does not have an active\n\tauthorization, then the value is zero.')
...
if mibBuilder.loadTexts: cwrBpiRmAuthRsLifetime.setDescription('Lifetime, in seconds, the Radio Master assigns to an authorization key\n\tfor this Radio Slave.\n\n        NOTE:  When installed in the field, this variable should NEVER be set\n\t       below 86400 which is the lower limit by standard.\n\t       This variable accepts a wider range to facilitate testing.')
...
if mibBuilder.loadTexts: cwrBpiRmAuthRsRequests.setDescription('Count of times the Radio Master has received an Authorization Request\n\tmessage from this Radio Slave.')
...
if mibBuilder.loadTexts: cwrBpiRmAuthRsReplies.setDescription('Count of times the Radio master has transmitted an Authorization Reply\n\tmessage to this Radio Slave.')
...
if mibBuilder.loadTexts: cwrBpiRmAuthRsInvalids.setDescription('Count of times the Radio Master has transmitted an Authorization\n\tInvalid message to this Radio Slave.')
...
if mibBuilder.loadTexts: cwrBpiRmAuthInvalidErrorCode.setDescription('Error-Code in most recent Authorization Invalid message transmitted to\n\tthe Radio Slave. On bootup, this has value no-information(0).  At all\n        other times, this object reflects the error code transmitted')
...
if mibBuilder.loadTexts: cwrBpiRmTEKEncryptionNegotiated.setDescription("This identifies whether this TEK service is using encryption or\n         not.  Encryption may not be in use even though\n\t cwrBpiRmAuthPrivacyEnable is provisioned.\n\t This is possible if the master is not configured\n         for privacy or it's not running an encryption capable image.")
...
if mibBuilder.loadTexts: cwrBpiRmTEKLifetime.setDescription('Lifetime, in seconds, the Radio Master assigns to keys for this TEK\n\tassociation.\n        NOTE:  When installed in the field, this variable should NEVER be set\n\t       below 1800 which is the lower limit by standard.\n\t       This variable accepts a wider range to facilitate testing.')
...
if mibBuilder.loadTexts: cwrBpiRmTEKExpiresOld.setDescription('The number of seconds left to expire for the oldest active key for\n\tthis TEK association. If this TEK associateion has no active key then\n\tthe value will be zero.')
...
if mibBuilder.loadTexts: cwrBpiRmTEKExpiresNew.setDescription('The number of seconds left to expire for the newest active key for\n\tthis TEK association. If this TEK association has no active keys\n\tthen this value will be zero.')
...
if mibBuilder.loadTexts: cwrBpiRmTEKReset.setDescription('Setting this object to TRUE causes the Radio Master to invalidate the\n\tcurrent active TEK(s) (plural due to key transition periods), and\n\tto generate a new TEK.  Reading this object always returns FALSE.')
...
if mibBuilder.loadTexts: cwrBpiRmTEKInvalids.setDescription('Count of times the Radio Master has transmitted a TEK Invalid\n\tmessage.')
...
if mibBuilder.loadTexts: cwrBpiRmTEKInvalidErrorCode.setDescription('Error-Code in most recent TEK Invalid message sent in association \n\twith this TEK service. On bootup, this has value no-information(0).\n\tAt all other times, this object reflects the error code received')
...
if mibBuilder.loadTexts: cwrBpiRmTEKInvalidErrorString.setDescription('Display-String in the most recent TEK Invalid message sent in \n\tssociation with this BPI TEK service. This is a zero length\n\tstring if no TEK Invalid message has been received since reboot.')
...
if mibBuilder.loadTexts: cwrBpiBasicCompliance.setDescription('The compliance statement for devices which implement the\n\tCisco Wireless Radio point to point Baseline Privacy Interface.')
...
mibBuilder.exportSymbols("CISCO-WIRELESS-P2P-BPI-MIB", PYSNMP_MODULE_ID=ciscoWirelessP2pBpiMIB, ciscoWirelessP2pBpiMIB=ciscoWirelessP2pBpiMIB, cwrBpiBasicCompliance=cwrBpiBasicCompliance, cwrBpiCompliances=cwrBpiCompliances, cwrBpiConformance=cwrBpiConformance, cwrBpiGroups=cwrBpiGroups, cwrBpiMIBObjects=cwrBpiMIBObjects, cwrBpiNotification=cwrBpiNotification, cwrBpiRmAuthEntry=cwrBpiRmAuthEntry, cwrBpiRmAuthInvalidErrorCode=cwrBpiRmAuthInvalidErrorCode, cwrBpiRmAuthInvalidErrorString=cwrBpiRmAuthInvalidErrorString, cwrBpiRmAuthPrivacyEnable=cwrBpiRmAuthPrivacyEnable, cwrBpiRmAuthRsExpires=cwrBpiRmAuthRsExpires, cwrBpiRmAuthRsInvalids=cwrBpiRmAuthRsInvalids, cwrBpiRmAuthRsKeySequenceNumber=cwrBpiRmAuthRsKeySequenceNumber, cwrBpiRmAuthRsLifetime=cwrBpiRmAuthRsLifetime, cwrBpiRmAuthRsPublicKey=cwrBpiRmAuthRsPublicKey, cwrBpiRmAuthRsReplies=cwrBpiRmAuthRsReplies, cwrBpiRmAuthRsRequests=cwrBpiRmAuthRsRequests, cwrBpiRmAuthRsReset=cwrBpiRmAuthRsReset, cwrBpiRmAuthTable=cwrBpiRmAuthTable, cwrBpiRmGroup=cwrBpiRmGroup, cwrBpiRmKeyReplies=cwrBpiRmKeyReplies, cwrBpiRmKeyRequests=cwrBpiRmKeyRequests, cwrBpiRmObjects=cwrBpiRmObjects, cwrBpiRmTEKEncryptionNegotiated=cwrBpiRmTEKEncryptionNegotiated, cwrBpiRmTEKEntry=cwrBpiRmTEKEntry, cwrBpiRmTEKExpiresNew=cwrBpiRmTEKExpiresNew, cwrBpiRmTEKExpiresOld=cwrBpiRmTEKExpiresOld, cwrBpiRmTEKInvalidErrorCode=cwrBpiRmTEKInvalidErrorCode, cwrBpiRmTEKInvalidErrorString=cwrBpiRmTEKInvalidErrorString, cwrBpiRmTEKInvalids=cwrBpiRmTEKInvalids, cwrBpiRmTEKLifetime=cwrBpiRmTEKLifetime, cwrBpiRmTEKReset=cwrBpiRmTEKReset, cwrBpiRmTEKTable=cwrBpiRmTEKTable, cwrBpiRsAuthExpires=cwrBpiRsAuthExpires, cwrBpiRsAuthGraceTime=cwrBpiRsAuthGraceTime, cwrBpiRsAuthInvalidErrorCode=cwrBpiRsAuthInvalidErrorCode, cwrBpiRsAuthInvalidErrorString=cwrBpiRsAuthInvalidErrorString, cwrBpiRsAuthInvalids=cwrBpiRsAuthInvalids, cwrBpiRsAuthKeySequenceNumber=cwrBpiRsAuthKeySequenceNumber, cwrBpiRsAuthReplies=cwrBpiRsAuthReplies, cwrBpiRsAuthRequests=cwrBpiRsAuthRequests, cwrBpiRsAuthReset=cwrBpiRsAuthReset, cwrBpiRsAuthState=cwrBpiRsAuthState, cwrBpiRsAuthWaitTimeout=cwrBpiRsAuthWaitTimeout, cwrBpiRsBaseEntry=cwrBpiRsBaseEntry, cwrBpiRsBaseTable=cwrBpiRsBaseTable, cwrBpiRsGroup=cwrBpiRsGroup, cwrBpiRsObjects=cwrBpiRsObjects, cwrBpiRsOpWaitTimeout=cwrBpiRsOpWaitTimeout, cwrBpiRsPrivacyEnable=cwrBpiRsPrivacyEnable, cwrBpiRsPublicKey=cwrBpiRsPublicKey, cwrBpiRsReauthWaitTimeout=cwrBpiRsReauthWaitTimeout, cwrBpiRsRekeyWaitTimeout=cwrBpiRsRekeyWaitTimeout, cwrBpiRsTEKAuthPends=cwrBpiRsTEKAuthPends, cwrBpiRsTEKEncryptionNegotiated=cwrBpiRsTEKEncryptionNegotiated, cwrBpiRsTEKEntry=cwrBpiRsTEKEntry, cwrBpiRsTEKExpiresNew=cwrBpiRsTEKExpiresNew, cwrBpiRsTEKExpiresOld=cwrBpiRsTEKExpiresOld, cwrBpiRsTEKGraceTime=cwrBpiRsTEKGraceTime, cwrBpiRsTEKInvalidErrorCode=cwrBpiRsTEKInvalidErrorCode, cwrBpiRsTEKInvalidErrorString=cwrBpiRsTEKInvalidErrorString, cwrBpiRsTEKInvalids=cwrBpiRsTEKInvalids, cwrBpiRsTEKKeyReplies=cwrBpiRsTEKKeyReplies, cwrBpiRsTEKKeyRequests=cwrBpiRsTEKKeyRequests, cwrBpiRsTEKState=cwrBpiRsTEKState, cwrBpiRsTEKTable=cwrBpiRsTEKTable)
