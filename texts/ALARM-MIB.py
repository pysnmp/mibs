...
Counter32, Counter64, Opaque, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Bits, MibIdentifier, zeroDotZero, iso, Integer32, ObjectIdentity, Gauge32, Unsigned32, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Opaque", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Bits", "MibIdentifier", "zeroDotZero", "iso", "Integer32", "ObjectIdentity", "Gauge32", "Unsigned32", "NotificationType", "mib-2")
...
mibBuilder.exportSymbols("ALARM-MIB", alarmModel=alarmModel, alarmActiveEngineID=alarmActiveEngineID, alarmActiveLastChanged=alarmActiveLastChanged, alarmModelDescription=alarmModelDescription, alarmActiveNotificationID=alarmActiveNotificationID, alarmClearGroup=alarmClearGroup, alarmActiveStatsActives=alarmActiveStatsActives, alarmActiveStatsLastClear=alarmActiveStatsLastClear, alarmActiveVariableIndex=alarmActiveVariableIndex, alarmClearEngineAddressType=alarmClearEngineAddressType, alarmModelEntry=alarmModelEntry, alarmModelTable=alarmModelTable, alarmActiveGroup=alarmActiveGroup, alarmModelIndex=alarmModelIndex, alarmActiveVariableOidVal=alarmActiveVariableOidVal, alarmActiveStatsActiveCurrent=alarmActiveStatsActiveCurrent, alarmActiveVariableCounter64Val=alarmActiveVariableCounter64Val, alarmClearIndex=alarmClearIndex, alarmClearMaximum=alarmClearMaximum, alarmModelVarbindSubtree=alarmModelVarbindSubtree, alarmActiveVariableTable=alarmActiveVariableTable, alarmCompliances=alarmCompliances, alarmActiveVariableTimeTicksVal=alarmActiveVariableTimeTicksVal, alarmObjects=alarmObjects, alarmActiveLogPointer=alarmActiveLogPointer, alarmActive=alarmActive, alarmActiveDateAndTime=alarmActiveDateAndTime, alarmActiveDescription=alarmActiveDescription, alarmActiveVariableUnsigned32Val=alarmActiveVariableUnsigned32Val, alarmActiveStatsGroup=alarmActiveStatsGroup, alarmNotificationsGroup=alarmNotificationsGroup, alarmActiveTable=alarmActiveTable, alarmModelVarbindIndex=alarmModelVarbindIndex, alarmActiveEngineAddressType=alarmActiveEngineAddressType, alarmActiveVariableID=alarmActiveVariableID, alarmActiveOverflow=alarmActiveOverflow, alarmClearTable=alarmClearTable, alarmActiveVariableCounter32Val=alarmActiveVariableCounter32Val, alarmGroups=alarmGroups, alarmClearDateAndTime=alarmClearDateAndTime, alarmListName=alarmListName, alarmConformance=alarmConformance, alarmClearEngineID=alarmClearEngineID, alarmClearResourceId=alarmClearResourceId, alarmActiveEntry=alarmActiveEntry, alarmClearState=alarmClearState, ResourceId=ResourceId, alarmMIB=alarmMIB, alarmActiveSpecificPointer=alarmActiveSpecificPointer, alarmModelGroup=alarmModelGroup, alarmClear=alarmClear, alarmActiveStatsEntry=alarmActiveStatsEntry, alarmClearEngineAddress=alarmClearEngineAddress, alarmModelResourcePrefix=alarmModelResourcePrefix, alarmActiveVariableOpaqueVal=alarmActiveVariableOpaqueVal, alarmModelState=alarmModelState, alarmActiveIndex=alarmActiveIndex, alarmModelSpecificPointer=alarmModelSpecificPointer, alarmClearModelPointer=alarmClearModelPointer, alarmActiveStatsLastRaise=alarmActiveStatsLastRaise, alarmActiveEngineAddress=alarmActiveEngineAddress, alarmActiveStatsTable=alarmActiveStatsTable, alarmClearContextName=alarmClearContextName, alarmActiveResourceId=alarmActiveResourceId, alarmActiveVariableIpAddressVal=alarmActiveVariableIpAddressVal, alarmClearEntry=alarmClearEntry, alarmActiveModelPointer=alarmActiveModelPointer, PYSNMP_MODULE_ID=alarmMIB, alarmActiveVariableInteger32Val=alarmActiveVariableInteger32Val, alarmActiveContextName=alarmActiveContextName, alarmModelLastChanged=alarmModelLastChanged, alarmActiveVariableValueType=alarmActiveVariableValueType, alarmModelRowStatus=alarmModelRowStatus, alarmActiveState=alarmActiveState, alarmModelNotificationId=alarmModelNotificationId, alarmClearLogIndex=alarmClearLogIndex, alarmModelVarbindValue=alarmModelVarbindValue, alarmNotifications=alarmNotifications, alarmCompliance=alarmCompliance, LocalSnmpEngineOrZeroLenStr=LocalSnmpEngineOrZeroLenStr, alarmActiveVariableEntry=alarmActiveVariableEntry, alarmActiveVariables=alarmActiveVariables, alarmActiveVariableOctetStringVal=alarmActiveVariableOctetStringVal, alarmClearNotificationID=alarmClearNotificationID)
