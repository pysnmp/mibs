...
ModuleIdentity, Opaque, Integer32, Counter64, Gauge32, mib_2, TimeTicks, Counter32, zeroDotZero, Bits, ObjectIdentity, MibIdentifier, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Opaque", "Integer32", "Counter64", "Gauge32", "mib-2", "TimeTicks", "Counter32", "zeroDotZero", "Bits", "ObjectIdentity", "MibIdentifier", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("ALARM-MIB", alarmActiveVariableCounter32Val=alarmActiveVariableCounter32Val, alarmActiveNotificationID=alarmActiveNotificationID, alarmActiveStatsTable=alarmActiveStatsTable, ResourceId=ResourceId, alarmActiveStatsEntry=alarmActiveStatsEntry, alarmActiveEngineAddress=alarmActiveEngineAddress, alarmActiveVariableEntry=alarmActiveVariableEntry, alarmNotifications=alarmNotifications, alarmActive=alarmActive, alarmCompliances=alarmCompliances, alarmModelRowStatus=alarmModelRowStatus, alarmActiveVariableOpaqueVal=alarmActiveVariableOpaqueVal, LocalSnmpEngineOrZeroLenStr=LocalSnmpEngineOrZeroLenStr, alarmActiveOverflow=alarmActiveOverflow, alarmNotificationsGroup=alarmNotificationsGroup, alarmActiveLogPointer=alarmActiveLogPointer, alarmClearGroup=alarmClearGroup, alarmActiveVariableTimeTicksVal=alarmActiveVariableTimeTicksVal, alarmActiveVariableCounter64Val=alarmActiveVariableCounter64Val, alarmActiveStatsActives=alarmActiveStatsActives, alarmActiveLastChanged=alarmActiveLastChanged, alarmModel=alarmModel, alarmActiveEngineID=alarmActiveEngineID, alarmActiveVariableIpAddressVal=alarmActiveVariableIpAddressVal, alarmGroups=alarmGroups, alarmModelDescription=alarmModelDescription, alarmCompliance=alarmCompliance, alarmClearContextName=alarmClearContextName, alarmActiveVariableID=alarmActiveVariableID, alarmModelSpecificPointer=alarmModelSpecificPointer, alarmClear=alarmClear, alarmActiveStatsGroup=alarmActiveStatsGroup, alarmModelIndex=alarmModelIndex, alarmActiveContextName=alarmActiveContextName, alarmActiveVariableUnsigned32Val=alarmActiveVariableUnsigned32Val, alarmActiveVariableOctetStringVal=alarmActiveVariableOctetStringVal, alarmClearEngineAddress=alarmClearEngineAddress, alarmClearMaximum=alarmClearMaximum, alarmClearTable=alarmClearTable, alarmModelNotificationId=alarmModelNotificationId, alarmActiveState=alarmActiveState, alarmActiveIndex=alarmActiveIndex, alarmModelLastChanged=alarmModelLastChanged, alarmActiveModelPointer=alarmActiveModelPointer, alarmModelVarbindValue=alarmModelVarbindValue, alarmClearEngineAddressType=alarmClearEngineAddressType, alarmActiveEntry=alarmActiveEntry, alarmActiveDescription=alarmActiveDescription, alarmMIB=alarmMIB, alarmClearEntry=alarmClearEntry, alarmClearResourceId=alarmClearResourceId, alarmModelVarbindIndex=alarmModelVarbindIndex, PYSNMP_MODULE_ID=alarmMIB, alarmActiveResourceId=alarmActiveResourceId, alarmClearModelPointer=alarmClearModelPointer, alarmModelVarbindSubtree=alarmModelVarbindSubtree, alarmActiveVariableInteger32Val=alarmActiveVariableInteger32Val, alarmListName=alarmListName, alarmActiveSpecificPointer=alarmActiveSpecificPointer, alarmActiveEngineAddressType=alarmActiveEngineAddressType, alarmActiveVariableValueType=alarmActiveVariableValueType, alarmActiveVariableIndex=alarmActiveVariableIndex, alarmModelResourcePrefix=alarmModelResourcePrefix, alarmActiveVariables=alarmActiveVariables, alarmConformance=alarmConformance, alarmClearNotificationID=alarmClearNotificationID, alarmModelEntry=alarmModelEntry, alarmActiveStatsLastRaise=alarmActiveStatsLastRaise, alarmActiveStatsActiveCurrent=alarmActiveStatsActiveCurrent, alarmActiveVariableOidVal=alarmActiveVariableOidVal, alarmClearIndex=alarmClearIndex, alarmActiveStatsLastClear=alarmActiveStatsLastClear, alarmActiveTable=alarmActiveTable, alarmModelState=alarmModelState, alarmActiveVariableTable=alarmActiveVariableTable, alarmClearEngineID=alarmClearEngineID, alarmClearState=alarmClearState, alarmObjects=alarmObjects, alarmModelTable=alarmModelTable, alarmClearLogIndex=alarmClearLogIndex, alarmClearDateAndTime=alarmClearDateAndTime, alarmActiveDateAndTime=alarmActiveDateAndTime, alarmModelGroup=alarmModelGroup, alarmActiveGroup=alarmActiveGroup)
