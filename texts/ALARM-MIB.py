...
Integer32, zeroDotZero, Opaque, ModuleIdentity, TimeTicks, Bits, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, NotificationType, MibIdentifier, Unsigned32, ObjectIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "zeroDotZero", "Opaque", "ModuleIdentity", "TimeTicks", "Bits", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "NotificationType", "MibIdentifier", "Unsigned32", "ObjectIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("ALARM-MIB", alarmActiveSpecificPointer=alarmActiveSpecificPointer, alarmActiveResourceId=alarmActiveResourceId, ResourceId=ResourceId, alarmModelSpecificPointer=alarmModelSpecificPointer, alarmActiveStatsActives=alarmActiveStatsActives, alarmActiveVariableCounter64Val=alarmActiveVariableCounter64Val, alarmActiveEngineAddress=alarmActiveEngineAddress, alarmClearModelPointer=alarmClearModelPointer, alarmClearEngineAddressType=alarmClearEngineAddressType, alarmActiveLastChanged=alarmActiveLastChanged, alarmActiveVariables=alarmActiveVariables, alarmCompliance=alarmCompliance, alarmActiveStatsActiveCurrent=alarmActiveStatsActiveCurrent, alarmClearNotificationID=alarmClearNotificationID, alarmActiveVariableCounter32Val=alarmActiveVariableCounter32Val, alarmActiveDateAndTime=alarmActiveDateAndTime, alarmActiveVariableEntry=alarmActiveVariableEntry, alarmActiveLogPointer=alarmActiveLogPointer, alarmModelTable=alarmModelTable, alarmNotificationsGroup=alarmNotificationsGroup, alarmClearResourceId=alarmClearResourceId, alarmActiveVariableID=alarmActiveVariableID, alarmClearGroup=alarmClearGroup, alarmActiveVariableIndex=alarmActiveVariableIndex, alarmModelRowStatus=alarmModelRowStatus, alarmActiveState=alarmActiveState, alarmCompliances=alarmCompliances, alarmActiveDescription=alarmActiveDescription, alarmModelNotificationId=alarmModelNotificationId, alarmObjects=alarmObjects, alarmActiveGroup=alarmActiveGroup, alarmActiveStatsLastClear=alarmActiveStatsLastClear, alarmClearLogIndex=alarmClearLogIndex, alarmActive=alarmActive, alarmClearIndex=alarmClearIndex, alarmActiveContextName=alarmActiveContextName, alarmClearEngineID=alarmClearEngineID, alarmClearEngineAddress=alarmClearEngineAddress, alarmActiveVariableUnsigned32Val=alarmActiveVariableUnsigned32Val, alarmModelEntry=alarmModelEntry, PYSNMP_MODULE_ID=alarmMIB, alarmActiveVariableOpaqueVal=alarmActiveVariableOpaqueVal, alarmModelState=alarmModelState, alarmActiveStatsGroup=alarmActiveStatsGroup, alarmModelResourcePrefix=alarmModelResourcePrefix, alarmModelVarbindValue=alarmModelVarbindValue, alarmModelLastChanged=alarmModelLastChanged, alarmModelVarbindSubtree=alarmModelVarbindSubtree, alarmActiveVariableOidVal=alarmActiveVariableOidVal, alarmActiveIndex=alarmActiveIndex, alarmActiveEngineAddressType=alarmActiveEngineAddressType, alarmActiveStatsTable=alarmActiveStatsTable, alarmModel=alarmModel, alarmActiveStatsLastRaise=alarmActiveStatsLastRaise, alarmActiveModelPointer=alarmActiveModelPointer, alarmActiveEntry=alarmActiveEntry, alarmActiveVariableTable=alarmActiveVariableTable, alarmConformance=alarmConformance, LocalSnmpEngineOrZeroLenStr=LocalSnmpEngineOrZeroLenStr, alarmActiveVariableIpAddressVal=alarmActiveVariableIpAddressVal, alarmClearEntry=alarmClearEntry, alarmActiveVariableTimeTicksVal=alarmActiveVariableTimeTicksVal, alarmModelGroup=alarmModelGroup, alarmActiveVariableValueType=alarmActiveVariableValueType, alarmClear=alarmClear, alarmActiveStatsEntry=alarmActiveStatsEntry, alarmActiveEngineID=alarmActiveEngineID, alarmActiveVariableInteger32Val=alarmActiveVariableInteger32Val, alarmGroups=alarmGroups, alarmClearTable=alarmClearTable, alarmModelVarbindIndex=alarmModelVarbindIndex, alarmModelDescription=alarmModelDescription, alarmMIB=alarmMIB, alarmActiveOverflow=alarmActiveOverflow, alarmListName=alarmListName, alarmClearState=alarmClearState, alarmClearDateAndTime=alarmClearDateAndTime, alarmClearContextName=alarmClearContextName, alarmClearMaximum=alarmClearMaximum, alarmActiveTable=alarmActiveTable, alarmActiveVariableOctetStringVal=alarmActiveVariableOctetStringVal, alarmModelIndex=alarmModelIndex, alarmActiveNotificationID=alarmActiveNotificationID, alarmNotifications=alarmNotifications)
