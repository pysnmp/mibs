...
ModuleIdentity, Counter32, NotificationType, zeroDotZero, Unsigned32, TimeTicks, IpAddress, iso, Opaque, Counter64, Gauge32, Bits, ObjectIdentity, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "NotificationType", "zeroDotZero", "Unsigned32", "TimeTicks", "IpAddress", "iso", "Opaque", "Counter64", "Gauge32", "Bits", "ObjectIdentity", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("ALARM-MIB", alarmNotifications=alarmNotifications, alarmActiveVariableOpaqueVal=alarmActiveVariableOpaqueVal, alarmActiveVariableTimeTicksVal=alarmActiveVariableTimeTicksVal, alarmActiveVariableCounter64Val=alarmActiveVariableCounter64Val, alarmActiveStatsEntry=alarmActiveStatsEntry, alarmModel=alarmModel, alarmActiveLastChanged=alarmActiveLastChanged, alarmMIB=alarmMIB, alarmClearResourceId=alarmClearResourceId, alarmActiveVariableIpAddressVal=alarmActiveVariableIpAddressVal, alarmActiveStatsLastRaise=alarmActiveStatsLastRaise, alarmActiveContextName=alarmActiveContextName, alarmClearModelPointer=alarmClearModelPointer, alarmActiveLogPointer=alarmActiveLogPointer, alarmClearEntry=alarmClearEntry, alarmActiveNotificationID=alarmActiveNotificationID, LocalSnmpEngineOrZeroLenStr=LocalSnmpEngineOrZeroLenStr, alarmActiveVariables=alarmActiveVariables, alarmGroups=alarmGroups, alarmActiveState=alarmActiveState, alarmModelVarbindSubtree=alarmModelVarbindSubtree, alarmActiveDescription=alarmActiveDescription, alarmModelVarbindValue=alarmModelVarbindValue, alarmModelGroup=alarmModelGroup, alarmModelTable=alarmModelTable, alarmClearIndex=alarmClearIndex, alarmClearDateAndTime=alarmClearDateAndTime, alarmActiveVariableOidVal=alarmActiveVariableOidVal, alarmClearState=alarmClearState, ResourceId=ResourceId, alarmActiveVariableValueType=alarmActiveVariableValueType, alarmActiveEngineID=alarmActiveEngineID, alarmActiveVariableID=alarmActiveVariableID, alarmActiveStatsTable=alarmActiveStatsTable, alarmCompliances=alarmCompliances, alarmActiveStatsLastClear=alarmActiveStatsLastClear, alarmActiveIndex=alarmActiveIndex, alarmActiveEntry=alarmActiveEntry, PYSNMP_MODULE_ID=alarmMIB, alarmActiveTable=alarmActiveTable, alarmClearLogIndex=alarmClearLogIndex, alarmActiveStatsGroup=alarmActiveStatsGroup, alarmClearEngineAddressType=alarmClearEngineAddressType, alarmCompliance=alarmCompliance, alarmClearTable=alarmClearTable, alarmActiveSpecificPointer=alarmActiveSpecificPointer, alarmClearEngineAddress=alarmClearEngineAddress, alarmActiveStatsActiveCurrent=alarmActiveStatsActiveCurrent, alarmActive=alarmActive, alarmListName=alarmListName, alarmClearMaximum=alarmClearMaximum, alarmClearNotificationID=alarmClearNotificationID, alarmClear=alarmClear, alarmActiveDateAndTime=alarmActiveDateAndTime, alarmActiveVariableEntry=alarmActiveVariableEntry, alarmClearContextName=alarmClearContextName, alarmObjects=alarmObjects, alarmActiveEngineAddress=alarmActiveEngineAddress, alarmConformance=alarmConformance, alarmModelDescription=alarmModelDescription, alarmModelIndex=alarmModelIndex, alarmModelNotificationId=alarmModelNotificationId, alarmActiveVariableOctetStringVal=alarmActiveVariableOctetStringVal, alarmActiveEngineAddressType=alarmActiveEngineAddressType, alarmActiveVariableUnsigned32Val=alarmActiveVariableUnsigned32Val, alarmModelEntry=alarmModelEntry, alarmActiveVariableIndex=alarmActiveVariableIndex, alarmClearEngineID=alarmClearEngineID, alarmModelLastChanged=alarmModelLastChanged, alarmActiveVariableTable=alarmActiveVariableTable, alarmModelState=alarmModelState, alarmModelRowStatus=alarmModelRowStatus, alarmActiveGroup=alarmActiveGroup, alarmModelResourcePrefix=alarmModelResourcePrefix, alarmActiveModelPointer=alarmActiveModelPointer, alarmClearGroup=alarmClearGroup, alarmModelVarbindIndex=alarmModelVarbindIndex, alarmActiveResourceId=alarmActiveResourceId, alarmModelSpecificPointer=alarmModelSpecificPointer, alarmActiveStatsActives=alarmActiveStatsActives, alarmActiveVariableInteger32Val=alarmActiveVariableInteger32Val, alarmActiveVariableCounter32Val=alarmActiveVariableCounter32Val, alarmActiveOverflow=alarmActiveOverflow, alarmNotificationsGroup=alarmNotificationsGroup)
