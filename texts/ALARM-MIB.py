...
mib_2, IpAddress, Counter64, TimeTicks, zeroDotZero, Counter32, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, MibIdentifier, Bits, Opaque, NotificationType, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "Counter64", "TimeTicks", "zeroDotZero", "Counter32", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "Bits", "Opaque", "NotificationType", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("ALARM-MIB", alarmClearEngineID=alarmClearEngineID, alarmActiveVariableCounter32Val=alarmActiveVariableCounter32Val, alarmActiveVariableCounter64Val=alarmActiveVariableCounter64Val, alarmObjects=alarmObjects, alarmActiveVariableIndex=alarmActiveVariableIndex, LocalSnmpEngineOrZeroLenStr=LocalSnmpEngineOrZeroLenStr, alarmClearTable=alarmClearTable, alarmActiveTable=alarmActiveTable, alarmActiveState=alarmActiveState, alarmModelNotificationId=alarmModelNotificationId, alarmClearIndex=alarmClearIndex, alarmActiveIndex=alarmActiveIndex, alarmGroups=alarmGroups, alarmClearGroup=alarmClearGroup, alarmActiveContextName=alarmActiveContextName, alarmActiveStatsActiveCurrent=alarmActiveStatsActiveCurrent, alarmActiveVariableTimeTicksVal=alarmActiveVariableTimeTicksVal, alarmClearResourceId=alarmClearResourceId, alarmModelVarbindValue=alarmModelVarbindValue, alarmActiveEngineAddress=alarmActiveEngineAddress, alarmActiveGroup=alarmActiveGroup, alarmModelSpecificPointer=alarmModelSpecificPointer, alarmClearContextName=alarmClearContextName, alarmListName=alarmListName, alarmModelResourcePrefix=alarmModelResourcePrefix, alarmActiveVariableOctetStringVal=alarmActiveVariableOctetStringVal, alarmActiveVariableID=alarmActiveVariableID, alarmModelLastChanged=alarmModelLastChanged, alarmModelVarbindSubtree=alarmModelVarbindSubtree, alarmCompliance=alarmCompliance, alarmActiveVariableValueType=alarmActiveVariableValueType, alarmModelState=alarmModelState, alarmActiveNotificationID=alarmActiveNotificationID, alarmCompliances=alarmCompliances, alarmActiveLastChanged=alarmActiveLastChanged, alarmActiveStatsEntry=alarmActiveStatsEntry, alarmActiveLogPointer=alarmActiveLogPointer, alarmClearDateAndTime=alarmClearDateAndTime, alarmActiveVariableIpAddressVal=alarmActiveVariableIpAddressVal, alarmModelTable=alarmModelTable, alarmActiveOverflow=alarmActiveOverflow, alarmActiveStatsLastClear=alarmActiveStatsLastClear, alarmConformance=alarmConformance, alarmClearMaximum=alarmClearMaximum, alarmClearEngineAddress=alarmClearEngineAddress, alarmClearEngineAddressType=alarmClearEngineAddressType, alarmActiveVariableOpaqueVal=alarmActiveVariableOpaqueVal, alarmActiveEngineID=alarmActiveEngineID, alarmModelEntry=alarmModelEntry, alarmActiveModelPointer=alarmActiveModelPointer, alarmActiveVariableTable=alarmActiveVariableTable, alarmModelIndex=alarmModelIndex, ResourceId=ResourceId, alarmActiveResourceId=alarmActiveResourceId, alarmModelRowStatus=alarmModelRowStatus, PYSNMP_MODULE_ID=alarmMIB, alarmActiveSpecificPointer=alarmActiveSpecificPointer, alarmNotificationsGroup=alarmNotificationsGroup, alarmActiveVariableEntry=alarmActiveVariableEntry, alarmClearState=alarmClearState, alarmModelVarbindIndex=alarmModelVarbindIndex, alarmActiveVariables=alarmActiveVariables, alarmActiveVariableUnsigned32Val=alarmActiveVariableUnsigned32Val, alarmActive=alarmActive, alarmClearLogIndex=alarmClearLogIndex, alarmActiveDateAndTime=alarmActiveDateAndTime, alarmActiveVariableInteger32Val=alarmActiveVariableInteger32Val, alarmActiveStatsTable=alarmActiveStatsTable, alarmClear=alarmClear, alarmActiveStatsGroup=alarmActiveStatsGroup, alarmModel=alarmModel, alarmActiveDescription=alarmActiveDescription, alarmClearNotificationID=alarmClearNotificationID, alarmNotifications=alarmNotifications, alarmActiveStatsActives=alarmActiveStatsActives, alarmActiveEngineAddressType=alarmActiveEngineAddressType, alarmActiveVariableOidVal=alarmActiveVariableOidVal, alarmModelGroup=alarmModelGroup, alarmMIB=alarmMIB, alarmActiveStatsLastRaise=alarmActiveStatsLastRaise, alarmClearModelPointer=alarmClearModelPointer, alarmClearEntry=alarmClearEntry, alarmActiveEntry=alarmActiveEntry, alarmModelDescription=alarmModelDescription)
