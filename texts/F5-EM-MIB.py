...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Integer32, MibIdentifier, NotificationType, Bits, Gauge32, Counter32, ModuleIdentity, TimeTicks, Counter64, IpAddress, Opaque, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Integer32", "MibIdentifier", "NotificationType", "Bits", "Gauge32", "Counter32", "ModuleIdentity", "TimeTicks", "Counter64", "IpAddress", "Opaque", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("F5-EM-MIB", emPerformanceStorageCap=emPerformanceStorageCap, emDeviceImpaired=emDeviceImpaired, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, imageEntry=imageEntry, emAlerts=emAlerts, emAlertConfigObjects=emAlertConfigObjects, emMemoryUsage=emMemoryUsage, emImages=emImages, deviceEntry=deviceEntry, groupName=groupName, imageDescription=imageDescription, emGlobals=emGlobals, emVersion=emVersion, emDeviceClockSkew=emDeviceClockSkew, emDeviceList=emDeviceList, emHotfixInstallFailed=emHotfixInstallFailed, archiveDescription=archiveDescription, PYSNMP_MODULE_ID=enterpriseManagement, archiveTimeStamp=archiveTimeStamp, emAlert=emAlert, groupDescription=groupDescription, archiveEntry=archiveEntry, archiveFilename=archiveFilename, emDeviceStandbyMode=emDeviceStandbyMode, emRaidDriveFailureDetected=emRaidDriveFailureDetected, deviceNumber=deviceNumber, emDeviceActiveMode=emDeviceActiveMode, groupNumber=groupNumber, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emASMSigUpdateFailed=emASMSigUpdateFailed, deviceName=deviceName, deviceEntryTable=deviceEntryTable, emArchives=emArchives, emDeviceConfigSync=emDeviceConfigSync, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emSoftwareInstallComplete=emSoftwareInstallComplete, groupEntry=groupEntry, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emSchedBackupFailed=emSchedBackupFailed, emMaxConcurrentUpdates=emMaxConcurrentUpdates, archiveSourceDevice=archiveSourceDevice, emScheduledArchiveFailed=emScheduledArchiveFailed, deviceAddressType=deviceAddressType, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceAddress=deviceAddress, groupEntryTable=groupEntryTable, emASMSigInstallComplete=emASMSigInstallComplete, emSoftwareInstallFailed=emSoftwareInstallFailed, emASMSigInstallFailed=emASMSigInstallFailed, archiveProduct=archiveProduct, emRefreshInterval=emRefreshInterval, emDevices=emDevices, enterpriseManagement=enterpriseManagement, emAlertObjects=emAlertObjects, emAlertObjMsg=emAlertObjMsg, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emCertificateExpiration=emCertificateExpiration, archiveNumber=archiveNumber, emDiskUsage=emDiskUsage, emCpuUsage=emCpuUsage, emDeviceOfflineMode=emDeviceOfflineMode, emPerformanceStorageDays=emPerformanceStorageDays, archiveEntryTable=archiveEntryTable, imageVersion=imageVersion, emServiceContractExpiry=emServiceContractExpiry, archiveVersion=archiveVersion, imageEntryTable=imageEntryTable, emDeviceGroups=emDeviceGroups, imageNumber=imageNumber, emDeviceUnreachable=emDeviceUnreachable, emHaSyncFailed=emHaSyncFailed, emPerformanceThreshold=emPerformanceThreshold)
