...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Integer32, Counter64, IpAddress, ModuleIdentity, iso, NotificationType, TimeTicks, enterprises, Gauge32, Counter32, Opaque, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Integer32", "Counter64", "IpAddress", "ModuleIdentity", "iso", "NotificationType", "TimeTicks", "enterprises", "Gauge32", "Counter32", "Opaque", "MibIdentifier")
...
mibBuilder.exportSymbols("F5-EM-MIB", emAlertObjects=emAlertObjects, emAlertConfigObjects=emAlertConfigObjects, emDeviceStandbyMode=emDeviceStandbyMode, enterpriseManagement=enterpriseManagement, imageNumber=imageNumber, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceOfflineMode=emDeviceOfflineMode, emPerformanceStorageCap=emPerformanceStorageCap, deviceAddress=deviceAddress, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emAlertObjMsg=emAlertObjMsg, emDiskUsage=emDiskUsage, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emAlerts=emAlerts, archiveSourceDevice=archiveSourceDevice, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emAlert=emAlert, emDeviceClockSkew=emDeviceClockSkew, deviceAddressType=deviceAddressType, emASMSigInstallComplete=emASMSigInstallComplete, groupDescription=groupDescription, emDeviceImpaired=emDeviceImpaired, groupName=groupName, emImages=emImages, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emStatsCollectionRateCap=emStatsCollectionRateCap, deviceEntryTable=deviceEntryTable, archiveProduct=archiveProduct, imageEntryTable=imageEntryTable, archiveDescription=archiveDescription, emRefreshInterval=emRefreshInterval, emCertificateExpiration=emCertificateExpiration, emServiceContractExpiry=emServiceContractExpiry, groupEntry=groupEntry, deviceNumber=deviceNumber, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceUnreachable=emDeviceUnreachable, emHaSyncFailed=emHaSyncFailed, imageDescription=imageDescription, deviceEntry=deviceEntry, emASMSigInstallFailed=emASMSigInstallFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emGatherServiceContractFailure=emGatherServiceContractFailure, archiveFilename=archiveFilename, emPerformanceStorageDays=emPerformanceStorageDays, groupEntryTable=groupEntryTable, imageEntry=imageEntry, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceList=emDeviceList, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emSchedBackupFailed=emSchedBackupFailed, emDevices=emDevices, emSoftwareInstallFailed=emSoftwareInstallFailed, emASMSigUpdateFailed=emASMSigUpdateFailed, emArchives=emArchives, emGlobals=emGlobals, archiveEntry=archiveEntry, deviceName=deviceName, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceGroups=emDeviceGroups, groupNumber=groupNumber, emMemoryUsage=emMemoryUsage, archiveNumber=archiveNumber, archiveVersion=archiveVersion, archiveEntryTable=archiveEntryTable, archiveTimeStamp=archiveTimeStamp, emPerformanceThreshold=emPerformanceThreshold, emCpuUsage=emCpuUsage, emDeviceActiveMode=emDeviceActiveMode, emDeviceConfigSync=emDeviceConfigSync, emHotfixInstallFailed=emHotfixInstallFailed, imageVersion=imageVersion, emVersion=emVersion)
