...
Bits, iso, Integer32, ModuleIdentity, enterprises, Counter64, Counter32, Unsigned32, NotificationType, Opaque, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Integer32", "ModuleIdentity", "enterprises", "Counter64", "Counter32", "Unsigned32", "NotificationType", "Opaque", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("F5-EM-MIB", emScheduledArchiveFailed=emScheduledArchiveFailed, emRefreshInterval=emRefreshInterval, enterpriseManagement=enterpriseManagement, emAlert=emAlert, emSoftwareInstallFailed=emSoftwareInstallFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, deviceAddressType=deviceAddressType, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emAlertObjects=emAlertObjects, emDevices=emDevices, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emCertificateExpiration=emCertificateExpiration, emStatsCollectionRateCap=emStatsCollectionRateCap, emASMSigInstallComplete=emASMSigInstallComplete, deviceNumber=deviceNumber, deviceName=deviceName, archiveSourceDevice=archiveSourceDevice, emHotfixInstallFailed=emHotfixInstallFailed, emPerformanceStorageCap=emPerformanceStorageCap, imageVersion=imageVersion, emDeviceOfflineMode=emDeviceOfflineMode, imageNumber=imageNumber, imageEntry=imageEntry, imageDescription=imageDescription, archiveEntryTable=archiveEntryTable, emSoftwareInstallComplete=emSoftwareInstallComplete, emArchives=emArchives, emGlobals=emGlobals, archiveVersion=archiveVersion, archiveFilename=archiveFilename, groupEntry=groupEntry, emServiceContractExpiry=emServiceContractExpiry, emDeviceClockSkew=emDeviceClockSkew, groupDescription=groupDescription, groupNumber=groupNumber, emDeviceActiveMode=emDeviceActiveMode, emAlerts=emAlerts, emDeviceUnreachable=emDeviceUnreachable, emDiskUsage=emDiskUsage, emAlertConfigObjects=emAlertConfigObjects, emASMSigInstallFailed=emASMSigInstallFailed, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceList=emDeviceList, emImages=emImages, archiveNumber=archiveNumber, emDeviceGroups=emDeviceGroups, emHaSyncFailed=emHaSyncFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceImpaired=emDeviceImpaired, deviceAddress=deviceAddress, archiveTimeStamp=archiveTimeStamp, imageEntryTable=imageEntryTable, emMemoryUsage=emMemoryUsage, emCpuUsage=emCpuUsage, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emVersion=emVersion, archiveEntry=archiveEntry, emSchedBackupFailed=emSchedBackupFailed, emHotfixInstallComplete=emHotfixInstallComplete, groupName=groupName, archiveProduct=archiveProduct, emDeviceConfigSync=emDeviceConfigSync, emPerformanceStorageDays=emPerformanceStorageDays, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceEntryTable=deviceEntryTable, groupEntryTable=groupEntryTable, emDeviceStandbyMode=emDeviceStandbyMode, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emAlertObjMsg=emAlertObjMsg, archiveDescription=archiveDescription, PYSNMP_MODULE_ID=enterpriseManagement, deviceEntry=deviceEntry, emPerformanceThreshold=emPerformanceThreshold, emRaidDriveFailureDetected=emRaidDriveFailureDetected)
