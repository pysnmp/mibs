...
Counter64, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, enterprises, Integer32, Bits, NotificationType, Gauge32, Opaque, IpAddress, TimeTicks, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "enterprises", "Integer32", "Bits", "NotificationType", "Gauge32", "Opaque", "IpAddress", "TimeTicks", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emAlertConfigObjects=emAlertConfigObjects, emVersion=emVersion, groupName=groupName, deviceName=deviceName, emDeviceList=emDeviceList, deviceAddress=deviceAddress, emDeviceStandbyMode=emDeviceStandbyMode, archiveTimeStamp=archiveTimeStamp, emMemoryUsage=emMemoryUsage, emSchedBackupFailed=emSchedBackupFailed, emImages=emImages, emStatsCollectionRateCap=emStatsCollectionRateCap, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDiskUsage=emDiskUsage, emDeviceClockSkew=emDeviceClockSkew, emDeviceActiveMode=emDeviceActiveMode, emSoftwareInstallComplete=emSoftwareInstallComplete, emAlert=emAlert, emDevices=emDevices, emServiceContractExpiry=emServiceContractExpiry, imageEntryTable=imageEntryTable, imageDescription=imageDescription, emDeviceConfigSync=emDeviceConfigSync, emAlertObjects=emAlertObjects, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceGroups=emDeviceGroups, archiveProduct=archiveProduct, emCertificateExpiration=emCertificateExpiration, emCpuUsage=emCpuUsage, groupDescription=groupDescription, emHotfixInstallComplete=emHotfixInstallComplete, archiveEntry=archiveEntry, enterpriseManagement=enterpriseManagement, emASMSigInstallFailed=emASMSigInstallFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emRefreshInterval=emRefreshInterval, deviceNumber=deviceNumber, emASMSigUpdateFailed=emASMSigUpdateFailed, emAlertObjMsg=emAlertObjMsg, deviceAddressType=deviceAddressType, emPerformanceStorageDays=emPerformanceStorageDays, deviceEntryTable=deviceEntryTable, groupNumber=groupNumber, archiveNumber=archiveNumber, emSoftwareInstallFailed=emSoftwareInstallFailed, emPerformanceStorageCap=emPerformanceStorageCap, imageEntry=imageEntry, emHotfixInstallFailed=emHotfixInstallFailed, archiveEntryTable=archiveEntryTable, emDeviceOfflineMode=emDeviceOfflineMode, imageVersion=imageVersion, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceEntry=deviceEntry, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceImpaired=emDeviceImpaired, emHaSyncFailed=emHaSyncFailed, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, imageNumber=imageNumber, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, archiveFilename=archiveFilename, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, archiveDescription=archiveDescription, emASMSigInstallComplete=emASMSigInstallComplete, archiveSourceDevice=archiveSourceDevice, groupEntry=groupEntry, emArchives=emArchives, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emPerformanceThreshold=emPerformanceThreshold, emDeviceUnreachable=emDeviceUnreachable, groupEntryTable=groupEntryTable, emAlerts=emAlerts, emGlobals=emGlobals, archiveVersion=archiveVersion)
