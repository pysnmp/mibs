...
MibIdentifier, TimeTicks, Bits, Integer32, Opaque, Counter64, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, ModuleIdentity, Counter32, Unsigned32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Bits", "Integer32", "Opaque", "Counter64", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "ModuleIdentity", "Counter32", "Unsigned32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", imageEntryTable=imageEntryTable, groupNumber=groupNumber, emAlertConfigObjects=emAlertConfigObjects, emAlert=emAlert, archiveNumber=archiveNumber, archiveFilename=archiveFilename, emDeviceActiveMode=emDeviceActiveMode, emGatherServiceContractFailure=emGatherServiceContractFailure, imageVersion=imageVersion, emDeviceList=emDeviceList, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emHotfixInstallComplete=emHotfixInstallComplete, deviceAddressType=deviceAddressType, emArchives=emArchives, imageEntry=imageEntry, emDeviceGroups=emDeviceGroups, emStatsCollectionRateCap=emStatsCollectionRateCap, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emVersion=emVersion, imageDescription=imageDescription, archiveSourceDevice=archiveSourceDevice, deviceNumber=deviceNumber, emMemoryUsage=emMemoryUsage, deviceName=deviceName, emASMSigInstallFailed=emASMSigInstallFailed, archiveDescription=archiveDescription, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceClockSkew=emDeviceClockSkew, emSchedBackupFailed=emSchedBackupFailed, emDeviceOfflineMode=emDeviceOfflineMode, groupName=groupName, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emImages=emImages, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceUnreachable=emDeviceUnreachable, emScheduledArchiveFailed=emScheduledArchiveFailed, emPerformanceStorageDays=emPerformanceStorageDays, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emAlerts=emAlerts, deviceEntryTable=deviceEntryTable, deviceEntry=deviceEntry, emDeviceImpaired=emDeviceImpaired, archiveProduct=archiveProduct, emHaSyncFailed=emHaSyncFailed, emGlobals=emGlobals, emRaidDriveFailureDetected=emRaidDriveFailureDetected, imageNumber=imageNumber, emServiceContractExpiry=emServiceContractExpiry, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceStandbyMode=emDeviceStandbyMode, emDeviceConfigSync=emDeviceConfigSync, emCertificateExpiration=emCertificateExpiration, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emPerformanceStorageCap=emPerformanceStorageCap, archiveTimeStamp=archiveTimeStamp, emRefreshInterval=emRefreshInterval, groupEntry=groupEntry, groupDescription=groupDescription, emSoftwareInstallFailed=emSoftwareInstallFailed, archiveEntry=archiveEntry, emAlertObjects=emAlertObjects, emPerformanceThreshold=emPerformanceThreshold, archiveEntryTable=archiveEntryTable, emDevices=emDevices, archiveVersion=archiveVersion, deviceAddress=deviceAddress, groupEntryTable=groupEntryTable, emAlertObjMsg=emAlertObjMsg, emSoftwareInstallComplete=emSoftwareInstallComplete, emHotfixInstallFailed=emHotfixInstallFailed, emDiskUsage=emDiskUsage, emCpuUsage=emCpuUsage, enterpriseManagement=enterpriseManagement)
