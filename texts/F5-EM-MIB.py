...
MibIdentifier, Opaque, Counter64, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, TimeTicks, Unsigned32, IpAddress, NotificationType, iso, Integer32, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Opaque", "Counter64", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "TimeTicks", "Unsigned32", "IpAddress", "NotificationType", "iso", "Integer32", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emArchives=emArchives, emAlert=emAlert, groupEntryTable=groupEntryTable, archiveEntry=archiveEntry, emDeviceStandbyMode=emDeviceStandbyMode, archiveTimeStamp=archiveTimeStamp, imageVersion=imageVersion, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emRefreshInterval=emRefreshInterval, imageNumber=imageNumber, archiveDescription=archiveDescription, deviceAddressType=deviceAddressType, emCertificateExpiration=emCertificateExpiration, imageDescription=imageDescription, archiveProduct=archiveProduct, emASMSigUpdateFailed=emASMSigUpdateFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceActiveMode=emDeviceActiveMode, deviceNumber=deviceNumber, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, deviceName=deviceName, emServiceContractExpiry=emServiceContractExpiry, deviceAddress=deviceAddress, emHaSyncFailed=emHaSyncFailed, emAlertConfigObjects=emAlertConfigObjects, emAlertObjMsg=emAlertObjMsg, groupEntry=groupEntry, emScheduledArchiveFailed=emScheduledArchiveFailed, emPerformanceThreshold=emPerformanceThreshold, archiveEntryTable=archiveEntryTable, emCpuUsage=emCpuUsage, emDeviceImpaired=emDeviceImpaired, emDeviceGroups=emDeviceGroups, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveFilename=archiveFilename, emASMSigInstallFailed=emASMSigInstallFailed, emSoftwareInstallComplete=emSoftwareInstallComplete, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceClockSkew=emDeviceClockSkew, emDeviceList=emDeviceList, emDiskUsage=emDiskUsage, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emAlerts=emAlerts, emHotfixInstallFailed=emHotfixInstallFailed, deviceEntryTable=deviceEntryTable, emASMSigInstallComplete=emASMSigInstallComplete, emVersion=emVersion, emDevices=emDevices, imageEntry=imageEntry, emDeviceUnreachable=emDeviceUnreachable, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceConfigSync=emDeviceConfigSync, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, groupName=groupName, groupNumber=groupNumber, emHotfixInstallComplete=emHotfixInstallComplete, emGlobals=emGlobals, archiveSourceDevice=archiveSourceDevice, imageEntryTable=imageEntryTable, archiveVersion=archiveVersion, emMemoryUsage=emMemoryUsage, emPerformanceStorageDays=emPerformanceStorageDays, enterpriseManagement=enterpriseManagement, emSchedBackupFailed=emSchedBackupFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, PYSNMP_MODULE_ID=enterpriseManagement, deviceEntry=deviceEntry, groupDescription=groupDescription, emImages=emImages, emPerformanceStorageCap=emPerformanceStorageCap, archiveNumber=archiveNumber, emAlertObjects=emAlertObjects, emDeviceOfflineMode=emDeviceOfflineMode)
