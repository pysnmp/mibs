...
TimeTicks, ModuleIdentity, IpAddress, Counter64, NotificationType, iso, enterprises, Bits, MibIdentifier, Counter32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "IpAddress", "Counter64", "NotificationType", "iso", "enterprises", "Bits", "MibIdentifier", "Counter32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emServiceContractExpiry=emServiceContractExpiry, emMemoryUsage=emMemoryUsage, archiveDescription=archiveDescription, emRefreshInterval=emRefreshInterval, emAlerts=emAlerts, emHotfixInstallFailed=emHotfixInstallFailed, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emDevices=emDevices, emAlertConfigObjects=emAlertConfigObjects, imageVersion=imageVersion, archiveVersion=archiveVersion, groupName=groupName, deviceEntry=deviceEntry, emAlertObjMsg=emAlertObjMsg, emDiskUsage=emDiskUsage, emASMSigUpdateAvailable=emASMSigUpdateAvailable, deviceAddressType=deviceAddressType, emGlobals=emGlobals, groupDescription=groupDescription, archiveTimeStamp=archiveTimeStamp, imageEntryTable=imageEntryTable, emHotfixInstallComplete=emHotfixInstallComplete, emSchedBackupFailed=emSchedBackupFailed, emPerformanceThreshold=emPerformanceThreshold, enterpriseManagement=enterpriseManagement, archiveSourceDevice=archiveSourceDevice, emDeviceConfigSync=emDeviceConfigSync, emAlert=emAlert, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceStandbyMode=emDeviceStandbyMode, emVersion=emVersion, emCpuUsage=emCpuUsage, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceOfflineMode=emDeviceOfflineMode, emDeviceImpaired=emDeviceImpaired, emDeviceList=emDeviceList, emArchives=emArchives, archiveNumber=archiveNumber, emASMSigInstallComplete=emASMSigInstallComplete, groupNumber=groupNumber, deviceEntryTable=deviceEntryTable, emStatsDBConnectivityLost=emStatsDBConnectivityLost, archiveProduct=archiveProduct, groupEntryTable=groupEntryTable, emHaSyncFailed=emHaSyncFailed, deviceName=deviceName, emImages=emImages, archiveFilename=archiveFilename, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emSoftwareInstallComplete=emSoftwareInstallComplete, imageEntry=imageEntry, emMaxConcurrentUpdates=emMaxConcurrentUpdates, deviceAddress=deviceAddress, emDeviceGroups=emDeviceGroups, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, PYSNMP_MODULE_ID=enterpriseManagement, imageNumber=imageNumber, archiveEntry=archiveEntry, groupEntry=groupEntry, emAlertObjects=emAlertObjects, emStatsCollectionRateCap=emStatsCollectionRateCap, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceClockSkew=emDeviceClockSkew, emDeviceActiveMode=emDeviceActiveMode, archiveEntryTable=archiveEntryTable, emScheduledArchiveFailed=emScheduledArchiveFailed, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emASMSigUpdateFailed=emASMSigUpdateFailed, emPerformanceStorageDays=emPerformanceStorageDays, emCertificateExpiration=emCertificateExpiration, emDeviceUnreachable=emDeviceUnreachable, imageDescription=imageDescription, deviceNumber=deviceNumber)
