...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, Gauge32, Unsigned32, NotificationType, IpAddress, Opaque, Counter64, iso, MibIdentifier, Counter32, Integer32, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "Gauge32", "Unsigned32", "NotificationType", "IpAddress", "Opaque", "Counter64", "iso", "MibIdentifier", "Counter32", "Integer32", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("F5-EM-MIB", emHotfixInstallComplete=emHotfixInstallComplete, emDeviceActiveMode=emDeviceActiveMode, groupDescription=groupDescription, archiveEntry=archiveEntry, archiveSourceDevice=archiveSourceDevice, emSchedBackupFailed=emSchedBackupFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emPerformanceStorageCap=emPerformanceStorageCap, groupEntry=groupEntry, emDeviceStandbyMode=emDeviceStandbyMode, emGlobals=emGlobals, groupEntryTable=groupEntryTable, emAlertObjMsg=emAlertObjMsg, imageEntry=imageEntry, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceImpaired=emDeviceImpaired, archiveProduct=archiveProduct, emStatsCollectionRateCap=emStatsCollectionRateCap, deviceName=deviceName, emCertificateExpiration=emCertificateExpiration, emImages=emImages, archiveNumber=archiveNumber, imageVersion=imageVersion, emDeviceUnreachable=emDeviceUnreachable, deviceEntryTable=deviceEntryTable, deviceNumber=deviceNumber, deviceAddressType=deviceAddressType, archiveEntryTable=archiveEntryTable, archiveFilename=archiveFilename, emSoftwareInstallFailed=emSoftwareInstallFailed, emHotfixInstallFailed=emHotfixInstallFailed, emDiskUsage=emDiskUsage, emDevices=emDevices, groupNumber=groupNumber, emDeviceList=emDeviceList, emPerformanceThreshold=emPerformanceThreshold, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emScheduledArchiveFailed=emScheduledArchiveFailed, emVersion=emVersion, emDeviceConfigSync=emDeviceConfigSync, imageNumber=imageNumber, emASMSigInstallFailed=emASMSigInstallFailed, imageEntryTable=imageEntryTable, emRefreshInterval=emRefreshInterval, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, emAlerts=emAlerts, emHaSyncFailed=emHaSyncFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emAlert=emAlert, deviceEntry=deviceEntry, PYSNMP_MODULE_ID=enterpriseManagement, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveVersion=archiveVersion, imageDescription=imageDescription, emDeviceClockSkew=emDeviceClockSkew, emMemoryUsage=emMemoryUsage, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emASMSigUpdateFailed=emASMSigUpdateFailed, emAlertObjects=emAlertObjects, emRaidDriveFailureDetected=emRaidDriveFailureDetected, groupName=groupName, archiveTimeStamp=archiveTimeStamp, emMaxConcurrentUpdates=emMaxConcurrentUpdates, enterpriseManagement=enterpriseManagement, emDeviceGroups=emDeviceGroups, emArchives=emArchives, deviceAddress=deviceAddress, emCpuUsage=emCpuUsage, emPerformanceStorageDays=emPerformanceStorageDays, emAlertConfigObjects=emAlertConfigObjects, emServiceContractExpiry=emServiceContractExpiry, archiveDescription=archiveDescription)
