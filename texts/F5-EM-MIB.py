...
Integer32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Opaque, Bits, TimeTicks, Unsigned32, Gauge32, enterprises, IpAddress, MibIdentifier, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Opaque", "Bits", "TimeTicks", "Unsigned32", "Gauge32", "enterprises", "IpAddress", "MibIdentifier", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("F5-EM-MIB", deviceName=deviceName, emHotfixInstallFailed=emHotfixInstallFailed, emAlertObjects=emAlertObjects, emDevices=emDevices, deviceNumber=deviceNumber, emServiceContractExpiry=emServiceContractExpiry, groupDescription=groupDescription, emMemoryUsage=emMemoryUsage, imageDescription=imageDescription, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emAlertObjMsg=emAlertObjMsg, emDeviceClockSkew=emDeviceClockSkew, deviceAddressType=deviceAddressType, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emCpuUsage=emCpuUsage, emImages=emImages, archiveTimeStamp=archiveTimeStamp, emArchives=emArchives, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceImpaired=emDeviceImpaired, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceOfflineMode=emDeviceOfflineMode, deviceAddress=deviceAddress, archiveVersion=archiveVersion, emAlerts=emAlerts, archiveNumber=archiveNumber, groupEntry=groupEntry, groupNumber=groupNumber, emRefreshInterval=emRefreshInterval, emGatherServiceContractFailure=emGatherServiceContractFailure, imageEntryTable=imageEntryTable, emCertificateExpiration=emCertificateExpiration, emASMSigInstallComplete=emASMSigInstallComplete, imageEntry=imageEntry, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceConfigSync=emDeviceConfigSync, emAlert=emAlert, deviceEntry=deviceEntry, emDeviceGroups=emDeviceGroups, groupEntryTable=groupEntryTable, emDeviceStandbyMode=emDeviceStandbyMode, emAlertConfigObjects=emAlertConfigObjects, emASMSigUpdateFailed=emASMSigUpdateFailed, emSchedBackupFailed=emSchedBackupFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emStatsCollectionRateCap=emStatsCollectionRateCap, emPerformanceThreshold=emPerformanceThreshold, archiveProduct=archiveProduct, emDeviceActiveMode=emDeviceActiveMode, emGlobals=emGlobals, archiveEntry=archiveEntry, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emPerformanceStorageDays=emPerformanceStorageDays, PYSNMP_MODULE_ID=enterpriseManagement, enterpriseManagement=enterpriseManagement, imageNumber=imageNumber, emDiskUsage=emDiskUsage, archiveFilename=archiveFilename, emScheduledArchiveFailed=emScheduledArchiveFailed, archiveSourceDevice=archiveSourceDevice, emHotfixInstallComplete=emHotfixInstallComplete, archiveDescription=archiveDescription, emDeviceList=emDeviceList, emVersion=emVersion, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emHaSyncFailed=emHaSyncFailed, emASMSigInstallFailed=emASMSigInstallFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceUnreachable=emDeviceUnreachable, deviceEntryTable=deviceEntryTable, archiveEntryTable=archiveEntryTable, emPerformanceStorageCap=emPerformanceStorageCap, groupName=groupName, imageVersion=imageVersion)
