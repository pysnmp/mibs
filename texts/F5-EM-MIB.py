...
ObjectIdentity, Counter64, Integer32, Bits, Counter32, TimeTicks, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, NotificationType, Gauge32, MibIdentifier, Unsigned32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Integer32", "Bits", "Counter32", "TimeTicks", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "NotificationType", "Gauge32", "MibIdentifier", "Unsigned32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceUnreachable=emDeviceUnreachable, groupDescription=groupDescription, emImages=emImages, emSoftwareInstallFailed=emSoftwareInstallFailed, emScheduledArchiveFailed=emScheduledArchiveFailed, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emSchedBackupFailed=emSchedBackupFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDiskUsage=emDiskUsage, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceAddress=deviceAddress, emPerformanceStorageDays=emPerformanceStorageDays, archiveSourceDevice=archiveSourceDevice, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emMemoryUsage=emMemoryUsage, deviceEntryTable=deviceEntryTable, emCpuUsage=emCpuUsage, emASMSigInstallComplete=emASMSigInstallComplete, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveEntryTable=archiveEntryTable, imageDescription=imageDescription, emHotfixInstallFailed=emHotfixInstallFailed, emASMSigInstallFailed=emASMSigInstallFailed, imageEntry=imageEntry, deviceEntry=deviceEntry, emDeviceOfflineMode=emDeviceOfflineMode, emAlertConfigObjects=emAlertConfigObjects, emPerformanceThreshold=emPerformanceThreshold, emDeviceActiveMode=emDeviceActiveMode, groupNumber=groupNumber, emHaSyncFailed=emHaSyncFailed, emGlobals=emGlobals, emArchives=emArchives, emDevices=emDevices, archiveTimeStamp=archiveTimeStamp, emAlertObjMsg=emAlertObjMsg, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceClockSkew=emDeviceClockSkew, enterpriseManagement=enterpriseManagement, emDeviceList=emDeviceList, groupEntry=groupEntry, groupName=groupName, archiveFilename=archiveFilename, emHotfixInstallComplete=emHotfixInstallComplete, groupEntryTable=groupEntryTable, archiveProduct=archiveProduct, emServiceContractExpiry=emServiceContractExpiry, PYSNMP_MODULE_ID=enterpriseManagement, imageEntryTable=imageEntryTable, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emVersion=emVersion, emDeviceStandbyMode=emDeviceStandbyMode, deviceAddressType=deviceAddressType, emDeviceConfigSync=emDeviceConfigSync, emAlerts=emAlerts, deviceName=deviceName, archiveVersion=archiveVersion, emStatsCollectionRateCap=emStatsCollectionRateCap, emCertificateExpiration=emCertificateExpiration, emDeviceImpaired=emDeviceImpaired, deviceNumber=deviceNumber, emPerformanceStorageCap=emPerformanceStorageCap, archiveNumber=archiveNumber, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveDescription=archiveDescription, emAlertObjects=emAlertObjects, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emRefreshInterval=emRefreshInterval, emDeviceGroups=emDeviceGroups, imageNumber=imageNumber, archiveEntry=archiveEntry, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emAlert=emAlert, imageVersion=imageVersion, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored)
