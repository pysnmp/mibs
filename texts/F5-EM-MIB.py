...
IpAddress, Unsigned32, Gauge32, MibIdentifier, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Integer32, Bits, Counter64, NotificationType, Opaque, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Gauge32", "MibIdentifier", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Integer32", "Bits", "Counter64", "NotificationType", "Opaque", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", deviceEntryTable=deviceEntryTable, emAlertConfigObjects=emAlertConfigObjects, deviceNumber=deviceNumber, emCertificateExpiration=emCertificateExpiration, imageDescription=imageDescription, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceGroups=emDeviceGroups, imageVersion=imageVersion, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emHotfixInstallFailed=emHotfixInstallFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emArchives=emArchives, deviceAddressType=deviceAddressType, imageEntry=imageEntry, emASMSigInstallComplete=emASMSigInstallComplete, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, archiveTimeStamp=archiveTimeStamp, emGlobals=emGlobals, emASMSigInstallFailed=emASMSigInstallFailed, archiveSourceDevice=archiveSourceDevice, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceOfflineMode=emDeviceOfflineMode, emAlerts=emAlerts, emPerformanceStorageDays=emPerformanceStorageDays, archiveEntry=archiveEntry, emDeviceClockSkew=emDeviceClockSkew, emHaSyncFailed=emHaSyncFailed, archiveNumber=archiveNumber, emVersion=emVersion, emServiceContractExpiry=emServiceContractExpiry, emDeviceImpaired=emDeviceImpaired, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceName=deviceName, groupEntryTable=groupEntryTable, emMemoryUsage=emMemoryUsage, emAlertObjects=emAlertObjects, archiveDescription=archiveDescription, emDeviceStandbyMode=emDeviceStandbyMode, emSchedBackupFailed=emSchedBackupFailed, emRaidDriveFailureDetected=emRaidDriveFailureDetected, deviceAddress=deviceAddress, emStatsCollectionRateCap=emStatsCollectionRateCap, emSoftwareInstallComplete=emSoftwareInstallComplete, emDevices=emDevices, emGatherServiceContractFailure=emGatherServiceContractFailure, emDiskUsage=emDiskUsage, deviceEntry=deviceEntry, emRefreshInterval=emRefreshInterval, archiveFilename=archiveFilename, emAlert=emAlert, groupName=groupName, archiveEntryTable=archiveEntryTable, emCpuUsage=emCpuUsage, enterpriseManagement=enterpriseManagement, groupNumber=groupNumber, emPerformanceStorageCap=emPerformanceStorageCap, groupEntry=groupEntry, emDeviceList=emDeviceList, emMaxConcurrentUpdates=emMaxConcurrentUpdates, archiveVersion=archiveVersion, emAlertObjMsg=emAlertObjMsg, emDeviceUnreachable=emDeviceUnreachable, emDeviceConfigSync=emDeviceConfigSync, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, imageEntryTable=imageEntryTable, PYSNMP_MODULE_ID=enterpriseManagement, groupDescription=groupDescription, imageNumber=imageNumber, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emPerformanceThreshold=emPerformanceThreshold, emSoftwareInstallFailed=emSoftwareInstallFailed, emImages=emImages, emDeviceActiveMode=emDeviceActiveMode, archiveProduct=archiveProduct)
