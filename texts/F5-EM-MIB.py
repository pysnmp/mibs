...
enterprises, TimeTicks, ObjectIdentity, Bits, IpAddress, Counter64, ModuleIdentity, Gauge32, iso, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Opaque, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "ObjectIdentity", "Bits", "IpAddress", "Counter64", "ModuleIdentity", "Gauge32", "iso", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Opaque", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("F5-EM-MIB", emAlertObjects=emAlertObjects, emSchedBackupFailed=emSchedBackupFailed, groupEntry=groupEntry, archiveFilename=archiveFilename, emHaSyncFailed=emHaSyncFailed, emSoftwareInstallFailed=emSoftwareInstallFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, emDeviceList=emDeviceList, emGlobals=emGlobals, emAlertConfigObjects=emAlertConfigObjects, enterpriseManagement=enterpriseManagement, deviceEntry=deviceEntry, archiveTimeStamp=archiveTimeStamp, groupDescription=groupDescription, archiveProduct=archiveProduct, emCpuUsage=emCpuUsage, emDeviceImpaired=emDeviceImpaired, imageDescription=imageDescription, imageNumber=imageNumber, imageEntry=imageEntry, emAlertObjMsg=emAlertObjMsg, emDiskUsage=emDiskUsage, emHotfixInstallComplete=emHotfixInstallComplete, emASMSigUpdateFailed=emASMSigUpdateFailed, emVersion=emVersion, emPerformanceStorageCap=emPerformanceStorageCap, emStatsCollectionRateCap=emStatsCollectionRateCap, emStatsDBConnectivityLost=emStatsDBConnectivityLost, archiveEntryTable=archiveEntryTable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, deviceNumber=deviceNumber, imageVersion=imageVersion, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceStandbyMode=emDeviceStandbyMode, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emCertificateExpiration=emCertificateExpiration, deviceEntryTable=deviceEntryTable, archiveVersion=archiveVersion, emAlerts=emAlerts, archiveDescription=archiveDescription, emGatherServiceContractFailure=emGatherServiceContractFailure, emAlert=emAlert, archiveSourceDevice=archiveSourceDevice, archiveNumber=archiveNumber, emDeviceUnreachable=emDeviceUnreachable, emMemoryUsage=emMemoryUsage, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emPerformanceStorageDays=emPerformanceStorageDays, groupName=groupName, emRaidDriveFailureDetected=emRaidDriveFailureDetected, groupEntryTable=groupEntryTable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceGroups=emDeviceGroups, emSoftwareInstallComplete=emSoftwareInstallComplete, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceActiveMode=emDeviceActiveMode, emPerformanceThreshold=emPerformanceThreshold, deviceAddressType=deviceAddressType, emArchives=emArchives, emDeviceConfigSync=emDeviceConfigSync, emHotfixInstallFailed=emHotfixInstallFailed, deviceAddress=deviceAddress, deviceName=deviceName, PYSNMP_MODULE_ID=enterpriseManagement, emDevices=emDevices, imageEntryTable=imageEntryTable, emImages=emImages, archiveEntry=archiveEntry, emDeviceClockSkew=emDeviceClockSkew, emRefreshInterval=emRefreshInterval, emServiceContractExpiry=emServiceContractExpiry, emScheduledArchiveFailed=emScheduledArchiveFailed, groupNumber=groupNumber)
