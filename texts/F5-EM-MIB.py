...
IpAddress, TimeTicks, Counter32, enterprises, ModuleIdentity, iso, Bits, Counter64, Gauge32, Integer32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Opaque, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter32", "enterprises", "ModuleIdentity", "iso", "Bits", "Counter64", "Gauge32", "Integer32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Opaque", "NotificationType")
...
mibBuilder.exportSymbols("F5-EM-MIB", emPerformanceStorageCap=emPerformanceStorageCap, emCertificateExpiration=emCertificateExpiration, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, deviceNumber=deviceNumber, emPerformanceStorageDays=emPerformanceStorageDays, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDeviceList=emDeviceList, emDeviceActiveMode=emDeviceActiveMode, emRefreshInterval=emRefreshInterval, emMemoryUsage=emMemoryUsage, archiveEntryTable=archiveEntryTable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceStandbyMode=emDeviceStandbyMode, emASMSigInstallComplete=emASMSigInstallComplete, emArchives=emArchives, deviceName=deviceName, emServiceContractExpiry=emServiceContractExpiry, emDeviceClockSkew=emDeviceClockSkew, archiveSourceDevice=archiveSourceDevice, emDeviceGroups=emDeviceGroups, deviceAddressType=deviceAddressType, deviceEntryTable=deviceEntryTable, emPerformanceThreshold=emPerformanceThreshold, emStatsDBConnectivityLost=emStatsDBConnectivityLost, archiveTimeStamp=archiveTimeStamp, emImages=emImages, groupEntry=groupEntry, groupNumber=groupNumber, groupDescription=groupDescription, archiveProduct=archiveProduct, emAlerts=emAlerts, archiveNumber=archiveNumber, emAlert=emAlert, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceOfflineMode=emDeviceOfflineMode, deviceEntry=deviceEntry, emVersion=emVersion, emCpuUsage=emCpuUsage, emSoftwareInstallFailed=emSoftwareInstallFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emDeviceImpaired=emDeviceImpaired, imageVersion=imageVersion, emDevices=emDevices, emScheduledArchiveFailed=emScheduledArchiveFailed, imageNumber=imageNumber, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceConfigSync=emDeviceConfigSync, emGlobals=emGlobals, imageEntry=imageEntry, deviceAddress=deviceAddress, imageEntryTable=imageEntryTable, groupEntryTable=groupEntryTable, emSoftwareInstallComplete=emSoftwareInstallComplete, enterpriseManagement=enterpriseManagement, emSchedBackupFailed=emSchedBackupFailed, archiveVersion=archiveVersion, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDiskUsage=emDiskUsage, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emASMSigInstallFailed=emASMSigInstallFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, PYSNMP_MODULE_ID=enterpriseManagement, emAlertObjMsg=emAlertObjMsg, emDeviceUnreachable=emDeviceUnreachable, emAlertObjects=emAlertObjects, emAlertConfigObjects=emAlertConfigObjects, archiveEntry=archiveEntry, imageDescription=imageDescription, emHotfixInstallComplete=emHotfixInstallComplete, groupName=groupName, emHaSyncFailed=emHaSyncFailed, archiveDescription=archiveDescription, archiveFilename=archiveFilename)
