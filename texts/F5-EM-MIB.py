...
Opaque, MibIdentifier, enterprises, Counter32, Integer32, Counter64, ObjectIdentity, Unsigned32, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Gauge32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "MibIdentifier", "enterprises", "Counter32", "Integer32", "Counter64", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Gauge32", "iso", "Bits")
...
mibBuilder.exportSymbols("F5-EM-MIB", emSchedBackupFailed=emSchedBackupFailed, groupEntryTable=groupEntryTable, emDeviceList=emDeviceList, imageEntryTable=imageEntryTable, archiveNumber=archiveNumber, emDeviceUnreachable=emDeviceUnreachable, groupEntry=groupEntry, emAlertObjMsg=emAlertObjMsg, deviceAddressType=deviceAddressType, deviceAddress=deviceAddress, archiveTimeStamp=archiveTimeStamp, emImages=emImages, emDiskUsage=emDiskUsage, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emHotfixInstallFailed=emHotfixInstallFailed, emHaSyncFailed=emHaSyncFailed, emDeviceOfflineMode=emDeviceOfflineMode, emStatsCollectionRateCap=emStatsCollectionRateCap, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceStandbyMode=emDeviceStandbyMode, archiveSourceDevice=archiveSourceDevice, emASMSigInstallComplete=emASMSigInstallComplete, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emHotfixInstallComplete=emHotfixInstallComplete, emSoftwareInstallFailed=emSoftwareInstallFailed, emMemoryUsage=emMemoryUsage, emDevices=emDevices, emVersion=emVersion, archiveEntry=archiveEntry, archiveFilename=archiveFilename, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emAlertConfigObjects=emAlertConfigObjects, deviceName=deviceName, archiveEntryTable=archiveEntryTable, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emGatherServiceContractFailure=emGatherServiceContractFailure, groupNumber=groupNumber, emAlerts=emAlerts, emCpuUsage=emCpuUsage, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emASMSigUpdateFailed=emASMSigUpdateFailed, groupName=groupName, deviceEntryTable=deviceEntryTable, groupDescription=groupDescription, imageNumber=imageNumber, emPerformanceStorageCap=emPerformanceStorageCap, emAlertObjects=emAlertObjects, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, deviceEntry=deviceEntry, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceActiveMode=emDeviceActiveMode, emSoftwareInstallComplete=emSoftwareInstallComplete, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceGroups=emDeviceGroups, emGlobals=emGlobals, emDeviceConfigSync=emDeviceConfigSync, emDeviceClockSkew=emDeviceClockSkew, emRefreshInterval=emRefreshInterval, archiveDescription=archiveDescription, enterpriseManagement=enterpriseManagement, emAlert=emAlert, imageEntry=imageEntry, emCertificateExpiration=emCertificateExpiration, imageVersion=imageVersion, emPerformanceStorageDays=emPerformanceStorageDays, archiveVersion=archiveVersion, emDeviceImpaired=emDeviceImpaired, deviceNumber=deviceNumber, archiveProduct=archiveProduct, emPerformanceThreshold=emPerformanceThreshold, emArchives=emArchives, imageDescription=imageDescription, PYSNMP_MODULE_ID=enterpriseManagement, emServiceContractExpiry=emServiceContractExpiry)
