...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, MibIdentifier, Gauge32, Unsigned32, Opaque, ModuleIdentity, enterprises, Counter64, iso, TimeTicks, NotificationType, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "MibIdentifier", "Gauge32", "Unsigned32", "Opaque", "ModuleIdentity", "enterprises", "Counter64", "iso", "TimeTicks", "NotificationType", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", imageEntryTable=imageEntryTable, imageEntry=imageEntry, emDiskUsage=emDiskUsage, emASMSigInstallComplete=emASMSigInstallComplete, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emGatherServiceContractFailure=emGatherServiceContractFailure, archiveEntry=archiveEntry, groupNumber=groupNumber, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceImpaired=emDeviceImpaired, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, archiveDescription=archiveDescription, deviceAddressType=deviceAddressType, archiveSourceDevice=archiveSourceDevice, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emPerformanceThreshold=emPerformanceThreshold, emDeviceOfflineMode=emDeviceOfflineMode, groupName=groupName, emDeviceStandbyMode=emDeviceStandbyMode, deviceAddress=deviceAddress, emGlobals=emGlobals, emSoftwareInstallFailed=emSoftwareInstallFailed, emCpuUsage=emCpuUsage, archiveFilename=archiveFilename, emDeviceConfigSync=emDeviceConfigSync, groupDescription=groupDescription, emImages=emImages, emAlertObjects=emAlertObjects, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveProduct=archiveProduct, emSchedBackupFailed=emSchedBackupFailed, emDeviceList=emDeviceList, imageNumber=imageNumber, emServiceContractExpiry=emServiceContractExpiry, emStatsCollectionRateCap=emStatsCollectionRateCap, emAlert=emAlert, emDevices=emDevices, archiveEntryTable=archiveEntryTable, groupEntryTable=groupEntryTable, imageVersion=imageVersion, emSoftwareInstallComplete=emSoftwareInstallComplete, emMemoryUsage=emMemoryUsage, emCertificateExpiration=emCertificateExpiration, emRefreshInterval=emRefreshInterval, enterpriseManagement=enterpriseManagement, deviceEntry=deviceEntry, emAlertConfigObjects=emAlertConfigObjects, PYSNMP_MODULE_ID=enterpriseManagement, archiveTimeStamp=archiveTimeStamp, emHotfixInstallComplete=emHotfixInstallComplete, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emASMSigInstallFailed=emASMSigInstallFailed, emAlerts=emAlerts, deviceEntryTable=deviceEntryTable, imageDescription=imageDescription, deviceNumber=deviceNumber, groupEntry=groupEntry, emMaxConcurrentUpdates=emMaxConcurrentUpdates, archiveVersion=archiveVersion, emAlertObjMsg=emAlertObjMsg, emDeviceClockSkew=emDeviceClockSkew, emDeviceActiveMode=emDeviceActiveMode, emPerformanceStorageDays=emPerformanceStorageDays, emDeviceUnreachable=emDeviceUnreachable, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emArchives=emArchives, emDeviceGroups=emDeviceGroups, emPerformanceStorageCap=emPerformanceStorageCap, emHaSyncFailed=emHaSyncFailed, emScheduledArchiveFailed=emScheduledArchiveFailed, deviceName=deviceName, emVersion=emVersion, archiveNumber=archiveNumber)
