...
Opaque, TimeTicks, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, MibIdentifier, Counter32, Counter64, Bits, Integer32, iso, ObjectIdentity, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "TimeTicks", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "MibIdentifier", "Counter32", "Counter64", "Bits", "Integer32", "iso", "ObjectIdentity", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emCpuUsage=emCpuUsage, archiveProduct=archiveProduct, emRaidDriveFailureDetected=emRaidDriveFailureDetected, groupDescription=groupDescription, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emAlertConfigObjects=emAlertConfigObjects, emAlertObjects=emAlertObjects, groupName=groupName, archiveFilename=archiveFilename, emDeviceImpaired=emDeviceImpaired, emDevices=emDevices, emDeviceStandbyMode=emDeviceStandbyMode, groupEntry=groupEntry, imageEntry=imageEntry, emASMSigInstallFailed=emASMSigInstallFailed, emPerformanceThreshold=emPerformanceThreshold, emDeviceList=emDeviceList, imageNumber=imageNumber, emDeviceClockSkew=emDeviceClockSkew, imageVersion=imageVersion, archiveDescription=archiveDescription, emRefreshInterval=emRefreshInterval, enterpriseManagement=enterpriseManagement, emDeviceActiveMode=emDeviceActiveMode, deviceEntryTable=deviceEntryTable, emHotfixInstallFailed=emHotfixInstallFailed, emAlert=emAlert, archiveSourceDevice=archiveSourceDevice, deviceAddressType=deviceAddressType, emHaSyncFailed=emHaSyncFailed, deviceEntry=deviceEntry, emArchives=emArchives, emDeviceOfflineMode=emDeviceOfflineMode, archiveTimeStamp=archiveTimeStamp, emSoftwareInstallComplete=emSoftwareInstallComplete, imageDescription=imageDescription, emGatherServiceContractFailure=emGatherServiceContractFailure, emStatsCollectionRateCap=emStatsCollectionRateCap, emVersion=emVersion, emDeviceConfigSync=emDeviceConfigSync, emServiceContractExpiry=emServiceContractExpiry, emDeviceUnreachable=emDeviceUnreachable, emAlerts=emAlerts, archiveEntry=archiveEntry, emSoftwareInstallFailed=emSoftwareInstallFailed, imageEntryTable=imageEntryTable, emSchedBackupFailed=emSchedBackupFailed, emAlertObjMsg=emAlertObjMsg, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emStatsDBConnectivityLost=emStatsDBConnectivityLost, groupEntryTable=groupEntryTable, deviceNumber=deviceNumber, groupNumber=groupNumber, emGlobals=emGlobals, PYSNMP_MODULE_ID=enterpriseManagement, deviceAddress=deviceAddress, emMemoryUsage=emMemoryUsage, emCertificateExpiration=emCertificateExpiration, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emPerformanceStorageDays=emPerformanceStorageDays, emPerformanceStorageCap=emPerformanceStorageCap, archiveNumber=archiveNumber, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceGroups=emDeviceGroups, emImages=emImages, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveEntryTable=archiveEntryTable, emDiskUsage=emDiskUsage, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emScheduledArchiveFailed=emScheduledArchiveFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, deviceName=deviceName, archiveVersion=archiveVersion, emASMSigInstallComplete=emASMSigInstallComplete)
