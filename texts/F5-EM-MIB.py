...
enterprises, Counter32, IpAddress, NotificationType, Unsigned32, ModuleIdentity, Integer32, iso, ObjectIdentity, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, MibIdentifier, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "IpAddress", "NotificationType", "Unsigned32", "ModuleIdentity", "Integer32", "iso", "ObjectIdentity", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "MibIdentifier", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emAlertObjects=emAlertObjects, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceGroups=emDeviceGroups, archiveEntryTable=archiveEntryTable, emDeviceUnreachable=emDeviceUnreachable, emSoftwareInstallFailed=emSoftwareInstallFailed, archiveNumber=archiveNumber, archiveSourceDevice=archiveSourceDevice, emStatsCollectionRateCap=emStatsCollectionRateCap, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceConfigSync=emDeviceConfigSync, emVersion=emVersion, emAlertConfigObjects=emAlertConfigObjects, archiveProduct=archiveProduct, groupEntryTable=groupEntryTable, archiveEntry=archiveEntry, archiveTimeStamp=archiveTimeStamp, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emGlobals=emGlobals, imageNumber=imageNumber, emDeviceOfflineMode=emDeviceOfflineMode, enterpriseManagement=enterpriseManagement, emStatsDBConnectivityLost=emStatsDBConnectivityLost, groupDescription=groupDescription, deviceName=deviceName, emASMSigInstallComplete=emASMSigInstallComplete, emPerformanceThreshold=emPerformanceThreshold, emRefreshInterval=emRefreshInterval, emImages=emImages, deviceNumber=deviceNumber, PYSNMP_MODULE_ID=enterpriseManagement, imageEntryTable=imageEntryTable, archiveFilename=archiveFilename, emArchives=emArchives, emCpuUsage=emCpuUsage, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emPerformanceStorageDays=emPerformanceStorageDays, emCertificateExpiration=emCertificateExpiration, emASMSigUpdateFailed=emASMSigUpdateFailed, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDeviceImpaired=emDeviceImpaired, emDevices=emDevices, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emAlert=emAlert, deviceAddressType=deviceAddressType, imageVersion=imageVersion, emAlertObjMsg=emAlertObjMsg, emDeviceClockSkew=emDeviceClockSkew, emDeviceActiveMode=emDeviceActiveMode, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, deviceEntry=deviceEntry, emHotfixInstallComplete=emHotfixInstallComplete, emMemoryUsage=emMemoryUsage, emSoftwareInstallComplete=emSoftwareInstallComplete, deviceAddress=deviceAddress, imageDescription=imageDescription, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emASMSigInstallFailed=emASMSigInstallFailed, groupName=groupName, emDeviceStandbyMode=emDeviceStandbyMode, emHaSyncFailed=emHaSyncFailed, emServiceContractExpiry=emServiceContractExpiry, deviceEntryTable=deviceEntryTable, groupNumber=groupNumber, archiveVersion=archiveVersion, imageEntry=imageEntry, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDiskUsage=emDiskUsage, emSchedBackupFailed=emSchedBackupFailed, groupEntry=groupEntry, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceList=emDeviceList, archiveDescription=archiveDescription, emAlerts=emAlerts, emHotfixInstallFailed=emHotfixInstallFailed)
