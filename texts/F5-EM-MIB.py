...
TimeTicks, ObjectIdentity, Counter64, Integer32, Gauge32, Unsigned32, Counter32, NotificationType, Bits, iso, MibIdentifier, ModuleIdentity, IpAddress, Opaque, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Counter64", "Integer32", "Gauge32", "Unsigned32", "Counter32", "NotificationType", "Bits", "iso", "MibIdentifier", "ModuleIdentity", "IpAddress", "Opaque", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceClockSkew=emDeviceClockSkew, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emGlobals=emGlobals, emASMSigUpdateFailed=emASMSigUpdateFailed, emRefreshInterval=emRefreshInterval, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceConfigSync=emDeviceConfigSync, emPerformanceStorageDays=emPerformanceStorageDays, emPerformanceThreshold=emPerformanceThreshold, emStatsDBConnectivityLost=emStatsDBConnectivityLost, archiveDescription=archiveDescription, emScheduledArchiveFailed=emScheduledArchiveFailed, emCpuUsage=emCpuUsage, emAlert=emAlert, imageVersion=imageVersion, emVersion=emVersion, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, deviceAddressType=deviceAddressType, deviceName=deviceName, imageDescription=imageDescription, groupNumber=groupNumber, emHotfixInstallComplete=emHotfixInstallComplete, emServiceContractExpiry=emServiceContractExpiry, archiveFilename=archiveFilename, groupDescription=groupDescription, emAlerts=emAlerts, deviceEntry=deviceEntry, emDiskUsage=emDiskUsage, groupEntry=groupEntry, archiveSourceDevice=archiveSourceDevice, archiveNumber=archiveNumber, deviceEntryTable=deviceEntryTable, deviceNumber=deviceNumber, emDeviceGroups=emDeviceGroups, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceActiveMode=emDeviceActiveMode, emDeviceOfflineMode=emDeviceOfflineMode, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, groupName=groupName, emAlertObjects=emAlertObjects, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emASMSigInstallComplete=emASMSigInstallComplete, archiveEntry=archiveEntry, emHaSyncFailed=emHaSyncFailed, emMemoryUsage=emMemoryUsage, archiveProduct=archiveProduct, emStatsCollectionRateCap=emStatsCollectionRateCap, emPerformanceStorageCap=emPerformanceStorageCap, imageEntry=imageEntry, emArchives=emArchives, enterpriseManagement=enterpriseManagement, emDevices=emDevices, deviceAddress=deviceAddress, PYSNMP_MODULE_ID=enterpriseManagement, emAlertConfigObjects=emAlertConfigObjects, emAlertObjMsg=emAlertObjMsg, emSchedBackupFailed=emSchedBackupFailed, emDeviceImpaired=emDeviceImpaired, emHotfixInstallFailed=emHotfixInstallFailed, emImages=emImages, emDeviceUnreachable=emDeviceUnreachable, archiveEntryTable=archiveEntryTable, emSoftwareInstallComplete=emSoftwareInstallComplete, emCertificateExpiration=emCertificateExpiration, archiveVersion=archiveVersion, imageEntryTable=imageEntryTable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceList=emDeviceList, archiveTimeStamp=archiveTimeStamp, emDeviceStandbyMode=emDeviceStandbyMode, imageNumber=imageNumber, groupEntryTable=groupEntryTable)
