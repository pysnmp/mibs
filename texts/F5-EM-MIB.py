...
NotificationType, Opaque, ModuleIdentity, Counter32, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, iso, ObjectIdentity, enterprises, IpAddress, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Opaque", "ModuleIdentity", "Counter32", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "iso", "ObjectIdentity", "enterprises", "IpAddress", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emImages=emImages, deviceAddressType=deviceAddressType, emCertificateExpiration=emCertificateExpiration, emDevices=emDevices, emASMSigInstallComplete=emASMSigInstallComplete, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceActiveMode=emDeviceActiveMode, emPerformanceStorageDays=emPerformanceStorageDays, emPerformanceStorageCap=emPerformanceStorageCap, emAlertConfigObjects=emAlertConfigObjects, archiveEntry=archiveEntry, emDeviceImpaired=emDeviceImpaired, emSoftwareInstallComplete=emSoftwareInstallComplete, emHotfixInstallComplete=emHotfixInstallComplete, deviceEntry=deviceEntry, archiveProduct=archiveProduct, emRefreshInterval=emRefreshInterval, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emServiceContractExpiry=emServiceContractExpiry, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceThreshold=emPerformanceThreshold, archiveEntryTable=archiveEntryTable, emDeviceOfflineMode=emDeviceOfflineMode, groupName=groupName, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceUnreachable=emDeviceUnreachable, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveFilename=archiveFilename, emAlertObjMsg=emAlertObjMsg, deviceNumber=deviceNumber, emHaSyncFailed=emHaSyncFailed, emAlerts=emAlerts, emStatsDBConnectivityLost=emStatsDBConnectivityLost, imageEntryTable=imageEntryTable, emMemoryUsage=emMemoryUsage, groupEntry=groupEntry, archiveNumber=archiveNumber, emDiskUsage=emDiskUsage, deviceEntryTable=deviceEntryTable, emAlert=emAlert, groupEntryTable=groupEntryTable, emDeviceStandbyMode=emDeviceStandbyMode, archiveDescription=archiveDescription, emDeviceConfigSync=emDeviceConfigSync, emSchedBackupFailed=emSchedBackupFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, archiveVersion=archiveVersion, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceName=deviceName, enterpriseManagement=enterpriseManagement, emHotfixInstallFailed=emHotfixInstallFailed, emGlobals=emGlobals, deviceAddress=deviceAddress, emArchives=emArchives, emDeviceClockSkew=emDeviceClockSkew, imageNumber=imageNumber, emASMSigInstallFailed=emASMSigInstallFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, imageVersion=imageVersion, emSoftwareInstallFailed=emSoftwareInstallFailed, emVersion=emVersion, emScheduledArchiveFailed=emScheduledArchiveFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emGatherServiceContractFailure=emGatherServiceContractFailure, archiveTimeStamp=archiveTimeStamp, archiveSourceDevice=archiveSourceDevice, imageDescription=imageDescription, emCpuUsage=emCpuUsage, emDeviceList=emDeviceList, groupDescription=groupDescription, groupNumber=groupNumber, imageEntry=imageEntry, emAlertObjects=emAlertObjects, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceGroups=emDeviceGroups)
