...
TimeTicks, NotificationType, IpAddress, Integer32, Opaque, enterprises, Counter64, Bits, Unsigned32, Counter32, ObjectIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "IpAddress", "Integer32", "Opaque", "enterprises", "Counter64", "Bits", "Unsigned32", "Counter32", "ObjectIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceUnreachable=emDeviceUnreachable, archiveTimeStamp=archiveTimeStamp, archiveEntryTable=archiveEntryTable, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceGroups=emDeviceGroups, emHotfixInstallFailed=emHotfixInstallFailed, emPerformanceStorageCap=emPerformanceStorageCap, emAlertObjects=emAlertObjects, emDeviceConfigSync=emDeviceConfigSync, emASMSigInstallComplete=emASMSigInstallComplete, emPerformanceThreshold=emPerformanceThreshold, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceImpaired=emDeviceImpaired, emMemoryUsage=emMemoryUsage, emSchedBackupFailed=emSchedBackupFailed, emASMSigInstallFailed=emASMSigInstallFailed, emServiceContractExpiry=emServiceContractExpiry, groupEntry=groupEntry, emSoftwareInstallFailed=emSoftwareInstallFailed, archiveSourceDevice=archiveSourceDevice, emDeviceList=emDeviceList, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, archiveProduct=archiveProduct, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceAddress=deviceAddress, emRefreshInterval=emRefreshInterval, imageEntryTable=imageEntryTable, emAlerts=emAlerts, imageNumber=imageNumber, groupEntryTable=groupEntryTable, PYSNMP_MODULE_ID=enterpriseManagement, groupName=groupName, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emArchives=emArchives, emGlobals=emGlobals, emDeviceOfflineMode=emDeviceOfflineMode, emDevices=emDevices, imageEntry=imageEntry, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emImages=emImages, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveEntry=archiveEntry, deviceEntry=deviceEntry, emAlert=emAlert, emStatsCollectionRateCap=emStatsCollectionRateCap, deviceNumber=deviceNumber, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveNumber=archiveNumber, emSoftwareInstallComplete=emSoftwareInstallComplete, emAlertObjMsg=emAlertObjMsg, enterpriseManagement=enterpriseManagement, imageVersion=imageVersion, groupNumber=groupNumber, imageDescription=imageDescription, emDeviceStandbyMode=emDeviceStandbyMode, deviceAddressType=deviceAddressType, emDiskUsage=emDiskUsage, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emVersion=emVersion, emDeviceClockSkew=emDeviceClockSkew, archiveFilename=archiveFilename, emScheduledArchiveFailed=emScheduledArchiveFailed, emHaSyncFailed=emHaSyncFailed, archiveDescription=archiveDescription, deviceName=deviceName, emDeviceActiveMode=emDeviceActiveMode, emRaidDriveFailureDetected=emRaidDriveFailureDetected, archiveVersion=archiveVersion, emCpuUsage=emCpuUsage, emCertificateExpiration=emCertificateExpiration, emPerformanceStorageDays=emPerformanceStorageDays, emAlertConfigObjects=emAlertConfigObjects, groupDescription=groupDescription, deviceEntryTable=deviceEntryTable)
