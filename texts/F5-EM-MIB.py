...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Integer32, NotificationType, Counter64, ObjectIdentity, iso, IpAddress, MibIdentifier, TimeTicks, Opaque, Unsigned32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Integer32", "NotificationType", "Counter64", "ObjectIdentity", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "Opaque", "Unsigned32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emImages=emImages, emVersion=emVersion, emDeviceOfflineMode=emDeviceOfflineMode, emHotfixInstallFailed=emHotfixInstallFailed, emSchedBackupFailed=emSchedBackupFailed, emAlertConfigObjects=emAlertConfigObjects, imageNumber=imageNumber, emSoftwareInstallFailed=emSoftwareInstallFailed, imageDescription=imageDescription, enterpriseManagement=enterpriseManagement, archiveFilename=archiveFilename, emAlert=emAlert, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceStandbyMode=emDeviceStandbyMode, emCertificateExpiration=emCertificateExpiration, emScheduledArchiveFailed=emScheduledArchiveFailed, emDiskUsage=emDiskUsage, emSoftwareInstallComplete=emSoftwareInstallComplete, emGlobals=emGlobals, emArchives=emArchives, emDeviceConfigSync=emDeviceConfigSync, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emRaidDriveFailureDetected=emRaidDriveFailureDetected, groupName=groupName, archiveNumber=archiveNumber, deviceName=deviceName, deviceAddressType=deviceAddressType, emASMSigInstallComplete=emASMSigInstallComplete, deviceEntryTable=deviceEntryTable, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, groupDescription=groupDescription, emHaSyncFailed=emHaSyncFailed, emDeviceImpaired=emDeviceImpaired, deviceEntry=deviceEntry, groupNumber=groupNumber, emMaxConcurrentUpdates=emMaxConcurrentUpdates, deviceNumber=deviceNumber, emDeviceList=emDeviceList, emDevices=emDevices, imageVersion=imageVersion, archiveEntryTable=archiveEntryTable, emASMSigInstallFailed=emASMSigInstallFailed, emCpuUsage=emCpuUsage, emPerformanceStorageDays=emPerformanceStorageDays, emServiceContractExpiry=emServiceContractExpiry, archiveDescription=archiveDescription, archiveProduct=archiveProduct, emDeviceUnreachable=emDeviceUnreachable, archiveTimeStamp=archiveTimeStamp, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, groupEntryTable=groupEntryTable, groupEntry=groupEntry, imageEntryTable=imageEntryTable, archiveEntry=archiveEntry, archiveSourceDevice=archiveSourceDevice, emAlerts=emAlerts, emDeviceClockSkew=emDeviceClockSkew, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emAlertObjMsg=emAlertObjMsg, emAlertObjects=emAlertObjects, archiveVersion=archiveVersion, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emRefreshInterval=emRefreshInterval, emMemoryUsage=emMemoryUsage, emDeviceActiveMode=emDeviceActiveMode, emASMSigUpdateFailed=emASMSigUpdateFailed, deviceAddress=deviceAddress, PYSNMP_MODULE_ID=enterpriseManagement, emPerformanceThreshold=emPerformanceThreshold, imageEntry=imageEntry, emDeviceGroups=emDeviceGroups, emStatsCollectionRateCap=emStatsCollectionRateCap, emPerformanceStorageCap=emPerformanceStorageCap, emHotfixInstallComplete=emHotfixInstallComplete)
