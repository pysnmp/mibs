...
enterprises, Counter32, Counter64, Integer32, ObjectIdentity, Gauge32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, MibIdentifier, Bits, Unsigned32, Opaque, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Counter64", "Integer32", "ObjectIdentity", "Gauge32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "Opaque", "NotificationType")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveVersion=archiveVersion, emDevices=emDevices, PYSNMP_MODULE_ID=enterpriseManagement, emAlertObjects=emAlertObjects, emHaSyncFailed=emHaSyncFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDiskUsage=emDiskUsage, emMemoryUsage=emMemoryUsage, emCertificateExpiration=emCertificateExpiration, emPerformanceThreshold=emPerformanceThreshold, emSchedBackupFailed=emSchedBackupFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceImpaired=emDeviceImpaired, archiveEntry=archiveEntry, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceOfflineMode=emDeviceOfflineMode, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDeviceGroups=emDeviceGroups, deviceAddress=deviceAddress, emMaxConcurrentUpdates=emMaxConcurrentUpdates, imageNumber=imageNumber, groupDescription=groupDescription, archiveProduct=archiveProduct, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emRefreshInterval=emRefreshInterval, imageEntry=imageEntry, emImages=emImages, imageEntryTable=imageEntryTable, emScheduledArchiveFailed=emScheduledArchiveFailed, emAlert=emAlert, emSoftwareInstallComplete=emSoftwareInstallComplete, emGatherServiceContractFailure=emGatherServiceContractFailure, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emASMSigInstallFailed=emASMSigInstallFailed, groupNumber=groupNumber, emDeviceActiveMode=emDeviceActiveMode, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveTimeStamp=archiveTimeStamp, emServiceContractExpiry=emServiceContractExpiry, emDeviceClockSkew=emDeviceClockSkew, emArchives=emArchives, groupName=groupName, archiveFilename=archiveFilename, emAlerts=emAlerts, deviceAddressType=deviceAddressType, imageDescription=imageDescription, emASMSigInstallComplete=emASMSigInstallComplete, emPerformanceStorageDays=emPerformanceStorageDays, emHotfixInstallFailed=emHotfixInstallFailed, emAlertConfigObjects=emAlertConfigObjects, emGlobals=emGlobals, enterpriseManagement=enterpriseManagement, emDeviceUnreachable=emDeviceUnreachable, groupEntryTable=groupEntryTable, emHotfixInstallComplete=emHotfixInstallComplete, deviceEntryTable=deviceEntryTable, archiveNumber=archiveNumber, deviceName=deviceName, emCpuUsage=emCpuUsage, archiveSourceDevice=archiveSourceDevice, emAlertObjMsg=emAlertObjMsg, imageVersion=imageVersion, archiveDescription=archiveDescription, emDeviceConfigSync=emDeviceConfigSync, deviceEntry=deviceEntry, archiveEntryTable=archiveEntryTable, deviceNumber=deviceNumber, emDeviceList=emDeviceList, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceStandbyMode=emDeviceStandbyMode, groupEntry=groupEntry, emVersion=emVersion)
