...
IpAddress, Unsigned32, MibIdentifier, iso, TimeTicks, ModuleIdentity, Opaque, NotificationType, Integer32, Counter64, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "MibIdentifier", "iso", "TimeTicks", "ModuleIdentity", "Opaque", "NotificationType", "Integer32", "Counter64", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emSoftwareInstallFailed=emSoftwareInstallFailed, archiveFilename=archiveFilename, emDevices=emDevices, groupNumber=groupNumber, groupEntry=groupEntry, emImages=emImages, archiveSourceDevice=archiveSourceDevice, archiveProduct=archiveProduct, emVersion=emVersion, emCpuUsage=emCpuUsage, emDeviceConfigSync=emDeviceConfigSync, emHotfixInstallComplete=emHotfixInstallComplete, emASMSigUpdateFailed=emASMSigUpdateFailed, groupEntryTable=groupEntryTable, emSoftwareInstallComplete=emSoftwareInstallComplete, emServiceContractExpiry=emServiceContractExpiry, deviceAddressType=deviceAddressType, groupDescription=groupDescription, deviceName=deviceName, archiveEntry=archiveEntry, emHotfixInstallFailed=emHotfixInstallFailed, imageVersion=imageVersion, emDeviceGroups=emDeviceGroups, archiveVersion=archiveVersion, emMemoryUsage=emMemoryUsage, deviceAddress=deviceAddress, groupName=groupName, archiveNumber=archiveNumber, emDeviceActiveMode=emDeviceActiveMode, emASMSigInstallComplete=emASMSigInstallComplete, emDiskUsage=emDiskUsage, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, imageEntry=imageEntry, emDeviceStandbyMode=emDeviceStandbyMode, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceUnreachable=emDeviceUnreachable, emAlerts=emAlerts, archiveEntryTable=archiveEntryTable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, deviceNumber=deviceNumber, imageEntryTable=imageEntryTable, emASMSigUpdateAvailable=emASMSigUpdateAvailable, imageNumber=imageNumber, emStatsCollectionRateCap=emStatsCollectionRateCap, imageDescription=imageDescription, emScheduledArchiveFailed=emScheduledArchiveFailed, emArchives=emArchives, emDeviceOfflineMode=emDeviceOfflineMode, emCertificateExpiration=emCertificateExpiration, archiveDescription=archiveDescription, emSchedBackupFailed=emSchedBackupFailed, emGlobals=emGlobals, emAlertObjects=emAlertObjects, emHaSyncFailed=emHaSyncFailed, emPerformanceStorageDays=emPerformanceStorageDays, emDeviceImpaired=emDeviceImpaired, deviceEntryTable=deviceEntryTable, PYSNMP_MODULE_ID=enterpriseManagement, emAlertConfigObjects=emAlertConfigObjects, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emAlertObjMsg=emAlertObjMsg, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, archiveTimeStamp=archiveTimeStamp, enterpriseManagement=enterpriseManagement, emDeviceClockSkew=emDeviceClockSkew, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceStorageCap=emPerformanceStorageCap, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emAlert=emAlert, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceList=emDeviceList, emRefreshInterval=emRefreshInterval, emPerformanceThreshold=emPerformanceThreshold, deviceEntry=deviceEntry)
