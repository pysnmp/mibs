...
Gauge32, NotificationType, Unsigned32, Counter32, ModuleIdentity, Integer32, Bits, TimeTicks, IpAddress, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Opaque, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Unsigned32", "Counter32", "ModuleIdentity", "Integer32", "Bits", "TimeTicks", "IpAddress", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Opaque", "Counter64")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveSourceDevice=archiveSourceDevice, emSoftwareInstallFailed=emSoftwareInstallFailed, groupNumber=groupNumber, emDeviceStandbyMode=emDeviceStandbyMode, emServiceContractExpiry=emServiceContractExpiry, deviceEntry=deviceEntry, deviceName=deviceName, emRefreshInterval=emRefreshInterval, deviceAddress=deviceAddress, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, groupDescription=groupDescription, emDiskUsage=emDiskUsage, imageDescription=imageDescription, emMemoryUsage=emMemoryUsage, emHaSyncFailed=emHaSyncFailed, emAlertConfigObjects=emAlertConfigObjects, emDevices=emDevices, imageNumber=imageNumber, groupEntry=groupEntry, emDeviceList=emDeviceList, groupName=groupName, emStatsCollectionRateCap=emStatsCollectionRateCap, archiveDescription=archiveDescription, emSchedBackupFailed=emSchedBackupFailed, emASMSigInstallComplete=emASMSigInstallComplete, emAlert=emAlert, emDeviceImpaired=emDeviceImpaired, emScheduledArchiveFailed=emScheduledArchiveFailed, emGlobals=emGlobals, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceEntryTable=deviceEntryTable, imageEntryTable=imageEntryTable, PYSNMP_MODULE_ID=enterpriseManagement, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emPerformanceThreshold=emPerformanceThreshold, enterpriseManagement=enterpriseManagement, emHotfixInstallComplete=emHotfixInstallComplete, archiveEntry=archiveEntry, imageEntry=imageEntry, emImages=emImages, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emAlertObjects=emAlertObjects, emAlertObjMsg=emAlertObjMsg, emVersion=emVersion, emDeviceGroups=emDeviceGroups, archiveProduct=archiveProduct, emCertificateExpiration=emCertificateExpiration, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceNumber=deviceNumber, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDeviceActiveMode=emDeviceActiveMode, emAlerts=emAlerts, archiveTimeStamp=archiveTimeStamp, archiveVersion=archiveVersion, emCpuUsage=emCpuUsage, emPerformanceStorageDays=emPerformanceStorageDays, archiveEntryTable=archiveEntryTable, imageVersion=imageVersion, emPerformanceStorageCap=emPerformanceStorageCap, archiveNumber=archiveNumber, deviceAddressType=deviceAddressType, groupEntryTable=groupEntryTable, emDeviceUnreachable=emDeviceUnreachable, emArchives=emArchives, emHotfixInstallFailed=emHotfixInstallFailed, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceConfigSync=emDeviceConfigSync, archiveFilename=archiveFilename, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceClockSkew=emDeviceClockSkew)
