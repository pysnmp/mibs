...
ObjectIdentity, ModuleIdentity, Integer32, enterprises, Bits, Counter64, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, TimeTicks, Unsigned32, iso, MibIdentifier, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Integer32", "enterprises", "Bits", "Counter64", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "TimeTicks", "Unsigned32", "iso", "MibIdentifier", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("F5-EM-MIB", emAlerts=emAlerts, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceClockSkew=emDeviceClockSkew, emPerformanceThreshold=emPerformanceThreshold, emStatsCollectionRateCap=emStatsCollectionRateCap, PYSNMP_MODULE_ID=enterpriseManagement, archiveNumber=archiveNumber, emDeviceConfigSync=emDeviceConfigSync, emPerformanceStorageCap=emPerformanceStorageCap, emSchedBackupFailed=emSchedBackupFailed, enterpriseManagement=enterpriseManagement, emDiskUsage=emDiskUsage, emSoftwareInstallComplete=emSoftwareInstallComplete, deviceEntryTable=deviceEntryTable, emCpuUsage=emCpuUsage, emPerformanceStorageDays=emPerformanceStorageDays, emAlert=emAlert, emImages=emImages, deviceNumber=deviceNumber, emDeviceStandbyMode=emDeviceStandbyMode, groupEntry=groupEntry, deviceAddressType=deviceAddressType, archiveSourceDevice=archiveSourceDevice, deviceEntry=deviceEntry, groupEntryTable=groupEntryTable, archiveFilename=archiveFilename, imageNumber=imageNumber, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emCertificateExpiration=emCertificateExpiration, emRaidDriveFailureDetected=emRaidDriveFailureDetected, imageEntryTable=imageEntryTable, deviceName=deviceName, imageEntry=imageEntry, archiveDescription=archiveDescription, emDeviceList=emDeviceList, emAlertObjects=emAlertObjects, emSoftwareInstallFailed=emSoftwareInstallFailed, emHotfixInstallComplete=emHotfixInstallComplete, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceActiveMode=emDeviceActiveMode, imageVersion=imageVersion, emGatherServiceContractFailure=emGatherServiceContractFailure, emAlertObjMsg=emAlertObjMsg, emASMSigUpdateFailed=emASMSigUpdateFailed, groupDescription=groupDescription, emArchives=emArchives, groupName=groupName, archiveEntry=archiveEntry, archiveTimeStamp=archiveTimeStamp, emASMSigInstallFailed=emASMSigInstallFailed, emMemoryUsage=emMemoryUsage, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emAlertConfigObjects=emAlertConfigObjects, emServiceContractExpiry=emServiceContractExpiry, deviceAddress=deviceAddress, imageDescription=imageDescription, archiveVersion=archiveVersion, archiveEntryTable=archiveEntryTable, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceUnreachable=emDeviceUnreachable, emStatsDBConnectivityLost=emStatsDBConnectivityLost, archiveProduct=archiveProduct, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emRefreshInterval=emRefreshInterval, emDeviceGroups=emDeviceGroups, emVersion=emVersion, emDevices=emDevices, groupNumber=groupNumber, emHaSyncFailed=emHaSyncFailed, emDeviceImpaired=emDeviceImpaired, emGlobals=emGlobals)
