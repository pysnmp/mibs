...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Gauge32, Counter32, ObjectIdentity, IpAddress, Integer32, Opaque, enterprises, MibIdentifier, Counter64, Bits, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Gauge32", "Counter32", "ObjectIdentity", "IpAddress", "Integer32", "Opaque", "enterprises", "MibIdentifier", "Counter64", "Bits", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emSoftwareInstallFailed=emSoftwareInstallFailed, emCpuUsage=emCpuUsage, deviceEntryTable=deviceEntryTable, emDevices=emDevices, archiveDescription=archiveDescription, imageEntry=imageEntry, enterpriseManagement=enterpriseManagement, imageNumber=imageNumber, imageDescription=imageDescription, deviceNumber=deviceNumber, emDeviceUnreachable=emDeviceUnreachable, emMemoryUsage=emMemoryUsage, emPerformanceStorageDays=emPerformanceStorageDays, groupDescription=groupDescription, archiveNumber=archiveNumber, emArchives=emArchives, archiveEntryTable=archiveEntryTable, emImages=emImages, emDeviceOfflineMode=emDeviceOfflineMode, emAlertConfigObjects=emAlertConfigObjects, emDeviceClockSkew=emDeviceClockSkew, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emAlert=emAlert, emAlerts=emAlerts, archiveSourceDevice=archiveSourceDevice, emDeviceGroups=emDeviceGroups, archiveTimeStamp=archiveTimeStamp, emGlobals=emGlobals, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDiskUsage=emDiskUsage, emHotfixInstallComplete=emHotfixInstallComplete, emHotfixInstallFailed=emHotfixInstallFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, PYSNMP_MODULE_ID=enterpriseManagement, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emStatsCollectionRateCap=emStatsCollectionRateCap, deviceName=deviceName, groupNumber=groupNumber, emASMSigInstallComplete=emASMSigInstallComplete, imageEntryTable=imageEntryTable, archiveEntry=archiveEntry, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceConfigSync=emDeviceConfigSync, emDeviceList=emDeviceList, emDeviceImpaired=emDeviceImpaired, deviceAddress=deviceAddress, emAlertObjects=emAlertObjects, emASMSigUpdateFailed=emASMSigUpdateFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, archiveProduct=archiveProduct, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emServiceContractExpiry=emServiceContractExpiry, emAlertObjMsg=emAlertObjMsg, deviceEntry=deviceEntry, archiveFilename=archiveFilename, emASMSigInstallFailed=emASMSigInstallFailed, emPerformanceThreshold=emPerformanceThreshold, imageVersion=imageVersion, emRefreshInterval=emRefreshInterval, emDeviceActiveMode=emDeviceActiveMode, deviceAddressType=deviceAddressType, groupName=groupName, archiveVersion=archiveVersion, emScheduledArchiveFailed=emScheduledArchiveFailed, emVersion=emVersion, groupEntryTable=groupEntryTable, emSchedBackupFailed=emSchedBackupFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emHaSyncFailed=emHaSyncFailed, emCertificateExpiration=emCertificateExpiration, emDeviceStandbyMode=emDeviceStandbyMode, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emPerformanceStorageCap=emPerformanceStorageCap, groupEntry=groupEntry)
