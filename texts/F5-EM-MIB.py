...
MibIdentifier, iso, Integer32, ModuleIdentity, Counter64, ObjectIdentity, TimeTicks, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, NotificationType, IpAddress, enterprises, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Integer32", "ModuleIdentity", "Counter64", "ObjectIdentity", "TimeTicks", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "NotificationType", "IpAddress", "enterprises", "Opaque")
...
mibBuilder.exportSymbols("F5-EM-MIB", imageEntry=imageEntry, groupNumber=groupNumber, archiveEntry=archiveEntry, groupDescription=groupDescription, emASMSigUpdateFailed=emASMSigUpdateFailed, emServiceContractExpiry=emServiceContractExpiry, deviceAddress=deviceAddress, emDevices=emDevices, imageEntryTable=imageEntryTable, emSchedBackupFailed=emSchedBackupFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emAlerts=emAlerts, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emScheduledArchiveFailed=emScheduledArchiveFailed, emGlobals=emGlobals, imageDescription=imageDescription, imageNumber=imageNumber, emSoftwareInstallComplete=emSoftwareInstallComplete, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceThreshold=emPerformanceThreshold, imageVersion=imageVersion, emMemoryUsage=emMemoryUsage, emDeviceActiveMode=emDeviceActiveMode, archiveEntryTable=archiveEntryTable, groupName=groupName, archiveVersion=archiveVersion, emDeviceOfflineMode=emDeviceOfflineMode, emVersion=emVersion, emCertificateExpiration=emCertificateExpiration, emASMSigInstallComplete=emASMSigInstallComplete, emASMSigInstallFailed=emASMSigInstallFailed, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emPerformanceStorageCap=emPerformanceStorageCap, deviceEntryTable=deviceEntryTable, emDiskUsage=emDiskUsage, emGatherServiceContractFailure=emGatherServiceContractFailure, emImages=emImages, enterpriseManagement=enterpriseManagement, deviceName=deviceName, archiveSourceDevice=archiveSourceDevice, emDeviceClockSkew=emDeviceClockSkew, groupEntryTable=groupEntryTable, deviceNumber=deviceNumber, groupEntry=groupEntry, PYSNMP_MODULE_ID=enterpriseManagement, emAlertObjMsg=emAlertObjMsg, emDeviceGroups=emDeviceGroups, emAlertConfigObjects=emAlertConfigObjects, emCpuUsage=emCpuUsage, emSoftwareInstallFailed=emSoftwareInstallFailed, archiveFilename=archiveFilename, emDeviceUnreachable=emDeviceUnreachable, emAlertObjects=emAlertObjects, deviceAddressType=deviceAddressType, emDeviceConfigSync=emDeviceConfigSync, emHaSyncFailed=emHaSyncFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceStandbyMode=emDeviceStandbyMode, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceList=emDeviceList, emAlert=emAlert, deviceEntry=deviceEntry, emArchives=emArchives, archiveTimeStamp=archiveTimeStamp, archiveDescription=archiveDescription, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, archiveProduct=archiveProduct, emDeviceImpaired=emDeviceImpaired, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveNumber=archiveNumber, emPerformanceStorageDays=emPerformanceStorageDays, emStatsCollectionRateCap=emStatsCollectionRateCap, emRefreshInterval=emRefreshInterval)
