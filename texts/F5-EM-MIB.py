...
enterprises, NotificationType, Counter32, Integer32, ModuleIdentity, iso, IpAddress, Opaque, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Counter64, Gauge32, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter32", "Integer32", "ModuleIdentity", "iso", "IpAddress", "Opaque", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Counter64", "Gauge32", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("F5-EM-MIB", emGatherServiceContractFailure=emGatherServiceContractFailure, enterpriseManagement=enterpriseManagement, emAlertObjects=emAlertObjects, imageEntry=imageEntry, emScheduledArchiveFailed=emScheduledArchiveFailed, imageEntryTable=imageEntryTable, groupNumber=groupNumber, emSchedBackupFailed=emSchedBackupFailed, archiveProduct=archiveProduct, imageNumber=imageNumber, emDeviceImpaired=emDeviceImpaired, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveVersion=archiveVersion, deviceName=deviceName, emDeviceConfigSync=emDeviceConfigSync, archiveSourceDevice=archiveSourceDevice, emASMSigUpdateFailed=emASMSigUpdateFailed, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, imageDescription=imageDescription, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emRaidDriveFailureDetected=emRaidDriveFailureDetected, groupDescription=groupDescription, emDeviceUnreachable=emDeviceUnreachable, emStatsCollectionRateCap=emStatsCollectionRateCap, emASMSigInstallFailed=emASMSigInstallFailed, emDevices=emDevices, archiveNumber=archiveNumber, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emPerformanceStorageDays=emPerformanceStorageDays, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, deviceEntry=deviceEntry, archiveEntry=archiveEntry, emMemoryUsage=emMemoryUsage, emDeviceGroups=emDeviceGroups, groupName=groupName, emAlertObjMsg=emAlertObjMsg, deviceAddressType=deviceAddressType, imageVersion=imageVersion, emDeviceClockSkew=emDeviceClockSkew, PYSNMP_MODULE_ID=enterpriseManagement, emArchives=emArchives, deviceNumber=deviceNumber, groupEntry=groupEntry, archiveFilename=archiveFilename, emDiskUsage=emDiskUsage, emHaSyncFailed=emHaSyncFailed, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emDeviceStandbyMode=emDeviceStandbyMode, emVersion=emVersion, emSoftwareInstallFailed=emSoftwareInstallFailed, emAlertConfigObjects=emAlertConfigObjects, emHotfixInstallFailed=emHotfixInstallFailed, emPerformanceThreshold=emPerformanceThreshold, archiveEntryTable=archiveEntryTable, emHotfixInstallComplete=emHotfixInstallComplete, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emRefreshInterval=emRefreshInterval, emDeviceList=emDeviceList, emCpuUsage=emCpuUsage, emAlert=emAlert, emAlerts=emAlerts, groupEntryTable=groupEntryTable, emGlobals=emGlobals, emCertificateExpiration=emCertificateExpiration, deviceAddress=deviceAddress, emServiceContractExpiry=emServiceContractExpiry, emImages=emImages, archiveTimeStamp=archiveTimeStamp, emPerformanceStorageCap=emPerformanceStorageCap, archiveDescription=archiveDescription, emSoftwareInstallComplete=emSoftwareInstallComplete, deviceEntryTable=deviceEntryTable, emDeviceActiveMode=emDeviceActiveMode)
