...
ModuleIdentity, Gauge32, TimeTicks, Opaque, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, NotificationType, ObjectIdentity, MibIdentifier, Counter64, enterprises, Bits, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "TimeTicks", "Opaque", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter64", "enterprises", "Bits", "Integer32", "iso")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveEntry=archiveEntry, emAlertConfigObjects=emAlertConfigObjects, emPerformanceStorageDays=emPerformanceStorageDays, emMemoryUsage=emMemoryUsage, archiveProduct=archiveProduct, emDeviceUnreachable=emDeviceUnreachable, emHotfixInstallComplete=emHotfixInstallComplete, emCpuUsage=emCpuUsage, deviceNumber=deviceNumber, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emSchedBackupFailed=emSchedBackupFailed, emDeviceImpaired=emDeviceImpaired, archiveVersion=archiveVersion, emCertificateExpiration=emCertificateExpiration, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emAlertObjects=emAlertObjects, emStatsCollectionRateCap=emStatsCollectionRateCap, deviceEntry=deviceEntry, emScheduledArchiveFailed=emScheduledArchiveFailed, emGlobals=emGlobals, deviceAddressType=deviceAddressType, archiveSourceDevice=archiveSourceDevice, emDeviceStandbyMode=emDeviceStandbyMode, emHaSyncFailed=emHaSyncFailed, emASMSigInstallFailed=emASMSigInstallFailed, emRefreshInterval=emRefreshInterval, imageEntry=imageEntry, emSoftwareInstallFailed=emSoftwareInstallFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, emImages=emImages, emServiceContractExpiry=emServiceContractExpiry, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emAlert=emAlert, emArchives=emArchives, emSoftwareInstallComplete=emSoftwareInstallComplete, emRaidDriveFailureDetected=emRaidDriveFailureDetected, imageEntryTable=imageEntryTable, emDeviceConfigSync=emDeviceConfigSync, emDeviceActiveMode=emDeviceActiveMode, groupName=groupName, archiveFilename=archiveFilename, emDeviceClockSkew=emDeviceClockSkew, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveNumber=archiveNumber, imageNumber=imageNumber, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, archiveEntryTable=archiveEntryTable, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, PYSNMP_MODULE_ID=enterpriseManagement, imageDescription=imageDescription, emAlerts=emAlerts, archiveDescription=archiveDescription, emAlertObjMsg=emAlertObjMsg, enterpriseManagement=enterpriseManagement, groupNumber=groupNumber, groupDescription=groupDescription, emDevices=emDevices, emDeviceGroups=emDeviceGroups, groupEntryTable=groupEntryTable, deviceAddress=deviceAddress, imageVersion=imageVersion, groupEntry=groupEntry, emPerformanceStorageCap=emPerformanceStorageCap, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, archiveTimeStamp=archiveTimeStamp, emHotfixInstallFailed=emHotfixInstallFailed, emPerformanceThreshold=emPerformanceThreshold, emDiskUsage=emDiskUsage, deviceName=deviceName, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceList=emDeviceList, emVersion=emVersion, deviceEntryTable=deviceEntryTable)
