...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Bits, iso, Gauge32, Counter64, ModuleIdentity, ObjectIdentity, Counter32, Unsigned32, TimeTicks, Opaque, IpAddress, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Bits", "iso", "Gauge32", "Counter64", "ModuleIdentity", "ObjectIdentity", "Counter32", "Unsigned32", "TimeTicks", "Opaque", "IpAddress", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("F5-EM-MIB", deviceEntry=deviceEntry, emDeviceClockSkew=emDeviceClockSkew, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceOfflineMode=emDeviceOfflineMode, emStatsDBConnectivityLost=emStatsDBConnectivityLost, archiveEntryTable=archiveEntryTable, emPerformanceStorageDays=emPerformanceStorageDays, deviceEntryTable=deviceEntryTable, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceStandbyMode=emDeviceStandbyMode, emScheduledArchiveFailed=emScheduledArchiveFailed, deviceAddressType=deviceAddressType, emSchedBackupFailed=emSchedBackupFailed, emHaSyncFailed=emHaSyncFailed, archiveDescription=archiveDescription, emAlertObjects=emAlertObjects, emImages=emImages, emAlertObjMsg=emAlertObjMsg, emDeviceImpaired=emDeviceImpaired, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveSourceDevice=archiveSourceDevice, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceUnreachable=emDeviceUnreachable, emArchives=emArchives, emPerformanceStorageCap=emPerformanceStorageCap, emASMSigInstallFailed=emASMSigInstallFailed, PYSNMP_MODULE_ID=enterpriseManagement, deviceName=deviceName, emDeviceGroups=emDeviceGroups, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, imageVersion=imageVersion, imageDescription=imageDescription, emASMSigInstallComplete=emASMSigInstallComplete, emRefreshInterval=emRefreshInterval, emSoftwareInstallFailed=emSoftwareInstallFailed, emAlertConfigObjects=emAlertConfigObjects, emDeviceList=emDeviceList, emMemoryUsage=emMemoryUsage, archiveVersion=archiveVersion, groupName=groupName, archiveEntry=archiveEntry, emServiceContractExpiry=emServiceContractExpiry, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emVersion=emVersion, emASMSigUpdateAvailable=emASMSigUpdateAvailable, groupEntryTable=groupEntryTable, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceConfigSync=emDeviceConfigSync, emMaxConcurrentUpdates=emMaxConcurrentUpdates, groupNumber=groupNumber, archiveProduct=archiveProduct, emGlobals=emGlobals, emDeviceActiveMode=emDeviceActiveMode, archiveNumber=archiveNumber, emPerformanceThreshold=emPerformanceThreshold, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emAlert=emAlert, groupEntry=groupEntry, deviceAddress=deviceAddress, imageEntryTable=imageEntryTable, imageEntry=imageEntry, archiveTimeStamp=archiveTimeStamp, enterpriseManagement=enterpriseManagement, deviceNumber=deviceNumber, emDevices=emDevices, groupDescription=groupDescription, imageNumber=imageNumber, archiveFilename=archiveFilename, emCertificateExpiration=emCertificateExpiration, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDiskUsage=emDiskUsage, emAlerts=emAlerts, emCpuUsage=emCpuUsage)
