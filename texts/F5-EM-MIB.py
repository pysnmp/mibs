...
Gauge32, Counter64, Bits, ObjectIdentity, NotificationType, Unsigned32, Opaque, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, ModuleIdentity, enterprises, MibIdentifier, iso, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Bits", "ObjectIdentity", "NotificationType", "Unsigned32", "Opaque", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "ModuleIdentity", "enterprises", "MibIdentifier", "iso", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("F5-EM-MIB", deviceName=deviceName, groupNumber=groupNumber, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emSchedBackupFailed=emSchedBackupFailed, emAlertConfigObjects=emAlertConfigObjects, emImages=emImages, emHotfixInstallComplete=emHotfixInstallComplete, imageVersion=imageVersion, emDevices=emDevices, deviceAddressType=deviceAddressType, imageEntryTable=imageEntryTable, archiveEntry=archiveEntry, archiveTimeStamp=archiveTimeStamp, emStatsCollectionRateCap=emStatsCollectionRateCap, emServiceContractExpiry=emServiceContractExpiry, emVersion=emVersion, groupEntryTable=groupEntryTable, emDeviceImpaired=emDeviceImpaired, emRefreshInterval=emRefreshInterval, archiveNumber=archiveNumber, emAlertObjMsg=emAlertObjMsg, emHaSyncFailed=emHaSyncFailed, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceList=emDeviceList, emDeviceUnreachable=emDeviceUnreachable, emGlobals=emGlobals, emArchives=emArchives, groupName=groupName, imageDescription=imageDescription, emDeviceActiveMode=emDeviceActiveMode, emGatherServiceContractFailure=emGatherServiceContractFailure, archiveSourceDevice=archiveSourceDevice, archiveProduct=archiveProduct, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emAlert=emAlert, groupDescription=groupDescription, emDeviceOfflineMode=emDeviceOfflineMode, PYSNMP_MODULE_ID=enterpriseManagement, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceClockSkew=emDeviceClockSkew, emDeviceStandbyMode=emDeviceStandbyMode, groupEntry=groupEntry, archiveDescription=archiveDescription, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, enterpriseManagement=enterpriseManagement, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emSoftwareInstallComplete=emSoftwareInstallComplete, emMemoryUsage=emMemoryUsage, deviceEntryTable=deviceEntryTable, deviceEntry=deviceEntry, emDeviceConfigSync=emDeviceConfigSync, deviceAddress=deviceAddress, emSoftwareInstallFailed=emSoftwareInstallFailed, emASMSigInstallFailed=emASMSigInstallFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, imageNumber=imageNumber, archiveEntryTable=archiveEntryTable, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emPerformanceStorageDays=emPerformanceStorageDays, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emAlertObjects=emAlertObjects, deviceNumber=deviceNumber, emDeviceGroups=emDeviceGroups, imageEntry=imageEntry, emCertificateExpiration=emCertificateExpiration, archiveFilename=archiveFilename, archiveVersion=archiveVersion, emHotfixInstallFailed=emHotfixInstallFailed, emCpuUsage=emCpuUsage, emPerformanceThreshold=emPerformanceThreshold, emAlerts=emAlerts, emDiskUsage=emDiskUsage, emASMSigInstallComplete=emASMSigInstallComplete)
