...
IpAddress, Integer32, ModuleIdentity, Unsigned32, Counter64, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Opaque, MibIdentifier, TimeTicks, ObjectIdentity, NotificationType, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "ModuleIdentity", "Unsigned32", "Counter64", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Opaque", "MibIdentifier", "TimeTicks", "ObjectIdentity", "NotificationType", "Bits", "enterprises")
...
mibBuilder.exportSymbols("F5-EM-MIB", emAlert=emAlert, archiveEntry=archiveEntry, emDevices=emDevices, emScheduledArchiveFailed=emScheduledArchiveFailed, emAlerts=emAlerts, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveFilename=archiveFilename, deviceEntryTable=deviceEntryTable, emASMSigInstallComplete=emASMSigInstallComplete, emArchives=emArchives, emVersion=emVersion, emSoftwareInstallComplete=emSoftwareInstallComplete, emCpuUsage=emCpuUsage, emCertificateExpiration=emCertificateExpiration, archiveProduct=archiveProduct, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceConfigSync=emDeviceConfigSync, groupNumber=groupNumber, emStatsCollectionRateCap=emStatsCollectionRateCap, groupEntry=groupEntry, emPerformanceStorageDays=emPerformanceStorageDays, emAlertObjMsg=emAlertObjMsg, emDiskUsage=emDiskUsage, archiveDescription=archiveDescription, emRefreshInterval=emRefreshInterval, emDeviceStandbyMode=emDeviceStandbyMode, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceOfflineMode=emDeviceOfflineMode, deviceName=deviceName, emDeviceUnreachable=emDeviceUnreachable, emHotfixInstallComplete=emHotfixInstallComplete, imageEntry=imageEntry, PYSNMP_MODULE_ID=enterpriseManagement, groupDescription=groupDescription, emDeviceClockSkew=emDeviceClockSkew, emASMSigUpdateFailed=emASMSigUpdateFailed, deviceEntry=deviceEntry, imageNumber=imageNumber, emServiceContractExpiry=emServiceContractExpiry, emGatherServiceContractFailure=emGatherServiceContractFailure, emAlertConfigObjects=emAlertConfigObjects, emAlertObjects=emAlertObjects, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceActiveMode=emDeviceActiveMode, emPerformanceThreshold=emPerformanceThreshold, archiveTimeStamp=archiveTimeStamp, enterpriseManagement=enterpriseManagement, deviceAddressType=deviceAddressType, imageDescription=imageDescription, emSchedBackupFailed=emSchedBackupFailed, deviceNumber=deviceNumber, imageVersion=imageVersion, groupEntryTable=groupEntryTable, emDeviceList=emDeviceList, archiveVersion=archiveVersion, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, archiveNumber=archiveNumber, emSoftwareInstallFailed=emSoftwareInstallFailed, emMemoryUsage=emMemoryUsage, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceAddress=deviceAddress, emPerformanceStorageCap=emPerformanceStorageCap, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceGroups=emDeviceGroups, archiveSourceDevice=archiveSourceDevice, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emHaSyncFailed=emHaSyncFailed, archiveEntryTable=archiveEntryTable, emDeviceImpaired=emDeviceImpaired, groupName=groupName, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emImages=emImages, emGlobals=emGlobals, imageEntryTable=imageEntryTable)
