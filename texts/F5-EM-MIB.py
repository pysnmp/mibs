...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Opaque, Counter64, IpAddress, iso, ObjectIdentity, Counter32, MibIdentifier, Bits, Gauge32, TimeTicks, enterprises, NotificationType, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Opaque", "Counter64", "IpAddress", "iso", "ObjectIdentity", "Counter32", "MibIdentifier", "Bits", "Gauge32", "TimeTicks", "enterprises", "NotificationType", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveEntryTable=archiveEntryTable, emCpuUsage=emCpuUsage, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emVersion=emVersion, emDevices=emDevices, emCertificateExpiration=emCertificateExpiration, emDeviceImpaired=emDeviceImpaired, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, PYSNMP_MODULE_ID=enterpriseManagement, deviceName=deviceName, emASMSigInstallComplete=emASMSigInstallComplete, deviceNumber=deviceNumber, archiveDescription=archiveDescription, groupEntry=groupEntry, emDeviceConfigSync=emDeviceConfigSync, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceList=emDeviceList, emHotfixInstallComplete=emHotfixInstallComplete, emHotfixInstallFailed=emHotfixInstallFailed, emSchedBackupFailed=emSchedBackupFailed, imageEntryTable=imageEntryTable, archiveVersion=archiveVersion, imageVersion=imageVersion, archiveFilename=archiveFilename, emGatherServiceContractFailure=emGatherServiceContractFailure, groupEntryTable=groupEntryTable, emSoftwareInstallFailed=emSoftwareInstallFailed, emRefreshInterval=emRefreshInterval, emDeviceActiveMode=emDeviceActiveMode, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, deviceAddress=deviceAddress, emServiceContractExpiry=emServiceContractExpiry, emGlobals=emGlobals, deviceAddressType=deviceAddressType, emASMSigInstallFailed=emASMSigInstallFailed, emHaSyncFailed=emHaSyncFailed, imageEntry=imageEntry, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveSourceDevice=archiveSourceDevice, deviceEntryTable=deviceEntryTable, enterpriseManagement=enterpriseManagement, groupName=groupName, groupNumber=groupNumber, emDeviceUnreachable=emDeviceUnreachable, emAlerts=emAlerts, groupDescription=groupDescription, emAlertConfigObjects=emAlertConfigObjects, emAlertObjects=emAlertObjects, emArchives=emArchives, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, emMaxConcurrentUpdates=emMaxConcurrentUpdates, archiveNumber=archiveNumber, archiveTimeStamp=archiveTimeStamp, emDeviceStandbyMode=emDeviceStandbyMode, emPerformanceStorageDays=emPerformanceStorageDays, emAlertObjMsg=emAlertObjMsg, imageNumber=imageNumber, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emImages=emImages, emDiskUsage=emDiskUsage, emAlert=emAlert, emPerformanceThreshold=emPerformanceThreshold, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceGroups=emDeviceGroups, emStatsDBConnectivityLost=emStatsDBConnectivityLost, deviceEntry=deviceEntry, archiveProduct=archiveProduct, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emMemoryUsage=emMemoryUsage, archiveEntry=archiveEntry, emDeviceClockSkew=emDeviceClockSkew, emScheduledArchiveFailed=emScheduledArchiveFailed, imageDescription=imageDescription)
