...
Bits, Gauge32, NotificationType, TimeTicks, Opaque, Counter64, enterprises, MibIdentifier, Unsigned32, ModuleIdentity, Counter32, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "NotificationType", "TimeTicks", "Opaque", "Counter64", "enterprises", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter32", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveProduct=archiveProduct, emCertificateExpiration=emCertificateExpiration, emASMSigUpdateFailed=emASMSigUpdateFailed, emServiceContractExpiry=emServiceContractExpiry, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceName=deviceName, deviceAddressType=deviceAddressType, imageVersion=imageVersion, PYSNMP_MODULE_ID=enterpriseManagement, emPerformanceThreshold=emPerformanceThreshold, emHotfixInstallComplete=emHotfixInstallComplete, emAlerts=emAlerts, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, imageEntry=imageEntry, imageNumber=imageNumber, groupName=groupName, imageDescription=imageDescription, archiveNumber=archiveNumber, archiveSourceDevice=archiveSourceDevice, emDeviceUnreachable=emDeviceUnreachable, emScheduledArchiveFailed=emScheduledArchiveFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, groupEntryTable=groupEntryTable, groupDescription=groupDescription, emDeviceConfigSync=emDeviceConfigSync, emHaSyncFailed=emHaSyncFailed, emDevices=emDevices, emImages=emImages, archiveTimeStamp=archiveTimeStamp, emRefreshInterval=emRefreshInterval, emDeviceActiveMode=emDeviceActiveMode, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emAlertConfigObjects=emAlertConfigObjects, emAlertObjMsg=emAlertObjMsg, archiveFilename=archiveFilename, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emPerformanceStorageCap=emPerformanceStorageCap, emGatherServiceContractFailure=emGatherServiceContractFailure, emASMSigInstallFailed=emASMSigInstallFailed, emAlertObjects=emAlertObjects, groupNumber=groupNumber, deviceEntryTable=deviceEntryTable, emPerformanceStorageDays=emPerformanceStorageDays, emAlert=emAlert, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceClockSkew=emDeviceClockSkew, emDeviceList=emDeviceList, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, archiveDescription=archiveDescription, emDeviceGroups=emDeviceGroups, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceStandbyMode=emDeviceStandbyMode, deviceEntry=deviceEntry, imageEntryTable=imageEntryTable, archiveEntryTable=archiveEntryTable, groupEntry=groupEntry, emDiskUsage=emDiskUsage, emMemoryUsage=emMemoryUsage, enterpriseManagement=enterpriseManagement, archiveVersion=archiveVersion, emVersion=emVersion, emCpuUsage=emCpuUsage, deviceNumber=deviceNumber, deviceAddress=deviceAddress, emArchives=emArchives, emGlobals=emGlobals, archiveEntry=archiveEntry, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emSchedBackupFailed=emSchedBackupFailed, emDeviceOfflineMode=emDeviceOfflineMode, emSoftwareInstallFailed=emSoftwareInstallFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceImpaired=emDeviceImpaired)
