...
ObjectIdentity, Unsigned32, TimeTicks, MibIdentifier, Bits, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, IpAddress, ModuleIdentity, Gauge32, Opaque, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "TimeTicks", "MibIdentifier", "Bits", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "IpAddress", "ModuleIdentity", "Gauge32", "Opaque", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("F5-EM-MIB", groupEntryTable=groupEntryTable, emDeviceClockSkew=emDeviceClockSkew, emDevices=emDevices, imageVersion=imageVersion, archiveEntryTable=archiveEntryTable, emImages=emImages, emASMSigUpdateFailed=emASMSigUpdateFailed, groupName=groupName, emAlerts=emAlerts, emSoftwareInstallComplete=emSoftwareInstallComplete, deviceEntry=deviceEntry, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emServiceContractExpiry=emServiceContractExpiry, emASMSigUpdateAvailable=emASMSigUpdateAvailable, deviceEntryTable=deviceEntryTable, archiveSourceDevice=archiveSourceDevice, emStatsDBConnectivityLost=emStatsDBConnectivityLost, imageEntry=imageEntry, emPerformanceStorageCap=emPerformanceStorageCap, imageEntryTable=imageEntryTable, emDeviceList=emDeviceList, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emScheduledArchiveFailed=emScheduledArchiveFailed, emSchedBackupFailed=emSchedBackupFailed, emAlert=emAlert, emHotfixInstallFailed=emHotfixInstallFailed, emDiskUsage=emDiskUsage, groupDescription=groupDescription, archiveNumber=archiveNumber, deviceAddressType=deviceAddressType, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceImpaired=emDeviceImpaired, emSoftwareInstallFailed=emSoftwareInstallFailed, emCertificateExpiration=emCertificateExpiration, groupNumber=groupNumber, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emAlertObjMsg=emAlertObjMsg, emGlobals=emGlobals, emDeviceGroups=emDeviceGroups, emDeviceUnreachable=emDeviceUnreachable, emMemoryUsage=emMemoryUsage, enterpriseManagement=enterpriseManagement, emArchives=emArchives, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveDescription=archiveDescription, emDeviceConfigSync=emDeviceConfigSync, emDeviceStandbyMode=emDeviceStandbyMode, emAlertObjects=emAlertObjects, deviceAddress=deviceAddress, emPerformanceThreshold=emPerformanceThreshold, emGatherServiceContractFailure=emGatherServiceContractFailure, groupEntry=groupEntry, archiveProduct=archiveProduct, archiveVersion=archiveVersion, archiveEntry=archiveEntry, emVersion=emVersion, emDeviceActiveMode=emDeviceActiveMode, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, imageDescription=imageDescription, emHaSyncFailed=emHaSyncFailed, emCpuUsage=emCpuUsage, PYSNMP_MODULE_ID=enterpriseManagement, emASMSigInstallComplete=emASMSigInstallComplete, archiveFilename=archiveFilename, emAlertConfigObjects=emAlertConfigObjects, deviceName=deviceName, emRefreshInterval=emRefreshInterval, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceOfflineMode=emDeviceOfflineMode, emHotfixInstallComplete=emHotfixInstallComplete, deviceNumber=deviceNumber, imageNumber=imageNumber, emPerformanceStorageDays=emPerformanceStorageDays, archiveTimeStamp=archiveTimeStamp)
