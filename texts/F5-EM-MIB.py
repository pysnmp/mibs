...
enterprises, IpAddress, Opaque, ModuleIdentity, Gauge32, MibIdentifier, Integer32, iso, Counter32, ObjectIdentity, NotificationType, Counter64, TimeTicks, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Opaque", "ModuleIdentity", "Gauge32", "MibIdentifier", "Integer32", "iso", "Counter32", "ObjectIdentity", "NotificationType", "Counter64", "TimeTicks", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("F5-EM-MIB", deviceAddressType=deviceAddressType, emCertificateExpiration=emCertificateExpiration, groupName=groupName, archiveNumber=archiveNumber, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emArchives=emArchives, emScheduledArchiveFailed=emScheduledArchiveFailed, emAlerts=emAlerts, archiveVersion=archiveVersion, emAlertObjects=emAlertObjects, deviceEntryTable=deviceEntryTable, emDeviceStandbyMode=emDeviceStandbyMode, emServiceContractExpiry=emServiceContractExpiry, emMemoryUsage=emMemoryUsage, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emSoftwareInstallFailed=emSoftwareInstallFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emImages=emImages, groupDescription=groupDescription, imageEntryTable=imageEntryTable, imageDescription=imageDescription, archiveTimeStamp=archiveTimeStamp, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceActiveMode=emDeviceActiveMode, archiveFilename=archiveFilename, emHaSyncFailed=emHaSyncFailed, emDeviceUnreachable=emDeviceUnreachable, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceClockSkew=emDeviceClockSkew, emASMSigInstallFailed=emASMSigInstallFailed, emPerformanceStorageCap=emPerformanceStorageCap, emAlertConfigObjects=emAlertConfigObjects, emDiskUsage=emDiskUsage, emStatsCollectionRateCap=emStatsCollectionRateCap, enterpriseManagement=enterpriseManagement, emDevices=emDevices, deviceName=deviceName, emDeviceOfflineMode=emDeviceOfflineMode, archiveDescription=archiveDescription, emSchedBackupFailed=emSchedBackupFailed, emPerformanceThreshold=emPerformanceThreshold, archiveEntry=archiveEntry, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emCpuUsage=emCpuUsage, emASMSigUpdateFailed=emASMSigUpdateFailed, emAlertObjMsg=emAlertObjMsg, deviceNumber=deviceNumber, emDeviceList=emDeviceList, groupEntryTable=groupEntryTable, groupEntry=groupEntry, archiveProduct=archiveProduct, emMaxConcurrentUpdates=emMaxConcurrentUpdates, deviceEntry=deviceEntry, imageNumber=imageNumber, archiveEntryTable=archiveEntryTable, groupNumber=groupNumber, emRefreshInterval=emRefreshInterval, emDeviceImpaired=emDeviceImpaired, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, imageEntry=imageEntry, emHotfixInstallFailed=emHotfixInstallFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, emAlert=emAlert, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceConfigSync=emDeviceConfigSync, emDeviceGroups=emDeviceGroups, emGlobals=emGlobals, imageVersion=imageVersion, emRaidDriveFailureDetected=emRaidDriveFailureDetected, archiveSourceDevice=archiveSourceDevice, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emHotfixInstallComplete=emHotfixInstallComplete, emVersion=emVersion, deviceAddress=deviceAddress, emPerformanceStorageDays=emPerformanceStorageDays)
