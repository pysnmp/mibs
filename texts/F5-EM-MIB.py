...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Integer32, TimeTicks, ObjectIdentity, Counter64, Opaque, ModuleIdentity, Bits, Counter32, IpAddress, iso, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Integer32", "TimeTicks", "ObjectIdentity", "Counter64", "Opaque", "ModuleIdentity", "Bits", "Counter32", "IpAddress", "iso", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceClockSkew=emDeviceClockSkew, emStatsDBConnectivityLost=emStatsDBConnectivityLost, groupName=groupName, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDeviceList=emDeviceList, archiveEntry=archiveEntry, emASMSigInstallFailed=emASMSigInstallFailed, archiveProduct=archiveProduct, emScheduledArchiveFailed=emScheduledArchiveFailed, emPerformanceStorageDays=emPerformanceStorageDays, emArchives=emArchives, emDeviceImpaired=emDeviceImpaired, emAlertConfigObjects=emAlertConfigObjects, deviceNumber=deviceNumber, groupEntryTable=groupEntryTable, archiveTimeStamp=archiveTimeStamp, imageVersion=imageVersion, emAlerts=emAlerts, emGlobals=emGlobals, imageEntryTable=imageEntryTable, emHotfixInstallFailed=emHotfixInstallFailed, deviceEntry=deviceEntry, emDeviceGroups=emDeviceGroups, emASMSigInstallComplete=emASMSigInstallComplete, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, deviceName=deviceName, emMemoryUsage=emMemoryUsage, emGatherServiceContractFailure=emGatherServiceContractFailure, emCpuUsage=emCpuUsage, emVersion=emVersion, emSoftwareInstallFailed=emSoftwareInstallFailed, emDiskUsage=emDiskUsage, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceActiveMode=emDeviceActiveMode, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emPerformanceStorageCap=emPerformanceStorageCap, emDevices=emDevices, emAlertObjects=emAlertObjects, archiveSourceDevice=archiveSourceDevice, emAlert=emAlert, emHotfixInstallComplete=emHotfixInstallComplete, emServiceContractExpiry=emServiceContractExpiry, PYSNMP_MODULE_ID=enterpriseManagement, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveNumber=archiveNumber, emDeviceStandbyMode=emDeviceStandbyMode, emSchedBackupFailed=emSchedBackupFailed, emDeviceUnreachable=emDeviceUnreachable, groupDescription=groupDescription, emDeviceConfigSync=emDeviceConfigSync, emPerformanceThreshold=emPerformanceThreshold, emRefreshInterval=emRefreshInterval, emHaSyncFailed=emHaSyncFailed, deviceEntryTable=deviceEntryTable, imageEntry=imageEntry, imageDescription=imageDescription, emImages=emImages, enterpriseManagement=enterpriseManagement, groupEntry=groupEntry, deviceAddressType=deviceAddressType, imageNumber=imageNumber, emAlertObjMsg=emAlertObjMsg, archiveFilename=archiveFilename, emCertificateExpiration=emCertificateExpiration, emDeviceOfflineMode=emDeviceOfflineMode, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceAddress=deviceAddress, groupNumber=groupNumber, archiveEntryTable=archiveEntryTable, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emRaidDriveFailureDetected=emRaidDriveFailureDetected, archiveDescription=archiveDescription, emStatsCollectionRateCap=emStatsCollectionRateCap, archiveVersion=archiveVersion)
