...
IpAddress, ObjectIdentity, ModuleIdentity, Counter64, iso, Opaque, Bits, TimeTicks, Integer32, Unsigned32, NotificationType, Gauge32, Counter32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Counter64", "iso", "Opaque", "Bits", "TimeTicks", "Integer32", "Unsigned32", "NotificationType", "Gauge32", "Counter32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("F5-EM-MIB", deviceAddressType=deviceAddressType, emASMSigInstallFailed=emASMSigInstallFailed, emSoftwareInstallComplete=emSoftwareInstallComplete, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emVersion=emVersion, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, groupEntry=groupEntry, emAlertConfigObjects=emAlertConfigObjects, emMaxConcurrentUpdates=emMaxConcurrentUpdates, deviceEntry=deviceEntry, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveFilename=archiveFilename, emPerformanceThreshold=emPerformanceThreshold, deviceName=deviceName, imageEntry=imageEntry, emCpuUsage=emCpuUsage, deviceEntryTable=deviceEntryTable, emAlertObjects=emAlertObjects, emAlert=emAlert, emDiskUsage=emDiskUsage, archiveProduct=archiveProduct, deviceNumber=deviceNumber, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveNumber=archiveNumber, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emStatsCollectionRateCap=emStatsCollectionRateCap, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceImpaired=emDeviceImpaired, emGlobals=emGlobals, emHotfixInstallFailed=emHotfixInstallFailed, enterpriseManagement=enterpriseManagement, groupName=groupName, emDeviceClockSkew=emDeviceClockSkew, emHaSyncFailed=emHaSyncFailed, emDeviceOfflineMode=emDeviceOfflineMode, PYSNMP_MODULE_ID=enterpriseManagement, emAlerts=emAlerts, emPerformanceStorageCap=emPerformanceStorageCap, emImages=emImages, groupNumber=groupNumber, emDeviceGroups=emDeviceGroups, groupDescription=groupDescription, archiveSourceDevice=archiveSourceDevice, emAlertObjMsg=emAlertObjMsg, emMemoryUsage=emMemoryUsage, emScheduledArchiveFailed=emScheduledArchiveFailed, groupEntryTable=groupEntryTable, emDevices=emDevices, emSoftwareInstallFailed=emSoftwareInstallFailed, imageNumber=imageNumber, emDeviceStandbyMode=emDeviceStandbyMode, archiveVersion=archiveVersion, emDeviceUnreachable=emDeviceUnreachable, archiveEntryTable=archiveEntryTable, imageEntryTable=imageEntryTable, imageVersion=imageVersion, archiveEntry=archiveEntry, emDeviceActiveMode=emDeviceActiveMode, emPerformanceStorageDays=emPerformanceStorageDays, emDeviceConfigSync=emDeviceConfigSync, emGatherServiceContractFailure=emGatherServiceContractFailure, archiveDescription=archiveDescription, emCertificateExpiration=emCertificateExpiration, emDeviceList=emDeviceList, deviceAddress=deviceAddress, imageDescription=imageDescription, emSchedBackupFailed=emSchedBackupFailed, emRefreshInterval=emRefreshInterval, emASMSigInstallComplete=emASMSigInstallComplete, emServiceContractExpiry=emServiceContractExpiry, archiveTimeStamp=archiveTimeStamp, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emArchives=emArchives, emStatsDBConnectivityLost=emStatsDBConnectivityLost)
