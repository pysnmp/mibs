...
enterprises, iso, Counter32, Bits, ModuleIdentity, Integer32, Opaque, Gauge32, Counter64, ObjectIdentity, Unsigned32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Counter32", "Bits", "ModuleIdentity", "Integer32", "Opaque", "Gauge32", "Counter64", "ObjectIdentity", "Unsigned32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveNumber=archiveNumber, emRefreshInterval=emRefreshInterval, emDeviceActiveMode=emDeviceActiveMode, emRaidDriveFailureDetected=emRaidDriveFailureDetected, deviceName=deviceName, emServiceContractExpiry=emServiceContractExpiry, deviceAddress=deviceAddress, archiveEntry=archiveEntry, emArchives=emArchives, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceStandbyMode=emDeviceStandbyMode, emDevices=emDevices, groupNumber=groupNumber, emImages=emImages, archiveVersion=archiveVersion, emSoftwareInstallComplete=emSoftwareInstallComplete, emASMSigInstallComplete=emASMSigInstallComplete, emPerformanceThreshold=emPerformanceThreshold, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveSourceDevice=archiveSourceDevice, emScheduledArchiveFailed=emScheduledArchiveFailed, archiveTimeStamp=archiveTimeStamp, archiveFilename=archiveFilename, emDeviceClockSkew=emDeviceClockSkew, imageEntryTable=imageEntryTable, emHotfixInstallComplete=emHotfixInstallComplete, deviceEntryTable=deviceEntryTable, emAlertConfigObjects=emAlertConfigObjects, imageEntry=imageEntry, emMaxConcurrentUpdates=emMaxConcurrentUpdates, imageVersion=imageVersion, emHotfixInstallFailed=emHotfixInstallFailed, archiveEntryTable=archiveEntryTable, emCertificateExpiration=emCertificateExpiration, emSchedBackupFailed=emSchedBackupFailed, emDeviceImpaired=emDeviceImpaired, emDeviceList=emDeviceList, emPerformanceStorageDays=emPerformanceStorageDays, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, deviceEntry=deviceEntry, emAlerts=emAlerts, emDiskUsage=emDiskUsage, groupEntry=groupEntry, imageDescription=imageDescription, emDeviceGroups=emDeviceGroups, emCpuUsage=emCpuUsage, enterpriseManagement=enterpriseManagement, emMemoryUsage=emMemoryUsage, emASMSigInstallFailed=emASMSigInstallFailed, emAlertObjMsg=emAlertObjMsg, emDeviceOfflineMode=emDeviceOfflineMode, groupEntryTable=groupEntryTable, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceUnreachable=emDeviceUnreachable, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceConfigSync=emDeviceConfigSync, emGatherServiceContractFailure=emGatherServiceContractFailure, emStatsCollectionRateCap=emStatsCollectionRateCap, imageNumber=imageNumber, emASMSigUpdateAvailable=emASMSigUpdateAvailable, PYSNMP_MODULE_ID=enterpriseManagement, archiveProduct=archiveProduct, emVersion=emVersion, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emAlert=emAlert, emGlobals=emGlobals, emHaSyncFailed=emHaSyncFailed, deviceAddressType=deviceAddressType, deviceNumber=deviceNumber, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, groupName=groupName, groupDescription=groupDescription, archiveDescription=archiveDescription, emAlertObjects=emAlertObjects)
