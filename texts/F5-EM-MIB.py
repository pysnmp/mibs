...
IpAddress, Unsigned32, Counter64, Bits, Gauge32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, enterprises, iso, Opaque, Counter32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Counter64", "Bits", "Gauge32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "enterprises", "iso", "Opaque", "Counter32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDiskUsage=emDiskUsage, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, archiveDescription=archiveDescription, emDeviceActiveMode=emDeviceActiveMode, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceList=emDeviceList, emDeviceImpaired=emDeviceImpaired, archiveSourceDevice=archiveSourceDevice, deviceName=deviceName, emSchedBackupFailed=emSchedBackupFailed, emDeviceGroups=emDeviceGroups, archiveFilename=archiveFilename, emAlertObjMsg=emAlertObjMsg, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceUnreachable=emDeviceUnreachable, archiveEntryTable=archiveEntryTable, emPerformanceStorageCap=emPerformanceStorageCap, imageDescription=imageDescription, emAlert=emAlert, archiveEntry=archiveEntry, groupEntry=groupEntry, groupNumber=groupNumber, emAlertConfigObjects=emAlertConfigObjects, groupName=groupName, imageNumber=imageNumber, emASMSigUpdateAvailable=emASMSigUpdateAvailable, deviceEntryTable=deviceEntryTable, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emRefreshInterval=emRefreshInterval, emSoftwareInstallFailed=emSoftwareInstallFailed, enterpriseManagement=enterpriseManagement, emHaSyncFailed=emHaSyncFailed, deviceEntry=deviceEntry, emStatsCollectionRateCap=emStatsCollectionRateCap, emMemoryUsage=emMemoryUsage, groupEntryTable=groupEntryTable, emVersion=emVersion, emDeviceConfigSync=emDeviceConfigSync, emCpuUsage=emCpuUsage, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceClockSkew=emDeviceClockSkew, groupDescription=groupDescription, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceStandbyMode=emDeviceStandbyMode, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceOfflineMode=emDeviceOfflineMode, emScheduledArchiveFailed=emScheduledArchiveFailed, imageEntry=imageEntry, emPerformanceThreshold=emPerformanceThreshold, imageVersion=imageVersion, emMaxConcurrentUpdates=emMaxConcurrentUpdates, deviceAddressType=deviceAddressType, emHotfixInstallComplete=emHotfixInstallComplete, emDevices=emDevices, emGlobals=emGlobals, emRaidDriveFailureDetected=emRaidDriveFailureDetected, deviceNumber=deviceNumber, archiveTimeStamp=archiveTimeStamp, archiveNumber=archiveNumber, emASMSigUpdateFailed=emASMSigUpdateFailed, emServiceContractExpiry=emServiceContractExpiry, emImages=emImages, emSoftwareInstallComplete=emSoftwareInstallComplete, imageEntryTable=imageEntryTable, archiveVersion=archiveVersion, emAlerts=emAlerts, emCertificateExpiration=emCertificateExpiration, emASMSigInstallFailed=emASMSigInstallFailed, archiveProduct=archiveProduct, emPerformanceStorageDays=emPerformanceStorageDays, emGatherServiceContractFailure=emGatherServiceContractFailure, emASMSigInstallComplete=emASMSigInstallComplete, emArchives=emArchives, deviceAddress=deviceAddress, emAlertObjects=emAlertObjects)
