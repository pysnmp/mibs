...
Unsigned32, Bits, Integer32, TimeTicks, enterprises, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Opaque, iso, MibIdentifier, ModuleIdentity, Counter64, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "Integer32", "TimeTicks", "enterprises", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Opaque", "iso", "MibIdentifier", "ModuleIdentity", "Counter64", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceList=emDeviceList, emSoftwareInstallFailed=emSoftwareInstallFailed, imageNumber=imageNumber, archiveNumber=archiveNumber, archiveDescription=archiveDescription, emDeviceImpaired=emDeviceImpaired, emImages=emImages, emDeviceStandbyMode=emDeviceStandbyMode, emPerformanceThreshold=emPerformanceThreshold, emDevices=emDevices, groupEntryTable=groupEntryTable, emAlert=emAlert, emAlerts=emAlerts, emAlertObjMsg=emAlertObjMsg, emScheduledArchiveFailed=emScheduledArchiveFailed, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, PYSNMP_MODULE_ID=enterpriseManagement, imageVersion=imageVersion, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emMaxConcurrentUpdates=emMaxConcurrentUpdates, groupEntry=groupEntry, emVersion=emVersion, emMemoryUsage=emMemoryUsage, emStatsCollectionRateCap=emStatsCollectionRateCap, emCertificateExpiration=emCertificateExpiration, emCpuUsage=emCpuUsage, imageEntry=imageEntry, archiveTimeStamp=archiveTimeStamp, archiveVersion=archiveVersion, emServiceContractExpiry=emServiceContractExpiry, imageEntryTable=imageEntryTable, groupName=groupName, emDeviceClockSkew=emDeviceClockSkew, enterpriseManagement=enterpriseManagement, emDeviceGroups=emDeviceGroups, emDiskUsage=emDiskUsage, emHaSyncFailed=emHaSyncFailed, emArchives=emArchives, emASMSigInstallFailed=emASMSigInstallFailed, emAlertObjects=emAlertObjects, groupNumber=groupNumber, archiveSourceDevice=archiveSourceDevice, emPerformanceStorageDays=emPerformanceStorageDays, emHotfixInstallComplete=emHotfixInstallComplete, deviceNumber=deviceNumber, emAlertConfigObjects=emAlertConfigObjects, archiveEntryTable=archiveEntryTable, archiveProduct=archiveProduct, archiveFilename=archiveFilename, emASMSigInstallComplete=emASMSigInstallComplete, emASMSigUpdateFailed=emASMSigUpdateFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, groupDescription=groupDescription, deviceAddressType=deviceAddressType, emPerformanceStorageCap=emPerformanceStorageCap, archiveEntry=archiveEntry, emSoftwareInstallComplete=emSoftwareInstallComplete, emSchedBackupFailed=emSchedBackupFailed, emDeviceUnreachable=emDeviceUnreachable, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceAddress=deviceAddress, emDeviceOfflineMode=emDeviceOfflineMode, deviceEntryTable=deviceEntryTable, imageDescription=imageDescription, deviceEntry=deviceEntry, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emRefreshInterval=emRefreshInterval, emHotfixInstallFailed=emHotfixInstallFailed, deviceName=deviceName, emDeviceActiveMode=emDeviceActiveMode, emDeviceConfigSync=emDeviceConfigSync, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emGlobals=emGlobals)
