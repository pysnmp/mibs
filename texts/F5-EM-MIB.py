...
Counter64, Bits, Counter32, iso, ObjectIdentity, NotificationType, TimeTicks, Opaque, enterprises, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "Counter32", "iso", "ObjectIdentity", "NotificationType", "TimeTicks", "Opaque", "enterprises", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emPerformanceStorageDays=emPerformanceStorageDays, emCpuUsage=emCpuUsage, emDeviceList=emDeviceList, emSoftwareInstallComplete=emSoftwareInstallComplete, emHaSyncFailed=emHaSyncFailed, emHotfixInstallFailed=emHotfixInstallFailed, archiveProduct=archiveProduct, deviceAddressType=deviceAddressType, imageEntry=imageEntry, emStatsCollectionRateCap=emStatsCollectionRateCap, emGatherServiceContractFailure=emGatherServiceContractFailure, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDiskUsage=emDiskUsage, emDeviceImpaired=emDeviceImpaired, emDeviceGroups=emDeviceGroups, emVersion=emVersion, emDeviceStandbyMode=emDeviceStandbyMode, deviceAddress=deviceAddress, emArchives=emArchives, archiveNumber=archiveNumber, groupDescription=groupDescription, emASMSigInstallComplete=emASMSigInstallComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emAlertObjects=emAlertObjects, emPerformanceThreshold=emPerformanceThreshold, groupEntryTable=groupEntryTable, archiveFilename=archiveFilename, emSchedBackupFailed=emSchedBackupFailed, imageEntryTable=imageEntryTable, emGlobals=emGlobals, emStatsDBConnectivityLost=emStatsDBConnectivityLost, enterpriseManagement=enterpriseManagement, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceClockSkew=emDeviceClockSkew, emDeviceConfigSync=emDeviceConfigSync, emDeviceUnreachable=emDeviceUnreachable, emHotfixInstallComplete=emHotfixInstallComplete, emASMSigInstallFailed=emASMSigInstallFailed, archiveEntry=archiveEntry, archiveDescription=archiveDescription, emAlertConfigObjects=emAlertConfigObjects, imageNumber=imageNumber, emASMSigUpdateFailed=emASMSigUpdateFailed, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emScheduledArchiveFailed=emScheduledArchiveFailed, emImages=emImages, emMemoryUsage=emMemoryUsage, emAlert=emAlert, PYSNMP_MODULE_ID=enterpriseManagement, imageDescription=imageDescription, emCertificateExpiration=emCertificateExpiration, groupNumber=groupNumber, deviceEntry=deviceEntry, deviceNumber=deviceNumber, deviceEntryTable=deviceEntryTable, emDeviceActiveMode=emDeviceActiveMode, imageVersion=imageVersion, archiveTimeStamp=archiveTimeStamp, archiveSourceDevice=archiveSourceDevice, emDeviceOfflineMode=emDeviceOfflineMode, emAlerts=emAlerts, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, groupName=groupName, archiveEntryTable=archiveEntryTable, groupEntry=groupEntry, emAlertObjMsg=emAlertObjMsg, emServiceContractExpiry=emServiceContractExpiry, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceName=deviceName, emRefreshInterval=emRefreshInterval, emDevices=emDevices, archiveVersion=archiveVersion, emMaxConcurrentUpdates=emMaxConcurrentUpdates)
