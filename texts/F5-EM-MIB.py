...
Gauge32, Integer32, ModuleIdentity, iso, Bits, TimeTicks, IpAddress, Opaque, ObjectIdentity, MibIdentifier, Unsigned32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "ModuleIdentity", "iso", "Bits", "TimeTicks", "IpAddress", "Opaque", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("F5-EM-MIB", emImages=emImages, imageEntry=imageEntry, emAlerts=emAlerts, emGatherServiceContractFailure=emGatherServiceContractFailure, emAlertObjects=emAlertObjects, imageNumber=imageNumber, emMemoryUsage=emMemoryUsage, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emPerformanceStorageCap=emPerformanceStorageCap, archiveEntry=archiveEntry, emDiskUsage=emDiskUsage, emDeviceOfflineMode=emDeviceOfflineMode, groupDescription=groupDescription, archiveEntryTable=archiveEntryTable, archiveVersion=archiveVersion, deviceNumber=deviceNumber, emRefreshInterval=emRefreshInterval, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emScheduledArchiveFailed=emScheduledArchiveFailed, emVersion=emVersion, emDeviceGroups=emDeviceGroups, archiveFilename=archiveFilename, emDeviceUnreachable=emDeviceUnreachable, emAlertConfigObjects=emAlertConfigObjects, groupEntryTable=groupEntryTable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emHotfixInstallComplete=emHotfixInstallComplete, emArchives=emArchives, emDeviceConfigSync=emDeviceConfigSync, emPerformanceStorageDays=emPerformanceStorageDays, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveSourceDevice=archiveSourceDevice, emSchedBackupFailed=emSchedBackupFailed, imageEntryTable=imageEntryTable, emGlobals=emGlobals, deviceEntryTable=deviceEntryTable, emASMSigInstallComplete=emASMSigInstallComplete, archiveProduct=archiveProduct, groupEntry=groupEntry, emAlertObjMsg=emAlertObjMsg, imageDescription=imageDescription, emCertificateExpiration=emCertificateExpiration, emASMSigInstallFailed=emASMSigInstallFailed, emDevices=emDevices, deviceAddress=deviceAddress, emSoftwareInstallFailed=emSoftwareInstallFailed, emAlert=emAlert, emDeviceStandbyMode=emDeviceStandbyMode, archiveDescription=archiveDescription, groupNumber=groupNumber, deviceEntry=deviceEntry, emPerformanceThreshold=emPerformanceThreshold, imageVersion=imageVersion, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emStatsCollectionRateCap=emStatsCollectionRateCap, deviceName=deviceName, deviceAddressType=deviceAddressType, enterpriseManagement=enterpriseManagement, archiveNumber=archiveNumber, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emServiceContractExpiry=emServiceContractExpiry, emDeviceImpaired=emDeviceImpaired, emDeviceActiveMode=emDeviceActiveMode, emHaSyncFailed=emHaSyncFailed, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emCpuUsage=emCpuUsage, emDeviceClockSkew=emDeviceClockSkew, emDeviceList=emDeviceList, archiveTimeStamp=archiveTimeStamp, PYSNMP_MODULE_ID=enterpriseManagement, emHotfixInstallFailed=emHotfixInstallFailed, groupName=groupName)
