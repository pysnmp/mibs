...
Bits, NotificationType, Integer32, Counter32, Gauge32, Unsigned32, IpAddress, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, ModuleIdentity, enterprises, MibIdentifier, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Integer32", "Counter32", "Gauge32", "Unsigned32", "IpAddress", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "ModuleIdentity", "enterprises", "MibIdentifier", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("F5-EM-MIB", deviceAddress=deviceAddress, imageNumber=imageNumber, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emArchives=emArchives, archiveVersion=archiveVersion, emScheduledArchiveFailed=emScheduledArchiveFailed, emAlertObjMsg=emAlertObjMsg, emDeviceActiveMode=emDeviceActiveMode, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceClockSkew=emDeviceClockSkew, emPerformanceStorageDays=emPerformanceStorageDays, emPerformanceStorageCap=emPerformanceStorageCap, emPerformanceThreshold=emPerformanceThreshold, emDeviceOfflineMode=emDeviceOfflineMode, emDeviceImpaired=emDeviceImpaired, imageEntryTable=imageEntryTable, deviceNumber=deviceNumber, groupEntry=groupEntry, emAlertConfigObjects=emAlertConfigObjects, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emAlert=emAlert, groupName=groupName, emDeviceGroups=emDeviceGroups, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, archiveNumber=archiveNumber, imageDescription=imageDescription, emAlerts=emAlerts, archiveTimeStamp=archiveTimeStamp, groupEntryTable=groupEntryTable, emRefreshInterval=emRefreshInterval, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emHaSyncFailed=emHaSyncFailed, archiveSourceDevice=archiveSourceDevice, archiveDescription=archiveDescription, emSchedBackupFailed=emSchedBackupFailed, emDeviceStandbyMode=emDeviceStandbyMode, emMemoryUsage=emMemoryUsage, archiveEntryTable=archiveEntryTable, emASMSigInstallComplete=emASMSigInstallComplete, emServiceContractExpiry=emServiceContractExpiry, archiveFilename=archiveFilename, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emCertificateExpiration=emCertificateExpiration, emASMSigUpdateFailed=emASMSigUpdateFailed, emGlobals=emGlobals, deviceName=deviceName, groupDescription=groupDescription, emDeviceConfigSync=emDeviceConfigSync, groupNumber=groupNumber, emDevices=emDevices, emSoftwareInstallFailed=emSoftwareInstallFailed, deviceEntry=deviceEntry, emHotfixInstallComplete=emHotfixInstallComplete, archiveEntry=archiveEntry, enterpriseManagement=enterpriseManagement, PYSNMP_MODULE_ID=enterpriseManagement, imageEntry=imageEntry, emGatherServiceContractFailure=emGatherServiceContractFailure, emStatsDBConnectivityLost=emStatsDBConnectivityLost, deviceAddressType=deviceAddressType, imageVersion=imageVersion, archiveProduct=archiveProduct, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emAlertObjects=emAlertObjects, emDeviceUnreachable=emDeviceUnreachable, emDeviceList=emDeviceList, emStatsCollectionRateCap=emStatsCollectionRateCap, emDiskUsage=emDiskUsage, emHotfixInstallFailed=emHotfixInstallFailed, emCpuUsage=emCpuUsage, emImages=emImages, deviceEntryTable=deviceEntryTable, emVersion=emVersion)
