...
iso, IpAddress, NotificationType, Opaque, Integer32, Counter64, Bits, Unsigned32, ModuleIdentity, TimeTicks, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "Opaque", "Integer32", "Counter64", "Bits", "Unsigned32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emServiceContractExpiry=emServiceContractExpiry, archiveProduct=archiveProduct, emDeviceActiveMode=emDeviceActiveMode, deviceEntry=deviceEntry, emDeviceStandbyMode=emDeviceStandbyMode, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveSourceDevice=archiveSourceDevice, imageDescription=imageDescription, deviceAddressType=deviceAddressType, archiveNumber=archiveNumber, archiveTimeStamp=archiveTimeStamp, PYSNMP_MODULE_ID=enterpriseManagement, deviceAddress=deviceAddress, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDeviceImpaired=emDeviceImpaired, archiveEntry=archiveEntry, emCertificateExpiration=emCertificateExpiration, emScheduledArchiveFailed=emScheduledArchiveFailed, archiveFilename=archiveFilename, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emASMSigInstallFailed=emASMSigInstallFailed, archiveDescription=archiveDescription, imageEntryTable=imageEntryTable, emAlertObjects=emAlertObjects, deviceEntryTable=deviceEntryTable, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emAlertObjMsg=emAlertObjMsg, deviceName=deviceName, emVersion=emVersion, emDeviceGroups=emDeviceGroups, groupEntry=groupEntry, emImages=emImages, emASMSigInstallComplete=emASMSigInstallComplete, emPerformanceStorageDays=emPerformanceStorageDays, deviceNumber=deviceNumber, emDeviceClockSkew=emDeviceClockSkew, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceList=emDeviceList, emSoftwareInstallFailed=emSoftwareInstallFailed, emAlert=emAlert, imageVersion=imageVersion, archiveVersion=archiveVersion, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDiskUsage=emDiskUsage, emPerformanceStorageCap=emPerformanceStorageCap, imageNumber=imageNumber, emSchedBackupFailed=emSchedBackupFailed, groupEntryTable=groupEntryTable, archiveEntryTable=archiveEntryTable, emPerformanceThreshold=emPerformanceThreshold, emDeviceOfflineMode=emDeviceOfflineMode, groupDescription=groupDescription, emCpuUsage=emCpuUsage, emDeviceUnreachable=emDeviceUnreachable, emDeviceConfigSync=emDeviceConfigSync, emStatsCollectionRateCap=emStatsCollectionRateCap, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, groupNumber=groupNumber, enterpriseManagement=enterpriseManagement, emHotfixInstallFailed=emHotfixInstallFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, imageEntry=imageEntry, emArchives=emArchives, emHaSyncFailed=emHaSyncFailed, emRefreshInterval=emRefreshInterval, emGlobals=emGlobals, emSoftwareInstallComplete=emSoftwareInstallComplete, emAlertConfigObjects=emAlertConfigObjects, emMemoryUsage=emMemoryUsage, emDevices=emDevices, emAlerts=emAlerts, groupName=groupName)
