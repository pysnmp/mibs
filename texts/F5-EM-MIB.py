...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Counter64, Gauge32, iso, TimeTicks, Unsigned32, ObjectIdentity, MibIdentifier, IpAddress, NotificationType, Counter32, Integer32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Counter64", "Gauge32", "iso", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibIdentifier", "IpAddress", "NotificationType", "Counter32", "Integer32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emArchives=emArchives, emAlert=emAlert, archiveFilename=archiveFilename, imageEntryTable=imageEntryTable, emCpuUsage=emCpuUsage, emDeviceActiveMode=emDeviceActiveMode, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, groupNumber=groupNumber, emAlertConfigObjects=emAlertConfigObjects, archiveEntry=archiveEntry, emServiceContractExpiry=emServiceContractExpiry, groupEntryTable=groupEntryTable, emImages=emImages, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveVersion=archiveVersion, emPerformanceStorageDays=emPerformanceStorageDays, emMemoryUsage=emMemoryUsage, groupName=groupName, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceEntryTable=deviceEntryTable, emDeviceImpaired=emDeviceImpaired, emGlobals=emGlobals, enterpriseManagement=enterpriseManagement, emRefreshInterval=emRefreshInterval, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceOfflineMode=emDeviceOfflineMode, archiveSourceDevice=archiveSourceDevice, deviceAddressType=deviceAddressType, groupEntry=groupEntry, PYSNMP_MODULE_ID=enterpriseManagement, emAlertObjects=emAlertObjects, emSchedBackupFailed=emSchedBackupFailed, imageDescription=imageDescription, deviceName=deviceName, emAlertObjMsg=emAlertObjMsg, emHotfixInstallComplete=emHotfixInstallComplete, imageNumber=imageNumber, emDeviceUnreachable=emDeviceUnreachable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, imageEntry=imageEntry, deviceNumber=deviceNumber, archiveDescription=archiveDescription, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDevices=emDevices, emAlerts=emAlerts, emCertificateExpiration=emCertificateExpiration, archiveEntryTable=archiveEntryTable, emDeviceConfigSync=emDeviceConfigSync, emHaSyncFailed=emHaSyncFailed, emASMSigUpdateFailed=emASMSigUpdateFailed, deviceEntry=deviceEntry, emVersion=emVersion, archiveProduct=archiveProduct, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceList=emDeviceList, emSoftwareInstallFailed=emSoftwareInstallFailed, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceGroups=emDeviceGroups, groupDescription=groupDescription, archiveNumber=archiveNumber, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emHotfixInstallFailed=emHotfixInstallFailed, archiveTimeStamp=archiveTimeStamp, deviceAddress=deviceAddress, emASMSigInstallComplete=emASMSigInstallComplete, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceClockSkew=emDeviceClockSkew, emDeviceStandbyMode=emDeviceStandbyMode, emDiskUsage=emDiskUsage, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceThreshold=emPerformanceThreshold, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, imageVersion=imageVersion)
