...
iso, ObjectIdentity, Counter32, NotificationType, Counter64, Opaque, enterprises, Bits, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Integer32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Counter32", "NotificationType", "Counter64", "Opaque", "enterprises", "Bits", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Integer32", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveFilename=archiveFilename, groupEntryTable=groupEntryTable, emAlerts=emAlerts, emPerformanceStorageDays=emPerformanceStorageDays, imageEntry=imageEntry, imageDescription=imageDescription, emAlertObjMsg=emAlertObjMsg, emDevices=emDevices, emPerformanceThreshold=emPerformanceThreshold, imageNumber=imageNumber, emASMSigInstallFailed=emASMSigInstallFailed, groupDescription=groupDescription, emDeviceOfflineMode=emDeviceOfflineMode, emCertificateExpiration=emCertificateExpiration, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emSoftwareInstallComplete=emSoftwareInstallComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveEntry=archiveEntry, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emGatherServiceContractFailure=emGatherServiceContractFailure, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emSoftwareInstallFailed=emSoftwareInstallFailed, emScheduledArchiveFailed=emScheduledArchiveFailed, emSchedBackupFailed=emSchedBackupFailed, deviceAddressType=deviceAddressType, emVersion=emVersion, emMemoryUsage=emMemoryUsage, emPerformanceStorageCap=emPerformanceStorageCap, imageEntryTable=imageEntryTable, groupName=groupName, emDeviceList=emDeviceList, archiveSourceDevice=archiveSourceDevice, archiveProduct=archiveProduct, deviceNumber=deviceNumber, emAlertObjects=emAlertObjects, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceAddress=deviceAddress, enterpriseManagement=enterpriseManagement, emAlert=emAlert, emArchives=emArchives, emHaSyncFailed=emHaSyncFailed, emASMSigInstallComplete=emASMSigInstallComplete, archiveVersion=archiveVersion, emServiceContractExpiry=emServiceContractExpiry, emDeviceStandbyMode=emDeviceStandbyMode, emDeviceUnreachable=emDeviceUnreachable, emGlobals=emGlobals, deviceEntryTable=deviceEntryTable, emStatsCollectionRateCap=emStatsCollectionRateCap, deviceEntry=deviceEntry, archiveDescription=archiveDescription, imageVersion=imageVersion, emRaidDriveFailureDetected=emRaidDriveFailureDetected, archiveEntryTable=archiveEntryTable, emDeviceClockSkew=emDeviceClockSkew, deviceName=deviceName, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDiskUsage=emDiskUsage, archiveNumber=archiveNumber, emDeviceActiveMode=emDeviceActiveMode, emDeviceConfigSync=emDeviceConfigSync, groupEntry=groupEntry, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveTimeStamp=archiveTimeStamp, emImages=emImages, emHotfixInstallComplete=emHotfixInstallComplete, PYSNMP_MODULE_ID=enterpriseManagement, groupNumber=groupNumber, emAlertConfigObjects=emAlertConfigObjects, emDeviceImpaired=emDeviceImpaired, emCpuUsage=emCpuUsage, emRefreshInterval=emRefreshInterval, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceGroups=emDeviceGroups)
