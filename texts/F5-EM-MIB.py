...
Unsigned32, TimeTicks, iso, Integer32, Opaque, Counter64, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, enterprises, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "iso", "Integer32", "Opaque", "Counter64", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "enterprises", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emAlertObjMsg=emAlertObjMsg, emRefreshInterval=emRefreshInterval, emHotfixInstallComplete=emHotfixInstallComplete, enterpriseManagement=enterpriseManagement, emServiceContractExpiry=emServiceContractExpiry, emSoftwareInstallFailed=emSoftwareInstallFailed, archiveNumber=archiveNumber, emGatherServiceContractFailure=emGatherServiceContractFailure, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceActiveMode=emDeviceActiveMode, archiveProduct=archiveProduct, archiveEntry=archiveEntry, emAlerts=emAlerts, emDevices=emDevices, emCertificateExpiration=emCertificateExpiration, emDeviceStandbyMode=emDeviceStandbyMode, emAlertObjects=emAlertObjects, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceImpaired=emDeviceImpaired, emASMSigInstallFailed=emASMSigInstallFailed, groupDescription=groupDescription, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceOfflineMode=emDeviceOfflineMode, groupEntry=groupEntry, groupName=groupName, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emAlert=emAlert, imageDescription=imageDescription, emGlobals=emGlobals, emPerformanceStorageDays=emPerformanceStorageDays, deviceAddressType=deviceAddressType, deviceAddress=deviceAddress, archiveEntryTable=archiveEntryTable, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceClockSkew=emDeviceClockSkew, emDeviceUnreachable=emDeviceUnreachable, imageEntryTable=imageEntryTable, groupEntryTable=groupEntryTable, emPerformanceThreshold=emPerformanceThreshold, emDeviceConfigSync=emDeviceConfigSync, archiveTimeStamp=archiveTimeStamp, emDiskUsage=emDiskUsage, emDeviceList=emDeviceList, archiveVersion=archiveVersion, imageEntry=imageEntry, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, imageNumber=imageNumber, emImages=emImages, emHotfixInstallFailed=emHotfixInstallFailed, emHaSyncFailed=emHaSyncFailed, emPerformanceStorageCap=emPerformanceStorageCap, deviceEntryTable=deviceEntryTable, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceGroups=emDeviceGroups, archiveDescription=archiveDescription, emCpuUsage=emCpuUsage, emAlertConfigObjects=emAlertConfigObjects, emStatsCollectionRateCap=emStatsCollectionRateCap, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveSourceDevice=archiveSourceDevice, emScheduledArchiveFailed=emScheduledArchiveFailed, emMemoryUsage=emMemoryUsage, deviceEntry=deviceEntry, archiveFilename=archiveFilename, emSchedBackupFailed=emSchedBackupFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emVersion=emVersion, emArchives=emArchives, deviceNumber=deviceNumber, imageVersion=imageVersion, groupNumber=groupNumber, emASMSigInstallComplete=emASMSigInstallComplete, deviceName=deviceName)
