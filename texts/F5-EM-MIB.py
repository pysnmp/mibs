...
ModuleIdentity, enterprises, Gauge32, ObjectIdentity, Counter32, iso, Unsigned32, Integer32, TimeTicks, Counter64, IpAddress, MibIdentifier, NotificationType, Opaque, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Gauge32", "ObjectIdentity", "Counter32", "iso", "Unsigned32", "Integer32", "TimeTicks", "Counter64", "IpAddress", "MibIdentifier", "NotificationType", "Opaque", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("F5-EM-MIB", PYSNMP_MODULE_ID=enterpriseManagement, emArchives=emArchives, emDeviceUnreachable=emDeviceUnreachable, archiveEntryTable=archiveEntryTable, archiveTimeStamp=archiveTimeStamp, emAlerts=emAlerts, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceConfigSync=emDeviceConfigSync, archiveSourceDevice=archiveSourceDevice, emDeviceImpaired=emDeviceImpaired, archiveVersion=archiveVersion, emPerformanceThreshold=emPerformanceThreshold, emDeviceGroups=emDeviceGroups, enterpriseManagement=enterpriseManagement, emRefreshInterval=emRefreshInterval, emDeviceClockSkew=emDeviceClockSkew, emImages=emImages, deviceAddress=deviceAddress, emCpuUsage=emCpuUsage, emServiceContractExpiry=emServiceContractExpiry, emGatherServiceContractFailure=emGatherServiceContractFailure, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDeviceList=emDeviceList, emAlertObjMsg=emAlertObjMsg, emSchedBackupFailed=emSchedBackupFailed, emPerformanceStorageCap=emPerformanceStorageCap, emScheduledArchiveFailed=emScheduledArchiveFailed, emAlertObjects=emAlertObjects, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emHotfixInstallComplete=emHotfixInstallComplete, archiveProduct=archiveProduct, imageEntry=imageEntry, emAlertConfigObjects=emAlertConfigObjects, groupEntryTable=groupEntryTable, emGlobals=emGlobals, groupName=groupName, imageVersion=imageVersion, emDiskUsage=emDiskUsage, deviceNumber=deviceNumber, deviceAddressType=deviceAddressType, emMemoryUsage=emMemoryUsage, emASMSigInstallComplete=emASMSigInstallComplete, archiveNumber=archiveNumber, groupEntry=groupEntry, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceStandbyMode=emDeviceStandbyMode, emAlert=emAlert, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDevices=emDevices, deviceName=deviceName, groupNumber=groupNumber, emASMSigInstallFailed=emASMSigInstallFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, imageDescription=imageDescription, archiveDescription=archiveDescription, emSoftwareInstallComplete=emSoftwareInstallComplete, imageNumber=imageNumber, emDeviceActiveMode=emDeviceActiveMode, emDeviceOfflineMode=emDeviceOfflineMode, emVersion=emVersion, emCertificateExpiration=emCertificateExpiration, emMaxConcurrentUpdates=emMaxConcurrentUpdates, imageEntryTable=imageEntryTable, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, archiveFilename=archiveFilename, emSoftwareInstallFailed=emSoftwareInstallFailed, emHaSyncFailed=emHaSyncFailed, deviceEntryTable=deviceEntryTable, deviceEntry=deviceEntry, archiveEntry=archiveEntry, emPerformanceStorageDays=emPerformanceStorageDays, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emASMSigUpdateFailed=emASMSigUpdateFailed, groupDescription=groupDescription)
