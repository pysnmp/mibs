...
ModuleIdentity, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Integer32, Opaque, Gauge32, ObjectIdentity, Counter32, iso, TimeTicks, MibIdentifier, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Integer32", "Opaque", "Gauge32", "ObjectIdentity", "Counter32", "iso", "TimeTicks", "MibIdentifier", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDiskUsage=emDiskUsage, archiveVersion=archiveVersion, archiveDescription=archiveDescription, emDeviceList=emDeviceList, emDeviceConfigSync=emDeviceConfigSync, emCpuUsage=emCpuUsage, imageEntry=imageEntry, imageDescription=imageDescription, emServiceContractExpiry=emServiceContractExpiry, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emASMSigInstallComplete=emASMSigInstallComplete, emSchedBackupFailed=emSchedBackupFailed, emAlertConfigObjects=emAlertConfigObjects, emDevices=emDevices, emDeviceStandbyMode=emDeviceStandbyMode, archiveFilename=archiveFilename, emDeviceActiveMode=emDeviceActiveMode, deviceAddressType=deviceAddressType, emPerformanceStorageCap=emPerformanceStorageCap, emScheduledArchiveFailed=emScheduledArchiveFailed, emAlertObjMsg=emAlertObjMsg, emHotfixInstallFailed=emHotfixInstallFailed, imageNumber=imageNumber, imageVersion=imageVersion, emRefreshInterval=emRefreshInterval, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveEntry=archiveEntry, groupName=groupName, emDeviceGroups=emDeviceGroups, deviceName=deviceName, imageEntryTable=imageEntryTable, archiveNumber=archiveNumber, archiveSourceDevice=archiveSourceDevice, archiveProduct=archiveProduct, emPerformanceStorageDays=emPerformanceStorageDays, emGatherServiceContractFailure=emGatherServiceContractFailure, emAlerts=emAlerts, emDeviceClockSkew=emDeviceClockSkew, groupNumber=groupNumber, emImages=emImages, groupDescription=groupDescription, emStatsDBConnectivityLost=emStatsDBConnectivityLost, PYSNMP_MODULE_ID=enterpriseManagement, emHaSyncFailed=emHaSyncFailed, groupEntry=groupEntry, archiveEntryTable=archiveEntryTable, archiveTimeStamp=archiveTimeStamp, emSoftwareInstallFailed=emSoftwareInstallFailed, emHotfixInstallComplete=emHotfixInstallComplete, emMemoryUsage=emMemoryUsage, emGlobals=emGlobals, deviceEntryTable=deviceEntryTable, deviceNumber=deviceNumber, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceThreshold=emPerformanceThreshold, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, deviceEntry=deviceEntry, emVersion=emVersion, emAlert=emAlert, enterpriseManagement=enterpriseManagement, emDeviceImpaired=emDeviceImpaired, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emCertificateExpiration=emCertificateExpiration, emAlertObjects=emAlertObjects, emDeviceUnreachable=emDeviceUnreachable, emASMSigInstallFailed=emASMSigInstallFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, deviceAddress=deviceAddress, emASMSigUpdateFailed=emASMSigUpdateFailed, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emArchives=emArchives, emDeviceOfflineMode=emDeviceOfflineMode, groupEntryTable=groupEntryTable)
