...
enterprises, iso, MibIdentifier, ObjectIdentity, Opaque, Unsigned32, IpAddress, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Gauge32, NotificationType, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "MibIdentifier", "ObjectIdentity", "Opaque", "Unsigned32", "IpAddress", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Gauge32", "NotificationType", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveProduct=archiveProduct, imageDescription=imageDescription, emDeviceImpaired=emDeviceImpaired, emSoftwareInstallComplete=emSoftwareInstallComplete, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceConfigSync=emDeviceConfigSync, emSoftwareInstallFailed=emSoftwareInstallFailed, emASMSigInstallComplete=emASMSigInstallComplete, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceStandbyMode=emDeviceStandbyMode, imageNumber=imageNumber, emAlertObjects=emAlertObjects, emHotfixInstallComplete=emHotfixInstallComplete, emHaSyncFailed=emHaSyncFailed, emDeviceList=emDeviceList, emStatsCollectionRateCap=emStatsCollectionRateCap, emServiceContractExpiry=emServiceContractExpiry, emDeviceActiveMode=emDeviceActiveMode, emAlertConfigObjects=emAlertConfigObjects, emCpuUsage=emCpuUsage, emASMSigInstallFailed=emASMSigInstallFailed, archiveDescription=archiveDescription, emStatsDBConnectivityLost=emStatsDBConnectivityLost, PYSNMP_MODULE_ID=enterpriseManagement, emAlerts=emAlerts, deviceEntryTable=deviceEntryTable, deviceName=deviceName, groupName=groupName, enterpriseManagement=enterpriseManagement, emGlobals=emGlobals, groupEntry=groupEntry, archiveSourceDevice=archiveSourceDevice, archiveEntry=archiveEntry, emDeviceClockSkew=emDeviceClockSkew, emDiskUsage=emDiskUsage, emSchedBackupFailed=emSchedBackupFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, emRaidDriveFailureDetected=emRaidDriveFailureDetected, imageVersion=imageVersion, emRefreshInterval=emRefreshInterval, groupEntryTable=groupEntryTable, emVersion=emVersion, archiveEntryTable=archiveEntryTable, emDeviceUnreachable=emDeviceUnreachable, deviceAddress=deviceAddress, emPerformanceThreshold=emPerformanceThreshold, emDeviceOfflineMode=emDeviceOfflineMode, deviceEntry=deviceEntry, emMemoryUsage=emMemoryUsage, emDevices=emDevices, emPerformanceStorageDays=emPerformanceStorageDays, deviceAddressType=deviceAddressType, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceGroups=emDeviceGroups, groupDescription=groupDescription, archiveVersion=archiveVersion, emAlertObjMsg=emAlertObjMsg, emImages=emImages, emHotfixInstallFailed=emHotfixInstallFailed, emScheduledArchiveFailed=emScheduledArchiveFailed, imageEntryTable=imageEntryTable, archiveFilename=archiveFilename, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, imageEntry=imageEntry, groupNumber=groupNumber, archiveTimeStamp=archiveTimeStamp, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emAlert=emAlert, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emCertificateExpiration=emCertificateExpiration, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, deviceNumber=deviceNumber, archiveNumber=archiveNumber, emArchives=emArchives)
