...
Integer32, ModuleIdentity, Bits, IpAddress, NotificationType, ObjectIdentity, Opaque, Counter32, iso, Unsigned32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Bits", "IpAddress", "NotificationType", "ObjectIdentity", "Opaque", "Counter32", "iso", "Unsigned32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emPerformanceThreshold=emPerformanceThreshold, emAlert=emAlert, archiveDescription=archiveDescription, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emHotfixInstallComplete=emHotfixInstallComplete, groupName=groupName, emCpuUsage=emCpuUsage, archiveProduct=archiveProduct, emScheduledArchiveFailed=emScheduledArchiveFailed, deviceAddress=deviceAddress, emDevices=emDevices, archiveEntry=archiveEntry, archiveVersion=archiveVersion, emHotfixInstallFailed=emHotfixInstallFailed, groupEntryTable=groupEntryTable, emPerformanceStorageCap=emPerformanceStorageCap, imageNumber=imageNumber, deviceEntry=deviceEntry, emAlertObjMsg=emAlertObjMsg, emDeviceActiveMode=emDeviceActiveMode, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceOfflineMode=emDeviceOfflineMode, archiveFilename=archiveFilename, emDeviceConfigSync=emDeviceConfigSync, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceImpaired=emDeviceImpaired, groupNumber=groupNumber, emRefreshInterval=emRefreshInterval, imageDescription=imageDescription, emAlertObjects=emAlertObjects, emDiskUsage=emDiskUsage, emDeviceStandbyMode=emDeviceStandbyMode, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emGlobals=emGlobals, groupEntry=groupEntry, emAlertConfigObjects=emAlertConfigObjects, emASMSigUpdateFailed=emASMSigUpdateFailed, emSoftwareInstallComplete=emSoftwareInstallComplete, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceList=emDeviceList, imageEntry=imageEntry, emHaSyncFailed=emHaSyncFailed, emASMSigInstallComplete=emASMSigInstallComplete, enterpriseManagement=enterpriseManagement, emDeviceClockSkew=emDeviceClockSkew, emCertificateExpiration=emCertificateExpiration, imageVersion=imageVersion, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceGroups=emDeviceGroups, emAlerts=emAlerts, emVersion=emVersion, emMemoryUsage=emMemoryUsage, emMaxConcurrentUpdates=emMaxConcurrentUpdates, imageEntryTable=imageEntryTable, archiveTimeStamp=archiveTimeStamp, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emPerformanceStorageDays=emPerformanceStorageDays, groupDescription=groupDescription, archiveEntryTable=archiveEntryTable, emServiceContractExpiry=emServiceContractExpiry, emArchives=emArchives, emImages=emImages, deviceNumber=deviceNumber, archiveNumber=archiveNumber, emSchedBackupFailed=emSchedBackupFailed, emDeviceUnreachable=emDeviceUnreachable, deviceEntryTable=deviceEntryTable, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emStatsCollectionRateCap=emStatsCollectionRateCap, emASMSigInstallFailed=emASMSigInstallFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, deviceName=deviceName, archiveSourceDevice=archiveSourceDevice, deviceAddressType=deviceAddressType)
