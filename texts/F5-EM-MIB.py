...
Unsigned32, IpAddress, Counter32, Bits, ObjectIdentity, ModuleIdentity, enterprises, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Integer32, TimeTicks, Gauge32, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter32", "Bits", "ObjectIdentity", "ModuleIdentity", "enterprises", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Integer32", "TimeTicks", "Gauge32", "Opaque")
...
mibBuilder.exportSymbols("F5-EM-MIB", emServiceContractExpiry=emServiceContractExpiry, deviceEntryTable=deviceEntryTable, archiveEntry=archiveEntry, archiveSourceDevice=archiveSourceDevice, emCpuUsage=emCpuUsage, emDeviceGroups=emDeviceGroups, emDeviceConfigSync=emDeviceConfigSync, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceOfflineMode=emDeviceOfflineMode, imageDescription=imageDescription, emDeviceUnreachable=emDeviceUnreachable, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveTimeStamp=archiveTimeStamp, emASMSigInstallFailed=emASMSigInstallFailed, archiveProduct=archiveProduct, deviceAddressType=deviceAddressType, emGlobals=emGlobals, archiveDescription=archiveDescription, emDevices=emDevices, deviceName=deviceName, emRefreshInterval=emRefreshInterval, imageVersion=imageVersion, emPerformanceThreshold=emPerformanceThreshold, emSchedBackupFailed=emSchedBackupFailed, emHotfixInstallFailed=emHotfixInstallFailed, groupName=groupName, emDeviceStandbyMode=emDeviceStandbyMode, emArchives=emArchives, emDiskUsage=emDiskUsage, emDeviceActiveMode=emDeviceActiveMode, emPerformanceStorageCap=emPerformanceStorageCap, deviceEntry=deviceEntry, enterpriseManagement=enterpriseManagement, PYSNMP_MODULE_ID=enterpriseManagement, deviceNumber=deviceNumber, emAlerts=emAlerts, emDeviceList=emDeviceList, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emAlertObjects=emAlertObjects, emHaSyncFailed=emHaSyncFailed, groupDescription=groupDescription, emPerformanceStorageDays=emPerformanceStorageDays, emAlertObjMsg=emAlertObjMsg, emGatherServiceContractFailure=emGatherServiceContractFailure, emHotfixInstallComplete=emHotfixInstallComplete, deviceAddress=deviceAddress, groupEntryTable=groupEntryTable, emSoftwareInstallFailed=emSoftwareInstallFailed, emASMSigUpdateFailed=emASMSigUpdateFailed, emAlert=emAlert, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceImpaired=emDeviceImpaired, emStatsCollectionRateCap=emStatsCollectionRateCap, archiveVersion=archiveVersion, imageNumber=imageNumber, emVersion=emVersion, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, archiveNumber=archiveNumber, imageEntry=imageEntry, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceClockSkew=emDeviceClockSkew, emRaidDriveFailureDetected=emRaidDriveFailureDetected, groupNumber=groupNumber, imageEntryTable=imageEntryTable, emCertificateExpiration=emCertificateExpiration, emASMSigInstallComplete=emASMSigInstallComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emAlertConfigObjects=emAlertConfigObjects, archiveEntryTable=archiveEntryTable, emImages=emImages, archiveFilename=archiveFilename, emMemoryUsage=emMemoryUsage, groupEntry=groupEntry, emStatsDBConnectivityLost=emStatsDBConnectivityLost)
