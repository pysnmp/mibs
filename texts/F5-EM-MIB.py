...
IpAddress, Counter64, TimeTicks, ModuleIdentity, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, enterprises, Opaque, MibIdentifier, Bits, Gauge32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "TimeTicks", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "enterprises", "Opaque", "MibIdentifier", "Bits", "Gauge32", "iso", "Integer32")
...
mibBuilder.exportSymbols("F5-EM-MIB", imageEntryTable=imageEntryTable, emHotfixInstallFailed=emHotfixInstallFailed, emPerformanceStorageDays=emPerformanceStorageDays, groupEntryTable=groupEntryTable, groupEntry=groupEntry, archiveEntryTable=archiveEntryTable, archiveProduct=archiveProduct, emVersion=emVersion, emMemoryUsage=emMemoryUsage, emDeviceActiveMode=emDeviceActiveMode, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emHaSyncFailed=emHaSyncFailed, emCpuUsage=emCpuUsage, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emAlerts=emAlerts, enterpriseManagement=enterpriseManagement, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveDescription=archiveDescription, emGlobals=emGlobals, archiveEntry=archiveEntry, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emImages=emImages, emStatsCollectionRateCap=emStatsCollectionRateCap, emRefreshInterval=emRefreshInterval, emScheduledArchiveFailed=emScheduledArchiveFailed, emSoftwareInstallComplete=emSoftwareInstallComplete, PYSNMP_MODULE_ID=enterpriseManagement, deviceEntry=deviceEntry, deviceAddress=deviceAddress, emDiskUsage=emDiskUsage, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, deviceAddressType=deviceAddressType, imageVersion=imageVersion, archiveNumber=archiveNumber, emDevices=emDevices, imageNumber=imageNumber, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, imageDescription=imageDescription, emAlertConfigObjects=emAlertConfigObjects, deviceName=deviceName, emDeviceClockSkew=emDeviceClockSkew, archiveSourceDevice=archiveSourceDevice, archiveVersion=archiveVersion, emPerformanceStorageCap=emPerformanceStorageCap, emSchedBackupFailed=emSchedBackupFailed, groupName=groupName, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emServiceContractExpiry=emServiceContractExpiry, emArchives=emArchives, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceImpaired=emDeviceImpaired, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emGatherServiceContractFailure=emGatherServiceContractFailure, emASMSigUpdateFailed=emASMSigUpdateFailed, deviceEntryTable=deviceEntryTable, emDeviceList=emDeviceList, emDeviceGroups=emDeviceGroups, archiveFilename=archiveFilename, deviceNumber=deviceNumber, emAlertObjects=emAlertObjects, emASMSigInstallFailed=emASMSigInstallFailed, emAlertObjMsg=emAlertObjMsg, emDeviceConfigSync=emDeviceConfigSync, emCertificateExpiration=emCertificateExpiration, groupDescription=groupDescription, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emAlert=emAlert, emSoftwareInstallFailed=emSoftwareInstallFailed, groupNumber=groupNumber, emDeviceUnreachable=emDeviceUnreachable, emDeviceStandbyMode=emDeviceStandbyMode, emPerformanceThreshold=emPerformanceThreshold, imageEntry=imageEntry, archiveTimeStamp=archiveTimeStamp)
