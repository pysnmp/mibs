...
ModuleIdentity, enterprises, iso, Gauge32, MibIdentifier, IpAddress, Counter32, Counter64, ObjectIdentity, NotificationType, TimeTicks, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "iso", "Gauge32", "MibIdentifier", "IpAddress", "Counter32", "Counter64", "ObjectIdentity", "NotificationType", "TimeTicks", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Integer32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emVersion=emVersion, deviceName=deviceName, emMaxConcurrentUpdates=emMaxConcurrentUpdates, enterpriseManagement=enterpriseManagement, emDeviceUnreachable=emDeviceUnreachable, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, deviceAddressType=deviceAddressType, emASMSigInstallFailed=emASMSigInstallFailed, emGlobals=emGlobals, groupDescription=groupDescription, emDeviceClockSkew=emDeviceClockSkew, imageVersion=imageVersion, PYSNMP_MODULE_ID=enterpriseManagement, archiveFilename=archiveFilename, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceOfflineMode=emDeviceOfflineMode, emCertificateExpiration=emCertificateExpiration, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emMemoryUsage=emMemoryUsage, emImages=emImages, emStatsCollectionRateCap=emStatsCollectionRateCap, emAlertConfigObjects=emAlertConfigObjects, groupName=groupName, deviceEntry=deviceEntry, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, deviceNumber=deviceNumber, archiveEntryTable=archiveEntryTable, emHotfixInstallFailed=emHotfixInstallFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, imageEntry=imageEntry, emDeviceConfigSync=emDeviceConfigSync, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emASMSigUpdateFailed=emASMSigUpdateFailed, emPerformanceStorageDays=emPerformanceStorageDays, emRefreshInterval=emRefreshInterval, groupNumber=groupNumber, archiveSourceDevice=archiveSourceDevice, emServiceContractExpiry=emServiceContractExpiry, groupEntry=groupEntry, archiveVersion=archiveVersion, archiveProduct=archiveProduct, emAlertObjMsg=emAlertObjMsg, emArchives=emArchives, deviceEntryTable=deviceEntryTable, emDiskUsage=emDiskUsage, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceGroups=emDeviceGroups, emASMSigInstallComplete=emASMSigInstallComplete, emPerformanceStorageCap=emPerformanceStorageCap, archiveTimeStamp=archiveTimeStamp, emDeviceActiveMode=emDeviceActiveMode, emDevices=emDevices, emDeviceImpaired=emDeviceImpaired, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emHaSyncFailed=emHaSyncFailed, emAlertObjects=emAlertObjects, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceList=emDeviceList, imageEntryTable=imageEntryTable, imageDescription=imageDescription, emSoftwareInstallFailed=emSoftwareInstallFailed, emSoftwareInstallComplete=emSoftwareInstallComplete, emSchedBackupFailed=emSchedBackupFailed, archiveDescription=archiveDescription, emAlerts=emAlerts, deviceAddress=deviceAddress, imageNumber=imageNumber, emAlert=emAlert, emPerformanceThreshold=emPerformanceThreshold, archiveEntry=archiveEntry, archiveNumber=archiveNumber, emDeviceStandbyMode=emDeviceStandbyMode, emCpuUsage=emCpuUsage, groupEntryTable=groupEntryTable)
