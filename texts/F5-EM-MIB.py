...
mibBuilder.exportSymbols("F5-EM-MIB", PYSNMP_MODULE_ID=enterpriseManagement, emSoftwareInstallFailed=emSoftwareInstallFailed, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emCertificateExpiration=emCertificateExpiration, emHaSyncFailed=emHaSyncFailed, emDeviceList=emDeviceList, groupEntry=groupEntry, archiveEntryTable=archiveEntryTable, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, deviceNumber=deviceNumber, deviceEntryTable=deviceEntryTable, archiveEntry=archiveEntry, emServiceContractExpiry=emServiceContractExpiry, emDeviceGroups=emDeviceGroups, emDeviceConfigSync=emDeviceConfigSync, emDeviceOfflineMode=emDeviceOfflineMode, emAlert=emAlert, emRefreshInterval=emRefreshInterval, emHotfixInstallComplete=emHotfixInstallComplete, emVersion=emVersion, emMemoryUsage=emMemoryUsage, deviceEntry=deviceEntry, archiveProduct=archiveProduct, archiveTimeStamp=archiveTimeStamp, emDevices=emDevices, emGlobals=emGlobals, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emSoftwareInstallComplete=emSoftwareInstallComplete, imageNumber=imageNumber, imageVersion=imageVersion, emGatherServiceContractFailure=emGatherServiceContractFailure, groupNumber=groupNumber, emDeviceActiveMode=emDeviceActiveMode, archiveSourceDevice=archiveSourceDevice, imageDescription=imageDescription, archiveFilename=archiveFilename, emPerformanceStorageDays=emPerformanceStorageDays, emDiskUsage=emDiskUsage, emAlerts=emAlerts, emASMSigInstallComplete=emASMSigInstallComplete, emPerformanceThreshold=emPerformanceThreshold, enterpriseManagement=enterpriseManagement, groupEntryTable=groupEntryTable, archiveDescription=archiveDescription, emArchives=emArchives, groupDescription=groupDescription, emDeviceStandbyMode=emDeviceStandbyMode, deviceAddress=deviceAddress, emAlertObjMsg=emAlertObjMsg, emASMSigUpdateAvailable=emASMSigUpdateAvailable, groupName=groupName, deviceAddressType=deviceAddressType, emDeviceUnreachable=emDeviceUnreachable, emHotfixInstallFailed=emHotfixInstallFailed, emASMSigUpdateFailed=emASMSigUpdateFailed, emCpuUsage=emCpuUsage, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emImages=emImages, emDeviceImpaired=emDeviceImpaired, emAlertObjects=emAlertObjects, deviceName=deviceName, imageEntryTable=imageEntryTable, archiveNumber=archiveNumber, emStatsCollectionRateCap=emStatsCollectionRateCap, archiveVersion=archiveVersion, emDeviceClockSkew=emDeviceClockSkew, emScheduledArchiveFailed=emScheduledArchiveFailed, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emASMSigInstallFailed=emASMSigInstallFailed, emPerformanceStorageCap=emPerformanceStorageCap, emAlertConfigObjects=emAlertConfigObjects, imageEntry=imageEntry, emSchedBackupFailed=emSchedBackupFailed)
