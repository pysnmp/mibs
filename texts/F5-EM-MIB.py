...
ObjectIdentity, Bits, Gauge32, iso, enterprises, Counter64, Unsigned32, IpAddress, MibIdentifier, NotificationType, Opaque, TimeTicks, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Gauge32", "iso", "enterprises", "Counter64", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "Opaque", "TimeTicks", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emCpuUsage=emCpuUsage, emAlert=emAlert, deviceAddress=deviceAddress, groupEntry=groupEntry, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emPerformanceThreshold=emPerformanceThreshold, emAlertObjects=emAlertObjects, archiveProduct=archiveProduct, emHotfixInstallFailed=emHotfixInstallFailed, emRefreshInterval=emRefreshInterval, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceConfigSync=emDeviceConfigSync, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emGatherServiceContractFailure=emGatherServiceContractFailure, enterpriseManagement=enterpriseManagement, deviceEntryTable=deviceEntryTable, emServiceContractExpiry=emServiceContractExpiry, emAlertConfigObjects=emAlertConfigObjects, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveFilename=archiveFilename, emDeviceList=emDeviceList, emASMSigInstallFailed=emASMSigInstallFailed, archiveEntry=archiveEntry, emArchives=emArchives, imageEntry=imageEntry, emDeviceActiveMode=emDeviceActiveMode, emStatsCollectionRateCap=emStatsCollectionRateCap, emSoftwareInstallComplete=emSoftwareInstallComplete, emAlerts=emAlerts, emVersion=emVersion, imageDescription=imageDescription, emASMSigUpdateFailed=emASMSigUpdateFailed, emMemoryUsage=emMemoryUsage, emGlobals=emGlobals, imageVersion=imageVersion, emAlertObjMsg=emAlertObjMsg, emDeviceStandbyMode=emDeviceStandbyMode, archiveDescription=archiveDescription, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceStorageDays=emPerformanceStorageDays, emDeviceGroups=emDeviceGroups, groupNumber=groupNumber, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, deviceAddressType=deviceAddressType, emImages=emImages, groupDescription=groupDescription, emDiskUsage=emDiskUsage, PYSNMP_MODULE_ID=enterpriseManagement, emCertificateExpiration=emCertificateExpiration, imageNumber=imageNumber, emScheduledArchiveFailed=emScheduledArchiveFailed, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceImpaired=emDeviceImpaired, archiveSourceDevice=archiveSourceDevice, emSchedBackupFailed=emSchedBackupFailed, groupName=groupName, deviceNumber=deviceNumber, archiveNumber=archiveNumber, archiveEntryTable=archiveEntryTable, archiveVersion=archiveVersion, imageEntryTable=imageEntryTable, archiveTimeStamp=archiveTimeStamp, emDeviceUnreachable=emDeviceUnreachable, emHaSyncFailed=emHaSyncFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDevices=emDevices, deviceName=deviceName, groupEntryTable=groupEntryTable, emDeviceOfflineMode=emDeviceOfflineMode, deviceEntry=deviceEntry, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceClockSkew=emDeviceClockSkew)
