...
Counter32, Gauge32, IpAddress, ModuleIdentity, ObjectIdentity, MibIdentifier, enterprises, iso, Unsigned32, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Opaque, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "enterprises", "iso", "Unsigned32", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Opaque", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveDescription=archiveDescription, emSoftwareInstallFailed=emSoftwareInstallFailed, emCertificateExpiration=emCertificateExpiration, emMemoryUsage=emMemoryUsage, emHaSyncFailed=emHaSyncFailed, archiveEntryTable=archiveEntryTable, emHotfixInstallFailed=emHotfixInstallFailed, deviceEntryTable=deviceEntryTable, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveProduct=archiveProduct, emGlobals=emGlobals, PYSNMP_MODULE_ID=enterpriseManagement, imageEntry=imageEntry, emAlertConfigObjects=emAlertConfigObjects, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, groupEntry=groupEntry, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceStandbyMode=emDeviceStandbyMode, archiveEntry=archiveEntry, archiveNumber=archiveNumber, emSoftwareInstallComplete=emSoftwareInstallComplete, emImages=emImages, emDeviceList=emDeviceList, emPerformanceStorageDays=emPerformanceStorageDays, emStatsDBConnectivityLost=emStatsDBConnectivityLost, groupNumber=groupNumber, groupEntryTable=groupEntryTable, emPerformanceThreshold=emPerformanceThreshold, archiveVersion=archiveVersion, emServiceContractExpiry=emServiceContractExpiry, emPerformanceStorageCap=emPerformanceStorageCap, imageVersion=imageVersion, emAlert=emAlert, emRefreshInterval=emRefreshInterval, emDevices=emDevices, deviceName=deviceName, archiveFilename=archiveFilename, imageDescription=imageDescription, archiveSourceDevice=archiveSourceDevice, emDeviceConfigSync=emDeviceConfigSync, emDeviceImpaired=emDeviceImpaired, emDiskUsage=emDiskUsage, deviceNumber=deviceNumber, emAlerts=emAlerts, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emVersion=emVersion, deviceAddress=deviceAddress, deviceAddressType=deviceAddressType, emCpuUsage=emCpuUsage, emScheduledArchiveFailed=emScheduledArchiveFailed, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emSchedBackupFailed=emSchedBackupFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, groupName=groupName, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceEntry=deviceEntry, emArchives=emArchives, emDeviceActiveMode=emDeviceActiveMode, emDeviceClockSkew=emDeviceClockSkew, emASMSigUpdateFailed=emASMSigUpdateFailed, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emAlertObjects=emAlertObjects, archiveTimeStamp=archiveTimeStamp, emAlertObjMsg=emAlertObjMsg, emDeviceUnreachable=emDeviceUnreachable, emDeviceOfflineMode=emDeviceOfflineMode, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, imageEntryTable=imageEntryTable, groupDescription=groupDescription, emASMSigInstallComplete=emASMSigInstallComplete, imageNumber=imageNumber, emDeviceGroups=emDeviceGroups, enterpriseManagement=enterpriseManagement)
