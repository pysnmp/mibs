...
MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, enterprises, Integer32, iso, ObjectIdentity, IpAddress, Gauge32, MibIdentifier, Unsigned32, Counter64, ModuleIdentity, Counter32, Bits, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "enterprises", "Integer32", "iso", "ObjectIdentity", "IpAddress", "Gauge32", "MibIdentifier", "Unsigned32", "Counter64", "ModuleIdentity", "Counter32", "Bits", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("F5-EM-MIB", PYSNMP_MODULE_ID=enterpriseManagement, emDeviceImpaired=emDeviceImpaired, imageDescription=imageDescription, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emAlertObjMsg=emAlertObjMsg, emRaidDriveFailureDetected=emRaidDriveFailureDetected, deviceAddressType=deviceAddressType, groupEntry=groupEntry, emDeviceOfflineMode=emDeviceOfflineMode, imageEntryTable=imageEntryTable, emSchedBackupFailed=emSchedBackupFailed, archiveTimeStamp=archiveTimeStamp, imageNumber=imageNumber, emDeviceList=emDeviceList, emSoftwareInstallComplete=emSoftwareInstallComplete, emDiskUsage=emDiskUsage, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emDeviceClockSkew=emDeviceClockSkew, deviceName=deviceName, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, deviceEntry=deviceEntry, emMemoryUsage=emMemoryUsage, emDeviceGroups=emDeviceGroups, deviceAddress=deviceAddress, archiveProduct=archiveProduct, emHotfixInstallFailed=emHotfixInstallFailed, emServiceContractExpiry=emServiceContractExpiry, emAlertConfigObjects=emAlertConfigObjects, groupName=groupName, enterpriseManagement=enterpriseManagement, groupDescription=groupDescription, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emPerformanceStorageCap=emPerformanceStorageCap, emArchives=emArchives, deviceNumber=deviceNumber, emAlertObjects=emAlertObjects, groupNumber=groupNumber, emASMSigInstallFailed=emASMSigInstallFailed, emGlobals=emGlobals, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveEntryTable=archiveEntryTable, emImages=emImages, deviceEntryTable=deviceEntryTable, groupEntryTable=groupEntryTable, emRefreshInterval=emRefreshInterval, emPerformanceThreshold=emPerformanceThreshold, emGatherServiceContractFailure=emGatherServiceContractFailure, emAlerts=emAlerts, archiveFilename=archiveFilename, emMaxConcurrentUpdates=emMaxConcurrentUpdates, archiveDescription=archiveDescription, imageVersion=imageVersion, emHaSyncFailed=emHaSyncFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceStandbyMode=emDeviceStandbyMode, emASMSigInstallComplete=emASMSigInstallComplete, imageEntry=imageEntry, archiveSourceDevice=archiveSourceDevice, emVersion=emVersion, emPerformanceStorageDays=emPerformanceStorageDays, archiveEntry=archiveEntry, emAlert=emAlert, emSoftwareInstallFailed=emSoftwareInstallFailed, emCpuUsage=emCpuUsage, emDeviceActiveMode=emDeviceActiveMode, emCertificateExpiration=emCertificateExpiration, archiveVersion=archiveVersion, emDeviceUnreachable=emDeviceUnreachable, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveNumber=archiveNumber, emDevices=emDevices, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceConfigSync=emDeviceConfigSync)
