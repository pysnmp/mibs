...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Bits, TimeTicks, Gauge32, Counter32, ObjectIdentity, MibIdentifier, ModuleIdentity, Integer32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Bits", "TimeTicks", "Gauge32", "Counter32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Integer32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("ALCATEL-IND1-TIMETRA-TC-MIB", PYSNMP_MODULE_ID=timetraTCMIBModule, TmnxVRtrIDOrZero=TmnxVRtrIDOrZero, TmnxMldVersion=TmnxMldVersion, TmnxIgmpVersion=TmnxIgmpVersion, TNamedItemOrEmpty=TNamedItemOrEmpty, TmnxIgmpGroupFilterMode=TmnxIgmpGroupFilterMode, TLspExpValue=TLspExpValue, TmnxEncapVal=TmnxEncapVal, TPIRRateOverride=TPIRRateOverride, TQueueId=TQueueId, TmnxBgpLocalPreference=TmnxBgpLocalPreference, TDSCPNameOrEmpty=TDSCPNameOrEmpty, TmnxSubProfileStringOrEmpty=TmnxSubProfileStringOrEmpty, SdpBindId=SdpBindId, TCpmProtPolicyID=TCpmProtPolicyID, TDSCPValue=TDSCPValue, TmnxMldGroupType=TmnxMldGroupType, TmnxVRtrID=TmnxVRtrID, TmnxAncpStringOrZero=TmnxAncpStringOrZero, TmnxBgpAutonomousSystem=TmnxBgpAutonomousSystem, TSapEgressPolicyID=TSapEgressPolicyID, InterfaceIndex=InterfaceIndex, TmnxTunnelID=TmnxTunnelID, TPortSchedulerCIR=TPortSchedulerCIR, TDSCPName=TDSCPName, TmnxAncpString=TmnxAncpString, TmnxVcType=TmnxVcType, TmnxAdminState=TmnxAdminState, ServiceAdminStatus=ServiceAdminStatus, TItemLongDescription=TItemLongDescription, TFCNameOrEmpty=TFCNameOrEmpty, TNamedItem=TNamedItem, TIpOption=TIpOption, TmnxSubIdentStringOrEmpty=TmnxSubIdentStringOrEmpty, ServiceAccessPoint=ServiceAccessPoint, TmnxSubMgtIntDestIdOrEmpty=TmnxSubMgtIntDestIdOrEmpty, TmnxVcIdOrNone=TmnxVcIdOrNone, TFCSet=TFCSet, TmnxPppoeUserNameOrEmpty=TmnxPppoeUserNameOrEmpty, TMlpppQoSProfileId=TMlpppQoSProfileId, TFrameType=TFrameType, TmnxVcId=TmnxVcId, TmnxBgpRouteTarget=TmnxBgpRouteTarget, TTcpUdpPort=TTcpUdpPort, TmnxStatus=TmnxStatus, TmnxMldGroupFilterMode=TmnxMldGroupFilterMode, Dot1PPriority=Dot1PPriority, TmnxSlaProfileString=TmnxSlaProfileString, TCIRRate=TCIRRate, TmnxCustId=TmnxCustId, TmnxEnabledDisabled=TmnxEnabledDisabled, TSecondaryShaper10GPIRRate=TSecondaryShaper10GPIRRate, TmnxDHCP6MsgType=TmnxDHCP6MsgType, TmnxTunnelType=TmnxTunnelType, QTag=QTag, TmnxPortID=TmnxPortID, TmnxBgpPreference=TmnxBgpPreference, TEgressQueueId=TEgressQueueId, TPolicyID=TPolicyID, TmnxOspfInstance=TmnxOspfInstance, TmnxVRtrMplsLspID=TmnxVRtrMplsLspID, TmnxSlaProfileStringOrEmpty=TmnxSlaProfileStringOrEmpty, TFCType=TFCType, IpAddressPrefixLength=IpAddressPrefixLength, TmnxManagedRouteStatus=TmnxManagedRouteStatus, TFCName=TFCName, TmnxAppProfileString=TmnxAppProfileString, TmnxSubIdentString=TmnxSubIdentString, TmnxVPNRouteDistinguisher=TmnxVPNRouteDistinguisher, TmnxDhcpVendorOption=TmnxDhcpVendorOption, TPortSchedulerPIR=TPortSchedulerPIR, TWeight=TWeight, TSapIngressPolicyID=TSapIngressPolicyID, ServiceOperStatus=ServiceOperStatus, TItemDescription=TItemDescription, TmnxStrSapId=TmnxStrSapId, TDSCPFilterActionValue=TDSCPFilterActionValue, TPIRRate=TPIRRate, TmnxDhcpOptionType=TmnxDhcpOptionType, TmnxServId=TmnxServId, TmnxOperState=TmnxOperState, TmnxActionType=TmnxActionType, TmnxMulticastAddrFamily=TmnxMulticastAddrFamily, TmnxSubMgtIntDestId=TmnxSubMgtIntDestId, TTcpUdpPortOperator=TTcpUdpPortOperator, TIngressQueueId=TIngressQueueId, TmnxBGPFamilyType=TmnxBGPFamilyType, TDSCPValueOrNone=TDSCPValueOrNone, timetraTCMIBModule=timetraTCMIBModule, TPIRRateOrZero=TPIRRateOrZero, TIpProtocol=TIpProtocol, QTagOrZero=QTagOrZero, TmnxIgmpGroupType=TmnxIgmpGroupType, TmnxSubProfileString=TmnxSubProfileString, TPolicyStatementNameOrEmpty=TPolicyStatementNameOrEmpty, TmnxAppProfileStringOrEmpty=TmnxAppProfileStringOrEmpty)
