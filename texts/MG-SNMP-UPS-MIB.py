...
NotificationType, NotificationType, MibIdentifier, iso, ModuleIdentity, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, TimeTicks, enterprises, IpAddress, Counter32, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "MibIdentifier", "iso", "ModuleIdentity", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "TimeTicks", "enterprises", "IpAddress", "Counter32", "Integer32", "Gauge32")
...
if mibBuilder.loadTexts: mgmanagerIndex.setDescription('A unique value for each manager. Its value ranges between 1\n                and the value of upsmgManagersNum.')
...
if mibBuilder.loadTexts: mgmanagerDeviceNumber.setDescription('This object is the number of the manager device in the\n                DevicesTable of the Config group. This means that the\n                manager is powered by the UPS. If not the default value is 0.')
...
if mibBuilder.loadTexts: mgmanagerDescr.setDescription('A textual string containing information about the manager.\n                (manufacturer and version description).')
...
if mibBuilder.loadTexts: mgmanagerAddress.setDescription('The IP address of the manager station receiving traps. The\n                value of this object is meaningful if and only if the value\n                of the relevant mgmanagerCommType object is snmp type.')
...
if mibBuilder.loadTexts: mgreceptacleIndex.setDescription('A unique value for each receptacle. Its value ranges between\n                1 and the value of upsmgReceptaclesNum.')
...
if mibBuilder.loadTexts: mgreceptaclePowerCons.setDescription('The volt-ampere rating of the receptacle.\n\n                The value of this object is meaningful if and only if the value\n                of the relevant mgreceptacleType object is related to a two-level\n                receptacle class. Otherwise the default value is 0.')
...
if mibBuilder.loadTexts: mgreceptacleOverload.setDescription('The overload status of the receptacle.\n\n                The value of this object is meaningful if and only if the value\n                of the relevant mgreceptacleType object is related to a two-level\n                receptacle class. Otherwise the default value is 0.')
...
if mibBuilder.loadTexts: mgreceptacleAutonomy.setDescription('The receptacle autonomy.\n\n                The value of this object is meaningful if and only if the value\n                of the relevant mgreceptacleType object is related to a two-level\n                receptacle class. Otherwise the default value is 0.')
...
if mibBuilder.loadTexts: upsmgConfigNominalRechargeTime.setDescription('The recharge time to go from low battery cut off\n                to full charge at full load.')
...
if mibBuilder.loadTexts: upsmgConfigMinRechargeLevel.setDescription('The minimum battery level required to supply power on the\n                 loads after low battery condition turn off and restart on\n                 main return.')
...
if mibBuilder.loadTexts: upsmgConfigMaxRechargeTime.setDescription('The maximum time delay of battery recharge before supply\n                power to the loads.')
...
if mibBuilder.loadTexts: mgdeviceIndex.setDescription('A unique value for each device. Its value ranges between 1\n                and the value of upsmgDevicesNum.')
...
if mibBuilder.loadTexts: mgdeviceReceptacleNum.setDescription('The receptacle number of the device plugged into the UPS.\n                This value gives index entry in the ReceptaclesTable object\n                of the Receptacle group. A value of 0 invalidates the entry\n                in the DevicesTable.')
...
if mibBuilder.loadTexts: mgdeviceShutdownDuration.setDescription('To set the duration from start of computer shut-down\n                to complete.')
...
if mibBuilder.loadTexts: mgdeviceBootUpDuration.setDescription('To set the duration from start of computer boot-up\n                to complete.')
...
if mibBuilder.loadTexts: mgreceptacleIndexb.setDescription('A unique value for each receptacle. Its value ranges between 1\n                and the value of upsmgReceptaclesNum.')
...
if mibBuilder.loadTexts: upsmgConfigExtAlarmNum.setDescription('The number of environ external alarm, value is\n                  between 8 and 32..')
...
if mibBuilder.loadTexts: mgextAlarmIndex.setDescription('A unique value for each external alarm. Its value ranges\n                between 1 and the value of upsmgConfigExtAlarmNum.')
...
if mibBuilder.loadTexts: mgcontrolDayIndex.setDescription('The day index. It is a number between 1 and 7, 1 for\n                Sunday, 2 for Monday, ...')
...
if mibBuilder.loadTexts: mgcontrolDayOn.setDescription('To set daily power on time. Any value greater than 86400\n                is to disable the Day On.')
...
if mibBuilder.loadTexts: mgcontrolDayOff.setDescription('To set daily power off time. Any value greater than 86400\n                is to disable the Day Off.')
...
if mibBuilder.loadTexts: upsmgBatteryFullRechargeTime.setDescription('The battery full recharge time (from 0 to 100 percent)\n                at current load.')
...
if mibBuilder.loadTexts: mginputIndex.setDescription('The input phase voltage index. It is a number between 1\n                and upsmgInputPhaseNum.')
...
if mibBuilder.loadTexts: mgoutputPhaseIndex.setDescription('The output phase voltage index. It is a number between 1\n                and upsmgOutputPhaseNum.')
...
if mibBuilder.loadTexts: mgalarmNum.setDescription('The external alarm number. A number between 1 and\n                upsmgConfigExtAlarmNum.')
...
if mibBuilder.loadTexts: mgreceptacleIndexc.setDescription('A unique value for each receptacle. Its value ranges between 1\n                and the value of upsmgReceptaclesNum.')
...
if mibBuilder.loadTexts: upsmgControlDayOff.setDescription('The schedule off control object. Default value is none(8).\n                Value 1 means to start scheduled off on Sunday,\n                value 2 to start scheduled off on Monday, and so on.')
...
if mibBuilder.loadTexts: upsRedundancyLost.setDescription('Redundancy Lost.')
upsRedundancyOK = NotificationType((1, 3, 6, 1, 4, 1, 705, 1, 11) + (0,66))
if mibBuilder.loadTexts: upsRedundancyOK.setDescription('Redundancy Recovered.')
upsProtectionLost = NotificationType((1, 3, 6, 1, 4, 1, 705, 1, 11) + (0,67))
if mibBuilder.loadTexts: upsProtectionLost.setDescription('Protection Lost.')
upsProtectionOK = NotificationType((1, 3, 6, 1, 4, 1, 705, 1, 11) + (0,68))
if mibBuilder.loadTexts: upsProtectionOK.setDescription('Protection Recovered.')
...
if mibBuilder.loadTexts: upsmgAgentIpaddress.setDescription(' The ip address that NMS can identify the managed\n                device')
...
if mibBuilder.loadTexts: upsmgAgentDefGateway.setDescription(' The default gateway that allow device managed\n                through routers ')
...
if mibBuilder.loadTexts: upsmgAgentBaudRate.setDescription(' the serial port communication speed. only 2400,\n                4800, and 9600 allowed')
...
if mibBuilder.loadTexts: upsmgAgentPollRate.setDescription(' The frequency that proxy agent polls the connected\n                UPS in ASCII protocol. (unit : second)')
...
if mibBuilder.loadTexts: upsmgAgentTrapAlarmDelay.setDescription(' The interval for the Trap packet retransmission,\n                while the TRAP Acknowledge is implemented and\n                the ack is received within the interval.')
...
if mibBuilder.loadTexts: upsmgAgentTrapAlarmRetry.setDescription(' The retry count for retransmitting Trap\n                 packet while the TRAP acknowledge is\n                 implemented.')
...
if mibBuilder.loadTexts: upsmgAgentAutoLearning.setDescription(' The enabled/disabled configuration of the Auto Learning\n                process of the agent, default value is yes(1) e.g. enabled.')
...
if mibBuilder.loadTexts: upsmgAgentBootP.setDescription(' The enabled/disabled configuration of the BootP process,\n                default value is yes(1) e.g. enabled.')
...
if mibBuilder.loadTexts: upsmgAgentTFTP.setDescription(' The enabled/disabled configuration of the TFTP process,\n                default value is no(2) e.g. disabled.')
...
if mibBuilder.loadTexts: upsmgRemoteOnBattery.setDescription('An object to inform an ups-less agent that the remote\n                 UPS is on autonomy. This object could be set by\n                 a management application.')
...
if mibBuilder.loadTexts: upsmgRemoteIpAddress.setDescription('An object to give the IP address of the agent managing\n                 the remote UPS. This object could be read by managers\n                 to perform management of receptacle dependencies\n                 between two different agents.')
mibBuilder.exportSymbols("MG-SNMP-UPS-MIB", upsmgToggleToStart=upsmgToggleToStart, upsmgAgentTFTP=upsmgAgentTFTP, mgsensorTemp=mgsensorTemp, mgreceptacleOffCtrl=mgreceptacleOffCtrl, upsmgEnvironmentTemperatureHigh=upsmgEnvironmentTemperatureHigh, upsmgBatteryRechargeLevel=upsmgBatteryRechargeLevel, upsmgUtilityFailure=upsmgUtilityFailure, upsmgOutputPhaseTable=upsmgOutputPhaseTable, upsmgConfigHumidityLow=upsmgConfigHumidityLow, mgreceptacleType=mgreceptacleType, mgreceptacleBootUpDuration=mgreceptacleBootUpDuration, mgmanagerDeviceNumber=mgmanagerDeviceNumber, upsmgEnvironTemperatureOK=upsmgEnvironTemperatureOK, upsmgConfigHumidityHigh=upsmgConfigHumidityHigh, upsmgUtilityRestored=upsmgUtilityRestored, upsmgBatteryFault=upsmgBatteryFault, upsmgOffToStart=upsmgOffToStart, upsmgReturnFromBattery=upsmgReturnFromBattery, upsmgAgentTrapAlarmRetry=upsmgAgentTrapAlarmRetry, mginputIndex=mginputIndex, upsmgConfigEmergencyTestFail=upsmgConfigEmergencyTestFail, upsmgEnvironComOK=upsmgEnvironComOK, mgdeviceVaRating=mgdeviceVaRating, upsmgFromLowCondition=upsmgFromLowCondition, upsmgDiagnosticTestOK=upsmgDiagnosticTestOK, upsmgConfigReceptaclesTable=upsmgConfigReceptaclesTable, upsmgConfigHighTransfer=upsmgConfigHighTransfer, mgreceptacleIndex=mgreceptacleIndex, upsmgTestCommandLine=upsmgTestCommandLine, upsmgManagersNum=upsmgManagersNum, upsmgBatteryCurrent=upsmgBatteryCurrent, upsmgConfigInput2Name=upsmgConfigInput2Name, upsmgConfigSensorName=upsmgConfigSensorName, upsmgBatteryLowBattery=upsmgBatteryLowBattery, upsmgConfigHighBooster=upsmgConfigHighBooster, mgreceptacleLevel=mgreceptacleLevel, upsmgRemoteOnBattery=upsmgRemoteOnBattery, upsmgReturnFromByPass=upsmgReturnFromByPass, mgreceptacleShutoffLevel=mgreceptacleShutoffLevel, mginputMinimumVoltage=mginputMinimumVoltage, upsmgTestBatteryCalibration=upsmgTestBatteryCalibration, upsProtectionLost=upsProtectionLost, upsmgConfig=upsmgConfig, mgdeviceBootUpDuration=mgdeviceBootUpDuration, mgreceptacleOffDelay=mgreceptacleOffDelay, mgoutputLoadPerPhase=mgoutputLoadPerPhase, upsmgTemperatureOK=upsmgTemperatureOK, upsmgToggleInProgress=upsmgToggleInProgress, mgmanagerTrapAck=mgmanagerTrapAck, mgreceptacleAutonomy=mgreceptacleAutonomy, upsmgReceptaclesNum=upsmgReceptaclesNum, upsmgEnvironTemperatureHigh=upsmgEnvironTemperatureHigh, upsmgEnvironInput1Closed=upsmgEnvironInput1Closed, upsmgByPassAvailable=upsmgByPassAvailable, mgreceptacleShutoffTimer=mgreceptacleShutoffTimer, upsmgBatteryLowCondition=upsmgBatteryLowCondition, upsmgBatteryAvailable=upsmgBatteryAvailable, upsmgConfigEnvironmentTable=upsmgConfigEnvironmentTable, upsmgFromLowRecharge=upsmgFromLowRecharge, upsmgEnvironmentTemperature=upsmgEnvironmentTemperature, upsmgControlReceptaclesEntry=upsmgControlReceptaclesEntry, upsmgControlReceptaclesTable=upsmgControlReceptaclesTable, mgmanagerCommunity=mgmanagerCommunity, upsmgAgentAutoLearning=upsmgAgentAutoLearning, upsmgReturnFromBoost=upsmgReturnFromBoost, mgreceptacleOnDelay=mgreceptacleOnDelay, mgcontrolDayOn=mgcontrolDayOn, upsmgTestCommandReady=upsmgTestCommandReady, upsmgLoadOK=upsmgLoadOK, upsmgConfigEnvironmentEntry=upsmgConfigEnvironmentEntry, upsmgIdentModelName=upsmgIdentModelName, upsmgOnAbort=upsmgOnAbort, upsmgEnvironmentTemperatureLow=upsmgEnvironmentTemperatureLow, upsmgEnvironmentComFailure=upsmgEnvironmentComFailure, mgreceptacleOffStatus=mgreceptacleOffStatus, upsmgAgentIpaddress=upsmgAgentIpaddress, mgextAlarmIndex=mgextAlarmIndex, upsmgTraps=upsmgTraps, upsmgEnvironmentHumidityHigh=upsmgEnvironmentHumidityHigh, upsmgTestDiagnostics=upsmgTestDiagnostics, upsmgConfigAlarmAudible=upsmgConfigAlarmAudible, upsmgConfigExtAlarmEntry=upsmgConfigExtAlarmEntry, upsProtectionOK=upsProtectionOK, upsmgAgentPollRate=upsmgAgentPollRate, upsmgEnvironComFailure=upsmgEnvironComFailure, upsmgTestDiagResult=upsmgTestDiagResult, mgmanagerIndex=mgmanagerIndex, upsmgEnvironAmbientTemp=upsmgEnvironAmbientTemp, upsmgConfigLowFader=upsmgConfigLowFader, upsmgEnvironHumidityHigh=upsmgEnvironHumidityHigh, upsmgToggleComplete=upsmgToggleComplete, upsmgConfigControlDayEntry=upsmgConfigControlDayEntry, mgoutputFrequency=mgoutputFrequency, upsmgConfigDevicesNum=upsmgConfigDevicesNum, upsmgConfigNominalRechargeTime=upsmgConfigNominalRechargeTime, upsmgInputLineFailCause=upsmgInputLineFailCause, upsmgConfigSensorIndex=upsmgConfigSensorIndex, upsmgAtLowCondition=upsmgAtLowCondition, upsmgOffAbort=upsmgOffAbort, upsmgEnvironAmbientHumidity=upsmgEnvironAmbientHumidity, mginputCurrent=mginputCurrent, upsmgConfigVARating=upsmgConfigVARating, upsmgOnByPass=upsmgOnByPass, upsmgTestResponseReady=upsmgTestResponseReady, mginputVoltage=mginputVoltage, upsmgIdentSerialNumber=upsmgIdentSerialNumber, upsmgConfigInput1OpenLabel=upsmgConfigInput1OpenLabel, mgsensorNum=mgsensorNum, mgreceptacleOnCtrl=mgreceptacleOnCtrl, upsmgOnBattery=upsmgOnBattery, upsmgAgentReset=upsmgAgentReset, upsRedundancyLost=upsRedundancyLost, upsmgBatteryTestFail=upsmgBatteryTestFail, mgcontrolDayIndex=mgcontrolDayIndex, upsmgOnBuck=upsmgOnBuck, upsmgInputPhaseEntry=upsmgInputPhaseEntry, upsmgConfigBatteryInstalled=upsmgConfigBatteryInstalled, upsmgConfigControlDayTable=upsmgConfigControlDayTable, upsmgConfigTemperatureHigh=upsmgConfigTemperatureHigh, mgmanagerAddress=mgmanagerAddress, upsmgAgentSubnetMask=upsmgAgentSubnetMask, upsmgBatteryChargerFault=upsmgBatteryChargerFault, upsmgConfigLowBatteryLevel=upsmgConfigLowBatteryLevel, upsmgConfigEmergencyOnByPass=upsmgConfigEmergencyOnByPass, upsmgBatteryFaultBattery=upsmgBatteryFaultBattery, upsmgOnBoost=upsmgOnBoost, upsmgIdentUserID=upsmgIdentUserID, upsmgOutput=upsmgOutput, mgdeviceSequenceOn=mgdeviceSequenceOn, upsmgBatteryReplaceNotIndicated=upsmgBatteryReplaceNotIndicated, upsmgAgentType=upsmgAgentType, upsmgReceptaclesEntry=upsmgReceptaclesEntry, upsmgEnvironHumidityOK=upsmgEnvironHumidityOK, upsmgExternalAlarmActive=upsmgExternalAlarmActive, upsmgToggleAbort=upsmgToggleAbort, mgdeviceIndex=mgdeviceIndex, upsmgInputOK=upsmgInputOK, upsmgOutputInverterOff=upsmgOutputInverterOff, upsmgOutputOnBuck=upsmgOutputOnBuck, upsmgConfigInput2OpenLabel=upsmgConfigInput2OpenLabel, upsmgBatteryNoBattery=upsmgBatteryNoBattery, upsmgConfigExtAlarmNum=upsmgConfigExtAlarmNum, upsmgTestBatteryResult=upsmgTestBatteryResult, upsmgEnvironExtAlarmTable=upsmgEnvironExtAlarmTable, upsmgAgent=upsmgAgent, mgreceptacleStateMainReturn=mgreceptacleStateMainReturn, upsmgRemoteIpAddress=upsmgRemoteIpAddress, mginputMaximumVoltage=mginputMaximumVoltage, upsmgReceptaclesTable=upsmgReceptaclesTable, upsmgBatteryVoltage=upsmgBatteryVoltage, upsmgConfigExtAlarmTable=upsmgConfigExtAlarmTable, upsmgOnToStart=upsmgOnToStart, upsmgOverTemperature=upsmgOverTemperature, mgoutputPhaseIndex=mgoutputPhaseIndex, upsmgConfigTemperatureLow=upsmgConfigTemperatureLow, upsmgConfigMaxRechargeTime=upsmgConfigMaxRechargeTime, upsmgConfigNominalBatteryTime=upsmgConfigNominalBatteryTime, mgreceptacleToggleDelay=mgreceptacleToggleDelay, upsmgBattery=upsmgBattery, upsmgEnvironInput2Open=upsmgEnvironInput2Open, mgdeviceSequenceOff=mgdeviceSequenceOff, upsmgAgentMibVersion=upsmgAgentMibVersion, mgreceptacleStateDischarge=mgreceptacleStateDischarge, upsmgConfigDevicesEntry=upsmgConfigDevicesEntry, mgreceptacleIndexc=mgreceptacleIndexc, upsmgInputBad=upsmgInputBad, upsmgOutputPhaseEntry=upsmgOutputPhaseEntry, upsmgCommunicationRestored=upsmgCommunicationRestored, mgreceptacleToggleDuration=mgreceptacleToggleDuration, upsmgEnvironInput2Closed=upsmgEnvironInput2Closed, upsmgEnvironSensorEntry=upsmgEnvironSensorEntry, upsmgConfigAutoRestart=upsmgConfigAutoRestart, mgreceptacleOverload=mgreceptacleOverload, upsmg=upsmg, upsmgDiagnosticTestFail=upsmgDiagnosticTestFail, upsmgEnvironmentIndex=upsmgEnvironmentIndex, upsmgInputPhaseTable=upsmgInputPhaseTable, upsmgEnviron=upsmgEnviron, mgextAlarmUID=mgextAlarmUID, upsmgOnInProgress=upsmgOnInProgress, mgreceptacleIdent=mgreceptacleIdent, upsmgConfigLowBatteryTime=upsmgConfigLowBatteryTime, upsmgTestLastCalibration=upsmgTestLastCalibration, mgcontrolDayOff=mgcontrolDayOff, upsmgEnvironmentInput2State=upsmgEnvironmentInput2State, upsmgChargerOK=upsmgChargerOK, upsmgBatteryFullRechargeTime=upsmgBatteryFullRechargeTime, upsmgAgentBootP=upsmgAgentBootP, upsmgAtLowBattery=upsmgAtLowBattery, upsmgBatteryNotHighCharge=upsmgBatteryNotHighCharge, upsmgBatteryTestOK=upsmgBatteryTestOK, upsmgConfigInput1ClosedLabel=upsmgConfigInput1ClosedLabel, upsmgConfigInput1Name=upsmgConfigInput1Name, upsmgControl=upsmgControl, upsmgIdentInstallationDate=upsmgIdentInstallationDate, upsmgConfigMinRechargeLevel=upsmgConfigMinRechargeLevel, upsmgEnvironExtAlarmEntry=upsmgEnvironExtAlarmEntry, upsmgConfigShutdownTimer=upsmgConfigShutdownTimer, mgreceptacleToggleCtrl=mgreceptacleToggleCtrl, upsmgConfigHumidityHysteresis=upsmgConfigHumidityHysteresis, upsmgAgentFirmwareVersion=upsmgAgentFirmwareVersion, upsmgEnvironmentNum=upsmgEnvironmentNum, upsmgOutputOnBattery=upsmgOutputOnBattery, upsmgTestIndicators=upsmgTestIndicators, upsmgEnvironInput1Open=upsmgEnvironInput1Open, upsmgBatteryLevel=upsmgBatteryLevel, upsRedundancyOK=upsRedundancyOK, upsmgOutputUtilityOff=upsmgOutputUtilityOff, upsmgOutputOnByPass=upsmgOutputOnByPass, upsmgConfigLowBooster=upsmgConfigLowBooster, upsmgConfigOutputNominalVoltage=upsmgConfigOutputNominalVoltage, mgdeviceShutdownDuration=mgdeviceShutdownDuration, upsmgOffComplete=upsmgOffComplete, mgmanagerCommType=mgmanagerCommType, upsmgInput=upsmgInput, upsmgConfigDevicesTable=upsmgConfigDevicesTable, upsmgManagersEntry=upsmgManagersEntry, upsmgOffInProgress=upsmgOffInProgress, mgalarmNum=mgalarmNum, upsmgConfigInput2ClosedLabel=upsmgConfigInput2ClosedLabel, upsmgConfigReceptaclesEntry=upsmgConfigReceptaclesEntry, upsmgExternalAlarmInactive=upsmgExternalAlarmInactive, upsmgConfigLowTransfer=upsmgConfigLowTransfer, upsmgControlDayOn=upsmgControlDayOn, upsmgConfigEmergencyOverload=upsmgConfigEmergencyOverload, mgreceptacleToggleStatus=mgreceptacleToggleStatus, mgmanagerNMSType=mgmanagerNMSType, upsmgEnvironmentSensorEntry=upsmgEnvironmentSensorEntry, mgalarmState=mgalarmState, mgreceptacleIndexb=mgreceptacleIndexb, upsmgByPassUnavailable=upsmgByPassUnavailable, upsmgAtLowRecharge=upsmgAtLowRecharge, upsmgTestResponseLine=upsmgTestResponseLine, upsmgOutputNoByPass=upsmgOutputNoByPass, upsmgAgentFactReset=upsmgAgentFactReset, upsmgManagement=upsmgManagement, upsmgIdentRevisionLevel=upsmgIdentRevisionLevel, upsmgOverLoad=upsmgOverLoad, upsmgBatteryOK=upsmgBatteryOK, mgreceptacleReceptacle=mgreceptacleReceptacle, mgreceptacleShutdownDuration=mgreceptacleShutdownDuration, mgreceptacleState=mgreceptacleState, mgreceptaclePowerCons=mgreceptaclePowerCons, upsmgBatteryUnavailableBattery=upsmgBatteryUnavailableBattery, upsmgTest=upsmgTest, upsmgConfigNominalBatteryVoltage=upsmgConfigNominalBatteryVoltage, upsmgAgentTrapSignature=upsmgAgentTrapSignature, upsmgEnvironmentHumidityLow=upsmgEnvironmentHumidityLow, upsmgIdentFirmwareVersion=upsmgIdentFirmwareVersion, upsmgOnComplete=upsmgOnComplete, upsmgBatteryUnavailable=upsmgBatteryUnavailable, upsmgIdentFamilyName=upsmgIdentFamilyName, mgdeviceIdent=mgdeviceIdent, upsmgConfigSysShutDuration=upsmgConfigSysShutDuration)
mibBuilder.exportSymbols("MG-SNMP-UPS-MIB", upsmgEnvironmentSensorTable=upsmgEnvironmentSensorTable, upsmgEnvironTemperatureLow=upsmgEnvironTemperatureLow, upsmgInputBadStatus=upsmgInputBadStatus, upsmgChargerFault=upsmgChargerFault, upsmgCommunicationFailure=upsmgCommunicationFailure, mgmanagerSeverityLevel=mgmanagerSeverityLevel, upsmgAgentTrapAlarmDelay=upsmgAgentTrapAlarmDelay, upsmgFromLowBattery=upsmgFromLowBattery, mginputFrequency=mginputFrequency, upsmgBatteryRechargeTime=upsmgBatteryRechargeTime, upsmgEnvironmentInput1State=upsmgEnvironmentInput1State, mgoutputVoltage=mgoutputVoltage, upsmgEnvironHumidityLow=upsmgEnvironHumidityLow, mgreceptacleOnStatus=mgreceptacleOnStatus, upsmgEnvironSensorNum=upsmgEnvironSensorNum, upsmgBatteryReplacementIndicated=upsmgBatteryReplacementIndicated, upsmgInputPhaseNum=upsmgInputPhaseNum, upsmgOutputUnavailableByPass=upsmgOutputUnavailableByPass, upsmgBatteryReplacement=upsmgBatteryReplacement, upsmgBatteryLowRecharge=upsmgBatteryLowRecharge, upsmgBatteryRemainingTime=upsmgBatteryRemainingTime, upsmgConfigAlarmTimeDelay=upsmgConfigAlarmTimeDelay, upsmgConfigOutputNominalCurrent=upsmgConfigOutputNominalCurrent, upsmgConfigOutputNomFrequency=upsmgConfigOutputNomFrequency, upsmgBatteryTemperature=upsmgBatteryTemperature, upsmgManagersTable=upsmgManagersTable, upsmgOutputOnBoost=upsmgOutputOnBoost, upsmgEnvironSensorTable=upsmgEnvironSensorTable, mgsensorHumidity=mgsensorHumidity, upsmgReceptacle=upsmgReceptacle, upsmgOutputPhaseNum=upsmgOutputPhaseNum, merlinGerin=merlinGerin, upsmgControlDayOff=upsmgControlDayOff, mgreceptacleRestartLevel=mgreceptacleRestartLevel, upsmgEnvironmentHumidity=upsmgEnvironmentHumidity, upsmgIdent=upsmgIdent, mgdeviceReceptacleNum=mgdeviceReceptacleNum, mgoutputCurrent=mgoutputCurrent, mgreceptacleRestartDelay=mgreceptacleRestartDelay, upsmgConfigHighFader=upsmgConfigHighFader, upsmgAgentTrapAck=upsmgAgentTrapAck, mgreceptacleStateTurnOn=mgreceptacleStateTurnOn, upsmgAgentDefGateway=upsmgAgentDefGateway, upsmgConfigByPassType=upsmgConfigByPassType, upsmgAgentBaudRate=upsmgAgentBaudRate, upsmgRemote=upsmgRemote, mgmanagerDescr=mgmanagerDescr, upsmgReturnFromBuck=upsmgReturnFromBuck, upsmgAgentCommUPS=upsmgAgentCommUPS, upsmgTestBatterySchedule=upsmgTestBatterySchedule, upsmgOutputOverLoad=upsmgOutputOverLoad, upsmgOutputOverTemp=upsmgOutputOverTemp, upsmgConfigTemperatureHysteresis=upsmgConfigTemperatureHysteresis)
