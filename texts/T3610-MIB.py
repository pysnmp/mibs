...
# Produced by pysmi-1.1.8 at Wed Sep 13 02:43:58 2023
...
Counter32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, IpAddress, NotificationType, TimeTicks, Bits, Gauge32, Counter64, Integer32, MibIdentifier, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "IpAddress", "NotificationType", "TimeTicks", "Bits", "Gauge32", "Counter64", "Integer32", "MibIdentifier", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarmInt=humAlarmInt, humHighInt=humHighInt, humMax=humMax, values=values, tempMax=tempMax, tempInt=tempInt, humLowInt=humLowInt, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarm=tempAlarm, tempLowInt=tempLowInt, tempUnit=tempUnit, compValDelayInt=compValDelayInt, tables=tables, trapSOAPErrDelivery=trapSOAPErrDelivery, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, valuesInt=valuesInt, DisplayString=DisplayString, humMin=humMin, messageString=messageString, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, pysmi_global=pysmi_global, products=products, humInt=humInt, humDelayInt=humDelayInt, histTemp=histTemp, hum=hum, traps=traps, serialNumber=serialNumber, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, comet=comet, historyEntry=historyEntry, deviceType=deviceType, histCompVal=histCompVal, trapNTPError=trapNTPError, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, compValUnit=compValUnit, t3610=t3610, temp=temp, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, humUnit=humUnit, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, sensorName=sensorName, tempHystInt=tempHystInt, compValMax=compValMax, historyTable=historyTable, trapSOAPErrDNS=trapSOAPErrDNS, trapTempClrAlarm=trapTempClrAlarm, compValAlarm=compValAlarm, trapHumError=trapHumError, compValMin=compValMin, histHum=histHum, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrFile=trapSOAPErrFile, compValInt=compValInt, trapHumLowAlarm=trapHumLowAlarm, compValHighInt=compValHighInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValError=trapCompValError, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt)
