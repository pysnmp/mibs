...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:34:10 2023
...
ObjectIdentity, enterprises, Bits, ModuleIdentity, Unsigned32, NotificationType, Counter64, MibIdentifier, Gauge32, TimeTicks, IpAddress, NotificationType, Integer32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "Bits", "ModuleIdentity", "Unsigned32", "NotificationType", "Counter64", "MibIdentifier", "Gauge32", "TimeTicks", "IpAddress", "NotificationType", "Integer32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, trapHumClrAlarm=trapHumClrAlarm, humUnit=humUnit, products=products, trapTest=trapTest, comet=comet, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, values=values, humAlarm=humAlarm, humInt=humInt, historyEntry=historyEntry, trapCompValLowAlarm=trapCompValLowAlarm, humHighInt=humHighInt, humHystInt=humHystInt, compValMax=compValMax, traps=traps, temp=temp, compValLowInt=compValLowInt, humAlarmInt=humAlarmInt, trapTempError=trapTempError, trapNTPError=trapNTPError, tempMin=tempMin, trapEmailErrLogin=trapEmailErrLogin, compValHighInt=compValHighInt, tables=tables, compValAlarm=compValAlarm, messageString=messageString, humMin=humMin, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, trapEmailErrSocket=trapEmailErrSocket, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, compValInt=compValInt, trapHumError=trapHumError, serialNumber=serialNumber, pysmi_global=pysmi_global, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, trapHumLowAlarm=trapHumLowAlarm, compValMin=compValMin, tempMax=tempMax, hum=hum, compValUnit=compValUnit, valuesInt=valuesInt, humMax=humMax, tempHighInt=tempHighInt, histCompVal=histCompVal, tempInt=tempInt, tempDelayInt=tempDelayInt, DisplayString=DisplayString, compVal=compVal, histHum=histHum, histTemp=histTemp, trapEmailErrDNS=trapEmailErrDNS, t3610=t3610, deviceType=deviceType, humDelayInt=humDelayInt, tempAlarm=tempAlarm, sensorName=sensorName, compValDelayInt=compValDelayInt, trapSOAPErrFile=trapSOAPErrFile, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, tempLowInt=tempLowInt, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket)
