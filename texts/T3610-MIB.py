...
# Produced by pysmi-1.1.12 at Tue May 28 13:06:35 2024
...
enterprises, Bits, Gauge32, Counter32, Counter64, NotificationType, NotificationType, iso, MibIdentifier, Unsigned32, ObjectIdentity, ModuleIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Gauge32", "Counter32", "Counter64", "NotificationType", "NotificationType", "iso", "MibIdentifier", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", tempMax=tempMax, humMax=humMax, compValUnit=compValUnit, compValAlarm=compValAlarm, tempDelayInt=tempDelayInt, trapHumLowAlarm=trapHumLowAlarm, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, tempAlarm=tempAlarm, tempInt=tempInt, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, compValAlarmInt=compValAlarmInt, hum=hum, settings=settings, humLowInt=humLowInt, traps=traps, compValHystInt=compValHystInt, messageString=messageString, trapCompValLowAlarm=trapCompValLowAlarm, humDelayInt=humDelayInt, tables=tables, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, compValMax=compValMax, valuesInt=valuesInt, histTemp=histTemp, deviceType=deviceType, trapEmailErrLogin=trapEmailErrLogin, trapTempError=trapTempError, t3610=t3610, humUnit=humUnit, humMin=humMin, comet=comet, compValMin=compValMin, historyEntry=historyEntry, humAlarmInt=humAlarmInt, products=products, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, tempHystInt=tempHystInt, tempAlarmInt=tempAlarmInt, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, sensorName=sensorName, pysmi_global=pysmi_global, trapSOAPErrDNS=trapSOAPErrDNS, humHighInt=humHighInt, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, compValInt=compValInt, histCompVal=histCompVal, temp=temp, trapNTPError=trapNTPError, values=values, humHystInt=humHystInt, tempUnit=tempUnit, DisplayString=DisplayString, humInt=humInt, tempHighInt=tempHighInt, tempMin=tempMin, tempLowInt=tempLowInt, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrFile=trapSOAPErrFile, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, compVal=compVal)
