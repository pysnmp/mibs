...
# Produced by pysmi-1.1.3 at Sun Nov 21 01:13:37 2021
...
iso, enterprises, Bits, NotificationType, Integer32, TimeTicks, Counter64, Gauge32, ObjectIdentity, IpAddress, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "Bits", "NotificationType", "Integer32", "TimeTicks", "Counter64", "Gauge32", "ObjectIdentity", "IpAddress", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", comet=comet, humHighInt=humHighInt, valuesInt=valuesInt, compValDelayInt=compValDelayInt, trapCompValError=trapCompValError, temp=temp, humAlarm=humAlarm, trapSOAPErrFile=trapSOAPErrFile, historyEntry=historyEntry, compVal=compVal, compValLowInt=compValLowInt, DisplayString=DisplayString, tempInt=tempInt, compValMax=compValMax, humMin=humMin, humMax=humMax, serialNumber=serialNumber, tempDelayInt=tempDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarmInt=humAlarmInt, trapTempError=trapTempError, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt, compValHystInt=compValHystInt, compValMin=compValMin, trapHumClrAlarm=trapHumClrAlarm, humLowInt=humLowInt, tempMax=tempMax, values=values, tempHystInt=tempHystInt, compValUnit=compValUnit, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, tempLowInt=tempLowInt, humDelayInt=humDelayInt, traps=traps, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, compValInt=compValInt, humUnit=humUnit, tempUnit=tempUnit, products=products, t3610=t3610, tempAlarm=tempAlarm, compValAlarm=compValAlarm, trapTest=trapTest, tables=tables, humInt=humInt, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, messageString=messageString, tempHighInt=tempHighInt, trapEmailErrSome=trapEmailErrSome, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, histHum=histHum, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, sensorName=sensorName, compValAlarmInt=compValAlarmInt, trapEmailErrLogin=trapEmailErrLogin, hum=hum, deviceType=deviceType, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, tempMin=tempMin, trapNTPError=trapNTPError, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm)
