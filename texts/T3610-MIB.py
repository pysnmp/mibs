...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:07:32 2023
...
iso, Counter32, Integer32, IpAddress, MibIdentifier, NotificationType, Counter64, ObjectIdentity, TimeTicks, Gauge32, ModuleIdentity, Unsigned32, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Integer32", "IpAddress", "MibIdentifier", "NotificationType", "Counter64", "ObjectIdentity", "TimeTicks", "Gauge32", "ModuleIdentity", "Unsigned32", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", histHum=histHum, deviceType=deviceType, tempUnit=tempUnit, compValAlarm=compValAlarm, tempHystInt=tempHystInt, trapHumHighAlarm=trapHumHighAlarm, historyEntry=historyEntry, valuesInt=valuesInt, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, trapCompValHighAlarm=trapCompValHighAlarm, humUnit=humUnit, serialNumber=serialNumber, tables=tables, trapCompValError=trapCompValError, humLowInt=humLowInt, compValHystInt=compValHystInt, trapHumClrAlarm=trapHumClrAlarm, compValMax=compValMax, humMax=humMax, tempAlarmInt=tempAlarmInt, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, sensorName=sensorName, humHighInt=humHighInt, temp=temp, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, trapSOAPErrFile=trapSOAPErrFile, messageString=messageString, tempHighInt=tempHighInt, products=products, compValLowInt=compValLowInt, compValHighInt=compValHighInt, trapTempLowAlarm=trapTempLowAlarm, tempInt=tempInt, humInt=humInt, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, trapTempHighAlarm=trapTempHighAlarm, compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, hum=hum, humHystInt=humHystInt, settings=settings, DisplayString=DisplayString, trapEmailErrLogin=trapEmailErrLogin, humAlarmInt=humAlarmInt, compVal=compVal, compValAlarmInt=compValAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSocket=trapEmailErrSocket, historyTable=historyTable, pysmi_global=pysmi_global, tempMin=tempMin, trapTest=trapTest, tempMax=tempMax, tempDelayInt=tempDelayInt, trapNTPError=trapNTPError, compValUnit=compValUnit, values=values, humAlarm=humAlarm, comet=comet, t3610=t3610, humMin=humMin, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, traps=traps, compValMin=compValMin, histCompVal=histCompVal, trapEmailErrSome=trapEmailErrSome, compValInt=compValInt)
