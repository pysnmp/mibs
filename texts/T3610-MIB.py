...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:58:49 2022
...
Integer32, Counter64, NotificationType, TimeTicks, NotificationType, ModuleIdentity, MibIdentifier, ObjectIdentity, Unsigned32, iso, Bits, Counter32, IpAddress, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "NotificationType", "TimeTicks", "NotificationType", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Unsigned32", "iso", "Bits", "Counter32", "IpAddress", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", humHighInt=humHighInt, trapEmailErrDNS=trapEmailErrDNS, histCompVal=histCompVal, pysmi_global=pysmi_global, trapTempClrAlarm=trapTempClrAlarm, deviceType=deviceType, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, trapTempError=trapTempError, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, compVal=compVal, valuesInt=valuesInt, tempAlarm=tempAlarm, humMax=humMax, tables=tables, compValMax=compValMax, humAlarmInt=humAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, historyEntry=historyEntry, trapCompValError=trapCompValError, comet=comet, tempMax=tempMax, tempLowInt=tempLowInt, tempHystInt=tempHystInt, compValUnit=compValUnit, sensorName=sensorName, compValLowInt=compValLowInt, temp=temp, tempInt=tempInt, histHum=histHum, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, tempUnit=tempUnit, compValMin=compValMin, tempDelayInt=tempDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, compValAlarm=compValAlarm, compValHighInt=compValHighInt, values=values, humInt=humInt, messageString=messageString, trapCompValClrAlarm=trapCompValClrAlarm, trapTest=trapTest, humDelayInt=humDelayInt, humLowInt=humLowInt, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, trapHumError=trapHumError, traps=traps, hum=hum, compValHystInt=compValHystInt, compValInt=compValInt, tempHighInt=tempHighInt, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSome=trapEmailErrSome, trapNTPError=trapNTPError, products=products, settings=settings, serialNumber=serialNumber, tempMin=tempMin, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, DisplayString=DisplayString, humMin=humMin)
