...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, enterprises, Integer32, NotificationType, MibIdentifier, IpAddress, Counter32, iso, Unsigned32, ModuleIdentity, ObjectIdentity, NotificationType, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "enterprises", "Integer32", "NotificationType", "MibIdentifier", "IpAddress", "Counter32", "iso", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", compVal=compVal, historyEntry=historyEntry, values=values, humDelayInt=humDelayInt, trapCompValError=trapCompValError, humMax=humMax, humHighInt=humHighInt, pysmi_global=pysmi_global, compValAlarmInt=compValAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, valuesInt=valuesInt, temp=temp, traps=traps, tempMax=tempMax, compValUnit=compValUnit, messageString=messageString, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, histCompVal=histCompVal, compValDelayInt=compValDelayInt, deviceType=deviceType, historyTable=historyTable, trapNTPError=trapNTPError, DisplayString=DisplayString, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, tempInt=tempInt, humUnit=humUnit, hum=hum, trapHumError=trapHumError, humMin=humMin, histHum=histHum, comet=comet, trapTempError=trapTempError, tables=tables, products=products, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, compValHighInt=compValHighInt, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, trapEmailErrSocket=trapEmailErrSocket, sensorName=sensorName, tempAlarm=tempAlarm, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, compValMax=compValMax, serialNumber=serialNumber, compValInt=compValInt, compValMin=compValMin, humInt=humInt, humAlarmInt=humAlarmInt, humLowInt=humLowInt, compValLowInt=compValLowInt, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, tempAlarmInt=tempAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, tempHighInt=tempHighInt, trapEmailErrDNS=trapEmailErrDNS, humAlarm=humAlarm, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, histTemp=histTemp, t3610=t3610, tempDelayInt=tempDelayInt, trapHumHighAlarm=trapHumHighAlarm)
