...
# Produced by pysmi-1.1.8 at Tue Sep 12 12:06:19 2023
...
IpAddress, TimeTicks, Counter64, NotificationType, iso, MibIdentifier, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Gauge32, Bits, Integer32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter64", "NotificationType", "iso", "MibIdentifier", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Gauge32", "Bits", "Integer32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", histHum=histHum, historyTable=historyTable, compValAlarmInt=compValAlarmInt, values=values, humMin=humMin, compValHystInt=compValHystInt, tempMin=tempMin, pysmi_global=pysmi_global, compValLowInt=compValLowInt, historyEntry=historyEntry, sensorName=sensorName, trapTempError=trapTempError, tempHighInt=tempHighInt, comet=comet, compVal=compVal, trapHumClrAlarm=trapHumClrAlarm, humMax=humMax, humHighInt=humHighInt, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, humAlarmInt=humAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSome=trapEmailErrSome, tables=tables, temp=temp, trapTempHighAlarm=trapTempHighAlarm, compValDelayInt=compValDelayInt, settings=settings, trapTest=trapTest, tempAlarm=tempAlarm, tempUnit=tempUnit, tempLowInt=tempLowInt, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrFile=trapSOAPErrFile, humLowInt=humLowInt, tempMax=tempMax, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, humDelayInt=humDelayInt, humHystInt=humHystInt, trapNTPError=trapNTPError, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, traps=traps, deviceType=deviceType, tempAlarmInt=tempAlarmInt, DisplayString=DisplayString, humAlarm=humAlarm, compValInt=compValInt, tempInt=tempInt, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, humUnit=humUnit, trapEmailErrDNS=trapEmailErrDNS, compValMin=compValMin, trapSOAPErrDNS=trapSOAPErrDNS, compValAlarm=compValAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, valuesInt=valuesInt, compValMax=compValMax, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, products=products, tempDelayInt=tempDelayInt, t3610=t3610, tempHystInt=tempHystInt, compValUnit=compValUnit, trapEmailErrAuth=trapEmailErrAuth, hum=hum, compValHighInt=compValHighInt)
