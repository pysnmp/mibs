...
Counter64, Bits, Unsigned32, NotificationType, iso, ModuleIdentity, Counter32, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, TimeTicks, ObjectIdentity, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "Unsigned32", "NotificationType", "iso", "ModuleIdentity", "Counter32", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "TimeTicks", "ObjectIdentity", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, compValHighInt=compValHighInt, tables=tables, compValUnit=compValUnit, compValMin=compValMin, humAlarmInt=humAlarmInt, messageString=messageString, trapCompValLowAlarm=trapCompValLowAlarm, humDelayInt=humDelayInt, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, values=values, comet=comet, sensorName=sensorName, humUnit=humUnit, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, tempMin=tempMin, tempDelayInt=tempDelayInt, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, valuesInt=valuesInt, pysmi_global=pysmi_global, humLowInt=humLowInt, trapSOAPErrSocket=trapSOAPErrSocket, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, deviceType=deviceType, products=products, tempHystInt=tempHystInt, tempAlarm=tempAlarm, trapCompValError=trapCompValError, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, t3610=t3610, tempLowInt=tempLowInt, serialNumber=serialNumber, traps=traps, compValInt=compValInt, trapTempError=trapTempError, histTemp=histTemp, humInt=humInt, trapEmailErrDNS=trapEmailErrDNS, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarm=compValAlarm, tempInt=tempInt, trapSOAPErrDelivery=trapSOAPErrDelivery, histHum=histHum, settings=settings, DisplayString=DisplayString, tempUnit=tempUnit, humHystInt=humHystInt, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, humMax=humMax, compValDelayInt=compValDelayInt, temp=temp, compValLowInt=compValLowInt, historyTable=historyTable, compVal=compVal, humAlarm=humAlarm, compValMax=compValMax, hum=hum, humHighInt=humHighInt)
