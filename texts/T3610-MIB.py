...
# Produced by pysmi-1.1.8 at Mon Jan 17 09:56:35 2022
...
Bits, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, NotificationType, ModuleIdentity, Gauge32, Integer32, Unsigned32, TimeTicks, Counter64, Counter32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "NotificationType", "ModuleIdentity", "Gauge32", "Integer32", "Unsigned32", "TimeTicks", "Counter64", "Counter32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValMax=compValMax, messageString=messageString, compValInt=compValInt, trapCompValError=trapCompValError, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, tempInt=tempInt, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, compValLowInt=compValLowInt, trapHumLowAlarm=trapHumLowAlarm, humAlarm=humAlarm, tempLowInt=tempLowInt, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, historyEntry=historyEntry, compValHighInt=compValHighInt, trapNTPError=trapNTPError, compVal=compVal, temp=temp, sensorName=sensorName, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, historyTable=historyTable, trapTempError=trapTempError, tempMax=tempMax, traps=traps, trapEmailErrSome=trapEmailErrSome, valuesInt=valuesInt, tables=tables, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, products=products, pysmi_global=pysmi_global, compValDelayInt=compValDelayInt, humInt=humInt, comet=comet, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, humHystInt=humHystInt, compValMin=compValMin, settings=settings, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, hum=hum, serialNumber=serialNumber, compValHystInt=compValHystInt, humMax=humMax, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarmInt=compValAlarmInt, tempMin=tempMin, humMin=humMin, tempAlarmInt=tempAlarmInt, humUnit=humUnit, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, t3610=t3610, tempHighInt=tempHighInt, trapTempClrAlarm=trapTempClrAlarm, tempHystInt=tempHystInt, DisplayString=DisplayString, humLowInt=humLowInt, compValAlarm=compValAlarm, values=values, humHighInt=humHighInt, humAlarmInt=humAlarmInt, humDelayInt=humDelayInt, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, tempAlarm=tempAlarm)
