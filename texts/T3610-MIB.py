...
# Produced by pysmi-1.1.8 at Fri Jan 13 13:50:29 2023
...
enterprises, Gauge32, TimeTicks, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, ObjectIdentity, Unsigned32, iso, IpAddress, MibIdentifier, Bits, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "TimeTicks", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "MibIdentifier", "Bits", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarmInt=humAlarmInt, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, humMin=humMin, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, histHum=histHum, tempInt=tempInt, tempAlarm=tempAlarm, trapEmailErrAuth=trapEmailErrAuth, trapHumError=trapHumError, values=values, compValLowInt=compValLowInt, tempLowInt=tempLowInt, compValMin=compValMin, humMax=humMax, humDelayInt=humDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, trapNTPError=trapNTPError, compVal=compVal, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, trapHumClrAlarm=trapHumClrAlarm, temp=temp, traps=traps, tempHighInt=tempHighInt, sensorName=sensorName, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, humHighInt=humHighInt, compValDelayInt=compValDelayInt, trapEmailErrSocket=trapEmailErrSocket, humInt=humInt, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, compValMax=compValMax, messageString=messageString, humAlarm=humAlarm, compValUnit=compValUnit, compValHighInt=compValHighInt, deviceType=deviceType, tempDelayInt=tempDelayInt, historyEntry=historyEntry, hum=hum, tempMax=tempMax, humUnit=humUnit, tempUnit=tempUnit, compValInt=compValInt, histTemp=histTemp, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, settings=settings, pysmi_global=pysmi_global, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, products=products, compValHystInt=compValHystInt, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, comet=comet, tables=tables, tempAlarmInt=tempAlarmInt, t3610=t3610, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, DisplayString=DisplayString, valuesInt=valuesInt, histCompVal=histCompVal)
