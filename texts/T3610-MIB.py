...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, serialNumber=serialNumber, deviceType=deviceType, messageString=messageString, temp=temp, trapEmailErrSocket=trapEmailErrSocket, compValLowInt=compValLowInt, pysmi_global=pysmi_global, valuesInt=valuesInt, traps=traps, compValAlarm=compValAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humLowInt=humLowInt, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, tempDelayInt=tempDelayInt, compValUnit=compValUnit, tempHighInt=tempHighInt, humHystInt=humHystInt, compValMax=compValMax, tempHystInt=tempHystInt, histTemp=histTemp, tempUnit=tempUnit, trapEmailErrSome=trapEmailErrSome, compValDelayInt=compValDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, compVal=compVal, humMin=humMin, compValInt=compValInt, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, trapTest=trapTest, historyTable=historyTable, humMax=humMax, settings=settings, histCompVal=histCompVal, trapNTPError=trapNTPError, compValHystInt=compValHystInt, compValHighInt=compValHighInt, tables=tables, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrDNS=trapEmailErrDNS, tempMax=tempMax, trapEmailErrAuth=trapEmailErrAuth, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, tempAlarm=tempAlarm, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrFile=trapSOAPErrFile, values=values, sensorName=sensorName, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrSocket=trapSOAPErrSocket, humHighInt=humHighInt, humUnit=humUnit, tempLowInt=tempLowInt, products=products, humDelayInt=humDelayInt, DisplayString=DisplayString, tempMin=tempMin, trapHumLowAlarm=trapHumLowAlarm, tempInt=tempInt, humAlarm=humAlarm, humInt=humInt, trapSOAPErrDelivery=trapSOAPErrDelivery, t3610=t3610, trapHumError=trapHumError, comet=comet)
