...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:52:28 2023
...
Counter32, ModuleIdentity, NotificationType, iso, NotificationType, Gauge32, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, IpAddress, Counter64, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "NotificationType", "iso", "NotificationType", "Gauge32", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "IpAddress", "Counter64", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", valuesInt=valuesInt, trapHumLowAlarm=trapHumLowAlarm, compVal=compVal, compValUnit=compValUnit, tempMax=tempMax, trapTempLowAlarm=trapTempLowAlarm, historyEntry=historyEntry, DisplayString=DisplayString, tempMin=tempMin, settings=settings, compValAlarmInt=compValAlarmInt, humDelayInt=humDelayInt, hum=hum, humMin=humMin, compValMin=compValMin, tempHighInt=tempHighInt, histHum=histHum, trapTempHighAlarm=trapTempHighAlarm, trapHumError=trapHumError, humHystInt=humHystInt, trapEmailErrSome=trapEmailErrSome, tempAlarm=tempAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, sensorName=sensorName, deviceType=deviceType, compValInt=compValInt, tempLowInt=tempLowInt, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, trapCompValHighAlarm=trapCompValHighAlarm, compValAlarm=compValAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, humLowInt=humLowInt, humMax=humMax, trapCompValError=trapCompValError, trapEmailErrLogin=trapEmailErrLogin, traps=traps, trapTempError=trapTempError, compValHighInt=compValHighInt, humAlarmInt=humAlarmInt, humHighInt=humHighInt, pysmi_global=pysmi_global, trapNTPError=trapNTPError, tempAlarmInt=tempAlarmInt, comet=comet, compValDelayInt=compValDelayInt, trapTest=trapTest, values=values, humInt=humInt, t3610=t3610, products=products, humUnit=humUnit, histTemp=histTemp, tempUnit=tempUnit, histCompVal=histCompVal, tables=tables, tempHystInt=tempHystInt, trapEmailErrDNS=trapEmailErrDNS, serialNumber=serialNumber, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrAuth=trapEmailErrAuth, trapCompValClrAlarm=trapCompValClrAlarm, messageString=messageString, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrFile=trapSOAPErrFile, compValMax=compValMax, humAlarm=humAlarm, tempInt=tempInt, compValLowInt=compValLowInt, historyTable=historyTable, temp=temp)
