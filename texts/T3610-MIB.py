...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:01:52 2023
...
Gauge32, ModuleIdentity, IpAddress, NotificationType, ObjectIdentity, Counter32, Counter64, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Unsigned32, NotificationType, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "IpAddress", "NotificationType", "ObjectIdentity", "Counter32", "Counter64", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Unsigned32", "NotificationType", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", historyTable=historyTable, temp=temp, comet=comet, trapSOAPErrSocket=trapSOAPErrSocket, humAlarmInt=humAlarmInt, valuesInt=valuesInt, trapSOAPErrFile=trapSOAPErrFile, trapCompValClrAlarm=trapCompValClrAlarm, humMax=humMax, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, humMin=humMin, trapTempHighAlarm=trapTempHighAlarm, humHighInt=humHighInt, trapCompValLowAlarm=trapCompValLowAlarm, compVal=compVal, trapSOAPErrDNS=trapSOAPErrDNS, values=values, compValAlarm=compValAlarm, historyEntry=historyEntry, trapHumError=trapHumError, traps=traps, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempError=trapTempError, serialNumber=serialNumber, deviceType=deviceType, humHystInt=humHystInt, hum=hum, histHum=histHum, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, compValDelayInt=compValDelayInt, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, compValUnit=compValUnit, trapNTPError=trapNTPError, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, tempMin=tempMin, tempInt=tempInt, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, tempDelayInt=tempDelayInt, histTemp=histTemp, trapCompValError=trapCompValError, humUnit=humUnit, compValInt=compValInt, humInt=humInt, tempHystInt=tempHystInt, sensorName=sensorName, trapHumClrAlarm=trapHumClrAlarm, compValMax=compValMax, settings=settings, histCompVal=histCompVal, pysmi_global=pysmi_global, compValLowInt=compValLowInt, compValHighInt=compValHighInt, humDelayInt=humDelayInt, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, tables=tables, tempLowInt=tempLowInt, compValMin=compValMin, compValHystInt=compValHystInt, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, humAlarm=humAlarm, tempAlarm=tempAlarm, t3610=t3610, tempMax=tempMax, tempHighInt=tempHighInt, products=products)
