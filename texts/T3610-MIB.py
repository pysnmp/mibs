...
# Produced by pysmi-1.1.8 at Thu Jan  5 11:25:43 2023
...
TimeTicks, Gauge32, Counter64, Bits, NotificationType, Integer32, ObjectIdentity, IpAddress, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Counter32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Counter64", "Bits", "NotificationType", "Integer32", "ObjectIdentity", "IpAddress", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Counter32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, temp=temp, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, trapCompValLowAlarm=trapCompValLowAlarm, tempInt=tempInt, compValHighInt=compValHighInt, trapTest=trapTest, compVal=compVal, trapNTPError=trapNTPError, traps=traps, trapHumError=trapHumError, serialNumber=serialNumber, historyEntry=historyEntry, products=products, trapSOAPErrSocket=trapSOAPErrSocket, valuesInt=valuesInt, messageString=messageString, trapCompValError=trapCompValError, humInt=humInt, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, tempAlarm=tempAlarm, humAlarm=humAlarm, tempMin=tempMin, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, compValLowInt=compValLowInt, trapEmailErrSocket=trapEmailErrSocket, settings=settings, sensorName=sensorName, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, trapSOAPErrFile=trapSOAPErrFile, tempHighInt=tempHighInt, comet=comet, humMin=humMin, tempLowInt=tempLowInt, histHum=histHum, humHystInt=humHystInt, compValAlarm=compValAlarm, hum=hum, pysmi_global=pysmi_global, historyTable=historyTable, compValHystInt=compValHystInt, humUnit=humUnit, tempMax=tempMax, trapHumHighAlarm=trapHumHighAlarm, compValAlarmInt=compValAlarmInt, histTemp=histTemp, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, trapTempError=trapTempError, humAlarmInt=humAlarmInt, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, humDelayInt=humDelayInt, humMax=humMax, humHighInt=humHighInt, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, tempAlarmInt=tempAlarmInt, compValMax=compValMax, tables=tables, trapTempHighAlarm=trapTempHighAlarm, tempDelayInt=tempDelayInt, DisplayString=DisplayString, values=values, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm)
