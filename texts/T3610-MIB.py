...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:56:53 2023
...
NotificationType, Integer32, Unsigned32, Bits, NotificationType, iso, IpAddress, MibIdentifier, TimeTicks, Counter32, Counter64, enterprises, ModuleIdentity, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Unsigned32", "Bits", "NotificationType", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "Counter32", "Counter64", "enterprises", "ModuleIdentity", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrSocket=trapSOAPErrSocket, compVal=compVal, comet=comet, sensorName=sensorName, humUnit=humUnit, trapTempClrAlarm=trapTempClrAlarm, hum=hum, compValLowInt=compValLowInt, deviceType=deviceType, humHighInt=humHighInt, tempUnit=tempUnit, humMin=humMin, t3610=t3610, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarm=compValAlarm, tempMax=tempMax, tempHystInt=tempHystInt, humAlarmInt=humAlarmInt, tables=tables, trapCompValError=trapCompValError, histHum=histHum, trapEmailErrSome=trapEmailErrSome, humHystInt=humHystInt, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, tempAlarmInt=tempAlarmInt, humMax=humMax, compValAlarmInt=compValAlarmInt, tempLowInt=tempLowInt, products=products, historyEntry=historyEntry, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, humLowInt=humLowInt, compValHighInt=compValHighInt, trapHumHighAlarm=trapHumHighAlarm, humDelayInt=humDelayInt, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, valuesInt=valuesInt, compValDelayInt=compValDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, settings=settings, traps=traps, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, compValInt=compValInt, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, temp=temp, trapCompValHighAlarm=trapCompValHighAlarm, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, tempMin=tempMin, humAlarm=humAlarm, tempInt=tempInt, historyTable=historyTable, histTemp=histTemp, histCompVal=histCompVal, values=values, trapSOAPErrFile=trapSOAPErrFile, humInt=humInt, compValUnit=compValUnit, tempDelayInt=tempDelayInt, pysmi_global=pysmi_global, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compValMin=compValMin, serialNumber=serialNumber, tempAlarm=tempAlarm)
