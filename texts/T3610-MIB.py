...
# Produced by pysmi-1.1.12 at Wed May 29 07:15:02 2024
...
NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Unsigned32, Gauge32, ModuleIdentity, IpAddress, NotificationType, iso, Counter64, ObjectIdentity, Integer32, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Unsigned32", "Gauge32", "ModuleIdentity", "IpAddress", "NotificationType", "iso", "Counter64", "ObjectIdentity", "Integer32", "Bits", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValError=trapCompValError, trapCompValHighAlarm=trapCompValHighAlarm, tempMin=tempMin, compValLowInt=compValLowInt, tempDelayInt=tempDelayInt, comet=comet, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, trapSOAPErrFile=trapSOAPErrFile, humMin=humMin, humHystInt=humHystInt, hum=hum, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, historyTable=historyTable, temp=temp, compValInt=compValInt, humInt=humInt, tempAlarm=tempAlarm, compValUnit=compValUnit, trapCompValLowAlarm=trapCompValLowAlarm, histHum=histHum, sensorName=sensorName, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, humUnit=humUnit, tempHystInt=tempHystInt, compValMax=compValMax, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, compValHighInt=compValHighInt, trapNTPError=trapNTPError, humAlarm=humAlarm, tempMax=tempMax, trapHumError=trapHumError, deviceType=deviceType, histTemp=histTemp, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, trapEmailErrLogin=trapEmailErrLogin, humLowInt=humLowInt, humHighInt=humHighInt, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, values=values, humAlarmInt=humAlarmInt, settings=settings, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, traps=traps, DisplayString=DisplayString, products=products, compVal=compVal, humDelayInt=humDelayInt, historyEntry=historyEntry, trapTest=trapTest, compValDelayInt=compValDelayInt, compValAlarm=compValAlarm, pysmi_global=pysmi_global, humMax=humMax, tables=tables, t3610=t3610, compValHystInt=compValHystInt, trapTempError=trapTempError, serialNumber=serialNumber, trapTempHighAlarm=trapTempHighAlarm, messageString=messageString, tempInt=tempInt, tempLowInt=tempLowInt)
