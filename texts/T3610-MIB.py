...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:02:27 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, iso, TimeTicks, Counter32, NotificationType, Integer32, Bits, Unsigned32, IpAddress, enterprises, ModuleIdentity, ObjectIdentity, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "iso", "TimeTicks", "Counter32", "NotificationType", "Integer32", "Bits", "Unsigned32", "IpAddress", "enterprises", "ModuleIdentity", "ObjectIdentity", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempClrAlarm=trapTempClrAlarm, tempLowInt=tempLowInt, humHystInt=humHystInt, tempAlarmInt=tempAlarmInt, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, humAlarmInt=humAlarmInt, compValLowInt=compValLowInt, compValDelayInt=compValDelayInt, trapCompValError=trapCompValError, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, histHum=histHum, humDelayInt=humDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, trapEmailErrAuth=trapEmailErrAuth, compVal=compVal, humLowInt=humLowInt, histTemp=histTemp, tables=tables, compValAlarm=compValAlarm, compValMax=compValMax, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, humAlarm=humAlarm, humMax=humMax, temp=temp, trapTempLowAlarm=trapTempLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrSome=trapEmailErrSome, compValHystInt=compValHystInt, settings=settings, humInt=humInt, trapTempHighAlarm=trapTempHighAlarm, compValMin=compValMin, humHighInt=humHighInt, humUnit=humUnit, values=values, serialNumber=serialNumber, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDNS=trapSOAPErrDNS, historyTable=historyTable, trapCompValClrAlarm=trapCompValClrAlarm, pysmi_global=pysmi_global, tempAlarm=tempAlarm, deviceType=deviceType, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, messageString=messageString, products=products, t3610=t3610, valuesInt=valuesInt, humMin=humMin, comet=comet, compValInt=compValInt, traps=traps, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, compValHighInt=compValHighInt, trapTest=trapTest, trapHumLowAlarm=trapHumLowAlarm, tempMax=tempMax, DisplayString=DisplayString, tempHystInt=tempHystInt, tempInt=tempInt, histCompVal=histCompVal, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, hum=hum)
