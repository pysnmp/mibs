...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:55:57 2024
...
Counter32, ModuleIdentity, Integer32, NotificationType, ObjectIdentity, enterprises, iso, Unsigned32, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, TimeTicks, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Integer32", "NotificationType", "ObjectIdentity", "enterprises", "iso", "Unsigned32", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "TimeTicks", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", comet=comet, products=products, trapTempError=trapTempError, temp=temp, trapEmailErrLogin=trapEmailErrLogin, humMax=humMax, tempLowInt=tempLowInt, DisplayString=DisplayString, trapTempHighAlarm=trapTempHighAlarm, trapHumLowAlarm=trapHumLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrSome=trapEmailErrSome, humHighInt=humHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempClrAlarm=trapTempClrAlarm, tempUnit=tempUnit, compVal=compVal, tempAlarm=tempAlarm, compValMin=compValMin, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, messageString=messageString, values=values, serialNumber=serialNumber, histCompVal=histCompVal, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, tempMin=tempMin, settings=settings, trapCompValError=trapCompValError, pysmi_global=pysmi_global, trapTest=trapTest, humUnit=humUnit, tempMax=tempMax, humHystInt=humHystInt, compValHystInt=compValHystInt, valuesInt=valuesInt, histTemp=histTemp, humDelayInt=humDelayInt, humAlarmInt=humAlarmInt, histHum=histHum, compValLowInt=compValLowInt, humAlarm=humAlarm, tempDelayInt=tempDelayInt, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, sensorName=sensorName, tempInt=tempInt, trapHumHighAlarm=trapHumHighAlarm, trapHumClrAlarm=trapHumClrAlarm, compValUnit=compValUnit, tables=tables, tempHighInt=tempHighInt, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, traps=traps, trapEmailErrSocket=trapEmailErrSocket, trapTempLowAlarm=trapTempLowAlarm, hum=hum, humLowInt=humLowInt, compValInt=compValInt, tempHystInt=tempHystInt, compValMax=compValMax, compValAlarm=compValAlarm, humInt=humInt, t3610=t3610, deviceType=deviceType, compValAlarmInt=compValAlarmInt, historyTable=historyTable, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, humMin=humMin)
