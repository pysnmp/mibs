...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:36:00 2021
...
iso, Gauge32, Counter64, NotificationType, ModuleIdentity, ObjectIdentity, Unsigned32, Bits, enterprises, Counter32, TimeTicks, NotificationType, MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Counter64", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Bits", "enterprises", "Counter32", "TimeTicks", "NotificationType", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", tempLowInt=tempLowInt, trapHumLowAlarm=trapHumLowAlarm, humInt=humInt, tempInt=tempInt, messageString=messageString, products=products, traps=traps, tempMax=tempMax, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, compValMin=compValMin, t3610=t3610, tempAlarm=tempAlarm, humMax=humMax, compValInt=compValInt, comet=comet, hum=hum, histHum=histHum, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, humHighInt=humHighInt, tempDelayInt=tempDelayInt, histTemp=histTemp, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, valuesInt=valuesInt, trapSOAPErrSocket=trapSOAPErrSocket, humDelayInt=humDelayInt, trapTempError=trapTempError, humLowInt=humLowInt, compVal=compVal, compValDelayInt=compValDelayInt, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, tables=tables, tempAlarmInt=tempAlarmInt, trapHumError=trapHumError, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrFile=trapSOAPErrFile, histCompVal=histCompVal, settings=settings, humMin=humMin, compValAlarm=compValAlarm, compValHighInt=compValHighInt, humAlarmInt=humAlarmInt, trapNTPError=trapNTPError, temp=temp, compValMax=compValMax, tempHighInt=tempHighInt, tempMin=tempMin, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, historyEntry=historyEntry, tempUnit=tempUnit, historyTable=historyTable, values=values, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrSocket=trapEmailErrSocket, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, compValLowInt=compValLowInt, DisplayString=DisplayString, serialNumber=serialNumber, compValHystInt=compValHystInt, tempHystInt=tempHystInt, humHystInt=humHystInt, pysmi_global=pysmi_global, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, compValUnit=compValUnit)
