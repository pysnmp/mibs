...
# Produced by pysmi-1.1.8 at Sun Jan 16 00:56:05 2022
...
enterprises, ObjectIdentity, Bits, Counter32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Counter64, Unsigned32, NotificationType, IpAddress, iso, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Bits", "Counter32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Counter64", "Unsigned32", "NotificationType", "IpAddress", "iso", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarmInt=humAlarmInt, humAlarm=humAlarm, compValMin=compValMin, t3610=t3610, products=products, compVal=compVal, tempHystInt=tempHystInt, trapHumError=trapHumError, tables=tables, histTemp=histTemp, humInt=humInt, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, humHighInt=humHighInt, compValMax=compValMax, humUnit=humUnit, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, sensorName=sensorName, tempHighInt=tempHighInt, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, tempInt=tempInt, compValHystInt=compValHystInt, trapTempError=trapTempError, tempAlarm=tempAlarm, trapEmailErrAuth=trapEmailErrAuth, compValInt=compValInt, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, tempMin=tempMin, compValUnit=compValUnit, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, humHystInt=humHystInt, histCompVal=histCompVal, trapEmailErrSome=trapEmailErrSome, deviceType=deviceType, historyEntry=historyEntry, tempLowInt=tempLowInt, values=values, humMin=humMin, compValAlarm=compValAlarm, tempMax=tempMax, trapCompValError=trapCompValError, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, pysmi_global=pysmi_global, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrLogin=trapEmailErrLogin, serialNumber=serialNumber, trapNTPError=trapNTPError, trapHumHighAlarm=trapHumHighAlarm, historyTable=historyTable, valuesInt=valuesInt, humLowInt=humLowInt, DisplayString=DisplayString, trapTempHighAlarm=trapTempHighAlarm, compValHighInt=compValHighInt, comet=comet, temp=temp, settings=settings, humMax=humMax, traps=traps, hum=hum, trapSOAPErrFile=trapSOAPErrFile, tempAlarmInt=tempAlarmInt)
