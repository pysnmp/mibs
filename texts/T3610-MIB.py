...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:09:23 2024
...
IpAddress, Bits, Unsigned32, Counter64, ModuleIdentity, ObjectIdentity, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, NotificationType, MibIdentifier, Integer32, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Unsigned32", "Counter64", "ModuleIdentity", "ObjectIdentity", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "NotificationType", "MibIdentifier", "Integer32", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, humInt=humInt, messageString=messageString, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, trapTempHighAlarm=trapTempHighAlarm, traps=traps, tempMax=tempMax, trapCompValClrAlarm=trapCompValClrAlarm, humAlarm=humAlarm, humLowInt=humLowInt, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, t3610=t3610, compValUnit=compValUnit, compVal=compVal, tempAlarm=tempAlarm, humMin=humMin, trapNTPError=trapNTPError, trapCompValError=trapCompValError, deviceType=deviceType, pysmi_global=pysmi_global, compValInt=compValInt, compValMax=compValMax, compValAlarmInt=compValAlarmInt, trapTempError=trapTempError, tempDelayInt=tempDelayInt, DisplayString=DisplayString, compValHighInt=compValHighInt, trapEmailErrSocket=trapEmailErrSocket, tempMin=tempMin, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, histTemp=histTemp, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, products=products, trapEmailErrSome=trapEmailErrSome, compValAlarm=compValAlarm, tempHighInt=tempHighInt, trapHumLowAlarm=trapHumLowAlarm, humHystInt=humHystInt, temp=temp, compValMin=compValMin, compValHystInt=compValHystInt, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, tables=tables, sensorName=sensorName, settings=settings, humMax=humMax, serialNumber=serialNumber, historyTable=historyTable, humHighInt=humHighInt, compValLowInt=compValLowInt, historyEntry=historyEntry, histCompVal=histCompVal, tempLowInt=tempLowInt, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, tempInt=tempInt, humUnit=humUnit, tempUnit=tempUnit, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, comet=comet, values=values)
