...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:05:02 2022
...
TimeTicks, Unsigned32, IpAddress, Integer32, MibIdentifier, Gauge32, NotificationType, ObjectIdentity, NotificationType, iso, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "Integer32", "MibIdentifier", "Gauge32", "NotificationType", "ObjectIdentity", "NotificationType", "iso", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", traps=traps, values=values, humHystInt=humHystInt, settings=settings, hum=hum, valuesInt=valuesInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValError=trapCompValError, tempUnit=tempUnit, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTest=trapTest, compValMin=compValMin, humAlarmInt=humAlarmInt, compValLowInt=compValLowInt, pysmi_global=pysmi_global, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humMax=humMax, humHighInt=humHighInt, messageString=messageString, tempMax=tempMax, trapHumLowAlarm=trapHumLowAlarm, histHum=histHum, humAlarm=humAlarm, tempMin=tempMin, DisplayString=DisplayString, compValDelayInt=compValDelayInt, tables=tables, humUnit=humUnit, humLowInt=humLowInt, tempLowInt=tempLowInt, tempInt=tempInt, tempAlarmInt=tempAlarmInt, serialNumber=serialNumber, trapSOAPErrDelivery=trapSOAPErrDelivery, humInt=humInt, compValInt=compValInt, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, trapHumHighAlarm=trapHumHighAlarm, trapNTPError=trapNTPError, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, compValAlarmInt=compValAlarmInt, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, comet=comet, t3610=t3610, compValMax=compValMax, compValHystInt=compValHystInt, humMin=humMin, histCompVal=histCompVal, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, historyTable=historyTable, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, compValUnit=compValUnit, products=products, tempHighInt=tempHighInt, temp=temp, trapEmailErrSome=trapEmailErrSome, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName, compVal=compVal, deviceType=deviceType)
