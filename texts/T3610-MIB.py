...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:11:51 2024
...
NotificationType, enterprises, Counter32, NotificationType, IpAddress, TimeTicks, Bits, Integer32, MibIdentifier, Gauge32, iso, ObjectIdentity, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "Counter32", "NotificationType", "IpAddress", "TimeTicks", "Bits", "Integer32", "MibIdentifier", "Gauge32", "iso", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", comet=comet, histCompVal=histCompVal, humAlarm=humAlarm, humDelayInt=humDelayInt, tempMin=tempMin, tempHighInt=tempHighInt, trapTempHighAlarm=trapTempHighAlarm, tempAlarm=tempAlarm, humLowInt=humLowInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, compValMax=compValMax, compValHighInt=compValHighInt, trapCompValHighAlarm=trapCompValHighAlarm, historyTable=historyTable, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, humMin=humMin, pysmi_global=pysmi_global, messageString=messageString, DisplayString=DisplayString, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, histTemp=histTemp, humInt=humInt, histHum=histHum, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, compValInt=compValInt, trapHumLowAlarm=trapHumLowAlarm, compValMin=compValMin, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarmInt=humAlarmInt, humMax=humMax, t3610=t3610, traps=traps, trapEmailErrSocket=trapEmailErrSocket, valuesInt=valuesInt, trapTempLowAlarm=trapTempLowAlarm, historyEntry=historyEntry, humHystInt=humHystInt, trapHumError=trapHumError, tempAlarmInt=tempAlarmInt, tempHystInt=tempHystInt, products=products, compValDelayInt=compValDelayInt, compValAlarm=compValAlarm, tempMax=tempMax, sensorName=sensorName, tempInt=tempInt, tables=tables, hum=hum, humHighInt=humHighInt, compValLowInt=compValLowInt, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, values=values, temp=temp, trapCompValError=trapCompValError, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, compVal=compVal, compValUnit=compValUnit, deviceType=deviceType, trapTempError=trapTempError, tempLowInt=tempLowInt, trapTest=trapTest, trapTempClrAlarm=trapTempClrAlarm, tempUnit=tempUnit)
