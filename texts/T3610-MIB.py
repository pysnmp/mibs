...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Counter32, enterprises, Counter64, ModuleIdentity, TimeTicks, ObjectIdentity, IpAddress, NotificationType, Gauge32, Integer32, MibIdentifier, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Counter32", "enterprises", "Counter64", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "IpAddress", "NotificationType", "Gauge32", "Integer32", "MibIdentifier", "Bits", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", trapTest=trapTest, tempMin=tempMin, compValAlarmInt=compValAlarmInt, products=products, pysmi_global=pysmi_global, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, temp=temp, tempLowInt=tempLowInt, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt, humAlarm=humAlarm, historyEntry=historyEntry, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm, tempAlarm=tempAlarm, trapEmailErrLogin=trapEmailErrLogin, trapCompValError=trapCompValError, humAlarmInt=humAlarmInt, trapTempClrAlarm=trapTempClrAlarm, tables=tables, settings=settings, trapSOAPErrDelivery=trapSOAPErrDelivery, hum=hum, trapTempHighAlarm=trapTempHighAlarm, historyTable=historyTable, traps=traps, trapSOAPErrSocket=trapSOAPErrSocket, compValHighInt=compValHighInt, humMax=humMax, tempHystInt=tempHystInt, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrFile=trapSOAPErrFile, tempInt=tempInt, humHighInt=humHighInt, compVal=compVal, messageString=messageString, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, humInt=humInt, comet=comet, compValLowInt=compValLowInt, compValDelayInt=compValDelayInt, valuesInt=valuesInt, humDelayInt=humDelayInt, tempMax=tempMax, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, compValMax=compValMax, DisplayString=DisplayString, compValInt=compValInt, tempHighInt=tempHighInt, sensorName=sensorName, serialNumber=serialNumber, compValHystInt=compValHystInt, values=values, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, humMin=humMin, t3610=t3610, histTemp=histTemp, histHum=histHum, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm)
