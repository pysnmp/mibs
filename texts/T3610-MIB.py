...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:54:07 2024
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, NotificationType, IpAddress, TimeTicks, Gauge32, Counter64, iso, Integer32, ObjectIdentity, Unsigned32, MibIdentifier, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "NotificationType", "IpAddress", "TimeTicks", "Gauge32", "Counter64", "iso", "Integer32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", messageString=messageString, tempInt=tempInt, compValAlarmInt=compValAlarmInt, histTemp=histTemp, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, tempHighInt=tempHighInt, historyTable=historyTable, historyEntry=historyEntry, compValMax=compValMax, trapCompValError=trapCompValError, tempHystInt=tempHystInt, tempUnit=tempUnit, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, comet=comet, humHighInt=humHighInt, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, tables=tables, tempAlarm=tempAlarm, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, trapTest=trapTest, trapCompValClrAlarm=trapCompValClrAlarm, values=values, serialNumber=serialNumber, tempDelayInt=tempDelayInt, humLowInt=humLowInt, temp=temp, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, sensorName=sensorName, compValDelayInt=compValDelayInt, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, settings=settings, compValHighInt=compValHighInt, humInt=humInt, trapSOAPErrSocket=trapSOAPErrSocket, humMin=humMin, trapEmailErrSome=trapEmailErrSome, compValAlarm=compValAlarm, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery, humMax=humMax, t3610=t3610, products=products, trapEmailErrAuth=trapEmailErrAuth, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, trapNTPError=trapNTPError, traps=traps, compValLowInt=compValLowInt, pysmi_global=pysmi_global, compValUnit=compValUnit, humDelayInt=humDelayInt, DisplayString=DisplayString, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, histCompVal=histCompVal, humUnit=humUnit, compValHystInt=compValHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, humAlarm=humAlarm, trapEmailErrLogin=trapEmailErrLogin, valuesInt=valuesInt, trapHumError=trapHumError, hum=hum)
