...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:13:16 2023
...
Counter32, MibIdentifier, ModuleIdentity, NotificationType, ObjectIdentity, Bits, IpAddress, NotificationType, Counter64, TimeTicks, enterprises, Integer32, iso, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Bits", "IpAddress", "NotificationType", "Counter64", "TimeTicks", "enterprises", "Integer32", "iso", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, trapCompValError=trapCompValError, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, humDelayInt=humDelayInt, compValLowInt=compValLowInt, trapEmailErrLogin=trapEmailErrLogin, hum=hum, tempHystInt=tempHystInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, humInt=humInt, humAlarmInt=humAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, humMax=humMax, tempMax=tempMax, compValDelayInt=compValDelayInt, tempAlarmInt=tempAlarmInt, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, compValHighInt=compValHighInt, valuesInt=valuesInt, trapHumClrAlarm=trapHumClrAlarm, comet=comet, humHighInt=humHighInt, compVal=compVal, trapCompValHighAlarm=trapCompValHighAlarm, compValInt=compValInt, trapTempError=trapTempError, compValAlarm=compValAlarm, compValMin=compValMin, humLowInt=humLowInt, trapSOAPErrSocket=trapSOAPErrSocket, traps=traps, compValMax=compValMax, humMin=humMin, values=values, t3610=t3610, products=products, tempHighInt=tempHighInt, trapTest=trapTest, humAlarm=humAlarm, humHystInt=humHystInt, trapTempClrAlarm=trapTempClrAlarm, messageString=messageString, trapHumError=trapHumError, deviceType=deviceType, trapTempLowAlarm=trapTempLowAlarm, sensorName=sensorName, tempDelayInt=tempDelayInt, historyTable=historyTable, compValHystInt=compValHystInt, DisplayString=DisplayString, tempMin=tempMin, historyEntry=historyEntry, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, histCompVal=histCompVal, trapNTPError=trapNTPError, serialNumber=serialNumber, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, tables=tables, trapSOAPErrDNS=trapSOAPErrDNS, compValAlarmInt=compValAlarmInt, histHum=histHum, humUnit=humUnit, histTemp=histTemp, compValUnit=compValUnit, temp=temp, tempInt=tempInt)
