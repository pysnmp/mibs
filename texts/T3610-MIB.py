...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:42:50 2021
...
iso, MibIdentifier, Integer32, ModuleIdentity, Unsigned32, IpAddress, TimeTicks, ObjectIdentity, NotificationType, Gauge32, enterprises, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Integer32", "ModuleIdentity", "Unsigned32", "IpAddress", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32", "enterprises", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", settings=settings, trapEmailErrDNS=trapEmailErrDNS, humLowInt=humLowInt, tempUnit=tempUnit, compValHighInt=compValHighInt, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, histHum=histHum, products=products, tempLowInt=tempLowInt, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, humMax=humMax, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrFile=trapSOAPErrFile, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, pysmi_global=pysmi_global, values=values, humInt=humInt, historyEntry=historyEntry, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrLogin=trapEmailErrLogin, trapHumLowAlarm=trapHumLowAlarm, humHighInt=humHighInt, compValMin=compValMin, tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapTempError=trapTempError, sensorName=sensorName, tempMin=tempMin, compValInt=compValInt, tempMax=tempMax, historyTable=historyTable, trapCompValError=trapCompValError, compValUnit=compValUnit, trapTempHighAlarm=trapTempHighAlarm, trapTest=trapTest, humAlarm=humAlarm, serialNumber=serialNumber, tempInt=tempInt, tempHighInt=tempHighInt, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, temp=temp, compVal=compVal, histTemp=histTemp, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, DisplayString=DisplayString, deviceType=deviceType, tempAlarmInt=tempAlarmInt, traps=traps, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, compValHystInt=compValHystInt, t3610=t3610, trapHumError=trapHumError, tables=tables, tempAlarm=tempAlarm, trapSOAPErrDNS=trapSOAPErrDNS, humAlarmInt=humAlarmInt, tempHystInt=tempHystInt, humHystInt=humHystInt, trapHumHighAlarm=trapHumHighAlarm, hum=hum, humMin=humMin, humUnit=humUnit, messageString=messageString, compValAlarm=compValAlarm)
