...
# Produced by pysmi-1.1.8 at Tue Jan 18 13:39:35 2022
...
NotificationType, iso, MibIdentifier, Integer32, TimeTicks, Gauge32, NotificationType, IpAddress, enterprises, Unsigned32, Counter32, Counter64, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "MibIdentifier", "Integer32", "TimeTicks", "Gauge32", "NotificationType", "IpAddress", "enterprises", "Unsigned32", "Counter32", "Counter64", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, compValUnit=compValUnit, humMax=humMax, sensorName=sensorName, t3610=t3610, compValHighInt=compValHighInt, valuesInt=valuesInt, messageString=messageString, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, tempLowInt=tempLowInt, humHighInt=humHighInt, compValLowInt=compValLowInt, traps=traps, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, trapHumHighAlarm=trapHumHighAlarm, humLowInt=humLowInt, comet=comet, histTemp=histTemp, serialNumber=serialNumber, humInt=humInt, humHystInt=humHystInt, trapEmailErrSome=trapEmailErrSome, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, compValInt=compValInt, trapEmailErrLogin=trapEmailErrLogin, trapHumClrAlarm=trapHumClrAlarm, compValHystInt=compValHystInt, tempMax=tempMax, tempAlarmInt=tempAlarmInt, values=values, products=products, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, temp=temp, trapCompValLowAlarm=trapCompValLowAlarm, hum=hum, compValMin=compValMin, tables=tables, deviceType=deviceType, humAlarm=humAlarm, compValMax=compValMax, humAlarmInt=humAlarmInt, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, histCompVal=histCompVal, tempInt=tempInt, trapEmailErrDNS=trapEmailErrDNS, humUnit=humUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, historyTable=historyTable, trapTempHighAlarm=trapTempHighAlarm, tempHystInt=tempHystInt, DisplayString=DisplayString, humMin=humMin, trapTempLowAlarm=trapTempLowAlarm, compVal=compVal, pysmi_global=pysmi_global, tempAlarm=tempAlarm, tempMin=tempMin, trapTest=trapTest, histHum=histHum, trapTempError=trapTempError, settings=settings, compValAlarm=compValAlarm)
