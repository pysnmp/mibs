...
# Produced by pysmi-1.1.10 at Mon Dec 11 02:35:10 2023
...
Integer32, IpAddress, Counter32, TimeTicks, Gauge32, Unsigned32, NotificationType, ModuleIdentity, Counter64, enterprises, NotificationType, iso, Bits, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Counter32", "TimeTicks", "Gauge32", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter64", "enterprises", "NotificationType", "iso", "Bits", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, sensorName=sensorName, trapEmailErrSome=trapEmailErrSome, histCompVal=histCompVal, hum=hum, DisplayString=DisplayString, tempAlarm=tempAlarm, humHystInt=humHystInt, trapNTPError=trapNTPError, compValDelayInt=compValDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, temp=temp, tempAlarmInt=tempAlarmInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempUnit=tempUnit, trapTempHighAlarm=trapTempHighAlarm, values=values, products=products, tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, tempInt=tempInt, trapCompValError=trapCompValError, compValUnit=compValUnit, settings=settings, histTemp=histTemp, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, humInt=humInt, humLowInt=humLowInt, histHum=histHum, tempMin=tempMin, valuesInt=valuesInt, compValHystInt=compValHystInt, tempHystInt=tempHystInt, compValInt=compValInt, t3610=t3610, compValHighInt=compValHighInt, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, messageString=messageString, trapTest=trapTest, traps=traps, pysmi_global=pysmi_global, humUnit=humUnit, trapHumHighAlarm=trapHumHighAlarm, tempHighInt=tempHighInt, humDelayInt=humDelayInt, humHighInt=humHighInt, humAlarm=humAlarm, tempMax=tempMax, trapTempError=trapTempError, compValAlarmInt=compValAlarmInt, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, compValMin=compValMin, compValLowInt=compValLowInt, compValMax=compValMax, humMin=humMin, compValAlarm=compValAlarm, comet=comet)
