...
# Produced by pysmi-1.1.3 at Tue Dec  7 14:00:34 2021
...
NotificationType, NotificationType, Gauge32, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, MibIdentifier, ObjectIdentity, enterprises, Counter32, iso, Integer32, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "Gauge32", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "MibIdentifier", "ObjectIdentity", "enterprises", "Counter32", "iso", "Integer32", "Counter64", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, humUnit=humUnit, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDNS=trapSOAPErrDNS, humInt=humInt, humDelayInt=humDelayInt, traps=traps, tables=tables, tempMin=tempMin, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, compValAlarmInt=compValAlarmInt, values=values, comet=comet, compVal=compVal, compValAlarm=compValAlarm, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, hum=hum, valuesInt=valuesInt, compValMin=compValMin, DisplayString=DisplayString, humHystInt=humHystInt, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, trapCompValError=trapCompValError, trapTempHighAlarm=trapTempHighAlarm, settings=settings, messageString=messageString, humMin=humMin, humHighInt=humHighInt, trapNTPError=trapNTPError, compValLowInt=compValLowInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempMax=tempMax, compValInt=compValInt, t3610=t3610, compValMax=compValMax, trapTempError=trapTempError, tempAlarm=tempAlarm, compValHighInt=compValHighInt, humLowInt=humLowInt, historyEntry=historyEntry, histHum=histHum, tempInt=tempInt, trapTest=trapTest, temp=temp, tempUnit=tempUnit, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, serialNumber=serialNumber, trapEmailErrSocket=trapEmailErrSocket, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrAuth=trapEmailErrAuth, pysmi_global=pysmi_global, deviceType=deviceType, compValDelayInt=compValDelayInt, products=products, tempAlarmInt=tempAlarmInt, humMax=humMax, humAlarm=humAlarm, trapEmailErrSome=trapEmailErrSome)
