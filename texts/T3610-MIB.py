...
# Produced by pysmi-1.1.12 at Tue Dec  3 12:32:51 2024
...
ObjectIdentity, NotificationType, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Unsigned32, MibIdentifier, NotificationType, iso, IpAddress, enterprises, Counter32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "NotificationType", "iso", "IpAddress", "enterprises", "Counter32", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", traps=traps, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, humInt=humInt, humHystInt=humHystInt, compValUnit=compValUnit, tempInt=tempInt, deviceType=deviceType, tables=tables, histTemp=histTemp, tempLowInt=tempLowInt, serialNumber=serialNumber, humAlarmInt=humAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, temp=temp, trapTempError=trapTempError, histHum=histHum, compValInt=compValInt, humAlarm=humAlarm, valuesInt=valuesInt, compVal=compVal, tempMax=tempMax, comet=comet, trapSOAPErrFile=trapSOAPErrFile, hum=hum, tempUnit=tempUnit, trapNTPError=trapNTPError, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrAuth=trapEmailErrAuth, sensorName=sensorName, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, compValMin=compValMin, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, humLowInt=humLowInt, trapEmailErrSocket=trapEmailErrSocket, tempAlarm=tempAlarm, tempHighInt=tempHighInt, trapEmailErrLogin=trapEmailErrLogin, humHighInt=humHighInt, messageString=messageString, trapTempLowAlarm=trapTempLowAlarm, compValMax=compValMax, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, histCompVal=histCompVal, pysmi_global=pysmi_global, trapHumLowAlarm=trapHumLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, compValHystInt=compValHystInt, tempMin=tempMin, products=products, tempDelayInt=tempDelayInt, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, trapTempHighAlarm=trapTempHighAlarm, humMin=humMin, humDelayInt=humDelayInt, values=values, humMax=humMax, DisplayString=DisplayString, compValHighInt=compValHighInt, tempAlarmInt=tempAlarmInt, t3610=t3610, historyTable=historyTable, compValDelayInt=compValDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, settings=settings)
