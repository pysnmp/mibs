...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:37:35 2021
...
ObjectIdentity, Unsigned32, NotificationType, enterprises, Integer32, TimeTicks, iso, Counter64, Bits, MibIdentifier, IpAddress, ModuleIdentity, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "NotificationType", "enterprises", "Integer32", "TimeTicks", "iso", "Counter64", "Bits", "MibIdentifier", "IpAddress", "ModuleIdentity", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", messageString=messageString, humAlarm=humAlarm, trapHumHighAlarm=trapHumHighAlarm, tempInt=tempInt, comet=comet, histHum=histHum, compValMin=compValMin, humMin=humMin, serialNumber=serialNumber, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, trapNTPError=trapNTPError, historyEntry=historyEntry, trapTempClrAlarm=trapTempClrAlarm, humInt=humInt, values=values, tempLowInt=tempLowInt, trapSOAPErrDNS=trapSOAPErrDNS, products=products, trapHumClrAlarm=trapHumClrAlarm, histTemp=histTemp, compValAlarm=compValAlarm, trapEmailErrSome=trapEmailErrSome, compValDelayInt=compValDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, deviceType=deviceType, humAlarmInt=humAlarmInt, temp=temp, compValLowInt=compValLowInt, DisplayString=DisplayString, sensorName=sensorName, settings=settings, humLowInt=humLowInt, compValMax=compValMax, trapCompValLowAlarm=trapCompValLowAlarm, trapTempLowAlarm=trapTempLowAlarm, traps=traps, tempUnit=tempUnit, compValUnit=compValUnit, compVal=compVal, tempHystInt=tempHystInt, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, histCompVal=histCompVal, compValInt=compValInt, humHighInt=humHighInt, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, hum=hum, pysmi_global=pysmi_global, tables=tables, humUnit=humUnit, valuesInt=valuesInt, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, t3610=t3610, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, compValAlarmInt=compValAlarmInt, tempMin=tempMin, humHystInt=humHystInt, trapCompValError=trapCompValError, tempMax=tempMax, humDelayInt=humDelayInt, compValHystInt=compValHystInt)
