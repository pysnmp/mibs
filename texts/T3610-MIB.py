...
Bits, NotificationType, NotificationType, Gauge32, Unsigned32, enterprises, TimeTicks, Counter32, ModuleIdentity, MibIdentifier, iso, ObjectIdentity, Counter64, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "NotificationType", "Gauge32", "Unsigned32", "enterprises", "TimeTicks", "Counter32", "ModuleIdentity", "MibIdentifier", "iso", "ObjectIdentity", "Counter64", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, compValAlarmInt=compValAlarmInt, humAlarmInt=humAlarmInt, compValMin=compValMin, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, temp=temp, tempAlarmInt=tempAlarmInt, humDelayInt=humDelayInt, valuesInt=valuesInt, tempLowInt=tempLowInt, humHighInt=humHighInt, compValLowInt=compValLowInt, compValAlarm=compValAlarm, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, t3610=t3610, settings=settings, compValDelayInt=compValDelayInt, humLowInt=humLowInt, traps=traps, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, tempUnit=tempUnit, tempAlarm=tempAlarm, historyEntry=historyEntry, historyTable=historyTable, tempDelayInt=tempDelayInt, humMin=humMin, messageString=messageString, trapTempError=trapTempError, tempMin=tempMin, trapCompValError=trapCompValError, hum=hum, compVal=compVal, tempHighInt=tempHighInt, histTemp=histTemp, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, trapSOAPErrSocket=trapSOAPErrSocket, humHystInt=humHystInt, pysmi_global=pysmi_global, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, compValHighInt=compValHighInt, DisplayString=DisplayString, trapTempClrAlarm=trapTempClrAlarm, humInt=humInt, trapHumClrAlarm=trapHumClrAlarm, trapHumLowAlarm=trapHumLowAlarm, comet=comet, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, histHum=histHum, trapEmailErrSome=trapEmailErrSome, trapHumError=trapHumError, tempMax=tempMax, deviceType=deviceType, humMax=humMax, sensorName=sensorName, tempInt=tempInt, values=values, compValInt=compValInt, products=products, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, trapNTPError=trapNTPError)
