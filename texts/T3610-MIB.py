...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:29:34 2023
...
MibIdentifier, IpAddress, enterprises, Bits, ModuleIdentity, Counter32, NotificationType, TimeTicks, Counter64, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "enterprises", "Bits", "ModuleIdentity", "Counter32", "NotificationType", "TimeTicks", "Counter64", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarmInt=compValAlarmInt, tempMax=tempMax, serialNumber=serialNumber, deviceType=deviceType, tempHighInt=tempHighInt, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, humLowInt=humLowInt, humHighInt=humHighInt, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, hum=hum, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, histHum=histHum, tempAlarm=tempAlarm, DisplayString=DisplayString, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, humHystInt=humHystInt, values=values, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, traps=traps, products=products, trapHumLowAlarm=trapHumLowAlarm, compValMax=compValMax, compValHystInt=compValHystInt, compValMin=compValMin, histTemp=histTemp, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, comet=comet, temp=temp, settings=settings, humDelayInt=humDelayInt, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, trapHumError=trapHumError, tempMin=tempMin, humAlarmInt=humAlarmInt, sensorName=sensorName, messageString=messageString, humMax=humMax, trapNTPError=trapNTPError, compValUnit=compValUnit, humAlarm=humAlarm, tempUnit=tempUnit, compValLowInt=compValLowInt, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrAuth=trapEmailErrAuth, valuesInt=valuesInt, humInt=humInt, compValHighInt=compValHighInt, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, trapCompValError=trapCompValError, tempInt=tempInt, t3610=t3610, tempDelayInt=tempDelayInt, humMin=humMin, compValInt=compValInt, historyTable=historyTable, compVal=compVal, histCompVal=histCompVal, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt)
