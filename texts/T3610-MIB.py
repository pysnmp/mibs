...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:06:05 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Integer32, Counter64, NotificationType, Gauge32, Unsigned32, Bits, iso, Counter32, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Integer32", "Counter64", "NotificationType", "Gauge32", "Unsigned32", "Bits", "iso", "Counter32", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, products=products, tempUnit=tempUnit, tempMax=tempMax, compValUnit=compValUnit, DisplayString=DisplayString, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, deviceType=deviceType, trapCompValError=trapCompValError, hum=hum, tempAlarm=tempAlarm, humInt=humInt, valuesInt=valuesInt, humHystInt=humHystInt, humAlarmInt=humAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, settings=settings, compValMin=compValMin, historyEntry=historyEntry, messageString=messageString, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, values=values, serialNumber=serialNumber, trapHumHighAlarm=trapHumHighAlarm, histTemp=histTemp, t3610=t3610, humMax=humMax, comet=comet, histHum=histHum, tempDelayInt=tempDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, humMin=humMin, sensorName=sensorName, tempInt=tempInt, pysmi_global=pysmi_global, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, compValHystInt=compValHystInt, humLowInt=humLowInt, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, humUnit=humUnit, tempLowInt=tempLowInt, trapTempError=trapTempError, trapTest=trapTest, compValAlarm=compValAlarm, tempMin=tempMin, compVal=compVal, trapEmailErrLogin=trapEmailErrLogin, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDNS=trapSOAPErrDNS, compValDelayInt=compValDelayInt, tempAlarmInt=tempAlarmInt, trapTempLowAlarm=trapTempLowAlarm, compValAlarmInt=compValAlarmInt, compValInt=compValInt, trapHumLowAlarm=trapHumLowAlarm, traps=traps, humHighInt=humHighInt, tempHystInt=tempHystInt, humDelayInt=humDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, compValHighInt=compValHighInt, compValMax=compValMax, tempHighInt=tempHighInt)
