...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:05:08 2022
...
Counter64, Bits, NotificationType, ModuleIdentity, Counter32, Unsigned32, MibIdentifier, NotificationType, enterprises, Gauge32, iso, IpAddress, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "NotificationType", "ModuleIdentity", "Counter32", "Unsigned32", "MibIdentifier", "NotificationType", "enterprises", "Gauge32", "iso", "IpAddress", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", tables=tables, trapHumClrAlarm=trapHumClrAlarm, tempInt=tempInt, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSome=trapEmailErrSome, humUnit=humUnit, compValLowInt=compValLowInt, humMax=humMax, compValHighInt=compValHighInt, compValUnit=compValUnit, trapHumError=trapHumError, humMin=humMin, trapEmailErrSocket=trapEmailErrSocket, humHystInt=humHystInt, products=products, trapTest=trapTest, compValInt=compValInt, trapNTPError=trapNTPError, tempLowInt=tempLowInt, comet=comet, trapSOAPErrDelivery=trapSOAPErrDelivery, historyEntry=historyEntry, humAlarmInt=humAlarmInt, histCompVal=histCompVal, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, histHum=histHum, compValMin=compValMin, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, humHighInt=humHighInt, compVal=compVal, sensorName=sensorName, DisplayString=DisplayString, humLowInt=humLowInt, trapEmailErrDNS=trapEmailErrDNS, traps=traps, settings=settings, serialNumber=serialNumber, deviceType=deviceType, histTemp=histTemp, compValMax=compValMax, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, values=values, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, trapCompValError=trapCompValError, trapCompValLowAlarm=trapCompValLowAlarm, humDelayInt=humDelayInt, temp=temp, trapTempError=trapTempError, compValHystInt=compValHystInt, historyTable=historyTable, trapSOAPErrDNS=trapSOAPErrDNS, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, pysmi_global=pysmi_global, tempAlarm=tempAlarm, humInt=humInt, hum=hum, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, t3610=t3610, trapCompValClrAlarm=trapCompValClrAlarm, tempMax=tempMax, tempMin=tempMin, compValAlarm=compValAlarm)
