...
mibBuilder.exportSymbols("T3610-MIB", tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, tempMin=tempMin, compValAlarm=compValAlarm, settings=settings, pysmi_global=pysmi_global, tempAlarm=tempAlarm, humAlarm=humAlarm, humMax=humMax, tables=tables, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, hum=hum, serialNumber=serialNumber, valuesInt=valuesInt, trapTempError=trapTempError, trapCompValError=trapCompValError, compValHystInt=compValHystInt, humHystInt=humHystInt, compValLowInt=compValLowInt, histCompVal=histCompVal, products=products, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarmInt=tempAlarmInt, DisplayString=DisplayString, compValInt=compValInt, humUnit=humUnit, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrFile=trapSOAPErrFile, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, humHighInt=humHighInt, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, sensorName=sensorName, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, messageString=messageString, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, humInt=humInt, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, histTemp=histTemp, compValAlarmInt=compValAlarmInt, comet=comet, compValUnit=compValUnit, trapTempLowAlarm=trapTempLowAlarm, deviceType=deviceType, trapCompValLowAlarm=trapCompValLowAlarm, compValHighInt=compValHighInt, trapHumError=trapHumError, tempHighInt=tempHighInt, compValMax=compValMax, humMin=humMin, trapEmailErrDNS=trapEmailErrDNS, tempUnit=tempUnit, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, tempMax=tempMax, tempInt=tempInt, temp=temp, t3610=t3610, trapTempHighAlarm=trapTempHighAlarm, traps=traps, compValMin=compValMin, trapEmailErrLogin=trapEmailErrLogin, trapNTPError=trapNTPError, compVal=compVal, tempHystInt=tempHystInt, values=values, trapSOAPErrDNS=trapSOAPErrDNS)
