...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:13:19 2022
...
NotificationType, ModuleIdentity, Bits, ObjectIdentity, NotificationType, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Unsigned32, Gauge32, IpAddress, MibIdentifier, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Bits", "ObjectIdentity", "NotificationType", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Unsigned32", "Gauge32", "IpAddress", "MibIdentifier", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, histTemp=histTemp, trapEmailErrDNS=trapEmailErrDNS, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, humHystInt=humHystInt, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, traps=traps, serialNumber=serialNumber, humInt=humInt, trapEmailErrSocket=trapEmailErrSocket, tempLowInt=tempLowInt, historyTable=historyTable, historyEntry=historyEntry, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, tempMax=tempMax, compValDelayInt=compValDelayInt, tempDelayInt=tempDelayInt, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, deviceType=deviceType, compValInt=compValInt, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, trapTest=trapTest, trapHumLowAlarm=trapHumLowAlarm, trapCompValError=trapCompValError, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, trapCompValHighAlarm=trapCompValHighAlarm, humHighInt=humHighInt, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, trapEmailErrSome=trapEmailErrSome, humMax=humMax, compValMax=compValMax, compValAlarmInt=compValAlarmInt, humAlarm=humAlarm, trapSOAPErrDNS=trapSOAPErrDNS, compVal=compVal, sensorName=sensorName, histCompVal=histCompVal, trapNTPError=trapNTPError, compValMin=compValMin, compValAlarm=compValAlarm, pysmi_global=pysmi_global, humLowInt=humLowInt, trapEmailErrAuth=trapEmailErrAuth, humUnit=humUnit, products=products, humAlarmInt=humAlarmInt, values=values, comet=comet, compValLowInt=compValLowInt, temp=temp, tempAlarm=tempAlarm, tempHighInt=tempHighInt, humDelayInt=humDelayInt, tables=tables, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, tempHystInt=tempHystInt, tempMin=tempMin, trapTempError=trapTempError, compValHighInt=compValHighInt, valuesInt=valuesInt, compValUnit=compValUnit, t3610=t3610, hum=hum, messageString=messageString, compValHystInt=compValHystInt)
