...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:10:40 2023
...
Bits, enterprises, iso, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Unsigned32, IpAddress, MibIdentifier, NotificationType, ModuleIdentity, Counter64, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "iso", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "ModuleIdentity", "Counter64", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, trapTempLowAlarm=trapTempLowAlarm, DisplayString=DisplayString, trapTempError=trapTempError, tempHighInt=tempHighInt, trapCompValError=trapCompValError, deviceType=deviceType, humDelayInt=humDelayInt, trapEmailErrSocket=trapEmailErrSocket, sensorName=sensorName, historyTable=historyTable, humUnit=humUnit, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, valuesInt=valuesInt, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, histHum=histHum, tables=tables, humHighInt=humHighInt, tempMax=tempMax, trapTempClrAlarm=trapTempClrAlarm, humMin=humMin, compValHystInt=compValHystInt, humAlarm=humAlarm, trapTempHighAlarm=trapTempHighAlarm, humHystInt=humHystInt, t3610=t3610, humMax=humMax, tempInt=tempInt, messageString=messageString, pysmi_global=pysmi_global, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, humLowInt=humLowInt, trapEmailErrAuth=trapEmailErrAuth, traps=traps, trapTest=trapTest, serialNumber=serialNumber, compValInt=compValInt, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, hum=hum, tempLowInt=tempLowInt, tempUnit=tempUnit, compValAlarm=compValAlarm, tempHystInt=tempHystInt, tempDelayInt=tempDelayInt, humInt=humInt, tempAlarm=tempAlarm, trapSOAPErrDNS=trapSOAPErrDNS, values=values, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumLowAlarm=trapHumLowAlarm, products=products, compVal=compVal, compValHighInt=compValHighInt, humAlarmInt=humAlarmInt, trapEmailErrSome=trapEmailErrSome, trapCompValHighAlarm=trapCompValHighAlarm, tempMin=tempMin, compValUnit=compValUnit, temp=temp, compValAlarmInt=compValAlarmInt, settings=settings, comet=comet, trapHumError=trapHumError, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt)
