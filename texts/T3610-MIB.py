...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:12:35 2022
...
NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Counter64, NotificationType, Gauge32, ModuleIdentity, IpAddress, Integer32, TimeTicks, Unsigned32, iso, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Counter64", "NotificationType", "Gauge32", "ModuleIdentity", "IpAddress", "Integer32", "TimeTicks", "Unsigned32", "iso", "Bits", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", pysmi_global=pysmi_global, sensorName=sensorName, histHum=histHum, values=values, compValHighInt=compValHighInt, tempAlarmInt=tempAlarmInt, compVal=compVal, hum=hum, trapTempHighAlarm=trapTempHighAlarm, traps=traps, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, serialNumber=serialNumber, tempMin=tempMin, trapCompValError=trapCompValError, tempDelayInt=tempDelayInt, humMin=humMin, trapTempError=trapTempError, humHighInt=humHighInt, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, humLowInt=humLowInt, trapNTPError=trapNTPError, humMax=humMax, compValDelayInt=compValDelayInt, trapHumLowAlarm=trapHumLowAlarm, comet=comet, tempAlarm=tempAlarm, tables=tables, deviceType=deviceType, trapSOAPErrSocket=trapSOAPErrSocket, historyTable=historyTable, historyEntry=historyEntry, trapTempClrAlarm=trapTempClrAlarm, humHystInt=humHystInt, tempInt=tempInt, tempLowInt=tempLowInt, compValHystInt=compValHystInt, histTemp=histTemp, trapSOAPErrFile=trapSOAPErrFile, DisplayString=DisplayString, compValAlarm=compValAlarm, tempMax=tempMax, humAlarm=humAlarm, products=products, trapEmailErrLogin=trapEmailErrLogin, humDelayInt=humDelayInt, t3610=t3610, compValMin=compValMin, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, messageString=messageString, trapHumError=trapHumError, humInt=humInt, settings=settings, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, valuesInt=valuesInt, temp=temp, tempUnit=tempUnit, compValInt=compValInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, compValLowInt=compValLowInt, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humAlarmInt=humAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery)
