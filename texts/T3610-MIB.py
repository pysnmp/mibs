...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:15:27 2022
...
Bits, ObjectIdentity, Counter32, TimeTicks, Counter64, Integer32, MibIdentifier, NotificationType, NotificationType, Unsigned32, IpAddress, ModuleIdentity, Gauge32, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter32", "TimeTicks", "Counter64", "Integer32", "MibIdentifier", "NotificationType", "NotificationType", "Unsigned32", "IpAddress", "ModuleIdentity", "Gauge32", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", humMin=humMin, trapNTPError=trapNTPError, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, humAlarm=humAlarm, tempUnit=tempUnit, humMax=humMax, trapEmailErrSome=trapEmailErrSome, compValAlarmInt=compValAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, temp=temp, compValUnit=compValUnit, compValLowInt=compValLowInt, compValAlarm=compValAlarm, humDelayInt=humDelayInt, humHystInt=humHystInt, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, tempAlarm=tempAlarm, tempInt=tempInt, pysmi_global=pysmi_global, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, tables=tables, products=products, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, histHum=histHum, compValMin=compValMin, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, compValMax=compValMax, histCompVal=histCompVal, trapTest=trapTest, sensorName=sensorName, tempDelayInt=tempDelayInt, historyTable=historyTable, humHighInt=humHighInt, trapEmailErrSocket=trapEmailErrSocket, compValHighInt=compValHighInt, trapTempError=trapTempError, settings=settings, tempLowInt=tempLowInt, histTemp=histTemp, messageString=messageString, deviceType=deviceType, DisplayString=DisplayString, humAlarmInt=humAlarmInt, compVal=compVal, humLowInt=humLowInt, humInt=humInt, traps=traps, tempHighInt=tempHighInt, trapSOAPErrFile=trapSOAPErrFile, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, values=values, hum=hum, tempAlarmInt=tempAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, tempMax=tempMax, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, t3610=t3610, serialNumber=serialNumber, compValInt=compValInt, trapCompValError=trapCompValError, comet=comet, humUnit=humUnit, trapHumClrAlarm=trapHumClrAlarm)
