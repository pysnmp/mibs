...
# Produced by pysmi-1.1.12 at Tue Sep 17 09:58:09 2024
...
Unsigned32, Integer32, Bits, NotificationType, enterprises, Counter32, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter64, iso, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Bits", "NotificationType", "enterprises", "Counter32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter64", "iso", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, historyEntry=historyEntry, humMax=humMax, trapNTPError=trapNTPError, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrDNS=trapEmailErrDNS, traps=traps, tempMax=tempMax, compValInt=compValInt, compValHighInt=compValHighInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, deviceType=deviceType, compValAlarm=compValAlarm, trapHumClrAlarm=trapHumClrAlarm, hum=hum, temp=temp, tempHighInt=tempHighInt, trapCompValClrAlarm=trapCompValClrAlarm, pysmi_global=pysmi_global, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, trapTest=trapTest, tempInt=tempInt, humMin=humMin, humAlarmInt=humAlarmInt, compValLowInt=compValLowInt, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm, trapHumLowAlarm=trapHumLowAlarm, humInt=humInt, compValHystInt=compValHystInt, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, compValMax=compValMax, messageString=messageString, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, products=products, trapTempError=trapTempError, trapHumError=trapHumError, historyTable=historyTable, humHystInt=humHystInt, t3610=t3610, histHum=histHum, tables=tables, sensorName=sensorName, humHighInt=humHighInt, serialNumber=serialNumber, histCompVal=histCompVal, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, humLowInt=humLowInt, comet=comet, tempLowInt=tempLowInt, compValDelayInt=compValDelayInt, tempMin=tempMin, tempAlarmInt=tempAlarmInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, humUnit=humUnit, compVal=compVal, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, tempAlarm=tempAlarm, settings=settings, humAlarm=humAlarm, valuesInt=valuesInt, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, values=values)
