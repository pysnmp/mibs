...
Integer32, iso, NotificationType, Counter64, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, enterprises, Bits, IpAddress, MibIdentifier, ModuleIdentity, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "NotificationType", "Counter64", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "enterprises", "Bits", "IpAddress", "MibIdentifier", "ModuleIdentity", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, humHystInt=humHystInt, trapHumClrAlarm=trapHumClrAlarm, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, DisplayString=DisplayString, settings=settings, tempMax=tempMax, humInt=humInt, compValInt=compValInt, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, t3610=t3610, humHighInt=humHighInt, trapSOAPErrFile=trapSOAPErrFile, trapHumLowAlarm=trapHumLowAlarm, trapTempHighAlarm=trapTempHighAlarm, tables=tables, trapHumHighAlarm=trapHumHighAlarm, values=values, hum=hum, compValAlarmInt=compValAlarmInt, compValMin=compValMin, humMin=humMin, tempInt=tempInt, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, histTemp=histTemp, trapEmailErrSome=trapEmailErrSome, trapEmailErrSocket=trapEmailErrSocket, valuesInt=valuesInt, trapSOAPErrSocket=trapSOAPErrSocket, traps=traps, pysmi_global=pysmi_global, humAlarm=humAlarm, tempUnit=tempUnit, histCompVal=histCompVal, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, products=products, compValLowInt=compValLowInt, humDelayInt=humDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, serialNumber=serialNumber, trapCompValError=trapCompValError, comet=comet, tempMin=tempMin, tempDelayInt=tempDelayInt, trapEmailErrLogin=trapEmailErrLogin, tempAlarmInt=tempAlarmInt, tempHystInt=tempHystInt, historyTable=historyTable, sensorName=sensorName, temp=temp, trapTempError=trapTempError, tempAlarm=tempAlarm, humLowInt=humLowInt, compVal=compVal, compValMax=compValMax, compValHighInt=compValHighInt, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, deviceType=deviceType, compValHystInt=compValHystInt, trapTest=trapTest, trapTempClrAlarm=trapTempClrAlarm, humMax=humMax, compValUnit=compValUnit, compValAlarm=compValAlarm, messageString=messageString)
