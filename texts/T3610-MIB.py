...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:00:04 2023
...
Integer32, Gauge32, ModuleIdentity, Bits, IpAddress, MibIdentifier, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, TimeTicks, NotificationType, Unsigned32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "ModuleIdentity", "Bits", "IpAddress", "MibIdentifier", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "TimeTicks", "NotificationType", "Unsigned32", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", serialNumber=serialNumber, compValUnit=compValUnit, histHum=histHum, values=values, humUnit=humUnit, tempAlarm=tempAlarm, trapHumLowAlarm=trapHumLowAlarm, trapTempHighAlarm=trapTempHighAlarm, valuesInt=valuesInt, sensorName=sensorName, compValInt=compValInt, humHighInt=humHighInt, compValDelayInt=compValDelayInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, compValMin=compValMin, humInt=humInt, trapTest=trapTest, tempUnit=tempUnit, tempInt=tempInt, trapHumClrAlarm=trapHumClrAlarm, temp=temp, messageString=messageString, tables=tables, trapCompValHighAlarm=trapCompValHighAlarm, trapHumHighAlarm=trapHumHighAlarm, humHystInt=humHystInt, tempHystInt=tempHystInt, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarm=compValAlarm, compValAlarmInt=compValAlarmInt, trapNTPError=trapNTPError, tempDelayInt=tempDelayInt, settings=settings, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, tempMax=tempMax, hum=hum, historyTable=historyTable, compValLowInt=compValLowInt, humDelayInt=humDelayInt, comet=comet, deviceType=deviceType, compValHighInt=compValHighInt, histCompVal=histCompVal, products=products, DisplayString=DisplayString, humMin=humMin, compVal=compVal, trapEmailErrSome=trapEmailErrSome, pysmi_global=pysmi_global, t3610=t3610, trapEmailErrDNS=trapEmailErrDNS, traps=traps, humAlarm=humAlarm, humMax=humMax, humLowInt=humLowInt, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, compValHystInt=compValHystInt, tempMin=tempMin, humAlarmInt=humAlarmInt, trapCompValError=trapCompValError, tempAlarmInt=tempAlarmInt, tempLowInt=tempLowInt, compValMax=compValMax)
