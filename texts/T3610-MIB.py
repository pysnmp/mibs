...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:34:43 2024
...
Gauge32, MibIdentifier, iso, TimeTicks, Counter64, ObjectIdentity, Unsigned32, Integer32, NotificationType, Counter32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "iso", "TimeTicks", "Counter64", "ObjectIdentity", "Unsigned32", "Integer32", "NotificationType", "Counter32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, deviceType=deviceType, messageString=messageString, trapTempClrAlarm=trapTempClrAlarm, humMin=humMin, tempAlarmInt=tempAlarmInt, trapHumError=trapHumError, comet=comet, trapTempError=trapTempError, compValMax=compValMax, compValHystInt=compValHystInt, historyTable=historyTable, valuesInt=valuesInt, humInt=humInt, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, tempUnit=tempUnit, compValInt=compValInt, compVal=compVal, humHighInt=humHighInt, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, humHystInt=humHystInt, sensorName=sensorName, tempMax=tempMax, products=products, histTemp=histTemp, trapTest=trapTest, tempHighInt=tempHighInt, tempHystInt=tempHystInt, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, traps=traps, tempLowInt=tempLowInt, tempInt=tempInt, humAlarmInt=humAlarmInt, compValUnit=compValUnit, compValLowInt=compValLowInt, hum=hum, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, values=values, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarmInt=compValAlarmInt, compValAlarm=compValAlarm, compValHighInt=compValHighInt, serialNumber=serialNumber, tempDelayInt=tempDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, t3610=t3610, tempMin=tempMin, settings=settings, humAlarm=humAlarm, trapNTPError=trapNTPError, tempAlarm=tempAlarm, temp=temp, pysmi_global=pysmi_global, DisplayString=DisplayString, compValMin=compValMin, humLowInt=humLowInt, compValDelayInt=compValDelayInt, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, humUnit=humUnit, trapEmailErrLogin=trapEmailErrLogin)
