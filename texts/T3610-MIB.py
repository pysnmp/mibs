...
# Produced by pysmi-1.1.3 at Tue Nov 30 14:00:04 2021
...
ObjectIdentity, MibIdentifier, NotificationType, Gauge32, NotificationType, Bits, enterprises, Counter32, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, iso, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "NotificationType", "Gauge32", "NotificationType", "Bits", "enterprises", "Counter32", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "iso", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrSocket=trapSOAPErrSocket, trapTempError=trapTempError, trapTest=trapTest, tempAlarmInt=tempAlarmInt, traps=traps, humDelayInt=humDelayInt, compValLowInt=compValLowInt, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, compValMax=compValMax, compValAlarm=compValAlarm, settings=settings, tempHighInt=tempHighInt, messageString=messageString, compVal=compVal, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, histHum=histHum, humUnit=humUnit, tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, compValHystInt=compValHystInt, histTemp=histTemp, trapCompValLowAlarm=trapCompValLowAlarm, compValInt=compValInt, trapHumError=trapHumError, tempLowInt=tempLowInt, t3610=t3610, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHystInt=tempHystInt, humHystInt=humHystInt, humMin=humMin, trapSOAPErrFile=trapSOAPErrFile, temp=temp, historyTable=historyTable, compValDelayInt=compValDelayInt, tempMin=tempMin, deviceType=deviceType, hum=hum, DisplayString=DisplayString, humMax=humMax, compValUnit=compValUnit, sensorName=sensorName, humLowInt=humLowInt, products=products, humInt=humInt, compValHighInt=compValHighInt, tempDelayInt=tempDelayInt, trapNTPError=trapNTPError, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, humAlarm=humAlarm, trapTempHighAlarm=trapTempHighAlarm, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, valuesInt=valuesInt, histCompVal=histCompVal, historyEntry=historyEntry, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapTempLowAlarm=trapTempLowAlarm, compValMin=compValMin, trapCompValHighAlarm=trapCompValHighAlarm, comet=comet, trapHumLowAlarm=trapHumLowAlarm, values=values, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, tables=tables, trapCompValClrAlarm=trapCompValClrAlarm, serialNumber=serialNumber)
