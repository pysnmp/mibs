...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, IpAddress, Counter32, Gauge32, Unsigned32, enterprises, Integer32, Counter64, iso, NotificationType, MibIdentifier, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "IpAddress", "Counter32", "Gauge32", "Unsigned32", "enterprises", "Integer32", "Counter64", "iso", "NotificationType", "MibIdentifier", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, trapSOAPErrSocket=trapSOAPErrSocket, DisplayString=DisplayString, compValHystInt=compValHystInt, trapTempHighAlarm=trapTempHighAlarm, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, tempMax=tempMax, compValMax=compValMax, compValAlarmInt=compValAlarmInt, values=values, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, hum=hum, trapTempError=trapTempError, temp=temp, trapEmailErrDNS=trapEmailErrDNS, compValHighInt=compValHighInt, comet=comet, traps=traps, trapHumError=trapHumError, trapSOAPErrFile=trapSOAPErrFile, humInt=humInt, trapEmailErrSocket=trapEmailErrSocket, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, historyTable=historyTable, humHighInt=humHighInt, trapCompValError=trapCompValError, trapEmailErrSome=trapEmailErrSome, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrLogin=trapEmailErrLogin, compValMin=compValMin, humMax=humMax, deviceType=deviceType, tempAlarm=tempAlarm, products=products, compValInt=compValInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValLowInt=compValLowInt, compValDelayInt=compValDelayInt, histCompVal=histCompVal, messageString=messageString, tempHighInt=tempHighInt, pysmi_global=pysmi_global, historyEntry=historyEntry, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, humAlarmInt=humAlarmInt, compVal=compVal, humUnit=humUnit, humAlarm=humAlarm, sensorName=sensorName, trapCompValLowAlarm=trapCompValLowAlarm, humDelayInt=humDelayInt, settings=settings, tempInt=tempInt, tempAlarmInt=tempAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, t3610=t3610, trapNTPError=trapNTPError, compValAlarm=compValAlarm, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, tables=tables, tempLowInt=tempLowInt, tempHystInt=tempHystInt, humLowInt=humLowInt, humHystInt=humHystInt, compValUnit=compValUnit, tempMin=tempMin, tempDelayInt=tempDelayInt, serialNumber=serialNumber, humMin=humMin)
