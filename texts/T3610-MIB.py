...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:27:08 2024
...
ObjectIdentity, ModuleIdentity, Bits, IpAddress, Counter32, NotificationType, Gauge32, NotificationType, enterprises, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Bits", "IpAddress", "Counter32", "NotificationType", "Gauge32", "NotificationType", "enterprises", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValClrAlarm=trapCompValClrAlarm, DisplayString=DisplayString, comet=comet, humAlarm=humAlarm, t3610=t3610, deviceType=deviceType, compValAlarmInt=compValAlarmInt, trapTest=trapTest, trapNTPError=trapNTPError, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, values=values, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrSocket=trapEmailErrSocket, compValHystInt=compValHystInt, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, humHystInt=humHystInt, trapTempClrAlarm=trapTempClrAlarm, humMax=humMax, products=products, tempAlarm=tempAlarm, histCompVal=histCompVal, trapTempError=trapTempError, trapTempLowAlarm=trapTempLowAlarm, tempAlarmInt=tempAlarmInt, trapTempHighAlarm=trapTempHighAlarm, compValInt=compValInt, tempHighInt=tempHighInt, compValUnit=compValUnit, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, messageString=messageString, humHighInt=humHighInt, humInt=humInt, compVal=compVal, compValAlarm=compValAlarm, trapEmailErrSome=trapEmailErrSome, compValMin=compValMin, humMin=humMin, historyEntry=historyEntry, tempUnit=tempUnit, historyTable=historyTable, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, serialNumber=serialNumber, valuesInt=valuesInt, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, sensorName=sensorName, tempLowInt=tempLowInt, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, trapCompValHighAlarm=trapCompValHighAlarm, temp=temp, tempMax=tempMax, compValHighInt=compValHighInt, tempInt=tempInt, traps=traps, humUnit=humUnit, settings=settings, tables=tables, hum=hum, tempHystInt=tempHystInt, histTemp=histTemp, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarmInt=humAlarmInt, compValMax=compValMax, pysmi_global=pysmi_global, trapCompValError=trapCompValError)
