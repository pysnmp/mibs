...
# Produced by pysmi-1.1.12 at Tue May 28 11:44:50 2024
...
Bits, Counter64, MibIdentifier, Unsigned32, Counter32, iso, ObjectIdentity, ModuleIdentity, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Integer32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "MibIdentifier", "Unsigned32", "Counter32", "iso", "ObjectIdentity", "ModuleIdentity", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Integer32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarm=tempAlarm, compValMax=compValMax, deviceType=deviceType, trapTempHighAlarm=trapTempHighAlarm, trapNTPError=trapNTPError, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compValInt=compValInt, sensorName=sensorName, tempDelayInt=tempDelayInt, compValLowInt=compValLowInt, trapSOAPErrDNS=trapSOAPErrDNS, DisplayString=DisplayString, trapTempLowAlarm=trapTempLowAlarm, values=values, humInt=humInt, humAlarm=humAlarm, compVal=compVal, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrAuth=trapEmailErrAuth, tempLowInt=tempLowInt, humLowInt=humLowInt, trapEmailErrSome=trapEmailErrSome, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, products=products, trapTempError=trapTempError, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, traps=traps, comet=comet, historyEntry=historyEntry, humDelayInt=humDelayInt, trapHumClrAlarm=trapHumClrAlarm, historyTable=historyTable, compValUnit=compValUnit, tables=tables, compValMin=compValMin, humMin=humMin, temp=temp, trapCompValClrAlarm=trapCompValClrAlarm, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, humUnit=humUnit, humMax=humMax, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, trapEmailErrLogin=trapEmailErrLogin, settings=settings, compValAlarmInt=compValAlarmInt, compValAlarm=compValAlarm, messageString=messageString, hum=hum, trapSOAPErrFile=trapSOAPErrFile, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, trapTest=trapTest, pysmi_global=pysmi_global, tempHighInt=tempHighInt, t3610=t3610, humHighInt=humHighInt, humHystInt=humHystInt, histCompVal=histCompVal, compValHighInt=compValHighInt, trapCompValError=trapCompValError, tempInt=tempInt, valuesInt=valuesInt, serialNumber=serialNumber, tempUnit=tempUnit, tempMax=tempMax)
