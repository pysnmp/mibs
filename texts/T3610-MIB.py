...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:00:35 2023
...
IpAddress, NotificationType, enterprises, Gauge32, NotificationType, iso, Integer32, TimeTicks, ModuleIdentity, Counter64, Counter32, Unsigned32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "enterprises", "Gauge32", "NotificationType", "iso", "Integer32", "TimeTicks", "ModuleIdentity", "Counter64", "Counter32", "Unsigned32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", compValHystInt=compValHystInt, trapNTPError=trapNTPError, humMax=humMax, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, values=values, compValDelayInt=compValDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, temp=temp, deviceType=deviceType, DisplayString=DisplayString, pysmi_global=pysmi_global, tempInt=tempInt, tempMax=tempMax, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, settings=settings, humHystInt=humHystInt, humInt=humInt, histHum=histHum, trapCompValError=trapCompValError, tempAlarmInt=tempAlarmInt, trapEmailErrAuth=trapEmailErrAuth, tempMin=tempMin, humAlarmInt=humAlarmInt, trapHumError=trapHumError, trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, comet=comet, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, sensorName=sensorName, t3610=t3610, compValLowInt=compValLowInt, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, compVal=compVal, humUnit=humUnit, compValMax=compValMax, trapTempLowAlarm=trapTempLowAlarm, tempAlarm=tempAlarm, humDelayInt=humDelayInt, traps=traps, humMin=humMin, tempDelayInt=tempDelayInt, trapTest=trapTest, humLowInt=humLowInt, trapCompValClrAlarm=trapCompValClrAlarm, tempLowInt=tempLowInt, historyTable=historyTable, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, compValMin=compValMin, hum=hum, humAlarm=humAlarm, tempHystInt=tempHystInt, messageString=messageString, compValHighInt=compValHighInt, trapTempError=trapTempError, compValAlarm=compValAlarm, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, histTemp=histTemp, tables=tables, products=products, trapHumClrAlarm=trapHumClrAlarm)
