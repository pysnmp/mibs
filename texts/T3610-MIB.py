...
# Produced by pysmi-1.1.10 at Mon Feb 12 02:20:16 2024
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, NotificationType, Counter64, Gauge32, Bits, iso, ModuleIdentity, enterprises, MibIdentifier, TimeTicks, IpAddress, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "NotificationType", "Counter64", "Gauge32", "Bits", "iso", "ModuleIdentity", "enterprises", "MibIdentifier", "TimeTicks", "IpAddress", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, tempHighInt=tempHighInt, humLowInt=humLowInt, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, humAlarmInt=humAlarmInt, trapHumError=trapHumError, humHighInt=humHighInt, compValMin=compValMin, compValInt=compValInt, hum=hum, valuesInt=valuesInt, traps=traps, tempHystInt=tempHystInt, trapHumHighAlarm=trapHumHighAlarm, humInt=humInt, trapHumClrAlarm=trapHumClrAlarm, compValUnit=compValUnit, settings=settings, histTemp=histTemp, tables=tables, trapTempClrAlarm=trapTempClrAlarm, compValAlarm=compValAlarm, trapTempError=trapTempError, histHum=histHum, compVal=compVal, compValDelayInt=compValDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, compValHystInt=compValHystInt, compValHighInt=compValHighInt, pysmi_global=pysmi_global, trapSOAPErrFile=trapSOAPErrFile, humMin=humMin, tempMin=tempMin, trapTest=trapTest, humMax=humMax, values=values, histCompVal=histCompVal, comet=comet, tempAlarmInt=tempAlarmInt, compValLowInt=compValLowInt, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrDNS=trapEmailErrDNS, tempAlarm=tempAlarm, tempMax=tempMax, temp=temp, t3610=t3610, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, compValMax=compValMax, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, serialNumber=serialNumber, tempInt=tempInt, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSocket=trapEmailErrSocket, trapCompValError=trapCompValError, DisplayString=DisplayString, sensorName=sensorName, tempDelayInt=tempDelayInt, products=products, humAlarm=humAlarm, humDelayInt=humDelayInt, messageString=messageString, trapCompValHighAlarm=trapCompValHighAlarm, humHystInt=humHystInt)
