...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:16:37 2023
...
NotificationType, enterprises, ObjectIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Unsigned32, Integer32, NotificationType, MibIdentifier, ModuleIdentity, TimeTicks, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "ObjectIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Unsigned32", "Integer32", "NotificationType", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Gauge32", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarmInt=humAlarmInt, humHystInt=humHystInt, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, sensorName=sensorName, tempAlarm=tempAlarm, trapCompValError=trapCompValError, tempMax=tempMax, deviceType=deviceType, products=products, messageString=messageString, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempUnit=tempUnit, tempHighInt=tempHighInt, humUnit=humUnit, hum=hum, settings=settings, tempMin=tempMin, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrFile=trapSOAPErrFile, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, trapTempError=trapTempError, trapEmailErrSome=trapEmailErrSome, tempInt=tempInt, humInt=humInt, compValHighInt=compValHighInt, values=values, humDelayInt=humDelayInt, t3610=t3610, humMax=humMax, compValInt=compValInt, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, traps=traps, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, temp=temp, trapHumLowAlarm=trapHumLowAlarm, compValUnit=compValUnit, trapEmailErrSocket=trapEmailErrSocket, tempLowInt=tempLowInt, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, valuesInt=valuesInt, serialNumber=serialNumber, compValLowInt=compValLowInt, tables=tables, historyTable=historyTable, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humLowInt=humLowInt, pysmi_global=pysmi_global, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDNS=trapSOAPErrDNS, DisplayString=DisplayString, compValAlarm=compValAlarm, compValMax=compValMax, humHighInt=humHighInt, tempHystInt=tempHystInt, histCompVal=histCompVal, compValMin=compValMin, compVal=compVal, trapNTPError=trapNTPError, trapHumError=trapHumError, histTemp=histTemp)
