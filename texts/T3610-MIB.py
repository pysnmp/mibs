...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:47:18 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Unsigned32, NotificationType, NotificationType, MibIdentifier, Gauge32, enterprises, iso, Counter32, IpAddress, ModuleIdentity, ObjectIdentity, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Unsigned32", "NotificationType", "NotificationType", "MibIdentifier", "Gauge32", "enterprises", "iso", "Counter32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", tempDelayInt=tempDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, humHighInt=humHighInt, temp=temp, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, tempMin=tempMin, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, hum=hum, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, compValAlarmInt=compValAlarmInt, t3610=t3610, trapSOAPErrDelivery=trapSOAPErrDelivery, tables=tables, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSocket=trapEmailErrSocket, humMin=humMin, histTemp=histTemp, compValInt=compValInt, trapHumHighAlarm=trapHumHighAlarm, trapTempError=trapTempError, valuesInt=valuesInt, histHum=histHum, humAlarm=humAlarm, compValDelayInt=compValDelayInt, compValHystInt=compValHystInt, humUnit=humUnit, tempUnit=tempUnit, settings=settings, deviceType=deviceType, humAlarmInt=humAlarmInt, humLowInt=humLowInt, humDelayInt=humDelayInt, DisplayString=DisplayString, serialNumber=serialNumber, tempHystInt=tempHystInt, messageString=messageString, trapSOAPErrFile=trapSOAPErrFile, values=values, histCompVal=histCompVal, compValAlarm=compValAlarm, historyTable=historyTable, historyEntry=historyEntry, products=products, compVal=compVal, trapTempHighAlarm=trapTempHighAlarm, trapHumError=trapHumError, humInt=humInt, tempLowInt=tempLowInt, trapCompValLowAlarm=trapCompValLowAlarm, compValMax=compValMax, tempInt=tempInt, humMax=humMax, comet=comet, pysmi_global=pysmi_global, compValUnit=compValUnit, tempHighInt=tempHighInt, tempMax=tempMax, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, compValLowInt=compValLowInt, trapNTPError=trapNTPError, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt, trapEmailErrDNS=trapEmailErrDNS, trapTest=trapTest, traps=traps, trapCompValError=trapCompValError)
