...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:01:30 2023
...
enterprises, Integer32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, ObjectIdentity, NotificationType, Counter64, iso, TimeTicks, ModuleIdentity, Gauge32, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "ObjectIdentity", "NotificationType", "Counter64", "iso", "TimeTicks", "ModuleIdentity", "Gauge32", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", settings=settings, humUnit=humUnit, histTemp=histTemp, valuesInt=valuesInt, trapHumHighAlarm=trapHumHighAlarm, compVal=compVal, values=values, trapEmailErrSocket=trapEmailErrSocket, tables=tables, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, tempAlarmInt=tempAlarmInt, sensorName=sensorName, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, tempMax=tempMax, deviceType=deviceType, tempHighInt=tempHighInt, humAlarmInt=humAlarmInt, t3610=t3610, humLowInt=humLowInt, tempLowInt=tempLowInt, histHum=histHum, trapNTPError=trapNTPError, DisplayString=DisplayString, trapHumError=trapHumError, tempAlarm=tempAlarm, compValMax=compValMax, humInt=humInt, compValHystInt=compValHystInt, compValUnit=compValUnit, compValAlarm=compValAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, traps=traps, humHighInt=humHighInt, trapEmailErrLogin=trapEmailErrLogin, trapHumClrAlarm=trapHumClrAlarm, hum=hum, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrDNS=trapEmailErrDNS, comet=comet, compValInt=compValInt, humDelayInt=humDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, compValHighInt=compValHighInt, trapSOAPErrSocket=trapSOAPErrSocket, products=products, tempMin=tempMin, humMin=humMin, temp=temp, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, messageString=messageString, trapSOAPErrDNS=trapSOAPErrDNS, tempUnit=tempUnit, serialNumber=serialNumber, humHystInt=humHystInt, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, compValMin=compValMin, pysmi_global=pysmi_global, compValLowInt=compValLowInt, histCompVal=histCompVal, trapEmailErrSome=trapEmailErrSome, trapHumLowAlarm=trapHumLowAlarm, tempHystInt=tempHystInt, historyEntry=historyEntry, tempInt=tempInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humMax=humMax)
