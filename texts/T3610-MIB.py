...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:15:06 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ModuleIdentity, Integer32, enterprises, MibIdentifier, Counter64, TimeTicks, ObjectIdentity, NotificationType, Gauge32, NotificationType, iso, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ModuleIdentity", "Integer32", "enterprises", "MibIdentifier", "Counter64", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32", "NotificationType", "iso", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", humMin=humMin, histCompVal=histCompVal, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, t3610=t3610, trapCompValHighAlarm=trapCompValHighAlarm, tempLowInt=tempLowInt, temp=temp, messageString=messageString, DisplayString=DisplayString, compValUnit=compValUnit, humInt=humInt, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, serialNumber=serialNumber, tempHystInt=tempHystInt, tempMax=tempMax, humUnit=humUnit, tempUnit=tempUnit, hum=hum, histHum=histHum, sensorName=sensorName, humHighInt=humHighInt, tempDelayInt=tempDelayInt, trapNTPError=trapNTPError, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapHumLowAlarm=trapHumLowAlarm, humDelayInt=humDelayInt, humHystInt=humHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, trapHumError=trapHumError, traps=traps, tables=tables, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, values=values, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, compVal=compVal, historyEntry=historyEntry, tempMin=tempMin, histTemp=histTemp, trapCompValError=trapCompValError, humMax=humMax, compValAlarmInt=compValAlarmInt, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, settings=settings, pysmi_global=pysmi_global, tempInt=tempInt, humAlarm=humAlarm, trapEmailErrSome=trapEmailErrSome, products=products, tempAlarm=tempAlarm, compValHighInt=compValHighInt, trapTest=trapTest, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, compValLowInt=compValLowInt, trapEmailErrLogin=trapEmailErrLogin, trapTempError=trapTempError, compValMax=compValMax, trapHumHighAlarm=trapHumHighAlarm, compValInt=compValInt, deviceType=deviceType, compValHystInt=compValHystInt, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, trapSOAPErrDNS=trapSOAPErrDNS)
