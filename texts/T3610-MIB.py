...
# Produced by pysmi-1.1.12 at Thu Apr  4 09:15:49 2024
...
Unsigned32, NotificationType, MibIdentifier, Integer32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ModuleIdentity, Bits, Gauge32, Counter64, Counter32, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "MibIdentifier", "Integer32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ModuleIdentity", "Bits", "Gauge32", "Counter64", "Counter32", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", tempHystInt=tempHystInt, serialNumber=serialNumber, tempInt=tempInt, compValMin=compValMin, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, sensorName=sensorName, tempAlarm=tempAlarm, compValAlarm=compValAlarm, tempUnit=tempUnit, compValHystInt=compValHystInt, trapTempError=trapTempError, humUnit=humUnit, settings=settings, tempDelayInt=tempDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, histHum=histHum, humHighInt=humHighInt, humInt=humInt, humMax=humMax, t3610=t3610, compValDelayInt=compValDelayInt, humAlarmInt=humAlarmInt, traps=traps, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, tables=tables, tempAlarmInt=tempAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, deviceType=deviceType, tempLowInt=tempLowInt, products=products, comet=comet, humLowInt=humLowInt, compValInt=compValInt, humMin=humMin, humAlarm=humAlarm, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, trapCompValError=trapCompValError, trapEmailErrAuth=trapEmailErrAuth, tempMax=tempMax, compValAlarmInt=compValAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrSome=trapEmailErrSome, compValHighInt=compValHighInt, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, trapHumHighAlarm=trapHumHighAlarm, compVal=compVal, compValUnit=compValUnit, tempHighInt=tempHighInt, trapHumError=trapHumError, trapTempClrAlarm=trapTempClrAlarm, hum=hum, historyEntry=historyEntry, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, humHystInt=humHystInt, DisplayString=DisplayString, trapHumLowAlarm=trapHumLowAlarm, messageString=messageString, histTemp=histTemp, compValMax=compValMax, trapNTPError=trapNTPError, trapTest=trapTest, compValLowInt=compValLowInt, pysmi_global=pysmi_global, valuesInt=valuesInt, values=values)
