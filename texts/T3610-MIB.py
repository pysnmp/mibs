...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:14:53 2023
...
Bits, IpAddress, NotificationType, TimeTicks, Unsigned32, ObjectIdentity, enterprises, Integer32, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Counter64, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "NotificationType", "TimeTicks", "Unsigned32", "ObjectIdentity", "enterprises", "Integer32", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Counter64", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrDNS=trapEmailErrDNS, humMax=humMax, trapTempHighAlarm=trapTempHighAlarm, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, trapHumClrAlarm=trapHumClrAlarm, humHighInt=humHighInt, temp=temp, histCompVal=histCompVal, t3610=t3610, traps=traps, humUnit=humUnit, tempMin=tempMin, humInt=humInt, historyTable=historyTable, tempAlarm=tempAlarm, compValAlarm=compValAlarm, sensorName=sensorName, tempHighInt=tempHighInt, tempHystInt=tempHystInt, tempInt=tempInt, compValHystInt=compValHystInt, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, serialNumber=serialNumber, trapNTPError=trapNTPError, trapSOAPErrSocket=trapSOAPErrSocket, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt, humAlarm=humAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, values=values, tempAlarmInt=tempAlarmInt, hum=hum, trapSOAPErrDNS=trapSOAPErrDNS, compVal=compVal, tempLowInt=tempLowInt, compValMax=compValMax, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, histTemp=histTemp, products=products, tempDelayInt=tempDelayInt, comet=comet, humDelayInt=humDelayInt, compValLowInt=compValLowInt, compValUnit=compValUnit, trapCompValLowAlarm=trapCompValLowAlarm, compValInt=compValInt, humMin=humMin, compValAlarmInt=compValAlarmInt, tempMax=tempMax, trapSOAPErrDelivery=trapSOAPErrDelivery, tables=tables, trapHumHighAlarm=trapHumHighAlarm, trapTest=trapTest, deviceType=deviceType, humLowInt=humLowInt, compValDelayInt=compValDelayInt, tempUnit=tempUnit, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, trapCompValError=trapCompValError, compValMin=compValMin, trapEmailErrSome=trapEmailErrSome, humHystInt=humHystInt, trapHumError=trapHumError, compValHighInt=compValHighInt, settings=settings)
