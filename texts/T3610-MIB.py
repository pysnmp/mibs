...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:30:41 2021
...
Bits, enterprises, Unsigned32, Gauge32, Counter64, TimeTicks, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, iso, IpAddress, NotificationType, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "Unsigned32", "Gauge32", "Counter64", "TimeTicks", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "iso", "IpAddress", "NotificationType", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", humLowInt=humLowInt, humMin=humMin, products=products, humInt=humInt, trapNTPError=trapNTPError, compValUnit=compValUnit, trapEmailErrSome=trapEmailErrSome, compValAlarm=compValAlarm, pysmi_global=pysmi_global, temp=temp, trapTempLowAlarm=trapTempLowAlarm, DisplayString=DisplayString, histTemp=histTemp, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, t3610=t3610, trapHumLowAlarm=trapHumLowAlarm, tempMin=tempMin, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, compVal=compVal, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, compValLowInt=compValLowInt, humHystInt=humHystInt, compValMax=compValMax, tempLowInt=tempLowInt, traps=traps, tables=tables, tempInt=tempInt, tempHystInt=tempHystInt, messageString=messageString, histHum=histHum, tempMax=tempMax, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, trapTempClrAlarm=trapTempClrAlarm, settings=settings, humHighInt=humHighInt, tempUnit=tempUnit, humUnit=humUnit, sensorName=sensorName, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, trapEmailErrAuth=trapEmailErrAuth, deviceType=deviceType, tempHighInt=tempHighInt, humMax=humMax, humDelayInt=humDelayInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, compValAlarmInt=compValAlarmInt, trapHumClrAlarm=trapHumClrAlarm, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, compValHystInt=compValHystInt, trapTest=trapTest, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, trapHumError=trapHumError, humAlarm=humAlarm, trapCompValLowAlarm=trapCompValLowAlarm, valuesInt=valuesInt, comet=comet, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, values=values, hum=hum, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, compValHighInt=compValHighInt)
