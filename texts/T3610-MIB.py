...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:10:02 2022
...
MibIdentifier, ObjectIdentity, TimeTicks, Unsigned32, NotificationType, Gauge32, IpAddress, Counter32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter64, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Unsigned32", "NotificationType", "Gauge32", "IpAddress", "Counter32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter64", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", messageString=messageString, humInt=humInt, trapEmailErrSocket=trapEmailErrSocket, tempAlarmInt=tempAlarmInt, humMin=humMin, settings=settings, compValDelayInt=compValDelayInt, products=products, compValMin=compValMin, tempUnit=tempUnit, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, humAlarmInt=humAlarmInt, trapHumError=trapHumError, DisplayString=DisplayString, trapCompValError=trapCompValError, tempAlarm=tempAlarm, humLowInt=humLowInt, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, histCompVal=histCompVal, sensorName=sensorName, historyEntry=historyEntry, compValHystInt=compValHystInt, humHystInt=humHystInt, pysmi_global=pysmi_global, compValHighInt=compValHighInt, humDelayInt=humDelayInt, humAlarm=humAlarm, traps=traps, histTemp=histTemp, trapEmailErrAuth=trapEmailErrAuth, trapHumHighAlarm=trapHumHighAlarm, temp=temp, tempHighInt=tempHighInt, compValUnit=compValUnit, tempDelayInt=tempDelayInt, valuesInt=valuesInt, deviceType=deviceType, values=values, tempInt=tempInt, compValMax=compValMax, hum=hum, compValInt=compValInt, trapCompValLowAlarm=trapCompValLowAlarm, humMax=humMax, t3610=t3610, tables=tables, trapHumLowAlarm=trapHumLowAlarm, historyTable=historyTable, trapNTPError=trapNTPError, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, compValAlarm=compValAlarm, comet=comet, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, humHighInt=humHighInt, compValAlarmInt=compValAlarmInt, serialNumber=serialNumber, trapTempError=trapTempError, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempMin=tempMin, humUnit=humUnit, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, tempHystInt=tempHystInt, tempMax=tempMax, compVal=compVal)
