...
# Produced by pysmi-1.1.12 at Tue Dec  3 12:13:31 2024
...
Integer32, Counter64, ModuleIdentity, Bits, IpAddress, NotificationType, Gauge32, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Unsigned32, ObjectIdentity, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "Bits", "IpAddress", "NotificationType", "Gauge32", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Unsigned32", "ObjectIdentity", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, compVal=compVal, tempInt=tempInt, tempMax=tempMax, tempDelayInt=tempDelayInt, valuesInt=valuesInt, deviceType=deviceType, trapEmailErrDNS=trapEmailErrDNS, compValDelayInt=compValDelayInt, traps=traps, serialNumber=serialNumber, trapTest=trapTest, humUnit=humUnit, compValMax=compValMax, trapCompValHighAlarm=trapCompValHighAlarm, trapHumClrAlarm=trapHumClrAlarm, tempUnit=tempUnit, tempHighInt=tempHighInt, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, humHighInt=humHighInt, products=products, humMax=humMax, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, trapTempError=trapTempError, humAlarmInt=humAlarmInt, histHum=histHum, historyTable=historyTable, tables=tables, humDelayInt=humDelayInt, histCompVal=histCompVal, humAlarm=humAlarm, humMin=humMin, sensorName=sensorName, humInt=humInt, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, comet=comet, t3610=t3610, humLowInt=humLowInt, messageString=messageString, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, compValUnit=compValUnit, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, DisplayString=DisplayString, temp=temp, compValHighInt=compValHighInt, tempHystInt=tempHystInt, humHystInt=humHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, historyEntry=historyEntry, tempLowInt=tempLowInt, histTemp=histTemp, tempAlarmInt=tempAlarmInt, settings=settings, pysmi_global=pysmi_global, tempMin=tempMin, values=values, compValInt=compValInt, trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, compValMin=compValMin, trapHumLowAlarm=trapHumLowAlarm, hum=hum, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm)
