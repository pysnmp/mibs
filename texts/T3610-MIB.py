...
Counter32, NotificationType, Unsigned32, enterprises, ModuleIdentity, Counter64, Bits, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, MibIdentifier, Integer32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Unsigned32", "enterprises", "ModuleIdentity", "Counter64", "Bits", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Integer32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", products=products, deviceType=deviceType, settings=settings, trapHumError=trapHumError, compValAlarm=compValAlarm, hum=hum, sensorName=sensorName, humDelayInt=humDelayInt, humAlarmInt=humAlarmInt, histTemp=histTemp, histHum=histHum, trapHumClrAlarm=trapHumClrAlarm, t3610=t3610, tempInt=tempInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValLowInt=compValLowInt, trapEmailErrSocket=trapEmailErrSocket, tempAlarm=tempAlarm, humAlarm=humAlarm, tempUnit=tempUnit, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, tempDelayInt=tempDelayInt, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrLogin=trapEmailErrLogin, compValHighInt=compValHighInt, pysmi_global=pysmi_global, tempAlarmInt=tempAlarmInt, compValUnit=compValUnit, humHystInt=humHystInt, compValMin=compValMin, comet=comet, messageString=messageString, histCompVal=histCompVal, tempMin=tempMin, tempMax=tempMax, trapSOAPErrFile=trapSOAPErrFile, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapNTPError=trapNTPError, humMin=humMin, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, humUnit=humUnit, humMax=humMax, humInt=humInt, humLowInt=humLowInt, trapCompValLowAlarm=trapCompValLowAlarm, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, traps=traps, trapTest=trapTest, tables=tables, historyEntry=historyEntry, compVal=compVal, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, temp=temp, serialNumber=serialNumber, trapTempError=trapTempError, values=values, compValInt=compValInt, tempHighInt=tempHighInt, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, compValMax=compValMax, historyTable=historyTable, valuesInt=valuesInt)
