...
IpAddress, TimeTicks, iso, enterprises, MibIdentifier, Bits, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, NotificationType, Counter32, ModuleIdentity, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "iso", "enterprises", "MibIdentifier", "Bits", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "NotificationType", "Counter32", "ModuleIdentity", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", sensorName=sensorName, serialNumber=serialNumber, humAlarm=humAlarm, humHighInt=humHighInt, humInt=humInt, humLowInt=humLowInt, tempHystInt=tempHystInt, compValLowInt=compValLowInt, tempMax=tempMax, tempLowInt=tempLowInt, tempInt=tempInt, compVal=compVal, trapTempError=trapTempError, temp=temp, trapTest=trapTest, compValMax=compValMax, compValHighInt=compValHighInt, trapHumError=trapHumError, trapSOAPErrDNS=trapSOAPErrDNS, DisplayString=DisplayString, humMax=humMax, compValMin=compValMin, comet=comet, traps=traps, tempMin=tempMin, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, t3610=t3610, compValAlarmInt=compValAlarmInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, settings=settings, trapTempHighAlarm=trapTempHighAlarm, humHystInt=humHystInt, tempUnit=tempUnit, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrAuth=trapEmailErrAuth, compValInt=compValInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrFile=trapSOAPErrFile, trapCompValHighAlarm=trapCompValHighAlarm, humUnit=humUnit, histTemp=histTemp, trapNTPError=trapNTPError, tempAlarmInt=tempAlarmInt, trapHumLowAlarm=trapHumLowAlarm, values=values, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, trapHumClrAlarm=trapHumClrAlarm, tempHighInt=tempHighInt, pysmi_global=pysmi_global, historyTable=historyTable, compValAlarm=compValAlarm, humAlarmInt=humAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, products=products, historyEntry=historyEntry, trapCompValLowAlarm=trapCompValLowAlarm, compValUnit=compValUnit, histCompVal=histCompVal, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, trapCompValError=trapCompValError, humDelayInt=humDelayInt, histHum=histHum, humMin=humMin, messageString=messageString, hum=hum)
