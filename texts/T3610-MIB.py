...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:21:11 2023
...
TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Gauge32, Bits, IpAddress, iso, enterprises, MibIdentifier, NotificationType, NotificationType, Counter64, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Gauge32", "Bits", "IpAddress", "iso", "enterprises", "MibIdentifier", "NotificationType", "NotificationType", "Counter64", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", compValLowInt=compValLowInt, historyTable=historyTable, tempMax=tempMax, humDelayInt=humDelayInt, values=values, deviceType=deviceType, trapCompValLowAlarm=trapCompValLowAlarm, comet=comet, pysmi_global=pysmi_global, humMin=humMin, compValDelayInt=compValDelayInt, compVal=compVal, compValUnit=compValUnit, trapEmailErrLogin=trapEmailErrLogin, histTemp=histTemp, tempInt=tempInt, trapTest=trapTest, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, traps=traps, humHighInt=humHighInt, serialNumber=serialNumber, humHystInt=humHystInt, humUnit=humUnit, sensorName=sensorName, trapEmailErrSome=trapEmailErrSome, trapEmailErrSocket=trapEmailErrSocket, humAlarm=humAlarm, compValAlarm=compValAlarm, humInt=humInt, historyEntry=historyEntry, tempUnit=tempUnit, hum=hum, DisplayString=DisplayString, trapHumHighAlarm=trapHumHighAlarm, humAlarmInt=humAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, trapTempLowAlarm=trapTempLowAlarm, tempMin=tempMin, temp=temp, trapSOAPErrDelivery=trapSOAPErrDelivery, settings=settings, tables=tables, compValInt=compValInt, compValHighInt=compValHighInt, compValHystInt=compValHystInt, trapTempClrAlarm=trapTempClrAlarm, tempHighInt=tempHighInt, trapHumError=trapHumError, products=products, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarmInt=tempAlarmInt, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, tempHystInt=tempHystInt, tempDelayInt=tempDelayInt, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, tempAlarm=tempAlarm, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, messageString=messageString, histCompVal=histCompVal, t3610=t3610, compValMin=compValMin, tempLowInt=tempLowInt, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt)
