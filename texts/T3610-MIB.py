...
enterprises, Gauge32, Integer32, Unsigned32, NotificationType, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Bits, ModuleIdentity, Counter32, TimeTicks, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Integer32", "Unsigned32", "NotificationType", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Bits", "ModuleIdentity", "Counter32", "TimeTicks", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, comet=comet, deviceType=deviceType, t3610=t3610, products=products, humHighInt=humHighInt, trapHumError=trapHumError, valuesInt=valuesInt, traps=traps, temp=temp, tempAlarm=tempAlarm, historyTable=historyTable, sensorName=sensorName, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, humAlarmInt=humAlarmInt, compValMin=compValMin, trapTempError=trapTempError, tempLowInt=tempLowInt, DisplayString=DisplayString, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, serialNumber=serialNumber, trapNTPError=trapNTPError, pysmi_global=pysmi_global, histCompVal=histCompVal, humInt=humInt, humMin=humMin, tempInt=tempInt, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, tables=tables, trapEmailErrAuth=trapEmailErrAuth, compValDelayInt=compValDelayInt, trapTempHighAlarm=trapTempHighAlarm, values=values, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, compValInt=compValInt, historyEntry=historyEntry, compValAlarmInt=compValAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, histTemp=histTemp, compValHystInt=compValHystInt, humUnit=humUnit, tempDelayInt=tempDelayInt, trapHumLowAlarm=trapHumLowAlarm, compValLowInt=compValLowInt, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, compValMax=compValMax, messageString=messageString, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrFile=trapSOAPErrFile, tempHystInt=tempHystInt, humDelayInt=humDelayInt, settings=settings, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, trapTest=trapTest, compValAlarm=compValAlarm, tempMax=tempMax, tempHighInt=tempHighInt, compVal=compVal, humLowInt=humLowInt, compValHighInt=compValHighInt, trapEmailErrSome=trapEmailErrSome, hum=hum)
