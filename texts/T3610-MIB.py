...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:37:05 2024
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Bits, ObjectIdentity, NotificationType, iso, MibIdentifier, NotificationType, Counter64, Counter32, Gauge32, IpAddress, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Bits", "ObjectIdentity", "NotificationType", "iso", "MibIdentifier", "NotificationType", "Counter64", "Counter32", "Gauge32", "IpAddress", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, humHighInt=humHighInt, humLowInt=humLowInt, humInt=humInt, compValAlarm=compValAlarm, values=values, tempHighInt=tempHighInt, humMin=humMin, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, tempMax=tempMax, humUnit=humUnit, humHystInt=humHystInt, trapSOAPErrFile=trapSOAPErrFile, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, tempMin=tempMin, trapHumError=trapHumError, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, messageString=messageString, trapTest=trapTest, trapSOAPErrSocket=trapSOAPErrSocket, compValHystInt=compValHystInt, temp=temp, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, histTemp=histTemp, settings=settings, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrLogin=trapEmailErrLogin, humMax=humMax, humAlarmInt=humAlarmInt, trapTempError=trapTempError, deviceType=deviceType, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, tempUnit=tempUnit, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, compValInt=compValInt, sensorName=sensorName, compValLowInt=compValLowInt, compValUnit=compValUnit, humAlarm=humAlarm, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, hum=hum, traps=traps, trapEmailErrSome=trapEmailErrSome, histHum=histHum, comet=comet, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrDNS=trapEmailErrDNS, products=products, tempAlarmInt=tempAlarmInt, historyTable=historyTable, valuesInt=valuesInt, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, compVal=compVal, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, t3610=t3610, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm, compValMax=compValMax, humDelayInt=humDelayInt)
