...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:17:20 2022
...
TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, IpAddress, iso, Counter64, ObjectIdentity, Integer32, enterprises, Counter32, ModuleIdentity, Bits, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "IpAddress", "iso", "Counter64", "ObjectIdentity", "Integer32", "enterprises", "Counter32", "ModuleIdentity", "Bits", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumHighAlarm=trapHumHighAlarm, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, tempLowInt=tempLowInt, tempUnit=tempUnit, compValHighInt=compValHighInt, histHum=histHum, deviceType=deviceType, trapTest=trapTest, temp=temp, compVal=compVal, tables=tables, humMax=humMax, compValUnit=compValUnit, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, tempInt=tempInt, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, comet=comet, compValLowInt=compValLowInt, tempHystInt=tempHystInt, tempMin=tempMin, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, hum=hum, tempMax=tempMax, tempDelayInt=tempDelayInt, humHystInt=humHystInt, tempAlarm=tempAlarm, compValMin=compValMin, traps=traps, humHighInt=humHighInt, humUnit=humUnit, humMin=humMin, humAlarm=humAlarm, t3610=t3610, compValHystInt=compValHystInt, histTemp=histTemp, compValInt=compValInt, compValDelayInt=compValDelayInt, trapHumError=trapHumError, messageString=messageString, trapNTPError=trapNTPError, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, valuesInt=valuesInt, humInt=humInt, trapEmailErrSocket=trapEmailErrSocket, settings=settings, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, products=products, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, values=values, trapEmailErrAuth=trapEmailErrAuth, compValMax=compValMax, trapEmailErrSome=trapEmailErrSome, historyTable=historyTable, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, DisplayString=DisplayString, trapHumLowAlarm=trapHumLowAlarm, pysmi_global=pysmi_global, humDelayInt=humDelayInt)
