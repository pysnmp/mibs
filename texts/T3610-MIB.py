...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:56:58 2022
...
NotificationType, ObjectIdentity, ModuleIdentity, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, Bits, Counter64, Integer32, TimeTicks, Unsigned32, Gauge32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "ModuleIdentity", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "Bits", "Counter64", "Integer32", "TimeTicks", "Unsigned32", "Gauge32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumError=trapHumError, trapCompValLowAlarm=trapCompValLowAlarm, tempMax=tempMax, compValInt=compValInt, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, pysmi_global=pysmi_global, histHum=histHum, trapTempError=trapTempError, products=products, settings=settings, sensorName=sensorName, humMax=humMax, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, humUnit=humUnit, tempHystInt=tempHystInt, humDelayInt=humDelayInt, tempInt=tempInt, tempAlarm=tempAlarm, humInt=humInt, tempAlarmInt=tempAlarmInt, historyTable=historyTable, humHystInt=humHystInt, trapTempClrAlarm=trapTempClrAlarm, humAlarm=humAlarm, temp=temp, compVal=compVal, tempMin=tempMin, tempLowInt=tempLowInt, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTempLowAlarm=trapTempLowAlarm, compValMax=compValMax, compValUnit=compValUnit, serialNumber=serialNumber, humAlarmInt=humAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, historyEntry=historyEntry, histTemp=histTemp, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, compValHystInt=compValHystInt, compValAlarmInt=compValAlarmInt, trapSOAPErrFile=trapSOAPErrFile, deviceType=deviceType, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest, traps=traps, trapSOAPErrSocket=trapSOAPErrSocket, tables=tables, DisplayString=DisplayString, t3610=t3610, hum=hum, humLowInt=humLowInt, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, trapCompValHighAlarm=trapCompValHighAlarm, comet=comet, valuesInt=valuesInt, values=values, compValMin=compValMin, compValDelayInt=compValDelayInt, trapEmailErrSocket=trapEmailErrSocket, compValAlarm=compValAlarm, trapCompValError=trapCompValError, compValHighInt=compValHighInt, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, tempUnit=tempUnit, compValLowInt=compValLowInt, messageString=messageString)
