...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:36:28 2021
...
MibIdentifier, NotificationType, enterprises, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Integer32, iso, Counter32, Gauge32, IpAddress, Bits, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "enterprises", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Integer32", "iso", "Counter32", "Gauge32", "IpAddress", "Bits", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarm=compValAlarm, humAlarm=humAlarm, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, comet=comet, humUnit=humUnit, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, tempAlarmInt=tempAlarmInt, compValLowInt=compValLowInt, trapHumError=trapHumError, tempUnit=tempUnit, humMin=humMin, humHystInt=humHystInt, humAlarmInt=humAlarmInt, trapEmailErrSome=trapEmailErrSome, trapTempClrAlarm=trapTempClrAlarm, tempLowInt=tempLowInt, humDelayInt=humDelayInt, valuesInt=valuesInt, compValHystInt=compValHystInt, DisplayString=DisplayString, t3610=t3610, compVal=compVal, compValHighInt=compValHighInt, serialNumber=serialNumber, humHighInt=humHighInt, tempHystInt=tempHystInt, messageString=messageString, tempAlarm=tempAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, tempInt=tempInt, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, trapTempError=trapTempError, trapSOAPErrSocket=trapSOAPErrSocket, products=products, trapTempLowAlarm=trapTempLowAlarm, hum=hum, humMax=humMax, values=values, sensorName=sensorName, deviceType=deviceType, compValDelayInt=compValDelayInt, trapTest=trapTest, humInt=humInt, temp=temp, histTemp=histTemp, tempDelayInt=tempDelayInt, settings=settings, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrFile=trapSOAPErrFile, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, traps=traps, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, compValMax=compValMax, humLowInt=humLowInt, historyTable=historyTable, compValAlarmInt=compValAlarmInt, trapEmailErrAuth=trapEmailErrAuth, tempMax=tempMax, trapCompValError=trapCompValError, tempHighInt=tempHighInt, compValInt=compValInt, pysmi_global=pysmi_global, tables=tables, compValMin=compValMin)
