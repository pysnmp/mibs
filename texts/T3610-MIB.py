...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:01:53 2022
...
Bits, ObjectIdentity, enterprises, iso, NotificationType, NotificationType, Gauge32, Counter32, Unsigned32, IpAddress, Counter64, MibIdentifier, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "enterprises", "iso", "NotificationType", "NotificationType", "Gauge32", "Counter32", "Unsigned32", "IpAddress", "Counter64", "MibIdentifier", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", temp=temp, values=values, t3610=t3610, tempUnit=tempUnit, trapTempError=trapTempError, settings=settings, tempHighInt=tempHighInt, humHystInt=humHystInt, histHum=histHum, tables=tables, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, trapHumLowAlarm=trapHumLowAlarm, tempLowInt=tempLowInt, trapHumError=trapHumError, trapSOAPErrFile=trapSOAPErrFile, histCompVal=histCompVal, compValUnit=compValUnit, humUnit=humUnit, compVal=compVal, trapCompValLowAlarm=trapCompValLowAlarm, deviceType=deviceType, historyTable=historyTable, comet=comet, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, histTemp=histTemp, trapEmailErrSome=trapEmailErrSome, valuesInt=valuesInt, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, compValMin=compValMin, trapTempClrAlarm=trapTempClrAlarm, compValAlarmInt=compValAlarmInt, DisplayString=DisplayString, trapEmailErrLogin=trapEmailErrLogin, humLowInt=humLowInt, tempAlarm=tempAlarm, compValHystInt=compValHystInt, trapCompValClrAlarm=trapCompValClrAlarm, hum=hum, trapHumHighAlarm=trapHumHighAlarm, tempAlarmInt=tempAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, trapEmailErrSocket=trapEmailErrSocket, products=products, compValInt=compValInt, trapCompValError=trapCompValError, compValHighInt=compValHighInt, tempMax=tempMax, trapEmailErrAuth=trapEmailErrAuth, compValAlarm=compValAlarm, humAlarm=humAlarm, humMax=humMax, humInt=humInt, compValLowInt=compValLowInt, historyEntry=historyEntry, trapTest=trapTest, pysmi_global=pysmi_global, trapNTPError=trapNTPError, humAlarmInt=humAlarmInt, traps=traps, compValDelayInt=compValDelayInt, humHighInt=humHighInt, tempHystInt=tempHystInt, compValMax=compValMax, sensorName=sensorName, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, tempDelayInt=tempDelayInt, messageString=messageString, humMin=humMin)
