...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:31:06 2023
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Integer32, NotificationType, ObjectIdentity, MibIdentifier, NotificationType, Counter32, iso, ModuleIdentity, Bits, Gauge32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Integer32", "NotificationType", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter32", "iso", "ModuleIdentity", "Bits", "Gauge32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", values=values, compValMax=compValMax, historyEntry=historyEntry, tempAlarm=tempAlarm, histHum=histHum, compValUnit=compValUnit, sensorName=sensorName, messageString=messageString, tempDelayInt=tempDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, products=products, comet=comet, compValHighInt=compValHighInt, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarm=compValAlarm, trapEmailErrLogin=trapEmailErrLogin, compValLowInt=compValLowInt, trapSOAPErrSocket=trapSOAPErrSocket, humMin=humMin, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMax=tempMax, humHighInt=humHighInt, settings=settings, trapTest=trapTest, humUnit=humUnit, tempInt=tempInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, compValAlarmInt=compValAlarmInt, t3610=t3610, humLowInt=humLowInt, humInt=humInt, historyTable=historyTable, trapNTPError=trapNTPError, trapHumError=trapHumError, valuesInt=valuesInt, tables=tables, tempMin=tempMin, trapTempHighAlarm=trapTempHighAlarm, compValHystInt=compValHystInt, tempAlarmInt=tempAlarmInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, compValMin=compValMin, trapSOAPErrDNS=trapSOAPErrDNS, compVal=compVal, compValDelayInt=compValDelayInt, compValInt=compValInt, histTemp=histTemp, trapHumHighAlarm=trapHumHighAlarm, traps=traps, hum=hum, tempHystInt=tempHystInt, tempLowInt=tempLowInt, humHystInt=humHystInt, trapHumLowAlarm=trapHumLowAlarm, serialNumber=serialNumber, humAlarm=humAlarm, histCompVal=histCompVal, trapEmailErrAuth=trapEmailErrAuth, pysmi_global=pysmi_global, DisplayString=DisplayString, tempUnit=tempUnit, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, humDelayInt=humDelayInt, tempHighInt=tempHighInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, temp=temp, humAlarmInt=humAlarmInt, humMax=humMax)
