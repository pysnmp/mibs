...
# Produced by pysmi-1.1.12 at Fri Jul 19 10:02:42 2024
...
iso, Counter32, NotificationType, TimeTicks, Gauge32, ModuleIdentity, enterprises, Counter64, Bits, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "NotificationType", "TimeTicks", "Gauge32", "ModuleIdentity", "enterprises", "Counter64", "Bits", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDNS=trapSOAPErrDNS, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, trapSOAPErrSocket=trapSOAPErrSocket, tables=tables, humAlarm=humAlarm, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, compValLowInt=compValLowInt, histHum=histHum, compVal=compVal, compValMin=compValMin, historyTable=historyTable, trapNTPError=trapNTPError, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, valuesInt=valuesInt, settings=settings, compValAlarm=compValAlarm, hum=hum, trapHumHighAlarm=trapHumHighAlarm, humLowInt=humLowInt, humHystInt=humHystInt, compValMax=compValMax, humInt=humInt, humDelayInt=humDelayInt, trapTempClrAlarm=trapTempClrAlarm, sensorName=sensorName, histTemp=histTemp, compValHighInt=compValHighInt, t3610=t3610, pysmi_global=pysmi_global, tempAlarm=tempAlarm, compValUnit=compValUnit, trapTempError=trapTempError, serialNumber=serialNumber, tempLowInt=tempLowInt, tempHighInt=tempHighInt, tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, tempUnit=tempUnit, tempInt=tempInt, tempDelayInt=tempDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrDNS=trapEmailErrDNS, tempAlarmInt=tempAlarmInt, trapTempLowAlarm=trapTempLowAlarm, humMin=humMin, values=values, humAlarmInt=humAlarmInt, compValHystInt=compValHystInt, humUnit=humUnit, trapEmailErrSome=trapEmailErrSome, trapTest=trapTest, compValAlarmInt=compValAlarmInt, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, products=products, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, DisplayString=DisplayString, tempMin=tempMin, temp=temp, traps=traps, compValDelayInt=compValDelayInt, historyEntry=historyEntry, comet=comet, deviceType=deviceType, histCompVal=histCompVal, humHighInt=humHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery)
