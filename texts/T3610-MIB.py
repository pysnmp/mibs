...
# Produced by pysmi-1.1.12 at Wed May 29 06:43:40 2024
...
TimeTicks, IpAddress, Gauge32, iso, Counter64, Bits, NotificationType, Unsigned32, ObjectIdentity, enterprises, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Gauge32", "iso", "Counter64", "Bits", "NotificationType", "Unsigned32", "ObjectIdentity", "enterprises", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSome=trapEmailErrSome, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, humHystInt=humHystInt, compValInt=compValInt, DisplayString=DisplayString, humDelayInt=humDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, histHum=histHum, serialNumber=serialNumber, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValError=trapCompValError, values=values, tables=tables, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, tempInt=tempInt, tempLowInt=tempLowInt, compValDelayInt=compValDelayInt, tempMax=tempMax, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, settings=settings, compValAlarm=compValAlarm, compValUnit=compValUnit, trapEmailErrAuth=trapEmailErrAuth, tempMin=tempMin, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempHighInt=tempHighInt, humLowInt=humLowInt, humHighInt=humHighInt, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapHumError=trapHumError, histTemp=histTemp, compValMin=compValMin, tempHystInt=tempHystInt, trapTest=trapTest, products=products, hum=hum, humUnit=humUnit, compValLowInt=compValLowInt, trapTempLowAlarm=trapTempLowAlarm, compValHystInt=compValHystInt, compValHighInt=compValHighInt, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, sensorName=sensorName, trapSOAPErrFile=trapSOAPErrFile, compVal=compVal, comet=comet, pysmi_global=pysmi_global, trapTempError=trapTempError, messageString=messageString, tempAlarm=tempAlarm, trapNTPError=trapNTPError, historyEntry=historyEntry, humAlarmInt=humAlarmInt, compValMax=compValMax, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrSocket=trapSOAPErrSocket, temp=temp, t3610=t3610, humAlarm=humAlarm, tempUnit=tempUnit, humMin=humMin, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarmInt=tempAlarmInt, traps=traps)
