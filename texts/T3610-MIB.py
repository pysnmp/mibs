...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:58:13 2021
...
Integer32, Unsigned32, enterprises, Gauge32, ModuleIdentity, iso, NotificationType, MibIdentifier, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, IpAddress, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "enterprises", "Gauge32", "ModuleIdentity", "iso", "NotificationType", "MibIdentifier", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "IpAddress", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, tempInt=tempInt, trapCompValClrAlarm=trapCompValClrAlarm, tempLowInt=tempLowInt, compValAlarm=compValAlarm, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, serialNumber=serialNumber, hum=hum, temp=temp, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, t3610=t3610, histTemp=histTemp, trapTempError=trapTempError, DisplayString=DisplayString, humMin=humMin, tempHystInt=tempHystInt, tempUnit=tempUnit, comet=comet, deviceType=deviceType, settings=settings, pysmi_global=pysmi_global, humUnit=humUnit, compValHighInt=compValHighInt, tables=tables, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrAuth=trapEmailErrAuth, trapHumClrAlarm=trapHumClrAlarm, messageString=messageString, trapCompValLowAlarm=trapCompValLowAlarm, compValInt=compValInt, humLowInt=humLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, humAlarm=humAlarm, compValLowInt=compValLowInt, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, products=products, tempMax=tempMax, historyTable=historyTable, trapTest=trapTest, trapCompValError=trapCompValError, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, humDelayInt=humDelayInt, trapTempLowAlarm=trapTempLowAlarm, tempDelayInt=tempDelayInt, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt, tempMin=tempMin, tempHighInt=tempHighInt, compValHystInt=compValHystInt, traps=traps, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, humAlarmInt=humAlarmInt, compVal=compVal, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, trapHumError=trapHumError, humHighInt=humHighInt, compValMax=compValMax, humMax=humMax, trapEmailErrSome=trapEmailErrSome, values=values, compValMin=compValMin)
