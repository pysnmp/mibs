...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:00:47 2024
...
Counter32, Counter64, NotificationType, NotificationType, Bits, IpAddress, MibIdentifier, iso, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ModuleIdentity, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "NotificationType", "NotificationType", "Bits", "IpAddress", "MibIdentifier", "iso", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ModuleIdentity", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", traps=traps, tempInt=tempInt, tempUnit=tempUnit, humMax=humMax, deviceType=deviceType, tempMin=tempMin, compValAlarmInt=compValAlarmInt, hum=hum, humHystInt=humHystInt, historyEntry=historyEntry, trapTest=trapTest, valuesInt=valuesInt, trapTempClrAlarm=trapTempClrAlarm, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, tempDelayInt=tempDelayInt, compValMax=compValMax, trapEmailErrSocket=trapEmailErrSocket, compValHighInt=compValHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, histCompVal=histCompVal, tempHighInt=tempHighInt, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, tables=tables, historyTable=historyTable, compValMin=compValMin, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, humMin=humMin, humUnit=humUnit, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, settings=settings, trapNTPError=trapNTPError, tempMax=tempMax, compVal=compVal, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, compValUnit=compValUnit, compValAlarm=compValAlarm, serialNumber=serialNumber, trapCompValClrAlarm=trapCompValClrAlarm, trapTempHighAlarm=trapTempHighAlarm, humInt=humInt, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, products=products, tempHystInt=tempHystInt, sensorName=sensorName, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, compValInt=compValInt, humAlarm=humAlarm, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, trapTempError=trapTempError, values=values, comet=comet, histTemp=histTemp, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, trapEmailErrSome=trapEmailErrSome, messageString=messageString, trapCompValError=trapCompValError, compValLowInt=compValLowInt, humHighInt=humHighInt, temp=temp)
