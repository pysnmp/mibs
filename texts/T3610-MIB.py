...
# Produced by pysmi-1.1.8 at Fri Jul  8 07:59:26 2022
...
iso, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits, TimeTicks, Counter64, Gauge32, Counter32, ModuleIdentity, IpAddress, NotificationType, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits", "TimeTicks", "Counter64", "Gauge32", "Counter32", "ModuleIdentity", "IpAddress", "NotificationType", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", products=products, trapSOAPErrDelivery=trapSOAPErrDelivery, histTemp=histTemp, humDelayInt=humDelayInt, trapTempClrAlarm=trapTempClrAlarm, pysmi_global=pysmi_global, temp=temp, settings=settings, hum=hum, compValAlarm=compValAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, tempAlarmInt=tempAlarmInt, trapNTPError=trapNTPError, trapCompValLowAlarm=trapCompValLowAlarm, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, histHum=histHum, historyTable=historyTable, trapTest=trapTest, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrDNS=trapEmailErrDNS, comet=comet, compValDelayInt=compValDelayInt, DisplayString=DisplayString, tempInt=tempInt, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, compValHighInt=compValHighInt, compValInt=compValInt, historyEntry=historyEntry, deviceType=deviceType, tempUnit=tempUnit, compValUnit=compValUnit, compValMin=compValMin, trapHumHighAlarm=trapHumHighAlarm, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, traps=traps, tables=tables, humHighInt=humHighInt, t3610=t3610, trapHumError=trapHumError, tempDelayInt=tempDelayInt, humMin=humMin, trapEmailErrSome=trapEmailErrSome, values=values, humUnit=humUnit, humAlarmInt=humAlarmInt, sensorName=sensorName, messageString=messageString, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, compValHystInt=compValHystInt, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, tempHystInt=tempHystInt, tempHighInt=tempHighInt, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, tempMin=tempMin, trapTempError=trapTempError, compValAlarmInt=compValAlarmInt, tempAlarm=tempAlarm, humInt=humInt, humMax=humMax, compValMax=compValMax, trapTempHighAlarm=trapTempHighAlarm, tempMax=tempMax, valuesInt=valuesInt, histCompVal=histCompVal, humHystInt=humHystInt, humAlarm=humAlarm, compValLowInt=compValLowInt)
