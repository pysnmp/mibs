...
# Produced by pysmi-1.1.12 at Mon Jun  3 03:01:25 2024
...
enterprises, ModuleIdentity, IpAddress, MibIdentifier, NotificationType, ObjectIdentity, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, iso, Integer32, NotificationType, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "IpAddress", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "iso", "Integer32", "NotificationType", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValHighAlarm=trapCompValHighAlarm, messageString=messageString, histTemp=histTemp, compValDelayInt=compValDelayInt, histHum=histHum, comet=comet, tempMax=tempMax, values=values, tables=tables, compValAlarmInt=compValAlarmInt, compVal=compVal, tempUnit=tempUnit, historyTable=historyTable, trapNTPError=trapNTPError, trapEmailErrDNS=trapEmailErrDNS, t3610=t3610, DisplayString=DisplayString, compValLowInt=compValLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, pysmi_global=pysmi_global, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, humHighInt=humHighInt, tempInt=tempInt, tempAlarmInt=tempAlarmInt, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, trapCompValError=trapCompValError, trapHumError=trapHumError, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, humHystInt=humHystInt, trapTempClrAlarm=trapTempClrAlarm, tempDelayInt=tempDelayInt, humAlarm=humAlarm, trapEmailErrLogin=trapEmailErrLogin, settings=settings, products=products, serialNumber=serialNumber, humLowInt=humLowInt, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, temp=temp, trapSOAPErrDNS=trapSOAPErrDNS, deviceType=deviceType, tempHystInt=tempHystInt, humMax=humMax, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSome=trapEmailErrSome, compValHystInt=compValHystInt, trapTempError=trapTempError, hum=hum, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, compValUnit=compValUnit, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrFile=trapSOAPErrFile, compValMax=compValMax, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, tempAlarm=tempAlarm, tempMin=tempMin, sensorName=sensorName, humInt=humInt, humUnit=humUnit, compValAlarm=compValAlarm, humAlarmInt=humAlarmInt, tempHighInt=tempHighInt, compValMin=compValMin, compValInt=compValInt, traps=traps, histCompVal=histCompVal, trapTest=trapTest)
