...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:16:22 2022
...
Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, IpAddress, MibIdentifier, Counter64, ObjectIdentity, Gauge32, Bits, TimeTicks, NotificationType, Integer32, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "IpAddress", "MibIdentifier", "Counter64", "ObjectIdentity", "Gauge32", "Bits", "TimeTicks", "NotificationType", "Integer32", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, compValHighInt=compValHighInt, compValMax=compValMax, humHighInt=humHighInt, tempInt=tempInt, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, hum=hum, trapHumError=trapHumError, tables=tables, compValAlarmInt=compValAlarmInt, compVal=compVal, sensorName=sensorName, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, humAlarm=humAlarm, trapTempHighAlarm=trapTempHighAlarm, compValAlarm=compValAlarm, humLowInt=humLowInt, trapNTPError=trapNTPError, tempHystInt=tempHystInt, trapHumLowAlarm=trapHumLowAlarm, temp=temp, histHum=histHum, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempMax=tempMax, trapEmailErrSocket=trapEmailErrSocket, messageString=messageString, trapHumHighAlarm=trapHumHighAlarm, tempDelayInt=tempDelayInt, humDelayInt=humDelayInt, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, humMin=humMin, compValDelayInt=compValDelayInt, compValMin=compValMin, histTemp=histTemp, humUnit=humUnit, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, comet=comet, settings=settings, compValLowInt=compValLowInt, humHystInt=humHystInt, pysmi_global=pysmi_global, traps=traps, trapTest=trapTest, DisplayString=DisplayString, humInt=humInt, compValUnit=compValUnit, serialNumber=serialNumber, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, trapSOAPErrSocket=trapSOAPErrSocket, compValInt=compValInt, tempLowInt=tempLowInt, tempHighInt=tempHighInt, deviceType=deviceType, trapCompValError=trapCompValError, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, values=values, trapEmailErrLogin=trapEmailErrLogin, humAlarmInt=humAlarmInt, humMax=humMax, valuesInt=valuesInt, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, compValHystInt=compValHystInt, histCompVal=histCompVal, tempMin=tempMin, products=products)
