...
# Produced by pysmi-1.1.12 at Tue May 28 13:33:56 2024
...
MibIdentifier, NotificationType, NotificationType, iso, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Counter32, Counter64, ObjectIdentity, Integer32, enterprises, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "NotificationType", "iso", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Counter32", "Counter64", "ObjectIdentity", "Integer32", "enterprises", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValClrAlarm=trapCompValClrAlarm, t3610=t3610, trapEmailErrLogin=trapEmailErrLogin, humHystInt=humHystInt, traps=traps, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMin=tempMin, trapSOAPErrSocket=trapSOAPErrSocket, valuesInt=valuesInt, trapCompValError=trapCompValError, humAlarm=humAlarm, tempMax=tempMax, trapTempError=trapTempError, tempInt=tempInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, comet=comet, tempAlarm=tempAlarm, humUnit=humUnit, humLowInt=humLowInt, compValInt=compValInt, humAlarmInt=humAlarmInt, trapTempHighAlarm=trapTempHighAlarm, humHighInt=humHighInt, humMin=humMin, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, trapNTPError=trapNTPError, temp=temp, humInt=humInt, tempAlarmInt=tempAlarmInt, compValMax=compValMax, histCompVal=histCompVal, compValAlarmInt=compValAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, trapEmailErrSocket=trapEmailErrSocket, tempLowInt=tempLowInt, trapTempClrAlarm=trapTempClrAlarm, tempHighInt=tempHighInt, compValLowInt=compValLowInt, settings=settings, tables=tables, trapCompValHighAlarm=trapCompValHighAlarm, compValHystInt=compValHystInt, sensorName=sensorName, trapHumHighAlarm=trapHumHighAlarm, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, humDelayInt=humDelayInt, values=values, deviceType=deviceType, historyEntry=historyEntry, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, compValAlarm=compValAlarm, tempUnit=tempUnit, serialNumber=serialNumber, trapEmailErrAuth=trapEmailErrAuth, messageString=messageString, pysmi_global=pysmi_global, compValDelayInt=compValDelayInt, trapHumClrAlarm=trapHumClrAlarm, humMax=humMax, compValUnit=compValUnit, DisplayString=DisplayString, trapTest=trapTest, compValHighInt=compValHighInt, products=products, historyTable=historyTable, tempHystInt=tempHystInt, histTemp=histTemp, hum=hum)
