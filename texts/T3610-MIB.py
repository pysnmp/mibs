...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:41:03 2023
...
NotificationType, Integer32, iso, IpAddress, ModuleIdentity, Counter32, TimeTicks, Bits, Gauge32, Counter64, enterprises, Unsigned32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "iso", "IpAddress", "ModuleIdentity", "Counter32", "TimeTicks", "Bits", "Gauge32", "Counter64", "enterprises", "Unsigned32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", traps=traps, humAlarmInt=humAlarmInt, tempInt=tempInt, tempMax=tempMax, humAlarm=humAlarm, trapCompValError=trapCompValError, tables=tables, trapTempLowAlarm=trapTempLowAlarm, settings=settings, valuesInt=valuesInt, trapTest=trapTest, DisplayString=DisplayString, compValHystInt=compValHystInt, trapSOAPErrFile=trapSOAPErrFile, tempMin=tempMin, serialNumber=serialNumber, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, products=products, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrDNS=trapEmailErrDNS, temp=temp, humInt=humInt, hum=hum, compValMax=compValMax, trapHumClrAlarm=trapHumClrAlarm, tempAlarm=tempAlarm, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, values=values, humMax=humMax, compValLowInt=compValLowInt, compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, historyEntry=historyEntry, pysmi_global=pysmi_global, trapEmailErrLogin=trapEmailErrLogin, humHighInt=humHighInt, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, tempLowInt=tempLowInt, historyTable=historyTable, tempUnit=tempUnit, humMin=humMin, tempDelayInt=tempDelayInt, humHystInt=humHystInt, histCompVal=histCompVal, compValUnit=compValUnit, histTemp=histTemp, deviceType=deviceType, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, trapHumError=trapHumError, trapNTPError=trapNTPError, t3610=t3610, compValInt=compValInt, tempHighInt=tempHighInt, compValMin=compValMin, compVal=compVal, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, trapSOAPErrSocket=trapSOAPErrSocket, sensorName=sensorName, compValHighInt=compValHighInt, trapCompValClrAlarm=trapCompValClrAlarm, humDelayInt=humDelayInt, comet=comet, messageString=messageString)
