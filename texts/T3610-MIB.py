...
# Produced by pysmi-1.1.12 at Fri Nov 22 16:40:37 2024
...
enterprises, Gauge32, Integer32, NotificationType, IpAddress, MibIdentifier, Counter32, NotificationType, TimeTicks, iso, ObjectIdentity, Unsigned32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Integer32", "NotificationType", "IpAddress", "MibIdentifier", "Counter32", "NotificationType", "TimeTicks", "iso", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempClrAlarm=trapTempClrAlarm, compValAlarmInt=compValAlarmInt, humMax=humMax, sensorName=sensorName, compValMin=compValMin, trapCompValError=trapCompValError, humAlarmInt=humAlarmInt, traps=traps, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, trapEmailErrDNS=trapEmailErrDNS, compValHighInt=compValHighInt, tables=tables, trapHumLowAlarm=trapHumLowAlarm, historyTable=historyTable, pysmi_global=pysmi_global, tempUnit=tempUnit, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, comet=comet, tempMax=tempMax, tempHystInt=tempHystInt, compValMax=compValMax, tempDelayInt=tempDelayInt, compValAlarm=compValAlarm, trapSOAPErrFile=trapSOAPErrFile, trapNTPError=trapNTPError, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarm=tempAlarm, trapEmailErrSome=trapEmailErrSome, humDelayInt=humDelayInt, historyEntry=historyEntry, humHystInt=humHystInt, DisplayString=DisplayString, histTemp=histTemp, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, trapSOAPErrSocket=trapSOAPErrSocket, humMin=humMin, compValLowInt=compValLowInt, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, humHighInt=humHighInt, products=products, tempAlarmInt=tempAlarmInt, compValInt=compValInt, tempMin=tempMin, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, tempLowInt=tempLowInt, messageString=messageString, tempHighInt=tempHighInt, compValUnit=compValUnit, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, humAlarm=humAlarm, compVal=compVal, serialNumber=serialNumber, compValHystInt=compValHystInt, values=values, settings=settings, trapEmailErrLogin=trapEmailErrLogin, tempInt=tempInt, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, histCompVal=histCompVal, trapSOAPErrDelivery=trapSOAPErrDelivery, hum=hum, t3610=t3610, valuesInt=valuesInt, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, temp=temp)
