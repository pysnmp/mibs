...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:58:37 2021
...
TimeTicks, iso, ObjectIdentity, Unsigned32, IpAddress, enterprises, ModuleIdentity, Integer32, MibIdentifier, Counter64, NotificationType, Counter32, NotificationType, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "ObjectIdentity", "Unsigned32", "IpAddress", "enterprises", "ModuleIdentity", "Integer32", "MibIdentifier", "Counter64", "NotificationType", "Counter32", "NotificationType", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", values=values, tempMin=tempMin, tempInt=tempInt, tempDelayInt=tempDelayInt, tempHighInt=tempHighInt, trapSOAPErrSocket=trapSOAPErrSocket, compValMin=compValMin, sensorName=sensorName, humHystInt=humHystInt, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarmInt=tempAlarmInt, humInt=humInt, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, trapCompValHighAlarm=trapCompValHighAlarm, products=products, compValUnit=compValUnit, messageString=messageString, histCompVal=histCompVal, compVal=compVal, trapTempError=trapTempError, trapHumError=trapHumError, humHighInt=humHighInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValDelayInt=compValDelayInt, comet=comet, hum=hum, humAlarm=humAlarm, histTemp=histTemp, humMax=humMax, temp=temp, compValHystInt=compValHystInt, humDelayInt=humDelayInt, pysmi_global=pysmi_global, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, trapEmailErrSocket=trapEmailErrSocket, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, compValInt=compValInt, trapEmailErrDNS=trapEmailErrDNS, tables=tables, trapEmailErrLogin=trapEmailErrLogin, humLowInt=humLowInt, historyEntry=historyEntry, settings=settings, tempAlarm=tempAlarm, humMin=humMin, humUnit=humUnit, tempLowInt=tempLowInt, trapTest=trapTest, DisplayString=DisplayString, valuesInt=valuesInt, compValMax=compValMax, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, tempMax=tempMax, histHum=histHum, tempHystInt=tempHystInt, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapNTPError=trapNTPError, tempUnit=tempUnit, traps=traps, compValAlarm=compValAlarm, historyTable=historyTable, serialNumber=serialNumber, trapSOAPErrDNS=trapSOAPErrDNS)
