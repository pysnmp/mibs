...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:56:47 2023
...
NotificationType, ObjectIdentity, ModuleIdentity, Counter64, Bits, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, MibIdentifier, enterprises, Counter32, NotificationType, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Counter64", "Bits", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "MibIdentifier", "enterprises", "Counter32", "NotificationType", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, tempDelayInt=tempDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, tempHystInt=tempHystInt, temp=temp, compValHighInt=compValHighInt, t3610=t3610, DisplayString=DisplayString, tempMax=tempMax, sensorName=sensorName, tempInt=tempInt, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, trapNTPError=trapNTPError, valuesInt=valuesInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDelivery=trapSOAPErrDelivery, tempUnit=tempUnit, values=values, tables=tables, tempMin=tempMin, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, humAlarm=humAlarm, hum=hum, compValAlarm=compValAlarm, compValAlarmInt=compValAlarmInt, serialNumber=serialNumber, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, traps=traps, humDelayInt=humDelayInt, trapTest=trapTest, historyTable=historyTable, humInt=humInt, humMax=humMax, trapCompValError=trapCompValError, humHystInt=humHystInt, tempHighInt=tempHighInt, products=products, tempAlarm=tempAlarm, compValUnit=compValUnit, compValMax=compValMax, compValHystInt=compValHystInt, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, trapHumLowAlarm=trapHumLowAlarm, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, historyEntry=historyEntry, humMin=humMin, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, trapEmailErrDNS=trapEmailErrDNS, humHighInt=humHighInt, settings=settings, trapHumError=trapHumError, trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compVal=compVal, humAlarmInt=humAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, tempLowInt=tempLowInt)
