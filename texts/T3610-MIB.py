...
Integer32, ModuleIdentity, ObjectIdentity, TimeTicks, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter32, MibIdentifier, NotificationType, Unsigned32, NotificationType, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter32", "MibIdentifier", "NotificationType", "Unsigned32", "NotificationType", "iso", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", t3610=t3610, compValAlarmInt=compValAlarmInt, compVal=compVal, tempInt=tempInt, humInt=humInt, compValMin=compValMin, tempDelayInt=tempDelayInt, trapTempClrAlarm=trapTempClrAlarm, tempUnit=tempUnit, products=products, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrAuth=trapEmailErrAuth, tempMax=tempMax, trapHumLowAlarm=trapHumLowAlarm, tempAlarmInt=tempAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, humUnit=humUnit, trapCompValError=trapCompValError, compValMax=compValMax, DisplayString=DisplayString, humAlarmInt=humAlarmInt, trapTest=trapTest, humDelayInt=humDelayInt, pysmi_global=pysmi_global, tables=tables, messageString=messageString, settings=settings, compValHighInt=compValHighInt, histCompVal=histCompVal, serialNumber=serialNumber, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarm=tempAlarm, histHum=histHum, traps=traps, deviceType=deviceType, compValInt=compValInt, trapEmailErrDNS=trapEmailErrDNS, values=values, comet=comet, humHystInt=humHystInt, compValHystInt=compValHystInt, humHighInt=humHighInt, humLowInt=humLowInt, historyEntry=historyEntry, tempHighInt=tempHighInt, tempMin=tempMin, tempHystInt=tempHystInt, humMin=humMin, histTemp=histTemp, trapHumHighAlarm=trapHumHighAlarm, trapTempHighAlarm=trapTempHighAlarm, compValUnit=compValUnit, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, trapCompValLowAlarm=trapCompValLowAlarm, compValLowInt=compValLowInt, humMax=humMax, trapHumError=trapHumError, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, temp=temp, trapSOAPErrFile=trapSOAPErrFile, hum=hum, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, trapTempLowAlarm=trapTempLowAlarm, humAlarm=humAlarm, compValAlarm=compValAlarm)
