...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:15:16 2021
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Gauge32, Counter64, IpAddress, iso, Bits, enterprises, Unsigned32, TimeTicks, Counter32, MibIdentifier, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Gauge32", "Counter64", "IpAddress", "iso", "Bits", "enterprises", "Unsigned32", "TimeTicks", "Counter32", "MibIdentifier", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, trapNTPError=trapNTPError, humAlarm=humAlarm, humMax=humMax, histHum=histHum, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, deviceType=deviceType, compValLowInt=compValLowInt, humMin=humMin, t3610=t3610, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, histCompVal=histCompVal, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, trapCompValError=trapCompValError, tempMin=tempMin, sensorName=sensorName, humDelayInt=humDelayInt, humLowInt=humLowInt, tempHystInt=tempHystInt, settings=settings, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrAuth=trapEmailErrAuth, humUnit=humUnit, tempMax=tempMax, serialNumber=serialNumber, compValAlarmInt=compValAlarmInt, tempDelayInt=tempDelayInt, traps=traps, pysmi_global=pysmi_global, trapCompValLowAlarm=trapCompValLowAlarm, compValMin=compValMin, comet=comet, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, products=products, tempUnit=tempUnit, compValHighInt=compValHighInt, compValUnit=compValUnit, trapTempError=trapTempError, tables=tables, compValInt=compValInt, valuesInt=valuesInt, compVal=compVal, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, trapHumHighAlarm=trapHumHighAlarm, values=values, messageString=messageString, histTemp=histTemp, trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, trapTempLowAlarm=trapTempLowAlarm, historyEntry=historyEntry, humInt=humInt, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, humHystInt=humHystInt, trapEmailErrSome=trapEmailErrSome, compValAlarm=compValAlarm, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, trapTempHighAlarm=trapTempHighAlarm, hum=hum, tempInt=tempInt, historyTable=historyTable, temp=temp, tempAlarm=tempAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery)
