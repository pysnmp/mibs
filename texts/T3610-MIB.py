...
# Produced by pysmi-1.1.8 at Mon Feb  7 16:08:57 2022
...
Gauge32, ModuleIdentity, MibIdentifier, Counter64, NotificationType, NotificationType, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Bits, Counter32, Integer32, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "MibIdentifier", "Counter64", "NotificationType", "NotificationType", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Bits", "Counter32", "Integer32", "iso", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", tempDelayInt=tempDelayInt, tempAlarmInt=tempAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, tempMax=tempMax, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, compValMax=compValMax, humHystInt=humHystInt, messageString=messageString, histCompVal=histCompVal, trapHumError=trapHumError, compValHystInt=compValHystInt, humInt=humInt, compValHighInt=compValHighInt, tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, hum=hum, serialNumber=serialNumber, sensorName=sensorName, compValMin=compValMin, compValDelayInt=compValDelayInt, settings=settings, historyTable=historyTable, products=products, compVal=compVal, tempAlarm=tempAlarm, humDelayInt=humDelayInt, traps=traps, humAlarm=humAlarm, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, trapEmailErrSome=trapEmailErrSome, humMin=humMin, humAlarmInt=humAlarmInt, t3610=t3610, compValAlarmInt=compValAlarmInt, trapTest=trapTest, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, histHum=histHum, trapTempError=trapTempError, tempMin=tempMin, trapSOAPErrDelivery=trapSOAPErrDelivery, values=values, humMax=humMax, compValAlarm=compValAlarm, tempUnit=tempUnit, tempInt=tempInt, humLowInt=humLowInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, deviceType=deviceType, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, temp=temp, trapTempHighAlarm=trapTempHighAlarm, compValUnit=compValUnit, historyEntry=historyEntry, trapNTPError=trapNTPError, tempLowInt=tempLowInt, humHighInt=humHighInt, trapTempClrAlarm=trapTempClrAlarm, comet=comet, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, tables=tables, tempHighInt=tempHighInt, pysmi_global=pysmi_global)
