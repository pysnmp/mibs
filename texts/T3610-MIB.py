...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:42:31 2024
...
enterprises, NotificationType, Unsigned32, TimeTicks, IpAddress, Bits, NotificationType, Counter32, MibIdentifier, iso, ModuleIdentity, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Unsigned32", "TimeTicks", "IpAddress", "Bits", "NotificationType", "Counter32", "MibIdentifier", "iso", "ModuleIdentity", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSome=trapEmailErrSome, compValHighInt=compValHighInt, humMin=humMin, humHighInt=humHighInt, historyEntry=historyEntry, products=products, compValUnit=compValUnit, compValLowInt=compValLowInt, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, tables=tables, compValMax=compValMax, humAlarmInt=humAlarmInt, tempMax=tempMax, compValAlarmInt=compValAlarmInt, trapHumLowAlarm=trapHumLowAlarm, tempInt=tempInt, histCompVal=histCompVal, trapCompValLowAlarm=trapCompValLowAlarm, deviceType=deviceType, tempAlarm=tempAlarm, humInt=humInt, compValDelayInt=compValDelayInt, trapTest=trapTest, tempLowInt=tempLowInt, histTemp=histTemp, pysmi_global=pysmi_global, humMax=humMax, compValAlarm=compValAlarm, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, compValHystInt=compValHystInt, DisplayString=DisplayString, comet=comet, humUnit=humUnit, tempUnit=tempUnit, compValMin=compValMin, trapEmailErrSocket=trapEmailErrSocket, t3610=t3610, trapSOAPErrSocket=trapSOAPErrSocket, humLowInt=humLowInt, values=values, serialNumber=serialNumber, tempMin=tempMin, messageString=messageString, valuesInt=valuesInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, trapTempLowAlarm=trapTempLowAlarm, tempHighInt=tempHighInt, trapNTPError=trapNTPError, traps=traps, humDelayInt=humDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, compVal=compVal, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, tempDelayInt=tempDelayInt, trapTempError=trapTempError, trapSOAPErrFile=trapSOAPErrFile, hum=hum, sensorName=sensorName, settings=settings, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempClrAlarm=trapTempClrAlarm, historyTable=historyTable, tempAlarmInt=tempAlarmInt, trapHumError=trapHumError, humAlarm=humAlarm, histHum=histHum, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, compValInt=compValInt, temp=temp)
