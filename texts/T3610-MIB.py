...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:48:50 2022
...
Integer32, NotificationType, Unsigned32, ObjectIdentity, Bits, ModuleIdentity, Counter32, iso, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, MibIdentifier, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Unsigned32", "ObjectIdentity", "Bits", "ModuleIdentity", "Counter32", "iso", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "MibIdentifier", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", deviceType=deviceType, trapTempClrAlarm=trapTempClrAlarm, compValHystInt=compValHystInt, historyTable=historyTable, humHystInt=humHystInt, tempMax=tempMax, trapHumLowAlarm=trapHumLowAlarm, histTemp=histTemp, serialNumber=serialNumber, historyEntry=historyEntry, humUnit=humUnit, compValUnit=compValUnit, compValLowInt=compValLowInt, pysmi_global=pysmi_global, trapTempHighAlarm=trapTempHighAlarm, histHum=histHum, t3610=t3610, trapEmailErrLogin=trapEmailErrLogin, tempInt=tempInt, trapHumClrAlarm=trapHumClrAlarm, compVal=compVal, tempUnit=tempUnit, trapCompValLowAlarm=trapCompValLowAlarm, tempDelayInt=tempDelayInt, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, compValInt=compValInt, histCompVal=histCompVal, settings=settings, temp=temp, compValAlarm=compValAlarm, compValMax=compValMax, humLowInt=humLowInt, humAlarmInt=humAlarmInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrFile=trapSOAPErrFile, hum=hum, trapTempLowAlarm=trapTempLowAlarm, compValHighInt=compValHighInt, comet=comet, tempHighInt=tempHighInt, tempHystInt=tempHystInt, compValMin=compValMin, trapTest=trapTest, tempAlarm=tempAlarm, valuesInt=valuesInt, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, trapHumHighAlarm=trapHumHighAlarm, trapNTPError=trapNTPError, values=values, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, sensorName=sensorName, products=products, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, trapHumError=trapHumError, humHighInt=humHighInt, tempLowInt=tempLowInt, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarmInt=tempAlarmInt, humMin=humMin, tempMin=tempMin, traps=traps, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, tables=tables, DisplayString=DisplayString, humInt=humInt, trapSOAPErrDelivery=trapSOAPErrDelivery)
