...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:25:17 2021
...
enterprises, TimeTicks, Bits, IpAddress, ObjectIdentity, Counter64, Unsigned32, NotificationType, MibIdentifier, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Bits", "IpAddress", "ObjectIdentity", "Counter64", "Unsigned32", "NotificationType", "MibIdentifier", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, hum=hum, pysmi_global=pysmi_global, tempAlarmInt=tempAlarmInt, historyTable=historyTable, trapTest=trapTest, compVal=compVal, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, humAlarm=humAlarm, comet=comet, traps=traps, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, tempMin=tempMin, humInt=humInt, humAlarmInt=humAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, temp=temp, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, messageString=messageString, humMin=humMin, humDelayInt=humDelayInt, compValInt=compValInt, sensorName=sensorName, t3610=t3610, values=values, trapTempClrAlarm=trapTempClrAlarm, deviceType=deviceType, trapTempError=trapTempError, tempLowInt=tempLowInt, DisplayString=DisplayString, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, humMax=humMax, compValAlarm=compValAlarm, humUnit=humUnit, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, compValMin=compValMin, compValDelayInt=compValDelayInt, trapCompValError=trapCompValError, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempInt=tempInt, tempHighInt=tempHighInt, humLowInt=humLowInt, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, tempHystInt=tempHystInt, products=products, compValMax=compValMax, compValHystInt=compValHystInt, tempUnit=tempUnit, serialNumber=serialNumber, compValHighInt=compValHighInt, trapHumClrAlarm=trapHumClrAlarm, settings=settings, tables=tables, tempMax=tempMax, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, trapNTPError=trapNTPError, tempAlarm=tempAlarm)
