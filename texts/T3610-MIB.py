...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:02:56 2021
...
enterprises, NotificationType, Counter64, MibIdentifier, ModuleIdentity, NotificationType, Bits, iso, ObjectIdentity, Integer32, Counter32, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter64", "MibIdentifier", "ModuleIdentity", "NotificationType", "Bits", "iso", "ObjectIdentity", "Integer32", "Counter32", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, trapTempClrAlarm=trapTempClrAlarm, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, compValHighInt=compValHighInt, t3610=t3610, trapSOAPErrFile=trapSOAPErrFile, messageString=messageString, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, tempDelayInt=tempDelayInt, trapEmailErrLogin=trapEmailErrLogin, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, compValUnit=compValUnit, humUnit=humUnit, deviceType=deviceType, trapTest=trapTest, trapHumError=trapHumError, trapCompValLowAlarm=trapCompValLowAlarm, temp=temp, histTemp=histTemp, DisplayString=DisplayString, comet=comet, humAlarmInt=humAlarmInt, historyEntry=historyEntry, historyTable=historyTable, settings=settings, compValAlarm=compValAlarm, trapTempHighAlarm=trapTempHighAlarm, compValHystInt=compValHystInt, trapCompValClrAlarm=trapCompValClrAlarm, histCompVal=histCompVal, tempMax=tempMax, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, products=products, tempInt=tempInt, compValAlarmInt=compValAlarmInt, tempMin=tempMin, tables=tables, humMin=humMin, compValLowInt=compValLowInt, humDelayInt=humDelayInt, tempHystInt=tempHystInt, histHum=histHum, compValDelayInt=compValDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarm=tempAlarm, trapNTPError=trapNTPError, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, compValMax=compValMax, tempUnit=tempUnit, pysmi_global=pysmi_global, traps=traps, compVal=compVal, humInt=humInt, humAlarm=humAlarm, humHystInt=humHystInt, tempLowInt=tempLowInt, humHighInt=humHighInt, sensorName=sensorName, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, values=values, hum=hum, trapEmailErrSome=trapEmailErrSome, humLowInt=humLowInt)
