...
TimeTicks, Integer32, Counter32, Counter64, MibIdentifier, ModuleIdentity, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Bits, ObjectIdentity, iso, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Counter32", "Counter64", "MibIdentifier", "ModuleIdentity", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Bits", "ObjectIdentity", "iso", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, DisplayString=DisplayString, messageString=messageString, humHighInt=humHighInt, trapHumError=trapHumError, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, compVal=compVal, trapSOAPErrSocket=trapSOAPErrSocket, compValMin=compValMin, compValInt=compValInt, historyEntry=historyEntry, humMax=humMax, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValClrAlarm=trapCompValClrAlarm, tempAlarm=tempAlarm, humUnit=humUnit, compValDelayInt=compValDelayInt, compValMax=compValMax, humHystInt=humHystInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, tempMin=tempMin, trapHumClrAlarm=trapHumClrAlarm, histTemp=histTemp, deviceType=deviceType, historyTable=historyTable, valuesInt=valuesInt, trapHumHighAlarm=trapHumHighAlarm, trapCompValError=trapCompValError, tempHystInt=tempHystInt, humDelayInt=humDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, trapSOAPErrFile=trapSOAPErrFile, trapCompValHighAlarm=trapCompValHighAlarm, tables=tables, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrDNS=trapEmailErrDNS, traps=traps, tempLowInt=tempLowInt, humMin=humMin, values=values, temp=temp, hum=hum, tempDelayInt=tempDelayInt, trapTest=trapTest, trapNTPError=trapNTPError, compValUnit=compValUnit, trapTempLowAlarm=trapTempLowAlarm, tempUnit=tempUnit, pysmi_global=pysmi_global, products=products, humAlarmInt=humAlarmInt, histHum=histHum, serialNumber=serialNumber, trapTempError=trapTempError, humAlarm=humAlarm, histCompVal=histCompVal, humLowInt=humLowInt, tempAlarmInt=tempAlarmInt, comet=comet, trapTempHighAlarm=trapTempHighAlarm, compValAlarm=compValAlarm, sensorName=sensorName, compValHighInt=compValHighInt, trapEmailErrLogin=trapEmailErrLogin, compValAlarmInt=compValAlarmInt, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, compValLowInt=compValLowInt, tempMax=tempMax, tempInt=tempInt, trapEmailErrSome=trapEmailErrSome)
