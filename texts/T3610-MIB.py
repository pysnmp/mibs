...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:20:05 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Gauge32, IpAddress, Bits, NotificationType, TimeTicks, iso, MibIdentifier, NotificationType, Unsigned32, Counter64, ModuleIdentity, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Gauge32", "IpAddress", "Bits", "NotificationType", "TimeTicks", "iso", "MibIdentifier", "NotificationType", "Unsigned32", "Counter64", "ModuleIdentity", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, compValMin=compValMin, trapEmailErrLogin=trapEmailErrLogin, compValHighInt=compValHighInt, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, tempHighInt=tempHighInt, humDelayInt=humDelayInt, compValUnit=compValUnit, sensorName=sensorName, historyEntry=historyEntry, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, tempUnit=tempUnit, trapHumClrAlarm=trapHumClrAlarm, compVal=compVal, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, messageString=messageString, compValInt=compValInt, humMin=humMin, tempLowInt=tempLowInt, histCompVal=histCompVal, traps=traps, tempDelayInt=tempDelayInt, humAlarmInt=humAlarmInt, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, pysmi_global=pysmi_global, compValMax=compValMax, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, trapEmailErrAuth=trapEmailErrAuth, humAlarm=humAlarm, serialNumber=serialNumber, trapTempError=trapTempError, compValLowInt=compValLowInt, humHystInt=humHystInt, tempMin=tempMin, tempAlarmInt=tempAlarmInt, trapTempHighAlarm=trapTempHighAlarm, tempInt=tempInt, trapSOAPErrFile=trapSOAPErrFile, trapTest=trapTest, humLowInt=humLowInt, trapEmailErrSome=trapEmailErrSome, compValHystInt=compValHystInt, temp=temp, histTemp=histTemp, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarm=compValAlarm, t3610=t3610, tempAlarm=tempAlarm, humUnit=humUnit, comet=comet, tempMax=tempMax, humMax=humMax, trapTempClrAlarm=trapTempClrAlarm, deviceType=deviceType, compValAlarmInt=compValAlarmInt, trapHumError=trapHumError, trapCompValClrAlarm=trapCompValClrAlarm, DisplayString=DisplayString, trapCompValError=trapCompValError, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, settings=settings, trapEmailErrSocket=trapEmailErrSocket, products=products, values=values, humInt=humInt, humHighInt=humHighInt, hum=hum)
