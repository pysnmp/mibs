...
# Produced by pysmi-1.1.8 at Tue Sep 12 07:22:28 2023
...
NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, iso, ModuleIdentity, ObjectIdentity, MibIdentifier, Bits, Counter32, Unsigned32, Integer32, NotificationType, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "iso", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Bits", "Counter32", "Unsigned32", "Integer32", "NotificationType", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, trapTempError=trapTempError, temp=temp, DisplayString=DisplayString, histHum=histHum, humAlarm=humAlarm, settings=settings, trapSOAPErrFile=trapSOAPErrFile, histCompVal=histCompVal, trapTempClrAlarm=trapTempClrAlarm, tempMax=tempMax, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, humLowInt=humLowInt, t3610=t3610, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarm=compValAlarm, compValMin=compValMin, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrDNS=trapSOAPErrDNS, compValMax=compValMax, compVal=compVal, tempAlarm=tempAlarm, humUnit=humUnit, tempAlarmInt=tempAlarmInt, serialNumber=serialNumber, valuesInt=valuesInt, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, humInt=humInt, tempHighInt=tempHighInt, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, comet=comet, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, compValInt=compValInt, trapEmailErrSocket=trapEmailErrSocket, traps=traps, trapEmailErrSome=trapEmailErrSome, messageString=messageString, compValHighInt=compValHighInt, humHighInt=humHighInt, humAlarmInt=humAlarmInt, humMin=humMin, historyTable=historyTable, tempDelayInt=tempDelayInt, tempHystInt=tempHystInt, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempLowInt=tempLowInt, trapHumError=trapHumError, trapTest=trapTest, pysmi_global=pysmi_global, compValAlarmInt=compValAlarmInt, products=products, humMax=humMax, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm, histTemp=histTemp, humDelayInt=humDelayInt, trapHumClrAlarm=trapHumClrAlarm, values=values, tempMin=tempMin, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, tables=tables, trapCompValError=trapCompValError, compValUnit=compValUnit)
