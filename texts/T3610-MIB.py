...
Counter32, NotificationType, iso, TimeTicks, Unsigned32, IpAddress, MibIdentifier, Gauge32, ModuleIdentity, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "iso", "TimeTicks", "Unsigned32", "IpAddress", "MibIdentifier", "Gauge32", "ModuleIdentity", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", compValHighInt=compValHighInt, tempUnit=tempUnit, products=products, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, histTemp=histTemp, humUnit=humUnit, trapNTPError=trapNTPError, compValMax=compValMax, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrLogin=trapEmailErrLogin, values=values, compValAlarm=compValAlarm, trapTempError=trapTempError, historyEntry=historyEntry, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, humAlarmInt=humAlarmInt, trapEmailErrSome=trapEmailErrSome, DisplayString=DisplayString, traps=traps, humAlarm=humAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, comet=comet, trapCompValError=trapCompValError, humLowInt=humLowInt, temp=temp, compValInt=compValInt, compValUnit=compValUnit, histHum=histHum, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, serialNumber=serialNumber, tempLowInt=tempLowInt, tempHystInt=tempHystInt, tempMin=tempMin, humHystInt=humHystInt, compValHystInt=compValHystInt, trapHumClrAlarm=trapHumClrAlarm, tables=tables, tempInt=tempInt, compVal=compVal, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, tempAlarmInt=tempAlarmInt, pysmi_global=pysmi_global, humHighInt=humHighInt, messageString=messageString, tempDelayInt=tempDelayInt, valuesInt=valuesInt, sensorName=sensorName, tempHighInt=tempHighInt, humMin=humMin, tempMax=tempMax, humMax=humMax, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, humInt=humInt, trapHumLowAlarm=trapHumLowAlarm, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, hum=hum, compValLowInt=compValLowInt, tempAlarm=tempAlarm, settings=settings, compValAlarmInt=compValAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError)
