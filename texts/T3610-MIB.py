...
enterprises, Bits, Counter64, Counter32, NotificationType, Gauge32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Unsigned32, Integer32, NotificationType, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Counter64", "Counter32", "NotificationType", "Gauge32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Unsigned32", "Integer32", "NotificationType", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", values=values, trapEmailErrDNS=trapEmailErrDNS, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, trapTempError=trapTempError, compValHighInt=compValHighInt, trapEmailErrAuth=trapEmailErrAuth, valuesInt=valuesInt, humHystInt=humHystInt, sensorName=sensorName, trapSOAPErrDNS=trapSOAPErrDNS, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, t3610=t3610, DisplayString=DisplayString, compVal=compVal, tempHighInt=tempHighInt, histHum=histHum, trapTempLowAlarm=trapTempLowAlarm, compValAlarm=compValAlarm, compValLowInt=compValLowInt, compValAlarmInt=compValAlarmInt, deviceType=deviceType, pysmi_global=pysmi_global, humLowInt=humLowInt, compValMin=compValMin, tempMax=tempMax, compValMax=compValMax, humInt=humInt, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSocket=trapEmailErrSocket, tempHystInt=tempHystInt, traps=traps, histCompVal=histCompVal, tempDelayInt=tempDelayInt, tempMin=tempMin, tempInt=tempInt, tempAlarm=tempAlarm, tempLowInt=tempLowInt, trapSOAPErrFile=trapSOAPErrFile, tables=tables, products=products, settings=settings, trapHumHighAlarm=trapHumHighAlarm, humMax=humMax, hum=hum, humDelayInt=humDelayInt, messageString=messageString, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, serialNumber=serialNumber, temp=temp, historyTable=historyTable, trapEmailErrSome=trapEmailErrSome, trapNTPError=trapNTPError, compValHystInt=compValHystInt, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, humMin=humMin, comet=comet, tempUnit=tempUnit, compValUnit=compValUnit, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, humAlarm=humAlarm, humUnit=humUnit, historyEntry=historyEntry, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTest=trapTest, humHighInt=humHighInt, compValInt=compValInt, histTemp=histTemp)
