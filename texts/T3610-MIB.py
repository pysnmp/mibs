...
Counter32, enterprises, Counter64, NotificationType, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, TimeTicks, NotificationType, ModuleIdentity, Unsigned32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "Counter64", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "TimeTicks", "NotificationType", "ModuleIdentity", "Unsigned32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumHighAlarm=trapHumHighAlarm, histHum=histHum, compValHystInt=compValHystInt, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, hum=hum, trapTempError=trapTempError, tempDelayInt=tempDelayInt, values=values, tables=tables, compValAlarm=compValAlarm, humAlarm=humAlarm, historyTable=historyTable, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, tempMax=tempMax, valuesInt=valuesInt, comet=comet, trapCompValClrAlarm=trapCompValClrAlarm, compVal=compVal, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, serialNumber=serialNumber, trapNTPError=trapNTPError, trapHumError=trapHumError, temp=temp, compValMin=compValMin, humMax=humMax, compValLowInt=compValLowInt, tempLowInt=tempLowInt, messageString=messageString, historyEntry=historyEntry, traps=traps, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, compValDelayInt=compValDelayInt, tempMin=tempMin, tempHystInt=tempHystInt, pysmi_global=pysmi_global, trapSOAPErrFile=trapSOAPErrFile, tempUnit=tempUnit, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, settings=settings, tempAlarmInt=tempAlarmInt, humMin=humMin, deviceType=deviceType, t3610=t3610, trapSOAPErrDNS=trapSOAPErrDNS, compValMax=compValMax, humDelayInt=humDelayInt, tempHighInt=tempHighInt, DisplayString=DisplayString, trapCompValError=trapCompValError, trapEmailErrDNS=trapEmailErrDNS, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, trapHumLowAlarm=trapHumLowAlarm, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrLogin=trapEmailErrLogin, humInt=humInt, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, sensorName=sensorName, tempInt=tempInt, compValHighInt=compValHighInt, tempAlarm=tempAlarm, humUnit=humUnit, compValInt=compValInt, histTemp=histTemp, humLowInt=humLowInt, products=products, humHighInt=humHighInt)
