...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:42:46 2022
...
NotificationType, TimeTicks, NotificationType, Counter32, enterprises, ObjectIdentity, Integer32, iso, ModuleIdentity, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "NotificationType", "Counter32", "enterprises", "ObjectIdentity", "Integer32", "iso", "ModuleIdentity", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, compValInt=compValInt, histCompVal=histCompVal, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempError=trapTempError, temp=temp, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, DisplayString=DisplayString, tempUnit=tempUnit, tables=tables, humAlarm=humAlarm, settings=settings, tempMax=tempMax, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, humAlarmInt=humAlarmInt, humHighInt=humHighInt, tempHighInt=tempHighInt, products=products, compValLowInt=compValLowInt, trapEmailErrLogin=trapEmailErrLogin, tempMin=tempMin, sensorName=sensorName, trapHumError=trapHumError, tempInt=tempInt, trapCompValError=trapCompValError, trapTempHighAlarm=trapTempHighAlarm, historyTable=historyTable, comet=comet, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapNTPError=trapNTPError, traps=traps, values=values, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, humDelayInt=humDelayInt, historyEntry=historyEntry, histTemp=histTemp, trapCompValHighAlarm=trapCompValHighAlarm, pysmi_global=pysmi_global, humMax=humMax, hum=hum, humMin=humMin, humInt=humInt, humLowInt=humLowInt, compValDelayInt=compValDelayInt, compValHystInt=compValHystInt, deviceType=deviceType, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, humUnit=humUnit, trapHumClrAlarm=trapHumClrAlarm, tempDelayInt=tempDelayInt, compValAlarm=compValAlarm, compValMax=compValMax, serialNumber=serialNumber, compValHighInt=compValHighInt, tempHystInt=tempHystInt, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, t3610=t3610, histHum=histHum, compVal=compVal)
