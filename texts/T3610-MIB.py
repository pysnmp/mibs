...
# Produced by pysmi-1.1.12 at Tue Dec  3 11:38:01 2024
...
MibIdentifier, Counter64, NotificationType, Unsigned32, ModuleIdentity, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Bits, enterprises, TimeTicks, Integer32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "NotificationType", "Unsigned32", "ModuleIdentity", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Bits", "enterprises", "TimeTicks", "Integer32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, tempMax=tempMax, products=products, humMax=humMax, sensorName=sensorName, trapEmailErrSocket=trapEmailErrSocket, DisplayString=DisplayString, compValHighInt=compValHighInt, tempHighInt=tempHighInt, trapCompValError=trapCompValError, trapEmailErrAuth=trapEmailErrAuth, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, valuesInt=valuesInt, compValDelayInt=compValDelayInt, trapTempError=trapTempError, compVal=compVal, humHystInt=humHystInt, historyTable=historyTable, settings=settings, values=values, humDelayInt=humDelayInt, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, temp=temp, trapEmailErrDNS=trapEmailErrDNS, traps=traps, compValMin=compValMin, tables=tables, compValHystInt=compValHystInt, pysmi_global=pysmi_global, tempMin=tempMin, tempAlarmInt=tempAlarmInt, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, humLowInt=humLowInt, t3610=t3610, trapEmailErrLogin=trapEmailErrLogin, trapNTPError=trapNTPError, humAlarm=humAlarm, humHighInt=humHighInt, tempDelayInt=tempDelayInt, histHum=histHum, compValLowInt=compValLowInt, tempAlarm=tempAlarm, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, tempLowInt=tempLowInt, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, compValUnit=compValUnit, tempHystInt=tempHystInt, humAlarmInt=humAlarmInt, compValInt=compValInt, messageString=messageString, histTemp=histTemp, hum=hum, comet=comet, trapHumLowAlarm=trapHumLowAlarm, histCompVal=histCompVal, trapEmailErrSome=trapEmailErrSome, serialNumber=serialNumber, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, tempUnit=tempUnit, humMin=humMin, tempInt=tempInt, compValMax=compValMax, humInt=humInt, trapTempClrAlarm=trapTempClrAlarm, compValAlarmInt=compValAlarmInt, trapTempLowAlarm=trapTempLowAlarm)
