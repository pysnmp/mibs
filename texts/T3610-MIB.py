...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:09:39 2023
...
Gauge32, Counter32, Counter64, ModuleIdentity, enterprises, iso, Unsigned32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, NotificationType, Bits, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Counter64", "ModuleIdentity", "enterprises", "iso", "Unsigned32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "NotificationType", "Bits", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempHighAlarm=trapTempHighAlarm, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName, histCompVal=histCompVal, compValMin=compValMin, humAlarmInt=humAlarmInt, trapTest=trapTest, trapCompValClrAlarm=trapCompValClrAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, histHum=histHum, tempLowInt=tempLowInt, trapEmailErrSome=trapEmailErrSome, valuesInt=valuesInt, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, trapHumClrAlarm=trapHumClrAlarm, tempMax=tempMax, compValHystInt=compValHystInt, tempInt=tempInt, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, humMin=humMin, tempAlarm=tempAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, humUnit=humUnit, trapHumHighAlarm=trapHumHighAlarm, comet=comet, compValInt=compValInt, tempDelayInt=tempDelayInt, humMax=humMax, serialNumber=serialNumber, humInt=humInt, historyTable=historyTable, messageString=messageString, trapHumError=trapHumError, tempHighInt=tempHighInt, trapTempClrAlarm=trapTempClrAlarm, historyEntry=historyEntry, traps=traps, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, trapSOAPErrDNS=trapSOAPErrDNS, values=values, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, pysmi_global=pysmi_global, tables=tables, temp=temp, trapNTPError=trapNTPError, histTemp=histTemp, trapEmailErrDNS=trapEmailErrDNS, DisplayString=DisplayString, humHighInt=humHighInt, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, humHystInt=humHystInt, compValAlarm=compValAlarm, compValLowInt=compValLowInt, trapTempError=trapTempError, tempHystInt=tempHystInt, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, settings=settings, products=products, tempUnit=tempUnit, humDelayInt=humDelayInt, hum=hum, compValMax=compValMax, humAlarm=humAlarm, deviceType=deviceType, compValUnit=compValUnit, tempMin=tempMin)
