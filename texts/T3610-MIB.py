...
# Produced by pysmi-1.1.8 at Thu Oct 26 08:58:48 2023
...
NotificationType, enterprises, iso, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Counter64, Gauge32, Unsigned32, MibIdentifier, ModuleIdentity, TimeTicks, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "iso", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Counter64", "Gauge32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", tempHighInt=tempHighInt, hum=hum, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, humHighInt=humHighInt, compValUnit=compValUnit, temp=temp, compValMax=compValMax, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, tempHystInt=tempHystInt, compValAlarmInt=compValAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, humAlarmInt=humAlarmInt, trapTempLowAlarm=trapTempLowAlarm, tempInt=tempInt, sensorName=sensorName, messageString=messageString, tempAlarm=tempAlarm, values=values, humMin=humMin, pysmi_global=pysmi_global, tables=tables, t3610=t3610, trapTempHighAlarm=trapTempHighAlarm, humLowInt=humLowInt, trapCompValError=trapCompValError, compValLowInt=compValLowInt, compValInt=compValInt, compVal=compVal, compValMin=compValMin, deviceType=deviceType, trapEmailErrLogin=trapEmailErrLogin, tempAlarmInt=tempAlarmInt, trapTempError=trapTempError, tempUnit=tempUnit, compValHighInt=compValHighInt, compValHystInt=compValHystInt, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, tempMax=tempMax, settings=settings, serialNumber=serialNumber, humInt=humInt, tempMin=tempMin, tempLowInt=tempLowInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, histHum=histHum, products=products, humMax=humMax, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrFile=trapSOAPErrFile, compValDelayInt=compValDelayInt, DisplayString=DisplayString, trapSOAPErrDelivery=trapSOAPErrDelivery, trapNTPError=trapNTPError, comet=comet, histCompVal=histCompVal, traps=traps, trapHumError=trapHumError, humAlarm=humAlarm, historyTable=historyTable, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTest=trapTest, valuesInt=valuesInt, histTemp=histTemp, compValAlarm=compValAlarm, humHystInt=humHystInt)
