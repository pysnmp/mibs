...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:10:52 2024
...
ModuleIdentity, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Unsigned32, NotificationType, IpAddress, NotificationType, ObjectIdentity, Counter64, Integer32, enterprises, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Unsigned32", "NotificationType", "IpAddress", "NotificationType", "ObjectIdentity", "Counter64", "Integer32", "enterprises", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", temp=temp, trapTempError=trapTempError, traps=traps, humAlarm=humAlarm, compValAlarm=compValAlarm, sensorName=sensorName, messageString=messageString, compValLowInt=compValLowInt, valuesInt=valuesInt, trapCompValError=trapCompValError, tempMax=tempMax, humLowInt=humLowInt, humDelayInt=humDelayInt, trapHumLowAlarm=trapHumLowAlarm, tempHystInt=tempHystInt, DisplayString=DisplayString, compValUnit=compValUnit, tables=tables, values=values, humAlarmInt=humAlarmInt, serialNumber=serialNumber, humUnit=humUnit, trapEmailErrDNS=trapEmailErrDNS, humHighInt=humHighInt, humInt=humInt, trapEmailErrLogin=trapEmailErrLogin, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, t3610=t3610, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt, histCompVal=histCompVal, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, products=products, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, comet=comet, compValMin=compValMin, trapSOAPErrDelivery=trapSOAPErrDelivery, settings=settings, hum=hum, tempUnit=tempUnit, deviceType=deviceType, compValDelayInt=compValDelayInt, compVal=compVal, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, compValHighInt=compValHighInt, trapTempLowAlarm=trapTempLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, tempLowInt=tempLowInt, tempDelayInt=tempDelayInt, trapTest=trapTest, compValMax=compValMax, compValInt=compValInt, tempInt=tempInt, trapCompValHighAlarm=trapCompValHighAlarm, tempMin=tempMin, trapHumClrAlarm=trapHumClrAlarm, tempHighInt=tempHighInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, humMin=humMin, historyTable=historyTable, histTemp=histTemp, compValHystInt=compValHystInt, humMax=humMax)
