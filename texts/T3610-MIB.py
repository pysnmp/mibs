...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:54:04 2023
...
Counter64, iso, Counter32, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, enterprises, TimeTicks, Bits, Gauge32, NotificationType, IpAddress, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Counter32", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "enterprises", "TimeTicks", "Bits", "Gauge32", "NotificationType", "IpAddress", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, pysmi_global=pysmi_global, compVal=compVal, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, histHum=histHum, tempLowInt=tempLowInt, trapTest=trapTest, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, historyTable=historyTable, humMax=humMax, tempAlarm=tempAlarm, compValDelayInt=compValDelayInt, compValAlarm=compValAlarm, histCompVal=histCompVal, temp=temp, tempMax=tempMax, values=values, sensorName=sensorName, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, t3610=t3610, messageString=messageString, compValLowInt=compValLowInt, trapCompValHighAlarm=trapCompValHighAlarm, humMin=humMin, serialNumber=serialNumber, tempHystInt=tempHystInt, products=products, trapTempHighAlarm=trapTempHighAlarm, traps=traps, valuesInt=valuesInt, tempInt=tempInt, humHighInt=humHighInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, humLowInt=humLowInt, compValHighInt=compValHighInt, DisplayString=DisplayString, compValMax=compValMax, trapCompValError=trapCompValError, tables=tables, humUnit=humUnit, tempUnit=tempUnit, tempHighInt=tempHighInt, humInt=humInt, histTemp=histTemp, compValAlarmInt=compValAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, humDelayInt=humDelayInt, comet=comet, historyEntry=historyEntry, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapHumClrAlarm=trapHumClrAlarm, settings=settings, trapSOAPErrDNS=trapSOAPErrDNS, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, trapTempError=trapTempError, trapNTPError=trapNTPError, trapHumError=trapHumError, trapEmailErrSome=trapEmailErrSome, trapHumLowAlarm=trapHumLowAlarm, humHystInt=humHystInt, compValUnit=compValUnit, tempMin=tempMin, hum=hum, compValMin=compValMin)
