...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:40:41 2022
...
TimeTicks, enterprises, ModuleIdentity, Integer32, NotificationType, MibIdentifier, IpAddress, Bits, Counter64, ObjectIdentity, NotificationType, Gauge32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "ModuleIdentity", "Integer32", "NotificationType", "MibIdentifier", "IpAddress", "Bits", "Counter64", "ObjectIdentity", "NotificationType", "Gauge32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", compValMin=compValMin, tempHighInt=tempHighInt, humHighInt=humHighInt, tempHystInt=tempHystInt, trapCompValError=trapCompValError, trapHumError=trapHumError, pysmi_global=pysmi_global, humUnit=humUnit, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSocket=trapEmailErrSocket, messageString=messageString, trapTempLowAlarm=trapTempLowAlarm, humLowInt=humLowInt, traps=traps, compValAlarm=compValAlarm, trapNTPError=trapNTPError, compValInt=compValInt, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrDNS=trapEmailErrDNS, values=values, valuesInt=valuesInt, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, trapHumClrAlarm=trapHumClrAlarm, histTemp=histTemp, compValLowInt=compValLowInt, trapTempError=trapTempError, tempUnit=tempUnit, historyTable=historyTable, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, histHum=histHum, t3610=t3610, deviceType=deviceType, hum=hum, compValHystInt=compValHystInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compVal=compVal, trapSOAPErrSocket=trapSOAPErrSocket, humInt=humInt, humMin=humMin, humAlarm=humAlarm, tempMin=tempMin, tempInt=tempInt, compValHighInt=compValHighInt, products=products, settings=settings, compValAlarmInt=compValAlarmInt, humDelayInt=humDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSome=trapEmailErrSome, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, histCompVal=histCompVal, sensorName=sensorName, trapHumLowAlarm=trapHumLowAlarm, compValMax=compValMax, trapTest=trapTest, tables=tables, tempMax=tempMax, compValDelayInt=compValDelayInt, temp=temp, tempAlarm=tempAlarm, DisplayString=DisplayString, compValUnit=compValUnit, humMax=humMax, serialNumber=serialNumber, comet=comet, humHystInt=humHystInt)
