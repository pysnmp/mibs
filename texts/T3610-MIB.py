...
Counter64, Integer32, IpAddress, Bits, ObjectIdentity, enterprises, NotificationType, NotificationType, TimeTicks, Gauge32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "IpAddress", "Bits", "ObjectIdentity", "enterprises", "NotificationType", "NotificationType", "TimeTicks", "Gauge32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, trapHumLowAlarm=trapHumLowAlarm, values=values, trapTempClrAlarm=trapTempClrAlarm, trapTest=trapTest, compValHystInt=compValHystInt, trapTempError=trapTempError, serialNumber=serialNumber, humDelayInt=humDelayInt, trapNTPError=trapNTPError, t3610=t3610, humAlarm=humAlarm, tables=tables, compValAlarm=compValAlarm, humUnit=humUnit, humMin=humMin, humMax=humMax, tempAlarmInt=tempAlarmInt, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, products=products, pysmi_global=pysmi_global, comet=comet, DisplayString=DisplayString, compValHighInt=compValHighInt, hum=hum, tempUnit=tempUnit, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, tempInt=tempInt, humAlarmInt=humAlarmInt, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, compValAlarmInt=compValAlarmInt, trapTempHighAlarm=trapTempHighAlarm, tempMax=tempMax, temp=temp, compValLowInt=compValLowInt, traps=traps, trapCompValError=trapCompValError, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, tempHystInt=tempHystInt, trapSOAPErrDNS=trapSOAPErrDNS, humHighInt=humHighInt, compValInt=compValInt, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, settings=settings, sensorName=sensorName, humInt=humInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, humLowInt=humLowInt, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, valuesInt=valuesInt, tempLowInt=tempLowInt, tempMin=tempMin, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery, deviceType=deviceType, tempHighInt=tempHighInt, histHum=histHum, histTemp=histTemp, compValMax=compValMax, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSocket=trapEmailErrSocket, messageString=messageString)
