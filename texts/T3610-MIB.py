...
iso, IpAddress, Gauge32, Counter64, enterprises, Integer32, ObjectIdentity, Counter32, NotificationType, Bits, TimeTicks, MibIdentifier, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Gauge32", "Counter64", "enterprises", "Integer32", "ObjectIdentity", "Counter32", "NotificationType", "Bits", "TimeTicks", "MibIdentifier", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", pysmi_global=pysmi_global, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarm=compValAlarm, traps=traps, trapSOAPErrFile=trapSOAPErrFile, humInt=humInt, trapTest=trapTest, tempMin=tempMin, tempAlarm=tempAlarm, trapCompValHighAlarm=trapCompValHighAlarm, serialNumber=serialNumber, compValHystInt=compValHystInt, compValMin=compValMin, temp=temp, values=values, compValUnit=compValUnit, trapHumError=trapHumError, tempMax=tempMax, tempHighInt=tempHighInt, compValHighInt=compValHighInt, trapEmailErrSome=trapEmailErrSome, histCompVal=histCompVal, humLowInt=humLowInt, compValLowInt=compValLowInt, compValDelayInt=compValDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, tempDelayInt=tempDelayInt, humDelayInt=humDelayInt, historyEntry=historyEntry, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, t3610=t3610, tempLowInt=tempLowInt, comet=comet, tempAlarmInt=tempAlarmInt, humMax=humMax, deviceType=deviceType, products=products, trapEmailErrDNS=trapEmailErrDNS, humAlarm=humAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, humAlarmInt=humAlarmInt, compValMax=compValMax, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, histHum=histHum, trapEmailErrLogin=trapEmailErrLogin, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, humHighInt=humHighInt, DisplayString=DisplayString, compValInt=compValInt, histTemp=histTemp, tempHystInt=tempHystInt, compVal=compVal, compValAlarmInt=compValAlarmInt, trapHumClrAlarm=trapHumClrAlarm, tempUnit=tempUnit, settings=settings, tempInt=tempInt, historyTable=historyTable, sensorName=sensorName, trapHumHighAlarm=trapHumHighAlarm, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, hum=hum, valuesInt=valuesInt, humMin=humMin, humUnit=humUnit, tables=tables, trapSOAPErrDelivery=trapSOAPErrDelivery)
