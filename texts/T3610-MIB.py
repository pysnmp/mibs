...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:01:41 2022
...
MibIdentifier, iso, Integer32, enterprises, Counter64, Gauge32, TimeTicks, Counter32, ObjectIdentity, Unsigned32, ModuleIdentity, Bits, NotificationType, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Integer32", "enterprises", "Counter64", "Gauge32", "TimeTicks", "Counter32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Bits", "NotificationType", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, historyEntry=historyEntry, trapTempError=trapTempError, comet=comet, compValLowInt=compValLowInt, compValHighInt=compValHighInt, tempAlarm=tempAlarm, trapHumError=trapHumError, settings=settings, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, compValInt=compValInt, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, serialNumber=serialNumber, trapTempClrAlarm=trapTempClrAlarm, traps=traps, trapCompValLowAlarm=trapCompValLowAlarm, humDelayInt=humDelayInt, products=products, t3610=t3610, hum=hum, compValUnit=compValUnit, trapEmailErrSocket=trapEmailErrSocket, tempHystInt=tempHystInt, compVal=compVal, compValDelayInt=compValDelayInt, trapHumLowAlarm=trapHumLowAlarm, tempLowInt=tempLowInt, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, histTemp=histTemp, tempUnit=tempUnit, compValAlarm=compValAlarm, trapTempLowAlarm=trapTempLowAlarm, values=values, tempDelayInt=tempDelayInt, humHystInt=humHystInt, tables=tables, tempMin=tempMin, compValMin=compValMin, tempMax=tempMax, compValMax=compValMax, humMin=humMin, sensorName=sensorName, compValAlarmInt=compValAlarmInt, historyTable=historyTable, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, valuesInt=valuesInt, trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, humInt=humInt, tempHighInt=tempHighInt, humUnit=humUnit, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, histHum=histHum, humMax=humMax, humLowInt=humLowInt, messageString=messageString, histCompVal=histCompVal, humAlarmInt=humAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, trapNTPError=trapNTPError, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, humAlarm=humAlarm)
