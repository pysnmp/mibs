...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:53:40 2021
...
Integer32, NotificationType, IpAddress, NotificationType, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter64, Gauge32, ModuleIdentity, Counter32, ObjectIdentity, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "IpAddress", "NotificationType", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter64", "Gauge32", "ModuleIdentity", "Counter32", "ObjectIdentity", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", compValHystInt=compValHystInt, trapCompValError=trapCompValError, messageString=messageString, trapHumHighAlarm=trapHumHighAlarm, humInt=humInt, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, tempLowInt=tempLowInt, valuesInt=valuesInt, t3610=t3610, settings=settings, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, products=products, trapEmailErrDNS=trapEmailErrDNS, tempAlarm=tempAlarm, humMin=humMin, hum=hum, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, compValHighInt=compValHighInt, histTemp=histTemp, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, compValMin=compValMin, humDelayInt=humDelayInt, values=values, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, trapNTPError=trapNTPError, trapSOAPErrDNS=trapSOAPErrDNS, tempInt=tempInt, humHighInt=humHighInt, DisplayString=DisplayString, serialNumber=serialNumber, deviceType=deviceType, trapTempLowAlarm=trapTempLowAlarm, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt, humAlarm=humAlarm, compValDelayInt=compValDelayInt, historyTable=historyTable, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, tables=tables, compValAlarmInt=compValAlarmInt, trapTest=trapTest, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, compValLowInt=compValLowInt, tempUnit=tempUnit, traps=traps, tempMin=tempMin, sensorName=sensorName, compValInt=compValInt, tempHystInt=tempHystInt, histHum=histHum, trapTempError=trapTempError, compValMax=compValMax, trapTempClrAlarm=trapTempClrAlarm, comet=comet, humMax=humMax, temp=temp, trapCompValLowAlarm=trapCompValLowAlarm, tempHighInt=tempHighInt, tempMax=tempMax, humHystInt=humHystInt, tempDelayInt=tempDelayInt)
