...
# Produced by pysmi-1.1.12 at Thu May 30 02:13:48 2024
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, IpAddress, Unsigned32, MibIdentifier, Integer32, Bits, enterprises, ModuleIdentity, iso, Counter32, NotificationType, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "Integer32", "Bits", "enterprises", "ModuleIdentity", "iso", "Counter32", "NotificationType", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", products=products, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, messageString=messageString, compValDelayInt=compValDelayInt, values=values, trapCompValLowAlarm=trapCompValLowAlarm, humHystInt=humHystInt, compValAlarm=compValAlarm, tempMax=tempMax, tempAlarmInt=tempAlarmInt, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, compValUnit=compValUnit, histTemp=histTemp, historyEntry=historyEntry, trapTempError=trapTempError, compValLowInt=compValLowInt, trapHumHighAlarm=trapHumHighAlarm, humMin=humMin, pysmi_global=pysmi_global, comet=comet, humUnit=humUnit, humHighInt=humHighInt, compValHighInt=compValHighInt, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, trapCompValError=trapCompValError, humMax=humMax, sensorName=sensorName, DisplayString=DisplayString, tempInt=tempInt, humDelayInt=humDelayInt, tempUnit=tempUnit, tables=tables, t3610=t3610, temp=temp, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, serialNumber=serialNumber, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, humLowInt=humLowInt, traps=traps, compValMax=compValMax, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, trapTest=trapTest, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrLogin=trapEmailErrLogin, compValMin=compValMin, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, histCompVal=histCompVal, humAlarm=humAlarm, trapHumLowAlarm=trapHumLowAlarm, tempHystInt=tempHystInt, humAlarmInt=humAlarmInt, historyTable=historyTable, tempHighInt=tempHighInt, hum=hum, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, settings=settings, tempAlarm=tempAlarm, compVal=compVal, tempMin=tempMin, humInt=humInt, trapSOAPErrSocket=trapSOAPErrSocket, compValInt=compValInt, valuesInt=valuesInt)
