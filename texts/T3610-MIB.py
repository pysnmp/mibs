...
# Produced by pysmi-1.1.8 at Wed Jun 29 15:03:37 2022
...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, NotificationType, Integer32, ObjectIdentity, Bits, NotificationType, Counter64, Gauge32, MibIdentifier, iso, enterprises, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "NotificationType", "Integer32", "ObjectIdentity", "Bits", "NotificationType", "Counter64", "Gauge32", "MibIdentifier", "iso", "enterprises", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValError=trapCompValError, historyTable=historyTable, trapCompValHighAlarm=trapCompValHighAlarm, humInt=humInt, traps=traps, trapTempClrAlarm=trapTempClrAlarm, trapHumHighAlarm=trapHumHighAlarm, historyEntry=historyEntry, humHighInt=humHighInt, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, histTemp=histTemp, tempLowInt=tempLowInt, tempAlarm=tempAlarm, serialNumber=serialNumber, trapEmailErrDNS=trapEmailErrDNS, histCompVal=histCompVal, sensorName=sensorName, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, tables=tables, deviceType=deviceType, humLowInt=humLowInt, histHum=histHum, tempMax=tempMax, compValAlarm=compValAlarm, compValMax=compValMax, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, tempUnit=tempUnit, humHystInt=humHystInt, humAlarmInt=humAlarmInt, settings=settings, humAlarm=humAlarm, humMax=humMax, compVal=compVal, compValHighInt=compValHighInt, tempInt=tempInt, tempDelayInt=tempDelayInt, messageString=messageString, trapNTPError=trapNTPError, humDelayInt=humDelayInt, temp=temp, compValLowInt=compValLowInt, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, t3610=t3610, compValInt=compValInt, products=products, compValMin=compValMin, tempMin=tempMin, trapTempError=trapTempError, trapHumLowAlarm=trapHumLowAlarm, values=values, tempAlarmInt=tempAlarmInt, tempHystInt=tempHystInt, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, hum=hum, humMin=humMin, trapEmailErrSome=trapEmailErrSome, pysmi_global=pysmi_global, compValUnit=compValUnit, trapCompValClrAlarm=trapCompValClrAlarm, comet=comet, compValDelayInt=compValDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, tempHighInt=tempHighInt, compValAlarmInt=compValAlarmInt, trapTempHighAlarm=trapTempHighAlarm)
