...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:38:54 2021
...
ObjectIdentity, Bits, NotificationType, Counter64, TimeTicks, Gauge32, MibIdentifier, ModuleIdentity, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, NotificationType, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "NotificationType", "Counter64", "TimeTicks", "Gauge32", "MibIdentifier", "ModuleIdentity", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "NotificationType", "iso", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", compValHighInt=compValHighInt, hum=hum, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, trapHumHighAlarm=trapHumHighAlarm, historyTable=historyTable, tempMin=tempMin, histHum=histHum, tables=tables, products=products, valuesInt=valuesInt, compValAlarm=compValAlarm, tempHighInt=tempHighInt, histCompVal=histCompVal, trapNTPError=trapNTPError, trapTest=trapTest, compVal=compVal, trapCompValError=trapCompValError, compValUnit=compValUnit, settings=settings, traps=traps, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, compValAlarmInt=compValAlarmInt, tempAlarmInt=tempAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, histTemp=histTemp, compValDelayInt=compValDelayInt, comet=comet, sensorName=sensorName, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, serialNumber=serialNumber, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, humMin=humMin, tempMax=tempMax, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, trapEmailErrSocket=trapEmailErrSocket, trapTempError=trapTempError, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, tempUnit=tempUnit, trapCompValHighAlarm=trapCompValHighAlarm, humInt=humInt, compValLowInt=compValLowInt, humAlarm=humAlarm, trapCompValLowAlarm=trapCompValLowAlarm, temp=temp, humHighInt=humHighInt, compValMin=compValMin, trapTempHighAlarm=trapTempHighAlarm, messageString=messageString, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, humUnit=humUnit, humMax=humMax, tempInt=tempInt, values=values, t3610=t3610, humAlarmInt=humAlarmInt, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, compValHystInt=compValHystInt, humLowInt=humLowInt, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, DisplayString=DisplayString, historyEntry=historyEntry, tempLowInt=tempLowInt)
