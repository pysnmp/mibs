...
ModuleIdentity, iso, TimeTicks, NotificationType, MibIdentifier, enterprises, Integer32, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Counter64, ObjectIdentity, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "TimeTicks", "NotificationType", "MibIdentifier", "enterprises", "Integer32", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", serialNumber=serialNumber, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, traps=traps, DisplayString=DisplayString, historyTable=historyTable, tempHystInt=tempHystInt, compVal=compVal, trapCompValClrAlarm=trapCompValClrAlarm, compValHighInt=compValHighInt, comet=comet, messageString=messageString, humMin=humMin, trapEmailErrSome=trapEmailErrSome, compValMax=compValMax, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, humAlarm=humAlarm, humHighInt=humHighInt, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, valuesInt=valuesInt, t3610=t3610, historyEntry=historyEntry, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, sensorName=sensorName, compValHystInt=compValHystInt, histHum=histHum, products=products, trapTempLowAlarm=trapTempLowAlarm, compValDelayInt=compValDelayInt, trapEmailErrSocket=trapEmailErrSocket, values=values, trapTempClrAlarm=trapTempClrAlarm, compValMin=compValMin, hum=hum, temp=temp, compValInt=compValInt, deviceType=deviceType, compValLowInt=compValLowInt, histTemp=histTemp, tempAlarmInt=tempAlarmInt, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, humHystInt=humHystInt, compValUnit=compValUnit, tempUnit=tempUnit, humLowInt=humLowInt, tempMax=tempMax, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, pysmi_global=pysmi_global, trapSOAPErrDNS=trapSOAPErrDNS, humAlarmInt=humAlarmInt, tempMin=tempMin, trapTempError=trapTempError, tables=tables, tempInt=tempInt, compValAlarm=compValAlarm, compValAlarmInt=compValAlarmInt, humUnit=humUnit, humInt=humInt, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, tempHighInt=tempHighInt, tempAlarm=tempAlarm, trapTest=trapTest)
