...
# Produced by pysmi-1.1.3 at Mon Nov 22 20:12:42 2021
...
Counter64, MibIdentifier, IpAddress, TimeTicks, Bits, ObjectIdentity, Counter32, NotificationType, Gauge32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "IpAddress", "TimeTicks", "Bits", "ObjectIdentity", "Counter32", "NotificationType", "Gauge32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, compValHighInt=compValHighInt, t3610=t3610, serialNumber=serialNumber, trapHumHighAlarm=trapHumHighAlarm, compVal=compVal, humAlarmInt=humAlarmInt, tempMax=tempMax, trapEmailErrLogin=trapEmailErrLogin, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, humInt=humInt, comet=comet, humHystInt=humHystInt, trapEmailErrSome=trapEmailErrSome, trapTest=trapTest, compValLowInt=compValLowInt, hum=hum, tempDelayInt=tempDelayInt, humDelayInt=humDelayInt, histCompVal=histCompVal, tempAlarmInt=tempAlarmInt, tempHighInt=tempHighInt, trapTempLowAlarm=trapTempLowAlarm, histHum=histHum, trapTempError=trapTempError, trapHumError=trapHumError, histTemp=histTemp, compValAlarmInt=compValAlarmInt, humMax=humMax, trapCompValLowAlarm=trapCompValLowAlarm, humAlarm=humAlarm, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery, humMin=humMin, trapCompValError=trapCompValError, compValHystInt=compValHystInt, tables=tables, compValAlarm=compValAlarm, trapCompValHighAlarm=trapCompValHighAlarm, messageString=messageString, historyEntry=historyEntry, trapEmailErrDNS=trapEmailErrDNS, tempAlarm=tempAlarm, trapTempClrAlarm=trapTempClrAlarm, humLowInt=humLowInt, trapCompValClrAlarm=trapCompValClrAlarm, compValMin=compValMin, compValUnit=compValUnit, pysmi_global=pysmi_global, settings=settings, tempInt=tempInt, tempMin=tempMin, trapNTPError=trapNTPError, trapSOAPErrDNS=trapSOAPErrDNS, compValDelayInt=compValDelayInt, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, traps=traps, deviceType=deviceType, temp=temp, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, values=values, tempLowInt=tempLowInt, products=products, tempHystInt=tempHystInt, sensorName=sensorName, humHighInt=humHighInt, compValMax=compValMax, compValInt=compValInt, humUnit=humUnit)
