...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:36:21 2022
...
iso, enterprises, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, NotificationType, Unsigned32, ModuleIdentity, ObjectIdentity, Gauge32, MibIdentifier, Integer32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "NotificationType", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "Gauge32", "MibIdentifier", "Integer32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, values=values, humAlarm=humAlarm, compValMax=compValMax, comet=comet, compValHystInt=compValHystInt, compValUnit=compValUnit, histTemp=histTemp, historyEntry=historyEntry, compVal=compVal, humLowInt=humLowInt, humMin=humMin, humMax=humMax, trapHumHighAlarm=trapHumHighAlarm, products=products, pysmi_global=pysmi_global, trapCompValLowAlarm=trapCompValLowAlarm, humUnit=humUnit, compValMin=compValMin, trapHumError=trapHumError, compValInt=compValInt, tempHighInt=tempHighInt, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapNTPError=trapNTPError, trapTempError=trapTempError, trapEmailErrAuth=trapEmailErrAuth, trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, trapTempClrAlarm=trapTempClrAlarm, hum=hum, traps=traps, tables=tables, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, trapEmailErrSome=trapEmailErrSome, tempMax=tempMax, humDelayInt=humDelayInt, messageString=messageString, compValHighInt=compValHighInt, histHum=histHum, tempLowInt=tempLowInt, sensorName=sensorName, humInt=humInt, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, tempDelayInt=tempDelayInt, tempAlarmInt=tempAlarmInt, humHighInt=humHighInt, tempHystInt=tempHystInt, trapCompValError=trapCompValError, trapEmailErrDNS=trapEmailErrDNS, trapTest=trapTest, trapSOAPErrFile=trapSOAPErrFile, humAlarmInt=humAlarmInt, settings=settings, deviceType=deviceType, compValAlarm=compValAlarm, t3610=t3610, tempAlarm=tempAlarm, historyTable=historyTable, humHystInt=humHystInt, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, temp=temp, trapHumLowAlarm=trapHumLowAlarm, tempInt=tempInt)
