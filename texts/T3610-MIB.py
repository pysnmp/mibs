...
# Produced by pysmi-1.1.12 at Mon Jul  1 10:52:11 2024
...
Bits, Gauge32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, MibIdentifier, iso, TimeTicks, NotificationType, IpAddress, Unsigned32, ModuleIdentity, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "MibIdentifier", "iso", "TimeTicks", "NotificationType", "IpAddress", "Unsigned32", "ModuleIdentity", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, compValMin=compValMin, humMax=humMax, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, tempDelayInt=tempDelayInt, trapHumHighAlarm=trapHumHighAlarm, compValAlarmInt=compValAlarmInt, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, products=products, temp=temp, tempMax=tempMax, trapTest=trapTest, tempAlarm=tempAlarm, tempUnit=tempUnit, trapHumClrAlarm=trapHumClrAlarm, historyTable=historyTable, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, deviceType=deviceType, humHystInt=humHystInt, tables=tables, humDelayInt=humDelayInt, messageString=messageString, tempAlarmInt=tempAlarmInt, histCompVal=histCompVal, trapCompValError=trapCompValError, compValUnit=compValUnit, serialNumber=serialNumber, humLowInt=humLowInt, valuesInt=valuesInt, trapEmailErrAuth=trapEmailErrAuth, compValAlarm=compValAlarm, DisplayString=DisplayString, tempHighInt=tempHighInt, compValHighInt=compValHighInt, humAlarm=humAlarm, compValDelayInt=compValDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, values=values, humMin=humMin, trapEmailErrSocket=trapEmailErrSocket, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, compValMax=compValMax, t3610=t3610, pysmi_global=pysmi_global, settings=settings, humAlarmInt=humAlarmInt, humInt=humInt, tempMin=tempMin, tempLowInt=tempLowInt, compValHystInt=compValHystInt, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, traps=traps, tempInt=tempInt, trapSOAPErrDNS=trapSOAPErrDNS, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, trapTempError=trapTempError, compVal=compVal, sensorName=sensorName, tempHystInt=tempHystInt, comet=comet, historyEntry=historyEntry, histHum=histHum)
