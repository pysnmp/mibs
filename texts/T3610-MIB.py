...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:18:25 2023
...
ObjectIdentity, iso, Counter64, NotificationType, Counter32, Unsigned32, IpAddress, Gauge32, MibIdentifier, Integer32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Counter64", "NotificationType", "Counter32", "Unsigned32", "IpAddress", "Gauge32", "MibIdentifier", "Integer32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumError=trapHumError, tables=tables, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, sensorName=sensorName, trapTest=trapTest, messageString=messageString, histTemp=histTemp, tempAlarmInt=tempAlarmInt, tempUnit=tempUnit, humLowInt=humLowInt, compValInt=compValInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSocket=trapEmailErrSocket, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm, humAlarm=humAlarm, compValMin=compValMin, compValUnit=compValUnit, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrLogin=trapEmailErrLogin, t3610=t3610, pysmi_global=pysmi_global, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, values=values, compVal=compVal, tempHighInt=tempHighInt, products=products, humMax=humMax, humHystInt=humHystInt, trapSOAPErrSocket=trapSOAPErrSocket, humDelayInt=humDelayInt, trapTempError=trapTempError, trapSOAPErrFile=trapSOAPErrFile, compValHystInt=compValHystInt, historyTable=historyTable, trapEmailErrSome=trapEmailErrSome, hum=hum, humUnit=humUnit, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, trapHumClrAlarm=trapHumClrAlarm, compValHighInt=compValHighInt, compValMax=compValMax, valuesInt=valuesInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, humAlarmInt=humAlarmInt, compValLowInt=compValLowInt, humHighInt=humHighInt, humInt=humInt, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, compValDelayInt=compValDelayInt, trapHumHighAlarm=trapHumHighAlarm, traps=traps, tempMax=tempMax, DisplayString=DisplayString, histCompVal=histCompVal, tempLowInt=tempLowInt, comet=comet, settings=settings, tempAlarm=tempAlarm, humMin=humMin, historyEntry=historyEntry, tempInt=tempInt, compValAlarm=compValAlarm, temp=temp, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, tempDelayInt=tempDelayInt)
