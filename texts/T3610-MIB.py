...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:11:50 2023
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Counter32, Integer32, Counter64, ModuleIdentity, IpAddress, Bits, Unsigned32, ObjectIdentity, NotificationType, Gauge32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Counter32", "Integer32", "Counter64", "ModuleIdentity", "IpAddress", "Bits", "Unsigned32", "ObjectIdentity", "NotificationType", "Gauge32", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", tempDelayInt=tempDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, tempUnit=tempUnit, trapTempError=trapTempError, trapCompValError=trapCompValError, humMin=humMin, traps=traps, compValInt=compValInt, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, trapHumClrAlarm=trapHumClrAlarm, humInt=humInt, trapSOAPErrDelivery=trapSOAPErrDelivery, sensorName=sensorName, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, humHystInt=humHystInt, tempLowInt=tempLowInt, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, hum=hum, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, humHighInt=humHighInt, tables=tables, humDelayInt=humDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, serialNumber=serialNumber, pysmi_global=pysmi_global, compValMin=compValMin, compValDelayInt=compValDelayInt, humUnit=humUnit, historyTable=historyTable, temp=temp, trapHumLowAlarm=trapHumLowAlarm, humAlarmInt=humAlarmInt, compValUnit=compValUnit, values=values, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, histTemp=histTemp, compValAlarm=compValAlarm, products=products, compValAlarmInt=compValAlarmInt, humMax=humMax, compValHighInt=compValHighInt, DisplayString=DisplayString, valuesInt=valuesInt, tempAlarm=tempAlarm, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValHystInt=compValHystInt, settings=settings, tempMax=tempMax, trapEmailErrLogin=trapEmailErrLogin, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, messageString=messageString, compVal=compVal, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, humAlarm=humAlarm, tempInt=tempInt, histHum=histHum, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, compValLowInt=compValLowInt, trapTempClrAlarm=trapTempClrAlarm, t3610=t3610, comet=comet, histCompVal=histCompVal)
