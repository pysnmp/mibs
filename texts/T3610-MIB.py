...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:38:38 2023
...
TimeTicks, Integer32, Counter32, Bits, IpAddress, Gauge32, MibIdentifier, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, iso, Counter64, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Counter32", "Bits", "IpAddress", "Gauge32", "MibIdentifier", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "iso", "Counter64", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, humLowInt=humLowInt, sensorName=sensorName, serialNumber=serialNumber, compValHystInt=compValHystInt, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarmInt=humAlarmInt, tempMin=tempMin, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, compValUnit=compValUnit, compVal=compVal, humAlarm=humAlarm, trapEmailErrAuth=trapEmailErrAuth, compValLowInt=compValLowInt, messageString=messageString, products=products, humMax=humMax, humInt=humInt, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, temp=temp, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, settings=settings, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, tables=tables, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, comet=comet, histTemp=histTemp, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, trapEmailErrLogin=trapEmailErrLogin, values=values, humHighInt=humHighInt, trapCompValHighAlarm=trapCompValHighAlarm, pysmi_global=pysmi_global, deviceType=deviceType, trapCompValError=trapCompValError, compValMax=compValMax, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, tempLowInt=tempLowInt, compValInt=compValInt, traps=traps, tempAlarmInt=tempAlarmInt, compValAlarm=compValAlarm, compValHighInt=compValHighInt, tempHystInt=tempHystInt, historyTable=historyTable, humDelayInt=humDelayInt, historyEntry=historyEntry, tempMax=tempMax, humMin=humMin, hum=hum, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, trapEmailErrSome=trapEmailErrSome, valuesInt=valuesInt, trapHumError=trapHumError, DisplayString=DisplayString, t3610=t3610, compValMin=compValMin)
