...
# Produced by pysmi-1.1.10 at Thu Nov  9 13:45:01 2023
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, IpAddress, Bits, NotificationType, enterprises, TimeTicks, Integer32, NotificationType, Gauge32, ModuleIdentity, ObjectIdentity, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "IpAddress", "Bits", "NotificationType", "enterprises", "TimeTicks", "Integer32", "NotificationType", "Gauge32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValHighAlarm=trapCompValHighAlarm, humMax=humMax, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, humAlarm=humAlarm, messageString=messageString, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, t3610=t3610, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, comet=comet, DisplayString=DisplayString, tempUnit=tempUnit, humMin=humMin, compValMax=compValMax, compVal=compVal, histCompVal=histCompVal, humLowInt=humLowInt, trapHumHighAlarm=trapHumHighAlarm, compValLowInt=compValLowInt, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, traps=traps, trapTempError=trapTempError, products=products, trapHumLowAlarm=trapHumLowAlarm, tables=tables, tempInt=tempInt, humUnit=humUnit, trapTest=trapTest, tempMax=tempMax, humHystInt=humHystInt, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, hum=hum, trapEmailErrSome=trapEmailErrSome, deviceType=deviceType, humInt=humInt, compValHighInt=compValHighInt, historyTable=historyTable, compValAlarmInt=compValAlarmInt, temp=temp, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, humHighInt=humHighInt, humDelayInt=humDelayInt, trapCompValError=trapCompValError, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, trapHumClrAlarm=trapHumClrAlarm, histHum=histHum, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, compValMin=compValMin, serialNumber=serialNumber, compValInt=compValInt, trapNTPError=trapNTPError, settings=settings, sensorName=sensorName, tempHystInt=tempHystInt, compValHystInt=compValHystInt, histTemp=histTemp, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, values=values)
