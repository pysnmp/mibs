...
# Produced by pysmi-1.1.8 at Wed Sep 13 07:58:03 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Counter32, TimeTicks, Bits, NotificationType, IpAddress, MibIdentifier, ModuleIdentity, Counter64, ObjectIdentity, iso, Integer32, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Counter32", "TimeTicks", "Bits", "NotificationType", "IpAddress", "MibIdentifier", "ModuleIdentity", "Counter64", "ObjectIdentity", "iso", "Integer32", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, tempDelayInt=tempDelayInt, trapTest=trapTest, values=values, humAlarm=humAlarm, humMax=humMax, humMin=humMin, sensorName=sensorName, humInt=humInt, pysmi_global=pysmi_global, trapTempError=trapTempError, compValDelayInt=compValDelayInt, deviceType=deviceType, t3610=t3610, historyTable=historyTable, trapHumError=trapHumError, tempHystInt=tempHystInt, compVal=compVal, products=products, humAlarmInt=humAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, DisplayString=DisplayString, tempAlarm=tempAlarm, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, trapHumLowAlarm=trapHumLowAlarm, historyEntry=historyEntry, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, tempLowInt=tempLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, settings=settings, humLowInt=humLowInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarmInt=tempAlarmInt, traps=traps, compValLowInt=compValLowInt, messageString=messageString, temp=temp, trapTempLowAlarm=trapTempLowAlarm, histHum=histHum, trapCompValError=trapCompValError, valuesInt=valuesInt, compValMin=compValMin, compValAlarmInt=compValAlarmInt, compValInt=compValInt, tables=tables, trapNTPError=trapNTPError, humHystInt=humHystInt, trapTempClrAlarm=trapTempClrAlarm, compValHystInt=compValHystInt, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, comet=comet, tempUnit=tempUnit, humUnit=humUnit, compValUnit=compValUnit, tempInt=tempInt, tempHighInt=tempHighInt, histTemp=histTemp, compValMax=compValMax, humDelayInt=humDelayInt, tempMax=tempMax, serialNumber=serialNumber, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDNS=trapSOAPErrDNS, compValHighInt=compValHighInt, compValAlarm=compValAlarm)
