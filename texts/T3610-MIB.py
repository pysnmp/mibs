...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:50:52 2023
...
IpAddress, ObjectIdentity, MibIdentifier, Counter64, NotificationType, NotificationType, iso, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, enterprises, Unsigned32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter64", "NotificationType", "NotificationType", "iso", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "enterprises", "Unsigned32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", values=values, histHum=histHum, histTemp=histTemp, tempAlarm=tempAlarm, humMin=humMin, trapSOAPErrFile=trapSOAPErrFile, humAlarmInt=humAlarmInt, t3610=t3610, trapTempClrAlarm=trapTempClrAlarm, tempHighInt=tempHighInt, pysmi_global=pysmi_global, trapEmailErrAuth=trapEmailErrAuth, trapHumError=trapHumError, messageString=messageString, trapCompValClrAlarm=trapCompValClrAlarm, traps=traps, tables=tables, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, valuesInt=valuesInt, serialNumber=serialNumber, trapEmailErrDNS=trapEmailErrDNS, trapTest=trapTest, compValHystInt=compValHystInt, trapTempError=trapTempError, humMax=humMax, hum=hum, tempLowInt=tempLowInt, humDelayInt=humDelayInt, comet=comet, temp=temp, tempMax=tempMax, compValInt=compValInt, humLowInt=humLowInt, compValLowInt=compValLowInt, trapEmailErrSome=trapEmailErrSome, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, compValDelayInt=compValDelayInt, deviceType=deviceType, trapHumClrAlarm=trapHumClrAlarm, tempUnit=tempUnit, trapCompValHighAlarm=trapCompValHighAlarm, compValAlarmInt=compValAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, humHighInt=humHighInt, tempMin=tempMin, compValMax=compValMax, compValMin=compValMin, tempAlarmInt=tempAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, humHystInt=humHystInt, tempDelayInt=tempDelayInt, tempInt=tempInt, tempHystInt=tempHystInt, DisplayString=DisplayString, humInt=humInt, products=products, humUnit=humUnit, trapNTPError=trapNTPError, trapCompValError=trapCompValError, trapSOAPErrDelivery=trapSOAPErrDelivery, compVal=compVal, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, trapTempHighAlarm=trapTempHighAlarm, compValUnit=compValUnit, compValAlarm=compValAlarm, humAlarm=humAlarm, sensorName=sensorName, settings=settings)
