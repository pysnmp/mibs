...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:14:25 2021
...
MibIdentifier, TimeTicks, NotificationType, Counter32, iso, IpAddress, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "NotificationType", "Counter32", "iso", "IpAddress", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDNS=trapSOAPErrDNS, trapHumError=trapHumError, products=products, tempAlarmInt=tempAlarmInt, compValHighInt=compValHighInt, trapEmailErrSome=trapEmailErrSome, messageString=messageString, values=values, humAlarmInt=humAlarmInt, compValMax=compValMax, compValUnit=compValUnit, trapEmailErrDNS=trapEmailErrDNS, tempMax=tempMax, compValInt=compValInt, historyEntry=historyEntry, trapCompValLowAlarm=trapCompValLowAlarm, humDelayInt=humDelayInt, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, t3610=t3610, humLowInt=humLowInt, trapSOAPErrFile=trapSOAPErrFile, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, compValLowInt=compValLowInt, trapCompValHighAlarm=trapCompValHighAlarm, compVal=compVal, valuesInt=valuesInt, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, tempInt=tempInt, compValHystInt=compValHystInt, histTemp=histTemp, traps=traps, humMax=humMax, deviceType=deviceType, compValDelayInt=compValDelayInt, comet=comet, hum=hum, pysmi_global=pysmi_global, serialNumber=serialNumber, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, settings=settings, temp=temp, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrLogin=trapEmailErrLogin, humAlarm=humAlarm, compValAlarm=compValAlarm, humUnit=humUnit, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, tempDelayInt=tempDelayInt, trapCompValError=trapCompValError, humInt=humInt, DisplayString=DisplayString, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, trapNTPError=trapNTPError, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, trapTest=trapTest, sensorName=sensorName, humMin=humMin, tempAlarm=tempAlarm, tempMin=tempMin, compValMin=compValMin, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, trapTempClrAlarm=trapTempClrAlarm, tempHystInt=tempHystInt, tables=tables, trapTempError=trapTempError)
