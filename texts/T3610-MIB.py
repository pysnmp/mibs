...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:03:21 2021
...
ObjectIdentity, Integer32, NotificationType, IpAddress, NotificationType, ModuleIdentity, Gauge32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Counter64, enterprises, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "IpAddress", "NotificationType", "ModuleIdentity", "Gauge32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Counter64", "enterprises", "Counter32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", temp=temp, tempUnit=tempUnit, compValAlarm=compValAlarm, values=values, humInt=humInt, histHum=histHum, humMax=humMax, compValMax=compValMax, histTemp=histTemp, trapTempError=trapTempError, compValDelayInt=compValDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, compValInt=compValInt, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, t3610=t3610, pysmi_global=pysmi_global, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, traps=traps, compValLowInt=compValLowInt, trapCompValError=trapCompValError, humAlarmInt=humAlarmInt, tempAlarm=tempAlarm, humUnit=humUnit, tempInt=tempInt, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, hum=hum, trapEmailErrSome=trapEmailErrSome, products=products, deviceType=deviceType, compValHystInt=compValHystInt, humHighInt=humHighInt, valuesInt=valuesInt, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, DisplayString=DisplayString, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, humMin=humMin, tables=tables, sensorName=sensorName, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, compValUnit=compValUnit, humDelayInt=humDelayInt, trapTest=trapTest, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, humAlarm=humAlarm, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValMin=compValMin, trapNTPError=trapNTPError, tempLowInt=tempLowInt, compValAlarmInt=compValAlarmInt, compVal=compVal, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrFile=trapSOAPErrFile, compValHighInt=compValHighInt, settings=settings, tempAlarmInt=tempAlarmInt, tempHystInt=tempHystInt, histCompVal=histCompVal, tempMax=tempMax, trapHumError=trapHumError, tempHighInt=tempHighInt)
