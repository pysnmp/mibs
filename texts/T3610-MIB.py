...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:57:32 2023
...
Integer32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Counter32, ObjectIdentity, IpAddress, Counter64, ModuleIdentity, NotificationType, Bits, Gauge32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Counter32", "ObjectIdentity", "IpAddress", "Counter64", "ModuleIdentity", "NotificationType", "Bits", "Gauge32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", histHum=histHum, tempHystInt=tempHystInt, trapHumError=trapHumError, tempAlarm=tempAlarm, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, humLowInt=humLowInt, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, humAlarm=humAlarm, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, values=values, compValUnit=compValUnit, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, trapTest=trapTest, historyEntry=historyEntry, compValHystInt=compValHystInt, products=products, comet=comet, sensorName=sensorName, compValDelayInt=compValDelayInt, serialNumber=serialNumber, compValAlarmInt=compValAlarmInt, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humHighInt=humHighInt, deviceType=deviceType, compValHighInt=compValHighInt, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, humUnit=humUnit, humMax=humMax, humInt=humInt, trapTempError=trapTempError, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, settings=settings, tempHighInt=tempHighInt, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, trapEmailErrAuth=trapEmailErrAuth, trapHumLowAlarm=trapHumLowAlarm, temp=temp, pysmi_global=pysmi_global, valuesInt=valuesInt, tempAlarmInt=tempAlarmInt, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, compValMax=compValMax, tables=tables, traps=traps, compVal=compVal, humMin=humMin, compValMin=compValMin, t3610=t3610, tempInt=tempInt, humAlarmInt=humAlarmInt, compValLowInt=compValLowInt, tempUnit=tempUnit, messageString=messageString, tempMin=tempMin, tempMax=tempMax, histTemp=histTemp, hum=hum, trapSOAPErrDNS=trapSOAPErrDNS)
