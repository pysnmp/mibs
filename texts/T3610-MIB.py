...
Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, TimeTicks, Gauge32, NotificationType, MibIdentifier, Integer32, Counter32, ObjectIdentity, Counter64, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "TimeTicks", "Gauge32", "NotificationType", "MibIdentifier", "Integer32", "Counter32", "ObjectIdentity", "Counter64", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", pysmi_global=pysmi_global, tempAlarmInt=tempAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, compValMin=compValMin, trapEmailErrSocket=trapEmailErrSocket, compValDelayInt=compValDelayInt, trapTest=trapTest, tempInt=tempInt, humMax=humMax, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, compValMax=compValMax, humHystInt=humHystInt, serialNumber=serialNumber, humAlarmInt=humAlarmInt, sensorName=sensorName, tempMax=tempMax, trapEmailErrAuth=trapEmailErrAuth, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, humHighInt=humHighInt, tempHystInt=tempHystInt, trapHumHighAlarm=trapHumHighAlarm, products=products, tempUnit=tempUnit, histHum=histHum, traps=traps, humAlarm=humAlarm, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, humDelayInt=humDelayInt, compVal=compVal, compValUnit=compValUnit, histTemp=histTemp, tempAlarm=tempAlarm, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, DisplayString=DisplayString, histCompVal=histCompVal, humUnit=humUnit, humInt=humInt, comet=comet, humMin=humMin, tempDelayInt=tempDelayInt, historyEntry=historyEntry, tempHighInt=tempHighInt, tables=tables, trapSOAPErrDNS=trapSOAPErrDNS, trapHumError=trapHumError, hum=hum, compValInt=compValInt, humLowInt=humLowInt, compValHighInt=compValHighInt, messageString=messageString, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, trapTempClrAlarm=trapTempClrAlarm, values=values, compValLowInt=compValLowInt, temp=temp, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, historyTable=historyTable, compValAlarm=compValAlarm, settings=settings, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMin=tempMin, compValAlarmInt=compValAlarmInt, t3610=t3610, tempLowInt=tempLowInt)
