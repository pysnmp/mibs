...
Counter64, TimeTicks, Gauge32, IpAddress, MibIdentifier, NotificationType, ObjectIdentity, Unsigned32, Bits, iso, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Gauge32", "IpAddress", "MibIdentifier", "NotificationType", "ObjectIdentity", "Unsigned32", "Bits", "iso", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValHighInt=compValHighInt, trapEmailErrSome=trapEmailErrSome, tempMin=tempMin, historyEntry=historyEntry, humAlarmInt=humAlarmInt, trapSOAPErrFile=trapSOAPErrFile, humAlarm=humAlarm, messageString=messageString, tempInt=tempInt, trapEmailErrDNS=trapEmailErrDNS, settings=settings, valuesInt=valuesInt, humInt=humInt, trapNTPError=trapNTPError, products=products, traps=traps, compValInt=compValInt, tempHystInt=tempHystInt, deviceType=deviceType, DisplayString=DisplayString, compValAlarmInt=compValAlarmInt, hum=hum, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, compValMax=compValMax, trapTempLowAlarm=trapTempLowAlarm, tables=tables, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, sensorName=sensorName, tempUnit=tempUnit, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrSocket=trapSOAPErrSocket, histHum=histHum, histCompVal=histCompVal, humHystInt=humHystInt, pysmi_global=pysmi_global, compValAlarm=compValAlarm, serialNumber=serialNumber, humDelayInt=humDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, comet=comet, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapTempClrAlarm=trapTempClrAlarm, humMin=humMin, trapTempHighAlarm=trapTempHighAlarm, humLowInt=humLowInt, trapEmailErrAuth=trapEmailErrAuth, compValMin=compValMin, humHighInt=humHighInt, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, humMax=humMax, temp=temp, t3610=t3610, tempLowInt=tempLowInt, tempAlarm=tempAlarm, trapTest=trapTest, humUnit=humUnit, trapHumHighAlarm=trapHumHighAlarm, tempHighInt=tempHighInt, values=values, tempMax=tempMax, compValUnit=compValUnit, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarmInt=tempAlarmInt, compVal=compVal, compValLowInt=compValLowInt, trapCompValError=trapCompValError, histTemp=histTemp, compValHystInt=compValHystInt)
