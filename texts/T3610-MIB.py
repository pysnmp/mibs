...
# Produced by pysmi-1.1.12 at Tue May 28 12:46:22 2024
...
iso, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, NotificationType, ObjectIdentity, NotificationType, Counter64, Integer32, ModuleIdentity, IpAddress, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "NotificationType", "ObjectIdentity", "NotificationType", "Counter64", "Integer32", "ModuleIdentity", "IpAddress", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarm=humAlarm, compValAlarm=compValAlarm, trapCompValError=trapCompValError, trapSOAPErrSocket=trapSOAPErrSocket, compValUnit=compValUnit, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrLogin=trapEmailErrLogin, products=products, humUnit=humUnit, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, t3610=t3610, compValHighInt=compValHighInt, messageString=messageString, tempMin=tempMin, histTemp=histTemp, serialNumber=serialNumber, traps=traps, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, humHystInt=humHystInt, valuesInt=valuesInt, humInt=humInt, tempAlarm=tempAlarm, comet=comet, trapSOAPErrFile=trapSOAPErrFile, tempHighInt=tempHighInt, trapTempError=trapTempError, compValMin=compValMin, settings=settings, compVal=compVal, trapEmailErrAuth=trapEmailErrAuth, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, humHighInt=humHighInt, values=values, humMin=humMin, compValDelayInt=compValDelayInt, historyTable=historyTable, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, tables=tables, histCompVal=histCompVal, tempInt=tempInt, trapEmailErrSome=trapEmailErrSome, hum=hum, pysmi_global=pysmi_global, compValInt=compValInt, trapNTPError=trapNTPError, humMax=humMax, trapTempLowAlarm=trapTempLowAlarm, humAlarmInt=humAlarmInt, tempAlarmInt=tempAlarmInt, DisplayString=DisplayString, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, tempUnit=tempUnit, histHum=histHum, compValMax=compValMax, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, temp=temp, tempDelayInt=tempDelayInt, humDelayInt=humDelayInt, compValHystInt=compValHystInt, tempMax=tempMax, compValAlarmInt=compValAlarmInt, deviceType=deviceType, sensorName=sensorName)
