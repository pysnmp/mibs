...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:53:53 2024
...
enterprises, Gauge32, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, NotificationType, iso, TimeTicks, Counter64, NotificationType, ModuleIdentity, IpAddress, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "NotificationType", "iso", "TimeTicks", "Counter64", "NotificationType", "ModuleIdentity", "IpAddress", "Bits", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", compVal=compVal, compValAlarmInt=compValAlarmInt, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, tempAlarmInt=tempAlarmInt, compValMax=compValMax, tempHystInt=tempHystInt, histCompVal=histCompVal, humAlarm=humAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrAuth=trapEmailErrAuth, humLowInt=humLowInt, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, traps=traps, trapTempError=trapTempError, humHighInt=humHighInt, trapCompValClrAlarm=trapCompValClrAlarm, tempInt=tempInt, tempDelayInt=tempDelayInt, compValLowInt=compValLowInt, histHum=histHum, comet=comet, trapEmailErrSocket=trapEmailErrSocket, compValHystInt=compValHystInt, tempLowInt=tempLowInt, humMax=humMax, trapEmailErrLogin=trapEmailErrLogin, humHystInt=humHystInt, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, tempMin=tempMin, compValInt=compValInt, trapEmailErrSome=trapEmailErrSome, settings=settings, compValUnit=compValUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, trapHumHighAlarm=trapHumHighAlarm, sensorName=sensorName, trapTempLowAlarm=trapTempLowAlarm, humMin=humMin, tempMax=tempMax, tempHighInt=tempHighInt, trapNTPError=trapNTPError, serialNumber=serialNumber, trapTest=trapTest, products=products, historyTable=historyTable, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, historyEntry=historyEntry, values=values, tempUnit=tempUnit, histTemp=histTemp, humInt=humInt, trapCompValLowAlarm=trapCompValLowAlarm, hum=hum, temp=temp, messageString=messageString, compValMin=compValMin, humUnit=humUnit, DisplayString=DisplayString, deviceType=deviceType, humDelayInt=humDelayInt, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, trapCompValError=trapCompValError, pysmi_global=pysmi_global, trapTempClrAlarm=trapTempClrAlarm, tables=tables)
