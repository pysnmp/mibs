...
Integer32, iso, Counter64, Bits, enterprises, MibIdentifier, NotificationType, Gauge32, ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Counter64", "Bits", "enterprises", "MibIdentifier", "NotificationType", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", valuesInt=valuesInt, products=products, humMin=humMin, serialNumber=serialNumber, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, compValMax=compValMax, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, humAlarm=humAlarm, compValAlarm=compValAlarm, tempMax=tempMax, DisplayString=DisplayString, trapTempError=trapTempError, compValUnit=compValUnit, compValMin=compValMin, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, trapCompValError=trapCompValError, trapHumHighAlarm=trapHumHighAlarm, hum=hum, settings=settings, histHum=histHum, compValHystInt=compValHystInt, trapEmailErrSome=trapEmailErrSome, compValAlarmInt=compValAlarmInt, pysmi_global=pysmi_global, humMax=humMax, trapNTPError=trapNTPError, sensorName=sensorName, traps=traps, trapEmailErrSocket=trapEmailErrSocket, tempHighInt=tempHighInt, values=values, compVal=compVal, tempInt=tempInt, tempAlarmInt=tempAlarmInt, comet=comet, tempMin=tempMin, tempLowInt=tempLowInt, compValLowInt=compValLowInt, tables=tables, deviceType=deviceType, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, t3610=t3610, humHighInt=humHighInt, humHystInt=humHystInt, compValHighInt=compValHighInt, trapHumClrAlarm=trapHumClrAlarm, messageString=messageString, humLowInt=humLowInt, trapTempClrAlarm=trapTempClrAlarm, trapTempHighAlarm=trapTempHighAlarm, trapTest=trapTest, humAlarmInt=humAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, tempDelayInt=tempDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, humInt=humInt, trapEmailErrAuth=trapEmailErrAuth, temp=temp, tempUnit=tempUnit, humUnit=humUnit, trapTempLowAlarm=trapTempLowAlarm, tempAlarm=tempAlarm, historyTable=historyTable, trapCompValHighAlarm=trapCompValHighAlarm)
