...
# Produced by pysmi-1.1.8 at Thu Feb  3 21:00:34 2022
...
NotificationType, Counter32, Gauge32, NotificationType, enterprises, TimeTicks, ModuleIdentity, Integer32, Unsigned32, Counter64, MibIdentifier, iso, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Gauge32", "NotificationType", "enterprises", "TimeTicks", "ModuleIdentity", "Integer32", "Unsigned32", "Counter64", "MibIdentifier", "iso", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, tempHystInt=tempHystInt, valuesInt=valuesInt, traps=traps, trapCompValHighAlarm=trapCompValHighAlarm, histTemp=histTemp, trapHumError=trapHumError, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, humMax=humMax, settings=settings, humAlarm=humAlarm, humInt=humInt, humUnit=humUnit, temp=temp, trapEmailErrDNS=trapEmailErrDNS, compValUnit=compValUnit, values=values, hum=hum, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrLogin=trapEmailErrLogin, compValDelayInt=compValDelayInt, humLowInt=humLowInt, tempHighInt=tempHighInt, tempMin=tempMin, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarm=tempAlarm, compValMax=compValMax, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, trapHumHighAlarm=trapHumHighAlarm, tables=tables, serialNumber=serialNumber, trapTempHighAlarm=trapTempHighAlarm, compValHystInt=compValHystInt, sensorName=sensorName, histCompVal=histCompVal, DisplayString=DisplayString, humDelayInt=humDelayInt, historyEntry=historyEntry, trapTempLowAlarm=trapTempLowAlarm, t3610=t3610, trapTest=trapTest, compValAlarmInt=compValAlarmInt, trapTempClrAlarm=trapTempClrAlarm, compVal=compVal, compValMin=compValMin, humHighInt=humHighInt, histHum=histHum, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, trapTempError=trapTempError, tempAlarmInt=tempAlarmInt, tempUnit=tempUnit, products=products, deviceType=deviceType, pysmi_global=pysmi_global, trapHumLowAlarm=trapHumLowAlarm, tempInt=tempInt, compValAlarm=compValAlarm, compValInt=compValInt, trapSOAPErrFile=trapSOAPErrFile, humAlarmInt=humAlarmInt, comet=comet, tempDelayInt=tempDelayInt, historyTable=historyTable, humHystInt=humHystInt, trapNTPError=trapNTPError, tempMax=tempMax, compValHighInt=compValHighInt)
