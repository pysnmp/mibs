...
TimeTicks, ObjectIdentity, NotificationType, NotificationType, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, ModuleIdentity, enterprises, Unsigned32, Bits, IpAddress, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "NotificationType", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "ModuleIdentity", "enterprises", "Unsigned32", "Bits", "IpAddress", "Counter64", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, serialNumber=serialNumber, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, compValAlarmInt=compValAlarmInt, products=products, hum=hum, trapEmailErrSocket=trapEmailErrSocket, comet=comet, humMax=humMax, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempError=trapTempError, DisplayString=DisplayString, trapTempLowAlarm=trapTempLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, humUnit=humUnit, tempHighInt=tempHighInt, tempMax=tempMax, trapSOAPErrFile=trapSOAPErrFile, temp=temp, tempUnit=tempUnit, tempHystInt=tempHystInt, compValLowInt=compValLowInt, humDelayInt=humDelayInt, trapCompValError=trapCompValError, trapNTPError=trapNTPError, histCompVal=histCompVal, histTemp=histTemp, tempAlarm=tempAlarm, deviceType=deviceType, trapTempClrAlarm=trapTempClrAlarm, compValHystInt=compValHystInt, values=values, compValMin=compValMin, humHighInt=humHighInt, trapEmailErrSome=trapEmailErrSome, trapTest=trapTest, trapSOAPErrSocket=trapSOAPErrSocket, compValHighInt=compValHighInt, tempLowInt=tempLowInt, humLowInt=humLowInt, historyEntry=historyEntry, traps=traps, compValInt=compValInt, compValDelayInt=compValDelayInt, trapHumError=trapHumError, humMin=humMin, compValUnit=compValUnit, trapTempHighAlarm=trapTempHighAlarm, histHum=histHum, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, compValAlarm=compValAlarm, t3610=t3610, humAlarmInt=humAlarmInt, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, humAlarm=humAlarm, tempMin=tempMin, tempInt=tempInt, historyTable=historyTable, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, messageString=messageString, tables=tables, compVal=compVal, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings)
