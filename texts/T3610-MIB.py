...
# Produced by pysmi-1.1.10 at Wed Nov 15 02:35:18 2023
...
TimeTicks, Gauge32, NotificationType, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, enterprises, IpAddress, ObjectIdentity, MibIdentifier, Bits, Counter64, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "NotificationType", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "enterprises", "IpAddress", "ObjectIdentity", "MibIdentifier", "Bits", "Counter64", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, serialNumber=serialNumber, trapCompValClrAlarm=trapCompValClrAlarm, humMax=humMax, compValHighInt=compValHighInt, humHighInt=humHighInt, trapSOAPErrFile=trapSOAPErrFile, humAlarmInt=humAlarmInt, tempMax=tempMax, humHystInt=humHystInt, compValMin=compValMin, hum=hum, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, trapSOAPErrDNS=trapSOAPErrDNS, trapTest=trapTest, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, t3610=t3610, DisplayString=DisplayString, compValMax=compValMax, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, histHum=histHum, products=products, trapEmailErrAuth=trapEmailErrAuth, humDelayInt=humDelayInt, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, trapNTPError=trapNTPError, traps=traps, compValDelayInt=compValDelayInt, histTemp=histTemp, deviceType=deviceType, trapTempHighAlarm=trapTempHighAlarm, trapHumLowAlarm=trapHumLowAlarm, values=values, historyEntry=historyEntry, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, historyTable=historyTable, humMin=humMin, humLowInt=humLowInt, tempDelayInt=tempDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, messageString=messageString, tempLowInt=tempLowInt, compValHystInt=compValHystInt, settings=settings, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, temp=temp, trapHumError=trapHumError, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, tables=tables, pysmi_global=pysmi_global, histCompVal=histCompVal, compValLowInt=compValLowInt, humAlarm=humAlarm, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, humUnit=humUnit, tempInt=tempInt, compValAlarm=compValAlarm, comet=comet, compValUnit=compValUnit, tempAlarm=tempAlarm, tempHighInt=tempHighInt, tempAlarmInt=tempAlarmInt, compValInt=compValInt, trapHumClrAlarm=trapHumClrAlarm)
