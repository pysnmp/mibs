...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:58:03 2021
...
enterprises, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, IpAddress, Unsigned32, NotificationType, Gauge32, Bits, Counter32, iso, ModuleIdentity, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "IpAddress", "Unsigned32", "NotificationType", "Gauge32", "Bits", "Counter32", "iso", "ModuleIdentity", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", compValHighInt=compValHighInt, compValInt=compValInt, values=values, compValUnit=compValUnit, historyEntry=historyEntry, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, humUnit=humUnit, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, tempHystInt=tempHystInt, trapTempClrAlarm=trapTempClrAlarm, tempDelayInt=tempDelayInt, trapHumClrAlarm=trapHumClrAlarm, t3610=t3610, valuesInt=valuesInt, tempLowInt=tempLowInt, trapTest=trapTest, tempAlarmInt=tempAlarmInt, tempMax=tempMax, humHighInt=humHighInt, comet=comet, humAlarm=humAlarm, compValAlarm=compValAlarm, trapNTPError=trapNTPError, settings=settings, trapCompValError=trapCompValError, compValMin=compValMin, tempAlarm=tempAlarm, deviceType=deviceType, historyTable=historyTable, humLowInt=humLowInt, histCompVal=histCompVal, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, trapSOAPErrDelivery=trapSOAPErrDelivery, histTemp=histTemp, tempUnit=tempUnit, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, trapSOAPErrDNS=trapSOAPErrDNS, serialNumber=serialNumber, trapHumLowAlarm=trapHumLowAlarm, compVal=compVal, trapSOAPErrFile=trapSOAPErrFile, products=products, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrLogin=trapEmailErrLogin, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, traps=traps, hum=hum, tables=tables, tempMin=tempMin, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, pysmi_global=pysmi_global, tempHighInt=tempHighInt, trapTempError=trapTempError, DisplayString=DisplayString, humMax=humMax, humDelayInt=humDelayInt, histHum=histHum, trapTempHighAlarm=trapTempHighAlarm, humMin=humMin, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, compValAlarmInt=compValAlarmInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, tempInt=tempInt, trapEmailErrSocket=trapEmailErrSocket, temp=temp, compValHystInt=compValHystInt, messageString=messageString)
