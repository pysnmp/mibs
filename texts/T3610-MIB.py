...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:32:54 2023
...
IpAddress, iso, Integer32, NotificationType, Counter32, Gauge32, Counter64, TimeTicks, ModuleIdentity, enterprises, Bits, MibIdentifier, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Integer32", "NotificationType", "Counter32", "Gauge32", "Counter64", "TimeTicks", "ModuleIdentity", "enterprises", "Bits", "MibIdentifier", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, trapHumError=trapHumError, temp=temp, values=values, humUnit=humUnit, tempInt=tempInt, tempAlarmInt=tempAlarmInt, tables=tables, humHystInt=humHystInt, pysmi_global=pysmi_global, valuesInt=valuesInt, serialNumber=serialNumber, trapCompValError=trapCompValError, compValInt=compValInt, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrFile=trapSOAPErrFile, trapCompValLowAlarm=trapCompValLowAlarm, humAlarmInt=humAlarmInt, histTemp=histTemp, deviceType=deviceType, messageString=messageString, trapEmailErrSome=trapEmailErrSome, DisplayString=DisplayString, tempLowInt=tempLowInt, historyEntry=historyEntry, humMin=humMin, tempHystInt=tempHystInt, compValMax=compValMax, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarm=tempAlarm, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrLogin=trapEmailErrLogin, trapTempLowAlarm=trapTempLowAlarm, sensorName=sensorName, trapTempError=trapTempError, compValMin=compValMin, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, hum=hum, histCompVal=histCompVal, humDelayInt=humDelayInt, humMax=humMax, compVal=compVal, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, t3610=t3610, trapEmailErrSocket=trapEmailErrSocket, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, tempUnit=tempUnit, tempMax=tempMax, tempMin=tempMin, compValHighInt=compValHighInt, trapTest=trapTest, products=products, traps=traps, tempHighInt=tempHighInt, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, settings=settings, humAlarm=humAlarm, humLowInt=humLowInt, compValAlarm=compValAlarm, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, compValUnit=compValUnit, humInt=humInt, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, comet=comet)
