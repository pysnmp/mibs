...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:20:56 2021
...
NotificationType, ModuleIdentity, MibIdentifier, Gauge32, iso, enterprises, Counter64, Counter32, Bits, Unsigned32, TimeTicks, NotificationType, IpAddress, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibIdentifier", "Gauge32", "iso", "enterprises", "Counter64", "Counter32", "Bits", "Unsigned32", "TimeTicks", "NotificationType", "IpAddress", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", tempMin=tempMin, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, compValHighInt=compValHighInt, trapTest=trapTest, compValInt=compValInt, humHystInt=humHystInt, tempHighInt=tempHighInt, trapHumLowAlarm=trapHumLowAlarm, temp=temp, trapEmailErrSocket=trapEmailErrSocket, humInt=humInt, humMin=humMin, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, tempAlarm=tempAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, humMax=humMax, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, tables=tables, compValMin=compValMin, sensorName=sensorName, histTemp=histTemp, messageString=messageString, t3610=t3610, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrSome=trapEmailErrSome, trapNTPError=trapNTPError, compValLowInt=compValLowInt, trapHumError=trapHumError, humUnit=humUnit, compValHystInt=compValHystInt, tempInt=tempInt, compValAlarmInt=compValAlarmInt, traps=traps, trapEmailErrAuth=trapEmailErrAuth, pysmi_global=pysmi_global, humHighInt=humHighInt, serialNumber=serialNumber, historyEntry=historyEntry, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, compValUnit=compValUnit, compVal=compVal, trapCompValError=trapCompValError, trapTempError=trapTempError, settings=settings, tempMax=tempMax, tempLowInt=tempLowInt, tempDelayInt=tempDelayInt, comet=comet, hum=hum, compValDelayInt=compValDelayInt, histCompVal=histCompVal, values=values, products=products, tempUnit=tempUnit, tempHystInt=tempHystInt, humAlarm=humAlarm, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, deviceType=deviceType, humLowInt=humLowInt, humAlarmInt=humAlarmInt)
