...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:31:25 2023
...
enterprises, Counter64, Unsigned32, Counter32, Integer32, Bits, MibIdentifier, Gauge32, TimeTicks, IpAddress, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Unsigned32", "Counter32", "Integer32", "Bits", "MibIdentifier", "Gauge32", "TimeTicks", "IpAddress", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarmInt=humAlarmInt, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, tempHighInt=tempHighInt, values=values, compVal=compVal, trapEmailErrSome=trapEmailErrSome, humMin=humMin, humUnit=humUnit, sensorName=sensorName, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, tempHystInt=tempHystInt, tempInt=tempInt, trapTempClrAlarm=trapTempClrAlarm, humInt=humInt, trapHumError=trapHumError, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarmInt=tempAlarmInt, traps=traps, trapCompValHighAlarm=trapCompValHighAlarm, humHystInt=humHystInt, historyTable=historyTable, tempAlarm=tempAlarm, compValInt=compValInt, trapCompValLowAlarm=trapCompValLowAlarm, trapTest=trapTest, humMax=humMax, settings=settings, tables=tables, trapEmailErrAuth=trapEmailErrAuth, temp=temp, trapHumClrAlarm=trapHumClrAlarm, compValMax=compValMax, products=products, trapSOAPErrFile=trapSOAPErrFile, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, trapNTPError=trapNTPError, compValHystInt=compValHystInt, trapCompValError=trapCompValError, hum=hum, tempLowInt=tempLowInt, histTemp=histTemp, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempError=trapTempError, tempDelayInt=tempDelayInt, serialNumber=serialNumber, comet=comet, t3610=t3610, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, humAlarm=humAlarm, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, historyEntry=historyEntry, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, compValMin=compValMin, tempMin=tempMin, compValHighInt=compValHighInt, messageString=messageString, histHum=histHum, trapEmailErrLogin=trapEmailErrLogin, humHighInt=humHighInt, compValUnit=compValUnit, tempMax=tempMax, tempUnit=tempUnit, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, deviceType=deviceType, histCompVal=histCompVal, pysmi_global=pysmi_global, DisplayString=DisplayString)
