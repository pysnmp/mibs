...
# Produced by pysmi-1.1.0 at Mon Nov 15 20:05:32 2021
...
Counter32, MibIdentifier, Integer32, enterprises, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, TimeTicks, ObjectIdentity, NotificationType, Bits, Counter64, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Integer32", "enterprises", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "TimeTicks", "ObjectIdentity", "NotificationType", "Bits", "Counter64", "iso", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempHighAlarm=trapTempHighAlarm, hum=hum, histTemp=histTemp, humHighInt=humHighInt, tempMin=tempMin, trapHumHighAlarm=trapHumHighAlarm, products=products, compValAlarm=compValAlarm, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrLogin=trapEmailErrLogin, compVal=compVal, pysmi_global=pysmi_global, trapCompValError=trapCompValError, tempUnit=tempUnit, compValMin=compValMin, trapSOAPErrDNS=trapSOAPErrDNS, sensorName=sensorName, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, traps=traps, tempLowInt=tempLowInt, humMin=humMin, compValHystInt=compValHystInt, trapEmailErrSome=trapEmailErrSome, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, compValUnit=compValUnit, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrSocket=trapEmailErrSocket, DisplayString=DisplayString, compValMax=compValMax, deviceType=deviceType, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, compValDelayInt=compValDelayInt, trapHumLowAlarm=trapHumLowAlarm, tempAlarm=tempAlarm, comet=comet, humInt=humInt, histCompVal=histCompVal, humUnit=humUnit, messageString=messageString, t3610=t3610, trapHumClrAlarm=trapHumClrAlarm, tempInt=tempInt, values=values, compValLowInt=compValLowInt, historyTable=historyTable, trapHumError=trapHumError, serialNumber=serialNumber, tempMax=tempMax, humDelayInt=humDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, settings=settings, humMax=humMax, compValHighInt=compValHighInt, histHum=histHum, valuesInt=valuesInt, trapSOAPErrSocket=trapSOAPErrSocket, trapNTPError=trapNTPError, trapTest=trapTest, tempHighInt=tempHighInt, trapTempLowAlarm=trapTempLowAlarm, tempAlarmInt=tempAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, tempDelayInt=tempDelayInt, compValInt=compValInt, temp=temp, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarm=humAlarm, humHystInt=humHystInt, tempHystInt=tempHystInt, tables=tables, humAlarmInt=humAlarmInt)
