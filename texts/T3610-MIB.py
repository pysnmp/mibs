...
# Produced by pysmi-1.1.3 at Wed Dec  1 15:53:10 2021
...
MibIdentifier, Bits, Integer32, TimeTicks, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Gauge32, iso, IpAddress, enterprises, ObjectIdentity, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Integer32", "TimeTicks", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Gauge32", "iso", "IpAddress", "enterprises", "ObjectIdentity", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", comet=comet, tempHighInt=tempHighInt, humInt=humInt, trapSOAPErrFile=trapSOAPErrFile, messageString=messageString, historyTable=historyTable, products=products, tempAlarm=tempAlarm, humAlarmInt=humAlarmInt, trapCompValError=trapCompValError, compValHystInt=compValHystInt, tempMax=tempMax, t3610=t3610, humMax=humMax, humHighInt=humHighInt, humDelayInt=humDelayInt, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, trapTest=trapTest, tempLowInt=tempLowInt, trapHumLowAlarm=trapHumLowAlarm, trapTempError=trapTempError, tables=tables, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, compValAlarm=compValAlarm, trapEmailErrDNS=trapEmailErrDNS, tempAlarmInt=tempAlarmInt, trapTempClrAlarm=trapTempClrAlarm, serialNumber=serialNumber, humLowInt=humLowInt, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, settings=settings, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, compValMax=compValMax, temp=temp, values=values, pysmi_global=pysmi_global, compValMin=compValMin, sensorName=sensorName, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, trapHumError=trapHumError, compVal=compVal, compValHighInt=compValHighInt, tempInt=tempInt, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarm=humAlarm, historyEntry=historyEntry, DisplayString=DisplayString, humHystInt=humHystInt, histTemp=histTemp, traps=traps, histCompVal=histCompVal, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, histHum=histHum, humUnit=humUnit, valuesInt=valuesInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, compValInt=compValInt, hum=hum, compValUnit=compValUnit)
