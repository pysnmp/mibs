...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:57:07 2023
...
NotificationType, iso, Counter64, ObjectIdentity, NotificationType, IpAddress, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, TimeTicks, Integer32, Gauge32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter64", "ObjectIdentity", "NotificationType", "IpAddress", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "TimeTicks", "Integer32", "Gauge32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", humDelayInt=humDelayInt, settings=settings, humLowInt=humLowInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, comet=comet, tempDelayInt=tempDelayInt, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, sensorName=sensorName, compValLowInt=compValLowInt, pysmi_global=pysmi_global, trapTempHighAlarm=trapTempHighAlarm, histCompVal=histCompVal, compValHighInt=compValHighInt, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, t3610=t3610, trapSOAPErrDNS=trapSOAPErrDNS, humMax=humMax, compValMax=compValMax, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarmInt=tempAlarmInt, humHighInt=humHighInt, humUnit=humUnit, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, tempUnit=tempUnit, values=values, tempAlarm=tempAlarm, trapCompValError=trapCompValError, compValMin=compValMin, hum=hum, tempMin=tempMin, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrFile=trapSOAPErrFile, tempInt=tempInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumLowAlarm=trapHumLowAlarm, trapTempError=trapTempError, DisplayString=DisplayString, trapTest=trapTest, histHum=histHum, deviceType=deviceType, serialNumber=serialNumber, compValInt=compValInt, compVal=compVal, compValAlarm=compValAlarm, messageString=messageString, tables=tables, humHystInt=humHystInt, trapHumClrAlarm=trapHumClrAlarm, temp=temp, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSocket=trapEmailErrSocket, valuesInt=valuesInt, products=products, tempLowInt=tempLowInt, trapHumError=trapHumError, humAlarmInt=humAlarmInt, trapNTPError=trapNTPError, tempHystInt=tempHystInt, trapCompValClrAlarm=trapCompValClrAlarm, humInt=humInt, humMin=humMin, humAlarm=humAlarm, compValUnit=compValUnit, traps=traps)
