...
Integer32, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Bits, NotificationType, ModuleIdentity, iso, TimeTicks, Counter32, Gauge32, NotificationType, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Bits", "NotificationType", "ModuleIdentity", "iso", "TimeTicks", "Counter32", "Gauge32", "NotificationType", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", valuesInt=valuesInt, products=products, humAlarmInt=humAlarmInt, tables=tables, trapNTPError=trapNTPError, compValMax=compValMax, compValMin=compValMin, tempMax=tempMax, deviceType=deviceType, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrAuth=trapEmailErrAuth, compValHystInt=compValHystInt, humDelayInt=humDelayInt, trapCompValError=trapCompValError, t3610=t3610, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, serialNumber=serialNumber, histTemp=histTemp, hum=hum, sensorName=sensorName, humAlarm=humAlarm, trapTempLowAlarm=trapTempLowAlarm, compValUnit=compValUnit, humUnit=humUnit, trapTempHighAlarm=trapTempHighAlarm, compValLowInt=compValLowInt, humMin=humMin, humMax=humMax, histHum=histHum, tempUnit=tempUnit, compVal=compVal, pysmi_global=pysmi_global, trapHumClrAlarm=trapHumClrAlarm, humInt=humInt, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSome=trapEmailErrSome, tempAlarm=tempAlarm, trapTempClrAlarm=trapTempClrAlarm, histCompVal=histCompVal, historyTable=historyTable, messageString=messageString, tempLowInt=tempLowInt, traps=traps, trapTest=trapTest, compValHighInt=compValHighInt, trapEmailErrDNS=trapEmailErrDNS, tempHighInt=tempHighInt, settings=settings, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, trapCompValClrAlarm=trapCompValClrAlarm, values=values, comet=comet, trapSOAPErrSocket=trapSOAPErrSocket, tempInt=tempInt, compValInt=compValInt, temp=temp, trapHumError=trapHumError, tempDelayInt=tempDelayInt, humHighInt=humHighInt, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, trapSOAPErrFile=trapSOAPErrFile, historyEntry=historyEntry, trapHumLowAlarm=trapHumLowAlarm)
