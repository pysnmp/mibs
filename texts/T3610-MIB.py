...
Counter64, ModuleIdentity, ObjectIdentity, NotificationType, Gauge32, Unsigned32, Integer32, Counter32, NotificationType, iso, Bits, MibIdentifier, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Gauge32", "Unsigned32", "Integer32", "Counter32", "NotificationType", "iso", "Bits", "MibIdentifier", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, trapTempClrAlarm=trapTempClrAlarm, tempHystInt=tempHystInt, humLowInt=humLowInt, t3610=t3610, tempUnit=tempUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHystInt=compValHystInt, products=products, trapHumClrAlarm=trapHumClrAlarm, messageString=messageString, trapSOAPErrDNS=trapSOAPErrDNS, compValAlarm=compValAlarm, humMax=humMax, trapTempError=trapTempError, humAlarm=humAlarm, tables=tables, sensorName=sensorName, tempLowInt=tempLowInt, serialNumber=serialNumber, humDelayInt=humDelayInt, pysmi_global=pysmi_global, histCompVal=histCompVal, tempAlarm=tempAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, comet=comet, tempAlarmInt=tempAlarmInt, compValDelayInt=compValDelayInt, compValHighInt=compValHighInt, compValMin=compValMin, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, tempMax=tempMax, tempInt=tempInt, historyTable=historyTable, deviceType=deviceType, trapTest=trapTest, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, temp=temp, humMin=humMin, compValInt=compValInt, DisplayString=DisplayString, tempMin=tempMin, settings=settings, tempHighInt=tempHighInt, historyEntry=historyEntry, humAlarmInt=humAlarmInt, humHystInt=humHystInt, histHum=histHum, trapSOAPErrFile=trapSOAPErrFile, compValLowInt=compValLowInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSome=trapEmailErrSome, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapTempLowAlarm=trapTempLowAlarm, hum=hum, compVal=compVal, tempDelayInt=tempDelayInt, humInt=humInt, humHighInt=humHighInt, trapCompValHighAlarm=trapCompValHighAlarm, histTemp=histTemp, trapCompValLowAlarm=trapCompValLowAlarm, humUnit=humUnit, trapCompValError=trapCompValError, values=values, traps=traps, compValMax=compValMax, valuesInt=valuesInt, compValUnit=compValUnit)
