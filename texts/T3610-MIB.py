...
Counter64, ModuleIdentity, MibIdentifier, iso, TimeTicks, ObjectIdentity, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, IpAddress, NotificationType, Counter32, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "MibIdentifier", "iso", "TimeTicks", "ObjectIdentity", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "IpAddress", "NotificationType", "Counter32", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarm=compValAlarm, compValUnit=compValUnit, trapHumClrAlarm=trapHumClrAlarm, histTemp=histTemp, compVal=compVal, compValHystInt=compValHystInt, tempLowInt=tempLowInt, compValHighInt=compValHighInt, compValMin=compValMin, tempMin=tempMin, sensorName=sensorName, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, serialNumber=serialNumber, humAlarmInt=humAlarmInt, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, tempMax=tempMax, messageString=messageString, trapHumError=trapHumError, historyTable=historyTable, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, valuesInt=valuesInt, tempDelayInt=tempDelayInt, settings=settings, DisplayString=DisplayString, tempHystInt=tempHystInt, comet=comet, trapEmailErrSocket=trapEmailErrSocket, trapTest=trapTest, tempHighInt=tempHighInt, temp=temp, tempAlarm=tempAlarm, humInt=humInt, humHighInt=humHighInt, humDelayInt=humDelayInt, humUnit=humUnit, tempAlarmInt=tempAlarmInt, pysmi_global=pysmi_global, humLowInt=humLowInt, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, trapTempError=trapTempError, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, traps=traps, compValInt=compValInt, trapTempHighAlarm=trapTempHighAlarm, trapCompValError=trapCompValError, compValMax=compValMax, humMax=humMax, compValLowInt=compValLowInt, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, hum=hum, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, products=products, trapEmailErrDNS=trapEmailErrDNS, historyEntry=historyEntry, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, histHum=histHum, tempUnit=tempUnit, values=values, t3610=t3610, tables=tables, humMin=humMin, trapSOAPErrDNS=trapSOAPErrDNS)
