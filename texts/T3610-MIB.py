...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:30:45 2024
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ObjectIdentity, MibIdentifier, Gauge32, Bits, NotificationType, enterprises, ModuleIdentity, Unsigned32, Integer32, Counter32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ObjectIdentity", "MibIdentifier", "Gauge32", "Bits", "NotificationType", "enterprises", "ModuleIdentity", "Unsigned32", "Integer32", "Counter32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", compValMin=compValMin, trapEmailErrLogin=trapEmailErrLogin, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, tempHystInt=tempHystInt, humMax=humMax, t3610=t3610, tempLowInt=tempLowInt, valuesInt=valuesInt, histTemp=histTemp, trapNTPError=trapNTPError, pysmi_global=pysmi_global, tempAlarm=tempAlarm, humUnit=humUnit, products=products, hum=hum, sensorName=sensorName, compValHystInt=compValHystInt, values=values, messageString=messageString, historyTable=historyTable, humAlarm=humAlarm, histCompVal=histCompVal, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, tempHighInt=tempHighInt, trapTempError=trapTempError, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrFile=trapSOAPErrFile, compValDelayInt=compValDelayInt, humLowInt=humLowInt, tempInt=tempInt, DisplayString=DisplayString, compValAlarm=compValAlarm, tempUnit=tempUnit, trapTempClrAlarm=trapTempClrAlarm, temp=temp, compVal=compVal, historyEntry=historyEntry, humAlarmInt=humAlarmInt, tempMax=tempMax, trapTempHighAlarm=trapTempHighAlarm, traps=traps, trapHumError=trapHumError, deviceType=deviceType, trapEmailErrAuth=trapEmailErrAuth, compValMax=compValMax, tempDelayInt=tempDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapTest=trapTest, compValLowInt=compValLowInt, humMin=humMin, trapCompValError=trapCompValError, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, humHighInt=humHighInt, compValInt=compValInt, settings=settings, trapEmailErrSome=trapEmailErrSome, tempMin=tempMin, tables=tables, compValUnit=compValUnit, humInt=humInt, tempAlarmInt=tempAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, trapEmailErrDNS=trapEmailErrDNS, serialNumber=serialNumber, compValHighInt=compValHighInt, trapEmailErrSocket=trapEmailErrSocket, humDelayInt=humDelayInt)
