...
# Produced by pysmi-1.1.12 at Wed May 29 06:42:43 2024
...
enterprises, NotificationType, Counter32, Counter64, Bits, NotificationType, TimeTicks, iso, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Unsigned32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter32", "Counter64", "Bits", "NotificationType", "TimeTicks", "iso", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, trapTest=trapTest, products=products, trapTempLowAlarm=trapTempLowAlarm, tempMax=tempMax, hum=hum, compValAlarmInt=compValAlarmInt, settings=settings, compValMin=compValMin, sensorName=sensorName, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, trapHumError=trapHumError, tempAlarm=tempAlarm, tempDelayInt=tempDelayInt, humInt=humInt, historyEntry=historyEntry, temp=temp, deviceType=deviceType, trapNTPError=trapNTPError, humAlarm=humAlarm, t3610=t3610, traps=traps, tables=tables, tempHystInt=tempHystInt, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, tempHighInt=tempHighInt, trapEmailErrAuth=trapEmailErrAuth, pysmi_global=pysmi_global, humMax=humMax, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, humHystInt=humHystInt, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, trapEmailErrSome=trapEmailErrSome, humLowInt=humLowInt, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, histHum=histHum, trapCompValError=trapCompValError, compValDelayInt=compValDelayInt, compValAlarm=compValAlarm, compValHighInt=compValHighInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, comet=comet, humHighInt=humHighInt, humAlarmInt=humAlarmInt, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, DisplayString=DisplayString, compValLowInt=compValLowInt, tempUnit=tempUnit, compVal=compVal, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, humDelayInt=humDelayInt, values=values, humUnit=humUnit, trapTempHighAlarm=trapTempHighAlarm, tempAlarmInt=tempAlarmInt, serialNumber=serialNumber, compValMax=compValMax, humMin=humMin, valuesInt=valuesInt)
