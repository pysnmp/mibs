...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:42:33 2024
...
enterprises, Gauge32, Unsigned32, iso, ObjectIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, TimeTicks, Integer32, ModuleIdentity, MibIdentifier, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Unsigned32", "iso", "ObjectIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "TimeTicks", "Integer32", "ModuleIdentity", "MibIdentifier", "Counter64", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, trapSOAPErrSocket=trapSOAPErrSocket, t3610=t3610, histHum=histHum, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, tempMin=tempMin, products=products, trapTest=trapTest, tempAlarm=tempAlarm, humMax=humMax, tempHighInt=tempHighInt, humInt=humInt, trapTempHighAlarm=trapTempHighAlarm, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValError=trapCompValError, trapHumClrAlarm=trapHumClrAlarm, compValMax=compValMax, humUnit=humUnit, tempHystInt=tempHystInt, compValLowInt=compValLowInt, temp=temp, messageString=messageString, deviceType=deviceType, compValUnit=compValUnit, pysmi_global=pysmi_global, humMin=humMin, histTemp=histTemp, trapHumHighAlarm=trapHumHighAlarm, historyTable=historyTable, humAlarmInt=humAlarmInt, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, compValAlarm=compValAlarm, compValMin=compValMin, trapHumLowAlarm=trapHumLowAlarm, comet=comet, tempMax=tempMax, tempDelayInt=tempDelayInt, tables=tables, trapTempError=trapTempError, valuesInt=valuesInt, tempInt=tempInt, hum=hum, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, compVal=compVal, compValDelayInt=compValDelayInt, compValHighInt=compValHighInt, trapTempClrAlarm=trapTempClrAlarm, compValAlarmInt=compValAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, humHighInt=humHighInt, trapHumError=trapHumError, trapCompValClrAlarm=trapCompValClrAlarm, humAlarm=humAlarm, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, settings=settings, serialNumber=serialNumber, humDelayInt=humDelayInt, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt, values=values, trapSOAPErrFile=trapSOAPErrFile, compValHystInt=compValHystInt, trapCompValHighAlarm=trapCompValHighAlarm, humLowInt=humLowInt, historyEntry=historyEntry, trapCompValLowAlarm=trapCompValLowAlarm, traps=traps)
