...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:03:48 2024
...
Integer32, Gauge32, iso, NotificationType, MibIdentifier, ModuleIdentity, IpAddress, Counter64, enterprises, ObjectIdentity, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "iso", "NotificationType", "MibIdentifier", "ModuleIdentity", "IpAddress", "Counter64", "enterprises", "ObjectIdentity", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, tempHighInt=tempHighInt, sensorName=sensorName, humAlarm=humAlarm, humHystInt=humHystInt, trapNTPError=trapNTPError, deviceType=deviceType, historyEntry=historyEntry, trapTempError=trapTempError, settings=settings, histHum=histHum, humHighInt=humHighInt, traps=traps, trapCompValLowAlarm=trapCompValLowAlarm, compValMax=compValMax, temp=temp, serialNumber=serialNumber, DisplayString=DisplayString, tempInt=tempInt, tempMax=tempMax, messageString=messageString, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, tempAlarmInt=tempAlarmInt, values=values, comet=comet, compValMin=compValMin, compValInt=compValInt, humMin=humMin, trapTest=trapTest, t3610=t3610, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, humUnit=humUnit, trapCompValHighAlarm=trapCompValHighAlarm, humMax=humMax, tempLowInt=tempLowInt, humInt=humInt, trapTempLowAlarm=trapTempLowAlarm, tables=tables, compValAlarm=compValAlarm, tempUnit=tempUnit, compValLowInt=compValLowInt, tempHystInt=tempHystInt, compValHystInt=compValHystInt, tempMin=tempMin, histTemp=histTemp, products=products, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrFile=trapSOAPErrFile, trapCompValError=trapCompValError, pysmi_global=pysmi_global, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, trapEmailErrAuth=trapEmailErrAuth, valuesInt=valuesInt, hum=hum, trapTempClrAlarm=trapTempClrAlarm, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, historyTable=historyTable, histCompVal=histCompVal)
