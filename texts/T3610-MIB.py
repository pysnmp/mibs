...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:00:50 2022
...
IpAddress, Gauge32, ObjectIdentity, TimeTicks, Counter64, NotificationType, Unsigned32, ModuleIdentity, iso, Integer32, Counter32, NotificationType, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "ObjectIdentity", "TimeTicks", "Counter64", "NotificationType", "Unsigned32", "ModuleIdentity", "iso", "Integer32", "Counter32", "NotificationType", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", tempHystInt=tempHystInt, compValHystInt=compValHystInt, humHighInt=humHighInt, trapSOAPErrDNS=trapSOAPErrDNS, compValMax=compValMax, trapHumLowAlarm=trapHumLowAlarm, compValMin=compValMin, compValLowInt=compValLowInt, compValHighInt=compValHighInt, compValAlarm=compValAlarm, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, histTemp=histTemp, trapHumError=trapHumError, pysmi_global=pysmi_global, humMin=humMin, compValInt=compValInt, sensorName=sensorName, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, trapEmailErrDNS=trapEmailErrDNS, tempDelayInt=tempDelayInt, tempLowInt=tempLowInt, humHystInt=humHystInt, humLowInt=humLowInt, deviceType=deviceType, values=values, trapNTPError=trapNTPError, tempHighInt=tempHighInt, trapHumClrAlarm=trapHumClrAlarm, trapHumHighAlarm=trapHumHighAlarm, trapTest=trapTest, tempMin=tempMin, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, serialNumber=serialNumber, t3610=t3610, trapSOAPErrDelivery=trapSOAPErrDelivery, tempUnit=tempUnit, compValUnit=compValUnit, tempMax=tempMax, products=products, trapTempLowAlarm=trapTempLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrLogin=trapEmailErrLogin, trapCompValError=trapCompValError, tempAlarm=tempAlarm, trapTempError=trapTempError, settings=settings, traps=traps, humUnit=humUnit, tables=tables, trapEmailErrSome=trapEmailErrSome, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, compVal=compVal, trapTempHighAlarm=trapTempHighAlarm, compValDelayInt=compValDelayInt, DisplayString=DisplayString, comet=comet, trapEmailErrAuth=trapEmailErrAuth, humAlarmInt=humAlarmInt, tempInt=tempInt, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, valuesInt=valuesInt, trapSOAPErrFile=trapSOAPErrFile, historyTable=historyTable, humInt=humInt, temp=temp, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, hum=hum, humMax=humMax)
