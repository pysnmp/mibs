...
# Produced by pysmi-1.1.10 at Fri Oct 27 06:58:06 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, IpAddress, iso, NotificationType, Counter64, Bits, TimeTicks, MibIdentifier, Counter32, Unsigned32, ObjectIdentity, Integer32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "IpAddress", "iso", "NotificationType", "Counter64", "Bits", "TimeTicks", "MibIdentifier", "Counter32", "Unsigned32", "ObjectIdentity", "Integer32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, t3610=t3610, compValDelayInt=compValDelayInt, humMax=humMax, compValMin=compValMin, serialNumber=serialNumber, tempDelayInt=tempDelayInt, trapEmailErrSocket=trapEmailErrSocket, tempHighInt=tempHighInt, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, temp=temp, products=products, trapTempError=trapTempError, trapCompValError=trapCompValError, humUnit=humUnit, compValAlarmInt=compValAlarmInt, compValUnit=compValUnit, sensorName=sensorName, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, traps=traps, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, messageString=messageString, humAlarm=humAlarm, tempMax=tempMax, tempAlarmInt=tempAlarmInt, humMin=humMin, humHighInt=humHighInt, historyEntry=historyEntry, tempUnit=tempUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHighInt=compValHighInt, tempHystInt=tempHystInt, hum=hum, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, compValHystInt=compValHystInt, histHum=histHum, settings=settings, tables=tables, comet=comet, compValLowInt=compValLowInt, trapTest=trapTest, DisplayString=DisplayString, tempInt=tempInt, tempMin=tempMin, compVal=compVal, compValMax=compValMax, trapCompValClrAlarm=trapCompValClrAlarm, humLowInt=humLowInt, deviceType=deviceType, histTemp=histTemp, compValAlarm=compValAlarm, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, humHystInt=humHystInt, humDelayInt=humDelayInt, histCompVal=histCompVal, trapHumError=trapHumError, trapSOAPErrFile=trapSOAPErrFile, compValInt=compValInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrAuth=trapEmailErrAuth, humInt=humInt, values=values, tempLowInt=tempLowInt, tempAlarm=tempAlarm)
