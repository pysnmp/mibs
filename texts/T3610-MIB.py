...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Gauge32, TimeTicks, ObjectIdentity, Integer32, MibIdentifier, ModuleIdentity, Counter64, Bits, iso, enterprises, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Gauge32", "TimeTicks", "ObjectIdentity", "Integer32", "MibIdentifier", "ModuleIdentity", "Counter64", "Bits", "iso", "enterprises", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempError=trapTempError, compValInt=compValInt, trapEmailErrSocket=trapEmailErrSocket, trapHumClrAlarm=trapHumClrAlarm, compValMax=compValMax, historyEntry=historyEntry, settings=settings, trapNTPError=trapNTPError, tempMin=tempMin, humUnit=humUnit, humAlarmInt=humAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, tempMax=tempMax, compValUnit=compValUnit, humHighInt=humHighInt, compValDelayInt=compValDelayInt, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, humAlarm=humAlarm, histCompVal=histCompVal, compValLowInt=compValLowInt, trapSOAPErrFile=trapSOAPErrFile, trapCompValError=trapCompValError, t3610=t3610, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, tempUnit=tempUnit, trapTest=trapTest, sensorName=sensorName, histHum=histHum, tables=tables, pysmi_global=pysmi_global, tempAlarm=tempAlarm, historyTable=historyTable, values=values, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempHighInt=tempHighInt, tempLowInt=tempLowInt, serialNumber=serialNumber, temp=temp, tempInt=tempInt, tempHystInt=tempHystInt, compValMin=compValMin, trapHumError=trapHumError, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, trapTempClrAlarm=trapTempClrAlarm, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, messageString=messageString, DisplayString=DisplayString, trapEmailErrSome=trapEmailErrSome, trapTempHighAlarm=trapTempHighAlarm, tempDelayInt=tempDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compVal=compVal, trapEmailErrAuth=trapEmailErrAuth, humMin=humMin, comet=comet, humInt=humInt, products=products, compValAlarm=compValAlarm, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, humMax=humMax, hum=hum, traps=traps, humDelayInt=humDelayInt, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, humLowInt=humLowInt)
