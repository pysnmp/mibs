...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:28:09 2022
...
Integer32, Gauge32, Unsigned32, NotificationType, IpAddress, TimeTicks, Counter64, iso, NotificationType, Bits, ObjectIdentity, ModuleIdentity, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Unsigned32", "NotificationType", "IpAddress", "TimeTicks", "Counter64", "iso", "NotificationType", "Bits", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, tempUnit=tempUnit, DisplayString=DisplayString, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, compValHighInt=compValHighInt, humDelayInt=humDelayInt, tempHystInt=tempHystInt, humHystInt=humHystInt, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, products=products, sensorName=sensorName, humAlarmInt=humAlarmInt, tempAlarm=tempAlarm, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, compValDelayInt=compValDelayInt, tempInt=tempInt, compValInt=compValInt, humInt=humInt, compVal=compVal, compValMax=compValMax, trapCompValHighAlarm=trapCompValHighAlarm, humAlarm=humAlarm, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, deviceType=deviceType, values=values, compValAlarmInt=compValAlarmInt, historyTable=historyTable, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, t3610=t3610, hum=hum, valuesInt=valuesInt, pysmi_global=pysmi_global, serialNumber=serialNumber, trapHumError=trapHumError, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, temp=temp, tempDelayInt=tempDelayInt, histHum=histHum, trapNTPError=trapNTPError, trapTempError=trapTempError, trapEmailErrLogin=trapEmailErrLogin, messageString=messageString, compValLowInt=compValLowInt, tempHighInt=tempHighInt, tempMin=tempMin, trapEmailErrSome=trapEmailErrSome, compValMin=compValMin, trapTempClrAlarm=trapTempClrAlarm, humMin=humMin, historyEntry=historyEntry, compValUnit=compValUnit, trapTest=trapTest, comet=comet, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, traps=traps, tables=tables, humUnit=humUnit, humMax=humMax, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, compValHystInt=compValHystInt, tempMax=tempMax, tempAlarmInt=tempAlarmInt)
