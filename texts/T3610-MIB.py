...
Integer32, Unsigned32, ModuleIdentity, IpAddress, ObjectIdentity, TimeTicks, NotificationType, Counter64, Bits, MibIdentifier, Counter32, enterprises, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "TimeTicks", "NotificationType", "Counter64", "Bits", "MibIdentifier", "Counter32", "enterprises", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, tempUnit=tempUnit, compValHystInt=compValHystInt, comet=comet, tempInt=tempInt, trapSOAPErrFile=trapSOAPErrFile, humMax=humMax, compVal=compVal, tables=tables, pysmi_global=pysmi_global, compValInt=compValInt, trapHumError=trapHumError, trapCompValLowAlarm=trapCompValLowAlarm, settings=settings, trapNTPError=trapNTPError, hum=hum, messageString=messageString, histCompVal=histCompVal, compValMax=compValMax, compValHighInt=compValHighInt, trapCompValHighAlarm=trapCompValHighAlarm, humAlarm=humAlarm, compValLowInt=compValLowInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, trapTempLowAlarm=trapTempLowAlarm, tempDelayInt=tempDelayInt, values=values, t3610=t3610, trapTempHighAlarm=trapTempHighAlarm, tempLowInt=tempLowInt, tempMin=tempMin, humLowInt=humLowInt, tempHighInt=tempHighInt, histTemp=histTemp, humHystInt=humHystInt, trapTest=trapTest, humUnit=humUnit, serialNumber=serialNumber, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, traps=traps, compValAlarm=compValAlarm, compValUnit=compValUnit, valuesInt=valuesInt, humAlarmInt=humAlarmInt, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, temp=temp, trapEmailErrDNS=trapEmailErrDNS, historyEntry=historyEntry, tempMax=tempMax, deviceType=deviceType, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, trapCompValError=trapCompValError, humInt=humInt, trapTempError=trapTempError, products=products, compValAlarmInt=compValAlarmInt, trapEmailErrLogin=trapEmailErrLogin, historyTable=historyTable, trapEmailErrSome=trapEmailErrSome, tempAlarmInt=tempAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, humDelayInt=humDelayInt, compValMin=compValMin, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, tempAlarm=tempAlarm)
