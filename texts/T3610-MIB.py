...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, MibIdentifier, NotificationType, NotificationType, IpAddress, enterprises, Gauge32, Counter32, Bits, TimeTicks, ModuleIdentity, Counter64, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "NotificationType", "IpAddress", "enterprises", "Gauge32", "Counter32", "Bits", "TimeTicks", "ModuleIdentity", "Counter64", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, compValDelayInt=compValDelayInt, humHystInt=humHystInt, trapEmailErrDNS=trapEmailErrDNS, humLowInt=humLowInt, hum=hum, trapHumClrAlarm=trapHumClrAlarm, tempAlarm=tempAlarm, compValUnit=compValUnit, histCompVal=histCompVal, trapCompValClrAlarm=trapCompValClrAlarm, serialNumber=serialNumber, tempHystInt=tempHystInt, DisplayString=DisplayString, compValMax=compValMax, trapTempError=trapTempError, traps=traps, trapSOAPErrDelivery=trapSOAPErrDelivery, compVal=compVal, compValInt=compValInt, historyEntry=historyEntry, compValLowInt=compValLowInt, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, compValHystInt=compValHystInt, trapCompValError=trapCompValError, humMax=humMax, trapSOAPErrSocket=trapSOAPErrSocket, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, historyTable=historyTable, tables=tables, humAlarm=humAlarm, tempMin=tempMin, histHum=histHum, trapEmailErrLogin=trapEmailErrLogin, humUnit=humUnit, tempMax=tempMax, tempAlarmInt=tempAlarmInt, trapTempHighAlarm=trapTempHighAlarm, products=products, compValAlarmInt=compValAlarmInt, t3610=t3610, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, comet=comet, deviceType=deviceType, tempInt=tempInt, values=values, trapSOAPErrDNS=trapSOAPErrDNS, compValHighInt=compValHighInt, tempUnit=tempUnit, temp=temp, compValMin=compValMin, histTemp=histTemp, trapHumError=trapHumError, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, humAlarmInt=humAlarmInt, humHighInt=humHighInt, trapEmailErrSome=trapEmailErrSome, humInt=humInt, valuesInt=valuesInt, trapTempLowAlarm=trapTempLowAlarm, tempDelayInt=tempDelayInt, humDelayInt=humDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, sensorName=sensorName, settings=settings, humMin=humMin, pysmi_global=pysmi_global)
