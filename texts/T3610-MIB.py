...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:14:36 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, MibIdentifier, iso, IpAddress, Integer32, Unsigned32, Counter64, NotificationType, ModuleIdentity, Counter32, enterprises, NotificationType, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "MibIdentifier", "iso", "IpAddress", "Integer32", "Unsigned32", "Counter64", "NotificationType", "ModuleIdentity", "Counter32", "enterprises", "NotificationType", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, tempUnit=tempUnit, tempHighInt=tempHighInt, tempInt=tempInt, compValInt=compValInt, humLowInt=humLowInt, tempDelayInt=tempDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, humHystInt=humHystInt, hum=hum, histCompVal=histCompVal, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, compValAlarmInt=compValAlarmInt, trapEmailErrSome=trapEmailErrSome, trapHumHighAlarm=trapHumHighAlarm, sensorName=sensorName, deviceType=deviceType, trapCompValLowAlarm=trapCompValLowAlarm, compValMax=compValMax, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, trapCompValHighAlarm=trapCompValHighAlarm, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, humMax=humMax, tables=tables, compValMin=compValMin, humHighInt=humHighInt, humDelayInt=humDelayInt, messageString=messageString, temp=temp, compVal=compVal, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, trapEmailErrSocket=trapEmailErrSocket, tempMin=tempMin, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, humAlarm=humAlarm, tempMax=tempMax, t3610=t3610, historyEntry=historyEntry, compValHystInt=compValHystInt, traps=traps, settings=settings, products=products, values=values, humInt=humInt, trapTempError=trapTempError, compValDelayInt=compValDelayInt, humUnit=humUnit, histTemp=histTemp, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, DisplayString=DisplayString, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, compValHighInt=compValHighInt, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, trapTest=trapTest, serialNumber=serialNumber, tempLowInt=tempLowInt, comet=comet, humAlarmInt=humAlarmInt, pysmi_global=pysmi_global)
