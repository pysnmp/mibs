...
TimeTicks, ModuleIdentity, enterprises, Integer32, NotificationType, iso, NotificationType, Gauge32, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, ObjectIdentity, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "enterprises", "Integer32", "NotificationType", "iso", "NotificationType", "Gauge32", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "ObjectIdentity", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", tempLowInt=tempLowInt, hum=hum, temp=temp, trapNTPError=trapNTPError, humUnit=humUnit, traps=traps, humMax=humMax, compValLowInt=compValLowInt, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, tempMin=tempMin, tempHystInt=tempHystInt, trapHumError=trapHumError, humHighInt=humHighInt, settings=settings, trapSOAPErrFile=trapSOAPErrFile, compVal=compVal, histCompVal=histCompVal, trapCompValLowAlarm=trapCompValLowAlarm, products=products, compValInt=compValInt, humAlarm=humAlarm, trapCompValHighAlarm=trapCompValHighAlarm, compValMax=compValMax, compValMin=compValMin, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, t3610=t3610, humAlarmInt=humAlarmInt, tempMax=tempMax, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrSome=trapEmailErrSome, messageString=messageString, historyTable=historyTable, pysmi_global=pysmi_global, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrAuth=trapEmailErrAuth, compValHighInt=compValHighInt, trapCompValError=trapCompValError, tables=tables, compValAlarm=compValAlarm, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, valuesInt=valuesInt, historyEntry=historyEntry, compValUnit=compValUnit, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, tempInt=tempInt, trapCompValClrAlarm=trapCompValClrAlarm, humMin=humMin, serialNumber=serialNumber, tempDelayInt=tempDelayInt, humLowInt=humLowInt, tempAlarm=tempAlarm, comet=comet, deviceType=deviceType, compValAlarmInt=compValAlarmInt, trapEmailErrSocket=trapEmailErrSocket, tempAlarmInt=tempAlarmInt, trapHumLowAlarm=trapHumLowAlarm, values=values, compValHystInt=compValHystInt, humDelayInt=humDelayInt, trapTempClrAlarm=trapTempClrAlarm, trapTempHighAlarm=trapTempHighAlarm, sensorName=sensorName, tempUnit=tempUnit, humInt=humInt)
