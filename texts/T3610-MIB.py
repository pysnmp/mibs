...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:33:39 2021
...
Gauge32, ModuleIdentity, MibIdentifier, Counter32, IpAddress, Unsigned32, ObjectIdentity, TimeTicks, enterprises, Integer32, NotificationType, Counter64, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "MibIdentifier", "Counter32", "IpAddress", "Unsigned32", "ObjectIdentity", "TimeTicks", "enterprises", "Integer32", "NotificationType", "Counter64", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, tempMax=tempMax, trapCompValHighAlarm=trapCompValHighAlarm, hum=hum, trapHumError=trapHumError, trapSOAPErrDNS=trapSOAPErrDNS, compValLowInt=compValLowInt, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, settings=settings, tempUnit=tempUnit, values=values, compValAlarmInt=compValAlarmInt, tempDelayInt=tempDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarmInt=tempAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, humInt=humInt, humLowInt=humLowInt, tempInt=tempInt, compValHighInt=compValHighInt, serialNumber=serialNumber, historyTable=historyTable, humMin=humMin, histHum=histHum, humMax=humMax, historyEntry=historyEntry, trapTempLowAlarm=trapTempLowAlarm, DisplayString=DisplayString, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, t3610=t3610, tempAlarm=tempAlarm, humAlarm=humAlarm, histTemp=histTemp, trapTest=trapTest, products=products, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, messageString=messageString, comet=comet, compValMax=compValMax, humDelayInt=humDelayInt, traps=traps, trapHumLowAlarm=trapHumLowAlarm, tempHighInt=tempHighInt, temp=temp, humUnit=humUnit, sensorName=sensorName, compValAlarm=compValAlarm, trapNTPError=trapNTPError, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMin=tempMin, deviceType=deviceType, compValMin=compValMin, compVal=compVal, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, trapTempError=trapTempError, tables=tables, compValUnit=compValUnit, compValHystInt=compValHystInt)
