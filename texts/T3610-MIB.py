...
Counter32, MibIdentifier, Integer32, Bits, iso, Gauge32, Unsigned32, Counter64, NotificationType, TimeTicks, ModuleIdentity, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Integer32", "Bits", "iso", "Gauge32", "Unsigned32", "Counter64", "NotificationType", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, tempDelayInt=tempDelayInt, humAlarmInt=humAlarmInt, compValAlarmInt=compValAlarmInt, compValHystInt=compValHystInt, historyTable=historyTable, trapTempLowAlarm=trapTempLowAlarm, traps=traps, trapCompValError=trapCompValError, settings=settings, compVal=compVal, trapTempError=trapTempError, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, compValHighInt=compValHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, deviceType=deviceType, messageString=messageString, DisplayString=DisplayString, humAlarm=humAlarm, t3610=t3610, historyEntry=historyEntry, tables=tables, humDelayInt=humDelayInt, compValInt=compValInt, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, humHighInt=humHighInt, valuesInt=valuesInt, trapHumClrAlarm=trapHumClrAlarm, trapHumLowAlarm=trapHumLowAlarm, histTemp=histTemp, humInt=humInt, trapEmailErrDNS=trapEmailErrDNS, humLowInt=humLowInt, tempMin=tempMin, humMax=humMax, temp=temp, sensorName=sensorName, tempInt=tempInt, humHystInt=humHystInt, values=values, trapHumError=trapHumError, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, hum=hum, tempMax=tempMax, compValMax=compValMax, trapNTPError=trapNTPError, compValAlarm=compValAlarm, humMin=humMin, trapCompValLowAlarm=trapCompValLowAlarm, trapTest=trapTest, products=products, tempHystInt=tempHystInt, trapHumHighAlarm=trapHumHighAlarm, trapTempHighAlarm=trapTempHighAlarm, compValLowInt=compValLowInt, tempAlarm=tempAlarm, serialNumber=serialNumber, trapCompValClrAlarm=trapCompValClrAlarm, comet=comet, humUnit=humUnit, pysmi_global=pysmi_global)
