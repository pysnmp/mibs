...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:59:54 2024
...
Bits, ModuleIdentity, ObjectIdentity, TimeTicks, Counter32, iso, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Unsigned32, IpAddress, NotificationType, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Counter32", "iso", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Unsigned32", "IpAddress", "NotificationType", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumError=trapHumError, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, tempDelayInt=tempDelayInt, histHum=histHum, messageString=messageString, tempInt=tempInt, trapCompValClrAlarm=trapCompValClrAlarm, humInt=humInt, deviceType=deviceType, valuesInt=valuesInt, compValMax=compValMax, histTemp=histTemp, compValUnit=compValUnit, humAlarmInt=humAlarmInt, compValInt=compValInt, trapEmailErrDNS=trapEmailErrDNS, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrLogin=trapEmailErrLogin, compValHighInt=compValHighInt, trapEmailErrSome=trapEmailErrSome, trapTempClrAlarm=trapTempClrAlarm, tables=tables, temp=temp, histCompVal=histCompVal, trapTest=trapTest, trapNTPError=trapNTPError, trapCompValHighAlarm=trapCompValHighAlarm, t3610=t3610, tempUnit=tempUnit, tempAlarm=tempAlarm, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, hum=hum, humUnit=humUnit, tempMin=tempMin, tempAlarmInt=tempAlarmInt, humHystInt=humHystInt, trapSOAPErrSocket=trapSOAPErrSocket, pysmi_global=pysmi_global, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, compValHystInt=compValHystInt, humMax=humMax, tempMax=tempMax, trapTempError=trapTempError, trapHumClrAlarm=trapHumClrAlarm, trapHumLowAlarm=trapHumLowAlarm, compValAlarm=compValAlarm, sensorName=sensorName, trapCompValLowAlarm=trapCompValLowAlarm, humLowInt=humLowInt, humAlarm=humAlarm, values=values, comet=comet, DisplayString=DisplayString, products=products, humHighInt=humHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, historyEntry=historyEntry, compVal=compVal, serialNumber=serialNumber, tempLowInt=tempLowInt, traps=traps, trapCompValError=trapCompValError, trapTempLowAlarm=trapTempLowAlarm, trapTempHighAlarm=trapTempHighAlarm, settings=settings)
