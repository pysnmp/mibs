...
# Produced by pysmi-1.1.12 at Wed May 29 10:53:21 2024
...
Bits, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Counter32, Gauge32, NotificationType, ModuleIdentity, Counter64, ObjectIdentity, TimeTicks, Integer32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Counter32", "Gauge32", "NotificationType", "ModuleIdentity", "Counter64", "ObjectIdentity", "TimeTicks", "Integer32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, tempMax=tempMax, temp=temp, tempDelayInt=tempDelayInt, compVal=compVal, serialNumber=serialNumber, deviceType=deviceType, tempHystInt=tempHystInt, compValDelayInt=compValDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, trapEmailErrLogin=trapEmailErrLogin, trapHumClrAlarm=trapHumClrAlarm, tempUnit=tempUnit, historyEntry=historyEntry, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapTest=trapTest, trapCompValLowAlarm=trapCompValLowAlarm, messageString=messageString, humInt=humInt, settings=settings, compValLowInt=compValLowInt, tempLowInt=tempLowInt, compValInt=compValInt, compValHighInt=compValHighInt, trapNTPError=trapNTPError, humUnit=humUnit, humHighInt=humHighInt, trapHumError=trapHumError, compValHystInt=compValHystInt, histCompVal=histCompVal, hum=hum, pysmi_global=pysmi_global, comet=comet, humMin=humMin, valuesInt=valuesInt, tempAlarm=tempAlarm, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, compValMin=compValMin, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, values=values, tempInt=tempInt, products=products, trapEmailErrSome=trapEmailErrSome, traps=traps, humAlarm=humAlarm, humLowInt=humLowInt, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, t3610=t3610, sensorName=sensorName, histHum=histHum, humMax=humMax, compValAlarmInt=compValAlarmInt, trapTempError=trapTempError, tempHighInt=tempHighInt, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, humDelayInt=humDelayInt, compValMax=compValMax, trapEmailErrAuth=trapEmailErrAuth, historyTable=historyTable, compValUnit=compValUnit, trapSOAPErrFile=trapSOAPErrFile)
