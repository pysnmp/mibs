...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:32:00 2022
...
Counter32, Counter64, ObjectIdentity, IpAddress, iso, Unsigned32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, TimeTicks, enterprises, ModuleIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "ObjectIdentity", "IpAddress", "iso", "Unsigned32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "TimeTicks", "enterprises", "ModuleIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, tempMin=tempMin, historyEntry=historyEntry, histHum=histHum, values=values, trapEmailErrSome=trapEmailErrSome, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, sensorName=sensorName, tempMax=tempMax, tempInt=tempInt, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, comet=comet, compValMin=compValMin, compValMax=compValMax, humDelayInt=humDelayInt, settings=settings, humAlarmInt=humAlarmInt, tables=tables, valuesInt=valuesInt, compVal=compVal, humInt=humInt, hum=hum, tempUnit=tempUnit, compValInt=compValInt, temp=temp, tempAlarmInt=tempAlarmInt, compValAlarm=compValAlarm, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, compValDelayInt=compValDelayInt, compValHystInt=compValHystInt, historyTable=historyTable, messageString=messageString, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, humHystInt=humHystInt, compValUnit=compValUnit, t3610=t3610, products=products, humUnit=humUnit, trapTempError=trapTempError, trapHumLowAlarm=trapHumLowAlarm, trapNTPError=trapNTPError, humLowInt=humLowInt, trapEmailErrSocket=trapEmailErrSocket, compValLowInt=compValLowInt, trapCompValClrAlarm=trapCompValClrAlarm, tempHystInt=tempHystInt, humMax=humMax, humMin=humMin, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, humAlarm=humAlarm, tempLowInt=tempLowInt, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, serialNumber=serialNumber, trapCompValLowAlarm=trapCompValLowAlarm, humHighInt=humHighInt, pysmi_global=pysmi_global, compValHighInt=compValHighInt, histTemp=histTemp, trapHumError=trapHumError, traps=traps, trapTest=trapTest)
