...
mibBuilder.exportSymbols("T3610-MIB", compVal=compVal, compValHighInt=compValHighInt, trapTempHighAlarm=trapTempHighAlarm, humHighInt=humHighInt, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, compValUnit=compValUnit, trapTempClrAlarm=trapTempClrAlarm, tempMin=tempMin, sensorName=sensorName, serialNumber=serialNumber, deviceType=deviceType, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, humHystInt=humHystInt, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, trapTempLowAlarm=trapTempLowAlarm, humInt=humInt, tempAlarmInt=tempAlarmInt, trapHumClrAlarm=trapHumClrAlarm, tempMax=tempMax, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValLowAlarm=trapCompValLowAlarm, compValInt=compValInt, humDelayInt=humDelayInt, histTemp=histTemp, tables=tables, hum=hum, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, humMin=humMin, messageString=messageString, compValLowInt=compValLowInt, tempAlarm=tempAlarm, humLowInt=humLowInt, humAlarm=humAlarm, trapNTPError=trapNTPError, tempDelayInt=tempDelayInt, historyTable=historyTable, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, tempUnit=tempUnit, pysmi_global=pysmi_global, trapEmailErrAuth=trapEmailErrAuth, comet=comet, compValMax=compValMax, humAlarmInt=humAlarmInt, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, values=values, tempHighInt=tempHighInt, products=products, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, t3610=t3610, traps=traps, compValHystInt=compValHystInt, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, tempLowInt=tempLowInt, compValMin=compValMin, trapHumError=trapHumError, temp=temp, humMax=humMax, settings=settings, humUnit=humUnit, trapTempError=trapTempError)
