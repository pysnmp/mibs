...
# Produced by pysmi-1.1.3 at Sun Nov 28 15:13:19 2021
...
ModuleIdentity, ObjectIdentity, enterprises, iso, Counter32, NotificationType, Unsigned32, TimeTicks, NotificationType, Bits, Integer32, Counter64, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "enterprises", "iso", "Counter32", "NotificationType", "Unsigned32", "TimeTicks", "NotificationType", "Bits", "Integer32", "Counter64", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarm=compValAlarm, humUnit=humUnit, compValUnit=compValUnit, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, tempMax=tempMax, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, histTemp=histTemp, compValDelayInt=compValDelayInt, sensorName=sensorName, trapSOAPErrDNS=trapSOAPErrDNS, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, comet=comet, temp=temp, trapTempError=trapTempError, tables=tables, values=values, deviceType=deviceType, compValAlarmInt=compValAlarmInt, histHum=histHum, tempAlarmInt=tempAlarmInt, compValLowInt=compValLowInt, trapCompValHighAlarm=trapCompValHighAlarm, historyEntry=historyEntry, messageString=messageString, compValHighInt=compValHighInt, valuesInt=valuesInt, compValMax=compValMax, hum=hum, trapEmailErrSome=trapEmailErrSome, humInt=humInt, tempLowInt=tempLowInt, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, DisplayString=DisplayString, trapHumClrAlarm=trapHumClrAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, tempDelayInt=tempDelayInt, trapHumHighAlarm=trapHumHighAlarm, humDelayInt=humDelayInt, traps=traps, settings=settings, compVal=compVal, tempMin=tempMin, tempHystInt=tempHystInt, pysmi_global=pysmi_global, humMin=humMin, tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, tempHighInt=tempHighInt, humAlarm=humAlarm, humMax=humMax, histCompVal=histCompVal, humHighInt=humHighInt, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, historyTable=historyTable, humAlarmInt=humAlarmInt, compValHystInt=compValHystInt, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, tempAlarm=tempAlarm, serialNumber=serialNumber, products=products)
