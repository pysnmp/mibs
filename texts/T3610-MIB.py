...
enterprises, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, ObjectIdentity, Unsigned32, Integer32, Counter32, TimeTicks, MibIdentifier, NotificationType, ModuleIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "ObjectIdentity", "Unsigned32", "Integer32", "Counter32", "TimeTicks", "MibIdentifier", "NotificationType", "ModuleIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", compValMax=compValMax, products=products, compValUnit=compValUnit, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, trapSOAPErrSocket=trapSOAPErrSocket, histTemp=histTemp, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, trapSOAPErrFile=trapSOAPErrFile, trapCompValError=trapCompValError, histHum=histHum, tempMax=tempMax, tempAlarm=tempAlarm, compValHighInt=compValHighInt, values=values, settings=settings, traps=traps, DisplayString=DisplayString, deviceType=deviceType, tempMin=tempMin, tempDelayInt=tempDelayInt, tempHystInt=tempHystInt, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarmInt=tempAlarmInt, humDelayInt=humDelayInt, historyEntry=historyEntry, humInt=humInt, trapEmailErrAuth=trapEmailErrAuth, valuesInt=valuesInt, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapTempError=trapTempError, histCompVal=histCompVal, pysmi_global=pysmi_global, humHystInt=humHystInt, tempUnit=tempUnit, compValLowInt=compValLowInt, humMax=humMax, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, humMin=humMin, messageString=messageString, compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, humLowInt=humLowInt, tables=tables, historyTable=historyTable, trapTempLowAlarm=trapTempLowAlarm, humHighInt=humHighInt, humUnit=humUnit, trapHumLowAlarm=trapHumLowAlarm, temp=temp, tempInt=tempInt, compValAlarm=compValAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempHighInt=tempHighInt, humAlarmInt=humAlarmInt, hum=hum, sensorName=sensorName, trapHumHighAlarm=trapHumHighAlarm, compVal=compVal, trapEmailErrSocket=trapEmailErrSocket, comet=comet, serialNumber=serialNumber, compValInt=compValInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, tempLowInt=tempLowInt, t3610=t3610, compValMin=compValMin)
