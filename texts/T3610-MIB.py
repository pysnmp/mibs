...
Counter32, NotificationType, Counter64, TimeTicks, Gauge32, IpAddress, Integer32, ObjectIdentity, Unsigned32, iso, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Counter64", "TimeTicks", "Gauge32", "IpAddress", "Integer32", "ObjectIdentity", "Unsigned32", "iso", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, messageString=messageString, tempAlarm=tempAlarm, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, tempDelayInt=tempDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, tempMin=tempMin, compValLowInt=compValLowInt, histTemp=histTemp, compValMax=compValMax, compValAlarm=compValAlarm, compValMin=compValMin, historyEntry=historyEntry, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, comet=comet, humAlarmInt=humAlarmInt, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, trapHumHighAlarm=trapHumHighAlarm, humDelayInt=humDelayInt, trapCompValError=trapCompValError, trapTempClrAlarm=trapTempClrAlarm, compValDelayInt=compValDelayInt, histHum=histHum, humHystInt=humHystInt, serialNumber=serialNumber, products=products, compValHystInt=compValHystInt, tempMax=tempMax, hum=hum, histCompVal=histCompVal, trapNTPError=trapNTPError, values=values, tempHystInt=tempHystInt, settings=settings, humMax=humMax, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, humHighInt=humHighInt, trapTempLowAlarm=trapTempLowAlarm, deviceType=deviceType, trapHumError=trapHumError, compValHighInt=compValHighInt, compValUnit=compValUnit, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, humMin=humMin, humInt=humInt, compValInt=compValInt, humLowInt=humLowInt, humAlarm=humAlarm, compVal=compVal, DisplayString=DisplayString, sensorName=sensorName, tempAlarmInt=tempAlarmInt, tempLowInt=tempLowInt, historyTable=historyTable, trapEmailErrSocket=trapEmailErrSocket, trapHumLowAlarm=trapHumLowAlarm, tables=tables, trapHumClrAlarm=trapHumClrAlarm, traps=traps, humUnit=humUnit, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDelivery=trapSOAPErrDelivery, t3610=t3610, trapCompValHighAlarm=trapCompValHighAlarm, tempHighInt=tempHighInt)
