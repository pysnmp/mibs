...
Counter32, MibIdentifier, NotificationType, TimeTicks, ModuleIdentity, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Gauge32, ObjectIdentity, NotificationType, IpAddress, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "NotificationType", "TimeTicks", "ModuleIdentity", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Gauge32", "ObjectIdentity", "NotificationType", "IpAddress", "enterprises", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, compValHystInt=compValHystInt, humHystInt=humHystInt, humMin=humMin, trapEmailErrSocket=trapEmailErrSocket, compValUnit=compValUnit, histHum=histHum, tempMin=tempMin, trapTest=trapTest, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, humUnit=humUnit, DisplayString=DisplayString, temp=temp, tempInt=tempInt, humAlarmInt=humAlarmInt, valuesInt=valuesInt, values=values, trapTempHighAlarm=trapTempHighAlarm, humMax=humMax, tempLowInt=tempLowInt, compValInt=compValInt, tempDelayInt=tempDelayInt, historyTable=historyTable, products=products, humInt=humInt, humLowInt=humLowInt, tempAlarm=tempAlarm, trapTempLowAlarm=trapTempLowAlarm, compValMax=compValMax, humHighInt=humHighInt, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, histCompVal=histCompVal, compValAlarm=compValAlarm, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrLogin=trapEmailErrLogin, humAlarm=humAlarm, traps=traps, sensorName=sensorName, compValHighInt=compValHighInt, tables=tables, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, compVal=compVal, trapHumError=trapHumError, tempAlarmInt=tempAlarmInt, deviceType=deviceType, historyEntry=historyEntry, trapHumHighAlarm=trapHumHighAlarm, tempHystInt=tempHystInt, trapSOAPErrFile=trapSOAPErrFile, messageString=messageString, compValMin=compValMin, hum=hum, tempUnit=tempUnit, trapEmailErrSome=trapEmailErrSome, trapHumLowAlarm=trapHumLowAlarm, trapNTPError=trapNTPError, trapTempError=trapTempError, settings=settings, histTemp=histTemp, tempMax=tempMax, trapSOAPErrDNS=trapSOAPErrDNS, compValLowInt=compValLowInt, pysmi_global=pysmi_global, t3610=t3610, tempHighInt=tempHighInt, compValAlarmInt=compValAlarmInt, comet=comet)
