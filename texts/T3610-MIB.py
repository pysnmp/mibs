...
ObjectIdentity, IpAddress, Integer32, Counter32, NotificationType, enterprises, NotificationType, iso, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Unsigned32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Integer32", "Counter32", "NotificationType", "enterprises", "NotificationType", "iso", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Unsigned32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, humLowInt=humLowInt, trapTempHighAlarm=trapTempHighAlarm, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrSome=trapEmailErrSome, humUnit=humUnit, tempAlarm=tempAlarm, trapHumLowAlarm=trapHumLowAlarm, comet=comet, trapCompValLowAlarm=trapCompValLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, tempUnit=tempUnit, humMin=humMin, humHystInt=humHystInt, tables=tables, compValAlarm=compValAlarm, compValLowInt=compValLowInt, histHum=histHum, tempDelayInt=tempDelayInt, hum=hum, compValMax=compValMax, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMax=tempMax, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, tempInt=tempInt, compValAlarmInt=compValAlarmInt, products=products, humHighInt=humHighInt, histCompVal=histCompVal, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, DisplayString=DisplayString, humInt=humInt, compVal=compVal, settings=settings, humAlarm=humAlarm, compValMin=compValMin, tempAlarmInt=tempAlarmInt, pysmi_global=pysmi_global, humMax=humMax, valuesInt=valuesInt, tempLowInt=tempLowInt, compValHystInt=compValHystInt, historyEntry=historyEntry, compValUnit=compValUnit, trapTest=trapTest, trapTempError=trapTempError, compValHighInt=compValHighInt, tempMin=tempMin, tempHighInt=tempHighInt, humAlarmInt=humAlarmInt, histTemp=histTemp, sensorName=sensorName, messageString=messageString, compValInt=compValInt, t3610=t3610, traps=traps, temp=temp, trapNTPError=trapNTPError, humDelayInt=humDelayInt, values=values, deviceType=deviceType, trapHumHighAlarm=trapHumHighAlarm, tempHystInt=tempHystInt)
