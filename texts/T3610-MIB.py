...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:24:43 2024
...
NotificationType, iso, NotificationType, Gauge32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Integer32, Counter64, enterprises, Counter32, Unsigned32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "NotificationType", "Gauge32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Integer32", "Counter64", "enterprises", "Counter32", "Unsigned32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", tempHighInt=tempHighInt, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, trapTest=trapTest, humMin=humMin, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, compVal=compVal, tempInt=tempInt, values=values, tempMin=tempMin, tempAlarm=tempAlarm, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, historyTable=historyTable, compValMax=compValMax, trapTempHighAlarm=trapTempHighAlarm, compValLowInt=compValLowInt, tables=tables, products=products, compValAlarmInt=compValAlarmInt, tempLowInt=tempLowInt, compValMin=compValMin, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp, t3610=t3610, histCompVal=histCompVal, temp=temp, serialNumber=serialNumber, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, humMax=humMax, trapCompValHighAlarm=trapCompValHighAlarm, deviceType=deviceType, humInt=humInt, traps=traps, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, humLowInt=humLowInt, settings=settings, humDelayInt=humDelayInt, trapCompValError=trapCompValError, sensorName=sensorName, trapTempError=trapTempError, compValDelayInt=compValDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapHumError=trapHumError, comet=comet, humAlarmInt=humAlarmInt, valuesInt=valuesInt, humAlarm=humAlarm, humHighInt=humHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrSocket=trapSOAPErrSocket, humHystInt=humHystInt, humUnit=humUnit, compValHighInt=compValHighInt, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, tempMax=tempMax, tempDelayInt=tempDelayInt, tempAlarmInt=tempAlarmInt, tempHystInt=tempHystInt, tempUnit=tempUnit, messageString=messageString, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, historyEntry=historyEntry, hum=hum, compValAlarm=compValAlarm)
