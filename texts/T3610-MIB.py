...
ObjectIdentity, Counter32, Unsigned32, Counter64, ModuleIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, MibIdentifier, TimeTicks, Integer32, NotificationType, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Unsigned32", "Counter64", "ModuleIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "MibIdentifier", "TimeTicks", "Integer32", "NotificationType", "Bits", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrSocket=trapSOAPErrSocket, tempAlarm=tempAlarm, compValAlarm=compValAlarm, humUnit=humUnit, trapHumError=trapHumError, trapEmailErrAuth=trapEmailErrAuth, hum=hum, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, temp=temp, compValAlarmInt=compValAlarmInt, trapTest=trapTest, trapTempError=trapTempError, compValLowInt=compValLowInt, pysmi_global=pysmi_global, products=products, humMax=humMax, humAlarmInt=humAlarmInt, humHighInt=humHighInt, historyTable=historyTable, valuesInt=valuesInt, tempDelayInt=tempDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compVal=compVal, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, sensorName=sensorName, tempLowInt=tempLowInt, compValInt=compValInt, tempMax=tempMax, histCompVal=histCompVal, histTemp=histTemp, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, traps=traps, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, settings=settings, humDelayInt=humDelayInt, trapNTPError=trapNTPError, tempHystInt=tempHystInt, compValHighInt=compValHighInt, t3610=t3610, humHystInt=humHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSome=trapEmailErrSome, humInt=humInt, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, trapHumClrAlarm=trapHumClrAlarm, tempHighInt=tempHighInt, compValMax=compValMax, serialNumber=serialNumber, humMin=humMin, historyEntry=historyEntry, compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, humAlarm=humAlarm, comet=comet, tempMin=tempMin, tempAlarmInt=tempAlarmInt, trapTempHighAlarm=trapTempHighAlarm, DisplayString=DisplayString, tempUnit=tempUnit, values=values, humLowInt=humLowInt)
