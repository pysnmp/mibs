...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:04:17 2024
...
Bits, TimeTicks, Unsigned32, Counter32, ObjectIdentity, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, iso, MibIdentifier, Integer32, enterprises, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Unsigned32", "Counter32", "ObjectIdentity", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "iso", "MibIdentifier", "Integer32", "enterprises", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", settings=settings, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, compValMax=compValMax, compValHighInt=compValHighInt, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMin=tempMin, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, compValUnit=compValUnit, compValAlarm=compValAlarm, humInt=humInt, comet=comet, tempHystInt=tempHystInt, values=values, tempInt=tempInt, histTemp=histTemp, compVal=compVal, trapNTPError=trapNTPError, trapTest=trapTest, tempDelayInt=tempDelayInt, serialNumber=serialNumber, trapHumHighAlarm=trapHumHighAlarm, trapTempError=trapTempError, trapCompValError=trapCompValError, tempHighInt=tempHighInt, compValMin=compValMin, trapHumError=trapHumError, tempLowInt=tempLowInt, traps=traps, histCompVal=histCompVal, DisplayString=DisplayString, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, humLowInt=humLowInt, humAlarmInt=humAlarmInt, temp=temp, trapTempLowAlarm=trapTempLowAlarm, messageString=messageString, trapEmailErrDNS=trapEmailErrDNS, tempMax=tempMax, humMin=humMin, t3610=t3610, humUnit=humUnit, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, humHighInt=humHighInt, compValInt=compValInt, hum=hum, valuesInt=valuesInt, pysmi_global=pysmi_global, sensorName=sensorName, humHystInt=humHystInt, products=products, humDelayInt=humDelayInt, humMax=humMax, historyTable=historyTable, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, trapSOAPErrSocket=trapSOAPErrSocket, compValHystInt=compValHystInt, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, tables=tables, tempUnit=tempUnit, compValDelayInt=compValDelayInt, histHum=histHum, compValAlarmInt=compValAlarmInt, trapEmailErrSome=trapEmailErrSome, deviceType=deviceType, compValLowInt=compValLowInt)
