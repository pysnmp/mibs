...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:14:45 2022
...
NotificationType, enterprises, Gauge32, ObjectIdentity, Bits, Counter32, NotificationType, ModuleIdentity, IpAddress, Integer32, iso, MibIdentifier, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "Gauge32", "ObjectIdentity", "Bits", "Counter32", "NotificationType", "ModuleIdentity", "IpAddress", "Integer32", "iso", "MibIdentifier", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, histCompVal=histCompVal, historyEntry=historyEntry, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, compValUnit=compValUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, humUnit=humUnit, values=values, humHystInt=humHystInt, temp=temp, trapCompValHighAlarm=trapCompValHighAlarm, humHighInt=humHighInt, compValMax=compValMax, compValHighInt=compValHighInt, trapCompValClrAlarm=trapCompValClrAlarm, valuesInt=valuesInt, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, trapCompValLowAlarm=trapCompValLowAlarm, traps=traps, tempHystInt=tempHystInt, trapTempHighAlarm=trapTempHighAlarm, hum=hum, compValAlarm=compValAlarm, sensorName=sensorName, humAlarmInt=humAlarmInt, tempAlarmInt=tempAlarmInt, compValDelayInt=compValDelayInt, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrFile=trapSOAPErrFile, deviceType=deviceType, products=products, t3610=t3610, histHum=histHum, historyTable=historyTable, tempMin=tempMin, trapCompValError=trapCompValError, settings=settings, tempDelayInt=tempDelayInt, trapTempLowAlarm=trapTempLowAlarm, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, comet=comet, trapHumError=trapHumError, humMax=humMax, compVal=compVal, humDelayInt=humDelayInt, humInt=humInt, histTemp=histTemp, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, DisplayString=DisplayString, tempHighInt=tempHighInt, tempInt=tempInt, compValInt=compValInt, tempAlarm=tempAlarm, pysmi_global=pysmi_global, messageString=messageString, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, tempLowInt=tempLowInt, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, compValLowInt=compValLowInt, trapNTPError=trapNTPError, trapTempClrAlarm=trapTempClrAlarm, compValMin=compValMin)
