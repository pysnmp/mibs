...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:22:15 2021
...
enterprises, Integer32, IpAddress, ObjectIdentity, Unsigned32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, TimeTicks, ModuleIdentity, Counter64, iso, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "IpAddress", "ObjectIdentity", "Unsigned32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "TimeTicks", "ModuleIdentity", "Counter64", "iso", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarm=humAlarm, trapCompValClrAlarm=trapCompValClrAlarm, comet=comet, tempHystInt=tempHystInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, tables=tables, humLowInt=humLowInt, historyEntry=historyEntry, compValHystInt=compValHystInt, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarmInt=compValAlarmInt, compValInt=compValInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, tempInt=tempInt, compValMin=compValMin, histTemp=histTemp, trapTempLowAlarm=trapTempLowAlarm, histHum=histHum, tempMax=tempMax, values=values, trapHumLowAlarm=trapHumLowAlarm, compValMax=compValMax, compValLowInt=compValLowInt, compValUnit=compValUnit, messageString=messageString, trapTest=trapTest, humDelayInt=humDelayInt, humHystInt=humHystInt, products=products, trapEmailErrAuth=trapEmailErrAuth, sensorName=sensorName, tempDelayInt=tempDelayInt, valuesInt=valuesInt, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, settings=settings, hum=hum, trapEmailErrSome=trapEmailErrSome, traps=traps, tempAlarm=tempAlarm, deviceType=deviceType, trapTempHighAlarm=trapTempHighAlarm, temp=temp, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, trapTempError=trapTempError, compVal=compVal, humMax=humMax, pysmi_global=pysmi_global, tempLowInt=tempLowInt, tempMin=tempMin, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, tempHighInt=tempHighInt, humUnit=humUnit, serialNumber=serialNumber, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, t3610=t3610, humHighInt=humHighInt, DisplayString=DisplayString, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrFile=trapSOAPErrFile, humInt=humInt, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, humMin=humMin, trapNTPError=trapNTPError)
