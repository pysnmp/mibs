...
# Produced by pysmi-1.1.12 at Tue Jun  4 07:47:00 2024
...
Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Counter32, Counter64, ModuleIdentity, enterprises, Integer32, Bits, NotificationType, ObjectIdentity, IpAddress, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Counter32", "Counter64", "ModuleIdentity", "enterprises", "Integer32", "Bits", "NotificationType", "ObjectIdentity", "IpAddress", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", valuesInt=valuesInt, humUnit=humUnit, humInt=humInt, hum=hum, compValAlarm=compValAlarm, sensorName=sensorName, histTemp=histTemp, humAlarm=humAlarm, tempHystInt=tempHystInt, tempUnit=tempUnit, compValUnit=compValUnit, compVal=compVal, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, histCompVal=histCompVal, trapEmailErrLogin=trapEmailErrLogin, trapNTPError=trapNTPError, deviceType=deviceType, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, tempLowInt=tempLowInt, humHystInt=humHystInt, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, trapCompValError=trapCompValError, DisplayString=DisplayString, tempMin=tempMin, tempAlarmInt=tempAlarmInt, humMax=humMax, compValAlarmInt=compValAlarmInt, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, humHighInt=humHighInt, trapHumError=trapHumError, trapSOAPErrSocket=trapSOAPErrSocket, settings=settings, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, humLowInt=humLowInt, tempAlarm=tempAlarm, historyEntry=historyEntry, temp=temp, t3610=t3610, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, comet=comet, trapTest=trapTest, traps=traps, tables=tables, humMin=humMin, tempInt=tempInt, compValLowInt=compValLowInt, historyTable=historyTable, messageString=messageString, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, tempHighInt=tempHighInt, trapSOAPErrFile=trapSOAPErrFile, pysmi_global=pysmi_global, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, products=products, trapEmailErrSocket=trapEmailErrSocket, values=values, compValMin=compValMin, histHum=histHum, compValMax=compValMax, trapHumClrAlarm=trapHumClrAlarm, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrAuth=trapEmailErrAuth, compValHystInt=compValHystInt, serialNumber=serialNumber, trapEmailErrDNS=trapEmailErrDNS, humAlarmInt=humAlarmInt)
