...
# Produced by pysmi-1.1.3 at Tue Dec  7 13:49:21 2021
...
TimeTicks, MibIdentifier, Bits, IpAddress, Gauge32, ModuleIdentity, Counter64, iso, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Integer32, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Bits", "IpAddress", "Gauge32", "ModuleIdentity", "Counter64", "iso", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Integer32", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, DisplayString=DisplayString, hum=hum, historyEntry=historyEntry, trapNTPError=trapNTPError, valuesInt=valuesInt, trapEmailErrDNS=trapEmailErrDNS, tempAlarm=tempAlarm, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humMax=humMax, pysmi_global=pysmi_global, humMin=humMin, compValMax=compValMax, humHystInt=humHystInt, traps=traps, histHum=histHum, tables=tables, temp=temp, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, trapHumHighAlarm=trapHumHighAlarm, tempHighInt=tempHighInt, compValAlarmInt=compValAlarmInt, comet=comet, trapEmailErrAuth=trapEmailErrAuth, humUnit=humUnit, trapCompValError=trapCompValError, compValLowInt=compValLowInt, products=products, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, messageString=messageString, humAlarm=humAlarm, trapTempHighAlarm=trapTempHighAlarm, compVal=compVal, trapTempError=trapTempError, compValUnit=compValUnit, compValAlarm=compValAlarm, t3610=t3610, trapSOAPErrFile=trapSOAPErrFile, humDelayInt=humDelayInt, tempUnit=tempUnit, humInt=humInt, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, compValMin=compValMin, compValDelayInt=compValDelayInt, deviceType=deviceType, historyTable=historyTable, values=values, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, compValHystInt=compValHystInt, compValHighInt=compValHighInt, trapTest=trapTest, histTemp=histTemp, trapEmailErrSocket=trapEmailErrSocket, trapHumError=trapHumError, tempMin=tempMin, sensorName=sensorName, humLowInt=humLowInt, histCompVal=histCompVal, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, trapTempClrAlarm=trapTempClrAlarm, humHighInt=humHighInt, settings=settings, trapEmailErrSome=trapEmailErrSome, tempHystInt=tempHystInt)
