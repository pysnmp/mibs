...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:53:45 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, ModuleIdentity, MibIdentifier, NotificationType, enterprises, Unsigned32, Integer32, Counter64, Gauge32, Counter32, TimeTicks, IpAddress, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "ModuleIdentity", "MibIdentifier", "NotificationType", "enterprises", "Unsigned32", "Integer32", "Counter64", "Gauge32", "Counter32", "TimeTicks", "IpAddress", "Bits", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", tempDelayInt=tempDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, serialNumber=serialNumber, temp=temp, values=values, DisplayString=DisplayString, humMin=humMin, compValInt=compValInt, compValHighInt=compValHighInt, hum=hum, compValAlarm=compValAlarm, compValUnit=compValUnit, humAlarmInt=humAlarmInt, historyTable=historyTable, trapTempError=trapTempError, settings=settings, tempLowInt=tempLowInt, messageString=messageString, comet=comet, trapEmailErrSome=trapEmailErrSome, tempUnit=tempUnit, humLowInt=humLowInt, sensorName=sensorName, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, traps=traps, trapEmailErrSocket=trapEmailErrSocket, trapHumError=trapHumError, compValAlarmInt=compValAlarmInt, humDelayInt=humDelayInt, histHum=histHum, histCompVal=histCompVal, humHystInt=humHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, humInt=humInt, products=products, trapCompValHighAlarm=trapCompValHighAlarm, tables=tables, compValMax=compValMax, trapSOAPErrFile=trapSOAPErrFile, histTemp=histTemp, compVal=compVal, humAlarm=humAlarm, trapHumHighAlarm=trapHumHighAlarm, deviceType=deviceType, pysmi_global=pysmi_global, tempMin=tempMin, compValMin=compValMin, tempAlarmInt=tempAlarmInt, trapCompValError=trapCompValError, tempMax=tempMax, compValHystInt=compValHystInt, humUnit=humUnit, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTest=trapTest, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, historyEntry=historyEntry, trapNTPError=trapNTPError, tempHystInt=tempHystInt, t3610=t3610, trapCompValClrAlarm=trapCompValClrAlarm, humHighInt=humHighInt, compValLowInt=compValLowInt, humMax=humMax, trapEmailErrLogin=trapEmailErrLogin, tempInt=tempInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrDNS=trapEmailErrDNS)
