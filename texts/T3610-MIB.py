...
# Produced by pysmi-1.1.11 at Wed Apr  3 15:12:34 2024
...
ObjectIdentity, Integer32, MibIdentifier, Gauge32, iso, TimeTicks, IpAddress, Counter32, Counter64, NotificationType, Bits, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "MibIdentifier", "Gauge32", "iso", "TimeTicks", "IpAddress", "Counter32", "Counter64", "NotificationType", "Bits", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSocket=trapEmailErrSocket, trapHumHighAlarm=trapHumHighAlarm, compVal=compVal, compValUnit=compValUnit, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, tempMax=tempMax, compValDelayInt=compValDelayInt, humHystInt=humHystInt, tempUnit=tempUnit, humUnit=humUnit, histTemp=histTemp, trapTempError=trapTempError, pysmi_global=pysmi_global, comet=comet, humAlarm=humAlarm, humLowInt=humLowInt, compValHystInt=compValHystInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, compValAlarmInt=compValAlarmInt, serialNumber=serialNumber, histHum=histHum, hum=hum, compValLowInt=compValLowInt, historyTable=historyTable, compValInt=compValInt, trapHumClrAlarm=trapHumClrAlarm, tempInt=tempInt, values=values, tempAlarm=tempAlarm, compValAlarm=compValAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValClrAlarm=trapCompValClrAlarm, humInt=humInt, tempHystInt=tempHystInt, tempLowInt=tempLowInt, humDelayInt=humDelayInt, messageString=messageString, humMax=humMax, trapTempClrAlarm=trapTempClrAlarm, trapHumLowAlarm=trapHumLowAlarm, products=products, humMin=humMin, historyEntry=historyEntry, histCompVal=histCompVal, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, t3610=t3610, trapSOAPErrDNS=trapSOAPErrDNS, sensorName=sensorName, deviceType=deviceType, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, compValHighInt=compValHighInt, trapEmailErrLogin=trapEmailErrLogin, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, tempHighInt=tempHighInt, settings=settings, DisplayString=DisplayString, humHighInt=humHighInt, trapEmailErrAuth=trapEmailErrAuth, temp=temp, trapCompValHighAlarm=trapCompValHighAlarm, trapNTPError=trapNTPError, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, tables=tables, valuesInt=valuesInt, compValMin=compValMin, traps=traps, tempMin=tempMin)
