...
# Produced by pysmi-1.1.12 at Tue May 28 12:32:28 2024
...
NotificationType, enterprises, Bits, Gauge32, Unsigned32, TimeTicks, Counter32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, ModuleIdentity, Counter64, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "Bits", "Gauge32", "Unsigned32", "TimeTicks", "Counter32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "ModuleIdentity", "Counter64", "IpAddress", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarmInt=compValAlarmInt, trapEmailErrAuth=trapEmailErrAuth, messageString=messageString, t3610=t3610, tempLowInt=tempLowInt, trapHumLowAlarm=trapHumLowAlarm, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSome=trapEmailErrSome, trapEmailErrSocket=trapEmailErrSocket, historyEntry=historyEntry, compValDelayInt=compValDelayInt, compValMax=compValMax, tempHighInt=tempHighInt, humUnit=humUnit, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, settings=settings, trapCompValError=trapCompValError, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, compValAlarm=compValAlarm, tempMin=tempMin, tempInt=tempInt, compVal=compVal, humHighInt=humHighInt, trapSOAPErrFile=trapSOAPErrFile, temp=temp, pysmi_global=pysmi_global, traps=traps, humMin=humMin, tempUnit=tempUnit, tempMax=tempMax, histTemp=histTemp, humDelayInt=humDelayInt, trapNTPError=trapNTPError, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, DisplayString=DisplayString, values=values, humInt=humInt, humLowInt=humLowInt, humAlarm=humAlarm, sensorName=sensorName, tempDelayInt=tempDelayInt, tables=tables, trapTest=trapTest, histCompVal=histCompVal, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, valuesInt=valuesInt, products=products, humMax=humMax, compValHighInt=compValHighInt, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, compValLowInt=compValLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHystInt=tempHystInt, compValInt=compValInt, trapTempError=trapTempError, tempAlarmInt=tempAlarmInt, trapTempHighAlarm=trapTempHighAlarm, tempAlarm=tempAlarm, compValMin=compValMin, hum=hum, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, compValUnit=compValUnit, compValHystInt=compValHystInt, comet=comet)
