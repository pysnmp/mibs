...
# Produced by pysmi-1.1.8 at Mon Feb  7 16:09:26 2022
...
Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Unsigned32, TimeTicks, NotificationType, MibIdentifier, ModuleIdentity, Gauge32, iso, Bits, IpAddress, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Unsigned32", "TimeTicks", "NotificationType", "MibIdentifier", "ModuleIdentity", "Gauge32", "iso", "Bits", "IpAddress", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, hum=hum, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, humHystInt=humHystInt, values=values, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, tempDelayInt=tempDelayInt, pysmi_global=pysmi_global, humHighInt=humHighInt, trapTempClrAlarm=trapTempClrAlarm, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, trapHumLowAlarm=trapHumLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, products=products, tempMax=tempMax, humInt=humInt, tables=tables, humMin=humMin, t3610=t3610, temp=temp, DisplayString=DisplayString, histCompVal=histCompVal, historyEntry=historyEntry, trapNTPError=trapNTPError, trapHumError=trapHumError, tempUnit=tempUnit, humUnit=humUnit, compValDelayInt=compValDelayInt, compValAlarm=compValAlarm, compValMax=compValMax, comet=comet, compValInt=compValInt, tempMin=tempMin, tempLowInt=tempLowInt, historyTable=historyTable, compValHystInt=compValHystInt, serialNumber=serialNumber, trapTempError=trapTempError, deviceType=deviceType, compValHighInt=compValHighInt, trapEmailErrSome=trapEmailErrSome, compVal=compVal, settings=settings, tempAlarm=tempAlarm, humLowInt=humLowInt, trapSOAPErrDNS=trapSOAPErrDNS, humMax=humMax, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSocket=trapEmailErrSocket, compValMin=compValMin, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, humAlarmInt=humAlarmInt, histTemp=histTemp, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, tempHighInt=tempHighInt, compValLowInt=compValLowInt, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, humDelayInt=humDelayInt, traps=traps, trapEmailErrDNS=trapEmailErrDNS, histHum=histHum, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrAuth=trapEmailErrAuth, tempInt=tempInt, compValUnit=compValUnit)
