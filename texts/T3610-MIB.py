...
# Produced by pysmi-1.1.8 at Wed Oct 11 11:22:14 2023
...
Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, ModuleIdentity, Integer32, Unsigned32, MibIdentifier, Bits, NotificationType, iso, IpAddress, enterprises, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "ModuleIdentity", "Integer32", "Unsigned32", "MibIdentifier", "Bits", "NotificationType", "iso", "IpAddress", "enterprises", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, messageString=messageString, serialNumber=serialNumber, humLowInt=humLowInt, compValMin=compValMin, humHighInt=humHighInt, histTemp=histTemp, humInt=humInt, trapEmailErrLogin=trapEmailErrLogin, comet=comet, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, trapCompValHighAlarm=trapCompValHighAlarm, compValHighInt=compValHighInt, tempMin=tempMin, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, compValAlarm=compValAlarm, tempInt=tempInt, trapCompValError=trapCompValError, trapCompValLowAlarm=trapCompValLowAlarm, products=products, tempDelayInt=tempDelayInt, compValMax=compValMax, values=values, DisplayString=DisplayString, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, hum=hum, humMax=humMax, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, compValLowInt=compValLowInt, histCompVal=histCompVal, trapTest=trapTest, humDelayInt=humDelayInt, humHystInt=humHystInt, tempUnit=tempUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, t3610=t3610, settings=settings, humAlarmInt=humAlarmInt, sensorName=sensorName, deviceType=deviceType, tempHighInt=tempHighInt, trapNTPError=trapNTPError, compVal=compVal, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, tempMax=tempMax, temp=temp, valuesInt=valuesInt, historyEntry=historyEntry, humUnit=humUnit, tempAlarm=tempAlarm, trapSOAPErrFile=trapSOAPErrFile, trapCompValClrAlarm=trapCompValClrAlarm, humAlarm=humAlarm, humMin=humMin, trapEmailErrDNS=trapEmailErrDNS, compValAlarmInt=compValAlarmInt, tables=tables, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, traps=traps, compValInt=compValInt, trapTempError=trapTempError)
