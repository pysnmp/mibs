...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:26:35 2023
...
NotificationType, NotificationType, IpAddress, iso, MibIdentifier, Counter64, Gauge32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, ObjectIdentity, ModuleIdentity, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "IpAddress", "iso", "MibIdentifier", "Counter64", "Gauge32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "ObjectIdentity", "ModuleIdentity", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValError=trapCompValError, compValUnit=compValUnit, traps=traps, humMin=humMin, trapTempLowAlarm=trapTempLowAlarm, humAlarm=humAlarm, trapEmailErrDNS=trapEmailErrDNS, DisplayString=DisplayString, compVal=compVal, historyEntry=historyEntry, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, tempAlarmInt=tempAlarmInt, temp=temp, tempHystInt=tempHystInt, humInt=humInt, humHystInt=humHystInt, humAlarmInt=humAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest, trapSOAPErrFile=trapSOAPErrFile, deviceType=deviceType, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, tempMax=tempMax, serialNumber=serialNumber, messageString=messageString, tempLowInt=tempLowInt, compValAlarm=compValAlarm, compValInt=compValInt, compValLowInt=compValLowInt, comet=comet, trapHumHighAlarm=trapHumHighAlarm, trapHumClrAlarm=trapHumClrAlarm, humDelayInt=humDelayInt, compValAlarmInt=compValAlarmInt, values=values, tempMin=tempMin, trapTempError=trapTempError, compValMax=compValMax, compValHystInt=compValHystInt, t3610=t3610, pysmi_global=pysmi_global, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, humMax=humMax, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, trapSOAPErrSocket=trapSOAPErrSocket, hum=hum, trapHumError=trapHumError, sensorName=sensorName, tempAlarm=tempAlarm, tables=tables, humLowInt=humLowInt, histTemp=histTemp, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, products=products, trapTempClrAlarm=trapTempClrAlarm, settings=settings, humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, trapNTPError=trapNTPError, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, tempInt=tempInt, tempUnit=tempUnit, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, humHighInt=humHighInt, valuesInt=valuesInt, compValMin=compValMin, compValHighInt=compValHighInt)
