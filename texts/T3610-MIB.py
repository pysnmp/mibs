...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:40:49 2023
...
TimeTicks, IpAddress, Integer32, ModuleIdentity, MibIdentifier, NotificationType, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, Bits, Unsigned32, Gauge32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Integer32", "ModuleIdentity", "MibIdentifier", "NotificationType", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "Bits", "Unsigned32", "Gauge32", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compVal=compVal, compValMin=compValMin, valuesInt=valuesInt, humMin=humMin, historyTable=historyTable, tempUnit=tempUnit, trapEmailErrLogin=trapEmailErrLogin, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, tempLowInt=tempLowInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDNS=trapSOAPErrDNS, serialNumber=serialNumber, histTemp=histTemp, humAlarmInt=humAlarmInt, tempAlarmInt=tempAlarmInt, deviceType=deviceType, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, sensorName=sensorName, tempInt=tempInt, humInt=humInt, compValAlarmInt=compValAlarmInt, trapTest=trapTest, compValHighInt=compValHighInt, tempMin=tempMin, compValAlarm=compValAlarm, trapSOAPErrSocket=trapSOAPErrSocket, historyEntry=historyEntry, trapHumClrAlarm=trapHumClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, temp=temp, tables=tables, humUnit=humUnit, tempMax=tempMax, messageString=messageString, trapEmailErrSome=trapEmailErrSome, pysmi_global=pysmi_global, settings=settings, comet=comet, compValInt=compValInt, trapHumHighAlarm=trapHumHighAlarm, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapCompValError=trapCompValError, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, trapEmailErrAuth=trapEmailErrAuth, compValHystInt=compValHystInt, trapHumError=trapHumError, trapTempHighAlarm=trapTempHighAlarm, histCompVal=histCompVal, compValLowInt=compValLowInt, products=products, humAlarm=humAlarm, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, tempHighInt=tempHighInt, trapHumLowAlarm=trapHumLowAlarm, traps=traps, tempAlarm=tempAlarm, humHighInt=humHighInt, t3610=t3610, compValUnit=compValUnit, humDelayInt=humDelayInt, DisplayString=DisplayString, values=values, trapSOAPErrDelivery=trapSOAPErrDelivery, humLowInt=humLowInt, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, trapNTPError=trapNTPError, hum=hum, humMax=humMax)
