...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:54:22 2023
...
enterprises, ModuleIdentity, IpAddress, Gauge32, iso, Bits, TimeTicks, Counter64, NotificationType, NotificationType, ObjectIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "IpAddress", "Gauge32", "iso", "Bits", "TimeTicks", "Counter64", "NotificationType", "NotificationType", "ObjectIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", values=values, tempAlarm=tempAlarm, trapNTPError=trapNTPError, humMin=humMin, compValMax=compValMax, humMax=humMax, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, trapCompValError=trapCompValError, trapEmailErrSocket=trapEmailErrSocket, historyTable=historyTable, trapHumError=trapHumError, humUnit=humUnit, trapSOAPErrFile=trapSOAPErrFile, tempInt=tempInt, pysmi_global=pysmi_global, trapSOAPErrSocket=trapSOAPErrSocket, hum=hum, deviceType=deviceType, tempDelayInt=tempDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, tempAlarmInt=tempAlarmInt, humHighInt=humHighInt, compValHighInt=compValHighInt, valuesInt=valuesInt, tempUnit=tempUnit, trapHumClrAlarm=trapHumClrAlarm, trapTest=trapTest, histTemp=histTemp, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, settings=settings, temp=temp, tempHighInt=tempHighInt, compValLowInt=compValLowInt, trapEmailErrSome=trapEmailErrSome, humHystInt=humHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, humDelayInt=humDelayInt, comet=comet, compValHystInt=compValHystInt, t3610=t3610, humAlarm=humAlarm, histHum=histHum, trapTempHighAlarm=trapTempHighAlarm, compValDelayInt=compValDelayInt, tempMin=tempMin, trapSOAPErrDNS=trapSOAPErrDNS, trapTempLowAlarm=trapTempLowAlarm, DisplayString=DisplayString, trapEmailErrAuth=trapEmailErrAuth, trapCompValClrAlarm=trapCompValClrAlarm, humInt=humInt, histCompVal=histCompVal, products=products, humAlarmInt=humAlarmInt, tables=tables, tempLowInt=tempLowInt, tempHystInt=tempHystInt, tempMax=tempMax, messageString=messageString, traps=traps, compVal=compVal, trapCompValHighAlarm=trapCompValHighAlarm, compValUnit=compValUnit, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, humLowInt=humLowInt, serialNumber=serialNumber, compValAlarm=compValAlarm, sensorName=sensorName, trapTempError=trapTempError)
