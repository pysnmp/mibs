...
enterprises, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, IpAddress, NotificationType, Counter64, Counter32, iso, Integer32, MibIdentifier, ObjectIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "IpAddress", "NotificationType", "Counter64", "Counter32", "iso", "Integer32", "MibIdentifier", "ObjectIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, compValMin=compValMin, tempMax=tempMax, compValHystInt=compValHystInt, trapCompValLowAlarm=trapCompValLowAlarm, histTemp=histTemp, compValAlarmInt=compValAlarmInt, tempMin=tempMin, tempAlarmInt=tempAlarmInt, humHighInt=humHighInt, humDelayInt=humDelayInt, trapEmailErrSocket=trapEmailErrSocket, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, trapTempClrAlarm=trapTempClrAlarm, messageString=messageString, humUnit=humUnit, trapEmailErrAuth=trapEmailErrAuth, tempUnit=tempUnit, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrSome=trapEmailErrSome, humMin=humMin, tempDelayInt=tempDelayInt, humMax=humMax, compVal=compVal, temp=temp, compValHighInt=compValHighInt, comet=comet, trapTempHighAlarm=trapTempHighAlarm, t3610=t3610, humInt=humInt, tempLowInt=tempLowInt, humAlarm=humAlarm, histCompVal=histCompVal, tempHystInt=tempHystInt, compValUnit=compValUnit, pysmi_global=pysmi_global, historyTable=historyTable, trapNTPError=trapNTPError, DisplayString=DisplayString, compValAlarm=compValAlarm, compValInt=compValInt, trapCompValClrAlarm=trapCompValClrAlarm, trapHumError=trapHumError, hum=hum, values=values, trapHumLowAlarm=trapHumLowAlarm, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, humHystInt=humHystInt, valuesInt=valuesInt, settings=settings, compValLowInt=compValLowInt, tables=tables, trapCompValError=trapCompValError, trapTempError=trapTempError, trapSOAPErrSocket=trapSOAPErrSocket, products=products, serialNumber=serialNumber, humLowInt=humLowInt, humAlarmInt=humAlarmInt, tempAlarm=tempAlarm, traps=traps, trapTempLowAlarm=trapTempLowAlarm, sensorName=sensorName, tempInt=tempInt, trapHumClrAlarm=trapHumClrAlarm, deviceType=deviceType, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, trapSOAPErrDelivery=trapSOAPErrDelivery)
