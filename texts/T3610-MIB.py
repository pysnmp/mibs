...
IpAddress, ObjectIdentity, TimeTicks, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, MibIdentifier, NotificationType, Unsigned32, iso, Gauge32, Counter64, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "TimeTicks", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "MibIdentifier", "NotificationType", "Unsigned32", "iso", "Gauge32", "Counter64", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, humUnit=humUnit, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, tables=tables, trapCompValError=trapCompValError, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, compVal=compVal, tempAlarm=tempAlarm, compValMin=compValMin, DisplayString=DisplayString, temp=temp, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, tempDelayInt=tempDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, trapHumClrAlarm=trapHumClrAlarm, compValDelayInt=compValDelayInt, compValLowInt=compValLowInt, humDelayInt=humDelayInt, trapTempHighAlarm=trapTempHighAlarm, compValHighInt=compValHighInt, historyEntry=historyEntry, compValAlarmInt=compValAlarmInt, compValMax=compValMax, histTemp=histTemp, sensorName=sensorName, humHighInt=humHighInt, humMin=humMin, traps=traps, tempMax=tempMax, valuesInt=valuesInt, settings=settings, pysmi_global=pysmi_global, products=products, trapSOAPErrFile=trapSOAPErrFile, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, trapTempClrAlarm=trapTempClrAlarm, humLowInt=humLowInt, tempMin=tempMin, values=values, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, humInt=humInt, compValHystInt=compValHystInt, historyTable=historyTable, messageString=messageString, compValAlarm=compValAlarm, hum=hum, tempInt=tempInt, compValInt=compValInt, compValUnit=compValUnit, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, trapTest=trapTest, histCompVal=histCompVal, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, tempHystInt=tempHystInt, trapCompValLowAlarm=trapCompValLowAlarm, tempHighInt=tempHighInt, serialNumber=serialNumber, comet=comet)
