...
NotificationType, TimeTicks, Bits, Counter32, IpAddress, Counter64, Gauge32, MibIdentifier, iso, ObjectIdentity, ModuleIdentity, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Bits", "Counter32", "IpAddress", "Counter64", "Gauge32", "MibIdentifier", "iso", "ObjectIdentity", "ModuleIdentity", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarmInt=compValAlarmInt, histHum=histHum, products=products, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm, humAlarmInt=humAlarmInt, compValMin=compValMin, historyTable=historyTable, pysmi_global=pysmi_global, humAlarm=humAlarm, tempHighInt=tempHighInt, humUnit=humUnit, tempHystInt=tempHystInt, historyEntry=historyEntry, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, compVal=compVal, compValInt=compValInt, tables=tables, compValLowInt=compValLowInt, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, humMax=humMax, compValHighInt=compValHighInt, sensorName=sensorName, histTemp=histTemp, deviceType=deviceType, traps=traps, trapEmailErrAuth=trapEmailErrAuth, tempAlarm=tempAlarm, trapEmailErrSome=trapEmailErrSome, serialNumber=serialNumber, trapSOAPErrDelivery=trapSOAPErrDelivery, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, tempUnit=tempUnit, comet=comet, DisplayString=DisplayString, tempInt=tempInt, tempLowInt=tempLowInt, humDelayInt=humDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, humHystInt=humHystInt, humMin=humMin, compValDelayInt=compValDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, trapTempHighAlarm=trapTempHighAlarm, temp=temp, trapHumError=trapHumError, trapEmailErrLogin=trapEmailErrLogin, compValAlarm=compValAlarm, humInt=humInt, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, valuesInt=valuesInt, compValMax=compValMax, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapHumHighAlarm=trapHumHighAlarm, tempDelayInt=tempDelayInt, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSocket=trapEmailErrSocket, settings=settings, humLowInt=humLowInt, tempMax=tempMax, trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, values=values, messageString=messageString, t3610=t3610, compValUnit=compValUnit, trapNTPError=trapNTPError)
