...
# Produced by pysmi-1.1.12 at Tue Jun  4 02:37:56 2024
...
Gauge32, ModuleIdentity, TimeTicks, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Counter64, MibIdentifier, IpAddress, iso, Integer32, enterprises, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Counter64", "MibIdentifier", "IpAddress", "iso", "Integer32", "enterprises", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValMin=compValMin, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, humHystInt=humHystInt, tempMax=tempMax, historyTable=historyTable, deviceType=deviceType, trapCompValClrAlarm=trapCompValClrAlarm, pysmi_global=pysmi_global, hum=hum, compValUnit=compValUnit, humMax=humMax, compValInt=compValInt, t3610=t3610, tempLowInt=tempLowInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, humInt=humInt, histTemp=histTemp, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrFile=trapSOAPErrFile, humUnit=humUnit, trapTest=trapTest, histHum=histHum, DisplayString=DisplayString, settings=settings, trapTempError=trapTempError, valuesInt=valuesInt, compValMax=compValMax, comet=comet, tempInt=tempInt, tempAlarmInt=tempAlarmInt, sensorName=sensorName, histCompVal=histCompVal, traps=traps, compVal=compVal, humLowInt=humLowInt, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, trapEmailErrSome=trapEmailErrSome, trapEmailErrAuth=trapEmailErrAuth, tables=tables, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, historyEntry=historyEntry, tempMin=tempMin, tempAlarm=tempAlarm, values=values, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, trapNTPError=trapNTPError, humHighInt=humHighInt, compValLowInt=compValLowInt, humMin=humMin, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, compValAlarmInt=compValAlarmInt, compValAlarm=compValAlarm, products=products, humAlarmInt=humAlarmInt, humAlarm=humAlarm, tempHystInt=tempHystInt, temp=temp, compValHystInt=compValHystInt, tempHighInt=tempHighInt, compValHighInt=compValHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, tempUnit=tempUnit)
