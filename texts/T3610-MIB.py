...
# Produced by pysmi-1.1.8 at Mon Feb  7 15:46:13 2022
...
Counter64, IpAddress, Counter32, MibIdentifier, Integer32, Gauge32, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, NotificationType, Unsigned32, NotificationType, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Counter32", "MibIdentifier", "Integer32", "Gauge32", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "NotificationType", "Unsigned32", "NotificationType", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValError=trapCompValError, tempMin=tempMin, deviceType=deviceType, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, humMax=humMax, hum=hum, sensorName=sensorName, compValUnit=compValUnit, compValHystInt=compValHystInt, serialNumber=serialNumber, historyEntry=historyEntry, tempUnit=tempUnit, tempMax=tempMax, humHystInt=humHystInt, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, tempInt=tempInt, trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, trapEmailErrLogin=trapEmailErrLogin, tables=tables, traps=traps, settings=settings, compValLowInt=compValLowInt, humAlarmInt=humAlarmInt, histTemp=histTemp, pysmi_global=pysmi_global, products=products, humMin=humMin, compValHighInt=compValHighInt, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, values=values, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, trapNTPError=trapNTPError, t3610=t3610, humInt=humInt, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, compValMin=compValMin, trapTempError=trapTempError, compValAlarm=compValAlarm, tempHighInt=tempHighInt, humLowInt=humLowInt, valuesInt=valuesInt, compVal=compVal, temp=temp, humDelayInt=humDelayInt, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, humAlarm=humAlarm, humUnit=humUnit, humHighInt=humHighInt, tempHystInt=tempHystInt, trapHumError=trapHumError, trapCompValLowAlarm=trapCompValLowAlarm, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, compValMax=compValMax, trapSOAPErrDelivery=trapSOAPErrDelivery, tempDelayInt=tempDelayInt, compValInt=compValInt, comet=comet, tempLowInt=tempLowInt, compValDelayInt=compValDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, histCompVal=histCompVal, trapCompValClrAlarm=trapCompValClrAlarm)
