...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:20:26 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, ObjectIdentity, IpAddress, Gauge32, ModuleIdentity, enterprises, TimeTicks, NotificationType, iso, NotificationType, Counter32, Bits, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "ObjectIdentity", "IpAddress", "Gauge32", "ModuleIdentity", "enterprises", "TimeTicks", "NotificationType", "iso", "NotificationType", "Counter32", "Bits", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumError=trapHumError, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, humInt=humInt, deviceType=deviceType, trapSOAPErrSocket=trapSOAPErrSocket, humUnit=humUnit, compValUnit=compValUnit, compValHighInt=compValHighInt, trapTempClrAlarm=trapTempClrAlarm, serialNumber=serialNumber, humAlarmInt=humAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, products=products, values=values, DisplayString=DisplayString, compValLowInt=compValLowInt, t3610=t3610, historyTable=historyTable, trapTempHighAlarm=trapTempHighAlarm, humMin=humMin, tempInt=tempInt, compValHystInt=compValHystInt, trapTempLowAlarm=trapTempLowAlarm, tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, trapHumLowAlarm=trapHumLowAlarm, tables=tables, tempMax=tempMax, histTemp=histTemp, tempMin=tempMin, histCompVal=histCompVal, sensorName=sensorName, compValAlarm=compValAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, tempLowInt=tempLowInt, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, pysmi_global=pysmi_global, tempAlarmInt=tempAlarmInt, trapSOAPErrFile=trapSOAPErrFile, humHystInt=humHystInt, compValMin=compValMin, compValMax=compValMax, hum=hum, tempDelayInt=tempDelayInt, compVal=compVal, trapEmailErrDNS=trapEmailErrDNS, humAlarm=humAlarm, trapCompValError=trapCompValError, historyEntry=historyEntry, comet=comet, humMax=humMax, histHum=histHum, trapTempError=trapTempError, trapTest=trapTest, traps=traps, humHighInt=humHighInt, valuesInt=valuesInt, tempUnit=tempUnit, compValInt=compValInt, trapHumClrAlarm=trapHumClrAlarm, tempHighInt=tempHighInt, humLowInt=humLowInt, temp=temp, compValAlarmInt=compValAlarmInt, humDelayInt=humDelayInt, trapNTPError=trapNTPError, tempAlarm=tempAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome)
