...
Counter64, enterprises, Integer32, Bits, NotificationType, Counter32, ObjectIdentity, IpAddress, TimeTicks, iso, Gauge32, Unsigned32, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "Integer32", "Bits", "NotificationType", "Counter32", "ObjectIdentity", "IpAddress", "TimeTicks", "iso", "Gauge32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, compValMax=compValMax, compValHystInt=compValHystInt, humLowInt=humLowInt, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, humHighInt=humHighInt, tempLowInt=tempLowInt, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, humMax=humMax, compValHighInt=compValHighInt, compValMin=compValMin, deviceType=deviceType, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, temp=temp, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrDNS=trapEmailErrDNS, messageString=messageString, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, tempMin=tempMin, traps=traps, trapTempError=trapTempError, compValInt=compValInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, tempHighInt=tempHighInt, compVal=compVal, tempAlarm=tempAlarm, settings=settings, trapTest=trapTest, trapHumError=trapHumError, trapCompValError=trapCompValError, tables=tables, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, humMin=humMin, trapTempClrAlarm=trapTempClrAlarm, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, histHum=histHum, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, pysmi_global=pysmi_global, histCompVal=histCompVal, products=products, valuesInt=valuesInt, values=values, tempMax=tempMax, sensorName=sensorName, tempAlarmInt=tempAlarmInt, humDelayInt=humDelayInt, historyEntry=historyEntry, comet=comet, humAlarmInt=humAlarmInt, compValLowInt=compValLowInt, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp, humInt=humInt, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, hum=hum, historyTable=historyTable, humAlarm=humAlarm)
