...
# Produced by pysmi-1.1.11 at Wed Dec  6 02:59:09 2023
...
IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, NotificationType, Gauge32, Unsigned32, Counter32, Bits, Counter64, Integer32, enterprises, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "NotificationType", "Gauge32", "Unsigned32", "Counter32", "Bits", "Counter64", "Integer32", "enterprises", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, compValAlarm=compValAlarm, tempMin=tempMin, valuesInt=valuesInt, humInt=humInt, hum=hum, compValMin=compValMin, trapNTPError=trapNTPError, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, tempMax=tempMax, compValDelayInt=compValDelayInt, humAlarmInt=humAlarmInt, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, tempHighInt=tempHighInt, tables=tables, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, comet=comet, humMin=humMin, trapTempLowAlarm=trapTempLowAlarm, deviceType=deviceType, tempInt=tempInt, histHum=histHum, trapHumHighAlarm=trapHumHighAlarm, compVal=compVal, tempUnit=tempUnit, compValLowInt=compValLowInt, histTemp=histTemp, sensorName=sensorName, serialNumber=serialNumber, humLowInt=humLowInt, tempDelayInt=tempDelayInt, humHighInt=humHighInt, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, messageString=messageString, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSome=trapEmailErrSome, compValHighInt=compValHighInt, trapTempError=trapTempError, values=values, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, humDelayInt=humDelayInt, trapSOAPErrFile=trapSOAPErrFile, temp=temp, products=products, tempAlarm=tempAlarm, compValInt=compValInt, histCompVal=histCompVal, humUnit=humUnit, trapCompValHighAlarm=trapCompValHighAlarm, humHystInt=humHystInt, trapTest=trapTest, compValUnit=compValUnit, trapTempHighAlarm=trapTempHighAlarm, compValAlarmInt=compValAlarmInt, trapTempClrAlarm=trapTempClrAlarm, humAlarm=humAlarm, t3610=t3610, settings=settings, humMax=humMax, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, pysmi_global=pysmi_global, tempLowInt=tempLowInt, traps=traps, compValHystInt=compValHystInt, trapCompValError=trapCompValError, tempHystInt=tempHystInt, trapCompValLowAlarm=trapCompValLowAlarm, historyEntry=historyEntry)
