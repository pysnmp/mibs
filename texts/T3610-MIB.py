...
# Produced by pysmi-1.1.8 at Fri Oct 13 13:58:18 2023
...
Unsigned32, Integer32, Bits, ModuleIdentity, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, iso, NotificationType, NotificationType, Counter32, MibIdentifier, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Bits", "ModuleIdentity", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "iso", "NotificationType", "NotificationType", "Counter32", "MibIdentifier", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarmInt=humAlarmInt, trapCompValError=trapCompValError, trapTempClrAlarm=trapTempClrAlarm, tempMax=tempMax, humLowInt=humLowInt, humMin=humMin, humUnit=humUnit, humDelayInt=humDelayInt, tempHystInt=tempHystInt, histHum=histHum, trapNTPError=trapNTPError, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarm=tempAlarm, compValInt=compValInt, pysmi_global=pysmi_global, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, trapHumHighAlarm=trapHumHighAlarm, compVal=compVal, trapEmailErrLogin=trapEmailErrLogin, compValDelayInt=compValDelayInt, tempMin=tempMin, tables=tables, compValMin=compValMin, compValUnit=compValUnit, trapHumClrAlarm=trapHumClrAlarm, trapHumLowAlarm=trapHumLowAlarm, hum=hum, tempInt=tempInt, serialNumber=serialNumber, values=values, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, comet=comet, humHighInt=humHighInt, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, deviceType=deviceType, sensorName=sensorName, valuesInt=valuesInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, tempHighInt=tempHighInt, temp=temp, compValHighInt=compValHighInt, DisplayString=DisplayString, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, tempLowInt=tempLowInt, humInt=humInt, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, tempAlarmInt=tempAlarmInt, humMax=humMax, compValMax=compValMax, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, messageString=messageString, compValAlarm=compValAlarm, traps=traps, humAlarm=humAlarm, histCompVal=histCompVal, histTemp=histTemp, compValAlarmInt=compValAlarmInt, trapTest=trapTest, tempUnit=tempUnit, compValLowInt=compValLowInt, settings=settings, historyTable=historyTable, products=products, historyEntry=historyEntry, t3610=t3610)
