...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:10:37 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Counter32, iso, Counter64, ModuleIdentity, Bits, MibIdentifier, ObjectIdentity, TimeTicks, Unsigned32, Integer32, NotificationType, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Counter32", "iso", "Counter64", "ModuleIdentity", "Bits", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Unsigned32", "Integer32", "NotificationType", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, humLowInt=humLowInt, sensorName=sensorName, comet=comet, humMin=humMin, messageString=messageString, trapHumHighAlarm=trapHumHighAlarm, trapHumLowAlarm=trapHumLowAlarm, humAlarmInt=humAlarmInt, tempLowInt=tempLowInt, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, traps=traps, trapCompValError=trapCompValError, DisplayString=DisplayString, historyTable=historyTable, histHum=histHum, trapCompValClrAlarm=trapCompValClrAlarm, settings=settings, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, compValLowInt=compValLowInt, t3610=t3610, compValMax=compValMax, compValUnit=compValUnit, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, trapHumError=trapHumError, tempAlarm=tempAlarm, humHighInt=humHighInt, trapTest=trapTest, trapTempLowAlarm=trapTempLowAlarm, serialNumber=serialNumber, humInt=humInt, humMax=humMax, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, tempMax=tempMax, histTemp=histTemp, humHystInt=humHystInt, compValAlarm=compValAlarm, compValHighInt=compValHighInt, trapTempHighAlarm=trapTempHighAlarm, tempHystInt=tempHystInt, compValMin=compValMin, trapTempClrAlarm=trapTempClrAlarm, pysmi_global=pysmi_global, humUnit=humUnit, trapEmailErrDNS=trapEmailErrDNS, products=products, tempUnit=tempUnit, trapHumClrAlarm=trapHumClrAlarm, compVal=compVal, tables=tables, trapNTPError=trapNTPError, values=values, compValInt=compValInt, historyEntry=historyEntry, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, tempAlarmInt=tempAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, compValHystInt=compValHystInt, tempMin=tempMin, hum=hum, trapEmailErrSocket=trapEmailErrSocket, temp=temp, humAlarm=humAlarm, deviceType=deviceType)
