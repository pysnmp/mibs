...
# Produced by pysmi-1.1.8 at Mon Sep 19 07:23:25 2022
...
Integer32, NotificationType, Gauge32, ModuleIdentity, NotificationType, Bits, TimeTicks, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Unsigned32, IpAddress, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Gauge32", "ModuleIdentity", "NotificationType", "Bits", "TimeTicks", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "iso", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumLowAlarm=trapHumLowAlarm, products=products, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, tempUnit=tempUnit, humLowInt=humLowInt, compValMax=compValMax, humAlarmInt=humAlarmInt, compValAlarm=compValAlarm, tempInt=tempInt, trapCompValLowAlarm=trapCompValLowAlarm, compVal=compVal, t3610=t3610, tempDelayInt=tempDelayInt, sensorName=sensorName, humDelayInt=humDelayInt, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt, trapEmailErrLogin=trapEmailErrLogin, serialNumber=serialNumber, histCompVal=histCompVal, trapHumError=trapHumError, trapEmailErrSocket=trapEmailErrSocket, tempMax=tempMax, values=values, humAlarm=humAlarm, deviceType=deviceType, trapEmailErrDNS=trapEmailErrDNS, traps=traps, hum=hum, tempMin=tempMin, humUnit=humUnit, humMax=humMax, valuesInt=valuesInt, comet=comet, temp=temp, tempLowInt=tempLowInt, tempHighInt=tempHighInt, histHum=histHum, trapTest=trapTest, trapNTPError=trapNTPError, tables=tables, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, trapCompValError=trapCompValError, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, settings=settings, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, humInt=humInt, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, humHighInt=humHighInt, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, compValHystInt=compValHystInt, compValLowInt=compValLowInt, compValHighInt=compValHighInt, compValUnit=compValUnit, messageString=messageString, humMin=humMin, tempAlarmInt=tempAlarmInt, trapTempLowAlarm=trapTempLowAlarm, pysmi_global=pysmi_global, humHystInt=humHystInt, tempAlarm=tempAlarm, compValInt=compValInt)
