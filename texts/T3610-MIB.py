...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:30:53 2022
...
MibIdentifier, NotificationType, Integer32, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, ObjectIdentity, iso, Gauge32, NotificationType, TimeTicks, Counter32, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Integer32", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "ObjectIdentity", "iso", "Gauge32", "NotificationType", "TimeTicks", "Counter32", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, trapEmailErrLogin=trapEmailErrLogin, compValInt=compValInt, histHum=histHum, t3610=t3610, tempAlarm=tempAlarm, compValDelayInt=compValDelayInt, settings=settings, humAlarm=humAlarm, trapTempClrAlarm=trapTempClrAlarm, historyEntry=historyEntry, messageString=messageString, trapEmailErrSocket=trapEmailErrSocket, humAlarmInt=humAlarmInt, compValUnit=compValUnit, compValMin=compValMin, tempHystInt=tempHystInt, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, DisplayString=DisplayString, trapHumClrAlarm=trapHumClrAlarm, humMin=humMin, trapEmailErrSome=trapEmailErrSome, humDelayInt=humDelayInt, trapTempError=trapTempError, tempHighInt=tempHighInt, traps=traps, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrDNS=trapEmailErrDNS, trapHumError=trapHumError, histTemp=histTemp, trapTest=trapTest, trapHumHighAlarm=trapHumHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarmInt=tempAlarmInt, values=values, tempInt=tempInt, deviceType=deviceType, compValAlarmInt=compValAlarmInt, compValHystInt=compValHystInt, tables=tables, temp=temp, tempUnit=tempUnit, humUnit=humUnit, tempMax=tempMax, trapSOAPErrSocket=trapSOAPErrSocket, serialNumber=serialNumber, trapCompValLowAlarm=trapCompValLowAlarm, pysmi_global=pysmi_global, compValHighInt=compValHighInt, humMax=humMax, tempDelayInt=tempDelayInt, humInt=humInt, humLowInt=humLowInt, compValAlarm=compValAlarm, humHighInt=humHighInt, sensorName=sensorName, valuesInt=valuesInt, trapEmailErrAuth=trapEmailErrAuth, trapTempHighAlarm=trapTempHighAlarm, products=products, compVal=compVal, tempMin=tempMin, trapSOAPErrDNS=trapSOAPErrDNS, compValMax=compValMax, comet=comet, compValLowInt=compValLowInt, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, histCompVal=histCompVal, trapHumLowAlarm=trapHumLowAlarm, tempLowInt=tempLowInt, trapTempLowAlarm=trapTempLowAlarm, hum=hum, humHystInt=humHystInt)
