...
iso, NotificationType, ObjectIdentity, NotificationType, Counter64, enterprises, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Gauge32, IpAddress, Integer32, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "ObjectIdentity", "NotificationType", "Counter64", "enterprises", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Gauge32", "IpAddress", "Integer32", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, serialNumber=serialNumber, sensorName=sensorName, trapTempHighAlarm=trapTempHighAlarm, histTemp=histTemp, trapHumHighAlarm=trapHumHighAlarm, DisplayString=DisplayString, tempMax=tempMax, humLowInt=humLowInt, compValLowInt=compValLowInt, humMin=humMin, tempUnit=tempUnit, compValHighInt=compValHighInt, humHighInt=humHighInt, trapEmailErrAuth=trapEmailErrAuth, temp=temp, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, tables=tables, tempHighInt=tempHighInt, trapNTPError=trapNTPError, compValAlarmInt=compValAlarmInt, trapTempClrAlarm=trapTempClrAlarm, values=values, compValMax=compValMax, compValMin=compValMin, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, trapCompValClrAlarm=trapCompValClrAlarm, humDelayInt=humDelayInt, settings=settings, tempLowInt=tempLowInt, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarm=tempAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, compValInt=compValInt, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrDNS=trapEmailErrDNS, compValUnit=compValUnit, traps=traps, compValDelayInt=compValDelayInt, trapTest=trapTest, trapTempLowAlarm=trapTempLowAlarm, tempHystInt=tempHystInt, trapCompValLowAlarm=trapCompValLowAlarm, histCompVal=histCompVal, pysmi_global=pysmi_global, valuesInt=valuesInt, humUnit=humUnit, deviceType=deviceType, trapCompValError=trapCompValError, products=products, messageString=messageString, humMax=humMax, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, historyTable=historyTable, t3610=t3610, hum=hum, compVal=compVal, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, comet=comet, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, humAlarmInt=humAlarmInt, histHum=histHum, trapHumError=trapHumError, trapEmailErrLogin=trapEmailErrLogin, tempDelayInt=tempDelayInt, compValHystInt=compValHystInt, tempInt=tempInt, humInt=humInt)
