...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:30:29 2021
...
Counter32, IpAddress, TimeTicks, ObjectIdentity, MibIdentifier, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, NotificationType, Counter64, Bits, Integer32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "TimeTicks", "ObjectIdentity", "MibIdentifier", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "NotificationType", "Counter64", "Bits", "Integer32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarm=tempAlarm, sensorName=sensorName, compValAlarm=compValAlarm, humLowInt=humLowInt, humMax=humMax, tables=tables, histCompVal=histCompVal, trapHumLowAlarm=trapHumLowAlarm, humInt=humInt, trapCompValLowAlarm=trapCompValLowAlarm, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, pysmi_global=pysmi_global, trapEmailErrDNS=trapEmailErrDNS, historyTable=historyTable, trapTempHighAlarm=trapTempHighAlarm, messageString=messageString, trapEmailErrSome=trapEmailErrSome, humAlarm=humAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tempUnit=tempUnit, humHighInt=humHighInt, compValDelayInt=compValDelayInt, t3610=t3610, trapCompValHighAlarm=trapCompValHighAlarm, compVal=compVal, compValHighInt=compValHighInt, tempHystInt=tempHystInt, trapEmailErrSocket=trapEmailErrSocket, historyEntry=historyEntry, trapTempLowAlarm=trapTempLowAlarm, temp=temp, trapSOAPErrDNS=trapSOAPErrDNS, settings=settings, compValMin=compValMin, histTemp=histTemp, histHum=histHum, trapEmailErrLogin=trapEmailErrLogin, humAlarmInt=humAlarmInt, deviceType=deviceType, humUnit=humUnit, tempDelayInt=tempDelayInt, trapEmailErrAuth=trapEmailErrAuth, humMin=humMin, trapSOAPErrDelivery=trapSOAPErrDelivery, compValLowInt=compValLowInt, tempInt=tempInt, compValMax=compValMax, serialNumber=serialNumber, products=products, compValHystInt=compValHystInt, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarmInt=compValAlarmInt, trapSOAPErrFile=trapSOAPErrFile, traps=traps, trapTempClrAlarm=trapTempClrAlarm, hum=hum, humHystInt=humHystInt, trapHumError=trapHumError, tempMax=tempMax, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, values=values, valuesInt=valuesInt, trapCompValError=trapCompValError, trapTest=trapTest, comet=comet, trapNTPError=trapNTPError, DisplayString=DisplayString, tempLowInt=tempLowInt, humDelayInt=humDelayInt, tempAlarmInt=tempAlarmInt, tempMin=tempMin, tempHighInt=tempHighInt, compValInt=compValInt)
