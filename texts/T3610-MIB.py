...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:48:43 2022
...
IpAddress, Unsigned32, Integer32, Gauge32, ModuleIdentity, iso, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Counter64, MibIdentifier, ObjectIdentity, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Integer32", "Gauge32", "ModuleIdentity", "iso", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Counter64", "MibIdentifier", "ObjectIdentity", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValMax=compValMax, trapHumLowAlarm=trapHumLowAlarm, humMin=humMin, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, settings=settings, tempAlarmInt=tempAlarmInt, compValUnit=compValUnit, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, traps=traps, compValLowInt=compValLowInt, valuesInt=valuesInt, histHum=histHum, trapTest=trapTest, humLowInt=humLowInt, humHighInt=humHighInt, humInt=humInt, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, trapTempError=trapTempError, DisplayString=DisplayString, compValDelayInt=compValDelayInt, tempMax=tempMax, trapEmailErrLogin=trapEmailErrLogin, humMax=humMax, comet=comet, tempUnit=tempUnit, trapHumHighAlarm=trapHumHighAlarm, tempInt=tempInt, products=products, trapTempLowAlarm=trapTempLowAlarm, humAlarm=humAlarm, serialNumber=serialNumber, messageString=messageString, histCompVal=histCompVal, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, trapEmailErrAuth=trapEmailErrAuth, trapHumError=trapHumError, trapTempHighAlarm=trapTempHighAlarm, pysmi_global=pysmi_global, tempLowInt=tempLowInt, trapSOAPErrDNS=trapSOAPErrDNS, histTemp=histTemp, compVal=compVal, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, hum=hum, trapCompValError=trapCompValError, humHystInt=humHystInt, sensorName=sensorName, temp=temp, humUnit=humUnit, humDelayInt=humDelayInt, tempMin=tempMin, trapNTPError=trapNTPError, values=values, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, compValInt=compValInt, compValMin=compValMin, compValHighInt=compValHighInt, historyEntry=historyEntry, compValAlarm=compValAlarm, t3610=t3610, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, compValHystInt=compValHystInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery)
