...
# Produced by pysmi-1.1.8 at Mon Jan  9 09:48:24 2023
...
ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, TimeTicks, NotificationType, Bits, Integer32, Gauge32, IpAddress, Counter32, NotificationType, Unsigned32, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "TimeTicks", "NotificationType", "Bits", "Integer32", "Gauge32", "IpAddress", "Counter32", "NotificationType", "Unsigned32", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", pysmi_global=pysmi_global, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, histTemp=histTemp, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHighInt=compValHighInt, compValHystInt=compValHystInt, humInt=humInt, trapHumLowAlarm=trapHumLowAlarm, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, humMin=humMin, trapEmailErrLogin=trapEmailErrLogin, compValDelayInt=compValDelayInt, tables=tables, serialNumber=serialNumber, trapHumError=trapHumError, compVal=compVal, compValAlarm=compValAlarm, humAlarmInt=humAlarmInt, trapEmailErrSome=trapEmailErrSome, values=values, compValUnit=compValUnit, tempLowInt=tempLowInt, tempAlarmInt=tempAlarmInt, messageString=messageString, histHum=histHum, trapCompValHighAlarm=trapCompValHighAlarm, trapTempClrAlarm=trapTempClrAlarm, compValMin=compValMin, humAlarm=humAlarm, humHighInt=humHighInt, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, compValLowInt=compValLowInt, temp=temp, trapNTPError=trapNTPError, tempInt=tempInt, traps=traps, DisplayString=DisplayString, products=products, tempUnit=tempUnit, tempMin=tempMin, sensorName=sensorName, deviceType=deviceType, trapHumHighAlarm=trapHumHighAlarm, settings=settings, humUnit=humUnit, compValInt=compValInt, hum=hum, t3610=t3610, valuesInt=valuesInt, humDelayInt=humDelayInt, trapCompValError=trapCompValError, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarm=tempAlarm, tempMax=tempMax, compValMax=compValMax, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, trapHumClrAlarm=trapHumClrAlarm, tempDelayInt=tempDelayInt, histCompVal=histCompVal, compValAlarmInt=compValAlarmInt, trapTest=trapTest, trapCompValLowAlarm=trapCompValLowAlarm, comet=comet, humMax=humMax, tempHighInt=tempHighInt, trapEmailErrAuth=trapEmailErrAuth, tempHystInt=tempHystInt, humLowInt=humLowInt)
