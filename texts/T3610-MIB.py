...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:05:01 2023
...
NotificationType, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Unsigned32, Integer32, iso, IpAddress, Counter64, Counter32, ModuleIdentity, enterprises, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Unsigned32", "Integer32", "iso", "IpAddress", "Counter64", "Counter32", "ModuleIdentity", "enterprises", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, trapEmailErrDNS=trapEmailErrDNS, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, humHystInt=humHystInt, compValAlarm=compValAlarm, trapTempClrAlarm=trapTempClrAlarm, compValHystInt=compValHystInt, compVal=compVal, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, trapHumHighAlarm=trapHumHighAlarm, humUnit=humUnit, trapEmailErrSome=trapEmailErrSome, trapTest=trapTest, tempLowInt=tempLowInt, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, tempMin=tempMin, comet=comet, tempMax=tempMax, historyEntry=historyEntry, tempUnit=tempUnit, humAlarm=humAlarm, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, humMax=humMax, messageString=messageString, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValError=trapCompValError, compValMax=compValMax, compValDelayInt=compValDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, pysmi_global=pysmi_global, trapCompValLowAlarm=trapCompValLowAlarm, histHum=histHum, deviceType=deviceType, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, hum=hum, settings=settings, trapTempError=trapTempError, humMin=humMin, tempInt=tempInt, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, trapHumError=trapHumError, products=products, humDelayInt=humDelayInt, histTemp=histTemp, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, valuesInt=valuesInt, compValUnit=compValUnit, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, trapEmailErrSocket=trapEmailErrSocket, traps=traps, humLowInt=humLowInt, temp=temp, compValInt=compValInt, trapSOAPErrSocket=trapSOAPErrSocket, compValLowInt=compValLowInt, values=values, DisplayString=DisplayString, tables=tables, tempHystInt=tempHystInt, humHighInt=humHighInt, tempAlarm=tempAlarm)
