...
iso, enterprises, MibIdentifier, NotificationType, ModuleIdentity, Integer32, Unsigned32, TimeTicks, Bits, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "MibIdentifier", "NotificationType", "ModuleIdentity", "Integer32", "Unsigned32", "TimeTicks", "Bits", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, histTemp=histTemp, compValAlarm=compValAlarm, compValUnit=compValUnit, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, trapEmailErrAuth=trapEmailErrAuth, humLowInt=humLowInt, humHighInt=humHighInt, tempHystInt=tempHystInt, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSome=trapEmailErrSome, humUnit=humUnit, traps=traps, trapHumLowAlarm=trapHumLowAlarm, compValMin=compValMin, messageString=messageString, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, tempUnit=tempUnit, trapCompValLowAlarm=trapCompValLowAlarm, products=products, compVal=compVal, humMin=humMin, tempAlarm=tempAlarm, compValMax=compValMax, comet=comet, humMax=humMax, tempInt=tempInt, temp=temp, histHum=histHum, trapCompValHighAlarm=trapCompValHighAlarm, values=values, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, tempMax=tempMax, tempMin=tempMin, deviceType=deviceType, settings=settings, trapSOAPErrSocket=trapSOAPErrSocket, hum=hum, compValLowInt=compValLowInt, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, compValHystInt=compValHystInt, historyTable=historyTable, tempLowInt=tempLowInt, humInt=humInt, humDelayInt=humDelayInt, compValHighInt=compValHighInt, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, pysmi_global=pysmi_global, compValInt=compValInt, trapTempHighAlarm=trapTempHighAlarm, sensorName=sensorName, t3610=t3610, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, trapCompValError=trapCompValError, serialNumber=serialNumber, humAlarmInt=humAlarmInt, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, tempHighInt=tempHighInt, tables=tables)
