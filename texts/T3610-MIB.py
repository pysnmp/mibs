...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:19:00 2024
...
Integer32, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, ObjectIdentity, iso, enterprises, IpAddress, Bits, NotificationType, NotificationType, ModuleIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "ObjectIdentity", "iso", "enterprises", "IpAddress", "Bits", "NotificationType", "NotificationType", "ModuleIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarm=compValAlarm, valuesInt=valuesInt, sensorName=sensorName, tempAlarm=tempAlarm, humAlarm=humAlarm, compValMin=compValMin, traps=traps, tempMax=tempMax, tempLowInt=tempLowInt, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, trapHumError=trapHumError, trapCompValClrAlarm=trapCompValClrAlarm, humMin=humMin, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, trapTempLowAlarm=trapTempLowAlarm, tempUnit=tempUnit, t3610=t3610, humMax=humMax, DisplayString=DisplayString, compValUnit=compValUnit, compValMax=compValMax, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, historyTable=historyTable, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, humLowInt=humLowInt, trapTempClrAlarm=trapTempClrAlarm, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, compValHighInt=compValHighInt, trapEmailErrAuth=trapEmailErrAuth, tempHystInt=tempHystInt, trapEmailErrDNS=trapEmailErrDNS, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, pysmi_global=pysmi_global, settings=settings, compValDelayInt=compValDelayInt, humDelayInt=humDelayInt, histTemp=histTemp, compVal=compVal, hum=hum, humHighInt=humHighInt, humInt=humInt, tempDelayInt=tempDelayInt, tempInt=tempInt, trapEmailErrSome=trapEmailErrSome, humUnit=humUnit, values=values, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, tables=tables, temp=temp, humHystInt=humHystInt, tempMin=tempMin, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, humAlarmInt=humAlarmInt, messageString=messageString, products=products, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, deviceType=deviceType, comet=comet, trapTempError=trapTempError)
