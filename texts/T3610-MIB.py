...
# Produced by pysmi-1.1.8 at Fri Jul  8 07:35:07 2022
...
Counter32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Unsigned32, TimeTicks, Integer32, ModuleIdentity, enterprises, Counter64, ObjectIdentity, NotificationType, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Unsigned32", "TimeTicks", "Integer32", "ModuleIdentity", "enterprises", "Counter64", "ObjectIdentity", "NotificationType", "Gauge32", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, values=values, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValError=trapCompValError, historyEntry=historyEntry, trapSOAPErrFile=trapSOAPErrFile, trapTest=trapTest, tempMax=tempMax, tempDelayInt=tempDelayInt, t3610=t3610, temp=temp, humDelayInt=humDelayInt, histTemp=histTemp, humAlarm=humAlarm, histCompVal=histCompVal, deviceType=deviceType, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, trapHumClrAlarm=trapHumClrAlarm, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, tempAlarm=tempAlarm, tempHystInt=tempHystInt, DisplayString=DisplayString, compValAlarmInt=compValAlarmInt, compValInt=compValInt, pysmi_global=pysmi_global, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, humHystInt=humHystInt, trapNTPError=trapNTPError, compValMax=compValMax, trapCompValClrAlarm=trapCompValClrAlarm, humMin=humMin, compVal=compVal, compValUnit=compValUnit, humUnit=humUnit, compValMin=compValMin, valuesInt=valuesInt, humAlarmInt=humAlarmInt, settings=settings, products=products, traps=traps, trapCompValLowAlarm=trapCompValLowAlarm, trapTempClrAlarm=trapTempClrAlarm, hum=hum, tempUnit=tempUnit, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, tables=tables, sensorName=sensorName, humLowInt=humLowInt, compValHighInt=compValHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHystInt=compValHystInt, trapEmailErrAuth=trapEmailErrAuth, trapTempError=trapTempError, humMax=humMax, comet=comet, trapHumError=trapHumError, serialNumber=serialNumber, messageString=messageString, histHum=histHum, trapCompValHighAlarm=trapCompValHighAlarm, compValAlarm=compValAlarm, tempHighInt=tempHighInt, tempInt=tempInt, humInt=humInt, trapSOAPErrSocket=trapSOAPErrSocket)
