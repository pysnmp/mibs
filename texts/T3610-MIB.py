...
NotificationType, Integer32, Unsigned32, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, IpAddress, TimeTicks, ModuleIdentity, Bits, ObjectIdentity, enterprises, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Unsigned32", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "IpAddress", "TimeTicks", "ModuleIdentity", "Bits", "ObjectIdentity", "enterprises", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, compValMin=compValMin, pysmi_global=pysmi_global, trapHumClrAlarm=trapHumClrAlarm, valuesInt=valuesInt, tempAlarm=tempAlarm, trapTempClrAlarm=trapTempClrAlarm, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, compValHighInt=compValHighInt, humAlarm=humAlarm, compValAlarm=compValAlarm, humMax=humMax, humHystInt=humHystInt, values=values, tempUnit=tempUnit, trapEmailErrSocket=trapEmailErrSocket, compValInt=compValInt, compValUnit=compValUnit, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapNTPError=trapNTPError, tempHystInt=tempHystInt, trapCompValError=trapCompValError, messageString=messageString, t3610=t3610, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, settings=settings, historyTable=historyTable, trapTempError=trapTempError, tempInt=tempInt, compValDelayInt=compValDelayInt, tables=tables, compValMax=compValMax, deviceType=deviceType, temp=temp, compValLowInt=compValLowInt, tempDelayInt=tempDelayInt, trapEmailErrLogin=trapEmailErrLogin, tempHighInt=tempHighInt, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, trapHumError=trapHumError, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, hum=hum, serialNumber=serialNumber, trapCompValHighAlarm=trapCompValHighAlarm, compValAlarmInt=compValAlarmInt, humDelayInt=humDelayInt, humMin=humMin, trapHumLowAlarm=trapHumLowAlarm, humLowInt=humLowInt, historyEntry=historyEntry, tempMax=tempMax, histHum=histHum, humAlarmInt=humAlarmInt, humInt=humInt, compValHystInt=compValHystInt, trapTempHighAlarm=trapTempHighAlarm, products=products, histTemp=histTemp, tempLowInt=tempLowInt, comet=comet, traps=traps, humUnit=humUnit, trapSOAPErrFile=trapSOAPErrFile, compVal=compVal, histCompVal=histCompVal, tempAlarmInt=tempAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin)
