...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:06:56 2023
...
NotificationType, ModuleIdentity, Counter64, Unsigned32, NotificationType, Counter32, ObjectIdentity, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Bits, IpAddress, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Counter64", "Unsigned32", "NotificationType", "Counter32", "ObjectIdentity", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Bits", "IpAddress", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", messageString=messageString, valuesInt=valuesInt, hum=hum, trapSOAPErrFile=trapSOAPErrFile, tempHystInt=tempHystInt, trapSOAPErrSocket=trapSOAPErrSocket, serialNumber=serialNumber, deviceType=deviceType, humUnit=humUnit, trapTempLowAlarm=trapTempLowAlarm, tempMax=tempMax, humMin=humMin, compValHighInt=compValHighInt, humHystInt=humHystInt, compValAlarm=compValAlarm, historyTable=historyTable, pysmi_global=pysmi_global, humAlarmInt=humAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, compValHystInt=compValHystInt, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, humDelayInt=humDelayInt, trapHumError=trapHumError, humInt=humInt, compVal=compVal, compValDelayInt=compValDelayInt, trapEmailErrSocket=trapEmailErrSocket, compValAlarmInt=compValAlarmInt, trapEmailErrDNS=trapEmailErrDNS, tempUnit=tempUnit, trapTempClrAlarm=trapTempClrAlarm, t3610=t3610, trapEmailErrAuth=trapEmailErrAuth, trapNTPError=trapNTPError, tempLowInt=tempLowInt, values=values, tempHighInt=tempHighInt, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, humHighInt=humHighInt, comet=comet, trapHumLowAlarm=trapHumLowAlarm, historyEntry=historyEntry, compValMin=compValMin, compValUnit=compValUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, humLowInt=humLowInt, trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, tables=tables, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, settings=settings, tempMin=tempMin, sensorName=sensorName, compValInt=compValInt, products=products, trapTest=trapTest, trapCompValError=trapCompValError, temp=temp, compValMax=compValMax, DisplayString=DisplayString, humMax=humMax, histHum=histHum, traps=traps, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, tempInt=tempInt, trapTempHighAlarm=trapTempHighAlarm, humAlarm=humAlarm, tempAlarm=tempAlarm)
