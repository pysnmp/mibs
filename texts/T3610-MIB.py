...
Bits, Integer32, Counter64, Unsigned32, iso, NotificationType, MibIdentifier, ModuleIdentity, TimeTicks, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "Counter64", "Unsigned32", "iso", "NotificationType", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrFile=trapSOAPErrFile, tempMax=tempMax, tempLowInt=tempLowInt, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, valuesInt=valuesInt, hum=hum, comet=comet, tables=tables, compValAlarm=compValAlarm, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, histHum=histHum, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, humMax=humMax, historyTable=historyTable, humAlarmInt=humAlarmInt, humHystInt=humHystInt, deviceType=deviceType, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, trapNTPError=trapNTPError, temp=temp, compVal=compVal, DisplayString=DisplayString, compValInt=compValInt, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, pysmi_global=pysmi_global, compValMax=compValMax, trapCompValClrAlarm=trapCompValClrAlarm, tempUnit=tempUnit, products=products, messageString=messageString, trapTempError=trapTempError, serialNumber=serialNumber, traps=traps, humHighInt=humHighInt, trapHumClrAlarm=trapHumClrAlarm, settings=settings, tempHystInt=tempHystInt, humMin=humMin, trapEmailErrSome=trapEmailErrSome, trapCompValLowAlarm=trapCompValLowAlarm, compValMin=compValMin, compValHighInt=compValHighInt, values=values, compValLowInt=compValLowInt, trapHumError=trapHumError, compValDelayInt=compValDelayInt, humInt=humInt, trapTempLowAlarm=trapTempLowAlarm, tempAlarmInt=tempAlarmInt, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarmInt=compValAlarmInt, trapCompValError=trapCompValError, tempHighInt=tempHighInt, humAlarm=humAlarm, humDelayInt=humDelayInt, humLowInt=humLowInt, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, compValUnit=compValUnit, tempInt=tempInt, trapTest=trapTest, t3610=t3610)
