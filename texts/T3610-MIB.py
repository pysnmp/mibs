...
ModuleIdentity, iso, enterprises, NotificationType, Bits, Gauge32, Counter64, Integer32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, TimeTicks, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "enterprises", "NotificationType", "Bits", "Gauge32", "Counter64", "Integer32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "TimeTicks", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", compValMin=compValMin, deviceType=deviceType, tables=tables, values=values, trapTempError=trapTempError, tempUnit=tempUnit, trapTest=trapTest, humUnit=humUnit, tempInt=tempInt, compValInt=compValInt, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, trapCompValHighAlarm=trapCompValHighAlarm, trapHumHighAlarm=trapHumHighAlarm, tempHighInt=tempHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValError=trapCompValError, messageString=messageString, hum=hum, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrAuth=trapEmailErrAuth, compValLowInt=compValLowInt, traps=traps, compValHighInt=compValHighInt, trapEmailErrSocket=trapEmailErrSocket, tempAlarmInt=tempAlarmInt, trapTempLowAlarm=trapTempLowAlarm, tempMin=tempMin, products=products, histHum=histHum, humMax=humMax, valuesInt=valuesInt, humDelayInt=humDelayInt, temp=temp, compValAlarm=compValAlarm, tempMax=tempMax, humMin=humMin, humInt=humInt, t3610=t3610, settings=settings, tempAlarm=tempAlarm, compValHystInt=compValHystInt, trapCompValLowAlarm=trapCompValLowAlarm, compValAlarmInt=compValAlarmInt, tempDelayInt=tempDelayInt, DisplayString=DisplayString, pysmi_global=pysmi_global, sensorName=sensorName, trapHumError=trapHumError, tempLowInt=tempLowInt, compValMax=compValMax, tempHystInt=tempHystInt, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, trapHumLowAlarm=trapHumLowAlarm, trapNTPError=trapNTPError, comet=comet, compValDelayInt=compValDelayInt, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, humAlarmInt=humAlarmInt, humHystInt=humHystInt, humAlarm=humAlarm, humLowInt=humLowInt, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, compVal=compVal, serialNumber=serialNumber, compValUnit=compValUnit, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, humHighInt=humHighInt)
