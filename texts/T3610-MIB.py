...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:57:51 2023
...
NotificationType, TimeTicks, ModuleIdentity, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Counter64, iso, Counter32, Unsigned32, MibIdentifier, enterprises, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "ModuleIdentity", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Counter64", "iso", "Counter32", "Unsigned32", "MibIdentifier", "enterprises", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrSocket=trapSOAPErrSocket, tempLowInt=tempLowInt, compValHystInt=compValHystInt, trapHumLowAlarm=trapHumLowAlarm, historyTable=historyTable, compValAlarmInt=compValAlarmInt, trapNTPError=trapNTPError, tempMin=tempMin, tempMax=tempMax, hum=hum, histHum=histHum, compValMax=compValMax, humAlarm=humAlarm, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, comet=comet, t3610=t3610, histCompVal=histCompVal, products=products, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp, humAlarmInt=humAlarmInt, pysmi_global=pysmi_global, compValAlarm=compValAlarm, compValDelayInt=compValDelayInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, deviceType=deviceType, compValLowInt=compValLowInt, humDelayInt=humDelayInt, trapEmailErrSome=trapEmailErrSome, serialNumber=serialNumber, compValMin=compValMin, tempHystInt=tempHystInt, trapHumError=trapHumError, DisplayString=DisplayString, settings=settings, humMax=humMax, messageString=messageString, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, tempInt=tempInt, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, historyEntry=historyEntry, trapEmailErrDNS=trapEmailErrDNS, humMin=humMin, compVal=compVal, humInt=humInt, humUnit=humUnit, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, trapCompValError=trapCompValError, valuesInt=valuesInt, sensorName=sensorName, traps=traps, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, humHighInt=humHighInt, tables=tables, tempUnit=tempUnit, trapTempClrAlarm=trapTempClrAlarm, tempHighInt=tempHighInt, trapTempHighAlarm=trapTempHighAlarm, compValInt=compValInt, values=values, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHighInt=compValHighInt, tempDelayInt=tempDelayInt, trapTempError=trapTempError, tempAlarm=tempAlarm, trapHumClrAlarm=trapHumClrAlarm, humLowInt=humLowInt)
