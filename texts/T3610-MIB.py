...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Counter64, IpAddress, NotificationType, TimeTicks, iso, Bits, Unsigned32, ModuleIdentity, Gauge32, ObjectIdentity, MibIdentifier, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Counter64", "IpAddress", "NotificationType", "TimeTicks", "iso", "Bits", "Unsigned32", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", compValMax=compValMax, compValDelayInt=compValDelayInt, tempHighInt=tempHighInt, trapTest=trapTest, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, trapTempLowAlarm=trapTempLowAlarm, trapTempClrAlarm=trapTempClrAlarm, settings=settings, humHystInt=humHystInt, historyTable=historyTable, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, compVal=compVal, sensorName=sensorName, histTemp=histTemp, valuesInt=valuesInt, compValMin=compValMin, pysmi_global=pysmi_global, t3610=t3610, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, traps=traps, comet=comet, tempUnit=tempUnit, humInt=humInt, histHum=histHum, compValAlarm=compValAlarm, humDelayInt=humDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, trapEmailErrSocket=trapEmailErrSocket, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, humHighInt=humHighInt, products=products, trapCompValError=trapCompValError, deviceType=deviceType, humUnit=humUnit, compValAlarmInt=compValAlarmInt, humMax=humMax, tempMin=tempMin, compValHighInt=compValHighInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, tempAlarm=tempAlarm, messageString=messageString, humAlarmInt=humAlarmInt, compValHystInt=compValHystInt, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, humLowInt=humLowInt, compValInt=compValInt, compValUnit=compValUnit, values=values, trapNTPError=trapNTPError, temp=temp, trapSOAPErrFile=trapSOAPErrFile, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrLogin=trapEmailErrLogin, compValLowInt=compValLowInt, serialNumber=serialNumber, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, trapTempError=trapTempError, trapTempHighAlarm=trapTempHighAlarm, tempInt=tempInt, tempDelayInt=tempDelayInt, hum=hum, trapSOAPErrDelivery=trapSOAPErrDelivery, tables=tables, humMin=humMin)
