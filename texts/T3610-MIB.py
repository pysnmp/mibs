...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:05:56 2024
...
ModuleIdentity, MibIdentifier, iso, Counter32, Gauge32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, IpAddress, Counter64, Integer32, Bits, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "iso", "Counter32", "Gauge32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "IpAddress", "Counter64", "Integer32", "Bits", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, trapSOAPErrFile=trapSOAPErrFile, pysmi_global=pysmi_global, temp=temp, histTemp=histTemp, tempLowInt=tempLowInt, trapHumClrAlarm=trapHumClrAlarm, trapTempLowAlarm=trapTempLowAlarm, humMin=humMin, compValAlarm=compValAlarm, trapNTPError=trapNTPError, trapEmailErrAuth=trapEmailErrAuth, trapHumError=trapHumError, tempMin=tempMin, values=values, humHystInt=humHystInt, trapCompValHighAlarm=trapCompValHighAlarm, traps=traps, trapCompValError=trapCompValError, compValInt=compValInt, histCompVal=histCompVal, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, DisplayString=DisplayString, historyTable=historyTable, trapSOAPErrDelivery=trapSOAPErrDelivery, messageString=messageString, trapTempHighAlarm=trapTempHighAlarm, compValHighInt=compValHighInt, humInt=humInt, compValHystInt=compValHystInt, humMax=humMax, histHum=histHum, comet=comet, trapSOAPErrDNS=trapSOAPErrDNS, sensorName=sensorName, valuesInt=valuesInt, compValMin=compValMin, deviceType=deviceType, compValMax=compValMax, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, humHighInt=humHighInt, serialNumber=serialNumber, compValUnit=compValUnit, t3610=t3610, compValAlarmInt=compValAlarmInt, tempMax=tempMax, hum=hum, trapEmailErrSome=trapEmailErrSome, tempHighInt=tempHighInt, products=products, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, tables=tables, trapEmailErrDNS=trapEmailErrDNS, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, humLowInt=humLowInt, tempUnit=tempUnit, tempDelayInt=tempDelayInt, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, compVal=compVal, humAlarm=humAlarm, trapTest=trapTest, compValLowInt=compValLowInt, tempAlarm=tempAlarm, settings=settings, tempHystInt=tempHystInt, tempInt=tempInt)
