...
Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, iso, IpAddress, Bits, MibIdentifier, ModuleIdentity, Unsigned32, NotificationType, Gauge32, Counter64, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "iso", "IpAddress", "Bits", "MibIdentifier", "ModuleIdentity", "Unsigned32", "NotificationType", "Gauge32", "Counter64", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", pysmi_global=pysmi_global, humAlarm=humAlarm, tempMax=tempMax, tempAlarm=tempAlarm, humMax=humMax, humMin=humMin, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, historyTable=historyTable, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, comet=comet, tempUnit=tempUnit, compValMin=compValMin, trapTempLowAlarm=trapTempLowAlarm, trapHumError=trapHumError, hum=hum, trapNTPError=trapNTPError, trapCompValError=trapCompValError, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, humDelayInt=humDelayInt, trapEmailErrSocket=trapEmailErrSocket, compVal=compVal, trapCompValClrAlarm=trapCompValClrAlarm, humInt=humInt, tables=tables, compValUnit=compValUnit, humHighInt=humHighInt, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, values=values, humHystInt=humHystInt, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName, trapHumClrAlarm=trapHumClrAlarm, humAlarmInt=humAlarmInt, compValHystInt=compValHystInt, trapEmailErrDNS=trapEmailErrDNS, compValAlarmInt=compValAlarmInt, trapTempHighAlarm=trapTempHighAlarm, trapTempError=trapTempError, deviceType=deviceType, histHum=histHum, settings=settings, tempMin=tempMin, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, humUnit=humUnit, compValMax=compValMax, temp=temp, traps=traps, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, serialNumber=serialNumber, tempHighInt=tempHighInt, t3610=t3610, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, products=products, trapEmailErrLogin=trapEmailErrLogin, histTemp=histTemp, tempInt=tempInt, DisplayString=DisplayString, compValLowInt=compValLowInt, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, tempLowInt=tempLowInt, tempHystInt=tempHystInt, tempDelayInt=tempDelayInt, valuesInt=valuesInt)
