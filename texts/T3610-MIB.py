...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:01:56 2023
...
enterprises, Unsigned32, NotificationType, IpAddress, MibIdentifier, TimeTicks, iso, Counter64, ObjectIdentity, Counter32, Gauge32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "NotificationType", "IpAddress", "MibIdentifier", "TimeTicks", "iso", "Counter64", "ObjectIdentity", "Counter32", "Gauge32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", temp=temp, compVal=compVal, tempAlarm=tempAlarm, historyTable=historyTable, histCompVal=histCompVal, tempAlarmInt=tempAlarmInt, trapHumLowAlarm=trapHumLowAlarm, products=products, values=values, trapTempClrAlarm=trapTempClrAlarm, DisplayString=DisplayString, humAlarmInt=humAlarmInt, trapEmailErrAuth=trapEmailErrAuth, trapHumHighAlarm=trapHumHighAlarm, traps=traps, tempMax=tempMax, humLowInt=humLowInt, messageString=messageString, compValMin=compValMin, deviceType=deviceType, tempDelayInt=tempDelayInt, tempLowInt=tempLowInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, humMax=humMax, trapEmailErrDNS=trapEmailErrDNS, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, sensorName=sensorName, compValHighInt=compValHighInt, compValMax=compValMax, comet=comet, tempHystInt=tempHystInt, histHum=histHum, tempMin=tempMin, humInt=humInt, trapNTPError=trapNTPError, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, trapCompValError=trapCompValError, tempUnit=tempUnit, humAlarm=humAlarm, humHighInt=humHighInt, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, tempInt=tempInt, historyEntry=historyEntry, tables=tables, compValAlarm=compValAlarm, humMin=humMin, compValAlarmInt=compValAlarmInt, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, settings=settings, trapSOAPErrSocket=trapSOAPErrSocket, histTemp=histTemp, humDelayInt=humDelayInt, hum=hum, trapHumError=trapHumError, pysmi_global=pysmi_global, compValUnit=compValUnit, t3610=t3610, compValHystInt=compValHystInt, humUnit=humUnit, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, compValInt=compValInt, humHystInt=humHystInt, compValLowInt=compValLowInt)
