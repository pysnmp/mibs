...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:38:09 2023
...
Bits, Unsigned32, NotificationType, Counter64, NotificationType, ObjectIdentity, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, IpAddress, ModuleIdentity, TimeTicks, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "NotificationType", "Counter64", "NotificationType", "ObjectIdentity", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "IpAddress", "ModuleIdentity", "TimeTicks", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", pysmi_global=pysmi_global, serialNumber=serialNumber, compVal=compVal, tempDelayInt=tempDelayInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSocket=trapEmailErrSocket, humAlarmInt=humAlarmInt, trapSOAPErrFile=trapSOAPErrFile, sensorName=sensorName, compValHighInt=compValHighInt, comet=comet, compValDelayInt=compValDelayInt, histCompVal=histCompVal, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, trapTempError=trapTempError, traps=traps, historyTable=historyTable, compValAlarm=compValAlarm, compValUnit=compValUnit, t3610=t3610, tempMin=tempMin, tempInt=tempInt, compValAlarmInt=compValAlarmInt, DisplayString=DisplayString, trapNTPError=trapNTPError, histHum=histHum, trapEmailErrSome=trapEmailErrSome, products=products, tempMax=tempMax, humHighInt=humHighInt, tempAlarmInt=tempAlarmInt, compValLowInt=compValLowInt, humUnit=humUnit, hum=hum, trapCompValError=trapCompValError, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, compValMin=compValMin, settings=settings, trapTempLowAlarm=trapTempLowAlarm, humDelayInt=humDelayInt, tempHystInt=tempHystInt, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, tables=tables, histTemp=histTemp, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrLogin=trapEmailErrLogin, messageString=messageString, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumClrAlarm=trapHumClrAlarm, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, tempUnit=tempUnit, tempLowInt=tempLowInt, humMax=humMax, deviceType=deviceType, trapTest=trapTest, trapCompValLowAlarm=trapCompValLowAlarm, compValInt=compValInt, compValHystInt=compValHystInt, valuesInt=valuesInt, temp=temp, tempAlarm=tempAlarm, humHystInt=humHystInt, historyEntry=historyEntry, humMin=humMin, values=values, trapSOAPErrDNS=trapSOAPErrDNS, trapHumError=trapHumError, tempHighInt=tempHighInt, humAlarm=humAlarm, trapSOAPErrSocket=trapSOAPErrSocket, humInt=humInt)
