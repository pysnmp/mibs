...
# Produced by pysmi-1.1.8 at Thu Sep 29 08:43:46 2022
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Unsigned32, iso, Gauge32, TimeTicks, Counter64, ObjectIdentity, IpAddress, NotificationType, Counter32, MibIdentifier, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Unsigned32", "iso", "Gauge32", "TimeTicks", "Counter64", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "MibIdentifier", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, sensorName=sensorName, compValHystInt=compValHystInt, settings=settings, tempHystInt=tempHystInt, trapEmailErrSocket=trapEmailErrSocket, humMin=humMin, compValUnit=compValUnit, humUnit=humUnit, tempLowInt=tempLowInt, tempMax=tempMax, trapSOAPErrDNS=trapSOAPErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, trapTempHighAlarm=trapTempHighAlarm, humAlarm=humAlarm, trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, compValHighInt=compValHighInt, histHum=histHum, tempDelayInt=tempDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrAuth=trapEmailErrAuth, compValAlarmInt=compValAlarmInt, histTemp=histTemp, DisplayString=DisplayString, histCompVal=histCompVal, temp=temp, compValDelayInt=compValDelayInt, compValMax=compValMax, humInt=humInt, compVal=compVal, tempHighInt=tempHighInt, compValLowInt=compValLowInt, humDelayInt=humDelayInt, humHystInt=humHystInt, messageString=messageString, trapNTPError=trapNTPError, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, traps=traps, trapHumClrAlarm=trapHumClrAlarm, t3610=t3610, humLowInt=humLowInt, compValMin=compValMin, hum=hum, comet=comet, trapCompValLowAlarm=trapCompValLowAlarm, values=values, tempInt=tempInt, pysmi_global=pysmi_global, tempUnit=tempUnit, deviceType=deviceType, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValError=trapCompValError, trapCompValHighAlarm=trapCompValHighAlarm, humAlarmInt=humAlarmInt, serialNumber=serialNumber, compValAlarm=compValAlarm, historyEntry=historyEntry, humMax=humMax, products=products, trapTest=trapTest, historyTable=historyTable, tempMin=tempMin, tempAlarm=tempAlarm, humHighInt=humHighInt, tables=tables)
