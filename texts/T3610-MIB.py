...
# Produced by pysmi-1.1.12 at Tue Jun  4 11:43:49 2024
...
Counter32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, ObjectIdentity, Bits, TimeTicks, Gauge32, ModuleIdentity, enterprises, NotificationType, iso, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "ObjectIdentity", "Bits", "TimeTicks", "Gauge32", "ModuleIdentity", "enterprises", "NotificationType", "iso", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", compValMax=compValMax, sensorName=sensorName, tempUnit=tempUnit, deviceType=deviceType, tempInt=tempInt, compValHystInt=compValHystInt, trapTest=trapTest, trapSOAPErrDNS=trapSOAPErrDNS, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, values=values, humAlarmInt=humAlarmInt, humInt=humInt, humDelayInt=humDelayInt, compValAlarmInt=compValAlarmInt, humHystInt=humHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, trapNTPError=trapNTPError, comet=comet, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrFile=trapSOAPErrFile, trapTempHighAlarm=trapTempHighAlarm, histTemp=histTemp, products=products, trapEmailErrSome=trapEmailErrSome, messageString=messageString, tables=tables, compValUnit=compValUnit, hum=hum, compValHighInt=compValHighInt, tempLowInt=tempLowInt, compValAlarm=compValAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, historyTable=historyTable, trapTempError=trapTempError, compValInt=compValInt, trapEmailErrDNS=trapEmailErrDNS, traps=traps, temp=temp, tempAlarm=tempAlarm, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, humMax=humMax, DisplayString=DisplayString, tempMin=tempMin, humAlarm=humAlarm, histHum=histHum, trapEmailErrAuth=trapEmailErrAuth, compVal=compVal, compValLowInt=compValLowInt, trapTempClrAlarm=trapTempClrAlarm, pysmi_global=pysmi_global, serialNumber=serialNumber, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, humLowInt=humLowInt, tempHystInt=tempHystInt, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, valuesInt=valuesInt, settings=settings, humHighInt=humHighInt, compValDelayInt=compValDelayInt, histCompVal=histCompVal, trapCompValClrAlarm=trapCompValClrAlarm, humUnit=humUnit, trapCompValError=trapCompValError, t3610=t3610, humMin=humMin)
