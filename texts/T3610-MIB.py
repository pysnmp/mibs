...
MibIdentifier, enterprises, Bits, Counter32, NotificationType, NotificationType, Integer32, Gauge32, Unsigned32, IpAddress, ObjectIdentity, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "Bits", "Counter32", "NotificationType", "NotificationType", "Integer32", "Gauge32", "Unsigned32", "IpAddress", "ObjectIdentity", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, sensorName=sensorName, DisplayString=DisplayString, trapEmailErrSocket=trapEmailErrSocket, pysmi_global=pysmi_global, humUnit=humUnit, comet=comet, tempHystInt=tempHystInt, valuesInt=valuesInt, trapTempError=trapTempError, settings=settings, humAlarm=humAlarm, humMax=humMax, trapHumHighAlarm=trapHumHighAlarm, t3610=t3610, tempAlarm=tempAlarm, trapTest=trapTest, messageString=messageString, compValHighInt=compValHighInt, humHystInt=humHystInt, trapHumError=trapHumError, serialNumber=serialNumber, humMin=humMin, histCompVal=histCompVal, compValInt=compValInt, trapSOAPErrFile=trapSOAPErrFile, histHum=histHum, humHighInt=humHighInt, tempDelayInt=tempDelayInt, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, compValMax=compValMax, tempAlarmInt=tempAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValClrAlarm=trapCompValClrAlarm, trapTempHighAlarm=trapTempHighAlarm, compValHystInt=compValHystInt, humInt=humInt, compValLowInt=compValLowInt, trapEmailErrLogin=trapEmailErrLogin, tempInt=tempInt, tempUnit=tempUnit, trapCompValError=trapCompValError, trapHumLowAlarm=trapHumLowAlarm, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, compValAlarm=compValAlarm, humLowInt=humLowInt, compValAlarmInt=compValAlarmInt, trapTempClrAlarm=trapTempClrAlarm, deviceType=deviceType, trapTempLowAlarm=trapTempLowAlarm, trapHumClrAlarm=trapHumClrAlarm, historyEntry=historyEntry, products=products, trapEmailErrAuth=trapEmailErrAuth, compValDelayInt=compValDelayInt, tables=tables, trapEmailErrDNS=trapEmailErrDNS, values=values, tempLowInt=tempLowInt, traps=traps, compVal=compVal, compValMin=compValMin, compValUnit=compValUnit, humDelayInt=humDelayInt, temp=temp, tempHighInt=tempHighInt, historyTable=historyTable, humAlarmInt=humAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm)
