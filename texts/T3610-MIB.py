...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:51:04 2024
...
iso, enterprises, NotificationType, TimeTicks, Counter32, Counter64, NotificationType, IpAddress, MibIdentifier, ObjectIdentity, Gauge32, Integer32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "NotificationType", "TimeTicks", "Counter32", "Counter64", "NotificationType", "IpAddress", "MibIdentifier", "ObjectIdentity", "Gauge32", "Integer32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, compValMin=compValMin, compValHystInt=compValHystInt, tempAlarmInt=tempAlarmInt, deviceType=deviceType, values=values, trapEmailErrLogin=trapEmailErrLogin, humMax=humMax, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempMin=tempMin, humDelayInt=humDelayInt, trapNTPError=trapNTPError, tempHighInt=tempHighInt, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, comet=comet, compValAlarm=compValAlarm, compValInt=compValInt, DisplayString=DisplayString, compValAlarmInt=compValAlarmInt, trapTempLowAlarm=trapTempLowAlarm, trapEmailErrSome=trapEmailErrSome, messageString=messageString, hum=hum, humAlarmInt=humAlarmInt, compValLowInt=compValLowInt, tempInt=tempInt, histTemp=histTemp, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, serialNumber=serialNumber, compValDelayInt=compValDelayInt, compValUnit=compValUnit, humMin=humMin, pysmi_global=pysmi_global, humLowInt=humLowInt, histCompVal=histCompVal, trapHumLowAlarm=trapHumLowAlarm, tables=tables, compVal=compVal, trapEmailErrAuth=trapEmailErrAuth, compValMax=compValMax, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, t3610=t3610, trapSOAPErrFile=trapSOAPErrFile, tempAlarm=tempAlarm, tempLowInt=tempLowInt, humUnit=humUnit, traps=traps, compValHighInt=compValHighInt, settings=settings, tempDelayInt=tempDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, humInt=humInt, tempMax=tempMax, temp=temp, tempHystInt=tempHystInt, trapCompValClrAlarm=trapCompValClrAlarm, valuesInt=valuesInt, trapHumError=trapHumError, trapCompValError=trapCompValError, historyTable=historyTable, histHum=histHum, humHystInt=humHystInt, trapTempError=trapTempError, sensorName=sensorName, humHighInt=humHighInt, products=products, trapTest=trapTest)
