...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:52:56 2022
...
NotificationType, TimeTicks, IpAddress, Bits, Counter32, NotificationType, Gauge32, ModuleIdentity, Unsigned32, enterprises, Integer32, MibIdentifier, Counter64, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "IpAddress", "Bits", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "enterprises", "Integer32", "MibIdentifier", "Counter64", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, compValDelayInt=compValDelayInt, trapTempHighAlarm=trapTempHighAlarm, compValUnit=compValUnit, trapSOAPErrDNS=trapSOAPErrDNS, humDelayInt=humDelayInt, humUnit=humUnit, t3610=t3610, tempAlarmInt=tempAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrFile=trapSOAPErrFile, traps=traps, tempMax=tempMax, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, humMax=humMax, compValMin=compValMin, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, tempUnit=tempUnit, DisplayString=DisplayString, sensorName=sensorName, messageString=messageString, historyTable=historyTable, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, pysmi_global=pysmi_global, comet=comet, compVal=compVal, trapHumClrAlarm=trapHumClrAlarm, humAlarmInt=humAlarmInt, temp=temp, humAlarm=humAlarm, tempLowInt=tempLowInt, tempDelayInt=tempDelayInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, trapTempError=trapTempError, valuesInt=valuesInt, compValHystInt=compValHystInt, trapCompValHighAlarm=trapCompValHighAlarm, compValLowInt=compValLowInt, compValAlarmInt=compValAlarmInt, compValAlarm=compValAlarm, tempInt=tempInt, compValMax=compValMax, humLowInt=humLowInt, compValHighInt=compValHighInt, tempHighInt=tempHighInt, humHighInt=humHighInt, tables=tables, histTemp=histTemp, tempMin=tempMin, histCompVal=histCompVal, deviceType=deviceType, trapEmailErrSome=trapEmailErrSome, humInt=humInt, tempHystInt=tempHystInt, trapHumLowAlarm=trapHumLowAlarm, serialNumber=serialNumber, trapCompValError=trapCompValError, products=products, trapNTPError=trapNTPError, histHum=histHum, values=values, settings=settings, hum=hum, compValInt=compValInt, historyEntry=historyEntry, trapTest=trapTest, humMin=humMin)
