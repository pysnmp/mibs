...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:03:41 2024
...
TimeTicks, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Integer32, Gauge32, IpAddress, Bits, NotificationType, Counter64, ModuleIdentity, enterprises, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Integer32", "Gauge32", "IpAddress", "Bits", "NotificationType", "Counter64", "ModuleIdentity", "enterprises", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, historyEntry=historyEntry, tempUnit=tempUnit, compValHystInt=compValHystInt, compValMax=compValMax, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarm=compValAlarm, values=values, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, humAlarmInt=humAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, t3610=t3610, traps=traps, humMin=humMin, serialNumber=serialNumber, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrSome=trapEmailErrSome, trapEmailErrDNS=trapEmailErrDNS, compValAlarmInt=compValAlarmInt, histHum=histHum, trapTempError=trapTempError, compValHighInt=compValHighInt, tempLowInt=tempLowInt, tempAlarmInt=tempAlarmInt, trapNTPError=trapNTPError, trapTempClrAlarm=trapTempClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, compValDelayInt=compValDelayInt, compValUnit=compValUnit, trapHumClrAlarm=trapHumClrAlarm, humMax=humMax, messageString=messageString, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, temp=temp, compVal=compVal, tables=tables, DisplayString=DisplayString, tempInt=tempInt, historyTable=historyTable, trapTest=trapTest, tempHighInt=tempHighInt, valuesInt=valuesInt, humInt=humInt, humLowInt=humLowInt, products=products, tempAlarm=tempAlarm, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, trapHumError=trapHumError, trapCompValError=trapCompValError, trapEmailErrAuth=trapEmailErrAuth, histTemp=histTemp, settings=settings, humHighInt=humHighInt, histCompVal=histCompVal, tempHystInt=tempHystInt, sensorName=sensorName, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, humAlarm=humAlarm, compValMin=compValMin, humDelayInt=humDelayInt, compValLowInt=compValLowInt, humUnit=humUnit, deviceType=deviceType, hum=hum, tempMin=tempMin, comet=comet, pysmi_global=pysmi_global)
