...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:31:14 2023
...
ObjectIdentity, enterprises, Unsigned32, Counter64, Integer32, IpAddress, Counter32, Bits, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, NotificationType, Gauge32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "Unsigned32", "Counter64", "Integer32", "IpAddress", "Counter32", "Bits", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "NotificationType", "Gauge32", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, compValUnit=compValUnit, compValMax=compValMax, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, tempHighInt=tempHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, comet=comet, humAlarm=humAlarm, trapTempError=trapTempError, compValAlarmInt=compValAlarmInt, histHum=histHum, trapCompValLowAlarm=trapCompValLowAlarm, humUnit=humUnit, humLowInt=humLowInt, humMin=humMin, trapHumError=trapHumError, tables=tables, DisplayString=DisplayString, compValLowInt=compValLowInt, humAlarmInt=humAlarmInt, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, serialNumber=serialNumber, tempMin=tempMin, histCompVal=histCompVal, deviceType=deviceType, compValInt=compValInt, trapTempClrAlarm=trapTempClrAlarm, tempLowInt=tempLowInt, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, tempAlarmInt=tempAlarmInt, products=products, humInt=humInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, trapTest=trapTest, tempHystInt=tempHystInt, compValHighInt=compValHighInt, tempAlarm=tempAlarm, t3610=t3610, sensorName=sensorName, compValMin=compValMin, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, compValAlarm=compValAlarm, pysmi_global=pysmi_global, messageString=messageString, tempDelayInt=tempDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, values=values, tempMax=tempMax, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, tempInt=tempInt, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrAuth=trapEmailErrAuth, tempUnit=tempUnit, historyEntry=historyEntry, trapHumClrAlarm=trapHumClrAlarm, humHighInt=humHighInt, hum=hum, settings=settings, traps=traps, historyTable=historyTable)
