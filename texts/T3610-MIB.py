...
# Produced by pysmi-1.1.8 at Wed Feb  2 19:24:57 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Unsigned32, IpAddress, ModuleIdentity, Integer32, Gauge32, Counter64, enterprises, ObjectIdentity, iso, Counter32, NotificationType, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Unsigned32", "IpAddress", "ModuleIdentity", "Integer32", "Gauge32", "Counter64", "enterprises", "ObjectIdentity", "iso", "Counter32", "NotificationType", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, tempMax=tempMax, historyTable=historyTable, trapEmailErrAuth=trapEmailErrAuth, temp=temp, trapSOAPErrFile=trapSOAPErrFile, tempDelayInt=tempDelayInt, humAlarm=humAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapTempLowAlarm=trapTempLowAlarm, hum=hum, trapSOAPErrDNS=trapSOAPErrDNS, compValHystInt=compValHystInt, valuesInt=valuesInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, compValAlarmInt=compValAlarmInt, tempMin=tempMin, compValInt=compValInt, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, settings=settings, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSome=trapEmailErrSome, messageString=messageString, humMin=humMin, trapEmailErrDNS=trapEmailErrDNS, comet=comet, compValAlarm=compValAlarm, t3610=t3610, histHum=histHum, tempAlarm=tempAlarm, humUnit=humUnit, products=products, tables=tables, humLowInt=humLowInt, histTemp=histTemp, humHighInt=humHighInt, compValHighInt=compValHighInt, trapHumHighAlarm=trapHumHighAlarm, tempInt=tempInt, sensorName=sensorName, serialNumber=serialNumber, compValLowInt=compValLowInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, humInt=humInt, histCompVal=histCompVal, compValDelayInt=compValDelayInt, deviceType=deviceType, humAlarmInt=humAlarmInt, compValMin=compValMin, humMax=humMax, tempAlarmInt=tempAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, compVal=compVal, values=values, tempHystInt=tempHystInt, tempLowInt=tempLowInt, DisplayString=DisplayString, trapTempError=trapTempError, traps=traps, tempHighInt=tempHighInt, humDelayInt=humDelayInt, tempUnit=tempUnit, trapTempHighAlarm=trapTempHighAlarm, trapNTPError=trapNTPError, compValMax=compValMax, compValUnit=compValUnit, historyEntry=historyEntry, pysmi_global=pysmi_global)
