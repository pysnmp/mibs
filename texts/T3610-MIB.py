...
mibBuilder.exportSymbols("T3610-MIB", tables=tables, comet=comet, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, compValUnit=compValUnit, humMax=humMax, compValInt=compValInt, trapTempError=trapTempError, compValHystInt=compValHystInt, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrLogin=trapEmailErrLogin, DisplayString=DisplayString, hum=hum, products=products, trapTempClrAlarm=trapTempClrAlarm, t3610=t3610, humMin=humMin, historyTable=historyTable, trapCompValClrAlarm=trapCompValClrAlarm, humHighInt=humHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, humAlarm=humAlarm, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, histHum=histHum, humDelayInt=humDelayInt, trapEmailErrAuth=trapEmailErrAuth, settings=settings, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, humUnit=humUnit, trapHumClrAlarm=trapHumClrAlarm, humAlarmInt=humAlarmInt, tempMin=tempMin, tempHystInt=tempHystInt, tempAlarm=tempAlarm, humHystInt=humHystInt, trapNTPError=trapNTPError, trapTempHighAlarm=trapTempHighAlarm, messageString=messageString, trapHumHighAlarm=trapHumHighAlarm, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, compValLowInt=compValLowInt, historyEntry=historyEntry, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarmInt=compValAlarmInt, deviceType=deviceType, trapHumError=trapHumError, sensorName=sensorName, pysmi_global=pysmi_global, valuesInt=valuesInt, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, compValHighInt=compValHighInt, values=values, tempInt=tempInt, compVal=compVal, tempLowInt=tempLowInt, traps=traps, trapCompValLowAlarm=trapCompValLowAlarm, temp=temp, tempMax=tempMax, compValMax=compValMax, tempDelayInt=tempDelayInt, serialNumber=serialNumber, humInt=humInt, tempHighInt=tempHighInt, compValMin=compValMin, compValAlarm=compValAlarm, histTemp=histTemp, trapTest=trapTest)
