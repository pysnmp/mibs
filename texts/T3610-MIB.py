...
# Produced by pysmi-1.1.3 at Sat Nov 20 22:42:03 2021
...
ModuleIdentity, MibIdentifier, TimeTicks, NotificationType, Gauge32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, IpAddress, Unsigned32, enterprises, Bits, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "Gauge32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "IpAddress", "Unsigned32", "enterprises", "Bits", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humHystInt=humHystInt, pysmi_global=pysmi_global, settings=settings, humAlarm=humAlarm, compValInt=compValInt, histHum=histHum, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, traps=traps, humInt=humInt, messageString=messageString, trapHumError=trapHumError, tempHighInt=tempHighInt, hum=hum, trapEmailErrDNS=trapEmailErrDNS, trapNTPError=trapNTPError, trapTempLowAlarm=trapTempLowAlarm, t3610=t3610, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, trapHumHighAlarm=trapHumHighAlarm, histTemp=histTemp, trapTempError=trapTempError, trapCompValError=trapCompValError, humMin=humMin, tempMax=tempMax, trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, tempUnit=tempUnit, humAlarmInt=humAlarmInt, valuesInt=valuesInt, humMax=humMax, values=values, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrSocket=trapSOAPErrSocket, tables=tables, compValHystInt=compValHystInt, tempDelayInt=tempDelayInt, products=products, tempAlarmInt=tempAlarmInt, histCompVal=histCompVal, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, trapTest=trapTest, sensorName=sensorName, tempMin=tempMin, serialNumber=serialNumber, compVal=compVal, deviceType=deviceType, historyEntry=historyEntry, compValHighInt=compValHighInt, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, humUnit=humUnit, tempLowInt=tempLowInt, temp=temp, compValUnit=compValUnit, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrSocket=trapEmailErrSocket, humDelayInt=humDelayInt, comet=comet, compValMax=compValMax, compValDelayInt=compValDelayInt, trapTempClrAlarm=trapTempClrAlarm, humLowInt=humLowInt, compValAlarm=compValAlarm, compValLowInt=compValLowInt, tempInt=tempInt, tempHystInt=tempHystInt)
