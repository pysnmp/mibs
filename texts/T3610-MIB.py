...
# Produced by pysmi-1.1.12 at Mon Jul  1 11:10:59 2024
...
TimeTicks, Integer32, Counter32, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, ObjectIdentity, Bits, ModuleIdentity, Counter64, iso, enterprises, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Counter32", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "ObjectIdentity", "Bits", "ModuleIdentity", "Counter64", "iso", "enterprises", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrDNS=trapSOAPErrDNS, tempMax=tempMax, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, products=products, historyTable=historyTable, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, compValHystInt=compValHystInt, tempAlarm=tempAlarm, temp=temp, tempMin=tempMin, tempInt=tempInt, histTemp=histTemp, tempUnit=tempUnit, t3610=t3610, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compValHighInt=compValHighInt, trapNTPError=trapNTPError, humMin=humMin, comet=comet, compValInt=compValInt, traps=traps, compValAlarmInt=compValAlarmInt, hum=hum, trapHumError=trapHumError, tables=tables, compValAlarm=compValAlarm, tempHighInt=tempHighInt, humHighInt=humHighInt, historyEntry=historyEntry, humHystInt=humHystInt, settings=settings, trapHumClrAlarm=trapHumClrAlarm, trapTempHighAlarm=trapTempHighAlarm, humLowInt=humLowInt, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumLowAlarm=trapHumLowAlarm, histHum=histHum, histCompVal=histCompVal, compVal=compVal, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrDNS=trapEmailErrDNS, compValMin=compValMin, sensorName=sensorName, trapCompValHighAlarm=trapCompValHighAlarm, humMax=humMax, trapTempError=trapTempError, trapTest=trapTest, tempHystInt=tempHystInt, humDelayInt=humDelayInt, humAlarmInt=humAlarmInt, humAlarm=humAlarm, values=values, tempLowInt=tempLowInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, trapCompValError=trapCompValError, serialNumber=serialNumber, compValLowInt=compValLowInt, deviceType=deviceType, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, compValUnit=compValUnit, humInt=humInt, DisplayString=DisplayString, humUnit=humUnit)
