...
# Produced by pysmi-1.1.12 at Thu Sep 26 02:11:20 2024
...
Integer32, Counter64, Bits, Gauge32, ObjectIdentity, MibIdentifier, NotificationType, NotificationType, Counter32, IpAddress, TimeTicks, iso, Unsigned32, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Bits", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "NotificationType", "Counter32", "IpAddress", "TimeTicks", "iso", "Unsigned32", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, settings=settings, trapEmailErrSome=trapEmailErrSome, humLowInt=humLowInt, trapCompValError=trapCompValError, compValLowInt=compValLowInt, trapEmailErrSocket=trapEmailErrSocket, humHighInt=humHighInt, compValInt=compValInt, tables=tables, trapEmailErrAuth=trapEmailErrAuth, tempMin=tempMin, trapTempClrAlarm=trapTempClrAlarm, historyTable=historyTable, humUnit=humUnit, humAlarmInt=humAlarmInt, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, trapEmailErrLogin=trapEmailErrLogin, humInt=humInt, trapCompValHighAlarm=trapCompValHighAlarm, sensorName=sensorName, trapHumHighAlarm=trapHumHighAlarm, trapHumError=trapHumError, tempAlarm=tempAlarm, tempHighInt=tempHighInt, humDelayInt=humDelayInt, compValMax=compValMax, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, compValMin=compValMin, histHum=histHum, serialNumber=serialNumber, pysmi_global=pysmi_global, tempDelayInt=tempDelayInt, tempUnit=tempUnit, trapNTPError=trapNTPError, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, tempInt=tempInt, trapTempError=trapTempError, temp=temp, hum=hum, humMax=humMax, trapHumLowAlarm=trapHumLowAlarm, traps=traps, compValHighInt=compValHighInt, compVal=compVal, products=products, tempLowInt=tempLowInt, messageString=messageString, historyEntry=historyEntry, values=values, compValAlarm=compValAlarm, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarmInt=tempAlarmInt, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, comet=comet, humAlarm=humAlarm, t3610=t3610, trapSOAPErrFile=trapSOAPErrFile, compValUnit=compValUnit, humHystInt=humHystInt, trapSOAPErrSocket=trapSOAPErrSocket, histCompVal=histCompVal, compValDelayInt=compValDelayInt, trapTest=trapTest, compValHystInt=compValHystInt, trapTempHighAlarm=trapTempHighAlarm, humMin=humMin, compValAlarmInt=compValAlarmInt, trapTempLowAlarm=trapTempLowAlarm, histTemp=histTemp)
