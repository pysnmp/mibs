...
# Produced by pysmi-1.1.8 at Sat Jan 15 19:33:28 2022
...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, iso, Integer32, Counter32, enterprises, IpAddress, Unsigned32, Gauge32, ObjectIdentity, ModuleIdentity, NotificationType, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "iso", "Integer32", "Counter32", "enterprises", "IpAddress", "Unsigned32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrSome=trapEmailErrSome, humMax=humMax, comet=comet, trapCompValLowAlarm=trapCompValLowAlarm, hum=hum, tempMax=tempMax, trapHumError=trapHumError, compValUnit=compValUnit, serialNumber=serialNumber, pysmi_global=pysmi_global, tables=tables, tempLowInt=tempLowInt, products=products, trapEmailErrLogin=trapEmailErrLogin, values=values, tempHystInt=tempHystInt, humLowInt=humLowInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, traps=traps, t3610=t3610, compValDelayInt=compValDelayInt, compValAlarmInt=compValAlarmInt, compValHighInt=compValHighInt, trapTest=trapTest, trapTempError=trapTempError, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValError=trapCompValError, tempAlarm=tempAlarm, trapSOAPErrFile=trapSOAPErrFile, DisplayString=DisplayString, humAlarm=humAlarm, historyEntry=historyEntry, messageString=messageString, tempDelayInt=tempDelayInt, tempAlarmInt=tempAlarmInt, trapHumClrAlarm=trapHumClrAlarm, temp=temp, trapEmailErrAuth=trapEmailErrAuth, humDelayInt=humDelayInt, compValInt=compValInt, trapNTPError=trapNTPError, historyTable=historyTable, trapHumHighAlarm=trapHumHighAlarm, humUnit=humUnit, humHighInt=humHighInt, trapSOAPErrSocket=trapSOAPErrSocket, humAlarmInt=humAlarmInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumLowAlarm=trapHumLowAlarm, compValAlarm=compValAlarm, histCompVal=histCompVal, trapTempLowAlarm=trapTempLowAlarm, tempMin=tempMin, compValMin=compValMin, settings=settings, compValMax=compValMax, tempInt=tempInt, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, deviceType=deviceType, tempHighInt=tempHighInt, histTemp=histTemp, valuesInt=valuesInt, humInt=humInt, compValLowInt=compValLowInt, sensorName=sensorName, trapCompValClrAlarm=trapCompValClrAlarm, humMin=humMin, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, tempUnit=tempUnit, humHystInt=humHystInt)
