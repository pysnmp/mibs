...
Counter32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Gauge32, NotificationType, Integer32, Unsigned32, ModuleIdentity, ObjectIdentity, MibIdentifier, Bits, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Gauge32", "NotificationType", "Integer32", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Bits", "iso", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, trapEmailErrLogin=trapEmailErrLogin, hum=hum, serialNumber=serialNumber, deviceType=deviceType, tempUnit=tempUnit, compValMax=compValMax, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValClrAlarm=trapCompValClrAlarm, tables=tables, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, settings=settings, compValAlarmInt=compValAlarmInt, historyTable=historyTable, tempAlarm=tempAlarm, products=products, compValMin=compValMin, tempMax=tempMax, trapSOAPErrSocket=trapSOAPErrSocket, trapTempLowAlarm=trapTempLowAlarm, humAlarmInt=humAlarmInt, trapTempError=trapTempError, comet=comet, humHighInt=humHighInt, compValHighInt=compValHighInt, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, temp=temp, compVal=compVal, compValDelayInt=compValDelayInt, pysmi_global=pysmi_global, tempMin=tempMin, histTemp=histTemp, trapEmailErrAuth=trapEmailErrAuth, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSocket=trapEmailErrSocket, tempHighInt=tempHighInt, compValLowInt=compValLowInt, humAlarm=humAlarm, humInt=humInt, humMax=humMax, humDelayInt=humDelayInt, trapTempHighAlarm=trapTempHighAlarm, values=values, tempDelayInt=tempDelayInt, trapEmailErrSome=trapEmailErrSome, tempHystInt=tempHystInt, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, t3610=t3610, trapHumError=trapHumError, sensorName=sensorName, humLowInt=humLowInt, historyEntry=historyEntry, trapSOAPErrDNS=trapSOAPErrDNS, traps=traps, humMin=humMin, compValInt=compValInt, trapCompValError=trapCompValError, trapNTPError=trapNTPError, histCompVal=histCompVal, humHystInt=humHystInt, humUnit=humUnit, tempLowInt=tempLowInt)
