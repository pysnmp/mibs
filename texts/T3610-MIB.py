...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:18:17 2022
...
ObjectIdentity, Counter64, Integer32, NotificationType, Unsigned32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, NotificationType, Bits, IpAddress, MibIdentifier, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Integer32", "NotificationType", "Unsigned32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "NotificationType", "Bits", "IpAddress", "MibIdentifier", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", compValUnit=compValUnit, trapEmailErrSome=trapEmailErrSome, trapEmailErrDNS=trapEmailErrDNS, trapTempClrAlarm=trapTempClrAlarm, histTemp=histTemp, tempMax=tempMax, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, deviceType=deviceType, trapNTPError=trapNTPError, DisplayString=DisplayString, humAlarmInt=humAlarmInt, trapCompValError=trapCompValError, hum=hum, humMin=humMin, compValLowInt=compValLowInt, trapHumClrAlarm=trapHumClrAlarm, tempHystInt=tempHystInt, products=products, trapHumLowAlarm=trapHumLowAlarm, tempAlarm=tempAlarm, pysmi_global=pysmi_global, sensorName=sensorName, humDelayInt=humDelayInt, histHum=histHum, trapTempLowAlarm=trapTempLowAlarm, historyTable=historyTable, humUnit=humUnit, trapTempError=trapTempError, trapEmailErrLogin=trapEmailErrLogin, traps=traps, tempAlarmInt=tempAlarmInt, tempUnit=tempUnit, trapEmailErrAuth=trapEmailErrAuth, serialNumber=serialNumber, trapCompValClrAlarm=trapCompValClrAlarm, humMax=humMax, compValAlarmInt=compValAlarmInt, humInt=humInt, tempInt=tempInt, comet=comet, tempHighInt=tempHighInt, humLowInt=humLowInt, compValHighInt=compValHighInt, messageString=messageString, trapTempHighAlarm=trapTempHighAlarm, tempMin=tempMin, trapCompValLowAlarm=trapCompValLowAlarm, trapTest=trapTest, historyEntry=historyEntry, tables=tables, trapHumError=trapHumError, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery, humHighInt=humHighInt, compValDelayInt=compValDelayInt, compValInt=compValInt, tempDelayInt=tempDelayInt, compValAlarm=compValAlarm, trapSOAPErrFile=trapSOAPErrFile, temp=temp, values=values, valuesInt=valuesInt, humHystInt=humHystInt, trapEmailErrSocket=trapEmailErrSocket, t3610=t3610, compValHystInt=compValHystInt, trapCompValHighAlarm=trapCompValHighAlarm, humAlarm=humAlarm, compValMax=compValMax, tempLowInt=tempLowInt, histCompVal=histCompVal, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, settings=settings)
