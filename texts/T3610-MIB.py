...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:11:59 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, TimeTicks, Counter32, Unsigned32, MibIdentifier, NotificationType, IpAddress, Bits, Counter64, enterprises, Integer32, Gauge32, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter32", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "Bits", "Counter64", "enterprises", "Integer32", "Gauge32", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", humUnit=humUnit, compValHighInt=compValHighInt, trapEmailErrAuth=trapEmailErrAuth, trapSOAPErrSocket=trapSOAPErrSocket, trapTempClrAlarm=trapTempClrAlarm, tempLowInt=tempLowInt, values=values, compValMax=compValMax, trapHumHighAlarm=trapHumHighAlarm, tempHighInt=tempHighInt, serialNumber=serialNumber, humInt=humInt, compValInt=compValInt, compValHystInt=compValHystInt, humAlarmInt=humAlarmInt, trapEmailErrDNS=trapEmailErrDNS, traps=traps, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, humLowInt=humLowInt, products=products, compValLowInt=compValLowInt, messageString=messageString, compValUnit=compValUnit, histTemp=histTemp, compValAlarm=compValAlarm, tempInt=tempInt, trapTest=trapTest, historyTable=historyTable, trapCompValError=trapCompValError, tempHystInt=tempHystInt, trapTempError=trapTempError, tempAlarmInt=tempAlarmInt, compValDelayInt=compValDelayInt, settings=settings, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, humAlarm=humAlarm, temp=temp, tempMax=tempMax, trapEmailErrLogin=trapEmailErrLogin, trapNTPError=trapNTPError, trapCompValClrAlarm=trapCompValClrAlarm, trapTempLowAlarm=trapTempLowAlarm, historyEntry=historyEntry, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, hum=hum, tempAlarm=tempAlarm, comet=comet, sensorName=sensorName, humHighInt=humHighInt, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, humMax=humMax, t3610=t3610, DisplayString=DisplayString, compVal=compVal, pysmi_global=pysmi_global, compValMin=compValMin, tempUnit=tempUnit, tempDelayInt=tempDelayInt, histHum=histHum, tempMin=tempMin, trapEmailErrSome=trapEmailErrSome, trapSOAPErrFile=trapSOAPErrFile, tables=tables, deviceType=deviceType)
