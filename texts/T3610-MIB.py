...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, MibIdentifier, TimeTicks, Integer32, ObjectIdentity, NotificationType, Unsigned32, IpAddress, enterprises, ModuleIdentity, Counter32, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "MibIdentifier", "TimeTicks", "Integer32", "ObjectIdentity", "NotificationType", "Unsigned32", "IpAddress", "enterprises", "ModuleIdentity", "Counter32", "Counter64", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", compValDelayInt=compValDelayInt, valuesInt=valuesInt, traps=traps, compValLowInt=compValLowInt, values=values, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHystInt=tempHystInt, humInt=humInt, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, products=products, compValHighInt=compValHighInt, compValHystInt=compValHystInt, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, humHystInt=humHystInt, humDelayInt=humDelayInt, hum=hum, compVal=compVal, humMax=humMax, compValAlarmInt=compValAlarmInt, trapCompValClrAlarm=trapCompValClrAlarm, historyTable=historyTable, settings=settings, sensorName=sensorName, tables=tables, tempMin=tempMin, humHighInt=humHighInt, trapEmailErrSome=trapEmailErrSome, trapCompValHighAlarm=trapCompValHighAlarm, tempAlarmInt=tempAlarmInt, humMin=humMin, historyEntry=historyEntry, serialNumber=serialNumber, DisplayString=DisplayString, trapTempLowAlarm=trapTempLowAlarm, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapHumError=trapHumError, messageString=messageString, histCompVal=histCompVal, tempMax=tempMax, compValMin=compValMin, trapEmailErrSocket=trapEmailErrSocket, tempAlarm=tempAlarm, humAlarm=humAlarm, trapNTPError=trapNTPError, tempInt=tempInt, trapTempError=trapTempError, trapSOAPErrFile=trapSOAPErrFile, humUnit=humUnit, trapHumLowAlarm=trapHumLowAlarm, pysmi_global=pysmi_global, t3610=t3610, trapCompValLowAlarm=trapCompValLowAlarm, tempUnit=tempUnit, compValMax=compValMax, deviceType=deviceType, trapTest=trapTest, comet=comet, trapCompValError=trapCompValError, histTemp=histTemp, compValUnit=compValUnit, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, compValInt=compValInt, trapHumClrAlarm=trapHumClrAlarm, temp=temp, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrAuth=trapEmailErrAuth, tempHighInt=tempHighInt)
