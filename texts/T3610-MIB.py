...
NotificationType, ObjectIdentity, Integer32, Counter64, enterprises, Gauge32, Unsigned32, TimeTicks, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Counter32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Integer32", "Counter64", "enterprises", "Gauge32", "Unsigned32", "TimeTicks", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Counter32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, trapEmailErrAuth=trapEmailErrAuth, messageString=messageString, compValAlarmInt=compValAlarmInt, trapEmailErrSome=trapEmailErrSome, tempMax=tempMax, settings=settings, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, DisplayString=DisplayString, trapTempHighAlarm=trapTempHighAlarm, sensorName=sensorName, trapNTPError=trapNTPError, tempInt=tempInt, tempUnit=tempUnit, humHighInt=humHighInt, compValHystInt=compValHystInt, trapCompValHighAlarm=trapCompValHighAlarm, humLowInt=humLowInt, humMin=humMin, compValMin=compValMin, t3610=t3610, trapSOAPErrFile=trapSOAPErrFile, compValAlarm=compValAlarm, trapTest=trapTest, tables=tables, temp=temp, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, compValInt=compValInt, compValLowInt=compValLowInt, humDelayInt=humDelayInt, humHystInt=humHystInt, histTemp=histTemp, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempClrAlarm=trapTempClrAlarm, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrLogin=trapEmailErrLogin, trapHumError=trapHumError, trapCompValClrAlarm=trapCompValClrAlarm, humMax=humMax, pysmi_global=pysmi_global, humUnit=humUnit, humAlarm=humAlarm, compValMax=compValMax, compValDelayInt=compValDelayInt, histHum=histHum, traps=traps, tempHighInt=tempHighInt, trapEmailErrSocket=trapEmailErrSocket, compValUnit=compValUnit, humAlarmInt=humAlarmInt, historyEntry=historyEntry, values=values, trapEmailErrDNS=trapEmailErrDNS, trapTempLowAlarm=trapTempLowAlarm, histCompVal=histCompVal, comet=comet, compVal=compVal, trapTempError=trapTempError, tempMin=tempMin, tempAlarm=tempAlarm, products=products, tempAlarmInt=tempAlarmInt, deviceType=deviceType, trapCompValError=trapCompValError, compValHighInt=compValHighInt, tempLowInt=tempLowInt, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, hum=hum, trapSOAPErrSocket=trapSOAPErrSocket, tempDelayInt=tempDelayInt)
