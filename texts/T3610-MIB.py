...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:04:37 2024
...
ObjectIdentity, enterprises, iso, Integer32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Unsigned32, NotificationType, IpAddress, Counter32, TimeTicks, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "iso", "Integer32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Unsigned32", "NotificationType", "IpAddress", "Counter32", "TimeTicks", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, humAlarmInt=humAlarmInt, trapHumError=trapHumError, trapNTPError=trapNTPError, tempMax=tempMax, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, compValInt=compValInt, compValAlarmInt=compValAlarmInt, deviceType=deviceType, humLowInt=humLowInt, tempInt=tempInt, humDelayInt=humDelayInt, compValMin=compValMin, values=values, trapSOAPErrSocket=trapSOAPErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValHystInt=compValHystInt, humAlarm=humAlarm, trapTempClrAlarm=trapTempClrAlarm, tables=tables, DisplayString=DisplayString, hum=hum, humMin=humMin, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, compValHighInt=compValHighInt, temp=temp, compValLowInt=compValLowInt, valuesInt=valuesInt, historyEntry=historyEntry, histHum=histHum, tempMin=tempMin, trapTempLowAlarm=trapTempLowAlarm, trapCompValError=trapCompValError, settings=settings, humHystInt=humHystInt, tempHystInt=tempHystInt, tempAlarm=tempAlarm, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDelivery=trapSOAPErrDelivery, compValMax=compValMax, trapCompValLowAlarm=trapCompValLowAlarm, tempDelayInt=tempDelayInt, compValDelayInt=compValDelayInt, humMax=humMax, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, comet=comet, t3610=t3610, trapEmailErrSocket=trapEmailErrSocket, compValAlarm=compValAlarm, pysmi_global=pysmi_global, traps=traps, products=products, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, messageString=messageString, tempAlarmInt=tempAlarmInt, humHighInt=humHighInt, trapTest=trapTest, serialNumber=serialNumber, compVal=compVal, histTemp=histTemp, compValUnit=compValUnit, humUnit=humUnit, tempUnit=tempUnit, sensorName=sensorName)
