...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, enterprises, IpAddress, MibIdentifier, TimeTicks, ModuleIdentity, NotificationType, Unsigned32, ObjectIdentity, Gauge32, Counter32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "enterprises", "IpAddress", "MibIdentifier", "TimeTicks", "ModuleIdentity", "NotificationType", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter32", "Integer32", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, values=values, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, tempAlarmInt=tempAlarmInt, histCompVal=histCompVal, trapHumLowAlarm=trapHumLowAlarm, compVal=compVal, humDelayInt=humDelayInt, trapHumError=trapHumError, trapTempError=trapTempError, humAlarm=humAlarm, serialNumber=serialNumber, temp=temp, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, compValUnit=compValUnit, compValLowInt=compValLowInt, products=products, tempDelayInt=tempDelayInt, trapCompValError=trapCompValError, humHighInt=humHighInt, tempLowInt=tempLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValDelayInt=compValDelayInt, tempMin=tempMin, humLowInt=humLowInt, t3610=t3610, humMax=humMax, sensorName=sensorName, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, comet=comet, traps=traps, trapSOAPErrFile=trapSOAPErrFile, messageString=messageString, compValMin=compValMin, trapNTPError=trapNTPError, trapEmailErrAuth=trapEmailErrAuth, histHum=histHum, pysmi_global=pysmi_global, tempHighInt=tempHighInt, tempHystInt=tempHystInt, settings=settings, trapEmailErrDNS=trapEmailErrDNS, compValHighInt=compValHighInt, humMin=humMin, trapCompValClrAlarm=trapCompValClrAlarm, compValInt=compValInt, tempAlarm=tempAlarm, DisplayString=DisplayString, compValMax=compValMax, humInt=humInt, historyTable=historyTable, hum=hum, humAlarmInt=humAlarmInt, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, tables=tables, valuesInt=valuesInt, tempInt=tempInt, humUnit=humUnit, humHystInt=humHystInt, deviceType=deviceType, compValHystInt=compValHystInt, trapTest=trapTest, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, tempMax=tempMax, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, compValAlarm=compValAlarm, histTemp=histTemp, trapTempHighAlarm=trapTempHighAlarm)
