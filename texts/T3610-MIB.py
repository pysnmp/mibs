...
# Produced by pysmi-1.1.12 at Wed May 29 07:59:24 2024
...
ModuleIdentity, enterprises, Counter32, Bits, Integer32, TimeTicks, Gauge32, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, NotificationType, NotificationType, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Counter32", "Bits", "Integer32", "TimeTicks", "Gauge32", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "NotificationType", "NotificationType", "Counter64", "iso")
...
mibBuilder.exportSymbols("T3610-MIB", tempInt=tempInt, trapCompValLowAlarm=trapCompValLowAlarm, compValMin=compValMin, DisplayString=DisplayString, humDelayInt=humDelayInt, tempUnit=tempUnit, historyTable=historyTable, histTemp=histTemp, compValAlarmInt=compValAlarmInt, histHum=histHum, trapCompValClrAlarm=trapCompValClrAlarm, comet=comet, serialNumber=serialNumber, trapEmailErrSome=trapEmailErrSome, values=values, humHystInt=humHystInt, compVal=compVal, t3610=t3610, trapEmailErrLogin=trapEmailErrLogin, compValLowInt=compValLowInt, historyEntry=historyEntry, humMax=humMax, traps=traps, humInt=humInt, trapTempClrAlarm=trapTempClrAlarm, tempHystInt=tempHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapTempError=trapTempError, products=products, deviceType=deviceType, compValInt=compValInt, tempLowInt=tempLowInt, trapNTPError=trapNTPError, humMin=humMin, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, tempHighInt=tempHighInt, tempDelayInt=tempDelayInt, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrFile=trapSOAPErrFile, tables=tables, humAlarm=humAlarm, settings=settings, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, trapCompValError=trapCompValError, compValMax=compValMax, tempMin=tempMin, compValDelayInt=compValDelayInt, histCompVal=histCompVal, trapTest=trapTest, compValHystInt=compValHystInt, compValAlarm=compValAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapEmailErrAuth=trapEmailErrAuth, humHighInt=humHighInt, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrSocket=trapEmailErrSocket, messageString=messageString, trapHumHighAlarm=trapHumHighAlarm, compValUnit=compValUnit, sensorName=sensorName, trapHumError=trapHumError, hum=hum, pysmi_global=pysmi_global, valuesInt=valuesInt, humUnit=humUnit, temp=temp, tempMax=tempMax, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarm=tempAlarm, compValHighInt=compValHighInt, trapHumLowAlarm=trapHumLowAlarm, humLowInt=humLowInt)
