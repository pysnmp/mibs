...
# Produced by pysmi-1.1.11 at Tue Dec  5 08:32:21 2023
...
Counter64, ModuleIdentity, Gauge32, MibIdentifier, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, NotificationType, ObjectIdentity, IpAddress, Unsigned32, enterprises, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Gauge32", "MibIdentifier", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "NotificationType", "ObjectIdentity", "IpAddress", "Unsigned32", "enterprises", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, tempHystInt=tempHystInt, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, tempDelayInt=tempDelayInt, DisplayString=DisplayString, trapEmailErrSocket=trapEmailErrSocket, compValAlarmInt=compValAlarmInt, humAlarm=humAlarm, tempLowInt=tempLowInt, tables=tables, products=products, trapHumHighAlarm=trapHumHighAlarm, humMin=humMin, t3610=t3610, compValMax=compValMax, humHighInt=humHighInt, humDelayInt=humDelayInt, trapCompValLowAlarm=trapCompValLowAlarm, compValLowInt=compValLowInt, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, trapTest=trapTest, settings=settings, temp=temp, humLowInt=humLowInt, histCompVal=histCompVal, trapNTPError=trapNTPError, valuesInt=valuesInt, compVal=compVal, compValHystInt=compValHystInt, messageString=messageString, trapHumError=trapHumError, values=values, tempUnit=tempUnit, compValInt=compValInt, tempHighInt=tempHighInt, humAlarmInt=humAlarmInt, compValHighInt=compValHighInt, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tempMin=tempMin, deviceType=deviceType, historyTable=historyTable, trapHumLowAlarm=trapHumLowAlarm, compValDelayInt=compValDelayInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrDNS=trapEmailErrDNS, compValAlarm=compValAlarm, tempAlarmInt=tempAlarmInt, histTemp=histTemp, pysmi_global=pysmi_global, trapSOAPErrDNS=trapSOAPErrDNS, tempInt=tempInt, humInt=humInt, compValUnit=compValUnit, hum=hum, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrAuth=trapEmailErrAuth, trapTempLowAlarm=trapTempLowAlarm, tempAlarm=tempAlarm, comet=comet, serialNumber=serialNumber, humUnit=humUnit, humHystInt=humHystInt, compValMin=compValMin, trapSOAPErrDelivery=trapSOAPErrDelivery, traps=traps, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, trapCompValError=trapCompValError, sensorName=sensorName)
