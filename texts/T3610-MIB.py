...
iso, Bits, TimeTicks, MibIdentifier, Unsigned32, Counter32, enterprises, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "TimeTicks", "MibIdentifier", "Unsigned32", "Counter32", "enterprises", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("T3610-MIB", temp=temp, trapHumHighAlarm=trapHumHighAlarm, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, tempDelayInt=tempDelayInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, humHighInt=humHighInt, trapTempLowAlarm=trapTempLowAlarm, valuesInt=valuesInt, compValDelayInt=compValDelayInt, humAlarm=humAlarm, compValAlarmInt=compValAlarmInt, tempLowInt=tempLowInt, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, values=values, humMax=humMax, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrDNS=trapEmailErrDNS, compValHystInt=compValHystInt, tempAlarm=tempAlarm, trapTempError=trapTempError, trapNTPError=trapNTPError, compVal=compVal, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, compValAlarm=compValAlarm, historyEntry=historyEntry, compValHighInt=compValHighInt, sensorName=sensorName, deviceType=deviceType, DisplayString=DisplayString, tempHighInt=tempHighInt, humHystInt=humHystInt, messageString=messageString, tables=tables, t3610=t3610, tempInt=tempInt, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, tempUnit=tempUnit, compValInt=compValInt, settings=settings, trapEmailErrAuth=trapEmailErrAuth, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, humInt=humInt, humDelayInt=humDelayInt, products=products, tempHystInt=tempHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, traps=traps, trapCompValError=trapCompValError, compValUnit=compValUnit, humMin=humMin, compValLowInt=compValLowInt, histTemp=histTemp, comet=comet, tempMax=tempMax, trapHumLowAlarm=trapHumLowAlarm, serialNumber=serialNumber, trapSOAPErrFile=trapSOAPErrFile, compValMin=compValMin, tempAlarmInt=tempAlarmInt, historyTable=historyTable, compValMax=compValMax, hum=hum)
