...
# Produced by pysmi-1.1.12 at Wed Dec  4 21:12:35 2024
...
Counter64, Gauge32, NotificationType, Integer32, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, enterprises, iso, IpAddress, Bits, NotificationType, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "NotificationType", "Integer32", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "enterprises", "iso", "IpAddress", "Bits", "NotificationType", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", humHighInt=humHighInt, compValLowInt=compValLowInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, tables=tables, values=values, humInt=humInt, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, trapEmailErrSome=trapEmailErrSome, histHum=histHum, comet=comet, trapEmailErrLogin=trapEmailErrLogin, trapHumLowAlarm=trapHumLowAlarm, tempAlarmInt=tempAlarmInt, trapNTPError=trapNTPError, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, temp=temp, trapCompValClrAlarm=trapCompValClrAlarm, compValUnit=compValUnit, DisplayString=DisplayString, compValMin=compValMin, trapTempClrAlarm=trapTempClrAlarm, histCompVal=histCompVal, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, hum=hum, trapHumError=trapHumError, pysmi_global=pysmi_global, settings=settings, humMin=humMin, compVal=compVal, compValHighInt=compValHighInt, humLowInt=humLowInt, compValDelayInt=compValDelayInt, humMax=humMax, humAlarmInt=humAlarmInt, trapTempHighAlarm=trapTempHighAlarm, traps=traps, products=products, trapTest=trapTest, serialNumber=serialNumber, messageString=messageString, tempHystInt=tempHystInt, t3610=t3610, trapCompValError=trapCompValError, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, humUnit=humUnit, compValMax=compValMax, tempLowInt=tempLowInt, histTemp=histTemp, tempMax=tempMax, compValInt=compValInt, compValAlarmInt=compValAlarmInt, tempAlarm=tempAlarm, tempHighInt=tempHighInt, tempUnit=tempUnit, tempDelayInt=tempDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, tempInt=tempInt, historyEntry=historyEntry, humAlarm=humAlarm, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrDNS=trapEmailErrDNS, deviceType=deviceType, humHystInt=humHystInt, humDelayInt=humDelayInt, tempMin=tempMin, trapSOAPErrDNS=trapSOAPErrDNS, historyTable=historyTable)
