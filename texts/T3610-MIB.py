...
mibBuilder.exportSymbols("T3610-MIB", humHighInt=humHighInt, trapCompValHighAlarm=trapCompValHighAlarm, historyTable=historyTable, hum=hum, historyEntry=historyEntry, tempMax=tempMax, tempHighInt=tempHighInt, compValUnit=compValUnit, trapSOAPErrFile=trapSOAPErrFile, humHystInt=humHystInt, humAlarm=humAlarm, trapTempHighAlarm=trapTempHighAlarm, tempAlarm=tempAlarm, values=values, humLowInt=humLowInt, tables=tables, humUnit=humUnit, trapEmailErrSocket=trapEmailErrSocket, trapHumClrAlarm=trapHumClrAlarm, t3610=t3610, deviceType=deviceType, tempLowInt=tempLowInt, trapHumLowAlarm=trapHumLowAlarm, trapHumError=trapHumError, DisplayString=DisplayString, compValDelayInt=compValDelayInt, trapEmailErrAuth=trapEmailErrAuth, humMax=humMax, compValHystInt=compValHystInt, humDelayInt=humDelayInt, comet=comet, compValMin=compValMin, histHum=histHum, pysmi_global=pysmi_global, trapSOAPErrDNS=trapSOAPErrDNS, humInt=humInt, trapSOAPErrDelivery=trapSOAPErrDelivery, temp=temp, compValAlarm=compValAlarm, trapTest=trapTest, traps=traps, trapEmailErrLogin=trapEmailErrLogin, compValHighInt=compValHighInt, valuesInt=valuesInt, tempInt=tempInt, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValClrAlarm=trapCompValClrAlarm, tempMin=tempMin, compValLowInt=compValLowInt, tempHystInt=tempHystInt, tempAlarmInt=tempAlarmInt, serialNumber=serialNumber, compValInt=compValInt, products=products, compValMax=compValMax, trapEmailErrSome=trapEmailErrSome, tempDelayInt=tempDelayInt, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, humMin=humMin, trapHumHighAlarm=trapHumHighAlarm, histTemp=histTemp, tempUnit=tempUnit, trapTempError=trapTempError, messageString=messageString, histCompVal=histCompVal, trapNTPError=trapNTPError, humAlarmInt=humAlarmInt, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, settings=settings, trapTempClrAlarm=trapTempClrAlarm, compValAlarmInt=compValAlarmInt, compVal=compVal)
