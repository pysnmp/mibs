...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:26:32 2023
...
NotificationType, Gauge32, ModuleIdentity, ObjectIdentity, Unsigned32, enterprises, NotificationType, IpAddress, iso, Counter64, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "enterprises", "NotificationType", "IpAddress", "iso", "Counter64", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumError=trapHumError, t3610=t3610, tempMin=tempMin, humLowInt=humLowInt, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapSOAPErrSocket=trapSOAPErrSocket, compValLowInt=compValLowInt, compValInt=compValInt, trapHumLowAlarm=trapHumLowAlarm, humUnit=humUnit, serialNumber=serialNumber, compValAlarm=compValAlarm, historyTable=historyTable, pysmi_global=pysmi_global, trapTempError=trapTempError, tempDelayInt=tempDelayInt, humHystInt=humHystInt, humMin=humMin, trapSOAPErrDNS=trapSOAPErrDNS, tempMax=tempMax, compValDelayInt=compValDelayInt, trapEmailErrLogin=trapEmailErrLogin, trapTempClrAlarm=trapTempClrAlarm, trapHumClrAlarm=trapHumClrAlarm, settings=settings, valuesInt=valuesInt, humAlarm=humAlarm, tempUnit=tempUnit, humAlarmInt=humAlarmInt, humMax=humMax, traps=traps, tempAlarmInt=tempAlarmInt, temp=temp, hum=hum, compValMax=compValMax, humInt=humInt, humHighInt=humHighInt, histTemp=histTemp, trapTest=trapTest, histCompVal=histCompVal, tempAlarm=tempAlarm, trapEmailErrDNS=trapEmailErrDNS, compValHighInt=compValHighInt, sensorName=sensorName, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrFile=trapSOAPErrFile, products=products, compValHystInt=compValHystInt, deviceType=deviceType, tables=tables, trapHumHighAlarm=trapHumHighAlarm, compValMin=compValMin, messageString=messageString, DisplayString=DisplayString, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, trapEmailErrAuth=trapEmailErrAuth, tempInt=tempInt, tempHighInt=tempHighInt, trapCompValClrAlarm=trapCompValClrAlarm, comet=comet, trapNTPError=trapNTPError, trapEmailErrSome=trapEmailErrSome, tempHystInt=tempHystInt, histHum=histHum, values=values, trapCompValError=trapCompValError, compVal=compVal, compValUnit=compValUnit)
