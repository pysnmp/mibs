...
# Produced by pysmi-1.1.12 at Tue Dec  3 09:40:20 2024
...
Integer32, iso, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, enterprises, MibIdentifier, ObjectIdentity, ModuleIdentity, Counter32, Counter64, NotificationType, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "enterprises", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Counter32", "Counter64", "NotificationType", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", humMin=humMin, serialNumber=serialNumber, trapTempClrAlarm=trapTempClrAlarm, DisplayString=DisplayString, trapCompValHighAlarm=trapCompValHighAlarm, trapNTPError=trapNTPError, humLowInt=humLowInt, trapCompValError=trapCompValError, histHum=histHum, values=values, humUnit=humUnit, comet=comet, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, humDelayInt=humDelayInt, valuesInt=valuesInt, sensorName=sensorName, trapCompValClrAlarm=trapCompValClrAlarm, tempUnit=tempUnit, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarm=tempAlarm, tempMin=tempMin, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, products=products, humInt=humInt, humHighInt=humHighInt, trapEmailErrAuth=trapEmailErrAuth, trapTempError=trapTempError, trapCompValLowAlarm=trapCompValLowAlarm, trapHumHighAlarm=trapHumHighAlarm, compValInt=compValInt, t3610=t3610, tempHystInt=tempHystInt, humAlarm=humAlarm, compValAlarm=compValAlarm, humAlarmInt=humAlarmInt, histCompVal=histCompVal, tempHighInt=tempHighInt, pysmi_global=pysmi_global, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSome=trapEmailErrSome, compValMin=compValMin, compVal=compVal, tables=tables, deviceType=deviceType, compValDelayInt=compValDelayInt, historyTable=historyTable, tempLowInt=tempLowInt, hum=hum, humMax=humMax, tempDelayInt=tempDelayInt, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, compValLowInt=compValLowInt, compValHystInt=compValHystInt, histTemp=histTemp, settings=settings, trapSOAPErrSocket=trapSOAPErrSocket, trapHumClrAlarm=trapHumClrAlarm, tempMax=tempMax, compValMax=compValMax, trapEmailErrDNS=trapEmailErrDNS, compValUnit=compValUnit, tempInt=tempInt, humHystInt=humHystInt, trapSOAPErrFile=trapSOAPErrFile, trapTempLowAlarm=trapTempLowAlarm, compValHighInt=compValHighInt, messageString=messageString, temp=temp, trapHumError=trapHumError, trapEmailErrSocket=trapEmailErrSocket, traps=traps, tempAlarmInt=tempAlarmInt)
