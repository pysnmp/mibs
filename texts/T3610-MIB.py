...
# Produced by pysmi-1.1.8 at Mon Jan 17 17:49:29 2022
...
Counter32, IpAddress, Unsigned32, MibIdentifier, Bits, Gauge32, NotificationType, ModuleIdentity, Integer32, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Unsigned32", "MibIdentifier", "Bits", "Gauge32", "NotificationType", "ModuleIdentity", "Integer32", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, DisplayString=DisplayString, hum=hum, trapTempHighAlarm=trapTempHighAlarm, tables=tables, tempAlarmInt=tempAlarmInt, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, trapTempError=trapTempError, trapSOAPErrFile=trapSOAPErrFile, compValUnit=compValUnit, trapSOAPErrDelivery=trapSOAPErrDelivery, tempHighInt=tempHighInt, tempHystInt=tempHystInt, humInt=humInt, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, serialNumber=serialNumber, trapNTPError=trapNTPError, compVal=compVal, humHighInt=humHighInt, historyEntry=historyEntry, tempMax=tempMax, trapCompValHighAlarm=trapCompValHighAlarm, tempDelayInt=tempDelayInt, trapCompValError=trapCompValError, humAlarm=humAlarm, trapTempLowAlarm=trapTempLowAlarm, compValLowInt=compValLowInt, traps=traps, valuesInt=valuesInt, settings=settings, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, tempLowInt=tempLowInt, humAlarmInt=humAlarmInt, comet=comet, humDelayInt=humDelayInt, compValHystInt=compValHystInt, values=values, trapTest=trapTest, sensorName=sensorName, tempUnit=tempUnit, compValInt=compValInt, compValHighInt=compValHighInt, historyTable=historyTable, trapSOAPErrSocket=trapSOAPErrSocket, humMin=humMin, trapCompValLowAlarm=trapCompValLowAlarm, trapHumHighAlarm=trapHumHighAlarm, messageString=messageString, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, histTemp=histTemp, deviceType=deviceType, histCompVal=histCompVal, pysmi_global=pysmi_global, trapEmailErrSome=trapEmailErrSome, products=products, humMax=humMax, compValMax=compValMax, humLowInt=humLowInt, tempAlarm=tempAlarm, tempInt=tempInt, humHystInt=humHystInt, trapEmailErrAuth=trapEmailErrAuth, t3610=t3610, trapEmailErrLogin=trapEmailErrLogin, trapHumError=trapHumError, compValAlarm=compValAlarm, humUnit=humUnit, temp=temp, compValMin=compValMin, trapCompValClrAlarm=trapCompValClrAlarm)
