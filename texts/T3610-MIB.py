...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:39:57 2021
...
Gauge32, ObjectIdentity, Bits, Integer32, Counter32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Counter64, ModuleIdentity, Unsigned32, NotificationType, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Bits", "Integer32", "Counter32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Counter64", "ModuleIdentity", "Unsigned32", "NotificationType", "iso", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", pysmi_global=pysmi_global, serialNumber=serialNumber, trapHumHighAlarm=trapHumHighAlarm, trapHumError=trapHumError, trapNTPError=trapNTPError, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarmInt=tempAlarmInt, compValUnit=compValUnit, trapCompValHighAlarm=trapCompValHighAlarm, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, humLowInt=humLowInt, values=values, humInt=humInt, histHum=histHum, historyTable=historyTable, compValMin=compValMin, trapHumLowAlarm=trapHumLowAlarm, settings=settings, trapHumClrAlarm=trapHumClrAlarm, trapCompValError=trapCompValError, DisplayString=DisplayString, tempHighInt=tempHighInt, trapEmailErrDNS=trapEmailErrDNS, compValHighInt=compValHighInt, trapTest=trapTest, compValAlarmInt=compValAlarmInt, trapEmailErrAuth=trapEmailErrAuth, histCompVal=histCompVal, trapSOAPErrDNS=trapSOAPErrDNS, tables=tables, trapEmailErrSocket=trapEmailErrSocket, t3610=t3610, trapEmailErrSome=trapEmailErrSome, messageString=messageString, tempUnit=tempUnit, tempAlarm=tempAlarm, tempMax=tempMax, temp=temp, compValAlarm=compValAlarm, compVal=compVal, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, traps=traps, compValLowInt=compValLowInt, tempInt=tempInt, tempLowInt=tempLowInt, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrLogin=trapEmailErrLogin, compValMax=compValMax, products=products, humUnit=humUnit, sensorName=sensorName, humMin=humMin, compValDelayInt=compValDelayInt, humDelayInt=humDelayInt, tempHystInt=tempHystInt, deviceType=deviceType, valuesInt=valuesInt, compValHystInt=compValHystInt, trapTempClrAlarm=trapTempClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, histTemp=histTemp, hum=hum, tempMin=tempMin, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, humMax=humMax, humHystInt=humHystInt, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, humAlarm=humAlarm, comet=comet, compValInt=compValInt)
