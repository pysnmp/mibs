...
# Produced by pysmi-1.1.12 at Wed Nov  6 08:28:20 2024
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, ObjectIdentity, Integer32, Unsigned32, Counter64, iso, TimeTicks, enterprises, IpAddress, Bits, NotificationType, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "ObjectIdentity", "Integer32", "Unsigned32", "Counter64", "iso", "TimeTicks", "enterprises", "IpAddress", "Bits", "NotificationType", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrLogin=trapEmailErrLogin, tempInt=tempInt, trapTempError=trapTempError, comet=comet, serialNumber=serialNumber, tables=tables, trapSOAPErrFile=trapSOAPErrFile, trapHumLowAlarm=trapHumLowAlarm, tempAlarmInt=tempAlarmInt, histHum=histHum, sensorName=sensorName, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, compValHighInt=compValHighInt, trapCompValLowAlarm=trapCompValLowAlarm, tempHighInt=tempHighInt, humHystInt=humHystInt, trapNTPError=trapNTPError, trapEmailErrDNS=trapEmailErrDNS, tempHystInt=tempHystInt, compVal=compVal, settings=settings, tempMax=tempMax, humHighInt=humHighInt, trapEmailErrAuth=trapEmailErrAuth, humUnit=humUnit, humMax=humMax, trapHumClrAlarm=trapHumClrAlarm, compValAlarm=compValAlarm, humInt=humInt, hum=hum, temp=temp, humMin=humMin, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, tempUnit=tempUnit, deviceType=deviceType, histTemp=histTemp, humAlarm=humAlarm, values=values, compValMax=compValMax, tempMin=tempMin, trapEmailErrSocket=trapEmailErrSocket, histCompVal=histCompVal, trapTempLowAlarm=trapTempLowAlarm, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, products=products, compValUnit=compValUnit, compValAlarmInt=compValAlarmInt, trapTempHighAlarm=trapTempHighAlarm, traps=traps, compValHystInt=compValHystInt, trapHumHighAlarm=trapHumHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, DisplayString=DisplayString, humLowInt=humLowInt, humAlarmInt=humAlarmInt, trapTest=trapTest, historyEntry=historyEntry, tempDelayInt=tempDelayInt, tempLowInt=tempLowInt, trapCompValError=trapCompValError, trapSOAPErrDNS=trapSOAPErrDNS, pysmi_global=pysmi_global, compValLowInt=compValLowInt, compValMin=compValMin, valuesInt=valuesInt, t3610=t3610, humDelayInt=humDelayInt, compValInt=compValInt, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, trapCompValHighAlarm=trapCompValHighAlarm)
