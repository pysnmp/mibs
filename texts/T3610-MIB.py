...
# Produced by pysmi-1.1.12 at Fri Apr 12 00:25:45 2024
...
iso, NotificationType, IpAddress, enterprises, MibIdentifier, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, NotificationType, TimeTicks, ModuleIdentity, Counter64, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "IpAddress", "enterprises", "MibIdentifier", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "NotificationType", "TimeTicks", "ModuleIdentity", "Counter64", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", histCompVal=histCompVal, humAlarm=humAlarm, histTemp=histTemp, humUnit=humUnit, trapHumError=trapHumError, trapEmailErrSome=trapEmailErrSome, trapEmailErrSocket=trapEmailErrSocket, traps=traps, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempLowAlarm=trapTempLowAlarm, humInt=humInt, humAlarmInt=humAlarmInt, temp=temp, compValMin=compValMin, tempHystInt=tempHystInt, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, trapTempHighAlarm=trapTempHighAlarm, histHum=histHum, sensorName=sensorName, trapEmailErrAuth=trapEmailErrAuth, compValAlarm=compValAlarm, compValHystInt=compValHystInt, humHystInt=humHystInt, DisplayString=DisplayString, tempAlarm=tempAlarm, hum=hum, trapTest=trapTest, trapTempError=trapTempError, compValInt=compValInt, comet=comet, products=products, trapNTPError=trapNTPError, historyEntry=historyEntry, deviceType=deviceType, humMin=humMin, trapSOAPErrSocket=trapSOAPErrSocket, values=values, tempHighInt=tempHighInt, trapHumClrAlarm=trapHumClrAlarm, compValAlarmInt=compValAlarmInt, pysmi_global=pysmi_global, tempMin=tempMin, trapTempClrAlarm=trapTempClrAlarm, tempMax=tempMax, compValHighInt=compValHighInt, trapHumHighAlarm=trapHumHighAlarm, compVal=compVal, trapCompValError=trapCompValError, trapCompValHighAlarm=trapCompValHighAlarm, compValUnit=compValUnit, tempLowInt=tempLowInt, humDelayInt=humDelayInt, serialNumber=serialNumber, trapEmailErrLogin=trapEmailErrLogin, trapCompValLowAlarm=trapCompValLowAlarm, humHighInt=humHighInt, settings=settings, humMax=humMax, compValMax=compValMax, messageString=messageString, historyTable=historyTable, tables=tables, tempInt=tempInt, valuesInt=valuesInt, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrDNS=trapSOAPErrDNS, humLowInt=humLowInt, compValDelayInt=compValDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, tempAlarmInt=tempAlarmInt)
