...
ModuleIdentity, enterprises, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, iso, Bits, Gauge32, NotificationType, TimeTicks, NotificationType, Integer32, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "iso", "Bits", "Gauge32", "NotificationType", "TimeTicks", "NotificationType", "Integer32", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrSocket=trapSOAPErrSocket, tempHighInt=tempHighInt, sensorName=sensorName, tempAlarmInt=tempAlarmInt, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, compValDelayInt=compValDelayInt, deviceType=deviceType, compValAlarm=compValAlarm, comet=comet, serialNumber=serialNumber, histHum=histHum, trapEmailErrLogin=trapEmailErrLogin, trapTempClrAlarm=trapTempClrAlarm, trapTempError=trapTempError, tempMax=tempMax, trapNTPError=trapNTPError, trapHumError=trapHumError, trapEmailErrSome=trapEmailErrSome, compValInt=compValInt, trapHumHighAlarm=trapHumHighAlarm, valuesInt=valuesInt, compValLowInt=compValLowInt, compValHystInt=compValHystInt, humMax=humMax, tempUnit=tempUnit, temp=temp, messageString=messageString, compValHighInt=compValHighInt, tempMin=tempMin, trapHumClrAlarm=trapHumClrAlarm, trapTest=trapTest, trapEmailErrSocket=trapEmailErrSocket, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm, humAlarmInt=humAlarmInt, humLowInt=humLowInt, trapHumLowAlarm=trapHumLowAlarm, settings=settings, histTemp=histTemp, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, traps=traps, humHighInt=humHighInt, values=values, trapTempHighAlarm=trapTempHighAlarm, tables=tables, compValMin=compValMin, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrAuth=trapEmailErrAuth, trapCompValClrAlarm=trapCompValClrAlarm, trapCompValLowAlarm=trapCompValLowAlarm, historyTable=historyTable, DisplayString=DisplayString, tempAlarm=tempAlarm, tempInt=tempInt, tempHystInt=tempHystInt, trapCompValError=trapCompValError, t3610=t3610, products=products, histCompVal=histCompVal, pysmi_global=pysmi_global, humMin=humMin, humInt=humInt, compValAlarmInt=compValAlarmInt, humAlarm=humAlarm, compValUnit=compValUnit, compVal=compVal, humDelayInt=humDelayInt, trapSOAPErrDelivery=trapSOAPErrDelivery, historyEntry=historyEntry, humUnit=humUnit)
