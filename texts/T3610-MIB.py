...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, enterprises, Bits, Counter32, Gauge32, ObjectIdentity, IpAddress, Integer32, iso, NotificationType, Counter64, Unsigned32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "enterprises", "Bits", "Counter32", "Gauge32", "ObjectIdentity", "IpAddress", "Integer32", "iso", "NotificationType", "Counter64", "Unsigned32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", humInt=humInt, humHighInt=humHighInt, deviceType=deviceType, histTemp=histTemp, temp=temp, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, compValHighInt=compValHighInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, comet=comet, histHum=histHum, tempAlarmInt=tempAlarmInt, trapHumLowAlarm=trapHumLowAlarm, values=values, humMax=humMax, sensorName=sensorName, compValDelayInt=compValDelayInt, trapTest=trapTest, serialNumber=serialNumber, settings=settings, trapTempHighAlarm=trapTempHighAlarm, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, compValLowInt=compValLowInt, products=products, humUnit=humUnit, compValMin=compValMin, humAlarm=humAlarm, tempLowInt=tempLowInt, tempHystInt=tempHystInt, trapCompValHighAlarm=trapCompValHighAlarm, trapHumError=trapHumError, tempInt=tempInt, compValInt=compValInt, messageString=messageString, tempUnit=tempUnit, compValMax=compValMax, trapTempClrAlarm=trapTempClrAlarm, humDelayInt=humDelayInt, t3610=t3610, traps=traps, historyTable=historyTable, humLowInt=humLowInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, tempMax=tempMax, compValHystInt=compValHystInt, tempMin=tempMin, trapHumClrAlarm=trapHumClrAlarm, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrDNS=trapEmailErrDNS, trapCompValError=trapCompValError, historyEntry=historyEntry, hum=hum, humAlarmInt=humAlarmInt, compVal=compVal, compValAlarmInt=compValAlarmInt, trapNTPError=trapNTPError, trapEmailErrLogin=trapEmailErrLogin, tempHighInt=tempHighInt, compValAlarm=compValAlarm, humMin=humMin, trapTempError=trapTempError, tables=tables, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarm=tempAlarm, DisplayString=DisplayString, valuesInt=valuesInt, tempDelayInt=tempDelayInt, compValUnit=compValUnit)
