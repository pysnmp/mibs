...
# Produced by pysmi-1.1.12 at Wed May 29 02:41:17 2024
...
Integer32, Bits, Counter64, NotificationType, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ModuleIdentity, enterprises, Gauge32, Counter32, TimeTicks, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ModuleIdentity", "enterprises", "Gauge32", "Counter32", "TimeTicks", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", trapCompValError=trapCompValError, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, trapTempLowAlarm=trapTempLowAlarm, tempUnit=tempUnit, trapHumHighAlarm=trapHumHighAlarm, tempAlarm=tempAlarm, tables=tables, humLowInt=humLowInt, deviceType=deviceType, compValHighInt=compValHighInt, trapNTPError=trapNTPError, sensorName=sensorName, trapSOAPErrFile=trapSOAPErrFile, historyTable=historyTable, settings=settings, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrDNS=trapEmailErrDNS, humMax=humMax, temp=temp, historyEntry=historyEntry, compValDelayInt=compValDelayInt, tempMin=tempMin, DisplayString=DisplayString, messageString=messageString, trapEmailErrAuth=trapEmailErrAuth, humUnit=humUnit, trapHumError=trapHumError, humInt=humInt, values=values, compValAlarmInt=compValAlarmInt, tempHighInt=tempHighInt, products=products, t3610=t3610, trapSOAPErrDelivery=trapSOAPErrDelivery, humDelayInt=humDelayInt, compValLowInt=compValLowInt, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, compVal=compVal, comet=comet, trapEmailErrSocket=trapEmailErrSocket, histHum=histHum, histTemp=histTemp, humAlarmInt=humAlarmInt, compValMax=compValMax, tempInt=tempInt, compValMin=compValMin, hum=hum, compValInt=compValInt, trapTempHighAlarm=trapTempHighAlarm, trapHumLowAlarm=trapHumLowAlarm, humHighInt=humHighInt, trapTempError=trapTempError, tempHystInt=tempHystInt, traps=traps, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrSome=trapEmailErrSome, tempAlarmInt=tempAlarmInt, tempDelayInt=tempDelayInt, pysmi_global=pysmi_global, compValAlarm=compValAlarm, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, humMin=humMin, serialNumber=serialNumber, humHystInt=humHystInt, compValHystInt=compValHystInt, compValUnit=compValUnit, tempLowInt=tempLowInt, histCompVal=histCompVal, trapTest=trapTest, trapHumClrAlarm=trapHumClrAlarm, humAlarm=humAlarm, valuesInt=valuesInt)
