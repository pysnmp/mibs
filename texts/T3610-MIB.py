...
# Produced by pysmi-1.1.3 at Wed Dec  8 19:48:42 2021
...
NotificationType, TimeTicks, NotificationType, Unsigned32, Integer32, MibIdentifier, Counter64, ModuleIdentity, IpAddress, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "NotificationType", "Unsigned32", "Integer32", "MibIdentifier", "Counter64", "ModuleIdentity", "IpAddress", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", tempAlarmInt=tempAlarmInt, compValAlarm=compValAlarm, compValMin=compValMin, compValAlarmInt=compValAlarmInt, trapEmailErrLogin=trapEmailErrLogin, deviceType=deviceType, trapNTPError=trapNTPError, humInt=humInt, humDelayInt=humDelayInt, valuesInt=valuesInt, compValUnit=compValUnit, hum=hum, trapTempLowAlarm=trapTempLowAlarm, humAlarm=humAlarm, tempMin=tempMin, compVal=compVal, trapSOAPErrSocket=trapSOAPErrSocket, t3610=t3610, values=values, sensorName=sensorName, compValInt=compValInt, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, historyTable=historyTable, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, trapHumHighAlarm=trapHumHighAlarm, tempDelayInt=tempDelayInt, humUnit=humUnit, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, tempHighInt=tempHighInt, historyEntry=historyEntry, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, trapTempClrAlarm=trapTempClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, tempHystInt=tempHystInt, tempMax=tempMax, humLowInt=humLowInt, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humHystInt=humHystInt, serialNumber=serialNumber, trapEmailErrSome=trapEmailErrSome, tempInt=tempInt, DisplayString=DisplayString, temp=temp, settings=settings, humMax=humMax, humMin=humMin, compValHighInt=compValHighInt, tables=tables, tempUnit=tempUnit, compValHystInt=compValHystInt, products=products, trapEmailErrSocket=trapEmailErrSocket, trapHumError=trapHumError, trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, humAlarmInt=humAlarmInt, compValMax=compValMax, pysmi_global=pysmi_global, tempAlarm=tempAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, comet=comet, traps=traps, trapTempError=trapTempError, trapCompValError=trapCompValError, histTemp=histTemp, trapHumClrAlarm=trapHumClrAlarm, compValDelayInt=compValDelayInt)
