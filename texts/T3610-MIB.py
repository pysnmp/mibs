...
Gauge32, Counter32, ModuleIdentity, IpAddress, MibIdentifier, ObjectIdentity, NotificationType, TimeTicks, Unsigned32, enterprises, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "ModuleIdentity", "IpAddress", "MibIdentifier", "ObjectIdentity", "NotificationType", "TimeTicks", "Unsigned32", "enterprises", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", deviceType=deviceType, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, serialNumber=serialNumber, trapCompValClrAlarm=trapCompValClrAlarm, compValUnit=compValUnit, tempHighInt=tempHighInt, trapHumLowAlarm=trapHumLowAlarm, humInt=humInt, messageString=messageString, trapSOAPErrDNS=trapSOAPErrDNS, compValHystInt=compValHystInt, tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, humHystInt=humHystInt, trapTempError=trapTempError, tempAlarmInt=tempAlarmInt, compValAlarm=compValAlarm, pysmi_global=pysmi_global, histCompVal=histCompVal, temp=temp, tempMin=tempMin, humMax=humMax, trapNTPError=trapNTPError, trapEmailErrSocket=trapEmailErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, compValInt=compValInt, compValLowInt=compValLowInt, tempInt=tempInt, tempLowInt=tempLowInt, historyEntry=historyEntry, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, humAlarm=humAlarm, tables=tables, trapHumHighAlarm=trapHumHighAlarm, compValHighInt=compValHighInt, tempAlarm=tempAlarm, sensorName=sensorName, histHum=histHum, settings=settings, DisplayString=DisplayString, traps=traps, tempUnit=tempUnit, tempMax=tempMax, trapHumError=trapHumError, comet=comet, compValMin=compValMin, humLowInt=humLowInt, trapSOAPErrSocket=trapSOAPErrSocket, products=products, humHighInt=humHighInt, humMin=humMin, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, trapTest=trapTest, hum=hum, trapTempLowAlarm=trapTempLowAlarm, humDelayInt=humDelayInt, trapHumClrAlarm=trapHumClrAlarm, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, histTemp=histTemp, trapTempHighAlarm=trapTempHighAlarm, trapEmailErrDNS=trapEmailErrDNS, tempDelayInt=tempDelayInt, values=values, t3610=t3610, historyTable=historyTable, compVal=compVal, trapEmailErrSome=trapEmailErrSome, humUnit=humUnit, compValMax=compValMax)
