...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:08:16 2024
...
IpAddress, Gauge32, iso, enterprises, Counter64, Unsigned32, NotificationType, ObjectIdentity, Integer32, TimeTicks, NotificationType, ModuleIdentity, MibIdentifier, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "iso", "enterprises", "Counter64", "Unsigned32", "NotificationType", "ObjectIdentity", "Integer32", "TimeTicks", "NotificationType", "ModuleIdentity", "MibIdentifier", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", tempMax=tempMax, hum=hum, comet=comet, trapTempHighAlarm=trapTempHighAlarm, compValHighInt=compValHighInt, trapHumError=trapHumError, compVal=compVal, tempDelayInt=tempDelayInt, histCompVal=histCompVal, trapEmailErrAuth=trapEmailErrAuth, trapCompValError=trapCompValError, tempLowInt=tempLowInt, sensorName=sensorName, humMin=humMin, trapSOAPErrFile=trapSOAPErrFile, tempMin=tempMin, trapTempClrAlarm=trapTempClrAlarm, values=values, humHystInt=humHystInt, humDelayInt=humDelayInt, trapHumHighAlarm=trapHumHighAlarm, tempInt=tempInt, pysmi_global=pysmi_global, compValMax=compValMax, trapTempLowAlarm=trapTempLowAlarm, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, histHum=histHum, trapTest=trapTest, humAlarm=humAlarm, deviceType=deviceType, trapCompValHighAlarm=trapCompValHighAlarm, messageString=messageString, tempUnit=tempUnit, compValAlarmInt=compValAlarmInt, histTemp=histTemp, tempAlarm=tempAlarm, compValInt=compValInt, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, trapHumClrAlarm=trapHumClrAlarm, products=products, tables=tables, tempHighInt=tempHighInt, compValUnit=compValUnit, tempAlarmInt=tempAlarmInt, t3610=t3610, serialNumber=serialNumber, tempHystInt=tempHystInt, DisplayString=DisplayString, compValMin=compValMin, trapCompValLowAlarm=trapCompValLowAlarm, trapHumLowAlarm=trapHumLowAlarm, valuesInt=valuesInt, trapSOAPErrSocket=trapSOAPErrSocket, compValAlarm=compValAlarm, humInt=humInt, trapNTPError=trapNTPError, settings=settings, humAlarmInt=humAlarmInt, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, traps=traps, humLowInt=humLowInt, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, humMax=humMax, humHighInt=humHighInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHystInt=compValHystInt, compValLowInt=compValLowInt, compValDelayInt=compValDelayInt, humUnit=humUnit)
