...
ObjectIdentity, Counter64, NotificationType, enterprises, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, ModuleIdentity, iso, Counter32, MibIdentifier, IpAddress, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "NotificationType", "enterprises", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "ModuleIdentity", "iso", "Counter32", "MibIdentifier", "IpAddress", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValHighInt=compValHighInt, compValAlarmInt=compValAlarmInt, histCompVal=histCompVal, tempMin=tempMin, trapCompValError=trapCompValError, trapTempLowAlarm=trapTempLowAlarm, temp=temp, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, compValUnit=compValUnit, humInt=humInt, trapEmailErrSome=trapEmailErrSome, trapHumClrAlarm=trapHumClrAlarm, trapEmailErrAuth=trapEmailErrAuth, tempDelayInt=tempDelayInt, trapHumError=trapHumError, trapCompValClrAlarm=trapCompValClrAlarm, tempHighInt=tempHighInt, compValLowInt=compValLowInt, sensorName=sensorName, compValInt=compValInt, trapCompValHighAlarm=trapCompValHighAlarm, comet=comet, trapSOAPErrFile=trapSOAPErrFile, histHum=histHum, humDelayInt=humDelayInt, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, compVal=compVal, compValAlarm=compValAlarm, pysmi_global=pysmi_global, humAlarm=humAlarm, compValMin=compValMin, trapTest=trapTest, hum=hum, humAlarmInt=humAlarmInt, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, values=values, humMax=humMax, settings=settings, trapEmailErrSocket=trapEmailErrSocket, t3610=t3610, tempAlarm=tempAlarm, historyEntry=historyEntry, tempLowInt=tempLowInt, trapSOAPErrDelivery=trapSOAPErrDelivery, compValMax=compValMax, tables=tables, products=products, humHighInt=humHighInt, tempMax=tempMax, trapSOAPErrDNS=trapSOAPErrDNS, traps=traps, tempHystInt=tempHystInt, compValHystInt=compValHystInt, trapTempError=trapTempError, DisplayString=DisplayString, tempAlarmInt=tempAlarmInt, humLowInt=humLowInt, trapCompValLowAlarm=trapCompValLowAlarm, trapNTPError=trapNTPError, humMin=humMin, serialNumber=serialNumber, humHystInt=humHystInt, trapTempHighAlarm=trapTempHighAlarm, trapTempClrAlarm=trapTempClrAlarm, tempUnit=tempUnit, deviceType=deviceType, histTemp=histTemp, humUnit=humUnit, tempInt=tempInt, valuesInt=valuesInt, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm)
