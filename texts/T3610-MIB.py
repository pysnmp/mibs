...
enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter64, Integer32, NotificationType, Gauge32, ModuleIdentity, IpAddress, iso, MibIdentifier, Counter32, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter64", "Integer32", "NotificationType", "Gauge32", "ModuleIdentity", "IpAddress", "iso", "MibIdentifier", "Counter32", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("T3610-MIB", t3610=t3610, pysmi_global=pysmi_global, compValAlarm=compValAlarm, humDelayInt=humDelayInt, humHystInt=humHystInt, trapSOAPErrDNS=trapSOAPErrDNS, hum=hum, traps=traps, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDelivery=trapSOAPErrDelivery, trapNTPError=trapNTPError, tempHighInt=tempHighInt, trapCompValHighAlarm=trapCompValHighAlarm, historyTable=historyTable, tempUnit=tempUnit, humHighInt=humHighInt, trapEmailErrSocket=trapEmailErrSocket, compVal=compVal, compValLowInt=compValLowInt, trapEmailErrDNS=trapEmailErrDNS, compValInt=compValInt, trapSOAPErrFile=trapSOAPErrFile, tables=tables, histCompVal=histCompVal, trapCompValError=trapCompValError, historyEntry=historyEntry, compValAlarmInt=compValAlarmInt, trapHumError=trapHumError, compValUnit=compValUnit, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempMin=tempMin, trapHumHighAlarm=trapHumHighAlarm, tempAlarmInt=tempAlarmInt, comet=comet, compValMin=compValMin, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, valuesInt=valuesInt, trapEmailErrLogin=trapEmailErrLogin, compValMax=compValMax, trapHumClrAlarm=trapHumClrAlarm, deviceType=deviceType, tempDelayInt=tempDelayInt, tempMax=tempMax, serialNumber=serialNumber, trapTempLowAlarm=trapTempLowAlarm, tempLowInt=tempLowInt, trapEmailErrAuth=trapEmailErrAuth, histTemp=histTemp, humUnit=humUnit, humAlarm=humAlarm, tempAlarm=tempAlarm, compValHystInt=compValHystInt, humMin=humMin, trapHumLowAlarm=trapHumLowAlarm, trapTempError=trapTempError, settings=settings, humAlarmInt=humAlarmInt, DisplayString=DisplayString, products=products, temp=temp, humMax=humMax, tempInt=tempInt, compValHighInt=compValHighInt, histHum=histHum, humInt=humInt, trapTest=trapTest, trapCompValLowAlarm=trapCompValLowAlarm, humLowInt=humLowInt, trapTempClrAlarm=trapTempClrAlarm, values=values, sensorName=sensorName, compValDelayInt=compValDelayInt, tempHystInt=tempHystInt)
