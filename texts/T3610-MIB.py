...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:41:47 2023
...
ModuleIdentity, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, ObjectIdentity, IpAddress, Integer32, MibIdentifier, Counter64, enterprises, iso, Gauge32, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "ObjectIdentity", "IpAddress", "Integer32", "MibIdentifier", "Counter64", "enterprises", "iso", "Gauge32", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValAlarm=compValAlarm, compVal=compVal, humInt=humInt, tempAlarm=tempAlarm, humHighInt=humHighInt, compValAlarmInt=compValAlarmInt, trapHumHighAlarm=trapHumHighAlarm, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, trapEmailErrAuth=trapEmailErrAuth, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, humDelayInt=humDelayInt, trapHumError=trapHumError, tables=tables, historyEntry=historyEntry, trapEmailErrSome=trapEmailErrSome, trapSOAPErrSocket=trapSOAPErrSocket, trapSOAPErrDelivery=trapSOAPErrDelivery, valuesInt=valuesInt, products=products, sensorName=sensorName, serialNumber=serialNumber, tempLowInt=tempLowInt, compValMin=compValMin, tempInt=tempInt, t3610=t3610, deviceType=deviceType, pysmi_global=pysmi_global, hum=hum, messageString=messageString, tempDelayInt=tempDelayInt, trapHumLowAlarm=trapHumLowAlarm, trapCompValHighAlarm=trapCompValHighAlarm, DisplayString=DisplayString, tempUnit=tempUnit, traps=traps, tempHystInt=tempHystInt, histCompVal=histCompVal, humUnit=humUnit, compValMax=compValMax, tempAlarmInt=tempAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, comet=comet, humLowInt=humLowInt, histTemp=histTemp, trapTempHighAlarm=trapTempHighAlarm, settings=settings, humHystInt=humHystInt, compValHystInt=compValHystInt, humAlarm=humAlarm, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, compValHighInt=compValHighInt, historyTable=historyTable, humMin=humMin, tempMin=tempMin, trapSOAPErrFile=trapSOAPErrFile, trapTest=trapTest, trapCompValLowAlarm=trapCompValLowAlarm, trapTempError=trapTempError, humAlarmInt=humAlarmInt, trapTempLowAlarm=trapTempLowAlarm, tempHighInt=tempHighInt, tempMax=tempMax, trapCompValError=trapCompValError, trapEmailErrSocket=trapEmailErrSocket, humMax=humMax, compValUnit=compValUnit, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, values=values, temp=temp)
