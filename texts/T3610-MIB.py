...
# Produced by pysmi-1.1.12 at Tue May 28 13:56:17 2024
...
Bits, IpAddress, enterprises, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Counter64, NotificationType, MibIdentifier, ModuleIdentity, Integer32, TimeTicks, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "enterprises", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Counter64", "NotificationType", "MibIdentifier", "ModuleIdentity", "Integer32", "TimeTicks", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("T3610-MIB", humHighInt=humHighInt, histCompVal=histCompVal, trapSOAPErrDelivery=trapSOAPErrDelivery, deviceType=deviceType, humLowInt=humLowInt, humDelayInt=humDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, pysmi_global=pysmi_global, trapCompValHighAlarm=trapCompValHighAlarm, compValAlarmInt=compValAlarmInt, compValInt=compValInt, settings=settings, trapCompValLowAlarm=trapCompValLowAlarm, serialNumber=serialNumber, histTemp=histTemp, tempAlarm=tempAlarm, trapHumHighAlarm=trapHumHighAlarm, comet=comet, DisplayString=DisplayString, trapHumClrAlarm=trapHumClrAlarm, trapHumError=trapHumError, humAlarmInt=humAlarmInt, trapTest=trapTest, products=products, compValMax=compValMax, values=values, trapTempClrAlarm=trapTempClrAlarm, humMax=humMax, tempHighInt=tempHighInt, humUnit=humUnit, trapTempError=trapTempError, trapCompValError=trapCompValError, tempUnit=tempUnit, compValHystInt=compValHystInt, compValAlarm=compValAlarm, humMin=humMin, tempMax=tempMax, humInt=humInt, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, tempInt=tempInt, messageString=messageString, tempLowInt=tempLowInt, histHum=histHum, trapEmailErrSome=trapEmailErrSome, hum=hum, compValLowInt=compValLowInt, valuesInt=valuesInt, humAlarm=humAlarm, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, traps=traps, temp=temp, t3610=t3610, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSocket=trapEmailErrSocket, compValUnit=compValUnit, trapEmailErrAuth=trapEmailErrAuth, compVal=compVal, trapNTPError=trapNTPError, historyEntry=historyEntry, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrSocket=trapSOAPErrSocket, tempMin=tempMin, trapSOAPErrDNS=trapSOAPErrDNS, historyTable=historyTable, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, compValMin=compValMin, trapTempHighAlarm=trapTempHighAlarm, tables=tables, humHystInt=humHystInt, sensorName=sensorName, tempAlarmInt=tempAlarmInt)
