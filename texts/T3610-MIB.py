...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:19:12 2023
...
Counter32, Gauge32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, TimeTicks, NotificationType, Counter64, NotificationType, Unsigned32, iso, MibIdentifier, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "TimeTicks", "NotificationType", "Counter64", "NotificationType", "Unsigned32", "iso", "MibIdentifier", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, compValAlarmInt=compValAlarmInt, compValDelayInt=compValDelayInt, historyEntry=historyEntry, trapTempLowAlarm=trapTempLowAlarm, humAlarm=humAlarm, settings=settings, trapHumClrAlarm=trapHumClrAlarm, traps=traps, compValUnit=compValUnit, humMin=humMin, trapSOAPErrFile=trapSOAPErrFile, tempLowInt=tempLowInt, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, compValInt=compValInt, histTemp=histTemp, humDelayInt=humDelayInt, hum=hum, humMax=humMax, trapHumError=trapHumError, trapCompValHighAlarm=trapCompValHighAlarm, valuesInt=valuesInt, trapEmailErrSome=trapEmailErrSome, tables=tables, compValLowInt=compValLowInt, values=values, comet=comet, deviceType=deviceType, histCompVal=histCompVal, trapNTPError=trapNTPError, trapEmailErrDNS=trapEmailErrDNS, sensorName=sensorName, tempAlarmInt=tempAlarmInt, trapHumLowAlarm=trapHumLowAlarm, pysmi_global=pysmi_global, trapTempError=trapTempError, humLowInt=humLowInt, compValMax=compValMax, tempDelayInt=tempDelayInt, compValAlarm=compValAlarm, products=products, humHystInt=humHystInt, tempUnit=tempUnit, trapSOAPErrSocket=trapSOAPErrSocket, DisplayString=DisplayString, temp=temp, tempHighInt=tempHighInt, trapTest=trapTest, trapEmailErrLogin=trapEmailErrLogin, t3610=t3610, trapCompValClrAlarm=trapCompValClrAlarm, humAlarmInt=humAlarmInt, tempMax=tempMax, trapCompValLowAlarm=trapCompValLowAlarm, tempMin=tempMin, trapTempHighAlarm=trapTempHighAlarm, tempInt=tempInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValError=trapCompValError, serialNumber=serialNumber, compValHystInt=compValHystInt, historyTable=historyTable, humHighInt=humHighInt, messageString=messageString, tempHystInt=tempHystInt, compValHighInt=compValHighInt, histHum=histHum, trapSOAPErrDNS=trapSOAPErrDNS, compValMin=compValMin, humInt=humInt, tempAlarm=tempAlarm, humUnit=humUnit, compVal=compVal, trapSOAPErrDelivery=trapSOAPErrDelivery)
