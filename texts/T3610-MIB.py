...
Unsigned32, ModuleIdentity, iso, Counter32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Integer32, Gauge32, NotificationType, ObjectIdentity, Bits, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "iso", "Counter32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Integer32", "Gauge32", "NotificationType", "ObjectIdentity", "Bits", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, compValDelayInt=compValDelayInt, trapEmailErrAuth=trapEmailErrAuth, temp=temp, deviceType=deviceType, values=values, hum=hum, compValMin=compValMin, tempHighInt=tempHighInt, humHighInt=humHighInt, trapEmailErrLogin=trapEmailErrLogin, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery, trapHumError=trapHumError, humAlarm=humAlarm, humMin=humMin, histCompVal=histCompVal, histHum=histHum, historyTable=historyTable, tempInt=tempInt, pysmi_global=pysmi_global, comet=comet, trapTempClrAlarm=trapTempClrAlarm, tempUnit=tempUnit, humLowInt=humLowInt, valuesInt=valuesInt, trapHumHighAlarm=trapHumHighAlarm, t3610=t3610, humUnit=humUnit, histTemp=histTemp, tempAlarmInt=tempAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, serialNumber=serialNumber, humHystInt=humHystInt, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, trapCompValError=trapCompValError, humAlarmInt=humAlarmInt, trapEmailErrSocket=trapEmailErrSocket, compValAlarm=compValAlarm, trapCompValClrAlarm=trapCompValClrAlarm, compVal=compVal, settings=settings, historyEntry=historyEntry, compValUnit=compValUnit, tempDelayInt=tempDelayInt, humInt=humInt, humDelayInt=humDelayInt, tempMin=tempMin, humMax=humMax, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, compValHystInt=compValHystInt, messageString=messageString, DisplayString=DisplayString, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, traps=traps, compValHighInt=compValHighInt, trapTest=trapTest, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, products=products, sensorName=sensorName, trapCompValLowAlarm=trapCompValLowAlarm, tempLowInt=tempLowInt, tables=tables, tempAlarm=tempAlarm)
