...
mibBuilder.exportSymbols("T3610-MIB", tempUnit=tempUnit, compValAlarm=compValAlarm, deviceType=deviceType, trapNTPError=trapNTPError, compValMin=compValMin, pysmi_global=pysmi_global, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, trapTempHighAlarm=trapTempHighAlarm, histTemp=histTemp, humLowInt=humLowInt, sensorName=sensorName, traps=traps, humAlarmInt=humAlarmInt, settings=settings, compValLowInt=compValLowInt, DisplayString=DisplayString, tempHystInt=tempHystInt, trapSOAPErrDNS=trapSOAPErrDNS, historyEntry=historyEntry, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, tempMin=tempMin, compValAlarmInt=compValAlarmInt, humMin=humMin, humHystInt=humHystInt, histHum=histHum, trapEmailErrSocket=trapEmailErrSocket, valuesInt=valuesInt, compValInt=compValInt, humHighInt=humHighInt, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, trapHumError=trapHumError, trapEmailErrDNS=trapEmailErrDNS, historyTable=historyTable, comet=comet, tempInt=tempInt, tempAlarm=tempAlarm, tempHighInt=tempHighInt, messageString=messageString, compValHighInt=compValHighInt, compValMax=compValMax, trapCompValClrAlarm=trapCompValClrAlarm, temp=temp, values=values, tempAlarmInt=tempAlarmInt, tempMax=tempMax, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, t3610=t3610, humUnit=humUnit, serialNumber=serialNumber, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, humMax=humMax, products=products, histCompVal=histCompVal, tables=tables, tempLowInt=tempLowInt, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, compValDelayInt=compValDelayInt, hum=hum, compValUnit=compValUnit, humInt=humInt, trapCompValLowAlarm=trapCompValLowAlarm, humAlarm=humAlarm, compValHystInt=compValHystInt, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, tempDelayInt=tempDelayInt, compVal=compVal)
