...
# Produced by pysmi-1.1.8 at Thu Sep  7 09:12:44 2023
...
IpAddress, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, TimeTicks, NotificationType, MibIdentifier, Gauge32, Unsigned32, Integer32, Counter32, enterprises, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "TimeTicks", "NotificationType", "MibIdentifier", "Gauge32", "Unsigned32", "Integer32", "Counter32", "enterprises", "iso", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrLogin=trapEmailErrLogin, historyEntry=historyEntry, hum=hum, tempAlarm=tempAlarm, tempHighInt=tempHighInt, trapCompValLowAlarm=trapCompValLowAlarm, histHum=histHum, compValAlarm=compValAlarm, tables=tables, trapNTPError=trapNTPError, trapTempError=trapTempError, sensorName=sensorName, compValDelayInt=compValDelayInt, values=values, compValHystInt=compValHystInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, histTemp=histTemp, compValMin=compValMin, humMax=humMax, humDelayInt=humDelayInt, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrFile=trapSOAPErrFile, humAlarm=humAlarm, humUnit=humUnit, trapCompValHighAlarm=trapCompValHighAlarm, trapTempLowAlarm=trapTempLowAlarm, t3610=t3610, trapEmailErrSocket=trapEmailErrSocket, DisplayString=DisplayString, trapEmailErrSome=trapEmailErrSome, humHystInt=humHystInt, trapEmailErrDNS=trapEmailErrDNS, compValMax=compValMax, tempLowInt=tempLowInt, compValLowInt=compValLowInt, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, tempDelayInt=tempDelayInt, trapCompValError=trapCompValError, serialNumber=serialNumber, trapHumLowAlarm=trapHumLowAlarm, compValHighInt=compValHighInt, messageString=messageString, humLowInt=humLowInt, compValUnit=compValUnit, compValAlarmInt=compValAlarmInt, humInt=humInt, trapHumError=trapHumError, tempInt=tempInt, trapTempClrAlarm=trapTempClrAlarm, compVal=compVal, deviceType=deviceType, trapSOAPErrDelivery=trapSOAPErrDelivery, traps=traps, temp=temp, tempHystInt=tempHystInt, trapHumClrAlarm=trapHumClrAlarm, tempMin=tempMin, comet=comet, humMin=humMin, tempMax=tempMax, compValInt=compValInt, settings=settings, valuesInt=valuesInt, histCompVal=histCompVal, products=products, historyTable=historyTable, tempAlarmInt=tempAlarmInt, tempUnit=tempUnit, pysmi_global=pysmi_global, humHighInt=humHighInt, trapTest=trapTest)
