...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:11:51 2022
...
NotificationType, Counter32, ModuleIdentity, enterprises, Bits, Gauge32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ObjectIdentity, MibIdentifier, NotificationType, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ModuleIdentity", "enterprises", "Bits", "Gauge32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ObjectIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", trapEmailErrAuth=trapEmailErrAuth, DisplayString=DisplayString, values=values, valuesInt=valuesInt, tempAlarm=tempAlarm, humMax=humMax, trapEmailErrSocket=trapEmailErrSocket, deviceType=deviceType, compValAlarmInt=compValAlarmInt, humHighInt=humHighInt, trapCompValLowAlarm=trapCompValLowAlarm, compValMin=compValMin, trapHumError=trapHumError, histCompVal=histCompVal, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrDNS=trapEmailErrDNS, humHystInt=humHystInt, compValAlarm=compValAlarm, humAlarm=humAlarm, histHum=histHum, compVal=compVal, humLowInt=humLowInt, historyTable=historyTable, compValDelayInt=compValDelayInt, products=products, tempDelayInt=tempDelayInt, tempLowInt=tempLowInt, trapSOAPErrDNS=trapSOAPErrDNS, trapTempHighAlarm=trapTempHighAlarm, trapCompValClrAlarm=trapCompValClrAlarm, tempAlarmInt=tempAlarmInt, trapEmailErrLogin=trapEmailErrLogin, serialNumber=serialNumber, trapNTPError=trapNTPError, tempHighInt=tempHighInt, settings=settings, tempUnit=tempUnit, compValMax=compValMax, compValInt=compValInt, tempInt=tempInt, humAlarmInt=humAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, humDelayInt=humDelayInt, compValUnit=compValUnit, tempHystInt=tempHystInt, humUnit=humUnit, compValHystInt=compValHystInt, tempMin=tempMin, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHighInt=compValHighInt, trapTempClrAlarm=trapTempClrAlarm, pysmi_global=pysmi_global, humInt=humInt, trapTempError=trapTempError, comet=comet, messageString=messageString, trapHumLowAlarm=trapHumLowAlarm, sensorName=sensorName, tempMax=tempMax, tables=tables, trapEmailErrSome=trapEmailErrSome, histTemp=histTemp, trapCompValError=trapCompValError, historyEntry=historyEntry, t3610=t3610, trapTest=trapTest, trapHumHighAlarm=trapHumHighAlarm, compValLowInt=compValLowInt, traps=traps, hum=hum, trapTempLowAlarm=trapTempLowAlarm, temp=temp, trapHumClrAlarm=trapHumClrAlarm, trapCompValHighAlarm=trapCompValHighAlarm, humMin=humMin)
