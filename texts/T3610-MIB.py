...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:05:54 2022
...
NotificationType, Counter64, IpAddress, enterprises, Counter32, Gauge32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, iso, ModuleIdentity, Bits, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "IpAddress", "enterprises", "Counter32", "Gauge32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "iso", "ModuleIdentity", "Bits", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", trapTempLowAlarm=trapTempLowAlarm, temp=temp, trapSOAPErrSocket=trapSOAPErrSocket, messageString=messageString, compValAlarm=compValAlarm, humMin=humMin, humLowInt=humLowInt, tempUnit=tempUnit, trapSOAPErrDNS=trapSOAPErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValError=trapCompValError, tempMax=tempMax, comet=comet, t3610=t3610, compValMax=compValMax, sensorName=sensorName, humInt=humInt, compValHighInt=compValHighInt, humHystInt=humHystInt, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, humAlarmInt=humAlarmInt, histTemp=histTemp, tempDelayInt=tempDelayInt, trapNTPError=trapNTPError, compValDelayInt=compValDelayInt, settings=settings, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, tempInt=tempInt, compValAlarmInt=compValAlarmInt, trapSOAPErrFile=trapSOAPErrFile, tables=tables, trapCompValClrAlarm=trapCompValClrAlarm, pysmi_global=pysmi_global, traps=traps, compValLowInt=compValLowInt, humDelayInt=humDelayInt, humAlarm=humAlarm, tempHystInt=tempHystInt, values=values, compValMin=compValMin, humHighInt=humHighInt, trapHumHighAlarm=trapHumHighAlarm, tempMin=tempMin, serialNumber=serialNumber, tempAlarmInt=tempAlarmInt, compValHystInt=compValHystInt, deviceType=deviceType, historyEntry=historyEntry, compValInt=compValInt, DisplayString=DisplayString, trapCompValLowAlarm=trapCompValLowAlarm, trapTempHighAlarm=trapTempHighAlarm, trapTempError=trapTempError, histHum=histHum, trapHumError=trapHumError, historyTable=historyTable, trapHumLowAlarm=trapHumLowAlarm, hum=hum, trapEmailErrAuth=trapEmailErrAuth, humMax=humMax, compVal=compVal, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrDNS=trapEmailErrDNS, valuesInt=valuesInt, compValUnit=compValUnit, products=products, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, tempAlarm=tempAlarm, tempHighInt=tempHighInt, humUnit=humUnit, trapTest=trapTest)
