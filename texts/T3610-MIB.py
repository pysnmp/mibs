...
# Produced by pysmi-1.1.8 at Thu Dec 15 08:20:46 2022
...
ModuleIdentity, enterprises, TimeTicks, Counter64, IpAddress, iso, MibIdentifier, Unsigned32, Integer32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "TimeTicks", "Counter64", "IpAddress", "iso", "MibIdentifier", "Unsigned32", "Integer32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", historyEntry=historyEntry, trapSOAPErrSocket=trapSOAPErrSocket, humLowInt=humLowInt, compValLowInt=compValLowInt, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, histCompVal=histCompVal, tempLowInt=tempLowInt, humHystInt=humHystInt, trapCompValLowAlarm=trapCompValLowAlarm, trapHumError=trapHumError, humAlarm=humAlarm, trapTempHighAlarm=trapTempHighAlarm, products=products, trapHumLowAlarm=trapHumLowAlarm, compValInt=compValInt, humUnit=humUnit, compValAlarm=compValAlarm, compValUnit=compValUnit, compValMax=compValMax, compValHighInt=compValHighInt, compValDelayInt=compValDelayInt, trapEmailErrDNS=trapEmailErrDNS, temp=temp, tempHystInt=tempHystInt, histTemp=histTemp, tempInt=tempInt, trapCompValHighAlarm=trapCompValHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, trapEmailErrSocket=trapEmailErrSocket, DisplayString=DisplayString, sensorName=sensorName, hum=hum, humMax=humMax, trapNTPError=trapNTPError, compValAlarmInt=compValAlarmInt, humDelayInt=humDelayInt, compValMin=compValMin, trapTest=trapTest, valuesInt=valuesInt, compVal=compVal, tables=tables, histHum=histHum, trapTempClrAlarm=trapTempClrAlarm, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, tempHighInt=tempHighInt, trapEmailErrAuth=trapEmailErrAuth, pysmi_global=pysmi_global, tempAlarm=tempAlarm, tempMin=tempMin, serialNumber=serialNumber, messageString=messageString, trapEmailErrLogin=trapEmailErrLogin, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, trapTempLowAlarm=trapTempLowAlarm, values=values, deviceType=deviceType, trapCompValError=trapCompValError, tempUnit=tempUnit, settings=settings, humAlarmInt=humAlarmInt, traps=traps, humMin=humMin, tempAlarmInt=tempAlarmInt, trapSOAPErrDNS=trapSOAPErrDNS, humInt=humInt, compValHystInt=compValHystInt, comet=comet, trapEmailErrSome=trapEmailErrSome, humHighInt=humHighInt, tempMax=tempMax, t3610=t3610)
