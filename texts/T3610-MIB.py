...
# Produced by pysmi-1.1.12 at Tue Jun 18 02:32:32 2024
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits, Gauge32, iso, TimeTicks, NotificationType, Counter64, Integer32, IpAddress, enterprises, MibIdentifier, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits", "Gauge32", "iso", "TimeTicks", "NotificationType", "Counter64", "Integer32", "IpAddress", "enterprises", "MibIdentifier", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", hum=hum, compValMax=compValMax, trapHumLowAlarm=trapHumLowAlarm, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, temp=temp, humAlarm=humAlarm, trapTest=trapTest, tempHystInt=tempHystInt, histHum=histHum, tempAlarm=tempAlarm, trapHumError=trapHumError, valuesInt=valuesInt, trapCompValError=trapCompValError, traps=traps, humHystInt=humHystInt, products=products, compVal=compVal, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, humInt=humInt, humAlarmInt=humAlarmInt, tempAlarmInt=tempAlarmInt, trapEmailErrSocket=trapEmailErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, tempInt=tempInt, trapEmailErrAuth=trapEmailErrAuth, deviceType=deviceType, tempLowInt=tempLowInt, tempUnit=tempUnit, tables=tables, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, humMax=humMax, compValAlarmInt=compValAlarmInt, values=values, compValInt=compValInt, tempDelayInt=tempDelayInt, t3610=t3610, settings=settings, trapNTPError=trapNTPError, trapSOAPErrFile=trapSOAPErrFile, compValHystInt=compValHystInt, sensorName=sensorName, histCompVal=histCompVal, tempHighInt=tempHighInt, humUnit=humUnit, humLowInt=humLowInt, humMin=humMin, compValAlarm=compValAlarm, messageString=messageString, historyTable=historyTable, historyEntry=historyEntry, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, trapHumClrAlarm=trapHumClrAlarm, compValDelayInt=compValDelayInt, trapSOAPErrDNS=trapSOAPErrDNS, serialNumber=serialNumber, compValHighInt=compValHighInt, humHighInt=humHighInt, trapEmailErrDNS=trapEmailErrDNS, DisplayString=DisplayString, tempMin=tempMin, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrSocket=trapSOAPErrSocket, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, humDelayInt=humDelayInt, compValUnit=compValUnit, trapEmailErrLogin=trapEmailErrLogin, comet=comet, trapTempClrAlarm=trapTempClrAlarm)
