...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:15:37 2024
...
ObjectIdentity, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, MibIdentifier, Gauge32, iso, Counter32, Unsigned32, ModuleIdentity, Integer32, TimeTicks, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "MibIdentifier", "Gauge32", "iso", "Counter32", "Unsigned32", "ModuleIdentity", "Integer32", "TimeTicks", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", settings=settings, tempDelayInt=tempDelayInt, histCompVal=histCompVal, DisplayString=DisplayString, trapEmailErrSocket=trapEmailErrSocket, humLowInt=humLowInt, histTemp=histTemp, compVal=compVal, trapCompValError=trapCompValError, humMin=humMin, compValHighInt=compValHighInt, compValAlarmInt=compValAlarmInt, trapTempClrAlarm=trapTempClrAlarm, humHighInt=humHighInt, trapHumClrAlarm=trapHumClrAlarm, tempHystInt=tempHystInt, trapEmailErrSome=trapEmailErrSome, trapTempError=trapTempError, temp=temp, tempUnit=tempUnit, pysmi_global=pysmi_global, compValMin=compValMin, valuesInt=valuesInt, tables=tables, compValMax=compValMax, trapEmailErrAuth=trapEmailErrAuth, serialNumber=serialNumber, tempMax=tempMax, humHystInt=humHystInt, compValInt=compValInt, historyTable=historyTable, trapSOAPErrFile=trapSOAPErrFile, tempAlarm=tempAlarm, sensorName=sensorName, humInt=humInt, humDelayInt=humDelayInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, histHum=histHum, trapNTPError=trapNTPError, humAlarm=humAlarm, tempAlarmInt=tempAlarmInt, trapTest=trapTest, trapSOAPErrDelivery=trapSOAPErrDelivery, products=products, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapTempHighAlarm=trapTempHighAlarm, historyEntry=historyEntry, hum=hum, trapSOAPErrDNS=trapSOAPErrDNS, traps=traps, compValDelayInt=compValDelayInt, tempLowInt=tempLowInt, values=values, trapHumHighAlarm=trapHumHighAlarm, compValAlarm=compValAlarm, trapHumError=trapHumError, compValLowInt=compValLowInt, trapCompValClrAlarm=trapCompValClrAlarm, trapEmailErrLogin=trapEmailErrLogin, humMax=humMax, humUnit=humUnit, tempHighInt=tempHighInt, compValUnit=compValUnit, messageString=messageString, trapTempLowAlarm=trapTempLowAlarm, humAlarmInt=humAlarmInt, t3610=t3610, compValHystInt=compValHystInt, deviceType=deviceType, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, comet=comet, tempInt=tempInt)
