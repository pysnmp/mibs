...
enterprises, Unsigned32, Bits, IpAddress, TimeTicks, Counter32, iso, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Counter64, Integer32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "Bits", "IpAddress", "TimeTicks", "Counter32", "iso", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Counter64", "Integer32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("T3610-MIB", compValInt=compValInt, trapSOAPErrDNS=trapSOAPErrDNS, humMin=humMin, humHystInt=humHystInt, trapTempError=trapTempError, tempInt=tempInt, humUnit=humUnit, tempLowInt=tempLowInt, historyEntry=historyEntry, traps=traps, trapHumError=trapHumError, histTemp=histTemp, compValHighInt=compValHighInt, trapSOAPErrFile=trapSOAPErrFile, trapEmailErrLogin=trapEmailErrLogin, trapCompValClrAlarm=trapCompValClrAlarm, tempDelayInt=tempDelayInt, tables=tables, tempHighInt=tempHighInt, messageString=messageString, histCompVal=histCompVal, trapHumClrAlarm=trapHumClrAlarm, tempAlarm=tempAlarm, compValAlarm=compValAlarm, humAlarmInt=humAlarmInt, hum=hum, products=products, humMax=humMax, compValHystInt=compValHystInt, valuesInt=valuesInt, sensorName=sensorName, trapEmailErrDNS=trapEmailErrDNS, compVal=compVal, trapNTPError=trapNTPError, trapHumLowAlarm=trapHumLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, compValMin=compValMin, deviceType=deviceType, trapEmailErrAuth=trapEmailErrAuth, compValLowInt=compValLowInt, humDelayInt=humDelayInt, serialNumber=serialNumber, compValDelayInt=compValDelayInt, tempAlarmInt=tempAlarmInt, tempMin=tempMin, compValUnit=compValUnit, humInt=humInt, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, comet=comet, DisplayString=DisplayString, trapCompValLowAlarm=trapCompValLowAlarm, trapTempLowAlarm=trapTempLowAlarm, trapHumHighAlarm=trapHumHighAlarm, tempHystInt=tempHystInt, humLowInt=humLowInt, trapCompValHighAlarm=trapCompValHighAlarm, pysmi_global=pysmi_global, historyTable=historyTable, trapTempClrAlarm=trapTempClrAlarm, histHum=histHum, values=values, trapEmailErrSocket=trapEmailErrSocket, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValError=trapCompValError, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, settings=settings, humAlarm=humAlarm, tempMax=tempMax, compValAlarmInt=compValAlarmInt, tempUnit=tempUnit, compValMax=compValMax, temp=temp, t3610=t3610)
