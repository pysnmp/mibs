...
# Produced by pysmi-1.1.12 at Wed Jul  3 10:43:59 2024
...
IpAddress, TimeTicks, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter32, iso, enterprises, NotificationType, MibIdentifier, Gauge32, Unsigned32, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter32", "iso", "enterprises", "NotificationType", "MibIdentifier", "Gauge32", "Unsigned32", "Counter64", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", traps=traps, values=values, humLowInt=humLowInt, compValUnit=compValUnit, compValHighInt=compValHighInt, trapCompValError=trapCompValError, t3610=t3610, temp=temp, humDelayInt=humDelayInt, trapEmailErrDNS=trapEmailErrDNS, hum=hum, trapEmailErrAuth=trapEmailErrAuth, trapHumError=trapHumError, compVal=compVal, humMax=humMax, trapTempError=trapTempError, historyTable=historyTable, histTemp=histTemp, tables=tables, sensorName=sensorName, tempAlarm=tempAlarm, tempInt=tempInt, humUnit=humUnit, trapCompValHighAlarm=trapCompValHighAlarm, compValMin=compValMin, tempMax=tempMax, humAlarmInt=humAlarmInt, compValHystInt=compValHystInt, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrFile=trapSOAPErrFile, valuesInt=valuesInt, messageString=messageString, trapTest=trapTest, histCompVal=histCompVal, compValLowInt=compValLowInt, trapSOAPErrSocket=trapSOAPErrSocket, humAlarm=humAlarm, deviceType=deviceType, trapHumClrAlarm=trapHumClrAlarm, trapHumLowAlarm=trapHumLowAlarm, compValAlarm=compValAlarm, comet=comet, compValInt=compValInt, tempHighInt=tempHighInt, humMin=humMin, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, compValDelayInt=compValDelayInt, humHighInt=humHighInt, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, products=products, settings=settings, trapSOAPErrDNS=trapSOAPErrDNS, tempDelayInt=tempDelayInt, trapCompValClrAlarm=trapCompValClrAlarm, trapTempLowAlarm=trapTempLowAlarm, serialNumber=serialNumber, tempMin=tempMin, humHystInt=humHystInt, humInt=humInt, compValAlarmInt=compValAlarmInt, tempUnit=tempUnit, DisplayString=DisplayString, compValMax=compValMax, tempLowInt=tempLowInt, histHum=histHum, trapNTPError=trapNTPError, trapHumHighAlarm=trapHumHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, tempHystInt=tempHystInt, historyEntry=historyEntry, tempAlarmInt=tempAlarmInt)
