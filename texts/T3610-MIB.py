...
Bits, iso, NotificationType, Counter64, Counter32, NotificationType, Integer32, ObjectIdentity, Unsigned32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "NotificationType", "Counter64", "Counter32", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumError=trapHumError, compValHystInt=compValHystInt, humAlarm=humAlarm, trapEmailErrSocket=trapEmailErrSocket, tempUnit=tempUnit, humAlarmInt=humAlarmInt, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, settings=settings, compValUnit=compValUnit, trapCompValHighAlarm=trapCompValHighAlarm, trapTest=trapTest, valuesInt=valuesInt, trapCompValClrAlarm=trapCompValClrAlarm, trapHumClrAlarm=trapHumClrAlarm, compValDelayInt=compValDelayInt, serialNumber=serialNumber, pysmi_global=pysmi_global, tempInt=tempInt, values=values, tempDelayInt=tempDelayInt, deviceType=deviceType, tempLowInt=tempLowInt, histHum=histHum, trapEmailErrLogin=trapEmailErrLogin, trapHumHighAlarm=trapHumHighAlarm, comet=comet, compValMin=compValMin, tempHighInt=tempHighInt, t3610=t3610, histTemp=histTemp, humLowInt=humLowInt, humInt=humInt, compValAlarm=compValAlarm, compValMax=compValMax, humMax=humMax, tables=tables, compValInt=compValInt, tempHystInt=tempHystInt, tempMin=tempMin, hum=hum, trapSOAPErrFile=trapSOAPErrFile, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarmInt=tempAlarmInt, trapEmailErrSome=trapEmailErrSome, messageString=messageString, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrAuth=trapEmailErrAuth, historyTable=historyTable, temp=temp, DisplayString=DisplayString, sensorName=sensorName, compValLowInt=compValLowInt, trapTempLowAlarm=trapTempLowAlarm, trapTempError=trapTempError, traps=traps, products=products, humUnit=humUnit, tempAlarm=tempAlarm, compValAlarmInt=compValAlarmInt, historyEntry=historyEntry, histCompVal=histCompVal, trapEmailErrDNS=trapEmailErrDNS, trapNTPError=trapNTPError, compVal=compVal, humMin=humMin, compValHighInt=compValHighInt, humHighInt=humHighInt, humHystInt=humHystInt, trapTempClrAlarm=trapTempClrAlarm, trapSOAPErrDNS=trapSOAPErrDNS, trapHumLowAlarm=trapHumLowAlarm, tempMax=tempMax, humDelayInt=humDelayInt)
