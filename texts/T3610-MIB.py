...
# Produced by pysmi-1.1.10 at Fri Nov 10 07:39:09 2023
...
Unsigned32, IpAddress, ObjectIdentity, Bits, Integer32, Gauge32, NotificationType, NotificationType, TimeTicks, Counter64, enterprises, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "ObjectIdentity", "Bits", "Integer32", "Gauge32", "NotificationType", "NotificationType", "TimeTicks", "Counter64", "enterprises", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("T3610-MIB", tempHystInt=tempHystInt, tempMax=tempMax, trapCompValHighAlarm=trapCompValHighAlarm, trapHumHighAlarm=trapHumHighAlarm, trapSOAPErrFile=trapSOAPErrFile, t3610=t3610, products=products, tempMin=tempMin, trapTempClrAlarm=trapTempClrAlarm, tempAlarm=tempAlarm, valuesInt=valuesInt, trapHumError=trapHumError, humMax=humMax, tempInt=tempInt, humAlarmInt=humAlarmInt, compValHystInt=compValHystInt, messageString=messageString, settings=settings, comet=comet, humHighInt=humHighInt, trapEmailErrLogin=trapEmailErrLogin, trapNTPError=trapNTPError, humDelayInt=humDelayInt, compValHighInt=compValHighInt, histTemp=histTemp, tempLowInt=tempLowInt, historyTable=historyTable, humUnit=humUnit, humMin=humMin, compValLowInt=compValLowInt, histCompVal=histCompVal, compValMax=compValMax, trapCompValError=trapCompValError, tables=tables, histHum=histHum, compValAlarm=compValAlarm, historyEntry=historyEntry, humInt=humInt, humHystInt=humHystInt, compVal=compVal, trapHumLowAlarm=trapHumLowAlarm, DisplayString=DisplayString, trapSOAPErrDNS=trapSOAPErrDNS, traps=traps, tempHighInt=tempHighInt, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, pysmi_global=pysmi_global, compValAlarmInt=compValAlarmInt, humLowInt=humLowInt, tempAlarmInt=tempAlarmInt, compValMin=compValMin, trapTest=trapTest, trapCompValLowAlarm=trapCompValLowAlarm, hum=hum, trapSOAPErrSocket=trapSOAPErrSocket, deviceType=deviceType, trapTempError=trapTempError, trapTempLowAlarm=trapTempLowAlarm, sensorName=sensorName, values=values, compValUnit=compValUnit, tempUnit=tempUnit, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrAuth=trapEmailErrAuth, serialNumber=serialNumber, humAlarm=humAlarm, tempDelayInt=tempDelayInt, trapEmailErrDNS=trapEmailErrDNS, temp=temp, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, compValInt=compValInt)
