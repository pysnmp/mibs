...
# Produced by pysmi-1.1.12 at Fri Nov 22 11:53:13 2024
...
ModuleIdentity, Counter32, Counter64, Gauge32, MibIdentifier, TimeTicks, ObjectIdentity, NotificationType, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Unsigned32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Counter64", "Gauge32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "NotificationType", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Unsigned32", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", trapNTPError=trapNTPError, tempUnit=tempUnit, tempAlarmInt=tempAlarmInt, settings=settings, trapHumError=trapHumError, trapCompValError=trapCompValError, tempLowInt=tempLowInt, humLowInt=humLowInt, trapHumClrAlarm=trapHumClrAlarm, historyEntry=historyEntry, serialNumber=serialNumber, compValUnit=compValUnit, tempMax=tempMax, humAlarm=humAlarm, trapEmailErrDNS=trapEmailErrDNS, trapCompValLowAlarm=trapCompValLowAlarm, histTemp=histTemp, trapSOAPErrSocket=trapSOAPErrSocket, t3610=t3610, histHum=histHum, trapTempLowAlarm=trapTempLowAlarm, values=values, pysmi_global=pysmi_global, compValMax=compValMax, compValAlarmInt=compValAlarmInt, trapEmailErrAuth=trapEmailErrAuth, messageString=messageString, trapTempClrAlarm=trapTempClrAlarm, tempHystInt=tempHystInt, compValMin=compValMin, compValInt=compValInt, compValLowInt=compValLowInt, trapEmailErrSome=trapEmailErrSome, comet=comet, hum=hum, trapSOAPErrDelivery=trapSOAPErrDelivery, compValHighInt=compValHighInt, trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, tempMin=tempMin, humHystInt=humHystInt, trapTest=trapTest, trapCompValHighAlarm=trapCompValHighAlarm, sensorName=sensorName, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, histCompVal=histCompVal, trapTempHighAlarm=trapTempHighAlarm, trapSOAPErrDNS=trapSOAPErrDNS, temp=temp, humInt=humInt, tempDelayInt=tempDelayInt, trapHumHighAlarm=trapHumHighAlarm, humAlarmInt=humAlarmInt, trapTempError=trapTempError, products=products, trapEmailErrSocket=trapEmailErrSocket, tables=tables, DisplayString=DisplayString, deviceType=deviceType, humMin=humMin, humDelayInt=humDelayInt, trapEmailErrLogin=trapEmailErrLogin, valuesInt=valuesInt, historyTable=historyTable, compValHystInt=compValHystInt, traps=traps, compValDelayInt=compValDelayInt, compValAlarm=compValAlarm, tempAlarm=tempAlarm, humMax=humMax, compVal=compVal, humUnit=humUnit, trapCompValClrAlarm=trapCompValClrAlarm, tempHighInt=tempHighInt)
