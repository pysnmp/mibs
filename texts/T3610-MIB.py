...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:53:42 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Unsigned32, Integer32, Bits, NotificationType, IpAddress, iso, MibIdentifier, enterprises, TimeTicks, ModuleIdentity, Counter64, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Unsigned32", "Integer32", "Bits", "NotificationType", "IpAddress", "iso", "MibIdentifier", "enterprises", "TimeTicks", "ModuleIdentity", "Counter64", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("T3610-MIB", humMax=humMax, trapCompValLowAlarm=trapCompValLowAlarm, deviceType=deviceType, tempAlarm=tempAlarm, histHum=histHum, historyEntry=historyEntry, tempLowInt=tempLowInt, hum=hum, comet=comet, humInt=humInt, humMin=humMin, humAlarm=humAlarm, tempHystInt=tempHystInt, tempMin=tempMin, trapEmailErrDNS=trapEmailErrDNS, compValInt=compValInt, compVal=compVal, pysmi_global=pysmi_global, trapTempLowAlarm=trapTempLowAlarm, humHystInt=humHystInt, historyTable=historyTable, trapEmailErrLogin=trapEmailErrLogin, tempMax=tempMax, trapSOAPErrDelivery=trapSOAPErrDelivery, compValAlarm=compValAlarm, humAlarmInt=humAlarmInt, trapHumHighAlarm=trapHumHighAlarm, products=products, compValDelayInt=compValDelayInt, trapHumError=trapHumError, temp=temp, messageString=messageString, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, compValAlarmInt=compValAlarmInt, compValHystInt=compValHystInt, humLowInt=humLowInt, trapSOAPErrSocket=trapSOAPErrSocket, tempAlarmInt=tempAlarmInt, valuesInt=valuesInt, compValMin=compValMin, sensorName=sensorName, serialNumber=serialNumber, traps=traps, tempInt=tempInt, t3610=t3610, trapSOAPErrFile=trapSOAPErrFile, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, DisplayString=DisplayString, trapSOAPErrDNS=trapSOAPErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapNTPError=trapNTPError, tables=tables, trapCompValError=trapCompValError, compValUnit=compValUnit, settings=settings, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, histCompVal=histCompVal, trapTest=trapTest, tempDelayInt=tempDelayInt, humDelayInt=humDelayInt, tempUnit=tempUnit, compValMax=compValMax, humHighInt=humHighInt, compValHighInt=compValHighInt, trapEmailErrAuth=trapEmailErrAuth, values=values, trapEmailErrSocket=trapEmailErrSocket, tempHighInt=tempHighInt, trapTempClrAlarm=trapTempClrAlarm, humUnit=humUnit, trapEmailErrSome=trapEmailErrSome, compValLowInt=compValLowInt)
