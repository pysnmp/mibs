...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:21:56 2022
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Unsigned32, MibIdentifier, Counter64, iso, Counter32, Integer32, enterprises, Gauge32, ObjectIdentity, TimeTicks, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Counter64", "iso", "Counter32", "Integer32", "enterprises", "Gauge32", "ObjectIdentity", "TimeTicks", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("T3610-MIB", histTemp=histTemp, compValHighInt=compValHighInt, trapSOAPErrDNS=trapSOAPErrDNS, traps=traps, tempMin=tempMin, tempHighInt=tempHighInt, trapEmailErrLogin=trapEmailErrLogin, trapTempError=trapTempError, trapCompValError=trapCompValError, pysmi_global=pysmi_global, DisplayString=DisplayString, compValHystInt=compValHystInt, serialNumber=serialNumber, products=products, humHighInt=humHighInt, tempAlarmInt=tempAlarmInt, trapEmailErrDNS=trapEmailErrDNS, trapCompValHighAlarm=trapCompValHighAlarm, historyEntry=historyEntry, compValAlarm=compValAlarm, hum=hum, compValMin=compValMin, compVal=compVal, histHum=histHum, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrAuth=trapEmailErrAuth, trapCompValClrAlarm=trapCompValClrAlarm, valuesInt=valuesInt, humHystInt=humHystInt, trapSOAPErrFile=trapSOAPErrFile, compValAlarmInt=compValAlarmInt, trapTempLowAlarm=trapTempLowAlarm, trapNTPError=trapNTPError, humAlarm=humAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, compValUnit=compValUnit, tempUnit=tempUnit, humUnit=humUnit, settings=settings, humMax=humMax, tempHystInt=tempHystInt, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, humAlarmInt=humAlarmInt, trapTempClrAlarm=trapTempClrAlarm, trapHumLowAlarm=trapHumLowAlarm, tempDelayInt=tempDelayInt, tables=tables, values=values, messageString=messageString, trapTempHighAlarm=trapTempHighAlarm, trapHumError=trapHumError, tempMax=tempMax, humDelayInt=humDelayInt, humInt=humInt, deviceType=deviceType, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, compValLowInt=compValLowInt, humLowInt=humLowInt, compValMax=compValMax, temp=temp, t3610=t3610, humMin=humMin, comet=comet, tempAlarm=tempAlarm, compValDelayInt=compValDelayInt, trapTest=trapTest, trapEmailErrSome=trapEmailErrSome, tempLowInt=tempLowInt, trapEmailErrSocket=trapEmailErrSocket, compValInt=compValInt, tempInt=tempInt, trapCompValLowAlarm=trapCompValLowAlarm, sensorName=sensorName)
