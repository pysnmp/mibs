...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:40:50 2022
...
IpAddress, Counter32, iso, Bits, MibIdentifier, Integer32, Counter64, enterprises, Gauge32, ObjectIdentity, Unsigned32, NotificationType, NotificationType, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "iso", "Bits", "MibIdentifier", "Integer32", "Counter64", "enterprises", "Gauge32", "ObjectIdentity", "Unsigned32", "NotificationType", "NotificationType", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("T3610-MIB", DisplayString=DisplayString, trapTempLowAlarm=trapTempLowAlarm, trapSOAPErrFile=trapSOAPErrFile, tempInt=tempInt, humHighInt=humHighInt, temp=temp, compVal=compVal, trapEmailErrLogin=trapEmailErrLogin, humAlarm=humAlarm, trapCompValError=trapCompValError, traps=traps, trapEmailErrAuth=trapEmailErrAuth, trapTempClrAlarm=trapTempClrAlarm, compValLowInt=compValLowInt, trapCompValLowAlarm=trapCompValLowAlarm, hum=hum, trapCompValHighAlarm=trapCompValHighAlarm, tempHystInt=tempHystInt, comet=comet, trapSOAPErrDelivery=trapSOAPErrDelivery, historyEntry=historyEntry, trapHumLowAlarm=trapHumLowAlarm, tempMax=tempMax, messageString=messageString, humHystInt=humHystInt, trapNTPError=trapNTPError, tables=tables, deviceType=deviceType, tempAlarmInt=tempAlarmInt, humAlarmInt=humAlarmInt, compValMin=compValMin, humLowInt=humLowInt, trapEmailErrSome=trapEmailErrSome, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, sensorName=sensorName, histCompVal=histCompVal, tempHighInt=tempHighInt, compValDelayInt=compValDelayInt, serialNumber=serialNumber, compValAlarmInt=compValAlarmInt, humInt=humInt, historyTable=historyTable, histTemp=histTemp, tempMin=tempMin, tempDelayInt=tempDelayInt, trapEmailErrSocket=trapEmailErrSocket, compValUnit=compValUnit, tempLowInt=tempLowInt, valuesInt=valuesInt, t3610=t3610, compValMax=compValMax, histHum=histHum, humMax=humMax, trapSOAPErrDNS=trapSOAPErrDNS, values=values, trapTempHighAlarm=trapTempHighAlarm, trapHumClrAlarm=trapHumClrAlarm, tempAlarm=tempAlarm, compValHighInt=compValHighInt, humDelayInt=humDelayInt, humMin=humMin, compValHystInt=compValHystInt, tempUnit=tempUnit, trapTempError=trapTempError, pysmi_global=pysmi_global, compValInt=compValInt, trapHumError=trapHumError, trapHumHighAlarm=trapHumHighAlarm, humUnit=humUnit, trapSOAPErrSocket=trapSOAPErrSocket, settings=settings, products=products, compValAlarm=compValAlarm, trapCompValClrAlarm=trapCompValClrAlarm)
