...
# Produced by pysmi-1.1.10 at Thu Apr  4 02:55:26 2024
...
iso, enterprises, Bits, MibIdentifier, Counter32, NotificationType, IpAddress, Unsigned32, Counter64, NotificationType, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "Bits", "MibIdentifier", "Counter32", "NotificationType", "IpAddress", "Unsigned32", "Counter64", "NotificationType", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", trapHumClrAlarm=trapHumClrAlarm, serialNumber=serialNumber, histCompVal=histCompVal, trapCompValHighAlarm=trapCompValHighAlarm, humHighInt=humHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapHumLowAlarm=trapHumLowAlarm, trapEmailErrSocket=trapEmailErrSocket, trapHumError=trapHumError, humUnit=humUnit, traps=traps, trapSOAPErrDelivery=trapSOAPErrDelivery, humMin=humMin, tempDelayInt=tempDelayInt, sensorName=sensorName, compValInt=compValInt, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, tempHighInt=tempHighInt, trapSOAPErrFile=trapSOAPErrFile, trapHumHighAlarm=trapHumHighAlarm, histTemp=histTemp, humAlarm=humAlarm, comet=comet, tempAlarm=tempAlarm, tempInt=tempInt, humLowInt=humLowInt, temp=temp, tempHystInt=tempHystInt, humAlarmInt=humAlarmInt, trapEmailErrLogin=trapEmailErrLogin, tempUnit=tempUnit, compValUnit=compValUnit, historyTable=historyTable, settings=settings, valuesInt=valuesInt, trapTempError=trapTempError, trapTest=trapTest, humHystInt=humHystInt, compValAlarmInt=compValAlarmInt, tempMin=tempMin, trapEmailErrAuth=trapEmailErrAuth, tempAlarmInt=tempAlarmInt, products=products, DisplayString=DisplayString, compValAlarm=compValAlarm, compValMax=compValMax, messageString=messageString, compValDelayInt=compValDelayInt, trapCompValError=trapCompValError, pysmi_global=pysmi_global, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, compValHystInt=compValHystInt, tables=tables, humInt=humInt, histHum=histHum, historyEntry=historyEntry, trapCompValClrAlarm=trapCompValClrAlarm, trapSOAPErrSocket=trapSOAPErrSocket, deviceType=deviceType, compValLowInt=compValLowInt, compValHighInt=compValHighInt, humDelayInt=humDelayInt, trapEmailErrDNS=trapEmailErrDNS, compValMin=compValMin, tempLowInt=tempLowInt, trapNTPError=trapNTPError, compVal=compVal, trapTempLowAlarm=trapTempLowAlarm, humMax=humMax, values=values, hum=hum, trapTempClrAlarm=trapTempClrAlarm, t3610=t3610)
