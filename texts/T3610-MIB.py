...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:09:58 2021
...
enterprises, Unsigned32, Counter32, iso, IpAddress, Integer32, Gauge32, NotificationType, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, NotificationType, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "Counter32", "iso", "IpAddress", "Integer32", "Gauge32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "NotificationType", "Counter64", "Bits")
...
mibBuilder.exportSymbols("T3610-MIB", t3610=t3610, tempUnit=tempUnit, tempHystInt=tempHystInt, messageString=messageString, trapEmailErrSome=trapEmailErrSome, tables=tables, values=values, tempMin=tempMin, tempMax=tempMax, humHystInt=humHystInt, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, tempHighInt=tempHighInt, humAlarm=humAlarm, compValLowInt=compValLowInt, compValAlarm=compValAlarm, trapEmailErrSocket=trapEmailErrSocket, serialNumber=serialNumber, tempAlarmInt=tempAlarmInt, historyEntry=historyEntry, humLowInt=humLowInt, humHighInt=humHighInt, histHum=histHum, humMax=humMax, trapTest=trapTest, trapEmailErrAuth=trapEmailErrAuth, historyTable=historyTable, trapHumClrAlarm=trapHumClrAlarm, compValHighInt=compValHighInt, trapSOAPErrFile=trapSOAPErrFile, trapTempError=trapTempError, temp=temp, compValMax=compValMax, trapEmailErrLogin=trapEmailErrLogin, traps=traps, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDNS=trapSOAPErrDNS, comet=comet, compValInt=compValInt, humMin=humMin, trapHumError=trapHumError, settings=settings, tempInt=tempInt, pysmi_global=pysmi_global, histTemp=histTemp, trapCompValClrAlarm=trapCompValClrAlarm, trapHumHighAlarm=trapHumHighAlarm, deviceType=deviceType, compValDelayInt=compValDelayInt, trapNTPError=trapNTPError, DisplayString=DisplayString, trapTempHighAlarm=trapTempHighAlarm, compValHystInt=compValHystInt, humUnit=humUnit, trapTempClrAlarm=trapTempClrAlarm, compValUnit=compValUnit, trapCompValError=trapCompValError, histCompVal=histCompVal, compVal=compVal, hum=hum, products=products, tempDelayInt=tempDelayInt, tempAlarm=tempAlarm, valuesInt=valuesInt, tempLowInt=tempLowInt, humDelayInt=humDelayInt, trapTempLowAlarm=trapTempLowAlarm, sensorName=sensorName, compValMin=compValMin, trapHumLowAlarm=trapHumLowAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, humAlarmInt=humAlarmInt, humInt=humInt, compValAlarmInt=compValAlarmInt)
