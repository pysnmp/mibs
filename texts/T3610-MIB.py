...
Gauge32, Unsigned32, iso, ModuleIdentity, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Bits, Counter64, enterprises, ObjectIdentity, MibIdentifier, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "iso", "ModuleIdentity", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Bits", "Counter64", "enterprises", "ObjectIdentity", "MibIdentifier", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("T3610-MIB", traps=traps, tables=tables, tempLowInt=tempLowInt, trapEmailErrLogin=trapEmailErrLogin, compValInt=compValInt, humHystInt=humHystInt, humMin=humMin, compValMin=compValMin, tempHighInt=tempHighInt, tempHystInt=tempHystInt, trapEmailErrAuth=trapEmailErrAuth, trapEmailErrSocket=trapEmailErrSocket, compValMax=compValMax, trapTempHighAlarm=trapTempHighAlarm, trapTempLowAlarm=trapTempLowAlarm, comet=comet, trapHumError=trapHumError, historyTable=historyTable, trapEmailErrDNS=trapEmailErrDNS, trapHumLowAlarm=trapHumLowAlarm, deviceType=deviceType, trapSOAPErrFile=trapSOAPErrFile, trapCompValHighAlarm=trapCompValHighAlarm, values=values, compValLowInt=compValLowInt, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValLowAlarm=trapCompValLowAlarm, trapSOAPErrDelivery=trapSOAPErrDelivery, tempAlarm=tempAlarm, trapCompValClrAlarm=trapCompValClrAlarm, historyEntry=historyEntry, temp=temp, humDelayInt=humDelayInt, serialNumber=serialNumber, compValAlarmInt=compValAlarmInt, DisplayString=DisplayString, tempUnit=tempUnit, sensorName=sensorName, compValHighInt=compValHighInt, compValHystInt=compValHystInt, tempMin=tempMin, humUnit=humUnit, humHighInt=humHighInt, trapSOAPErrDNS=trapSOAPErrDNS, trapCompValError=trapCompValError, tempAlarmInt=tempAlarmInt, histTemp=histTemp, humInt=humInt, compValAlarm=compValAlarm, tempInt=tempInt, humAlarm=humAlarm, valuesInt=valuesInt, trapTempError=trapTempError, products=products, settings=settings, trapHumHighAlarm=trapHumHighAlarm, trapTempClrAlarm=trapTempClrAlarm, compValDelayInt=compValDelayInt, humLowInt=humLowInt, compVal=compVal, tempMax=tempMax, trapEmailErrSome=trapEmailErrSome, histHum=histHum, t3610=t3610, pysmi_global=pysmi_global, compValUnit=compValUnit, messageString=messageString, trapTest=trapTest, trapNTPError=trapNTPError, trapHumClrAlarm=trapHumClrAlarm, hum=hum, tempDelayInt=tempDelayInt, humMax=humMax, humAlarmInt=humAlarmInt)
