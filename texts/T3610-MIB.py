...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:17:09 2021
...
Unsigned32, NotificationType, enterprises, Gauge32, Bits, Integer32, ModuleIdentity, NotificationType, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, IpAddress, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "enterprises", "Gauge32", "Bits", "Integer32", "ModuleIdentity", "NotificationType", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "IpAddress", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("T3610-MIB", humAlarm=humAlarm, compValHystInt=compValHystInt, serialNumber=serialNumber, compValAlarmInt=compValAlarmInt, compValLowInt=compValLowInt, historyEntry=historyEntry, compValMax=compValMax, tempHighInt=tempHighInt, compValUnit=compValUnit, trapHumHighAlarm=trapHumHighAlarm, trapEmailErrSome=trapEmailErrSome, humLowInt=humLowInt, trapSOAPErrFile=trapSOAPErrFile, temp=temp, compValDelayInt=compValDelayInt, trapEmailErrAuth=trapEmailErrAuth, histHum=histHum, tempInt=tempInt, compValHighInt=compValHighInt, trapCompValError=trapCompValError, trapEmailErrLogin=trapEmailErrLogin, sensorName=sensorName, hum=hum, t3610=t3610, humHighInt=humHighInt, trapTempHighAlarm=trapTempHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, humMax=humMax, valuesInt=valuesInt, tempDelayInt=tempDelayInt, humInt=humInt, tempAlarm=tempAlarm, trapHumError=trapHumError, trapHumClrAlarm=trapHumClrAlarm, compValMin=compValMin, tempLowInt=tempLowInt, tempHystInt=tempHystInt, trapTempLowAlarm=trapTempLowAlarm, humAlarmInt=humAlarmInt, compVal=compVal, comet=comet, trapSOAPErrDelivery=trapSOAPErrDelivery, histCompVal=histCompVal, trapSOAPErrSocket=trapSOAPErrSocket, trapCompValHighAlarm=trapCompValHighAlarm, values=values, histTemp=histTemp, tables=tables, traps=traps, trapEmailErrSocket=trapEmailErrSocket, settings=settings, trapTest=trapTest, trapEmailErrDNS=trapEmailErrDNS, tempUnit=tempUnit, trapHumLowAlarm=trapHumLowAlarm, tempMax=tempMax, humMin=humMin, DisplayString=DisplayString, trapTempError=trapTempError, pysmi_global=pysmi_global, trapNTPError=trapNTPError, humUnit=humUnit, compValInt=compValInt, messageString=messageString, trapCompValClrAlarm=trapCompValClrAlarm, deviceType=deviceType, tempAlarmInt=tempAlarmInt, humDelayInt=humDelayInt, compValAlarm=compValAlarm, products=products, tempMin=tempMin, trapSOAPErrDNS=trapSOAPErrDNS, trapTempClrAlarm=trapTempClrAlarm, humHystInt=humHystInt, historyTable=historyTable)
