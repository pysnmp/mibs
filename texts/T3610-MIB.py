...
Counter64, Integer32, NotificationType, NotificationType, enterprises, ObjectIdentity, Bits, TimeTicks, IpAddress, Gauge32, Unsigned32, ModuleIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "NotificationType", "NotificationType", "enterprises", "ObjectIdentity", "Bits", "TimeTicks", "IpAddress", "Gauge32", "Unsigned32", "ModuleIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("T3610-MIB", trapSOAPErrFile=trapSOAPErrFile, humHighInt=humHighInt, trapCompValError=trapCompValError, trapSOAPErrDNS=trapSOAPErrDNS, trapHumError=trapHumError, comet=comet, valuesInt=valuesInt, tempAlarmInt=tempAlarmInt, compVal=compVal, humAlarmInt=humAlarmInt, tempDelayInt=tempDelayInt, humDelayInt=humDelayInt, sensorName=sensorName, compValUnit=compValUnit, compValAlarm=compValAlarm, trapEmailErrSocket=trapEmailErrSocket, trapTempHighAlarm=trapTempHighAlarm, trapCompValHighAlarm=trapCompValHighAlarm, trapCompValLowAlarm=trapCompValLowAlarm, trapEmailErrAuth=trapEmailErrAuth, deviceType=deviceType, t3610=t3610, compValAlarmInt=compValAlarmInt, trapTempClrAlarm=trapTempClrAlarm, trapEmailErrLogin=trapEmailErrLogin, humUnit=humUnit, humHystInt=humHystInt, trapHumHighAlarm=trapHumHighAlarm, tempHystInt=tempHystInt, products=products, tempHighInt=tempHighInt, trapSOAPErrSocket=trapSOAPErrSocket, histCompVal=histCompVal, trapTempLowAlarm=trapTempLowAlarm, trapHumClrAlarm=trapHumClrAlarm, trapTempError=trapTempError, pysmi_global=pysmi_global, humAlarm=humAlarm, tables=tables, tempAlarm=tempAlarm, messageString=messageString, tempUnit=tempUnit, trapTest=trapTest, hum=hum, trapEmailErrSome=trapEmailErrSome, compValDelayInt=compValDelayInt, serialNumber=serialNumber, compValMin=compValMin, compValInt=compValInt, historyTable=historyTable, temp=temp, compValHystInt=compValHystInt, tempInt=tempInt, trapHumLowAlarm=trapHumLowAlarm, tempLowInt=tempLowInt, humMin=humMin, values=values, tempMax=tempMax, humMax=humMax, DisplayString=DisplayString, tempMin=tempMin, compValHighInt=compValHighInt, historyEntry=historyEntry, histTemp=histTemp, trapNTPError=trapNTPError, trapSOAPErrDelivery=trapSOAPErrDelivery, histHum=histHum, trapEmailErrDNS=trapEmailErrDNS, humInt=humInt, trapCompValClrAlarm=trapCompValClrAlarm, compValMax=compValMax, settings=settings, traps=traps, humLowInt=humLowInt, compValLowInt=compValLowInt)
