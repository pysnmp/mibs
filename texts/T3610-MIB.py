...
ModuleIdentity, iso, MibIdentifier, NotificationType, Integer32, TimeTicks, Counter64, ObjectIdentity, Counter32, Bits, IpAddress, NotificationType, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibIdentifier", "NotificationType", "Integer32", "TimeTicks", "Counter64", "ObjectIdentity", "Counter32", "Bits", "IpAddress", "NotificationType", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("T3610-MIB", t3610=t3610, compValMin=compValMin, compValMax=compValMax, trapSOAPErrFile=trapSOAPErrFile, tempInt=tempInt, trapNTPError=trapNTPError, humMin=humMin, humInt=humInt, tempUnit=tempUnit, trapTempError=trapTempError, compValAlarm=compValAlarm, trapHumHighAlarm=trapHumHighAlarm, tempMax=tempMax, compValHighInt=compValHighInt, trapCompValClrAlarm=trapCompValClrAlarm, compValLowInt=compValLowInt, values=values, trapCompValHighAlarm=trapCompValHighAlarm, humLowInt=humLowInt, trapTempClrAlarm=trapTempClrAlarm, valuesInt=valuesInt, comet=comet, humMax=humMax, messageString=messageString, trapTempLowAlarm=trapTempLowAlarm, trapHumLowAlarm=trapHumLowAlarm, products=products, humHighInt=humHighInt, trapHumError=trapHumError, compVal=compVal, tempMin=tempMin, histCompVal=histCompVal, compValDelayInt=compValDelayInt, trapEmailErrSome=trapEmailErrSome, trapSOAPErrDNS=trapSOAPErrDNS, tempAlarm=tempAlarm, histTemp=histTemp, tables=tables, compValAlarmInt=compValAlarmInt, tempHystInt=tempHystInt, traps=traps, historyEntry=historyEntry, trapEmailErrSocket=trapEmailErrSocket, trapEmailErrDNS=trapEmailErrDNS, trapSOAPErrDelivery=trapSOAPErrDelivery, tempLowInt=tempLowInt, historyTable=historyTable, tempHighInt=tempHighInt, pysmi_global=pysmi_global, hum=hum, serialNumber=serialNumber, settings=settings, sensorName=sensorName, trapCompValLowAlarm=trapCompValLowAlarm, trapCompValError=trapCompValError, humAlarmInt=humAlarmInt, trapSOAPErrSocket=trapSOAPErrSocket, trapEmailErrLogin=trapEmailErrLogin, trapEmailErrAuth=trapEmailErrAuth, trapHumClrAlarm=trapHumClrAlarm, humUnit=humUnit, histHum=histHum, temp=temp, tempAlarmInt=tempAlarmInt, trapTest=trapTest, trapTempHighAlarm=trapTempHighAlarm, humHystInt=humHystInt, compValHystInt=compValHystInt, compValUnit=compValUnit, compValInt=compValInt, DisplayString=DisplayString, humDelayInt=humDelayInt, humAlarm=humAlarm, tempDelayInt=tempDelayInt, deviceType=deviceType)
