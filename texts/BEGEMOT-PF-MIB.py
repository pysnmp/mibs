...
iso, NotificationType, IpAddress, Counter64, Unsigned32, TimeTicks, Gauge32, ModuleIdentity, Integer32, ObjectIdentity, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "IpAddress", "Counter64", "Unsigned32", "TimeTicks", "Gauge32", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("BEGEMOT-PF-MIB", pfTablesAddrTZero=pfTablesAddrTZero, pfTimeoutsIcmpError=pfTimeoutsIcmpError, pfTablesAddrNet=pfTablesAddrNet, pfTablesAddrPktsInPass=pfTablesAddrPktsInPass, pfTimeoutsOtherSingle=pfTimeoutsOtherSingle, pfSrcNodesInserts=pfSrcNodesInserts, pfTablesAddrNetType=pfTablesAddrNetType, pfLabelsLblEvals=pfLabelsLblEvals, pfTablesTblDescr=pfTablesTblDescr, pfTimeoutsAdaptiveStart=pfTimeoutsAdaptiveStart, pfAltqQueueLimit=pfAltqQueueLimit, pfInterfacesIfTable=pfInterfacesIfTable, pfInterfacesIfType=pfInterfacesIfType, pfInterfacesIf4PktsOutPass=pfInterfacesIf4PktsOutPass, pfInterfacesIfIndex=pfInterfacesIfIndex, pfTablesAddrTable=pfTablesAddrTable, pfAltqQueueEntry=pfAltqQueueEntry, pfInterfacesIf6BytesInBlock=pfInterfacesIf6BytesInBlock, pfSrcNodesSearches=pfSrcNodesSearches, pfTablesAddrIndex=pfTablesAddrIndex, pfTablesTblEvalMatch=pfTablesTblEvalMatch, pfTablesAddrPktsOutPass=pfTablesAddrPktsOutPass, pfStatus=pfStatus, pfTablesTblTable=pfTablesTblTable, pfTables=pfTables, pfTablesTblBytesOutBlock=pfTablesTblBytesOutBlock, pfTablesAddrEntry=pfTablesAddrEntry, pfInterfacesIf6PktsOutPass=pfInterfacesIf6PktsOutPass, pfInterfacesIf4BytesInPass=pfInterfacesIf4BytesInPass, pfLogInterfaceName=pfLogInterfaceName, pfStateTableInserts=pfStateTableInserts, pfAltqQueuePriority=pfAltqQueuePriority, pfTimeoutsTcpFinWait=pfTimeoutsTcpFinWait, pfTablesAddrBytesOutPass=pfTablesAddrBytesOutPass, pfStatusRunning=pfStatusRunning, pfTimeoutsTcpOpening=pfTimeoutsTcpOpening, pfLabelsLblPktsOut=pfLabelsLblPktsOut, pfLabels=pfLabels, pfLimitsSrcNodes=pfLimitsSrcNodes, pfTablesAddrPktsOutBlock=pfTablesAddrPktsOutBlock, pfTimeoutsTcpClosed=pfTimeoutsTcpClosed, pfInterfacesIf6BytesOutPass=pfInterfacesIf6BytesOutPass, pfTablesTblBytesInXPass=pfTablesTblBytesInXPass, pfTablesTblPktsInXPass=pfTablesTblPktsInXPass, pfStateTableSearches=pfStateTableSearches, pfLogInterfaceIp4PktsInPass=pfLogInterfaceIp4PktsInPass, pfTimeoutsUdpSingle=pfTimeoutsUdpSingle, pfInterfacesIf6PktsInPass=pfInterfacesIf6PktsInPass, pfInterfacesIf6BytesOutBlock=pfInterfacesIf6BytesOutBlock, pfAltqQueueDescr=pfAltqQueueDescr, pfInterfacesIf4BytesInBlock=pfInterfacesIf4BytesInBlock, pfTimeoutsInterval=pfTimeoutsInterval, begemotPf=begemotPf, pfInterfacesIf4PktsInBlock=pfInterfacesIf4PktsInBlock, pfLogInterface=pfLogInterface, pfStateTable=pfStateTable, pfTablesTblNumber=pfTablesTblNumber, pfStatusHostId=pfStatusHostId, pfCounterFragment=pfCounterFragment, pfLogInterfaceIp6BytesOut=pfLogInterfaceIp6BytesOut, pfLogInterfaceIp6PktsInDrop=pfLogInterfaceIp6PktsInDrop, pfTablesTblBytesInBlock=pfTablesTblBytesInBlock, pfLogInterfaceIp4PktsOutPass=pfLogInterfaceIp4PktsOutPass, pfTimeoutsTcpEstablished=pfTimeoutsTcpEstablished, pfTimeoutsSrcNode=pfTimeoutsSrcNode, pfInterfacesIfTZero=pfInterfacesIfTZero, pfTablesTblTZero=pfTablesTblTZero, pfAltqQueueParent=pfAltqQueueParent, pfTimeoutsOtherFirst=pfTimeoutsOtherFirst, pfAltqQueueIndex=pfAltqQueueIndex, pfLabelsLblTable=pfLabelsLblTable, pfLogInterfaceIp4BytesIn=pfLogInterfaceIp4BytesIn, pfInterfacesIfDescr=pfInterfacesIfDescr, pfTimeoutsTcpFirst=pfTimeoutsTcpFirst, pfInterfacesIf6PktsInBlock=pfInterfacesIf6PktsInBlock, pfAltqQueueTable=pfAltqQueueTable, pfLogInterfaceIp6PktsOutPass=pfLogInterfaceIp6PktsOutPass, pfInterfacesIf4PktsOutBlock=pfInterfacesIf4PktsOutBlock, pfCounterMemDrop=pfCounterMemDrop, pfStatusDebug=pfStatusDebug, pfLogInterfaceIp4PktsInDrop=pfLogInterfaceIp4PktsInDrop, pfLogInterfaceIp6BytesIn=pfLogInterfaceIp6BytesIn, pfTablesTblCount=pfTablesTblCount, pfTimeoutsFragment=pfTimeoutsFragment, pfTablesTblBytesInPass=pfTablesTblBytesInPass, pfSrcNodesCount=pfSrcNodesCount, pfCounter=pfCounter, pfStateTableRemovals=pfStateTableRemovals, pfInterfacesIfEntry=pfInterfacesIfEntry, pfLogInterfaceIp6PktsOutDrop=pfLogInterfaceIp6PktsOutDrop, pfTablesTblPktsInPass=pfTablesTblPktsInPass, pfStatusRuntime=pfStatusRuntime, pfInterfacesIfRefsState=pfInterfacesIfRefsState, pfTablesTblIndex=pfTablesTblIndex, pfTablesTblPktsOutBlock=pfTablesTblPktsOutBlock, pfInterfacesIf4PktsInPass=pfInterfacesIf4PktsInPass, pfTablesTblPktsOutXPass=pfTablesTblPktsOutXPass, pfLabelsLblBytesOut=pfLabelsLblBytesOut, pfTablesTblBytesOutPass=pfTablesTblBytesOutPass, pfSrcNodes=pfSrcNodes, pfLabelsLblPktsIn=pfLabelsLblPktsIn, pfTablesTblPktsInBlock=pfTablesTblPktsInBlock, pfTimeoutsOtherMultiple=pfTimeoutsOtherMultiple, pfTimeoutsTcpClosing=pfTimeoutsTcpClosing, pfTablesAddrBytesInPass=pfTablesAddrBytesInPass, pfLogInterfaceIp4PktsOutDrop=pfLogInterfaceIp4PktsOutDrop, pfTablesTblRefsRule=pfTablesTblRefsRule, pfLabelsLblIndex=pfLabelsLblIndex, pfTimeoutsAdaptiveEnd=pfTimeoutsAdaptiveEnd, pfLimitsStates=pfLimitsStates, pfInterfaces=pfInterfaces, pfTablesAddrPrefix=pfTablesAddrPrefix, pfTablesAddrBytesOutBlock=pfTablesAddrBytesOutBlock, pfTimeoutsIcmpFirst=pfTimeoutsIcmpFirst, pfInterfacesIf4BytesOutBlock=pfInterfacesIf4BytesOutBlock, pfTablesTblEvalNoMatch=pfTablesTblEvalNoMatch, pfInterfacesIfNumber=pfInterfacesIfNumber, pfCounterMatch=pfCounterMatch, pfInterfacesIfRefsRule=pfInterfacesIfRefsRule, pfLabelsLblNumber=pfLabelsLblNumber, pfLabelsLblName=pfLabelsLblName, pfStateTableCount=pfStateTableCount, pfLimits=pfLimits, pfAltqQueueNumber=pfAltqQueueNumber, pfTablesTblBytesOutXPass=pfTablesTblBytesOutXPass, PYSNMP_MODULE_ID=begemotPf, pfSrcNodesRemovals=pfSrcNodesRemovals, pfLabelsLblBytesIn=pfLabelsLblBytesIn, pfTimeouts=pfTimeouts, pfLogInterfaceIp4BytesOut=pfLogInterfaceIp4BytesOut, pfAltqQueueBandwidth=pfAltqQueueBandwidth, pfLimitsFrags=pfLimitsFrags, pfCounterNormalize=pfCounterNormalize, begemotPfObjects=begemotPfObjects, pfAltqQueueScheduler=pfAltqQueueScheduler, pfLogInterfaceIp6PktsInPass=pfLogInterfaceIp6PktsInPass, pfTablesAddrPktsInBlock=pfTablesAddrPktsInBlock, pfTablesTblPktsOutPass=pfTablesTblPktsOutPass, pfCounterBadOffset=pfCounterBadOffset, pfTablesTblRefsAnchor=pfTablesTblRefsAnchor, pfInterfacesIf4BytesOutPass=pfInterfacesIf4BytesOutPass, pfInterfacesIf6PktsOutBlock=pfInterfacesIf6PktsOutBlock, pfTablesAddrBytesInBlock=pfTablesAddrBytesInBlock, pfInterfacesIf6BytesInPass=pfInterfacesIf6BytesInPass, pfAltq=pfAltq, pfLabelsLblEntry=pfLabelsLblEntry, pfTablesTblEntry=pfTablesTblEntry, pfTimeoutsUdpFirst=pfTimeoutsUdpFirst, pfCounterShort=pfCounterShort, pfTimeoutsUdpMultiple=pfTimeoutsUdpMultiple)
