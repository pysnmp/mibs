...
NotificationType, IpAddress, Unsigned32, TimeTicks, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, Bits, Counter64, iso, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Unsigned32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "Bits", "Counter64", "iso", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("BEGEMOT-PF-MIB", pfLogInterfaceIp6BytesOut=pfLogInterfaceIp6BytesOut, pfTimeoutsTcpOpening=pfTimeoutsTcpOpening, pfTimeoutsAdaptiveStart=pfTimeoutsAdaptiveStart, pfStateTableInserts=pfStateTableInserts, pfLogInterfaceIp6BytesIn=pfLogInterfaceIp6BytesIn, pfInterfacesIfRefsRule=pfInterfacesIfRefsRule, pfInterfacesIf4BytesInBlock=pfInterfacesIf4BytesInBlock, pfTablesTblBytesInXPass=pfTablesTblBytesInXPass, pfTablesAddrIndex=pfTablesAddrIndex, pfLogInterfaceIp6PktsInPass=pfLogInterfaceIp6PktsInPass, pfAltqQueueScheduler=pfAltqQueueScheduler, pfCounterShort=pfCounterShort, pfInterfacesIf4PktsInBlock=pfInterfacesIf4PktsInBlock, pfCounterMatch=pfCounterMatch, pfLabelsLblBytesOut=pfLabelsLblBytesOut, pfTablesTblIndex=pfTablesTblIndex, pfAltqQueueEntry=pfAltqQueueEntry, pfInterfacesIf6PktsOutPass=pfInterfacesIf6PktsOutPass, pfTimeoutsUdpSingle=pfTimeoutsUdpSingle, pfInterfacesIf6PktsInPass=pfInterfacesIf6PktsInPass, pfSrcNodesRemovals=pfSrcNodesRemovals, pfTablesTblBytesOutBlock=pfTablesTblBytesOutBlock, pfLabelsLblName=pfLabelsLblName, pfTablesAddrBytesOutBlock=pfTablesAddrBytesOutBlock, pfLogInterfaceIp4BytesIn=pfLogInterfaceIp4BytesIn, pfLogInterfaceName=pfLogInterfaceName, pfLogInterfaceIp6PktsOutDrop=pfLogInterfaceIp6PktsOutDrop, pfTablesTblPktsOutPass=pfTablesTblPktsOutPass, pfAltqQueueIndex=pfAltqQueueIndex, pfLabelsLblPktsOut=pfLabelsLblPktsOut, begemotPf=begemotPf, pfCounter=pfCounter, pfInterfacesIfTable=pfInterfacesIfTable, pfTablesAddrPrefix=pfTablesAddrPrefix, pfTablesAddrTZero=pfTablesAddrTZero, pfLogInterfaceIp6PktsOutPass=pfLogInterfaceIp6PktsOutPass, pfCounterFragment=pfCounterFragment, pfAltqQueuePriority=pfAltqQueuePriority, pfStatusRunning=pfStatusRunning, pfTimeoutsTcpClosed=pfTimeoutsTcpClosed, pfInterfacesIf4PktsInPass=pfInterfacesIf4PktsInPass, pfTimeoutsInterval=pfTimeoutsInterval, pfStatusHostId=pfStatusHostId, pfTimeouts=pfTimeouts, pfTablesAddrPktsInPass=pfTablesAddrPktsInPass, pfTablesTblEvalNoMatch=pfTablesTblEvalNoMatch, pfSrcNodesInserts=pfSrcNodesInserts, pfTablesAddrTable=pfTablesAddrTable, pfTimeoutsFragment=pfTimeoutsFragment, pfTablesAddrEntry=pfTablesAddrEntry, pfLabelsLblIndex=pfLabelsLblIndex, pfCounterNormalize=pfCounterNormalize, pfTablesTblPktsInBlock=pfTablesTblPktsInBlock, pfTimeoutsTcpClosing=pfTimeoutsTcpClosing, pfTablesTblBytesInBlock=pfTablesTblBytesInBlock, pfTablesAddrPktsOutBlock=pfTablesAddrPktsOutBlock, pfAltqQueueBandwidth=pfAltqQueueBandwidth, pfLabels=pfLabels, pfSrcNodesSearches=pfSrcNodesSearches, pfTablesAddrPktsInBlock=pfTablesAddrPktsInBlock, pfStatusRuntime=pfStatusRuntime, pfTimeoutsAdaptiveEnd=pfTimeoutsAdaptiveEnd, pfTablesAddrBytesInBlock=pfTablesAddrBytesInBlock, pfLimits=pfLimits, pfLogInterfaceIp4BytesOut=pfLogInterfaceIp4BytesOut, pfTimeoutsSrcNode=pfTimeoutsSrcNode, pfInterfacesIf4BytesOutBlock=pfInterfacesIf4BytesOutBlock, pfTablesAddrNet=pfTablesAddrNet, pfInterfacesIf4BytesInPass=pfInterfacesIf4BytesInPass, pfTablesAddrBytesInPass=pfTablesAddrBytesInPass, pfTablesAddrBytesOutPass=pfTablesAddrBytesOutPass, pfTablesAddrNetType=pfTablesAddrNetType, pfTimeoutsUdpFirst=pfTimeoutsUdpFirst, pfTimeoutsOtherMultiple=pfTimeoutsOtherMultiple, pfTablesTblEntry=pfTablesTblEntry, pfTablesTblBytesOutPass=pfTablesTblBytesOutPass, pfAltqQueueTable=pfAltqQueueTable, pfLabelsLblBytesIn=pfLabelsLblBytesIn, pfTablesTblEvalMatch=pfTablesTblEvalMatch, pfTablesAddrPktsOutPass=pfTablesAddrPktsOutPass, pfTimeoutsTcpFinWait=pfTimeoutsTcpFinWait, pfTablesTblNumber=pfTablesTblNumber, pfInterfacesIfNumber=pfInterfacesIfNumber, pfTablesTblPktsInXPass=pfTablesTblPktsInXPass, pfInterfacesIfIndex=pfInterfacesIfIndex, pfTablesTblRefsRule=pfTablesTblRefsRule, pfTimeoutsOtherFirst=pfTimeoutsOtherFirst, pfTablesTblCount=pfTablesTblCount, pfTablesTblTZero=pfTablesTblTZero, pfTablesTblBytesOutXPass=pfTablesTblBytesOutXPass, pfInterfacesIf6BytesInBlock=pfInterfacesIf6BytesInBlock, pfLogInterfaceIp4PktsOutPass=pfLogInterfaceIp4PktsOutPass, pfInterfacesIf4BytesOutPass=pfInterfacesIf4BytesOutPass, pfInterfacesIfDescr=pfInterfacesIfDescr, pfInterfacesIf4PktsOutPass=pfInterfacesIf4PktsOutPass, PYSNMP_MODULE_ID=begemotPf, pfCounterMemDrop=pfCounterMemDrop, pfLimitsStates=pfLimitsStates, pfInterfacesIf6BytesOutPass=pfInterfacesIf6BytesOutPass, pfAltqQueueLimit=pfAltqQueueLimit, pfTimeoutsOtherSingle=pfTimeoutsOtherSingle, pfLabelsLblNumber=pfLabelsLblNumber, pfInterfacesIf6PktsOutBlock=pfInterfacesIf6PktsOutBlock, pfInterfacesIf6BytesOutBlock=pfInterfacesIf6BytesOutBlock, pfSrcNodesCount=pfSrcNodesCount, pfTablesTblPktsOutXPass=pfTablesTblPktsOutXPass, pfInterfacesIfType=pfInterfacesIfType, pfInterfacesIfTZero=pfInterfacesIfTZero, begemotPfObjects=begemotPfObjects, pfTimeoutsUdpMultiple=pfTimeoutsUdpMultiple, pfTablesTblBytesInPass=pfTablesTblBytesInPass, pfTables=pfTables, pfSrcNodes=pfSrcNodes, pfInterfaces=pfInterfaces, pfAltqQueueNumber=pfAltqQueueNumber, pfAltqQueueParent=pfAltqQueueParent, pfLogInterfaceIp4PktsInDrop=pfLogInterfaceIp4PktsInDrop, pfLabelsLblEntry=pfLabelsLblEntry, pfTimeoutsTcpFirst=pfTimeoutsTcpFirst, pfTablesTblTable=pfTablesTblTable, pfTablesTblDescr=pfTablesTblDescr, pfLogInterfaceIp6PktsInDrop=pfLogInterfaceIp6PktsInDrop, pfTablesTblPktsInPass=pfTablesTblPktsInPass, pfInterfacesIfEntry=pfInterfacesIfEntry, pfLabelsLblTable=pfLabelsLblTable, pfTablesTblRefsAnchor=pfTablesTblRefsAnchor, pfStatus=pfStatus, pfAltq=pfAltq, pfLimitsSrcNodes=pfLimitsSrcNodes, pfTimeoutsTcpEstablished=pfTimeoutsTcpEstablished, pfLogInterfaceIp4PktsInPass=pfLogInterfaceIp4PktsInPass, pfTablesTblPktsOutBlock=pfTablesTblPktsOutBlock, pfAltqQueueDescr=pfAltqQueueDescr, pfLogInterface=pfLogInterface, pfStateTableSearches=pfStateTableSearches, pfInterfacesIf4PktsOutBlock=pfInterfacesIf4PktsOutBlock, pfStateTableCount=pfStateTableCount, pfInterfacesIf6PktsInBlock=pfInterfacesIf6PktsInBlock, pfStatusDebug=pfStatusDebug, pfLabelsLblPktsIn=pfLabelsLblPktsIn, pfStateTableRemovals=pfStateTableRemovals, pfTimeoutsIcmpError=pfTimeoutsIcmpError, pfInterfacesIf6BytesInPass=pfInterfacesIf6BytesInPass, pfCounterBadOffset=pfCounterBadOffset, pfInterfacesIfRefsState=pfInterfacesIfRefsState, pfStateTable=pfStateTable, pfLabelsLblEvals=pfLabelsLblEvals, pfTimeoutsIcmpFirst=pfTimeoutsIcmpFirst, pfLogInterfaceIp4PktsOutDrop=pfLogInterfaceIp4PktsOutDrop, pfLimitsFrags=pfLimitsFrags)
