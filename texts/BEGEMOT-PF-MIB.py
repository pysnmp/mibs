...
Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, IpAddress, Gauge32, ObjectIdentity, ModuleIdentity, iso, NotificationType, Counter64, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "IpAddress", "Gauge32", "ObjectIdentity", "ModuleIdentity", "iso", "NotificationType", "Counter64", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("BEGEMOT-PF-MIB", pfStatus=pfStatus, pfTablesTblTable=pfTablesTblTable, pfLogInterfaceIp4PktsInDrop=pfLogInterfaceIp4PktsInDrop, pfInterfacesIf4PktsOutBlock=pfInterfacesIf4PktsOutBlock, pfCounterNormalize=pfCounterNormalize, pfSrcNodesRemovals=pfSrcNodesRemovals, pfTablesAddrNet=pfTablesAddrNet, pfLabelsLblEntry=pfLabelsLblEntry, pfSrcNodesCount=pfSrcNodesCount, pfTimeoutsTcpFirst=pfTimeoutsTcpFirst, pfInterfacesIf6PktsOutPass=pfInterfacesIf6PktsOutPass, pfLabelsLblName=pfLabelsLblName, pfAltqQueueTable=pfAltqQueueTable, pfTimeoutsTcpOpening=pfTimeoutsTcpOpening, pfTablesTblBytesInBlock=pfTablesTblBytesInBlock, pfTimeoutsUdpSingle=pfTimeoutsUdpSingle, pfAltqQueueBandwidth=pfAltqQueueBandwidth, pfAltqQueueEntry=pfAltqQueueEntry, pfTimeoutsOtherSingle=pfTimeoutsOtherSingle, pfInterfacesIf4PktsInBlock=pfInterfacesIf4PktsInBlock, pfTablesTblIndex=pfTablesTblIndex, pfAltqQueueNumber=pfAltqQueueNumber, pfTablesTblRefsRule=pfTablesTblRefsRule, pfTablesAddrEntry=pfTablesAddrEntry, pfAltqQueueDescr=pfAltqQueueDescr, pfInterfacesIf6BytesInPass=pfInterfacesIf6BytesInPass, pfTablesTblRefsAnchor=pfTablesTblRefsAnchor, pfLogInterfaceIp4BytesIn=pfLogInterfaceIp4BytesIn, pfTablesTblPktsOutPass=pfTablesTblPktsOutPass, pfTablesTblPktsOutBlock=pfTablesTblPktsOutBlock, pfTablesTblBytesInXPass=pfTablesTblBytesInXPass, pfTablesAddrTZero=pfTablesAddrTZero, pfTablesTblBytesInPass=pfTablesTblBytesInPass, PYSNMP_MODULE_ID=begemotPf, pfTimeoutsTcpFinWait=pfTimeoutsTcpFinWait, pfInterfacesIfEntry=pfInterfacesIfEntry, pfTablesTblPktsOutXPass=pfTablesTblPktsOutXPass, pfTimeoutsSrcNode=pfTimeoutsSrcNode, pfLogInterfaceName=pfLogInterfaceName, pfTablesTblCount=pfTablesTblCount, pfLogInterfaceIp4BytesOut=pfLogInterfaceIp4BytesOut, pfInterfacesIf6PktsOutBlock=pfInterfacesIf6PktsOutBlock, pfStatusDebug=pfStatusDebug, pfInterfacesIfNumber=pfInterfacesIfNumber, pfTimeoutsOtherMultiple=pfTimeoutsOtherMultiple, pfStateTableRemovals=pfStateTableRemovals, pfCounterBadOffset=pfCounterBadOffset, pfInterfacesIfRefsRule=pfInterfacesIfRefsRule, pfStateTable=pfStateTable, pfLogInterfaceIp6PktsOutPass=pfLogInterfaceIp6PktsOutPass, pfLogInterfaceIp4PktsOutPass=pfLogInterfaceIp4PktsOutPass, pfTimeoutsTcpClosed=pfTimeoutsTcpClosed, begemotPfObjects=begemotPfObjects, pfTablesAddrBytesInPass=pfTablesAddrBytesInPass, pfAltqQueuePriority=pfAltqQueuePriority, pfLogInterfaceIp6PktsInPass=pfLogInterfaceIp6PktsInPass, pfTablesTblEvalMatch=pfTablesTblEvalMatch, pfTablesAddrNetType=pfTablesAddrNetType, pfInterfacesIf4PktsInPass=pfInterfacesIf4PktsInPass, pfTablesTblTZero=pfTablesTblTZero, pfTimeoutsIcmpError=pfTimeoutsIcmpError, pfStatusRuntime=pfStatusRuntime, pfCounterFragment=pfCounterFragment, pfTablesAddrBytesOutBlock=pfTablesAddrBytesOutBlock, pfCounter=pfCounter, pfStateTableInserts=pfStateTableInserts, pfInterfacesIfDescr=pfInterfacesIfDescr, pfLabelsLblPktsIn=pfLabelsLblPktsIn, pfTablesTblBytesOutBlock=pfTablesTblBytesOutBlock, pfLogInterfaceIp6PktsInDrop=pfLogInterfaceIp6PktsInDrop, pfLabelsLblBytesIn=pfLabelsLblBytesIn, pfCounterMemDrop=pfCounterMemDrop, pfSrcNodes=pfSrcNodes, pfInterfacesIf4BytesInBlock=pfInterfacesIf4BytesInBlock, pfTimeouts=pfTimeouts, pfAltq=pfAltq, pfLogInterfaceIp4PktsOutDrop=pfLogInterfaceIp4PktsOutDrop, pfInterfacesIf6PktsInPass=pfInterfacesIf6PktsInPass, pfTablesTblBytesOutXPass=pfTablesTblBytesOutXPass, pfSrcNodesSearches=pfSrcNodesSearches, pfTablesAddrPrefix=pfTablesAddrPrefix, pfTimeoutsAdaptiveStart=pfTimeoutsAdaptiveStart, pfStateTableSearches=pfStateTableSearches, pfLogInterfaceIp6PktsOutDrop=pfLogInterfaceIp6PktsOutDrop, pfStatusRunning=pfStatusRunning, pfLabels=pfLabels, pfTablesAddrTable=pfTablesAddrTable, pfLabelsLblTable=pfLabelsLblTable, pfAltqQueueScheduler=pfAltqQueueScheduler, pfAltqQueueParent=pfAltqQueueParent, pfTablesTblEntry=pfTablesTblEntry, pfTimeoutsTcpClosing=pfTimeoutsTcpClosing, pfInterfacesIf4PktsOutPass=pfInterfacesIf4PktsOutPass, pfTimeoutsUdpMultiple=pfTimeoutsUdpMultiple, pfTimeoutsIcmpFirst=pfTimeoutsIcmpFirst, pfLabelsLblNumber=pfLabelsLblNumber, pfTablesTblDescr=pfTablesTblDescr, pfTimeoutsInterval=pfTimeoutsInterval, pfLogInterfaceIp4PktsInPass=pfLogInterfaceIp4PktsInPass, pfLogInterfaceIp6BytesIn=pfLogInterfaceIp6BytesIn, pfLimitsStates=pfLimitsStates, pfLogInterface=pfLogInterface, pfInterfacesIf4BytesOutBlock=pfInterfacesIf4BytesOutBlock, pfLabelsLblEvals=pfLabelsLblEvals, pfInterfacesIfRefsState=pfInterfacesIfRefsState, pfTablesAddrBytesOutPass=pfTablesAddrBytesOutPass, pfInterfacesIf6BytesInBlock=pfInterfacesIf6BytesInBlock, pfTablesTblNumber=pfTablesTblNumber, begemotPf=begemotPf, pfLimitsSrcNodes=pfLimitsSrcNodes, pfLimitsFrags=pfLimitsFrags, pfInterfacesIfIndex=pfInterfacesIfIndex, pfInterfacesIfType=pfInterfacesIfType, pfInterfacesIf6BytesOutPass=pfInterfacesIf6BytesOutPass, pfTimeoutsAdaptiveEnd=pfTimeoutsAdaptiveEnd, pfInterfaces=pfInterfaces, pfInterfacesIfTZero=pfInterfacesIfTZero, pfInterfacesIf6PktsInBlock=pfInterfacesIf6PktsInBlock, pfTablesAddrPktsOutPass=pfTablesAddrPktsOutPass, pfAltqQueueLimit=pfAltqQueueLimit, pfCounterShort=pfCounterShort, pfTimeoutsUdpFirst=pfTimeoutsUdpFirst, pfLimits=pfLimits, pfTablesTblEvalNoMatch=pfTablesTblEvalNoMatch, pfTablesAddrIndex=pfTablesAddrIndex, pfTablesAddrPktsInPass=pfTablesAddrPktsInPass, pfLabelsLblBytesOut=pfLabelsLblBytesOut, pfInterfacesIf4BytesOutPass=pfInterfacesIf4BytesOutPass, pfStateTableCount=pfStateTableCount, pfTablesTblPktsInXPass=pfTablesTblPktsInXPass, pfInterfacesIf6BytesOutBlock=pfInterfacesIf6BytesOutBlock, pfLogInterfaceIp6BytesOut=pfLogInterfaceIp6BytesOut, pfLabelsLblPktsOut=pfLabelsLblPktsOut, pfTimeoutsFragment=pfTimeoutsFragment, pfLabelsLblIndex=pfLabelsLblIndex, pfTimeoutsOtherFirst=pfTimeoutsOtherFirst, pfTables=pfTables, pfSrcNodesInserts=pfSrcNodesInserts, pfCounterMatch=pfCounterMatch, pfTablesAddrPktsOutBlock=pfTablesAddrPktsOutBlock, pfTablesTblPktsInPass=pfTablesTblPktsInPass, pfStatusHostId=pfStatusHostId, pfTablesAddrBytesInBlock=pfTablesAddrBytesInBlock, pfTablesTblPktsInBlock=pfTablesTblPktsInBlock, pfInterfacesIf4BytesInPass=pfInterfacesIf4BytesInPass, pfAltqQueueIndex=pfAltqQueueIndex, pfInterfacesIfTable=pfInterfacesIfTable, pfTablesTblBytesOutPass=pfTablesTblBytesOutPass, pfTablesAddrPktsInBlock=pfTablesAddrPktsInBlock, pfTimeoutsTcpEstablished=pfTimeoutsTcpEstablished)
