...
MibIdentifier, Integer32, Counter64, Unsigned32, iso, NotificationType, ObjectIdentity, Gauge32, Counter32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Counter64", "Unsigned32", "iso", "NotificationType", "ObjectIdentity", "Gauge32", "Counter32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("BEGEMOT-PF-MIB", pfLogInterfaceIp4PktsInPass=pfLogInterfaceIp4PktsInPass, pfLogInterfaceIp6BytesOut=pfLogInterfaceIp6BytesOut, pfLabels=pfLabels, pfTimeoutsFragment=pfTimeoutsFragment, pfLabelsLblBytesOut=pfLabelsLblBytesOut, pfStateTableCount=pfStateTableCount, pfTables=pfTables, pfInterfacesIf6BytesInPass=pfInterfacesIf6BytesInPass, pfStatusHostId=pfStatusHostId, pfTablesAddrEntry=pfTablesAddrEntry, pfInterfacesIf6BytesInBlock=pfInterfacesIf6BytesInBlock, pfTablesAddrPktsOutBlock=pfTablesAddrPktsOutBlock, pfTablesTblPktsOutXPass=pfTablesTblPktsOutXPass, pfLabelsLblPktsIn=pfLabelsLblPktsIn, pfLogInterfaceIp6BytesIn=pfLogInterfaceIp6BytesIn, pfInterfacesIfTZero=pfInterfacesIfTZero, pfInterfacesIf6BytesOutBlock=pfInterfacesIf6BytesOutBlock, pfTimeoutsOtherMultiple=pfTimeoutsOtherMultiple, pfInterfacesIf4BytesOutBlock=pfInterfacesIf4BytesOutBlock, pfInterfacesIf6BytesOutPass=pfInterfacesIf6BytesOutPass, pfTimeoutsTcpEstablished=pfTimeoutsTcpEstablished, pfInterfacesIf4BytesInPass=pfInterfacesIf4BytesInPass, pfTablesTblTZero=pfTablesTblTZero, pfTablesTblBytesInXPass=pfTablesTblBytesInXPass, pfTablesTblPktsOutPass=pfTablesTblPktsOutPass, pfInterfacesIfTable=pfInterfacesIfTable, pfLabelsLblIndex=pfLabelsLblIndex, PYSNMP_MODULE_ID=begemotPf, pfCounterShort=pfCounterShort, pfStateTableInserts=pfStateTableInserts, pfInterfacesIf4BytesOutPass=pfInterfacesIf4BytesOutPass, pfTimeoutsIcmpError=pfTimeoutsIcmpError, pfCounter=pfCounter, pfInterfacesIfDescr=pfInterfacesIfDescr, pfTablesAddrBytesOutBlock=pfTablesAddrBytesOutBlock, pfTablesTblEvalMatch=pfTablesTblEvalMatch, pfLogInterfaceIp6PktsInDrop=pfLogInterfaceIp6PktsInDrop, pfTablesTblNumber=pfTablesTblNumber, pfTimeoutsTcpOpening=pfTimeoutsTcpOpening, begemotPfObjects=begemotPfObjects, pfAltq=pfAltq, pfSrcNodesSearches=pfSrcNodesSearches, pfTimeoutsSrcNode=pfTimeoutsSrcNode, pfAltqQueueIndex=pfAltqQueueIndex, pfLogInterfaceIp4BytesOut=pfLogInterfaceIp4BytesOut, pfTimeoutsInterval=pfTimeoutsInterval, pfSrcNodesRemovals=pfSrcNodesRemovals, pfLimits=pfLimits, pfInterfacesIfNumber=pfInterfacesIfNumber, pfTimeoutsOtherSingle=pfTimeoutsOtherSingle, pfSrcNodes=pfSrcNodes, pfTimeoutsTcpFirst=pfTimeoutsTcpFirst, pfInterfacesIfType=pfInterfacesIfType, pfTablesAddrIndex=pfTablesAddrIndex, pfTablesTblTable=pfTablesTblTable, pfInterfacesIf4PktsInPass=pfInterfacesIf4PktsInPass, pfAltqQueueTable=pfAltqQueueTable, pfAltqQueueLimit=pfAltqQueueLimit, pfTablesAddrPrefix=pfTablesAddrPrefix, pfCounterBadOffset=pfCounterBadOffset, pfLabelsLblEvals=pfLabelsLblEvals, pfLabelsLblTable=pfLabelsLblTable, pfLogInterface=pfLogInterface, pfSrcNodesInserts=pfSrcNodesInserts, pfTimeoutsOtherFirst=pfTimeoutsOtherFirst, pfTimeoutsTcpClosed=pfTimeoutsTcpClosed, pfInterfacesIf4BytesInBlock=pfInterfacesIf4BytesInBlock, pfLabelsLblEntry=pfLabelsLblEntry, pfLogInterfaceIp6PktsInPass=pfLogInterfaceIp6PktsInPass, pfTablesTblRefsRule=pfTablesTblRefsRule, pfTablesAddrPktsOutPass=pfTablesAddrPktsOutPass, pfTimeoutsUdpFirst=pfTimeoutsUdpFirst, pfTablesTblDescr=pfTablesTblDescr, pfLabelsLblBytesIn=pfLabelsLblBytesIn, pfAltqQueuePriority=pfAltqQueuePriority, pfTablesTblCount=pfTablesTblCount, pfTimeoutsAdaptiveEnd=pfTimeoutsAdaptiveEnd, pfTablesAddrPktsInPass=pfTablesAddrPktsInPass, pfLimitsStates=pfLimitsStates, pfInterfacesIf6PktsInPass=pfInterfacesIf6PktsInPass, pfStateTable=pfStateTable, pfInterfacesIfRefsState=pfInterfacesIfRefsState, pfStatusDebug=pfStatusDebug, pfTablesAddrTZero=pfTablesAddrTZero, pfTimeoutsIcmpFirst=pfTimeoutsIcmpFirst, pfTimeoutsTcpClosing=pfTimeoutsTcpClosing, pfTablesTblEntry=pfTablesTblEntry, pfTablesTblBytesOutPass=pfTablesTblBytesOutPass, pfStateTableRemovals=pfStateTableRemovals, pfTablesAddrPktsInBlock=pfTablesAddrPktsInBlock, pfCounterMatch=pfCounterMatch, pfInterfacesIfRefsRule=pfInterfacesIfRefsRule, pfTablesAddrNet=pfTablesAddrNet, pfLogInterfaceIp4PktsOutPass=pfLogInterfaceIp4PktsOutPass, pfTimeoutsUdpMultiple=pfTimeoutsUdpMultiple, pfAltqQueueNumber=pfAltqQueueNumber, pfTablesTblBytesInBlock=pfTablesTblBytesInBlock, pfAltqQueueBandwidth=pfAltqQueueBandwidth, pfInterfacesIf6PktsInBlock=pfInterfacesIf6PktsInBlock, pfCounterFragment=pfCounterFragment, pfInterfacesIf4PktsInBlock=pfInterfacesIf4PktsInBlock, pfStateTableSearches=pfStateTableSearches, pfTablesAddrBytesInPass=pfTablesAddrBytesInPass, pfLogInterfaceIp4PktsInDrop=pfLogInterfaceIp4PktsInDrop, pfLabelsLblName=pfLabelsLblName, begemotPf=begemotPf, pfTablesAddrBytesOutPass=pfTablesAddrBytesOutPass, pfTablesAddrTable=pfTablesAddrTable, pfLogInterfaceIp4PktsOutDrop=pfLogInterfaceIp4PktsOutDrop, pfTablesTblEvalNoMatch=pfTablesTblEvalNoMatch, pfTablesTblBytesInPass=pfTablesTblBytesInPass, pfCounterNormalize=pfCounterNormalize, pfSrcNodesCount=pfSrcNodesCount, pfLimitsSrcNodes=pfLimitsSrcNodes, pfInterfacesIf4PktsOutPass=pfInterfacesIf4PktsOutPass, pfInterfacesIf6PktsOutPass=pfInterfacesIf6PktsOutPass, pfLabelsLblPktsOut=pfLabelsLblPktsOut, pfLogInterfaceIp4BytesIn=pfLogInterfaceIp4BytesIn, pfInterfacesIfEntry=pfInterfacesIfEntry, pfStatus=pfStatus, pfStatusRunning=pfStatusRunning, pfTablesTblPktsInBlock=pfTablesTblPktsInBlock, pfTablesAddrNetType=pfTablesAddrNetType, pfInterfaces=pfInterfaces, pfTablesTblIndex=pfTablesTblIndex, pfLogInterfaceIp6PktsOutDrop=pfLogInterfaceIp6PktsOutDrop, pfLimitsFrags=pfLimitsFrags, pfTablesTblPktsInPass=pfTablesTblPktsInPass, pfLogInterfaceIp6PktsOutPass=pfLogInterfaceIp6PktsOutPass, pfTablesTblPktsOutBlock=pfTablesTblPktsOutBlock, pfAltqQueueParent=pfAltqQueueParent, pfAltqQueueDescr=pfAltqQueueDescr, pfTablesTblRefsAnchor=pfTablesTblRefsAnchor, pfTimeoutsUdpSingle=pfTimeoutsUdpSingle, pfTablesTblPktsInXPass=pfTablesTblPktsInXPass, pfInterfacesIf6PktsOutBlock=pfInterfacesIf6PktsOutBlock, pfTablesTblBytesOutXPass=pfTablesTblBytesOutXPass, pfAltqQueueEntry=pfAltqQueueEntry, pfTablesAddrBytesInBlock=pfTablesAddrBytesInBlock, pfLogInterfaceName=pfLogInterfaceName, pfTimeoutsAdaptiveStart=pfTimeoutsAdaptiveStart, pfInterfacesIfIndex=pfInterfacesIfIndex, pfCounterMemDrop=pfCounterMemDrop, pfTablesTblBytesOutBlock=pfTablesTblBytesOutBlock, pfInterfacesIf4PktsOutBlock=pfInterfacesIf4PktsOutBlock, pfStatusRuntime=pfStatusRuntime, pfTimeoutsTcpFinWait=pfTimeoutsTcpFinWait, pfTimeouts=pfTimeouts, pfAltqQueueScheduler=pfAltqQueueScheduler, pfLabelsLblNumber=pfLabelsLblNumber)
