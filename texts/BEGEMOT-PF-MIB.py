...
Gauge32, ModuleIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, TimeTicks, ObjectIdentity, IpAddress, NotificationType, iso, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "TimeTicks", "ObjectIdentity", "IpAddress", "NotificationType", "iso", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("BEGEMOT-PF-MIB", pfTimeoutsSrcNode=pfTimeoutsSrcNode, pfLabelsLblPktsIn=pfLabelsLblPktsIn, pfTimeoutsFragment=pfTimeoutsFragment, pfInterfacesIfIndex=pfInterfacesIfIndex, pfTablesAddrBytesOutBlock=pfTablesAddrBytesOutBlock, pfTablesAddrPktsInBlock=pfTablesAddrPktsInBlock, pfInterfacesIf6BytesOutPass=pfInterfacesIf6BytesOutPass, pfTimeoutsIcmpError=pfTimeoutsIcmpError, pfLimitsFrags=pfLimitsFrags, pfStatus=pfStatus, pfTablesTblEvalNoMatch=pfTablesTblEvalNoMatch, pfAltqQueueDescr=pfAltqQueueDescr, pfTablesTblPktsOutBlock=pfTablesTblPktsOutBlock, pfLabelsLblEvals=pfLabelsLblEvals, pfInterfacesIfNumber=pfInterfacesIfNumber, pfTablesTblPktsOutPass=pfTablesTblPktsOutPass, pfInterfacesIfTable=pfInterfacesIfTable, pfLabels=pfLabels, begemotPf=begemotPf, pfStateTableSearches=pfStateTableSearches, pfTablesTblCount=pfTablesTblCount, pfAltqQueueBandwidth=pfAltqQueueBandwidth, pfAltqQueueScheduler=pfAltqQueueScheduler, pfLabelsLblTable=pfLabelsLblTable, pfAltqQueueParent=pfAltqQueueParent, pfInterfacesIf4BytesOutPass=pfInterfacesIf4BytesOutPass, pfInterfacesIf4BytesOutBlock=pfInterfacesIf4BytesOutBlock, pfTablesAddrNetType=pfTablesAddrNetType, pfInterfacesIf4PktsOutBlock=pfInterfacesIf4PktsOutBlock, pfTablesTblPktsInBlock=pfTablesTblPktsInBlock, PYSNMP_MODULE_ID=begemotPf, pfLabelsLblBytesOut=pfLabelsLblBytesOut, pfTablesAddrNet=pfTablesAddrNet, pfTablesTblBytesInPass=pfTablesTblBytesInPass, pfTablesTblRefsAnchor=pfTablesTblRefsAnchor, pfStateTableCount=pfStateTableCount, pfTablesTblBytesInXPass=pfTablesTblBytesInXPass, pfLogInterface=pfLogInterface, pfLogInterfaceIp6PktsInDrop=pfLogInterfaceIp6PktsInDrop, pfInterfacesIf6BytesOutBlock=pfInterfacesIf6BytesOutBlock, pfTimeoutsTcpFirst=pfTimeoutsTcpFirst, pfLabelsLblNumber=pfLabelsLblNumber, pfAltqQueueNumber=pfAltqQueueNumber, pfLimits=pfLimits, pfTimeoutsIcmpFirst=pfTimeoutsIcmpFirst, pfTablesAddrBytesInPass=pfTablesAddrBytesInPass, pfLogInterfaceIp6PktsOutDrop=pfLogInterfaceIp6PktsOutDrop, pfStateTableInserts=pfStateTableInserts, pfInterfacesIfRefsState=pfInterfacesIfRefsState, pfLogInterfaceName=pfLogInterfaceName, pfAltqQueueEntry=pfAltqQueueEntry, pfTables=pfTables, pfTimeoutsUdpSingle=pfTimeoutsUdpSingle, pfLogInterfaceIp4PktsInPass=pfLogInterfaceIp4PktsInPass, pfInterfacesIf4BytesInBlock=pfInterfacesIf4BytesInBlock, pfTablesTblTable=pfTablesTblTable, pfTablesAddrEntry=pfTablesAddrEntry, begemotPfObjects=begemotPfObjects, pfInterfacesIf4PktsOutPass=pfInterfacesIf4PktsOutPass, pfTablesTblDescr=pfTablesTblDescr, pfTablesAddrBytesOutPass=pfTablesAddrBytesOutPass, pfAltqQueueLimit=pfAltqQueueLimit, pfCounter=pfCounter, pfSrcNodesInserts=pfSrcNodesInserts, pfLogInterfaceIp4PktsInDrop=pfLogInterfaceIp4PktsInDrop, pfTimeoutsTcpClosed=pfTimeoutsTcpClosed, pfTimeoutsOtherSingle=pfTimeoutsOtherSingle, pfLogInterfaceIp6PktsInPass=pfLogInterfaceIp6PktsInPass, pfLogInterfaceIp6BytesOut=pfLogInterfaceIp6BytesOut, pfInterfacesIf4BytesInPass=pfInterfacesIf4BytesInPass, pfStateTable=pfStateTable, pfLimitsStates=pfLimitsStates, pfLabelsLblPktsOut=pfLabelsLblPktsOut, pfSrcNodes=pfSrcNodes, pfTablesAddrPktsOutPass=pfTablesAddrPktsOutPass, pfLogInterfaceIp4BytesIn=pfLogInterfaceIp4BytesIn, pfInterfacesIf6PktsInPass=pfInterfacesIf6PktsInPass, pfTablesTblPktsInPass=pfTablesTblPktsInPass, pfLogInterfaceIp4PktsOutDrop=pfLogInterfaceIp4PktsOutDrop, pfSrcNodesCount=pfSrcNodesCount, pfSrcNodesSearches=pfSrcNodesSearches, pfInterfacesIfRefsRule=pfInterfacesIfRefsRule, pfCounterMatch=pfCounterMatch, pfLabelsLblName=pfLabelsLblName, pfTimeoutsInterval=pfTimeoutsInterval, pfTimeoutsAdaptiveEnd=pfTimeoutsAdaptiveEnd, pfLogInterfaceIp4PktsOutPass=pfLogInterfaceIp4PktsOutPass, pfTablesTblEvalMatch=pfTablesTblEvalMatch, pfTablesAddrPktsOutBlock=pfTablesAddrPktsOutBlock, pfTablesTblRefsRule=pfTablesTblRefsRule, pfTablesTblPktsOutXPass=pfTablesTblPktsOutXPass, pfAltq=pfAltq, pfInterfacesIfType=pfInterfacesIfType, pfStatusRuntime=pfStatusRuntime, pfCounterBadOffset=pfCounterBadOffset, pfTablesAddrPktsInPass=pfTablesAddrPktsInPass, pfAltqQueueIndex=pfAltqQueueIndex, pfTablesAddrBytesInBlock=pfTablesAddrBytesInBlock, pfTablesTblPktsInXPass=pfTablesTblPktsInXPass, pfTablesTblBytesOutPass=pfTablesTblBytesOutPass, pfInterfacesIf4PktsInBlock=pfInterfacesIf4PktsInBlock, pfStatusRunning=pfStatusRunning, pfInterfacesIfDescr=pfInterfacesIfDescr, pfLogInterfaceIp6BytesIn=pfLogInterfaceIp6BytesIn, pfTimeoutsAdaptiveStart=pfTimeoutsAdaptiveStart, pfInterfacesIf6PktsOutPass=pfInterfacesIf6PktsOutPass, pfTablesAddrTZero=pfTablesAddrTZero, pfSrcNodesRemovals=pfSrcNodesRemovals, pfTablesTblTZero=pfTablesTblTZero, pfLogInterfaceIp6PktsOutPass=pfLogInterfaceIp6PktsOutPass, pfAltqQueuePriority=pfAltqQueuePriority, pfTablesAddrIndex=pfTablesAddrIndex, pfStatusDebug=pfStatusDebug, pfTimeoutsTcpClosing=pfTimeoutsTcpClosing, pfTablesTblBytesOutXPass=pfTablesTblBytesOutXPass, pfTimeouts=pfTimeouts, pfLabelsLblIndex=pfLabelsLblIndex, pfTimeoutsTcpFinWait=pfTimeoutsTcpFinWait, pfTablesTblEntry=pfTablesTblEntry, pfTablesAddrPrefix=pfTablesAddrPrefix, pfLogInterfaceIp4BytesOut=pfLogInterfaceIp4BytesOut, pfInterfacesIfEntry=pfInterfacesIfEntry, pfTimeoutsTcpEstablished=pfTimeoutsTcpEstablished, pfTablesTblBytesInBlock=pfTablesTblBytesInBlock, pfInterfacesIf6PktsOutBlock=pfInterfacesIf6PktsOutBlock, pfCounterShort=pfCounterShort, pfTimeoutsTcpOpening=pfTimeoutsTcpOpening, pfLabelsLblBytesIn=pfLabelsLblBytesIn, pfStateTableRemovals=pfStateTableRemovals, pfTimeoutsUdpMultiple=pfTimeoutsUdpMultiple, pfTablesTblNumber=pfTablesTblNumber, pfInterfacesIf6PktsInBlock=pfInterfacesIf6PktsInBlock, pfInterfacesIf6BytesInPass=pfInterfacesIf6BytesInPass, pfTablesTblBytesOutBlock=pfTablesTblBytesOutBlock, pfCounterMemDrop=pfCounterMemDrop, pfInterfacesIfTZero=pfInterfacesIfTZero, pfLabelsLblEntry=pfLabelsLblEntry, pfCounterNormalize=pfCounterNormalize, pfLimitsSrcNodes=pfLimitsSrcNodes, pfInterfaces=pfInterfaces, pfInterfacesIf6BytesInBlock=pfInterfacesIf6BytesInBlock, pfTimeoutsUdpFirst=pfTimeoutsUdpFirst, pfStatusHostId=pfStatusHostId, pfTimeoutsOtherFirst=pfTimeoutsOtherFirst, pfInterfacesIf4PktsInPass=pfInterfacesIf4PktsInPass, pfTablesTblIndex=pfTablesTblIndex, pfAltqQueueTable=pfAltqQueueTable, pfTablesAddrTable=pfTablesAddrTable, pfCounterFragment=pfCounterFragment, pfTimeoutsOtherMultiple=pfTimeoutsOtherMultiple)
