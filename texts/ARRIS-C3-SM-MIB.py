...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMBootDevice=dcxSMBootDevice, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMObjects=dcxSMObjects, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDownloadStatus=dcxSMDownloadStatus, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxIpdrGroup=dcxIpdrGroup, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd)
