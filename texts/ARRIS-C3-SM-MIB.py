...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxIpdrGroup=dcxIpdrGroup, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMBootDevice=dcxSMBootDevice, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMBootPassword=dcxSMBootPassword, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMObjects=dcxSMObjects, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadPassword=dcxSMDownloadPassword, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootPath=dcxSMBootPath, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxIpdrEnable=dcxIpdrEnable, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname)
