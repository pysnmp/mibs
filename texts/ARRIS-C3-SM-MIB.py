...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMBootPath=dcxSMBootPath, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusState=dcxDxmStatusState, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusPort=dcxDxmStatusPort, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareSize=dcxSMSoftwareSize, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMObjects=dcxSMObjects, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxIpdrEnable=dcxIpdrEnable, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount)
