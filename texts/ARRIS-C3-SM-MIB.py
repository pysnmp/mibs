...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileDate=dcxSMConfigFileDate, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMTrapGroup=dcxSMTrapGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusState=dcxDxmStatusState, dcxSMBootPath=dcxSMBootPath, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMObjects=dcxSMObjects, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMBootDevice=dcxSMBootDevice)
