...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMObjects=dcxSMObjects, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootPath=dcxSMBootPath, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMBootDevice=dcxSMBootDevice, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMBootUsername=dcxSMBootUsername, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadUsername=dcxSMDownloadUsername, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMBootGroup=dcxSMBootGroup, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd)
