...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMObjects=dcxSMObjects, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMTrapGroup=dcxSMTrapGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxIpdrGroup=dcxIpdrGroup, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMRebootAction=dcxSMRebootAction, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmObjects=dcxDxmObjects, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMBootPath=dcxSMBootPath, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface)
