...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusState=dcxDxmStatusState, dcxSMBootGroup=dcxSMBootGroup, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxIpdrFileName=dcxIpdrFileName, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootPath=dcxSMBootPath, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMObjects=dcxSMObjects, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadUsername=dcxSMDownloadUsername, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup)
