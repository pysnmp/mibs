...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMObjects=dcxSMObjects, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMBootGroup=dcxSMBootGroup, dcxDxmObjects=dcxDxmObjects, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxIpdrFileName=dcxIpdrFileName, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMImageBootFailed=dcxSMImageBootFailed, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMBootPassword=dcxSMBootPassword)
