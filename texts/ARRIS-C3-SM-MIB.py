...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxIpdrEnable=dcxIpdrEnable, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMObjects=dcxSMObjects, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxIpdrGroup=dcxIpdrGroup, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMBootUsername=dcxSMBootUsername, dcxDxmStatusState=dcxDxmStatusState, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMBootDevice=dcxSMBootDevice, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup)
