...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmObjects=dcxDxmObjects, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMObjects=dcxSMObjects, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootUsername=dcxSMBootUsername, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMBootDevice=dcxSMBootDevice, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxIpdrGroup=dcxIpdrGroup, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDownloadDevice=dcxSMDownloadDevice)
