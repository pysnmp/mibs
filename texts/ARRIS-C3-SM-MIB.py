...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMBootPath=dcxSMBootPath, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMBootUsername=dcxSMBootUsername, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMBootGroup=dcxSMBootGroup, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMBootPassword=dcxSMBootPassword, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMObjects=dcxSMObjects, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMBootDevice=dcxSMBootDevice, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMBootHostname=dcxSMBootHostname, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusState=dcxDxmStatusState, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadHostname=dcxSMDownloadHostname)
