...
Integer32, NotificationType, Counter64, IpAddress, TimeTicks, ModuleIdentity, enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Counter32, Unsigned32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "IpAddress", "TimeTicks", "ModuleIdentity", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Counter32", "Unsigned32", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootUsername=dcxSMBootUsername, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootGroup=dcxSMBootGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxIpdrGroup=dcxIpdrGroup, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadControl=dcxSMDownloadControl, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMBootDevice=dcxSMBootDevice, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMObjects=dcxSMObjects, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMRebootAction=dcxSMRebootAction, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMDownloadDevice=dcxSMDownloadDevice)
