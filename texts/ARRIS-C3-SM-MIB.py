...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootPath=dcxSMBootPath, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrFileName=dcxIpdrFileName, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMBootUsername=dcxSMBootUsername, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMDiskRemoved=dcxSMDiskRemoved, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMBootGroup=dcxSMBootGroup, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMObjects=dcxSMObjects, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMBootPassword=dcxSMBootPassword, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadHostname=dcxSMDownloadHostname)
