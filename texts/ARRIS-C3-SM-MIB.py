...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMBootPassword=dcxSMBootPassword, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMBootGroup=dcxSMBootGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxIpdrFileName=dcxIpdrFileName, dcxSMBootUsername=dcxSMBootUsername, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMObjects=dcxSMObjects, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMRebootAction=dcxSMRebootAction, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmObjects=dcxDxmObjects, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMBootPath=dcxSMBootPath, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMBootHostname=dcxSMBootHostname, dcxSMSoftwareSize=dcxSMSoftwareSize, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxDxmStatusState=dcxDxmStatusState, dcxSMConfigFileSize=dcxSMConfigFileSize, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxIpdrEnable=dcxIpdrEnable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed)
