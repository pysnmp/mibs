...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMBootPassword=dcxSMBootPassword, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMBootGroup=dcxSMBootGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxDxmStatusState=dcxDxmStatusState, dcxSMBootDevice=dcxSMBootDevice, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMRebootAction=dcxSMRebootAction, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMObjects=dcxSMObjects, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMBootUsername=dcxSMBootUsername, dcxIpdrFileName=dcxIpdrFileName, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxIpdrEnable=dcxIpdrEnable, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMTrapGroup=dcxSMTrapGroup, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname)
