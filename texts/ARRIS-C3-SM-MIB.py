...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMBootHostname=dcxSMBootHostname, dcxDxmStatusRole=dcxDxmStatusRole, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMObjects=dcxSMObjects, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadHostname=dcxSMDownloadHostname, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMBootDevice=dcxSMBootDevice, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMBootUsername=dcxSMBootUsername, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMRebootAction=dcxSMRebootAction, dcxDxmObjects=dcxDxmObjects, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxIpdrGroup=dcxIpdrGroup, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMBootGroup=dcxSMBootGroup, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxDxmStatusState=dcxDxmStatusState, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileTable=dcxSMConfigFileTable)
