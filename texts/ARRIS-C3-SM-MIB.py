...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxIpdrGroup=dcxIpdrGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMRebootAction=dcxSMRebootAction, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMDownloadControl=dcxSMDownloadControl, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxDxmObjects=dcxDxmObjects, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMBootGroup=dcxSMBootGroup, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusPort=dcxDxmStatusPort, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDownloadDevice=dcxSMDownloadDevice, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxIpdrEnable=dcxIpdrEnable, dcxSMBootHostname=dcxSMBootHostname, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMDownloadPath=dcxSMDownloadPath, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMObjects=dcxSMObjects, dcxSMBootPath=dcxSMBootPath, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileEntry=dcxSMConfigFileEntry)
