...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxSMBootGroup=dcxSMBootGroup, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMDownloadControl=dcxSMDownloadControl, dcxIpdrEnable=dcxIpdrEnable, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMDiskFailed=dcxSMDiskFailed, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMBootPath=dcxSMBootPath, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootPassword=dcxSMBootPassword, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxIpdrGroup=dcxIpdrGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMObjects=dcxSMObjects, dcxIpdrFileName=dcxIpdrFileName, dcxDxmObjects=dcxDxmObjects, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMBootHostname=dcxSMBootHostname, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMConfigFileSize=dcxSMConfigFileSize, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMBootDevice=dcxSMBootDevice, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxDxmStatusState=dcxDxmStatusState, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxDxmStatusGroup=dcxDxmStatusGroup, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname)
