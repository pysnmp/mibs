...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxIpdrGroup=dcxIpdrGroup, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxSMRebootAction=dcxSMRebootAction, dcxSMBootPath=dcxSMBootPath, dcxSMDownloadControl=dcxSMDownloadControl, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMMiscUserTable=dcxSMMiscUserTable, dcxDxmObjects=dcxDxmObjects, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMBootGroup=dcxSMBootGroup, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMObjects=dcxSMObjects, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxIpdrFileName=dcxIpdrFileName, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMBootHostname=dcxSMBootHostname, dcxIpdrEnable=dcxIpdrEnable, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxSMBootDevice=dcxSMBootDevice, dcxSMBootPassword=dcxSMBootPassword, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, cmtsC3SMMIB=cmtsC3SMMIB, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxDxmStatusState=dcxDxmStatusState, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileStatus=dcxSMConfigFileStatus, dcxDxmStatusPort=dcxDxmStatusPort, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxSMTrapGroup=dcxSMTrapGroup, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMBootUsername=dcxSMBootUsername, dcxSMConfigFileDesc=dcxSMConfigFileDesc)
