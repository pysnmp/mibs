...
mibBuilder.exportSymbols("ARRIS-C3-SM-MIB", dcxSMMiscUserEnableSecretePwd=dcxSMMiscUserEnableSecretePwd, dcxSMConfigFileEntry=dcxSMConfigFileEntry, dcxIpdrGroup=dcxIpdrGroup, dcxSMConfigFileTable=dcxSMConfigFileTable, dcxDxmStatusHeartbeatCount=dcxDxmStatusHeartbeatCount, dcxIpdrEnable=dcxIpdrEnable, dcxSMConfigFileDate=dcxSMConfigFileDate, dcxDxmStatusNotifAddCmCount=dcxDxmStatusNotifAddCmCount, dcxSMEnetMgmtInterface=dcxSMEnetMgmtInterface, dcxSMMiscUserLoginName=dcxSMMiscUserLoginName, dcxSMTrapGroup=dcxSMTrapGroup, dcxDxmObjects=dcxDxmObjects, dcxSMDownloadControl=dcxSMDownloadControl, dcxSMDownloadDevice=dcxSMDownloadDevice, dcxDxmStatusNotifDelCpeCount=dcxDxmStatusNotifDelCpeCount, dcxSMDownloadStatus=dcxSMDownloadStatus, dcxSMSoftwareIndex=dcxSMSoftwareIndex, dcxSMSoftwareVersion=dcxSMSoftwareVersion, dcxSMConfigFileBootPath=dcxSMConfigFileBootPath, dcxSMMiscUserWorkMode=dcxSMMiscUserWorkMode, dcxSMConfigFileBootPassword=dcxSMConfigFileBootPassword, dcxSMConfigFileBootHostname=dcxSMConfigFileBootHostname, dcxDxmStatusState=dcxDxmStatusState, dcxDxmStatusIpAddress=dcxDxmStatusIpAddress, dcxSMSoftwareStatus=dcxSMSoftwareStatus, dcxIpdrFileName=dcxIpdrFileName, dcxDxmStatusNotifDelCmCount=dcxDxmStatusNotifDelCmCount, dcxSMConfigFileBootGroup=dcxSMConfigFileBootGroup, dcxSMConfigFileBootDevice=dcxSMConfigFileBootDevice, dcxSMMiscUserTable=dcxSMMiscUserTable, cmtsC3SMMIB=cmtsC3SMMIB, dcxSMSoftwareListTable=dcxSMSoftwareListTable, dcxSMImageChecksumChanged=dcxSMImageChecksumChanged, dcxIpdrUserLoginName=dcxIpdrUserLoginName, dcxSMBootGroup=dcxSMBootGroup, dcxSMDownloadPassword=dcxSMDownloadPassword, dcxDxmStatusLastConfigRetrieval=dcxDxmStatusLastConfigRetrieval, dcxDxmStatusNotifAddCpeCount=dcxDxmStatusNotifAddCpeCount, dcxSMDownloadPath=dcxSMDownloadPath, dcxSMDiskRemoved=dcxSMDiskRemoved, dcxSMSoftwareDesc=dcxSMSoftwareDesc, dcxSMMiscUserEnablePwd=dcxSMMiscUserEnablePwd, dcxIpdrUserLoginPwd=dcxIpdrUserLoginPwd, dcxSMSoftwareListGroup=dcxSMSoftwareListGroup, dcxSMDiskInserted=dcxSMDiskInserted, dcxSMConfigFileDesc=dcxSMConfigFileDesc, dcxDxmStatusPort=dcxDxmStatusPort, dcxSMBootPath=dcxSMBootPath, dcxSMSoftwareSize=dcxSMSoftwareSize, dcxDxmStatusCmtsId=dcxDxmStatusCmtsId, dcxSMRebootAction=dcxSMRebootAction, dcxSMConfigChecksumChanged=dcxSMConfigChecksumChanged, dcxDxmStatusGroup=dcxDxmStatusGroup, dcxSMBootDevice=dcxSMBootDevice, dcxDxmStatusLastConfigChange=dcxDxmStatusLastConfigChange, dcxSMSoftwareDate=dcxSMSoftwareDate, dcxDxmStatusRole=dcxDxmStatusRole, dcxSMConfigFileIndex=dcxSMConfigFileIndex, dcxSMMiscUserLoginPwd=dcxSMMiscUserLoginPwd, dcxSMImageDownloadFailed=dcxSMImageDownloadFailed, dcxSMConfigFileGroup=dcxSMConfigFileGroup, dcxSMDownloadHostname=dcxSMDownloadHostname, dcxSMSoftwareListEntry=dcxSMSoftwareListEntry, dcxSMDownloadGroup=dcxSMDownloadGroup, dcxSMDiskFailed=dcxSMDiskFailed, dcxSMObjects=dcxSMObjects, dcxDxmStatusConfigRetrievalCount=dcxDxmStatusConfigRetrievalCount, dcxDxmStatusEnable=dcxDxmStatusEnable, dcxSMConfigFileChecksum=dcxSMConfigFileChecksum, dcxSMBootHostname=dcxSMBootHostname, PYSNMP_MODULE_ID=cmtsC3SMMIB, dcxSMImageBootFailed=dcxSMImageBootFailed, dcxSMDownloadUsername=dcxSMDownloadUsername, dcxSMConfigFileBootUsername=dcxSMConfigFileBootUsername, dcxSMMiscUserManagementGroup=dcxSMMiscUserManagementGroup, dcxSMBootUsername=dcxSMBootUsername, dcxSMBootPassword=dcxSMBootPassword, dcxSMSoftwareChecksum=dcxSMSoftwareChecksum, dcxSMConfigFileSize=dcxSMConfigFileSize, dcxSMMiscUserIndex=dcxSMMiscUserIndex, dcxSMMiscUserListEntry=dcxSMMiscUserListEntry, dcxSMConfigFileStatus=dcxSMConfigFileStatus)
