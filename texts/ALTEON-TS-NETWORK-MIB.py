...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, vrrpOper=vrrpOper, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoTag=ipRouteInfoTag, routeStatHighWater=routeStatHighWater, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxTxStats=ospfAreaRxTxStats, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfIndex=ospfIntfIndex, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrp_info=vrrp_info, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumTxHello=ospfCumTxHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgListen=ripNewCfgListen, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrDown=ospfIntfNbrDown, ipGatewayTableMax=ipGatewayTableMax, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfGeneralStats=ospfGeneralStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfInterface=ospfInterface, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpStats=vrrpStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkData=routerLSALinkData, ospfGeneral=ospfGeneral, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwTable=ipCurCfgGwTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpInfoDestIp=arpInfoDestIp, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTotalNeighbours=ospfTotalNeighbours, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumRxPkts=ospfCumRxPkts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpGeneral=vrrpGeneral, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routerLSAId=routerLSAId, ipNewCfgIntfTable=ipNewCfgIntfTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpStats=arpStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxHello=ospfAreaRxHello, arpInfoEntry=arpInfoEntry, ospfCumIntfBackup=ospfCumIntfBackup, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfLoop=ospfCumIntfLoop, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumIntfHello=ospfCumIntfHello, ospfIfWaitInterval=ospfIfWaitInterval, ospfNbrInExchState=ospfNbrInExchState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routeStats=routeStats, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSALinkIndex=routerLSALinkIndex, ip_info=ip_info, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoVLAN=arpInfoVLAN, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTmrsKckOffHello=ospfTmrsKckOffHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfState=ipNewCfgIntfState, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNbrInFullState=ospfNbrInFullState, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumTxDatabase=ospfCumTxDatabase, ripStats=ripStats, ospfArea=ospfArea, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrp=vrrp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripCurCfgState=ripCurCfgState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfLsTypesSupported=ospfLsTypesSupported, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfChangeStats=ospfIntfChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfHello=ospfIntfHello, arpInfoFlag=arpInfoFlag, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInInitState=ospfNbrInInitState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpStatHighWater=arpStatHighWater, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripConfig=ripConfig, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgVip=ripCurCfgVip, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCfg=ospfCfg, ripStatInPkts=ripStatInPkts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaTxHello=ospfAreaTxHello, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfDown=ospfIntfDown, ospfStats=ospfStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoType=ipRouteInfoType, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrStart=ospfCumNbrStart, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipForward=ipForward, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStatOutPkts=ripStatOutPkts, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routeStatEntries=routeStatEntries, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routerLSALinkID=routerLSALinkID, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfLoop=ospfIntfLoop, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipInterfaceTableMax=ipInterfaceTableMax)
