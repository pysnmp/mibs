...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoType=ipRouteInfoType, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCfg=ospfCfg, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpStats=arpStats, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, ospfNbrInExchState=ospfNbrInExchState, ospfinfo=ospfinfo, ospfLsTypesSupported=ospfLsTypesSupported, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpGeneral=vrrpGeneral, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaChangeStats=ospfAreaChangeStats, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfInterface=ospfInterface, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfStats=ospfStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrDown=ospfCumNbrDown, routerLSAId=routerLSAId, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgListen=ripNewCfgListen, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipForward=ipForward, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTimersKickOffStats=ospfTimersKickOffStats, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfGeneralStats=ospfGeneralStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrp=vrrp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfDown=ospfCumIntfDown, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrhello=ospfAreaNbrhello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumIntfLoop=ospfCumIntfLoop, ripStats=ripStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfIndex=ospfIntfIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfArea=ospfArea, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routeStats=routeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwTable=ipNewCfgGwTable, arpStatEntries=arpStatEntries, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routerLSAAreaIndex=routerLSAAreaIndex, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfLoop=ospfIntfLoop, ospfCumNbrRstAd=ospfCumNbrRstAd, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoFlag=arpInfoFlag, ripCurCfgVip=ripCurCfgVip, ospfGeneralInfo=ospfGeneralInfo, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routeStatHighWater=routeStatHighWater, arpInfoDestIp=arpInfoDestIp, ospfNbrInInitState=ospfNbrInInitState, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTotalAreas=ospfTotalAreas, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfEntry=ipNewCfgIntfEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwArp=ipNewCfgGwArp, ospfCumTxDatabase=ospfCumTxDatabase, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrN1way=ospfCumNbrN1way, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNbrInFullState=ospfNbrInFullState, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrRstAd=ospfAreaNbrRstAd, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripCurCfgListen=ripCurCfgListen, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routeStatEntries=routeStatEntries, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxHello=ospfAreaRxHello, arpInfoVLAN=arpInfoVLAN, ospfIntfChangeStats=ospfIntfChangeStats, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrStart=ospfAreaNbrStart, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgGwIndex=ipNewCfgGwIndex, arpStatHighWater=arpStatHighWater, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipRouteInfoTable=ipRouteInfoTable, ospfCumTxHello=ospfCumTxHello, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgState=ipFwdNewCfgState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfHello=ospfIntfHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxTxStats=ospfIntfRxTxStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaTxPkts=ospfAreaTxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, iprouting=iprouting, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfGeneral=ospfGeneral, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpOper=vrrpOper, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ip_info=ip_info, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, arpInfoTable=arpInfoTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfProcessUptime=ospfProcessUptime, ipGatewayTableMax=ipGatewayTableMax, dnsStats=dnsStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoIndx=ipRouteInfoIndx, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpStats=vrrpStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfHostTableMaxSize=ospfHostTableMaxSize)
