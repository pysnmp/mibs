...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfInterface=ospfInterface, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ip_info=ip_info, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgSupply=ripCurCfgSupply, ipRouteInfoInterface=ipRouteInfoInterface, vrrpOper=vrrpOper, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfRxPkts=ospfIntfRxPkts, arpInfoTable=arpInfoTable, ospfAreaIntfBackup=ospfAreaIntfBackup, routeStats=routeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipForward=ipForward, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfTxPkts=ospfIntfTxPkts, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrStart=ospfCumNbrStart, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripStatInErrorPkts=ripStatInErrorPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfProcessUptime=ospfProcessUptime, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpStatHighWater=arpStatHighWater, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwState=ipNewCfgGwState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfStats=ospfStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpInfoVLAN=arpInfoVLAN, ripNewCfgListen=ripNewCfgListen, ospfArea=ospfArea, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routeStatMaxEntries=routeStatMaxEntries, ospfLsTypesSupported=ospfLsTypesSupported, arpStats=arpStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgListen=ripCurCfgListen, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, dnsStats=dnsStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTotalTransitAreas=ospfTotalTransitAreas, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNbrInInitState=ospfNbrInInitState, ripStatOutPkts=ripStatOutPkts, ripConfig=ripConfig, arpInfoDestIp=arpInfoDestIp, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routeStatHighWater=routeStatHighWater, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNbrInFullState=ospfNbrInFullState, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumTxHello=ospfCumTxHello, arpInfoFlag=arpInfoFlag, ripStats=ripStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumRxlsAcks=ospfCumRxlsAcks)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfGeneralInfo=ospfGeneralInfo, vrrp_info=vrrp_info, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumTxPkts=ospfCumTxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNbrInExchState=ospfNbrInExchState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrp=vrrp, vrrpGeneral=vrrpGeneral, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripCurCfgVip=ripCurCfgVip, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxlsAcks=ospfCumTxlsAcks, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, routerLSALinkID=routerLSALinkID, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfLoop=ospfIntfLoop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfGeneralStats=ospfGeneralStats, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrChangeStats=ospfCumNbrChangeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfinfo=ospfinfo, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpInfoEntry=arpInfoEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpStatMaxEntries=arpStatMaxEntries, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfDown=ospfIntfDown, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfGeneral=ospfGeneral, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripNewCfgState=ripNewCfgState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripNewCfgVip=ripNewCfgVip, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfHello=ospfIntfHello, ospfCfg=ospfCfg, ospfIntfTxHello=ospfIntfTxHello, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrDown=ospfCumNbrDown, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoTable=ipRouteInfoTable, arpStatEntries=arpStatEntries, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoMask=ipRouteInfoMask, ripCurCfgState=ripCurCfgState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, iprouting=iprouting, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumIntfBackup=ospfCumIntfBackup, ospfStartTime=ospfStartTime, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumTxDatabase=ospfCumTxDatabase, routerLSAId=routerLSAId, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrhello=ospfCumNbrhello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfIndex=ospfIntfIndex, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing)
