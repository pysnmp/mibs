...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrN1way=ospfCumNbrN1way, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripCurCfgState=ripCurCfgState, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfDown=ospfIntfDown, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, routerLSAId=routerLSAId, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwState=ipNewCfgGwState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrp_info=vrrp_info, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpInfoEntry=arpInfoEntry, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrStart=ospfIntfNbrStart, ripCurCfgListen=ripCurCfgListen, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfCountForRouter=ospfIntfCountForRouter, ip_info=ip_info, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpInfoFlag=arpInfoFlag, ospfAreaInfoId=ospfAreaInfoId, ospfCfg=ospfCfg, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfBackup=ospfIntfBackup, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routeStatHighWater=routeStatHighWater, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripConfig=ripConfig, ripCurCfgVip=ripCurCfgVip, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, arpInfoDestIp=arpInfoDestIp, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfTotalNeighbours=ospfTotalNeighbours, ripCurCfgDefListen=ripCurCfgDefListen, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfArea=ospfArea, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxPkts=ospfCumRxPkts, routerLSALinkID=routerLSALinkID, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfGeneralStats=ospfGeneralStats, ripStats=ripStats, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfHello=ospfIntfHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpStats=arpStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, iprouting=iprouting, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripStatInPkts=ripStatInPkts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfDelete=ipNewCfgIntfDelete, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTotalAreas=ospfTotalAreas, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfIndex=ospfIntfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfIndex=ospfAreaIntfIndex, ripStatOutPkts=ripStatOutPkts, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNbrInFullState=ospfNbrInFullState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfMask=ipNewCfgIntfMask, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpStatHighWater=arpStatHighWater, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxTxStats=ospfIntfRxTxStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripNewCfgState=ripNewCfgState, ospfAreaNbrDown=ospfAreaNbrDown, ipForward=ipForward, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfinfo=ospfinfo, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgListen=ripNewCfgListen, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfStartTime=ospfStartTime, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, arpStatEntries=arpStatEntries, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNbrInExchState=ospfNbrInExchState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgSupply=ripCurCfgSupply, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgIntfEntry=ipNewCfgIntfEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipRouteInfoTag=ipRouteInfoTag, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpOper=vrrpOper, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routeStatEntries=routeStatEntries, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoTable=ipRouteInfoTable, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routerLSALinkIfIndex=routerLSALinkIfIndex, routerLSALinkData=routerLSALinkData, vrrpStats=vrrpStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpInfoRefPorts=arpInfoRefPorts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, dnsStats=dnsStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIfWaitInterval=ospfIfWaitInterval, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routeStats=routeStats, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwState=ipCurCfgGwState, ospfStats=ospfStats, ospfAreaTxHello=ospfAreaTxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoType=ipRouteInfoType, ipCurCfgIntfIndex=ipCurCfgIntfIndex)
