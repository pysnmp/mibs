...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgState=ripNewCfgState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripStatOutPkts=ripStatOutPkts, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatHighWater=arpStatHighWater, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routeStats=routeStats, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxPkts=ospfCumRxPkts, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaTxHello=ospfAreaTxHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpStatEntries=arpStatEntries, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpInfoVLAN=arpInfoVLAN, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgVip=ripNewCfgVip, routerLSAId=routerLSAId, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTotalAreas=ospfTotalAreas, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCfg=ospfCfg, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrhello=ospfAreaNbrhello, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTotalNssaAreas=ospfTotalNssaAreas, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrhello=ospfCumNbrhello, ospfIntfLoop=ospfIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpInfoFlag=arpInfoFlag, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpStats=vrrpStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfStartTime=ospfStartTime, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgDefListen=ripCurCfgDefListen, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripStats=ripStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrp=vrrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfGeneral=ospfGeneral, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwState=ipCurCfgGwState, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfChangeStats=ospfIntfChangeStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoTable=arpInfoTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpOper=vrrpOper, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfWaitInterval=ospfIfWaitInterval, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfDown=ospfIntfDown, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoType=ipRouteInfoType, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkData=routerLSALinkData, vrrpGeneral=vrrpGeneral, ipNewCfgGwTable=ipNewCfgGwTable, ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgListen=ripCurCfgListen, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfGeneralStats=ospfGeneralStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, dnsStats=dnsStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipForward=ipForward, arpStats=arpStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrp_info=vrrp_info, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfRxPkts=ospfIntfRxPkts, ripStatInPkts=ripStatInPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrDown=ospfAreaNbrDown, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrRstAd=ospfCumNbrRstAd)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routeStatEntries=routeStatEntries, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoRefPorts=arpInfoRefPorts, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgBootpState=ipNewCfgBootpState, ospfLsTypesSupported=ospfLsTypesSupported, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaInfoId=ospfAreaInfoId, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routerLSALinkID=routerLSALinkID, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoEntry=arpInfoEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripConfig=ripConfig, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxHello=ospfIntfRxHello, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumRxDatabase=ospfCumRxDatabase, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgState=ripCurCfgState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfBackup=ospfIntfBackup, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfHello=ospfCumIntfHello, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfGeneralInfo=ospfGeneralInfo, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfDown=ospfAreaIntfDown, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaChangeStats=ospfAreaChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfInterface=ospfInterface, ospfIntfNbrStart=ospfIntfNbrStart, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routerLSALinkIndex=routerLSALinkIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, iprouting=iprouting, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxPkts=ospfCumTxPkts, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipGatewayTableMax=ipGatewayTableMax, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ip_info=ip_info, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk)
