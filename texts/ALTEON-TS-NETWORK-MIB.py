...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpStats=vrrpStats, ospfCumNbrhello=ospfCumNbrhello, ospfTotalAreas=ospfTotalAreas, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ip_info=ip_info, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routeStatHighWater=routeStatHighWater, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpGeneral=vrrpGeneral, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfStats=ospfStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumRxPkts=ospfCumRxPkts, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoTable=arpInfoTable, ripNewCfgVip=ripNewCfgVip, arpStats=arpStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripStats=ripStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, routerLSAId=routerLSAId, vrrpStatOutAdvers=vrrpStatOutAdvers, iprouting=iprouting, ospfAreaInfoTable=ospfAreaInfoTable, arpInfoSrcPort=arpInfoSrcPort, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgGwMetric=ipNewCfgGwMetric, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpInfoEntry=arpInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfArea=ospfArea, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfProcessUptime=ospfProcessUptime, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgListen=ripCurCfgListen, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgBootpState=ipNewCfgBootpState, vrrpStatInAdvers=vrrpStatInAdvers, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfWaitTimer=ospfIntfWaitTimer, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNbrInFullState=ospfNbrInFullState, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripNewCfgListen=ripNewCfgListen, ipInterfaceTableMax=ipInterfaceTableMax, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripConfig=ripConfig, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripNewCfgSupply=ripNewCfgSupply, arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgState=ipFwdCurCfgState, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrDown=ospfIntfNbrDown, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgGwState=ipCurCfgGwState, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaInfoId=ospfAreaInfoId, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfState=ipCurCfgIntfState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfIndex=ospfIntfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoIndx=ipRouteInfoIndx, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, dnsStats=dnsStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgState=ripCurCfgState, routeStatEntries=routeStatEntries)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrp=vrrp, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSALinkIndex=routerLSALinkIndex, ospfCumTxPkts=ospfCumTxPkts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfDown=ospfIntfDown, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routerLSALinkData=routerLSALinkData, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipForward=ipForward, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfHello=ospfIntfHello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipRouteInfoType=ipRouteInfoType, ospfNbrInExchState=ospfNbrInExchState, vrrpOper=vrrpOper, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTxHello=ospfIntfTxHello, ospfStartTime=ospfStartTime, ipCurCfgBootpState=ipCurCfgBootpState, ripCurCfgVip=ripCurCfgVip, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumTxHello=ospfCumTxHello, ospfInterface=ospfInterface, ospfCfg=ospfCfg, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routeStats=routeStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrDown=ospfCumNbrDown, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoFlag=arpInfoFlag, ospfIntfRxHello=ospfIntfRxHello, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumRxHello=ospfCumRxHello, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgIntfState=ipNewCfgIntfState, ospfGeneral=ospfGeneral, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, routeStatMaxEntries=routeStatMaxEntries, vrrp_info=vrrp_info, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumTxDatabase=ospfCumTxDatabase, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrStart=ospfCumNbrStart, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod)
