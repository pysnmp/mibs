...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwTable=ipNewCfgGwTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgVip=ripNewCfgVip, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfDown=ospfIntfDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrDown=ospfIntfNbrDown, arpStatEntries=arpStatEntries, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpStatMaxEntries=arpStatMaxEntries, vrrpStats=vrrpStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumRxHello=ospfCumRxHello, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIfInfoIndex=ospfIfInfoIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfStartTime=ospfStartTime, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgSupply=ripNewCfgSupply, arpInfoDestIp=arpInfoDestIp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripStatOutPkts=ripStatOutPkts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipForward=ipForward, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routerLSAId=routerLSAId, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoInterface=ipRouteInfoInterface, iprouting=iprouting, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfIndex=ospfIntfIndex, ospfTotalAreas=ospfTotalAreas, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfProcessUptime=ospfProcessUptime, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfArea=ospfArea, ipRouteInfoEntry=ipRouteInfoEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoType=ipRouteInfoType, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxDatabase=ospfCumRxDatabase, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalNeighbours=ospfTotalNeighbours, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrp_info=vrrp_info, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpStatHighWater=arpStatHighWater, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfinfo=ospfinfo, ip_info=ip_info, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, routeStatEntries=routeStatEntries, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfBackup=ospfIntfBackup, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpStats=arpStats, ospfIntfTxHello=ospfIntfTxHello, ospfCumTxPkts=ospfCumTxPkts, ospfNbrInInitState=ospfNbrInInitState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpStatInAdvers=vrrpStatInAdvers, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxHello=ospfAreaRxHello, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripConfig=ripConfig, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrDown=ospfAreaNbrDown, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfGeneral=ospfGeneral, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpGeneral=vrrpGeneral, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumIntfHello=ospfCumIntfHello, ospfIntfTxPkts=ospfIntfTxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgGwArp=ipCurCfgGwArp, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfInterface=ospfInterface, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfLsTypesSupported=ospfLsTypesSupported, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwVlan=ipNewCfgGwVlan)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripCurCfgState=ripCurCfgState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCfg=ospfCfg, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaTxHello=ospfAreaTxHello, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routeStats=routeStats, vrrp=vrrp, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumRxTxStats=ospfCumRxTxStats, vrrpOper=vrrpOper, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipGatewayTableMax=ipGatewayTableMax, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatInPkts=ripStatInPkts, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgIntfMask=ipCurCfgIntfMask, ripStats=ripStats, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfHello=ospfIntfHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipInterfaceTableMax=ipInterfaceTableMax, ospfStats=ospfStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwState=ipCurCfgGwState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxHello=ospfIntfRxHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSALinkData=routerLSALinkData, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaInfoId=ospfAreaInfoId, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfGeneralInfo=ospfGeneralInfo, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfState=ipNewCfgIntfState, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpInfoEntry=arpInfoEntry, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, dnsStats=dnsStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex)
