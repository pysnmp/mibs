...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpInfoSrcPort=arpInfoSrcPort, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoId=ospfAreaInfoId, routerLSAAreaIndex=routerLSAAreaIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripCurCfgSupply=ripCurCfgSupply, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfHello=ospfAreaIntfHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNbrInInitState=ospfNbrInInitState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxHello=ospfCumRxHello, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfIndex=ospfIntfIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStats=vrrpStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripNewCfgState=ripNewCfgState, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpStatHighWater=arpStatHighWater, ripCurCfgDefListen=ripCurCfgDefListen, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripNewCfgSupply=ripNewCfgSupply, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoType=ipRouteInfoType, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaInfoEntry=ospfAreaInfoEntry, ip_info=ip_info, ripStats=ripStats, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTxHello=ospfAreaTxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxPkts=ospfCumRxPkts, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaInfoTable=ospfAreaInfoTable, ripNewCfgListen=ripNewCfgListen, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripCurCfgVip=ripCurCfgVip, ipRouteInfoTag=ipRouteInfoTag, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripStatInPkts=ripStatInPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, arpInfoVLAN=arpInfoVLAN, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpStats=arpStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwArp=ipCurCfgGwArp, ripCurCfgListen=ripCurCfgListen, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfGeneralStats=ospfGeneralStats, ospfInterface=ospfInterface, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routeStats=routeStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpGeneral=vrrpGeneral, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, iprouting=iprouting, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, dnsStats=dnsStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routeStatMaxEntries=routeStatMaxEntries, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrDown=ospfAreaNbrDown, routerLSAId=routerLSAId, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfinfo=ospfinfo, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routerLSALinkData=routerLSALinkData, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNbrInExchState=ospfNbrInExchState, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfStats=ospfStats, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipGatewayTableMax=ipGatewayTableMax, vrrp_info=vrrp_info, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxHello=ospfCumTxHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpOper=vrrpOper, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipForward=ipForward, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIfWaitInterval=ospfIfWaitInterval, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoEntry=arpInfoEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrhello=ospfCumNbrhello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrChange=ospfIntfNbrChange, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfLoop=ospfIntfLoop, ospfGeneral=ospfGeneral, arpStatEntries=arpStatEntries, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfDown=ospfIntfDown, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalAreas=ospfTotalAreas, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routeStatHighWater=routeStatHighWater, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumNbrN1way=ospfCumNbrN1way, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrhello=ospfAreaNbrhello, routeStatEntries=routeStatEntries, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfHello=ospfIntfHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSALinkID=routerLSALinkID, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfArea=ospfArea, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrp=vrrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfStartTime=ospfStartTime, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfProcessUptime=ospfProcessUptime, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoMask=ipRouteInfoMask, routerLSALinkIndex=routerLSALinkIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ripConfig=ripConfig, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrhello=ospfIntfNbrhello, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp)
