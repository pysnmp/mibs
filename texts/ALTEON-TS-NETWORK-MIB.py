...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrDown=ospfCumNbrDown, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalAreas=ospfTotalAreas, ospfStartTime=ospfStartTime, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgState=ipFwdNewCfgState, ospfArea=ospfArea, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenState=vrrpCurCfgGenState, arpStats=arpStats, ipCurCfgGwTable=ipCurCfgGwTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfIndex=ospfIntfIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routerLSALinkID=routerLSALinkID, ripStats=ripStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoVLAN=arpInfoVLAN, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipGatewayTableMax=ipGatewayTableMax, routerLSALinkIndex=routerLSALinkIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpInfoEntry=arpInfoEntry, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaIntfHello=ospfAreaIntfHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxHello=ospfAreaRxHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routeStats=routeStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOper=vrrpOper, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoType=ipRouteInfoType, vrrp_info=vrrp_info, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfTxPkts=ospfIntfTxPkts, routerLSAId=routerLSAId, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgState=ripCurCfgState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, dnsStats=dnsStats, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoIndx=ipRouteInfoIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxPkts=ospfIntfRxPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfBackup=ospfIntfBackup, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgListen=ripCurCfgListen, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpStatEntries=arpStatEntries, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfStats=ospfStats, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrChange=ospfIntfNbrChange, ripConfig=ripConfig, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpStats=vrrpStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfLsTypesSupported=ospfLsTypesSupported, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwState=ipCurCfgGwState, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxHello=ospfIntfRxHello, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNbrInFullState=ospfNbrInFullState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfGeneral=ospfGeneral, iprouting=iprouting, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrp=vrrp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCfg=ospfCfg, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgVip=ripNewCfgVip, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpStatMaxEntries=arpStatMaxEntries, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrStart=ospfIntfNbrStart, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfHello=ospfIntfHello, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfGeneralStats=ospfGeneralStats, ospfCumNbrhello=ospfCumNbrhello, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpStatHighWater=arpStatHighWater, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpGeneral=vrrpGeneral, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfLoop=ospfIntfLoop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwMetric=ipCurCfgGwMetric, arpInfoRefPorts=arpInfoRefPorts, ospfGeneralInfo=ospfGeneralInfo, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwEntry=ipCurCfgGwEntry, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrhello=ospfAreaNbrhello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpInfoTable=arpInfoTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfInterface=ospfInterface, ospfCumTxHello=ospfCumTxHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrhello=ospfIntfNbrhello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwState=ipNewCfgGwState, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfProcessUptime=ospfProcessUptime, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripNewCfgSupply=ripNewCfgSupply, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfTxDatabase=ospfIntfTxDatabase, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripStatInErrorPkts=ripStatInErrorPkts, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumTxDatabase=ospfCumTxDatabase, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxPkts=ospfCumRxPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ip_info=ip_info, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipRouteInfoGateway=ipRouteInfoGateway, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripNewCfgState=ripNewCfgState, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipForward=ipForward, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoTable=ipRouteInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable)
