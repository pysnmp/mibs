...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxHello=ospfAreaRxHello, ospfinfo=ospfinfo, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoMask=ipRouteInfoMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfIndex=ospfIntfIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripStatInErrorPkts=ripStatInErrorPkts, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfUnloop=ospfIntfUnloop, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpStats=arpStats, dnsStats=dnsStats, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNbrInFullState=ospfNbrInFullState, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpStatHighWater=arpStatHighWater, ripStatOutPkts=ripStatOutPkts, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpInfoDestIp=arpInfoDestIp, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, routeStatHighWater=routeStatHighWater, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxHello=ospfIntfRxHello, vrrpGeneral=vrrpGeneral, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoSrcPort=arpInfoSrcPort, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSALinkIfIndex=routerLSALinkIfIndex, routerLSALinkData=routerLSALinkData, ospfCumNbrStart=ospfCumNbrStart, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripStats=ripStats, ospfAreaInfoId=ospfAreaInfoId, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpOper=vrrpOper, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoTable=arpInfoTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfHello=ospfCumIntfHello, ripCurCfgState=ripCurCfgState, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfState=ipNewCfgIntfState, ripConfig=ripConfig, ospfCfg=ospfCfg, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxHello=ospfIntfTxHello, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripNewCfgState=ripNewCfgState, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfGeneral=ospfGeneral, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxPkts=ospfIntfRxPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfArea=ospfArea, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumTxHello=ospfCumTxHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpStatInAdvers=vrrpStatInAdvers, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwEntry=ipCurCfgGwEntry, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfStats=ospfStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSALinkIndex=routerLSALinkIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpStats=vrrpStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNbrInExchState=ospfNbrInExchState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaInfoTable=ospfAreaInfoTable, ipForward=ipForward, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipRouteInfoTag=ipRouteInfoTag, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfDown=ospfIntfDown, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumRxPkts=ospfCumRxPkts)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfStartTime=ospfStartTime, routerLSAId=routerLSAId, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfLoop=ospfCumIntfLoop, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripCurCfgVip=ripCurCfgVip, routerLSALinkID=routerLSALinkID, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfGeneralStats=ospfGeneralStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpStatEntries=arpStatEntries, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaIntfHello=ospfAreaIntfHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfHello=ospfIntfHello, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfInterface=ospfInterface, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrp_info=vrrp_info, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfProcessUptime=ospfProcessUptime, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgState=ipFwdNewCfgState, routeStats=routeStats, arpInfoFlag=arpInfoFlag, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfLoop=ospfIntfLoop, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpInfoVLAN=arpInfoVLAN, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrStart=ospfAreaNbrStart, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpInfoEntry=arpInfoEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfTxDatabase=ospfIntfTxDatabase, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ip_info=ip_info, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrp=vrrp, ospfCumNbrN1way=ospfCumNbrN1way)
