...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgGwState=ipNewCfgGwState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoVLAN=arpInfoVLAN, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgState=ripNewCfgState, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfStats=ospfStats, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, dnsStats=dnsStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipRouteInfoType=ipRouteInfoType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipGatewayTableMax=ipGatewayTableMax, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTxHello=ospfIntfTxHello, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrp=vrrp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwDelete=ipNewCfgGwDelete, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripCurCfgState=ripCurCfgState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCfg=ospfCfg, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpOper=vrrpOper, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoDestIp=arpInfoDestIp, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoTag=ipRouteInfoTag, routeStatHighWater=routeStatHighWater, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwArp=ipCurCfgGwArp, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, iprouting=iprouting, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfDown=ospfIntfDown, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, routeStatEntries=routeStatEntries, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumNbrhello=ospfCumNbrhello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrChange=ospfIntfNbrChange, arpStatHighWater=arpStatHighWater, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpStats=vrrpStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgState=ipFwdCurCfgState, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxDatabase=ospfCumTxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripCurCfgDefListen=ripCurCfgDefListen, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoMask=ipRouteInfoMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumRxDatabase=ospfCumRxDatabase, ospfGeneral=ospfGeneral, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrN1way=ospfAreaNbrN1way, ripNewCfgDefListen=ripNewCfgDefListen, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripCurCfgListen=ripCurCfgListen, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, arpStatEntries=arpStatEntries, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkData=routerLSALinkData, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripCurCfgVip=ripCurCfgVip, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfGeneralStats=ospfGeneralStats, ripConfig=ripConfig, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumRxHello=ospfCumRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ip_info=ip_info, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfHello=ospfIntfHello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipForward=ipForward, ripStatOutPkts=ripStatOutPkts, routeStats=routeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpStats=arpStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfNbrInExchState=ospfNbrInExchState, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumTxHello=ospfCumTxHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwArp=ipNewCfgGwArp, arpInfoTable=arpInfoTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfUnloop=ospfIntfUnloop, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoEntry=arpInfoEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIfInfoIndex=ospfIfInfoIndex, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrStart=ospfAreaNbrStart, ripStats=ripStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrp_info=vrrp_info, ospfArea=ospfArea, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxPkts=ospfIntfTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripStatInPkts=ripStatInPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs)
