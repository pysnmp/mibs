...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoTag=ipRouteInfoTag, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpStatEntries=arpStatEntries, ipFwdNewCfgState=ipFwdNewCfgState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, routeStatHighWater=routeStatHighWater, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumRxHello=ospfCumRxHello, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCfg=ospfCfg, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoTable=ipRouteInfoTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwTable=ipCurCfgGwTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNbrInExchState=ospfNbrInExchState, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpOper=vrrpOper, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoFlag=arpInfoFlag, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSAId=routerLSAId, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoEntry=arpInfoEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfHostTableMaxSize=ospfHostTableMaxSize, routeStatEntries=routeStatEntries, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgSupply=ripNewCfgSupply, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwTable=ipNewCfgGwTable, ospfinfo=ospfinfo, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxHello=ospfCumTxHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpStats=arpStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrDown=ospfIntfNbrDown, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfGeneral=ospfGeneral, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTxHello=ospfIntfTxHello, arpInfoMacAddr=arpInfoMacAddr, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpInfoTable=arpInfoTable, ospfIntfNbrhello=ospfIntfNbrhello, ospfStats=ospfStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipInterfaceTableMax=ipInterfaceTableMax, ipForward=ipForward, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaInfoTable=ospfAreaInfoTable, routerLSALinkData=routerLSALinkData, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfHello=ospfIntfHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSAAreaIndex=routerLSAAreaIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrhello=ospfCumNbrhello, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSALinkIfIndex=routerLSALinkIfIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfIndex=ospfIntfIndex, ipRouteInfoMask=ipRouteInfoMask, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaChangeStats=ospfAreaChangeStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgBootpState=ipCurCfgBootpState, ripNewCfgListen=ripNewCfgListen, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrp_info=vrrp_info, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipRouteInfoGateway=ipRouteInfoGateway, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfInfoTable=ospfIntfInfoTable, vrrpStats=vrrpStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoInterface=ipRouteInfoInterface, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkID=routerLSALinkID, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfInterface=ospfInterface, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrRstAd=ospfCumNbrRstAd, arpInfoRefPorts=arpInfoRefPorts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrIndex=ospfAreaNbrIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfArea=ospfArea, ospfCumTxDatabase=ospfCumTxDatabase, ripConfig=ripConfig, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, routeStats=routeStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaIntfDown=ospfAreaIntfDown, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routerLSALinkIndex=routerLSALinkIndex, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTotalAreas=ospfTotalAreas, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ip_info=ip_info, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwArp=ipNewCfgGwArp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfDown=ospfIntfDown, ospfIntfLoop=ospfIntfLoop, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpInfoDestIp=arpInfoDestIp, ospfAreaInfoEntry=ospfAreaInfoEntry, ripStats=ripStats, ospfCumNbrN1way=ospfCumNbrN1way, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfStartTime=ospfStartTime, vrrpStatInAdvers=vrrpStatInAdvers, vrrp=vrrp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfDown=ospfCumIntfDown, ospfCumTxPkts=ospfCumTxPkts, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, iprouting=iprouting, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTxPkts=ospfIntfTxPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfBackup=ospfIntfBackup, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfProcessUptime=ospfProcessUptime, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgState=ripNewCfgState)
