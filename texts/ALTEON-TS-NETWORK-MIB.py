...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpStats=arpStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCfg=ospfCfg, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfGeneral=ospfGeneral, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrhello=ospfAreaNbrhello, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxHello=ospfCumRxHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIfInfoIndex=ospfIfInfoIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrDown=ospfAreaNbrDown, ipForward=ipForward, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipRouteInfoMask=ipRouteInfoMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSALinkID=routerLSALinkID, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfArea=ospfArea, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfStartTime=ospfStartTime, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, arpInfoTable=arpInfoTable, ospfAreaRxHello=ospfAreaRxHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripNewCfgVip=ripNewCfgVip, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfGeneralInfo=ospfGeneralInfo, ospfAreaIntfDown=ospfAreaIntfDown, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumTxPkts=ospfCumTxPkts, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrp=vrrp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpStats=vrrpStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumTxHello=ospfCumTxHello, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpStatEntries=arpStatEntries, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routerLSAAreaIndex=routerLSAAreaIndex, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripCurCfgState=ripCurCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumIntfBackup=ospfCumIntfBackup, ospfStats=ospfStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfBackup=ospfIntfBackup, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routeStatHighWater=routeStatHighWater, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpOper=vrrpOper, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwState=ipCurCfgGwState, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSAId=routerLSAId, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgIntfAddr=ipCurCfgIntfAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpStatMaxEntries=arpStatMaxEntries, dnsStats=dnsStats, ripConfig=ripConfig, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrStart=ospfCumNbrStart, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpStatHighWater=arpStatHighWater, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrhello=ospfCumNbrhello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routeStats=routeStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoMacAddr=arpInfoMacAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipRouteInfoTable=ipRouteInfoTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgGwEntry=ipCurCfgGwEntry, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoFlag=arpInfoFlag, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, routeStatMaxEntries=routeStatMaxEntries, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgState=ripNewCfgState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipRouteInfoType=ipRouteInfoType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumRxPkts=ospfCumRxPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripStatRoutesAgedOut=ripStatRoutesAgedOut, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrStart=ospfIntfNbrStart, ospfProcessUptime=ospfProcessUptime, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSALinkData=routerLSALinkData, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrp_info=vrrp_info, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoDestIp=arpInfoDestIp, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripNewCfgListen=ripNewCfgListen, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoTag=ipRouteInfoTag, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripStats=ripStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgGenState=vrrpCurCfgGenState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routeStatEntries=routeStatEntries, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgIntfMask=ipNewCfgIntfMask, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState)
