...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrN1way=ospfIntfNbrN1way, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgGwArp=ipCurCfgGwArp, vrrpGeneral=vrrpGeneral, ospfAreaNbrIndex=ospfAreaNbrIndex, ripCurCfgState=ripCurCfgState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, iprouting=iprouting, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routerLSAId=routerLSAId, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipRouteInfoType=ipRouteInfoType, vrrp=vrrp, ospfCfg=ospfCfg, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfHello=ospfIntfHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpOper=vrrpOper, ospfCumNbrStart=ospfCumNbrStart, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ip_info=ip_info, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrhello=ospfCumNbrhello, ripCurCfgListen=ripCurCfgListen, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumRxHello=ospfCumRxHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfInterface=ospfInterface, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfLoop=ospfAreaIntfLoop, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfTxHello=ospfIntfTxHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpStatHighWater=arpStatHighWater, dnsStats=dnsStats, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipRouteInfoIndx=ipRouteInfoIndx, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoTag=ipRouteInfoTag, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrStart=ospfIntfNbrStart, ospfGeneralStats=ospfGeneralStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpStats=vrrpStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfinfo=ospfinfo, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripCurCfgVip=ripCurCfgVip, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipForward=ipForward, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripStats=ripStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routerLSALinkID=routerLSALinkID, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxHello=ospfAreaRxHello, ripNewCfgState=ripNewCfgState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfIndex=ospfIntfIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumTxHello=ospfCumTxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenState=vrrpCurCfgGenState, ripStatInPkts=ripStatInPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrDown=ospfCumNbrDown, arpStats=arpStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumIntfDown=ospfCumIntfDown, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxDatabase=ospfAreaTxDatabase, routeStats=routeStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaTxPkts=ospfAreaTxPkts, ripConfig=ripConfig, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumTxPkts=ospfCumTxPkts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoDestIp=arpInfoDestIp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripStatOutPkts=ripStatOutPkts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumRxTxStats=ospfCumRxTxStats, routeStatMaxEntries=routeStatMaxEntries, ospfProcessUptime=ospfProcessUptime, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpStatEntries=arpStatEntries, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfChangeStats=ospfIntfChangeStats, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfGeneral=ospfGeneral, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrp_info=vrrp_info, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxTxStats=ospfAreaRxTxStats, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoEntry=ipRouteInfoEntry, arpInfoTable=arpInfoTable, ripNewCfgSupply=ripNewCfgSupply, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNbrInInitState=ospfNbrInInitState, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfStats=ospfStats, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfGeneralInfo=ospfGeneralInfo, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripStatInErrorPkts=ripStatInErrorPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfArea=ospfArea, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfState=ipCurCfgIntfState)
