...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipGatewayTableMax=ipGatewayTableMax, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSAId=routerLSAId, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpGeneral=vrrpGeneral, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxPkts=ospfCumTxPkts, ospfStats=ospfStats, arpStats=arpStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCfg=ospfCfg, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, iprouting=iprouting, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ip_info=ip_info, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpInfoTable=arpInfoTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNbrInFullState=ospfNbrInFullState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwEntry=ipCurCfgGwEntry, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipRouteInfoType=ipRouteInfoType, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgSupply=ripCurCfgSupply, vrrp=vrrp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfProcessUptime=ospfProcessUptime, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfRxPkts=ospfIntfRxPkts, ripCurCfgVip=ripCurCfgVip, ospfIntfTxPkts=ospfIntfTxPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, dnsStats=dnsStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumRxPkts=ospfCumRxPkts, ospfIntfLoop=ospfIntfLoop, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNbrInInitState=ospfNbrInInitState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoTable=ipRouteInfoTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumIntfHello=ospfCumIntfHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgState=ripNewCfgState, ripConfig=ripConfig, routeStatEntries=routeStatEntries, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfInfoIndex=ospfIfInfoIndex, ripStatOutPkts=ripStatOutPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrp_info=vrrp_info, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfHello=ospfIntfHello, vrrpOper=vrrpOper, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTotalNssaAreas=ospfTotalNssaAreas, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routerLSALinkID=routerLSALinkID, ospfInterface=ospfInterface, routerLSALinkData=routerLSALinkData, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoDestIp=arpInfoDestIp, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpInfoVLAN=arpInfoVLAN, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoMask=ipRouteInfoMask, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgIntfTable=ipCurCfgIntfTable, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTotalAreas=ospfTotalAreas, arpInfoEntry=arpInfoEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrDown=ospfAreaNbrDown, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoRefPorts=arpInfoRefPorts, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgIntfState=ipNewCfgIntfState, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrChange=ospfIntfNbrChange, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfGeneralStats=ospfGeneralStats, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgGwInterval=ipCurCfgGwInterval, arpStatEntries=arpStatEntries, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfArea=ospfArea, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrStart=ospfCumNbrStart, ospfStartTime=ospfStartTime, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTxHello=ospfAreaTxHello, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfGeneral=ospfGeneral, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumRxHello=ospfCumRxHello, ospfCumRxlsReqs=ospfCumRxlsReqs, ripStats=ripStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipForward=ipForward, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaInfoId=ospfAreaInfoId, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpStats=vrrpStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgListen=ripCurCfgListen, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrhello=ospfIntfNbrhello, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfUnloop=ospfIntfUnloop, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrStart=ospfAreaNbrStart, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripStatInPkts=ripStatInPkts, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfGeneralInfo=ospfGeneralInfo, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoFlag=arpInfoFlag, ospfinfo=ospfinfo)
