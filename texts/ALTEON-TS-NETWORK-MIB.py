...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpStatMaxEntries=arpStatMaxEntries, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfBackup=ospfAreaIntfBackup, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgState=ipFwdNewCfgState, vrrp=vrrp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoTable=ipRouteInfoTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoFlag=arpInfoFlag, ospfCumNbrStart=ospfCumNbrStart, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumTxPkts=ospfCumTxPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routeStats=routeStats, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfInterface=ospfInterface, arpInfoVLAN=arpInfoVLAN, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpInfoSrcPort=arpInfoSrcPort, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwIndex=ipNewCfgGwIndex, arpStats=arpStats, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrDown=ospfAreaNbrDown, routerLSAId=routerLSAId, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpInfoRefPorts=arpInfoRefPorts, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumRxDatabase=ospfCumRxDatabase, ripCurCfgVip=ripCurCfgVip, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripCurCfgDefListen=ripCurCfgDefListen, ospfGeneral=ospfGeneral, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpStatInAdvers=vrrpStatInAdvers, arpStatEntries=arpStatEntries, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfProcessUptime=ospfProcessUptime, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfState=ipCurCfgIntfState, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgSupply=ripNewCfgSupply, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, dnsStats=dnsStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrp_info=vrrp_info, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routeStatHighWater=routeStatHighWater, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripStatInPkts=ripStatInPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgGwInterval=ipNewCfgGwInterval, arpInfoEntry=arpInfoEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTotalNeighbours=ospfTotalNeighbours, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpGeneral=vrrpGeneral, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxPkts=ospfCumRxPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripStats=ripStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfHello=ospfCumIntfHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgDefListen=ripNewCfgDefListen, routeStatEntries=routeStatEntries, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripNewCfgVip=ripNewCfgVip, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgBootpState=ipNewCfgBootpState, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ip_info=ip_info, ospfAreaInfoId=ospfAreaInfoId, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfStartTime=ospfStartTime, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgState=ripNewCfgState, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfInfoTable=ospfIntfInfoTable, iprouting=iprouting, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaTxHello=ospfAreaTxHello, ospfGeneralStats=ospfGeneralStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfState=ipNewCfgIntfState, routerLSALinkID=routerLSALinkID, ipRouteInfoInterface=ipRouteInfoInterface, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfLsTypesSupported=ospfLsTypesSupported, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgSupply=ripCurCfgSupply, vrrpOper=vrrpOper, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwState=ipNewCfgGwState, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrhello=ospfCumNbrhello, ospfNbrInExchState=ospfNbrInExchState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfArea=ospfArea, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripConfig=ripConfig, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, arpStatHighWater=arpStatHighWater, ospfCfg=ospfCfg, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfDown=ospfIntfDown, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumRxHello=ospfCumRxHello, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwDelete=ipNewCfgGwDelete, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfStats=ospfStats, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoType=ipRouteInfoType, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfHello=ospfIntfHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNbrInFullState=ospfNbrInFullState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwArp=ipNewCfgGwArp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoTag=ipRouteInfoTag, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrStart=ospfIntfNbrStart)
