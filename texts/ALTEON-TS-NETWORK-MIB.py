...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoEntry=ipRouteInfoEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgListen=ripNewCfgListen, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpInfoVLAN=arpInfoVLAN, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrChange=ospfIntfNbrChange, ospfArea=ospfArea, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfTxPkts=ospfIntfTxPkts, ripConfig=ripConfig, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfIndex=ospfIntfIndex, vrrp=vrrp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpInfoFlag=arpInfoFlag, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumTxDatabase=ospfCumTxDatabase, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfGeneralInfo=ospfGeneralInfo, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSAId=routerLSAId, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCfg=ospfCfg, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoTable=ipRouteInfoTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSALinkData=routerLSALinkData, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfTxHello=ospfIntfTxHello, ipForward=ipForward, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpGeneral=vrrpGeneral, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoIndx=ipRouteInfoIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwArp=ipCurCfgGwArp, arpInfoTable=arpInfoTable, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, iprouting=iprouting, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpStatEntries=arpStatEntries, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfProcessUptime=ospfProcessUptime, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgState=ripNewCfgState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgState=ripCurCfgState, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrp_info=vrrp_info, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpStats=arpStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumIntfHello=ospfCumIntfHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrN1way=ospfCumNbrN1way, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumNbrStart=ospfCumNbrStart, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfStartTime=ospfStartTime, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwMetric=ipCurCfgGwMetric, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrDown=ospfIntfNbrDown, vrrpIfTableMaxSize=vrrpIfTableMaxSize, dnsStats=dnsStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfAddr=ipNewCfgIntfAddr, arpInfoDestIp=arpInfoDestIp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfLoop=ospfIntfLoop, ripStatInPkts=ripStatInPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routeStats=routeStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfStats=ospfStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfHello=ospfIntfHello, ospfCumRxHello=ospfCumRxHello, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgGwVlan=ipNewCfgGwVlan, ripCurCfgVip=ripCurCfgVip, ospfLsTypesSupported=ospfLsTypesSupported, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwArp=ipNewCfgGwArp, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumIntfUnloop=ospfCumIntfUnloop, ipGatewayTableMax=ipGatewayTableMax, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripNewCfgVip=ripNewCfgVip, ospfIntfChangeStats=ospfIntfChangeStats, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwTable=ipNewCfgGwTable, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ip_info=ip_info, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routeStatHighWater=routeStatHighWater, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSALinkIndex=routerLSALinkIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpStatHighWater=arpStatHighWater, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfInfoTable=ospfIntfInfoTable, ospfinfo=ospfinfo, ospfGeneral=ospfGeneral, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgSupply=ripNewCfgSupply, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripStats=ripStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumTxHello=ospfCumTxHello, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrDown=ospfCumNbrDown, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routerLSALinkID=routerLSALinkID, ospfCumRxPkts=ospfCumRxPkts, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfDown=ospfIntfDown, routeStatEntries=routeStatEntries, ospfIntfBackup=ospfIntfBackup, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipInterfaceTableMax=ipInterfaceTableMax)
