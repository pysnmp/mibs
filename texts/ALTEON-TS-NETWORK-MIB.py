...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routeStatEntries=routeStatEntries, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrp_info=vrrp_info, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumTxPkts=ospfCumTxPkts, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpInfoFlag=arpInfoFlag, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwDelete=ipNewCfgGwDelete, iprouting=iprouting, ospfIntfInfoTable=ospfIntfInfoTable, routerLSALinkData=routerLSALinkData, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpStatEntries=arpStatEntries, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpStatInAdvers=vrrpStatInAdvers, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripStats=ripStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpStats=vrrpStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrhello=ospfCumNbrhello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfStats=ospfStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, arpStatHighWater=arpStatHighWater, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoTag=ipRouteInfoTag, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfUnloop=ospfIntfUnloop, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumTxlsAcks=ospfCumTxlsAcks, arpInfoRefPorts=arpInfoRefPorts, routeStats=routeStats, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStatOutPkts=ripStatOutPkts, ripStatInPkts=ripStatInPkts, vrrp=vrrp, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpOper=vrrpOper, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrhello=ospfAreaNbrhello, routerLSAAreaIndex=routerLSAAreaIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrStart=ospfAreaNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfGeneral=ospfGeneral, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripConfig=ripConfig, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfArea=ospfArea, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrChangeStats=ospfCumNbrChangeStats, routerLSAId=routerLSAId, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxDatabase=ospfCumTxDatabase, ospfNbrInExchState=ospfNbrInExchState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumTxHello=ospfCumTxHello, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfCountForRouter=ospfIntfCountForRouter, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxPkts=ospfAreaRxPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaIntfBackup=ospfAreaIntfBackup, arpInfoTable=arpInfoTable, ospfIntfIndex=ospfIntfIndex, ripCurCfgListen=ripCurCfgListen, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfState=ipNewCfgIntfState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgListen=ripNewCfgListen, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoMask=ipRouteInfoMask, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgState=ripNewCfgState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, dnsStats=dnsStats, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfBackup=ospfIntfBackup, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfHello=ospfIntfHello, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrDown=ospfIntfNbrDown, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgState=ipFwdNewCfgState, ospfGeneralInfo=ospfGeneralInfo, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpInfoVLAN=arpInfoVLAN, ospfStartTime=ospfStartTime, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipForward=ipForward, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumIntfHello=ospfCumIntfHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfinfo=ospfinfo, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripCurCfgVip=ripCurCfgVip, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNbrInFullState=ospfNbrInFullState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfInfoIndex=ospfIfInfoIndex, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfGeneralStats=ospfGeneralStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfDown=ospfIntfDown, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipInterfaceTableMax=ipInterfaceTableMax, ip_info=ip_info, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routeStatMaxEntries=routeStatMaxEntries, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaInfoId=ospfAreaInfoId, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpStats=arpStats, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgState=ipFwdCurCfgState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaChangeStats=ospfAreaChangeStats, ospfNbrInInitState=ospfNbrInInitState, vrrpGeneral=vrrpGeneral, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgVip=ripNewCfgVip, routerLSALinkID=routerLSALinkID, ipRouteInfoEntry=ipRouteInfoEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripStatInErrorPkts=ripStatInErrorPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipRouteInfoType=ipRouteInfoType, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone)
