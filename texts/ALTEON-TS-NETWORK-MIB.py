...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoTag=ipRouteInfoTag, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumRxPkts=ospfCumRxPkts, ospfStartTime=ospfStartTime, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkIndex=routerLSALinkIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgIntfState=ipCurCfgIntfState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumTxPkts=ospfCumTxPkts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipInterfaceTableMax=ipInterfaceTableMax, ripCurCfgListen=ripCurCfgListen, ipRouteInfoType=ipRouteInfoType, ipForward=ipForward, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripStatInPkts=ripStatInPkts, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNewCfgAreaId=ospfNewCfgAreaId, ipGatewayTableMax=ipGatewayTableMax, ospfCumRxDatabase=ospfCumRxDatabase, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgSupply=ripCurCfgSupply, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrN1way=ospfIntfNbrN1way, ripNewCfgVip=ripNewCfgVip, ospfCumTxHello=ospfCumTxHello, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfBackup=ospfIntfBackup, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripCurCfgState=ripCurCfgState, ipNewCfgGwState=ipNewCfgGwState, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrp_info=vrrp_info, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgListen=ripNewCfgListen, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, dnsStats=dnsStats, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTotalAreas=ospfTotalAreas, arpInfoEntry=arpInfoEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoDestIp=arpInfoDestIp, routeStatMaxEntries=routeStatMaxEntries, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgState=ipFwdNewCfgState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripCurCfgVip=ripCurCfgVip, ospfIntfHello=ospfIntfHello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfArea=ospfArea, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgState=ripNewCfgState, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, ripStatOutPkts=ripStatOutPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routerLSALinkID=routerLSALinkID, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoTable=arpInfoTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routeStats=routeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfInterface=ospfInterface, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaChangeStats=ospfAreaChangeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpOper=vrrpOper, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrp=vrrp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfLoop=ospfIntfLoop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenState=vrrpCurCfgGenState, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrIndex=ospfIntfNbrIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfDown=ospfAreaIntfDown, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpStatEntries=arpStatEntries, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfinfo=ospfinfo, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgGwMetric=ipCurCfgGwMetric, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripStats=ripStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpStats=vrrpStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoInterface=ipRouteInfoInterface, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpGeneral=vrrpGeneral, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrDown=ospfAreaNbrDown, ospfNbrInInitState=ospfNbrInInitState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxHello=ospfAreaRxHello, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfGeneralInfo=ospfGeneralInfo, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpStats=arpStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCfg=ospfCfg, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfGeneral=ospfGeneral, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumRxHello=ospfCumRxHello, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripConfig=ripConfig, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfIndex=ospfIntfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, iprouting=iprouting, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routeStatEntries=routeStatEntries, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ip_info=ip_info, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoTable=ipRouteInfoTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNbrInExchState=ospfNbrInExchState, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSAId=routerLSAId, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf)
