...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrStart=ospfCumNbrStart, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgGwTable=ipCurCfgGwTable, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxPkts=ospfAreaRxPkts, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgBootpAddr=ipNewCfgBootpAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoIndx=ipRouteInfoIndx, routeStatHighWater=routeStatHighWater, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdCurCfgState=ipFwdCurCfgState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routerLSALinkData=routerLSALinkData, ospfInterface=ospfInterface, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfinfo=ospfinfo, ospfIfWaitInterval=ospfIfWaitInterval, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrhello=ospfAreaNbrhello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpStatMaxEntries=arpStatMaxEntries, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfArea=ospfArea, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaTxHello=ospfAreaTxHello, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgIntfTable=ipNewCfgIntfTable, arpStats=arpStats, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoVLAN=arpInfoVLAN, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfStartTime=ospfStartTime, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwState=ipNewCfgGwState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgState=ripNewCfgState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgBootpState=ipCurCfgBootpState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoInterface=ipRouteInfoInterface, ipInterfaceTableMax=ipInterfaceTableMax, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipForward=ipForward, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, arpInfoTable=arpInfoTable, ospfIntfDown=ospfIntfDown, arpInfoDestIp=arpInfoDestIp, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwIndex=ipNewCfgGwIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpInfoRefPorts=arpInfoRefPorts, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwInterval=ipCurCfgGwInterval, ipGatewayTableMax=ipGatewayTableMax, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaInfoId=ospfAreaInfoId, ospfCfg=ospfCfg, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routerLSALinkIndex=routerLSALinkIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrhello=ospfCumNbrhello, ip_info=ip_info, ospfIntfChangeStats=ospfIntfChangeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfStats=ospfStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripConfig=ripConfig, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwState=ipCurCfgGwState, routerLSAId=routerLSAId, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripStatInPkts=ripStatInPkts, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgState=ripCurCfgState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfHello=ospfIntfHello, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrp_info=vrrp_info, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, routerLSALinkID=routerLSALinkID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgGwMetric=ipCurCfgGwMetric, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipRouteInfoMask=ipRouteInfoMask, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfGeneralStats=ospfGeneralStats, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routeStats=routeStats, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgBootpState=ipNewCfgBootpState, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, dnsStats=dnsStats, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfHello=ospfCumIntfHello, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpStats=vrrpStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoTable=ipRouteInfoTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripNewCfgVip=ripNewCfgVip, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, iprouting=iprouting, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxHello=ospfCumRxHello, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfGeneral=ospfGeneral, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripStats=ripStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfLoop=ospfIntfLoop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrp=vrrp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfProcessUptime=ospfProcessUptime, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwAddr=ipNewCfgGwAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, vrrpOper=vrrpOper, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaIntfDown=ospfAreaIntfDown, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoFlag=arpInfoFlag, ospfAreaNbrDown=ospfAreaNbrDown, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk)
