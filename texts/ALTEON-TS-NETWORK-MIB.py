...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoDestIp=arpInfoDestIp, ospfIntfBackup=ospfIntfBackup, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, routeStatMaxEntries=routeStatMaxEntries, ospfGeneral=ospfGeneral, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfIndex=ospfIntfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripNewCfgDefListen=ripNewCfgDefListen, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripCurCfgVip=ripCurCfgVip, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNbrInInitState=ospfNbrInInitState, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfInterface=ospfInterface, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrhello=ospfIntfNbrhello, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfRxDatabase=ospfIntfRxDatabase, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoGateway=ipRouteInfoGateway, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfArea=ospfArea, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoInterface=ipRouteInfoInterface, ospfProcessUptime=ospfProcessUptime, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripStatInPkts=ripStatInPkts, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpOper=vrrpOper, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrp_info=vrrp_info, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpStats=arpStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoVLAN=arpInfoVLAN, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNbrInFullState=ospfNbrInFullState, ripNewCfgState=ripNewCfgState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatHighWater=arpStatHighWater, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfinfo=ospfinfo, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumIntfDown=ospfCumIntfDown, routeStats=routeStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpStats=vrrpStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaChangeStats=ospfAreaChangeStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfStartTime=ospfStartTime, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, dnsStats=dnsStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfDown=ospfIntfDown, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumTxHello=ospfCumTxHello)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipRouteInfoMask=ipRouteInfoMask, ospfCfg=ospfCfg, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripCurCfgListen=ripCurCfgListen, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripStats=ripStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgBootpState=ipCurCfgBootpState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfHello=ospfIntfHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffHello=ospfTmrsKckOffHello, iprouting=iprouting, vrrp=vrrp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpStatMaxEntries=arpStatMaxEntries, ip_info=ip_info, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfInfoTable=ospfIntfInfoTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipForward=ipForward, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfWaitInterval=ospfIfWaitInterval, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routerLSALinkData=routerLSALinkData, ospfIntfLoop=ospfIntfLoop, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpInfoSrcPort=arpInfoSrcPort, ospfIntfChangeStats=ospfIntfChangeStats, arpInfoFlag=arpInfoFlag, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenState=vrrpCurCfgGenState, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpGeneral=vrrpGeneral, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgVip=ripNewCfgVip, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgGwRetry=ipCurCfgGwRetry, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfStats=ospfStats, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripConfig=ripConfig, arpInfoEntry=arpInfoEntry, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTotalAreas=ospfTotalAreas, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgIntfMask=ipCurCfgIntfMask, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkID=routerLSALinkID, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval)
