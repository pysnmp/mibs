...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfProcessUptime=ospfProcessUptime, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoTable=arpInfoTable, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripCurCfgVip=ripCurCfgVip, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgState=ripNewCfgState, ipCurCfgIntfState=ipCurCfgIntfState, ospfInterface=ospfInterface, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrN1way=ospfCumNbrN1way, arpStats=arpStats, ripConfig=ripConfig, vrrp=vrrp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNbrInExchState=ospfNbrInExchState, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgState=ripCurCfgState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrDown=ospfCumNbrDown, ospfStats=ospfStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTimersKickOffStats=ospfTimersKickOffStats, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSALinkID=routerLSALinkID, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfLoop=ospfIntfLoop, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfStartTime=ospfStartTime, ospfAreaRxPkts=ospfAreaRxPkts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routeStatHighWater=routeStatHighWater, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNbrInFullState=ospfNbrInFullState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipInterfaceTableMax=ipInterfaceTableMax, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfinfo=ospfinfo, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTotalAreas=ospfTotalAreas, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfInfoTable=ospfIntfInfoTable, arpInfoEntry=arpInfoEntry, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwState=ipCurCfgGwState, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpStats=vrrpStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgListen=ripNewCfgListen, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfGeneralStats=ospfGeneralStats, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpOper=vrrpOper, ripStatInPkts=ripStatInPkts, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumIntfDown=ospfCumIntfDown, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwMetric=ipNewCfgGwMetric, iprouting=iprouting, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipRouteInfoEntry=ipRouteInfoEntry, ripStats=ripStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgVip=ripNewCfgVip, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCfg=ospfCfg, ipRouteInfoMask=ipRouteInfoMask, dnsStats=dnsStats, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrp_info=vrrp_info, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ip_info=ip_info, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, arpStatMaxEntries=arpStatMaxEntries, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaTxHello=ospfAreaTxHello, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfDown=ospfIntfDown, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, routerLSALinkData=routerLSALinkData, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpStatEntries=arpStatEntries, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfArea=ospfArea, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaTxPkts=ospfAreaTxPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoVLAN=arpInfoVLAN, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrhello=ospfCumNbrhello, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumRxHello=ospfCumRxHello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwArp=ipCurCfgGwArp, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routeStats=routeStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, routeStatMaxEntries=routeStatMaxEntries, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfHello=ospfIntfHello, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipRouteInfoType=ipRouteInfoType, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwTable=ipCurCfgGwTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routeStatEntries=routeStatEntries, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipForward=ipForward, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpGeneral=vrrpGeneral, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumRxPkts=ospfCumRxPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID)
