...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, iprouting=iprouting, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoSrcPort=arpInfoSrcPort, ospfIntfHello=ospfIntfHello, ospfAreaInfoId=ospfAreaInfoId, ospfIntfWaitTimer=ospfIntfWaitTimer, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripStatInPkts=ripStatInPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgState=ripNewCfgState, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaRxPkts=ospfAreaRxPkts, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ip_info=ip_info, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpGeneral=vrrpGeneral, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfInterface=ospfInterface, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpInfoDestIp=arpInfoDestIp, vrrp_info=vrrp_info, ripNewCfgDefListen=ripNewCfgDefListen, ospfGeneral=ospfGeneral, arpInfoEntry=arpInfoEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripConfig=ripConfig, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSAAreaIndex=routerLSAAreaIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgState=ripCurCfgState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfStats=ospfStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfStartTime=ospfStartTime, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaTxHello=ospfAreaTxHello, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgPortState=ipFwdCurCfgPortState, routeStatHighWater=routeStatHighWater, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfInfoIndex=ospfIfInfoIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipInterfaceTableMax=ipInterfaceTableMax, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routerLSALinkData=routerLSALinkData, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumTxDatabase=ospfCumTxDatabase, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumRxDatabase=ospfCumRxDatabase, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpStatEntries=arpStatEntries, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStats=routeStats, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routeStatEntries=routeStatEntries, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfBackup=ospfCumIntfBackup, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwTable=ipNewCfgGwTable, vrrp=vrrp, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfInfoEntry=ospfIntfInfoEntry, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, dnsStats=dnsStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoMask=ipRouteInfoMask, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOper=vrrpOper, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfTxPkts=ospfIntfTxPkts, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfIndex=ospfIntfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpInfoTable=arpInfoTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ipForward=ipForward, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaIntfHello=ospfAreaIntfHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfLoop=ospfIntfLoop, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripCurCfgVip=ripCurCfgVip, routerLSAId=routerLSAId, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpStats=arpStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxHello=ospfAreaRxHello, arpInfoRefPorts=arpInfoRefPorts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoTag=ipRouteInfoTag, ripStats=ripStats, arpStatHighWater=arpStatHighWater, routerLSALinkID=routerLSALinkID, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCfg=ospfCfg, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrStart=ospfCumNbrStart, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgBootpState=ipCurCfgBootpState, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfArea=ospfArea, ipCurCfgGwEntry=ipCurCfgGwEntry, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, arpInfoVLAN=arpInfoVLAN, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfState=ipCurCfgIntfState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry)
