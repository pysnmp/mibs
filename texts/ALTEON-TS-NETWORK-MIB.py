...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgListen=ripCurCfgListen, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrhello=ospfCumNbrhello, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpStats=arpStats, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrStart=ospfCumNbrStart, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfStartTime=ospfStartTime, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfDown=ospfAreaIntfDown, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripNewCfgDefListen=ripNewCfgDefListen, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfGeneral=ospfGeneral, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxHello=ospfIntfRxHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwArp=ipCurCfgGwArp, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrDown=ospfIntfNbrDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwArp=ipNewCfgGwArp, vrrp=vrrp, ospfCumTxHello=ospfCumTxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ip_info=ip_info, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpStatHighWater=arpStatHighWater, routeStatMaxEntries=routeStatMaxEntries, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routerLSALinkID=routerLSALinkID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgGwEntry=ipCurCfgGwEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumRxHello=ospfCumRxHello, ipRouteInfoInterface=ipRouteInfoInterface, routeStatEntries=routeStatEntries, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpOper=vrrpOper, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfArea=ospfArea, ipNewCfgBootpState=ipNewCfgBootpState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfHello=ospfIntfHello, arpInfoRefPorts=arpInfoRefPorts, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrStart=ospfAreaNbrStart, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfHello=ospfAreaIntfHello, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgState=ripNewCfgState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfLoop=ospfAreaIntfLoop, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumRxPkts=ospfCumRxPkts, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgVip=ripCurCfgVip, ospfCumRxTxStats=ospfCumRxTxStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfInterface=ospfInterface, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumTxPkts=ospfCumTxPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgIfTable=vrrpCurCfgIfTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNbrInFullState=ospfNbrInFullState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipRouteInfoMask=ipRouteInfoMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCfg=ospfCfg, ospfCumRxlsReqs=ospfCumRxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfLoop=ospfIntfLoop, ospfIntfBackup=ospfIntfBackup, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoMacAddr=arpInfoMacAddr, arpInfoVLAN=arpInfoVLAN, ospfCumRxDatabase=ospfCumRxDatabase, ripStats=ripStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaInfoTable=ospfAreaInfoTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgState=ipFwdCurCfgState, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ospfStats=ospfStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoEntry=ipRouteInfoEntry, arpInfoFlag=arpInfoFlag, ipForward=ipForward, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripConfig=ripConfig, arpInfoSrcPort=arpInfoSrcPort, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStatInPkts=ripStatInPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxDatabase=ospfAreaRxDatabase, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routeStats=routeStats, ripStatOutPkts=ripStatOutPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrp_info=vrrp_info, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, iprouting=iprouting, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routerLSAId=routerLSAId, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkData=routerLSALinkData, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipRouteInfoTag=ipRouteInfoTag, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfRangeTableMaxSize=ospfRangeTableMaxSize, dnsStats=dnsStats, ospfTotalAreas=ospfTotalAreas, arpInfoTable=arpInfoTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routeStatHighWater=routeStatHighWater, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumRxlsUpdates=ospfCumRxlsUpdates)
