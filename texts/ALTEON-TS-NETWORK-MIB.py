...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwState=ipCurCfgGwState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, routeStatHighWater=routeStatHighWater, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrhello=ospfCumNbrhello, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, arpStats=arpStats, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgDefListen=ripCurCfgDefListen, routeStatMaxEntries=routeStatMaxEntries, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwAddr=ipCurCfgGwAddr, arpInfoFlag=arpInfoFlag, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaIntfDown=ospfAreaIntfDown, vrrpGeneral=vrrpGeneral, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfUnloop=ospfIntfUnloop, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfHello=ospfIntfHello, ospfCumTxlsReqs=ospfCumTxlsReqs, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumIntfHello=ospfCumIntfHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumRxTxStats=ospfCumRxTxStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwInterval=ipNewCfgGwInterval, ripCurCfgVip=ripCurCfgVip, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoDestIp=arpInfoDestIp, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfStartTime=ospfStartTime, ripNewCfgState=ripNewCfgState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfGeneral=ospfGeneral, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfGeneralStats=ospfGeneralStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripConfig=ripConfig, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpStats=vrrpStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfState=ipNewCfgIntfState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ip_info=ip_info, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumTxHello=ospfCumTxHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxPkts=ospfAreaRxPkts, ripCurCfgState=ripCurCfgState, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumRxPkts=ospfCumRxPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripStats=ripStats, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrp=vrrp, ipRouteInfoTag=ipRouteInfoTag, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTotalAreas=ospfTotalAreas, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgSupply=ripCurCfgSupply, arpInfoMacAddr=arpInfoMacAddr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgBootpState=ipCurCfgBootpState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoGateway=ipRouteInfoGateway, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfRxTxIndex=ospfIntfRxTxIndex, dnsStats=dnsStats, routeStatEntries=routeStatEntries, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpStatEntries=arpStatEntries, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfinfo=ospfinfo, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaTableMaxSize=ospfAreaTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfChangeStats=ospfIntfChangeStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStatInPkts=ripStatInPkts, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, iprouting=iprouting, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfGeneralInfo=ospfGeneralInfo, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxDatabase=ospfCumRxDatabase, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxHello=ospfCumRxHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfRxHello=ospfIntfRxHello, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgBootpState=ipNewCfgBootpState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgState=ipFwdNewCfgState, ipRouteInfoType=ipRouteInfoType, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrDown=ospfCumNbrDown, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfStats=ospfStats, ripNewCfgVip=ripNewCfgVip, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfDown=ospfIntfDown, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwDelete=ipNewCfgGwDelete, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpOper=vrrpOper, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCfg=ospfCfg, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrp_info=vrrp_info, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfInterface=ospfInterface, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routeStats=routeStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpInfoTable=arpInfoTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSALinkID=routerLSALinkID, ipRouteInfoIndx=ipRouteInfoIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipForward=ipForward, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaIntfLoop=ospfAreaIntfLoop)
