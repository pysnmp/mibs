...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipRouteInfoMask=ipRouteInfoMask, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipForward=ipForward, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwAddr=ipNewCfgGwAddr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoFlag=arpInfoFlag, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxHello=ospfIntfRxHello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, dnsStats=dnsStats, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTotalNssaAreas=ospfTotalNssaAreas, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripStatOutPkts=ripStatOutPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNewCfgAreaTable=ospfNewCfgAreaTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrStart=ospfCumNbrStart, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfLoop=ospfIntfLoop, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routeStatEntries=routeStatEntries, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfArea=ospfArea, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwVlan=ipCurCfgGwVlan, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, routeStatHighWater=routeStatHighWater, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTotalAreas=ospfTotalAreas, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripCurCfgSupply=ripCurCfgSupply, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfStats=ospfStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaTxHello=ospfAreaTxHello, vrrp=vrrp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpInfoEntry=arpInfoEntry, ospfIntfTxHello=ospfIntfTxHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpGeneral=vrrpGeneral, vrrp_info=vrrp_info, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfLsTypesSupported=ospfLsTypesSupported, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgDefListen=ripNewCfgDefListen, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSAId=routerLSAId, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgState=ipFwdCurCfgState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrN1way=ospfCumNbrN1way, ospfStartTime=ospfStartTime, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfinfo=ospfinfo, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaRxHello=ospfAreaRxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaIntfDown=ospfAreaIntfDown, vrrpStatInAdvers=vrrpStatInAdvers, routerLSALinkIndex=routerLSALinkIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfGeneral=ospfGeneral, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxTxStats=ospfCumRxTxStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripStatInPkts=ripStatInPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routerLSALinkData=routerLSALinkData, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStats=vrrpStats, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpInfoSrcPort=arpInfoSrcPort, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripNewCfgSupply=ripNewCfgSupply, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxTxStats=ospfAreaRxTxStats, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrStart=ospfIntfNbrStart, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrIndex=ospfAreaNbrIndex, ripNewCfgListen=ripNewCfgListen, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ip_info=ip_info, ripStats=ripStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routeStats=routeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpStatHighWater=arpStatHighWater, ospfGeneralStats=ospfGeneralStats, ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgIntfTable=ipCurCfgIntfTable, ripConfig=ripConfig, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpStats=arpStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoTable=ipRouteInfoTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoType=ipRouteInfoType, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpOper=vrrpOper, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrhello=ospfCumNbrhello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumIntfDown=ospfCumIntfDown, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfGeneralInfo=ospfGeneralInfo, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNbrInExchState=ospfNbrInExchState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCfg=ospfCfg, ipCurCfgGwTable=ipCurCfgGwTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgGwIndex=ipCurCfgGwIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfDown=ospfIntfDown, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgGenState=vrrpCurCfgGenState)
