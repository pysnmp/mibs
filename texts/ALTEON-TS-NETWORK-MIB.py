...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routeStatHighWater=routeStatHighWater, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfInfoEntry=ospfIntfInfoEntry, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwEntry=ipNewCfgGwEntry, ripStats=ripStats, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfinfo=ospfinfo, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoTable=ipRouteInfoTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgGenState=vrrpCurCfgGenState, routerLSALinkIndex=routerLSALinkIndex, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, ipRouteInfoType=ipRouteInfoType, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumRxHello=ospfCumRxHello, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfArea=ospfArea, ospfAreaTxPkts=ospfAreaTxPkts, ipGatewayTableMax=ipGatewayTableMax, ripNewCfgVip=ripNewCfgVip, ospfCumIntfLoop=ospfCumIntfLoop, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpStatEntries=arpStatEntries, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrChange=ospfIntfNbrChange, ripStatInPkts=ripStatInPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfProcessUptime=ospfProcessUptime, routerLSALinkID=routerLSALinkID, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpStatHighWater=arpStatHighWater, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripConfig=ripConfig, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpOper=vrrpOper, ospfGeneral=ospfGeneral, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpInfoDestIp=arpInfoDestIp, ospfCumNbrN1way=ospfCumNbrN1way, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxPkts=ospfCumRxPkts, vrrpStats=vrrpStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfBackup=ospfIntfBackup, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrhello=ospfAreaNbrhello, ipRouteInfoTag=ipRouteInfoTag, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumRxTxStats=ospfCumRxTxStats, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrStart=ospfCumNbrStart, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgListen=ripCurCfgListen, ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgDefListen=ripCurCfgDefListen, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwArp=ipNewCfgGwArp, ospfStartTime=ospfStartTime, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfInterface=ospfInterface, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaIntfLoop=ospfAreaIntfLoop, arpInfoRefPorts=arpInfoRefPorts, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, iprouting=iprouting, ipCurCfgBootpState=ipCurCfgBootpState, dnsStats=dnsStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoEntry=arpInfoEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpStats=arpStats, routeStats=routeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStatMaxEntries=routeStatMaxEntries, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSAId=routerLSAId, ospfTotalAreas=ospfTotalAreas, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripCurCfgSupply=ripCurCfgSupply, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwTable=ipNewCfgGwTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaTxDatabase=ospfAreaTxDatabase, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaInfoId=ospfAreaInfoId, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumIntfHello=ospfCumIntfHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfHello=ospfIntfHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumTxPkts=ospfCumTxPkts, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgState=ripNewCfgState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routeStatEntries=routeStatEntries, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrp=vrrp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfStats=ospfStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoTable=arpInfoTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrp_info=vrrp_info, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCfg=ospfCfg, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwEntry=ipCurCfgGwEntry)
