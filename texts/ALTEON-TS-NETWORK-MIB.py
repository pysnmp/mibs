...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaInfoTable=ospfAreaInfoTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumRxPkts=ospfCumRxPkts, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, routerLSALinkIndex=routerLSALinkIndex, routerLSALinkID=routerLSALinkID, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfArea=ospfArea, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripConfig=ripConfig, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, ipRouteInfoTag=ipRouteInfoTag, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, iprouting=iprouting, ospfIntfTxPkts=ospfIntfTxPkts, arpStatEntries=arpStatEntries, vrrpOper=vrrpOper, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routeStats=routeStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfIndex=ospfAreaIntfIndex, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumIntfHello=ospfCumIntfHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripStats=ripStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgGwInterval=ipCurCfgGwInterval, routeStatEntries=routeStatEntries, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxHello=ospfCumTxHello, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrDown=ospfAreaNbrDown, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTxHello=ospfAreaTxHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfInterface=ospfInterface, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfHello=ospfIntfHello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoInterface=ipRouteInfoInterface, ospfinfo=ospfinfo, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripCurCfgSupply=ripCurCfgSupply, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfStartTime=ospfStartTime, ospfGeneralStats=ospfGeneralStats, arpStats=arpStats, ipRouteInfoTable=ipRouteInfoTable, arpInfoEntry=arpInfoEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTimersKickOffStats=ospfTimersKickOffStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfDown=ospfIntfDown, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfLoop=ospfIntfLoop, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoMask=ipRouteInfoMask, vrrpGeneral=vrrpGeneral, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrp=vrrp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrhello=ospfAreaNbrhello, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgIntfState=ipNewCfgIntfState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfWaitInterval=ospfIfWaitInterval, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfChangeStats=ospfIntfChangeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoId=ospfAreaInfoId, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripCurCfgDefListen=ripCurCfgDefListen, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpInfoTable=arpInfoTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, dnsStats=dnsStats, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalAreas=ospfTotalAreas, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ip_info=ip_info, ripCurCfgListen=ripCurCfgListen, routeStatMaxEntries=routeStatMaxEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpStatHighWater=arpStatHighWater, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgVip=ripNewCfgVip, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgState=ipFwdCurCfgState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripNewCfgState=ripNewCfgState, ospfCumIntfLoop=ospfCumIntfLoop, ipForward=ipForward, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routerLSALinkData=routerLSALinkData, ospfTmrsKckOffHello=ospfTmrsKckOffHello, routeStatHighWater=routeStatHighWater, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumRxTxStats=ospfCumRxTxStats, ospfNbrInFullState=ospfNbrInFullState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfGeneral=ospfGeneral, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfBackup=ospfIntfBackup, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCfg=ospfCfg, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgBootpState=ipNewCfgBootpState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfUnloop=ospfIntfUnloop, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpStats=vrrpStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaIntfHello=ospfAreaIntfHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfIndex=ospfIntfIndex, arpInfoSrcPort=arpInfoSrcPort, vrrp_info=vrrp_info, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripStatInPkts=ripStatInPkts, ospfStats=ospfStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfTxHello=ospfIntfTxHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry)
