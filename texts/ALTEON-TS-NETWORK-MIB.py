...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfBackup=ospfIntfBackup, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrDown=ospfCumNbrDown, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, ripStats=ripStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfinfo=ospfinfo, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaNbrDown=ospfAreaNbrDown, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpStats=arpStats, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoInterface=ipRouteInfoInterface, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpStats=vrrpStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfStartTime=ospfStartTime, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routeStatEntries=routeStatEntries, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfDown=ospfIntfDown, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCfg=ospfCfg, ospfIntfTxHello=ospfIntfTxHello, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routerLSALinkData=routerLSALinkData, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripNewCfgVip=ripNewCfgVip, ripStatInPkts=ripStatInPkts, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrhello=ospfAreaNbrhello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrChange=ospfIntfNbrChange, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfState=ipCurCfgIntfState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfHello=ospfIntfHello, ospfProcessUptime=ospfProcessUptime, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpInfoFlag=arpInfoFlag, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfGeneralStats=ospfGeneralStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrStart=ospfIntfNbrStart, ospfTotalNeighbours=ospfTotalNeighbours, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxPkts=ospfAreaTxPkts, ipInterfaceTableMax=ipInterfaceTableMax, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpStatEntries=arpStatEntries, ospfStats=ospfStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripConfig=ripConfig, routerLSALinkID=routerLSALinkID, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routeStatMaxEntries=routeStatMaxEntries, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNbrInInitState=ospfNbrInInitState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrp_info=vrrp_info, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTxHello=ospfAreaTxHello, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipForward=ipForward, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpGeneral=vrrpGeneral, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfArea=ospfArea, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaInfoEntry=ospfAreaInfoEntry, routerLSAId=routerLSAId, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfHello=ospfAreaIntfHello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpInfoTable=arpInfoTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrp=vrrp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumNbrhello=ospfCumNbrhello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwState=ipNewCfgGwState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNbrInFullState=ospfNbrInFullState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfLoop=ospfIntfLoop, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, dnsStats=dnsStats, ospfLsTypesSupported=ospfLsTypesSupported, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumIntfBackup=ospfCumIntfBackup, arpInfoMacAddr=arpInfoMacAddr, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripNewCfgState=ripNewCfgState, ipRouteInfoGateway=ipRouteInfoGateway, ospfInterface=ospfInterface, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfBackup=ospfAreaIntfBackup, routeStats=routeStats, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNbrInExchState=ospfNbrInExchState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgListen=ripCurCfgListen, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwEntry=ipCurCfgGwEntry, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTxDatabase=ospfIntfTxDatabase, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ip_info=ip_info, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfGeneral=ospfGeneral, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxHello=ospfCumRxHello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpOper=vrrpOper, ospfIntfTxPkts=ospfIntfTxPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwState=ipCurCfgGwState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgSupply=ripNewCfgSupply)
