...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfStats=ospfStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfArea=ospfArea, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgIntfMask=ipNewCfgIntfMask, ipRouteInfoTable=ipRouteInfoTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgState=ripNewCfgState, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, iprouting=iprouting, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routerLSAId=routerLSAId, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, routerLSALinkData=routerLSALinkData, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrDown=ospfCumNbrDown, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfIndex=ospfIntfIndex, ospfInterface=ospfInterface, ip_info=ip_info, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfGeneralStats=ospfGeneralStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routeStatMaxEntries=routeStatMaxEntries, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgDefListen=ripNewCfgDefListen, arpInfoTable=arpInfoTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgGwState=ipNewCfgGwState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfBackup=ospfCumIntfBackup, vrrp=vrrp, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrStart=ospfCumNbrStart, ospfCumTxlsAcks=ospfCumTxlsAcks, arpInfoEntry=arpInfoEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoTag=ipRouteInfoTag, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgBootpState=ipCurCfgBootpState, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripNewCfgSupply=ripNewCfgSupply, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaChangeStats=ospfAreaChangeStats, vrrpStats=vrrpStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfStartTime=ospfStartTime, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumTxDatabase=ospfCumTxDatabase, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStatInPkts=ripStatInPkts, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, arpInfoFlag=arpInfoFlag, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgBootpState=ipNewCfgBootpState, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoSrcPort=arpInfoSrcPort, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgVip=ripCurCfgVip, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfTxHello=ospfIntfTxHello, ospfIntfWaitTimer=ospfIntfWaitTimer, ipRouteInfoEntry=ipRouteInfoEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumRxPkts=ospfCumRxPkts, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpStats=arpStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpStatEntries=arpStatEntries, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgAreaId=ospfNewCfgAreaId)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrhello=ospfCumNbrhello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripConfig=ripConfig, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaInfoIndex=ospfAreaInfoIndex, routeStatHighWater=routeStatHighWater, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfGeneral=ospfGeneral, vrrp_info=vrrp_info, ripCurCfgState=ripCurCfgState, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfinfo=ospfinfo, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripNewCfgVip=ripNewCfgVip, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfDown=ospfCumIntfDown, arpInfoRefPorts=arpInfoRefPorts, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfLoop=ospfIntfLoop, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaIntfDown=ospfAreaIntfDown, routeStatEntries=routeStatEntries, ospfIntfBackup=ospfIntfBackup, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoMacAddr=arpInfoMacAddr, dnsStats=dnsStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpStatMaxEntries=arpStatMaxEntries, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumTxlsReqs=ospfCumTxlsReqs, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipForward=ipForward, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumTxHello=ospfCumTxHello, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfInfoTable=ospfIntfInfoTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumTxPkts=ospfCumTxPkts, vrrpOper=vrrpOper, ospfCfg=ospfCfg, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpGeneral=vrrpGeneral, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStatHighWater=arpStatHighWater, ipRouteInfoIndx=ipRouteInfoIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, routeStats=routeStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrStart=ospfAreaNbrStart, ipRouteInfoMask=ipRouteInfoMask, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripStatInErrorPkts=ripStatInErrorPkts, routerLSALinkID=routerLSALinkID, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxPkts=ospfIntfRxPkts)
