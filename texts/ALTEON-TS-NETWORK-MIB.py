...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxHello=ospfCumRxHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, iprouting=iprouting, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxHello=ospfAreaTxHello, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumTxHello=ospfCumTxHello, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfGeneral=ospfGeneral, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrStart=ospfIntfNbrStart, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrDown=ospfCumNbrDown, arpInfoFlag=arpInfoFlag, ospfIntfDown=ospfIntfDown, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfChangeStats=ospfIntfChangeStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumRxTxStats=ospfCumRxTxStats, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, routeStatHighWater=routeStatHighWater, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipRouteInfoGateway=ipRouteInfoGateway, vrrpOper=vrrpOper, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCfg=ospfCfg, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipRouteInfoTag=ipRouteInfoTag, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpStats=arpStats, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxlsReqs=ospfCumRxlsReqs, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripNewCfgListen=ripNewCfgListen, ospfIntfBackup=ospfIntfBackup, ripCurCfgDefListen=ripCurCfgDefListen, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfIndex=ospfIntfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwIndex=ipCurCfgGwIndex, routeStats=routeStats, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfInfoTable=ospfIntfInfoTable, routerLSALinkData=routerLSALinkData, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfStats=ospfStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaChangeStats=ospfAreaChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaRxHello=ospfAreaRxHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwState=ipNewCfgGwState, arpInfoRefPorts=arpInfoRefPorts, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfArea=ospfArea, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrp=vrrp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoType=ipRouteInfoType, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpStats=vrrpStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripNewCfgState=ripNewCfgState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrRstAd=ospfCumNbrRstAd, arpStatEntries=arpStatEntries, ospfAreaTxDatabase=ospfAreaTxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumRxPkts=ospfCumRxPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfProcessUptime=ospfProcessUptime, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTxHello=ospfIntfTxHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalTransitAreas=ospfTotalTransitAreas)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, dnsStats=dnsStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripStatInErrorPkts=ripStatInErrorPkts, ip_info=ip_info, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routeStatEntries=routeStatEntries, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrStart=ospfCumNbrStart, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkID=routerLSALinkID, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfInterface=ospfInterface, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwDelete=ipNewCfgGwDelete, ipGatewayTableMax=ipGatewayTableMax, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoEntry=arpInfoEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSALinkIfIndex=routerLSALinkIfIndex, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIfWaitInterval=ospfIfWaitInterval, ospfNbrInExchState=ospfNbrInExchState, arpStatHighWater=arpStatHighWater, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripCurCfgListen=ripCurCfgListen, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrp_info=vrrp_info, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgGwTable=ipNewCfgGwTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripStats=ripStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaInfoEntry=ospfAreaInfoEntry, ripCurCfgVip=ripCurCfgVip, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaInfoId=ospfAreaInfoId, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfState=ipCurCfgIntfState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripConfig=ripConfig, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgState=ripCurCfgState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgBootpState=ipNewCfgBootpState, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgVip=ripNewCfgVip, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfinfo=ospfinfo, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipForward=ipForward, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, routeStatMaxEntries=routeStatMaxEntries, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrhello=ospfIntfNbrhello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaIntfHello=ospfAreaIntfHello, routerLSAId=routerLSAId)
