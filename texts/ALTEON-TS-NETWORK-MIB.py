...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfRxHello=ospfIntfRxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfProcessUptime=ospfProcessUptime, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxHello=ospfCumRxHello, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumRxTxStats=ospfCumRxTxStats, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoType=ipRouteInfoType, ospfGeneralStats=ospfGeneralStats, ospfCfg=ospfCfg, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipRouteInfoTag=ipRouteInfoTag, ospfStats=ospfStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfInterface=ospfInterface, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgVip=ripNewCfgVip, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, ipRouteInfoIndx=ipRouteInfoIndx, routerLSALinkID=routerLSALinkID, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpStatInAdvers=vrrpStatInAdvers, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgIntfTable=ipCurCfgIntfTable, arpInfoMacAddr=arpInfoMacAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgIntfState=ipCurCfgIntfState, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoDestIp=ipRouteInfoDestIp, routeStatHighWater=routeStatHighWater, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoVLAN=arpInfoVLAN, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoDestIp=arpInfoDestIp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripConfig=ripConfig, routeStats=routeStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfHello=ospfAreaIntfHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfNbrhello=ospfIntfNbrhello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfStartTime=ospfStartTime, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, dnsStats=dnsStats, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxlsAcks=ospfCumRxlsAcks, arpStatEntries=arpStatEntries, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripStatOutPkts=ripStatOutPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumTxDatabase=ospfCumTxDatabase, routeStatEntries=routeStatEntries, routerLSAId=routerLSAId, ripCurCfgDefListen=ripCurCfgDefListen, vrrp=vrrp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfBackup=ospfIntfBackup, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipGatewayTableMax=ipGatewayTableMax, vrrpOper=vrrpOper, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrStart=ospfIntfNbrStart, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfGeneral=ospfGeneral, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpInfoSrcPort=arpInfoSrcPort, iprouting=iprouting, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ipForward=ipForward, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrp_info=vrrp_info, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripNewCfgState=ripNewCfgState, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxHello=ospfCumTxHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoTable=arpInfoTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfIndex=ospfIntfIndex, ospfAreaNbrStart=ospfAreaNbrStart, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwArp=ipNewCfgGwArp, ospfArea=ospfArea, vrrpStats=vrrpStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ip_info=ip_info, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripCurCfgVip=ripCurCfgVip, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfDown=ospfCumIntfDown, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrDown=ospfIntfNbrDown, vrrpStatOutAdvers=vrrpStatOutAdvers, routerLSALinkData=routerLSALinkData, ripStats=ripStats, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxDatabase=ospfCumRxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfDown=ospfIntfDown, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfHello=ospfIntfHello, arpStatHighWater=arpStatHighWater, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxPkts=ospfIntfRxPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpStats=arpStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfLoop=ospfIntfLoop, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoTable=ipRouteInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkIndex=routerLSALinkIndex, ripStatInPkts=ripStatInPkts, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfEntry=ipCurCfgIntfEntry)
