...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumRxPkts=ospfCumRxPkts, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, dnsStats=dnsStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaInfoTable=ospfAreaInfoTable, vrrpStats=vrrpStats, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfEntry=ipCurCfgIntfEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfGeneral=ospfGeneral, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfArea=ospfArea, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routeStatMaxEntries=routeStatMaxEntries, ospfTotalAreas=ospfTotalAreas, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpInfoFlag=arpInfoFlag, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrStart=ospfCumNbrStart, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfRxPkts=ospfIntfRxPkts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ip_info=ip_info, ospfCumNbrDown=ospfCumNbrDown, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripConfig=ripConfig, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfGeneralStats=ospfGeneralStats, iprouting=iprouting, ripCurCfgListen=ripCurCfgListen, ospfIntfHello=ospfIntfHello, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfinfo=ospfinfo, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoRefPorts=arpInfoRefPorts, ospfIntfInfoTable=ospfIntfInfoTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfUnloop=ospfIntfUnloop, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoDestIp=arpInfoDestIp, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrp=vrrp, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrStart=ospfAreaNbrStart, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgListen=ripNewCfgListen, routerLSAAreaIndex=routerLSAAreaIndex, routerLSAId=routerLSAId, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfIndex=ospfIntfIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpOper=vrrpOper, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routerLSALinkID=routerLSALinkID, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumTxHello=ospfCumTxHello, ospfNewCfgAreaId=ospfNewCfgAreaId, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxPkts=ospfAreaTxPkts, arpStatEntries=arpStatEntries, ospfIntfDown=ospfIntfDown, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipRouteInfoTable=ipRouteInfoTable, routeStats=routeStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgState=ripNewCfgState, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfLoop=ospfIntfLoop, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripStatRoutesAgedOut=ripStatRoutesAgedOut)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoType=ipRouteInfoType, ospfCfg=ospfCfg, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgIntfTable=ipNewCfgIntfTable, arpStatMaxEntries=arpStatMaxEntries, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, arpInfoSrcPort=arpInfoSrcPort, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoInterface=ipRouteInfoInterface, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripStats=ripStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrp_info=vrrp_info, ospfNbrInInitState=ospfNbrInInitState, ospfIntfInfoEntry=ospfIntfInfoEntry, ripStatInErrorPkts=ripStatInErrorPkts, ripNewCfgDefListen=ripNewCfgDefListen, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaInfoEntry=ospfAreaInfoEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipRouteInfoTag=ipRouteInfoTag, ospfInterface=ospfInterface, ospfCumNbrN1way=ospfCumNbrN1way, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgState=ipFwdNewCfgState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfBackup=ospfIntfBackup, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpGeneral=vrrpGeneral, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routeStatHighWater=routeStatHighWater, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfStats=ospfStats, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpStats=arpStats, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgIntfState=ipCurCfgIntfState, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgVip=ripCurCfgVip, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipForward=ipForward, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwState=ipCurCfgGwState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routeStatEntries=routeStatEntries, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoTable=arpInfoTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumIntfLoop=ospfCumIntfLoop, ospfNbrInFullState=ospfNbrInFullState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc)
