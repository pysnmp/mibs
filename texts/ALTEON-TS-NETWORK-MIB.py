...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routerLSALinkData=routerLSALinkData, ipNewCfgGwInterval=ipNewCfgGwInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfinfo=ospfinfo, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgVip=ripNewCfgVip, arpInfoDestIp=arpInfoDestIp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoSrcPort=arpInfoSrcPort, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpStatEntries=arpStatEntries, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfProcessUptime=ospfProcessUptime, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxPkts=ospfAreaRxPkts, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoType=ipRouteInfoType, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ripCurCfgState=ripCurCfgState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwIndex=ipNewCfgGwIndex, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpStatHighWater=arpStatHighWater, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipGatewayTableMax=ipGatewayTableMax, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenState=vrrpNewCfgGenState, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrDown=ospfCumNbrDown, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfStats=ospfStats, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrN1way=ospfCumNbrN1way, ripNewCfgState=ripNewCfgState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfInterface=ospfInterface, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfGeneralInfo=ospfGeneralInfo, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaInfoTable=ospfAreaInfoTable, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routerLSAId=routerLSAId, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routeStatHighWater=routeStatHighWater, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripNewCfgStaticSupply=ripNewCfgStaticSupply, iprouting=iprouting, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCfg=ospfCfg)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, ripStats=ripStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgBootpState=ipCurCfgBootpState, ripStatInPkts=ripStatInPkts, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfGeneral=ospfGeneral, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumIntfDown=ospfCumIntfDown, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrDown=ospfIntfNbrDown, arpInfoEntry=arpInfoEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfBackup=ospfIntfBackup, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgVip=ripCurCfgVip, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ip_info=ip_info, vrrpGeneral=vrrpGeneral, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTotalAreas=ospfTotalAreas, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgListen=ripCurCfgListen, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrhello=ospfAreaNbrhello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfState=ipCurCfgIntfState, arpStats=arpStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpInfoVLAN=arpInfoVLAN, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxHello=ospfAreaRxHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrp=vrrp, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfGeneralStats=ospfGeneralStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfTxHello=ospfIntfTxHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routeStats=routeStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripStatOutPkts=ripStatOutPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfStartTime=ospfStartTime, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwTable=ipCurCfgGwTable, routeStatEntries=routeStatEntries, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxlsReqs=ospfCumTxlsReqs, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaNbrStart=ospfAreaNbrStart, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrStart=ospfIntfNbrStart, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipForward=ipForward, ipNewCfgGwState=ipNewCfgGwState, ipRouteInfoTable=ipRouteInfoTable, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfDown=ospfIntfDown, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgState=ipFwdCurCfgState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, routerLSALinkID=routerLSALinkID, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer)
