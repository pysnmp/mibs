...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNbrInExchState=ospfNbrInExchState, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTotalAreas=ospfTotalAreas, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, dnsStats=dnsStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumIntfBackup=ospfCumIntfBackup, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaInfoId=ospfAreaInfoId, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgState=ripCurCfgState, arpInfoEntry=arpInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpStatEntries=arpStatEntries, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoDestIp=arpInfoDestIp, ospfNbrInInitState=ospfNbrInInitState, iprouting=iprouting, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipRouteInfoType=ipRouteInfoType, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfHello=ospfIntfHello, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripNewCfgVip=ripNewCfgVip, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenState=vrrpCurCfgGenState, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ipRouteInfoTag=ipRouteInfoTag, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumTxHello=ospfCumTxHello, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrp=vrrp, ipCurCfgIntfMask=ipCurCfgIntfMask, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpStats=vrrpStats, vrrp_info=vrrp_info, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxHello=ospfAreaRxHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumIntfDown=ospfCumIntfDown, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgGwIndex=ipNewCfgGwIndex, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpStats=arpStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpInfoMacAddr=arpInfoMacAddr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfLoop=ospfIntfLoop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwState=ipCurCfgGwState, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgIntfState=ipNewCfgIntfState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfStats=ospfStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNbrInFullState=ospfNbrInFullState, ipRouteInfoEntry=ipRouteInfoEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCfg=ospfCfg, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfinfo=ospfinfo, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSALinkID=routerLSALinkID, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpOper=vrrpOper, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripStatOutPkts=ripStatOutPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, ripStats=ripStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripNewCfgSupply=ripNewCfgSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripConfig=ripConfig, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routerLSAId=routerLSAId, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpStatMaxEntries=arpStatMaxEntries, ospfTotalNeighbours=ospfTotalNeighbours, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfInfoTable=ospfIntfInfoTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfInterface=ospfInterface, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgVip=ripCurCfgVip, ripNewCfgState=ripNewCfgState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIfInfoIndex=ospfIfInfoIndex, routeStats=routeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrhello=ospfAreaNbrhello, routerLSALinkData=routerLSALinkData, ip_info=ip_info, ipForward=ipForward, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfGeneral=ospfGeneral, ospfCumNbrDown=ospfCumNbrDown, ospfIntfDown=ospfIntfDown, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoVLAN=arpInfoVLAN, ospfIntfBackup=ospfIntfBackup, ospfGeneralInfo=ospfGeneralInfo, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwDelete=ipNewCfgGwDelete, routeStatEntries=routeStatEntries, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpStatHighWater=arpStatHighWater, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routerLSALinkIndex=routerLSALinkIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpGeneral=vrrpGeneral, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaInfoIndex=ospfAreaInfoIndex)
