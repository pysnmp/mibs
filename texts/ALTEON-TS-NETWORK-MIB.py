...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfIndex=ospfIntfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpStatHighWater=arpStatHighWater, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpStats=vrrpStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, iprouting=iprouting, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoMask=ipRouteInfoMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxlsAcks=ospfCumRxlsAcks, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrStart=ospfAreaNbrStart, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwState=ipNewCfgGwState, routerLSALinkID=routerLSALinkID, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgIntfTable=ipCurCfgIntfTable, ripConfig=ripConfig, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipForward=ipForward, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfLoop=ospfAreaIntfLoop, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxDatabase=ospfCumRxDatabase, ospfGeneral=ospfGeneral, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpStatEntries=arpStatEntries, ipCurCfgGwTable=ipCurCfgGwTable, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpInfoSrcPort=arpInfoSrcPort, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoVLAN=arpInfoVLAN, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumTxDatabase=ospfCumTxDatabase, ospfGeneralStats=ospfGeneralStats, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfDown=ospfIntfDown, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwAddr=ipCurCfgGwAddr, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfLoop=ospfIntfLoop, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routeStatHighWater=routeStatHighWater, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaTxHello=ospfAreaTxHello, ospfCumIntfHello=ospfCumIntfHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfNbrInExchState=ospfNbrInExchState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfStats=ospfStats, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCfg=ospfCfg, ospfInterface=ospfInterface, ospfCumRxPkts=ospfCumRxPkts, vrrp=vrrp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoTable=ipRouteInfoTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpGeneral=vrrpGeneral, ripCurCfgListen=ripCurCfgListen, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpStats=arpStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfWaitTimer=ospfIntfWaitTimer, dnsStats=dnsStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfUnloop=ospfIntfUnloop, ospfStartTime=ospfStartTime, arpInfoFlag=arpInfoFlag, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfHello=ospfIntfHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripStatInPkts=ripStatInPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgState=ipFwdCurCfgState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfinfo=ospfinfo)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfArea=ospfArea, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumTxHello=ospfCumTxHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoTable=arpInfoTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaRxPkts=ospfAreaRxPkts, ripStats=ripStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgSupply=ripCurCfgSupply, routeStatEntries=routeStatEntries, ip_info=ip_info, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routeStatMaxEntries=routeStatMaxEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrChange=ospfIntfNbrChange, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfDown=ospfCumIntfDown, routeStats=routeStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrDown=ospfIntfNbrDown, vrrpOper=vrrpOper, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpStatMaxEntries=arpStatMaxEntries, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfProcessUptime=ospfProcessUptime, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaRxHello=ospfAreaRxHello, ipRouteInfoIndx=ipRouteInfoIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSALinkIndex=routerLSALinkIndex, arpInfoEntry=arpInfoEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgVip=ripNewCfgVip, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID)
