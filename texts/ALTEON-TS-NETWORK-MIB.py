...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSALinkIndex=routerLSALinkIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpStatMaxEntries=arpStatMaxEntries, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNbrInExchState=ospfNbrInExchState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSAId=routerLSAId, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpStats=vrrpStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpGeneral=vrrpGeneral, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaInfoIndex=ospfAreaInfoIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfUnloop=ospfIntfUnloop, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripConfig=ripConfig, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipForward=ipForward, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxDatabase=ospfCumTxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfLoop=ospfIntfLoop, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaTxHello=ospfAreaTxHello, arpStats=arpStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfTotalAreas=ospfTotalAreas, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfDown=ospfIntfDown, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfGeneral=ospfGeneral, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfInterface=ospfInterface, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrp_info=vrrp_info, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripStatInErrorPkts=ripStatInErrorPkts, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaInfoId=ospfAreaInfoId, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoDestIp=arpInfoDestIp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwArp=ipNewCfgGwArp, routerLSALinkID=routerLSALinkID, routerLSALinkData=routerLSALinkData, ospfCumIntfDown=ospfCumIntfDown, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfinfo=ospfinfo, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routeStatEntries=routeStatEntries, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumRxHello=ospfCumRxHello, iprouting=iprouting, ospfIntfInfoTable=ospfIntfInfoTable, arpInfoTable=arpInfoTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwTable=ipCurCfgGwTable, ripStatOutPkts=ripStatOutPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumRxPkts=ospfCumRxPkts, ospfIntfHello=ospfIntfHello, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpStatEntries=arpStatEntries, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfStartTime=ospfStartTime, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripNewCfgState=ripNewCfgState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routeStatHighWater=routeStatHighWater, ripStatInPkts=ripStatInPkts, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaRxlsReqs=ospfAreaRxlsReqs, dnsStats=dnsStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripStats=ripStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpOper=vrrpOper, ripCurCfgDefListen=ripCurCfgDefListen, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCfg=ospfCfg, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipRouteInfoType=ipRouteInfoType, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumTxHello=ospfCumTxHello, arpInfoSrcPort=arpInfoSrcPort, routeStats=routeStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripCurCfgState=ripCurCfgState, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaRxHello=ospfAreaRxHello, ospfProcessUptime=ospfProcessUptime, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgListen=ripCurCfgListen, ripNewCfgListen=ripNewCfgListen, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripNewCfgVip=ripNewCfgVip, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrhello=ospfCumNbrhello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpStatHighWater=arpStatHighWater, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIfInfoIndex=ospfIfInfoIndex, arpInfoRefPorts=arpInfoRefPorts, vrrp=vrrp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumRxDatabase=ospfCumRxDatabase, ipRouteInfoTable=ipRouteInfoTable, ospfIntfIndex=ospfIntfIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumIntfHello=ospfCumIntfHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxHello=ospfIntfRxHello, arpInfoFlag=arpInfoFlag, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ip_info=ip_info, vrrpStatOutAdvers=vrrpStatOutAdvers, ripCurCfgVip=ripCurCfgVip, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfArea=ospfArea, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx)
