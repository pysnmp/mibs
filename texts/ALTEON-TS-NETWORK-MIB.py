...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, dnsStats=dnsStats, ospfAreaIntfHello=ospfAreaIntfHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumTxPkts=ospfCumTxPkts, arpInfoTable=arpInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgListen=ripNewCfgListen, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrhello=ospfAreaNbrhello, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfinfo=ospfinfo, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrp=vrrp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrp_info=vrrp_info, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, iprouting=iprouting, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripStats=ripStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwArp=ipCurCfgGwArp, routeStats=routeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfGeneral=ospfGeneral, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfArea=ospfArea, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaIntfIndex=ospfAreaIntfIndex, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrhello=ospfCumNbrhello, ospfCfg=ospfCfg, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumRxTxStats=ospfCumRxTxStats, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoEntry=ipRouteInfoEntry, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, arpInfoEntry=arpInfoEntry, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxHello=ospfAreaRxHello, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfLoop=ospfIntfLoop, ospfCumRxPkts=ospfCumRxPkts, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgIntfState=ipCurCfgIntfState, ripNewCfgState=ripNewCfgState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgState=ipFwdCurCfgState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaInfoId=ospfAreaInfoId, ospfStats=ospfStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfDown=ospfIntfDown, ospfNbrInInitState=ospfNbrInInitState, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumNbrN1way=ospfCumNbrN1way, ospfInterface=ospfInterface, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripNewCfgSupply=ripNewCfgSupply, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpInfoVLAN=arpInfoVLAN, ospfIntfChangeStats=ospfIntfChangeStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaRxlsAcks=ospfAreaRxlsAcks)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumTxlsAcks=ospfCumTxlsAcks, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOper=vrrpOper, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfTable=ipCurCfgIntfTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfRxHello=ospfIntfRxHello, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpStats=arpStats, arpStatHighWater=arpStatHighWater, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpStats=vrrpStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoFlag=arpInfoFlag, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpInfoDestIp=arpInfoDestIp, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfMask=ipNewCfgIntfMask, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrDown=ospfAreaNbrDown, ospfNbrInExchState=ospfNbrInExchState, vrrpGeneral=vrrpGeneral, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwIndex=ipCurCfgGwIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfStartTime=ospfStartTime, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripConfig=ripConfig, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwMetric=ipNewCfgGwMetric, ripCurCfgVip=ripCurCfgVip, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, routeStatEntries=routeStatEntries, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoTable=ipRouteInfoTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ip_info=ip_info, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwArp=ipNewCfgGwArp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumRxHello=ospfCumRxHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, arpStatEntries=arpStatEntries, ipForward=ipForward, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumIntfDown=ospfCumIntfDown, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfHello=ospfIntfHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripStatOutPkts=ripStatOutPkts, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfInfoIndex=ospfIfInfoIndex, routerLSALinkID=routerLSALinkID, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgVip=ripNewCfgVip, ipCurCfgGwState=ipCurCfgGwState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp)
