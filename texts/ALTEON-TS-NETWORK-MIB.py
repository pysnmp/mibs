...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfDown=ospfIntfDown, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfUnloop=ospfIntfUnloop, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgSupply=ripCurCfgSupply, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoSrcPort=arpInfoSrcPort, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfChangeStats=ospfIntfChangeStats, ospfStats=ospfStats, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfTxHello=ospfIntfTxHello, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTotalNeighbours=ospfTotalNeighbours, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNbrInFullState=ospfNbrInFullState, arpInfoVLAN=arpInfoVLAN, routeStatHighWater=routeStatHighWater, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumRxTxStats=ospfCumRxTxStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrp_info=vrrp_info, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTotalAreas=ospfTotalAreas, ripNewCfgVip=ripNewCfgVip, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrp=vrrp, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfProcessUptime=ospfProcessUptime, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfInterface=ospfInterface, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpGeneral=vrrpGeneral, ipCurCfgGwVlan=ipCurCfgGwVlan, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatHighWater=arpStatHighWater, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpStatMaxEntries=arpStatMaxEntries, ospfArea=ospfArea, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSAId=routerLSAId, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, ripStats=ripStats, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoEntry=arpInfoEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipRouteInfoTable=ipRouteInfoTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIfWaitInterval=ospfIfWaitInterval, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfState=ipCurCfgIntfState, ripCurCfgListen=ripCurCfgListen, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgVip=ripCurCfgVip, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripConfig=ripConfig, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfGeneralInfo=ospfGeneralInfo, ospfIntfInfoTable=ospfIntfInfoTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxHello=ospfIntfRxHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, dnsStats=dnsStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfDown=ospfCumIntfDown, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripStatOutPkts=ripStatOutPkts, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxHello=ospfCumRxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfLoop=ospfIntfLoop, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNbrInInitState=ospfNbrInInitState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStatEntries=routeStatEntries, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripStatInPkts=ripStatInPkts, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrStart=ospfCumNbrStart, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumTxHello=ospfCumTxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoTable=arpInfoTable, ospfinfo=ospfinfo, arpInfoDestIp=arpInfoDestIp, ipForward=ipForward, ospfIntfWaitTimer=ospfIntfWaitTimer, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routerLSALinkData=routerLSALinkData, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxDatabase=ospfCumRxDatabase, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStats=vrrpStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaTxHello=ospfAreaTxHello, ospfAreaRxDatabase=ospfAreaRxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, arpStats=arpStats, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNbrInExchState=ospfNbrInExchState, ip_info=ip_info, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwArp=ipCurCfgGwArp, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrDown=ospfCumNbrDown, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpInfoMacAddr=arpInfoMacAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCfg=ospfCfg, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpStatEntries=arpStatEntries, ripNewCfgState=ripNewCfgState, ospfGeneralStats=ospfGeneralStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfGeneral=ospfGeneral, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, iprouting=iprouting, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr)
