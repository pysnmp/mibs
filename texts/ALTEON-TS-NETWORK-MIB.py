...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfGeneral=ospfGeneral, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routerLSALinkID=routerLSALinkID, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwState=ipCurCfgGwState, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoFlag=arpInfoFlag, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripConfig=ripConfig, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfIndex=ospfIntfIndex, ospfAreaInfoId=ospfAreaInfoId, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ip_info=ip_info, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipRouteInfoTable=ipRouteInfoTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgListen=ripCurCfgListen, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgGwInterval=ipCurCfgGwInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoVLAN=arpInfoVLAN, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routeStatEntries=routeStatEntries, ripNewCfgVip=ripNewCfgVip, ospfAreaTableMaxSize=ospfAreaTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrp_info=vrrp_info, ospfInterface=ospfInterface, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrStart=ospfAreaNbrStart, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrStart=ospfIntfNbrStart, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, iprouting=iprouting, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaTxHello=ospfAreaTxHello, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoType=ipRouteInfoType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgState=ripCurCfgState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrDown=ospfIntfNbrDown, ipGatewayTableMax=ipGatewayTableMax, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfLoop=ospfAreaIntfLoop, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfLoop=ospfIntfLoop, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpOper=vrrpOper, ospfCumIntfBackup=ospfCumIntfBackup, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfState=ipNewCfgIntfState, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrhello=ospfCumNbrhello, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfLoop=ospfCumIntfLoop, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrhello=ospfAreaNbrhello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpStats=vrrpStats, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfHello=ospfIntfHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpStats=arpStats, ipCurCfgGwTable=ipCurCfgGwTable, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripStatOutPkts=ripStatOutPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfinfo=ospfinfo, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpInfoEntry=arpInfoEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripNewCfgState=ripNewCfgState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfArea=ospfArea, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwEntry=ipCurCfgGwEntry, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripNewCfgDefListen=ripNewCfgDefListen, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfBackup=ospfIntfBackup, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfStats=ospfStats, ospfProcessUptime=ospfProcessUptime, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, dnsStats=dnsStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrDown=ospfCumNbrDown, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoInterface=ipRouteInfoInterface, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routeStats=routeStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfRxHello=ospfIntfRxHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routerLSAId=routerLSAId, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripStatInPkts=ripStatInPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrp=vrrp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaRxPkts=ospfAreaRxPkts, arpStatMaxEntries=arpStatMaxEntries, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIfWaitInterval=ospfIfWaitInterval, routerLSALinkData=routerLSALinkData, ripStatInErrorPkts=ripStatInErrorPkts, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCfg=ospfCfg, ospfCumIntfUnloop=ospfCumIntfUnloop, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, ripNewCfgListen=ripNewCfgListen, arpStatHighWater=arpStatHighWater, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfGeneralStats=ospfGeneralStats, arpInfoRefPorts=arpInfoRefPorts, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr)
