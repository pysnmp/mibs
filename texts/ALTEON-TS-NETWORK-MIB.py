...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfInterface=ospfInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwTable=ipNewCfgGwTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoMask=ipRouteInfoMask, arpInfoRefPorts=arpInfoRefPorts, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTotalAreas=ospfTotalAreas, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfStats=ospfStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfHello=ospfIntfHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfDown=ospfIntfDown, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwState=ipNewCfgGwState, vrrp=vrrp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfIndex=ospfIntfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpOper=vrrpOper, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgState=ripCurCfgState, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumIntfLoop=ospfCumIntfLoop, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxTxStats=ospfAreaRxTxStats, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routeStats=routeStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNbrInInitState=ospfNbrInInitState, ospfCumRxHello=ospfCumRxHello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgState=ripNewCfgState, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripStatOutPkts=ripStatOutPkts, vrrpGeneral=vrrpGeneral, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfStartTime=ospfStartTime, ospfIntfNbrhello=ospfIntfNbrhello, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpInfoFlag=arpInfoFlag, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripCurCfgListen=ripCurCfgListen, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgBootpState=ipNewCfgBootpState, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoInterface=ipRouteInfoInterface, arpStatMaxEntries=arpStatMaxEntries, ripStatInPkts=ripStatInPkts, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfinfo=ospfinfo, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpStatEntries=arpStatEntries, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripConfig=ripConfig, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfProcessUptime=ospfProcessUptime, ospfCumTxDatabase=ospfCumTxDatabase, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrStart=ospfIntfNbrStart, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaNbrStart=ospfAreaNbrStart, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgVip=ripCurCfgVip, vrrp_info=vrrp_info, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpInfoDestIp=arpInfoDestIp, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipRouteInfoType=ipRouteInfoType, ipCurCfgGwEntry=ipCurCfgGwEntry, routeStatHighWater=routeStatHighWater, ospfCfg=ospfCfg, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, iprouting=iprouting, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfLoop=ospfIntfLoop, ip_info=ip_info, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipForward=ipForward, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwArp=ipNewCfgGwArp, routerLSALinkData=routerLSALinkData, routerLSALinkIndex=routerLSALinkIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaRxHello=ospfAreaRxHello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripStats=ripStats, ospfCumTxPkts=ospfCumTxPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfGeneralInfo=ospfGeneralInfo, vrrpStats=vrrpStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, dnsStats=dnsStats, ospfCumTxHello=ospfCumTxHello, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfRxHello=ospfIntfRxHello, ospfIntfBackup=ospfIntfBackup, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, arpStatHighWater=arpStatHighWater, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfGeneral=ospfGeneral, ospfAreaChangeStats=ospfAreaChangeStats, routeStatMaxEntries=routeStatMaxEntries, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, arpStats=arpStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpInfoVLAN=arpInfoVLAN, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfArea=ospfArea, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf)
