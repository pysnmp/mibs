...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaIntfDown=ospfAreaIntfDown, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfLoop=ospfIntfLoop, ospfCumIntfLoop=ospfCumIntfLoop, ripConfig=ripConfig, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxHello=ospfAreaRxHello, ip_info=ip_info, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpGeneral=vrrpGeneral, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipGatewayTableMax=ipGatewayTableMax, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpInfoEntry=arpInfoEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpInfoVLAN=arpInfoVLAN, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfRxHello=ospfIntfRxHello, arpStatHighWater=arpStatHighWater, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfGeneralStats=ospfGeneralStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwArp=ipNewCfgGwArp, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgSupply=ripNewCfgSupply, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoMask=ipRouteInfoMask, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwIndex=ipNewCfgGwIndex, ripCurCfgState=ripCurCfgState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipForward=ipForward, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCfg=ospfCfg, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrStart=ospfCumNbrStart, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfDown=ospfCumIntfDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxHello=ospfCumRxHello, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrhello=ospfCumNbrhello, ospfAreaIntfHello=ospfAreaIntfHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfWaitTimer=ospfIntfWaitTimer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrDown=ospfCumNbrDown, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfInterface=ospfInterface, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgState=ripNewCfgState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfIndex=ospfAreaIntfIndex, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrChange=ospfIntfNbrChange, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgVip=ripCurCfgVip, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaInfoTable=ospfAreaInfoTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfIndex=ospfIntfIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfState=ipNewCfgIntfState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfHello=ospfIntfHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripStatInErrorPkts=ripStatInErrorPkts)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripCurCfgSupply=ripCurCfgSupply, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routeStatMaxEntries=routeStatMaxEntries, ospfGeneral=ospfGeneral, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaTxDatabase=ospfAreaTxDatabase, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfDown=ospfIntfDown, ospfGeneralInfo=ospfGeneralInfo, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrN1way=ospfCumNbrN1way, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaInfoEntry=ospfAreaInfoEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTotalNeighbours=ospfTotalNeighbours, vrrp_info=vrrp_info, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumRxPkts=ospfCumRxPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfinfo=ospfinfo, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoTable=arpInfoTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfHello=ospfCumIntfHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, routeStats=routeStats, routeStatHighWater=routeStatHighWater, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfTotalAreas=ospfTotalAreas, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrhello=ospfIntfNbrhello, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumRxDatabase=ospfCumRxDatabase, ospfStats=ospfStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfStartTime=ospfStartTime, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoFlag=arpInfoFlag, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpOper=vrrpOper, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwVlan=ipNewCfgGwVlan, arpStatEntries=arpStatEntries, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpInfoDestIp=arpInfoDestIp, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, routerLSAId=routerLSAId, arpInfoMacAddr=arpInfoMacAddr, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwIndex=ipCurCfgGwIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfBackup=ospfIntfBackup, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfArea=ospfArea, ospfProcessUptime=ospfProcessUptime, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNbrInExchState=ospfNbrInExchState, arpStatMaxEntries=arpStatMaxEntries, routeStatEntries=routeStatEntries, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpStats=vrrpStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpStats=arpStats, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripStats=ripStats, ospfAreaTxHello=ospfAreaTxHello, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripStatInPkts=ripStatInPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrp=vrrp, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr)
