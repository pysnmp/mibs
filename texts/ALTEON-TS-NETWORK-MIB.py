...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfGeneral=ospfGeneral, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, ipRouteInfoTable=ipRouteInfoTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwEntry=ipNewCfgGwEntry, ipRouteInfoTag=ipRouteInfoTag, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, ipGatewayTableMax=ipGatewayTableMax, routerLSAId=routerLSAId, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfDown=ospfAreaIntfDown, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoRefPorts=arpInfoRefPorts, ospfProcessUptime=ospfProcessUptime, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTimersKickOffStats=ospfTimersKickOffStats, arpStatHighWater=arpStatHighWater, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfLoop=ospfIntfLoop, routerLSALinkData=routerLSALinkData, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfHello=ospfIntfHello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgBootpState=ipNewCfgBootpState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrp=vrrp, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrp_info=vrrp_info, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpOper=vrrpOper, ipNewCfgIntfMask=ipNewCfgIntfMask, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpInfoFlag=arpInfoFlag, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpGeneral=vrrpGeneral, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routeStatHighWater=routeStatHighWater, ospfTotalAreas=ospfTotalAreas, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routeStats=routeStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfDown=ospfIntfDown, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipForward=ipForward, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routeStatEntries=routeStatEntries, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpStatEntries=arpStatEntries, routerLSAAreaIndex=routerLSAAreaIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgIntfTable=ipNewCfgIntfTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoTable=arpInfoTable, ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrhello=ospfCumNbrhello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfWaitInterval=ospfIfWaitInterval, ripNewCfgState=ripNewCfgState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatInPkts=ripStatInPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfGeneralStats=ospfGeneralStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfUnloop=ospfIntfUnloop, ripStats=ripStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfGeneralInfo=ospfGeneralInfo, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipRouteInfoGateway=ipRouteInfoGateway, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripStatOutPkts=ripStatOutPkts, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrDown=ospfCumNbrDown, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfIndex=ospfIntfIndex, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNbrInFullState=ospfNbrInFullState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaRxHello=ospfAreaRxHello, ospfCumRxHello=ospfCumRxHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoIndx=ipRouteInfoIndx, ospfinfo=ospfinfo, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrChange=ospfIntfNbrChange, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ip_info=ip_info, ospfCumTxPkts=ospfCumTxPkts, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpStats=arpStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgSupply=ripNewCfgSupply, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrStart=ospfIntfNbrStart, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfTxHello=ospfIntfTxHello, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrIndex=ospfIntfNbrIndex, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwState=ipNewCfgGwState, dnsStats=dnsStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfStats=ospfStats, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfTxPkts=ospfIntfTxPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfInterface=ospfInterface, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpStatMaxEntries=arpStatMaxEntries, ripConfig=ripConfig, iprouting=iprouting, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfHello=ospfCumIntfHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfDown=ospfCumIntfDown, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, arpInfoDestIp=arpInfoDestIp, ospfAreaInfoTable=ospfAreaInfoTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfArea=ospfArea, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfInfoTable=ospfIntfInfoTable, ospfStartTime=ospfStartTime, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSALinkID=routerLSALinkID, ospfNbrInExchState=ospfNbrInExchState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwArp=ipNewCfgGwArp)
