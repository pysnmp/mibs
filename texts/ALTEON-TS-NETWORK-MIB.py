...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfRxHello=ospfIntfRxHello, ospfStats=ospfStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrp_info=vrrp_info, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxHello=ospfCumRxHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripConfig=ripConfig, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpStats=vrrpStats, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripStats=ripStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpStatMaxEntries=arpStatMaxEntries, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCfg=ospfCfg, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfEntry=ipCurCfgIntfEntry, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfTable=ipNewCfgIntfTable, arpInfoDestIp=arpInfoDestIp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgGwState=ipNewCfgGwState, ospfTotalAreas=ospfTotalAreas, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfBackup=ospfCumIntfBackup, ripStatInPkts=ripStatInPkts, routeStats=routeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipRouteInfoInterface=ipRouteInfoInterface, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpOper=vrrpOper, ripNewCfgVip=ripNewCfgVip, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSAId=routerLSAId, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTxHello=ospfIntfTxHello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNbrInExchState=ospfNbrInExchState, ospfInterface=ospfInterface, iprouting=iprouting, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNbrInFullState=ospfNbrInFullState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripStatOutPkts=ripStatOutPkts, ospfIntfHello=ospfIntfHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfLsTypesSupported=ospfLsTypesSupported, ospfinfo=ospfinfo, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfProcessUptime=ospfProcessUptime, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoTable=ipRouteInfoTable, ripCurCfgListen=ripCurCfgListen, routeStatEntries=routeStatEntries, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumTxHello=ospfCumTxHello, ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoTag=ipRouteInfoTag, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, routeStatHighWater=routeStatHighWater, ospfIntfLoop=ospfIntfLoop, ripCurCfgVip=ripCurCfgVip, ospfAreaNbrhello=ospfAreaNbrhello, arpInfoFlag=arpInfoFlag, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripNewCfgState=ripNewCfgState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoVLAN=arpInfoVLAN, ospfIntfDown=ospfIntfDown, ospfStartTime=ospfStartTime, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoEntry=ipRouteInfoEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoEntry=arpInfoEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipInterfaceTableMax=ipInterfaceTableMax, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoSrcPort=arpInfoSrcPort, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, arpStatEntries=arpStatEntries, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaTxHello=ospfAreaTxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripCurCfgState=ripCurCfgState, ip_info=ip_info, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoMacAddr=arpInfoMacAddr, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfArea=ospfArea, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpStatHighWater=arpStatHighWater, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routerLSALinkData=routerLSALinkData, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrp=vrrp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoTable=arpInfoTable, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpInfoRefPorts=arpInfoRefPorts, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrStart=ospfCumNbrStart, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipForward=ipForward, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrDown=ospfIntfNbrDown, ipRouteInfoIndx=ipRouteInfoIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfBackup=ospfIntfBackup, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpGeneral=vrrpGeneral, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgListen=ripNewCfgListen, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpStats=arpStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumTxlsUpdates=ospfCumTxlsUpdates)
