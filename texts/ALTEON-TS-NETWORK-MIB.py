...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipRouteInfoType=ipRouteInfoType, arpStatHighWater=arpStatHighWater, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgVip=ripNewCfgVip, ospfCumIntfUnloop=ospfCumIntfUnloop, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripConfig=ripConfig, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfDown=ospfCumIntfDown, arpInfoVLAN=arpInfoVLAN, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfNbrInInitState=ospfNbrInInitState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routerLSALinkData=routerLSALinkData, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpStatMaxEntries=arpStatMaxEntries, ospfinfo=ospfinfo, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfRxHello=ospfIntfRxHello, dnsStats=dnsStats, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumNbrDown=ospfCumNbrDown, ospfAreaRxHello=ospfAreaRxHello, ospfIfInfoIndex=ospfIfInfoIndex, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumIntfLoop=ospfCumIntfLoop, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfDown=ospfIntfDown, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrChange=ospfIntfNbrChange, ospfLsTypesSupported=ospfLsTypesSupported, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNbrInFullState=ospfNbrInFullState, arpStats=arpStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwAddr=ipNewCfgGwAddr, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrhello=ospfIntfNbrhello, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCfg=ospfCfg, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfCountForRouter=ospfIntfCountForRouter, ipForward=ipForward, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfInfoTable=ospfIntfInfoTable, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoTable=ipRouteInfoTable, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrp=vrrp, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSALinkID=routerLSALinkID, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaChangeStats=ospfAreaChangeStats, arpInfoDestIp=arpInfoDestIp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripStats=ripStats, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumRxDatabase=ospfCumRxDatabase, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripCurCfgSupply=ripCurCfgSupply, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrDown=ospfIntfNbrDown, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfTxPkts=ospfIntfTxPkts, arpInfoTable=arpInfoTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpStatEntries=arpStatEntries, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumRxlsAcks=ospfCumRxlsAcks, ripNewCfgListen=ripNewCfgListen, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatHighWater=routeStatHighWater, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpStats=vrrpStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxHello=ospfCumRxHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routeStats=routeStats, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrhello=ospfCumNbrhello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumRxPkts=ospfCumRxPkts, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfGeneralStats=ospfGeneralStats, vrrp_info=vrrp_info, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfArea=ospfArea, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfNbrInExchState=ospfNbrInExchState, ospfIntfLoop=ospfIntfLoop, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgBootpState=ipCurCfgBootpState, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripStatOutPkts=ripStatOutPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfBackup=ospfIntfBackup, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgState=ripCurCfgState, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOper=vrrpOper, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpGeneral=vrrpGeneral, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgSupply=ripNewCfgSupply, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaTxHello=ospfAreaTxHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoIndx=ipRouteInfoIndx, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfHello=ospfIntfHello, ospfAreaNbrStart=ospfAreaNbrStart, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfHello=ospfCumIntfHello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwIndex=ipNewCfgGwIndex, ripStatInPkts=ripStatInPkts, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfStats=ospfStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfChangeStats=ospfIntfChangeStats, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfState=ipCurCfgIntfState, ripNewCfgState=ripNewCfgState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoEntry=ipRouteInfoEntry)
