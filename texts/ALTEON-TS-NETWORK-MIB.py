...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoFlag=arpInfoFlag, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgGwDelete=ipNewCfgGwDelete, routerLSALinkData=routerLSALinkData, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaChangeStats=ospfAreaChangeStats, ripNewCfgSupply=ripNewCfgSupply, routeStats=routeStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfStats=ospfStats, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwArp=ipNewCfgGwArp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumRxHello=ospfCumRxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpStatHighWater=arpStatHighWater, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routeStatHighWater=routeStatHighWater, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwTable=ipNewCfgGwTable, vrrpGeneral=vrrpGeneral, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgVip=ripNewCfgVip, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrStart=ospfCumNbrStart, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfIndex=ospfIntfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgGwTable=ipCurCfgGwTable, ipForward=ipForward, ipInterfaceTableMax=ipInterfaceTableMax, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgState=ripCurCfgState, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCfg=ospfCfg, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripCurCfgListen=ripCurCfgListen, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoIndx=ipRouteInfoIndx, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgListen=ripNewCfgListen, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpStats=vrrpStats, iprouting=iprouting, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumRxPkts=ospfCumRxPkts, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTmrsKckOffHello=ospfTmrsKckOffHello, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ip_info=ip_info, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipRouteInfoMask=ipRouteInfoMask, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrStart=ospfAreaNbrStart, ospfProcessUptime=ospfProcessUptime, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfinfo=ospfinfo, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgGwArp=ipCurCfgGwArp, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwInterval=ipNewCfgGwInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpStatMaxEntries=arpStatMaxEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumIntfDown=ospfCumIntfDown, ripStats=ripStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgIntfState=ipCurCfgIntfState, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrp_info=vrrp_info, ospfHostTableMaxSize=ospfHostTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfLoop=ospfIntfLoop, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumNbrhello=ospfCumNbrhello, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgState=ipFwdNewCfgState, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfBackup=ospfIntfBackup, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripStatInPkts=ripStatInPkts, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxPkts=ospfAreaTxPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpInfoDestIp=arpInfoDestIp, vrrpOper=vrrpOper, ipCurCfgGwMetric=ipCurCfgGwMetric, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrDown=ospfIntfNbrDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfArea=ospfArea, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaInfoId=ospfAreaInfoId, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaTxHello=ospfAreaTxHello, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumTxPkts=ospfCumTxPkts, ospfAreaInfoEntry=ospfAreaInfoEntry, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfInfoTable=ospfIntfInfoTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpInfoEntry=arpInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpStats=arpStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfGeneralStats=ospfGeneralStats, arpInfoSrcPort=arpInfoSrcPort, ospfIntfDown=ospfIntfDown, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripNewCfgState=ripNewCfgState, routerLSAAreaIndex=routerLSAAreaIndex, routerLSAId=routerLSAId, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrp=vrrp, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfNbrStart=ospfIntfNbrStart, ripConfig=ripConfig, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoType=ipRouteInfoType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxDatabase=ospfCumTxDatabase, ripCurCfgVip=ripCurCfgVip, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipGatewayTableMax=ipGatewayTableMax, arpStatEntries=arpStatEntries, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfGeneral=ospfGeneral, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwState=ipNewCfgGwState)
