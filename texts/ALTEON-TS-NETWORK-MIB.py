...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumRxHello=ospfCumRxHello, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfTxDatabase=ospfIntfTxDatabase, arpInfoTable=arpInfoTable, dnsStats=dnsStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoMask=ipRouteInfoMask, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxDatabase=ospfIntfRxDatabase, ipForward=ipForward, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipInterfaceTableMax=ipInterfaceTableMax, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumIntfDown=ospfCumIntfDown, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, arpStatEntries=arpStatEntries, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfLoop=ospfCumIntfLoop, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfHello=ospfIntfHello, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTotalNeighbours=ospfTotalNeighbours, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgListen=ripCurCfgListen, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ip_info=ip_info, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoEntry=arpInfoEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfArea=ospfArea, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgBootpState=ipNewCfgBootpState, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpStats=vrrpStats, ospfinfo=ospfinfo, ospfInterface=ospfInterface, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrDown=ospfIntfNbrDown, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrp=vrrp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfStats=ospfStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripConfig=ripConfig, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, routeStatEntries=routeStatEntries, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfProcessUptime=ospfProcessUptime, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfMask=ipNewCfgIntfMask, ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, arpStatMaxEntries=arpStatMaxEntries, ripStatInPkts=ripStatInPkts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfDown=ospfIntfDown, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routeStats=routeStats, ipNewCfgGwState=ipNewCfgGwState, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgStaticSupply=ripNewCfgStaticSupply)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTotalAreas=ospfTotalAreas, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfGeneral=ospfGeneral, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxPkts=ospfCumRxPkts, ospfIntfLoop=ospfIntfLoop, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxTxStats=ospfAreaRxTxStats, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfHello=ospfCumIntfHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, iprouting=iprouting, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripStatOutPkts=ripStatOutPkts, ospfIntfTxPkts=ospfIntfTxPkts, ripNewCfgState=ripNewCfgState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoType=ipRouteInfoType, routerLSALinkData=routerLSALinkData, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrIndex=ospfAreaNbrIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaInfoTable=ospfAreaInfoTable, arpStats=arpStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routeStatHighWater=routeStatHighWater, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpStatHighWater=arpStatHighWater, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpGeneral=vrrpGeneral, ripStats=ripStats, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrDown=ospfCumNbrDown, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaTxHello=ospfAreaTxHello, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoTable=ipRouteInfoTable, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrp_info=vrrp_info, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, routeStatMaxEntries=routeStatMaxEntries, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routerLSAId=routerLSAId, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripCurCfgVip=ripCurCfgVip)
