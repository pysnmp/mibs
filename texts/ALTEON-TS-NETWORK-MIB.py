...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgIntfMask=ipCurCfgIntfMask, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumRxPkts=ospfCumRxPkts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfinfo=ospfinfo, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumRxHello=ospfCumRxHello, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoIndx=ipRouteInfoIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfWaitInterval=ospfIfWaitInterval, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfStats=ospfStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoTable=arpInfoTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, arpStatHighWater=arpStatHighWater, ospfTotalAreas=ospfTotalAreas, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfTxHello=ospfIntfTxHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfInfoTable=ospfIntfInfoTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumNbrStart=ospfCumNbrStart, ospfGeneralStats=ospfGeneralStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipRouteInfoTag=ipRouteInfoTag, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpOper=vrrpOper, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNbrInFullState=ospfNbrInFullState, arpInfoFlag=arpInfoFlag, routeStats=routeStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfInterface=ospfInterface, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaInfoId=ospfAreaInfoId, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxDatabase=ospfAreaRxDatabase, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfChangeStats=ospfIntfChangeStats, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgGwMetric=ipNewCfgGwMetric, dnsStats=dnsStats, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwTable=ipNewCfgGwTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwState=ipNewCfgGwState, ospfCumTxHello=ospfCumTxHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routeStatHighWater=routeStatHighWater, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpGeneral=vrrpGeneral, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripStatInPkts=ripStatInPkts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoEntry=arpInfoEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgState=ripNewCfgState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, iprouting=iprouting, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfDown=ospfAreaIntfDown, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpStats=vrrpStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routeStatEntries=routeStatEntries, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfBackup=ospfIntfBackup, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgListen=ripNewCfgListen, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripStats=ripStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipRouteInfoMask=ipRouteInfoMask, arpInfoMacAddr=arpInfoMacAddr, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfStartTime=ospfStartTime, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfTxDatabase=ospfIntfTxDatabase, arpStatEntries=arpStatEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routerLSALinkData=routerLSALinkData, ipRouteInfoEntry=ipRouteInfoEntry, ripCurCfgState=ripCurCfgState, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxHello=ospfIntfRxHello, routerLSAId=routerLSAId, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, arpStats=arpStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfHello=ospfIntfHello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrp=vrrp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfIndex=ospfIntfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgVip=ripCurCfgVip, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfBackup=ospfCumIntfBackup, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrp_info=vrrp_info, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfDown=ospfIntfDown, ip_info=ip_info, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoDestIp=arpInfoDestIp, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfGeneral=ospfGeneral, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfArea=ospfArea, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCfg=ospfCfg, ospfAreaChangeStats=ospfAreaChangeStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ipForward=ipForward, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfGeneralInfo=ospfGeneralInfo, ripStatOutPkts=ripStatOutPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTimersKickOffStats=ospfTimersKickOffStats, ripConfig=ripConfig, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwState=ipCurCfgGwState, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumIntfHello=ospfCumIntfHello, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex)
