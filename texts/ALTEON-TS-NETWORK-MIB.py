...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrStart=ospfCumNbrStart, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpStatInAdvers=vrrpStatInAdvers, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrp=vrrp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ospfProcessUptime=ospfProcessUptime, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfArea=ospfArea, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ip_info=ip_info, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpOper=vrrpOper, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfUnloop=ospfIntfUnloop, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwTable=ipCurCfgGwTable, ospfInterface=ospfInterface, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoTag=ipRouteInfoTag, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfinfo=ospfinfo, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgState=ripCurCfgState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgGwIndex=ipCurCfgGwIndex, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfHello=ospfIntfHello, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpStatMaxEntries=arpStatMaxEntries, ospfGeneral=ospfGeneral, arpInfoTable=arpInfoTable, iprouting=iprouting, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpStats=vrrpStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCfg=ospfCfg, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpStats=arpStats, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoDestIp=arpInfoDestIp, arpStatEntries=arpStatEntries, ripStatInPkts=ripStatInPkts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoFlag=arpInfoFlag, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripStats=ripStats, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ipGatewayTableMax=ipGatewayTableMax, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrp_info=vrrp_info, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoMask=ipRouteInfoMask, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpInfoSrcPort=arpInfoSrcPort, ripNewCfgSupply=ripNewCfgSupply, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfGeneralStats=ospfGeneralStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTotalTransitAreas=ospfTotalTransitAreas, ipForward=ipForward, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routeStatHighWater=routeStatHighWater, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgBootpState=ipNewCfgBootpState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTotalNeighbours=ospfTotalNeighbours, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfBackup=ospfCumIntfBackup)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfBackup=ospfIntfBackup, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumRxHello=ospfCumRxHello, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfStartTime=ospfStartTime, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxDatabase=ospfAreaRxDatabase, routeStats=routeStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipInterfaceTableMax=ipInterfaceTableMax, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routerLSAId=routerLSAId, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgGwState=ipCurCfgGwState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrhello=ospfCumNbrhello, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpGeneral=vrrpGeneral, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwEntry=ipCurCfgGwEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfTxHello=ospfIntfTxHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, dnsStats=dnsStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripStatOutPkts=ripStatOutPkts, ospfAreaRxHello=ospfAreaRxHello, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routerLSALinkID=routerLSALinkID, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routeStatEntries=routeStatEntries, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwState=ipNewCfgGwState, ospfIntfDown=ospfIntfDown, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfLsTypesSupported=ospfLsTypesSupported, ripCurCfgVip=ripCurCfgVip, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgState=ripNewCfgState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumTxHello=ospfCumTxHello, ospfTimersKickOffStats=ospfTimersKickOffStats, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwRetry=ipCurCfgGwRetry, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfStats=ospfStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfLoop=ospfIntfLoop, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpStatHighWater=arpStatHighWater, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod)
