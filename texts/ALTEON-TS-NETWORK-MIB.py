...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfBackup=ospfIntfBackup, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfLsTypesSupported=ospfLsTypesSupported, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfLoop=ospfIntfLoop, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumTxDatabase=ospfCumTxDatabase, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrN1way=ospfAreaNbrN1way, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIfWaitInterval=ospfIfWaitInterval, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaInfoTable=ospfAreaInfoTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoVLAN=arpInfoVLAN, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgState=ipFwdNewCfgState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoEntry=arpInfoEntry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrStart=ospfIntfNbrStart, routerLSALinkData=routerLSALinkData, ospfInterface=ospfInterface, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwState=ipCurCfgGwState, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNbrInInitState=ospfNbrInInitState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxHello=ospfIntfRxHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfChangeStats=ospfIntfChangeStats, ripStatInPkts=ripStatInPkts, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripCurCfgState=ripCurCfgState, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfProcessUptime=ospfProcessUptime, arpStatHighWater=arpStatHighWater, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwInterval=ipCurCfgGwInterval, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfGeneralInfo=ospfGeneralInfo, ripCurCfgSupply=ripCurCfgSupply, ospfStats=ospfStats, ospfAreaInfoId=ospfAreaInfoId, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaChangeStats=ospfAreaChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpStats=arpStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfGeneralStats=ospfGeneralStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfIndex=ospfIntfIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfNbrInFullState=ospfNbrInFullState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgVip=ripCurCfgVip, ipForward=ipForward, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxHello=ospfCumTxHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripNewCfgState=ripNewCfgState, ospfAreaRxHello=ospfAreaRxHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStatInAdvers=vrrpStatInAdvers, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripNewCfgSupply=ripNewCfgSupply, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, iprouting=iprouting, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, dnsStats=dnsStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwEntry=ipCurCfgGwEntry, ripNewCfgVip=ripNewCfgVip, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumRxTxStats=ospfCumRxTxStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, routeStatEntries=routeStatEntries, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfArea=ospfArea, ospfNewCfgAreaId=ospfNewCfgAreaId, ipRouteInfoTable=ipRouteInfoTable, arpInfoTable=arpInfoTable, routeStats=routeStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoType=ipRouteInfoType, routerLSAId=routerLSAId, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfinfo=ospfinfo, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfDown=ospfCumIntfDown, ospfStartTime=ospfStartTime, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaTxHello=ospfAreaTxHello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrStart=ospfCumNbrStart, vrrpOper=vrrpOper, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoFlag=arpInfoFlag, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfMask=ipNewCfgIntfMask, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrChange=ospfIntfNbrChange, vrrp=vrrp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routerLSALinkID=routerLSALinkID, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCfg=ospfCfg, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routeStatHighWater=routeStatHighWater, ip_info=ip_info, ospfIntfDown=ospfIntfDown, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripConfig=ripConfig, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrhello=ospfAreaNbrhello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripStats=ripStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNbrInExchState=ospfNbrInExchState, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpStatEntries=arpStatEntries, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc)
