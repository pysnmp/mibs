...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrStart=ospfCumNbrStart, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNbrInInitState=ospfNbrInInitState, ripStatOutPkts=ripStatOutPkts, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, routerLSALinkID=routerLSALinkID, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxPkts=ospfAreaRxPkts, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, routeStatHighWater=routeStatHighWater, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routeStatEntries=routeStatEntries, ospfAreaIntfHello=ospfAreaIntfHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routerLSALinkData=routerLSALinkData, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgGwState=ipCurCfgGwState, ospfGeneral=ospfGeneral, ospfIntfRxHello=ospfIntfRxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripConfig=ripConfig, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, iprouting=iprouting, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoFlag=arpInfoFlag, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpInfoTable=arpInfoTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpStats=arpStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrStart=ospfAreaNbrStart, arpStatMaxEntries=arpStatMaxEntries, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumTxHello=ospfCumTxHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfinfo=ospfinfo, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpOper=vrrpOper, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgVip=ripNewCfgVip, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfStartTime=ospfStartTime, routerLSAId=routerLSAId, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumRxTxStats=ospfCumRxTxStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfBackup=ospfIntfBackup, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaRxDatabase=ospfAreaRxDatabase, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripNewCfgState=ripNewCfgState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfGeneralStats=ospfGeneralStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfProcessUptime=ospfProcessUptime, ip_info=ip_info, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfLoop=ospfCumIntfLoop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, dnsStats=dnsStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNbrInExchState=ospfNbrInExchState, ospfIntfInfoTable=ospfIntfInfoTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpInfoEntry=arpInfoEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoEntry=ipRouteInfoEntry, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgGwState=ipNewCfgGwState, vrrp=vrrp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgDefListen=ripCurCfgDefListen, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxHello=ospfCumRxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfDown=ospfAreaIntfDown, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfHello=ospfIntfHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripStatInPkts=ripStatInPkts, ripCurCfgVip=ripCurCfgVip, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalAreas=ospfTotalAreas, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfInterface=ospfInterface, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpGeneral=vrrpGeneral, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNbrInFullState=ospfNbrInFullState, arpStatEntries=arpStatEntries, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrDown=ospfIntfNbrDown, ripStats=ripStats, ospfArea=ospfArea, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwEntry=ipCurCfgGwEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfLoop=ospfIntfLoop, routeStats=routeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrhello=ospfCumNbrhello, vrrp_info=vrrp_info, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfStats=ospfStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routeStatMaxEntries=routeStatMaxEntries, arpStatHighWater=arpStatHighWater, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipRouteInfoTable=ipRouteInfoTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ipForward=ipForward, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer)
