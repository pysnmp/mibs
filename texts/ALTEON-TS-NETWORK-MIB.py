...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfLsTypesSupported=ospfLsTypesSupported, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfGeneralStats=ospfGeneralStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwState=ipCurCfgGwState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrp=vrrp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrN1way=ospfAreaNbrN1way, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgBootpState=ipNewCfgBootpState, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoInterface=ipRouteInfoInterface, routerLSALinkIndex=routerLSALinkIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrRstAd=ospfCumNbrRstAd, arpStatHighWater=arpStatHighWater, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ip_info=ip_info, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOper=vrrpOper, ipNewCfgIntfState=ipNewCfgIntfState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaTxHello=ospfAreaTxHello, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfArea=ospfArea, ripNewCfgVip=ripNewCfgVip, ospfInterface=ospfInterface, ripCurCfgVip=ripCurCfgVip, ospfCumNbrDown=ospfCumNbrDown, ospfNbrInInitState=ospfNbrInInitState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumIntfHello=ospfCumIntfHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpStats=vrrpStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoGateway=ipRouteInfoGateway, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipForward=ipForward, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgListen=ripNewCfgListen, arpInfoRefPorts=arpInfoRefPorts, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCfg=ospfCfg, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfLoop=ospfIntfLoop, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, iprouting=iprouting, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfStats=ospfStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfHello=ospfIntfHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaRxHello=ospfAreaRxHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrp_info=vrrp_info, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripStatOutPkts=ripStatOutPkts, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTotalNeighbours=ospfTotalNeighbours, vrrpGeneral=vrrpGeneral, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripStatInErrorPkts=ripStatInErrorPkts, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfTotalAreas=ospfTotalAreas, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfChangeStats=ospfIntfChangeStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripNewCfgState=ripNewCfgState, ospfIntfIndex=ospfIntfIndex, arpStatEntries=arpStatEntries, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripConfig=ripConfig, ipNewCfgGwDelete=ipNewCfgGwDelete, ipInterfaceTableMax=ipInterfaceTableMax, ospfNbrInFullState=ospfNbrInFullState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfRxHello=ospfIntfRxHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, routeStats=routeStats, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfDown=ospfIntfDown, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripStats=ripStats, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routeStatHighWater=routeStatHighWater, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routerLSAId=routerLSAId, arpInfoEntry=arpInfoEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoTable=arpInfoTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpStats=arpStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, dnsStats=dnsStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgAreaId=ospfNewCfgAreaId, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNbrInExchState=ospfNbrInExchState, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgState=ripCurCfgState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrStart=ospfIntfNbrStart, routerLSALinkID=routerLSALinkID, ospfIntfRxPkts=ospfIntfRxPkts, ospfinfo=ospfinfo, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routeStatMaxEntries=routeStatMaxEntries, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfProcessUptime=ospfProcessUptime, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routeStatEntries=routeStatEntries, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType)
