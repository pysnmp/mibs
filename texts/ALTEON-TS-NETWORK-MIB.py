...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxDatabase=ospfIntfRxDatabase, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSAId=routerLSAId, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripConfig=ripConfig, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, routerLSALinkID=routerLSALinkID, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoDestIp=arpInfoDestIp, ipRouteInfoTable=ipRouteInfoTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripCurCfgListen=ripCurCfgListen, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoEntry=arpInfoEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfHello=ospfIntfHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpStatMaxEntries=arpStatMaxEntries, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfState=ipNewCfgIntfState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgGwInterval=ipNewCfgGwInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwInterval=ipCurCfgGwInterval, arpInfoFlag=arpInfoFlag, ipNewCfgGwVlan=ipNewCfgGwVlan, ipGatewayTableMax=ipGatewayTableMax, ospfInterface=ospfInterface, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumIntfDown=ospfCumIntfDown, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routeStatEntries=routeStatEntries, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpInfoVLAN=arpInfoVLAN, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOper=vrrpOper, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpStatHighWater=arpStatHighWater, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, dnsStats=dnsStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumTxHello=ospfCumTxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalNssaAreas=ospfTotalNssaAreas, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfGeneralInfo=ospfGeneralInfo, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgIntfState=ipCurCfgIntfState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrp_info=vrrp_info, routerLSALinkIndex=routerLSALinkIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrN1way=ospfAreaNbrN1way)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfStartTime=ospfStartTime, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfGeneralStats=ospfGeneralStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfTxHello=ospfIntfTxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpGeneral=vrrpGeneral, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoSrcPort=arpInfoSrcPort, ipForward=ipForward, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfGeneral=ospfGeneral, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfArea=ospfArea, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrp=vrrp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripNewCfgState=ripNewCfgState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpStats=arpStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxHello=ospfCumRxHello, ospfAreaTxHello=ospfAreaTxHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, iprouting=iprouting, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfUnloop=ospfIntfUnloop, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNbrInInitState=ospfNbrInInitState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgVip=ripNewCfgVip, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfinfo=ospfinfo, ospfTotalAreas=ospfTotalAreas, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfIndex=ospfIntfIndex, ospfLsTypesSupported=ospfLsTypesSupported, ripCurCfgState=ripCurCfgState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpInfoRefPorts=arpInfoRefPorts, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripStats=ripStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ip_info=ip_info, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ripStatOutPkts=ripStatOutPkts, ospfIfInfoIndex=ospfIfInfoIndex, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxPkts=ospfCumRxPkts, routeStats=routeStats, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgVip=ripCurCfgVip, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpStatEntries=arpStatEntries, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrChangeStats=ospfCumNbrChangeStats)
