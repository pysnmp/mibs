...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrhello=ospfCumNbrhello, ip_info=ip_info, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpStatOutAdvers=vrrpStatOutAdvers, routeStatEntries=routeStatEntries, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipGatewayTableMax=ipGatewayTableMax, ipRouteInfoTag=ipRouteInfoTag, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfInterface=ospfInterface, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfStartTime=ospfStartTime, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfStats=ospfStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfArea=ospfArea, ospfIntfInfoTable=ospfIntfInfoTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxTxStats=ospfAreaRxTxStats, iprouting=iprouting, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfProcessUptime=ospfProcessUptime, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrStart=ospfIntfNbrStart, ospfinfo=ospfinfo, ipRouteInfoType=ipRouteInfoType, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoSrcPort=arpInfoSrcPort, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpStatEntries=arpStatEntries, ripNewCfgListen=ripNewCfgListen, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfLsTypesSupported=ospfLsTypesSupported, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripStatInPkts=ripStatInPkts, ripCurCfgVip=ripCurCfgVip, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfState=ipNewCfgIntfState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routeStatHighWater=routeStatHighWater, ospfAreaRxHello=ospfAreaRxHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfChangeStats=ospfIntfChangeStats, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpGeneral=vrrpGeneral, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfGeneralStats=ospfGeneralStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpInfoDestIp=arpInfoDestIp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpInfoEntry=arpInfoEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipForward=ipForward, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoTable=ipRouteInfoTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaTxPkts=ospfAreaTxPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpOper=vrrpOper, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripNewCfgState=ripNewCfgState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpInfoVLAN=arpInfoVLAN, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripStats=ripStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSALinkData=routerLSALinkData, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routerLSAId=routerLSAId, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routeStatMaxEntries=routeStatMaxEntries, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumRxlsUpdates=ospfCumRxlsUpdates)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfDown=ospfCumIntfDown, ospfIntfDown=ospfIntfDown, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwState=ipCurCfgGwState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrp=vrrp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoId=ospfAreaInfoId, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrStart=ospfCumNbrStart, vrrpStats=vrrpStats, ospfCfg=ospfCfg, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfHello=ospfIntfHello, ripConfig=ripConfig, ipCurCfgGwArp=ipCurCfgGwArp, arpStats=arpStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpInfoFlag=arpInfoFlag, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaIntfBackup=ospfAreaIntfBackup, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoMask=ipRouteInfoMask, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgListen=ripCurCfgListen, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwState=ipNewCfgGwState, routeStats=routeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, dnsStats=dnsStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTxHello=ospfAreaTxHello, ripStatInErrorPkts=ripStatInErrorPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSALinkID=routerLSALinkID, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse)
