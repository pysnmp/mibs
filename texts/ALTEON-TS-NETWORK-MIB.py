...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumRxTxStats=ospfCumRxTxStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ip_info=ip_info, ospfCumNbrDown=ospfCumNbrDown, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwArp=ipNewCfgGwArp, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipForward=ipForward, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumNbrhello=ospfCumNbrhello, ospfCumRxHello=ospfCumRxHello, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, routerLSAId=routerLSAId, ospfTotalNeighbours=ospfTotalNeighbours, ospfStats=ospfStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpInfoEntry=arpInfoEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxHello=ospfIntfRxHello, dnsStats=dnsStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfHello=ospfAreaIntfHello, ripStatInPkts=ripStatInPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routeStats=routeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgState=ripNewCfgState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripCurCfgListen=ripCurCfgListen, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpGeneral=vrrpGeneral, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenState=vrrpNewCfgGenState, arpStatHighWater=arpStatHighWater, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumTxPkts=ospfCumTxPkts, ospfIntfHello=ospfIntfHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfDown=ospfAreaIntfDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpStatEntries=arpStatEntries, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripStats=ripStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, routerLSAAreaIndex=routerLSAAreaIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNbrInFullState=ospfNbrInFullState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipRouteInfoType=ipRouteInfoType, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, iprouting=iprouting, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwState=ipNewCfgGwState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfDown=ospfCumIntfDown, ospfIntfDown=ospfIntfDown, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwAddr=ipCurCfgGwAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrStart=ospfIntfNbrStart, arpStats=arpStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrp=vrrp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfLoop=ospfIntfLoop, ospfStartTime=ospfStartTime, vrrp_info=vrrp_info, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfInterface=ospfInterface, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCfg=ospfCfg, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpOper=vrrpOper, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfGeneral=ospfGeneral, ipCurCfgIntfState=ipCurCfgIntfState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripConfig=ripConfig, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, ospfCumTxDatabase=ospfCumTxDatabase, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routeStatHighWater=routeStatHighWater, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripStatOutPkts=ripStatOutPkts, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTotalAreas=ospfTotalAreas, ospfinfo=ospfinfo, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfLoop=ospfAreaIntfLoop, ipRouteInfoTable=ipRouteInfoTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoEntry=ipRouteInfoEntry, vrrpStats=vrrpStats, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumRxDatabase=ospfCumRxDatabase, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfArea=ospfArea, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfIndex=ospfIntfIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routerLSALinkData=routerLSALinkData, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoDestIp=arpInfoDestIp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfProcessUptime=ospfProcessUptime, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfChangeStats=ospfIntfChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgGwTable=ipNewCfgGwTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpInfoVLAN=arpInfoVLAN, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry)
