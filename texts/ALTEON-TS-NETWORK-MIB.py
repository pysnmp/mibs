...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfProcessUptime=ospfProcessUptime, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ripCurCfgListen=ripCurCfgListen, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpOper=vrrpOper, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipGatewayTableMax=ipGatewayTableMax, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfinfo=ospfinfo, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwTable=ipNewCfgGwTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfGeneral=ospfGeneral, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfStartTime=ospfStartTime, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfGeneralStats=ospfGeneralStats, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgBootpState=ipCurCfgBootpState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripCurCfgVip=ripCurCfgVip, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoEntry=arpInfoEntry, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStats=ripStats, vrrp=vrrp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrStart=ospfAreaNbrStart, arpStats=arpStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfArea=ospfArea, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumTxHello=ospfCumTxHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ip_info=ip_info, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfDown=ospfIntfDown, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwRetry=ipNewCfgGwRetry, routeStatEntries=routeStatEntries, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrDown=ospfCumNbrDown, ospfCfg=ospfCfg, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripConfig=ripConfig, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoInterface=ipRouteInfoInterface, ripNewCfgState=ripNewCfgState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfBackup=ospfIntfBackup, routerLSALinkID=routerLSALinkID, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoMask=ipRouteInfoMask, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routerLSALinkData=routerLSALinkData, arpInfoDestIp=arpInfoDestIp, ipForward=ipForward, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpInfoFlag=arpInfoFlag)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumTxlsReqs=ospfCumTxlsReqs, ripNewCfgListen=ripNewCfgListen, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfStats=ospfStats, ospfAreaNbrIndex=ospfAreaNbrIndex, arpStatHighWater=arpStatHighWater, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpInfoRefPorts=arpInfoRefPorts, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrhello=ospfAreaNbrhello, iprouting=iprouting, dnsStats=dnsStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfInterface=ospfInterface, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfLoop=ospfIntfLoop, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrp_info=vrrp_info, ripNewCfgVip=ripNewCfgVip, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpGeneral=vrrpGeneral, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfIndex=ospfIntfIndex, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoTable=arpInfoTable, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ripStatInPkts=ripStatInPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, routeStats=routeStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, arpStatEntries=arpStatEntries, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaChangeStats=ospfAreaChangeStats, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpStats=vrrpStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaInfoId=ospfAreaInfoId, ospfIntfHello=ospfIntfHello, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, routerLSAId=routerLSAId, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgGwState=ipNewCfgGwState, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenState=vrrpCurCfgGenState, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrN1way=ospfAreaNbrN1way, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrStart=ospfCumNbrStart, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfTotalAreas=ospfTotalAreas, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfTxHello=ospfIntfTxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfLsTypesSupported=ospfLsTypesSupported, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSAAreaIndex=routerLSAAreaIndex, ripCurCfgState=ripCurCfgState, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSALinkIndex=routerLSALinkIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx)
