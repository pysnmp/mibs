...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routeStats=routeStats, ospfTotalNeighbours=ospfTotalNeighbours, ospfInterface=ospfInterface, routerLSALinkData=routerLSALinkData, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpInfoEntry=arpInfoEntry, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTxPkts=ospfAreaTxPkts, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripNewCfgVip=ripNewCfgVip, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoTable=arpInfoTable, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfRxTxStats=ospfIntfRxTxStats, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrp=vrrp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfUnloop=ospfIntfUnloop, arpInfoSrcPort=arpInfoSrcPort, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgBootpState=ipNewCfgBootpState, routeStatHighWater=routeStatHighWater, ipRouteInfoTable=ipRouteInfoTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwState=ipNewCfgGwState, ip_info=ip_info, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxHello=ospfIntfTxHello, ripStats=ripStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipRouteInfoMask=ipRouteInfoMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfIndex=ospfIntfIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumRxHello=ospfCumRxHello, vrrpGeneral=vrrpGeneral, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgState=ripNewCfgState, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, ripConfig=ripConfig, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfLsTypesSupported=ospfLsTypesSupported, arpInfoDestIp=arpInfoDestIp, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIfInfoIndex=ospfIfInfoIndex, ospfinfo=ospfinfo, arpStatHighWater=arpStatHighWater, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoTag=ipRouteInfoTag, ospfIntfLoop=ospfIntfLoop, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripStatInPkts=ripStatInPkts, arpStats=arpStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpStatMaxEntries=arpStatMaxEntries, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwDelete=ipNewCfgGwDelete, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpOper=vrrpOper, ospfIntfRxHello=ospfIntfRxHello, ospfGeneralStats=ospfGeneralStats, ospfGeneral=ospfGeneral, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ospfCfg=ospfCfg, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfDown=ospfIntfDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripCurCfgState=ripCurCfgState, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpInfoFlag=arpInfoFlag, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumIntfBackup=ospfCumIntfBackup, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwTable=ipNewCfgGwTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoIndx=ipRouteInfoIndx, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, iprouting=iprouting, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfChangeStats=ospfIntfChangeStats, ospfArea=ospfArea, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumRxDatabase=ospfCumRxDatabase, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routerLSALinkID=routerLSALinkID, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, routerLSAAreaIndex=routerLSAAreaIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrDown=ospfAreaNbrDown, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrDown=ospfIntfNbrDown, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipForward=ipForward, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfHello=ospfIntfHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routerLSAId=routerLSAId, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNbrInInitState=ospfNbrInInitState, arpInfoVLAN=arpInfoVLAN, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfLoop=ospfCumIntfLoop, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumRxTxStats=ospfCumRxTxStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfStats=ospfStats, dnsStats=dnsStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfBackup=ospfIntfBackup, ripCurCfgVip=ripCurCfgVip, ospfNbrInExchState=ospfNbrInExchState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby)
