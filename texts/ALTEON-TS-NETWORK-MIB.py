...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgGwState=ipCurCfgGwState, arpStatEntries=arpStatEntries, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaTxHello=ospfAreaTxHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrChange=ospfIntfNbrChange, arpStats=arpStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaRxHello=ospfAreaRxHello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoMacAddr=arpInfoMacAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ip_info=ip_info, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripStatInPkts=ripStatInPkts, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfBackup=ospfIntfBackup, ripConfig=ripConfig, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpOper=vrrpOper, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfGeneralInfo=ospfGeneralInfo, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgState=ripNewCfgState, ospfInterface=ospfInterface, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumNbrN1way=ospfCumNbrN1way, ospfNbrInFullState=ospfNbrInFullState, ipForward=ipForward, ospfCumNbrStart=ospfCumNbrStart, ospfIntfUnloop=ospfIntfUnloop, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfGeneral=ospfGeneral, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgGwTable=ipCurCfgGwTable, routerLSAId=routerLSAId, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, routeStatHighWater=routeStatHighWater, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrDown=ospfCumNbrDown, arpInfoFlag=arpInfoFlag, ipNewCfgGwTable=ipNewCfgGwTable, arpStatMaxEntries=arpStatMaxEntries, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfLoop=ospfIntfLoop, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpInfoTable=arpInfoTable, ospfCumIntfDown=ospfCumIntfDown, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripStatInErrorPkts=ripStatInErrorPkts, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxDatabase=ospfIntfRxDatabase, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfDown=ospfIntfDown, ospfCumIntfHello=ospfCumIntfHello, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoTable=ipRouteInfoTable, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfIndex=ospfIntfIndex, routeStats=routeStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpInfoDestIp=arpInfoDestIp, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripCurCfgState=ripCurCfgState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxPkts=ospfIntfRxPkts, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxHello=ospfCumRxHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrDown=ospfAreaNbrDown, ospfGeneralStats=ospfGeneralStats, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfStats=ospfStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoTag=ipRouteInfoTag, ospfStartTime=ospfStartTime, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfArea=ospfArea, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumTxlsAcks=ospfCumTxlsAcks, arpStatHighWater=arpStatHighWater, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalAreas=ospfTotalAreas, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrhello=ospfCumNbrhello, vrrp=vrrp, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpStats=vrrpStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripNewCfgListen=ripNewCfgListen, arpInfoSrcPort=arpInfoSrcPort, ipRouteInfoIndx=ipRouteInfoIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripStats=ripStats, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfEntry=ipCurCfgIntfEntry, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgIntfState=ipNewCfgIntfState, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSALinkID=routerLSALinkID, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumRxPkts=ospfCumRxPkts, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpInfoEntry=arpInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgVip=ripCurCfgVip, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, iprouting=iprouting, ospfCumTxHello=ospfCumTxHello, ospfAreaIntfHello=ospfAreaIntfHello, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfinfo=ospfinfo, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCfg=ospfCfg, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwMetric=ipCurCfgGwMetric, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoMask=ipRouteInfoMask)
