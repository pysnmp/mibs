...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfinfo=ospfinfo, vrrpStatOutAdvers=vrrpStatOutAdvers, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrN1way=ospfAreaNbrN1way, routeStatHighWater=routeStatHighWater, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipGatewayTableMax=ipGatewayTableMax, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaTxlsReqs=ospfAreaTxlsReqs, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumIntfHello=ospfCumIntfHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxHello=ospfCumRxHello, ospfIntfRxPkts=ospfIntfRxPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSAAreaIndex=routerLSAAreaIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrDown=ospfAreaNbrDown, ospfCfg=ospfCfg, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgBootpState=ipCurCfgBootpState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipForward=ipForward, ipCurCfgGwInterval=ipCurCfgGwInterval, arpInfoDestIp=arpInfoDestIp, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgGwState=ipCurCfgGwState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfUnloop=ospfIntfUnloop, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpStats=vrrpStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgListen=ripNewCfgListen, arpStatHighWater=arpStatHighWater, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipRouteInfoType=ipRouteInfoType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpGeneral=vrrpGeneral, ospfLsTypesSupported=ospfLsTypesSupported, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipRouteInfoInterface=ipRouteInfoInterface, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaRxPkts=ospfAreaRxPkts, ip_info=ip_info, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumTxPkts=ospfCumTxPkts, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfDown=ospfCumIntfDown, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfTxPkts=ospfIntfTxPkts, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumRxPkts=ospfCumRxPkts, ospfProcessUptime=ospfProcessUptime, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrp_info=vrrp_info, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgState=ripCurCfgState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routerLSAId=routerLSAId, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrp=vrrp, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrhello=ospfCumNbrhello, ospfIntfLoop=ospfIntfLoop, arpInfoFlag=arpInfoFlag, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfRxHello=ospfIntfRxHello, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfInfoTable=ospfIntfInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfArea=ospfArea, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpStatInAdvers=vrrpStatInAdvers, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripStats=ripStats, ospfTotalAreas=ospfTotalAreas, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripConfig=ripConfig, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpStats=arpStats, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfInterface=ospfInterface, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpInfoRefPorts=arpInfoRefPorts, dnsStats=dnsStats, ipCurCfgGwArp=ipCurCfgGwArp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripStatOutPkts=ripStatOutPkts, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgGwRetry=ipCurCfgGwRetry, iprouting=iprouting, ospfAreaNbrStart=ospfAreaNbrStart, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpStatEntries=arpStatEntries, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfGeneral=ospfGeneral, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, routerLSALinkID=routerLSALinkID, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTxPkts=ospfAreaTxPkts, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgVip=ripCurCfgVip, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkData=routerLSALinkData, routeStatEntries=routeStatEntries, routerLSALinkIndex=routerLSALinkIndex, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgState=ripNewCfgState, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoEntry=arpInfoEntry, ripNewCfgVip=ripNewCfgVip, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripStatInPkts=ripStatInPkts, arpInfoTable=arpInfoTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routeStats=routeStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxlsReqs=ospfAreaRxlsReqs, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfBackup=ospfIntfBackup, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfStats=ospfStats, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP)
