...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxHello=ospfAreaTxHello, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpStatHighWater=arpStatHighWater, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routeStatHighWater=routeStatHighWater, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpInfoVLAN=arpInfoVLAN, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfinfo=ospfinfo, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumIntfHello=ospfCumIntfHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfHello=ospfIntfHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxPkts=ospfIntfRxPkts, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpStats=vrrpStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumTxPkts=ospfCumTxPkts, ripStatOutPkts=ripStatOutPkts, ipCurCfgIntfState=ipCurCfgIntfState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfDown=ospfIntfDown, vrrpStatInAdvers=vrrpStatInAdvers, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routeStatEntries=routeStatEntries, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripConfig=ripConfig, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routerLSAId=routerLSAId, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, dnsStats=dnsStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routerLSALinkID=routerLSALinkID, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfGeneral=ospfGeneral, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTotalAreas=ospfTotalAreas, ospfAreaRxDatabase=ospfAreaRxDatabase, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgState=ripNewCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfLsTypesSupported=ospfLsTypesSupported, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpInfoEntry=arpInfoEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwEntry=ipNewCfgGwEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumRxPkts=ospfCumRxPkts, ospfArea=ospfArea, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpStats=arpStats, ospfNbrInInitState=ospfNbrInInitState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpStatEntries=arpStatEntries, ospfInterface=ospfInterface, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpInfoDestIp=arpInfoDestIp, ripStats=ripStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCfg=ospfCfg, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ip_info=ip_info, routeStats=routeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripNewCfgSupply=ripNewCfgSupply, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrp_info=vrrp_info, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfState=ipNewCfgIntfState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfGeneralStats=ospfGeneralStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripCurCfgVip=ripCurCfgVip, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipInterfaceTableMax=ipInterfaceTableMax, iprouting=iprouting, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, routerLSALinkData=routerLSALinkData, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, routeStatMaxEntries=routeStatMaxEntries, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenState=vrrpCurCfgGenState, ripCurCfgState=ripCurCfgState, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumNbrStart=ospfCumNbrStart, ripNewCfgVip=ripNewCfgVip, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTxPkts=ospfIntfTxPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoType=ipRouteInfoType, ripNewCfgListen=ripNewCfgListen, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfGeneralInfo=ospfGeneralInfo, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripStatInPkts=ripStatInPkts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfStats=ospfStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoTable=arpInfoTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrp=vrrp, ipRouteInfoTable=ipRouteInfoTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumRxHello=ospfCumRxHello, ipRouteInfoMask=ipRouteInfoMask, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpOper=vrrpOper, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrhello=ospfCumNbrhello, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgAreaId=ospfNewCfgAreaId, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable)
