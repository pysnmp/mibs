...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripConfig=ripConfig, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfIndex=ospfIntfIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgListen=ripCurCfgListen, ospfIntfDown=ospfIntfDown, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSALinkData=routerLSALinkData, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfNbrInFullState=ospfNbrInFullState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoType=ipRouteInfoType, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgState=ripCurCfgState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrp=vrrp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpGeneral=vrrpGeneral, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipForward=ipForward, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaNbrhello=ospfAreaNbrhello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpOper=vrrpOper, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpStats=vrrpStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ip_info=ip_info, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgBootpState=ipNewCfgBootpState, iprouting=iprouting, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpInfoFlag=arpInfoFlag, ipGatewayTableMax=ipGatewayTableMax, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfGeneral=ospfGeneral, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfStats=ospfStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumRxHello=ospfCumRxHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaInfoTable=ospfAreaInfoTable, arpStats=arpStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipInterfaceTableMax=ipInterfaceTableMax, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStats=ripStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripCurCfgVip=ripCurCfgVip, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripStatInErrorPkts=ripStatInErrorPkts, ripStatOutPkts=ripStatOutPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfTotalAreas=ospfTotalAreas, routerLSALinkID=routerLSALinkID, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgSupply=ripNewCfgSupply, ospfArea=ospfArea, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, arpInfoVLAN=arpInfoVLAN, ospfAreaTxHello=ospfAreaTxHello, arpStatHighWater=arpStatHighWater, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaInfoId=ospfAreaInfoId, routerLSALinkIndex=routerLSALinkIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripStatInPkts=ripStatInPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfHello=ospfIntfHello, ospfIntfChangeStats=ospfIntfChangeStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, arpInfoEntry=arpInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipRouteInfoMask=ipRouteInfoMask, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaTxDatabase=ospfAreaTxDatabase, routerLSAId=routerLSAId, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routeStatEntries=routeStatEntries, arpInfoSrcPort=arpInfoSrcPort, ospfProcessUptime=ospfProcessUptime, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfStartTime=ospfStartTime, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpStatEntries=arpStatEntries, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routeStats=routeStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfGeneralStats=ospfGeneralStats, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgGwRetry=ipNewCfgGwRetry, arpInfoDestIp=arpInfoDestIp, ospfinfo=ospfinfo, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoTable=ipRouteInfoTable, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routeStatMaxEntries=routeStatMaxEntries, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaRxHello=ospfAreaRxHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrDown=ospfCumNbrDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, dnsStats=dnsStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgVip=ripNewCfgVip, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfTxHello=ospfIntfTxHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfInterface=ospfInterface, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgDefListen=ripNewCfgDefListen, ospfCfg=ospfCfg, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipRouteInfoIndx=ipRouteInfoIndx, ripNewCfgState=ripNewCfgState, ospfIntfLoop=ospfIntfLoop, ospfCumTxDatabase=ospfCumTxDatabase, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgGwTable=ipCurCfgGwTable)
