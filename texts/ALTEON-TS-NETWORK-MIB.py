...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoVLAN=arpInfoVLAN, ospfCumNbrN1way=ospfCumNbrN1way, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumRxHello=ospfCumRxHello, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaIntfHello=ospfAreaIntfHello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrp=vrrp, ipNewCfgGwState=ipNewCfgGwState, ipInterfaceTableMax=ipInterfaceTableMax, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routeStatMaxEntries=routeStatMaxEntries, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routerLSALinkID=routerLSALinkID, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrhello=ospfAreaNbrhello, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripCurCfgSupply=ripCurCfgSupply, ospfStats=ospfStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoType=ipRouteInfoType, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipForward=ipForward, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfArea=ospfArea, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfHello=ospfIntfHello, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNbrInExchState=ospfNbrInExchState, arpInfoTable=arpInfoTable, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfDown=ospfIntfDown, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfGeneralInfo=ospfGeneralInfo, ospfinfo=ospfinfo, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripNewCfgState=ripNewCfgState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routerLSALinkData=routerLSALinkData, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrDown=ospfCumNbrDown, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrChange=ospfIntfNbrChange, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripConfig=ripConfig, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfNbrInFullState=ospfNbrInFullState, ospfInterface=ospfInterface, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumIntfHello=ospfCumIntfHello, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgGwEntry=ipCurCfgGwEntry, iprouting=iprouting, arpStats=arpStats, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoFlag=arpInfoFlag, vrrpOper=vrrpOper, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripStatInPkts=ripStatInPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumNbrStart=ospfCumNbrStart, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCfg=ospfCfg, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfIndex=ospfIntfIndex, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwAddr=ipCurCfgGwAddr, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumTxHello=ospfCumTxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfLsTypesSupported=ospfLsTypesSupported, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfGeneral=ospfGeneral, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgGwAddr=ipNewCfgGwAddr, ripStats=ripStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxHello=ospfIntfRxHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTimersKickOffStats=ospfTimersKickOffStats, routeStats=routeStats, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripCurCfgDefListen=ripCurCfgDefListen, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaInfoId=ospfAreaInfoId, ipRouteInfoIndx=ipRouteInfoIndx, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routeStatEntries=routeStatEntries, ospfStartTime=ospfStartTime, ip_info=ip_info, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoMask=ipRouteInfoMask, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSAId=routerLSAId, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpStats=vrrpStats, ripCurCfgListen=ripCurCfgListen, ospfCumIntfLoop=ospfCumIntfLoop, arpStatMaxEntries=arpStatMaxEntries, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routeStatHighWater=routeStatHighWater, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpStatEntries=arpStatEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxPkts=ospfAreaTxPkts, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpStatHighWater=arpStatHighWater, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumIntfUnloop=ospfCumIntfUnloop)
