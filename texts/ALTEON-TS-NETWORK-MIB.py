...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxPkts=ospfAreaRxPkts, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipRouteInfoTable=ipRouteInfoTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrp_info=vrrp_info, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfStartTime=ospfStartTime, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfStats=ospfStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgBootpState=ipNewCfgBootpState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaInfoTable=ospfAreaInfoTable, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumIntfDown=ospfCumIntfDown, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfGeneral=ospfGeneral, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfGeneralStats=ospfGeneralStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpGeneral=vrrpGeneral, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routerLSALinkID=routerLSALinkID, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCfg=ospfCfg, vrrpOper=vrrpOper, ospfNbrInInitState=ospfNbrInInitState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaNbrStart=ospfAreaNbrStart, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgListen=ripNewCfgListen, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrDown=ospfCumNbrDown, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routeStatHighWater=routeStatHighWater, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumIntfHello=ospfCumIntfHello, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfState=ipNewCfgIntfState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routerLSAAreaIndex=routerLSAAreaIndex, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfDown=ospfIntfDown, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfNbrInExchState=ospfNbrInExchState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfIndex=ospfIntfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfProcessUptime=ospfProcessUptime, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxDatabase=ospfAreaTxDatabase, ipRouteInfoTag=ipRouteInfoTag, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoSrcPort=arpInfoSrcPort, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpInfoTable=arpInfoTable, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumIntfUnloop=ospfCumIntfUnloop, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, dnsStats=dnsStats, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoMask=ipRouteInfoMask, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxDatabase=ospfCumRxDatabase, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumTxHello=ospfCumTxHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, routeStatEntries=routeStatEntries, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfRxHello=ospfIntfRxHello, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipForward=ipForward, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, arpStatHighWater=arpStatHighWater, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoEntry=arpInfoEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwVlan=ipNewCfgGwVlan, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaTxHello=ospfAreaTxHello, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaRxDatabase=ospfAreaRxDatabase, ripStats=ripStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalAreas=ospfTotalAreas, ripNewCfgSupply=ripNewCfgSupply, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfArea=ospfArea, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfHello=ospfIntfHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ip_info=ip_info, ipCurCfgIntfAddr=ipCurCfgIntfAddr, iprouting=iprouting, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routeStats=routeStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpStats=arpStats, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgState=ripCurCfgState, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoRefPorts=arpInfoRefPorts, vrrp=vrrp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNbrInFullState=ospfNbrInFullState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgListen=ripCurCfgListen, ipRouteInfoType=ipRouteInfoType, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrStart=ospfIntfNbrStart, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoDestIp=arpInfoDestIp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfInterface=ospfInterface, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ripStatInPkts=ripStatInPkts, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrDown=ospfIntfNbrDown, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrChange=ospfIntfNbrChange, vrrpStats=vrrpStats, ripStatOutPkts=ripStatOutPkts, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfTxPkts=ospfIntfTxPkts, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse)
