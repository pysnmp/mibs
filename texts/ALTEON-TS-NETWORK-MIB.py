...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwRetry=ipCurCfgGwRetry, arpStatEntries=arpStatEntries, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgGwArp=ipCurCfgGwArp, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgSupply=ripNewCfgSupply, routeStats=routeStats, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaInfoTable=ospfAreaInfoTable, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpGeneral=vrrpGeneral, ospfNbrInInitState=ospfNbrInInitState, ospfCumTxHello=ospfCumTxHello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfGeneral=ospfGeneral, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfLoop=ospfIntfLoop, routerLSALinkData=routerLSALinkData, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgGenState=vrrpNewCfgGenState, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfArea=ospfArea, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoEntry=arpInfoEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfHello=ospfIntfHello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumTxlsAcks=ospfCumTxlsAcks, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfIndex=ospfIntfIndex, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgState=ripNewCfgState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfInfoEntry=ospfIntfInfoEntry, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCfg=ospfCfg, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripConfig=ripConfig, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfGeneralInfo=ospfGeneralInfo, routerLSAId=routerLSAId, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSALinkID=routerLSALinkID, arpInfoSrcPort=arpInfoSrcPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxDatabase=ospfIntfRxDatabase, arpInfoFlag=arpInfoFlag, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, dnsStats=dnsStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, routeStatEntries=routeStatEntries, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoDestIp=arpInfoDestIp, ospfCumIntfLoop=ospfCumIntfLoop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfStartTime=ospfStartTime, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoVLAN=arpInfoVLAN, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, iprouting=iprouting, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfDown=ospfIntfDown, ospfStats=ospfStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumTxPkts=ospfCumTxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ripStatOutPkts=ripStatOutPkts, vrrpStats=vrrpStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipRouteInfoType=ipRouteInfoType, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaInfoId=ospfAreaInfoId, ip_info=ip_info, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfProcessUptime=ospfProcessUptime, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routeStatHighWater=routeStatHighWater, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrhello=ospfCumNbrhello, arpStats=arpStats, ipGatewayTableMax=ipGatewayTableMax, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNbrInExchState=ospfNbrInExchState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfRxHello=ospfIntfRxHello, ospfinfo=ospfinfo, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripNewCfgListen=ripNewCfgListen, vrrp_info=vrrp_info, ospfTotalAreas=ospfTotalAreas, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumRxHello=ospfCumRxHello, ripStats=ripStats, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfState=ipNewCfgIntfState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripStatInErrorPkts=ripStatInErrorPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfUnloop=ospfIntfUnloop, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrhello=ospfIntfNbrhello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpOper=vrrpOper, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfBackup=ospfIntfBackup, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrp=vrrp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripStatInPkts=ripStatInPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwState=ipNewCfgGwState, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgState=ripCurCfgState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwRetry=ipNewCfgGwRetry)
