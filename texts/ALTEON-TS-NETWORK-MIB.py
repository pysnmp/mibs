...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrp_info=vrrp_info, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripCurCfgState=ripCurCfgState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwState=ipCurCfgGwState, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgGwTable=ipCurCfgGwTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatInPkts=ripStatInPkts, ospfCumIntfHello=ospfCumIntfHello, vrrpOper=vrrpOper, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpGeneral=vrrpGeneral, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipForward=ipForward, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoTable=arpInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxDatabase=ospfAreaRxDatabase, ripCurCfgListen=ripCurCfgListen, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumRxPkts=ospfCumRxPkts, ospfCumRxTxStats=ospfCumRxTxStats, ip_info=ip_info, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, iprouting=iprouting, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrp=vrrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfStats=ospfStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoMask=ipRouteInfoMask, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routerLSALinkData=routerLSALinkData, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoTag=ipRouteInfoTag, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripStats=ripStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfLoop=ospfIntfLoop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpInfoVLAN=arpInfoVLAN, ospfIntfIndex=ospfIntfIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaInfoId=ospfAreaInfoId, ospfIntfBackup=ospfIntfBackup, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipRouteInfoEntry=ipRouteInfoEntry, ospfInterface=ospfInterface, ipCurCfgGwMetric=ipCurCfgGwMetric, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripStatInErrorPkts=ripStatInErrorPkts, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgDefListen=ripNewCfgDefListen, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSAId=routerLSAId, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxHello=ospfIntfRxHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoFlag=arpInfoFlag, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgState=ripNewCfgState, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipRouteInfoType=ipRouteInfoType, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, dnsStats=dnsStats, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfTxPkts=ospfIntfTxPkts, ospfLsTypesSupported=ospfLsTypesSupported, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpStats=vrrpStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgGwVlan=ipNewCfgGwVlan, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxDatabase=ospfIntfRxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfHello=ospfIntfHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoMacAddr=arpInfoMacAddr, ospfIntfDown=ospfIntfDown, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumTxHello=ospfCumTxHello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrStart=ospfIntfNbrStart, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgGwIndex=ipCurCfgGwIndex, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routeStatHighWater=routeStatHighWater, ipRouteInfoTable=ipRouteInfoTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCfg=ospfCfg, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkID=routerLSALinkID, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumTxlsReqs=ospfCumTxlsReqs, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpInfoSrcPort=arpInfoSrcPort, vrrpStatInAdvers=vrrpStatInAdvers, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpStatHighWater=arpStatHighWater, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfNbrDown=ospfIntfNbrDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routeStats=routeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwState=ipNewCfgGwState, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrhello=ospfCumNbrhello, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaIntfIndex=ospfAreaIntfIndex, ripConfig=ripConfig, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrhello=ospfIntfNbrhello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfStartTime=ospfStartTime, ipNewCfgGwTable=ipNewCfgGwTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaIntfBackup=ospfAreaIntfBackup, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwMetric=ipNewCfgGwMetric, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIfWaitInterval=ospfIfWaitInterval, arpStats=arpStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfGeneralStats=ospfGeneralStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routerLSALinkIndex=routerLSALinkIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfinfo=ospfinfo, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfArea=ospfArea, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpStatEntries=arpStatEntries)
