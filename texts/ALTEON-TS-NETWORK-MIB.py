...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStats=dnsStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routeStatEntries=routeStatEntries, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfGeneralInfo=ospfGeneralInfo, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfArea=ospfArea, ospfNbrInInitState=ospfNbrInInitState, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoDestIp=arpInfoDestIp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfUnloop=ospfIntfUnloop, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpGeneral=vrrpGeneral, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipRouteInfoInterface=ipRouteInfoInterface, ospfCfg=ospfCfg, ripStats=ripStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNbrInExchState=ospfNbrInExchState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgGwState=ipNewCfgGwState, ospfCumNbrhello=ospfCumNbrhello, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTotalAreas=ospfTotalAreas, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripStatInPkts=ripStatInPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfState=ipNewCfgIntfState, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfLsTypesSupported=ospfLsTypesSupported, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfStats=ospfStats, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxHello=ospfIntfRxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoType=ipRouteInfoType, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoTag=ipRouteInfoTag, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoRefPorts=arpInfoRefPorts, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripConfig=ripConfig, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxHello=ospfAreaRxHello, ospfIntfHello=ospfIntfHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIfWaitInterval=ospfIfWaitInterval, routeStats=routeStats, arpInfoSrcPort=arpInfoSrcPort, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxPkts=ospfAreaRxPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpStatMaxEntries=arpStatMaxEntries, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpStats=arpStats, vrrpStats=vrrpStats, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfWaitTimer=ospfIntfWaitTimer, arpStatEntries=arpStatEntries, ospfAreaIntfDown=ospfAreaIntfDown, ip_info=ip_info, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfTxHello=ospfIntfTxHello, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrStart=ospfCumNbrStart, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfIndex=ospfIntfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routerLSALinkIndex=routerLSALinkIndex, routeStatMaxEntries=routeStatMaxEntries, ripCurCfgVip=ripCurCfgVip, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipForward=ipForward, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfBackup=ospfIntfBackup, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxHello=ospfCumRxHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfRxPkts=ospfIntfRxPkts, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgVip=ripNewCfgVip, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfInfoTable=ospfIntfInfoTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxPkts=ospfCumRxPkts, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStatInAdvers=vrrpStatInAdvers, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfGeneralStats=ospfGeneralStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, arpInfoEntry=arpInfoEntry, ospfIntfDown=ospfIntfDown, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfStartTime=ospfStartTime, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrStart=ospfAreaNbrStart, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNbrInFullState=ospfNbrInFullState, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfinfo=ospfinfo, ripCurCfgState=ripCurCfgState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, iprouting=iprouting, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipRouteInfoIndx=ipRouteInfoIndx, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoMask=ipRouteInfoMask, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoVLAN=arpInfoVLAN, ipRouteInfoDestIp=ipRouteInfoDestIp, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpOper=vrrpOper, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaIntfBackup=ospfAreaIntfBackup, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumTxPkts=ospfCumTxPkts, routeStatHighWater=routeStatHighWater, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripCurCfgListen=ripCurCfgListen, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrp=vrrp, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, routerLSALinkID=routerLSALinkID, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast)
