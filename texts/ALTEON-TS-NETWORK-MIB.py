...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfState=ipCurCfgIntfState, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routerLSALinkData=routerLSALinkData, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfInterface=ospfInterface, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfHello=ospfIntfHello, ospfAreaNbrhello=ospfAreaNbrhello, ripConfig=ripConfig, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routeStatHighWater=routeStatHighWater, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrhello=ospfCumNbrhello, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfInfoTable=ospfIntfInfoTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpStats=vrrpStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routeStatEntries=routeStatEntries, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgGwRetry=ipCurCfgGwRetry, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrStart=ospfCumNbrStart, ospfNbrInExchState=ospfNbrInExchState, arpInfoEntry=arpInfoEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfTxHello=ospfIntfTxHello, ospfTotalAreas=ospfTotalAreas, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, routerLSALinkIndex=routerLSALinkIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, dnsStats=dnsStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipRouteInfoTable=ipRouteInfoTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxHello=ospfCumRxHello, ospfCumTxPkts=ospfCumTxPkts, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routerLSAId=routerLSAId, ospfIntfUnloop=ospfIntfUnloop, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfCountForRouter=ospfIntfCountForRouter, arpInfoFlag=arpInfoFlag, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, arpStatEntries=arpStatEntries, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ripCurCfgVip=ripCurCfgVip, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkID=routerLSALinkID, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfArea=ospfArea, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfStartTime=ospfStartTime, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpStats=arpStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfGeneralStats=ospfGeneralStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfDown=ospfIntfDown, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfProcessUptime=ospfProcessUptime)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipGatewayTableMax=ipGatewayTableMax, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumIntfHello=ospfCumIntfHello, routeStatMaxEntries=routeStatMaxEntries, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrDown=ospfCumNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIfInfoIndex=ospfIfInfoIndex, routeStats=routeStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgGwState=ipNewCfgGwState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumTxDatabase=ospfCumTxDatabase, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripStats=ripStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgSupply=ripCurCfgSupply, ripStatInPkts=ripStatInPkts, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, iprouting=iprouting, ipRouteInfoMask=ipRouteInfoMask, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoIndx=ipRouteInfoIndx, routerLSAAreaIndex=routerLSAAreaIndex, ripNewCfgSupply=ripNewCfgSupply, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripNewCfgState=ripNewCfgState, ip_info=ip_info, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaRxHello=ospfAreaRxHello, ripNewCfgVip=ripNewCfgVip, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrDown=ospfIntfNbrDown, arpInfoVLAN=arpInfoVLAN, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumTxlsReqs=ospfCumTxlsReqs, ipForward=ipForward, ospfAreaRxDatabase=ospfAreaRxDatabase, ipRouteInfoGateway=ipRouteInfoGateway, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoTable=arpInfoTable, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfWaitTimer=ospfIntfWaitTimer, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaTxHello=ospfAreaTxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoTag=ipRouteInfoTag, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCfg=ospfCfg, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripStatOutPkts=ripStatOutPkts, vrrp=vrrp, ipCurCfgGwState=ipCurCfgGwState, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpGeneral=vrrpGeneral, vrrpOper=vrrpOper, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfStats=ospfStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrp_info=vrrp_info, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc)
