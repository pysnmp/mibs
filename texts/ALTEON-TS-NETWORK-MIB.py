...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ripStatOutPkts=ripStatOutPkts, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routeStatMaxEntries=routeStatMaxEntries, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfUnloop=ospfIntfUnloop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routeStats=routeStats, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfTxHello=ospfIntfTxHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrN1way=ospfCumNbrN1way, ospfinfo=ospfinfo, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfInterface=ospfInterface, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfBackup=ospfIntfBackup, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwAddr=ipNewCfgGwAddr, routerLSAId=routerLSAId, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfStartTime=ospfStartTime, arpInfoEntry=arpInfoEntry, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrhello=ospfIntfNbrhello, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripCurCfgState=ripCurCfgState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgVip=ripNewCfgVip, routeStatHighWater=routeStatHighWater, iprouting=iprouting, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrStart=ospfIntfNbrStart, ospfStats=ospfStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxStats=ospfAreaRxTxStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTotalAreas=ospfTotalAreas, ripConfig=ripConfig, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfBackup=ospfCumIntfBackup, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrhello=ospfCumNbrhello, ip_info=ip_info, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfWaitInterval=ospfIfWaitInterval, ospfProcessUptime=ospfProcessUptime, ripCurCfgVip=ripCurCfgVip, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSALinkIndex=routerLSALinkIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfCountForRouter=ospfIntfCountForRouter, ripStats=ripStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfGeneral=ospfGeneral, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrhello=ospfAreaNbrhello, arpStats=arpStats, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfChangeStats=ospfIntfChangeStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumRxHello=ospfCumRxHello, ospfGeneralStats=ospfGeneralStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSALinkID=routerLSALinkID, vrrp=vrrp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpStats=vrrpStats, ospfCumIntfHello=ospfCumIntfHello, vrrp_info=vrrp_info, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfHello=ospfIntfHello, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpOper=vrrpOper, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routeStatEntries=routeStatEntries, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpInfoFlag=arpInfoFlag, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipForward=ipForward, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaChangeStats=ospfAreaChangeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxHello=ospfIntfRxHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoTable=arpInfoTable, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxDatabase=ospfAreaRxDatabase, arpInfoVLAN=arpInfoVLAN, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpGeneral=vrrpGeneral, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwTable=ipCurCfgGwTable, ripNewCfgState=ripNewCfgState, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwArp=ipNewCfgGwArp, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpStatMaxEntries=arpStatMaxEntries, ospfArea=ospfArea, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxHello=ospfAreaTxHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxPkts=ospfCumRxPkts, ripStatInPkts=ripStatInPkts, ospfAreaNbrStart=ospfAreaNbrStart, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpInfoDestIp=arpInfoDestIp, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumIntfLoop=ospfCumIntfLoop)
