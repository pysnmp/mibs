...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routeStatHighWater=routeStatHighWater, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdNewCfgState=ipFwdNewCfgState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpStats=vrrpStats, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfLoop=ospfIntfLoop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipRouteInfoMask=ipRouteInfoMask, arpInfoTable=arpInfoTable, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrDown=ospfAreaNbrDown, ripNewCfgListen=ripNewCfgListen, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, iprouting=iprouting, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoEntry=arpInfoEntry, ospfGeneral=ospfGeneral, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSALinkID=routerLSALinkID, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpStatInAdvers=vrrpStatInAdvers, routeStats=routeStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgVip=ripNewCfgVip, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripStatInPkts=ripStatInPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaNbrStart=ospfAreaNbrStart, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoFlag=arpInfoFlag, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgVip=ripCurCfgVip, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripCurCfgDefListen=ripCurCfgDefListen, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfIndex=ospfIntfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumIntfDown=ospfCumIntfDown, ipForward=ipForward, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfChangeStats=ospfIntfChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIfWaitInterval=ospfIfWaitInterval, routerLSALinkData=routerLSALinkData, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpStatEntries=arpStatEntries, ospfAreaInfoTable=ospfAreaInfoTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfStats=ospfStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoInterface=ipRouteInfoInterface, ripStatOutPkts=ripStatOutPkts, ripConfig=ripConfig, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, dnsStats=dnsStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumTxHello=ospfCumTxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfUnloop=ospfIntfUnloop, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrhello=ospfCumNbrhello, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgState=ripCurCfgState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxHello=ospfAreaRxHello, vrrp=vrrp, ospfIntfDown=ospfIntfDown, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfState=ipCurCfgIntfState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumRxTxStats=ospfCumRxTxStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrChange=ospfIntfNbrChange, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpStatMaxEntries=arpStatMaxEntries, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwArp=ipCurCfgGwArp, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwIndex=ipNewCfgGwIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrp_info=vrrp_info, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgState=ipFwdCurCfgState, ip_info=ip_info, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwArp=ipNewCfgGwArp, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxDatabase=ospfCumRxDatabase, routerLSAId=routerLSAId, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNbrInExchState=ospfNbrInExchState, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrStart=ospfIntfNbrStart, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCfg=ospfCfg, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpGeneral=vrrpGeneral, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripStats=ripStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, arpInfoVLAN=arpInfoVLAN, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgState=ripNewCfgState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripNewCfgDefListen=ripNewCfgDefListen, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTxPkts=ospfAreaTxPkts, ripCurCfgSupply=ripCurCfgSupply, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfHello=ospfIntfHello, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpStats=arpStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfInterface=ospfInterface, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgListen=ripCurCfgListen, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumNbrN1way=ospfCumNbrN1way, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, arpStatHighWater=arpStatHighWater, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex)
