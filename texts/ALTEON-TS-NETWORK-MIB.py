...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoGateway=ipRouteInfoGateway, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgSupply=ripCurCfgSupply, ospfGeneral=ospfGeneral, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfIndex=ospfIntfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpStatMaxEntries=arpStatMaxEntries, arpInfoRefPorts=arpInfoRefPorts, ospfTotalNeighbours=ospfTotalNeighbours, routeStatHighWater=routeStatHighWater, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgState=ripNewCfgState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfUnloop=ospfIntfUnloop, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgVip=ripCurCfgVip, ripStats=ripStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumTxDatabase=ospfCumTxDatabase, ipGatewayTableMax=ipGatewayTableMax, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, routerLSALinkIndex=routerLSALinkIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumRxHello=ospfCumRxHello, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpStatEntries=arpStatEntries, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routeStatMaxEntries=routeStatMaxEntries, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwArp=ipNewCfgGwArp, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaTxPkts=ospfAreaTxPkts, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfTable=ipNewCfgIntfTable, ripCurCfgState=ripCurCfgState, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfDown=ospfIntfDown, ospfCumNbrDown=ospfCumNbrDown, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfBackup=ospfIntfBackup, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaIntfDown=ospfAreaIntfDown, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwInterval=ipNewCfgGwInterval, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfInterface=ospfInterface, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routerLSAId=routerLSAId, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripNewCfgVip=ripNewCfgVip, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfArea=ospfArea, vrrp=vrrp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routerLSALinkData=routerLSALinkData, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrStart=ospfAreaNbrStart, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routerLSAAreaIndex=routerLSAAreaIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalAreas=ospfTotalAreas, ripCurCfgListen=ripCurCfgListen, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfStats=ospfStats, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipRouteInfoMask=ipRouteInfoMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrChange=ospfIntfNbrChange, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipRouteInfoTag=ipRouteInfoTag, ripNewCfgSupply=ripNewCfgSupply, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxPkts=ospfCumTxPkts, arpStats=arpStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxHello=ospfAreaRxHello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfRxHello=ospfIntfRxHello, ospfIfWaitInterval=ospfIfWaitInterval, arpInfoEntry=arpInfoEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfGeneralInfo=ospfGeneralInfo, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStats=vrrpStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrhello=ospfCumNbrhello, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ip_info=ip_info, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOper=vrrpOper, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoTable=arpInfoTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgBootpState=ipCurCfgBootpState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaNbrhello=ospfAreaNbrhello, iprouting=iprouting, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCfg=ospfCfg, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSALinkID=routerLSALinkID, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumTxHello=ospfCumTxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfProcessUptime=ospfProcessUptime, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, routeStats=routeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfinfo=ospfinfo, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaInfoId=ospfAreaInfoId, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipRouteInfoType=ipRouteInfoType, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ospfGeneralStats=ospfGeneralStats, vrrp_info=vrrp_info, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipForward=ipForward, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripStatInPkts=ripStatInPkts, arpStatHighWater=arpStatHighWater, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwArp=ipCurCfgGwArp, ripConfig=ripConfig, vrrpGeneral=vrrpGeneral, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpInfoVLAN=arpInfoVLAN, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwTable=ipCurCfgGwTable)
