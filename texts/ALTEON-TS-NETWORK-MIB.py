...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpStatHighWater=arpStatHighWater, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfDown=ospfIntfDown, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routeStatHighWater=routeStatHighWater, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgVip=ripCurCfgVip, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, arpStatMaxEntries=arpStatMaxEntries, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoVLAN=arpInfoVLAN, ripNewCfgVip=ripNewCfgVip, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwArp=ipNewCfgGwArp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfNbrInInitState=ospfNbrInInitState, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routeStatEntries=routeStatEntries, ipNewCfgIntfAddr=ipNewCfgIntfAddr, arpInfoTable=arpInfoTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdCurCfgState=ipFwdCurCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpGeneral=vrrpGeneral, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routeStats=routeStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfTxHello=ospfIntfTxHello, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipGatewayTableMax=ipGatewayTableMax, routerLSALinkIndex=routerLSALinkIndex, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrp=vrrp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpStatEntries=arpStatEntries, iprouting=iprouting, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, routerLSALinkID=routerLSALinkID, ipNewCfgIntfState=ipNewCfgIntfState, ospfCfg=ospfCfg, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxHello=ospfCumTxHello, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpStats=vrrpStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgGwState=ipCurCfgGwState, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfArea=ospfArea, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ip_info=ip_info, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipInterfaceTableMax=ipInterfaceTableMax)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpStats=arpStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routerLSALinkData=routerLSALinkData, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfGeneralStats=ospfGeneralStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipForward=ipForward, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfHello=ospfIntfHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripCurCfgState=ripCurCfgState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrDown=ospfAreaNbrDown, ipRouteInfoTable=ipRouteInfoTable, ospfinfo=ospfinfo, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripConfig=ripConfig, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrhello=ospfAreaNbrhello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfLoop=ospfIntfLoop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfProcessUptime=ospfProcessUptime, ripStats=ripStats, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfBackup=ospfAreaIntfBackup, dnsStats=dnsStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfGeneral=ospfGeneral, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrp_info=vrrp_info, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfStats=ospfStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routerLSAAreaIndex=routerLSAAreaIndex, ospfStartTime=ospfStartTime, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgGenState=vrrpCurCfgGenState, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfIndex=ospfIntfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoType=ipRouteInfoType, ripStatInErrorPkts=ripStatInErrorPkts, routerLSAId=routerLSAId, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripStatOutPkts=ripStatOutPkts, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripNewCfgState=ripNewCfgState, ripStatInPkts=ripStatInPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfInterface=ospfInterface, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpInfoEntry=arpInfoEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrDown=ospfCumNbrDown, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState)
