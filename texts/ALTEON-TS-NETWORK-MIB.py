...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfGeneral=ospfGeneral, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrp_info=vrrp_info, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumIntfLoop=ospfCumIntfLoop, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgGwTable=ipNewCfgGwTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwDelete=ipNewCfgGwDelete, routeStatEntries=routeStatEntries, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfStats=ospfStats, ipCurCfgIntfTable=ipCurCfgIntfTable, arpStatEntries=arpStatEntries, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfTotalAreas=ospfTotalAreas, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripNewCfgVip=ripNewCfgVip, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpInfoSrcPort=arpInfoSrcPort, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTotalNeighbours=ospfTotalNeighbours, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpStatHighWater=arpStatHighWater, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxDatabase=ospfCumTxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ip_info=ip_info, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripStats=ripStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, routeStatMaxEntries=routeStatMaxEntries, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routeStats=routeStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgGwArp=ipCurCfgGwArp, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripStatInPkts=ripStatInPkts, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpStatMaxEntries=arpStatMaxEntries, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfInfoEntry=ospfIntfInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgVip=ripCurCfgVip, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripConfig=ripConfig, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipForward=ipForward, ripNewCfgState=ripNewCfgState, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaRxHello=ospfAreaRxHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwAddr=ipNewCfgGwAddr, ipRouteInfoType=ipRouteInfoType, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfBackup=ospfIntfBackup, ospfCumNbrDown=ospfCumNbrDown, arpInfoFlag=arpInfoFlag, ospfCumTxPkts=ospfCumTxPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumRxHello=ospfCumRxHello, arpInfoTable=arpInfoTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfArea=ospfArea, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgBootpState=ipCurCfgBootpState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routeStatHighWater=routeStatHighWater, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfHello=ospfCumIntfHello, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrp=vrrp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrStart=ospfAreaNbrStart, ospfCfg=ospfCfg, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, iprouting=iprouting, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSALinkID=routerLSALinkID, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfIndex=ospfIntfIndex, arpInfoVLAN=arpInfoVLAN, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSALinkIndex=routerLSALinkIndex, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripStatOutPkts=ripStatOutPkts, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgGwState=ipNewCfgGwState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfinfo=ospfinfo, arpStats=arpStats, routerLSALinkData=routerLSALinkData, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgIntfState=ipCurCfgIntfState, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfInterface=ospfInterface, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfProcessUptime=ospfProcessUptime, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumIntfDown=ospfCumIntfDown, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripCurCfgState=ripCurCfgState, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfHello=ospfIntfHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpGeneral=vrrpGeneral, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxHello=ospfIntfTxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfLsTypesSupported=ospfLsTypesSupported, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripStatInErrorPkts=ripStatInErrorPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfGeneralStats=ospfGeneralStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxlsAcks=ospfCumTxlsAcks, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrStart=ospfIntfNbrStart, ospfStartTime=ospfStartTime, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface)
