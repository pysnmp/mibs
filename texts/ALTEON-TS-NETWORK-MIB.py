...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumTxDatabase=ospfCumTxDatabase, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaRxPkts=ospfAreaRxPkts, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfArea=ospfArea, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, routeStatMaxEntries=routeStatMaxEntries, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripStatOutPkts=ripStatOutPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfDown=ospfCumIntfDown, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfGeneral=ospfGeneral, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipForward=ipForward, vrrpOper=vrrpOper, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCfg=ospfCfg, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoTable=arpInfoTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, iprouting=iprouting, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripStats=ripStats, vrrpStats=vrrpStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, routeStatHighWater=routeStatHighWater, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpStats=arpStats, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripStatInPkts=ripStatInPkts, ospfIntfIndex=ospfIntfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgDefListen=ripNewCfgDefListen, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgState=ripNewCfgState, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTotalAreas=ospfTotalAreas, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfInterface=ospfInterface, arpStatHighWater=arpStatHighWater, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfLoop=ospfIntfLoop, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrp=vrrp, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfChangeStats=ospfIntfChangeStats, dnsStats=dnsStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipRouteInfoDestIp=ipRouteInfoDestIp, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripNewCfgSupply=ripNewCfgSupply, ospfAreaInfoId=ospfAreaInfoId, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripConfig=ripConfig, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenState=vrrpNewCfgGenState, ipRouteInfoInterface=ipRouteInfoInterface, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSAId=routerLSAId, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrN1way=ospfIntfNbrN1way)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripCurCfgListen=ripCurCfgListen, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoDestIp=arpInfoDestIp, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoVLAN=arpInfoVLAN, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpInfoSrcPort=arpInfoSrcPort, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwState=ipCurCfgGwState, routeStats=routeStats, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrhello=ospfIntfNbrhello, arpStatEntries=arpStatEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, routeStatEntries=routeStatEntries, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfRxHello=ospfIntfRxHello, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, ripNewCfgVip=ripNewCfgVip, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripCurCfgState=ripCurCfgState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoTag=ipRouteInfoTag, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfHello=ospfAreaIntfHello, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfDown=ospfIntfDown, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipRouteInfoMask=ipRouteInfoMask, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfHello=ospfIntfHello, ip_info=ip_info, ipCurCfgIntfTable=ipCurCfgIntfTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwArp=ipCurCfgGwArp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfStartTime=ospfStartTime, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgGwState=ipNewCfgGwState, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routerLSALinkID=routerLSALinkID, arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpGeneral=vrrpGeneral, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripCurCfgSupply=ripCurCfgSupply, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfStats=ospfStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpInfoFlag=arpInfoFlag, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgListen=ripNewCfgListen, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfInfoTable=ospfIntfInfoTable, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrp_info=vrrp_info, ipCurCfgIntfMask=ipCurCfgIntfMask, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt)
