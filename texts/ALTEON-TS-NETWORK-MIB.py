...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfArea=ospfArea, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routeStatHighWater=routeStatHighWater, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routeStatEntries=routeStatEntries, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripStatInErrorPkts=ripStatInErrorPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxPkts=ospfCumTxPkts, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfDown=ospfAreaIntfDown, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdCurCfgState=ipFwdCurCfgState, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfStartTime=ospfStartTime, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenState=vrrpCurCfgGenState, arpInfoDestIp=arpInfoDestIp, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfProcessUptime=ospfProcessUptime, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCfg=ospfCfg, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrDown=ospfAreaNbrDown, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxHello=ospfIntfTxHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, dnsStats=dnsStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrDown=ospfCumNbrDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpGeneral=vrrpGeneral, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpStatMaxEntries=arpStatMaxEntries, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwRetry=ipNewCfgGwRetry, ripStatInPkts=ripStatInPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripStats=ripStats, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipRouteInfoEntry=ipRouteInfoEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, iprouting=iprouting, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwEntry=ipNewCfgGwEntry, ripNewCfgListen=ripNewCfgListen, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipForward=ipForward, ripConfig=ripConfig, ipGatewayTableMax=ipGatewayTableMax, arpInfoMacAddr=arpInfoMacAddr, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrN1way=ospfCumNbrN1way, ospfInterface=ospfInterface, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumIntfHello=ospfCumIntfHello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ip_info=ip_info, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfWaitTimer=ospfIntfWaitTimer, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrp=vrrp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgState=ripCurCfgState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxHello=ospfAreaRxHello, arpInfoVLAN=arpInfoVLAN, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpInfoEntry=arpInfoEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfinfo=ospfinfo)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgListen=ripCurCfgListen, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxPkts=ospfCumRxPkts, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpStats=vrrpStats, ospfIntfHello=ospfIntfHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoId=ospfAreaInfoId, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routerLSAAreaIndex=routerLSAAreaIndex, vrrp_info=vrrp_info, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpStats=arpStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfBackup=ospfIntfBackup, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripNewCfgSupply=ripNewCfgSupply, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoTable=arpInfoTable, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTimersKickOffStats=ospfTimersKickOffStats, routeStats=routeStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNbrInFullState=ospfNbrInFullState, arpInfoFlag=arpInfoFlag, ospfCumTxHello=ospfCumTxHello, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwState=ipNewCfgGwState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgVip=ripNewCfgVip, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaChangeStats=ospfAreaChangeStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgState=ipFwdNewCfgState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaTxPkts=ospfAreaTxPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfStats=ospfStats, arpInfoSrcPort=arpInfoSrcPort, vrrpOper=vrrpOper, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfRangeTableMaxSize=ospfRangeTableMaxSize)
