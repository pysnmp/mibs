...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripCurCfgVip=ripCurCfgVip, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrp=vrrp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoInterface=ipRouteInfoInterface, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumRxHello=ospfCumRxHello, ipRouteInfoIndx=ipRouteInfoIndx, routerLSAId=routerLSAId, routerLSALinkData=routerLSALinkData, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrStart=ospfCumNbrStart, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwInterval=ipNewCfgGwInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfArea=ospfArea, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripCurCfgSupply=ripCurCfgSupply, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumTxPkts=ospfCumTxPkts, arpInfoTable=arpInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpInfoFlag=arpInfoFlag, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfUnloop=ospfIntfUnloop, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfGeneral=ospfGeneral, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripNewCfgListen=ripNewCfgListen, ipCurCfgGwEntry=ipCurCfgGwEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSALinkIndex=routerLSALinkIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routeStats=routeStats, ospfIntfBackup=ospfIntfBackup, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpStats=arpStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfIndex=ospfIntfIndex, arpInfoSrcPort=arpInfoSrcPort, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routerLSAAreaIndex=routerLSAAreaIndex, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwRetry=ipCurCfgGwRetry, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfinfo=ospfinfo, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoEntry=arpInfoEntry, ripNewCfgSupply=ripNewCfgSupply, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpInfoVLAN=arpInfoVLAN, vrrp_info=vrrp_info, ripStatInPkts=ripStatInPkts, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipRouteInfoType=ipRouteInfoType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumRxPkts=ospfCumRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripStatInErrorPkts=ripStatInErrorPkts, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwState=ipCurCfgGwState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgPortState=ipFwdNewCfgPortState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpOper=vrrpOper, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfTable=ipNewCfgIntfTable, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfStats=ospfStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipRouteInfoEntry=ipRouteInfoEntry, ripConfig=ripConfig, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripStats=ripStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaInfoId=ospfAreaInfoId, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpStatMaxEntries=arpStatMaxEntries, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTotalTransitAreas=ospfTotalTransitAreas, ripCurCfgState=ripCurCfgState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfTxPkts=ospfIntfTxPkts, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxPkts=ospfIntfRxPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipForward=ipForward, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfGeneralStats=ospfGeneralStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfHello=ospfAreaIntfHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfLoop=ospfIntfLoop, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgState=ripNewCfgState, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoMask=ipRouteInfoMask, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrDown=ospfAreaNbrDown, ospfInterface=ospfInterface, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxHello=ospfIntfRxHello, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxHello=ospfCumTxHello, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfDown=ospfIntfDown, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumNbrhello=ospfCumNbrhello, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ip_info=ip_info, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routeStatHighWater=routeStatHighWater, dnsStats=dnsStats, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoGateway=ipRouteInfoGateway)
