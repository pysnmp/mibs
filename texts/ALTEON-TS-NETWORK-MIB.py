...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routeStatHighWater=routeStatHighWater, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrhello=ospfAreaNbrhello, vrrpStatOutAdvers=vrrpStatOutAdvers, arpInfoSrcPort=arpInfoSrcPort, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpStats=vrrpStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpOper=vrrpOper, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCfg=ospfCfg, ospfIntfNbrDown=ospfIntfNbrDown, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripStatInPkts=ripStatInPkts, ospfStartTime=ospfStartTime, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumTxDatabase=ospfCumTxDatabase, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfIndex=ospfIntfIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfInterface=ospfInterface, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwState=ipCurCfgGwState, ospfGeneralInfo=ospfGeneralInfo, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaInfoId=ospfAreaInfoId, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgState=ipFwdNewCfgState, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwTable=ipCurCfgGwTable, ip_info=ip_info, ipCurCfgGwMetric=ipCurCfgGwMetric, routeStats=routeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNbrInFullState=ospfNbrInFullState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoTable=ipRouteInfoTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxHello=ospfAreaRxHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, arpInfoTable=arpInfoTable, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrp_info=vrrp_info, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumNbrStart=ospfCumNbrStart, ospfIntfBackup=ospfIntfBackup, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfHello=ospfIntfHello, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgBootpState=ipCurCfgBootpState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumIntfHello=ospfCumIntfHello, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfGeneral=ospfGeneral, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfProcessUptime=ospfProcessUptime, ospfIntfUnloop=ospfIntfUnloop, ospfGeneralStats=ospfGeneralStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenState=vrrpNewCfgGenState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipRouteInfoType=ipRouteInfoType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgVip=ripNewCfgVip, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfLoop=ospfIntfLoop, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, arpStatEntries=arpStatEntries, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStats=ripStats, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgState=ripNewCfgState, ospfNbrInExchState=ospfNbrInExchState, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, iprouting=iprouting, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSAId=routerLSAId, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, routerLSALinkIfIndex=routerLSALinkIfIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgListen=ripCurCfgListen, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipGatewayTableMax=ipGatewayTableMax, ospfCumTxlsAcks=ospfCumTxlsAcks, ipForward=ipForward, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routerLSALinkIndex=routerLSALinkIndex, routeStatEntries=routeStatEntries, ospfCumRxHello=ospfCumRxHello, ospfAreaTxPkts=ospfAreaTxPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpStatHighWater=arpStatHighWater, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, routeStatMaxEntries=routeStatMaxEntries, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, dnsStats=dnsStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfStats=ospfStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpStats=arpStats, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumIntfDown=ospfCumIntfDown, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrN1way=ospfCumNbrN1way, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoTag=ipRouteInfoTag, ospfIfInfoIndex=ospfIfInfoIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripStatInErrorPkts=ripStatInErrorPkts, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpInfoDestIp=arpInfoDestIp, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumRxlsAcks=ospfCumRxlsAcks, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpInfoVLAN=arpInfoVLAN, ripConfig=ripConfig, ipFwdCurCfgState=ipFwdCurCfgState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrp=vrrp, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpInfoFlag=arpInfoFlag, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfinfo=ospfinfo, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast)
