...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrp=vrrp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpStats=arpStats, routeStatHighWater=routeStatHighWater, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgGenState=vrrpNewCfgGenState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpInfoSrcPort=arpInfoSrcPort, vrrpStats=vrrpStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaInfoId=ospfAreaInfoId, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgVip=ripCurCfgVip, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwState=ipNewCfgGwState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrDown=ospfAreaNbrDown, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpOper=vrrpOper, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, routeStats=routeStats, ospfLsTypesSupported=ospfLsTypesSupported, ipInterfaceTableMax=ipInterfaceTableMax, routerLSALinkData=routerLSALinkData, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpStatEntries=arpStatEntries, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, ip_info=ip_info, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfStartTime=ospfStartTime, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, dnsStats=dnsStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripNewCfgState=ripNewCfgState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgSupply=ripNewCfgSupply, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrhello=ospfAreaNbrhello, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrp_info=vrrp_info, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routeStatMaxEntries=routeStatMaxEntries, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTotalAreas=ospfTotalAreas, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwArp=ipNewCfgGwArp, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgListen=ripNewCfgListen, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfGeneral=ospfGeneral, ospfCumRxHello=ospfCumRxHello, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipForward=ipForward, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripCurCfgListen=ripCurCfgListen, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoTable=arpInfoTable, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrRstAd=ospfCumNbrRstAd, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpInfoVLAN=arpInfoVLAN, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoMacAddr=arpInfoMacAddr, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgIntfIndex=ipCurCfgIntfIndex, iprouting=iprouting, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwTable=ipCurCfgGwTable, vrrpGeneral=vrrpGeneral, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpInfoDestIp=arpInfoDestIp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCfg=ospfCfg, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumNbrDown=ospfCumNbrDown, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfTxPkts=ospfIntfTxPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfHello=ospfIntfHello, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripConfig=ripConfig, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfLoop=ospfCumIntfLoop, ospfInterface=ospfInterface, ospfIntfLoop=ospfIntfLoop, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfArea=ospfArea, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfProcessUptime=ospfProcessUptime, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSAId=routerLSAId, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripStats=ripStats, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfStats=ospfStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripStatInPkts=ripStatInPkts, arpStatHighWater=arpStatHighWater, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoFlag=arpInfoFlag, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routeStatEntries=routeStatEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfUnloop=ospfCumIntfUnloop, routerLSALinkID=routerLSALinkID, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpInfoEntry=arpInfoEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase)
