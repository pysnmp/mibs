...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxDatabase=ospfIntfRxDatabase, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpInfoFlag=arpInfoFlag, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoTable=arpInfoTable, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrDown=ospfAreaNbrDown, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routeStatHighWater=routeStatHighWater, ospfCumRxPkts=ospfCumRxPkts, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrp=vrrp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripStats=ripStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfIndex=ospfIntfIndex, ospfCumTxHello=ospfCumTxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, dnsStats=dnsStats, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTotalTransitAreas=ospfTotalTransitAreas, arpStatHighWater=arpStatHighWater, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfGeneralStats=ospfGeneralStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripStatInErrorPkts=ripStatInErrorPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfGeneral=ospfGeneral, ripNewCfgVip=ripNewCfgVip, ospfCumTxPkts=ospfCumTxPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripStatInPkts=ripStatInPkts, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, routeStats=routeStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatOutPkts=ripStatOutPkts, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumTxlsAcks=ospfCumTxlsAcks, ripConfig=ripConfig, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpStatEntries=arpStatEntries, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoTable=ipRouteInfoTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgGwAddr=ipCurCfgGwAddr, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoEntry=arpInfoEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfHello=ospfAreaIntfHello, routerLSALinkIndex=routerLSALinkIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfinfo=ospfinfo, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIfWaitInterval=ospfIfWaitInterval, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripNewCfgListen=ripNewCfgListen, ip_info=ip_info, ospfArea=ospfArea, ospfCumIntfDown=ospfCumIntfDown, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, arpInfoMacAddr=arpInfoMacAddr, ospfIntfLoop=ospfIntfLoop, ipRouteInfoIndx=ipRouteInfoIndx, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSAId=routerLSAId, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfTxHello=ospfIntfTxHello)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSAAreaIndex=routerLSAAreaIndex, iprouting=iprouting, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwState=ipCurCfgGwState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfStats=ospfStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoDestIp=arpInfoDestIp, arpInfoSrcPort=arpInfoSrcPort, arpStatMaxEntries=arpStatMaxEntries, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfHostTableMaxSize=ospfHostTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpStats=arpStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdCurCfgState=ipFwdCurCfgState, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipRouteInfoGateway=ipRouteInfoGateway, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxHello=ospfCumRxHello, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, routerLSALinkData=routerLSALinkData, ospfIntfNbrhello=ospfIntfNbrhello, ipForward=ipForward, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripNewCfgState=ripNewCfgState, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCfg=ospfCfg, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipRouteInfoTag=ipRouteInfoTag, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpStats=vrrpStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpOper=vrrpOper, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfDown=ospfIntfDown, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripCurCfgState=ripCurCfgState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfInterface=ospfInterface, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoInterface=ipRouteInfoInterface, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfStartTime=ospfStartTime, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routeStatEntries=routeStatEntries, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxPkts=ospfAreaTxPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumRxTxStats=ospfCumRxTxStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpGeneral=vrrpGeneral, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaChangeStats=ospfAreaChangeStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTotalNssaAreas=ospfTotalNssaAreas)
