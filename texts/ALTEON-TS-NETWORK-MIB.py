...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpStatMaxEntries=arpStatMaxEntries, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfInterface=ospfInterface, ospfArea=ospfArea, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoGateway=ipRouteInfoGateway, arpStatHighWater=arpStatHighWater, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTotalAreas=ospfTotalAreas, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfUnloop=ospfIntfUnloop, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfChangeStats=ospfIntfChangeStats, vrrpStats=vrrpStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumIntfLoop=ospfCumIntfLoop, ipGatewayTableMax=ipGatewayTableMax, arpInfoTable=arpInfoTable, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfDown=ospfIntfDown, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripStats=ripStats, ospfCumNbrStart=ospfCumNbrStart, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfBackup=ospfCumIntfBackup, ospfIfInfoIndex=ospfIfInfoIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrStart=ospfAreaNbrStart, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfProcessUptime=ospfProcessUptime, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfGeneralStats=ospfGeneralStats, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfLsTypesSupported=ospfLsTypesSupported, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaInfoIndex=ospfAreaInfoIndex, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrp=vrrp, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrhello=ospfIntfNbrhello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwIndex=ipNewCfgGwIndex, routerLSAId=routerLSAId, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, routeStatHighWater=routeStatHighWater, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripNewCfgListen=ripNewCfgListen, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaInfoId=ospfAreaInfoId, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfTxDatabase=ospfIntfTxDatabase, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNbrInInitState=ospfNbrInInitState, ip_info=ip_info, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumRxlsReqs=ospfCumRxlsReqs, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routeStats=routeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoType=ipRouteInfoType, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxDatabase=ospfIntfRxDatabase, ipInterfaceTableMax=ipInterfaceTableMax, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routerLSALinkIndex=routerLSALinkIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpStatEntries=arpStatEntries, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfStats=ospfStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpOper=vrrpOper, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfStartTime=ospfStartTime, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, iprouting=iprouting, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoMacAddr=arpInfoMacAddr, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrN1way=ospfIntfNbrN1way, ripNewCfgSupply=ripNewCfgSupply, ospfIntfLoop=ospfIntfLoop, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfTxHello=ospfIntfTxHello, ospfIntfBackup=ospfIntfBackup, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSALinkID=routerLSALinkID, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumTxPkts=ospfCumTxPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrDown=ospfCumNbrDown, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumRxPkts=ospfCumRxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routeStatMaxEntries=routeStatMaxEntries, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgState=ripNewCfgState, ospfIntfIndex=ospfIntfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfinfo=ospfinfo, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgVip=ripNewCfgVip, ipForward=ipForward, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgIntfVlan=ipNewCfgIntfVlan, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoVLAN=arpInfoVLAN, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCfg=ospfCfg, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwTable=ipNewCfgGwTable, arpInfoFlag=arpInfoFlag, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpStats=arpStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, dnsStats=dnsStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrp_info=vrrp_info, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaTxHello=ospfAreaTxHello, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfGeneral=ospfGeneral, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfHello=ospfIntfHello, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgDefListen=ripNewCfgDefListen, routeStatEntries=routeStatEntries, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfRxPkts=ospfIntfRxPkts, vrrpGeneral=vrrpGeneral, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfInfoTable=ospfIntfInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex)
