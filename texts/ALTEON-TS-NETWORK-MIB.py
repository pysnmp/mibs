...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkData=routerLSALinkData, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgStaticSupply=ripNewCfgStaticSupply, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripStatOutPkts=ripStatOutPkts, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatInErrorPkts=ripStatInErrorPkts, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaInfoIndex=ospfAreaInfoIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoEntry=ipRouteInfoEntry, arpInfoFlag=arpInfoFlag, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipForward=ipForward, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrp=vrrp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfArea=ospfArea, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumIntfLoop=ospfCumIntfLoop, ospfGeneral=ospfGeneral, ripCurCfgSupply=ripCurCfgSupply, ospfStats=ospfStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfRxHello=ospfIntfRxHello, ospfIntfHello=ospfIntfHello, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrp_info=vrrp_info, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routeStats=routeStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripConfig=ripConfig, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrRstAd=ospfIntfNbrRstAd, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfProcessUptime=ospfProcessUptime, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpStatEntries=arpStatEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCfg=ospfCfg, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgListen=ripNewCfgListen, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwState=ipCurCfgGwState, ripCurCfgListen=ripCurCfgListen, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgState=ripCurCfgState, ipCurCfgBootpState=ipCurCfgBootpState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIfInfoIndex=ospfIfInfoIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripStatInPkts=ripStatInPkts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxHello=ospfAreaTxHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoEntry=arpInfoEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, iprouting=iprouting, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgIntfAddr=ipCurCfgIntfAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpGeneral=vrrpGeneral, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfDown=ospfAreaIntfDown, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipRouteInfoTable=ipRouteInfoTable, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripNewCfgState=ripNewCfgState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfLoop=ospfIntfLoop, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumRxHello=ospfCumRxHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, routeStatEntries=routeStatEntries, ripNewCfgSupply=ripNewCfgSupply, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrDown=ospfAreaNbrDown, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfUnloop=ospfIntfUnloop, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwArp=ipCurCfgGwArp, ip_info=ip_info, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxPkts=ospfCumRxPkts, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfInterface=ospfInterface, ospfCumRxlsAcks=ospfCumRxlsAcks, dnsStats=dnsStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumIntfDown=ospfCumIntfDown, routeStatHighWater=routeStatHighWater, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNbrInFullState=ospfNbrInFullState, routerLSAId=routerLSAId, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoTag=ipRouteInfoTag, ospfIntfIndex=ospfIntfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpStatMaxEntries=arpStatMaxEntries, ospfStartTime=ospfStartTime, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumIntfHello=ospfCumIntfHello, ripStats=ripStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routerLSALinkID=routerLSALinkID, arpInfoRefPorts=arpInfoRefPorts, ospfinfo=ospfinfo, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpStats=arpStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNbrInInitState=ospfNbrInInitState, ospfIntfDown=ospfIntfDown, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpStats=vrrpStats, ripNewCfgVip=ripNewCfgVip, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwDelete=ipNewCfgGwDelete, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpOper=vrrpOper, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpStatHighWater=arpStatHighWater, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSALinkIndex=routerLSALinkIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr)
