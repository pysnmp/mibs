...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOper=vrrpOper, ospfCumIntfBackup=ospfCumIntfBackup, ospfTotalNssaAreas=ospfTotalNssaAreas, ipForward=ipForward, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoSrcPort=arpInfoSrcPort, routerLSALinkIndex=routerLSALinkIndex, routeStatEntries=routeStatEntries, ospfIntfBackup=ospfIntfBackup, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrStart=ospfCumNbrStart, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrRstAd=ospfCumNbrRstAd, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrN1way=ospfIntfNbrN1way, routeStatHighWater=routeStatHighWater, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoVLAN=arpInfoVLAN, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaTxPkts=ospfAreaTxPkts, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNbrInExchState=ospfNbrInExchState, arpInfoTable=arpInfoTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTotalAreas=ospfTotalAreas, arpStatEntries=arpStatEntries, ospfGeneralStats=ospfGeneralStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripStatInPkts=ripStatInPkts, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoType=ipRouteInfoType, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, routerLSALinkData=routerLSALinkData, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgListen=ripNewCfgListen, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ip_info=ip_info, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoEntry=arpInfoEntry, ospfGeneral=ospfGeneral, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTotalNeighbours=ospfTotalNeighbours, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfInfoEntry=ospfIntfInfoEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumTxHello=ospfCumTxHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrp=vrrp, ripCurCfgListen=ripCurCfgListen, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgVip=ripNewCfgVip, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgState=ripCurCfgState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfHello=ospfAreaIntfHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfInterface=ospfInterface, ospfinfo=ospfinfo, ripCurCfgVip=ripCurCfgVip, ospfAreaInfoTable=ospfAreaInfoTable, ripConfig=ripConfig, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfArea=ospfArea, ipRouteInfoInterface=ipRouteInfoInterface, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgSupply=ripNewCfgSupply, ospfCumIntfDown=ospfCumIntfDown, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgDefListen=ripCurCfgDefListen, arpInfoRefPorts=arpInfoRefPorts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpGeneral=vrrpGeneral, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpStatInAdvers=vrrpStatInAdvers, ripStats=ripStats, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgGwEntry=ipNewCfgGwEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrChange=ospfIntfNbrChange, routeStats=routeStats, ospfAreaRxDatabase=ospfAreaRxDatabase, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, dnsStats=dnsStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfTxHello=ospfIntfTxHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfDown=ospfIntfDown, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrDown=ospfCumNbrDown, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSALinkID=routerLSALinkID, arpStatMaxEntries=arpStatMaxEntries, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, iprouting=iprouting, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfLsTypesSupported=ospfLsTypesSupported, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrp_info=vrrp_info, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumRxHello=ospfCumRxHello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpStatHighWater=arpStatHighWater, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripStatOutPkts=ripStatOutPkts, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumRxDatabase=ospfCumRxDatabase, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfGeneralInfo=ospfGeneralInfo, arpInfoFlag=arpInfoFlag, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpStats=vrrpStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpStats=arpStats, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoDestIp=arpInfoDestIp, ospfAreaInfoId=ospfAreaInfoId, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfStats=ospfStats, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete)
