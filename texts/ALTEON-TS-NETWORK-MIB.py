...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfIndex=ospfIntfIndex, ospfNbrInFullState=ospfNbrInFullState, ospfGeneralInfo=ospfGeneralInfo, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgBootpState=ipCurCfgBootpState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrStart=ospfIntfNbrStart, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwState=ipNewCfgGwState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoVLAN=arpInfoVLAN, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfChangeStats=ospfIntfChangeStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripStats=ripStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, dnsStats=dnsStats, vrrp=vrrp, ospfAreaIntfHello=ospfAreaIntfHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgState=ipFwdNewCfgState, vrrpOper=vrrpOper, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrDown=ospfCumNbrDown, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routeStatEntries=routeStatEntries, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfHello=ospfIntfHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoDestIp=arpInfoDestIp, vrrp_info=vrrp_info, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSALinkData=routerLSALinkData, ospfAreaIntfIndex=ospfAreaIntfIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfGeneral=ospfGeneral, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxPkts=ospfCumTxPkts, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpStatHighWater=arpStatHighWater, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoTag=ipRouteInfoTag, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfArea=ospfArea, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpStats=vrrpStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwArp=ipNewCfgGwArp, routeStatHighWater=routeStatHighWater, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, routerLSALinkID=routerLSALinkID, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfLsTypesSupported=ospfLsTypesSupported, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfTotalAreas=ospfTotalAreas, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfInterface=ospfInterface, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripStatOutPkts=ripStatOutPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgListen=ripNewCfgListen, ipForward=ipForward, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfState=ipNewCfgIntfState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, arpStats=arpStats, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfStartTime=ospfStartTime, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaInfoId=ospfAreaInfoId, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumIntfLoop=ospfCumIntfLoop, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfVlan=ipNewCfgIntfVlan, iprouting=iprouting, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripStatInPkts=ripStatInPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipGatewayTableMax=ipGatewayTableMax, ipRouteInfoTable=ipRouteInfoTable, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgListen=ripCurCfgListen, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpInfoEntry=arpInfoEntry, routeStats=routeStats, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfDown=ospfIntfDown, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCurCfgAreaId=ospfCurCfgAreaId, routerLSAId=routerLSAId, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripNewCfgVip=ripNewCfgVip, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoRefPorts=arpInfoRefPorts, ip_info=ip_info, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ripNewCfgState=ripNewCfgState, ipCurCfgIntfTable=ipCurCfgIntfTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumTxHello=ospfCumTxHello, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxPkts=ospfCumRxPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgGwArp=ipCurCfgGwArp, arpStatEntries=arpStatEntries, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpInfoMacAddr=arpInfoMacAddr, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaIntfBackup=ospfAreaIntfBackup, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfUnloop=ospfIntfUnloop, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgGwMetric=ipNewCfgGwMetric, ripCurCfgState=ripCurCfgState, ospfCfg=ospfCfg, ospfAreaNbrDown=ospfAreaNbrDown, arpInfoSrcPort=arpInfoSrcPort, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaTableMaxSize=ospfAreaTableMaxSize)
