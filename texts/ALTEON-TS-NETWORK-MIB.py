...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, arpStats=arpStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCfg=ospfCfg, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routeStatHighWater=routeStatHighWater, ospfIntfIndex=ospfIntfIndex, ospfAreaRxPkts=ospfAreaRxPkts, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ip_info=ip_info, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoTable=arpInfoTable, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSALinkID=routerLSALinkID, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgGwTable=ipCurCfgGwTable, vrrpStats=vrrpStats, ospfCumIntfDown=ospfCumIntfDown, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipInterfaceTableMax=ipInterfaceTableMax, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIfWaitInterval=ospfIfWaitInterval, ospfProcessUptime=ospfProcessUptime, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumNbrN1way=ospfCumNbrN1way, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routeStatEntries=routeStatEntries, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgState=ipFwdNewCfgState, routerLSALinkData=routerLSALinkData, ospfArea=ospfArea, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpInfoFlag=arpInfoFlag, ripStats=ripStats, arpStatMaxEntries=arpStatMaxEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumIntfBackup=ospfCumIntfBackup, ospfGeneral=ospfGeneral, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrStart=ospfAreaNbrStart, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxHello=ospfAreaRxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgBootpState=ipCurCfgBootpState, arpStatHighWater=arpStatHighWater, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumRxPkts=ospfCumRxPkts, dnsStats=dnsStats, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripNewCfgVip=ripNewCfgVip, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrp_info=vrrp_info, ospfCumNbrDown=ospfCumNbrDown, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrp=vrrp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipNewCfgGwEntry=ipNewCfgGwEntry, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routeStatMaxEntries=routeStatMaxEntries, ospfIntfBackup=ospfIntfBackup, ospfCumNbrStart=ospfCumNbrStart, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpStatEntries=arpStatEntries, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripCurCfgVip=ripCurCfgVip, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumTxHello=ospfCumTxHello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwRetry=ipNewCfgGwRetry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNbrInExchState=ospfNbrInExchState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpStatInAdvers=vrrpStatInAdvers, vrrpOper=vrrpOper, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgDefListen=ripCurCfgDefListen, ipRouteInfoType=ipRouteInfoType, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrRstAd=ospfCumNbrRstAd, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpInfoDestIp=arpInfoDestIp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumRxDatabase=ospfCumRxDatabase, ospfGeneralInfo=ospfGeneralInfo, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routerLSALinkIndex=routerLSALinkIndex, arpInfoEntry=arpInfoEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpInfoMacAddr=arpInfoMacAddr, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfHello=ospfIntfHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoTag=ipRouteInfoTag, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaInfoId=ospfAreaInfoId, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routeStats=routeStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfInterface=ospfInterface, ipNewCfgGwAddr=ipNewCfgGwAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfinfo=ospfinfo, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfHostTableMaxSize=ospfHostTableMaxSize, ipForward=ipForward, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripStatInPkts=ripStatInPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripNewCfgSupply=ripNewCfgSupply, arpInfoRefPorts=arpInfoRefPorts, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, iprouting=iprouting, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfStats=ospfStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpGeneral=vrrpGeneral, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNbrInFullState=ospfNbrInFullState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripConfig=ripConfig, ospfIntfTxPkts=ospfIntfTxPkts, ripCurCfgListen=ripCurCfgListen, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgBootpState=ipNewCfgBootpState, ripCurCfgState=ripCurCfgState)
