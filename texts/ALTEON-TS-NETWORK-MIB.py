...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrStart=ospfCumNbrStart, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, iprouting=iprouting, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrChange=ospfIntfNbrChange, vrrpStats=vrrpStats, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routeStatMaxEntries=routeStatMaxEntries, ospfIntfLoop=ospfIntfLoop, arpStatMaxEntries=arpStatMaxEntries, ipRouteInfoType=ipRouteInfoType, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfRxPkts=ospfIntfRxPkts, ospfCfg=ospfCfg, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgGwArp=ipCurCfgGwArp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrp=vrrp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumIntfBackup=ospfCumIntfBackup, vrrp_info=vrrp_info, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpStatInAdvers=vrrpStatInAdvers, arpStats=arpStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOper=vrrpOper, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpInfoFlag=arpInfoFlag, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfProcessUptime=ospfProcessUptime, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpGeneral=vrrpGeneral, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipForward=ipForward, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfArea=ospfArea, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfChangeStats=ospfIntfChangeStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgGenState=vrrpCurCfgGenState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxPkts=ospfCumRxPkts, ospfNbrInFullState=ospfNbrInFullState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaInfoTable=ospfAreaInfoTable, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgState=ipFwdCurCfgState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwState=ipNewCfgGwState, ospfGeneralInfo=ospfGeneralInfo, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumRxTxStats=ospfCumRxTxStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfIndex=ospfIntfIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripConfig=ripConfig, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoEntry=arpInfoEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfRxHello=ospfIntfRxHello, routerLSAId=routerLSAId, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfInterface=ospfInterface, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfTxHello=ospfIntfTxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfDown=ospfIntfDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripCurCfgVip=ripCurCfgVip, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripStats=ripStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfStartTime=ospfStartTime, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpStatHighWater=arpStatHighWater, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoVLAN=arpInfoVLAN, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfStats=ospfStats, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxHello=ospfCumRxHello, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaInfoId=ospfAreaInfoId, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfBackup=ospfIntfBackup, ipRouteInfoGateway=ipRouteInfoGateway, routerLSALinkData=routerLSALinkData, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumNbrhello=ospfCumNbrhello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routerLSALinkID=routerLSALinkID, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfGeneral=ospfGeneral, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routeStatHighWater=routeStatHighWater, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripNewCfgVip=ripNewCfgVip, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwTable=ipNewCfgGwTable, ripNewCfgListen=ripNewCfgListen, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routerLSAAreaIndex=routerLSAAreaIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfInfoTable=ospfIntfInfoTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgState=ripNewCfgState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIfInfoIndex=ospfIfInfoIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, dnsStats=dnsStats, routeStats=routeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpInfoDestIp=arpInfoDestIp, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxPkts=ospfAreaRxPkts, arpStatEntries=arpStatEntries, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ip_info=ip_info, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaTxHello=ospfAreaTxHello, arpInfoTable=arpInfoTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfTxDatabase=ospfIntfTxDatabase, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipRouteInfoMask=ipRouteInfoMask, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgGwState=ipCurCfgGwState, routeStatEntries=routeStatEntries, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgSupply=ripNewCfgSupply)
