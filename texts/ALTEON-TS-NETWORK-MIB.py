...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumRxTxStats=ospfCumRxTxStats, ospfGeneral=ospfGeneral, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfGeneralStats=ospfGeneralStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfLsTypesSupported=ospfLsTypesSupported, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgBootpState=ipNewCfgBootpState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripNewCfgSupply=ripNewCfgSupply, ripConfig=ripConfig, ripNewCfgVip=ripNewCfgVip, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpStatMaxEntries=arpStatMaxEntries, ospfinfo=ospfinfo, ospfCumNbrDown=ospfCumNbrDown, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfHello=ospfCumIntfHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, iprouting=iprouting, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpStatHighWater=arpStatHighWater, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripNewCfgListen=ripNewCfgListen, vrrpOper=vrrpOper, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTotalAreas=ospfTotalAreas, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrN1way=ospfCumNbrN1way, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSAId=routerLSAId, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfIndex=ospfIntfIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgGwState=ipCurCfgGwState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfDown=ospfIntfDown, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfBackup=ospfIntfBackup, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, dnsStats=dnsStats, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumRxHello=ospfCumRxHello, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgGwRetry=ipCurCfgGwRetry, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipGatewayTableMax=ipGatewayTableMax, vrrpGeneral=vrrpGeneral, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ip_info=ip_info, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripNewCfgState=ripNewCfgState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgGwEntry=ipCurCfgGwEntry, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpStats=arpStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfHello=ospfIntfHello, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoType=ipRouteInfoType, arpStatEntries=arpStatEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoFlag=arpInfoFlag, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrDown=ospfIntfNbrDown, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipForward=ipForward, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfCfg=ospfCfg, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfUnloop=ospfIntfUnloop, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxDatabase=ospfAreaRxDatabase)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrStart=ospfIntfNbrStart, vrrp=vrrp, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfRxPkts=ospfIntfRxPkts, ripStatOutPkts=ripStatOutPkts, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfArea=ospfArea, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripStats=ripStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNewCfgAreaId=ospfNewCfgAreaId, routeStatHighWater=routeStatHighWater, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripStatInPkts=ripStatInPkts, ipRouteInfoTable=ipRouteInfoTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoRefPorts=arpInfoRefPorts, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpStats=vrrpStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfGeneralInfo=ospfGeneralInfo, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwState=ipNewCfgGwState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgIntfState=ipNewCfgIntfState, ospfStats=ospfStats, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaIntfDown=ospfAreaIntfDown, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrp_info=vrrp_info, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoEntry=arpInfoEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routeStats=routeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routeStatEntries=routeStatEntries, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfInterface=ospfInterface, routerLSALinkData=routerLSALinkData, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfLoop=ospfIntfLoop, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routerLSALinkIndex=routerLSALinkIndex, arpInfoVLAN=arpInfoVLAN, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfVlan=ipCurCfgIntfVlan, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgBootpState=ipCurCfgBootpState, ripCurCfgListen=ripCurCfgListen, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumTxHello=ospfCumTxHello, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgGwEntry=ipNewCfgGwEntry, routeStatMaxEntries=routeStatMaxEntries)
