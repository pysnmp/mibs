...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwDelete=ipNewCfgGwDelete, arpStatHighWater=arpStatHighWater, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpInfoRefPorts=arpInfoRefPorts, arpStatEntries=arpStatEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfBackup=ospfIntfBackup, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripStatOutPkts=ripStatOutPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumTxPkts=ospfCumTxPkts, vrrpOper=vrrpOper, ospfNbrInExchState=ospfNbrInExchState, arpInfoMacAddr=arpInfoMacAddr, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, dnsStats=dnsStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSALinkData=routerLSALinkData, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCfg=ospfCfg, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrN1way=ospfCumNbrN1way, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipGatewayTableMax=ipGatewayTableMax, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfTxPkts=ospfIntfTxPkts, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfTxHello=ospfIntfTxHello, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxDatabase=ospfCumTxDatabase, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumTxHello=ospfCumTxHello, ipCurCfgGwState=ipCurCfgGwState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfState=ipNewCfgIntfState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatInPkts=ripStatInPkts, ospfStats=ospfStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpStats=arpStats, arpStatMaxEntries=arpStatMaxEntries, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipForward=ipForward, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpGeneral=vrrpGeneral, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaIntfBackup=ospfAreaIntfBackup, routeStatHighWater=routeStatHighWater, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgVip=ripNewCfgVip, ospfCumRxHello=ospfCumRxHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumRxlsAcks=ospfCumRxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaTxHello=ospfAreaTxHello, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoTable=ipRouteInfoTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgGwIndex=ipNewCfgGwIndex, ripNewCfgDefListen=ripNewCfgDefListen, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfTable=ipNewCfgIntfTable, ipRouteInfoIndx=ipRouteInfoIndx, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpInfoDestIp=arpInfoDestIp, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpInfoFlag=arpInfoFlag, ospfAreaInfoId=ospfAreaInfoId, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfInterface=ospfInterface, ospfCumNbrhello=ospfCumNbrhello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrStart=ospfIntfNbrStart, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfinfo=ospfinfo, ripNewCfgSupply=ripNewCfgSupply, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfHello=ospfIntfHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfHello=ospfAreaIntfHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ip_info=ip_info, ospfArea=ospfArea, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routeStatEntries=routeStatEntries, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwTable=ipCurCfgGwTable, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumRxPkts=ospfCumRxPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTotalNeighbours=ospfTotalNeighbours, ripStats=ripStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrDown=ospfCumNbrDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumNbrStart=ospfCumNbrStart, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgState=ripCurCfgState, ospfTotalAreas=ospfTotalAreas, ospfProcessUptime=ospfProcessUptime, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoTag=ipRouteInfoTag, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgListen=ripCurCfgListen, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, routeStats=routeStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripConfig=ripConfig, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpStatInAdvers=vrrpStatInAdvers, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpInfoVLAN=arpInfoVLAN, ospfIntfUnloop=ospfIntfUnloop, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrp=vrrp, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routerLSAId=routerLSAId, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpInfoEntry=arpInfoEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgListen=ripNewCfgListen, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfLoop=ospfIntfLoop, arpInfoSrcPort=arpInfoSrcPort, vrrpStats=vrrpStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask)
