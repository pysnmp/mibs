...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrDown=ospfCumNbrDown, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrDown=ospfAreaNbrDown, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipForward=ipForward, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCfg=ospfCfg, arpStatEntries=arpStatEntries, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrp=vrrp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripStatInPkts=ripStatInPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoInterface=ipRouteInfoInterface, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfStats=ospfStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpOper=vrrpOper, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ip_info=ip_info, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfDown=ospfIntfDown, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaInfoId=ospfAreaInfoId, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipRouteInfoEntry=ipRouteInfoEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, iprouting=iprouting, routeStats=routeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfChangeStats=ospfIntfChangeStats, routeStatEntries=routeStatEntries, ospfAreaIntfIndex=ospfAreaIntfIndex, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgState=ripCurCfgState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoRefPorts=arpInfoRefPorts, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwIndex=ipCurCfgGwIndex, ripNewCfgState=ripNewCfgState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfGeneral=ospfGeneral, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routerLSALinkID=routerLSALinkID, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgGwMetric=ipNewCfgGwMetric, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, routeStatMaxEntries=routeStatMaxEntries, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ripConfig=ripConfig, ipCurCfgBootpState=ipCurCfgBootpState, arpStats=arpStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwState=ipCurCfgGwState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgDefListen=ripCurCfgDefListen, routerLSALinkData=routerLSALinkData, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdNewCfgState=ipFwdNewCfgState, vrrpStats=vrrpStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfBackup=ospfIntfBackup, dnsStats=dnsStats, ipRouteInfoTag=ipRouteInfoTag, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatInErrorPkts=ripStatInErrorPkts, ospfCumIntfDown=ospfCumIntfDown, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoSrcPort=arpInfoSrcPort, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripNewCfgSupply=ripNewCfgSupply, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpGeneral=vrrpGeneral, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrhello=ospfAreaNbrhello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumRxHello=ospfCumRxHello, ospfTotalAreas=ospfTotalAreas, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfInterface=ospfInterface, ospfGeneralStats=ospfGeneralStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoVLAN=arpInfoVLAN, ospfIntfHello=ospfIntfHello, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpStatHighWater=arpStatHighWater, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipGatewayTableMax=ipGatewayTableMax, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripNewCfgListen=ripNewCfgListen, ipRouteInfoMask=ipRouteInfoMask, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumIntfBackup=ospfCumIntfBackup, ospfNbrInInitState=ospfNbrInInitState, ospfCumIntfHello=ospfCumIntfHello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfProcessUptime=ospfProcessUptime, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoTable=arpInfoTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfArea=ospfArea, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripStats=ripStats, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoMacAddr=arpInfoMacAddr, vrrp_info=vrrp_info, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfRxHello=ospfIntfRxHello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipRouteInfoTable=ipRouteInfoTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfLoop=ospfIntfLoop, ospfIntfInfoTable=ospfIntfInfoTable, ospfinfo=ospfinfo, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaNbrRstAd=ospfAreaNbrRstAd, routeStatHighWater=routeStatHighWater, ripStatOutPkts=ripStatOutPkts, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv)
