...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpOper=vrrpOper, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripNewCfgState=ripNewCfgState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripNewCfgVip=ripNewCfgVip, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfState=ipCurCfgIntfState, ospfinfo=ospfinfo, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTotalNeighbours=ospfTotalNeighbours, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgGwState=ipNewCfgGwState, ospfGeneralStats=ospfGeneralStats, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoInterface=ipRouteInfoInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumRxDatabase=ospfCumRxDatabase, ipForward=ipForward, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpStats=vrrpStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfStartTime=ospfStartTime, ripConfig=ripConfig, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, routeStatEntries=routeStatEntries, ipRouteInfoGateway=ipRouteInfoGateway, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaRxDatabase=ospfAreaRxDatabase, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routerLSALinkData=routerLSALinkData, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfState=ipNewCfgIntfState, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpStatInAdvers=vrrpStatInAdvers, arpInfoEntry=arpInfoEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumTxlsAcks=ospfCumTxlsAcks, routeStats=routeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgListen=ripNewCfgListen, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfBackup=ospfIntfBackup, ripNewCfgDefListen=ripNewCfgDefListen, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfGeneral=ospfGeneral, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpInfoMacAddr=arpInfoMacAddr, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumTxPkts=ospfCumTxPkts, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoTag=ipRouteInfoTag, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfHello=ospfIntfHello, ospfAreaInfoId=ospfAreaInfoId, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfRxHello=ospfIntfRxHello, ospfIntfTxPkts=ospfIntfTxPkts, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfInterface=ospfInterface, ospfCumNbrStart=ospfCumNbrStart, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripStats=ripStats, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrDown=ospfCumNbrDown, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxHello=ospfAreaRxHello, routerLSALinkID=routerLSALinkID, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoTable=arpInfoTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgGwState=ipCurCfgGwState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrp=vrrp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfDown=ospfIntfDown, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfRxDatabase=ospfIntfRxDatabase, iprouting=iprouting, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumIntfHello=ospfCumIntfHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSAAreaIndex=routerLSAAreaIndex, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumTxDatabase=ospfCumTxDatabase, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwIndex=ipCurCfgGwIndex, ipInterfaceTableMax=ipInterfaceTableMax, arpStatEntries=arpStatEntries, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoEntry=ipRouteInfoEntry, ripStatOutPkts=ripStatOutPkts, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoVLAN=arpInfoVLAN, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, dnsStats=dnsStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfArea=ospfArea, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumIntfDown=ospfCumIntfDown, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgState=ripCurCfgState, ripCurCfgListen=ripCurCfgListen, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoTable=ipRouteInfoTable, ospfCfg=ospfCfg, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, routeStatHighWater=routeStatHighWater, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaTxHello=ospfAreaTxHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpStatHighWater=arpStatHighWater, ip_info=ip_info, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpGeneral=vrrpGeneral, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpStats=arpStats)
