...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrN1way=ospfCumNbrN1way, ripNewCfgSupply=ripNewCfgSupply, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpStatInAdvers=vrrpStatInAdvers, ripStats=ripStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrhello=ospfCumNbrhello, ospfIntfUnloop=ospfIntfUnloop, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routeStats=routeStats, ripCurCfgSupply=ripCurCfgSupply, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumTxHello=ospfCumTxHello, routeStatHighWater=routeStatHighWater, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpStatEntries=arpStatEntries, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNbrInFullState=ospfNbrInFullState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfIndex=ospfAreaIntfIndex, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfArea=ospfArea, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfTxHello=ospfIntfTxHello, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfinfo=ospfinfo, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, arpInfoTable=arpInfoTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxPkts=ospfIntfRxPkts, ospfNbrInInitState=ospfNbrInInitState, ripConfig=ripConfig, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumRxHello=ospfCumRxHello, routeStatMaxEntries=routeStatMaxEntries, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrp=vrrp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpInfoSrcPort=arpInfoSrcPort, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumIntfLoop=ospfCumIntfLoop, ripCurCfgVip=ripCurCfgVip, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routerLSALinkData=routerLSALinkData, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripStatInPkts=ripStatInPkts, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfGeneralInfo=ospfGeneralInfo, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfBackup=ospfIntfBackup, ipRouteInfoMask=ipRouteInfoMask, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSAAreaIndex=routerLSAAreaIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfDown=ospfIntfDown, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfIndex=ospfIntfIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipRouteInfoTable=ipRouteInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfStats=ospfStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumRxTxStats=ospfCumRxTxStats, arpStatMaxEntries=arpStatMaxEntries, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ripNewCfgListen=ripNewCfgListen, vrrpStats=vrrpStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipRouteInfoType=ipRouteInfoType, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipRouteInfoGateway=ipRouteInfoGateway, ospfGeneral=ospfGeneral, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoEntry=arpInfoEntry, ospfCumNbrStart=ospfCumNbrStart, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaTxPkts=ospfAreaTxPkts, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfStartTime=ospfStartTime, ospfInterface=ospfInterface, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaInfoId=ospfAreaInfoId, ospfIntfTxPkts=ospfIntfTxPkts, dnsStats=dnsStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumTxDatabase=ospfCumTxDatabase, ipForward=ipForward, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumIntfDown=ospfCumIntfDown, routeStatEntries=routeStatEntries, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, iprouting=iprouting, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoEntry=ipRouteInfoEntry, routerLSALinkID=routerLSALinkID, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipRouteInfoTag=ipRouteInfoTag, arpStats=arpStats, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTotalAreas=ospfTotalAreas, ripCurCfgState=ripCurCfgState, ip_info=ip_info, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfHello=ospfIntfHello, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrp_info=vrrp_info, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaInfoTable=ospfAreaInfoTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSALinkIndex=routerLSALinkIndex, ripStatOutPkts=ripStatOutPkts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxHello=ospfIntfRxHello, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpStatHighWater=arpStatHighWater, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpOper=vrrpOper, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfUnloop=ospfCumIntfUnloop, ripCurCfgListen=ripCurCfgListen, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfProcessUptime=ospfProcessUptime)
