...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfHello=ospfIntfHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfNbrStart=ospfIntfNbrStart, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routeStatHighWater=routeStatHighWater, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwState=ipCurCfgGwState, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfArea=ospfArea, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfGeneral=ospfGeneral, ospfAreaIntfIndex=ospfAreaIntfIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, arpStatHighWater=arpStatHighWater, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTotalNeighbours=ospfTotalNeighbours, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfLoop=ospfIntfLoop, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripStatInPkts=ripStatInPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrDown=ospfAreaNbrDown, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfState=ipCurCfgIntfState, routeStats=routeStats, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIfInfoIndex=ospfIfInfoIndex, arpInfoDestIp=arpInfoDestIp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxDatabase=ospfIntfRxDatabase, iprouting=iprouting, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfProcessUptime=ospfProcessUptime, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCfg=ospfCfg, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoTable=arpInfoTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, arpStatMaxEntries=arpStatMaxEntries, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripStatOutPkts=ripStatOutPkts, ipForward=ipForward, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfBackup=ospfIntfBackup, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, dnsStats=dnsStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaInfoEntry=ospfAreaInfoEntry, arpInfoEntry=arpInfoEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripStatInErrorPkts=ripStatInErrorPkts, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfTxHello=ospfIntfTxHello, ospfCumIntfHello=ospfCumIntfHello, ospfNbrInInitState=ospfNbrInInitState, vrrpGeneral=vrrpGeneral, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrhello=ospfAreaNbrhello, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgBootpState=ipNewCfgBootpState, arpStatEntries=arpStatEntries, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, routerLSALinkID=routerLSALinkID, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSALinkData=routerLSALinkData, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrIndex=ospfIntfNbrIndex, arpInfoFlag=arpInfoFlag, ospfCumNbrhello=ospfCumNbrhello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfCountForRouter=ospfIntfCountForRouter, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ip_info=ip_info)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrp_info=vrrp_info, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumNbrStart=ospfCumNbrStart, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfDown=ospfIntfDown, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routerLSALinkIndex=routerLSALinkIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrN1way=ospfCumNbrN1way, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaInfoIndex=ospfAreaInfoIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfDown=ospfCumIntfDown, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfInterface=ospfInterface, ospfCumRxHello=ospfCumRxHello, vrrpStatInAdvers=vrrpStatInAdvers, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrp=vrrp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripConfig=ripConfig, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfNbrInFullState=ospfNbrInFullState, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfinfo=ospfinfo, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfGeneralStats=ospfGeneralStats, ipRouteInfoGateway=ipRouteInfoGateway, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoMask=ipRouteInfoMask, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrBadSequence=ospfCumNbrBadSequence, arpStats=arpStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpStats=vrrpStats, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoVLAN=arpInfoVLAN, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, routeStatEntries=routeStatEntries, ospfStartTime=ospfStartTime, ospfCumTxHello=ospfCumTxHello, ospfStats=ospfStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaInfoTable=ospfAreaInfoTable, ipRouteInfoTable=ipRouteInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipRouteInfoIndx=ipRouteInfoIndx, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumRxPkts=ospfCumRxPkts, ripCurCfgVip=ripCurCfgVip, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaRxDatabase=ospfAreaRxDatabase, ripStats=ripStats)
