...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpStats=vrrpStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfIndex=ospfIntfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, dnsStats=dnsStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfRxPkts=ospfIntfRxPkts, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfProcessUptime=ospfProcessUptime, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, arpStats=arpStats, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripCurCfgSupply=ripCurCfgSupply, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumIntfBackup=ospfCumIntfBackup, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpInfoDestIp=arpInfoDestIp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwState=ipNewCfgGwState, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCfg=ospfCfg, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripConfig=ripConfig, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfDown=ospfCumIntfDown, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumTxHello=ospfCumTxHello, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoType=ipRouteInfoType, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, iprouting=iprouting, ospfCumRxTxStats=ospfCumRxTxStats, vrrpGeneral=vrrpGeneral, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgSupply=ripNewCfgSupply, arpInfoTable=arpInfoTable, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgBootpState=ipCurCfgBootpState, arpInfoEntry=arpInfoEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfArea=ospfArea, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIfInfoIndex=ospfIfInfoIndex, ospfNbrInInitState=ospfNbrInInitState, arpInfoSrcPort=arpInfoSrcPort, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipGatewayTableMax=ipGatewayTableMax, ipRouteInfoMask=ipRouteInfoMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfStats=ospfStats, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfStartTime=ospfStartTime, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumNbrhello=ospfCumNbrhello, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpStatMaxEntries=arpStatMaxEntries, vrrp_info=vrrp_info, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfGeneralStats=ospfGeneralStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfLoop=ospfIntfLoop, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfInterface=ospfInterface, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpStatHighWater=arpStatHighWater, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripStatInPkts=ripStatInPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfinfo=ospfinfo, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, routeStats=routeStats, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipForward=ipForward, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrDown=ospfAreaNbrDown, ripStats=ripStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrChange=ospfIntfNbrChange, ospfLsTypesSupported=ospfLsTypesSupported, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgListen=ripCurCfgListen, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumIntfHello=ospfCumIntfHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaInfoTable=ospfAreaInfoTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ip_info=ip_info, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrN1way=ospfIntfNbrN1way, routerLSAId=routerLSAId, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumRxHello=ospfCumRxHello, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgState=ripNewCfgState, ospfAreaTxPkts=ospfAreaTxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routeStatEntries=routeStatEntries, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoEntry=ipRouteInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwRetry=ipNewCfgGwRetry, arpStatEntries=arpStatEntries, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumRxPkts=ospfCumRxPkts, vrrp=vrrp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routeStatHighWater=routeStatHighWater, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNbrInExchState=ospfNbrInExchState, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgIfTable=vrrpNewCfgIfTable)
