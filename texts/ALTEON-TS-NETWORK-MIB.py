...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, iprouting=iprouting, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfInterface=ospfInterface, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ip_info=ip_info, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfTotalNssaAreas=ospfTotalNssaAreas, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripCurCfgListen=ripCurCfgListen, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpInfoFlag=arpInfoFlag, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, arpInfoEntry=arpInfoEntry, ospfCfg=ospfCfg, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routeStatEntries=routeStatEntries, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfStats=ospfStats, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrp_info=vrrp_info, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfGeneralInfo=ospfGeneralInfo, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfHello=ospfCumIntfHello, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpStats=arpStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumRxPkts=ospfCumRxPkts, ospfProcessUptime=ospfProcessUptime, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTotalAreas=ospfTotalAreas, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ripCurCfgVip=ripCurCfgVip, arpStatHighWater=arpStatHighWater, vrrpOper=vrrpOper, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfDown=ospfIntfDown, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripStats=ripStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumNbrDown=ospfCumNbrDown, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfGeneral=ospfGeneral, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routerLSALinkID=routerLSALinkID, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipForward=ipForward, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwState=ipCurCfgGwState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpInfoTable=arpInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgListen=ripNewCfgListen, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, arpStatEntries=arpStatEntries, ospfIntfNbrDown=ospfIntfNbrDown, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripConfig=ripConfig, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfGeneralStats=ospfGeneralStats, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaTxHello=ospfAreaTxHello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaChangeStats=ospfAreaChangeStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipRouteInfoIndx=ipRouteInfoIndx, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfNbrInFullState=ospfNbrInFullState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ripStatInPkts=ripStatInPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpStats=vrrpStats, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoDestIp=arpInfoDestIp, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCurCfgAreaId=ospfCurCfgAreaId, routeStats=routeStats, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumIntfDown=ospfCumIntfDown, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgGwTable=ipCurCfgGwTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipRouteInfoGateway=ipRouteInfoGateway, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfBackup=ospfIntfBackup, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgGwInterval=ipCurCfgGwInterval, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStatInErrorPkts=ripStatInErrorPkts, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgGwIndex=ipCurCfgGwIndex, routerLSALinkIndex=routerLSALinkIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripNewCfgState=ripNewCfgState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaNbrDown=ospfAreaNbrDown, vrrpGeneral=vrrpGeneral, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrp=vrrp, ospfIntfIndex=ospfIntfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, dnsStats=dnsStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripNewCfgVip=ripNewCfgVip)
