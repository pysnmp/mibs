...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxHello=ospfIntfRxHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgListen=ripCurCfgListen, iprouting=iprouting, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumTxHello=ospfCumTxHello, ripStats=ripStats, arpStats=arpStats, ipRouteInfoMask=ipRouteInfoMask, ospfAreaTxPkts=ospfAreaTxPkts, ospfGeneral=ospfGeneral, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfLoop=ospfIntfLoop, ripNewCfgState=ripNewCfgState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrhello=ospfAreaNbrhello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxHello=ospfIntfTxHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgGwVlan=ipNewCfgGwVlan, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routerLSAId=routerLSAId, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfTxPkts=ospfIntfTxPkts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxHello=ospfAreaTxHello, vrrpOper=vrrpOper, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpStats=vrrpStats, ospfNbrInExchState=ospfNbrInExchState, ospfTotalTransitAreas=ospfTotalTransitAreas, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripNewCfgVip=ripNewCfgVip, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfUnloop=ospfIntfUnloop, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfDown=ospfIntfDown, arpStatEntries=arpStatEntries, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripStatInPkts=ripStatInPkts, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfGeneralStats=ospfGeneralStats, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSALinkID=routerLSALinkID, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfLsTypesSupported=ospfLsTypesSupported, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfInfoTable=ospfIntfInfoTable, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfinfo=ospfinfo, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumRxHello=ospfCumRxHello, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfDown=ospfAreaIntfDown, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwMetric=ipCurCfgGwMetric, routeStatEntries=routeStatEntries, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripConfig=ripConfig, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrp_info=vrrp_info, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwRetry=ipNewCfgGwRetry, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwArp=ipNewCfgGwArp, ospfInterface=ospfInterface, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTotalAreas=ospfTotalAreas, ipRouteInfoType=ipRouteInfoType, ipForward=ipForward, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfArea=ospfArea, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripCurCfgState=ripCurCfgState, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfStats=ospfStats, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrp=vrrp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgGwState=ipNewCfgGwState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfProcessUptime=ospfProcessUptime, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, dnsStats=dnsStats, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgGwTable=ipCurCfgGwTable, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfHello=ospfIntfHello, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumTxlsAcks=ospfCumTxlsAcks, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpGeneral=vrrpGeneral, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoFlag=arpInfoFlag, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCfg=ospfCfg, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoEntry=arpInfoEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ip_info=ip_info, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoDestIp=arpInfoDestIp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgGwState=ipCurCfgGwState, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipGatewayTableMax=ipGatewayTableMax, routeStats=routeStats, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaInfoIndex=ospfAreaInfoIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumRxlsAcks=ospfCumRxlsAcks, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfMask=ipCurCfgIntfMask, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSALinkData=routerLSALinkData, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCumNbrhello=ospfCumNbrhello, ipInterfaceTableMax=ipInterfaceTableMax, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumTxDatabase=ospfCumTxDatabase, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrIndex=ospfIntfNbrIndex, arpInfoRefPorts=arpInfoRefPorts, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgDefListen=ripCurCfgDefListen, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, arpInfoTable=arpInfoTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState)
