...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routeStats=routeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrhello=ospfIntfNbrhello, ospfProcessUptime=ospfProcessUptime, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, routeStatHighWater=routeStatHighWater, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoType=ipRouteInfoType, arpInfoVLAN=arpInfoVLAN, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfHello=ospfAreaIntfHello, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgSupply=ripNewCfgSupply, ospfCumTxPkts=ospfCumTxPkts, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfIndex=ospfIntfIndex, ospfTotalAreas=ospfTotalAreas, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrp=vrrp, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipRouteInfoEntry=ipRouteInfoEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfArea=ospfArea, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfGeneralInfo=ospfGeneralInfo, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCfg=ospfCfg, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwState=ipNewCfgGwState, ripConfig=ripConfig, ospfCumNbrRstAd=ospfCumNbrRstAd, dnsStats=dnsStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpStats=vrrpStats, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwInterval=ipNewCfgGwInterval, ripNewCfgDefListen=ripNewCfgDefListen, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, arpStatHighWater=arpStatHighWater, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfinfo=ospfinfo, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfBackup=ospfIntfBackup, routerLSALinkIndex=routerLSALinkIndex, ospfCumTxHello=ospfCumTxHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfGeneral=ospfGeneral, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrStart=ospfCumNbrStart, ipRouteInfoInterface=ipRouteInfoInterface, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumRxHello=ospfCumRxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaChangeStats=ospfAreaChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripStatInPkts=ripStatInPkts, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrp_info=vrrp_info, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgState=ipFwdCurCfgState, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrDown=ospfAreaNbrDown, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpInfoMacAddr=arpInfoMacAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSALinkID=routerLSALinkID, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpOper=vrrpOper, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfDown=ospfIntfDown, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumNbrhello=ospfCumNbrhello, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgState=ripNewCfgState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfLsTypesSupported=ospfLsTypesSupported)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgState=ripCurCfgState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSAId=routerLSAId, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripStatInErrorPkts=ripStatInErrorPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routeStatMaxEntries=routeStatMaxEntries, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripStatOutPkts=ripStatOutPkts, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfRxHello=ospfIntfRxHello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwRetry=ipNewCfgGwRetry, arpInfoTable=arpInfoTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpGeneral=vrrpGeneral, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgVip=ripCurCfgVip, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwIndex=ipCurCfgGwIndex, ipForward=ipForward, ipNewCfgBootpState=ipNewCfgBootpState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipRouteInfoIndx=ipRouteInfoIndx, iprouting=iprouting, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, arpStats=arpStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgBootpState=ipCurCfgBootpState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrN1way=ospfCumNbrN1way, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ip_info=ip_info, ospfAreaTxHello=ospfAreaTxHello, ospfCumTxDatabase=ospfCumTxDatabase, ripStats=ripStats, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfInfoEntry=ospfIntfInfoEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwMetric=ipNewCfgGwMetric, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfHello=ospfIntfHello, ipRouteInfoTable=ipRouteInfoTable, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumIntfHello=ospfCumIntfHello, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfStats=ospfStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumRxPkts=ospfCumRxPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoFlag=arpInfoFlag, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNbrInFullState=ospfNbrInFullState, ospfIntfLoop=ospfIntfLoop, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfGeneralStats=ospfGeneralStats, arpStatEntries=arpStatEntries, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex)
