...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrhello=ospfAreaNbrhello, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoGateway=ipRouteInfoGateway, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpStats=vrrpStats, ospfAreaRxHello=ospfAreaRxHello, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfUnloop=ospfIntfUnloop, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfInterface=ospfInterface, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrhello=ospfCumNbrhello, arpInfoVLAN=arpInfoVLAN, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpInfoFlag=arpInfoFlag, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwVlan=ipNewCfgGwVlan, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrp_info=vrrp_info, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaRxPkts=ospfAreaRxPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwState=ipNewCfgGwState, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumNbrDown=ospfCumNbrDown, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgGwMetric=ipNewCfgGwMetric, ripCurCfgSupply=ripCurCfgSupply, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipCurCfgBootpState=ipCurCfgBootpState, arpStatEntries=arpStatEntries, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwState=ipCurCfgGwState, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxDatabase=ospfCumRxDatabase, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrp=vrrp, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaIntfLoop=ospfAreaIntfLoop, arpStatMaxEntries=arpStatMaxEntries, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ripCurCfgDefListen=ripCurCfgDefListen, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfIndex=ospfIntfIndex, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routeStats=routeStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfTxHello=ospfIntfTxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfStartTime=ospfStartTime, ospfNbrInInitState=ospfNbrInInitState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaChangeStats=ospfAreaChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgListen=ripNewCfgListen, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, arpInfoRefPorts=arpInfoRefPorts, ospfCumRxTxStats=ospfCumRxTxStats, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfinfo=ospfinfo, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfGeneralStats=ospfGeneralStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaInfoId=ospfAreaInfoId, vrrpGeneral=vrrpGeneral, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgState=ripCurCfgState, dnsStats=dnsStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpStatOutAdvers=vrrpStatOutAdvers, routerLSALinkID=routerLSALinkID, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfState=ipNewCfgIntfState, ip_info=ip_info, ipCurCfgIntfState=ipCurCfgIntfState, routerLSALinkData=routerLSALinkData, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripStats=ripStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumRxHello=ospfCumRxHello, routeStatHighWater=routeStatHighWater, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoTable=arpInfoTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipForward=ipForward, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSALinkIndex=routerLSALinkIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, arpStats=arpStats, vrrpNewCfgGenState=vrrpNewCfgGenState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpStatHighWater=arpStatHighWater, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSAId=routerLSAId, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatInPkts=ripStatInPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripConfig=ripConfig, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTotalAreas=ospfTotalAreas, arpInfoMacAddr=arpInfoMacAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfBackup=ospfIntfBackup, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumTxPkts=ospfCumTxPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfArea=ospfArea, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfNbrIndex=ospfIntfNbrIndex, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCfg=ospfCfg, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfDown=ospfIntfDown, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfLoop=ospfIntfLoop, arpInfoDestIp=arpInfoDestIp, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfStats=ospfStats, ripNewCfgState=ripNewCfgState, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfHello=ospfIntfHello, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfRxPkts=ospfIntfRxPkts, ospfGeneral=ospfGeneral, arpInfoSrcPort=arpInfoSrcPort, iprouting=iprouting, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoEntry=ipRouteInfoEntry, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable)
