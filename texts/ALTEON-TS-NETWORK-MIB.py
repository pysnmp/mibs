...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaNbrStart=ospfAreaNbrStart, routerLSALinkID=routerLSALinkID, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipRouteInfoTable=ipRouteInfoTable, arpStatHighWater=arpStatHighWater, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ip_info=ip_info, ospfLsTypesSupported=ospfLsTypesSupported, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrp=vrrp, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routeStatHighWater=routeStatHighWater, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpGeneral=vrrpGeneral, iprouting=iprouting, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaRxHello=ospfAreaRxHello, ipRouteInfoType=ipRouteInfoType, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCfg=ospfCfg, arpInfoMacAddr=arpInfoMacAddr, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgBootpState=ipCurCfgBootpState, ospfStartTime=ospfStartTime, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfGeneral=ospfGeneral, ipCurCfgIntfMask=ipCurCfgIntfMask, routeStatMaxEntries=routeStatMaxEntries, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfTxHello=ospfIntfTxHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgGwTable=ipCurCfgGwTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpStats=vrrpStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfUnloop=ospfIntfUnloop, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumNbrStart=ospfCumNbrStart, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, dnsStats=dnsStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfDown=ospfIntfDown, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoTable=arpInfoTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfArea=ospfArea, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumNbrhello=ospfCumNbrhello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfHello=ospfIntfHello, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpStats=arpStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSALinkData=routerLSALinkData, ipRouteInfoMask=ipRouteInfoMask, ospfIntfBackup=ospfIntfBackup, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ripCurCfgVip=ripCurCfgVip, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpOper=vrrpOper, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgGwVlan=ipCurCfgGwVlan, ripCurCfgListen=ripCurCfgListen, ospfIntfIndex=ospfIntfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipForward=ipForward, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfProcessUptime=ospfProcessUptime, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumIntfDown=ospfCumIntfDown, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgGwArp=ipCurCfgGwArp, ripNewCfgVip=ripNewCfgVip, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoFlag=arpInfoFlag, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrN1way=ospfCumNbrN1way, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoEntry=arpInfoEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrhello=ospfIntfNbrhello, routeStats=routeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfStats=ospfStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumTxDatabase=ospfCumTxDatabase, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwRetry=ipNewCfgGwRetry, ripConfig=ripConfig, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfInterface=ospfInterface, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSAAreaIndex=routerLSAAreaIndex, vrrp_info=vrrp_info, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipRouteInfoEntry=ipRouteInfoEntry, ospfNbrInInitState=ospfNbrInInitState, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCumRxlsReqs=ospfCumRxlsReqs, ripNewCfgSupply=ripNewCfgSupply, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumRxPkts=ospfCumRxPkts, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgGwTable=ipNewCfgGwTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatInErrorPkts=ripStatInErrorPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgState=ripCurCfgState, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfGeneralStats=ospfGeneralStats, routerLSAId=routerLSAId, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, arpStatMaxEntries=arpStatMaxEntries, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripStatInPkts=ripStatInPkts, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfLoop=ospfIntfLoop, routeStatEntries=routeStatEntries, ipNewCfgGwIndex=ipNewCfgGwIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripNewCfgListen=ripNewCfgListen, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoVLAN=arpInfoVLAN, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTotalAreas=ospfTotalAreas, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripStats=ripStats, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone)
