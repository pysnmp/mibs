...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, arpStats=arpStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfProcessUptime=ospfProcessUptime, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTotalAreas=ospfTotalAreas, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwEntry=ipCurCfgGwEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfStartTime=ospfStartTime, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrp_info=vrrp_info, ospfIntfTxHello=ospfIntfTxHello, ripNewCfgState=ripNewCfgState, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfGeneral=ospfGeneral, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoSrcPort=arpInfoSrcPort, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxHello=ospfCumRxHello, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrChange=ospfIntfNbrChange, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwVlan=ipCurCfgGwVlan, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpInfoFlag=arpInfoFlag, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfNbrhello=ospfIntfNbrhello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrhello=ospfCumNbrhello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpInfoEntry=arpInfoEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfInterface=ospfInterface, ipRouteInfoTable=ipRouteInfoTable, ospfGeneralStats=ospfGeneralStats, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripCurCfgSupply=ripCurCfgSupply, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOper=vrrpOper, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxHello=ospfAreaRxHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumTxPkts=ospfCumTxPkts, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIfInfoIndex=ospfIfInfoIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfArea=ospfArea, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaTxPkts=ospfAreaTxPkts, routerLSALinkData=routerLSALinkData, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumIntfDown=ospfCumIntfDown, vrrp=vrrp, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripStatOutPkts=ripStatOutPkts, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ip_info=ip_info, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipForward=ipForward, vrrpStats=vrrpStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgState=ipFwdCurCfgState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpInfoTable=arpInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfLoop=ospfIntfLoop, iprouting=iprouting, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgBootpState=ipNewCfgBootpState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumNbrDown=ospfCumNbrDown, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipInterfaceTableMax=ipInterfaceTableMax)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, dnsStats=dnsStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwState=ipNewCfgGwState, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwAddr=ipNewCfgGwAddr, ripStats=ripStats, ospfCumRxPkts=ospfCumRxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwArp=ipCurCfgGwArp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, routerLSAId=routerLSAId, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, routeStats=routeStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routerLSALinkID=routerLSALinkID, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfHello=ospfIntfHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripConfig=ripConfig, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCfg=ospfCfg, ospfIntfRxHello=ospfIntfRxHello, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpStatEntries=arpStatEntries, ospfIntfBackup=ospfIntfBackup, ripStatInPkts=ripStatInPkts, ospfinfo=ospfinfo, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumTxDatabase=ospfCumTxDatabase, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIfWaitInterval=ospfIfWaitInterval, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoType=ipRouteInfoType, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumRxTxStats=ospfCumRxTxStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfTxDatabase=ospfIntfTxDatabase, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfTotalNeighbours=ospfTotalNeighbours, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfDown=ospfIntfDown, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrIndex=ospfIntfNbrIndex, routeStatHighWater=routeStatHighWater, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwTable=ipCurCfgGwTable, ripCurCfgState=ripCurCfgState, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfStats=ospfStats, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStatEntries=routeStatEntries, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgGwTable=ipNewCfgGwTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStatHighWater=arpStatHighWater, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipGatewayTableMax=ipGatewayTableMax, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgGenState=vrrpNewCfgGenState, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxlsAcks=ospfCumRxlsAcks, ripNewCfgVip=ripNewCfgVip)
