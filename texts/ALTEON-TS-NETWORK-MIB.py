...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Counter32, TimeTicks, Bits, Integer32, Counter64, NotificationType, ModuleIdentity, Unsigned32, iso, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Counter32", "TimeTicks", "Bits", "Integer32", "Counter64", "NotificationType", "ModuleIdentity", "Unsigned32", "iso", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpStatOutAdvers=vrrpStatOutAdvers, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfDown=ospfIntfDown, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfStartTime=ospfStartTime, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrN1way=ospfCumNbrN1way, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaTxPkts=ospfAreaTxPkts, iprouting=iprouting, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipForward=ipForward, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpOper=vrrpOper, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgState=ripCurCfgState, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumNbrDown=ospfCumNbrDown, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpStats=vrrpStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ripNewCfgListen=ripNewCfgListen, arpStatHighWater=arpStatHighWater, arpInfoEntry=arpInfoEntry, ospfCumRxDatabase=ospfCumRxDatabase, arpInfoDestIp=arpInfoDestIp, routeStatEntries=routeStatEntries, ip_info=ip_info, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfStats=ospfStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfRangeTableMaxSize=ospfRangeTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrp=vrrp, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwTable=ipNewCfgGwTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfHello=ospfIntfHello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfArea=ospfArea, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpStats=arpStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipRouteInfoMask=ipRouteInfoMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfGeneral=ospfGeneral, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown, ripNewCfgDefListen=ripNewCfgDefListen, ospfinfo=ospfinfo, ripCurCfgListen=ripCurCfgListen, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgGwArp=ipCurCfgGwArp, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfProcessUptime=ospfProcessUptime, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxHello=ospfCumTxHello, arpStatEntries=arpStatEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgSupply=ripNewCfgSupply, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwEntry=ipCurCfgGwEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfEntry=ipCurCfgIntfEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgState=ripNewCfgState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrN1way=ospfIntfNbrN1way, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrp_info=vrrp_info, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfIndex=ospfIntfIndex, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, routerLSAId=routerLSAId, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSALinkID=routerLSALinkID, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpStatInAdvers=vrrpStatInAdvers, ripConfig=ripConfig, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipRouteInfoGateway=ipRouteInfoGateway, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpGeneral=vrrpGeneral, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwState=ipCurCfgGwState, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwState=ipNewCfgGwState, routeStats=routeStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrStart=ospfIntfNbrStart, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumRxPkts=ospfCumRxPkts, ospfGeneralInfo=ospfGeneralInfo, ospfIntfUnloop=ospfIntfUnloop, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpInfoSrcPort=arpInfoSrcPort, ipGatewayTableMax=ipGatewayTableMax, ospfNbrInExchState=ospfNbrInExchState, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgVip=ripCurCfgVip, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrStart=ospfCumNbrStart, dnsStats=dnsStats, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTotalAreas=ospfTotalAreas, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkData=routerLSALinkData, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrDown=ospfIntfNbrDown, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipRouteInfoTag=ipRouteInfoTag, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCfg=ospfCfg, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaRxPkts=ospfAreaRxPkts, ripNewCfgVip=ripNewCfgVip, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfGeneralStats=ospfGeneralStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfLoop=ospfIntfLoop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ripStats=ripStats)
