...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, arpStats=arpStats, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routeStatHighWater=routeStatHighWater, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrRstAd=ospfCumNbrRstAd, arpInfoMacAddr=arpInfoMacAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpOper=vrrpOper, ospfStartTime=ospfStartTime, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSALinkID=routerLSALinkID, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrhello=ospfCumNbrhello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripStatInPkts=ripStatInPkts, ospfIntfHello=ospfIntfHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoTable=arpInfoTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrIndex=ospfIntfNbrIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfTotalAreas=ospfTotalAreas, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipRouteInfoType=ipRouteInfoType, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfIndex=ospfIntfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfTxHello=ospfIntfTxHello, ospfArea=ospfArea, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripStatOutPkts=ripStatOutPkts, ospfIntfChangeStats=ospfIntfChangeStats, ospfinfo=ospfinfo, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNbrInFullState=ospfNbrInFullState, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripCurCfgVip=ripCurCfgVip, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaTxPkts=ospfAreaTxPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfTxPkts=ospfIntfTxPkts, ripConfig=ripConfig, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfUnloop=ospfIntfUnloop, vrrp=vrrp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrDown=ospfAreaNbrDown, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgBootpAddr=ipCurCfgBootpAddr, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaInfoTable=ospfAreaInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaInfoId=ospfAreaInfoId, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfProcessUptime=ospfProcessUptime, arpInfoVLAN=arpInfoVLAN, ripNewCfgState=ripNewCfgState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipForward=ipForward, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSALinkData=routerLSALinkData, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoFlag=arpInfoFlag, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routeStatMaxEntries=routeStatMaxEntries, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfStats=ospfStats, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaTxHello=ospfAreaTxHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaInfoIndex=ospfAreaInfoIndex, iprouting=iprouting, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ip_info=ip_info, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxTxStats=ospfIntfRxTxStats, arpStatHighWater=arpStatHighWater, vrrpStats=vrrpStats, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrStart=ospfIntfNbrStart, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpStatEntries=arpStatEntries, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routeStatEntries=routeStatEntries, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, arpInfoDestIp=arpInfoDestIp, ripNewCfgListen=ripNewCfgListen, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpGeneral=vrrpGeneral, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoEntry=arpInfoEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgVip=ripNewCfgVip, routerLSALinkIndex=routerLSALinkIndex, routeStats=routeStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfLsTypesSupported=ospfLsTypesSupported, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumIntfLoop=ospfCumIntfLoop, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgState=ripCurCfgState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumTxHello=ospfCumTxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfInterface=ospfInterface, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgGwTable=ipCurCfgGwTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ripStats=ripStats, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrp_info=vrrp_info, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routerLSAId=routerLSAId, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfCfg=ospfCfg, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfDown=ospfIntfDown, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripNewCfgSupply=ripNewCfgSupply, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxPkts=ospfAreaRxPkts, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, dnsStats=dnsStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgIntfMask=ipCurCfgIntfMask, arpInfoSrcPort=arpInfoSrcPort, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxHello=ospfCumRxHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port)
