...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfDown=ospfCumIntfDown, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrhello=ospfAreaNbrhello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTotalAreas=ospfTotalAreas, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrDown=ospfCumNbrDown, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, routerLSALinkID=routerLSALinkID, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, arpStatEntries=arpStatEntries, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfState=ipCurCfgIntfState, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoTable=arpInfoTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripConfig=ripConfig, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripStatOutPkts=ripStatOutPkts, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfInterface=ospfInterface, ospfAreaTxHello=ospfAreaTxHello, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrN1way=ospfCumNbrN1way, routerLSALinkData=routerLSALinkData, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfLoop=ospfIntfLoop, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfIndex=ospfIntfIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgState=ripCurCfgState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfNbrhello=ospfIntfNbrhello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfGeneral=ospfGeneral, ripStats=ripStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCfg=ospfCfg, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgGenState=vrrpCurCfgGenState, ripCurCfgDefListen=ripCurCfgDefListen, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ip_info=ip_info, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipCurCfgGwRetry=ipCurCfgGwRetry, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpInfoFlag=arpInfoFlag, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripStatInPkts=ripStatInPkts, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpStatHighWater=arpStatHighWater, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, dnsStats=dnsStats, vrrpOper=vrrpOper, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwArp=ipNewCfgGwArp, ripCurCfgSupply=ripCurCfgSupply, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumTxHello=ospfCumTxHello, ospfinfo=ospfinfo, ospfArea=ospfArea, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfTxHello=ospfIntfTxHello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfStats=ospfStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumNbrStart=ospfCumNbrStart, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxHello=ospfCumRxHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfTxPkts=ospfIntfTxPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrp_info=vrrp_info, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routeStatHighWater=routeStatHighWater, arpStats=arpStats, ipRouteInfoEntry=ipRouteInfoEntry, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfBackup=ospfIntfBackup, ospfCurCfgAreaTable=ospfCurCfgAreaTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripNewCfgState=ripNewCfgState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, arpInfoVLAN=arpInfoVLAN, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfGeneralInfo=ospfGeneralInfo, ospfStartTime=ospfStartTime, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNbrInFullState=ospfNbrInFullState, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripNewCfgSupply=ripNewCfgSupply, ipRouteInfoType=ipRouteInfoType, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpStatMaxEntries=arpStatMaxEntries, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoTag=ipRouteInfoTag, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrStart=ospfAreaNbrStart, routeStats=routeStats, ipCurCfgBootpState=ipCurCfgBootpState, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoDestIp=arpInfoDestIp, vrrpGeneral=vrrpGeneral, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripNewCfgListen=ripNewCfgListen, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfDown=ospfIntfDown, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfDelete=ipNewCfgIntfDelete, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrp=vrrp, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipForward=ipForward, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfHello=ospfIntfHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfRxlsReqs=ospfIntfRxlsReqs, routeStatEntries=routeStatEntries, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxTxStats=ospfCumRxTxStats, iprouting=iprouting, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routerLSAId=routerLSAId, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwMetric=ipNewCfgGwMetric, ipRouteInfoTable=ipRouteInfoTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripNewCfgVip=ripNewCfgVip, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpStats=vrrpStats, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable)
