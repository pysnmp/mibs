...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfUnloop=ospfIntfUnloop, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpStats=arpStats, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfDown=ospfIntfDown, ospfIntfIndex=ospfIntfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrp=vrrp, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwEntry=ipNewCfgGwEntry, routeStatMaxEntries=routeStatMaxEntries, ospfStartTime=ospfStartTime, ospfCumNbrhello=ospfCumNbrhello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ipGatewayTableMax=ipGatewayTableMax, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwArp=ipCurCfgGwArp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfDown=ospfCumIntfDown, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgState=ripNewCfgState, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgState=ipFwdCurCfgState, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrp_info=vrrp_info, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoDestIp=arpInfoDestIp, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrStart=ospfAreaNbrStart, arpInfoVLAN=arpInfoVLAN, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfinfo=ospfinfo, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumIntfHello=ospfCumIntfHello, routerLSALinkData=routerLSALinkData, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgState=ipFwdNewCfgState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoRefPorts=arpInfoRefPorts, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwState=ipCurCfgGwState, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ip_info=ip_info, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfBackup=ospfIntfBackup, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgGwRetry=ipCurCfgGwRetry, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrDown=ospfCumNbrDown, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoMask=ipRouteInfoMask, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxPkts=ospfAreaRxPkts, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoInterface=ipRouteInfoInterface, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCfg=ospfCfg, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaTxPkts=ospfAreaTxPkts, ospfGeneral=ospfGeneral, routerLSAId=routerLSAId, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwAddr=ipNewCfgGwAddr, ripConfig=ripConfig, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrStart=ospfCumNbrStart, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNbrInFullState=ospfNbrInFullState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumRxHello=ospfCumRxHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrN1way=ospfCumNbrN1way, ripStatInErrorPkts=ripStatInErrorPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, routeStatEntries=routeStatEntries, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoTag=ipRouteInfoTag, ipRouteInfoType=ipRouteInfoType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripStats=ripStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpStatInAdvers=vrrpStatInAdvers, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, dnsStats=dnsStats, ipCurCfgGwVlan=ipCurCfgGwVlan, routeStatHighWater=routeStatHighWater, ospfIntfNbrIndex=ospfIntfNbrIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfTotalNssaAreas=ospfTotalNssaAreas, ipForward=ipForward, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfInterface=ospfInterface, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfLoop=ospfCumIntfLoop, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaNbrN1way=ospfAreaNbrN1way, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgVip=ripNewCfgVip, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfStats=ospfStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIfWaitInterval=ospfIfWaitInterval, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumTxDatabase=ospfCumTxDatabase, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routeStats=routeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, arpStatHighWater=arpStatHighWater, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpStatEntries=arpStatEntries, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOper=vrrpOper, ripCurCfgDefListen=ripCurCfgDefListen, arpInfoFlag=arpInfoFlag, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripNewCfgSupply=ripNewCfgSupply, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoEntry=arpInfoEntry, ripCurCfgListen=ripCurCfgListen, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripStatInPkts=ripStatInPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTotalTransitAreas=ospfTotalTransitAreas, routerLSALinkID=routerLSALinkID, ospfArea=ospfArea, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTotalAreas=ospfTotalAreas, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxHello=ospfCumTxHello, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpGeneral=vrrpGeneral, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, routerLSALinkIfIndex=routerLSALinkIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoTable=arpInfoTable, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgVip=ripCurCfgVip, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumTxPkts=ospfCumTxPkts, ospfIntfChangeStats=ospfIntfChangeStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex)
