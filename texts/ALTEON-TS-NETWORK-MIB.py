...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipGatewayTableMax=ipGatewayTableMax, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ripConfig=ripConfig, ripStatInPkts=ripStatInPkts, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ip_info=ip_info, ipFwdNewCfgState=ipFwdNewCfgState, vrrpGeneral=vrrpGeneral, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxDatabase=ospfIntfRxDatabase, routerLSALinkIndex=routerLSALinkIndex, ripStats=ripStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripNewCfgVip=ripNewCfgVip, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, arpStatMaxEntries=arpStatMaxEntries, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routeStatEntries=routeStatEntries, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripCurCfgState=ripCurCfgState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, routeStatHighWater=routeStatHighWater, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoFlag=arpInfoFlag, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpOper=vrrpOper, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfNbrInInitState=ospfNbrInInitState, ospfAreaRxTxStats=ospfAreaRxTxStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgVip=ripCurCfgVip, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfStartTime=ospfStartTime, arpInfoEntry=arpInfoEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgState=ripNewCfgState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfRxTxStats=ospfIntfRxTxStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoMacAddr=arpInfoMacAddr, iprouting=iprouting, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpStats=arpStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfBackup=ospfAreaIntfBackup, ripNewCfgSupply=ripNewCfgSupply, vrrpStatInAdvers=vrrpStatInAdvers, arpInfoSrcPort=arpInfoSrcPort, ipRouteInfoIndx=ipRouteInfoIndx, ripNewCfgListen=ripNewCfgListen, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfStats=ospfStats, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfinfo=ospfinfo, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwState=ipCurCfgGwState, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgState=ipFwdCurCfgState, vrrp_info=vrrp_info, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfLoop=ospfIntfLoop, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routeStatMaxEntries=routeStatMaxEntries, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaRxHello=ospfAreaRxHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, arpInfoVLAN=arpInfoVLAN, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripStatOutPkts=ripStatOutPkts, ipRouteInfoEntry=ipRouteInfoEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfTxHello=ospfIntfTxHello, ospfIfInfoIndex=ospfIfInfoIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaChangeStats=ospfAreaChangeStats, routeStats=routeStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpStats=vrrpStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgListen=ripCurCfgListen, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfArea=ospfArea, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfHello=ospfIntfHello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpStatHighWater=arpStatHighWater, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrDown=ospfIntfNbrDown, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumIntfLoop=ospfCumIntfLoop, ospfNbrInExchState=ospfNbrInExchState, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipCurCfgGwMetric=ipCurCfgGwMetric, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgDefListen=ripCurCfgDefListen, vrrp=vrrp, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipForward=ipForward, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrChange=ospfIntfNbrChange, ospfGeneralStats=ospfGeneralStats, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, routerLSALinkData=routerLSALinkData, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoTable=arpInfoTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfInterface=ospfInterface, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaNbrDown=ospfAreaNbrDown, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfRxHello=ospfIntfRxHello, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpStatEntries=arpStatEntries, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCfg=ospfCfg, ospfIntfDown=ospfIntfDown, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripStatInErrorPkts=ripStatInErrorPkts, ospfNbrInFullState=ospfNbrInFullState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumRxPkts=ospfCumRxPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaNbrhello=ospfAreaNbrhello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer)
