...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipInterfaceTableMax=ipInterfaceTableMax, arpStatHighWater=arpStatHighWater, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, arpInfoVLAN=arpInfoVLAN, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaInfoId=ospfAreaInfoId, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaTxDatabase=ospfAreaTxDatabase, arpInfoDestIp=arpInfoDestIp, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrp_info=vrrp_info, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxDatabase=ospfCumTxDatabase, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routerLSALinkID=routerLSALinkID, ospfIntfIndex=ospfIntfIndex, routeStatHighWater=routeStatHighWater, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpStats=arpStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfProcessUptime=ospfProcessUptime, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ripNewCfgState=ripNewCfgState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfUnloop=ospfIntfUnloop, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfArea=ospfArea, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpStatMaxEntries=arpStatMaxEntries, vrrp=vrrp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfGeneralStats=ospfGeneralStats, ipNewCfgGwState=ipNewCfgGwState, ospfIntfInfoEntry=ospfIntfInfoEntry, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, iprouting=iprouting, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfLoop=ospfIntfLoop, dnsStats=dnsStats, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ripStatInErrorPkts=ripStatInErrorPkts, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ip_info=ip_info, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ripStatInPkts=ripStatInPkts, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgBootpState=ipCurCfgBootpState, ospfinfo=ospfinfo, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCfg=ospfCfg, routerLSAId=routerLSAId, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipRouteInfoTag=ipRouteInfoTag, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrStart=ospfAreaNbrStart, ripStatOutPkts=ripStatOutPkts, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routeStatEntries=routeStatEntries, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdNewCfgPortState=ipFwdNewCfgPortState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumIntfDown=ospfCumIntfDown, ospfAreaTxPkts=ospfAreaTxPkts, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumRxPkts=ospfCumRxPkts, ospfIntfDown=ospfIntfDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoFlag=arpInfoFlag, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumIntfBackup=ospfCumIntfBackup, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrStart=ospfCumNbrStart, ospfTotalAreas=ospfTotalAreas, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwInterval=ipNewCfgGwInterval, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrN1way=ospfCumNbrN1way, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ripCurCfgListen=ripCurCfgListen, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgIntfMask=ipNewCfgIntfMask, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfStartTime=ospfStartTime, vrrpGeneral=vrrpGeneral, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ripStats=ripStats, ipRouteInfoType=ipRouteInfoType, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfChangeStats=ospfIntfChangeStats, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfStats=ospfStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumIntfLoop=ospfCumIntfLoop, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgVip=ripNewCfgVip, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNbrInExchState=ospfNbrInExchState, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpInfoEntry=arpInfoEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgState=ripCurCfgState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfTxHello=ospfIntfTxHello, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, ipForward=ipForward, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, routeStats=routeStats, ospfCumTxHello=ospfCumTxHello, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpStats=vrrpStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwState=ipCurCfgGwState, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc)
