...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfDown=ospfIntfDown, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routerLSAId=routerLSAId, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfGeneralStats=ospfGeneralStats, ripNewCfgVip=ripNewCfgVip, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumIntfLoop=ospfCumIntfLoop, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfLoop=ospfIntfLoop, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgState=ipFwdNewCfgState, ripStatInPkts=ripStatInPkts, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCfg=ospfCfg, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumNbrN1way=ospfCumNbrN1way, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfInterface=ospfInterface, vrrpStats=vrrpStats, ospfAreaIntfDown=ospfAreaIntfDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, routeStats=routeStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, iprouting=iprouting, ospfStartTime=ospfStartTime, ipNewCfgIntfTable=ipNewCfgIntfTable, dnsStats=dnsStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoDestIp=arpInfoDestIp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ip_info=ip_info, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrStart=ospfIntfNbrStart, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgBootpState=ipCurCfgBootpState, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfArea=ospfArea, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxDatabase=ospfCumTxDatabase, ripNewCfgSupply=ripNewCfgSupply, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfStats=ospfStats, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfLsTypesSupported=ospfLsTypesSupported, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfIndex=ospfIntfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoTable=arpInfoTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaChangeStats=ospfAreaChangeStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripNewCfgListen=ripNewCfgListen, arpInfoEntry=arpInfoEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrChange=ospfIntfNbrChange, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoTable=ipRouteInfoTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNbrInExchState=ospfNbrInExchState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrp=vrrp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgListen=ripCurCfgListen, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routeStatMaxEntries=routeStatMaxEntries, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumRxlsAcks=ospfCumRxlsAcks)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripStats=ripStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrDown=ospfCumNbrDown, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfGeneral=ospfGeneral, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routerLSALinkIndex=routerLSALinkIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, routerLSALinkData=routerLSALinkData, arpInfoFlag=arpInfoFlag, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfDown=ospfCumIntfDown, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfNbrInFullState=ospfNbrInFullState, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaInfoTable=ospfAreaInfoTable, ospfProcessUptime=ospfProcessUptime, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripCurCfgState=ripCurCfgState, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfHello=ospfIntfHello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSALinkID=routerLSALinkID, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTotalNeighbours=ospfTotalNeighbours, routerLSAAreaIndex=routerLSAAreaIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpInfoSrcPort=arpInfoSrcPort, ospfTotalAreas=ospfTotalAreas, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfInfoTable=ospfIntfInfoTable, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxPkts=ospfCumRxPkts, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgGwTable=ipCurCfgGwTable, ripConfig=ripConfig, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpGeneral=vrrpGeneral, arpStats=arpStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumTxlsUpdates=ospfCumTxlsUpdates, routeStatHighWater=routeStatHighWater, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatInErrorPkts=ripStatInErrorPkts, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipForward=ipForward, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, arpInfoMacAddr=arpInfoMacAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoIndx=ipRouteInfoIndx, ripNewCfgState=ripNewCfgState, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpStatHighWater=arpStatHighWater, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats)
