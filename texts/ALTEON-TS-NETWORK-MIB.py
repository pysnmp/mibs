...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTotalNeighbours=ospfTotalNeighbours, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumIntfHello=ospfCumIntfHello, arpStatEntries=arpStatEntries, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpStats=arpStats, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipRouteInfoMask=ipRouteInfoMask, arpInfoFlag=arpInfoFlag, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfHello=ospfIntfHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfDown=ospfIntfDown, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpInfoSrcPort=arpInfoSrcPort, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNbrInExchState=ospfNbrInExchState, ripCurCfgVip=ripCurCfgVip, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgGwState=ipCurCfgGwState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, arpInfoTable=arpInfoTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgIntfAddr=ipCurCfgIntfAddr, iprouting=iprouting, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfTable=ipCurCfgIntfTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ripStatInPkts=ripStatInPkts, ripStats=ripStats, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoTable=ospfAreaInfoTable, ospfNbrInFullState=ospfNbrInFullState, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routeStatEntries=routeStatEntries, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfRxPkts=ospfIntfRxPkts, routeStatMaxEntries=routeStatMaxEntries, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrp=vrrp, ospfStartTime=ospfStartTime, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumRxPkts=ospfCumRxPkts, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrp_info=vrrp_info, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumIntfUnloop=ospfCumIntfUnloop, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfMask=ipNewCfgIntfMask, routerLSALinkData=routerLSALinkData, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, ripNewCfgState=ripNewCfgState, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoInterface=ipRouteInfoInterface, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, routeStats=routeStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipRouteInfoTable=ipRouteInfoTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfLoop=ospfIntfLoop, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ripStatRoutesAgedOut=ripStatRoutesAgedOut, routeStatHighWater=routeStatHighWater, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routerLSAAreaIndex=routerLSAAreaIndex, routerLSALinkID=routerLSALinkID, ospfStats=ospfStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumTxlsReqs=ospfCumTxlsReqs)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumRxTxStats=ospfCumRxTxStats, ip_info=ip_info, ospfGeneral=ospfGeneral, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumRxHello=ospfCumRxHello, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipForward=ipForward, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpStatInAdvers=vrrpStatInAdvers, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripNewCfgListen=ripNewCfgListen, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgIntfState=ipCurCfgIntfState, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfinfo=ospfinfo, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumNbrN1way=ospfCumNbrN1way, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripStatOutPkts=ripStatOutPkts, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfBackup=ospfIntfBackup, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwState=ipNewCfgGwState, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripConfig=ripConfig, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripCurCfgState=ripCurCfgState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ripNewCfgVip=ripNewCfgVip, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpInfoRefPorts=arpInfoRefPorts, ripStatInErrorPkts=ripStatInErrorPkts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwTable=ipNewCfgGwTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpStats=vrrpStats, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrStart=ospfCumNbrStart, ipRouteInfoEntry=ipRouteInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, routerLSAId=routerLSAId, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumTxHello=ospfCumTxHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, dnsStats=dnsStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfIndex=ospfIntfIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaRxHello=ospfAreaRxHello, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrhello=ospfCumNbrhello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfInterface=ospfInterface, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing)
