...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfProcessUptime=ospfProcessUptime, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfLoop=ospfIntfLoop, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStatInPkts=ripStatInPkts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrN1way=ospfCumNbrN1way, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaTxDatabase=ospfAreaTxDatabase, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgIntfIndex=ipCurCfgIntfIndex, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrp=vrrp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTimersKickOffStats=ospfTimersKickOffStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripStatOutPkts=ripStatOutPkts, ipRouteInfoIndx=ipRouteInfoIndx, arpStatHighWater=arpStatHighWater, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, routeStatEntries=routeStatEntries, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumIntfLoop=ospfCumIntfLoop, ripStats=ripStats, ospfIntfInfoEntry=ospfIntfInfoEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripNewCfgVip=ripNewCfgVip, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfGeneralStats=ospfGeneralStats, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumRxPkts=ospfCumRxPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTxHello=ospfAreaTxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfArea=ospfArea, ripCurCfgVip=ripCurCfgVip, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, routerLSAId=routerLSAId, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routeStats=routeStats, arpStatEntries=arpStatEntries, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfGeneral=ospfGeneral, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTotalNeighbours=ospfTotalNeighbours, vrrp_info=vrrp_info, ipRouteInfoGateway=ipRouteInfoGateway, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, iprouting=iprouting, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdCurCfgState=ipFwdCurCfgState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfInterface=ospfInterface, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpStatMaxEntries=arpStatMaxEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfNbrInFullState=ospfNbrInFullState, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumTxlsReqs=ospfCumTxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumIntfBackup=ospfCumIntfBackup, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgBootpState=ipCurCfgBootpState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxHello=ospfCumRxHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgState=ripNewCfgState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSALinkID=routerLSALinkID, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgBootpAddr=ipNewCfgBootpAddr, dnsStats=dnsStats, ospfCumIntfDown=ospfCumIntfDown, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgIntfMask=ipNewCfgIntfMask, ripConfig=ripConfig, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrDown=ospfIntfNbrDown, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripCurCfgSupply=ripCurCfgSupply, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrStart=ospfCumNbrStart, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpOper=vrrpOper, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripNewCfgSupply=ripNewCfgSupply, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxHello=ospfAreaRxHello, ipGatewayTableMax=ipGatewayTableMax, ipRouteInfoEntry=ipRouteInfoEntry, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpStats=arpStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfStats=ospfStats, ospfIntfDown=ospfIntfDown, ospfNbrInExchState=ospfNbrInExchState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumTxlsAcks=ospfCumTxlsAcks, arpInfoFlag=arpInfoFlag, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSALinkData=routerLSALinkData, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgGwState=ipCurCfgGwState, ospfLsTypesSupported=ospfLsTypesSupported, vrrpStats=vrrpStats, ipRouteInfoTag=ipRouteInfoTag, arpInfoTable=arpInfoTable, ospfinfo=ospfinfo, ipForward=ipForward, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIfInfoIndex=ospfIfInfoIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfIndex=ospfIntfIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwIndex=ipCurCfgGwIndex, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripStatInErrorPkts=ripStatInErrorPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgListen=ripCurCfgListen, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaInfoId=ospfAreaInfoId, ospfIntfHello=ospfIntfHello, ospfNbrInInitState=ospfNbrInInitState, ip_info=ip_info, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpInfoRefPorts=arpInfoRefPorts, routeStatHighWater=routeStatHighWater, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpGeneral=vrrpGeneral, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgState=ripCurCfgState, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfStartTime=ospfStartTime, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc)
