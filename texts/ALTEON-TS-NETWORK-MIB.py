...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, ripNewCfgState=ripNewCfgState, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumNbrDown=ospfCumNbrDown, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumNbrRstAd=ospfCumNbrRstAd, ipRouteInfoMask=ipRouteInfoMask, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwIndex=ipNewCfgGwIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoRefPorts=arpInfoRefPorts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumRxHello=ospfCumRxHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumTxHello=ospfCumTxHello, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStatOutPkts=ripStatOutPkts, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfUnloop=ospfCumIntfUnloop, ipForward=ipForward, ospfCumNbrhello=ospfCumNbrhello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routerLSALinkData=routerLSALinkData, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfStats=ospfStats, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, dnsStats=dnsStats, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwInterval=ipNewCfgGwInterval, ipRouteInfoType=ipRouteInfoType, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumRxPkts=ospfCumRxPkts, ospfIntfHello=ospfIntfHello, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, arpInfoVLAN=arpInfoVLAN, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfProcessUptime=ospfProcessUptime, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaNbrStart=ospfAreaNbrStart, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpOper=vrrpOper, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routerLSALinkID=routerLSALinkID, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfLoop=ospfIntfLoop, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfInterface=ospfInterface, routerLSAId=routerLSAId, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrp_info=vrrp_info, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoTable=arpInfoTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCfg=ospfCfg, ospfNbrInExchState=ospfNbrInExchState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipGatewayTableMax=ipGatewayTableMax, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routeStatMaxEntries=routeStatMaxEntries, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfIndex=ospfIntfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipRouteInfoTag=ipRouteInfoTag, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routeStats=routeStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpStatEntries=arpStatEntries, vrrpGeneral=vrrpGeneral, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfStartTime=ospfStartTime, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, arpInfoFlag=arpInfoFlag, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpStatHighWater=arpStatHighWater, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfChangeStats=ospfIntfChangeStats, ospfinfo=ospfinfo, ospfLsTypesSupported=ospfLsTypesSupported, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpStats=arpStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfArea=ospfArea, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfNbrInFullState=ospfNbrInFullState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpStats=vrrpStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoEntry=arpInfoEntry, arpInfoMacAddr=arpInfoMacAddr, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgBootpState=ipNewCfgBootpState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ripStatInPkts=ripStatInPkts, routeStatEntries=routeStatEntries, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrhello=ospfAreaNbrhello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfGeneralStats=ospfGeneralStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfDown=ospfIntfDown, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrhello=ospfIntfNbrhello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumIntfDown=ospfCumIntfDown, ripStats=ripStats, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgGwState=ipCurCfgGwState, ospfGeneral=ospfGeneral, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipRouteInfoGateway=ipRouteInfoGateway, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ripCurCfgState=ripCurCfgState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routerLSAAreaIndex=routerLSAAreaIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxPkts=ospfCumTxPkts, iprouting=iprouting, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrp=vrrp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ip_info=ip_info, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripConfig=ripConfig, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr)
