...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfTxHello=ospfIntfTxHello, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoInterface=ipRouteInfoInterface, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfStats=ospfStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, arpInfoRefPorts=arpInfoRefPorts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxPkts=ospfAreaRxPkts, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaInfoIndex=ospfAreaInfoIndex, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgGwState=ipNewCfgGwState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpInfoTable=arpInfoTable, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfGeneral=ospfGeneral, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripConfig=ripConfig, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripStats=ripStats, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfArea=ospfArea, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripStatInPkts=ripStatInPkts, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ripNewCfgListen=ripNewCfgListen, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfWaitTimer=ospfIntfWaitTimer, ripCurCfgVip=ripCurCfgVip, arpInfoVLAN=arpInfoVLAN, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routeStatMaxEntries=routeStatMaxEntries, ospfIntfLoop=ospfIntfLoop, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrp_info=vrrp_info, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoGateway=ipRouteInfoGateway, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwIndex=ipCurCfgGwIndex, routerLSALinkIndex=routerLSALinkIndex, ripNewCfgState=ripNewCfgState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpGeneral=vrrpGeneral, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumRxPkts=ospfCumRxPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routeStatEntries=routeStatEntries, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxHello=ospfIntfRxHello, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTotalAreas=ospfTotalAreas, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwTable=ipCurCfgGwTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripCurCfgState=ripCurCfgState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfRangeTableMaxSize=ospfRangeTableMaxSize, iprouting=iprouting, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipForward=ipForward, ripNewCfgSupply=ripNewCfgSupply, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfBackup=ospfIntfBackup, dnsStats=dnsStats, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgBootpState=ipNewCfgBootpState, ospfIfInfoIndex=ospfIfInfoIndex, ipRouteInfoIndx=ipRouteInfoIndx, vrrpOper=vrrpOper, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfDown=ospfIntfDown, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoTag=ipRouteInfoTag, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgListen=ripCurCfgListen, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrStart=ospfCumNbrStart, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumTxHello=ospfCumTxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfMask=ipNewCfgIntfMask, ripStatOutPkts=ripStatOutPkts, vrrpStats=vrrpStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfinfo=ospfinfo, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripNewCfgDefListen=ripNewCfgDefListen, arpStats=arpStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoMacAddr=arpInfoMacAddr, ospfStartTime=ospfStartTime, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfProcessUptime=ospfProcessUptime, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNbrInFullState=ospfNbrInFullState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpStatHighWater=arpStatHighWater, ospfAreaRxHello=ospfAreaRxHello, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwEntry=ipNewCfgGwEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgGwInterval=ipNewCfgGwInterval, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCfg=ospfCfg, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaChangeStats=ospfAreaChangeStats, arpInfoFlag=arpInfoFlag, routerLSALinkID=routerLSALinkID, ospfIntfCountForRouter=ospfIntfCountForRouter, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfWaitInterval=ospfIfWaitInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripNewCfgVip=ripNewCfgVip, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoTable=ipRouteInfoTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoDestIp=arpInfoDestIp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumIntfBackup=ospfCumIntfBackup, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaIntfHello=ospfAreaIntfHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ip_info=ip_info, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgGwState=ipCurCfgGwState, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgAreaId=ospfNewCfgAreaId, routeStatHighWater=routeStatHighWater, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaTxlsReqs=ospfAreaTxlsReqs, routeStats=routeStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfNbrInInitState=ospfNbrInInitState, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrhello=ospfAreaNbrhello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfGeneralInfo=ospfGeneralInfo, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpStatEntries=arpStatEntries, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrp=vrrp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routerLSALinkData=routerLSALinkData, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgGwDelete=ipNewCfgGwDelete)
