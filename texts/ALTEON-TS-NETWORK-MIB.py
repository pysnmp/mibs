...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfStats=ospfStats, ipCurCfgBootpState=ipCurCfgBootpState, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipRouteInfoTable=ipRouteInfoTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSALinkID=routerLSALinkID, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfTxHello=ospfIntfTxHello, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaIntfBackup=ospfAreaIntfBackup, arpInfoTable=arpInfoTable, ospfCumRxDatabase=ospfCumRxDatabase, routeStats=routeStats, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ip_info=ip_info, vrrp=vrrp, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgVip=ripCurCfgVip, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfIndex=ospfIntfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgGwAddr=ipCurCfgGwAddr, routeStatMaxEntries=routeStatMaxEntries, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrhello=ospfAreaNbrhello, iprouting=iprouting, ripNewCfgSupply=ripNewCfgSupply, ospfIntfRxHello=ospfIntfRxHello, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrStart=ospfAreaNbrStart, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCfg=ospfCfg, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwArp=ipNewCfgGwArp, ripNewCfgState=ripNewCfgState, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgIfTable=vrrpCurCfgIfTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfInfoTable=ospfIntfInfoTable, arpInfoFlag=arpInfoFlag, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfChangeStats=ospfIntfChangeStats, ospfNbrInFullState=ospfNbrInFullState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStatHighWater=arpStatHighWater, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumTxHello=ospfCumTxHello, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfInterface=ospfInterface, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfRxPkts=ospfIntfRxPkts, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpStats=vrrpStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumNbrStart=ospfCumNbrStart, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripStats=ripStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfDown=ospfIntfDown, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, dnsStats=dnsStats, ospfinfo=ospfinfo, ospfLsTypesSupported=ospfLsTypesSupported, ipForward=ipForward, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSAId=routerLSAId, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfProcessUptime=ospfProcessUptime, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ripNewCfgVip=ripNewCfgVip, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrhello=ospfCumNbrhello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoType=ipRouteInfoType, vrrpGeneral=vrrpGeneral, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgState=ripCurCfgState, arpStats=arpStats, ospfTotalAreas=ospfTotalAreas, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripCurCfgDefListen=ripCurCfgDefListen, arpInfoRefPorts=arpInfoRefPorts, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaRxTxStats=ospfAreaRxTxStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfLoop=ospfIntfLoop, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripStatOutPkts=ripStatOutPkts, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoMask=ipRouteInfoMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfLoop=ospfCumIntfLoop, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpInfoEntry=arpInfoEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routerLSALinkData=routerLSALinkData, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgListen=ripCurCfgListen, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpOper=vrrpOper, routeStatEntries=routeStatEntries, ipCurCfgGwState=ipCurCfgGwState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxHello=ospfCumRxHello, ospfGeneral=ospfGeneral, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripConfig=ripConfig, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpStatMaxEntries=arpStatMaxEntries, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfArea=ospfArea, ospfIntfBackup=ospfIntfBackup, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaRxHello=ospfAreaRxHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripCurCfgSupply=ripCurCfgSupply, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripStatInPkts=ripStatInPkts, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete)
