...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripStats=ripStats, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenState=vrrpNewCfgGenState, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxHello=ospfAreaRxHello, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripStatInPkts=ripStatInPkts, ospfAreaInfoId=ospfAreaInfoId, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfArea=ospfArea, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfHello=ospfIntfHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfProcessUptime=ospfProcessUptime, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwAddr=ipCurCfgGwAddr, arpStatHighWater=arpStatHighWater, ospfIntfRxHello=ospfIntfRxHello, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, arpInfoDestIp=arpInfoDestIp, ipRouteInfoTag=ipRouteInfoTag, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaNbrStart=ospfAreaNbrStart, routeStatHighWater=routeStatHighWater, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoFlag=arpInfoFlag, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrp=vrrp, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfNbrDown=ospfIntfNbrDown, arpInfoSrcPort=arpInfoSrcPort, vrrpStatInAdvers=vrrpStatInAdvers, routeStatMaxEntries=routeStatMaxEntries, ospfCumIntfLoop=ospfCumIntfLoop, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumNbrhello=ospfCumNbrhello, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfIndex=ospfIntfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfinfo=ospfinfo, ripCurCfgState=ripCurCfgState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumTxPkts=ospfCumTxPkts, ripNewCfgListen=ripNewCfgListen, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpGeneral=vrrpGeneral, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfDown=ospfCumIntfDown, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumRxPkts=ospfCumRxPkts, ospfNewCfgAreaId=ospfNewCfgAreaId, ripCurCfgListen=ripCurCfgListen, routerLSAId=routerLSAId, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, arpInfoVLAN=arpInfoVLAN, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfGeneralInfo=ospfGeneralInfo, ospfTotalAreas=ospfTotalAreas, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipForward=ipForward, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpStats=arpStats, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfStartTime=ospfStartTime, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfTxPkts=ospfIntfTxPkts, ospfStats=ospfStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrChange=ospfIntfNbrChange, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routerLSALinkData=routerLSALinkData, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaNbrDown=ospfAreaNbrDown, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routeStatEntries=routeStatEntries, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, dnsStats=dnsStats, ipRouteInfoEntry=ipRouteInfoEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrN1way=ospfCumNbrN1way, arpStatEntries=arpStatEntries, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoEntry=arpInfoEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfTotalNeighbours=ospfTotalNeighbours, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwMetric=ipNewCfgGwMetric, routeStats=routeStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfDown=ospfIntfDown, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfLoop=ospfIntfLoop, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfTxHello=ospfIntfTxHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSALinkID=routerLSALinkID, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfInterface=ospfInterface, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, iprouting=iprouting, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgIntfState=ipNewCfgIntfState, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxPkts=ospfAreaRxPkts, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrhello=ospfAreaNbrhello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrN1way=ospfIntfNbrN1way, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSALinkIndex=routerLSALinkIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxPkts=ospfIntfRxPkts, ospfCumTxHello=ospfCumTxHello, ip_info=ip_info, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripConfig=ripConfig, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfNbrStart=ospfIntfNbrStart, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfUnloop=ospfIntfUnloop, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaIntfLoop=ospfAreaIntfLoop, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrp_info=vrrp_info, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpStats=vrrpStats, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumRxHello=ospfCumRxHello, ripNewCfgState=ripNewCfgState, vrrpOper=vrrpOper, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable)
