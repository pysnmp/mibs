...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgGenState=vrrpCurCfgGenState, ripStats=ripStats, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoTable=arpInfoTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSALinkData=routerLSALinkData, vrrp_info=vrrp_info, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaTxHello=ospfAreaTxHello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfUnloop=ospfIntfUnloop, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrDown=ospfCumNbrDown, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, arpInfoEntry=arpInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgIntfTable=ipNewCfgIntfTable, ripConfig=ripConfig, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfHello=ospfIntfHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfGeneral=ospfGeneral, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxHello=ospfAreaRxHello, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumIntfBackup=ospfCumIntfBackup, ripNewCfgState=ripNewCfgState, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwVlan=ipNewCfgGwVlan, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpStats=vrrpStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoVLAN=arpInfoVLAN, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, arpInfoMacAddr=arpInfoMacAddr, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfBackup=ospfIntfBackup, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, iprouting=iprouting, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxPkts=ospfIntfRxPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfLsTypesSupported=ospfLsTypesSupported, routeStatEntries=routeStatEntries, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfMask=ipCurCfgIntfMask, routerLSALinkIndex=routerLSALinkIndex, ripStatOutPkts=ripStatOutPkts, ipFwdCurCfgState=ipFwdCurCfgState, ripCurCfgVip=ripCurCfgVip, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrp=vrrp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripCurCfgState=ripCurCfgState, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfinfo=ospfinfo, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgGwTable=ipNewCfgGwTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrChange=ospfIntfNbrChange, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumTxPkts=ospfCumTxPkts, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumRxHello=ospfCumRxHello, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpStatEntries=arpStatEntries, ripCurCfgSupply=ripCurCfgSupply, ospfCurCfgAreaTable=ospfCurCfgAreaTable, arpStats=arpStats, ripNewCfgSupply=ripNewCfgSupply, ospfCumTxDatabase=ospfCumTxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoMask=ipRouteInfoMask, ospfIntfDown=ospfIntfDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, routerLSAId=routerLSAId, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTotalAreas=ospfTotalAreas, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumTxHello=ospfCumTxHello, arpInfoFlag=arpInfoFlag, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ripNewCfgVip=ripNewCfgVip, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpGeneral=vrrpGeneral, ospfCumRxDatabase=ospfCumRxDatabase, ipRouteInfoTable=ipRouteInfoTable, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgIntfState=ipCurCfgIntfState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ripCurCfgListen=ripCurCfgListen, ospfCumRxPkts=ospfCumRxPkts, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfArea=ospfArea, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfStats=ospfStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumIntfLoop=ospfCumIntfLoop, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatInPkts=ripStatInPkts, ospfCfg=ospfCfg, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoType=ipRouteInfoType, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfChangeStats=ospfIntfChangeStats, routeStats=routeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, routerLSALinkID=routerLSALinkID, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaChangeStats=ospfAreaChangeStats, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipGatewayTableMax=ipGatewayTableMax, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routeStatHighWater=routeStatHighWater, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgIntfMask=ipNewCfgIntfMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ip_info=ip_info, ospfGeneralStats=ospfGeneralStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipRouteInfoTag=ipRouteInfoTag, vrrpOper=vrrpOper, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpStatMaxEntries=arpStatMaxEntries, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfStartTime=ospfStartTime, ipNewCfgGwDelete=ipNewCfgGwDelete, ipInterfaceTableMax=ipInterfaceTableMax, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpStatHighWater=arpStatHighWater, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipForward=ipForward, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port)
