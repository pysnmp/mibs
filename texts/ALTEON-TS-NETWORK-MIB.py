...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxlsReqs=ospfCumTxlsReqs, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routeStats=routeStats, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfUnloop=ospfIntfUnloop, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, dnsStats=dnsStats, arpInfoEntry=arpInfoEntry, routerLSALinkID=routerLSALinkID, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpInfoVLAN=arpInfoVLAN, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfLoop=ospfIntfLoop, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxDatabase=ospfCumTxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumNbrStart=ospfCumNbrStart, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfDown=ospfIntfDown, ospfIntfNbrIndex=ospfIntfNbrIndex, ripCurCfgListen=ripCurCfgListen, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfInterface=ospfInterface, ospfAreaInfoId=ospfAreaInfoId, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNbrInExchState=ospfNbrInExchState, vrrpStats=vrrpStats, ospfIntfIndex=ospfIntfIndex, vrrpGeneral=vrrpGeneral, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCfg=ospfCfg, ospfIfInfoIndex=ospfIfInfoIndex, ospfGeneralInfo=ospfGeneralInfo, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumIntfDown=ospfCumIntfDown, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripNewCfgListen=ripNewCfgListen, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrhello=ospfIntfNbrhello, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routeStatMaxEntries=routeStatMaxEntries, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfNbrN1way=ospfIntfNbrN1way, iprouting=iprouting, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfDown=ospfAreaIntfDown, arpStatEntries=arpStatEntries, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxHello=ospfCumRxHello, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxHello=ospfAreaRxHello, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfStats=ospfStats, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgVip=ripNewCfgVip, arpStats=arpStats, routerLSALinkData=routerLSALinkData, ospfStartTime=ospfStartTime, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgState=ripCurCfgState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripStatInErrorPkts=ripStatInErrorPkts, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfTxPkts=ospfIntfTxPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpOper=vrrpOper, ospfIntfBackup=ospfIntfBackup, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrp_info=vrrp_info, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumRxPkts=ospfCumRxPkts, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoTable=ipRouteInfoTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, vrrp=vrrp, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfRxPkts=ospfIntfRxPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, arpStatHighWater=arpStatHighWater, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripNewCfgState=ripNewCfgState, routerLSALinkIndex=routerLSALinkIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoRefPorts=arpInfoRefPorts, ipForward=ipForward, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrDown=ospfIntfNbrDown, ripCurCfgSupply=ripCurCfgSupply, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgVip=ripCurCfgVip, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfNbrInFullState=ospfNbrInFullState, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrDown=ospfCumNbrDown, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, routeStatEntries=routeStatEntries, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripStatInPkts=ripStatInPkts, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripNewCfgDefListen=ripNewCfgDefListen, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpStatMaxEntries=arpStatMaxEntries, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxDatabase=ospfCumRxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routerLSAId=routerLSAId, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwTable=ipNewCfgGwTable, ospfinfo=ospfinfo, arpInfoDestIp=arpInfoDestIp, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripStats=ripStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfGeneral=ospfGeneral, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoType=ipRouteInfoType, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaIntfLoop=ospfAreaIntfLoop, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumTxPkts=ospfCumTxPkts, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfGeneralStats=ospfGeneralStats, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipRouteInfoEntry=ipRouteInfoEntry, ospfLsTypesSupported=ospfLsTypesSupported, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfArea=ospfArea, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ip_info=ip_info, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripConfig=ripConfig, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumIntfHello=ospfCumIntfHello, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface)
