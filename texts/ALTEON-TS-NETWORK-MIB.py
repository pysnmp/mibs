...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoFlag=arpInfoFlag, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ip_info=ip_info, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaTxHello=ospfAreaTxHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumIntfDown=ospfCumIntfDown, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, routeStatMaxEntries=routeStatMaxEntries, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfinfo=ospfinfo, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrhello=ospfAreaNbrhello, iprouting=iprouting, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwInterval=ipNewCfgGwInterval, arpStats=arpStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routeStatHighWater=routeStatHighWater, ospfNbrInFullState=ospfNbrInFullState, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxPkts=ospfIntfRxPkts, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfStartTime=ospfStartTime, ospfCumTxHello=ospfCumTxHello, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routerLSALinkID=routerLSALinkID, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrhello=ospfCumNbrhello, ospfIntfIndex=ospfIntfIndex, ospfGeneralInfo=ospfGeneralInfo, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, dnsStats=dnsStats, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfUnloop=ospfIntfUnloop, ospfTotalNeighbours=ospfTotalNeighbours, ipRouteInfoTag=ipRouteInfoTag, ospfAreaTxPkts=ospfAreaTxPkts, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfBackup=ospfIntfBackup, routerLSALinkData=routerLSALinkData, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfStats=ospfStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripNewCfgState=ripNewCfgState, arpStatHighWater=arpStatHighWater, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgIntfTable=ipCurCfgIntfTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, ripConfig=ripConfig, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgGwArp=ipCurCfgGwArp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfInterface=ospfInterface, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxHello=ospfAreaRxHello, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumTxPkts=ospfCumTxPkts, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrN1way=ospfCumNbrN1way, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCfg=ospfCfg, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoDestIp=arpInfoDestIp, vrrpStats=vrrpStats, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpOper=vrrpOper, ospfGeneralStats=ospfGeneralStats, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfTotalNssaAreas=ospfTotalNssaAreas, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfInfoTable=ospfIntfInfoTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfDown=ospfIntfDown, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfArea=ospfArea, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumIntfLoop=ospfCumIntfLoop, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, arpStatMaxEntries=arpStatMaxEntries, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripStatOutPkts=ripStatOutPkts, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumRxPkts=ospfCumRxPkts, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrChange=ospfIntfNbrChange, ospfNbrInInitState=ospfNbrInInitState, ripStatInPkts=ripStatInPkts, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumIntfHello=ospfCumIntfHello, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgListen=ripNewCfgListen, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfGeneral=ospfGeneral, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfLoop=ospfIntfLoop, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, arpStatEntries=arpStatEntries, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routeStatEntries=routeStatEntries, ripNewCfgDefListen=ripNewCfgDefListen, ipForward=ipForward, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumIntfBackup=ospfCumIntfBackup, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrp=vrrp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaIntfDown=ospfAreaIntfDown, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripStats=ripStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrDown=ospfIntfNbrDown, ripCurCfgState=ripCurCfgState, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaInfoIndex=ospfAreaInfoIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipGatewayTableMax=ipGatewayTableMax, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpInfoEntry=arpInfoEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTotalAreas=ospfTotalAreas, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfState=ipNewCfgIntfState, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwTable=ipNewCfgGwTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrDown=ospfCumNbrDown, arpInfoTable=arpInfoTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routerLSAId=routerLSAId, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipRouteInfoType=ipRouteInfoType, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello)
