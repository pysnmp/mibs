...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoEntry=arpInfoEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfNbrChange=ospfIntfNbrChange, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStats=arpStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwTable=ipCurCfgGwTable, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgGwTable=ipNewCfgGwTable, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumIntfHello=ospfCumIntfHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfDown=ospfIntfDown, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfChangeStats=ospfIntfChangeStats, routerLSALinkID=routerLSALinkID, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpStats=vrrpStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgBootpState=ipCurCfgBootpState, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfGeneralInfo=ospfGeneralInfo, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNewCfgAreaId=ospfNewCfgAreaId, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfinfo=ospfinfo, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, routerLSALinkIndex=routerLSALinkIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrhello=ospfAreaNbrhello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripNewCfgDefListen=ripNewCfgDefListen, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routeStats=routeStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgGwVlan=ipNewCfgGwVlan, ripStatInPkts=ripStatInPkts, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgGwState=ipNewCfgGwState, dnsStats=dnsStats, ospfIntfRxHello=ospfIntfRxHello, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipRouteInfoInterface=ipRouteInfoInterface, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumTxPkts=ospfCumTxPkts, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenState=vrrpCurCfgGenState, ipForward=ipForward, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ip_info=ip_info, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaInfoId=ospfAreaInfoId, ipRouteInfoMask=ipRouteInfoMask, ospfGeneral=ospfGeneral, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfGeneralStats=ospfGeneralStats, ospfProcessUptime=ospfProcessUptime, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrDown=ospfAreaNbrDown, arpStatHighWater=arpStatHighWater, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, iprouting=iprouting, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpInfoFlag=arpInfoFlag, ospfNbrInFullState=ospfNbrInFullState, vrrp_info=vrrp_info, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSALinkData=routerLSALinkData, ospfTotalAreas=ospfTotalAreas, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTotalTransitAreas=ospfTotalTransitAreas, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipRouteInfoGateway=ipRouteInfoGateway, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, arpInfoTable=arpInfoTable, ipNewCfgIntfState=ipNewCfgIntfState, ripNewCfgState=ripNewCfgState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaIntfHello=ospfAreaIntfHello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfBackup=ospfIntfBackup, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfNbrInExchState=ospfNbrInExchState)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpOper=vrrpOper, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrN1way=ospfCumNbrN1way, ospfNbrInInitState=ospfNbrInInitState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxTxStats=ospfCumRxTxStats, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfUnloop=ospfCumIntfUnloop, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripConfig=ripConfig, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgGwAddr=ipCurCfgGwAddr, ripNewCfgSupply=ripNewCfgSupply, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripStats=ripStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfTxHello=ospfIntfTxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfHello=ospfIntfHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ripCurCfgVip=ripCurCfgVip, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrp=vrrp, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpInfoMacAddr=arpInfoMacAddr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipRouteInfoType=ipRouteInfoType, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrhello=ospfIntfNbrhello, ospfInterface=ospfInterface, ospfIfInfoIndex=ospfIfInfoIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfStats=ospfStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoSrcPort=arpInfoSrcPort, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumRxHello=ospfCumRxHello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routeStatEntries=routeStatEntries, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgListen=ripNewCfgListen, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgState=ripCurCfgState, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpGeneral=vrrpGeneral, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumRxDatabase=ospfCumRxDatabase, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask)
