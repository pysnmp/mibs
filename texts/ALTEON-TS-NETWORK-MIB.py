...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrChange=ospfIntfNbrChange, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, iprouting=iprouting, routerLSALinkIndex=routerLSALinkIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipRouteInfoEntry=ipRouteInfoEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfTxDatabase=ospfIntfTxDatabase, arpInfoTable=arpInfoTable, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpInfoFlag=arpInfoFlag, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ripNewCfgVip=ripNewCfgVip, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipRouteInfoType=ipRouteInfoType, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfChangeStats=ospfIntfChangeStats, ospfIfWaitInterval=ospfIfWaitInterval, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfDown=ospfIntfDown, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgGwEntry=ipNewCfgGwEntry, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrp=vrrp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipForward=ipForward, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaNbrhello=ospfAreaNbrhello, ripStatOutPkts=ripStatOutPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumIntfUnloop=ospfCumIntfUnloop, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpStatEntries=arpStatEntries, ipRouteInfoMask=ipRouteInfoMask, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfGeneralInfo=ospfGeneralInfo, ospfCumRxPkts=ospfCumRxPkts, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripStatInPkts=ripStatInPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfGeneral=ospfGeneral, routerLSALinkID=routerLSALinkID, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrIndex=ospfIntfNbrIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipRouteInfoTable=ipRouteInfoTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfRxHello=ospfIntfRxHello, ospfCumRxlsReqs=ospfCumRxlsReqs, arpInfoDestIp=arpInfoDestIp, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrDown=ospfCumNbrDown, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrp_info=vrrp_info, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ripCurCfgListen=ripCurCfgListen, ospfAreaIntfHello=ospfAreaIntfHello, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgGwEntry=ipCurCfgGwEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfStats=ospfStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, dnsStats=dnsStats, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripNewCfgState=ripNewCfgState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ripCurCfgDefListen=ripCurCfgDefListen, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routeStatHighWater=routeStatHighWater, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfLoop=ospfIntfLoop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwDelete=ipNewCfgGwDelete, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfTxHello=ospfIntfTxHello, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ip_info=ip_info, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfState=ipCurCfgIntfState, ripCurCfgVip=ripCurCfgVip, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfNbrhello=ospfIntfNbrhello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfinfo=ospfinfo, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfInfoTable=ospfIntfInfoTable, routeStats=routeStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumRxTxStats=ospfCumRxTxStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfBackup=ospfIntfBackup, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumRxHello=ospfCumRxHello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfProcessUptime=ospfProcessUptime, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfNbrInInitState=ospfNbrInInitState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfGeneralStats=ospfGeneralStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, routeStatEntries=routeStatEntries, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgGwState=ipCurCfgGwState, arpStats=arpStats, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgGwRetry=ipCurCfgGwRetry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpStatHighWater=arpStatHighWater, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgGwInterval=ipNewCfgGwInterval, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripStats=ripStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfArea=ospfArea, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgGwState=ipNewCfgGwState, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoVLAN=arpInfoVLAN, ospfAreaInfoId=ospfAreaInfoId, vrrpOper=vrrpOper, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumRxDatabase=ospfCumRxDatabase, vrrpGeneral=vrrpGeneral, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTotalAreas=ospfTotalAreas, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumTxPkts=ospfCumTxPkts, ospfAreaTxHello=ospfAreaTxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfHello=ospfIntfHello, ospfStartTime=ospfStartTime, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumTxHello=ospfCumTxHello, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrStart=ospfCumNbrStart, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx)
