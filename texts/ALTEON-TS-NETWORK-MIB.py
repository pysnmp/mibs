...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxTxStats=ospfCumRxTxStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfDown=ospfIntfDown, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwArp=ipNewCfgGwArp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumTxlsAcks=ospfCumTxlsAcks, iprouting=iprouting, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpStatInAdvers=vrrpStatInAdvers, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ripNewCfgVip=ripNewCfgVip, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgGwState=ipNewCfgGwState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, routeStats=routeStats, ospfAreaRxHello=ospfAreaRxHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgGwRetry=ipNewCfgGwRetry, ripStatInPkts=ripStatInPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxHello=ospfCumTxHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgState=ripCurCfgState, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routeStatEntries=routeStatEntries, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpGeneral=vrrpGeneral, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgListen=ripNewCfgListen, ospfIntfTxHello=ospfIntfTxHello, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routeStatHighWater=routeStatHighWater, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTotalAreas=ospfTotalAreas, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgGwInterval=ipCurCfgGwInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoEntry=arpInfoEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoDestIp=arpInfoDestIp, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipForward=ipForward, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, dnsStats=dnsStats, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfGeneralStats=ospfGeneralStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrp_info=vrrp_info, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwVlan=ipCurCfgGwVlan, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfArea=ospfArea, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfInfoTable=ospfIntfInfoTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfinfo=ospfinfo, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoTag=ipRouteInfoTag, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ip_info=ip_info, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipGatewayTableMax=ipGatewayTableMax, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaInfoId=ospfAreaInfoId, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipRouteInfoType=ipRouteInfoType, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrp=vrrp, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routerLSAId=routerLSAId, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwAddr=ipNewCfgGwAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrN1way=ospfCumNbrN1way, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfIndex=ospfIntfIndex, ospfCumNbrhello=ospfCumNbrhello, routerLSALinkID=routerLSALinkID, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfStartTime=ospfStartTime, ospfHostTableMaxSize=ospfHostTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ripCurCfgListen=ripCurCfgListen, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripConfig=ripConfig, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpStats=arpStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipRouteInfoGateway=ipRouteInfoGateway, arpStatHighWater=arpStatHighWater, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfLoop=ospfIntfLoop, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpInfoVLAN=arpInfoVLAN, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrDown=ospfAreaNbrDown, vrrpStats=vrrpStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripCurCfgVip=ripCurCfgVip, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripStats=ripStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripNewCfgSupply=ripNewCfgSupply, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpStatEntries=arpStatEntries, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwVlan=ipNewCfgGwVlan, arpInfoFlag=arpInfoFlag, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumRxHello=ospfCumRxHello, ospfInterface=ospfInterface, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumRxDatabase=ospfCumRxDatabase, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfHello=ospfIntfHello, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripNewCfgState=ripNewCfgState, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfProcessUptime=ospfProcessUptime, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpOper=vrrpOper, ospfStats=ospfStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTmrsKckOffHello=ospfTmrsKckOffHello)
