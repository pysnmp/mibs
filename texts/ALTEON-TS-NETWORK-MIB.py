...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpStats=vrrpStats, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripNewCfgSupply=ripNewCfgSupply, ripStatInPkts=ripStatInPkts, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ipRouteInfoTag=ipRouteInfoTag, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripConfig=ripConfig, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfProcessUptime=ospfProcessUptime, ospfCfg=ospfCfg, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfUnloop=ospfIntfUnloop, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrp_info=vrrp_info, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgGwState=ipCurCfgGwState, ipForward=ipForward, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoMacAddr=arpInfoMacAddr, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripStats=ripStats, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfinfo=ospfinfo, routeStatHighWater=routeStatHighWater, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfStartTime=ospfStartTime, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfInterface=ospfInterface, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfTxHello=ospfIntfTxHello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumNbrhello=ospfCumNbrhello, ipRouteInfoTable=ipRouteInfoTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgBootpAddr=ipCurCfgBootpAddr, routerLSAId=routerLSAId, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfBackup=ospfIntfBackup, ospfTimersKickOffStats=ospfTimersKickOffStats, routerLSALinkIndex=routerLSALinkIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ripCurCfgState=ripCurCfgState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgGwState=ipNewCfgGwState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumIntfHello=ospfCumIntfHello, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpInfoTable=arpInfoTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTotalAreas=ospfTotalAreas, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfStats=ospfStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoEntry=arpInfoEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgGenState=vrrpNewCfgGenState, routeStats=routeStats, vrrpOper=vrrpOper, ospfArea=ospfArea, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumRxHello=ospfCumRxHello, arpInfoDestIp=arpInfoDestIp, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, arpStats=arpStats, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNbrInFullState=ospfNbrInFullState, ospfNbrInExchState=ospfNbrInExchState, ospfIntfNbrStart=ospfIntfNbrStart, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfHello=ospfIntfHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgVip=ripCurCfgVip, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwMetric=ipCurCfgGwMetric, iprouting=iprouting, ip_info=ip_info, ipNewCfgGwRetry=ipNewCfgGwRetry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ripCurCfgListen=ripCurCfgListen, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwArp=ipNewCfgGwArp, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwAddr=ipCurCfgGwAddr, ripStatOutPkts=ripStatOutPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaTxHello=ospfAreaTxHello, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTotalNeighbours=ospfTotalNeighbours, arpInfoFlag=arpInfoFlag, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpStatEntries=arpStatEntries, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgGwTable=ipCurCfgGwTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrp=vrrp, ipCurCfgIntfState=ipCurCfgIntfState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpInfoRefPorts=arpInfoRefPorts, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpStatHighWater=arpStatHighWater, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoVLAN=arpInfoVLAN, ospfCumIntfDown=ospfCumIntfDown, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgGwTable=ipNewCfgGwTable, ospfCumRxDatabase=ospfCumRxDatabase, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrhello=ospfIntfNbrhello, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfLoop=ospfIntfLoop, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, dnsStats=dnsStats, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgState=ipFwdNewCfgState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumTxHello=ospfCumTxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaIntfDown=ospfAreaIntfDown, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripNewCfgListen=ripNewCfgListen, ospfNbrInInitState=ospfNbrInInitState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfIndex=ospfIntfIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ripNewCfgVip=ripNewCfgVip, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgGwAddr=ipNewCfgGwAddr, routerLSALinkID=routerLSALinkID, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex)
