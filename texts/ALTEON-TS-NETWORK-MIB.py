...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrDown=ospfCumNbrDown, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfTxPkts=ospfIntfTxPkts, dnsStats=dnsStats, ospfNbrInFullState=ospfNbrInFullState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgGwState=ipCurCfgGwState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfGeneralInfo=ospfGeneralInfo, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaTxHello=ospfAreaTxHello, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNbrInInitState=ospfNbrInInitState, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ripStats=ripStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrhello=ospfIntfNbrhello, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpInfoTable=arpInfoTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumRxDatabase=ospfCumRxDatabase, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, arpInfoDestIp=arpInfoDestIp, vrrp_info=vrrp_info, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgGwTable=ipCurCfgGwTable, arpStats=arpStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfBackup=ospfIntfBackup, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgGwTable=ipNewCfgGwTable, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgGwIndex=ipNewCfgGwIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumNbrStart=ospfCumNbrStart, ospfIntfTxHello=ospfIntfTxHello, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfUnloop=ospfCumIntfUnloop, routeStatMaxEntries=routeStatMaxEntries, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrhello=ospfCumNbrhello, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaNbrhello=ospfAreaNbrhello, vrrp=vrrp, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgGwVlan=ipCurCfgGwVlan, ripConfig=ripConfig, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgState=ripCurCfgState, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCfg=ospfCfg, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routeStatEntries=routeStatEntries, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNbrInExchState=ospfNbrInExchState, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routerLSAId=routerLSAId, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, iprouting=iprouting, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxPkts=ospfCumTxPkts, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpStatMaxEntries=arpStatMaxEntries, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIfWaitInterval=ospfIfWaitInterval, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfStats=ospfStats, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipForward=ipForward, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpOper=vrrpOper, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumIntfDown=ospfCumIntfDown, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfProcessUptime=ospfProcessUptime, ipRouteInfoTag=ipRouteInfoTag, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumRxTxStats=ospfCumRxTxStats, routerLSALinkID=routerLSALinkID, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpGeneral=vrrpGeneral, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripStatInErrorPkts=ripStatInErrorPkts, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoMacAddr=arpInfoMacAddr, ripNewCfgListen=ripNewCfgListen, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipNewCfgBootpState=ipNewCfgBootpState, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfHello=ospfIntfHello, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripCurCfgDefListen=ripCurCfgDefListen, ip_info=ip_info, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routeStats=routeStats, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfUnloop=ospfIntfUnloop, arpInfoVLAN=arpInfoVLAN, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfState=ipCurCfgIntfState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpInfoFlag=arpInfoFlag, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfArea=ospfArea, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipRouteInfoTable=ipRouteInfoTable, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoEntry=arpInfoEntry, ipRouteInfoMask=ipRouteInfoMask, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaInfoTable=ospfAreaInfoTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfIndex=ospfAreaIntfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfDown=ospfIntfDown, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgBootpState=ipCurCfgBootpState, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwAddr=ipCurCfgGwAddr, arpInfoSrcPort=arpInfoSrcPort, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripStatInPkts=ripStatInPkts, routerLSALinkIndex=routerLSALinkIndex, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp)
