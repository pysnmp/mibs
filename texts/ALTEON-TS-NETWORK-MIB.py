...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumNbrDown=ospfCumNbrDown, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripCurCfgListen=ripCurCfgListen, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwArp=ipNewCfgGwArp, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaNbrhello=ospfAreaNbrhello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumNbrN1way=ospfCumNbrN1way, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwMetric=ipNewCfgGwMetric, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfStartTime=ospfStartTime, vrrp=vrrp, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumTxHello=ospfCumTxHello, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ripStats=ripStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxPkts=ospfAreaRxPkts, ripStatInPkts=ripStatInPkts, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfNbrStart=ospfIntfNbrStart, ospfIntfInfoTable=ospfIntfInfoTable, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrhello=ospfCumNbrhello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpStatHighWater=arpStatHighWater, ospfIntfIndex=ospfIntfIndex, ipRouteInfoTag=ipRouteInfoTag, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripCurCfgState=ripCurCfgState, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfTxlsAcks=ospfIntfTxlsAcks, routerLSALinkData=routerLSALinkData, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpInfoMacAddr=arpInfoMacAddr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumTxDatabase=ospfCumTxDatabase, ospfTotalNeighbours=ospfTotalNeighbours, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipRouteInfoIndx=ipRouteInfoIndx, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ip_info=ip_info, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfStats=ospfStats, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ripNewCfgSupply=ripNewCfgSupply, ospfIntfLoop=ospfIntfLoop, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfGeneral=ospfGeneral, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaTxHello=ospfAreaTxHello, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfHello=ospfIntfHello, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpGeneral=vrrpGeneral, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumRxlsAcks=ospfCumRxlsAcks, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrp_info=vrrp_info, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routerLSAId=routerLSAId, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, dnsStats=dnsStats, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrStart=ospfAreaNbrStart, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfCountForRouter=ospfIntfCountForRouter, arpStatEntries=arpStatEntries, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfNewCfgAreaId=ospfNewCfgAreaId, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfChangeStats=ospfCumIntfChangeStats, arpInfoEntry=arpInfoEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, routerLSAAreaIndex=routerLSAAreaIndex, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrStart=ospfCumNbrStart, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNbrInFullState=ospfNbrInFullState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, arpInfoVLAN=arpInfoVLAN, ripStatRoutesAgedOut=ripStatRoutesAgedOut, arpInfoSrcPort=arpInfoSrcPort, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgBootpState=ipCurCfgBootpState, ripConfig=ripConfig, ipCurCfgGwTable=ipCurCfgGwTable, arpInfoFlag=arpInfoFlag, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgIfTable=vrrpCurCfgIfTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipInterfaceTableMax=ipInterfaceTableMax, arpInfoTable=arpInfoTable, ripStatOutPkts=ripStatOutPkts, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpStats=vrrpStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfBackup=ospfIntfBackup, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripStatInErrorPkts=ripStatInErrorPkts, iprouting=iprouting, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfinfo=ospfinfo, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routeStatMaxEntries=routeStatMaxEntries, ospfIntfDown=ospfIntfDown, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgGwState=ipNewCfgGwState, ospfAreaInfoId=ospfAreaInfoId, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpOper=vrrpOper, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwVlan=ipNewCfgGwVlan, arpStats=arpStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumIntfHello=ospfCumIntfHello, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumIntfBackup=ospfCumIntfBackup, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwState=ipCurCfgGwState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipRouteInfoMask=ipRouteInfoMask, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipRouteInfoEntry=ipRouteInfoEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoDestIp=arpInfoDestIp, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, routeStats=routeStats, ospfIfWaitInterval=ospfIfWaitInterval, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripNewCfgState=ripNewCfgState, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpStatMaxEntries=arpStatMaxEntries, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, routeStatHighWater=routeStatHighWater, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaIntfHello=ospfAreaIntfHello, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfInterface=ospfInterface, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfArea=ospfArea, ospfIfInfoIndex=ospfIfInfoIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNbrInInitState=ospfNbrInInitState, ipRouteInfoTable=ipRouteInfoTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport)
