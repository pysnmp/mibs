...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpStatMaxEntries=arpStatMaxEntries, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, routerLSAId=routerLSAId, ospfAreaInfoId=ospfAreaInfoId, arpStats=arpStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoGateway=ipRouteInfoGateway, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipRouteInfoMask=ipRouteInfoMask, ospfCumTxlsAcks=ospfCumTxlsAcks, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfBackup=ospfIntfBackup, ripConfig=ripConfig, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgGenState=vrrpCurCfgGenState, ripNewCfgSupply=ripNewCfgSupply, routeStatMaxEntries=routeStatMaxEntries, ospfInterface=ospfInterface, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, routerLSALinkData=routerLSALinkData, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumTxHello=ospfCumTxHello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpInfoFlag=arpInfoFlag, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOper=vrrpOper, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoTable=ipRouteInfoTable, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfNbrInExchState=ospfNbrInExchState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripStatOutPkts=ripStatOutPkts, ipRouteInfoInterface=ipRouteInfoInterface, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpInfoTable=arpInfoTable, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgIntfState=ipNewCfgIntfState, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ripStats=ripStats, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgGwTable=ipCurCfgGwTable, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipGatewayTableMax=ipGatewayTableMax, ospfStats=ospfStats, ospfArea=ospfArea, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaInfoEntry=ospfAreaInfoEntry, ipRouteInfoType=ipRouteInfoType, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfHello=ospfIntfHello, ospfCumIntfDown=ospfCumIntfDown, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgListen=ripNewCfgListen, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipRouteInfoIndx=ipRouteInfoIndx, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpGeneral=vrrpGeneral, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfTimersKickOffStats=ospfTimersKickOffStats, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipFwdCurCfgState=ipFwdCurCfgState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaTxPkts=ospfAreaTxPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, dnsStats=dnsStats, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, iprouting=iprouting, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgGwState=ipNewCfgGwState, ripNewCfgVip=ripNewCfgVip, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfDown=ospfIntfDown, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTotalNeighbours=ospfTotalNeighbours, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfRxHello=ospfIntfRxHello, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfinfo=ospfinfo, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoTable=ospfAreaInfoTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxHello=ospfAreaRxHello, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNbrInInitState=ospfNbrInInitState, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripNewCfgStaticSupply=ripNewCfgStaticSupply)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, arpStatEntries=arpStatEntries, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrp=vrrp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfRxTxStats=ospfIntfRxTxStats, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCfg=ospfCfg, vrrp_info=vrrp_info, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaIntfDown=ospfAreaIntfDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxDatabase=ospfCumRxDatabase, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipForward=ipForward, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgState=ripCurCfgState, ospfCumNbrRstAd=ospfCumNbrRstAd, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpStats=vrrpStats, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfGeneral=ospfGeneral, routeStatHighWater=routeStatHighWater, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoDestIp=arpInfoDestIp, ospfAreaNbrStart=ospfAreaNbrStart, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, arpStatHighWater=arpStatHighWater, ipRouteInfoEntry=ipRouteInfoEntry, ospfIntfNbrChange=ospfIntfNbrChange, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripCurCfgListen=ripCurCfgListen, ospfIntfIndex=ospfIntfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ripNewCfgState=ripNewCfgState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwEntry=ipNewCfgGwEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, routeStats=routeStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfLoop=ospfIntfLoop, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfState=ipCurCfgIntfState, routerLSALinkID=routerLSALinkID, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ip_info=ip_info, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripStatInPkts=ripStatInPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry)
