...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfIndex=ospfAreaIntfIndex, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, arpInfoFlag=arpInfoFlag, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumIntfHello=ospfCumIntfHello, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpStats=arpStats, ospfIntfUnloop=ospfIntfUnloop, ipRouteInfoTag=ipRouteInfoTag, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routerLSALinkIndex=routerLSALinkIndex, vrrpOper=vrrpOper, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgState=ripNewCfgState, ipRouteInfoType=ipRouteInfoType, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipRouteInfoMask=ipRouteInfoMask, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripStatInPkts=ripStatInPkts, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfTotalTransitAreas=ospfTotalTransitAreas, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfNbrInExchState=ospfNbrInExchState, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfCumTxHello=ospfCumTxHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfinfo=ospfinfo, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripStats=ripStats, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, arpInfoSrcPort=arpInfoSrcPort, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipInterfaceTableMax=ipInterfaceTableMax, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrp_info=vrrp_info, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, iprouting=iprouting, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgGwState=ipCurCfgGwState, ipRouteInfoTable=ipRouteInfoTable, ospfCumTxPkts=ospfCumTxPkts, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfIntfHello=ospfIntfHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrp=vrrp, ipForward=ipForward, routeStatEntries=routeStatEntries, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ripNewCfgSupply=ripNewCfgSupply, ripStatOutPkts=ripStatOutPkts, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNbrInFullState=ospfNbrInFullState, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgGwVlan=ipNewCfgGwVlan, ipFwdNewCfgState=ipFwdNewCfgState, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routerLSAId=routerLSAId, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgIntfState=ipNewCfgIntfState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTotalAreas=ospfTotalAreas, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpStats=vrrpStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfIndex=ospfIntfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfGeneral=ospfGeneral, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ripNewCfgDefListen=ripNewCfgDefListen, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgState=ripCurCfgState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpGeneral=vrrpGeneral, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgGwInterval=ipNewCfgGwInterval, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxHello=ospfIntfRxHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfArea=ospfArea, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoDestIp=arpInfoDestIp, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumRxHello=ospfCumRxHello, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, arpStatMaxEntries=arpStatMaxEntries, routerLSALinkData=routerLSALinkData, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfBackup=ospfIntfBackup, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfInterface=ospfInterface, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, arpStatHighWater=arpStatHighWater, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, routerLSALinkIfIndex=routerLSALinkIfIndex, ripCurCfgSupply=ripCurCfgSupply, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumNbrDown=ospfCumNbrDown, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfAreaInfoTable=ospfAreaInfoTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfChangeStats=ospfIntfChangeStats, arpInfoEntry=arpInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumRxPkts=ospfCumRxPkts, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrStart=ospfAreaNbrStart, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, routerLSALinkID=routerLSALinkID, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpInfoTable=arpInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfNbrDown=ospfIntfNbrDown, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, arpStatEntries=arpStatEntries, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, routeStats=routeStats, ripNewCfgVip=ripNewCfgVip, routeStatHighWater=routeStatHighWater, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgGwArp=ipNewCfgGwArp, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfGeneralStats=ospfGeneralStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaInfoEntry=ospfAreaInfoEntry, ripConfig=ripConfig, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwIndex=ipCurCfgGwIndex, ip_info=ip_info, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfAddr=ipNewCfgIntfAddr)
