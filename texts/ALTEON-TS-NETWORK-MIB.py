...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwTable=ipCurCfgGwTable, routeStats=routeStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfBackup=ospfAreaIntfBackup, arpStats=arpStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxPkts=ospfAreaRxPkts, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ripStatInPkts=ripStatInPkts, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaTxHello=ospfAreaTxHello, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfRxHello=ospfIntfRxHello, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaIntfHello=ospfAreaIntfHello, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ip_info=ip_info, vrrp_info=vrrp_info, arpInfoTable=arpInfoTable, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routeStatEntries=routeStatEntries, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipRouteInfoTag=ipRouteInfoTag, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfNbrChange=ospfIntfNbrChange, vrrpOper=vrrpOper, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipForward=ipForward, ospfIntfHello=ospfIntfHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfStartTime=ospfStartTime, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgState=ripNewCfgState, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpStats=vrrpStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrhello=ospfCumNbrhello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNbrInExchState=ospfNbrInExchState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCfg=ospfCfg, arpInfoFlag=arpInfoFlag, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfStats=ospfStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ripCurCfgSupply=ripCurCfgSupply, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfGeneralInfo=ospfGeneralInfo, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfInfoTable=ospfIntfInfoTable, routerLSALinkID=routerLSALinkID, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfArea=ospfArea, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrhello=ospfIntfNbrhello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripCurCfgState=ripCurCfgState, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfGeneralStats=ospfGeneralStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripStatOutPkts=ripStatOutPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumTxPkts=ospfCumTxPkts, ospfProcessUptime=ospfProcessUptime, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaInfoTable=ospfAreaInfoTable, vrrpStatInAdvers=vrrpStatInAdvers, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoEntry=arpInfoEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfWaitTimer=ospfIntfWaitTimer, ipInterfaceTableMax=ipInterfaceTableMax, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrN1way=ospfIntfNbrN1way, arpStatEntries=arpStatEntries, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, routerLSAId=routerLSAId, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumRxPkts=ospfCumRxPkts, ospfIntfIndex=ospfIntfIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfTotalAreas=ospfTotalAreas, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfinfo=ospfinfo, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipRouteInfoTable=ipRouteInfoTable, arpInfoVLAN=arpInfoVLAN, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, iprouting=iprouting, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpInfoMacAddr=arpInfoMacAddr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfVlinkCountForRouter=ospfVlinkCountForRouter, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripNewCfgSupply=ripNewCfgSupply, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpStatOutAdvers=vrrpStatOutAdvers, ipRouteInfoType=ipRouteInfoType, ripConfig=ripConfig, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrhello=ospfAreaNbrhello, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipFwdNewCfgState=ipFwdNewCfgState, ospfInterface=ospfInterface, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, routerLSAAreaIndex=routerLSAAreaIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfLoop=ospfIntfLoop, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgGwState=ipNewCfgGwState, ripStats=ripStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfGeneral=ospfGeneral, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfLsTypesSupported=ospfLsTypesSupported, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpInfoDestIp=arpInfoDestIp, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgBootpState=ipCurCfgBootpState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipRouteInfoMask=ipRouteInfoMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfInfoEntry=ospfIntfInfoEntry, routerLSALinkData=routerLSALinkData, ripCurCfgVip=ripCurCfgVip, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumRxHello=ospfCumRxHello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgGwInterval=ipCurCfgGwInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, dnsStats=dnsStats, ripCurCfgListen=ripCurCfgListen, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfTxHello=ospfIntfTxHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, arpStatHighWater=arpStatHighWater, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpStatMaxEntries=arpStatMaxEntries, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrp=vrrp, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgGwDelete=ipNewCfgGwDelete, ripNewCfgVip=ripNewCfgVip, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpGeneral=vrrpGeneral, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgState=ipFwdCurCfgState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routeStatHighWater=routeStatHighWater, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrStart=ospfAreaNbrStart, ospfNbrInInitState=ospfNbrInInitState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaChangeStats=ospfAreaChangeStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing)
