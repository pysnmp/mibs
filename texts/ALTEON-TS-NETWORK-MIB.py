...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatInErrorPkts=ripStatInErrorPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumTxDatabase=ospfCumTxDatabase, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgState=ipFwdCurCfgState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, routerLSALinkIndex=routerLSALinkIndex, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpStatEntries=arpStatEntries, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgIntfMask=ipNewCfgIntfMask, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxHello=ospfIntfTxHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfGeneralInfo=ospfGeneralInfo, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrStart=ospfCumNbrStart, ospfTmrsKckOffHello=ospfTmrsKckOffHello, routerLSAAreaIndex=routerLSAAreaIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrp=vrrp, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, ip_info=ip_info, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpStatInAdvers=vrrpStatInAdvers, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, arpInfoRefPorts=arpInfoRefPorts, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaIntfHello=ospfAreaIntfHello, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwState=ipCurCfgGwState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgGwState=ipNewCfgGwState, routeStatHighWater=routeStatHighWater, ipCurCfgBootpState=ipCurCfgBootpState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaTxPkts=ospfAreaTxPkts, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfRxPkts=ospfIntfRxPkts, ospfGeneralStats=ospfGeneralStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, dnsStats=dnsStats, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgIfTable=vrrpCurCfgIfTable, routerLSALinkData=routerLSALinkData, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripStatOutPkts=ripStatOutPkts, ospfGeneral=ospfGeneral, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgStaticSupply=ripNewCfgStaticSupply, arpStatHighWater=arpStatHighWater, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripStatInPkts=ripStatInPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, arpInfoFlag=arpInfoFlag, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgState=ipFwdNewCfgState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfArea=ospfArea, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfDown=ospfAreaIntfDown, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpInfoSrcPort=arpInfoSrcPort, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipInterfaceTableMax=ipInterfaceTableMax, routerLSAId=routerLSAId, arpInfoTable=arpInfoTable, iprouting=iprouting, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, arpStatMaxEntries=arpStatMaxEntries, ripStats=ripStats, ospfAreaTxHello=ospfAreaTxHello, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrp_info=vrrp_info, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumIntfDown=ospfCumIntfDown, ripConfig=ripConfig, ospfCumIntfBackup=ospfCumIntfBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoEntry=arpInfoEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipRouteInfoType=ipRouteInfoType, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipForward=ipForward, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIfWaitInterval=ospfIfWaitInterval, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfRxlsAcks=ospfIntfRxlsAcks, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoMask=ipRouteInfoMask, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSALinkID=routerLSALinkID, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrDown=ospfAreaNbrDown, ospfinfo=ospfinfo, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNbrInExchState=ospfNbrInExchState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoDestIp=arpInfoDestIp, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTimersKickOffStats=ospfTimersKickOffStats, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwTable=ipNewCfgGwTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoTable=ipRouteInfoTable, ospfTotalAreas=ospfTotalAreas, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIntfRxTxStats=ospfIntfRxTxStats, ripCurCfgListen=ripCurCfgListen, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrhello=ospfIntfNbrhello, arpStats=arpStats, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxHello=ospfIntfRxHello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfBackup=ospfIntfBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, routeStats=routeStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, routeStatEntries=routeStatEntries, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfInterface=ospfInterface, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgVip=ripNewCfgVip, ospfStats=ospfStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripNewCfgState=ripNewCfgState, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCumRxPkts=ospfCumRxPkts, ospfIntfDown=ospfIntfDown, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpGeneral=vrrpGeneral, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNbrInFullState=ospfNbrInFullState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfHello=ospfIntfHello, ospfAreaIntfLoop=ospfAreaIntfLoop)
