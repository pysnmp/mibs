...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ip_info=ip_info, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgIntfTable=ipCurCfgIntfTable, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgVip=ripNewCfgVip, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpGeneral=vrrpGeneral, ipRouteInfoGateway=ipRouteInfoGateway, arpInfoRefPorts=arpInfoRefPorts, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdCurCfgState=ipFwdCurCfgState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfStats=ospfStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, dnsStats=dnsStats, ospfGeneralStats=ospfGeneralStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfLoop=ospfIntfLoop, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ospfNbrInInitState=ospfNbrInInitState, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfIndex=ospfIntfIndex, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfinfo=ospfinfo, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, arpInfoTable=arpInfoTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routeStatHighWater=routeStatHighWater, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfGeneralInfo=ospfGeneralInfo, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumIntfLoop=ospfCumIntfLoop, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfNewCfgAreaId=ospfNewCfgAreaId, ripNewCfgSupply=ripNewCfgSupply, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxHello=ospfAreaRxHello, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfIndex=ospfAreaIntfIndex, arpStats=arpStats, arpStatEntries=arpStatEntries, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgPortState=ipFwdCurCfgPortState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrp=vrrp, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfTxPkts=ospfIntfTxPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrStart=ospfCumNbrStart, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaTxHello=ospfAreaTxHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripStats=ripStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, routerLSALinkID=routerLSALinkID, arpInfoEntry=arpInfoEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, iprouting=iprouting, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfDown=ospfIntfDown, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumRxDatabase=ospfCumRxDatabase, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCfg=ospfCfg, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfCountForRouter=ospfIntfCountForRouter, arpStatHighWater=arpStatHighWater, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ripNewCfgState=ripNewCfgState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipForward=ipForward, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrhello=ospfIntfNbrhello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ripStatInPkts=ripStatInPkts, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfHello=ospfIntfHello, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routerLSAAreaIndex=routerLSAAreaIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfLsTypesSupported=ospfLsTypesSupported, ipRouteInfoType=ipRouteInfoType, ospfIntfRxHello=ospfIntfRxHello, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfArea=ospfArea, ospfCumRxHello=ospfCumRxHello, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxDatabase=ospfCumTxDatabase, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrN1way=ospfIntfNbrN1way, ripConfig=ripConfig, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpStats=vrrpStats, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfRxPkts=ospfIntfRxPkts, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, routeStatEntries=routeStatEntries, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfBackup=ospfIntfBackup, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaChangeStats=ospfAreaChangeStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrp_info=vrrp_info, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfInterface=ospfInterface, ospfCumNbrDown=ospfCumNbrDown, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgGwTable=ipNewCfgGwTable, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfDown=ospfCumIntfDown, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTotalAreas=ospfTotalAreas, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumNbrN1way=ospfCumNbrN1way, routeStats=routeStats, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpInfoVLAN=arpInfoVLAN, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumRxPkts=ospfCumRxPkts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgBootpState=ipNewCfgBootpState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripStatInErrorPkts=ripStatInErrorPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaInfoTable=ospfAreaInfoTable, ipRouteInfoTable=ipRouteInfoTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfGeneral=ospfGeneral, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSAId=routerLSAId, arpInfoFlag=arpInfoFlag, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaRxPkts=ospfAreaRxPkts, vrrpStatInAdvers=vrrpStatInAdvers, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripCurCfgState=ripCurCfgState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfStartTime=ospfStartTime, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipGatewayTableMax=ipGatewayTableMax, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripCurCfgVip=ripCurCfgVip, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfTableMaxSize=ospfIntfTableMaxSize)
