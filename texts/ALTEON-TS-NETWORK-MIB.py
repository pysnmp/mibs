...
Gauge32, ModuleIdentity, iso, Bits, TimeTicks, Unsigned32, NotificationType, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "iso", "Bits", "TimeTicks", "Unsigned32", "NotificationType", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoIndx=ipRouteInfoIndx, ospfinfo=ospfinfo, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfGeneralStats=ospfGeneralStats, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpOper=vrrpOper, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpStats=vrrpStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaIntfDown=ospfAreaIntfDown, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfArea=ospfArea, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrp_info=vrrp_info, ospfCumNbrhello=ospfCumNbrhello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgSupply=ripNewCfgSupply, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfTotalAreas=ospfTotalAreas, ospfIntfBackup=ospfIntfBackup, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumNbrStart=ospfCumNbrStart, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpInfoFlag=arpInfoFlag, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIfWaitInterval=ospfIfWaitInterval, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfChangeStats=ospfIntfChangeStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfHello=ospfIntfHello, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaInfoTable=ospfAreaInfoTable, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfStats=ospfStats, ripConfig=ripConfig, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxHello=ospfCumTxHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumNbrDown=ospfCumNbrDown, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaChangeStats=ospfAreaChangeStats, ripStats=ripStats, arpStats=arpStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgVip=ripCurCfgVip, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfNbrhello=ospfIntfNbrhello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, iprouting=iprouting, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfTotalNeighbours=ospfTotalNeighbours, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwState=ipCurCfgGwState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCumRxTxStats=ospfCumRxTxStats, routerLSALinkData=routerLSALinkData, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgState=ripCurCfgState, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfState=ipCurCfgIntfState, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgVip=ripNewCfgVip)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSALinkID=routerLSALinkID, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfLoop=ospfIntfLoop, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaIntfHello=ospfAreaIntfHello, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrp=vrrp, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ripStatOutPkts=ripStatOutPkts, routeStatHighWater=routeStatHighWater, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaRxDatabase=ospfAreaRxDatabase, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNbrInFullState=ospfNbrInFullState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ripStatInPkts=ripStatInPkts, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCfg=ospfCfg, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, arpStatEntries=arpStatEntries, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfIndex=ospfIntfIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpStatHighWater=arpStatHighWater, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfState=ipNewCfgIntfState, ipForward=ipForward, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrDown=ospfAreaNbrDown, vrrpGeneral=vrrpGeneral, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoTable=arpInfoTable, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routerLSALinkIfIndex=routerLSALinkIfIndex, arpInfoDestIp=arpInfoDestIp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgGwVlan=ipNewCfgGwVlan, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgState=ripNewCfgState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumIntfDown=ospfCumIntfDown, arpStatMaxEntries=arpStatMaxEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfStartTime=ospfStartTime, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumRxPkts=ospfCumRxPkts, ospfCumTxDatabase=ospfCumTxDatabase, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, routeStatEntries=routeStatEntries, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, routeStats=routeStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routerLSAId=routerLSAId, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfInterface=ospfInterface, ipCurCfgGwEntry=ipCurCfgGwEntry, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ip_info=ip_info, ripNewCfgListen=ripNewCfgListen, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfRxPkts=ospfIntfRxPkts, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrN1way=ospfCumNbrN1way, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize)
