...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgState=ipFwdCurCfgState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaIntfHello=ospfAreaIntfHello, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrp_info=vrrp_info, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumNbrN1way=ospfCumNbrN1way, ospfProcessUptime=ospfProcessUptime, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfStats=ospfStats, ipCurCfgIntfState=ipCurCfgIntfState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSALinkID=routerLSALinkID, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routeStats=routeStats, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfNbrInInitState=ospfNbrInInitState, routerLSAAreaIndex=routerLSAAreaIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpGeneral=vrrpGeneral, ripCurCfgListen=ripCurCfgListen, ospfArea=ospfArea, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ripConfig=ripConfig, ospfAreaNbrDown=ospfAreaNbrDown, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCumNbrhello=ospfCumNbrhello, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfNbrN1way=ospfIntfNbrN1way, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, arpStats=arpStats, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpStatInAdvers=vrrpStatInAdvers, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoType=ipRouteInfoType, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumIntfHello=ospfCumIntfHello, ospfCumRxHello=ospfCumRxHello, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripStats=ripStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaChangeStats=ospfAreaChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, iprouting=iprouting, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfInterface=ospfInterface, ospfIntfHello=ospfIntfHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgGwArp=ipCurCfgGwArp, ipForward=ipForward, routerLSALinkData=routerLSALinkData, routeStatHighWater=routeStatHighWater, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfStartTime=ospfStartTime, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrp=vrrp, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfDown=ospfIntfDown, arpInfoMacAddr=arpInfoMacAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripNewCfgState=ripNewCfgState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgState=ipFwdNewCfgState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIfWaitInterval=ospfIfWaitInterval, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOper=vrrpOper, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCurCfgAreaId=ospfCurCfgAreaId, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoEntry=arpInfoEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrStart=ospfCumNbrStart, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCfg=ospfCfg, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumRxTxStats=ospfCumRxTxStats, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrDown=ospfIntfNbrDown, ospfinfo=ospfinfo, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrDown=ospfCumNbrDown, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, arpInfoDestIp=arpInfoDestIp, ospfAreaInfoId=ospfAreaInfoId, vrrpStats=vrrpStats, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgDefListen=ripNewCfgDefListen, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ripNewCfgSupply=ripNewCfgSupply, arpInfoTable=arpInfoTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwTable=ipNewCfgGwTable, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpInfoFlag=arpInfoFlag, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwTable=ipCurCfgGwTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routeStatEntries=routeStatEntries, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, routeStatMaxEntries=routeStatMaxEntries, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfNbrInExchState=ospfNbrInExchState, arpInfoVLAN=arpInfoVLAN, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfLoop=ospfIntfLoop, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, routerLSAId=routerLSAId, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripNewCfgListen=ripNewCfgListen, arpStatHighWater=arpStatHighWater, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxHello=ospfIntfRxHello, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfGeneral=ospfGeneral, ip_info=ip_info, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfGeneralInfo=ospfGeneralInfo, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfIndex=ospfIntfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumTxHello=ospfCumTxHello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ripStatInPkts=ripStatInPkts, dnsStats=dnsStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoTable=ipRouteInfoTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumTxDatabase=ospfCumTxDatabase, arpInfoRefPorts=arpInfoRefPorts, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex)
