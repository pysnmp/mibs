...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routeStatEntries=routeStatEntries, vrrpOper=vrrpOper, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripStatInPkts=ripStatInPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaIntfDown=ospfAreaIntfDown, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfArea=ospfArea, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrp_info=vrrp_info, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaInfoIndex=ospfAreaInfoIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrRstAd=ospfIntfNbrRstAd, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCurCfgAreaId=ospfCurCfgAreaId, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrhello=ospfIntfNbrhello, ripNewCfgSupply=ripNewCfgSupply, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrN1way=ospfCumNbrN1way, arpStatHighWater=arpStatHighWater, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpInfoMacAddr=arpInfoMacAddr, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipRouteInfoMask=ipRouteInfoMask, ripNewCfgDefListen=ripNewCfgDefListen, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgState=ripNewCfgState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripStatInErrorPkts=ripStatInErrorPkts, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpStatEntries=arpStatEntries, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfBackup=ospfCumIntfBackup, ospfTotalAreas=ospfTotalAreas, arpInfoDestIp=arpInfoDestIp, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ripNewCfgListen=ripNewCfgListen, routerLSAId=routerLSAId, ipCurCfgGwVlan=ipCurCfgGwVlan, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfChangeStats=ospfIntfChangeStats, iprouting=iprouting, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumRxPkts=ospfCumRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ripCurCfgVip=ripCurCfgVip, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripStatOutPkts=ripStatOutPkts, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripConfig=ripConfig, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ripNewCfgVip=ripNewCfgVip, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrStart=ospfAreaNbrStart, ospfNbrInExchState=ospfNbrInExchState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routeStatHighWater=routeStatHighWater, ospfCumRxTxStats=ospfCumRxTxStats, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStatMaxEntries=arpStatMaxEntries, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaInfoId=ospfAreaInfoId, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfStats=ospfStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgIntfVlan=ipCurCfgIntfVlan)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrhello=ospfAreaNbrhello, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpStats=vrrpStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfUnloop=ospfIntfUnloop, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumNbrDown=ospfCumNbrDown, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfDown=ospfIntfDown, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfGeneral=ospfGeneral, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSALinkID=routerLSALinkID, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipNewCfgGwArp=ipNewCfgGwArp, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripStats=ripStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfHello=ospfIntfHello, ospfinfo=ospfinfo, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipInterfaceTableMax=ipInterfaceTableMax, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfGeneralStats=ospfGeneralStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipForward=ipForward, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipRouteInfoTable=ipRouteInfoTable, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumIntfDown=ospfCumIntfDown, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxHello=ospfCumRxHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwDelete=ipNewCfgGwDelete, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfStartTime=ospfStartTime, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfAreaTxPkts=ospfAreaTxPkts, ipRouteInfoType=ipRouteInfoType, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrp=vrrp, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routerLSALinkIndex=routerLSALinkIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgState=ripCurCfgState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxHello=ospfAreaRxHello, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfTxHello=ospfIntfTxHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ip_info=ip_info, ipCurCfgBootpState=ipCurCfgBootpState, routerLSALinkData=routerLSALinkData, ospfIntfLoop=ospfIntfLoop, arpInfoEntry=arpInfoEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrStart=ospfCumNbrStart, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, dnsStats=dnsStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCumTxPkts=ospfCumTxPkts, ospfIntfBackup=ospfIntfBackup, ospfIntfNbrDown=ospfIntfNbrDown, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, routeStats=routeStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpGeneral=vrrpGeneral, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc)
