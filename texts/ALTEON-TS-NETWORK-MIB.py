...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaChangeStats=ospfAreaChangeStats, ipForward=ipForward, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgGwTable=ipNewCfgGwTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpInfoEntry=arpInfoEntry, arpInfoTable=arpInfoTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaTxPkts=ospfAreaTxPkts, ospfArea=ospfArea, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, routeStatHighWater=routeStatHighWater, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipRouteInfoInterface=ipRouteInfoInterface, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfInfoTable=ospfIntfInfoTable, routeStatEntries=routeStatEntries, ospfIntfBackup=ospfIntfBackup, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCumIntfBackup=ospfCumIntfBackup, ospfProcessUptime=ospfProcessUptime, ospfNbrInFullState=ospfNbrInFullState, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfCountForRouter=ospfIntfCountForRouter, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripStatOutPkts=ripStatOutPkts, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfHello=ospfIntfHello, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripConfig=ripConfig, ripNewCfgListen=ripNewCfgListen, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, arpStats=arpStats, ospfIntfInfoEntry=ospfIntfInfoEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfStartTime=ospfStartTime, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ipInterfaceTableMax=ipInterfaceTableMax, ripNewCfgSupply=ripNewCfgSupply, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfNbrInInitState=ospfNbrInInitState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpStatOutAdvers=vrrpStatOutAdvers, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIntfNbrDown=ospfIntfNbrDown, routeStatMaxEntries=routeStatMaxEntries, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routerLSALinkID=routerLSALinkID, arpInfoRefPorts=arpInfoRefPorts, routerLSAAreaIndex=routerLSAAreaIndex, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfRxDatabase=ospfIntfRxDatabase, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfIndex=ospfIntfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrDown=ospfCumNbrDown, ospfStats=ospfStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaNbrStart=ospfAreaNbrStart, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSAId=routerLSAId, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrp_info=vrrp_info, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumNbrhello=ospfCumNbrhello, ripStatInPkts=ripStatInPkts, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumIntfUnloop=ospfCumIntfUnloop, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgGwTable=ipCurCfgGwTable, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwState=ipNewCfgGwState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrp=vrrp, ripCurCfgState=ripCurCfgState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfTotalAreas=ospfTotalAreas, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumTxDatabase=ospfCumTxDatabase, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrIndex=ospfIntfNbrIndex)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxTxStats=ospfAreaRxTxStats, ripCurCfgSupply=ripCurCfgSupply, ripStatInErrorPkts=ripStatInErrorPkts, ospfCfg=ospfCfg, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipRouteInfoDestIp=ipRouteInfoDestIp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgListen=ripCurCfgListen, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumIntfLoop=ospfCumIntfLoop, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfLoop=ospfIntfLoop, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfRxHello=ospfIntfRxHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxPkts=ospfCumRxPkts, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoVLAN=arpInfoVLAN, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaIntfDown=ospfAreaIntfDown, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwArp=ipNewCfgGwArp, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpOper=vrrpOper, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfGeneralInfo=ospfGeneralInfo, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfGeneralStats=ospfGeneralStats, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, iprouting=iprouting, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routeStats=routeStats, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfGeneral=ospfGeneral, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpStats=vrrpStats, arpStatHighWater=arpStatHighWater, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfInterface=ospfInterface, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgVip=ripCurCfgVip, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfCumRxHello=ospfCumRxHello, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpGeneral=vrrpGeneral, arpInfoFlag=arpInfoFlag, ip_info=ip_info, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, routerLSALinkData=routerLSALinkData, ospfCumIntfChangeStats=ospfCumIntfChangeStats, dnsStats=dnsStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCumIntfHello=ospfCumIntfHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgState=ripNewCfgState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ripStats=ripStats, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority)
