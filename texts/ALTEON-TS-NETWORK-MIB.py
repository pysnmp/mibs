...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfStartTime=ospfStartTime, ospfIntfDown=ospfIntfDown, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routeStatHighWater=routeStatHighWater, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgBootpState=ipCurCfgBootpState, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfWaitTimer=ospfIntfWaitTimer, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTotalAreas=ospfTotalAreas, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumNbrN1way=ospfCumNbrN1way, ospfCfg=ospfCfg, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfChangeStats=ospfIntfChangeStats, arpStatEntries=arpStatEntries, ospfAreaChangeStats=ospfAreaChangeStats, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipRouteInfoMask=ipRouteInfoMask, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCumTxPkts=ospfCumTxPkts, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripNewCfgDefListen=ripNewCfgDefListen, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, dnsStats=dnsStats, ipNewCfgGwAddr=ipNewCfgGwAddr, arpInfoTable=arpInfoTable, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaInfoEntry=ospfAreaInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfTotalNssaAreas=ospfTotalNssaAreas, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfArea=ospfArea, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfCountForRouter=ospfIntfCountForRouter, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, routeStatEntries=routeStatEntries, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripConfig=ripConfig, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routerLSALinkID=routerLSALinkID, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgListen=ripNewCfgListen, ospfInterface=ospfInterface, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routerLSALinkData=routerLSALinkData, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfState=ipNewCfgIntfState, ipRouteInfoType=ipRouteInfoType, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfStats=ospfStats, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfIndex=ospfAreaIntfIndex, routerLSAId=routerLSAId, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfGeneralStats=ospfGeneralStats, ospfIntfRxHello=ospfIntfRxHello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTotalNeighbours=ospfTotalNeighbours, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfinfo=ospfinfo, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpGeneral=vrrpGeneral, ripCurCfgListen=ripCurCfgListen, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripNewCfgSupply=ripNewCfgSupply, ospfCumIntfUnloop=ospfCumIntfUnloop, ipGatewayTableMax=ipGatewayTableMax, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwState=ipNewCfgGwState, ripCurCfgSupply=ripCurCfgSupply, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumRxPkts=ospfCumRxPkts, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfTxlsReqs=ospfIntfTxlsReqs, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfTxHello=ospfIntfTxHello, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfLoop=ospfIntfLoop, ipCurCfgGwState=ipCurCfgGwState, routeStats=routeStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoEntry=arpInfoEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumTxlsAcks=ospfCumTxlsAcks, ripStatInPkts=ripStatInPkts, ripStatOutPkts=ripStatOutPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumTxDatabase=ospfCumTxDatabase, arpInfoDestIp=arpInfoDestIp, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripStats=ripStats, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routerLSALinkIndex=routerLSALinkIndex, ospfIntfHello=ospfIntfHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwMetric=ipCurCfgGwMetric, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, arpInfoVLAN=arpInfoVLAN, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrDown=ospfCumNbrDown, vrrp_info=vrrp_info, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ripNewCfgState=ripNewCfgState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwArp=ipCurCfgGwArp, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfRxDatabase=ospfIntfRxDatabase, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, arpStatHighWater=arpStatHighWater, vrrpOper=vrrpOper, vrrpStats=vrrpStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, iprouting=iprouting, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrp=vrrp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipForward=ipForward, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ip_info=ip_info, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfGeneral=ospfGeneral, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumIntfDown=ospfCumIntfDown, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpInfoFlag=arpInfoFlag, ipRouteInfoTag=ipRouteInfoTag, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, arpStats=arpStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfBackup=ospfIntfBackup, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfLoop=ospfCumIntfLoop)
