...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpStats=arpStats, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpStats=vrrpStats, ospfIfInfoIndex=ospfIfInfoIndex, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumRxDatabase=ospfCumRxDatabase, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCfg=ospfCfg, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumIntfLoop=ospfCumIntfLoop, iprouting=iprouting, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, arpInfoDestIp=arpInfoDestIp, ripCurCfgListen=ripCurCfgListen, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSAAreaIndex=routerLSAAreaIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfIndex=ospfIntfIndex, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdCurCfgState=ipFwdCurCfgState, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfArea=ospfArea, ospfIntfNbrhello=ospfIntfNbrhello, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipRouteInfoEntry=ipRouteInfoEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ripCurCfgState=ripCurCfgState, vrrpStatInAdvers=vrrpStatInAdvers, routerLSAId=routerLSAId, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfRxTxStats=ospfIntfRxTxStats, arpInfoSrcPort=arpInfoSrcPort, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, routerLSALinkIndex=routerLSALinkIndex, ospfIntfDown=ospfIntfDown, ipForward=ipForward, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripStatOutPkts=ripStatOutPkts, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipNewCfgGwState=ipNewCfgGwState, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrIndex=ospfAreaNbrIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoType=ipRouteInfoType, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfCountForRouter=ospfIntfCountForRouter, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfGeneral=ospfGeneral, routerLSALinkData=routerLSALinkData, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfNbrInFullState=ospfNbrInFullState, vrrpOper=vrrpOper, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxPkts=ospfIntfRxPkts, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfState=ipNewCfgIntfState, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgGwArp=ipNewCfgGwArp, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routeStats=routeStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ip_info=ip_info, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfUnloop=ospfIntfUnloop, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgIfTable=vrrpNewCfgIfTable, routeStatEntries=routeStatEntries, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrp=vrrp, dnsStats=dnsStats, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrStart=ospfAreaNbrStart, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfDown=ospfAreaIntfDown, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, arpInfoTable=arpInfoTable, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfState=ipCurCfgIntfState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfVlan=ipNewCfgIntfVlan)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpStatMaxEntries=arpStatMaxEntries, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfInterface=ospfInterface, ospfCumTxDatabase=ospfCumTxDatabase, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpInfoEntry=arpInfoEntry, ospfCumNbrhello=ospfCumNbrhello, ospfinfo=ospfinfo, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ripStats=ripStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ripNewCfgListen=ripNewCfgListen, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipGatewayTableMax=ipGatewayTableMax, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgBootpState=ipCurCfgBootpState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ripConfig=ripConfig, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaNbrhello=ospfAreaNbrhello, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxlsReqs=ospfCumTxlsReqs, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumRxPkts=ospfCumRxPkts, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgSupply=ripNewCfgSupply, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfNbrDown=ospfIntfNbrDown, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfChangeStats=ospfIntfChangeStats, vrrp_info=vrrp_info, arpStatHighWater=arpStatHighWater, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfBackup=ospfIntfBackup, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfStartTime=ospfStartTime, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumRxlsUpdates=ospfCumRxlsUpdates, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipRouteInfoMask=ipRouteInfoMask, arpStatEntries=arpStatEntries, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrN1way=ospfIntfNbrN1way, arpInfoFlag=arpInfoFlag, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrChange=ospfIntfNbrChange, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routerLSALinkID=routerLSALinkID, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipRouteInfoIndx=ipRouteInfoIndx, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumRxTxStats=ospfCumRxTxStats, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpGeneral=vrrpGeneral, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfStats=ospfStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfHello=ospfIntfHello, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfAreaRxPkts=ospfAreaRxPkts, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfRxHello=ospfIntfRxHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ripStatInPkts=ripStatInPkts, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routeStatHighWater=routeStatHighWater, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup)
