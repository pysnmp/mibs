...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaTxHello=ospfAreaTxHello, ospfInterface=ospfInterface, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipRouteInfoType=ipRouteInfoType, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgIntfState=ipCurCfgIntfState, ipForward=ipForward, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpOper=vrrpOper, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfCurCfgAreaId=ospfCurCfgAreaId, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumTxPkts=ospfCumTxPkts, ospfAreaChangeStats=ospfAreaChangeStats, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfTotalNssaAreas=ospfTotalNssaAreas, ripStatInPkts=ripStatInPkts, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoInterface=ipRouteInfoInterface, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgState=ipFwdCurCfgState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfTxHello=ospfIntfTxHello, ospfNbrInFullState=ospfNbrInFullState, ip_info=ip_info, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNbrInInitState=ospfNbrInInitState, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIfInfoIndex=ospfIfInfoIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumNbrhello=ospfCumNbrhello, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfStats=ospfStats, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgIntfTable=ipCurCfgIntfTable, ripCurCfgState=ripCurCfgState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumTxDatabase=ospfCumTxDatabase, arpInfoEntry=arpInfoEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripConfig=ripConfig, ospfAreaRxHello=ospfAreaRxHello, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, iprouting=iprouting, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, arpInfoTable=arpInfoTable, ospfCumIntfHello=ospfCumIntfHello, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgGwEntry=ipNewCfgGwEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, routeStatEntries=routeStatEntries, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ripNewCfgSupply=ripNewCfgSupply, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routerLSAId=routerLSAId, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpGeneral=vrrpGeneral, ospfAreaNbrhello=ospfAreaNbrhello, ospfStartTime=ospfStartTime, ospfCumNbrRstAd=ospfCumNbrRstAd, routerLSALinkID=routerLSALinkID, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaInfoTable=ospfAreaInfoTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, arpStatHighWater=arpStatHighWater, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, dnsStats=dnsStats, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumTxHello=ospfCumTxHello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfUnloop=ospfIntfUnloop, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwInterval=ipNewCfgGwInterval, routeStatMaxEntries=routeStatMaxEntries, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, routeStats=routeStats, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpStats=arpStats, ospfCfg=ospfCfg, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrStart=ospfCumNbrStart, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumNbrDown=ospfCumNbrDown, ospfNbrInExchState=ospfNbrInExchState, ospfIntfHello=ospfIntfHello, ospfAreaInfoId=ospfAreaInfoId, vrrp=vrrp, ripStats=ripStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpInfoRefPorts=arpInfoRefPorts, ospfProcessUptime=ospfProcessUptime, ospfTotalTransitAreas=ospfTotalTransitAreas, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfArea=ospfArea, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfTimersKickOffStats=ospfTimersKickOffStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoGateway=ipRouteInfoGateway, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoFlag=arpInfoFlag, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, arpInfoDestIp=arpInfoDestIp, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumNbrN1way=ospfCumNbrN1way, vrrp_info=vrrp_info, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipCurCfgGwEntry=ipCurCfgGwEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIntfNbrN1way=ospfIntfNbrN1way, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfIndex=ospfIntfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpStats=vrrpStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfGeneralStats=ospfGeneralStats, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfTotalAreas=ospfTotalAreas, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripCurCfgVip=ripCurCfgVip, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgState=ripNewCfgState, routeStatHighWater=routeStatHighWater, ipRouteInfoEntry=ipRouteInfoEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgListen=ripCurCfgListen, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumRxPkts=ospfCumRxPkts, ospfGeneralInfo=ospfGeneralInfo, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfWaitTimer=ospfIntfWaitTimer)
