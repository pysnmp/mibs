...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, routeStatHighWater=routeStatHighWater, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfGeneral=ospfGeneral, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfCumTxDatabase=ospfCumTxDatabase, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripNewCfgSupply=ripNewCfgSupply, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfProcessUptime=ospfProcessUptime, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwTable=ipCurCfgGwTable, ripCurCfgVip=ripCurCfgVip, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrStart=ospfAreaNbrStart, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfStartTime=ospfStartTime, ipFwdCurCfgState=ipFwdCurCfgState, arpStatEntries=arpStatEntries, routerLSALinkID=routerLSALinkID, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumTxHello=ospfCumTxHello, ospfCumRxTxStats=ospfCumRxTxStats, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfTotalNssaAreas=ospfTotalNssaAreas, ripStatInPkts=ripStatInPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgIntfState=ipCurCfgIntfState, ipRouteInfoEntry=ipRouteInfoEntry, arpInfoDestIp=arpInfoDestIp, ospfAreaInfoEntry=ospfAreaInfoEntry, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfHello=ospfIntfHello, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaTxHello=ospfAreaTxHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, routeStats=routeStats, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpInfoTable=arpInfoTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipNewCfgIntfState=ipNewCfgIntfState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipCurCfgGwVlan=ipCurCfgGwVlan, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumTxPkts=ospfCumTxPkts, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgBootpState=ipNewCfgBootpState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrp=vrrp, ospfIntfBackup=ospfIntfBackup, ospfinfo=ospfinfo, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumRxPkts=ospfCumRxPkts, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIfWaitInterval=ospfIfWaitInterval, ospfTotalAreas=ospfTotalAreas, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfIndex=ospfIntfIndex, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfInterface=ospfInterface, dnsStats=dnsStats, vrrpOper=vrrpOper, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routeStatMaxEntries=routeStatMaxEntries, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrStart=ospfIntfNbrStart, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumIntfHello=ospfCumIntfHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgGwState=ipNewCfgGwState, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgState=ripNewCfgState, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, arpInfoMacAddr=arpInfoMacAddr, vrrpStats=vrrpStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, arpStatMaxEntries=arpStatMaxEntries, ospfCumIntfUnloop=ospfCumIntfUnloop, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaInfoId=ospfAreaInfoId, ospfIntfLoop=ospfIntfLoop, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfArea=ospfArea, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ripStats=ripStats, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumRxlsAcks=ospfCumRxlsAcks, ipRouteInfoTag=ipRouteInfoTag, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpGeneral=vrrpGeneral)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCfg=ospfCfg, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIfInfoIndex=ospfIfInfoIndex, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routerLSALinkIndex=routerLSALinkIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ripStatOutPkts=ripStatOutPkts, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripConfig=ripConfig, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, routerLSALinkData=routerLSALinkData, ripStatInErrorPkts=ripStatInErrorPkts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrN1way=ospfAreaNbrN1way, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfInfoEntry=ospfIntfInfoEntry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipRouteInfoType=ipRouteInfoType, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxHello=ospfCumRxHello, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpStatHighWater=arpStatHighWater, ospfStats=ospfStats, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipRouteInfoMask=ipRouteInfoMask, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwEntry=ipNewCfgGwEntry, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ripNewCfgListen=ripNewCfgListen, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfIntfUnloop=ospfIntfUnloop, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, iprouting=iprouting, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfRangeTableMaxSize=ospfRangeTableMaxSize, arpInfoVLAN=arpInfoVLAN, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, routerLSAId=routerLSAId, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwAddr=ipNewCfgGwAddr, ip_info=ip_info, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrp_info=vrrp_info, ospfGeneralInfo=ospfGeneralInfo, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfDown=ospfAreaIntfDown, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaRxPkts=ospfAreaRxPkts, ipForward=ipForward, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwEntry=ipCurCfgGwEntry, ripNewCfgVip=ripNewCfgVip, ospfNbrInExchState=ospfNbrInExchState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwDelete=ipNewCfgGwDelete, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpInfoFlag=arpInfoFlag, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, arpStats=arpStats, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfHostTableMaxSize=ospfHostTableMaxSize)
