...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripNewCfgListen=ripNewCfgListen, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, arpInfoFlag=arpInfoFlag, arpInfoVLAN=arpInfoVLAN, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfHello=ospfIntfHello, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, arpStats=arpStats, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfBackup=ospfCumIntfBackup, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ip_info=ip_info, routerLSALinkIndex=routerLSALinkIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripNewCfgState=ripNewCfgState, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgAreaId=ospfCurCfgAreaId, iprouting=iprouting, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumIntfHello=ospfCumIntfHello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ripConfig=ripConfig, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, routerLSAId=routerLSAId, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfinfo=ospfinfo, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaIntfLoop=ospfAreaIntfLoop, arpStatHighWater=arpStatHighWater, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, routeStats=routeStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrStart=ospfIntfNbrStart, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumRxHello=ospfCumRxHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumIntfLoop=ospfCumIntfLoop, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwState=ipNewCfgGwState, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfGeneralStats=ospfGeneralStats, routeStatEntries=routeStatEntries, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfInterface=ospfInterface, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCfg=ospfCfg, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, arpInfoTable=arpInfoTable, ospfLsTypesSupported=ospfLsTypesSupported, ipGatewayTableMax=ipGatewayTableMax, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoEntry=arpInfoEntry, ipForward=ipForward, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfArea=ospfArea, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxHello=ospfCumTxHello, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfBackup=ospfIntfBackup, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfDown=ospfIntfDown, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxPkts=ospfCumTxPkts, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrp=vrrp, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrp_info=vrrp_info, ipCurCfgGwMetric=ipCurCfgGwMetric, routerLSALinkData=routerLSALinkData, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpInfoRefPorts=arpInfoRefPorts, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaRxTxIndex=ospfAreaRxTxIndex, routeStatHighWater=routeStatHighWater, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfTotalAreas=ospfTotalAreas, ospfNewCfgAreaId=ospfNewCfgAreaId, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIntfIndex=ospfIntfIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipInterfaceTableMax=ipInterfaceTableMax, ospfNbrInInitState=ospfNbrInInitState, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfIntfInfoTable=ospfIntfInfoTable, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrStart=ospfCumNbrStart, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfStats=ospfStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwEntry=ipNewCfgGwEntry, ipRouteInfoMask=ipRouteInfoMask, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ripStatInPkts=ripStatInPkts, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ripNewCfgVip=ripNewCfgVip, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgIntfAddr=ipNewCfgIntfAddr, routerLSALinkID=routerLSALinkID, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrStart=ospfAreaNbrStart, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfTxPkts=ospfIntfTxPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfGeneralInfo=ospfGeneralInfo, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrDown=ospfCumNbrDown, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumIntfDown=ospfCumIntfDown, ripStats=ripStats, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumTxDatabase=ospfCumTxDatabase, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfProcessUptime=ospfProcessUptime, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNbrInFullState=ospfNbrInFullState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripCurCfgListen=ripCurCfgListen, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpStatMaxEntries=arpStatMaxEntries, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaRxHello=ospfAreaRxHello, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpOper=vrrpOper, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwState=ipCurCfgGwState, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgState=ripCurCfgState, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipRouteInfoType=ipRouteInfoType, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfGeneral=ospfGeneral, vrrpNewCfgGenState=vrrpNewCfgGenState, arpStatEntries=arpStatEntries, ripCurCfgVip=ripCurCfgVip, ospfAreaRxlsAcks=ospfAreaRxlsAcks, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpInfoMacAddr=arpInfoMacAddr, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfTxHello=ospfIntfTxHello, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipNewCfgGwMetric=ipNewCfgGwMetric, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipCurCfgGwTable=ipCurCfgGwTable, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, dnsStats=dnsStats)
