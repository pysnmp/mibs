...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfCumTxHello=ospfCumTxHello, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwState=ipNewCfgGwState, ospfCumTxPkts=ospfCumTxPkts, ospfCumIntfNbrChange=ospfCumIntfNbrChange, routeStatMaxEntries=routeStatMaxEntries, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfHello=ospfCumIntfHello, ospfIntfInfoEntry=ospfIntfInfoEntry, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpInfoEntry=arpInfoEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpStats=arpStats, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfDown=ospfIntfDown, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, routerLSALinkID=routerLSALinkID, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrStart=ospfCumNbrStart, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfInfoIndex=ospfIfInfoIndex, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgIntfEntry=ipCurCfgIntfEntry, routeStats=routeStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpOper=vrrpOper, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumIntfDown=ospfCumIntfDown, ospfIntfCountForRouter=ospfIntfCountForRouter, ipRouteInfoType=ipRouteInfoType, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, arpInfoTable=arpInfoTable, ospfArea=ospfArea, ospfIntfIndex=ospfIntfIndex, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNbrInInitState=ospfNbrInInitState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenState=vrrpNewCfgGenState, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipRouteInfoMask=ipRouteInfoMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfStats=ospfStats, ospfIntfTxHello=ospfIntfTxHello, vrrp_info=vrrp_info, arpStatEntries=arpStatEntries, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfGeneral=ospfGeneral, ospfIntfRxHello=ospfIntfRxHello, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripStatInPkts=ripStatInPkts, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgGwAddr=ipNewCfgGwAddr, ripNewCfgState=ripNewCfgState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfinfo=ospfinfo, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNbrInExchState=ospfNbrInExchState, arpInfoVLAN=arpInfoVLAN, arpInfoMacAddr=arpInfoMacAddr, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpStats=vrrpStats, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfAreaIntfDown=ospfAreaIntfDown, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, routerLSALinkIfIndex=routerLSALinkIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ospfTotalNssaAreas=ospfTotalNssaAreas, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpStatMaxEntries=arpStatMaxEntries, routeStatHighWater=routeStatHighWater, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumNbrhello=ospfCumNbrhello, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumTxDatabase=ospfCumTxDatabase, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripCurCfgState=ripCurCfgState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgIntfState=ipCurCfgIntfState, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgListen=ripCurCfgListen, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrStart=ospfIntfNbrStart, routerLSAId=routerLSAId, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipFwdCurCfgPortState=ipFwdCurCfgPortState, arpInfoFlag=arpInfoFlag)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfBackup=ospfIntfBackup, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrp=vrrp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfGeneralStats=ospfGeneralStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStatOutPkts=ripStatOutPkts, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ripConfig=ripConfig, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpGeneral=vrrpGeneral, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfChangeStats=ospfIntfChangeStats, arpInfoDestIp=arpInfoDestIp, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgIntfState=ipNewCfgIntfState, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdNewCfgState=ipFwdNewCfgState, ospfCumIntfChangeStats=ospfCumIntfChangeStats, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ripNewCfgSupply=ripNewCfgSupply, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaIntfLoop=ospfAreaIntfLoop, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxHello=ospfAreaRxHello, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ripCurCfgVip=ripCurCfgVip, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumRxHello=ospfCumRxHello, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaTxHello=ospfAreaTxHello, iprouting=iprouting, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoIndx=ipRouteInfoIndx, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfNbrN1way=ospfIntfNbrN1way, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfTotalAreas=ospfTotalAreas, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfStartTime=ospfStartTime, ospfCfg=ospfCfg, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripStats=ripStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfUnloop=ospfIntfUnloop, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipCurCfgGwTable=ipCurCfgGwTable, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfInterface=ospfInterface, arpInfoSrcPort=arpInfoSrcPort, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, dnsStats=dnsStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfHello=ospfIntfHello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipForward=ipForward, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrStart=ospfAreaNbrStart, ripStatInErrorPkts=ripStatInErrorPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ip_info=ip_info, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry)
