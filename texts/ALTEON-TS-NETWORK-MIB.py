...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfLoop=ospfIntfLoop, arpStatEntries=arpStatEntries, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfHello=ospfIntfHello, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfWaitTimer=ospfIntfWaitTimer, routeStatMaxEntries=routeStatMaxEntries, arpInfoDestIp=arpInfoDestIp, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfNbrInExchState=ospfNbrInExchState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgBootpState=ipNewCfgBootpState, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgListen=ripCurCfgListen, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrp=vrrp, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfTotalNeighbours=ospfTotalNeighbours, arpStatHighWater=arpStatHighWater, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCfg=ospfCfg, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipNewCfgGwState=ipNewCfgGwState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfStats=ospfStats, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfTableMaxSize=ospfIntfTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripStatInErrorPkts=ripStatInErrorPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfNbrInInitState=ospfNbrInInitState, ospfIntfUnloop=ospfIntfUnloop, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpInfoMacAddr=arpInfoMacAddr, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxPkts=ospfAreaTxPkts, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfCumNbrhello=ospfCumNbrhello, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, routeStatEntries=routeStatEntries, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfNbrInFullState=ospfNbrInFullState, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaRxPkts=ospfAreaRxPkts, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpGeneral=vrrpGeneral, ospfAreaNbrN1way=ospfAreaNbrN1way, arpStatMaxEntries=arpStatMaxEntries, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumTxHello=ospfCumTxHello, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIfInfoIndex=ospfIfInfoIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrp_info=vrrp_info, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrN1way=ospfCumNbrN1way, ospfGeneralInfo=ospfGeneralInfo, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ripNewCfgListen=ripNewCfgListen, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfIntfNbrhello=ospfIntfNbrhello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfBackup=ospfIntfBackup, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrDown=ospfAreaNbrDown, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrIndex=ospfIntfNbrIndex, routerLSAId=routerLSAId, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfinfo=ospfinfo, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, arpInfoVLAN=arpInfoVLAN, ripNewCfgSupply=ripNewCfgSupply, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfArea=ospfArea, ospfGeneralStats=ospfGeneralStats, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgGwTable=ipCurCfgGwTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgGwArp=ipNewCfgGwArp, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfBackup=ospfCumIntfBackup, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, routeStatHighWater=routeStatHighWater, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, dnsStats=dnsStats, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumRxHello=ospfCumRxHello, ipRouteInfoInterface=ipRouteInfoInterface, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgIntfMask=ipCurCfgIntfMask, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOper=vrrpOper, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, arpStats=arpStats, ripNewCfgState=ripNewCfgState, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfAreaIntfHello=ospfAreaIntfHello, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIntfIndex=ospfIntfIndex, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfProcessUptime=ospfProcessUptime, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfGeneral=ospfGeneral, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipNewCfgGwVlan=ipNewCfgGwVlan, ripNewCfgVip=ripNewCfgVip, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfTotalTransitAreas=ospfTotalTransitAreas, ip_info=ip_info, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfDown=ospfAreaIntfDown, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfRxlsReqs=ospfIntfRxlsReqs, iprouting=iprouting, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ripCurCfgSupply=ripCurCfgSupply, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfHostTableMaxSize=ospfHostTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfAreaTxHello=ospfAreaTxHello, ripCurCfgState=ripCurCfgState, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routeStats=routeStats, ipFwdNewCfgState=ipFwdNewCfgState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfCumRxPkts=ospfCumRxPkts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfNbrChange=ospfIntfNbrChange, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaChangeStats=ospfAreaChangeStats, ripStats=ripStats, ipRouteInfoMask=ipRouteInfoMask, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, arpInfoTable=arpInfoTable, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipForward=ipForward, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfLsTypesSupported=ospfLsTypesSupported, vrrpStats=vrrpStats, ospfIntfDown=ospfIntfDown, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoIndx=ipRouteInfoIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfInterface=ospfInterface, ripCurCfgDefListen=ripCurCfgDefListen, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfStartTime=ospfStartTime, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, arpInfoFlag=arpInfoFlag, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoEntry=arpInfoEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipCurCfgGwState=ipCurCfgGwState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfTotalNssaAreas=ospfTotalNssaAreas, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripConfig=ripConfig, ipNewCfgGwRetry=ipNewCfgGwRetry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipRouteInfoType=ipRouteInfoType, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask)
