...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfHello=ospfIntfHello, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdNewCfgState=ipFwdNewCfgState, arpInfoDestIp=arpInfoDestIp, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfinfo=ospfinfo, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfIndex=ospfAreaIntfIndex, arpInfoFlag=arpInfoFlag, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfStartTime=ospfStartTime, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgSupply=ripCurCfgSupply, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ripNewCfgSupply=ripNewCfgSupply, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoEntry=arpInfoEntry, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, routerLSALinkIfIndex=routerLSALinkIfIndex, routerLSAAreaIndex=routerLSAAreaIndex, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, routerLSALinkID=routerLSALinkID, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgState=ripNewCfgState, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCumIntfLoop=ospfCumIntfLoop, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfRxHello=ospfIntfRxHello, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrStart=ospfCumNbrStart, vrrpStats=vrrpStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumRxPkts=ospfCumRxPkts, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrStart=ospfAreaNbrStart, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfIndex=ospfIntfIndex, arpInfoSrcPort=arpInfoSrcPort, dnsStats=dnsStats, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrhello=ospfAreaNbrhello, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaTxHello=ospfAreaTxHello, vrrp=vrrp, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpStatMaxEntries=arpStatMaxEntries, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCfg=ospfCfg, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfLsTypesSupported=ospfLsTypesSupported, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrp_info=vrrp_info, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipRouteInfoTable=ipRouteInfoTable, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfInterface=ospfInterface, ipNewCfgGwInterval=ipNewCfgGwInterval, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumRxHello=ospfCumRxHello, ospfIntfBackup=ospfIntfBackup, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, routeStatMaxEntries=routeStatMaxEntries, ospfArea=ospfArea, ipInterfaceTableMax=ipInterfaceTableMax, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfLoop=ospfIntfLoop, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumNbrDown=ospfCumNbrDown, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpStatEntries=arpStatEntries, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipNewCfgGwVlan=ipNewCfgGwVlan, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwVlan=ipCurCfgGwVlan, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripStatOutPkts=ripStatOutPkts, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpStatHighWater=arpStatHighWater, ipFwdCurCfgState=ipFwdCurCfgState, routerLSAId=routerLSAId, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripStats=ripStats, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ripNewCfgVip=ripNewCfgVip, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaRxHello=ospfAreaRxHello, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpGeneral=vrrpGeneral, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipRouteInfoMask=ipRouteInfoMask, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfGeneralStats=ospfGeneralStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfGeneral=ospfGeneral, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfTxHello=ospfIntfTxHello, routeStatHighWater=routeStatHighWater, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumNbrN1way=ospfCumNbrN1way, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfAreaChangeStats=ospfAreaChangeStats, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgIntfState=ipNewCfgIntfState, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgListen=ripCurCfgListen, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpStats=arpStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwTable=ipNewCfgGwTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaIntfDown=ospfAreaIntfDown, ripCurCfgDefListen=ripCurCfgDefListen, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfNbrInInitState=ospfNbrInInitState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrhello=ospfCumNbrhello, iprouting=iprouting, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, ipRouteInfoType=ipRouteInfoType, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, routeStatEntries=routeStatEntries, ospfIntfDown=ospfIntfDown, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfNbrStart=ospfIntfNbrStart, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipForward=ipForward, ipGatewayTableMax=ipGatewayTableMax, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfChangeStats=ospfIntfChangeStats, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripConfig=ripConfig, ospfAreaRxPkts=ospfAreaRxPkts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfStats=ospfStats, ipRouteInfoInterface=ipRouteInfoInterface, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgGwState=ipNewCfgGwState, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ripNewCfgListen=ripNewCfgListen, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoMacAddr=arpInfoMacAddr, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpStatInAdvers=vrrpStatInAdvers, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ip_info=ip_info, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumIntfDown=ospfCumIntfDown, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfTotalAreas=ospfTotalAreas, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfRxPkts=ospfIntfRxPkts, routeStats=routeStats)
