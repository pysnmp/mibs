...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripCurCfgVip=ripCurCfgVip, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIfWaitInterval=ospfIfWaitInterval, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaTxHello=ospfAreaTxHello, ospfLsTypesSupported=ospfLsTypesSupported, dnsStats=dnsStats, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipNewCfgGwAddr=ipNewCfgGwAddr, ip_info=ip_info, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, arpStatMaxEntries=arpStatMaxEntries, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipCurCfgIntfMask=ipCurCfgIntfMask, arpInfoVLAN=arpInfoVLAN, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ripNewCfgListen=ripNewCfgListen, ipForward=ipForward, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumIntfUnloop=ospfCumIntfUnloop, ipFwdCurCfgState=ipFwdCurCfgState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrhello=ospfIntfNbrhello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumTxlsAcks=ospfCumTxlsAcks, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoTable=ipRouteInfoTable, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCumNbrStart=ospfCumNbrStart, ospfNbrInFullState=ospfNbrInFullState, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routerLSALinkID=routerLSALinkID, vrrpOper=vrrpOper, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfChangeStats=ospfIntfChangeStats, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgGwRetry=ipCurCfgGwRetry, ipRouteInfoType=ipRouteInfoType, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaIntfDown=ospfAreaIntfDown, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipNewCfgGwEntry=ipNewCfgGwEntry, routeStatHighWater=routeStatHighWater, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNbrInInitState=ospfNbrInInitState, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpInfoFlag=arpInfoFlag, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaInfoEntry=ospfAreaInfoEntry, iprouting=iprouting, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipCurCfgGwArp=ipCurCfgGwArp, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumIntfHello=ospfCumIntfHello, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfRxlsReqs=ospfIntfRxlsReqs, arpStatHighWater=arpStatHighWater, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfDown=ospfIntfDown, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfIntfIndex=ospfIntfIndex, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaRxHello=ospfAreaRxHello, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ripConfig=ripConfig, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpInfoEntry=arpInfoEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripStatInPkts=ripStatInPkts, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfGeneral=ospfGeneral, ospfTimersKickOffStats=ospfTimersKickOffStats, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfAreaTxPkts=ospfAreaTxPkts, ospfNbrInExchState=ospfNbrInExchState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipRouteInfoTag=ipRouteInfoTag, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfArea=ospfArea, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ripNewCfgSupply=ripNewCfgSupply, arpStatEntries=arpStatEntries, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipCurCfgGwTable=ipCurCfgGwTable, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrChange=ospfIntfNbrChange, ospfCumNbrhello=ospfCumNbrhello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoRefPorts=arpInfoRefPorts, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrp=vrrp, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrp_info=vrrp_info, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, routeStats=routeStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaRxPkts=ospfAreaRxPkts, ipCurCfgBootpState=ipCurCfgBootpState, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpGeneral=vrrpGeneral, ripStatOutPkts=ripStatOutPkts, vrrpStatInAdvers=vrrpStatInAdvers, ospfCfg=ospfCfg, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfCumRxHello=ospfCumRxHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipRouteInfoInterface=ipRouteInfoInterface, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfGeneralInfo=ospfGeneralInfo, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfBackup=ospfIntfBackup, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfAreaInfoId=ospfAreaInfoId, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfAreaTxDatabase=ospfAreaTxDatabase, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgGwInterval=ipCurCfgGwInterval, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfAreaIntfLoop=ospfAreaIntfLoop, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipRouteInfoMask=ipRouteInfoMask, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipInterfaceTableMax=ipInterfaceTableMax, arpStats=arpStats, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTotalAreas=ospfTotalAreas, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwVlan=ipCurCfgGwVlan, ripStatInErrorPkts=ripStatInErrorPkts, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, routerLSAId=routerLSAId, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfTxHello=ospfIntfTxHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgGwState=ipNewCfgGwState, ospfStartTime=ospfStartTime, arpInfoSrcPort=arpInfoSrcPort, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routeStatMaxEntries=routeStatMaxEntries, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumRxDatabase=ospfCumRxDatabase, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaInfoTable=ospfAreaInfoTable, ripStats=ripStats, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipCurCfgIntfState=ipCurCfgIntfState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipRouteInfoEntry=ipRouteInfoEntry, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwState=ipCurCfgGwState, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxDatabase=ospfIntfRxDatabase, ipRouteInfoIndx=ipRouteInfoIndx, ospfIntfHello=ospfIntfHello, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfinfo=ospfinfo, ospfStats=ospfStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaChangeStats=ospfAreaChangeStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoTable=arpInfoTable, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgState=ripCurCfgState)
