...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfState=ipNewCfgIntfState, ospfProcessUptime=ospfProcessUptime, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfLsTypesSupported=ospfLsTypesSupported, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipCurCfgBootpState=ipCurCfgBootpState, ipCurCfgGwMetric=ipCurCfgGwMetric, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumRxTxStats=ospfCumRxTxStats, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripStats=ripStats, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfGeneral=ospfGeneral, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfRxPkts=ospfIntfRxPkts, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfCumTxDatabase=ospfCumTxDatabase, ripCurCfgState=ripCurCfgState, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrChange=ospfIntfNbrChange, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfDown=ospfIntfDown, arpStatEntries=arpStatEntries, arpInfoMacAddr=arpInfoMacAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipRouteInfoMask=ipRouteInfoMask, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrhello=ospfIntfNbrhello, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripStatOutPkts=ripStatOutPkts, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipGatewayTableMax=ipGatewayTableMax, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrStart=ospfCumNbrStart, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfNbrInInitState=ospfNbrInInitState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, routerLSAAreaIndex=routerLSAAreaIndex, ospfGeneralInfo=ospfGeneralInfo, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxDatabase=ospfAreaRxDatabase, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfGeneralStats=ospfGeneralStats, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfTxHello=ospfIntfTxHello, arpStats=arpStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwVlan=ipNewCfgGwVlan, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrDown=ospfIntfNbrDown, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, arpInfoFlag=arpInfoFlag, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumTxHello=ospfCumTxHello, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrDown=ospfAreaNbrDown, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgIntfTable=ipCurCfgIntfTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpOper=vrrpOper, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipRouteInfoInterface=ipRouteInfoInterface, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaTxHello=ospfAreaTxHello, ospfInterface=ospfInterface, ripNewCfgVip=ripNewCfgVip, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfUnloop=ospfIntfUnloop, ripStatInPkts=ripStatInPkts, routeStats=routeStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpInfoVLAN=arpInfoVLAN, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfCfg=ospfCfg, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpStatMaxEntries=arpStatMaxEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, routerLSAId=routerLSAId, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrp=vrrp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaInfoIndex=ospfAreaInfoIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfHello=ospfIntfHello, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumIntfLoop=ospfCumIntfLoop, arpInfoTable=arpInfoTable, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routerLSALinkData=routerLSALinkData, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgGwArp=ipCurCfgGwArp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripCurCfgDefListen=ripCurCfgDefListen, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpGeneral=vrrpGeneral, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoTag=ipRouteInfoTag, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaChangeStats=ospfAreaChangeStats, routeStatHighWater=routeStatHighWater, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipNewCfgGwTable=ipNewCfgGwTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfBackup=ospfIntfBackup, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipCurCfgIntfState=ipCurCfgIntfState, arpInfoDestIp=arpInfoDestIp, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfIndex=ospfIntfIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCumRxHello=ospfCumRxHello, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfCumRxDatabase=ospfCumRxDatabase, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ip_info=ip_info, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripCurCfgListen=ripCurCfgListen, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgSupply=ripNewCfgSupply, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfTxPkts=ospfIntfTxPkts, routerLSALinkIndex=routerLSALinkIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfAreaRxHello=ospfAreaRxHello, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, routeStatEntries=routeStatEntries, ipRouteInfoIndx=ipRouteInfoIndx, ospfArea=ospfArea, dnsStats=dnsStats, ipRouteInfoEntry=ipRouteInfoEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpStatHighWater=arpStatHighWater, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, arpInfoSrcPort=arpInfoSrcPort, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfRxTxIndex=ospfIntfRxTxIndex, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpStats=vrrpStats, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfRxHello=ospfIntfRxHello, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaIntfHello=ospfAreaIntfHello, ripStatInErrorPkts=ripStatInErrorPkts, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfChangeStats=ospfIntfChangeStats, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpStatInAdvers=vrrpStatInAdvers, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipNewCfgGwRetry=ipNewCfgGwRetry, ripConfig=ripConfig, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfTotalAreas=ospfTotalAreas, iprouting=iprouting, ospfIntfNbrIndex=ospfIntfNbrIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumIntfBackup=ospfCumIntfBackup, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipForward=ipForward, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwState=ipCurCfgGwState, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfinfo=ospfinfo, ripNewCfgState=ripNewCfgState, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripCurCfgVip=ripCurCfgVip, ospfAreaRxPkts=ospfAreaRxPkts)
