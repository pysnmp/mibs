...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgGenState=vrrpCurCfgGenState, ipRouteInfoType=ipRouteInfoType, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipRouteInfoGateway=ipRouteInfoGateway, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTotalTransitAreas=ospfTotalTransitAreas, ipRouteInfoTable=ipRouteInfoTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwState=ipNewCfgGwState, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaInfoEntry=ospfAreaInfoEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripStatOutPkts=ripStatOutPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaChangeStats=ospfAreaChangeStats, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ripNewCfgState=ripNewCfgState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfRxHello=ospfIntfRxHello, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpInfoVLAN=arpInfoVLAN, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTxHello=ospfIntfTxHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrStart=ospfCumNbrStart, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, routerLSALinkID=routerLSALinkID, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgIntfTable=ipNewCfgIntfTable, ipCurCfgGwTable=ipCurCfgGwTable, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfTotalNssaAreas=ospfTotalNssaAreas, ripCurCfgDefListen=ripCurCfgDefListen, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfHello=ospfIntfHello, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfinfo=ospfinfo, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfIntfBackup=ospfIntfBackup, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrIndex=ospfAreaNbrIndex, ripStats=ripStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaIntfBackup=ospfAreaIntfBackup, ip_info=ip_info, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrChange=ospfIntfNbrChange, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, routerLSALinkData=routerLSALinkData, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfProcessUptime=ospfProcessUptime, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfLoop=ospfIntfLoop, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, arpInfoDestIp=arpInfoDestIp, ripConfig=ripConfig, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfUnloop=ospfIntfUnloop, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfInterface=ospfInterface, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumTxlsAcks=ospfCumTxlsAcks, ripNewCfgListen=ripNewCfgListen, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfCumNbrhello=ospfCumNbrhello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwAddr=ipCurCfgGwAddr, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routeStats=routeStats, arpInfoFlag=arpInfoFlag, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, arpInfoTable=arpInfoTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrStart=ospfAreaNbrStart, ospfStats=ospfStats, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfCumTxlsReqs=ospfCumTxlsReqs)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaTxDatabase=ospfAreaTxDatabase, ipForward=ipForward, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpOper=vrrpOper, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdNewCfgState=ipFwdNewCfgState, ospfAreaNbrhello=ospfAreaNbrhello, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfNbrDown=ospfIntfNbrDown, ospfCumRxlsUpdates=ospfCumRxlsUpdates, arpInfoEntry=arpInfoEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaIntfDown=ospfAreaIntfDown, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routeStatHighWater=routeStatHighWater, ospfCumIntfHello=ospfCumIntfHello, vrrpStats=vrrpStats, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgGwState=ipCurCfgGwState, ripStatInPkts=ripStatInPkts, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTotalAreas=ospfTotalAreas, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIntfInfoTable=ospfIntfInfoTable, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSALinkIndex=routerLSALinkIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, routeStatEntries=routeStatEntries, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSAId=routerLSAId, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgState=ipFwdCurCfgState, ospfCumIntfDown=ospfCumIntfDown, arpInfoRefPorts=arpInfoRefPorts, ripNewCfgVip=ripNewCfgVip, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, routeStatMaxEntries=routeStatMaxEntries, ospfCumRxlsReqs=ospfCumRxlsReqs, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaInfoId=ospfAreaInfoId, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfCumRxTxStats=ospfCumRxTxStats, ospfStartTime=ospfStartTime, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxHello=ospfCumRxHello, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfAreaInfoTable=ospfAreaInfoTable, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaIntfHello=ospfAreaIntfHello, ospfAreaTxPkts=ospfAreaTxPkts, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgGwArp=ipNewCfgGwArp, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfTxlsReqs=ospfIntfTxlsReqs, iprouting=iprouting, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfGeneralStats=ospfGeneralStats, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrp=vrrp, ospfArea=ospfArea, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfGeneral=ospfGeneral, ospfNbrInFullState=ospfNbrInFullState, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfDown=ospfIntfDown, ospfHostTableMaxSize=ospfHostTableMaxSize, ipNewCfgIntfState=ipNewCfgIntfState, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipCurCfgGwEntry=ipCurCfgGwEntry, ripCurCfgState=ripCurCfgState, ospfIntfTxPkts=ospfIntfTxPkts, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, arpInfoSrcPort=arpInfoSrcPort, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgDefListen=ripNewCfgDefListen, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxPkts=ospfIntfRxPkts, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIfWaitInterval=ospfIfWaitInterval, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpStatHighWater=arpStatHighWater, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCfg=ospfCfg, ospfCumRxPkts=ospfCumRxPkts, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, dnsStats=dnsStats, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrN1way=ospfIntfNbrN1way, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgAreaId=ospfCurCfgAreaId, arpStats=arpStats)
