...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ripStatInPkts=ripStatInPkts, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSALinkIndex=routerLSALinkIndex, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaInfoId=ospfAreaInfoId, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaRxPkts=ospfAreaRxPkts, ripCurCfgVip=ripCurCfgVip, ospfTotalAreas=ospfTotalAreas, routerLSALinkID=routerLSALinkID, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrIndex=ospfAreaNbrIndex, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpInfoEntry=arpInfoEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumRxDatabase=ospfCumRxDatabase, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfIndex=ospfIntfIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfCumRxlsReqs=ospfCumRxlsReqs, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfTxHello=ospfIntfTxHello, arpStats=arpStats, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgGenState=vrrpNewCfgGenState, ripConfig=ripConfig, vrrp=vrrp, ospfCumRxHello=ospfCumRxHello, ospfIntfHello=ospfIntfHello, ripNewCfgSupply=ripNewCfgSupply, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfIntfDown=ospfIntfDown, ospfinfo=ospfinfo, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfNbrInInitState=ospfNbrInInitState, ipCurCfgGwInterval=ipCurCfgGwInterval, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipInterfaceTableMax=ipInterfaceTableMax, vrrpGeneral=vrrpGeneral, ipRouteInfoIndx=ipRouteInfoIndx, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, routerLSALinkData=routerLSALinkData, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgBootpState=ipNewCfgBootpState, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfBackup=ospfIntfBackup, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfInterface=ospfInterface, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpStatHighWater=arpStatHighWater, iprouting=iprouting, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrp_info=vrrp_info, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfCumTxlsAcks=ospfCumTxlsAcks, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfNbrInFullState=ospfNbrInFullState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCfg=ospfCfg, ipFwdNewCfgState=ipFwdNewCfgState, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfGeneralInfo=ospfGeneralInfo, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, routerLSAId=routerLSAId, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routeStatHighWater=routeStatHighWater, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaInfoTable=ospfAreaInfoTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTxPkts=ospfIntfTxPkts, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumNbrStart=ospfCumNbrStart, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, routerLSAAreaIndex=routerLSAAreaIndex, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfLoop=ospfIntfLoop, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfGeneral=ospfGeneral, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipForward=ipForward, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfInfoTable=ospfIntfInfoTable, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ripStatOutPkts=ripStatOutPkts, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfStartTime=ospfStartTime, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxDatabase=ospfAreaRxDatabase, ipCurCfgGwState=ipCurCfgGwState, ospfStats=ospfStats, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumRxlsAcks=ospfCumRxlsAcks, ipCurCfgGwMetric=ipCurCfgGwMetric)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfNbrInExchState=ospfNbrInExchState, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, arpInfoTable=arpInfoTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpOper=vrrpOper, ipCurCfgIntfIndex=ipCurCfgIntfIndex, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfArea=ospfArea, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumIntfHello=ospfCumIntfHello, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpInfoRefPorts=arpInfoRefPorts, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, dnsStats=dnsStats, ripNewCfgState=ripNewCfgState, routeStatMaxEntries=routeStatMaxEntries, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfRxPkts=ospfIntfRxPkts, ip_info=ip_info, ripCurCfgState=ripCurCfgState, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, arpInfoSrcPort=arpInfoSrcPort, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrhello=ospfAreaNbrhello, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripStats=ripStats, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaRxHello=ospfAreaRxHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwMetric=ipNewCfgGwMetric, ripNewCfgVip=ripNewCfgVip, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumNbrN1way=ospfCumNbrN1way, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaChangeStats=ospfAreaChangeStats, routeStatEntries=routeStatEntries, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwEntry=ipNewCfgGwEntry, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfAreaIntfDown=ospfAreaIntfDown, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaTxPkts=ospfAreaTxPkts, arpStatEntries=arpStatEntries, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCumRxPkts=ospfCumRxPkts, ospfCumNbrDown=ospfCumNbrDown, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpStatInAdvers=vrrpStatInAdvers, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrDown=ospfAreaNbrDown, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfNbrChange=ospfIntfNbrChange, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaIntfHello=ospfAreaIntfHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, routeStats=routeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoDestIp=arpInfoDestIp, ospfGeneralStats=ospfGeneralStats, ipRouteInfoType=ipRouteInfoType, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, arpInfoFlag=arpInfoFlag, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, ipNewCfgIntfState=ipNewCfgIntfState, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgGwArp=ipNewCfgGwArp, ipGatewayTableMax=ipGatewayTableMax, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxDatabase=ospfIntfTxDatabase, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfNbrhello=ospfIntfNbrhello)
