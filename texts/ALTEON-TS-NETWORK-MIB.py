...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaTxHello=ospfAreaTxHello, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpGeneral=vrrpGeneral, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfLoop=ospfIntfLoop, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, routerLSAId=routerLSAId, ospfLsTypesSupported=ospfLsTypesSupported, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNbrInInitState=ospfNbrInInitState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaNbrStart=ospfAreaNbrStart, ospfCumTxPkts=ospfCumTxPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, arpStatMaxEntries=arpStatMaxEntries, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfHello=ospfIntfHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaTxPkts=ospfAreaTxPkts, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpStats=arpStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfArea=ospfArea, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfAreaIntfHello=ospfAreaIntfHello, arpInfoDestIp=arpInfoDestIp, ospfinfo=ospfinfo, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwArp=ipCurCfgGwArp, routeStatEntries=routeStatEntries, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfAreaRxTxStats=ospfAreaRxTxStats, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ripNewCfgListen=ripNewCfgListen, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, routerLSALinkID=routerLSALinkID, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfBackup=ospfIntfBackup, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfCfg=ospfCfg, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfStartTime=ospfStartTime, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrIndex=ospfAreaNbrIndex, dnsStats=dnsStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaRxPkts=ospfAreaRxPkts, ripCurCfgDefListen=ripCurCfgDefListen, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfIntfTxHello=ospfIntfTxHello, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripNewCfgSupply=ripNewCfgSupply, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrp=vrrp, vrrpOper=vrrpOper, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfCumIntfDown=ospfCumIntfDown, ipNewCfgIntfState=ipNewCfgIntfState, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfDown=ospfIntfDown, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipRouteInfoInterface=ipRouteInfoInterface, arpInfoEntry=arpInfoEntry, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipRouteInfoType=ipRouteInfoType, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipGatewayTableMax=ipGatewayTableMax, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, routeStats=routeStats, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, arpInfoTable=arpInfoTable, ospfIntfNbrStart=ospfIntfNbrStart, ospfCumNbrhello=ospfCumNbrhello, routerLSALinkIndex=routerLSALinkIndex, ripStatOutPkts=ripStatOutPkts, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripNewCfgDefListen=ripNewCfgDefListen, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipNewCfgGwState=ipNewCfgGwState, ripStatInPkts=ripStatInPkts, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoTable=ipRouteInfoTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ripStats=ripStats, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgGwTable=ipNewCfgGwTable, ipCurCfgGwMetric=ipCurCfgGwMetric, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaNbrDown=ospfAreaNbrDown, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfAreaIntfDown=ospfAreaIntfDown, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfCurCfgAreaId=ospfCurCfgAreaId, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpStats=vrrpStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripNewCfgState=ripNewCfgState, vrrp_info=vrrp_info, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripConfig=ripConfig, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfRxHello=ospfIntfRxHello, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgBootpState=ipCurCfgBootpState, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ripCurCfgSupply=ripCurCfgSupply, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipForward=ipForward, ospfCumTxHello=ospfCumTxHello, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpInfoVLAN=arpInfoVLAN, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfIntfWaitTimer=ospfIntfWaitTimer, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumIntfLoop=ospfCumIntfLoop, ospfCumRxHello=ospfCumRxHello, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgGwState=ipCurCfgGwState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, arpInfoFlag=arpInfoFlag, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIntfInfoEntry=ospfIntfInfoEntry, ipInterfaceTableMax=ipInterfaceTableMax, routerLSALinkData=routerLSALinkData, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ripCurCfgVip=ripCurCfgVip, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, arpStatHighWater=arpStatHighWater, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfCumIntfBackup=ospfCumIntfBackup, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfCumRxPkts=ospfCumRxPkts, ospfAreaRxHello=ospfAreaRxHello, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumRxDatabase=ospfCumRxDatabase, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfIndex=ospfIntfIndex, ospfTotalAreas=ospfTotalAreas, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpStatEntries=arpStatEntries, ripStatInErrorPkts=ripStatInErrorPkts, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxPkts=ospfIntfRxPkts, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ripCurCfgListen=ripCurCfgListen, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfIntfUnloop=ospfIntfUnloop, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumNbrStart=ospfCumNbrStart, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfTxDatabase=ospfIntfTxDatabase, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfStats=ospfStats, ipCurCfgGwTable=ipCurCfgGwTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfProcessUptime=ospfProcessUptime, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ip_info=ip_info, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaInfoTable=ospfAreaInfoTable, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipRouteInfoIndx=ipRouteInfoIndx, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, iprouting=iprouting, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaTxDatabase=ospfAreaTxDatabase)
