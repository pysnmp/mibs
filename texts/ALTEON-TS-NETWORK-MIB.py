...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfTotalAreas=ospfTotalAreas, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, routerLSALinkID=routerLSALinkID, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfGeneral=ospfGeneral, ipFwdCurCfgPortState=ipFwdCurCfgPortState, vrrp=vrrp, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipRouteInfoGateway=ipRouteInfoGateway, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, iprouting=iprouting, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfIntfRxPkts=ospfIntfRxPkts, ospfAreaInfoTable=ospfAreaInfoTable, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfIntfDown=ospfIntfDown, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgGwState=ipNewCfgGwState, ospfCumTxlsAcks=ospfCumTxlsAcks, ripCurCfgListen=ripCurCfgListen, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrp_info=vrrp_info, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipRouteInfoIndx=ipRouteInfoIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routeStatEntries=routeStatEntries, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, routerLSAAreaIndex=routerLSAAreaIndex, arpInfoSrcPort=arpInfoSrcPort, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTotalNssaAreas=ospfTotalNssaAreas, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ripStatOutPkts=ripStatOutPkts, ospfAreaTxPkts=ospfAreaTxPkts, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoMask=ipRouteInfoMask, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, routerLSALinkData=routerLSALinkData, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgGenState=vrrpCurCfgGenState, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgGwVlan=ipCurCfgGwVlan, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, arpInfoEntry=arpInfoEntry, vrrpOper=vrrpOper, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipGatewayTableMax=ipGatewayTableMax, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfIntfRxHello=ospfIntfRxHello, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfinfo=ospfinfo, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfHello=ospfIntfHello, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipRouteInfoTag=ipRouteInfoTag, ipNewCfgGwAddr=ipNewCfgGwAddr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgIntfState=ipNewCfgIntfState, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfCumRxlsAcks=ospfCumRxlsAcks, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipRouteInfoType=ipRouteInfoType, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, dnsStats=dnsStats, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfIntfTxHello=ospfIntfTxHello, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfLsTypesSupported=ospfLsTypesSupported, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfVlinkCountForRouter=ospfVlinkCountForRouter, arpInfoTable=arpInfoTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfBackup=ospfIntfBackup, ospfProcessUptime=ospfProcessUptime, routeStatHighWater=routeStatHighWater, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, arpInfoDestIp=arpInfoDestIp, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, ospfCumRxTxStats=ospfCumRxTxStats, arpInfoRefPorts=arpInfoRefPorts, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgVip=ripNewCfgVip, ospfCumNbrhello=ospfCumNbrhello, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgState=ripCurCfgState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumTxHello=ospfCumTxHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwInterval=ipCurCfgGwInterval, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipRouteInfoEntry=ipRouteInfoEntry, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpStats=vrrpStats)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", arpStatMaxEntries=arpStatMaxEntries, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCfg=ospfCfg, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgVip=ripCurCfgVip, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfIndex=ospfIntfIndex, ospfCumNbrStart=ospfCumNbrStart, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumRxHello=ospfCumRxHello, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfLoop=ospfIntfLoop, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfArea=ospfArea, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgGwArp=ipCurCfgGwArp, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIfInfoIndex=ospfIfInfoIndex, arpStats=arpStats, ripCurCfgSupply=ripCurCfgSupply, ospfCumTxDatabase=ospfCumTxDatabase, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfStats=ospfStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgIntfMask=ipNewCfgIntfMask, arpInfoFlag=arpInfoFlag, ospfGeneralStats=ospfGeneralStats, ospfAreaIntfUnloop=ospfAreaIntfUnloop, arpInfoMacAddr=arpInfoMacAddr, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipFwdCurCfgState=ipFwdCurCfgState, ripStats=ripStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaNbrhello=ospfAreaNbrhello, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfNbrStart=ospfIntfNbrStart, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routeStats=routeStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrDown=ospfCumNbrDown, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripStatInPkts=ripStatInPkts, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumTxPkts=ospfCumTxPkts, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaTxDatabase=ospfAreaTxDatabase, ip_info=ip_info, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwRetry=ipCurCfgGwRetry, ripNewCfgState=ripNewCfgState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIntfUnloop=ospfIntfUnloop, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipForward=ipForward, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipRouteInfoTable=ipRouteInfoTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ipNewCfgBootpState=ipNewCfgBootpState, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgGwMetric=ipCurCfgGwMetric, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, ripNewCfgListen=ripNewCfgListen, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, arpStatHighWater=arpStatHighWater, ospfAreaIntfHello=ospfAreaIntfHello, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgGwMetric=ipNewCfgGwMetric, routerLSALinkIndex=routerLSALinkIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfGeneralInfo=ospfGeneralInfo, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ripNewCfgDefListen=ripNewCfgDefListen, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumNbrN1way=ospfCumNbrN1way, ospfIntfInfoTable=ospfIntfInfoTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripConfig=ripConfig, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfInfoEntry=ospfIntfInfoEntry, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipRouteInfoInterface=ipRouteInfoInterface, vrrpStatOutAdvers=vrrpStatOutAdvers)
