...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfTotalAreas=ospfTotalAreas, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaRxHello=ospfAreaRxHello, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumIntfDown=ospfCumIntfDown, arpInfoEntry=arpInfoEntry, ospfIntfDown=ospfIntfDown, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, arpInfoFlag=arpInfoFlag, ripStats=ripStats, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routeStatHighWater=routeStatHighWater, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfStats=ospfStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaTxPkts=ospfAreaTxPkts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfGeneralStats=ospfGeneralStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaInfoIndex=ospfAreaInfoIndex, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipForward=ipForward, ipFwdCurCfgState=ipFwdCurCfgState, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpGeneral=vrrpGeneral, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ip_info=ip_info, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripStatOutPkts=ripStatOutPkts, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, dnsStats=dnsStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumRxPkts=ospfCumRxPkts, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfChangeStats=ospfIntfChangeStats, ipNewCfgIntfState=ipNewCfgIntfState, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpStatInAdvers=vrrpStatInAdvers, ospfGeneral=ospfGeneral, ripCurCfgSupply=ripCurCfgSupply, ospfLsTypesSupported=ospfLsTypesSupported, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfIndex=ospfIntfIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfStartTime=ospfStartTime, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfAreaInfoTable=ospfAreaInfoTable, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCfg=ospfCfg, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfMask=ipNewCfgIntfMask, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, routerLSALinkIndex=routerLSALinkIndex, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfCumRxTxStats=ospfCumRxTxStats, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipFwdNewCfgState=ipFwdNewCfgState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, routerLSAAreaIndex=routerLSAAreaIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfInfoTable=ospfIntfInfoTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfIntfUnloop=ospfIntfUnloop, ospfAreaNbrIndex=ospfAreaNbrIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIfTotalNeighbours=ospfIfTotalNeighbours, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumRxHello=ospfCumRxHello, routeStats=routeStats, routeStatEntries=routeStatEntries, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfArea=ospfArea, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfGeneralInfo=ospfGeneralInfo, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ripNewCfgDefListen=ripNewCfgDefListen, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfHostTableMaxSize=ospfHostTableMaxSize, ripNewCfgState=ripNewCfgState, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, arpInfoTable=arpInfoTable, ospfIntfBackup=ospfIntfBackup, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfIntfHello=ospfIntfHello, ipNewCfgGwAddr=ipNewCfgGwAddr, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgIntfEntry=ipCurCfgIntfEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumIntfBackup=ospfCumIntfBackup, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfIntfRxHello=ospfIntfRxHello, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ipCurCfgIntfState=ipCurCfgIntfState, ipCurCfgGwArp=ipCurCfgGwArp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipCurCfgGwRetry=ipCurCfgGwRetry, ripCurCfgDefListen=ripCurCfgDefListen, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfAreaIntfIndex=ospfAreaIntfIndex, ipCurCfgGwTable=ipCurCfgGwTable, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfinfo=ospfinfo, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoRefPorts=arpInfoRefPorts, iprouting=iprouting, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgGwMetric=ipCurCfgGwMetric, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ripStatInPkts=ripStatInPkts, ospfCumNbrN1way=ospfCumNbrN1way, ripNewCfgListen=ripNewCfgListen, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfNbrInExchState=ospfNbrInExchState, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCumNbrDown=ospfCumNbrDown)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfAreaNbrhello=ospfAreaNbrhello, ipNewCfgGwIndex=ipNewCfgGwIndex, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaTxHello=ospfAreaTxHello, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgIfTable=vrrpCurCfgIfTable, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfTxHello=ospfIntfTxHello, ospfAreaInfoId=ospfAreaInfoId, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ripCurCfgListen=ripCurCfgListen, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoMask=ipRouteInfoMask, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCumTxHello=ospfCumTxHello, arpInfoSrcPort=arpInfoSrcPort, ospfAreaRxPkts=ospfAreaRxPkts, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, routerLSAId=routerLSAId, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ripConfig=ripConfig, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfIfInfoIpAddress=ospfIfInfoIpAddress, arpInfoDestIp=arpInfoDestIp, ospfNbrInFullState=ospfNbrInFullState, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipRouteInfoTable=ipRouteInfoTable, ospfAreaNbrDown=ospfAreaNbrDown, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoType=ipRouteInfoType, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfInterface=ospfInterface, ospfIntfRxDatabase=ospfIntfRxDatabase, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfAreaTxDatabase=ospfAreaTxDatabase, ipNewCfgGwState=ipNewCfgGwState, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, routerLSALinkData=routerLSALinkData, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumIntfLoop=ospfCumIntfLoop, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipNewCfgGwEntry=ipNewCfgGwEntry, arpStats=arpStats, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumRxDatabase=ospfCumRxDatabase, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrp_info=vrrp_info, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrp=vrrp, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfNbrStart=ospfIntfNbrStart, vrrpOper=vrrpOper, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpStats=vrrpStats, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, arpStatEntries=arpStatEntries, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, arpInfoMacAddr=arpInfoMacAddr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, arpInfoVLAN=arpInfoVLAN, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipNewCfgGwArp=ipNewCfgGwArp, routeStatMaxEntries=routeStatMaxEntries, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, routerLSALinkID=routerLSALinkID, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumNbrRstAd=ospfCumNbrRstAd, ipCurCfgGwState=ipCurCfgGwState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipCurCfgIntfMask=ipCurCfgIntfMask, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ripNewCfgVip=ripNewCfgVip, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumTxPkts=ospfCumTxPkts, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ripNewCfgSupply=ripNewCfgSupply, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpStatHighWater=arpStatHighWater)
