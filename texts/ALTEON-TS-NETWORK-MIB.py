...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumTxHello=ospfCumTxHello, ospfNbrInInitState=ospfNbrInInitState, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfBackup=ospfIntfBackup, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfNbrInFullState=ospfNbrInFullState, ospfAreaNbrDown=ospfAreaNbrDown, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfIntfDown=ospfIntfDown, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfCumNbrhello=ospfCumNbrhello, ospfGeneralInfo=ospfGeneralInfo, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfStats=ospfStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumNbrN1way=ospfCumNbrN1way, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ripNewCfgState=ripNewCfgState, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripNewCfgDefListen=ripNewCfgDefListen, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfArea=ospfArea, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumIntfBackup=ospfCumIntfBackup, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrp_info=vrrp_info, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfAreaNbrIndex=ospfAreaNbrIndex, iprouting=iprouting, arpInfoRefPorts=arpInfoRefPorts, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpGeneral=vrrpGeneral, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ripConfig=ripConfig, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfLsTypesSupported=ospfLsTypesSupported, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumRxTxStats=ospfCumRxTxStats, routerLSALinkID=routerLSALinkID, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxDatabase=ospfAreaRxDatabase, routeStatMaxEntries=routeStatMaxEntries, arpStatEntries=arpStatEntries, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumTxPkts=ospfCumTxPkts, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, routerLSALinkData=routerLSALinkData, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfStartTime=ospfStartTime, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfProcessUptime=ospfProcessUptime, arpInfoSrcPort=arpInfoSrcPort, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumRxHello=ospfCumRxHello, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripStats=ripStats, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgDefListen=ripCurCfgDefListen, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfIntfRxPkts=ospfIntfRxPkts, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfNbrhello=ospfIntfNbrhello, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, vrrp=vrrp, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfNewCfgAreaId=ospfNewCfgAreaId, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ripStatInPkts=ripStatInPkts, arpInfoMacAddr=arpInfoMacAddr, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfTimersKickOffStats=ospfTimersKickOffStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaInfoTable=ospfAreaInfoTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgBootpState=ipNewCfgBootpState, ipRouteInfoTag=ipRouteInfoTag, ipFwdNewCfgState=ipFwdNewCfgState, vrrpOper=vrrpOper, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, dnsStats=dnsStats, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfAreaNbrN1way=ospfAreaNbrN1way, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrDown=ospfIntfNbrDown, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipNewCfgIntfState=ipNewCfgIntfState, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, arpStats=arpStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipRouteInfoType=ipRouteInfoType, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumTxlsReqs=ospfCumTxlsReqs, ipRouteInfoTable=ipRouteInfoTable, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, arpInfoVLAN=arpInfoVLAN, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrN1way=ospfIntfNbrN1way, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ripNewCfgSupply=ripNewCfgSupply, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipCurCfgGwEntry=ipCurCfgGwEntry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdCurCfgState=ipFwdCurCfgState, ospfInterface=ospfInterface, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ripCurCfgListen=ripCurCfgListen, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfRxTxStats=ospfIntfRxTxStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfGeneral=ospfGeneral, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfAreaRxTxStats=ospfAreaRxTxStats, ipRouteInfoEntry=ipRouteInfoEntry, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgBootpState=ipCurCfgBootpState, routerLSAId=routerLSAId, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgGwTable=ipCurCfgGwTable, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumRxPkts=ospfCumRxPkts, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipForward=ipForward, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIntfRxHello=ospfIntfRxHello, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipRouteInfoInterface=ipRouteInfoInterface, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIntfTxPkts=ospfIntfTxPkts, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxHello=ospfAreaRxHello, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ipCurCfgGwAddr=ipCurCfgGwAddr, routerLSALinkIndex=routerLSALinkIndex, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaInfoEntry=ospfAreaInfoEntry, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgGwRetry=ipNewCfgGwRetry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfNbrInExchState=ospfNbrInExchState, routerLSAAreaIndex=routerLSAAreaIndex, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipNewCfgIntfVlan=ipNewCfgIntfVlan, routeStatHighWater=routeStatHighWater, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfIntfNbrChange=ospfIntfNbrChange, arpInfoDestIp=arpInfoDestIp, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpStats=vrrpStats, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfHello=ospfIntfHello, ospfCumRxDatabase=ospfCumRxDatabase, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipInterfaceTableMax=ipInterfaceTableMax, ip_info=ip_info, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgIntfState=ipCurCfgIntfState, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStatEntries=routeStatEntries, ospfAreaIntfLoop=ospfAreaIntfLoop, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfCfg=ospfCfg, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfAreaInfoId=ospfAreaInfoId, arpStatMaxEntries=arpStatMaxEntries, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ripNewCfgVip=ripNewCfgVip, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfTotalAreas=ospfTotalAreas, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, arpInfoTable=arpInfoTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, arpStatHighWater=arpStatHighWater, arpInfoFlag=arpInfoFlag, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwTable=ipNewCfgGwTable, ripCurCfgVip=ripCurCfgVip, arpInfoEntry=arpInfoEntry, ospfAreaNbrhello=ospfAreaNbrhello, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, routeStats=routeStats, ripStatOutPkts=ripStatOutPkts, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaNbrStart=ospfAreaNbrStart, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgGenState=vrrpNewCfgGenState, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex)
