...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxHello=ospfAreaTxHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfTotalAreas=ospfTotalAreas, iprouting=iprouting, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumTxlsReqs=ospfCumTxlsReqs, arpInfoRefPorts=arpInfoRefPorts, ospfIntfRxHello=ospfIntfRxHello, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, arpInfoFlag=arpInfoFlag, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaIntfHello=ospfAreaIntfHello, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaInfoId=ospfAreaInfoId, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, routeStatHighWater=routeStatHighWater, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfAreaNbrhello=ospfAreaNbrhello, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaRxTxStats=ospfAreaRxTxStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxPkts=ospfAreaRxPkts, ospfStartTime=ospfStartTime, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ripNewCfgListen=ripNewCfgListen, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfIntfTxPkts=ospfIntfTxPkts, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfInterface=ospfInterface, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrp_info=vrrp_info, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumNbrStart=ospfCumNbrStart, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipInterfaceTableMax=ipInterfaceTableMax, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, arpInfoMacAddr=arpInfoMacAddr, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfCumRxHello=ospfCumRxHello, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfCumRxPkts=ospfCumRxPkts, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipNewCfgGwMetric=ipNewCfgGwMetric, routerLSALinkID=routerLSALinkID, ipCurCfgGwState=ipCurCfgGwState, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipForward=ipForward, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfProcessUptime=ospfProcessUptime, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripConfig=ripConfig, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, routerLSAId=routerLSAId, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipRouteInfoEntry=ipRouteInfoEntry, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfIntfRxPkts=ospfIntfRxPkts, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaNbrStart=ospfAreaNbrStart, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoInterface=ipRouteInfoInterface, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfTxHello=ospfIntfTxHello, routerLSALinkIndex=routerLSALinkIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipRouteInfoType=ipRouteInfoType, ospfIntfUnloop=ospfIntfUnloop, ospfCumIntfLoop=ospfCumIntfLoop, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfInfoTable=ospfIntfInfoTable, ospfAreaIntfDown=ospfAreaIntfDown, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfHello=ospfIntfHello, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaNbrRstAd=ospfAreaNbrRstAd, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfCumNbrN1way=ospfCumNbrN1way, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfCumIntfBackup=ospfCumIntfBackup, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwAddr=ipCurCfgGwAddr, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipCurCfgGwTable=ipCurCfgGwTable, ripStatInErrorPkts=ripStatInErrorPkts, ospfinfo=ospfinfo, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaRxHello=ospfAreaRxHello, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfLsTypesSupported=ospfLsTypesSupported, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpOper=vrrpOper, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ip_info=ip_info, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripCurCfgVip=ripCurCfgVip, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpStatHighWater=arpStatHighWater, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipRouteInfoTable=ipRouteInfoTable, ospfTotalNeighbours=ospfTotalNeighbours, ospfIntfNbrStart=ospfIntfNbrStart, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfIntfBackup=ospfIntfBackup, ospfCumRxlsAcks=ospfCumRxlsAcks, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdNewCfgState=ipFwdNewCfgState, ripNewCfgDefListen=ripNewCfgDefListen, routeStatEntries=routeStatEntries, ospfCumNbrRstAd=ospfCumNbrRstAd, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ripCurCfgSupply=ripCurCfgSupply, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrChange=ospfIntfNbrChange, ipGatewayTableMax=ipGatewayTableMax, ipCurCfgGwRetry=ipCurCfgGwRetry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfArea=ospfArea, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpStats=arpStats, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrp=vrrp, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, vrrpIfTableMaxSize=vrrpIfTableMaxSize, arpInfoTable=arpInfoTable, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, arpInfoDestIp=arpInfoDestIp, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgDefListen=ripCurCfgDefListen, ripStats=ripStats, routerLSALinkData=routerLSALinkData, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripStatOutPkts=ripStatOutPkts, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpStats=vrrpStats, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfGeneralInfo=ospfGeneralInfo, ospfCfg=ospfCfg, arpStatEntries=arpStatEntries, arpStatMaxEntries=arpStatMaxEntries, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfTxDatabase=ospfIntfTxDatabase, ripNewCfgState=ripNewCfgState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfChangeStats=ospfIntfChangeStats, ipCurCfgGwArp=ipCurCfgGwArp, ospfIntfDown=ospfIntfDown, ripNewCfgVip=ripNewCfgVip, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaNbrDown=ospfAreaNbrDown, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfCumTxHello=ospfCumTxHello, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaInfoTable=ospfAreaInfoTable, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgGwInterval=ipNewCfgGwInterval, vrrpStatInAdvers=vrrpStatInAdvers, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfIntfIndex=ospfIntfIndex, ripCurCfgState=ripCurCfgState, ospfGeneralStats=ospfGeneralStats, ripStatInPkts=ripStatInPkts, ospfStats=ospfStats, ospfCumIntfHello=ospfCumIntfHello, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgGwTable=ipNewCfgGwTable, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, arpInfoSrcPort=arpInfoSrcPort, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfGeneral=ospfGeneral, ipNewCfgGwState=ipNewCfgGwState, ospfIntfLoop=ospfIntfLoop, routerLSALinkIfIndex=routerLSALinkIfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, dnsStats=dnsStats, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfNbrInExchState=ospfNbrInExchState, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipRouteInfoGateway=ipRouteInfoGateway, ipRouteInfoDestIp=ipRouteInfoDestIp, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfCumNbrDown=ospfCumNbrDown, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpInfoEntry=arpInfoEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, routerLSAAreaIndex=routerLSAAreaIndex, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIfInfoIpAddress=ospfIfInfoIpAddress, routeStats=routeStats, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIfWaitInterval=ospfIfWaitInterval, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwIndex=ipNewCfgGwIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize)
