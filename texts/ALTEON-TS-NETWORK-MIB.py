...
iso, NotificationType, ModuleIdentity, ObjectIdentity, IpAddress, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Unsigned32, Gauge32, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Unsigned32", "Gauge32", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipRouteInfoInterface=ipRouteInfoInterface, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfGeneralStats=ospfGeneralStats, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpStatEntries=arpStatEntries, ripStatOutPkts=ripStatOutPkts, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaNbrDown=ospfAreaNbrDown, arpStatHighWater=arpStatHighWater, ospfNbrInInitState=ospfNbrInInitState, ospfCumIntfLoop=ospfCumIntfLoop, iprouting=iprouting, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routerLSAId=routerLSAId, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ripNewCfgState=ripNewCfgState, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrp=vrrp, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ripCurCfgVip=ripCurCfgVip, ipCurCfgIntfState=ipCurCfgIntfState, ospfCurCfgAreaId=ospfCurCfgAreaId, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfinfo=ospfinfo, ospfGeneralInfo=ospfGeneralInfo, ospfArea=ospfArea, ripNewCfgVip=ripNewCfgVip, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfRxHello=ospfIntfRxHello, ipInterfaceTableMax=ipInterfaceTableMax, arpInfoTable=arpInfoTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfCumRxTxStats=ospfCumRxTxStats, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfIndex=ospfIntfIndex, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfAreaInfoTable=ospfAreaInfoTable, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripCurCfgState=ripCurCfgState, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, arpInfoRefPorts=arpInfoRefPorts, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfTotalNeighbours=ospfTotalNeighbours, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaTxHello=ospfAreaTxHello, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfNbrhello=ospfIntfNbrhello, ospfTimersKickOffStats=ospfTimersKickOffStats, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaTxPkts=ospfAreaTxPkts, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfAreaNbrIndex=ospfAreaNbrIndex, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaNbrStart=ospfAreaNbrStart, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgDefListen=ripCurCfgDefListen, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfTotalAreas=ospfTotalAreas, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgGwArp=ipCurCfgGwArp, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgListen=ripNewCfgListen, vrrpGeneral=vrrpGeneral, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCumIntfHello=ospfCumIntfHello, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrp_info=vrrp_info, arpInfoMacAddr=arpInfoMacAddr, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfGeneral=ospfGeneral, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoSrcPort=arpInfoSrcPort, ospfAreaRxHello=ospfAreaRxHello, ospfIntfHello=ospfIntfHello, ospfAreaInfoId=ospfAreaInfoId, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ripConfig=ripConfig, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfCumRxDatabase=ospfCumRxDatabase, ospfStats=ospfStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaIntfHello=ospfAreaIntfHello, ip_info=ip_info, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipRouteInfoGateway=ipRouteInfoGateway, ospfCumNbrStart=ospfCumNbrStart, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfIfInfoIndex=ospfIfInfoIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwArp=ipNewCfgGwArp, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, arpStats=arpStats, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, routerLSALinkID=routerLSALinkID, ipNewCfgGwEntry=ipNewCfgGwEntry, ipRouteInfoMask=ipRouteInfoMask, ospfIntfRxPkts=ospfIntfRxPkts, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipRouteInfoTable=ipRouteInfoTable, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfIntfInfoTable=ospfIntfInfoTable, routerLSALinkIndex=routerLSALinkIndex, ospfAreaIntfDown=ospfAreaIntfDown, vrrpOper=vrrpOper, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipNewCfgBootpState=ipNewCfgBootpState, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ripCurCfgSupply=ripCurCfgSupply, ospfIfWaitInterval=ospfIfWaitInterval, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfRangeTableMaxSize=ospfRangeTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, routeStatMaxEntries=routeStatMaxEntries, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrChange=ospfIntfNbrChange, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCfg=ospfCfg, ospfCumTxHello=ospfCumTxHello, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrIndex=ospfIntfNbrIndex, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ripNewCfgSupply=ripNewCfgSupply, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfNbrInFullState=ospfNbrInFullState, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfCumNbrN1way=ospfCumNbrN1way, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfBackup=ospfIntfBackup, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumNbrDown=ospfCumNbrDown, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfUnloop=ospfCumIntfUnloop, ipForward=ipForward, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgGwState=ipCurCfgGwState, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfIntfTxPkts=ospfIntfTxPkts, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ripNewCfgDefListen=ripNewCfgDefListen, ripCurCfgListen=ripCurCfgListen, ospfCumTxDatabase=ospfCumTxDatabase, ospfIntfTxDatabase=ospfIntfTxDatabase, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumRxPkts=ospfCumRxPkts, vrrpStats=vrrpStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpStatInAdvers=vrrpStatInAdvers, ipRouteInfoTag=ipRouteInfoTag, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfAreaIntfIndex=ospfAreaIntfIndex, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpStatMaxEntries=arpStatMaxEntries, routeStats=routeStats, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipNewCfgGwDelete=ipNewCfgGwDelete, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxDatabase=ospfAreaRxDatabase, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, routerLSALinkIfIndex=routerLSALinkIfIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, dnsStats=dnsStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfIntfLoop=ospfIntfLoop, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfInterface=ospfInterface, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfStartTime=ospfStartTime, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfWaitTimer=ospfIntfWaitTimer, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, arpInfoEntry=arpInfoEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfCumRxHello=ospfCumRxHello, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfProcessUptime=ospfProcessUptime, ospfIntfNbrDown=ospfIntfNbrDown, ripStats=ripStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgGwIndex=ipCurCfgGwIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipFwdNewCfgState=ipFwdNewCfgState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpInfoFlag=arpInfoFlag, ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipNewCfgIntfState=ipNewCfgIntfState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfDown=ospfIntfDown, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipRouteInfoType=ipRouteInfoType, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCurCfgAreaTable=ospfCurCfgAreaTable, routeStatEntries=routeStatEntries, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod)
