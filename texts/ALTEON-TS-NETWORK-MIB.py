...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumIntfDown=ospfCumIntfDown, ripStatInErrorPkts=ripStatInErrorPkts, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfInterface=ospfInterface, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, routeStatMaxEntries=routeStatMaxEntries, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfUnloop=ospfIntfUnloop, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaChangeStats=ospfAreaChangeStats, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrN1way=ospfCumNbrN1way, ospfNbrInInitState=ospfNbrInInitState, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfCumRxDatabase=ospfCumRxDatabase, ospfCumNbrhello=ospfCumNbrhello, ospfGeneralStats=ospfGeneralStats, arpInfoFlag=arpInfoFlag, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfIntfIndex=ospfIntfIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaTxHello=ospfAreaTxHello, ospfAreaIntfDown=ospfAreaIntfDown, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipRouteInfoMask=ipRouteInfoMask, ipNewCfgGwState=ipNewCfgGwState, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrhello=ospfIntfNbrhello, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumRxTxStats=ospfCumRxTxStats, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipNewCfgIntfState=ipNewCfgIntfState, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ipCurCfgIntfState=ipCurCfgIntfState, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumTxHello=ospfCumTxHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, routerLSALinkID=routerLSALinkID, ospfStartTime=ospfStartTime, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipCurCfgGwAddr=ipCurCfgGwAddr, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfAreaIntfLoop=ospfAreaIntfLoop, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ripNewCfgSupply=ripNewCfgSupply, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ip_info=ip_info, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfinfo=ospfinfo, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfCfg=ospfCfg, ospfIntfChangeStats=ospfIntfChangeStats, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumIntfLoop=ospfCumIntfLoop, ipCurCfgBootpAddr=ipCurCfgBootpAddr, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwState=ipCurCfgGwState, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripStatInPkts=ripStatInPkts, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaInfoId=ospfAreaInfoId, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, routeStats=routeStats, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfGeneralInfo=ospfGeneralInfo, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpStats=arpStats, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ripCurCfgListen=ripCurCfgListen, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgGwArp=ipNewCfgGwArp, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, arpStatHighWater=arpStatHighWater, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfIntfInfoEntry=ospfIntfInfoEntry, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumRxlsAcks=ospfCumRxlsAcks, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfTxPkts=ospfIntfTxPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ipNewCfgGwDelete=ipNewCfgGwDelete, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIfWaitInterval=ospfIfWaitInterval, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfIntfBackup=ospfIntfBackup, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipNewCfgIntfVlan=ipNewCfgIntfVlan, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpStats=vrrpStats, ospfCumNbrStart=ospfCumNbrStart, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrIndex=ospfAreaNbrIndex, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ospfIntfWaitTimer=ospfIntfWaitTimer, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumTxDatabase=ospfCumTxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipRouteInfoEntry=ipRouteInfoEntry, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipRouteInfoTag=ipRouteInfoTag, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpStatEntries=arpStatEntries, ospfNewCfgAreaId=ospfNewCfgAreaId, ripConfig=ripConfig, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfAreaRxTxStats=ospfAreaRxTxStats, iprouting=iprouting, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipCurCfgGwVlan=ipCurCfgGwVlan, arpInfoRefPorts=arpInfoRefPorts, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipFwdNewCfgState=ipFwdNewCfgState, dnsStats=dnsStats, ospfArea=ospfArea, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfIntfLoop=ospfIntfLoop, ospfCumIntfNbrChange=ospfCumIntfNbrChange, arpInfoMacAddr=arpInfoMacAddr, ospfCumIntfHello=ospfCumIntfHello, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpStatOutAdvers=vrrpStatOutAdvers, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaIntfBackup=ospfAreaIntfBackup, ipCurCfgBootpState=ipCurCfgBootpState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipNewCfgIntfMask=ipNewCfgIntfMask)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfProcessUptime=ospfProcessUptime, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfNbrStart=ospfIntfNbrStart, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCumNbrDown=ospfCumNbrDown, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoEntry=arpInfoEntry, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSAId=routerLSAId, ipInterfaceTableMax=ipInterfaceTableMax, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, arpStatMaxEntries=arpStatMaxEntries, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfHello=ospfIntfHello, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfInfoTable=ospfIntfInfoTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIntfTxHello=ospfIntfTxHello, ipRouteInfoIndx=ipRouteInfoIndx, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCumRxHello=ospfCumRxHello, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrp=vrrp, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ripNewCfgState=ripNewCfgState, ipRouteInfoInterface=ipRouteInfoInterface, ipRouteInfoType=ipRouteInfoType, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfIntfRxTxStats=ospfIntfRxTxStats, ripStats=ripStats, arpInfoDestIp=arpInfoDestIp, ipNewCfgGwEntry=ipNewCfgGwEntry, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfCumTxPkts=ospfCumTxPkts, routeStatHighWater=routeStatHighWater, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaTxPkts=ospfAreaTxPkts, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTotalAreas=ospfTotalAreas, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, vrrpGeneral=vrrpGeneral, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, routerLSALinkIfIndex=routerLSALinkIfIndex, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfTotalNeighbours=ospfTotalNeighbours, ospfNbrInFullState=ospfNbrInFullState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ipRouteInfoGateway=ipRouteInfoGateway, ospfIntfNbrDown=ospfIntfNbrDown, arpInfoTable=arpInfoTable, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfRxlsAcks=ospfIntfRxlsAcks, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrp_info=vrrp_info, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgAreaId=ospfCurCfgAreaId, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ripCurCfgVip=ripCurCfgVip, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumRxPkts=ospfCumRxPkts, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfIntfNbrChange=ospfIntfNbrChange, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipGatewayTableMax=ipGatewayTableMax, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ripNewCfgVip=ripNewCfgVip, vrrpStatInAdvers=vrrpStatInAdvers, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfGeneral=ospfGeneral, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfCountForRouter=ospfIntfCountForRouter, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ripCurCfgDefListen=ripCurCfgDefListen, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ripNewCfgListen=ripNewCfgListen, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwIndex=ipCurCfgGwIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwArp=ipCurCfgGwArp, ipForward=ipForward, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf)
