...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipRouteInfoIndx=ipRouteInfoIndx, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrhello=ospfCumNbrhello, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipRouteInfoInterface=ipRouteInfoInterface, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipNewCfgGwTable=ipNewCfgGwTable, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfCumNbrBadRequests=ospfCumNbrBadRequests, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNbrInInitState=ospfNbrInInitState, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIntfIndex=ospfIntfIndex, ripConfig=ripConfig, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpOper=vrrpOper, ospfAreaIntfDown=ospfAreaIntfDown, ripStats=ripStats, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfCumIntfBackup=ospfCumIntfBackup, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfIntfNbrChange=ospfIntfNbrChange, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfHostTableMaxSize=ospfHostTableMaxSize, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ripCurCfgVip=ripCurCfgVip, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumTxlsReqs=ospfCumTxlsReqs, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfStats=ospfStats, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, routeStats=routeStats, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, iprouting=iprouting, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaNbrIndex=ospfAreaNbrIndex, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripStatInErrorPkts=ripStatInErrorPkts, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrDown=ospfIntfNbrDown, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ripNewCfgState=ripNewCfgState, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfCumNbrChangeStats=ospfCumNbrChangeStats, arpInfoMacAddr=arpInfoMacAddr, ripCurCfgListen=ripCurCfgListen, ipNewCfgGwInterval=ipNewCfgGwInterval, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumIntfDown=ospfCumIntfDown, ospfAreaNbrStart=ospfAreaNbrStart, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, routerLSALinkID=routerLSALinkID, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ipFwdNewCfgPortState=ipFwdNewCfgPortState, routeStatEntries=routeStatEntries, arpStats=arpStats, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfIntfNbrIndex=ospfIntfNbrIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpInfoTable=arpInfoTable, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ip_info=ip_info, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSALinkData=routerLSALinkData, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfCumNbrDown=ospfCumNbrDown, ripNewCfgDefListen=ripNewCfgDefListen, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ipNewCfgIntfState=ipNewCfgIntfState, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, routeStatHighWater=routeStatHighWater, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ipRouteInfoTag=ipRouteInfoTag, arpInfoDestIp=arpInfoDestIp, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpStatOutAdvers=vrrpStatOutAdvers, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, dnsStats=dnsStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, arpInfoEntry=arpInfoEntry, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfStartTime=ospfStartTime, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfIntfRxHello=ospfIntfRxHello, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfinfo=ospfinfo, ipNewCfgGwState=ipNewCfgGwState, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpCurCfgGenState=vrrpCurCfgGenState, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIfInfoIpAddress=ospfIfInfoIpAddress, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfCumNbrStart=ospfCumNbrStart, ospfIntfRxPkts=ospfIntfRxPkts, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipRouteInfoType=ipRouteInfoType, ipRouteInfoDestIp=ipRouteInfoDestIp, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrp=vrrp, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfLoop=ospfIntfLoop, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwState=ipCurCfgGwState, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfGeneralInfo=ospfGeneralInfo, ipCurCfgBootpState=ipCurCfgBootpState, ospfProcessUptime=ospfProcessUptime, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ripStatInPkts=ripStatInPkts, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTimersKickOffStats=ospfTimersKickOffStats, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipRouteInfoGateway=ipRouteInfoGateway, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ospfCfg=ospfCfg, ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfCumRxTxStats=ospfCumRxTxStats, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, routerLSAId=routerLSAId, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ipCurCfgGwArp=ipCurCfgGwArp)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipFwdCurCfgState=ipFwdCurCfgState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfGeneralStats=ospfGeneralStats, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfInterface=ospfInterface, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfUnloop=ospfIntfUnloop, ospfCumTxDatabase=ospfCumTxDatabase, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfIntfInfoTable=ospfIntfInfoTable, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ripStatOutPkts=ripStatOutPkts, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfCumIntfLoop=ospfCumIntfLoop, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ipCurCfgGwRetry=ipCurCfgGwRetry, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfIntfHello=ospfIntfHello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxHello=ospfAreaTxHello, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfBackup=ospfIntfBackup, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaTxPkts=ospfAreaTxPkts, ospfCumTxPkts=ospfCumTxPkts, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipRouteInfoEntry=ipRouteInfoEntry, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfAreaChangeStats=ospfAreaChangeStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, arpStatEntries=arpStatEntries, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCumRxPkts=ospfCumRxPkts, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfTotalNeighbours=ospfTotalNeighbours, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ripNewCfgListen=ripNewCfgListen, ospfNbrInExchState=ospfNbrInExchState, ospfCumIntfHello=ospfCumIntfHello, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgVip=ripNewCfgVip, ospfAreaRxDatabase=ospfAreaRxDatabase, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgIntfState=ipCurCfgIntfState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaIntfIndex=ospfAreaIntfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipInterfaceTableMax=ipInterfaceTableMax, ospfArea=ospfArea, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfIntfChangeStats=ospfIntfChangeStats, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumRxlsUpdates=ospfCumRxlsUpdates, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaRxPkts=ospfAreaRxPkts, arpInfoSrcPort=arpInfoSrcPort, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, arpInfoVLAN=arpInfoVLAN, ipForward=ipForward, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, arpStatHighWater=arpStatHighWater, ospfAreaIntfHello=ospfAreaIntfHello, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfCumNbrN1way=ospfCumNbrN1way, ripCurCfgState=ripCurCfgState, ospfCumRxHello=ospfCumRxHello, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfTxPkts=ospfIntfTxPkts, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpStats=vrrpStats, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfIntfCountForRouter=ospfIntfCountForRouter, arpStatMaxEntries=arpStatMaxEntries, ospfAreaRxHello=ospfAreaRxHello, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrhello=ospfIntfNbrhello, ospfTotalAreas=ospfTotalAreas, ospfAreaInfoId=ospfAreaInfoId, ospfAreaTxDatabase=ospfAreaTxDatabase, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, routerLSAAreaIndex=routerLSAAreaIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpGeneral=vrrpGeneral, ospfCumTxlsUpdates=ospfCumTxlsUpdates, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrp_info=vrrp_info, ipNewCfgGwArp=ipNewCfgGwArp, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNewCfgAreaTable=ospfNewCfgAreaTable)
