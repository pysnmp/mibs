...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipGatewayTableMax=ipGatewayTableMax, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIntfWaitTimer=ospfIntfWaitTimer, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCfg=ospfCfg, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfTotalTransitAreas=ospfTotalTransitAreas, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumRxPkts=ospfCumRxPkts, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgGwArp=ipCurCfgGwArp, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfArea=ospfArea, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfIntfTxDatabase=ospfIntfTxDatabase, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfIntfNbrDown=ospfIntfNbrDown, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, routerLSALinkData=routerLSALinkData, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaId=ospfNewCfgAreaId, routeStatHighWater=routeStatHighWater, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, arpStatEntries=arpStatEntries, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipRouteInfoGateway=ipRouteInfoGateway, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ospfTotalAreas=ospfTotalAreas, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfIntfIndex=ospfIntfIndex, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfInterface=ospfInterface, ospfIntfTxHello=ospfIntfTxHello, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfBackup=ospfIntfBackup, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ospfIntfRxPkts=ospfIntfRxPkts, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ipFwdCurCfgState=ipFwdCurCfgState, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipRouteInfoType=ipRouteInfoType, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfHello=ospfIntfHello, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrp=vrrp, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfRxHello=ospfIntfRxHello, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipForward=ipForward, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, vrrpStatOutAdvers=vrrpStatOutAdvers, ipNewCfgGwInterval=ipNewCfgGwInterval, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, routerLSALinkID=routerLSALinkID, ospfIntfChangeStats=ospfIntfChangeStats, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipCurCfgGwIndex=ipCurCfgGwIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipNewCfgGwMetric=ipNewCfgGwMetric, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ospfCumRxHello=ospfCumRxHello, ospfCumIntfHello=ospfCumIntfHello, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfCumNbrStart=ospfCumNbrStart, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripNewCfgState=ripNewCfgState, ospfIntfLoop=ospfIntfLoop, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ripStatInPkts=ripStatInPkts, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfMask=ipCurCfgIntfMask, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfStats=ospfStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfIfWaitInterval=ospfIfWaitInterval, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ripCurCfgDefListen=ripCurCfgDefListen, ospfIntfRxTxStats=ospfIntfRxTxStats, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, arpInfoTable=arpInfoTable, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfAreaTxPkts=ospfAreaTxPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripConfig=ripConfig, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfStartTime=ospfStartTime, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfNbrInFullState=ospfNbrInFullState, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, arpInfoMacAddr=arpInfoMacAddr, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfAreaNbrIndex=ospfAreaNbrIndex, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ripCurCfgVip=ripCurCfgVip, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ipCurCfgGwState=ipCurCfgGwState, ospfAreaTxHello=ospfAreaTxHello, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaIntfHello=ospfAreaIntfHello, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, routerLSALinkIndex=routerLSALinkIndex, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ip_info=ip_info, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, arpStatMaxEntries=arpStatMaxEntries, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrN1way=ospfCumNbrN1way, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, dnsStats=dnsStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfinfo=ospfinfo, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ripCurCfgListen=ripCurCfgListen, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipNewCfgIntfIndex=ipNewCfgIntfIndex, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdNewCfgPortState=ipFwdNewCfgPortState, arpInfoVLAN=arpInfoVLAN, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwInterval=ipCurCfgGwInterval, ripNewCfgVip=ripNewCfgVip, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ipRouteInfoTable=ipRouteInfoTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ospfAreaRxHello=ospfAreaRxHello, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfAreaTxDatabase=ospfAreaTxDatabase, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfLoop=ospfAreaIntfLoop, iprouting=iprouting, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgIntfTable=ipCurCfgIntfTable, ipRouteInfoInterface=ipRouteInfoInterface, vrrpStats=vrrpStats, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfGeneral=ospfGeneral, ospfGeneralInfo=ospfGeneralInfo, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfCumNbrDown=ospfCumNbrDown, routeStats=routeStats, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipNewCfgGwArp=ipNewCfgGwArp, arpInfoEntry=arpInfoEntry, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipNewCfgGwAddr=ipNewCfgGwAddr, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfProcessUptime=ospfProcessUptime, vrrp_info=vrrp_info, ipInterfaceTableMax=ipInterfaceTableMax, vrrpOper=vrrpOper, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumTxDatabase=ospfCumTxDatabase, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ripCurCfgSupply=ripCurCfgSupply, routerLSAId=routerLSAId, ospfGeneralStats=ospfGeneralStats, ripStatOutPkts=ripStatOutPkts, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, arpStatHighWater=arpStatHighWater, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ripNewCfgSupply=ripNewCfgSupply, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfCumIntfLoop=ospfCumIntfLoop, vrrpGeneral=vrrpGeneral, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfDown=ospfIntfDown, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfIfInfoIndex=ospfIfInfoIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, arpStats=arpStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipCurCfgBootpState=ipCurCfgBootpState, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfLsTypesSupported=ospfLsTypesSupported, ipNewCfgGwState=ipNewCfgGwState, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaInfoId=ospfAreaInfoId, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfInfoTable=ospfIntfInfoTable, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, routeStatMaxEntries=routeStatMaxEntries, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaRxPkts=ospfAreaRxPkts, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfCumTxHello=ospfCumTxHello, arpInfoFlag=arpInfoFlag, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, arpInfoDestIp=arpInfoDestIp, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ripStats=ripStats, ospfAreaIntfIndex=ospfAreaIntfIndex, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfCumIntfBackup=ospfCumIntfBackup, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, ospfIntfUnloop=ospfIntfUnloop, vrrpStatInAdvers=vrrpStatInAdvers, ospfAreaNbrDown=ospfAreaNbrDown, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenState=vrrpNewCfgGenState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp)
