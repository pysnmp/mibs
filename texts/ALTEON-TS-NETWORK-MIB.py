...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaTxHello=ospfAreaTxHello, ospfLsTypesSupported=ospfLsTypesSupported, ospfAreaNbrhello=ospfAreaNbrhello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaInfoId=ospfAreaInfoId, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfCumIntfDown=ospfCumIntfDown, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfNbrInFullState=ospfNbrInFullState, ipRouteInfoEntry=ipRouteInfoEntry, ipGatewayTableMax=ipGatewayTableMax, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ospfAreaRxlsAcks=ospfAreaRxlsAcks, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ipInterfaceTableMax=ipInterfaceTableMax, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfIntfRxPkts=ospfIntfRxPkts, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ipCurCfgGwAddr=ipCurCfgGwAddr, ipCurCfgIntfMask=ipCurCfgIntfMask, ripStatOutPkts=ripStatOutPkts, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ospfCumRxHello=ospfCumRxHello, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfCumNbrDown=ospfCumNbrDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfCfg=ospfCfg, ospfTotalAreas=ospfTotalAreas, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgGwTable=ipNewCfgGwTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfHostTableMaxSize=ospfHostTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, ospfCumRxDatabase=ospfCumRxDatabase, ospfIntfTxPkts=ospfIntfTxPkts, dnsStats=dnsStats, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfGeneralInfo=ospfGeneralInfo, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, arpInfoEntry=arpInfoEntry, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumTxlsReqs=ospfCumTxlsReqs, arpStatHighWater=arpStatHighWater, ipCurCfgGwState=ipCurCfgGwState, vrrp=vrrp, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ripCurCfgSupply=ripCurCfgSupply, ipNewCfgIntfMask=ipNewCfgIntfMask, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCumTxDatabase=ospfCumTxDatabase, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfinfo=ospfinfo, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfNbrStart=ospfIntfNbrStart, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaIntfHello=ospfAreaIntfHello, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, routeStatMaxEntries=routeStatMaxEntries, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfArea=ospfArea, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ospfIntfNbrN1way=ospfIntfNbrN1way, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumRxPkts=ospfCumRxPkts, ospfStartTime=ospfStartTime, ipCurCfgGwRetry=ipCurCfgGwRetry, ripCurCfgVip=ripCurCfgVip, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, routerLSAId=routerLSAId, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, routerLSALinkIndex=routerLSALinkIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfAreaNbrDown=ospfAreaNbrDown, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ripNewCfgVip=ripNewCfgVip, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, arpInfoTable=arpInfoTable, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoVLAN=arpInfoVLAN, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ripNewCfgListen=ripNewCfgListen, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, arpInfoRefPorts=arpInfoRefPorts, ospfAreaRxPkts=ospfAreaRxPkts, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgBootpState=ipNewCfgBootpState, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ipCurCfgGwMetric=ipCurCfgGwMetric, ospfIntfInfoTable=ospfIntfInfoTable, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfIntfRxTxIndex=ospfIntfRxTxIndex, routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgGwArp=ipCurCfgGwArp, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfCumTxHello=ospfCumTxHello, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIfInfoIndex=ospfIfInfoIndex, ripCurCfgListen=ripCurCfgListen, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfIntfDown=ospfIntfDown, ospfTotalNeighbours=ospfTotalNeighbours, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfBackup=ospfCumIntfBackup, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfIntfIndex=ospfIntfIndex, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ospfCumNbrN1way=ospfCumNbrN1way, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ripNewCfgDefListen=ripNewCfgDefListen, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfInterface=ospfInterface, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfCurCfgAreaTable=ospfCurCfgAreaTable, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ripNewCfgState=ripNewCfgState, routeStatHighWater=routeStatHighWater, arpInfoFlag=arpInfoFlag, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, arpStats=arpStats, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpIfTableMaxSize=vrrpIfTableMaxSize, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfLoop=ospfCumIntfLoop, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ospfIntfRxTxStats=ospfIntfRxTxStats, ipNewCfgIntfTable=ipNewCfgIntfTable, ipNewCfgGwRetry=ipNewCfgGwRetry, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrp_info=vrrp_info, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfIntfRxHello=ospfIntfRxHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipRouteInfoInterface=ipRouteInfoInterface, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgIntfDelete=ipNewCfgIntfDelete, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpStatInAdvers=vrrpStatInAdvers, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ospfAreaRxTxStats=ospfAreaRxTxStats, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ipCurCfgGwInterval=ipCurCfgGwInterval, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfAreaRxHello=ospfAreaRxHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ripStatInPkts=ripStatInPkts, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfCumNbrhello=ospfCumNbrhello, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfInfoEntry=ospfIntfInfoEntry, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpGeneral=vrrpGeneral, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfNbrIndex=ospfIntfNbrIndex, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripStatInErrorPkts=ripStatInErrorPkts, ospfAreaNbrN1way=ospfAreaNbrN1way, ipNewCfgGwDelete=ipNewCfgGwDelete, ipRouteInfoType=ipRouteInfoType, routerLSALinkID=routerLSALinkID, ripStats=ripStats, ipNewCfgGwArp=ipNewCfgGwArp, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, routeStatEntries=routeStatEntries, routerLSALinkIfIndex=routerLSALinkIfIndex, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfBackup=ospfIntfBackup, ospfAreaNbrRstAd=ospfAreaNbrRstAd, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfGeneralStats=ospfGeneralStats, ospfAreaRxDatabase=ospfAreaRxDatabase, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpOper=vrrpOper, ospfProcessUptime=ospfProcessUptime, ipCurCfgIntfState=ipCurCfgIntfState, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ospfIntfLoop=ospfIntfLoop, ipNewCfgGwVlan=ipNewCfgGwVlan, ospfGeneral=ospfGeneral, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipRouteInfoDestIp=ipRouteInfoDestIp, arpStatEntries=arpStatEntries, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfNbrhello=ospfIntfNbrhello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipForward=ipForward, ipNewCfgGwIndex=ipNewCfgGwIndex, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaInfoTable=ospfAreaInfoTable, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaIntfLoop=ospfAreaIntfLoop, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfIntfTxHello=ospfIntfTxHello, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfIntfNbrDown=ospfIntfNbrDown, ospfAreaNbrStart=ospfAreaNbrStart, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfCumTxPkts=ospfCumTxPkts, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfNewCfgAreaId=ospfNewCfgAreaId, iprouting=iprouting, ipCurCfgGwVlan=ipCurCfgGwVlan, ripConfig=ripConfig, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, routeStats=routeStats, ipNewCfgGwState=ipNewCfgGwState, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIfWaitInterval=ospfIfWaitInterval, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfIntfUnloop=ospfIntfUnloop, ipFwdNewCfgState=ipFwdNewCfgState, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfIntfChangeStats=ospfIntfChangeStats, ripNewCfgSupply=ripNewCfgSupply, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ripCurCfgDefListen=ripCurCfgDefListen, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaIntfDown=ospfAreaIntfDown, ip_info=ip_info, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfCumRxTxStats=ospfCumRxTxStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, arpStatMaxEntries=arpStatMaxEntries, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfStats=ospfStats, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipCurCfgGwTable=ipCurCfgGwTable, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ripCurCfgState=ripCurCfgState, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfTotalTransitAreas=ospfTotalTransitAreas, arpInfoDestIp=arpInfoDestIp, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfNbrInExchState=ospfNbrInExchState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpStats=vrrpStats, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfAreaChangeStats=ospfAreaChangeStats, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfHello=ospfIntfHello, ipFwdCurCfgState=ipFwdCurCfgState)
