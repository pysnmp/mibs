...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumRxHello=ospfCumRxHello, vrrpCurCfgGenState=vrrpCurCfgGenState, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfIntfRxTxIndex=ospfIntfRxTxIndex, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdCurCfgState=ipFwdCurCfgState, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfAreaIntfHello=ospfAreaIntfHello, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ospfAreaTxHello=ospfAreaTxHello, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, ipCurCfgGwIndex=ipCurCfgGwIndex, ospfArea=ospfArea, ipCurCfgGwInterval=ipCurCfgGwInterval, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfGeneral=ospfGeneral, ipNewCfgIntfDelete=ipNewCfgIntfDelete, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ripCurCfgListen=ripCurCfgListen, ipCurCfgGwArp=ipCurCfgGwArp, ipRouteInfoTable=ipRouteInfoTable, routeStats=routeStats, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfTotalNeighbours=ospfTotalNeighbours, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfCumTxlsReqs=ospfCumTxlsReqs, ipNewCfgIntfTable=ipNewCfgIntfTable, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, routerLSALinkID=routerLSALinkID, ipCurCfgIntfVlan=ipCurCfgIntfVlan, routerLSAId=routerLSAId, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfAreaNbrN1way=ospfAreaNbrN1way, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ospfTimersKickOffStats=ospfTimersKickOffStats, ospfIntfTxPkts=ospfIntfTxPkts, ospfAreaNbrhello=ospfAreaNbrhello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgSupply=ripCurCfgSupply, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ipNewCfgGwArp=ipNewCfgGwArp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ripNewCfgVip=ripNewCfgVip, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfCumNbrhello=ospfCumNbrhello, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ipCurCfgGwAddr=ipCurCfgGwAddr, ospfIntfCountForRouter=ospfIntfCountForRouter, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfCumTxlsAcks=ospfCumTxlsAcks, routerLSALinkIfIndex=routerLSALinkIfIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, arpInfoRefPorts=arpInfoRefPorts, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ipNewCfgGwTable=ipNewCfgGwTable, vrrp_info=vrrp_info, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipInterfaceTableMax=ipInterfaceTableMax, ripNewCfgListen=ripNewCfgListen, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCumTxDatabase=ospfCumTxDatabase, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, arpInfoEntry=arpInfoEntry, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfCumRxlsAcks=ospfCumRxlsAcks, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, arpStatHighWater=arpStatHighWater, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, arpInfoTable=arpInfoTable, ospfIntfTxHello=ospfIntfTxHello, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, ospfIntfDown=ospfIntfDown, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, arpInfoMacAddr=arpInfoMacAddr, vrrpStats=vrrpStats, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipNewCfgGwDelete=ipNewCfgGwDelete, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfIntfRxPkts=ospfIntfRxPkts, arpStats=arpStats, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ipCurCfgGwTable=ipCurCfgGwTable, ipRouteInfoDestIp=ipRouteInfoDestIp, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfStats=ospfStats, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ipCurCfgGwState=ipCurCfgGwState, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfAreaChangeStats=ospfAreaChangeStats, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgGwVlan=ipCurCfgGwVlan, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfNbrhello=ospfIntfNbrhello, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, arpInfoSrcPort=arpInfoSrcPort, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipNewCfgIntfAddr=ipNewCfgIntfAddr, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfIntfInfoTable=ospfIntfInfoTable, arpInfoFlag=arpInfoFlag, arpInfoDestIp=arpInfoDestIp, ipRouteInfoEntry=ipRouteInfoEntry, ospfIfInfoIndex=ospfIfInfoIndex, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfUnloop=ospfIntfUnloop, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ipRouteInfoTag=ipRouteInfoTag, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, routeStatEntries=routeStatEntries, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfCumIntfHello=ospfCumIntfHello, ospfInterface=ospfInterface, ospfCumIntfChangeStats=ospfCumIntfChangeStats, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfHostTableMaxSize=ospfHostTableMaxSize, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ospfNbrInFullState=ospfNbrInFullState, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfIntfIndex=ospfIntfIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, vrrp=vrrp, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfGeneralInfo=ospfGeneralInfo, ripNewCfgState=ripNewCfgState, ospfIntfRxTxStats=ospfIntfRxTxStats, ripConfig=ripConfig, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, ospfAreaRxPkts=ospfAreaRxPkts, routerLSAAreaIndex=routerLSAAreaIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoMask=ipRouteInfoMask, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ripNewCfgDefListen=ripNewCfgDefListen, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfAreaTxPkts=ospfAreaTxPkts, arpInfoVLAN=arpInfoVLAN, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ripStats=ripStats, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfAreaTxlsReqs=ospfAreaTxlsReqs, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ospfCumIntfLoop=ospfCumIntfLoop, ospfAreaInfoId=ospfAreaInfoId, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, vrrpOper=vrrpOper, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfAreaRxlsAcks=ospfAreaRxlsAcks)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfCumNbrBadRequests=ospfCumNbrBadRequests, ipCurCfgBootpState=ipCurCfgBootpState, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrIndex=ospfAreaNbrIndex, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfAreaRxHello=ospfAreaRxHello, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ip_info=ip_info, ospfTotalAreas=ospfTotalAreas, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, dnsStats=dnsStats, ipNewCfgBootpState=ipNewCfgBootpState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, ipNewCfgGwVlan=ipNewCfgGwVlan, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaTxlsAcks=ospfAreaTxlsAcks, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwState=ipNewCfgGwState, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfIntfHello=ospfIntfHello, ospfAreaInfoTable=ospfAreaInfoTable, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ipCurCfgIntfAddr=ipCurCfgIntfAddr, routeStatHighWater=routeStatHighWater, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfCumTxHello=ospfCumTxHello, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfinfo=ospfinfo, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ipFwdNewCfgState=ipFwdNewCfgState, vrrpGeneral=vrrpGeneral, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumTxPkts=ospfCumTxPkts, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipFwdNewCfgPortState=ipFwdNewCfgPortState, vrrpStatOutAdvers=vrrpStatOutAdvers, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ospfCumNbrStart=ospfCumNbrStart, ospfCumNbrN1way=ospfCumNbrN1way, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfCumIntfNbrChange=ospfCumIntfNbrChange, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ipCurCfgIntfState=ipCurCfgIntfState, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfLsTypesSupported=ospfLsTypesSupported, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ipCurCfgIntfMask=ipCurCfgIntfMask, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfCumIntfBackup=ospfCumIntfBackup, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, routeStatMaxEntries=routeStatMaxEntries, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfCfg=ospfCfg, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipRouteInfoIndx=ipRouteInfoIndx, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSALinkIndex=routerLSALinkIndex, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwIndex=ipNewCfgGwIndex, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaIntfDown=ospfAreaIntfDown, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfProcessUptime=ospfProcessUptime, ospfTotalNssaAreas=ospfTotalNssaAreas, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrDown=ospfCumNbrDown, ipNewCfgGwEntry=ipNewCfgGwEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfIfWaitInterval=ospfIfWaitInterval, ospfIntfTableMaxSize=ospfIntfTableMaxSize, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ripCurCfgVip=ripCurCfgVip, ospfIntfBackup=ospfIntfBackup, ripStatInPkts=ripStatInPkts, ospfIntfNbrDown=ospfIntfNbrDown, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfCumRxPkts=ospfCumRxPkts, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfLoop=ospfIntfLoop, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ripStatInErrorPkts=ripStatInErrorPkts, ospfNbrInExchState=ospfNbrInExchState, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ripStatOutPkts=ripStatOutPkts, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfGeneralStats=ospfGeneralStats, routerLSALinkData=routerLSALinkData, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ospfNbrInInitState=ospfNbrInInitState, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipRouteInfoGateway=ipRouteInfoGateway, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfCurCfgAreaId=ospfCurCfgAreaId, ripCurCfgState=ripCurCfgState, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ospfIntfRxDatabase=ospfIntfRxDatabase, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, arpStatMaxEntries=arpStatMaxEntries, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ripCurCfgDefListen=ripCurCfgDefListen, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfCumRxDatabase=ospfCumRxDatabase, iprouting=iprouting, ospfIntfRxHello=ospfIntfRxHello, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, ospfIntfNbrStart=ospfIntfNbrStart, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, vrrpStatInAdvers=vrrpStatInAdvers, ipForward=ipForward, ospfAreaNbrStart=ospfAreaNbrStart, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfStartTime=ospfStartTime, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, ospfIntfNbrChange=ospfIntfNbrChange, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfAreaRxDatabase=ospfAreaRxDatabase)
