...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, ospfIntfTxPkts=ospfIntfTxPkts, ospfIntfChangeStats=ospfIntfChangeStats, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ripStatOutPkts=ripStatOutPkts, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfCumTxlsAcks=ospfCumTxlsAcks, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipCurCfgGwState=ipCurCfgGwState, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, routeStatEntries=routeStatEntries, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ripNewCfgListen=ripNewCfgListen, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ipCurCfgGwTable=ipCurCfgGwTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ripCurCfgStaticSupply=ripCurCfgStaticSupply, ospfCumRxPkts=ospfCumRxPkts, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ipNewCfgGwArp=ipNewCfgGwArp, ipRouteInfoDestIp=ipRouteInfoDestIp, ipNewCfgGwVlan=ipNewCfgGwVlan, arpStatEntries=arpStatEntries, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpStats=vrrpStats, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfRxTxStats=ospfIntfRxTxStats, routerLSALinkIfIndex=routerLSALinkIfIndex, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ospfIntfIndex=ospfIntfIndex, ripStatInPkts=ripStatInPkts, ipFwdNewCfgState=ipFwdNewCfgState, ospfIntfInfoEntry=ospfIntfInfoEntry, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgIntfTable=ipCurCfgIntfTable, vrrpOper=vrrpOper, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfAreaRxDatabase=ospfAreaRxDatabase, ipRouteInfoMask=ipRouteInfoMask, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipForward=ipForward, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfTimersKickOffStats=ospfTimersKickOffStats, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfCurCfgAreaId=ospfCurCfgAreaId, vrrpNewCfgIfTable=vrrpNewCfgIfTable, ospfCumNbrhello=ospfCumNbrhello, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ripStatInErrorPkts=ripStatInErrorPkts, ipNewCfgIntfState=ipNewCfgIntfState, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfIntfRxPkts=ospfIntfRxPkts, ospfIfWaitInterval=ospfIfWaitInterval, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripCurCfgSupply=ripCurCfgSupply, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ipInterfaceTableMax=ipInterfaceTableMax, ospfCumRxlsReqs=ospfCumRxlsReqs, ripNewCfgState=ripNewCfgState, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfinfo=ospfinfo, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfAreaNbrhello=ospfAreaNbrhello, ospfCumIntfDown=ospfCumIntfDown, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaTxPkts=ospfAreaTxPkts, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfAreaNbrStart=ospfAreaNbrStart, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ospfArea=ospfArea, ipNewCfgGwIndex=ipNewCfgGwIndex, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, arpInfoVLAN=arpInfoVLAN, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ripCurCfgListen=ripCurCfgListen, ospfCumNbrN1way=ospfCumNbrN1way, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, ospfCumIntfHello=ospfCumIntfHello, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ospfStartTime=ospfStartTime, ripConfig=ripConfig, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfNewCfgAreaTable=ospfNewCfgAreaTable, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, ipNewCfgBootpAddr=ipNewCfgBootpAddr, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, ospfCumTxPkts=ospfCumTxPkts, ipFwdCurCfgState=ipFwdCurCfgState, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, routeStatMaxEntries=routeStatMaxEntries, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ospfAreaInfoId=ospfAreaInfoId, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfNbrInInitState=ospfNbrInInitState, ospfCumRxDatabase=ospfCumRxDatabase, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ipGatewayTableMax=ipGatewayTableMax, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfAreaInfoTable=ospfAreaInfoTable, ospfIntfInfoTable=ospfIntfInfoTable, ospfIntfCountForRouter=ospfIntfCountForRouter, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, routerLSAAreaIndex=routerLSAAreaIndex, ospfTotalAreas=ospfTotalAreas, ripCurCfgDefListen=ripCurCfgDefListen, ospfHostTableMaxSize=ospfHostTableMaxSize, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfCumNbrRstAd=ospfCumNbrRstAd, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, ospfCumTxDatabase=ospfCumTxDatabase, ipRouteInfoIndx=ipRouteInfoIndx, arpInfoFlag=arpInfoFlag, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrN1way=ospfIntfNbrN1way, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfIntfDown=ospfIntfDown, ospfCumTxHello=ospfCumTxHello, ipNewCfgGwInterval=ipNewCfgGwInterval, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfAreaTxHello=ospfAreaTxHello, ipNewCfgGwState=ipNewCfgGwState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfGeneralInfo=ospfGeneralInfo, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, iprouting=iprouting, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumRxHello=ospfCumRxHello, ipRouteInfoType=ipRouteInfoType, vrrp=vrrp, ospfAreaIntfBackup=ospfAreaIntfBackup, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfBackup=ospfIntfBackup, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfInterface=ospfInterface, ip_info=ip_info, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfGeneralStats=ospfGeneralStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, routeStats=routeStats, ipNewCfgBootpState=ipNewCfgBootpState, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfIntfNbrDown=ospfIntfNbrDown, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfNbrIndex=ospfIntfNbrIndex, arpInfoSrcPort=arpInfoSrcPort, ipNewCfgIntfVlan=ipNewCfgIntfVlan, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfAreaNbrIndex=ospfAreaNbrIndex, arpInfoEntry=arpInfoEntry, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipNewCfgIntfMask=ipNewCfgIntfMask, ospfTotalNeighbours=ospfTotalNeighbours, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, ospfStats=ospfStats, ospfIntfUnloop=ospfIntfUnloop, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ospfCumRxTxStats=ospfCumRxTxStats, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ipCurCfgGwMetric=ipCurCfgGwMetric, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ospfIntfWaitTimer=ospfIntfWaitTimer, ripStats=ripStats, ripCurCfgVip=ripCurCfgVip, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, ospfAreaIntfHello=ospfAreaIntfHello, ipCurCfgIntfState=ipCurCfgIntfState, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfTmrsKckOffHello=ospfTmrsKckOffHello, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ipRouteInfoEntry=ipRouteInfoEntry, ipRouteInfoInterface=ipRouteInfoInterface, ipCurCfgBootpState=ipCurCfgBootpState, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfIntfRxHello=ospfIntfRxHello, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ospfIntfNbrhello=ospfIntfNbrhello, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, arpStatHighWater=arpStatHighWater, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ospfIntfLoop=ospfIntfLoop, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSALinkData=routerLSALinkData, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfGeneral=ospfGeneral, arpInfoTable=arpInfoTable, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfCumIntfBackup=ospfCumIntfBackup, ospfAreaIntfIndex=ospfAreaIntfIndex, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, arpStatMaxEntries=arpStatMaxEntries, ipCurCfgGwRetry=ipCurCfgGwRetry, ospfAreaRxPkts=ospfAreaRxPkts, routerLSALinkID=routerLSALinkID, ipRouteInfoTag=ipRouteInfoTag, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIfTotalNeighbours=ospfIfTotalNeighbours, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfCumNbrDown=ospfCumNbrDown, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfProcessUptime=ospfProcessUptime, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ospfCfg=ospfCfg, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaRxHello=ospfAreaRxHello, arpInfoRefPorts=arpInfoRefPorts, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfIntfNbrStart=ospfIntfNbrStart, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, routerLSALinkIndex=routerLSALinkIndex, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipNewCfgGwTable=ipNewCfgGwTable, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, ospfIfInfoIndex=ospfIfInfoIndex, ospfAreaNbrDown=ospfAreaNbrDown, ipCurCfgGwInterval=ipCurCfgGwInterval, arpStats=arpStats, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, arpInfoDestIp=arpInfoDestIp, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaInfoEntry=ospfAreaInfoEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, dnsStats=dnsStats, ospfIntfTxHello=ospfIntfTxHello, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ipCurCfgGwVlan=ipCurCfgGwVlan, ipCurCfgIntfIndex=ipCurCfgIntfIndex, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpGeneral=vrrpGeneral, ipNewCfgIntfTable=ipNewCfgIntfTable, ospfNbrInExchState=ospfNbrInExchState, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfNbrInFullState=ospfNbrInFullState, ipRouteInfoGateway=ipRouteInfoGateway, routeStatHighWater=routeStatHighWater, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ipNewCfgGwMetric=ipNewCfgGwMetric, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ipRouteInfoTable=ipRouteInfoTable, ipCurCfgGwArp=ipCurCfgGwArp, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ripCurCfgState=ripCurCfgState, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfAreaNbrN1way=ospfAreaNbrN1way, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipCurCfgGwAddr=ipCurCfgGwAddr, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwEntry=ipNewCfgGwEntry, arpInfoMacAddr=arpInfoMacAddr, ospfIntfNbrChange=ospfIntfNbrChange, ospfIntfHello=ospfIntfHello, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, vrrpNewCfgGenState=vrrpNewCfgGenState, ospfCumIntfLoop=ospfCumIntfLoop, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, routerLSAId=routerLSAId, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ospfCumIntfUnloop=ospfCumIntfUnloop, vrrp_info=vrrp_info)
