...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", routerLSALinkData=routerLSALinkData, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, ospfAreaInfoTable=ospfAreaInfoTable, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, ospfAreaIntfDown=ospfAreaIntfDown, iprouting=iprouting, ospfIntfBackup=ospfIntfBackup, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgIntfState=ipNewCfgIntfState, ospfCumRxDatabase=ospfCumRxDatabase, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, ospfGeneralStats=ospfGeneralStats, ipInterfaceTableMax=ipInterfaceTableMax, ipFwdNewCfgState=ipFwdNewCfgState, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone, ospfCumNbrStart=ospfCumNbrStart, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ripCurCfgState=ripCurCfgState, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripConfig=ripConfig, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ripStats=ripStats, ipNewCfgIntfEntry=ipNewCfgIntfEntry, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ospfIntfNbrhello=ospfIntfNbrhello, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ospfAreaChangeStats=ospfAreaChangeStats, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfDown=ospfCumIntfDown, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, routeStats=routeStats, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, ospfTimersKickOffStats=ospfTimersKickOffStats, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, arpInfoEntry=arpInfoEntry, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfIntfNbrN1way=ospfIntfNbrN1way, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfIntfNbrRstAd=ospfIntfNbrRstAd, ospfTotalAreas=ospfTotalAreas, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ospfNbrInExchState=ospfNbrInExchState, ipCurCfgGwMetric=ipCurCfgGwMetric, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfCumRxPkts=ospfCumRxPkts, ospfCumIntfLoop=ospfCumIntfLoop, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, vrrpCurCfgIfTable=vrrpCurCfgIfTable, ospfAreaInfoIndex=ospfAreaInfoIndex, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, ipNewCfgGwState=ipNewCfgGwState, ospfIntfTxlsAcks=ospfIntfTxlsAcks, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, routerLSALinkID=routerLSALinkID, ospfIntfTxPkts=ospfIntfTxPkts, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ipCurCfgGwRetry=ipCurCfgGwRetry, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrN1way=ospfAreaNbrN1way, ipCurCfgGwAddr=ipCurCfgGwAddr, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ipCurCfgGwState=ipCurCfgGwState, ospfIntfRxHello=ospfIntfRxHello, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, ospfProcessUptime=ospfProcessUptime, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ripNewCfgState=ripNewCfgState, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, ospfAreaIntfUnloop=ospfAreaIntfUnloop, ripNewCfgListen=ripNewCfgListen, ospfInterface=ospfInterface, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, ospfAreaTxDatabase=ospfAreaTxDatabase, ipCurCfgGwVlan=ipCurCfgGwVlan, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfIntfHello=ospfIntfHello, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipRouteInfoIndx=ipRouteInfoIndx, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ripCurCfgSupply=ripCurCfgSupply, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ipRouteInfoTable=ipRouteInfoTable, ospfIntfNbrIndex=ospfIntfNbrIndex, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgIntfEntry=ipCurCfgIntfEntry, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgGenState=vrrpCurCfgGenState, ipNewCfgGwDelete=ipNewCfgGwDelete, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaTxHello=ospfAreaTxHello, ipGatewayTableMax=ipGatewayTableMax, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ipCurCfgIntfAddr=ipCurCfgIntfAddr, arpInfoFlag=arpInfoFlag, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ipNewCfgGwEntry=ipNewCfgGwEntry, ospfCumRxlsReqs=ospfCumRxlsReqs, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfIntfUnloop=ospfIntfUnloop, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, ospfIntfNbrChange=ospfIntfNbrChange, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, routerLSALinkIndex=routerLSALinkIndex, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaNbrDown=ospfAreaNbrDown, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, ospfLsTypesSupported=ospfLsTypesSupported, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, arpInfoMacAddr=arpInfoMacAddr, arpStatMaxEntries=arpStatMaxEntries, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, ospfIntfIndex=ospfIntfIndex, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ipNewCfgGwArp=ipNewCfgGwArp, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfGeneral=ospfGeneral, ospfCumRxHello=ospfCumRxHello, ospfAreaTxlsAcks=ospfAreaTxlsAcks, routeStatMaxEntries=routeStatMaxEntries, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, ospfCfg=ospfCfg, ipRouteInfoGateway=ipRouteInfoGateway, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, ipNewCfgIntfMask=ipNewCfgIntfMask, ripStatInPkts=ripStatInPkts, arpInfoRefPorts=arpInfoRefPorts, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpStats=vrrpStats, ripCurCfgListen=ripCurCfgListen, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, ipRouteInfoEntry=ipRouteInfoEntry, ipForward=ipForward, ipNewCfgIntfTable=ipNewCfgIntfTable, arpInfoSrcPort=arpInfoSrcPort, ripStatOutPkts=ripStatOutPkts, ipNewCfgGwInterval=ipNewCfgGwInterval, ospfAreaIntfLoop=ospfAreaIntfLoop, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, ospfCumTxHello=ospfCumTxHello, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfTotalNeighbours=ospfTotalNeighbours, ospfAreaRxTxIndex=ospfAreaRxTxIndex, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ospfIfTotalNeighbours=ospfIfTotalNeighbours, arpInfoVLAN=arpInfoVLAN, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, vrrp_info=vrrp_info, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ipCurCfgIntfState=ipCurCfgIntfState, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ospfCumNbrDown=ospfCumNbrDown, ospfAreaInfoEntry=ospfAreaInfoEntry, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, ospfAreaRxlsReqs=ospfAreaRxlsReqs, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, vrrpStatInAdvers=vrrpStatInAdvers, ospfIntfRxDatabase=ospfIntfRxDatabase, ospfGeneralInfo=ospfGeneralInfo, ospfCumNbrBadSequence=ospfCumNbrBadSequence, ospfAreaTxPkts=ospfAreaTxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfTotalNssaAreas=ospfTotalNssaAreas, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, arpInfoTable=arpInfoTable, ipRouteInfoTag=ipRouteInfoTag, ip_info=ip_info, ripCurCfgVip=ripCurCfgVip, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ospfCumIntfUnloop=ospfCumIntfUnloop, ospfAreaInfoId=ospfAreaInfoId, ospfIntfTxlsReqs=ospfIntfTxlsReqs, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ospfIntfRxlsReqs=ospfIntfRxlsReqs, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, ipRouteInfoType=ipRouteInfoType, ipRouteInfoInterface=ipRouteInfoInterface, ospfIntfTxHello=ospfIntfTxHello, ospfIntfCountForRouter=ospfIntfCountForRouter, arpStatHighWater=arpStatHighWater, ospfCumTxPkts=ospfCumTxPkts, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, ospfAreaNbrhello=ospfAreaNbrhello, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfIntfNbrStart=ospfIntfNbrStart, ospfHostTableMaxSize=ospfHostTableMaxSize, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, vrrpNewCfgGenState=vrrpNewCfgGenState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, ipCurCfgGwArp=ipCurCfgGwArp, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfCumTxDatabase=ospfCumTxDatabase, ipNewCfgIntfIndex=ipNewCfgIntfIndex, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfCumTxlsReqs=ospfCumTxlsReqs, ipCurCfgGwTable=ipCurCfgGwTable, ripNewCfgDefListen=ripNewCfgDefListen, vrrpNewCfgIfTable=vrrpNewCfgIfTable, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIfInfoIndex=ospfIfInfoIndex, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, vrrp=vrrp, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ipNewCfgBootpState=ipNewCfgBootpState, ipNewCfgGwTable=ipNewCfgGwTable, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, arpInfoDestIp=arpInfoDestIp, routeStatHighWater=routeStatHighWater, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripCurCfgDefListen=ripCurCfgDefListen, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfAreaTableMaxSize=ospfAreaTableMaxSize, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, ripNewCfgSupply=ripNewCfgSupply, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, ipNewCfgGwVlan=ipNewCfgGwVlan, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ipFwdCurCfgState=ipFwdCurCfgState, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, ospfIntfDown=ospfIntfDown, ipCurCfgIntfIndex=ipCurCfgIntfIndex, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfinfo=ospfinfo, vrrpGeneral=vrrpGeneral, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfCumIntfBackup=ospfCumIntfBackup, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripStatInErrorPkts=ripStatInErrorPkts, ospfCumRxlsAcks=ospfCumRxlsAcks, ipNewCfgGwMetric=ipNewCfgGwMetric, arpStats=arpStats, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, ripNewCfgStaticSupply=ripNewCfgStaticSupply, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfNbrInInitState=ospfNbrInInitState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, routerLSAAreaIndex=routerLSAAreaIndex, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, ospfTotalTransitAreas=ospfTotalTransitAreas, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, ospfAreaRxTxStats=ospfAreaRxTxStats, ipCurCfgGwEntry=ipCurCfgGwEntry, vrrpOper=vrrpOper, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, routeStatEntries=routeStatEntries, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, ospfAreaRxlsAcks=ospfAreaRxlsAcks, routerLSAId=routerLSAId, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, ospfCumRxTxStats=ospfCumRxTxStats, ospfVlinkCountForRouter=ospfVlinkCountForRouter, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, ospfAreaRxPkts=ospfAreaRxPkts, ospfCumTxlsUpdates=ospfCumTxlsUpdates, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfNewCfgAreaId=ospfNewCfgAreaId, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfIntfRxTxStats=ospfIntfRxTxStats, ipCurCfgGwIndex=ipCurCfgGwIndex, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ipRouteInfoDestIp=ipRouteInfoDestIp, ospfIntfRxPkts=ospfIntfRxPkts, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfCumNbrN1way=ospfCumNbrN1way, ospfStartTime=ospfStartTime, vrrpStatOutAdvers=vrrpStatOutAdvers, routerLSALinkIfIndex=routerLSALinkIfIndex, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ospfAreaRxHello=ospfAreaRxHello, ospfIntfLoop=ospfIntfLoop, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgIntfTable=ipCurCfgIntfTable, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfStats=ospfStats, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfAreaRxDatabase=ospfAreaRxDatabase, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ipNewCfgGwAddr=ipNewCfgGwAddr, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, ospfArea=ospfArea, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ipRouteInfoMask=ipRouteInfoMask, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, ospfCumNbrhello=ospfCumNbrhello, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, dnsStats=dnsStats, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgGwRetry=ipNewCfgGwRetry, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, ospfAreaIntfIndex=ospfAreaIntfIndex, ospfCumNbrChangeStats=ospfCumNbrChangeStats, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIfWaitInterval=ospfIfWaitInterval, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, arpStatEntries=arpStatEntries, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ospfNbrInFullState=ospfNbrInFullState, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry)
