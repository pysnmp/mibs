...
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", vrrpCurCfgVirtRtrGrpTckL4Port=vrrpCurCfgVirtRtrGrpTckL4Port, ipCurCfgStaticRouteEntry=ipCurCfgStaticRouteEntry, vrrpNewCfgIfTable=vrrpNewCfgIfTable, arpStatHighWater=arpStatHighWater, ospfAreaNbrIndex=ospfAreaNbrIndex, ipNewCfgBootpAddr=ipNewCfgBootpAddr, ospfNbrInFullState=ospfNbrInFullState, ipCurCfgStaticRouteGateway=ipCurCfgStaticRouteGateway, vrrpCurCfgGenTckVlanPortInc=vrrpCurCfgGenTckVlanPortInc, vrrpNewCfgGenTckRServerInc=vrrpNewCfgGenTckRServerInc, ipRouteInfoTable=ipRouteInfoTable, vrrpNewCfgVirtRtrTckHsrv=vrrpNewCfgVirtRtrTckHsrv, vrrpNewCfgIfDelete=vrrpNewCfgIfDelete, vrrpCurCfgVirtRtrGrpID=vrrpCurCfgVirtRtrGrpID, ospfCurCfgAreaAuthType=ospfCurCfgAreaAuthType, ipRouteInfoType=ipRouteInfoType, ospfAreaNbrStart=ospfAreaNbrStart, ipCurCfgIntfVlan=ipCurCfgIntfVlan, ospfAreaRxTxStats=ospfAreaRxTxStats, ospfAreaTxHello=ospfAreaTxHello, ospfAreaTxlsReqs=ospfAreaTxlsReqs, ospfProcessUptime=ospfProcessUptime, ipNewCfgGwVlan=ipNewCfgGwVlan, routerLSAId=routerLSAId, ipInterfaceTableMax=ipInterfaceTableMax, ospfIntfNbrBadRequests=ospfIntfNbrBadRequests, ipFwdNewCfgPortEntry=ipFwdNewCfgPortEntry, vrrpCurCfgVirtRtrState=vrrpCurCfgVirtRtrState, ospfGeneral=ospfGeneral, routerLSALinkIndex=routerLSALinkIndex, ospfCumRxlsAcks=ospfCumRxlsAcks, ospfAreaInfoTable=ospfAreaInfoTable, ospfAreaNbrExchangeDone=ospfAreaNbrExchangeDone, vrrpNewCfgGenState=vrrpNewCfgGenState, ipNewCfgStaticRouteIndx=ipNewCfgStaticRouteIndx, ipNewCfgBootpState=ipNewCfgBootpState, ospfNewCfgAreaAuthType=ospfNewCfgAreaAuthType, ospfAreaRxlsUpdates=ospfAreaRxlsUpdates, ospfCurCfgAreaIndex=ospfCurCfgAreaIndex, ospfTotalNumberOfInterfaces=ospfTotalNumberOfInterfaces, ospfIntfInfoEntry=ospfIntfInfoEntry, vrrpOperVirtRtrGroupBackup=vrrpOperVirtRtrGroupBackup, ospfNewCfgAreaEntry=ospfNewCfgAreaEntry, arpNewCfgReARPPeriod=arpNewCfgReARPPeriod, vrrpInfoVirtRtrIndex=vrrpInfoVirtRtrIndex, ipRouteInfoMask=ipRouteInfoMask, vrrpCurCfgGenTckL4PortInc=vrrpCurCfgGenTckL4PortInc, vrrpCurCfgVirtRtrAddr=vrrpCurCfgVirtRtrAddr, ospfIntfTxPkts=ospfIntfTxPkts, ospfCumRxPkts=ospfCumRxPkts, ospfAreaTxlsUpdates=ospfAreaTxlsUpdates, ipNewCfgIntfAddr=ipNewCfgIntfAddr, ipFwdCurCfgState=ipFwdCurCfgState, ospfIntfHello=ospfIntfHello, ospfIntfRxPkts=ospfIntfRxPkts, ospfCurCfgDefaultRouteMetric=ospfCurCfgDefaultRouteMetric, vrrpCurCfgVirtRtrGrpTckHsrp=vrrpCurCfgVirtRtrGrpTckHsrp, ospfIntfRxTxStats=ospfIntfRxTxStats, vrrpCurCfgVirtRtrGrpTckVlanPort=vrrpCurCfgVirtRtrGrpTckVlanPort, ipNewCfgGwEntry=ipNewCfgGwEntry, arpStatEntries=arpStatEntries, vrrpCurCfgVirtRtrGrpPreempt=vrrpCurCfgVirtRtrGrpPreempt, vrrpNewCfgVirtRtrIndx=vrrpNewCfgVirtRtrIndx, ospfAreaRxlsReqs=ospfAreaRxlsReqs, ospfAreaNbrN1way=ospfAreaNbrN1way, ospfAreaIntfHello=ospfAreaIntfHello, ipFwdCurCfgPortIndex=ipFwdCurCfgPortIndex, ospfCumNbrBadSequence=ospfCumNbrBadSequence, vrrpStats=vrrpStats, ospfAreaNbrRstAd=ospfAreaNbrRstAd, ospfIntfDown=ospfIntfDown, ospfCumTxDatabase=ospfCumTxDatabase, vrrpInfoVirtRtrOwnership=vrrpInfoVirtRtrOwnership, vrrpIfTableMaxSize=vrrpIfTableMaxSize, ospfCumNbrAdjointOk=ospfCumNbrAdjointOk, vrrpNewCfgVirtRtrGrpTableEntry=vrrpNewCfgVirtRtrGrpTableEntry, vrrp=vrrp, vrrpNewCfgVirtRtrTckRServer=vrrpNewCfgVirtRtrTckRServer, ospfIntfCountForRouter=ospfIntfCountForRouter, ipNewCfgIntfVlan=ipNewCfgIntfVlan, ripNewCfgDefListen=ripNewCfgDefListen, ipFwdCurCfgPortState=ipFwdCurCfgPortState, ospfRangeTableMaxSize=ospfRangeTableMaxSize, ipNewCfgStaticRouteAction=ipNewCfgStaticRouteAction, ospfTimersKickOffStats=ospfTimersKickOffStats, ipForward=ipForward, ipNewCfgStaticRouteTable=ipNewCfgStaticRouteTable, vrrpCurCfgVirtRtrGrpState=vrrpCurCfgVirtRtrGrpState, vrrpCurCfgVirtRtrGrpTckIpIntf=vrrpCurCfgVirtRtrGrpTckIpIntf, ripCurCfgSupply=ripCurCfgSupply, ipFwdCurCfgPortEntry=ipFwdCurCfgPortEntry, ospfHostTableMaxSize=ospfHostTableMaxSize, ripNewCfgUpdatePeriod=ripNewCfgUpdatePeriod, vrrpCurCfgVirtRtrTckRServer=vrrpCurCfgVirtRtrTckRServer, ospfAreaNbrLoadingDone=ospfAreaNbrLoadingDone, ipRouteInfoGateway=ipRouteInfoGateway, ipFwdNewCfgLocalEntry=ipFwdNewCfgLocalEntry, ospfCurCfgAreaEntry=ospfCurCfgAreaEntry, ospfIntfNbrStart=ospfIntfNbrStart, ipRouteInfoInterface=ipRouteInfoInterface, vrrpNewCfgVirtRtrGrpSharing=vrrpNewCfgVirtRtrGrpSharing, ospfCumNbrChangeStats=ospfCumNbrChangeStats, vrrpNewCfgVirtRtrGrpTckIpIntf=vrrpNewCfgVirtRtrGrpTckIpIntf, ripStatInPkts=ripStatInPkts, ospfIntfNbrBadSequence=ospfIntfNbrBadSequence, ospfCumIntfLoop=ospfCumIntfLoop, ospfTmrsKckOffAseExport=ospfTmrsKckOffAseExport, ipCurCfgStaticRouteInterface=ipCurCfgStaticRouteInterface, vrrpNewCfgVirtRtrGrpID=vrrpNewCfgVirtRtrGrpID, vrrpCurCfgGenTckHsrvInc=vrrpCurCfgGenTckHsrvInc, vrrpCurCfgGenHotstandby=vrrpCurCfgGenHotstandby, routeStatHighWater=routeStatHighWater, ospfAreaNbrChangeStatsEntry=ospfAreaNbrChangeStatsEntry, ospfAreaNbrhello=ospfAreaNbrhello, ospfIntfRxlsAcks=ospfIntfRxlsAcks, ipFwdNewCfgPortIndex=ipFwdNewCfgPortIndex, ipNewCfgGwInterval=ipNewCfgGwInterval, routerLSANoOfTOSZeroMetrics=routerLSANoOfTOSZeroMetrics, ospfAreaChangeStatsEntry=ospfAreaChangeStatsEntry, ipCurCfgIntfAddr=ipCurCfgIntfAddr, vrrpOperVirtRtrBackup=vrrpOperVirtRtrBackup, ospfIntfLoop=ospfIntfLoop, ospfIntfRxTxIndex=ospfIntfRxTxIndex, ipFwdNewCfgLocalIndex=ipFwdNewCfgLocalIndex, ipFwdCurCfgLocalMask=ipFwdCurCfgLocalMask, ospfIntfIndex=ospfIntfIndex, ospfAreaNbrChangeStats=ospfAreaNbrChangeStats, ospfAreaTxlsAcks=ospfAreaTxlsAcks, ipFwdLocalTableMaxSize=ipFwdLocalTableMaxSize, ipFwdCurCfgPortTable=ipFwdCurCfgPortTable, ospfIntfUnloop=ospfIntfUnloop, ipCurCfgBootpAddr=ipCurCfgBootpAddr, ospfCumIntfDown=ospfCumIntfDown, vrrpCurCfgVirtRtrTable=vrrpCurCfgVirtRtrTable, ipNewCfgStaticRouteGateway=ipNewCfgStaticRouteGateway, vrrpNewCfgVirtRtrTable=vrrpNewCfgVirtRtrTable, vrrpNewCfgVirtRtrAddr=vrrpNewCfgVirtRtrAddr, arpInfoEntry=arpInfoEntry, ospfAreaTableMaxSize=ospfAreaTableMaxSize, vrrpOperVirtRtrEntry=vrrpOperVirtRtrEntry, vrrpCurCfgVirtRtrGrpTckRServer=vrrpCurCfgVirtRtrGrpTckRServer, ospfTotalNeighbours=ospfTotalNeighbours, vrrpNewCfgVirtRtrGrpTckVirtRtr=vrrpNewCfgVirtRtrGrpTckVirtRtr, vrrpNewCfgVirtRtrGrpTable=vrrpNewCfgVirtRtrGrpTable, ospfCumTxPkts=ospfCumTxPkts, ipFwdNewCfgLocalMask=ipFwdNewCfgLocalMask, ipFwdNewCfgLocalDelete=ipFwdNewCfgLocalDelete, vrrpCurCfgVirtRtrID=vrrpCurCfgVirtRtrID, arpInfoMacAddr=arpInfoMacAddr, ipNewCfgGwState=ipNewCfgGwState, vrrpCurCfgVirtRtrSharing=vrrpCurCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpTckHsrp=vrrpNewCfgVirtRtrGrpTckHsrp, vrrpVirtRtrGrpTableMaxSize=vrrpVirtRtrGrpTableMaxSize, vrrpCurCfgVirtRtrTckHsrv=vrrpCurCfgVirtRtrTckHsrv, ipFwdNewCfgDirectedBcast=ipFwdNewCfgDirectedBcast, ospfTmrsKckOffSummary=ospfTmrsKckOffSummary, ospfIntfNbrN1way=ospfIntfNbrN1way, ipNewCfgIntfBootpRelay=ipNewCfgIntfBootpRelay, ipCurCfgIntfEntry=ipCurCfgIntfEntry, ospfCumNbrBadRequests=ospfCumNbrBadRequests, ospfinfo=ospfinfo, ipNewCfgGwIndex=ipNewCfgGwIndex, ipCurCfgIntfBroadcast=ipCurCfgIntfBroadcast, vrrpCurCfgVirtRtrGrpTableEntry=vrrpCurCfgVirtRtrGrpTableEntry, ipCurCfgGwInterval=ipCurCfgGwInterval, vrrpCurCfgVirtRtrIndx=vrrpCurCfgVirtRtrIndx, ospfIntfWaitTimer=ospfIntfWaitTimer, ospfCurCfgAreaId=ospfCurCfgAreaId, ospfCumNbrDown=ospfCumNbrDown, ospfTmrsKckOffLsaLock=ospfTmrsKckOffLsaLock, ospfIntfRxlsUpdates=ospfIntfRxlsUpdates, ip_info=ip_info, ospfIfTotalNeighbours=ospfIfTotalNeighbours, vrrpCurCfgVirtRtrTckL4Port=vrrpCurCfgVirtRtrTckL4Port, ospfCumTxlsAcks=ospfCumTxlsAcks, ospfAreaInfoId=ospfAreaInfoId, arpInfoVLAN=arpInfoVLAN, ospfAreaRxDatabase=ospfAreaRxDatabase, vrrpInfoVirtRtrState=vrrpInfoVirtRtrState, ipNewCfgIntfMask=ipNewCfgIntfMask, ipCurCfgStaticRouteIndx=ipCurCfgStaticRouteIndx, ipCurCfgGwMetric=ipCurCfgGwMetric, dnsStats=dnsStats, ospfStats=ospfStats, ospfCumNbrStart=ospfCumNbrStart, ipCurCfgBootpState=ipCurCfgBootpState, vrrpCurCfgVirtRtrTableEntry=vrrpCurCfgVirtRtrTableEntry, ospfTotalNssaAreas=ospfTotalNssaAreas, vrrpInfoVirtRtrTable=vrrpInfoVirtRtrTable, ospfIntfChangeStatsEntry=ospfIntfChangeStatsEntry, vrrpNewCfgVirtRtrGrpState=vrrpNewCfgVirtRtrGrpState, ipCurCfgIntfIndex=ipCurCfgIntfIndex, vrrpCurCfgVirtRtrGrpPriority=vrrpCurCfgVirtRtrGrpPriority, ospfStartTime=ospfStartTime, iprouting=iprouting, ospfIfInfoIpAddress=ospfIfInfoIpAddress, ospfNbrInInitState=ospfNbrInInitState, dnsStatInBadDnsRequests=dnsStatInBadDnsRequests, ipNewCfgStaticRouteEntry=ipNewCfgStaticRouteEntry, ripCurCfgVip=ripCurCfgVip, ripNewCfgPoisonReverse=ripNewCfgPoisonReverse, ipNewCfgStaticRouteMask=ipNewCfgStaticRouteMask, ospfVirtIntfTableMaxSize=ospfVirtIntfTableMaxSize, vrrpCurCfgVirtRtrGrpInterval=vrrpCurCfgVirtRtrGrpInterval, dnsStatInGoodDnsRequests=dnsStatInGoodDnsRequests, vrrpCurCfgGenTckVirtRtrInc=vrrpCurCfgGenTckVirtRtrInc, vrrpCurCfgVirtRtrGrpTable=vrrpCurCfgVirtRtrGrpTable, ospfArea=ospfArea, ipNewCfgGwRetry=ipNewCfgGwRetry, routerLSALinkIfIndex=routerLSALinkIfIndex, ripNewCfgStaticSupply=ripNewCfgStaticSupply, ospfCurCfgDefaultRouteMetricType=ospfCurCfgDefaultRouteMetricType, ospfTmrsKckOffRetransmit=ospfTmrsKckOffRetransmit, arpInfoSrcPort=arpInfoSrcPort, vrrpCurCfgVirtRtrPreempt=vrrpCurCfgVirtRtrPreempt, ospfAreaTxPkts=ospfAreaTxPkts, vrrpCurCfgVirtRtrTckVirtRtr=vrrpCurCfgVirtRtrTckVirtRtr, ipCurCfgGwRetry=ipCurCfgGwRetry, vrrpNewCfgVirtRtrPreempt=vrrpNewCfgVirtRtrPreempt, ospfAreaNbrBadSequence=ospfAreaNbrBadSequence, vrrpNewCfgVirtRtrGrpIfIndex=vrrpNewCfgVirtRtrGrpIfIndex, ospfAreaIntfDown=ospfAreaIntfDown, ipRouteInfoEntry=ipRouteInfoEntry, vrrpCurCfgGenTckIpIntfInc=vrrpCurCfgGenTckIpIntfInc, vrrpInfoVirtRtrServer=vrrpInfoVirtRtrServer, arpInfoFlag=arpInfoFlag, vrrpNewCfgGenTckIpIntfInc=vrrpNewCfgGenTckIpIntfInc, ipCurCfgGwEntry=ipCurCfgGwEntry, ospfTmrsKckOffLsaAck=ospfTmrsKckOffLsaAck, vrrpCurCfgVirtRtrInterval=vrrpCurCfgVirtRtrInterval, ipCurCfgIntfTable=ipCurCfgIntfTable, ospfIntfTxlsReqs=ospfIntfTxlsReqs, ospfAreaIntfUnloop=ospfAreaIntfUnloop, vrrpStatInAdvers=vrrpStatInAdvers, vrrpNewCfgVirtRtrTableEntry=vrrpNewCfgVirtRtrTableEntry, ospfTotalTransitAreas=ospfTotalTransitAreas, ospfAreaNbrDown=ospfAreaNbrDown, ospfIntfNbrLoadingDone=ospfIntfNbrLoadingDone, vrrpCurCfgIfIndx=vrrpCurCfgIfIndx, vrrpNewCfgIfPasswd=vrrpNewCfgIfPasswd, ospfAreaIntfIndex=ospfAreaIntfIndex, ipNewCfgIntfIndex=ipNewCfgIntfIndex, ipFwdCurCfgLocalIndex=ipFwdCurCfgLocalIndex, ipRouteInfoIndx=ipRouteInfoIndx, ospfCfg=ospfCfg, ospfCumRxHello=ospfCumRxHello, ospfNewCfgAreaIndex=ospfNewCfgAreaIndex, ipCurCfgIntfBootpRelay=ipCurCfgIntfBootpRelay, ipFwdCurCfgLocalSubnet=ipFwdCurCfgLocalSubnet, vrrpCurCfgGenTckHsrpInc=vrrpCurCfgGenTckHsrpInc, ospfAreaNbrBadRequests=ospfAreaNbrBadRequests, ripConfig=ripConfig, ospfAreaRxlsAcks=ospfAreaRxlsAcks, ospfAreaIntfWaitTimer=ospfAreaIntfWaitTimer)
mibBuilder.exportSymbols("ALTEON-TS-NETWORK-MIB", ipCurCfgGwTable=ipCurCfgGwTable, vrrpNewCfgVirtRtrID=vrrpNewCfgVirtRtrID, ospfInterface=ospfInterface, ospfNumberOfLsdbEntries=ospfNumberOfLsdbEntries, vrrpInfoVirtRtrProxy=vrrpInfoVirtRtrProxy, ospfAreaRxHello=ospfAreaRxHello, ipFwdNewCfgLocalTable=ipFwdNewCfgLocalTable, ospfCurCfgAreaTable=ospfCurCfgAreaTable, ospfNewCfgAreaId=ospfNewCfgAreaId, vrrpNewCfgVirtRtrGrpIndx=vrrpNewCfgVirtRtrGrpIndx, vrrpNewCfgVirtRtrState=vrrpNewCfgVirtRtrState, vrrpNewCfgVirtRtrPriority=vrrpNewCfgVirtRtrPriority, arpInfoRefPorts=arpInfoRefPorts, ospfIntfNbrChangeStats=ospfIntfNbrChangeStats, routerLSALinkData=routerLSALinkData, ipCurCfgStaticRouteMask=ipCurCfgStaticRouteMask, ospfIntfRxlsReqs=ospfIntfRxlsReqs, ospfIntfNbrhello=ospfIntfNbrhello, ospfCumRxDatabase=ospfCumRxDatabase, ipNewCfgStaticRouteInterface=ipNewCfgStaticRouteInterface, vrrpVirtRtrTableMaxSize=vrrpVirtRtrTableMaxSize, ospfCumIntfNbrChange=ospfCumIntfNbrChange, ospfNumberOfInterfacesUp=ospfNumberOfInterfacesUp, ipNewCfgGwAddr=ipNewCfgGwAddr, ospfIntfBackup=ospfIntfBackup, ospfNewCfgDefaultRouteMetricType=ospfNewCfgDefaultRouteMetricType, ipNewCfgIntfState=ipNewCfgIntfState, ripCurCfgDefListen=ripCurCfgDefListen, ospfCumRxlsUpdates=ospfCumRxlsUpdates, ospfCumNbrRstAd=ospfCumNbrRstAd, vrrpNewCfgIfTableEntry=vrrpNewCfgIfTableEntry, ospfIfWaitInterval=ospfIfWaitInterval, ospfAreaNbrAdjointOk=ospfAreaNbrAdjointOk, vrrpNewCfgVirtRtrGrpTckHsrv=vrrpNewCfgVirtRtrGrpTckHsrv, vrrpNewCfgVirtRtrTckVirtRtr=vrrpNewCfgVirtRtrTckVirtRtr, ospfTmrsKckOffHello=ospfTmrsKckOffHello, ospfIntfNbrAdjointOk=ospfIntfNbrAdjointOk, vrrpNewCfgVirtRtrDelete=vrrpNewCfgVirtRtrDelete, ipFwdCurCfgDirectedBcast=ipFwdCurCfgDirectedBcast, vrrpCurCfgVirtRtrTckIpIntf=vrrpCurCfgVirtRtrTckIpIntf, vrrpCurCfgVirtRtrIfIndex=vrrpCurCfgVirtRtrIfIndex, ospfAreaInfoEntry=ospfAreaInfoEntry, ospfIntfChangeStats=ospfIntfChangeStats, vrrpNewCfgVirtRtrGrpDelete=vrrpNewCfgVirtRtrGrpDelete, ospfIntfInfoTable=ospfIntfInfoTable, ipCurCfgGwAddr=ipCurCfgGwAddr, ripStatInErrorPkts=ripStatInErrorPkts, routeStatEntries=routeStatEntries, routerLSAAreaIndex=routerLSAAreaIndex, vrrpNewCfgVirtRtrSharing=vrrpNewCfgVirtRtrSharing, vrrpNewCfgVirtRtrGrpInterval=vrrpNewCfgVirtRtrGrpInterval, ipNewCfgIntfTable=ipNewCfgIntfTable, vrrpNewCfgVirtRtrGrpTckVlanPort=vrrpNewCfgVirtRtrGrpTckVlanPort, ipCurCfgBootpAddr2=ipCurCfgBootpAddr2, vrrpNewCfgVirtRtrTckIpIntf=vrrpNewCfgVirtRtrTckIpIntf, ripNewCfgListen=ripNewCfgListen, ospfNewCfgAreaSpfInterval=ospfNewCfgAreaSpfInterval, vrrpCurCfgVirtRtrGrpTckHsrv=vrrpCurCfgVirtRtrGrpTckHsrv, ospfNbrInExchState=ospfNbrInExchState, ospfGeneralStats=ospfGeneralStats, ospfNewCfgAreaTable=ospfNewCfgAreaTable, ospfIntfTxlsUpdates=ospfIntfTxlsUpdates, arpStatMaxEntries=arpStatMaxEntries, ospfIntfTableMaxSize=ospfIntfTableMaxSize, ospfAreaNbrNegotiationDone=ospfAreaNbrNegotiationDone, vrrpOperVirtRtrTable=vrrpOperVirtRtrTable, ospfIntfTxlsAcks=ospfIntfTxlsAcks, ospfNewCfgDefaultRouteMetric=ospfNewCfgDefaultRouteMetric, ospfAreaTxDatabase=ospfAreaTxDatabase, ospfGeneralInfo=ospfGeneralInfo, ospfIfInfoIndex=ospfIfInfoIndex, vrrpNewCfgVirtRtrGrpPreempt=vrrpNewCfgVirtRtrGrpPreempt, vrrpOper=vrrpOper, arpStats=arpStats, ipFwdNewCfgPortState=ipFwdNewCfgPortState, ipFwdNewCfgLocalSubnet=ipFwdNewCfgLocalSubnet, ospfIntfNbrChangeStatsEntry=ospfIntfNbrChangeStatsEntry, ospfCumNbrExchangeDone=ospfCumNbrExchangeDone, vrrpNewCfgGenTckVirtRtrInc=vrrpNewCfgGenTckVirtRtrInc, ospfIntfRxHello=ospfIntfRxHello, ripNewCfgState=ripNewCfgState, arpCurCfgReARPPeriod=arpCurCfgReARPPeriod, vrrpInfoVirtRtrTableEntry=vrrpInfoVirtRtrTableEntry, ospfAreaRxTxStatsEntry=ospfAreaRxTxStatsEntry, ospfIntfNbrExchangeDone=ospfIntfNbrExchangeDone, vrrpCurCfgIfTable=vrrpCurCfgIfTable, vrrpStatOutBadAdvers=vrrpStatOutBadAdvers, ipNewCfgGwDelete=ipNewCfgGwDelete, ripCurCfgState=ripCurCfgState, ipFwdNewCfgState=ipFwdNewCfgState, ipNewCfgIntfDelete=ipNewCfgIntfDelete, ipCurCfgGwArp=ipCurCfgGwArp, vrrpNewCfgVirtRtrTckVlanPort=vrrpNewCfgVirtRtrTckVlanPort, ospfAreaRxPkts=ospfAreaRxPkts, ipRouteInfoTag=ipRouteInfoTag, vrrpNewCfgIfIndx=vrrpNewCfgIfIndx, ospfIntfTxHello=ospfIntfTxHello, routeStatMaxEntries=routeStatMaxEntries, ospfCumTxlsReqs=ospfCumTxlsReqs, vrrpNewCfgGenTckVlanPortInc=vrrpNewCfgGenTckVlanPortInc, vrrpNewCfgGenHotstandby=vrrpNewCfgGenHotstandby, ospfIntfRxTxStatsEntry=ospfIntfRxTxStatsEntry, ipCurCfgStaticRouteTable=ipCurCfgStaticRouteTable, ospfCumIntfUnloop=ospfCumIntfUnloop, ipCurCfgGwState=ipCurCfgGwState, ospfRouterLSAInfoTable=ospfRouterLSAInfoTable, ipNewCfgGwArp=ipNewCfgGwArp, ipStaticRouteTableMaxSize=ipStaticRouteTableMaxSize, vrrpNewCfgGenTckHsrvInc=vrrpNewCfgGenTckHsrvInc, ospfCumNbrhello=ospfCumNbrhello, ipNewCfgBootpAddr2=ipNewCfgBootpAddr2, vrrpCurCfgVirtRtrGrpSharing=vrrpCurCfgVirtRtrGrpSharing, routeStats=routeStats, ipFwdPortTableMaxSize=ipFwdPortTableMaxSize, ospfCumNbrN1way=ospfCumNbrN1way, ripStats=ripStats, arpInfoDestIp=arpInfoDestIp, vrrp_info=vrrp_info, ipNewCfgIntfEntry=ipNewCfgIntfEntry, vrrpNewCfgVirtRtrTckL4Port=vrrpNewCfgVirtRtrTckL4Port, vrrpNewCfgGenTckL4PortInc=vrrpNewCfgGenTckL4PortInc, vrrpNewCfgIfAuthType=vrrpNewCfgIfAuthType, ipRouteInfoDestIp=ipRouteInfoDestIp, arpInfoTable=arpInfoTable, ipCurCfgIntfState=ipCurCfgIntfState, vrrpNewCfgGenTckHsrpInc=vrrpNewCfgGenTckHsrpInc, ospfLsTypesSupported=ospfLsTypesSupported, vrrpCurCfgVirtRtrGrpTckVirtRtr=vrrpCurCfgVirtRtrGrpTckVirtRtr, vrrpStatOutAdvers=vrrpStatOutAdvers, ospfIntfRxDatabase=ospfIntfRxDatabase, vrrpGeneral=vrrpGeneral, ospfIntfNbrDown=ospfIntfNbrDown, vrrpNewCfgVirtRtrGrpTckL4Port=vrrpNewCfgVirtRtrGrpTckL4Port, vrrpCurCfgVirtRtrTckHsrp=vrrpCurCfgVirtRtrTckHsrp, vrrpNewCfgVirtRtrGrpTckRServer=vrrpNewCfgVirtRtrGrpTckRServer, ospfIntfNbrNegotiationDone=ospfIntfNbrNegotiationDone, ipNewCfgStaticRouteDestIp=ipNewCfgStaticRouteDestIp, vrrpNewCfgVirtRtrInterval=vrrpNewCfgVirtRtrInterval, ospfCumTxlsUpdates=ospfCumTxlsUpdates, ripCurCfgPoisonReverse=ripCurCfgPoisonReverse, routerLSANoOfTOSMetrics=routerLSANoOfTOSMetrics, ospfAreaInfoIndex=ospfAreaInfoIndex, ospfAreaIntfBackup=ospfAreaIntfBackup, ospfCumIntfBackup=ospfCumIntfBackup, ripStatOutPkts=ripStatOutPkts, routerLSALinkID=routerLSALinkID, ipGatewayTableMax=ipGatewayTableMax, ospfCumNbrLoadingDone=ospfCumNbrLoadingDone, ospfCumIntfHello=ospfCumIntfHello, ospfCumIntfWaitTimer=ospfCumIntfWaitTimer, vrrpCurCfgIfTableEntry=vrrpCurCfgIfTableEntry, ospfTmrsKckOffDbage=ospfTmrsKckOffDbage, ospfTotalAreas=ospfTotalAreas, ospfRouterLSAInfoEntry=ospfRouterLSAInfoEntry, ipCurCfgGwIndex=ipCurCfgGwIndex, ripNewCfgVip=ripNewCfgVip, vrrpCurCfgVirtRtrTckVlanPort=vrrpCurCfgVirtRtrTckVlanPort, ripStatRoutesAgedOut=ripStatRoutesAgedOut, ospfAreaRxTxIndex=ospfAreaRxTxIndex, ospfCumRxlsReqs=ospfCumRxlsReqs, ipNewCfgGwMetric=ipNewCfgGwMetric, vrrpCurCfgVirtRtrGrpIndx=vrrpCurCfgVirtRtrGrpIndx, ospfCumTxHello=ospfCumTxHello, ospfIfBackupDesignatedRouterIP=ospfIfBackupDesignatedRouterIP, ipNewCfgGwTable=ipNewCfgGwTable, ospfAreaIntfLoop=ospfAreaIntfLoop, ipCurCfgIntfMask=ipCurCfgIntfMask, vrrpCurCfgIfAuthType=vrrpCurCfgIfAuthType, ospfAreaChangeStats=ospfAreaChangeStats, ospfIntfNbrRstAd=ospfIntfNbrRstAd, vrrpCurCfgIfPasswd=vrrpCurCfgIfPasswd, ipCurCfgGwVlan=ipCurCfgGwVlan, ospfIntfNbrIndex=ospfIntfNbrIndex, ipCurCfgStaticRouteDestIp=ipCurCfgStaticRouteDestIp, ospfIfDesignatedRouterIP=ospfIfDesignatedRouterIP, ospfIntfTxDatabase=ospfIntfTxDatabase, vrrpCurCfgVirtRtrGrpIfIndex=vrrpCurCfgVirtRtrGrpIfIndex, ipFwdNewCfgPortTable=ipFwdNewCfgPortTable, ripNewCfgSupply=ripNewCfgSupply, vrrpNewCfgVirtRtrGrpPriority=vrrpNewCfgVirtRtrGrpPriority, ospfIntfNbrChange=ospfIntfNbrChange, vrrpCurCfgVirtRtrPriority=vrrpCurCfgVirtRtrPriority, ripCurCfgStaticSupply=ripCurCfgStaticSupply, vrrpCurCfgGenTckRServerInc=vrrpCurCfgGenTckRServerInc, ospfAreaIntfNbrChange=ospfAreaIntfNbrChange, vrrpNewCfgVirtRtrIfIndex=vrrpNewCfgVirtRtrIfIndex, vrrpOperVirtRtrIndex=vrrpOperVirtRtrIndex, vrrpNewCfgVirtRtrTckHsrp=vrrpNewCfgVirtRtrTckHsrp, ospfVlinkCountForRouter=ospfVlinkCountForRouter, ipFwdCurCfgLocalTable=ipFwdCurCfgLocalTable, ospfCurCfgAreaSpfInterval=ospfCurCfgAreaSpfInterval, ospfCumRxTxStats=ospfCumRxTxStats, ripCurCfgListen=ripCurCfgListen, ripCurCfgUpdatePeriod=ripCurCfgUpdatePeriod, ipFwdCurCfgLocalEntry=ipFwdCurCfgLocalEntry, ospfCumIntfChangeStats=ospfCumIntfChangeStats, ipNewCfgIntfBroadcast=ipNewCfgIntfBroadcast, vrrpCurCfgGenState=vrrpCurCfgGenState, ospfCumNbrNegotiationDone=ospfCumNbrNegotiationDone)
